...
.method static synthetic access$000(Lcom/android/server/ExplicitHealthCheckController;Landroid/os/IBinder;)V
    ...
    invoke-direct {p0, p1}, initState(Landroid/os/IBinder;)V
...
.method static synthetic access$202(Lcom/android/server/ExplicitHealthCheckController;Landroid/service/watchdog/IExplicitHealthCheckService;)Landroid/service/watchdog/IExplicitHealthCheckService;
    ...
    iput-object p1, p0, mRemoteService:Landroid/service/watchdog/IExplicitHealthCheckService;
...
.method private bindService()V
    ...
    iget-object v1, p0, mRemoteService:Landroid/service/watchdog/IExplicitHealthCheckService;
    ...
    :cond_0
    invoke-direct {p0}, getServiceComponentNameLocked()Landroid/content/ComponentName;
...
.method private cancel(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v1}, prepareServiceLocked(Ljava/lang/String;)Z
...
.method private getServiceComponentNameLocked()Landroid/content/ComponentName;
    ...
    invoke-direct {p0}, getServiceInfoLocked()Landroid/content/pm/ServiceInfo;
...
.method private initState(Landroid/os/IBinder;)V
    ...
    iput-object v1, p0, mRemoteService:Landroid/service/watchdog/IExplicitHealthCheckService;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget-object v0, p0, mNotifySyncRunnable:Ljava/lang/Runnable;
...
.method private prepareServiceLocked(Ljava/lang/String;)Z
    ...
    iget-object v0, p0, mRemoteService:Landroid/service/watchdog/IExplicitHealthCheckService;
...
.method public synthetic lambda$initState$6$ExplicitHealthCheckController(Landroid/os/Bundle;)V
    ...
    iget-object v1, p0, mPassedConsumer:Ljava/util/function/Consumer;
...
.method public synthetic lambda$syncRequests$0$ExplicitHealthCheckController(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, cancel(Ljava/lang/String;)V
...
.method public synthetic lambda$syncRequests$1$ExplicitHealthCheckController(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, request(Ljava/lang/String;)V
...
.method public synthetic lambda$syncRequests$2$ExplicitHealthCheckController(Ljava/util/List;Ljava/util/Set;Ljava/util/List;)V
    ...
    invoke-direct {p0, p3, p2, v2}, actOnDifference(Ljava/util/Collection;Ljava/util/Collection;Ljava/util/function/Consumer;)V
    ...
    invoke-direct {p0, p2, p3, v2}, actOnDifference(Ljava/util/Collection;Ljava/util/Collection;Ljava/util/function/Consumer;)V
...
.method public synthetic lambda$syncRequests$3$ExplicitHealthCheckController(Ljava/util/Set;Ljava/util/List;)V
    ...
    iget-object v0, p0, mSupportedConsumer:Ljava/util/function/Consumer;
    ...
    invoke-direct {p0, v0}, getRequestedPackages(Ljava/util/function/Consumer;)V
...
.method public setCallbacks(Ljava/util/function/Consumer;Ljava/util/function/Consumer;Ljava/lang/Runnable;)V
    ...
    iget-object v1, p0, mSupportedConsumer:Ljava/util/function/Consumer;

    if-nez v1, :cond_0

    iget-object v1, p0, mNotifySyncRunnable:Ljava/lang/Runnable;
    ...
    iput-object v1, p0, mPassedConsumer:Ljava/util/function/Consumer;
    ...
    iput-object v1, p0, mSupportedConsumer:Ljava/util/function/Consumer;
    ...
    iput-object v1, p0, mNotifySyncRunnable:Ljava/lang/Runnable;
...
.method public syncRequests(Ljava/util/Set;)V
    ...
    invoke-direct {p0, v0}, getSupportedPackages(Ljava/util/function/Consumer;)V
