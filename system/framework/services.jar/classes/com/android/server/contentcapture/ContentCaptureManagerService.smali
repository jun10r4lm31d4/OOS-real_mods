...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mLocalService:Lcom/android/server/contentcapture/ContentCaptureManagerService$LocalService;
    ...
    iput-object v0, p0, mGlobalContentCaptureOptions:Lcom/android/server/contentcapture/ContentCaptureManagerService$GlobalContentCaptureOptions;
    ...
    iget v0, p0, mDevCfgLogHistorySize:I
    ...
    iget v2, p0, mDevCfgLogHistorySize:I
    ...
    iget v1, p0, mDevCfgLogHistorySize:I
    ...
    iget v3, p0, mDevCfgLogHistorySize:I
    ...
    :cond_2
    iput-object v1, p0, mRequestsHistory:Landroid/util/LocalLog;
    ...
    invoke-direct {p0, v3}, isEnabledBySettings(I)Z
    ...
    iget-object v6, p0, mDisabledBySettings:Landroid/util/SparseBooleanArray;
    ...
    iput-object v6, p0, mDisabledBySettings:Landroid/util/SparseBooleanArray;
    ...
    :cond_4
    iget-object v5, p0, mGlobalContentCaptureOptions:Lcom/android/server/contentcapture/ContentCaptureManagerService$GlobalContentCaptureOptions;

    iget-object v6, p0, mServiceNameResolver:Lcom/android/server/infra/ServiceNameResolver;

    invoke-interface {v6, v3}, Lcom/android/server/infra/ServiceNameResolver;->getServiceName(I)Ljava/lang/String;

    move-result-object v6

    iget-object v7, p0, mServiceNameResolver:Lcom/android/server/infra/ServiceNameResolver;
...
.method static synthetic access$1000(Lcom/android/server/contentcapture/ContentCaptureManagerService;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, assertCalledByPackageOwner(Ljava/lang/String;)V
...
.method static synthetic access$1400(Lcom/android/server/contentcapture/ContentCaptureManagerService;Lcom/android/internal/os/IResultReceiver;Ljava/lang/Runnable;)Z
    ...
    invoke-direct {p0, p1, p2}, throwsSecurityException(Lcom/android/internal/os/IResultReceiver;Ljava/lang/Runnable;)Z
...
.method static synthetic access$1500(Lcom/android/server/contentcapture/ContentCaptureManagerService;)Z
    ...
    iget-boolean v0, p0, mDisabledByDeviceConfig:Z
...
.method static synthetic access$1600(Lcom/android/server/contentcapture/ContentCaptureManagerService;I)Z
    ...
    invoke-direct {p0, p1}, isDisabledBySettingsLocked(I)Z
...
.method static synthetic access$200(Lcom/android/server/contentcapture/ContentCaptureManagerService;)Landroid/app/ActivityManagerInternal;
    ...
    invoke-direct {p0}, getAmInternal()Landroid/app/ActivityManagerInternal;
...
.method static synthetic access$2800(Lcom/android/server/contentcapture/ContentCaptureManagerService;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, assertCalledByServiceLocked(Ljava/lang/String;)V
...
.method private assertCalledByServiceLocked(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, isCalledByServiceLocked(Ljava/lang/String;)Z
...
.method private getAmInternal()Landroid/app/ActivityManagerInternal;
    ...
    :try_start_0
    iget-object v1, p0, mAm:Landroid/app/ActivityManagerInternal;
    ...
    iput-object v1, p0, mAm:Landroid/app/ActivityManagerInternal;
...
.method private isCalledByServiceLocked(Ljava/lang/String;)Z
    ...
    iget-object v2, p0, mServiceNameResolver:Lcom/android/server/infra/ServiceNameResolver;
    ...
    iget-object v5, p0, mTag:Ljava/lang/String;
    ...
    iget-object v9, p0, mTag:Ljava/lang/String;
...
.method private isDisabledBySettingsLocked(I)Z
    ...
    iget-object v0, p0, mDisabledBySettings:Landroid/util/SparseBooleanArray;
...
.method private onDeviceConfigChange(Landroid/provider/DeviceConfig$Properties;)V
    ...
    :pswitch_0
    invoke-direct {p0}, setFineTuneParamsFromDeviceConfig()V

    return-void

    :pswitch_1
    invoke-direct {p0}, setLoggingLevelFromDeviceConfig()V
    ...
    invoke-direct {p0, v0}, setDisabledByDeviceConfig(Ljava/lang/String;)V
...
.method private setContentCaptureFeatureEnabledBySettingsForUser(IZ)V
    ...
    :try_start_0
    iget-object v1, p0, mDisabledBySettings:Landroid/util/SparseBooleanArray;
    ...
    iput-object v1, p0, mDisabledBySettings:Landroid/util/SparseBooleanArray;
    ...
    iget-object v3, p0, mDisabledBySettings:Landroid/util/SparseBooleanArray;
    ...
    iget-boolean v3, p0, mDisabledByDeviceConfig:Z
    ...
    :cond_5
    :goto_1
    invoke-virtual {p0, p1, v2}, updateCachedServiceLocked(IZ)Lcom/android/server/infra/AbstractPerUserSystemService;
...
.method private setDisabledByDeviceConfig(Ljava/lang/String;)V
    ...
    :try_start_0
    iget-boolean v4, p0, mDisabledByDeviceConfig:Z

    if-ne v4, v2, :cond_3

    iget-boolean v4, p0, verbose:Z
    ...
    :cond_3
    iput-boolean v2, p0, mDisabledByDeviceConfig:Z
    ...
    iget-boolean v6, p0, mDisabledByDeviceConfig:Z
    ...
    iget-boolean v7, p0, mDisabledByDeviceConfig:Z

    if-nez v7, :cond_5

    invoke-direct {p0, v6}, isDisabledBySettingsLocked(I)Z
    ...
    invoke-virtual {p0, v6, v7}, updateCachedServiceLocked(IZ)Lcom/android/server/infra/AbstractPerUserSystemService;
...
.method private setFineTuneParamsFromDeviceConfig()V
    ...
    iput v1, p0, mDevCfgMaxBufferSize:I
    ...
    iput v1, p0, mDevCfgIdleFlushingFrequencyMs:I
    ...
    iput v1, p0, mDevCfgTextChangeFlushingFrequencyMs:I
    ...
    iput v1, p0, mDevCfgLogHistorySize:I
    ...
    iput v1, p0, mDevCfgIdleUnbindTimeoutMs:I
    ...
    iget v3, p0, mDevCfgMaxBufferSize:I
    ...
    iget v3, p0, mDevCfgIdleFlushingFrequencyMs:I
    ...
    iget v3, p0, mDevCfgTextChangeFlushingFrequencyMs:I
    ...
    iget v3, p0, mDevCfgIdleUnbindTimeoutMs:I
...
.method private setLoggingLevelFromDeviceConfig()V
    ...
    iput v0, p0, mDevCfgLoggingLevel:I

    iget v0, p0, mDevCfgLoggingLevel:I
    ...
    iget v2, p0, mDevCfgLoggingLevel:I
...
.method protected dumpLocked(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    iget-boolean v1, p0, mDisabledByDeviceConfig:Z
    ...
    iget v1, p0, mDevCfgLoggingLevel:I
    ...
    iget v1, p0, mDevCfgMaxBufferSize:I
    ...
    iget v1, p0, mDevCfgIdleFlushingFrequencyMs:I
    ...
    iget v1, p0, mDevCfgTextChangeFlushingFrequencyMs:I
    ...
    iget v1, p0, mDevCfgIdleUnbindTimeoutMs:I
    ...
    iget-object v1, p0, mGlobalContentCaptureOptions:Lcom/android/server/contentcapture/ContentCaptureManagerService$GlobalContentCaptureOptions;
...
.method public synthetic lambda$new$0$ContentCaptureManagerService(Landroid/provider/DeviceConfig$Properties;)V
    ...
    invoke-direct {p0, p1}, onDeviceConfigChange(Landroid/provider/DeviceConfig$Properties;)V
...
.method protected bridge synthetic newServiceLocked(IZ)Lcom/android/server/infra/AbstractPerUserSystemService;
    ...
    invoke-virtual {p0, p1, p2}, newServiceLocked(IZ)Lcom/android/server/contentcapture/ContentCapturePerUserService;
...
.method protected onServiceNameChanged(ILjava/lang/String;Z)V
    ...
    iget-object v0, p0, mGlobalContentCaptureOptions:Lcom/android/server/contentcapture/ContentCaptureManagerService$GlobalContentCaptureOptions;
...
.method protected bridge synthetic onServiceRemoved(Lcom/android/server/infra/AbstractPerUserSystemService;I)V
    ...
    invoke-virtual {p0, p1, p2}, onServiceRemoved(Lcom/android/server/contentcapture/ContentCapturePerUserService;I)V
...
.method protected onSettingsChanged(ILjava/lang/String;)V
    ...
    invoke-direct {p0, p1}, isEnabledBySettings(I)Z

    move-result v0

    invoke-direct {p0, p1, v0}, setContentCaptureFeatureEnabledBySettingsForUser(IZ)V
...
.method public onStart()V
    ...
    iget-object v1, p0, mLocalService:Lcom/android/server/contentcapture/ContentCaptureManagerService$LocalService;
