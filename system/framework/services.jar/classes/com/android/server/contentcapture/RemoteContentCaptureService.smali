...
.method constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/service/contentcapture/IContentCaptureServiceCallback;ILcom/android/server/contentcapture/ContentCapturePerUserService;ZZI)V
    ...
    iput-object v0, v10, mPerUserService:Lcom/android/server/contentcapture/ContentCapturePerUserService;

    invoke-interface {p4}, Landroid/service/contentcapture/IContentCaptureServiceCallback;->asBinder()Landroid/os/IBinder;

    move-result-object v1

    iput-object v1, v10, mServerCallback:Landroid/os/IBinder;

    move/from16 v1, p9

    iput v1, v10, mIdleUnbindTimeoutMs:I

    invoke-virtual {p0}, ensureBoundLocked()V
...
.method public ensureBoundLocked()V
    ...
    invoke-virtual {p0}, scheduleBind()V
...
.method protected bridge synthetic getServiceInterface(Landroid/os/IBinder;)Landroid/os/IInterface;
    ...
    invoke-virtual {p0, p1}, getServiceInterface(Landroid/os/IBinder;)Landroid/service/contentcapture/IContentCaptureService;
...
.method protected getTimeoutIdleBindMillis()J
    ...
    iget v0, p0, mIdleUnbindTimeoutMs:I
...
.method protected handleOnConnectedStateChanged(Z)V
    ...
    invoke-virtual {p0}, getTimeoutIdleBindMillis()J
    ...
    invoke-virtual {p0}, scheduleUnbind()V
    ...
    iget-object v1, p0, mServerCallback:Landroid/os/IBinder;
    ...
    :try_start_1
    iget-object v0, p0, mPerUserService:Lcom/android/server/contentcapture/ContentCapturePerUserService;
    ...
    iget-object v1, p0, mPerUserService:Lcom/android/server/contentcapture/ContentCapturePerUserService;
...
.method public onActivityLifecycleEvent(Landroid/service/contentcapture/ActivityEvent;)V
    ...
    invoke-virtual {p0, v0}, scheduleAsyncRequest(Lcom/android/internal/infra/AbstractRemoteService$AsyncRequest;)V
...
.method public onSessionStarted(Landroid/view/contentcapture/ContentCaptureContext;IILcom/android/internal/os/IResultReceiver;I)V
    ...
    invoke-virtual {p0, v6}, scheduleAsyncRequest(Lcom/android/internal/infra/AbstractRemoteService$AsyncRequest;)V
