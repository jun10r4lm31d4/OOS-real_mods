...
.method constructor <init>(Ljava/lang/Object;Landroid/os/IBinder;Lcom/android/server/contentcapture/ContentCapturePerUserService;Landroid/content/ComponentName;Lcom/android/internal/os/IResultReceiver;IIIII)V
    ...
    iput-object v4, v1, mLock:Ljava/lang/Object;

    iput-object v2, v1, mActivityToken:Landroid/os/IBinder;

    move-object/from16 v11, p4

    iput-object v11, v1, appComponentName:Landroid/content/ComponentName;

    move-object/from16 v12, p3

    iput-object v12, v1, mService:Lcom/android/server/contentcapture/ContentCapturePerUserService;
    ...
    iput-object v14, v1, mContentCaptureContext:Landroid/view/contentcapture/ContentCaptureContext;

    move-object/from16 v5, p5

    iput-object v5, v1, mSessionStateReceiver:Lcom/android/internal/os/IResultReceiver;
...
.method private onClientDeath()V
    ...
    iget-object v0, p0, mService:Lcom/android/server/contentcapture/ContentCapturePerUserService;
    ...
    :try_start_0
    invoke-virtual {p0, v1}, removeSelfLocked(Z)V
...
.method public dumpLocked(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    iget-object v0, p0, mContentCaptureContext:Landroid/view/contentcapture/ContentCaptureContext;
    ...
    iget-object v0, p0, appComponentName:Landroid/content/ComponentName;
...
.method public synthetic lambda$new$0$ContentCaptureServerSession()V
    ...
    invoke-direct {p0}, onClientDeath()V
...
.method public notifySessionStartedLocked(Lcom/android/internal/os/IResultReceiver;)V
    ...
    iget-object v2, p0, mContentCaptureContext:Landroid/view/contentcapture/ContentCaptureContext;
...
.method public pauseLocked()V
    ...
    :cond_0
    iget-object v0, p0, mSessionStateReceiver:Lcom/android/internal/os/IResultReceiver;
...
.method public removeSelfLocked(Z)V
    ...
    :try_start_0
    invoke-virtual {p0, p1}, destroyLocked(Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget-object v1, p0, mService:Lcom/android/server/contentcapture/ContentCapturePerUserService;
...
.method public resurrectLocked()V
    ...
    iget-object v1, p0, mContentCaptureContext:Landroid/view/contentcapture/ContentCaptureContext;
    ...
    iget-object v5, p0, mSessionStateReceiver:Lcom/android/internal/os/IResultReceiver;
...
.method public setContentCaptureEnabledLocked(Z)V
    ...
    iget-object v1, p0, mSessionStateReceiver:Lcom/android/internal/os/IResultReceiver;
