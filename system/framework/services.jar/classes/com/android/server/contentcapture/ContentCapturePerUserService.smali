...
.method constructor <init>(Lcom/android/server/contentcapture/ContentCaptureManagerService;Ljava/lang/Object;ZI)V
    ...
    iput-object v0, p0, mRemoteServiceCallback:Lcom/android/server/contentcapture/ContentCapturePerUserService$ContentCaptureServiceRemoteCallback;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, mConditionsByPkg:Landroid/util/ArrayMap;

    invoke-direct {p0, p3}, updateRemoteServiceLocked(Z)V
...
.method static synthetic access$1400(Lcom/android/server/contentcapture/ContentCapturePerUserService;)Landroid/util/ArrayMap;
    ...
    iget-object v0, p0, mConditionsByPkg:Landroid/util/ArrayMap;
...
.method private resurrectSessionsLocked()V
    ...
    iget-object v3, p0, mRemoteService:Lcom/android/server/contentcapture/RemoteContentCaptureService;
...
.method private updateRemoteServiceLocked(Z)V
    ...
    :cond_0
    iget-object v0, p0, mRemoteService:Lcom/android/server/contentcapture/RemoteContentCaptureService;
    ...
    iput-object v0, p0, mRemoteService:Lcom/android/server/contentcapture/RemoteContentCaptureService;

    invoke-direct {p0}, resetContentCaptureWhitelistLocked()V

    :cond_2
    invoke-virtual {p0}, updateServiceInfoLocked()Landroid/content/ComponentName;
    ...
    iget-object v5, p0, mRemoteServiceCallback:Lcom/android/server/contentcapture/ContentCapturePerUserService$ContentCaptureServiceRemoteCallback;
    ...
    iput-object v11, p0, mRemoteService:Lcom/android/server/contentcapture/RemoteContentCaptureService;
...
.method protected dumpLocked(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    iget-object v1, p0, mInfo:Landroid/service/contentcapture/ContentCaptureServiceInfo;
    ...
    iget-boolean v1, p0, mZombie:Z

    invoke-virtual {p2, v1}, Ljava/io/PrintWriter;->println(Z)V

    iget-object v1, p0, mRemoteService:Lcom/android/server/contentcapture/RemoteContentCaptureService;
...
.method public getServiceSettingsActivityLocked()Landroid/content/ComponentName;
    ...
    iget-object v0, p0, mInfo:Landroid/service/contentcapture/ContentCaptureServiceInfo;
...
.method protected newServiceInfoLocked(Landroid/content/ComponentName;)Landroid/content/pm/ServiceInfo;
    ...
    invoke-virtual {p0}, isTemporaryServiceSetLocked()Z
    ...
    iput-object v0, p0, mInfo:Landroid/service/contentcapture/ContentCaptureServiceInfo;
...
.method onConnected()V
    ...
    iput-boolean v1, p0, mZombie:Z

    invoke-direct {p0}, resurrectSessionsLocked()V
...
.method onPackageUpdatedLocked()V
    ...
    invoke-direct {p0, v0}, updateRemoteServiceLocked(Z)V
...
.method public bridge synthetic onServiceDied(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, onServiceDied(Lcom/android/server/contentcapture/RemoteContentCaptureService;)V
...
.method public removeDataLocked(Landroid/view/contentcapture/DataRemovalRequest;)V
    ...
    invoke-direct {p0, v0}, assertCallerLocked(Ljava/lang/String;)V
...
.method public sendActivityAssistDataLocked(Landroid/os/IBinder;Landroid/os/Bundle;)Z
    ...
    invoke-direct {p0, p1}, getSessionId(Landroid/os/IBinder;)I
...
.method public startSessionLocked(Landroid/os/IBinder;Landroid/content/pm/ActivityPresentationInfo;IIILcom/android/internal/os/IResultReceiver;)V
    ...
    iget-object v1, v11, mMaster:Lcom/android/server/infra/AbstractMasterSystemService;
    ...
    invoke-virtual/range {p0 .. p0}, getServiceComponentName()Landroid/content/ComponentName;
    ...
    iget-object v3, v11, mMaster:Lcom/android/server/infra/AbstractMasterSystemService;
    ...
    iget-object v0, v11, mMaster:Lcom/android/server/infra/AbstractMasterSystemService;
    ...
    :cond_9
    iget-object v3, v11, mSessions:Landroid/util/SparseArray;
    ...
    iget-object v5, v11, mRemoteService:Lcom/android/server/contentcapture/RemoteContentCaptureService;

    if-nez v5, :cond_b

    invoke-direct {v11, v2}, updateRemoteServiceLocked(Z)V

    :cond_b
    iget-object v2, v11, mRemoteService:Lcom/android/server/contentcapture/RemoteContentCaptureService;
    ...
    :cond_d
    iget-object v1, v11, mSessions:Landroid/util/SparseArray;
...
.method protected updateLocked(Z)Z
    ...
    invoke-direct {p0, p1}, updateRemoteServiceLocked(Z)V
