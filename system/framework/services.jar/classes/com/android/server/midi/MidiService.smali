...
.method static constructor <clinit>()V
    ...
    sput-object v1, EMPTY_DEVICE_INFO_ARRAY:[Landroid/media/midi/MidiDeviceInfo;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mDevicesByInfo:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, mBluetoothDevices:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, mDevicesByServer:Ljava/util/HashMap;

    const/4 v0, 0x1

    iput v0, p0, mNextDeviceId:I
    ...
    iput v0, p0, mBluetoothServiceUid:I
...
.method static synthetic access$000(Lcom/android/server/midi/MidiService;)V
    ...
    invoke-direct {p0}, onUnlockUser()V
...
.method private addDeviceLocked(III[Ljava/lang/String;[Ljava/lang/String;Landroid/os/Bundle;Landroid/media/midi/IMidiDeviceServer;Landroid/content/pm/ServiceInfo;ZI)Landroid/media/midi/MidiDeviceInfo;
    ...
    iget v11, v7, mNextDeviceId:I

    add-int/lit8 v0, v11, 0x1

    iput v0, v7, mNextDeviceId:I
    ...
    iget-object v2, v7, mBluetoothDevices:Ljava/util/HashMap;
    ...
    :goto_2
    iget-object v0, v7, mDevicesByInfo:Ljava/util/HashMap;

    invoke-virtual {v0, v9, v1}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    if-eqz v13, :cond_4

    iget-object v0, v7, mBluetoothDevices:Ljava/util/HashMap;

    invoke-virtual {v0, v13, v1}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_4
    iget-object v2, v7, mClients:Ljava/util/HashMap;

    monitor-enter v2

    :try_start_1
    iget-object v0, v7, mClients:Ljava/util/HashMap;
...
.method private addPackageDeviceServer(Landroid/content/pm/ServiceInfo;)V
    ...
    :try_start_0
    iget-object v0, v12, mPackageManager:Landroid/content/pm/PackageManager;
    ...
    :try_start_5
    iget-object v7, v12, mDevicesByInfo:Ljava/util/HashMap;
...
.method private addPackageDeviceServers(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v3}, addPackageDeviceServer(Landroid/content/pm/ServiceInfo;)V
...
.method private onUnlockUser()V
    ...
    iput v3, p0, mBluetoothServiceUid:I
...
.method private removePackageDeviceServers(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v2}, removeDeviceLocked(Lcom/android/server/midi/MidiService$Device;)V
...
.method public getDevices()[Landroid/media/midi/MidiDeviceInfo;
    ...
    sget-object v2, EMPTY_DEVICE_INFO_ARRAY:[Landroid/media/midi/MidiDeviceInfo;
...
.method public openBluetoothDevice(Landroid/os/IBinder;Landroid/bluetooth/BluetoothDevice;Landroid/media/midi/IMidiDeviceOpenCallback;)V
    ...
    iget-object v3, p0, mBluetoothDevices:Ljava/util/HashMap;
...
.method public registerDeviceServer(Landroid/media/midi/IMidiDeviceServer;II[Ljava/lang/String;[Ljava/lang/String;Landroid/os/Bundle;I)Landroid/media/midi/MidiDeviceInfo;
    ...
    iget v0, v12, mBluetoothServiceUid:I
    ...
    :cond_3
    :goto_1
    iget-object v15, v12, mDevicesByInfo:Ljava/util/HashMap;
