...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/NsdService$NsdSettings;Landroid/os/Handler;Lcom/android/server/NsdService$DaemonConnectionSupplier;)V
    ...
    iput-object p2, p0, mNsdSettings:Lcom/android/server/NsdService$NsdSettings;
    ...
    iput-object v0, p0, mDaemonCallback:Lcom/android/server/NsdService$NativeCallbackReceiver;

    iget-object v0, p0, mDaemonCallback:Lcom/android/server/NsdService$NativeCallbackReceiver;
    ...
    iput-object v0, p0, mDaemon:Lcom/android/server/NsdService$DaemonConnection;
...
.method static synthetic access$100(Lcom/android/server/NsdService;Z)V
    ...
    invoke-direct {p0, p1}, notifyEnabled(Z)V
...
.method static synthetic access$200(Lcom/android/server/NsdService;)Lcom/android/server/NsdService$NsdSettings;
    ...
    iget-object v0, p0, mNsdSettings:Lcom/android/server/NsdService$NsdSettings;
...
.method static synthetic access$600(Lcom/android/server/NsdService;)Lcom/android/server/NsdService$DaemonConnection;
    ...
    iget-object v0, p0, mDaemon:Lcom/android/server/NsdService$DaemonConnection;
...
.method public static create(Landroid/content/Context;)Lcom/android/server/NsdService;
    ...
    invoke-direct {v3, p0, v0, v2, v4}, <init>(Landroid/content/Context;Lcom/android/server/NsdService$NsdSettings;Landroid/os/Handler;Lcom/android/server/NsdService$DaemonConnectionSupplier;)V

    iget-object v4, v3, mDaemonCallback:Lcom/android/server/NsdService$NativeCallbackReceiver;
...
.method private registerService(ILandroid/net/nsd/NsdServiceInfo;)Z
    ...
    iget-object v6, p0, mDaemon:Lcom/android/server/NsdService$DaemonConnection;
...
.method private resolveService(ILandroid/net/nsd/NsdServiceInfo;)Z
    ...
    iget-object v2, p0, mDaemon:Lcom/android/server/NsdService$DaemonConnection;
...
.method private updateService(ILandroid/net/nsd/DnsSdTxtRecord;)Z
    ...
    :cond_0
    iget-object v1, p0, mDaemon:Lcom/android/server/NsdService$DaemonConnection;
