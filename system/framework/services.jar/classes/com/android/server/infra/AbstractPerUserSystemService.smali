...
.method protected constructor <init>(Lcom/android/server/infra/AbstractMasterSystemService;Ljava/lang/Object;I)V
    ...
    iput-object p1, p0, mMaster:Lcom/android/server/infra/AbstractMasterSystemService;
...
.method protected dumpLocked(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    invoke-virtual {p0}, getServiceLabelLocked()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0}, getTargedSdkLocked()I
...
.method public final getServicePackageName()Ljava/lang/String;
    ...
    invoke-virtual {p0}, getServiceComponentName()Landroid/content/ComponentName;
...
.method protected updateLocked(Z)Z
    ...
    iget-boolean v3, p0, mDisabled:Z
    ...
    iput-boolean v2, p0, mSetupComplete:Z
...
.method protected final updateServiceInfoLocked()Landroid/content/ComponentName;
    ...
    :try_start_1
    invoke-virtual {p0, v0}, newServiceInfoLocked(Landroid/content/ComponentName;)Landroid/content/pm/ServiceInfo;

    move-result-object v5

    iput-object v5, p0, mServiceInfo:Landroid/content/pm/ServiceInfo;

    iget-object v5, p0, mMaster:Lcom/android/server/infra/AbstractMasterSystemService;
    ...
    iget-object v7, p0, mServiceInfo:Landroid/content/pm/ServiceInfo;
    ...
    :cond_2
    iput-object v3, p0, mServiceInfo:Landroid/content/pm/ServiceInfo;
