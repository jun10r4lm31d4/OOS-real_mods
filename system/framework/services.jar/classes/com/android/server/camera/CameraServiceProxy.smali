...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mActiveCameraUsage:Landroid/util/ArrayMap;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mCameraUsageHistory:Ljava/util/List;

    new-instance v0, Lcom/android/internal/logging/MetricsLogger;

    invoke-direct {v0}, Lcom/android/internal/logging/MetricsLogger;-><init>()V

    iput-object v0, p0, mLogger:Lcom/android/internal/logging/MetricsLogger;
    ...
    iput-object v0, p0, mCameraServiceProxy:Landroid/hardware/ICameraServiceProxy$Stub;
    ...
    :cond_0
    iput-boolean v1, p0, mNotifyNfc:Z
...
.method static synthetic access$600(I)Ljava/lang/String;
    ...
    invoke-static {p0}, cameraFacingToString(I)Ljava/lang/String;
...
.method static synthetic access$700(Lcom/android/server/camera/CameraServiceProxy;Ljava/lang/String;IILjava/lang/String;I)V
    ...
    invoke-direct/range {p0 .. p5}, updateActivityCount(Ljava/lang/String;IILjava/lang/String;I)V
...
.method private notifyCameraserverLocked(ILjava/util/Set;)Z
    ...
    iget-object v0, p0, mCameraServiceRaw:Landroid/hardware/ICameraService;
    ...
    invoke-virtual {p0, v0}, getBinderService(Ljava/lang/String;)Landroid/os/IBinder;
...
.method private notifySwitchWithRetries(I)V
    ...
    :try_start_0
    invoke-direct {p0, p1}, notifySwitchWithRetriesLocked(I)V
...
.method private notifySwitchWithRetriesLocked(I)V
    ...
    invoke-direct {p0, v1, v0}, notifyCameraserverLocked(ILjava/util/Set;)Z
...
.method private switchUserLocked(I)V
    ...
    invoke-direct {p0, v1}, notifySwitchWithRetriesLocked(I)V
...
.method private updateActivityCount(Ljava/lang/String;IILjava/lang/String;I)V
    ...
    :try_start_0
    iget-object v1, p0, mActiveCameraUsage:Landroid/util/ArrayMap;
    ...
    :cond_0
    iget-object v4, p0, mActiveCameraUsage:Landroid/util/ArrayMap;
    ...
    iget-object v5, p0, mCameraUsageHistory:Ljava/util/List;
    ...
    invoke-virtual {p0}, dumpUsageEvents()V
    ...
    :goto_0
    iget-object v7, p0, mActiveCameraUsage:Landroid/util/ArrayMap;
    ...
    :goto_2
    iget-object v6, p0, mActiveCameraUsage:Landroid/util/ArrayMap;
    ...
    iget-object v7, p0, mCameraUsageHistory:Ljava/util/List;
    ...
    iget-boolean v5, p0, mNotifyNfc:Z

    if-eqz v5, :cond_c

    if-eq v1, v4, :cond_c

    invoke-direct {p0, v4}, notifyNfcService(Z)V
    ...
    :cond_d
    invoke-direct {p0, v2}, notifyColorGamutEnhance(Z)V
...
.method public binderDied()V
    ...
    iget-object v2, p0, mActiveCameraUsage:Landroid/util/ArrayMap;
    ...
    invoke-direct {p0, v2}, notifyNfcService(Z)V
...
.method dumpUsageEvents()V
    ...
    :try_start_0
    iget-object v1, p0, mCameraUsageHistory:Ljava/util/List;
    ...
    iget-object v5, p0, mLogger:Lcom/android/internal/logging/MetricsLogger;
...
.method public onStart()V
    ...
    iget-object v1, p0, mCameraServiceProxy:Landroid/hardware/ICameraServiceProxy$Stub;
    ...
    invoke-virtual {p0, v1, p0}, publishLocalService(Ljava/lang/Class;Ljava/lang/Object;)V
