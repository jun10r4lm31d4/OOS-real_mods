...
.method static constructor <clinit>()V
    ...
    sput-wide v0, NATIVE_CRASH_POLLING_INTERVAL_MILLIS:J
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mPendingStagedRollbackIds:Ljava/util/Set;

    iput-object p1, p0, mContext:Landroid/content/Context;

    const-wide/16 v0, 0xa

    iput-wide v0, p0, mNumberOfNativeCrashPollsRemaining:J
    ...
    iput-object v2, p0, mLastStagedRollbackIdFile:Ljava/io/File;
...
.method static synthetic access$000(Lcom/android/server/rollback/RollbackPackageHealthObserver;Landroid/content/rollback/RollbackManager;ILandroid/content/BroadcastReceiver;Landroid/content/pm/VersionedPackage;)V
    ...
    invoke-direct {p0, p1, p2, p3, p4}, handleStagedSessionChange(Landroid/content/rollback/RollbackManager;ILandroid/content/BroadcastReceiver;Landroid/content/pm/VersionedPackage;)V
...
.method private checkAndMitigateNativeCrashes()V
    ...
    iget-wide v0, p0, mNumberOfNativeCrashPollsRemaining:J
    ...
    invoke-direct {p0}, getModuleMetadataPackage()Landroid/content/pm/VersionedPackage;

    move-result-object v0

    invoke-virtual {p0, v0}, execute(Landroid/content/pm/VersionedPackage;)Z
    ...
    sget-wide v2, NATIVE_CRASH_POLLING_INTERVAL_MILLIS:J
...
.method private getModuleMetadataPackage()Landroid/content/pm/VersionedPackage;
    ...
    invoke-direct {p0}, getModuleMetadataPackageName()Ljava/lang/String;
...
.method private handleStagedSessionChange(Landroid/content/rollback/RollbackManager;ILandroid/content/BroadcastReceiver;Landroid/content/pm/VersionedPackage;)V
    ...
    invoke-direct {p0, p2}, markStagedSessionHandled(I)Z
    ...
    invoke-direct {p0, p2}, saveLastStagedRollbackId(I)V

    const/4 v6, 0x4

    invoke-static {p4, v6}, logEvent(Landroid/content/pm/VersionedPackage;I)V
...
.method private markStagedSessionHandled(I)Z
    ...
    iget-object v0, p0, mPendingStagedRollbackIds:Ljava/util/Set;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, mPendingStagedRollbackIds:Ljava/util/Set;
...
.method private onBootCompleted()V
    ...
    invoke-direct {p0, v0, v3}, getAvailableRollback(Landroid/content/rollback/RollbackManager;Landroid/content/pm/VersionedPackage;)Landroid/content/rollback/RollbackInfo;

    move-result-object v4

    if-eqz v4, :cond_0

    invoke-direct {p0}, scheduleCheckAndMitigateNativeCrashes()V

    :cond_0
    invoke-direct {p0}, popLastStagedRollbackId()I
    ...
    invoke-static {v7, v6}, logEvent(Landroid/content/pm/VersionedPackage;I)V
...
.method private popLastStagedRollbackId()I
    ...
    iget-object v1, p0, mLastStagedRollbackIdFile:Ljava/io/File;
...
.method private scheduleCheckAndMitigateNativeCrashes()V
    ...
    iget-wide v1, p0, mNumberOfNativeCrashPollsRemaining:J
...
.method public execute(Landroid/content/pm/VersionedPackage;)Z
    ...
    invoke-direct {p0, v0, p1}, getAvailableRollback(Landroid/content/rollback/RollbackManager;Landroid/content/pm/VersionedPackage;)Landroid/content/rollback/RollbackInfo;
    ...
    invoke-static {v1, v3}, logEvent(Landroid/content/pm/VersionedPackage;I)V
...
.method public synthetic lambda$checkAndMitigateNativeCrashes$3$RollbackPackageHealthObserver()V
    ...
    invoke-direct {p0}, checkAndMitigateNativeCrashes()V
...
.method public synthetic lambda$execute$0$RollbackPackageHealthObserver(Landroid/content/rollback/RollbackInfo;Landroid/content/rollback/RollbackManager;Landroid/content/pm/VersionedPackage;Landroid/content/Intent;)V
    ...
    iget-object v2, p0, mPendingStagedRollbackIds:Ljava/util/Set;

    monitor-enter v2

    :try_start_0
    iget-object v3, p0, mPendingStagedRollbackIds:Ljava/util/Set;
    ...
    invoke-direct {p0, p2, v1, p3}, listenForStagedSessionReady(Landroid/content/rollback/RollbackManager;ILandroid/content/pm/VersionedPackage;)Landroid/content/BroadcastReceiver;

    move-result-object v2

    invoke-direct {p0, p2, v1, v2, p3}, handleStagedSessionChange(Landroid/content/rollback/RollbackManager;ILandroid/content/BroadcastReceiver;Landroid/content/pm/VersionedPackage;)V
    ...
    invoke-static {p3, v1}, logEvent(Landroid/content/pm/VersionedPackage;I)V
...
.method public synthetic lambda$onBootCompletedAsync$2$RollbackPackageHealthObserver()V
    ...
    invoke-direct {p0}, onBootCompleted()V
