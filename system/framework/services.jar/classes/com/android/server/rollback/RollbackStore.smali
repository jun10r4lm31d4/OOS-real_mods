...
.method constructor <init>(Ljava/io/File;)V
    ...
    iput-object p1, p0, mRollbackDataDir:Ljava/io/File;
...
.method static deletePackageCodePaths(Lcom/android/server/rollback/RollbackData;)V
    ...
    invoke-static {v2}, removeFile(Ljava/io/File;)V
...
.method private static loadRollbackData(Ljava/io/File;)Lcom/android/server/rollback/RollbackData;
    ...
    invoke-static {v2}, rollbackInfoFromJson(Lorg/json/JSONObject;)Landroid/content/rollback/RollbackInfo;
...
.method private static packageRollbackInfoFromJson(Lorg/json/JSONObject;)Landroid/content/rollback/PackageRollbackInfo;
    ...
    invoke-static {v1}, versionedPackageFromJson(Lorg/json/JSONObject;)Landroid/content/pm/VersionedPackage;
    ...
    invoke-static {v2}, versionedPackageFromJson(Lorg/json/JSONObject;)Landroid/content/pm/VersionedPackage;
    ...
    invoke-static {v2}, convertToIntArray(Lorg/json/JSONArray;)Landroid/util/IntArray;
    ...
    invoke-static {v2}, convertToRestoreInfoArray(Lorg/json/JSONArray;)Ljava/util/ArrayList;
    ...
    invoke-static {v2}, ceSnapshotInodesFromJson(Lorg/json/JSONArray;)Landroid/util/SparseLongArray;
...
.method private static packageRollbackInfosFromJson(Lorg/json/JSONArray;)Ljava/util/List;
    ...
    invoke-static {v2}, packageRollbackInfoFromJson(Lorg/json/JSONObject;)Landroid/content/rollback/PackageRollbackInfo;
...
.method private static removeFile(Ljava/io/File;)V
    ...
    invoke-static {v3}, removeFile(Ljava/io/File;)V
...
.method private static rollbackInfoFromJson(Lorg/json/JSONObject;)Landroid/content/rollback/RollbackInfo;
    ...
    invoke-static {v0}, packageRollbackInfosFromJson(Lorg/json/JSONArray;)Ljava/util/List;
    ...
    invoke-static {v0}, versionedPackagesFromJson(Lorg/json/JSONArray;)Ljava/util/List;
...
.method private static rollbackInfoToJson(Landroid/content/rollback/RollbackInfo;)Lorg/json/JSONObject;
    ...
    invoke-static {v1}, toJson(Ljava/util/List;)Lorg/json/JSONArray;
    ...
    invoke-static {v1}, versionedPackagesToJson(Ljava/util/List;)Lorg/json/JSONArray;
...
.method private static toJson(Ljava/util/List;)Lorg/json/JSONArray;
    ...
    invoke-static {v2}, toJson(Landroid/content/rollback/PackageRollbackInfo;)Lorg/json/JSONObject;
...
.method private static toJson(Landroid/content/rollback/PackageRollbackInfo;)Lorg/json/JSONObject;
    ...
    invoke-static {v1}, toJson(Landroid/content/pm/VersionedPackage;)Lorg/json/JSONObject;
    ...
    invoke-static {v1}, convertToJsonArray(Landroid/util/IntArray;)Lorg/json/JSONArray;
    ...
    invoke-static {v2}, convertToJsonArray(Ljava/util/List;)Lorg/json/JSONArray;
    ...
    invoke-static {v3}, convertToJsonArray(Landroid/util/IntArray;)Lorg/json/JSONArray;
    ...
    invoke-static {v4}, ceSnapshotInodesToJson(Landroid/util/SparseLongArray;)Lorg/json/JSONArray;
...
.method private static versionedPackagesToJson(Ljava/util/List;)Lorg/json/JSONArray;
    ...
    invoke-static {v2}, toJson(Landroid/content/pm/VersionedPackage;)Lorg/json/JSONObject;
...
.method createNonStagedRollback(I)Lcom/android/server/rollback/RollbackData;
    ...
    iget-object v1, p0, mRollbackDataDir:Ljava/io/File;
...
.method deleteRollbackData(Lcom/android/server/rollback/RollbackData;)V
    ...
    invoke-static {v0}, removeFile(Ljava/io/File;)V
...
.method loadAllRollbackData()Ljava/util/List;
    ...
    :try_start_0
    invoke-static {v4}, loadRollbackData(Ljava/io/File;)Lcom/android/server/rollback/RollbackData;
    ...
    invoke-static {v4}, removeFile(Ljava/io/File;)V
...
.method saveRollbackData(Lcom/android/server/rollback/RollbackData;)V
    ...
    invoke-static {v2}, rollbackInfoToJson(Landroid/content/rollback/RollbackInfo;)Lorg/json/JSONObject;
