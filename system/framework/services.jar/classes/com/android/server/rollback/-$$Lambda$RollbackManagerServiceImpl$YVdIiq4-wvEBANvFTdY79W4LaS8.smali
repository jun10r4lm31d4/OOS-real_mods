...
.method public synthetic constructor <init>(Lcom/android/server/rollback/RollbackManagerServiceImpl;Landroid/content/Intent;Lcom/android/server/rollback/RollbackData;Landroid/content/IntentSender;ILjava/util/List;)V
    ...
    iput-object p1, p0, f$0:Lcom/android/server/rollback/RollbackManagerServiceImpl;

    iput-object p2, p0, f$1:Landroid/content/Intent;

    iput-object p3, p0, f$2:Lcom/android/server/rollback/RollbackData;

    iput-object p4, p0, f$3:Landroid/content/IntentSender;

    iput p5, p0, f$4:I

    iput-object p6, p0, f$5:Ljava/util/List;
...
.method public final run()V
    ...
    iget-object v0, p0, f$0:Lcom/android/server/rollback/RollbackManagerServiceImpl;

    iget-object v1, p0, f$1:Landroid/content/Intent;

    iget-object v2, p0, f$2:Lcom/android/server/rollback/RollbackData;

    iget-object v3, p0, f$3:Landroid/content/IntentSender;

    iget v4, p0, f$4:I

    iget-object v5, p0, f$5:Ljava/util/List;
