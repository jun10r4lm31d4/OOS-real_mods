...
.method constructor <init>(ILjava/io/File;I)V
    ...
    iput v0, p0, apkSessionId:I

    const/4 v1, 0x0

    iput-boolean v1, p0, restoreUserDataInProgress:Z
    ...
    iput-object v8, p0, info:Landroid/content/rollback/RollbackInfo;

    iput-object p2, p0, backupDir:Ljava/io/File;

    iput p3, p0, stagedSessionId:I
    ...
    iput-object v0, p0, timestamp:Ljava/time/Instant;
...
.method constructor <init>(Landroid/content/rollback/RollbackInfo;Ljava/io/File;Ljava/time/Instant;IIIZ)V
    ...
    iput-boolean v0, p0, restoreUserDataInProgress:Z

    iput-object p1, p0, info:Landroid/content/rollback/RollbackInfo;

    iput-object p2, p0, backupDir:Ljava/io/File;

    iput-object p3, p0, timestamp:Ljava/time/Instant;

    iput p4, p0, stagedSessionId:I

    iput p5, p0, state:I

    iput p6, p0, apkSessionId:I

    iput-boolean p7, p0, restoreUserDataInProgress:Z
...
.method public getStateAsString()Ljava/lang/String;
    ...
    invoke-static {v0}, rollbackStateToString(I)Ljava/lang/String;
...
.method public isStaged()Z
    ...
    iget-object v0, p0, info:Landroid/content/rollback/RollbackInfo;
