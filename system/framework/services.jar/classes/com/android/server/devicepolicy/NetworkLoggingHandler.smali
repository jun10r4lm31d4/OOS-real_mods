...
.method constructor <init>(Landroid/os/Looper;Lcom/android/server/devicepolicy/DevicePolicyManagerService;)V
    ...
    invoke-direct {p0, p1, p2, v0, v1}, <init>(Landroid/os/Looper;Lcom/android/server/devicepolicy/DevicePolicyManagerService;J)V
...
.method constructor <init>(Landroid/os/Looper;Lcom/android/server/devicepolicy/DevicePolicyManagerService;J)V
    ...
    iput-wide v0, p0, mLastFinalizationNanos:J
    ...
    iput-object v0, p0, mBatchTimeoutAlarmListener:Landroid/app/AlarmManager$OnAlarmListener;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mNetworkEvents:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, mBatches:Landroid/util/LongSparseArray;

    const/4 v0, 0x0

    iput-boolean v0, p0, mPaused:Z

    iput-object p2, p0, mDpm:Lcom/android/server/devicepolicy/DevicePolicyManagerService;

    iget-object v0, p0, mDpm:Lcom/android/server/devicepolicy/DevicePolicyManagerService;
...
.method static synthetic access$100(Lcom/android/server/devicepolicy/NetworkLoggingHandler;)Ljava/util/ArrayList;
    ...
    iget-object v0, p0, mNetworkEvents:Ljava/util/ArrayList;
...
.method static synthetic access$200(Lcom/android/server/devicepolicy/NetworkLoggingHandler;)Landroid/os/Bundle;
    ...
    invoke-direct {p0}, finalizeBatchAndBuildDeviceOwnerMessageLocked()Landroid/os/Bundle;
...
.method static synthetic access$300(Lcom/android/server/devicepolicy/NetworkLoggingHandler;Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, p1}, notifyDeviceOwner(Landroid/os/Bundle;)V
...
.method private buildDeviceOwnerMessageLocked()Landroid/os/Bundle;
    ...
    iget-object v1, p0, mBatches:Landroid/util/LongSparseArray;
    ...
    iget-wide v2, p0, mCurrentBatchToken:J
...
.method private finalizeBatchAndBuildDeviceOwnerMessageLocked()Landroid/os/Bundle;
    ...
    iget-object v1, p0, mNetworkEvents:Ljava/util/ArrayList;
    ...
    iget-wide v5, p0, mCurrentBatchToken:J
    ...
    :cond_2
    iget-wide v1, p0, mCurrentBatchToken:J

    add-long/2addr v1, v3

    iput-wide v1, p0, mCurrentBatchToken:J

    iget-object v1, p0, mBatches:Landroid/util/LongSparseArray;

    iget-wide v2, p0, mCurrentBatchToken:J

    iget-object v4, p0, mNetworkEvents:Ljava/util/ArrayList;
    ...
    iput-object v1, p0, mNetworkEvents:Ljava/util/ArrayList;

    iget-boolean v1, p0, mPaused:Z

    if-nez v1, :cond_4

    invoke-direct {p0}, buildDeviceOwnerMessageLocked()Landroid/os/Bundle;
    ...
    iget-wide v3, p0, mCurrentBatchToken:J
    ...
    :cond_4
    :goto_2
    invoke-virtual {p0}, scheduleBatchFinalization()V
...
.method declared-synchronized discardLogs()V
    ...
    :try_start_0
    iget-object v0, p0, mBatches:Landroid/util/LongSparseArray;
...
.method forceBatchFinalization()J
    ...
    :try_start_0
    iget-wide v0, p0, mLastFinalizationNanos:J

    sget-wide v2, FORCE_FETCH_THROTTLE_NS:J
    ...
    invoke-direct {p0, v0}, notifyDeviceOwner(Landroid/os/Bundle;)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    :try_start_0
    iget-object v2, p0, mNetworkEvents:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v1}, notifyDeviceOwner(Landroid/os/Bundle;)V
...
.method resume()V
    ...
    iget-wide v3, p0, mLastRetrievedBatchToken:J
    ...
    iget-wide v1, p0, mLastRetrievedBatchToken:J
...
.method declared-synchronized retrieveFullLogBatch(J)Ljava/util/List;
    ...
    iput-wide p1, p0, mLastRetrievedBatchToken:J
...
.method scheduleBatchFinalization()V
    ...
    iget-object v11, p0, mBatchTimeoutAlarmListener:Landroid/app/AlarmManager$OnAlarmListener;
