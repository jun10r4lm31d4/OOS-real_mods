...
.method static constructor <clinit>()V
    ...
    sput v0, DEF_ORGANIZATION_COLOR:I
...
.method constructor <init>(Landroid/app/admin/DeviceAdminInfo;Z)V
    ...
    iput v0, p0, passwordHistoryLength:I
    ...
    iput-object v10, p0, minimumPasswordMetrics:Landroid/app/admin/PasswordMetrics;

    const-wide/16 v1, 0x0

    iput-wide v1, p0, maximumTimeToUnlock:J

    iput-wide v1, p0, strongAuthUnlockTimeout:J

    iput v0, p0, maximumFailedPasswordsForWipe:I

    iput-wide v1, p0, passwordExpirationTimeout:J

    iput-wide v1, p0, passwordExpirationDate:J

    iput v0, p0, disabledKeyguardFeatures:I

    iput-boolean v0, p0, encryptionRequested:Z

    iput-boolean v0, p0, testOnlyAdmin:Z

    iput-boolean v0, p0, disableCamera:Z

    iput-boolean v0, p0, disableCallerId:Z

    iput-boolean v0, p0, disableContactsSearch:Z

    const/4 v3, 0x1

    iput-boolean v3, p0, disableBluetoothContactSharing:Z

    iput-boolean v0, p0, disableScreenCapture:Z

    iput-boolean v0, p0, requireAutoTime:Z

    iput-boolean v0, p0, forceEphemeralUsers:Z

    iput-boolean v0, p0, isNetworkLoggingEnabled:Z

    iput-boolean v0, p0, isLogoutEnabled:Z

    iput v0, p0, numNetworkLoggingNotifications:I

    iput-wide v1, p0, lastNetworkLoggingNotificationTimeMs:J

    new-instance v1, Landroid/util/ArraySet;

    invoke-direct {v1}, Landroid/util/ArraySet;-><init>()V

    iput-object v1, p0, accountTypesWithManagementDisabled:Ljava/util/Set;

    iput-boolean v0, p0, specifiesGlobalProxy:Z

    const/4 v0, 0x0

    iput-object v0, p0, globalProxySpec:Ljava/lang/String;

    iput-object v0, p0, globalProxyExclusionList:Ljava/lang/String;

    new-instance v1, Landroid/util/ArrayMap;

    invoke-direct {v1}, Landroid/util/ArrayMap;-><init>()V

    iput-object v1, p0, trustAgentInfos:Landroid/util/ArrayMap;

    new-instance v1, Landroid/util/ArraySet;

    invoke-direct {v1}, Landroid/util/ArraySet;-><init>()V

    iput-object v1, p0, defaultEnabledRestrictionsAlreadySet:Ljava/util/Set;

    iput-object v0, p0, shortSupportMessage:Ljava/lang/CharSequence;

    iput-object v0, p0, longSupportMessage:Ljava/lang/CharSequence;

    sget v1, DEF_ORGANIZATION_COLOR:I

    iput v1, p0, organizationColor:I

    iput-object v0, p0, organizationName:Ljava/lang/String;

    iput-object v0, p0, startUserSessionMessage:Ljava/lang/String;

    iput-object v0, p0, endUserSessionMessage:Ljava/lang/String;

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object v0

    iput-object v0, p0, mCrossProfileCalendarPackages:Ljava/util/List;

    iput-object p1, p0, info:Landroid/app/admin/DeviceAdminInfo;

    iput-boolean p2, p0, isParent:Z
...
.method dump(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    iget-boolean v0, p0, testOnlyAdmin:Z
    ...
    iget-object v2, p0, minimumPasswordMetrics:Landroid/app/admin/PasswordMetrics;
    ...
    iget-wide v2, p0, strongAuthUnlockTimeout:J
    ...
    iget-boolean v2, p0, disableContactsSearch:Z
    ...
    iget-boolean v2, p0, forceEphemeralUsers:Z
    ...
    iget-boolean v2, p0, isNetworkLoggingEnabled:Z
    ...
    :cond_4
    iget-object v2, p0, permittedNotificationListeners:Ljava/util/List;
    ...
    :cond_5
    iget-object v2, p0, keepUninstalledPackages:Ljava/util/List;
    ...
    iget v2, p0, organizationColor:I

    invoke-virtual {p2, v2}, Ljava/io/PrintWriter;->println(I)V

    iget-object v2, p0, organizationName:Ljava/lang/String;
    ...
    iget-object v3, p0, userRestrictions:Landroid/os/Bundle;
    ...
    iget-object v2, p0, defaultEnabledRestrictionsAlreadySet:Ljava/util/Set;
    ...
    iget-boolean v2, p0, isParent:Z

    invoke-virtual {p2, v2}, Ljava/io/PrintWriter;->println(Z)V

    iget-object v2, p0, parentAdmin:Lcom/android/server/devicepolicy/DevicePolicyManagerService$ActiveAdmin;
    ...
    invoke-virtual {v2, v1, p2}, dump(Ljava/lang/String;Ljava/io/PrintWriter;)V

    :cond_8
    iget-object v1, p0, mCrossProfileCalendarPackages:Ljava/util/List;
...
.method ensureUserRestrictions()Landroid/os/Bundle;
    ...
    iget-object v0, p0, userRestrictions:Landroid/os/Bundle;
    ...
    iput-object v0, p0, userRestrictions:Landroid/os/Bundle;
...
.method getParentActiveAdmin()Lcom/android/server/devicepolicy/DevicePolicyManagerService$ActiveAdmin;
    ...
    iget-object v0, p0, parentAdmin:Lcom/android/server/devicepolicy/DevicePolicyManagerService$ActiveAdmin;
    ...
    invoke-direct {v0, v2, v1}, <init>(Landroid/app/admin/DeviceAdminInfo;Z)V

    iput-object v0, p0, parentAdmin:Lcom/android/server/devicepolicy/DevicePolicyManagerService$ActiveAdmin;
...
.method readFromXml(Lorg/xmlpull/v1/XmlPullParser;Z)V
    ...
    iget-object v1, p0, minimumPasswordMetrics:Landroid/app/admin/PasswordMetrics;
    ...
    iput-wide v5, p0, maximumTimeToUnlock:J
    ...
    iput-wide v5, p0, strongAuthUnlockTimeout:J
    ...
    iput-object v1, p0, globalProxySpec:Ljava/lang/String;
    ...
    iput-object v1, p0, globalProxyExclusionList:Ljava/lang/String;
    ...
    iput-wide v5, p0, passwordExpirationTimeout:J
    ...
    iput-wide v5, p0, passwordExpirationDate:J
    ...
    iput-boolean v1, p0, testOnlyAdmin:Z
    ...
    iput-boolean v1, p0, disableContactsSearch:Z
    ...
    iput-boolean v1, p0, disableBluetoothContactSharing:Z
    ...
    iput-boolean v1, p0, forceEphemeralUsers:Z
    ...
    iput-boolean v1, p0, isNetworkLoggingEnabled:Z
    ...
    iput-wide v5, p0, lastNetworkLoggingNotificationTimeMs:J
    ...
    iput v1, p0, numNetworkLoggingNotifications:I
    ...
    iget-object v1, p0, accountTypesWithManagementDisabled:Ljava/util/Set;

    const-string v3, "account-type"

    invoke-direct {p0, p1, v3, v1}, readAttributeValues(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;Ljava/util/Collection;)V
    ...
    invoke-direct {p0, p1, v4}, getAllTrustAgentInfos(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Landroid/util/ArrayMap;
    ...
    iput-object v1, p0, crossProfileWidgetProviders:Ljava/util/List;

    iget-object v1, p0, crossProfileWidgetProviders:Ljava/util/List;
    ...
    iput-object v1, p0, permittedAccessiblityServices:Ljava/util/List;
    ...
    iput-object v1, p0, permittedInputMethods:Ljava/util/List;
    ...
    iput-object v1, p0, permittedNotificationListeners:Ljava/util/List;
    ...
    iput-object v1, p0, keepUninstalledPackages:Ljava/util/List;
    ...
    iput-object v1, p0, meteredDisabledPackages:Ljava/util/List;
    ...
    iput-object v1, p0, userRestrictions:Landroid/os/Bundle;
    ...
    iget-object v1, p0, defaultEnabledRestrictionsAlreadySet:Ljava/util/Set;
    ...
    iput-object v1, p0, shortSupportMessage:Ljava/lang/CharSequence;
    ...
    iput-object v1, p0, longSupportMessage:Ljava/lang/CharSequence;
    ...
    iget-object v5, p0, info:Landroid/app/admin/DeviceAdminInfo;

    invoke-direct {v1, v5, v3}, <init>(Landroid/app/admin/DeviceAdminInfo;Z)V

    iput-object v1, p0, parentAdmin:Lcom/android/server/devicepolicy/DevicePolicyManagerService$ActiveAdmin;

    iget-object v1, p0, parentAdmin:Lcom/android/server/devicepolicy/DevicePolicyManagerService$ActiveAdmin;

    invoke-virtual {v1, p1, p2}, readFromXml(Lorg/xmlpull/v1/XmlPullParser;Z)V
    ...
    iput-object v1, p0, organizationName:Ljava/lang/String;
    ...
    iput-boolean v1, p0, isLogoutEnabled:Z
    ...
    iput-object v1, p0, startUserSessionMessage:Ljava/lang/String;
    ...
    iput-object v1, p0, endUserSessionMessage:Ljava/lang/String;
    ...
    iput-object v1, p0, mCrossProfileCalendarPackages:Ljava/util/List;
    ...
    iput-object v8, p0, mCrossProfileCalendarPackages:Ljava/util/List;
...
.method public transfer(Landroid/app/admin/DeviceAdminInfo;)V
    ...
    invoke-virtual {p0}, hasParentActiveAdmin()Z
    ...
    iput-object p1, v0, info:Landroid/app/admin/DeviceAdminInfo;
...
.method writePackageListToXml(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-virtual {p0, p1, v1, p3}, writeAttributeValuesToXml(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;Ljava/util/Collection;)V
...
.method writeToXml(Lorg/xmlpull/v1/XmlSerializer;)V
    ...
    iget-object v0, p0, minimumPasswordMetrics:Landroid/app/admin/PasswordMetrics;
    ...
    iget-object v3, p0, minimumPasswordMetrics:Landroid/app/admin/PasswordMetrics;
    ...
    :cond_0
    iget v0, p0, passwordHistoryLength:I
    ...
    iget v3, p0, passwordHistoryLength:I
    ...
    :cond_7
    iget-wide v3, p0, maximumTimeToUnlock:J
    ...
    :cond_8
    iget-wide v3, p0, strongAuthUnlockTimeout:J
    ...
    :cond_9
    iget v0, p0, maximumFailedPasswordsForWipe:I
    ...
    iget v3, p0, maximumFailedPasswordsForWipe:I
    ...
    :cond_a
    iget-boolean v0, p0, specifiesGlobalProxy:Z
    ...
    iget-boolean v3, p0, specifiesGlobalProxy:Z
    ...
    iget-object v0, p0, globalProxySpec:Ljava/lang/String;
    ...
    :cond_b
    iget-object v0, p0, globalProxyExclusionList:Ljava/lang/String;
    ...
    :cond_c
    iget-wide v3, p0, passwordExpirationTimeout:J
    ...
    :cond_d
    iget-wide v3, p0, passwordExpirationDate:J
    ...
    :cond_e
    iget-boolean v0, p0, encryptionRequested:Z
    ...
    :cond_10
    iget-boolean v0, p0, disableCamera:Z
    ...
    :cond_11
    iget-boolean v0, p0, disableCallerId:Z
    ...
    :cond_12
    iget-boolean v0, p0, disableContactsSearch:Z
    ...
    :cond_13
    iget-boolean v0, p0, disableBluetoothContactSharing:Z
    ...
    :cond_14
    iget-boolean v0, p0, disableScreenCapture:Z
    ...
    :cond_15
    iget-boolean v0, p0, requireAutoTime:Z
    ...
    :cond_16
    iget-boolean v0, p0, forceEphemeralUsers:Z
    ...
    :cond_17
    iget-boolean v0, p0, isNetworkLoggingEnabled:Z
    ...
    iget v0, p0, numNetworkLoggingNotifications:I
    ...
    iget-wide v3, p0, lastNetworkLoggingNotificationTimeMs:J
    ...
    :cond_18
    iget v0, p0, disabledKeyguardFeatures:I
    ...
    :cond_19
    iget-object v0, p0, accountTypesWithManagementDisabled:Ljava/util/Set;
    ...
    invoke-virtual {p0, p1, v3, v0}, writeAttributeValuesToXml(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;Ljava/util/Collection;)V
    ...
    :cond_1a
    iget-object v0, p0, trustAgentInfos:Landroid/util/ArrayMap;
    ...
    :cond_1d
    iget-object v0, p0, crossProfileWidgetProviders:Ljava/util/List;
    ...
    :cond_1e
    iget-object v0, p0, permittedAccessiblityServices:Ljava/util/List;

    const-string/jumbo v3, "permitted-accessiblity-services"

    invoke-virtual {p0, p1, v3, v0}, writePackageListToXml(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;Ljava/util/List;)V

    iget-object v0, p0, permittedInputMethods:Ljava/util/List;

    const-string/jumbo v3, "permitted-imes"

    invoke-virtual {p0, p1, v3, v0}, writePackageListToXml(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;Ljava/util/List;)V

    iget-object v0, p0, permittedNotificationListeners:Ljava/util/List;

    const-string/jumbo v3, "permitted-notification-listeners"

    invoke-virtual {p0, p1, v3, v0}, writePackageListToXml(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;Ljava/util/List;)V

    iget-object v0, p0, keepUninstalledPackages:Ljava/util/List;

    const-string/jumbo v3, "keep-uninstalled-packages"

    invoke-virtual {p0, p1, v3, v0}, writePackageListToXml(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;Ljava/util/List;)V

    iget-object v0, p0, meteredDisabledPackages:Ljava/util/List;

    const-string/jumbo v3, "metered_data_disabled_packages"

    invoke-virtual {p0, p1, v3, v0}, writePackageListToXml(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;Ljava/util/List;)V

    invoke-virtual {p0}, hasUserRestrictions()Z
    ...
    :cond_1f
    iget-object v0, p0, defaultEnabledRestrictionsAlreadySet:Ljava/util/Set;
    ...
    :cond_20
    iget-object v0, p0, shortSupportMessage:Ljava/lang/CharSequence;
    ...
    :cond_21
    iget-object v0, p0, longSupportMessage:Ljava/lang/CharSequence;
    ...
    invoke-virtual {v0, p1}, writeToXml(Lorg/xmlpull/v1/XmlSerializer;)V
    ...
    :cond_23
    iget v0, p0, organizationColor:I

    sget v3, DEF_ORGANIZATION_COLOR:I
    ...
    :cond_24
    iget-object v0, p0, organizationName:Ljava/lang/String;
    ...
    :cond_25
    iget-boolean v0, p0, isLogoutEnabled:Z
    ...
    :cond_26
    iget-object v0, p0, startUserSessionMessage:Ljava/lang/String;
    ...
    :cond_27
    iget-object v0, p0, endUserSessionMessage:Ljava/lang/String;
    ...
    :cond_28
    iget-object v0, p0, mCrossProfileCalendarPackages:Ljava/util/List;
    ...
    invoke-virtual {p0, p1, v1, v0}, writePackageListToXml(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;Ljava/util/List;)V
