...
.method static constructor <clinit>()V
    ...
    sput-wide v0, RATE_LIMIT_INTERVAL_MS:J
    ...
    sput-wide v0, BROADCAST_RETRY_INTERVAL_MS:J
    ...
    sput-wide v0, POLLING_INTERVAL_MS:J
    ...
    sput-wide v0, FORCE_FETCH_THROTTLE_NS:J
...
.method constructor <init>(Lcom/android/server/devicepolicy/DevicePolicyManagerService;)V
    ...
    invoke-direct {p0, p1, v0, v1}, <init>(Lcom/android/server/devicepolicy/DevicePolicyManagerService;J)V
...
.method constructor <init>(Lcom/android/server/devicepolicy/DevicePolicyManagerService;J)V
    ...
    iput-object v0, p0, mLock:Ljava/util/concurrent/locks/Lock;

    const/4 v0, 0x0

    iput-object v0, p0, mMonitorThread:Ljava/lang/Thread;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mPendingLogs:Ljava/util/ArrayList;

    const/4 v0, 0x0

    iput-boolean v0, p0, mAllowedToRetrieve:Z

    iput-boolean v0, p0, mCriticalLevelLogged:Z

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, mLastEvents:Ljava/util/ArrayList;

    const-wide/16 v1, -0x1

    iput-wide v1, p0, mLastEventNanos:J

    iput-wide v1, p0, mNextAllowedRetrievalTimeMillis:J
    ...
    iput-object v1, p0, mForceSemaphore:Ljava/util/concurrent/Semaphore;

    const-wide/16 v0, 0x0

    iput-wide v0, p0, mLastForceNanos:J

    iput-object p1, p0, mService:Lcom/android/server/devicepolicy/DevicePolicyManagerService;
...
.method private checkCriticalLevel()V
    ...
    :cond_0
    iget-object v0, p0, mPendingLogs:Ljava/util/ArrayList;
    ...
    iget-boolean v0, p0, mCriticalLevelLogged:Z
...
.method private getNextBatch(Ljava/util/ArrayList;)V
    ...
    iget-wide v0, p0, mLastEventNanos:J
    ...
    :cond_0
    iget-object v0, p0, mLastEvents:Ljava/util/ArrayList;
...
.method private mergeBatchLocked(Ljava/util/ArrayList;)V
    ...
    :goto_0
    iget-object v2, p0, mLastEvents:Ljava/util/ArrayList;
    ...
    iget-wide v5, p0, mLastEventNanos:J
    ...
    :cond_0
    iget-object v5, p0, mLastEvents:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v2}, assignLogId(Landroid/app/admin/SecurityLog$SecurityEvent;)V

    iget-object v8, p0, mPendingLogs:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v4}, assignLogId(Landroid/app/admin/SecurityLog$SecurityEvent;)V

    goto :goto_4

    :cond_5
    iget-object v3, p0, mPendingLogs:Ljava/util/ArrayList;

    invoke-virtual {v3, v2}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    invoke-direct {p0}, checkCriticalLevel()V
    ...
    iget-object v4, p0, mPendingLogs:Ljava/util/ArrayList;
    ...
    iget-object v6, p0, mPendingLogs:Ljava/util/ArrayList;
    ...
    iput-object v3, p0, mPendingLogs:Ljava/util/ArrayList;

    const/4 v3, 0x0

    iput-boolean v3, p0, mCriticalLevelLogged:Z
...
.method private notifyDeviceOwnerIfNeeded(Z)V
    ...
    iget-object v1, p0, mLock:Ljava/util/concurrent/locks/Lock;
    ...
    :cond_0
    :try_start_1
    iget-object v1, p0, mPendingLogs:Ljava/util/ArrayList;
    ...
    :cond_1
    iget-boolean v2, p0, mAllowedToRetrieve:Z
    ...
    iget-wide v4, p0, mNextAllowedRetrievalTimeMillis:J
    ...
    iput-boolean v2, p0, mAllowedToRetrieve:Z

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J

    move-result-wide v2

    sget-wide v4, BROADCAST_RETRY_INTERVAL_MS:J

    add-long/2addr v2, v4

    iput-wide v2, p0, mNextAllowedRetrievalTimeMillis:J
    :try_end_1
    ...
    iget-object v2, p0, mLock:Ljava/util/concurrent/locks/Lock;
...
.method private saveLastEvents(Ljava/util/ArrayList;)V
    ...
    iput-wide v0, p0, mLastEventNanos:J
    ...
    iget-wide v1, p0, mLastEventNanos:J
    ...
    iget-object v1, p0, mLastEvents:Ljava/util/ArrayList;
...
.method discardLogs()V
    ...
    iget-object v0, p0, mLock:Ljava/util/concurrent/locks/Lock;
    ...
    iput-object v1, p0, mPendingLogs:Ljava/util/ArrayList;
...
.method public forceLogs()J
    ...
    iget-object v2, p0, mForceSemaphore:Ljava/util/concurrent/Semaphore;

    monitor-enter v2

    :try_start_0
    iget-wide v3, p0, mLastForceNanos:J

    sget-wide v5, FORCE_FETCH_THROTTLE_NS:J
    ...
    iget-object v7, p0, mForceSemaphore:Ljava/util/concurrent/Semaphore;
...
.method resume()V
    ...
    :try_start_3
    invoke-direct {p0, v0}, notifyDeviceOwnerIfNeeded(Z)V
    :try_end_3
...
.method retrieveLogs()Ljava/util/List;
    ...
    :try_start_0
    iget-boolean v0, p0, mAllowedToRetrieve:Z
    ...
    sget-wide v3, RATE_LIMIT_INTERVAL_MS:J
    ...
    iput-object v2, p0, mPendingLogs:Ljava/util/ArrayList;
...
.method public run()V
    ...
    :try_start_0
    iget-object v1, p0, mForceSemaphore:Ljava/util/concurrent/Semaphore;

    sget-wide v3, POLLING_INTERVAL_MS:J
    ...
    invoke-direct {p0, v0}, getNextBatch(Ljava/util/ArrayList;)V

    iget-object v3, p0, mLock:Ljava/util/concurrent/locks/Lock;
    ...
    :try_start_1
    invoke-direct {p0, v0}, mergeBatchLocked(Ljava/util/ArrayList;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-direct {p0, v0}, saveLastEvents(Ljava/util/ArrayList;)V

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    invoke-direct {p0, v1}, notifyDeviceOwnerIfNeeded(Z)V
    ...
    iget-object v4, p0, mLock:Ljava/util/concurrent/locks/Lock;
    ...
    iget-wide v3, p0, mLastEventNanos:J
    ...
    iput-wide v3, p0, mLastEventNanos:J
...
.method start()V
    ...
    :try_start_0
    iget-object v1, p0, mMonitorThread:Ljava/lang/Thread;
    ...
    iget-object v0, p0, mMonitorThread:Ljava/lang/Thread;
...
.method stop()V
    ...
    :try_start_0
    iget-object v2, p0, mMonitorThread:Ljava/lang/Thread;
    ...
    iput-wide v2, p0, mId:J

    iput-boolean v1, p0, mAllowedToRetrieve:Z
