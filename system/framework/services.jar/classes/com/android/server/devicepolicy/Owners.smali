...
.method public constructor <init>(Landroid/os/UserManager;Landroid/os/UserManagerInternal;Landroid/content/pm/PackageManagerInternal;Lcom/android/server/wm/ActivityTaskManagerInternal;)V
    ...
    invoke-direct/range {v0 .. v5}, <init>(Landroid/os/UserManager;Landroid/os/UserManagerInternal;Landroid/content/pm/PackageManagerInternal;Lcom/android/server/wm/ActivityTaskManagerInternal;Lcom/android/server/devicepolicy/Owners$Injector;)V
...
.method constructor <init>(Landroid/os/UserManager;Landroid/os/UserManagerInternal;Landroid/content/pm/PackageManagerInternal;Lcom/android/server/wm/ActivityTaskManagerInternal;Lcom/android/server/devicepolicy/Owners$Injector;)V
    ...
    iput-object v0, p0, mProfileOwners:Landroid/util/ArrayMap;
    ...
    iput-object p2, p0, mUserManagerInternal:Landroid/os/UserManagerInternal;

    iput-object p3, p0, mPackageManagerInternal:Landroid/content/pm/PackageManagerInternal;

    iput-object p4, p0, mActivityTaskManagerInternal:Lcom/android/server/wm/ActivityTaskManagerInternal;

    iput-object p5, p0, mInjector:Lcom/android/server/devicepolicy/Owners$Injector;
...
.method static synthetic access$000(Lcom/android/server/devicepolicy/Owners;)Lcom/android/server/devicepolicy/Owners$OwnerInfo;
    ...
    iget-object v0, p0, mDeviceOwner:Lcom/android/server/devicepolicy/Owners$OwnerInfo;
...
.method static synthetic access$002(Lcom/android/server/devicepolicy/Owners;Lcom/android/server/devicepolicy/Owners$OwnerInfo;)Lcom/android/server/devicepolicy/Owners$OwnerInfo;
    ...
    iput-object p1, p0, mDeviceOwner:Lcom/android/server/devicepolicy/Owners$OwnerInfo;
...
.method static synthetic access$200(Lcom/android/server/devicepolicy/Owners;)Landroid/app/admin/SystemUpdateInfo;
    ...
    iget-object v0, p0, mSystemUpdateInfo:Landroid/app/admin/SystemUpdateInfo;
...
.method static synthetic access$202(Lcom/android/server/devicepolicy/Owners;Landroid/app/admin/SystemUpdateInfo;)Landroid/app/admin/SystemUpdateInfo;
    ...
    iput-object p1, p0, mSystemUpdateInfo:Landroid/app/admin/SystemUpdateInfo;
...
.method static synthetic access$400(Lcom/android/server/devicepolicy/Owners;)Ljava/time/LocalDate;
    ...
    iget-object v0, p0, mSystemUpdateFreezeStart:Ljava/time/LocalDate;
...
.method static synthetic access$402(Lcom/android/server/devicepolicy/Owners;Ljava/time/LocalDate;)Ljava/time/LocalDate;
    ...
    iput-object p1, p0, mSystemUpdateFreezeStart:Ljava/time/LocalDate;
...
.method static synthetic access$500(Lcom/android/server/devicepolicy/Owners;)Ljava/time/LocalDate;
    ...
    iget-object v0, p0, mSystemUpdateFreezeEnd:Ljava/time/LocalDate;
...
.method static synthetic access$502(Lcom/android/server/devicepolicy/Owners;Ljava/time/LocalDate;)Ljava/time/LocalDate;
    ...
    iput-object p1, p0, mSystemUpdateFreezeEnd:Ljava/time/LocalDate;
...
.method static synthetic access$600(Lcom/android/server/devicepolicy/Owners;)Landroid/util/ArrayMap;
    ...
    iget-object v0, p0, mProfileOwners:Landroid/util/ArrayMap;
...
.method private pushToActivityTaskManagerLocked()V
    ...
    iget-object v1, p0, mPackageManagerInternal:Landroid/content/pm/PackageManagerInternal;

    iget-object v0, v0, Lcom/android/server/devicepolicy/Owners$OwnerInfo;->packageName:Ljava/lang/String;

    const v2, 0x422000

    iget v3, p0, mDeviceOwnerUserId:I
    ...
    iget-object v1, p0, mActivityTaskManagerInternal:Lcom/android/server/wm/ActivityTaskManagerInternal;
...
.method private pushToPackageManagerLocked()V
    ...
    iget-object v1, p0, mProfileOwners:Landroid/util/ArrayMap;
    ...
    iget-object v2, p0, mProfileOwners:Landroid/util/ArrayMap;
    ...
    iget-object v3, p0, mProfileOwners:Landroid/util/ArrayMap;
    ...
    iget v2, p0, mDeviceOwnerUserId:I

    iget-object v3, p0, mDeviceOwner:Lcom/android/server/devicepolicy/Owners$OwnerInfo;
...
.method private readLegacyOwnerFileLocked(Ljava/io/File;)Z
    ...
    iput-object v9, v1, mDeviceOwner:Lcom/android/server/devicepolicy/Owners$OwnerInfo;

    iput v3, v1, mDeviceOwnerUserId:I
    ...
    :cond_6
    iget-object v12, v1, mProfileOwners:Landroid/util/ArrayMap;
    ...
    iput-object v9, v1, mSystemUpdatePolicy:Landroid/app/admin/SystemUpdatePolicy;
...
.method clearDeviceOwner()V
    ...
    :try_start_0
    iput-object v1, p0, mDeviceOwner:Lcom/android/server/devicepolicy/Owners$OwnerInfo;

    const/16 v1, -0x2710

    iput v1, p0, mDeviceOwnerUserId:I
    ...
    invoke-direct {p0}, pushToPackageManagerLocked()V

    invoke-direct {p0}, pushToActivityTaskManagerLocked()V

    invoke-virtual {p0}, pushToAppOpsLocked()V
...
.method clearSystemUpdatePolicy()V
    ...
    :try_start_0
    iput-object v1, p0, mSystemUpdatePolicy:Landroid/app/admin/SystemUpdatePolicy;
...
.method public dump(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    iget-object v1, p0, mDeviceOwner:Lcom/android/server/devicepolicy/Owners$OwnerInfo;
    ...
    :cond_0
    iget-object v1, p0, mSystemUpdatePolicy:Landroid/app/admin/SystemUpdatePolicy;
    ...
    iget-object v3, p0, mSystemUpdatePolicy:Landroid/app/admin/SystemUpdatePolicy;
    ...
    :cond_4
    iget-object v1, p0, mSystemUpdateInfo:Landroid/app/admin/SystemUpdateInfo;
    ...
    iget-object v2, p0, mSystemUpdateInfo:Landroid/app/admin/SystemUpdateInfo;
    ...
    :cond_6
    iget-object v1, p0, mSystemUpdateFreezeStart:Ljava/time/LocalDate;

    if-nez v1, :cond_7

    iget-object v1, p0, mSystemUpdateFreezeEnd:Ljava/time/LocalDate;
    ...
    invoke-virtual {p0}, getSystemUpdateFreezePeriodRecordAsString()Ljava/lang/String;
...
.method getDeviceOwnerFile()Ljava/io/File;
    ...
    iget-object v1, p0, mInjector:Lcom/android/server/devicepolicy/Owners$Injector;
...
.method getDeviceOwnerUserId()I
    ...
    :try_start_0
    iget v1, p0, mDeviceOwnerUserId:I
...
.method getDeviceOwnerUserIdAndComponent()Landroid/util/Pair;
    ...
    iget-object v2, p0, mDeviceOwner:Lcom/android/server/devicepolicy/Owners$OwnerInfo;
...
.method getSystemUpdateFreezePeriodRecord()Landroid/util/Pair;
    ...
    iget-object v2, p0, mSystemUpdateFreezeStart:Ljava/time/LocalDate;

    iget-object v3, p0, mSystemUpdateFreezeEnd:Ljava/time/LocalDate;
...
.method hasProfileOwner(I)Z
    ...
    :try_start_0
    invoke-virtual {p0, p1}, getProfileOwnerComponent(I)Landroid/content/ComponentName;
...
.method load()V
    ...
    :try_start_0
    invoke-virtual {p0}, getLegacyConfigFile()Ljava/io/File;
    ...
    invoke-direct {p0, v1}, readLegacyOwnerFileLocked(Ljava/io/File;)Z

    move-result v4

    if-eqz v4, :cond_1

    invoke-virtual {p0}, writeDeviceOwner()V

    invoke-virtual {p0}, getProfileOwnerKeys()Ljava/util/Set;
    ...
    invoke-virtual {p0, v5}, writeProfileOwner(I)V
    ...
    invoke-virtual {p0}, hasDeviceOwner()Z
    ...
    iget-object v6, p0, mUserManagerInternal:Landroid/os/UserManagerInternal;

    iget v7, v5, Landroid/content/pm/UserInfo;->id:I

    iget v8, v5, Landroid/content/pm/UserInfo;->id:I

    invoke-virtual {p0, v8}, hasProfileOwner(I)Z
    ...
    invoke-virtual {p0}, getDeviceOwnerUserId()I

    move-result v4

    invoke-virtual {p0, v4}, hasProfileOwner(I)Z
...
.method pushToAppOpsLocked()V
    ...
    iget-object v3, p0, mPackageManagerInternal:Landroid/content/pm/PackageManagerInternal;

    iget-object v5, p0, mDeviceOwner:Lcom/android/server/devicepolicy/Owners$OwnerInfo;

    iget-object v5, v5, Lcom/android/server/devicepolicy/Owners$OwnerInfo;->packageName:Ljava/lang/String;

    iget v6, p0, mDeviceOwnerUserId:I
    ...
    iget-object v5, p0, mPackageManagerInternal:Landroid/content/pm/PackageManagerInternal;

    iget-object v6, p0, mProfileOwners:Landroid/util/ArrayMap;
    ...
    iget-object v7, p0, mProfileOwners:Landroid/util/ArrayMap;
...
.method setDeviceOwner(Landroid/content/ComponentName;Ljava/lang/String;I)V
    ...
    :try_start_0
    invoke-virtual {p0, p1, p2, p3, v1}, setDeviceOwnerWithRestrictionsMigrated(Landroid/content/ComponentName;Ljava/lang/String;IZ)V
...
.method setDeviceOwnerWithRestrictionsMigrated(Landroid/content/ComponentName;Ljava/lang/String;IZ)V
    ...
    iput-object v8, p0, mDeviceOwner:Lcom/android/server/devicepolicy/Owners$OwnerInfo;

    iput p3, p0, mDeviceOwnerUserId:I
...
.method setProfileOwnerCanAccessDeviceIds(I)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, writeProfileOwner(I)V
...
.method setSystemUpdateFreezePeriodRecord(Ljava/time/LocalDate;Ljava/time/LocalDate;)Z
    ...
    :cond_0
    iget-object v2, p0, mSystemUpdateFreezeEnd:Ljava/time/LocalDate;
    ...
    iput-object p2, p0, mSystemUpdateFreezeEnd:Ljava/time/LocalDate;
