...
.method readFromFileLocked()V
    ...
    :cond_4
    :try_start_1
    invoke-virtual {p0, v3, v4, v5}, readInner(Lorg/xmlpull/v1/XmlPullParser;ILjava/lang/String;)Z
...
.method writeToFileLocked()V
    ...
    invoke-virtual {p0}, shouldWrite()Z
    ...
    invoke-virtual {p0, v4}, writeInner(Lorg/xmlpull/v1/XmlSerializer;)V
