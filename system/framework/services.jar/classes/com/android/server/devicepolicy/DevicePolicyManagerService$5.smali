...
.method constructor <init>(Lcom/android/server/devicepolicy/DevicePolicyManagerService;Landroid/content/BroadcastReceiver;Landroid/content/Intent;Lcom/android/server/devicepolicy/DevicePolicyManagerService$ActiveAdmin;Landroid/app/BroadcastOptions;)V
    ...
    iput-object p2, p0, val$result:Landroid/content/BroadcastReceiver;

    iput-object p3, p0, val$intent:Landroid/content/Intent;

    iput-object p4, p0, val$admin:Lcom/android/server/devicepolicy/DevicePolicyManagerService$ActiveAdmin;

    iput-object p5, p0, val$options:Landroid/app/BroadcastOptions;
...
.method public run()V
    ...
    iget-object v0, p0, val$result:Landroid/content/BroadcastReceiver;
    ...
    iget-object v0, p0, val$admin:Lcom/android/server/devicepolicy/DevicePolicyManagerService$ActiveAdmin;
    ...
    iget-object v0, p0, val$options:Landroid/app/BroadcastOptions;

    invoke-virtual {v0}, Landroid/app/BroadcastOptions;->toBundle()Landroid/os/Bundle;

    move-result-object v6

    iget-object v7, p0, val$result:Landroid/content/BroadcastReceiver;
    ...
    iget-object v2, p0, val$admin:Lcom/android/server/devicepolicy/DevicePolicyManagerService$ActiveAdmin;
    ...
    iget-object v4, p0, val$options:Landroid/app/BroadcastOptions;
