...
.method static constructor <clinit>()V
    ...
    invoke-static {}, buildErrorCodesMap()Ljava/util/Map;

    move-result-object v0

    sput-object v0, errorCodesMap:Ljava/util/Map;

    invoke-static {}, buildErrorStringsMap()Ljava/util/Map;

    move-result-object v0

    sput-object v0, errorStringsMap:Ljava/util/Map;
...
.method constructor <init>(Landroid/content/Context;Landroid/os/ParcelFileDescriptor;Landroid/app/admin/StartInstallingUpdateCallback;Lcom/android/server/devicepolicy/DevicePolicyManagerService$Injector;Lcom/android/server/devicepolicy/DevicePolicyConstants;)V
    ...
    iput-boolean v0, p0, mUpdateInstalled:Z
...
.method static synthetic access$000()Ljava/util/Map;
    ...
    sget-object v0, errorCodesMap:Ljava/util/Map;
...
.method static synthetic access$100()Ljava/util/Map;
    ...
    sget-object v0, errorStringsMap:Ljava/util/Map;
...
.method private applyPayload(Ljava/lang/String;)V
    ...
    invoke-direct {p0}, updateStateForPayload()Z
    ...
    :cond_0
    iget-object v0, p0, mProperties:Ljava/util/List;
    ...
    iget-wide v1, p0, mSizeForUpdate:J
    ...
    invoke-virtual {p0, v2, v1}, notifyCallbackOnError(ILjava/lang/String;)V

    return-void

    :cond_1
    invoke-direct {p0}, buildBoundUpdateEngine()Landroid/os/UpdateEngine;

    move-result-object v9

    :try_start_0
    iget-wide v3, p0, mOffsetForUpdate:J

    iget-wide v5, p0, mSizeForUpdate:J
    ...
    invoke-virtual {p0, v3, v2}, notifyCallbackOnError(ILjava/lang/String;)V
...
.method private setState()V
    ...
    iget-object v1, p0, mCopiedUpdateFile:Ljava/io/File;

    invoke-direct {v0, v1}, Ljava/util/zip/ZipFile;-><init>(Ljava/io/File;)V

    iput-object v0, p0, mPackedUpdateFile:Ljava/util/zip/ZipFile;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mProperties:Ljava/util/List;

    const-wide/16 v0, -0x1

    iput-wide v0, p0, mSizeForUpdate:J

    const-wide/16 v0, 0x0

    iput-wide v0, p0, mOffsetForUpdate:J

    iget-object v0, p0, mPackedUpdateFile:Ljava/util/zip/ZipFile;

    invoke-virtual {v0}, Ljava/util/zip/ZipFile;->entries()Ljava/util/Enumeration;

    move-result-object v0

    iput-object v0, p0, mEntries:Ljava/util/Enumeration;
...
.method private updatePropertiesForEntry(Ljava/util/zip/ZipEntry;)V
    ...
    iget-object v2, p0, mPackedUpdateFile:Ljava/util/zip/ZipFile;
    ...
    iget-object v1, p0, mProperties:Ljava/util/List;
...
.method private updateStateForPayload()Z
    ...
    :goto_0
    iget-object v2, p0, mEntries:Ljava/util/Enumeration;
    ...
    invoke-direct {p0, v2, v3}, buildOffsetForEntry(Ljava/util/zip/ZipEntry;Ljava/lang/String;)J
    ...
    invoke-virtual {p0, v5, v4}, notifyCallbackOnError(ILjava/lang/String;)V
    ...
    iput-wide v4, p0, mSizeForUpdate:J
    ...
    iput-wide v4, p0, mOffsetForUpdate:J
    ...
    invoke-direct {p0, v2}, updatePropertiesForEntry(Ljava/util/zip/ZipEntry;)V
...
.method public installUpdateInThread()V
    ...
    iget-boolean v1, p0, mUpdateInstalled:Z

    if-nez v1, :cond_0

    :try_start_0
    invoke-direct {p0}, setState()V
    ...
    invoke-direct {p0, v1}, applyPayload(Ljava/lang/String;)V
    :try_end_0
    ...
    invoke-virtual {p0, v0, v2}, notifyCallbackOnError(ILjava/lang/String;)V
