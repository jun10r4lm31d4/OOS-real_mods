...
.method protected constructor <init>(Landroid/content/Context;Landroid/os/ParcelFileDescriptor;Landroid/app/admin/StartInstallingUpdateCallback;Lcom/android/server/devicepolicy/DevicePolicyManagerService$Injector;Lcom/android/server/devicepolicy/DevicePolicyConstants;)V
    ...
    iput-object p3, p0, mCallback:Landroid/app/admin/StartInstallingUpdateCallback;

    iput-object p2, p0, mUpdateFileDescriptor:Landroid/os/ParcelFileDescriptor;

    iput-object p4, p0, mInjector:Lcom/android/server/devicepolicy/DevicePolicyManagerService$Injector;

    iput-object p5, p0, mConstants:Lcom/android/server/devicepolicy/DevicePolicyConstants;
...
.method private copyToFile(Ljava/io/File;)V
    ...
    iget-object v2, p0, mUpdateFileDescriptor:Landroid/os/ParcelFileDescriptor;
...
.method private copyUpdateFileToDataOtaPackageDir()Ljava/io/File;
    ...
    :try_start_0
    invoke-direct {p0}, createNewFileWithPermissions()Ljava/io/File;

    move-result-object v0

    invoke-direct {p0, v0}, copyToFile(Ljava/io/File;)V
    :try_end_0
    ...
    invoke-virtual {p0, v1, v2}, notifyCallbackOnError(ILjava/lang/String;)V
...
.method private isBatteryLevelSufficient()Z
    ...
    invoke-direct {p0, v0}, calculateBatteryPercentage(Landroid/content/Intent;)F
    ...
    iget-object v5, p0, mConstants:Lcom/android/server/devicepolicy/DevicePolicyConstants;
...
.method cleanupUpdateFile()V
    ...
    iget-object v0, p0, mCopiedUpdateFile:Ljava/io/File;
...
.method public synthetic lambda$startInstallUpdate$0$UpdateInstaller()V
    ...
    invoke-direct {p0}, copyUpdateFileToDataOtaPackageDir()Ljava/io/File;

    move-result-object v0

    iput-object v0, p0, mCopiedUpdateFile:Ljava/io/File;
    ...
    invoke-virtual {p0, v0, v1}, notifyCallbackOnError(ILjava/lang/String;)V

    return-void

    :cond_0
    invoke-virtual {p0}, installUpdateInThread()V
...
.method protected notifyCallbackOnError(ILjava/lang/String;)V
    ...
    invoke-virtual {p0}, cleanupUpdateFile()V
    ...
    :try_start_0
    iget-object v0, p0, mCallback:Landroid/app/admin/StartInstallingUpdateCallback;
...
.method protected notifyCallbackOnSuccess()V
    ...
    iget-object v0, p0, mInjector:Lcom/android/server/devicepolicy/DevicePolicyManagerService$Injector;
...
.method public startInstallUpdate()V
    ...
    invoke-direct {p0}, isBatteryLevelSufficient()Z
    ...
    iget-object v2, p0, mConstants:Lcom/android/server/devicepolicy/DevicePolicyConstants;
