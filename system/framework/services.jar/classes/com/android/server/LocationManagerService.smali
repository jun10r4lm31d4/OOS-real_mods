...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mRealProviders:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, mBackgroundThrottlePackageWhitelist:Landroid/util/ArraySet;

    new-instance v0, Landroid/util/ArraySet;

    invoke-direct {v0}, Landroid/util/ArraySet;-><init>()V

    iput-object v0, p0, mIgnoreSettingsPackageWhitelist:Landroid/util/ArraySet;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, mGnssMeasurementsListeners:Landroid/util/ArrayMap;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, mGnssNavigationMessageListeners:Landroid/util/ArrayMap;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, mGnssStatusListeners:Landroid/util/ArrayMap;
    ...
    iput-boolean v0, p0, mGnssBatchingInProgress:Z
    ...
    iput-object v0, p0, mLocationUsageLogger:Lcom/android/server/LocationUsageLogger;
    ...
    iput-object v1, p0, mdmLmsInjector:Lcom/android/server/LocationManagerServiceInjector$MdmGnssInjector;
...
.method static synthetic access$1000(Lcom/android/server/LocationManagerService;)V
    ...
    invoke-direct {p0}, onIgnoreSettingsWhitelistChangedLocked()V
...
.method static synthetic access$1100(Lcom/android/server/LocationManagerService;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, onPackageDisappearedLocked(Ljava/lang/String;)V
...
.method static synthetic access$1200(Lcom/android/server/LocationManagerService;I)V
    ...
    invoke-direct {p0, p1}, onUserChangedLocked(I)V
...
.method static synthetic access$1300(Lcom/android/server/LocationManagerService;)V
    ...
    invoke-direct {p0}, onUserProfilesChangedLocked()V
...
.method static synthetic access$1400(Lcom/android/server/LocationManagerService;)V
    ...
    invoke-direct {p0}, onScreenStateChangedLocked()V
...
.method static synthetic access$2100(Lcom/android/server/LocationManagerService;)Lcom/android/server/location/PassiveProvider;
    ...
    iget-object v0, p0, mPassiveProvider:Lcom/android/server/location/PassiveProvider;
...
.method static synthetic access$2200(Lcom/android/server/LocationManagerService;I)Z
    ...
    invoke-direct {p0, p1}, isCurrentProfileLocked(I)Z
...
.method static synthetic access$2300(Lcom/android/server/LocationManagerService;)Z
    ...
    invoke-direct {p0}, isLocationEnabled()Z
...
.method static synthetic access$2400(Lcom/android/server/LocationManagerService;)Ljava/util/HashMap;
    ...
    iget-object v0, p0, mLastLocation:Ljava/util/HashMap;
...
.method static synthetic access$2500(Lcom/android/server/LocationManagerService;)Ljava/util/HashMap;
    ...
    iget-object v0, p0, mLastLocationCoarseInterval:Ljava/util/HashMap;
...
.method static synthetic access$2600(Lcom/android/server/LocationManagerService;Lcom/android/server/LocationManagerService$LocationProvider;)V
    ...
    invoke-direct {p0, p1}, updateProviderUseableLocked(Lcom/android/server/LocationManagerService$LocationProvider;)V
...
.method static synthetic access$2700(Lcom/android/server/LocationManagerService;Ljava/lang/String;)Lcom/android/server/LocationManagerService$LocationProvider;
    ...
    invoke-direct {p0, p1}, getLocationProviderLocked(Ljava/lang/String;)Lcom/android/server/LocationManagerService$LocationProvider;
...
.method static synthetic access$2800(Lcom/android/server/LocationManagerService;)Landroid/location/IBatchedLocationCallback;
    ...
    iget-object v0, p0, mGnssBatchingCallback:Landroid/location/IBatchedLocationCallback;
...
.method static synthetic access$2900(Lcom/android/server/LocationManagerService;Landroid/location/Location;Lcom/android/server/LocationManagerService$LocationProvider;)V
    ...
    invoke-direct {p0, p1, p2}, handleLocationChangedLocked(Landroid/location/Location;Lcom/android/server/LocationManagerService$LocationProvider;)V
...
.method static synthetic access$300(Lcom/android/server/LocationManagerService;Lcom/android/server/LocationManagerService$LocationProvider;)V
    ...
    invoke-direct {p0, p1}, applyRequirementsLocked(Lcom/android/server/LocationManagerService$LocationProvider;)V
...
.method static synthetic access$3300(Lcom/android/server/LocationManagerService;Lcom/android/server/LocationManagerService$UpdateRecord;)Z
    ...
    invoke-direct {p0, p1}, isSettingsExemptLocked(Lcom/android/server/LocationManagerService$UpdateRecord;)Z
...
.method static synthetic access$4200(I)Z
    ...
    invoke-static {p0}, isImportanceForeground(I)Z
...
.method static synthetic access$4500(Lcom/android/server/LocationManagerService;)Lcom/android/server/LocationUsageLogger;
    ...
    iget-object v0, p0, mLocationUsageLogger:Lcom/android/server/LocationUsageLogger;
...
.method static synthetic access$500(Lcom/android/server/LocationManagerService;)V
    ...
    invoke-direct {p0}, onAppOpChangedLocked()V
...
.method static synthetic access$600(Lcom/android/server/LocationManagerService;Z)V
    ...
    invoke-direct {p0, p1}, onLocationModeChangedLocked(Z)V
...
.method static synthetic access$700(Lcom/android/server/LocationManagerService;)V
    ...
    invoke-direct {p0}, onProviderAllowedChangedLocked()V
...
.method static synthetic access$800(Lcom/android/server/LocationManagerService;)V
    ...
    invoke-direct {p0}, onBackgroundThrottleIntervalChangedLocked()V
...
.method static synthetic access$900(Lcom/android/server/LocationManagerService;)V
    ...
    invoke-direct {p0}, onBackgroundThrottleWhitelistChangedLocked()V
...
.method private addGnssDataListener(Landroid/os/IInterface;Ljava/lang/String;Ljava/lang/String;Lcom/android/server/location/RemoteListenerHelper;Landroid/util/ArrayMap;Ljava/util/function/Consumer;)Z
    ...
    invoke-direct {v1, v11}, hasGnssPermissions(Ljava/lang/String;)Z
    ...
    iget-object v10, v1, mLock:Ljava/lang/Object;

    monitor-enter v10

    :try_start_0
    invoke-direct {v1, v15, v14}, linkToListenerDeathNotificationLocked(Landroid/os/IBinder;Lcom/android/server/LocationManagerService$LinkedListenerBase;)Z
    ...
    :try_start_1
    iget-object v0, v1, mGnssMeasurementsProvider:Lcom/android/server/location/GnssMeasurementsProvider;

    if-eq v12, v0, :cond_3

    iget-object v0, v1, mGnssStatusProvider:Lcom/android/server/location/GnssStatusListenerHelper;
    ...
    :cond_3
    :goto_0
    iget-object v2, v1, mLocationUsageLogger:Lcom/android/server/LocationUsageLogger;
    ...
    iget-object v5, v1, mActivityManager:Landroid/app/ActivityManager;
    ...
    :goto_2
    invoke-direct {v1, v13}, isThrottlingExemptLocked(Lcom/android/server/location/CallerIdentity;)Z

    move-result v0

    if-nez v0, :cond_6

    iget-object v0, v1, mActivityManager:Landroid/app/ActivityManager;

    invoke-virtual {v0, v11}, Landroid/app/ActivityManager;->getPackageImportance(Ljava/lang/String;)I

    move-result v0

    invoke-static {v0}, isImportanceForeground(I)Z
...
.method private addProviderLocked(Lcom/android/server/LocationManagerService$LocationProvider;)V
    ...
    invoke-direct {p0, v0}, getLocationProviderLocked(Ljava/lang/String;)Lcom/android/server/LocationManagerService$LocationProvider;
...
.method private applyRequirementsLocked(Lcom/android/server/LocationManagerService$LocationProvider;)V
    ...
    iget-object v0, v1, mRecordsByProvider:Ljava/util/HashMap;
    ...
    iget-object v0, v1, mProviders:Ljava/util/ArrayList;
    ...
    iget v0, v1, mBatterySaverMode:I
    ...
    :goto_0
    iget v10, v1, mBatterySaverMode:I
    ...
    invoke-direct {v1, v15}, isCurrentProfileLocked(I)Z
    ...
    invoke-virtual {v1, v15, v11, v12, v13}, checkLocationAccess(IILjava/lang/String;I)Z
    ...
    :cond_7
    invoke-direct {v1, v14}, isSettingsExemptLocked(Lcom/android/server/LocationManagerService$UpdateRecord;)Z
    ...
    invoke-direct {v1, v0}, isThrottlingExemptLocked(Lcom/android/server/location/CallerIdentity;)Z
    ...
    invoke-direct {v14, v12}, isCurrentProfileLocked(I)Z
    ...
    invoke-static {v15}, isValidWorkSource(Landroid/os/WorkSource;)Z
...
.method private applyRequirementsLocked(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0}, applyRequirementsLocked(Lcom/android/server/LocationManagerService$LocationProvider;)V
...
.method private checkResolutionLevelIsSufficientForProviderUseLocked(ILjava/lang/String;)V
    ...
    invoke-direct {p0, p2}, getMinimumResolutionLevelForProviderUseLocked(Ljava/lang/String;)I
...
.method private dumpGnssDataListenersLocked(Ljava/io/PrintWriter;Landroid/util/ArrayMap;)V
    ...
    invoke-direct {p0, v2}, isThrottlingExemptLocked(Lcom/android/server/location/CallerIdentity;)Z
...
.method private getReceiverLocked(Landroid/app/PendingIntent;IILjava/lang/String;Landroid/os/WorkSource;Z)Lcom/android/server/LocationManagerService$Receiver;
    ...
    iget-object v0, v10, mReceivers:Ljava/util/HashMap;
...
.method private getReceiverLocked(Landroid/location/ILocationListener;IILjava/lang/String;Landroid/os/WorkSource;Z)Lcom/android/server/LocationManagerService$Receiver;
    ...
    invoke-direct {p0, v0, v12}, linkToListenerDeathNotificationLocked(Landroid/os/IBinder;Lcom/android/server/LocationManagerService$LinkedListenerBase;)Z
...
.method private getReceiverLocked(Landroid/location/LocationRequest;Landroid/location/ILocationListener;IILjava/lang/String;Landroid/os/WorkSource;Z)Lcom/android/server/LocationManagerService$Receiver;
    ...
    iget-object v1, v10, mReceivers:Ljava/util/HashMap;
    ...
    invoke-direct {v10, v1, v0}, linkToListenerDeathNotificationLocked(Landroid/os/IBinder;Lcom/android/server/LocationManagerService$LinkedListenerBase;)Z
...
.method private handleLocationChangedLocked(Landroid/location/Location;Lcom/android/server/LocationManagerService$LocationProvider;)V
    ...
    iget-object v3, v0, mProviders:Ljava/util/ArrayList;
    ...
    iget-object v3, v0, mPassiveProvider:Lcom/android/server/location/PassiveProvider;
    ...
    invoke-virtual {v0, v5, v6}, mdmCheckIfLossSv(J)V

    :cond_4
    iget-object v3, v0, mdmLmsInjector:Lcom/android/server/LocationManagerServiceInjector$MdmGnssInjector;
    ...
    invoke-direct {v0, v1, v3}, updateLastLocationLocked(Landroid/location/Location;Ljava/lang/String;)V

    :cond_5
    iget-object v3, v0, mLastLocationCoarseInterval:Ljava/util/HashMap;
    ...
    iget-object v7, v0, mLastLocationCoarseInterval:Ljava/util/HashMap;
    ...
    iget-object v10, v0, mRecordsByProvider:Ljava/util/HashMap;
    ...
    iget-object v12, v0, mLocationFudger:Lcom/android/server/location/LocationFudger;
    ...
    invoke-direct {v0, v15}, isSettingsExemptLocked(Lcom/android/server/LocationManagerService$UpdateRecord;)Z
    ...
    invoke-direct {v0, v3}, isCurrentProfileLocked(I)Z
    ...
    invoke-virtual {v0, v7}, isProviderPackage(Ljava/lang/String;)Z
    ...
    :cond_d
    iget-object v7, v0, mBlacklist:Lcom/android/server/location/LocationBlacklist;
    ...
    invoke-static {v7, v8, v15, v5, v6}, shouldBroadcastSafeLocked(Landroid/location/Location;Landroid/location/Location;Lcom/android/server/LocationManagerService$UpdateRecord;J)Z
    ...
    invoke-direct {v0, v3, v8, v9, v10}, reportLocationAccessNoThrow(IILjava/lang/String;I)Z
    ...
    invoke-direct {v0, v3}, removeUpdatesLocked(Lcom/android/server/LocationManagerService$Receiver;)V
    ...
    :cond_25
    invoke-direct {v0, v2}, applyRequirementsLocked(Lcom/android/server/LocationManagerService$LocationProvider;)V
...
.method private hasGnssPermissions(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v1, v2}, checkResolutionLevelIsSufficientForProviderUseLocked(ILjava/lang/String;)V
    ...
    :try_start_1
    invoke-virtual {p0, v2, v3, p1, v1}, checkLocationAccess(IILjava/lang/String;I)Z
...
.method private initializeLocked()V
    ...
    invoke-direct {p0}, initializeProvidersLocked()V
    ...
    invoke-direct {p0, v2}, onUserChangedLocked(I)V
    ...
    invoke-direct {p0, v2}, onBatterySaverModeChangedLocked(I)V
...
.method private initializeProvidersLocked()V
    ...
    invoke-direct {v0, v1}, addProviderLocked(Lcom/android/server/LocationManagerService$LocationProvider;)V
    ...
    iput-object v3, v0, mPassiveProvider:Lcom/android/server/location/PassiveProvider;
    ...
    iget-object v5, v0, mRealProviders:Ljava/util/ArrayList;

    invoke-virtual {v5, v3}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-direct {v0, v3}, addProviderLocked(Lcom/android/server/LocationManagerService$LocationProvider;)V
    ...
    iput-object v6, v0, mGnssSystemInfoProvider:Lcom/android/server/location/GnssLocationProvider$GnssSystemInfoProvider;
    ...
    iput-object v6, v0, mGnssBatchingProvider:Lcom/android/server/location/GnssBatchingProvider;
    ...
    iput-object v6, v0, mGnssMetricsProvider:Lcom/android/server/location/GnssLocationProvider$GnssMetricsProvider;
    ...
    iput-object v6, v0, mGnssCapabilitiesProvider:Lcom/android/server/location/GnssCapabilitiesProvider;
    ...
    iput-object v6, v0, mGnssStatusProvider:Lcom/android/server/location/GnssStatusListenerHelper;
    ...
    iput-object v6, v0, mNetInitiatedListener:Landroid/location/INetInitiatedListener;
    ...
    iput-object v6, v0, mGnssMeasurementsProvider:Lcom/android/server/location/GnssMeasurementsProvider;
    ...
    iput-object v6, v0, mGnssMeasurementCorrectionsProvider:Lcom/android/server/location/GnssMeasurementCorrectionsProvider;
    ...
    iput-object v6, v0, mGnssNavigationMessageProvider:Lcom/android/server/location/GnssNavigationMessageProvider;
    ...
    iput-object v6, v0, mGpsGeofenceProxy:Landroid/location/IGpsGeofenceHardware;
    ...
    :cond_2
    invoke-direct {v0, v6}, ensureFallbackFusedProviderPresentLocked([Ljava/lang/String;)V
    ...
    iget-object v10, v0, mRealProviders:Ljava/util/ArrayList;

    invoke-virtual {v10, v7}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-direct {v0, v7}, addProviderLocked(Lcom/android/server/LocationManagerService$LocationProvider;)V
    ...
    iget-object v10, v0, mdmLmsInjector:Lcom/android/server/LocationManagerServiceInjector$MdmGnssInjector;
    ...
    iget-object v12, v0, mRealProviders:Ljava/util/ArrayList;

    invoke-virtual {v12, v10}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-direct {v0, v10}, addProviderLocked(Lcom/android/server/LocationManagerService$LocationProvider;)V
    ...
    iget-object v12, v0, mdmLmsInjector:Lcom/android/server/LocationManagerServiceInjector$MdmGnssInjector;
    ...
    iput-object v5, v0, mGeocodeProvider:Lcom/android/server/location/GeocoderProxy;

    iget-object v5, v0, mGeocodeProvider:Lcom/android/server/location/GeocoderProxy;
    ...
    iget-object v5, v0, mGpsGeofenceProxy:Landroid/location/IGpsGeofenceHardware;
    ...
    iput-object v12, v0, mComboNlpPackageName:Ljava/lang/String;

    iget-object v12, v0, mComboNlpPackageName:Ljava/lang/String;
    ...
    iget-object v13, v0, mComboNlpPackageName:Ljava/lang/String;
    ...
    iput-object v12, v0, mComboNlpReadyMarker:Ljava/lang/String;
    ...
    iput-object v12, v0, mComboNlpScreenMarker:Ljava/lang/String;
...
.method private isCurrentProfileLocked(I)Z
    ...
    iget-object v0, p0, mCurrentUserProfiles:[I
...
.method private isLocationEnabled()Z
    ...
    invoke-virtual {p0, v0}, isLocationEnabledForUser(I)Z
...
.method private isSettingsExemptLocked(Lcom/android/server/LocationManagerService$UpdateRecord;)Z
    ...
    :cond_0
    iget-object v0, p0, mIgnoreSettingsPackageWhitelist:Landroid/util/ArraySet;
    ...
    invoke-virtual {p0, v0}, isProviderPackage(Ljava/lang/String;)Z
...
.method private isThrottlingExemptLocked(Lcom/android/server/location/CallerIdentity;)Z
    ...
    :cond_0
    iget-object v0, p0, mBackgroundThrottlePackageWhitelist:Landroid/util/ArraySet;
...
.method private onAppOpChangedLocked()V
    ...
    invoke-direct {p0, v1}, applyRequirementsLocked(Lcom/android/server/LocationManagerService$LocationProvider;)V
...
.method private onBackgroundThrottleWhitelistChangedLocked()V
    ...
    iget-object v1, p0, mBackgroundThrottlePackageWhitelist:Landroid/util/ArraySet;
    ...
    invoke-direct {p0, v2}, applyRequirementsLocked(Lcom/android/server/LocationManagerService$LocationProvider;)V
...
.method private onBatterySaverModeChangedLocked(I)V
    ...
    iget v1, p0, mBatterySaverMode:I
    ...
    :cond_0
    iget v0, p0, mBatterySaverMode:I
    ...
    :cond_1
    iput p1, p0, mBatterySaverMode:I
...
.method private onIgnoreSettingsWhitelistChangedLocked()V
    ...
    iget-object v1, p0, mIgnoreSettingsPackageWhitelist:Landroid/util/ArraySet;
...
.method private onLocationModeChangedLocked(Z)V
    ...
    :cond_2
    iget-object v0, p0, mdmLmsInjector:Lcom/android/server/LocationManagerServiceInjector$MdmGnssInjector;
...
.method private onPackageDisappearedLocked(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v2}, removeUpdatesLocked(Lcom/android/server/LocationManagerService$Receiver;)V
...
.method private onUidImportanceChangedLocked(II)V
    ...
    invoke-static {p2}, isImportanceForeground(I)Z

    move-result v6

    new-instance v0, Ljava/util/HashSet;

    iget-object v1, p0, mRecordsByProvider:Ljava/util/HashMap;
    ...
    invoke-static {v6}, foregroundAsString(Z)Ljava/lang/String;
    ...
    invoke-direct {p0, v5}, isThrottlingExemptLocked(Lcom/android/server/location/CallerIdentity;)Z
    ...
    :cond_4
    iget-object v1, p0, mGnssMeasurementsListeners:Landroid/util/ArrayMap;

    iget-object v2, p0, mGnssMeasurementsProvider:Lcom/android/server/location/GnssMeasurementsProvider;
    ...
    invoke-direct/range {v0 .. v5}, updateGnssDataProviderOnUidImportanceChangedLocked(Landroid/util/ArrayMap;Lcom/android/server/location/RemoteListenerHelper;Ljava/util/function/Function;IZ)V

    iget-object v1, p0, mGnssNavigationMessageListeners:Landroid/util/ArrayMap;

    iget-object v2, p0, mGnssNavigationMessageProvider:Lcom/android/server/location/GnssNavigationMessageProvider;
    ...
    iget-object v1, p0, mGnssStatusListeners:Landroid/util/ArrayMap;

    iget-object v2, p0, mGnssStatusProvider:Lcom/android/server/location/GnssStatusListenerHelper;
...
.method private onUserChangedLocked(I)V
    ...
    invoke-direct {p0, v0}, onLocationModeChangedLocked(Z)V
...
.method private removeGnssDataListener(Landroid/os/IInterface;Lcom/android/server/location/RemoteListenerHelper;Landroid/util/ArrayMap;)V
    ...
    :cond_2
    iget-object v9, v1, mLocationUsageLogger:Lcom/android/server/LocationUsageLogger;
    ...
    invoke-direct {v1, v3, v6}, unlinkFromListenerDeathNotificationLocked(Landroid/os/IBinder;Lcom/android/server/LocationManagerService$LinkedListenerBase;)Z
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_1
...
.method private removeUpdatesLocked(Lcom/android/server/LocationManagerService$Receiver;)V
    ...
    invoke-direct {p0, v0, p1}, unlinkFromListenerDeathNotificationLocked(Landroid/os/IBinder;Lcom/android/server/LocationManagerService$LinkedListenerBase;)Z
    ...
    invoke-direct {p0, v3}, applyRequirementsLocked(Ljava/lang/String;)V
...
.method private requestLocationUpdatesLocked(Landroid/location/LocationRequest;Lcom/android/server/LocationManagerService$Receiver;ILjava/lang/String;)V
    ...
    invoke-direct {p0, v6}, getLocationProviderLocked(Ljava/lang/String;)Lcom/android/server/LocationManagerService$LocationProvider;
    ...
    invoke-direct {p0, v1}, isThrottlingExemptLocked(Lcom/android/server/location/CallerIdentity;)Z
    ...
    invoke-direct {p0, v8}, isSettingsExemptLocked(Lcom/android/server/LocationManagerService$UpdateRecord;)Z
    ...
    :cond_6
    invoke-direct {p0, v6}, applyRequirementsLocked(Ljava/lang/String;)V
...
.method private updateGnssDataProviderOnUidImportanceChangedLocked(Landroid/util/ArrayMap;Lcom/android/server/location/RemoteListenerHelper;Ljava/util/function/Function;IZ)V
    ...
    invoke-static {p5}, foregroundAsString(Z)Ljava/lang/String;
    ...
    invoke-direct {p0, v3}, isThrottlingExemptLocked(Lcom/android/server/location/CallerIdentity;)Z
...
.method private updateProviderUseableLocked(Lcom/android/server/LocationManagerService$LocationProvider;)V
    ...
    iget-object v2, p0, mRecordsByProvider:Ljava/util/HashMap;
    ...
    invoke-direct {p0, v5}, isCurrentProfileLocked(I)Z
    ...
    :cond_0
    invoke-direct {p0, v4}, isSettingsExemptLocked(Lcom/android/server/LocationManagerService$UpdateRecord;)Z
    ...
    invoke-direct {p0, v4}, removeUpdatesLocked(Lcom/android/server/LocationManagerService$Receiver;)V
...
.method public addGnssBatchingCallback(Landroid/location/IBatchedLocationCallback;Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p2}, hasGnssPermissions(Ljava/lang/String;)Z
    ...
    iget-object v0, p0, mGnssBatchingProvider:Lcom/android/server/location/GnssBatchingProvider;
    ...
    :try_start_0
    iput-object p1, p0, mGnssBatchingCallback:Landroid/location/IBatchedLocationCallback;
    ...
    iput-object v8, p0, mGnssBatchingDeathCallback:Lcom/android/server/LocationManagerService$LinkedListener;

    invoke-interface {p1}, Landroid/location/IBatchedLocationCallback;->asBinder()Landroid/os/IBinder;

    move-result-object v2

    iget-object v3, p0, mGnssBatchingDeathCallback:Lcom/android/server/LocationManagerService$LinkedListener;

    invoke-direct {p0, v2, v3}, linkToListenerDeathNotificationLocked(Landroid/os/IBinder;Lcom/android/server/LocationManagerService$LinkedListenerBase;)Z
...
.method public addGnssMeasurementsListener(Landroid/location/IGnssMeasurementsListener;Ljava/lang/String;)Z
    ...
    iget-object v4, p0, mGnssMeasurementsProvider:Lcom/android/server/location/GnssMeasurementsProvider;

    iget-object v5, p0, mGnssMeasurementsListeners:Landroid/util/ArrayMap;
    ...
    invoke-direct/range {v0 .. v6}, addGnssDataListener(Landroid/os/IInterface;Ljava/lang/String;Ljava/lang/String;Lcom/android/server/location/RemoteListenerHelper;Landroid/util/ArrayMap;Ljava/util/function/Consumer;)Z
...
.method public addGnssNavigationMessageListener(Landroid/location/IGnssNavigationMessageListener;Ljava/lang/String;)Z
    ...
    iget-object v4, p0, mGnssNavigationMessageProvider:Lcom/android/server/location/GnssNavigationMessageProvider;

    iget-object v5, p0, mGnssNavigationMessageListeners:Landroid/util/ArrayMap;
...
.method public addTestProvider(Ljava/lang/String;Lcom/android/internal/location/ProviderProperties;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v3}, removeProviderLocked(Lcom/android/server/LocationManagerService$LocationProvider;)V
    ...
    invoke-direct {p0, v4}, addProviderLocked(Lcom/android/server/LocationManagerService$LocationProvider;)V
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v1, p0, mGnssMetricsProvider:Lcom/android/server/location/GnssLocationProvider$GnssMetricsProvider;
    ...
    iget-object v3, p0, mCurrentUserProfiles:[I
    ...
    iget v3, p0, mBatterySaverMode:I
    ...
    invoke-direct {p0, p2, v1}, dumpGnssDataListenersLocked(Ljava/io/PrintWriter;Landroid/util/ArrayMap;)V
    ...
    iget-object v1, p0, mRequestStatistics:Lcom/android/server/location/LocationRequestStatistics;
    ...
    :cond_8
    iget-object v1, p0, mGeofenceManager:Lcom/android/server/location/GeofenceManager;
    ...
    :goto_6
    iget-object v1, p0, mBlacklist:Lcom/android/server/location/LocationBlacklist;
    ...
    :goto_7
    iget-object v1, p0, mExtraLocationControllerPackage:Ljava/lang/String;
    ...
    iget-object v3, p0, mExtraLocationControllerPackage:Ljava/lang/String;
    ...
    iget-boolean v3, p0, mExtraLocationControllerPackageEnabled:Z
    ...
    :cond_d
    iget-object v1, p0, mLocationFudger:Lcom/android/server/location/LocationFudger;
    ...
    :cond_10
    iget-boolean v1, p0, mGnssBatchingInProgress:Z
...
.method public flushGnssBatch(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, hasGnssPermissions(Ljava/lang/String;)Z
    ...
    :cond_1
    iget-object v1, p0, mGnssBatchingProvider:Lcom/android/server/location/GnssBatchingProvider;
...
.method public getFromLocationName(Ljava/lang/String;DDDDILandroid/location/GeocoderParams;Ljava/util/List;)Ljava/lang/String;
    ...
    iget-object v1, v0, mGeocodeProvider:Lcom/android/server/location/GeocoderProxy;
...
.method public getGnssCapabilities(Ljava/lang/String;)J
    ...
    iget-object v0, p0, mGnssCapabilitiesProvider:Lcom/android/server/location/GnssCapabilitiesProvider;
...
.method public getGnssHardwareModelName()Ljava/lang/String;
    ...
    iget-object v0, p0, mGnssSystemInfoProvider:Lcom/android/server/location/GnssLocationProvider$GnssSystemInfoProvider;
...
.method public getLastLocation(Landroid/location/LocationRequest;Ljava/lang/String;)Landroid/location/Location;
    ...
    :cond_0
    :try_start_0
    sget-object v0, DEFAULT_LOCATION_REQUEST:Landroid/location/LocationRequest;
    ...
    invoke-direct {v1, v2}, checkPackageName(Ljava/lang/String;)V
    ...
    invoke-direct {v1, v5, v0}, checkResolutionLevelIsSufficientForProviderUseLocked(ILjava/lang/String;)V
    ...
    :try_start_1
    iget-object v0, v1, mBlacklist:Lcom/android/server/location/LocationBlacklist;
    ...
    :cond_3
    :try_start_6
    invoke-direct {v1, v0}, getLocationProviderLocked(Ljava/lang/String;)Lcom/android/server/LocationManagerService$LocationProvider;
    ...
    invoke-direct {v1, v12}, isCurrentProfileLocked(I)Z
    ...
    :try_start_9
    invoke-virtual {v1, v2}, isProviderPackage(Ljava/lang/String;)Z
    ...
    :try_start_d
    iget-object v13, v1, mLastLocationCoarseInterval:Ljava/util/HashMap;
    ...
    :cond_7
    :try_start_e
    iget-object v13, v1, mLastLocation:Ljava/util/HashMap;
    ...
    :cond_8
    :try_start_10
    invoke-static {v5}, resolutionLevelToOpStr(I)Ljava/lang/String;
    ...
    :try_start_12
    iget-object v4, v1, mAppOps:Landroid/app/AppOpsManager;
    ...
    iget-object v0, v1, mLocationFudger:Lcom/android/server/location/LocationFudger;
    ...
    invoke-direct {v1, v6, v7, v2, v5}, reportLocationAccessNoThrow(IILjava/lang/String;I)Z
...
.method public getProviderProperties(Ljava/lang/String;)Lcom/android/internal/location/ProviderProperties;
    ...
    invoke-direct {p0, v1, p1}, checkResolutionLevelIsSufficientForProviderUseLocked(ILjava/lang/String;)V
...
.method public getProviders(Landroid/location/Criteria;Z)Ljava/util/List;
    ...
    :cond_0
    invoke-direct {p0, v5}, getMinimumResolutionLevelForProviderUseLocked(Ljava/lang/String;)I
...
.method public injectGnssMeasurementCorrections(Landroid/location/GnssMeasurementCorrections;Ljava/lang/String;)V
    ...
    :cond_0
    iget-object v0, p0, mGnssMeasurementCorrectionsProvider:Lcom/android/server/location/GnssMeasurementCorrectionsProvider;
...
.method public injectLocation(Landroid/location/Location;)Z
    ...
    invoke-direct {p0, v2}, getLocationProviderLocked(Ljava/lang/String;)Lcom/android/server/LocationManagerService$LocationProvider;
    ...
    :cond_2
    iget-object v3, p0, mLastLocation:Ljava/util/HashMap;
    ...
    invoke-direct {p0, p1, v0}, updateLastLocationLocked(Landroid/location/Location;Ljava/lang/String;)V
...
.method public isExtraLocationControllerPackageEnabled()Z
    ...
    :try_start_0
    iget-boolean v1, p0, mExtraLocationControllerPackageEnabled:Z
...
.method public synthetic lambda$addGnssBatchingCallback$8$LocationManagerService(Landroid/location/IBatchedLocationCallback;)V
    ...
    invoke-virtual {p0}, stopGnssBatch()Z

    invoke-virtual {p0}, removeGnssBatchingCallback()V
...
.method public synthetic lambda$initializeLocked$2$LocationManagerService()V
    ...
    :try_start_0
    invoke-direct {p0}, onPermissionsChangedLocked()V
...
.method public synthetic lambda$initializeLocked$4$LocationManagerService(II)V
    ...
    :try_start_0
    invoke-direct {p0, p1, p2}, onUidImportanceChangedLocked(II)V
...
.method public synthetic lambda$initializeLocked$6$LocationManagerService(Landroid/os/PowerSaveState;)V
    ...
    invoke-direct {p0, v1}, onBatterySaverModeChangedLocked(I)V
...
.method public registerGnssStatusCallback(Landroid/location/IGnssStatusListener;Ljava/lang/String;)Z
    ...
    iget-object v4, p0, mGnssStatusProvider:Lcom/android/server/location/GnssStatusListenerHelper;

    iget-object v5, p0, mGnssStatusListeners:Landroid/util/ArrayMap;
...
.method public removeGeofence(Landroid/location/Geofence;Landroid/app/PendingIntent;Ljava/lang/String;)V
    ...
    :try_start_1
    iget-object v3, p0, mLocationUsageLogger:Lcom/android/server/LocationUsageLogger;
    ...
    iget-object v6, p0, mActivityManager:Landroid/app/ActivityManager;
...
.method public removeGnssBatchingCallback()V
    ...
    :try_start_0
    iget-object v1, p0, mGnssBatchingCallback:Landroid/location/IBatchedLocationCallback;

    invoke-interface {v1}, Landroid/location/IBatchedLocationCallback;->asBinder()Landroid/os/IBinder;

    move-result-object v1

    iget-object v2, p0, mGnssBatchingDeathCallback:Lcom/android/server/LocationManagerService$LinkedListener;

    invoke-direct {p0, v1, v2}, unlinkFromListenerDeathNotificationLocked(Landroid/os/IBinder;Lcom/android/server/LocationManagerService$LinkedListenerBase;)Z

    const/4 v1, 0x0

    iput-object v1, p0, mGnssBatchingCallback:Landroid/location/IBatchedLocationCallback;

    iput-object v1, p0, mGnssBatchingDeathCallback:Lcom/android/server/LocationManagerService$LinkedListener;
...
.method public removeGnssMeasurementsListener(Landroid/location/IGnssMeasurementsListener;)V
    ...
    iget-object v0, p0, mGnssMeasurementsProvider:Lcom/android/server/location/GnssMeasurementsProvider;

    iget-object v1, p0, mGnssMeasurementsListeners:Landroid/util/ArrayMap;

    invoke-direct {p0, p1, v0, v1}, removeGnssDataListener(Landroid/os/IInterface;Lcom/android/server/location/RemoteListenerHelper;Landroid/util/ArrayMap;)V
...
.method public removeGnssNavigationMessageListener(Landroid/location/IGnssNavigationMessageListener;)V
    ...
    iget-object v0, p0, mGnssNavigationMessageProvider:Lcom/android/server/location/GnssNavigationMessageProvider;
...
.method public removeTestProvider(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v5, p0, mRealProviders:Ljava/util/ArrayList;
...
.method public removeUpdates(Landroid/location/ILocationListener;Landroid/app/PendingIntent;Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-direct/range {v1 .. v7}, getReceiverLocked(Landroid/app/PendingIntent;IILjava/lang/String;Landroid/os/WorkSource;Z)Lcom/android/server/LocationManagerService$Receiver;
    ...
    invoke-direct/range {v1 .. v8}, getReceiverLocked(Landroid/location/LocationRequest;Landroid/location/ILocationListener;IILjava/lang/String;Landroid/os/WorkSource;Z)Lcom/android/server/LocationManagerService$Receiver;
    ...
    :try_start_1
    invoke-direct {p0, v1}, removeUpdatesLocked(Lcom/android/server/LocationManagerService$Receiver;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public requestGeofence(Landroid/location/LocationRequest;Landroid/location/Geofence;Landroid/app/PendingIntent;Ljava/lang/String;)V
    ...
    invoke-direct {v1, v6}, checkResolutionLevelIsSufficientForGeofenceUse(I)V

    if-eqz v9, :cond_4

    invoke-direct {v1, v8}, checkPackageName(Ljava/lang/String;)V
    ...
    invoke-direct {v1, v6, v0}, checkResolutionLevelIsSufficientForProviderUseLocked(ILjava/lang/String;)V
    ...
    invoke-direct {v1, v7, v6, v5}, createSanitizedRequest(Landroid/location/LocationRequest;IZ)Landroid/location/LocationRequest;
    ...
    :try_start_2
    iget-object v10, v1, mLocationUsageLogger:Lcom/android/server/LocationUsageLogger;
    ...
    :try_start_3
    iget-object v2, v1, mGeofenceManager:Lcom/android/server/location/GeofenceManager;
    :try_end_3
...
.method public requestLocationUpdates(Landroid/location/LocationRequest;Landroid/location/ILocationListener;Landroid/app/PendingIntent;Ljava/lang/String;)V
    ...
    iget-object v7, v9, mLock:Ljava/lang/Object;
    ...
    :goto_0
    :try_start_1
    invoke-direct {v9, v8}, checkPackageName(Ljava/lang/String;)V
    ...
    invoke-direct {v9, v5, v0}, checkResolutionLevelIsSufficientForProviderUseLocked(ILjava/lang/String;)V
    ...
    iget-object v1, v9, mContext:Landroid/content/Context;
    ...
    :cond_3
    :try_start_7
    iget-object v0, v9, mContext:Landroid/content/Context;
    ...
    invoke-direct {v9, v6, v5, v4}, createSanitizedRequest(Landroid/location/LocationRequest;IZ)Landroid/location/LocationRequest;
    ...
    :try_start_8
    invoke-virtual {v9, v15, v14, v8, v5}, checkLocationAccess(IILjava/lang/String;I)Z
    :try_end_8
    ...
    :goto_4
    :try_start_a
    iget-object v10, v9, mLocationUsageLogger:Lcom/android/server/LocationUsageLogger;
    ...
    iget-object v1, v9, mActivityManager:Landroid/app/ActivityManager;
    ...
    :goto_7
    invoke-direct {v9, v11, v0, v10, v12}, requestLocationUpdatesLocked(Landroid/location/LocationRequest;Lcom/android/server/LocationManagerService$Receiver;ILjava/lang/String;)V
    :try_end_d
...
.method public sendExtraCommand(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Z
    ...
    iget-object v1, p0, mLocationUsageLogger:Lcom/android/server/LocationUsageLogger;
    ...
    :cond_0
    iget-object v2, p0, mLocationUsageLogger:Lcom/android/server/LocationUsageLogger;
...
.method public setExtraLocationControllerPackage(Ljava/lang/String;)V
    ...
    :try_start_0
    iput-object p1, p0, mExtraLocationControllerPackage:Ljava/lang/String;
...
.method public setExtraLocationControllerPackageEnabled(Z)V
    ...
    :try_start_0
    iput-boolean p1, p0, mExtraLocationControllerPackageEnabled:Z
...
.method public startGnssBatch(JZLjava/lang/String;)Z
    ...
    invoke-direct {p0, p4}, hasGnssPermissions(Ljava/lang/String;)Z
    ...
    iput-boolean v1, p0, mGnssBatchingInProgress:Z
...
.method public stopGnssBatch()Z
    ...
    iput-boolean v2, p0, mGnssBatchingInProgress:Z
...
.method public systemRunning()V
    ...
    :try_start_0
    invoke-direct {p0}, initializeLocked()V
...
.method public unregisterGnssStatusCallback(Landroid/location/IGnssStatusListener;)V
    ...
    iget-object v0, p0, mGnssStatusProvider:Lcom/android/server/location/GnssStatusListenerHelper;
