...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mGrantedUriPermissions:Landroid/util/SparseArray;
    ...
    iput-object v0, p0, mH:Lcom/android/server/uri/UriGrantsManagerService$H;
    ...
    iput-object v1, p0, mGrantFile:Landroid/util/AtomicFile;
...
.method static synthetic access$200(Lcom/android/server/uri/UriGrantsManagerService;)V
    ...
    invoke-direct {p0}, writeGrantedUriPermissions()V
...
.method static synthetic access$400(Lcom/android/server/uri/UriGrantsManagerService;Lcom/android/server/uri/UriPermission;)V
    ...
    invoke-direct {p0, p1}, removeUriPermissionIfNeeded(Lcom/android/server/uri/UriPermission;)V
...
.method static synthetic access$500(Lcom/android/server/uri/UriGrantsManagerService;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, enforceNotIsolatedCaller(Ljava/lang/String;)V
...
.method static synthetic access$600(Lcom/android/server/uri/UriGrantsManagerService;)Landroid/util/SparseArray;
    ...
    iget-object v0, p0, mGrantedUriPermissions:Landroid/util/SparseArray;
...
.method private checkHoldingPermissions(Landroid/content/pm/IPackageManager;Landroid/content/pm/ProviderInfo;Lcom/android/server/uri/GrantUri;II)Z
    ...
    invoke-direct/range {v1 .. v7}, checkHoldingPermissionsInternal(Landroid/content/pm/IPackageManager;Landroid/content/pm/ProviderInfo;Lcom/android/server/uri/GrantUri;IIZ)Z
...
.method private findOrCreateUriPermission(Ljava/lang/String;Ljava/lang/String;ILcom/android/server/uri/GrantUri;)Lcom/android/server/uri/UriPermission;
    ...
    iget-object v1, p0, mGrantedUriPermissions:Landroid/util/SparseArray;
...
.method private grantUriPermissionUnchecked(ILjava/lang/String;Lcom/android/server/uri/GrantUri;ILcom/android/server/uri/UriPermissionOwner;)V
    ...
    invoke-direct {p0, v0, v1, v2}, getProviderInfo(Ljava/lang/String;II)Landroid/content/pm/ProviderInfo;
    ...
    invoke-direct {p0, v2, p2, p1, p3}, findOrCreateUriPermission(Ljava/lang/String;Ljava/lang/String;ILcom/android/server/uri/GrantUri;)Lcom/android/server/uri/UriPermission;
...
.method private maybePrunePersistedUriGrants(I)Z
    ...
    invoke-direct {p0, v3}, removeUriPermissionIfNeeded(Lcom/android/server/uri/UriPermission;)V
...
.method private schedulePersistUriGrants()V
    ...
    iget-object v0, p0, mH:Lcom/android/server/uri/UriGrantsManagerService$H;
...
.method private writeGrantedUriPermissions()V
    ...
    :try_start_0
    iget-object v3, p0, mGrantedUriPermissions:Landroid/util/SparseArray;
    ...
    iget-object v5, p0, mGrantedUriPermissions:Landroid/util/SparseArray;
    ...
    :try_start_1
    iget-object v4, p0, mGrantFile:Landroid/util/AtomicFile;
    ...
    iget-object v5, p0, mGrantFile:Landroid/util/AtomicFile;
...
.method checkAuthorityGrants(ILandroid/content/pm/ProviderInfo;IZ)Z
    ...
    invoke-direct {p0, v4, p2}, matchesProvider(Landroid/net/Uri;Landroid/content/pm/ProviderInfo;)Z
...
.method checkGrantUriPermission(ILjava/lang/String;Landroid/net/Uri;II)I
    ...
    invoke-virtual/range {v0 .. v5}, checkGrantUriPermission(ILjava/lang/String;Lcom/android/server/uri/GrantUri;II)I
...
.method checkGrantUriPermission(ILjava/lang/String;Lcom/android/server/uri/GrantUri;II)I
    ...
    invoke-direct {v8, v7, v0, v2}, getProviderInfo(Ljava/lang/String;II)Landroid/content/pm/ProviderInfo;
    ...
    invoke-direct/range {v1 .. v6}, checkHoldingPermissions(Landroid/content/pm/IPackageManager;Landroid/content/pm/ProviderInfo;Lcom/android/server/uri/GrantUri;II)Z
    ...
    invoke-virtual {v8, v11, v9, v12}, checkUriPermission(Lcom/android/server/uri/GrantUri;II)Z
...
.method checkGrantUriPermissionFromIntent(ILjava/lang/String;Landroid/content/Intent;ILcom/android/server/uri/NeededUriGrants;I)Lcom/android/server/uri/NeededUriGrants;
    ...
    invoke-virtual/range {v1 .. v6}, checkGrantUriPermission(ILjava/lang/String;Lcom/android/server/uri/GrantUri;II)I
    ...
    invoke-virtual/range {v1 .. v7}, checkGrantUriPermissionFromIntent(ILjava/lang/String;Landroid/content/Intent;ILcom/android/server/uri/NeededUriGrants;I)Lcom/android/server/uri/NeededUriGrants;
...
.method checkUriPermission(Lcom/android/server/uri/GrantUri;II)Z
    ...
    :cond_2
    iget-object v4, p0, mGrantedUriPermissions:Landroid/util/SparseArray;
...
.method public clearGrantedUriPermissions(Ljava/lang/String;I)V
    ...
    iget-object v0, p0, mAmInternal:Landroid/app/ActivityManagerInternal;
    ...
    :try_start_0
    invoke-virtual {p0, p1, p2, v1, v1}, removeUriPermissionsForPackage(Ljava/lang/String;IZZ)V
...
.method public getGrantedUriPermissions(Ljava/lang/String;I)Landroid/content/pm/ParceledListSlice;
    ...
    :try_start_0
    iget-object v2, p0, mGrantedUriPermissions:Landroid/util/SparseArray;
...
.method public getUriPermissions(Ljava/lang/String;ZZ)Landroid/content/pm/ParceledListSlice;
    ...
    invoke-direct {p0, v0}, enforceNotIsolatedCaller(Ljava/lang/String;)V
    ...
    :try_start_1
    iget-object v6, p0, mGrantedUriPermissions:Landroid/util/SparseArray;
    ...
    iget-object v8, p0, mGrantedUriPermissions:Landroid/util/SparseArray;
...
.method grantUriPermission(ILjava/lang/String;Lcom/android/server/uri/GrantUri;ILcom/android/server/uri/UriPermissionOwner;I)V
    ...
    invoke-virtual/range {v2 .. v7}, checkGrantUriPermission(ILjava/lang/String;Lcom/android/server/uri/GrantUri;II)I
    ...
    invoke-direct/range {v1 .. v6}, grantUriPermissionUnchecked(ILjava/lang/String;Lcom/android/server/uri/GrantUri;ILcom/android/server/uri/UriPermissionOwner;)V
...
.method grantUriPermissionFromIntent(ILjava/lang/String;Landroid/content/Intent;Lcom/android/server/uri/UriPermissionOwner;I)V
    ...
    :cond_1
    invoke-virtual {p0, v0, p4}, grantUriPermissionUncheckedFromIntent(Lcom/android/server/uri/NeededUriGrants;Lcom/android/server/uri/UriPermissionOwner;)V
...
.method public grantUriPermissionFromOwner(Landroid/os/IBinder;ILjava/lang/String;Landroid/net/Uri;III)V
    ...
    iget-object v10, v8, mAmInternal:Landroid/app/ActivityManagerInternal;
    ...
    iget-object v11, v8, mLock:Ljava/lang/Object;
    ...
    invoke-virtual/range {v1 .. v7}, grantUriPermission(ILjava/lang/String;Lcom/android/server/uri/GrantUri;ILcom/android/server/uri/UriPermissionOwner;I)V
...
.method grantUriPermissionUncheckedFromIntent(Lcom/android/server/uri/NeededUriGrants;Lcom/android/server/uri/UriPermissionOwner;)V
    ...
    invoke-direct/range {v2 .. v7}, grantUriPermissionUnchecked(ILjava/lang/String;Lcom/android/server/uri/GrantUri;ILcom/android/server/uri/UriPermissionOwner;)V
...
.method onActivityManagerInternalAdded()V
    ...
    iput-object v0, p0, mAmInternal:Landroid/app/ActivityManagerInternal;
...
.method readGrantedUriPermissions()V
    ...
    :try_start_0
    iget-object v0, v1, mGrantFile:Landroid/util/AtomicFile;
    ...
    :try_start_1
    invoke-direct {v1, v0, v10, v4}, getProviderInfo(Ljava/lang/String;II)Landroid/content/pm/ProviderInfo;
    ...
    invoke-direct {v1, v14, v15, v5, v0}, findOrCreateUriPermission(Ljava/lang/String;Ljava/lang/String;ILcom/android/server/uri/GrantUri;)Lcom/android/server/uri/UriPermission;
...
.method public releasePersistableUriPermission(Landroid/net/Uri;ILjava/lang/String;I)V
    ...
    iget-object v1, p0, mAmInternal:Landroid/app/ActivityManagerInternal;
    ...
    invoke-direct {p0}, getPmInternal()Landroid/content/pm/PackageManagerInternal;
    ...
    invoke-direct {p0, v1}, enforceNotIsolatedCaller(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v1, v4}, findUriPermissionLocked(ILcom/android/server/uri/GrantUri;)Lcom/android/server/uri/UriPermission;
    ...
    invoke-direct {p0, v0}, removeUriPermissionIfNeeded(Lcom/android/server/uri/UriPermission;)V
    ...
    invoke-direct {p0, v4}, removeUriPermissionIfNeeded(Lcom/android/server/uri/UriPermission;)V

    :cond_4
    if-eqz v3, :cond_5

    invoke-direct {p0}, schedulePersistUriGrants()V
...
.method removeUriPermissionsForPackage(Ljava/lang/String;IZZ)V
    ...
    iget-object v7, p0, mGrantedUriPermissions:Landroid/util/SparseArray;
...
.method revokeUriPermission(Ljava/lang/String;ILcom/android/server/uri/GrantUri;I)V
    ...
    invoke-direct {v6, v11, v0, v1}, getProviderInfo(Ljava/lang/String;II)Landroid/content/pm/ProviderInfo;
    ...
    invoke-direct/range {v0 .. v5}, checkHoldingPermissions(Landroid/content/pm/IPackageManager;Landroid/content/pm/ProviderInfo;Lcom/android/server/uri/GrantUri;II)Z
    ...
    iget-object v0, v6, mGrantedUriPermissions:Landroid/util/SparseArray;
    ...
    iget-object v1, v6, mGrantedUriPermissions:Landroid/util/SparseArray;
    ...
    invoke-direct/range {p0 .. p0}, schedulePersistUriGrants()V
    ...
    iget-object v3, v6, mGrantedUriPermissions:Landroid/util/SparseArray;
    ...
    iget-object v4, v6, mGrantedUriPermissions:Landroid/util/SparseArray;

    invoke-virtual {v4, v3}, Landroid/util/SparseArray;->keyAt(I)I

    move-result v4

    iget-object v5, v6, mGrantedUriPermissions:Landroid/util/SparseArray;
...
.method public takePersistableUriPermission(Landroid/net/Uri;ILjava/lang/String;I)V
    ...
    invoke-direct {p0, v1, v6}, findUriPermissionLocked(ILcom/android/server/uri/GrantUri;)Lcom/android/server/uri/UriPermission;
    ...
    :cond_6
    invoke-direct {p0, v1}, maybePrunePersistedUriGrants(I)Z
