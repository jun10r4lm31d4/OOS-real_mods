...
.method constructor <init>(Ljava/lang/String;Ljava/lang/String;ILcom/android/server/uri/GrantUri;)V
    ...
    iput-object p4, p0, uri:Lcom/android/server/uri/GrantUri;
...
.method private updateModeFlags()V
    ...
    iget v0, p0, modeFlags:I

    iget v1, p0, ownedModeFlags:I

    iget v2, p0, globalModeFlags:I
    ...
    iget-object v3, p0, uri:Lcom/android/server/uri/GrantUri;
...
.method public buildGrantedUriPermission()Landroid/app/GrantedUriPermission;
    ...
    iget-object v1, p0, uri:Lcom/android/server/uri/GrantUri;

    iget-object v1, v1, Lcom/android/server/uri/GrantUri;->uri:Landroid/net/Uri;

    iget-object v2, p0, targetPkg:Ljava/lang/String;
...
.method public buildPersistedPublicApiObject()Landroid/content/UriPermission;
    ...
    iget-wide v3, p0, persistedCreateTime:J
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    iget-object v1, p0, sourcePkg:Ljava/lang/String;
    ...
    iget-object v1, p0, targetPkg:Ljava/lang/String;
    ...
    iget-wide v0, p0, persistedCreateTime:J
    ...
    iget-wide v1, p0, persistedCreateTime:J
...
.method grantModes(ILcom/android/server/uri/UriPermissionOwner;)V
    ...
    invoke-direct {p0, p2}, addReadOwner(Lcom/android/server/uri/UriPermissionOwner;)V
    ...
    invoke-direct {p0, p2}, addWriteOwner(Lcom/android/server/uri/UriPermissionOwner;)V
...
.method releasePersistableModes(I)Z
    ...
    iput-wide v1, p0, persistedCreateTime:J
...
.method revokeModes(IZ)Z
    ...
    iput v4, p0, persistableModeFlags:I

    iget v4, p0, persistedModeFlags:I

    and-int/lit8 v4, v4, -0x2

    iput v4, p0, persistedModeFlags:I

    :cond_1
    iget v4, p0, globalModeFlags:I

    and-int/lit8 v4, v4, -0x2

    iput v4, p0, globalModeFlags:I

    iget-object v4, p0, mReadOwners:Landroid/util/ArraySet;
    ...
    :cond_2
    iput-object v5, p0, mReadOwners:Landroid/util/ArraySet;
    ...
    iget-object v4, p0, mWriteOwners:Landroid/util/ArraySet;
    ...
    :cond_5
    iput-object v5, p0, mWriteOwners:Landroid/util/ArraySet;
    ...
    iput-wide v4, p0, persistedCreateTime:J
...
.method takePersistableModes(I)Z
    ...
    iput-wide v3, p0, persistedCreateTime:J
