...
.method static constructor <clinit>()V
    ...
    sput-object v0, SERVICE_TO_BIND_TO:Landroid/content/ComponentName;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mUidToStorage:Ljava/util/concurrent/ConcurrentMap;
    ...
    iput-object v0, p0, mImpl:Lcom/android/server/companion/CompanionDeviceManagerService$CompanionDeviceManagerImpl;
    ...
    iput-object v0, p0, mIdleController:Landroid/os/IDeviceIdleController;
    ...
    iput-object v0, p0, mAppOpsManager:Lcom/android/internal/app/IAppOpsService;

    invoke-direct {p0}, registerPackageMonitor()V
...
.method static synthetic access$000(Lcom/android/server/companion/CompanionDeviceManagerService;Ljava/util/function/Function;I)V
    ...
    invoke-direct {p0, p1, p2}, updateAssociations(Ljava/util/function/Function;I)V
...
.method static synthetic access$100(Lcom/android/server/companion/CompanionDeviceManagerService;ILjava/lang/String;)Ljava/util/Set;
    ...
    invoke-direct {p0, p1, p2}, readAllAssociations(ILjava/lang/String;)Ljava/util/Set;
...
.method static synthetic access$1100(Lcom/android/server/companion/CompanionDeviceManagerService;)Lcom/android/internal/app/IAppOpsService;
    ...
    iget-object v0, p0, mAppOpsManager:Lcom/android/internal/app/IAppOpsService;
...
.method static synthetic access$1200(Lcom/android/server/companion/CompanionDeviceManagerService;Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    invoke-direct {p0, p1, p2}, getPackageInfo(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
...
.method static synthetic access$1300(Lcom/android/server/companion/CompanionDeviceManagerService;)Landroid/companion/ICompanionDeviceDiscoveryServiceCallback$Stub;
    ...
    invoke-direct {p0}, getServiceCallback()Landroid/companion/ICompanionDeviceDiscoveryServiceCallback$Stub;
...
.method static synthetic access$1500(Lcom/android/server/companion/CompanionDeviceManagerService;I)Ljava/util/Set;
    ...
    invoke-direct {p0, p1}, readAllAssociations(I)Ljava/util/Set;
...
.method static synthetic access$200(Lcom/android/server/companion/CompanionDeviceManagerService;Ljava/lang/String;I)V
    ...
    invoke-direct {p0, p1, p2}, updateSpecialAccessPermissionForAssociatedPackage(Ljava/lang/String;I)V
...
.method static synthetic access$300()I
    ...
    invoke-static {}, getCallingUserId()I
...
.method static synthetic access$400()Landroid/content/ComponentName;
    ...
    sget-object v0, SERVICE_TO_BIND_TO:Landroid/content/ComponentName;
...
.method static synthetic access$500(Lcom/android/server/companion/CompanionDeviceManagerService;Landroid/companion/AssociationRequest;Landroid/companion/IFindDeviceCallback;Ljava/lang/String;)Landroid/content/ServiceConnection;
    ...
    invoke-direct {p0, p1, p2, p3}, createServiceConnection(Landroid/companion/AssociationRequest;Landroid/companion/IFindDeviceCallback;Ljava/lang/String;)Landroid/content/ServiceConnection;
...
.method static synthetic access$600(Lcom/android/server/companion/CompanionDeviceManagerService;)Landroid/companion/AssociationRequest;
    ...
    iget-object v0, p0, mRequest:Landroid/companion/AssociationRequest;
...
.method static synthetic access$602(Lcom/android/server/companion/CompanionDeviceManagerService;Landroid/companion/AssociationRequest;)Landroid/companion/AssociationRequest;
    ...
    iput-object p1, p0, mRequest:Landroid/companion/AssociationRequest;
...
.method static synthetic access$700(Lcom/android/server/companion/CompanionDeviceManagerService;)Landroid/companion/IFindDeviceCallback;
    ...
    iget-object v0, p0, mFindDeviceCallback:Landroid/companion/IFindDeviceCallback;
...
.method static synthetic access$702(Lcom/android/server/companion/CompanionDeviceManagerService;Landroid/companion/IFindDeviceCallback;)Landroid/companion/IFindDeviceCallback;
    ...
    iput-object p1, p0, mFindDeviceCallback:Landroid/companion/IFindDeviceCallback;
...
.method private cleanup()V
    ...
    invoke-direct {p0, v1}, unbind(Landroid/content/ServiceConnection;)Landroid/content/ServiceConnection;

    move-result-object v1

    iput-object v1, p0, mServiceConnection:Landroid/content/ServiceConnection;

    iget-object v1, p0, mFindDeviceCallback:Landroid/companion/IFindDeviceCallback;

    const/4 v2, 0x0

    invoke-static {v1, p0, v2}, unlinkToDeath(Landroid/os/IInterface;Landroid/os/IBinder$DeathRecipient;I)Landroid/os/IInterface;

    move-result-object v1

    check-cast v1, Landroid/companion/IFindDeviceCallback;

    iput-object v1, p0, mFindDeviceCallback:Landroid/companion/IFindDeviceCallback;

    const/4 v1, 0x0

    iput-object v1, p0, mRequest:Landroid/companion/AssociationRequest;

    iput-object v1, p0, mCallingPackage:Ljava/lang/String;
...
.method private getStorageFileForUser(I)Landroid/util/AtomicFile;
    ...
    iget-object v0, p0, mUidToStorage:Ljava/util/concurrent/ConcurrentMap;
...
.method public static synthetic lambda$wnUkAY8uXyjMGM59-bNpzLLMJ1I(Lcom/android/server/companion/CompanionDeviceManagerService;Landroid/content/pm/PackageInfo;)V
    ...
    invoke-direct {p0, p1}, updateSpecialAccessPermissionAsSystem(Landroid/content/pm/PackageInfo;)V
...
.method private readAllAssociations(I)Ljava/util/Set;
    ...
    invoke-direct {p0, p1, v0}, readAllAssociations(ILjava/lang/String;)Ljava/util/Set;
...
.method private readAllAssociations(ILjava/lang/String;)Ljava/util/Set;
    ...
    invoke-direct/range {p0 .. p1}, getStorageFileForUser(I)Landroid/util/AtomicFile;
...
.method private recordAssociation(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v1}, updateAssociations(Ljava/util/function/Function;)V
...
.method private updateAssociations(Ljava/util/function/Function;)V
    ...
    invoke-direct {p0, p1, v0}, updateAssociations(Ljava/util/function/Function;I)V
...
.method private updateAssociations(Ljava/util/function/Function;I)V
    ...
    invoke-direct {p0, p2}, getStorageFileForUser(I)Landroid/util/AtomicFile;
    ...
    :try_start_0
    invoke-direct {p0, p2}, readAllAssociations(I)Ljava/util/Set;
...
.method private updateSpecialAccessPermissionAsSystem(Landroid/content/pm/PackageInfo;)V
    ...
    invoke-static {v0, v1, v2}, containsEither([Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, mIdleController:Landroid/os/IDeviceIdleController;
    ...
    invoke-static {v1, v2, v3}, containsEither([Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method addAssociation(ILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p2, p1}, updateSpecialAccessPermissionForAssociatedPackage(Ljava/lang/String;I)V

    invoke-direct {p0, p2, p3}, recordAssociation(Ljava/lang/String;Ljava/lang/String;)V
...
.method public onStart()V
    ...
    iget-object v0, p0, mImpl:Lcom/android/server/companion/CompanionDeviceManagerService$CompanionDeviceManagerImpl;
...
.method removeAssociation(ILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0}, updateAssociations(Ljava/util/function/Function;)V
