...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Lcom/android/internal/os/BatteryStatsImpl$Uid$Pkg$Serv;Landroid/content/ComponentName;Landroid/content/ComponentName;Ljava/lang/String;ILandroid/content/Intent$FilterComparison;Landroid/content/pm/ServiceInfo;ZLjava/lang/Runnable;)V
    ...
    iput-object p4, p0, instanceName:Landroid/content/ComponentName;

    invoke-virtual {p4}, Landroid/content/ComponentName;->flattenToShortString()Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, shortInstanceName:Ljava/lang/String;

    iput-object p5, p0, definingPackageName:Ljava/lang/String;

    iput p6, p0, definingUid:I

    iput-object p7, p0, intent:Landroid/content/Intent$FilterComparison;

    iput-object p8, p0, serviceInfo:Landroid/content/pm/ServiceInfo;
    ...
    iput-object p10, p0, restarter:Ljava/lang/Runnable;

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J

    move-result-wide v0

    iput-wide v0, p0, createRealTime:J
    ...
    iput-boolean p9, p0, createdFromFg:Z
...
.method private setHasStartedWhitelistingBgActivityStarts(Z)V
    ...
    iget-boolean v0, p0, mHasStartedWhitelistingBgActivityStarts:Z

    if-eq v0, p1, :cond_0

    iput-boolean p1, p0, mHasStartedWhitelistingBgActivityStarts:Z

    invoke-direct {p0}, updateParentProcessBgActivityStartsWhitelistingToken()V
...
.method private updateParentProcessBgActivityStartsWhitelistingToken()V
    ...
    :cond_0
    iget-boolean v1, p0, mHasStartedWhitelistingBgActivityStarts:Z

    if-nez v1, :cond_2

    iget-boolean v1, p0, mHasBindingWhitelistingBgActivityStarts:Z
...
.method addConnection(Landroid/os/IBinder;Lcom/android/server/am/ConnectionRecord;)V
    ...
    iget-object v0, p0, connections:Landroid/util/ArrayMap;
    ...
    iget-object v1, p0, connections:Landroid/util/ArrayMap;
...
.method public clearDeliveredStartsLocked()V
    ...
    iget-object v0, p0, deliveredStarts:Ljava/util/ArrayList;
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    iget-object v0, p0, isolatedProc:Lcom/android/server/am/ProcessRecord;
    ...
    :cond_3
    iget-boolean v0, p0, whitelistManager:Z
    ...
    :cond_4
    iget-boolean v0, p0, mHasBindingWhitelistingBgActivityStarts:Z
    ...
    :cond_7
    iget-boolean v0, p0, isForeground:Z
    ...
    iget-wide v0, p0, createRealTime:J
    ...
    iget-wide v0, p0, startingBgTimeout:J
    ...
    iget-wide v0, p0, lastActivity:J
    ...
    iget-boolean v0, p0, createdFromFg:Z

    invoke-virtual {p1, v0}, Ljava/io/PrintWriter;->println(Z)V

    iget v0, p0, pendingConnectionGroup:I
    ...
    iget v0, p0, pendingConnectionImportance:I

    invoke-virtual {p1, v0}, Ljava/io/PrintWriter;->println(I)V

    :cond_a
    iget-boolean v0, p0, startRequested:Z

    if-nez v0, :cond_b

    iget-boolean v0, p0, delayedStop:Z
    ...
    iget-boolean v0, p0, stopIfKilled:Z
    ...
    iget-boolean v0, p0, callStart:Z
    ...
    iget-boolean v0, p0, executeFg:Z
    ...
    iget-wide v0, p0, executingStart:J
    ...
    :cond_d
    iget-boolean v0, p0, destroying:Z

    const-wide/16 v1, 0x0

    if-nez v0, :cond_e

    iget-wide v3, p0, destroyTime:J
    ...
    :cond_f
    iget v0, p0, crashCount:I

    if-nez v0, :cond_10

    iget v0, p0, restartCount:I

    if-nez v0, :cond_10

    iget-wide v3, p0, restartDelay:J

    cmp-long v0, v3, v1

    if-nez v0, :cond_10

    iget-wide v3, p0, nextRestartTime:J
    ...
    iget-wide v0, p0, restartDelay:J
    ...
    iget-wide v0, p0, nextRestartTime:J
    ...
    invoke-virtual/range {v0 .. v5}, dumpStartList(Ljava/io/PrintWriter;Ljava/lang/String;Ljava/util/List;J)V

    :cond_12
    iget-object v0, p0, pendingStarts:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, pendingStarts:Ljava/util/ArrayList;
    ...
    :cond_13
    iget-object v0, p0, bindings:Landroid/util/ArrayMap;
    ...
    :goto_0
    iget-object v2, p0, bindings:Landroid/util/ArrayMap;
    ...
    :goto_1
    iget-object v2, p0, connections:Landroid/util/ArrayMap;
...
.method public findDeliveredStart(IZZ)Lcom/android/server/am/ServiceRecord$StartItem;
    ...
    iget-object v2, p0, deliveredStarts:Ljava/util/ArrayList;
...
.method public forceClearTracker()V
    ...
    iget-object v0, p0, tracker:Lcom/android/internal/app/procstats/ServiceState;
    ...
    iput-object v0, p0, tracker:Lcom/android/internal/app/procstats/ServiceState;
...
.method public getComponentName()Landroid/content/ComponentName;
    ...
    iget-object v0, p0, name:Landroid/content/ComponentName;
...
.method public synthetic lambda$whitelistBgActivityStartsOnServiceStart$0$ServiceRecord()V
    ...
    iget-object v2, p0, mAppForStartedWhitelistingBgActivityStarts:Lcom/android/server/am/ProcessRecord;

    if-ne v1, v2, :cond_0

    const/4 v1, 0x0

    invoke-direct {p0, v1}, setHasStartedWhitelistingBgActivityStarts(Z)V

    goto :goto_0

    :cond_0
    iget-object v1, p0, mAppForStartedWhitelistingBgActivityStarts:Lcom/android/server/am/ProcessRecord;
    ...
    iput-object v1, p0, mAppForStartedWhitelistingBgActivityStarts:Lcom/android/server/am/ProcessRecord;
...
.method public makeRestarting(IJ)V
    ...
    iget-object v0, p0, restartTracker:Lcom/android/internal/app/procstats/ServiceState;
    ...
    iput-object v0, p0, restartTracker:Lcom/android/internal/app/procstats/ServiceState;
...
.method public postNotification()V
    ...
    iget-object v1, p0, foregroundNoti:Landroid/app/Notification;

    if-eqz v1, :cond_0

    iget-object v10, p0, packageName:Ljava/lang/String;

    iget v11, p0, foregroundId:I

    iget-object v12, p0, foregroundNoti:Landroid/app/Notification;

    move-object v8, p0

    iget-object v1, p0, ams:Lcom/android/server/am/ActivityManagerService;
...
.method public resetRestartCounter()V
    ...
    iput-wide v0, p0, restartDelay:J

    iput-wide v0, p0, restartTime:J
...
.method public retrieveAppBindingLocked(Landroid/content/Intent;Lcom/android/server/am/ProcessRecord;)Lcom/android/server/am/AppBindRecord;
    ...
    iget-object v1, p0, bindings:Landroid/util/ArrayMap;
...
.method setHasBindingWhitelistingBgActivityStarts(Z)V
    ...
    iput-boolean p1, p0, mHasBindingWhitelistingBgActivityStarts:Z
...
.method public setProcess(Lcom/android/server/am/ProcessRecord;)V
    ...
    iget-object v0, p0, mAppForStartedWhitelistingBgActivityStarts:Lcom/android/server/am/ProcessRecord;
    ...
    iget-object v1, p0, mStartedWhitelistingBgActivityStartsCleanUp:Ljava/lang/Runnable;
    ...
    :goto_0
    iput-object v0, p0, mAppForStartedWhitelistingBgActivityStarts:Lcom/android/server/am/ProcessRecord;
    ...
    :cond_6
    iput-object p1, p0, app:Lcom/android/server/am/ProcessRecord;
    ...
    iput v0, p0, pendingConnectionImportance:I

    iput v0, p0, pendingConnectionGroup:I
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, shortInstanceName:Ljava/lang/String;
...
.method updateHasBindingWhitelistingBgActivityStarts()V
    ...
    :cond_3
    :goto_3
    invoke-virtual {p0, v0}, setHasBindingWhitelistingBgActivityStarts(Z)V
...
.method public updateWhitelistManager()V
    ...
    iput-boolean v0, p0, whitelistManager:Z
    ...
    iput-boolean v1, p0, whitelistManager:Z
...
.method whitelistBgActivityStartsOnServiceStart()V
    ...
    invoke-direct {p0, v0}, setHasStartedWhitelistingBgActivityStarts(Z)V
    ...
    :cond_0
    iget-object v0, p0, mStartedWhitelistingBgActivityStartsCleanUp:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mStartedWhitelistingBgActivityStartsCleanUp:Ljava/lang/Runnable;
...
.method writeToProto(Landroid/util/proto/ProtoOutputStream;J)V
    ...
    iget-object v1, v0, shortInstanceName:Ljava/lang/String;

    const-wide v12, 0x10900000001L

    invoke-virtual {v9, v12, v13, v1}, Landroid/util/proto/ProtoOutputStream;->write(JLjava/lang/String;)V

    iget-object v1, v0, app:Lcom/android/server/am/ProcessRecord;
    ...
    :cond_1
    iget-object v1, v0, intent:Landroid/content/Intent$FilterComparison;
    ...
    iget-object v3, v0, processName:Ljava/lang/String;

    invoke-virtual {v9, v1, v2, v3}, Landroid/util/proto/ProtoOutputStream;->write(JLjava/lang/String;)V

    const-wide v1, 0x10900000007L

    iget-object v3, v0, permission:Ljava/lang/String;
    ...
    iget-object v1, v0, appInfo:Landroid/content/pm/ApplicationInfo;
    ...
    iget-object v3, v0, appInfo:Landroid/content/pm/ApplicationInfo;
    ...
    :cond_5
    iget-object v1, v0, isolatedProc:Lcom/android/server/am/ProcessRecord;
    ...
    iget-boolean v3, v0, whitelistManager:Z

    invoke-virtual {v9, v1, v2, v3}, Landroid/util/proto/ProtoOutputStream;->write(JZ)V

    const-wide v1, 0x1080000000cL

    iget-boolean v3, v0, delayed:Z

    invoke-virtual {v9, v1, v2, v3}, Landroid/util/proto/ProtoOutputStream;->write(JZ)V

    iget-boolean v1, v0, isForeground:Z

    const-wide v12, 0x10500000001L

    if-nez v1, :cond_7

    iget v1, v0, foregroundId:I
    ...
    iget v3, v0, foregroundId:I

    invoke-virtual {v9, v12, v13, v3}, Landroid/util/proto/ProtoOutputStream;->write(JI)V

    iget-object v3, v0, foregroundNoti:Landroid/app/Notification;
    ...
    iget-wide v4, v0, createRealTime:J
    ...
    iget-boolean v3, v0, createdFromFg:Z

    invoke-virtual {v9, v1, v2, v3}, Landroid/util/proto/ProtoOutputStream;->write(JZ)V

    iget-boolean v1, v0, startRequested:Z

    if-nez v1, :cond_9

    iget-boolean v1, v0, delayedStop:Z

    if-nez v1, :cond_9

    iget v1, v0, lastStartId:I
    ...
    iget-boolean v1, v0, executeFg:Z
    ...
    :cond_b
    iget-boolean v1, v0, destroying:Z

    const-wide/16 v14, 0x0

    if-nez v1, :cond_c

    iget-wide v1, v0, destroyTime:J
    ...
    :cond_d
    iget v1, v0, crashCount:I

    if-nez v1, :cond_e

    iget v1, v0, restartCount:I

    if-nez v1, :cond_e

    iget-wide v1, v0, restartDelay:J

    cmp-long v1, v1, v14

    if-nez v1, :cond_e

    iget-wide v1, v0, nextRestartTime:J
    ...
    :cond_f
    iget-object v1, v0, deliveredStarts:Ljava/util/ArrayList;
    ...
    :cond_10
    iget-object v1, v0, pendingStarts:Ljava/util/ArrayList;
    ...
    :cond_11
    iget-object v1, v0, bindings:Landroid/util/ArrayMap;
    ...
    iget-object v3, v0, bindings:Landroid/util/ArrayMap;
    ...
    :cond_12
    iget-object v1, v0, connections:Landroid/util/ArrayMap;
    ...
    iget-object v3, v0, connections:Landroid/util/ArrayMap;
