...
.method constructor <init>(Lcom/android/server/am/ProcessList;III)V
    ...
    iput-object v0, p0, mAppRanges:Lcom/android/internal/app/ProcessMap;

    iput p2, p0, mFirstUid:I

    iput p4, p0, mNumUidsPerRange:I
    ...
    iput v0, p0, mNumUidRanges:I

    new-instance v0, Ljava/util/BitSet;

    iget v1, p0, mNumUidRanges:I

    invoke-direct {v0, v1}, Ljava/util/BitSet;-><init>(I)V

    iput-object v0, p0, mAvailableUidRanges:Ljava/util/BitSet;

    iget-object v0, p0, mAvailableUidRanges:Ljava/util/BitSet;
...
.method freeUidRangeLocked(Landroid/content/pm/ApplicationInfo;)V
    ...
    iget-object v0, p0, mAppRanges:Lcom/android/internal/app/ProcessMap;
    ...
    iget v2, p0, mFirstUid:I

    sub-int/2addr v1, v2

    iget v2, p0, mNumUidsPerRange:I

    div-int/2addr v1, v2

    iget-object v2, p0, mAvailableUidRanges:Ljava/util/BitSet;

    invoke-virtual {v2, v1}, Ljava/util/BitSet;->set(I)V

    iget-object v2, p0, mAppRanges:Lcom/android/internal/app/ProcessMap;
...
.method getOrCreateIsolatedUidRangeLocked(Ljava/lang/String;I)Lcom/android/server/am/ProcessList$IsolatedUidRange;
    ...
    invoke-virtual {p0, p1, p2}, getIsolatedUidRangeLocked(Ljava/lang/String;I)Lcom/android/server/am/ProcessList$IsolatedUidRange;

    move-result-object v0

    if-nez v0, :cond_1

    iget-object v1, p0, mAvailableUidRanges:Ljava/util/BitSet;
    ...
    iget-object v5, p0, this$0:Lcom/android/server/am/ProcessList;
    ...
    iget-object v3, p0, mAppRanges:Lcom/android/internal/app/ProcessMap;
