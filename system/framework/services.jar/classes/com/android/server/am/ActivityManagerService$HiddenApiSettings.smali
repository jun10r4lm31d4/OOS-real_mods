...
.method public constructor <init>(Landroid/os/Handler;Landroid/content/Context;)V
    ...
    iput-object v0, p0, mExemptions:Ljava/util/List;

    const/4 v0, -0x1

    iput v0, p0, mLogSampleRate:I

    iput v0, p0, mStatslogSampleRate:I
...
.method private initializeSampleRates()V
    ...
    invoke-direct {p0, v2, v0}, setSampleRates(II)V
...
.method private setSampleRates(II)V
    ...
    iget v1, p0, mLogSampleRate:I

    if-eq p1, v1, :cond_0

    iput p1, p0, mLogSampleRate:I

    sget-object v1, Landroid/os/Process;->ZYGOTE_PROCESS:Landroid/os/ZygoteProcess;

    iget v2, p0, mLogSampleRate:I
    ...
    iget v0, p0, mStatslogSampleRate:I

    if-eq p2, v0, :cond_1

    iput p2, p0, mStatslogSampleRate:I

    sget-object v0, Landroid/os/Process;->ZYGOTE_PROCESS:Landroid/os/ZygoteProcess;

    iget v1, p0, mStatslogSampleRate:I
...
.method private update()V
    ...
    iget-object v1, p0, mExemptionsStr:Ljava/lang/String;
    ...
    iput-object v0, p0, mExemptionsStr:Ljava/lang/String;
    ...
    iput-boolean v1, p0, mBlacklistDisabled:Z

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object v1

    iput-object v1, p0, mExemptions:Ljava/util/List;
    ...
    iget-object v2, p0, mExemptions:Ljava/util/List;
    ...
    invoke-direct {p0, v1}, getValidEnforcementPolicy(Ljava/lang/String;)I

    move-result v1

    iput v1, p0, mPolicy:I
...
.method isDisabled()Z
    ...
    iget-boolean v0, p0, mBlacklistDisabled:Z
...
.method public onPropertiesChanged(Landroid/provider/DeviceConfig$Properties;)V
    ...
    invoke-direct {p0, v0, v1}, setSampleRates(II)V
...
.method public registerObserver()V
    ...
    invoke-direct {p0}, initializeSampleRates()V
