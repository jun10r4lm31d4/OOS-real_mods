...
.method constructor <init>(Lcom/android/server/am/ActiveServices;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;IZLjava/lang/String;)V
    ...
    iput-object v1, v0, this$0:Lcom/android/server/am/ActiveServices;
    ...
    iput-object v4, v0, services:Ljava/util/ArrayList;

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J

    move-result-wide v4

    iput-wide v4, v0, nowReal:J

    const/4 v4, 0x0

    iput-boolean v4, v0, needSep:Z

    iput-boolean v4, v0, printedAnything:Z

    iput-boolean v4, v0, printed:Z

    move-object/from16 v5, p2

    iput-object v5, v0, fd:Ljava/io/FileDescriptor;

    move-object/from16 v6, p3

    iput-object v6, v0, pw:Ljava/io/PrintWriter;

    iput-object v2, v0, args:[Ljava/lang/String;

    move/from16 v7, p6

    iput-boolean v7, v0, dumpAll:Z

    iput-object v3, v0, dumpPackage:Ljava/lang/String;
    ...
    iput-object v8, v0, matcher:Lcom/android/server/am/ActivityManagerService$ItemMatcher;

    iget-object v8, v0, matcher:Lcom/android/server/am/ActivityManagerService$ItemMatcher;
    ...
    iget-object v15, v0, matcher:Lcom/android/server/am/ActivityManagerService$ItemMatcher;
    ...
    :cond_1
    iget-object v1, v0, services:Ljava/util/ArrayList;
...
.method private dumpHeaderLocked()V
    ...
    iget-object v0, p0, pw:Ljava/io/PrintWriter;
...
.method private dumpRemainsLocked()V
    ...
    iget-object v1, v0, this$0:Lcom/android/server/am/ActiveServices;
    ...
    iput-boolean v3, v0, printed:Z

    const/4 v1, 0x0

    :goto_0
    iget-object v5, v0, this$0:Lcom/android/server/am/ActiveServices;
    ...
    iget-object v6, v0, matcher:Lcom/android/server/am/ActivityManagerService$ItemMatcher;
    ...
    :cond_0
    iget-object v6, v0, dumpPackage:Ljava/lang/String;
    ...
    iget-boolean v6, v0, printed:Z

    if-nez v6, :cond_3

    iget-boolean v6, v0, needSep:Z

    if-eqz v6, :cond_2

    iget-object v6, v0, pw:Ljava/io/PrintWriter;
    ...
    :cond_12
    iget-object v8, v0, dumpPackage:Ljava/lang/String;
    ...
    iget-boolean v8, v0, printed:Z

    if-nez v8, :cond_15

    iget-boolean v8, v0, needSep:Z

    if-eqz v8, :cond_14

    iget-object v8, v0, pw:Ljava/io/PrintWriter;
    ...
    :cond_18
    iget-object v1, v0, matcher:Lcom/android/server/am/ActivityManagerService$ItemMatcher;
    ...
    iget-object v10, v0, this$0:Lcom/android/server/am/ActiveServices;
    ...
    iget-object v14, v0, dumpPackage:Ljava/lang/String;
    ...
    iget-boolean v14, v0, needSep:Z

    if-eqz v14, :cond_1b

    iget-object v14, v0, pw:Ljava/io/PrintWriter;
    ...
    :cond_1c
    iget-object v12, v0, pw:Ljava/io/PrintWriter;
    ...
    iget-boolean v11, v0, needSep:Z

    if-eqz v11, :cond_20

    iget-object v11, v0, pw:Ljava/io/PrintWriter;
    ...
    :cond_22
    iget-boolean v1, v0, printedAnything:Z

    if-nez v1, :cond_23

    iget-object v1, v0, pw:Ljava/io/PrintWriter;
...
.method private dumpServiceClient(Lcom/android/server/am/ServiceRecord;)V
    ...
    :cond_1
    iget-object v2, p0, pw:Ljava/io/PrintWriter;
    ...
    iget-object v4, p0, args:[Ljava/lang/String;
    ...
    iget-object v3, p0, fd:Ljava/io/FileDescriptor;
    ...
    iget-object v3, p0, pw:Ljava/io/PrintWriter;
...
.method private dumpServiceLocalLocked(Lcom/android/server/am/ServiceRecord;)V
    ...
    invoke-direct {p0, v0}, dumpUserHeaderLocked(I)V
    ...
    iget-wide v2, p0, nowReal:J

    iget-object v4, p0, pw:Ljava/io/PrintWriter;
    ...
    iget-object v1, p0, pw:Ljava/io/PrintWriter;
    ...
    iget-object v5, p0, pw:Ljava/io/PrintWriter;
    ...
    iget-object v6, p0, pw:Ljava/io/PrintWriter;
...
.method private dumpUserHeaderLocked(I)V
    ...
    iget-boolean v0, p0, printed:Z

    const/4 v1, 0x1

    if-nez v0, :cond_1

    iget-boolean v0, p0, printedAnything:Z
    ...
    iput-boolean v1, p0, printed:Z

    :cond_1
    iput-boolean v1, p0, printedAnything:Z

    iget-boolean v0, p0, needSep:Z
...
.method private dumpUserRemainsLocked(I)V
    ...
    iget-object v7, p0, matcher:Lcom/android/server/am/ActivityManagerService$ItemMatcher;
    ...
    :cond_0
    iget-object v7, p0, dumpPackage:Ljava/lang/String;
    ...
    :cond_1
    iget-boolean v7, p0, printed:Z

    if-nez v7, :cond_3

    iget-boolean v7, p0, printedAnything:Z

    if-eqz v7, :cond_2

    iget-object v7, p0, pw:Ljava/io/PrintWriter;
    ...
    iput-boolean v5, p0, printed:Z

    :cond_3
    iput-boolean v5, p0, printedAnything:Z
    ...
    iget-object v6, p0, matcher:Lcom/android/server/am/ActivityManagerService$ItemMatcher;
    ...
    :cond_5
    iget-object v6, p0, dumpPackage:Ljava/lang/String;
    ...
    :cond_6
    iget-boolean v6, p0, printed:Z

    if-nez v6, :cond_8

    iget-boolean v6, p0, printedAnything:Z
...
.method dumpLocked()V
    ...
    invoke-direct {p0}, dumpHeaderLocked()V
    ...
    :goto_1
    iget-object v6, p0, services:Ljava/util/ArrayList;
    ...
    :cond_1
    invoke-direct {p0, v6}, dumpServiceLocalLocked(Lcom/android/server/am/ServiceRecord;)V

    goto :goto_2

    :cond_2
    :goto_3
    iget-boolean v6, p0, needSep:Z

    iget-boolean v7, p0, printed:Z

    or-int/2addr v6, v7

    iput-boolean v6, p0, needSep:Z

    :cond_3
    invoke-direct {p0, v4}, dumpUserRemainsLocked(I)V
    :try_end_0
    ...
    :goto_4
    invoke-direct {p0}, dumpRemainsLocked()V
...
.method dumpWithClient()V
    ...
    :cond_1
    iget-object v7, p0, this$0:Lcom/android/server/am/ActiveServices;
    ...
    invoke-direct {p0, v6}, dumpServiceClient(Lcom/android/server/am/ServiceRecord;)V
    :try_end_3
    ...
    :cond_3
    iget-object v6, p0, this$0:Lcom/android/server/am/ActiveServices;
