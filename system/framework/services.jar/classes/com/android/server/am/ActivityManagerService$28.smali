...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/ProcessRecord;Ljava/lang/String;Landroid/content/pm/ApplicationInfo;Ljava/lang/String;Lcom/android/server/wm/WindowProcessController;ZLjava/lang/String;)V
    ...
    iput-object p2, p0, val$proc:Lcom/android/server/am/ProcessRecord;

    iput-object p3, p0, val$activityShortComponentName:Ljava/lang/String;

    iput-object p4, p0, val$aInfo:Landroid/content/pm/ApplicationInfo;

    iput-object p5, p0, val$parentShortComponentName:Ljava/lang/String;

    iput-object p6, p0, val$parentProcess:Lcom/android/server/wm/WindowProcessController;

    iput-boolean p7, p0, val$aboveSystem:Z

    iput-object p8, p0, val$annotation:Ljava/lang/String;
...
.method public run()V
    ...
    iget-object v1, p0, val$activityShortComponentName:Ljava/lang/String;

    iget-object v2, p0, val$aInfo:Landroid/content/pm/ApplicationInfo;

    iget-object v3, p0, val$parentShortComponentName:Ljava/lang/String;

    iget-object v4, p0, val$parentProcess:Lcom/android/server/wm/WindowProcessController;

    iget-boolean v5, p0, val$aboveSystem:Z

    iget-object v6, p0, val$annotation:Ljava/lang/String;
