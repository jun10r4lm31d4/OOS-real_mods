...
.method static constructor <clinit>()V
    ...
    sput-object v0, sNextToken:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method constructor <init>(Lcom/android/server/am/BroadcastQueue;Landroid/content/Intent;Lcom/android/server/am/ProcessRecord;Ljava/lang/String;IIZLjava/lang/String;[Ljava/lang/String;ILandroid/app/BroadcastOptions;Ljava/util/List;Landroid/content/IIntentReceiver;ILjava/lang/String;Landroid/os/Bundle;ZZZIZZ)V
    ...
    iput-object v3, v0, queue:Lcom/android/server/am/BroadcastQueue;

    iput-object v1, v0, intent:Landroid/content/Intent;

    invoke-virtual/range {p2 .. p2}, Landroid/content/Intent;->getComponent()Landroid/content/ComponentName;

    move-result-object v4

    iput-object v4, v0, targetComp:Landroid/content/ComponentName;

    move-object/from16 v4, p3

    iput-object v4, v0, callerApp:Lcom/android/server/am/ProcessRecord;

    move-object/from16 v5, p4

    iput-object v5, v0, callerPackage:Ljava/lang/String;

    move/from16 v6, p5

    iput v6, v0, callingPid:I

    move/from16 v7, p6

    iput v7, v0, callingUid:I

    move/from16 v8, p7

    iput-boolean v8, v0, callerInstantApp:Z

    move-object/from16 v9, p8

    iput-object v9, v0, resolvedType:Ljava/lang/String;

    move-object/from16 v10, p9

    iput-object v10, v0, requiredPermissions:[Ljava/lang/String;
    ...
    iput-object v12, v0, options:Landroid/app/BroadcastOptions;

    iput-object v2, v0, receivers:Ljava/util/List;
    ...
    iput-object v14, v0, delivery:[I

    iget-object v14, v0, delivery:[I

    array-length v14, v14

    new-array v14, v14, [J

    iput-object v14, v0, duration:[J

    move-object/from16 v14, p13

    iput-object v14, v0, resultTo:Landroid/content/IIntentReceiver;

    move/from16 v15, p14

    iput v15, v0, resultCode:I

    move-object/from16 v13, p15

    iput-object v13, v0, resultData:Ljava/lang/String;

    move-object/from16 v1, p16

    iput-object v1, v0, resultExtras:Landroid/os/Bundle;

    move/from16 v1, p17

    iput-boolean v1, v0, ordered:Z

    move/from16 v1, p18

    iput-boolean v1, v0, sticky:Z

    move/from16 v1, p19

    iput-boolean v1, v0, initialSticky:Z
    ...
    iput v1, v0, nextReceiver:I

    iput v1, v0, state:I

    move/from16 v1, p21

    iput-boolean v1, v0, allowBackgroundActivityStarts:Z

    move/from16 v1, p22

    iput-boolean v1, v0, timeoutExempt:Z
...
.method private constructor <init>(Lcom/android/server/am/BroadcastRecord;Landroid/content/Intent;)V
    ...
    iput-object v0, p0, targetComp:Landroid/content/ComponentName;

    iget-object v0, p1, callerApp:Lcom/android/server/am/ProcessRecord;

    iput-object v0, p0, callerApp:Lcom/android/server/am/ProcessRecord;

    iget-object v0, p1, callerPackage:Ljava/lang/String;

    iput-object v0, p0, callerPackage:Ljava/lang/String;

    iget v0, p1, callingPid:I

    iput v0, p0, callingPid:I

    iget v0, p1, callingUid:I

    iput v0, p0, callingUid:I

    iget-boolean v0, p1, callerInstantApp:Z

    iput-boolean v0, p0, callerInstantApp:Z

    iget-boolean v0, p1, ordered:Z

    iput-boolean v0, p0, ordered:Z

    iget-boolean v0, p1, sticky:Z

    iput-boolean v0, p0, sticky:Z

    iget-boolean v0, p1, initialSticky:Z
    ...
    iget-object v0, p1, resolvedType:Ljava/lang/String;

    iput-object v0, p0, resolvedType:Ljava/lang/String;

    iget-object v0, p1, requiredPermissions:[Ljava/lang/String;

    iput-object v0, p0, requiredPermissions:[Ljava/lang/String;

    iget v0, p1, appOp:I

    iput v0, p0, appOp:I

    iget-object v0, p1, options:Landroid/app/BroadcastOptions;

    iput-object v0, p0, options:Landroid/app/BroadcastOptions;

    iget-object v0, p1, receivers:Ljava/util/List;

    iput-object v0, p0, receivers:Ljava/util/List;

    iget-object v0, p1, delivery:[I

    iput-object v0, p0, delivery:[I

    iget-object v0, p1, duration:[J

    iput-object v0, p0, duration:[J

    iget-object v0, p1, resultTo:Landroid/content/IIntentReceiver;

    iput-object v0, p0, resultTo:Landroid/content/IIntentReceiver;

    iget-wide v0, p1, enqueueClockTime:J

    iput-wide v0, p0, enqueueClockTime:J

    iget-wide v0, p1, dispatchTime:J

    iput-wide v0, p0, dispatchTime:J

    iget-wide v0, p1, dispatchClockTime:J

    iput-wide v0, p0, dispatchClockTime:J

    iget-wide v0, p1, receiverTime:J

    iput-wide v0, p0, receiverTime:J

    iget-wide v0, p1, finishTime:J

    iput-wide v0, p0, finishTime:J

    iget v0, p1, resultCode:I

    iput v0, p0, resultCode:I

    iget-object v0, p1, resultData:Ljava/lang/String;

    iput-object v0, p0, resultData:Ljava/lang/String;

    iget-object v0, p1, resultExtras:Landroid/os/Bundle;

    iput-object v0, p0, resultExtras:Landroid/os/Bundle;

    iget-boolean v0, p1, resultAbort:Z

    iput-boolean v0, p0, resultAbort:Z

    iget v0, p1, nextReceiver:I

    iput v0, p0, nextReceiver:I

    iget-object v0, p1, receiver:Landroid/os/IBinder;

    iput-object v0, p0, receiver:Landroid/os/IBinder;

    iget v0, p1, state:I

    iput v0, p0, state:I

    iget v0, p1, anrCount:I

    iput v0, p0, anrCount:I

    iget v0, p1, manifestCount:I

    iput v0, p0, manifestCount:I

    iget v0, p1, manifestSkipCount:I

    iput v0, p0, manifestSkipCount:I

    iget-object v0, p1, queue:Lcom/android/server/am/BroadcastQueue;

    iput-object v0, p0, queue:Lcom/android/server/am/BroadcastQueue;

    iget-boolean v0, p1, allowBackgroundActivityStarts:Z

    iput-boolean v0, p0, allowBackgroundActivityStarts:Z

    iget-boolean v0, p1, timeoutExempt:Z

    iput-boolean v0, p0, timeoutExempt:Z
...
.method cleanupDisabledPackageReceiversLocked(Ljava/lang/String;Ljava/util/Set;IZ)Z
    ...
    iget-object v0, p0, receivers:Ljava/util/List;
    ...
    iget-object v5, p0, receivers:Ljava/util/List;
    ...
    iget-object v9, p0, receivers:Ljava/util/List;

    invoke-interface {v9, v5}, Ljava/util/List;->remove(I)Ljava/lang/Object;

    iget v9, p0, nextReceiver:I

    if-ge v5, v9, :cond_9

    add-int/lit8 v9, v9, -0x1

    iput v9, p0, nextReceiver:I
    ...
    :cond_a
    iget v1, p0, nextReceiver:I

    iget-object v2, p0, receivers:Ljava/util/List;
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;Ljava/text/SimpleDateFormat;)V
    ...
    iget-object v5, v0, intent:Landroid/content/Intent;
    ...
    iget-object v5, v0, targetComp:Landroid/content/ComponentName;

    if-eqz v5, :cond_0

    iget-object v6, v0, intent:Landroid/content/Intent;
    ...
    iget-object v6, v0, callerPackage:Ljava/lang/String;
    ...
    iget-object v7, v0, callerApp:Lcom/android/server/am/ProcessRecord;
    ...
    iget v7, v0, callingUid:I

    invoke-virtual {v1, v7}, Ljava/io/PrintWriter;->println(I)V

    iget-object v7, v0, requiredPermissions:[Ljava/lang/String;
    ...
    :cond_5
    iget-object v7, v0, options:Landroid/app/BroadcastOptions;
    ...
    iget-wide v9, v0, enqueueClockTime:J
    ...
    iget-wide v9, v0, dispatchClockTime:J
    ...
    iget-wide v9, v0, dispatchTime:J
    ...
    iget-wide v11, v0, enqueueClockTime:J
    ...
    iget-wide v11, v0, dispatchTime:J
    ...
    iget-wide v9, v0, receiverTime:J
    ...
    :cond_8
    iget-object v7, v0, resultTo:Landroid/content/IIntentReceiver;

    if-nez v7, :cond_9

    iget v7, v0, resultCode:I

    if-ne v7, v8, :cond_9

    iget-object v7, v0, resultData:Ljava/lang/String;
    ...
    :cond_a
    iget-object v7, v0, resultExtras:Landroid/os/Bundle;
    ...
    :cond_b
    iget-boolean v7, v0, resultAbort:Z

    if-nez v7, :cond_c

    iget-boolean v7, v0, ordered:Z

    if-nez v7, :cond_c

    iget-boolean v7, v0, sticky:Z

    if-nez v7, :cond_c

    iget-boolean v7, v0, initialSticky:Z
    ...
    :cond_d
    iget v7, v0, nextReceiver:I

    if-nez v7, :cond_e

    iget-object v7, v0, receiver:Landroid/os/IBinder;
    ...
    :cond_f
    iget-object v7, v0, curFilter:Lcom/android/server/am/BroadcastFilter;
    ...
    :cond_10
    iget-object v7, v0, curReceiver:Landroid/content/pm/ActivityInfo;
    ...
    :cond_11
    iget-object v7, v0, curApp:Lcom/android/server/am/ProcessRecord;
    ...
    iget-object v7, v0, curComponent:Landroid/content/ComponentName;
    ...
    :cond_18
    iget-object v7, v0, receivers:Ljava/util/List;
    ...
    iget-object v11, v0, receivers:Ljava/util/List;
...
.method public maybeStripForHistory()Lcom/android/server/am/BroadcastRecord;
    ...
    invoke-direct {v0, p0, v1}, <init>(Lcom/android/server/am/BroadcastRecord;Landroid/content/Intent;)V
...
.method splitRecipientsLocked(II)Lcom/android/server/am/BroadcastRecord;
    ...
    :goto_0
    iget-object v3, v0, receivers:Ljava/util/List;
    ...
    invoke-virtual {v0, v3}, getReceiverUid(Ljava/lang/Object;)I
    ...
    iget-object v4, v0, receivers:Ljava/util/List;
    ...
    iget-object v4, v0, queue:Lcom/android/server/am/BroadcastQueue;

    iget-object v5, v0, intent:Landroid/content/Intent;

    iget-object v6, v0, callerApp:Lcom/android/server/am/ProcessRecord;

    iget-object v7, v0, callerPackage:Ljava/lang/String;

    iget v8, v0, callingPid:I

    iget v9, v0, callingUid:I

    iget-boolean v10, v0, callerInstantApp:Z

    iget-object v11, v0, resolvedType:Ljava/lang/String;

    iget-object v12, v0, requiredPermissions:[Ljava/lang/String;

    iget v13, v0, appOp:I

    iget-object v14, v0, options:Landroid/app/BroadcastOptions;

    iget-object v15, v0, resultTo:Landroid/content/IIntentReceiver;

    move-object/from16 v16, v15

    iget v15, v0, resultCode:I

    move/from16 v17, v15

    iget-object v15, v0, resultData:Ljava/lang/String;

    move-object/from16 v18, v15

    iget-object v15, v0, resultExtras:Landroid/os/Bundle;

    move-object/from16 v19, v15

    iget-boolean v15, v0, ordered:Z

    move/from16 v20, v15

    iget-boolean v15, v0, sticky:Z

    move/from16 v21, v15

    iget-boolean v15, v0, initialSticky:Z

    move/from16 v22, v15

    iget v15, v0, userId:I

    move/from16 v23, v15

    iget-boolean v15, v0, allowBackgroundActivityStarts:Z

    move/from16 v24, v15

    iget-boolean v15, v0, timeoutExempt:Z

    move/from16 v25, v15

    move-object v15, v1

    invoke-direct/range {v3 .. v25}, <init>(Lcom/android/server/am/BroadcastQueue;Landroid/content/Intent;Lcom/android/server/am/ProcessRecord;Ljava/lang/String;IIZLjava/lang/String;[Ljava/lang/String;ILandroid/app/BroadcastOptions;Ljava/util/List;Landroid/content/IIntentReceiver;ILjava/lang/String;Landroid/os/Bundle;ZZZIZZ)V

    iget v3, v0, splitToken:I

    iput v3, v2, splitToken:I
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, callerApp:Lcom/android/server/am/ProcessRecord;
