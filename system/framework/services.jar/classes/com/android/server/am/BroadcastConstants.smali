...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput-wide v2, p0, SLOW_TIME:J

    iput-wide v2, p0, DEFERRAL:J

    const/high16 v2, 0x3f400000    # 0.75f

    iput v2, p0, DEFERRAL_DECAY_FACTOR:F

    const-wide/16 v2, 0x0

    iput-wide v2, p0, DEFERRAL_FLOOR:J

    iput-wide v0, p0, ALLOW_BG_ACTIVITY_START_TIMEOUT:J
    ...
    iput-object p1, p0, mSettingsKey:Ljava/lang/String;
...
.method private updateConstants()V
    ...
    iget-object v3, p0, mSettingsKey:Ljava/lang/String;
    ...
    iget-wide v3, p0, TIMEOUT:J

    invoke-virtual {v1, v2, v3, v4}, Landroid/util/KeyValueListParser;->getLong(Ljava/lang/String;J)J

    move-result-wide v1

    iput-wide v1, p0, TIMEOUT:J

    iget-object v1, p0, mParser:Landroid/util/KeyValueListParser;

    const-string v2, "bcast_slow_time"

    iget-wide v3, p0, SLOW_TIME:J

    invoke-virtual {v1, v2, v3, v4}, Landroid/util/KeyValueListParser;->getLong(Ljava/lang/String;J)J

    move-result-wide v1

    iput-wide v1, p0, SLOW_TIME:J

    iget-object v1, p0, mParser:Landroid/util/KeyValueListParser;

    const-string v2, "bcast_deferral"

    iget-wide v3, p0, DEFERRAL:J

    invoke-virtual {v1, v2, v3, v4}, Landroid/util/KeyValueListParser;->getLong(Ljava/lang/String;J)J

    move-result-wide v1

    iput-wide v1, p0, DEFERRAL:J

    iget-object v1, p0, mParser:Landroid/util/KeyValueListParser;

    const-string v2, "bcast_deferral_decay_factor"

    iget v3, p0, DEFERRAL_DECAY_FACTOR:F

    invoke-virtual {v1, v2, v3}, Landroid/util/KeyValueListParser;->getFloat(Ljava/lang/String;F)F

    move-result v1

    iput v1, p0, DEFERRAL_DECAY_FACTOR:F

    iget-object v1, p0, mParser:Landroid/util/KeyValueListParser;

    const-string v2, "bcast_deferral_floor"

    iget-wide v3, p0, DEFERRAL_FLOOR:J

    invoke-virtual {v1, v2, v3, v4}, Landroid/util/KeyValueListParser;->getLong(Ljava/lang/String;J)J

    move-result-wide v1

    iput-wide v1, p0, DEFERRAL_FLOOR:J

    iget-object v1, p0, mParser:Landroid/util/KeyValueListParser;

    const-string v2, "bcast_allow_bg_activity_start_timeout"

    iget-wide v3, p0, ALLOW_BG_ACTIVITY_START_TIMEOUT:J

    invoke-virtual {v1, v2, v3, v4}, Landroid/util/KeyValueListParser;->getLong(Ljava/lang/String;J)J

    move-result-wide v1

    iput-wide v1, p0, ALLOW_BG_ACTIVITY_START_TIMEOUT:J
    ...
    iget-object v4, p0, mSettingsKey:Ljava/lang/String;
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    iget-object v1, p0, mSettingsKey:Ljava/lang/String;
    ...
    iget-object v1, p0, mSettingsObserver:Lcom/android/server/am/BroadcastConstants$SettingsObserver;
    ...
    iget v1, p0, DEFERRAL_DECAY_FACTOR:F
    ...
    iget-wide v1, p0, DEFERRAL_FLOOR:J
    ...
    iget-wide v1, p0, ALLOW_BG_ACTIVITY_START_TIMEOUT:J
...
.method public startObserving(Landroid/os/Handler;Landroid/content/ContentResolver;)V
    ...
    iput-object v0, p0, mSettingsObserver:Lcom/android/server/am/BroadcastConstants$SettingsObserver;
    ...
    iget-object v2, p0, mSettingsObserver:Lcom/android/server/am/BroadcastConstants$SettingsObserver;
