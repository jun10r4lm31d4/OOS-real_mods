...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Landroid/content/pm/ApplicationInfo;Ljava/lang/String;I)V
    ...
    iput-object v0, p0, pkgList:Lcom/android/server/am/ProcessRecord$PackageList;
    ...
    iput-object v0, p0, procStateMemTracker:Lcom/android/server/am/ProcessList$ProcStateMemTracker;

    const/4 v0, 0x4

    new-array v1, v0, [J

    iput-object v1, p0, lastRxBytes:[J

    new-array v1, v0, [J

    iput-object v1, p0, lastTxBytes:[J

    const/16 v1, 0x15

    iput v1, p0, mCurProcState:I

    iput v1, p0, mRepProcState:I

    iput v1, p0, mCurRawProcState:I

    iput v1, p0, setProcState:I

    iput v1, p0, pssProcState:I

    new-instance v1, Landroid/util/ArraySet;

    invoke-direct {v1}, Landroid/util/ArraySet;-><init>()V

    iput-object v1, p0, curReceivers:Landroid/util/ArraySet;

    new-array v0, v0, [J

    iput-object v0, p0, lastCpuTimeBgMonitor:[J
    ...
    iput-object v0, p0, mAllowBackgroundActivityStartsTokens:Landroid/util/ArraySet;

    new-instance v0, Landroid/util/ArraySet;

    invoke-direct {v0}, Landroid/util/ArraySet;-><init>()V

    iput-object v0, p0, mBoundClientUids:Landroid/util/ArraySet;
    ...
    :goto_1
    iput-boolean v1, p0, appZygote:Z
    ...
    iput v0, p0, setRawAdj:I

    iput v0, p0, mCurRawAdj:I

    iput v0, p0, verifiedAdj:I

    iput v0, p0, setAdj:I

    iput v0, p0, curAdj:I

    iput-boolean v2, p0, mPersistent:Z

    iput-boolean v2, p0, removed:Z
    ...
    iput-wide v0, p0, lastContactProviderTime:J

    iput-wide v0, p0, lastSkipTime:J

    iput v2, p0, permRequestCount:I
    ...
    iput-object v0, p0, mWindowProcessController:Lcom/android/server/wm/WindowProcessController;

    iget-object v0, p0, pkgList:Lcom/android/server/am/ProcessRecord$PackageList;
    ...
    iget-wide v0, p0, nextPssTime:J

    iput-wide v0, p0, forkTime:J
...
.method static synthetic access$000(Lcom/android/server/am/ProcessRecord;)Lcom/android/server/wm/WindowProcessController;
    ...
    iget-object v0, p0, mWindowProcessController:Lcom/android/server/wm/WindowProcessController;
...
.method private makeAppNotRespondingLocked(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, setNotResponding(Z)V
    ...
    iput-object v0, p0, notRespondingReport:Landroid/app/ActivityManager$ProcessErrorStateInfo;

    :cond_0
    invoke-virtual {p0}, startAppProblemLocked()V

    invoke-virtual {p0}, getWindowProcessController()Lcom/android/server/wm/WindowProcessController;
...
.method addAllowBackgroundActivityStartsToken(Landroid/os/Binder;)V
    ...
    :cond_0
    iget-object v0, p0, mAllowBackgroundActivityStartsTokens:Landroid/util/ArraySet;
...
.method addBoundClientUid(I)V
    ...
    iget-object v0, p0, mBoundClientUids:Landroid/util/ArraySet;
    ...
    iget-object v1, p0, mBoundClientUids:Landroid/util/ArraySet;
...
.method addBoundClientUidsOfNewService(Lcom/android/server/am/ServiceRecord;)V
    ...
    iget-object v4, p0, mBoundClientUids:Landroid/util/ArraySet;
    ...
    :cond_2
    iget-object v1, p0, mWindowProcessController:Lcom/android/server/wm/WindowProcessController;

    iget-object v2, p0, mBoundClientUids:Landroid/util/ArraySet;
...
.method public addPackage(Ljava/lang/String;JLcom/android/server/am/ProcessStatsService;)Z
    ...
    iget-object v1, p0, baseProcessTracker:Lcom/android/internal/app/procstats/ProcessState;
    ...
    iget-object v7, p0, processName:Ljava/lang/String;
    ...
    iget-object v1, p0, pkgList:Lcom/android/server/am/ProcessRecord$PackageList;
    ...
    iget-object v2, p0, baseProcessTracker:Lcom/android/internal/app/procstats/ProcessState;
...
.method appNotResponding(Ljava/lang/String;Landroid/content/pm/ApplicationInfo;Ljava/lang/String;Lcom/android/server/wm/WindowProcessController;ZLjava/lang/String;)V
    ...
    iget v0, v12, permRequestCount:I
    ...
    :cond_0
    iget-object v0, v12, mWindowProcessController:Lcom/android/server/wm/WindowProcessController;
    ...
    invoke-virtual/range {p0 .. p0}, isMonitorCpuUsage()Z

    move-result v0

    if-eqz v0, :cond_1

    iget-object v0, v12, mService:Lcom/android/server/am/ActivityManagerService;

    invoke-virtual {v0}, Lcom/android/server/am/ActivityManagerService;->updateCpuStatsNow()V

    :cond_1
    iget-object v2, v12, mService:Lcom/android/server/am/ActivityManagerService;
    ...
    :cond_2
    :try_start_2
    invoke-virtual/range {p0 .. p0}, isNotResponding()Z
    ...
    :cond_3
    :try_start_4
    invoke-virtual/range {p0 .. p0}, isCrashing()Z
    ...
    :cond_4
    :try_start_6
    iget-boolean v0, v12, killedByAm:Z
    :try_end_6
    ...
    :try_start_a
    invoke-virtual {v12, v0}, setNotResponding(Z)V

    const/16 v3, 0x7538

    new-array v1, v1, [Ljava/lang/Object;

    iget v4, v12, userId:I
    ...
    iget-object v4, v12, processName:Ljava/lang/String;

    const/4 v6, 0x2

    aput-object v4, v1, v6

    iget-object v4, v12, info:Landroid/content/pm/ApplicationInfo;
    ...
    invoke-virtual/range {p0 .. p0}, isSilentAnr()Z
    ...
    :cond_a
    :try_start_10
    invoke-virtual/range {p0 .. p0}, getLruProcessList()Ljava/util/List;
    ...
    iget-object v0, v6, thread:Landroid/app/IApplicationThread;
    ...
    invoke-virtual {v6}, isPersistent()Z
    ...
    iget-boolean v1, v6, treatLikeActivity:Z
    ...
    iget-object v0, v12, processName:Ljava/lang/String;
    ...
    iget-object v3, v12, processName:Ljava/lang/String;
    ...
    iget-object v2, v12, processName:Ljava/lang/String;
    ...
    :goto_b
    iget-object v1, v12, info:Landroid/content/pm/ApplicationInfo;
    ...
    :goto_c
    invoke-virtual/range {p0 .. p0}, isInterestingToUserLocked()Z
    ...
    :goto_d
    invoke-virtual/range {p0 .. p0}, getProcessClassEnum()I
    ...
    :goto_f
    iget-object v1, v12, mService:Lcom/android/server/am/ActivityManagerService;
    ...
    iget-object v1, v12, mWindowProcessController:Lcom/android/server/wm/WindowProcessController;
    ...
    invoke-virtual/range {p0 .. p0}, isDebugging()Z
    ...
    invoke-virtual {v12, v0, v2}, kill(Ljava/lang/String;Z)V
    ...
    invoke-direct {v12, v13, v2, v3}, makeAppNotRespondingLocked(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v3, v12, mService:Lcom/android/server/am/ActivityManagerService;
    ...
    iget-object v6, v12, processName:Ljava/lang/String;
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    iget-object v4, p0, mRequiredAbi:Ljava/lang/String;
    ...
    iget-object v4, p0, instructionSet:Ljava/lang/String;
    ...
    :goto_1
    iget-object v5, p0, pkgList:Lcom/android/server/am/ProcessRecord$PackageList;
    ...
    iget-object v4, p0, pkgDeps:Landroid/util/ArraySet;
    ...
    :goto_2
    iget-object v5, p0, pkgDeps:Landroid/util/ArraySet;
    ...
    iget-object v2, p0, compat:Landroid/content/res/CompatibilityInfo;

    invoke-virtual {p1, v2}, Ljava/io/PrintWriter;->println(Ljava/lang/Object;)V

    iget-object v2, p0, mInstr:Lcom/android/server/am/ActiveInstrumentation;
    ...
    iget-wide v2, p0, lastActivityTime:J
    ...
    iget-wide v2, p0, lastCachedPss:J
    ...
    iget-wide v2, p0, lastCachedSwapPss:J
    ...
    iget-object v2, p0, procStateMemTracker:Lcom/android/server/am/ProcessList$ProcStateMemTracker;
    ...
    iget-boolean v2, p0, empty:Z

    invoke-virtual {p1, v2}, Ljava/io/PrintWriter;->println(Z)V

    iget-boolean v2, p0, serviceb:Z
    ...
    iget-boolean v2, p0, serviceHighRam:Z

    invoke-virtual {p1, v2}, Ljava/io/PrintWriter;->println(Z)V

    :cond_b
    iget-boolean v2, p0, notCachedSinceIdle:Z
    ...
    iget-wide v2, p0, initialIdlePss:J
    ...
    iget-wide v2, p0, lastCompactTime:J
    ...
    iget v2, p0, lastCompactAction:I
    ...
    iget-boolean v2, p0, systemNoUi:Z
    ...
    invoke-virtual {p0}, getCurProcState()I
    ...
    iget-wide v2, p0, lastStateTime:J

    invoke-static {v2, v3, v0, v1, p1}, Landroid/util/TimeUtils;->formatDuration(JJLjava/io/PrintWriter;)V

    invoke-virtual {p1}, Ljava/io/PrintWriter;->println()V

    iget-boolean v2, p0, hasShownUi:Z

    if-nez v2, :cond_d

    iget-boolean v2, p0, mPendingUiClean:Z

    if-nez v2, :cond_d

    iget-boolean v2, p0, hasAboveClient:Z

    if-nez v2, :cond_d

    iget-boolean v2, p0, treatLikeActivity:Z
    ...
    :cond_e
    iget-object v2, p0, connectionService:Lcom/android/server/am/ServiceRecord;

    if-nez v2, :cond_f

    iget v2, p0, connectionGroup:I
    ...
    iget v2, p0, connectionImportance:I
    ...
    :cond_10
    invoke-virtual {p0}, hasTopUi()Z

    move-result v2

    if-nez v2, :cond_11

    invoke-virtual {p0}, hasOverlayUi()Z

    move-result v2

    if-nez v2, :cond_11

    iget-boolean v2, p0, runningRemoteAnimation:Z
    ...
    :cond_12
    iget-boolean v2, p0, mHasForegroundServices:Z

    if-nez v2, :cond_13

    iget-object v2, p0, forcingToImportant:Ljava/lang/Object;
    ...
    :cond_14
    iget-boolean v2, p0, reportedInteraction:Z

    const-wide/16 v3, 0x0

    if-nez v2, :cond_15

    iget-wide v5, p0, mFgInteractionTime:J
    ...
    iget-wide v5, p0, mInteractionEventTime:J
    ...
    :cond_18
    iget-boolean v2, p0, mPersistent:Z

    if-nez v2, :cond_19

    iget-boolean v2, p0, removed:Z
    ...
    :cond_1a
    iget-boolean v2, p0, mHasClientActivities:Z

    const-string v5, ")"

    if-nez v2, :cond_1b

    iget-boolean v2, p0, mHasForegroundActivities:Z

    if-nez v2, :cond_1b

    iget-boolean v2, p0, repForegroundActivities:Z
    ...
    :cond_1c
    iget-wide v6, p0, lastProviderTime:J
    ...
    :cond_1e
    iget-boolean v2, p0, hasStartedServices:Z
    ...
    :cond_1f
    iget-boolean v2, p0, pendingStart:Z
    ...
    iget-wide v2, p0, mWhenUnimportant:J
    ...
    iget-wide v2, p0, lastRequestedGc:J
    ...
    iget-wide v2, p0, lastLowMemory:J
    ...
    iget-boolean v2, p0, reportLowMemory:Z

    invoke-virtual {p1, v2}, Ljava/io/PrintWriter;->println(Z)V

    iget-boolean v2, p0, killed:Z

    if-nez v2, :cond_23

    iget-boolean v2, p0, killedByAm:Z

    if-nez v2, :cond_23

    iget-object v2, p0, waitingToKill:Ljava/lang/String;
    ...
    :cond_24
    iget-boolean v2, p0, mDebugging:Z

    if-nez v2, :cond_25

    iget-boolean v2, p0, mCrashing:Z

    if-nez v2, :cond_25

    iget-object v2, p0, crashDialog:Landroid/app/Dialog;

    if-nez v2, :cond_25

    iget-boolean v2, p0, mNotResponding:Z

    if-nez v2, :cond_25

    iget-object v2, p0, anrDialog:Landroid/app/Dialog;

    if-nez v2, :cond_25

    iget-boolean v2, p0, bad:Z
    ...
    iget-object v3, p0, crashDialog:Landroid/app/Dialog;
    ...
    iget-boolean v3, p0, mNotResponding:Z
    ...
    iget-object v2, p0, errorReportReceiver:Landroid/content/ComponentName;
    ...
    :cond_27
    iget-boolean v2, p0, whitelistManager:Z
    ...
    :cond_28
    iget-object v2, p0, isolatedEntryPoint:Ljava/lang/String;

    if-nez v2, :cond_29

    iget-object v2, p0, isolatedEntryPointArgs:[Ljava/lang/String;
    ...
    :cond_2a
    iget-object v2, p0, mWindowProcessController:Lcom/android/server/wm/WindowProcessController;

    invoke-virtual {v2, p1, p2}, Lcom/android/server/wm/WindowProcessController;->dump(Ljava/io/PrintWriter;Ljava/lang/String;)V

    iget-object v2, p0, services:Landroid/util/ArraySet;
    ...
    :goto_3
    iget-object v4, p0, services:Landroid/util/ArraySet;
    ...
    :cond_2b
    iget-object v2, p0, executingServices:Landroid/util/ArraySet;
    ...
    iget-boolean v2, p0, execServicesFg:Z
    ...
    :goto_4
    iget-object v4, p0, executingServices:Landroid/util/ArraySet;
    ...
    :goto_5
    iget-object v4, p0, connections:Landroid/util/ArraySet;
    ...
    :cond_2d
    iget-object v2, p0, pubProviders:Landroid/util/ArrayMap;
    ...
    :goto_6
    iget-object v4, p0, pubProviders:Landroid/util/ArrayMap;
    ...
    :cond_2e
    iget-object v2, p0, conProviders:Ljava/util/ArrayList;
    ...
    :goto_7
    iget-object v4, p0, conProviders:Ljava/util/ArrayList;
    ...
    :cond_2f
    iget-object v2, p0, curReceivers:Landroid/util/ArraySet;
    ...
    :goto_8
    iget-object v4, p0, curReceivers:Landroid/util/ArraySet;
    ...
    :cond_30
    iget-object v2, p0, receivers:Landroid/util/ArraySet;
    ...
    :goto_9
    iget-object v4, p0, receivers:Landroid/util/ArraySet;
    ...
    :cond_31
    iget-object v2, p0, mAllowBackgroundActivityStartsTokens:Landroid/util/ArraySet;
    ...
    :goto_a
    iget-object v4, p0, mAllowBackgroundActivityStartsTokens:Landroid/util/ArraySet;
...
.method public forceProcessStateUpTo(I)V
    ...
    iget v0, p0, mRepProcState:I

    if-le v0, p1, :cond_0

    iput p1, p0, mRepProcState:I

    invoke-virtual {p0, p1}, setCurProcState(I)V

    invoke-virtual {p0, p1}, setCurRawProcState(I)V
    ...
    iget-object v4, p0, pkgList:Lcom/android/server/am/ProcessRecord$PackageList;

    invoke-virtual {v4, v0}, Lcom/android/server/am/ProcessRecord$PackageList;->keyAt(I)Ljava/lang/String;

    move-result-object v4

    iget v5, p0, mRepProcState:I

    invoke-static {v5}, Landroid/app/ActivityManager;->processStateAmToProto(I)I

    move-result v5

    iget-object v6, p0, pkgList:Lcom/android/server/am/ProcessRecord$PackageList;
...
.method getActiveInstrumentation()Lcom/android/server/am/ActiveInstrumentation;
    ...
    iget-object v0, p0, mInstr:Lcom/android/server/am/ActiveInstrumentation;
...
.method getFgInteractionTime()J
    ...
    iget-wide v0, p0, mFgInteractionTime:J
...
.method getForegroundServiceTypes()I
    ...
    iget-boolean v0, p0, mHasForegroundServices:Z

    if-eqz v0, :cond_0

    iget v0, p0, mFgServiceTypes:I
...
.method getInteractionEventTime()J
    ...
    iget-wide v0, p0, mInteractionEventTime:J
...
.method public getPackageList()[Ljava/lang/String;
    ...
    :goto_0
    iget-object v3, p0, pkgList:Lcom/android/server/am/ProcessRecord$PackageList;
...
.method getReportedForegroundServiceTypes()I
    ...
    iget v0, p0, mRepFgServiceTypes:I
...
.method getRequiredAbi()Ljava/lang/String;
    ...
    iget-object v0, p0, mRequiredAbi:Ljava/lang/String;
...
.method getWhenUnimportant()J
    ...
    iget-wide v0, p0, mWhenUnimportant:J
...
.method hasClientActivities()Z
    ...
    iget-boolean v0, p0, mHasClientActivities:Z
...
.method hasForegroundActivities()Z
    ...
    iget-boolean v0, p0, mHasForegroundActivities:Z
...
.method hasOverlayUi()Z
    ...
    iget-boolean v0, p0, mHasOverlayUi:Z
...
.method hasPendingUiClean()Z
    ...
    iget-boolean v0, p0, mPendingUiClean:Z
...
.method hasTopUi()Z
    ...
    iget-boolean v0, p0, mHasTopUi:Z
...
.method isCrashing()Z
    ...
    iget-boolean v0, p0, mCrashing:Z
...
.method isDebugging()Z
    ...
    iget-boolean v0, p0, mDebugging:Z
...
.method protected isInterestingForBackgroundTraces()Z
    ...
    :cond_0
    invoke-virtual {p0}, isInterestingTopLocked()Z
...
.method public isInterestingToUserLocked()Z
    ...
    :cond_0
    iget-object v0, p0, services:Landroid/util/ArraySet;
    ...
    :try_start_0
    iget-object v3, p0, services:Landroid/util/ArraySet;
...
.method isNotResponding()Z
    ...
    iget-boolean v0, p0, mNotResponding:Z
...
.method isPersistent()Z
    ...
    iget-boolean v0, p0, mPersistent:Z
...
.method isSilentAnr()Z
    ...
    invoke-direct {p0}, getShowBackground()Z

    move-result v0

    if-nez v0, :cond_0

    invoke-virtual {p0}, isInterestingForBackgroundTraces()Z
...
.method isUsingWrapper()Z
    ...
    iget-boolean v0, p0, mUsingWrapper:Z
...
.method kill(Ljava/lang/String;Z)V
    ...
    iget-object v9, p0, processName:Ljava/lang/String;
    ...
    :cond_2
    iput-boolean v6, p0, pendingStart:Z
    ...
    iget-boolean v3, p0, mPersistent:Z
...
.method public synthetic lambda$appNotResponding$0$ProcessRecord()V
    ...
    invoke-virtual {p0, v0, v1}, kill(Ljava/lang/String;Z)V
...
.method public makeActive(Landroid/app/IApplicationThread;Lcom/android/server/am/ProcessStatsService;)V
    ...
    iget-boolean v1, p0, mHasForegroundActivities:Z
    ...
    iget-boolean v1, p0, mHasForegroundServices:Z
    ...
    invoke-virtual {p0}, isDebugging()Z
    ...
    iget-object v2, p0, pkgList:Lcom/android/server/am/ProcessRecord$PackageList;
    ...
    iget-object v8, p0, pkgList:Lcom/android/server/am/ProcessRecord$PackageList;
    ...
    iput-object v2, p0, baseProcessTracker:Lcom/android/internal/app/procstats/ProcessState;
    ...
    iget-object v10, p0, processName:Ljava/lang/String;
    ...
    iget-object v5, p0, baseProcessTracker:Lcom/android/internal/app/procstats/ProcessState;
...
.method public makeAdjReason()Ljava/lang/String;
    ...
    iget-object v0, p0, adjSource:Ljava/lang/Object;

    if-nez v0, :cond_1

    iget-object v0, p0, adjTarget:Ljava/lang/Object;
...
.method public makeInactive(Lcom/android/server/am/ProcessStatsService;)V
    ...
    iput-object v1, p0, thread:Landroid/app/IApplicationThread;
    ...
    iget-object v7, p0, pkgList:Lcom/android/server/am/ProcessRecord$PackageList;
    ...
    iget-object v9, p0, pkgList:Lcom/android/server/am/ProcessRecord$PackageList;
    ...
    iput-object v1, p0, baseProcessTracker:Lcom/android/internal/app/procstats/ProcessState;
...
.method public onStartActivity(IZLjava/lang/String;J)V
    ...
    iput-object v1, p0, waitingToKill:Ljava/lang/String;
    ...
    invoke-virtual {p0, p3, p4, p5, v1}, addPackage(Ljava/lang/String;JLcom/android/server/am/ProcessStatsService;)Z
    ...
    invoke-virtual {p0, v1, v2, v2}, updateProcessInfo(ZZZ)V

    iput-boolean v2, p0, hasShownUi:Z

    invoke-virtual {p0, v2}, setPendingUiClean(Z)V

    invoke-virtual {p0, p1}, forceProcessStateUpTo(I)V
...
.method public permRequestDec()V
    ...
    iget v0, p0, permRequestCount:I

    add-int/lit8 v0, v0, -0x1

    iput v0, p0, permRequestCount:I
...
.method removeAllowBackgroundActivityStartsToken(Landroid/os/Binder;)V
    ...
    iget-object v1, p0, mAllowBackgroundActivityStartsTokens:Landroid/util/ArraySet;
...
.method public resetPackageList(Lcom/android/server/am/ProcessStatsService;)V
    ...
    iget-object v1, v0, pkgList:Lcom/android/server/am/ProcessRecord$PackageList;

    invoke-virtual {v1}, Lcom/android/server/am/ProcessRecord$PackageList;->size()I

    move-result v1

    iget-object v2, v0, baseProcessTracker:Lcom/android/internal/app/procstats/ProcessState;
    ...
    iget-object v4, v0, baseProcessTracker:Lcom/android/internal/app/procstats/ProcessState;
    ...
    iget-object v2, v0, pkgList:Lcom/android/server/am/ProcessRecord$PackageList;
    ...
    iget-object v14, v0, processName:Ljava/lang/String;

    iget-object v4, v0, pkgList:Lcom/android/server/am/ProcessRecord$PackageList;
    ...
    iget-object v3, v0, pkgList:Lcom/android/server/am/ProcessRecord$PackageList;
    ...
    iget-object v5, v0, baseProcessTracker:Lcom/android/internal/app/procstats/ProcessState;
    ...
    iget-object v3, v0, info:Landroid/content/pm/ApplicationInfo;
    ...
    iget-object v5, v0, processName:Ljava/lang/String;
    ...
    iget-object v4, v0, info:Landroid/content/pm/ApplicationInfo;
    ...
    iget-object v5, v0, info:Landroid/content/pm/ApplicationInfo;
...
.method scheduleCrash(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v3, v4}, kill(Ljava/lang/String;Z)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method setActiveInstrumentation(Lcom/android/server/am/ActiveInstrumentation;)V
    ...
    iput-object p1, p0, mInstr:Lcom/android/server/am/ActiveInstrumentation;
    ...
    :goto_0
    iget-object v3, p0, mWindowProcessController:Lcom/android/server/wm/WindowProcessController;
...
.method setCrashing(Z)V
    ...
    iput-boolean p1, p0, mCrashing:Z
...
.method setCurProcState(I)V
    ...
    iput p1, p0, mCurProcState:I

    iget-object v0, p0, mWindowProcessController:Lcom/android/server/wm/WindowProcessController;

    iget v1, p0, mCurProcState:I
...
.method setDebugging(Z)V
    ...
    iput-boolean p1, p0, mDebugging:Z
...
.method setFgInteractionTime(J)V
    ...
    iput-wide p1, p0, mFgInteractionTime:J
...
.method setHasClientActivities(Z)V
    ...
    iput-boolean p1, p0, mHasClientActivities:Z
...
.method setHasForegroundActivities(Z)V
    ...
    iput-boolean p1, p0, mHasForegroundActivities:Z
...
.method setHasForegroundServices(ZI)V
    ...
    iput-boolean p1, p0, mHasForegroundServices:Z

    iput p2, p0, mFgServiceTypes:I
...
.method setHasOverlayUi(Z)V
    ...
    iput-boolean p1, p0, mHasOverlayUi:Z
...
.method setHasTopUi(Z)V
    ...
    iput-boolean p1, p0, mHasTopUi:Z
...
.method setInteractionEventTime(J)V
    ...
    iput-wide p1, p0, mInteractionEventTime:J
...
.method setNotResponding(Z)V
    ...
    iput-boolean p1, p0, mNotResponding:Z
...
.method public setPendingUiClean(Z)V
    ...
    iput-boolean p1, p0, mPendingUiClean:Z
...
.method public setPendingUiCleanAndForceProcessStateUpTo(I)V
    ...
    invoke-virtual {p0, v1}, setPendingUiClean(Z)V
...
.method setPersistent(Z)V
    ...
    iput-boolean p1, p0, mPersistent:Z
...
.method public setPid(I)V
    ...
    iput-object v0, p0, procStatFile:Ljava/lang/String;
...
.method setReportedForegroundServiceTypes(I)V
    ...
    iput p1, p0, mRepFgServiceTypes:I
...
.method public setRequiredAbi(Ljava/lang/String;)V
    ...
    iput-object p1, p0, mRequiredAbi:Ljava/lang/String;
...
.method setStartParams(ILcom/android/server/am/HostingRecord;Ljava/lang/String;J)V
    ...
    iput p1, p0, startUid:I

    iput-object p2, p0, hostingRecord:Lcom/android/server/am/HostingRecord;

    iput-object p3, p0, seInfo:Ljava/lang/String;
...
.method setUsingWrapper(Z)V
    ...
    iput-boolean p1, p0, mUsingWrapper:Z
...
.method setWhenUnimportant(J)V
    ...
    iput-wide p1, p0, mWhenUnimportant:J
...
.method startAppProblemLocked()V
    ...
    iput-object v0, p0, errorReportReceiver:Landroid/content/ComponentName;
    ...
    iput-object v4, p0, errorReportReceiver:Landroid/content/ComponentName;
...
.method public toShortString()Ljava/lang/String;
    ...
    iget-object v0, p0, shortStringName:Ljava/lang/String;
...
.method public unlinkDeathRecipient()V
    ...
    iget-object v1, p0, deathReason:Ljava/lang/String;
    ...
    iget v0, p0, killReason:I

    if-nez v0, :cond_0

    const/4 v0, 0x2

    iput v0, p0, killReason:I
...
.method updateBoundClientUids()V
    ...
    invoke-virtual {p0}, clearBoundClientUids()V
    ...
    iget-object v3, p0, mBoundClientUids:Landroid/util/ArraySet;
...
.method updateHasAboveClientLocked()V
    ...
    iput-boolean v0, p0, hasAboveClient:Z

    iget-object v0, p0, connections:Landroid/util/ArraySet;
    ...
    iput-boolean v1, p0, hasAboveClient:Z
...
.method public writeToProto(Landroid/util/proto/ProtoOutputStream;J)V
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, writeToProto(Landroid/util/proto/ProtoOutputStream;JI)V
...
.method public writeToProto(Landroid/util/proto/ProtoOutputStream;JI)V
    ...
    iget-boolean v4, p0, mPersistent:Z
