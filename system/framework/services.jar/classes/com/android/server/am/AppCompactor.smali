...
.method static constructor <clinit>()V
    ...
    sput-object v0, DEFAULT_USE_COMPACTION:Ljava/lang/Boolean;
    ...
    sput-object v0, DEFAULT_COMPACT_PROC_STATE_THROTTLE:Ljava/lang/String;
...
.method public constructor <init>(Lcom/android/server/am/ActivityManagerService;)V
    ...
    iput-object v0, p0, mPendingCompactionProcesses:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, mOnFlagsChangedListener:Landroid/provider/DeviceConfig$OnPropertiesChangedListener;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, mPhenotypeFlagLock:Ljava/lang/Object;

    nop

    const/4 v0, 0x1

    invoke-static {v0}, compactActionIntToString(I)Ljava/lang/String;

    move-result-object v1

    iput-object v1, p0, mCompactActionSome:Ljava/lang/String;

    nop

    const/4 v1, 0x3

    invoke-static {v1}, compactActionIntToString(I)Ljava/lang/String;

    move-result-object v1

    iput-object v1, p0, mCompactActionFull:Ljava/lang/String;

    const-wide/16 v1, 0x1388

    iput-wide v1, p0, mCompactThrottleSomeSome:J

    const-wide/16 v1, 0x2710

    iput-wide v1, p0, mCompactThrottleSomeFull:J

    const-wide/16 v3, 0x1f4

    iput-wide v3, p0, mCompactThrottleFullSome:J

    iput-wide v1, p0, mCompactThrottleFullFull:J

    const-wide/32 v1, 0x927c0

    iput-wide v1, p0, mCompactThrottleBFGS:J

    iput-wide v1, p0, mCompactThrottlePersistent:J

    sget-object v1, DEFAULT_USE_COMPACTION:Ljava/lang/Boolean;

    invoke-virtual {v1}, Ljava/lang/Boolean;->booleanValue()Z

    move-result v1

    iput-boolean v1, p0, mUseCompaction:Z
    ...
    iput v1, p0, mStatsdSampleRate:F

    const-wide/16 v1, 0x2ee0

    iput-wide v1, p0, mFullAnonRssThrottleKb:J

    const-wide/16 v1, 0x1f40

    iput-wide v1, p0, mFullDeltaRssThrottleKb:J
    ...
    iput-object v1, p0, mLastCompactionStats:Ljava/util/Map;
    ...
    iput-object v1, p0, mCompactionThread:Lcom/android/server/ServiceThread;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, mProcStateThrottle:Ljava/util/Set;
...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/AppCompactor$PropertyChangedCallbackForTest;)V
    ...
    iput-object p2, p0, mTestCallback:Lcom/android/server/am/AppCompactor$PropertyChangedCallbackForTest;
...
.method static synthetic access$000(Lcom/android/server/am/AppCompactor;)Ljava/lang/Object;
    ...
    iget-object v0, p0, mPhenotypeFlagLock:Ljava/lang/Object;
...
.method static synthetic access$100(Lcom/android/server/am/AppCompactor;)V
    ...
    invoke-direct {p0}, updateUseCompaction()V
...
.method static synthetic access$1100(Lcom/android/server/am/AppCompactor;)Ljava/util/ArrayList;
    ...
    iget-object v0, p0, mPendingCompactionProcesses:Ljava/util/ArrayList;
...
.method static synthetic access$1200(Lcom/android/server/am/AppCompactor;)Ljava/util/Map;
    ...
    iget-object v0, p0, mLastCompactionStats:Ljava/util/Map;
...
.method static synthetic access$1308(Lcom/android/server/am/AppCompactor;)I
    ...
    iget v0, p0, mSomeCompactionCount:I

    add-int/lit8 v1, v0, 0x1

    iput v1, p0, mSomeCompactionCount:I
...
.method static synthetic access$1408(Lcom/android/server/am/AppCompactor;)I
    ...
    iget v0, p0, mFullCompactionCount:I

    add-int/lit8 v1, v0, 0x1

    iput v1, p0, mFullCompactionCount:I
...
.method static synthetic access$1508(Lcom/android/server/am/AppCompactor;)I
    ...
    iget v0, p0, mPersistentCompactionCount:I

    add-int/lit8 v1, v0, 0x1

    iput v1, p0, mPersistentCompactionCount:I
...
.method static synthetic access$1608(Lcom/android/server/am/AppCompactor;)I
    ...
    iget v0, p0, mBfgsCompactionCount:I

    add-int/lit8 v1, v0, 0x1

    iput v1, p0, mBfgsCompactionCount:I
...
.method static synthetic access$1800(Lcom/android/server/am/AppCompactor;)V
    ...
    invoke-direct {p0}, compactSystem()V
...
.method static synthetic access$200(Lcom/android/server/am/AppCompactor;)V
    ...
    invoke-direct {p0}, updateCompactionActions()V
...
.method static synthetic access$300(Lcom/android/server/am/AppCompactor;)V
    ...
    invoke-direct {p0}, updateCompactionThrottles()V
...
.method static synthetic access$400(Lcom/android/server/am/AppCompactor;)V
    ...
    invoke-direct {p0}, updateStatsdSampleRate()V
...
.method static synthetic access$500(Lcom/android/server/am/AppCompactor;)V
    ...
    invoke-direct {p0}, updateFullRssThrottle()V
...
.method static synthetic access$600(Lcom/android/server/am/AppCompactor;)V
    ...
    invoke-direct {p0}, updateFullDeltaRssThrottle()V
...
.method static synthetic access$700(Lcom/android/server/am/AppCompactor;)V
    ...
    invoke-direct {p0}, updateProcStateThrottle()V
...
.method static synthetic access$800(Lcom/android/server/am/AppCompactor;)Lcom/android/server/am/AppCompactor$PropertyChangedCallbackForTest;
    ...
    iget-object v0, p0, mTestCallback:Lcom/android/server/am/AppCompactor$PropertyChangedCallbackForTest;
...
.method private parseProcStateThrottle(Ljava/lang/String;)Z
    ...
    iget-object v1, p0, mProcStateThrottle:Ljava/util/Set;
    ...
    :try_start_0
    iget-object v5, p0, mProcStateThrottle:Ljava/util/Set;
...
.method private updateCompactionActions()V
    ...
    iput-object v2, p0, mCompactActionSome:Ljava/lang/String;

    invoke-static {v0}, compactActionIntToString(I)Ljava/lang/String;

    move-result-object v2

    iput-object v2, p0, mCompactActionFull:Ljava/lang/String;
...
.method private updateCompactionThrottles()V
    ...
    iput-wide v7, p0, mCompactThrottleSomeSome:J
    ...
    iput-wide v7, p0, mCompactThrottleSomeFull:J
    ...
    iput-wide v7, p0, mCompactThrottleFullSome:J
    ...
    iput-wide v7, p0, mCompactThrottleFullFull:J
    ...
    iput-wide v7, p0, mCompactThrottleBFGS:J
    ...
    iput-wide v7, p0, mCompactThrottlePersistent:J
    :try_end_0
    .catch Ljava/lang/NumberFormatException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iput-wide v9, p0, mCompactThrottleFullSome:J
...
.method private updateFullDeltaRssThrottle()V
    ...
    iput-wide v2, p0, mFullDeltaRssThrottleKb:J

    iget-wide v2, p0, mFullDeltaRssThrottleKb:J
    ...
    iput-wide v0, p0, mFullDeltaRssThrottleKb:J
...
.method private updateFullRssThrottle()V
    ...
    iput-wide v2, p0, mFullAnonRssThrottleKb:J

    iget-wide v2, p0, mFullAnonRssThrottleKb:J
    ...
    iput-wide v0, p0, mFullAnonRssThrottleKb:J
...
.method private updateProcStateThrottle()V
    ...
    sget-object v0, DEFAULT_COMPACT_PROC_STATE_THROTTLE:Ljava/lang/String;
    ...
    invoke-direct {p0, v0}, parseProcStateThrottle(Ljava/lang/String;)Z
    ...
    sget-object v1, DEFAULT_COMPACT_PROC_STATE_THROTTLE:Ljava/lang/String;

    invoke-direct {p0, v1}, parseProcStateThrottle(Ljava/lang/String;)Z
    ...
    sget-object v3, DEFAULT_COMPACT_PROC_STATE_THROTTLE:Ljava/lang/String;
...
.method private updateStatsdSampleRate()V
    ...
    iput v0, p0, mStatsdSampleRate:F

    iget v0, p0, mStatsdSampleRate:F
...
.method private updateUseCompaction()V
    ...
    sget-object v0, DEFAULT_USE_COMPACTION:Ljava/lang/Boolean;
    ...
    iput-boolean v0, p0, mUseCompaction:Z

    iget-boolean v0, p0, mUseCompaction:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, mCompactionThread:Lcom/android/server/ServiceThread;
    ...
    iput-object v0, p0, mCompactionHandler:Landroid/os/Handler;
...
.method compactAllSystem()V
    ...
    iget-object v0, p0, mCompactionHandler:Landroid/os/Handler;
...
.method compactAppSome(Lcom/android/server/am/ProcessRecord;)V
    ...
    iget-object v1, p0, mPendingCompactionProcesses:Ljava/util/ArrayList;

    invoke-virtual {v1, p1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v1, p0, mCompactionHandler:Landroid/os/Handler;
...
.method dump(Ljava/io/PrintWriter;)V
    ...
    iget-boolean v2, p0, mUseCompaction:Z
    ...
    iget-object v2, p0, mCompactActionSome:Ljava/lang/String;
    ...
    iget-object v2, p0, mCompactActionFull:Ljava/lang/String;
    ...
    iget-wide v2, p0, mCompactThrottleSomeSome:J
    ...
    iget-wide v2, p0, mCompactThrottleSomeFull:J
    ...
    iget-wide v2, p0, mCompactThrottleFullSome:J
    ...
    iget-wide v2, p0, mCompactThrottleFullFull:J
    ...
    iget-wide v2, p0, mCompactThrottleBFGS:J
    ...
    iget-wide v2, p0, mCompactThrottlePersistent:J
    ...
    iget v2, p0, mStatsdSampleRate:F
    ...
    iget-object v2, p0, mProcStateThrottle:Ljava/util/Set;
    ...
    iget v2, p0, mSomeCompactionCount:I
    ...
    iget v2, p0, mFullCompactionCount:I
    ...
    iget v2, p0, mPersistentCompactionCount:I
    ...
    iget v2, p0, mBfgsCompactionCount:I
    ...
    iget-object v2, p0, mLastCompactionStats:Ljava/util/Map;
    ...
    iget-object v1, p0, mLastCompactionStats:Ljava/util/Map;
...
.method public init()V
    ...
    iget-object v1, p0, mOnFlagsChangedListener:Landroid/provider/DeviceConfig$OnPropertiesChangedListener;
...
.method public useCompaction()Z
    ...
    :try_start_0
    iget-boolean v1, p0, mUseCompaction:Z
