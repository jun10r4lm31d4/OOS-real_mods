...
.method static constructor <clinit>()V
    ...
    sput v0, BACKGROUND_USER:I

    const/4 v0, -0x3

    sput v0, ALREADY_SHOWING:I
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/AppErrorDialog$Data;)V
    ...
    iput-object v1, p0, mProc:Lcom/android/server/am/ProcessRecord;

    iget-object v1, p3, Lcom/android/server/am/AppErrorDialog$Data;->result:Lcom/android/server/am/AppErrorResult;

    iput-object v1, p0, mResult:Lcom/android/server/am/AppErrorResult;
    ...
    :goto_0
    iput-boolean v1, p0, mIsRestartable:Z

    invoke-static {}, Landroid/text/BidiFormatter;->getInstance()Landroid/text/BidiFormatter;

    move-result-object v1

    iget-object v4, p0, mProc:Lcom/android/server/am/ProcessRecord;
    ...
    iget-object v5, p0, mProc:Lcom/android/server/am/ProcessRecord;
    ...
    iget-object v2, p0, mProc:Lcom/android/server/am/ProcessRecord;
    ...
    invoke-virtual {p0, v2}, setCancelMessage(Landroid/os/Message;)V
    ...
    iget-object v3, p0, mProc:Lcom/android/server/am/ProcessRecord;
...
.method static synthetic access$000(Lcom/android/server/am/AppErrorDialog;I)V
    ...
    invoke-direct {p0, p1}, setResult(I)V
...
.method private setResult(I)V
    ...
    iget-object v1, p0, mProc:Lcom/android/server/am/ProcessRecord;
...
.method public dismiss()V
    ...
    invoke-direct {p0, v0}, setResult(I)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iget-boolean v6, p0, mIsRestartable:Z
    ...
    invoke-virtual {p0, v9}, findViewById(I)Landroid/view/View;
    ...
    invoke-virtual {p0, v10}, findViewById(I)Landroid/view/View;
