...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, DEBUG_PROCESS_ADJ_CONTROL:Z
    ...
    sput-boolean v0, PROCESS_ADJ_CONTROL_ENABLED:Z

    const/4 v0, 0x0

    sput-object v0, opProcessAdjControl:Lcom/android/server/am/IOpProcessAdjControl;

    sput-object v0, opSmartPowerControl:Lcom/android/server/IOpSmartPowerControl;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, sRestartWhiteList:Ljava/util/ArrayList;
    ...
    sput-boolean v0, IS_HIDE_PCB_FEATURE:Z

    sput v2, mHighConsumptionAppPid:I

    const-wide/16 v0, 0x0

    sput-wide v0, mHighConsumptionTime:J

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    sput-object v0, rmTaskSet:Ljava/util/HashSet;
...
.method public constructor <init>()V
    ...
    iput-wide v0, p0, mLastInputEvent:J

    const/4 v0, 0x0

    iput-boolean v0, p0, mPointerEventListenerRegistered:Z

    const/4 v1, 0x0

    iput-object v1, p0, mAutoShutdownWakelock:Landroid/os/PowerManager$WakeLock;
    ...
    iput-object v2, p0, mHidePcbList:Ljava/util/ArrayList;

    iput-boolean v0, p0, mHidePcbWindow:Z

    new-instance v2, Ljava/lang/String;

    invoke-direct {v2}, Ljava/lang/String;-><init>()V

    iput-object v2, p0, mLaunchPackageName:Ljava/lang/String;

    iput-boolean v0, p0, mIsMultiWindowMode:Z
    ...
    iput-boolean v0, p0, mInputMethodVisible:Z
    ...
    iput-object v0, p0, mPointerEventListener:Landroid/view/WindowManagerPolicyConstants$PointerEventListener;
    ...
    iput-object v0, p0, mTurnOffScreenIfSetupIdle:Ljava/lang/Runnable;

    iput-object v1, p0, items:Ljava/lang/Object;

    iput-object v1, p0, class1:Ljava/lang/Class;

    iput-object v1, p0, pcb:Ljava/lang/String;
    ...
    iput-object v0, p0, mResetAllowLaunchBackground:Ljava/lang/Runnable;
...
.method static synthetic access$000(Lcom/android/server/am/ActivityManagerServiceInjector;)Z
    ...
    iget-boolean v0, p0, mPointerEventListenerRegistered:Z
...
.method static synthetic access$002(Lcom/android/server/am/ActivityManagerServiceInjector;Z)Z
    ...
    iput-boolean p1, p0, mPointerEventListenerRegistered:Z
...
.method static synthetic access$100(Lcom/android/server/am/ActivityManagerServiceInjector;)Landroid/view/WindowManagerPolicyConstants$PointerEventListener;
    ...
    iget-object v0, p0, mPointerEventListener:Landroid/view/WindowManagerPolicyConstants$PointerEventListener;
...
.method static synthetic access$1000(Lcom/android/server/am/ActivityManagerServiceInjector;)Ljava/lang/Object;
    ...
    iget-object v0, p0, items:Ljava/lang/Object;
...
.method static synthetic access$1100(Lcom/android/server/am/ActivityManagerServiceInjector;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, showPCBNo(Ljava/lang/String;)V
...
.method static synthetic access$1202(Lcom/android/server/am/ActivityManagerServiceInjector;Z)Z
    ...
    iput-boolean p1, p0, mIsMultiWindowMode:Z
...
.method static synthetic access$200(Lcom/android/server/am/ActivityManagerServiceInjector;)Lcom/android/server/wm/WindowManagerService;
    ...
    iget-object v0, p0, mWmService:Lcom/android/server/wm/WindowManagerService;
...
.method static synthetic access$300(Lcom/android/server/am/ActivityManagerServiceInjector;)Landroid/os/PowerManager$WakeLock;
    ...
    iget-object v0, p0, mAutoShutdownWakelock:Landroid/os/PowerManager$WakeLock;
...
.method static synthetic access$400(Lcom/android/server/am/ActivityManagerServiceInjector;)Ljava/lang/Runnable;
    ...
    iget-object v0, p0, mTurnOffScreenIfSetupIdle:Ljava/lang/Runnable;
...
.method static synthetic access$700(Lcom/android/server/am/ActivityManagerServiceInjector;)J
    ...
    iget-wide v0, p0, mLastInputEvent:J
...
.method static synthetic access$900(Lcom/android/server/am/ActivityManagerServiceInjector;)Ljava/lang/String;
    ...
    iget-object v0, p0, pcb:Ljava/lang/String;
...
.method public static addRestartWhitelist()V
    ...
    invoke-static {v0}, addRestartWhitelist(Ljava/lang/String;)V
...
.method private static addRestartWhitelist(Ljava/lang/String;)V
    ...
    sget-object v0, sRestartWhiteList:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    sget-object v1, sRestartWhiteList:Ljava/util/ArrayList;
...
.method public static final checkRestart(Lcom/android/server/am/ProcessRecord;ZI)Z
    ...
    invoke-static {v1}, isExcludedAPP(Ljava/lang/String;)Z
...
.method public static cleanupProcessesByWatchdog(Lcom/android/server/am/ProcessList;JI)V
    ...
    invoke-static {v5, p1, p2, p3}, isProcShouldBeKilled(Lcom/android/server/am/ProcessRecord;JI)Z
...
.method public static getInstance()Lcom/android/server/am/ActivityManagerServiceInjector;
    ...
    sget-object v0, mAmsInjector:Lcom/android/server/am/ActivityManagerServiceInjector;
    ...
    sput-object v0, mAmsInjector:Lcom/android/server/am/ActivityManagerServiceInjector;
...
.method public static initProcessAdjControl(Landroid/content/Context;)V
    ...
    sget-boolean v0, DEBUG_PROCESS_ADJ_CONTROL:Z
    ...
    :cond_0
    sget-boolean v0, PROCESS_ADJ_CONTROL_ENABLED:Z

    if-eqz v0, :cond_3

    sget-object v0, opProcessAdjControl:Lcom/android/server/am/IOpProcessAdjControl;
...
.method public static isDeepClean(Ljava/lang/String;)Z
    ...
    sget-object v0, opSmartPowerControl:Lcom/android/server/IOpSmartPowerControl;
...
.method private static isProcShouldBeKilled(Lcom/android/server/am/ProcessRecord;JI)Z
    ...
    sget v2, mHighConsumptionAppPid:I
    ...
    sget-wide v3, mHighConsumptionTime:J
...
.method public static isRemoveTsk(Ljava/lang/String;)Z
    ...
    sget-object v1, rmTaskSet:Ljava/util/HashSet;
...
.method public static recordProcesskillbyRMTsk(Ljava/lang/String;)V
    ...
    sget-object v0, rmTaskSet:Ljava/util/HashSet;
...
.method private shouldHidePCB(Ljava/lang/String;)Z
    ...
    iget-object v0, p0, mHidePcbList:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, mHidePcbList:Ljava/util/ArrayList;
...
.method private final showPCBNo(Ljava/lang/String;)V
    ...
    iput-object v0, p0, mPcbView:Landroid/view/View;

    new-instance v0, Landroid/view/WindowManager$LayoutParams;

    invoke-direct {v0}, Landroid/view/WindowManager$LayoutParams;-><init>()V

    iget-object v1, p0, mPcbView:Landroid/view/View;
    ...
    iget-object v3, p0, mPcbView:Landroid/view/View;
...
.method public getInputMethodVisible()Z
    ...
    :try_start_0
    iget-boolean v1, p0, mInputMethodVisible:Z
...
.method public final getPCBNumber(Landroid/content/Context;)V
    ...
    iput-object v5, p0, items:Ljava/lang/Object;
    ...
    iget-object v7, p0, qcHandler:Landroid/os/Handler;
    ...
    iget-object v3, p0, items:Ljava/lang/Object;
...
.method public initAutoShutdown(Landroid/content/Context;Lcom/android/server/wm/WindowManagerService;Landroid/os/Handler;)V
    ...
    iput-object p2, p0, mWmService:Lcom/android/server/wm/WindowManagerService;
    ...
    iget-object v3, p0, mPointerEventListener:Landroid/view/WindowManagerPolicyConstants$PointerEventListener;
    ...
    iput-boolean v2, p0, mPointerEventListenerRegistered:Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iput-object v4, p0, mAutoShutdownWakelock:Landroid/os/PowerManager$WakeLock;

    iget-object v4, p0, mAutoShutdownWakelock:Landroid/os/PowerManager$WakeLock;
    ...
    iput-wide v4, p0, mLastInputEvent:J

    iget-object v0, p0, mWmService:Lcom/android/server/wm/WindowManagerService;

    iget-object v4, p0, mPointerEventListener:Landroid/view/WindowManagerPolicyConstants$PointerEventListener;
    ...
    iput-boolean v3, p0, mPointerEventListenerRegistered:Z

    iget-object v0, p0, mHandler:Landroid/os/Handler;

    iget-object v2, p0, mTurnOffScreenIfSetupIdle:Ljava/lang/Runnable;
...
.method public initOMMDockDividerVisibility()V
    ...
    iput-object v0, p0, mDockDividerVisibilityListener:Lcom/android/server/am/ActivityManagerServiceInjector$DockDividerVisibilityListener;
    ...
    iget-object v1, p0, mDockDividerVisibilityListener:Lcom/android/server/am/ActivityManagerServiceInjector$DockDividerVisibilityListener;
...
.method public isAllowLaunchBackground(Ljava/lang/String;)Z
    ...
    iget-object v0, p0, mLaunchPackageName:Ljava/lang/String;
    ...
    iget-boolean v0, p0, mAllowLaunchBackground:Z
...
.method isDockedApp(Ljava/lang/String;I)Z
    ...
    :try_start_0
    iget-boolean v2, p0, mIsMultiWindowMode:Z
...
.method public synthetic lambda$setPCBVisibility$0$ActivityManagerServiceInjector(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, shouldHidePCB(Ljava/lang/String;)Z

    move-result v0

    iget-boolean v1, p0, mHidePcbWindow:Z
...
.method public setAllowLaunchBackground(Landroid/os/Handler;Ljava/lang/String;)V
    ...
    iput-boolean v0, p0, mAllowLaunchBackground:Z

    iput-object p2, p0, mLaunchPackageName:Ljava/lang/String;

    iget-object v0, p0, mResetAllowLaunchBackground:Ljava/lang/Runnable;
...
.method public setInputMethodVisible(Z)V
    ...
    :try_start_0
    iput-boolean p1, p0, mInputMethodVisible:Z
...
.method public setPCBVisibility(Ljava/lang/String;)V
    ...
    sget-boolean v0, IS_HIDE_PCB_FEATURE:Z

    if-eqz v0, :cond_1

    iget-object v0, p0, mPcbView:Landroid/view/View;
    ...
    :cond_0
    iget-object v0, p0, qcHandler:Landroid/os/Handler;
