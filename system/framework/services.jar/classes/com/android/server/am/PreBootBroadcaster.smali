...
.method public constructor <init>(Lcom/android/server/am/ActivityManagerService;ILcom/android/internal/util/ProgressReporter;Z)V
    ...
    iput-object p3, p0, mProgress:Lcom/android/internal/util/ProgressReporter;

    iput-boolean p4, p0, mQuiet:Z
    ...
    iput-object v0, p0, mTargets:Ljava/util/List;
...
.method public sendNext()V
    ...
    iget v0, v15, mIndex:I

    iget-object v1, v15, mTargets:Ljava/util/List;
    ...
    iget-object v0, v15, mHandler:Landroid/os/Handler;
    ...
    invoke-virtual/range {p0 .. p0}, onFinished()V
    ...
    iget-object v2, v15, mTargets:Ljava/util/List;

    invoke-interface {v2}, Ljava/util/List;->size()I

    move-result v2

    iget v4, v15, mIndex:I
    ...
    :cond_2
    iget-object v0, v15, mTargets:Ljava/util/List;

    iget v2, v15, mIndex:I

    add-int/lit8 v4, v2, 0x1

    iput v4, v15, mIndex:I
    ...
    iget-object v0, v15, mProgress:Lcom/android/internal/util/ProgressReporter;
    ...
    iget-object v2, v15, mProgress:Lcom/android/internal/util/ProgressReporter;

    iget v4, v15, mIndex:I

    iget-object v5, v15, mTargets:Ljava/util/List;

    invoke-interface {v5}, Ljava/util/List;->size()I

    move-result v5

    iget-object v6, v15, mService:Lcom/android/server/am/ActivityManagerService;
    ...
    iget-object v0, v15, mIntent:Landroid/content/Intent;

    invoke-virtual {v0, v13}, Landroid/content/Intent;->setComponent(Landroid/content/ComponentName;)Landroid/content/Intent;

    iget-object v12, v15, mService:Lcom/android/server/am/ActivityManagerService;
    ...
    iget-object v4, v15, mIntent:Landroid/content/Intent;
