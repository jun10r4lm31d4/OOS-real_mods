...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;)V
    ...
    invoke-direct {p0, v0}, <init>(Lcom/android/server/am/UserController$Injector;)V
...
.method constructor <init>(Lcom/android/server/am/UserController$Injector;)V
    ...
    iput v1, p0, mTargetUserId:I

    new-instance v1, Landroid/util/SparseArray;

    invoke-direct {v1}, Landroid/util/SparseArray;-><init>()V

    iput-object v1, p0, mStartedUsers:Landroid/util/SparseArray;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, mUserLru:Ljava/util/ArrayList;
    ...
    iput-object v2, p0, mStartedUserArray:[I

    new-array v2, v0, [I

    iput-object v2, p0, mCurrentProfileIds:[I

    new-instance v2, Landroid/util/SparseIntArray;

    invoke-direct {v2}, Landroid/util/SparseIntArray;-><init>()V

    iput-object v2, p0, mUserProfileGroupIds:Landroid/util/SparseIntArray;

    new-instance v2, Landroid/os/RemoteCallbackList;

    invoke-direct {v2}, Landroid/os/RemoteCallbackList;-><init>()V

    iput-object v2, p0, mUserSwitchObservers:Landroid/os/RemoteCallbackList;

    iput-boolean v1, p0, mUserSwitchUiEnabled:Z

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, mLastActiveUsers:Ljava/util/ArrayList;

    iput-object p1, p0, mInjector:Lcom/android/server/am/UserController$Injector;

    iget-object v1, p0, mInjector:Lcom/android/server/am/UserController$Injector;
    ...
    iget-object v2, p0, mStartedUsers:Landroid/util/SparseArray;

    invoke-virtual {v2, v0, v1}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    iget-object v2, p0, mUserLru:Ljava/util/ArrayList;
    ...
    iget-object v0, p0, mInjector:Lcom/android/server/am/UserController$Injector;
    ...
    invoke-direct {p0}, updateStartedUserArrayLU()V
...
.method static synthetic access$400(Lcom/android/server/am/UserController;)Landroid/util/ArraySet;
    ...
    iget-object v0, p0, mCurWaitingUserSwitchCallbacks:Landroid/util/ArraySet;
...
.method private dispatchForegroundProfileChanged(I)V
    ...
    iget-object v0, p0, mUserSwitchObservers:Landroid/os/RemoteCallbackList;
    ...
    :try_start_0
    iget-object v2, p0, mUserSwitchObservers:Landroid/os/RemoteCallbackList;
    ...
    :cond_0
    iget-object v1, p0, mUserSwitchObservers:Landroid/os/RemoteCallbackList;
...
.method private finishUserBoot(Lcom/android/server/am/UserState;)V
    ...
    invoke-direct {p0, p1, v0}, finishUserBoot(Lcom/android/server/am/UserState;Landroid/content/IIntentReceiver;)V
...
.method private finishUserBoot(Lcom/android/server/am/UserState;Landroid/content/IIntentReceiver;)V
    ...
    :try_start_0
    iget-object v0, v1, mStartedUsers:Landroid/util/SparseArray;
    ...
    iget-object v0, v1, mInjector:Lcom/android/server/am/UserController$Injector;
    ...
    iget-object v4, v1, mInjector:Lcom/android/server/am/UserController$Injector;
    ...
    iget-object v3, v1, mInjector:Lcom/android/server/am/UserController$Injector;
    ...
    invoke-virtual {v1, v3, v5}, isUserRunning(II)Z
    ...
    invoke-direct {v1, v4}, maybeUnlockUser(I)Z
...
.method private finishUserUnlockedCompleted(Lcom/android/server/am/UserState;)V
    ...
    :try_start_0
    iget-object v0, v7, mStartedUsers:Landroid/util/SparseArray;
    ...
    invoke-direct {v7, v6}, getUserInfo(I)Landroid/content/pm/UserInfo;
    ...
    :cond_2
    iget-object v1, v7, mInjector:Lcom/android/server/am/UserController$Injector;
    ...
    iget-object v9, v7, mInjector:Lcom/android/server/am/UserController$Injector;
    ...
    iget-object v2, v7, mInjector:Lcom/android/server/am/UserController$Injector;
...
.method private finishUserUnlocking(Lcom/android/server/am/UserState;)Z
    ...
    :try_start_0
    iget-object v3, p0, mStartedUsers:Landroid/util/SparseArray;
    ...
    iget-object v3, p0, mInjector:Lcom/android/server/am/UserController$Injector;
...
.method private forceStopUser(ILjava/lang/String;)V
    ...
    iget-object v2, v0, mInjector:Lcom/android/server/am/UserController$Injector;
    ...
    iget-object v5, v0, mInjector:Lcom/android/server/am/UserController$Injector;
...
.method private getSwitchingFromSystemUserMessage()Ljava/lang/String;
    ...
    :try_start_0
    iget-object v1, p0, mSwitchingFromSystemUserMessage:Ljava/lang/String;
...
.method private getSwitchingToSystemUserMessage()Ljava/lang/String;
    ...
    :try_start_0
    iget-object v1, p0, mSwitchingToSystemUserMessage:Ljava/lang/String;
...
.method private getUsersToStopLU(I)[I
    ...
    iget-object v0, p0, mStartedUsers:Landroid/util/SparseArray;
    ...
    iget-object v2, p0, mUserProfileGroupIds:Landroid/util/SparseIntArray;
    ...
    iget-object v5, p0, mStartedUsers:Landroid/util/SparseArray;
    ...
    iget-object v7, p0, mUserProfileGroupIds:Landroid/util/SparseIntArray;
...
.method private isCurrentUserLU(I)Z
    ...
    invoke-virtual {p0}, getCurrentOrTargetUserIdLU()I
...
.method private maybeUnlockChildProfile(I)V
    ...
    :try_start_0
    iget-object v1, p0, mStartedUsers:Landroid/util/SparseArray;
    ...
    iget-object v4, p0, mStartedUsers:Landroid/util/SparseArray;
    ...
    iget-object v4, p0, mInjector:Lcom/android/server/am/UserController$Injector;
    ...
    invoke-direct {p0, v3}, maybeUnlockUser(I)Z
...
.method private maybeUnlockUser(I)Z
    ...
    invoke-direct {p0, p1, v0, v0, v0}, unlockUserCleared(I[B[BLandroid/os/IProgressListener;)Z
...
.method private moveUserToForeground(Lcom/android/server/am/UserState;II)V
    ...
    invoke-virtual {p0, p2, p3}, sendUserSwitchBroadcasts(II)V
...
.method private showUserSwitchDialog(Landroid/util/Pair;)V
    ...
    invoke-direct {p0}, getSwitchingFromSystemUserMessage()Ljava/lang/String;

    move-result-object v3

    invoke-direct {p0}, getSwitchingToSystemUserMessage()Ljava/lang/String;
...
.method private stopBackgroundUsersIfEnforced(I)V
    ...
    iget-boolean v0, p0, mDelayUserDataLocking:Z
    ...
    invoke-direct {p0, p1, v1, v3, v3}, stopUsersLU(IZLandroid/app/IStopUserCallback;Lcom/android/server/am/UserState$KeyEvictedCallback;)I
...
.method private stopGuestOrEphemeralUserIfBackground(I)V
    ...
    :try_start_1
    invoke-direct {p0, p1, v0, v3, v3}, stopUsersLU(IZLandroid/app/IStopUserCallback;Lcom/android/server/am/UserState$KeyEvictedCallback;)I
...
.method private stopUsersLU(IZLandroid/app/IStopUserCallback;Lcom/android/server/am/UserState$KeyEvictedCallback;)I
    ...
    :cond_0
    invoke-direct {p0, p1}, isCurrentUserLU(I)Z
    ...
    :cond_1
    invoke-direct {p0, p1}, getUsersToStopLU(I)[I
    ...
    invoke-direct {p0, v2}, isCurrentUserLU(I)Z
    ...
    invoke-direct {p0, p1, p3, p4}, stopSingleUserLU(ILandroid/app/IStopUserCallback;Lcom/android/server/am/UserState$KeyEvictedCallback;)V
    ...
    :cond_9
    invoke-direct {p0, v3, v6, v5}, stopSingleUserLU(ILandroid/app/IStopUserCallback;Lcom/android/server/am/UserState$KeyEvictedCallback;)V
...
.method private timeoutUserSwitch(Lcom/android/server/am/UserState;II)V
    ...
    iget-object v1, p0, mCurWaitingUserSwitchCallbacks:Landroid/util/ArraySet;

    iput-object v1, p0, mTimeoutUserSwitchCallbacks:Landroid/util/ArraySet;
    ...
    invoke-virtual {p0, p1, p2, p3}, sendContinueUserSwitchLU(Lcom/android/server/am/UserState;II)V
...
.method private timeoutUserSwitchCallbacks(II)V
    ...
    :try_start_0
    iget-object v1, p0, mTimeoutUserSwitchCallbacks:Landroid/util/ArraySet;
    ...
    iget-object v3, p0, mTimeoutUserSwitchCallbacks:Landroid/util/ArraySet;
...
.method private unlockUserCleared(I[B[BLandroid/os/IProgressListener;)Z
    ...
    invoke-static {p1, p4}, notifyFinished(ILandroid/os/IProgressListener;)V

    return v3

    :cond_3
    invoke-direct {p0, v1}, finishUserUnlocking(Lcom/android/server/am/UserState;)Z
    ...
    :cond_4
    invoke-direct {p0, p1}, maybeUnlockChildProfile(I)V
...
.method private updateCurrentProfileIds()V
    ...
    :try_start_0
    iput-object v1, p0, mCurrentProfileIds:[I

    iget-object v5, p0, mUserProfileGroupIds:Landroid/util/SparseIntArray;
    ...
    iget-object v6, p0, mUserProfileGroupIds:Landroid/util/SparseIntArray;
...
.method private updateStartedUserArrayLU()V
    ...
    iput-object v1, p0, mStartedUserArray:[I
    ...
    iget-object v5, p0, mStartedUserArray:[I

    add-int/lit8 v6, v0, 0x1

    iget-object v7, p0, mStartedUsers:Landroid/util/SparseArray;
...
.method private updateUserToLockLU(I)I
    ...
    iget-boolean v1, p0, mDelayUserDataLocking:Z
    ...
    invoke-virtual {p0, v1, p1}, hasUserRestriction(Ljava/lang/String;I)Z

    move-result v1

    if-nez v1, :cond_1

    iget-object v1, p0, mLastActiveUsers:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, mLastActiveUsers:Ljava/util/ArrayList;
...
.method canStartMoreUsers()Z
    ...
    :try_start_0
    invoke-virtual {p0}, getRunningUsersLU()Ljava/util/List;
...
.method continueUserSwitch(Lcom/android/server/am/UserState;II)V
    ...
    iget-boolean v0, p0, mUserSwitchUiEnabled:Z
    ...
    invoke-direct {p0, p2}, stopGuestOrEphemeralUserIfBackground(I)V

    invoke-direct {p0, p2}, stopBackgroundUsersIfEnforced(I)V
...
.method dispatchUserSwitch(Lcom/android/server/am/UserState;II)V
    ...
    iget-object v0, v11, mUserSwitchObservers:Landroid/os/RemoteCallbackList;
    ...
    iget-object v1, v11, mLock:Ljava/lang/Object;
    ...
    iput-object v15, v11, mCurWaitingUserSwitchCallbacks:Landroid/util/ArraySet;
    ...
    iget-object v1, v11, mUserSwitchObservers:Landroid/os/RemoteCallbackList;
    ...
    :try_start_8
    invoke-virtual/range {p0 .. p3}, sendContinueUserSwitchLU(Lcom/android/server/am/UserState;II)V
...
.method dump(Ljava/io/PrintWriter;Z)V
    ...
    :goto_1
    iget-object v3, p0, mStartedUserArray:[I
    ...
    :goto_2
    iget-object v3, p0, mUserLru:Ljava/util/ArrayList;
...
.method finishUserStopped(Lcom/android/server/am/UserState;)V
    ...
    iget-object v6, p0, mStartedUsers:Landroid/util/SparseArray;
    ...
    iget-object v7, p0, mUserLru:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v0}, updateUserToLockLU(I)I
    ...
    invoke-direct {p0, v0, v3}, forceStopUser(ILjava/lang/String;)V
    ...
    invoke-direct {p0, v0}, getUserInfo(I)Landroid/content/pm/UserInfo;
...
.method finishUserStopping(ILcom/android/server/am/UserState;)V
    ...
    iget-object v2, v1, mInjector:Lcom/android/server/am/UserController$Injector;
...
.method finishUserUnlocked(Lcom/android/server/am/UserState;)V
    ...
    invoke-direct {v1, v15}, maybeUnlockChildProfile(I)V
    ...
    invoke-direct {v1, v4}, getUserInfo(I)Landroid/content/pm/UserInfo;
    ...
    invoke-virtual/range {p0 .. p0}, hasMdmReady()Z
    ...
    iget-object v11, v1, mInjector:Lcom/android/server/am/UserController$Injector;
    ...
    iget-object v8, v1, mInjector:Lcom/android/server/am/UserController$Injector;
    ...
    iget-object v6, v1, mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;
    ...
    :goto_4
    iget-object v7, v1, mInjector:Lcom/android/server/am/UserController$Injector;
    ...
    :cond_b
    invoke-direct/range {p0 .. p1}, finishUserUnlockedCompleted(Lcom/android/server/am/UserState;)V
...
.method getCurrentProfileIds()[I
    ...
    :try_start_0
    iget-object v1, p0, mCurrentProfileIds:[I
...
.method getCurrentUser()Landroid/content/pm/UserInfo;
    ...
    :try_start_0
    invoke-virtual {p0}, getCurrentUserLU()Landroid/content/pm/UserInfo;
...
.method getRunningUsersLU()Ljava/util/List;
    ...
    iget-object v1, p0, mUserLru:Ljava/util/ArrayList;
...
.method getStartedUserArray()[I
    ...
    :try_start_0
    iget-object v1, p0, mStartedUserArray:[I
...
.method handleIncomingUser(IIIZILjava/lang/String;Ljava/lang/String;)I
    ...
    :cond_0
    invoke-virtual {p0, v8}, unsafeConvertIncomingUser(I)I
    ...
    iget-object v1, v0, mInjector:Lcom/android/server/am/UserController$Injector;
    ...
    invoke-virtual {p0, v11, v12}, isSameProfileGroup(II)Z
    ...
    invoke-virtual {p0, v12}, ensureNotSpecialUser(I)V
    ...
    invoke-virtual {p0, v1, v12}, hasUserRestriction(Ljava/lang/String;I)Z
...
.method public handleMessage(Landroid/os/Message;)Z
    ...
    invoke-direct {p0, v0}, showUserSwitchDialog(Landroid/util/Pair;)V
    ...
    invoke-virtual {p0, v0}, startUserInForeground(I)V
    ...
    invoke-direct {p0, v0}, dispatchLockedBootComplete(I)V
    ...
    invoke-virtual {p0, v1}, finishUserUnlocked(Lcom/android/server/am/UserState;)V
    ...
    invoke-direct {p0, v0, v1}, timeoutUserSwitchCallbacks(II)V
    ...
    invoke-virtual {p0, v0}, dispatchUserSwitchComplete(I)V
    ...
    invoke-direct {p0, v0}, dispatchForegroundProfileChanged(I)V
    ...
    :sswitch_9
    invoke-virtual {p0}, startProfiles()V
    ...
    invoke-direct {p0, v0, v1, v2}, timeoutUserSwitch(Lcom/android/server/am/UserState;II)V
    ...
    invoke-virtual {p0, v0, v1, v2}, continueUserSwitch(Lcom/android/server/am/UserState;II)V
    ...
    invoke-virtual {p0, v0, v1, v2}, dispatchUserSwitch(Lcom/android/server/am/UserState;II)V
...
.method isSameProfileGroup(II)Z
    ...
    iget-object v4, p0, mUserProfileGroupIds:Landroid/util/SparseIntArray;
...
.method isUserOrItsParentRunning(I)Z
    ...
    :try_start_0
    invoke-virtual {p0, p1, v1}, isUserRunning(II)Z
    ...
    :cond_1
    invoke-virtual {p0, v2, v1}, isUserRunning(II)Z
...
.method isUserRunning(II)Z
    ...
    invoke-virtual {p0, p1}, getStartedUserState(I)Lcom/android/server/am/UserState;
...
.method public synthetic lambda$finishUserSwitch$0$UserController(Lcom/android/server/am/UserState;)V
    ...
    invoke-direct {p0, p1}, finishUserBoot(Lcom/android/server/am/UserState;)V
    ...
    :try_start_0
    iget v1, p0, mMaxRunningUsers:I

    invoke-virtual {p0, v1}, stopRunningUsersLU(I)V
...
.method public synthetic lambda$finishUserUnlocked$2$UserController(Lcom/android/server/am/UserState;)V
    ...
    invoke-direct {p0, p1}, finishUserUnlockedCompleted(Lcom/android/server/am/UserState;)V
...
.method public synthetic lambda$startUser$8$UserController(IZLandroid/os/IProgressListener;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, startUser(IZLandroid/os/IProgressListener;)Z
...
.method public synthetic lambda$stopSingleUserLU$5$UserController(ILcom/android/server/am/UserState;)V
    ...
    iget-object v4, v0, mInjector:Lcom/android/server/am/UserController$Injector;
...
.method onSystemReady()V
    ...
    invoke-direct {p0}, updateCurrentProfileIds()V
...
.method onUserRemoved(I)V
    ...
    :try_start_0
    iget-object v1, p0, mUserProfileGroupIds:Landroid/util/SparseIntArray;
    ...
    iget-object v3, p0, mUserProfileGroupIds:Landroid/util/SparseIntArray;
...
.method restartUser(IZ)I
    ...
    invoke-virtual {p0, p1, v1, v2, v0}, stopUser(IZLandroid/app/IStopUserCallback;Lcom/android/server/am/UserState$KeyEvictedCallback;)I
...
.method sendBootCompleted(Landroid/content/IIntentReceiver;)V
    ...
    invoke-direct {p0, v2, p1}, finishUserBoot(Lcom/android/server/am/UserState;Landroid/content/IIntentReceiver;)V
...
.method sendContinueUserSwitchLU(Lcom/android/server/am/UserState;II)V
    ...
    iput-object v0, p0, mCurWaitingUserSwitchCallbacks:Landroid/util/ArraySet;
...
.method setSwitchingFromSystemUserMessage(Ljava/lang/String;)V
    ...
    :try_start_0
    iput-object p1, p0, mSwitchingFromSystemUserMessage:Ljava/lang/String;
...
.method setSwitchingToSystemUserMessage(Ljava/lang/String;)V
    ...
    :try_start_0
    iput-object p1, p0, mSwitchingToSystemUserMessage:Ljava/lang/String;
...
.method startProfiles()V
    ...
    invoke-virtual {p0, v7, v3}, startUser(IZ)Z
...
.method startUser(IZ)Z
    ...
    invoke-virtual {p0, p1, p2, v0}, startUser(IZLandroid/os/IProgressListener;)Z
...
.method startUser(IZLandroid/os/IProgressListener;)Z
    ...
    :try_start_0
    invoke-virtual/range {p0 .. p0}, getCurrentUserId()I
    ...
    invoke-virtual/range {p0 .. p1}, getStartedUserState(I)Lcom/android/server/am/UserState;
    ...
    invoke-static {v14, v12}, notifyFinished(ILandroid/os/IProgressListener;)V
    :try_end_0
    ...
    :cond_4
    invoke-direct/range {p0 .. p1}, getUserInfo(I)Landroid/content/pm/UserInfo;
    ...
    :try_start_3
    iget-boolean v3, v1, mUserSwitchUiEnabled:Z
    ...
    :try_start_4
    iget-object v6, v1, mStartedUsers:Landroid/util/SparseArray;
    ...
    iget-object v9, v1, mStartedUsers:Landroid/util/SparseArray;

    invoke-virtual {v9, v14, v6}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    invoke-direct/range {p0 .. p0}, updateStartedUserArrayLU()V
    :try_end_5
    ...
    :try_start_7
    invoke-direct/range {p0 .. p0}, isCallingOnHandlerThread()Z
    ...
    iget-object v2, v1, mHandler:Landroid/os/Handler;
    ...
    iget-object v6, v1, mUserLru:Ljava/util/ArrayList;
    ...
    :try_start_a
    iput v14, v1, mCurrentUserId:I

    const/16 v5, -0x2710

    iput v5, v1, mTargetUserId:I
    ...
    invoke-direct/range {p0 .. p0}, updateCurrentProfileIds()V
    ...
    invoke-virtual/range {p0 .. p0}, getCurrentProfileIds()[I
    ...
    iget-boolean v4, v1, mUserSwitchUiEnabled:Z
    ...
    iget-object v5, v1, mInjector:Lcom/android/server/am/UserController$Injector;
    ...
    iget-object v3, v1, mHandler:Landroid/os/Handler;

    iget-object v4, v1, mHandler:Landroid/os/Handler;
    ...
    iget-object v5, v1, mHandler:Landroid/os/Handler;
    ...
    :try_start_15
    invoke-direct {v1, v14, v15, v2}, moveUserToForeground(Lcom/android/server/am/UserState;II)V
    ...
    invoke-direct {v1, v14}, finishUserBoot(Lcom/android/server/am/UserState;)V
...
.method startUserInForeground(I)V
    ...
    invoke-virtual {p0, p1, v0}, startUser(IZ)Z
...
.method stopRunningUsersLU(I)V
    ...
    invoke-direct {p0, v3, v4, v5, v5}, stopUsersLU(IZLandroid/app/IStopUserCallback;Lcom/android/server/am/UserState$KeyEvictedCallback;)I
...
.method stopUser(IZLandroid/app/IStopUserCallback;Lcom/android/server/am/UserState$KeyEvictedCallback;)I
    ...
    invoke-direct {p0, v0, p1}, enforceShellRestriction(Ljava/lang/String;I)V
    ...
    :try_start_0
    invoke-direct {p0, p1, p2, p3, p4}, stopUsersLU(IZLandroid/app/IStopUserCallback;Lcom/android/server/am/UserState$KeyEvictedCallback;)I
...
.method switchUser(I)Z
    ...
    :try_start_0
    iput p1, p0, mTargetUserId:I

    monitor-exit v4
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-boolean v4, p0, mUserSwitchUiEnabled:Z
...
.method unlockUser(I[B[BLandroid/os/IProgressListener;)Z
    ...
    :try_start_0
    invoke-direct {p0, p1, p2, p3, p4}, unlockUserCleared(I[B[BLandroid/os/IProgressListener;)Z
...
.method writeToProto(Landroid/util/proto/ProtoOutputStream;J)V
    ...
    :goto_2
    iget-object v5, p0, mUserLru:Ljava/util/ArrayList;
    ...
    iget-object v8, p0, mUserProfileGroupIds:Landroid/util/SparseIntArray;
    ...
    iget-object v10, p0, mUserProfileGroupIds:Landroid/util/SparseIntArray;
