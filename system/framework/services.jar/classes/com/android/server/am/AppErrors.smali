...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/am/ActivityManagerService;Lcom/android/server/PackageWatchdog;)V
    ...
    iput-object v0, p0, mProcessCrashTimes:Lcom/android/internal/app/ProcessMap;

    new-instance v0, Lcom/android/internal/app/ProcessMap;

    invoke-direct {v0}, Lcom/android/internal/app/ProcessMap;-><init>()V

    iput-object v0, p0, mProcessCrashTimesPersistent:Lcom/android/internal/app/ProcessMap;

    new-instance v0, Lcom/android/internal/app/ProcessMap;

    invoke-direct {v0}, Lcom/android/internal/app/ProcessMap;-><init>()V

    iput-object v0, p0, mBadProcesses:Lcom/android/internal/app/ProcessMap;
    ...
    iput-object p3, p0, mPackageWatchdog:Lcom/android/server/PackageWatchdog;
...
.method private killAppImmediateLocked(Lcom/android/server/am/ProcessRecord;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual/range {v2 .. v8}, handleAppCrashLocked(Lcom/android/server/am/ProcessRecord;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/android/server/am/AppErrorDialog$Data;)Z
...
.method private makeAppCrashingLocked(Lcom/android/server/am/ProcessRecord;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/android/server/am/AppErrorDialog$Data;)Z
    ...
    invoke-virtual/range {v1 .. v7}, generateProcessError(Lcom/android/server/am/ProcessRecord;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/app/ActivityManager$ProcessErrorStateInfo;
    ...
    invoke-virtual/range {v1 .. v7}, handleAppCrashLocked(Lcom/android/server/am/ProcessRecord;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/android/server/am/AppErrorDialog$Data;)Z
...
.method private stopReportingCrashesLocked(Lcom/android/server/am/ProcessRecord;)V
    ...
    iget-object v0, p0, mAppsNotReportingCrashes:Landroid/util/ArraySet;
    ...
    iput-object v0, p0, mAppsNotReportingCrashes:Landroid/util/ArraySet;
...
.method clearBadProcessLocked(Landroid/content/pm/ApplicationInfo;)V
    ...
    iget-object v0, p0, mBadProcesses:Lcom/android/internal/app/ProcessMap;
...
.method crashApplication(Lcom/android/server/am/ProcessRecord;Landroid/app/ApplicationErrorReport$CrashInfo;)V
    ...
    :try_start_0
    invoke-virtual {p0, p1, p2, v0, v1}, crashApplicationInner(Lcom/android/server/am/ProcessRecord;Landroid/app/ApplicationErrorReport$CrashInfo;II)V
    :try_end_0
...
.method crashApplicationInner(Lcom/android/server/am/ProcessRecord;Landroid/app/ApplicationErrorReport$CrashInfo;II)V
    ...
    :cond_5
    iget-object v0, v11, mPackageWatchdog:Lcom/android/server/PackageWatchdog;
    ...
    iget-object v5, v11, mService:Lcom/android/server/am/ActivityManagerService;
    ...
    :try_start_2
    invoke-direct/range {v1 .. v10}, handleAppCrashInActivityController(Lcom/android/server/am/ProcessRecord;Landroid/app/ApplicationErrorReport$CrashInfo;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;JII)Z
    ...
    invoke-direct/range {v1 .. v6}, makeAppCrashingLocked(Lcom/android/server/am/ProcessRecord;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/android/server/am/AppErrorDialog$Data;)Z
    ...
    :try_start_a
    invoke-direct/range {p0 .. p1}, stopReportingCrashesLocked(Lcom/android/server/am/ProcessRecord;)V
    ...
    :try_start_f
    invoke-virtual {v11, v12, v6, v7, v2}, createAppErrorIntentLocked(Lcom/android/server/am/ProcessRecord;JLandroid/app/ApplicationErrorReport$CrashInfo;)Landroid/content/Intent;
    ...
    iget-object v0, v11, mProcessCrashTimes:Lcom/android/internal/app/ProcessMap;
...
.method createAppErrorIntentLocked(Lcom/android/server/am/ProcessRecord;JLandroid/app/ApplicationErrorReport$CrashInfo;)Landroid/content/Intent;
    ...
    invoke-direct {p0, p1, p2, p3, p4}, createAppErrorReportLocked(Lcom/android/server/am/ProcessRecord;JLandroid/app/ApplicationErrorReport$CrashInfo;)Landroid/app/ApplicationErrorReport;
...
.method dumpLocked(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;ZLjava/lang/String;)Z
    ...
    iget-object v3, v0, mProcessCrashTimes:Lcom/android/internal/app/ProcessMap;
    ...
    iget-object v7, v0, mProcessCrashTimes:Lcom/android/internal/app/ProcessMap;
    ...
    :goto_3
    iget-object v3, v0, mBadProcesses:Lcom/android/internal/app/ProcessMap;
    ...
    iget-object v5, v0, mBadProcesses:Lcom/android/internal/app/ProcessMap;
...
.method handleAppCrashLocked(Lcom/android/server/am/ProcessRecord;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/android/server/am/AppErrorDialog$Data;)Z
    ...
    iget-object v4, v0, mProcessCrashTimes:Lcom/android/internal/app/ProcessMap;
    ...
    iget-object v5, v0, mProcessCrashTimesPersistent:Lcom/android/internal/app/ProcessMap;
    ...
    iget-object v11, v0, mBadProcesses:Lcom/android/internal/app/ProcessMap;
    ...
    iget-object v5, v0, mProcessCrashTimes:Lcom/android/internal/app/ProcessMap;
...
.method handleShowAnrUi(Landroid/os/Message;)V
    ...
    iget-object v2, p0, mPackageWatchdog:Lcom/android/server/PackageWatchdog;
...
.method handleShowAppErrorUi(Landroid/os/Message;)V
    ...
    iget-object v8, v1, mService:Lcom/android/server/am/ActivityManagerService;
    ...
    :goto_1
    iget-object v13, v1, mService:Lcom/android/server/am/ActivityManagerService;
    ...
    iget-object v14, v1, mService:Lcom/android/server/am/ActivityManagerService;
    ...
    :goto_5
    iget-object v13, v1, mAppsNotReportingCrashes:Landroid/util/ArraySet;
...
.method killAppAtUserRequestLocked(Lcom/android/server/am/ProcessRecord;Landroid/app/Dialog;)V
    ...
    invoke-direct {p0, p1, v0, v1}, killAppImmediateLocked(Lcom/android/server/am/ProcessRecord;Ljava/lang/String;Ljava/lang/String;)V
...
.method public synthetic lambda$handleAppCrashInActivityController$1$AppErrors(Landroid/app/ApplicationErrorReport$CrashInfo;Ljava/lang/String;ILcom/android/server/am/ProcessRecord;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V
    ...
    invoke-direct/range {v2 .. v7}, makeAppCrashingLocked(Lcom/android/server/am/ProcessRecord;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/android/server/am/AppErrorDialog$Data;)Z
...
.method public synthetic lambda$scheduleAppCrashLocked$0$AppErrors(Lcom/android/server/am/ProcessRecord;)V
    ...
    invoke-direct {p0, p1, v1, v2}, killAppImmediateLocked(Lcom/android/server/am/ProcessRecord;Ljava/lang/String;Ljava/lang/String;)V
...
.method loadAppsNotReportingCrashesFromConfigLocked(Ljava/lang/String;)V
    ...
    iput-object v1, p0, mAppsNotReportingCrashes:Landroid/util/ArraySet;

    iget-object v1, p0, mAppsNotReportingCrashes:Landroid/util/ArraySet;
...
.method resetProcessCrashTimeLocked(Landroid/content/pm/ApplicationInfo;)V
    ...
    iget-object v0, p0, mProcessCrashTimes:Lcom/android/internal/app/ProcessMap;
