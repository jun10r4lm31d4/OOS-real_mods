...
.method collectFlags()I
    ...
    iget-object v1, p0, apps:Landroid/util/ArrayMap;
...
.method dumpInService(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    iget-boolean v1, p0, requested:Z
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, intent:Landroid/content/Intent$FilterComparison;
...
.method public writeToProto(Landroid/util/proto/ProtoOutputStream;J)V
    ...
    iget-boolean v4, p0, requested:Z

    invoke-virtual {p1, v2, v3, v4}, Landroid/util/proto/ProtoOutputStream;->write(JZ)V

    const-wide v2, 0x10800000005L

    iget-boolean v4, p0, received:Z

    invoke-virtual {p1, v2, v3, v4}, Landroid/util/proto/ProtoOutputStream;->write(JZ)V

    const-wide v2, 0x10800000006L

    iget-boolean v4, p0, hasBound:Z

    invoke-virtual {p1, v2, v3, v4}, Landroid/util/proto/ProtoOutputStream;->write(JZ)V

    const-wide v2, 0x10800000007L

    iget-boolean v4, p0, doRebind:Z
