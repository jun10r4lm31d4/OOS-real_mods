...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, DEBUG_COLDSTART:Z

    sget-boolean v0, DEBUG_COLDSTART:Z
    ...
    :goto_0
    sput-wide v0, sReportInterval:J

    const/4 v0, 0x1

    sput-boolean v0, sEnable:Z

    sput-boolean v0, sEnableMdm:Z
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-wide v0, p0, mLastReportTime:J

    const-string v0, ""

    iput-object v0, p0, mCrashKillProcess:Ljava/lang/String;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mHistoryTasks:Ljava/util/ArrayList;

    const/16 v0, 0x3c

    iput v0, p0, mMaxHistorySize:I

    const/16 v0, 0xf

    iput v0, p0, mClearHistorySize:I

    const/16 v0, 0x14

    iput v0, p0, mMaxPosition:I
    ...
    iput-object v1, p0, mTaskPositionCount:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, mDiedProcessMap:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, mExtraData:Ljava/util/HashMap;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mMdmRecord:Ljava/util/ArrayList;

    invoke-direct {p0}, fillAllMdmData()V
    ...
    :cond_0
    iget-object v0, p0, mConfigHandlerThread:Landroid/os/HandlerThread;
    ...
    iput-object v0, p0, mConfigHandlerThread:Landroid/os/HandlerThread;
    ...
    iget-object v1, p0, mConfigHandlerThread:Landroid/os/HandlerThread;
    ...
    iget-object v3, p0, mConfigHandler:Landroid/os/Handler;
...
.method static synthetic access$000(Lcom/android/server/am/ColdStartInjector;)Ljava/lang/String;
    ...
    invoke-direct {p0}, makeAdjString()Ljava/lang/String;
...
.method static synthetic access$100(Lcom/android/server/am/ColdStartInjector;)Ljava/lang/String;
    ...
    invoke-direct {p0}, makePositionCountString()Ljava/lang/String;
...
.method static synthetic access$400(Lcom/android/server/am/ColdStartInjector;)Ljava/util/ArrayList;
    ...
    iget-object v0, p0, mMdmRecord:Ljava/util/ArrayList;
...
.method static synthetic access$500(Lorg/json/JSONArray;)V
    ...
    invoke-static {p0}, resolveConfig(Lorg/json/JSONArray;)V
...
.method private addPositionCount(I)V
    ...
    sget-boolean v1, DEBUG_COLDSTART:Z
    ...
    :cond_2
    iget-object v1, p0, mTaskPositionCount:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, mTaskPositionCount:Ljava/util/ArrayList;
    ...
    sget-boolean v2, DEBUG_COLDSTART:Z
    ...
    iget-object v3, p0, mTaskPositionCount:Ljava/util/ArrayList;
...
.method private checkNeedSubmit()V
    ...
    iget-wide v0, p0, mLastReportTime:J
    ...
    iget-wide v2, p0, mLastReportTime:J
    ...
    iget-object v3, p0, mMdmRecord:Ljava/util/ArrayList;
...
.method private fillAllMdmData()V
    ...
    iget-object v4, p0, mMdmRecord:Ljava/util/ArrayList;
...
.method private getHistoryTaskPosition(Ljava/lang/String;)I
    ...
    :cond_0
    iget-object v2, p0, mHistoryTasks:Ljava/util/ArrayList;
...
.method public static getInstance(Landroid/content/Context;)Lcom/android/server/am/ColdStartInjector;
    ...
    sget-object v0, sInstance:Lcom/android/server/am/ColdStartInjector;
    ...
    sput-object v0, sInstance:Lcom/android/server/am/ColdStartInjector;
...
.method private makeAdjString()Ljava/lang/String;
    ...
    iget-object v1, p0, mMdmRecord:Ljava/util/ArrayList;
...
.method private makePositionCountString()Ljava/lang/String;
    ...
    iget-object v4, p0, mTaskPositionCount:Ljava/util/ArrayList;
...
.method private static resolveConfig(Lorg/json/JSONArray;)V
    ...
    sput-wide v4, sReportInterval:J
...
.method public addDiedRecord(Lcom/android/server/am/ProcessRecord;)V
    ...
    iget-object v0, p0, mCrashKillProcess:Ljava/lang/String;
    ...
    iget-object v0, p0, mDiedProcessMap:Ljava/util/HashMap;
    ...
    iget-object v1, p0, mCrashKillProcess:Ljava/lang/String;
...
.method public addHistoryTask(Landroid/content/ComponentName;)V
    ...
    iget-object v3, p0, mHistoryTasks:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, mHistoryTasks:Ljava/util/ArrayList;
    ...
    sget-boolean v5, DEBUG_COLDSTART:Z
    ...
    iget-object v5, p0, mHistoryTasks:Ljava/util/ArrayList;
    ...
    :cond_3
    sget-boolean v4, DEBUG_COLDSTART:Z
    ...
    invoke-virtual {p0}, dumpHistoryTask()Ljava/lang/String;
...
.method public checkColdStart(Ljava/lang/String;)V
    ...
    :cond_0
    invoke-direct {p0, p1}, getHistoryTaskPosition(Ljava/lang/String;)I

    move-result v0

    invoke-direct {p0, v0}, addPositionCount(I)V

    iget-object v1, p0, mDiedProcessMap:Ljava/util/HashMap;
    ...
    :cond_1
    iget-object v2, p0, mDiedProcessMap:Ljava/util/HashMap;

    invoke-virtual {v2, p1}, Ljava/util/HashMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    sget-boolean v2, sEnableMdm:Z
    ...
    :cond_3
    :goto_0
    invoke-direct {p0, v1}, addMdmData(I)V

    :cond_4
    invoke-direct {p0}, checkNeedSubmit()V
...
.method public dumpHistoryTask()Ljava/lang/String;
    ...
    iget-object v1, p0, mHistoryTasks:Ljava/util/ArrayList;
...
.method public setCrashKillProc(Ljava/lang/String;)V
    ...
    :cond_0
    iput-object p1, p0, mCrashKillProcess:Ljava/lang/String;
