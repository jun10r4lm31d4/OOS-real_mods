...
.method static constructor <clinit>()V
    ...
    sput v0, mNumRecentTasks:I

    const/4 v1, 0x2

    sput v1, mNumHighUsed:I

    const/16 v1, 0x320

    sput v1, mStartOptAdj:I

    const/4 v1, 0x1

    sput v1, sStartIndex:I
    ...
    sput-boolean v3, sDebugOptAdj:Z
    ...
    sput-boolean v3, sEnableOptAdj:Z
    ...
    sput-boolean v3, sEnableTuneFgService:Z
    ...
    sput-object v3, sFgServiceBlackList:Ljava/util/ArrayList;

    new-instance v3, Ljava/util/ArrayList;

    invoke-direct {v3}, Ljava/util/ArrayList;-><init>()V

    sput-object v3, sPersistBlackList:Ljava/util/ArrayList;
    ...
    sput-object v3, sBServiceLimitWhiteList:Ljava/util/ArrayList;

    sget-boolean v3, Landroid/os/Build;->DEBUG_ONEPLUS:Z

    sput-boolean v3, DEBUG_ONEPLUS:Z
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mOomAdjusterConfigObserver:Lcom/oneplus/config/ConfigObserver;

    iget-object v0, p0, mOomAdjusterConfigObserver:Lcom/oneplus/config/ConfigObserver;
    ...
    iput-object v0, p0, mConfigHandler:Landroid/os/Handler;
...
.method public static adjustProcessAdj(Ljava/lang/String;I)I
    ...
    sget-boolean v1, PROCESS_ADJ_CONTROL_ENABLED:Z

    if-eqz v1, :cond_2

    sget-object v1, opProcessAdjControl:Lcom/android/server/am/IOpProcessAdjControl;
    ...
    sput-object v1, opProcessAdjControl:Lcom/android/server/am/IOpProcessAdjControl;
...
.method public static getBServiceLimitWhiteList()Ljava/util/ArrayList;
    ...
    sget-object v0, sBServiceLimitWhiteList:Ljava/util/ArrayList;
...
.method public static getInstance(Landroid/content/Context;)Lcom/android/server/am/OomAdjusterInjector;
    ...
    invoke-static {p0}, initOomAdjusterInjector(Landroid/content/Context;)V

    sget-object v0, sOomAdjusterInjector:Lcom/android/server/am/OomAdjusterInjector;
...
.method public static initOomAdjusterInjector(Landroid/content/Context;)V
    ...
    sput-object v0, sOomAdjusterInjector:Lcom/android/server/am/OomAdjusterInjector;
...
.method public static resolveConfig(Lorg/json/JSONArray;)V
    ...
    sget-boolean v7, sEnableOptAdj:Z
    ...
    sput-boolean v5, sEnableOptAdj:Z
    ...
    sget-object v5, sFgServiceBlackList:Ljava/util/ArrayList;
    ...
    sget-object v8, sFgServiceBlackList:Ljava/util/ArrayList;
    ...
    sget-object v5, sBServiceLimitWhiteList:Ljava/util/ArrayList;
    ...
    :try_start_2
    sget-object v6, sBServiceLimitWhiteList:Ljava/util/ArrayList;
    ...
    sget-object v9, sBServiceLimitWhiteList:Ljava/util/ArrayList;
    ...
    sput-boolean v5, sEnableTuneFgService:Z
    ...
    sget-boolean v7, sEnableTuneFgService:Z
    ...
    sget-object v5, sPersistBlackList:Ljava/util/ArrayList;
    ...
    sget-object v8, sPersistBlackList:Ljava/util/ArrayList;
...
.method private static setHighUsedAdj(Lcom/android/server/am/ProcessRecord;)V
    ...
    sget-object v6, sRecentTasks:Ljava/util/List;
    ...
    sget-object v9, sRecentTasks:Ljava/util/List;
    ...
    sget-object v10, sRecentTasks:Ljava/util/List;
    ...
    sget-object v12, sRecentTasks:Ljava/util/List;
    ...
    :cond_4
    :goto_3
    sget-boolean v3, sDebugOptAdj:Z
    ...
    sget v0, mStartOptAdj:I

    sget v3, mNumRecentTasks:I
    ...
    sget-boolean v0, sDebugOptAdj:Z
...
.method public static setOptimizationAdj(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/ActivityManagerService;)V
    ...
    sput-object v1, sRecentTasks:Ljava/util/List;

    sget-object v1, sRecentTasks:Ljava/util/List;
    ...
    :cond_0
    sget-boolean v1, sDebugOptAdj:Z
    ...
    invoke-static {p0, p1}, setRecentTaskAdj(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/ActivityManagerService;)Z
    ...
    invoke-static {p0}, setHighUsedAdj(Lcom/android/server/am/ProcessRecord;)V

    goto :goto_0

    :cond_3
    invoke-static {p0}, setSecondTask(Lcom/android/server/am/ProcessRecord;)V
...
.method private static setRecentTaskAdj(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/ActivityManagerService;)Z
    ...
    sget-object v0, sRecentTasks:Ljava/util/List;
    ...
    sget v2, sStartIndex:I

    if-le v0, v2, :cond_6

    sget v0, mNumRecentTasks:I
    ...
    :cond_0
    sget v0, sStartIndex:I

    sget v2, mNumRecentTasks:I
    ...
    sget-object v2, sRecentTasks:Ljava/util/List;
    ...
    sget v1, mStartOptAdj:I

    sget v5, sStartIndex:I
...
.method public static setTunedAdj(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/ProcessRecord;)V
    ...
    sget-boolean v0, sEnableTuneFgService:Z
    ...
    sget-object v1, sFgServiceBlackList:Ljava/util/ArrayList;
    ...
    :cond_1
    sget-object v1, sPersistBlackList:Ljava/util/ArrayList;
...
.method public forceUpdateOnlineConfig()V
    ...
    invoke-static {v1}, resolveConfig(Lorg/json/JSONArray;)V
