...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/ProcessList;Lcom/android/server/am/ActiveUids;)V
    ...
    iput-object v0, p0, mTmpLong:[J

    const/4 v0, 0x0

    iput v0, p0, mAdjSeq:I

    iput v0, p0, mNumServiceProcs:I

    iput v0, p0, mNewNumAServiceProcs:I

    iput v0, p0, mNewNumServiceProcs:I
    ...
    iput-object v1, p0, mTmpBroadcastQueue:Landroid/util/ArraySet;

    const/16 v1, 0x1388

    iput v1, p0, mMinBServiceAgingTime:I

    const/4 v1, 0x5

    iput v1, p0, mBServiceAppThreshold:I

    iput-boolean v0, p0, mEnableBServicePropagation:Z

    iput v0, p0, mLastTopUid:I
    ...
    iput-object v2, p0, mTmpComputeOomAdjWindowCallback:Lcom/android/server/am/OomAdjuster$ComputeOomAdjWindowCallback;
    ...
    iput-object p3, p0, mActiveUids:Lcom/android/server/am/ActiveUids;
    ...
    iput-object v2, p0, mLocalPowerManager:Landroid/os/PowerManagerInternal;

    iget-object v2, p0, mService:Lcom/android/server/am/ActivityManagerService;

    iget-object v2, v2, Lcom/android/server/am/ActivityManagerService;->mConstants:Lcom/android/server/am/ActivityManagerConstants;

    iput-object v2, p0, mConstants:Lcom/android/server/am/ActivityManagerConstants;
    ...
    iput-object v2, p0, mAppCompact:Lcom/android/server/am/AppCompactor;

    sget-object v2, mPerf:Landroid/util/BoostFramework;
    ...
    iput v2, p0, mMinBServiceAgingTime:I
    ...
    iput v2, p0, mBServiceAppThreshold:I
    ...
    iput-boolean v2, p0, mEnableBServicePropagation:Z

    :cond_0
    iget v2, p0, mBServiceAppThreshold:I
    ...
    iget v9, p0, mBServiceAppThreshold:I
    ...
    iput-object v1, p0, mProcessGroupHandler:Landroid/os/Handler;
...
.method private final applyOomAdjLocked(Lcom/android/server/am/ProcessRecord;ZJJ)Z
    ...
    iget-object v0, v1, mAppCompact:Lcom/android/server/am/AppCompactor;
    ...
    iget-object v5, v1, mService:Lcom/android/server/am/ActivityManagerService;
    ...
    invoke-virtual {v1, v7, v0}, reportOomAdjMessageLocked(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, v1, mProcessGroupHandler:Landroid/os/Handler;
    ...
    invoke-virtual {v1, v13, v0}, reportOomAdjMessageLocked(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_2f
    invoke-direct {v1, v2, v11, v12}, maybeUpdateUsageStatsLocked(Lcom/android/server/am/ProcessRecord;J)V

    invoke-direct {v1, v2, v9, v10}, maybeUpdateLastTopTime(Lcom/android/server/am/ProcessRecord;J)V
    ...
    iget-object v0, v1, mConstants:Lcom/android/server/am/ActivityManagerConstants;
...
.method private final computeOomAdjLocked(Lcom/android/server/am/ProcessRecord;ILcom/android/server/am/ProcessRecord;ZJZ)Z
    ...
    iget-object v9, v8, mService:Lcom/android/server/am/ActivityManagerService;
    ...
    iget-object v6, v8, mService:Lcom/android/server/am/ActivityManagerService;
    ...
    iget-object v6, v8, mTmpBroadcastQueue:Landroid/util/ArraySet;
    ...
    invoke-virtual {v8, v12, v2}, reportOomAdjMessageLocked(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_15
    iget-object v2, v8, mService:Lcom/android/server/am/ActivityManagerService;
    ...
    iget-object v10, v8, mService:Lcom/android/server/am/ActivityManagerService;
    ...
    invoke-virtual {v8, v12, v10}, reportOomAdjMessageLocked(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v10, v8, mTmpComputeOomAdjWindowCallback:Lcom/android/server/am/OomAdjuster$ComputeOomAdjWindowCallback;
    ...
    iget-object v11, v8, mTmpComputeOomAdjWindowCallback:Lcom/android/server/am/OomAdjuster$ComputeOomAdjWindowCallback;
    ...
    invoke-virtual {v8, v4, v2}, reportOomAdjMessageLocked(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v15, v8, mConstants:Lcom/android/server/am/ActivityManagerConstants;
    ...
    invoke-virtual {v8, v4, v10}, reportOomAdjMessageLocked(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v8, v4, v5}, reportOomAdjMessageLocked(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v1, v8, mConstants:Lcom/android/server/am/ActivityManagerConstants;
    ...
    invoke-direct/range {v0 .. v7}, computeOomAdjLocked(Lcom/android/server/am/ProcessRecord;ILcom/android/server/am/ProcessRecord;ZJZ)Z
    ...
    invoke-direct/range {v0 .. v5}, shouldSkipDueToCycle(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/ProcessRecord;IIZ)Z
    ...
    iget-object v7, v8, mConstants:Lcom/android/server/am/ActivityManagerConstants;
    ...
    invoke-virtual {v8, v7, v5}, reportOomAdjMessageLocked(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v8, v11, v0}, reportOomAdjMessageLocked(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v8, v11, v1}, reportOomAdjMessageLocked(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v3, v8, mConstants:Lcom/android/server/am/ActivityManagerConstants;
    ...
    iget v0, v8, mNewNumAServiceProcs:I

    iget v1, v8, mNumServiceProcs:I
    ...
    iget v0, v8, mNewNumServiceProcs:I

    const/4 v1, 0x1

    add-int/2addr v0, v1

    iput v0, v8, mNewNumServiceProcs:I

    iget-boolean v0, v10, Lcom/android/server/am/ProcessRecord;->serviceb:Z

    if-nez v0, :cond_b0

    iget-object v0, v8, mService:Lcom/android/server/am/ActivityManagerService;
    ...
    iget-object v3, v8, mProcessList:Lcom/android/server/am/ProcessList;
    ...
    :goto_46
    iget v1, v8, mNewNumAServiceProcs:I

    add-int/2addr v1, v0

    iput v1, v8, mNewNumAServiceProcs:I
    ...
    iget v3, v8, mLastTopUid:I

    iget v7, v1, Lcom/android/server/am/ProcessRecord;->uid:I

    if-eq v3, v7, :cond_b4

    invoke-direct {v8, v1}, updataKernelTopUid(Lcom/android/server/am/ProcessRecord;)V

    iget v3, v1, Lcom/android/server/am/ProcessRecord;->uid:I

    iput v3, v8, mLastTopUid:I
    ...
    iget-object v7, v8, mService:Lcom/android/server/am/ActivityManagerService;
...
.method private maybeUpdateUsageStatsLocked(Lcom/android/server/am/ProcessRecord;J)V
    ...
    iget-object v6, p0, mConstants:Lcom/android/server/am/ActivityManagerConstants;
    ...
    iget-object v1, p0, mConstants:Lcom/android/server/am/ActivityManagerConstants;
...
.method private final updateOomAdjLocked(Lcom/android/server/am/ProcessRecord;ILcom/android/server/am/ProcessRecord;ZJ)Z
    ...
    invoke-direct/range {v1 .. v8}, computeOomAdjLocked(Lcom/android/server/am/ProcessRecord;ILcom/android/server/am/ProcessRecord;ZJZ)Z
    ...
    invoke-direct/range {v0 .. v6}, applyOomAdjLocked(Lcom/android/server/am/ProcessRecord;ZJJ)Z
...
.method dumpAppCompactorSettings(Ljava/io/PrintWriter;)V
    ...
    iget-object v0, p0, mAppCompact:Lcom/android/server/am/AppCompactor;
...
.method dumpProcCountsLocked(Ljava/io/PrintWriter;)V
    ...
    iget v1, p0, mNumNonCachedProcs:I
    ...
    iget-object v1, p0, mProcessList:Lcom/android/server/am/ProcessList;
    ...
    iget v1, p0, mNumCachedHiddenProcs:I
    ...
    iget v1, p0, mNewNumServiceProcs:I
...
.method dumpProcessListVariablesLocked(Landroid/util/proto/ProtoOutputStream;)V
    ...
    iget v0, p0, mAdjSeq:I

    const-wide v1, 0x10500000031L

    invoke-virtual {p1, v1, v2, v0}, Landroid/util/proto/ProtoOutputStream;->write(JI)V

    iget-object v0, p0, mProcessList:Lcom/android/server/am/ProcessList;
    ...
    iget v0, p0, mNumServiceProcs:I

    const-wide v1, 0x10500000035L

    invoke-virtual {p1, v1, v2, v0}, Landroid/util/proto/ProtoOutputStream;->write(JI)V

    iget v0, p0, mNewNumServiceProcs:I
...
.method idleUidsLocked()V
    ...
    iget-object v3, p0, mConstants:Lcom/android/server/am/ActivityManagerConstants;
    ...
    iget-object v7, p0, mLocalPowerManager:Landroid/os/PowerManagerInternal;
    ...
    iget-object v10, p0, mActiveUids:Lcom/android/server/am/ActiveUids;
    ...
    iget-object v9, p0, mConstants:Lcom/android/server/am/ActivityManagerConstants;
...
.method maybeUpdateUsageStats(Lcom/android/server/am/ProcessRecord;J)V
    ...
    invoke-direct {p0, p1, p2, p3}, maybeUpdateUsageStatsLocked(Lcom/android/server/am/ProcessRecord;J)V
...
.method final setAppIdTempWhitelistStateLocked(IZ)V
    ...
    invoke-virtual {p0, v1}, updateOomAdjLocked(Ljava/lang/String;)V
...
.method final setUidTempWhitelistStateLocked(IZ)V
    ...
    invoke-virtual {p0, v2}, updateOomAdjLocked(Ljava/lang/String;)V
...
.method updateOomAdjLocked(Ljava/lang/String;)V
    ...
    iget-object v0, v8, mProcessList:Lcom/android/server/am/ProcessList;

    invoke-virtual {v0}, Lcom/android/server/am/ProcessList;->getLruSizeLocked()I

    move-result v7

    iget-object v0, v8, mActiveUids:Lcom/android/server/am/ActiveUids;
    ...
    iget-object v1, v8, mActiveUids:Lcom/android/server/am/ActiveUids;
    ...
    iput v0, v8, mAdjSeq:I

    const/4 v3, 0x0

    iput v3, v8, mNewNumServiceProcs:I

    iput v3, v8, mNewNumAServiceProcs:I

    invoke-static {}, Lcom/android/server/am/OpBGFrozenInjector;->clearImportantUids()V

    iget-object v0, v8, mConstants:Lcom/android/server/am/ActivityManagerConstants;
    ...
    iget v0, v8, mNumNonCachedProcs:I

    sub-int v0, v7, v0

    iget v9, v8, mNumCachedHiddenProcs:I
    ...
    :cond_3
    iget v15, v8, mNumCachedHiddenProcs:I
    ...
    iput v3, v8, mNumNonCachedProcs:I

    iput v3, v8, mNumCachedHiddenProcs:I
    ...
    iget-object v2, v8, mProcessList:Lcom/android/server/am/ProcessList;
    ...
    iget-boolean v5, v8, mEnableBServicePropagation:Z
    ...
    iget v10, v8, mMinBServiceAgingTime:I
    ...
    iget-object v1, v8, mProcessList:Lcom/android/server/am/ProcessList;
    ...
    iput v0, v8, mNumNonCachedProcs:I
    ...
    iget v4, v8, mNumCachedHiddenProcs:I

    add-int/2addr v4, v3

    iput v4, v8, mNumCachedHiddenProcs:I
    ...
    iget v0, v8, mBServiceAppThreshold:I
    ...
    iget v3, v8, mBServiceAppThreshold:I
    ...
    iget-object v3, v8, mService:Lcom/android/server/am/ActivityManagerService;
    ...
    :cond_3e
    :goto_22
    iget-object v1, v8, mService:Lcom/android/server/am/ActivityManagerService;

    invoke-virtual {v1}, Lcom/android/server/am/ActivityManagerService;->incrementProcStateSeqAndNotifyAppsLocked()V

    iget v1, v8, mNewNumServiceProcs:I

    iput v1, v8, mNumServiceProcs:I
    ...
    iget-object v5, v8, mLocalPowerManager:Landroid/os/PowerManagerInternal;
    ...
    :cond_41
    iget-object v5, v8, mActiveUids:Lcom/android/server/am/ActiveUids;
    ...
    iget-object v10, v8, mActiveUids:Lcom/android/server/am/ActiveUids;
    ...
    iget-object v2, v8, mConstants:Lcom/android/server/am/ActivityManagerConstants;
    ...
    iget-object v0, v8, mLocalPowerManager:Landroid/os/PowerManagerInternal;
...
.method updateOomAdjLocked(Lcom/android/server/am/ProcessRecord;ZLjava/lang/String;)Z
    ...
    invoke-direct/range {v1 .. v7}, updateOomAdjLocked(Lcom/android/server/am/ProcessRecord;ILcom/android/server/am/ProcessRecord;ZJ)Z
    ...
    :cond_2
    invoke-virtual {p0, p3}, updateOomAdjLocked(Ljava/lang/String;)V
