...
.method private dumpProvider(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;Lcom/android/server/am/ContentProviderRecord;[Ljava/lang/String;Z)V
    ...
    invoke-direct/range {v3 .. v8}, dumpToTransferPipe(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;Lcom/android/server/am/ContentProviderRecord;[Ljava/lang/String;)V
    ...
    invoke-direct/range {v2 .. v7}, dumpToTransferPipe(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;Lcom/android/server/am/ContentProviderRecord;[Ljava/lang/String;)V
...
.method private getProvidersForName(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    iget-object v4, p0, mSingletonByClass:Ljava/util/HashMap;
    ...
    :goto_0
    iget-object v5, p0, mProvidersByClassPerUser:Landroid/util/SparseArray;
...
.method collectPackageProvidersLocked(Ljava/lang/String;Ljava/util/Set;ZZILjava/util/ArrayList;)Z
    ...
    :cond_0
    iget-object v5, v7, mSingletonByClass:Ljava/util/HashMap;
    ...
    :goto_0
    iget-object v0, v7, mProvidersByClassPerUser:Landroid/util/SparseArray;
    ...
    invoke-virtual {p0, v8}, getProvidersByClass(I)Ljava/util/HashMap;
...
.method protected dumpProvider(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;Ljava/lang/String;[Ljava/lang/String;IZ)Z
    ...
    invoke-direct {p0, p3}, getProvidersForName(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-direct/range {v0 .. v6}, dumpProvider(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;Lcom/android/server/am/ContentProviderRecord;[Ljava/lang/String;Z)V
...
.method dumpProvidersLocked(Ljava/io/PrintWriter;ZLjava/lang/String;)Z
    ...
    invoke-direct/range {v1 .. v7}, dumpProvidersByClassLocked(Ljava/io/PrintWriter;ZLjava/lang/String;Ljava/lang/String;ZLjava/util/HashMap;)Z
    ...
    iget-object v6, p0, mSingletonByName:Ljava/util/HashMap;
    ...
    invoke-direct/range {v1 .. v6}, dumpProvidersByNameLocked(Ljava/io/PrintWriter;Ljava/lang/String;Ljava/lang/String;ZLjava/util/HashMap;)Z
    ...
    iget-object v3, p0, mProvidersByNamePerUser:Landroid/util/SparseArray;
    ...
    invoke-direct/range {v2 .. v7}, dumpProvidersByNameLocked(Ljava/io/PrintWriter;Ljava/lang/String;Ljava/lang/String;ZLjava/util/HashMap;)Z
...
.method getProviderByName(Ljava/lang/String;I)Lcom/android/server/am/ContentProviderRecord;
    ...
    iget-object v0, p0, mSingletonByName:Ljava/util/HashMap;
