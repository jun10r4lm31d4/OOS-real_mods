...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, DEBUG_DELAYED_SERVICE:Z

    sget-boolean v0, DEBUG_DELAYED_SERVICE:Z

    sput-boolean v0, DEBUG_DELAYED_STARTS:Z

    const/4 v0, 0x0

    sput-boolean v0, LOG_SERVICE_START_STOP:Z

    new-instance v1, Landroid/util/BoostFramework;

    invoke-direct {v1}, Landroid/util/BoostFramework;-><init>()V

    sput-object v1, mPerf:Landroid/util/BoostFramework;
    ...
    sput-object v1, servicesCanRestartAnonList:Ljava/util/ArrayList;

    sput-boolean v0, isSupport:Z
...
.method public constructor <init>(Lcom/android/server/am/ActivityManagerService;)V
    ...
    iput-object v0, p0, mServiceMap:Landroid/util/SparseArray;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, mServiceConnections:Landroid/util/ArrayMap;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mPendingServices:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mRestartingServices:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mDestroyingServices:Ljava/util/ArrayList;

    const/4 v0, 0x0

    iput-object v0, p0, mTmpCollectionResults:Ljava/util/ArrayList;
...
.method static synthetic access$000(Lcom/android/server/am/ActiveServices;I)Lcom/android/server/am/ActiveServices$ServiceMap;
    ...
    invoke-direct {p0, p1}, getServiceMapLocked(I)Lcom/android/server/am/ActiveServices$ServiceMap;
...
.method static synthetic access$100(Lcom/android/server/am/ActiveServices;Lcom/android/server/am/ServiceRecord;ILandroid/app/Notification;II)V
    ...
    invoke-direct/range {p0 .. p5}, setServiceForegroundInnerLocked(Lcom/android/server/am/ServiceRecord;ILandroid/app/Notification;II)V
...
.method static synthetic access$200()Z
    ...
    sget-boolean v0, DEBUG_DELAYED_STARTS:Z
...
.method static synthetic access$400(Lcom/android/server/am/ActiveServices;Lcom/android/server/am/ServiceRecord;IZZZ)Ljava/lang/String;
    ...
    invoke-direct/range {p0 .. p5}, bringUpServiceLocked(Lcom/android/server/am/ServiceRecord;IZZZ)Ljava/lang/String;
...
.method private final bringDownServiceIfNeededLocked(Lcom/android/server/am/ServiceRecord;ZZ)V
    ...
    invoke-direct {p0, p1, p2, p3}, isServiceNeededLocked(Lcom/android/server/am/ServiceRecord;ZZ)Z
...
.method private final bringDownServiceLocked(Lcom/android/server/am/ServiceRecord;)V
    ...
    :try_start_0
    invoke-direct {p0}, getServicetrackerInstance()Z

    move-result v4

    if-eqz v4, :cond_1

    iget-object v4, p0, mServicetracker:Lvendor/qti/hardware/servicetracker/V1_0/IServicetracker;
    ...
    iput-object v1, p0, mServicetracker:Lvendor/qti/hardware/servicetracker/V1_0/IServicetracker;
    ...
    invoke-direct {p0, p1, v3, v9}, bumpServiceExecutingLocked(Lcom/android/server/am/ServiceRecord;ZLjava/lang/String;)V
    ...
    iget-object v9, p0, mAm:Lcom/android/server/am/ActivityManagerService;
    ...
    sget-boolean v5, LOG_SERVICE_START_STOP:Z
    ...
    invoke-direct {p0, v2}, getServiceMapLocked(I)Lcom/android/server/am/ActiveServices$ServiceMap;
    ...
    invoke-direct {p0, p1, v3, v6}, unscheduleServiceRestartLocked(Lcom/android/server/am/ServiceRecord;IZ)Z

    iget-object v8, p0, mPendingServices:Ljava/util/ArrayList;
    ...
    iget-object v9, p0, mPendingServices:Ljava/util/ArrayList;
    ...
    :cond_10
    invoke-direct {p0, p1}, cancelForegroundNotificationLocked(Lcom/android/server/am/ServiceRecord;)V

    iget-boolean v8, p1, Lcom/android/server/am/ServiceRecord;->isForeground:Z

    if-eqz v8, :cond_12

    invoke-direct {p0, v2, p1}, decActiveForegroundAppLocked(Lcom/android/server/am/ActiveServices$ServiceMap;Lcom/android/server/am/ServiceRecord;)V
    ...
    invoke-direct {p0, v7}, updateWhitelistManagerLocked(Lcom/android/server/am/ProcessRecord;)V
    ...
    invoke-direct {p0, v7, v3}, updateServiceForegroundLocked(Lcom/android/server/am/ProcessRecord;Z)V

    :try_start_4
    const-string v7, "destroy"

    invoke-direct {p0, p1, v3, v7}, bumpServiceExecutingLocked(Lcom/android/server/am/ServiceRecord;ZLjava/lang/String;)V
...
.method private bringUpServiceLocked(Lcom/android/server/am/ServiceRecord;IZZZ)Ljava/lang/String;
    ...
    invoke-direct {v1, v2, v3, v5}, sendServiceArgsLocked(Lcom/android/server/am/ServiceRecord;ZZ)V
    ...
    iget-object v0, v1, mRestartingServices:Ljava/util/ArrayList;
    ...
    invoke-direct {v1, v0}, getServiceMapLocked(I)Lcom/android/server/am/ActiveServices$ServiceMap;
    ...
    iget-object v14, v1, mAm:Lcom/android/server/am/ActivityManagerService;
    ...
    invoke-direct {v1, v2, v11, v3}, realStartServiceLocked(Lcom/android/server/am/ServiceRecord;Lcom/android/server/am/ProcessRecord;Z)V
    :try_end_1
    ...
    iget-object v10, v1, mAm:Lcom/android/server/am/ActivityManagerService;
    ...
    :cond_12
    iget-object v7, v1, mAm:Lcom/android/server/am/ActivityManagerService;
    ...
    :cond_13
    iget-object v7, v1, mPendingServices:Ljava/util/ArrayList;
    ...
    sget-boolean v5, DEBUG_DELAYED_STARTS:Z
...
.method private cancelForegroundNotificationLocked(Lcom/android/server/am/ServiceRecord;)V
    ...
    invoke-direct {p0, v0}, getServiceMapLocked(I)Lcom/android/server/am/ActiveServices$ServiceMap;
...
.method private collectPackageServicesLocked(Ljava/lang/String;Ljava/util/Set;ZZLandroid/util/ArrayMap;)Z
    ...
    invoke-direct {p0, v5}, updateWhitelistManagerLocked(Lcom/android/server/am/ProcessRecord;)V
...
.method private decActiveForegroundAppLocked(Lcom/android/server/am/ActiveServices$ServiceMap;Lcom/android/server/am/ServiceRecord;)V
    ...
    invoke-virtual {p0, v0, v3, v4}, foregroundAppShownEnoughLocked(Lcom/android/server/am/ActiveServices$ActiveForegroundApp;J)Z
    ...
    invoke-direct {p0, p1, v1, v2}, requestUpdateActiveForegroundAppsLocked(Lcom/android/server/am/ActiveServices$ServiceMap;J)V
...
.method static dynamicallyUpdateLogTag(Z)V
    ...
    sput-boolean p0, DEBUG_DELAYED_SERVICE:Z

    sput-boolean p0, DEBUG_DELAYED_STARTS:Z

    sput-boolean p0, LOG_SERVICE_START_STOP:Z
...
.method private final findServiceLocked(Landroid/content/ComponentName;Landroid/os/IBinder;I)Lcom/android/server/am/ServiceRecord;
    ...
    invoke-virtual {p0, p1, p3}, getServiceByNameLocked(Landroid/content/ComponentName;I)Lcom/android/server/am/ServiceRecord;
...
.method private getServicetrackerInstance()Z
    ...
    iget-object v1, p0, mServicetracker:Lvendor/qti/hardware/servicetracker/V1_0/IServicetracker;
    ...
    iput-object v2, p0, mServicetracker:Lvendor/qti/hardware/servicetracker/V1_0/IServicetracker;
    :try_end_0
    ...
    iget-object v2, p0, mServicetracker:Lvendor/qti/hardware/servicetracker/V1_0/IServicetracker;
...
.method private final realStartServiceLocked(Lcom/android/server/am/ServiceRecord;Lcom/android/server/am/ProcessRecord;Z)V
    ...
    invoke-direct {v1, v9, v11, v0}, bumpServiceExecutingLocked(Lcom/android/server/am/ServiceRecord;ZLjava/lang/String;)V
    ...
    invoke-direct {v1, v0, v13}, updateServiceForegroundLocked(Lcom/android/server/am/ProcessRecord;Z)V
    ...
    :try_start_0
    sget-boolean v0, LOG_SERVICE_START_STOP:Z
    ...
    iget-object v5, v1, mAm:Lcom/android/server/am/ActivityManagerService;
    ...
    :try_start_4
    invoke-direct/range {p0 .. p0}, getServicetrackerInstance()Z

    move-result v0

    if-eqz v0, :cond_4

    iget-object v0, v1, mServicetracker:Lvendor/qti/hardware/servicetracker/V1_0/IServicetracker;
    ...
    iput-object v2, v1, mServicetracker:Lvendor/qti/hardware/servicetracker/V1_0/IServicetracker;
    :try_end_5
    ...
    iget-object v0, v1, mDestroyingServices:Ljava/util/ArrayList;

    invoke-virtual {v0, v9}, Ljava/util/ArrayList;->contains(Ljava/lang/Object;)Z

    move-result v0

    invoke-direct {v1, v9, v0, v0}, serviceDoneExecutingLocked(Lcom/android/server/am/ServiceRecord;ZZ)V
    ...
    sget-boolean v3, DEBUG_DELAYED_SERVICE:Z
    ...
    invoke-direct {v1, v9, v13}, scheduleServiceRestartLocked(Lcom/android/server/am/ServiceRecord;Z)Z
    ...
    :cond_7
    invoke-direct {v1, v9, v11}, requestServiceBindingsLocked(Lcom/android/server/am/ServiceRecord;Z)V

    invoke-direct {v1, v10, v2, v14}, updateServiceClientActivitiesLocked(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/ConnectionRecord;Z)Z
    ...
    :cond_9
    invoke-direct {v1, v9, v11, v14}, sendServiceArgsLocked(Lcom/android/server/am/ServiceRecord;ZZ)V
    ...
    iget-object v4, v1, mDestroyingServices:Ljava/util/ArrayList;

    invoke-virtual {v4, v9}, Ljava/util/ArrayList;->contains(Ljava/lang/Object;)Z

    move-result v4

    invoke-direct {v1, v9, v4, v4}, serviceDoneExecutingLocked(Lcom/android/server/am/ServiceRecord;ZZ)V
    ...
    sget-boolean v2, SERVICE_RESCHEDULE:Z

    if-eqz v2, :cond_e

    sget-boolean v2, DEBUG_DELAYED_SERVICE:Z
    ...
    invoke-direct {v1, v9, v2}, scheduleServiceRestartLocked(Lcom/android/server/am/ServiceRecord;Z)Z
...
.method private final requestServiceBindingLocked(Lcom/android/server/am/ServiceRecord;Lcom/android/server/am/IntentBindRecord;ZZ)Z
    ...
    invoke-direct {p0, p1, p3, v1}, bumpServiceExecutingLocked(Lcom/android/server/am/ServiceRecord;ZLjava/lang/String;)V
...
.method private requestStartTargetPermissionsReviewIfNeededLocked(Lcom/android/server/am/ServiceRecord;Ljava/lang/String;ILandroid/content/Intent;ZI)Z
    ...
    iget-object v10, v0, mAm:Lcom/android/server/am/ActivityManagerService;
...
.method private retrieveServiceLocked(Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IIIZZZZ)Lcom/android/server/am/ActiveServices$ServiceLookupResult;
    ...
    :goto_0
    iget-object v2, v1, mAm:Lcom/android/server/am/ActivityManagerService;
    ...
    invoke-direct {v1, v11}, getServiceMapLocked(I)Lcom/android/server/am/ActiveServices$ServiceMap;
    ...
    invoke-direct {v1, v2}, getServiceMapLocked(I)Lcom/android/server/am/ActiveServices$ServiceMap;
    ...
    iget-object v9, v1, mAm:Lcom/android/server/am/ActivityManagerService;
    ...
    iget-object v0, v1, mPendingServices:Ljava/util/ArrayList;
    ...
    iget-object v9, v1, mPendingServices:Ljava/util/ArrayList;
    ...
    :goto_a
    iget-object v2, v1, mPendingServices:Ljava/util/ArrayList;
...
.method private final scheduleServiceRestartLocked(Lcom/android/server/am/ServiceRecord;Z)Z
    ...
    invoke-direct {v0, v4}, getServiceMapLocked(I)Lcom/android/server/am/ActiveServices$ServiceMap;
    ...
    sget-boolean v13, DEBUG_DELAYED_SERVICE:Z
    ...
    sget-boolean v24, SERVICE_RESCHEDULE:Z

    if-eqz v24, :cond_7

    sget-boolean v24, DEBUG_DELAYED_SERVICE:Z
    ...
    sget-boolean v9, DEBUG_DELAYED_SERVICE:Z
    ...
    :cond_c
    sget-boolean v5, SERVICE_RESCHEDULE:Z
    ...
    sget-boolean v5, DEBUG_DELAYED_SERVICE:Z
    ...
    iget-object v15, v5, mAm:Lcom/android/server/am/ActivityManagerService;
    ...
    :cond_10
    sget-object v2, servicesCanRestartAnonList:Ljava/util/ArrayList;
    ...
    iget-object v14, v5, mAm:Lcom/android/server/am/ActivityManagerService;
    ...
    iget-object v15, v14, mAm:Lcom/android/server/am/ActivityManagerService;
    ...
    iget-object v15, v14, mRestartingServices:Ljava/util/ArrayList;
    ...
    iget-object v4, v14, mRestartingServices:Ljava/util/ArrayList;
    ...
    :goto_d
    iget-object v3, v14, mRestartingServices:Ljava/util/ArrayList;
    ...
    iget-object v2, v14, mRestartingServices:Ljava/util/ArrayList;
    ...
    :cond_1b
    invoke-direct/range {p0 .. p1}, cancelForegroundNotificationLocked(Lcom/android/server/am/ServiceRecord;)V
    ...
    iget-object v0, v14, mRestartingServices:Ljava/util/ArrayList;
...
.method private final sendServiceArgsLocked(Lcom/android/server/am/ServiceRecord;ZZ)V
    ...
    invoke-direct {p0, p1, p2, v6}, bumpServiceExecutingLocked(Lcom/android/server/am/ServiceRecord;ZLjava/lang/String;)V
    ...
    :cond_5
    invoke-virtual {p0, p1}, scheduleServiceForegroundTransitionTimeoutLocked(Lcom/android/server/am/ServiceRecord;)V
...
.method private serviceDoneExecutingLocked(Lcom/android/server/am/ServiceRecord;ZZ)V
    ...
    invoke-direct {p0, v0}, updateWhitelistManagerLocked(Lcom/android/server/am/ProcessRecord;)V
...
.method private setServiceForegroundInnerLocked(Lcom/android/server/am/ServiceRecord;ILandroid/app/Notification;II)V
    ...
    iget-object v12, v1, mAm:Lcom/android/server/am/ActivityManagerService;
    ...
    iget-object v13, v1, mAm:Lcom/android/server/am/ActivityManagerService;
    ...
    invoke-direct {v1, v14}, appIsTopLocked(I)Z
    ...
    invoke-direct {v1, v14, v15}, appRestrictedAnyInBackground(ILjava/lang/String;)Z
    ...
    invoke-direct {v1, v14, v8}, updateServiceForegroundLocked(Lcom/android/server/am/ProcessRecord;Z)V
    ...
    invoke-direct {v1, v6}, getServiceMapLocked(I)Lcom/android/server/am/ActiveServices$ServiceMap;
    ...
    iget-boolean v15, v1, mScreenOn:Z
    ...
    invoke-direct {v1, v6, v7, v8}, requestUpdateActiveForegroundAppsLocked(Lcom/android/server/am/ActiveServices$ServiceMap;J)V
    ...
    iget-object v8, v1, mAm:Lcom/android/server/am/ActivityManagerService;
    ...
    iget-object v6, v1, mAm:Lcom/android/server/am/ActivityManagerService;
    ...
    invoke-direct {v1, v5, v9}, updateServiceForegroundLocked(Lcom/android/server/am/ProcessRecord;Z)V

    :cond_15
    iget v5, v2, Lcom/android/server/am/ServiceRecord;->userId:I

    invoke-direct {v1, v5}, getServiceMapLocked(I)Lcom/android/server/am/ActiveServices$ServiceMap;
    ...
    invoke-direct {v1, v0, v2}, decActiveForegroundAppLocked(Lcom/android/server/am/ActiveServices$ServiceMap;Lcom/android/server/am/ServiceRecord;)V
    ...
    invoke-direct {v1, v6, v9}, updateServiceForegroundLocked(Lcom/android/server/am/ProcessRecord;Z)V
...
.method private stopServiceLocked(Lcom/android/server/am/ServiceRecord;)V
    ...
    invoke-direct {p0, p1, v0, v0}, bringDownServiceIfNeededLocked(Lcom/android/server/am/ServiceRecord;ZZ)V
...
.method attachApplicationLocked(Lcom/android/server/am/ProcessRecord;Ljava/lang/String;)Z
    ...
    iget-object v1, p0, mPendingServices:Ljava/util/ArrayList;
    ...
    :goto_0
    :try_start_0
    iget-object v4, p0, mPendingServices:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v1, p1, v4}, realStartServiceLocked(Lcom/android/server/am/ServiceRecord;Lcom/android/server/am/ProcessRecord;Z)V

    const/4 v0, 0x1

    invoke-direct {p0, v1, v2, v2}, isServiceNeededLocked(Lcom/android/server/am/ServiceRecord;ZZ)Z
...
.method bindServiceLocked(Landroid/app/IApplicationThread;Landroid/os/IBinder;Landroid/content/Intent;Ljava/lang/String;Landroid/app/IServiceConnection;ILjava/lang/String;Ljava/lang/String;I)I
    ...
    :cond_0
    iget-object v1, v13, mAm:Lcom/android/server/am/ActivityManagerService;
    ...
    iget-object v3, v13, mAm:Lcom/android/server/am/ActivityManagerService;
    ...
    iget-object v0, v13, mAm:Lcom/android/server/am/ActivityManagerService;
    ...
    invoke-direct/range {v1 .. v12}, retrieveServiceLocked(Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IIIZZZZ)Lcom/android/server/am/ActiveServices$ServiceLookupResult;
    ...
    :cond_16
    iget-object v2, v13, mAm:Lcom/android/server/am/ActivityManagerService;
    ...
    invoke-direct {v13, v7, v0, v8}, unscheduleServiceRestartLocked(Lcom/android/server/am/ServiceRecord;IZ)Z
    ...
    invoke-direct {v13, v0, v7, v1}, updateServiceClientActivitiesLocked(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/ConnectionRecord;Z)Z
    :try_end_c
    .catchall {:try_start_c .. :try_end_c} :catchall_1

    :cond_22
    :try_start_d
    iget-object v0, v13, mServiceConnections:Landroid/util/ArrayMap;
    ...
    iget-object v1, v13, mServiceConnections:Landroid/util/ArrayMap;
    ...
    iget-object v0, v13, mServicetracker:Lvendor/qti/hardware/servicetracker/V1_0/IServicetracker;
    ...
    iput-object v1, v13, mServicetracker:Lvendor/qti/hardware/servicetracker/V1_0/IServicetracker;
    :try_end_13
    ...
    invoke-direct/range {v1 .. v6}, bringUpServiceLocked(Lcom/android/server/am/ServiceRecord;IZZZ)Ljava/lang/String;
    ...
    :try_start_1c
    invoke-direct {v13, v10, v0, v1, v2}, requestServiceBindingLocked(Lcom/android/server/am/ServiceRecord;Lcom/android/server/am/IntentBindRecord;ZZ)Z
    ...
    invoke-direct {v13, v10, v0, v1, v15}, requestServiceBindingLocked(Lcom/android/server/am/ServiceRecord;Lcom/android/server/am/IntentBindRecord;ZZ)Z

    :cond_33
    :goto_13
    iget v0, v10, Lcom/android/server/am/ServiceRecord;->userId:I

    invoke-direct {v13, v0}, getServiceMapLocked(I)Lcom/android/server/am/ActiveServices$ServiceMap;
...
.method bringDownDisabledPackageServicesLocked(Ljava/lang/String;Ljava/util/Set;IZZ)Z
    ...
    iget-object v1, p0, mTmpCollectionResults:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, mServiceMap:Landroid/util/SparseArray;
    ...
    invoke-direct/range {v4 .. v9}, collectPackageServicesLocked(Ljava/lang/String;Ljava/util/Set;ZZLandroid/util/ArrayMap;)Z
    ...
    invoke-virtual {p0, p1, v3}, forceStopPackageLocked(Ljava/lang/String;I)V
    ...
    invoke-direct/range {v3 .. v8}, collectPackageServicesLocked(Ljava/lang/String;Ljava/util/Set;ZZLandroid/util/ArrayMap;)Z
    ...
    invoke-virtual {p0, p1, p3}, forceStopPackageLocked(Ljava/lang/String;I)V

    :cond_6
    :goto_1
    iget-object v2, p0, mTmpCollectionResults:Ljava/util/ArrayList;
...
.method cleanUpServices(ILandroid/content/ComponentName;Landroid/content/Intent;)V
    ...
    invoke-virtual/range {p0 .. p1}, getServicesLocked(I)Landroid/util/ArrayMap;
    ...
    invoke-direct {p0, v13}, stopServiceLocked(Lcom/android/server/am/ServiceRecord;)V
    ...
    :try_start_0
    invoke-direct {p0, v13, v4, v0}, sendServiceArgsLocked(Lcom/android/server/am/ServiceRecord;ZZ)V
    :try_end_0
...
.method protected dumpService(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;Ljava/lang/String;[Ljava/lang/String;IZ)Z
    ...
    iget-object v1, v8, mAm:Lcom/android/server/am/ActivityManagerService;
    ...
    iget-object v0, v8, mAm:Lcom/android/server/am/ActivityManagerService;
    ...
    iget-object v6, v8, mServiceMap:Landroid/util/SparseArray;
    ...
    invoke-direct/range {v1 .. v7}, dumpService(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;Lcom/android/server/am/ServiceRecord;[Ljava/lang/String;Z)V
...
.method forceStopPackageLocked(Ljava/lang/String;I)V
    ...
    invoke-direct {p0, v0, v1, v2}, requestUpdateActiveForegroundAppsLocked(Lcom/android/server/am/ActiveServices$ServiceMap;J)V
...
.method foregroundServiceProcStateChangedLocked(Lcom/android/server/am/UidRecord;)V
    ...
    invoke-direct {p0, v0, v2, v3}, requestUpdateActiveForegroundAppsLocked(Lcom/android/server/am/ActiveServices$ServiceMap;J)V
...
.method public getForegroundServiceTypeLocked(Landroid/content/ComponentName;Landroid/os/IBinder;)I
    ...
    :try_start_0
    invoke-direct {p0, p1, p2, v0}, findServiceLocked(Landroid/content/ComponentName;Landroid/os/IBinder;I)Lcom/android/server/am/ServiceRecord;
...
.method public getRunningServiceControlPanelLocked(Landroid/content/ComponentName;)Landroid/app/PendingIntent;
    ...
    invoke-virtual {p0, p1, v0}, getServiceByNameLocked(Landroid/content/ComponentName;I)Lcom/android/server/am/ServiceRecord;
...
.method getRunningServiceInfoLocked(IIIZZ)Ljava/util/List;
    ...
    invoke-virtual {p0, v6}, getServicesLocked(I)Landroid/util/ArrayMap;
    ...
    invoke-virtual {p0, v8}, makeRunningServiceInfoLocked(Lcom/android/server/am/ServiceRecord;)Landroid/app/ActivityManager$RunningServiceInfo;
    ...
    invoke-virtual {p0, v4}, getServicesLocked(I)Landroid/util/ArrayMap;
    ...
    :goto_4
    iget-object v6, p0, mRestartingServices:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v6}, makeRunningServiceInfoLocked(Lcom/android/server/am/ServiceRecord;)Landroid/app/ActivityManager$RunningServiceInfo;
...
.method getServiceByNameLocked(Landroid/content/ComponentName;I)Lcom/android/server/am/ServiceRecord;
    ...
    :cond_0
    invoke-direct {p0, p2}, getServiceMapLocked(I)Lcom/android/server/am/ActiveServices$ServiceMap;
...
.method final killServicesLocked(Lcom/android/server/am/ProcessRecord;Z)V
    ...
    iput-object v3, v1, mServicetracker:Lvendor/qti/hardware/servicetracker/V1_0/IServicetracker;
    ...
    invoke-virtual {v1, v5, v2, v3}, removeConnectionLocked(Lcom/android/server/am/ConnectionRecord;Lcom/android/server/am/ProcessRecord;Lcom/android/server/wm/ActivityServiceConnectionsHolder;)V
    ...
    iget-object v7, v1, mDestroyingServices:Ljava/util/ArrayList;
    ...
    invoke-direct {v1, v3}, getServiceMapLocked(I)Lcom/android/server/am/ActiveServices$ServiceMap;
    ...
    invoke-direct {v1, v6}, bringDownServiceLocked(Lcom/android/server/am/ServiceRecord;)V
    ...
    :cond_11
    invoke-direct {v1, v6, v4}, scheduleServiceRestartLocked(Lcom/android/server/am/ServiceRecord;Z)Z
    ...
    iget-object v5, v1, mRestartingServices:Ljava/util/ArrayList;
    ...
    iget-object v6, v1, mRestartingServices:Ljava/util/ArrayList;

    invoke-virtual {v6, v0}, Ljava/util/ArrayList;->remove(I)Ljava/lang/Object;

    invoke-direct {v1, v5}, clearRestartingIfNeededLocked(Lcom/android/server/am/ServiceRecord;)V
    ...
    iget-object v4, v1, mPendingServices:Ljava/util/ArrayList;
    ...
    iget-object v5, v1, mPendingServices:Ljava/util/ArrayList;
    ...
    iget-object v5, v1, mDestroyingServices:Ljava/util/ArrayList;
...
.method peekServiceLocked(Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;)Landroid/os/IBinder;
    ...
    invoke-direct/range {v0 .. v11}, retrieveServiceLocked(Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IIIZZZZ)Lcom/android/server/am/ActiveServices$ServiceLookupResult;
...
.method final performServiceRestartLocked(Lcom/android/server/am/ServiceRecord;)V
    ...
    invoke-direct {p0, p1, v0, v0}, isServiceNeededLocked(Lcom/android/server/am/ServiceRecord;ZZ)Z
    ...
    invoke-direct/range {v5 .. v10}, bringUpServiceLocked(Lcom/android/server/am/ServiceRecord;IZZZ)Ljava/lang/String;
    ...
    invoke-direct {p0, p1, v6}, scheduleServiceRestartLocked(Lcom/android/server/am/ServiceRecord;Z)Z
...
.method publishServiceLocked(Lcom/android/server/am/ServiceRecord;Landroid/content/Intent;Landroid/os/IBinder;)V
    ...
    invoke-direct {v1, v2, v0, v3}, serviceDoneExecutingLocked(Lcom/android/server/am/ServiceRecord;ZZ)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
...
.method removeConnectionLocked(Lcom/android/server/am/ConnectionRecord;Lcom/android/server/am/ProcessRecord;Lcom/android/server/wm/ActivityServiceConnectionsHolder;)V
    ...
    invoke-direct {v1, v6}, updateWhitelistManagerLocked(Lcom/android/server/am/ProcessRecord;)V
    ...
    invoke-direct {v1, v6, v2, v8}, updateServiceClientActivitiesLocked(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/ConnectionRecord;Z)Z

    :cond_7
    iget-object v6, v1, mServiceConnections:Landroid/util/ArrayMap;
    ...
    iget-object v0, v1, mServiceConnections:Landroid/util/ArrayMap;
    ...
    invoke-direct {v1, v5, v10, v0}, bumpServiceExecutingLocked(Lcom/android/server/am/ServiceRecord;ZLjava/lang/String;)V
    ...
    invoke-direct {v1, v5}, serviceProcessGoneLocked(Lcom/android/server/am/ServiceRecord;)V
    ...
    iget-object v11, v1, mAm:Lcom/android/server/am/ActivityManagerService;
    ...
    invoke-direct {v1, v5, v8, v0}, bringDownServiceIfNeededLocked(Lcom/android/server/am/ServiceRecord;ZZ)V
...
.method serviceTimeout(Lcom/android/server/am/ProcessRecord;)V
    ...
    iget-object v3, v1, mAm:Lcom/android/server/am/ActivityManagerService;
    ...
    iput-object v13, v1, mLastAnrDump:Ljava/lang/String;

    iget-object v13, v1, mAm:Lcom/android/server/am/ActivityManagerService;

    iget-object v13, v13, Lcom/android/server/am/ActivityManagerService;->mHandler:Lcom/android/server/am/ActivityManagerService$MainHandler;

    iget-object v14, v1, mLastAnrDumpClearer:Ljava/lang/Runnable;
...
.method public setServiceForegroundLocked(Landroid/content/ComponentName;Landroid/os/IBinder;ILandroid/app/Notification;II)V
    ...
    :try_start_0
    invoke-direct {p0, p1, p2, v1}, findServiceLocked(Landroid/content/ComponentName;Landroid/os/IBinder;I)Lcom/android/server/am/ServiceRecord;
    ...
    invoke-direct/range {v4 .. v9}, setServiceForegroundInnerLocked(Lcom/android/server/am/ServiceRecord;ILandroid/app/Notification;II)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method startServiceInnerLocked(Lcom/android/server/am/ActiveServices$ServiceMap;Landroid/content/Intent;Lcom/android/server/am/ServiceRecord;ZZ)Landroid/content/ComponentName;
    ...
    iget-object v1, v7, mAm:Lcom/android/server/am/ActivityManagerService;
    ...
    iget-object v4, v7, mAm:Lcom/android/server/am/ActivityManagerService;
    ...
    :cond_3
    sget-boolean v2, DEBUG_DELAYED_STARTS:Z
...
.method startServiceLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;IIZLjava/lang/String;I)Landroid/content/ComponentName;
    ...
    invoke-virtual/range {v0 .. v9}, startServiceLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;IIZLjava/lang/String;IZ)Landroid/content/ComponentName;
...
.method startServiceLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;IIZLjava/lang/String;IZ)Landroid/content/ComponentName;
    ...
    iget-object v1, v12, mAm:Lcom/android/server/am/ActivityManagerService;
    ...
    iget-object v0, v12, mAm:Lcom/android/server/am/ActivityManagerService;
    ...
    invoke-direct {v12, v1, v2}, appRestrictedAnyInBackground(ILjava/lang/String;)Z
    ...
    iget-object v9, v12, mAm:Lcom/android/server/am/ActivityManagerService;
    ...
    :cond_16
    iget-object v2, v12, mAm:Lcom/android/server/am/ActivityManagerService;
    ...
    invoke-direct/range {v0 .. v6}, requestStartTargetPermissionsReviewIfNeededLocked(Lcom/android/server/am/ServiceRecord;Ljava/lang/String;ILandroid/content/Intent;ZI)Z
    ...
    invoke-direct {v12, v10, v9, v6}, unscheduleServiceRestartLocked(Lcom/android/server/am/ServiceRecord;IZ)Z
    ...
    invoke-direct {v12, v0}, getServiceMapLocked(I)Lcom/android/server/am/ActiveServices$ServiceMap;
    ...
    sget-boolean v1, DEBUG_DELAYED_STARTS:Z
    ...
    :cond_21
    sget-boolean v3, DEBUG_DELAYED_STARTS:Z
    ...
    :cond_23
    :goto_d
    sget-boolean v1, DEBUG_DELAYED_SERVICE:Z
    ...
    iget v3, v12, mMaxStartingBackground:I
    ...
    invoke-virtual/range {v0 .. v5}, startServiceInnerLocked(Lcom/android/server/am/ActiveServices$ServiceMap;Landroid/content/Intent;Lcom/android/server/am/ServiceRecord;ZZ)Landroid/content/ComponentName;
...
.method stopInBackgroundLocked(I)V
    ...
    invoke-direct {p0, v6, v7}, appRestrictedAnyInBackground(ILjava/lang/String;)Z

    move-result v6

    if-eqz v6, :cond_2

    invoke-direct {p0, v3}, cancelForegroundNotificationLocked(Lcom/android/server/am/ServiceRecord;)V
    ...
    invoke-direct {p0, v3}, stopServiceLocked(Lcom/android/server/am/ServiceRecord;)V
...
.method stopServiceLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;I)I
    ...
    invoke-direct {v13, v0}, stopServiceLocked(Lcom/android/server/am/ServiceRecord;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method stopServiceTokenLocked(Landroid/content/ComponentName;Landroid/os/IBinder;I)Z
    ...
    invoke-direct {p0, v0, v1, v1}, bringDownServiceIfNeededLocked(Lcom/android/server/am/ServiceRecord;ZZ)V
...
.method unbindFinishedLocked(Lcom/android/server/am/ServiceRecord;Landroid/content/Intent;Z)V
    ...
    :goto_2
    :try_start_1
    invoke-direct {p0, p1, v3, v6, v7}, requestServiceBindingLocked(Lcom/android/server/am/ServiceRecord;Lcom/android/server/am/IntentBindRecord;ZZ)Z
    :try_end_1
    ...
    :cond_5
    :goto_4
    invoke-direct {p0, p1, v4, v5}, serviceDoneExecutingLocked(Lcom/android/server/am/ServiceRecord;ZZ)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method unbindServiceLocked(Landroid/app/IServiceConnection;)Z
    ...
    :cond_0
    iget-object v1, p0, mServiceConnections:Landroid/util/ArrayMap;
    ...
    iget-object v11, p0, mServicetracker:Lvendor/qti/hardware/servicetracker/V1_0/IServicetracker;
    ...
    iput-object v10, p0, mServicetracker:Lvendor/qti/hardware/servicetracker/V1_0/IServicetracker;

    :goto_2
    invoke-virtual {p0, v6, v10, v10}, removeConnectionLocked(Lcom/android/server/am/ConnectionRecord;Lcom/android/server/am/ProcessRecord;Lcom/android/server/wm/ActivityServiceConnectionsHolder;)V
    ...
    invoke-direct {p0, v11}, updateWhitelistManagerLocked(Lcom/android/server/am/ProcessRecord;)V
...
.method updateForegroundApps(Lcom/android/server/am/ActiveServices$ServiceMap;)V
    ...
    invoke-virtual {p0, v8, v2, v3}, foregroundAppShownEnoughLocked(Lcom/android/server/am/ActiveServices$ActiveForegroundApp;J)Z
...
.method updateScreenStateLocked(Z)V
    ...
    :cond_2
    invoke-virtual {p0, v11, v0, v1}, foregroundAppShownEnoughLocked(Lcom/android/server/am/ActiveServices$ActiveForegroundApp;J)Z
    ...
    invoke-direct {p0, v4, v9, v10}, requestUpdateActiveForegroundAppsLocked(Lcom/android/server/am/ActiveServices$ServiceMap;J)V
    ...
    invoke-direct {p0, v4, v5, v6}, requestUpdateActiveForegroundAppsLocked(Lcom/android/server/am/ActiveServices$ServiceMap;J)V
...
.method public updateServiceConnectionActivitiesLocked(Lcom/android/server/am/ProcessRecord;)V
    ...
    invoke-direct {p0, v3, v4, v5}, updateServiceClientActivitiesLocked(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/ConnectionRecord;Z)Z
...
.method protected writeToProto(Landroid/util/proto/ProtoOutputStream;J)V
    ...
    iget-object v10, v1, mServiceMap:Landroid/util/SparseArray;
