...
.method static constructor <clinit>()V
    ...
    sput-object v1, ORIG_ENUMS:[I

    new-array v0, v0, [I

    fill-array-data v0, :array_1

    sput-object v0, PROTO_ENUMS:[I
...
.method public constructor <init>(I)V
    ...
    iput-object v0, p0, networkStateLock:Ljava/lang/Object;

    iput p1, p0, uid:I

    const/4 v0, 0x1

    iput-boolean v0, p0, idle:Z
...
.method public reset()V
    ...
    invoke-virtual {p0, v0}, setCurProcState(I)V

    const/4 v0, 0x0

    iput-boolean v0, p0, foregroundServices:Z
...
.method public toString()Ljava/lang/String;
    ...
    iget-boolean v1, p0, ephemeral:Z
    ...
    :cond_1
    iget-boolean v1, p0, curWhitelist:Z
    ...
    :cond_2
    iget-wide v1, p0, lastBackgroundTime:J
    ...
    iget-wide v3, p0, lastBackgroundTime:J
    ...
    :cond_4
    iget v1, p0, lastReportedChange:I
    ...
    iget v2, p0, lastReportedChange:I
    ...
    iget-wide v1, p0, curProcStateSeq:J
    ...
    iget-wide v2, p0, lastNetworkUpdatedProcStateSeq:J

    invoke-virtual {v0, v2, v3}, Ljava/lang/StringBuilder;->append(J)Ljava/lang/StringBuilder;

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-wide v1, p0, lastDispatchedProcStateSeq:J
...
.method public updateHasInternetPermission()V
    ...
    :goto_0
    iput-boolean v0, p0, hasInternetPermission:Z
...
.method public updateLastDispatchedProcStateSeq(I)V
    ...
    iget-wide v0, p0, curProcStateSeq:J

    iput-wide v0, p0, lastDispatchedProcStateSeq:J
...
.method writeToProto(Landroid/util/proto/ProtoOutputStream;J)V
    ...
    iget-boolean v2, p0, ephemeral:Z

    const-wide v3, 0x10800000003L

    invoke-virtual {p1, v3, v4, v2}, Landroid/util/proto/ProtoOutputStream;->write(JZ)V

    iget-boolean v2, p0, foregroundServices:Z

    const-wide v3, 0x10800000004L

    invoke-virtual {p1, v3, v4, v2}, Landroid/util/proto/ProtoOutputStream;->write(JZ)V

    iget-boolean v2, p0, curWhitelist:Z

    const-wide v3, 0x10800000005L

    invoke-virtual {p1, v3, v4, v2}, Landroid/util/proto/ProtoOutputStream;->write(JZ)V

    iget-wide v8, p0, lastBackgroundTime:J
    ...
    iget v8, p0, lastReportedChange:I

    if-eqz v8, :cond_0

    const-wide v6, 0x20e00000008L

    sget-object v9, ORIG_ENUMS:[I

    sget-object v10, PROTO_ENUMS:[I
    ...
    iget-wide v6, p0, curProcStateSeq:J

    invoke-virtual {p1, v4, v5, v6, v7}, Landroid/util/proto/ProtoOutputStream;->write(JJ)V

    const-wide v4, 0x10300000002L

    iget-wide v6, p0, lastNetworkUpdatedProcStateSeq:J

    invoke-virtual {p1, v4, v5, v6, v7}, Landroid/util/proto/ProtoOutputStream;->write(JJ)V

    const-wide v4, 0x10300000003L

    iget-wide v6, p0, lastDispatchedProcStateSeq:J
