...
.method public constructor <init>(Lcom/android/server/am/BroadcastQueue;Lcom/android/server/am/BroadcastConstants;Landroid/os/Handler;Ljava/lang/Object;)V
    ...
    iput-object v0, p0, mAlarmUids:Landroid/util/SparseIntArray;
    ...
    iput-object v0, p0, mAlarmListener:Lcom/android/server/AlarmManagerInternal$InFlightListener;
    ...
    iput-object v0, p0, mScheduleRunnable:Ljava/lang/Runnable;

    const/4 v0, 0x0

    iput-boolean v0, p0, mRecheckScheduled:Z
    ...
    iput-object v0, p0, mDeferredBroadcasts:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mAlarmBroadcasts:Ljava/util/ArrayList;

    iput-object p1, p0, mQueue:Lcom/android/server/am/BroadcastQueue;

    iput-object p2, p0, mConstants:Lcom/android/server/am/BroadcastConstants;

    iput-object p3, p0, mHandler:Landroid/os/Handler;

    iput-object p4, p0, mLock:Ljava/lang/Object;
...
.method static synthetic access$100(Lcom/android/server/am/BroadcastDispatcher;)Ljava/util/ArrayList;
    ...
    iget-object v0, p0, mDeferredBroadcasts:Ljava/util/ArrayList;
...
.method static synthetic access$200(Lcom/android/server/am/BroadcastDispatcher;)Ljava/util/ArrayList;
    ...
    iget-object v0, p0, mAlarmBroadcasts:Ljava/util/ArrayList;
...
.method static synthetic access$300(Ljava/util/ArrayList;Lcom/android/server/am/BroadcastDispatcher$Deferrals;)V
    ...
    invoke-static {p0, p1}, insertLocked(Ljava/util/ArrayList;Lcom/android/server/am/BroadcastDispatcher$Deferrals;)V
...
.method static synthetic access$400(Lcom/android/server/am/BroadcastDispatcher;)Lcom/android/server/am/BroadcastQueue;
    ...
    iget-object v0, p0, mQueue:Lcom/android/server/am/BroadcastQueue;
...
.method static synthetic access$502(Lcom/android/server/am/BroadcastDispatcher;Z)Z
    ...
    iput-boolean p1, p0, mRecheckScheduled:Z
...
.method private calculateDeferral(J)J
    ...
    iget-object v3, p0, mConstants:Lcom/android/server/am/BroadcastConstants;
...
.method private cleanupDeferralsListDisabledReceiversLocked(Ljava/util/ArrayList;Ljava/lang/String;Ljava/util/Set;IZ)Z
    ...
    invoke-direct/range {v3 .. v8}, cleanupBroadcastListDisabledReceiversLocked(Ljava/util/ArrayList;Ljava/lang/String;Ljava/util/Set;IZ)Z
...
.method private findUidLocked(I)Lcom/android/server/am/BroadcastDispatcher$Deferrals;
    ...
    invoke-static {p1, v0}, findUidLocked(ILjava/util/ArrayList;)Lcom/android/server/am/BroadcastDispatcher$Deferrals;

    move-result-object v0

    if-nez v0, :cond_0

    iget-object v1, p0, mAlarmBroadcasts:Ljava/util/ArrayList;

    invoke-static {p1, v1}, findUidLocked(ILjava/util/ArrayList;)Lcom/android/server/am/BroadcastDispatcher$Deferrals;
...
.method private static isDeferralsListEmpty(Ljava/util/ArrayList;)Z
    ...
    invoke-static {p0}, pendingInDeferralsList(Ljava/util/ArrayList;)I
...
.method private replaceBroadcastLocked(Ljava/util/ArrayList;Lcom/android/server/am/BroadcastRecord;Ljava/lang/String;)Lcom/android/server/am/BroadcastRecord;
    ...
    iget-object v4, p0, mQueue:Lcom/android/server/am/BroadcastQueue;
...
.method private replaceDeferredBroadcastLocked(Ljava/util/ArrayList;Lcom/android/server/am/BroadcastRecord;Ljava/lang/String;)Lcom/android/server/am/BroadcastRecord;
    ...
    invoke-direct {p0, v3, p2, p3}, replaceBroadcastLocked(Ljava/util/ArrayList;Lcom/android/server/am/BroadcastRecord;Ljava/lang/String;)Lcom/android/server/am/BroadcastRecord;
...
.method public addDeferredBroadcast(ILcom/android/server/am/BroadcastRecord;)V
    ...
    :try_start_0
    invoke-direct {p0, p1}, findUidLocked(I)Lcom/android/server/am/BroadcastDispatcher$Deferrals;
...
.method public cancelDeferralsLocked()V
    ...
    invoke-static {v0}, zeroDeferralTimes(Ljava/util/ArrayList;)V
...
.method cleanupDisabledPackageReceiversLocked(Ljava/lang/String;Ljava/util/Set;IZ)Z
    ...
    invoke-direct/range {v0 .. v5}, cleanupBroadcastListDisabledReceiversLocked(Ljava/util/ArrayList;Ljava/lang/String;Ljava/util/Set;IZ)Z
    ...
    :cond_0
    iget-object v2, p0, mAlarmBroadcasts:Ljava/util/ArrayList;
    ...
    invoke-direct/range {v1 .. v6}, cleanupDeferralsListDisabledReceiversLocked(Ljava/util/ArrayList;Ljava/lang/String;Ljava/util/Set;IZ)Z
    ...
    :cond_2
    iget-object v2, p0, mDeferredBroadcasts:Ljava/util/ArrayList;
    ...
    :cond_4
    iget-object v1, p0, mCurrentBroadcast:Lcom/android/server/am/BroadcastRecord;
...
.method public describeStateLocked()Ljava/lang/String;
    ...
    invoke-static {v1}, pendingInDeferralsList(Ljava/util/ArrayList;)I
    ...
    :cond_1
    iget-object v3, p0, mDeferredBroadcasts:Ljava/util/ArrayList;

    invoke-static {v3}, pendingInDeferralsList(Ljava/util/ArrayList;)I
...
.method dumpLocked(Ljava/io/PrintWriter;Ljava/lang/String;Ljava/lang/String;Ljava/text/SimpleDateFormat;)Z
    ...
    iget-object v2, p0, mCurrentBroadcast:Lcom/android/server/am/BroadcastRecord;
...
.method public getActiveBroadcastLocked()Lcom/android/server/am/BroadcastRecord;
    ...
    iget-object v0, p0, mCurrentBroadcast:Lcom/android/server/am/BroadcastRecord;
...
.method public getNextBroadcastLocked(J)Lcom/android/server/am/BroadcastRecord;
    ...
    invoke-static {v2}, popLocked(Ljava/util/ArrayList;)Lcom/android/server/am/BroadcastRecord;
    ...
    iget-object v4, p0, mDeferredBroadcasts:Ljava/util/ArrayList;
    ...
    :goto_0
    iget-object v5, p0, mDeferredBroadcasts:Ljava/util/ArrayList;
    ...
    iget-object v6, p0, mDeferredBroadcasts:Ljava/util/ArrayList;

    invoke-virtual {v6, v4}, Ljava/util/ArrayList;->remove(I)Ljava/lang/Object;

    iget-wide v6, v5, Lcom/android/server/am/BroadcastDispatcher$Deferrals;->deferredBy:J

    invoke-direct {p0, v6, v7}, calculateDeferral(J)J
    ...
    invoke-static {v6, v5}, insertLocked(Ljava/util/ArrayList;Lcom/android/server/am/BroadcastDispatcher$Deferrals;)V
    ...
    iget-object v4, p0, mOrderedBroadcasts:Ljava/util/ArrayList;
    ...
    :cond_5
    iput-object v1, p0, mCurrentBroadcast:Lcom/android/server/am/BroadcastRecord;
...
.method public isDeferringLocked(I)Z
    ...
    :cond_0
    invoke-direct {p0, v0}, removeDeferral(Lcom/android/server/am/BroadcastDispatcher$Deferrals;)Z
...
.method public isEmpty()Z
    ...
    iget-object v1, p0, mDeferredBroadcasts:Ljava/util/ArrayList;

    invoke-static {v1}, isDeferralsListEmpty(Ljava/util/ArrayList;)Z
...
.method replaceBroadcastLocked(Lcom/android/server/am/BroadcastRecord;Ljava/lang/String;)Lcom/android/server/am/BroadcastRecord;
    ...
    invoke-direct {p0, v0, p1, p2}, replaceBroadcastLocked(Ljava/util/ArrayList;Lcom/android/server/am/BroadcastRecord;Ljava/lang/String;)Lcom/android/server/am/BroadcastRecord;
    ...
    invoke-direct {p0, v1, p1, p2}, replaceDeferredBroadcastLocked(Ljava/util/ArrayList;Lcom/android/server/am/BroadcastRecord;Ljava/lang/String;)Lcom/android/server/am/BroadcastRecord;
...
.method public retireBroadcastLocked(Lcom/android/server/am/BroadcastRecord;)V
    ...
    iput-object v0, p0, mCurrentBroadcast:Lcom/android/server/am/BroadcastRecord;
...
.method public scheduleDeferralCheckLocked(Z)V
    ...
    iget-boolean v0, p0, mRecheckScheduled:Z
    ...
    iget-object v2, p0, mScheduleRunnable:Ljava/lang/Runnable;
    ...
    iput-boolean v1, p0, mRecheckScheduled:Z
...
.method public start()V
    ...
    iput-object v0, p0, mAlarm:Lcom/android/server/AlarmManagerInternal;

    iget-object v0, p0, mAlarm:Lcom/android/server/AlarmManagerInternal;

    iget-object v1, p0, mAlarmListener:Lcom/android/server/AlarmManagerInternal$InFlightListener;
...
.method public startDeferring(I)V
    ...
    iget-object v2, p0, mConstants:Lcom/android/server/am/BroadcastConstants;

    iget-wide v6, v2, Lcom/android/server/am/BroadcastConstants;->DEFERRAL:J

    iget-object v2, p0, mAlarmUids:Landroid/util/SparseIntArray;
    ...
    invoke-static {v2, v1}, insertLocked(Ljava/util/ArrayList;Lcom/android/server/am/BroadcastDispatcher$Deferrals;)V

    const/4 v2, 0x1

    invoke-virtual {p0, v2}, scheduleDeferralCheckLocked(Z)V
