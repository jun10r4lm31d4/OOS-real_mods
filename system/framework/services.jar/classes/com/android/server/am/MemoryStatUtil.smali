...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, DEVICE_HAS_PER_APP_MEMCG:Z
    ...
    sput-object v0, PGFAULT:Ljava/util/regex/Pattern;
    ...
    sput-object v0, PGMAJFAULT:Ljava/util/regex/Pattern;
    ...
    sput-object v0, RSS_IN_BYTES:Ljava/util/regex/Pattern;
    ...
    sput-object v0, CACHE_IN_BYTES:Ljava/util/regex/Pattern;
    ...
    sput-object v0, SWAP_IN_BYTES:Ljava/util/regex/Pattern;
    ...
    sput-object v0, RSS_HIGH_WATERMARK_IN_KILOBYTES:Ljava/util/regex/Pattern;
    ...
    sput-object v0, PROCFS_RSS_IN_KILOBYTES:Ljava/util/regex/Pattern;
    ...
    sput-object v0, PROCFS_ANON_RSS_IN_KILOBYTES:Ljava/util/regex/Pattern;
    ...
    sput-object v0, PROCFS_SWAP_IN_KILOBYTES:Ljava/util/regex/Pattern;
    ...
    sput-object v0, ION_HEAP_SIZE_IN_BYTES:Ljava/util/regex/Pattern;
    ...
    sput-object v0, PROCESS_ION_HEAP_SIZE_IN_BYTES:Ljava/util/regex/Pattern;
...
.method static hasMemcg()Z
    ...
    sget-boolean v0, DEVICE_HAS_PER_APP_MEMCG:Z
...
.method static parseIonHeapSizeFromDebugfs(Ljava/lang/String;)J
    ...
    :cond_0
    sget-object v0, ION_HEAP_SIZE_IN_BYTES:Ljava/util/regex/Pattern;

    invoke-static {v0, p0}, tryParseLong(Ljava/util/regex/Pattern;Ljava/lang/String;)J
...
.method static parseMemoryStatFromMemcg(Ljava/lang/String;)Lcom/android/server/am/MemoryStatUtil$MemoryStat;
    ...
    sget-object v1, PGFAULT:Ljava/util/regex/Pattern;

    invoke-static {v1, p0}, tryParseLong(Ljava/util/regex/Pattern;Ljava/lang/String;)J

    move-result-wide v1

    iput-wide v1, v0, Lcom/android/server/am/MemoryStatUtil$MemoryStat;->pgfault:J

    sget-object v1, PGMAJFAULT:Ljava/util/regex/Pattern;
    ...
    sget-object v1, RSS_IN_BYTES:Ljava/util/regex/Pattern;
    ...
    sget-object v1, CACHE_IN_BYTES:Ljava/util/regex/Pattern;
    ...
    sget-object v1, SWAP_IN_BYTES:Ljava/util/regex/Pattern;
...
.method static parseMemoryStatFromProcfs(Ljava/lang/String;Ljava/lang/String;)Lcom/android/server/am/MemoryStatUtil$MemoryStat;
    ...
    sget-object v3, PROCFS_RSS_IN_KILOBYTES:Ljava/util/regex/Pattern;

    invoke-static {v3, p1}, tryParseLong(Ljava/util/regex/Pattern;Ljava/lang/String;)J
    ...
    sget-object v3, PROCFS_ANON_RSS_IN_KILOBYTES:Ljava/util/regex/Pattern;
    ...
    sget-object v3, PROCFS_SWAP_IN_KILOBYTES:Ljava/util/regex/Pattern;
...
.method static parseProcessIonHeapSizesFromDebugfs(Ljava/lang/String;)Ljava/util/List;
    ...
    :cond_0
    sget-object v0, PROCESS_ION_HEAP_SIZE_IN_BYTES:Ljava/util/regex/Pattern;
...
.method static parseVmHWMFromProcfs(Ljava/lang/String;)J
    ...
    :cond_0
    sget-object v0, RSS_HIGH_WATERMARK_IN_KILOBYTES:Ljava/util/regex/Pattern;
...
.method public static readCmdlineFromProcfs(I)Ljava/lang/String;
    ...
    invoke-static {v0}, readFileContents(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    invoke-static {v1}, parseCmdlineFromProcfs(Ljava/lang/String;)Ljava/lang/String;
...
.method public static readMemoryStatFromFilesystem(II)Lcom/android/server/am/MemoryStatUtil$MemoryStat;
    ...
    invoke-static {}, hasMemcg()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p0, p1}, readMemoryStatFromMemcg(II)Lcom/android/server/am/MemoryStatUtil$MemoryStat;
    ...
    :cond_0
    invoke-static {p1}, readMemoryStatFromProcfs(I)Lcom/android/server/am/MemoryStatUtil$MemoryStat;
...
.method static readMemoryStatFromMemcg(II)Lcom/android/server/am/MemoryStatUtil$MemoryStat;
    ...
    invoke-static {v1}, parseMemoryStatFromMemcg(Ljava/lang/String;)Lcom/android/server/am/MemoryStatUtil$MemoryStat;
...
.method public static readMemoryStatFromProcfs(I)Lcom/android/server/am/MemoryStatUtil$MemoryStat;
    ...
    invoke-static {v1}, readFileContents(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    invoke-static {v2, v3}, parseMemoryStatFromProcfs(Ljava/lang/String;Ljava/lang/String;)Lcom/android/server/am/MemoryStatUtil$MemoryStat;
...
.method public static readProcessSystemIonHeapSizesFromDebugfs()Ljava/util/List;
    ...
    invoke-static {v0}, parseProcessIonHeapSizesFromDebugfs(Ljava/lang/String;)Ljava/util/List;
...
.method public static readRssHighWaterMarkFromProcfs(I)J
    ...
    invoke-static {v1}, parseVmHWMFromProcfs(Ljava/lang/String;)J
...
.method public static readSystemIonHeapSizeFromDebugfs()J
    ...
    invoke-static {v0}, parseIonHeapSizeFromDebugfs(Ljava/lang/String;)J
