...
.method constructor <init>(Lcom/android/server/am/UserController;JLjava/lang/String;Landroid/util/ArraySet;Ljava/util/concurrent/atomic/AtomicInteger;Lcom/android/server/am/UserState;II)V
    ...
    iput-object p1, p0, this$0:Lcom/android/server/am/UserController;

    iput-wide p2, p0, val$dispatchStartedTime:J

    iput-object p4, p0, val$name:Ljava/lang/String;

    iput-object p5, p0, val$curWaitingUserSwitchCallbacks:Landroid/util/ArraySet;

    iput-object p6, p0, val$waitingCallbacksCount:Ljava/util/concurrent/atomic/AtomicInteger;

    iput-object p7, p0, val$uss:Lcom/android/server/am/UserState;

    iput p8, p0, val$oldUserId:I

    iput p9, p0, val$newUserId:I
...
.method public sendResult(Landroid/os/Bundle;)V
    ...
    iget-object v0, p0, this$0:Lcom/android/server/am/UserController;
    ...
    iget-wide v3, p0, val$dispatchStartedTime:J
    ...
    iget-object v5, p0, val$name:Ljava/lang/String;
    ...
    :cond_0
    iget-object v3, p0, val$curWaitingUserSwitchCallbacks:Landroid/util/ArraySet;

    iget-object v4, p0, val$name:Ljava/lang/String;

    invoke-virtual {v3, v4}, Landroid/util/ArraySet;->remove(Ljava/lang/Object;)Z

    iget-object v3, p0, val$waitingCallbacksCount:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v4, p0, this$0:Lcom/android/server/am/UserController;
    ...
    iget-object v3, p0, this$0:Lcom/android/server/am/UserController;

    iget-object v4, p0, val$uss:Lcom/android/server/am/UserState;

    iget v5, p0, val$oldUserId:I

    iget v6, p0, val$newUserId:I
