...
.method public constructor <init>()V
    ...
    iput-wide v0, p0, mNowRealtimeMs:J

    invoke-static {}, Landroid/os/SystemClock;->uptimeMillis()J

    move-result-wide v0

    iput-wide v0, p0, mNowUptimeMs:J
...
.method private addTimer(Landroid/os/health/HealthStatsWriter;ILandroid/os/BatteryStats$Timer;)V
    ...
    iget-wide v2, p0, mNowRealtimeMs:J
...
.method private addTimers(Landroid/os/health/HealthStatsWriter;ILjava/lang/String;Landroid/os/BatteryStats$Timer;)V
    ...
    iget-wide v3, p0, mNowRealtimeMs:J
...
.method public writePkg(Landroid/os/health/HealthStatsWriter;Landroid/os/BatteryStats$Uid$Pkg;)V
    ...
    invoke-virtual {p0, v2, v3}, writeServ(Landroid/os/health/HealthStatsWriter;Landroid/os/BatteryStats$Uid$Pkg$Serv;)V
...
.method public writeUid(Landroid/os/health/HealthStatsWriter;Landroid/os/BatteryStats;Landroid/os/BatteryStats$Uid;)V
    ...
    iget-wide v4, v0, mNowRealtimeMs:J
    ...
    iget-wide v4, v0, mNowUptimeMs:J
    ...
    invoke-direct {v0, v1, v13, v11, v10}, addTimers(Landroid/os/health/HealthStatsWriter;ILjava/lang/String;Landroid/os/BatteryStats$Timer;)V
    ...
    invoke-direct {v0, v1, v10, v11, v9}, addTimers(Landroid/os/health/HealthStatsWriter;ILjava/lang/String;Landroid/os/BatteryStats$Timer;)V
    ...
    invoke-direct {v0, v1, v11, v12, v13}, addTimers(Landroid/os/health/HealthStatsWriter;ILjava/lang/String;Landroid/os/BatteryStats$Timer;)V
    ...
    invoke-direct {v0, v1, v13, v14}, addTimer(Landroid/os/health/HealthStatsWriter;ILandroid/os/BatteryStats$Timer;)V
    ...
    invoke-direct {v0, v1, v13, v14, v15}, addTimers(Landroid/os/health/HealthStatsWriter;ILjava/lang/String;Landroid/os/BatteryStats$Timer;)V
    ...
    invoke-virtual {v0, v13, v14}, writePid(Landroid/os/health/HealthStatsWriter;Landroid/os/BatteryStats$Uid$Pid;)V
    ...
    invoke-virtual {v0, v14, v15}, writeProc(Landroid/os/health/HealthStatsWriter;Landroid/os/BatteryStats$Uid$Proc;)V
    ...
    invoke-virtual {v0, v13, v14}, writePkg(Landroid/os/health/HealthStatsWriter;Landroid/os/BatteryStats$Uid$Pkg;)V
    ...
    iget-wide v11, v0, mNowRealtimeMs:J
    ...
    iget-wide v12, v0, mNowRealtimeMs:J
    ...
    invoke-direct {v0, v1, v10, v11}, addTimer(Landroid/os/health/HealthStatsWriter;ILandroid/os/BatteryStats$Timer;)V
    ...
    invoke-direct {v0, v1, v10, v12}, addTimer(Landroid/os/health/HealthStatsWriter;ILandroid/os/BatteryStats$Timer;)V
    ...
    invoke-direct {v0, v1, v10, v14}, addTimer(Landroid/os/health/HealthStatsWriter;ILandroid/os/BatteryStats$Timer;)V
