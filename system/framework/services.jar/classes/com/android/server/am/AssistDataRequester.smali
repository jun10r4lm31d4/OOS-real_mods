...
.method public constructor <init>(Landroid/content/Context;Landroid/view/IWindowManager;Landroid/app/AppOpsManager;Lcom/android/server/am/AssistDataRequester$AssistDataRequesterCallbacks;Ljava/lang/Object;II)V
    ...
    iput-object v0, p0, mAssistData:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mAssistScreenshot:Ljava/util/ArrayList;

    iput-object p4, p0, mCallbacks:Lcom/android/server/am/AssistDataRequester$AssistDataRequesterCallbacks;

    iput-object p5, p0, mCallbacksLock:Ljava/lang/Object;
    ...
    iput-object p3, p0, mAppOpsManager:Landroid/app/AppOpsManager;

    iput p6, p0, mRequestStructureAppOps:I

    iput p7, p0, mRequestScreenshotAppOps:I
...
.method private dispatchAssistDataReceived(Landroid/os/Bundle;)V
    ...
    :cond_1
    iget-object v3, p0, mCallbacks:Lcom/android/server/am/AssistDataRequester$AssistDataRequesterCallbacks;
...
.method private dispatchAssistScreenshotReceived(Landroid/graphics/Bitmap;)V
    ...
    iget-object v0, p0, mCallbacks:Lcom/android/server/am/AssistDataRequester$AssistDataRequesterCallbacks;
...
.method private flushPendingAssistData()V
    ...
    iget-object v0, p0, mAssistData:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, mAssistData:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v2}, dispatchAssistDataReceived(Landroid/os/Bundle;)V
    ...
    :cond_0
    iget-object v1, p0, mAssistData:Ljava/util/ArrayList;

    invoke-virtual {v1}, Ljava/util/ArrayList;->clear()V

    iget-object v1, p0, mAssistScreenshot:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, mAssistScreenshot:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v3}, dispatchAssistScreenshotReceived(Landroid/graphics/Bitmap;)V
    ...
    :cond_1
    iget-object v2, p0, mAssistScreenshot:Ljava/util/ArrayList;
...
.method private requestData(Ljava/util/List;ZZZZZILjava/lang/String;)V
    ...
    invoke-direct/range {p0 .. p0}, tryDispatchRequestComplete()V
    ...
    :try_start_0
    iget-object v0, v8, mActivityTaskManager:Landroid/app/IActivityTaskManager;
    ...
    iget v0, v8, mRequestScreenshotAppOps:I
    ...
    iput-boolean v13, v8, mCanceled:Z

    iput v13, v8, mPendingDataCount:I

    iput v13, v8, mPendingScreenshotCount:I

    iget-object v0, v8, mAssistData:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    iget-object v0, v8, mAssistScreenshot:Ljava/util/ArrayList;
    ...
    iget-object v0, v8, mAppOpsManager:Landroid/app/AppOpsManager;

    iget v1, v8, mRequestStructureAppOps:I
    ...
    :try_start_2
    iget-object v1, v8, mActivityTaskManager:Landroid/app/IActivityTaskManager;
    ...
    iget v2, v8, mPendingDataCount:I

    add-int/2addr v2, v14

    iput v2, v8, mPendingDataCount:I
    ...
    iget-object v2, v8, mCallbacks:Lcom/android/server/am/AssistDataRequester$AssistDataRequesterCallbacks;
    ...
    invoke-direct {v8, v13}, dispatchAssistDataReceived(Landroid/os/Bundle;)V

    goto :goto_6

    :cond_6
    iget-object v2, v8, mAssistData:Ljava/util/ArrayList;
    ...
    iget-object v0, v8, mCallbacks:Lcom/android/server/am/AssistDataRequester$AssistDataRequesterCallbacks;
    ...
    iget v1, v8, mRequestScreenshotAppOps:I
    ...
    iget v0, v8, mPendingScreenshotCount:I

    add-int/2addr v0, v14

    iput v0, v8, mPendingScreenshotCount:I

    iget-object v0, v8, mWindowManager:Landroid/view/IWindowManager;
    ...
    invoke-direct {v8, v13}, dispatchAssistScreenshotReceived(Landroid/graphics/Bitmap;)V
...
.method private tryDispatchRequestComplete()V
    ...
    iget v0, p0, mPendingDataCount:I

    if-nez v0, :cond_0

    iget v0, p0, mPendingScreenshotCount:I
    ...
    iget-object v0, p0, mAssistScreenshot:Ljava/util/ArrayList;
...
.method public cancel()V
    ...
    iput v0, p0, mPendingDataCount:I

    iput v0, p0, mPendingScreenshotCount:I
...
.method public onHandleAssistData(Landroid/os/Bundle;)V
    ...
    iget-object v0, p0, mCallbacksLock:Ljava/lang/Object;
    ...
    :cond_0
    iget v1, p0, mPendingDataCount:I

    add-int/lit8 v1, v1, -0x1

    iput v1, p0, mPendingDataCount:I

    iget-object v1, p0, mCallbacks:Lcom/android/server/am/AssistDataRequester$AssistDataRequesterCallbacks;
    ...
    invoke-direct {p0}, flushPendingAssistData()V

    invoke-direct {p0, p1}, dispatchAssistDataReceived(Landroid/os/Bundle;)V

    invoke-direct {p0}, tryDispatchRequestComplete()V
...
.method public onHandleAssistScreenshot(Landroid/graphics/Bitmap;)V
    ...
    :cond_0
    iget v1, p0, mPendingScreenshotCount:I

    add-int/lit8 v1, v1, -0x1

    iput v1, p0, mPendingScreenshotCount:I
    ...
    invoke-direct {p0, p1}, dispatchAssistScreenshotReceived(Landroid/graphics/Bitmap;)V
...
.method public requestAssistData(Ljava/util/List;ZZZZILjava/lang/String;)V
    ...
    invoke-direct/range {v0 .. v8}, requestData(Ljava/util/List;ZZZZZILjava/lang/String;)V
