...
.method constructor <init>(Landroid/app/IActivityManager;Ljava/io/PrintWriter;Ljava/io/InputStream;Ljava/lang/String;Z)V
    ...
    iput-object p3, p0, mInput:Ljava/io/InputStream;

    iput-object p4, p0, mGdbPort:Ljava/lang/String;

    iput-boolean p5, p0, mMonkey:Z
...
.method public appCrashed(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;JLjava/lang/String;)Z
    ...
    invoke-virtual {p0, p2, v0}, waitControllerLocked(II)I
...
.method killGdbLocked()V
    ...
    iput-boolean v0, p0, mGotGdbPrint:Z

    iget-object v0, p0, mGdbProcess:Ljava/lang/Process;
    ...
    iput-object v1, p0, mGdbProcess:Ljava/lang/Process;

    :cond_0
    iget-object v0, p0, mGdbThread:Ljava/lang/Thread;

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Ljava/lang/Thread;->interrupt()V

    iput-object v1, p0, mGdbThread:Ljava/lang/Thread;
...
.method run()V
    ...
    :try_start_0
    invoke-virtual {p0}, printMessageForState()V

    iget-object v1, p0, mPw:Ljava/io/PrintWriter;

    invoke-virtual {v1}, Ljava/io/PrintWriter;->flush()V

    iget-object v1, p0, mInterface:Landroid/app/IActivityManager;

    iget-boolean v2, p0, mMonkey:Z
    ...
    iget-object v3, p0, mInput:Ljava/io/InputStream;
    ...
    :cond_3
    iget-object v6, p0, mPw:Ljava/io/PrintWriter;
    ...
    :cond_4
    :goto_1
    invoke-virtual {p0, v7}, resumeController(I)V

    goto/16 :goto_8

    :cond_5
    :goto_2
    invoke-virtual {p0, v1}, resumeController(I)V
    ...
    :try_start_3
    iget-object v2, p0, mPw:Ljava/io/PrintWriter;
...
.method waitControllerLocked(II)I
    ...
    iget-object v0, p0, mGdbPort:Ljava/lang/String;

    if-eqz v0, :cond_0

    invoke-virtual {p0}, killGdbLocked()V
    ...
    iget-object v2, p0, mGdbPort:Ljava/lang/String;
    ...
    iget-object v4, p0, mGdbPort:Ljava/lang/String;
    ...
    iput-object v0, p0, mGdbProcess:Ljava/lang/Process;

    new-instance v0, Ljava/io/InputStreamReader;

    iget-object v1, p0, mGdbProcess:Ljava/lang/Process;
    ...
    iget-object v1, p0, mGdbThread:Ljava/lang/Thread;
