...
.method public constructor <init>(Ljava/lang/String;Landroid/content/Context;Landroid/os/Handler;ILandroid/content/ComponentName;JDJJ)V
    ...
    iput-object v1, v0, mServiceConnection:Landroid/content/ServiceConnection;
    ...
    iput-object v1, v0, mBindForBackoffRunnable:Ljava/lang/Runnable;
    ...
    iput-object v1, v0, mStableCheck:Ljava/lang/Runnable;

    move-object v1, p1

    iput-object v1, v0, mTag:Ljava/lang/String;
    ...
    iput v4, v0, mUserId:I

    move-object/from16 v5, p5

    iput-object v5, v0, mComponentName:Landroid/content/ComponentName;

    const-wide/16 v6, 0x3e8

    mul-long v8, p6, v6

    iput-wide v8, v0, mRebindBackoffMs:J

    move-wide/from16 v8, p8

    iput-wide v8, v0, mRebindBackoffIncrease:D

    mul-long v10, p10, v6

    iput-wide v10, v0, mRebindMaxBackoffMs:J

    mul-long v6, v6, p12

    iput-wide v6, v0, mResetBackoffDelay:J

    iget-wide v6, v0, mRebindBackoffMs:J

    iput-wide v6, v0, mNextBackoffMs:J
...
.method static synthetic access$1008(Lcom/android/server/am/PersistentConnection;)I
    ...
    iget v0, p0, mNumDisconnected:I

    add-int/lit8 v1, v0, 0x1

    iput v1, p0, mNumDisconnected:I
...
.method static synthetic access$1100(Lcom/android/server/am/PersistentConnection;)V
    ...
    invoke-direct {p0}, cleanUpConnectionLocked()V
...
.method static synthetic access$1208(Lcom/android/server/am/PersistentConnection;)I
    ...
    iget v0, p0, mNumBindingDied:I

    add-int/lit8 v1, v0, 0x1

    iput v1, p0, mNumBindingDied:I
...
.method static synthetic access$508(Lcom/android/server/am/PersistentConnection;)I
    ...
    iget v0, p0, mNumConnected:I

    add-int/lit8 v1, v0, 0x1

    iput v1, p0, mNumConnected:I
...
.method static synthetic access$702(Lcom/android/server/am/PersistentConnection;J)J
    ...
    iput-wide p1, p0, mLastConnectedTime:J
...
.method static synthetic access$802(Lcom/android/server/am/PersistentConnection;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iput-object p1, p0, mService:Ljava/lang/Object;
...
.method static synthetic access$900(Lcom/android/server/am/PersistentConnection;)V
    ...
    invoke-direct {p0}, scheduleStableCheckLocked()V
...
.method private cleanUpConnectionLocked()V
    ...
    iput-object v0, p0, mService:Ljava/lang/Object;

    invoke-direct {p0}, unscheduleStableCheckLocked()V
...
.method public static synthetic lambda$rkvbuN0FQdQUv1hqSwDvmwwh6Uk(Lcom/android/server/am/PersistentConnection;)V
    ...
    invoke-direct {p0}, stableConnectionCheck()V
...
.method private resetBackoffLocked()V
    ...
    iget-wide v0, p0, mNextBackoffMs:J

    iget-wide v2, p0, mRebindBackoffMs:J

    cmp-long v0, v0, v2

    if-eqz v0, :cond_0

    iput-wide v2, p0, mNextBackoffMs:J
    ...
    iget-wide v2, p0, mNextBackoffMs:J
...
.method private scheduleStableCheckLocked()V
    ...
    iget-object v0, p0, mStableCheck:Ljava/lang/Runnable;

    invoke-virtual {p0}, injectUptimeMillis()J

    move-result-wide v1

    iget-wide v3, p0, mResetBackoffDelay:J

    add-long/2addr v1, v3

    invoke-virtual {p0, v0, v1, v2}, injectPostAtTime(Ljava/lang/Runnable;J)V
...
.method private stableConnectionCheck()V
    ...
    iget-wide v3, p0, mLastConnectedTime:J

    iget-wide v5, p0, mResetBackoffDelay:J

    add-long/2addr v3, v5

    sub-long/2addr v3, v1

    iget-boolean v5, p0, mBound:Z

    if-eqz v5, :cond_0

    iget-boolean v5, p0, mIsConnected:Z
    ...
    invoke-direct {p0}, resetBackoffLocked()V
...
.method private final unbindLocked()V
    ...
    invoke-virtual {p0}, unscheduleRebindLocked()V
...
.method private unscheduleStableCheckLocked()V
    ...
    invoke-virtual {p0, v0}, injectRemoveCallbacks(Ljava/lang/Runnable;)V
...
.method public final bind()V
    ...
    :try_start_0
    iput-boolean v1, p0, mShouldBeBound:Z

    invoke-virtual {p0, v1}, bindInnerLocked(Z)V
...
.method final bindForBackoff()V
    ...
    :try_start_0
    iget-boolean v1, p0, mShouldBeBound:Z
...
.method public final bindInnerLocked(Z)V
    ...
    iget-object v5, p0, mServiceConnection:Landroid/content/ServiceConnection;

    invoke-virtual {p0}, getBindFlags()I
...
.method public dump(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    iget-boolean v1, p0, mIsConnected:Z
    ...
    iget-boolean v1, p0, mRebindScheduled:Z
    ...
    iget-wide v1, p0, mReconnectTime:J
    ...
    iget-wide v1, p0, mNextBackoffMs:J
...
.method getBindForBackoffRunnableForTest()Ljava/lang/Runnable;
    ...
    iget-object v0, p0, mBindForBackoffRunnable:Ljava/lang/Runnable;
...
.method getReconnectTimeForTest()J
    ...
    iget-wide v0, p0, mReconnectTime:J
...
.method public final getServiceBinder()Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v1, p0, mService:Ljava/lang/Object;
...
.method public synthetic lambda$new$0$PersistentConnection()V
    ...
    invoke-virtual {p0}, bindForBackoff()V
...
.method scheduleRebindLocked()V
    ...
    iget-boolean v0, p0, mRebindScheduled:Z
    ...
    iput-wide v0, p0, mReconnectTime:J
    ...
    iget-wide v0, p0, mRebindMaxBackoffMs:J

    iget-wide v2, p0, mNextBackoffMs:J

    long-to-double v2, v2

    iget-wide v4, p0, mRebindBackoffIncrease:D
    ...
    iput-wide v0, p0, mNextBackoffMs:J

    const/4 v0, 0x1

    iput-boolean v0, p0, mRebindScheduled:Z
...
.method shouldBeBoundForTest()Z
    ...
    iget-boolean v0, p0, mShouldBeBound:Z
