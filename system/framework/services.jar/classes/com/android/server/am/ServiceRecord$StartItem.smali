...
.method constructor <init>(Lcom/android/server/am/ServiceRecord;ZILandroid/content/Intent;Lcom/android/server/uri/NeededUriGrants;I)V
    ...
    iput-object p5, p0, neededGrants:Lcom/android/server/uri/NeededUriGrants;

    iput p6, p0, callingId:I
...
.method getUriPermissionsLocked()Lcom/android/server/uri/UriPermissionOwner;
    ...
    iget-object v0, p0, uriPermissions:Lcom/android/server/uri/UriPermissionOwner;
    ...
    iput-object v0, p0, uriPermissions:Lcom/android/server/uri/UriPermissionOwner;
...
.method public writeToProto(Landroid/util/proto/ProtoOutputStream;JJ)V
    ...
    iget-wide v4, v0, deliveredTime:J
    ...
    iget v1, v0, deliveryCount:I

    const-wide v2, 0x10500000003L

    invoke-virtual {p1, v2, v3, v1}, Landroid/util/proto/ProtoOutputStream;->write(JI)V

    iget v1, v0, doneExecutingCount:I
    ...
    :cond_0
    iget-object v1, v0, neededGrants:Lcom/android/server/uri/NeededUriGrants;
    ...
    :cond_1
    iget-object v1, v0, uriPermissions:Lcom/android/server/uri/UriPermissionOwner;
