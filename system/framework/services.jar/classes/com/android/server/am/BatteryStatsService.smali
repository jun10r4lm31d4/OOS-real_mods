...
.method constructor <init>(Landroid/content/Context;Ljava/io/File;Landroid/os/Handler;)V
    ...
    iput-object v0, p0, mDecoderStat:Ljava/nio/charset/CharsetDecoder;
    ...
    iput-object v1, p0, mUtf8BufferStat:Ljava/nio/ByteBuffer;

    invoke-static {v0}, Ljava/nio/CharBuffer;->allocate(I)Ljava/nio/CharBuffer;

    move-result-object v0

    iput-object v0, p0, mUtf16BufferStat:Ljava/nio/CharBuffer;

    const/4 v0, 0x0

    iput-boolean v0, p0, mNoAutoReset:Z
    ...
    iput-boolean v0, p0, mOpFeatrueCollectBatterystats:Z
    ...
    iput-object v0, p0, mUserManagerUserInfoProvider:Lcom/android/internal/os/BatteryStatsImpl$UserInfoProvider;

    new-instance v0, Lcom/android/internal/os/BatteryStatsImpl;

    iget-object v6, p0, mUserManagerUserInfoProvider:Lcom/android/internal/os/BatteryStatsImpl$UserInfoProvider;
    ...
    iput-object v0, p0, mWorker:Lcom/android/server/am/BatteryExternalStatsWorker;

    iget-object v0, p0, mStats:Lcom/android/internal/os/BatteryStatsImpl;

    iget-object v1, p0, mWorker:Lcom/android/server/am/BatteryExternalStatsWorker;
...
.method private doEnableOrDisable(Ljava/io/PrintWriter;I[Ljava/lang/String;Z)I
    ...
    iput-boolean p4, p0, mNoAutoReset:Z
...
.method public static getService()Lcom/android/internal/app/IBatteryStats;
    ...
    sget-object v0, sService:Lcom/android/internal/app/IBatteryStats;
...
.method private shouldCollectExternalStats()Z
    ...
    iget-object v2, p0, mWorker:Lcom/android/server/am/BatteryExternalStatsWorker;
...
.method private syncStats(Ljava/lang/String;I)V
    ...
    iget-object v0, p0, mWorker:Lcom/android/server/am/BatteryExternalStatsWorker;
    ...
    invoke-static {v0}, awaitUninterruptibly(Ljava/util/concurrent/Future;)V
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-direct {v1, v9}, dumpHelp(Ljava/io/PrintWriter;)V
    ...
    iget-object v14, v1, mStats:Lcom/android/internal/os/BatteryStatsImpl;
    ...
    iget-object v3, v1, mStats:Lcom/android/internal/os/BatteryStatsImpl;
    ...
    iget-object v0, v1, mWorker:Lcom/android/server/am/BatteryExternalStatsWorker;
    ...
    invoke-direct {v1, v0, v3}, syncStats(Ljava/lang/String;I)V
    ...
    invoke-direct {v1, v9}, dumpSettings(Ljava/io/PrintWriter;)V
    ...
    invoke-direct {v1, v9}, dumpCpuStats(Ljava/io/PrintWriter;)V
    ...
    invoke-direct {v1, v9, v14, v10, v0}, doEnableOrDisable(Ljava/io/PrintWriter;I[Ljava/lang/String;Z)I
    ...
    iget-object v7, v1, mUserManagerUserInfoProvider:Lcom/android/internal/os/BatteryStatsImpl$UserInfoProvider;
    ...
    iget-object v4, v1, mUserManagerUserInfoProvider:Lcom/android/internal/os/BatteryStatsImpl$UserInfoProvider;
    ...
    iget-object v2, v1, mStats:Lcom/android/internal/os/BatteryStatsImpl;
    ...
    iget-object v4, v1, mStats:Lcom/android/internal/os/BatteryStatsImpl;
...
.method public fillLowPowerStats(Lcom/android/internal/os/RpmStats;)V
    ...
    :try_start_0
    invoke-direct {p0, p1}, getLowPowerStats(Lcom/android/internal/os/RpmStats;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public fillRailDataStats(Lcom/android/internal/os/RailStats;)V
    ...
    :try_start_0
    invoke-direct {p0, p1}, getRailEnergyPowerStats(Lcom/android/internal/os/RailStats;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public getPlatformLowPowerStats()Ljava/lang/String;
    ...
    :try_start_0
    iget-object v0, p0, mUtf8BufferStat:Ljava/nio/ByteBuffer;

    invoke-virtual {v0}, Ljava/nio/ByteBuffer;->clear()Ljava/nio/Buffer;

    iget-object v0, p0, mUtf16BufferStat:Ljava/nio/CharBuffer;

    invoke-virtual {v0}, Ljava/nio/CharBuffer;->clear()Ljava/nio/Buffer;

    iget-object v0, p0, mDecoderStat:Ljava/nio/charset/CharsetDecoder;

    invoke-virtual {v0}, Ljava/nio/charset/CharsetDecoder;->reset()Ljava/nio/charset/CharsetDecoder;

    iget-object v0, p0, mUtf8BufferStat:Ljava/nio/ByteBuffer;

    invoke-direct {p0, v0}, getPlatformLowPowerStats(Ljava/nio/ByteBuffer;)I
    ...
    :cond_1
    iget-object v1, p0, mUtf8BufferStat:Ljava/nio/ByteBuffer;

    invoke-virtual {v1, v0}, Ljava/nio/ByteBuffer;->limit(I)Ljava/nio/Buffer;

    iget-object v1, p0, mDecoderStat:Ljava/nio/charset/CharsetDecoder;

    iget-object v2, p0, mUtf8BufferStat:Ljava/nio/ByteBuffer;

    iget-object v3, p0, mUtf16BufferStat:Ljava/nio/CharBuffer;
    ...
    iget-object v1, p0, mUtf16BufferStat:Ljava/nio/CharBuffer;
...
.method public getStatistics()[B
    ...
    invoke-direct {p0, v1, v2}, syncStats(Ljava/lang/String;I)V
...
.method public getStatisticsStream()Landroid/os/ParcelFileDescriptor;
    ...
    invoke-direct {p0, v2, v3}, syncStats(Ljava/lang/String;I)V
...
.method public getSubsystemLowPowerStats()Ljava/lang/String;
    ...
    invoke-direct {p0, v0}, getSubsystemLowPowerStats(Ljava/nio/ByteBuffer;)I
...
.method public synthetic lambda$setBatteryState$1$BatteryStatsService(IIIIIIII)V
    ...
    iget-object v1, v11, mStats:Lcom/android/internal/os/BatteryStatsImpl;
    ...
    iget-object v2, v11, mStats:Lcom/android/internal/os/BatteryStatsImpl;
    ...
    iget-object v12, v11, mStats:Lcom/android/internal/os/BatteryStatsImpl;
    ...
    iget-object v0, v11, mWorker:Lcom/android/server/am/BatteryExternalStatsWorker;
...
.method public noteStartAudio(I)V
    ...
    invoke-direct {p0, p1}, enforceSelfOrCallingPermission(I)V
...
.method public noteWifiRadioPowerState(IJI)V
    ...
    iget-object v3, p0, mWorker:Lcom/android/server/am/BatteryExternalStatsWorker;
...
.method public setBatteryState(IIIIIIII)V
    ...
    invoke-virtual/range {p0 .. p0}, enforceCallingPermission()V

    iget-boolean v0, v10, mOpFeatrueCollectBatterystats:Z

    if-eqz v0, :cond_0

    iget-object v0, v10, mStats:Lcom/android/internal/os/BatteryStatsImpl;

    iget-boolean v1, v10, mNoAutoReset:Z
    ...
    :goto_0
    iget-object v14, v10, mWorker:Lcom/android/server/am/BatteryExternalStatsWorker;
...
.method public shutdown()V
    ...
    invoke-direct {p0, v0, v1}, syncStats(Ljava/lang/String;I)V
...
.method public takeUidSnapshot(I)Landroid/os/health/HealthStatsParceler;
    ...
    :try_start_0
    invoke-direct {p0}, shouldCollectExternalStats()Z
    ...
    :try_start_1
    invoke-virtual {p0, p1}, getHealthStatsForUidLocked(I)Landroid/os/health/HealthStatsParceler;
...
.method public takeUidSnapshots([I)[Landroid/os/health/HealthStatsParceler;
    ...
    invoke-static {p1}, onlyCaller([I)Z
    ...
    invoke-direct {p0, v3, v4}, syncStats(Ljava/lang/String;I)V
    ...
    invoke-virtual {p0, v6}, getHealthStatsForUidLocked(I)Landroid/os/health/HealthStatsParceler;
