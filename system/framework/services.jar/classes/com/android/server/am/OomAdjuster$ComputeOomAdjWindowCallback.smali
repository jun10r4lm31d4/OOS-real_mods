...
.method synthetic constructor <init>(Lcom/android/server/am/OomAdjuster;Lcom/android/server/am/OomAdjuster$1;)V
    ...
    invoke-direct {p0, p1}, <init>(Lcom/android/server/am/OomAdjuster;)V
...
.method initialize(Lcom/android/server/am/ProcessRecord;IZIIIII)V
    ...
    iput-boolean p3, p0, foregroundActivities:Z

    iput p4, p0, procState:I

    iput p5, p0, schedGroup:I

    iput p6, p0, appUid:I

    iput p7, p0, logUid:I

    iput p8, p0, processStateCurTop:I
...
.method public onOtherActivity()V
    ...
    iget v0, p0, procState:I

    const/16 v1, 0x11

    if-le v0, v1, :cond_1

    iput v1, p0, procState:I
    ...
    :cond_0
    iget-object v0, p0, this$0:Lcom/android/server/am/OomAdjuster;
    ...
    iget-object v2, p0, app:Lcom/android/server/am/ProcessRecord;
...
.method public onPausedActivity()V
    ...
    iget-object v4, p0, app:Lcom/android/server/am/ProcessRecord;
    ...
    iget v3, p0, processStateCurTop:I

    if-le v0, v3, :cond_3

    iput v3, p0, procState:I
    ...
    iget-object v3, p0, app:Lcom/android/server/am/ProcessRecord;
    ...
    :cond_3
    iget v0, p0, schedGroup:I

    const/4 v1, 0x2

    if-ge v0, v1, :cond_4

    iput v1, p0, schedGroup:I
    ...
    iput-boolean v0, p0, foregroundActivities:Z
