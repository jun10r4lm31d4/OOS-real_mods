...
.method constructor <init>(Landroid/content/Context;Ljava/io/File;Ljava/security/SecureRandom;)V
    ...
    iput-object p2, p0, mBaseStateDir:Ljava/io/File;

    invoke-direct {p0}, loadStateFromFilesystem()V
...
.method private clearPassword()Z
    ...
    invoke-direct {p0}, getPasswordHashFile()Ljava/io/File;
    ...
    iput-object v1, p0, mPasswordHash:Ljava/lang/String;

    iput-object v1, p0, mPasswordSalt:[B
...
.method private loadStateFromFilesystem()V
    ...
    :try_start_0
    invoke-direct {p0}, getPasswordVersionFileCodec()Lcom/android/server/backup/utils/DataStreamFileCodec;
    ...
    iput v2, p0, mPasswordVersion:I

    :goto_0
    :try_start_1
    invoke-direct {p0}, getPasswordHashFileCodec()Lcom/android/server/backup/utils/DataStreamFileCodec;
...
.method private passwordMatchesSaved(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v0, p1}, passwordMatchesSaved(Ljava/lang/String;Ljava/lang/String;)Z

    move-result v0

    if-nez v0, :cond_1

    invoke-direct {p0}, usePbkdf2Fallback()Z
...
.method private passwordMatchesSaved(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :cond_3
    iget-object v0, p0, mPasswordSalt:[B
    ...
    iget-object v1, p0, mPasswordHash:Ljava/lang/String;
...
.method private randomSalt()[B
    ...
    iget-object v2, p0, mRng:Ljava/security/SecureRandom;
...
.method backupPasswordMatches(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1}, passwordMatchesSaved(Ljava/lang/String;)Z
...
.method setBackupPassword(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    iput-object v3, p0, mPasswordHash:Ljava/lang/String;
    ...
    :cond_2
    :goto_0
    invoke-direct {p0}, clearPassword()Z
