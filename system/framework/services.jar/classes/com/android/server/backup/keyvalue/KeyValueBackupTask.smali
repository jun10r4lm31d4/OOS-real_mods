...
.method static constructor <clinit>()V
    ...
    sput-object v0, THREAD_COUNT:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public constructor <init>(Lcom/android/server/backup/UserBackupManagerService;Lcom/android/server/backup/transport/TransportClient;Ljava/lang/String;Ljava/util/List;Lcom/android/server/backup/DataChangedJournal;Lcom/android/server/backup/keyvalue/KeyValueBackupReporter;Lcom/android/server/backup/internal/OnTaskFinishedListener;Ljava/util/List;ZZ)V
    ...
    iput-object v0, p0, mCancelAcknowledged:Landroid/os/ConditionVariable;

    iput-boolean v1, p0, mCancelled:Z

    iput-object p1, p0, mBackupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    iput-object v0, p0, mTransportManager:Lcom/android/server/backup/TransportManager;
    ...
    iput-object p2, p0, mTransportClient:Lcom/android/server/backup/transport/TransportClient;

    iput-object p4, p0, mOriginalQueue:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0, p4}, Ljava/util/ArrayList;-><init>(Ljava/util/Collection;)V

    iput-object v0, p0, mQueue:Ljava/util/List;

    iput-object p5, p0, mJournal:Lcom/android/server/backup/DataChangedJournal;

    iput-object p6, p0, mReporter:Lcom/android/server/backup/keyvalue/KeyValueBackupReporter;

    iput-object p7, p0, mTaskFinishedListener:Lcom/android/server/backup/internal/OnTaskFinishedListener;

    iput-object p8, p0, mPendingFullBackups:Ljava/util/List;

    iput-boolean p9, p0, mUserInitiated:Z

    iput-boolean p10, p0, mNonIncremental:Z
    ...
    iput-object v0, p0, mAgentTimeoutParameters:Lcom/android/server/backup/BackupAgentTimeoutParameters;
    ...
    iput-object v0, p0, mStateDirectory:Ljava/io/File;

    iget-object v0, p0, mBackupManagerService:Lcom/android/server/backup/UserBackupManagerService;

    invoke-virtual {v0}, Lcom/android/server/backup/UserBackupManagerService;->getDataDir()Ljava/io/File;

    move-result-object v0

    iput-object v0, p0, mDataDirectory:Ljava/io/File;

    invoke-virtual {p1}, Lcom/android/server/backup/UserBackupManagerService;->generateRandomIntegerToken()I

    move-result v0

    iput v0, p0, mCurrentOpToken:I
    ...
    iput-object v0, p0, mQueueLock:Ljava/lang/Object;

    new-instance v0, Ljava/io/File;

    iget-object v1, p0, mStateDirectory:Ljava/io/File;

    const-string v2, "blank_state"

    invoke-direct {v0, v1, v2}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    iput-object v0, p0, mBlankStateFile:Ljava/io/File;
...
.method private SHA1Checksum([B)Ljava/lang/String;
    ...
    iget-object v1, p0, mReporter:Lcom/android/server/backup/keyvalue/KeyValueBackupReporter;
...
.method private agentDoQuotaExceeded(Landroid/app/IBackupAgent;Ljava/lang/String;J)V
    ...
    iget-object v2, p0, mAgentTimeoutParameters:Lcom/android/server/backup/BackupAgentTimeoutParameters;
    ...
    invoke-direct {p0, v1, v2, v3, v4}, remoteCall(Lcom/android/server/backup/remote/RemoteCallable;JLjava/lang/String;)Lcom/android/server/backup/remote/RemoteResult;
    :try_end_0
...
.method private applyStateTransaction(I)V
    ...
    iget-object v0, p0, mSavedStateFile:Ljava/io/File;

    invoke-virtual {v0}, Ljava/io/File;->delete()Z

    iget-object v0, p0, mNewStateFile:Ljava/io/File;
    ...
    iget-object v1, p0, mSavedStateFile:Ljava/io/File;
...
.method private backupPackage(Ljava/lang/String;)V
    ...
    iget-object v0, p0, mReporter:Lcom/android/server/backup/keyvalue/KeyValueBackupReporter;

    invoke-virtual {v0, p1}, Lcom/android/server/backup/keyvalue/KeyValueBackupReporter;->onStartPackageBackup(Ljava/lang/String;)V

    invoke-direct {p0, p1}, getPackageForBackup(Ljava/lang/String;)Landroid/content/pm/PackageInfo;
    ...
    invoke-direct {p0, v0}, extractAgentData(Landroid/content/pm/PackageInfo;)V

    iget-object v0, p0, mCurrentPackage:Landroid/content/pm/PackageInfo;

    invoke-direct {p0, v0}, sendDataToTransport(Landroid/content/pm/PackageInfo;)I

    move-result v0

    invoke-direct {p0, v0}, cleanUpAgentForTransportStatus(I)V
    :try_end_0
    ...
    invoke-direct {p0, v0}, cleanUpAgentForError(Lcom/android/server/backup/keyvalue/BackupException;)V
...
.method private backupPm()V
    ...
    :try_start_0
    invoke-direct {p0, v0}, extractPmAgentData(Landroid/content/pm/PackageInfo;)V
...
.method private bindAgent(Landroid/content/pm/PackageInfo;)Landroid/app/IBackupAgent;
    ...
    :try_start_0
    iget-object v1, p0, mBackupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    :cond_0
    iget-object v2, p0, mReporter:Lcom/android/server/backup/keyvalue/KeyValueBackupReporter;
...
.method private checkBackupData(Landroid/content/pm/ApplicationInfo;Ljava/io/File;)V
    ...
    invoke-direct {p0, v1, v4}, agentFail(Landroid/app/IBackupAgent;Ljava/lang/String;)V
...
.method private cleanUpAgent(I)V
    ...
    invoke-direct {p0, p1}, applyStateTransaction(I)V

    iget-object v0, p0, mBackupDataFile:Ljava/io/File;
    ...
    :cond_0
    iget-object v0, p0, mBlankStateFile:Ljava/io/File;

    invoke-virtual {v0}, Ljava/io/File;->delete()Z

    const/4 v0, 0x0

    iput-object v0, p0, mSavedStateFile:Ljava/io/File;

    iput-object v0, p0, mBackupDataFile:Ljava/io/File;

    iput-object v0, p0, mNewStateFile:Ljava/io/File;

    iget-object v1, p0, mSavedState:Landroid/os/ParcelFileDescriptor;

    const-string/jumbo v2, "old state"

    invoke-direct {p0, v1, v2}, tryCloseFileDescriptor(Ljava/io/Closeable;Ljava/lang/String;)V

    iget-object v1, p0, mBackupData:Landroid/os/ParcelFileDescriptor;

    const-string v2, "backup data"

    invoke-direct {p0, v1, v2}, tryCloseFileDescriptor(Ljava/io/Closeable;Ljava/lang/String;)V

    iget-object v1, p0, mNewState:Landroid/os/ParcelFileDescriptor;
...
.method private cleanUpAgentForError(Lcom/android/server/backup/keyvalue/BackupException;)V
    ...
    invoke-direct {p0, v0}, cleanUpAgent(I)V
...
.method private createFullBackupTask(Ljava/util/List;)Lcom/android/server/backup/fullbackup/PerformFullTransportBackupTask;
    ...
    iget-object v2, p0, mTransportClient:Lcom/android/server/backup/transport/TransportClient;
    ...
    iget-object v10, p0, mTaskFinishedListener:Lcom/android/server/backup/internal/OnTaskFinishedListener;

    iget-boolean v11, p0, mUserInitiated:Z
...
.method private extractAgentData(Landroid/content/pm/PackageInfo;)V
    ...
    :try_start_0
    invoke-direct {p0, p1}, bindAgent(Landroid/content/pm/PackageInfo;)Landroid/app/IBackupAgent;
    ...
    invoke-direct {p0, p1, v1}, extractAgentData(Landroid/content/pm/PackageInfo;Landroid/app/IBackupAgent;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget-object v2, p0, mBackupManagerService:Lcom/android/server/backup/UserBackupManagerService;
...
.method private extractAgentData(Landroid/content/pm/PackageInfo;Landroid/app/IBackupAgent;)V
    ...
    iget-object v2, p0, mStateDirectory:Ljava/io/File;

    invoke-direct {v1, v2, v0}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    iput-object v1, p0, mSavedStateFile:Ljava/io/File;

    new-instance v1, Ljava/io/File;

    iget-object v2, p0, mDataDirectory:Ljava/io/File;
    ...
    iput-object v1, p0, mBackupDataFile:Ljava/io/File;
    ...
    iput-object v1, p0, mNewStateFile:Ljava/io/File;

    iget-object v1, p0, mReporter:Lcom/android/server/backup/keyvalue/KeyValueBackupReporter;

    iget-object v2, p0, mBackupDataFile:Ljava/io/File;
    ...
    :try_start_0
    iget-boolean v2, p0, mNonIncremental:Z

    if-eqz v2, :cond_0

    iget-object v2, p0, mBlankStateFile:Ljava/io/File;

    goto :goto_0

    :cond_0
    iget-object v2, p0, mSavedStateFile:Ljava/io/File;
    ...
    iput-object v3, p0, mSavedState:Landroid/os/ParcelFileDescriptor;

    iget-object v3, p0, mBackupDataFile:Ljava/io/File;
    ...
    iput-object v3, p0, mBackupData:Landroid/os/ParcelFileDescriptor;

    iget-object v3, p0, mNewStateFile:Ljava/io/File;

    invoke-static {v3, v4}, Landroid/os/ParcelFileDescriptor;->open(Ljava/io/File;I)Landroid/os/ParcelFileDescriptor;

    move-result-object v3

    iput-object v3, p0, mNewState:Landroid/os/ParcelFileDescriptor;
    ...
    iget-object v3, p0, mReporter:Lcom/android/server/backup/keyvalue/KeyValueBackupReporter;

    iget-object v4, p0, mBackupDataFile:Ljava/io/File;

    invoke-virtual {v3, v4}, Lcom/android/server/backup/keyvalue/KeyValueBackupReporter;->onRestoreconFailed(Ljava/io/File;)V

    :cond_1
    iget-object v3, p0, mTransportClient:Lcom/android/server/backup/transport/TransportClient;
    ...
    iget-object v5, p0, mAgentTimeoutParameters:Lcom/android/server/backup/BackupAgentTimeoutParameters;
    ...
    invoke-direct {p0, v4, v5, v6, v7}, remoteCall(Lcom/android/server/backup/remote/RemoteCallable;JLjava/lang/String;)Lcom/android/server/backup/remote/RemoteResult;
    ...
    invoke-direct {p0, p1, v2}, checkAgentResult(Landroid/content/pm/PackageInfo;Lcom/android/server/backup/remote/RemoteResult;)V
...
.method private finishTask(I)V
    ...
    iget-object v0, p0, mQueue:Ljava/util/List;
    ...
    iget-object v1, p0, mJournal:Lcom/android/server/backup/DataChangedJournal;
    ...
    iget-boolean v3, p0, mHasDataToBackup:Z
    ...
    iget-object v4, p0, mBackupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    iget-object v4, p0, mReporter:Lcom/android/server/backup/keyvalue/KeyValueBackupReporter;
    ...
    :try_start_2
    invoke-direct {p0}, triggerTransportInitializationLocked()V
    :try_end_2
    ...
    :try_start_3
    iget-object v5, p0, mReporter:Lcom/android/server/backup/keyvalue/KeyValueBackupReporter;
    ...
    invoke-direct {p0}, unregisterTask()V

    iget-object v3, p0, mReporter:Lcom/android/server/backup/keyvalue/KeyValueBackupReporter;

    invoke-virtual {v3}, Lcom/android/server/backup/keyvalue/KeyValueBackupReporter;->onTaskFinished()V

    iget-boolean v3, p0, mCancelled:Z

    if-eqz v3, :cond_4

    iget-object v3, p0, mCancelAcknowledged:Landroid/os/ConditionVariable;
    ...
    iget-object v3, p0, mFullBackupTask:Lcom/android/server/backup/fullbackup/PerformFullTransportBackupTask;

    if-eqz v3, :cond_5

    iget-object v3, p0, mPendingFullBackups:Ljava/util/List;
    ...
    iget-object v4, p0, mPendingFullBackups:Ljava/util/List;
    ...
    iget-object v4, p0, mFullBackupTask:Lcom/android/server/backup/fullbackup/PerformFullTransportBackupTask;
    ...
    :cond_6
    iget-object v3, p0, mTaskFinishedListener:Lcom/android/server/backup/internal/OnTaskFinishedListener;

    invoke-interface {v3, v0}, Lcom/android/server/backup/internal/OnTaskFinishedListener;->onFinished(Ljava/lang/String;)V

    iget-object v3, p0, mReporter:Lcom/android/server/backup/keyvalue/KeyValueBackupReporter;

    iget-boolean v4, p0, mCancelled:Z

    invoke-direct {p0, v4, p1}, getBackupFinishedStatus(ZI)I

    move-result v4

    invoke-virtual {v3, v4}, Lcom/android/server/backup/keyvalue/KeyValueBackupReporter;->onBackupFinished(I)V

    iget-object v3, p0, mBackupManagerService:Lcom/android/server/backup/UserBackupManagerService;
...
.method private handleTransportStatus(ILjava/lang/String;J)V
    ...
    invoke-direct {p0, v0, p2, p3, p4}, agentDoQuotaExceeded(Landroid/app/IBackupAgent;Ljava/lang/String;J)V
...
.method private remoteCall(Lcom/android/server/backup/remote/RemoteCallable;JLjava/lang/String;)Lcom/android/server/backup/remote/RemoteResult;
    ...
    iget-boolean v1, p0, mCancelled:Z
    ...
    iput-object v0, p0, mPendingCall:Lcom/android/server/backup/remote/RemoteCall;

    iget-object v0, p0, mPendingCall:Lcom/android/server/backup/remote/RemoteCall;
    ...
    iput-object v1, p0, mPendingCall:Lcom/android/server/backup/remote/RemoteCall;
...
.method private revertTask()V
    ...
    iget-object v2, p0, mOriginalQueue:Ljava/util/List;
...
.method private sendDataToTransport()I
    ...
    invoke-direct {p0, v0, v3}, checkBackupData(Landroid/content/pm/ApplicationInfo;Ljava/io/File;)V

    iget-object v0, p0, mCurrentPackage:Landroid/content/pm/PackageInfo;

    iget-object v0, v0, Landroid/content/pm/PackageInfo;->packageName:Ljava/lang/String;

    iget-object v3, p0, mBackupData:Landroid/os/ParcelFileDescriptor;

    invoke-virtual {v3}, Landroid/os/ParcelFileDescriptor;->getFileDescriptor()Ljava/io/FileDescriptor;

    move-result-object v3

    invoke-direct {p0, v3, v0}, writeWidgetPayloadIfAppropriate(Ljava/io/FileDescriptor;Ljava/lang/String;)V

    iget-object v3, p0, mSavedStateFile:Ljava/io/File;
    ...
    invoke-direct {p0, v2, v3, v1}, transportPerformBackup(Landroid/content/pm/PackageInfo;Ljava/io/File;Z)I
    ...
    invoke-direct {p0, v2, v0, v3, v4}, handleTransportStatus(ILjava/lang/String;J)V
...
.method private sendDataToTransport(Landroid/content/pm/PackageInfo;)I
    ...
    :try_start_0
    invoke-direct {p0}, sendDataToTransport()I
...
.method public static start(Lcom/android/server/backup/UserBackupManagerService;Lcom/android/server/backup/transport/TransportClient;Ljava/lang/String;Ljava/util/List;Lcom/android/server/backup/DataChangedJournal;Landroid/app/backup/IBackupObserver;Landroid/app/backup/IBackupManagerMonitor;Lcom/android/server/backup/internal/OnTaskFinishedListener;Ljava/util/List;ZZ)Lcom/android/server/backup/keyvalue/KeyValueBackupTask;
    ...
    invoke-direct/range {v0 .. v10}, <init>(Lcom/android/server/backup/UserBackupManagerService;Lcom/android/server/backup/transport/TransportClient;Ljava/lang/String;Ljava/util/List;Lcom/android/server/backup/DataChangedJournal;Lcom/android/server/backup/keyvalue/KeyValueBackupReporter;Lcom/android/server/backup/internal/OnTaskFinishedListener;Ljava/util/List;ZZ)V
    ...
    sget-object v3, THREAD_COUNT:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method private startTask()V
    ...
    iget-object v0, p0, mPendingFullBackups:Ljava/util/List;

    invoke-direct {p0, v0}, createFullBackupTask(Ljava/util/List;)Lcom/android/server/backup/fullbackup/PerformFullTransportBackupTask;

    move-result-object v0

    iput-object v0, p0, mFullBackupTask:Lcom/android/server/backup/fullbackup/PerformFullTransportBackupTask;

    invoke-direct {p0}, registerTask()V
    ...
    iget-boolean v0, p0, mNonIncremental:Z
    ...
    iget-object v3, p0, mQueue:Ljava/util/List;
    ...
    iget-object v3, p0, mStateDirectory:Ljava/io/File;
    ...
    iget-object v5, p0, mStateDirectory:Ljava/io/File;
...
.method private transportPerformBackup(Landroid/content/pm/PackageInfo;Ljava/io/File;Z)I
    ...
    iput-boolean v3, p0, mHasDataToBackup:Z
    ...
    :try_start_1
    iget-object v5, p0, mTransportClient:Lcom/android/server/backup/transport/TransportClient;
    ...
    iget-object v6, p0, mReporter:Lcom/android/server/backup/keyvalue/KeyValueBackupReporter;
    ...
    iget-boolean v6, p0, mUserInitiated:Z

    invoke-direct {p0, v6, p3}, getPerformBackupFlags(ZZ)I
...
.method private triggerTransportInitializationLocked()V
    ...
    invoke-direct {p0}, deletePmStateFile()V
...
.method private writeWidgetPayloadIfAppropriate(Ljava/io/FileDescriptor;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0}, SHA1Checksum([B)Ljava/lang/String;
    ...
    :try_start_2
    invoke-static {v4, v6}, $closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_2

    invoke-static {v4, v5}, $closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    ...
    invoke-static {v4, v7}, $closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
...
.method public handleCancel(Z)V
    ...
    invoke-virtual {p0}, markCancel()V

    invoke-virtual {p0}, waitCancel()V
...
.method public run()V
    ...
    iput-boolean v0, p0, mHasDataToBackup:Z

    const/4 v1, 0x0

    :try_start_0
    invoke-direct {p0}, startTask()V

    :goto_0
    iget-object v2, p0, mQueue:Ljava/util/List;
    ...
    iget-boolean v2, p0, mCancelled:Z
    ...
    invoke-direct {p0}, backupPm()V

    goto :goto_1

    :cond_0
    invoke-direct {p0, v2}, backupPackage(Ljava/lang/String;)V
    :try_end_1
    ...
    :goto_3
    invoke-direct {p0, v1}, finishTask(I)V
...
.method public waitCancel()V
    ...
    iget-object v0, p0, mCancelAcknowledged:Landroid/os/ConditionVariable;
