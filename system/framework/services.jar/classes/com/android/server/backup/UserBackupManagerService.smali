...
.method private constructor <init>(ILandroid/content/Context;Lcom/android/server/backup/Trampoline;Landroid/os/HandlerThread;Ljava/io/File;Ljava/io/File;Lcom/android/server/backup/TransportManager;)V
    ...
    iput-object v0, v1, mPendingInits:Landroid/util/ArraySet;
    ...
    iput-object v0, v1, mAdbBackupRestoreConfirmations:Landroid/util/SparseArray;
    ...
    iput-object v0, v1, mPendingRestores:Ljava/util/Queue;
    ...
    iput-object v0, v1, mNextToken:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iput-wide v3, v1, mAncestralToken:J

    iput-wide v3, v1, mCurrentToken:J
    ...
    iput-object v3, v1, mFullBackupScheduleWriter:Ljava/lang/Runnable;
    ...
    iput-object v3, v1, mBroadcastReceiver:Landroid/content/BroadcastReceiver;

    iput v2, v1, mUserId:I
    ...
    iput-object v3, v1, mContext:Landroid/content/Context;

    invoke-virtual/range {p2 .. p2}, Landroid/content/Context;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object v3

    iput-object v3, v1, mPackageManager:Landroid/content/pm/PackageManager;

    invoke-static {}, Landroid/app/AppGlobals;->getPackageManager()Landroid/content/pm/IPackageManager;

    move-result-object v3

    iput-object v3, v1, mPackageManagerBinder:Landroid/content/pm/IPackageManager;

    invoke-static {}, Landroid/app/ActivityManager;->getService()Landroid/app/IActivityManager;

    move-result-object v3

    iput-object v3, v1, mActivityManager:Landroid/app/IActivityManager;
    ...
    iput-object v3, v1, mActivityManagerInternal:Landroid/app/ActivityManagerInternal;
    ...
    iput-object v3, v1, mAlarmManager:Landroid/app/AlarmManager;
    ...
    iput-object v3, v1, mPowerManager:Landroid/os/PowerManager;
    ...
    iput-object v3, v1, mStorageManager:Landroid/os/storage/IStorageManager;
    ...
    iput-object v3, v1, mBackupManagerBinder:Landroid/app/backup/IBackupManager;
    ...
    iput-object v3, v1, mAgentTimeoutParameters:Lcom/android/server/backup/BackupAgentTimeoutParameters;

    iget-object v3, v1, mAgentTimeoutParameters:Lcom/android/server/backup/BackupAgentTimeoutParameters;
    ...
    iput-object v12, v1, mUserBackupThread:Landroid/os/HandlerThread;
    ...
    iput-object v3, v1, mBackupHandler:Lcom/android/server/backup/internal/BackupHandler;

    invoke-virtual/range {p2 .. p2}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v14

    invoke-static {v11, v2}, getSetupCompleteSettingForUser(Landroid/content/Context;I)Z

    move-result v3

    iput-boolean v3, v1, mSetupComplete:Z
    ...
    :goto_0
    iput-boolean v3, v1, mAutoRestore:Z

    new-instance v3, Lcom/android/server/backup/internal/SetupObserver;

    iget-object v4, v1, mBackupHandler:Lcom/android/server/backup/internal/BackupHandler;
    ...
    iput-object v3, v1, mBaseStateDir:Ljava/io/File;

    if-nez v2, :cond_1

    iget-object v3, v1, mBaseStateDir:Ljava/io/File;
    ...
    iget-object v4, v1, mBaseStateDir:Ljava/io/File;
    ...
    iput-object v3, v1, mDataDir:Ljava/io/File;

    new-instance v3, Lcom/android/server/backup/BackupPasswordManager;

    iget-object v4, v1, mContext:Landroid/content/Context;

    iget-object v5, v1, mBaseStateDir:Ljava/io/File;

    iget-object v6, v1, mRng:Ljava/security/SecureRandom;
    ...
    iput-object v3, v1, mBackupPasswordManager:Lcom/android/server/backup/BackupPasswordManager;
    ...
    iput-object v8, v1, mRunBackupIntent:Landroid/app/PendingIntent;
    ...
    iput-object v7, v1, mRunInitIntent:Landroid/app/PendingIntent;

    new-instance v7, Ljava/io/File;

    iget-object v9, v1, mBaseStateDir:Ljava/io/File;

    const-string/jumbo v10, "pending"

    invoke-direct {v7, v9, v10}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    iput-object v7, v1, mJournalDir:Ljava/io/File;

    iget-object v7, v1, mJournalDir:Ljava/io/File;

    invoke-virtual {v7}, Ljava/io/File;->mkdirs()Z

    iput-object v0, v1, mJournal:Lcom/android/server/backup/DataChangedJournal;

    new-instance v7, Lcom/android/server/backup/BackupManagerConstants;

    iget-object v9, v1, mBackupHandler:Lcom/android/server/backup/internal/BackupHandler;
    ...
    iput-object v7, v1, mConstants:Lcom/android/server/backup/BackupManagerConstants;

    iget-object v7, v1, mConstants:Lcom/android/server/backup/BackupManagerConstants;

    invoke-virtual {v7}, Lcom/android/server/backup/BackupManagerConstants;->start()V

    iget-object v7, v1, mBackupParticipants:Landroid/util/SparseArray;

    monitor-enter v7

    :try_start_0
    invoke-direct {v1, v0}, addPackageParticipantsLocked([Ljava/lang/String;)V
    ...
    iput-object v0, v1, mTransportManager:Lcom/android/server/backup/TransportManager;

    iget-object v0, v1, mTransportManager:Lcom/android/server/backup/TransportManager;
    ...
    iput-wide v3, v1, mRegisterTransportsRequestedTime:J

    iget-object v0, v1, mBackupHandler:Lcom/android/server/backup/internal/BackupHandler;

    iget-object v3, v1, mTransportManager:Lcom/android/server/backup/TransportManager;
    ...
    iget-object v0, v1, mPowerManager:Landroid/os/PowerManager;
...
.method static synthetic access$100(Lcom/android/server/backup/UserBackupManagerService;)Ljava/util/ArrayList;
    ...
    iget-object v0, p0, mFullBackupQueue:Ljava/util/ArrayList;
...
.method static synthetic access$1100(Lcom/android/server/backup/UserBackupManagerService;)Lcom/android/server/backup/TransportManager;
    ...
    iget-object v0, p0, mTransportManager:Lcom/android/server/backup/TransportManager;
...
.method static synthetic access$1200(Lcom/android/server/backup/UserBackupManagerService;)Lcom/android/server/backup/fullbackup/PerformFullTransportBackupTask;
    ...
    iget-object v0, p0, mRunningFullBackupTask:Lcom/android/server/backup/fullbackup/PerformFullTransportBackupTask;
...
.method static synthetic access$200(Lcom/android/server/backup/UserBackupManagerService;)Ljava/io/File;
    ...
    iget-object v0, p0, mFullBackupScheduleFile:Ljava/io/File;
...
.method static synthetic access$300(Lcom/android/server/backup/UserBackupManagerService;)Lcom/android/server/backup/internal/BackupHandler;
    ...
    iget-object v0, p0, mBackupHandler:Lcom/android/server/backup/internal/BackupHandler;
...
.method static synthetic access$400(Lcom/android/server/backup/UserBackupManagerService;)Landroid/util/SparseArray;
    ...
    iget-object v0, p0, mBackupParticipants:Landroid/util/SparseArray;
...
.method static synthetic access$500(Lcom/android/server/backup/UserBackupManagerService;[Ljava/lang/String;I)V
    ...
    invoke-direct {p0, p1, p2}, removePackageParticipantsLocked([Ljava/lang/String;I)V
...
.method static synthetic access$600(Lcom/android/server/backup/UserBackupManagerService;[Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, addPackageParticipantsLocked([Ljava/lang/String;)V
...
.method static synthetic access$900(Lcom/android/server/backup/UserBackupManagerService;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, dequeueFullBackupLocked(Ljava/lang/String;)V
...
.method private addPackageParticipantsLocked([Ljava/lang/String;)V
    ...
    invoke-direct {p0}, allAgentPackages()Ljava/util/List;
    ...
    invoke-direct {p0, v3, v0}, addPackageParticipantsLockedInner(Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-direct {p0, v1, v0}, addPackageParticipantsLockedInner(Ljava/lang/String;Ljava/util/List;)V
...
.method private addPackageParticipantsLockedInner(Ljava/lang/String;Ljava/util/List;)V
    ...
    iget-object v3, p0, mBackupParticipants:Landroid/util/SparseArray;
    ...
    iget-object v4, p0, mBackupHandler:Lcom/android/server/backup/internal/BackupHandler;
    ...
    iget-object v5, p0, mBackupHandler:Lcom/android/server/backup/internal/BackupHandler;
...
.method private clearApplicationDataSynchronous(Ljava/lang/String;ZZ)V
    ...
    iget-object v3, p0, mClearDataLock:Ljava/lang/Object;

    monitor-enter v3

    :try_start_1
    iput-boolean v1, p0, mClearingData:Z
    :try_end_1
    ...
    :goto_3
    iget-boolean v1, p0, mClearingData:Z
    ...
    :try_start_4
    iget-object v1, p0, mClearDataLock:Ljava/lang/Object;
    ...
    :try_start_5
    iput-boolean v2, p0, mClearingData:Z
...
.method public static createAndInitializeService(ILandroid/content/Context;Lcom/android/server/backup/Trampoline;Landroid/os/HandlerThread;Ljava/io/File;Ljava/io/File;Lcom/android/server/backup/TransportManager;)Lcom/android/server/backup/UserBackupManagerService;
    ...
    invoke-direct/range {v0 .. v7}, <init>(ILandroid/content/Context;Lcom/android/server/backup/Trampoline;Landroid/os/HandlerThread;Ljava/io/File;Ljava/io/File;Lcom/android/server/backup/TransportManager;)V
...
.method static createAndInitializeService(ILandroid/content/Context;Lcom/android/server/backup/Trampoline;Ljava/util/Set;)Lcom/android/server/backup/UserBackupManagerService;
    ...
    invoke-static/range {v3 .. v9}, createAndInitializeService(ILandroid/content/Context;Lcom/android/server/backup/Trampoline;Landroid/os/HandlerThread;Ljava/io/File;Ljava/io/File;Lcom/android/server/backup/TransportManager;)Lcom/android/server/backup/UserBackupManagerService;
...
.method private dataChangedImpl(Ljava/lang/String;Ljava/util/HashSet;)V
    ...
    iget-object v2, p0, mPendingBackups:Ljava/util/HashMap;
    ...
    iget-object v2, p0, mConstants:Lcom/android/server/backup/BackupManagerConstants;
...
.method private dataChangedTargets(Ljava/lang/String;)Ljava/util/HashSet;
    ...
    :try_start_0
    iget-object v1, p0, mBackupParticipants:Landroid/util/SparseArray;
...
.method private dequeueFullBackupLocked(Ljava/lang/String;)V
    ...
    iget-object v2, p0, mFullBackupQueue:Ljava/util/ArrayList;
...
.method private dumpInternal(Ljava/io/PrintWriter;)V
    ...
    iget-boolean v2, p0, mSetupComplete:Z
    ...
    iget-object v2, p0, mPendingInits:Landroid/util/ArraySet;
    ...
    iget-boolean v2, p0, mAutoRestore:Z
    ...
    :cond_4
    invoke-virtual {p0}, isBackupOperationInProgress()Z
    ...
    iget-wide v2, p0, mLastBackupPass:J
    ...
    iget-object v1, p0, mTransportManager:Lcom/android/server/backup/TransportManager;
    ...
    invoke-virtual {p0}, listAllTransports()[Ljava/lang/String;
    ...
    iget-object v7, p0, mTransportManager:Lcom/android/server/backup/TransportManager;
    ...
    iget-object v7, p0, mBaseStateDir:Ljava/io/File;

    iget-object v8, p0, mTransportManager:Lcom/android/server/backup/TransportManager;
    ...
    :cond_9
    iget-object v2, p0, mTransportManager:Lcom/android/server/backup/TransportManager;
    ...
    iget-object v3, p0, mPendingInits:Landroid/util/ArraySet;
    ...
    iget-wide v2, p0, mAncestralToken:J
    ...
    iget-wide v2, p0, mCurrentToken:J
    ...
    iget-object v2, p0, mBackupParticipants:Landroid/util/SparseArray;
    ...
    iget-object v3, p0, mAncestralPackages:Ljava/util/Set;
    ...
    :cond_e
    iget-object v3, p0, mProcessedPackagesJournal:Lcom/android/server/backup/ProcessedPackagesJournal;
    ...
    iget-object v5, p0, mPendingBackups:Ljava/util/HashMap;
    ...
    iget-object v4, p0, mPendingBackups:Ljava/util/HashMap;
    ...
    iget-object v5, p0, mFullBackupQueue:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, mFullBackupQueue:Ljava/util/ArrayList;
...
.method private getAncestralSerialNumberFile()Ljava/io/RandomAccessFile;
    ...
    iget-object v0, p0, mAncestralSerialNumberFile:Ljava/io/File;
    ...
    iput-object v0, p0, mAncestralSerialNumberFile:Ljava/io/File;
    ...
    iget-object v1, p0, mAncestralSerialNumberFile:Ljava/io/File;
...
.method private initPackageTracking()V
    ...
    iget-object v1, p0, mBaseStateDir:Ljava/io/File;

    const-string v2, "ancestral"

    invoke-direct {v0, v1, v2}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    iput-object v0, p0, mTokenFile:Ljava/io/File;
    ...
    iget-object v3, p0, mTokenFile:Ljava/io/File;
    ...
    iput-wide v3, p0, mAncestralToken:J

    invoke-virtual {v0}, Ljava/io/DataInputStream;->readLong()J

    move-result-wide v3

    iput-wide v3, p0, mCurrentToken:J
    ...
    iput-object v4, p0, mAncestralPackages:Ljava/util/Set;
    ...
    iput-object v0, p0, mProcessedPackagesJournal:Lcom/android/server/backup/ProcessedPackagesJournal;

    iget-object v0, p0, mProcessedPackagesJournal:Lcom/android/server/backup/ProcessedPackagesJournal;
    ...
    :try_start_5
    invoke-direct {p0}, readFullBackupSchedule()Ljava/util/ArrayList;

    move-result-object v1

    iput-object v1, p0, mFullBackupQueue:Ljava/util/ArrayList;
...
.method public static synthetic lambda$9cuIH_XloqtNByp_6hXeGaVars8(Lcom/android/server/backup/UserBackupManagerService;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2}, onTransportRegistered(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static synthetic lambda$_gNqJq9Ygtc0ZVwYhCSDKCUKrKY(Lcom/android/server/backup/UserBackupManagerService;)V
    ...
    invoke-direct {p0}, parseLeftoverJournals()V
...
.method private onTransportRegistered(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-wide v2, p0, mRegisterTransportsRequestedTime:J
...
.method private parseLeftoverJournals()V
    ...
    iget-object v0, p0, mJournalDir:Ljava/io/File;
    ...
    iget-object v3, p0, mJournal:Lcom/android/server/backup/DataChangedJournal;
...
.method private readFullBackupSchedule()Ljava/util/ArrayList;
    ...
    iget-object v0, v1, mFullBackupScheduleFile:Ljava/io/File;
    ...
    iget-object v9, v1, mFullBackupScheduleFile:Ljava/io/File;
    ...
    :try_start_5
    invoke-static {v13, v11}, $closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_5
    .catchall {:try_start_5 .. :try_end_5} :catchall_1

    :try_start_6
    invoke-static {v13, v10}, $closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_6
    .catchall {:try_start_6 .. :try_end_6} :catchall_0

    :try_start_7
    invoke-static {v13, v9}, $closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_7
    ...
    :try_start_12
    invoke-static {v2, v11}, $closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_12
    .catchall {:try_start_12 .. :try_end_12} :catchall_8

    :try_start_13
    invoke-static {v2, v10}, $closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_13
    ...
    :try_start_14
    invoke-static {v2, v7}, $closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_14
    ...
    iget-object v2, v1, mFullBackupScheduleFile:Ljava/io/File;
...
.method private removePackageParticipantsLocked([Ljava/lang/String;I)V
    ...
    invoke-direct {p0, v3, v2}, removePackageFromSetLocked(Ljava/util/HashSet;Ljava/lang/String;)V
...
.method private startConfirmationTimeout(ILcom/android/server/backup/params/AdbParams;)V
    ...
    iget-object v1, p0, mBackupHandler:Lcom/android/server/backup/internal/BackupHandler;
...
.method private updateStateForTransport(Ljava/lang/String;)V
    ...
    iput-wide v7, p0, mCurrentToken:J
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iput-wide v2, p0, mCurrentToken:J
...
.method private writeToJournalLocked(Ljava/lang/String;)V
    ...
    :try_start_0
    iget-object v0, p0, mJournal:Lcom/android/server/backup/DataChangedJournal;
    ...
    iput-object v0, p0, mJournal:Lcom/android/server/backup/DataChangedJournal;
    ...
    iput-object v1, p0, mJournal:Lcom/android/server/backup/DataChangedJournal;
...
.method public acknowledgeAdbBackupOrRestore(IZLjava/lang/String;Ljava/lang/String;Landroid/app/backup/IFullBackupRestoreObserver;)V
    ...
    :try_start_0
    iget-object v2, p0, mAdbBackupRestoreConfirmations:Landroid/util/SparseArray;
    ...
    :try_start_1
    iget-object v3, p0, mAdbBackupRestoreConfirmations:Landroid/util/SparseArray;
    ...
    iget-object v4, p0, mAdbBackupRestoreConfirmations:Landroid/util/SparseArray;
    ...
    iget-object v6, p0, mBackupHandler:Lcom/android/server/backup/internal/BackupHandler;
    ...
    invoke-virtual {p0, v3}, signalAdbBackupRestoreCompletion(Lcom/android/server/backup/params/AdbParams;)V
...
.method public adbBackup(Landroid/os/ParcelFileDescriptor;ZZZZZZZZ[Ljava/lang/String;)V
    ...
    :try_start_0
    iget-boolean v0, v1, mSetupComplete:Z
    ...
    invoke-virtual/range {p0 .. p0}, generateRandomIntegerToken()I

    move-result v0

    move v3, v0

    iget-object v4, v1, mAdbBackupRestoreConfirmations:Landroid/util/SparseArray;
    ...
    :try_start_3
    iget-object v0, v1, mAdbBackupRestoreConfirmations:Landroid/util/SparseArray;
    ...
    invoke-direct {v1, v3, v0}, startConfirmationUi(ILjava/lang/String;)Z
    ...
    invoke-direct {v1, v3, v2}, startConfirmationTimeout(ILcom/android/server/backup/params/AdbParams;)V
    ...
    invoke-direct {v1, v2}, waitForCompletion(Lcom/android/server/backup/params/AdbParams;)V
    :try_end_6
...
.method public adbRestore(Landroid/os/ParcelFileDescriptor;)V
    ...
    :try_start_0
    iget-boolean v3, p0, mSetupComplete:Z
    ...
    invoke-virtual {p0}, generateRandomIntegerToken()I

    move-result v4

    iget-object v5, p0, mAdbBackupRestoreConfirmations:Landroid/util/SparseArray;
    ...
    :try_start_3
    iget-object v6, p0, mAdbBackupRestoreConfirmations:Landroid/util/SparseArray;
    ...
    invoke-direct {p0, v4, v5}, startConfirmationUi(ILjava/lang/String;)Z
    ...
    invoke-direct {p0, v4, v3}, startConfirmationTimeout(ILcom/android/server/backup/params/AdbParams;)V
    ...
    invoke-direct {p0, v3}, waitForCompletion(Lcom/android/server/backup/params/AdbParams;)V
    :try_end_6
    .catchall {:try_start_6 .. :try_end_6} :catchall_1
...
.method public agentConnected(Ljava/lang/String;Landroid/os/IBinder;)V
    ...
    iput-object v1, p0, mConnectedAgent:Landroid/app/IBackupAgent;
...
.method public backupNow()V
    ...
    iget-object v5, p0, mConstants:Lcom/android/server/backup/BackupManagerConstants;
    ...
    :try_start_1
    iget-object v4, p0, mRunBackupIntent:Landroid/app/PendingIntent;
...
.method public backupPasswordMatches(Ljava/lang/String;)Z
    ...
    iget-object v0, p0, mBackupPasswordManager:Lcom/android/server/backup/BackupPasswordManager;
...
.method public beginFullBackup(Lcom/android/server/backup/FullBackupJob;)Z
    ...
    iget-object v1, v11, mConstants:Lcom/android/server/backup/BackupManagerConstants;

    monitor-enter v1

    :try_start_0
    iget-object v0, v11, mConstants:Lcom/android/server/backup/BackupManagerConstants;
    ...
    iget-boolean v0, v11, mEnabled:Z

    const/4 v4, 0x0

    if-eqz v0, :cond_e

    iget-boolean v0, v11, mSetupComplete:Z
    ...
    :cond_0
    iget-object v0, v11, mPowerManager:Landroid/os/PowerManager;
    ...
    iget v0, v11, mUserId:I

    iget-object v5, v11, mContext:Landroid/content/Context;

    iget-object v6, v11, mConstants:Lcom/android/server/backup/BackupManagerConstants;
    ...
    iget-object v7, v11, mQueueLock:Ljava/lang/Object;

    monitor-enter v7

    :try_start_1
    iget-object v0, v11, mRunningFullBackupTask:Lcom/android/server/backup/fullbackup/PerformFullTransportBackupTask;
    :try_end_1
    ...
    :goto_0
    :try_start_3
    iget-object v6, v11, mFullBackupQueue:Ljava/util/ArrayList;
    ...
    :try_start_5
    iget-object v6, v11, mTransportManager:Lcom/android/server/backup/TransportManager;

    invoke-virtual {v6}, Lcom/android/server/backup/TransportManager;->getCurrentTransportName()Ljava/lang/String;

    move-result-object v6

    invoke-direct {v11, v6}, fullBackupAllowable(Ljava/lang/String;)Z
    ...
    :try_start_6
    iget-object v4, v11, mFullBackupQueue:Ljava/util/ArrayList;
    :try_end_6
    ...
    :cond_6
    :try_start_9
    iget-object v0, v11, mPackageManager:Landroid/content/pm/PackageManager;
    :try_end_9
    ...
    :try_start_c
    iget-object v2, v11, mFullBackupQueue:Ljava/util/ArrayList;
    ...
    :try_start_e
    iget-object v3, v11, mActivityManagerInternal:Landroid/app/ActivityManagerInternal;
    ...
    iget-object v0, v11, mTokenGenerator:Ljava/util/Random;
    ...
    invoke-virtual {v11, v0, v5, v6}, enqueueFullBackup(Ljava/lang/String;J)V
    :try_end_11
    ...
    :try_start_15
    iget-object v0, v11, mFullBackupQueue:Ljava/util/ArrayList;
    ...
    iput-object v0, v11, mRunningFullBackupTask:Lcom/android/server/backup/fullbackup/PerformFullTransportBackupTask;

    iget-object v0, v11, mWakelock:Landroid/os/PowerManager$WakeLock;

    invoke-virtual {v0}, Landroid/os/PowerManager$WakeLock;->acquire()V

    new-instance v0, Ljava/lang/Thread;

    iget-object v1, v11, mRunningFullBackupTask:Lcom/android/server/backup/fullbackup/PerformFullTransportBackupTask;
...
.method public beginRestoreSession(Ljava/lang/String;Ljava/lang/String;)Landroid/app/backup/IRestoreSession;
    ...
    :try_start_1
    iget-object v1, p0, mActiveRestoreSession:Lcom/android/server/backup/restore/ActiveRestoreSession;
    ...
    iput-object v1, p0, mActiveRestoreSession:Lcom/android/server/backup/restore/ActiveRestoreSession;

    iget-object v1, p0, mBackupHandler:Lcom/android/server/backup/internal/BackupHandler;

    const/16 v2, 0x8

    iget-object v3, p0, mAgentTimeoutParameters:Lcom/android/server/backup/BackupAgentTimeoutParameters;
...
.method public bindToAgentSynchronous(Landroid/content/pm/ApplicationInfo;I)Landroid/app/IBackupAgent;
    ...
    :try_start_0
    iput-boolean v2, p0, mConnecting:Z

    const/4 v2, 0x0

    iput-object v2, p0, mConnectedAgent:Landroid/app/IBackupAgent;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :goto_0
    iget-boolean v5, p0, mConnecting:Z

    if-eqz v5, :cond_0

    iget-object v5, p0, mConnectedAgent:Landroid/app/IBackupAgent;
    ...
    iget-object v2, p0, mConnectedAgent:Landroid/app/IBackupAgent;
    :try_end_3
    ...
    iget-object v1, p0, mActivityManagerInternal:Landroid/app/ActivityManagerInternal;
...
.method public cancelBackups()V
    ...
    :goto_0
    :try_start_1
    iget-object v5, p0, mCurrentOperations:Landroid/util/SparseArray;
    ...
    iget-object v6, p0, mCurrentOperations:Landroid/util/SparseArray;
    ...
    invoke-virtual {p0, v5, v6}, handleCancel(IZ)V
    ...
    iget-object v7, p0, mConstants:Lcom/android/server/backup/BackupManagerConstants;
...
.method public clearApplicationDataAfterRestoreFailure(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, v0, v1}, clearApplicationDataSynchronous(Ljava/lang/String;ZZ)V
...
.method public clearBackupData(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_0
    iget-object v1, p0, mProcessedPackagesJournal:Lcom/android/server/backup/ProcessedPackagesJournal;
    ...
    iget-object v2, p0, mBackupHandler:Lcom/android/server/backup/internal/BackupHandler;
    ...
    :try_start_1
    iget-object v4, p0, mTransportManager:Lcom/android/server/backup/TransportManager;
    ...
    iget-object v7, p0, mBackupHandler:Lcom/android/server/backup/internal/BackupHandler;
    ...
    iget-object v8, p0, mBackupHandler:Lcom/android/server/backup/internal/BackupHandler;
...
.method public clearPendingInits()V
    ...
    iget-object v0, p0, mPendingInits:Landroid/util/ArraySet;
...
.method public clearRestoreSession(Lcom/android/server/backup/restore/ActiveRestoreSession;)V
    ...
    :try_start_0
    iget-object v0, p0, mActiveRestoreSession:Lcom/android/server/backup/restore/ActiveRestoreSession;
    ...
    iput-object v0, p0, mActiveRestoreSession:Lcom/android/server/backup/restore/ActiveRestoreSession;
...
.method public filterAppsEligibleForBackup([Ljava/lang/String;)[Ljava/lang/String;
    ...
    iget-object v3, p0, mTransportManager:Lcom/android/server/backup/TransportManager;
    ...
    iget-object v5, p0, mTransportManager:Lcom/android/server/backup/TransportManager;
...
.method public fullTransportBackup([Ljava/lang/String;)V
    ...
    iget-object v0, v11, mTransportManager:Lcom/android/server/backup/TransportManager;

    invoke-virtual {v0}, Lcom/android/server/backup/TransportManager;->getCurrentTransportName()Ljava/lang/String;

    move-result-object v14

    invoke-direct {v11, v14}, fullBackupAllowable(Ljava/lang/String;)Z
    ...
    invoke-virtual {v11, v5, v2, v3}, enqueueFullBackup(Ljava/lang/String;J)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method public generateRandomIntegerToken()I
    ...
    iget-object v0, p0, mTokenGenerator:Ljava/util/Random;
    ...
    iget-object v1, p0, mNextToken:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public getAdbBackupRestoreConfirmations()Landroid/util/SparseArray;
    ...
    iget-object v0, p0, mAdbBackupRestoreConfirmations:Landroid/util/SparseArray;
...
.method public getAgentTimeoutParameters()Lcom/android/server/backup/BackupAgentTimeoutParameters;
    ...
    iget-object v0, p0, mAgentTimeoutParameters:Lcom/android/server/backup/BackupAgentTimeoutParameters;
...
.method public getAncestralSerialNumber()J
    ...
    :try_start_0
    invoke-direct {p0}, getAncestralSerialNumberFile()Ljava/io/RandomAccessFile;
...
.method public getAvailableRestoreToken(Ljava/lang/String;)J
    ...
    :try_start_0
    iget-wide v3, p0, mCurrentToken:J
...
.method public getBackupManagerBinder()Landroid/app/backup/IBackupManager;
    ...
    iget-object v0, p0, mBackupManagerBinder:Landroid/app/backup/IBackupManager;
...
.method public getBaseStateDir()Ljava/io/File;
    ...
    iget-object v0, p0, mBaseStateDir:Ljava/io/File;
...
.method public getClearDataLock()Ljava/lang/Object;
    ...
    iget-object v0, p0, mClearDataLock:Ljava/lang/Object;
...
.method public getConstants()Lcom/android/server/backup/BackupManagerConstants;
    ...
    iget-object v0, p0, mConstants:Lcom/android/server/backup/BackupManagerConstants;
...
.method public getCurrentOpLock()Ljava/lang/Object;
    ...
    iget-object v0, p0, mCurrentOpLock:Ljava/lang/Object;
...
.method public getCurrentOperations()Landroid/util/SparseArray;
    ...
    iget-object v0, p0, mCurrentOperations:Landroid/util/SparseArray;
...
.method public getPackageManagerBinder()Landroid/content/pm/IPackageManager;
    ...
    iget-object v0, p0, mPackageManagerBinder:Landroid/content/pm/IPackageManager;
...
.method public getPendingRestores()Ljava/util/Queue;
    ...
    iget-object v0, p0, mPendingRestores:Ljava/util/Queue;
...
.method public getRunInitIntent()Landroid/app/PendingIntent;
    ...
    iget-object v0, p0, mRunInitIntent:Landroid/app/PendingIntent;
...
.method public handleCancel(IZ)V
    ...
    iget-object v1, p0, mCurrentOpLock:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, mCurrentOperations:Landroid/util/SparseArray;
    ...
    invoke-direct {p0, v4}, getMessageIdForOperationType(I)I
...
.method initializeBackupEnableState()V
    ...
    invoke-virtual {p0, v0}, setBackupEnabled(Z)V
...
.method public initializeTransports([Ljava/lang/String;Landroid/app/backup/IBackupObserver;)V
    ...
    iget-object v3, p0, mBackupHandler:Lcom/android/server/backup/internal/BackupHandler;
...
.method public isRestoreInProgress()Z
    ...
    iget-boolean v0, p0, mIsRestoreInProgress:Z
...
.method public isSetupComplete()Z
    ...
    iget-boolean v0, p0, mSetupComplete:Z
...
.method public synthetic lambda$parseLeftoverJournals$0$UserBackupManagerService(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, dataChangedImpl(Ljava/lang/String;)V
...
.method public synthetic lambda$selectBackupTransportAsync$5$UserBackupManagerService(Landroid/content/ComponentName;Landroid/app/backup/ISelectBackupTransportCallback;)V
    ...
    invoke-direct {p0, v0}, updateStateForTransport(Ljava/lang/String;)V
    :try_end_0
    .catch Lcom/android/server/backup/transport/TransportNotRegisteredException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public prepareOperationTimeout(IJLcom/android/server/backup/BackupRestoreTask;I)V
    ...
    invoke-direct {p0, p5}, getMessageIdForOperationType(I)I
...
.method public recordInitPending(ZLjava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v2, p0, mBaseStateDir:Ljava/io/File;
...
.method public requestBackup([Ljava/lang/String;Landroid/app/backup/IBackupObserver;I)I
    ...
    invoke-virtual {p0, p1, p2, v0, p3}, requestBackup([Ljava/lang/String;Landroid/app/backup/IBackupObserver;Landroid/app/backup/IBackupManagerMonitor;I)I
...
.method public requestBackup([Ljava/lang/String;Landroid/app/backup/IBackupObserver;Landroid/app/backup/IBackupManagerMonitor;I)I
    ...
    iget-boolean v5, v1, mEnabled:Z

    const/16 v8, -0x7d1

    if-eqz v5, :cond_6

    iget-boolean v5, v1, mSetupComplete:Z
    ...
    iget-object v5, v1, mTransportManager:Lcom/android/server/backup/TransportManager;
    ...
    iget-object v2, v1, mBackupHandler:Lcom/android/server/backup/internal/BackupHandler;
    ...
    iget-boolean v3, v1, mSetupComplete:Z
...
.method public resetBackupState(Ljava/io/File;)V
    ...
    iput-wide v1, p0, mCurrentToken:J
    ...
    invoke-virtual {p0, v5}, dataChangedImpl(Ljava/lang/String;)V
...
.method public restoreAtInstall(Ljava/lang/String;I)V
    ...
    :cond_2
    iget-boolean v3, v1, mAutoRestore:Z
    ...
    iget-boolean v4, v1, mAutoRestore:Z
    ...
    :try_start_0
    iget-object v0, v1, mWakelock:Landroid/os/PowerManager$WakeLock;
    ...
    iget-object v3, v1, mBackupHandler:Lcom/android/server/backup/internal/BackupHandler;
    ...
    :try_start_1
    iget-object v0, v1, mPackageManagerBinder:Landroid/content/pm/IPackageManager;
    :try_end_1
...
.method public scheduleNextFullBackupJob(J)V
    ...
    iget-object v2, v1, mQueueLock:Ljava/lang/Object;

    monitor-enter v2

    :try_start_0
    iget-object v0, v1, mFullBackupQueue:Ljava/util/ArrayList;
    ...
    iget-object v0, v1, mConstants:Lcom/android/server/backup/BackupManagerConstants;
    ...
    iget v0, v1, mUserId:I

    iget-object v15, v1, mContext:Landroid/content/Context;

    move-wide/from16 v16, v3

    iget-object v3, v1, mConstants:Lcom/android/server/backup/BackupManagerConstants;
...
.method public selectBackupTransport(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, p1}, updateStateForTransport(Ljava/lang/String;)V
...
.method public setAncestralPackages(Ljava/util/Set;)V
    ...
    iput-object p1, p0, mAncestralPackages:Ljava/util/Set;
...
.method public setAncestralSerialNumber(J)V
    ...
    :try_start_2
    invoke-static {v2, v0}, $closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_2
    .catch Ljava/io/IOException; {:try_start_2 .. :try_end_2} :catch_0
...
.method setAncestralSerialNumberFile(Ljava/io/File;)V
    ...
    iput-object p1, p0, mAncestralSerialNumberFile:Ljava/io/File;
...
.method public setAncestralToken(J)V
    ...
    iput-wide p1, p0, mAncestralToken:J
...
.method public setBackupEnabled(Z)V
    ...
    :try_start_3
    iget-boolean v4, p0, mSetupComplete:Z
    ...
    iget-object v6, p0, mConstants:Lcom/android/server/backup/BackupManagerConstants;
    ...
    invoke-virtual {p0, v4, v5}, scheduleNextFullBackupJob(J)V
    ...
    iget-object v6, p0, mTransportManager:Lcom/android/server/backup/TransportManager;
    ...
    invoke-virtual {p0, v10, v8, v9}, recordInitPending(ZLjava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v10, p0, mRunInitIntent:Landroid/app/PendingIntent;
...
.method public setClearingData(Z)V
    ...
    iput-boolean p1, p0, mClearingData:Z
...
.method public setCurrentToken(J)V
    ...
    iput-wide p1, p0, mCurrentToken:J
...
.method public setJournal(Lcom/android/server/backup/DataChangedJournal;)V
    ...
    iput-object p1, p0, mJournal:Lcom/android/server/backup/DataChangedJournal;
...
.method public setLastBackupPass(J)V
    ...
    iput-wide p1, p0, mLastBackupPass:J
...
.method public setRestoreInProgress(Z)V
    ...
    iput-boolean p1, p0, mIsRestoreInProgress:Z
...
.method public setRunningFullBackupTask(Lcom/android/server/backup/fullbackup/PerformFullTransportBackupTask;)V
    ...
    iput-object p1, p0, mRunningFullBackupTask:Lcom/android/server/backup/fullbackup/PerformFullTransportBackupTask;
...
.method public setSetupComplete(Z)V
    ...
    iput-boolean p1, p0, mSetupComplete:Z
...
.method tearDownService()V
    ...
    iget-object v0, p0, mUserBackupThread:Landroid/os/HandlerThread;
...
.method updateTransportAttributes(ILandroid/content/ComponentName;Ljava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/content/Intent;Ljava/lang/CharSequence;)V
    ...
    :try_start_1
    iget-object v2, v1, mTransportManager:Lcom/android/server/backup/TransportManager;
...
.method public updateTransportAttributes(Landroid/content/ComponentName;Ljava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/content/Intent;Ljava/lang/CharSequence;)V
    ...
    invoke-virtual/range {v0 .. v7}, updateTransportAttributes(ILandroid/content/ComponentName;Ljava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/content/Intent;Ljava/lang/CharSequence;)V
...
.method public waitUntilOperationComplete(I)Z
    ...
    invoke-virtual {p0, p1}, removeOperation(I)V
    ...
    invoke-direct {p0, v3}, getMessageIdForOperationType(I)I
...
.method public writeRestoreTokens()V
    ...
    iget-object v2, p0, mTokenFile:Ljava/io/File;
    ...
    iget-wide v3, p0, mAncestralToken:J
