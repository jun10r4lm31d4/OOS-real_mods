...
.method public constructor <init>(Lcom/android/server/backup/UserBackupManagerService;Lcom/android/server/backup/BackupRestoreTask;Landroid/app/backup/IFullBackupRestoreObserver;Landroid/app/backup/IBackupManagerMonitor;Landroid/content/pm/PackageInfo;ZZIZ)V
    ...
    iput-object v0, p0, mDeleteObserver:Lcom/android/server/backup/restore/RestoreDeleteObserver;

    const/4 v0, 0x0

    iput-object v0, p0, mObbConnection:Lcom/android/server/backup/fullbackup/FullBackupObbConnection;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, mPackagePolicies:Ljava/util/HashMap;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, mPackageInstallers:Ljava/util/HashMap;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, mManifestSignatures:Ljava/util/HashMap;

    new-instance v1, Ljava/util/HashSet;

    invoke-direct {v1}, Ljava/util/HashSet;-><init>()V

    iput-object v1, p0, mClearedPackages:Ljava/util/HashSet;
    ...
    iput-object v1, p0, mPipesLock:Ljava/lang/Object;

    iput-object v0, p0, mWidgetData:[B

    iput-object p1, p0, mBackupManagerService:Lcom/android/server/backup/UserBackupManagerService;

    iput p8, p0, mEphemeralOpToken:I

    iput-object p2, p0, mMonitorTask:Lcom/android/server/backup/BackupRestoreTask;

    iput-object p3, p0, mObserver:Landroid/app/backup/IFullBackupRestoreObserver;

    iput-object p4, p0, mMonitor:Landroid/app/backup/IBackupManagerMonitor;

    iput-object p5, p0, mOnlyPackage:Landroid/content/pm/PackageInfo;

    iput-boolean p6, p0, mAllowApks:Z

    iput-boolean p7, p0, mAllowObbs:Z
    ...
    iput-boolean p9, p0, mIsAdbRestore:Z
...
.method private setUpPipes()V
    ...
    iget-object v0, p0, mPipesLock:Ljava/lang/Object;
    ...
    iput-boolean v1, p0, mPipesClosed:Z
...
.method private tearDownAgent(Landroid/content/pm/ApplicationInfo;Z)V
    ...
    iget-object v1, p0, mTargetApp:Landroid/content/pm/ApplicationInfo;
    ...
    iget-object v6, p0, mBackupManagerService:Lcom/android/server/backup/UserBackupManagerService;
...
.method private tearDownPipes()V
    ...
    :try_start_0
    iget-boolean v1, p0, mPipesClosed:Z
    ...
    iput-boolean v2, p0, mPipesClosed:Z
    :try_end_1
...
.method handleTimeout()V
    ...
    invoke-direct {p0}, tearDownPipes()V
...
.method public restoreOneFile(Ljava/io/InputStream;Z[BLandroid/content/pm/PackageInfo;ZILandroid/app/backup/IBackupManagerMonitor;)Z
    ...
    iget-object v0, v1, mAgentPackage:Ljava/lang/String;
    ...
    invoke-virtual {v1, v6}, setResult(I)V

    invoke-virtual {v1, v14}, setRunning(Z)V

    return v14

    :cond_1
    iget-object v0, v1, mPackagePolicies:Ljava/util/HashMap;
    ...
    :cond_2
    iget-object v0, v1, mAgent:Landroid/app/IBackupAgent;
    ...
    invoke-direct/range {p0 .. p0}, tearDownPipes()V

    iget-object v0, v1, mTargetApp:Landroid/content/pm/ApplicationInfo;

    iget-boolean v7, v1, mIsAdbRestore:Z

    invoke-direct {v1, v0, v7}, tearDownAgent(Landroid/content/pm/ApplicationInfo;Z)V

    iput-object v2, v1, mTargetApp:Landroid/content/pm/ApplicationInfo;

    iput-object v2, v1, mAgentPackage:Ljava/lang/String;
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0
    ...
    iget-object v2, v1, mBackupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    iget-object v3, v1, mManifestSignatures:Ljava/util/HashMap;
    ...
    iget-object v3, v1, mPackagePolicies:Ljava/util/HashMap;

    invoke-virtual {v3, v14, v2}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v3, v1, mPackageInstallers:Ljava/util/HashMap;
    ...
    iget-object v3, v1, mObserver:Landroid/app/backup/IFullBackupRestoreObserver;
    ...
    iput-object v3, v1, mObserver:Landroid/app/backup/IFullBackupRestoreObserver;
    :try_end_4
    ...
    iput-object v0, v1, mWidgetData:[B
    ...
    iget-object v2, v1, mPackageInstallers:Ljava/util/HashMap;
    ...
    iget-object v4, v1, mDeleteObserver:Lcom/android/server/backup/restore/RestoreDeleteObserver;

    iget-object v5, v1, mManifestSignatures:Ljava/util/HashMap;

    iget-object v7, v1, mPackagePolicies:Ljava/util/HashMap;
    ...
    iget-object v5, v1, mPackagePolicies:Ljava/util/HashMap;
    ...
    :goto_2
    :try_start_c
    invoke-static {v3}, isRestorableFile(Lcom/android/server/backup/FileMetadata;)Z
    ...
    invoke-static {v5}, isCanonicalFilePath(Ljava/lang/String;)Z
    ...
    :try_start_f
    iget-object v0, v1, mBackupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    iput-object v0, v1, mTargetApp:Landroid/content/pm/ApplicationInfo;

    iget-object v0, v1, mClearedPackages:Ljava/util/HashSet;
    ...
    invoke-direct {v1, v0}, shouldForceClearAppDataOnFullRestore(Ljava/lang/String;)Z

    move-result v0

    iget-object v7, v1, mTargetApp:Landroid/content/pm/ApplicationInfo;
    ...
    iget-object v7, v1, mBackupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    :cond_f
    iget-object v7, v1, mClearedPackages:Ljava/util/HashSet;

    invoke-virtual {v7, v14}, Ljava/util/HashSet;->add(Ljava/lang/Object;)Z

    :cond_10
    invoke-direct/range {p0 .. p0}, setUpPipes()V
    ...
    iput-object v0, v1, mAgent:Landroid/app/IBackupAgent;

    iput-object v14, v1, mAgentPackage:Ljava/lang/String;
    :try_end_f
    ...
    iget-object v4, v1, mAgentPackage:Ljava/lang/String;
    ...
    :try_start_12
    iget-object v0, v1, mAgentTimeoutParameters:Lcom/android/server/backup/BackupAgentTimeoutParameters;
    ...
    iget-object v2, v1, mMonitorTask:Lcom/android/server/backup/BackupRestoreTask;
    ...
    iget-object v0, v1, mObbConnection:Lcom/android/server/backup/fullbackup/FullBackupObbConnection;

    iget-object v2, v1, mPipes:[Landroid/os/ParcelFileDescriptor;
    ...
    :try_start_18
    iget-object v13, v1, mBackupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    iget-object v4, v1, mBackupManagerService:Lcom/android/server/backup/UserBackupManagerService;

    invoke-virtual {v4}, Lcom/android/server/backup/UserBackupManagerService;->getDataDir()Ljava/io/File;

    move-result-object v18

    iget-object v4, v1, mPipes:[Landroid/os/ParcelFileDescriptor;

    const/4 v5, 0x0

    aget-object v20, v4, v5

    iget-object v4, v1, mAgent:Landroid/app/IBackupAgent;
    ...
    iget-object v5, v1, mPipes:[Landroid/os/ParcelFileDescriptor;
    ...
    :try_start_1f
    iget-object v10, v1, mBackupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    iget-object v6, v1, mPipes:[Landroid/os/ParcelFileDescriptor;
    ...
    invoke-direct {v1, v0, v6}, tearDownAgent(Landroid/content/pm/ApplicationInfo;Z)V

    const/4 v6, 0x0

    iput-object v6, v1, mAgent:Landroid/app/IBackupAgent;
    ...
    invoke-virtual {v1, v0}, setResult(I)V

    const/4 v6, 0x0

    invoke-virtual {v1, v6}, setRunning(Z)V
    :try_end_27
    ...
    :try_start_2b
    iget-wide v2, v1, mBytes:J

    add-long/2addr v2, v13

    iput-wide v2, v1, mBytes:J
    :try_end_2b
    ...
    invoke-virtual {v1, v3}, setResult(I)V
    ...
    invoke-virtual {v1, v13}, setRunning(Z)V

    if-eqz p2, :cond_29

    iget-object v0, v1, mTargetApp:Landroid/content/pm/ApplicationInfo;

    iget-boolean v3, v1, mIsAdbRestore:Z

    invoke-direct {v1, v0, v3}, tearDownAgent(Landroid/content/pm/ApplicationInfo;Z)V
...
.method sendOnRestorePackage(Ljava/lang/String;)V
    ...
    iget-object v0, p0, mObserver:Landroid/app/backup/IFullBackupRestoreObserver;
