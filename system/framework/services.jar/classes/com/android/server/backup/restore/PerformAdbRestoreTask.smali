...
.method public constructor <init>(Lcom/android/server/backup/UserBackupManagerService;Landroid/os/ParcelFileDescriptor;Ljava/lang/String;Ljava/lang/String;Landroid/app/backup/IFullBackupRestoreObserver;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    ...
    iput-object v1, p0, mPackageManagerBackupAgent:Landroid/app/backup/BackupAgent;

    iput-object v0, p0, mAgentPackage:Ljava/lang/String;

    iput-object v0, p0, mTargetApp:Landroid/content/pm/ApplicationInfo;
...
.method private static decodeAesHeaderAndInitialize(Ljava/lang/String;Ljava/lang/String;ZLjava/io/InputStream;)Ljava/io/InputStream;
    ...
    invoke-static/range {p3 .. p3}, readHeaderLine(Ljava/io/InputStream;)Ljava/lang/String;
    ...
    invoke-static/range {v4 .. v12}, attemptMasterKeyDecryption(Ljava/lang/String;Ljava/lang/String;[B[BILjava/lang/String;Ljava/lang/String;Ljava/io/InputStream;Z)Ljava/io/InputStream;
    ...
    invoke-static/range {v14 .. v22}, attemptMasterKeyDecryption(Ljava/lang/String;Ljava/lang/String;[B[BILjava/lang/String;Ljava/lang/String;Ljava/io/InputStream;Z)Ljava/io/InputStream;
...
.method public static parseBackupFileHeaderAndReturnTarStream(Ljava/io/InputStream;Ljava/lang/String;)Ljava/io/InputStream;
    ...
    invoke-static {p0, v5}, readFullyOrThrow(Ljava/io/InputStream;[B)V
    ...
    invoke-static {p0}, readHeaderLine(Ljava/io/InputStream;)Ljava/lang/String;
    ...
    invoke-static {p1, v6, v11, p0}, decodeAesHeaderAndInitialize(Ljava/lang/String;Ljava/lang/String;ZLjava/io/InputStream;)Ljava/io/InputStream;
...
.method public run()V
    ...
    iget-object v0, p0, mObbConnection:Lcom/android/server/backup/fullbackup/FullBackupObbConnection;
    ...
    iput-object v0, p0, mObserver:Landroid/app/backup/IFullBackupRestoreObserver;
    ...
    iget-object v0, p0, mPackagePolicies:Ljava/util/HashMap;
    ...
    iget-object v3, p0, mCurrentPassword:Ljava/lang/String;
    ...
    :cond_1
    iget-object v2, p0, mInputFile:Landroid/os/ParcelFileDescriptor;
    ...
    :goto_0
    iget-object v2, p0, mLatchObject:Ljava/util/concurrent/atomic/AtomicBoolean;

    monitor-enter v2

    :try_start_2
    iget-object v3, p0, mLatchObject:Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-virtual {v3, v1}, Ljava/util/concurrent/atomic/AtomicBoolean;->set(Z)V

    iget-object v1, p0, mLatchObject:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v1, p0, mObbConnection:Lcom/android/server/backup/fullbackup/FullBackupObbConnection;
    ...
    iget-object v3, p0, mInputFile:Landroid/os/ParcelFileDescriptor;
    ...
    iget-object v2, p0, mDecryptPassword:Ljava/lang/String;

    invoke-static {v0, v2}, parseBackupFileHeaderAndReturnTarStream(Ljava/io/InputStream;Ljava/lang/String;)Ljava/io/InputStream;
    ...
    :try_start_6
    iget-object v4, p0, mLatchObject:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v5, p0, mBackupManagerService:Lcom/android/server/backup/UserBackupManagerService;

    const/4 v6, 0x0

    iget-object v7, p0, mObserver:Landroid/app/backup/IFullBackupRestoreObserver;
