...
.method static constructor <clinit>()V
    ...
    sput-object v0, INITIAL:Lcom/android/server/backup/restore/UnifiedRestoreState;
    ...
    sput-object v0, RUNNING_QUEUE:Lcom/android/server/backup/restore/UnifiedRestoreState;
    ...
    sput-object v0, RESTORE_KEYVALUE:Lcom/android/server/backup/restore/UnifiedRestoreState;
    ...
    sput-object v0, RESTORE_FULL:Lcom/android/server/backup/restore/UnifiedRestoreState;
    ...
    sput-object v0, RESTORE_FINISHED:Lcom/android/server/backup/restore/UnifiedRestoreState;
    ...
    sput-object v0, FINAL:Lcom/android/server/backup/restore/UnifiedRestoreState;

    const/4 v0, 0x6

    new-array v0, v0, [Lcom/android/server/backup/restore/UnifiedRestoreState;

    sget-object v7, INITIAL:Lcom/android/server/backup/restore/UnifiedRestoreState;

    aput-object v7, v0, v1

    sget-object v1, RUNNING_QUEUE:Lcom/android/server/backup/restore/UnifiedRestoreState;

    aput-object v1, v0, v2

    sget-object v1, RESTORE_KEYVALUE:Lcom/android/server/backup/restore/UnifiedRestoreState;

    aput-object v1, v0, v3

    sget-object v1, RESTORE_FULL:Lcom/android/server/backup/restore/UnifiedRestoreState;

    aput-object v1, v0, v4

    sget-object v1, RESTORE_FINISHED:Lcom/android/server/backup/restore/UnifiedRestoreState;

    aput-object v1, v0, v5

    sget-object v1, FINAL:Lcom/android/server/backup/restore/UnifiedRestoreState;

    aput-object v1, v0, v6

    sput-object v0, $VALUES:[Lcom/android/server/backup/restore/UnifiedRestoreState;
...
.method public static values()[Lcom/android/server/backup/restore/UnifiedRestoreState;
    ...
    sget-object v0, $VALUES:[Lcom/android/server/backup/restore/UnifiedRestoreState;
