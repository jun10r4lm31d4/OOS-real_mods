...
.method public constructor <init>(Landroid/app/backup/FullBackupDataOutput;Landroid/content/pm/PackageManager;)V
    ...
    iput-object p1, p0, mOutput:Landroid/app/backup/FullBackupDataOutput;
...
.method public backupApk(Landroid/content/pm/PackageInfo;)V
    ...
    iget-object v6, p0, mOutput:Landroid/app/backup/FullBackupDataOutput;
...
.method public backupManifest(Landroid/content/pm/PackageInfo;Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-direct {p0, p1, v3}, getManifestBytes(Landroid/content/pm/PackageInfo;Z)[B
    ...
    iget-object v13, v0, mOutput:Landroid/app/backup/FullBackupDataOutput;
...
.method public backupManifest(Landroid/content/pm/PackageInfo;Ljava/io/File;Ljava/io/File;Z)V
    ...
    invoke-virtual/range {v0 .. v6}, backupManifest(Landroid/content/pm/PackageInfo;Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;Z)V
...
.method public backupObb(ILandroid/content/pm/PackageInfo;)V
    ...
    iget-object v9, p0, mOutput:Landroid/app/backup/FullBackupDataOutput;
...
.method public backupWidget(Landroid/content/pm/PackageInfo;Ljava/io/File;Ljava/io/File;[B)V
    ...
    invoke-direct {p0, v0}, getMetadataBytes(Ljava/lang/String;)[B

    move-result-object v10

    invoke-virtual {v8, v10}, Ljava/io/BufferedOutputStream;->write([B)V

    invoke-direct {p0, v9, p4}, writeWidgetData(Ljava/io/DataOutputStream;[B)V
    ...
    iget-object v7, p0, mOutput:Landroid/app/backup/FullBackupDataOutput;
