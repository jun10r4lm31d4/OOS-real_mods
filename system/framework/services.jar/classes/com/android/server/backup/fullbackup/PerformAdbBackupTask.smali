...
.method public constructor <init>(Lcom/android/server/backup/UserBackupManagerService;Landroid/os/ParcelFileDescriptor;Landroid/app/backup/IFullBackupRestoreObserver;ZZZZLjava/lang/String;Ljava/lang/String;ZZZZ[Ljava/lang/String;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    ...
    iput-object v4, v0, mUserBackupManagerService:Lcom/android/server/backup/UserBackupManagerService;

    invoke-virtual/range {p1 .. p1}, Lcom/android/server/backup/UserBackupManagerService;->generateRandomIntegerToken()I

    move-result v5

    iput v5, v0, mCurrentOpToken:I

    move-object/from16 v5, p15

    iput-object v5, v0, mLatch:Ljava/util/concurrent/atomic/AtomicBoolean;

    move-object/from16 v6, p2

    iput-object v6, v0, mOutputFile:Landroid/os/ParcelFileDescriptor;

    move/from16 v7, p4

    iput-boolean v7, v0, mIncludeApks:Z

    move/from16 v8, p5

    iput-boolean v8, v0, mIncludeObbs:Z

    move/from16 v9, p6

    iput-boolean v9, v0, mIncludeShared:Z

    move/from16 v10, p7

    iput-boolean v10, v0, mDoWidgets:Z

    move/from16 v11, p10

    iput-boolean v11, v0, mAllApps:Z

    move/from16 v12, p11

    iput-boolean v12, v0, mIncludeSystem:Z
    ...
    :goto_0
    iput-object v13, v0, mPackages:Ljava/util/ArrayList;

    iput-object v1, v0, mCurrentPassword:Ljava/lang/String;
    ...
    :cond_1
    iput-object v2, v0, mEncryptPassword:Ljava/lang/String;

    goto :goto_2

    :cond_2
    :goto_1
    iput-object v1, v0, mEncryptPassword:Ljava/lang/String;

    :goto_2
    move/from16 v13, p12

    iput-boolean v13, v0, mCompress:Z

    move/from16 v14, p13

    iput-boolean v14, v0, mKeyValue:Z
...
.method private addPackagesToSet(Ljava/util/TreeMap;Ljava/util/List;)V
    ...
    :try_start_0
    iget-object v2, p0, mUserBackupManagerService:Lcom/android/server/backup/UserBackupManagerService;
...
.method private emitAesBackupHeader(Ljava/lang/StringBuilder;Ljava/io/OutputStream;)Ljava/io/OutputStream;
    ...
    iget-object v2, v0, mUserBackupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    iget-object v4, v0, mEncryptPassword:Ljava/lang/String;
    ...
    iget-object v8, v0, mUserBackupManagerService:Lcom/android/server/backup/UserBackupManagerService;
...
.method public handleCancel(Z)V
    ...
    iget-object v0, p0, mCurrentTarget:Landroid/content/pm/PackageInfo;
    ...
    iget-object v2, p0, mCurrentTarget:Landroid/content/pm/PackageInfo;
...
.method public run()V
    ...
    iget-boolean v0, v12, mKeyValue:Z
    ...
    iget-object v1, v12, mUserBackupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    iget-object v0, v12, mUserBackupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    iget-boolean v0, v12, mAllApps:Z
    ...
    iget-boolean v3, v12, mIncludeSystem:Z
    ...
    :cond_3
    iget-boolean v0, v12, mDoWidgets:Z
    ...
    invoke-direct {v12, v14, v0}, addPackagesToSet(Ljava/util/TreeMap;Ljava/util/List;)V

    :cond_4
    iget-object v0, v12, mPackages:Ljava/util/ArrayList;
    ...
    iget-object v3, v12, mUserBackupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    iget-object v2, v12, mOutputFile:Landroid/os/ParcelFileDescriptor;
    ...
    :try_start_0
    iget-object v0, v12, mEncryptPassword:Ljava/lang/String;
    :try_end_0
    ...
    :cond_b
    iget-object v0, v12, mOutputFile:Landroid/os/ParcelFileDescriptor;
    ...
    :goto_6
    iget-object v1, v12, mLatch:Ljava/util/concurrent/atomic/AtomicBoolean;

    monitor-enter v1

    :try_start_5
    iget-object v0, v12, mLatch:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v5, v12, mCurrentPassword:Ljava/lang/String;
    ...
    iget-boolean v0, v12, mCompress:Z
    :try_end_c
    ...
    :try_start_f
    invoke-direct {v12, v6, v4}, emitAesBackupHeader(Ljava/lang/StringBuilder;Ljava/io/OutputStream;)Ljava/io/OutputStream;
    ...
    iget-boolean v5, v12, mCompress:Z
    :try_end_10
    ...
    :try_start_12
    iget-boolean v0, v12, mIncludeShared:Z
    :try_end_12
    ...
    iget-object v2, v12, mUserBackupManagerService:Lcom/android/server/backup/UserBackupManagerService;

    const/4 v10, 0x0

    iget-boolean v1, v12, mIncludeApks:Z
    :try_end_18
    ...
    :goto_d
    invoke-virtual {v12, v3}, sendOnBackupPackage(Ljava/lang/String;)V

    iput-object v2, v12, mCurrentTarget:Landroid/content/pm/PackageInfo;

    invoke-virtual {v1}, Lcom/android/server/backup/fullbackup/FullBackupEngine;->backupOnePackage()I

    iget-boolean v3, v12, mIncludeObbs:Z
    :try_end_1c
    ...
    :try_start_1e
    iget-boolean v1, v12, mKeyValue:Z
    :try_end_1e
    ...
    iget-object v6, v12, mUserBackupManagerService:Lcom/android/server/backup/UserBackupManagerService;

    iget-object v7, v12, mUserBackupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    invoke-virtual {v12, v6}, sendOnBackupPackage(Ljava/lang/String;)V
    ...
    :cond_17
    :try_start_20
    invoke-direct {v12, v4}, finalizeBackup(Ljava/io/OutputStream;)V
    :try_end_20
    ...
    :goto_18
    iget-object v6, v12, mLatch:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :goto_20
    iget-object v2, v12, mLatch:Ljava/util/concurrent/atomic/AtomicBoolean;
