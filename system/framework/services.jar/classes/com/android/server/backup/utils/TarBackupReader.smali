...
.method public constructor <init>(Ljava/io/InputStream;Lcom/android/server/backup/utils/BytesReadListener;Landroid/app/backup/IBackupManagerMonitor;)V
    ...
    iput-object p2, p0, mBytesReadListener:Lcom/android/server/backup/utils/BytesReadListener;

    iput-object p3, p0, mMonitor:Landroid/app/backup/IBackupManagerMonitor;
...
.method private readPaxExtendedHeader(Lcom/android/server/backup/FileMetadata;)Z
    ...
    iget-object v5, v0, mInputStream:Ljava/io/InputStream;

    const/4 v6, 0x0

    array-length v7, v4

    invoke-static {v5, v4, v6, v7}, readExactly(Ljava/io/InputStream;[BII)I
    ...
    iget-object v5, v0, mBytesReadListener:Lcom/android/server/backup/utils/BytesReadListener;
    ...
    invoke-static {v4, v6, v8, v9}, extractRadix([BIII)J
...
.method private readTarHeader([B)Z
    ...
    invoke-static {v0, p1, v2, v1}, readExactly(Ljava/io/InputStream;[BII)I
    ...
    iget-object v1, p0, mBytesReadListener:Lcom/android/server/backup/utils/BytesReadListener;
...
.method public chooseRestorePolicy(Landroid/content/pm/PackageManager;ZLcom/android/server/backup/FileMetadata;[Landroid/content/pm/Signature;Landroid/content/pm/PackageManagerInternal;I)Lcom/android/server/backup/restore/RestorePolicy;
    ...
    iget-object v14, v1, mMonitor:Landroid/app/backup/IBackupManagerMonitor;
    ...
    iput-object v9, v1, mMonitor:Landroid/app/backup/IBackupManagerMonitor;
    :try_end_1
    ...
    iput-object v14, v1, mMonitor:Landroid/app/backup/IBackupManagerMonitor;
    ...
    iget-object v10, v1, mMonitor:Landroid/app/backup/IBackupManagerMonitor;
    ...
    iput-object v5, v1, mMonitor:Landroid/app/backup/IBackupManagerMonitor;
    ...
    iget-object v5, v1, mMonitor:Landroid/app/backup/IBackupManagerMonitor;
...
.method public readAppManifestAndReturnSignatures(Lcom/android/server/backup/FileMetadata;)[Landroid/content/pm/Signature;
    ...
    iget-object v0, v1, mInputStream:Ljava/io/InputStream;
    ...
    invoke-static {v0, v5, v7, v6}, readExactly(Ljava/io/InputStream;[BII)I
    ...
    iget-object v0, v1, mBytesReadListener:Lcom/android/server/backup/utils/BytesReadListener;
    ...
    :try_start_0
    invoke-static {v5, v8, v6}, extractLine([BI[Ljava/lang/String;)I
    ...
    iget-object v9, v1, mMonitor:Landroid/app/backup/IBackupManagerMonitor;
...
.method public readMetadata(Lcom/android/server/backup/FileMetadata;)V
    ...
    invoke-static {v1, v0, v3, v2}, readExactly(Ljava/io/InputStream;[BII)I
    ...
    invoke-static {v0, v3, v2}, extractLine([BI[Ljava/lang/String;)I
    ...
    invoke-static {v0, v4, v2}, extractLine([BI[Ljava/lang/String;)I
    ...
    iput-object v10, p0, mWidgetData:[B

    iget-object v10, p0, mWidgetData:[B
    ...
    iget-object v7, p0, mMonitor:Landroid/app/backup/IBackupManagerMonitor;
    ...
    iput-object v6, p0, mMonitor:Landroid/app/backup/IBackupManagerMonitor;
    ...
    iget-object v3, p0, mMonitor:Landroid/app/backup/IBackupManagerMonitor;
...
.method public readTarHeaders()Lcom/android/server/backup/FileMetadata;
    ...
    invoke-direct {p0, v3}, readTarHeader([B)Z
    ...
    invoke-static {v3, v6, v7, v8}, extractRadix([BIII)J
    ...
    invoke-static {v3, v6, v8, v8}, extractRadix([BIII)J
    ...
    invoke-static {v3, v7, v8}, extractString([BII)Ljava/lang/String;
    ...
    invoke-static {v3, v7, v6}, extractString([BII)Ljava/lang/String;
    ...
    invoke-direct {p0, v4}, readPaxExtendedHeader(Lcom/android/server/backup/FileMetadata;)Z
...
.method public skipTarPadding(J)V
    ...
    invoke-static {v4, v1, v5, v0}, readExactly(Ljava/io/InputStream;[BII)I

    move-result v4

    if-ne v4, v0, :cond_0

    iget-object v4, p0, mBytesReadListener:Lcom/android/server/backup/utils/BytesReadListener;
