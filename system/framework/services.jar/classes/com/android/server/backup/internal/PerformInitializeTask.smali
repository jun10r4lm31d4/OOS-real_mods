...
.method constructor <init>(Lcom/android/server/backup/UserBackupManagerService;Lcom/android/server/backup/TransportManager;[Ljava/lang/String;Landroid/app/backup/IBackupObserver;Lcom/android/server/backup/internal/OnTaskFinishedListener;Ljava/io/File;)V
    ...
    iput-object p2, p0, mTransportManager:Lcom/android/server/backup/TransportManager;

    iput-object p3, p0, mQueue:[Ljava/lang/String;

    iput-object p4, p0, mObserver:Landroid/app/backup/IBackupObserver;

    iput-object p5, p0, mListener:Lcom/android/server/backup/internal/OnTaskFinishedListener;

    iput-object p6, p0, mBaseStateDir:Ljava/io/File;
...
.method public constructor <init>(Lcom/android/server/backup/UserBackupManagerService;[Ljava/lang/String;Landroid/app/backup/IBackupObserver;Lcom/android/server/backup/internal/OnTaskFinishedListener;)V
    ...
    invoke-direct/range {v0 .. v6}, <init>(Lcom/android/server/backup/UserBackupManagerService;Lcom/android/server/backup/TransportManager;[Ljava/lang/String;Landroid/app/backup/IBackupObserver;Lcom/android/server/backup/internal/OnTaskFinishedListener;Ljava/io/File;)V
...
.method private notifyFinished(I)V
    ...
    :try_start_0
    iget-object v0, p0, mObserver:Landroid/app/backup/IBackupObserver;
    ...
    iput-object v1, p0, mObserver:Landroid/app/backup/IBackupObserver;
...
.method public run()V
    ...
    iget-object v4, v1, mQueue:[Ljava/lang/String;
    ...
    :try_start_0
    iget-object v0, v1, mQueue:[Ljava/lang/String;
    ...
    iget-object v10, v1, mTransportManager:Lcom/android/server/backup/TransportManager;
    ...
    iget-object v11, v1, mTransportManager:Lcom/android/server/backup/TransportManager;
    ...
    iget-object v7, v1, mBaseStateDir:Ljava/io/File;
    ...
    invoke-direct {v1, v9, v7}, notifyResult(Ljava/lang/String;I)V
    ...
    invoke-direct {v1, v9, v15}, notifyResult(Ljava/lang/String;I)V
    :try_end_1
    ...
    iget-object v6, v1, mBackupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    :cond_5
    invoke-direct {v1, v8}, notifyFinished(I)V

    iget-object v0, v1, mListener:Lcom/android/server/backup/internal/OnTaskFinishedListener;
    ...
    iget-object v6, v1, mTransportManager:Lcom/android/server/backup/TransportManager;
    ...
    iget-object v2, v1, mListener:Lcom/android/server/backup/internal/OnTaskFinishedListener;
