...
.method public constructor <init>(Lcom/android/server/backup/UserBackupManagerService;Ljava/io/File;Lcom/android/server/backup/FileMetadata;Landroid/os/ParcelFileDescriptor;Landroid/app/IBackupAgent;I)V
    ...
    iput-object p2, p0, mDataDir:Ljava/io/File;

    iput-object p3, p0, mInfo:Lcom/android/server/backup/FileMetadata;

    iput-object p4, p0, mInFD:Landroid/os/ParcelFileDescriptor;

    iput-object p5, p0, mAgent:Landroid/app/IBackupAgent;
...
.method private invokeAgentForAdbRestore(Landroid/app/IBackupAgent;Lcom/android/server/backup/FileMetadata;Ljava/io/File;)V
    ...
    iget-object v3, p0, mDataDir:Ljava/io/File;
...
.method private prepareRestoreData(Lcom/android/server/backup/FileMetadata;Landroid/os/ParcelFileDescriptor;)Ljava/io/File;
    ...
    invoke-direct {p0, v1, v2}, sortKeyValueData(Ljava/io/File;Ljava/io/File;)V
...
.method private sortKeyValueData(Ljava/io/File;Ljava/io/File;)V
    ...
    invoke-direct {p0, v2, v3}, copyKeysInLexicalOrder(Landroid/app/backup/BackupDataInput;Landroid/app/backup/BackupDataOutput;)V
    :try_end_0
...
.method public run()V
    ...
    :try_start_0
    iget-object v0, p0, mInfo:Lcom/android/server/backup/FileMetadata;

    iget-object v1, p0, mInFD:Landroid/os/ParcelFileDescriptor;

    invoke-direct {p0, v0, v1}, prepareRestoreData(Lcom/android/server/backup/FileMetadata;Landroid/os/ParcelFileDescriptor;)Ljava/io/File;

    move-result-object v0

    iget-object v1, p0, mAgent:Landroid/app/IBackupAgent;

    iget-object v2, p0, mInfo:Lcom/android/server/backup/FileMetadata;

    invoke-direct {p0, v1, v2, v0}, invokeAgentForAdbRestore(Landroid/app/IBackupAgent;Lcom/android/server/backup/FileMetadata;Ljava/io/File;)V
    :try_end_0
