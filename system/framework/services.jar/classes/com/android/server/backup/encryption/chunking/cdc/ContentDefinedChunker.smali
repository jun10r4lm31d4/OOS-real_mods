...
.method public constructor <init>(IILcom/android/server/backup/encryption/chunking/cdc/RabinFingerprint64;Lcom/android/server/backup/encryption/chunking/cdc/FingerprintMixer;Lcom/android/server/backup/encryption/chunking/cdc/ContentDefinedChunker$BreakpointPredicate;)V
    ...
    iput-object v0, p0, mChunkBuffer:[B

    iput-object p3, p0, mRabinFingerprint64:Lcom/android/server/backup/encryption/chunking/cdc/RabinFingerprint64;

    iput-object p5, p0, mBreakpointPredicate:Lcom/android/server/backup/encryption/chunking/cdc/ContentDefinedChunker$BreakpointPredicate;

    iput-object p4, p0, mFingerprintMixer:Lcom/android/server/backup/encryption/chunking/cdc/FingerprintMixer;

    iput p1, p0, mMinChunkSize:I
...
.method private getCurrentWindowStartByte(I)B
    ...
    :cond_0
    iget-object v0, p0, mChunkBuffer:[B
...
.method public chunkify(Ljava/io/InputStream;Lcom/android/server/backup/encryption/chunking/Chunker$ChunkConsumer;)V
    ...
    :goto_0
    iget-object v1, p0, mChunkBuffer:[B
    ...
    invoke-direct {p0, v2}, getCurrentWindowStartByte(I)B

    move-result v7

    iget-object v8, p0, mChunkBuffer:[B

    add-int/lit8 v9, v2, 0x1

    aput-byte v1, v8, v2

    iget-object v2, p0, mRabinFingerprint64:Lcom/android/server/backup/encryption/chunking/cdc/RabinFingerprint64;
    ...
    iget v2, p0, mMaxChunkSize:I

    if-ge v9, v2, :cond_1

    iget v2, p0, mMinChunkSize:I

    if-lt v9, v2, :cond_0

    iget-object v2, p0, mBreakpointPredicate:Lcom/android/server/backup/encryption/chunking/cdc/ContentDefinedChunker$BreakpointPredicate;

    iget-object v8, p0, mFingerprintMixer:Lcom/android/server/backup/encryption/chunking/cdc/FingerprintMixer;
    ...
    :cond_1
    :goto_2
    iget-object v2, p0, mChunkBuffer:[B
