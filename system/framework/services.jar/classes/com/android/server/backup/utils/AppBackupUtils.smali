...
.method static constructor <clinit>()V
    ...
    sput-object v0, systemPackagesWhitelistedForAllUsers:Ljava/util/Set;
...
.method static appIsDisabled(Landroid/content/pm/ApplicationInfo;I)Z
    ...
    invoke-static {p0, v0, p1}, appIsDisabled(Landroid/content/pm/ApplicationInfo;Landroid/content/pm/PackageManagerInternal;I)Z
...
.method public static appIsEligibleForBackup(Landroid/content/pm/ApplicationInfo;I)Z
    ...
    invoke-static {p0, v0, p1}, appIsEligibleForBackup(Landroid/content/pm/ApplicationInfo;Landroid/content/pm/PackageManagerInternal;I)Z
...
.method static appIsEligibleForBackup(Landroid/content/pm/ApplicationInfo;Landroid/content/pm/PackageManagerInternal;I)Z
    ...
    sget-object v0, systemPackagesWhitelistedForAllUsers:Ljava/util/Set;
    ...
    :cond_4
    invoke-static {p0, p1, p2}, appIsDisabled(Landroid/content/pm/ApplicationInfo;Landroid/content/pm/PackageManagerInternal;I)Z
...
.method public static appIsKeyValueOnly(Landroid/content/pm/PackageInfo;)Z
    ...
    invoke-static {p0}, appGetsFullBackup(Landroid/content/pm/PackageInfo;)Z
...
.method public static appIsRunningAndEligibleForBackupWithTransport(Lcom/android/server/backup/transport/TransportClient;Ljava/lang/String;Landroid/content/pm/PackageManager;I)Z
    ...
    invoke-static {v2, p3}, appIsEligibleForBackup(Landroid/content/pm/ApplicationInfo;I)Z

    move-result v3

    if-eqz v3, :cond_2

    invoke-static {v2}, appIsStopped(Landroid/content/pm/ApplicationInfo;)Z

    move-result v3

    if-nez v3, :cond_2

    invoke-static {v2, p3}, appIsDisabled(Landroid/content/pm/ApplicationInfo;I)Z
    ...
    invoke-static {v0}, appGetsFullBackup(Landroid/content/pm/PackageInfo;)Z
