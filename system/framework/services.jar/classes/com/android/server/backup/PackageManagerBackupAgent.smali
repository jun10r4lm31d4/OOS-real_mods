...
.method public constructor <init>(Landroid/content/pm/PackageManager;I)V
    ...
    invoke-direct {p0, p1, v0, p2}, init(Landroid/content/pm/PackageManager;Ljava/util/List;I)V
...
.method public constructor <init>(Landroid/content/pm/PackageManager;Ljava/util/List;I)V
    ...
    invoke-direct {p0, p1, p2, p3}, init(Landroid/content/pm/PackageManager;Ljava/util/List;I)V
...
.method static synthetic access$1002(Lcom/android/server/backup/PackageManagerBackupAgent;Ljava/util/HashMap;)Ljava/util/HashMap;
    ...
    iput-object p1, p0, mRestoredSignatures:Ljava/util/HashMap;
...
.method static synthetic access$202(Lcom/android/server/backup/PackageManagerBackupAgent;I)I
    ...
    iput p1, p0, mStoredSdkVersion:I
...
.method static synthetic access$302(Lcom/android/server/backup/PackageManagerBackupAgent;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object p1, p0, mStoredIncrementalVersion:Ljava/lang/String;
...
.method static synthetic access$402(Lcom/android/server/backup/PackageManagerBackupAgent;Z)Z
    ...
    iput-boolean p1, p0, mHasMetadata:Z
...
.method static synthetic access$502(Lcom/android/server/backup/PackageManagerBackupAgent;Landroid/content/ComponentName;)Landroid/content/ComponentName;
    ...
    iput-object p1, p0, mRestoredHome:Landroid/content/ComponentName;
...
.method static synthetic access$602(Lcom/android/server/backup/PackageManagerBackupAgent;J)J
    ...
    iput-wide p1, p0, mRestoredHomeVersion:J
...
.method static synthetic access$702(Lcom/android/server/backup/PackageManagerBackupAgent;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object p1, p0, mRestoredHomeInstaller:Ljava/lang/String;
...
.method static synthetic access$802(Lcom/android/server/backup/PackageManagerBackupAgent;Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    iput-object p1, p0, mRestoredHomeSigHashes:Ljava/util/ArrayList;
...
.method static synthetic access$900(Ljava/io/DataInputStream;)Ljava/util/ArrayList;
    ...
    invoke-static {p0}, readSignatureHashArray(Ljava/io/DataInputStream;)Ljava/util/ArrayList;
...
.method private parseStateFile(Landroid/os/ParcelFileDescriptor;)V
    ...
    iget-object v2, p0, mExisting:Ljava/util/HashSet;

    invoke-virtual {v2}, Ljava/util/HashSet;->clear()V

    iget-object v2, p0, mStateVersions:Ljava/util/HashMap;

    invoke-virtual {v2}, Ljava/util/HashMap;->clear()V

    const/4 v2, 0x0

    iput v2, p0, mStoredSdkVersion:I

    const/4 v2, 0x0

    iput-object v2, p0, mStoredIncrementalVersion:Ljava/lang/String;

    iput-object v2, p0, mStoredHomeComponent:Landroid/content/ComponentName;

    const-wide/16 v3, 0x0

    iput-wide v3, p0, mStoredHomeVersion:J

    iput-object v2, p0, mStoredHomeSigHashes:Ljava/util/ArrayList;
    ...
    invoke-static {v5}, readSignatureHashArray(Ljava/io/DataInputStream;)Ljava/util/ArrayList;
    ...
    iget-object v10, p0, mExisting:Ljava/util/HashSet;

    invoke-virtual {v10, v7}, Ljava/util/HashSet;->add(Ljava/lang/Object;)Z

    :cond_5
    iget-object v10, p0, mStateVersions:Ljava/util/HashMap;
...
.method public evaluateStorablePackages()V
    ...
    invoke-static {v0, v1}, getStorableApplications(Landroid/content/pm/PackageManager;I)Ljava/util/List;
...
.method public onBackup(Landroid/os/ParcelFileDescriptor;Landroid/app/backup/BackupDataOutput;Landroid/os/ParcelFileDescriptor;)V
    ...
    iget-object v0, v8, mStoredIncrementalVersion:Ljava/lang/String;
    ...
    iget-object v4, v8, mStoredIncrementalVersion:Ljava/lang/String;
    ...
    iget-object v0, v8, mExisting:Ljava/util/HashSet;
    ...
    invoke-static {v9, v0, v5}, writeEntity(Landroid/app/backup/BackupDataOutput;Ljava/lang/String;[B)V
    :try_end_0
    ...
    :try_start_1
    iget-object v0, v8, mPackageManager:Landroid/content/pm/PackageManager;

    invoke-virtual {v14}, Landroid/content/ComponentName;->getPackageName()Ljava/lang/String;

    move-result-object v4

    iget v15, v8, mUserId:I
    :try_end_1
    ...
    iget-wide v5, v8, mStoredHomeVersion:J
    :try_end_4
    ...
    :try_start_5
    iget-object v0, v8, mStoredHomeComponent:Landroid/content/ComponentName;
    ...
    iget-object v0, v8, mStoredHomeSigHashes:Ljava/util/ArrayList;
    ...
    invoke-static {v11, v7}, writeSignatureHashArray(Ljava/io/DataOutputStream;Ljava/util/ArrayList;)V

    invoke-virtual {v10}, Ljava/io/ByteArrayOutputStream;->toByteArray()[B

    move-result-object v6

    invoke-static {v9, v0, v6}, writeEntity(Landroid/app/backup/BackupDataOutput;Ljava/lang/String;[B)V
    ...
    invoke-static {v9, v2, v0}, writeEntity(Landroid/app/backup/BackupDataOutput;Ljava/lang/String;[B)V
    :try_end_8
    ...
    :goto_7
    iget-object v0, v8, mAllPackages:Ljava/util/List;
    ...
    :try_start_e
    iget-object v2, v8, mExisting:Ljava/util/HashSet;
    ...
    iget-object v2, v8, mStateVersions:Ljava/util/HashMap;
    ...
    invoke-static {v11, v6}, writeSignatureHashArray(Ljava/io/DataOutputStream;Ljava/util/ArrayList;)V

    invoke-virtual {v10}, Ljava/io/ByteArrayOutputStream;->toByteArray()[B

    move-result-object v6

    invoke-static {v9, v4, v6}, writeEntity(Landroid/app/backup/BackupDataOutput;Ljava/lang/String;[B)V
    ...
    iget-object v2, v8, mAllPackages:Ljava/util/List;
    ...
    invoke-direct/range {v1 .. v7}, writeStateFile(Ljava/util/List;Landroid/content/ComponentName;JLjava/util/ArrayList;Landroid/os/ParcelFileDescriptor;)V
...
.method public onRestore(Landroid/app/backup/BackupDataInput;ILandroid/os/ParcelFileDescriptor;)V
    ...
    invoke-direct {p0, p1}, getAncestralRecordVersionValue(Landroid/app/backup/BackupDataInput;)I

    move-result v0

    invoke-direct {p0, v0}, getRestoreDataConsumer(I)Lcom/android/server/backup/PackageManagerBackupAgent$RestoreDataConsumer;
