...
.method public constructor <init>(Ljava/io/OutputStream;Landroid/content/pm/PackageInfo;Lcom/android/server/backup/UserBackupManagerService;Landroid/content/pm/PackageManager;Ljava/io/File;Ljava/io/File;)V
    ...
    iput-object p1, p0, mOutput:Ljava/io/OutputStream;

    iput-object p2, p0, mCurrentPackage:Landroid/content/pm/PackageInfo;

    iput-object p3, p0, mBackupManagerService:Lcom/android/server/backup/UserBackupManagerService;

    iput-object p4, p0, mPackageManager:Landroid/content/pm/PackageManager;

    iput-object p6, p0, mDataDir:Ljava/io/File;
    ...
    iget-object v0, p0, mStateDir:Ljava/io/File;
    ...
    iget-object v2, p0, mStateDir:Ljava/io/File;

    const-string v3, "blank_state"

    invoke-direct {v1, v2, v3}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    iput-object v1, p0, mBlankStateName:Ljava/io/File;

    new-instance v1, Ljava/io/File;

    iget-object v2, p0, mDataDir:Ljava/io/File;
    ...
    iput-object v1, p0, mBackupDataName:Ljava/io/File;
    ...
    iput-object v1, p0, mNewStateName:Ljava/io/File;
    ...
    iput-object v1, p0, mManifestFile:Ljava/io/File;
    ...
    iput-object v1, p0, mAgentTimeoutParameters:Lcom/android/server/backup/BackupAgentTimeoutParameters;
...
.method static synthetic access$100(Lcom/android/server/backup/KeyValueAdbBackupEngine;)Ljava/io/File;
    ...
    iget-object v0, p0, mManifestFile:Ljava/io/File;
...
.method private cleanup()V
    ...
    iget-object v0, p0, mBlankStateName:Ljava/io/File;
...
.method private invokeAgentForAdbBackup(Ljava/lang/String;Landroid/app/IBackupAgent;)Z
    ...
    iget-object v15, v1, mSavedState:Landroid/os/ParcelFileDescriptor;

    iget-object v0, v1, mBackupData:Landroid/os/ParcelFileDescriptor;

    iget-object v4, v1, mNewState:Landroid/os/ParcelFileDescriptor;
...
.method private writeBackupData()V
    ...
    iget-object v5, p0, mOutput:Ljava/io/OutputStream;
    ...
    :cond_0
    iget-object v0, p0, mOutput:Ljava/io/OutputStream;
    ...
    :goto_3
    iget-object v2, p0, mOutput:Ljava/io/OutputStream;
...
.method public backupOnePackage()V
    ...
    invoke-direct {p0, v2}, prepareBackupFiles(Ljava/lang/String;)V

    invoke-direct {p0, v1}, bindToAgent(Landroid/content/pm/ApplicationInfo;)Landroid/app/IBackupAgent;
    ...
    invoke-direct {p0, v3, v2}, invokeAgentForAdbBackup(Ljava/lang/String;Landroid/app/IBackupAgent;)Z
    ...
    :cond_1
    :try_start_2
    invoke-direct {p0}, writeBackupData()V
    :try_end_2
