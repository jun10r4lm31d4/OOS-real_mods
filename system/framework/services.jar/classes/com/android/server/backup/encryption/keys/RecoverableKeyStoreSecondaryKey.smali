...
.method public constructor <init>(Ljava/lang/String;Ljavax/crypto/SecretKey;)V
    ...
    iput-object v0, p0, mSecretKey:Ljavax/crypto/SecretKey;
...
.method public getSecretKey()Ljavax/crypto/SecretKey;
    ...
    iget-object v0, p0, mSecretKey:Ljavax/crypto/SecretKey;
...
.method public getStatus(Landroid/content/Context;)I
    ...
    :try_start_0
    invoke-direct {p0, p1}, getStatusInternal(Landroid/content/Context;)I
