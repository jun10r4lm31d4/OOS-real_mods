...
.method public constructor <init>(Ljava/io/OutputStream;I)V
    ...
    iput p2, p0, mMaxNewByteChunkSize:I

    new-array v0, p2, [B

    iput-object v0, p0, mByteBuffer:[B
...
.method private writeByteBuffer()V
    ...
    sget-object v2, UTF_8:Ljava/nio/charset/Charset;
    ...
    iget-object v2, p0, mByteBuffer:[B

    iget v3, p0, mBufferSize:I
...
.method private writeReusableChunk()V
    ...
    iget-object v0, p0, mReusableChunk:Lcom/android/server/backup/encryption/chunking/ByteRange;
    ...
    iget-object v4, p0, mReusableChunk:Lcom/android/server/backup/encryption/chunking/ByteRange;
    ...
    iput-object v0, p0, mReusableChunk:Lcom/android/server/backup/encryption/chunking/ByteRange;
...
.method public flush()V
    ...
    invoke-direct {p0}, writeByteBuffer()V
    ...
    invoke-direct {p0}, writeReusableChunk()V
...
.method public writeByte(B)V
    ...
    :cond_0
    iget-object v0, p0, mByteBuffer:[B

    iget v1, p0, mBufferSize:I

    add-int/lit8 v2, v1, 0x1

    iput v2, p0, mBufferSize:I

    aput-byte p1, v0, v1

    iget v0, p0, mBufferSize:I

    iget v1, p0, mMaxNewByteChunkSize:I
