...
.method public constructor <init>(Lcom/android/server/backup/UserBackupManagerService;Lcom/android/server/backup/transport/TransportClient;Landroid/app/backup/IRestoreObserver;Landroid/app/backup/IBackupManagerMonitor;JLandroid/content/pm/PackageInfo;IZ[Ljava/lang/String;Lcom/android/server/backup/internal/OnTaskFinishedListener;)V
    ...
    iput-object v3, v1, backupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    iput v0, v1, mEphemeralOpToken:I
    ...
    iput-object v0, v1, mState:Lcom/android/server/backup/restore/UnifiedRestoreState;

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J

    move-result-wide v4

    iput-wide v4, v1, mStartRealtime:J

    move-object/from16 v4, p2

    iput-object v4, v1, mTransportClient:Lcom/android/server/backup/transport/TransportClient;

    move-object/from16 v5, p3

    iput-object v5, v1, mObserver:Landroid/app/backup/IRestoreObserver;

    move-object/from16 v6, p4

    iput-object v6, v1, mMonitor:Landroid/app/backup/IBackupManagerMonitor;

    move-wide/from16 v7, p5

    iput-wide v7, v1, mToken:J

    move/from16 v9, p8

    iput v9, v1, mPmToken:I

    iput-object v2, v1, mTargetPackage:Landroid/content/pm/PackageInfo;

    move/from16 v10, p9

    iput-boolean v10, v1, mIsSystemRestore:Z

    const/4 v11, 0x0

    iput-boolean v11, v1, mFinished:Z

    iput-boolean v11, v1, mDidLaunch:Z

    move-object/from16 v12, p11

    iput-object v12, v1, mListener:Lcom/android/server/backup/internal/OnTaskFinishedListener;
    ...
    iput-object v0, v1, mAgentTimeoutParameters:Lcom/android/server/backup/BackupAgentTimeoutParameters;
    ...
    iput-object v0, v1, mAcceptSet:Ljava/util/List;

    iget-object v0, v1, mAcceptSet:Ljava/util/List;
    ...
    invoke-direct {v1, v0}, packagesToNames(Ljava/util/List;)[Ljava/lang/String;
    ...
    iget-object v2, v1, mAcceptSet:Ljava/util/List;
...
.method static synthetic access$000(Lcom/android/server/backup/restore/PerformUnifiedRestoreTask;)Lcom/android/server/backup/UserBackupManagerService;
    ...
    iget-object v0, p0, backupManagerService:Lcom/android/server/backup/UserBackupManagerService;
...
.method static synthetic access$200(Lcom/android/server/backup/restore/PerformUnifiedRestoreTask;)Landroid/app/backup/IBackupManagerMonitor;
    ...
    iget-object v0, p0, mMonitor:Landroid/app/backup/IBackupManagerMonitor;
...
.method static synthetic access$202(Lcom/android/server/backup/restore/PerformUnifiedRestoreTask;Landroid/app/backup/IBackupManagerMonitor;)Landroid/app/backup/IBackupManagerMonitor;
    ...
    iput-object p1, p0, mMonitor:Landroid/app/backup/IBackupManagerMonitor;
...
.method static synthetic access$300(Lcom/android/server/backup/restore/PerformUnifiedRestoreTask;)Lcom/android/server/backup/transport/TransportClient;
    ...
    iget-object v0, p0, mTransportClient:Lcom/android/server/backup/transport/TransportClient;
...
.method static synthetic access$402(Lcom/android/server/backup/restore/PerformUnifiedRestoreTask;Z)Z
    ...
    iput-boolean p1, p0, mDidLaunch:Z
...
.method static synthetic access$602(Lcom/android/server/backup/restore/PerformUnifiedRestoreTask;[B)[B
    ...
    iput-object p1, p0, mWidgetData:[B
...
.method private dispatchNextRestore()V
    ...
    :try_start_0
    iget-object v0, v1, mTransportClient:Lcom/android/server/backup/transport/TransportClient;
    ...
    iput-object v0, v1, mRestoreDescription:Landroid/app/backup/RestoreDescription;

    iget-object v0, v1, mRestoreDescription:Landroid/app/backup/RestoreDescription;
    ...
    invoke-virtual {v1, v0}, executeNextState(Lcom/android/server/backup/restore/UnifiedRestoreState;)V
    ...
    iget-wide v14, v1, mStartRealtime:J
    ...
    invoke-virtual {v1, v2}, executeNextState(Lcom/android/server/backup/restore/UnifiedRestoreState;)V
    ...
    iget-object v9, v1, mRestoreDescription:Landroid/app/backup/RestoreDescription;
    ...
    invoke-virtual {v1, v8}, sendOnRestorePackage(Ljava/lang/String;)V

    iget-object v0, v1, mPmAgent:Lcom/android/server/backup/PackageManagerBackupAgent;
    ...
    :try_start_3
    iget-object v0, v1, backupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    iput-object v0, v1, mCurrentPackage:Landroid/content/pm/PackageInfo;
    :try_end_3
    ...
    iget-object v0, v1, mCurrentPackage:Landroid/content/pm/PackageInfo;
    ...
    iget-object v10, v1, mCurrentPackage:Landroid/content/pm/PackageInfo;
    ...
    iget-object v7, v1, mMonitor:Landroid/app/backup/IBackupManagerMonitor;
    ...
    iput-object v7, v1, mMonitor:Landroid/app/backup/IBackupManagerMonitor;
    ...
    iget-object v4, v1, mMonitor:Landroid/app/backup/IBackupManagerMonitor;
    ...
    iput-object v4, v1, mMonitor:Landroid/app/backup/IBackupManagerMonitor;

    :cond_5
    iput-object v7, v1, mWidgetData:[B
    ...
    iget-object v11, v1, mCurrentPackage:Landroid/content/pm/PackageInfo;
    ...
    :goto_2
    invoke-virtual {v1, v3}, executeNextState(Lcom/android/server/backup/restore/UnifiedRestoreState;)V
...
.method private finalizeRestore()V
    ...
    :try_start_0
    iget-object v1, p0, mTransportClient:Lcom/android/server/backup/transport/TransportClient;
    ...
    :cond_0
    :goto_1
    iget-object v1, p0, backupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    iget v2, p0, mPmToken:I

    iget-boolean v3, p0, mDidLaunch:Z
    ...
    :cond_1
    iget-object v1, p0, mAgentTimeoutParameters:Lcom/android/server/backup/BackupAgentTimeoutParameters;
    ...
    iget-boolean v1, p0, mIsSystemRestore:Z

    if-eqz v1, :cond_2

    iget-object v1, p0, mPmAgent:Lcom/android/server/backup/PackageManagerBackupAgent;

    if-eqz v1, :cond_2

    iget-object v2, p0, backupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    iget-object v3, p0, backupManagerService:Lcom/android/server/backup/UserBackupManagerService;

    invoke-virtual {v3}, Lcom/android/server/backup/UserBackupManagerService;->getBackupHandler()Landroid/os/Handler;

    move-result-object v3

    iget-object v4, p0, backupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    iget-object v1, p0, mListener:Lcom/android/server/backup/internal/OnTaskFinishedListener;
...
.method private restoreFinished()V
    ...
    iget v3, p0, mEphemeralOpToken:I
    ...
    iget v2, p0, mEphemeralOpToken:I
    ...
    invoke-virtual {p0, v5}, keyValueAgentErrorCleanup(Z)V
    ...
    invoke-virtual {p0, v1}, executeNextState(Lcom/android/server/backup/restore/UnifiedRestoreState;)V
...
.method private restoreKeyValue()V
    ...
    iget-object v8, p0, mMonitor:Landroid/app/backup/IBackupManagerMonitor;

    const/16 v10, 0x1d

    iget-object v11, p0, mCurrentPackage:Landroid/content/pm/PackageInfo;
    ...
    iput-object v3, p0, mMonitor:Landroid/app/backup/IBackupManagerMonitor;
    ...
    invoke-virtual {p0, v2}, executeNextState(Lcom/android/server/backup/restore/UnifiedRestoreState;)V

    return-void

    :cond_1
    iget-object v8, p0, backupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    iput-object v8, p0, mAgent:Landroid/app/IBackupAgent;

    iget-object v8, p0, mAgent:Landroid/app/IBackupAgent;
    ...
    :cond_2
    iput-boolean v5, p0, mDidLaunch:Z
    ...
    invoke-virtual {p0, v2, v3, v4}, initiateOneRestore(Landroid/content/pm/PackageInfo;J)V
    ...
    invoke-virtual {p0, v6}, keyValueAgentErrorCleanup(Z)V
    ...
    invoke-virtual {p0, v3}, executeNextState(Lcom/android/server/backup/restore/UnifiedRestoreState;)V
    ...
    :cond_3
    :goto_1
    iget-object v1, p0, mMonitor:Landroid/app/backup/IBackupManagerMonitor;
    ...
    iput-object v1, p0, mMonitor:Landroid/app/backup/IBackupManagerMonitor;
...
.method private startRestore()V
    ...
    iget-object v3, v1, mAcceptSet:Ljava/util/List;

    invoke-interface {v3}, Ljava/util/List;->size()I

    move-result v3

    invoke-virtual {p0, v3}, sendStartRestore(I)V

    iget-boolean v3, v1, mIsSystemRestore:Z
    ...
    :try_start_0
    iget-object v7, v1, mTransportManager:Lcom/android/server/backup/TransportManager;

    iget-object v8, v1, mTransportClient:Lcom/android/server/backup/transport/TransportClient;
    ...
    iget-object v9, v1, backupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    iput-object v8, v1, mStateDir:Ljava/io/File;
    ...
    iget-object v9, v1, mAcceptSet:Ljava/util/List;
    ...
    iget-object v11, v1, mTransportClient:Lcom/android/server/backup/transport/TransportClient;
    ...
    iput v12, v1, mStatus:I

    iget v12, v1, mStatus:I
    ...
    iput v5, v1, mStatus:I

    sget-object v0, Lcom/android/server/backup/restore/UnifiedRestoreState;->FINAL:Lcom/android/server/backup/restore/UnifiedRestoreState;

    invoke-virtual {p0, v0}, executeNextState(Lcom/android/server/backup/restore/UnifiedRestoreState;)V
    ...
    iget-object v0, v1, mMonitor:Landroid/app/backup/IBackupManagerMonitor;

    const/16 v10, 0x16

    iget-object v14, v1, mCurrentPackage:Landroid/content/pm/PackageInfo;
    ...
    iput-object v0, v1, mMonitor:Landroid/app/backup/IBackupManagerMonitor;
    ...
    iput-object v14, v1, mCurrentPackage:Landroid/content/pm/PackageInfo;

    iget-object v14, v1, mCurrentPackage:Landroid/content/pm/PackageInfo;

    iput-object v0, v14, Landroid/content/pm/PackageInfo;->packageName:Ljava/lang/String;

    iget-object v14, v1, backupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    iput-object v14, v1, mPmAgent:Lcom/android/server/backup/PackageManagerBackupAgent;

    iget-object v14, v1, mPmAgent:Lcom/android/server/backup/PackageManagerBackupAgent;
    ...
    iput-object v14, v1, mAgent:Landroid/app/IBackupAgent;

    iget-object v14, v1, mCurrentPackage:Landroid/content/pm/PackageInfo;

    const-wide/16 v3, 0x0

    invoke-virtual {p0, v14, v3, v4}, initiateOneRestore(Landroid/content/pm/PackageInfo;J)V

    iget-object v3, v1, backupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    iget-object v3, v1, mPmAgent:Lcom/android/server/backup/PackageManagerBackupAgent;
    ...
    iget-object v3, v1, mMonitor:Landroid/app/backup/IBackupManagerMonitor;
    ...
    iput-object v3, v1, mMonitor:Landroid/app/backup/IBackupManagerMonitor;
    ...
    iget-object v2, v1, mMonitor:Landroid/app/backup/IBackupManagerMonitor;
    ...
    iput-object v2, v1, mMonitor:Landroid/app/backup/IBackupManagerMonitor;

    iput v5, v1, mStatus:I

    iget-object v2, v1, backupManagerService:Lcom/android/server/backup/UserBackupManagerService;
...
.method public execute()V
    ...
    iget-object v1, p0, mState:Lcom/android/server/backup/restore/UnifiedRestoreState;
...
.method executeNextState(Lcom/android/server/backup/restore/UnifiedRestoreState;)V
    ...
    iput-object p1, p0, mState:Lcom/android/server/backup/restore/UnifiedRestoreState;
...
.method public handleCancel(Z)V
    ...
    iget v1, p0, mEphemeralOpToken:I
    ...
    iput-object v0, p0, mMonitor:Landroid/app/backup/IBackupManagerMonitor;
    ...
    invoke-virtual {p0, v1}, keyValueAgentErrorCleanup(Z)V
...
.method initiateOneRestore(Landroid/content/pm/PackageInfo;J)V
    ...
    iget-object v1, v7, backupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    iput-object v0, v7, mBackupDataName:Ljava/io/File;
    ...
    iput-object v0, v7, mStageName:Ljava/io/File;

    new-instance v0, Ljava/io/File;

    iget-object v1, v7, mStateDir:Ljava/io/File;
    ...
    iput-object v0, v7, mNewStateName:Ljava/io/File;
    ...
    iput-object v0, v7, mSavedStateName:Ljava/io/File;
    ...
    iget-object v0, v7, mStageName:Ljava/io/File;

    goto :goto_0

    :cond_0
    iget-object v0, v7, mBackupDataName:Ljava/io/File;
    ...
    :try_start_0
    iget-object v0, v7, mTransportClient:Lcom/android/server/backup/transport/TransportClient;
    ...
    invoke-virtual {v7, v1}, executeNextState(Lcom/android/server/backup/restore/UnifiedRestoreState;)V
    ...
    iget-object v4, v7, mBackupDataName:Ljava/io/File;

    invoke-static {v4, v1}, Landroid/os/ParcelFileDescriptor;->open(Ljava/io/File;I)Landroid/os/ParcelFileDescriptor;

    move-result-object v4

    iput-object v4, v7, mBackupData:Landroid/os/ParcelFileDescriptor;
    ...
    iget-object v6, v7, mBackupData:Landroid/os/ParcelFileDescriptor;
    ...
    iput-object v11, v7, mWidgetData:[B

    iget-object v11, v7, mWidgetData:[B
    ...
    :cond_4
    iget-object v1, v7, mBackupData:Landroid/os/ParcelFileDescriptor;
    ...
    iget-object v1, v7, mBackupDataName:Ljava/io/File;
    ...
    iput-object v1, v7, mBackupData:Landroid/os/ParcelFileDescriptor;

    iget-object v1, v7, mNewStateName:Ljava/io/File;
    ...
    iput-object v1, v7, mNewState:Landroid/os/ParcelFileDescriptor;

    iget-object v1, v7, mAgentTimeoutParameters:Lcom/android/server/backup/BackupAgentTimeoutParameters;
    ...
    iget v2, v7, mEphemeralOpToken:I
    ...
    iget-object v1, v7, mAgent:Landroid/app/IBackupAgent;

    iget-object v2, v7, mBackupData:Landroid/os/ParcelFileDescriptor;

    iget-object v5, v7, mNewState:Landroid/os/ParcelFileDescriptor;

    iget v6, v7, mEphemeralOpToken:I

    iget-object v15, v7, backupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    invoke-virtual {v7, v14}, keyValueAgentErrorCleanup(Z)V
...
.method keyValueAgentCleanup()V
    ...
    iget-object v1, p0, mRestoreDescription:Landroid/app/backup/RestoreDescription;
...
.method public operationComplete(J)V
    ...
    iget-object v2, p0, mState:Lcom/android/server/backup/restore/UnifiedRestoreState;
    ...
    iget-object v1, p0, mWidgetData:[B
...
.method sendEndRestore()V
    ...
    iget-object v0, p0, mObserver:Landroid/app/backup/IRestoreObserver;
