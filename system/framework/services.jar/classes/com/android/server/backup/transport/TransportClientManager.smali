...
.method public constructor <init>(ILandroid/content/Context;Lcom/android/server/backup/transport/TransportStats;)V
    ...
    iput-object v0, p0, mTransportClientsLock:Ljava/lang/Object;

    const/4 v0, 0x0

    iput v0, p0, mTransportClientsCreated:I

    new-instance v0, Ljava/util/WeakHashMap;

    invoke-direct {v0}, Ljava/util/WeakHashMap;-><init>()V

    iput-object v0, p0, mTransportClientsCallerMap:Ljava/util/Map;
...
.method private getTransportClient(Landroid/content/ComponentName;Ljava/lang/String;Landroid/content/Intent;)Lcom/android/server/backup/transport/TransportClient;
    ...
    iget-object v0, p0, mTransportClientsLock:Ljava/lang/Object;
    ...
    iget-object v4, p0, mTransportStats:Lcom/android/server/backup/transport/TransportStats;

    iget v1, p0, mTransportClientsCreated:I
    ...
    iget-object v2, p0, mTransportClientsCallerMap:Ljava/util/Map;

    invoke-interface {v2, v1, p2}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    iget v2, p0, mTransportClientsCreated:I

    add-int/lit8 v2, v2, 0x1

    iput v2, p0, mTransportClientsCreated:I
...
.method public disposeOfTransportClient(Lcom/android/server/backup/transport/TransportClient;Ljava/lang/String;)V
    ...
    iget-object v1, p0, mTransportClientsCallerMap:Ljava/util/Map;
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    iget-object v3, p0, mTransportClientsCallerMap:Ljava/util/Map;
...
.method public getTransportClient(Landroid/content/ComponentName;Landroid/os/Bundle;Ljava/lang/String;)Lcom/android/server/backup/transport/TransportClient;
    ...
    invoke-direct {p0, p1, p3, v0}, getTransportClient(Landroid/content/ComponentName;Ljava/lang/String;Landroid/content/Intent;)Lcom/android/server/backup/transport/TransportClient;
...
.method public getTransportClient(Landroid/content/ComponentName;Ljava/lang/String;)Lcom/android/server/backup/transport/TransportClient;
    ...
    invoke-direct {p0, p1, p2, v0}, getTransportClient(Landroid/content/ComponentName;Ljava/lang/String;Landroid/content/Intent;)Lcom/android/server/backup/transport/TransportClient;
