...
.method constructor <init>(Lcom/android/server/backup/fullbackup/FullBackupEngine;Lcom/android/server/backup/UserBackupManagerService;Landroid/content/pm/PackageInfo;Landroid/app/IBackupAgent;Landroid/os/ParcelFileDescriptor;IZ)V
    ...
    iput-object p1, p0, this$0:Lcom/android/server/backup/fullbackup/FullBackupEngine;
    ...
    iput-object p4, p0, mAgent:Landroid/app/IBackupAgent;
    ...
    iput-boolean p7, p0, mIncludeApks:Z
...
.method public run()V
    ...
    iget-object v3, v1, mPipe:Landroid/os/ParcelFileDescriptor;

    const-wide/16 v4, -0x1

    iget-object v6, v1, this$0:Lcom/android/server/backup/fullbackup/FullBackupEngine;
    ...
    iget-object v4, v1, mPackage:Landroid/content/pm/PackageInfo;
    ...
    iget-object v6, v1, mPackage:Landroid/content/pm/PackageInfo;

    iget-object v6, v6, Landroid/content/pm/PackageInfo;->applicationInfo:Landroid/content/pm/ApplicationInfo;

    iget-boolean v7, v1, mIncludeApks:Z

    invoke-direct {v1, v6, v7, v5}, shouldWriteApk(Landroid/content/pm/ApplicationInfo;ZZ)Z
    ...
    iget-object v8, v1, mFilesDir:Ljava/io/File;

    const-string v9, "_manifest"

    invoke-direct {v7, v8, v9}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    iget-object v8, v1, mPackage:Landroid/content/pm/PackageInfo;

    iget-object v9, v1, mFilesDir:Ljava/io/File;
    ...
    iget-object v10, v1, mFilesDir:Ljava/io/File;

    const-string v11, "_meta"

    invoke-direct {v9, v10, v11}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    iget-object v10, v1, mPackage:Landroid/content/pm/PackageInfo;

    iget-object v11, v1, mFilesDir:Ljava/io/File;
    ...
    iget-object v7, v1, mPackage:Landroid/content/pm/PackageInfo;
    ...
    iget-object v7, v1, this$0:Lcom/android/server/backup/fullbackup/FullBackupEngine;
    ...
    iget-object v15, v1, mAgent:Landroid/app/IBackupAgent;

    iget-object v7, v1, mPipe:Landroid/os/ParcelFileDescriptor;

    iget-object v8, v1, this$0:Lcom/android/server/backup/fullbackup/FullBackupEngine;
    ...
    iget-object v9, v1, this$0:Lcom/android/server/backup/fullbackup/FullBackupEngine;
    ...
    :try_start_1
    iget-object v0, v1, mPipe:Landroid/os/ParcelFileDescriptor;
