...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-virtual {p0}, isBackupDisabled()Z

    move-result v0

    iput-boolean v0, p0, mGlobalDisable:Z
...
.method private activateBackupForUserLocked(I)V
    ...
    invoke-virtual {p0}, getSuppressFileForSystemUser()Ljava/io/File;

    move-result-object v0

    invoke-direct {p0, v0}, deleteFile(Ljava/io/File;)V

    goto :goto_0

    :cond_0
    invoke-virtual {p0, p1}, getActivatedFileForNonSystemUser(I)Ljava/io/File;

    move-result-object v0

    invoke-direct {p0, v0}, createFile(Ljava/io/File;)V
...
.method private enforcePermissionsOnUser(I)V
    ...
    invoke-virtual {p0}, getUserManager()Landroid/os/UserManager;
    ...
    invoke-virtual {p0}, binderGetCallingUid()I
...
.method private isUserReadyForBackup(I)Z
    ...
    invoke-direct {p0, p1}, isBackupActivatedForUser(I)Z
...
.method public acknowledgeFullBackupOrRestore(IZLjava/lang/String;Ljava/lang/String;Landroid/app/backup/IFullBackupRestoreObserver;)V
    ...
    invoke-virtual {p0}, binderGetCallingUserId()I
    ...
    invoke-virtual/range {v0 .. v6}, acknowledgeFullBackupOrRestoreForUser(IIZLjava/lang/String;Ljava/lang/String;Landroid/app/backup/IFullBackupRestoreObserver;)V
...
.method public acknowledgeFullBackupOrRestoreForUser(IIZLjava/lang/String;Ljava/lang/String;Landroid/app/backup/IFullBackupRestoreObserver;)V
    ...
    invoke-direct {p0, p1}, isUserReadyForBackup(I)Z
...
.method public adbBackup(ILandroid/os/ParcelFileDescriptor;ZZZZZZZZ[Ljava/lang/String;)V
    ...
    iget-object v1, v0, mService:Lcom/android/server/backup/BackupManagerService;
...
.method public agentConnected(Ljava/lang/String;Landroid/os/IBinder;)V
    ...
    invoke-virtual {p0, v0, p1, p2}, agentConnectedForUser(ILjava/lang/String;Landroid/os/IBinder;)V
...
.method public agentDisconnected(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0, p1}, agentDisconnectedForUser(ILjava/lang/String;)V
...
.method public backupNow()V
    ...
    invoke-virtual {p0, v0}, backupNowForUser(I)V
...
.method public cancelBackups()V
    ...
    invoke-virtual {p0, v0}, cancelBackupsForUser(I)V
...
.method public clearBackupData(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0, p1, p2}, clearBackupDataForUser(ILjava/lang/String;Ljava/lang/String;)V
...
.method public dataChanged(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0, p1}, dataChangedForUser(ILjava/lang/String;)V
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0}, isUserReadyForBackup(I)Z
...
.method public getConfigurationIntent(Ljava/lang/String;)Landroid/content/Intent;
    ...
    invoke-virtual {p0, v0, p1}, getConfigurationIntentForUser(ILjava/lang/String;)Landroid/content/Intent;
...
.method public getCurrentTransport()Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, getCurrentTransportForUser(I)Ljava/lang/String;
...
.method public getDataManagementIntent(Ljava/lang/String;)Landroid/content/Intent;
    ...
    invoke-virtual {p0, v0, p1}, getDataManagementIntentForUser(ILjava/lang/String;)Landroid/content/Intent;
...
.method public getDestinationString(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v0, p1}, getDestinationStringForUser(ILjava/lang/String;)Ljava/lang/String;
...
.method initializeService()V
    ...
    invoke-virtual {p0, v0}, postToHandler(Ljava/lang/Runnable;)V
...
.method public isBackupEnabled()Z
    ...
    invoke-virtual {p0, v0}, isBackupEnabledForUser(I)Z
...
.method public synthetic lambda$initializeService$0$Trampoline()V
    ...
    :try_start_0
    iget-object v3, p0, mService:Lcom/android/server/backup/BackupManagerService;

    if-nez v3, :cond_1

    invoke-virtual {p0}, createBackupManagerService()Lcom/android/server/backup/BackupManagerService;

    move-result-object v3

    iput-object v3, p0, mService:Lcom/android/server/backup/BackupManagerService;
...
.method public synthetic lambda$unlockUser$1$Trampoline(I)V
    ...
    invoke-direct {p0, p1}, startServiceForUser(I)V
...
.method public listAllTransports()[Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, listAllTransportsForUser(I)[Ljava/lang/String;
...
.method public opComplete(IJ)V
    ...
    invoke-virtual {p0, v0, p1, p2, p3}, opCompleteForUser(IIJ)V
...
.method public requestBackup([Ljava/lang/String;Landroid/app/backup/IBackupObserver;Landroid/app/backup/IBackupManagerMonitor;I)I
    ...
    invoke-virtual/range {v0 .. v5}, requestBackupForUser(I[Ljava/lang/String;Landroid/app/backup/IBackupObserver;Landroid/app/backup/IBackupManagerMonitor;I)I
...
.method public restoreAtInstall(Ljava/lang/String;I)V
    ...
    invoke-virtual {p0, v0, p1, p2}, restoreAtInstallForUser(ILjava/lang/String;I)V
...
.method public selectBackupTransport(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v0, p1}, selectBackupTransportForUser(ILjava/lang/String;)Ljava/lang/String;
...
.method public setAutoRestore(Z)V
    ...
    invoke-virtual {p0, v0, p1}, setAutoRestoreForUser(IZ)V
...
.method public setBackupEnabled(Z)V
    ...
    invoke-virtual {p0, v0, p1}, setBackupEnabledForUser(IZ)V
...
.method public setBackupServiceActive(IZ)V
    ...
    invoke-direct {p0, p1}, enforcePermissionsOnUser(I)V

    if-eqz p1, :cond_0

    :try_start_0
    invoke-virtual {p0, p1}, getRememberActivatedFileForNonSystemUser(I)Ljava/io/File;
    ...
    iput-object v1, p0, mService:Lcom/android/server/backup/BackupManagerService;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1

    :cond_3
    :try_start_2
    invoke-direct {p0, p1}, activateBackupForUserLocked(I)V
    :try_end_2
    ...
    :cond_4
    :try_start_6
    invoke-direct {p0, p1}, deactivateBackupForUserLocked(I)V
    :try_end_6
    ...
    :goto_3
    invoke-virtual {p0, p1}, stopUser(I)V
