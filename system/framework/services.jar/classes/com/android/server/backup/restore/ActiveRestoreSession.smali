...
.method public constructor <init>(Lcom/android/server/backup/UserBackupManagerService;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v0, p0, mRestoreSets:[Landroid/app/backup/RestoreSet;
    ...
    iput-object p3, p0, mTransportName:Ljava/lang/String;
...
.method private sendRestoreToHandlerLocked(Ljava/util/function/BiFunction;Ljava/lang/String;)I
    ...
    iget-object v1, p0, mTransportName:Ljava/lang/String;
    ...
    iget-object v2, p0, mTransportName:Ljava/lang/String;
...
.method public declared-synchronized getAvailableRestoreSets(Landroid/app/backup/IRestoreObserver;Landroid/app/backup/IBackupManagerMonitor;)I
    ...
    :try_start_0
    iget-object v0, v7, mBackupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    iget-boolean v0, v7, mEnded:Z

    if-nez v0, :cond_2

    iget-boolean v0, v7, mTimedOut:Z
    ...
    :try_start_2
    iget-object v0, v7, mTransportManager:Lcom/android/server/backup/TransportManager;

    iget-object v1, v7, mTransportName:Ljava/lang/String;
    ...
    :cond_1
    :try_start_4
    iget-object v1, v7, mBackupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    iget-object v1, v7, mTransportManager:Lcom/android/server/backup/TransportManager;
    ...
    iget-object v2, v7, mBackupManagerService:Lcom/android/server/backup/UserBackupManagerService;
...
.method public declared-synchronized restoreAll(JLandroid/app/backup/IRestoreObserver;Landroid/app/backup/IBackupManagerMonitor;)I
    ...
    :cond_0
    :try_start_1
    iget-object v0, p0, mRestoreSets:[Landroid/app/backup/RestoreSet;
    ...
    iget-object v3, p0, mTransportName:Ljava/lang/String;
    ...
    invoke-direct {p0, v1, v5}, sendRestoreToHandlerLocked(Ljava/util/function/BiFunction;Ljava/lang/String;)I
...
.method public declared-synchronized restorePackage(Ljava/lang/String;Landroid/app/backup/IRestoreObserver;Landroid/app/backup/IBackupManagerMonitor;)I
    ...
    iget-boolean v0, v1, mEnded:Z

    if-nez v0, :cond_6

    iget-boolean v0, v1, mTimedOut:Z
    ...
    iget-object v6, v1, mPackageName:Ljava/lang/String;
    ...
    iget-object v5, v1, mTransportName:Ljava/lang/String;
    ...
    iget-object v6, v1, mTransportName:Ljava/lang/String;
    ...
    invoke-direct {v1, v0, v3}, sendRestoreToHandlerLocked(Ljava/util/function/BiFunction;Ljava/lang/String;)I
...
.method public declared-synchronized restorePackages(JLandroid/app/backup/IRestoreObserver;[Ljava/lang/String;Landroid/app/backup/IBackupManagerMonitor;)I
    ...
    :cond_5
    :try_start_1
    iget-object v0, v1, mRestoreSets:[Landroid/app/backup/RestoreSet;
    ...
    iget-object v4, v1, mTransportName:Ljava/lang/String;
    ...
    invoke-direct {p0, v0, v2}, sendRestoreToHandlerLocked(Ljava/util/function/BiFunction;Ljava/lang/String;)I
...
.method public setRestoreSets([Landroid/app/backup/RestoreSet;)V
    ...
    iput-object p1, p0, mRestoreSets:[Landroid/app/backup/RestoreSet;
