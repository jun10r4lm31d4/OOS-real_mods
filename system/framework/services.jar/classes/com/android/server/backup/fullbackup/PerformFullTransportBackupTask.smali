...
.method public constructor <init>(Lcom/android/server/backup/UserBackupManagerService;Lcom/android/server/backup/transport/TransportClient;Landroid/app/backup/IFullBackupRestoreObserver;[Ljava/lang/String;ZLcom/android/server/backup/FullBackupJob;Ljava/util/concurrent/CountDownLatch;Landroid/app/backup/IBackupObserver;Landroid/app/backup/IBackupManagerMonitor;Lcom/android/server/backup/internal/OnTaskFinishedListener;Z)V
    ...
    iput-object v0, v1, mCancelLock:Ljava/lang/Object;

    move-object/from16 v4, p1

    iput-object v4, v1, backupManagerService:Lcom/android/server/backup/UserBackupManagerService;

    move-object/from16 v5, p2

    iput-object v5, v1, mTransportClient:Lcom/android/server/backup/transport/TransportClient;

    move/from16 v6, p5

    iput-boolean v6, v1, mUpdateSchedule:Z

    move-object/from16 v7, p7

    iput-object v7, v1, mLatch:Ljava/util/concurrent/CountDownLatch;

    move-object/from16 v8, p6

    iput-object v8, v1, mJob:Lcom/android/server/backup/FullBackupJob;
    ...
    iput-object v0, v1, mPackages:Ljava/util/ArrayList;

    move-object/from16 v9, p8

    iput-object v9, v1, mBackupObserver:Landroid/app/backup/IBackupObserver;

    move-object/from16 v10, p9

    iput-object v10, v1, mMonitor:Landroid/app/backup/IBackupManagerMonitor;
    ...
    :goto_0
    iput-object v0, v1, mListener:Lcom/android/server/backup/internal/OnTaskFinishedListener;

    move/from16 v11, p11

    iput-boolean v11, v1, mUserInitiated:Z

    invoke-virtual/range {p1 .. p1}, Lcom/android/server/backup/UserBackupManagerService;->generateRandomIntegerToken()I

    move-result v0

    iput v0, v1, mCurrentOpToken:I

    invoke-virtual/range {p1 .. p1}, Lcom/android/server/backup/UserBackupManagerService;->generateRandomIntegerToken()I

    move-result v0

    iput v0, v1, mBackupRunnerOpToken:I
    ...
    iput-boolean v0, v1, mCancelAll:Z

    return-void

    :cond_1
    invoke-direct/range {p0 .. p0}, registerTask()V
    ...
    iput-object v2, v1, mCurrentPackage:Landroid/content/pm/PackageInfo;
    ...
    iget-object v3, v1, mCurrentPackage:Landroid/content/pm/PackageInfo;
    ...
    iget-object v0, v1, mBackupObserver:Landroid/app/backup/IBackupObserver;
    ...
    iget-object v4, v1, mCurrentPackage:Landroid/content/pm/PackageInfo;
    ...
    :cond_4
    iget-object v0, v1, mPackages:Ljava/util/ArrayList;
...
.method public static newWithCurrentTransport(Lcom/android/server/backup/UserBackupManagerService;Landroid/app/backup/IFullBackupRestoreObserver;[Ljava/lang/String;ZLcom/android/server/backup/FullBackupJob;Ljava/util/concurrent/CountDownLatch;Landroid/app/backup/IBackupObserver;Landroid/app/backup/IBackupManagerMonitor;ZLjava/lang/String;)Lcom/android/server/backup/fullbackup/PerformFullTransportBackupTask;
    ...
    invoke-direct/range {v2 .. v13}, <init>(Lcom/android/server/backup/UserBackupManagerService;Lcom/android/server/backup/transport/TransportClient;Landroid/app/backup/IFullBackupRestoreObserver;[Ljava/lang/String;ZLcom/android/server/backup/FullBackupJob;Ljava/util/concurrent/CountDownLatch;Landroid/app/backup/IBackupObserver;Landroid/app/backup/IBackupManagerMonitor;Lcom/android/server/backup/internal/OnTaskFinishedListener;Z)V
...
.method public handleCancel(Z)V
    ...
    iget-object v0, p0, mCancelLock:Ljava/lang/Object;
    ...
    :cond_0
    iget-boolean v1, p0, mCancelAll:Z
    ...
    iput-boolean v1, p0, mCancelAll:Z

    iget-boolean v1, p0, mIsDoingBackup:Z

    if-eqz v1, :cond_2

    iget-object v1, p0, backupManagerService:Lcom/android/server/backup/UserBackupManagerService;

    iget v2, p0, mBackupRunnerOpToken:I
...
.method public run()V
    ...
    :try_start_0
    iget-object v5, v10, backupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    :cond_0
    iget-object v5, v10, mTransportClient:Lcom/android/server/backup/transport/TransportClient;
    ...
    iget-object v5, v10, mMonitor:Landroid/app/backup/IBackupManagerMonitor;

    const/16 v6, 0xf

    iget-object v7, v10, mCurrentPackage:Landroid/content/pm/PackageInfo;
    ...
    iput-object v5, v10, mMonitor:Landroid/app/backup/IBackupManagerMonitor;
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_1

    iget-boolean v5, v10, mCancelAll:Z
    ...
    iget-object v6, v10, mBackupObserver:Landroid/app/backup/IBackupObserver;
    ...
    invoke-virtual {v10, v2}, cleanUpPipes([Landroid/os/ParcelFileDescriptor;)V

    invoke-virtual {v10, v1}, cleanUpPipes([Landroid/os/ParcelFileDescriptor;)V

    invoke-virtual/range {p0 .. p0}, unregisterTask()V

    iget-object v6, v10, mJob:Lcom/android/server/backup/FullBackupJob;

    if-eqz v6, :cond_2

    iget v7, v10, mUserId:I

    invoke-virtual {v6, v7}, Lcom/android/server/backup/FullBackupJob;->finishBackupPass(I)V

    :cond_2
    iget-object v6, v10, backupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    :try_start_2
    iget-object v7, v10, backupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    iget-object v6, v10, mListener:Lcom/android/server/backup/internal/OnTaskFinishedListener;
    ...
    iget-object v6, v10, mLatch:Ljava/util/concurrent/CountDownLatch;

    invoke-virtual {v6}, Ljava/util/concurrent/CountDownLatch;->countDown()V

    iget-boolean v6, v10, mUpdateSchedule:Z
    ...
    :cond_4
    :try_start_4
    iget-object v5, v10, mPackages:Ljava/util/ArrayList;
    ...
    :try_start_5
    iput-object v13, v10, mBackupRunner:Lcom/android/server/backup/fullbackup/PerformFullTransportBackupTask$SinglePackageBackupRunner;

    iget-object v3, v10, mPackages:Ljava/util/ArrayList;
    ...
    iget v14, v10, mCurrentOpToken:I
    ...
    :try_start_6
    iget-boolean v2, v10, mUserInitiated:Z
    ...
    iget-object v9, v10, mCancelLock:Ljava/lang/Object;
    ...
    :try_start_7
    iget-boolean v2, v10, mCancelAll:Z
    :try_end_7
    ...
    iget-object v2, v10, mTransportClient:Lcom/android/server/backup/transport/TransportClient;

    iget v1, v10, mBackupRunnerOpToken:I
    ...
    iput-object v11, v10, mBackupRunner:Lcom/android/server/backup/fullbackup/PerformFullTransportBackupTask$SinglePackageBackupRunner;
    ...
    iput-boolean v12, v10, mIsDoingBackup:Z
    :try_end_d
    ...
    iget-object v4, v10, mBackupRunner:Lcom/android/server/backup/fullbackup/PerformFullTransportBackupTask$SinglePackageBackupRunner;
    ...
    iget-object v5, v10, mBackupRunner:Lcom/android/server/backup/fullbackup/PerformFullTransportBackupTask$SinglePackageBackupRunner;
    ...
    :try_start_10
    iget-object v11, v10, mMonitor:Landroid/app/backup/IBackupManagerMonitor;

    iget-object v2, v10, mCurrentPackage:Landroid/content/pm/PackageInfo;
    ...
    iput-object v2, v10, mMonitor:Landroid/app/backup/IBackupManagerMonitor;
    ...
    iget-object v1, v10, mCancelLock:Ljava/lang/Object;
    ...
    :try_start_12
    iget-boolean v8, v10, mCancelAll:Z
    :try_end_12
    ...
    :try_start_15
    iget-object v1, v10, mBackupObserver:Landroid/app/backup/IBackupObserver;
    ...
    iget-object v1, v10, mMonitor:Landroid/app/backup/IBackupManagerMonitor;

    const/16 v2, 0x12

    iget-object v11, v10, mCurrentPackage:Landroid/content/pm/PackageInfo;
    ...
    iput-object v1, v10, mMonitor:Landroid/app/backup/IBackupManagerMonitor;

    iget-object v1, v10, mBackupRunner:Lcom/android/server/backup/fullbackup/PerformFullTransportBackupTask$SinglePackageBackupRunner;
    ...
    :goto_b
    iget-object v2, v10, mBackupRunner:Lcom/android/server/backup/fullbackup/PerformFullTransportBackupTask$SinglePackageBackupRunner;
    ...
    iget-object v4, v10, mCancelLock:Ljava/lang/Object;
    ...
    iget-boolean v12, v10, mCancelAll:Z
    ...
    :goto_e
    :try_start_1d
    iget-boolean v2, v10, mUpdateSchedule:Z
    :try_end_1d
    ...
    :try_start_1e
    iget-object v2, v10, backupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    iget-object v4, v10, mBackupObserver:Landroid/app/backup/IBackupObserver;
    ...
    iget-object v8, v10, mBackupObserver:Landroid/app/backup/IBackupObserver;
    ...
    iget-boolean v11, v10, mCancelAll:Z
    ...
    :try_start_1f
    iget-object v2, v10, mBackupObserver:Landroid/app/backup/IBackupObserver;
    ...
    invoke-virtual {v10, v5}, cleanUpPipes([Landroid/os/ParcelFileDescriptor;)V

    move-object/from16 v8, v31

    invoke-virtual {v10, v8}, cleanUpPipes([Landroid/os/ParcelFileDescriptor;)V

    invoke-virtual/range {p0 .. p0}, unregisterTask()V

    iget-object v9, v10, mJob:Lcom/android/server/backup/FullBackupJob;

    if-eqz v9, :cond_1c

    iget v11, v10, mUserId:I

    invoke-virtual {v9, v11}, Lcom/android/server/backup/FullBackupJob;->finishBackupPass(I)V

    :cond_1c
    iget-object v9, v10, backupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    :try_start_21
    iget-object v11, v10, backupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    :try_end_21
    ...
    iget-object v1, v10, mListener:Lcom/android/server/backup/internal/OnTaskFinishedListener;
    ...
    iget-object v1, v10, mLatch:Ljava/util/concurrent/CountDownLatch;

    invoke-virtual {v1}, Ljava/util/concurrent/CountDownLatch;->countDown()V

    iget-boolean v1, v10, mUpdateSchedule:Z

    if-eqz v1, :cond_1d

    iget-object v1, v10, backupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    invoke-virtual {v10, v13}, cleanUpPipes([Landroid/os/ParcelFileDescriptor;)V

    invoke-virtual {v10, v1}, cleanUpPipes([Landroid/os/ParcelFileDescriptor;)V

    invoke-virtual/range {p0 .. p0}, unregisterTask()V

    iget-object v2, v10, mJob:Lcom/android/server/backup/FullBackupJob;

    if-eqz v2, :cond_22

    iget v3, v10, mUserId:I
    ...
    iget-object v2, v10, mListener:Lcom/android/server/backup/internal/OnTaskFinishedListener;
    ...
    iget-object v2, v10, mLatch:Ljava/util/concurrent/CountDownLatch;
    ...
    :goto_1a
    iget-object v6, v10, mMonitor:Landroid/app/backup/IBackupManagerMonitor;
    ...
    iput-object v6, v10, mMonitor:Landroid/app/backup/IBackupManagerMonitor;

    const/4 v6, 0x0

    iput-boolean v6, v10, mUpdateSchedule:Z
    :try_end_2a
    ...
    iget-boolean v7, v10, mCancelAll:Z
    ...
    iget-object v7, v10, mBackupObserver:Landroid/app/backup/IBackupObserver;
    ...
    iget-object v7, v10, mJob:Lcom/android/server/backup/FullBackupJob;

    if-eqz v7, :cond_27

    iget v8, v10, mUserId:I
    ...
    :try_start_2b
    iget-object v8, v10, backupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    iget-object v7, v10, mListener:Lcom/android/server/backup/internal/OnTaskFinishedListener;
    ...
    iget-object v7, v10, mLatch:Ljava/util/concurrent/CountDownLatch;

    invoke-virtual {v7}, Ljava/util/concurrent/CountDownLatch;->countDown()V

    iget-boolean v7, v10, mUpdateSchedule:Z
    ...
    iget-boolean v1, v10, mCancelAll:Z
    ...
    iget-object v5, v10, mBackupObserver:Landroid/app/backup/IBackupObserver;
    ...
    iget-object v5, v10, mJob:Lcom/android/server/backup/FullBackupJob;

    if-eqz v5, :cond_2a

    iget v6, v10, mUserId:I
    ...
    iget-object v5, v10, mListener:Lcom/android/server/backup/internal/OnTaskFinishedListener;

    const-string v6, "PFTBT.run()"

    invoke-interface {v5, v6}, Lcom/android/server/backup/internal/OnTaskFinishedListener;->onFinished(Ljava/lang/String;)V

    iget-object v5, v10, mLatch:Ljava/util/concurrent/CountDownLatch;

    invoke-virtual {v5}, Ljava/util/concurrent/CountDownLatch;->countDown()V

    iget-boolean v5, v10, mUpdateSchedule:Z
    ...
    iget-object v3, v10, mBackupObserver:Landroid/app/backup/IBackupObserver;
    ...
    iget-object v3, v10, mJob:Lcom/android/server/backup/FullBackupJob;

    if-eqz v3, :cond_2d

    iget v4, v10, mUserId:I

    invoke-virtual {v3, v4}, Lcom/android/server/backup/FullBackupJob;->finishBackupPass(I)V

    :cond_2d
    iget-object v3, v10, backupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    :try_start_30
    iget-object v4, v10, backupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    iget-object v3, v10, mListener:Lcom/android/server/backup/internal/OnTaskFinishedListener;
    ...
    iget-object v3, v10, mLatch:Ljava/util/concurrent/CountDownLatch;

    invoke-virtual {v3}, Ljava/util/concurrent/CountDownLatch;->countDown()V

    iget-boolean v3, v10, mUpdateSchedule:Z
