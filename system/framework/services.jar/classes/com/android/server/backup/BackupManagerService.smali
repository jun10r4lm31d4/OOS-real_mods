...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/backup/Trampoline;Landroid/os/HandlerThread;)V
    ...
    iput-object v0, p0, mServiceUsers:Landroid/util/SparseArray;
    ...
    iput-object v0, p0, mTrampoline:Lcom/android/server/backup/Trampoline;
    ...
    iput-object v0, p0, mBackupThread:Landroid/os/HandlerThread;
    ...
    iput-object v1, p0, mTransportWhitelist:Ljava/util/Set;

    iget-object v1, p0, mTransportWhitelist:Ljava/util/Set;
...
.method static synthetic access$000(Lcom/android/server/backup/BackupManagerService;I)V
    ...
    invoke-direct {p0, p1}, onRemovedNonSystemUser(I)V
...
.method static synthetic access$102(Lcom/android/server/backup/Trampoline;)Lcom/android/server/backup/Trampoline;
    ...
    sput-object p0, sInstance:Lcom/android/server/backup/Trampoline;
...
.method public acknowledgeAdbBackupOrRestore(IIZLjava/lang/String;Ljava/lang/String;Landroid/app/backup/IFullBackupRestoreObserver;)V
    ...
    invoke-virtual {p0, p1, v0}, getServiceForUserIfCallerHasPermission(ILjava/lang/String;)Lcom/android/server/backup/UserBackupManagerService;
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    :goto_1
    iget-object v1, p0, mServiceUsers:Landroid/util/SparseArray;
    ...
    iget-object v2, p0, mServiceUsers:Landroid/util/SparseArray;
    ...
    invoke-virtual {p0, v0, v1}, getServiceForUserIfCallerHasPermission(ILjava/lang/String;)Lcom/android/server/backup/UserBackupManagerService;
...
.method getServiceForUserIfCallerHasPermission(ILjava/lang/String;)Lcom/android/server/backup/UserBackupManagerService;
    ...
    invoke-direct {p0, p1, p2}, enforceCallingPermissionOnUserId(ILjava/lang/String;)V

    iget-object v0, p0, mServiceUsers:Landroid/util/SparseArray;
...
.method public getTransportWhitelist()[Ljava/lang/String;
    ...
    iget-object v2, p0, mTransportWhitelist:Ljava/util/Set;
...
.method public getUserForAncestralSerialNumber(J)Landroid/os/UserHandle;
    ...
    invoke-virtual {p0}, getServiceUsers()Landroid/util/SparseArray;
...
.method protected startServiceForUser(I)V
    ...
    iget-object v1, p0, mTrampoline:Lcom/android/server/backup/Trampoline;
    ...
    invoke-virtual {p0, p1, v0}, startServiceForUser(ILcom/android/server/backup/UserBackupManagerService;)V
