...
.method public run()V
    ...
    iget-object v4, p0, mInfo:Lcom/android/server/backup/FileMetadata;

    iget v4, v4, Lcom/android/server/backup/FileMetadata;->type:I

    iget-object v5, p0, mInfo:Lcom/android/server/backup/FileMetadata;

    iget-object v5, v5, Lcom/android/server/backup/FileMetadata;->domain:Ljava/lang/String;

    iget-object v6, p0, mInfo:Lcom/android/server/backup/FileMetadata;

    iget-object v6, v6, Lcom/android/server/backup/FileMetadata;->path:Ljava/lang/String;

    iget-object v7, p0, mInfo:Lcom/android/server/backup/FileMetadata;

    iget-wide v7, v7, Lcom/android/server/backup/FileMetadata;->mode:J

    iget-object v9, p0, mInfo:Lcom/android/server/backup/FileMetadata;

    iget-wide v9, v9, Lcom/android/server/backup/FileMetadata;->mtime:J

    iget v11, p0, mToken:I

    iget-object v12, p0, mBackupManagerService:Lcom/android/server/backup/UserBackupManagerService;
