...
.method constructor <init>(ILandroid/content/Context;Lcom/android/server/backup/transport/TransportStats;Landroid/content/Intent;Landroid/content/ComponentName;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct/range {v0 .. v8}, <init>(ILandroid/content/Context;Lcom/android/server/backup/transport/TransportStats;Landroid/content/Intent;Landroid/content/ComponentName;Ljava/lang/String;Ljava/lang/String;Landroid/os/Handler;)V
...
.method constructor <init>(ILandroid/content/Context;Lcom/android/server/backup/transport/TransportStats;Landroid/content/Intent;Landroid/content/ComponentName;Ljava/lang/String;Ljava/lang/String;Landroid/os/Handler;)V
    ...
    iput-object v0, p0, mLogBufferLock:Ljava/lang/Object;
    ...
    iput-object v0, p0, mLogBuffer:Ljava/util/List;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, mListeners:Ljava/util/Map;
    ...
    iput-object p3, p0, mTransportStats:Lcom/android/server/backup/transport/TransportStats;

    iput-object p5, p0, mTransportComponent:Landroid/content/ComponentName;

    iput-object p4, p0, mBindIntent:Landroid/content/Intent;

    iput-object p6, p0, mIdentifier:Ljava/lang/String;

    iput-object p7, p0, mCreatorLogString:Ljava/lang/String;

    iput-object p8, p0, mListenerHandler:Landroid/os/Handler;
    ...
    iget-object v0, p0, mTransportComponent:Landroid/content/ComponentName;
    ...
    iget-object v2, p0, mIdentifier:Ljava/lang/String;
    ...
    iput-object v1, p0, mPrefixForLog:Ljava/lang/String;
...
.method static synthetic access$100(Lcom/android/server/backup/transport/TransportClient;Landroid/os/IBinder;)V
    ...
    invoke-direct {p0, p1}, onServiceConnected(Landroid/os/IBinder;)V
...
.method static synthetic access$200(Lcom/android/server/backup/transport/TransportClient;)V
    ...
    invoke-direct {p0}, onServiceDisconnected()V
...
.method static synthetic access$300(Lcom/android/server/backup/transport/TransportClient;)V
    ...
    invoke-direct {p0}, onBindingDied()V
...
.method private checkState(ZLjava/lang/String;)V
    ...
    invoke-direct {p0, v0, p2}, log(ILjava/lang/String;)V
...
.method private checkStateIntegrityLocked()V
    ...
    invoke-direct {p0, v2}, stateToString(I)Ljava/lang/String;
    ...
    invoke-direct {p0, v1, v0}, checkState(ZLjava/lang/String;)V

    goto :goto_1

    :cond_0
    iget-object v0, p0, mListeners:Ljava/util/Map;
    ...
    invoke-direct {p0, v0, v3}, checkState(ZLjava/lang/String;)V
...
.method private log(ILjava/lang/String;)V
    ...
    iget-object v0, p0, mPrefixForLog:Ljava/lang/String;
    ...
    invoke-direct {p0, v0}, saveLogEntry(Ljava/lang/String;)V
...
.method private notifyListener(Lcom/android/server/backup/transport/TransportConnectionListener;Lcom/android/internal/backup/IBackupTransport;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v1, v2}, log(ILjava/lang/String;)V
...
.method private notifyListenersAndClearLocked(Lcom/android/internal/backup/IBackupTransport;)V
    ...
    invoke-direct {p0, v2, p1, v3}, notifyListener(Lcom/android/server/backup/transport/TransportConnectionListener;Lcom/android/internal/backup/IBackupTransport;Ljava/lang/String;)V
...
.method private onBindingDied()V
    ...
    :try_start_0
    invoke-direct {p0}, checkStateIntegrityLocked()V

    const-string v1, "Binding died: client UNUSABLE"

    const/4 v2, 0x6

    invoke-direct {p0, v2, v1}, log(ILjava/lang/String;)V
    ...
    :cond_0
    invoke-direct {p0, v4, v5}, setStateLocked(ILcom/android/internal/backup/IBackupTransport;)V
    ...
    invoke-direct {p0, v5}, notifyListenersAndClearLocked(Lcom/android/internal/backup/IBackupTransport;)V
...
.method private onServiceConnected(Landroid/os/IBinder;)V
    ...
    invoke-direct {p0, v3, v2}, log(ILjava/lang/String;)V

    invoke-direct {p0, v3, v0}, setStateLocked(ILcom/android/internal/backup/IBackupTransport;)V

    invoke-direct {p0, v0}, notifyListenersAndClearLocked(Lcom/android/internal/backup/IBackupTransport;)V
...
.method private onServiceDisconnected()V
    ...
    invoke-direct {p0, v1, v2}, setStateLocked(ILcom/android/internal/backup/IBackupTransport;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-direct {p0, v2, v3}, log(ILjava/lang/String;)V
...
.method private onStateTransition(II)V
    ...
    invoke-direct {p0, p1, p2, v1}, transitionThroughState(III)I

    move-result v2

    const/4 v3, 0x3

    invoke-direct {p0, p1, p2, v3}, transitionThroughState(III)I
...
.method private saveLogEntry(Ljava/lang/String;)V
    ...
    iget-object v1, p0, mLogBufferLock:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, mLogBuffer:Ljava/util/List;
    ...
    iget-object v3, p0, mLogBuffer:Ljava/util/List;
...
.method private setStateLocked(ILcom/android/internal/backup/IBackupTransport;)V
    ...
    invoke-direct {p0, v1}, stateToString(I)Ljava/lang/String;
    ...
    invoke-direct {p0, p1}, stateToString(I)Ljava/lang/String;
    ...
    invoke-direct {p0, v1, v0}, log(ILjava/lang/String;)V

    iget v0, p0, mState:I

    invoke-direct {p0, v0, p1}, onStateTransition(II)V
...
.method public connect(Ljava/lang/String;)Lcom/android/internal/backup/IBackupTransport;
    ...
    invoke-direct {p0, v2, p1, v1}, log(ILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v1, p1, v2}, log(ILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v2, p1, v8}, log(ILjava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, v4, p1}, connectAsync(Lcom/android/server/backup/transport/TransportConnectionListener;Ljava/lang/String;)V
    ...
    iget-object v10, p0, mTransportStats:Lcom/android/server/backup/transport/TransportStats;

    iget-object v11, p0, mTransportComponent:Landroid/content/ComponentName;
    ...
    invoke-direct {p0, v8, p1, v9}, log(ILjava/lang/String;Ljava/lang/String;)V
...
.method public connectAsync(Lcom/android/server/backup/transport/TransportConnectionListener;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v5, p2, v1}, log(ILjava/lang/String;Ljava/lang/String;)V

    iget-object v1, p0, mTransport:Lcom/android/internal/backup/IBackupTransport;

    invoke-direct {p0, p1, v1, p2}, notifyListener(Lcom/android/server/backup/transport/TransportConnectionListener;Lcom/android/internal/backup/IBackupTransport;Ljava/lang/String;)V
    ...
    iget-object v1, p0, mListeners:Ljava/util/Map;
    ...
    iget-object v6, p0, mBindIntent:Landroid/content/Intent;

    iget-object v7, p0, mConnection:Landroid/content/ServiceConnection;
    ...
    invoke-direct {p0, v5, p2, v4}, log(ILjava/lang/String;Ljava/lang/String;)V

    invoke-direct {p0, v3, v2}, setStateLocked(ILcom/android/internal/backup/IBackupTransport;)V

    iget-object v2, p0, mListeners:Ljava/util/Map;
    ...
    invoke-direct {p0, v3, v4}, log(ILjava/lang/String;)V
    ...
    invoke-direct {p0, p1, v2, p2}, notifyListener(Lcom/android/server/backup/transport/TransportConnectionListener;Lcom/android/internal/backup/IBackupTransport;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v1, p2, v3}, log(ILjava/lang/String;Ljava/lang/String;)V
...
.method public connectOrThrow(Ljava/lang/String;)Lcom/android/internal/backup/IBackupTransport;
    ...
    invoke-virtual {p0, p1}, connect(Ljava/lang/String;)Lcom/android/internal/backup/IBackupTransport;
...
.method protected finalize()V
    ...
    iget-object v4, p0, mCreatorLogString:Ljava/lang/String;
    ...
    invoke-direct {p0, v2, v1, v3}, log(ILjava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :try_start_1
    invoke-virtual {p0, v1}, unbind(Ljava/lang/String;)V
    :try_end_1
...
.method getLogBuffer()Ljava/util/List;
    ...
    iget-object v0, p0, mLogBufferLock:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, mLogBuffer:Ljava/util/List;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, mTransportComponent:Landroid/content/ComponentName;
    ...
    iget-object v1, p0, mIdentifier:Ljava/lang/String;
...
.method public unbind(Ljava/lang/String;)V
    ...
    :cond_0
    invoke-direct {p0, v3, v5}, setStateLocked(ILcom/android/internal/backup/IBackupTransport;)V
