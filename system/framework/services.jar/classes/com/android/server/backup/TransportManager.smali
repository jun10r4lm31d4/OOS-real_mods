...
.method constructor <init>(ILandroid/content/Context;Ljava/util/Set;Ljava/lang/String;)V
    ...
    iput-object v0, p0, mTransportServiceIntent:Landroid/content/Intent;
    ...
    iput-object v0, p0, mOnTransportRegisteredListener:Lcom/android/server/backup/transport/OnTransportRegisteredListener;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, mTransportLock:Ljava/lang/Object;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, mRegisteredTransportsDescriptionMap:Ljava/util/Map;
    ...
    iput-object v0, p0, mTransportWhitelist:Ljava/util/Set;

    iput-object p4, p0, mCurrentTransportName:Ljava/lang/String;
    ...
    iput-object v0, p0, mTransportStats:Lcom/android/server/backup/transport/TransportStats;

    new-instance v0, Lcom/android/server/backup/transport/TransportClientManager;

    iget v1, p0, mUserId:I

    iget-object v2, p0, mTransportStats:Lcom/android/server/backup/transport/TransportStats;
    ...
    iput-object v0, p0, mTransportClientManager:Lcom/android/server/backup/transport/TransportClientManager;
...
.method constructor <init>(ILandroid/content/Context;Ljava/util/Set;Ljava/lang/String;Lcom/android/server/backup/transport/TransportClientManager;)V
    ...
    iput-object p5, p0, mTransportClientManager:Lcom/android/server/backup/transport/TransportClientManager;
...
.method private checkCanUseTransport()V
    ...
    iget-object v0, p0, mTransportLock:Ljava/lang/Object;
...
.method private getRegisteredTransportComponentLocked(Ljava/lang/String;)Landroid/content/ComponentName;
    ...
    invoke-direct {p0, p1}, getRegisteredTransportEntryLocked(Ljava/lang/String;)Ljava/util/Map$Entry;
...
.method private getRegisteredTransportComponentOrThrowLocked(Ljava/lang/String;)Landroid/content/ComponentName;
    ...
    invoke-direct {p0, p1}, getRegisteredTransportComponentLocked(Ljava/lang/String;)Landroid/content/ComponentName;
...
.method private getRegisteredTransportDescriptionOrThrowLocked(Landroid/content/ComponentName;)Lcom/android/server/backup/TransportManager$TransportDescription;
    ...
    iget-object v0, p0, mRegisteredTransportsDescriptionMap:Ljava/util/Map;
...
.method private getRegisteredTransportDescriptionOrThrowLocked(Ljava/lang/String;)Lcom/android/server/backup/TransportManager$TransportDescription;
    ...
    invoke-direct {p0, p1}, getRegisteredTransportDescriptionLocked(Ljava/lang/String;)Lcom/android/server/backup/TransportManager$TransportDescription;
...
.method private isTransportTrusted(Landroid/content/ComponentName;)Z
    ...
    iget-object v0, p0, mTransportWhitelist:Ljava/util/Set;
...
.method private registerTransport(Landroid/content/ComponentName;)I
    ...
    invoke-direct {p0}, checkCanUseTransport()V

    invoke-direct {p0, p1}, isTransportTrusted(Landroid/content/ComponentName;)Z
    ...
    iget-object v5, p0, mTransportClientManager:Lcom/android/server/backup/transport/TransportClientManager;
    ...
    invoke-direct {p0, p1, v6}, registerTransport(Landroid/content/ComponentName;Lcom/android/internal/backup/IBackupTransport;)V
    ...
    iget-object v9, p0, mOnTransportRegisteredListener:Lcom/android/server/backup/transport/OnTransportRegisteredListener;
    ...
    :goto_0
    iget-object v1, p0, mTransportClientManager:Lcom/android/server/backup/transport/TransportClientManager;
...
.method private registerTransport(Landroid/content/ComponentName;Lcom/android/internal/backup/IBackupTransport;)V
    ...
    iget-object v1, p0, mTransportLock:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, mRegisteredTransportsDescriptionMap:Ljava/util/Map;
...
.method private registerTransportsForIntent(Landroid/content/Intent;Ljava/util/function/Predicate;)V
    ...
    invoke-direct {p0, v3}, isTransportTrusted(Landroid/content/ComponentName;)Z

    move-result v4

    if-eqz v4, :cond_1

    invoke-direct {p0, v3}, registerTransport(Landroid/content/ComponentName;)I
...
.method private registerTransportsFromPackage(Ljava/lang/String;Ljava/util/function/Predicate;)V
    ...
    iget-object v1, p0, mTransportServiceIntent:Landroid/content/Intent;
    ...
    invoke-static {p1}, fromPackageFilter(Ljava/lang/String;)Ljava/util/function/Predicate;
    ...
    invoke-direct {p0, v0, v1}, registerTransportsForIntent(Landroid/content/Intent;Ljava/util/function/Predicate;)V
...
.method public disposeOfTransportClient(Lcom/android/server/backup/transport/TransportClient;Ljava/lang/String;)V
    ...
    iget-object v0, p0, mTransportClientManager:Lcom/android/server/backup/transport/TransportClientManager;
...
.method public dumpTransportStats(Ljava/io/PrintWriter;)V
    ...
    iget-object v0, p0, mTransportStats:Lcom/android/server/backup/transport/TransportStats;
...
.method public forEachRegisteredTransport(Ljava/util/function/Consumer;)V
    ...
    :try_start_0
    iget-object v1, p0, mRegisteredTransportsDescriptionMap:Ljava/util/Map;
...
.method public getCurrentTransportClient(Ljava/lang/String;)Lcom/android/server/backup/transport/TransportClient;
    ...
    iget-object v0, p0, mCurrentTransportName:Ljava/lang/String;
    ...
    :try_start_0
    iget-object v1, p0, mCurrentTransportName:Ljava/lang/String;

    invoke-virtual {p0, v1, p1}, getTransportClient(Ljava/lang/String;Ljava/lang/String;)Lcom/android/server/backup/transport/TransportClient;
...
.method public getCurrentTransportClientOrThrow(Ljava/lang/String;)Lcom/android/server/backup/transport/TransportClient;
    ...
    invoke-virtual {p0, v1, p1}, getTransportClientOrThrow(Ljava/lang/String;Ljava/lang/String;)Lcom/android/server/backup/transport/TransportClient;
...
.method public getCurrentTransportComponent()Landroid/content/ComponentName;
    ...
    invoke-direct {p0, v1}, getRegisteredTransportComponentOrThrowLocked(Ljava/lang/String;)Landroid/content/ComponentName;
...
.method getRegisteredTransportNames()[Ljava/lang/String;
    ...
    iget-object v3, p0, mRegisteredTransportsDescriptionMap:Ljava/util/Map;
...
.method public getTransportClient(Ljava/lang/String;Ljava/lang/String;)Lcom/android/server/backup/transport/TransportClient;
    ...
    :try_start_0
    invoke-virtual {p0, p1, p2}, getTransportClientOrThrow(Ljava/lang/String;Ljava/lang/String;)Lcom/android/server/backup/transport/TransportClient;
...
.method public getTransportClientOrThrow(Ljava/lang/String;Ljava/lang/String;)Lcom/android/server/backup/transport/TransportClient;
    ...
    iget-object v2, p0, mTransportClientManager:Lcom/android/server/backup/transport/TransportClientManager;
...
.method public getTransportConfigurationIntent(Ljava/lang/String;)Landroid/content/Intent;
    ...
    :try_start_0
    invoke-direct {p0, p1}, getRegisteredTransportDescriptionOrThrowLocked(Ljava/lang/String;)Lcom/android/server/backup/TransportManager$TransportDescription;
...
.method public getTransportDirName(Landroid/content/ComponentName;)Ljava/lang/String;
    ...
    :try_start_0
    invoke-direct {p0, p1}, getRegisteredTransportDescriptionOrThrowLocked(Landroid/content/ComponentName;)Lcom/android/server/backup/TransportManager$TransportDescription;
...
.method onPackageAdded(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, v0}, registerTransportsFromPackage(Ljava/lang/String;Ljava/util/function/Predicate;)V
...
.method varargs onPackageChanged(Ljava/lang/String;[Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, v1}, registerTransportsFromPackage(Ljava/lang/String;Ljava/util/function/Predicate;)V
...
.method public registerAndSelectTransport(Landroid/content/ComponentName;)I
    ...
    :try_start_0
    invoke-virtual {p0, p1}, getTransportName(Landroid/content/ComponentName;)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p0, v2}, selectTransport(Ljava/lang/String;)Ljava/lang/String;
    :try_end_0
    .catch Lcom/android/server/backup/transport/TransportNotRegisteredException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-direct {p0, p1}, registerTransport(Landroid/content/ComponentName;)I
    ...
    :cond_0
    iget-object v3, p0, mTransportLock:Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0}, selectTransport(Ljava/lang/String;)Ljava/lang/String;
    :try_end_2
...
.method public registerTransports()V
    ...
    iget-object v0, p0, mTransportServiceIntent:Landroid/content/Intent;
...
.method selectTransport(Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object p1, p0, mCurrentTransportName:Ljava/lang/String;
...
.method public setOnTransportRegisteredListener(Lcom/android/server/backup/transport/OnTransportRegisteredListener;)V
    ...
    iput-object p1, p0, mOnTransportRegisteredListener:Lcom/android/server/backup/transport/OnTransportRegisteredListener;
