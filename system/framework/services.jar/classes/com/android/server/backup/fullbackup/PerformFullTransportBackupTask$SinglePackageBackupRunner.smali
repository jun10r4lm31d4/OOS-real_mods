...
.method constructor <init>(Lcom/android/server/backup/fullbackup/PerformFullTransportBackupTask;Landroid/os/ParcelFileDescriptor;Landroid/content/pm/PackageInfo;Lcom/android/server/backup/transport/TransportClient;JII)V
    ...
    iput-object v8, v0, this$0:Lcom/android/server/backup/fullbackup/PerformFullTransportBackupTask;
    ...
    iput-object v1, v0, mOutput:Landroid/os/ParcelFileDescriptor;

    move-object v9, p3

    iput-object v9, v0, mTarget:Landroid/content/pm/PackageInfo;

    move/from16 v10, p7

    iput v10, v0, mCurrentOpToken:I
    ...
    iput-object v11, v0, mPreflight:Lcom/android/server/backup/fullbackup/PerformFullTransportBackupTask$SinglePackageBackupPreflight;
    ...
    iput-object v1, v0, mPreflightLatch:Ljava/util/concurrent/CountDownLatch;

    new-instance v1, Ljava/util/concurrent/CountDownLatch;

    invoke-direct {v1, v2}, Ljava/util/concurrent/CountDownLatch;-><init>(I)V

    iput-object v1, v0, mBackupLatch:Ljava/util/concurrent/CountDownLatch;

    const/16 v1, -0x3eb

    iput v1, v0, mPreflightResult:I

    iput v1, v0, mBackupResult:I

    move-wide/from16 v1, p5

    iput-wide v1, v0, mQuota:J

    move/from16 v3, p8

    iput v3, v0, mTransportFlags:I

    invoke-virtual {p0}, registerTask()V
...
.method getBackupResultBlocking()I
    ...
    iget-object v0, p0, this$0:Lcom/android/server/backup/fullbackup/PerformFullTransportBackupTask;
...
.method getPreflightResultBlocking()J
    ...
    :try_start_0
    iget-object v2, p0, mPreflightLatch:Ljava/util/concurrent/CountDownLatch;
    ...
    :cond_0
    iget v2, p0, mPreflightResult:I

    if-nez v2, :cond_1

    iget-object v2, p0, mPreflight:Lcom/android/server/backup/fullbackup/PerformFullTransportBackupTask$SinglePackageBackupPreflight;
...
.method public handleCancel(Z)V
    ...
    iget-object v2, p0, this$0:Lcom/android/server/backup/fullbackup/PerformFullTransportBackupTask;
    ...
    iget-object v0, p0, mPreflightLatch:Ljava/util/concurrent/CountDownLatch;

    invoke-virtual {v0}, Ljava/util/concurrent/CountDownLatch;->countDown()V

    iget-object v0, p0, mBackupLatch:Ljava/util/concurrent/CountDownLatch;
...
.method registerTask()V
    ...
    :try_start_0
    iget-object v1, p0, this$0:Lcom/android/server/backup/fullbackup/PerformFullTransportBackupTask;
...
.method public run()V
    ...
    iget-object v2, p0, mOutput:Landroid/os/ParcelFileDescriptor;
    ...
    iget-object v5, p0, mPreflight:Lcom/android/server/backup/fullbackup/PerformFullTransportBackupTask$SinglePackageBackupPreflight;

    iget-object v6, p0, mTarget:Landroid/content/pm/PackageInfo;

    iget-wide v9, p0, mQuota:J

    iget v11, p0, mCurrentOpToken:I

    iget v12, p0, mTransportFlags:I
    ...
    iput-object v13, p0, mEngine:Lcom/android/server/backup/fullbackup/FullBackupEngine;
    ...
    iget-object v2, p0, mEngine:Lcom/android/server/backup/fullbackup/FullBackupEngine;

    invoke-virtual {v2}, Lcom/android/server/backup/fullbackup/FullBackupEngine;->preflightCheck()I

    move-result v2

    iput v2, p0, mPreflightResult:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iput v2, p0, mBackupResult:I
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1

    :cond_1
    invoke-virtual {p0}, unregisterTask()V
    ...
    :try_start_3
    iget-object v3, p0, mPreflightLatch:Ljava/util/concurrent/CountDownLatch;
    ...
    iget-object v3, p0, mBackupLatch:Ljava/util/concurrent/CountDownLatch;
...
.method public sendQuotaExceeded(JJ)V
    ...
    iget-object v0, p0, mEngine:Lcom/android/server/backup/fullbackup/FullBackupEngine;
