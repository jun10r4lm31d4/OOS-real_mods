...
.method public constructor <init>(Lcom/android/server/backup/UserBackupManagerService;Ljava/io/OutputStream;Lcom/android/server/backup/fullbackup/FullBackupPreflight;Landroid/content/pm/PackageInfo;ZLcom/android/server/backup/BackupRestoreTask;JII)V
    ...
    iput-object p1, p0, backupManagerService:Lcom/android/server/backup/UserBackupManagerService;

    iput-object p2, p0, mOutput:Ljava/io/OutputStream;

    iput-object p3, p0, mPreflightHook:Lcom/android/server/backup/fullbackup/FullBackupPreflight;

    iput-object p4, p0, mPkg:Landroid/content/pm/PackageInfo;

    iput-boolean p5, p0, mIncludeApks:Z

    iput-object p6, p0, mTimeoutMonitor:Lcom/android/server/backup/BackupRestoreTask;

    iput-wide p7, p0, mQuota:J

    iput p9, p0, mOpToken:I

    iput p10, p0, mTransportFlags:I
...
.method static synthetic access$300(Lcom/android/server/backup/fullbackup/FullBackupEngine;)Lcom/android/server/backup/BackupRestoreTask;
    ...
    iget-object v0, p0, mTimeoutMonitor:Lcom/android/server/backup/BackupRestoreTask;
...
.method private initializeAgent()Z
    ...
    iget-object v2, p0, mPkg:Landroid/content/pm/PackageInfo;
...
.method private tearDown()V
    ...
    iget-object v0, p0, mPkg:Landroid/content/pm/PackageInfo;
...
.method public backupOnePackage()I
    ...
    invoke-direct {p0}, initializeAgent()Z
    ...
    iget-object v9, p0, mPkg:Landroid/content/pm/PackageInfo;

    iget-object v10, p0, mAgent:Landroid/app/IBackupAgent;

    aget-object v11, v2, v5

    iget v12, p0, mOpToken:I

    iget-boolean v13, p0, mIncludeApks:Z
    ...
    iget-object v9, p0, mOutput:Ljava/io/OutputStream;
    ...
    :goto_0
    :try_start_1
    iget-object v6, p0, mOutput:Ljava/io/OutputStream;
    ...
    iget-object v8, p0, mPkg:Landroid/content/pm/PackageInfo;
    ...
    :goto_3
    :try_start_4
    iget-object v7, p0, mOutput:Ljava/io/OutputStream;
...
.method public preflightCheck()I
    ...
    iget-object v0, p0, mPreflightHook:Lcom/android/server/backup/fullbackup/FullBackupPreflight;
    ...
    iget-object v1, p0, mPkg:Landroid/content/pm/PackageInfo;
