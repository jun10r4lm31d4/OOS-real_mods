...
.method static constructor <clinit>()V
    ...
    :goto_1
    sput-boolean v1, VENDOR_IS_Q_OR_LATER:Z
...
.method constructor <init>(Lcom/android/server/pm/Installer;Lcom/android/server/om/OverlayManagerServiceImpl$PackageManagerHelper;)V
    ...
    iput-object p2, p0, mPackageManager:Lcom/android/server/om/OverlayManagerServiceImpl$PackageManagerHelper;

    invoke-direct {p0}, connectToIdmap2d()V
...
.method private calculateFulfilledPolicies(Landroid/content/pm/PackageInfo;Landroid/content/pm/PackageInfo;I)I
    ...
    iget-object v2, p0, mPackageManager:Lcom/android/server/om/OverlayManagerServiceImpl$PackageManagerHelper;
...
.method private connectToIdmap2d()V
    ...
    iput-object v2, p0, mIdmap2Service:Landroid/os/IIdmap2;
...
.method private enforceOverlayable(Landroid/content/pm/PackageInfo;)Z
    ...
    sget-boolean v1, VENDOR_IS_Q_OR_LATER:Z
...
.method private getIdmapPath(Ljava/lang/String;I)Ljava/lang/String;
    ...
    :try_start_0
    iget-object v0, p0, mIdmap2Service:Landroid/os/IIdmap2;
...
.method createIdmap(Landroid/content/pm/PackageInfo;Landroid/content/pm/PackageInfo;I)Z
    ...
    :try_start_0
    invoke-direct/range {p0 .. p3}, calculateFulfilledPolicies(Landroid/content/pm/PackageInfo;Landroid/content/pm/PackageInfo;I)I

    move-result v0

    invoke-direct {v1, v3}, enforceOverlayable(Landroid/content/pm/PackageInfo;)Z

    move-result v7

    move v12, v7

    iget-object v7, v1, mIdmap2Service:Landroid/os/IIdmap2;
...
.method idmapExists(Landroid/content/om/OverlayInfo;)Z
    ...
    invoke-direct {p0, v1, v2}, getIdmapPath(Ljava/lang/String;I)Ljava/lang/String;
...
.method idmapExists(Landroid/content/pm/PackageInfo;I)Z
    ...
    invoke-direct {p0, v1, p2}, getIdmapPath(Ljava/lang/String;I)Ljava/lang/String;
