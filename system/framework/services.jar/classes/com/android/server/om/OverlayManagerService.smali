...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/pm/Installer;)V
    ...
    iput-object v0, v1, mLock:Ljava/lang/Object;
    ...
    iput-object v0, v1, mPersistSettingsScheduled:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v0, v1, mService:Landroid/os/IBinder;
    ...
    iput-object v0, v1, mSettingsFile:Landroid/util/AtomicFile;
    ...
    iput-object v0, v1, mPackageManager:Lcom/android/server/om/OverlayManagerService$PackageManagerHelper;

    invoke-static {}, Lcom/android/server/pm/UserManagerService;->getInstance()Lcom/android/server/pm/UserManagerService;

    move-result-object v0

    iput-object v0, v1, mUserManager:Lcom/android/server/pm/UserManagerService;

    new-instance v7, Lcom/android/server/om/IdmapManager;

    iget-object v0, v1, mPackageManager:Lcom/android/server/om/OverlayManagerService$PackageManagerHelper;
    :try_end_0
    ...
    iput-object v0, v1, mSettings:Lcom/android/server/om/OverlayManagerSettings;

    new-instance v0, Lcom/android/server/om/OverlayManagerServiceImpl;

    iget-object v6, v1, mPackageManager:Lcom/android/server/om/OverlayManagerService$PackageManagerHelper;

    iget-object v8, v1, mSettings:Lcom/android/server/om/OverlayManagerSettings;

    invoke-static {}, getDefaultOverlayPackages()[Ljava/lang/String;
    ...
    iput-object v0, v1, mImpl:Lcom/android/server/om/OverlayManagerServiceImpl;
    ...
    invoke-direct/range {p0 .. p0}, restoreSettings()V

    invoke-direct/range {p0 .. p0}, initIfNeeded()V

    invoke-virtual {v1, v2}, onSwitchUser(I)V

    const-string/jumbo v2, "overlay"

    iget-object v6, v1, mService:Landroid/os/IBinder;

    invoke-virtual {v1, v2, v6}, publishBinderService(Ljava/lang/String;Landroid/os/IBinder;)V

    const-class v2, Lcom/android/server/om/OverlayManagerService;

    invoke-virtual {v1, v2, v1}, publishLocalService(Ljava/lang/Class;Ljava/lang/Object;)V
    :try_end_1
...
.method static synthetic access$300(Lcom/android/server/om/OverlayManagerService;)Lcom/android/server/pm/UserManagerService;
    ...
    iget-object v0, p0, mUserManager:Lcom/android/server/pm/UserManagerService;
...
.method static synthetic access$500(Lcom/android/server/om/OverlayManagerService;)Lcom/android/server/om/OverlayManagerService$PackageManagerHelper;
    ...
    iget-object v0, p0, mPackageManager:Lcom/android/server/om/OverlayManagerService$PackageManagerHelper;
...
.method static synthetic access$600(Lcom/android/server/om/OverlayManagerService;)Lcom/android/server/om/OverlayManagerServiceImpl;
    ...
    iget-object v0, p0, mImpl:Lcom/android/server/om/OverlayManagerServiceImpl;
...
.method static synthetic access$700(Lcom/android/server/om/OverlayManagerService;ILjava/util/List;)V
    ...
    invoke-direct {p0, p1, p2}, updateOverlayPaths(ILjava/util/List;)V
...
.method static synthetic access$800(Lcom/android/server/om/OverlayManagerService;)V
    ...
    invoke-direct {p0}, schedulePersistSettings()V
...
.method static synthetic access$900(Lcom/android/server/om/OverlayManagerService;ILjava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2}, updateAssets(ILjava/lang/String;)V
...
.method private initIfNeeded()V
    ...
    iget-object v6, p0, mImpl:Lcom/android/server/om/OverlayManagerServiceImpl;
    ...
    invoke-direct {p0, v7, v6}, updateOverlayPaths(ILjava/util/List;)V
...
.method private restoreSettings()V
    ...
    iget-object v4, p0, mUserManager:Lcom/android/server/pm/UserManagerService;
...
.method private schedulePersistSettings()V
    ...
    iget-object v0, p0, mPersistSettingsScheduled:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private updateAssets(ILjava/lang/String;)V
    ...
    invoke-direct {p0, p1, v0}, updateAssets(ILjava/util/List;)V
...
.method private updateOverlayPaths(ILjava/util/List;)V
    ...
    :cond_2
    iget-object v11, p0, mImpl:Lcom/android/server/om/OverlayManagerServiceImpl;
...
.method public onSwitchUser(I)V
    ...
    :try_start_1
    iget-object v3, p0, mImpl:Lcom/android/server/om/OverlayManagerServiceImpl;

    invoke-virtual {v3, p1}, Lcom/android/server/om/OverlayManagerServiceImpl;->updateOverlaysForUser(I)Ljava/util/ArrayList;

    move-result-object v3

    invoke-direct {p0, p1, v3}, updateAssets(ILjava/util/List;)V
