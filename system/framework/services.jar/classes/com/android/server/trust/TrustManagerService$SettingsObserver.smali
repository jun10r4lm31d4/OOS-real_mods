...
.method constructor <init>(Lcom/android/server/trust/TrustManagerService;Landroid/os/Handler;)V
    ...
    iput-object v0, p0, TRUST_AGENTS_EXTEND_UNLOCK:Landroid/net/Uri;
    ...
    iput-object v0, p0, LOCK_SCREEN_WHEN_TRUST_LOST:Landroid/net/Uri;
    ...
    iput-boolean v1, p0, mIsAutomotive:Z
...
.method getLockWhenTrustLost()Z
    ...
    iget-boolean v0, p0, mLockWhenTrustLost:Z
...
.method getTrustAgentsExtendUnlock()Z
    ...
    iget-boolean v0, p0, mTrustAgentsExtendUnlock:Z
...
.method public onChange(ZLandroid/net/Uri;)V
    ...
    iget-object v0, p0, TRUST_AGENTS_EXTEND_UNLOCK:Landroid/net/Uri;
    ...
    iget-boolean v0, p0, mIsAutomotive:Z

    xor-int/2addr v0, v1

    iget-object v3, p0, mContentResolver:Landroid/content/ContentResolver;

    iget-object v4, p0, this$0:Lcom/android/server/trust/TrustManagerService;
    ...
    :goto_0
    iput-boolean v1, p0, mTrustAgentsExtendUnlock:Z

    goto :goto_2

    :cond_1
    iget-object v0, p0, LOCK_SCREEN_WHEN_TRUST_LOST:Landroid/net/Uri;
    ...
    :goto_1
    iput-boolean v1, p0, mLockWhenTrustLost:Z
...
.method updateContentObserver()V
    ...
    iget-object v1, p0, TRUST_AGENTS_EXTEND_UNLOCK:Landroid/net/Uri;
    ...
    iget-object v1, p0, LOCK_SCREEN_WHEN_TRUST_LOST:Landroid/net/Uri;
    ...
    invoke-virtual {p0, v1, v0}, onChange(ZLandroid/net/Uri;)V
