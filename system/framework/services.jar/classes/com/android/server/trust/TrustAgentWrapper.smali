...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/trust/TrustManagerService;Landroid/content/Intent;Landroid/os/UserHandle;)V
    ...
    iput-boolean v0, p0, mPendingSuccessfulUnlock:Z
    ...
    iput-object v1, p0, mCallback:Landroid/service/trust/ITrustAgentServiceCallback;
    ...
    iput-object v1, p0, mName:Landroid/content/ComponentName;
    ...
    iget-object v3, p0, mName:Landroid/content/ComponentName;
    ...
    iput-object v1, p0, mAlarmIntent:Landroid/content/Intent;

    iget-object v1, p0, mAlarmIntent:Landroid/content/Intent;
...
.method static synthetic access$1700(Lcom/android/server/trust/TrustAgentWrapper;Ljava/lang/Exception;)V
    ...
    invoke-direct {p0, p1}, onError(Ljava/lang/Exception;)V
...
.method static synthetic access$2000(Lcom/android/server/trust/TrustAgentWrapper;)Z
    ...
    iget-boolean v0, p0, mPendingSuccessfulUnlock:Z
...
.method static synthetic access$2002(Lcom/android/server/trust/TrustAgentWrapper;Z)Z
    ...
    iput-boolean p1, p0, mPendingSuccessfulUnlock:Z
...
.method private scheduleRestart()V
    ...
    iput-wide v2, p0, mScheduledRestartUptimeMillis:J
...
.method public destroy()V
    ...
    iget-object v1, p0, mName:Landroid/content/ComponentName;
    ...
    iput-object v0, p0, mTrustAgentService:Landroid/service/trust/ITrustAgentService;

    iput-object v0, p0, mSetTrustAgentFeaturesToken:Landroid/os/IBinder;
...
.method updateDevicePolicyFeatures()Z
    ...
    iput-object v2, p0, mSetTrustAgentFeaturesToken:Landroid/os/IBinder;

    iget-object v2, p0, mTrustAgentService:Landroid/service/trust/ITrustAgentService;

    iget-object v5, p0, mSetTrustAgentFeaturesToken:Landroid/os/IBinder;
    ...
    iget-wide v5, p0, mMaximumTimeToLock:J

    cmp-long v5, v2, v5

    if-eqz v5, :cond_5

    iput-wide v2, p0, mMaximumTimeToLock:J

    iget-object v5, p0, mAlarmPendingIntent:Landroid/app/PendingIntent;
    ...
    iput-object v4, p0, mAlarmPendingIntent:Landroid/app/PendingIntent;
    ...
    invoke-direct {p0, v1}, onError(Ljava/lang/Exception;)V

    :goto_1
    iget-boolean v1, p0, mTrustDisabledByDpm:Z

    if-eq v1, v0, :cond_6

    iput-boolean v0, p0, mTrustDisabledByDpm:Z

    iget-object v1, p0, mTrustManagerService:Lcom/android/server/trust/TrustManagerService;
