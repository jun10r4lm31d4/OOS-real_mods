...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mTrustUsuallyManagedForUser:Landroid/util/SparseBooleanArray;

    new-instance v0, Landroid/util/SparseBooleanArray;

    invoke-direct {v0}, Landroid/util/SparseBooleanArray;-><init>()V

    iput-object v0, p0, mUsersUnlockedByBiometric:Landroid/util/SparseBooleanArray;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, mTrustTimeoutAlarmListenerForUser:Landroid/util/ArrayMap;

    const/4 v0, 0x0

    iput-boolean v0, p0, mTrustAgentsCanRun:Z
    ...
    iput-object v0, p0, mStrongAuthTracker:Lcom/android/server/trust/TrustManagerService$StrongAuthTracker;
    ...
    iput-object v0, p0, mSettingsObserver:Lcom/android/server/trust/TrustManagerService$SettingsObserver;
...
.method static synthetic access$1200(Lcom/android/server/trust/TrustManagerService;)Lcom/android/server/trust/TrustManagerService$StrongAuthTracker;
    ...
    iget-object v0, p0, mStrongAuthTracker:Lcom/android/server/trust/TrustManagerService$StrongAuthTracker;
...
.method static synthetic access$1500(Lcom/android/server/trust/TrustManagerService;I)Z
    ...
    invoke-direct {p0, p1}, isTrustUsuallyManagedInternal(I)Z
...
.method static synthetic access$1600(Lcom/android/server/trust/TrustManagerService;)Landroid/util/SparseBooleanArray;
    ...
    iget-object v0, p0, mUsersUnlockedByBiometric:Landroid/util/SparseBooleanArray;
...
.method static synthetic access$1700(Lcom/android/server/trust/TrustManagerService;)Lcom/android/server/trust/TrustManagerService$SettingsObserver;
    ...
    iget-object v0, p0, mSettingsObserver:Lcom/android/server/trust/TrustManagerService$SettingsObserver;
...
.method static synthetic access$2100(Lcom/android/server/trust/TrustManagerService;II)V
    ...
    invoke-direct {p0, p1, p2}, dispatchUnlockLockout(II)V
...
.method static synthetic access$2300(Lcom/android/server/trust/TrustManagerService;IZ)V
    ...
    invoke-direct {p0, p1, p2}, setDeviceLockedForUser(IZ)V
...
.method static synthetic access$2400(Lcom/android/server/trust/TrustManagerService;)Landroid/util/SparseBooleanArray;
    ...
    iget-object v0, p0, mTrustUsuallyManagedForUser:Landroid/util/SparseBooleanArray;
...
.method static synthetic access$2500(Lcom/android/server/trust/TrustManagerService;IIZ)V
    ...
    invoke-direct {p0, p1, p2, p3}, updateTrust(IIZ)V
...
.method static synthetic access$2600(Lcom/android/server/trust/TrustManagerService;II)V
    ...
    invoke-direct {p0, p1, p2}, handleScheduleTrustTimeout(II)V
...
.method static synthetic access$3000(Lcom/android/server/trust/TrustManagerService;)Landroid/util/ArrayMap;
    ...
    iget-object v0, p0, mTrustTimeoutAlarmListenerForUser:Landroid/util/ArrayMap;
...
.method static synthetic access$3200(Lcom/android/server/trust/TrustManagerService;I)V
    ...
    invoke-direct {p0, p1}, maybeLockScreen(I)V
...
.method private addListener(Landroid/app/trust/ITrustListener;)V
    ...
    :cond_1
    iget-object v0, p0, mTrustListeners:Ljava/util/ArrayList;
...
.method private dispatchDeviceLocked(IZ)V
    ...
    :goto_0
    iget-object v1, p0, mActiveAgents:Landroid/util/ArraySet;
...
.method private dispatchOnTrustChanged(ZII)V
    ...
    iget-object v3, p0, mTrustListeners:Ljava/util/ArrayList;
...
.method private dispatchUnlockAttempt(ZI)V
    ...
    invoke-direct {p0, p2, v0, v1}, updateTrust(IIZ)V
...
.method private handleScheduleTrustTimeout(II)V
    ...
    iget p1, p0, mCurrentUser:I

    iget-object v2, p0, mTrustTimeoutAlarmListenerForUser:Landroid/util/ArrayMap;
    ...
    iget-object v4, p0, mTrustTimeoutAlarmListenerForUser:Landroid/util/ArrayMap;
...
.method private isTrustUsuallyManagedInternal(I)Z
    ...
    :try_start_0
    iget-object v1, p0, mTrustUsuallyManagedForUser:Landroid/util/SparseBooleanArray;
    ...
    iget-object v2, p0, mTrustUsuallyManagedForUser:Landroid/util/SparseBooleanArray;
    ...
    iget-object v3, p0, mTrustUsuallyManagedForUser:Landroid/util/SparseBooleanArray;
...
.method private maybeEnableFactoryTrustAgents(Lcom/android/internal/widget/LockPatternUtils;I)V
    ...
    invoke-direct {v0, v2, v1}, resolveAllowedTrustAgents(Landroid/content/pm/PackageManager;I)Ljava/util/List;

    move-result-object v5

    iget-object v6, v0, mContext:Landroid/content/Context;

    invoke-static {v6}, getDefaultFactoryTrustAgent(Landroid/content/Context;)Landroid/content/ComponentName;
    ...
    invoke-direct {v0, v11}, getComponentName(Landroid/content/pm/ResolveInfo;)Landroid/content/ComponentName;
...
.method private maybeLockScreen(I)V
    ...
    iget-object v1, p0, mSettingsObserver:Lcom/android/server/trust/TrustManagerService$SettingsObserver;
...
.method private refreshDeviceLockedForUser(I)V
    ...
    invoke-direct {p0, v5, v8}, setDeviceLockedForUser(IZ)V

    goto :goto_3

    :cond_3
    invoke-direct {p0, v5}, aggregateIsTrusted(I)Z
    ...
    iget-object v11, p0, mUsersUnlockedByBiometric:Landroid/util/SparseBooleanArray;

    monitor-enter v11

    :try_start_0
    iget-object v12, p0, mUsersUnlockedByBiometric:Landroid/util/SparseBooleanArray;
...
.method private resolveAllowedTrustAgents(Landroid/content/pm/PackageManager;I)Ljava/util/List;
    ...
    sget-object v0, TRUST_AGENT_INTENT:Landroid/content/Intent;
    ...
    invoke-direct {p0, v3}, getComponentName(Landroid/content/pm/ResolveInfo;)Landroid/content/ComponentName;
...
.method private setDeviceLockedForUser(IZ)V
    ...
    :try_start_0
    invoke-virtual {p0, p1}, isDeviceLockedInner(I)Z
    ...
    :goto_0
    iget-object v3, p0, mDeviceLockedForUser:Landroid/util/SparseBooleanArray;
    ...
    invoke-direct {p0, p1, p2}, dispatchDeviceLocked(IZ)V
...
.method private updateTrust(IIZ)V
    ...
    iget-object v1, p0, mStrongAuthTracker:Lcom/android/server/trust/TrustManagerService$StrongAuthTracker;
    ...
    invoke-direct {p0, p1, v0}, updateTrustUsuallyManaged(IZ)V
    ...
    :goto_0
    iget-object v4, p0, mUserIsTrusted:Landroid/util/SparseBooleanArray;

    monitor-enter v4

    :try_start_1
    iget-object v5, p0, mSettingsObserver:Lcom/android/server/trust/TrustManagerService$SettingsObserver;
    ...
    iget-object v5, p0, mUserIsTrusted:Landroid/util/SparseBooleanArray;
    ...
    iget-object v6, p0, mUserIsTrusted:Landroid/util/SparseBooleanArray;
    ...
    :cond_8
    invoke-direct {p0, p1, v7}, scheduleTrustTimeout(IZ)V
...
.method public synthetic lambda$addEscrowToken$0$TrustManagerService(JI)V
    ...
    invoke-direct {p0, p1, p2, p3}, dispatchEscrowTokenActivatedLocked(JI)V
...
.method public onBootPhase(I)V
    ...
    iput-boolean v1, p0, mTrustAgentsCanRun:Z

    const/4 v0, -0x1

    invoke-virtual {p0, v0}, refreshAgentList(I)V

    invoke-direct {p0, v0}, refreshDeviceLockedForUser(I)V
...
.method refreshAgentList(I)V
    ...
    :cond_0
    iget-boolean v2, v0, mTrustAgentsCanRun:Z
    ...
    iget-object v7, v0, mUserManager:Landroid/os/UserManager;
    ...
    :goto_0
    iget-object v7, v0, mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;

    new-instance v8, Landroid/util/ArraySet;

    invoke-direct {v8}, Landroid/util/ArraySet;-><init>()V

    iget-object v9, v0, mActiveAgents:Landroid/util/ArraySet;
    ...
    :cond_6
    iget-object v12, v0, mActivityManager:Landroid/app/ActivityManager;
    ...
    invoke-direct {v0, v4, v2}, resolveAllowedTrustAgents(Landroid/content/pm/PackageManager;I)Ljava/util/List;
    ...
    invoke-direct {v0, v5}, getComponentName(Landroid/content/pm/ResolveInfo;)Landroid/content/ComponentName;
    ...
    iget-object v7, v0, mActiveAgents:Landroid/util/ArraySet;
    ...
    invoke-direct {v0, v4, v5}, getSettingsAttrs(Landroid/content/pm/PackageManager;Landroid/content/pm/ResolveInfo;)Lcom/android/server/trust/TrustManagerService$SettingsAttrs;
    ...
    :cond_16
    iget-object v6, v0, mStrongAuthTracker:Lcom/android/server/trust/TrustManagerService$StrongAuthTracker;
    ...
    iget-object v4, v0, mStrongAuthTracker:Lcom/android/server/trust/TrustManagerService$StrongAuthTracker;
    ...
    :cond_1c
    iget-object v4, v0, mActiveAgents:Landroid/util/ArraySet;
    ...
    iget-object v5, v0, mActiveAgents:Landroid/util/ArraySet;
    ...
    invoke-virtual {v0, v1, v3}, updateTrust(II)V
...
.method public resetAgent(Landroid/content/ComponentName;I)V
    ...
    invoke-virtual {p0, p2, v1}, updateTrust(II)V
...
.method showKeyguardErrorMessage(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {p0, p1}, dispatchOnTrustError(Ljava/lang/CharSequence;)V
...
.method updateDevicePolicyFeatures()V
    ...
    iget-object v1, p0, mArchive:Lcom/android/server/trust/TrustArchive;
...
.method public updateTrust(II)V
    ...
    invoke-direct {p0, p1, p2, v0}, updateTrust(IIZ)V
