...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Looper;)V
    ...
    iput-object v0, p0, mRunAnyRestrictedPackages:Landroid/util/ArraySet;

    new-instance v0, Landroid/util/SparseBooleanArray;

    invoke-direct {v0}, Landroid/util/SparseBooleanArray;-><init>()V

    iput-object v0, p0, mActiveUids:Landroid/util/SparseBooleanArray;
    ...
    iput-object v1, p0, mPowerWhitelistedAllAppIds:[I

    new-array v0, v0, [I

    iput-object v0, p0, mPowerWhitelistedUserAppIds:[I

    iget-object v0, p0, mPowerWhitelistedAllAppIds:[I

    iput-object v0, p0, mTempWhitelistedAppIds:[I

    new-instance v0, Landroid/util/SparseSetArray;

    invoke-direct {v0}, Landroid/util/SparseSetArray;-><init>()V

    iput-object v0, p0, mExemptedPackages:Landroid/util/SparseSetArray;
    ...
    iput-object v0, p0, mHandler:Lcom/android/server/AppStateTracker$MyHandler;
...
.method static synthetic access$1800(Landroid/util/SparseBooleanArray;IZ)Z
    ...
    invoke-static {p0, p1, p2}, removeUidFromArray(Landroid/util/SparseBooleanArray;IZ)Z
...
.method static synthetic access$1900(Landroid/util/SparseBooleanArray;I)Z
    ...
    invoke-static {p0, p1}, addUidToArray(Landroid/util/SparseBooleanArray;I)Z
...
.method static synthetic access$200(Lcom/android/server/AppStateTracker;)Lcom/android/server/AppStateTracker$MyHandler;
    ...
    iget-object v0, p0, mHandler:Lcom/android/server/AppStateTracker$MyHandler;
...
.method static synthetic access$300(Lcom/android/server/AppStateTracker;)V
    ...
    invoke-direct {p0}, updateForceAllAppStandbyState()V
...
.method static synthetic access$700(Lcom/android/server/AppStateTracker;)Landroid/util/SparseSetArray;
    ...
    iget-object v0, p0, mExemptedPackages:Landroid/util/SparseSetArray;
...
.method static synthetic access$900(Lcom/android/server/AppStateTracker;)[Lcom/android/server/AppStateTracker$Listener;
    ...
    invoke-direct {p0}, cloneListeners()[Lcom/android/server/AppStateTracker$Listener;
...
.method private cloneListeners()[Lcom/android/server/AppStateTracker$Listener;
    ...
    :try_start_0
    iget-object v1, p0, mListeners:Landroid/util/ArraySet;

    iget-object v2, p0, mListeners:Landroid/util/ArraySet;
...
.method private findForcedAppStandbyUidPackageIndexLocked(ILjava/lang/String;)I
    ...
    iget-object v0, p0, mRunAnyRestrictedPackages:Landroid/util/ArraySet;
    ...
    iget-object v1, p0, mRunAnyRestrictedPackages:Landroid/util/ArraySet;
    ...
    iget-object v2, p0, mRunAnyRestrictedPackages:Landroid/util/ArraySet;
...
.method private isRestricted(ILjava/lang/String;ZZ)Z
    ...
    invoke-virtual {p0, p1}, isUidActive(I)Z
    ...
    iget-object v3, p0, mPowerWhitelistedAllAppIds:[I
    ...
    iget-object v3, p0, mTempWhitelistedAppIds:[I
    ...
    :cond_2
    iget-boolean v3, p0, mForcedAppStandbyEnabled:Z

    if-eqz v3, :cond_3

    invoke-virtual {p0, p1, p2}, isRunAnyRestrictedLocked(ILjava/lang/String;)Z
    ...
    iget-object v4, p0, mExemptedPackages:Landroid/util/SparseSetArray;
    ...
    :cond_5
    iget-boolean v1, p0, mForceAllAppsStandby:Z
...
.method private refreshForcedAppStandbyUidPackagesLocked()V
    ...
    iget-object v8, p0, mRunAnyRestrictedPackages:Landroid/util/ArraySet;
...
.method private toggleForceAllAppsStandbyLocked(Z)V
    ...
    iget-boolean v0, p0, mForceAllAppsStandby:Z
    ...
    :cond_0
    iput-boolean p1, p0, mForceAllAppsStandby:Z
...
.method private updateForceAllAppStandbyState()V
    ...
    :try_start_0
    iget-boolean v1, p0, mForceAllAppStandbyForSmallBattery:Z

    if-eqz v1, :cond_1

    invoke-virtual {p0}, isSmallBatteryDevice()Z

    move-result v1

    if-eqz v1, :cond_1

    iget-boolean v1, p0, mIsPluggedIn:Z
    ...
    :goto_0
    invoke-direct {p0, v1}, toggleForceAllAppsStandbyLocked(Z)V

    goto :goto_1

    :cond_1
    iget-boolean v1, p0, mBatterySaverEnabled:Z
...
.method public areAlarmsRestricted(ILjava/lang/String;Z)Z
    ...
    invoke-direct {p0, p1, p2, v0, p3}, isRestricted(ILjava/lang/String;ZZ)Z
...
.method public dump(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    iget-boolean v2, p0, mForcedAppStandbyEnabled:Z
    ...
    invoke-virtual {p0}, isForceAllAppsStandbyEnabled()Z
    ...
    iget-object v1, p0, mActiveUids:Landroid/util/SparseBooleanArray;

    invoke-direct {p0, p1, v1}, dumpUids(Ljava/io/PrintWriter;Landroid/util/SparseBooleanArray;)V
    ...
    iget-object v1, p0, mPowerWhitelistedAllAppIds:[I
    ...
    iget-object v1, p0, mPowerWhitelistedUserAppIds:[I
    ...
    iget-object v1, p0, mTempWhitelistedAppIds:[I
    ...
    :goto_0
    iget-object v3, p0, mExemptedPackages:Landroid/util/SparseSetArray;
    ...
    iget-object v1, p0, mStatLogger:Lcom/android/internal/util/StatLogger;
...
.method public dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, dump(Lcom/android/internal/util/IndentingPrintWriter;)V
...
.method public dumpProto(Landroid/util/proto/ProtoOutputStream;J)V
    ...
    iget-boolean v0, v1, mForceAllAppsStandby:Z
    ...
    iget-boolean v0, v1, mForceAllAppStandbyForSmallBattery:Z

    invoke-virtual {v2, v6, v7, v0}, Landroid/util/proto/ProtoOutputStream;->write(JZ)V

    const-wide v6, 0x10800000008L

    iget-boolean v0, v1, mIsPluggedIn:Z
    ...
    :goto_0
    iget-object v7, v1, mActiveUids:Landroid/util/SparseBooleanArray;
    ...
    iget-object v9, v1, mActiveUids:Landroid/util/SparseBooleanArray;
    ...
    :goto_1
    iget-object v7, v1, mForegroundUids:Landroid/util/SparseBooleanArray;
    ...
    iget-object v9, v1, mForegroundUids:Landroid/util/SparseBooleanArray;
    ...
    :cond_3
    iget-object v6, v1, mPowerWhitelistedAllAppIds:[I
    ...
    :cond_4
    iget-object v6, v1, mPowerWhitelistedUserAppIds:[I
    ...
    :cond_5
    iget-object v6, v1, mTempWhitelistedAppIds:[I
    ...
    :goto_5
    iget-object v7, v1, mExemptedPackages:Landroid/util/SparseSetArray;
    ...
    :goto_6
    iget-object v12, v1, mExemptedPackages:Landroid/util/SparseSetArray;
    ...
    iget-object v14, v1, mExemptedPackages:Landroid/util/SparseSetArray;
    ...
    :cond_8
    iget-object v0, v1, mRunAnyRestrictedPackages:Landroid/util/ArraySet;
    ...
    :cond_9
    iget-object v0, v1, mStatLogger:Lcom/android/internal/util/StatLogger;
...
.method handleUserRemoved(I)V
    ...
    iget-object v5, p0, mRunAnyRestrictedPackages:Landroid/util/ArraySet;
    ...
    invoke-direct {p0, v1, p1}, cleanUpArrayForUser(Landroid/util/SparseBooleanArray;I)V

    iget-object v1, p0, mForegroundUids:Landroid/util/SparseBooleanArray;

    invoke-direct {p0, v1, p1}, cleanUpArrayForUser(Landroid/util/SparseBooleanArray;I)V

    iget-object v1, p0, mExemptedPackages:Landroid/util/SparseSetArray;
...
.method isRunAnyRestrictedLocked(ILjava/lang/String;)Z
    ...
    invoke-direct {p0, p1, p2}, findForcedAppStandbyUidPackageIndexLocked(ILjava/lang/String;)I
...
.method public synthetic lambda$onSystemServicesReady$0$AppStateTracker(Landroid/os/PowerSaveState;)V
    ...
    iput-boolean v1, p0, mBatterySaverEnabled:Z
...
.method public onSystemServicesReady()V
    ...
    invoke-virtual {p0}, injectIActivityManager()Landroid/app/IActivityManager;
    ...
    iput-object v1, p0, mIActivityManager:Landroid/app/IActivityManager;

    invoke-virtual {p0}, injectActivityManagerInternal()Landroid/app/ActivityManagerInternal;
    ...
    iput-object v1, p0, mActivityManagerInternal:Landroid/app/ActivityManagerInternal;

    invoke-virtual {p0}, injectAppOpsManager()Landroid/app/AppOpsManager;
    ...
    invoke-virtual {p0}, injectIAppOpsService()Lcom/android/internal/app/IAppOpsService;
    ...
    invoke-virtual {p0}, injectPowerManagerInternal()Landroid/os/PowerManagerInternal;
    ...
    iput-object v1, p0, mPowerManagerInternal:Landroid/os/PowerManagerInternal;

    nop

    invoke-virtual {p0}, injectUsageStatsManagerInternal()Landroid/app/usage/UsageStatsManagerInternal;
    ...
    iput-object v1, p0, mFlagsObserver:Lcom/android/server/AppStateTracker$FeatureFlagsObserver;

    iget-object v1, p0, mFlagsObserver:Lcom/android/server/AppStateTracker$FeatureFlagsObserver;
    ...
    iput-boolean v1, p0, mForcedAppStandbyEnabled:Z
    ...
    iput-boolean v1, p0, mForceAllAppStandbyForSmallBattery:Z
    ...
    iput-object v1, p0, mStandbyTracker:Lcom/android/server/AppStateTracker$StandbyTracker;

    iget-object v1, p0, mUsageStatsManagerInternal:Landroid/app/usage/UsageStatsManagerInternal;

    iget-object v2, p0, mStandbyTracker:Lcom/android/server/AppStateTracker$StandbyTracker;
    ...
    :try_start_1
    iget-object v2, p0, mIActivityManager:Landroid/app/IActivityManager;
    ...
    invoke-direct {p0}, refreshForcedAppStandbyUidPackagesLocked()V
...
.method public setPowerSaveWhitelistAppIds([I[I[I)V
    ...
    iget-object v2, p0, mTempWhitelistedAppIds:[I

    iput-object p1, p0, mPowerWhitelistedAllAppIds:[I

    iput-object p3, p0, mTempWhitelistedAppIds:[I

    iput-object p2, p0, mPowerWhitelistedUserAppIds:[I

    iget-object v3, p0, mPowerWhitelistedAllAppIds:[I

    invoke-static {v1, v3}, isAnyAppIdUnwhitelisted([I[I)Z

    move-result v3

    if-eqz v3, :cond_0

    iget-object v3, p0, mHandler:Lcom/android/server/AppStateTracker$MyHandler;
