...
.method constructor <init>(Landroid/content/Context;Ljava/util/List;ILjava/util/function/UnaryOperator;Ljava/util/function/UnaryOperator;)V
    ...
    iput-object p2, p0, mScoredNetworkList:Ljava/util/List;

    iput p3, p0, mNetworkType:I

    iput-object p4, p0, mCurrentNetworkFilter:Ljava/util/function/UnaryOperator;

    iput-object p5, p0, mScanResultsFilter:Ljava/util/function/UnaryOperator;
...
.method static create(Landroid/content/Context;Ljava/util/List;I)Lcom/android/server/NetworkScoreService$FilteringCacheUpdatingConsumer;
    ...
    invoke-direct/range {v0 .. v5}, <init>(Landroid/content/Context;Ljava/util/List;ILjava/util/function/UnaryOperator;Ljava/util/function/UnaryOperator;)V
...
.method private filterScores(Ljava/util/List;I)Ljava/util/List;
    ...
    :cond_0
    iget-object v0, p0, mScanResultsFilter:Ljava/util/function/UnaryOperator;
    ...
    iput-object v0, p0, mScanResultsFilter:Ljava/util/function/UnaryOperator;
    ...
    :cond_2
    iget-object v0, p0, mCurrentNetworkFilter:Ljava/util/function/UnaryOperator;
    ...
    iput-object v0, p0, mCurrentNetworkFilter:Ljava/util/function/UnaryOperator;
...
.method public accept(Landroid/net/INetworkScoreCache;Ljava/lang/Object;)V
    ...
    :cond_0
    :try_start_0
    iget-object v1, p0, mScoredNetworkList:Ljava/util/List;

    invoke-direct {p0, v1, v0}, filterScores(Ljava/util/List;I)Ljava/util/List;
...
.method public bridge synthetic accept(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, accept(Landroid/net/INetworkScoreCache;Ljava/lang/Object;)V
