...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;Lcom/android/server/DeviceIdleController$LocalService;)V
    ...
    iput-boolean v0, p0, mMonitoring:Z
    ...
    iput-object v0, p0, mTimeoutCallback:Ljava/lang/Runnable;

    iput-object p1, p0, mContext:Landroid/content/Context;

    iput-object p2, p0, mHandler:Landroid/os/Handler;

    iput-object p3, p0, mLocalService:Lcom/android/server/DeviceIdleController$LocalService;
    ...
    iput-object v0, p0, mBluetoothManager:Landroid/bluetooth/BluetoothManager;
...
.method static synthetic access$000(Lcom/android/server/deviceidle/BluetoothConstraint;)Lcom/android/server/DeviceIdleController$LocalService;
    ...
    iget-object v0, p0, mLocalService:Lcom/android/server/DeviceIdleController$LocalService;
...
.method static synthetic access$100(Lcom/android/server/deviceidle/BluetoothConstraint;)V
    ...
    invoke-direct {p0}, updateAndReportActiveLocked()V
...
.method private declared-synchronized cancelMonitoringDueToTimeout()V
    ...
    :try_start_0
    iget-boolean v0, p0, mMonitoring:Z
    ...
    iget-object v1, p0, mLocalService:Lcom/android/server/DeviceIdleController$LocalService;
...
.method private updateAndReportActiveLocked()V
    ...
    iget-object v0, p0, mBluetoothManager:Landroid/bluetooth/BluetoothManager;

    invoke-static {v0}, isBluetoothConnected(Landroid/bluetooth/BluetoothManager;)Z
...
.method public synthetic lambda$new$0$BluetoothConstraint()V
    ...
    invoke-direct {p0}, cancelMonitoringDueToTimeout()V
...
.method public declared-synchronized startMonitoring()V
    ...
    iget-object v3, p0, mTimeoutCallback:Ljava/lang/Runnable;
...
.method public declared-synchronized stopMonitoring()V
    ...
    iget-object v1, p0, mTimeoutCallback:Ljava/lang/Runnable;
