...
.method static constructor <clinit>()V
    ...
    sput-object v0, TETHER_SERVICE:Landroid/content/ComponentName;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/internal/util/StateMachine;Landroid/net/util/SharedLog;ILcom/android/server/connectivity/MockableSystemProperties;)V
    ...
    iput-boolean v0, p0, mCellularUpstreamPermitted:Z

    const/4 v0, 0x0

    iput-boolean v0, p0, mUsingCellularAsUpstream:Z

    iput-boolean v0, p0, mNeedReRunProvisioningUi:Z
    ...
    iput-object v0, p0, mCurrentTethers:Landroid/util/ArraySet;

    new-instance v0, Landroid/util/SparseIntArray;

    invoke-direct {v0}, Landroid/util/SparseIntArray;-><init>()V

    iput-object v0, p0, mCellularPermitted:Landroid/util/SparseIntArray;

    iput-object p5, p0, mSystemProperties:Lcom/android/server/connectivity/MockableSystemProperties;

    new-instance v0, Landroid/util/SparseIntArray;

    invoke-direct {v0}, Landroid/util/SparseIntArray;-><init>()V

    iput-object v0, p0, mEntitlementCacheValue:Landroid/util/SparseIntArray;

    iput-object p2, p0, mTetherMasterSM:Lcom/android/internal/util/StateMachine;

    iput p4, p0, mPermissionChangeMessageCode:I
    ...
    iput-object v1, p0, mHandler:Lcom/android/server/connectivity/tethering/EntitlementManager$EntitlementHandler;
    ...
    iget-object v4, p0, mHandler:Lcom/android/server/connectivity/tethering/EntitlementManager$EntitlementHandler;
...
.method static synthetic access$100(Lcom/android/server/connectivity/tethering/EntitlementManager;)Lcom/android/server/connectivity/tethering/EntitlementManager$TetheringConfigurationFetcher;
    ...
    iget-object v0, p0, mFetcher:Lcom/android/server/connectivity/tethering/EntitlementManager$TetheringConfigurationFetcher;
...
.method static synthetic access$300(Lcom/android/server/connectivity/tethering/EntitlementManager;IZ)V
    ...
    invoke-direct {p0, p1, p2}, handleStartProvisioningIfNeeded(IZ)V
...
.method static synthetic access$400(Lcom/android/server/connectivity/tethering/EntitlementManager;I)V
    ...
    invoke-direct {p0, p1}, handleStopProvisioningIfNeeded(I)V
...
.method static synthetic access$500(Lcom/android/server/connectivity/tethering/EntitlementManager;Z)V
    ...
    invoke-direct {p0, p1}, handleNotifyUpstream(Z)V
...
.method static synthetic access$600(Lcom/android/server/connectivity/tethering/EntitlementManager;Lcom/android/server/connectivity/tethering/TetheringConfiguration;)V
    ...
    invoke-direct {p0, p1}, handleMaybeRunProvisioning(Lcom/android/server/connectivity/tethering/TetheringConfiguration;)V
...
.method static synthetic access$700(Lcom/android/server/connectivity/tethering/EntitlementManager;ILandroid/os/ResultReceiver;Z)V
    ...
    invoke-direct {p0, p1, p2, p3}, handleGetLatestTetheringEntitlementValue(ILandroid/os/ResultReceiver;Z)V
...
.method static synthetic access$800(Lcom/android/server/connectivity/tethering/EntitlementManager;II)I
    ...
    invoke-direct {p0, p1, p2}, updateEntitlementCacheValue(II)I
...
.method static synthetic access$900(Lcom/android/server/connectivity/tethering/EntitlementManager;)Lcom/android/server/connectivity/tethering/EntitlementManager$OnUiEntitlementFailedListener;
    ...
    iget-object v0, p0, mListener:Lcom/android/server/connectivity/tethering/EntitlementManager$OnUiEntitlementFailedListener;
...
.method private buildProxyReceiver(IZLandroid/os/ResultReceiver;)Landroid/os/ResultReceiver;
    ...
    iget-object v2, p0, mHandler:Lcom/android/server/connectivity/tethering/EntitlementManager$EntitlementHandler;
    ...
    invoke-direct {p0, v0}, writeToParcel(Landroid/os/ResultReceiver;)Landroid/os/ResultReceiver;
...
.method private cancelTetherProvisioningRechecks()V
    ...
    iget-object v0, p0, mProvisioningRecheckAlarm:Landroid/app/PendingIntent;
    ...
    iget-object v1, p0, mProvisioningRecheckAlarm:Landroid/app/PendingIntent;

    invoke-virtual {v0, v1}, Landroid/app/AlarmManager;->cancel(Landroid/app/PendingIntent;)V

    const/4 v1, 0x0

    iput-object v1, p0, mProvisioningRecheckAlarm:Landroid/app/PendingIntent;
...
.method private carrierConfigAffirmsEntitlementCheckNotRequired(Lcom/android/server/connectivity/tethering/TetheringConfiguration;)Z
    ...
    invoke-virtual {p0, p1}, getCarrierConfig(Lcom/android/server/connectivity/tethering/TetheringConfiguration;)Landroid/os/PersistableBundle;
...
.method private evaluateCellularPermission(Lcom/android/server/connectivity/tethering/TetheringConfiguration;)V
    ...
    iget-boolean v0, p0, mCellularUpstreamPermitted:Z

    invoke-virtual {p0, p1}, isTetherProvisioningRequired(Lcom/android/server/connectivity/tethering/TetheringConfiguration;)Z
    ...
    iget-object v1, p0, mCellularPermitted:Landroid/util/SparseIntArray;
    ...
    :cond_1
    iput-boolean v2, p0, mCellularUpstreamPermitted:Z

    iget-boolean v1, p0, mCellularUpstreamPermitted:Z
    ...
    iget-boolean v3, p0, mCellularUpstreamPermitted:Z
    ...
    iget v2, p0, mPermissionChangeMessageCode:I
    ...
    invoke-direct {p0, p1}, scheduleProvisioningRechecks(Lcom/android/server/connectivity/tethering/TetheringConfiguration;)V

    goto :goto_0

    :cond_3
    invoke-direct {p0}, cancelTetherProvisioningRechecks()V
...
.method private handleGetLatestTetheringEntitlementValue(ILandroid/os/ResultReceiver;Z)V
    ...
    invoke-virtual {p0, v0}, isTetherProvisioningRequired(Lcom/android/server/connectivity/tethering/TetheringConfiguration;)Z
    ...
    :cond_0
    iget-object v1, p0, mEntitlementCacheValue:Landroid/util/SparseIntArray;
    ...
    :cond_1
    invoke-direct {p0, p1, v3, p2}, buildProxyReceiver(IZLandroid/os/ResultReceiver;)Landroid/os/ResultReceiver;

    move-result-object v2

    iget v3, v0, Lcom/android/server/connectivity/tethering/TetheringConfiguration;->subId:I

    invoke-virtual {p0, p1, v3, v2}, runUiTetherProvisioning(IILandroid/os/ResultReceiver;)V
...
.method private handleMaybeRunProvisioning(Lcom/android/server/connectivity/tethering/TetheringConfiguration;)V
    ...
    iget-object v0, p0, mCurrentTethers:Landroid/util/ArraySet;
    ...
    iget-object v2, p0, mCellularPermitted:Landroid/util/SparseIntArray;
    ...
    iget-boolean v2, p0, mNeedReRunProvisioningUi:Z

    if-eqz v2, :cond_1

    const/4 v2, 0x0

    iput-boolean v2, p0, mNeedReRunProvisioningUi:Z
    ...
    invoke-direct {p0, v2, v3}, runUiTetherProvisioning(II)V
    ...
    invoke-virtual {p0, v2, v3}, runSilentTetherProvisioning(II)V
...
.method private handleNotifyUpstream(Z)V
    ...
    iput-boolean p1, p0, mUsingCellularAsUpstream:Z

    iget-boolean v0, p0, mUsingCellularAsUpstream:Z
    ...
    invoke-direct {p0, v0}, handleMaybeRunProvisioning(Lcom/android/server/connectivity/tethering/TetheringConfiguration;)V
...
.method private handleStartProvisioningIfNeeded(IZ)V
    ...
    invoke-static {p1}, isValidDownstreamType(I)Z
    ...
    :cond_2
    iget-boolean v1, p0, mUsingCellularAsUpstream:Z
    ...
    invoke-direct {p0, p1, v1}, runUiTetherProvisioning(II)V
    ...
    invoke-virtual {p0, p1, v1}, runSilentTetherProvisioning(II)V
    ...
    :cond_4
    iget-boolean v1, p0, mNeedReRunProvisioningUi:Z

    or-int/2addr v1, p2

    iput-boolean v1, p0, mNeedReRunProvisioningUi:Z
    ...
    iput-boolean v1, p0, mCellularUpstreamPermitted:Z
...
.method private handleStopProvisioningIfNeeded(I)V
    ...
    invoke-virtual {p0, p1}, removeDownstreamMapping(I)V
...
.method private runUiTetherProvisioning(II)V
    ...
    invoke-direct {p0, p1, v0, v1}, buildProxyReceiver(IZLandroid/os/ResultReceiver;)Landroid/os/ResultReceiver;

    move-result-object v0

    invoke-virtual {p0, p1, p2, v0}, runUiTetherProvisioning(IILandroid/os/ResultReceiver;)V
...
.method private scheduleProvisioningRechecks(Lcom/android/server/connectivity/tethering/TetheringConfiguration;)V
    ...
    iput-object v2, p0, mProvisioningRecheckAlarm:Landroid/app/PendingIntent;
    ...
    iget-object v9, p0, mProvisioningRecheckAlarm:Landroid/app/PendingIntent;
...
.method private updateEntitlementCacheValue(II)I
    ...
    iget-object v0, p0, mEntitlementCacheValue:Landroid/util/SparseIntArray;
...
.method protected addDownstreamMapping(II)V
    ...
    iget-object v2, p0, mCurrentTethers:Landroid/util/ArraySet;
    ...
    :cond_0
    iget-object v0, p0, mCellularPermitted:Landroid/util/SparseIntArray;
    ...
    invoke-direct {p0, v0}, evaluateCellularPermission(Lcom/android/server/connectivity/tethering/TetheringConfiguration;)V
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    invoke-static {v2}, typeString(I)Ljava/lang/String;
    ...
    invoke-static {v2}, errorString(I)Ljava/lang/String;
...
.method public getLatestTetheringEntitlementResult(ILandroid/os/ResultReceiver;Z)V
    ...
    iget-object v0, p0, mHandler:Lcom/android/server/connectivity/tethering/EntitlementManager$EntitlementHandler;
...
.method protected isTetherProvisioningRequired(Lcom/android/server/connectivity/tethering/TetheringConfiguration;)Z
    ...
    :cond_0
    invoke-direct {p0, p1}, carrierConfigAffirmsEntitlementCheckNotRequired(Lcom/android/server/connectivity/tethering/TetheringConfiguration;)Z
...
.method public reevaluateSimCardProvisioning(Lcom/android/server/connectivity/tethering/TetheringConfiguration;)V
    ...
    :cond_3
    :goto_0
    invoke-direct {p0, p1}, evaluateCellularPermission(Lcom/android/server/connectivity/tethering/TetheringConfiguration;)V
...
.method protected runSilentTetherProvisioning(II)V
    ...
    sget-object v2, TETHER_SERVICE:Landroid/content/ComponentName;
...
.method public setOnUiEntitlementFailedListener(Lcom/android/server/connectivity/tethering/EntitlementManager$OnUiEntitlementFailedListener;)V
    ...
    iput-object p1, p0, mListener:Lcom/android/server/connectivity/tethering/EntitlementManager$OnUiEntitlementFailedListener;
...
.method public setTetheringConfigurationFetcher(Lcom/android/server/connectivity/tethering/EntitlementManager$TetheringConfigurationFetcher;)V
    ...
    iput-object p1, p0, mFetcher:Lcom/android/server/connectivity/tethering/EntitlementManager$TetheringConfigurationFetcher;
