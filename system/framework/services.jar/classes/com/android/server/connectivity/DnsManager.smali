...
.method static constructor <clinit>()V
    ...
    sput-object v0, PRIVATE_DNS_OFF:Landroid/net/shared/PrivateDnsConfig;
...
.method public constructor <init>(Landroid/content/Context;Landroid/net/IDnsResolver;Lcom/android/server/connectivity/MockableSystemProperties;)V
    ...
    iput-object p2, p0, mDnsResolver:Landroid/net/IDnsResolver;

    iput-object p3, p0, mSystemProperties:Lcom/android/server/connectivity/MockableSystemProperties;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, mPrivateDnsMap:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, mPrivateDnsValidationMap:Ljava/util/Map;
...
.method public static getPrivateDnsConfig(Landroid/content/ContentResolver;)Landroid/net/shared/PrivateDnsConfig;
    ...
    invoke-static {p0}, getPrivateDnsMode(Landroid/content/ContentResolver;)Ljava/lang/String;
    ...
    invoke-static {p0, v2}, getStringSetting(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;
...
.method private static getPrivateDnsMode(Landroid/content/ContentResolver;)Ljava/lang/String;
    ...
    invoke-static {p0, v0}, getStringSetting(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v1}, getStringSetting(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;
...
.method private setNetDnsProperty(ILjava/lang/String;)V
    ...
    :try_start_0
    iget-object v1, p0, mSystemProperties:Lcom/android/server/connectivity/MockableSystemProperties;
...
.method private updateParametersSettings()V
    ...
    invoke-direct {p0, v1, v0}, getIntSetting(Ljava/lang/String;I)I

    move-result v1

    iput v1, p0, mSampleValidity:I

    iget v1, p0, mSampleValidity:I
    ...
    iput v1, p0, mSuccessThreshold:I

    iget v1, p0, mSuccessThreshold:I
    ...
    iget v4, p0, mSuccessThreshold:I
    ...
    iput v0, p0, mSuccessThreshold:I
    ...
    iput v1, p0, mMinSamples:I

    const/16 v1, 0x40

    const-string v2, "dns_resolver_max_samples"

    invoke-direct {p0, v2, v1}, getIntSetting(Ljava/lang/String;I)I

    move-result v2

    iput v2, p0, mMaxSamples:I

    iget v2, p0, mMinSamples:I

    if-ltz v2, :cond_4

    iget v3, p0, mMaxSamples:I
    ...
    iput v0, p0, mMinSamples:I

    iput v1, p0, mMaxSamples:I
...
.method public getPrivateDnsConfig()Landroid/net/shared/PrivateDnsConfig;
    ...
    invoke-static {v0}, getPrivateDnsConfig(Landroid/content/ContentResolver;)Landroid/net/shared/PrivateDnsConfig;
...
.method public removeNetwork(Landroid/net/Network;)V
    ...
    iget-object v0, p0, mPrivateDnsMap:Ljava/util/Map;
    ...
    iget-object v0, p0, mPrivateDnsValidationMap:Ljava/util/Map;
...
.method public setDefaultDnsSystemProperties(Ljava/util/Collection;)V
    ...
    invoke-direct {p0, v0, v3}, setNetDnsProperty(ILjava/lang/String;)V
    ...
    :goto_1
    iget v2, p0, mNumDnsEntries:I

    if-gt v1, v2, :cond_1

    const-string v2, ""

    invoke-direct {p0, v1, v2}, setNetDnsProperty(ILjava/lang/String;)V
...
.method public setDnsConfigurationForNetwork(ILandroid/net/LinkProperties;Z)V
    ...
    invoke-direct {p0}, updateParametersSettings()V

    new-instance v0, Landroid/net/ResolverParamsParcel;

    invoke-direct {v0}, Landroid/net/ResolverParamsParcel;-><init>()V

    iget-object v1, p0, mPrivateDnsMap:Ljava/util/Map;

    invoke-static {p1}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v2

    sget-object v3, PRIVATE_DNS_OFF:Landroid/net/shared/PrivateDnsConfig;
    ...
    invoke-static {v4}, getDomainStrings(Ljava/lang/String;)[Ljava/lang/String;
    ...
    iget-object v5, p0, mPrivateDnsValidationMap:Ljava/util/Map;
    ...
    :try_start_0
    iget-object v4, p0, mDnsResolver:Landroid/net/IDnsResolver;
    ...
    invoke-virtual {p0, v4}, setDefaultDnsSystemProperties(Ljava/util/Collection;)V
...
.method public updatePrivateDnsStatus(ILandroid/net/LinkProperties;)V
    ...
    sget-object v2, PRIVATE_DNS_OFF:Landroid/net/shared/PrivateDnsConfig;
    ...
    iget-object v3, p0, mPrivateDnsValidationMap:Ljava/util/Map;
