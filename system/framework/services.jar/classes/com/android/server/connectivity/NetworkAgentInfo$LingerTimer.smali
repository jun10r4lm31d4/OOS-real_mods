...
.method public constructor <init>(Landroid/net/NetworkRequest;J)V
    ...
    iput-object p1, p0, request:Landroid/net/NetworkRequest;

    iput-wide p2, p0, expiryMs:J
...
.method public compareTo(Lcom/android/server/connectivity/NetworkAgentInfo$LingerTimer;)I
    ...
    iget-wide v0, p0, expiryMs:J

    iget-wide v2, p1, expiryMs:J
    ...
    iget-object v1, p1, request:Landroid/net/NetworkRequest;
...
.method public bridge synthetic compareTo(Ljava/lang/Object;)I
    ...
    invoke-virtual {p0, p1}, compareTo(Lcom/android/server/connectivity/NetworkAgentInfo$LingerTimer;)I
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v2, p0, request:Landroid/net/NetworkRequest;

    iget v2, v2, Landroid/net/NetworkRequest;->requestId:I

    iget-object v3, v0, request:Landroid/net/NetworkRequest;

    iget v3, v3, Landroid/net/NetworkRequest;->requestId:I

    if-ne v2, v3, :cond_1

    iget-wide v2, p0, expiryMs:J

    iget-wide v4, v0, expiryMs:J
