...
.method public constructor <init>(Lcom/android/server/connectivity/MultipathPolicyTracker;Landroid/net/Network;Landroid/net/NetworkCapabilities;)V
    ...
    iput-object p1, p0, this$0:Lcom/android/server/connectivity/MultipathPolicyTracker;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, network:Landroid/net/Network;
    ...
    iput-object v3, p0, subscriberId:Ljava/lang/String;

    new-instance v3, Landroid/net/NetworkTemplate;

    const/4 v5, 0x1

    iget-object v6, p0, subscriberId:Ljava/lang/String;
    ...
    iput-object v3, p0, mNetworkTemplate:Landroid/net/NetworkTemplate;
    ...
    iput-object v0, p0, mUsageCallback:Landroid/app/usage/NetworkStatsManager$UsageCallback;

    invoke-virtual {p0}, updateMultipathBudget()V
...
.method static synthetic access$202(Lcom/android/server/connectivity/MultipathPolicyTracker$MultipathTracker;J)J
    ...
    iput-wide p1, p0, mMultipathBudget:J
...
.method private getDailyNonDefaultDataUsage()J
    ...
    iget-object v0, p0, this$0:Lcom/android/server/connectivity/MultipathPolicyTracker;
    ...
    invoke-direct {p0, v2, v3, v4, v5}, getNetworkTotalBytes(JJ)J
...
.method private getNetworkTotalBytes(JJ)J
    ...
    iget-object v2, p0, mNetworkTemplate:Landroid/net/NetworkTemplate;
...
.method private getRemainingDailyBudget(JLandroid/util/Range;)J
    ...
    invoke-direct {p0, v1, v2, v3, v4}, getNetworkTotalBytes(JJ)J
    ...
    iget-object v9, v0, this$0:Lcom/android/server/connectivity/MultipathPolicyTracker;
...
.method private getTemplateMatchingNetworkIdentity(Landroid/net/NetworkCapabilities;)Landroid/net/NetworkIdentity;
    ...
    iget-object v3, p0, subscriberId:Ljava/lang/String;
...
.method private getUserPolicyOpportunisticQuotaBytes()J
    ...
    iget-object v3, v0, mNetworkCapabilities:Landroid/net/NetworkCapabilities;

    invoke-direct {v0, v3}, getTemplateMatchingNetworkIdentity(Landroid/net/NetworkCapabilities;)Landroid/net/NetworkIdentity;

    move-result-object v3

    iget-object v4, v0, this$0:Lcom/android/server/connectivity/MultipathPolicyTracker;
    ...
    invoke-direct {v0, v14, v15, v7}, getRemainingDailyBudget(JLandroid/util/Range;)J
...
.method private haveMultipathBudget()Z
    ...
    iget-wide v0, p0, mMultipathBudget:J
...
.method private maybeUnregisterUsageCallback()V
    ...
    invoke-direct {p0}, haveMultipathBudget()Z
    ...
    iget-object v1, p0, mUsageCallback:Landroid/app/usage/NetworkStatsManager$UsageCallback;
    ...
    iput-wide v0, p0, mMultipathBudget:J
...
.method private registerUsageCallback(J)V
    ...
    invoke-direct {p0}, maybeUnregisterUsageCallback()V
    ...
    iget-object v6, p0, mUsageCallback:Landroid/app/usage/NetworkStatsManager$UsageCallback;
...
.method updateMultipathBudget()V
    ...
    invoke-direct {p0}, getUserPolicyOpportunisticQuotaBytes()J
    ...
    iget-object v4, p0, this$0:Lcom/android/server/connectivity/MultipathPolicyTracker;
    ...
    :cond_2
    iput-wide v0, p0, mQuota:J

    invoke-direct {p0}, getDailyNonDefaultDataUsage()J
    ...
    invoke-direct {p0, v2, v3}, registerUsageCallback(J)V
