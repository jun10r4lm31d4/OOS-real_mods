...
.method static constructor <clinit>()V
    ...
    sput-object v0, messageClasses:[Ljava/lang/Class;

    sget-object v0, messageClasses:[Ljava/lang/Class;
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Landroid/net/INetworkStatsService;Landroid/net/INetworkPolicyManager;Landroid/os/Looper;Lcom/android/server/connectivity/MockableSystemProperties;Lcom/android/server/connectivity/tethering/TetheringDependencies;)V
    ...
    iput-object v2, v0, mLog:Landroid/net/util/SharedLog;

    new-instance v2, Landroid/os/RemoteCallbackList;

    invoke-direct {v2}, Landroid/os/RemoteCallbackList;-><init>()V

    iput-object v2, v0, mTetheringEventCallbacks:Landroid/os/RemoteCallbackList;

    const/4 v2, 0x0

    iput v2, v0, mConnectedClients:I

    const/4 v3, 0x0

    iput-object v3, v0, mCallerPkg:Ljava/lang/String;

    iput-boolean v2, v0, mWifiTethered:Z

    iput-boolean v2, v0, mUsbTethered:Z

    iput-boolean v2, v0, mBluetoothTethered:Z

    iget-object v2, v0, mLog:Landroid/net/util/SharedLog;
    ...
    iput-object v4, v0, mNMService:Landroid/os/INetworkManagementService;

    move-object/from16 v5, p3

    iput-object v5, v0, mStatsService:Landroid/net/INetworkStatsService;

    move-object/from16 v6, p4

    iput-object v6, v0, mPolicyManager:Landroid/net/INetworkPolicyManager;

    move-object/from16 v7, p5

    iput-object v7, v0, mLooper:Landroid/os/Looper;

    iput-object v1, v0, mDeps:Lcom/android/server/connectivity/tethering/TetheringDependencies;

    new-instance v8, Ljava/lang/Object;

    invoke-direct {v8}, Ljava/lang/Object;-><init>()V

    iput-object v8, v0, mPublicSync:Ljava/lang/Object;

    new-instance v8, Landroid/util/ArrayMap;

    invoke-direct {v8}, Landroid/util/ArrayMap;-><init>()V

    iput-object v8, v0, mTetherStates:Landroid/util/ArrayMap;

    new-instance v8, Lcom/android/server/connectivity/Tethering$TetherMasterSM;

    iget-object v9, v0, mLooper:Landroid/os/Looper;
    ...
    iput-object v8, v0, mTetherMasterSM:Lcom/android/internal/util/StateMachine;

    iget-object v8, v0, mTetherMasterSM:Lcom/android/internal/util/StateMachine;
    ...
    iput-object v8, v0, mHandler:Landroid/os/Handler;

    new-instance v8, Lcom/android/server/connectivity/tethering/OffloadController;

    iget-object v10, v0, mHandler:Landroid/os/Handler;

    iget-object v9, v0, mDeps:Lcom/android/server/connectivity/tethering/TetheringDependencies;

    iget-object v11, v0, mLog:Landroid/net/util/SharedLog;
    ...
    iget-object v13, v0, mNMService:Landroid/os/INetworkManagementService;

    iget-object v14, v0, mLog:Landroid/net/util/SharedLog;
    ...
    iput-object v8, v0, mOffloadController:Lcom/android/server/connectivity/tethering/OffloadController;

    iget-object v8, v0, mContext:Landroid/content/Context;

    iget-object v9, v0, mTetherMasterSM:Lcom/android/internal/util/StateMachine;

    iget-object v10, v0, mLog:Landroid/net/util/SharedLog;
    ...
    iput-object v8, v0, mUpstreamNetworkMonitor:Lcom/android/server/connectivity/tethering/UpstreamNetworkMonitor;

    new-instance v8, Ljava/util/HashSet;

    invoke-direct {v8}, Ljava/util/HashSet;-><init>()V

    iput-object v8, v0, mForwardedDownstreams:Ljava/util/HashSet;
    ...
    iget-object v10, v0, mDeps:Lcom/android/server/connectivity/tethering/TetheringDependencies;

    iget-object v11, v0, mContext:Landroid/content/Context;

    iget-object v12, v0, mTetherMasterSM:Lcom/android/internal/util/StateMachine;

    iget-object v13, v0, mLog:Landroid/net/util/SharedLog;
    ...
    iput-object v9, v0, mEntitlementMgr:Lcom/android/server/connectivity/tethering/EntitlementManager;

    iget-object v9, v0, mEntitlementMgr:Lcom/android/server/connectivity/tethering/EntitlementManager;
    ...
    iput-object v15, v0, mCarrierConfigChange:Landroid/net/util/VersionedBroadcastListener;
    ...
    iput-object v9, v0, mDefaultSubscriptionChange:Landroid/net/util/VersionedBroadcastListener;
    ...
    iput-object v9, v0, mStateReceiver:Landroid/content/BroadcastReceiver;

    invoke-direct/range {p0 .. p0}, updateConfiguration()V

    iget-object v3, v0, mHandler:Landroid/os/Handler;

    invoke-direct {v0, v3}, startStateMachineUpdaters(Landroid/os/Handler;)V
...
.method static synthetic access$100(Lcom/android/server/connectivity/Tethering;Landroid/os/ResultReceiver;I)V
    ...
    invoke-direct {p0, p1, p2}, sendTetherResult(Landroid/os/ResultReceiver;I)V
...
.method static synthetic access$1000(Lcom/android/server/connectivity/Tethering;Ljava/lang/String;I)V
    ...
    invoke-direct {p0, p1, p2}, enableWifiIpServingLocked(Ljava/lang/String;I)V
...
.method static synthetic access$1102(Lcom/android/server/connectivity/Tethering;I)I
    ...
    iput p1, p0, mConnectedClients:I
...
.method static synthetic access$1200(Lcom/android/server/connectivity/Tethering;Ljava/lang/String;I)V
    ...
    invoke-direct {p0, p1, p2}, disableWifiIpServingLocked(Ljava/lang/String;I)V
...
.method static synthetic access$1300(Lcom/android/server/connectivity/Tethering;Lcom/android/internal/util/State;I)V
    ...
    invoke-direct {p0, p1, p2}, logMessage(Lcom/android/internal/util/State;I)V
...
.method static synthetic access$1700(Lcom/android/server/connectivity/Tethering;)Lcom/android/server/connectivity/tethering/TetheringConfiguration;
    ...
    iget-object v0, p0, mConfig:Lcom/android/server/connectivity/tethering/TetheringConfiguration;
...
.method static synthetic access$1900(Lcom/android/server/connectivity/Tethering;)V
    ...
    invoke-direct {p0}, maybeDunSettingChanged()V
...
.method static synthetic access$2000(Lcom/android/server/connectivity/Tethering;)Lcom/android/server/connectivity/tethering/UpstreamNetworkMonitor;
    ...
    iget-object v0, p0, mUpstreamNetworkMonitor:Lcom/android/server/connectivity/tethering/UpstreamNetworkMonitor;
...
.method static synthetic access$2100(Lcom/android/server/connectivity/Tethering;)Landroid/net/Network;
    ...
    iget-object v0, p0, mTetherUpstream:Landroid/net/Network;
...
.method static synthetic access$2102(Lcom/android/server/connectivity/Tethering;Landroid/net/Network;)Landroid/net/Network;
    ...
    iput-object p1, p0, mTetherUpstream:Landroid/net/Network;
...
.method static synthetic access$2200(Lcom/android/server/connectivity/Tethering;Landroid/net/Network;)V
    ...
    invoke-direct {p0, p1}, reportUpstreamChanged(Landroid/net/Network;)V
...
.method static synthetic access$2300(Lcom/android/server/connectivity/Tethering;Landroid/net/NetworkState;)Z
    ...
    invoke-direct {p0, p1}, pertainsToCurrentUpstream(Landroid/net/NetworkState;)Z
...
.method static synthetic access$2400(Lcom/android/server/connectivity/Tethering;)Landroid/net/util/InterfaceSet;
    ...
    iget-object v0, p0, mCurrentUpstreamIfaceSet:Landroid/net/util/InterfaceSet;
...
.method static synthetic access$2402(Lcom/android/server/connectivity/Tethering;Landroid/net/util/InterfaceSet;)Landroid/net/util/InterfaceSet;
    ...
    iput-object p1, p0, mCurrentUpstreamIfaceSet:Landroid/net/util/InterfaceSet;
...
.method static synthetic access$2500(Lcom/android/server/connectivity/Tethering;)Ljava/util/HashSet;
    ...
    iget-object v0, p0, mForwardedDownstreams:Ljava/util/HashSet;
...
.method static synthetic access$2800(Lcom/android/server/connectivity/Tethering;)Z
    ...
    invoke-direct {p0}, upstreamWanted()Z
...
.method static synthetic access$300(Lcom/android/server/connectivity/Tethering;)V
    ...
    invoke-direct {p0}, updateConfiguration()V
...
.method static synthetic access$3300(Lcom/android/server/connectivity/Tethering;)Lcom/android/server/connectivity/tethering/OffloadController;
    ...
    iget-object v0, p0, mOffloadController:Lcom/android/server/connectivity/tethering/OffloadController;
...
.method static synthetic access$3400(Lcom/android/server/connectivity/Tethering;Landroid/net/ip/IpServer;II)V
    ...
    invoke-direct {p0, p1, p2, p3}, notifyInterfaceStateChange(Landroid/net/ip/IpServer;II)V
...
.method static synthetic access$3500(Lcom/android/server/connectivity/Tethering;Landroid/net/ip/IpServer;Landroid/net/LinkProperties;)V
    ...
    invoke-direct {p0, p1, p2}, notifyLinkPropertiesChanged(Landroid/net/ip/IpServer;Landroid/net/LinkProperties;)V
...
.method static synthetic access$700(Lcom/android/server/connectivity/Tethering;II)V
    ...
    invoke-direct {p0, p1, p2}, tetherMatchingInterfaces(II)V
...
.method static synthetic access$900(Lcom/android/server/connectivity/Tethering;)Ljava/lang/String;
    ...
    iget-object v0, p0, mCallerPkg:Ljava/lang/String;
...
.method static synthetic access$902(Lcom/android/server/connectivity/Tethering;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object p1, p0, mCallerPkg:Ljava/lang/String;
...
.method private changeInterfaceState(Ljava/lang/String;I)V
    ...
    :cond_0
    invoke-direct {p0, p1, p2}, tether(Ljava/lang/String;I)I
    ...
    :cond_1
    invoke-virtual {p0, p1}, untether(Ljava/lang/String;)I
...
.method private disableWifiIpServingLocked(Ljava/lang/String;I)V
    ...
    iput-boolean v0, p0, mWifiTetherRequested:Z
    ...
    iget-object v0, p0, mTetherStates:Landroid/util/ArrayMap;
    ...
    :goto_0
    iget-object v1, p0, mTetherStates:Landroid/util/ArrayMap;
...
.method private enableTetheringInternal(IZLandroid/os/ResultReceiver;)V
    ...
    invoke-direct {p0, p1, p2, p3, v0}, enableTetheringInternal(IZLandroid/os/ResultReceiver;Ljava/lang/String;)V
...
.method private enableTetheringInternal(IZLandroid/os/ResultReceiver;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p3, v0}, sendTetherResult(Landroid/os/ResultReceiver;I)V

    goto :goto_0

    :cond_0
    invoke-direct {p0, p2, p3}, setBluetoothTethering(ZLandroid/os/ResultReceiver;)V

    goto :goto_0

    :cond_1
    invoke-virtual {p0, p2}, setUsbTethering(Z)I
    ...
    :cond_2
    invoke-direct {p0, p2, p4}, setWifiTethering(ZLjava/lang/String;)I
...
.method private enableWifiIpServingLocked(Ljava/lang/String;I)V
    ...
    invoke-direct {p0, p1, v3}, maybeTrackNewInterfaceLocked(Ljava/lang/String;I)V

    invoke-direct {p0, p1, v1}, changeInterfaceState(Ljava/lang/String;I)V

    goto :goto_1

    :cond_2
    iget-object v2, p0, mLog:Landroid/net/util/SharedLog;
...
.method private logMessage(Lcom/android/internal/util/State;I)V
    ...
    sget-object v2, sMagicDecoderRing:Landroid/util/SparseArray;
...
.method private maybeDefaultDataSubChanged()V
    ...
    iget-object v0, p0, mDeps:Lcom/android/server/connectivity/tethering/TetheringDependencies;

    invoke-virtual {v0}, Lcom/android/server/connectivity/tethering/TetheringDependencies;->getDefaultDataSubscriptionId()I

    move-result v0

    iget-object v1, p0, mConfig:Lcom/android/server/connectivity/tethering/TetheringConfiguration;
    ...
    :cond_0
    invoke-direct {p0, v0}, updateConfiguration(I)V
...
.method private maybeTrackNewInterfaceLocked(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, ifaceNameToType(Ljava/lang/String;)I
    ...
    :cond_0
    invoke-direct {p0, p1, v0}, maybeTrackNewInterfaceLocked(Ljava/lang/String;I)V
...
.method private maybeTrackNewInterfaceLocked(Ljava/lang/String;I)V
    ...
    iget-object v5, p0, mLog:Landroid/net/util/SharedLog;

    iget-object v6, p0, mNMService:Landroid/os/INetworkManagementService;

    iget-object v7, p0, mStatsService:Landroid/net/INetworkStatsService;

    invoke-direct {p0}, makeControlCallback()Landroid/net/ip/IpServer$Callback;
    ...
    iget-object v1, p0, mDeps:Lcom/android/server/connectivity/tethering/TetheringDependencies;
...
.method private notifyInterfaceStateChange(Landroid/net/ip/IpServer;II)V
    ...
    iget-object v1, p0, mPublicSync:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, mTetherStates:Landroid/util/ArrayMap;
    ...
    iget-object v1, p0, mTetherMasterSM:Lcom/android/internal/util/StateMachine;
...
.method private notifyLinkPropertiesChanged(Landroid/net/ip/IpServer;Landroid/net/LinkProperties;)V
    ...
    :cond_0
    :try_start_1
    iget-object v3, p0, mLog:Landroid/net/util/SharedLog;
...
.method private pertainsToCurrentUpstream(Landroid/net/NetworkState;)Z
    ...
    iget-object v2, p0, mCurrentUpstreamIfaceSet:Landroid/net/util/InterfaceSet;
...
.method private reportUpstreamChanged(Landroid/net/Network;)V
    ...
    iget-object v0, p0, mTetheringEventCallbacks:Landroid/os/RemoteCallbackList;
    ...
    :try_start_0
    iget-object v2, p0, mTetheringEventCallbacks:Landroid/os/RemoteCallbackList;
    ...
    :cond_0
    iget-object v1, p0, mTetheringEventCallbacks:Landroid/os/RemoteCallbackList;
...
.method private sendTetherStateChangedBroadcast()V
    ...
    iput-boolean v4, p0, mWifiTethered:Z

    iput-boolean v4, p0, mUsbTethered:Z

    iput-boolean v4, p0, mBluetoothTethered:Z

    iget-object v5, p0, mConfig:Lcom/android/server/connectivity/tethering/TetheringConfiguration;
    ...
    :goto_0
    :try_start_0
    iget-object v7, p0, mTetherStates:Landroid/util/ArrayMap;
    ...
    iget-object v8, p0, mTetherStates:Landroid/util/ArrayMap;
    ...
    iput-boolean v10, p0, mUsbTethered:Z
    ...
    iput-boolean v10, p0, mWifiTethered:Z
    ...
    iput-boolean v10, p0, mBluetoothTethered:Z
    ...
    iget-boolean v6, p0, mUsbTethered:Z

    const/16 v7, 0xe

    if-eqz v6, :cond_b

    iget-boolean v6, p0, mWifiTethered:Z

    if-nez v6, :cond_a

    iget-boolean v6, p0, mBluetoothTethered:Z
    ...
    invoke-direct {p0, v6}, showTetheredNotification(I)V

    goto :goto_4

    :cond_a
    :goto_3
    invoke-direct {p0, v7}, showTetheredNotification(I)V
    ...
    :cond_c
    invoke-virtual {p0}, clearTetheredNotification()V
...
.method private setBluetoothTethering(ZLandroid/os/ResultReceiver;)V
    ...
    invoke-direct {p0, p2, v1}, sendTetherResult(Landroid/os/ResultReceiver;I)V
...
.method private setWifiTethering(Z)I
    ...
    invoke-direct {p0, p1, v0}, setWifiTethering(ZLjava/lang/String;)I
...
.method private setWifiTethering(ZLjava/lang/String;)I
    ...
    :cond_2
    iput-boolean p1, p0, mWifiTetherRequested:Z
...
.method private showTetheredNotification(I)V
    ...
    invoke-virtual {p0, p1, v0}, showTetheredNotification(IZ)V
...
.method private startStateMachineUpdaters(Landroid/os/Handler;)V
    ...
    iget-object v0, p0, mCarrierConfigChange:Landroid/net/util/VersionedBroadcastListener;

    invoke-virtual {v0}, Landroid/net/util/VersionedBroadcastListener;->startListening()V

    iget-object v0, p0, mDefaultSubscriptionChange:Landroid/net/util/VersionedBroadcastListener;
    ...
    iget-object v2, p0, mStateReceiver:Landroid/content/BroadcastReceiver;
...
.method private tether(Ljava/lang/String;I)I
    ...
    iget-object v4, p0, mCallerPkg:Ljava/lang/String;
...
.method private tetherMatchingInterfaces(II)V
    ...
    invoke-direct {p0, v4}, ifaceNameToType(Ljava/lang/String;)I
    ...
    :cond_2
    invoke-direct {p0, v1, p1}, changeInterfaceState(Ljava/lang/String;I)V
...
.method private updateConfiguration(I)V
    ...
    iput-object v0, p0, mConfig:Lcom/android/server/connectivity/tethering/TetheringConfiguration;
...
.method private upstreamWanted()Z
    ...
    :try_start_0
    iget-boolean v1, p0, mWifiTetherRequested:Z
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v2, p0, mEntitlementMgr:Lcom/android/server/connectivity/tethering/EntitlementManager;
    ...
    :goto_0
    iget-object v4, p0, mTetherStates:Landroid/util/ArrayMap;
    ...
    iget-object v5, p0, mTetherStates:Landroid/util/ArrayMap;
    ...
    iget-object v4, p0, mCurrentUpstreamIfaceSet:Landroid/net/util/InterfaceSet;
    ...
    iget-object v2, p0, mOffloadController:Lcom/android/server/connectivity/tethering/OffloadController;
    ...
    invoke-static {p3, v2}, argsContain([Ljava/lang/String;Ljava/lang/String;)Z
...
.method public getErroredIfaces()[Ljava/lang/String;
    ...
    :goto_0
    :try_start_0
    iget-object v3, p0, mTetherStates:Landroid/util/ArrayMap;
...
.method public getTetherableBluetoothRegexs()[Ljava/lang/String;
    ...
    invoke-static {v0}, copy([Ljava/lang/String;)[Ljava/lang/String;
...
.method public interfaceAdded(Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-direct {p0, p1}, maybeTrackNewInterfaceLocked(Ljava/lang/String;)V
...
.method public interfaceRemoved(Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-direct {p0, p1}, stopTrackingInterfaceLocked(Ljava/lang/String;)V
...
.method public synthetic lambda$new$0$Tethering(I)V
    ...
    invoke-virtual {p0, p1}, stopTethering(I)V
...
.method public synthetic lambda$new$1$Tethering()Lcom/android/server/connectivity/tethering/TetheringConfiguration;
    ...
    invoke-direct {p0}, maybeDefaultDataSubChanged()V
...
.method public showSoftApClientsNotification(I)V
    ...
    iget-boolean v0, p0, mUsbTethered:Z

    if-nez v0, :cond_1

    iget-boolean v0, p0, mBluetoothTethered:Z
    ...
    invoke-direct {p0, v0}, showTetheredNotification(I)V
...
.method protected showTetheredNotification(IZ)V
    ...
    :goto_0
    iget v0, v1, mLastNotificationId:I
    ...
    iput v9, v1, mLastNotificationId:I
    ...
    iget v7, v1, mConnectedClients:I
    ...
    iget v14, v1, mConnectedClients:I
    ...
    iget-object v14, v1, mPublicSync:Ljava/lang/Object;

    monitor-enter v14

    :try_start_0
    iget-object v15, v1, mTetheredNotificationBuilder:Landroid/app/Notification$Builder;
    ...
    iput-object v15, v1, mTetheredNotificationBuilder:Landroid/app/Notification$Builder;

    iget-object v8, v1, mTetheredNotificationBuilder:Landroid/app/Notification$Builder;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_1
    ...
    :goto_3
    iget-object v0, v1, mTetheredNotificationBuilder:Landroid/app/Notification$Builder;
    ...
    iput v4, v1, mLastNotificationId:I
...
.method public startTethering(ILandroid/os/ResultReceiver;ZLjava/lang/String;)V
    ...
    iput-object p4, p0, mCallerPkg:Ljava/lang/String;
    ...
    iput-object v0, p0, mCallerPkg:Ljava/lang/String;
    ...
    invoke-direct {p0, p1, v0, p2, p4}, enableTetheringInternal(IZLandroid/os/ResultReceiver;Ljava/lang/String;)V
...
.method public stopTethering(I)V
    ...
    invoke-direct {p0, p1, v0, v1}, enableTetheringInternal(IZLandroid/os/ResultReceiver;)V
...
.method public tether(Ljava/lang/String;)I
    ...
    invoke-direct {p0, p1, v0}, tether(Ljava/lang/String;I)I
...
.method public untetherAll()V
    ...
    invoke-virtual {p0, v0}, stopTethering(I)V
