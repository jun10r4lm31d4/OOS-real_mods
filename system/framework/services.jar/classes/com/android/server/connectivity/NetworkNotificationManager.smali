...
.method public constructor <init>(Landroid/content/Context;Landroid/telephony/TelephonyManager;Landroid/app/NotificationManager;)V
    ...
    iput-object p2, p0, mTelephonyManager:Landroid/telephony/TelephonyManager;

    iput-object p3, p0, mNotificationManager:Landroid/app/NotificationManager;

    new-instance v0, Landroid/util/SparseIntArray;

    invoke-direct {v0}, Landroid/util/SparseIntArray;-><init>()V

    iput-object v0, p0, mNotificationTypeMap:Landroid/util/SparseIntArray;
...
.method public clearNotification(I)V
    ...
    iget-object v0, p0, mNotificationTypeMap:Landroid/util/SparseIntArray;
    ...
    :cond_0
    invoke-static {p1}, tagFor(I)Ljava/lang/String;

    move-result-object v0

    iget-object v1, p0, mNotificationTypeMap:Landroid/util/SparseIntArray;
    ...
    invoke-static {v1}, nameOf(I)Ljava/lang/String;
    ...
    :goto_0
    iget-object v2, p0, mNotificationTypeMap:Landroid/util/SparseIntArray;
...
.method public clearNotification(ILcom/android/server/connectivity/NetworkNotificationManager$NotificationType;)V
    ...
    :cond_0
    invoke-virtual {p0, p1}, clearNotification(I)V
...
.method public setProvNotificationVisible(ZILjava/lang/String;)V
    ...
    invoke-virtual/range {v3 .. v9}, showNotification(ILcom/android/server/connectivity/NetworkNotificationManager$NotificationType;Lcom/android/server/connectivity/NetworkAgentInfo;Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/app/PendingIntent;Z)V

    goto :goto_0

    :cond_0
    invoke-virtual {p0, p2}, clearNotification(I)V
...
.method public showNotification(ILcom/android/server/connectivity/NetworkNotificationManager$NotificationType;Lcom/android/server/connectivity/NetworkAgentInfo;Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/app/PendingIntent;Z)V
    ...
    invoke-static/range {p1 .. p1}, tagFor(I)Ljava/lang/String;
    ...
    invoke-static/range {p3 .. p3}, getFirstTransportType(Lcom/android/server/connectivity/NetworkAgentInfo;)I
    ...
    :goto_1
    iget-object v0, v1, mNotificationTypeMap:Landroid/util/SparseIntArray;
    ...
    invoke-static {v10}, priority(Lcom/android/server/connectivity/NetworkNotificationManager$NotificationType;)I

    move-result v0

    invoke-static/range {p2 .. p2}, priority(Lcom/android/server/connectivity/NetworkNotificationManager$NotificationType;)I
    ...
    :cond_3
    invoke-virtual/range {p0 .. p1}, clearNotification(I)V
    ...
    invoke-static {v6}, nameOf(I)Ljava/lang/String;

    move-result-object v16

    aput-object v16, v11, v15

    invoke-static {v7}, getTransportName(I)Ljava/lang/String;
    ...
    invoke-static {v7, v3}, getIcon(ILcom/android/server/connectivity/NetworkNotificationManager$NotificationType;)I
    ...
    invoke-static/range {p4 .. p4}, getFirstTransportType(Lcom/android/server/connectivity/NetworkAgentInfo;)I

    move-result v8

    invoke-static {v8}, getTransportName(I)Ljava/lang/String;
    ...
    :try_start_1
    iget-object v0, v1, mNotificationManager:Landroid/app/NotificationManager;
...
.method public showToast(Lcom/android/server/connectivity/NetworkAgentInfo;Lcom/android/server/connectivity/NetworkAgentInfo;)V
    ...
    invoke-static {p1}, getFirstTransportType(Lcom/android/server/connectivity/NetworkAgentInfo;)I

    move-result v0

    invoke-static {v0}, getTransportName(I)Ljava/lang/String;

    move-result-object v0

    invoke-static {p2}, getFirstTransportType(Lcom/android/server/connectivity/NetworkAgentInfo;)I

    move-result v1

    invoke-static {v1}, getTransportName(I)Ljava/lang/String;
