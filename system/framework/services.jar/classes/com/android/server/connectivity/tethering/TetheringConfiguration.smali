...
.method static constructor <clinit>()V
    ...
    sput-object v0, LEGACY_DHCP_DEFAULT_RANGE:[Ljava/lang/String;

    const-string v0, "bond0"

    sput-object v0, fstInterfaceName:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Landroid/net/util/SharedLog;I)V
    ...
    iput-object v0, p0, DEFAULT_IPV4_DNS:[Ljava/lang/String;
    ...
    invoke-direct {p0, p1, v1}, getResources(Landroid/content/Context;I)Landroid/content/res/Resources;

    move-result-object v1

    const v2, 0x1070098

    invoke-static {v1, v2}, getResourceStringArray(Landroid/content/res/Resources;I)[Ljava/lang/String;

    move-result-object v2

    iput-object v2, p0, tetherableUsbRegexs:[Ljava/lang/String;
    ...
    sget-object v4, fstInterfaceName:Ljava/lang/String;

    aput-object v4, v3, v2

    iput-object v3, p0, tetherableWifiRegexs:[Ljava/lang/String;
    ...
    invoke-static {v1, v3}, getResourceStringArray(Landroid/content/res/Resources;I)[Ljava/lang/String;
    ...
    iput-object v3, p0, tetherableBluetoothRegexs:[Ljava/lang/String;

    invoke-static {p1}, checkDunRequired(Landroid/content/Context;)Z

    move-result v3

    iput-boolean v3, p0, isDunRequired:Z

    const v3, 0x11100e3

    invoke-static {v1, v3}, getResourceBoolean(Landroid/content/res/Resources;I)Z

    move-result v3

    iput-boolean v3, p0, chooseUpstreamAutomatically:Z

    iget-boolean v3, p0, isDunRequired:Z

    invoke-static {v1, v3}, getUpstreamIfaceTypes(Landroid/content/res/Resources;Z)Ljava/util/Collection;

    move-result-object v3

    iput-object v3, p0, preferredUpstreamIfaceTypes:Ljava/util/Collection;

    invoke-static {v1}, getLegacyDhcpRanges(Landroid/content/res/Resources;)[Ljava/lang/String;

    move-result-object v3

    iput-object v3, p0, legacyDhcpRanges:[Ljava/lang/String;

    iget-object v3, p0, DEFAULT_IPV4_DNS:[Ljava/lang/String;

    invoke-static {v3}, copy([Ljava/lang/String;)[Ljava/lang/String;

    move-result-object v3

    iput-object v3, p0, defaultIPv4DNS:[Ljava/lang/String;

    invoke-static {p1}, getEnableLegacyDhcpServer(Landroid/content/Context;)Z

    move-result v3

    iput-boolean v3, p0, enableLegacyDhcpServer:Z
    ...
    iput-object v3, p0, provisioningApp:[Ljava/lang/String;

    invoke-static {v1}, getProvisioningAppNoUi(Landroid/content/res/Resources;)Ljava/lang/String;

    move-result-object v3

    iput-object v3, p0, provisioningAppNoUi:Ljava/lang/String;

    const v3, 0x10e0081

    invoke-static {v1, v3, v2}, getResourceInteger(Landroid/content/res/Resources;II)I

    move-result v2

    iput v2, p0, provisioningCheckPeriod:I
...
.method public static getFstInterfaceName()Ljava/lang/String;
    ...
    sget-object v0, fstInterfaceName:Ljava/lang/String;
...
.method private static getLegacyDhcpRanges(Landroid/content/res/Resources;)[Ljava/lang/String;
    ...
    invoke-static {p0, v0}, getResourceStringArray(Landroid/content/res/Resources;I)[Ljava/lang/String;
    ...
    :cond_0
    sget-object v1, LEGACY_DHCP_DEFAULT_RANGE:[Ljava/lang/String;

    invoke-static {v1}, copy([Ljava/lang/String;)[Ljava/lang/String;
...
.method private getResources(Landroid/content/Context;I)Landroid/content/res/Resources;
    ...
    invoke-virtual {p0, p1, p2}, getResourcesForSubIdWrapper(Landroid/content/Context;I)Landroid/content/res/Resources;
...
.method private static getUpstreamIfaceTypes(Landroid/content/res/Resources;Z)Ljava/util/Collection;
    ...
    invoke-static {v1, v6}, appendIfNotPresent(Ljava/util/ArrayList;I)V
    ...
    invoke-static {v1, v2}, containsOneOf(Ljava/util/ArrayList;[Ljava/lang/Integer;)Z
    ...
    invoke-static {v1, v2}, prependIfNotPresent(Ljava/util/ArrayList;I)V
...
.method public static setFstInterfaceName(Ljava/lang/String;)V
    ...
    sput-object p0, fstInterfaceName:Ljava/lang/String;
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    invoke-static {p1, v1, v0}, dumpStringArray(Ljava/io/PrintWriter;Ljava/lang/String;[Ljava/lang/String;)V
    ...
    iget-object v0, p0, tetherableBluetoothRegexs:[Ljava/lang/String;
    ...
    iget-boolean v0, p0, isDunRequired:Z
    ...
    iget-boolean v0, p0, chooseUpstreamAutomatically:Z

    invoke-virtual {p1, v0}, Ljava/io/PrintWriter;->println(Z)V

    iget-object v0, p0, preferredUpstreamIfaceTypes:Ljava/util/Collection;

    invoke-static {v0}, preferredUpstreamNames(Ljava/util/Collection;)[Ljava/lang/String;
    ...
    iget-object v0, p0, legacyDhcpRanges:[Ljava/lang/String;

    const-string/jumbo v1, "legacyDhcpRanges"

    invoke-static {p1, v1, v0}, dumpStringArray(Ljava/io/PrintWriter;Ljava/lang/String;[Ljava/lang/String;)V

    iget-object v0, p0, defaultIPv4DNS:[Ljava/lang/String;

    const-string v1, "defaultIPv4DNS"

    invoke-static {p1, v1, v0}, dumpStringArray(Ljava/io/PrintWriter;Ljava/lang/String;[Ljava/lang/String;)V

    iget-object v0, p0, provisioningApp:[Ljava/lang/String;
    ...
    iget-object v0, p0, provisioningAppNoUi:Ljava/lang/String;
    ...
    iget-boolean v0, p0, enableLegacyDhcpServer:Z
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v3, p0, tetherableUsbRegexs:[Ljava/lang/String;

    invoke-static {v3}, makeString([Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v3, p0, tetherableWifiRegexs:[Ljava/lang/String;
    ...
    iget-object v3, p0, tetherableBluetoothRegexs:[Ljava/lang/String;
    ...
    iget-boolean v3, p0, chooseUpstreamAutomatically:Z
    ...
    iget-object v3, p0, preferredUpstreamIfaceTypes:Ljava/util/Collection;

    invoke-static {v3}, preferredUpstreamNames(Ljava/util/Collection;)[Ljava/lang/String;
    ...
    iget-object v3, p0, provisioningApp:[Ljava/lang/String;
    ...
    iget-object v3, p0, provisioningAppNoUi:Ljava/lang/String;
    ...
    iget-boolean v3, p0, enableLegacyDhcpServer:Z
