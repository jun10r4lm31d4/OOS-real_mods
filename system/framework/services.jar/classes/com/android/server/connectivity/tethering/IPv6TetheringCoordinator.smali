...
.method public constructor <init>(Ljava/util/ArrayList;Landroid/net/util/SharedLog;)V
    ...
    iput-object p1, p0, mNotifyList:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, mActiveDownstreams:Ljava/util/LinkedList;

    invoke-static {}, generateUniqueLocalPrefix()[B

    move-result-object v0

    iput-object v0, p0, mUniqueLocalPrefix:[B

    const/4 v0, 0x0

    iput-short v0, p0, mNextSubnetId:S
...
.method private static getIPv6OnlyLinkProperties(Landroid/net/LinkProperties;)Landroid/net/LinkProperties;
    ...
    invoke-static {v2}, isIPv6GlobalAddress(Ljava/net/InetAddress;)Z
...
.method private getInterfaceIPv6LinkProperties(Landroid/net/ip/IpServer;)Landroid/net/LinkProperties;
    ...
    :cond_0
    invoke-virtual {p0, p1}, findDownstream(Landroid/net/ip/IpServer;)Lcom/android/server/connectivity/tethering/IPv6TetheringCoordinator$Downstream;
    ...
    iget-object v1, p0, mUniqueLocalPrefix:[B

    iget-short v2, v0, Lcom/android/server/connectivity/tethering/IPv6TetheringCoordinator$Downstream;->subnetId:S

    invoke-static {v1, v2}, getUniqueLocalConfig([BS)Landroid/net/LinkProperties;
    ...
    :cond_2
    iget-object v2, p0, mUpstreamNetworkState:Landroid/net/NetworkState;
    ...
    :cond_3
    iget-object v2, p0, mActiveDownstreams:Ljava/util/LinkedList;
    ...
    iget-object v3, p0, mUpstreamNetworkState:Landroid/net/NetworkState;

    iget-object v3, v3, Landroid/net/NetworkState;->linkProperties:Landroid/net/LinkProperties;

    invoke-static {v3}, getIPv6OnlyLinkProperties(Landroid/net/LinkProperties;)Landroid/net/LinkProperties;
...
.method private static getUniqueLocalConfig([BS)Landroid/net/LinkProperties;
    ...
    invoke-static {p0, v1, v2}, makeUniqueLocalPrefix([BSI)Landroid/net/IpPrefix;
    ...
    invoke-static {p0, p1, v2}, makeUniqueLocalPrefix([BSI)Landroid/net/IpPrefix;
...
.method private setUpstreamNetworkState(Landroid/net/NetworkState;)V
    ...
    iput-object v0, p0, mUpstreamNetworkState:Landroid/net/NetworkState;
    ...
    invoke-static {v2}, toDebugString(Landroid/net/NetworkState;)Ljava/lang/String;
...
.method private stopIPv6TetheringOnAllInterfaces()V
    ...
    invoke-static {v1}, stopIPv6TetheringOn(Landroid/net/ip/IpServer;)V
...
.method private updateIPv6TetheringInterfaces()V
    ...
    invoke-direct {p0, v0}, getInterfaceIPv6LinkProperties(Landroid/net/ip/IpServer;)Landroid/net/LinkProperties;
...
.method public addActiveDownstream(Landroid/net/ip/IpServer;I)V
    ...
    iget-short v1, p0, mNextSubnetId:S
    ...
    :cond_0
    invoke-direct {p0}, updateIPv6TetheringInterfaces()V
...
.method public removeActiveDownstream(Landroid/net/ip/IpServer;)V
    ...
    invoke-static {p1}, stopIPv6TetheringOn(Landroid/net/ip/IpServer;)V
...
.method public updateUpstreamNetworkState(Landroid/net/NetworkState;)V
    ...
    invoke-direct {p0}, stopIPv6TetheringOnAllInterfaces()V

    const/4 v0, 0x0

    invoke-direct {p0, v0}, setUpstreamNetworkState(Landroid/net/NetworkState;)V

    return-void

    :cond_0
    iget-object v0, p0, mUpstreamNetworkState:Landroid/net/NetworkState;

    if-eqz v0, :cond_1

    iget-object v0, p1, Landroid/net/NetworkState;->network:Landroid/net/Network;

    iget-object v1, p0, mUpstreamNetworkState:Landroid/net/NetworkState;
    ...
    :cond_1
    invoke-direct {p0, p1}, setUpstreamNetworkState(Landroid/net/NetworkState;)V
