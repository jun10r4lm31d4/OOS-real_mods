...
.method constructor <init>(Lcom/android/server/connectivity/Tethering;Ljava/lang/String;Landroid/os/Looper;Lcom/android/server/connectivity/tethering/TetheringDependencies;)V
    ...
    iput-object v0, p0, mIPv6TetheringCoordinator:Lcom/android/server/connectivity/tethering/IPv6TetheringCoordinator;
    ...
    iput-object v0, p0, mOffload:Lcom/android/server/connectivity/Tethering$TetherMasterSM$OffloadWrapper;
...
.method static synthetic access$1400(Lcom/android/server/connectivity/Tethering$TetherMasterSM;ILandroid/net/ip/IpServer;)V
    ...
    invoke-direct {p0, p1, p2}, handleInterfaceServingStateActive(ILandroid/net/ip/IpServer;)V
...
.method static synthetic access$1600(Lcom/android/server/connectivity/Tethering$TetherMasterSM;Landroid/net/ip/IpServer;)V
    ...
    invoke-direct {p0, p1}, handleInterfaceServingStateInactive(Landroid/net/ip/IpServer;)V
...
.method static synthetic access$2900(Lcom/android/server/connectivity/Tethering$TetherMasterSM;)Lcom/android/server/connectivity/Tethering$TetherMasterSM$OffloadWrapper;
    ...
    iget-object v0, p0, mOffload:Lcom/android/server/connectivity/Tethering$TetherMasterSM$OffloadWrapper;
...
.method static synthetic access$3100(Lcom/android/server/connectivity/Tethering$TetherMasterSM;ILjava/lang/Object;)V
    ...
    invoke-direct {p0, p1, p2}, handleUpstreamNetworkMonitorCallback(ILjava/lang/Object;)V
...
.method private handleInterfaceServingStateActive(ILandroid/net/ip/IpServer;)V
    ...
    iget-object v0, p0, mIPv6TetheringCoordinator:Lcom/android/server/connectivity/tethering/IPv6TetheringCoordinator;
    ...
    :cond_1
    iget-object v1, p0, mOffload:Lcom/android/server/connectivity/Tethering$TetherMasterSM$OffloadWrapper;
...
.method private handleUpstreamNetworkMonitorCallback(ILjava/lang/Object;)V
    ...
    iget-object v2, p0, this$0:Lcom/android/server/connectivity/Tethering;
    ...
    invoke-virtual {p0, v1}, handleNewUpstreamNetworkState(Landroid/net/NetworkState;)V
    ...
    :cond_4
    invoke-virtual {p0, v0}, handleNewUpstreamNetworkState(Landroid/net/NetworkState;)V
...
.method protected chooseUpstreamType(Z)V
    ...
    invoke-virtual {p0, v2, v3, v4}, sendMessageDelayed(IJ)V

    :cond_2
    :goto_1
    invoke-virtual {p0, v1}, setUpstreamNetwork(Landroid/net/NetworkState;)V
    ...
    :goto_2
    iget-object v3, p0, this$0:Lcom/android/server/connectivity/Tethering;
    ...
    iget-object v4, p0, this$0:Lcom/android/server/connectivity/Tethering;
...
.method protected setDnsForwarders(Landroid/net/Network;Landroid/net/LinkProperties;)V
    ...
    iget-object v3, p0, mSetDnsForwardersErrorState:Lcom/android/internal/util/State;

    invoke-virtual {p0, v3}, transitionTo(Lcom/android/internal/util/IState;)V
...
.method protected setUpstreamNetwork(Landroid/net/NetworkState;)V
    ...
    invoke-virtual {p0, v1, v2}, setDnsForwarders(Landroid/net/Network;Landroid/net/LinkProperties;)V

    :cond_1
    invoke-virtual {p0, v0}, notifyDownstreamsOfNewUpstreamIface(Landroid/net/util/InterfaceSet;)V
    ...
    invoke-virtual {p0, p1}, handleNewUpstreamNetworkState(Landroid/net/NetworkState;)V
...
.method protected turnOffMasterTetherSettings()Z
    ...
    iget-object v2, p0, mSetIpForwardingDisabledErrorState:Lcom/android/internal/util/State;

    invoke-virtual {p0, v2}, transitionTo(Lcom/android/internal/util/IState;)V
    ...
    iget-object v2, p0, mStopTetheringErrorState:Lcom/android/internal/util/State;
...
.method protected turnOnMasterTetherSettings()Z
    ...
    :try_start_2
    iget-object v5, p0, this$0:Lcom/android/server/connectivity/Tethering;
    ...
    iget-object v5, p0, mStartTetheringErrorState:Lcom/android/internal/util/State;

    invoke-virtual {p0, v5}, transitionTo(Lcom/android/internal/util/IState;)V
    ...
    iget-object v2, p0, mSetIpForwardingEnabledErrorState:Lcom/android/internal/util/State;
