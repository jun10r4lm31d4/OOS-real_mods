...
.method static constructor <clinit>()V
    ...
    sput-object v0, LOST_INTERNET:Lcom/android/server/connectivity/NetworkNotificationManager$NotificationType;
    ...
    sput-object v0, NETWORK_SWITCH:Lcom/android/server/connectivity/NetworkNotificationManager$NotificationType;
    ...
    sput-object v0, NO_INTERNET:Lcom/android/server/connectivity/NetworkNotificationManager$NotificationType;
    ...
    sput-object v0, LOGGED_IN:Lcom/android/server/connectivity/NetworkNotificationManager$NotificationType;
    ...
    sput-object v0, PARTIAL_CONNECTIVITY:Lcom/android/server/connectivity/NetworkNotificationManager$NotificationType;
    ...
    sput-object v0, SIGN_IN:Lcom/android/server/connectivity/NetworkNotificationManager$NotificationType;

    const/4 v0, 0x6

    new-array v0, v0, [Lcom/android/server/connectivity/NetworkNotificationManager$NotificationType;

    sget-object v7, LOST_INTERNET:Lcom/android/server/connectivity/NetworkNotificationManager$NotificationType;

    aput-object v7, v0, v1

    sget-object v1, NETWORK_SWITCH:Lcom/android/server/connectivity/NetworkNotificationManager$NotificationType;

    aput-object v1, v0, v2

    sget-object v1, NO_INTERNET:Lcom/android/server/connectivity/NetworkNotificationManager$NotificationType;

    aput-object v1, v0, v3

    sget-object v1, LOGGED_IN:Lcom/android/server/connectivity/NetworkNotificationManager$NotificationType;

    aput-object v1, v0, v4

    sget-object v1, PARTIAL_CONNECTIVITY:Lcom/android/server/connectivity/NetworkNotificationManager$NotificationType;

    aput-object v1, v0, v5

    sget-object v1, SIGN_IN:Lcom/android/server/connectivity/NetworkNotificationManager$NotificationType;

    aput-object v1, v0, v6

    sput-object v0, $VALUES:[Lcom/android/server/connectivity/NetworkNotificationManager$NotificationType;
...
.method public static values()[Lcom/android/server/connectivity/NetworkNotificationManager$NotificationType;
    ...
    sget-object v0, $VALUES:[Lcom/android/server/connectivity/NetworkNotificationManager$NotificationType;
