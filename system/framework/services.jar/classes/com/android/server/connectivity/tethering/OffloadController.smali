...
.method static constructor <clinit>()V
    ...
    sput-object v0, EMPTY_STATS:Lcom/android/server/connectivity/tethering/OffloadHardwareInterface$ForwardedStats;
...
.method public constructor <init>(Landroid/os/Handler;Lcom/android/server/connectivity/tethering/OffloadHardwareInterface;Landroid/content/ContentResolver;Landroid/os/INetworkManagementService;Landroid/net/util/SharedLog;)V
    ...
    iput-object v0, p0, mForwardedStats:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, mInterfaceQuotas:Ljava/util/HashMap;

    iput-object p1, p0, mHandler:Landroid/os/Handler;

    iput-object p2, p0, mHwInterface:Lcom/android/server/connectivity/tethering/OffloadHardwareInterface;

    iput-object p3, p0, mContentResolver:Landroid/content/ContentResolver;

    iput-object p4, p0, mNms:Landroid/os/INetworkManagementService;
    ...
    iput-object v0, p0, mStatsProvider:Landroid/net/ITetheringStatsProvider;
    ...
    iput-object v0, p0, mDownstreams:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, mExemptPrefixes:Ljava/util/Set;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, mLastLocalPrefixStrs:Ljava/util/Set;

    :try_start_0
    iget-object v0, p0, mNms:Landroid/os/INetworkManagementService;

    iget-object v1, p0, mStatsProvider:Landroid/net/ITetheringStatsProvider;
...
.method static synthetic access$1100(Lcom/android/server/connectivity/tethering/OffloadController;)Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v0, p0, mForwardedStats:Ljava/util/concurrent/ConcurrentHashMap;
...
.method static synthetic access$1200(Lcom/android/server/connectivity/tethering/OffloadController;)Ljava/util/HashMap;
    ...
    iget-object v0, p0, mInterfaceQuotas:Ljava/util/HashMap;
...
.method static synthetic access$1300(Lcom/android/server/connectivity/tethering/OffloadController;Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1}, maybeUpdateDataLimit(Ljava/lang/String;)Z
...
.method static synthetic access$300(Lcom/android/server/connectivity/tethering/OffloadController;)V
    ...
    invoke-direct {p0}, updateStatsForAllUpstreams()V
...
.method static synthetic access$400(Lcom/android/server/connectivity/tethering/OffloadController;)V
    ...
    invoke-direct {p0}, forceTetherStatsPoll()V
...
.method static synthetic access$500(Lcom/android/server/connectivity/tethering/OffloadController;Lcom/android/server/connectivity/tethering/OffloadController$UpdateType;)Z
    ...
    invoke-direct {p0, p1}, computeAndPushLocalPrefixes(Lcom/android/server/connectivity/tethering/OffloadController$UpdateType;)Z
...
.method static synthetic access$600(Lcom/android/server/connectivity/tethering/OffloadController;)V
    ...
    invoke-direct {p0}, pushAllDownstreamState()V
...
.method static synthetic access$700(Lcom/android/server/connectivity/tethering/OffloadController;Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1}, pushUpstreamParameters(Ljava/lang/String;)Z
...
.method static synthetic access$800(Lcom/android/server/connectivity/tethering/OffloadController;)V
    ...
    invoke-direct {p0}, updateStatsForCurrentUpstream()V
...
.method static synthetic access$900(Lcom/android/server/connectivity/tethering/OffloadController;ILjava/lang/String;ILjava/lang/String;I)V
    ...
    invoke-direct/range {p0 .. p5}, updateNatTimeout(ILjava/lang/String;ILjava/lang/String;I)V
...
.method private computeAndPushLocalPrefixes(Lcom/android/server/connectivity/tethering/OffloadController$UpdateType;)Z
    ...
    :goto_0
    iget-object v2, p0, mExemptPrefixes:Ljava/util/Set;

    iget-object v3, p0, mUpstreamLinkProperties:Landroid/net/LinkProperties;

    invoke-static {v2, v3}, computeLocalPrefixStrings(Ljava/util/Set;Landroid/net/LinkProperties;)Ljava/util/Set;

    move-result-object v2

    if-nez v0, :cond_1

    iget-object v3, p0, mLastLocalPrefixStrs:Ljava/util/Set;
    ...
    :cond_1
    iput-object v2, p0, mLastLocalPrefixStrs:Ljava/util/Set;

    iget-object v1, p0, mHwInterface:Lcom/android/server/connectivity/tethering/OffloadHardwareInterface;
...
.method private currentUpstreamInterface()Ljava/lang/String;
    ...
    iget-object v0, p0, mUpstreamLinkProperties:Landroid/net/LinkProperties;
...
.method private isOffloadDisabled()Z
    ...
    iget-object v0, p0, mHwInterface:Lcom/android/server/connectivity/tethering/OffloadHardwareInterface;
...
.method private maybeUpdateDataLimit(Ljava/lang/String;)Z
    ...
    invoke-direct {p0}, currentUpstreamInterface()Ljava/lang/String;
...
.method private maybeUpdateStats(Ljava/lang/String;)V
    ...
    iget-object v1, p0, mForwardedStats:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_1
    iget-object v2, p0, mForwardedStats:Ljava/util/concurrent/ConcurrentHashMap;
...
.method private pushAllDownstreamState()V
    ...
    iget-object v0, p0, mDownstreams:Ljava/util/HashMap;
    ...
    invoke-direct {p0, v2, v1}, pushDownstreamState(Landroid/net/LinkProperties;Landroid/net/LinkProperties;)V
...
.method private pushDownstreamState(Landroid/net/LinkProperties;Landroid/net/LinkProperties;)V
    ...
    invoke-static {v4}, shouldIgnoreDownstreamRoute(Landroid/net/RouteInfo;)Z
    ...
    iget-object v5, p0, mHwInterface:Lcom/android/server/connectivity/tethering/OffloadHardwareInterface;
...
.method private pushUpstreamParameters(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1}, maybeUpdateStats(Ljava/lang/String;)V
    ...
    iget-object v5, p0, mUpstreamLinkProperties:Landroid/net/LinkProperties;
    ...
    invoke-direct {p0, v0}, maybeUpdateDataLimit(Ljava/lang/String;)Z
...
.method private started()Z
    ...
    iget-boolean v0, p0, mConfigInitialized:Z

    if-eqz v0, :cond_0

    iget-boolean v0, p0, mControlInitialized:Z
...
.method private updateNatTimeout(ILjava/lang/String;ILjava/lang/String;I)V
    ...
    invoke-static/range {p1 .. p1}, protoNameFor(I)Ljava/lang/String;

    move-result-object v4

    if-nez v4, :cond_0

    iget-object v0, v1, mLog:Landroid/net/util/SharedLog;
    ...
    invoke-static/range {p2 .. p2}, parseIPv4Address(Ljava/lang/String;)Ljava/net/Inet4Address;
    ...
    iget-object v7, v1, mLog:Landroid/net/util/SharedLog;
    ...
    invoke-static/range {p4 .. p4}, parseIPv4Address(Ljava/lang/String;)Ljava/net/Inet4Address;
    ...
    iget v0, v1, mNatUpdateCallbacksReceived:I

    const/16 v16, 0x1

    add-int/lit8 v0, v0, 0x1

    iput v0, v1, mNatUpdateCallbacksReceived:I
    ...
    invoke-static/range {p1 .. p1}, connectionTimeoutUpdateSecondsFor(I)I
    ...
    iget v8, v1, mNatUpdateNetlinkErrors:I

    add-int/lit8 v8, v8, 0x1

    iput v8, v1, mNatUpdateNetlinkErrors:I

    iget-object v8, v1, mLog:Landroid/net/util/SharedLog;
    ...
    iget v10, v1, mNatUpdateCallbacksReceived:I
    ...
    iget v10, v1, mNatUpdateNetlinkErrors:I
...
.method private updateStatsForAllUpstreams()V
    ...
    invoke-direct {p0, v2}, maybeUpdateStats(Ljava/lang/String;)V
...
.method private updateStatsForCurrentUpstream()V
    ...
    invoke-direct {p0, v0}, maybeUpdateStats(Ljava/lang/String;)V
...
.method public dump(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    invoke-direct {p0}, isOffloadDisabled()Z
    ...
    iget-object v1, p0, mUpstreamLinkProperties:Landroid/net/LinkProperties;
    ...
    iget-object v4, p0, mLastLocalPrefixStrs:Ljava/util/Set;
    ...
    iget v7, p0, mNatUpdateCallbacksReceived:I
    ...
    iget v4, p0, mNatUpdateNetlinkErrors:I
...
.method public notifyDownstreamLinkProperties(Landroid/net/LinkProperties;)V
    ...
    iget-object v1, p0, mDownstreams:Ljava/util/HashMap;
    ...
    :cond_1
    invoke-direct {p0, v1, p1}, pushDownstreamState(Landroid/net/LinkProperties;Landroid/net/LinkProperties;)V
...
.method public removeDownstreamInterface(Ljava/lang/String;)V
    ...
    invoke-static {v2}, shouldIgnoreDownstreamRoute(Landroid/net/RouteInfo;)Z
    ...
    :cond_2
    iget-object v3, p0, mHwInterface:Lcom/android/server/connectivity/tethering/OffloadHardwareInterface;
...
.method public setLocalPrefixes(Ljava/util/Set;)V
    ...
    iput-object p1, p0, mExemptPrefixes:Ljava/util/Set;
    ...
    invoke-direct {p0, v0}, computeAndPushLocalPrefixes(Lcom/android/server/connectivity/tethering/OffloadController$UpdateType;)Z
...
.method public setUpstreamLinkProperties(Landroid/net/LinkProperties;)V
    ...
    :goto_0
    iput-object v1, p0, mUpstreamLinkProperties:Landroid/net/LinkProperties;
    ...
    sget-object v3, EMPTY_STATS:Lcom/android/server/connectivity/tethering/OffloadHardwareInterface$ForwardedStats;
    ...
    invoke-direct {p0, v2}, computeAndPushLocalPrefixes(Lcom/android/server/connectivity/tethering/OffloadController$UpdateType;)Z

    invoke-direct {p0, v0}, pushUpstreamParameters(Ljava/lang/String;)Z
...
.method public start()Z
    ...
    iput-boolean v0, p0, mConfigInitialized:Z
    ...
    iput-boolean v0, p0, mControlInitialized:Z
    ...
    iput v1, p0, mNatUpdateCallbacksReceived:I

    iput v1, p0, mNatUpdateNetlinkErrors:I
...
.method public stop()V
    ...
    iput-boolean v1, p0, mControlInitialized:Z

    iput-boolean v1, p0, mConfigInitialized:Z
