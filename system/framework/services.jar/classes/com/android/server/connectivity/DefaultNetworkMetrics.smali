...
.method public constructor <init>()V
    ...
    iput-wide v0, p0, creationTimeMs:J
    ...
    iput-object v0, p0, mEventsLog:Lcom/android/internal/util/RingBuffer;

    iget-wide v0, p0, creationTimeMs:J

    const/4 v2, 0x0

    invoke-direct {p0, v0, v1, v2}, newDefaultNetwork(JLcom/android/server/connectivity/NetworkAgentInfo;)V
...
.method private logCurrentDefaultNetwork(JLcom/android/server/connectivity/NetworkAgentInfo;)V
    ...
    iget-boolean v0, p0, mIsCurrentlyValid:Z

    if-eqz v0, :cond_0

    invoke-direct {p0, p1, p2}, updateValidationTime(J)V

    :cond_0
    iget-object v0, p0, mCurrentDefaultNetwork:Landroid/net/metrics/DefaultNetworkEvent;

    invoke-virtual {v0, p1, p2}, Landroid/net/metrics/DefaultNetworkEvent;->updateDuration(J)V

    iget v1, p0, mLastTransports:I

    iput v1, v0, Landroid/net/metrics/DefaultNetworkEvent;->previousTransports:I

    if-eqz p3, :cond_1

    invoke-static {v0, p3}, fillLinkInfo(Landroid/net/metrics/DefaultNetworkEvent;Lcom/android/server/connectivity/NetworkAgentInfo;)V
    ...
    iget-object v1, p0, mEventsLog:Lcom/android/internal/util/RingBuffer;
...
.method private newDefaultNetwork(JLcom/android/server/connectivity/NetworkAgentInfo;)V
    ...
    iput-boolean v1, p0, mIsCurrentlyValid:Z

    iput-wide p1, p0, mLastValidationTimeMs:J
    ...
    :cond_1
    :goto_0
    iput-object v0, p0, mCurrentDefaultNetwork:Landroid/net/metrics/DefaultNetworkEvent;
...
.method private updateValidationTime(J)V
    ...
    iget-wide v3, p0, mLastValidationTimeMs:J
...
.method public declared-synchronized listEvents(Ljava/io/PrintWriter;)V
    ...
    iget-object v4, p0, mEventsLog:Lcom/android/internal/util/RingBuffer;
    ...
    invoke-static {v0, v1, p1, v7}, printEvent(JLjava/io/PrintWriter;Landroid/net/metrics/DefaultNetworkEvent;)V
    ...
    :cond_0
    iget-object v4, p0, mCurrentDefaultNetwork:Landroid/net/metrics/DefaultNetworkEvent;

    invoke-virtual {v4, v2, v3}, Landroid/net/metrics/DefaultNetworkEvent;->updateDuration(J)V

    iget-boolean v4, p0, mIsCurrentlyValid:Z

    if-eqz v4, :cond_1

    invoke-direct {p0, v2, v3}, updateValidationTime(J)V

    iput-wide v2, p0, mLastValidationTimeMs:J

    :cond_1
    iget-object v4, p0, mCurrentDefaultNetwork:Landroid/net/metrics/DefaultNetworkEvent;

    invoke-static {v0, v1, p1, v4}, printEvent(JLjava/io/PrintWriter;Landroid/net/metrics/DefaultNetworkEvent;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized listEventsAsProto(Ljava/io/PrintWriter;)V
    ...
    :try_start_0
    iget-object v0, p0, mEventsLog:Lcom/android/internal/util/RingBuffer;
...
.method public declared-synchronized logDefaultNetworkEvent(JLcom/android/server/connectivity/NetworkAgentInfo;Lcom/android/server/connectivity/NetworkAgentInfo;)V
    ...
    :try_start_0
    invoke-direct {p0, p1, p2, p4}, logCurrentDefaultNetwork(JLcom/android/server/connectivity/NetworkAgentInfo;)V

    invoke-direct {p0, p1, p2, p3}, newDefaultNetwork(JLcom/android/server/connectivity/NetworkAgentInfo;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized logDefaultNetworkValidity(JZ)V
    ...
    iput-boolean v0, p0, mIsCurrentlyValid:Z
