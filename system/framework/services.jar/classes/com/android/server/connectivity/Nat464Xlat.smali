...
.method static constructor <clinit>()V
    ...
    sput-object v0, NETWORK_TYPES:[I
    ...
    sput-object v0, NETWORK_STATES:[Landroid/net/NetworkInfo$State;
...
.method public constructor <init>(Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/INetd;Landroid/net/IDnsResolver;Landroid/os/INetworkManagementService;)V
    ...
    iput-object v0, p0, mState:Lcom/android/server/connectivity/Nat464Xlat$State;

    iput-object p3, p0, mDnsResolver:Landroid/net/IDnsResolver;

    iput-object p2, p0, mNetd:Landroid/net/INetd;

    iput-object p4, p0, mNMService:Landroid/os/INetworkManagementService;

    iput-object p1, p0, mNetwork:Lcom/android/server/connectivity/NetworkAgentInfo;
...
.method private enterStartingState(Ljava/lang/String;)V
    ...
    iget-object v2, p0, mNat64Prefix:Landroid/net/IpPrefix;
    ...
    iput-object p1, p0, mBaseIface:Ljava/lang/String;
    ...
    iput-object v1, p0, mState:Lcom/android/server/connectivity/Nat464Xlat$State;
    ...
    iput-object v1, p0, mIPv6Address:Ljava/net/Inet6Address;
    :try_end_2
...
.method private handleInterfaceLinkStateChanged(Ljava/lang/String;Z)V
    ...
    invoke-virtual {p0}, isStarting()Z
    ...
    invoke-direct {p0}, enterRunningState()V
...
.method private leaveStartedState()V
    ...
    iget-object v0, p0, mNetwork:Lcom/android/server/connectivity/NetworkAgentInfo;

    invoke-static {v0}, requiresClat(Lcom/android/server/connectivity/NetworkAgentInfo;)Z
    ...
    :cond_0
    invoke-direct {p0}, stopPrefixDiscovery()V
...
.method protected static requiresClat(Lcom/android/server/connectivity/NetworkAgentInfo;)Z
    ...
    sget-object v1, NETWORK_TYPES:[I
    ...
    sget-object v2, NETWORK_STATES:[Landroid/net/NetworkInfo$State;
...
.method protected static shouldStartClat(Lcom/android/server/connectivity/NetworkAgentInfo;)Z
    ...
    invoke-static {p0}, requiresClat(Lcom/android/server/connectivity/NetworkAgentInfo;)Z
...
.method public fixupLinkProperties(Landroid/net/LinkProperties;Landroid/net/LinkProperties;)V
    ...
    iget-object v0, p0, mNat64Prefix:Landroid/net/IpPrefix;
...
.method public isPrefixDiscoveryStarted()Z
    ...
    iget-object v0, p0, mState:Lcom/android/server/connectivity/Nat464Xlat$State;
...
.method public synthetic lambda$interfaceLinkStateChanged$0$Nat464Xlat(Ljava/lang/String;Z)V
    ...
    invoke-direct {p0, p1, p2}, handleInterfaceLinkStateChanged(Ljava/lang/String;Z)V
...
.method public synthetic lambda$interfaceRemoved$1$Nat464Xlat(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, handleInterfaceRemoved(Ljava/lang/String;)V
...
.method public setNat64Prefix(Landroid/net/IpPrefix;)V
    ...
    iput-object p1, p0, mNat64Prefix:Landroid/net/IpPrefix;
...
.method protected start()V
    ...
    invoke-direct {p0, v0}, enterStartingState(Ljava/lang/String;)V
...
.method protected stop()V
    ...
    invoke-direct {p0}, leaveStartedState()V
    ...
    iget-object v4, p0, mNetwork:Lcom/android/server/connectivity/NetworkAgentInfo;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, mState:Lcom/android/server/connectivity/Nat464Xlat$State;
...
.method public update()V
    ...
    invoke-virtual {p0}, isPrefixDiscoveryStarted()Z

    move-result v0

    if-nez v0, :cond_0

    invoke-direct {p0}, startPrefixDiscovery()V
    ...
    invoke-static {v0}, shouldStartClat(Lcom/android/server/connectivity/NetworkAgentInfo;)Z
