...
.method static constructor <clinit>()V
    ...
    sput-object v0, ALLOWED_CALLBACK_TYPES:[I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, v0}, <init>(Landroid/net/ConnectivityManager;)V
...
.method public constructor <init>(Landroid/net/ConnectivityManager;)V
    ...
    iput-object v0, p0, mNetworkMetrics:Landroid/util/SparseArray;
    ...
    iput-object v0, p0, mNetworkMetricsSnapshots:Lcom/android/internal/util/RingBuffer;

    const-wide/16 v0, 0x0

    iput-wide v0, p0, mLastSnapshot:J

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, mWakeupStats:Landroid/util/ArrayMap;
    ...
    iput-object v0, p0, mWakeupEvents:Lcom/android/internal/util/RingBuffer;
    ...
    iput-object v0, p0, mConnectTb:Lcom/android/internal/util/TokenBucket;

    sget-object v0, ALLOWED_CALLBACK_TYPES:[I

    array-length v0, v0

    new-array v0, v0, [Landroid/net/INetdEventCallback;

    iput-object v0, p0, mNetdEventCallbackList:[Landroid/net/INetdEventCallback;
...
.method private addWakeupEvent(Landroid/net/metrics/WakeupEvent;)V
    ...
    iget-object v1, p0, mWakeupEvents:Lcom/android/internal/util/RingBuffer;

    invoke-virtual {v1, p1}, Lcom/android/internal/util/RingBuffer;->append(Ljava/lang/Object;)V

    iget-object v1, p0, mWakeupStats:Landroid/util/ArrayMap;
    ...
    iget-object v2, p0, mWakeupStats:Landroid/util/ArrayMap;
...
.method private collectPendingMetricsSnapshot(J)V
    ...
    iget-wide v0, p0, mLastSnapshot:J
    ...
    :cond_0
    invoke-static {p1, p2}, projectSnapshotTime(J)J
    ...
    iget-object v2, p0, mNetworkMetrics:Landroid/util/SparseArray;
    ...
    :cond_1
    iget-object v1, p0, mNetworkMetricsSnapshots:Lcom/android/internal/util/RingBuffer;
...
.method private getMetricsForNetwork(JI)Landroid/net/metrics/NetworkMetrics;
    ...
    invoke-direct {p0, p1, p2}, collectPendingMetricsSnapshot(J)V

    iget-object v0, p0, mNetworkMetrics:Landroid/util/SparseArray;
    ...
    invoke-direct {p0, p3}, getTransports(I)J

    move-result-wide v2

    iget-object v4, p0, mConnectTb:Lcom/android/internal/util/TokenBucket;

    invoke-direct {v1, p3, v2, v3, v4}, Landroid/net/metrics/NetworkMetrics;-><init>(IJLcom/android/internal/util/TokenBucket;)V

    move-object v0, v1

    iget-object v1, p0, mNetworkMetrics:Landroid/util/SparseArray;
...
.method private getNetworkMetricsSnapshots()[Lcom/android/server/connectivity/NetdEventListenerService$NetworkMetricsSnapshot;
    ...
    invoke-direct {p0, v0, v1}, collectPendingMetricsSnapshot(J)V

    iget-object v0, p0, mNetworkMetricsSnapshots:Lcom/android/internal/util/RingBuffer;
...
.method private static isValidCallerType(I)Z
    ...
    :goto_0
    sget-object v1, ALLOWED_CALLBACK_TYPES:[I
...
.method public declared-synchronized addNetdEventCallback(ILandroid/net/INetdEventCallback;)Z
    ...
    :try_start_0
    invoke-static {p1}, isValidCallerType(I)Z
    ...
    :cond_0
    :try_start_1
    iget-object v0, p0, mNetdEventCallbackList:[Landroid/net/INetdEventCallback;
...
.method public declared-synchronized flushStatistics(Ljava/util/List;)V
    ...
    iget-object v0, p0, mWakeupStats:Landroid/util/ArrayMap;
...
.method public declared-synchronized list(Ljava/io/PrintWriter;)V
    ...
    invoke-direct {p0}, getNetworkMetricsSnapshots()[Lcom/android/server/connectivity/NetdEventListenerService$NetworkMetricsSnapshot;
...
.method public declared-synchronized onConnectEvent(IIILjava/lang/String;II)V
    ...
    invoke-direct {v1, v2, v3, v0}, getMetricsForNetwork(JI)Landroid/net/metrics/NetworkMetrics;
    ...
    iget-object v13, v1, mNetdEventCallbackList:[Landroid/net/INetdEventCallback;
...
.method public declared-synchronized onDnsEvent(IIIILjava/lang/String;[Ljava/lang/String;II)V
    ...
    iget-object v11, v1, mNetdEventCallbackList:[Landroid/net/INetdEventCallback;
...
.method public declared-synchronized onTcpSocketStatsEvent([I[I[I[I[I)V
    ...
    invoke-direct {p0, v0, v1, v3}, getMetricsForNetwork(JI)Landroid/net/metrics/NetworkMetrics;
...
.method public declared-synchronized onWakeupEvent(Ljava/lang/String;III[BLjava/lang/String;Ljava/lang/String;IIJ)V
    ...
    invoke-direct {v1, v2}, addWakeupEvent(Landroid/net/metrics/WakeupEvent;)V
