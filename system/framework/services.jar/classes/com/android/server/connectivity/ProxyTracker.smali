...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;I)V
    ...
    iput-object v0, p0, mDefaultProxy:Landroid/net/ProxyInfo;

    const/4 v0, 0x1

    iput-boolean v0, p0, mDefaultProxyEnabled:Z
    ...
    iput-object v0, p0, mPacManager:Lcom/android/server/connectivity/PacManager;
...
.method public static proxyInfoEqual(Landroid/net/ProxyInfo;Landroid/net/ProxyInfo;)Z
    ...
    invoke-static {p0}, canonicalizeProxyInfo(Landroid/net/ProxyInfo;)Landroid/net/ProxyInfo;

    move-result-object v0

    invoke-static {p1}, canonicalizeProxyInfo(Landroid/net/ProxyInfo;)Landroid/net/ProxyInfo;
...
.method public getDefaultProxy()Landroid/net/ProxyInfo;
    ...
    :cond_0
    iget-boolean v1, p0, mDefaultProxyEnabled:Z
...
.method public loadDeprecatedGlobalHttpProxy()V
    ...
    invoke-virtual {p0, v4}, setGlobalProxy(Landroid/net/ProxyInfo;)V
...
.method public loadGlobalProxy()V
    ...
    :cond_2
    iget-object v6, p0, mProxyLock:Ljava/lang/Object;

    monitor-enter v6

    :try_start_0
    iput-object v5, p0, mGlobalProxy:Landroid/net/ProxyInfo;
    ...
    :cond_3
    invoke-virtual {p0}, loadDeprecatedGlobalHttpProxy()V
...
.method public sendProxyBroadcast()V
    ...
    invoke-virtual {p0}, getDefaultProxy()Landroid/net/ProxyInfo;
    ...
    :goto_0
    iget-object v2, p0, mPacManager:Lcom/android/server/connectivity/PacManager;
...
.method public setDefaultProxy(Landroid/net/ProxyInfo;)V
    ...
    invoke-virtual {p0}, sendProxyBroadcast()V
...
.method public setGlobalProxy(Landroid/net/ProxyInfo;)V
    ...
    iput-object v1, p0, mGlobalProxy:Landroid/net/ProxyInfo;
