...
.method static constructor <clinit>()V
    ...
    sput-object v0, READ_BUFFER_SIZE:Ljava/util/function/ToIntFunction;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    sget-object v0, READ_BUFFER_SIZE:Ljava/util/function/ToIntFunction;

    invoke-direct {p0, p1, v0}, <init>(Landroid/content/Context;Ljava/util/function/ToIntFunction;)V
...
.method public constructor <init>(Landroid/content/Context;Ljava/util/function/ToIntFunction;)V
    ...
    iput-object v0, p0, impl:Lcom/android/server/connectivity/IpConnectivityMetrics$Impl;
    ...
    iput-object v0, p0, mEventLog:Lcom/android/internal/util/RingBuffer;

    nop

    invoke-static {}, makeRateLimitingBuckets()Landroid/util/ArrayMap;

    move-result-object v0

    iput-object v0, p0, mBuckets:Landroid/util/ArrayMap;
    ...
    iput-object v0, p0, mDefaultNetworkMetrics:Lcom/android/server/connectivity/DefaultNetworkMetrics;

    iput-object p2, p0, mCapacityGetter:Ljava/util/function/ToIntFunction;
...
.method static synthetic access$100(Lcom/android/server/connectivity/IpConnectivityMetrics;Landroid/net/ConnectivityMetricsEvent;)I
    ...
    invoke-direct {p0, p1}, append(Landroid/net/ConnectivityMetricsEvent;)I
...
.method static synthetic access$200(Lcom/android/server/connectivity/IpConnectivityMetrics;Ljava/io/PrintWriter;)V
    ...
    invoke-direct {p0, p1}, cmdFlush(Ljava/io/PrintWriter;)V
...
.method static synthetic access$300(Lcom/android/server/connectivity/IpConnectivityMetrics;Ljava/io/PrintWriter;)V
    ...
    invoke-direct {p0, p1}, cmdListAsProto(Ljava/io/PrintWriter;)V
...
.method static synthetic access$400(Lcom/android/server/connectivity/IpConnectivityMetrics;Ljava/io/PrintWriter;)V
    ...
    invoke-direct {p0, p1}, cmdList(Ljava/io/PrintWriter;)V
...
.method private append(Landroid/net/ConnectivityMetricsEvent;)I
    ...
    :try_start_0
    iget-object v1, p0, mEventLog:Lcom/android/internal/util/RingBuffer;
    ...
    :cond_0
    invoke-direct {p0, p1}, isRateLimited(Landroid/net/ConnectivityMetricsEvent;)Z
    ...
    iget v2, p0, mDropped:I

    add-int/lit8 v2, v2, 0x1

    iput v2, p0, mDropped:I
...
.method private cmdFlush(Ljava/io/PrintWriter;)V
    ...
    invoke-direct {p0}, flushEncodedOutput()Ljava/lang/String;
...
.method private cmdList(Ljava/io/PrintWriter;)V
    ...
    invoke-direct {p0}, getEvents()Ljava/util/List;
    ...
    iget-object v2, p0, mNetdListener:Lcom/android/server/connectivity/NetdEventListenerService;
    ...
    iget-object v1, p0, mDefaultNetworkMetrics:Lcom/android/server/connectivity/DefaultNetworkMetrics;
...
.method private cmdListAsProto(Ljava/io/PrintWriter;)V
    ...
    :cond_0
    iget-object v1, p0, mNetdListener:Lcom/android/server/connectivity/NetdEventListenerService;
...
.method private flushEncodedOutput()Ljava/lang/String;
    ...
    iget-object v3, p0, mDefaultNetworkMetrics:Lcom/android/server/connectivity/DefaultNetworkMetrics;

    invoke-virtual {v3, v0}, Lcom/android/server/connectivity/DefaultNetworkMetrics;->flushEvents(Ljava/util/List;)V

    iget-object v3, p0, mNetdListener:Lcom/android/server/connectivity/NetdEventListenerService;
...
.method private initBuffer()V
    ...
    :try_start_0
    iput v1, p0, mDropped:I

    invoke-virtual {p0}, bufferCapacity()I

    move-result v1

    iput v1, p0, mCapacity:I

    new-instance v1, Ljava/util/ArrayList;

    iget v2, p0, mCapacity:I

    invoke-direct {v1, v2}, Ljava/util/ArrayList;-><init>(I)V

    iput-object v1, p0, mBuffer:Ljava/util/ArrayList;
...
.method private isRateLimited(Landroid/net/ConnectivityMetricsEvent;)Z
    ...
    iget-object v0, p0, mBuckets:Landroid/util/ArrayMap;
...
.method public bufferCapacity()I
    ...
    iget-object v0, p0, mCapacityGetter:Ljava/util/function/ToIntFunction;
...
.method public onBootPhase(I)V
    ...
    iput-object v0, p0, mNetdListener:Lcom/android/server/connectivity/NetdEventListenerService;

    iget-object v0, p0, impl:Lcom/android/server/connectivity/IpConnectivityMetrics$Impl;

    const-string v1, "connmetrics"

    invoke-virtual {p0, v1, v0}, publishBinderService(Ljava/lang/String;Landroid/os/IBinder;)V

    iget-object v0, p0, mNetdListener:Lcom/android/server/connectivity/NetdEventListenerService;
