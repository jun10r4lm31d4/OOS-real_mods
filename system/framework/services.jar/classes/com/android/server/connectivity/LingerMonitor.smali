...
.method static constructor <clinit>()V
    ...
    invoke-static {}, makeTransportToNameMap()Ljava/util/HashMap;

    move-result-object v0

    sput-object v0, TRANSPORT_NAMES:Ljava/util/HashMap;
    ...
    sput-object v0, CELLULAR_SETTINGS:Landroid/content/Intent;
    ...
    sput-object v0, sNotifyTypeNames:Landroid/util/SparseArray;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/connectivity/NetworkNotificationManager;IJ)V
    ...
    iput-object v0, p0, mNotifications:Landroid/util/SparseIntArray;

    new-instance v0, Landroid/util/SparseBooleanArray;

    invoke-direct {v0}, Landroid/util/SparseBooleanArray;-><init>()V

    iput-object v0, p0, mEverNotified:Landroid/util/SparseBooleanArray;

    iput-object p1, p0, mContext:Landroid/content/Context;

    iput-object p2, p0, mNotifier:Lcom/android/server/connectivity/NetworkNotificationManager;

    iput p3, p0, mDailyLimit:I

    iput-wide p4, p0, mRateLimitMillis:J

    neg-long v0, p4

    iput-wide v0, p0, mLastNotificationMillis:J
...
.method private everNotified(Lcom/android/server/connectivity/NetworkAgentInfo;)Z
    ...
    iget-object v0, p0, mEverNotified:Landroid/util/SparseBooleanArray;
...
.method private getNotificationSource(Lcom/android/server/connectivity/NetworkAgentInfo;)I
    ...
    :goto_0
    iget-object v1, p0, mNotifications:Landroid/util/SparseIntArray;
...
.method private isAboveDailyLimit(J)Z
    ...
    iget-wide v0, p0, mFirstNotificationMillis:J
    ...
    iput-wide p1, p0, mFirstNotificationMillis:J
    ...
    iput v5, p0, mNotificationCounter:I

    iput-wide v2, p0, mFirstNotificationMillis:J

    :cond_1
    iget v2, p0, mNotificationCounter:I

    iget v3, p0, mDailyLimit:I
    ...
    iput v2, p0, mNotificationCounter:I
...
.method private isRateLimited(J)Z
    ...
    iget-wide v0, p0, mLastNotificationMillis:J

    sub-long v0, p1, v0

    iget-wide v2, p0, mRateLimitMillis:J
    ...
    :cond_0
    iput-wide p1, p0, mLastNotificationMillis:J
...
.method private maybeStopNotifying(Lcom/android/server/connectivity/NetworkAgentInfo;)V
    ...
    invoke-direct {p0, p1}, getNotificationSource(Lcom/android/server/connectivity/NetworkAgentInfo;)I
...
.method private notify(Lcom/android/server/connectivity/NetworkAgentInfo;Lcom/android/server/connectivity/NetworkAgentInfo;Z)V
    ...
    :cond_2
    invoke-direct {p0, p1, p2}, showNotification(Lcom/android/server/connectivity/NetworkAgentInfo;Lcom/android/server/connectivity/NetworkAgentInfo;)V
    ...
    sget-object v4, sNotifyTypeNames:Landroid/util/SparseArray;
    ...
    iget-object v2, p0, mNotifications:Landroid/util/SparseIntArray;
    ...
    iget-object v2, p0, mEverNotified:Landroid/util/SparseBooleanArray;
...
.method private showNotification(Lcom/android/server/connectivity/NetworkAgentInfo;Lcom/android/server/connectivity/NetworkAgentInfo;)V
    ...
    invoke-virtual {p0}, createNotificationIntent()Landroid/app/PendingIntent;
...
.method protected createNotificationIntent()Landroid/app/PendingIntent;
    ...
    sget-object v2, CELLULAR_SETTINGS:Landroid/content/Intent;
...
.method public isNotificationEnabled(Lcom/android/server/connectivity/NetworkAgentInfo;Lcom/android/server/connectivity/NetworkAgentInfo;)Z
    ...
    :cond_1
    sget-object v5, TRANSPORT_NAMES:Ljava/util/HashMap;
    ...
    sget-object v7, TRANSPORT_NAMES:Ljava/util/HashMap;
    ...
    invoke-static {p1, v5}, hasTransport(Lcom/android/server/connectivity/NetworkAgentInfo;I)Z

    move-result v9

    if-eqz v9, :cond_2

    invoke-static {p2, v7}, hasTransport(Lcom/android/server/connectivity/NetworkAgentInfo;I)Z
...
.method public noteDisconnect(Lcom/android/server/connectivity/NetworkAgentInfo;)V
    ...
    iget-object v0, p0, mNotifications:Landroid/util/SparseIntArray;
    ...
    invoke-direct {p0, p1}, maybeStopNotifying(Lcom/android/server/connectivity/NetworkAgentInfo;)V
...
.method public noteLingerDefaultNetwork(Lcom/android/server/connectivity/NetworkAgentInfo;Lcom/android/server/connectivity/NetworkAgentInfo;)V
    ...
    invoke-direct {p0, p1}, everNotified(Lcom/android/server/connectivity/NetworkAgentInfo;)Z
    ...
    :cond_2
    invoke-virtual {p0, p1, p2}, isNotificationEnabled(Lcom/android/server/connectivity/NetworkAgentInfo;Lcom/android/server/connectivity/NetworkAgentInfo;)Z
    ...
    invoke-direct {p0, v1, v2}, isRateLimited(J)Z

    move-result v3

    if-nez v3, :cond_5

    invoke-direct {p0, v1, v2}, isAboveDailyLimit(J)Z
    ...
    :cond_4
    invoke-direct {p0, p1, p2, v0}, notify(Lcom/android/server/connectivity/NetworkAgentInfo;Lcom/android/server/connectivity/NetworkAgentInfo;Z)V
