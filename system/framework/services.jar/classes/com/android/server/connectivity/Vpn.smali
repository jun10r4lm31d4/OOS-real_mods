...
.method static constructor <clinit>()V
    ...
    sput-wide v3, MOST_IPV4_ADDRESSES_COUNT:J
    ...
    sput-object v4, MOST_IPV6_ADDRESSES_COUNT:Ljava/math/BigInteger;
...
.method public constructor <init>(Landroid/os/Looper;Landroid/content/Context;Landroid/os/INetworkManagementService;I)V
    ...
    invoke-direct/range {v0 .. v5}, <init>(Landroid/os/Looper;Landroid/content/Context;Landroid/os/INetworkManagementService;ILcom/android/server/connectivity/Vpn$SystemServices;)V
...
.method protected constructor <init>(Landroid/os/Looper;Landroid/content/Context;Landroid/os/INetworkManagementService;ILcom/android/server/connectivity/Vpn$SystemServices;)V
    ...
    iput-boolean v0, p0, mEnableTeardown:Z

    const/4 v0, 0x0

    iput-boolean v0, p0, mAlwaysOn:Z

    iput-boolean v0, p0, mLockdown:Z

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object v1

    iput-object v1, p0, mLockdownWhitelist:Ljava/util/List;

    new-instance v1, Landroid/util/ArraySet;

    invoke-direct {v1}, Landroid/util/ArraySet;-><init>()V

    iput-object v1, p0, mBlockedUsers:Ljava/util/Set;
    ...
    iput-object v1, p0, mObserver:Landroid/net/INetworkManagementEventObserver;
    ...
    iput-object p5, p0, mSystemServices:Lcom/android/server/connectivity/Vpn$SystemServices;

    const-string v1, "[Legacy VPN]"

    iput-object v1, p0, mPackage:Ljava/lang/String;

    iget-object v1, p0, mPackage:Ljava/lang/String;

    iget v2, p0, mUserHandle:I

    invoke-direct {p0, v1, v2}, getAppUid(Ljava/lang/String;I)I

    move-result v1

    iput v1, p0, mOwnerUID:I

    iget-object v1, p0, mPackage:Ljava/lang/String;

    invoke-direct {p0, v1}, doesPackageTargetAtLeastQ(Ljava/lang/String;)Z

    move-result v1

    iput-boolean v1, p0, mIsPackageTargetingAtLeastQ:Z

    :try_start_0
    iget-object v1, p0, mObserver:Landroid/net/INetworkManagementEventObserver;
    ...
    iput-object v1, p0, mNetworkInfo:Landroid/net/NetworkInfo;
    ...
    invoke-virtual {p0, v0}, updateCapabilities(Landroid/net/Network;)Landroid/net/NetworkCapabilities;

    invoke-direct {p0}, loadAlwaysOnPackage()V
...
.method static synthetic access$1300(Lcom/android/server/connectivity/Vpn;)V
    ...
    invoke-direct {p0}, prepareStatusIntent()V
...
.method private agentConnect()V
    ...
    invoke-direct/range {p0 .. p0}, makeLinkProperties()Landroid/net/LinkProperties;

    move-result-object v13

    iget-object v0, v12, mNetworkCapabilities:Landroid/net/NetworkCapabilities;

    const/16 v1, 0xc

    invoke-virtual {v0, v1}, Landroid/net/NetworkCapabilities;->addCapability(I)Landroid/net/NetworkCapabilities;

    iget-object v0, v12, mNetworkInfo:Landroid/net/NetworkInfo;
    ...
    iget-object v0, v12, mConfig:Lcom/android/internal/net/VpnConfig;
    ...
    iget-boolean v0, v12, mLockdown:Z
    ...
    iget v1, v12, mUserHandle:I

    iget-object v2, v12, mConfig:Lcom/android/internal/net/VpnConfig;

    iget-object v2, v2, Lcom/android/internal/net/VpnConfig;->allowedApplications:Ljava/util/List;

    iget-object v3, v12, mConfig:Lcom/android/internal/net/VpnConfig;

    iget-object v3, v3, Lcom/android/internal/net/VpnConfig;->disallowedApplications:Ljava/util/List;

    invoke-virtual {v12, v1, v2, v3}, createUserAndRestrictedProfilesRanges(ILjava/util/List;Ljava/util/List;)Ljava/util/Set;
    ...
    iget-object v3, v12, mLooper:Landroid/os/Looper;

    iget-object v4, v12, mContext:Landroid/content/Context;

    const-string v5, "VPN"

    iget-object v6, v12, mNetworkInfo:Landroid/net/NetworkInfo;

    iget-object v7, v12, mNetworkCapabilities:Landroid/net/NetworkCapabilities;
    ...
    iput-object v0, v12, mNetworkAgent:Landroid/net/NetworkAgent;
    :try_end_0
    ...
    invoke-virtual {v12, v0, v1}, updateState(Landroid/net/NetworkInfo$DetailedState;Ljava/lang/String;)V
...
.method private agentDisconnect()V
    ...
    invoke-virtual {p0, v0, v1}, updateState(Landroid/net/NetworkInfo$DetailedState;Ljava/lang/String;)V
...
.method private getAppsUids(Ljava/util/List;I)Ljava/util/SortedSet;
    ...
    invoke-direct {p0, v2, p2}, getAppUid(Ljava/lang/String;I)I
...
.method private isCurrentPreparedPackage(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1, v0}, getAppUid(Ljava/lang/String;I)I
...
.method private loadAlwaysOnPackage()V
    ...
    :try_start_0
    iget-object v2, p0, mSystemServices:Lcom/android/server/connectivity/Vpn$SystemServices;
    ...
    iget-object v3, p0, mSystemServices:Lcom/android/server/connectivity/Vpn$SystemServices;
    ...
    iget-object v4, p0, mSystemServices:Lcom/android/server/connectivity/Vpn$SystemServices;
    ...
    :goto_0
    invoke-direct {p0, v2, v3, v5}, setAlwaysOnPackageInternal(Ljava/lang/String;ZLjava/util/List;)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private makeLinkProperties()Landroid/net/LinkProperties;
    ...
    iget-object v3, p0, mInterface:Ljava/lang/String;
    ...
    iget-object v4, p0, mConfig:Lcom/android/internal/net/VpnConfig;
...
.method private prepareInternal(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v4}, jniReset(Ljava/lang/String;)V

    iput-object v5, p0, mInterface:Ljava/lang/String;

    iget-object v4, p0, mNetworkCapabilities:Landroid/net/NetworkCapabilities;

    invoke-virtual {v4, v5}, Landroid/net/NetworkCapabilities;->setUids(Ljava/util/Set;)Landroid/net/NetworkCapabilities;

    :cond_0
    iget-object v4, p0, mConnection:Lcom/android/server/connectivity/Vpn$Connection;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_1
    iget-object v4, p0, mLegacyVpnRunner:Lcom/android/server/connectivity/Vpn$LegacyVpnRunner;
    ...
    invoke-direct {p0, p1, v4}, getAppUid(Ljava/lang/String;I)I

    move-result v4

    iput v4, p0, mOwnerUID:I

    invoke-direct {p0, p1}, doesPackageTargetAtLeastQ(Ljava/lang/String;)Z

    move-result v4

    iput-boolean v4, p0, mIsPackageTargetingAtLeastQ:Z
    :try_end_4
    ...
    iget-boolean v0, p0, mLockdown:Z

    invoke-direct {p0, v0}, setVpnForcedLocked(Z)V
    :try_end_6
...
.method static providesRoutesToMostDestinations(Landroid/net/LinkProperties;)Z
    ...
    sget-wide v7, MOST_IPV4_ADDRESSES_COUNT:J
    ...
    sget-object v6, MOST_IPV6_ADDRESSES_COUNT:Ljava/math/BigInteger;
...
.method private saveAlwaysOnPackage()V
    ...
    invoke-virtual {p0}, getAlwaysOnPackage()Ljava/lang/String;
    ...
    iget-boolean v4, p0, mAlwaysOn:Z

    if-eqz v4, :cond_0

    iget-boolean v4, p0, mLockdown:Z
    ...
    iget-object v5, p0, mLockdownWhitelist:Ljava/util/List;
...
.method private setAllowOnlyVpnForUids(ZLjava/util/Collection;)Z
    ...
    iget-object v2, p0, mBlockedUsers:Ljava/util/Set;
...
.method private setAlwaysOnPackageInternal(Ljava/lang/String;ZLjava/util/List;)Z
    ...
    invoke-virtual {p0, p1, v0}, setPackageAuthorization(Ljava/lang/String;Z)Z
    ...
    iput-boolean v2, p0, mAlwaysOn:Z

    :goto_1
    iget-boolean v1, p0, mAlwaysOn:Z
    ...
    :cond_5
    iput-boolean v2, p0, mLockdown:Z

    iget-boolean v1, p0, mLockdown:Z
    ...
    invoke-direct {p0, p1}, isCurrentPreparedPackage(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v1}, updateAlwaysOnNotification(Landroid/net/NetworkInfo$DetailedState;)V

    iget-boolean v1, p0, mLockdown:Z

    invoke-direct {p0, v1}, setVpnForcedLocked(Z)V
...
.method private setVpnForcedLocked(Z)V
    ...
    invoke-static {v0}, isNullOrLegacyVpn(Ljava/lang/String;)Z
    ...
    iget-object v1, p0, mLockdownWhitelist:Ljava/util/List;
    ...
    invoke-virtual {p0, v4, v5, v0}, createUserAndRestrictedProfilesRanges(ILjava/util/List;Ljava/util/List;)Ljava/util/Set;
    ...
    iget-object v4, p0, mBlockedUsers:Ljava/util/Set;
    ...
    invoke-direct {p0, v4, v1}, setAllowOnlyVpnForUids(ZLjava/util/Collection;)Z

    invoke-direct {p0, v3, v2}, setAllowOnlyVpnForUids(ZLjava/util/Collection;)Z
...
.method private updateAlwaysOnNotification(Landroid/net/NetworkInfo$DetailedState;)V
    ...
    iget-boolean v0, p0, mAlwaysOn:Z
    ...
    iget-boolean v10, p0, mLockdown:Z
    ...
    iget-object v9, p0, mSystemServices:Lcom/android/server/connectivity/Vpn$SystemServices;
...
.method public declared-synchronized addAddress(Ljava/lang/String;I)Z
    ...
    :try_start_0
    invoke-virtual {p0}, isCallerEstablishedOwnerLocked()Z
    ...
    invoke-direct {p0, v0, p1, p2}, jniAddAddress(Ljava/lang/String;Ljava/lang/String;I)Z
...
.method addUserToRanges(Ljava/util/Set;ILjava/util/List;Ljava/util/List;)V
    ...
    invoke-direct {p0, p3, p2}, getAppsUids(Ljava/util/List;I)Ljava/util/SortedSet;
    ...
    invoke-direct {p0, p4, p2}, getAppsUids(Ljava/util/List;I)Ljava/util/SortedSet;
...
.method createUserAndRestrictedProfilesRanges(ILjava/util/List;Ljava/util/List;)Ljava/util/Set;
    ...
    invoke-virtual {p0, v0, p1, p2, p3}, addUserToRanges(Ljava/util/Set;ILjava/util/List;Ljava/util/List;)V

    invoke-direct {p0, p1}, canHaveRestrictedProfile(I)Z
    ...
    invoke-virtual {p0, v0, v7, p2, p3}, addUserToRanges(Ljava/util/Set;ILjava/util/List;Ljava/util/List;)V
    ...
    invoke-virtual {p0, v0, v1, p2, p3}, addUserToRanges(Ljava/util/Set;ILjava/util/List;Ljava/util/List;)V
...
.method public declared-synchronized establish(Lcom/android/internal/net/VpnConfig;)Landroid/os/ParcelFileDescriptor;
    ...
    :cond_0
    :try_start_1
    iget-object v0, v1, mPackage:Ljava/lang/String;

    invoke-direct {v1, v0}, isVpnUserPreConsented(Ljava/lang/String;)Z
    ...
    iget-object v0, v1, mConfig:Lcom/android/internal/net/VpnConfig;

    move-object v8, v0

    iget-object v0, v1, mInterface:Ljava/lang/String;

    move-object v9, v0

    iget-object v0, v1, mConnection:Lcom/android/server/connectivity/Vpn$Connection;

    move-object v10, v0

    iget-object v0, v1, mNetworkAgent:Landroid/net/NetworkAgent;

    move-object v11, v0

    iget-object v0, v1, mNetworkCapabilities:Landroid/net/NetworkCapabilities;
    ...
    invoke-direct {v1, v0}, jniCreate(I)I
    ...
    invoke-direct {v1, v0}, jniGetName(I)Ljava/lang/String;
    ...
    invoke-direct {v1, v14, v0}, jniSetAddresses(Ljava/lang/String;Ljava/lang/String;)I
    ...
    iput-object v5, v1, mConnection:Lcom/android/server/connectivity/Vpn$Connection;

    iput-object v14, v1, mInterface:Ljava/lang/String;
    ...
    iput-object v2, v1, mConfig:Lcom/android/internal/net/VpnConfig;

    if-eqz v8, :cond_3

    iget-object v0, v1, mNetworkAgent:Landroid/net/NetworkAgent;

    invoke-direct {v1, v0, v8}, updateLinkPropertiesInPlaceIfPossible(Landroid/net/NetworkAgent;Lcom/android/internal/net/VpnConfig;)Z
    ...
    invoke-virtual {v1, v0, v3}, updateState(Landroid/net/NetworkInfo$DetailedState;Ljava/lang/String;)V

    invoke-direct/range {p0 .. p0}, agentConnect()V

    invoke-direct {v1, v11}, agentDisconnect(Landroid/net/NetworkAgent;)V
    ...
    invoke-direct {v1, v9}, jniReset(Ljava/lang/String;)V
    :try_end_9
    ...
    iget-object v4, v1, mInterface:Ljava/lang/String;
    ...
    iput-object v8, v1, mConfig:Lcom/android/internal/net/VpnConfig;

    iput-object v10, v1, mConnection:Lcom/android/server/connectivity/Vpn$Connection;

    iget-object v3, v1, mNetworkCapabilities:Landroid/net/NetworkCapabilities;

    invoke-virtual {v3, v12}, Landroid/net/NetworkCapabilities;->setUids(Ljava/util/Set;)Landroid/net/NetworkCapabilities;

    iput-object v11, v1, mNetworkAgent:Landroid/net/NetworkAgent;

    iput-object v9, v1, mInterface:Ljava/lang/String;
...
.method public declared-synchronized getAlwaysOnPackage()Ljava/lang/String;
    ...
    :try_start_0
    invoke-direct {p0}, enforceControlPermissionOrInternalCaller()V
...
.method public declared-synchronized getLockdownWhitelist()Ljava/util/List;
    ...
    iget-object v0, p0, mLockdownWhitelist:Ljava/util/List;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized isBlockingUid(I)Z
    ...
    invoke-virtual {p0, p1}, appliesToUid(I)Z
    ...
    :cond_0
    :try_start_1
    iget-object v0, p0, mBlockedUsers:Ljava/util/Set;
...
.method public onUserAdded(I)V
    ...
    :try_start_1
    iget-object v2, p0, mConfig:Lcom/android/internal/net/VpnConfig;
    ...
    invoke-virtual {p0, v1, p1, v2, v3}, addUserToRanges(Ljava/util/Set;ILjava/util/List;Ljava/util/List;)V
    ...
    :cond_0
    :goto_0
    iget-boolean v2, p0, mLockdown:Z

    invoke-direct {p0, v2}, setVpnForcedLocked(Z)V
...
.method public onUserRemoved(I)V
    ...
    :try_start_1
    invoke-static {p1, v1}, uidRangesForUser(ILjava/util/Set;)Ljava/util/List;

    move-result-object v2

    invoke-interface {v1, v2}, Ljava/util/Set;->removeAll(Ljava/util/Collection;)Z

    iget-object v3, p0, mNetworkCapabilities:Landroid/net/NetworkCapabilities;
...
.method public declared-synchronized onUserStopped()V
    ...
    :try_start_0
    invoke-virtual {p0, v0}, setLockdown(Z)V
...
.method public declared-synchronized prepare(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :try_start_0
    iget-boolean v2, p0, mAlwaysOn:Z
    ...
    invoke-direct {p0, p2}, isCurrentPreparedPackage(Ljava/lang/String;)Z
...
.method public declared-synchronized removeAddress(Ljava/lang/String;I)Z
    ...
    invoke-direct {p0, v0, p1, p2}, jniDelAddress(Ljava/lang/String;Ljava/lang/String;I)Z
...
.method public declared-synchronized setAlwaysOnPackage(Ljava/lang/String;ZLjava/util/List;)Z
    ...
    invoke-direct {p0, p1, p2, p3}, setAlwaysOnPackageInternal(Ljava/lang/String;ZLjava/util/List;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-direct {p0}, saveAlwaysOnPackage()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized setLockdown(Z)V
    ...
    invoke-direct {p0, p1}, setVpnForcedLocked(Z)V

    iput-boolean p1, p0, mLockdown:Z
...
.method public startAlwaysOnVpn()Z
    ...
    :cond_0
    invoke-virtual {p0, v0}, isAlwaysOnPackageSupported(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v1, v10, v1}, setAlwaysOnPackage(Ljava/lang/String;ZLjava/util/List;)Z
    ...
    :cond_1
    invoke-virtual {p0}, getNetworkInfo()Landroid/net/NetworkInfo;
...
.method public startLegacyVpnPrivileged(Lcom/android/internal/net/VpnProfile;Landroid/security/KeyStore;Landroid/net/LinkProperties;)V
    ...
    :cond_f
    invoke-direct {v0, v2, v12, v13, v1}, startLegacyVpn(Lcom/android/internal/net/VpnConfig;[Ljava/lang/String;[Ljava/lang/String;Lcom/android/internal/net/VpnProfile;)V
...
.method public declared-synchronized updateCapabilities(Landroid/net/Network;)Landroid/net/NetworkCapabilities;
    ...
    :cond_1
    iget-boolean v3, p0, mIsPackageTargetingAtLeastQ:Z
    ...
    invoke-static {v2, v0, v3, v1}, applyUnderlyingCapabilities(Landroid/net/ConnectivityManager;[Landroid/net/Network;Landroid/net/NetworkCapabilities;Z)V
...
.method protected updateState(Landroid/net/NetworkInfo$DetailedState;Ljava/lang/String;)V
    ...
    :cond_0
    invoke-direct {p0, p1}, updateAlwaysOnNotification(Landroid/net/NetworkInfo$DetailedState;)V
