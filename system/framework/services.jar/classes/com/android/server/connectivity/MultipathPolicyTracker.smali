...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;)V
    ...
    invoke-direct {p0, p1, p2, v0}, <init>(Landroid/content/Context;Landroid/os/Handler;Lcom/android/server/connectivity/MultipathPolicyTracker$Dependencies;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;Lcom/android/server/connectivity/MultipathPolicyTracker$Dependencies;)V
    ...
    iput-object v0, p0, mMultipathTrackers:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-object p3, p0, mDeps:Lcom/android/server/connectivity/MultipathPolicyTracker$Dependencies;
    ...
    iput-object v0, p0, mConfigChangeReceiver:Lcom/android/server/connectivity/MultipathPolicyTracker$ConfigChangeReceiver;
...
.method static synthetic access$1000(Lcom/android/server/connectivity/MultipathPolicyTracker;)Landroid/app/usage/NetworkStatsManager;
    ...
    iget-object v0, p0, mStatsManager:Landroid/app/usage/NetworkStatsManager;
...
.method static synthetic access$1100(Lcom/android/server/connectivity/MultipathPolicyTracker;)Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v0, p0, mMultipathTrackers:Ljava/util/concurrent/ConcurrentHashMap;
...
.method static synthetic access$1200(Lcom/android/server/connectivity/MultipathPolicyTracker;)V
    ...
    invoke-direct {p0}, updateAllMultipathBudgets()V
...
.method static synthetic access$500(Lcom/android/server/connectivity/MultipathPolicyTracker;)Landroid/net/NetworkPolicyManager;
    ...
    iget-object v0, p0, mNPM:Landroid/net/NetworkPolicyManager;
...
.method static synthetic access$600(Landroid/net/NetworkPolicy;J)J
    ...
    invoke-static {p0, p1, p2}, getActiveWarning(Landroid/net/NetworkPolicy;J)J
...
.method static synthetic access$700(Landroid/net/NetworkPolicy;J)J
    ...
    invoke-static {p0, p1, p2}, getActiveLimit(Landroid/net/NetworkPolicy;J)J
...
.method static synthetic access$800(Lcom/android/server/connectivity/MultipathPolicyTracker;)J
    ...
    invoke-direct {p0}, getDefaultDailyMultipathQuotaBytes()J
...
.method private registerNetworkPolicyListener()V
    ...
    iput-object v0, p0, mPolicyListener:Landroid/net/NetworkPolicyManager$Listener;

    iget-object v0, p0, mNPM:Landroid/net/NetworkPolicyManager;

    iget-object v1, p0, mPolicyListener:Landroid/net/NetworkPolicyManager$Listener;
...
.method private registerTrackMobileCallback()V
    ...
    iget-object v2, p0, mMobileNetworkCallback:Landroid/net/ConnectivityManager$NetworkCallback;
...
.method public getMultipathPreference(Landroid/net/Network;)Ljava/lang/Integer;
    ...
    :cond_0
    iget-object v1, p0, mMultipathTrackers:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public shutdown()V
    ...
    invoke-direct {p0}, maybeUnregisterTrackMobileCallback()V

    invoke-direct {p0}, unregisterNetworkPolicyListener()V
    ...
    iget-object v1, p0, mConfigChangeReceiver:Lcom/android/server/connectivity/MultipathPolicyTracker$ConfigChangeReceiver;
...
.method public start()V
    ...
    iput-object v0, p0, mNPM:Landroid/net/NetworkPolicyManager;
    ...
    iput-object v0, p0, mStatsManager:Landroid/app/usage/NetworkStatsManager;

    invoke-direct {p0}, registerTrackMobileCallback()V

    invoke-direct {p0}, registerNetworkPolicyListener()V
    ...
    iget-object v3, p0, mConfigChangeReceiver:Lcom/android/server/connectivity/MultipathPolicyTracker$ConfigChangeReceiver;
