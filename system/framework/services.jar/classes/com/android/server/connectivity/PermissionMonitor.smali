...
.method static constructor <clinit>()V
    ...
    sput-object v0, SYSTEM:Ljava/lang/Boolean;

    sget-object v0, Ljava/lang/Boolean;->FALSE:Ljava/lang/Boolean;

    sput-object v0, NETWORK:Ljava/lang/Boolean;
...
.method public constructor <init>(Landroid/content/Context;Landroid/net/INetd;)V
    ...
    iput-object v0, p0, mVpnUidRanges:Ljava/util/Map;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, mAllApps:Ljava/util/Set;
    ...
    iput-object p2, p0, mNetd:Landroid/net/INetd;
...
.method static synthetic access$200([Ljava/lang/String;[I)I
    ...
    invoke-static {p0, p1}, getNetdPermissionMask([Ljava/lang/String;[I)I
...
.method private update(Ljava/util/Set;Ljava/util/Map;Z)V
    ...
    invoke-direct {p0, v0}, toIntArray(Ljava/util/Collection;)[I
    ...
    invoke-direct {p0, v1}, toIntArray(Ljava/util/Collection;)[I
...
.method private updateVpnUids(Ljava/lang/String;Ljava/util/Set;Z)V
    ...
    invoke-direct {p0, p2}, toIntArray(Ljava/util/Collection;)[I
    ...
    invoke-static {v0, v1}, loge(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public dump(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    iget-object v0, p0, mVpnUidRanges:Ljava/util/Map;
...
.method hasNetworkPermission(Landroid/content/pm/PackageInfo;)Z
    ...
    invoke-virtual {p0, p1, v0}, hasPermission(Landroid/content/pm/PackageInfo;Ljava/lang/String;)Z
...
.method hasRestrictedNetworkPermission(Landroid/content/pm/PackageInfo;)Z
    ...
    invoke-virtual {p0}, getDeviceFirstSdkInt()I
    ...
    invoke-static {v0}, isVendorApp(Landroid/content/pm/ApplicationInfo;)Z
...
.method protected highestPermissionForUid(Ljava/lang/Boolean;Ljava/lang/String;)Ljava/lang/Boolean;
    ...
    sget-object v0, SYSTEM:Ljava/lang/Boolean;
    ...
    invoke-virtual {p0, v0}, hasNetworkPermission(Landroid/content/pm/PackageInfo;)Z

    move-result v1

    invoke-virtual {p0, v0}, hasRestrictedNetworkPermission(Landroid/content/pm/PackageInfo;)Z
...
.method public synthetic lambda$removeBypassingUids$0$PermissionMonitor(Ljava/lang/Integer;)Z
    ...
    sget-object v1, NETWORK:Ljava/lang/Boolean;

    invoke-interface {v0, p1, v1}, Ljava/util/Map;->getOrDefault(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v0

    sget-object v1, SYSTEM:Ljava/lang/Boolean;
...
.method public declared-synchronized onPackageAdded(Ljava/lang/String;I)V
    ...
    invoke-virtual {p0, v0, p1}, highestPermissionForUid(Ljava/lang/Boolean;Ljava/lang/String;)Ljava/lang/Boolean;
    ...
    iget-object v3, p0, mUsers:Ljava/util/Set;

    invoke-direct {p0, v3, v1, v2}, update(Ljava/util/Set;Ljava/util/Map;Z)V

    :cond_0
    iget-object v1, p0, mVpnUidRanges:Ljava/util/Map;
    ...
    invoke-direct {p0, v4, v5}, removeBypassingUids(Ljava/util/Set;I)V
    ...
    invoke-direct {p0, v5, v4, v2}, updateVpnUids(Ljava/lang/String;Ljava/util/Set;Z)V

    :cond_1
    goto :goto_0

    :cond_2
    iget-object v1, p0, mAllApps:Ljava/util/Set;
...
.method public declared-synchronized onPackageRemoved(I)V
    ...
    invoke-direct {p0, v3, v4}, removeBypassingUids(Ljava/util/Set;I)V
    ...
    invoke-direct {p0, v4, v3, v2}, updateVpnUids(Ljava/lang/String;Ljava/util/Set;Z)V
    ...
    iget-object v0, p0, mAllApps:Ljava/util/Set;
    ...
    invoke-virtual {p0, v5, v6}, highestPermissionForUid(Ljava/lang/Boolean;Ljava/lang/String;)Ljava/lang/Boolean;

    move-result-object v7

    move-object v5, v7

    sget-object v7, SYSTEM:Ljava/lang/Boolean;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_5
    :try_start_1
    iget-object v4, p0, mApps:Ljava/util/Map;
    ...
    :try_start_2
    iget-object v2, p0, mApps:Ljava/util/Map;
    ...
    iget-object v2, p0, mUsers:Ljava/util/Set;

    const/4 v4, 0x1

    invoke-direct {p0, v2, v0, v4}, update(Ljava/util/Set;Ljava/util/Map;Z)V
    ...
    sget-object v5, NETWORK:Ljava/lang/Boolean;

    invoke-interface {v0, v4, v5}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v4, p0, mUsers:Ljava/util/Set;

    invoke-direct {p0, v4, v0, v2}, update(Ljava/util/Set;Ljava/util/Map;Z)V
    :try_end_2
...
.method public declared-synchronized onPackageReplaced(Ljava/lang/String;I)V
    ...
    invoke-direct {p0, v4}, getPackageInfo(Ljava/lang/String;)Landroid/content/pm/PackageInfo;
    ...
    invoke-static {v6, v7}, getNetdPermissionMask([Ljava/lang/String;[I)I
    ...
    invoke-virtual {p0, p2, v0}, sendPackagePermissionsForUid(II)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized onVpnUidRangesAdded(Ljava/lang/String;Ljava/util/Set;I)V
    ...
    invoke-direct {p0, p2, v0}, intersectUids(Ljava/util/Set;Ljava/util/Set;)Ljava/util/Set;

    move-result-object v0

    invoke-direct {p0, v0, p3}, removeBypassingUids(Ljava/util/Set;I)V

    const/4 v1, 0x1

    invoke-direct {p0, p1, v0, v1}, updateVpnUids(Ljava/lang/String;Ljava/util/Set;Z)V
...
.method public declared-synchronized onVpnUidRangesRemoved(Ljava/lang/String;Ljava/util/Set;I)V
    ...
    iget-object v2, p0, mVpnUidRanges:Ljava/util/Map;
...
.method sendPackagePermissionsForUid(II)V
    ...
    invoke-virtual {p0, v0}, sendPackagePermissionsToNetd(Landroid/util/SparseIntArray;)V
...
.method sendPackagePermissionsToNetd(Landroid/util/SparseIntArray;)V
    ...
    iget-object v6, p0, mNetd:Landroid/net/INetd;
...
.method public declared-synchronized startMonitoring()V
    ...
    :cond_3
    iget-object v6, p0, mAllApps:Ljava/util/Set;
    ...
    invoke-virtual {p0, v4}, hasNetworkPermission(Landroid/content/pm/PackageInfo;)Z

    move-result v6

    invoke-virtual {p0, v4}, hasRestrictedNetworkPermission(Landroid/content/pm/PackageInfo;)Z
    ...
    :cond_4
    iget-object v8, p0, mApps:Ljava/util/Map;
    ...
    sget-object v9, NETWORK:Ljava/lang/Boolean;

    if-ne v8, v9, :cond_6

    :cond_5
    iget-object v9, p0, mApps:Ljava/util/Map;
    ...
    invoke-static {v8, v9}, getNetdPermissionMask([Ljava/lang/String;[I)I
    ...
    iget-object v7, p0, mUsers:Ljava/util/Set;
    ...
    iget-object v7, p0, mApps:Ljava/util/Map;
    ...
    invoke-direct {p0, v6, v7, v4}, update(Ljava/util/Set;Ljava/util/Map;Z)V

    invoke-virtual {p0, v2}, sendPackagePermissionsToNetd(Landroid/util/SparseIntArray;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
