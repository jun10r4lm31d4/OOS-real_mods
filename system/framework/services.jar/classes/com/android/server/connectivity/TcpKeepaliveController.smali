...
.method public constructor <init>(Landroid/os/Handler;)V
    ...
    iput-object v0, p0, mFdHandlerQueue:Landroid/os/MessageQueue;
...
.method public static getTcpKeepalivePacket(Ljava/io/FileDescriptor;)Landroid/net/TcpKeepalivePacketData;
    ...
    :try_start_0
    invoke-static {p0}, switchToRepairMode(Ljava/io/FileDescriptor;)Landroid/net/TcpKeepalivePacketDataParcelable;
    ...
    invoke-static {p0}, switchOutOfRepairMode(Ljava/io/FileDescriptor;)V
...
.method private static isSocketIdle(Ljava/io/FileDescriptor;)Z
    ...
    invoke-static {p0}, isReceiveQueueEmpty(Ljava/io/FileDescriptor;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p0}, isSendQueueEmpty(Ljava/io/FileDescriptor;)Z
...
.method private static switchToRepairMode(Ljava/io/FileDescriptor;)Landroid/net/TcpKeepalivePacketDataParcelable;
    ...
    invoke-static {v4}, getAddress(Ljava/net/InetSocketAddress;)[B
    ...
    invoke-static {v4}, getPort(Ljava/net/InetSocketAddress;)I
    ...
    invoke-static {v5}, getAddress(Ljava/net/InetSocketAddress;)[B
    ...
    invoke-static {v5}, getPort(Ljava/net/InetSocketAddress;)I
    ...
    invoke-static {p0, v5}, dropAllIncomingPackets(Ljava/io/FileDescriptor;Z)V
    ...
    invoke-static {p0}, isSocketIdle(Ljava/io/FileDescriptor;)Z
    ...
    :cond_0
    invoke-static {p0, v6}, dropAllIncomingPackets(Ljava/io/FileDescriptor;Z)V
...
.method public startSocketMonitor(Ljava/io/FileDescriptor;Lcom/android/server/connectivity/KeepaliveTracker$KeepaliveInfo;I)V
    ...
    iget-object v0, p0, mListeners:Landroid/util/SparseArray;
    ...
    :cond_1
    iget-object v1, p0, mFdHandlerQueue:Landroid/os/MessageQueue;
...
.method public stopSocketMonitor(I)V
    ...
    iget-object v0, p0, mFdHandlerQueue:Landroid/os/MessageQueue;

    invoke-virtual {v0, v1}, Landroid/os/MessageQueue;->removeOnFileDescriptorEventListener(Ljava/io/FileDescriptor;)V

    invoke-static {v1}, switchOutOfRepairMode(Ljava/io/FileDescriptor;)V
