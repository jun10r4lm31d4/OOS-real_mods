...
.method public constructor <init>(Landroid/net/Network;Landroid/net/LinkProperties;J)V
    ...
    iput-object v0, p0, mIcmpChecks:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, mExplicitSourceIcmpChecks:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, mDnsUdpChecks:Ljava/util/Map;
    ...
    invoke-static {v0}, getInterfaceIndex(Ljava/lang/String;)Ljava/lang/Integer;

    move-result-object v0

    iput-object v0, p0, mInterfaceIndex:Ljava/lang/Integer;
    ...
    iget-wide v2, p0, mTimeoutMs:J

    add-long/2addr v0, v2

    iput-wide v0, p0, mDeadlineTime:J

    iget-object v0, p0, mLinkProperties:Landroid/net/LinkProperties;

    sget-object v1, TEST_DNS4:Ljava/net/InetAddress;
    ...
    sget-object v1, TEST_DNS6:Ljava/net/InetAddress;
    ...
    invoke-direct {p0, v2}, prepareExplicitSourceIcmpMeasurements(Ljava/net/InetAddress;)V
    ...
    invoke-direct {p0, v1}, prepareIcmpMeasurement(Ljava/net/InetAddress;)V

    invoke-direct {p0, v1}, prepareDnsMeasurement(Ljava/net/InetAddress;)V
    ...
    iput-object v0, p0, mCountDownLatch:Ljava/util/concurrent/CountDownLatch;
    ...
    iget-object v1, p0, mInterfaceIndex:Ljava/lang/Integer;
...
.method private prepareDnsMeasurement(Ljava/net/InetAddress;)V
    ...
    iget-object v0, p0, mDnsUdpChecks:Ljava/util/Map;
...
.method private prepareExplicitSourceIcmpMeasurements(Ljava/net/InetAddress;)V
    ...
    iget-object v4, p0, mExplicitSourceIcmpChecks:Ljava/util/Map;
...
.method private startMeasurements()V
    ...
    :cond_0
    iget-object v0, p0, mExplicitSourceIcmpChecks:Ljava/util/Map;
...
.method public dump(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    invoke-virtual {p0}, getMeasurements()Ljava/util/List;
...
.method public waitForMeasurements()V
    ...
    iget-wide v1, p0, mDeadlineTime:J
