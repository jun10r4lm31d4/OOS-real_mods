...
.method private constructor <init>(Lcom/android/server/appbinding/AppBindingService$Injector;Landroid/content/Context;)V
    ...
    iput-object v0, p0, mRunningUsers:Landroid/util/SparseBooleanArray;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mApps:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, mPackageUserMonitor:Landroid/content/BroadcastReceiver;

    iput-object p1, p0, mInjector:Lcom/android/server/appbinding/AppBindingService$Injector;
    ...
    iget-object v0, p0, mApps:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, mConstants:Lcom/android/server/appbinding/AppBindingConstants;
...
.method synthetic constructor <init>(Lcom/android/server/appbinding/AppBindingService$Injector;Landroid/content/Context;Lcom/android/server/appbinding/AppBindingService$1;)V
    ...
    invoke-direct {p0, p1, p2}, <init>(Lcom/android/server/appbinding/AppBindingService$Injector;Landroid/content/Context;)V
...
.method static synthetic access$500(Lcom/android/server/appbinding/AppBindingService;)V
    ...
    invoke-direct {p0}, refreshConstants()V
...
.method static synthetic access$700(Lcom/android/server/appbinding/AppBindingService;Ljava/lang/String;I)V
    ...
    invoke-direct {p0, p1, p2}, handlePackageAddedReplacing(Ljava/lang/String;I)V
...
.method private bindServicesLocked(ILcom/android/server/appbinding/finders/AppServiceFinder;Ljava/lang/String;)V
    ...
    :goto_0
    iget-object v1, p0, mApps:Ljava/util/ArrayList;
    ...
    :cond_0
    invoke-direct {p0, p1, v1}, findConnectionLock(ILcom/android/server/appbinding/finders/AppServiceFinder;)Lcom/android/server/appbinding/AppBindingService$AppServiceConnection;

    move-result-object v9

    if-eqz v9, :cond_1

    invoke-direct {p0, p1, p2, p3}, unbindServicesLocked(ILcom/android/server/appbinding/finders/AppServiceFinder;Ljava/lang/String;)V

    :cond_1
    iget-object v2, p0, mIPackageManager:Landroid/content/pm/IPackageManager;

    iget-object v3, p0, mConstants:Lcom/android/server/appbinding/AppBindingConstants;
    ...
    iget-object v5, p0, mConstants:Lcom/android/server/appbinding/AppBindingConstants;
...
.method private dumpSimple(Ljava/io/PrintWriter;)V
    ...
    invoke-direct {p0, v1}, forAllAppsLocked(Ljava/util/function/Consumer;)V
...
.method private handlePackageAddedReplacing(Ljava/lang/String;I)V
    ...
    :try_start_0
    invoke-direct {p0, p2, p1}, findFinderLocked(ILjava/lang/String;)Lcom/android/server/appbinding/finders/AppServiceFinder;
    ...
    invoke-direct {p0, p2, v1, v2}, unbindServicesLocked(ILcom/android/server/appbinding/finders/AppServiceFinder;Ljava/lang/String;)V

    const-string/jumbo v2, "package update"

    invoke-direct {p0, p2, v1, v2}, bindServicesLocked(ILcom/android/server/appbinding/finders/AppServiceFinder;Ljava/lang/String;)V
...
.method public static synthetic lambda$D_3boeCn8eAANOp2ZDk6OC2rNaI(Lcom/android/server/appbinding/AppBindingService;Lcom/android/server/appbinding/finders/AppServiceFinder;I)V
    ...
    invoke-direct {p0, p1, p2}, onAppChanged(Lcom/android/server/appbinding/finders/AppServiceFinder;I)V
...
.method private onAppChanged(Lcom/android/server/appbinding/finders/AppServiceFinder;I)V
    ...
    invoke-direct {p0, p2, p1, v1}, unbindServicesLocked(ILcom/android/server/appbinding/finders/AppServiceFinder;Ljava/lang/String;)V

    invoke-direct {p0, p2, p1, v1}, bindServicesLocked(ILcom/android/server/appbinding/finders/AppServiceFinder;Ljava/lang/String;)V
...
.method private onBootPhase(I)V
    ...
    :cond_0
    invoke-direct {p0}, onPhaseThirdPartyAppsCanStart()V

    goto :goto_0

    :cond_1
    invoke-direct {p0}, onPhaseActivityManagerReady()V
...
.method private onPhaseActivityManagerReady()V
    ...
    iget-object v2, p0, mPackageUserMonitor:Landroid/content/BroadcastReceiver;
    ...
    iget-object v3, p0, mPackageUserMonitor:Landroid/content/BroadcastReceiver;
...
.method private onStartUser(I)V
    ...
    :try_start_0
    iget-object v1, p0, mRunningUsers:Landroid/util/SparseBooleanArray;
    ...
    invoke-direct {p0, p1, v1, v2}, bindServicesLocked(ILcom/android/server/appbinding/finders/AppServiceFinder;Ljava/lang/String;)V
...
.method private onStopUser(I)V
    ...
    invoke-direct {p0, p1, v1, v2}, unbindServicesLocked(ILcom/android/server/appbinding/finders/AppServiceFinder;Ljava/lang/String;)V
...
.method private rebindAllLocked(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v1, v2, p1}, unbindServicesLocked(ILcom/android/server/appbinding/finders/AppServiceFinder;Ljava/lang/String;)V

    invoke-direct {p0, v1, v2, p1}, bindServicesLocked(ILcom/android/server/appbinding/finders/AppServiceFinder;Ljava/lang/String;)V
...
.method private refreshConstants()V
    ...
    iget-object v0, p0, mInjector:Lcom/android/server/appbinding/AppBindingService$Injector;
    ...
    :try_start_0
    iget-object v2, p0, mConstants:Lcom/android/server/appbinding/AppBindingConstants;
    ...
    iput-object v2, p0, mConstants:Lcom/android/server/appbinding/AppBindingConstants;

    const-string/jumbo v2, "settings update"

    invoke-direct {p0, v2}, rebindAllLocked(Ljava/lang/String;)V
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-direct {p0, p2}, dumpSimple(Ljava/io/PrintWriter;)V
    ...
    :goto_0
    iget-object v3, p0, mRunningUsers:Landroid/util/SparseBooleanArray;
...
.method getConstantsForTest()Lcom/android/server/appbinding/AppBindingConstants;
    ...
    iget-object v0, p0, mConstants:Lcom/android/server/appbinding/AppBindingConstants;
