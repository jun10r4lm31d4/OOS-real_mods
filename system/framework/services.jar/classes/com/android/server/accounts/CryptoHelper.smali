...
.method private constructor <init>()V
    ...
    iput-object v1, p0, mEncryptionKey:Ljavax/crypto/SecretKey;
    ...
    iput-object v1, p0, mMacKey:Ljavax/crypto/SecretKey;
...
.method static declared-synchronized getInstance()Lcom/android/server/accounts/CryptoHelper;
    ...
    :try_start_0
    sget-object v1, sInstance:Lcom/android/server/accounts/CryptoHelper;
    ...
    sput-object v1, sInstance:Lcom/android/server/accounts/CryptoHelper;
...
.method private verifyMac([B[B[B)Z
    ...
    :cond_0
    invoke-direct {p0, p1, p2}, createMac([B[B)[B

    move-result-object v0

    invoke-static {p3, v0}, constantTimeArrayEquals([B[B)Z
...
.method decryptBundle(Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    invoke-direct {p0, v1, v0, v2}, verifyMac([B[B[B)Z
    ...
    iget-object v6, p0, mEncryptionKey:Ljavax/crypto/SecretKey;
...
.method encryptBundle(Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    invoke-direct {p0, v3, v4}, createMac([B[B)[B
