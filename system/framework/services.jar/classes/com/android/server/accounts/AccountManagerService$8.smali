...
.method constructor <init>(Lcom/android/server/accounts/AccountManagerService;Lcom/android/server/accounts/AccountManagerService$UserAccounts;Landroid/accounts/IAccountManagerResponse;Ljava/lang/String;ZZLjava/lang/String;ZLandroid/os/Bundle;Landroid/accounts/Account;Ljava/lang/String;ZZIZLjava/lang/String;[BLcom/android/server/accounts/AccountManagerService$UserAccounts;)V
    ...
    iput-object v1, v0, this$0:Lcom/android/server/accounts/AccountManagerService;

    move-object v2, p9

    iput-object v2, v0, val$loginOptions:Landroid/os/Bundle;

    move-object v2, p10

    iput-object v2, v0, val$account:Landroid/accounts/Account;

    move-object v2, p11

    iput-object v2, v0, val$authTokenType:Ljava/lang/String;

    move v2, p12

    iput-boolean v2, v0, val$notifyOnAuthFailure:Z

    move/from16 v2, p13

    iput-boolean v2, v0, val$permissionGranted:Z

    move/from16 v2, p14

    iput v2, v0, val$callerUid:I

    move/from16 v2, p15

    iput-boolean v2, v0, val$customTokens:Z

    move-object/from16 v2, p16

    iput-object v2, v0, val$callerPkg:Ljava/lang/String;

    move-object/from16 v2, p17

    iput-object v2, v0, val$callerPkgSigDigest:[B

    move-object/from16 v2, p18

    iput-object v2, v0, val$accounts:Lcom/android/server/accounts/AccountManagerService$UserAccounts;
...
.method public onResult(Landroid/os/Bundle;)V
    ...
    iget-object v4, v0, this$0:Lcom/android/server/accounts/AccountManagerService;

    iget-object v5, v0, val$account:Landroid/accounts/Account;

    const/4 v6, 0x0

    iget v7, v0, val$callerUid:I
    ...
    iget-object v9, v0, val$authTokenType:Ljava/lang/String;
    ...
    invoke-virtual {v0, v4}, onResult(Landroid/os/Bundle;)V
    ...
    iget-boolean v4, v0, val$customTokens:Z

    if-nez v4, :cond_2

    iget-object v4, v0, this$0:Lcom/android/server/accounts/AccountManagerService;

    iget-object v5, v0, mAccounts:Lcom/android/server/accounts/AccountManagerService$UserAccounts;

    iget-object v6, v0, val$authTokenType:Ljava/lang/String;
    ...
    iget-object v6, v0, val$account:Landroid/accounts/Account;

    iget-object v7, v0, val$callerPkg:Ljava/lang/String;

    iget-object v8, v0, val$callerPkgSigDigest:[B
    ...
    invoke-virtual {v0, v13, v3}, onError(ILjava/lang/String;)V
    ...
    iget-boolean v4, v0, val$notifyOnAuthFailure:Z
    ...
    invoke-virtual {v0, v4, v3}, checkKeyIntent(ILandroid/content/Intent;)Z
    ...
    invoke-virtual {v0, v13, v4}, onError(ILjava/lang/String;)V
    ...
    iget-object v8, v0, val$accounts:Lcom/android/server/accounts/AccountManagerService$UserAccounts;
