...
.method public constructor <init>(Lcom/android/server/job/JobSchedulerService;)V
    ...
    iput-object v0, p0, DEADLINE_TAG:Ljava/lang/String;

    const-string v0, "*job.delay*"

    iput-object v0, p0, DELAY_TAG:Ljava/lang/String;
    ...
    iput-object v0, p0, mDeadlineExpiredListener:Landroid/app/AlarmManager$OnAlarmListener;
    ...
    iput-object v0, p0, mNextDelayExpiredListener:Landroid/app/AlarmManager$OnAlarmListener;

    const-wide v0, 0x7fffffffffffffffL

    iput-wide v0, p0, mNextJobExpiredElapsedMillis:J

    iput-wide v0, p0, mNextDelayExpiredElapsedMillis:J
    ...
    iput-boolean v0, p0, mChainedAttributionEnabled:Z
    ...
    iput-object v0, p0, mTcConstants:Lcom/android/server/job/controllers/TimeController$TcConstants;
...
.method private deriveWorkSource(ILjava/lang/String;)Landroid/os/WorkSource;
    ...
    iget-boolean v0, p0, mChainedAttributionEnabled:Z
...
.method private maybeUpdateDeadlineAlarmLocked(JLandroid/os/WorkSource;)V
    ...
    invoke-direct {p0, p1, p2, p3}, setDeadlineExpiredAlarmLocked(JLandroid/os/WorkSource;)V
...
.method private maybeUpdateDelayAlarmLocked(JLandroid/os/WorkSource;)V
    ...
    invoke-direct {p0, p1, p2, p3}, setDelayExpiredAlarmLocked(JLandroid/os/WorkSource;)V
...
.method private setDeadlineExpiredAlarmLocked(JLandroid/os/WorkSource;)V
    ...
    iget-object v3, p0, mDeadlineExpiredListener:Landroid/app/AlarmManager$OnAlarmListener;

    iget-wide v4, p0, mNextJobExpiredElapsedMillis:J
    ...
    invoke-direct/range {v1 .. v6}, updateAlarmWithListenerLocked(Ljava/lang/String;Landroid/app/AlarmManager$OnAlarmListener;JLandroid/os/WorkSource;)V
...
.method private setDelayExpiredAlarmLocked(JLandroid/os/WorkSource;)V
    ...
    iget-object v3, p0, mNextDelayExpiredListener:Landroid/app/AlarmManager$OnAlarmListener;

    iget-wide v4, p0, mNextDelayExpiredElapsedMillis:J
...
.method private updateAlarmWithListenerLocked(Ljava/lang/String;Landroid/app/AlarmManager$OnAlarmListener;JLandroid/os/WorkSource;)V
    ...
    invoke-direct/range {p0 .. p0}, ensureAlarmServiceLocked()V
    ...
    iget-object v1, v0, mAlarmService:Landroid/app/AlarmManager;
...
.method checkExpiredDeadlinesAndResetAlarm()V
    ...
    iget-object v7, p0, mTrackedJobs:Ljava/util/List;
    ...
    :cond_1
    invoke-direct {p0, v8, v5, v6}, evaluateDeadlineConstraint(Lcom/android/server/job/controllers/JobStatus;J)Z
    ...
    :cond_3
    iget-object v9, p0, mTcConstants:Lcom/android/server/job/controllers/TimeController$TcConstants;
    ...
    invoke-virtual {p0, v8, v9}, wouldBeReadyWithConstraintLocked(Lcom/android/server/job/controllers/JobStatus;I)Z
    ...
    invoke-direct {p0, v3, v4}, deriveWorkSource(ILjava/lang/String;)Landroid/os/WorkSource;

    move-result-object v8

    invoke-direct {p0, v1, v2, v8}, setDeadlineExpiredAlarmLocked(JLandroid/os/WorkSource;)V
...
.method checkExpiredDelaysAndResetAlarm()V
    ...
    :cond_1
    invoke-direct {p0, v9, v1, v2}, evaluateTimingDelayConstraint(Lcom/android/server/job/controllers/JobStatus;J)Z

    move-result v10

    if-eqz v10, :cond_3

    invoke-direct {p0, v9}, canStopTrackingJobLocked(Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    :cond_3
    iget-object v10, p0, mTcConstants:Lcom/android/server/job/controllers/TimeController$TcConstants;
    ...
    invoke-virtual {p0, v9, v10}, wouldBeReadyWithConstraintLocked(Lcom/android/server/job/controllers/JobStatus;I)Z
    ...
    invoke-direct {p0, v5, v6}, deriveWorkSource(ILjava/lang/String;)Landroid/os/WorkSource;

    move-result-object v9

    invoke-direct {p0, v3, v4, v9}, setDelayExpiredAlarmLocked(JLandroid/os/WorkSource;)V
...
.method public dumpConstants(Landroid/util/proto/ProtoOutputStream;)V
    ...
    iget-object v0, p0, mTcConstants:Lcom/android/server/job/controllers/TimeController$TcConstants;
...
.method public dumpControllerStateLocked(Landroid/util/proto/ProtoOutputStream;JLjava/util/function/Predicate;)V
    ...
    iget-wide v8, v0, mNextDelayExpiredElapsedMillis:J
    ...
    iget-wide v8, v0, mNextJobExpiredElapsedMillis:J
    ...
    iget-object v8, v0, mTrackedJobs:Ljava/util/List;
...
.method public evaluateStateLocked(Lcom/android/server/job/controllers/JobStatus;)V
    ...
    iget-wide v7, p0, mNextJobExpiredElapsedMillis:J

    cmp-long v5, v5, v7

    if-gtz v5, :cond_5

    invoke-direct {p0, p1, v0, v1}, evaluateDeadlineConstraint(Lcom/android/server/job/controllers/JobStatus;J)Z

    move-result v5

    if-eqz v5, :cond_1

    invoke-virtual {p0}, checkExpiredDeadlinesAndResetAlarm()V

    invoke-virtual {p0}, checkExpiredDelaysAndResetAlarm()V
    ...
    :goto_0
    invoke-virtual {p0, p1, v2}, wouldBeReadyWithConstraintLocked(Lcom/android/server/job/controllers/JobStatus;I)Z
    ...
    iget-wide v7, p0, mNextDelayExpiredElapsedMillis:J

    cmp-long v5, v5, v7

    if-gtz v5, :cond_a

    invoke-direct {p0, p1, v0, v1}, evaluateTimingDelayConstraint(Lcom/android/server/job/controllers/JobStatus;J)Z
...
.method public maybeStartTrackingJobLocked(Lcom/android/server/job/controllers/JobStatus;Lcom/android/server/job/controllers/JobStatus;)V
    ...
    invoke-virtual {p0, p1, v0, v1}, maybeStopTrackingJobLocked(Lcom/android/server/job/controllers/JobStatus;Lcom/android/server/job/controllers/JobStatus;Z)V
    ...
    invoke-direct {p0, v4, v5}, deriveWorkSource(ILjava/lang/String;)Landroid/os/WorkSource;
    ...
    iget-object v7, p0, mTcConstants:Lcom/android/server/job/controllers/TimeController$TcConstants;
    ...
    invoke-virtual {p0, p1, v7}, wouldBeReadyWithConstraintLocked(Lcom/android/server/job/controllers/JobStatus;I)Z

    move-result v7

    if-eqz v7, :cond_8

    invoke-direct {p0, v5, v6, v4}, maybeUpdateDelayAlarmLocked(JLandroid/os/WorkSource;)V
    ...
    invoke-direct {p0, v8, v9, v4}, maybeUpdateDeadlineAlarmLocked(JLandroid/os/WorkSource;)V
