...
.method constructor <init>(Landroid/content/Context;Ljava/lang/Object;Lcom/android/internal/app/IBatteryStats;Lcom/android/server/job/JobPackageTracker;Lcom/android/server/job/JobCompletedListener;Landroid/os/Looper;)V
    ...
    iput-boolean v0, p0, isTiming:Z

    iput-boolean v0, p0, isMonitoring:Z
    ...
    iput-object p4, p0, mJobPackageTracker:Lcom/android/server/job/JobPackageTracker;
    ...
    iput-object p5, p0, mCompletedListener:Lcom/android/server/job/JobCompletedListener;
...
.method constructor <init>(Lcom/android/server/job/JobSchedulerService;Lcom/android/internal/app/IBatteryStats;Lcom/android/server/job/JobPackageTracker;Landroid/os/Looper;)V
    ...
    invoke-direct/range {v0 .. v6}, <init>(Landroid/content/Context;Ljava/lang/Object;Lcom/android/internal/app/IBatteryStats;Lcom/android/server/job/JobPackageTracker;Lcom/android/server/job/JobCompletedListener;Landroid/os/Looper;)V
...
.method static synthetic access$100(Lcom/android/server/job/JobServiceContext;)Lcom/android/server/job/JobServiceContext$JobCallback;
    ...
    iget-object v0, p0, mRunningCallback:Lcom/android/server/job/JobServiceContext$JobCallback;
...
.method static synthetic access$200(Lcom/android/server/job/JobServiceContext;)V
    ...
    invoke-direct {p0}, handleOpTimeoutLocked()V
...
.method private applyStoppedReasonLocked(Ljava/lang/String;)V
    ...
    iget-object v0, p0, mStoppedReason:Ljava/lang/String;

    if-nez v0, :cond_0

    iput-object p1, p0, mStoppedReason:Ljava/lang/String;
    ...
    iput-wide v0, p0, mStoppedTime:J

    iget-object v0, p0, mRunningCallback:Lcom/android/server/job/JobServiceContext$JobCallback;

    if-eqz v0, :cond_0

    iget-object v1, p0, mStoppedReason:Ljava/lang/String;

    iput-object v1, v0, Lcom/android/server/job/JobServiceContext$JobCallback;->mStoppedReason:Ljava/lang/String;

    iget-wide v1, p0, mStoppedTime:J
...
.method private assertCallerLocked(Lcom/android/server/job/JobServiceContext$JobCallback;)V
    ...
    invoke-direct {p0, p1}, verifyCallerLocked(Lcom/android/server/job/JobServiceContext$JobCallback;)Z
...
.method private closeAndCleanupJobLocked(ZLjava/lang/String;)V
    ...
    :cond_0
    invoke-direct {p0, p2}, applyStoppedReasonLocked(Ljava/lang/String;)V
    ...
    iget-object v3, p0, mParams:Landroid/app/job/JobParameters;
    ...
    iget-object v2, p0, mParams:Landroid/app/job/JobParameters;
    ...
    iput-object v2, p0, mRunningJob:Lcom/android/server/job/controllers/JobStatus;

    iput-object v2, p0, mRunningCallback:Lcom/android/server/job/JobServiceContext$JobCallback;

    iput-object v2, p0, mParams:Landroid/app/job/JobParameters;
    ...
    iput-boolean v1, p0, mAvailable:Z

    invoke-direct {p0}, removeOpTimeOutLocked()V

    iget-object v1, p0, mCompletedListener:Lcom/android/server/job/JobCompletedListener;
...
.method private handleCancelLocked(Ljava/lang/String;)V
    ...
    sget-object v2, VERB_STRINGS:[Ljava/lang/String;
    ...
    :cond_2
    invoke-direct {p0, p1}, sendStopMessageLocked(Ljava/lang/String;)V

    goto :goto_0

    :cond_3
    iput-boolean v2, p0, mCancelled:Z

    invoke-direct {p0, p1}, applyStoppedReasonLocked(Ljava/lang/String;)V
...
.method private handleFinishedLocked(ZLjava/lang/String;)V
    ...
    sget-object v1, VERB_STRINGS:[Ljava/lang/String;
    ...
    :cond_0
    invoke-direct {p0, p1, p2}, closeAndCleanupJobLocked(ZLjava/lang/String;)V
...
.method private handleOpTimeoutLocked()V
    ...
    invoke-direct {p0}, getRunningJobNameLocked()Ljava/lang/String;
    ...
    invoke-direct {p0, v2, v0}, closeAndCleanupJobLocked(ZLjava/lang/String;)V
    ...
    invoke-direct {p0, v4, v0}, closeAndCleanupJobLocked(ZLjava/lang/String;)V
    ...
    invoke-direct {p0, v0}, sendStopMessageLocked(Ljava/lang/String;)V
...
.method private handleServiceBoundLocked()V
    ...
    invoke-direct {p0, v0, v1}, closeAndCleanupJobLocked(ZLjava/lang/String;)V
    ...
    invoke-direct {p0}, scheduleOpTimeOutLocked()V

    iget-object v0, p0, service:Landroid/app/job/IJobService;
...
.method private handleStartedLocked(Z)V
    ...
    invoke-direct {p0, v0, v1}, handleFinishedLocked(ZLjava/lang/String;)V
    ...
    invoke-direct {p0, v0}, handleCancelLocked(Ljava/lang/String;)V
...
.method private scheduleOpTimeOutLocked()V
    ...
    :cond_0
    invoke-direct {p0}, startTiming()V
    ...
    iget-object v4, p0, mRunningCallback:Lcom/android/server/job/JobServiceContext$JobCallback;
    ...
    iput-wide v3, p0, mTimeoutElapsed:J
...
.method private sendStopMessageLocked(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0, p1}, closeAndCleanupJobLocked(ZLjava/lang/String;)V
    ...
    invoke-direct {p0, v1, v2}, closeAndCleanupJobLocked(ZLjava/lang/String;)V
...
.method private startTiming()V
    ...
    iput-wide v1, p0, startTime:J

    iget-object v1, p0, mRunningJob:Lcom/android/server/job/controllers/JobStatus;

    if-eqz v1, :cond_0

    invoke-static {v1}, Lcom/android/server/am/OpBGFrozenInjector;->isJobRestrict(Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    invoke-static {p0, v1}, Lcom/android/server/am/OpBGFrozenInjector;->startMonitoring(Lcom/android/server/job/JobServiceContext;Lcom/android/server/job/controllers/JobStatus;)V
...
.method private stopTiming()V
    ...
    iget-wide v3, p0, startTime:J

    sub-long/2addr v1, v3

    iget-boolean v3, p0, isMonitoring:Z

    if-eqz v3, :cond_0

    iget-object v3, p0, mRunningJob:Lcom/android/server/job/controllers/JobStatus;

    invoke-static {p0, v3}, Lcom/android/server/am/OpBGFrozenInjector;->stopMonitoring(Lcom/android/server/job/JobServiceContext;Lcom/android/server/job/controllers/JobStatus;)V
    ...
    invoke-static {}, Lcom/android/server/am/OpBGFrozenInjector;->getJobTimeout()J
    ...
    iget-object v5, p0, mRunningJob:Lcom/android/server/job/controllers/JobStatus;
    ...
    invoke-static {v0, v1, v2}, Lcom/android/server/am/OpBGFrozenInjector;->reportRestrictJob(Lcom/android/server/job/controllers/JobStatus;J)V
...
.method cancelExecutingJobLocked(ILjava/lang/String;)V
    ...
    invoke-virtual {p0, p1, p2}, doCancelLocked(ILjava/lang/String;)V
...
.method doAcknowledgeStartMessage(Lcom/android/server/job/JobServiceContext$JobCallback;IZ)V
    ...
    invoke-virtual {p0, p1, p3, v0}, doCallback(Lcom/android/server/job/JobServiceContext$JobCallback;ZLjava/lang/String;)V
...
.method doCallback(Lcom/android/server/job/JobServiceContext$JobCallback;ZLjava/lang/String;)V
    ...
    :cond_0
    :try_start_2
    invoke-virtual {p0, p2, p3}, doCallbackLocked(ZLjava/lang/String;)V
...
.method doCallbackLocked(ZLjava/lang/String;)V
    ...
    invoke-direct {p0, p1}, handleStartedLocked(Z)V
    ...
    :cond_3
    :goto_0
    invoke-direct {p0, p1, p2}, handleFinishedLocked(ZLjava/lang/String;)V
...
.method doCancelLocked(ILjava/lang/String;)V
    ...
    :cond_3
    invoke-direct {p0, p2}, handleCancelLocked(Ljava/lang/String;)V
...
.method doCompleteWork(Lcom/android/server/job/JobServiceContext$JobCallback;II)Z
    ...
    :try_start_1
    invoke-direct {p0, p1}, assertCallerLocked(Lcom/android/server/job/JobServiceContext$JobCallback;)V
...
.method doDequeueWork(Lcom/android/server/job/JobServiceContext$JobCallback;I)Landroid/app/job/JobWorkItem;
    ...
    iget-object v4, p0, mRunningJob:Lcom/android/server/job/controllers/JobStatus;
    ...
    invoke-virtual {p0, v4, v5}, doCallbackLocked(ZLjava/lang/String;)V
...
.method doServiceBoundLocked()V
    ...
    invoke-direct {p0}, handleServiceBoundLocked()V
...
.method executeRunnableJob(Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    :try_start_0
    iget-boolean v0, v1, mAvailable:Z
    ...
    iput v0, v1, mPreferredUid:I

    iput-object v2, v1, mRunningJob:Lcom/android/server/job/controllers/JobStatus;
    ...
    iput-object v0, v1, mRunningCallback:Lcom/android/server/job/JobServiceContext$JobCallback;
    ...
    iget-object v7, v1, mRunningCallback:Lcom/android/server/job/JobServiceContext$JobCallback;
    ...
    iput-object v0, v1, mParams:Landroid/app/job/JobParameters;
    ...
    iput-wide v6, v1, mExecutionStartTimeElapsed:J
    ...
    iget-wide v10, v1, mExecutionStartTimeElapsed:J
    ...
    invoke-direct/range {p0 .. p0}, scheduleOpTimeOutLocked()V
    ...
    :cond_5
    iput-object v12, v1, mRunningJob:Lcom/android/server/job/controllers/JobStatus;

    iput-object v12, v1, mRunningCallback:Lcom/android/server/job/JobServiceContext$JobCallback;

    iput-object v12, v1, mParams:Landroid/app/job/JobParameters;

    iput-wide v8, v1, mExecutionStartTimeElapsed:J

    const/4 v0, 0x4

    iput v0, v1, mVerb:I

    invoke-direct/range {p0 .. p0}, removeOpTimeOutLocked()V
    ...
    iget-wide v14, v1, mExecutionStartTimeElapsed:J
    ...
    iput-boolean v4, v1, mAvailable:Z

    iput-object v12, v1, mStoppedReason:Ljava/lang/String;

    const-wide/16 v14, 0x0

    iput-wide v14, v1, mStoppedTime:J
...
.method public onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    iput-object v3, p0, service:Landroid/app/job/IJobService;
    ...
    invoke-direct {p0, v1}, deriveWorkSource(Lcom/android/server/job/controllers/JobStatus;)Landroid/os/WorkSource;
    ...
    invoke-virtual {p0}, doServiceBoundLocked()V
    ...
    invoke-direct {p0, v2, v3}, closeAndCleanupJobLocked(ZLjava/lang/String;)V
...
.method preemptExecutingJobLocked()V
    ...
    invoke-virtual {p0, v0, v1}, doCancelLocked(ILjava/lang/String;)V
...
.method public restrictJob()V
    ...
    invoke-static {v0}, Lcom/android/server/am/OpBGFrozenInjector;->isJobRestrict(Lcom/android/server/job/controllers/JobStatus;)Z
...
.method timeoutIfExecutingLocked(Ljava/lang/String;IZILjava/lang/String;)Z
    ...
    invoke-virtual {p0}, getRunningJobLocked()Lcom/android/server/job/controllers/JobStatus;
    ...
    invoke-direct {p0, v1}, sendStopMessageLocked(Ljava/lang/String;)V
