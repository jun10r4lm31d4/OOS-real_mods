...
.method public constructor <init>()V
    ...
    iput v1, v0, MIN_IDLE_COUNT:I

    iput v1, v0, MIN_CHARGING_COUNT:I

    iput v1, v0, MIN_BATTERY_NOT_LOW_COUNT:I

    iput v1, v0, MIN_STORAGE_NOT_LOW_COUNT:I

    iput v1, v0, MIN_CONNECTIVITY_COUNT:I

    iput v1, v0, MIN_CONTENT_COUNT:I

    iput v1, v0, MIN_READY_JOBS_COUNT:I

    const v1, 0x3f666666    # 0.9f

    iput v1, v0, HEAVY_USE_FACTOR:F

    const/high16 v1, 0x3f000000    # 0.5f

    iput v1, v0, MODERATE_USE_FACTOR:F
    ...
    iput-object v2, v0, MAX_JOB_COUNTS_SCREEN_ON:Lcom/android/server/job/JobSchedulerService$MaxJobCountsPerMemoryTrimLevel;
    ...
    iput-object v2, v0, MAX_JOB_COUNTS_SCREEN_OFF:Lcom/android/server/job/JobSchedulerService$MaxJobCountsPerMemoryTrimLevel;
    ...
    iput-object v2, v0, SCREEN_OFF_JOB_CONCURRENCY_INCREASE_DELAY_MS:Landroid/util/KeyValueListParser$IntValue;

    const v2, 0x7fffffff

    iput v2, v0, MAX_STANDARD_RESCHEDULE_COUNT:I

    iput v2, v0, MAX_WORK_RESCHEDULE_COUNT:I

    const-wide/16 v2, 0x2710

    iput-wide v2, v0, MIN_LINEAR_BACKOFF_TIME:J

    iput-wide v2, v0, MIN_EXP_BACKOFF_TIME:J

    const-wide/32 v2, 0xa1220

    iput-wide v2, v0, STANDBY_HEARTBEAT_TIME:J
    ...
    iput-object v2, v0, STANDBY_BEATS:[I

    iput v1, v0, CONN_CONGESTION_DELAY_FRAC:F

    iput v1, v0, CONN_PREFETCH_RELAX_FRAC:F

    const/4 v1, 0x0

    iput-boolean v1, v0, USE_HEARTBEATS:Z
    ...
    iput-object v1, v0, mParser:Landroid/util/KeyValueListParser;
...
.method dump(Landroid/util/proto/ProtoOutputStream;)V
    ...
    iget v0, p0, MIN_IDLE_COUNT:I

    const-wide v1, 0x10500000001L

    invoke-virtual {p1, v1, v2, v0}, Landroid/util/proto/ProtoOutputStream;->write(JI)V

    iget v0, p0, MIN_CHARGING_COUNT:I

    const-wide v1, 0x10500000002L

    invoke-virtual {p1, v1, v2, v0}, Landroid/util/proto/ProtoOutputStream;->write(JI)V

    iget v0, p0, MIN_BATTERY_NOT_LOW_COUNT:I

    const-wide v1, 0x10500000003L

    invoke-virtual {p1, v1, v2, v0}, Landroid/util/proto/ProtoOutputStream;->write(JI)V

    iget v0, p0, MIN_STORAGE_NOT_LOW_COUNT:I

    const-wide v1, 0x10500000004L

    invoke-virtual {p1, v1, v2, v0}, Landroid/util/proto/ProtoOutputStream;->write(JI)V

    iget v0, p0, MIN_CONNECTIVITY_COUNT:I

    const-wide v1, 0x10500000005L

    invoke-virtual {p1, v1, v2, v0}, Landroid/util/proto/ProtoOutputStream;->write(JI)V

    iget v0, p0, MIN_CONTENT_COUNT:I

    const-wide v1, 0x10500000006L

    invoke-virtual {p1, v1, v2, v0}, Landroid/util/proto/ProtoOutputStream;->write(JI)V

    iget v0, p0, MIN_READY_JOBS_COUNT:I

    const-wide v1, 0x10500000007L

    invoke-virtual {p1, v1, v2, v0}, Landroid/util/proto/ProtoOutputStream;->write(JI)V

    iget v0, p0, HEAVY_USE_FACTOR:F

    const-wide v1, 0x10100000008L

    invoke-virtual {p1, v1, v2, v0}, Landroid/util/proto/ProtoOutputStream;->write(JF)V

    iget v0, p0, MODERATE_USE_FACTOR:F

    const-wide v1, 0x10100000009L

    invoke-virtual {p1, v1, v2, v0}, Landroid/util/proto/ProtoOutputStream;->write(JF)V

    iget-object v0, p0, MAX_JOB_COUNTS_SCREEN_ON:Lcom/android/server/job/JobSchedulerService$MaxJobCountsPerMemoryTrimLevel;
    ...
    iget-object v0, p0, MAX_JOB_COUNTS_SCREEN_OFF:Lcom/android/server/job/JobSchedulerService$MaxJobCountsPerMemoryTrimLevel;

    const-wide v1, 0x10b0000001bL

    invoke-virtual {v0, p1, v1, v2}, Lcom/android/server/job/JobSchedulerService$MaxJobCountsPerMemoryTrimLevel;->dumpProto(Landroid/util/proto/ProtoOutputStream;J)V

    iget-object v0, p0, SCREEN_OFF_JOB_CONCURRENCY_INCREASE_DELAY_MS:Landroid/util/KeyValueListParser$IntValue;
    ...
    iget v0, p0, MAX_STANDARD_RESCHEDULE_COUNT:I

    const-wide v1, 0x1050000000fL

    invoke-virtual {p1, v1, v2, v0}, Landroid/util/proto/ProtoOutputStream;->write(JI)V

    iget v0, p0, MAX_WORK_RESCHEDULE_COUNT:I

    const-wide v1, 0x10500000010L

    invoke-virtual {p1, v1, v2, v0}, Landroid/util/proto/ProtoOutputStream;->write(JI)V

    iget-wide v0, p0, MIN_LINEAR_BACKOFF_TIME:J

    const-wide v2, 0x10300000011L

    invoke-virtual {p1, v2, v3, v0, v1}, Landroid/util/proto/ProtoOutputStream;->write(JJ)V

    iget-wide v0, p0, MIN_EXP_BACKOFF_TIME:J

    const-wide v2, 0x10300000012L

    invoke-virtual {p1, v2, v3, v0, v1}, Landroid/util/proto/ProtoOutputStream;->write(JJ)V

    iget-wide v0, p0, STANDBY_HEARTBEAT_TIME:J

    const-wide v2, 0x10300000013L

    invoke-virtual {p1, v2, v3, v0, v1}, Landroid/util/proto/ProtoOutputStream;->write(JJ)V

    iget-object v0, p0, STANDBY_BEATS:[I
...
.method dump(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    :goto_0
    iget-object v1, p0, STANDBY_BEATS:[I
    ...
    iget v0, p0, CONN_CONGESTION_DELAY_FRAC:F
    ...
    iget v0, p0, CONN_PREFETCH_RELAX_FRAC:F
    ...
    iget-boolean v0, p0, USE_HEARTBEATS:Z
...
.method updateConstantsLocked(Ljava/lang/String;)V
    ...
    iput v0, p0, MIN_CHARGING_COUNT:I
    ...
    iput v0, p0, MIN_BATTERY_NOT_LOW_COUNT:I
    ...
    iput v0, p0, MIN_STORAGE_NOT_LOW_COUNT:I
    ...
    iput v0, p0, MIN_CONNECTIVITY_COUNT:I
    ...
    iput v0, p0, MIN_CONTENT_COUNT:I
    ...
    iput v0, p0, MIN_READY_JOBS_COUNT:I
    ...
    iput v0, p0, MODERATE_USE_FACTOR:F
    ...
    iput v0, p0, MAX_STANDARD_RESCHEDULE_COUNT:I
    ...
    iput v0, p0, MAX_WORK_RESCHEDULE_COUNT:I
    ...
    iput-wide v5, p0, MIN_LINEAR_BACKOFF_TIME:J
    ...
    iput-wide v3, p0, MIN_EXP_BACKOFF_TIME:J
    ...
    iput-wide v3, p0, STANDBY_HEARTBEAT_TIME:J
    ...
    iput v0, p0, CONN_CONGESTION_DELAY_FRAC:F
    ...
    iput v0, p0, CONN_PREFETCH_RELAX_FRAC:F
    ...
    iput-boolean v0, p0, USE_HEARTBEATS:Z
