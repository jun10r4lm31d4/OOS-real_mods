...
.method constructor <init>(Lcom/android/server/job/controllers/QuotaController;Landroid/os/Handler;)V
    ...
    iput-wide v0, p0, ALLOWED_TIME_PER_PERIOD_MS:J

    const-wide/16 v2, 0x7530

    iput-wide v2, p0, IN_QUOTA_BUFFER_MS:J

    iput-wide v0, p0, WINDOW_SIZE_ACTIVE_MS:J

    const-wide/32 v2, 0x6ddd00

    iput-wide v2, p0, WINDOW_SIZE_WORKING_MS:J

    iput-wide v2, p0, WINDOW_SIZE_FREQUENT_MS:J

    const-wide/32 v2, 0x5265c00

    iput-wide v2, p0, WINDOW_SIZE_RARE_MS:J

    const-wide/32 v2, 0xdbba00

    iput-wide v2, p0, MAX_EXECUTION_TIME_MS:J

    const/16 v2, 0x14

    iput v2, p0, MAX_JOB_COUNT_ACTIVE:I

    const/16 v3, 0x78

    iput v3, p0, MAX_JOB_COUNT_WORKING:I

    const/16 v3, 0x32

    iput v3, p0, MAX_JOB_COUNT_FREQUENT:I

    const/16 v3, 0x30

    iput v3, p0, MAX_JOB_COUNT_RARE:I

    iput-wide v0, p0, RATE_LIMITING_WINDOW_MS:J

    iput v2, p0, MAX_JOB_COUNT_PER_RATE_LIMITING_WINDOW:I

    iput v2, p0, MAX_SESSION_COUNT_ACTIVE:I

    const/16 v0, 0xa

    iput v0, p0, MAX_SESSION_COUNT_WORKING:I

    const/4 v0, 0x1

    iput v0, p0, MAX_SESSION_COUNT_FREQUENT:I

    const/4 v0, 0x3

    iput v0, p0, MAX_SESSION_COUNT_RARE:I

    iput v2, p0, MAX_SESSION_COUNT_PER_RATE_LIMITING_WINDOW:I

    const-wide/16 v0, 0x1388

    iput-wide v0, p0, TIMING_SESSION_COALESCING_DURATION_MS:J
...
.method private dump(Landroid/util/proto/ProtoOutputStream;)V
    ...
    iget-wide v2, p0, ALLOWED_TIME_PER_PERIOD_MS:J

    const-wide v4, 0x10300000001L

    invoke-virtual {p1, v4, v5, v2, v3}, Landroid/util/proto/ProtoOutputStream;->write(JJ)V

    iget-wide v2, p0, IN_QUOTA_BUFFER_MS:J

    const-wide v4, 0x10300000002L

    invoke-virtual {p1, v4, v5, v2, v3}, Landroid/util/proto/ProtoOutputStream;->write(JJ)V

    iget-wide v2, p0, WINDOW_SIZE_ACTIVE_MS:J

    const-wide v4, 0x10300000003L

    invoke-virtual {p1, v4, v5, v2, v3}, Landroid/util/proto/ProtoOutputStream;->write(JJ)V

    iget-wide v2, p0, WINDOW_SIZE_WORKING_MS:J

    const-wide v4, 0x10300000004L

    invoke-virtual {p1, v4, v5, v2, v3}, Landroid/util/proto/ProtoOutputStream;->write(JJ)V

    iget-wide v2, p0, WINDOW_SIZE_FREQUENT_MS:J

    const-wide v4, 0x10300000005L

    invoke-virtual {p1, v4, v5, v2, v3}, Landroid/util/proto/ProtoOutputStream;->write(JJ)V

    iget-wide v2, p0, WINDOW_SIZE_RARE_MS:J

    const-wide v4, 0x10300000006L

    invoke-virtual {p1, v4, v5, v2, v3}, Landroid/util/proto/ProtoOutputStream;->write(JJ)V

    iget-wide v2, p0, MAX_EXECUTION_TIME_MS:J

    const-wide v4, 0x10300000007L

    invoke-virtual {p1, v4, v5, v2, v3}, Landroid/util/proto/ProtoOutputStream;->write(JJ)V

    iget v2, p0, MAX_JOB_COUNT_ACTIVE:I

    const-wide v3, 0x10500000008L

    invoke-virtual {p1, v3, v4, v2}, Landroid/util/proto/ProtoOutputStream;->write(JI)V

    iget v2, p0, MAX_JOB_COUNT_WORKING:I

    const-wide v3, 0x10500000009L

    invoke-virtual {p1, v3, v4, v2}, Landroid/util/proto/ProtoOutputStream;->write(JI)V

    iget v2, p0, MAX_JOB_COUNT_FREQUENT:I

    const-wide v3, 0x1050000000aL

    invoke-virtual {p1, v3, v4, v2}, Landroid/util/proto/ProtoOutputStream;->write(JI)V

    iget v2, p0, MAX_JOB_COUNT_RARE:I

    const-wide v3, 0x1050000000bL

    invoke-virtual {p1, v3, v4, v2}, Landroid/util/proto/ProtoOutputStream;->write(JI)V

    iget-wide v2, p0, RATE_LIMITING_WINDOW_MS:J

    const-wide v4, 0x10500000013L

    invoke-virtual {p1, v4, v5, v2, v3}, Landroid/util/proto/ProtoOutputStream;->write(JJ)V

    iget v2, p0, MAX_JOB_COUNT_PER_RATE_LIMITING_WINDOW:I

    const-wide v3, 0x1050000000cL

    invoke-virtual {p1, v3, v4, v2}, Landroid/util/proto/ProtoOutputStream;->write(JI)V

    iget v2, p0, MAX_SESSION_COUNT_ACTIVE:I

    const-wide v3, 0x1050000000dL

    invoke-virtual {p1, v3, v4, v2}, Landroid/util/proto/ProtoOutputStream;->write(JI)V

    iget v2, p0, MAX_SESSION_COUNT_WORKING:I

    const-wide v3, 0x1050000000eL

    invoke-virtual {p1, v3, v4, v2}, Landroid/util/proto/ProtoOutputStream;->write(JI)V

    iget v2, p0, MAX_SESSION_COUNT_FREQUENT:I

    const-wide v3, 0x1050000000fL

    invoke-virtual {p1, v3, v4, v2}, Landroid/util/proto/ProtoOutputStream;->write(JI)V

    iget v2, p0, MAX_SESSION_COUNT_RARE:I

    const-wide v3, 0x10500000010L

    invoke-virtual {p1, v3, v4, v2}, Landroid/util/proto/ProtoOutputStream;->write(JI)V

    iget v2, p0, MAX_SESSION_COUNT_PER_RATE_LIMITING_WINDOW:I

    const-wide v3, 0x10500000011L

    invoke-virtual {p1, v3, v4, v2}, Landroid/util/proto/ProtoOutputStream;->write(JI)V

    iget-wide v2, p0, TIMING_SESSION_COALESCING_DURATION_MS:J
...
.method private dump(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    iget-wide v0, p0, ALLOWED_TIME_PER_PERIOD_MS:J
    ...
    iget-wide v0, p0, IN_QUOTA_BUFFER_MS:J
    ...
    iget-wide v0, p0, WINDOW_SIZE_ACTIVE_MS:J
    ...
    iget-wide v0, p0, WINDOW_SIZE_WORKING_MS:J
    ...
    iget-wide v0, p0, WINDOW_SIZE_FREQUENT_MS:J
    ...
    iget-wide v0, p0, WINDOW_SIZE_RARE_MS:J
    ...
    iget-wide v0, p0, MAX_EXECUTION_TIME_MS:J
    ...
    iget v0, p0, MAX_JOB_COUNT_ACTIVE:I
    ...
    iget v0, p0, MAX_JOB_COUNT_WORKING:I
    ...
    iget v0, p0, MAX_JOB_COUNT_FREQUENT:I
    ...
    iget v0, p0, MAX_JOB_COUNT_RARE:I
    ...
    iget-wide v0, p0, RATE_LIMITING_WINDOW_MS:J
    ...
    iget v0, p0, MAX_JOB_COUNT_PER_RATE_LIMITING_WINDOW:I
    ...
    iget v0, p0, MAX_SESSION_COUNT_ACTIVE:I
    ...
    iget v0, p0, MAX_SESSION_COUNT_WORKING:I
    ...
    iget v0, p0, MAX_SESSION_COUNT_FREQUENT:I
    ...
    iget v0, p0, MAX_SESSION_COUNT_RARE:I
    ...
    iget v0, p0, MAX_SESSION_COUNT_PER_RATE_LIMITING_WINDOW:I
    ...
    iget-wide v0, p0, TIMING_SESSION_COALESCING_DURATION_MS:J
...
.method private start(Landroid/content/ContentResolver;)V
    ...
    invoke-virtual {p0}, updateConstants()V
...
.method public synthetic lambda$updateConstants$0$QuotaController$QcConstants()V
    ...
    iget-object v0, p0, this$0:Lcom/android/server/job/controllers/QuotaController;
    ...
    :try_start_0
    iget-object v1, p0, this$0:Lcom/android/server/job/controllers/QuotaController;
...
.method public onChange(ZLandroid/net/Uri;)V
    ...
    iput-wide v4, p0, ALLOWED_TIME_PER_PERIOD_MS:J
    ...
    iput-wide v4, p0, IN_QUOTA_BUFFER_MS:J
    ...
    iput-wide v4, p0, WINDOW_SIZE_ACTIVE_MS:J
    ...
    iput-wide v6, p0, WINDOW_SIZE_WORKING_MS:J
    ...
    iput-wide v4, p0, WINDOW_SIZE_FREQUENT_MS:J
    ...
    iput-wide v4, p0, WINDOW_SIZE_RARE_MS:J
    ...
    iput-wide v4, p0, MAX_EXECUTION_TIME_MS:J
    ...
    iput v1, p0, MAX_JOB_COUNT_ACTIVE:I
    ...
    iput v1, p0, MAX_JOB_COUNT_WORKING:I
    ...
    iput v1, p0, MAX_JOB_COUNT_FREQUENT:I
    ...
    iput v1, p0, MAX_JOB_COUNT_RARE:I
    ...
    iput-wide v1, p0, RATE_LIMITING_WINDOW_MS:J
    ...
    iput v1, p0, MAX_JOB_COUNT_PER_RATE_LIMITING_WINDOW:I
    ...
    iput v1, p0, MAX_SESSION_COUNT_ACTIVE:I
    ...
    iput v1, p0, MAX_SESSION_COUNT_WORKING:I
    ...
    iput v1, p0, MAX_SESSION_COUNT_FREQUENT:I
    ...
    iput v1, p0, MAX_SESSION_COUNT_RARE:I
    ...
    iput v1, p0, MAX_SESSION_COUNT_PER_RATE_LIMITING_WINDOW:I
    ...
    iput-wide v1, p0, TIMING_SESSION_COALESCING_DURATION_MS:J
...
.method updateConstants()V
    ...
    iget-object v0, v1, this$0:Lcom/android/server/job/controllers/QuotaController;
    ...
    :try_start_0
    iget-wide v5, v1, MAX_EXECUTION_TIME_MS:J
    ...
    iget-object v5, v1, this$0:Lcom/android/server/job/controllers/QuotaController;
    ...
    iget-object v6, v1, this$0:Lcom/android/server/job/controllers/QuotaController;
    ...
    iget-wide v11, v1, ALLOWED_TIME_PER_PERIOD_MS:J
    ...
    iget-object v9, v1, this$0:Lcom/android/server/job/controllers/QuotaController;
    ...
    iget-object v10, v1, this$0:Lcom/android/server/job/controllers/QuotaController;
    ...
    iget-object v12, v1, this$0:Lcom/android/server/job/controllers/QuotaController;
    ...
    iget-wide v11, v1, IN_QUOTA_BUFFER_MS:J
    ...
    iget-object v13, v1, this$0:Lcom/android/server/job/controllers/QuotaController;
    ...
    iget-object v14, v1, this$0:Lcom/android/server/job/controllers/QuotaController;
    ...
    iget-object v11, v1, this$0:Lcom/android/server/job/controllers/QuotaController;
    ...
    iget-wide v13, v1, WINDOW_SIZE_ACTIVE_MS:J
    ...
    iget-wide v7, v1, WINDOW_SIZE_WORKING_MS:J
    ...
    iget-object v7, v1, this$0:Lcom/android/server/job/controllers/QuotaController;
    ...
    iget-wide v8, v1, WINDOW_SIZE_FREQUENT_MS:J
    ...
    iget-object v8, v1, this$0:Lcom/android/server/job/controllers/QuotaController;
    ...
    iget-wide v7, v1, WINDOW_SIZE_RARE_MS:J
    ...
    iget-wide v8, v1, RATE_LIMITING_WINDOW_MS:J
    ...
    :cond_7
    iget v7, v1, MAX_JOB_COUNT_PER_RATE_LIMITING_WINDOW:I
    ...
    :cond_8
    iget v7, v1, MAX_JOB_COUNT_ACTIVE:I
    ...
    :cond_9
    iget v12, v1, MAX_JOB_COUNT_WORKING:I

    invoke-static {v13, v12}, Ljava/lang/Math;->max(II)I

    move-result v12

    iget-object v15, v1, this$0:Lcom/android/server/job/controllers/QuotaController;
    ...
    :cond_a
    iget v15, v1, MAX_JOB_COUNT_FREQUENT:I
    ...
    :cond_b
    iget v7, v1, MAX_JOB_COUNT_RARE:I
    ...
    :cond_c
    iget v13, v1, MAX_SESSION_COUNT_PER_RATE_LIMITING_WINDOW:I
    ...
    :cond_d
    iget v13, v1, MAX_SESSION_COUNT_ACTIVE:I
    ...
    :cond_e
    iget v7, v1, MAX_SESSION_COUNT_WORKING:I
    ...
    :cond_f
    iget v0, v1, MAX_SESSION_COUNT_FREQUENT:I
    ...
    iget-object v4, v1, this$0:Lcom/android/server/job/controllers/QuotaController;
    ...
    :cond_10
    iget v4, v1, MAX_SESSION_COUNT_RARE:I
    ...
    iget-wide v3, v1, TIMING_SESSION_COALESCING_DURATION_MS:J
