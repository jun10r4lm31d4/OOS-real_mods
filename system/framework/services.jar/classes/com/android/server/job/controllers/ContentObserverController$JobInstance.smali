...
.method constructor <init>(Lcom/android/server/job/controllers/ContentObserverController;Lcom/android/server/job/controllers/JobStatus;)V
    ...
    iput-object v1, v0, this$0:Lcom/android/server/job/controllers/ContentObserverController;
    ...
    iput-object v2, v0, mMyObservers:Ljava/util/ArrayList;

    move-object/from16 v2, p2

    iput-object v2, v0, mJobStatus:Lcom/android/server/job/controllers/JobStatus;
    ...
    iput-object v3, v0, mExecuteRunner:Ljava/lang/Runnable;

    new-instance v3, Lcom/android/server/job/controllers/ContentObserverController$TriggerRunnable;

    invoke-direct {v3, v0}, Lcom/android/server/job/controllers/ContentObserverController$TriggerRunnable;-><init>(Lcom/android/server/job/controllers/ContentObserverController$JobInstance;)V

    iput-object v3, v0, mTimeoutRunner:Ljava/lang/Runnable;
    ...
    iget-object v7, v0, mMyObservers:Ljava/util/ArrayList;
...
.method detachLocked()V
    ...
    iget-object v0, p0, mMyObservers:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, mMyObservers:Ljava/util/ArrayList;
    ...
    :cond_0
    iget-object v3, p0, this$0:Lcom/android/server/job/controllers/ContentObserverController;
...
.method scheduleLocked()V
    ...
    iget-boolean v0, p0, mTriggerPending:Z

    if-nez v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, p0, mTriggerPending:Z

    iget-object v0, p0, this$0:Lcom/android/server/job/controllers/ContentObserverController;

    iget-object v0, v0, Lcom/android/server/job/controllers/ContentObserverController;->mHandler:Landroid/os/Handler;

    iget-object v1, p0, mTimeoutRunner:Ljava/lang/Runnable;

    iget-object v2, p0, mJobStatus:Lcom/android/server/job/controllers/JobStatus;
    ...
    iget-object v1, p0, mExecuteRunner:Ljava/lang/Runnable;

    invoke-virtual {v0, v1}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    iget-object v0, p0, mChangedUris:Landroid/util/ArraySet;
...
.method trigger()V
    ...
    iget-object v1, p0, this$0:Lcom/android/server/job/controllers/ContentObserverController;
    ...
    :try_start_0
    iget-boolean v2, p0, mTriggerPending:Z
    ...
    :cond_0
    invoke-virtual {p0}, unscheduleLocked()V
