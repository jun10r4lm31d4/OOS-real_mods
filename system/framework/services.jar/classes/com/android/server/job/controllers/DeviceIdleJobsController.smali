...
.method public constructor <init>(Lcom/android/server/job/JobSchedulerService;)V
    ...
    iput-object v0, p0, mHandler:Lcom/android/server/job/controllers/DeviceIdleJobsController$DeviceIdleJobsDelayHandler;
    ...
    iput-object v0, p0, mLocalDeviceIdleController:Lcom/android/server/DeviceIdleController$LocalService;

    iget-object v0, p0, mLocalDeviceIdleController:Lcom/android/server/DeviceIdleController$LocalService;

    invoke-virtual {v0}, Lcom/android/server/DeviceIdleController$LocalService;->getPowerSaveWhitelistUserAppIds()[I

    move-result-object v0

    iput-object v0, p0, mDeviceIdleWhitelistAppIds:[I
    ...
    iput-object v0, p0, mPowerSaveTempWhitelistAppIds:[I
    ...
    iput-object v0, p0, mDeviceIdleUpdateFunctor:Lcom/android/server/job/controllers/DeviceIdleJobsController$DeviceIdleUpdateFunctor;

    new-instance v0, Landroid/util/ArraySet;

    invoke-direct {v0}, Landroid/util/ArraySet;-><init>()V

    iput-object v0, p0, mAllowInIdleJobs:Landroid/util/ArraySet;
...
.method static synthetic access$100(Lcom/android/server/job/controllers/DeviceIdleJobsController;)[I
    ...
    iget-object v0, p0, mDeviceIdleWhitelistAppIds:[I
...
.method static synthetic access$102(Lcom/android/server/job/controllers/DeviceIdleJobsController;[I)[I
    ...
    iput-object p1, p0, mDeviceIdleWhitelistAppIds:[I
...
.method static synthetic access$400(Lcom/android/server/job/controllers/DeviceIdleJobsController;)[I
    ...
    iget-object v0, p0, mPowerSaveTempWhitelistAppIds:[I
...
.method static synthetic access$402(Lcom/android/server/job/controllers/DeviceIdleJobsController;[I)[I
    ...
    iput-object p1, p0, mPowerSaveTempWhitelistAppIds:[I
...
.method static synthetic access$500(Lcom/android/server/job/controllers/DeviceIdleJobsController;)Landroid/util/ArraySet;
    ...
    iget-object v0, p0, mAllowInIdleJobs:Landroid/util/ArraySet;
...
.method static synthetic access$600(Lcom/android/server/job/controllers/DeviceIdleJobsController;Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    invoke-direct {p0, p1}, updateTaskStateLocked(Lcom/android/server/job/controllers/JobStatus;)Z
...
.method static synthetic access$700(Lcom/android/server/job/controllers/DeviceIdleJobsController;)Lcom/android/server/job/controllers/DeviceIdleJobsController$DeviceIdleUpdateFunctor;
    ...
    iget-object v0, p0, mDeviceIdleUpdateFunctor:Lcom/android/server/job/controllers/DeviceIdleJobsController$DeviceIdleUpdateFunctor;
...
.method private updateTaskStateLocked(Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    invoke-virtual {p0, p1}, isTempWhitelistedLocked(Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    :goto_0
    invoke-virtual {p0, p1}, isWhitelistedLocked(Lcom/android/server/job/controllers/JobStatus;)Z

    move-result v3

    iget-boolean v4, p0, mDeviceIdleMode:Z
...
.method public dumpControllerStateLocked(Landroid/util/proto/ProtoOutputStream;JLjava/util/function/Predicate;)V
    ...
    iget-object v4, p0, mService:Lcom/android/server/job/JobSchedulerService;
...
.method public synthetic lambda$dumpControllerStateLocked$1$DeviceIdleJobsController(Landroid/util/proto/ProtoOutputStream;Lcom/android/server/job/controllers/JobStatus;)V
    ...
    iget-object v4, p0, mAllowInIdleJobs:Landroid/util/ArraySet;
...
.method public setUidActiveLocked(IZ)V
    ...
    :cond_3
    iget-object v2, p0, mForegroundUids:Landroid/util/SparseBooleanArray;

    invoke-virtual {v2, p1, p2}, Landroid/util/SparseBooleanArray;->put(IZ)V

    iget-object v2, p0, mDeviceIdleUpdateFunctor:Lcom/android/server/job/controllers/DeviceIdleJobsController$DeviceIdleUpdateFunctor;
    ...
    iget-object v1, p0, mDeviceIdleUpdateFunctor:Lcom/android/server/job/controllers/DeviceIdleJobsController$DeviceIdleUpdateFunctor;
...
.method updateIdleMode(Z)V
    ...
    iget-object v3, p0, mHandler:Lcom/android/server/job/controllers/DeviceIdleJobsController$DeviceIdleJobsDelayHandler;
    ...
    iget-object v2, p0, mService:Lcom/android/server/job/JobSchedulerService;

    invoke-virtual {v2}, Lcom/android/server/job/JobSchedulerService;->getJobStore()Lcom/android/server/job/JobStore;

    move-result-object v2

    iget-object v3, p0, mDeviceIdleUpdateFunctor:Lcom/android/server/job/controllers/DeviceIdleJobsController$DeviceIdleUpdateFunctor;
    ...
    :goto_0
    iget-object v4, p0, mForegroundUids:Landroid/util/SparseBooleanArray;
    ...
    iget-object v5, p0, mForegroundUids:Landroid/util/SparseBooleanArray;

    invoke-virtual {v5, v3}, Landroid/util/SparseBooleanArray;->keyAt(I)I

    move-result v5

    iget-object v6, p0, mDeviceIdleUpdateFunctor:Lcom/android/server/job/controllers/DeviceIdleJobsController$DeviceIdleUpdateFunctor;
