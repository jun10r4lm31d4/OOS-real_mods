...
.method private constructor <init>(Landroid/content/Context;Ljava/lang/Object;Ljava/io/File;)V
    ...
    iput-object v0, p0, mPersistInfo:Lcom/android/server/job/JobSchedulerInternal$JobStorePersistStats;
    ...
    iput-object v0, p0, mWriteRunnable:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mWriteScheduleLock:Ljava/lang/Object;
    ...
    iput-object v2, p0, mJobSet:Lcom/android/server/job/JobStore$JobSet;

    iget-object v2, p0, mJobsFile:Landroid/util/AtomicFile;

    invoke-virtual {v2}, Landroid/util/AtomicFile;->getLastModifiedTime()J

    move-result-wide v2

    iput-wide v2, p0, mXmlTimestamp:J
    ...
    iget-wide v4, p0, mXmlTimestamp:J
    ...
    :goto_0
    iput-boolean v2, p0, mRtcGood:Z

    iget-object v2, p0, mJobSet:Lcom/android/server/job/JobStore$JobSet;

    iget-boolean v3, p0, mRtcGood:Z

    invoke-virtual {p0, v2, v3}, readJobMapFromDisk(Lcom/android/server/job/JobStore$JobSet;Z)V
...
.method static synthetic access$002(Lcom/android/server/job/JobStore;Z)Z
    ...
    iput-boolean p1, p0, mWriteScheduled:Z
...
.method static synthetic access$202(Lcom/android/server/job/JobStore;Z)Z
    ...
    iput-boolean p1, p0, mWriteInProgress:Z
...
.method static synthetic access$300(Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    invoke-static {p0}, isSyncJob(Lcom/android/server/job/controllers/JobStatus;)Z
...
.method static synthetic access$500(Lcom/android/server/job/JobStore;)Lcom/android/server/job/JobSchedulerInternal$JobStorePersistStats;
    ...
    iget-object v0, p0, mPersistInfo:Lcom/android/server/job/JobSchedulerInternal$JobStorePersistStats;
...
.method static synthetic access$600(Landroid/util/Pair;J)Landroid/util/Pair;
    ...
    invoke-static {p0, p1, p2}, convertRtcBoundsToElapsed(Landroid/util/Pair;J)Landroid/util/Pair;
...
.method static initAndGet(Lcom/android/server/job/JobSchedulerService;)Lcom/android/server/job/JobStore;
    ...
    sget-object v0, sSingletonLock:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    sget-object v1, sSingleton:Lcom/android/server/job/JobStore;
    ...
    invoke-direct {v1, v2, v3, v4}, <init>(Landroid/content/Context;Ljava/lang/Object;Ljava/io/File;)V

    sput-object v1, sSingleton:Lcom/android/server/job/JobStore;
...
.method public static initAndGetForTesting(Landroid/content/Context;Ljava/io/File;)Lcom/android/server/job/JobStore;
    ...
    invoke-direct {v0, p0, v1, p1}, <init>(Landroid/content/Context;Ljava/lang/Object;Ljava/io/File;)V
...
.method static synthetic lambda$getRtcCorrectedJobsLocked$0(JLandroid/app/IActivityManager;Ljava/util/ArrayList;Ljava/util/ArrayList;Lcom/android/server/job/controllers/JobStatus;)V
    ...
    invoke-static {v0, v1, v2}, convertRtcBoundsToElapsed(Landroid/util/Pair;J)Landroid/util/Pair;
...
.method private maybeWriteStatusToDiskAsync()V
    ...
    iget-object v0, p0, mWriteScheduleLock:Ljava/lang/Object;
    ...
    iget-object v2, p0, mWriteRunnable:Ljava/lang/Runnable;
    ...
    iput-boolean v1, p0, mWriteInProgress:Z
...
.method public add(Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    iget-object v0, p0, mJobSet:Lcom/android/server/job/JobStore$JobSet;

    invoke-virtual {v0, p1}, Lcom/android/server/job/JobStore$JobSet;->remove(Lcom/android/server/job/controllers/JobStatus;)Z

    move-result v0

    iget-object v1, p0, mJobSet:Lcom/android/server/job/JobStore$JobSet;
...
.method public clockNowValidToInflate(J)Z
    ...
    iget-wide v0, p0, mXmlTimestamp:J
...
.method public getRtcCorrectedJobsLocked(Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {p0, v9}, forEachJob(Ljava/util/function/Consumer;)V
...
.method public waitForWriteToCompleteForTesting(J)Z
    ...
    iget-object v4, p0, mWriteScheduleLock:Ljava/lang/Object;

    monitor-enter v4

    :goto_0
    :try_start_0
    iget-boolean v5, p0, mWriteInProgress:Z
    ...
    :cond_0
    :try_start_1
    iget-object v7, p0, mWriteScheduleLock:Ljava/lang/Object;
