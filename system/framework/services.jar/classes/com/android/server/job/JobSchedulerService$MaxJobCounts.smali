...
.method constructor <init>(ILjava/lang/String;ILjava/lang/String;ILjava/lang/String;)V
    ...
    iput-object v0, p0, mTotal:Landroid/util/KeyValueListParser$IntValue;

    new-instance v0, Landroid/util/KeyValueListParser$IntValue;

    invoke-direct {v0, p4, p3}, Landroid/util/KeyValueListParser$IntValue;-><init>(Ljava/lang/String;I)V

    iput-object v0, p0, mMaxBg:Landroid/util/KeyValueListParser$IntValue;

    new-instance v0, Landroid/util/KeyValueListParser$IntValue;

    invoke-direct {v0, p6, p5}, Landroid/util/KeyValueListParser$IntValue;-><init>(Ljava/lang/String;I)V

    iput-object v0, p0, mMinBg:Landroid/util/KeyValueListParser$IntValue;
...
.method public dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    iget-object v0, p0, mTotal:Landroid/util/KeyValueListParser$IntValue;

    invoke-virtual {v0, p1, p2}, Landroid/util/KeyValueListParser$IntValue;->dump(Ljava/io/PrintWriter;Ljava/lang/String;)V

    iget-object v0, p0, mMaxBg:Landroid/util/KeyValueListParser$IntValue;

    invoke-virtual {v0, p1, p2}, Landroid/util/KeyValueListParser$IntValue;->dump(Ljava/io/PrintWriter;Ljava/lang/String;)V

    iget-object v0, p0, mMinBg:Landroid/util/KeyValueListParser$IntValue;
...
.method public dumpProto(Landroid/util/proto/ProtoOutputStream;J)V
    ...
    iget-object v2, p0, mTotal:Landroid/util/KeyValueListParser$IntValue;
    ...
    iget-object v2, p0, mMaxBg:Landroid/util/KeyValueListParser$IntValue;

    const-wide v3, 0x10500000002L

    invoke-virtual {v2, p1, v3, v4}, Landroid/util/KeyValueListParser$IntValue;->dumpProto(Landroid/util/proto/ProtoOutputStream;J)V

    iget-object v2, p0, mMinBg:Landroid/util/KeyValueListParser$IntValue;
