...
.method constructor <init>(Lcom/android/server/job/JobStore;Lcom/android/server/job/JobStore$JobSet;Z)V
    ...
    iput-object p2, p0, jobSet:Lcom/android/server/job/JobStore$JobSet;

    iput-boolean p3, p0, rtcGood:Z
...
.method private readJobMapImpl(Ljava/io/FileInputStream;Z)Ljava/util/List;
    ...
    invoke-direct {p0, p2, v1}, restoreJobFromXml(ZLorg/xmlpull/v1/XmlPullParser;)Lcom/android/server/job/controllers/JobStatus;
...
.method private restoreJobFromXml(ZLorg/xmlpull/v1/XmlPullParser;)Lcom/android/server/job/controllers/JobStatus;
    ...
    :try_start_0
    invoke-direct {v1, v2}, buildBuilderFromXml(Lorg/xmlpull/v1/XmlPullParser;)Landroid/app/job/JobInfo$Builder;
    ...
    :cond_6
    :try_start_2
    invoke-direct {v1, v6, v2}, buildConstraintsFromXml(Landroid/app/job/JobInfo$Builder;Lorg/xmlpull/v1/XmlPullParser;)V
    :try_end_2
    ...
    :cond_7
    :try_start_3
    invoke-direct {v1, v2}, buildRtcExecutionTimesFromXml(Lorg/xmlpull/v1/XmlPullParser;)Landroid/util/Pair;
    ...
    invoke-direct {v8, v6, v2}, maybeBuildBackoffPolicyFromXml(Landroid/app/job/JobInfo$Builder;Lorg/xmlpull/v1/XmlPullParser;)V
...
.method public run()V
    ...
    :try_start_1
    iget-boolean v5, p0, rtcGood:Z

    invoke-direct {p0, v3, v5}, readJobMapImpl(Ljava/io/FileInputStream;Z)Ljava/util/List;
    ...
    iget-object v11, p0, jobSet:Lcom/android/server/job/JobStore$JobSet;
