...
.method private constructor <init>(Landroid/app/IActivityManager;IILjava/lang/String;)V
    ...
    iput-object v0, p0, mUris:Ljava/util/ArrayList;

    iput p2, p0, mGrantFlags:I

    invoke-static {p3}, Landroid/os/UserHandle;->getUserId(I)I

    move-result v0

    iput v0, p0, mSourceUserId:I
...
.method public static createFromClip(Landroid/app/IActivityManager;Landroid/content/ClipData;ILjava/lang/String;IILjava/lang/String;)Lcom/android/server/job/GrantedUriPermissions;
    ...
    invoke-static {p5}, checkGrantFlags(I)Z
    ...
    invoke-static/range {v1 .. v8}, grantClip(Landroid/app/IActivityManager;Landroid/content/ClipData;ILjava/lang/String;IILjava/lang/String;Lcom/android/server/job/GrantedUriPermissions;)Lcom/android/server/job/GrantedUriPermissions;
...
.method public static createFromIntent(Landroid/app/IActivityManager;Landroid/content/Intent;ILjava/lang/String;ILjava/lang/String;)Lcom/android/server/job/GrantedUriPermissions;
    ...
    invoke-static {v8}, checkGrantFlags(I)Z
    ...
    invoke-static/range {v0 .. v7}, grantUri(Landroid/app/IActivityManager;Landroid/net/Uri;ILjava/lang/String;IILjava/lang/String;Lcom/android/server/job/GrantedUriPermissions;)Lcom/android/server/job/GrantedUriPermissions;
    ...
    invoke-static/range {v0 .. v7}, grantClip(Landroid/app/IActivityManager;Landroid/content/ClipData;ILjava/lang/String;IILjava/lang/String;Lcom/android/server/job/GrantedUriPermissions;)Lcom/android/server/job/GrantedUriPermissions;
...
.method private static grantClip(Landroid/app/IActivityManager;Landroid/content/ClipData;ILjava/lang/String;IILjava/lang/String;Lcom/android/server/job/GrantedUriPermissions;)Lcom/android/server/job/GrantedUriPermissions;
    ...
    invoke-static/range {v2 .. v9}, grantItem(Landroid/app/IActivityManager;Landroid/content/ClipData$Item;ILjava/lang/String;IILjava/lang/String;Lcom/android/server/job/GrantedUriPermissions;)Lcom/android/server/job/GrantedUriPermissions;
...
.method private static grantItem(Landroid/app/IActivityManager;Landroid/content/ClipData$Item;ILjava/lang/String;IILjava/lang/String;Lcom/android/server/job/GrantedUriPermissions;)Lcom/android/server/job/GrantedUriPermissions;
    ...
    invoke-static/range {v1 .. v8}, grantUri(Landroid/app/IActivityManager;Landroid/net/Uri;ILjava/lang/String;IILjava/lang/String;Lcom/android/server/job/GrantedUriPermissions;)Lcom/android/server/job/GrantedUriPermissions;
...
.method private static grantUri(Landroid/app/IActivityManager;Landroid/net/Uri;ILjava/lang/String;IILjava/lang/String;Lcom/android/server/job/GrantedUriPermissions;)Lcom/android/server/job/GrantedUriPermissions;
    ...
    :try_start_3
    invoke-direct {v0, p0, v12, v11, v13}, <init>(Landroid/app/IActivityManager;IILjava/lang/String;)V
    :try_end_3
    ...
    iget-object v3, v14, mPermissionOwner:Landroid/os/IBinder;
    ...
    iget-object v0, v14, mUris:Ljava/util/ArrayList;
...
.method public dump(Landroid/util/proto/ProtoOutputStream;J)V
    ...
    iget v2, p0, mGrantFlags:I

    const-wide v3, 0x10500000001L

    invoke-virtual {p1, v3, v4, v2}, Landroid/util/proto/ProtoOutputStream;->write(JI)V

    iget v2, p0, mSourceUserId:I
    ...
    :goto_0
    iget-object v3, p0, mUris:Ljava/util/ArrayList;
...
.method public dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    iget-object v0, p0, mPermissionOwner:Landroid/os/IBinder;
    ...
    :goto_0
    iget-object v1, p0, mUris:Ljava/util/ArrayList;
...
.method public revoke(Landroid/app/IActivityManager;)V
    ...
    iget-object v0, p0, mUris:Ljava/util/ArrayList;
    ...
    iget v4, p0, mGrantFlags:I

    iget v5, p0, mSourceUserId:I
