...
.method static constructor <clinit>()V
    ...
    sput-object v0, sSystemClock:Ljava/time/Clock;

    invoke-static {}, Landroid/os/SystemClock;->uptimeMillisClock()Ljava/time/Clock;

    move-result-object v0

    sput-object v0, sUptimeMillisClock:Ljava/time/Clock;

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtimeClock()Ljava/time/Clock;

    move-result-object v0

    sput-object v0, sElapsedRealtimeClock:Ljava/time/Clock;
    ...
    sput-object v0, mEnqueueTimeComparator:Ljava/util/Comparator;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mJobPackageTracker:Lcom/android/server/job/JobPackageTracker;
    ...
    iput-boolean v0, p0, mThermalConstraint:Z
    ...
    iput-object v0, p0, mUidPriorityOverride:Landroid/util/SparseIntArray;

    new-instance v0, Landroid/util/SparseIntArray;

    invoke-direct {v0}, Landroid/util/SparseIntArray;-><init>()V

    iput-object v0, p0, mBackingUpUids:Landroid/util/SparseIntArray;
    ...
    iput-object v0, p0, mNextBucketHeartbeat:[J

    const-wide/16 v0, 0x0

    iput-wide v0, p0, mHeartbeat:J

    sget-object v0, sElapsedRealtimeClock:Ljava/time/Clock;

    invoke-virtual {v0}, Ljava/time/Clock;->millis()J

    move-result-wide v0

    iput-wide v0, p0, mLastHeartbeatTime:J

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, mLastJobHeartbeats:Landroid/util/SparseArray;
    ...
    iput-object v0, p0, mHeartbeatAlarm:Lcom/android/server/job/JobSchedulerService$HeartbeatAlarmListener;
    ...
    iput-object v0, p0, mIsUidActivePredicate:Ljava/util/function/Predicate;
    ...
    iput-object v0, p0, mTimeSetReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v0, p0, mJobTimeUpdater:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mReadyQueueFunctor:Lcom/android/server/job/JobSchedulerService$ReadyJobQueueFunctor;
    ...
    iput-object v0, p0, mMaybeQueueFunctor:Lcom/android/server/job/JobSchedulerService$MaybeReadyJobQueueFunctor;
    ...
    iput-object v0, p0, mLocalPM:Landroid/content/pm/PackageManagerInternal;
    ...
    iput-object v0, p0, mConstantsObserver:Lcom/android/server/job/JobSchedulerService$ConstantsObserver;
    ...
    iput-object v0, p0, mConcurrencyManager:Lcom/android/server/job/JobConcurrencyManager;
    ...
    iput-object v0, p0, mStandbyTracker:Lcom/android/server/job/JobSchedulerService$StandbyTracker;
    ...
    iget-object v1, p0, mStandbyTracker:Lcom/android/server/job/JobSchedulerService$StandbyTracker;
    ...
    iput-object v0, p0, mBatteryController:Lcom/android/server/job/controllers/BatteryController;

    iget-object v0, p0, mControllers:Ljava/util/List;

    iget-object v1, p0, mBatteryController:Lcom/android/server/job/controllers/BatteryController;
    ...
    iput-object v0, p0, mStorageController:Lcom/android/server/job/controllers/StorageController;

    iget-object v0, p0, mControllers:Ljava/util/List;

    iget-object v1, p0, mStorageController:Lcom/android/server/job/controllers/StorageController;
    ...
    iput-object v0, p0, mDeviceIdleJobsController:Lcom/android/server/job/controllers/DeviceIdleJobsController;

    iget-object v0, p0, mControllers:Ljava/util/List;

    iget-object v1, p0, mDeviceIdleJobsController:Lcom/android/server/job/controllers/DeviceIdleJobsController;
    ...
    iget-object v0, p0, mTimeSetReceiver:Landroid/content/BroadcastReceiver;
...
.method static synthetic access$002(Lcom/android/server/job/JobSchedulerService;Z)Z
    ...
    iput-boolean p1, p0, mThermalConstraint:Z
...
.method static synthetic access$200(Lcom/android/server/job/JobSchedulerService;)Ljava/lang/Runnable;
    ...
    iget-object v0, p0, mJobTimeUpdater:Ljava/lang/Runnable;
...
.method static synthetic access$400(Lcom/android/server/job/JobSchedulerService;Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    invoke-direct {p0, p1}, isReadyToBeExecutedLocked(Lcom/android/server/job/controllers/JobStatus;)Z
...
.method static synthetic access$500(Lcom/android/server/job/JobSchedulerService;)V
    ...
    invoke-direct {p0}, queueReadyJobsForExecutionLocked()V
...
.method static synthetic access$600(Lcom/android/server/job/JobSchedulerService;)V
    ...
    invoke-direct {p0}, maybeQueueReadyJobsForExecutionLocked()V
...
.method static synthetic access$700(Lcom/android/server/job/JobSchedulerService;Lcom/android/server/job/controllers/JobStatus;Lcom/android/server/job/controllers/JobStatus;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2, p3}, cancelJobImplLocked(Lcom/android/server/job/controllers/JobStatus;Lcom/android/server/job/controllers/JobStatus;Ljava/lang/String;)V
...
.method static synthetic access$800(Lcom/android/server/job/JobSchedulerService;)Lcom/android/server/job/controllers/DeviceIdleJobsController;
    ...
    iget-object v0, p0, mDeviceIdleJobsController:Lcom/android/server/job/controllers/DeviceIdleJobsController;
...
.method static synthetic access$900(Lcom/android/server/job/JobSchedulerService;Lcom/android/server/job/controllers/JobStatus;)V
    ...
    invoke-direct {p0, p1}, evaluateControllerStatesLocked(Lcom/android/server/job/controllers/JobStatus;)V
...
.method private adjustJobPriority(ILcom/android/server/job/controllers/JobStatus;)I
    ...
    iget-object v0, p0, mJobPackageTracker:Lcom/android/server/job/JobPackageTracker;
    ...
    iget-object v1, p0, mConstants:Lcom/android/server/job/JobSchedulerService$Constants;
...
.method private areUsersStartedLocked(Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    iget-object v1, p0, mStartedUsers:[I
...
.method private cancelJobImplLocked(Lcom/android/server/job/controllers/JobStatus;Lcom/android/server/job/controllers/JobStatus;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2, v0}, stopTrackingJobLocked(Lcom/android/server/job/controllers/JobStatus;Lcom/android/server/job/controllers/JobStatus;Z)Z
    ...
    invoke-direct {p0, p1, v0, p3}, stopJobOnServiceContextLocked(Lcom/android/server/job/controllers/JobStatus;ILjava/lang/String;)Z
    ...
    :cond_2
    invoke-direct {p0, p2, p1}, startTrackingJobLocked(Lcom/android/server/job/controllers/JobStatus;Lcom/android/server/job/controllers/JobStatus;)V

    :cond_3
    invoke-virtual {p0}, reportActiveLocked()V
...
.method private evaluateControllerStatesLocked(Lcom/android/server/job/controllers/JobStatus;)V
    ...
    iget-object v1, p0, mControllers:Ljava/util/List;
...
.method private isCurrentlyActiveLocked(Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    :goto_0
    iget-object v1, p0, mActiveServices:Ljava/util/List;
...
.method private isJobThermalConstrainedLocked(Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    iget-boolean v0, p0, mThermalConstraint:Z
    ...
    invoke-virtual {p0, p1}, evaluateJobPriorityLocked(Lcom/android/server/job/controllers/JobStatus;)I
...
.method private isReadyToBeExecutedLocked(Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    invoke-direct {p0, p1}, areUsersStartedLocked(Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    :cond_4
    invoke-direct {p0, p1}, isJobThermalConstrainedLocked(Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    :cond_5
    iget-object v6, p0, mPendingJobs:Ljava/util/ArrayList;
    ...
    :cond_7
    iget-object v8, p0, mConstants:Lcom/android/server/job/JobSchedulerService$Constants;

    iget-boolean v8, v8, Lcom/android/server/job/JobSchedulerService$Constants;->USE_HEARTBEATS:Z

    if-eqz v8, :cond_e

    sget-boolean v8, DEBUG_STANDBY:Z
    ...
    iget-boolean v2, p0, mInParole:Z
    ...
    iget-object v9, p0, mNextBucketHeartbeat:[J
    ...
    :cond_9
    iget-wide v8, p0, mHeartbeat:J

    iget-object v10, p0, mNextBucketHeartbeat:[J
    ...
    invoke-virtual {p0, p1}, heartbeatWhenJobsLastRun(Lcom/android/server/job/controllers/JobStatus;)J

    move-result-wide v8

    iget-object v10, p0, mConstants:Lcom/android/server/job/JobSchedulerService$Constants;
    ...
    iget-wide v10, p0, mHeartbeat:J

    cmp-long v12, v10, v8

    if-lez v12, :cond_a

    iget-object v12, p0, mConstants:Lcom/android/server/job/JobSchedulerService$Constants;
    ...
    :cond_a
    sget-boolean v10, DEBUG_STANDBY:Z
    ...
    iget-object v11, p0, mConstants:Lcom/android/server/job/JobSchedulerService$Constants;
    ...
    :cond_c
    sget-object v3, sElapsedRealtimeClock:Ljava/time/Clock;
    ...
    :cond_e
    :goto_1
    invoke-direct {p0, p1}, isComponentUsable(Lcom/android/server/job/controllers/JobStatus;)Z
...
.method public static synthetic lambda$AauD0it1BcgWldVm_V1m2Jo7_Zc(Lcom/android/server/job/JobSchedulerService;I)Z
    ...
    invoke-direct {p0, p1}, isUidActive(I)Z
...
.method private maybeQueueReadyJobsForExecutionLocked()V
    ...
    invoke-virtual {p0, v0}, noteJobsNonpending(Ljava/util/List;)V

    iget-object v0, p0, mPendingJobs:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    invoke-direct {p0}, stopNonReadyActiveJobsLocked()V

    iget-object v0, p0, mJobs:Lcom/android/server/job/JobStore;

    iget-object v1, p0, mMaybeQueueFunctor:Lcom/android/server/job/JobSchedulerService$MaybeReadyJobQueueFunctor;

    invoke-virtual {v0, v1}, Lcom/android/server/job/JobStore;->forEachJob(Ljava/util/function/Consumer;)V

    iget-object v0, p0, mMaybeQueueFunctor:Lcom/android/server/job/JobSchedulerService$MaybeReadyJobQueueFunctor;
...
.method private queueReadyJobsForExecutionLocked()V
    ...
    iget-object v2, p0, mReadyQueueFunctor:Lcom/android/server/job/JobSchedulerService$ReadyJobQueueFunctor;

    invoke-virtual {v0, v2}, Lcom/android/server/job/JobStore;->forEachJob(Ljava/util/function/Consumer;)V

    iget-object v0, p0, mReadyQueueFunctor:Lcom/android/server/job/JobSchedulerService$ReadyJobQueueFunctor;
...
.method public static standbyBucketForPackage(Ljava/lang/String;IJ)I
    ...
    invoke-static {v1}, standbyBucketToBucketIndex(I)I

    move-result v1

    sget-boolean v2, DEBUG_STANDBY:Z
...
.method private startTrackingJobLocked(Lcom/android/server/job/controllers/JobStatus;Lcom/android/server/job/controllers/JobStatus;)V
    ...
    iget-boolean v1, p0, mReadyToRock:Z
    ...
    :goto_0
    iget-object v2, p0, mControllers:Ljava/util/List;
...
.method private stopNonReadyActiveJobsLocked()V
    ...
    :cond_1
    invoke-direct {p0, v2}, isJobThermalConstrainedLocked(Lcom/android/server/job/controllers/JobStatus;)Z
...
.method advanceHeartbeatLocked(J)V
    ...
    :cond_0
    iget-wide v0, p0, mHeartbeat:J

    add-long/2addr v0, p1

    iput-wide v0, p0, mHeartbeat:J

    sget-boolean v0, DEBUG_STANDBY:Z
    ...
    :goto_0
    iget-object v3, p0, mNextBucketHeartbeat:[J
    ...
    :cond_2
    :goto_1
    iget-wide v3, p0, mHeartbeat:J

    iget-object v5, p0, mNextBucketHeartbeat:[J
    ...
    iget-object v6, p0, mConstants:Lcom/android/server/job/JobSchedulerService$Constants;
    ...
    iget-object v4, p0, mNextBucketHeartbeat:[J
...
.method public cancelJob(III)Z
    ...
    invoke-direct {p0, v1, v2, v3}, cancelJobImplLocked(Lcom/android/server/job/controllers/JobStatus;Lcom/android/server/job/controllers/JobStatus;Ljava/lang/String;)V
...
.method cancelJobsForPackageAndUid(Ljava/lang/String;ILjava/lang/String;)V
    ...
    invoke-direct {p0, v3, v4, p3}, cancelJobImplLocked(Lcom/android/server/job/controllers/JobStatus;Lcom/android/server/job/controllers/JobStatus;Ljava/lang/String;)V
...
.method public cancelJobsForUid(ILjava/lang/String;)Z
    ...
    invoke-direct {p0, v4, v5, p2}, cancelJobImplLocked(Lcom/android/server/job/controllers/JobStatus;Lcom/android/server/job/controllers/JobStatus;Ljava/lang/String;)V
...
.method cancelJobsForUser(I)V
    ...
    invoke-direct {p0, v3, v4, v5}, cancelJobImplLocked(Lcom/android/server/job/controllers/JobStatus;Lcom/android/server/job/controllers/JobStatus;Ljava/lang/String;)V
...
.method dumpInternal(Lcom/android/internal/util/IndentingPrintWriter;I)V
    ...
    sget-object v0, sSystemClock:Ljava/time/Clock;
    ...
    sget-object v0, sUptimeMillisClock:Ljava/time/Clock;
    ...
    :try_start_0
    iget-object v0, v1, mConstants:Lcom/android/server/job/JobSchedulerService$Constants;
    ...
    iget-object v0, v1, mControllers:Ljava/util/List;
    ...
    iget-object v0, v1, mNextBucketHeartbeat:[J
    ...
    iget-wide v2, v1, mLastHeartbeatTime:J
    ...
    iget-boolean v0, v1, mInParole:Z
    ...
    iget-boolean v0, v1, mThermalConstraint:Z
    ...
    iget-object v2, v1, mStartedUsers:[I
    ...
    iget-object v0, v1, mJobs:Lcom/android/server/job/JobStore;
    ...
    invoke-static/range {v18 .. v18}, sortJobs(Ljava/util/List;)V
    ...
    invoke-virtual {v1, v10}, heartbeatWhenJobsLastRun(Lcom/android/server/job/controllers/JobStatus;)J
    ...
    invoke-direct {v1, v10}, isReadyToBeExecutedLocked(Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    invoke-direct {v1, v10}, areUsersStartedLocked(Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    iget-object v0, v1, mPendingJobs:Ljava/util/ArrayList;
    ...
    invoke-direct {v1, v10}, isCurrentlyActiveLocked(Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    iget-object v0, v1, mBackingUpUids:Landroid/util/SparseIntArray;
    ...
    :goto_8
    iget-object v2, v1, mControllers:Ljava/util/List;
    ...
    iget-object v3, v1, mControllers:Ljava/util/List;
    ...
    :goto_9
    iget-object v2, v1, mUidPriorityOverride:Landroid/util/SparseIntArray;
    ...
    iget-object v3, v1, mUidPriorityOverride:Landroid/util/SparseIntArray;
    ...
    :goto_a
    iget-object v3, v1, mBackingUpUids:Landroid/util/SparseIntArray;
    ...
    iget-object v0, v1, mJobPackageTracker:Lcom/android/server/job/JobPackageTracker;
    ...
    :goto_c
    iget-object v2, v1, mPendingJobs:Ljava/util/ArrayList;
    ...
    invoke-virtual {v1, v10}, evaluateJobPriorityLocked(Lcom/android/server/job/controllers/JobStatus;)I
    ...
    :goto_d
    iget-object v2, v1, mActiveServices:Ljava/util/List;
    ...
    invoke-virtual {v1, v2}, evaluateJobPriorityLocked(Lcom/android/server/job/controllers/JobStatus;)I
    ...
    iget-boolean v0, v1, mReadyToRock:Z
    ...
    iget-boolean v0, v1, mReportedActive:Z
    ...
    iget-object v2, v1, mConcurrencyManager:Lcom/android/server/job/JobConcurrencyManager;
...
.method dumpInternalProto(Ljava/io/FileDescriptor;I)V
    ...
    iget-wide v5, v1, mLastHeartbeatTime:J
    ...
    iget-object v0, v1, mStartedUsers:[I
    ...
    invoke-static {v2}, sortJobs(Ljava/util/List;)V
    ...
    invoke-direct {v1, v5}, areUsersStartedLocked(Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    invoke-direct {v1, v5}, isCurrentlyActiveLocked(Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    invoke-virtual {v1, v5}, heartbeatWhenJobsLastRun(Lcom/android/server/job/controllers/JobStatus;)J
    ...
    iget-object v7, v1, mUidPriorityOverride:Landroid/util/SparseIntArray;
    ...
    :goto_9
    :try_start_d
    iget-object v2, v1, mBackingUpUids:Landroid/util/SparseIntArray;
    ...
    :cond_e
    :try_start_11
    iget-object v0, v1, mActiveServices:Ljava/util/List;
    ...
    invoke-virtual {v1, v5}, evaluateJobPriorityLocked(Lcom/android/server/job/controllers/JobStatus;)I
    ...
    :goto_d
    :try_start_18
    iget-object v3, v1, mConcurrencyManager:Lcom/android/server/job/JobConcurrencyManager;
    :try_end_18
...
.method evaluateJobPriorityLocked(Lcom/android/server/job/controllers/JobStatus;)I
    ...
    invoke-direct {p0, v0, p1}, adjustJobPriority(ILcom/android/server/job/controllers/JobStatus;)I
    ...
    :cond_0
    iget-object v1, p0, mUidPriorityOverride:Landroid/util/SparseIntArray;
    ...
    invoke-direct {p0, v1, p1}, adjustJobPriority(ILcom/android/server/job/controllers/JobStatus;)I
...
.method executeCancelCommand(Ljava/io/PrintWriter;Ljava/lang/String;IZI)I
    ...
    invoke-virtual {p0, v0, v2}, cancelJobsForUid(ILjava/lang/String;)Z
    ...
    invoke-virtual {p0, v0, p5, v2}, cancelJob(III)Z
...
.method executeHeartbeatCommand(Ljava/io/PrintWriter;I)I
    ...
    invoke-virtual {p0}, getCurrentHeartbeat()J
    ...
    :try_start_0
    invoke-virtual {p0, v2, v3}, advanceHeartbeatLocked(J)V
...
.method executeRunCommand(Ljava/lang/String;IIZ)I
    ...
    invoke-virtual {p0}, maybeRunPendingJobsLocked()V
...
.method executeTimeoutCommand(Ljava/io/PrintWriter;Ljava/lang/String;IZI)I
    ...
    :goto_1
    :try_start_0
    iget-object v4, v1, mActiveServices:Ljava/util/List;
...
.method getJobState(Ljava/io/PrintWriter;Ljava/lang/String;II)I
    ...
    iget-object v5, p0, mPendingJobs:Ljava/util/ArrayList;
    ...
    :cond_4
    invoke-direct {p0, v3}, isCurrentlyActiveLocked(Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    :cond_6
    iget-object v5, p0, mStartedUsers:[I
    ...
    :cond_a
    iget-object v5, p0, mBackingUpUids:Landroid/util/SparseIntArray;
...
.method getRescheduleJobForFailureLocked(Lcom/android/server/job/controllers/JobStatus;)Lcom/android/server/job/controllers/JobStatus;
    ...
    sget-object v1, sElapsedRealtimeClock:Ljava/time/Clock;
    ...
    iget-object v1, v0, mConstants:Lcom/android/server/job/JobSchedulerService$Constants;
    ...
    iget-object v2, v0, mConstants:Lcom/android/server/job/JobSchedulerService$Constants;
    ...
    iget-object v3, v0, mConstants:Lcom/android/server/job/JobSchedulerService$Constants;
    ...
    invoke-virtual/range {p0 .. p0}, getCurrentHeartbeat()J
    ...
    sget-object v1, sSystemClock:Ljava/time/Clock;
    ...
    :goto_1
    iget-object v3, v0, mControllers:Ljava/util/List;
...
.method getRescheduleJobForPeriodic(Lcom/android/server/job/controllers/JobStatus;)Lcom/android/server/job/controllers/JobStatus;
    ...
    sget-object v9, sSystemClock:Ljava/time/Clock;
...
.method heartbeatWhenJobsLastRun(Lcom/android/server/job/controllers/JobStatus;)J
    ...
    invoke-virtual {p0, v0, v1}, heartbeatWhenJobsLastRun(Ljava/lang/String;I)J
...
.method heartbeatWhenJobsLastRun(Ljava/lang/String;I)J
    ...
    :try_start_0
    iget-object v4, p0, mLastJobHeartbeats:Landroid/util/SparseArray;
    ...
    iget-object v7, p0, mUsageStats:Landroid/app/usage/UsageStatsManagerInternal;
    ...
    iget-wide v5, p0, mHeartbeat:J

    iget-object v9, p0, mConstants:Lcom/android/server/job/JobSchedulerService$Constants;
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, v0, v1}, setLastJobHeartbeatLocked(Ljava/lang/String;IJ)V
...
.method public synthetic lambda$new$1$JobSchedulerService()V
    ...
    :try_start_0
    invoke-virtual {p0}, getJobStore()Lcom/android/server/job/JobStore;
    ...
    invoke-direct {p0, v5, v6, v7}, cancelJobImplLocked(Lcom/android/server/job/controllers/JobStatus;Lcom/android/server/job/controllers/JobStatus;Ljava/lang/String;)V
...
.method maybeRunPendingJobsLocked()V
    ...
    iget-object v1, p0, mPendingJobs:Ljava/util/ArrayList;
    ...
    :cond_0
    iget-object v0, p0, mConcurrencyManager:Lcom/android/server/job/JobConcurrencyManager;
...
.method noteJobsNonpending(Ljava/util/List;)V
    ...
    iget-object v2, p0, mJobPackageTracker:Lcom/android/server/job/JobPackageTracker;
...
.method public onBootPhase(I)V
    ...
    iget-object v0, p0, mConstantsObserver:Lcom/android/server/job/JobSchedulerService$ConstantsObserver;
    ...
    invoke-virtual {p0}, setNextHeartbeatAlarm()V
    ...
    iget-object v3, p0, mUidObserver:Landroid/app/IUidObserver;
    ...
    :goto_1
    iget-object v2, p0, mConcurrencyManager:Lcom/android/server/job/JobConcurrencyManager;

    invoke-virtual {v2}, Lcom/android/server/job/JobConcurrencyManager;->onSystemReady()V

    invoke-direct {p0}, cancelJobsForNonExistentUsers()V
    ...
    iput-object v2, p0, mThermalService:Landroid/os/IThermalService;

    iget-object v2, p0, mThermalService:Landroid/os/IThermalService;
    ...
    :try_start_2
    iput-boolean v1, p0, mReadyToRock:Z
    ...
    iput-object v2, p0, mBatteryStats:Lcom/android/internal/app/IBatteryStats;
    ...
    iput-object v2, p0, mLocalDeviceIdleController:Lcom/android/server/DeviceIdleController$LocalService;
    ...
    iget-object v5, p0, mBatteryStats:Lcom/android/internal/app/IBatteryStats;

    iget-object v6, p0, mJobPackageTracker:Lcom/android/server/job/JobPackageTracker;
...
.method public onDeviceIdleStateChanged(Z)V
    ...
    iget-object v2, p0, mLocalDeviceIdleController:Lcom/android/server/DeviceIdleController$LocalService;

    if-eqz v2, :cond_4

    iget-boolean v2, p0, mReportedActive:Z

    if-nez v2, :cond_4

    iput-boolean v1, p0, mReportedActive:Z
...
.method public onJobCompletedLocked(Lcom/android/server/job/controllers/JobStatus;Z)V
    ...
    invoke-virtual {p0, p1}, getRescheduleJobForFailureLocked(Lcom/android/server/job/controllers/JobStatus;)Lcom/android/server/job/controllers/JobStatus;
    ...
    invoke-direct {p0, p1, v0, v2}, stopTrackingJobLocked(Lcom/android/server/job/controllers/JobStatus;Lcom/android/server/job/controllers/JobStatus;Z)Z
    ...
    :goto_1
    invoke-direct {p0, v0, p1}, startTrackingJobLocked(Lcom/android/server/job/controllers/JobStatus;Lcom/android/server/job/controllers/JobStatus;)V
    ...
    invoke-virtual {p0, p1}, getRescheduleJobForPeriodic(Lcom/android/server/job/controllers/JobStatus;)Lcom/android/server/job/controllers/JobStatus;
    ...
    :goto_2
    invoke-direct {p0, v4, p1}, startTrackingJobLocked(Lcom/android/server/job/controllers/JobStatus;Lcom/android/server/job/controllers/JobStatus;)V
...
.method public onStart()V
    ...
    iget-object v0, p0, mJobSchedulerStub:Lcom/android/server/job/JobSchedulerService$JobSchedulerStub;
...
.method public onStartUser(I)V
    ...
    iput-object v1, p0, mStartedUsers:[I
...
.method reportActiveLocked()V
    ...
    :goto_0
    iget-object v2, p0, mPendingJobs:Ljava/util/ArrayList;
    ...
    :cond_2
    :goto_2
    iget-boolean v1, p0, mReportedActive:Z

    if-eq v1, v0, :cond_3

    iput-boolean v0, p0, mReportedActive:Z

    iget-object v1, p0, mLocalDeviceIdleController:Lcom/android/server/DeviceIdleController$LocalService;
...
.method public scheduleAsPackage(Landroid/app/job/JobInfo;Landroid/app/job/JobWorkItem;ILjava/lang/String;ILjava/lang/String;)I
    ...
    iget-object v4, v1, mIsUidActivePredicate:Ljava/util/function/Predicate;
    ...
    iget-object v4, v1, mJobs:Lcom/android/server/job/JobStore;
    ...
    invoke-direct {v1, v0, v9, v4}, cancelJobImplLocked(Lcom/android/server/job/controllers/JobStatus;Lcom/android/server/job/controllers/JobStatus;Ljava/lang/String;)V
    ...
    invoke-direct {v1, v9, v4}, startTrackingJobLocked(Lcom/android/server/job/controllers/JobStatus;Lcom/android/server/job/controllers/JobStatus;)V
    ...
    invoke-direct {v1, v15}, isReadyToBeExecutedLocked(Lcom/android/server/job/controllers/JobStatus;)Z

    move-result v4

    if-eqz v4, :cond_7

    iget-object v4, v1, mJobPackageTracker:Lcom/android/server/job/JobPackageTracker;
    ...
    iget-object v4, v1, mPendingJobs:Ljava/util/ArrayList;

    sget-object v5, mEnqueueTimeComparator:Ljava/util/Comparator;

    invoke-static {v4, v15, v5}, addOrderedItem(Ljava/util/ArrayList;Ljava/lang/Object;Ljava/util/Comparator;)V

    invoke-virtual/range {p0 .. p0}, maybeRunPendingJobsLocked()V

    goto :goto_3

    :cond_7
    invoke-direct {v1, v15}, evaluateControllerStatesLocked(Lcom/android/server/job/controllers/JobStatus;)V
...
.method setLastJobHeartbeatLocked(Ljava/lang/String;IJ)V
    ...
    iget-object v0, p0, mLastJobHeartbeats:Landroid/util/SparseArray;
    ...
    iget-object v1, p0, mLastJobHeartbeats:Landroid/util/SparseArray;
...
.method setNextHeartbeatAlarm()V
    ...
    iget-object v2, v1, mHeartbeatAlarm:Lcom/android/server/job/JobSchedulerService$HeartbeatAlarmListener;

    iget-object v13, v1, mHandler:Lcom/android/server/job/JobSchedulerService$JobHandler;
