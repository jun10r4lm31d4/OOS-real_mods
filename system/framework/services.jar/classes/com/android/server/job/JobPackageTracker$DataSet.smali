...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mEntries:Landroid/util/SparseArray;
    ...
    iput-wide v0, p0, mStartUptimeTime:J
    ...
    iput-wide v0, p0, mStartElapsedTime:J
...
.method public constructor <init>(Lcom/android/server/job/JobPackageTracker$DataSet;)V
    ...
    iget-wide v0, p1, mStartUptimeTime:J

    iput-wide v0, p0, mStartUptimeTime:J

    iget-wide v0, p1, mStartElapsedTime:J

    iput-wide v0, p0, mStartElapsedTime:J

    iget-wide v0, p1, mStartClockTime:J
...
.method private getOrCreateEntry(ILjava/lang/String;)Lcom/android/server/job/JobPackageTracker$PackageEntry;
    ...
    iget-object v0, p0, mEntries:Landroid/util/SparseArray;
    ...
    iget-object v1, p0, mEntries:Landroid/util/SparseArray;
...
.method addTo(Lcom/android/server/job/JobPackageTracker$DataSet;J)V
    ...
    iget-wide v0, p1, mSummedTime:J

    invoke-virtual {p0, p2, p3}, getTotalTime(J)J

    move-result-wide v2

    add-long/2addr v0, v2

    iput-wide v0, p1, mSummedTime:J
    ...
    iget-object v2, p0, mEntries:Landroid/util/SparseArray;
    ...
    iget-object v5, p0, mEntries:Landroid/util/SparseArray;
    ...
    invoke-direct {p1, v5, v6}, getOrCreateEntry(ILjava/lang/String;)Lcom/android/server/job/JobPackageTracker$PackageEntry;
    ...
    :cond_5
    iget v0, p0, mMaxTotalActive:I

    iget v1, p1, mMaxTotalActive:I

    if-le v0, v1, :cond_6

    iput v0, p1, mMaxTotalActive:I

    :cond_6
    iget v0, p0, mMaxFgActive:I

    iget v1, p1, mMaxFgActive:I

    if-le v0, v1, :cond_7

    iput v0, p1, mMaxFgActive:I
...
.method decActive(ILjava/lang/String;JI)V
    ...
    invoke-direct {p0, p1, p2}, getOrCreateEntry(ILjava/lang/String;)Lcom/android/server/job/JobPackageTracker$PackageEntry;
...
.method dump(Landroid/util/proto/ProtoOutputStream;JJJI)V
    ...
    invoke-virtual {v7, v9, v10}, getTotalTime(J)J

    move-result-wide v14

    iget-wide v0, v7, mStartClockTime:J

    const-wide v2, 0x10300000001L

    invoke-virtual {v8, v2, v3, v0, v1}, Landroid/util/proto/ProtoOutputStream;->write(JJ)V

    iget-wide v0, v7, mStartElapsedTime:J
    ...
    iget-object v0, v7, mEntries:Landroid/util/SparseArray;
    ...
    invoke-direct/range {v0 .. v6}, printPackageEntryState(Landroid/util/proto/ProtoOutputStream;JJI)V
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;Ljava/lang/String;JJI)V
    ...
    invoke-virtual {v8, v11, v12}, getTotalTime(J)J
    ...
    iget-wide v0, v8, mStartClockTime:J
    ...
    iget-wide v0, v8, mStartElapsedTime:J
    ...
    iget-object v0, v8, mEntries:Landroid/util/SparseArray;
    ...
    invoke-virtual/range {v0 .. v7}, printDuration(Ljava/io/PrintWriter;JJILjava/lang/String;)V
...
.method finish(Lcom/android/server/job/JobPackageTracker$DataSet;J)V
    ...
    :cond_0
    iget-object v4, p0, mEntries:Landroid/util/SparseArray;
    ...
    invoke-direct {p1, v4, v5}, getOrCreateEntry(ILjava/lang/String;)Lcom/android/server/job/JobPackageTracker$PackageEntry;
...
.method getTotalTime(J)J
    ...
    :cond_0
    iget-wide v0, p0, mStartUptimeTime:J
