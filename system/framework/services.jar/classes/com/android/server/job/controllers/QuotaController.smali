...
.method public constructor <init>(Lcom/android/server/job/JobSchedulerService;)V
    ...
    iput-object v0, p0, mTrackedJobs:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;

    new-instance v0, Lcom/android/server/job/controllers/QuotaController$UserPackageMap;

    invoke-direct {v0, v1}, Lcom/android/server/job/controllers/QuotaController$UserPackageMap;-><init>(Lcom/android/server/job/controllers/QuotaController$1;)V

    iput-object v0, p0, mPkgTimers:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;

    new-instance v0, Lcom/android/server/job/controllers/QuotaController$UserPackageMap;

    invoke-direct {v0, v1}, Lcom/android/server/job/controllers/QuotaController$UserPackageMap;-><init>(Lcom/android/server/job/controllers/QuotaController$1;)V

    iput-object v0, p0, mTimingSessions:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;

    new-instance v0, Lcom/android/server/job/controllers/QuotaController$UserPackageMap;

    invoke-direct {v0, v1}, Lcom/android/server/job/controllers/QuotaController$UserPackageMap;-><init>(Lcom/android/server/job/controllers/QuotaController$1;)V

    iput-object v0, p0, mInQuotaAlarmListeners:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;

    new-instance v0, Lcom/android/server/job/controllers/QuotaController$UserPackageMap;

    invoke-direct {v0, v1}, Lcom/android/server/job/controllers/QuotaController$UserPackageMap;-><init>(Lcom/android/server/job/controllers/QuotaController$1;)V

    iput-object v0, p0, mExecutionStatsCache:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;

    new-instance v0, Landroid/util/SparseBooleanArray;

    invoke-direct {v0}, Landroid/util/SparseBooleanArray;-><init>()V

    iput-object v0, p0, mForegroundUids:Landroid/util/SparseBooleanArray;

    new-instance v0, Landroid/util/SparseSetArray;

    invoke-direct {v0}, Landroid/util/SparseSetArray;-><init>()V

    iput-object v0, p0, mUidToPackageCache:Landroid/util/SparseSetArray;

    new-instance v0, Landroid/util/ArraySet;

    invoke-direct {v0}, Landroid/util/ArraySet;-><init>()V

    iput-object v0, p0, mTopStartedJobs:Landroid/util/ArraySet;

    const-wide/32 v2, 0x927c0

    iput-wide v2, p0, mAllowedTimePerPeriodMs:J

    const-wide/32 v4, 0xdbba00

    iput-wide v4, p0, mMaxExecutionTimeMs:J

    const-wide/16 v4, 0x7530

    iput-wide v4, p0, mQuotaBufferMs:J

    iget-wide v4, p0, mAllowedTimePerPeriodMs:J

    iget-wide v6, p0, mQuotaBufferMs:J

    sub-long/2addr v4, v6

    iput-wide v4, p0, mAllowedTimeIntoQuotaMs:J

    iget-wide v4, p0, mMaxExecutionTimeMs:J

    sub-long/2addr v4, v6

    iput-wide v4, p0, mMaxExecutionTimeIntoQuotaMs:J

    iput-wide v2, p0, mRateLimitingWindowMs:J

    const/16 v0, 0x14

    iput v0, p0, mMaxJobCountPerRateLimitingWindow:I

    iput v0, p0, mMaxSessionCountPerRateLimitingWindow:I

    const-wide/16 v2, 0x0

    iput-wide v2, p0, mNextCleanupTimeElapsed:J
    ...
    iput-object v0, p0, mSessionCleanupAlarmListener:Landroid/app/AlarmManager$OnAlarmListener;
    ...
    iput-object v0, p0, mPackageAddedReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v2, p0, mBucketPeriodsMs:[J

    new-array v2, v0, [I

    fill-array-data v2, :array_1

    iput-object v2, p0, mMaxBucketJobCounts:[I

    new-array v0, v0, [I

    fill-array-data v0, :array_2

    iput-object v0, p0, mMaxBucketSessionCounts:[I

    const-wide/16 v2, 0x1388

    iput-wide v2, p0, mTimingSessionCoalescingDurationMs:J
    ...
    iput-object v0, p0, mEarliestEndTimeFunctor:Lcom/android/server/job/controllers/QuotaController$EarliestEndTimeFunctor;
    ...
    iput-object v0, p0, mUpdateUidConstraints:Lcom/android/server/job/controllers/QuotaController$UidConstraintUpdater;
    ...
    iput-object v0, p0, mDeleteOldSessionsFunctor:Lcom/android/server/job/controllers/QuotaController$DeleteTimingSessionsFunctor;
    ...
    iput-object v0, p0, mChargeTracker:Lcom/android/server/job/controllers/QuotaController$ChargingTracker;

    iget-object v0, p0, mChargeTracker:Lcom/android/server/job/controllers/QuotaController$ChargingTracker;
    ...
    iput-object v0, p0, mQcConstants:Lcom/android/server/job/controllers/QuotaController$QcConstants;
    ...
    iget-object v4, p0, mPackageAddedReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v4, p0, mUidObserver:Landroid/app/IUidObserver;
    ...
    iput-boolean v1, p0, mShouldThrottle:Z
...
.method static synthetic access$000(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, p1}, string(ILjava/lang/String;)Ljava/lang/String;
...
.method static synthetic access$100(J)I
    ...
    invoke-static {p0, p1}, hashLong(J)I
...
.method static synthetic access$1200(Lcom/android/server/job/controllers/QuotaController;)V
    ...
    invoke-direct {p0}, handleNewChargingStateLocked()V
...
.method static synthetic access$1300(Lcom/android/server/job/controllers/QuotaController;Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    invoke-direct {p0, p1}, isTopStartedJobLocked(Lcom/android/server/job/controllers/JobStatus;)Z
...
.method static synthetic access$1500(Lcom/android/server/job/controllers/QuotaController;ILjava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2}, incrementTimingSessionCount(ILjava/lang/String;)V
...
.method static synthetic access$1600(Lcom/android/server/job/controllers/QuotaController;)Landroid/util/SparseBooleanArray;
    ...
    iget-object v0, p0, mForegroundUids:Landroid/util/SparseBooleanArray;
...
.method static synthetic access$1702(Lcom/android/server/job/controllers/QuotaController;Z)Z
    ...
    iput-boolean p1, p0, mInParole:Z
...
.method static synthetic access$1800(Lcom/android/server/job/controllers/QuotaController;)V
    ...
    invoke-direct {p0}, maybeUpdateAllConstraintsLocked()V
...
.method static synthetic access$1900(Lcom/android/server/job/controllers/QuotaController;)Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
    ...
    iget-object v0, p0, mTrackedJobs:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
...
.method static synthetic access$2000(Lcom/android/server/job/controllers/QuotaController;)Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
    ...
    iget-object v0, p0, mPkgTimers:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
...
.method static synthetic access$2100(Lcom/android/server/job/controllers/QuotaController;)Z
    ...
    iget-boolean v0, p0, mShouldThrottle:Z
...
.method static synthetic access$2200(Lcom/android/server/job/controllers/QuotaController;ILjava/lang/String;)Z
    ...
    invoke-direct {p0, p1, p2}, maybeUpdateConstraintForPkgLocked(ILjava/lang/String;)Z
...
.method static synthetic access$2400(Lcom/android/server/job/controllers/QuotaController;I)Z
    ...
    invoke-direct {p0, p1}, maybeUpdateConstraintForUidLocked(I)Z
...
.method static synthetic access$2500(Lcom/android/server/job/controllers/QuotaController;)J
    ...
    iget-wide v0, p0, mMaxExecutionTimeMs:J
...
.method static synthetic access$2502(Lcom/android/server/job/controllers/QuotaController;J)J
    ...
    iput-wide p1, p0, mMaxExecutionTimeMs:J
...
.method static synthetic access$2602(Lcom/android/server/job/controllers/QuotaController;J)J
    ...
    iput-wide p1, p0, mMaxExecutionTimeIntoQuotaMs:J
...
.method static synthetic access$2700(Lcom/android/server/job/controllers/QuotaController;)J
    ...
    iget-wide v0, p0, mQuotaBufferMs:J
...
.method static synthetic access$2702(Lcom/android/server/job/controllers/QuotaController;J)J
    ...
    iput-wide p1, p0, mQuotaBufferMs:J
...
.method static synthetic access$2800(Lcom/android/server/job/controllers/QuotaController;)J
    ...
    iget-wide v0, p0, mAllowedTimePerPeriodMs:J
...
.method static synthetic access$2802(Lcom/android/server/job/controllers/QuotaController;J)J
    ...
    iput-wide p1, p0, mAllowedTimePerPeriodMs:J
...
.method static synthetic access$2902(Lcom/android/server/job/controllers/QuotaController;J)J
    ...
    iput-wide p1, p0, mAllowedTimeIntoQuotaMs:J
...
.method static synthetic access$3000(Lcom/android/server/job/controllers/QuotaController;)[J
    ...
    iget-object v0, p0, mBucketPeriodsMs:[J
...
.method static synthetic access$3100(Lcom/android/server/job/controllers/QuotaController;)J
    ...
    iget-wide v0, p0, mRateLimitingWindowMs:J
...
.method static synthetic access$3102(Lcom/android/server/job/controllers/QuotaController;J)J
    ...
    iput-wide p1, p0, mRateLimitingWindowMs:J
...
.method static synthetic access$3200(Lcom/android/server/job/controllers/QuotaController;)I
    ...
    iget v0, p0, mMaxJobCountPerRateLimitingWindow:I
...
.method static synthetic access$3202(Lcom/android/server/job/controllers/QuotaController;I)I
    ...
    iput p1, p0, mMaxJobCountPerRateLimitingWindow:I
...
.method static synthetic access$3300(Lcom/android/server/job/controllers/QuotaController;)[I
    ...
    iget-object v0, p0, mMaxBucketJobCounts:[I
...
.method static synthetic access$3400(Lcom/android/server/job/controllers/QuotaController;)I
    ...
    iget v0, p0, mMaxSessionCountPerRateLimitingWindow:I
...
.method static synthetic access$3402(Lcom/android/server/job/controllers/QuotaController;I)I
    ...
    iput p1, p0, mMaxSessionCountPerRateLimitingWindow:I
...
.method static synthetic access$3500(Lcom/android/server/job/controllers/QuotaController;)[I
    ...
    iget-object v0, p0, mMaxBucketSessionCounts:[I
...
.method static synthetic access$3600(Lcom/android/server/job/controllers/QuotaController;)J
    ...
    iget-wide v0, p0, mTimingSessionCoalescingDurationMs:J
...
.method static synthetic access$3602(Lcom/android/server/job/controllers/QuotaController;J)J
    ...
    iput-wide p1, p0, mTimingSessionCoalescingDurationMs:J
...
.method static synthetic access$400(Lcom/android/server/job/controllers/QuotaController;)Landroid/util/SparseSetArray;
    ...
    iget-object v0, p0, mUidToPackageCache:Landroid/util/SparseSetArray;
...
.method static synthetic access$700(Lcom/android/server/job/controllers/QuotaController;Lcom/android/server/job/controllers/JobStatus;Z)Z
    ...
    invoke-direct {p0, p1, p2}, setConstraintSatisfied(Lcom/android/server/job/controllers/JobStatus;Z)Z
...
.method static synthetic access$800(Lcom/android/server/job/controllers/QuotaController;)Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
    ...
    iget-object v0, p0, mInQuotaAlarmListeners:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
...
.method private calculateTimeUntilQuotaConsumedLocked(Ljava/util/List;JJ)J
    ...
    iget-wide v8, v4, mMaxExecutionTimeMs:J
...
.method private getExecutionStatsLocked(ILjava/lang/String;IZ)Lcom/android/server/job/controllers/QuotaController$ExecutionStats;
    ...
    :cond_0
    iget-object v0, p0, mExecutionStatsCache:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
    ...
    iget-object v1, p0, mBucketPeriodsMs:[J

    array-length v1, v1

    new-array v0, v1, [Lcom/android/server/job/controllers/QuotaController$ExecutionStats;

    iget-object v1, p0, mExecutionStatsCache:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
    ...
    iget-object v2, p0, mBucketPeriodsMs:[J

    aget-wide v2, v2, p3

    iget-object v4, p0, mMaxBucketJobCounts:[I

    aget v4, v4, p3

    iget-object v5, p0, mMaxBucketSessionCounts:[I

    aget v5, v5, p3

    iget-object v6, p0, mPkgTimers:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
    ...
    invoke-virtual {p0, p1, p2, v1}, updateExecutionStatsLocked(ILjava/lang/String;Lcom/android/server/job/controllers/QuotaController$ExecutionStats;)V
...
.method private getRemainingExecutionTimeLocked(ILjava/lang/String;I)J
    ...
    invoke-virtual {p0, p1, p2, p3}, getExecutionStatsLocked(ILjava/lang/String;I)Lcom/android/server/job/controllers/QuotaController$ExecutionStats;

    move-result-object v0

    invoke-direct {p0, v0}, getRemainingExecutionTimeLocked(Lcom/android/server/job/controllers/QuotaController$ExecutionStats;)J
...
.method private getRemainingExecutionTimeLocked(Lcom/android/server/job/controllers/QuotaController$ExecutionStats;)J
    ...
    iget-wide v2, p0, mMaxExecutionTimeMs:J
...
.method private handleNewChargingStateLocked()V
    ...
    iget-object v2, p0, mChargeTracker:Lcom/android/server/job/controllers/QuotaController$ChargingTracker;
    ...
    :cond_0
    iget-object v3, p0, mPkgTimers:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
...
.method private incrementTimingSessionCount(ILjava/lang/String;)V
    ...
    iget-object v2, p0, mExecutionStatsCache:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
    ...
    iget-object v3, p0, mBucketPeriodsMs:[J

    array-length v3, v3

    new-array v2, v3, [Lcom/android/server/job/controllers/QuotaController$ExecutionStats;

    iget-object v3, p0, mExecutionStatsCache:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
    ...
    iget-wide v5, p0, mRateLimitingWindowMs:J
...
.method private isTopStartedJobLocked(Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    iget-object v0, p0, mTopStartedJobs:Landroid/util/ArraySet;
...
.method private isUidInForeground(I)Z
    ...
    :try_start_0
    iget-object v1, p0, mForegroundUids:Landroid/util/SparseBooleanArray;
...
.method private isUnderJobCountQuotaLocked(Lcom/android/server/job/controllers/QuotaController$ExecutionStats;I)Z
    ...
    iget v5, p0, mMaxJobCountPerRateLimitingWindow:I
    ...
    iget-object v6, p0, mMaxBucketJobCounts:[I
...
.method private isUnderSessionCountQuotaLocked(Lcom/android/server/job/controllers/QuotaController$ExecutionStats;I)Z
    ...
    iget v5, p0, mMaxSessionCountPerRateLimitingWindow:I
    ...
    iget-object v6, p0, mMaxBucketSessionCounts:[I
...
.method private maybeUpdateAllConstraintsLocked()V
    ...
    :goto_0
    iget-object v2, p0, mTrackedJobs:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
    ...
    :goto_1
    iget-object v4, p0, mTrackedJobs:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
    ...
    invoke-direct {p0, v2, v4}, maybeUpdateConstraintForPkgLocked(ILjava/lang/String;)Z
    ...
    iget-object v1, p0, mStateChangedListener:Lcom/android/server/job/StateChangedListener;
...
.method private maybeUpdateConstraintForPkgLocked(ILjava/lang/String;)Z
    ...
    invoke-virtual {p0, p1, p2, v1}, isWithinQuotaLocked(ILjava/lang/String;I)Z
    ...
    invoke-direct {p0, v6}, isTopStartedJobLocked(Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    invoke-direct {p0, v6}, getEffectiveStandbyBucket(Lcom/android/server/job/controllers/JobStatus;)I

    move-result v7

    if-ne v1, v7, :cond_2

    invoke-direct {p0, v6, v2}, setConstraintSatisfied(Lcom/android/server/job/controllers/JobStatus;Z)Z
    ...
    :cond_2
    invoke-virtual {p0, v6}, isWithinQuotaLocked(Lcom/android/server/job/controllers/JobStatus;)Z

    move-result v7

    invoke-direct {p0, v6, v7}, setConstraintSatisfied(Lcom/android/server/job/controllers/JobStatus;Z)Z
    ...
    invoke-virtual {p0, p1, p2, v1}, maybeScheduleStartAlarmLocked(ILjava/lang/String;I)V

    goto :goto_2

    :cond_4
    iget-object v4, p0, mInQuotaAlarmListeners:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
...
.method private maybeUpdateConstraintForUidLocked(I)Z
    ...
    iget-object v1, p0, mUpdateUidConstraints:Lcom/android/server/job/controllers/QuotaController$UidConstraintUpdater;

    invoke-virtual {v0, p1, v1}, Lcom/android/server/job/JobStore;->forEachJobForSourceUid(ILjava/util/function/Consumer;)V

    iget-object v0, p0, mUpdateUidConstraints:Lcom/android/server/job/controllers/QuotaController$UidConstraintUpdater;
...
.method deleteObsoleteSessionsLocked()V
    ...
    iget-object v0, p0, mTimingSessions:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;

    iget-object v1, p0, mDeleteOldSessionsFunctor:Lcom/android/server/job/controllers/QuotaController$DeleteTimingSessionsFunctor;
...
.method public dumpConstants(Landroid/util/proto/ProtoOutputStream;)V
    ...
    iget-object v0, p0, mQcConstants:Lcom/android/server/job/controllers/QuotaController$QcConstants;
...
.method public dumpControllerStateLocked(Landroid/util/proto/ProtoOutputStream;JLjava/util/function/Predicate;)V
    ...
    iget-object v7, v0, mChargeTracker:Lcom/android/server/job/controllers/QuotaController$ChargingTracker;
    ...
    iget-boolean v7, v0, mInParole:Z
    ...
    :goto_0
    iget-object v10, v0, mForegroundUids:Landroid/util/SparseBooleanArray;
    ...
    iget-object v14, v0, mForegroundUids:Landroid/util/SparseBooleanArray;
    ...
    :cond_0
    iget-object v7, v0, mTrackedJobs:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
    ...
    :goto_1
    iget-object v10, v0, mPkgTimers:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
    ...
    :goto_2
    iget-object v14, v0, mPkgTimers:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
    ...
    iget-object v15, v0, mPkgTimers:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
    ...
    iget-object v12, v0, mTimingSessions:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
    ...
    :goto_4
    iget-object v2, v0, mExecutionStatsCache:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
    ...
    :goto_7
    iget-object v3, v0, mInQuotaAlarmListeners:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
...
.method public dumpControllerStateLocked(Lcom/android/internal/util/IndentingPrintWriter;Ljava/util/function/Predicate;)V
    ...
    iget-boolean v1, p0, mShouldThrottle:Z
    ...
    iget-object v1, p0, mChargeTracker:Lcom/android/server/job/controllers/QuotaController$ChargingTracker;
    ...
    iget-boolean v1, p0, mInParole:Z
    ...
    :goto_0
    iget-object v1, p0, mUidToPackageCache:Landroid/util/SparseSetArray;
    ...
    iget-object v2, p0, mUidToPackageCache:Landroid/util/SparseSetArray;
    ...
    :goto_1
    iget-object v1, p0, mPkgTimers:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
    ...
    :goto_2
    iget-object v4, p0, mPkgTimers:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
    ...
    iget-object v5, p0, mPkgTimers:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
    ...
    iget-object v5, p0, mTimingSessions:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
    ...
    :goto_5
    iget-object v4, p0, mExecutionStatsCache:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
    ...
    iget-object v5, p0, mExecutionStatsCache:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
    ...
    invoke-static {v1, v4}, string(ILjava/lang/String;)Ljava/lang/String;
    ...
    :goto_7
    iget-object v1, p0, mInQuotaAlarmListeners:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
    ...
    iget-object v5, p0, mInQuotaAlarmListeners:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
...
.method getExecutionStatsLocked(ILjava/lang/String;I)Lcom/android/server/job/controllers/QuotaController$ExecutionStats;
    ...
    invoke-direct {p0, p1, p2, p3, v0}, getExecutionStatsLocked(ILjava/lang/String;IZ)Lcom/android/server/job/controllers/QuotaController$ExecutionStats;
...
.method getRemainingExecutionTimeLocked(ILjava/lang/String;)J
    ...
    invoke-direct {p0, p1, p2, v0}, getRemainingExecutionTimeLocked(ILjava/lang/String;I)J
...
.method getRemainingExecutionTimeLocked(Lcom/android/server/job/controllers/JobStatus;)J
    ...
    invoke-direct {p0, p1}, getEffectiveStandbyBucket(Lcom/android/server/job/controllers/JobStatus;)I

    move-result v2

    invoke-direct {p0, v0, v1, v2}, getRemainingExecutionTimeLocked(ILjava/lang/String;I)J
...
.method getTimeUntilQuotaConsumedLocked(ILjava/lang/String;)J
    ...
    :cond_0
    iget-object v0, v6, mTimingSessions:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
    ...
    :cond_1
    invoke-virtual {v6, v7, v8, v11}, getExecutionStatsLocked(ILjava/lang/String;I)Lcom/android/server/job/controllers/QuotaController$ExecutionStats;
    ...
    iget-wide v2, v6, mAllowedTimePerPeriodMs:J
    ...
    invoke-direct/range {v0 .. v5}, calculateTimeUntilQuotaConsumedLocked(Ljava/util/List;JJ)J
...
.method isWithinQuotaLocked(ILjava/lang/String;I)Z
    ...
    invoke-direct {p0, v1}, getRemainingExecutionTimeLocked(Lcom/android/server/job/controllers/QuotaController$ExecutionStats;)J
    ...
    invoke-direct {p0, v1, p3}, isUnderJobCountQuotaLocked(Lcom/android/server/job/controllers/QuotaController$ExecutionStats;I)Z

    move-result v3

    if-eqz v3, :cond_3

    invoke-direct {p0, v1, p3}, isUnderSessionCountQuotaLocked(Lcom/android/server/job/controllers/QuotaController$ExecutionStats;I)Z
...
.method isWithinQuotaLocked(Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    invoke-direct {p0, v1}, isUidInForeground(I)Z
    ...
    invoke-virtual {p0, v1, v2, v0}, isWithinQuotaLocked(ILjava/lang/String;I)Z
...
.method public synthetic lambda$dumpControllerStateLocked$3$QuotaController(Ljava/util/function/Predicate;Lcom/android/internal/util/IndentingPrintWriter;Landroid/util/ArraySet;)V
    ...
    iget-object v2, p0, mTopStartedJobs:Landroid/util/ArraySet;
    ...
    invoke-direct {p0, v1}, getEffectiveStandbyBucket(Lcom/android/server/job/controllers/JobStatus;)I
    ...
    invoke-virtual {p0, v1}, getRemainingExecutionTimeLocked(Lcom/android/server/job/controllers/JobStatus;)J
...
.method public synthetic lambda$dumpControllerStateLocked$4$QuotaController(Ljava/util/function/Predicate;Landroid/util/proto/ProtoOutputStream;Landroid/util/ArraySet;)V
    ...
    iget-object v6, p0, mTopStartedJobs:Landroid/util/ArraySet;
...
.method maybeScheduleCleanupAlarmLocked()V
    ...
    iget-wide v0, p0, mNextCleanupTimeElapsed:J
    ...
    iget-wide v2, p0, mNextCleanupTimeElapsed:J
    ...
    :cond_1
    iget-object v0, p0, mEarliestEndTimeFunctor:Lcom/android/server/job/controllers/QuotaController$EarliestEndTimeFunctor;

    invoke-virtual {v0}, Lcom/android/server/job/controllers/QuotaController$EarliestEndTimeFunctor;->reset()V

    iget-object v0, p0, mTimingSessions:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;

    iget-object v2, p0, mEarliestEndTimeFunctor:Lcom/android/server/job/controllers/QuotaController$EarliestEndTimeFunctor;
    ...
    iget-wide v6, p0, mNextCleanupTimeElapsed:J
    ...
    :cond_4
    iput-wide v4, p0, mNextCleanupTimeElapsed:J

    iget-object v6, p0, mAlarmManager:Landroid/app/AlarmManager;

    const/4 v7, 0x3

    iget-object v11, p0, mSessionCleanupAlarmListener:Landroid/app/AlarmManager$OnAlarmListener;
...
.method maybeScheduleStartAlarmLocked(ILjava/lang/String;I)V
    ...
    :cond_0
    invoke-static/range {p1 .. p2}, string(ILjava/lang/String;)Ljava/lang/String;

    move-result-object v4

    invoke-virtual/range {p0 .. p3}, getExecutionStatsLocked(ILjava/lang/String;I)Lcom/android/server/job/controllers/QuotaController$ExecutionStats;

    move-result-object v5

    invoke-direct {v0, v5, v3}, isUnderJobCountQuotaLocked(Lcom/android/server/job/controllers/QuotaController$ExecutionStats;I)Z

    move-result v6

    invoke-direct {v0, v5, v3}, isUnderSessionCountQuotaLocked(Lcom/android/server/job/controllers/QuotaController$ExecutionStats;I)Z

    move-result v7

    iget-object v8, v0, mInQuotaAlarmListeners:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
    ...
    iget-wide v11, v0, mAllowedTimePerPeriodMs:J
    ...
    iget-wide v13, v0, mMaxExecutionTimeMs:J
    ...
    invoke-direct/range {p0 .. p3}, getRemainingExecutionTimeLocked(ILjava/lang/String;I)J
    ...
    iget-object v9, v0, mAlarmManager:Landroid/app/AlarmManager;
    ...
    iget-object v9, v0, mInQuotaAlarmListeners:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
...
.method public maybeStartTrackingJobLocked(Lcom/android/server/job/controllers/JobStatus;Lcom/android/server/job/controllers/JobStatus;)V
    ...
    iget-object v3, p0, mTrackedJobs:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
    ...
    iget-boolean v3, p0, mShouldThrottle:Z

    if-eqz v3, :cond_2

    invoke-virtual {p0, p1}, isWithinQuotaLocked(Lcom/android/server/job/controllers/JobStatus;)Z

    move-result v3

    invoke-direct {p0, p1, v3}, setConstraintSatisfied(Lcom/android/server/job/controllers/JobStatus;Z)Z
    ...
    invoke-virtual {p0, v0, v1, v4}, maybeScheduleStartAlarmLocked(ILjava/lang/String;I)V
...
.method public maybeStopTrackingJobLocked(Lcom/android/server/job/controllers/JobStatus;Lcom/android/server/job/controllers/JobStatus;Z)V
    ...
    :cond_0
    iget-object v1, p0, mTrackedJobs:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
...
.method public onAppRemovedLocked(Ljava/lang/String;I)V
    ...
    iget-object v2, p0, mPkgTimers:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
    ...
    iget-object v3, p0, mInQuotaAlarmListeners:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
    ...
    iget-object v3, p0, mForegroundUids:Landroid/util/SparseBooleanArray;

    invoke-virtual {v3, p2}, Landroid/util/SparseBooleanArray;->delete(I)V

    iget-object v3, p0, mUidToPackageCache:Landroid/util/SparseSetArray;
...
.method public onConstantsUpdatedLocked()V
    ...
    iput-boolean v0, p0, mShouldThrottle:Z
...
.method public prepareForExecutionLocked(Lcom/android/server/job/controllers/JobStatus;)V
    ...
    :cond_1
    iget-object v1, p0, mTopStartedJobs:Landroid/util/ArraySet;
...
.method saveTimingSession(ILjava/lang/String;Lcom/android/server/job/controllers/QuotaController$TimingSession;)V
    ...
    :try_start_0
    iget-object v1, p0, mTimingSessions:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
    ...
    iget-object v2, p0, mTimingSessions:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
    ...
    invoke-virtual {p0, p1, p2}, invalidateAllExecutionStatsLocked(ILjava/lang/String;)V

    invoke-virtual {p0}, maybeScheduleCleanupAlarmLocked()V
...
.method updateExecutionStatsLocked(ILjava/lang/String;Lcom/android/server/job/controllers/QuotaController$ExecutionStats;)V
    ...
    iget-object v4, v0, mPkgTimers:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
    ...
    iget-wide v11, v0, mAllowedTimeIntoQuotaMs:J
    ...
    iget-wide v11, v0, mMaxExecutionTimeIntoQuotaMs:J
    ...
    :cond_1
    iget-object v9, v0, mTimingSessions:Lcom/android/server/job/controllers/QuotaController$UserPackageMap;
    ...
    iget-wide v14, v0, mAllowedTimeIntoQuotaMs:J
    ...
    iget-wide v4, v0, mAllowedTimeIntoQuotaMs:J
    ...
    iget-wide v10, v0, mTimingSessionCoalescingDurationMs:J
    ...
    iget-wide v10, v0, mMaxExecutionTimeIntoQuotaMs:J
    ...
    iget-wide v14, v0, mMaxExecutionTimeIntoQuotaMs:J
