...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mIdleAlarmListener:Landroid/app/AlarmManager$OnAlarmListener;
    ...
    iput-boolean v0, p0, mDockIdle:Z
...
.method private handleIdleTrigger()V
    ...
    iget-boolean v0, p0, mDockIdle:Z
    ...
    iget-object v0, p0, mIdleListener:Lcom/android/server/job/controllers/idle/IdlenessListener;
...
.method public synthetic lambda$new$0$DeviceIdlenessTracker()V
    ...
    invoke-direct {p0}, handleIdleTrigger()V
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-direct/range {p0 .. p0}, handleIdleTrigger()V
    ...
    iget-boolean v2, v0, mScreenOn:Z
    ...
    :cond_4
    iput-boolean v4, v0, mDockIdle:Z

    goto :goto_2

    :cond_5
    iput-boolean v6, v0, mScreenOn:Z

    iput-boolean v6, v0, mDockIdle:Z
    ...
    iget-wide v6, v0, mInactivityIdleThreshold:J
    ...
    :cond_6
    iget-object v8, v0, mAlarm:Landroid/app/AlarmManager;

    const/4 v9, 0x2

    iget-wide v12, v0, mIdleWindowSlop:J

    iget-object v15, v0, mIdleAlarmListener:Landroid/app/AlarmManager$OnAlarmListener;
    ...
    :cond_9
    iput-boolean v4, v0, mScreenOn:Z
    ...
    :cond_a
    iget-object v2, v0, mAlarm:Landroid/app/AlarmManager;

    iget-object v3, v0, mIdleAlarmListener:Landroid/app/AlarmManager$OnAlarmListener;

    invoke-virtual {v2, v3}, Landroid/app/AlarmManager;->cancel(Landroid/app/AlarmManager$OnAlarmListener;)V

    iget-boolean v2, v0, mIdle:Z

    if-eqz v2, :cond_b

    iput-boolean v6, v0, mIdle:Z

    iget-object v2, v0, mIdleListener:Lcom/android/server/job/controllers/idle/IdlenessListener;

    iget-boolean v3, v0, mIdle:Z
...
.method public startTracking(Landroid/content/Context;Lcom/android/server/job/controllers/idle/IdlenessListener;)V
    ...
    iput-object p2, p0, mIdleListener:Lcom/android/server/job/controllers/idle/IdlenessListener;
    ...
    iput-wide v0, p0, mInactivityIdleThreshold:J
    ...
    iput-wide v0, p0, mIdleWindowSlop:J
    ...
    iput-object v0, p0, mAlarm:Landroid/app/AlarmManager;
