...
.method public constructor <init>(Lcom/android/server/job/JobSchedulerService;)V
    ...
    iput-object v0, p0, mTrackedJobs:Landroid/util/SparseArray;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, mRequestedWhitelistJobs:Landroid/util/SparseArray;

    new-instance v0, Landroid/util/ArraySet;

    invoke-direct {v0}, Landroid/util/ArraySet;-><init>()V

    iput-object v0, p0, mAvailableNetworks:Landroid/util/ArraySet;
    ...
    iput-object v0, p0, mNetPolicyListener:Landroid/net/INetworkPolicyListener;
    ...
    iput-object v0, p0, mConnManager:Landroid/net/ConnectivityManager;
    ...
    iput-object v0, p0, mNetPolicyManager:Landroid/net/NetworkPolicyManager;
    ...
    iput-object v0, p0, mNetPolicyManagerInternal:Lcom/android/server/net/NetworkPolicyManagerInternal;
    ...
    iget-object v1, p0, mConnManager:Landroid/net/ConnectivityManager;

    iget-object v2, p0, mNetworkCallback:Landroid/net/ConnectivityManager$NetworkCallback;

    invoke-virtual {v1, v0, v2}, Landroid/net/ConnectivityManager;->registerNetworkCallback(Landroid/net/NetworkRequest;Landroid/net/ConnectivityManager$NetworkCallback;)V

    iget-object v1, p0, mNetPolicyManager:Landroid/net/NetworkPolicyManager;

    iget-object v2, p0, mNetPolicyListener:Landroid/net/INetworkPolicyListener;
...
.method static synthetic access$100(Lcom/android/server/job/controllers/ConnectivityController;)Landroid/util/ArraySet;
    ...
    iget-object v0, p0, mAvailableNetworks:Landroid/util/ArraySet;
...
.method static synthetic access$200(Lcom/android/server/job/controllers/ConnectivityController;ILandroid/net/Network;)V
    ...
    invoke-direct {p0, p1, p2}, updateTrackedJobs(ILandroid/net/Network;)V
...
.method static isSatisfied(Lcom/android/server/job/controllers/JobStatus;Landroid/net/Network;Landroid/net/NetworkCapabilities;Lcom/android/server/job/JobSchedulerService$Constants;)Z
    ...
    :cond_0
    invoke-static {p0, p1, p2, p3}, isInsane(Lcom/android/server/job/controllers/JobStatus;Landroid/net/Network;Landroid/net/NetworkCapabilities;Lcom/android/server/job/JobSchedulerService$Constants;)Z
    ...
    :cond_1
    invoke-static {p0, p1, p2, p3}, isCongestionDelayed(Lcom/android/server/job/controllers/JobStatus;Landroid/net/Network;Landroid/net/NetworkCapabilities;Lcom/android/server/job/JobSchedulerService$Constants;)Z
    ...
    :cond_2
    invoke-static {p0, p1, p2, p3}, isStrictSatisfied(Lcom/android/server/job/controllers/JobStatus;Landroid/net/Network;Landroid/net/NetworkCapabilities;Lcom/android/server/job/JobSchedulerService$Constants;)Z
    ...
    :cond_3
    invoke-static {p0, p1, p2, p3}, isRelaxedSatisfied(Lcom/android/server/job/controllers/JobStatus;Landroid/net/Network;Landroid/net/NetworkCapabilities;Lcom/android/server/job/JobSchedulerService$Constants;)Z
...
.method private revokeStandbyExceptionLocked(I)V
    ...
    :cond_0
    iget-object v0, p0, mNetPolicyManagerInternal:Lcom/android/server/net/NetworkPolicyManagerInternal;

    const/4 v1, 0x0

    invoke-virtual {v0, p1, v1}, Lcom/android/server/net/NetworkPolicyManagerInternal;->setAppIdleWhitelist(IZ)V

    iget-object v0, p0, mRequestedWhitelistJobs:Landroid/util/SparseArray;
...
.method private updateConstraintsSatisfied(Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    iget-object v0, p0, mConnManager:Landroid/net/ConnectivityManager;
    ...
    invoke-direct {p0, p1, v0, v1}, updateConstraintsSatisfied(Lcom/android/server/job/controllers/JobStatus;Landroid/net/Network;Landroid/net/NetworkCapabilities;)Z
...
.method private updateConstraintsSatisfied(Lcom/android/server/job/controllers/JobStatus;Landroid/net/Network;Landroid/net/NetworkCapabilities;)Z
    ...
    :goto_0
    iget-object v3, p0, mConnManager:Landroid/net/ConnectivityManager;
    ...
    invoke-static {p1, p2, p3, v5}, isSatisfied(Lcom/android/server/job/controllers/JobStatus;Landroid/net/Network;Landroid/net/NetworkCapabilities;Lcom/android/server/job/JobSchedulerService$Constants;)Z
...
.method private updateTrackedJobs(ILandroid/net/Network;)V
    ...
    iget-object v3, p0, mTrackedJobs:Landroid/util/SparseArray;
    ...
    iget-object v4, p0, mTrackedJobs:Landroid/util/SparseArray;
    ...
    invoke-direct {p0, v4, p2, v1}, updateTrackedJobsLocked(Landroid/util/ArraySet;Landroid/net/Network;Landroid/util/SparseArray;)Z
    ...
    invoke-direct {p0, v3, p2, v1}, updateTrackedJobsLocked(Landroid/util/ArraySet;Landroid/net/Network;Landroid/util/SparseArray;)Z
    ...
    iget-object v3, p0, mStateChangedListener:Lcom/android/server/job/StateChangedListener;
...
.method private updateTrackedJobsLocked(Landroid/util/ArraySet;Landroid/net/Network;Landroid/util/SparseArray;)Z
    ...
    iget-object v4, p0, mConnManager:Landroid/net/ConnectivityManager;
    ...
    :cond_5
    invoke-direct {p0, v4, v1, v3}, updateConstraintsSatisfied(Lcom/android/server/job/controllers/JobStatus;Landroid/net/Network;Landroid/net/NetworkCapabilities;)Z
...
.method public dumpControllerStateLocked(Landroid/util/proto/ProtoOutputStream;JLjava/util/function/Predicate;)V
    ...
    :goto_0
    iget-object v9, v0, mTrackedJobs:Landroid/util/SparseArray;
...
.method public dumpControllerStateLocked(Lcom/android/internal/util/IndentingPrintWriter;Ljava/util/function/Predicate;)V
    ...
    :goto_0
    iget-object v1, p0, mRequestedWhitelistJobs:Landroid/util/SparseArray;
    ...
    :goto_1
    iget-object v1, p0, mAvailableNetworks:Landroid/util/ArraySet;
    ...
    :goto_3
    iget-object v1, p0, mTrackedJobs:Landroid/util/SparseArray;
...
.method public evaluateStateLocked(Lcom/android/server/job/controllers/JobStatus;)V
    ...
    :cond_1
    invoke-virtual {p0, p1}, wouldBeReadyWithConnectivityLocked(Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    :cond_2
    invoke-virtual {p0, p1}, requestStandbyExceptionLocked(Lcom/android/server/job/controllers/JobStatus;)V
    ...
    :cond_4
    invoke-virtual {p0, p1}, maybeRevokeStandbyExceptionLocked(Lcom/android/server/job/controllers/JobStatus;)V
...
.method public isNetworkAvailable(Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    :goto_0
    :try_start_0
    iget-object v3, p0, mAvailableNetworks:Landroid/util/ArraySet;
    ...
    invoke-static {p1, v3, v4, v5}, isSatisfied(Lcom/android/server/job/controllers/JobStatus;Landroid/net/Network;Landroid/net/NetworkCapabilities;Lcom/android/server/job/JobSchedulerService$Constants;)Z
...
.method maybeRevokeStandbyExceptionLocked(Lcom/android/server/job/controllers/JobStatus;)V
    ...
    invoke-virtual {p0, v0}, isStandbyExceptionRequestedLocked(I)Z
    ...
    :cond_2
    invoke-direct {p0, v0}, revokeStandbyExceptionLocked(I)V
...
.method public maybeStartTrackingJobLocked(Lcom/android/server/job/controllers/JobStatus;Lcom/android/server/job/controllers/JobStatus;)V
    ...
    invoke-direct {p0, p1}, updateConstraintsSatisfied(Lcom/android/server/job/controllers/JobStatus;)Z

    iget-object v0, p0, mTrackedJobs:Landroid/util/SparseArray;
...
.method public onConstantsUpdatedLocked()V
    ...
    iget-object v2, p0, mNetPolicyManagerInternal:Lcom/android/server/net/NetworkPolicyManagerInternal;
...
.method public onNetworkActive()V
    ...
    iget-object v2, p0, mTrackedJobs:Landroid/util/SparseArray;
...
.method public reevaluateStateLocked(I)V
    ...
    invoke-virtual {p0, v2}, evaluateStateLocked(Lcom/android/server/job/controllers/JobStatus;)V
...
.method requestStandbyExceptionLocked(Lcom/android/server/job/controllers/JobStatus;)V
    ...
    iget-object v2, p0, mRequestedWhitelistJobs:Landroid/util/SparseArray;
    ...
    iget-object v3, p0, mRequestedWhitelistJobs:Landroid/util/SparseArray;
    ...
    :cond_2
    iget-object v3, p0, mNetPolicyManagerInternal:Lcom/android/server/net/NetworkPolicyManagerInternal;
...
.method wouldBeReadyWithConnectivityLocked(Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    invoke-virtual {p0, p1}, isNetworkAvailable(Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    invoke-virtual {p0, p1, v1}, wouldBeReadyWithConstraintLocked(Lcom/android/server/job/controllers/JobStatus;I)Z
