...
.method constructor <init>(Lcom/android/server/job/controllers/QuotaController;IILjava/lang/String;)V
    ...
    iput-object p1, p0, mRunningBgJobs:Landroid/util/ArraySet;
    ...
    iput-object p1, p0, mPkg:Lcom/android/server/job/controllers/QuotaController$Package;
...
.method private cancelCutoff()V
    ...
    iget-object v1, p0, mPkg:Lcom/android/server/job/controllers/QuotaController$Package;
...
.method private emitSessionLocked(J)V
    ...
    iget-wide v1, p0, mStartTimeElapsed:J
    ...
    iget-object v2, p0, mPkg:Lcom/android/server/job/controllers/QuotaController$Package;

    iget v2, v2, Lcom/android/server/job/controllers/QuotaController$Package;->userId:I

    iget-object v3, p0, mPkg:Lcom/android/server/job/controllers/QuotaController$Package;
    ...
    iput v1, p0, mBgJobCount:I

    invoke-direct {p0}, cancelCutoff()V
...
.method private scheduleCutoff()V
    ...
    iget-object v2, p0, this$0:Lcom/android/server/job/controllers/QuotaController;

    iget-object v3, p0, mPkg:Lcom/android/server/job/controllers/QuotaController$Package;

    iget v3, v3, Lcom/android/server/job/controllers/QuotaController$Package;->userId:I

    iget-object v4, p0, mPkg:Lcom/android/server/job/controllers/QuotaController$Package;
    ...
    iget-object v6, p0, mPkg:Lcom/android/server/job/controllers/QuotaController$Package;
    ...
    :cond_1
    iget-object v4, p0, this$0:Lcom/android/server/job/controllers/QuotaController;
...
.method dropEverythingLocked()V
    ...
    iget-object v0, p0, mRunningBgJobs:Landroid/util/ArraySet;
...
.method public dump(Landroid/util/proto/ProtoOutputStream;JLjava/util/function/Predicate;)V
    ...
    iget-wide v2, p0, mStartTimeElapsed:J

    const-wide v4, 0x10300000003L

    invoke-virtual {p1, v4, v5, v2, v3}, Landroid/util/proto/ProtoOutputStream;->write(JJ)V

    iget v2, p0, mBgJobCount:I
    ...
    :goto_0
    iget-object v3, p0, mRunningBgJobs:Landroid/util/ArraySet;
...
.method public dump(Lcom/android/internal/util/IndentingPrintWriter;Ljava/util/function/Predicate;)V
    ...
    iget-object v0, p0, mPkg:Lcom/android/server/job/controllers/QuotaController$Package;
    ...
    iget-wide v0, p0, mStartTimeElapsed:J
    ...
    :goto_1
    iget-object v1, p0, mRunningBgJobs:Landroid/util/ArraySet;
...
.method onStateChangedLocked(JZ)V
    ...
    invoke-direct {p0, p1, p2}, emitSessionLocked(J)V
    ...
    invoke-direct {p0}, shouldTrackLocked()Z
    ...
    iput-wide p1, p0, mStartTimeElapsed:J
    ...
    invoke-direct {p0}, scheduleCutoff()V
...
.method startTrackingJobLocked(Lcom/android/server/job/controllers/JobStatus;)V
    ...
    iput-wide v0, p0, mStartTimeElapsed:J
...
.method stopTrackingJob(Lcom/android/server/job/controllers/JobStatus;)V
    ...
    invoke-direct {p0, v1, v2}, emitSessionLocked(J)V
