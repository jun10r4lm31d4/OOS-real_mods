...
.method public updateDescriptor(Landroid/media/RemoteDisplayState;)Z
    ...
    iget-object v1, p0, mDescriptor:Landroid/media/RemoteDisplayState;
    ...
    invoke-direct {p0, v7}, findRouteByDescriptorId(Ljava/lang/String;)I

    move-result v8

    if-gez v8, :cond_0

    invoke-direct {p0, v7}, assignRouteUniqueId(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_1
    iget-object v9, p0, mRoutes:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, mProvider:Lcom/android/server/media/RemoteDisplayProviderProxy;
