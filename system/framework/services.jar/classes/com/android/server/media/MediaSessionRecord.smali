...
.method public constructor <init>(IIILjava/lang/String;Landroid/media/session/ISessionCallback;Ljava/lang/String;Landroid/os/Bundle;Lcom/android/server/media/MediaSessionService;Landroid/os/Looper;)V
    ...
    iput-object v0, p0, mControllerCallbackHolders:Ljava/util/ArrayList;

    const/4 v0, 0x1

    iput v0, p0, mVolumeType:I

    const/4 v1, 0x2

    iput v1, p0, mVolumeControlType:I
    ...
    iput v2, p0, mOptimisticVolume:I
    ...
    iput-object v1, p0, mClearOptimisticVolumeRunnable:Ljava/lang/Runnable;
    ...
    iput-object p7, p0, mSessionInfo:Landroid/os/Bundle;
    ...
    iput-object v1, p0, mController:Lcom/android/server/media/MediaSessionRecord$ControllerStub;

    new-instance v1, Landroid/media/session/MediaSession$Token;

    iget-object v2, p0, mController:Lcom/android/server/media/MediaSessionRecord$ControllerStub;

    invoke-direct {v1, v2}, Landroid/media/session/MediaSession$Token;-><init>(Landroid/media/session/ISessionController;)V

    iput-object v1, p0, mSessionToken:Landroid/media/session/MediaSession$Token;
    ...
    iput-object v1, p0, mSession:Lcom/android/server/media/MediaSessionRecord$SessionStub;
    ...
    iput-object v1, p0, mSessionCb:Lcom/android/server/media/MediaSessionRecord$SessionCb;

    iput-object p8, p0, mService:Lcom/android/server/media/MediaSessionService;

    iget-object v1, p0, mService:Lcom/android/server/media/MediaSessionService;
    ...
    iput-object v1, p0, mHandler:Lcom/android/server/media/MediaSessionRecord$MessageHandler;
...
.method static synthetic access$1802(Lcom/android/server/media/MediaSessionRecord;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object p1, p0, mMetadataDescription:Ljava/lang/String;
...
.method static synthetic access$2002(Lcom/android/server/media/MediaSessionRecord;Ljava/util/List;)Ljava/util/List;
    ...
    iput-object p1, p0, mQueue:Ljava/util/List;
...
.method static synthetic access$3100(Lcom/android/server/media/MediaSessionRecord;Landroid/media/session/ISessionControllerCallback;)I
    ...
    invoke-direct {p0, p1}, getControllerHolderIndexForCb(Landroid/media/session/ISessionControllerCallback;)I
...
.method static synthetic access$3200(Lcom/android/server/media/MediaSessionRecord;)Ljava/util/ArrayList;
    ...
    iget-object v0, p0, mControllerCallbackHolders:Ljava/util/ArrayList;
...
.method static synthetic access$3600(Lcom/android/server/media/MediaSessionRecord;)Landroid/os/Bundle;
    ...
    iget-object v0, p0, mSessionInfo:Landroid/os/Bundle;
...
.method static synthetic access$3700(Lcom/android/server/media/MediaSessionRecord;)Landroid/media/session/MediaController$PlaybackInfo;
    ...
    invoke-direct {p0}, getVolumeAttributes()Landroid/media/session/MediaController$PlaybackInfo;
...
.method static synthetic access$3800(Lcom/android/server/media/MediaSessionRecord;Ljava/lang/String;Ljava/lang/String;IILandroid/media/session/ISessionControllerCallback;II)V
    ...
    invoke-direct/range {p0 .. p7}, setVolumeTo(Ljava/lang/String;Ljava/lang/String;IILandroid/media/session/ISessionControllerCallback;II)V
...
.method private getControllerHolderIndexForCb(Landroid/media/session/ISessionControllerCallback;)I
    ...
    iget-object v1, p0, mControllerCallbackHolders:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, mControllerCallbackHolders:Ljava/util/ArrayList;
...
.method private getStateWithUpdatedPosition()Landroid/media/session/PlaybackState;
    ...
    :try_start_0
    iget-object v0, v1, mPlaybackState:Landroid/media/session/PlaybackState;

    iget-wide v3, v1, mDuration:J
...
.method private getVolumeAttributes()Landroid/media/session/MediaController$PlaybackInfo;
    ...
    :try_start_0
    iget v1, p0, mVolumeType:I

    const/4 v2, 0x2

    if-ne v1, v2, :cond_1

    iget v1, p0, mOptimisticVolume:I
    ...
    iget v3, p0, mVolumeType:I

    iget v4, p0, mVolumeControlType:I

    iget v5, p0, mMaxVolume:I

    iget-object v7, p0, mAudioAttrs:Landroid/media/AudioAttributes;
...
.method private postAdjustLocalVolume(IIILjava/lang/String;IIZZI)V
    ...
    :goto_1
    iget-object v8, v9, mHandler:Lcom/android/server/media/MediaSessionRecord$MessageHandler;
...
.method private pushEvent(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v4, v2, v3}, logCallbackException(Ljava/lang/String;Lcom/android/server/media/MediaSessionRecord$ISessionControllerCallbackHolder;Ljava/lang/Exception;)V
    ...
    iget-object v4, p0, mControllerCallbackHolders:Ljava/util/ArrayList;
...
.method private pushMetadataUpdate()V
    ...
    iget-object v4, p0, mMetadata:Landroid/media/MediaMetadata;
...
.method private pushPlaybackStateUpdate()V
    ...
    iget-object v4, p0, mPlaybackState:Landroid/media/session/PlaybackState;
...
.method private pushQueueTitleUpdate()V
    ...
    iget-object v4, p0, mQueueTitle:Ljava/lang/CharSequence;
...
.method private pushQueueUpdate()V
    ...
    iget-object v4, p0, mQueue:Ljava/util/List;
    ...
    iget-object v5, p0, mQueue:Ljava/util/List;
...
.method private pushVolumeUpdate()V
    ...
    iget-object v3, p0, mControllerCallbackHolders:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v5, v3, v4}, logCallbackException(Ljava/lang/String;Lcom/android/server/media/MediaSessionRecord$ISessionControllerCallbackHolder;Ljava/lang/Exception;)V
    ...
    iget-object v5, p0, mControllerCallbackHolders:Ljava/util/ArrayList;
...
.method private setVolumeTo(Ljava/lang/String;Ljava/lang/String;IILandroid/media/session/ISessionControllerCallback;II)V
    ...
    iget v0, v7, mVolumeType:I

    const/4 v1, 0x1

    if-ne v0, v1, :cond_0

    iget-object v0, v7, mAudioAttrs:Landroid/media/AudioAttributes;
    ...
    iget-object v9, v7, mHandler:Lcom/android/server/media/MediaSessionRecord$MessageHandler;
    ...
    :cond_0
    iget v0, v7, mVolumeControlType:I
    ...
    iget-object v8, v7, mSessionCb:Lcom/android/server/media/MediaSessionRecord$SessionCb;
    ...
    iget v1, v7, mOptimisticVolume:I

    if-gez v1, :cond_2

    iget v1, v7, mCurrentVolume:I

    :cond_2
    iget v3, v7, mMaxVolume:I
    ...
    iput v2, v7, mOptimisticVolume:I

    iget-object v2, v7, mHandler:Lcom/android/server/media/MediaSessionRecord$MessageHandler;

    iget-object v3, v7, mClearOptimisticVolumeRunnable:Ljava/lang/Runnable;
    ...
    iget v2, v7, mOptimisticVolume:I
    ...
    :cond_3
    iget-object v2, v7, mService:Lcom/android/server/media/MediaSessionService;
    ...
    iget v4, v7, mOptimisticVolume:I
...
.method public adjustVolume(Ljava/lang/String;Ljava/lang/String;IILandroid/media/session/ISessionControllerCallback;ZIIZ)V
    ...
    invoke-virtual {p0}, isPlaybackActive()Z
    ...
    :goto_1
    iget v0, v10, mVolumeType:I

    const/4 v1, 0x1

    if-ne v0, v1, :cond_2

    iget-object v0, v10, mAudioAttrs:Landroid/media/AudioAttributes;
    ...
    invoke-direct/range {v0 .. v9}, postAdjustLocalVolume(IIILjava/lang/String;IIZZI)V
    ...
    :cond_2
    iget v0, v10, mVolumeControlType:I
    ...
    :goto_2
    iget-object v0, v10, mSessionCb:Lcom/android/server/media/MediaSessionRecord$SessionCb;
    ...
    iget v0, v10, mOptimisticVolume:I

    if-gez v0, :cond_6

    iget v0, v10, mCurrentVolume:I

    :cond_6
    add-int v1, v0, v11

    iput v1, v10, mOptimisticVolume:I

    const/4 v1, 0x0

    iget v2, v10, mOptimisticVolume:I

    iget v3, v10, mMaxVolume:I
    ...
    iget-object v1, v10, mHandler:Lcom/android/server/media/MediaSessionRecord$MessageHandler;

    iget-object v2, v10, mClearOptimisticVolumeRunnable:Ljava/lang/Runnable;
    ...
    iget v1, v10, mOptimisticVolume:I
    ...
    :cond_7
    iget-object v1, v10, mService:Lcom/android/server/media/MediaSessionService;
...
.method public dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    iget-object v2, p0, mPlaybackState:Landroid/media/session/PlaybackState;
    ...
    iget-object v2, p0, mMetadataDescription:Ljava/lang/String;
...
.method public onDestroy()V
    ...
    iget-object v1, p0, mHandler:Lcom/android/server/media/MediaSessionRecord$MessageHandler;
