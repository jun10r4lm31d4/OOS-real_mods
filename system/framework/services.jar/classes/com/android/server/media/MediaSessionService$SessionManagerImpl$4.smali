...
.method constructor <init>(Lcom/android/server/media/MediaSessionService$SessionManagerImpl;ZLjava/lang/String;IIIILjava/lang/String;)V
    ...
    iput-boolean p2, p0, val$asSystemService:Z

    iput-object p3, p0, val$opPackageName:Ljava/lang/String;

    iput p4, p0, val$uid:I

    iput p5, p0, val$suggestedStream:I

    iput p6, p0, val$direction:I

    iput p7, p0, val$flags:I

    iput-object p8, p0, val$packageName:Ljava/lang/String;
...
.method public run()V
    ...
    iget-boolean v0, p0, val$asSystemService:Z
    ...
    :cond_0
    iget-object v0, p0, val$opPackageName:Ljava/lang/String;

    iget v1, p0, val$uid:I
    ...
    iget v3, p0, val$suggestedStream:I

    iget v4, p0, val$direction:I
    ...
    iget v4, p0, val$suggestedStream:I
    ...
    iget-boolean v4, p0, val$asSystemService:Z
