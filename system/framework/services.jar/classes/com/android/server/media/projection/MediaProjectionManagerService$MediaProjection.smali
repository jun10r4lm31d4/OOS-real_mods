...
.method constructor <init>(Lcom/android/server/media/projection/MediaProjectionManagerService;IILjava/lang/String;IZ)V
    ...
    iput-object p1, p0, userHandle:Landroid/os/UserHandle;

    iput p5, p0, mTargetSdkVersion:I

    iput-boolean p6, p0, mIsPrivileged:Z
...
.method requiresForegroundService()Z
    ...
    iget-boolean v0, p0, mIsPrivileged:Z
...
.method public start(Landroid/media/projection/IMediaProjectionCallback;)V
    ...
    invoke-virtual {p0}, requiresForegroundService()Z
    ...
    iget-object v2, p0, mCallback:Landroid/media/projection/IMediaProjectionCallback;

    invoke-virtual {p0, v2}, registerCallback(Landroid/media/projection/IMediaProjectionCallback;)V
    :try_end_0
    ...
    iput-object v2, p0, mDeathEater:Landroid/os/IBinder$DeathRecipient;
...
.method public stop()V
    ...
    iget-object v3, p0, mCallback:Landroid/media/projection/IMediaProjectionCallback;

    invoke-virtual {p0, v3}, unregisterCallback(Landroid/media/projection/IMediaProjectionCallback;)V

    iput-object v2, p0, mCallback:Landroid/media/projection/IMediaProjectionCallback;
