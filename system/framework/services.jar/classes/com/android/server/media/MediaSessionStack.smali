...
.method constructor <init>(Lcom/android/server/media/AudioPlayerStateMonitor;Lcom/android/server/media/MediaSessionStack$OnMediaButtonSessionChangedListener;)V
    ...
    iput-object v0, p0, mSessions:Ljava/util/List;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, mCachedActiveLists:Landroid/util/SparseArray;

    iput-object p1, p0, mAudioPlayerStateMonitor:Lcom/android/server/media/AudioPlayerStateMonitor;

    iput-object p2, p0, mOnMediaButtonSessionChangedListener:Lcom/android/server/media/MediaSessionStack$OnMediaButtonSessionChangedListener;
...
.method private clearCache(I)V
    ...
    iget-object v0, p0, mCachedActiveLists:Landroid/util/SparseArray;
...
.method private findMediaButtonSession(I)Lcom/android/server/media/MediaSessionRecord;
    ...
    iget-object v1, p0, mSessions:Ljava/util/List;
    ...
    iget-object v4, p0, mAudioPlayerStateMonitor:Lcom/android/server/media/AudioPlayerStateMonitor;
...
.method private shouldUpdatePriority(II)Z
    ...
    sget-object v0, ALWAYS_PRIORITY_STATES:[I

    invoke-direct {p0, p2, v0}, containsState(I[I)Z
    ...
    :cond_0
    sget-object v0, TRANSITION_PRIORITY_STATES:[I

    invoke-direct {p0, p1, v0}, containsState(I[I)Z
...
.method private updateMediaButtonSession(Lcom/android/server/media/MediaSessionRecord;)V
    ...
    iget-object v0, p0, mMediaButtonSession:Lcom/android/server/media/MediaSessionRecord;

    iput-object p1, p0, mMediaButtonSession:Lcom/android/server/media/MediaSessionRecord;

    iget-object v1, p0, mOnMediaButtonSessionChangedListener:Lcom/android/server/media/MediaSessionStack$OnMediaButtonSessionChangedListener;
...
.method public addSession(Lcom/android/server/media/MediaSessionRecord;)V
    ...
    iget-object v0, p0, mSessions:Ljava/util/List;
    ...
    invoke-direct {p0, v0}, clearCache(I)V

    invoke-virtual {p0}, updateMediaButtonSessionIfNeeded()V
...
.method public dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0, v1}, getPriorityList(ZI)Ljava/util/ArrayList;
    ...
    iget-object v3, p0, mMediaButtonSession:Lcom/android/server/media/MediaSessionRecord;
...
.method public getActiveSessions(I)Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v1, p1}, getPriorityList(ZI)Ljava/util/ArrayList;

    move-result-object v0

    iget-object v1, p0, mCachedActiveLists:Landroid/util/SparseArray;
...
.method public getDefaultRemoteSession(I)Lcom/android/server/media/MediaSessionRecord;
    ...
    invoke-virtual {p0, v0, p1}, getPriorityList(ZI)Ljava/util/ArrayList;
...
.method public getDefaultVolumeSession()Lcom/android/server/media/MediaSessionRecord;
    ...
    iget-object v0, p0, mCachedVolumeDefault:Lcom/android/server/media/MediaSessionRecord;
    ...
    invoke-virtual {p0, v1, v0}, getPriorityList(ZI)Ljava/util/ArrayList;
    ...
    iput-object v3, p0, mCachedVolumeDefault:Lcom/android/server/media/MediaSessionRecord;
...
.method public getMediaButtonSession()Lcom/android/server/media/MediaSessionRecord;
    ...
    iget-object v2, p0, mMediaButtonSession:Lcom/android/server/media/MediaSessionRecord;
    ...
    iget-object v3, p0, mSessions:Ljava/util/List;
    ...
    :cond_1
    iget-object v1, p0, mMediaButtonSession:Lcom/android/server/media/MediaSessionRecord;
...
.method public getPriorityList(ZI)Ljava/util/ArrayList;
    ...
    iget-object v5, p0, mSessions:Ljava/util/List;
...
.method public onPlaystateChanged(Lcom/android/server/media/MediaSessionRecord;II)V
    ...
    invoke-direct {p0, v0}, findMediaButtonSession(I)Lcom/android/server/media/MediaSessionRecord;
    ...
    invoke-direct {p0, v0}, updateMediaButtonSession(Lcom/android/server/media/MediaSessionRecord;)V
...
.method public updateMediaButtonSessionIfNeeded()V
    ...
    invoke-direct {p0, v2}, findMediaButtonSession(I)Lcom/android/server/media/MediaSessionRecord;

    move-result-object v2

    if-eqz v2, :cond_2

    iget-object v3, p0, mAudioPlayerStateMonitor:Lcom/android/server/media/AudioPlayerStateMonitor;
    ...
    invoke-direct {p0, v2}, updateMediaButtonSession(Lcom/android/server/media/MediaSessionRecord;)V
