...
.method constructor <init>(Lcom/android/server/media/MediaSessionRecord;ZIIILjava/lang/String;II)V
    ...
    iput-boolean p2, p0, val$useSuggested:Z

    iput p3, p0, val$stream:I

    iput p4, p0, val$direction:I

    iput p5, p0, val$flags:I

    iput-object p6, p0, val$opPackageName:Ljava/lang/String;

    iput p7, p0, val$uid:I

    iput p8, p0, val$previousFlagPlaySound:I
...
.method public run()V
    ...
    :try_start_0
    iget-boolean v0, p0, val$useSuggested:Z

    if-eqz v0, :cond_1

    iget v0, p0, val$stream:I
    ...
    iget v2, p0, val$stream:I

    iget v3, p0, val$direction:I

    iget v4, p0, val$flags:I

    iget-object v5, p0, val$opPackageName:Ljava/lang/String;

    iget v6, p0, val$uid:I
    ...
    iget v0, p0, val$flags:I

    iget v4, p0, val$previousFlagPlaySound:I
    ...
    iget-object v2, p0, val$opPackageName:Ljava/lang/String;
    ...
    iget-boolean v2, p0, val$useSuggested:Z
    ...
    iget v2, p0, val$previousFlagPlaySound:I
