...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mActivePlayerMinPriorityQueue:Landroid/util/IntArray;

    new-instance v0, Landroid/util/IntArray;

    invoke-direct {v0}, Landroid/util/IntArray;-><init>()V

    iput-object v0, p0, mActivePlayerUidMinPriorityQueue:Landroid/util/IntArray;
    ...
    iput v0, p0, mAudioRouteMainType:I
...
.method static synthetic access$000(Lcom/android/server/media/MediaRouterService;)Landroid/util/IntArray;
    ...
    iget-object v0, p0, mActivePlayerMinPriorityQueue:Landroid/util/IntArray;
...
.method static synthetic access$100(Lcom/android/server/media/MediaRouterService;)Landroid/util/IntArray;
    ...
    iget-object v0, p0, mActivePlayerUidMinPriorityQueue:Landroid/util/IntArray;
...
.method private getStateLocked(Landroid/media/IMediaRouterClient;)Landroid/media/MediaRouterClientState;
    ...
    iget-object v0, p0, mAllClientRecords:Landroid/util/ArrayMap;
...
.method private registerClientLocked(Landroid/media/IMediaRouterClient;IILjava/lang/String;IZ)V
    ...
    iget-object v0, v9, mAllClientRecords:Landroid/util/ArrayMap;
    ...
    iget-object v2, v9, mUserRecords:Landroid/util/SparseArray;
    ...
    iget-object v0, v9, mUserRecords:Landroid/util/SparseArray;

    invoke-virtual {v0, v10, v12}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    invoke-direct {p0, v12}, initializeUserLocked(Lcom/android/server/media/MediaRouterService$UserRecord;)V
    ...
    invoke-direct {p0, v1}, initializeClientLocked(Lcom/android/server/media/MediaRouterService$ClientRecord;)V
...
.method clientDied(Lcom/android/server/media/MediaRouterService$ClientRecord;)V
    ...
    invoke-direct {p0, v1, v2}, unregisterClientLocked(Landroid/media/IMediaRouterClient;Z)V
...
.method public isPlaybackActive(Landroid/media/IMediaRouterClient;)Z
    ...
    :try_start_1
    iget-object v3, p0, mAllClientRecords:Landroid/util/ArrayMap;
    ...
    :try_start_2
    iget-object v2, p0, mAudioPlayerStateMonitor:Lcom/android/server/media/AudioPlayerStateMonitor;
...
.method public registerClientAsUser(Landroid/media/IMediaRouterClient;Ljava/lang/String;I)V
    ...
    invoke-direct {v8, v9, v10}, validatePackageName(ILjava/lang/String;)Z
    ...
    :try_start_0
    iget-object v15, v8, mLock:Ljava/lang/Object;
    ...
    :try_start_1
    invoke-direct/range {v1 .. v7}, registerClientLocked(Landroid/media/IMediaRouterClient;IILjava/lang/String;IZ)V
...
.method public registerClientGroupId(Landroid/media/IMediaRouterClient;Ljava/lang/String;)V
    ...
    :try_start_1
    invoke-direct {p0, p1, p2}, registerClientGroupIdLocked(Landroid/media/IMediaRouterClient;Ljava/lang/String;)V
...
.method restoreBluetoothA2dp()V
    ...
    :try_start_1
    iget-boolean v1, p0, mGlobalBluetoothA2dpOn:Z

    iget-object v2, p0, mActiveBluetoothDevice:Landroid/bluetooth/BluetoothDevice;
...
.method restoreRoute(I)V
    ...
    invoke-direct {p0, p1, v5}, validatePackageName(ILjava/lang/String;)Z
    ...
    :cond_2
    invoke-virtual {p0}, restoreBluetoothA2dp()V
...
.method switchUser()V
    ...
    invoke-direct {p0, v3}, disposeUserIfNeededLocked(Lcom/android/server/media/MediaRouterService$UserRecord;)V
...
.method public unregisterClient(Landroid/media/IMediaRouterClient;)V
    ...
    :try_start_1
    invoke-direct {p0, p1, v3}, unregisterClientLocked(Landroid/media/IMediaRouterClient;Z)V
