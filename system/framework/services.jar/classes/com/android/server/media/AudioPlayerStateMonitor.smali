...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mActiveAudioUids:Ljava/util/Set;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, mPrevActiveAudioPlaybackConfigs:Landroid/util/ArrayMap;

    new-instance v0, Landroid/util/IntArray;

    invoke-direct {v0}, Landroid/util/IntArray;-><init>()V

    iput-object v0, p0, mSortedAudioPlaybackClientUids:Landroid/util/IntArray;
...
.method static synthetic access$400(Lcom/android/server/media/AudioPlayerStateMonitor;Landroid/media/AudioPlaybackConfiguration;Z)V
    ...
    invoke-direct {p0, p1, p2}, sendAudioPlayerActiveStateChangedMessageLocked(Landroid/media/AudioPlaybackConfiguration;Z)V
...
.method static getInstance(Landroid/content/Context;)Lcom/android/server/media/AudioPlayerStateMonitor;
    ...
    :try_start_0
    sget-object v1, sInstance:Lcom/android/server/media/AudioPlayerStateMonitor;
    ...
    sput-object v1, sInstance:Lcom/android/server/media/AudioPlayerStateMonitor;
...
.method public cleanUpAudioPlaybackUids(I)V
    ...
    iget-object v2, p0, mSortedAudioPlaybackClientUids:Landroid/util/IntArray;
    ...
    iget-object v3, p0, mSortedAudioPlaybackClientUids:Landroid/util/IntArray;
    ...
    invoke-virtual {p0, v3}, isPlaybackActive(I)Z

    move-result v4

    if-nez v4, :cond_1

    iget-object v4, p0, mSortedAudioPlaybackClientUids:Landroid/util/IntArray;
...
.method public isPlaybackActive(I)Z
    ...
    :try_start_0
    iget-object v1, p0, mActiveAudioUids:Ljava/util/Set;
