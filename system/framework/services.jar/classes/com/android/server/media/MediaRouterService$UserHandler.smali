...
.method private checkSelectedRouteState()V
    ...
    iget-object v0, p0, mSelectedRouteRecord:Lcom/android/server/media/MediaRouterService$UserHandler$RouteRecord;
    ...
    iget-object v3, p0, mSelectedRouteRecord:Lcom/android/server/media/MediaRouterService$UserHandler$RouteRecord;

    invoke-virtual {v3}, Lcom/android/server/media/MediaRouterService$UserHandler$RouteRecord;->getStatus()I

    move-result v3

    invoke-static {v3}, getConnectionPhase(I)I

    move-result v3

    iput v3, p0, mConnectionPhase:I
    ...
    iget-object v2, p0, mSelectedRouteRecord:Lcom/android/server/media/MediaRouterService$UserHandler$RouteRecord;
...
.method private connectionTimedOut()V
    ...
    invoke-direct {p0}, unselectSelectedRoute()V
...
.method private findProviderRecord(Lcom/android/server/media/RemoteDisplayProviderProxy;)I
    ...
    iget-object v0, p0, mProviderRecords:Ljava/util/ArrayList;
...
.method private selectRoute(Ljava/lang/String;)V
    ...
    iput-object v0, p0, mSelectedRouteRecord:Lcom/android/server/media/MediaRouterService$UserHandler$RouteRecord;

    invoke-direct {p0}, checkSelectedRouteState()V
...
.method private unselectSelectedRoute()V
    ...
    iget-object v1, p0, mSelectedRouteRecord:Lcom/android/server/media/MediaRouterService$UserHandler$RouteRecord;
    ...
    iput-object v1, p0, mSelectedRouteRecord:Lcom/android/server/media/MediaRouterService$UserHandler$RouteRecord;
...
.method private updateClientState()V
    ...
    :cond_0
    :try_start_0
    iget-object v2, p0, mService:Lcom/android/server/media/MediaRouterService;
    ...
    :try_start_1
    iget-object v3, p0, mUserRecord:Lcom/android/server/media/MediaRouterService$UserRecord;
    ...
    iget-object v5, p0, mTempClients:Ljava/util/ArrayList;
    ...
    :try_start_2
    iget-object v2, p0, mTempClients:Ljava/util/ArrayList;
    ...
    :try_start_3
    iget-object v4, p0, mTempClients:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, mTempClients:Ljava/util/ArrayList;
...
.method private updateConnectionTimeout(I)V
    ...
    iput-wide v2, p0, mConnectionTimeoutStartTime:J
    ...
    :cond_3
    invoke-virtual {p0, v1}, sendEmptyMessage(I)Z
...
.method private updateDiscoveryRequest()V
    ...
    iget-object v5, p0, mUserRecord:Lcom/android/server/media/MediaRouterService$UserRecord;
    ...
    :goto_1
    iget v3, p0, mDiscoveryMode:I

    if-eq v3, v2, :cond_3

    iput v2, p0, mDiscoveryMode:I
    ...
    iget-object v5, p0, mProviderRecords:Ljava/util/ArrayList;
...
.method private updateSelectedRoute(Ljava/lang/String;)V
    ...
    :try_start_0
    iget-object v1, p0, mService:Lcom/android/server/media/MediaRouterService;
    ...
    iget-object v1, p0, mTempClients:Ljava/util/ArrayList;
    ...
    :cond_3
    iget-object v0, p0, mTempClients:Ljava/util/ArrayList;
...
.method public dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    iget v2, p0, mConnectionTimeoutReason:I
    ...
    iget-wide v2, p0, mConnectionTimeoutStartTime:J
    ...
    iget-object v1, p0, mWatcher:Lcom/android/server/media/RemoteDisplayProviderWatcher;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-direct {p0, v0}, updateSelectedRoute(Ljava/lang/String;)V
