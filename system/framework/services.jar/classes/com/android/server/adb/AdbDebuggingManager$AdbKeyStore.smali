...
.method constructor <init>(Lcom/android/server/adb/AdbDebuggingManager;Ljava/io/File;)V
    ...
    iput-object p2, p0, mKeyFile:Ljava/io/File;
...
.method private addUserKeysToKeyStore()V
    ...
    iget-object v0, p0, this$0:Lcom/android/server/adb/AdbDebuggingManager;
    ...
    iget-object v6, p0, mKeyMap:Ljava/util/Map;
    ...
    iget-object v2, p0, this$0:Lcom/android/server/adb/AdbDebuggingManager;
...
.method private filterOutOldKeys()Z
    ...
    invoke-virtual {p0}, getAllowedConnectionTime()J
    ...
    iget-object v5, p0, mKeyMap:Ljava/util/Map;
    ...
    iget-object v6, p0, this$0:Lcom/android/server/adb/AdbDebuggingManager;

    iget-object v7, p0, mKeyMap:Ljava/util/Map;
...
.method private getKeyMap()Ljava/util/Map;
    ...
    iget-object v2, p0, mAtomicKeyFile:Landroid/util/AtomicFile;

    const-string v3, "AdbDebuggingManager"

    if-nez v2, :cond_0

    invoke-direct {p0}, initKeyFile()V
    ...
    iget-object v2, p0, mKeyFile:Ljava/io/File;
    ...
    :try_start_4
    invoke-static {v7, v2}, $closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_4
...
.method private init()V
    ...
    invoke-direct {p0}, getKeyMap()Ljava/util/Map;

    move-result-object v0

    iput-object v0, p0, mKeyMap:Ljava/util/Map;

    const-string v0, "/adb_keys"

    invoke-direct {p0, v0}, getSystemKeysFromFile(Ljava/lang/String;)Ljava/util/Set;

    move-result-object v0

    iput-object v0, p0, mSystemKeys:Ljava/util/Set;

    invoke-direct {p0}, addUserKeysToKeyStore()V
...
.method private initKeyFile()V
    ...
    iget-object v0, p0, mKeyFile:Ljava/io/File;
    ...
    iput-object v0, p0, mKeyFile:Ljava/io/File;
    ...
    iput-object v1, p0, mAtomicKeyFile:Landroid/util/AtomicFile;
...
.method public deleteKeyStore()V
    ...
    iget-object v0, p0, mKeyMap:Ljava/util/Map;
    ...
    iget-object v0, p0, mAtomicKeyFile:Landroid/util/AtomicFile;
...
.method public getNextExpirationTime()J
    ...
    invoke-virtual/range {p0 .. p0}, getAllowedConnectionTime()J
    ...
    iget-object v9, v8, mKeyMap:Ljava/util/Map;
...
.method public isKeyAuthorized(Ljava/lang/String;)Z
    ...
    iget-object v0, p0, mSystemKeys:Ljava/util/Set;
    ...
    :cond_0
    invoke-virtual {p0, p1}, getLastConnectionTime(Ljava/lang/String;)J
...
.method public persistKeyStore()V
    ...
    invoke-direct {p0}, filterOutOldKeys()Z

    iget-object v1, p0, mKeyMap:Ljava/util/Map;
    ...
    invoke-virtual {p0}, deleteKeyStore()V

    return-void

    :cond_0
    iget-object v1, p0, mAtomicKeyFile:Landroid/util/AtomicFile;
    ...
    iget-object v1, p0, mKeyFile:Ljava/io/File;
    ...
    iget-object v4, p0, mAtomicKeyFile:Landroid/util/AtomicFile;
    ...
    iget-object v4, p0, mKeyMap:Ljava/util/Map;
...
.method public setLastConnectionTime(Ljava/lang/String;J)V
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, setLastConnectionTime(Ljava/lang/String;JZ)V
