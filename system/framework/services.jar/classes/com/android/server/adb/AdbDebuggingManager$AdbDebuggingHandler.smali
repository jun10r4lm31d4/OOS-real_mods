...
.method constructor <init>(Lcom/android/server/adb/AdbDebuggingManager;Landroid/os/Looper;)V
    ...
    iput-object v0, p0, mAuthTimeObserver:Landroid/database/ContentObserver;
...
.method constructor <init>(Lcom/android/server/adb/AdbDebuggingManager;Landroid/os/Looper;Lcom/android/server/adb/AdbDebuggingManager$AdbDebuggingThread;Lcom/android/server/adb/AdbDebuggingManager$AdbKeyStore;)V
    ...
    iput-object p4, p0, mAdbKeyStore:Lcom/android/server/adb/AdbDebuggingManager$AdbKeyStore;
...
.method private logAdbConnectionChanged(Ljava/lang/String;IZ)V
    ...
    iget-object v0, p0, mAdbKeyStore:Lcom/android/server/adb/AdbDebuggingManager$AdbKeyStore;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    :cond_0
    iget-object v1, p0, this$0:Lcom/android/server/adb/AdbDebuggingManager;
    ...
    :cond_1
    iget-object v1, p0, mAdbKeyStore:Lcom/android/server/adb/AdbDebuggingManager$AdbKeyStore;
    ...
    invoke-virtual {p0}, scheduleJobToUpdateAdbKeyStore()J

    const/4 v1, 0x4

    invoke-direct {p0, v0, v1, v7}, logAdbConnectionChanged(Ljava/lang/String;IZ)V
    ...
    iget-object v2, p0, mAdbKeyStore:Lcom/android/server/adb/AdbDebuggingManager$AdbKeyStore;
    ...
    invoke-direct {p0, v0, v2, v1}, logAdbConnectionChanged(Ljava/lang/String;IZ)V
    ...
    :cond_7
    invoke-direct {p0}, cancelJobToUpdateAdbKeyStore()V
    ...
    invoke-direct {p0, v0, v1, v6}, logAdbConnectionChanged(Ljava/lang/String;IZ)V
    ...
    :cond_b
    invoke-direct {p0, v0, v7, v6}, logAdbConnectionChanged(Ljava/lang/String;IZ)V
    ...
    invoke-direct {p0, v3, v0, v6}, logAdbConnectionChanged(Ljava/lang/String;IZ)V
    ...
    iget-object v5, p0, this$0:Lcom/android/server/adb/AdbDebuggingManager;
    ...
    :cond_f
    invoke-direct {p0, v0, v1, v4}, logAdbConnectionChanged(Ljava/lang/String;IZ)V
    ...
    :cond_14
    invoke-virtual {p0}, registerForAuthTimeChanges()V
    ...
    iput-object v0, p0, mAdbKeyStore:Lcom/android/server/adb/AdbDebuggingManager$AdbKeyStore;
...
.method registerForAuthTimeChanges()V
    ...
    iget-object v2, p0, mAuthTimeObserver:Landroid/database/ContentObserver;
...
.method scheduleJobToUpdateAdbKeyStore()J
    ...
    invoke-virtual {p0, v4}, obtainMessage(I)Landroid/os/Message;

    move-result-object v4

    invoke-virtual {p0, v4, v2, v3}, sendMessageDelayed(Landroid/os/Message;J)Z
