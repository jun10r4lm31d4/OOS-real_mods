...
.method static constructor <clinit>()V
    ...
    sput-object v0, sBinder:Landroid/os/Binder;
...
.method constructor <init>(Lcom/android/internal/app/IAppOpsService;Lcom/android/server/appop/AppOpsService;)V
    ...
    iput-object p1, p0, mInterface:Lcom/android/internal/app/IAppOpsService;

    iput-object p2, p0, mInternal:Lcom/android/server/appop/AppOpsService;

    :try_start_0
    iget-object v0, p0, mInterface:Lcom/android/internal/app/IAppOpsService;

    sget-object v1, sBinder:Landroid/os/Binder;
...
.method static synthetic access$1100(Ljava/lang/String;Ljava/io/PrintWriter;)I
    ...
    invoke-static {p0, p1}, strOpToOp(Ljava/lang/String;Ljava/io/PrintWriter;)I
...
.method parseUserOpMode(ILjava/io/PrintWriter;)I
    ...
    iput-object v0, p0, opStr:Ljava/lang/String;

    iput-object v0, p0, modeStr:Ljava/lang/String;
    ...
    :cond_1
    iget-object v0, p0, opStr:Ljava/lang/String;

    if-nez v0, :cond_2

    iput-object v1, p0, opStr:Ljava/lang/String;

    goto :goto_0

    :cond_2
    iget-object v0, p0, modeStr:Ljava/lang/String;

    if-nez v0, :cond_0

    iput-object v1, p0, modeStr:Ljava/lang/String;
    ...
    :cond_4
    invoke-static {v0, p2}, strOpToOp(Ljava/lang/String;Ljava/io/PrintWriter;)I
    ...
    invoke-static {v0, p2}, strModeToMode(Ljava/lang/String;Ljava/io/PrintWriter;)I
...
.method parseUserPackageOp(ZLjava/io/PrintWriter;)I
    ...
    iput-boolean v4, p0, targetsUid:Z
    ...
    :cond_3
    iget-object v2, p0, opStr:Ljava/lang/String;

    if-nez v2, :cond_0

    iput-object v3, p0, opStr:Ljava/lang/String;
    ...
    invoke-static {v2, p2}, strOpToOp(Ljava/lang/String;Ljava/io/PrintWriter;)I
    ...
    iput v0, p0, packageUid:I

    iget v0, p0, packageUid:I
