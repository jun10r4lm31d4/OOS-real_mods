...
.method constructor <init>(Lcom/android/server/appop/HistoricalRegistry;Ljava/lang/String;Ljava/io/PrintWriter;ILjava/lang/String;I)V
    ...
    iput-object p1, p0, mDateFormatter:Ljava/text/SimpleDateFormat;

    new-instance p1, Ljava/util/Date;

    invoke-direct {p1}, Ljava/util/Date;-><init>()V

    iput-object p1, p0, mDate:Ljava/util/Date;
    ...
    iput-object p1, p0, mOpsPrefix:Ljava/lang/String;

    new-instance p1, Ljava/lang/StringBuilder;

    invoke-direct {p1}, Ljava/lang/StringBuilder;-><init>()V

    iget-object v1, p0, mOpsPrefix:Ljava/lang/String;
    ...
    iput-object p1, p0, mUidPrefix:Ljava/lang/String;

    new-instance p1, Ljava/lang/StringBuilder;

    invoke-direct {p1}, Ljava/lang/StringBuilder;-><init>()V

    iget-object v1, p0, mUidPrefix:Ljava/lang/String;
    ...
    iput-object p1, p0, mPackagePrefix:Ljava/lang/String;

    new-instance p1, Ljava/lang/StringBuilder;

    invoke-direct {p1}, Ljava/lang/StringBuilder;-><init>()V

    iget-object v1, p0, mPackagePrefix:Ljava/lang/String;
    ...
    iput-object p1, p0, mEntryPrefix:Ljava/lang/String;

    new-instance p1, Ljava/lang/StringBuilder;

    invoke-direct {p1}, Ljava/lang/StringBuilder;-><init>()V

    iget-object v1, p0, mEntryPrefix:Ljava/lang/String;
    ...
    iput-object p1, p0, mUidStatePrefix:Ljava/lang/String;

    iput-object p3, p0, mWriter:Ljava/io/PrintWriter;

    iput p4, p0, mFilterUid:I

    iput-object p5, p0, mFilterPackage:Ljava/lang/String;

    iput p6, p0, mFilterOp:I
...
.method public visitHistoricalOp(Landroid/app/AppOpsManager$HistoricalOp;)V
    ...
    :cond_0
    iget-object v2, v0, mWriter:Ljava/io/PrintWriter;

    iget-object v3, v0, mEntryPrefix:Ljava/lang/String;
    ...
    iget-object v14, v0, mWriter:Ljava/io/PrintWriter;

    iget-object v12, v0, mUidStatePrefix:Ljava/lang/String;

    invoke-virtual {v14, v12}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    iget-object v12, v0, mWriter:Ljava/io/PrintWriter;
    ...
    iget-object v3, v0, mUidStatePrefix:Ljava/lang/String;

    invoke-virtual {v14, v3}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    iget-object v3, v0, mWriter:Ljava/io/PrintWriter;
...
.method public visitHistoricalOps(Landroid/app/AppOpsManager$HistoricalOps;)V
    ...
    iget-object v0, p0, mWriter:Ljava/io/PrintWriter;
    ...
    iget-object v0, p0, mDate:Ljava/util/Date;
    ...
    iget-object v1, p0, mDateFormatter:Ljava/text/SimpleDateFormat;

    iget-object v2, p0, mDate:Ljava/util/Date;
    ...
    iget-object v3, p0, mUidPrefix:Ljava/lang/String;
    ...
    iget-object v3, p0, mDateFormatter:Ljava/text/SimpleDateFormat;

    iget-object v4, p0, mDate:Ljava/util/Date;
    ...
    iget-wide v3, p0, mNow:J

    sub-long/2addr v0, v3

    iget-object v3, p0, mWriter:Ljava/io/PrintWriter;
...
.method public visitHistoricalPackageOps(Landroid/app/AppOpsManager$HistoricalPackageOps;)V
    ...
    iget-object v0, p0, mFilterPackage:Ljava/lang/String;
