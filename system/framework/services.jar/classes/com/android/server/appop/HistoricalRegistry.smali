...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, KEEP_WTF_LOG:Z
    ...
    sput-wide v0, DEFAULT_SNAPSHOT_INTERVAL_MILLIS:J
...
.method constructor <init>(Ljava/lang/Object;)V
    ...
    iput-object v0, p0, mPendingWrites:Ljava/util/LinkedList;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, mOnDiskLock:Ljava/lang/Object;

    const/4 v0, 0x0

    iput v0, p0, mMode:I

    sget-wide v0, DEFAULT_SNAPSHOT_INTERVAL_MILLIS:J

    iput-wide v0, p0, mBaseSnapshotInterval:J

    const-wide/16 v0, 0xa

    iput-wide v0, p0, mIntervalCompressionMultiplier:J

    iput-object p1, p0, mInMemoryLock:Ljava/lang/Object;
...
.method static synthetic access$000(Lcom/android/server/appop/HistoricalRegistry;Landroid/content/ContentResolver;)V
    ...
    invoke-direct {p0, p1}, updateParametersFromSetting(Landroid/content/ContentResolver;)V
...
.method static synthetic access$300(Ljava/lang/String;Ljava/lang/Throwable;Ljava/io/File;)V
    ...
    invoke-static {p0, p1, p2}, wtf(Ljava/lang/String;Ljava/lang/Throwable;Ljava/io/File;)V
...
.method private clearHistoryOnDiskDLocked()V
    ...
    iget-object v0, p0, mInMemoryLock:Ljava/lang/Object;
    ...
    :try_start_0
    iput-object v1, p0, mCurrentHistoricalOps:Landroid/app/AppOpsManager$HistoricalOps;

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v1

    iput-wide v1, p0, mNextPersistDueTimeMillis:J

    iget-object v1, p0, mPendingWrites:Ljava/util/LinkedList;
...
.method private getUpdatedPendingHistoricalOpsMLocked(J)Landroid/app/AppOpsManager$HistoricalOps;
    ...
    iget-object v0, p0, mCurrentHistoricalOps:Landroid/app/AppOpsManager$HistoricalOps;

    const-wide/16 v1, 0x0

    if-eqz v0, :cond_3

    iget-wide v3, p0, mNextPersistDueTimeMillis:J

    sub-long/2addr v3, p1

    iget-wide v5, p0, mBaseSnapshotInterval:J
    ...
    iput-wide v5, p0, mPendingHistoryOffsetMillis:J
    ...
    iget-wide v0, p0, mBaseSnapshotInterval:J

    add-long/2addr v0, p1

    iput-wide v0, p0, mNextPersistDueTimeMillis:J
    ...
    iget-wide v7, p0, mBaseSnapshotInterval:J
    ...
    iget-wide v9, p0, mBaseSnapshotInterval:J
    ...
    invoke-direct {p0, v0}, schedulePersistHistoricalOpsMLocked(Landroid/app/AppOpsManager$HistoricalOps;)V
    ...
    iput-object v0, p0, mCurrentHistoricalOps:Landroid/app/AppOpsManager$HistoricalOps;
...
.method private isPersistenceInitializedMLocked()Z
    ...
    iget-object v0, p0, mPersistence:Lcom/android/server/appop/HistoricalRegistry$Persistence;
...
.method public static synthetic lambda$dJrtb4M71TzV6sx9vPEImQG_akU(Lcom/android/server/appop/HistoricalRegistry;)V
    ...
    invoke-direct {p0}, persistPendingHistory()V
...
.method private persistPendingHistory()V
    ...
    iget-object v0, p0, mOnDiskLock:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, mInMemoryLock:Ljava/lang/Object;
    ...
    iget-object v3, p0, mPendingWrites:Ljava/util/LinkedList;
    ...
    iget-wide v3, p0, mPendingHistoryOffsetMillis:J
    ...
    invoke-direct {p0, v3, v4}, resampleHistoryOnDiskInMemoryDMLocked(J)V
    ...
    :try_start_2
    invoke-direct {p0, v2}, persistPendingHistory(Ljava/util/List;)V
...
.method private persistPendingHistory(Ljava/util/List;)V
    ...
    :cond_2
    iget-object v2, p0, mPersistence:Lcom/android/server/appop/HistoricalRegistry$Persistence;
...
.method private resampleHistoryOnDiskInMemoryDMLocked(J)V
    ...
    iget-wide v1, p0, mBaseSnapshotInterval:J

    iget-wide v3, p0, mIntervalCompressionMultiplier:J

    invoke-direct {v0, v1, v2, v3, v4}, Lcom/android/server/appop/HistoricalRegistry$Persistence;-><init>(JJ)V

    iput-object v0, p0, mPersistence:Lcom/android/server/appop/HistoricalRegistry$Persistence;

    invoke-virtual {p0, p1, p2}, offsetHistory(J)V
...
.method private updateParametersFromSetting(Landroid/content/ContentResolver;)V
    ...
    sget-object v7, LOG_TAG:Ljava/lang/String;
    ...
    invoke-virtual/range {v9 .. v14}, setHistoryParameters(IJJ)V
    :try_end_0
...
.method private static wtf(Ljava/lang/String;Ljava/lang/Throwable;Ljava/io/File;)V
    ...
    sget-boolean v0, KEEP_WTF_LOG:Z
...
.method addHistoricalOps(Landroid/app/AppOpsManager$HistoricalOps;)V
    ...
    :try_start_0
    invoke-direct {p0}, isPersistenceInitializedMLocked()Z
    ...
    iget-object v2, p0, mPendingWrites:Ljava/util/LinkedList;
    ...
    invoke-direct {p0, v1}, persistPendingHistory(Ljava/util/List;)V
...
.method clearHistory()V
    ...
    :cond_0
    :try_start_3
    invoke-direct {p0}, clearHistoryOnDiskDLocked()V
...
.method dump(Ljava/lang/String;Ljava/io/PrintWriter;ILjava/lang/String;I)V
    ...
    iget-object v11, v8, mOnDiskLock:Ljava/lang/Object;

    monitor-enter v11

    :try_start_0
    iget-object v12, v8, mInMemoryLock:Ljava/lang/Object;
    ...
    invoke-direct {p0, v1, v2}, getUpdatedPendingHistoricalOpsMLocked(J)Landroid/app/AppOpsManager$HistoricalOps;

    move-result-object v3

    invoke-static {v3, v1, v2}, makeRelativeToEpochStart(Landroid/app/AppOpsManager$HistoricalOps;J)V
    ...
    :cond_0
    :try_start_3
    iget-object v4, v8, mPersistence:Lcom/android/server/appop/HistoricalRegistry$Persistence;
    ...
    iget-wide v5, v8, mNextPersistDueTimeMillis:J

    sub-long/2addr v5, v1

    iget-wide v13, v8, mBaseSnapshotInterval:J
    ...
    invoke-static {v14, v1, v2}, makeRelativeToEpochStart(Landroid/app/AppOpsManager$HistoricalOps;J)V
...
.method getHistoricalOps(ILjava/lang/String;[Ljava/lang/String;JJILandroid/os/RemoteCallback;)V
    ...
    iget-object v11, v1, mOnDiskLock:Ljava/lang/Object;

    monitor-enter v11

    :try_start_0
    iget-object v12, v1, mInMemoryLock:Ljava/lang/Object;
    ...
    :try_start_1
    invoke-direct/range {p0 .. p0}, isPersistenceInitializedMLocked()Z
    ...
    :try_start_5
    invoke-direct {v1, v5, v6}, getUpdatedPendingHistoricalOpsMLocked(J)Landroid/app/AppOpsManager$HistoricalOps;
    ...
    iget-object v14, v1, mPendingWrites:Ljava/util/LinkedList;
    ...
    :try_start_9
    invoke-direct {v1, v13}, persistPendingHistory(Ljava/util/List;)V

    move-object v15, v13

    iget-wide v12, v1, mNextPersistDueTimeMillis:J
    :try_end_9
    ...
    :try_start_a
    iget-wide v5, v1, mBaseSnapshotInterval:J
    :try_end_a
    ...
    iget-object v5, v1, mPersistence:Lcom/android/server/appop/HistoricalRegistry$Persistence;
...
.method getHistoricalOpsFromDiskRaw(ILjava/lang/String;[Ljava/lang/String;JJILandroid/os/RemoteCallback;)V
    ...
    iget-object v3, v1, mOnDiskLock:Ljava/lang/Object;

    monitor-enter v3

    :try_start_0
    iget-object v4, v1, mInMemoryLock:Ljava/lang/Object;
...
.method offsetHistory(J)V
    ...
    invoke-virtual {p0}, clearHistory()V
    ...
    invoke-direct {p0, v2}, pruneFutureOps(Ljava/util/List;)V

    :cond_2
    iget-object v4, p0, mPersistence:Lcom/android/server/appop/HistoricalRegistry$Persistence;
...
.method resetHistoryParameters()V
    ...
    sget-wide v4, DEFAULT_SNAPSHOT_INTERVAL_MILLIS:J

    const-wide/16 v6, 0xa

    move-object v2, p0

    invoke-virtual/range {v2 .. v7}, setHistoryParameters(IJJ)V
...
.method systemReady(Landroid/content/ContentResolver;)V
    ...
    iget-object v1, p0, mOnDiskLock:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, mInMemoryLock:Ljava/lang/Object;
