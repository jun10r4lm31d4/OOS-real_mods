...
.method private evalForegroundWatchers(ILandroid/util/SparseArray;Landroid/util/SparseBooleanArray;)V
    ...
    iput-boolean v3, p0, hasForegroundWatchers:Z
...
.method public evalForegroundOps(Landroid/util/SparseArray;)V
    ...
    iput-boolean v1, p0, hasForegroundWatchers:Z

    iget-object v1, p0, opModes:Landroid/util/SparseIntArray;
    ...
    iget-object v3, p0, opModes:Landroid/util/SparseIntArray;
    ...
    invoke-direct {p0, v3, p1, v0}, evalForegroundWatchers(ILandroid/util/SparseArray;Landroid/util/SparseBooleanArray;)V
    ...
    :cond_2
    iget-object v1, p0, pkgOps:Landroid/util/ArrayMap;
    ...
    iget-object v3, p0, pkgOps:Landroid/util/ArrayMap;
    ...
    invoke-direct {p0, v5, p1, v0}, evalForegroundWatchers(ILandroid/util/SparseArray;Landroid/util/SparseBooleanArray;)V
    ...
    :cond_6
    iput-object v0, p0, foregroundOps:Landroid/util/SparseBooleanArray;
