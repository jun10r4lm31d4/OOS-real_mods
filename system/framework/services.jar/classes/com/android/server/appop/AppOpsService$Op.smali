...
.method constructor <init>(Lcom/android/server/appop/AppOpsService$UidState;Ljava/lang/String;I)V
    ...
    iput-object p1, p0, uidState:Lcom/android/server/appop/AppOpsService$UidState;
...
.method static synthetic access$400(Lcom/android/server/appop/AppOpsService$Op;)Landroid/util/LongSparseLongArray;
    ...
    iget-object v0, p0, mAccessTimes:Landroid/util/LongSparseLongArray;
...
.method static synthetic access$500(Lcom/android/server/appop/AppOpsService$Op;)Landroid/util/LongSparseLongArray;
    ...
    iget-object v0, p0, mRejectTimes:Landroid/util/LongSparseLongArray;
...
.method static synthetic access$600(Lcom/android/server/appop/AppOpsService$Op;)Landroid/util/LongSparseLongArray;
    ...
    iget-object v0, p0, mDurations:Landroid/util/LongSparseLongArray;
...
.method static synthetic access$700(Lcom/android/server/appop/AppOpsService$Op;)Landroid/util/LongSparseLongArray;
    ...
    iget-object v0, p0, mProxyUids:Landroid/util/LongSparseLongArray;
...
.method static synthetic access$800(Lcom/android/server/appop/AppOpsService$Op;)Landroid/util/LongSparseArray;
    ...
    iget-object v0, p0, mProxyPackageNames:Landroid/util/LongSparseArray;
...
.method private updateAccessTimeAndDuration(JJII)V
    ...
    iget-object v2, p0, mAccessTimes:Landroid/util/LongSparseLongArray;
    ...
    iput-object v2, p0, mAccessTimes:Landroid/util/LongSparseLongArray;
    ...
    iget-object v2, p0, mDurations:Landroid/util/LongSparseLongArray;
    ...
    iput-object v2, p0, mDurations:Landroid/util/LongSparseLongArray;
...
.method private updateProxyState(JILjava/lang/String;)V
    ...
    iput-object v0, p0, mProxyUids:Landroid/util/LongSparseLongArray;
    ...
    iput-object v0, p0, mProxyPackageNames:Landroid/util/LongSparseArray;
...
.method public accessed(JILjava/lang/String;II)V
    ...
    invoke-direct {p0, v0, v1, p3, p4}, updateProxyState(JILjava/lang/String;)V
...
.method evalMode()I
    ...
    iget-object v0, p0, uidState:Lcom/android/server/appop/AppOpsService$UidState;
...
.method public finished(JJII)V
    ...
    invoke-direct/range {p0 .. p6}, updateAccessTimeAndDuration(JJII)V
...
.method public rejected(JILjava/lang/String;II)V
    ...
    iget-object v2, p0, mRejectTimes:Landroid/util/LongSparseLongArray;
    ...
    iput-object v2, p0, mRejectTimes:Landroid/util/LongSparseLongArray;
...
.method public started(JII)V
    ...
    invoke-direct/range {v0 .. v6}, updateAccessTimeAndDuration(JJII)V
