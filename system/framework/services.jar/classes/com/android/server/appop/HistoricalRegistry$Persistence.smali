...
.method static constructor <clinit>()V
    ...
    sput-object v0, sHistoricalAppOpsDir:Lcom/android/internal/os/AtomicDirectory;
...
.method constructor <init>(JJ)V
    ...
    iput-wide p1, p0, mBaseSnapshotInterval:J

    iput-wide p3, p0, mIntervalCompressionMultiplier:J
...
.method static synthetic access$100(Lcom/android/server/appop/HistoricalRegistry$Persistence;Landroid/app/AppOpsManager$HistoricalOps;ILjava/lang/String;[Ljava/lang/String;JJI)V
    ...
    invoke-direct/range {p0 .. p9}, collectHistoricalOpsDLocked(Landroid/app/AppOpsManager$HistoricalOps;ILjava/lang/String;[Ljava/lang/String;JJI)V
...
.method static synthetic access$200(Landroid/app/AppOpsManager$HistoricalOps;D)Landroid/app/AppOpsManager$HistoricalOps;
    ...
    invoke-static {p0, p1, p2}, spliceFromBeginning(Landroid/app/AppOpsManager$HistoricalOps;D)Landroid/app/AppOpsManager$HistoricalOps;
...
.method static clearHistoryDLocked()V
    ...
    sget-object v0, sHistoricalAppOpsDir:Lcom/android/internal/os/AtomicDirectory;
...
.method private collectHistoricalOpsBaseDLocked(ILjava/lang/String;[Ljava/lang/String;JJI)Ljava/util/LinkedList;
    ...
    :try_start_1
    invoke-static {v3}, getHistoricalFileNames(Ljava/io/File;)Ljava/util/Set;
    ...
    invoke-direct/range {v2 .. v15}, collectHistoricalOpsRecursiveDLocked(Ljava/io/File;ILjava/lang/String;[Ljava/lang/String;JJI[JLjava/util/LinkedList;ILjava/util/Set;)Ljava/util/LinkedList;

    move-result-object v0

    sget-object v1, sHistoricalAppOpsDir:Lcom/android/internal/os/AtomicDirectory;
...
.method private collectHistoricalOpsDLocked(Landroid/app/AppOpsManager$HistoricalOps;ILjava/lang/String;[Ljava/lang/String;JJI)V
    ...
    invoke-direct/range {v0 .. v8}, collectHistoricalOpsBaseDLocked(ILjava/lang/String;[Ljava/lang/String;JJI)Ljava/util/LinkedList;
...
.method private collectHistoricalOpsRecursiveDLocked(Ljava/io/File;ILjava/lang/String;[Ljava/lang/String;JJI[JLjava/util/LinkedList;ILjava/util/Set;)Ljava/util/LinkedList;
    ...
    iget-wide v2, v11, mIntervalCompressionMultiplier:J
    ...
    iget-wide v4, v11, mBaseSnapshotInterval:J

    mul-long v17, v2, v4

    move-wide/from16 v2, v17

    iget-wide v4, v11, mIntervalCompressionMultiplier:J
    ...
    iget-wide v9, v11, mBaseSnapshotInterval:J
    ...
    invoke-direct/range {v0 .. v16}, readHistoricalOpsLocked(Ljava/io/File;JJILjava/lang/String;[Ljava/lang/String;JJI[JILjava/util/Set;)Ljava/util/List;
    ...
    invoke-direct/range {v0 .. v13}, collectHistoricalOpsRecursiveDLocked(Ljava/io/File;ILjava/lang/String;[Ljava/lang/String;JJI[JLjava/util/LinkedList;ILjava/util/Set;)Ljava/util/LinkedList;
...
.method private computeGlobalIntervalBeginMillis(I)J
    ...
    iget-wide v5, p0, mIntervalCompressionMultiplier:J
    ...
    :cond_0
    iget-wide v2, p0, mBaseSnapshotInterval:J
...
.method private static enforceOpsWellFormed(Ljava/util/List;)V
    ...
    invoke-static {p0}, opsToDebugString(Ljava/util/List;)Ljava/lang/String;
...
.method private generateFile(Ljava/io/File;I)Ljava/io/File;
    ...
    invoke-direct {p0, p2}, computeGlobalIntervalBeginMillis(I)J
...
.method private handlePersistHistoricalOpsRecursiveDLocked(Ljava/io/File;Ljava/io/File;Ljava/util/List;Ljava/util/Set;I)V
    ...
    iget-wide v0, v15, mIntervalCompressionMultiplier:J
    ...
    iget-wide v6, v15, mBaseSnapshotInterval:J

    mul-long/2addr v0, v6

    iget-wide v6, v15, mIntervalCompressionMultiplier:J
    ...
    iget-wide v8, v15, mBaseSnapshotInterval:J
    ...
    invoke-static {v0, v13, v14}, spliceFromEnd(Landroid/app/AppOpsManager$HistoricalOps;D)Landroid/app/AppOpsManager$HistoricalOps;
    ...
    invoke-direct {v5, v4, v3}, generateFile(Ljava/io/File;I)Ljava/io/File;
    ...
    invoke-static {v12, v8, v9}, normalizeSnapshotForSlotDuration(Ljava/util/List;J)V

    invoke-direct {v5, v12, v13, v14, v2}, writeHistoricalOpsDLocked(Ljava/util/List;JLjava/io/File;)V
    ...
    invoke-direct/range {v0 .. v5}, handlePersistHistoricalOpsRecursiveDLocked(Ljava/io/File;Ljava/io/File;Ljava/util/List;Ljava/util/Set;I)V
    ...
    invoke-direct {v9, v10, v7}, generateFile(Ljava/io/File;I)Ljava/io/File;
    ...
    invoke-direct {v9, v8, v7}, generateFile(Ljava/io/File;I)Ljava/io/File;
...
.method private static normalizeSnapshotForSlotDuration(Ljava/util/List;J)V
    ...
    invoke-static {v9, v13, v14}, spliceFromEnd(Landroid/app/AppOpsManager$HistoricalOps;D)Landroid/app/AppOpsManager$HistoricalOps;
...
.method private readHistoricalOpDLocked(Landroid/app/AppOpsManager$HistoricalOps;ILjava/lang/String;Lorg/xmlpull/v1/XmlPullParser;[Ljava/lang/String;ID)Landroid/app/AppOpsManager$HistoricalOps;
    ...
    invoke-direct/range {v0 .. v8}, readStateDLocked(Landroid/app/AppOpsManager$HistoricalOps;ILjava/lang/String;ILorg/xmlpull/v1/XmlPullParser;ID)Landroid/app/AppOpsManager$HistoricalOps;
...
.method private readHistoricalOpsLocked(Ljava/io/File;ILjava/lang/String;[Ljava/lang/String;JJI[J)Ljava/util/List;
    ...
    invoke-direct/range {v2 .. v12}, readeHistoricalOpsDLocked(Lorg/xmlpull/v1/XmlPullParser;ILjava/lang/String;[Ljava/lang/String;JJI[J)Landroid/app/AppOpsManager$HistoricalOps;
...
.method private readHistoricalOpsLocked(Ljava/io/File;JJILjava/lang/String;[Ljava/lang/String;JJI[JILjava/util/Set;)Ljava/util/List;
    ...
    invoke-direct {v11, v13, v14}, generateFile(Ljava/io/File;I)Ljava/io/File;
    ...
    invoke-direct/range {v0 .. v10}, readHistoricalOpsLocked(Ljava/io/File;ILjava/lang/String;[Ljava/lang/String;JJI[J)Ljava/util/List;
...
.method private readHistoricalPackageOpsDLocked(Landroid/app/AppOpsManager$HistoricalOps;ILorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;[Ljava/lang/String;ID)Landroid/app/AppOpsManager$HistoricalOps;
    ...
    invoke-direct/range {v0 .. v8}, readHistoricalOpDLocked(Landroid/app/AppOpsManager$HistoricalOps;ILjava/lang/String;Lorg/xmlpull/v1/XmlPullParser;[Ljava/lang/String;ID)Landroid/app/AppOpsManager$HistoricalOps;
...
.method private readHistoricalUidOpsDLocked(Landroid/app/AppOpsManager$HistoricalOps;Lorg/xmlpull/v1/XmlPullParser;ILjava/lang/String;[Ljava/lang/String;ID)Landroid/app/AppOpsManager$HistoricalOps;
    ...
    invoke-direct/range {v0 .. v8}, readHistoricalPackageOpsDLocked(Landroid/app/AppOpsManager$HistoricalOps;ILorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;[Ljava/lang/String;ID)Landroid/app/AppOpsManager$HistoricalOps;
...
.method private readeHistoricalOpsDLocked(Lorg/xmlpull/v1/XmlPullParser;ILjava/lang/String;[Ljava/lang/String;JJI[J)Landroid/app/AppOpsManager$HistoricalOps;
    ...
    invoke-direct/range {v0 .. v8}, readHistoricalUidOpsDLocked(Landroid/app/AppOpsManager$HistoricalOps;Lorg/xmlpull/v1/XmlPullParser;ILjava/lang/String;[Ljava/lang/String;ID)Landroid/app/AppOpsManager$HistoricalOps;
...
.method private writeHistoricalOpDLocked(Landroid/app/AppOpsManager$HistoricalOp;Lorg/xmlpull/v1/XmlSerializer;)V
    ...
    invoke-direct {p0, p1, v5, v6, p2}, writeStateOnLocked(Landroid/app/AppOpsManager$HistoricalOp;JLorg/xmlpull/v1/XmlSerializer;)V
...
.method private writeHistoricalOpDLocked(Landroid/app/AppOpsManager$HistoricalOps;Lorg/xmlpull/v1/XmlSerializer;)V
    ...
    invoke-direct {p0, v4, p2}, writeHistoricalUidOpsDLocked(Landroid/app/AppOpsManager$HistoricalUidOps;Lorg/xmlpull/v1/XmlSerializer;)V
...
.method private writeHistoricalOpsDLocked(Ljava/util/List;JLjava/io/File;)V
    ...
    invoke-direct {p0, v6, v2}, writeHistoricalOpDLocked(Landroid/app/AppOpsManager$HistoricalOps;Lorg/xmlpull/v1/XmlSerializer;)V
    ...
    sget-object v2, sHistoricalAppOpsDir:Lcom/android/internal/os/AtomicDirectory;
...
.method private writeHistoricalPackageOpsDLocked(Landroid/app/AppOpsManager$HistoricalPackageOps;Lorg/xmlpull/v1/XmlSerializer;)V
    ...
    invoke-direct {p0, v4, p2}, writeHistoricalOpDLocked(Landroid/app/AppOpsManager$HistoricalOp;Lorg/xmlpull/v1/XmlSerializer;)V
...
.method private writeHistoricalUidOpsDLocked(Landroid/app/AppOpsManager$HistoricalUidOps;Lorg/xmlpull/v1/XmlSerializer;)V
    ...
    invoke-direct {p0, v4, p2}, writeHistoricalPackageOpsDLocked(Landroid/app/AppOpsManager$HistoricalPackageOps;Lorg/xmlpull/v1/XmlSerializer;)V
...
.method clearHistoryDLocked(ILjava/lang/String;)V
    ...
    invoke-virtual {p0}, readHistoryDLocked()Ljava/util/List;
    ...
    :cond_1
    invoke-static {}, clearHistoryDLocked()V

    invoke-virtual {p0, v0}, persistHistoricalOpsDLocked(Ljava/util/List;)V
...
.method getLastPersistTimeMillisDLocked()J
    ...
    :try_start_0
    sget-object v3, sHistoricalAppOpsDir:Lcom/android/internal/os/AtomicDirectory;
    ...
    :cond_5
    :try_start_3
    sget-object v4, sHistoricalAppOpsDir:Lcom/android/internal/os/AtomicDirectory;
...
.method persistHistoricalOpsDLocked(Ljava/util/List;)V
    ...
    invoke-direct/range {v1 .. v6}, handlePersistHistoricalOpsRecursiveDLocked(Ljava/io/File;Ljava/io/File;Ljava/util/List;Ljava/util/Set;I)V
...
.method readHistoryDLocked()Ljava/util/List;
    ...
    invoke-virtual {p0}, readHistoryRawDLocked()Ljava/util/List;
    ...
    iget-wide v4, p0, mBaseSnapshotInterval:J
