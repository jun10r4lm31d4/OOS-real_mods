...
.method static synthetic access$100(Lcom/android/server/testharness/TestHarnessModeService;)Landroid/content/pm/UserInfo;
    ...
    invoke-direct {p0}, getPrimaryUser()Landroid/content/pm/UserInfo;
...
.method static synthetic access$200(Lcom/android/server/testharness/TestHarnessModeService;)Lcom/android/server/PersistentDataBlockManagerInternal;
    ...
    invoke-direct {p0}, getPersistentDataBlock()Lcom/android/server/PersistentDataBlockManagerInternal;
...
.method private completeTestHarnessModeSetup()V
    ...
    invoke-direct {p0}, getTestHarnessModeData()[B
    ...
    invoke-direct {p0, v1}, setUpAdbFiles(Lcom/android/server/testharness/TestHarnessModeService$PersistentData;)V

    invoke-direct {p0}, configureSettings()V

    invoke-direct {p0}, configureUser()V
    :try_end_0
...
.method private setUpAdbFiles(Lcom/android/server/testharness/TestHarnessModeService$PersistentData;)V
    ...
    invoke-direct {p0, v1, v2}, writeBytesToFile([BLjava/nio/file/Path;)V
...
.method private setUpTestHarnessMode()V
    ...
    :cond_0
    invoke-direct {p0}, setDeviceProvisioned()V

    invoke-direct {p0}, disableLockScreen()V
...
.method public onBootPhase(I)V
    ...
    :cond_0
    invoke-direct {p0}, completeTestHarnessModeSetup()V

    invoke-direct {p0}, showNotificationIfEnabled()V

    goto :goto_0

    :cond_1
    invoke-direct {p0}, setUpTestHarnessMode()V
