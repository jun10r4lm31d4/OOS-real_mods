...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, mCallActive:Z

    iput-boolean v0, p0, mIsPowerSaveMode:Z

    iput-boolean v0, p0, mServiceDisabled:Z

    iput-boolean v0, p0, mRecognitionRunning:Z
    ...
    iput-object v4, p0, mTelephonyManager:Landroid/telephony/TelephonyManager;
    ...
    iput-object v4, p0, mModelDataMap:Ljava/util/HashMap;

    new-instance v4, Ljava/util/HashMap;

    invoke-direct {v4}, Ljava/util/HashMap;-><init>()V

    iput-object v4, p0, mKeyphraseUuidMap:Ljava/util/HashMap;
    ...
    iput-object v4, p0, mPhoneStateListener:Landroid/telephony/PhoneStateListener;
    ...
    iput-object v0, p0, mModuleProperties:Landroid/hardware/soundtrigger/SoundTrigger$ModuleProperties;
    ...
    iput-object v1, p0, mModuleProperties:Landroid/hardware/soundtrigger/SoundTrigger$ModuleProperties;

    iput-object v1, p0, mModule:Landroid/hardware/soundtrigger/SoundTriggerModule;
...
.method private cleanUpExistingKeyphraseModelLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;)I
    ...
    invoke-direct {p0, p1, v0, v0}, tryStopAndUnloadLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;ZZ)I
...
.method private computeRecognitionRunningLocked()Z
    ...
    iget-object v0, p0, mModuleProperties:Landroid/hardware/soundtrigger/SoundTrigger$ModuleProperties;

    const/4 v1, 0x0

    if-eqz v0, :cond_3

    iget-object v0, p0, mModule:Landroid/hardware/soundtrigger/SoundTriggerModule;
    ...
    :cond_0
    iget-object v0, p0, mModelDataMap:Ljava/util/HashMap;
    ...
    iget-boolean v0, p0, mRecognitionRunning:Z
    ...
    :cond_2
    iput-boolean v1, p0, mRecognitionRunning:Z
...
.method private createKeyphraseModelDataLocked(Ljava/util/UUID;I)Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;
    ...
    iget-object v0, p0, mKeyphraseUuidMap:Ljava/util/HashMap;
    ...
    iget-object v1, p0, mModelDataMap:Ljava/util/HashMap;
...
.method private dumpModelStateLocked()V
    ...
    iget-object v2, p0, mModelDataMap:Ljava/util/HashMap;
...
.method private forceStopAndUnloadModelLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;Ljava/lang/Exception;)V
    ...
    invoke-direct {p0, p1, p2, v0}, forceStopAndUnloadModelLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;Ljava/lang/Exception;Ljava/util/Iterator;)V
...
.method private initializeTelephonyAndPowerStateListeners()V
    ...
    :goto_0
    iput-boolean v2, p0, mCallActive:Z
    ...
    iget-object v2, p0, mPowerSaveModeListener:Lcom/android/server/soundtrigger/SoundTriggerHelper$PowerSaveModeListener;
    ...
    iput-object v2, p0, mPowerSaveModeListener:Lcom/android/server/soundtrigger/SoundTriggerHelper$PowerSaveModeListener;

    iget-object v2, p0, mContext:Landroid/content/Context;

    iget-object v3, p0, mPowerSaveModeListener:Lcom/android/server/soundtrigger/SoundTriggerHelper$PowerSaveModeListener;
    ...
    iput-boolean v2, p0, mIsPowerSaveMode:Z
    :try_end_0
...
.method private onCallStateChangedLocked(Z)V
    ...
    invoke-direct {p0, v0}, updateAllRecognitionsLocked(Z)V
...
.method private onGenericRecognitionSuccessLocked(Landroid/hardware/soundtrigger/SoundTrigger$GenericRecognitionEvent;)V
    ...
    invoke-direct {p0, v0}, getModelDataForLocked(I)Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;
    ...
    invoke-direct {p0}, isRecognitionAllowed()Z

    move-result v2

    invoke-direct {p0, v0, v2, v1}, updateRecognitionLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;ZZ)I
    ...
    invoke-direct {p0, v0, v1}, forceStopAndUnloadModelLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;Ljava/lang/Exception;)V
...
.method private onKeyphraseRecognitionSuccessLocked(Landroid/hardware/soundtrigger/SoundTrigger$KeyphraseRecognitionEvent;)V
    ...
    invoke-direct {p0, p1}, getKeyphraseIdFromEvent(Landroid/hardware/soundtrigger/SoundTrigger$KeyphraseRecognitionEvent;)I

    move-result v1

    invoke-direct {p0, v1}, getKeyphraseModelDataLocked(I)Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;
    ...
    invoke-direct {p0, v3, v4, v2}, updateRecognitionLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;ZZ)I
    ...
    invoke-direct {p0, v3, v0}, forceStopAndUnloadModelLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;Ljava/lang/Exception;)V
...
.method private onRecognitionAbortLocked(Landroid/hardware/soundtrigger/SoundTrigger$RecognitionEvent;)V
    ...
    invoke-direct {p0, v1}, getModelDataForLocked(I)Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;
    ...
    invoke-direct {p0, v1, v0}, forceStopAndUnloadModelLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;Ljava/lang/Exception;)V
...
.method private onRecognitionFailureLocked()V
    ...
    :try_start_0
    invoke-direct {p0, v0}, sendErrorCallbacksToAllLocked(I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-direct {p0}, internalClearModelStateLocked()V

    invoke-direct {p0}, internalClearGlobalStateLocked()V
...
.method private onServiceDiedLocked()V
    ...
    invoke-direct {p0, v1}, sendErrorCallbacksToAllLocked(I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iput-object v0, p0, mModule:Landroid/hardware/soundtrigger/SoundTriggerModule;
...
.method private removeKeyphraseModelLocked(I)V
    ...
    iget-object v1, p0, mKeyphraseUuidMap:Ljava/util/HashMap;
...
.method private startRecognitionLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;Z)I
    ...
    invoke-direct {p0, p1, v4}, forceStopAndUnloadModelLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;Ljava/lang/Exception;)V
...
.method private stopAndUnloadDeadModelsLocked()V
    ...
    invoke-direct {p0, v1, v2, v0}, forceStopAndUnloadModelLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;Ljava/lang/Exception;Ljava/util/Iterator;)V
...
.method private stopRecognition(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;Landroid/hardware/soundtrigger/IRecognitionStatusCallback;)I
    ...
    :cond_0
    iget-object v2, p0, mModuleProperties:Landroid/hardware/soundtrigger/SoundTrigger$ModuleProperties;
    ...
    invoke-direct {p0, p1, v3, v1}, updateRecognitionLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;ZZ)I
    ...
    invoke-direct {p0}, computeRecognitionRunningLocked()Z
...
.method private stopRecognitionLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;Z)I
    ...
    invoke-direct {p0, p1, v2}, forceStopAndUnloadModelLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;Ljava/lang/Exception;)V
...
.method private tryStopAndUnloadLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;ZZ)I
    ...
    invoke-direct {p0, p1, v2}, stopRecognitionLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;Z)I
...
.method private updateAllRecognitionsLocked(Z)V
    ...
    invoke-direct {p0, v3, v0, p1}, updateRecognitionLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;ZZ)I
...
.method private updateRecognitionLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;ZZ)I
    ...
    invoke-direct {p0, p1, p3}, startRecognitionLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;Z)I
    ...
    :cond_2
    invoke-direct {p0, p1, p3}, stopRecognitionLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;Z)I
...
.method dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v1, p0, mModuleProperties:Landroid/hardware/soundtrigger/SoundTrigger$ModuleProperties;
    ...
    iget-boolean v1, p0, mCallActive:Z
    ...
    iget-boolean v1, p0, mIsPowerSaveMode:Z
    ...
    iget-boolean v1, p0, mServiceDisabled:Z
...
.method public onRecognition(Landroid/hardware/soundtrigger/SoundTrigger$RecognitionEvent;)V
    ...
    :cond_3
    invoke-direct {p0, p1}, onRecognitionAbortLocked(Landroid/hardware/soundtrigger/SoundTrigger$RecognitionEvent;)V

    goto :goto_0

    :cond_4
    invoke-direct {p0, p1}, isKeyphraseRecognitionEvent(Landroid/hardware/soundtrigger/SoundTrigger$RecognitionEvent;)Z
    ...
    invoke-direct {p0, v1}, onKeyphraseRecognitionSuccessLocked(Landroid/hardware/soundtrigger/SoundTrigger$KeyphraseRecognitionEvent;)V
    ...
    invoke-direct {p0, v1}, onGenericRecognitionSuccessLocked(Landroid/hardware/soundtrigger/SoundTrigger$GenericRecognitionEvent;)V
...
.method public onServiceStateChange(I)V
    ...
    :goto_0
    :try_start_0
    invoke-direct {p0, v1}, onServiceStateChangedLocked(Z)V
...
.method startGenericRecognition(Ljava/util/UUID;Landroid/hardware/soundtrigger/SoundTrigger$GenericSoundModel;Landroid/hardware/soundtrigger/IRecognitionStatusCallback;Landroid/hardware/soundtrigger/SoundTrigger$RecognitionConfig;)I
    ...
    :try_start_0
    invoke-direct {p0, p1}, getOrCreateGenericModelDataLocked(Ljava/util/UUID;)Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;
    ...
    invoke-virtual/range {v3 .. v8}, startRecognition(Landroid/hardware/soundtrigger/SoundTrigger$SoundModel;Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;Landroid/hardware/soundtrigger/IRecognitionStatusCallback;Landroid/hardware/soundtrigger/SoundTrigger$RecognitionConfig;I)I
...
.method startKeyphraseRecognition(ILandroid/hardware/soundtrigger/SoundTrigger$KeyphraseSoundModel;Landroid/hardware/soundtrigger/IRecognitionStatusCallback;Landroid/hardware/soundtrigger/SoundTrigger$RecognitionConfig;)I
    ...
    :cond_0
    invoke-direct {p0, p1}, getKeyphraseModelDataLocked(I)Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;
    ...
    invoke-direct {p0, v2}, cleanUpExistingKeyphraseModelLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;)I
    ...
    :cond_2
    invoke-direct {p0, p1}, removeKeyphraseModelLocked(I)V
    ...
    invoke-direct {p0, v1, p1}, createKeyphraseModelDataLocked(Ljava/util/UUID;I)Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;
    ...
    invoke-virtual/range {v2 .. v7}, startRecognition(Landroid/hardware/soundtrigger/SoundTrigger$SoundModel;Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;Landroid/hardware/soundtrigger/IRecognitionStatusCallback;Landroid/hardware/soundtrigger/SoundTrigger$RecognitionConfig;I)I
...
.method startRecognition(Landroid/hardware/soundtrigger/SoundTrigger$SoundModel;Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;Landroid/hardware/soundtrigger/IRecognitionStatusCallback;Landroid/hardware/soundtrigger/SoundTrigger$RecognitionConfig;I)I
    ...
    :cond_1
    iget-boolean v1, p0, mRecognitionRunning:Z

    if-nez v1, :cond_2

    invoke-direct {p0}, initializeTelephonyAndPowerStateListeners()V
    ...
    :cond_5
    invoke-direct {p0, p2, v1, v3}, tryStopAndUnloadLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;ZZ)I
    ...
    invoke-direct {p0}, stopAndUnloadDeadModelsLocked()V

    new-array v3, v4, [I

    aput v2, v3, v5

    iget-object v6, p0, mModule:Landroid/hardware/soundtrigger/SoundTriggerModule;
    ...
    invoke-direct {p0, p2, v5}, startRecognitionLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;Z)I
...
.method stopGenericRecognition(Ljava/util/UUID;Landroid/hardware/soundtrigger/IRecognitionStatusCallback;)I
    ...
    :cond_1
    invoke-direct {p0, v2, p2}, stopRecognition(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;Landroid/hardware/soundtrigger/IRecognitionStatusCallback;)I
...
.method unloadGenericSoundModel(Ljava/util/UUID;)I
    ...
    invoke-direct {p0, v2, v3}, stopRecognitionLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;Z)I
    ...
    :cond_4
    iget-object v3, p0, mModelDataMap:Ljava/util/HashMap;
...
.method unloadKeyphraseSoundModel(I)I
    ...
    invoke-direct {p0, v1, v3, v2}, updateRecognitionLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;ZZ)I
