...
.method private constructor <init>(Ljava/util/UUID;I)V
    ...
    iput v0, p0, mModelType:I

    const/4 v0, 0x0

    iput-object v0, p0, mCallback:Landroid/hardware/soundtrigger/IRecognitionStatusCallback;

    iput-object v0, p0, mRecognitionConfig:Landroid/hardware/soundtrigger/SoundTrigger$RecognitionConfig;

    const/high16 v1, -0x80000000

    iput v1, p0, mModelHandle:I

    iput-object v0, p0, mSoundModel:Landroid/hardware/soundtrigger/SoundTrigger$SoundModel;

    iput-object p1, p0, mModelId:Ljava/util/UUID;

    iput p2, p0, mModelType:I
...
.method static createGenericModelData(Ljava/util/UUID;)Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;
    ...
    invoke-direct {v0, p0, v1}, <init>(Ljava/util/UUID;I)V
...
.method declared-synchronized callbackToString()Ljava/lang/String;
    ...
    iget-object v1, p0, mCallback:Landroid/hardware/soundtrigger/IRecognitionStatusCallback;
...
.method declared-synchronized clearState()V
    ...
    iput-object v1, p0, mRecognitionConfig:Landroid/hardware/soundtrigger/SoundTrigger$RecognitionConfig;

    iput-boolean v0, p0, mRequested:Z

    iput-object v1, p0, mCallback:Landroid/hardware/soundtrigger/IRecognitionStatusCallback;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method declared-synchronized getCallback()Landroid/hardware/soundtrigger/IRecognitionStatusCallback;
    ...
    :try_start_0
    iget-object v0, p0, mCallback:Landroid/hardware/soundtrigger/IRecognitionStatusCallback;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method declared-synchronized getModelId()Ljava/util/UUID;
    ...
    :try_start_0
    iget-object v0, p0, mModelId:Ljava/util/UUID;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method declared-synchronized getSoundModel()Landroid/hardware/soundtrigger/SoundTrigger$SoundModel;
    ...
    :try_start_0
    iget-object v0, p0, mSoundModel:Landroid/hardware/soundtrigger/SoundTrigger$SoundModel;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method declared-synchronized requestedToString()Ljava/lang/String;
    ...
    iget-boolean v1, p0, mRequested:Z
...
.method declared-synchronized setCallback(Landroid/hardware/soundtrigger/IRecognitionStatusCallback;)V
    ...
    :try_start_0
    iput-object p1, p0, mCallback:Landroid/hardware/soundtrigger/IRecognitionStatusCallback;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method declared-synchronized setRecognitionConfig(Landroid/hardware/soundtrigger/SoundTrigger$RecognitionConfig;)V
    ...
    :try_start_0
    iput-object p1, p0, mRecognitionConfig:Landroid/hardware/soundtrigger/SoundTrigger$RecognitionConfig;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method declared-synchronized setSoundModel(Landroid/hardware/soundtrigger/SoundTrigger$SoundModel;)V
    ...
    :try_start_0
    iput-object p1, p0, mSoundModel:Landroid/hardware/soundtrigger/SoundTrigger$SoundModel;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized toString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, stateToString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, requestedToString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, callbackToString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, uuidToString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, modelTypeToString()Ljava/lang/String;
...
.method declared-synchronized uuidToString()Ljava/lang/String;
    ...
    iget-object v1, p0, mModelId:Ljava/util/UUID;
