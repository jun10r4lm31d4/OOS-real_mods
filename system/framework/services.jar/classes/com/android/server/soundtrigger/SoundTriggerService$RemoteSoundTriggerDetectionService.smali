...
.method public constructor <init>(Lcom/android/server/soundtrigger/SoundTriggerService;Ljava/util/UUID;Landroid/os/Bundle;Landroid/content/ComponentName;Landroid/os/UserHandle;Landroid/hardware/soundtrigger/SoundTrigger$RecognitionConfig;)V
    ...
    iput-object p1, p0, this$0:Lcom/android/server/soundtrigger/SoundTriggerService;
    ...
    iput-object v0, p0, mRemoteServiceLock:Ljava/lang/Object;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mPendingOps:Ljava/util/ArrayList;

    new-instance v0, Landroid/util/ArraySet;

    invoke-direct {v0}, Landroid/util/ArraySet;-><init>()V

    iput-object v0, p0, mRunningOpIds:Landroid/util/ArraySet;

    new-instance v0, Landroid/os/ParcelUuid;

    invoke-direct {v0, p2}, Landroid/os/ParcelUuid;-><init>(Ljava/util/UUID;)V

    iput-object v0, p0, mPuuid:Landroid/os/ParcelUuid;

    iput-object p3, p0, mParams:Landroid/os/Bundle;

    iput-object p4, p0, mServiceName:Landroid/content/ComponentName;

    iput-object p5, p0, mUser:Landroid/os/UserHandle;

    iput-object p6, p0, mRecognitionConfig:Landroid/hardware/soundtrigger/SoundTrigger$RecognitionConfig;
    ...
    iput-object v1, p0, mRemoteServiceWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    iget-object v4, p0, mServiceName:Landroid/content/ComponentName;
    ...
    :cond_0
    iput-object v2, p0, mNumOps:Lcom/android/server/soundtrigger/SoundTriggerService$NumOps;
    ...
    iput-object v1, p0, mClient:Landroid/media/soundtrigger/ISoundTriggerDetectionServiceClient;
...
.method static synthetic access$1100(Lcom/android/server/soundtrigger/SoundTriggerService$RemoteSoundTriggerDetectionService;)Ljava/lang/Object;
    ...
    iget-object v0, p0, mRemoteServiceLock:Ljava/lang/Object;
...
.method static synthetic access$1200(Lcom/android/server/soundtrigger/SoundTriggerService$RemoteSoundTriggerDetectionService;)Landroid/util/ArraySet;
    ...
    iget-object v0, p0, mRunningOpIds:Landroid/util/ArraySet;
...
.method static synthetic access$1300(Lcom/android/server/soundtrigger/SoundTriggerService$RemoteSoundTriggerDetectionService;)Ljava/util/ArrayList;
    ...
    iget-object v0, p0, mPendingOps:Ljava/util/ArrayList;
...
.method static synthetic access$1400(Lcom/android/server/soundtrigger/SoundTriggerService$RemoteSoundTriggerDetectionService;)Z
    ...
    iget-boolean v0, p0, mDestroyOnceRunningOpsDone:Z
...
.method static synthetic access$1600(Lcom/android/server/soundtrigger/SoundTriggerService$RemoteSoundTriggerDetectionService;)V
    ...
    invoke-direct {p0}, disconnectLocked()V
...
.method private bind()V
    ...
    iget-object v7, p0, mServiceName:Landroid/content/ComponentName;

    invoke-virtual {v6, v7}, Landroid/content/Intent;->setComponent(Landroid/content/ComponentName;)Landroid/content/Intent;

    iget-object v7, p0, this$0:Lcom/android/server/soundtrigger/SoundTriggerService;
    ...
    iget-object v9, p0, mUser:Landroid/os/UserHandle;
    ...
    iget-object v1, p0, mPuuid:Landroid/os/ParcelUuid;

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    invoke-virtual {v0, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v1, p0, mServiceName:Landroid/content/ComponentName;
    ...
    iget-object v8, p0, mPuuid:Landroid/os/ParcelUuid;

    invoke-virtual {v3, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    invoke-virtual {v3, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v8, p0, mServiceName:Landroid/content/ComponentName;
    ...
    iget-object v2, p0, mPuuid:Landroid/os/ParcelUuid;
    ...
    iget-object v10, p0, mPuuid:Landroid/os/ParcelUuid;

    invoke-virtual {v8, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v9, p0, mServiceName:Landroid/content/ComponentName;
    ...
    :cond_1
    :try_start_3
    iget-object v1, p0, this$0:Lcom/android/server/soundtrigger/SoundTriggerService;

    iget-object v1, v1, Lcom/android/server/soundtrigger/SoundTriggerService;->mContext:Landroid/content/Context;

    const v2, 0x4000001

    iget-object v3, p0, mUser:Landroid/os/UserHandle;
    ...
    iput-boolean v1, p0, mIsBound:Z

    iget-boolean v1, p0, mIsBound:Z

    if-eqz v1, :cond_2

    iget-object v0, p0, mRemoteServiceWakeLock:Landroid/os/PowerManager$WakeLock;
...
.method private destroy()V
    ...
    iget-object v3, p0, mPuuid:Landroid/os/ParcelUuid;
    ...
    iput-boolean v1, p0, mIsDestroyed:Z
    ...
    iget-object v0, p0, this$0:Lcom/android/server/soundtrigger/SoundTriggerService;
...
.method private disconnectLocked()V
    ...
    iget-object v0, p0, mService:Landroid/media/soundtrigger/ISoundTriggerDetectionService;
    ...
    iget-object v4, p0, mPuuid:Landroid/os/ParcelUuid;
    ...
    iput-object v0, p0, mService:Landroid/media/soundtrigger/ISoundTriggerDetectionService;
    ...
    :try_start_1
    iget-object v1, p0, mRemoteServiceWakeLock:Landroid/os/PowerManager$WakeLock;
...
.method public static synthetic lambda$wfDlqQ7aPvu9qZCZ24jJu4tfUMY(Lcom/android/server/soundtrigger/SoundTriggerService$RemoteSoundTriggerDetectionService;)V
    ...
    invoke-direct {p0}, stopAllPendingOperations()V
...
.method private runOrAddOperation(Lcom/android/server/soundtrigger/SoundTriggerService$Operation;)V
    ...
    iget-boolean v1, p0, mDestroyOnceRunningOpsDone:Z
    ...
    :cond_0
    iget-object v1, p0, mService:Landroid/media/soundtrigger/ISoundTriggerDetectionService;

    if-nez v1, :cond_1

    iget-object v1, p0, mPendingOps:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, mNumOps:Lcom/android/server/soundtrigger/SoundTriggerService$NumOps;

    invoke-virtual {v3, v1, v2}, Lcom/android/server/soundtrigger/SoundTriggerService$NumOps;->clearOldOps(J)V

    iget-object v3, p0, this$0:Lcom/android/server/soundtrigger/SoundTriggerService;
    ...
    iget-object v4, p0, mNumOps:Lcom/android/server/soundtrigger/SoundTriggerService$NumOps;

    invoke-virtual {v4}, Lcom/android/server/soundtrigger/SoundTriggerService$NumOps;->getOpsAdded()I

    move-result v4

    iget-object v5, p0, mNumOps:Lcom/android/server/soundtrigger/SoundTriggerService$NumOps;

    invoke-virtual {v5, v1, v2}, Lcom/android/server/soundtrigger/SoundTriggerService$NumOps;->addOp(J)V

    iget v5, p0, mNumTotalOpsPerformed:I

    :cond_2
    iget v6, p0, mNumTotalOpsPerformed:I

    const/4 v7, 0x1

    add-int/2addr v6, v7

    iput v6, p0, mNumTotalOpsPerformed:I

    iget-object v6, p0, mRunningOpIds:Landroid/util/ArraySet;
    ...
    iget-object v9, p0, mPuuid:Landroid/os/ParcelUuid;
    ...
    iget-object v6, p0, mService:Landroid/media/soundtrigger/ISoundTriggerDetectionService;
    ...
    iget-object v11, p0, mPuuid:Landroid/os/ParcelUuid;
    ...
    :goto_0
    iget-object v5, p0, mPendingOps:Ljava/util/ArrayList;
    ...
    iget-object v5, p0, mRunningOpIds:Landroid/util/ArraySet;
    ...
    iget-boolean v5, p0, mDestroyOnceRunningOpsDone:Z
...
.method private stopAllPendingOperations()V
    ...
    iget-object v1, p0, mRunningOpIds:Landroid/util/ArraySet;
    ...
    :try_start_1
    iget-object v3, p0, mService:Landroid/media/soundtrigger/ISoundTriggerDetectionService;
    ...
    iget-object v6, p0, mPuuid:Landroid/os/ParcelUuid;
    ...
    iget-object v7, p0, mPuuid:Landroid/os/ParcelUuid;
    ...
    iget-object v7, p0, mRunningOpIds:Landroid/util/ArraySet;
    ...
    :cond_1
    iget-object v2, p0, mRunningOpIds:Landroid/util/ArraySet;
...
.method public synthetic lambda$onError$3$SoundTriggerService$RemoteSoundTriggerDetectionService()V
    ...
    iput-boolean v0, p0, mDestroyOnceRunningOpsDone:Z
...
.method public synthetic lambda$onError$4$SoundTriggerService$RemoteSoundTriggerDetectionService(IILandroid/media/soundtrigger/ISoundTriggerDetectionService;)V
    ...
    iget-object v0, p0, mPuuid:Landroid/os/ParcelUuid;
...
.method public synthetic lambda$onGenericSoundTriggerDetected$0$SoundTriggerService$RemoteSoundTriggerDetectionService()V
    ...
    iget-object v0, p0, mRecognitionConfig:Landroid/hardware/soundtrigger/SoundTrigger$RecognitionConfig;
...
.method public synthetic lambda$onGenericSoundTriggerDetected$2$SoundTriggerService$RemoteSoundTriggerDetectionService(Landroid/hardware/soundtrigger/SoundTrigger$GenericRecognitionEvent;)V
    ...
    invoke-direct {p0, p1}, createAudioRecordForEvent(Landroid/hardware/soundtrigger/SoundTrigger$GenericRecognitionEvent;)Landroid/media/AudioRecord;
...
.method public onError(I)V
    ...
    invoke-direct {p0, v0}, runOrAddOperation(Lcom/android/server/soundtrigger/SoundTriggerService$Operation;)V
...
.method public onRecognitionPaused()V
    ...
    iget-object v5, p0, mPuuid:Landroid/os/ParcelUuid;
...
.method public onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    iput-object v1, p0, mService:Landroid/media/soundtrigger/ISoundTriggerDetectionService;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget-object v3, p0, mParams:Landroid/os/Bundle;

    iget-object v4, p0, mClient:Landroid/media/soundtrigger/ISoundTriggerDetectionServiceClient;
    ...
    invoke-direct {p0, v1}, runOrAddOperation(Lcom/android/server/soundtrigger/SoundTriggerService$Operation;)V
