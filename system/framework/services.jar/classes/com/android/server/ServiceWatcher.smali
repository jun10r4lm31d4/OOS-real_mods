...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;IIILandroid/os/Handler;)V
    ...
    iput-object v2, p0, mServicePackageName:Ljava/lang/String;

    invoke-static {p1, v3}, getSignatureSets(Landroid/content/Context;[Ljava/lang/String;)Ljava/util/ArrayList;

    move-result-object v4

    iput-object v4, p0, mSignatureSets:Ljava/util/List;
    ...
    iput-object v3, p0, mServicePackageName:Ljava/lang/String;
    ...
    iget-object v5, p0, mServicePackageName:Ljava/lang/String;
    ...
    iput-object v3, p0, mSignatureSets:Ljava/util/List;

    :goto_0
    iput-object p7, p0, mHandler:Landroid/os/Handler;

    iput-object v2, p0, mBestComponent:Landroid/content/ComponentName;

    const/high16 v3, -0x80000000

    iput v3, p0, mBestVersion:I

    const/16 v3, -0x2710

    iput v3, p0, mBestUserId:I

    iput-object v2, p0, mBestService:Landroid/os/IBinder;
...
.method static synthetic access$000(Lcom/android/server/ServiceWatcher;Z)V
    ...
    invoke-direct {p0, p1}, bindBestPackage(Z)V
...
.method private bind(Landroid/content/ComponentName;II)V
    ...
    iput-object p1, p0, mBestComponent:Landroid/content/ComponentName;

    iput p2, p0, mBestVersion:I

    iput p3, p0, mBestUserId:I
...
.method private bindBestPackage(Z)V
    ...
    iget-object v2, v1, mAction:Ljava/lang/String;

    invoke-direct {v0, v2}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    move-object v2, v0

    iget-object v0, v1, mServicePackageName:Ljava/lang/String;
    ...
    iget-object v14, v1, mSignatureSets:Ljava/util/List;

    invoke-static {v13, v14}, isSignatureMatch([Landroid/content/pm/Signature;Ljava/util/List;)Z

    move-result v13

    if-nez v13, :cond_3

    iget-object v13, v1, mTag:Ljava/lang/String;
    ...
    iget-object v15, v1, mAction:Ljava/lang/String;
    ...
    iget-object v3, v1, mTag:Ljava/lang/String;
    ...
    iget-object v0, v1, mTag:Ljava/lang/String;
    ...
    iget-object v4, v1, mAction:Ljava/lang/String;
    ...
    invoke-direct/range {p0 .. p0}, unbind()V
    ...
    :cond_8
    iget v0, v1, mCurrentUserId:I

    :goto_3
    iget-object v3, v1, mBestComponent:Landroid/content/ComponentName;
    ...
    iget v3, v1, mBestVersion:I

    if-ne v9, v3, :cond_9

    iget v3, v1, mBestUserId:I
    ...
    invoke-direct {v1, v6, v9, v0}, bind(Landroid/content/ComponentName;II)V
...
.method private unbind()V
    ...
    iget-object v0, p0, mBestComponent:Landroid/content/ComponentName;
    ...
    iput-object v0, p0, mBestComponent:Landroid/content/ComponentName;

    const/high16 v0, -0x80000000

    iput v0, p0, mBestVersion:I

    const/16 v0, -0x2710

    iput v0, p0, mBestUserId:I
...
.method public synthetic lambda$onServiceConnected$3$ServiceWatcher(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    iput-object p2, p0, mBestService:Landroid/os/IBinder;

    invoke-virtual {p0}, onBind()V
...
.method public synthetic lambda$onServiceDisconnected$4$ServiceWatcher(Landroid/content/ComponentName;)V
    ...
    iput-object v0, p0, mBestService:Landroid/os/IBinder;

    invoke-virtual {p0}, onUnbind()V
...
.method public synthetic lambda$runOnBinder$1$ServiceWatcher(Lcom/android/server/ServiceWatcher$BinderRunner;)V
    ...
    iget-object v0, p0, mBestService:Landroid/os/IBinder;
    ...
    iget-object v2, p0, mBestService:Landroid/os/IBinder;
...
.method public synthetic lambda$start$0$ServiceWatcher()V
    ...
    invoke-direct {p0, v0}, bindBestPackage(Z)V
...
.method public final runOnBinderBlocking(Lcom/android/server/ServiceWatcher$BlockingBinderRunner;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, v0}, runOnHandlerBlocking(Ljava/util/concurrent/Callable;)Ljava/lang/Object;
...
.method public final start()Z
    ...
    invoke-direct {p0}, isServiceMissing()Z
