...
.method private constructor <init>(Lcom/android/server/LocationManagerService;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2, v0}, <init>(Lcom/android/server/LocationManagerService;Ljava/lang/String;Z)V
...
.method synthetic constructor <init>(Lcom/android/server/LocationManagerService;Ljava/lang/String;Lcom/android/server/LocationManagerService$1;)V
    ...
    invoke-direct {p0, p1, p2}, <init>(Lcom/android/server/LocationManagerService;Ljava/lang/String;)V
...
.method private constructor <init>(Lcom/android/server/LocationManagerService;Ljava/lang/String;Z)V
    ...
    iput-boolean p3, p0, mIsManagedBySettings:Z

    const/4 v0, 0x0

    iput-object v0, p0, mProvider:Lcom/android/server/location/AbstractLocationProvider;

    const/4 v1, 0x0

    iput-boolean v1, p0, mUseable:Z

    iget-boolean v2, p0, mIsManagedBySettings:Z

    xor-int/lit8 v3, v2, 0x1

    iput-boolean v3, p0, mAllowed:Z

    iput-boolean v1, p0, mEnabled:Z

    iput-object v0, p0, mProperties:Lcom/android/internal/location/ProviderProperties;
...
.method synthetic constructor <init>(Lcom/android/server/LocationManagerService;Ljava/lang/String;ZLcom/android/server/LocationManagerService$1;)V
    ...
    invoke-direct {p0, p1, p2, p3}, <init>(Lcom/android/server/LocationManagerService;Ljava/lang/String;Z)V
...
.method private isUseableIgnoringAllowedLocked()Z
    ...
    iget-object v0, p0, mProvider:Lcom/android/server/location/AbstractLocationProvider;
...
.method public attachLocked(Lcom/android/server/location/AbstractLocationProvider;)V
    ...
    :cond_1
    iput-object p1, p0, mProvider:Lcom/android/server/location/AbstractLocationProvider;

    invoke-virtual {p0, v1}, onUseableChangedLocked(Z)V
...
.method public dumpLocked(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v1, p0, mProvider:Lcom/android/server/location/AbstractLocationProvider;
    ...
    iget-boolean v0, p0, mIsManagedBySettings:Z
    ...
    iget-object v1, p0, mProperties:Lcom/android/internal/location/ProviderProperties;
    ...
    :try_start_0
    iget-object v2, p0, mProvider:Lcom/android/server/location/AbstractLocationProvider;
...
.method public isUseableLocked()Z
    ...
    invoke-virtual {p0, v0}, isUseableForUserLocked(I)Z
...
.method public synthetic lambda$onReportLocation$1$LocationManagerService$LocationProvider(Ljava/util/List;)V
    ...
    invoke-virtual {v1}, isUseableLocked()Z
...
.method public onAllowedChangedLocked()V
    ...
    :cond_1
    iput-boolean v1, p0, mAllowed:Z

    const/4 v2, 0x1

    invoke-virtual {p0, v2}, onUseableChangedLocked(Z)V
...
.method public onLocationModeChangedLocked()V
    ...
    invoke-virtual {p0, v0}, onUseableChangedLocked(Z)V
...
.method public onUseableChangedLocked(Z)V
    ...
    invoke-direct {p0}, isUseableIgnoringAllowedLocked()Z
