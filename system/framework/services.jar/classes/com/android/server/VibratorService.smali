...
.method static constructor <clinit>()V
    ...
    sput-object v0, DOUBLE_CLICK_EFFECT_FALLBACK_TIMINGS:[J
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mProcStatesCache:Landroid/util/SparseArray;

    new-instance v0, Landroid/os/WorkSource;

    invoke-direct {v0}, Landroid/os/WorkSource;-><init>()V

    iput-object v0, p0, mTmpWorkSource:Landroid/os/WorkSource;
    ...
    iput v0, p0, mSetVibratorEffectUid:I

    iput v0, p0, mSetVibratorEffectPid:I

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, mInputDeviceVibrators:Ljava/util/ArrayList;

    const/4 v1, -0x1

    iput v1, p0, mCurVibUid:I
    ...
    iput-object v2, p0, mVibrationEndRunnable:Ljava/lang/Runnable;
    ...
    invoke-static {}, vibratorInit()V

    invoke-static {}, vibratorOff()V

    invoke-static {}, Lcom/android/server/OpVibratorServiceInjector;->initCaliFile()V

    invoke-static {}, vibratorSupportsAmplitudeControl()Z

    move-result v3

    iput-boolean v3, p0, mSupportsAmplitudeControl:Z

    invoke-static {}, vibratorSupportsExternalControl()Z

    move-result v3

    iput-boolean v3, p0, mSupportsExternalControl:Z
    ...
    iput-object v4, p0, mWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    iput-object v4, p0, mAppOps:Landroid/app/AppOpsManager;
    ...
    iput-object v4, p0, mBatteryStatsService:Lcom/android/internal/app/IBatteryStats;
    ...
    iput v4, p0, mPreviousVibrationsLimit:I
    ...
    iput v4, p0, mDefaultVibrationAmplitude:I
    ...
    iput-boolean v4, p0, mAllowPriorityVibrationsInLowPowerMode:Z

    new-instance v4, Ljava/util/LinkedList;

    invoke-direct {v4}, Ljava/util/LinkedList;-><init>()V

    iput-object v4, p0, mPreviousRingVibrations:Ljava/util/LinkedList;

    new-instance v4, Ljava/util/LinkedList;

    invoke-direct {v4}, Ljava/util/LinkedList;-><init>()V

    iput-object v4, p0, mPreviousNotificationVibrations:Ljava/util/LinkedList;

    new-instance v4, Ljava/util/LinkedList;

    invoke-direct {v4}, Ljava/util/LinkedList;-><init>()V

    iput-object v4, p0, mPreviousAlarmVibrations:Ljava/util/LinkedList;

    new-instance v4, Ljava/util/LinkedList;

    invoke-direct {v4}, Ljava/util/LinkedList;-><init>()V

    iput-object v4, p0, mPreviousVibrations:Ljava/util/LinkedList;

    new-instance v4, Ljava/util/LinkedList;

    invoke-direct {v4}, Ljava/util/LinkedList;-><init>()V

    iput-object v4, p0, mPreviousExternalVibrations:Ljava/util/LinkedList;
    ...
    iget-object v5, p0, mIntentReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-direct {p0, v5}, createEffectFromResource(I)Landroid/os/VibrationEffect;

    move-result-object v5

    sget-object v6, DOUBLE_CLICK_EFFECT_FALLBACK_TIMINGS:[J
    ...
    invoke-direct {p0, v7}, createEffectFromResource(I)Landroid/os/VibrationEffect;

    move-result-object v7

    const v8, 0x1070025

    invoke-direct {p0, v8}, createEffectFromResource(I)Landroid/os/VibrationEffect;
    ...
    iput-object v9, p0, mFallbackEffects:Landroid/util/SparseArray;

    iget-object v9, p0, mFallbackEffects:Landroid/util/SparseArray;
    ...
    iput-object v9, p0, mScaleLevels:Landroid/util/SparseArray;

    iget-object v9, p0, mScaleLevels:Landroid/util/SparseArray;
    ...
    iget-object v1, p0, mScaleLevels:Landroid/util/SparseArray;
...
.method static synthetic access$000(Lcom/android/server/VibratorService;)Landroid/util/SparseArray;
    ...
    iget-object v0, p0, mProcStatesCache:Landroid/util/SparseArray;
...
.method static synthetic access$102(Lcom/android/server/VibratorService;I)I
    ...
    iput p1, p0, mSetVibratorEffectUid:I
...
.method static synthetic access$1400(Lcom/android/server/VibratorService;I)V
    ...
    invoke-direct {p0, p1}, doVibratorSetAmplitude(I)V
...
.method static synthetic access$1800(Lcom/android/server/VibratorService;)Z
    ...
    iget-boolean v0, p0, mSupportsExternalControl:Z
...
.method static synthetic access$1900(Lcom/android/server/VibratorService;)Landroid/os/ExternalVibration;
    ...
    iget-object v0, p0, mCurrentExternalVibration:Landroid/os/ExternalVibration;
...
.method static synthetic access$1902(Lcom/android/server/VibratorService;Landroid/os/ExternalVibration;)Landroid/os/ExternalVibration;
    ...
    iput-object p1, p0, mCurrentExternalVibration:Landroid/os/ExternalVibration;
...
.method static synthetic access$2000(Lcom/android/server/VibratorService;Z)V
    ...
    invoke-direct {p0, p1}, setVibratorUnderExternalControl(Z)V
...
.method static synthetic access$202(Lcom/android/server/VibratorService;I)I
    ...
    iput p1, p0, mSetVibratorEffectPid:I
...
.method static synthetic access$2200(Lcom/android/server/VibratorService;)Ljava/util/LinkedList;
    ...
    iget-object v0, p0, mPreviousExternalVibrations:Ljava/util/LinkedList;
...
.method static synthetic access$2300(Lcom/android/server/VibratorService;)I
    ...
    iget v0, p0, mPreviousVibrationsLimit:I
...
.method static synthetic access$2600(Lcom/android/server/VibratorService;)I
    ...
    iget v0, p0, mNotificationIntensity:I
...
.method static synthetic access$2700(Lcom/android/server/VibratorService;)I
    ...
    iget v0, p0, mHapticFeedbackIntensity:I
...
.method static synthetic access$400(I)Z
    ...
    invoke-static {p0}, isHapticFeedback(I)Z
...
.method static synthetic access$500(I)Z
    ...
    invoke-static {p0}, isNotification(I)Z
...
.method static synthetic access$600(I)Z
    ...
    invoke-static {p0}, isRingtone(I)Z
...
.method static synthetic access$800(Lcom/android/server/VibratorService;)V
    ...
    invoke-direct {p0}, updateVibrators()V
...
.method private addToPreviousVibrationsLocked(Lcom/android/server/VibratorService$Vibration;)V
    ...
    iget-object v0, p0, mPreviousRingVibrations:Ljava/util/LinkedList;
    ...
    iget-object v0, p0, mPreviousNotificationVibrations:Ljava/util/LinkedList;
    ...
    iget-object v0, p0, mPreviousAlarmVibrations:Ljava/util/LinkedList;
    ...
    iget v2, p0, mPreviousVibrationsLimit:I
...
.method private applyVibrationIntensityScalingLocked(Lcom/android/server/VibratorService$Vibration;I)V
    ...
    invoke-static {p2}, intensityToEffectStrength(I)I
    ...
    iget v4, p0, mDefaultVibrationAmplitude:I
...
.method private createEffectFromResource(I)Landroid/os/VibrationEffect;
    ...
    invoke-static {v0, p1}, getLongIntArray(Landroid/content/res/Resources;I)[J

    move-result-object v0

    invoke-static {v0}, createEffectFromTimings([J)Landroid/os/VibrationEffect;
...
.method private doCancelVibrateLocked()V
    ...
    iget-object v6, p0, mVibrationEndRunnable:Ljava/lang/Runnable;

    invoke-virtual {v5, v6}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    iget-object v5, p0, mThread:Lcom/android/server/VibratorService$VibrateThread;
    ...
    iput-object v6, p0, mThread:Lcom/android/server/VibratorService$VibrateThread;

    :cond_0
    iget-object v5, p0, mCurrentExternalVibration:Landroid/os/ExternalVibration;
    ...
    iput-object v6, p0, mCurrentExternalVibration:Landroid/os/ExternalVibration;

    invoke-direct {p0, v2}, setVibratorUnderExternalControl(Z)V
...
.method private doVibratorOff()V
    ...
    :cond_0
    invoke-direct {p0}, noteVibratorOffLocked()V
    ...
    iget-object v5, p0, mInputDeviceVibrators:Ljava/util/ArrayList;
...
.method private doVibratorOn(JIII)V
    ...
    :try_start_1
    iget v3, p0, mDefaultVibrationAmplitude:I
    ...
    :cond_1
    invoke-direct {p0, p4, p1, p2}, noteVibratorOnLocked(IJ)V
    ...
    iget-object v6, p0, mInputDeviceVibrators:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, p3}, doVibratorSetAmplitude(I)V
...
.method private doVibratorPrebakedEffectLocked(Lcom/android/server/VibratorService$Vibration;)J
    ...
    iget-object v1, v10, mInputDeviceVibrators:Ljava/util/ArrayList;
    ...
    :try_start_1
    iget-object v0, v10, mInputDeviceVibrators:Ljava/util/ArrayList;
    ...
    invoke-static {v1, v2, v3, v4}, vibratorPerformEffect(JJ)J
    ...
    invoke-direct {v10, v3, v1, v2}, noteVibratorOnLocked(IJ)V
    :try_end_2
    ...
    invoke-direct {v10, v1}, getFallbackEffect(I)Landroid/os/VibrationEffect;
    ...
    invoke-direct {v10, v1}, getCurrentIntensityLocked(Lcom/android/server/VibratorService$Vibration;)I

    move-result v2

    invoke-direct {v10, v1}, linkVibration(Lcom/android/server/VibratorService$Vibration;)V

    invoke-direct {v10, v1, v2}, applyVibrationIntensityScalingLocked(Lcom/android/server/VibratorService$Vibration;I)V

    invoke-direct {v10, v1}, startVibrationInnerLocked(Lcom/android/server/VibratorService$Vibration;)V
    :try_end_5
...
.method private doVibratorSetAmplitude(I)V
    ...
    iget-boolean v0, p0, mSupportsAmplitudeControl:Z
    ...
    :cond_0
    invoke-static {p1}, vibratorSetAmplitude(I)V
...
.method private getFallbackEffect(I)Landroid/os/VibrationEffect;
    ...
    iget-object v0, p0, mFallbackEffects:Landroid/util/SparseArray;
...
.method private isAllowedToVibrateLocked(Lcom/android/server/VibratorService$Vibration;)Z
    ...
    :cond_0
    iget-boolean v0, p0, mLowPowerMode:Z
...
.method private noteVibratorOffLocked()V
    ...
    iget v0, p0, mCurVibUid:I

    if-ltz v0, :cond_0

    :try_start_0
    iget-object v1, p0, mBatteryStatsService:Lcom/android/internal/app/IBatteryStats;

    invoke-interface {v1, v0}, Lcom/android/internal/app/IBatteryStats;->noteVibratorOff(I)V

    const/16 v0, 0x54

    iget v1, p0, mCurVibUid:I
...
.method private noteVibratorOnLocked(IJ)V
    ...
    :try_start_0
    iget-object v0, p0, mBatteryStatsService:Lcom/android/internal/app/IBatteryStats;
...
.method private reportFinishVibrationLocked()V
    ...
    iget-object v5, p0, mCurrentVibration:Lcom/android/server/VibratorService$Vibration;
...
.method private setVibratorUnderExternalControl(Z)V
    ...
    :cond_1
    :goto_0
    iput-boolean p1, p0, mVibratorUnderExternalControl:Z

    invoke-static {p1}, vibratorSetExternalControl(Z)V
...
.method private startVibrationInnerLocked(Lcom/android/server/VibratorService$Vibration;)V
    ...
    :try_start_0
    iput-object p1, p0, mCurrentVibration:Lcom/android/server/VibratorService$Vibration;
    ...
    invoke-direct/range {v3 .. v8}, doVibratorOn(JIII)V

    iget-object v3, p0, mH:Landroid/os/Handler;

    iget-object v4, p0, mVibrationEndRunnable:Ljava/lang/Runnable;
    ...
    iput-object v3, p0, mThread:Lcom/android/server/VibratorService$VibrateThread;

    iget-object v3, p0, mThread:Lcom/android/server/VibratorService$VibrateThread;
    ...
    invoke-direct {p0, p1}, doVibratorPrebakedEffectLocked(Lcom/android/server/VibratorService$Vibration;)J
    ...
    iget-object v5, p0, mVibrationEndRunnable:Ljava/lang/Runnable;
...
.method private startVibrationLocked(Lcom/android/server/VibratorService$Vibration;)V
    ...
    :cond_0
    :goto_0
    invoke-direct {p0, p1}, isAllowedToVibrateLocked(Lcom/android/server/VibratorService$Vibration;)Z
    ...
    :cond_1
    :try_start_3
    invoke-direct {p0, p1}, getCurrentIntensityLocked(Lcom/android/server/VibratorService$Vibration;)I
    ...
    invoke-direct {p0}, shouldVibrateForRingtone()Z
    ...
    :cond_4
    :try_start_5
    invoke-direct {p0, p1}, getAppOpMode(Lcom/android/server/VibratorService$Vibration;)I
    ...
    :cond_6
    :try_start_6
    invoke-direct {p0, p1, v2}, applyVibrationIntensityScalingLocked(Lcom/android/server/VibratorService$Vibration;I)V

    invoke-direct {p0, p1}, startVibrationInnerLocked(Lcom/android/server/VibratorService$Vibration;)V
    :try_end_6
...
.method private updateInputDeviceVibratorsLocked()Z
    ...
    iput-boolean v1, p0, mVibrateInputDevicesSetting:Z
    ...
    iget-boolean v2, p0, mInputDeviceListenerRegistered:Z

    if-nez v2, :cond_3

    iput-boolean v3, p0, mInputDeviceListenerRegistered:Z

    iget-object v2, p0, mIm:Landroid/hardware/input/InputManager;
    ...
    iput-boolean v2, p0, mInputDeviceListenerRegistered:Z
    ...
    iget-boolean v2, p0, mVibrateInputDevicesSetting:Z
    ...
    iget-object v5, p0, mIm:Landroid/hardware/input/InputManager;
...
.method private updateVibrationIntensityLocked()V
    ...
    iput v0, p0, mHapticFeedbackIntensity:I
    ...
    iput v0, p0, mNotificationIntensity:I
...
.method private updateVibrators()V
    ...
    :cond_0
    invoke-direct {p0}, updateInputDeviceVibratorsLocked()Z

    move-result v1

    invoke-direct {p0}, updateLowPowerModeLocked()Z

    move-result v2

    invoke-direct {p0}, updateVibrationIntensityLocked()V
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v1, p0, mCurrentExternalVibration:Landroid/os/ExternalVibration;
    ...
    iget-boolean v2, p0, mVibratorUnderExternalControl:Z
    ...
    iget v2, p0, mHapticFeedbackIntensity:I
    ...
    iget v2, p0, mNotificationIntensity:I
    ...
    iget-object v1, p0, mPreviousRingVibrations:Ljava/util/LinkedList;
    ...
    iget-object v1, p0, mPreviousNotificationVibrations:Ljava/util/LinkedList;
    ...
    iget-object v1, p0, mPreviousAlarmVibrations:Ljava/util/LinkedList;
    ...
    iget-object v1, p0, mPreviousVibrations:Ljava/util/LinkedList;
    ...
    iget-object v1, p0, mPreviousExternalVibrations:Ljava/util/LinkedList;
...
.method public hasAmplitudeControl()Z
    ...
    iget-object v0, p0, mInputDeviceVibrators:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-boolean v1, p0, mSupportsAmplitudeControl:Z

    if-eqz v1, :cond_0

    iget-object v1, p0, mInputDeviceVibrators:Ljava/util/ArrayList;
...
.method public systemReady()V
    ...
    iput-object v2, p0, mSettingObserver:Lcom/android/server/VibratorService$SettingsObserver;
    ...
    iput-object v2, p0, mPowerManagerInternal:Landroid/os/PowerManagerInternal;

    iget-object v2, p0, mPowerManagerInternal:Landroid/os/PowerManagerInternal;
    ...
    iget-object v4, p0, mSettingObserver:Lcom/android/server/VibratorService$SettingsObserver;
    ...
    iget-object v7, p0, mSettingObserver:Lcom/android/server/VibratorService$SettingsObserver;
    ...
    iget-object v6, p0, mH:Landroid/os/Handler;
...
.method public vibrate(ILjava/lang/String;Landroid/os/VibrationEffect;ILjava/lang/String;Landroid/os/IBinder;)V
    ...
    invoke-static/range {p3 .. p3}, verifyVibrationEffect(Landroid/os/VibrationEffect;)Z
    ...
    :cond_3
    :try_start_4
    iget-object v15, v10, mLock:Ljava/lang/Object;
    ...
    iget-object v0, v10, mCurrentVibration:Lcom/android/server/VibratorService$Vibration;
    ...
    iget-object v2, v10, mCurrentVibration:Lcom/android/server/VibratorService$Vibration;

    iget-object v2, v2, Lcom/android/server/VibratorService$Vibration;->effect:Landroid/os/VibrationEffect;

    check-cast v2, Landroid/os/VibrationEffect$OneShot;

    iget-object v3, v10, mCurrentVibration:Lcom/android/server/VibratorService$Vibration;
    ...
    :cond_5
    :try_start_6
    iget-object v0, v10, mCurrentExternalVibration:Landroid/os/ExternalVibration;
    ...
    :cond_7
    :try_start_7
    invoke-static/range {p3 .. p3}, isRepeatingVibration(Landroid/os/VibrationEffect;)Z
    ...
    invoke-static {v0}, isRepeatingVibration(Landroid/os/VibrationEffect;)Z
    ...
    iget v0, v10, mSetVibratorEffectUid:I

    if-eq v0, v11, :cond_c

    iget v0, v10, mSetVibratorEffectPid:I
    ...
    :cond_c
    iput v4, v10, mSetVibratorEffectUid:I

    iput v4, v10, mSetVibratorEffectPid:I
    ...
    iget-object v0, v10, mProcStatesCache:Landroid/util/SparseArray;
    ...
    :try_start_d
    invoke-direct/range {p0 .. p0}, doCancelVibrateLocked()V

    invoke-direct {v10, v1}, startVibrationLocked(Lcom/android/server/VibratorService$Vibration;)V

    invoke-direct {v10, v1}, addToPreviousVibrationsLocked(Lcom/android/server/VibratorService$Vibration;)V
    :try_end_d
