...
.method private adjustAndSetDeviceSystemClock(Landroid/util/TimestampedValue;ZJJLjava/lang/String;)V
    ...
    iget-object v9, v0, mCallback:Lcom/android/server/timedetector/TimeDetectorStrategy$Callback;
    ...
    iget-object v11, v0, mCallback:Lcom/android/server/timedetector/TimeDetectorStrategy$Callback;

    invoke-interface {v11, v5, v6}, Lcom/android/server/timedetector/TimeDetectorStrategy$Callback;->setSystemClock(J)V

    iput-object v1, v0, mLastSystemClockTimeSet:Landroid/util/TimestampedValue;
    ...
    iget-object v12, v0, mCallback:Lcom/android/server/timedetector/TimeDetectorStrategy$Callback;
...
.method private setSystemClockIfRequired(Landroid/util/TimestampedValue;Z)V
    ...
    iput-object v10, v9, mLastSystemClockTime:Landroid/util/TimestampedValue;

    move/from16 v11, p2

    iput-boolean v11, v9, mLastSystemClockTimeSendNetworkBroadcast:Z

    iget-object v0, v9, mCallback:Lcom/android/server/timedetector/TimeDetectorStrategy$Callback;
    ...
    iget-object v0, v9, mLastSystemClockTimeSet:Landroid/util/TimestampedValue;
    ...
    invoke-direct/range {v1 .. v8}, adjustAndSetDeviceSystemClock(Landroid/util/TimestampedValue;ZJJLjava/lang/String;)V
    :try_end_0
    ...
    iget-object v1, v9, mCallback:Lcom/android/server/timedetector/TimeDetectorStrategy$Callback;
...
.method public dump(Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v1, p0, mLastNitzTime:Landroid/util/TimestampedValue;
    ...
    iget-object v1, p0, mLastSystemClockTimeSet:Landroid/util/TimestampedValue;
    ...
    iget-object v1, p0, mLastSystemClockTime:Landroid/util/TimestampedValue;
    ...
    iget-boolean v1, p0, mLastSystemClockTimeSendNetworkBroadcast:Z
...
.method public handleAutoTimeDetectionToggle(Z)V
    ...
    iget-object v0, p0, mLastSystemClockTime:Landroid/util/TimestampedValue;

    if-eqz v0, :cond_1

    iget-boolean v0, p0, mLastSystemClockTimeSendNetworkBroadcast:Z

    iget-object v1, p0, mCallback:Lcom/android/server/timedetector/TimeDetectorStrategy$Callback;
    ...
    iget-object v2, p0, mLastSystemClockTime:Landroid/util/TimestampedValue;
    ...
    iget-object v2, p0, mCallback:Lcom/android/server/timedetector/TimeDetectorStrategy$Callback;
    ...
    iput-object v0, p0, mLastSystemClockTimeSet:Landroid/util/TimestampedValue;
...
.method public initialize(Lcom/android/server/timedetector/TimeDetectorStrategy$Callback;)V
    ...
    iput-object p1, p0, mCallback:Lcom/android/server/timedetector/TimeDetectorStrategy$Callback;
...
.method public suggestTime(Landroid/app/timedetector/TimeSignal;)V
    ...
    iget-object v2, p0, mLastNitzTime:Landroid/util/TimestampedValue;

    invoke-static {v0, v2}, validateNewNitzTime(Landroid/util/TimestampedValue;Landroid/util/TimestampedValue;)Z
    ...
    :cond_1
    iput-object v0, p0, mLastNitzTime:Landroid/util/TimestampedValue;
    ...
    invoke-direct {p0, v3, v1}, setSystemClockIfRequired(Landroid/util/TimestampedValue;Z)V
