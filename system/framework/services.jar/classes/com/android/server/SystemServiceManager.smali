...
.method public static ensureSystemDir()Ljava/io/File;
    ...
    sget-object v0, sSystemDir:Ljava/io/File;
    ...
    sput-object v1, sSystemDir:Ljava/io/File;

    sget-object v1, sSystemDir:Ljava/io/File;
...
.method public cleanupUser(I)V
    ...
    invoke-direct {p0, v9, v10, v3, v4}, warnIfTooLong(JLcom/android/server/SystemService;Ljava/lang/String;)V
...
.method public getRuntimeStartElapsedTime()J
    ...
    iget-wide v0, p0, mRuntimeStartElapsedTime:J
...
.method public getRuntimeStartUptime()J
    ...
    iget-wide v0, p0, mRuntimeStartUptime:J
...
.method public isRuntimeRestarted()Z
    ...
    iget-boolean v0, p0, mRuntimeRestarted:Z
...
.method setStartInfo(ZJJ)V
    ...
    iput-boolean p1, p0, mRuntimeRestarted:Z

    iput-wide p2, p0, mRuntimeStartElapsedTime:J

    iput-wide p4, p0, mRuntimeStartUptime:J
...
.method public startBootPhase(I)V
    ...
    invoke-direct {p0, v7, v8, v4, v9}, warnIfTooLong(JLcom/android/server/SystemService;Ljava/lang/String;)V
...
.method public startService(Ljava/lang/Class;)Lcom/android/server/SystemService;
    ...
    :try_start_2
    invoke-virtual {p0, v0}, startService(Lcom/android/server/SystemService;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method public startService(Ljava/lang/String;)Lcom/android/server/SystemService;
    ...
    invoke-virtual {p0, v0}, startService(Ljava/lang/Class;)Lcom/android/server/SystemService;
...
.method public startService(Lcom/android/server/SystemService;)V
    ...
    invoke-direct {p0, v2, v3, p1, v4}, warnIfTooLong(JLcom/android/server/SystemService;Ljava/lang/String;)V
...
.method public startUser(I)V
    ...
    invoke-direct {p0, v10, v11, v3, v5}, warnIfTooLong(JLcom/android/server/SystemService;Ljava/lang/String;)V
