...
.method static constructor <clinit>()V
    ...
    sput-object v1, SCREEN_TIME_THRESHOLDS:[J

    new-array v1, v0, [J

    fill-array-data v1, :array_1

    sput-object v1, ELAPSED_TIME_THRESHOLDS:[J

    new-array v1, v0, [I

    fill-array-data v1, :array_2

    sput-object v1, THRESHOLD_BUCKETS:[I

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1, v0}, Ljava/util/ArrayList;-><init>(I)V

    sput-object v1, sStandbyUpdatePool:Ljava/util/ArrayList;
...
.method constructor <init>(Landroid/content/Context;Landroid/os/Looper;)V
    ...
    invoke-direct {p0, v0}, <init>(Lcom/android/server/usage/AppStandbyController$Injector;)V
...
.method constructor <init>(Lcom/android/server/usage/AppStandbyController$Injector;)V
    ...
    iput-object v0, p0, mAppIdleLock:Ljava/lang/Object;
    ...
    iput-object v0, p0, mActiveAdminApps:Landroid/util/SparseArray;
    ...
    sget-object v0, SCREEN_TIME_THRESHOLDS:[J

    iput-object v0, p0, mAppStandbyScreenThresholds:[J

    sget-object v0, ELAPSED_TIME_THRESHOLDS:[J

    iput-object v0, p0, mAppStandbyElapsedThresholds:[J

    const/4 v0, 0x0

    iput-boolean v0, p0, mSystemServicesReady:Z
    ...
    iput-object v0, p0, mNetworkRequest:Landroid/net/NetworkRequest;
    ...
    iput-object p1, p0, mInjector:Lcom/android/server/usage/AppStandbyController$Injector;

    iget-object v0, p0, mInjector:Lcom/android/server/usage/AppStandbyController$Injector;
    ...
    iget-object v1, p0, mInjector:Lcom/android/server/usage/AppStandbyController$Injector;
    ...
    iput-object v0, p0, mHandler:Lcom/android/server/usage/AppStandbyController$AppStandbyHandler;
    ...
    iput-object v0, p0, mDeviceStateReceiver:Lcom/android/server/usage/AppStandbyController$DeviceStateReceiver;
    ...
    iget-object v3, p0, mDeviceStateReceiver:Lcom/android/server/usage/AppStandbyController$DeviceStateReceiver;

    invoke-virtual {v2, v3, v0}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    iget-object v2, p0, mAppIdleLock:Ljava/lang/Object;
    ...
    iget-object v4, p0, mInjector:Lcom/android/server/usage/AppStandbyController$Injector;

    invoke-virtual {v4}, Lcom/android/server/usage/AppStandbyController$Injector;->getDataSystemDirectory()Ljava/io/File;

    move-result-object v4

    iget-object v5, p0, mInjector:Lcom/android/server/usage/AppStandbyController$Injector;
    ...
    iput-object v3, p0, mAppIdleHistory:Lcom/android/server/usage/AppIdleHistory;
    ...
    iget-object v8, p0, mHandler:Lcom/android/server/usage/AppStandbyController$AppStandbyHandler;
...
.method static synthetic access$200(Lcom/android/server/usage/AppStandbyController;)Lcom/android/server/usage/AppStandbyController$AppStandbyHandler;
    ...
    iget-object v0, p0, mHandler:Lcom/android/server/usage/AppStandbyController$AppStandbyHandler;
...
.method static synthetic access$300(Lcom/android/server/usage/AppStandbyController;)V
    ...
    invoke-direct {p0}, waitForAdminData()V
...
.method static synthetic access$400(Lcom/android/server/usage/AppStandbyController;Ljava/lang/String;IIJ)V
    ...
    invoke-direct/range {p0 .. p5}, checkAndUpdateStandbyState(Ljava/lang/String;IIJ)V
...
.method static synthetic access$600(Lcom/android/server/usage/AppStandbyController;)Ljava/lang/Object;
    ...
    iget-object v0, p0, mAppIdleLock:Ljava/lang/Object;
...
.method static synthetic access$700(Lcom/android/server/usage/AppStandbyController;)Lcom/android/server/usage/AppIdleHistory;
    ...
    iget-object v0, p0, mAppIdleHistory:Lcom/android/server/usage/AppIdleHistory;
...
.method private checkAndUpdateStandbyState(Ljava/lang/String;IIJ)V
    ...
    :try_start_0
    iget-object v0, v9, mPackageManager:Landroid/content/pm/PackageManager;
    ...
    invoke-virtual {v9, v10, v0, v11}, isAppSpecial(Ljava/lang/String;II)Z
    ...
    iget-object v8, v9, mAppIdleLock:Ljava/lang/Object;

    monitor-enter v8

    :try_start_1
    iget-object v1, v9, mAppIdleHistory:Lcom/android/server/usage/AppIdleHistory;
    ...
    invoke-direct/range {v1 .. v8}, maybeInformListeners(Ljava/lang/String;IJIIZ)V
    ...
    :try_start_3
    iget-object v0, v9, mAppIdleHistory:Lcom/android/server/usage/AppIdleHistory;
    ...
    invoke-direct {v9, v0, v12, v13}, predictionTimedOut(Lcom/android/server/usage/AppIdleHistory$AppUsageHistory;J)Z
    ...
    :cond_5
    invoke-virtual {v9, v10, v11, v12, v13}, getBucketForLocked(Ljava/lang/String;IJ)I
    ...
    :cond_7
    :goto_1
    iget-object v2, v9, mAppIdleHistory:Lcom/android/server/usage/AppIdleHistory;
...
.method private fetchCarrierPrivilegedAppsLocked()V
    ...
    iput-object v1, p0, mCarrierPrivilegedApps:Ljava/util/List;

    const/4 v1, 0x1

    iput-boolean v1, p0, mHaveCarrierPrivilegedApps:Z
    ...
    iget-object v2, p0, mCarrierPrivilegedApps:Ljava/util/List;
...
.method private isAppIdleUnfiltered(Ljava/lang/String;IJ)Z
    ...
    :try_start_0
    iget-object v1, p0, mAppIdleHistory:Lcom/android/server/usage/AppIdleHistory;
...
.method private isCarrierApp(Ljava/lang/String;)Z
    ...
    :try_start_0
    iget-boolean v1, p0, mHaveCarrierPrivilegedApps:Z

    if-nez v1, :cond_0

    invoke-direct {p0}, fetchCarrierPrivilegedAppsLocked()V

    :cond_0
    iget-object v1, p0, mCarrierPrivilegedApps:Ljava/util/List;
...
.method private maybeInformListeners(Ljava/lang/String;IJIIZ)V
    ...
    :cond_0
    iget-object v2, p0, mHandler:Lcom/android/server/usage/AppStandbyController$AppStandbyHandler;

    iget-object v3, p0, mHandler:Lcom/android/server/usage/AppStandbyController$AppStandbyHandler;
...
.method private postNextParoleTimeout(JZ)V
    ...
    iget-wide v4, p0, mAppIdleParoleWindowMillis:J
...
.method private predictionTimedOut(Lcom/android/server/usage/AppIdleHistory$AppUsageHistory;J)Z
    ...
    iget-wide v2, p0, mPredictionTimeoutMillis:J
...
.method public addActiveDeviceAdmin(Ljava/lang/String;I)V
    ...
    iget-object v0, p0, mActiveAdminApps:Landroid/util/SparseArray;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, mActiveAdminApps:Landroid/util/SparseArray;
    ...
    iget-object v2, p0, mActiveAdminApps:Landroid/util/SparseArray;
...
.method addListener(Landroid/app/usage/UsageStatsManagerInternal$AppIdleStateChangeListener;)V
    ...
    :try_start_0
    iget-object v1, p0, mPackageAccessListeners:Ljava/util/ArrayList;
...
.method checkIdleStates(I)Z
    ...
    iget-boolean v0, v7, mAppIdleEnabled:Z
    ...
    :cond_0
    :try_start_0
    iget-object v0, v7, mInjector:Lcom/android/server/usage/AppStandbyController$Injector;
    ...
    iget-object v1, v7, mInjector:Lcom/android/server/usage/AppStandbyController$Injector;
    ...
    :cond_3
    iget-object v1, v7, mPackageManager:Landroid/content/pm/PackageManager;
    ...
    invoke-direct/range {v1 .. v6}, checkAndUpdateStandbyState(Ljava/lang/String;IIJ)V
    ...
    iget-object v3, v7, mInjector:Lcom/android/server/usage/AppStandbyController$Injector;
...
.method checkParoleTimeout()V
    ...
    :goto_0
    iget-object v6, p0, mAppIdleLock:Ljava/lang/Object;

    monitor-enter v6

    :try_start_0
    iget-object v7, p0, mInjector:Lcom/android/server/usage/AppStandbyController$Injector;

    invoke-virtual {v7}, Lcom/android/server/usage/AppStandbyController$Injector;->currentTimeMillis()J

    move-result-wide v7

    iget-boolean v9, p0, mAppIdleTempParoled:Z

    if-nez v9, :cond_8

    iget-wide v9, p0, mLastAppIdleParoledTime:J

    sub-long v9, v7, v9

    iget-wide v11, p0, mAppIdleParoleIntervalMillis:J
    ...
    iget-wide v13, p0, mAppIdleParoleWindowMillis:J
    ...
    invoke-direct {p0, v7, v8, v4}, postNextParoleTimeout(JZ)V
    ...
    :cond_7
    invoke-direct {p0, v7, v8, v3}, postNextParoleTimeout(JZ)V
    ...
    iget-object v6, p0, mNetworkRequest:Landroid/net/NetworkRequest;

    iget-object v7, p0, mNetworkCallback:Landroid/net/ConnectivityManager$NetworkCallback;
    ...
    invoke-virtual {p0, v4}, setAppIdleParoled(Z)V
...
.method dumpState([Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    iget-boolean v2, p0, mHaveCarrierPrivilegedApps:Z
    ...
    iget-wide v2, p0, mCheckIdleIntervalMillis:J
    ...
    iget-wide v2, p0, mAppIdleParoleIntervalMillis:J
    ...
    iget-wide v2, p0, mAppIdleParoleWindowMillis:J
    ...
    iget-wide v2, p0, mStrongUsageTimeoutMillis:J
    ...
    iget-wide v2, p0, mNotificationSeenTimeoutMillis:J
    ...
    iget-wide v2, p0, mSyncAdapterTimeoutMillis:J
    ...
    iget-wide v2, p0, mSystemInteractionTimeoutMillis:J
    ...
    iget-wide v2, p0, mInitialForegroundServiceStartTimeoutMillis:J
    ...
    iget-wide v2, p0, mExemptedSyncScheduledNonDozeTimeoutMillis:J
    ...
    iget-wide v2, p0, mExemptedSyncScheduledDozeTimeoutMillis:J
    ...
    iget-wide v2, p0, mExemptedSyncStartTimeoutMillis:J
    ...
    iget-wide v2, p0, mUnexemptedSyncScheduledTimeoutMillis:J
    ...
    iget-wide v2, p0, mSystemUpdateUsageTimeoutMillis:J
    ...
    iget-wide v2, p0, mStableChargingThresholdMillis:J
    ...
    iget-boolean v2, p0, mAppIdleEnabled:Z
    ...
    iget-boolean v2, p0, mAppIdleTempParoled:Z
    ...
    iget-boolean v2, p0, mCharging:Z
    ...
    iget-boolean v2, p0, mChargingStable:Z
    ...
    iget-object v2, p0, mAppStandbyScreenThresholds:[J
    ...
    iget-object v2, p0, mAppStandbyElapsedThresholds:[J
...
.method forceIdleState(Ljava/lang/String;IZ)V
    ...
    iget-boolean v0, v15, mAppIdleEnabled:Z
    ...
    :cond_0
    invoke-virtual/range {p0 .. p1}, getAppId(Ljava/lang/String;)I
    ...
    :cond_1
    iget-object v0, v15, mInjector:Lcom/android/server/usage/AppStandbyController$Injector;
    ...
    invoke-virtual/range {v1 .. v6}, isAppIdleFiltered(Ljava/lang/String;IIJ)Z

    move-result v14

    iget-object v7, v15, mAppIdleLock:Ljava/lang/Object;

    monitor-enter v7

    :try_start_0
    iget-object v1, v15, mAppIdleHistory:Lcom/android/server/usage/AppIdleHistory;
    ...
    invoke-direct/range {v7 .. v14}, maybeInformListeners(Ljava/lang/String;IJIIZ)V
...
.method getBucketForLocked(Ljava/lang/String;IJ)I
    ...
    iget-object v5, p0, mAppStandbyScreenThresholds:[J

    iget-object v6, p0, mAppStandbyElapsedThresholds:[J
    ...
    sget-object v1, THRESHOLD_BUCKETS:[I
...
.method getIdleUidsForUser(I)[I
    ...
    invoke-virtual/range {v2 .. v7}, isAppIdleFiltered(Ljava/lang/String;IIJ)Z
    ...
    iget-object v2, p0, mInjector:Lcom/android/server/usage/AppStandbyController$Injector;
...
.method public getTimeSinceLastJobRun(Ljava/lang/String;I)J
    ...
    :try_start_0
    iget-object v3, p0, mAppIdleHistory:Lcom/android/server/usage/AppIdleHistory;
...
.method informParoleStateChanged()V
    ...
    invoke-virtual {p0}, isParoledOrCharging()Z
...
.method initializeDefaultsForSystemApps(I)V
    ...
    iget-boolean v0, v1, mSystemServicesReady:Z

    if-nez v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, v1, mPendingInitializeDefaults:Z
    ...
    iget-boolean v2, v1, mAppIdleEnabled:Z
    ...
    iget-object v0, v1, mInjector:Lcom/android/server/usage/AppStandbyController$Injector;
    ...
    iget-object v9, v1, mAppIdleLock:Ljava/lang/Object;
    ...
    iget-object v2, v1, mAppIdleHistory:Lcom/android/server/usage/AppIdleHistory;

    const/16 v5, 0xa

    const/4 v6, 0x6

    iget-wide v7, v1, mSystemUpdateUsageTimeoutMillis:J
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget-object v0, v1, mAppIdleHistory:Lcom/android/server/usage/AppIdleHistory;
...
.method isAppIdleFiltered(Ljava/lang/String;IIJ)Z
    ...
    invoke-virtual {p0, p1, p2, p3}, isAppSpecial(Ljava/lang/String;II)Z
    ...
    :cond_0
    invoke-direct {p0, p1, p3, p4, p5}, isAppIdleUnfiltered(Ljava/lang/String;IJ)Z
...
.method isAppIdleFilteredOrParoled(Ljava/lang/String;IJZ)Z
    ...
    :cond_1
    invoke-virtual {p0, p1}, getAppId(Ljava/lang/String;)I
...
.method isAppSpecial(Ljava/lang/String;II)Z
    ...
    :cond_3
    iget-boolean v1, p0, mSystemServicesReady:Z
    ...
    invoke-virtual {p0, p1, p3}, isActiveDeviceAdmin(Ljava/lang/String;I)Z
    ...
    iget-object v3, p0, mInjector:Lcom/android/server/usage/AppStandbyController$Injector;
    ...
    :cond_7
    invoke-direct {p0, p1}, isDeviceProvisioningPackage(Ljava/lang/String;)Z
...
.method public onBootPhase(I)V
    ...
    iget-object v1, p0, mHandler:Lcom/android/server/usage/AppStandbyController$AppStandbyHandler;
    ...
    iget-object v1, p0, mAppIdleLock:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, mAppIdleHistory:Lcom/android/server/usage/AppIdleHistory;

    invoke-virtual {p0}, isDisplayOn()Z
    ...
    iput-boolean v1, p0, mSystemServicesReady:Z
    ...
    iget-boolean v2, p0, mPendingInitializeDefaults:Z
    ...
    :cond_0
    invoke-virtual {p0, v3}, initializeDefaultsForSystemApps(I)V

    :cond_1
    iget-boolean v2, p0, mPendingOneTimeCheckIdleStates:Z

    if-eqz v2, :cond_3

    invoke-virtual {p0}, postOneTimeCheckIdleStates()V
    ...
    invoke-virtual {p0, v0}, setChargingState(Z)V
...
.method onDeviceIdleModeChanged()V
    ...
    iget-wide v5, p0, mLastAppIdleParoledTime:J

    sub-long/2addr v3, v5

    if-nez v0, :cond_2

    iget-wide v5, p0, mAppIdleParoleIntervalMillis:J
...
.method postOneTimeCheckIdleStates()V
    ...
    iput-boolean v0, p0, mPendingOneTimeCheckIdleStates:Z
...
.method reportContentProviderUsage(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    iget-boolean v0, v9, mAppIdleEnabled:Z
    ...
    iget-object v0, v9, mInjector:Lcom/android/server/usage/AppStandbyController$Injector;
    ...
    iget-object v15, v9, mAppIdleLock:Ljava/lang/Object;
    ...
    :try_start_1
    iget-object v10, v9, mAppIdleHistory:Lcom/android/server/usage/AppIdleHistory;
    ...
    iget-wide v11, v9, mSyncAdapterTimeoutMillis:J
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
...
.method reportEvent(Landroid/app/usage/UsageEvents$Event;JI)V
    ...
    :cond_0
    iget-object v5, v9, mAppIdleLock:Ljava/lang/Object;
    ...
    invoke-direct {v9, v11}, usageEventToSubReason(I)I
    ...
    iget-wide v14, v9, mSystemInteractionTimeoutMillis:J
    ...
    iget-wide v2, v9, mSystemInteractionTimeoutMillis:J
    ...
    iget-wide v14, v9, mInitialForegroundServiceStartTimeoutMillis:J
    ...
    iget-wide v2, v9, mInitialForegroundServiceStartTimeoutMillis:J
    ...
    iget-wide v14, v9, mStrongUsageTimeoutMillis:J
    ...
    iget-wide v11, v9, mStrongUsageTimeoutMillis:J
    ...
    :goto_1
    iget-object v11, v9, mAppIdleHistory:Lcom/android/server/usage/AppIdleHistory;
    ...
    iget-wide v13, v9, mNotificationSeenTimeoutMillis:J
    ...
    iget-wide v11, v9, mNotificationSeenTimeoutMillis:J

    :goto_2
    iget-object v13, v9, mHandler:Lcom/android/server/usage/AppStandbyController$AppStandbyHandler;

    iget-object v14, v9, mHandler:Lcom/android/server/usage/AppStandbyController$AppStandbyHandler;
    ...
    invoke-direct {v9, v1, v13, v2}, notifyBatteryStats(Ljava/lang/String;IZ)V
...
.method reportExemptedSyncScheduled(Ljava/lang/String;I)V
    ...
    iget-wide v2, v9, mExemptedSyncScheduledNonDozeTimeoutMillis:J
    ...
    iget-wide v2, v9, mExemptedSyncScheduledDozeTimeoutMillis:J
...
.method reportExemptedSyncStart(Ljava/lang/String;I)V
    ...
    iget-object v11, p0, mAppIdleLock:Ljava/lang/Object;
    ...
    iget-wide v1, p0, mExemptedSyncStartTimeoutMillis:J
...
.method reportUnexemptedSyncScheduled(Ljava/lang/String;I)V
    ...
    iget-object v12, v9, mAppIdleLock:Ljava/lang/Object;
    ...
    iget-object v13, v9, mAppIdleHistory:Lcom/android/server/usage/AppIdleHistory;
    ...
    iget-wide v1, v9, mUnexemptedSyncScheduledTimeoutMillis:J
...
.method setAppIdleEnabled(Z)V
    ...
    iput-boolean p1, p0, mAppIdleEnabled:Z
...
.method setAppIdleParoled(Z)V
    ...
    iget-boolean v3, p0, mAppIdleTempParoled:Z

    if-eq v3, p1, :cond_2

    iput-boolean p1, p0, mAppIdleTempParoled:Z
    ...
    iget-boolean v5, p0, mAppIdleTempParoled:Z
    ...
    :cond_1
    iput-wide v1, p0, mLastAppIdleParoledTime:J

    const/4 v3, 0x0

    invoke-direct {p0, v1, v2, v3}, postNextParoleTimeout(JZ)V
...
.method setAppStandbyBucket(Ljava/lang/String;IIIJ)V
    ...
    invoke-virtual/range {v0 .. v7}, setAppStandbyBucket(Ljava/lang/String;IIIJZ)V
...
.method setAppStandbyBucket(Ljava/lang/String;IIIJZ)V
    ...
    iget-object v14, v9, mAppIdleLock:Ljava/lang/Object;
    ...
    iget-object v5, v9, mAppIdleHistory:Lcom/android/server/usage/AppIdleHistory;
...
.method setChargingState(Z)V
    ...
    iget-wide v4, p0, mStableChargingThresholdMillis:J
    ...
    iget-wide v3, p0, mStableChargingThresholdMillis:J
    ...
    invoke-virtual {p0}, updateChargingStableState()V
...
.method updateChargingStableState()V
    ...
    :try_start_0
    iget-boolean v1, p0, mChargingStable:Z
    ...
    iput-boolean v1, p0, mChargingStable:Z
