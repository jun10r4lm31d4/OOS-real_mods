...
.method static constructor <clinit>()V
    ...
    sput-object v0, INTERVAL_LENGTH:[J
    ...
    sput-object v0, sEventStatsCombiner:Lcom/android/server/usage/UsageStatsDatabase$StatCombiner;
...
.method private dumpFileDetails(Lcom/android/internal/util/IndentingPrintWriter;Lcom/android/server/usage/IntervalStats;J)V
    ...
    invoke-virtual/range {v1 .. v6}, printIntervalStats(Lcom/android/internal/util/IndentingPrintWriter;Lcom/android/server/usage/IntervalStats;ZZLjava/lang/String;)V
...
.method private dumpFileDetailsForInterval(Lcom/android/internal/util/IndentingPrintWriter;I)V
    ...
    invoke-direct {p0, p1, v5, v3, v4}, dumpFileDetails(Lcom/android/internal/util/IndentingPrintWriter;Lcom/android/server/usage/IntervalStats;J)V
...
.method static formatDateTime(JZ)Ljava/lang/String;
    ...
    sget-object v2, sDateFormat:Ljava/text/SimpleDateFormat;
...
.method private loadActiveStats(J)V
    ...
    sget-object v7, INTERVAL_LENGTH:[J
    ...
    invoke-direct {p0}, updateRolloverDeadline()V
...
.method private queryStats(IJJLcom/android/server/usage/UsageStatsDatabase$StatCombiner;)Ljava/util/List;
    ...
    iget-object v1, v0, mDatabase:Lcom/android/server/usage/UsageStatsDatabase;
    ...
    iget-object v3, v0, mLogPrefix:Ljava/lang/String;
    ...
    iget-object v4, v0, mLogPrefix:Ljava/lang/String;
    ...
    iget-object v5, v0, mLogPrefix:Ljava/lang/String;
...
.method private rolloverStats(J)V
    ...
    iget-object v3, v0, mCurrentStats:[Lcom/android/server/usage/IntervalStats;
    ...
    iget-object v9, v0, mCurrentStats:[Lcom/android/server/usage/IntervalStats;
    ...
    iget-object v12, v0, mDailyExpiryDate:Lcom/android/server/usage/UnixCalendar;
    ...
    invoke-direct/range {p0 .. p2}, loadActiveStats(J)V
    ...
    iget-object v13, v0, mCurrentStats:[Lcom/android/server/usage/IntervalStats;
    ...
    iget-object v11, v0, mLogPrefix:Ljava/lang/String;
...
.method private updateRolloverDeadline()V
    ...
    iget-object v0, p0, mDailyExpiryDate:Lcom/android/server/usage/UnixCalendar;
    ...
    iget-object v1, p0, mLogPrefix:Ljava/lang/String;
    ...
    sget-object v1, sDateFormat:Ljava/text/SimpleDateFormat;

    iget-object v2, p0, mDailyExpiryDate:Lcom/android/server/usage/UnixCalendar;
...
.method dump(Lcom/android/internal/util/IndentingPrintWriter;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, p2, v0}, dump(Lcom/android/internal/util/IndentingPrintWriter;Ljava/lang/String;Z)V
...
.method dump(Lcom/android/internal/util/IndentingPrintWriter;Ljava/lang/String;Z)V
    ...
    invoke-virtual {p0, p1, v0, p2}, printLast24HrEvents(Lcom/android/internal/util/IndentingPrintWriter;ZLjava/lang/String;)V
    ...
    invoke-virtual/range {v2 .. v7}, printIntervalStats(Lcom/android/internal/util/IndentingPrintWriter;Lcom/android/server/usage/IntervalStats;ZZLjava/lang/String;)V
...
.method dumpFile(Lcom/android/internal/util/IndentingPrintWriter;[Ljava/lang/String;)V
    ...
    invoke-static {v1}, stringToInterval(Ljava/lang/String;)I
    ...
    invoke-direct {p0, p1, v0}, dumpFileDetailsForInterval(Lcom/android/internal/util/IndentingPrintWriter;I)V
    ...
    invoke-direct {p0, p1, v1, v5, v6}, dumpFileDetails(Lcom/android/internal/util/IndentingPrintWriter;Lcom/android/server/usage/IntervalStats;J)V
    ...
    invoke-static {v1}, intervalToString(I)Ljava/lang/String;
    ...
    invoke-direct {p0, p1, v1}, dumpFileDetailsForInterval(Lcom/android/internal/util/IndentingPrintWriter;I)V
...
.method init(J)V
    ...
    :cond_2
    invoke-direct {p0, p1, p2}, loadActiveStats(J)V
    ...
    invoke-direct {p0}, notifyNewUpdate()V
...
.method onTimeChanged(JJ)V
    ...
    invoke-direct {p0, p3, p4}, loadActiveStats(J)V
...
.method persistActiveStats()V
    ...
    iget-object v3, p0, mDatabase:Lcom/android/server/usage/UsageStatsDatabase;
...
.method printEvent(Lcom/android/internal/util/IndentingPrintWriter;Landroid/app/usage/UsageEvents$Event;Z)V
    ...
    invoke-static {v0, v1, p3}, formatDateTime(JZ)Ljava/lang/String;
    ...
    invoke-static {v0}, eventToString(I)Ljava/lang/String;
...
.method printEventAggregation(Lcom/android/internal/util/IndentingPrintWriter;Ljava/lang/String;Lcom/android/server/usage/IntervalStats$EventTracker;Z)V
    ...
    invoke-direct {p0, v3, v4, p4}, formatElapsedTime(JZ)Ljava/lang/String;
    ...
    invoke-static {v0, v1, p4}, formatDateTime(JZ)Ljava/lang/String;
...
.method printIntervalStats(Lcom/android/internal/util/IndentingPrintWriter;Lcom/android/server/usage/IntervalStats;ZZLjava/lang/String;)V
    ...
    invoke-direct {v0, v10, v11, v3}, formatElapsedTime(JZ)Ljava/lang/String;
    ...
    invoke-static {v10, v11, v3}, formatDateTime(JZ)Ljava/lang/String;
    ...
    invoke-direct {v0, v9, v10, v3}, formatElapsedTime(JZ)Ljava/lang/String;
    ...
    invoke-static {v9, v10, v3}, formatDateTime(JZ)Ljava/lang/String;
    ...
    invoke-virtual {v0, v1, v8, v7, v3}, printEventAggregation(Lcom/android/internal/util/IndentingPrintWriter;Ljava/lang/String;Lcom/android/server/usage/IntervalStats$EventTracker;Z)V
    ...
    :cond_c
    invoke-virtual {v0, v1, v8, v3}, printEvent(Lcom/android/internal/util/IndentingPrintWriter;Landroid/app/usage/UsageEvents$Event;Z)V
...
.method printLast24HrEvents(Lcom/android/internal/util/IndentingPrintWriter;ZLjava/lang/String;)V
    ...
    invoke-virtual {v7, v8, v1, v9}, printEvent(Lcom/android/internal/util/IndentingPrintWriter;Landroid/app/usage/UsageEvents$Event;Z)V
...
.method queryEventStats(IJJ)Ljava/util/List;
    ...
    sget-object v6, sEventStatsCombiner:Lcom/android/server/usage/UsageStatsDatabase$StatCombiner;
...
.method queryEvents(JJZ)Landroid/app/usage/UsageEvents;
    ...
    invoke-direct/range {v1 .. v7}, queryStats(IJJLcom/android/server/usage/UsageStatsDatabase$StatCombiner;)Ljava/util/List;
...
.method reportEvent(Landroid/app/usage/UsageEvents$Event;)V
    ...
    invoke-static {v3}, eventToString(I)Ljava/lang/String;
    ...
    iget-object v4, v0, mDailyExpiryDate:Lcom/android/server/usage/UnixCalendar;
    ...
    invoke-direct {v0, v2, v3}, rolloverStats(J)V
    ...
    iget-object v8, v0, mLastBackgroundedPackage:Ljava/lang/String;
    ...
    iput-object v7, v0, mLastBackgroundedPackage:Ljava/lang/String;

    :cond_5
    :goto_0
    iget-object v7, v0, mCurrentStats:[Lcom/android/server/usage/IntervalStats;
