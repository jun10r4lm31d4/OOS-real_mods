...
.method static constructor <clinit>()V
    ...
    sput-object v0, MAX_FILES_PER_INTERVAL_TYPE:[I
    ...
    sput v0, SELECTION_LOG_RETENTION_LEN:I
...
.method public constructor <init>(Ljava/io/File;)V
    ...
    invoke-direct {p0, p1, v0}, <init>(Ljava/io/File;I)V
...
.method public constructor <init>(Ljava/io/File;I)V
    ...
    iput-object v0, p0, mBackupsDir:Ljava/io/File;
    ...
    iput-object v0, p0, mUpdateBreadcrumb:Ljava/io/File;
...
.method private checkVersionAndBuildLocked()V
    ...
    iput-boolean v2, p0, mFirstUpdate:Z

    iput-boolean v2, p0, mNewUpdate:Z
    ...
    iget-object v5, p0, mVersionFile:Ljava/io/File;
    ...
    iput-boolean v6, p0, mFirstUpdate:Z
    ...
    iput-boolean v6, p0, mNewUpdate:Z
    :try_end_1
    ...
    iget-object v3, p0, mUpdateBreadcrumb:Ljava/io/File;
    ...
    iget-object v7, p0, mUpdateBreadcrumb:Ljava/io/File;
    ...
    invoke-direct {p0, v8, v6, v7}, continueUpgradeLocked(IJ)V
    :try_end_7
    ...
    :try_start_a
    invoke-static {v6, v3}, $closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    ...
    iget-boolean v3, p0, mNewUpdate:Z
    ...
    iget-object v7, p0, mVersionFile:Ljava/io/File;
    ...
    :cond_6
    iget-object v0, p0, mUpdateBreadcrumb:Ljava/io/File;
    ...
    :cond_7
    iget-object v0, p0, mBackupsDir:Ljava/io/File;
    ...
    invoke-static {v0}, deleteDirectory(Ljava/io/File;)V
...
.method private continueUpgradeLocked(IJ)V
    ...
    iget-object v1, p0, mBackupsDir:Ljava/io/File;
    ...
    :goto_0
    iget-object v2, p0, mIntervalDirs:[Ljava/io/File;
    ...
    invoke-static {v7, v5, p1}, readLocked(Landroid/util/AtomicFile;Lcom/android/server/usage/IntervalStats;I)V
    ...
    iget v8, p0, mCurrentVersion:I

    invoke-static {v7, v5, v8}, writeLocked(Landroid/util/AtomicFile;Lcom/android/server/usage/IntervalStats;I)V
    :try_end_0
...
.method private static deleteDirectory(Ljava/io/File;)V
    ...
    :cond_0
    invoke-static {v3}, deleteDirectory(Ljava/io/File;)V
...
.method private deserializeIntervalStats([BI)Lcom/android/server/usage/IntervalStats;
    ...
    invoke-static {v1, v2, p2}, readLocked(Ljava/io/InputStream;Lcom/android/server/usage/IntervalStats;I)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private doUpgradeLocked(I)V
    ...
    :goto_0
    iget-object v3, v1, mIntervalDirs:[Ljava/io/File;
    ...
    iget-object v8, v1, mBackupsDir:Ljava/io/File;
    ...
    :try_start_0
    iget-object v8, v1, mVersionFile:Ljava/io/File;
    ...
    iget-object v10, v1, mVersionFile:Ljava/io/File;
    ...
    :goto_2
    iget-object v9, v1, mIntervalDirs:[Ljava/io/File;
    ...
    iget-object v11, v1, mIntervalDirs:[Ljava/io/File;
    ...
    iget-object v10, v1, mUpdateBreadcrumb:Ljava/io/File;
...
.method private indexFilesLocked()V
    ...
    :goto_0
    iget-object v2, p0, mSortedStatFiles:[Landroid/app/usage/TimeSparseArray;
    ...
    invoke-static {v8}, parseBeginTime(Landroid/util/AtomicFile;)J
    ...
    sget-object v7, MAX_FILES_PER_INTERVAL_TYPE:[I
...
.method private pruneChooserCountsOlderThan(Ljava/io/File;J)V
    ...
    :try_start_0
    invoke-static {v3}, parseBeginTime(Ljava/io/File;)J
    ...
    invoke-direct {p0, v6, v7}, readLocked(Landroid/util/AtomicFile;Lcom/android/server/usage/IntervalStats;)V
    ...
    :cond_1
    invoke-direct {p0, v6, v7}, writeLocked(Landroid/util/AtomicFile;Lcom/android/server/usage/IntervalStats;)V
    :try_end_1
...
.method private readLocked(Landroid/util/AtomicFile;Lcom/android/server/usage/IntervalStats;)V
    ...
    iget v0, p0, mCurrentVersion:I

    invoke-static {p1, p2, v0}, readLocked(Landroid/util/AtomicFile;Lcom/android/server/usage/IntervalStats;I)V
...
.method private static readLocked(Landroid/util/AtomicFile;Lcom/android/server/usage/IntervalStats;I)V
    ...
    invoke-static {v0, p1, p2}, readLocked(Ljava/io/InputStream;Lcom/android/server/usage/IntervalStats;I)V
...
.method private readLocked(Ljava/io/InputStream;Lcom/android/server/usage/IntervalStats;)V
    ...
    invoke-static {p1, p2, v0}, readLocked(Ljava/io/InputStream;Lcom/android/server/usage/IntervalStats;I)V
...
.method private serializeIntervalStats(Lcom/android/server/usage/IntervalStats;I)[B
    ...
    invoke-static {v1, p1, p2}, writeLocked(Ljava/io/OutputStream;Lcom/android/server/usage/IntervalStats;I)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method private writeIntervalStatsToStream(Ljava/io/DataOutputStream;Landroid/util/AtomicFile;I)V
    ...
    :try_start_0
    invoke-direct {p0, p2, v0}, readLocked(Landroid/util/AtomicFile;Lcom/android/server/usage/IntervalStats;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0

    nop

    invoke-static {v0}, sanitizeIntervalStatsForBackup(Lcom/android/server/usage/IntervalStats;)V

    invoke-direct {p0, v0, p3}, serializeIntervalStats(Lcom/android/server/usage/IntervalStats;I)[B
...
.method private writeLocked(Landroid/util/AtomicFile;Lcom/android/server/usage/IntervalStats;)V
    ...
    invoke-static {p1, p2, v0}, writeLocked(Landroid/util/AtomicFile;Lcom/android/server/usage/IntervalStats;I)V
...
.method private static writeLocked(Landroid/util/AtomicFile;Lcom/android/server/usage/IntervalStats;I)V
    ...
    :try_start_0
    invoke-static {v0, p1, p2}, writeLocked(Ljava/io/OutputStream;Lcom/android/server/usage/IntervalStats;I)V
...
.method private writeLocked(Ljava/io/OutputStream;Lcom/android/server/usage/IntervalStats;)V
    ...
    invoke-static {p1, p2, v0}, writeLocked(Ljava/io/OutputStream;Lcom/android/server/usage/IntervalStats;I)V
...
.method public applyRestoredPayload(Ljava/lang/String;[B)V
    ...
    invoke-virtual {v1, v0}, getLatestUsageStats(I)Lcom/android/server/usage/IntervalStats;
    ...
    invoke-virtual {v1, v5}, getLatestUsageStats(I)Lcom/android/server/usage/IntervalStats;
    ...
    invoke-virtual {v1, v7}, getLatestUsageStats(I)Lcom/android/server/usage/IntervalStats;
    ...
    invoke-virtual {v1, v9}, getLatestUsageStats(I)Lcom/android/server/usage/IntervalStats;
    ...
    :goto_0
    iget-object v15, v1, mIntervalDirs:[Ljava/io/File;
    ...
    invoke-static {v15}, deleteDirectoryContents(Ljava/io/File;)V
    ...
    invoke-static {v11}, getIntervalStatsBytes(Ljava/io/DataInputStream;)[B

    move-result-object v9

    invoke-direct {v1, v9, v12}, deserializeIntervalStats([BI)Lcom/android/server/usage/IntervalStats;

    move-result-object v9

    invoke-direct {v1, v9, v4}, mergeStats(Lcom/android/server/usage/IntervalStats;Lcom/android/server/usage/IntervalStats;)Lcom/android/server/usage/IntervalStats;

    move-result-object v16

    move-object/from16 v9, v16

    invoke-virtual {v1, v0, v9}, putUsageStats(ILcom/android/server/usage/IntervalStats;)V
    ...
    invoke-direct {v1, v14, v12}, deserializeIntervalStats([BI)Lcom/android/server/usage/IntervalStats;

    move-result-object v14

    invoke-direct {v1, v14, v6}, mergeStats(Lcom/android/server/usage/IntervalStats;Lcom/android/server/usage/IntervalStats;)Lcom/android/server/usage/IntervalStats;

    move-result-object v15

    move-object v14, v15

    invoke-virtual {v1, v5, v14}, putUsageStats(ILcom/android/server/usage/IntervalStats;)V
    ...
    invoke-direct {v1, v9, v8}, mergeStats(Lcom/android/server/usage/IntervalStats;Lcom/android/server/usage/IntervalStats;)Lcom/android/server/usage/IntervalStats;

    move-result-object v14

    move-object v9, v14

    invoke-virtual {v1, v7, v9}, putUsageStats(ILcom/android/server/usage/IntervalStats;)V
    ...
    invoke-direct {v1, v7, v12}, deserializeIntervalStats([BI)Lcom/android/server/usage/IntervalStats;

    move-result-object v7

    invoke-direct {v1, v7, v10}, mergeStats(Lcom/android/server/usage/IntervalStats;Lcom/android/server/usage/IntervalStats;)Lcom/android/server/usage/IntervalStats;
    ...
    invoke-virtual {v1, v9, v7}, putUsageStats(ILcom/android/server/usage/IntervalStats;)V
...
.method public checkinDailyFiles(Lcom/android/server/usage/UsageStatsDatabase$CheckinAction;)Z
    ...
    invoke-direct {p0, v9, v6}, readLocked(Landroid/util/AtomicFile;Lcom/android/server/usage/IntervalStats;)V
...
.method public dump(Lcom/android/internal/util/IndentingPrintWriter;Z)V
    ...
    :goto_0
    iget-object v3, p0, mSortedStatFiles:[Landroid/app/usage/TimeSparseArray;
...
.method public findBestFitBucket(JJ)I
    ...
    :try_start_0
    iget-object v4, p0, mSortedStatFiles:[Landroid/app/usage/TimeSparseArray;
    ...
    iget-object v5, p0, mSortedStatFiles:[Landroid/app/usage/TimeSparseArray;
    ...
    iget-object v7, p0, mSortedStatFiles:[Landroid/app/usage/TimeSparseArray;
...
.method getBackupPayload(Ljava/lang/String;)[B
    ...
    invoke-virtual {p0, p1, v0}, getBackupPayload(Ljava/lang/String;I)[B
...
.method public getBackupPayload(Ljava/lang/String;I)[B
    ...
    invoke-virtual {p0, v2, v3}, prune(J)V
    ...
    invoke-direct {p0, v2, v5, p2}, writeIntervalStatsToStream(Ljava/io/DataOutputStream;Landroid/util/AtomicFile;I)V
    ...
    invoke-direct {p0, v2, v6, p2}, writeIntervalStatsToStream(Ljava/io/DataOutputStream;Landroid/util/AtomicFile;I)V
    ...
    invoke-direct {p0, v2, v4, p2}, writeIntervalStatsToStream(Ljava/io/DataOutputStream;Landroid/util/AtomicFile;I)V
...
.method public getLatestUsageStats(I)Lcom/android/server/usage/IntervalStats;
    ...
    invoke-direct {p0, v3, v4}, readLocked(Landroid/util/AtomicFile;Lcom/android/server/usage/IntervalStats;)V
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public onTimeChanged(J)V
    ...
    iget-object v7, v1, mSortedStatFiles:[Landroid/app/usage/TimeSparseArray;
...
.method public prune(J)V
    ...
    :try_start_0
    iget-object v1, p0, mCal:Lcom/android/server/usage/UnixCalendar;
    ...
    invoke-static {v1, v2, v3}, pruneFilesOlderThan(Ljava/io/File;J)V
    ...
    iget-object v3, p0, mCal:Lcom/android/server/usage/UnixCalendar;

    invoke-virtual {v3}, Lcom/android/server/usage/UnixCalendar;->getTimeInMillis()J

    move-result-wide v3

    invoke-static {v1, v3, v4}, pruneFilesOlderThan(Ljava/io/File;J)V
    ...
    sget v3, SELECTION_LOG_RETENTION_LEN:I
    ...
    invoke-direct {p0, v2, v3, v4}, pruneChooserCountsOlderThan(Ljava/io/File;J)V
...
.method public putUsageStats(ILcom/android/server/usage/IntervalStats;)V
    ...
    iget-object v4, p0, mIntervalDirs:[Ljava/io/File;
    ...
    :cond_1
    invoke-direct {p0, v1, p2}, writeLocked(Landroid/util/AtomicFile;Lcom/android/server/usage/IntervalStats;)V
...
.method public queryUsageStats(IJJLcom/android/server/usage/UsageStatsDatabase$StatCombiner;)Ljava/util/List;
    ...
    :try_start_0
    iget-object v0, v1, mIntervalDirs:[Ljava/io/File;

    array-length v0, v0

    if-ge v2, v0, :cond_b

    iget-object v0, v1, mSortedStatFiles:[Landroid/app/usage/TimeSparseArray;
    ...
    :cond_8
    :try_start_1
    invoke-direct {v1, v14, v11}, readLocked(Landroid/util/AtomicFile;Lcom/android/server/usage/IntervalStats;)V
...
.method readIntervalStatsForFile(IJ)Lcom/android/server/usage/IntervalStats;
    ...
    invoke-direct {p0, v3, v1}, readLocked(Landroid/util/AtomicFile;Lcom/android/server/usage/IntervalStats;)V
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
