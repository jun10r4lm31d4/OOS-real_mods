...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, ENABLE_TIME_CHANGE_CORRECTION:Z
    ...
    sput-object v0, KERNEL_COUNTER_FILE:Ljava/io/File;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mUidToKernelCounter:Landroid/util/SparseIntArray;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, mUsageReporters:Landroid/util/SparseArray;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, mVisibleActivities:Landroid/util/SparseArray;
    ...
    iput-object v0, p0, mStandbyChangeListener:Landroid/app/usage/UsageStatsManagerInternal$AppIdleStateChangeListener;
...
.method static synthetic access$1000(Lcom/android/server/usage/UsageStatsService;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, p1, p2}, buildFullToken(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method static synthetic access$1200(Lcom/android/server/usage/UsageStatsService;)V
    ...
    invoke-direct {p0}, readUsageSourceSetting()V
...
.method static synthetic access$1400(Lcom/android/server/usage/UsageStatsService;IJ)Lcom/android/server/usage/UserUsageStatsService;
    ...
    invoke-direct {p0, p1, p2, p3}, getUserDataAndInitializeIfNeededLocked(IJ)Lcom/android/server/usage/UserUsageStatsService;
...
.method static synthetic access$600(Lcom/android/server/usage/UsageStatsService;)Landroid/util/SparseIntArray;
    ...
    iget-object v0, p0, mUidToKernelCounter:Landroid/util/SparseIntArray;
...
.method static synthetic access$700()Ljava/io/File;
    ...
    sget-object v0, KERNEL_COUNTER_FILE:Ljava/io/File;
...
.method static synthetic access$800(Lcom/android/server/usage/UsageStatsService;)Landroid/app/admin/DevicePolicyManagerInternal;
    ...
    invoke-direct {p0}, getDpmInternal()Landroid/app/admin/DevicePolicyManagerInternal;
...
.method static synthetic access$900(Lcom/android/server/usage/UsageStatsService;II)Z
    ...
    invoke-direct {p0, p1, p2}, shouldObfuscateInstantAppsForCaller(II)Z
...
.method private checkAndGetTimeLocked()J
    ...
    iget-wide v6, p0, mSystemTimeSnapshot:J
    ...
    sget-boolean v8, ENABLE_TIME_CHANGE_CORRECTION:Z
...
.method private cleanUpRemovedUsersLocked()V
    ...
    invoke-static {v6}, deleteRecursively(Ljava/io/File;)V
...
.method private convertToSystemTimeLocked(Landroid/app/usage/UsageEvents$Event;)V
    ...
    iget-wide v2, p0, mRealTimeSnapshot:J
...
.method private static deleteRecursively(Ljava/io/File;)V
    ...
    invoke-static {v3}, deleteRecursively(Ljava/io/File;)V
...
.method private flushToDiskLocked()V
    ...
    iget-object v2, p0, mUserState:Landroid/util/SparseArray;
    ...
    iget-object v3, p0, mAppStandby:Lcom/android/server/usage/AppStandbyController;

    iget-object v4, p0, mUserState:Landroid/util/SparseArray;
    ...
    :cond_0
    iget-object v1, p0, mAppStandby:Lcom/android/server/usage/AppStandbyController;
...
.method private getDpmInternal()Landroid/app/admin/DevicePolicyManagerInternal;
    ...
    iget-object v0, p0, mDpmInternal:Landroid/app/admin/DevicePolicyManagerInternal;
    ...
    iput-object v0, p0, mDpmInternal:Landroid/app/admin/DevicePolicyManagerInternal;
...
.method private getUserDataAndInitializeIfNeededLocked(IJ)Lcom/android/server/usage/UserUsageStatsService;
    ...
    iget-object v4, p0, mUsageStatsDir:Ljava/io/File;
...
.method dump([Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    iget-object v5, p0, mAppStandby:Lcom/android/server/usage/AppStandbyController;
    ...
    iget-object v8, p0, mAppTimeLimit:Lcom/android/server/usage/AppTimeLimitController;
    ...
    iget-object v12, p0, mUserState:Landroid/util/SparseArray;
    ...
    iget-object v11, p0, mUserState:Landroid/util/SparseArray;
    ...
    :goto_9
    iget-object v9, p0, mAppStandby:Lcom/android/server/usage/AppStandbyController;
    ...
    iget-object v7, p0, mAppStandby:Lcom/android/server/usage/AppStandbyController;
    ...
    iget-object v7, p0, mAppTimeLimit:Lcom/android/server/usage/AppTimeLimitController;
...
.method flushToDisk()V
    ...
    invoke-virtual {p0, v1}, reportEventToAllUserId(Landroid/app/usage/UsageEvents$Event;)V
...
.method public onBootPhase(I)V
    ...
    iget-object v0, p0, mAppStandby:Lcom/android/server/usage/AppStandbyController;
    ...
    iput-object v0, p0, mDeviceIdleController:Landroid/os/IDeviceIdleController;
    ...
    sget-object v1, KERNEL_COUNTER_FILE:Ljava/io/File;
...
.method public onStart()V
    ...
    iput-object v0, p0, mAppStandby:Lcom/android/server/usage/AppStandbyController;
    ...
    iput-object v0, p0, mAppTimeLimit:Lcom/android/server/usage/AppTimeLimitController;

    iget-object v0, p0, mAppStandby:Lcom/android/server/usage/AppStandbyController;

    iget-object v1, p0, mStandbyChangeListener:Landroid/app/usage/UsageStatsManagerInternal$AppIdleStateChangeListener;
    ...
    iput-wide v3, p0, mRealTimeSnapshot:J

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v3

    iput-wide v3, p0, mSystemTimeSnapshot:J
    ...
    iget-wide v3, p0, mSystemTimeSnapshot:J

    invoke-direct {p0, v2, v3, v4}, getUserDataAndInitializeIfNeededLocked(IJ)Lcom/android/server/usage/UserUsageStatsService;
...
.method onUserRemoved(I)V
    ...
    iget-object v1, p0, mAppTimeLimit:Lcom/android/server/usage/AppTimeLimitController;
...
.method queryConfigurationStats(IIJJ)Ljava/util/List;
    ...
    invoke-static/range {v3 .. v8}, validRange(JJJ)Z
    ...
    invoke-direct {p0, p1, v1, v2}, getUserDataAndInitializeIfNeededLocked(IJ)Lcom/android/server/usage/UserUsageStatsService;
...
.method queryEventsForPackage(IJJLjava/lang/String;Z)Landroid/app/usage/UsageEvents;
    ...
    invoke-static/range {v5 .. v10}, validRange(JJJ)Z
    ...
    :try_start_1
    invoke-direct {p0, p1, v3, v4}, getUserDataAndInitializeIfNeededLocked(IJ)Lcom/android/server/usage/UserUsageStatsService;
...
.method queryUsageStats(IIJJZ)Ljava/util/List;
    ...
    invoke-static/range {v6 .. v11}, validRange(JJJ)Z
    ...
    invoke-direct {p0, p1, v4, v5}, getUserDataAndInitializeIfNeededLocked(IJ)Lcom/android/server/usage/UserUsageStatsService;
    ...
    iget-object v9, v1, mPackageManagerInternal:Landroid/content/pm/PackageManagerInternal;
...
.method registerAppUsageLimitObserver(II[Ljava/lang/String;JJLandroid/app/PendingIntent;I)V
    ...
    iget-object v1, v0, mAppTimeLimit:Lcom/android/server/usage/AppTimeLimitController;
...
.method registerAppUsageObserver(II[Ljava/lang/String;JLandroid/app/PendingIntent;I)V
    ...
    iget-object v0, p0, mAppTimeLimit:Lcom/android/server/usage/AppTimeLimitController;
...
.method reportEvent(Landroid/app/usage/UsageEvents$Event;I)V
    ...
    iget-object v0, v1, mPackageManagerInternal:Landroid/content/pm/PackageManagerInternal;
    ...
    :cond_2
    iget-object v0, v1, mVisibleActivities:Landroid/util/SparseArray;
    ...
    :cond_3
    iget-object v11, v1, mUsageReporters:Landroid/util/SparseArray;
    ...
    :try_start_1
    iget-object v0, v1, mUsageReporters:Landroid/util/SparseArray;
    ...
    :try_start_4
    iget-object v0, v1, mAppTimeLimit:Lcom/android/server/usage/AppTimeLimitController;

    iget-object v15, v2, Landroid/app/usage/UsageEvents$Event;->mPackage:Ljava/lang/String;

    invoke-direct {v1, v15, v14}, buildFullToken(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v1, v3, v5, v6}, getUserDataAndInitializeIfNeededLocked(IJ)Lcom/android/server/usage/UserUsageStatsService;

    move-result-object v0

    invoke-virtual {v0, v2}, Lcom/android/server/usage/UserUsageStatsService;->reportEvent(Landroid/app/usage/UsageEvents$Event;)V

    iget-object v9, v1, mAppStandby:Lcom/android/server/usage/AppStandbyController;
...
.method reportEventToAllUserId(Landroid/app/usage/UsageEvents$Event;)V
    ...
    invoke-virtual {p0, v3, v4}, reportEvent(Landroid/app/usage/UsageEvents$Event;I)V
