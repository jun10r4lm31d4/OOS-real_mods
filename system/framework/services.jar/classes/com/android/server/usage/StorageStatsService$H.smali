...
.method public constructor <init>(Lcom/android/server/usage/StorageStatsService;Landroid/os/Looper;)V
    ...
    iput-object p1, p0, mStats:Landroid/os/StatFs;

    iget-object p1, p0, mStats:Landroid/os/StatFs;

    invoke-virtual {p1}, Landroid/os/StatFs;->getAvailableBytes()J

    move-result-wide v0

    iput-wide v0, p0, mPreviousBytes:J
    ...
    iput-wide v0, p0, mMinimumThresholdBytes:D
...
.method private getInitializedStrategy()Lcom/android/server/storage/CacheQuotaStrategy;
    ...
    iget-object v2, p0, this$0:Lcom/android/server/usage/StorageStatsService;
    ...
    iget-object v3, p0, this$0:Lcom/android/server/usage/StorageStatsService;
    ...
    iget-object v4, p0, this$0:Lcom/android/server/usage/StorageStatsService;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    iget-object v1, p0, this$0:Lcom/android/server/usage/StorageStatsService;
    ...
    :cond_1
    invoke-direct {p0}, getInitializedStrategy()Lcom/android/server/storage/CacheQuotaStrategy;

    move-result-object v1

    const-wide/16 v5, -0x1

    iput-wide v5, p0, mPreviousBytes:J
    ...
    :goto_1
    iget-wide v5, p0, mPreviousBytes:J
    ...
    iget-object v0, p0, mStats:Landroid/os/StatFs;
    ...
    invoke-direct {p0, v1}, recalculateQuotas(Lcom/android/server/storage/CacheQuotaStrategy;)V

    :cond_2
    invoke-virtual {p0, v4, v2, v3}, sendEmptyMessageDelayed(IJ)Z

    goto :goto_2

    :cond_3
    iget-wide v0, p0, mPreviousBytes:J

    iget-object v5, p0, mStats:Landroid/os/StatFs;
    ...
    iget-wide v7, p0, mMinimumThresholdBytes:D
    ...
    invoke-direct {p0, v5}, recalculateQuotas(Lcom/android/server/storage/CacheQuotaStrategy;)V

    iget-object v5, p0, this$0:Lcom/android/server/usage/StorageStatsService;
