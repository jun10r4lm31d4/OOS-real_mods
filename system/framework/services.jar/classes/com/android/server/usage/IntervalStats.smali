...
.method public constructor <init>()V
    ...
    iput v0, p0, majorVersion:I

    iput v0, p0, minorVersion:I
    ...
    iput-object v0, p0, interactiveTracker:Lcom/android/server/usage/IntervalStats$EventTracker;

    new-instance v0, Lcom/android/server/usage/IntervalStats$EventTracker;

    invoke-direct {v0}, Lcom/android/server/usage/IntervalStats$EventTracker;-><init>()V

    iput-object v0, p0, nonInteractiveTracker:Lcom/android/server/usage/IntervalStats$EventTracker;

    new-instance v0, Lcom/android/server/usage/IntervalStats$EventTracker;

    invoke-direct {v0}, Lcom/android/server/usage/IntervalStats$EventTracker;-><init>()V

    iput-object v0, p0, keyguardShownTracker:Lcom/android/server/usage/IntervalStats$EventTracker;

    new-instance v0, Lcom/android/server/usage/IntervalStats$EventTracker;

    invoke-direct {v0}, Lcom/android/server/usage/IntervalStats$EventTracker;-><init>()V

    iput-object v0, p0, keyguardHiddenTracker:Lcom/android/server/usage/IntervalStats$EventTracker;
    ...
    iput-object v0, p0, events:Landroid/app/usage/EventList;
...
.method private getCachedStringRef(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v0, p0, mStringCache:Landroid/util/ArraySet;
...
.method public addEvent(Landroid/app/usage/UsageEvents$Event;)V
    ...
    invoke-direct {p0, v0}, getCachedStringRef(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_3
    iget-object v0, p0, events:Landroid/app/usage/EventList;
...
.method addEventStatsTo(Ljava/util/List;)V
    ...
    iget-object v0, p0, interactiveTracker:Lcom/android/server/usage/IntervalStats$EventTracker;

    iget-wide v3, p0, beginTime:J

    iget-wide v5, p0, endTime:J
    ...
    iget-object v7, p0, nonInteractiveTracker:Lcom/android/server/usage/IntervalStats$EventTracker;

    iget-wide v10, p0, beginTime:J

    iget-wide v12, p0, endTime:J
    ...
    iget-object v0, p0, keyguardShownTracker:Lcom/android/server/usage/IntervalStats$EventTracker;
    ...
    iget-object v7, p0, keyguardHiddenTracker:Lcom/android/server/usage/IntervalStats$EventTracker;
...
.method buildEvent(Landroid/util/proto/ProtoInputStream;Ljava/util/List;)Landroid/app/usage/UsageEvents$Event;
    ...
    invoke-direct {p0, v1}, getCachedStringRef(Ljava/lang/String;)Ljava/lang/String;
...
.method commitTime(J)V
    ...
    iget-object v0, p0, nonInteractiveTracker:Lcom/android/server/usage/IntervalStats$EventTracker;
    ...
    iget-object v0, p0, keyguardHiddenTracker:Lcom/android/server/usage/IntervalStats$EventTracker;
...
.method getOrCreateConfigurationStats(Landroid/content/res/Configuration;)Landroid/app/usage/ConfigurationStats;
    ...
    iget-object v0, p0, configurations:Landroid/util/ArrayMap;
...
.method getOrCreateUsageStats(Ljava/lang/String;)Landroid/app/usage/UsageStats;
    ...
    iget-object v0, p0, packageStats:Landroid/util/ArrayMap;
...
.method public update(Ljava/lang/String;Ljava/lang/String;JII)V
    ...
    iget-object v2, p0, packageStats:Landroid/util/ArrayMap;
...
.method updateConfigurationStats(Landroid/content/res/Configuration;J)V
    ...
    iget-object v0, p0, activeConfiguration:Landroid/content/res/Configuration;
    ...
    iput-object v1, p0, activeConfiguration:Landroid/content/res/Configuration;
