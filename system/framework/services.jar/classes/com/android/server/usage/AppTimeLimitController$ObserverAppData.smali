...
.method private constructor <init>(Lcom/android/server/usage/AppTimeLimitController;I)V
    ...
    iput-object p1, p0, appUsageGroups:Landroid/util/SparseArray;

    new-instance p1, Landroid/util/SparseArray;

    invoke-direct {p1}, Landroid/util/SparseArray;-><init>()V

    iput-object p1, p0, sessionUsageGroups:Landroid/util/SparseArray;

    new-instance p1, Landroid/util/SparseArray;

    invoke-direct {p1}, Landroid/util/SparseArray;-><init>()V

    iput-object p1, p0, appUsageLimitGroups:Landroid/util/SparseArray;
...
.method synthetic constructor <init>(Lcom/android/server/usage/AppTimeLimitController;ILcom/android/server/usage/AppTimeLimitController$1;)V
    ...
    invoke-direct {p0, p1, p2}, <init>(Lcom/android/server/usage/AppTimeLimitController;I)V
...
.method dump(Ljava/io/PrintWriter;)V
    ...
    iget-object v0, p0, appUsageGroups:Landroid/util/SparseArray;
    ...
    iget-object v2, p0, appUsageGroups:Landroid/util/SparseArray;
    ...
    iget-object v1, p0, sessionUsageGroups:Landroid/util/SparseArray;
    ...
    iget-object v3, p0, sessionUsageGroups:Landroid/util/SparseArray;
    ...
    iget-object v2, p0, appUsageLimitGroups:Landroid/util/SparseArray;
    ...
    iget-object v4, p0, appUsageLimitGroups:Landroid/util/SparseArray;
...
.method removeAppUsageLimitGroup(I)V
    ...
    iget-object v0, p0, appUsageLimitGroups:Landroid/util/SparseArray;
...
.method removeSessionUsageGroup(I)V
    ...
    iget-object v0, p0, sessionUsageGroups:Landroid/util/SparseArray;
