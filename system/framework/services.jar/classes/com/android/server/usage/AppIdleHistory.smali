...
.method constructor <init>(Ljava/io/File;J)V
    ...
    iput-wide p2, p0, mElapsedSnapshot:J

    iput-wide p2, p0, mScreenOnSnapshot:J

    iput-object p1, p0, mStorageDir:Ljava/io/File;

    invoke-direct {p0}, readScreenOnTime()V
...
.method private getPackageHistory(Landroid/util/ArrayMap;Ljava/lang/String;JZ)Lcom/android/server/usage/AppIdleHistory$AppUsageHistory;
    ...
    invoke-virtual {p0, v1, v2}, getElapsedTime(J)J
...
.method private getUserHistory(I)Landroid/util/ArrayMap;
    ...
    invoke-direct {p0, p1, v0}, readAppIdleTimes(ILandroid/util/ArrayMap;)V
...
.method private readAppIdleTimes(ILandroid/util/ArrayMap;)V
    ...
    invoke-virtual/range {p0 .. p1}, getUserFile(I)Ljava/io/File;
    ...
    invoke-direct {v1, v7, v0, v9, v10}, getLongValue(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;J)J
...
.method private readScreenOnTime()V
    ...
    invoke-virtual {p0}, getScreenOnTimeFile()Ljava/io/File;
    ...
    iput-wide v2, p0, mScreenOnDuration:J
    ...
    iput-wide v2, p0, mElapsedDuration:J
    ...
    :cond_0
    invoke-direct {p0}, writeScreenOnTime()V
...
.method private writeScreenOnTime()V
    ...
    iget-wide v4, p0, mScreenOnDuration:J
    ...
    iget-wide v4, p0, mElapsedDuration:J
...
.method public clearUsage(Ljava/lang/String;I)V
    ...
    invoke-direct {p0, p2}, getUserHistory(I)Landroid/util/ArrayMap;
...
.method public dump(Lcom/android/internal/util/IndentingPrintWriter;ILjava/lang/String;)V
    ...
    iget-object v4, v0, mIdleHistory:Landroid/util/SparseArray;
    ...
    invoke-virtual {v0, v5, v6}, getElapsedTime(J)J

    move-result-wide v7

    invoke-virtual {v0, v5, v6}, getScreenOnTime(J)J
    ...
    invoke-virtual {v0, v13, v2, v5, v6}, isIdle(Ljava/lang/String;IJ)Z
...
.method public getAppStandbyBucket(Ljava/lang/String;IJ)I
    ...
    invoke-direct/range {v0 .. v5}, getPackageHistory(Landroid/util/ArrayMap;Ljava/lang/String;JZ)Lcom/android/server/usage/AppIdleHistory$AppUsageHistory;
...
.method public getElapsedTime(J)J
    ...
    iget-wide v0, p0, mElapsedSnapshot:J

    sub-long v0, p1, v0

    iget-wide v2, p0, mElapsedDuration:J
...
.method public getScreenOnTime(J)J
    ...
    iget-wide v0, p0, mScreenOnDuration:J

    iget-boolean v2, p0, mScreenOn:Z

    if-eqz v2, :cond_0

    iget-wide v2, p0, mScreenOnSnapshot:J
...
.method getScreenOnTimeFile()Ljava/io/File;
    ...
    iget-object v1, p0, mStorageDir:Ljava/io/File;
...
.method getThresholdIndex(Ljava/lang/String;IJ[J[J)I
    ...
    invoke-direct {v6, v11}, getUserHistory(I)Landroid/util/ArrayMap;
    ...
    :cond_0
    invoke-virtual {v6, v8, v9}, getScreenOnTime(J)J
    ...
    invoke-virtual {v6, v8, v9}, getElapsedTime(J)J
...
.method getUserFile(I)Ljava/io/File;
    ...
    iget-object v3, p0, mStorageDir:Ljava/io/File;
...
.method public reportUsage(Lcom/android/server/usage/AppIdleHistory$AppUsageHistory;Ljava/lang/String;IIJJ)Lcom/android/server/usage/AppIdleHistory$AppUsageHistory;
    ...
    iget-wide v0, p0, mElapsedDuration:J

    iget-wide v2, p0, mElapsedSnapshot:J
    ...
    invoke-virtual {p0, p5, p6}, getScreenOnTime(J)J
...
.method public reportUsage(Ljava/lang/String;IIIJJ)Lcom/android/server/usage/AppIdleHistory$AppUsageHistory;
    ...
    invoke-virtual/range {v0 .. v8}, reportUsage(Lcom/android/server/usage/AppIdleHistory$AppUsageHistory;Ljava/lang/String;IIJJ)Lcom/android/server/usage/AppIdleHistory$AppUsageHistory;
...
.method public setAppStandbyBucket(Ljava/lang/String;IJII)V
    ...
    invoke-virtual/range {v0 .. v7}, setAppStandbyBucket(Ljava/lang/String;IJIIZ)V
...
.method public updateDisplay(ZJ)V
    ...
    iput-wide v0, p0, mScreenOnDuration:J
    ...
    iput-wide v0, p0, mElapsedDuration:J
    ...
    iget-wide v1, p0, mScreenOnSnapshot:J
    ...
    iget-wide v1, p0, mScreenOnDuration:J
...
.method public writeAppIdleDurations()V
    ...
    iget-wide v4, p0, mElapsedSnapshot:J
    ...
    iput-wide v0, p0, mElapsedSnapshot:J
...
.method public writeAppIdleTimes(I)V
    ...
    invoke-direct/range {p0 .. p1}, getUserHistory(I)Landroid/util/ArrayMap;
