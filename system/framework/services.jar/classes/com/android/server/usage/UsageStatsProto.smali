...
.method private static loadChooserCounts(Landroid/util/proto/ProtoInputStream;Landroid/app/usage/UsageStats;)V
    ...
    invoke-static {p0, v3}, loadCountsForAction(Landroid/util/proto/ProtoInputStream;Landroid/util/ArrayMap;)V
...
.method private static loadUsageStats(Landroid/util/proto/ProtoInputStream;JLcom/android/server/usage/IntervalStats;Ljava/util/List;)V
    ...
    invoke-static {p0, v4}, loadChooserCounts(Landroid/util/proto/ProtoInputStream;Landroid/app/usage/UsageStats;)V
...
.method public static read(Ljava/io/InputStream;Lcom/android/server/usage/IntervalStats;)V
    ...
    invoke-static {v0, v2, v3, p1, v1}, loadEvent(Landroid/util/proto/ProtoInputStream;JLcom/android/server/usage/IntervalStats;Ljava/util/List;)V
    ...
    invoke-static {v0, v2, v3, p1}, loadConfigStats(Landroid/util/proto/ProtoInputStream;JLcom/android/server/usage/IntervalStats;)V
    ...
    invoke-static {v0, v2, v3, p1, v1}, loadUsageStats(Landroid/util/proto/ProtoInputStream;JLcom/android/server/usage/IntervalStats;Ljava/util/List;)V
    ...
    invoke-static {v0, v2, v3, v4}, loadCountAndTime(Landroid/util/proto/ProtoInputStream;JLcom/android/server/usage/IntervalStats$EventTracker;)V
    ...
    :cond_2
    invoke-static {v0}, readStringPool(Landroid/util/proto/ProtoInputStream;)Ljava/util/List;
...
.method public static write(Ljava/io/OutputStream;Lcom/android/server/usage/IntervalStats;)V
    ...
    invoke-static {v0, p1}, writeStringPool(Landroid/util/proto/ProtoOutputStream;Lcom/android/server/usage/IntervalStats;)V
    ...
    invoke-static/range {v1 .. v6}, writeCountAndTime(Landroid/util/proto/ProtoOutputStream;JIJ)V
    ...
    invoke-static {v0, v2, v3, p1, v4}, writeUsageStats(Landroid/util/proto/ProtoOutputStream;JLcom/android/server/usage/IntervalStats;Landroid/app/usage/UsageStats;)V
    ...
    invoke-static/range {v1 .. v6}, writeConfigStats(Landroid/util/proto/ProtoOutputStream;JLcom/android/server/usage/IntervalStats;Landroid/app/usage/ConfigurationStats;Z)V
    ...
    invoke-static {v0, v3, v4, p1, v5}, writeEvent(Landroid/util/proto/ProtoOutputStream;JLcom/android/server/usage/IntervalStats;Landroid/app/usage/UsageEvents$Event;)V
...
.method private static writeChooserCounts(Landroid/util/proto/ProtoOutputStream;Landroid/app/usage/UsageStats;)V
    ...
    invoke-static {p0, v3}, writeCountsForAction(Landroid/util/proto/ProtoOutputStream;Landroid/util/ArrayMap;)V
...
.method private static writeUsageStats(Landroid/util/proto/ProtoOutputStream;JLcom/android/server/usage/IntervalStats;Landroid/app/usage/UsageStats;)V
    ...
    invoke-static {p0, p4}, writeChooserCounts(Landroid/util/proto/ProtoOutputStream;Landroid/app/usage/UsageStats;)V
