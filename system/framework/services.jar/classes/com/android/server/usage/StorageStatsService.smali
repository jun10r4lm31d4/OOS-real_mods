...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mUser:Landroid/os/UserManager;
    ...
    iput-object v0, p0, mPackage:Landroid/content/pm/PackageManager;
    ...
    iput-object v0, p0, mCacheQuotas:Landroid/util/ArrayMap;
    ...
    invoke-direct {p0}, invalidateMounts()V
    ...
    iput-object v0, p0, mHandler:Lcom/android/server/usage/StorageStatsService$H;

    iget-object v0, p0, mHandler:Lcom/android/server/usage/StorageStatsService$H;

    const/16 v1, 0x65

    invoke-virtual {v0, v1}, Lcom/android/server/usage/StorageStatsService$H;->sendEmptyMessage(I)Z

    iget-object v0, p0, mStorage:Landroid/os/storage/StorageManager;
...
.method static synthetic access$300(Lcom/android/server/usage/StorageStatsService;)Landroid/util/ArrayMap;
    ...
    iget-object v0, p0, mCacheQuotas:Landroid/util/ArrayMap;
...
.method private static checkEquals(Ljava/lang/String;Landroid/content/pm/PackageStats;Landroid/content/pm/PackageStats;)V
    ...
    invoke-static {v0, v1, v2, v3, v4}, checkEquals(Ljava/lang/String;JJ)V
...
.method private static checkEquals(Ljava/lang/String;[J[J)V
    ...
    invoke-static {v1, v2, v3, v4, v5}, checkEquals(Ljava/lang/String;JJ)V
...
.method private getAppIds(I)[I
    ...
    iget-object v1, p0, mPackage:Landroid/content/pm/PackageManager;
...
.method public getCacheBytes(Ljava/lang/String;Ljava/lang/String;)J
    ...
    invoke-direct {p0, v0, p2}, enforcePermission(ILjava/lang/String;)V

    const-wide/16 v0, 0x0

    iget-object v2, p0, mUser:Landroid/os/UserManager;
    ...
    invoke-virtual {p0, p1, v4, v5}, queryStatsForUser(Ljava/lang/String;ILjava/lang/String;)Landroid/app/usage/StorageStats;
...
.method public getCacheQuotaBytes(Ljava/lang/String;ILjava/lang/String;)J
    ...
    invoke-direct {p0, v0, p3}, enforcePermission(ILjava/lang/String;)V
...
.method public getFreeBytes(Ljava/lang/String;Ljava/lang/String;)J
    ...
    :try_start_0
    iget-object v3, p0, mStorage:Landroid/os/storage/StorageManager;
    ...
    :try_start_1
    invoke-virtual {p0, p1, v0}, isQuotaSupported(Ljava/lang/String;Ljava/lang/String;)Z

    move-result v4

    if-eqz v4, :cond_0

    invoke-virtual {p0, p1, v0}, getCacheBytes(Ljava/lang/String;Ljava/lang/String;)J
...
.method public queryExternalStatsForUser(Ljava/lang/String;ILjava/lang/String;)Landroid/app/usage/ExternalStorageStats;
    ...
    invoke-direct {p0, p2}, getAppIds(I)[I
    ...
    invoke-static {}, getDefaultFlags()I
    ...
    invoke-static {v4, v2, v1}, checkEquals(Ljava/lang/String;[J[J)V
    :try_end_0
    .catch Lcom/android/server/pm/Installer$InstallerException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public queryStatsForPackage(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)Landroid/app/usage/StorageStats;
    ...
    :cond_0
    :try_start_0
    iget-object v0, v1, mPackage:Landroid/content/pm/PackageManager;
    ...
    invoke-direct {v1, v0, v13}, enforcePermission(ILjava/lang/String;)V
    ...
    invoke-virtual {v1, v15, v0, v13}, queryStatsForUid(Ljava/lang/String;ILjava/lang/String;)Landroid/app/usage/StorageStats;
    ...
    invoke-static {v11}, translate(Landroid/content/pm/PackageStats;)Landroid/app/usage/StorageStats;
...
.method public queryStatsForUid(Ljava/lang/String;ILjava/lang/String;)Landroid/app/usage/StorageStats;
    ...
    invoke-direct {v1, v0, v15}, enforcePermission(ILjava/lang/String;)V
    ...
    :try_start_0
    iget-object v3, v1, mPackage:Landroid/content/pm/PackageManager;
    ...
    :try_start_3
    invoke-static {v3, v0, v4}, checkEquals(Ljava/lang/String;Landroid/content/pm/PackageStats;Landroid/content/pm/PackageStats;)V
    :try_end_3
    ...
    invoke-static {v4}, translate(Landroid/content/pm/PackageStats;)Landroid/app/usage/StorageStats;
...
.method public queryStatsForUser(Ljava/lang/String;ILjava/lang/String;)Landroid/app/usage/StorageStats;
    ...
    invoke-static {v2, v1, v8}, checkEquals(Ljava/lang/String;Landroid/content/pm/PackageStats;Landroid/content/pm/PackageStats;)V
    :try_end_0
    .catch Lcom/android/server/pm/Installer$InstallerException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v8}, translate(Landroid/content/pm/PackageStats;)Landroid/app/usage/StorageStats;
