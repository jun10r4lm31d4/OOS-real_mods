...
.method public constructor <init>(Landroid/os/PowerManager;Landroid/os/Handler;Landroid/hardware/SensorManager;Lcom/android/server/AnyMotionDetector$DeviceIdleCallback;F)V
    ...
    iput-object v0, p0, mCurrentGravityVector:Lcom/android/server/AnyMotionDetector$Vector3;

    iput-object v0, p0, mPreviousGravityVector:Lcom/android/server/AnyMotionDetector$Vector3;

    iput-object v0, p0, mCallback:Lcom/android/server/AnyMotionDetector$DeviceIdleCallback;
    ...
    iput-object v0, p0, mWakelockTimeout:Ljava/lang/Runnable;
    ...
    iput-object v1, p0, mAccelSensor:Landroid/hardware/Sensor;

    iput-boolean v3, p0, mMeasurementInProgress:Z

    iput-boolean v3, p0, mMeasurementTimeoutIsActive:Z

    iput-boolean v3, p0, mWakelockTimeoutIsActive:Z

    iput-boolean v3, p0, mSensorRestartIsActive:Z

    iput v3, p0, mState:I

    iput-object p4, p0, mCallback:Lcom/android/server/AnyMotionDetector$DeviceIdleCallback;

    iput p5, p0, mThresholdAngle:F
    ...
    iput-object v1, p0, mRunningStats:Lcom/android/server/AnyMotionDetector$RunningSignalStats;
    ...
    iput v1, p0, mNumSufficientSamples:I
...
.method static synthetic access$1000(Lcom/android/server/AnyMotionDetector;)Z
    ...
    iget-boolean v0, p0, mMeasurementTimeoutIsActive:Z
...
.method static synthetic access$1002(Lcom/android/server/AnyMotionDetector;Z)Z
    ...
    iput-boolean p1, p0, mMeasurementTimeoutIsActive:Z
...
.method static synthetic access$400(Lcom/android/server/AnyMotionDetector;)Ljava/lang/Runnable;
    ...
    iget-object v0, p0, mWakelockTimeout:Ljava/lang/Runnable;
...
.method static synthetic access$600(Lcom/android/server/AnyMotionDetector;)Z
    ...
    iget-boolean v0, p0, mWakelockTimeoutIsActive:Z
...
.method static synthetic access$602(Lcom/android/server/AnyMotionDetector;Z)Z
    ...
    iput-boolean p1, p0, mWakelockTimeoutIsActive:Z
...
.method static synthetic access$800(Lcom/android/server/AnyMotionDetector;)Z
    ...
    iget-boolean v0, p0, mSensorRestartIsActive:Z
...
.method static synthetic access$802(Lcom/android/server/AnyMotionDetector;Z)Z
    ...
    iput-boolean p1, p0, mSensorRestartIsActive:Z
...
.method static synthetic access$900(Lcom/android/server/AnyMotionDetector;)V
    ...
    invoke-direct {p0}, startOrientationMeasurementLocked()V
...
.method private startOrientationMeasurementLocked()V
    ...
    iget-object v0, p0, mAccelSensor:Landroid/hardware/Sensor;
    ...
    iput-boolean v1, p0, mMeasurementTimeoutIsActive:Z
...
.method private stopOrientationMeasurementLocked()I
    ...
    iget-object v3, p0, mListener:Landroid/hardware/SensorEventListener;

    invoke-virtual {v2, v3}, Landroid/hardware/SensorManager;->unregisterListener(Landroid/hardware/SensorEventListener;)V

    iput-boolean v1, p0, mMeasurementInProgress:Z

    iget-object v2, p0, mCurrentGravityVector:Lcom/android/server/AnyMotionDetector$Vector3;

    iput-object v2, p0, mPreviousGravityVector:Lcom/android/server/AnyMotionDetector$Vector3;

    iget-object v2, p0, mRunningStats:Lcom/android/server/AnyMotionDetector$RunningSignalStats;
    ...
    iget-object v3, p0, mWakelockTimeout:Ljava/lang/Runnable;

    invoke-virtual {v2, v3}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    iput-boolean v1, p0, mWakelockTimeoutIsActive:Z
    ...
    iget-object v2, p0, mSensorRestart:Ljava/lang/Runnable;
    ...
    iput-boolean v2, p0, mSensorRestartIsActive:Z
...
.method public getStationaryStatus()I
    ...
    iget-object v0, p0, mPreviousGravityVector:Lcom/android/server/AnyMotionDetector$Vector3;
    ...
    iget-object v4, p0, mPreviousGravityVector:Lcom/android/server/AnyMotionDetector$Vector3;
...
.method public stop()V
    ...
    iput-object v1, p0, mCurrentGravityVector:Lcom/android/server/AnyMotionDetector$Vector3;

    iput-object v1, p0, mPreviousGravityVector:Lcom/android/server/AnyMotionDetector$Vector3;
    ...
    iget-object v2, p0, mWakelockTimeout:Ljava/lang/Runnable;
