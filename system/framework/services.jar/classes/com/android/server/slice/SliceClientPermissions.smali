...
.method static constructor <clinit>()V
    ...
    sput-object v0, NAMESPACE:Ljava/lang/String;
...
.method public constructor <init>(Lcom/android/server/slice/SlicePermissionManager$PkgUser;Lcom/android/server/slice/DirtyTracker;)V
    ...
    iput-object v0, p0, mAuths:Landroid/util/ArrayMap;

    iput-object p1, p0, mPkg:Lcom/android/server/slice/SlicePermissionManager$PkgUser;

    iput-object p2, p0, mTracker:Lcom/android/server/slice/DirtyTracker;
...
.method static synthetic access$200()Ljava/lang/String;
    ...
    sget-object v0, NAMESPACE:Ljava/lang/String;
...
.method public static createFrom(Lorg/xmlpull/v1/XmlPullParser;Lcom/android/server/slice/DirtyTracker;)Lcom/android/server/slice/SliceClientPermissions;
    ...
    sget-object v4, NAMESPACE:Ljava/lang/String;
    ...
    invoke-direct {v4, v3, p1}, <init>(Lcom/android/server/slice/SlicePermissionManager$PkgUser;Lcom/android/server/slice/DirtyTracker;)V

    sget-object v6, NAMESPACE:Ljava/lang/String;
    ...
    :goto_1
    iput-boolean v7, v4, mHasFullAccess:Z
    ...
    sget-object v9, NAMESPACE:Ljava/lang/String;
    ...
    sget-object v10, NAMESPACE:Ljava/lang/String;
    ...
    iget-object v9, v4, mAuths:Landroid/util/ArrayMap;
...
.method public clear()V
    ...
    iget-boolean v0, p0, mHasFullAccess:Z

    if-nez v0, :cond_0

    iget-object v0, p0, mAuths:Landroid/util/ArrayMap;
    ...
    iput-boolean v0, p0, mHasFullAccess:Z

    iget-object v0, p0, mAuths:Landroid/util/ArrayMap;

    invoke-virtual {v0}, Landroid/util/ArrayMap;->clear()V

    invoke-virtual {p0, p0}, onPersistableDirty(Lcom/android/server/slice/DirtyTracker$Persistable;)V
...
.method public declared-synchronized getAuthorities()Ljava/util/Collection;
    ...
    iget-object v1, p0, mAuths:Landroid/util/ArrayMap;
...
.method public getFileName()Ljava/lang/String;
    ...
    iget-object v0, p0, mPkg:Lcom/android/server/slice/SlicePermissionManager$PkgUser;

    invoke-static {v0}, getFileName(Lcom/android/server/slice/SlicePermissionManager$PkgUser;)Ljava/lang/String;
...
.method public declared-synchronized getOrCreateAuthority(Lcom/android/server/slice/SlicePermissionManager$PkgUser;Lcom/android/server/slice/SlicePermissionManager$PkgUser;)Lcom/android/server/slice/SliceClientPermissions$SliceAuthority;
    ...
    invoke-virtual {p0, v0}, onPersistableDirty(Lcom/android/server/slice/DirtyTracker$Persistable;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public grantUri(Landroid/net/Uri;Lcom/android/server/slice/SlicePermissionManager$PkgUser;)V
    ...
    invoke-virtual {p0, v0, p2}, getOrCreateAuthority(Lcom/android/server/slice/SlicePermissionManager$PkgUser;Lcom/android/server/slice/SlicePermissionManager$PkgUser;)Lcom/android/server/slice/SliceClientPermissions$SliceAuthority;
...
.method public declared-synchronized hasPermission(Landroid/net/Uri;I)Z
    ...
    invoke-virtual {p0, v0}, getAuthority(Lcom/android/server/slice/SlicePermissionManager$PkgUser;)Lcom/android/server/slice/SliceClientPermissions$SliceAuthority;
...
.method public onPersistableDirty(Lcom/android/server/slice/DirtyTracker$Persistable;)V
    ...
    iget-object v0, p0, mTracker:Lcom/android/server/slice/DirtyTracker;
...
.method public setHasFullAccess(Z)V
    ...
    :cond_0
    iput-boolean p1, p0, mHasFullAccess:Z
...
.method public declared-synchronized writeTo(Lorg/xmlpull/v1/XmlSerializer;)V
    ...
    iget-object v2, p0, mPkg:Lcom/android/server/slice/SlicePermissionManager$PkgUser;
    ...
    iget-boolean v2, p0, mHasFullAccess:Z
    ...
    sget-object v2, NAMESPACE:Ljava/lang/String;
    ...
    iget-object v4, p0, mAuths:Landroid/util/ArrayMap;
    ...
    iget-object v2, p0, mAuths:Landroid/util/ArrayMap;
    ...
    :cond_1
    sget-object v1, NAMESPACE:Ljava/lang/String;
