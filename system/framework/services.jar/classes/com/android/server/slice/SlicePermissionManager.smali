...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Looper;)V
    ...
    invoke-direct {p0, p1, p2, v0}, <init>(Landroid/content/Context;Landroid/os/Looper;Ljava/io/File;)V
...
.method constructor <init>(Landroid/content/Context;Landroid/os/Looper;Ljava/io/File;)V
    ...
    iput-object v0, p0, ATT_VERSION:Ljava/lang/String;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, mCachedProviders:Landroid/util/ArrayMap;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, mCachedClients:Landroid/util/ArrayMap;

    new-instance v0, Landroid/util/ArraySet;

    invoke-direct {v0}, Landroid/util/ArraySet;-><init>()V

    iput-object v0, p0, mDirty:Landroid/util/ArraySet;
    ...
    iput-object p3, p0, mSliceDir:Ljava/io/File;
...
.method static synthetic access$400(Lcom/android/server/slice/SlicePermissionManager;)Landroid/util/ArraySet;
    ...
    iget-object v0, p0, mDirty:Landroid/util/ArraySet;
...
.method static synthetic access$500(Lcom/android/server/slice/SlicePermissionManager;Lcom/android/server/slice/SlicePermissionManager$PkgUser;)V
    ...
    invoke-direct {p0, p1}, handleRemove(Lcom/android/server/slice/SlicePermissionManager$PkgUser;)V
...
.method static synthetic access$600(Lcom/android/server/slice/SlicePermissionManager;)Landroid/util/ArrayMap;
    ...
    iget-object v0, p0, mCachedClients:Landroid/util/ArrayMap;
...
.method static synthetic access$700(Lcom/android/server/slice/SlicePermissionManager;)Landroid/util/ArrayMap;
    ...
    iget-object v0, p0, mCachedProviders:Landroid/util/ArrayMap;
...
.method private getClient(Lcom/android/server/slice/SlicePermissionManager$PkgUser;)Lcom/android/server/slice/SliceClientPermissions;
    ...
    :try_start_0
    iget-object v1, p0, mCachedClients:Landroid/util/ArrayMap;
    ...
    invoke-direct {p0, v0}, getParser(Ljava/lang/String;)Lcom/android/server/slice/SlicePermissionManager$ParserHolder;
    ...
    iget-object v3, p0, mCachedClients:Landroid/util/ArrayMap;
    ...
    :try_start_3
    iget-object v4, p0, mCachedClients:Landroid/util/ArrayMap;
    ...
    iget-object v2, p0, mCachedClients:Landroid/util/ArrayMap;
...
.method private getFile(Ljava/lang/String;)Landroid/util/AtomicFile;
    ...
    iget-object v0, p0, mSliceDir:Ljava/io/File;
    ...
    iget-object v2, p0, mSliceDir:Ljava/io/File;
...
.method private getParser(Ljava/lang/String;)Lcom/android/server/slice/SlicePermissionManager$ParserHolder;
    ...
    invoke-direct {p0, p1}, getFile(Ljava/lang/String;)Landroid/util/AtomicFile;
...
.method private getProvider(Lcom/android/server/slice/SlicePermissionManager$PkgUser;)Lcom/android/server/slice/SliceProviderPermissions;
    ...
    :try_start_0
    iget-object v1, p0, mCachedProviders:Landroid/util/ArrayMap;
    ...
    iget-object v3, p0, mCachedProviders:Landroid/util/ArrayMap;
    ...
    :try_start_3
    iget-object v4, p0, mCachedProviders:Landroid/util/ArrayMap;
    ...
    iget-object v2, p0, mCachedProviders:Landroid/util/ArrayMap;
...
.method private handleRemove(Lcom/android/server/slice/SlicePermissionManager$PkgUser;)V
    ...
    invoke-direct {p0, v0}, getFile(Ljava/lang/String;)Landroid/util/AtomicFile;
...
.method public getAllPackagesGranted(Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-direct {p0, v1}, getProvider(Lcom/android/server/slice/SlicePermissionManager$PkgUser;)Lcom/android/server/slice/SliceProviderPermissions;
...
.method public grantFullAccess(Ljava/lang/String;I)V
    ...
    invoke-direct {p0, v0}, getClient(Lcom/android/server/slice/SlicePermissionManager$PkgUser;)Lcom/android/server/slice/SliceClientPermissions;
...
.method handlePersist()V
    ...
    invoke-direct {p0, v2}, getFile(Ljava/lang/String;)Landroid/util/AtomicFile;
...
.method public readRestore(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    iget-object v6, p0, mCachedClients:Landroid/util/ArrayMap;
    ...
    :try_start_1
    iget-object v7, p0, mCachedClients:Landroid/util/ArrayMap;
    ...
    :try_start_2
    invoke-virtual {p0, v3}, onPersistableDirty(Lcom/android/server/slice/DirtyTracker$Persistable;)V
    ...
    iget-object v6, p0, mCachedProviders:Landroid/util/ArrayMap;
    ...
    :try_start_5
    iget-object v7, p0, mCachedProviders:Landroid/util/ArrayMap;
...
.method public removePkg(Ljava/lang/String;I)V
    ...
    invoke-direct {p0, v0}, getProvider(Lcom/android/server/slice/SlicePermissionManager$PkgUser;)Lcom/android/server/slice/SliceProviderPermissions;
    ...
    invoke-direct {p0, v5}, getClient(Lcom/android/server/slice/SlicePermissionManager$PkgUser;)Lcom/android/server/slice/SliceClientPermissions;
...
.method public writeBackup(Lorg/xmlpull/v1/XmlSerializer;)V
    ...
    invoke-virtual {p0}, handlePersist()V

    :cond_0
    new-instance v3, Ljava/io/File;

    iget-object v4, p0, mSliceDir:Ljava/io/File;
    ...
    invoke-direct {p0, v6}, getParser(Ljava/lang/String;)Lcom/android/server/slice/SlicePermissionManager$ParserHolder;
    ...
    :try_start_2
    invoke-static {v1, v7}, $closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_2
