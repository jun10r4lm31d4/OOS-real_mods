...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-static {}, createHandler()Lcom/android/server/ServiceThread;
    ...
    invoke-direct {p0, p1, v0}, <init>(Landroid/content/Context;Landroid/os/Looper;)V
...
.method constructor <init>(Landroid/content/Context;Landroid/os/Looper;)V
    ...
    iput-object v0, p0, mPinnedSlicesByUri:Landroid/util/ArrayMap;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, mAssistantLookup:Landroid/util/SparseArray;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, mHomeLookup:Landroid/util/SparseArray;
    ...
    iput-object v0, p0, mAppUsageStats:Landroid/app/usage/UsageStatsManagerInternal;
    ...
    iput-object v0, p0, mPermissions:Lcom/android/server/slice/SlicePermissionManager;
...
.method static synthetic access$000(Lcom/android/server/slice/SliceManagerService;)Lcom/android/server/slice/SlicePermissionManager;
    ...
    iget-object v0, p0, mPermissions:Lcom/android/server/slice/SlicePermissionManager;
...
.method static synthetic access$300(Lcom/android/server/slice/SliceManagerService;I)V
    ...
    invoke-direct {p0, p1}, onStopUser(I)V
...
.method private enforceAccess(Ljava/lang/String;Landroid/net/Uri;)V
    ...
    invoke-virtual {p0, p1, p2, v0, v1}, checkAccess(Ljava/lang/String;Landroid/net/Uri;II)I
    ...
    invoke-direct {p0, p2, v0}, getProviderPkg(Landroid/net/Uri;I)Ljava/lang/String;
    ...
    :cond_1
    :goto_0
    invoke-direct {p0, p1, p2}, enforceCrossUser(Ljava/lang/String;Landroid/net/Uri;)V
...
.method private enforceOwner(Ljava/lang/String;Landroid/net/Uri;I)V
    ...
    invoke-direct {p0, p2, p3}, getProviderPkg(Landroid/net/Uri;I)Ljava/lang/String;
...
.method private getAssistantMatcher(I)Lcom/android/server/slice/SliceManagerService$PackageMatchingCache;
    ...
    iget-object v0, p0, mAssistantLookup:Landroid/util/SparseArray;
    ...
    iget-object v1, p0, mAssistantLookup:Landroid/util/SparseArray;
...
.method private getHomeMatcher(I)Lcom/android/server/slice/SliceManagerService$PackageMatchingCache;
    ...
    iget-object v0, p0, mHomeLookup:Landroid/util/SparseArray;
    ...
    iget-object v1, p0, mHomeLookup:Landroid/util/SparseArray;
...
.method private getOrCreatePinnedSlice(Landroid/net/Uri;Ljava/lang/String;)Lcom/android/server/slice/PinnedSliceState;
    ...
    :try_start_0
    iget-object v1, p0, mPinnedSlicesByUri:Landroid/util/ArrayMap;
    ...
    invoke-virtual {p0, p1, p2}, createPinnedSlice(Landroid/net/Uri;Ljava/lang/String;)Lcom/android/server/slice/PinnedSliceState;

    move-result-object v2

    move-object v1, v2

    iget-object v2, p0, mPinnedSlicesByUri:Landroid/util/ArrayMap;
...
.method private hasFullSliceAccess(Ljava/lang/String;I)Z
    ...
    :try_start_0
    invoke-direct {p0, p1, p2}, isDefaultHomeApp(Ljava/lang/String;I)Z

    move-result v2

    if-nez v2, :cond_1

    invoke-direct {p0, p1, p2}, isAssistant(Ljava/lang/String;I)Z

    move-result v2

    if-nez v2, :cond_1

    invoke-direct {p0, p1, p2}, isGrantedFullAccess(Ljava/lang/String;I)Z
...
.method private isAssistant(Ljava/lang/String;I)Z
    ...
    invoke-direct {p0, p2}, getAssistantMatcher(I)Lcom/android/server/slice/SliceManagerService$PackageMatchingCache;
...
.method private isDefaultHomeApp(Ljava/lang/String;I)Z
    ...
    invoke-direct {p0, p2}, getHomeMatcher(I)Lcom/android/server/slice/SliceManagerService$PackageMatchingCache;
...
.method public applyRestore([BI)V
    ...
    iget-object v3, p0, mPermissions:Lcom/android/server/slice/SlicePermissionManager;
...
.method protected checkAccess(Ljava/lang/String;Landroid/net/Uri;II)I
    ...
    invoke-virtual/range {v0 .. v6}, checkSlicePermission(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;II[Ljava/lang/String;)I
...
.method public checkSlicePermission(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;II[Ljava/lang/String;)I
    ...
    :cond_2
    invoke-direct {v7, v10, v14}, hasFullSliceAccess(Ljava/lang/String;I)Z
    ...
    :cond_3
    iget-object v0, v7, mPermissions:Lcom/android/server/slice/SlicePermissionManager;
    ...
    invoke-direct {v7, v9, v8, v14}, enforceOwner(Ljava/lang/String;Landroid/net/Uri;I)V
    ...
    invoke-direct {v7, v8, v15}, getProviderPkg(Landroid/net/Uri;I)Ljava/lang/String;
...
.method public getAllPackagesGranted(Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-direct {p0, v0, v1}, getProviderPkg(Landroid/net/Uri;I)Ljava/lang/String;

    move-result-object v0

    iget-object v1, p0, mPermissions:Lcom/android/server/slice/SlicePermissionManager;
...
.method public getBackupPayload(I)[B
    ...
    iget-object v4, p0, mPermissions:Lcom/android/server/slice/SlicePermissionManager;
...
.method public getPinnedSlices(Ljava/lang/String;)[Landroid/net/Uri;
    ...
    invoke-direct {p0, p1}, verifyCaller(Ljava/lang/String;)V
    ...
    :try_start_0
    iget-object v3, p0, mPinnedSlicesByUri:Landroid/util/ArrayMap;
...
.method public getPinnedSpecs(Landroid/net/Uri;Ljava/lang/String;)[Landroid/app/slice/SliceSpec;
    ...
    invoke-direct {p0, p2}, verifyCaller(Ljava/lang/String;)V

    invoke-direct {p0, p2, p1}, enforceAccess(Ljava/lang/String;Landroid/net/Uri;)V
    ...
    invoke-direct {p0, p1}, getPinnedSlice(Landroid/net/Uri;)Lcom/android/server/slice/PinnedSliceState;
...
.method public grantPermissionFromUser(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-direct {p0, p3}, verifyCaller(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v7, v8}, getProviderPkg(Landroid/net/Uri;I)Ljava/lang/String;
...
.method public grantSlicePermission(Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri;)V
    ...
    invoke-direct {p0, p1, p3, v0}, enforceOwner(Ljava/lang/String;Landroid/net/Uri;I)V
...
.method public hasSliceAccess(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1, v0}, hasFullSliceAccess(Ljava/lang/String;I)Z
...
.method public synthetic lambda$getAssistantMatcher$2$SliceManagerService(I)Ljava/lang/String;
    ...
    invoke-direct {p0, p1}, getAssistant(I)Ljava/lang/String;
...
.method public synthetic lambda$getHomeMatcher$3$SliceManagerService(I)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, getDefaultHome(I)Ljava/lang/String;
...
.method public synthetic lambda$pinSlice$1$SliceManagerService(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    invoke-direct {p0, p2, p3}, isAssistant(Ljava/lang/String;I)Z

    move-result v1

    if-nez v1, :cond_1

    invoke-direct {p0, p2, p3}, isDefaultHomeApp(Ljava/lang/String;I)Z
...
.method public pinSlice(Ljava/lang/String;Landroid/net/Uri;[Landroid/app/slice/SliceSpec;Landroid/os/IBinder;)V
    ...
    invoke-direct {p0, p1, p2}, enforceAccess(Ljava/lang/String;Landroid/net/Uri;)V
    ...
    invoke-direct {p0, p2, v1}, getOrCreatePinnedSlice(Landroid/net/Uri;Ljava/lang/String;)Lcom/android/server/slice/PinnedSliceState;
...
.method public unpinSlice(Ljava/lang/String;Landroid/net/Uri;Landroid/os/IBinder;)V
    ...
    invoke-direct {p0, p2}, getPinnedSlice(Landroid/net/Uri;)Lcom/android/server/slice/PinnedSliceState;
    ...
    invoke-virtual {p0, p2}, removePinnedSlice(Landroid/net/Uri;)V
