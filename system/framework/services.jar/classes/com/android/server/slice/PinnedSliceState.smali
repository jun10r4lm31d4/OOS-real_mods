...
.method public constructor <init>(Lcom/android/server/slice/SliceManagerService;Landroid/net/Uri;Ljava/lang/String;)V
    ...
    iput-object v0, p0, mPinnedPkgs:Landroid/util/ArraySet;
    ...
    iput-object v0, p0, mSupportedSpecs:[Landroid/app/slice/SliceSpec;
    ...
    iput-object p1, p0, mService:Lcom/android/server/slice/SliceManagerService;

    iput-object p2, p0, mUri:Landroid/net/Uri;

    iput-object p3, p0, mPkg:Ljava/lang/String;

    iget-object v0, p0, mService:Lcom/android/server/slice/SliceManagerService;
...
.method private checkSelfRemove()V
    ...
    invoke-virtual {p0}, hasPinOrListener()Z
...
.method private handleRecheckListeners()V
    ...
    :try_start_0
    iget-object v1, p0, mListeners:Landroid/util/ArrayMap;
    ...
    :cond_2
    invoke-direct {p0}, checkSelfRemove()V
...
.method private handleSendPinned()V
    ...
    invoke-virtual {p0}, getClient()Landroid/content/ContentProviderClient;
...
.method public static synthetic lambda$KzxFkvfomRuMb5PD8_pIHDIhUUE(Lcom/android/server/slice/PinnedSliceState;)V
    ...
    invoke-direct {p0}, handleRecheckListeners()V
...
.method public static synthetic lambda$TZdoqC_LDA8If7sQ7WXz9LM6VHg(Lcom/android/server/slice/PinnedSliceState;)V
    ...
    invoke-direct {p0}, handleSendPinned()V
...
.method public static synthetic lambda$t5Vl61Ns1u_83c4ri7920sczEu0(Lcom/android/server/slice/PinnedSliceState;)V
    ...
    invoke-direct {p0}, handleSendUnpinned()V
...
.method private setSlicePinned(Z)V
    ...
    :try_start_0
    iget-boolean v1, p0, mSlicePinned:Z
    ...
    :cond_0
    iput-boolean p1, p0, mSlicePinned:Z

    if-eqz p1, :cond_1

    iget-object v1, p0, mService:Lcom/android/server/slice/SliceManagerService;
...
.method public destroy()V
    ...
    invoke-direct {p0, v0}, setSlicePinned(Z)V
...
.method public getSpecs()[Landroid/app/slice/SliceSpec;
    ...
    iget-object v0, p0, mSupportedSpecs:[Landroid/app/slice/SliceSpec;
...
.method public hasPinOrListener()Z
    ...
    :try_start_0
    iget-object v1, p0, mPinnedPkgs:Landroid/util/ArraySet;
...
.method public synthetic lambda$mergeSpecs$0$PinnedSliceState([Landroid/app/slice/SliceSpec;Landroid/app/slice/SliceSpec;)Landroid/app/slice/SliceSpec;
    ...
    invoke-direct {p0, p1, v0}, findSpec([Landroid/app/slice/SliceSpec;Ljava/lang/String;)Landroid/app/slice/SliceSpec;
...
.method public mergeSpecs([Landroid/app/slice/SliceSpec;)V
    ...
    :try_start_0
    iget-object v1, p0, mSupportedSpecs:[Landroid/app/slice/SliceSpec;

    if-nez v1, :cond_0

    iput-object p1, p0, mSupportedSpecs:[Landroid/app/slice/SliceSpec;
    ...
    iput-object v2, p0, mSupportedSpecs:[Landroid/app/slice/SliceSpec;
...
.method public pin(Ljava/lang/String;[Landroid/app/slice/SliceSpec;Landroid/os/IBinder;)V
    ...
    :goto_0
    :try_start_2
    invoke-virtual {p0, p2}, mergeSpecs([Landroid/app/slice/SliceSpec;)V

    const/4 v1, 0x1

    invoke-direct {p0, v1}, setSlicePinned(Z)V
