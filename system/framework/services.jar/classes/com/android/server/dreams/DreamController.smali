...
.method private attach(Landroid/service/dreams/IDreamService;)V
    ...
    iget-object v3, p0, mCurrentDream:Lcom/android/server/dreams/DreamController$DreamRecord;
...
.method public startDream(Landroid/os/Binder;Landroid/content/ComponentName;ZZILandroid/os/PowerManager$WakeLock;)V
    ...
    invoke-virtual {v9, v14}, stopDream(Z)V
    ...
    iget-object v1, v9, mCloseNotificationShadeIntent:Landroid/content/Intent;
    ...
    iput-object v0, v9, mCurrentDream:Lcom/android/server/dreams/DreamController$DreamRecord;

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J

    move-result-wide v0

    iput-wide v0, v9, mDreamStartTime:J

    iget-object v0, v9, mContext:Landroid/content/Context;

    iget-object v1, v9, mCurrentDream:Lcom/android/server/dreams/DreamController$DreamRecord;
    ...
    iget-object v2, v9, mCurrentDream:Lcom/android/server/dreams/DreamController$DreamRecord;
    ...
    :try_start_7
    iget-object v0, v9, mCurrentDream:Lcom/android/server/dreams/DreamController$DreamRecord;
    ...
    iget-object v2, v9, mStopUnconnectedDreamRunnable:Ljava/lang/Runnable;
...
.method public stopDream(Z)V
    ...
    iget-object v4, p0, mStopStubbornDreamRunnable:Ljava/lang/Runnable;
    ...
    iput-object v4, p0, mCurrentDream:Lcom/android/server/dreams/DreamController$DreamRecord;
    ...
    iget-wide v9, p0, mDreamStartTime:J
    ...
    iget-object v6, p0, mStopUnconnectedDreamRunnable:Ljava/lang/Runnable;

    invoke-virtual {v5, v6}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    iget-object v5, p0, mHandler:Landroid/os/Handler;

    iget-object v6, p0, mStopStubbornDreamRunnable:Ljava/lang/Runnable;
    ...
    iget-object v6, p0, mDreamingStoppedIntent:Landroid/content/Intent;
