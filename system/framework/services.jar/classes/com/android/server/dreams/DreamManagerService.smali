...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mDozeEnabledObserver:Landroid/database/ContentObserver;
    ...
    iput-object v0, p0, mDozeConfig:Landroid/hardware/display/AmbientDisplayConfiguration;
...
.method static synthetic access$200(Lcom/android/server/dreams/DreamManagerService;)V
    ...
    invoke-direct {p0}, writePulseGestureEnabled()V
...
.method static synthetic access$2100(Lcom/android/server/dreams/DreamManagerService;Z)V
    ...
    invoke-direct {p0, p1}, forceAmbientDisplayEnabledInternal(Z)V
...
.method private cleanupDreamLocked()V
    ...
    iput-boolean v0, p0, mCurrentDreamIsTest:Z

    iput-boolean v0, p0, mCurrentDreamCanDoze:Z

    iput v0, p0, mCurrentDreamUserId:I
    ...
    iget-object v1, p0, mDozeWakeLock:Landroid/os/PowerManager$WakeLock;
...
.method private dumpInternal(Ljava/io/PrintWriter;)V
    ...
    iget-boolean v1, p0, mForceAmbientDisplayEnabled:Z
...
.method private forceAmbientDisplayEnabledInternal(Z)V
    ...
    :try_start_0
    iput-boolean p1, p0, mForceAmbientDisplayEnabled:Z
...
.method private getDozeComponent(I)Landroid/content/ComponentName;
    ...
    iget-boolean v0, p0, mForceAmbientDisplayEnabled:Z

    if-nez v0, :cond_1

    iget-object v0, p0, mDozeConfig:Landroid/hardware/display/AmbientDisplayConfiguration;
...
.method private getDreamComponentsForUser(I)[Landroid/content/ComponentName;
    ...
    invoke-static {v0}, componentsFromString(Ljava/lang/String;)[Landroid/content/ComponentName;
    ...
    invoke-direct {p0, v5}, validateDream(Landroid/content/ComponentName;)Z
...
.method private startDreamInternal(Z)V
    ...
    invoke-direct {p0, p1, v0}, chooseDreamForUser(ZI)Landroid/content/ComponentName;
    ...
    :try_start_0
    invoke-direct {p0, v1, v3, p1, v0}, startDreamLocked(Landroid/content/ComponentName;ZZI)V
...
.method private startDreamLocked(Landroid/content/ComponentName;ZZI)V
    ...
    iget-object v0, v8, mCurrentDreamName:Landroid/content/ComponentName;
    ...
    iget-boolean v0, v8, mCurrentDreamIsTest:Z

    if-ne v0, v10, :cond_0

    iget-boolean v0, v8, mCurrentDreamCanDoze:Z

    if-ne v0, v11, :cond_0

    iget v0, v8, mCurrentDreamUserId:I
    ...
    invoke-direct {v8, v0}, stopDreamLocked(Z)V
    ...
    iput-object v13, v8, mCurrentDreamToken:Landroid/os/Binder;

    iput-object v9, v8, mCurrentDreamName:Landroid/content/ComponentName;

    iput-boolean v10, v8, mCurrentDreamIsTest:Z

    iput-boolean v11, v8, mCurrentDreamCanDoze:Z

    iput v12, v8, mCurrentDreamUserId:I

    iget-object v1, v8, mPowerManager:Landroid/os/PowerManager;
    ...
    iget-object v15, v8, mHandler:Lcom/android/server/dreams/DreamManagerService$DreamHandler;
...
.method private stopDozingInternal(Landroid/os/IBinder;)V
    ...
    iget-object v2, p0, mDozeWakeLock:Landroid/os/PowerManager$WakeLock;
...
.method private testDreamInternal(Landroid/content/ComponentName;I)V
    ...
    :try_start_0
    invoke-direct {p0, p1, v1, v2, p2}, startDreamLocked(Landroid/content/ComponentName;ZZI)V
...
.method public onBootPhase(I)V
    ...
    iget-object v3, p0, mDozeEnabledObserver:Landroid/database/ContentObserver;
