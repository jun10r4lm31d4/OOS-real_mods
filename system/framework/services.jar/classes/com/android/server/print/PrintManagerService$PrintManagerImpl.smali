...
.method static synthetic access$000(Lcom/android/server/print/PrintManagerService$PrintManagerImpl;I)V
    ...
    invoke-direct {p0, p1}, handleUserUnlocked(I)V
...
.method static synthetic access$600(Lcom/android/server/print/PrintManagerService$PrintManagerImpl;IZZ)Lcom/android/server/print/UserState;
    ...
    invoke-direct {p0, p1, p2, p3}, getOrCreateUserStateLocked(IZZ)Lcom/android/server/print/UserState;
...
.method private getOrCreateUserStateLocked(IZ)Lcom/android/server/print/UserState;
    ...
    invoke-direct {p0, p1, p2, v0}, getOrCreateUserStateLocked(IZZ)Lcom/android/server/print/UserState;
...
.method public addPrintJobStateChangeListener(Landroid/print/IPrintJobStateChangeListener;II)V
    ...
    :try_start_0
    invoke-direct {p0, v0}, resolveCallingProfileParentLocked(I)I
    ...
    invoke-direct {p0, v0, v3}, getOrCreateUserStateLocked(IZ)Lcom/android/server/print/UserState;
...
.method public addPrintServiceRecommendationsChangeListener(Landroid/printservice/recommendation/IRecommendationsChangeListener;I)V
    ...
    invoke-direct {p0, v0, v2}, getOrCreateUserStateLocked(IZ)Lcom/android/server/print/UserState;
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-direct {p0, v5, v2}, dump(Lcom/android/internal/util/dump/DualDumpOutputStream;Ljava/util/ArrayList;)V
...
.method public getBindInstantServiceAllowed(I)Z
    ...
    :try_start_0
    invoke-direct {p0, p1, v2}, getOrCreateUserStateLocked(IZ)Lcom/android/server/print/UserState;
...
.method public getPrintJobInfo(Landroid/print/PrintJobId;II)Landroid/print/PrintJobInfo;
    ...
    :try_start_0
    invoke-direct {p0, v1}, resolveCallingProfileParentLocked(I)I
    ...
    invoke-direct {p0, v1, v3}, getOrCreateUserStateLocked(IZ)Lcom/android/server/print/UserState;
...
.method public getPrintServiceRecommendations(I)Ljava/util/List;
    ...
    invoke-direct {p0, v0, v1}, getOrCreateUserStateLocked(IZ)Lcom/android/server/print/UserState;
...
.method public print(Ljava/lang/String;Landroid/print/IPrintDocumentAdapter;Landroid/print/PrintAttributes;Ljava/lang/String;II)Landroid/os/Bundle;
    ...
    invoke-direct {p0}, isPrintingEnabled()Z
