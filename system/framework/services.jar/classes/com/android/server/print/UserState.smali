...
.method public constructor <init>(Landroid/content/Context;ILjava/lang/Object;Z)V
    ...
    iput-object v0, p0, mDisabledServices:Ljava/util/Set;
    ...
    :try_start_0
    invoke-direct {p0}, readInstalledPrintServicesLocked()V

    invoke-direct {p0}, upgradePersistentStateIfNeeded()V

    invoke-direct {p0}, readDisabledPrintServicesLocked()V

    monitor-exit v0
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-virtual {p0}, prunePrintServices()V
...
.method static synthetic access$400(Lcom/android/server/print/UserState;)Ljava/util/List;
    ...
    iget-object v0, p0, mPrintServicesChangeListenerRecords:Ljava/util/List;
...
.method static synthetic access$500(Lcom/android/server/print/UserState;)Ljava/util/List;
    ...
    iget-object v0, p0, mPrintServiceRecommendationsChangeListenerRecords:Ljava/util/List;
...
.method static synthetic access$700(Lcom/android/server/print/UserState;Lcom/android/server/print/RemotePrintService;)V
    ...
    invoke-direct {p0, p1}, removeServiceLocked(Lcom/android/server/print/RemotePrintService;)V
...
.method private getInstalledComponents()Ljava/util/ArrayList;
    ...
    iget-object v3, p0, mInstalledServices:Ljava/util/List;
...
.method private handleDispatchPrintJobStateChanged(Landroid/print/PrintJobId;Ljava/util/function/IntSupplier;)V
    ...
    :try_start_0
    iget-object v2, p0, mPrintJobStateChangeListenerRecords:Ljava/util/List;
...
.method private handleDispatchPrintServiceRecommendationsUpdated(Ljava/util/List;)V
    ...
    :try_start_0
    iget-object v1, p0, mPrintServiceRecommendationsChangeListenerRecords:Ljava/util/List;
    ...
    iget-object v2, p0, mPrintServiceRecommendationsChangeListenerRecords:Ljava/util/List;

    invoke-direct {v1, v2}, Ljava/util/ArrayList;-><init>(Ljava/util/Collection;)V

    iput-object p1, p0, mPrintServiceRecommendations:Ljava/util/List;
...
.method private handleDispatchPrintServicesChanged()V
    ...
    :try_start_0
    iget-object v1, p0, mPrintServicesChangeListenerRecords:Ljava/util/List;
    ...
    iget-object v2, p0, mPrintServicesChangeListenerRecords:Ljava/util/List;
...
.method public static synthetic lambda$LdWYUAKz4cbWqoxOD4oZ_ZslKdg(Lcom/android/server/print/UserState;)V
    ...
    invoke-direct {p0}, handleDispatchPrintServicesChanged()V
...
.method public static synthetic lambda$d-WQxYwbHYb6N0le5ohwQsWVdjw(Lcom/android/server/print/UserState;Landroid/print/PrintJobId;Ljava/util/function/IntSupplier;)V
    ...
    invoke-direct {p0, p1, p2}, handleDispatchPrintJobStateChanged(Landroid/print/PrintJobId;Ljava/util/function/IntSupplier;)V
...
.method public static synthetic lambda$f3loorfBpq9Tu3Vl5vt4Ul321ok(Lcom/android/server/print/UserState;Ljava/util/List;)V
    ...
    invoke-direct {p0, p1}, handleDispatchPrintServiceRecommendationsUpdated(Ljava/util/List;)V
...
.method private onConfigurationChangedLocked()V
    ...
    invoke-direct {p0}, getInstalledComponents()Ljava/util/ArrayList;
    ...
    iget-object v4, p0, mDisabledServices:Ljava/util/Set;
    ...
    invoke-direct {p0, v4}, addServiceLocked(Lcom/android/server/print/RemotePrintService;)V
    ...
    invoke-direct {p0, v4}, removeServiceLocked(Lcom/android/server/print/RemotePrintService;)V
    ...
    invoke-direct {p0, v5}, removeServiceLocked(Lcom/android/server/print/RemotePrintService;)V
    ...
    :cond_4
    invoke-virtual {p0}, onPrintServicesChanged()V
...
.method private readDisabledPrintServicesLocked()V
    ...
    iget-object v1, p0, mDisabledServices:Ljava/util/Set;
...
.method private readInstalledPrintServicesLocked()V
    ...
    iget-boolean v2, p0, mIsInstantServiceAllowed:Z
    ...
    iget-object v3, p0, mQueryIntent:Landroid/content/Intent;
    ...
    :cond_2
    iget-object v4, p0, mInstalledServices:Ljava/util/List;
...
.method private upgradePersistentStateIfNeeded()V
    ...
    invoke-direct {p0, v2, v1}, readPrintServicesFromSettingLocked(Ljava/lang/String;Ljava/util/Set;)V
    ...
    :cond_1
    invoke-direct {p0, v3}, writeDisabledPrintServicesLocked(Ljava/util/Set;)V
...
.method public addPrintJobStateChangeListener(Landroid/print/IPrintJobStateChangeListener;I)V
    ...
    iget-object v1, p0, mPrintJobStateChangeListenerRecords:Ljava/util/List;
    ...
    iput-object v1, p0, mPrintJobStateChangeListenerRecords:Ljava/util/List;
...
.method public addPrintServiceRecommendationsChangeListener(Landroid/printservice/recommendation/IRecommendationsChangeListener;)V
    ...
    iput-object v1, p0, mPrintServiceRecommendationsChangeListenerRecords:Ljava/util/List;
    ...
    iput-object v1, p0, mPrintServiceRecommendationsService:Lcom/android/server/print/RemotePrintServiceRecommendationService;
...
.method public addPrintServicesChangeListener(Landroid/print/IPrintServicesChangeListener;)V
    ...
    iput-object v1, p0, mPrintServicesChangeListenerRecords:Ljava/util/List;
...
.method public cancelPrintJob(Landroid/print/PrintJobId;I)V
    ...
    :try_start_0
    iget-object v5, p0, mActiveServices:Landroid/util/ArrayMap;
...
.method public createPrinterDiscoverySession(Landroid/print/IPrinterDiscoveryObserver;)V
    ...
    iget-object v1, p0, mPrinterDiscoverySession:Lcom/android/server/print/UserState$PrinterDiscoverySessionMediator;
    ...
    iput-object v1, p0, mPrinterDiscoverySession:Lcom/android/server/print/UserState$PrinterDiscoverySessionMediator;
...
.method public destroyLocked()V
    ...
    iget-object v0, p0, mDisabledServices:Ljava/util/Set;
...
.method public dump(Lcom/android/internal/util/dump/DualDumpOutputStream;)V
    ...
    iget-object v5, p0, mInstalledServices:Ljava/util/List;
    ...
    :cond_0
    iget-object v2, p0, mDisabledServices:Ljava/util/Set;
    ...
    :cond_2
    iget-object v3, p0, mPrintJobForAppCache:Lcom/android/server/print/UserState$PrintJobForAppCache;
    ...
    iget-object v3, p0, mPrinterDiscoverySession:Lcom/android/server/print/UserState$PrinterDiscoverySessionMediator;
    ...
    iget-object v5, p0, mPrinterDiscoverySession:Lcom/android/server/print/UserState$PrinterDiscoverySessionMediator;
...
.method public getBindInstantServiceAllowed()Z
    ...
    iget-boolean v0, p0, mIsInstantServiceAllowed:Z
...
.method public getPrintJobInfos(I)Ljava/util/List;
    ...
    :cond_0
    iget-object v3, p0, mSpooler:Lcom/android/server/print/RemotePrintSpooler;
...
.method public getPrintServiceRecommendations()Ljava/util/List;
    ...
    iget-object v0, p0, mPrintServiceRecommendations:Ljava/util/List;
...
.method public onServiceDied(Lcom/android/server/print/RemotePrintService;)V
    ...
    invoke-direct {p0, v1}, failActivePrintJobsForService(Landroid/content/ComponentName;)V
...
.method public print(Ljava/lang/String;Landroid/print/IPrintDocumentAdapter;Landroid/print/PrintAttributes;Ljava/lang/String;I)Landroid/os/Bundle;
    ...
    iget-object v6, v1, mPrintJobForAppCache:Lcom/android/server/print/UserState$PrintJobForAppCache;
...
.method public prunePrintServices()V
    ...
    iget-object v3, p0, mDisabledServices:Ljava/util/Set;
...
.method public removePrintJobStateChangeListener(Landroid/print/IPrintJobStateChangeListener;)V
    ...
    iget-object v4, p0, mPrintJobStateChangeListenerRecords:Ljava/util/List;
    ...
    iput-object v2, p0, mPrintJobStateChangeListenerRecords:Ljava/util/List;
...
.method public removePrintServiceRecommendationsChangeListener(Landroid/printservice/recommendation/IRecommendationsChangeListener;)V
    ...
    iget-object v3, p0, mPrintServiceRecommendationsChangeListenerRecords:Ljava/util/List;
    ...
    iget-object v4, p0, mPrintServiceRecommendationsChangeListenerRecords:Ljava/util/List;
    ...
    iput-object v2, p0, mPrintServiceRecommendationsChangeListenerRecords:Ljava/util/List;

    iput-object v2, p0, mPrintServiceRecommendations:Ljava/util/List;

    iget-object v3, p0, mPrintServiceRecommendationsService:Lcom/android/server/print/RemotePrintServiceRecommendationService;

    invoke-virtual {v3}, Lcom/android/server/print/RemotePrintServiceRecommendationService;->close()V

    iput-object v2, p0, mPrintServiceRecommendationsService:Lcom/android/server/print/RemotePrintServiceRecommendationService;
...
.method public removePrintServicesChangeListener(Landroid/print/IPrintServicesChangeListener;)V
    ...
    iget-object v3, p0, mPrintServicesChangeListenerRecords:Ljava/util/List;
    ...
    iget-object v4, p0, mPrintServicesChangeListenerRecords:Ljava/util/List;
    ...
    iput-object v2, p0, mPrintServicesChangeListenerRecords:Ljava/util/List;
...
.method public setBindInstantServiceAllowed(Z)V
    ...
    :try_start_0
    iput-boolean p1, p0, mIsInstantServiceAllowed:Z

    invoke-virtual {p0}, updateIfNeededLocked()V
...
.method public setPrintServiceEnabled(Landroid/content/ComponentName;Z)V
    ...
    iget-object v5, p0, mDisabledServices:Ljava/util/Set;
    ...
    invoke-direct {p0, v2}, writeDisabledPrintServicesLocked(Ljava/util/Set;)V
