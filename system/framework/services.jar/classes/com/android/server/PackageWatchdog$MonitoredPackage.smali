...
.method constructor <init>(Lcom/android/server/PackageWatchdog;Ljava/lang/String;JJZ)V
    ...
    iput-object p1, p0, this$0:Lcom/android/server/PackageWatchdog;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    const/4 v0, 0x1

    iput v0, p0, mHealthCheckState:I

    const-wide v0, 0x7fffffffffffffffL

    iput-wide v0, p0, mHealthCheckDurationMs:J

    iput-object p2, p0, mName:Ljava/lang/String;

    iput-wide p3, p0, mDurationMs:J

    iput-wide p5, p0, mHealthCheckDurationMs:J

    iput-boolean p7, p0, mHasPassedHealthCheck:Z

    invoke-direct {p0}, updateHealthCheckStateLocked()I
...
.method constructor <init>(Lcom/android/server/PackageWatchdog;Ljava/lang/String;JZ)V
    ...
    invoke-direct/range {v0 .. v7}, <init>(Lcom/android/server/PackageWatchdog;Ljava/lang/String;JJZ)V
...
.method static synthetic access$000(Lcom/android/server/PackageWatchdog$MonitoredPackage;)Ljava/lang/String;
    ...
    invoke-direct {p0}, getName()Ljava/lang/String;
...
.method private updateHealthCheckStateLocked()I
    ...
    iget v0, p0, mHealthCheckState:I

    iget-boolean v1, p0, mHasPassedHealthCheck:Z

    if-eqz v1, :cond_0

    const/4 v1, 0x2

    iput v1, p0, mHealthCheckState:I

    goto :goto_1

    :cond_0
    iget-wide v1, p0, mHealthCheckDurationMs:J
    ...
    invoke-direct {p0, v0}, toString(I)Ljava/lang/String;
    ...
    iget v2, p0, mHealthCheckState:I

    invoke-direct {p0, v2}, toString(I)Ljava/lang/String;
    ...
    iget v1, p0, mHealthCheckState:I
...
.method public getShortestScheduleDurationMsLocked()J
    ...
    iget-wide v0, p0, mDurationMs:J

    invoke-direct {p0, v0, v1}, toPositive(J)J

    move-result-wide v0

    invoke-virtual {p0}, isPendingHealthChecksLocked()Z

    move-result v2

    if-eqz v2, :cond_0

    iget-wide v2, p0, mHealthCheckDurationMs:J

    invoke-direct {p0, v2, v3}, toPositive(J)J
...
.method public handleElapsedTimeLocked(J)I
    ...
    iput-wide v0, p0, mDurationMs:J

    iget v0, p0, mHealthCheckState:I

    if-nez v0, :cond_1

    iget-wide v0, p0, mHealthCheckDurationMs:J
...
.method public onFailureLocked()Z
    ...
    iget-wide v2, p0, mUptimeStartMs:J

    sub-long v2, v0, v2

    iget-object v4, p0, this$0:Lcom/android/server/PackageWatchdog;
    ...
    iput v5, p0, mFailures:I

    iput-wide v0, p0, mUptimeStartMs:J

    goto :goto_0

    :cond_0
    iget v4, p0, mFailures:I

    add-int/2addr v4, v5

    iput v4, p0, mFailures:I

    :goto_0
    iget v4, p0, mFailures:I

    iget-object v6, p0, this$0:Lcom/android/server/PackageWatchdog;
...
.method public setHealthCheckActiveLocked(J)I
    ...
    iput-wide p1, p0, mHealthCheckDurationMs:J
...
.method public tryPassHealthCheckLocked()I
    ...
    iput-boolean v0, p0, mHasPassedHealthCheck:Z
...
.method public writeLocked(Lorg/xmlpull/v1/XmlSerializer;)V
    ...
    iget-boolean v2, p0, mHasPassedHealthCheck:Z
