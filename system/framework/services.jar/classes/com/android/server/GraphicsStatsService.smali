...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-static {}, nGetAshmemSize()I

    move-result v0

    iput v0, p0, ASHMEM_SIZE:I

    iget v0, p0, ASHMEM_SIZE:I

    new-array v0, v0, [B

    iput-object v0, p0, ZERO_DATA:[B
    ...
    iput-object v0, p0, mFileAccessLock:Ljava/lang/Object;

    const/4 v0, 0x0

    iput-boolean v0, p0, mRotateIsScheduled:Z
    ...
    iput-object v1, p0, mGraphicsStatsDir:Ljava/io/File;

    iget-object v1, p0, mGraphicsStatsDir:Ljava/io/File;
    ...
    iput-object v2, p0, mWriteOutHandler:Landroid/os/Handler;
    ...
    iget-object v3, p0, mGraphicsStatsDir:Ljava/io/File;
...
.method static synthetic access$000(Lcom/android/server/GraphicsStatsService;Lcom/android/server/GraphicsStatsService$HistoricalBuffer;)V
    ...
    invoke-direct {p0, p1}, saveBuffer(Lcom/android/server/GraphicsStatsService$HistoricalBuffer;)V
...
.method static synthetic access$100(Lcom/android/server/GraphicsStatsService;)V
    ...
    invoke-direct {p0}, deleteOldBuffers()V
...
.method private addToSaveQueue(Lcom/android/server/GraphicsStatsService$ActiveBuffer;)V
    ...
    iget-object v1, p0, mWriteOutHandler:Landroid/os/Handler;
...
.method private deleteOldBuffers()V
    ...
    iget-object v2, p0, mFileAccessLock:Ljava/lang/Object;
    ...
    iget-object v8, p0, mGraphicsStatsDir:Ljava/io/File;
    ...
    invoke-direct {p0, v7}, deleteRecursiveLocked(Ljava/io/File;)V
...
.method private deleteRecursiveLocked(Ljava/io/File;)V
    ...
    invoke-direct {p0, v3}, deleteRecursiveLocked(Ljava/io/File;)V
...
.method private dumpActiveLocked(JLjava/util/ArrayList;)Ljava/util/HashSet;
    ...
    invoke-direct {v5, v4}, pathForApp(Lcom/android/server/GraphicsStatsService$BufferInfo;)Ljava/io/File;
    ...
    invoke-static/range {v6 .. v16}, nAddToDump(JLjava/lang/String;Ljava/lang/String;JJJ[B)V
...
.method private dumpHistoricalLocked(JLjava/util/HashSet;)V
    ...
    iget-object v1, v0, mGraphicsStatsDir:Ljava/io/File;
    ...
    invoke-static {v0, v1, v3}, nAddToDump(JLjava/lang/String;)V
...
.method private fetchActiveBuffersLocked(Landroid/view/IGraphicsStatsCallback;IILjava/lang/String;J)Lcom/android/server/GraphicsStatsService$ActiveBuffer;
    ...
    iget-object v0, v9, mActive:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v0, v1}, normalizeDate(J)Ljava/util/Calendar;
    ...
    iget-object v1, v9, mActive:Ljava/util/ArrayList;
...
.method private onAlarm()V
    ...
    :try_start_0
    iput-boolean v1, p0, mRotateIsScheduled:Z

    invoke-direct {p0}, scheduleRotateLocked()V

    iget-object v2, p0, mActive:Ljava/util/ArrayList;
    ...
    :cond_0
    iget-object v0, p0, mWriteOutHandler:Landroid/os/Handler;
...
.method private pathForApp(Lcom/android/server/GraphicsStatsService$BufferInfo;)Ljava/io/File;
    ...
    invoke-direct {p0, v1, v2}, normalizeDate(J)Ljava/util/Calendar;
    ...
    iget-object v2, p0, mGraphicsStatsDir:Ljava/io/File;
...
.method private processDied(Lcom/android/server/GraphicsStatsService$ActiveBuffer;)V
    ...
    invoke-direct {p0, p1}, addToSaveQueue(Lcom/android/server/GraphicsStatsService$ActiveBuffer;)V
...
.method private requestBufferForProcessLocked(Landroid/view/IGraphicsStatsCallback;IILjava/lang/String;J)Landroid/os/ParcelFileDescriptor;
    ...
    invoke-direct/range {p0 .. p6}, fetchActiveBuffersLocked(Landroid/view/IGraphicsStatsCallback;IILjava/lang/String;J)Lcom/android/server/GraphicsStatsService$ActiveBuffer;
...
.method private saveBuffer(Lcom/android/server/GraphicsStatsService$HistoricalBuffer;)V
    ...
    invoke-direct {p0, v3}, pathForApp(Lcom/android/server/GraphicsStatsService$BufferInfo;)Ljava/io/File;
    ...
    invoke-static/range {v5 .. v13}, nSaveBuffer(Ljava/lang/String;Ljava/lang/String;JJJ[B)V
...
.method private scheduleRotateLocked()V
    ...
    iget-boolean v0, p0, mRotateIsScheduled:Z
    ...
    iget-object v9, p0, mWriteOutHandler:Landroid/os/Handler;
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v5, p0, mActive:Ljava/util/ArrayList;
    ...
    invoke-static {v1, v0}, nCreateDump(IZ)J

    move-result-wide v1

    :try_start_3
    iget-object v4, p0, mFileAccessLock:Ljava/lang/Object;
    ...
    :try_start_4
    invoke-direct {p0, v1, v2, v3}, dumpActiveLocked(JLjava/util/ArrayList;)Ljava/util/HashSet;

    move-result-object v5

    invoke-virtual {v3}, Ljava/util/ArrayList;->clear()V

    invoke-direct {p0, v1, v2, v5}, dumpHistoricalLocked(JLjava/util/HashSet;)V

    monitor-exit v4
    :try_end_4
    .catchall {:try_start_4 .. :try_end_4} :catchall_0

    invoke-static {v1, v2}, nFinishDump(J)V
...
.method public requestBufferForProcess(Ljava/lang/String;Landroid/view/IGraphicsStatsCallback;)Landroid/os/ParcelFileDescriptor;
    ...
    iget-object v6, v8, mLock:Ljava/lang/Object;
    ...
    :try_start_2
    invoke-direct/range {v1 .. v7}, requestBufferForProcessLocked(Landroid/view/IGraphicsStatsCallback;IILjava/lang/String;J)Landroid/os/ParcelFileDescriptor;
