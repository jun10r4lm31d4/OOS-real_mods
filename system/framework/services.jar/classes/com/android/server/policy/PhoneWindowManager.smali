...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, DEBUG_INPUT:Z

    sput-boolean v0, DEBUG_KEYGUARD:Z

    sput-boolean v0, DEBUG_LAYOUT:Z

    sput-boolean v0, DEBUG_SPLASH_SCREEN:Z

    const/4 v1, 0x1

    sput-boolean v1, DEBUG_WAKEUP:Z

    sput-boolean v1, SHOW_SPLASH_SCREENS:Z
    ...
    sput-object v2, VIBRATION_ATTRIBUTES:Landroid/media/AudioAttributes;

    const/4 v2, 0x0

    sput-object v2, mSensorManager:Landroid/hardware/SensorManager;

    new-instance v2, Landroid/util/SparseArray;

    invoke-direct {v2}, Landroid/util/SparseArray;-><init>()V

    sput-object v2, sApplicationLaunchKeyCategories:Landroid/util/SparseArray;

    sget-object v2, sApplicationLaunchKeyCategories:Landroid/util/SparseArray;
    ...
    sput-object v2, POWER_LONG_PRESS_WITH_ASSISTANT_HINT:Ljava/lang/String;

    const-string/jumbo v2, "power_long_press_with_google_assistant_hint"

    sput-object v2, POWER_LONG_PRESS_WITH_GOOGLE_ASSISTANT_HINT:Ljava/lang/String;

    const-string v2, "com.heytap.speechassist"

    sput-object v2, HEY_TAP_PACKAGE_NAME:Ljava/lang/String;
    ...
    sput-boolean v2, mIsCustomFP:Z

    sput v0, AUTHENTICATE_IGNORE:I

    sput v1, AUTHENTICATE_FINGERPRINT:I

    const/4 v0, 0x2

    sput v0, AUTHENTICATE_FACEUNLOCK:I
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, mIsNotifyWakeUpToSensor:Z
    ...
    iput-object v1, p0, mServiceAquireLock:Ljava/lang/Object;

    iput-boolean v0, p0, mEnableShiftMenuBugReports:Z

    const/4 v1, 0x0

    iput-object v1, p0, mKeyguardCandidate:Lcom/android/server/policy/WindowManagerPolicy$WindowState;

    new-instance v2, Landroid/util/LongSparseArray;

    invoke-direct {v2}, Landroid/util/LongSparseArray;-><init>()V

    iput-object v2, p0, mShortcutKeyServices:Landroid/util/LongSparseArray;

    const/4 v2, 0x1

    iput-boolean v2, p0, mEnableCarDockHomeCapture:Z
    ...
    iput-object v3, p0, mWindowManagerDrawCallback:Ljava/lang/Runnable;
    ...
    iput-object v3, p0, mKeyguardDrawnCallback:Lcom/android/server/policy/keyguard/KeyguardServiceDelegate$DrawnListener;

    iput-boolean v2, p0, mNavBarVirtualKeyHapticFeedbackEnabled:Z

    const/4 v2, -0x1

    iput v2, p0, mPendingWakeKey:I

    iput v2, p0, mCameraLensCoverState:I

    iput-boolean v0, p0, mHasSoftInput:Z

    new-instance v3, Ljava/util/HashSet;

    invoke-direct {v3}, Ljava/util/HashSet;-><init>()V

    iput-object v3, p0, mAllowLockscreenWhenOnDisplays:Ljava/util/HashSet;

    iput v0, p0, mRingerToggleChord:I

    new-instance v3, Landroid/util/SparseArray;

    invoke-direct {v3}, Landroid/util/SparseArray;-><init>()V

    iput-object v3, p0, mFallbackActions:Landroid/util/SparseArray;
    ...
    iput-object v3, p0, mLogDecelerateInterpolator:Lcom/android/server/policy/LogDecelerateInterpolator;

    new-instance v3, Landroid/util/MutableBoolean;

    invoke-direct {v3, v0}, Landroid/util/MutableBoolean;-><init>(Z)V

    iput-object v3, p0, mTmpBoolean:Landroid/util/MutableBoolean;

    iput-boolean v0, p0, mPerDisplayFocusEnabled:Z

    iput v2, p0, mTopFocusedDisplayId:I

    const/16 v2, 0x320

    iput v2, p0, mPowerButtonSuppressionDelayMillis:I
    ...
    iput-object v2, p0, mHDMIObserver:Landroid/os/UEventObserver;
    ...
    iput-object v2, p0, mExtEventObserver:Landroid/os/UEventObserver;
    ...
    iput-object v2, p0, mPersistentVrModeListener:Landroid/service/vr/IPersistentVrStateCallbacks;
    ...
    iput-object v2, p0, mPossibleVeryLongPressReboot:Ljava/lang/Runnable;
    ...
    iput-object v2, p0, mEndCallLongPress:Ljava/lang/Runnable;
    ...
    iput-object v2, p0, mScreenshotRunnable:Lcom/android/server/policy/PhoneWindowManager$ScreenshotRunnable;

    new-instance v2, Landroid/util/SparseArray;

    invoke-direct {v2}, Landroid/util/SparseArray;-><init>()V

    iput-object v2, p0, mDisplayHomeButtonHandlers:Landroid/util/SparseArray;

    iput-boolean v0, p0, mPreShowSurface:Z

    iput-boolean v0, p0, mPreShowed:Z

    iput-boolean v0, p0, mIsFingerprintEnabled:Z
    ...
    iput-object v0, p0, mNotifyWakeUptoSensorHandle:Landroid/os/Handler;

    iput-object v1, p0, mBootMsgDialog:Landroid/app/ProgressDialog;
    ...
    iput-object v0, p0, mZenModeCallback:Lcom/oneplus/android/server/zenmode/ZenModeInjector$Callback;
...
.method static synthetic access$1000(Lcom/android/server/policy/PhoneWindowManager;)V
    ...
    invoke-direct {p0}, accessibilityShortcutActivated()V
...
.method static synthetic access$1100(Lcom/android/server/policy/PhoneWindowManager;)V
    ...
    invoke-direct {p0}, requestFullBugreport()V
...
.method static synthetic access$1200(Lcom/android/server/policy/PhoneWindowManager;)Lcom/android/internal/accessibility/AccessibilityShortcutController;
    ...
    iget-object v0, p0, mAccessibilityShortcutController:Lcom/android/internal/accessibility/AccessibilityShortcutController;
...
.method static synthetic access$1300(Lcom/android/server/policy/PhoneWindowManager;)Z
    ...
    iget-boolean v0, p0, mPreShowSurface:Z
...
.method static synthetic access$1400(Lcom/android/server/policy/PhoneWindowManager;ZII)V
    ...
    invoke-direct {p0, p1, p2, p3}, handleAuthStateChange(ZII)V
...
.method static synthetic access$1600(Lcom/android/server/policy/PhoneWindowManager;I)V
    ...
    invoke-direct {p0, p1}, sendSystemKeyToStatusBar(I)V
...
.method static synthetic access$1700(Lcom/android/server/policy/PhoneWindowManager;)V
    ...
    invoke-direct {p0}, launchAllAppsAction()V
...
.method static synthetic access$1800(Lcom/android/server/policy/PhoneWindowManager;)V
    ...
    invoke-direct {p0}, handleRingerChordGesture()V
...
.method static synthetic access$1902(Lcom/android/server/policy/PhoneWindowManager;Z)Z
    ...
    iput-boolean p1, p0, mMovingDisplayToTopKeyTriggered:Z
...
.method static synthetic access$2300(Lcom/android/server/policy/PhoneWindowManager;JZILjava/lang/String;)Z
    ...
    invoke-direct/range {p0 .. p5}, wakeUp(JZILjava/lang/String;)Z
...
.method static synthetic access$2700(Lcom/android/server/policy/PhoneWindowManager;)V
    ...
    invoke-direct {p0}, cancelPreloadRecentApps()V
...
.method static synthetic access$2900(Lcom/android/server/policy/PhoneWindowManager;)V
    ...
    invoke-direct {p0}, preloadRecentApps()V
...
.method static synthetic access$3200(Lcom/android/server/policy/PhoneWindowManager;IJ)I
    ...
    invoke-direct {p0, p1, p2, p3}, handleStartTransitionForKeyguardLw(IJ)I
...
.method static synthetic access$3500()Landroid/hardware/SensorManager;
    ...
    sget-object v0, mSensorManager:Landroid/hardware/SensorManager;
...
.method static synthetic access$3502(Landroid/hardware/SensorManager;)Landroid/hardware/SensorManager;
    ...
    sput-object p0, mSensorManager:Landroid/hardware/SensorManager;
...
.method static synthetic access$400(Lcom/android/server/policy/PhoneWindowManager;)V
    ...
    invoke-direct {p0}, launchAssistLongPressAction()V
...
.method static synthetic access$700(Lcom/android/server/policy/PhoneWindowManager;)V
    ...
    invoke-direct {p0}, powerVeryLongPress()V
...
.method static synthetic access$800(Lcom/android/server/policy/PhoneWindowManager;)V
    ...
    invoke-direct {p0}, showPictureInPictureMenuInternal()V
...
.method static synthetic access$900(Lcom/android/server/policy/PhoneWindowManager;)V
    ...
    invoke-direct {p0}, backLongPress()V
...
.method private applyLidSwitchState()V
    ...
    iget-object v0, p0, mDefaultDisplayPolicy:Lcom/android/server/wm/DisplayPolicy;

    invoke-virtual {v0}, Lcom/android/server/wm/DisplayPolicy;->getLidState()I

    move-result v0

    iget-boolean v1, p0, mLidControlsDisplayFold:Z

    const/4 v2, 0x1

    if-eqz v1, :cond_1

    iget-object v1, p0, mDisplayFoldController:Lcom/android/server/policy/DisplayFoldController;
    ...
    invoke-direct {p0}, getLidBehavior()I
    ...
    :cond_2
    iget-object v2, p0, mWindowManagerFuncs:Lcom/android/server/policy/WindowManagerPolicy$WindowManagerFuncs;
    ...
    invoke-direct {p0, v3, v4, v5, v2}, goToSleep(JII)V
...
.method private backLongPress()V
    ...
    iput-boolean v0, p0, mBackKeyHandled:Z

    iget v1, p0, mLongPressOnBackBehavior:I
    ...
    invoke-direct {p0, v0}, launchVoiceAssist(Z)V
...
.method private bindKeyguard()V
    ...
    iget-boolean v3, p0, mKeyguardBound:Z
    ...
    iget-boolean v1, p0, mKeyguardBound:Z
    ...
    iput-boolean v1, p0, mKeyguardBound:Z
...
.method private cancelPendingBackKeyAction()V
    ...
    iget-boolean v0, p0, mBackKeyHandled:Z
...
.method private cancelPendingScreenshotChordAction()V
    ...
    iget-object v1, p0, mScreenshotRunnable:Lcom/android/server/policy/PhoneWindowManager$ScreenshotRunnable;
...
.method private cancelPossibleVeryLongPressReboot()V
    ...
    iget-object v1, p0, mPossibleVeryLongPressReboot:Ljava/lang/Runnable;
...
.method private cancelPreloadRecentApps()V
    ...
    iget-boolean v0, p0, mPreloadedRecentApps:Z

    if-eqz v0, :cond_0

    const/4 v0, 0x0

    iput-boolean v0, p0, mPreloadedRecentApps:Z

    invoke-virtual {p0}, getStatusBarManagerInternal()Lcom/android/server/statusbar/StatusBarManagerInternal;
...
.method private dispatchDirectAudioEvent(Landroid/view/KeyEvent;)V
    ...
    invoke-direct {p0}, getHdmiControlManager()Landroid/hardware/hdmi/HdmiControlManager;
    ...
    invoke-direct {p0}, shouldCecAudioDeviceForwardVolumeKeysSystemAudioModeOff()Z
...
.method private finishScreenTurningOn()V
    ...
    :cond_0
    iget-object v0, p0, mDefaultDisplayRotation:Lcom/android/server/wm/DisplayRotation;
    ...
    iget-object v1, p0, mDefaultDisplayPolicy:Lcom/android/server/wm/DisplayPolicy;
    ...
    :try_start_0
    iget-boolean v3, p0, mKeyguardDrawnOnce:Z
    ...
    iput-boolean v3, p0, mKeyguardDrawnOnce:Z

    const/4 v3, 0x1

    iget-boolean v5, p0, mBootMessageNeedsHiding:Z

    if-eqz v5, :cond_3

    iput-boolean v4, p0, mBootMessageNeedsHiding:Z
...
.method private getHdmiControl()Lcom/android/server/policy/PhoneWindowManager$HdmiControl;
    ...
    iget-object v0, p0, mHdmiControl:Lcom/android/server/policy/PhoneWindowManager$HdmiControl;

    if-nez v0, :cond_2

    iget-boolean v0, p0, mHasFeatureHdmiCec:Z
    ...
    iput-object v3, p0, mHdmiControl:Lcom/android/server/policy/PhoneWindowManager$HdmiControl;
...
.method private goToSleep(JII)V
    ...
    iput-boolean v0, p0, mRequestedOrGoingToSleep:Z
...
.method private goToSleepFromPowerButton(JI)Z
    ...
    iget v5, p0, mPowerButtonSuppressionDelayMillis:I

    if-lez v5, :cond_0

    iget-wide v5, v0, Landroid/os/PowerManager$WakeData;->wakeTime:J

    iget v7, p0, mPowerButtonSuppressionDelayMillis:I
    ...
    :cond_0
    invoke-direct {p0, p1, p2, v1, p3}, goToSleep(JII)V
...
.method private handleAuthStateChange(ZII)V
    ...
    iput-object v0, p0, mTopFocusedActivityWindow:Lcom/android/server/policy/WindowManagerPolicy$WindowState;

    sget-boolean v0, mIsCustomFP:Z
    ...
    :cond_0
    iput-boolean v2, p0, mPreShowSurface:Z

    iget-object v0, p0, mWindowManagerFuncs:Lcom/android/server/policy/WindowManagerPolicy$WindowManagerFuncs;
    ...
    :try_start_0
    iget-object v1, p0, mTopFocusedActivityWindow:Lcom/android/server/policy/WindowManagerPolicy$WindowState;

    if-eqz v1, :cond_2

    iget-object v1, p0, mTopFocusedActivityWindow:Lcom/android/server/policy/WindowManagerPolicy$WindowState;

    invoke-virtual {p0, v1}, canBeHiddenByKeyguardLw(Lcom/android/server/policy/WindowManagerPolicy$WindowState;)Z

    move-result v1

    if-nez v1, :cond_2

    sget-boolean v1, DEBUG_ONEPLUS:Z
    ...
    iget-object v5, p0, mTopFocusedActivityWindow:Lcom/android/server/policy/WindowManagerPolicy$WindowState;
    ...
    iput-boolean v2, p0, mPreShowed:Z
    ...
    sget v0, AUTHENTICATE_FACEUNLOCK:I
    ...
    :try_start_1
    iget-object v2, p0, mTopFocusedActivityWindow:Lcom/android/server/policy/WindowManagerPolicy$WindowState;

    if-eqz v2, :cond_5

    iget-object v2, p0, mTopFocusedActivityWindow:Lcom/android/server/policy/WindowManagerPolicy$WindowState;

    invoke-virtual {p0, v2}, canBeHiddenByKeyguardLw(Lcom/android/server/policy/WindowManagerPolicy$WindowState;)Z
    ...
    sget v0, AUTHENTICATE_FINGERPRINT:I
    ...
    :cond_9
    sget v0, AUTHENTICATE_IGNORE:I

    if-eq p2, v0, :cond_c

    iput-boolean v3, p0, mPreShowSurface:Z

    iget-object v0, p0, mTopFocusedActivityWindow:Lcom/android/server/policy/WindowManagerPolicy$WindowState;

    if-eqz v0, :cond_c

    invoke-virtual {p0}, isKeyguardOccluded()Z
    ...
    iget-boolean v5, p0, mPreShowed:Z
    ...
    :cond_a
    iget-boolean v2, p0, mPreShowed:Z
    ...
    :cond_c
    :goto_0
    iput-boolean v3, p0, mPreShowed:Z
...
.method private handleHideBootMessage()V
    ...
    :try_start_0
    iget-boolean v1, p0, mKeyguardDrawnOnce:Z

    if-nez v1, :cond_0

    const/4 v1, 0x1

    iput-boolean v1, p0, mBootMessageNeedsHiding:Z
...
.method private handleRingerChordGesture()V
    ...
    iget v0, p0, mRingerToggleChord:I
    ...
    :cond_0
    invoke-virtual {p0}, getAudioManagerInternal()Landroid/media/AudioManagerInternal;
    ...
    iget-object v0, p0, mLogger:Lcom/android/internal/logging/MetricsLogger;

    const/16 v1, 0x5a0

    iget v2, p0, mRingerToggleChord:I
...
.method private handleStartTransitionForKeyguardLw(IJ)I
    ...
    iget-boolean v0, p0, mKeyguardOccludedChanged:Z
    ...
    iget-boolean v3, p0, mPendingKeyguardOccluded:Z
    ...
    :cond_0
    iput-boolean v2, p0, mKeyguardOccludedChanged:Z

    iget-boolean v0, p0, mPendingKeyguardOccluded:Z

    invoke-direct {p0, v0, v2}, setKeyguardOccludedLw(ZZ)Z
    ...
    invoke-virtual {p0, v0, v1, p2, p3}, startKeyguardExitAnimation(JJ)V
...
.method private hasLongPressOnBackBehavior()Z
    ...
    iget v0, p0, mLongPressOnBackBehavior:I
...
.method private hasVeryLongPressOnPowerBehavior()Z
    ...
    iget v0, p0, mVeryLongPressOnPowerBehavior:I
...
.method private interceptAccessibilityGestureTv(IZ)Z
    ...
    iput-boolean p2, p0, mAccessibilityTvKey1Pressed:Z
    ...
    iput-boolean p2, p0, mAccessibilityTvKey2Pressed:Z

    :cond_1
    :goto_0
    iget-boolean v0, p0, mAccessibilityTvKey1Pressed:Z

    const/16 v1, 0x13

    if-eqz v0, :cond_2

    iget-boolean v0, p0, mAccessibilityTvKey2Pressed:Z

    if-eqz v0, :cond_2

    iget-boolean v0, p0, mAccessibilityTvScheduled:Z

    if-nez v0, :cond_3

    const/4 v0, 0x1

    iput-boolean v0, p0, mAccessibilityTvScheduled:Z
    ...
    invoke-direct {p0}, getAccessibilityShortcutTimeout()J
...
.method private interceptAccessibilityShortcutChord()V
    ...
    iget-boolean v0, p0, mScreenshotChordVolumeDownKeyTriggered:Z

    if-eqz v0, :cond_0

    iget-boolean v0, p0, mA11yShortcutChordVolumeUpKeyTriggered:Z

    if-eqz v0, :cond_0

    iget-boolean v0, p0, mScreenshotChordPowerKeyTriggered:Z
    ...
    iget-wide v2, p0, mA11yShortcutChordVolumeUpKeyTime:J
    ...
    iput-boolean v2, p0, mA11yShortcutChordVolumeUpKeyConsumed:Z
...
.method private interceptBackKeyDown()V
    ...
    invoke-direct {p0}, hasLongPressOnBackBehavior()Z
...
.method private interceptBackKeyUp(Landroid/view/KeyEvent;)Z
    ...
    invoke-direct {p0}, cancelPendingBackKeyAction()V

    iget-boolean v2, p0, mHasFeatureWatch:Z
    ...
    :cond_0
    iget v3, p0, mIncallBackBehavior:I
    ...
    :cond_1
    iget-object v1, p0, mAutofillManagerInternal:Landroid/view/autofill/AutofillManagerInternal;
...
.method private interceptBugreportGestureTv(IZ)Z
    ...
    iput-boolean p2, p0, mBugreportTvKey1Pressed:Z
    ...
    iput-boolean p2, p0, mBugreportTvKey2Pressed:Z

    :cond_1
    :goto_0
    iget-boolean v0, p0, mBugreportTvKey1Pressed:Z

    const/16 v1, 0x12

    if-eqz v0, :cond_2

    iget-boolean v0, p0, mBugreportTvKey2Pressed:Z

    if-eqz v0, :cond_2

    iget-boolean v0, p0, mBugreportTvScheduled:Z

    if-nez v0, :cond_3

    const/4 v0, 0x1

    iput-boolean v0, p0, mBugreportTvScheduled:Z
...
.method private interceptFallback(Lcom/android/server/policy/WindowManagerPolicy$WindowState;Landroid/view/KeyEvent;I)Z
    ...
    invoke-virtual {p0, p1, p2, p3}, interceptKeyBeforeDispatching(Lcom/android/server/policy/WindowManagerPolicy$WindowState;Landroid/view/KeyEvent;I)J
...
.method private interceptKeyBeforeDispatchingInner(Lcom/android/server/policy/WindowManagerPolicy$WindowState;Landroid/view/KeyEvent;I)J
    ...
    :cond_4
    iget-boolean v8, v1, mScreenshotChordEnabled:Z
    ...
    iget-boolean v8, v1, mScreenshotChordVolumeDownKeyTriggered:Z

    if-eqz v8, :cond_5

    iget-boolean v8, v1, mScreenshotChordPowerKeyTriggered:Z
    ...
    iget-wide v9, v1, mScreenshotChordVolumeDownKeyTime:J
    ...
    iget-boolean v9, v1, mScreenshotChordVolumeDownKeyConsumed:Z
    ...
    iput-boolean v9, v1, mScreenshotChordVolumeDownKeyConsumed:Z
    ...
    iget-object v9, v1, mAccessibilityShortcutController:Lcom/android/internal/accessibility/AccessibilityShortcutController;
    ...
    iget-boolean v9, v1, mScreenshotChordVolumeDownKeyTriggered:Z

    iget-boolean v10, v1, mA11yShortcutChordVolumeUpKeyTriggered:Z
    ...
    iget-boolean v0, v1, mScreenshotChordVolumeDownKeyTriggered:Z

    if-eqz v0, :cond_b

    iget-wide v14, v1, mScreenshotChordVolumeDownKeyTime:J

    goto :goto_1

    :cond_b
    iget-wide v14, v1, mA11yShortcutChordVolumeUpKeyTime:J
    ...
    iget-boolean v9, v1, mA11yShortcutChordVolumeUpKeyConsumed:Z
    ...
    iput-boolean v9, v1, mA11yShortcutChordVolumeUpKeyConsumed:Z
    ...
    :cond_10
    iget v9, v1, mRingerToggleChord:I
    ...
    iget-boolean v9, v1, mA11yShortcutChordVolumeUpKeyTriggered:Z

    if-eqz v9, :cond_11

    iget-boolean v9, v1, mScreenshotChordPowerKeyTriggered:Z
    ...
    :cond_13
    iget-boolean v9, v1, mPendingMetaAction:Z
    ...
    iput-boolean v9, v1, mPendingMetaAction:Z

    :cond_14
    iget-boolean v9, v1, mPendingCapsLockToggle:Z
    ...
    iput-boolean v9, v1, mPendingCapsLockToggle:Z
    ...
    iget-object v0, v1, mDisplayHomeButtonHandlers:Landroid/util/SparseArray;
    ...
    iget-object v9, v1, mDisplayHomeButtonHandlers:Landroid/util/SparseArray;
    ...
    iget-boolean v10, v1, mEnableShiftMenuBugReports:Z
    ...
    iput-boolean v10, v1, mSearchKeyShortcutPending:Z

    const/4 v10, 0x0

    iput-boolean v10, v1, mConsumeSearchKeyUp:Z
    ...
    iget-boolean v0, v1, mConsumeSearchKeyUp:Z
    ...
    iget-object v10, v1, mScreenshotRunnable:Lcom/android/server/policy/PhoneWindowManager$ScreenshotRunnable;

    invoke-virtual {v10, v0}, Lcom/android/server/policy/PhoneWindowManager$ScreenshotRunnable;->setScreenshotType(I)V

    iget-object v10, v1, mHandler:Landroid/os/Handler;

    iget-object v13, v1, mScreenshotRunnable:Lcom/android/server/policy/PhoneWindowManager$ScreenshotRunnable;
    ...
    invoke-direct {v1, v0}, toggleKeyboardShortcutsMenu(I)V
    ...
    iget-object v0, v1, mScreenshotRunnable:Lcom/android/server/policy/PhoneWindowManager$ScreenshotRunnable;
    ...
    :cond_2b
    iget-boolean v0, v1, mHasFeatureLeanback:Z

    if-eqz v0, :cond_2c

    invoke-direct {v1, v4, v8}, interceptBugreportGestureTv(IZ)Z
    ...
    :cond_2e
    :goto_6
    iget-boolean v0, v1, mUseTvRouting:Z

    if-nez v0, :cond_50

    iget-boolean v0, v1, mHandleVolumeKeysInWM:Z
    ...
    :cond_2f
    iget-object v0, v1, mDefaultDisplayPolicy:Lcom/android/server/wm/DisplayPolicy;
    ...
    iget-boolean v10, v1, mPendingCapsLockToggle:Z

    if-nez v10, :cond_31

    iget v10, v1, mMetaState:I

    iput v10, v1, mInitialMetaState:I

    const/4 v10, 0x1

    iput-boolean v10, v1, mPendingCapsLockToggle:Z
    ...
    iget v15, v1, mInitialMetaState:I
    ...
    iget-object v10, v1, mInputManagerInternal:Landroid/hardware/input/InputManagerInternal;
    ...
    iput-boolean v13, v1, mPendingMetaAction:Z

    goto :goto_a

    :cond_35
    iget-boolean v0, v1, mPendingMetaAction:Z
    ...
    invoke-virtual {v1, v13, v0}, launchAssistAction(Ljava/lang/String;I)V
    ...
    :cond_37
    iget-boolean v0, v1, mSearchKeyShortcutPending:Z
    ...
    iput-boolean v14, v1, mConsumeSearchKeyUp:Z

    const/4 v14, 0x0

    iput-boolean v14, v1, mSearchKeyShortcutPending:Z
    ...
    iget-object v14, v1, mShortcutManager:Lcom/android/server/policy/ShortcutManager;
    ...
    invoke-virtual {v1, v14, v0}, startActivityAsUser(Landroid/content/Intent;Landroid/os/UserHandle;)V

    invoke-direct/range {p0 .. p0}, dismissKeyboardShortcutsMenu()V
    :try_end_1
    ...
    sget-object v9, sApplicationLaunchKeyCategories:Landroid/util/SparseArray;
    ...
    invoke-virtual {v1, v7, v0}, startActivityAsUser(Landroid/content/Intent;Landroid/os/UserHandle;)V
    ...
    iget v0, v1, mRecentAppsHeldModifiers:I
    ...
    invoke-direct {v1, v7}, showRecentApps(Z)V
    ...
    iput v9, v1, mRecentAppsHeldModifiers:I

    const/4 v13, 0x1

    invoke-direct {v1, v13, v9}, hideRecentApps(ZZ)V
    ...
    :goto_11
    iget-object v7, v1, mWindowManagerFuncs:Lcom/android/server/policy/WindowManagerPolicy$WindowManagerFuncs;
    ...
    :cond_44
    iget-boolean v13, v1, mLanguageSwitchKeyPressed:Z
    ...
    iput-boolean v7, v1, mLanguageSwitchKeyPressed:Z
    ...
    :cond_46
    invoke-static {v4}, isValidGlobalKey(I)Z

    move-result v0

    if-eqz v0, :cond_47

    iget-object v0, v1, mGlobalKeyManager:Lcom/android/server/policy/GlobalKeyManager;
    ...
    :cond_4b
    iget-object v0, v1, mShortcutKeyServices:Landroid/util/LongSparseArray;
    ...
    iget-object v7, v1, mShortcutKeyServices:Landroid/util/LongSparseArray;
    ...
    :goto_14
    invoke-direct {v1, v2}, dispatchDirectAudioEvent(Landroid/view/KeyEvent;)V
    ...
    :cond_53
    iget-object v10, v1, mPowerManager:Landroid/os/PowerManager;

    invoke-virtual {v10}, Landroid/os/PowerManager;->getMinimumScreenBrightnessSetting()I

    move-result v10

    iget-object v13, v1, mPowerManager:Landroid/os/PowerManager;
    ...
    iget-object v15, v1, mContext:Landroid/content/Context;

    invoke-virtual {v15}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v15

    iget-object v9, v1, mPowerManager:Landroid/os/PowerManager;
    ...
    iget-object v9, v1, mContext:Landroid/content/Context;
    ...
    invoke-virtual {v1, v2, v9}, startActivityAsUser(Landroid/content/Intent;Landroid/os/UserHandle;)V
...
.method private interceptPowerKeyDown(Landroid/view/KeyEvent;Z)V
    ...
    :cond_0
    iget v0, p0, mPowerKeyPressCounter:I
    ...
    iget-boolean v1, p0, mScreenshotChordPowerKeyTriggered:Z
    ...
    iput-boolean v0, p0, mScreenshotChordPowerKeyTriggered:Z

    invoke-virtual {p1}, Landroid/view/KeyEvent;->getDownTime()J

    move-result-wide v1

    iput-wide v1, p0, mScreenshotChordPowerKeyTime:J

    invoke-direct {p0}, interceptScreenshotChord()V

    invoke-direct {p0}, interceptRingerToggleChord()V
    ...
    :cond_3
    iget v3, p0, mIncallPowerBehavior:I
    ...
    iget-object v5, p0, mTmpBoolean:Landroid/util/MutableBoolean;
    ...
    iget-boolean v5, p0, mRequestedOrGoingToSleep:Z

    if-eqz v5, :cond_5

    iput-boolean v0, p0, mCameraGestureTriggeredDuringGoingToSleep:Z
    ...
    invoke-direct {p0, v5}, sendSystemKeyToStatusBarAsync(I)V

    invoke-direct {p0}, schedulePossibleVeryLongPressReboot()V

    if-nez v2, :cond_7

    iget-boolean v5, p0, mScreenshotChordVolumeDownKeyTriggered:Z

    if-nez v5, :cond_7

    iget-boolean v5, p0, mA11yShortcutChordVolumeUpKeyTriggered:Z
    ...
    :goto_2
    iput-boolean v5, p0, mPowerKeyHandled:Z
    ...
    iget-boolean v7, p0, mScreenshotChordVolumeDownKeyTriggered:Z
    ...
    iget-boolean v7, p0, mA11yShortcutChordVolumeUpKeyTriggered:Z
    ...
    :cond_8
    iget-boolean v5, p0, mPowerKeyHandled:Z
    ...
    invoke-direct {p0}, hasLongPressOnPowerBehavior()Z
    ...
    invoke-virtual {p0}, powerLongPress()V
    ...
    invoke-direct {p0}, hasVeryLongPressOnPowerBehavior()Z
    ...
    iget v7, p0, mVeryLongPressTimeout:I
    ...
    invoke-direct {p0, v8, v9}, wakeUpFromPowerKey(J)V

    iget-boolean v8, p0, mSupportLongPressPowerWhenNonInteractive:Z
    ...
    iget v8, p0, mVeryLongPressTimeout:I
    ...
    sget-boolean v7, DEBUG_ONEPLUS:Z
...
.method private interceptPowerKeyUp(Landroid/view/KeyEvent;ZZ)V
    ...
    iget-boolean v2, p0, mPowerKeyHandled:Z
    ...
    invoke-virtual {p0}, cancelPendingPowerKeyAction()V
    ...
    iget-object v3, p0, mWindowManagerFuncs:Lcom/android/server/policy/WindowManagerPolicy$WindowManagerFuncs;
    ...
    :cond_3
    iget v1, p0, mPowerKeyPressCounter:I

    invoke-direct {p0, v3, v4, p2, v1}, powerPress(JZI)V
...
.method private interceptRingerToggleChord()V
    ...
    invoke-direct {p0}, getRingerToggleChordDelay()J
...
.method private interceptScreenshotChord()V
    ...
    iget-boolean v0, p0, mScreenshotChordEnabled:Z
    ...
    iget-object v3, p0, mScreenshotRunnable:Lcom/android/server/policy/PhoneWindowManager$ScreenshotRunnable;
...
.method private interceptSystemNavigationKey(Landroid/view/KeyEvent;)V
    ...
    :cond_0
    iget-boolean v0, p0, mSystemNavigationKeysEnabled:Z
    ...
    invoke-direct {p0, v0}, sendSystemKeyToStatusBarAsync(I)V
...
.method private launchAllAppsAction()V
    ...
    iget-boolean v1, p0, mHasFeatureLeanback:Z
    ...
    invoke-virtual {p0, v0, v1}, startActivityAsUser(Landroid/content/Intent;Landroid/os/UserHandle;)V
...
.method private launchAssistLongPressAction()V
    ...
    invoke-virtual {p0, v0, v2}, startActivityAsUser(Landroid/content/Intent;Landroid/os/UserHandle;)V
    :try_end_0
...
.method private launchVoiceAssist(Z)V
    ...
    invoke-direct {p0, v1, v2, v3, p1}, startActivityAsUser(Landroid/content/Intent;Landroid/os/Bundle;Landroid/os/UserHandle;Z)V
...
.method private powerMultiPressAction(JZI)V
    ...
    invoke-direct {p0, p1, p2, v0, v3}, goToSleep(JII)V
...
.method private powerPress(JZI)V
    ...
    iget-boolean v2, p0, mBeganFromNonInteractive:Z
    ...
    iget v2, p0, mShortPressOnPowerBehavior:I
    ...
    :cond_3
    iget-boolean v0, p0, mDismissImeOnBackKeyPressed:Z
    ...
    :cond_5
    invoke-direct {p0}, shortPressPowerGoHome()V
    ...
    :cond_7
    invoke-direct {p0, p1, p2, v4}, goToSleepFromPowerButton(JI)Z

    move-result v0

    if-eqz v0, :cond_a

    invoke-virtual {p0, v3}, launchHomeFromHotKey(I)V
    ...
    :cond_9
    invoke-direct {p0, p1, p2, v3}, goToSleepFromPowerButton(JI)Z
...
.method private powerVeryLongPress()V
    ...
    iget v1, p0, mVeryLongPressOnPowerBehavior:I
    ...
    :cond_1
    iput-boolean v1, p0, mPowerKeyHandled:Z

    const/4 v0, 0x0

    const-string v1, "Power - Very Long Press - Show Global Actions"

    invoke-virtual {p0, v0, v0, v1}, performHapticFeedback(IZLjava/lang/String;)Z
...
.method private readConfigurationDependentBehaviors()V
    ...
    iput v1, p0, mLongPressOnHomeBehavior:I
    ...
    iput v1, p0, mDoubleTapOnHomeBehavior:I
    ...
    :cond_3
    iput v2, p0, mShortPressOnWindowBehavior:I
    ...
    iput v3, p0, mShortPressOnWindowBehavior:I
...
.method private reportScreenStateToVrManager(Z)V
    ...
    iget-object v0, p0, mVrManagerInternal:Lcom/android/server/vr/VrManagerInternal;
...
.method private schedulePossibleVeryLongPressReboot()V
    ...
    iget v2, p0, mVeryLongPressTimeout:I
...
.method private setKeyguardOccludedLw(ZZ)Z
    ...
    iput-boolean v3, p0, mKeyguardOccluded:Z
    ...
    iget-object v3, p0, mKeyguardCandidate:Lcom/android/server/policy/WindowManagerPolicy$WindowState;
    ...
    iput-boolean v2, p0, mKeyguardOccluded:Z
    ...
    iput-boolean p1, p0, mKeyguardOccluded:Z
...
.method private shortPressPowerGoHome()V
    ...
    invoke-virtual {p0, v0, v1, v0}, launchHomeFromHotKey(IZZ)V
...
.method private shouldBeHiddenByKeyguard(Lcom/android/server/policy/WindowManagerPolicy$WindowState;Lcom/android/server/policy/WindowManagerPolicy$WindowState;)Z
    ...
    iget-boolean v0, p0, mIsFingerprintEnabled:Z
    ...
    iget-object v1, p0, mWindowManagerInternal:Lcom/android/server/wm/WindowManagerInternal;
    ...
    iget-boolean v2, p0, mAodShowing:Z

    if-nez v2, :cond_5

    iget-object v2, p0, mDefaultDisplayPolicy:Lcom/android/server/wm/DisplayPolicy;
    ...
    invoke-virtual {p0, p2}, canBeHiddenByKeyguardLw(Lcom/android/server/policy/WindowManagerPolicy$WindowState;)Z
...
.method private shouldDispatchInputWhenNonInteractive(II)Z
    ...
    iget-object v3, p0, mDefaultDisplay:Landroid/view/Display;
    ...
    iget-boolean v5, p0, mHasFeatureWatch:Z
...
.method private sleepPress()V
    ...
    invoke-virtual {p0, v0, v0, v1}, launchHomeFromHotKey(IZZ)V
...
.method private sleepRelease(J)V
    ...
    invoke-direct {p0, p1, p2, v0, v1}, goToSleep(JII)V
...
.method private startActivityAsUser(Landroid/content/Intent;Landroid/os/Bundle;Landroid/os/UserHandle;)V
    ...
    invoke-direct {p0, p1, p2, p3, v0}, startActivityAsUser(Landroid/content/Intent;Landroid/os/Bundle;Landroid/os/UserHandle;Z)V
...
.method private updateLockScreenTimeout()V
    ...
    :try_start_0
    iget-object v1, p0, mAllowLockscreenWhenOnDisplays:Ljava/util/HashSet;
    ...
    :goto_0
    iget-boolean v2, p0, mLockScreenTimerActive:Z

    if-eq v2, v1, :cond_4

    if-eqz v1, :cond_2

    sget-boolean v2, localLOGV:Z
    ...
    :goto_1
    iput-boolean v1, p0, mLockScreenTimerActive:Z
...
.method private updateScreenOffSleepToken(Z)V
    ...
    iget-object v0, p0, mScreenOffSleepToken:Lcom/android/server/wm/ActivityTaskManagerInternal$SleepToken;

    if-nez v0, :cond_1

    iget-object v0, p0, mActivityTaskManagerInternal:Lcom/android/server/wm/ActivityTaskManagerInternal;
    ...
    iput-object v0, p0, mScreenOffSleepToken:Lcom/android/server/wm/ActivityTaskManagerInternal$SleepToken;
...
.method private wakeUpFromPowerKey(J)V
    ...
    iget-boolean v3, p0, mAllowTheaterModeWakeFromPowerKey:Z
    ...
    invoke-direct/range {v0 .. v5}, wakeUp(JZILjava/lang/String;)Z

    iget-boolean v0, p0, mIsNotifyWakeUpToSensor:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, mNotifyWakeUptoSensorHandle:Landroid/os/Handler;
...
.method public addSplashScreen(Landroid/os/IBinder;Ljava/lang/String;ILandroid/content/res/CompatibilityInfo;Ljava/lang/CharSequence;IIIILandroid/content/res/Configuration;I)Lcom/android/server/policy/WindowManagerPolicy$StartingSurface;
    ...
    sget-boolean v0, SHOW_SPLASH_SCREENS:Z
    ...
    sget-boolean v12, DEBUG_SPLASH_SCREEN:Z
    :try_end_0
    ...
    :try_start_1
    sget-boolean v12, DEBUG_ONEPLUS:Z
    :try_end_1
    ...
    :cond_3
    invoke-direct {v1, v0, v8}, getDisplayContext(Landroid/content/Context;I)Landroid/content/Context;
    ...
    sget-boolean v15, DEBUG_SPLASH_SCREEN:Z
    :try_end_5
    ...
    sget-boolean v4, DEBUG_SPLASH_SCREEN:Z
    ...
    iget-object v0, v1, mWindowManagerFuncs:Lcom/android/server/policy/WindowManagerPolicy$WindowManagerFuncs;
    ...
    :try_start_9
    iget-boolean v0, v1, mKeyguardOccluded:Z
    :try_end_9
    ...
    invoke-direct {v1, v4, v13}, addSplashscreenContent(Lcom/android/internal/policy/PhoneWindow;Landroid/content/Context;)V
    ...
    sget-boolean v7, DEBUG_SPLASH_SCREEN:Z
...
.method public applyKeyguardPolicyLw(Lcom/android/server/policy/WindowManagerPolicy$WindowState;Lcom/android/server/policy/WindowManagerPolicy$WindowState;)V
    ...
    invoke-virtual {p0, p1}, canBeHiddenByKeyguardLw(Lcom/android/server/policy/WindowManagerPolicy$WindowState;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-direct {p0, p1, p2}, shouldBeHiddenByKeyguard(Lcom/android/server/policy/WindowManagerPolicy$WindowState;Lcom/android/server/policy/WindowManagerPolicy$WindowState;)Z
...
.method public canBeHiddenByKeyguardLw(Lcom/android/server/policy/WindowManagerPolicy$WindowState;)Z
    ...
    invoke-virtual {p0, v0}, isKeyguardSecure(I)Z
    ...
    invoke-virtual {p0, p1}, getWindowLayerLw(Lcom/android/server/policy/WindowManagerPolicy$WindowState;)I

    move-result v0

    invoke-virtual {p0, v2}, getWindowLayerFromTypeLw(I)I
...
.method cancelPendingPowerKeyAction()V
    ...
    :cond_1
    invoke-direct {p0}, cancelPossibleVeryLongPressReboot()V
...
.method public checkAddPermission(Landroid/view/WindowManager$LayoutParams;[I)I
    ...
    :cond_b
    iget-object v4, p0, mAppOpsManager:Landroid/app/AppOpsManager;
...
.method createHomeDockIntent()Landroid/content/Intent;
    ...
    iget v1, p0, mUiMode:I

    const/4 v2, 0x3

    if-ne v1, v2, :cond_0

    iget-boolean v1, p0, mEnableCarDockHomeCapture:Z
    ...
    iget-object v0, p0, mVrHeadsetHomeIntent:Landroid/content/Intent;
...
.method dispatchMediaKeyRepeatWithWakeLock(Landroid/view/KeyEvent;)V
    ...
    iput-boolean v0, p0, mHavePendingMediaKeyRepeatWithWakeLock:Z
...
.method dispatchMediaKeyWithWakeLock(Landroid/view/KeyEvent;)V
    ...
    :cond_0
    iget-boolean v0, p0, mHavePendingMediaKeyRepeatWithWakeLock:Z
    ...
    iget-object v0, p0, mBroadcastWakeLock:Landroid/os/PowerManager$WakeLock;
...
.method public dispatchUnhandledKey(Lcom/android/server/policy/WindowManagerPolicy$WindowState;Landroid/view/KeyEvent;I)Landroid/view/KeyEvent;
    ...
    :cond_2
    iget-object v10, v0, mFallbackActions:Landroid/util/SparseArray;
    ...
    sget-boolean v11, DEBUG_INPUT:Z
    ...
    invoke-direct {v0, v1, v3, v2}, interceptFallback(Lcom/android/server/policy/WindowManagerPolicy$WindowState;Landroid/view/KeyEvent;I)Z
    ...
    iget-object v9, v0, mFallbackActions:Landroid/util/SparseArray;
...
.method public dump(Ljava/lang/String;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-boolean v0, p0, mEnableCarDockHomeCapture:Z
    ...
    invoke-static {v0}, lidBehaviorToString(I)Ljava/lang/String;
    ...
    invoke-static {v0}, longPressOnBackBehaviorToString(I)Ljava/lang/String;
    ...
    invoke-static {v0}, longPressOnHomeBehaviorToString(I)Ljava/lang/String;
    ...
    invoke-static {v0}, doubleTapOnHomeBehaviorToString(I)Ljava/lang/String;
    ...
    invoke-static {v0}, shortPressOnPowerBehaviorToString(I)Ljava/lang/String;
    ...
    invoke-static {v0}, longPressOnPowerBehaviorToString(I)Ljava/lang/String;
    ...
    invoke-static {v0}, veryLongPressOnPowerBehaviorToString(I)Ljava/lang/String;
    ...
    invoke-static {v0}, multiPressOnPowerBehaviorToString(I)Ljava/lang/String;
    ...
    invoke-static {v0}, shortPressOnSleepBehaviorToString(I)Ljava/lang/String;
    ...
    iget v0, p0, mShortPressOnWindowBehavior:I

    invoke-static {v0}, shortPressOnWindowBehaviorToString(I)Ljava/lang/String;
    ...
    iget-boolean v0, p0, mAllowStartActivityForLongPressOnPowerDuringSetup:Z
    ...
    iget-boolean v0, p0, mHapticTextHandleEnabled:Z
    ...
    invoke-static {v0}, incallPowerBehaviorToString(I)Ljava/lang/String;
    ...
    iget v0, p0, mIncallBackBehavior:I

    invoke-static {v0}, incallBackBehaviorToString(I)Ljava/lang/String;
    ...
    invoke-static {v0}, endcallBehaviorToString(I)Ljava/lang/String;
    ...
    :goto_0
    iget-object v1, p0, mDisplayHomeButtonHandlers:Landroid/util/SparseArray;
    ...
    iget-object v2, p0, mDisplayHomeButtonHandlers:Landroid/util/SparseArray;
    ...
    iget-object v0, p0, mAllowLockscreenWhenOnDisplays:Ljava/util/HashSet;
    ...
    iget-boolean v0, p0, mHasFeatureLeanback:Z
    ...
    invoke-virtual {p0}, isKeyguardDisabledAndNotShowing()Z
...
.method public finishedGoingToSleep(I)V
    ...
    iget v2, p0, mLockScreenTimeout:I
    ...
    iput-boolean v0, p0, mGoingToSleep:Z
    ...
    iget-object v1, p0, mDefaultDisplayRotation:Lcom/android/server/wm/DisplayRotation;
    ...
    iget-boolean v2, p0, mCameraGestureTriggeredDuringGoingToSleep:Z
...
.method public finishedWakingUp(I)V
    ...
    :cond_1
    iget-object v0, p0, mDisplayFoldController:Lcom/android/server/policy/DisplayFoldController;
...
.method getAudioManagerInternal()Landroid/media/AudioManagerInternal;
    ...
    iget-object v0, p0, mServiceAquireLock:Ljava/lang/Object;
    ...
    iput-object v1, p0, mAudioManagerInternal:Landroid/media/AudioManagerInternal;
...
.method public getMaxWallpaperLayer()I
    ...
    invoke-virtual {p0, v0}, getWindowLayerFromTypeLw(I)I
...
.method getStatusBarManagerInternal()Lcom/android/server/statusbar/StatusBarManagerInternal;
    ...
    :try_start_0
    iget-object v1, p0, mStatusBarManagerInternal:Lcom/android/server/statusbar/StatusBarManagerInternal;
    ...
    iput-object v1, p0, mStatusBarManagerInternal:Lcom/android/server/statusbar/StatusBarManagerInternal;
...
.method getStatusBarService()Lcom/android/internal/statusbar/IStatusBarService;
    ...
    :try_start_0
    iget-object v1, p0, mStatusBarService:Lcom/android/internal/statusbar/IStatusBarService;
    ...
    iput-object v1, p0, mStatusBarService:Lcom/android/internal/statusbar/IStatusBarService;
...
.method protected getVibrationEffect(I)Landroid/os/VibrationEffect;
    ...
    :pswitch_4
    iget-object v2, p0, mCalendarDateVibePattern:[J
    ...
    :cond_1
    iget-object v2, p0, mSafeModeEnabledVibePattern:[J
...
.method goHome()Z
    ...
    iget-object v6, p0, mHomeIntent:Landroid/content/Intent;

    iget-object v1, p0, mHomeIntent:Landroid/content/Intent;
...
.method protected handleShortPressOnHome(I)V
    ...
    :cond_0
    iget-object v1, p0, mDreamManagerInternal:Landroid/service/dreams/DreamManagerInternal;
    ...
    :cond_1
    invoke-virtual {p0, p1}, launchHomeFromHotKey(I)V
...
.method public init(Landroid/content/Context;Landroid/view/IWindowManager;Lcom/android/server/policy/WindowManagerPolicy$WindowManagerFuncs;)V
    ...
    iput-object v8, v0, mContext:Landroid/content/Context;

    move-object/from16 v9, p2

    iput-object v9, v0, mWindowManager:Landroid/view/IWindowManager;

    move-object/from16 v10, p3

    iput-object v10, v0, mWindowManagerFuncs:Lcom/android/server/policy/WindowManagerPolicy$WindowManagerFuncs;
    ...
    iput-object v1, v0, mWindowManagerInternal:Lcom/android/server/wm/WindowManagerInternal;
    ...
    iput-object v1, v0, mActivityManagerInternal:Landroid/app/ActivityManagerInternal;
    ...
    iput-object v1, v0, mActivityTaskManagerInternal:Lcom/android/server/wm/ActivityTaskManagerInternal;
    ...
    iput-object v1, v0, mInputManagerInternal:Landroid/hardware/input/InputManagerInternal;
    ...
    iput-object v1, v0, mDreamManagerInternal:Landroid/service/dreams/DreamManagerInternal;
    ...
    iput-object v1, v0, mPowerManagerInternal:Landroid/os/PowerManagerInternal;
    ...
    iput-object v1, v0, mAppOpsManager:Landroid/app/AppOpsManager;
    ...
    iput-object v1, v0, mDisplayManager:Landroid/hardware/display/DisplayManager;
    ...
    iput-boolean v1, v0, mHasFeatureWatch:Z
    ...
    iput-boolean v1, v0, mHasFeatureLeanback:Z
    ...
    iput-boolean v1, v0, mHasFeatureHdmiCec:Z
    ...
    iput-object v1, v0, mAccessibilityShortcutController:Lcom/android/internal/accessibility/AccessibilityShortcutController;

    new-instance v1, Lcom/android/internal/logging/MetricsLogger;

    invoke-direct {v1}, Lcom/android/internal/logging/MetricsLogger;-><init>()V

    iput-object v1, v0, mLogger:Lcom/android/internal/logging/MetricsLogger;
    ...
    iput-object v12, v0, mBurnInProtectionHelper:Lcom/android/server/policy/BurnInProtectionHelper;
    ...
    iput-object v1, v0, mWakeGestureListener:Lcom/android/server/policy/PhoneWindowManager$MyWakeGestureListener;
    ...
    iput-object v1, v0, mSettingsObserver:Lcom/android/server/policy/PhoneWindowManager$SettingsObserver;

    iget-object v1, v0, mSettingsObserver:Lcom/android/server/policy/PhoneWindowManager$SettingsObserver;
    ...
    iput-object v1, v0, mShortcutManager:Lcom/android/server/policy/ShortcutManager;
    ...
    iput-object v1, v0, mHomeIntent:Landroid/content/Intent;
    ...
    iput-boolean v1, v0, mEnableCarDockHomeCapture:Z

    new-instance v1, Landroid/content/Intent;

    invoke-direct {v1, v3, v2}, Landroid/content/Intent;-><init>(Ljava/lang/String;Landroid/net/Uri;)V

    iput-object v1, v0, mCarDockIntent:Landroid/content/Intent;

    iget-object v1, v0, mCarDockIntent:Landroid/content/Intent;
    ...
    iput-object v1, v0, mDeskDockIntent:Landroid/content/Intent;

    iget-object v1, v0, mDeskDockIntent:Landroid/content/Intent;
    ...
    iput-object v1, v0, mVrHeadsetHomeIntent:Landroid/content/Intent;

    iget-object v1, v0, mVrHeadsetHomeIntent:Landroid/content/Intent;
    ...
    iput-object v1, v0, mPowerManager:Landroid/os/PowerManager;

    iget-object v1, v0, mPowerManager:Landroid/os/PowerManager;
    ...
    iput-object v1, v0, mBroadcastWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    iput-object v1, v0, mPowerKeyWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    iput-boolean v1, v0, mEnableShiftMenuBugReports:Z
    ...
    iput v1, v0, mLidKeyboardAccessibility:I
    ...
    iput v1, v0, mLidNavigationAccessibility:I
    ...
    iput-boolean v1, v0, mLidControlsDisplayFold:Z
    ...
    iput-boolean v1, v0, mAllowTheaterModeWakeFromKey:Z

    iget-boolean v1, v0, mAllowTheaterModeWakeFromKey:Z
    ...
    :goto_3
    iput-boolean v1, v0, mAllowTheaterModeWakeFromPowerKey:Z
    ...
    iput-boolean v1, v0, mAllowTheaterModeWakeFromMotion:Z
    ...
    iput-boolean v1, v0, mAllowTheaterModeWakeFromMotionWhenNotDreaming:Z
    ...
    iput-boolean v1, v0, mAllowTheaterModeWakeFromCameraLens:Z
    ...
    iput-boolean v1, v0, mAllowTheaterModeWakeFromLidSwitch:Z
    ...
    iput-boolean v1, v0, mAllowTheaterModeWakeFromWakeGesture:Z
    ...
    iput-boolean v1, v0, mGoToSleepOnButtonPressTheaterMode:Z
    ...
    iput-boolean v1, v0, mSupportLongPressPowerWhenNonInteractive:Z
    ...
    iput v1, v0, mLongPressOnBackBehavior:I
    ...
    iput v1, v0, mShortPressOnPowerBehavior:I
    ...
    iput v1, v0, mLongPressOnPowerBehavior:I
    ...
    iput v1, v0, mVeryLongPressOnPowerBehavior:I
    ...
    iput v1, v0, mDoublePressOnPowerBehavior:I
    ...
    iput v1, v0, mTriplePressOnPowerBehavior:I
    ...
    iput v1, v0, mShortPressOnSleepBehavior:I
    ...
    iput v1, v0, mVeryLongPressTimeout:I
    ...
    iput-boolean v1, v0, mAllowStartActivityForLongPressOnPowerDuringSetup:Z
    ...
    iput-boolean v1, v0, mHapticTextHandleEnabled:Z
    ...
    :goto_4
    iput-boolean v12, v0, mUseTvRouting:Z
    ...
    iput-boolean v1, v0, mHandleVolumeKeysInWM:Z
    ...
    iput-boolean v1, v0, mPerDisplayFocusEnabled:Z

    invoke-direct/range {p0 .. p0}, readConfigurationDependentBehaviors()V

    iget-boolean v1, v0, mLidControlsDisplayFold:Z
    ...
    iput-object v3, v0, mDisplayFoldController:Lcom/android/server/policy/DisplayFoldController;
    ...
    iput-object v1, v0, mAccessibilityManager:Landroid/view/accessibility/AccessibilityManager;
    ...
    iget-object v3, v0, mDockReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v4, v0, mDefaultDisplayPolicy:Lcom/android/server/wm/DisplayPolicy;
    ...
    iget-object v4, v0, mDreamReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v4, v0, mMultiuserReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v4, v0, mVibrator:Landroid/os/Vibrator;
    ...
    invoke-static {v4, v5}, getLongIntArray(Landroid/content/res/Resources;I)[J

    move-result-object v4

    iput-object v4, v0, mLongPressVibePattern:[J
    ...
    iput-object v4, v0, mCalendarDateVibePattern:[J
    ...
    iput-object v4, v0, mSafeModeEnabledVibePattern:[J
    ...
    iput-boolean v4, v0, mScreenshotChordEnabled:Z
    ...
    iput-object v4, v0, mGlobalKeyManager:Lcom/android/server/policy/GlobalKeyManager;
    ...
    :cond_a
    iget-object v2, v0, mWindowManagerInternal:Lcom/android/server/wm/WindowManagerInternal;
    ...
    iput-object v2, v0, mKeyguardDelegate:Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;

    iget-object v2, v0, mZenModeCallback:Lcom/oneplus/android/server/zenmode/ZenModeInjector$Callback;
...
.method initializeHdmiState()V
    ...
    :try_start_0
    invoke-virtual {p0}, initializeHdmiStateInternal()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method initializeHdmiStateInternal()V
    ...
    iget-object v2, p0, mExtEventObserver:Landroid/os/UEventObserver;
    ...
    iget-object v2, p0, mHDMIObserver:Landroid/os/UEventObserver;
...
.method public interceptKeyBeforeDispatching(Lcom/android/server/policy/WindowManagerPolicy$WindowState;Landroid/view/KeyEvent;I)J
    ...
    invoke-direct {p0, p1, p2, p3}, interceptKeyBeforeDispatchingInner(Lcom/android/server/policy/WindowManagerPolicy$WindowState;Landroid/view/KeyEvent;I)J
    ...
    iget-boolean v3, p0, mPerDisplayFocusEnabled:Z
    ...
    iget v3, p0, mTopFocusedDisplayId:I
    ...
    iget-wide v5, p0, mMovingDisplayToTopKeyTime:J
    ...
    iput-wide v3, p0, mMovingDisplayToTopKeyTime:J

    const/4 v5, 0x1

    iput-boolean v5, p0, mMovingDisplayToTopKeyTriggered:Z
    ...
    :cond_0
    iget-boolean v5, p0, mMovingDisplayToTopKeyTriggered:Z
...
.method public interceptKeyBeforeQueueing(Landroid/view/KeyEvent;I)I
    ...
    iget-boolean v0, v7, mSystemBooted:Z
    ...
    iget-object v0, v7, mKeyguardDelegate:Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;
    ...
    invoke-direct {v7, v13, v12}, shouldDispatchInputWhenNonInteractive(II)Z
    ...
    invoke-direct {v7, v12}, isWakeKeyWhenScreenOff(I)Z
    ...
    iget-object v4, v7, mGlobalKeyManager:Lcom/android/server/policy/GlobalKeyManager;
    ...
    iget-boolean v4, v7, mAllowTheaterModeWakeFromKey:Z
    ...
    invoke-direct/range {v1 .. v6}, wakeUp(JZILjava/lang/String;)Z
    ...
    iget-boolean v4, v7, mNavBarVirtualKeyHapticFeedbackEnabled:Z
    ...
    invoke-direct/range {p0 .. p1}, interceptSystemNavigationKey(Landroid/view/KeyEvent;)V
    ...
    iget-object v3, v7, mPowerManager:Landroid/os/PowerManager;
    ...
    invoke-direct/range {p0 .. p0}, sleepPress()V
    ...
    invoke-direct {v7, v5, v6}, sleepRelease(J)V
    ...
    iget-boolean v6, v7, mPowerKeyHandled:Z

    iget v1, v7, mPowerKeyPressCounter:I

    invoke-static {v5, v6, v1}, Lcom/android/server/policy/EventLogTags;->writeInterceptPower(Ljava/lang/String;II)V

    invoke-direct/range {p0 .. p0}, cancelPendingAccessibilityShortcutAction()V
    ...
    iget-object v5, v7, mKeyguardDelegate:Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;
    ...
    invoke-direct {v7, v8, v1}, interceptPowerKeyDown(Landroid/view/KeyEvent;Z)V

    goto :goto_a

    :cond_1b
    invoke-direct {v7, v8, v1, v11}, interceptPowerKeyUp(Landroid/view/KeyEvent;ZZ)V
    ...
    iget-object v1, v7, mPowerManagerInternal:Landroid/os/PowerManagerInternal;
    ...
    iget-object v1, v7, mBroadcastWakeLock:Landroid/os/PowerManager$WakeLock;

    invoke-virtual {v1}, Landroid/os/PowerManager$WakeLock;->acquire()V

    iget-object v1, v7, mHandler:Landroid/os/Handler;
    ...
    iget-object v3, v7, mHandler:Landroid/os/Handler;
    ...
    :cond_24
    iget v1, v7, mShortPressOnWindowBehavior:I

    const/4 v2, 0x1

    if-ne v1, v2, :cond_27

    iget-boolean v1, v7, mPictureInPictureVisible:Z

    if-eqz v1, :cond_26

    if-nez v10, :cond_25

    invoke-direct/range {p0 .. p1}, showPictureInPictureMenu(Landroid/view/KeyEvent;)V
    ...
    invoke-direct/range {p0 .. p0}, cancelPendingRingerToggleChordAction()V

    if-eqz v9, :cond_2d

    iget-boolean v0, v7, mScreenshotChordVolumeDownKeyTriggered:Z
    ...
    iput-boolean v2, v7, mScreenshotChordVolumeDownKeyTriggered:Z

    invoke-virtual/range {p1 .. p1}, Landroid/view/KeyEvent;->getDownTime()J

    move-result-wide v5

    iput-wide v5, v7, mScreenshotChordVolumeDownKeyTime:J

    const/4 v2, 0x0

    iput-boolean v2, v7, mScreenshotChordVolumeDownKeyConsumed:Z

    invoke-virtual/range {p0 .. p0}, cancelPendingPowerKeyAction()V

    invoke-direct/range {p0 .. p0}, interceptScreenshotChord()V

    invoke-direct/range {p0 .. p0}, interceptAccessibilityShortcutChord()V
    ...
    invoke-direct/range {p0 .. p0}, cancelPendingScreenshotChordAction()V
    ...
    iget-boolean v0, v7, mA11yShortcutChordVolumeUpKeyTriggered:Z
    ...
    iput-boolean v2, v7, mA11yShortcutChordVolumeUpKeyTriggered:Z

    invoke-virtual/range {p1 .. p1}, Landroid/view/KeyEvent;->getDownTime()J

    move-result-wide v5

    iput-wide v5, v7, mA11yShortcutChordVolumeUpKeyTime:J

    const/4 v2, 0x0

    iput-boolean v2, v7, mA11yShortcutChordVolumeUpKeyConsumed:Z
    ...
    invoke-direct/range {p0 .. p0}, interceptRingerToggleChord()V
    ...
    invoke-direct {v7, v0}, sendSystemKeyToStatusBarAsync(I)V
    ...
    iget-boolean v0, v7, mHandleVolumeKeysInWM:Z
    ...
    iget-object v2, v7, mContext:Landroid/content/Context;
    ...
    :goto_11
    iget-boolean v0, v7, mUseTvRouting:Z
    ...
    iput-boolean v3, v7, mEndCallKeyHandled:Z

    iget-object v3, v7, mHandler:Landroid/os/Handler;

    iget-object v4, v7, mEndCallLongPress:Ljava/lang/Runnable;

    iget-object v5, v7, mContext:Landroid/content/Context;
    ...
    :cond_3c
    iget-boolean v1, v7, mEndCallKeyHandled:Z

    if-nez v1, :cond_43

    iget-object v1, v7, mHandler:Landroid/os/Handler;

    iget-object v2, v7, mEndCallLongPress:Ljava/lang/Runnable;

    invoke-virtual {v1, v2}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    if-nez v11, :cond_43

    iget v1, v7, mEndcallBehavior:I
    ...
    invoke-direct {v7, v1, v2, v3, v4}, goToSleep(JII)V
    ...
    invoke-direct/range {p0 .. p0}, interceptBackKeyDown()V

    goto :goto_16

    :cond_41
    invoke-direct/range {p0 .. p1}, interceptBackKeyUp(Landroid/view/KeyEvent;)Z
    ...
    :cond_43
    :goto_16
    iget-boolean v1, v7, mHasFeatureLeanback:Z
    ...
    :cond_44
    invoke-direct {v7, v12, v10}, interceptAccessibilityGestureTv(IZ)Z
    ...
    :cond_45
    :goto_17
    iget-object v1, v7, mAccessibilityShortcutController:Lcom/android/internal/accessibility/AccessibilityShortcutController;
    ...
    invoke-virtual {v7, v3, v2, v1}, performHapticFeedback(IZLjava/lang/String;)Z
...
.method public interceptMotionBeforeQueueingNonInteractive(IJI)I
    ...
    iget-boolean v7, p0, mAllowTheaterModeWakeFromMotion:Z
    ...
    invoke-direct/range {v4 .. v9}, wakeUp(JZILjava/lang/String;)Z
    ...
    :cond_0
    invoke-direct {p0, p1, v3}, shouldDispatchInputWhenNonInteractive(II)Z
    ...
    iget-boolean v7, p0, mAllowTheaterModeWakeFromMotionWhenNotDreaming:Z
...
.method public isUserSetupComplete()Z
    ...
    invoke-direct {p0}, isTvUserSetupComplete()Z
...
.method launchAssistAction(Ljava/lang/String;I)V
    ...
    sget-object v2, POWER_LONG_PRESS_WITH_GOOGLE_ASSISTANT_HINT:Ljava/lang/String;
    ...
    sget-object v2, POWER_LONG_PRESS_WITH_ASSISTANT_HINT:Ljava/lang/String;
    ...
    sget-object v2, HEY_TAP_PACKAGE_NAME:Ljava/lang/String;
...
.method launchHomeFromHotKey(I)V
    ...
    invoke-virtual {p0, p1, v0, v0}, launchHomeFromHotKey(IZZ)V
...
.method launchHomeFromHotKey(IZZ)V
    ...
    :cond_3
    invoke-virtual {p0, p1, v1, p2}, startDockOrHome(IZZ)V
...
.method public notifyCameraLensCoverSwitchChanged(JZ)V
    ...
    iget v1, p0, mCameraLensCoverState:I
    ...
    iget-boolean v8, p0, mAllowTheaterModeWakeFromCameraLens:Z
    ...
    invoke-direct/range {v5 .. v10}, wakeUp(JZILjava/lang/String;)Z

    sget-object v3, Landroid/os/UserHandle;->CURRENT_OR_SELF:Landroid/os/UserHandle;

    invoke-virtual {p0, v2, v3}, startActivityAsUser(Landroid/content/Intent;Landroid/os/UserHandle;)V
...
.method public notifyLidSwitchChanged(JZ)V
    ...
    iget-boolean v5, p0, mAllowTheaterModeWakeFromLidSwitch:Z
    ...
    invoke-direct/range {v2 .. v7}, wakeUp(JZILjava/lang/String;)Z
...
.method public okToAnimate()Z
    ...
    iget-boolean v0, p0, mGoingToSleep:Z
...
.method public onDefaultDisplayFocusChangedLw(Lcom/android/server/policy/WindowManagerPolicy$WindowState;)V
    ...
    :cond_2
    invoke-virtual {p0, p1}, opOnDefaultDisplayFocusChangedLw(Lcom/android/server/policy/WindowManagerPolicy$WindowState;)V
...
.method public onKeyguardOccludedChangedLw(Z)V
    ...
    iput-boolean p1, p0, mPendingKeyguardOccluded:Z

    const/4 v0, 0x1

    iput-boolean v0, p0, mKeyguardOccludedChanged:Z
    ...
    invoke-direct {p0, p1, v0}, setKeyguardOccludedLw(ZZ)Z
...
.method public onSystemUiStarted()V
    ...
    invoke-direct {p0}, bindKeyguard()V
...
.method public performHapticFeedback(ILjava/lang/String;IZLjava/lang/String;)Z
    ...
    :cond_2
    invoke-virtual {p0, p3}, getVibrationEffect(I)Landroid/os/VibrationEffect;
    ...
    iget-object v3, p0, mPowerKeyWakeLock:Landroid/os/PowerManager$WakeLock;
...
.method protected performHapticFeedback(IZLjava/lang/String;)Z
    ...
    invoke-virtual/range {v0 .. v5}, performHapticFeedback(ILjava/lang/String;IZLjava/lang/String;)Z
...
.method powerLongPress()V
    ...
    invoke-virtual {p0, v2, v2, v1}, performHapticFeedback(IZLjava/lang/String;)Z
    ...
    invoke-virtual {p0, v2, v3}, launchAssistAction(Ljava/lang/String;I)V
    ...
    iget-boolean v1, p0, mAllowStartActivityForLongPressOnPowerDuringSetup:Z

    invoke-direct {p0, v1}, launchVoiceAssist(Z)V
    ...
    invoke-virtual {p0, v2, v2, v4}, performHapticFeedback(IZLjava/lang/String;)Z

    const-string v4, "globalactions"

    invoke-virtual {p0, v4}, sendCloseSystemWindows(Ljava/lang/String;)V

    iget-object v4, p0, mWindowManagerFuncs:Lcom/android/server/policy/WindowManagerPolicy$WindowManagerFuncs;
...
.method readLidState()V
    ...
    iget-object v1, p0, mWindowManagerFuncs:Lcom/android/server/policy/WindowManagerPolicy$WindowManagerFuncs;
...
.method public registerShortcutKey(JLcom/android/internal/policy/IShortcutService;)V
    ...
    :try_start_0
    iget-object v1, p0, mShortcutKeyServices:Landroid/util/LongSparseArray;
    ...
    :cond_1
    :goto_0
    iget-object v2, p0, mShortcutKeyServices:Landroid/util/LongSparseArray;
...
.method public requestUserActivityNotification()V
    ...
    iget-boolean v0, p0, mNotifyUserActivity:Z
    ...
    iput-boolean v0, p0, mNotifyUserActivity:Z
...
.method public screenTurnedOff()V
    ...
    invoke-direct {p0, v0}, reportScreenStateToVrManager(Z)V
...
.method public screenTurningOn(Lcom/android/server/policy/WindowManagerPolicy$ScreenOnListener;)V
    ...
    invoke-direct {p0}, getKeyguardDrawnTimeout()J
...
.method public setAodShowing(Z)Z
    ...
    iget-boolean v0, p0, mAodShowing:Z

    if-eq v0, p1, :cond_0

    iput-boolean p1, p0, mAodShowing:Z
...
.method public setDefaultDisplay(Lcom/android/server/policy/WindowManagerPolicy$DisplayContentInfo;)V
    ...
    iput-object v0, p0, mDefaultDisplayRotation:Lcom/android/server/wm/DisplayRotation;
    ...
    iput-object v0, p0, mDefaultDisplayPolicy:Lcom/android/server/wm/DisplayPolicy;
...
.method public setDismissImeOnBackKeyPressed(Z)V
    ...
    iput-boolean p1, p0, mDismissImeOnBackKeyPressed:Z
...
.method public setFingerprintEnabled(Z)V
    ...
    iput-boolean p1, p0, mIsFingerprintEnabled:Z
...
.method public setKeyguardCandidateLw(Lcom/android/server/policy/WindowManagerPolicy$WindowState;)V
    ...
    iput-object p1, p0, mKeyguardCandidate:Lcom/android/server/policy/WindowManagerPolicy$WindowState;

    iget-boolean v0, p0, mKeyguardOccluded:Z

    const/4 v1, 0x1

    invoke-direct {p0, v0, v1}, setKeyguardOccludedLw(ZZ)Z
...
.method public setNavBarVirtualKeyHapticFeedbackEnabledLw(Z)V
    ...
    iput-boolean p1, p0, mNavBarVirtualKeyHapticFeedbackEnabled:Z
...
.method public setPipVisibilityLw(Z)V
    ...
    iput-boolean p1, p0, mPictureInPictureVisible:Z
...
.method public setRecentsVisibilityLw(Z)V
    ...
    iput-boolean p1, p0, mRecentsVisible:Z
...
.method public setSafeMode(Z)V
    ...
    invoke-virtual {p0, v0, v1, v2}, performHapticFeedback(IZLjava/lang/String;)Z
...
.method public setTopFocusedDisplay(I)V
    ...
    iput p1, p0, mTopFocusedDisplayId:I
...
.method showGlobalActionsInternal()V
    ...
    iget-object v0, p0, mGlobalActions:Lcom/android/server/policy/GlobalActions;
    ...
    iput-object v0, p0, mGlobalActions:Lcom/android/server/policy/GlobalActions;
    ...
    invoke-direct {p0}, stopLongshot()V
...
.method startActivityAsUser(Landroid/content/Intent;Landroid/os/UserHandle;)V
    ...
    invoke-direct {p0, p1, v0, p2}, startActivityAsUser(Landroid/content/Intent;Landroid/os/Bundle;Landroid/os/UserHandle;)V
...
.method startDockOrHome(IZZ)V
    ...
    :cond_3
    iget-object v2, p0, mActivityTaskManagerInternal:Lcom/android/server/wm/ActivityTaskManagerInternal;
...
.method public startedGoingToSleep(I)V
    ...
    iput-boolean v1, p0, mGoingToSleep:Z

    iput-boolean v1, p0, mRequestedOrGoingToSleep:Z
...
.method public systemBooted()V
    ...
    :try_start_0
    iput-boolean v1, p0, mSystemBooted:Z
    ...
    invoke-virtual {p0, v0}, finishedWakingUp(I)V

    const/4 v0, 0x0

    invoke-virtual {p0, v0}, screenTurningOn(Lcom/android/server/policy/WindowManagerPolicy$ScreenOnListener;)V
...
.method public systemReady()V
    ...
    iput-object v0, p0, mVrManagerInternal:Lcom/android/server/vr/VrManagerInternal;
    ...
    iget-object v1, p0, mPersistentVrModeListener:Landroid/service/vr/IPersistentVrStateCallbacks;
    ...
    iget-boolean v2, p0, mSystemBooted:Z
    ...
    iput-object v0, p0, mAutofillManagerInternal:Landroid/view/autofill/AutofillManagerInternal;
    ...
    :cond_2
    iput-boolean v1, p0, mIsNotifyWakeUpToSensor:Z
...
.method public updateSettings()V
    ...
    iput v3, p0, mIncallPowerBehavior:I
    ...
    iput v3, p0, mIncallBackBehavior:I
    ...
    :goto_0
    iput-boolean v3, p0, mSystemNavigationKeysEnabled:Z
    ...
    iput v3, p0, mRingerToggleChord:I
    ...
    iput v3, p0, mPowerButtonSuppressionDelayMillis:I
    ...
    iput v6, p0, mRingerToggleChord:I
    ...
    :goto_1
    iget-boolean v7, p0, mWakeGestureEnabledSetting:Z

    if-eq v7, v3, :cond_3

    iput-boolean v3, p0, mWakeGestureEnabledSetting:Z
    ...
    iput v7, p0, mLockScreenTimeout:I
    ...
    :cond_4
    iget-boolean v7, p0, mHasSoftInput:Z

    if-eq v7, v6, :cond_5

    iput-boolean v6, p0, mHasSoftInput:Z
    ...
    iput v7, p0, mLongPressOnPowerBehavior:I
    ...
    iput v7, p0, mVeryLongPressOnPowerBehavior:I
    ...
    invoke-virtual {p0, v4}, updateRotation(Z)V
...
.method public writeToProto(Landroid/util/proto/ProtoOutputStream;J)V
    ...
    iget-object v2, p0, mDefaultDisplayRotation:Lcom/android/server/wm/DisplayRotation;
    ...
    iget-boolean v2, p0, mKeyguardOccluded:Z

    const-wide v3, 0x1080000000cL

    invoke-virtual {p1, v3, v4, v2}, Landroid/util/proto/ProtoOutputStream;->write(JZ)V

    iget-boolean v2, p0, mKeyguardOccludedChanged:Z

    const-wide v3, 0x1080000000dL

    invoke-virtual {p1, v3, v4, v2}, Landroid/util/proto/ProtoOutputStream;->write(JZ)V

    iget-boolean v2, p0, mPendingKeyguardOccluded:Z
