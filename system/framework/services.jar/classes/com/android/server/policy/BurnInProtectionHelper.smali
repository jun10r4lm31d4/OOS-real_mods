...
.method static constructor <clinit>()V
    ...
    sput-wide v0, BURNIN_PROTECTION_FIRST_WAKEUP_INTERVAL_MS:J
    ...
    sput-wide v0, BURNIN_PROTECTION_SUBSEQUENT_WAKEUP_INTERVAL_MS:J
...
.method public constructor <init>(Landroid/content/Context;IIIII)V
    ...
    iput v0, p0, mLastBurnInXOffset:I

    const/4 v1, 0x1

    iput v1, p0, mXOffsetDirection:I

    iput v0, p0, mLastBurnInYOffset:I

    iput v1, p0, mYOffsetDirection:I

    iput v0, p0, mAppliedBurnInXOffset:I

    iput v0, p0, mAppliedBurnInYOffset:I
    ...
    iput-object v1, p0, mBurnInProtectionReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput v1, p0, mBurnInRadiusMaxSquared:I
    ...
    iget-object v1, p0, mBurnInProtectionReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v0, p0, mCenteringAnimator:Landroid/animation/ValueAnimator;
...
.method private adjustOffsets()V
    ...
    :cond_0
    iget v0, p0, mXOffsetDirection:I
    ...
    iput v1, p0, mLastBurnInXOffset:I

    iget v1, p0, mLastBurnInXOffset:I

    iget v2, p0, mMaxHorizontalBurnInOffset:I

    const/4 v3, -0x1

    if-gt v1, v2, :cond_1

    iget v2, p0, mMinHorizontalBurnInOffset:I
    ...
    iget v4, p0, mMaxVerticalBurnInOffset:I

    if-gt v2, v4, :cond_2

    iget v4, p0, mMinVerticalBurnInOffset:I
    ...
    :cond_3
    iget v0, p0, mBurnInRadiusMaxSquared:I
...
.method private updateBurnInProtection()V
    ...
    sget-wide v0, BURNIN_PROTECTION_FIRST_WAKEUP_INTERVAL_MS:J

    goto :goto_0

    :cond_0
    sget-wide v0, BURNIN_PROTECTION_SUBSEQUENT_WAKEUP_INTERVAL_MS:J

    :goto_0
    nop

    iget-boolean v2, p0, mFirstUpdate:Z
    ...
    iput v2, p0, mAppliedBurnInXOffset:I

    iget v2, p0, mLastBurnInYOffset:I

    iput v2, p0, mAppliedBurnInYOffset:I
    ...
    iget v4, p0, mLastBurnInXOffset:I

    iget v5, p0, mLastBurnInYOffset:I
    ...
    sget-wide v6, BURNIN_PROTECTION_MINIMAL_INTERVAL_MS:J
    ...
    iget-object v10, p0, mAlarmManager:Landroid/app/AlarmManager;

    const/4 v11, 0x3

    iget-object v12, p0, mBurnInProtectionIntent:Landroid/app/PendingIntent;
    ...
    iget-object v1, p0, mBurnInProtectionIntent:Landroid/app/PendingIntent;
...
.method public dump(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    iget v3, p0, mXOffsetDirection:I
...
.method public onAnimationUpdate(Landroid/animation/ValueAnimator;)V
    ...
    iget v3, p0, mAppliedBurnInXOffset:I
    ...
    iget v4, p0, mAppliedBurnInYOffset:I
