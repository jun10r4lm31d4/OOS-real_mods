...
.method constructor <init>(Lcom/android/server/wm/WindowManagerInternal;Landroid/hardware/display/DisplayManagerInternal;ILandroid/graphics/Rect;Landroid/os/Handler;)V
    ...
    iput-object v0, p0, mOverrideFoldedArea:Landroid/graphics/Rect;

    new-instance v0, Landroid/view/DisplayInfo;

    invoke-direct {v0}, Landroid/view/DisplayInfo;-><init>()V

    iput-object v0, p0, mNonOverrideDisplayInfo:Landroid/view/DisplayInfo;
    ...
    iput-object v0, p0, mDurationLogger:Lcom/android/server/policy/DisplayFoldDurationLogger;

    iput-object p1, p0, mWindowManagerInternal:Lcom/android/server/wm/WindowManagerInternal;

    iput-object p2, p0, mDisplayManagerInternal:Landroid/hardware/display/DisplayManagerInternal;
    ...
    iput-object v0, p0, mFoldedArea:Landroid/graphics/Rect;
...
.method static create(Landroid/content/Context;I)Lcom/android/server/policy/DisplayFoldController;
    ...
    invoke-direct/range {v1 .. v6}, <init>(Lcom/android/server/wm/WindowManagerInternal;Landroid/hardware/display/DisplayManagerInternal;ILandroid/graphics/Rect;Landroid/os/Handler;)V
...
.method static createWithProxSensor(Landroid/content/Context;I)Lcom/android/server/policy/DisplayFoldController;
    ...
    :cond_0
    invoke-static {p0, p1}, create(Landroid/content/Context;I)Lcom/android/server/policy/DisplayFoldController;
...
.method finishedGoingToSleep()V
    ...
    iget-object v0, p0, mDurationLogger:Lcom/android/server/policy/DisplayFoldDurationLogger;
...
.method finishedWakingUp()V
    ...
    iget-object v1, p0, mFolded:Ljava/lang/Boolean;
...
.method getFoldedArea()Landroid/graphics/Rect;
    ...
    iget-object v0, p0, mOverrideFoldedArea:Landroid/graphics/Rect;
    ...
    :cond_0
    iget-object v0, p0, mFoldedArea:Landroid/graphics/Rect;
...
.method public synthetic lambda$requestDeviceFolded$0$DisplayFoldController(Z)V
    ...
    invoke-virtual {p0, p1}, setDeviceFolded(Z)V
...
.method onDefaultDisplayFocusChanged(Ljava/lang/String;)V
    ...
    iput-object p1, p0, mFocusedApp:Ljava/lang/String;
...
.method registerDisplayFoldListener(Landroid/view/IDisplayFoldListener;)V
    ...
    iget-object v0, p0, mFolded:Ljava/lang/Boolean;
...
.method setDeviceFolded(Z)V
    ...
    iget-object v3, p0, mNonOverrideDisplayInfo:Landroid/view/DisplayInfo;
    ...
    iget-object v1, p0, mNonOverrideDisplayInfo:Landroid/view/DisplayInfo;
    ...
    iget-object v2, p0, mNonOverrideDisplayInfo:Landroid/view/DisplayInfo;
    ...
    iget-object v1, p0, mFocusedApp:Ljava/lang/String;
    ...
    iput-object v0, p0, mFolded:Ljava/lang/Boolean;
    ...
    :try_start_0
    iget-object v2, p0, mListeners:Landroid/os/RemoteCallbackList;
