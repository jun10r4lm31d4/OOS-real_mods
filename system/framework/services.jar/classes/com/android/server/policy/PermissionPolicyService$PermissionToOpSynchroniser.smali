...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mAllUids:Landroid/util/SparseIntArray;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mOpsToDefault:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mOpsToAllowIfDefault:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mOpsToAllow:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mOpsToIgnoreIfDefault:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mOpsToIgnore:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mOpsToForeground:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mOpsToForegroundIfAllow:Ljava/util/ArrayList;
...
.method static synthetic access$400(Lcom/android/server/policy/PermissionPolicyService$PermissionToOpSynchroniser;)V
    ...
    invoke-direct {p0}, syncPackages()V
...
.method private addOpIfFgPermissions(Landroid/content/pm/PermissionInfo;Landroid/content/pm/PackageInfo;)V
    ...
    invoke-direct {p0, v3, v0, v4}, isBgPermRestricted(Ljava/lang/String;Ljava/lang/String;I)Z

    move-result v6

    if-eqz v6, :cond_1

    iget-object v6, p0, mOpsToForegroundIfAllow:Ljava/util/ArrayList;
    ...
    iget-object v7, p0, mOpsToAllow:Ljava/util/ArrayList;
    ...
    :cond_4
    iget-object v7, p0, mOpsToForeground:Ljava/util/ArrayList;
    ...
    :cond_5
    iget-object v5, p0, mOpsToIgnore:Ljava/util/ArrayList;
...
.method private addOpIfRestricted(Landroid/content/pm/PermissionInfo;Landroid/content/pm/PackageInfo;)V
    ...
    iget-object v4, p0, mOpsToDefault:Ljava/util/ArrayList;
    ...
    :cond_2
    iget-object v4, p0, mOpsToAllowIfDefault:Ljava/util/ArrayList;
    ...
    iget-object v7, p0, mOpsToAllowIfDefault:Ljava/util/ArrayList;
    ...
    :cond_4
    iget-object v7, p0, mOpsToDefault:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, mOpsToIgnore:Ljava/util/ArrayList;
    ...
    :cond_a
    iget-object v4, p0, mOpsToIgnoreIfDefault:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, mOpsToAllow:Ljava/util/ArrayList;
...
.method private setUidModeAllowed(IILjava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2, v0, p3}, setUidMode(IIILjava/lang/String;)V
...
.method private setUidModeAllowedIfDefault(IILjava/lang/String;)Z
    ...
    invoke-direct/range {v0 .. v5}, setUidModeIfMode(IIIILjava/lang/String;)Z
...
.method private syncPackages()V
    ...
    iget-object v1, p0, mOpsToAllow:Ljava/util/ArrayList;
    ...
    iget-object v5, p0, mOpsToAllow:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v6, v7, v8}, setUidModeAllowed(IILjava/lang/String;)V
    ...
    :cond_0
    iget-object v2, p0, mOpsToAllowIfDefault:Ljava/util/ArrayList;
    ...
    iget-object v6, p0, mOpsToAllowIfDefault:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v7, v8, v9}, setUidModeAllowedIfDefault(IILjava/lang/String;)Z
    ...
    :cond_3
    iget-object v5, p0, mOpsToForegroundIfAllow:Ljava/util/ArrayList;
    ...
    iget-object v7, p0, mOpsToForegroundIfAllow:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v8, v9, v10}, setUidModeForegroundIfAllow(IILjava/lang/String;)Z
    ...
    :cond_6
    iget-object v6, p0, mOpsToForeground:Ljava/util/ArrayList;
    ...
    iget-object v8, p0, mOpsToForeground:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v9, v10, v11}, setUidModeForeground(IILjava/lang/String;)V
    ...
    :cond_8
    iget-object v7, p0, mOpsToIgnore:Ljava/util/ArrayList;
    ...
    iget-object v9, p0, mOpsToIgnore:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v10, v11, v12}, setUidModeIgnored(IILjava/lang/String;)V
    ...
    :cond_a
    iget-object v8, p0, mOpsToIgnoreIfDefault:Ljava/util/ArrayList;
    ...
    iget-object v10, p0, mOpsToIgnoreIfDefault:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v11, v12, v13}, setUidModeIgnoredIfDefault(IILjava/lang/String;)Z
    ...
    :cond_d
    iget-object v9, p0, mOpsToDefault:Ljava/util/ArrayList;
    ...
    iget-object v11, p0, mOpsToDefault:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v12, v13, v14}, setUidModeDefault(IILjava/lang/String;)V
...
.method addPackage(Ljava/lang/String;)V
    ...
    :cond_0
    iget-object v1, p0, mAllUids:Landroid/util/SparseIntArray;
    ...
    invoke-direct {p0, v7, v0}, addOpIfRestricted(Landroid/content/pm/PermissionInfo;Landroid/content/pm/PackageInfo;)V

    invoke-direct {p0, v7, v0}, addOpIfFgPermissions(Landroid/content/pm/PermissionInfo;Landroid/content/pm/PackageInfo;)V
