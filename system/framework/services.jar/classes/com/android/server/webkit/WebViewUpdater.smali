...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/webkit/SystemInterface;)V
    ...
    iput-wide v0, p0, mMinimumVersionCode:J

    const/4 v0, 0x0

    iput v0, p0, mNumRelroCreationsStarted:I

    iput v0, p0, mNumRelroCreationsFinished:I

    iput-boolean v0, p0, mWebViewPackageDirty:Z

    iput-boolean v0, p0, mAnyWebViewInstalled:Z

    const v0, 0x7fffffff

    iput v0, p0, NUMBER_OF_RELROS_UNKNOWN:I

    const/4 v0, 0x0

    iput-object v0, p0, mCurrentWebViewPackage:Landroid/content/pm/PackageInfo;
...
.method private checkIfRelrosDoneLocked()V
    ...
    iget v0, p0, mNumRelroCreationsStarted:I

    iget v1, p0, mNumRelroCreationsFinished:I

    if-ne v0, v1, :cond_1

    iget-boolean v0, p0, mWebViewPackageDirty:Z
    ...
    :try_start_0
    invoke-direct {p0}, findPreferredWebViewPackage()Landroid/content/pm/PackageInfo;

    move-result-object v0

    invoke-direct {p0, v0}, onWebViewProviderChanged(Landroid/content/pm/PackageInfo;)V
    :try_end_0
    ...
    iput-object v1, p0, mCurrentWebViewPackage:Landroid/content/pm/PackageInfo;
...
.method private dumpAllPackageInformationLocked(Ljava/io/PrintWriter;)V
    ...
    iget-object v5, p0, mSystemInterface:Lcom/android/server/webkit/SystemInterface;
    ...
    :cond_0
    invoke-direct {p0, v4, v6}, validityResult(Landroid/webkit/WebViewProviderInfo;Landroid/content/pm/PackageInfo;)I
    ...
    iget-object v11, p0, mSystemInterface:Lcom/android/server/webkit/SystemInterface;
    ...
    invoke-static {v11}, isInstalledAndEnabledForAllUsers(Ljava/util/List;)Z
    ...
    invoke-static {v8}, getInvalidityReason(I)Ljava/lang/String;
...
.method private findPreferredWebViewPackage()Landroid/content/pm/PackageInfo;
    ...
    invoke-direct {p0}, getValidWebViewPackagesAndInfos()[Lcom/android/server/webkit/WebViewUpdater$ProviderAndPackageInfo;
    ...
    iget-object v6, p0, mSystemInterface:Lcom/android/server/webkit/SystemInterface;
    ...
    invoke-static {v6}, isInstalledAndEnabledForAllUsers(Ljava/util/List;)Z
    ...
    :cond_3
    iput-boolean v3, p0, mAnyWebViewInstalled:Z
...
.method private getMinimumVersionCode()J
    ...
    iget-wide v0, p0, mMinimumVersionCode:J
    ...
    iget-object v4, p0, mSystemInterface:Lcom/android/server/webkit/SystemInterface;
    ...
    :try_start_0
    iget-object v8, p0, mSystemInterface:Lcom/android/server/webkit/SystemInterface;
    ...
    iget-wide v2, p0, mMinimumVersionCode:J
...
.method private getValidWebViewPackagesAndInfos()[Lcom/android/server/webkit/WebViewUpdater$ProviderAndPackageInfo;
    ...
    :try_start_0
    iget-object v3, p0, mSystemInterface:Lcom/android/server/webkit/SystemInterface;
    ...
    invoke-virtual {p0, v4, v3}, isValidProvider(Landroid/webkit/WebViewProviderInfo;Landroid/content/pm/PackageInfo;)Z
...
.method private onWebViewProviderChanged(Landroid/content/pm/PackageInfo;)V
    ...
    :try_start_0
    iput-boolean v1, p0, mAnyWebViewInstalled:Z

    iget v2, p0, mNumRelroCreationsStarted:I

    iget v3, p0, mNumRelroCreationsFinished:I

    if-ne v2, v3, :cond_0

    iput-object p1, p0, mCurrentWebViewPackage:Landroid/content/pm/PackageInfo;

    iget v1, p0, NUMBER_OF_RELROS_UNKNOWN:I

    iput v1, p0, mNumRelroCreationsStarted:I

    const/4 v1, 0x0

    iput v1, p0, mNumRelroCreationsFinished:I
    ...
    invoke-direct {p0}, checkIfRelrosDoneLocked()V

    goto :goto_0

    :cond_0
    iput-boolean v1, p0, mWebViewPackageDirty:Z
...
.method private validityResult(Landroid/webkit/WebViewProviderInfo;Landroid/content/pm/PackageInfo;)I
    ...
    invoke-direct {p0}, getMinimumVersionCode()J

    move-result-wide v2

    invoke-static {v0, v1, v2, v3}, versionCodeGE(JJ)Z
    ...
    invoke-static {p1, p2, v0}, providerHasValidSignature(Landroid/webkit/WebViewProviderInfo;Landroid/content/pm/PackageInfo;Lcom/android/server/webkit/SystemInterface;)Z
...
.method private webViewIsReadyLocked()Z
    ...
    iget-boolean v0, p0, mAnyWebViewInstalled:Z
...
.method changeProviderAndSetting(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, updateCurrentWebViewPackage(Ljava/lang/String;)Landroid/content/pm/PackageInfo;
...
.method dumpState(Ljava/io/PrintWriter;)V
    ...
    :try_start_0
    iget-object v1, p0, mCurrentWebViewPackage:Landroid/content/pm/PackageInfo;
    ...
    iget-object v6, p0, mCurrentWebViewPackage:Landroid/content/pm/PackageInfo;
    ...
    iget-wide v6, p0, mMinimumVersionCode:J
    ...
    iget v6, p0, mNumRelroCreationsStarted:I
    ...
    iget v6, p0, mNumRelroCreationsFinished:I
    ...
    iget-boolean v6, p0, mWebViewPackageDirty:Z
    ...
    iget-boolean v6, p0, mAnyWebViewInstalled:Z
    ...
    :goto_1
    invoke-direct {p0, p1}, dumpAllPackageInformationLocked(Ljava/io/PrintWriter;)V
...
.method isValidProvider(Landroid/webkit/WebViewProviderInfo;Landroid/content/pm/PackageInfo;)Z
    ...
    invoke-direct {p0, p1, p2}, validityResult(Landroid/webkit/WebViewProviderInfo;Landroid/content/pm/PackageInfo;)I
...
.method packageStateChanged(Ljava/lang/String;I)V
    ...
    iget-object v8, p0, mCurrentWebViewPackage:Landroid/content/pm/PackageInfo;
    ...
    invoke-direct {p0, v6}, onWebViewProviderChanged(Landroid/content/pm/PackageInfo;)V
    :try_end_0
    .catch Lcom/android/server/webkit/WebViewUpdater$WebViewPackageMissingException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :try_start_1
    iput-object v8, p0, mCurrentWebViewPackage:Landroid/content/pm/PackageInfo;
...
.method prepareWebViewInSystemServer()V
    ...
    iget-object v2, p0, mCurrentWebViewPackage:Landroid/content/pm/PackageInfo;
    ...
    iget-object v4, p0, mCurrentWebViewPackage:Landroid/content/pm/PackageInfo;
    ...
    invoke-direct {p0, v2}, onWebViewProviderChanged(Landroid/content/pm/PackageInfo;)V
...
.method updateCurrentWebViewPackage(Ljava/lang/String;)Landroid/content/pm/PackageInfo;
    ...
    :try_start_2
    invoke-direct {p0, v1}, onWebViewProviderChanged(Landroid/content/pm/PackageInfo;)V
    ...
    :try_start_3
    iput-object v5, p0, mCurrentWebViewPackage:Landroid/content/pm/PackageInfo;
...
.method waitForAndGetProvider()Landroid/webkit/WebViewProviderResponse;
    ...
    :try_start_0
    invoke-direct {p0}, webViewIsReadyLocked()Z
    ...
    :cond_1
    :goto_2
    iget-object v5, p0, mCurrentWebViewPackage:Landroid/content/pm/PackageInfo;
    ...
    :cond_2
    iget-boolean v5, p0, mAnyWebViewInstalled:Z
    ...
    iget v10, p0, mNumRelroCreationsStarted:I
    ...
    iget v10, p0, mNumRelroCreationsFinished:I
    ...
    iget-boolean v10, p0, mWebViewPackageDirty:Z
