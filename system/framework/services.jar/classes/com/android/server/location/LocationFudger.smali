...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;)V
    ...
    iput-object v0, p0, mRandom:Ljava/security/SecureRandom;
...
.method private createCoarseLocked(Landroid/location/Location;)Landroid/location/Location;
    ...
    invoke-static {v1, v2}, wrapLatitude(D)D

    move-result-wide v1

    invoke-static {v3, v4}, wrapLongitude(D)D

    move-result-wide v3

    invoke-direct {p0}, updateRandomOffsetLocked()V

    iget-wide v5, p0, mOffsetLongitudeMeters:D

    invoke-static {v5, v6, v1, v2}, metersToDegreesLongitude(DD)D

    move-result-wide v5

    add-double/2addr v3, v5

    iget-wide v5, p0, mOffsetLatitudeMeters:D

    invoke-static {v5, v6}, metersToDegreesLatitude(D)D
    ...
    iget-wide v5, p0, mGridSizeInMeters:D
    ...
    iget-wide v1, p0, mGridSizeInMeters:D

    invoke-static {v1, v2, v7, v8}, metersToDegreesLongitude(DD)D
    ...
    invoke-static {v7, v8}, wrapLatitude(D)D

    move-result-wide v3

    invoke-static {v9, v10}, wrapLongitude(D)D
    ...
    iget v9, p0, mAccuracyInMeters:F
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-wide v1, p0, mOffsetLongitudeMeters:D
    ...
    iget-wide v1, p0, mOffsetLatitudeMeters:D
