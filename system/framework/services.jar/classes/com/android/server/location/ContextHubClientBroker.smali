...
.method constructor <init>(Landroid/content/Context;Landroid/hardware/contexthub/V1_0/IContexthub;Lcom/android/server/location/ContextHubClientManager;Landroid/hardware/location/ContextHubInfo;SLandroid/app/PendingIntent;J)V
    ...
    iput-object v0, p0, mCallbackInterface:Landroid/hardware/location/IContextHubClientCallback;
    ...
    iput-object p2, p0, mContextHubProxy:Landroid/hardware/contexthub/V1_0/IContexthub;

    iput-object p3, p0, mClientManager:Lcom/android/server/location/ContextHubClientManager;

    iput-object p4, p0, mAttachedContextHubInfo:Landroid/hardware/location/ContextHubInfo;

    iput-short p5, p0, mHostEndPointId:S
    ...
    iput-object v0, p0, mPendingIntentRequest:Lcom/android/server/location/ContextHubClientBroker$PendingIntentRequest;
...
.method constructor <init>(Landroid/content/Context;Landroid/hardware/contexthub/V1_0/IContexthub;Lcom/android/server/location/ContextHubClientManager;Landroid/hardware/location/ContextHubInfo;SLandroid/hardware/location/IContextHubClientCallback;)V
    ...
    iput-object p6, p0, mCallbackInterface:Landroid/hardware/location/IContextHubClientCallback;
...
.method private createIntent(I)Landroid/content/Intent;
    ...
    iget-object v1, p0, mAttachedContextHubInfo:Landroid/hardware/location/ContextHubInfo;
...
.method private createIntent(IJ)Landroid/content/Intent;
    ...
    invoke-direct {p0, p1}, createIntent(I)Landroid/content/Intent;
...
.method private doSendPendingIntent(Landroid/app/PendingIntent;Landroid/content/Intent;)V
    ...
    iget-short v2, p0, mHostEndPointId:S
...
.method private declared-synchronized invokeCallback(Lcom/android/server/location/ContextHubClientBroker$CallbackConsumer;)V
    ...
    :try_start_0
    iget-object v0, p0, mCallbackInterface:Landroid/hardware/location/IContextHubClientCallback;
    :try_end_0
    ...
    iget-short v3, p0, mHostEndPointId:S
...
.method private declared-synchronized onClientExit()V
    ...
    :cond_0
    iget-object v0, p0, mPendingIntentRequest:Lcom/android/server/location/ContextHubClientBroker$PendingIntentRequest;
...
.method private declared-synchronized sendPendingIntent(Ljava/util/function/Supplier;)V
    ...
    invoke-direct {p0, v0, v1}, doSendPendingIntent(Landroid/app/PendingIntent;Landroid/content/Intent;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public binderDied()V
    ...
    invoke-direct {p0}, onClientExit()V
...
.method getAttachedContextHubId()I
    ...
    iget-object v0, p0, mAttachedContextHubInfo:Landroid/hardware/location/ContextHubInfo;
...
.method getHostEndPointId()S
    ...
    iget-short v0, p0, mHostEndPointId:S
...
.method hasPendingIntent(Landroid/app/PendingIntent;J)Z
    ...
    :try_start_0
    iget-object v1, p0, mPendingIntentRequest:Lcom/android/server/location/ContextHubClientBroker$PendingIntentRequest;
...
.method public synthetic lambda$onHubReset$7$ContextHubClientBroker()Landroid/content/Intent;
    ...
    invoke-direct {p0, v0}, createIntent(I)Landroid/content/Intent;
...
.method public synthetic lambda$onNanoAppAborted$9$ContextHubClientBroker(JI)Landroid/content/Intent;
    ...
    invoke-direct {p0, v0, p1, p2}, createIntent(IJ)Landroid/content/Intent;
...
.method public synthetic lambda$sendMessageToClient$1$ContextHubClientBroker(Landroid/hardware/location/NanoAppMessage;)Landroid/content/Intent;
    ...
    invoke-direct {p0, v2, v0, v1}, createIntent(IJ)Landroid/content/Intent;
...
.method onHubReset()V
    ...
    invoke-direct {p0, v0}, invokeCallback(Lcom/android/server/location/ContextHubClientBroker$CallbackConsumer;)V
    ...
    invoke-direct {p0, v0}, sendPendingIntent(Ljava/util/function/Supplier;)V
...
.method onNanoAppAborted(JI)V
    ...
    invoke-direct {p0, v0, p1, p2}, sendPendingIntent(Ljava/util/function/Supplier;J)V
...
.method sendMessageToClient(Landroid/hardware/location/NanoAppMessage;)V
    ...
    invoke-direct {p0, v0, v1, v2}, sendPendingIntent(Ljava/util/function/Supplier;J)V
...
.method public sendMessageToNanoApp(Landroid/hardware/location/NanoAppMessage;)I
    ...
    invoke-direct {p0}, isRegistered()Z
    ...
    iget-object v2, p0, mAttachedContextHubInfo:Landroid/hardware/location/ContextHubInfo;
    ...
    :try_start_0
    iget-object v3, p0, mContextHubProxy:Landroid/hardware/contexthub/V1_0/IContexthub;
