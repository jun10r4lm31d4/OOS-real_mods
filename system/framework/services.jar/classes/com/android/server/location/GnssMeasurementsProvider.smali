...
.method protected constructor <init>(Landroid/content/Context;Landroid/os/Handler;)V
    ...
    invoke-direct {p0, p1, p2, v0}, <init>(Landroid/content/Context;Landroid/os/Handler;Lcom/android/server/location/GnssMeasurementsProvider$GnssMeasurementProviderNative;)V
...
.method constructor <init>(Landroid/content/Context;Landroid/os/Handler;Lcom/android/server/location/GnssMeasurementsProvider$GnssMeasurementProviderNative;)V
    ...
    iput-object p3, p0, mNative:Lcom/android/server/location/GnssMeasurementsProvider$GnssMeasurementProviderNative;
...
.method static synthetic access$100(Z)Z
    ...
    invoke-static {p0}, native_start_measurement_collection(Z)Z
...
.method static synthetic access$200()Z
    ...
    invoke-static {}, native_stop_measurement_collection()Z
...
.method public isAvailableInPlatform()Z
    ...
    iget-object v0, p0, mNative:Lcom/android/server/location/GnssMeasurementsProvider$GnssMeasurementProviderNative;
...
.method public synthetic lambda$onMeasurementsAvailable$0$GnssMeasurementsProvider(Landroid/location/GnssMeasurementsEvent;Landroid/location/IGnssMeasurementsListener;Lcom/android/server/location/CallerIdentity;)V
    ...
    invoke-virtual {p0, v0, p3}, hasPermission(Landroid/content/Context;Lcom/android/server/location/CallerIdentity;)Z
    ...
    invoke-virtual {p0, v1, v0, v2}, logPermissionDisabledEventNotReported(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public onGpsEnabledChanged()V
    ...
    invoke-virtual {p0}, tryUpdateRegistrationWithService()V
...
.method protected registerWithService()I
    ...
    :goto_0
    iget-object v5, p0, mNative:Lcom/android/server/location/GnssMeasurementsProvider$GnssMeasurementProviderNative;
    ...
    iput-boolean v3, p0, mIsCollectionStarted:Z

    iput-boolean v4, p0, mEnableFullTracking:Z
...
.method resumeIfStarted()V
    ...
    :cond_0
    iget-boolean v0, p0, mIsCollectionStarted:Z

    if-eqz v0, :cond_1

    iget-object v0, p0, mNative:Lcom/android/server/location/GnssMeasurementsProvider$GnssMeasurementProviderNative;

    iget-boolean v1, p0, mEnableFullTracking:Z
...
.method protected unregisterFromService()V
    ...
    iput-boolean v1, p0, mIsCollectionStarted:Z
