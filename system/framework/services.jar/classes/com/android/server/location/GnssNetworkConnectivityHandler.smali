...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/location/GnssNetworkConnectivityHandler$GnssNetworkListener;Landroid/os/Looper;)V
    ...
    iput-object v0, p0, mAvailableNetworkAttributes:Ljava/util/HashMap;

    iput-object p1, p0, mContext:Landroid/content/Context;

    iput-object p2, p0, mGnssNetworkListener:Lcom/android/server/location/GnssNetworkConnectivityHandler$GnssNetworkListener;
    ...
    invoke-direct {p0}, createSuplConnectivityCallback()Landroid/net/ConnectivityManager$NetworkCallback;

    move-result-object v1

    iput-object v1, p0, mSuplConnectivityCallback:Landroid/net/ConnectivityManager$NetworkCallback;
...
.method static synthetic access$300(Lcom/android/server/location/GnssNetworkConnectivityHandler;)Lcom/android/server/location/GnssNetworkConnectivityHandler$GnssNetworkListener;
    ...
    iget-object v0, p0, mGnssNetworkListener:Lcom/android/server/location/GnssNetworkConnectivityHandler$GnssNetworkListener;
...
.method static synthetic access$400(Lcom/android/server/location/GnssNetworkConnectivityHandler;Landroid/net/Network;ZLandroid/net/NetworkCapabilities;)V
    ...
    invoke-direct {p0, p1, p2, p3}, handleUpdateNetworkState(Landroid/net/Network;ZLandroid/net/NetworkCapabilities;)V
...
.method static synthetic access$500(Lcom/android/server/location/GnssNetworkConnectivityHandler;Landroid/net/Network;)V
    ...
    invoke-direct {p0, p1}, handleSuplConnectionAvailable(Landroid/net/Network;)V
...
.method static synthetic access$600(Lcom/android/server/location/GnssNetworkConnectivityHandler;I)V
    ...
    invoke-direct {p0, p1}, handleReleaseSuplConnection(I)V
...
.method private agpsDataConnStateAsString()Ljava/lang/String;
    ...
    iget v1, p0, mAGpsDataConnectionState:I
...
.method private getApnIpType(Ljava/lang/String;)I
    ...
    invoke-direct/range {p0 .. p0}, ensureInHandlerThread()V
    ...
    invoke-direct {v1, v0, v2}, translateToApnIpType(Ljava/lang/String;Ljava/lang/String;)I
...
.method private handleReleaseSuplConnection(I)V
    ...
    invoke-direct {p0}, agpsDataConnStateAsString()Ljava/lang/String;
    ...
    invoke-direct {p0, p1}, agpsDataConnStatusAsString(I)Ljava/lang/String;
    ...
    iget-object v0, p0, mConnMgr:Landroid/net/ConnectivityManager;

    iget-object v2, p0, mSuplConnectivityCallback:Landroid/net/ConnectivityManager$NetworkCallback;
...
.method private handleRequestSuplConnection(I[B)V
    ...
    iput-object v0, p0, mAGpsDataConnectionIpAddr:Ljava/net/InetAddress;

    iput p1, p0, mAGpsType:I
    ...
    iput-object v1, p0, mAGpsDataConnectionIpAddr:Ljava/net/InetAddress;
    ...
    iget-object v2, p0, mAGpsDataConnectionIpAddr:Ljava/net/InetAddress;
    ...
    invoke-direct {p0, p1}, agpsTypeAsString(I)Ljava/lang/String;
    ...
    iget-object v5, p0, mAGpsDataConnectionIpAddr:Ljava/net/InetAddress;
    ...
    iget v1, p0, mAGpsType:I

    invoke-direct {p0, v1}, getNetworkCapability(I)I
    ...
    iget-object v3, p0, mSuplConnectivityCallback:Landroid/net/ConnectivityManager$NetworkCallback;
...
.method private handleSuplConnectionAvailable(Landroid/net/Network;)V
    ...
    :cond_3
    invoke-direct {p0, v1}, getApnIpType(Ljava/lang/String;)I
    ...
    invoke-direct {p0, v3, v4, v1, v2}, native_agps_data_conn_open(JLjava/lang/String;I)V
...
.method private handleUpdateNetworkState(Landroid/net/Network;ZLandroid/net/NetworkCapabilities;)V
    ...
    invoke-direct {v9, v11, v10, v2}, updateTrackedNetworksState(ZLandroid/net/Network;Landroid/net/NetworkCapabilities;)Lcom/android/server/location/GnssNetworkConnectivityHandler$NetworkAttributes;
    ...
    invoke-direct/range {p0 .. p0}, agpsDataConnStateAsString()Ljava/lang/String;
    ...
    iget-object v3, v9, mAvailableNetworkAttributes:Ljava/util/HashMap;
    ...
    invoke-direct/range {v0 .. v8}, native_update_network_state(ZIZZLjava/lang/String;JS)V
...
.method private updateTrackedNetworksState(ZLandroid/net/Network;Landroid/net/NetworkCapabilities;)Lcom/android/server/location/GnssNetworkConnectivityHandler$NetworkAttributes;
    ...
    iget-object v0, p0, mAvailableNetworkAttributes:Ljava/util/HashMap;
    ...
    :cond_2
    iget-object v2, p0, mAvailableNetworkAttributes:Ljava/util/HashMap;
...
.method public synthetic lambda$onReportAGpsStatus$0$GnssNetworkConnectivityHandler(I[B)V
    ...
    invoke-direct {p0, p1, p2}, handleRequestSuplConnection(I[B)V
...
.method public synthetic lambda$onReportAGpsStatus$1$GnssNetworkConnectivityHandler()V
    ...
    invoke-direct {p0, v0}, handleReleaseSuplConnection(I)V
...
.method onReportAGpsStatus(II[B)V
    ...
    invoke-direct {p0, p2}, agpsDataConnStatusAsString(I)Ljava/lang/String;
...
.method registerNetworkCallbacks()V
    ...
    invoke-direct {p0}, createNetworkConnectivityCallback()Landroid/net/ConnectivityManager$NetworkCallback;

    move-result-object v2

    iput-object v2, p0, mNetworkConnectivityCallback:Landroid/net/ConnectivityManager$NetworkCallback;

    iget-object v2, p0, mConnMgr:Landroid/net/ConnectivityManager;

    iget-object v3, p0, mNetworkConnectivityCallback:Landroid/net/ConnectivityManager$NetworkCallback;
