...
.method protected constructor <init>(Landroid/content/Context;Landroid/os/Handler;Ljava/lang/String;)V
    ...
    iput-object p3, p0, mTag:Ljava/lang/String;
...
.method private foreachUnsafe(Lcom/android/server/location/RemoteListenerHelper$ListenerOperation;)V
    ...
    invoke-direct {p0, v1, p1}, post(Lcom/android/server/location/RemoteListenerHelper$IdentifiedListener;Lcom/android/server/location/RemoteListenerHelper$ListenerOperation;)V
...
.method public addListener(Landroid/os/IInterface;Lcom/android/server/location/CallerIdentity;)V
    ...
    :cond_1
    iget-boolean v3, p0, mHasIsSupported:Z

    if-eqz v3, :cond_2

    iget-boolean v3, p0, mIsSupported:Z
    ...
    invoke-direct {p0}, tryRegister()V
    ...
    invoke-direct {p0, v2, v5}, post(Lcom/android/server/location/RemoteListenerHelper$IdentifiedListener;Lcom/android/server/location/RemoteListenerHelper$ListenerOperation;)V
...
.method protected setSupported(Z)V
    ...
    :try_start_0
    iput-boolean v1, p0, mHasIsSupported:Z
...
.method protected updateResult()V
    ...
    iget v2, p0, mLastReportedResult:I
    ...
    invoke-direct {p0, v2}, foreachUnsafe(Lcom/android/server/location/RemoteListenerHelper$ListenerOperation;)V

    iput v1, p0, mLastReportedResult:I
