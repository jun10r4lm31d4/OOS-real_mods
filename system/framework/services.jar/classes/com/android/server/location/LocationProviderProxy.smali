...
.method private constructor <init>(Landroid/content/Context;Lcom/android/server/location/AbstractLocationProvider$LocationProviderManager;Ljava/lang/String;III)V
    ...
    iput-object v0, v9, mProviderPackagesLock:Ljava/lang/Object;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, v9, mRequestLock:Ljava/lang/Object;
    ...
    iput-object v0, v9, mManager:Lcom/android/internal/location/ILocationProviderManager$Stub;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, v9, mProviderPackages:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iput-object v10, v9, mServiceWatcher:Lcom/android/server/ServiceWatcher;

    const/4 v0, 0x0

    iput-object v0, v9, mRequest:Lcom/android/internal/location/ProviderRequest;

    new-instance v0, Landroid/os/WorkSource;

    invoke-direct {v0}, Landroid/os/WorkSource;-><init>()V

    iput-object v0, v9, mWorkSource:Landroid/os/WorkSource;
...
.method static synthetic access$000(Lcom/android/server/location/LocationProviderProxy;Ljava/util/List;)V
    ...
    invoke-direct {p0, p1}, onSetAdditionalProviderPackages(Ljava/util/List;)V
...
.method static synthetic access$100(Lcom/android/server/location/LocationProviderProxy;Ljava/util/List;)V
    ...
    invoke-direct {p0, p1}, resetProviderPackages(Ljava/util/List;)V
...
.method static synthetic access$200(Lcom/android/server/location/LocationProviderProxy;Landroid/os/IBinder;)V
    ...
    invoke-direct {p0, p1}, initializeService(Landroid/os/IBinder;)V
...
.method public static createAndBind(Landroid/content/Context;Lcom/android/server/location/AbstractLocationProvider$LocationProviderManager;Ljava/lang/String;III)Lcom/android/server/location/LocationProviderProxy;
    ...
    invoke-direct/range {v0 .. v6}, <init>(Landroid/content/Context;Lcom/android/server/location/AbstractLocationProvider$LocationProviderManager;Ljava/lang/String;III)V
...
.method private initializeService(Landroid/os/IBinder;)V
    ...
    invoke-direct {p0, v1}, resetProviderPackages(Ljava/util/List;)V

    iget-object v1, p0, mManager:Lcom/android/internal/location/ILocationProviderManager$Stub;
    ...
    iget-object v1, p0, mRequestLock:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, mRequest:Lcom/android/internal/location/ProviderRequest;

    if-eqz v2, :cond_1

    iget-object v2, p0, mRequest:Lcom/android/internal/location/ProviderRequest;

    iget-object v3, p0, mWorkSource:Landroid/os/WorkSource;
...
.method private resetProviderPackages(Ljava/util/List;)V
    ...
    :cond_0
    iget-object v1, p0, mProviderPackagesLock:Ljava/lang/Object;

    monitor-enter v1

    :try_start_1
    iget-object v2, p0, mProviderPackages:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iget-object v3, p0, mProviderPackages:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v1, p0, mServiceWatcher:Lcom/android/server/ServiceWatcher;
    ...
    iget-object v0, p0, mProviderPackagesLock:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, mProviderPackages:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public setRequest(Lcom/android/internal/location/ProviderRequest;Landroid/os/WorkSource;)V
    ...
    iget-object v0, p0, mRequestLock:Ljava/lang/Object;
