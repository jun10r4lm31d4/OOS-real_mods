...
.method constructor <init>(Landroid/content/Context;Landroid/hardware/contexthub/V1_0/IContexthub;)V
    ...
    iput-object v0, p0, mHostEndPointIdToClientMap:Ljava/util/concurrent/ConcurrentHashMap;

    const/4 v0, 0x0

    iput v0, p0, mNextHostEndPointId:I
...
.method private broadcastMessage(ILandroid/hardware/location/NanoAppMessage;)V
    ...
    invoke-direct {p0, p1, v0}, forEachClientOfHub(ILjava/util/function/Consumer;)V
...
.method private forEachClientOfHub(ILjava/util/function/Consumer;)V
    ...
    iget-object v0, p0, mHostEndPointIdToClientMap:Ljava/util/concurrent/ConcurrentHashMap;
...
.method private getHostEndPointId()S
    ...
    iget v0, p0, mNextHostEndPointId:I
    ...
    iget-object v3, p0, mHostEndPointIdToClientMap:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :goto_1
    iput v4, p0, mNextHostEndPointId:I
...
.method onMessageFromNanoApp(ILandroid/hardware/contexthub/V1_0/ContextHubMsg;)V
    ...
    invoke-direct {p0, p1, v0}, broadcastMessage(ILandroid/hardware/location/NanoAppMessage;)V

    goto :goto_0

    :cond_0
    iget-object v1, p0, mHostEndPointIdToClientMap:Ljava/util/concurrent/ConcurrentHashMap;
...
.method registerClient(Landroid/hardware/location/ContextHubInfo;Landroid/app/PendingIntent;J)Landroid/hardware/location/IContextHubClient;
    ...
    :try_start_1
    invoke-direct {v10, v0, v12, v13, v14}, getClientBroker(ILandroid/app/PendingIntent;J)Lcom/android/server/location/ContextHubClientBroker;

    move-result-object v0

    if-nez v0, :cond_0

    invoke-direct/range {p0 .. p0}, getHostEndPointId()S
    ...
    iget-object v3, v10, mContextHubProxy:Landroid/hardware/contexthub/V1_0/IContexthub;
    ...
    iget-object v1, v10, mHostEndPointIdToClientMap:Ljava/util/concurrent/ConcurrentHashMap;
...
.method registerClient(Landroid/hardware/location/ContextHubInfo;Landroid/hardware/location/IContextHubClientCallback;)Landroid/hardware/location/IContextHubClient;
    ...
    :try_start_0
    invoke-direct {p0}, getHostEndPointId()S
    ...
    iget-object v2, p0, mContextHubProxy:Landroid/hardware/contexthub/V1_0/IContexthub;
