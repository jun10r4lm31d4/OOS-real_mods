...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mCallbacksList:Landroid/os/RemoteCallbackList;
    ...
    iput-object v0, p0, mNanoAppStateManager:Lcom/android/server/location/NanoAppStateManager;

    iput-object p1, p0, mContext:Landroid/content/Context;

    invoke-direct {p0}, getContextHubProxy()Landroid/hardware/contexthub/V1_0/IContexthub;

    move-result-object v0

    iput-object v0, p0, mContextHubProxy:Landroid/hardware/contexthub/V1_0/IContexthub;

    iget-object v0, p0, mContextHubProxy:Landroid/hardware/contexthub/V1_0/IContexthub;

    if-nez v0, :cond_0

    const/4 v0, 0x0

    iput-object v0, p0, mTransactionManager:Lcom/android/server/location/ContextHubTransactionManager;

    iput-object v0, p0, mClientManager:Lcom/android/server/location/ContextHubClientManager;

    invoke-static {}, Ljava/util/Collections;->emptyMap()Ljava/util/Map;

    move-result-object v0

    iput-object v0, p0, mDefaultClientMap:Ljava/util/Map;

    invoke-static {}, Ljava/util/Collections;->emptyMap()Ljava/util/Map;

    move-result-object v0

    iput-object v0, p0, mContextHubIdToInfoMap:Ljava/util/Map;

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object v0

    iput-object v0, p0, mContextHubInfoList:Ljava/util/List;
    ...
    iput-object v1, p0, mClientManager:Lcom/android/server/location/ContextHubClientManager;

    new-instance v0, Lcom/android/server/location/ContextHubTransactionManager;

    iget-object v1, p0, mContextHubProxy:Landroid/hardware/contexthub/V1_0/IContexthub;

    iget-object v2, p0, mClientManager:Lcom/android/server/location/ContextHubClientManager;

    iget-object v3, p0, mNanoAppStateManager:Lcom/android/server/location/NanoAppStateManager;
    ...
    iput-object v2, p0, mContextHubIdToInfoMap:Ljava/util/Map;

    new-instance v2, Ljava/util/ArrayList;

    iget-object v3, p0, mContextHubIdToInfoMap:Ljava/util/Map;
    ...
    iput-object v2, p0, mContextHubInfoList:Ljava/util/List;
    ...
    iget-object v5, p0, mContextHubIdToInfoMap:Ljava/util/Map;
    ...
    iget-object v6, p0, mClientManager:Lcom/android/server/location/ContextHubClientManager;

    invoke-direct {p0, v4}, createDefaultClientCallback(I)Landroid/hardware/location/IContextHubClientCallback;
    ...
    :try_start_0
    iget-object v7, p0, mContextHubProxy:Landroid/hardware/contexthub/V1_0/IContexthub;
    ...
    :goto_1
    invoke-direct {p0, v4}, queryNanoAppsInternal(I)I
...
.method static synthetic access$000(Lcom/android/server/location/ContextHubService;ILandroid/hardware/contexthub/V1_0/ContextHubMsg;)V
    ...
    invoke-direct {p0, p1, p2}, handleClientMessageCallback(ILandroid/hardware/contexthub/V1_0/ContextHubMsg;)V
...
.method static synthetic access$100(Lcom/android/server/location/ContextHubService;III)V
    ...
    invoke-direct {p0, p1, p2, p3}, handleTransactionResultCallback(III)V
...
.method static synthetic access$200(Lcom/android/server/location/ContextHubService;II)V
    ...
    invoke-direct {p0, p1, p2}, handleHubEventCallback(II)V
...
.method static synthetic access$300(Lcom/android/server/location/ContextHubService;IJI)V
    ...
    invoke-direct {p0, p1, p2, p3, p4}, handleAppAbortCallback(IJI)V
...
.method static synthetic access$400(Lcom/android/server/location/ContextHubService;ILjava/util/List;)V
    ...
    invoke-direct {p0, p1, p2}, handleQueryAppsCallback(ILjava/util/List;)V
...
.method static synthetic access$500(Lcom/android/server/location/ContextHubService;)Lcom/android/server/location/NanoAppStateManager;
    ...
    iget-object v0, p0, mNanoAppStateManager:Lcom/android/server/location/NanoAppStateManager;
...
.method static synthetic access$600(Lcom/android/server/location/ContextHubService;III[B)I
    ...
    invoke-direct {p0, p1, p2, p3, p4}, onMessageReceiptOldApi(III[B)I
...
.method static synthetic access$700(Lcom/android/server/location/ContextHubService;IILandroid/hardware/location/NanoAppBinary;)V
    ...
    invoke-direct {p0, p1, p2, p3}, handleLoadResponseOldApi(IILandroid/hardware/location/NanoAppBinary;)V
...
.method static synthetic access$800(Lcom/android/server/location/ContextHubService;II)V
    ...
    invoke-direct {p0, p1, p2}, handleUnloadResponseOldApi(II)V
...
.method private checkHalProxyAndContextHubId(ILandroid/hardware/location/IContextHubTransactionCallback;I)Z
    ...
    :cond_0
    invoke-direct {p0, p1}, isValidContextHubId(I)Z
...
.method private handleAppAbortCallback(IJI)V
    ...
    iget-object v0, p0, mClientManager:Lcom/android/server/location/ContextHubClientManager;
...
.method private handleHubEventCallback(II)V
    ...
    iget-object v0, p0, mTransactionManager:Lcom/android/server/location/ContextHubTransactionManager;

    invoke-virtual {v0}, Lcom/android/server/location/ContextHubTransactionManager;->onHubReset()V

    invoke-direct {p0, p1}, queryNanoAppsInternal(I)I
...
.method private handleLoadResponseOldApi(IILandroid/hardware/location/NanoAppBinary;)V
    ...
    iget-object v1, p0, mNanoAppStateManager:Lcom/android/server/location/NanoAppStateManager;
    ...
    invoke-direct {p0, v2, p1, v3, v0}, onMessageReceiptOldApi(III[B)I
...
.method private handleQueryAppsCallback(ILjava/util/List;)V
    ...
    iget-object v1, p0, mTransactionManager:Lcom/android/server/location/ContextHubTransactionManager;
...
.method private handleUnloadResponseOldApi(II)V
    ...
    invoke-direct {p0, v1, p1, v2, v0}, onMessageReceiptOldApi(III[B)I
...
.method private isValidContextHubId(I)Z
    ...
    iget-object v0, p0, mContextHubIdToInfoMap:Ljava/util/Map;
...
.method private onMessageReceiptOldApi(III[B)I
    ...
    iget-object v1, p0, mCallbacksList:Landroid/os/RemoteCallbackList;
    ...
    iget-object v5, p0, mCallbacksList:Landroid/os/RemoteCallbackList;
    ...
    :cond_2
    iget-object v4, p0, mCallbacksList:Landroid/os/RemoteCallbackList;
...
.method private queryNanoAppsInternal(I)I
    ...
    invoke-direct {p0, p1}, createQueryTransactionCallback(I)Landroid/hardware/location/IContextHubTransactionCallback;
    ...
    iget-object v2, p0, mTransactionManager:Lcom/android/server/location/ContextHubTransactionManager;
...
.method public createClient(ILandroid/hardware/location/IContextHubClientCallback;)Landroid/hardware/location/IContextHubClient;
    ...
    iget-object v1, p0, mClientManager:Lcom/android/server/location/ContextHubClientManager;
...
.method public disableNanoApp(ILandroid/hardware/location/IContextHubTransactionCallback;J)V
    ...
    invoke-direct {p0, p1, p2, v0}, checkHalProxyAndContextHubId(ILandroid/hardware/location/IContextHubTransactionCallback;I)Z
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v1, p0, mContextHubIdToInfoMap:Ljava/util/Map;
...
.method public getContextHubs()Ljava/util/List;
    ...
    iget-object v0, p0, mContextHubInfoList:Ljava/util/List;
...
.method public loadNanoApp(ILandroid/hardware/location/NanoApp;)I
    ...
    invoke-direct {p0, p1, v0}, createLoadTransactionCallback(ILandroid/hardware/location/NanoAppBinary;)Landroid/hardware/location/IContextHubTransactionCallback;
    ...
    iget-object v3, p0, mTransactionManager:Lcom/android/server/location/ContextHubTransactionManager;
...
.method public registerCallback(Landroid/hardware/location/IContextHubCallback;)I
    ...
    iget-object v0, p0, mCallbacksList:Landroid/os/RemoteCallbackList;
...
.method public sendMessage(IILandroid/hardware/location/ContextHubMessage;)I
    ...
    :cond_6
    invoke-virtual {p0, p2}, getNanoAppInstanceInfo(I)Landroid/hardware/location/NanoAppInstanceInfo;
    ...
    iget-object v6, p0, mDefaultClientMap:Ljava/util/Map;
...
.method public unloadNanoApp(I)I
    ...
    invoke-direct {p0, v1}, createUnloadTransactionCallback(I)Landroid/hardware/location/IContextHubTransactionCallback;

    move-result-object v4

    iget-object v5, p0, mTransactionManager:Lcom/android/server/location/ContextHubTransactionManager;
    ...
    iget-object v6, p0, mTransactionManager:Lcom/android/server/location/ContextHubTransactionManager;
