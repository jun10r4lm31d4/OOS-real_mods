...
.method public synthetic constructor <init>(Lcom/android/server/location/GnssStatusListenerHelper;I[I[F[F[F[F)V
    ...
    iput-object p1, p0, f$0:Lcom/android/server/location/GnssStatusListenerHelper;

    iput p2, p0, f$1:I

    iput-object p3, p0, f$2:[I

    iput-object p4, p0, f$3:[F

    iput-object p5, p0, f$4:[F

    iput-object p6, p0, f$5:[F

    iput-object p7, p0, f$6:[F
...
.method public final execute(Landroid/os/IInterface;Lcom/android/server/location/CallerIdentity;)V
    ...
    iget-object v0, p0, f$0:Lcom/android/server/location/GnssStatusListenerHelper;

    iget v1, p0, f$1:I

    iget-object v2, p0, f$2:[I

    iget-object v3, p0, f$3:[F

    iget-object v4, p0, f$4:[F

    iget-object v5, p0, f$5:[F

    iget-object v6, p0, f$6:[F
