...
.method private addToLogs(Landroid/location/Country;)V
    ...
    :try_start_0
    iget-object v1, p0, mLastCountryAddedToLogs:Landroid/location/Country;
...
.method runAfterDetection(Landroid/location/Country;Landroid/location/Country;ZZ)V
    ...
    iget-object v1, p0, mLocationBasedCountryDetectionListener:Landroid/location/CountryListener;

    invoke-direct {p0, v1}, startLocationBasedDetector(Landroid/location/CountryListener;)V
...
.method public setCountryListener(Landroid/location/CountryListener;)V
    ...
    iput-wide v1, p0, mStopTime:J

    iget-wide v1, p0, mTotalTime:J

    iget-wide v3, p0, mStopTime:J

    add-long/2addr v1, v3

    iput-wide v1, p0, mTotalTime:J
    ...
    invoke-direct {p0, v2, v1}, detectCountry(ZZ)Landroid/location/Country;

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J

    move-result-wide v3

    iput-wide v3, p0, mStartTime:J

    const-wide/16 v3, 0x0

    iput-wide v3, p0, mStopTime:J

    iput v2, p0, mCountServiceStateChanges:I
...
.method public toString()Ljava/lang/String;
    ...
    iget-wide v7, p0, mStopTime:J

    iget-wide v9, p0, mStartTime:J
    ...
    iget v7, p0, mTotalCountServiceStateChanges:I
    ...
    iget v7, p0, mCountServiceStateChanges:I
    ...
    iget-object v5, p0, mDebugLogs:Ljava/util/concurrent/ConcurrentLinkedQueue;
