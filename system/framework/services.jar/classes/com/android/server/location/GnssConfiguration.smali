...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mOpGnssConfiguration:Lcom/android/server/location/OpGnssConfiguration;
...
.method static synthetic access$000(Lcom/android/server/location/GnssConfiguration$HalInterfaceVersion;)Z
    ...
    invoke-static {p0}, isConfigSuplEsSupported(Lcom/android/server/location/GnssConfiguration$HalInterfaceVersion;)Z
...
.method static synthetic access$100(Lcom/android/server/location/GnssConfiguration$HalInterfaceVersion;)Z
    ...
    invoke-static {p0}, isConfigGpsLockSupported(Lcom/android/server/location/GnssConfiguration$HalInterfaceVersion;)Z
...
.method static synthetic access$200(I)Z
    ...
    invoke-static {p0}, native_set_gps_lock(I)Z
...
.method static synthetic access$300(I)Z
    ...
    invoke-static {p0}, native_set_emergency_supl_pdn(I)Z
...
.method static synthetic access$400(I)Z
    ...
    invoke-static {p0}, native_set_gnss_pos_protocol_select(I)Z
...
.method static synthetic access$500(I)Z
    ...
    invoke-static {p0}, native_set_lpp_profile(I)Z
...
.method static synthetic access$600(I)Z
    ...
    invoke-static {p0}, native_set_supl_es(I)Z
...
.method static synthetic access$700(I)Z
    ...
    invoke-static {p0}, native_set_supl_mode(I)Z
...
.method static synthetic access$800(I)Z
    ...
    invoke-static {p0}, native_set_supl_version(I)Z
...
.method private getRangeCheckedConfigEsExtensionSec()I
    ...
    invoke-direct {p0, v0, v1}, getIntConfig(Ljava/lang/String;I)I
...
.method private logConfigurations()V
    ...
    invoke-virtual {p0}, getSuplHost()Ljava/lang/String;

    move-result-object v1

    const/4 v0, 0x0

    invoke-virtual {p0, v0}, getSuplPort(I)I

    move-result v2

    invoke-virtual {p0}, getC2KHost()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {p0, v0}, getC2KPort(I)I

    move-result v4

    const-string v5, "SUPL_VER"

    invoke-direct {p0, v5, v0}, getIntConfig(Ljava/lang/String;I)I

    move-result v5

    invoke-virtual {p0, v0}, getSuplMode(I)I

    move-result v6

    invoke-virtual {p0, v0}, getSuplEs(I)I
    ...
    invoke-direct {p0, v9, v0}, getIntConfig(Ljava/lang/String;I)I

    move-result v9

    const-string v10, "A_GLONASS_POS_PROTOCOL_SELECT"

    invoke-direct {p0, v10, v0}, getIntConfig(Ljava/lang/String;I)I

    move-result v10

    const-string v11, "USE_EMERGENCY_PDN_FOR_EMERGENCY_SUPL"

    invoke-direct {p0, v11, v0}, getIntConfig(Ljava/lang/String;I)I
    ...
    invoke-direct {p0, v8, v0}, getIntConfig(Ljava/lang/String;I)I

    move-result v12

    invoke-virtual {p0}, getEsExtensionSec()I
...
.method getC2KPort(I)I
    ...
    invoke-direct {p0, v0, p1}, getIntConfig(Ljava/lang/String;I)I
...
.method getProxyApps()Ljava/util/List;
    ...
    iget-object v0, p0, mOpGnssConfiguration:Lcom/android/server/location/OpGnssConfiguration;
...
.method loadPropertiesFromCarrierConfig()V
    ...
    iget-object v8, p0, mProperties:Ljava/util/Properties;
...
.method reloadGpsProperties()V
    ...
    :cond_0
    invoke-virtual {p0}, loadPropertiesFromCarrierConfig()V
    ...
    :cond_1
    iget-object v2, p0, mOpGnssConfiguration:Lcom/android/server/location/OpGnssConfiguration;
    ...
    invoke-direct {p0, v2}, loadPropertiesFromGpsDebugConfig(Ljava/util/Properties;)V

    invoke-direct {p0}, getRangeCheckedConfigEsExtensionSec()I

    move-result v2

    iput v2, p0, mEsExtensionSec:I

    invoke-direct {p0}, logConfigurations()V

    invoke-static {}, native_get_gnss_configuration_version()Lcom/android/server/location/GnssConfiguration$HalInterfaceVersion;

    move-result-object v2

    if-eqz v2, :cond_6

    invoke-static {v2}, isConfigEsExtensionSecSupported(Lcom/android/server/location/GnssConfiguration$HalInterfaceVersion;)Z

    move-result v3

    if-eqz v3, :cond_2

    iget v3, p0, mEsExtensionSec:I

    invoke-static {v3}, native_set_es_extension_sec(I)Z
...
.method setSatelliteBlacklist([I[I)V
    ...
    invoke-static {p1, p2}, native_set_satellite_blacklist([I[I)Z
