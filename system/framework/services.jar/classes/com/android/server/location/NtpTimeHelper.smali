...
.method constructor <init>(Landroid/content/Context;Landroid/os/Looper;Lcom/android/server/location/NtpTimeHelper$InjectNtpTimeCallback;)V
    ...
    invoke-direct {p0, p1, p2, p3, v0}, <init>(Landroid/content/Context;Landroid/os/Looper;Lcom/android/server/location/NtpTimeHelper$InjectNtpTimeCallback;Landroid/util/NtpTrustedTime;)V
...
.method constructor <init>(Landroid/content/Context;Landroid/os/Looper;Lcom/android/server/location/NtpTimeHelper$InjectNtpTimeCallback;Landroid/util/NtpTrustedTime;)V
    ...
    iput-object v0, p0, mNtpBackOff:Lcom/android/server/location/ExponentialBackOff;

    const/4 v0, 0x0

    iput v0, p0, mInjectNtpTimeState:I
    ...
    iput-object p3, p0, mCallback:Lcom/android/server/location/NtpTimeHelper$InjectNtpTimeCallback;

    iput-object p4, p0, mNtpTime:Landroid/util/NtpTrustedTime;
...
.method private blockingGetNtpTimeAndInject()V
    ...
    iget-object v1, v9, mNtpTime:Landroid/util/NtpTrustedTime;
    ...
    :try_start_0
    iput v0, v9, mInjectNtpTimeState:I
    ...
    :cond_1
    iget-object v15, v9, mHandler:Landroid/os/Handler;
    ...
    iget-object v2, v9, mNtpBackOff:Lcom/android/server/location/ExponentialBackOff;
    ...
    iget-object v0, v9, mNtpBackOff:Lcom/android/server/location/ExponentialBackOff;
    ...
    iget-boolean v6, v9, mOnDemandTimeInjection:Z
    ...
    :cond_3
    iget-boolean v0, v9, mOnDemandTimeInjection:Z
    ...
    :cond_4
    iget-object v0, v9, mHandler:Landroid/os/Handler;
    ...
    :try_start_1
    iget-object v0, v9, mWakeLock:Landroid/os/PowerManager$WakeLock;
...
.method public static synthetic lambda$xWqlqJuq4jBJ5-xhFLCwEKGVB0k(Lcom/android/server/location/NtpTimeHelper;)V
    ...
    invoke-direct {p0}, blockingGetNtpTimeAndInject()V
...
.method declared-synchronized enablePeriodicTimeInjection()V
    ...
    :try_start_0
    iput-boolean v0, p0, mOnDemandTimeInjection:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public synthetic lambda$blockingGetNtpTimeAndInject$0$NtpTimeHelper(JJJ)V
    ...
    iget-object v0, p0, mCallback:Lcom/android/server/location/NtpTimeHelper$InjectNtpTimeCallback;
...
.method declared-synchronized onNetworkAvailable()V
    ...
    :try_start_0
    iget v0, p0, mInjectNtpTimeState:I

    if-nez v0, :cond_0

    invoke-virtual {p0}, retrieveAndInjectNtpTime()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method declared-synchronized retrieveAndInjectNtpTime()V
    ...
    :cond_1
    :try_start_2
    iput v1, p0, mInjectNtpTimeState:I
