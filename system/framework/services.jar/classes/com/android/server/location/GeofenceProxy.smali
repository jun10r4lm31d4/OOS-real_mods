...
.method private constructor <init>(Landroid/content/Context;IIILandroid/location/IGpsGeofenceHardware;Landroid/location/IFusedGeofenceHardware;)V
    ...
    iput-object v0, v9, mUpdateGeofenceHardware:Lcom/android/server/ServiceWatcher$BinderRunner;
    ...
    iput-object v11, v9, mServiceWatcher:Lcom/android/server/ServiceWatcher;

    move-object/from16 v0, p5

    iput-object v0, v9, mGpsGeofenceHardware:Landroid/location/IGpsGeofenceHardware;

    move-object/from16 v1, p6

    iput-object v1, v9, mFusedGeofenceHardware:Landroid/location/IFusedGeofenceHardware;

    const/4 v2, 0x0

    iput-object v2, v9, mGeofenceHardware:Landroid/hardware/location/IGeofenceHardware;
...
.method static synthetic access$000(Lcom/android/server/location/GeofenceProxy;)Lcom/android/server/ServiceWatcher$BinderRunner;
    ...
    iget-object v0, p0, mUpdateGeofenceHardware:Lcom/android/server/ServiceWatcher$BinderRunner;
...
.method static synthetic access$200(Lcom/android/server/location/GeofenceProxy;)Landroid/location/IGpsGeofenceHardware;
    ...
    iget-object v0, p0, mGpsGeofenceHardware:Landroid/location/IGpsGeofenceHardware;
...
.method static synthetic access$300(Lcom/android/server/location/GeofenceProxy;)Landroid/location/IFusedGeofenceHardware;
    ...
    iget-object v0, p0, mFusedGeofenceHardware:Landroid/location/IFusedGeofenceHardware;
...
.method public static createAndBind(Landroid/content/Context;IIILandroid/location/IGpsGeofenceHardware;Landroid/location/IFusedGeofenceHardware;)Lcom/android/server/location/GeofenceProxy;
    ...
    invoke-direct/range {v0 .. v6}, <init>(Landroid/content/Context;IIILandroid/location/IGpsGeofenceHardware;Landroid/location/IFusedGeofenceHardware;)V
