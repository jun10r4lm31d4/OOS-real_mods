...
.method public declared-synchronized detectCountry()Landroid/location/Country;
    ...
    :try_start_0
    iget-object v0, p0, mLocationListeners:Ljava/util/List;
    ...
    invoke-virtual {p0, v3, v4}, registerListener(Ljava/lang/String;Landroid/location/LocationListener;)V
    ...
    invoke-direct {p0, v2}, queryCountryCode(Landroid/location/Location;)V

    :goto_1
    iget-object v2, p0, mDetectedCountry:Landroid/location/Country;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method protected getLastKnownLocation()Landroid/location/Location;
    ...
    iget-object v6, p0, mLocationManager:Landroid/location/LocationManager;
...
.method public declared-synchronized stop()V
    ...
    invoke-virtual {p0, v2}, unregisterListener(Landroid/location/LocationListener;)V

    goto :goto_0

    :cond_0
    iput-object v1, p0, mLocationListeners:Ljava/util/List;
    ...
    iput-object v1, p0, mTimer:Ljava/util/Timer;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
