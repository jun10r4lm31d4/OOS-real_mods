...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/location/LocationBlacklist;)V
    ...
    iput-object v0, p0, mFences:Ljava/util/List;
    ...
    iput-object v2, p0, mHandler:Lcom/android/server/location/GeofenceManager$GeofenceHandler;
    ...
    invoke-direct {p0}, updateMinInterval()V
    ...
    iget-object v5, p0, mHandler:Lcom/android/server/location/GeofenceManager$GeofenceHandler;
...
.method private scheduleUpdateFencesLocked()V
    ...
    iget-object v1, p0, mHandler:Lcom/android/server/location/GeofenceManager$GeofenceHandler;
...
.method private sendIntent(Landroid/app/PendingIntent;Landroid/content/Intent;)V
    ...
    invoke-virtual {p0, v0, p1}, removeFence(Landroid/location/Geofence;Landroid/app/PendingIntent;)V
...
.method private updateFences()V
    ...
    iget-object v9, v1, mFences:Ljava/util/List;
    ...
    iget-object v12, v1, mBlacklist:Lcom/android/server/location/LocationBlacklist;
    ...
    iget-object v13, v1, mAppOps:Landroid/app/AppOpsManager;
    ...
    iget-wide v14, v1, mEffectiveMinIntervalMs:J
    ...
    :cond_7
    iget-wide v9, v1, mEffectiveMinIntervalMs:J

    :goto_1
    iget-boolean v0, v1, mReceivingLocationUpdates:Z

    if-eqz v0, :cond_8

    iget-wide v12, v1, mLocationUpdateInterval:J
    ...
    :cond_8
    iput-boolean v11, v1, mReceivingLocationUpdates:Z

    iput-wide v9, v1, mLocationUpdateInterval:J

    iput-object v5, v1, mLastLocationUpdate:Landroid/location/Location;
    ...
    iget-object v11, v1, mLocationManager:Landroid/location/LocationManager;

    iget-object v12, v1, mHandler:Lcom/android/server/location/GeofenceManager$GeofenceHandler;
    ...
    :cond_a
    iget-boolean v9, v1, mReceivingLocationUpdates:Z
    ...
    iget-object v0, v1, mLocationManager:Landroid/location/LocationManager;
    ...
    iget-object v10, v1, mFences:Ljava/util/List;
    ...
    iget-boolean v10, v1, mReceivingLocationUpdates:Z
    ...
    iget-wide v10, v1, mLocationUpdateInterval:J
    ...
    iget-object v10, v1, mLastLocationUpdate:Landroid/location/Location;
    ...
    invoke-direct {v1, v4}, sendIntentExit(Landroid/app/PendingIntent;)V
    ...
    invoke-direct {v1, v4}, sendIntentEnter(Landroid/app/PendingIntent;)V
...
.method private updateMinInterval()V
    ...
    iput-wide v0, p0, mEffectiveMinIntervalMs:J
...
.method public addFence(Landroid/location/LocationRequest;Landroid/location/Geofence;Landroid/app/PendingIntent;IILjava/lang/String;)V
    ...
    :try_start_0
    iget-object v0, v1, mFences:Ljava/util/List;
    ...
    iget-object v4, v1, mFences:Ljava/util/List;
    ...
    iget-object v5, v1, mFences:Ljava/util/List;
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    iget-object v0, p0, mFences:Ljava/util/List;
...
.method public onLocationChanged(Landroid/location/Location;)V
    ...
    :try_start_0
    iget-boolean v1, p0, mReceivingLocationUpdates:Z
    ...
    :cond_0
    iget-boolean v1, p0, mPendingUpdate:Z
    ...
    :cond_1
    iput-boolean v2, p0, mPendingUpdate:Z
...
.method public removeFence(Landroid/location/Geofence;Landroid/app/PendingIntent;)V
    ...
    :try_start_0
    iget-object v1, p0, mFences:Ljava/util/List;
