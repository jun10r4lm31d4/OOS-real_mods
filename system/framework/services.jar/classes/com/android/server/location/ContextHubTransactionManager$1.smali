...
.method constructor <init>(Lcom/android/server/location/ContextHubTransactionManager;IILandroid/hardware/location/NanoAppBinary;ILandroid/hardware/location/IContextHubTransactionCallback;)V
    ...
    iput-object p1, p0, this$0:Lcom/android/server/location/ContextHubTransactionManager;

    iput-object p4, p0, val$nanoAppBinary:Landroid/hardware/location/NanoAppBinary;

    iput p5, p0, val$contextHubId:I

    iput-object p6, p0, val$onCompleteCallback:Landroid/hardware/location/IContextHubTransactionCallback;
...
.method onTransact()I
    ...
    iget-object v0, p0, val$nanoAppBinary:Landroid/hardware/location/NanoAppBinary;
    ...
    :try_start_0
    iget-object v1, p0, this$0:Lcom/android/server/location/ContextHubTransactionManager;
    ...
    iget v2, p0, val$contextHubId:I

    invoke-virtual {p0}, getTransactionId()I
    ...
    iget-object v3, p0, val$nanoAppBinary:Landroid/hardware/location/NanoAppBinary;
...
.method onTransactionComplete(I)V
    ...
    iget-object v0, p0, this$0:Lcom/android/server/location/ContextHubTransactionManager;
    ...
    iget v1, p0, val$contextHubId:I

    iget-object v2, p0, val$nanoAppBinary:Landroid/hardware/location/NanoAppBinary;

    invoke-virtual {v2}, Landroid/hardware/location/NanoAppBinary;->getNanoAppId()J

    move-result-wide v2

    iget-object v4, p0, val$nanoAppBinary:Landroid/hardware/location/NanoAppBinary;
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, val$onCompleteCallback:Landroid/hardware/location/IContextHubTransactionCallback;
