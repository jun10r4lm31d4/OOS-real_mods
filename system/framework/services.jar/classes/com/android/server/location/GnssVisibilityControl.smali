...
.method static constructor <clinit>()V
    ...
    sput-object v0, NO_LOCATION_ENABLED_PROXY_APPS:[Ljava/lang/String;
...
.method constructor <init>(Landroid/content/Context;Landroid/os/Looper;Lcom/android/internal/location/GpsNetInitiatedHandler;)V
    ...
    iput-object v0, p0, mProxyAppsState:Landroid/util/ArrayMap;
    ...
    iput-object v0, p0, mOnPermissionsChangedListener:Landroid/content/pm/PackageManager$OnPermissionsChangedListener;
    ...
    iput-object p3, p0, mNiHandler:Lcom/android/internal/location/GpsNetInitiatedHandler;
    ...
    invoke-direct {p0, v1}, runOnHandler(Ljava/lang/Runnable;)V
...
.method static synthetic access$000(Lcom/android/server/location/GnssVisibilityControl;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2}, handleProxyAppPackageUpdate(Ljava/lang/String;Ljava/lang/String;)V
...
.method private clearLocationIcon(Lcom/android/server/location/GnssVisibilityControl$ProxyAppState;ILjava/lang/String;)V
    ...
    invoke-direct {p0, v0, p2, p3}, updateLocationIcon(ZILjava/lang/String;)Z
...
.method private disableNfwLocationAccess()V
    ...
    sget-object v0, NO_LOCATION_ENABLED_PROXY_APPS:[Ljava/lang/String;

    invoke-direct {p0, v0}, setNfwLocationAccessProxyAppsInGnssHal([Ljava/lang/String;)V
...
.method private getLocationPermissionEnabledProxyApps()[Ljava/lang/String;
    ...
    iget-object v1, p0, mProxyAppsState:Landroid/util/ArrayMap;
    ...
    iget-object v3, p0, mProxyAppsState:Landroid/util/ArrayMap;
...
.method private handleEmergencyNfwNotification(Lcom/android/server/location/GnssVisibilityControl$NfwNotification;)V
    ...
    :cond_0
    iget-object v1, p0, mNiHandler:Lcom/android/internal/location/GpsNetInitiatedHandler;
    ...
    :cond_1
    invoke-direct {p0, p1, v0}, logEvent(Lcom/android/server/location/GnssVisibilityControl$NfwNotification;Z)V
    ...
    invoke-direct {p0, p1}, postEmergencyLocationUserNotification(Lcom/android/server/location/GnssVisibilityControl$NfwNotification;)V
...
.method private handleGpsEnabledChanged(Z)V
    ...
    iget-boolean v1, p0, mIsGpsEnabled:Z
    ...
    :cond_0
    iput-boolean p1, p0, mIsGpsEnabled:Z

    iget-boolean v0, p0, mIsGpsEnabled:Z

    if-nez v0, :cond_1

    invoke-direct {p0}, disableNfwLocationAccess()V

    return-void

    :cond_1
    invoke-direct {p0}, getLocationPermissionEnabledProxyApps()[Ljava/lang/String;
...
.method private handleInitialize()V
    ...
    invoke-direct {p0}, listenForProxyAppsPackageUpdates()V
...
.method private handleLocationIconTimeout(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, getProxyAppInfo(Ljava/lang/String;)Landroid/content/pm/ApplicationInfo;
    ...
    invoke-direct {p0, v1, v2, p1}, clearLocationIcon(Lcom/android/server/location/GnssVisibilityControl$ProxyAppState;ILjava/lang/String;)V
...
.method private handleNfwNotification(Lcom/android/server/location/GnssVisibilityControl$NfwNotification;)V
    ...
    invoke-direct {p0, p1}, handleEmergencyNfwNotification(Lcom/android/server/location/GnssVisibilityControl$NfwNotification;)V
    ...
    iget-object v2, p0, mProxyAppsState:Landroid/util/ArrayMap;
    ...
    invoke-direct {p0, v2, p1}, isPermissionMismatched(Lcom/android/server/location/GnssVisibilityControl$ProxyAppState;Lcom/android/server/location/GnssVisibilityControl$NfwNotification;)Z

    move-result v4

    invoke-direct {p0, p1, v4}, logEvent(Lcom/android/server/location/GnssVisibilityControl$NfwNotification;Z)V
    ...
    iget-object v6, p0, mProxyAppsState:Landroid/util/ArrayMap;
    ...
    :cond_5
    invoke-direct {p0, v0}, getProxyAppInfo(Ljava/lang/String;)Landroid/content/pm/ApplicationInfo;
    ...
    invoke-direct {p0, v2, p1, v6, v0}, showLocationIcon(Lcom/android/server/location/GnssVisibilityControl$ProxyAppState;Lcom/android/server/location/GnssVisibilityControl$NfwNotification;ILjava/lang/String;)V
    ...
    iget-boolean v7, p0, mIsGpsEnabled:Z
...
.method private handlePermissionsChanged(I)V
    ...
    iget-object v0, p0, mProxyAppsState:Landroid/util/ArrayMap;
    ...
    invoke-direct {p0, v2}, getProxyAppInfo(Ljava/lang/String;)Landroid/content/pm/ApplicationInfo;
    ...
    :cond_2
    invoke-direct {p0, v2}, shouldEnableLocationPermissionInGnssHal(Ljava/lang/String;)Z
    ...
    invoke-direct {p0}, updateNfwLocationAccessProxyAppsInGnssHal()V
...
.method private handleProxyAppPackageUpdate(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    invoke-direct {p0, p1}, shouldEnableLocationPermissionInGnssHal(Ljava/lang/String;)Z
...
.method private handleUpdateProxyApps(Ljava/util/List;)V
    ...
    invoke-direct {p0, p1}, isProxyAppListUpdated(Ljava/util/List;)Z
    ...
    iget-object v1, p0, mOnPermissionsChangedListener:Landroid/content/pm/PackageManager$OnPermissionsChangedListener;
    ...
    invoke-direct {p0}, resetProxyAppsState()V
    ...
    invoke-direct {p0, v1}, shouldEnableLocationPermissionInGnssHal(Ljava/lang/String;)Z
...
.method public static synthetic lambda$FLGfeDaxF8J3CE9m-TcOXh5j6ow(Lcom/android/server/location/GnssVisibilityControl;)V
    ...
    invoke-direct {p0}, handleInitialize()V
...
.method private postEmergencyLocationUserNotification(Lcom/android/server/location/GnssVisibilityControl$NfwNotification;)V
    ...
    invoke-static {v3}, createEmergencyLocationUserNotification(Landroid/content/Context;)Landroid/app/Notification;
...
.method private resetProxyAppsState()V
    ...
    invoke-direct {p0, v3}, getProxyAppInfo(Ljava/lang/String;)Landroid/content/pm/ApplicationInfo;
    ...
    invoke-direct {p0, v2, v4, v5}, clearLocationIcon(Lcom/android/server/location/GnssVisibilityControl$ProxyAppState;ILjava/lang/String;)V
...
.method private runOnHandler(Ljava/lang/Runnable;)V
    ...
    invoke-direct {p0, p1}, runEventAndReleaseWakeLock(Ljava/lang/Runnable;)Ljava/lang/Runnable;
...
.method private setNfwLocationAccessProxyAppsInGnssHal([Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, native_enable_nfw_location_access([Ljava/lang/String;)Z
...
.method private shouldEnableLocationPermissionInGnssHal(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1}, isProxyAppInstalled(Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-direct {p0, p1}, hasLocationPermission(Ljava/lang/String;)Z
...
.method private showLocationIcon(Lcom/android/server/location/GnssVisibilityControl$ProxyAppState;Lcom/android/server/location/GnssVisibilityControl$NfwNotification;ILjava/lang/String;)V
    ...
    invoke-direct {p0, v2, p3, p4}, updateLocationIcon(ZILjava/lang/String;)Z
    ...
    invoke-direct {p0, p1, p3, p4}, clearLocationIcon(Lcom/android/server/location/GnssVisibilityControl$ProxyAppState;ILjava/lang/String;)V
...
.method private updateLocationIcon(ZILjava/lang/String;)Z
    ...
    :cond_2
    invoke-direct {p0}, sendHighPowerMonitoringBroadcast()V
...
.method public synthetic lambda$new$0$GnssVisibilityControl(I)V
    ...
    invoke-direct {p0, p1}, handlePermissionsChanged(I)V
...
.method public synthetic lambda$new$1$GnssVisibilityControl(I)V
    ...
    invoke-direct {p0, v0}, runOnHandler(Ljava/lang/Runnable;)V
...
.method public synthetic lambda$onConfigurationUpdated$4$GnssVisibilityControl(Ljava/util/List;)V
    ...
    invoke-direct {p0, p1}, handleUpdateProxyApps(Ljava/util/List;)V
...
.method public synthetic lambda$onGpsEnabledChanged$2$GnssVisibilityControl(Z)V
    ...
    invoke-direct {p0, p1}, handleGpsEnabledChanged(Z)V
...
.method public synthetic lambda$reportNfwNotification$3$GnssVisibilityControl(Ljava/lang/String;BLjava/lang/String;BLjava/lang/String;BZZ)V
    ...
    invoke-direct {p0, v10}, handleNfwNotification(Lcom/android/server/location/GnssVisibilityControl$NfwNotification;)V
...
.method public synthetic lambda$showLocationIcon$5$GnssVisibilityControl(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, handleLocationIconTimeout(Ljava/lang/String;)V
...
.method reportNfwNotification(Ljava/lang/String;BLjava/lang/String;BLjava/lang/String;BZZ)V
    ...
    invoke-direct {p0, v10}, runOnHandler(Ljava/lang/Runnable;)V
