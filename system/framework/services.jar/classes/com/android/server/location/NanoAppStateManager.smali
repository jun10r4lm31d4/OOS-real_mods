...
.method constructor <init>()V
    ...
    iput-object v0, p0, mNanoAppHash:Ljava/util/HashMap;

    const/4 v0, 0x0

    iput v0, p0, mNextHandle:I
...
.method private handleQueryAppEntry(IJI)V
    ...
    invoke-virtual {p0, p1, p2, p3}, getNanoAppHandle(IJ)I
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, addNanoAppInstance(IJI)V

    goto :goto_0

    :cond_0
    iget-object v0, p0, mNanoAppHash:Ljava/util/HashMap;
    ...
    iget-object v8, p0, mNanoAppHash:Ljava/util/HashMap;
...
.method declared-synchronized addNanoAppInstance(IJI)V
    ...
    :try_start_0
    invoke-virtual/range {p0 .. p3}, removeNanoAppInstance(IJ)V

    iget-object v0, v1, mNanoAppHash:Ljava/util/HashMap;
    ...
    iget-object v4, v1, mNanoAppHash:Ljava/util/HashMap;
    ...
    iget-object v11, v1, mNanoAppHash:Ljava/util/HashMap;
...
.method declared-synchronized removeNanoAppInstance(IJ)V
    ...
    iget-object v1, p0, mNanoAppHash:Ljava/util/HashMap;
...
.method declared-synchronized updateCache(ILjava/util/List;)V
    ...
    invoke-direct {p0, p1, v3, v4, v5}, handleQueryAppEntry(IJI)V
