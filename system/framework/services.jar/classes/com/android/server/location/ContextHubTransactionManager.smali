...
.method constructor <init>(Landroid/hardware/contexthub/V1_0/IContexthub;Lcom/android/server/location/ContextHubClientManager;Lcom/android/server/location/NanoAppStateManager;)V
    ...
    iput-object v0, p0, mTransactionQueue:Ljava/util/ArrayDeque;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>()V

    iput-object v0, p0, mNextAvailableId:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iput-object v0, p0, mTimeoutExecutor:Ljava/util/concurrent/ScheduledThreadPoolExecutor;

    const/4 v0, 0x0

    iput-object v0, p0, mTimeoutFuture:Ljava/util/concurrent/ScheduledFuture;

    iput-object p1, p0, mContextHubProxy:Landroid/hardware/contexthub/V1_0/IContexthub;

    iput-object p2, p0, mClientManager:Lcom/android/server/location/ContextHubClientManager;

    iput-object p3, p0, mNanoAppStateManager:Lcom/android/server/location/NanoAppStateManager;
...
.method private removeTransactionAndStartNext()V
    ...
    iget-object v0, p0, mTimeoutFuture:Ljava/util/concurrent/ScheduledFuture;

    const/4 v1, 0x0

    invoke-interface {v0, v1}, Ljava/util/concurrent/ScheduledFuture;->cancel(Z)Z

    iget-object v0, p0, mTransactionQueue:Ljava/util/ArrayDeque;
    ...
    iget-object v1, p0, mTransactionQueue:Ljava/util/ArrayDeque;
    ...
    invoke-direct {p0}, startNextTransaction()V
...
.method private startNextTransaction()V
    ...
    iget-object v5, p0, mTimeoutExecutor:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
    ...
    iput-object v5, p0, mTimeoutFuture:Ljava/util/concurrent/ScheduledFuture;
    ...
    iget-object v2, p0, mTransactionQueue:Ljava/util/ArrayDeque;
...
.method createDisableTransaction(IJLandroid/hardware/location/IContextHubTransactionCallback;)Lcom/android/server/location/ContextHubServiceTransaction;
    ...
    iget-object v0, p0, mNextAvailableId:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public synthetic lambda$startNextTransaction$0$ContextHubTransactionManager(Lcom/android/server/location/ContextHubServiceTransaction;)V
    ...
    invoke-direct {p0}, removeTransactionAndStartNext()V
