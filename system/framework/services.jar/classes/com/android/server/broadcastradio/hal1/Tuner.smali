...
.method constructor <init>(Landroid/hardware/radio/ITunerCallback;IIZI)V
    ...
    iput-boolean v0, p0, mIsMuted:Z

    iput-object p1, p0, mClientCallback:Landroid/hardware/radio/ITunerCallback;
    ...
    iput-object v1, p0, mTunerCallback:Lcom/android/server/broadcastradio/hal1/TunerCallback;

    iput p3, p0, mRegion:I

    iput-boolean p4, p0, mWithAudio:Z

    invoke-direct {p0, p2, p4, p5}, nativeInit(IZI)J

    move-result-wide v1

    iput-wide v1, p0, mNativeContext:J
    ...
    iput-object v1, p0, mDeathRecipient:Landroid/os/IBinder$DeathRecipient;

    :try_start_0
    iget-object v1, p0, mClientCallback:Landroid/hardware/radio/ITunerCallback;

    invoke-interface {v1}, Landroid/hardware/radio/ITunerCallback;->asBinder()Landroid/os/IBinder;

    move-result-object v1

    iget-object v2, p0, mDeathRecipient:Landroid/os/IBinder$DeathRecipient;
...
.method private checkConfiguredLocked()Z
    ...
    iget-object v0, p0, mTunerCallback:Lcom/android/server/broadcastradio/hal1/TunerCallback;
...
.method public cancel()V
    ...
    :try_start_0
    invoke-direct {p0}, checkNotClosedLocked()V

    iget-wide v1, p0, mNativeContext:J

    invoke-direct {p0, v1, v2}, nativeCancel(J)V
...
.method public cancelAnnouncement()V
    ...
    invoke-direct {p0, v1, v2}, nativeCancelAnnouncement(J)V
...
.method public close()V
    ...
    iput-boolean v1, p0, mIsClosed:Z

    iget-object v1, p0, mTunerCallback:Lcom/android/server/broadcastradio/hal1/TunerCallback;
    ...
    invoke-direct {p0, v1, v2}, nativeClose(J)V
...
.method protected finalize()V
    ...
    invoke-direct {p0, v0, v1}, nativeFinalize(J)V
...
.method public getConfiguration()Landroid/hardware/radio/RadioManager$BandConfig;
    ...
    iget v3, p0, mRegion:I

    invoke-direct {p0, v1, v2, v3}, nativeGetConfiguration(JI)Landroid/hardware/radio/RadioManager$BandConfig;
...
.method public getImage(I)Landroid/graphics/Bitmap;
    ...
    invoke-direct {p0, v1, v2, p1}, nativeGetImage(JI)[B
...
.method getProgramList(Ljava/util/Map;)Ljava/util/List;
    ...
    iget-wide v2, p0, mNativeContext:J

    invoke-direct {p0, v2, v3, v0}, nativeGetProgramList(JLjava/util/Map;)Ljava/util/List;
...
.method public isConfigFlagSet(I)Z
    ...
    invoke-direct {p0, v1, v2}, nativeIsAnalogForced(J)Z
...
.method public isMuted()Z
    ...
    iget-boolean v0, p0, mWithAudio:Z
...
.method public scan(ZZ)V
    ...
    invoke-direct {p0}, checkConfiguredLocked()Z
    ...
    invoke-direct {p0, v1, v2, p1, p2}, nativeScan(JZZ)V
...
.method public setConfigFlag(IZ)V
    ...
    invoke-direct {p0, v1, v2, p2}, nativeSetAnalogForced(JZ)V
...
.method public setConfiguration(Landroid/hardware/radio/RadioManager$BandConfig;)V
    ...
    invoke-direct {p0, v1, v2, p1}, nativeSetConfiguration(JLandroid/hardware/radio/RadioManager$BandConfig;)V

    invoke-virtual {p1}, Landroid/hardware/radio/RadioManager$BandConfig;->getRegion()I

    move-result v1

    iput v1, p0, mRegion:I
...
.method public startBackgroundScan()Z
    ...
    invoke-direct {p0, v1, v2}, nativeStartBackgroundScan(J)Z
...
.method public step(ZZ)V
    ...
    invoke-direct {p0, v1, v2, p1, p2}, nativeStep(JZZ)V
...
.method public tune(Landroid/hardware/radio/ProgramSelector;)V
    ...
    invoke-direct {p0, v1, v2, p1}, nativeTune(JLandroid/hardware/radio/ProgramSelector;)V
