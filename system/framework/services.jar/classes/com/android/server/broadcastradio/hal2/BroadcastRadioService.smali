...
.method public constructor <init>(I)V
    ...
    iput v1, p0, mNextModuleId:I

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, mServiceNameToModuleIdMap:Ljava/util/Map;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, mModules:Ljava/util/Map;
    ...
    iput-object v1, p0, mServiceListener:Landroid/hidl/manager/V1_0/IServiceNotification$Stub;
    ...
    iput-object v1, p0, mDeathRecipient:Landroid/os/IHwBinder$DeathRecipient;

    iput p1, p0, mNextModuleId:I
    ...
    iget-object v4, p0, mServiceListener:Landroid/hidl/manager/V1_0/IServiceNotification$Stub;
...
.method static synthetic access$100(Lcom/android/server/broadcastradio/hal2/BroadcastRadioService;)Ljava/util/Map;
    ...
    iget-object v0, p0, mServiceNameToModuleIdMap:Ljava/util/Map;
...
.method static synthetic access$300(Lcom/android/server/broadcastradio/hal2/BroadcastRadioService;)Ljava/util/Map;
    ...
    iget-object v0, p0, mModules:Ljava/util/Map;
...
.method static synthetic access$400(Lcom/android/server/broadcastradio/hal2/BroadcastRadioService;)Landroid/os/IHwBinder$DeathRecipient;
    ...
    iget-object v0, p0, mDeathRecipient:Landroid/os/IHwBinder$DeathRecipient;
...
.method public addAnnouncementListener([ILandroid/hardware/radio/IAnnouncementListener;)Landroid/hardware/radio/ICloseHandle;
    ...
    :try_start_0
    iget-object v3, p0, mModules:Ljava/util/Map;
...
.method public hasAnyModules()Z
    ...
    :try_start_0
    iget-object v1, p0, mModules:Ljava/util/Map;
...
.method public openSession(ILandroid/hardware/radio/RadioManager$BandConfig;ZLandroid/hardware/radio/ITunerCallback;)Landroid/hardware/radio/ITuner;
    ...
    :try_start_0
    iget-object v2, p0, mModules:Ljava/util/Map;
