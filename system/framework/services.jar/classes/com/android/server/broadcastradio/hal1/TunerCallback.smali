...
.method constructor <init>(Lcom/android/server/broadcastradio/hal1/Tuner;Landroid/hardware/radio/ITunerCallback;I)V
    ...
    iput-object v0, p0, mProgramListFilter:Ljava/util/concurrent/atomic/AtomicReference;

    const/4 v0, 0x0

    iput-boolean v0, p0, mInitialConfigurationDone:Z

    iput-object p1, p0, mTuner:Lcom/android/server/broadcastradio/hal1/Tuner;

    iput-object p2, p0, mClientCallback:Landroid/hardware/radio/ITunerCallback;

    invoke-direct {p0, p1, p3}, nativeInit(Lcom/android/server/broadcastradio/hal1/Tuner;I)J

    move-result-wide v0

    iput-wide v0, p0, mNativeContext:J
...
.method private handleHwFailure()V
    ...
    iget-object v0, p0, mTuner:Lcom/android/server/broadcastradio/hal1/Tuner;
...
.method private sendProgramListUpdate()V
    ...
    iget-object v0, p0, mProgramListFilter:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    :cond_0
    :try_start_0
    iget-object v1, p0, mTuner:Lcom/android/server/broadcastradio/hal1/Tuner;
    ...
    invoke-direct {p0, v4}, dispatch(Lcom/android/server/broadcastradio/hal1/TunerCallback$RunnableThrowingRemoteException;)V
...
.method public detach()V
    ...
    invoke-direct {p0, v0, v1}, nativeDetach(J)V
...
.method isInitialConfigurationDone()Z
    ...
    iget-boolean v0, p0, mInitialConfigurationDone:Z
...
.method public synthetic lambda$onAntennaState$5$TunerCallback(Z)V
    ...
    iget-object v0, p0, mClientCallback:Landroid/hardware/radio/ITunerCallback;
...
.method public onAntennaState(Z)V
    ...
    invoke-direct {p0, v0}, dispatch(Lcom/android/server/broadcastradio/hal1/TunerCallback$RunnableThrowingRemoteException;)V
...
.method public onProgramListChanged()V
    ...
    invoke-direct {p0}, sendProgramListUpdate()V
