...
.method private constructor <init>(Landroid/hardware/broadcastradio/V2_0/IBroadcastRadio;Landroid/hardware/radio/RadioManager$ModuleProperties;)V
    ...
    iput-object v0, p0, mAntennaConnected:Ljava/lang/Boolean;

    iput-object v0, p0, mProgramInfo:Landroid/hardware/radio/RadioManager$ProgramInfo;
    ...
    iput-object v0, p0, mHalTunerCallback:Landroid/hardware/broadcastradio/V2_0/ITunerCallback;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, mAidlTunerSessions:Ljava/util/Set;
    ...
    iput-object v0, p0, mProperties:Landroid/hardware/radio/RadioManager$ModuleProperties;
    ...
    iput-object v0, p0, mService:Landroid/hardware/broadcastradio/V2_0/IBroadcastRadio;
...
.method static synthetic access$102(Lcom/android/server/broadcastradio/hal2/RadioModule;Landroid/hardware/radio/RadioManager$ProgramInfo;)Landroid/hardware/radio/RadioManager$ProgramInfo;
    ...
    iput-object p1, p0, mProgramInfo:Landroid/hardware/radio/RadioManager$ProgramInfo;
...
.method static synthetic access$200(Lcom/android/server/broadcastradio/hal2/RadioModule;Lcom/android/server/broadcastradio/hal2/RadioModule$AidlCallbackRunnable;)V
    ...
    invoke-direct {p0, p1}, fanoutAidlCallbackLocked(Lcom/android/server/broadcastradio/hal2/RadioModule$AidlCallbackRunnable;)V
...
.method static synthetic access$302(Lcom/android/server/broadcastradio/hal2/RadioModule;Ljava/lang/Boolean;)Ljava/lang/Boolean;
    ...
    iput-object p1, p0, mAntennaConnected:Ljava/lang/Boolean;
...
.method private fanoutAidlCallbackLocked(Lcom/android/server/broadcastradio/hal2/RadioModule$AidlCallbackRunnable;)V
    ...
    iget-object v1, p0, mAidlTunerSessions:Ljava/util/Set;
    ...
    iget-object v4, p0, mAidlTunerSessions:Ljava/util/Set;
...
.method public static tryLoadingModule(ILjava/lang/String;)Lcom/android/server/broadcastradio/hal2/RadioModule;
    ...
    invoke-direct {v5, v1, v4}, <init>(Landroid/hardware/broadcastradio/V2_0/IBroadcastRadio;Landroid/hardware/radio/RadioManager$ModuleProperties;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public addAnnouncementListener([ILandroid/hardware/radio/IAnnouncementListener;)Landroid/hardware/radio/ICloseHandle;
    ...
    iget-object v4, p0, mService:Landroid/hardware/broadcastradio/V2_0/IBroadcastRadio;

    monitor-enter v4

    :try_start_0
    iget-object v5, p0, mService:Landroid/hardware/broadcastradio/V2_0/IBroadcastRadio;
...
.method public closeSessions(Ljava/lang/Integer;)V
    ...
    iget-object v2, p0, mAidlTunerSessions:Ljava/util/Set;
...
.method getImage(I)Landroid/graphics/Bitmap;
    ...
    iget-object v0, p0, mService:Landroid/hardware/broadcastradio/V2_0/IBroadcastRadio;
...
.method onTunerSessionClosed(Lcom/android/server/broadcastradio/hal2/TunerSession;)V
    ...
    iget-object v1, p0, mHalTunerSession:Landroid/hardware/broadcastradio/V2_0/ITunerSession;
    ...
    iput-object v1, p0, mHalTunerSession:Landroid/hardware/broadcastradio/V2_0/ITunerSession;
...
.method public openSession(Landroid/hardware/radio/ITunerCallback;)Lcom/android/server/broadcastradio/hal2/TunerSession;
    ...
    iget-object v2, p0, mService:Landroid/hardware/broadcastradio/V2_0/IBroadcastRadio;

    iget-object v3, p0, mHalTunerCallback:Landroid/hardware/broadcastradio/V2_0/ITunerCallback;
    ...
    iput-object v2, p0, mHalTunerSession:Landroid/hardware/broadcastradio/V2_0/ITunerSession;

    :cond_0
    new-instance v1, Lcom/android/server/broadcastradio/hal2/TunerSession;

    iget-object v2, p0, mHalTunerSession:Landroid/hardware/broadcastradio/V2_0/ITunerSession;
    ...
    iget-object v2, p0, mAntennaConnected:Ljava/lang/Boolean;
    ...
    :cond_1
    iget-object v2, p0, mProgramInfo:Landroid/hardware/radio/RadioManager$ProgramInfo;
