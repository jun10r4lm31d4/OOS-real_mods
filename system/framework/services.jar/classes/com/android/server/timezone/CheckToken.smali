...
.method constructor <init>(ILcom/android/server/timezone/PackageVersions;)V
    ...
    iput p1, p0, mOptimisticLockId:I

    if-eqz p2, :cond_0

    iput-object p2, p0, mPackageVersions:Lcom/android/server/timezone/PackageVersions;
...
.method static fromByteArray([B)Lcom/android/server/timezone/CheckToken;
    ...
    invoke-direct {v7, v2, v8}, <init>(ILcom/android/server/timezone/PackageVersions;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    const/4 v8, 0x0

    invoke-static {v8, v1}, $closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget v2, p0, mOptimisticLockId:I

    iget v3, v1, mOptimisticLockId:I
    ...
    :cond_2
    iget-object v0, p0, mPackageVersions:Lcom/android/server/timezone/PackageVersions;

    iget-object v2, v1, mPackageVersions:Lcom/android/server/timezone/PackageVersions;
...
.method public hashCode()I
    ...
    iget v0, p0, mOptimisticLockId:I

    mul-int/lit8 v1, v0, 0x1f

    iget-object v2, p0, mPackageVersions:Lcom/android/server/timezone/PackageVersions;
...
.method toByteArray()[B
    ...
    :try_start_1
    iget v3, p0, mOptimisticLockId:I

    invoke-virtual {v1, v3}, Ljava/io/DataOutputStream;->writeInt(I)V

    iget-object v3, p0, mPackageVersions:Lcom/android/server/timezone/PackageVersions;
...
.method public toString()Ljava/lang/String;
    ...
    iget v1, p0, mOptimisticLockId:I
    ...
    iget-object v1, p0, mPackageVersions:Lcom/android/server/timezone/PackageVersions;
