...
.method constructor <init>(Lcom/android/server/timezone/RulesManagerService;Landroid/os/ParcelFileDescriptor;Lcom/android/server/timezone/CheckToken;Landroid/app/timezone/ICallback;)V
    ...
    iput-object p1, p0, this$0:Lcom/android/server/timezone/RulesManagerService;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, mDistroParcelFileDescriptor:Landroid/os/ParcelFileDescriptor;

    iput-object p3, p0, mCheckToken:Lcom/android/server/timezone/CheckToken;

    iput-object p4, p0, mCallback:Landroid/app/timezone/ICallback;
...
.method private sendInstallNotificationIntentIfRequired(I)V
    ...
    iget-object v0, p0, this$0:Lcom/android/server/timezone/RulesManagerService;
...
.method public run()V
    ...
    iget-object v0, p0, mCheckToken:Lcom/android/server/timezone/CheckToken;
    ...
    :try_start_0
    iget-object v2, p0, mDistroParcelFileDescriptor:Landroid/os/ParcelFileDescriptor;
    :try_end_0
    ...
    iget-object v6, p0, this$0:Lcom/android/server/timezone/RulesManagerService;
    ...
    invoke-direct {p0, v6}, sendInstallNotificationIntentIfRequired(I)V

    invoke-direct {p0, v6}, mapInstallerResultToApiCode(I)I

    move-result v7

    iget-object v8, p0, mCheckToken:Lcom/android/server/timezone/CheckToken;
    ...
    iget-object v8, p0, this$0:Lcom/android/server/timezone/RulesManagerService;

    iget-object v9, p0, mCallback:Landroid/app/timezone/ICallback;
    ...
    iget-object v3, p0, mCheckToken:Lcom/android/server/timezone/CheckToken;
    ...
    iget-object v3, p0, this$0:Lcom/android/server/timezone/RulesManagerService;

    iget-object v5, p0, mCallback:Landroid/app/timezone/ICallback;
    ...
    :goto_1
    iget-object v2, p0, this$0:Lcom/android/server/timezone/RulesManagerService;
    ...
    iget-object v4, p0, mCheckToken:Lcom/android/server/timezone/CheckToken;
