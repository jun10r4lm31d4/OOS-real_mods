...
.method constructor <init>(Ljava/io/File;)V
    ...
    iput-object v0, p0, mPackageStatusFile:Landroid/util/AtomicFile;
...
.method private getCurrentOptimisticLockId()I
    ...
    :try_start_0
    iget-object v0, p0, mPackageStatusFile:Landroid/util/AtomicFile;
    ...
    :try_start_1
    invoke-static {v0}, parseToPackageStatusTag(Ljava/io/FileInputStream;)Lorg/xmlpull/v1/XmlPullParser;

    move-result-object v2

    const-string/jumbo v3, "optimisticLockId"

    invoke-static {v2, v3}, getIntAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)I
...
.method private static getIntAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)I
    ...
    invoke-static {p0, p1}, getNullableIntAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Ljava/lang/Integer;
...
.method private getPackageStatusLocked()Lcom/android/server/timezone/PackageStatus;
    ...
    invoke-static {v1, v2}, getNullableIntAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Ljava/lang/Integer;
    ...
    :try_start_2
    invoke-static {v3, v0}, $closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_2
    .catch Ljava/io/IOException; {:try_start_2 .. :try_end_2} :catch_0
    ...
    invoke-static {v1, v4}, getIntAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)I

    move-result v4

    const-string v5, "dataAppPackageVersion"

    invoke-static {v1, v5}, getIntAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)I
...
.method private insertInitialPackageStatus()I
    ...
    invoke-direct {p0, v1, v0, v1}, writePackageStatusLocked(Ljava/lang/Integer;ILcom/android/server/timezone/PackageVersions;)V
...
.method private recoverFromBadData(Ljava/lang/Exception;)I
    ...
    :try_start_0
    invoke-direct {p0}, insertInitialPackageStatus()I
...
.method private writePackageStatusLocked(Ljava/lang/Integer;ILcom/android/server/timezone/PackageVersions;)V
    ...
    :try_start_0
    iget-object v3, p0, mPackageStatusFile:Landroid/util/AtomicFile;
    ...
    iget-object v2, p0, mPackageStatusFile:Landroid/util/AtomicFile;
...
.method private writePackageStatusWithOptimisticLockCheck(IILjava/lang/Integer;Lcom/android/server/timezone/PackageVersions;)Z
    ...
    :try_start_0
    invoke-direct {p0}, getCurrentOptimisticLockId()I
    ...
    invoke-direct {p0, p3, p2, p4}, writePackageStatusLocked(Ljava/lang/Integer;ILcom/android/server/timezone/PackageVersions;)V
    ...
    invoke-direct {p0, v1}, recoverFromBadData(Ljava/lang/Exception;)I
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    invoke-virtual {p0}, getPackageStatus()Lcom/android/server/timezone/PackageStatus;
...
.method public forceCheckStateForTests(ILcom/android/server/timezone/PackageVersions;)V
    ...
    invoke-direct {p0, v1, v0, p2}, writePackageStatusLocked(Ljava/lang/Integer;ILcom/android/server/timezone/PackageVersions;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method generateCheckToken(Lcom/android/server/timezone/PackageVersions;)Lcom/android/server/timezone/CheckToken;
    ...
    invoke-direct {p0, v0}, recoverFromBadData(Ljava/lang/Exception;)I
    ...
    invoke-direct {p0, v0, v1, v2, p1}, writePackageStatusWithOptimisticLockCheck(IILjava/lang/Integer;Lcom/android/server/timezone/PackageVersions;)Z
...
.method getPackageStatus()Lcom/android/server/timezone/PackageStatus;
    ...
    :try_start_0
    invoke-direct {p0}, getPackageStatusLocked()Lcom/android/server/timezone/PackageStatus;
...
.method markChecked(Lcom/android/server/timezone/CheckToken;Z)Z
    ...
    invoke-direct {p0, v0, v1, v3, v4}, writePackageStatusWithOptimisticLockCheck(IILjava/lang/Integer;Lcom/android/server/timezone/PackageVersions;)Z
...
.method resetCheckState()V
    ...
    :try_start_2
    invoke-direct {p0, v0, v1, v2, v2}, writePackageStatusWithOptimisticLockCheck(IILjava/lang/Integer;Lcom/android/server/timezone/PackageVersions;)Z
