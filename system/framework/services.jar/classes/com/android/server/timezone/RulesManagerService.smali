...
.method static constructor <clinit>()V
    ...
    sput-object v0, DISTRO_FORMAT_VERSION_SUPPORTED:Landroid/app/timezone/DistroFormatVersion;
...
.method constructor <init>(Lcom/android/server/timezone/PermissionHelper;Ljava/util/concurrent/Executor;Lcom/android/server/timezone/RulesManagerIntentHelper;Lcom/android/server/timezone/PackageTracker;Lcom/android/timezone/distro/installer/TimeZoneDistroInstaller;)V
    ...
    iput-object v0, p0, mOperationInProgress:Ljava/util/concurrent/atomic/AtomicBoolean;

    iput-object p1, p0, mPermissionHelper:Lcom/android/server/timezone/PermissionHelper;

    iput-object p2, p0, mExecutor:Ljava/util/concurrent/Executor;

    iput-object p3, p0, mIntentHelper:Lcom/android/server/timezone/RulesManagerIntentHelper;

    iput-object p4, p0, mPackageTracker:Lcom/android/server/timezone/PackageTracker;

    iput-object p5, p0, mInstaller:Lcom/android/timezone/distro/installer/TimeZoneDistroInstaller;
...
.method static synthetic access$000(Landroid/content/Context;)Lcom/android/server/timezone/RulesManagerService;
    ...
    invoke-static {p0}, create(Landroid/content/Context;)Lcom/android/server/timezone/RulesManagerService;
...
.method static synthetic access$100(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {p0}, toStringOrNull(Ljava/lang/Object;)Ljava/lang/String;
...
.method static synthetic access$200(Lcom/android/server/timezone/RulesManagerService;)Lcom/android/timezone/distro/installer/TimeZoneDistroInstaller;
    ...
    iget-object v0, p0, mInstaller:Lcom/android/timezone/distro/installer/TimeZoneDistroInstaller;
...
.method static synthetic access$300(Lcom/android/server/timezone/RulesManagerService;Landroid/app/timezone/ICallback;I)V
    ...
    invoke-direct {p0, p1, p2}, sendFinishedStatus(Landroid/app/timezone/ICallback;I)V
...
.method static synthetic access$500(Lcom/android/server/timezone/RulesManagerService;)Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v0, p0, mOperationInProgress:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method static synthetic access$600(Lcom/android/server/timezone/RulesManagerService;)Lcom/android/server/timezone/RulesManagerIntentHelper;
    ...
    iget-object v0, p0, mIntentHelper:Lcom/android/server/timezone/RulesManagerIntentHelper;
...
.method private static create(Landroid/content/Context;)Lcom/android/server/timezone/RulesManagerService;
    ...
    invoke-direct/range {v0 .. v5}, <init>(Lcom/android/server/timezone/PermissionHelper;Ljava/util/concurrent/Executor;Lcom/android/server/timezone/RulesManagerIntentHelper;Lcom/android/server/timezone/PackageTracker;Lcom/android/timezone/distro/installer/TimeZoneDistroInstaller;)V
...
.method private getRulesStateInternal()Landroid/app/timezone/RulesState;
    ...
    :try_start_1
    iget-object v3, p0, mInstaller:Lcom/android/timezone/distro/installer/TimeZoneDistroInstaller;
    ...
    :goto_1
    iget-object v3, p0, mOperationInProgress:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :try_start_3
    iget-object v6, p0, mInstaller:Lcom/android/timezone/distro/installer/TimeZoneDistroInstaller;
    ...
    sget-object v8, DISTRO_FORMAT_VERSION_SUPPORTED:Landroid/app/timezone/DistroFormatVersion;
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v0, p0, mPermissionHelper:Lcom/android/server/timezone/PermissionHelper;
    ...
    :cond_0
    invoke-direct {p0}, getRulesStateInternal()Landroid/app/timezone/RulesState;
    ...
    invoke-static {v8}, distroStatusToString(I)Ljava/lang/String;
    ...
    invoke-static {v8}, stagedOperationToString(I)Ljava/lang/String;
    ...
    iget-object v1, p0, mPackageTracker:Lcom/android/server/timezone/PackageTracker;
...
.method public requestInstall(Landroid/os/ParcelFileDescriptor;[BLandroid/app/timezone/ICallback;)I
    ...
    :try_start_0
    iget-object v1, p0, mPermissionHelper:Lcom/android/server/timezone/PermissionHelper;
    ...
    invoke-static {p2}, createCheckTokenOrThrow([B)Lcom/android/server/timezone/CheckToken;
    ...
    :cond_0
    invoke-static {v1}, toStringOrNull(Ljava/lang/Object;)Ljava/lang/String;
    ...
    :try_start_1
    iget-object v2, p0, mOperationInProgress:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v2, p0, mExecutor:Ljava/util/concurrent/Executor;
...
.method public requestNothing([BZ)V
    ...
    invoke-static {p1}, createCheckTokenOrThrow([B)Lcom/android/server/timezone/CheckToken;

    move-result-object v0

    :cond_0
    invoke-static {v0}, toStringOrNull(Ljava/lang/Object;)Ljava/lang/String;
...
.method public requestUninstall([BLandroid/app/timezone/ICallback;)I
    ...
    :try_start_0
    iget-object v1, p0, mOperationInProgress:Ljava/util/concurrent/atomic/AtomicBoolean;
