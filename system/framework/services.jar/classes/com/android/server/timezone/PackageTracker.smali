...
.method constructor <init>(Ljava/time/Clock;Lcom/android/server/timezone/ConfigHelper;Lcom/android/server/timezone/PackageManagerHelper;Lcom/android/server/timezone/PackageStatusStorage;Lcom/android/server/timezone/PackageTrackerIntentHelper;)V
    ...
    iput-object v0, p0, mLastTriggerTimestamp:Ljava/lang/Long;

    iput-object p1, p0, mElapsedRealtimeClock:Ljava/time/Clock;

    iput-object p2, p0, mConfigHelper:Lcom/android/server/timezone/ConfigHelper;

    iput-object p3, p0, mPackageManagerHelper:Lcom/android/server/timezone/PackageManagerHelper;

    iput-object p4, p0, mPackageStatusStorage:Lcom/android/server/timezone/PackageStatusStorage;

    iput-object p5, p0, mIntentHelper:Lcom/android/server/timezone/PackageTrackerIntentHelper;
...
.method static create(Landroid/content/Context;)Lcom/android/server/timezone/PackageTracker;
    ...
    invoke-direct/range {v0 .. v5}, <init>(Ljava/time/Clock;Lcom/android/server/timezone/ConfigHelper;Lcom/android/server/timezone/PackageManagerHelper;Lcom/android/server/timezone/PackageStatusStorage;Lcom/android/server/timezone/PackageTrackerIntentHelper;)V
...
.method private isCheckInProgress()Z
    ...
    iget-object v0, p0, mLastTriggerTimestamp:Ljava/lang/Long;
...
.method private isCheckResponseOverdue()Z
    ...
    :cond_0
    iget-object v0, p0, mElapsedRealtimeClock:Ljava/time/Clock;
    ...
    iget v0, p0, mCheckTimeAllowedMillis:I
...
.method private lookupInstalledPackageVersions()Lcom/android/server/timezone/PackageVersions;
    ...
    :try_start_0
    iget-object v0, p0, mPackageManagerHelper:Lcom/android/server/timezone/PackageManagerHelper;

    iget-object v1, p0, mUpdateAppPackageName:Ljava/lang/String;

    invoke-interface {v0, v1}, Lcom/android/server/timezone/PackageManagerHelper;->getInstalledPackageVersion(Ljava/lang/String;)J

    move-result-wide v0

    iget-object v2, p0, mPackageManagerHelper:Lcom/android/server/timezone/PackageManagerHelper;

    iget-object v3, p0, mDataAppPackageName:Ljava/lang/String;
...
.method private throwIfDeviceSettingsOrAppsAreBad()V
    ...
    iget-object v0, p0, mUpdateAppPackageName:Ljava/lang/String;

    const-string v1, "Update app package name missing."

    invoke-static {v0, v1}, throwRuntimeExceptionIfNullOrEmpty(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, p0, mDataAppPackageName:Ljava/lang/String;

    const-string v1, "Data app package name missing."

    invoke-static {v0, v1}, throwRuntimeExceptionIfNullOrEmpty(Ljava/lang/String;Ljava/lang/String;)V

    iget-wide v0, p0, mFailedCheckRetryCount:J
    ...
    iget-object v2, p0, mUpdateAppPackageName:Ljava/lang/String;
    ...
    iget-object v3, p0, mUpdateAppPackageName:Ljava/lang/String;
    ...
    iget-object v5, p0, mDataAppPackageName:Ljava/lang/String;
    ...
    iget-object v1, p0, mDataAppPackageName:Ljava/lang/String;
    ...
    invoke-static {v0, v1}, logAndThrowRuntimeException(Ljava/lang/String;Ljava/lang/Throwable;)Ljava/lang/RuntimeException;
    ...
    iget-object v2, p0, mDataAppPackageName:Ljava/lang/String;
    ...
    invoke-static {v1, v0}, logAndThrowRuntimeException(Ljava/lang/String;Ljava/lang/Throwable;)Ljava/lang/RuntimeException;
    ...
    iget v2, p0, mCheckTimeAllowedMillis:I
    ...
    iget-wide v2, p0, mFailedCheckRetryCount:J
...
.method private static throwRuntimeExceptionIfNullOrEmpty(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1, v0}, logAndThrowRuntimeException(Ljava/lang/String;Ljava/lang/Throwable;)Ljava/lang/RuntimeException;
...
.method private validateUpdaterAppManifest()Z
    ...
    :try_start_0
    iget-object v4, p0, mPackageManagerHelper:Lcom/android/server/timezone/PackageManagerHelper;

    iget-object v5, p0, mUpdateAppPackageName:Ljava/lang/String;
    ...
    iget-object v4, p0, mUpdateAppPackageName:Ljava/lang/String;
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    iget-object v0, p0, mPackageStatusStorage:Lcom/android/server/timezone/PackageStatusStorage;
...
.method protected getCheckFailureCountForTests()I
    ...
    iget v0, p0, mCheckFailureCount:I
...
.method protected declared-synchronized recordCheckResult(Lcom/android/server/timezone/CheckToken;Z)V
    ...
    iget-boolean v0, p0, mTrackingEnabled:Z
    ...
    iget-object v1, p0, mPackageStatusStorage:Lcom/android/server/timezone/PackageStatusStorage;

    invoke-virtual {v1}, Lcom/android/server/timezone/PackageStatusStorage;->resetCheckState()V

    iget-object v1, p0, mIntentHelper:Lcom/android/server/timezone/PackageTrackerIntentHelper;

    iget v2, p0, mDelayBeforeReliabilityCheckMillis:I

    int-to-long v2, v2

    invoke-interface {v1, v2, v3}, Lcom/android/server/timezone/PackageTrackerIntentHelper;->scheduleReliabilityTrigger(J)V

    iput v0, p0, mCheckFailureCount:I
    ...
    invoke-direct {p0}, setCheckComplete()V

    if-eqz p2, :cond_3

    iget-object v2, p0, mIntentHelper:Lcom/android/server/timezone/PackageTrackerIntentHelper;
    ...
    :cond_3
    iget-object v0, p0, mIntentHelper:Lcom/android/server/timezone/PackageTrackerIntentHelper;
...
.method protected declared-synchronized start()Z
    ...
    :try_start_0
    iget-object v0, p0, mConfigHelper:Lcom/android/server/timezone/ConfigHelper;

    invoke-interface {v0}, Lcom/android/server/timezone/ConfigHelper;->isTrackingEnabled()Z

    move-result v0

    iput-boolean v0, p0, mTrackingEnabled:Z
    ...
    iput-object v0, p0, mUpdateAppPackageName:Ljava/lang/String;
    ...
    iput-object v0, p0, mDataAppPackageName:Ljava/lang/String;
    ...
    iput v0, p0, mCheckTimeAllowedMillis:I
    ...
    iput-wide v2, p0, mFailedCheckRetryCount:J
    ...
    iput v0, p0, mDelayBeforeReliabilityCheckMillis:I

    invoke-direct {p0}, throwIfDeviceSettingsOrAppsAreBad()V

    iput-boolean v1, p0, mCheckTriggered:Z

    iput v1, p0, mCheckFailureCount:I
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    iget v1, p0, mDelayBeforeReliabilityCheckMillis:I
...
.method public toString()Ljava/lang/String;
    ...
    iget-boolean v1, p0, mTrackingEnabled:Z
    ...
    iget v1, p0, mCheckTimeAllowedMillis:I
    ...
    iget-wide v1, p0, mFailedCheckRetryCount:J
    ...
    iget-object v1, p0, mLastTriggerTimestamp:Ljava/lang/Long;
    ...
    iget-boolean v1, p0, mCheckTriggered:Z
    ...
    iget v1, p0, mCheckFailureCount:I
...
.method public declared-synchronized triggerUpdateIfNeeded(Z)V
    ...
    invoke-direct {p0}, validateUpdaterAppManifest()Z

    move-result v0

    invoke-direct {p0}, validateDataAppManifest()Z
    ...
    iget-boolean v2, p0, mCheckTriggered:Z
    ...
    :cond_1
    invoke-direct {p0}, isCheckInProgress()Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-direct {p0}, isCheckResponseOverdue()Z
    ...
    iget v3, p0, mDelayBeforeReliabilityCheckMillis:I
    ...
    :cond_2
    :try_start_1
    iget v2, p0, mCheckFailureCount:I

    int-to-long v2, v2

    iget-wide v4, p0, mFailedCheckRetryCount:J
    ...
    :goto_0
    :try_start_3
    invoke-direct {p0}, lookupInstalledPackageVersions()Lcom/android/server/timezone/PackageVersions;
    ...
    iget-object v3, p0, mIntentHelper:Lcom/android/server/timezone/PackageTrackerIntentHelper;
    ...
    :cond_5
    :try_start_4
    iget-object v3, p0, mPackageStatusStorage:Lcom/android/server/timezone/PackageStatusStorage;
    ...
    iget-object v4, p0, mIntentHelper:Lcom/android/server/timezone/PackageTrackerIntentHelper;
    ...
    :goto_1
    :try_start_5
    iget-object v4, p0, mPackageStatusStorage:Lcom/android/server/timezone/PackageStatusStorage;
    ...
    iget-object v5, p0, mIntentHelper:Lcom/android/server/timezone/PackageTrackerIntentHelper;

    iget v6, p0, mDelayBeforeReliabilityCheckMillis:I
    ...
    iput-boolean v5, p0, mCheckTriggered:Z

    invoke-direct {p0}, setCheckInProgress()V
