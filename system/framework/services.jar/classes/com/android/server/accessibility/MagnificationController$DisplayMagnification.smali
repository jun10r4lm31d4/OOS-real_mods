...
.method constructor <init>(Lcom/android/server/accessibility/MagnificationController;I)V
    ...
    iput-object p1, p0, this$0:Lcom/android/server/accessibility/MagnificationController;
    ...
    iput-object v0, p0, mCurrentMagnificationSpec:Landroid/view/MagnificationSpec;

    invoke-static {}, Landroid/graphics/Region;->obtain()Landroid/graphics/Region;

    move-result-object v0

    iput-object v0, p0, mMagnificationRegion:Landroid/graphics/Region;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, mMagnificationBounds:Landroid/graphics/Rect;
    ...
    iput v0, p0, mIdOfLastServiceToMagnify:I
    ...
    iput-object v0, p0, mSpecAnimationBridge:Lcom/android/server/accessibility/MagnificationController$SpecAnimationBridge;
...
.method getCenterX()F
    ...
    iget-object v0, p0, mMagnificationBounds:Landroid/graphics/Rect;
    ...
    iget-object v1, p0, mMagnificationBounds:Landroid/graphics/Rect;
    ...
    invoke-virtual {p0}, getOffsetX()F
...
.method getCenterY()F
    ...
    invoke-virtual {p0}, getOffsetY()F
...
.method getIdOfLastServiceToMagnify()I
    ...
    iget v0, p0, mIdOfLastServiceToMagnify:I
...
.method getMagnificationRegion(Landroid/graphics/Region;)V
    ...
    iget-object v0, p0, mMagnificationRegion:Landroid/graphics/Region;
...
.method getMagnifiedFrameInContentCoordsLocked(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p0}, getSentScale()F

    move-result v0

    invoke-virtual {p0}, getSentOffsetX()F

    move-result v1

    invoke-virtual {p0}, getSentOffsetY()F

    move-result v2

    invoke-virtual {p0, p1}, getMagnificationBounds(Landroid/graphics/Rect;)V
...
.method getSentOffsetX()F
    ...
    iget-object v0, p0, mSpecAnimationBridge:Lcom/android/server/accessibility/MagnificationController$SpecAnimationBridge;
...
.method offsetMagnifiedRegion(FFI)V
    ...
    invoke-virtual {p0, v0, v1}, updateCurrentSpecWithOffsetsLocked(FF)Z

    move-result v2

    if-eqz v2, :cond_1

    invoke-virtual {p0}, onMagnificationChangedLocked()V
    ...
    iput p3, p0, mIdOfLastServiceToMagnify:I
    ...
    invoke-virtual {p0, v2, v3}, sendSpecToAnimation(Landroid/view/MagnificationSpec;Z)V
...
.method onMagnificationChangedLocked()V
    ...
    iget-object v0, p0, this$0:Lcom/android/server/accessibility/MagnificationController;
    ...
    iget-object v3, p0, mMagnificationRegion:Landroid/graphics/Region;

    invoke-virtual {p0}, getScale()F

    move-result v4

    invoke-virtual {p0}, getCenterX()F

    move-result v5

    invoke-virtual {p0}, getCenterY()F
    ...
    iget-boolean v0, p0, mUnregisterPending:Z

    if-eqz v0, :cond_0

    invoke-virtual {p0}, isMagnifying()Z

    move-result v0

    if-nez v0, :cond_0

    iget-boolean v0, p0, mDeleteAfterUnregister:Z

    invoke-virtual {p0, v0}, unregister(Z)V
...
.method public onMagnificationRegionChanged(Landroid/graphics/Region;)V
    ...
    iget-object v1, p0, this$0:Lcom/android/server/accessibility/MagnificationController;
...
.method register()Z
    ...
    iget-object v2, p0, mMagnificationBounds:Landroid/graphics/Rect;
...
.method requestRectangleOnScreen(IIII)V
    ...
    invoke-virtual {p0, v1}, getMagnificationBounds(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p0, v2}, getMagnifiedFrameInContentCoordsLocked(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p0, v6, v7, v8}, offsetMagnifiedRegion(FFI)V
...
.method reset(Z)Z
    ...
    iput v2, p0, mIdOfLastServiceToMagnify:I

    invoke-virtual {p0, v0, p1}, sendSpecToAnimation(Landroid/view/MagnificationSpec;Z)V
...
.method sendSpecToAnimation(Landroid/view/MagnificationSpec;Z)V
    ...
    iget-object v2, p0, this$0:Lcom/android/server/accessibility/MagnificationController;
    ...
    iget-object v1, p0, mSpecAnimationBridge:Lcom/android/server/accessibility/MagnificationController$SpecAnimationBridge;
...
.method setScale(FFFZI)Z
    ...
    iget-boolean v0, v6, mRegistered:Z
    ...
    iget-object v8, v6, mTempRect:Landroid/graphics/Rect;

    iget-object v0, v6, mMagnificationRegion:Landroid/graphics/Region;

    invoke-virtual {v0, v8}, Landroid/graphics/Region;->getBounds(Landroid/graphics/Rect;)Z

    iget-object v9, v6, mCurrentMagnificationSpec:Landroid/view/MagnificationSpec;
    ...
    iput v5, v6, mIdOfLastServiceToMagnify:I
    ...
    invoke-virtual/range {v0 .. v5}, setScaleAndCenter(FFFZI)Z
...
.method setScaleAndCenter(FFFZI)Z
    ...
    :cond_0
    invoke-virtual {p0, p1, p2, p3}, updateMagnificationSpecLocked(FFF)Z

    move-result v0

    iget-object v1, p0, mCurrentMagnificationSpec:Landroid/view/MagnificationSpec;

    invoke-virtual {p0, v1, p4}, sendSpecToAnimation(Landroid/view/MagnificationSpec;Z)V
    ...
    iput p5, p0, mIdOfLastServiceToMagnify:I
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, mMagnificationRegion:Landroid/graphics/Region;
    ...
    iget v1, p0, mIdOfLastServiceToMagnify:I
    ...
    iget-boolean v1, p0, mUnregisterPending:Z
...
.method unregister(Z)V
    ...
    :cond_0
    iput-boolean v1, p0, mUnregisterPending:Z
...
.method unregisterPending(Z)V
    ...
    iput-boolean p1, p0, mDeleteAfterUnregister:Z

    const/4 v0, 0x1

    iput-boolean v0, p0, mUnregisterPending:Z

    invoke-virtual {p0, v0}, reset(Z)Z
...
.method updateCurrentSpecWithOffsetsLocked(FF)Z
    ...
    invoke-virtual {p0}, getMinOffsetXLocked()F

    move-result v1

    invoke-virtual {p0}, getMaxOffsetXLocked()F
    ...
    invoke-virtual {p0}, getMinOffsetYLocked()F

    move-result v2

    invoke-virtual {p0}, getMaxOffsetYLocked()F
    ...
    iget-object v3, p0, mCurrentMagnificationSpec:Landroid/view/MagnificationSpec;
...
.method updateMagnificationRegion(Landroid/graphics/Region;)V
    ...
    invoke-virtual {p0, v1, v2}, updateCurrentSpecWithOffsetsLocked(FF)Z
    ...
    invoke-virtual {p0, v1, v2}, sendSpecToAnimation(Landroid/view/MagnificationSpec;Z)V
...
.method updateMagnificationSpecLocked(FFF)Z
    ...
    iget-object v4, p0, mMagnificationBounds:Landroid/graphics/Rect;
    ...
    iget-object v3, p0, mMagnificationBounds:Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, v2, v4}, updateCurrentSpecWithOffsetsLocked(FF)Z
