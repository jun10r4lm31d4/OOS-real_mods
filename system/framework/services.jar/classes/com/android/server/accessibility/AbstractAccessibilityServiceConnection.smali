...
.method public constructor <init>(Landroid/content/Context;Landroid/content/ComponentName;Landroid/accessibilityservice/AccessibilityServiceInfo;ILandroid/os/Handler;Ljava/lang/Object;Lcom/android/server/accessibility/AccessibilityManagerService$SecurityPolicy;Lcom/android/server/accessibility/AbstractAccessibilityServiceConnection$SystemSupport;Lcom/android/server/wm/WindowManagerInternal;Lcom/android/server/accessibility/GlobalActionPerformer;)V
    ...
    iput-boolean v0, p0, mUsesAccessibilityCache:Z
    ...
    iput-object p9, p0, mWindowManagerService:Lcom/android/server/wm/WindowManagerInternal;

    iput p4, p0, mId:I

    iput-object p2, p0, mComponentName:Landroid/content/ComponentName;

    iput-object p3, p0, mAccessibilityServiceInfo:Landroid/accessibilityservice/AccessibilityServiceInfo;

    iput-object p6, p0, mLock:Ljava/lang/Object;

    iput-object p7, p0, mSecurityPolicy:Lcom/android/server/accessibility/AccessibilityManagerService$SecurityPolicy;

    iput-object p10, p0, mGlobalActionPerformer:Lcom/android/server/accessibility/GlobalActionPerformer;

    iput-object p8, p0, mSystemSupport:Lcom/android/server/accessibility/AbstractAccessibilityServiceConnection$SystemSupport;
    ...
    iput-object v0, p0, mInvocationHandler:Lcom/android/server/accessibility/AbstractAccessibilityServiceConnection$InvocationHandler;
    ...
    invoke-virtual {p0, p3}, setDynamicallyConfigurableProperties(Landroid/accessibilityservice/AccessibilityServiceInfo;)V
...
.method static synthetic access$000(Lcom/android/server/accessibility/AbstractAccessibilityServiceConnection;ILandroid/view/accessibility/AccessibilityEvent;Z)V
    ...
    invoke-direct {p0, p1, p2, p3}, notifyAccessibilityEventInternal(ILandroid/view/accessibility/AccessibilityEvent;Z)V
...
.method static synthetic access$300(Lcom/android/server/accessibility/AbstractAccessibilityServiceConnection;ILandroid/graphics/Region;FFF)V
    ...
    invoke-direct/range {p0 .. p5}, notifyMagnificationChangedInternal(ILandroid/graphics/Region;FFF)V
...
.method static synthetic access$400(Lcom/android/server/accessibility/AbstractAccessibilityServiceConnection;I)V
    ...
    invoke-direct {p0, p1}, notifySoftKeyboardShowModeChangedInternal(I)V
...
.method static synthetic access$500(Lcom/android/server/accessibility/AbstractAccessibilityServiceConnection;)V
    ...
    invoke-direct {p0}, notifyAccessibilityButtonClickedInternal()V
...
.method static synthetic access$600(Lcom/android/server/accessibility/AbstractAccessibilityServiceConnection;Z)V
    ...
    invoke-direct {p0, p1}, notifyAccessibilityButtonAvailabilityChangedInternal(Z)V
...
.method private notifyAccessibilityButtonAvailabilityChangedInternal(Z)V
    ...
    iget-boolean v0, p0, mReceivedAccessibilityButtonCallbackSinceBind:Z

    if-eqz v0, :cond_0

    iget-boolean v0, p0, mLastAccessibilityButtonCallbackState:Z
    ...
    iput-boolean v0, p0, mReceivedAccessibilityButtonCallbackSinceBind:Z

    iput-boolean p1, p0, mLastAccessibilityButtonCallbackState:Z

    invoke-direct {p0}, getServiceInterfaceSafely()Landroid/accessibilityservice/IAccessibilityServiceClient;
...
.method private wantsEventLocked(Landroid/view/accessibility/AccessibilityEvent;)Z
    ...
    invoke-virtual {p0}, canReceiveEventsLocked()Z
    ...
    :cond_2
    iget-object v2, p0, mPackageNames:Ljava/util/Set;
...
.method public findAccessibilityNodeInfoByAccessibilityId(IJILandroid/view/accessibility/IAccessibilityInteractionConnectionCallback;IJLandroid/os/Bundle;)[Ljava/lang/String;
    ...
    :try_start_0
    iput-boolean v0, v1, mUsesAccessibilityCache:Z

    invoke-virtual/range {p0 .. p0}, isCalledForCurrentUserLocked()Z
    ...
    iget-object v0, v1, mSecurityPolicy:Lcom/android/server/accessibility/AccessibilityManagerService$SecurityPolicy;
    ...
    :cond_1
    iget-object v5, v1, mSystemSupport:Lcom/android/server/accessibility/AbstractAccessibilityServiceConnection$SystemSupport;
    ...
    :cond_2
    iget-object v5, v1, mSecurityPolicy:Lcom/android/server/accessibility/AccessibilityManagerService$SecurityPolicy;
...
.method public findFocus(IJIILandroid/view/accessibility/IAccessibilityInteractionConnectionCallback;J)[Ljava/lang/String;
    ...
    :try_start_1
    invoke-direct {v1, v5, v15}, resolveAccessibilityWindowIdForFindFocusLocked(II)I
    ...
    :cond_1
    iget-object v6, v1, mSystemSupport:Lcom/android/server/accessibility/AbstractAccessibilityServiceConnection$SystemSupport;
...
.method public getMagnificationCenterX(I)F
    ...
    :try_start_0
    invoke-virtual {p0}, isCalledForCurrentUserLocked()Z
    ...
    :cond_0
    iget-object v1, p0, mSystemSupport:Lcom/android/server/accessibility/AbstractAccessibilityServiceConnection$SystemSupport;
    ...
    invoke-direct {p0, p1, v1}, registerMagnificationIfNeeded(ILcom/android/server/accessibility/MagnificationController;)Z
...
.method public getMagnificationRegion(I)Landroid/graphics/Region;
    ...
    :cond_0
    iget-object v2, p0, mSystemSupport:Lcom/android/server/accessibility/AbstractAccessibilityServiceConnection$SystemSupport;
    ...
    invoke-direct {p0, p1, v2}, registerMagnificationIfNeeded(ILcom/android/server/accessibility/MagnificationController;)Z
...
.method getRelevantEventTypes()I
    ...
    iget-boolean v0, p0, mUsesAccessibilityCache:Z
...
.method public getServiceInfo()Landroid/accessibilityservice/AccessibilityServiceInfo;
    ...
    :try_start_0
    iget-object v1, p0, mAccessibilityServiceInfo:Landroid/accessibilityservice/AccessibilityServiceInfo;
...
.method public getWindow(I)Landroid/view/accessibility/AccessibilityWindowInfo;
    ...
    iget-object v0, p0, mSystemSupport:Lcom/android/server/accessibility/AbstractAccessibilityServiceConnection$SystemSupport;
...
.method public isFingerprintGestureDetectionAvailable()Z
    ...
    :cond_0
    invoke-virtual {p0}, isCapturingFingerprintGestures()Z
...
.method public isMagnificationCallbackEnabled(I)Z
    ...
    iget-object v0, p0, mInvocationHandler:Lcom/android/server/accessibility/AbstractAccessibilityServiceConnection$InvocationHandler;
...
.method public notifyAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    invoke-direct {p0, p1}, wantsEventLocked(Landroid/view/accessibility/AccessibilityEvent;)Z

    move-result v2

    iget-boolean v3, p0, mUsesAccessibilityCache:Z
    ...
    iget-wide v7, p0, mNotificationTimeout:J
    ...
    iget-object v7, p0, mPendingEvents:Landroid/util/SparseArray;
    ...
    iget-object v8, p0, mPendingEvents:Landroid/util/SparseArray;

    invoke-virtual {v8, v1, v6}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    if-eqz v7, :cond_3

    iget-object v8, p0, mEventDispatchHandler:Landroid/os/Handler;
    ...
    :cond_4
    iget-object v7, p0, mEventDispatchHandler:Landroid/os/Handler;
    ...
    iget-object v4, p0, mEventDispatchHandler:Landroid/os/Handler;
...
.method public onKeyEvent(Landroid/view/KeyEvent;I)Z
    ...
    iget-boolean v0, p0, mRequestFilterKeyEvents:Z
...
.method public performAccessibilityAction(IJILandroid/os/Bundle;ILandroid/view/accessibility/IAccessibilityInteractionConnectionCallback;J)Z
    ...
    iget-object v3, v1, mSecurityPolicy:Lcom/android/server/accessibility/AccessibilityManagerService$SecurityPolicy;
...
.method public resetLocked()V
    ...
    :cond_1
    :goto_3
    iput-object v0, p0, mServiceInterface:Landroid/accessibilityservice/IAccessibilityServiceClient;

    iput-boolean v2, p0, mReceivedAccessibilityButtonCallbackSinceBind:Z
...
.method public resetMagnification(IZ)Z
    ...
    :try_start_1
    iget-object v3, p0, mSystemSupport:Lcom/android/server/accessibility/AbstractAccessibilityServiceConnection$SystemSupport;
...
.method public setDynamicallyConfigurableProperties(Landroid/accessibilityservice/AccessibilityServiceInfo;)V
    ...
    iput-wide v1, p0, mNotificationTimeout:J
    ...
    invoke-virtual {p0, p1}, supportsFlagForNotImportantViews(Landroid/accessibilityservice/AccessibilityServiceInfo;)Z
    ...
    :goto_5
    iput-boolean v1, p0, mRetrieveInteractiveWindows:Z
    ...
    :goto_6
    iput-boolean v1, p0, mCaptureFingerprintGestures:Z
    ...
    :goto_7
    iput-boolean v2, p0, mRequestAccessibilityButton:Z
...
.method public setMagnificationScaleAndCenter(IFFFZ)Z
    ...
    :try_start_1
    iget-object v0, v1, mSystemSupport:Lcom/android/server/accessibility/AbstractAccessibilityServiceConnection$SystemSupport;
...
.method public setServiceInfo(Landroid/accessibilityservice/AccessibilityServiceInfo;)V
    ...
    invoke-virtual {p0, v3}, setDynamicallyConfigurableProperties(Landroid/accessibilityservice/AccessibilityServiceInfo;)V
    ...
    :goto_0
    iget-object v4, p0, mSystemSupport:Lcom/android/server/accessibility/AbstractAccessibilityServiceConnection$SystemSupport;
