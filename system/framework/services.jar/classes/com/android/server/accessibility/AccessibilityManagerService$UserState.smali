...
.method public constructor <init>(Lcom/android/server/accessibility/AccessibilityManagerService;I)V
    ...
    iput-object v0, p0, mUserClients:Landroid/os/RemoteCallbackList;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, mUserClientUids:Ljava/util/HashSet;
    ...
    iput-object v0, p0, mBoundServices:Ljava/util/ArrayList;
    ...
    iput v0, p0, mNonInteractiveUiTimeout:I

    iput v0, p0, mInteractiveUiTimeout:I

    iput v0, p0, mSoftKeyboardShowMode:I
...
.method public addServiceLocked(Lcom/android/server/accessibility/AccessibilityServiceConnection;)V
    ...
    iget-object v0, p0, mBoundServices:Ljava/util/ArrayList;
    ...
    iget-object v0, p0, mComponentNameToServiceMap:Ljava/util/Map;
...
.method public getBindInstantServiceAllowed()Z
    ...
    :try_start_0
    iget-boolean v1, p0, mBindInstantServiceAllowed:Z
...
.method public getClientState()I
    ...
    invoke-virtual {p0}, isHandlingAccessibilityEvents()Z
    ...
    iget-boolean v2, p0, mIsTouchExplorationEnabled:Z
    ...
    :cond_3
    iget-boolean v2, p0, mIsTextHighContrastEnabled:Z
...
.method public getSoftKeyboardShowMode()I
    ...
    iget v0, p0, mSoftKeyboardShowMode:I
...
.method public onSwitchToAnotherUserLocked()V
    ...
    iget-object v1, p0, mTouchExplorationGrantedServices:Ljava/util/Set;

    invoke-interface {v1}, Ljava/util/Set;->clear()V

    iput-boolean v0, p0, mIsTouchExplorationEnabled:Z

    iput-boolean v0, p0, mIsDisplayMagnificationEnabled:Z

    iput-boolean v0, p0, mIsNavBarMagnificationEnabled:Z

    const/4 v1, 0x0

    iput-object v1, p0, mServiceAssignedToAccessibilityButton:Landroid/content/ComponentName;

    iput-boolean v0, p0, mIsNavBarMagnificationAssignedToAccessibilityButton:Z

    iput-boolean v0, p0, mIsAutoclickEnabled:Z

    iput v0, p0, mUserNonInteractiveUiTimeout:I

    iput v0, p0, mUserInteractiveUiTimeout:I
...
.method public reconcileSoftKeyboardModeWithSettingsLocked()V
    ...
    :goto_0
    iget v3, p0, mSoftKeyboardShowMode:I
    ...
    invoke-virtual {p0, v1, v5}, setSoftKeyboardModeLocked(ILandroid/content/ComponentName;)Z

    invoke-direct {p0}, setUserOverridesHardKeyboardSettingLocked()V

    :cond_1
    invoke-direct {p0}, getSoftKeyboardValueFromSettings()I

    move-result v3

    iget v4, p0, mSoftKeyboardShowMode:I
...
.method public removeServiceLocked(Lcom/android/server/accessibility/AccessibilityServiceConnection;)V
    ...
    iget-object v0, p0, mServiceChangingSoftKeyboardMode:Landroid/content/ComponentName;
    ...
    invoke-virtual {p0, v0, v1}, setSoftKeyboardModeLocked(ILandroid/content/ComponentName;)Z
    ...
    :goto_0
    iget-object v1, p0, mBoundServices:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, mComponentNameToServiceMap:Ljava/util/Map;
...
.method public serviceDisconnectedLocked(Lcom/android/server/accessibility/AccessibilityServiceConnection;)V
    ...
    invoke-virtual {p0, p1}, removeServiceLocked(Lcom/android/server/accessibility/AccessibilityServiceConnection;)V
...
.method public setBindInstantServiceAllowed(Z)V
    ...
    iput-boolean p1, p0, mBindInstantServiceAllowed:Z
...
.method public setSoftKeyboardModeLocked(ILandroid/content/ComponentName;)Z
    ...
    invoke-direct {p0}, hasUserOverriddenHardKeyboardSettingLocked()Z
    ...
    :cond_3
    invoke-direct {p0, v0}, setOriginalHardKeyboardValue(Z)V
    ...
    invoke-direct {p0}, getOriginalHardKeyboardValue()Z
    ...
    :cond_6
    :goto_0
    invoke-direct {p0, p1}, saveSoftKeyboardValueToSettings(I)V

    iput p1, p0, mSoftKeyboardShowMode:I

    iput-object p2, p0, mServiceChangingSoftKeyboardMode:Landroid/content/ComponentName;

    iget-object v0, p0, this$0:Lcom/android/server/accessibility/AccessibilityManagerService;

    iget v1, p0, mSoftKeyboardShowMode:I
