...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/accessibility/MagnificationController;ZZI)V
    ...
    iput-object p2, p0, mMagnificationController:Lcom/android/server/accessibility/MagnificationController;

    iput p5, p0, mDisplayId:I
    ...
    iput-object v0, p0, mDelegatingState:Lcom/android/server/accessibility/MagnificationGestureHandler$DelegatingState;
    ...
    iput-object v0, p0, mDetectingState:Lcom/android/server/accessibility/MagnificationGestureHandler$DetectingState;
    ...
    iput-object v0, p0, mViewportDraggingState:Lcom/android/server/accessibility/MagnificationGestureHandler$ViewportDraggingState;
    ...
    iput-object v0, p0, mPanningScalingState:Lcom/android/server/accessibility/MagnificationGestureHandler$PanningScalingState;

    iput-boolean p3, p0, mDetectTripleTap:Z

    iput-boolean p4, p0, mDetectShortcutTrigger:Z

    iget-boolean v0, p0, mDetectShortcutTrigger:Z
    ...
    iput-object v0, p0, mScreenStateReceiver:Lcom/android/server/accessibility/MagnificationGestureHandler$ScreenStateReceiver;

    iget-object v0, p0, mScreenStateReceiver:Lcom/android/server/accessibility/MagnificationGestureHandler$ScreenStateReceiver;
    ...
    :cond_0
    iput-object v1, p0, mScreenStateReceiver:Lcom/android/server/accessibility/MagnificationGestureHandler$ScreenStateReceiver;

    :goto_0
    iput-object v1, p0, mDebugInputEventHistory:Ljava/util/Queue;

    iput-object v1, p0, mDebugOutputEventHistory:Ljava/util/Queue;

    iget-object v0, p0, mDetectingState:Lcom/android/server/accessibility/MagnificationGestureHandler$DetectingState;

    invoke-direct {p0, v0}, transitionTo(Lcom/android/server/accessibility/MagnificationGestureHandler$State;)V
...
.method static synthetic access$200(Lcom/android/server/accessibility/MagnificationGestureHandler;Lcom/android/server/accessibility/MagnificationGestureHandler$State;)V
    ...
    invoke-direct {p0, p1}, transitionTo(Lcom/android/server/accessibility/MagnificationGestureHandler$State;)V
...
.method static synthetic access$500(Lcom/android/server/accessibility/MagnificationGestureHandler;Landroid/view/MotionEvent;Landroid/view/MotionEvent;I)V
    ...
    invoke-direct {p0, p1, p2, p3}, dispatchTransformedEvent(Landroid/view/MotionEvent;Landroid/view/MotionEvent;I)V
...
.method static synthetic access$700(Lcom/android/server/accessibility/MagnificationGestureHandler;Lcom/android/server/accessibility/MagnificationGestureHandler$State;Landroid/view/MotionEvent;Landroid/view/MotionEvent;I)V
    ...
    invoke-direct {p0, p1, p2, p3, p4}, handleEventWith(Lcom/android/server/accessibility/MagnificationGestureHandler$State;Landroid/view/MotionEvent;Landroid/view/MotionEvent;I)V
...
.method static synthetic access$800(Lcom/android/server/accessibility/MagnificationGestureHandler;FF)V
    ...
    invoke-direct {p0, p1, p2}, zoomOn(FF)V
...
.method static synthetic access$900(Landroid/view/MotionEvent;)Landroid/view/MotionEvent;
    ...
    invoke-static {p0}, recycleAndNullify(Landroid/view/MotionEvent;)Landroid/view/MotionEvent;
...
.method private getTempPointerCoordsWithMinSize(I)[Landroid/view/MotionEvent$PointerCoords;
    ...
    iget-object v0, p0, mTempPointerCoords:[Landroid/view/MotionEvent$PointerCoords;
    ...
    iput-object v3, p0, mTempPointerCoords:[Landroid/view/MotionEvent$PointerCoords;
    ...
    :cond_2
    iget-object v1, p0, mTempPointerCoords:[Landroid/view/MotionEvent$PointerCoords;
...
.method private getTempPointerPropertiesWithMinSize(I)[Landroid/view/MotionEvent$PointerProperties;
    ...
    iget-object v0, p0, mTempPointerProperties:[Landroid/view/MotionEvent$PointerProperties;
    ...
    iput-object v3, p0, mTempPointerProperties:[Landroid/view/MotionEvent$PointerProperties;
    ...
    :cond_2
    iget-object v1, p0, mTempPointerProperties:[Landroid/view/MotionEvent$PointerProperties;
...
.method private handleEventWith(Lcom/android/server/accessibility/MagnificationGestureHandler$State;Landroid/view/MotionEvent;Landroid/view/MotionEvent;I)V
    ...
    iget-object v0, p0, mPanningScalingState:Lcom/android/server/accessibility/MagnificationGestureHandler$PanningScalingState;
...
.method private onMotionEventInternal(Landroid/view/MotionEvent;Landroid/view/MotionEvent;I)V
    ...
    iget-boolean v0, p0, mDetectTripleTap:Z
    ...
    :cond_2
    iget-object v0, p0, mCurrentState:Lcom/android/server/accessibility/MagnificationGestureHandler$State;

    invoke-direct {p0, v0, p1, p2, p3}, handleEventWith(Lcom/android/server/accessibility/MagnificationGestureHandler$State;Landroid/view/MotionEvent;Landroid/view/MotionEvent;I)V
...
.method private transitionTo(Lcom/android/server/accessibility/MagnificationGestureHandler$State;)V
    ...
    iput-object v0, p0, mPreviousState:Lcom/android/server/accessibility/MagnificationGestureHandler$State;

    iput-object p1, p0, mCurrentState:Lcom/android/server/accessibility/MagnificationGestureHandler$State;
...
.method private zoomOn(FF)V
    ...
    iget-object v3, p0, mMagnificationController:Lcom/android/server/accessibility/MagnificationController;
...
.method clearAndTransitionToStateDetecting()V
    ...
    iput-object v0, p0, mCurrentState:Lcom/android/server/accessibility/MagnificationGestureHandler$State;

    invoke-virtual {v0}, Lcom/android/server/accessibility/MagnificationGestureHandler$DetectingState;->clear()V

    iget-object v0, p0, mViewportDraggingState:Lcom/android/server/accessibility/MagnificationGestureHandler$ViewportDraggingState;
...
.method public clearEvents(I)V
    ...
    invoke-virtual {p0}, clearAndTransitionToStateDetecting()V
...
.method notifyShortcutTriggered()V
    ...
    :cond_0
    iget-object v1, p0, mDetectingState:Lcom/android/server/accessibility/MagnificationGestureHandler$DetectingState;
...
.method public onMotionEvent(Landroid/view/MotionEvent;Landroid/view/MotionEvent;I)V
    ...
    invoke-direct {p0, p1, p2, p3}, onMotionEventInternal(Landroid/view/MotionEvent;Landroid/view/MotionEvent;I)V
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, mDelegatingState:Lcom/android/server/accessibility/MagnificationGestureHandler$DelegatingState;
    ...
    iget-object v1, p0, mPanningScalingState:Lcom/android/server/accessibility/MagnificationGestureHandler$PanningScalingState;
    ...
    iget-object v1, p0, mViewportDraggingState:Lcom/android/server/accessibility/MagnificationGestureHandler$ViewportDraggingState;
    ...
    iget-boolean v1, p0, mDetectTripleTap:Z
    ...
    iget-boolean v1, p0, mDetectShortcutTrigger:Z
    ...
    iget-object v1, p0, mCurrentState:Lcom/android/server/accessibility/MagnificationGestureHandler$State;
    ...
    iget-object v1, p0, mPreviousState:Lcom/android/server/accessibility/MagnificationGestureHandler$State;
