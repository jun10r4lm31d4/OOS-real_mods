...
.method public constructor <init>(Landroid/view/accessibility/IAccessibilityInteractionConnectionCallback;Landroid/view/accessibility/IAccessibilityInteractionConnection;IIJ)V
    ...
    iput-object v0, v13, mLock:Ljava/lang/Object;

    move-object/from16 v15, p1

    iput-object v15, v13, mServiceCallback:Landroid/view/accessibility/IAccessibilityInteractionConnectionCallback;

    move-object/from16 v12, p2

    iput-object v12, v13, mConnectionWithReplacementActions:Landroid/view/accessibility/IAccessibilityInteractionConnection;

    iput v14, v13, mInteractionId:I
    ...
    :try_start_0
    iget-object v1, v13, mConnectionWithReplacementActions:Landroid/view/accessibility/IAccessibilityInteractionConnection;
    ...
    :try_start_1
    iput-boolean v1, v13, mMultiNodeCallbackHappened:Z
    :try_end_1
...
.method private recycleReplaceActionNodesLocked()V
    ...
    iget-object v0, p0, mNodesWithReplacementActions:Ljava/util/List;
    ...
    iget-object v1, p0, mNodesWithReplacementActions:Ljava/util/List;
    ...
    iput-object v0, p0, mNodesWithReplacementActions:Ljava/util/List;
...
.method private replaceInfoActionsAndCallService()V
    ...
    :cond_0
    iget-object v1, p0, mNodeFromOriginalWindow:Landroid/view/accessibility/AccessibilityNodeInfo;

    if-eqz v1, :cond_1

    iget-object v1, p0, mNodeFromOriginalWindow:Landroid/view/accessibility/AccessibilityNodeInfo;

    invoke-direct {p0, v1}, replaceActionsOnInfoLocked(Landroid/view/accessibility/AccessibilityNodeInfo;)V

    :cond_1
    invoke-direct {p0}, recycleReplaceActionNodesLocked()V

    iget-object v1, p0, mNodeFromOriginalWindow:Landroid/view/accessibility/AccessibilityNodeInfo;

    const/4 v2, 0x1

    iput-boolean v2, p0, mDone:Z
    ...
    :try_start_1
    iget-object v0, p0, mServiceCallback:Landroid/view/accessibility/IAccessibilityInteractionConnectionCallback;

    iget v2, p0, mInteractionId:I
...
.method private replaceInfosActionsAndCallService()V
    ...
    :cond_0
    iget-object v1, p0, mNodesFromOriginalWindow:Ljava/util/List;
    ...
    :goto_0
    iget-object v2, p0, mNodesFromOriginalWindow:Ljava/util/List;
    ...
    invoke-direct {p0, v2}, replaceActionsOnInfoLocked(Landroid/view/accessibility/AccessibilityNodeInfo;)V
...
.method public setFindAccessibilityNodeInfoResult(Landroid/view/accessibility/AccessibilityNodeInfo;I)V
    ...
    iput-object p1, p0, mNodeFromOriginalWindow:Landroid/view/accessibility/AccessibilityNodeInfo;

    const/4 v1, 0x1

    iput-boolean v1, p0, mSingleNodeCallbackHappened:Z

    iget-boolean v1, p0, mMultiNodeCallbackHappened:Z
    ...
    invoke-direct {p0}, replaceInfoActionsAndCallService()V
...
.method public setFindAccessibilityNodeInfosResult(Ljava/util/List;I)V
    ...
    iput-object p1, p0, mNodesFromOriginalWindow:Ljava/util/List;
    ...
    iput-object p1, p0, mNodesWithReplacementActions:Ljava/util/List;

    :goto_0
    iget-boolean v1, p0, mSingleNodeCallbackHappened:Z

    iget-boolean v3, p0, mMultiNodeCallbackHappened:Z

    iput-boolean v2, p0, mMultiNodeCallbackHappened:Z
    ...
    invoke-direct {p0}, replaceInfosActionsAndCallService()V
