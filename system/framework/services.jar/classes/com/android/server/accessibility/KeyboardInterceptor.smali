...
.method public constructor <init>(Lcom/android/server/accessibility/AccessibilityManagerService;Lcom/android/server/policy/WindowManagerPolicy;)V
    ...
    iput-object p1, p0, mAms:Lcom/android/server/accessibility/AccessibilityManagerService;

    iput-object p2, p0, mPolicy:Lcom/android/server/policy/WindowManagerPolicy;
...
.method private addEventToQueue(Landroid/view/KeyEvent;IJ)V
    ...
    iget-object v2, p0, mEventQueueStart:Lcom/android/server/accessibility/KeyboardInterceptor$KeyEventHolder;
    ...
    iput-object v2, p0, mEventQueueStart:Lcom/android/server/accessibility/KeyboardInterceptor$KeyEventHolder;

    iput-object v2, p0, mEventQueueEnd:Lcom/android/server/accessibility/KeyboardInterceptor$KeyEventHolder;

    invoke-direct {p0}, scheduleProcessQueuedEvents()V
    ...
    iget-object v3, p0, mEventQueueStart:Lcom/android/server/accessibility/KeyboardInterceptor$KeyEventHolder;
...
.method private getEventDelay(Landroid/view/KeyEvent;I)J
    ...
    :cond_1
    :goto_0
    iget-object v1, p0, mPolicy:Lcom/android/server/policy/WindowManagerPolicy;
...
.method private processQueuedEvents()V
    ...
    :goto_0
    iget-object v2, p0, mEventQueueEnd:Lcom/android/server/accessibility/KeyboardInterceptor$KeyEventHolder;
    ...
    iget-object v3, p0, mEventQueueEnd:Lcom/android/server/accessibility/KeyboardInterceptor$KeyEventHolder;

    iget v3, v3, Lcom/android/server/accessibility/KeyboardInterceptor$KeyEventHolder;->policyFlags:I

    invoke-direct {p0, v2, v3}, getEventDelay(Landroid/view/KeyEvent;I)J
    ...
    iget-object v4, p0, mEventQueueEnd:Lcom/android/server/accessibility/KeyboardInterceptor$KeyEventHolder;
    ...
    iget-object v5, p0, mEventQueueEnd:Lcom/android/server/accessibility/KeyboardInterceptor$KeyEventHolder;

    iget-object v5, v5, Lcom/android/server/accessibility/KeyboardInterceptor$KeyEventHolder;->event:Landroid/view/KeyEvent;

    iget-object v6, p0, mEventQueueEnd:Lcom/android/server/accessibility/KeyboardInterceptor$KeyEventHolder;
    ...
    iput-object v5, p0, mEventQueueEnd:Lcom/android/server/accessibility/KeyboardInterceptor$KeyEventHolder;
    ...
    iput-object v6, p0, mEventQueueStart:Lcom/android/server/accessibility/KeyboardInterceptor$KeyEventHolder;
...
.method private scheduleProcessQueuedEvents()V
    ...
    iget-object v1, p0, mEventQueueEnd:Lcom/android/server/accessibility/KeyboardInterceptor$KeyEventHolder;
...
.method public handleMessage(Landroid/os/Message;)Z
    ...
    :cond_0
    invoke-direct {p0}, processQueuedEvents()V

    iget-object v0, p0, mEventQueueStart:Lcom/android/server/accessibility/KeyboardInterceptor$KeyEventHolder;
...
.method public onKeyEvent(Landroid/view/KeyEvent;I)V
    ...
    invoke-direct {p0, p1, p2}, getEventDelay(Landroid/view/KeyEvent;I)J
    ...
    :cond_2
    :goto_0
    invoke-direct {p0, p1, p2, v0, v1}, addEventToQueue(Landroid/view/KeyEvent;IJ)V
