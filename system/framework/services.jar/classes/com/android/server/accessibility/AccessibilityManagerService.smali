...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mTempComponentNameSet:Ljava/util/Set;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mTempAccessibilityServiceInfoList:Ljava/util/List;
    ...
    iput-object v0, p0, mTempIntArray:Landroid/util/IntArray;

    new-instance v0, Landroid/os/RemoteCallbackList;

    invoke-direct {v0}, Landroid/os/RemoteCallbackList;-><init>()V

    iput-object v0, p0, mGlobalClients:Landroid/os/RemoteCallbackList;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, mGlobalClientUids:Ljava/util/HashSet;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, mGlobalInteractionConnections:Landroid/util/SparseArray;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, mGlobalWindowTokens:Landroid/util/SparseArray;
    ...
    iput-object v0, p0, mUiAutomationManager:Lcom/android/server/accessibility/UiAutomationManager;
    ...
    iput-object v0, p0, mWindowManagerService:Lcom/android/server/wm/WindowManagerInternal;
    ...
    iput-object v0, p0, mSecurityPolicy:Lcom/android/server/accessibility/AccessibilityManagerService$SecurityPolicy;
    ...
    iput-object v0, p0, mMainHandler:Lcom/android/server/accessibility/AccessibilityManagerService$MainHandler;

    new-instance v0, Lcom/android/server/accessibility/GlobalActionPerformer;

    iget-object v1, p0, mContext:Landroid/content/Context;

    iget-object v2, p0, mWindowManagerService:Lcom/android/server/wm/WindowManagerInternal;
    ...
    iput-object v0, p0, mGlobalActionPerformer:Lcom/android/server/accessibility/GlobalActionPerformer;

    new-instance v0, Lcom/android/server/accessibility/AccessibilityManagerService$AccessibilityDisplayListener;

    iget-object v1, p0, mContext:Landroid/content/Context;

    iget-object v2, p0, mMainHandler:Lcom/android/server/accessibility/AccessibilityManagerService$MainHandler;
    ...
    iput-object v0, p0, mA11yDisplayListener:Lcom/android/server/accessibility/AccessibilityManagerService$AccessibilityDisplayListener;
...
.method static synthetic access$000(Lcom/android/server/accessibility/AccessibilityManagerService;I)V
    ...
    invoke-direct {p0, p1}, onBootPhase(I)V
...
.method static synthetic access$2700(Lcom/android/server/accessibility/AccessibilityManagerService;)Lcom/android/server/wm/WindowManagerInternal;
    ...
    iget-object v0, p0, mWindowManagerService:Lcom/android/server/wm/WindowManagerInternal;
...
.method static synthetic access$2800(Lcom/android/server/accessibility/AccessibilityManagerService;)Lcom/android/server/accessibility/GlobalActionPerformer;
    ...
    iget-object v0, p0, mGlobalActionPerformer:Lcom/android/server/accessibility/GlobalActionPerformer;
...
.method static synthetic access$3300(Lcom/android/server/accessibility/AccessibilityManagerService;)Landroid/appwidget/AppWidgetManagerInternal;
    ...
    iget-object v0, p0, mAppWidgetService:Landroid/appwidget/AppWidgetManagerInternal;
...
.method static synthetic access$3600(Lcom/android/server/accessibility/AccessibilityManagerService;Landroid/view/accessibility/AccessibilityEvent;I)V
    ...
    invoke-direct {p0, p1, p2}, sendAccessibilityEventLocked(Landroid/view/accessibility/AccessibilityEvent;I)V
...
.method static synthetic access$3800(Lcom/android/server/accessibility/AccessibilityManagerService;I)Landroid/os/IBinder;
    ...
    invoke-direct {p0, p1}, findWindowTokenLocked(I)Landroid/os/IBinder;
...
.method static synthetic access$4100(Lcom/android/server/accessibility/AccessibilityManagerService;Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)V
    ...
    invoke-direct {p0, p1}, updateMagnificationLocked(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)V
...
.method static synthetic access$4200(Lcom/android/server/accessibility/AccessibilityManagerService;)Lcom/android/server/accessibility/MagnificationController;
    ...
    iget-object v0, p0, mMagnificationController:Lcom/android/server/accessibility/MagnificationController;
...
.method static synthetic access$4300(Lcom/android/server/accessibility/AccessibilityManagerService;Lcom/android/server/accessibility/AccessibilityManagerService$UserState;Lcom/android/server/accessibility/AccessibilityManagerService$Client;)I
    ...
    invoke-direct {p0, p1, p2}, computeRelevantEventTypesLocked(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;Lcom/android/server/accessibility/AccessibilityManagerService$Client;)I
...
.method static synthetic access$4400(Lcom/android/server/accessibility/AccessibilityManagerService;)Lcom/android/server/accessibility/UiAutomationManager;
    ...
    iget-object v0, p0, mUiAutomationManager:Lcom/android/server/accessibility/UiAutomationManager;
...
.method static synthetic access$4600(Lcom/android/server/accessibility/AccessibilityManagerService;Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)V
    ...
    invoke-direct {p0, p1}, scheduleNotifyClientsOfServicesStateChangeLocked(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)V
...
.method static synthetic access$4700(Lcom/android/server/accessibility/AccessibilityManagerService;Ljava/lang/String;II)V
    ...
    invoke-direct {p0, p1, p2, p3}, putSecureIntForUser(Ljava/lang/String;II)V
...
.method static synthetic access$4800(Lcom/android/server/accessibility/AccessibilityManagerService;I)V
    ...
    invoke-direct {p0, p1}, notifySoftKeyboardShowModeChangedLocked(I)V
...
.method static synthetic access$5000(Lcom/android/server/accessibility/AccessibilityManagerService;Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)Z
    ...
    invoke-direct {p0, p1}, readMagnificationEnabledSettingsLocked(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)Z
...
.method static synthetic access$5100(Lcom/android/server/accessibility/AccessibilityManagerService;Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)Z
    ...
    invoke-direct {p0, p1}, readAutoclickEnabledSettingLocked(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)Z
...
.method static synthetic access$5500(Lcom/android/server/accessibility/AccessibilityManagerService;Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)Z
    ...
    invoke-direct {p0, p1}, readAccessibilityShortcutSettingLocked(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)Z
...
.method static synthetic access$5600(Lcom/android/server/accessibility/AccessibilityManagerService;Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)Z
    ...
    invoke-direct {p0, p1}, readAccessibilityButtonSettingsLocked(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)Z
...
.method static synthetic access$5700(Lcom/android/server/accessibility/AccessibilityManagerService;Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)Z
    ...
    invoke-direct {p0, p1}, readUserRecommendedUiTimeoutSettingsLocked(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)Z
...
.method static synthetic access$900(Lcom/android/server/accessibility/AccessibilityManagerService;I)V
    ...
    invoke-direct {p0, p1}, unlockUser(I)V
...
.method private announceNewUserIfNeeded()V
    ...
    invoke-direct {p0, v4, v5}, sendAccessibilityEventLocked(Landroid/view/accessibility/AccessibilityEvent;I)V
...
.method private canRequestAndRequestsTouchExplorationLocked(Lcom/android/server/accessibility/AccessibilityServiceConnection;Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)Z
    ...
    :cond_1
    iget-object v0, p0, mEnableTouchExplorationDialog:Landroid/app/AlertDialog;
...
.method private computeRelevantEventTypesLocked(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;Lcom/android/server/accessibility/AccessibilityManagerService$Client;)I
    ...
    invoke-static {v5, p2}, isClientInPackageWhitelist(Landroid/accessibilityservice/AccessibilityServiceInfo;Lcom/android/server/accessibility/AccessibilityManagerService$Client;)Z
    ...
    :cond_1
    iget-object v2, p0, mUiAutomationManager:Lcom/android/server/accessibility/UiAutomationManager;
    ...
    invoke-static {v2, p2}, isClientInPackageWhitelist(Landroid/accessibilityservice/AccessibilityServiceInfo;Lcom/android/server/accessibility/AccessibilityManagerService$Client;)Z
...
.method private disableAccessibilityServiceLocked(Landroid/content/ComponentName;I)V
    ...
    invoke-direct {p0, p2}, getUserStateLocked(I)Lcom/android/server/accessibility/AccessibilityManagerService$UserState;
...
.method private findWindowIdLocked(Landroid/os/IBinder;)I
    ...
    iget-object v0, p0, mGlobalWindowTokens:Landroid/util/SparseArray;
...
.method private getInteractionBridge()Lcom/android/server/accessibility/AccessibilityManagerService$InteractionBridge;
    ...
    :try_start_0
    iget-object v1, p0, mInteractionBridge:Lcom/android/server/accessibility/AccessibilityManagerService$InteractionBridge;
    ...
    iput-object v1, p0, mInteractionBridge:Lcom/android/server/accessibility/AccessibilityManagerService$InteractionBridge;
...
.method public static synthetic lambda$2LOhxU7QkqHWHlN_uVPLmAzrNWk(Lcom/android/server/accessibility/AccessibilityManagerService;I)V
    ...
    invoke-direct {p0, p1}, showAccessibilityButtonTargetSelection(I)V
...
.method public static synthetic lambda$5vwr6qV-eqdCr73CeDmVnsJlZHM(Lcom/android/server/accessibility/AccessibilityManagerService;II)V
    ...
    invoke-direct {p0, p1, p2}, sendStateToAllClients(II)V
...
.method public static synthetic lambda$BX2CMQr5jU9WhPYx7Aaae4zgxf4(Lcom/android/server/accessibility/AccessibilityManagerService;Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    invoke-direct {p0, p1}, sendAccessibilityEventToInputFilter(Landroid/view/accessibility/AccessibilityEvent;)V
...
.method public static synthetic lambda$bNCuysjTCG2afhYMHuqu25CfY5g(Lcom/android/server/accessibility/AccessibilityManagerService;Lcom/android/server/accessibility/AccessibilityServiceConnection;)V
    ...
    invoke-direct {p0, p1}, showEnableTouchExplorationDialog(Lcom/android/server/accessibility/AccessibilityServiceConnection;)V
...
.method public static synthetic lambda$fHb6jcCpfXvxrnf-dXJngiIFuoo(Lcom/android/server/accessibility/AccessibilityManagerService;I)V
    ...
    invoke-direct {p0, p1}, sendAccessibilityButtonToInputFilter(I)V
...
.method public static synthetic lambda$gWIX-xPon63LM1keYTGNXBKdyeE(Lcom/android/server/accessibility/AccessibilityManagerService;Landroid/os/RemoteCallbackList;Ljava/util/HashSet;J)V
    ...
    invoke-direct {p0, p1, p2, p3, p4}, sendServicesStateChanged(Landroid/os/RemoteCallbackList;Ljava/util/HashSet;J)V
...
.method public static synthetic lambda$mAPLBShddfLlktd9Q8jVo04VVXo(Lcom/android/server/accessibility/AccessibilityManagerService;Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)V
    ...
    invoke-direct {p0, p1}, updateFingerprintGestureHandling(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)V
...
.method public static synthetic lambda$zXJtauhUptSkQJSF-M55-grAVbo(Lcom/android/server/accessibility/AccessibilityManagerService;II)V
    ...
    invoke-direct {p0, p1, p2}, sendStateToClients(II)V
...
.method private notifyAccessibilityButtonVisibilityChangedLocked(Z)V
    ...
    iput-boolean p1, p0, mIsAccessibilityButtonShown:Z
...
.method private notifyOutsideTouchIfNeeded(II)V
    ...
    invoke-virtual {p0, v4}, getConnectionLocked(I)Lcom/android/server/accessibility/AccessibilityManagerService$RemoteAccessibilityConnection;
...
.method private onBootPhase(I)V
    ...
    iput-object v0, p0, mAppWidgetService:Landroid/appwidget/AppWidgetManagerInternal;
...
.method private onUserStateChangedLocked(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)V
    ...
    invoke-direct {p0, p1}, updateAccessibilityShortcutLocked(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)V
    ...
    invoke-direct {p0, p1}, updatePerformGesturesLocked(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)V

    invoke-direct {p0, p1}, updateMagnificationLocked(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)V

    invoke-direct {p0, p1}, scheduleUpdateFingerprintGestureHandling(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)V

    invoke-direct {p0, p1}, scheduleUpdateInputFilter(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)V

    invoke-direct {p0, p1}, updateRelevantEventsLocked(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)V
    ...
    invoke-direct {p0, p1}, updateAccessibilityButtonTargetsLocked(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)V
...
.method private readComponentNamesFromStringLocked(Ljava/lang/String;Ljava/util/Set;Z)V
    ...
    iget-object v0, p0, mStringColonSplitter:Landroid/text/TextUtils$SimpleStringSplitter;
...
.method private readEnabledAccessibilityServicesLocked(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)Z
    ...
    invoke-direct {p0, v2, v0, v1}, readComponentNamesFromSettingLocked(Ljava/lang/String;ILjava/util/Set;)V
...
.method private readInstalledAccessibilityServiceLocked(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)Z
    ...
    iget-object v0, p0, mTempAccessibilityServiceInfoList:Ljava/util/List;
    ...
    invoke-direct {p0, v5}, canRegisterService(Landroid/content/pm/ServiceInfo;)Z
    ...
    :cond_2
    iget-object v2, p0, mTempAccessibilityServiceInfoList:Ljava/util/List;
    ...
    iget-object v3, p0, mTempAccessibilityServiceInfoList:Ljava/util/List;
...
.method private scheduleNotifyClientsOfServicesStateChangeLocked(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)V
    ...
    invoke-direct {p0, p1}, updateRecommendedUiTimeoutLocked(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)V
    ...
    invoke-direct {p0, p1}, getRecommendedTimeoutMillisLocked(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)J
...
.method private sendAccessibilityButtonToInputFilter(I)V
    ...
    :try_start_0
    iget-boolean v1, p0, mHasInputFilter:Z
...
.method private sendServicesStateChanged(Landroid/os/RemoteCallbackList;Ljava/util/HashSet;J)V
    ...
    iget-object v1, p0, mGlobalClientUids:Ljava/util/HashSet;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, mGlobalClientUids:Ljava/util/HashSet;
    ...
    invoke-direct {p0, v1, p3, p4}, notifyClientsOfServicesStateChange(Landroid/os/RemoteCallbackList;J)V

    invoke-direct {p0, p1, p3, p4}, notifyClientsOfServicesStateChange(Landroid/os/RemoteCallbackList;J)V
...
.method private sendStateToAllClients(II)V
    ...
    invoke-direct {p0, p1, v0}, sendStateToClients(ILandroid/os/RemoteCallbackList;)V
...
.method private sendStateToClients(II)V
    ...
    invoke-direct {p0, p2}, getUserState(I)Lcom/android/server/accessibility/AccessibilityManagerService$UserState;
...
.method private showEnableTouchExplorationDialog(Lcom/android/server/accessibility/AccessibilityServiceConnection;)V
    ...
    :cond_0
    iget-object v3, p0, mEnableTouchExplorationDialog:Landroid/app/AlertDialog;
    ...
    iput-object v3, p0, mEnableTouchExplorationDialog:Landroid/app/AlertDialog;
...
.method private switchUser(I)V
    ...
    invoke-direct {p0, v4}, readConfigurationForUserStateLocked(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)Z

    invoke-direct {p0, v4}, onUserStateChangedLocked(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)V
...
.method private unlockUser(I)V
    ...
    invoke-direct {p0, v2}, onUserStateChangedLocked(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)V
...
.method private updateFingerprintGestureHandling(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)V
    ...
    iget-object v2, p0, mFingerprintGestureDispatcher:Lcom/android/server/accessibility/FingerprintGestureDispatcher;
    ...
    iput-object v7, p0, mFingerprintGestureDispatcher:Lcom/android/server/accessibility/FingerprintGestureDispatcher;
    ...
    iget-object v0, p0, mFingerprintGestureDispatcher:Lcom/android/server/accessibility/FingerprintGestureDispatcher;
...
.method private updateInputFilter(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)V
    ...
    :cond_2
    invoke-direct {p0, p1}, userHasMagnificationServicesLocked(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)Z
    ...
    iget-object v5, p0, mInputFilter:Lcom/android/server/accessibility/AccessibilityInputFilter;
...
.method private updateMagnificationLocked(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)V
    ...
    :cond_1
    invoke-virtual {p0}, getValidDisplayList()Ljava/util/ArrayList;
    ...
    invoke-direct {p0, p1, v3}, userHasListeningMagnificationServicesLocked(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;I)Z

    move-result v4

    if-eqz v4, :cond_3

    invoke-virtual {p0}, getMagnificationController()Lcom/android/server/accessibility/MagnificationController;
    ...
    :cond_3
    iget-object v4, p0, mMagnificationController:Lcom/android/server/accessibility/MagnificationController;
...
.method private updateServicesLocked(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)V
    ...
    iget-object v0, v12, mUiAutomationManager:Lcom/android/server/accessibility/UiAutomationManager;
    ...
    iget-object v2, v12, mContext:Landroid/content/Context;

    sget v5, sIdCounter:I

    add-int/lit8 v0, v5, 0x1

    sput v0, sIdCounter:I

    iget-object v6, v12, mMainHandler:Lcom/android/server/accessibility/AccessibilityManagerService$MainHandler;

    iget-object v7, v12, mLock:Ljava/lang/Object;

    iget-object v4, v12, mSecurityPolicy:Lcom/android/server/accessibility/AccessibilityManagerService$SecurityPolicy;

    iget-object v3, v12, mWindowManagerService:Lcom/android/server/wm/WindowManagerInternal;

    iget-object v1, v12, mGlobalActionPerformer:Lcom/android/server/accessibility/GlobalActionPerformer;
    ...
    iget-object v1, v12, mTempIntArray:Landroid/util/IntArray;
    ...
    iget-object v3, v12, mTempIntArray:Landroid/util/IntArray;
    ...
    iget-object v2, v12, mTempIntArray:Landroid/util/IntArray;

    invoke-virtual {v1, v2}, Landroid/media/AudioManagerInternal;->setAccessibilityServiceUids(Landroid/util/IntArray;)V

    :cond_a
    invoke-direct/range {p0 .. p1}, updateAccessibilityEnabledSetting(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)V
...
.method private updateTouchExplorationLocked(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)V
    ...
    invoke-direct {p0, v3, p1}, canRequestAndRequestsTouchExplorationLocked(Lcom/android/server/accessibility/AccessibilityServiceConnection;Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)Z
...
.method private updateWindowsForAccessibilityCallbackLocked(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)V
    ...
    iget-object v3, p0, mWindowsForAccessibilityCallback:Lcom/android/server/accessibility/AccessibilityManagerService$WindowsForAccessibilityCallback;
    ...
    iput-object v3, p0, mWindowsForAccessibilityCallback:Lcom/android/server/accessibility/AccessibilityManagerService$WindowsForAccessibilityCallback;

    iget-object v3, p0, mWindowManagerService:Lcom/android/server/wm/WindowManagerInternal;

    iget-object v4, p0, mWindowsForAccessibilityCallback:Lcom/android/server/accessibility/AccessibilityManagerService$WindowsForAccessibilityCallback;
    ...
    iget-object v4, p0, mWindowManagerService:Lcom/android/server/wm/WindowManagerInternal;
...
.method accessibilityFocusOnlyInActiveWindow()Z
    ...
    :try_start_0
    iget-object v1, p0, mWindowsForAccessibilityCallback:Lcom/android/server/accessibility/AccessibilityManagerService$WindowsForAccessibilityCallback;
...
.method public addAccessibilityInteractionConnection(Landroid/view/IWindow;Landroid/view/accessibility/IAccessibilityInteractionConnection;Ljava/lang/String;I)I
    ...
    iget-object v13, v14, mLock:Ljava/lang/Object;

    monitor-enter v13

    :try_start_0
    iget-object v0, v14, mSecurityPolicy:Lcom/android/server/accessibility/AccessibilityManagerService$SecurityPolicy;
    ...
    iget-object v1, v14, mSecurityPolicy:Lcom/android/server/accessibility/AccessibilityManagerService$SecurityPolicy;
    ...
    :try_start_2
    sget v1, sNextWindowId:I

    add-int/lit8 v2, v1, 0x1

    sput v2, sNextWindowId:I
    ...
    iget-object v2, v14, mGlobalInteractionConnections:Landroid/util/SparseArray;

    invoke-virtual {v2, v12, v1}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    iget-object v2, v14, mGlobalWindowTokens:Landroid/util/SparseArray;
    ...
    invoke-direct {v14, v0}, getUserStateLocked(I)Lcom/android/server/accessibility/AccessibilityManagerService$UserState;
...
.method public addClient(Landroid/view/accessibility/IAccessibilityManagerClient;I)J
    ...
    iget-object v4, p0, mGlobalClients:Landroid/os/RemoteCallbackList;

    invoke-virtual {v4, p1, v3}, Landroid/os/RemoteCallbackList;->register(Landroid/os/IInterface;Ljava/lang/Object;)Z

    iget-object v4, p0, mGlobalClientUids:Ljava/util/HashSet;
    ...
    :try_start_1
    iget-object v5, p0, mGlobalClientUids:Ljava/util/HashSet;
...
.method clearAccessibilityFocus(I)V
    ...
    invoke-direct {p0}, getInteractionBridge()Lcom/android/server/accessibility/AccessibilityManagerService$InteractionBridge;
...
.method clearAccessibilityFocus(Ljava/util/function/IntSupplier;)V
    ...
    invoke-virtual {p0, v0}, clearAccessibilityFocus(I)V
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v3, p0, mUserStates:Landroid/util/SparseArray;
    ...
    iget-object v4, p0, mUiAutomationManager:Lcom/android/server/accessibility/UiAutomationManager;
...
.method getBindInstantServiceAllowed(I)Z
    ...
    invoke-direct {p0, p1}, getUserState(I)Lcom/android/server/accessibility/AccessibilityManagerService$UserState;
...
.method public getCompatibleMagnificationSpecLocked(I)Landroid/view/MagnificationSpec;
    ...
    iget-object v1, p0, mWindowManagerService:Lcom/android/server/wm/WindowManagerInternal;
...
.method public getEnabledAccessibilityServiceList(II)Ljava/util/List;
    ...
    iget-object v3, p0, mUiAutomationManager:Lcom/android/server/accessibility/UiAutomationManager;
...
.method public getKeyEventDispatcher()Lcom/android/server/accessibility/KeyEventDispatcher;
    ...
    iget-object v0, p0, mKeyEventDispatcher:Lcom/android/server/accessibility/KeyEventDispatcher;
    ...
    iput-object v0, p0, mKeyEventDispatcher:Lcom/android/server/accessibility/KeyEventDispatcher;
...
.method public getMagnificationController()Lcom/android/server/accessibility/MagnificationController;
    ...
    :try_start_0
    iget-object v1, p0, mMagnificationController:Lcom/android/server/accessibility/MagnificationController;
    ...
    iput-object v1, p0, mMagnificationController:Lcom/android/server/accessibility/MagnificationController;
...
.method public getMotionEventInjectorLocked()Lcom/android/server/accessibility/MotionEventInjector;
    ...
    :goto_0
    iget-object v2, p0, mMotionEventInjector:Lcom/android/server/accessibility/MotionEventInjector;
...
.method public getRecommendedTimeoutMillis()J
    ...
    invoke-direct {p0, v1}, getRecommendedTimeoutMillisLocked(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)J
...
.method public getValidDisplayList()Ljava/util/ArrayList;
    ...
    iget-object v0, p0, mA11yDisplayListener:Lcom/android/server/accessibility/AccessibilityManagerService$AccessibilityDisplayListener;
...
.method public isAccessibilityButtonShown()Z
    ...
    iget-boolean v0, p0, mIsAccessibilityButtonShown:Z
...
.method public synthetic lambda$updateRelevantEventsLocked$1$AccessibilityManagerService(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)V
    ...
    invoke-direct {p0, p1, v0}, broadcastToClients(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;Ljava/util/function/Consumer;)V
...
.method public notifyAccessibilityButtonClicked(I)V
    ...
    :try_start_0
    invoke-direct {p0, p1}, notifyAccessibilityButtonClickedLocked(I)V
...
.method public notifyAccessibilityButtonVisibilityChanged(Z)V
    ...
    :try_start_0
    invoke-direct {p0, p1}, notifyAccessibilityButtonVisibilityChangedLocked(Z)V
...
.method public notifyKeyEvent(Landroid/view/KeyEvent;I)Z
    ...
    :cond_0
    invoke-virtual {p0}, getKeyEventDispatcher()Lcom/android/server/accessibility/KeyEventDispatcher;
...
.method public notifyMagnificationChanged(ILandroid/graphics/Region;FFF)V
    ...
    invoke-direct/range {p0 .. p5}, notifyMagnificationChangedLocked(ILandroid/graphics/Region;FFF)V
...
.method public onClientChangeLocked(Z)V
    ...
    invoke-direct {p0, v0}, scheduleNotifyClientsOfServicesStateChangeLocked(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)V
...
.method onGesture(I)Z
    ...
    invoke-direct {p0, p1, v2}, notifyGestureLocked(IZ)Z
...
.method public performAccessibilityAction(IJILandroid/os/Bundle;ILandroid/view/accessibility/IAccessibilityInteractionConnectionCallback;IJ)Z
    ...
    :try_start_0
    invoke-virtual/range {p0 .. p1}, getConnectionLocked(I)Lcom/android/server/accessibility/AccessibilityManagerService$RemoteAccessibilityConnection;
    ...
    :goto_1
    iget-object v6, v1, mSecurityPolicy:Lcom/android/server/accessibility/AccessibilityManagerService$SecurityPolicy;
    ...
    iget-object v7, v1, mSecurityPolicy:Lcom/android/server/accessibility/AccessibilityManagerService$SecurityPolicy;
    ...
    iget-object v3, v1, mPictureInPictureActionReplacingConnection:Lcom/android/server/accessibility/AccessibilityManagerService$RemoteAccessibilityConnection;
    ...
    invoke-direct {v1, v2, v14}, notifyOutsideTouchIfNeeded(II)V
    :try_end_3
...
.method public performAccessibilityShortcut()V
    ...
    invoke-direct {p0, v3, v6}, enableAccessibilityServiceLocked(Landroid/content/ComponentName;I)V
    ...
    invoke-direct {p0, v3, v6}, disableAccessibilityServiceLocked(Landroid/content/ComponentName;I)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public registerUiTestAutomationService(Landroid/os/IBinder;Landroid/accessibilityservice/IAccessibilityServiceClient;Landroid/accessibilityservice/AccessibilityServiceInfo;I)V
    ...
    iget-object v0, v13, mSecurityPolicy:Lcom/android/server/accessibility/AccessibilityManagerService$SecurityPolicy;
    ...
    iget-object v14, v13, mLock:Ljava/lang/Object;

    monitor-enter v14

    :try_start_0
    iget-object v1, v13, mUiAutomationManager:Lcom/android/server/accessibility/UiAutomationManager;

    iget-object v4, v13, mContext:Landroid/content/Context;

    sget v6, sIdCounter:I

    add-int/lit8 v0, v6, 0x1

    sput v0, sIdCounter:I

    iget-object v7, v13, mMainHandler:Lcom/android/server/accessibility/AccessibilityManagerService$MainHandler;

    iget-object v8, v13, mSecurityPolicy:Lcom/android/server/accessibility/AccessibilityManagerService$SecurityPolicy;

    iget-object v10, v13, mWindowManagerService:Lcom/android/server/wm/WindowManagerInternal;

    iget-object v11, v13, mGlobalActionPerformer:Lcom/android/server/accessibility/GlobalActionPerformer;
...
.method public removeAccessibilityInteractionConnection(Landroid/view/IWindow;)V
    ...
    iget-object v3, p0, mGlobalInteractionConnections:Landroid/util/SparseArray;

    invoke-direct {p0, v1, v2, v3}, removeAccessibilityInteractionConnectionInternalLocked(Landroid/os/IBinder;Landroid/util/SparseArray;Landroid/util/SparseArray;)I
    ...
    invoke-direct {p0, v1, v6, v7}, removeAccessibilityInteractionConnectionInternalLocked(Landroid/os/IBinder;Landroid/util/SparseArray;Landroid/util/SparseArray;)I
...
.method public replaceCallbackIfNeeded(Landroid/view/accessibility/IAccessibilityInteractionConnectionCallback;IIIJ)Landroid/view/accessibility/IAccessibilityInteractionConnectionCallback;
    ...
    iget-object v1, v0, mSecurityPolicy:Lcom/android/server/accessibility/AccessibilityManagerService$SecurityPolicy;
    ...
    iget-object v3, v0, mPictureInPictureActionReplacingConnection:Lcom/android/server/accessibility/AccessibilityManagerService$RemoteAccessibilityConnection;
...
.method restoreEnabledAccessibilityServicesLocked(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, v0, v1}, readComponentNamesFromStringLocked(Ljava/lang/String;Ljava/util/Set;Z)V

    iget-object v0, p0, mTempComponentNameSet:Ljava/util/Set;

    const/4 v2, 0x1

    invoke-direct {p0, p2, v0, v2}, readComponentNamesFromStringLocked(Ljava/lang/String;Ljava/util/Set;Z)V
    ...
    iget-object v3, p0, mTempComponentNameSet:Ljava/util/Set;
    ...
    invoke-virtual {p0, v3, v2, v1}, persistComponentNamesToSettingLocked(Ljava/lang/String;Ljava/util/Set;I)V
...
.method public sendAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;I)V
    ...
    :try_start_1
    invoke-direct {p0, p1, v2}, notifyAccessibilityServicesDelayedLocked(Landroid/view/accessibility/AccessibilityEvent;Z)V
...
.method setMotionEventInjector(Lcom/android/server/accessibility/MotionEventInjector;)V
    ...
    :try_start_0
    iput-object p1, p0, mMotionEventInjector:Lcom/android/server/accessibility/MotionEventInjector;
...
.method public setPictureInPictureActionReplacingConnection(Landroid/view/accessibility/IAccessibilityInteractionConnection;)V
    ...
    :try_start_0
    iget-object v1, p0, mPictureInPictureActionReplacingConnection:Lcom/android/server/accessibility/AccessibilityManagerService$RemoteAccessibilityConnection;
    ...
    iput-object v1, p0, mPictureInPictureActionReplacingConnection:Lcom/android/server/accessibility/AccessibilityManagerService$RemoteAccessibilityConnection;
...
.method public unregisterUiTestAutomationService(Landroid/accessibilityservice/IAccessibilityServiceClient;)V
    ...
    :try_start_0
    iget-object v1, p0, mUiAutomationManager:Lcom/android/server/accessibility/UiAutomationManager;
