...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/accessibility/AccessibilityManagerService;)V
    ...
    invoke-direct {p0, p1, p2, v0}, <init>(Landroid/content/Context;Lcom/android/server/accessibility/AccessibilityManagerService;Landroid/util/SparseArray;)V
...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/accessibility/AccessibilityManagerService;Landroid/util/SparseArray;)V
    ...
    iput-object v0, p0, mTouchExplorer:Landroid/util/SparseArray;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0, v1}, Landroid/util/SparseArray;-><init>(I)V

    iput-object v0, p0, mMagnificationGestureHandler:Landroid/util/SparseArray;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0, v1}, Landroid/util/SparseArray;-><init>(I)V

    iput-object v0, p0, mMotionEventInjector:Landroid/util/SparseArray;
    ...
    iput-object p3, p0, mEventHandler:Landroid/util/SparseArray;
...
.method private addFirstEventHandler(ILcom/android/server/accessibility/EventStreamTransformation;)V
    ...
    iget-object v0, p0, mEventHandler:Landroid/util/SparseArray;
    ...
    iget-object v1, p0, mEventHandler:Landroid/util/SparseArray;
...
.method private addFirstEventHandlerForAllDisplays(Ljava/util/ArrayList;Lcom/android/server/accessibility/EventStreamTransformation;)V
    ...
    invoke-direct {p0, v1, p2}, addFirstEventHandler(ILcom/android/server/accessibility/EventStreamTransformation;)V
...
.method private disableFeatures()V
    ...
    iget-object v0, p0, mMotionEventInjector:Landroid/util/SparseArray;
    ...
    iget-object v2, p0, mMotionEventInjector:Landroid/util/SparseArray;
    ...
    iget-object v0, p0, mAutoclickController:Lcom/android/server/accessibility/AutoclickController;

    if-eqz v0, :cond_2

    invoke-virtual {v0}, Lcom/android/server/accessibility/AutoclickController;->onDestroy()V

    iput-object v1, p0, mAutoclickController:Lcom/android/server/accessibility/AutoclickController;

    :cond_2
    iget-object v0, p0, mTouchExplorer:Landroid/util/SparseArray;
    ...
    iget-object v2, p0, mTouchExplorer:Landroid/util/SparseArray;
    ...
    iget-object v0, p0, mMagnificationGestureHandler:Landroid/util/SparseArray;
    ...
    iget-object v2, p0, mMagnificationGestureHandler:Landroid/util/SparseArray;
    ...
    iget-object v0, p0, mKeyboardInterceptor:Lcom/android/server/accessibility/KeyboardInterceptor;

    if-eqz v0, :cond_7

    invoke-virtual {v0}, Lcom/android/server/accessibility/KeyboardInterceptor;->onDestroy()V

    iput-object v1, p0, mKeyboardInterceptor:Lcom/android/server/accessibility/KeyboardInterceptor;
    ...
    invoke-virtual {p0}, resetStreamState()V
...
.method private enableFeatures()V
    ...
    iget-object v1, p0, mAutoclickController:Lcom/android/server/accessibility/AutoclickController;

    invoke-direct {p0, v0, v1}, addFirstEventHandlerForAllDisplays(Ljava/util/ArrayList;Lcom/android/server/accessibility/EventStreamTransformation;)V
    ...
    invoke-direct {p0, v4, v5}, addFirstEventHandler(ILcom/android/server/accessibility/EventStreamTransformation;)V

    iget-object v6, p0, mTouchExplorer:Landroid/util/SparseArray;
    ...
    invoke-direct {p0, v4, v3}, addFirstEventHandler(ILcom/android/server/accessibility/EventStreamTransformation;)V

    iget-object v5, p0, mMagnificationGestureHandler:Landroid/util/SparseArray;

    invoke-virtual {v5, v4, v3}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    :cond_5
    iget v3, p0, mEnabledFeatures:I
    ...
    iget-object v5, p0, mMotionEventInjector:Landroid/util/SparseArray;
    ...
    iget-object v1, p0, mKeyboardInterceptor:Lcom/android/server/accessibility/KeyboardInterceptor;

    invoke-direct {p0, v3, v1}, addFirstEventHandler(ILcom/android/server/accessibility/EventStreamTransformation;)V
...
.method private getEventStreamState(Landroid/view/InputEvent;)Lcom/android/server/accessibility/AccessibilityInputFilter$EventStreamState;
    ...
    iget-object v0, p0, mTouchScreenStreamState:Lcom/android/server/accessibility/AccessibilityInputFilter$EventStreamState;
    ...
    iput-object v0, p0, mTouchScreenStreamState:Lcom/android/server/accessibility/AccessibilityInputFilter$EventStreamState;
    ...
    iget-object v0, p0, mMouseStreamState:Lcom/android/server/accessibility/AccessibilityInputFilter$EventStreamState;
    ...
    iput-object v0, p0, mMouseStreamState:Lcom/android/server/accessibility/AccessibilityInputFilter$EventStreamState;
    ...
    iget-object v0, p0, mKeyboardStreamState:Lcom/android/server/accessibility/AccessibilityInputFilter$EventStreamState;
    ...
    iput-object v0, p0, mKeyboardStreamState:Lcom/android/server/accessibility/AccessibilityInputFilter$EventStreamState;
...
.method private handleMotionEvent(Landroid/view/MotionEvent;I)V
    ...
    iget-object v2, p0, mEventHandler:Landroid/util/SparseArray;

    invoke-direct {p0, v1}, isDisplayIdValid(I)Z
...
.method private processMotionEvent(Lcom/android/server/accessibility/AccessibilityInputFilter$EventStreamState;Landroid/view/MotionEvent;I)V
    ...
    :cond_1
    invoke-direct {p0, p2, p3}, handleMotionEvent(Landroid/view/MotionEvent;I)V
...
.method onDisplayChanged()V
    ...
    invoke-direct {p0}, disableFeatures()V
...
.method public onInputEvent(Landroid/view/InputEvent;I)V
    ...
    :cond_0
    invoke-direct {p0, p1}, getEventStreamState(Landroid/view/InputEvent;)Lcom/android/server/accessibility/AccessibilityInputFilter$EventStreamState;
    ...
    invoke-direct {p0, v1}, clearEventsForAllEventHandlers(I)V
    ...
    invoke-direct {p0, v0, v2, p2}, processMotionEvent(Lcom/android/server/accessibility/AccessibilityInputFilter$EventStreamState;Landroid/view/MotionEvent;I)V
    ...
    invoke-direct {p0, v0, v2, p2}, processKeyEvent(Lcom/android/server/accessibility/AccessibilityInputFilter$EventStreamState;Landroid/view/KeyEvent;I)V
