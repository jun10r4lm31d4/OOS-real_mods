...
.method static synthetic access$600(Lcom/android/server/accessibility/MagnificationGestureHandler$MotionEventInfo;)Lcom/android/server/accessibility/MagnificationGestureHandler$MotionEventInfo;
    ...
    iget-object v0, p0, mNext:Lcom/android/server/accessibility/MagnificationGestureHandler$MotionEventInfo;
...
.method static synthetic access$602(Lcom/android/server/accessibility/MagnificationGestureHandler$MotionEventInfo;Lcom/android/server/accessibility/MagnificationGestureHandler$MotionEventInfo;)Lcom/android/server/accessibility/MagnificationGestureHandler$MotionEventInfo;
    ...
    iput-object p1, p0, mNext:Lcom/android/server/accessibility/MagnificationGestureHandler$MotionEventInfo;
...
.method private clear()V
    ...
    iput-object v0, p0, event:Landroid/view/MotionEvent;

    iget-object v0, p0, rawEvent:Landroid/view/MotionEvent;

    invoke-static {v0}, Lcom/android/server/accessibility/MagnificationGestureHandler;->access$900(Landroid/view/MotionEvent;)Landroid/view/MotionEvent;

    move-result-object v0

    iput-object v0, p0, rawEvent:Landroid/view/MotionEvent;
...
.method static countOf(Lcom/android/server/accessibility/MagnificationGestureHandler$MotionEventInfo;I)I
    ...
    :cond_0
    iget-object v1, p0, event:Landroid/view/MotionEvent;
    ...
    :cond_1
    iget-object v1, p0, mNext:Lcom/android/server/accessibility/MagnificationGestureHandler$MotionEventInfo;

    invoke-static {v1, p1}, countOf(Lcom/android/server/accessibility/MagnificationGestureHandler$MotionEventInfo;I)I
...
.method public static obtain(Landroid/view/MotionEvent;Landroid/view/MotionEvent;I)Lcom/android/server/accessibility/MagnificationGestureHandler$MotionEventInfo;
    ...
    :try_start_0
    invoke-static {}, obtainInternal()Lcom/android/server/accessibility/MagnificationGestureHandler$MotionEventInfo;

    move-result-object v1

    invoke-direct {v1, p0, p1, p2}, initialize(Landroid/view/MotionEvent;Landroid/view/MotionEvent;I)V
...
.method private static obtainInternal()Lcom/android/server/accessibility/MagnificationGestureHandler$MotionEventInfo;
    ...
    sget-object v0, sPool:Lcom/android/server/accessibility/MagnificationGestureHandler$MotionEventInfo;

    iget-object v1, v0, mNext:Lcom/android/server/accessibility/MagnificationGestureHandler$MotionEventInfo;

    sput-object v1, sPool:Lcom/android/server/accessibility/MagnificationGestureHandler$MotionEventInfo;

    const/4 v1, 0x0

    iput-object v1, v0, mNext:Lcom/android/server/accessibility/MagnificationGestureHandler$MotionEventInfo;
...
.method public static toString(Lcom/android/server/accessibility/MagnificationGestureHandler$MotionEventInfo;)Ljava/lang/String;
    ...
    iget-object v2, p0, event:Landroid/view/MotionEvent;
    ...
    invoke-static {v0}, toString(Lcom/android/server/accessibility/MagnificationGestureHandler$MotionEventInfo;)Ljava/lang/String;
...
.method public recycle()V
    ...
    sget-object v1, sPool:Lcom/android/server/accessibility/MagnificationGestureHandler$MotionEventInfo;

    iput-object v1, p0, mNext:Lcom/android/server/accessibility/MagnificationGestureHandler$MotionEventInfo;

    sput-object p0, sPool:Lcom/android/server/accessibility/MagnificationGestureHandler$MotionEventInfo;

    iput-boolean v2, p0, mInPool:Z
