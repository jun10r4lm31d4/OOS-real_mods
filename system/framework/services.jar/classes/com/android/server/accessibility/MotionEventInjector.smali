...
.method public constructor <init>(Landroid/os/Handler;)V
    ...
    iput-object v0, p0, mOpenGesturesInProgress:Landroid/util/SparseArray;
    ...
    iput-object v0, p0, mSequencesInProgress:Landroid/util/IntArray;
    ...
    iput-object v0, p0, mStrokeIdToPointerId:Landroid/util/SparseIntArray;
...
.method private appendDownEvents(Ljava/util/List;[Landroid/accessibilityservice/GestureDescription$TouchPoint;IJ)V
    ...
    invoke-direct {p0}, getLastTouchPoints()[Landroid/accessibilityservice/GestureDescription$TouchPoint;
    ...
    iget v0, v8, mNumLastTouchPoints:I

    add-int/lit8 v1, v0, 0x1

    iput v1, v8, mNumLastTouchPoints:I
    ...
    iget-wide v1, v8, mDownTime:J

    iget v7, v8, mNumLastTouchPoints:I
    ...
    invoke-direct/range {v0 .. v7}, obtainMotionEvent(JJI[Landroid/accessibilityservice/GestureDescription$TouchPoint;I)Landroid/view/MotionEvent;
...
.method private appendMoveEventIfNeeded(Ljava/util/List;[Landroid/accessibilityservice/GestureDescription$TouchPoint;IJ)V
    ...
    iget v2, p0, mNumLastTouchPoints:I

    aget-object v3, p2, v1

    iget v3, v3, Landroid/accessibilityservice/GestureDescription$TouchPoint;->mStrokeId:I

    invoke-static {v9, v2, v3}, findPointByStrokeId([Landroid/accessibilityservice/GestureDescription$TouchPoint;II)I
    ...
    iget v8, p0, mNumLastTouchPoints:I
    ...
    invoke-direct/range {v1 .. v8}, obtainMotionEvent(JJI[Landroid/accessibilityservice/GestureDescription$TouchPoint;I)Landroid/view/MotionEvent;
...
.method private appendUpEvents(Ljava/util/List;[Landroid/accessibilityservice/GestureDescription$TouchPoint;IJ)V
    ...
    invoke-static {v9, v0, v1}, findPointByStrokeId([Landroid/accessibilityservice/GestureDescription$TouchPoint;II)I
    ...
    :goto_2
    iget v2, v8, mNumLastTouchPoints:I
    ...
    iget-object v3, v8, mLastTouchPoints:[Landroid/accessibilityservice/GestureDescription$TouchPoint;
    ...
    iput v2, v8, mNumLastTouchPoints:I

    iget v0, v8, mNumLastTouchPoints:I

    if-nez v0, :cond_4

    iget-object v0, v8, mStrokeIdToPointerId:Landroid/util/SparseIntArray;
...
.method private cancelAnyGestureInProgress(I)V
    ...
    invoke-virtual {p0}, getNext()Lcom/android/server/accessibility/EventStreamTransformation;

    move-result-object v0

    if-eqz v0, :cond_0

    iget-object v0, p0, mOpenGesturesInProgress:Landroid/util/SparseArray;
    ...
    invoke-direct/range {v2 .. v9}, obtainMotionEvent(JJI[Landroid/accessibilityservice/GestureDescription$TouchPoint;I)Landroid/view/MotionEvent;

    move-result-object v0

    const/high16 v2, 0x40000000    # 2.0f

    invoke-direct {p0, v0, v0, v2}, sendMotionEventToNext(Landroid/view/MotionEvent;Landroid/view/MotionEvent;I)V

    iget-object v2, p0, mOpenGesturesInProgress:Landroid/util/SparseArray;
...
.method private cancelAnyPendingInjectedEvents()V
    ...
    invoke-direct {p0, v3}, cancelAnyGestureInProgress(I)V

    iget-object v0, p0, mSequencesInProgress:Landroid/util/IntArray;
    ...
    iget-object v1, p0, mServiceInterfaceForCurrentGesture:Landroid/accessibilityservice/IAccessibilityServiceClient;

    iget-object v3, p0, mSequencesInProgress:Landroid/util/IntArray;

    invoke-virtual {v3, v0}, Landroid/util/IntArray;->get(I)I

    move-result v3

    invoke-direct {p0, v1, v3, v2}, notifyService(Landroid/accessibilityservice/IAccessibilityServiceClient;IZ)V

    iget-object v1, p0, mSequencesInProgress:Landroid/util/IntArray;
    ...
    :cond_1
    iget v0, p0, mNumLastTouchPoints:I
    ...
    :cond_2
    :goto_1
    iput v2, p0, mNumLastTouchPoints:I

    iget-object v0, p0, mStrokeIdToPointerId:Landroid/util/SparseIntArray;
...
.method private getLastTouchPoints()[Landroid/accessibilityservice/GestureDescription$TouchPoint;
    ...
    iget-object v0, p0, mLastTouchPoints:[Landroid/accessibilityservice/GestureDescription$TouchPoint;
    ...
    iput-object v1, p0, mLastTouchPoints:[Landroid/accessibilityservice/GestureDescription$TouchPoint;
    ...
    iget-object v2, p0, mLastTouchPoints:[Landroid/accessibilityservice/GestureDescription$TouchPoint;
...
.method private getMotionEventsFromGestureSteps(Ljava/util/List;J)Ljava/util/List;
    ...
    iput v1, p0, mNumLastTouchPoints:I
    ...
    invoke-direct/range {v1 .. v6}, appendMoveEventIfNeeded(Ljava/util/List;[Landroid/accessibilityservice/GestureDescription$TouchPoint;IJ)V
    ...
    invoke-direct/range {v1 .. v6}, appendUpEvents(Ljava/util/List;[Landroid/accessibilityservice/GestureDescription$TouchPoint;IJ)V
    ...
    invoke-direct/range {v1 .. v6}, appendDownEvents(Ljava/util/List;[Landroid/accessibilityservice/GestureDescription$TouchPoint;IJ)V
...
.method private getUnusedPointerId()I
    ...
    :cond_0
    iget-object v2, p0, mStrokeIdToPointerId:Landroid/util/SparseIntArray;
...
.method private injectEventsMainThread(Ljava/util/List;Landroid/accessibilityservice/IAccessibilityServiceClient;I)V
    ...
    iget-boolean v0, v1, mIsDestroyed:Z
    ...
    :cond_0
    invoke-virtual/range {p0 .. p0}, getNext()Lcom/android/server/accessibility/EventStreamTransformation;

    move-result-object v0

    if-nez v0, :cond_1

    invoke-direct {v1, v2, v3, v4}, notifyService(Landroid/accessibilityservice/IAccessibilityServiceClient;IZ)V

    return-void

    :cond_1
    invoke-direct/range {p0 .. p1}, newGestureTriesToContinueOldOne(Ljava/util/List;)Z

    move-result v0

    if-eqz v0, :cond_3

    iget-object v5, v1, mServiceInterfaceForCurrentGesture:Landroid/accessibilityservice/IAccessibilityServiceClient;

    if-ne v2, v5, :cond_2

    invoke-direct/range {p0 .. p1}, prepareToContinueOldGesture(Ljava/util/List;)Z
    ...
    :cond_2
    invoke-direct/range {p0 .. p0}, cancelAnyPendingInjectedEvents()V
    ...
    invoke-direct {v1, v5}, cancelAnyGestureInProgress(I)V

    :cond_4
    iput-object v2, v1, mServiceInterfaceForCurrentGesture:Landroid/accessibilityservice/IAccessibilityServiceClient;
    ...
    iget-object v7, v1, mSequencesInProgress:Landroid/util/IntArray;
    ...
    :cond_5
    iget-wide v7, v1, mLastScheduledEventTime:J

    :goto_1
    move-object/from16 v9, p1

    invoke-direct {v1, v9, v7, v8}, getMotionEventsFromGestureSteps(Ljava/util/List;J)Ljava/util/List;
    ...
    :cond_6
    iget-object v8, v1, mSequencesInProgress:Landroid/util/IntArray;
    ...
    iput-wide v13, v1, mLastScheduledEventTime:J
...
.method private notifyService(Landroid/accessibilityservice/IAccessibilityServiceClient;IZ)V
    ...
    iget-object v2, p0, mServiceInterfaceForCurrentGesture:Landroid/accessibilityservice/IAccessibilityServiceClient;
...
.method private obtainMotionEvent(JJI[Landroid/accessibilityservice/GestureDescription$TouchPoint;I)Landroid/view/MotionEvent;
    ...
    sget-object v1, sPointerCoords:[Landroid/view/MotionEvent$PointerCoords;
    ...
    sput-object v1, sPointerCoords:[Landroid/view/MotionEvent$PointerCoords;
    ...
    sget-object v2, sPointerCoords:[Landroid/view/MotionEvent$PointerCoords;
    ...
    :cond_1
    sget-object v1, sPointerProps:[Landroid/view/MotionEvent$PointerProperties;
    ...
    sput-object v1, sPointerProps:[Landroid/view/MotionEvent$PointerProperties;
    ...
    sget-object v2, sPointerProps:[Landroid/view/MotionEvent$PointerProperties;
    ...
    iget-object v2, v0, mStrokeIdToPointerId:Landroid/util/SparseIntArray;
    ...
    invoke-direct/range {p0 .. p0}, getUnusedPointerId()I

    move-result v2

    iget-object v3, v0, mStrokeIdToPointerId:Landroid/util/SparseIntArray;
    ...
    :cond_4
    sget-object v3, sPointerProps:[Landroid/view/MotionEvent$PointerProperties;
    ...
    sget-object v3, sPointerCoords:[Landroid/view/MotionEvent$PointerCoords;
    ...
    :cond_5
    sget-object v7, sPointerProps:[Landroid/view/MotionEvent$PointerProperties;

    sget-object v8, sPointerCoords:[Landroid/view/MotionEvent$PointerCoords;
...
.method private prepareToContinueOldGesture(Ljava/util/List;)Z
    ...
    iget-object v5, p0, mStrokeIdToPointerId:Landroid/util/SparseIntArray;
    ...
    :cond_1
    iget-object v7, p0, mStrokeIdToPointerId:Landroid/util/SparseIntArray;
    ...
    iget-object v7, p0, mLastTouchPoints:[Landroid/accessibilityservice/GestureDescription$TouchPoint;

    iget v8, p0, mNumLastTouchPoints:I

    iget v9, v4, Landroid/accessibilityservice/GestureDescription$TouchPoint;->mContinuedStrokeId:I

    invoke-static {v7, v8, v9}, findPointByStrokeId([Landroid/accessibilityservice/GestureDescription$TouchPoint;II)I
    ...
    iget-object v9, p0, mLastTouchPoints:[Landroid/accessibilityservice/GestureDescription$TouchPoint;
    ...
    :cond_2
    iget-object v8, p0, mLastTouchPoints:[Landroid/accessibilityservice/GestureDescription$TouchPoint;
    ...
    :cond_3
    iget-object v6, p0, mLastTouchPoints:[Landroid/accessibilityservice/GestureDescription$TouchPoint;
    ...
    :goto_3
    iget v4, p0, mNumLastTouchPoints:I

    if-ge v3, v4, :cond_8

    iget-object v4, p0, mLastTouchPoints:[Landroid/accessibilityservice/GestureDescription$TouchPoint;
...
.method public handleMessage(Landroid/os/Message;)Z
    ...
    invoke-direct {p0, v2, v3, v4}, injectEventsMainThread(Ljava/util/List;Landroid/accessibilityservice/IAccessibilityServiceClient;I)V
    ...
    invoke-direct {p0, v0, v0, v3}, sendMotionEventToNext(Landroid/view/MotionEvent;Landroid/view/MotionEvent;I)V
    ...
    iget-object v4, p0, mServiceInterfaceForCurrentGesture:Landroid/accessibilityservice/IAccessibilityServiceClient;

    iget-object v5, p0, mSequencesInProgress:Landroid/util/IntArray;

    invoke-virtual {v5, v2}, Landroid/util/IntArray;->get(I)I

    move-result v5

    invoke-direct {p0, v4, v5, v1}, notifyService(Landroid/accessibilityservice/IAccessibilityServiceClient;IZ)V

    iget-object v4, p0, mSequencesInProgress:Landroid/util/IntArray;
...
.method public onDestroy()V
    ...
    invoke-direct {p0}, cancelAnyPendingInjectedEvents()V
...
.method public onMotionEvent(Landroid/view/MotionEvent;Landroid/view/MotionEvent;I)V
    ...
    invoke-direct {p0, p1, p2, p3}, sendMotionEventToNext(Landroid/view/MotionEvent;Landroid/view/MotionEvent;I)V
