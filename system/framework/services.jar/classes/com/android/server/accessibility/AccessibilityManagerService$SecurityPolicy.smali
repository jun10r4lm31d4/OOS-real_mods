...
.method public constructor <init>(Lcom/android/server/accessibility/AccessibilityManagerService;)V
    ...
    iput-object v0, p0, mA11yWindowInfoById:Landroid/util/SparseArray;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, mWindowInfoById:Landroid/util/SparseArray;
...
.method static synthetic access$1200(Lcom/android/server/accessibility/AccessibilityManagerService$SecurityPolicy;)Landroid/view/accessibility/AccessibilityWindowInfo;
    ...
    invoke-direct {p0}, getPictureInPictureWindow()Landroid/view/accessibility/AccessibilityWindowInfo;
...
.method static synthetic access$2000(Lcom/android/server/accessibility/AccessibilityManagerService$SecurityPolicy;I)Ljava/util/List;
    ...
    invoke-direct {p0, p1}, getWatchOutsideTouchWindowIdLocked(I)Ljava/util/List;
...
.method static synthetic access$2100(Lcom/android/server/accessibility/AccessibilityManagerService$SecurityPolicy;I)Landroid/view/WindowInfo;
    ...
    invoke-direct {p0, p1}, findWindowInfoById(I)Landroid/view/WindowInfo;
...
.method private canDispatchAccessibilityEventLocked(Landroid/view/accessibility/AccessibilityEvent;)Z
    ...
    invoke-direct {p0, v1}, isRetrievalAllowingWindowLocked(I)Z
...
.method private findWindowInfoById(I)Landroid/view/WindowInfo;
    ...
    iget-object v0, p0, mWindowInfoById:Landroid/util/SparseArray;
...
.method private getPictureInPictureWindow()Landroid/view/accessibility/AccessibilityWindowInfo;
    ...
    iget-object v0, p0, mWindows:Ljava/util/List;
    ...
    iget-object v2, p0, mWindows:Ljava/util/List;
...
.method private getWatchOutsideTouchWindowIdLocked(I)Ljava/util/List;
    ...
    iget-boolean v1, p0, mHasWatchOutsideTouchWindow:Z
    ...
    :goto_0
    iget-object v3, p0, mWindowInfoById:Landroid/util/SparseArray;
    ...
    iget-object v4, p0, mWindowInfoById:Landroid/util/SparseArray;
...
.method private isRetrievalAllowingWindowLocked(I)Z
    ...
    invoke-direct {p0, p1}, isShellAllowedToRetrieveWindowLocked(I)Z
    ...
    :cond_2
    invoke-virtual {p0, p1}, findA11yWindowInfoById(I)Landroid/view/accessibility/AccessibilityWindowInfo;
...
.method private sendEventsForChangedWindowsLocked(Ljava/util/List;Landroid/util/SparseArray;)V
    ...
    iget-object v4, p0, mA11yWindowInfoById:Landroid/util/SparseArray;
    ...
    iget-object v5, p0, mWindows:Ljava/util/List;
...
.method public canGetAccessibilityNodeInfoLocked(Lcom/android/server/accessibility/AbstractAccessibilityServiceConnection;I)Z
    ...
    invoke-virtual {p0, p1}, canRetrieveWindowContentLocked(Lcom/android/server/accessibility/AbstractAccessibilityServiceConnection;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-direct {p0, p2}, isRetrievalAllowingWindowLocked(I)Z
...
.method public clearWindowsLocked()V
    ...
    invoke-virtual {p0, v0}, updateWindowsLocked(Ljava/util/List;)V

    iput v1, p0, mActiveWindowId:I
...
.method public computePartialInteractiveRegionForWindowLocked(ILandroid/graphics/Region;)Z
    ...
    iget-object v4, p0, mWindows:Ljava/util/List;
...
.method public findA11yWindowInfoById(I)Landroid/view/accessibility/AccessibilityWindowInfo;
    ...
    iget-object v0, p0, mA11yWindowInfoById:Landroid/util/SparseArray;
...
.method public onTouchInteractionEnd()V
    ...
    iget v2, p0, mFocusedWindowId:I

    invoke-direct {p0, v2}, setActiveWindowLocked(I)V
    ...
    iget v2, v2, mActiveWindowId:I

    if-eq v1, v2, :cond_0

    iget v2, p0, mAccessibilityFocusedWindowId:I
    ...
    invoke-direct {p0, v1}, box(I)Ljava/util/function/IntSupplier;
...
.method public resolveCallingUserIdEnforcingPermissionsLocked(I)I
    ...
    :cond_1
    invoke-direct {p0, v3}, resolveProfileParentLocked(I)I
    ...
    invoke-direct {p0, v5}, hasPermission(Ljava/lang/String;)Z
...
.method resolveValidReportedPackageLocked(Ljava/lang/CharSequence;II)Ljava/lang/String;
    ...
    invoke-direct {p0, v1, v2}, isValidPackageForUid(Ljava/lang/String;I)Z
...
.method public updateActiveAndAccessibilityFocusedWindowLocked(IJII)V
    ...
    :try_start_0
    iget-wide v1, p0, mAccessibilityFocusNodeId:J
    ...
    :cond_1
    iget-wide v4, p0, mAccessibilityFocusNodeId:J
    ...
    iput v1, p0, mAccessibilityFocusedWindowId:I
    ...
    iget v4, p0, mAccessibilityFocusedWindowId:I

    invoke-direct {p0, v4}, box(I)Ljava/util/function/IntSupplier;
    ...
    invoke-direct {v1, p1}, setAccessibilityFocusedWindowLocked(I)V
    ...
    :try_start_2
    iget-boolean v1, p0, mTouchInteractionInProgress:Z
...
.method public updateWindowsLocked(Ljava/util/List;)V
    ...
    iput-object v0, p0, mWindows:Ljava/util/List;

    :cond_0
    new-instance v0, Ljava/util/ArrayList;

    iget-object v1, p0, mWindows:Ljava/util/List;

    invoke-direct {v0, v1}, Ljava/util/ArrayList;-><init>(Ljava/util/Collection;)V

    iget-object v1, p0, mA11yWindowInfoById:Landroid/util/SparseArray;
    ...
    iget-object v2, p0, mA11yWindowInfoById:Landroid/util/SparseArray;
    ...
    :cond_1
    iget-object v2, p0, mWindowInfoById:Landroid/util/SparseArray;

    invoke-virtual {v2}, Landroid/util/SparseArray;->clear()V

    const/4 v2, 0x0

    iput-boolean v2, p0, mHasWatchOutsideTouchWindow:Z

    const/4 v3, -0x1

    iput v3, p0, mFocusedWindowId:I

    iget-boolean v4, p0, mTouchInteractionInProgress:Z

    if-nez v4, :cond_2

    iput v3, p0, mActiveWindowId:I
    ...
    iget v6, p0, mAccessibilityFocusedWindowId:I
    ...
    iput v9, p0, mFocusedWindowId:I

    iget-boolean v10, p0, mTouchInteractionInProgress:Z

    if-nez v10, :cond_5

    iput v9, p0, mActiveWindowId:I
    ...
    :cond_6
    :goto_3
    iget-boolean v10, p0, mHasWatchOutsideTouchWindow:Z
    ...
    iput-boolean v7, p0, mHasWatchOutsideTouchWindow:Z

    :cond_7
    iget-object v10, p0, mWindows:Ljava/util/List;

    invoke-interface {v10, v8}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    iget-object v10, p0, mA11yWindowInfoById:Landroid/util/SparseArray;

    invoke-virtual {v10, v9, v8}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    iget-object v10, p0, mWindowInfoById:Landroid/util/SparseArray;
    ...
    :cond_9
    iget-boolean v3, p0, mTouchInteractionInProgress:Z

    if-eqz v3, :cond_a

    if-eqz v4, :cond_a

    iget v3, p0, mFocusedWindowId:I
    ...
    iget-object v8, p0, mWindows:Ljava/util/List;
    ...
    iget v10, p0, mAccessibilityFocusedWindowId:I
    ...
    :cond_d
    invoke-direct {p0, v0, v1}, sendEventsForChangedWindowsLocked(Ljava/util/List;Landroid/util/SparseArray;)V
    ...
    iget v9, p0, mAccessibilityFocusedWindowId:I

    invoke-direct {p0, v9}, box(I)Ljava/util/function/IntSupplier;
