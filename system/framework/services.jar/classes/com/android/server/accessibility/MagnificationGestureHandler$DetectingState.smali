...
.method public constructor <init>(Lcom/android/server/accessibility/MagnificationGestureHandler;Landroid/content/Context;)V
    ...
    iput-object p1, p0, this$0:Lcom/android/server/accessibility/MagnificationGestureHandler;
    ...
    iput v0, p0, mMultiTapMaxDelay:I
    ...
    iput v0, p0, mSwipeMinDistance:I
    ...
    iput v0, p0, mMultiTapMaxDistance:I
...
.method private cacheDelayedMotionEvent(Landroid/view/MotionEvent;Landroid/view/MotionEvent;I)V
    ...
    iget-object v0, p0, mLastDown:Landroid/view/MotionEvent;

    iput-object v0, p0, mPreLastDown:Landroid/view/MotionEvent;

    invoke-static {p1}, Landroid/view/MotionEvent;->obtain(Landroid/view/MotionEvent;)Landroid/view/MotionEvent;

    move-result-object v0

    iput-object v0, p0, mLastDown:Landroid/view/MotionEvent;
    ...
    iget-object v0, p0, mLastUp:Landroid/view/MotionEvent;

    iput-object v0, p0, mPreLastUp:Landroid/view/MotionEvent;

    invoke-static {p1}, Landroid/view/MotionEvent;->obtain(Landroid/view/MotionEvent;)Landroid/view/MotionEvent;

    move-result-object v0

    iput-object v0, p0, mLastUp:Landroid/view/MotionEvent;
    ...
    iget-object v1, p0, mDelayedEventQueue:Lcom/android/server/accessibility/MagnificationGestureHandler$MotionEventInfo;

    if-nez v1, :cond_2

    iput-object v0, p0, mDelayedEventQueue:Lcom/android/server/accessibility/MagnificationGestureHandler$MotionEventInfo;
...
.method private clearDelayedMotionEvents()V
    ...
    :goto_0
    iget-object v0, p0, mDelayedEventQueue:Lcom/android/server/accessibility/MagnificationGestureHandler$MotionEventInfo;
    ...
    iput-object v1, p0, mDelayedEventQueue:Lcom/android/server/accessibility/MagnificationGestureHandler$MotionEventInfo;
...
.method private isMultiTap(Landroid/view/MotionEvent;Landroid/view/MotionEvent;)Z
    ...
    iget v0, p0, mMultiTapMaxDelay:I

    iget v1, p0, mMultiTapMaxDistance:I
...
.method private onTripleTap(Landroid/view/MotionEvent;)V
    ...
    iget-object v0, p0, this$0:Lcom/android/server/accessibility/MagnificationGestureHandler;
    ...
    iget-object v1, p0, this$0:Lcom/android/server/accessibility/MagnificationGestureHandler;
...
.method private timeBetween(Landroid/view/MotionEvent;Landroid/view/MotionEvent;)J
    ...
    :cond_0
    invoke-direct {p0, p1}, timeOf(Landroid/view/MotionEvent;)J

    move-result-wide v0

    invoke-direct {p0, p2}, timeOf(Landroid/view/MotionEvent;)J
...
.method public afterMultiTapTimeoutTransitionToDelegatingState()V
    ...
    iget v1, p0, mMultiTapMaxDelay:I
...
.method public clear()V
    ...
    invoke-virtual {p0, v0}, setShortcutTriggered(Z)V

    invoke-direct {p0}, removePendingDelayedMessages()V
...
.method public handleMessage(Landroid/os/Message;)Z
    ...
    invoke-virtual {p0}, transitionToDelegatingStateAndClear()V
    ...
    invoke-virtual {p0, v2}, transitionToViewportDraggingStateAndClear(Landroid/view/MotionEvent;)V
...
.method public isMultiTapTriggered(I)Z
    ...
    iget-boolean v0, p0, mShortcutTriggered:Z
    ...
    iget-object v0, p0, mPreLastDown:Landroid/view/MotionEvent;

    iget-object v3, p0, mLastDown:Landroid/view/MotionEvent;

    invoke-direct {p0, v0, v3}, isMultiTap(Landroid/view/MotionEvent;Landroid/view/MotionEvent;)Z

    move-result v0

    if-eqz v0, :cond_2

    iget-object v0, p0, mPreLastUp:Landroid/view/MotionEvent;

    iget-object v3, p0, mLastUp:Landroid/view/MotionEvent;
...
.method isTapOutOfDistanceSlop()Z
    ...
    iget-object v2, p0, mLastDown:Landroid/view/MotionEvent;
    ...
    iget v0, p0, mMultiTapMaxDistance:I
    ...
    iget-object v3, p0, mPreLastDown:Landroid/view/MotionEvent;

    iget-object v4, p0, mLastDown:Landroid/view/MotionEvent;

    iget v5, p0, mMultiTapMaxDelay:I
...
.method public onMotionEvent(Landroid/view/MotionEvent;Landroid/view/MotionEvent;I)V
    ...
    :cond_2
    invoke-virtual {p0}, isFingerDown()Z
    ...
    iget v0, p0, mSwipeMinDistance:I
    ...
    invoke-virtual {p0, v1}, isMultiTapTriggered(I)Z

    move-result v0

    if-eqz v0, :cond_3

    invoke-virtual {p0, p1}, transitionToViewportDraggingStateAndClear(Landroid/view/MotionEvent;)V
    ...
    invoke-virtual {p0, v0}, isMultiTapTriggered(I)Z

    move-result v0

    if-eqz v0, :cond_6

    invoke-direct {p0, p1}, onTripleTap(Landroid/view/MotionEvent;)V
    ...
    iget-object v1, p0, mLastUp:Landroid/view/MotionEvent;

    invoke-direct {p0, v0, v1}, timeBetween(Landroid/view/MotionEvent;Landroid/view/MotionEvent;)J

    move-result-wide v0

    iget v2, p0, mLongTapMinDelay:I
    ...
    iget v2, p0, mSwipeMinDistance:I
    ...
    iget-object v2, p0, this$0:Lcom/android/server/accessibility/MagnificationGestureHandler;
    ...
    invoke-virtual {p0, p1}, afterLongTapTimeoutTransitionToDraggingState(Landroid/view/MotionEvent;)V

    goto :goto_1

    :cond_a
    invoke-virtual {p0}, isTapOutOfDistanceSlop()Z
    ...
    :cond_d
    :goto_0
    invoke-virtual {p0}, afterMultiTapTimeoutTransitionToDelegatingState()V
...
.method setShortcutTriggered(Z)V
    ...
    :cond_0
    iput-boolean p1, p0, mShortcutTriggered:Z
...
.method public toString()Ljava/lang/String;
    ...
    iget-boolean v1, p0, mShortcutTriggered:Z
