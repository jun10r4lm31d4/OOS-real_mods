...
.method constructor <init>(Ljava/lang/Object;)V
    ...
    iput-object v0, p0, mUiAutomationServiceOwnerDeathRecipient:Landroid/os/IBinder$DeathRecipient;
...
.method static synthetic access$100(Lcom/android/server/accessibility/UiAutomationManager;)V
    ...
    invoke-direct {p0}, destroyUiAutomationService()V
...
.method static synthetic access$200()Landroid/content/ComponentName;
    ...
    sget-object v0, COMPONENT_NAME:Landroid/content/ComponentName;
...
.method private destroyUiAutomationService()V
    ...
    :try_start_0
    iget-object v1, p0, mUiAutomationService:Lcom/android/server/accessibility/UiAutomationManager$UiAutomationService;
    ...
    iget-object v2, p0, mUiAutomationService:Lcom/android/server/accessibility/UiAutomationManager$UiAutomationService;
    ...
    iput-object v1, p0, mUiAutomationService:Lcom/android/server/accessibility/UiAutomationManager$UiAutomationService;

    iput v3, p0, mUiAutomationFlags:I

    iget-object v2, p0, mUiAutomationServiceOwner:Landroid/os/IBinder;

    if-eqz v2, :cond_0

    iget-object v2, p0, mUiAutomationServiceOwner:Landroid/os/IBinder;

    iget-object v4, p0, mUiAutomationServiceOwnerDeathRecipient:Landroid/os/IBinder$DeathRecipient;

    invoke-interface {v2, v4, v3}, Landroid/os/IBinder;->unlinkToDeath(Landroid/os/IBinder$DeathRecipient;I)Z

    iput-object v1, p0, mUiAutomationServiceOwner:Landroid/os/IBinder;
...
.method canRetrieveInteractiveWindowsLocked()Z
    ...
    iget-object v0, p0, mUiAutomationService:Lcom/android/server/accessibility/UiAutomationManager$UiAutomationService;
...
.method registerUiTestAutomationServiceLocked(Landroid/os/IBinder;Landroid/accessibilityservice/IAccessibilityServiceClient;Landroid/content/Context;Landroid/accessibilityservice/AccessibilityServiceInfo;ILandroid/os/Handler;Lcom/android/server/accessibility/AccessibilityManagerService$SecurityPolicy;Lcom/android/server/accessibility/AbstractAccessibilityServiceConnection$SystemSupport;Lcom/android/server/wm/WindowManagerInternal;Lcom/android/server/accessibility/GlobalActionPerformer;I)V
    ...
    iget-object v11, v12, mLock:Ljava/lang/Object;
    ...
    iget-object v0, v12, mUiAutomationService:Lcom/android/server/accessibility/UiAutomationManager$UiAutomationService;
    :try_end_0
    ...
    :try_start_1
    iget-object v0, v12, mUiAutomationServiceOwnerDeathRecipient:Landroid/os/IBinder$DeathRecipient;
    ...
    :try_start_2
    iput-object v9, v12, mSystemSupport:Lcom/android/server/accessibility/AbstractAccessibilityServiceConnection$SystemSupport;
    ...
    iput-object v0, v12, mUiAutomationService:Lcom/android/server/accessibility/UiAutomationManager$UiAutomationService;

    iput-object v13, v12, mUiAutomationServiceOwner:Landroid/os/IBinder;
    :try_end_3
    ...
    :try_start_4
    iput v1, v12, mUiAutomationFlags:I

    iput-object v15, v12, mUiAutomationServiceInfo:Landroid/accessibilityservice/AccessibilityServiceInfo;
    ...
    iget-object v2, v12, mUiAutomationService:Lcom/android/server/accessibility/UiAutomationManager$UiAutomationService;
    ...
    invoke-direct/range {p0 .. p0}, destroyUiAutomationService()V
...
.method suppressingAccessibilityServicesLocked()Z
    ...
    iget v0, p0, mUiAutomationFlags:I
