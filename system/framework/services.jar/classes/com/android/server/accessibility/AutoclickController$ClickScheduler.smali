...
.method public constructor <init>(Lcom/android/server/accessibility/AutoclickController;Landroid/os/Handler;I)V
    ...
    iput-object p1, p0, this$0:Lcom/android/server/accessibility/AutoclickController;
    ...
    iput-object p1, p0, mLastMotionEvent:Landroid/view/MotionEvent;

    invoke-direct {p0}, resetInternalState()V
    ...
    iput-object p1, p0, mAnchorCoords:Landroid/view/MotionEvent$PointerCoords;
...
.method private cacheLastEvent(Landroid/view/MotionEvent;IZ)V
    ...
    iget-object v0, p0, mLastMotionEvent:Landroid/view/MotionEvent;
    ...
    iput-object v0, p0, mLastMotionEvent:Landroid/view/MotionEvent;

    iput p2, p0, mEventPolicyFlags:I
    ...
    iget-object v1, p0, mLastMotionEvent:Landroid/view/MotionEvent;

    iget-object v2, p0, mAnchorCoords:Landroid/view/MotionEvent$PointerCoords;
...
.method private detectMovement(Landroid/view/MotionEvent;)Z
    ...
    iget-object v3, p0, mAnchorCoords:Landroid/view/MotionEvent$PointerCoords;
...
.method private rescheduleClick(I)V
    ...
    iget-wide v2, p0, mScheduledClickTime:J

    cmp-long v2, v0, v2

    if-lez v2, :cond_0

    iput-wide v0, p0, mScheduledClickTime:J
...
.method private sendClick()V
    ...
    iget-object v1, v0, mLastMotionEvent:Landroid/view/MotionEvent;

    if-eqz v1, :cond_3

    iget-object v1, v0, this$0:Lcom/android/server/accessibility/AutoclickController;
    ...
    iget-object v2, v0, mTempPointerProperties:[Landroid/view/MotionEvent$PointerProperties;
    ...
    iput-object v2, v0, mTempPointerProperties:[Landroid/view/MotionEvent$PointerProperties;
    ...
    :cond_1
    iget-object v2, v0, mLastMotionEvent:Landroid/view/MotionEvent;

    iget-object v5, v0, mTempPointerProperties:[Landroid/view/MotionEvent$PointerProperties;
    ...
    iget-object v2, v0, mTempPointerCoords:[Landroid/view/MotionEvent$PointerCoords;

    if-nez v2, :cond_2

    new-array v2, v3, [Landroid/view/MotionEvent$PointerCoords;

    iput-object v2, v0, mTempPointerCoords:[Landroid/view/MotionEvent$PointerCoords;
    ...
    iget-object v5, v0, mTempPointerCoords:[Landroid/view/MotionEvent$PointerCoords;
    ...
    iget-object v11, v0, mTempPointerProperties:[Landroid/view/MotionEvent$PointerProperties;

    iget-object v12, v0, mTempPointerCoords:[Landroid/view/MotionEvent$PointerCoords;

    iget v13, v0, mMetaState:I
    ...
    iget-object v3, v0, this$0:Lcom/android/server/accessibility/AutoclickController;

    iget v5, v0, mEventPolicyFlags:I
...
.method public toString()Ljava/lang/String;
    ...
    iget-wide v1, p0, mScheduledClickTime:J
    ...
    iget-object v1, p0, mAnchorCoords:Landroid/view/MotionEvent$PointerCoords;
    ...
    iget v1, p0, mEventPolicyFlags:I
...
.method public update(Landroid/view/MotionEvent;I)V
    ...
    invoke-direct {p0, p1}, detectMovement(Landroid/view/MotionEvent;)Z
    ...
    :goto_1
    invoke-direct {p0, p1, p2, v1}, cacheLastEvent(Landroid/view/MotionEvent;IZ)V

    if-eqz v0, :cond_2

    iget v1, p0, mDelay:I

    invoke-direct {p0, v1}, rescheduleClick(I)V
