...
.method public constructor <init>(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;Landroid/content/Context;Landroid/content/ComponentName;Landroid/accessibilityservice/AccessibilityServiceInfo;ILandroid/os/Handler;Ljava/lang/Object;Lcom/android/server/accessibility/AccessibilityManagerService$SecurityPolicy;Lcom/android/server/accessibility/AbstractAccessibilityServiceConnection$SystemSupport;Lcom/android/server/wm/WindowManagerInternal;Lcom/android/server/accessibility/GlobalActionPerformer;)V
    ...
    iput-object v0, v12, mUserStateWeakReference:Ljava/lang/ref/WeakReference;

    new-instance v0, Landroid/content/Intent;

    invoke-direct {v0}, Landroid/content/Intent;-><init>()V

    iget-object v2, v12, mComponentName:Landroid/content/ComponentName;

    invoke-virtual {v0, v2}, Landroid/content/Intent;->setComponent(Landroid/content/ComponentName;)Landroid/content/Intent;

    move-result-object v0

    iput-object v0, v12, mIntent:Landroid/content/Intent;

    move-object/from16 v2, p6

    iput-object v2, v12, mMainHandler:Landroid/os/Handler;

    iget-object v0, v12, mIntent:Landroid/content/Intent;
    ...
    iget-object v6, v12, mSystemSupport:Lcom/android/server/accessibility/AbstractAccessibilityServiceConnection$SystemSupport;

    iget-object v7, v12, mContext:Landroid/content/Context;
...
.method private initializeService()V
    ...
    :try_start_0
    iget-object v2, p0, mUserStateWeakReference:Ljava/lang/ref/WeakReference;
    ...
    iget-boolean v4, p0, mWasConnectedAndDied:Z
    ...
    iput-boolean v5, p0, mWasConnectedAndDied:Z

    iget-object v4, p0, mServiceInterface:Landroid/accessibilityservice/IAccessibilityServiceClient;
    ...
    iget-object v2, p0, mOverlayWindowToken:Landroid/os/IBinder;
...
.method public static synthetic lambda$ASP9bmSvpeD7ZE_uJ8sm-9hCwiU(Lcom/android/server/accessibility/AccessibilityServiceConnection;)V
    ...
    invoke-direct {p0}, initializeService()V
...
.method public bindLocked()V
    ...
    iget-object v0, p0, mUserStateWeakReference:Ljava/lang/ref/WeakReference;
    ...
    iget-object v5, p0, mComponentName:Landroid/content/ComponentName;
...
.method public binderDied()V
    ...
    iget-object v1, p0, mUserStateWeakReference:Ljava/lang/ref/WeakReference;
...
.method public getServiceInfo()Landroid/accessibilityservice/AccessibilityServiceInfo;
    ...
    iget-boolean v1, p0, mWasConnectedAndDied:Z
...
.method public isAccessibilityButtonAvailable()Z
    ...
    invoke-virtual {p0, v1}, isAccessibilityButtonAvailableLocked(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)Z
...
.method public isAccessibilityButtonAvailableLocked(Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)Z
    ...
    iget-boolean v0, p0, mRequestAccessibilityButton:Z
    ...
    iget-boolean v4, v3, mRequestAccessibilityButton:Z
...
.method public isCapturingFingerprintGestures()Z
    ...
    iget-boolean v0, p0, mCaptureFingerprintGestures:Z
...
.method public onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    iput-object v1, p0, mServiceInterface:Landroid/accessibilityservice/IAccessibilityServiceClient;
    ...
    iget-object v2, p0, mMainHandler:Landroid/os/Handler;
...
.method public sendGesture(ILandroid/content/pm/ParceledListSlice;)V
    ...
    iget-object v3, p0, mServiceInterface:Landroid/accessibilityservice/IAccessibilityServiceClient;
    ...
    iget-object v5, p0, mServiceInterface:Landroid/accessibilityservice/IAccessibilityServiceClient;
