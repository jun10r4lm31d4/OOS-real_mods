...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/accessibility/AccessibilityManagerService;)V
    ...
    invoke-direct {p0, p1, p2, v0}, <init>(Landroid/content/Context;Lcom/android/server/accessibility/AccessibilityManagerService;Lcom/android/server/accessibility/AccessibilityGestureDetector;)V
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/accessibility/AccessibilityManagerService;Lcom/android/server/accessibility/AccessibilityGestureDetector;)V
    ...
    iput v0, p0, mLongPressingPointerId:I
    ...
    iput-object v0, p0, mReceivedPointerTracker:Lcom/android/server/accessibility/TouchExplorer$ReceivedPointerTracker;
    ...
    iput-object v0, p0, mInjectedPointerTracker:Lcom/android/server/accessibility/TouchExplorer$InjectedPointerTracker;

    invoke-static {}, Landroid/view/ViewConfiguration;->getDoubleTapTimeout()I

    move-result v0

    iput v0, p0, mDetermineUserIntentTimeout:I
    ...
    iput-object v0, p0, mExitGestureDetectionModeDelayed:Lcom/android/server/accessibility/TouchExplorer$ExitGestureDetectionModeDelayed;
    ...
    iput-object v0, p0, mSendHoverEnterAndMoveDelayed:Lcom/android/server/accessibility/TouchExplorer$SendHoverEnterAndMoveDelayed;
    ...
    iput-object v0, p0, mSendHoverExitDelayed:Lcom/android/server/accessibility/TouchExplorer$SendHoverExitDelayed;

    new-instance v0, Lcom/android/server/accessibility/TouchExplorer$SendAccessibilityEventDelayed;

    iget v1, p0, mDetermineUserIntentTimeout:I
    ...
    iput-object v0, p0, mSendTouchExplorationEndDelayed:Lcom/android/server/accessibility/TouchExplorer$SendAccessibilityEventDelayed;
    ...
    iput-object v0, p0, mSendTouchInteractionEndDelayed:Lcom/android/server/accessibility/TouchExplorer$SendAccessibilityEventDelayed;
    ...
    iput-object v0, p0, mGestureDetector:Lcom/android/server/accessibility/AccessibilityGestureDetector;

    goto :goto_0

    :cond_0
    iput-object p3, p0, mGestureDetector:Lcom/android/server/accessibility/AccessibilityGestureDetector;
...
.method private clear(Landroid/view/MotionEvent;I)V
    ...
    :cond_1
    iput v1, p0, mDraggingPointerId:I
    ...
    iget-object v0, p0, mGestureDetector:Lcom/android/server/accessibility/AccessibilityGestureDetector;
    ...
    iput v0, p0, mLongPressingPointerDeltaX:I

    iput v0, p0, mLongPressingPointerDeltaY:I

    iput v2, p0, mCurrentState:I

    iput-boolean v0, p0, mTouchExplorationInProgress:Z
...
.method private handleMotionEventStateDelegating(Landroid/view/MotionEvent;I)V
    ...
    iget v3, p0, mLongPressingPointerDeltaY:I

    neg-int v3, v3

    invoke-direct {p0, p1, v0, v3}, offsetEvent(Landroid/view/MotionEvent;II)Landroid/view/MotionEvent;
...
.method private handleMotionEventStateDragging(Landroid/view/MotionEvent;I)V
    ...
    iget v1, p0, mDraggingPointerId:I
    ...
    iget v5, p0, mDraggingPointerId:I
    ...
    iput v3, p0, mDraggingPointerId:I
    ...
    iget v2, p0, mDraggingPointerId:I

    if-ne v1, v2, :cond_2

    iput v3, p0, mDraggingPointerId:I

    invoke-direct {p0, p1, v4, v0, p2}, sendMotionEvent(Landroid/view/MotionEvent;III)V
    ...
    :cond_7
    invoke-direct {p0, p1}, isDraggingGesture(Landroid/view/MotionEvent;)Z
    ...
    iget v6, p0, mDraggingPointerId:I
    ...
    iget v11, p0, mScaledMinPointerDistanceToUseMiddleLocation:I
    ...
    :cond_a
    invoke-direct {p0, p1, v5, v0, p2}, sendMotionEvent(Landroid/view/MotionEvent;III)V
    ...
    :cond_d
    iget-object v1, p0, mAms:Lcom/android/server/accessibility/AccessibilityManagerService;
...
.method private handleMotionEventStateTouchExploring(Landroid/view/MotionEvent;Landroid/view/MotionEvent;I)V
    ...
    :cond_0
    iget-object v1, p0, mSendHoverEnterAndMoveDelayed:Lcom/android/server/accessibility/TouchExplorer$SendHoverEnterAndMoveDelayed;

    invoke-virtual {v1}, Lcom/android/server/accessibility/TouchExplorer$SendHoverEnterAndMoveDelayed;->cancel()V

    iget-object v1, p0, mSendHoverExitDelayed:Lcom/android/server/accessibility/TouchExplorer$SendHoverExitDelayed;
    ...
    iget-object v3, p0, mSendHoverEnterAndMoveDelayed:Lcom/android/server/accessibility/TouchExplorer$SendHoverEnterAndMoveDelayed;
    ...
    iget-object v3, p0, mSendHoverExitDelayed:Lcom/android/server/accessibility/TouchExplorer$SendHoverExitDelayed;
    ...
    :cond_2
    invoke-direct {p0, p3}, sendHoverExitAndTouchExplorationGestureEndIfNeeded(I)V
    ...
    invoke-direct {p0, p1, p3}, sendDownForAllNotInjectedPointers(Landroid/view/MotionEvent;I)V

    goto/16 :goto_2

    :cond_3
    iget-object v6, p0, mSendHoverEnterAndMoveDelayed:Lcom/android/server/accessibility/TouchExplorer$SendHoverEnterAndMoveDelayed;
    ...
    iget-object v6, p0, mSendHoverExitDelayed:Lcom/android/server/accessibility/TouchExplorer$SendHoverExitDelayed;
    ...
    :cond_4
    iget-boolean v6, p0, mTouchExplorationInProgress:Z
    ...
    invoke-direct {p0, p1, v2, v5, p3}, sendMotionEvent(Landroid/view/MotionEvent;III)V
    ...
    :cond_8
    iget-object v2, p0, mSendHoverEnterAndMoveDelayed:Lcom/android/server/accessibility/TouchExplorer$SendHoverEnterAndMoveDelayed;
    ...
    :cond_9
    iget-boolean v2, p0, mTouchExplorationInProgress:Z

    if-eqz v2, :cond_a

    invoke-direct {p0, p3}, sendTouchExplorationGestureStartAndHoverEnterIfNeeded(I)V
    ...
    :goto_3
    iget-object v3, p0, mSendTouchInteractionEndDelayed:Lcom/android/server/accessibility/TouchExplorer$SendAccessibilityEventDelayed;
    ...
    iget-boolean v1, p0, mTouchExplorationInProgress:Z
    ...
    :cond_e
    iget-object v1, p0, mGestureDetector:Lcom/android/server/accessibility/AccessibilityGestureDetector;
    ...
    iget-object v4, p0, mSendHoverEnterAndMoveDelayed:Lcom/android/server/accessibility/TouchExplorer$SendHoverEnterAndMoveDelayed;
...
.method private isDraggingGesture(Landroid/view/MotionEvent;)Z
    ...
    iget-object v2, v1, mReceivedPointerTracker:Lcom/android/server/accessibility/TouchExplorer$ReceivedPointerTracker;
...
.method private offsetEvent(Landroid/view/MotionEvent;II)Landroid/view/MotionEvent;
    ...
    iget v4, v3, mLongPressingPointerId:I
...
.method private sendActionDownAndUp(Landroid/view/MotionEvent;IZ)V
    ...
    invoke-direct {p0, p1, v3, v2, p2}, sendMotionEvent(Landroid/view/MotionEvent;III)V

    invoke-virtual {p1, p3}, Landroid/view/MotionEvent;->setTargetAccessibilityFocus(Z)V

    invoke-direct {p0, p1, v1, v2, p2}, sendMotionEvent(Landroid/view/MotionEvent;III)V
...
.method private sendDownForAllNotInjectedPointers(Landroid/view/MotionEvent;I)V
    ...
    invoke-direct {p0, v5, v3}, computeInjectionAction(II)I

    move-result v5

    invoke-direct {p0, p1, v5, v1, p2}, sendMotionEvent(Landroid/view/MotionEvent;III)V
...
.method private sendHoverExitAndTouchExplorationGestureEndIfNeeded(I)V
    ...
    iget-object v3, p0, mSendTouchExplorationEndDelayed:Lcom/android/server/accessibility/TouchExplorer$SendAccessibilityEventDelayed;
...
.method public onDoubleTap(Landroid/view/MotionEvent;I)Z
    ...
    :cond_0
    iget-object v2, v0, mAms:Lcom/android/server/accessibility/AccessibilityManagerService;

    invoke-virtual {v2}, Lcom/android/server/accessibility/AccessibilityManagerService;->onTouchInteractionEnd()V

    iget-object v2, v0, mSendHoverEnterAndMoveDelayed:Lcom/android/server/accessibility/TouchExplorer$SendHoverEnterAndMoveDelayed;

    invoke-virtual {v2}, Lcom/android/server/accessibility/TouchExplorer$SendHoverEnterAndMoveDelayed;->cancel()V

    iget-object v2, v0, mSendHoverExitDelayed:Lcom/android/server/accessibility/TouchExplorer$SendHoverExitDelayed;

    invoke-virtual {v2}, Lcom/android/server/accessibility/TouchExplorer$SendHoverExitDelayed;->cancel()V

    iget-object v2, v0, mSendTouchExplorationEndDelayed:Lcom/android/server/accessibility/TouchExplorer$SendAccessibilityEventDelayed;
    ...
    invoke-direct {v0, v2}, sendAccessibilityEvent(I)V
    ...
    iget-object v6, v0, mTempPoint:Landroid/graphics/Point;

    invoke-direct {v0, v6}, computeClickLocation(Landroid/graphics/Point;)I
    ...
    invoke-direct {v0, v8, v9, v3}, sendActionDownAndUp(Landroid/view/MotionEvent;IZ)V
...
.method public onDoubleTapAndHold(Landroid/view/MotionEvent;I)V
    ...
    invoke-direct {p0, v2}, computeClickLocation(Landroid/graphics/Point;)I
    ...
    iput v4, p0, mLongPressingPointerDeltaX:I
    ...
    iput v4, p0, mLongPressingPointerDeltaY:I
...
.method public onGestureCancelled(Landroid/view/MotionEvent;I)Z
    ...
    :cond_0
    invoke-direct {p0, v1}, endGestureDetection(Z)V
...
.method public onGestureCompleted(I)Z
    ...
    invoke-direct {p0, v0}, endGestureDetection(Z)V
...
.method public onMotionEvent(Landroid/view/MotionEvent;Landroid/view/MotionEvent;I)V
    ...
    invoke-direct {p0, p1, p3}, clear(Landroid/view/MotionEvent;I)V
...
.method public toString()Ljava/lang/String;
    ...
    invoke-static {v1}, getStateSymbolicName(I)Ljava/lang/String;
    ...
    iget v1, p0, mLastTouchedWindowId:I
    ...
    iget v1, p0, mScaledMinPointerDistanceToUseMiddleLocation:I
