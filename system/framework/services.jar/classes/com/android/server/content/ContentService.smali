...
.method static constructor <clinit>()V
    ...
    sput-object v0, sObserverDeathDispatcher:Lcom/android/internal/os/BinderDeathDispatcher;
    ...
    sput-object v0, sObserverLeakDetectedUid:Landroid/util/ArraySet;
...
.method constructor <init>(Landroid/content/Context;Z)V
    ...
    iput-object v0, p0, mCacheReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v3, p0, mCacheReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v4, p0, mCacheReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v3, p0, mHandlerThread:Landroid/os/HandlerThread;
    ...
    iput-object v3, p0, mTimeoutHandlerThread:Landroid/os/HandlerThread;

    iget-object v3, p0, mTimeoutHandlerThread:Landroid/os/HandlerThread;

    invoke-virtual {v3}, Landroid/os/HandlerThread;->start()V

    new-instance v3, Landroid/os/Handler;

    iget-object v4, p0, mTimeoutHandlerThread:Landroid/os/HandlerThread;
    ...
    iput-object v3, p0, mTimeoutHandler:Landroid/os/Handler;
...
.method static synthetic access$100(Lcom/android/server/content/ContentService;ILjava/lang/String;Landroid/net/Uri;)V
    ...
    invoke-direct {p0, p1, p2, p3}, invalidateCacheLocked(ILjava/lang/String;Landroid/net/Uri;)V
...
.method static synthetic access$300(Lcom/android/server/content/ContentService;)Landroid/os/Handler;
    ...
    iget-object v0, p0, mTimeoutHandler:Landroid/os/Handler;
...
.method static synthetic access$600()Lcom/android/internal/os/BinderDeathDispatcher;
    ...
    sget-object v0, sObserverDeathDispatcher:Lcom/android/internal/os/BinderDeathDispatcher;
...
.method static synthetic access$700()Landroid/util/ArraySet;
    ...
    sget-object v0, sObserverLeakDetectedUid:Landroid/util/ArraySet;
...
.method private getSyncExemptionForCaller(I)I
    ...
    invoke-direct {p0, p1, v0}, getSyncExemptionAndCleanUpExtrasForCaller(ILandroid/os/Bundle;)I
...
.method private getSyncManager()Lcom/android/server/content/SyncManager;
    ...
    iget-object v0, p0, mSyncManagerLock:Ljava/lang/Object;
    ...
    iget-boolean v3, p0, mFactoryTest:Z
...
.method private handleIncomingUser(Landroid/net/Uri;IIIZI)I
    ...
    invoke-direct/range {v0 .. v5}, checkUriPermission(Landroid/net/Uri;IIII)I
...
.method public addPeriodicSync(Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;J)V
    ...
    invoke-direct {v1, v0, v10}, validateExtras(ILandroid/os/Bundle;)V
    ...
    invoke-direct {v1, v3, v4}, clampPeriod(J)J
...
.method public cancelRequest(Landroid/content/SyncRequest;)V
    ...
    invoke-direct {p0, v2, v3}, validateExtras(ILandroid/os/Bundle;)V
...
.method protected declared-synchronized dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    :try_start_2
    iget-object v0, v1, mSyncManager:Lcom/android/server/content/SyncManager;
    ...
    iget-object v10, v1, mRootNode:Lcom/android/server/content/ContentService$ObserverNode;
    ...
    iget-object v4, v1, mRootNode:Lcom/android/server/content/ContentService$ObserverNode;
    ...
    sget-object v6, sObserverDeathDispatcher:Lcom/android/internal/os/BinderDeathDispatcher;
    ...
    :try_start_5
    sget-object v4, sObserverLeakDetectedUid:Landroid/util/ArraySet;
    ...
    :try_start_7
    iget-object v4, v1, mCache:Landroid/util/SparseArray;
    ...
    :goto_3
    iget-object v5, v1, mCache:Landroid/util/SparseArray;
    ...
    iget-object v6, v1, mCache:Landroid/util/SparseArray;
...
.method public getCache(Ljava/lang/String;Landroid/net/Uri;I)Landroid/os/Bundle;
    ...
    invoke-direct {p0, p3, v0}, enforceCrossUserPermission(ILjava/lang/String;)V
    ...
    invoke-direct {p0, p2}, getProviderPackageName(Landroid/net/Uri;)Ljava/lang/String;
    ...
    :try_start_0
    invoke-direct {p0, p3, v0}, findOrCreateCacheLocked(ILjava/lang/String;)Landroid/util/ArrayMap;
...
.method public getCurrentSyncsAsUser(I)Ljava/util/List;
    ...
    invoke-direct {p0, p1, v0}, enforceCrossUserPermission(ILjava/lang/String;)V
...
.method public getSyncAdapterPackagesForAuthorityAsUser(Ljava/lang/String;I)[Ljava/lang/String;
    ...
    invoke-direct {p0, p2, v0}, enforceCrossUserPermission(ILjava/lang/String;)V
...
.method public notifyChange(Landroid/net/Uri;Landroid/database/IContentObserver;ZIIILjava/lang/String;)V
    ...
    invoke-direct/range {v1 .. v7}, handleIncomingUser(Landroid/net/Uri;IIIZI)I
    ...
    iget-object v7, v8, mRootNode:Lcom/android/server/content/ContentService$ObserverNode;
    ...
    :try_start_1
    iget-object v9, v8, mRootNode:Lcom/android/server/content/ContentService$ObserverNode;
    :try_end_1
    ...
    iget-object v11, v8, mHandler:Landroid/os/Handler;
    ...
    iget-object v12, v8, mContext:Landroid/content/Context;
    ...
    :try_start_9
    iget-object v12, v8, mRootNode:Lcom/android/server/content/ContentService$ObserverNode;
    ...
    :try_start_f
    invoke-direct {v8, v2}, getSyncExemptionForCaller(I)I
    ...
    :goto_a
    iget-object v9, v8, mCache:Landroid/util/SparseArray;
    ...
    :try_start_11
    invoke-direct/range {p0 .. p1}, getProviderPackageName(Landroid/net/Uri;)Ljava/lang/String;

    move-result-object v0

    invoke-direct {v8, v1, v0, v7}, invalidateCacheLocked(ILjava/lang/String;Landroid/net/Uri;)V
...
.method public notifyChange(Landroid/net/Uri;Landroid/database/IContentObserver;ZZLjava/lang/String;)V
    ...
    invoke-virtual/range {v0 .. v7}, notifyChange(Landroid/net/Uri;Landroid/database/IContentObserver;ZIIILjava/lang/String;)V
...
.method public putCache(Ljava/lang/String;Landroid/net/Uri;Landroid/os/Bundle;I)V
    ...
    :try_start_0
    invoke-direct {p0, p4, v0}, findOrCreateCacheLocked(ILjava/lang/String;)Landroid/util/ArrayMap;
...
.method public registerContentObserver(Landroid/net/Uri;ZLandroid/database/IContentObserver;)V
    ...
    invoke-virtual/range {v0 .. v5}, registerContentObserver(Landroid/net/Uri;ZLandroid/database/IContentObserver;II)V
...
.method public registerContentObserver(Landroid/net/Uri;ZLandroid/database/IContentObserver;II)V
    ...
    :goto_0
    iget-object v4, v8, mRootNode:Lcom/android/server/content/ContentService$ObserverNode;
    ...
    iget-object v13, v8, mRootNode:Lcom/android/server/content/ContentService$ObserverNode;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public removePeriodicSync(Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v0, p3}, validateExtras(ILandroid/os/Bundle;)V
...
.method public requestSync(Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;Ljava/lang/String;)V
    ...
    invoke-direct {v1, v15, v13}, validateExtras(ILandroid/os/Bundle;)V

    invoke-direct {v1, v15, v13}, getSyncExemptionAndCleanUpExtrasForCaller(ILandroid/os/Bundle;)I
...
.method public resetTodayStats()V
    ...
    invoke-direct {p0, v0}, enforceShell(Ljava/lang/String;)V
    ...
    :try_start_0
    iget-object v2, p0, mSyncManager:Lcom/android/server/content/SyncManager;
...
.method public setIsSyncable(Landroid/accounts/Account;Ljava/lang/String;I)V
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, setIsSyncableAsUser(Landroid/accounts/Account;Ljava/lang/String;II)V
...
.method public setIsSyncableAsUser(Landroid/accounts/Account;Ljava/lang/String;II)V
    ...
    invoke-direct {p0, v9, v0}, enforceCrossUserPermission(ILjava/lang/String;)V
    ...
    invoke-static/range {p3 .. p3}, normalizeSyncable(I)I
...
.method public setMasterSyncAutomaticallyAsUser(ZI)V
    ...
    invoke-direct {p0, v0}, getSyncExemptionForCaller(I)I
    ...
    :cond_0
    invoke-static {v9, v10}, restoreCallingIdentity(J)V
...
.method public setSyncAutomaticallyAsUser(Landroid/accounts/Account;Ljava/lang/String;ZI)V
    ...
    invoke-direct {v1, v10, v0}, enforceCrossUserPermission(ILjava/lang/String;)V
    ...
    invoke-direct {v1, v11}, getSyncExemptionForCaller(I)I
...
.method public sync(Landroid/content/SyncRequest;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, v0, p2}, syncAsUser(Landroid/content/SyncRequest;ILjava/lang/String;)V
...
.method public syncAsUser(Landroid/content/SyncRequest;ILjava/lang/String;)V
    ...
    invoke-direct {v1, v13, v0}, enforceCrossUserPermission(ILjava/lang/String;)V
    ...
    invoke-direct {v1, v14, v12}, validateExtras(ILandroid/os/Bundle;)V

    invoke-direct {v1, v14, v12}, getSyncExemptionAndCleanUpExtrasForCaller(ILandroid/os/Bundle;)I
    ...
    invoke-static/range {v24 .. v25}, restoreCallingIdentity(J)V
    ...
    invoke-direct {v1, v10, v11}, clampPeriod(J)J
