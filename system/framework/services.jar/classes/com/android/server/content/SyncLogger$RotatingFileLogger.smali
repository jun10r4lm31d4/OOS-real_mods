...
.method static constructor <clinit>()V
    ...
    sput-object v0, sTimestampFormat:Ljava/text/SimpleDateFormat;
    ...
    sput-object v0, sFilenameDateFormat:Ljava/text/SimpleDateFormat;
...
.method constructor <init>()V
    ...
    iput-wide v0, p0, mKeepAgeMs:J

    new-instance v0, Ljava/util/Date;

    invoke-direct {v0}, Ljava/util/Date;-><init>()V

    iput-object v0, p0, mCachedDate:Ljava/util/Date;
    ...
    iput-object v0, p0, mLogPath:Ljava/io/File;
    ...
    iput-object v0, p0, mHandler:Lcom/android/server/content/SyncLogger$RotatingFileLogger$MyHandler;
...
.method private closeCurrentLogLocked()V
    ...
    iget-object v0, p0, mLogWriter:Ljava/io/Writer;

    invoke-static {v0}, Llibcore/io/IoUtils;->closeQuietly(Ljava/lang/AutoCloseable;)V

    const/4 v0, 0x0

    iput-object v0, p0, mLogWriter:Ljava/io/Writer;
...
.method private openLogLocked(J)V
    ...
    iget-object v2, p0, mLogWriter:Ljava/io/Writer;

    if-eqz v2, :cond_0

    iget-wide v2, p0, mCurrentLogFileDayTimestamp:J
    ...
    :cond_0
    invoke-direct {p0}, closeCurrentLogLocked()V

    iput-wide v0, p0, mCurrentLogFileDayTimestamp:J

    iget-object v2, p0, mCachedDate:Ljava/util/Date;
    ...
    sget-object v3, sFilenameDateFormat:Ljava/text/SimpleDateFormat;

    iget-object v4, p0, mCachedDate:Ljava/util/Date;
    ...
    iget-object v4, p0, mLogPath:Ljava/io/File;
    ...
    iput-object v4, p0, mLogWriter:Ljava/io/Writer;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-direct {p0, v5, v4}, handleException(Ljava/lang/String;Ljava/lang/Exception;)V
...
.method public dumpAll(Ljava/io/PrintWriter;)V
    ...
    :try_start_0
    iget-object v1, p0, mLogPath:Ljava/io/File;
    ...
    iget-object v6, p0, mLogPath:Ljava/io/File;

    invoke-direct {v5, v6, v4}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    invoke-direct {p0, p1, v5}, dumpFile(Ljava/io/PrintWriter;Ljava/io/File;)V
...
.method public varargs log([Ljava/lang/Object;)V
    ...
    iget-object v2, p0, mHandler:Lcom/android/server/content/SyncLogger$RotatingFileLogger$MyHandler;
...
.method logInner(J[Ljava/lang/Object;)V
    ...
    :try_start_0
    invoke-direct {p0, p1, p2}, openLogLocked(J)V

    iget-object v1, p0, mLogWriter:Ljava/io/Writer;
    ...
    iget-object v1, p0, mCachedDate:Ljava/util/Date;

    invoke-virtual {v1, p1, p2}, Ljava/util/Date;->setTime(J)V

    iget-object v1, p0, mStringBuilder:Ljava/lang/StringBuilder;

    sget-object v3, sTimestampFormat:Ljava/text/SimpleDateFormat;
    ...
    iget-object v5, p0, mStringBuilder:Ljava/lang/StringBuilder;
    ...
    invoke-direct {p0, v3, v2}, handleException(Ljava/lang/String;Ljava/lang/Exception;)V
