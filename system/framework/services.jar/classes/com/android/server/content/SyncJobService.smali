...
.method static constructor <clinit>()V
    ...
    sput-object v0, sJobParamsMap:Landroid/util/SparseArray;

    new-instance v0, Landroid/util/SparseBooleanArray;

    invoke-direct {v0}, Landroid/util/SparseBooleanArray;-><init>()V

    sput-object v0, sStartedSyncs:Landroid/util/SparseBooleanArray;

    new-instance v0, Landroid/util/SparseLongArray;

    invoke-direct {v0}, Landroid/util/SparseLongArray;-><init>()V

    sput-object v0, sJobStartUptimes:Landroid/util/SparseLongArray;

    invoke-static {}, Lcom/android/server/content/SyncLogger;->getInstance()Lcom/android/server/content/SyncLogger;

    move-result-object v0

    sput-object v0, sLogger:Lcom/android/server/content/SyncLogger;
...
.method public static callJobFinished(IZLjava/lang/String;)V
    ...
    invoke-static {}, getInstance()Lcom/android/server/content/SyncJobService;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-virtual {v0, p0, p1, p2}, callJobFinishedInner(IZLjava/lang/String;)V
...
.method private static getInstance()Lcom/android/server/content/SyncJobService;
    ...
    :try_start_0
    sget-object v1, sInstance:Lcom/android/server/content/SyncJobService;
...
.method public static markSyncStarted(I)V
    ...
    :try_start_0
    sget-object v1, sStartedSyncs:Landroid/util/SparseBooleanArray;
...
.method private updateInstance()V
    ...
    :try_start_0
    sput-object p0, sInstance:Lcom/android/server/content/SyncJobService;
...
.method private static wtf(Ljava/lang/String;)V
    ...
    sget-object v0, sLogger:Lcom/android/server/content/SyncLogger;
...
.method public callJobFinishedInner(IZLjava/lang/String;)V
    ...
    :try_start_0
    sget-object v1, sJobParamsMap:Landroid/util/SparseArray;
    ...
    sget-object v2, sLogger:Lcom/android/server/content/SyncLogger;
    ...
    sget-object v5, sLogger:Lcom/android/server/content/SyncLogger;
    ...
    invoke-virtual {p0, v1, p2}, jobFinished(Landroid/app/job/JobParameters;Z)V

    sget-object v2, sJobParamsMap:Landroid/util/SparseArray;
...
.method public onStartJob(Landroid/app/job/JobParameters;)Z
    ...
    invoke-direct {p0}, updateInstance()V
    ...
    sget-object v3, sLogger:Lcom/android/server/content/SyncLogger;
    ...
    sget-object v6, sJobParamsMap:Landroid/util/SparseArray;

    invoke-virtual {v6, v4, p1}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v6, sStartedSyncs:Landroid/util/SparseBooleanArray;

    invoke-virtual {v6, v4}, Landroid/util/SparseBooleanArray;->delete(I)V

    sget-object v6, sJobStartUptimes:Landroid/util/SparseLongArray;
...
.method public onStopJob(Landroid/app/job/JobParameters;)Z
    ...
    sget-object v4, sLogger:Lcom/android/server/content/SyncLogger;
    ...
    sget-object v5, sJobParamsMap:Landroid/util/SparseArray;

    invoke-virtual {v5, v0}, Landroid/util/SparseArray;->remove(I)V

    sget-object v5, sJobStartUptimes:Landroid/util/SparseLongArray;
    ...
    sget-object v5, sStartedSyncs:Landroid/util/SparseBooleanArray;
    ...
    invoke-static/range {p1 .. p1}, jobParametersToString(Landroid/app/job/JobParameters;)Ljava/lang/String;
    ...
    invoke-static {v5}, wtf(Ljava/lang/String;)V
