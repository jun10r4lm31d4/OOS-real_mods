...
.method private cancelActiveSyncH(Lcom/android/server/content/SyncStorageEngine$EndPoint;Landroid/os/Bundle;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v4, v2}, runSyncFinishedOrCanceledH(Landroid/content/SyncResult;Lcom/android/server/content/SyncManager$ActiveSyncContext;)V
...
.method private closeActiveSyncContext(Lcom/android/server/content/SyncManager$ActiveSyncContext;)V
    ...
    invoke-virtual {v1, v2, p1}, removeMessages(ILjava/lang/Object;)V
...
.method private computeSyncOpState(Lcom/android/server/content/SyncOperation;)I
    ...
    iget-object v5, p0, this$0:Lcom/android/server/content/SyncManager;
...
.method private deferActiveSyncH(Lcom/android/server/content/SyncManager$ActiveSyncContext;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v1, p1}, runSyncFinishedOrCanceledH(Landroid/content/SyncResult;Lcom/android/server/content/SyncManager$ActiveSyncContext;)V

    const-wide/16 v1, 0x2710

    invoke-direct {p0, v0, v1, v2, p2}, deferSyncH(Lcom/android/server/content/SyncOperation;JLjava/lang/String;)V
...
.method private dispatchSyncOperation(Lcom/android/server/content/SyncOperation;)Z
    ...
    iget-object v1, v0, this$0:Lcom/android/server/content/SyncManager;
...
.method private getSyncWakeLock(Lcom/android/server/content/SyncOperation;)Landroid/os/PowerManager$WakeLock;
    ...
    iget-object v1, p0, mWakeLocks:Ljava/util/HashMap;
...
.method private handleSyncMessage(Landroid/os/Message;)V
    ...
    invoke-direct {p0, v1, v3, v4}, removePeriodicSyncH(Lcom/android/server/content/SyncStorageEngine$EndPoint;Landroid/os/Bundle;Ljava/lang/String;)V
    ...
    invoke-direct/range {v3 .. v9}, updateOrAddPeriodicSyncH(Lcom/android/server/content/SyncStorageEngine$EndPoint;JJLandroid/os/Bundle;)V
    ...
    invoke-direct {p0, v3}, findActiveSyncContextH(I)Lcom/android/server/content/SyncManager$ActiveSyncContext;

    move-result-object v3

    if-eqz v3, :cond_13

    invoke-direct {p0, v6, v3}, runSyncFinishedOrCanceledH(Landroid/content/SyncResult;Lcom/android/server/content/SyncManager$ActiveSyncContext;)V
    ...
    invoke-direct {p0, v0, v7, v8}, deferStoppedSyncH(Lcom/android/server/content/SyncOperation;J)V
    ...
    invoke-direct {p0, v0}, startSyncH(Lcom/android/server/content/SyncOperation;)V
    ...
    invoke-direct {p0, v0}, updateRunningAccountsH(Lcom/android/server/content/SyncStorageEngine$EndPoint;)V
    ...
    :cond_7
    invoke-direct {p0, v0}, isSyncNotUsingNetworkH(Lcom/android/server/content/SyncManager$ActiveSyncContext;)Z
    ...
    invoke-direct {p0, v6, v0}, runSyncFinishedOrCanceledH(Landroid/content/SyncResult;Lcom/android/server/content/SyncManager$ActiveSyncContext;)V
    ...
    invoke-direct {p0, v0, v3, v1}, cancelActiveSyncH(Lcom/android/server/content/SyncStorageEngine$EndPoint;Landroid/os/Bundle;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0, v3}, runSyncFinishedOrCanceledH(Landroid/content/SyncResult;Lcom/android/server/content/SyncManager$ActiveSyncContext;)V
    ...
    invoke-direct {p0, v1, v3}, runBoundToAdapterH(Lcom/android/server/content/SyncManager$ActiveSyncContext;Landroid/os/IBinder;)V
    ...
    invoke-direct {p0, v1, v3}, runSyncFinishedOrCanceledH(Landroid/content/SyncResult;Lcom/android/server/content/SyncManager$ActiveSyncContext;)V
    :try_end_2
    ...
    :cond_13
    :goto_3
    iget-object v0, p0, mSyncTimeTracker:Lcom/android/server/content/SyncManager$SyncTimeTracker;
    ...
    iget-object v1, p0, mSyncTimeTracker:Lcom/android/server/content/SyncManager$SyncTimeTracker;
...
.method private installHandleTooManyDeletesNotification(Landroid/accounts/Account;Ljava/lang/String;JI)V
    ...
    iget-object v6, v0, this$0:Lcom/android/server/content/SyncManager;
    ...
    invoke-direct {v0, v5}, isActivityAvailable(Landroid/content/Intent;)Z
    ...
    iget-object v8, v0, this$0:Lcom/android/server/content/SyncManager;
    ...
    iget-object v9, v0, this$0:Lcom/android/server/content/SyncManager;
    ...
    iget-object v10, v0, this$0:Lcom/android/server/content/SyncManager;
    ...
    iget-object v11, v0, this$0:Lcom/android/server/content/SyncManager;
...
.method private isSyncNotUsingNetworkH(Lcom/android/server/content/SyncManager$ActiveSyncContext;)Z
    ...
    iget-object v2, v1, this$0:Lcom/android/server/content/SyncManager;
...
.method private removePeriodicSyncH(Lcom/android/server/content/SyncStorageEngine$EndPoint;Landroid/os/Bundle;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v2, p3}, removePeriodicSyncInternalH(Lcom/android/server/content/SyncOperation;Ljava/lang/String;)V
...
.method private removePeriodicSyncInternalH(Lcom/android/server/content/SyncOperation;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v5, v3}, runSyncFinishedOrCanceledH(Landroid/content/SyncResult;Lcom/android/server/content/SyncManager$ActiveSyncContext;)V
...
.method private runSyncFinishedOrCanceledH(Landroid/content/SyncResult;Lcom/android/server/content/SyncManager$ActiveSyncContext;)V
    ...
    iget-object v2, v10, this$0:Lcom/android/server/content/SyncManager;
    ...
    :cond_1
    invoke-direct {v10, v12}, closeActiveSyncContext(Lcom/android/server/content/SyncManager$ActiveSyncContext;)V

    iget-boolean v1, v14, Lcom/android/server/content/SyncOperation;->isPeriodic:Z

    if-nez v1, :cond_2

    iget-object v1, v10, this$0:Lcom/android/server/content/SyncManager;
    ...
    iget-object v3, v10, this$0:Lcom/android/server/content/SyncManager;
    ...
    invoke-direct {v10, v14}, reschedulePeriodicSyncH(Lcom/android/server/content/SyncOperation;)V
    ...
    :cond_4
    iget-object v0, v10, this$0:Lcom/android/server/content/SyncManager;
    ...
    invoke-virtual/range {v1 .. v9}, stopSyncEvent(JLcom/android/server/content/SyncOperation;Ljava/lang/String;IIJ)V
    ...
    invoke-direct/range {v1 .. v6}, installHandleTooManyDeletesNotification(Landroid/accounts/Account;Ljava/lang/String;JI)V
...
.method private startSyncH(Lcom/android/server/content/SyncOperation;)V
    ...
    invoke-direct {p0, p1, v0, v1, v3}, deferSyncH(Lcom/android/server/content/SyncOperation;JLjava/lang/String;)V
    ...
    invoke-direct {p0, p1, v0, v1, v4}, deferSyncH(Lcom/android/server/content/SyncOperation;JLjava/lang/String;)V
    ...
    invoke-direct {p0, v5, v1}, deferActiveSyncH(Lcom/android/server/content/SyncManager$ActiveSyncContext;Ljava/lang/String;)V
    ...
    :cond_b
    :goto_3
    invoke-direct {p0, p1}, computeSyncOpState(Lcom/android/server/content/SyncOperation;)I
    ...
    invoke-direct {p0, p1}, dispatchSyncOperation(Lcom/android/server/content/SyncOperation;)Z
...
.method private updateOrAddPeriodicSyncH(Lcom/android/server/content/SyncStorageEngine$EndPoint;JJLandroid/os/Bundle;)V
    ...
    iget-object v2, v8, this$0:Lcom/android/server/content/SyncManager;
    ...
    :cond_0
    iget-object v5, v8, this$0:Lcom/android/server/content/SyncManager;
    ...
    invoke-direct/range {v0 .. v5}, maybeUpdateSyncPeriodH(Lcom/android/server/content/SyncOperation;JJ)V
    ...
    :cond_4
    iget-object v1, v8, this$0:Lcom/android/server/content/SyncManager;
    ...
    invoke-direct {v8, v9}, computeSyncOpState(Lcom/android/server/content/SyncOperation;)I
    ...
    iget-object v0, v8, this$0:Lcom/android/server/content/SyncManager;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    :try_start_0
    invoke-direct {p0, p1}, handleSyncMessage(Landroid/os/Message;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
