...
.method private addObserverLocked(Landroid/net/Uri;ILandroid/database/IContentObserver;ZLjava/lang/Object;III)V
    ...
    invoke-direct/range {p0 .. p1}, countUriSegments(Landroid/net/Uri;)I

    move-result v0

    if-ne v10, v0, :cond_2

    iget-object v0, v9, mObservers:Ljava/util/ArrayList;
    ...
    iget-object v12, v9, mObservers:Ljava/util/ArrayList;
    ...
    invoke-direct/range {p0 .. p2}, getUriSegment(Landroid/net/Uri;I)Ljava/lang/String;

    move-result-object v0

    if-eqz v0, :cond_5

    iget-object v1, v9, mChildren:Ljava/util/ArrayList;
    ...
    iget-object v3, v9, mChildren:Ljava/util/ArrayList;
    ...
    iget-object v4, v3, mName:Ljava/lang/String;
    ...
    invoke-direct/range {v12 .. v20}, addObserverLocked(Landroid/net/Uri;ILandroid/database/IContentObserver;ZLjava/lang/Object;III)V
    ...
    invoke-direct {v2, v0}, <init>(Ljava/lang/String;)V
...
.method private collectMyObserversLocked(ZLandroid/database/IContentObserver;ZIILjava/util/ArrayList;)V
    ...
    iget-object v0, v7, mObservers:Ljava/util/ArrayList;
...
.method public collectObserversLocked(Landroid/net/Uri;ILandroid/database/IContentObserver;ZIILjava/util/ArrayList;)V
    ...
    invoke-direct/range {v0 .. v6}, collectMyObserversLocked(ZLandroid/database/IContentObserver;ZIILjava/util/ArrayList;)V
    ...
    :cond_1
    :goto_0
    iget-object v0, v7, mChildren:Ljava/util/ArrayList;
    ...
    iget-object v2, v7, mChildren:Ljava/util/ArrayList;
    ...
    invoke-virtual/range {v11 .. v18}, collectObserversLocked(Landroid/net/Uri;ILandroid/database/IContentObserver;ZIILjava/util/ArrayList;)V
...
.method public dumpLocked(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;[ILandroid/util/SparseIntArray;)V
    ...
    iget-object v3, v0, mObservers:Ljava/util/ArrayList;
    ...
    iget-object v2, v0, mName:Ljava/lang/String;
    ...
    iget-object v6, v0, mName:Ljava/lang/String;
    ...
    :goto_1
    iget-object v6, v0, mObservers:Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object v3, v0, mChildren:Ljava/util/ArrayList;
    ...
    :goto_3
    iget-object v2, v0, mChildren:Ljava/util/ArrayList;
    ...
    invoke-virtual/range {v2 .. v9}, dumpLocked(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;[ILandroid/util/SparseIntArray;)V
...
.method public removeObserverLocked(Landroid/database/IContentObserver;)Z
    ...
    invoke-virtual {v3, p1}, removeObserverLocked(Landroid/database/IContentObserver;)Z

    move-result v3

    if-eqz v3, :cond_0

    iget-object v4, p0, mChildren:Ljava/util/ArrayList;
