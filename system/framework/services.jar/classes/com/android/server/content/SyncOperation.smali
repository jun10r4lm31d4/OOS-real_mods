...
.method public constructor <init>(Landroid/accounts/Account;IILjava/lang/String;IILjava/lang/String;Landroid/os/Bundle;ZI)V
    ...
    invoke-direct/range {v0 .. v8}, <init>(Lcom/android/server/content/SyncStorageEngine$EndPoint;ILjava/lang/String;IILandroid/os/Bundle;ZI)V
...
.method public constructor <init>(Lcom/android/server/content/SyncOperation;)V
    ...
    iget v0, p1, owningUid:I

    iput v0, p0, owningUid:I

    iget-object v0, p1, owningPackage:Ljava/lang/String;

    iput-object v0, p0, owningPackage:Ljava/lang/String;
    ...
    iget-boolean v0, p1, allowParallelSyncs:Z
    ...
    invoke-virtual {p1}, wakeLockName()Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, wakeLockName:Ljava/lang/String;

    iget-boolean v0, p1, isPeriodic:Z

    iput-boolean v0, p0, isPeriodic:Z

    iget v0, p1, sourcePeriodicId:I

    iput v0, p0, sourcePeriodicId:I

    iget-wide v0, p1, periodMillis:J

    iput-wide v0, p0, periodMillis:J

    iget-wide v0, p1, flexMillis:J

    iput-wide v0, p0, flexMillis:J

    iget-object v0, p1, key:Ljava/lang/String;

    iput-object v0, p0, key:Ljava/lang/String;

    iget v0, p1, syncExemptionFlag:I

    iput v0, p0, syncExemptionFlag:I
...
.method public constructor <init>(Lcom/android/server/content/SyncOperation;JJ)V
    ...
    iget-object v2, v0, target:Lcom/android/server/content/SyncStorageEngine$EndPoint;

    iget v3, v0, owningUid:I

    iget-object v4, v0, owningPackage:Ljava/lang/String;
    ...
    iget-object v1, v0, extras:Landroid/os/Bundle;

    invoke-direct {v7, v1}, Landroid/os/Bundle;-><init>(Landroid/os/Bundle;)V

    iget-boolean v8, v0, allowParallelSyncs:Z

    iget-boolean v9, v0, isPeriodic:Z

    iget v10, v0, sourcePeriodicId:I
    ...
    invoke-direct/range {v1 .. v15}, <init>(Lcom/android/server/content/SyncStorageEngine$EndPoint;ILjava/lang/String;IILandroid/os/Bundle;ZZIJJI)V
...
.method private constructor <init>(Lcom/android/server/content/SyncStorageEngine$EndPoint;ILjava/lang/String;IILandroid/os/Bundle;ZI)V
    ...
    invoke-direct/range {v0 .. v14}, <init>(Lcom/android/server/content/SyncStorageEngine$EndPoint;ILjava/lang/String;IILandroid/os/Bundle;ZZIJJI)V
...
.method public constructor <init>(Lcom/android/server/content/SyncStorageEngine$EndPoint;ILjava/lang/String;IILandroid/os/Bundle;ZZIJJI)V
    ...
    iput p2, p0, owningUid:I

    iput-object p3, p0, owningPackage:Ljava/lang/String;

    iput p4, p0, reason:I

    iput p5, p0, syncSource:I
    ...
    iput-boolean p7, p0, allowParallelSyncs:Z

    iput-boolean p8, p0, isPeriodic:Z

    iput p9, p0, sourcePeriodicId:I

    iput-wide p10, p0, periodMillis:J

    iput-wide p12, p0, flexMillis:J

    const/4 v0, -0x1

    iput v0, p0, jobId:I

    invoke-direct {p0}, toKey()Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, key:Ljava/lang/String;

    iput p14, p0, syncExemptionFlag:I
...
.method static extrasToString(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    invoke-static {p0, v0}, extrasToStringBuilder(Landroid/os/Bundle;Ljava/lang/StringBuilder;)V
...
.method static maybeCreateFromJobExtras(Landroid/os/PersistableBundle;)Lcom/android/server/content/SyncOperation;
    ...
    invoke-direct/range {v10 .. v24}, <init>(Lcom/android/server/content/SyncStorageEngine$EndPoint;ILjava/lang/String;IILandroid/os/Bundle;ZZIJJI)V
    ...
    iput-wide v12, v4, expectedRuntime:J
...
.method static reasonToString(Landroid/content/pm/PackageManager;I)Ljava/lang/String;
    ...
    sget-object v0, REASON_NAMES:[Ljava/lang/String;
...
.method private toKey()Ljava/lang/String;
    ...
    iget-boolean v1, p0, isPeriodic:Z
    ...
    iget-wide v1, p0, periodMillis:J
...
.method public createOneTimeSyncOperation()Lcom/android/server/content/SyncOperation;
    ...
    iget-boolean v1, v0, isPeriodic:Z
    ...
    iget-object v3, v0, target:Lcom/android/server/content/SyncStorageEngine$EndPoint;

    iget v4, v0, owningUid:I

    iget-object v5, v0, owningPackage:Ljava/lang/String;

    iget v6, v0, reason:I

    iget v7, v0, syncSource:I
    ...
    iget-boolean v9, v0, allowParallelSyncs:Z

    const/4 v10, 0x0

    iget v11, v0, jobId:I

    iget-wide v12, v0, periodMillis:J

    iget-wide v14, v0, flexMillis:J

    const/16 v16, 0x0

    move-object v2, v1

    invoke-direct/range {v2 .. v16}, <init>(Lcom/android/server/content/SyncStorageEngine$EndPoint;ILjava/lang/String;IILandroid/os/Bundle;ZZIJJI)V
...
.method dump(Landroid/content/pm/PackageManager;ZLcom/android/server/content/SyncAdapterStateFetcher;Z)Ljava/lang/String;
    ...
    iget v4, p0, syncSource:I

    aget-object v3, v3, v4

    invoke-virtual {v0, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-wide v3, p0, expectedRuntime:J
    ...
    :cond_2
    iget v3, p0, syncExemptionFlag:I
    ...
    iget v4, p0, syncExemptionFlag:I
    ...
    invoke-static {p1, v3}, reasonToString(Landroid/content/pm/PackageManager;I)Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v0, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v3, p0, isPeriodic:Z
    ...
    iget-wide v3, p0, periodMillis:J
    ...
    iget-object v2, p0, extras:Landroid/os/Bundle;
...
.method findPriority()I
    ...
    invoke-virtual {p0}, isInitialization()Z
    ...
    :cond_0
    invoke-virtual {p0}, isExpedited()Z
...
.method isAppStandbyExempted()Z
    ...
    iget v0, p0, syncExemptionFlag:I
...
.method matchesPeriodicOperation(Lcom/android/server/content/SyncOperation;)Z
    ...
    iget-object v2, p1, extras:Landroid/os/Bundle;
    ...
    iget-wide v2, p0, periodMillis:J

    iget-wide v4, p1, periodMillis:J

    cmp-long v0, v2, v4

    if-nez v0, :cond_0

    iget-wide v2, p0, flexMillis:J

    iget-wide v4, p1, flexMillis:J
...
.method toJobInfoExtras()Landroid/os/PersistableBundle;
    ...
    iget-object v6, p0, extras:Landroid/os/Bundle;
    ...
    iget-object v2, p0, owningPackage:Ljava/lang/String;
    ...
    iget-boolean v2, p0, allowParallelSyncs:Z
    ...
    iget-boolean v2, p0, isPeriodic:Z

    const-string/jumbo v3, "isPeriodic"

    invoke-virtual {v0, v3, v2}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    iget v2, p0, sourcePeriodicId:I
    ...
    iget-wide v2, p0, expectedRuntime:J

    const-string v4, "expectedRuntime"

    invoke-virtual {v0, v4, v2, v3}, Landroid/os/PersistableBundle;->putLong(Ljava/lang/String;J)V

    iget v2, p0, retries:I

    const-string/jumbo v3, "retries"

    invoke-virtual {v0, v3, v2}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    iget v2, p0, syncExemptionFlag:I
...
.method public toSafeString()Ljava/lang/String;
    ...
    invoke-virtual {p0, v1, v0, v1, v0}, dump(Landroid/content/pm/PackageManager;ZLcom/android/server/content/SyncAdapterStateFetcher;Z)Ljava/lang/String;
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0, v0, v1, v0, v2}, dump(Landroid/content/pm/PackageManager;ZLcom/android/server/content/SyncAdapterStateFetcher;Z)Ljava/lang/String;
