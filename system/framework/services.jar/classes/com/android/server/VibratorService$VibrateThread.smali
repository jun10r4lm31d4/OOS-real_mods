...
.method constructor <init>(Lcom/android/server/VibratorService;Landroid/os/VibrationEffect$Waveform;II)V
    ...
    iput-object p2, p0, mWaveform:Landroid/os/VibrationEffect$Waveform;

    iput p3, p0, mUid:I

    iput p4, p0, mUsageHint:I
...
.method private delayLocked(J)J
    ...
    :goto_1
    :try_start_2
    iget-boolean v8, p0, mForceStop:Z
...
.method public cancel()V
    ...
    iput-boolean v1, v0, mForceStop:Z
...
.method public playWaveform()Z
    ...
    :try_start_1
    iget-object v0, v1, mWaveform:Landroid/os/VibrationEffect$Waveform;

    invoke-virtual {v0}, Landroid/os/VibrationEffect$Waveform;->getTimings()[J

    move-result-object v0

    iget-object v4, v1, mWaveform:Landroid/os/VibrationEffect$Waveform;
    ...
    iget-object v6, v1, mWaveform:Landroid/os/VibrationEffect$Waveform;
    ...
    :goto_0
    iget-boolean v13, v1, mForceStop:Z
    ...
    invoke-direct {v1, v0, v4, v8, v6}, getTotalOnDuration([J[III)J
    ...
    iget-object v14, v1, this$0:Lcom/android/server/VibratorService;

    iget v11, v1, mUid:I

    iget v12, v1, mUsageHint:I
    ...
    :goto_2
    invoke-direct {v1, v7, v8}, delayLocked(J)J
    ...
    :cond_7
    :goto_4
    iget-boolean v7, v1, mForceStop:Z
...
.method public run()V
    ...
    :try_start_0
    invoke-virtual {p0}, playWaveform()Z
