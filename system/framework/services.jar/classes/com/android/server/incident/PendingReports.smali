...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mRequestQueue:Lcom/android/server/incident/RequestQueue;
...
.method static synthetic access$008(Lcom/android/server/incident/PendingReports;)I
    ...
    iget v0, p0, mNextPendingId:I

    add-int/lit8 v1, v0, 0x1

    iput v1, p0, mNextPendingId:I
...
.method private authorizeReportImpl(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;ILandroid/os/IIncidentAuthListener;)V
    ...
    invoke-direct/range {p0 .. p2}, isPackageInUid(ILjava/lang/String;)Z
    ...
    invoke-direct {v8, v11, v10}, denyReportBeforeAddingRec(Landroid/os/IIncidentAuthListener;Ljava/lang/String;)V

    return-void

    :cond_0
    invoke-direct/range {p0 .. p0}, getAndValidateUser()I
    ...
    :cond_1
    invoke-direct {v8, v12}, getApproverComponent(I)Landroid/content/ComponentName;
    ...
    iget-object v0, v8, mPending:Ljava/util/ArrayList;
    ...
    invoke-direct {v8, v11, v13, v12}, cancelReportImpl(Landroid/os/IIncidentAuthListener;Landroid/content/ComponentName;I)V

    :goto_0
    invoke-direct {v8, v13, v12}, sendBroadcast(Landroid/content/ComponentName;I)V
...
.method private cancelReportImpl(Landroid/os/IIncidentAuthListener;)V
    ...
    invoke-direct {p0}, getAndValidateUser()I

    move-result v0

    invoke-direct {p0, v0}, getApproverComponent(I)Landroid/content/ComponentName;
    ...
    invoke-direct {p0, p1, v1, v0}, cancelReportImpl(Landroid/os/IIncidentAuthListener;Landroid/content/ComponentName;I)V
...
.method private cancelReportImpl(Landroid/os/IIncidentAuthListener;Landroid/content/ComponentName;I)V
    ...
    :try_start_0
    invoke-direct {p0, p1}, removePendingReportRecLocked(Landroid/os/IIncidentAuthListener;)V

    monitor-exit v0
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-direct {p0, p2, p3}, sendBroadcast(Landroid/content/ComponentName;I)V
...
.method private sendBroadcast()V
    ...
    :cond_1
    invoke-direct {p0, v1, v0}, sendBroadcast(Landroid/content/ComponentName;I)V
...
.method public approveReport(Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-direct {p0, p1}, findAndRemovePendingReportRecLocked(Ljava/lang/String;)Lcom/android/server/incident/PendingReports$PendingReportRec;
    ...
    invoke-direct {p0}, sendBroadcast()V
...
.method public authorizeReport(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;ILandroid/os/IIncidentAuthListener;)V
    ...
    iget-object v9, v8, mRequestQueue:Lcom/android/server/incident/RequestQueue;
...
.method public cancelAuthorization(Landroid/os/IIncidentAuthListener;)V
    ...
    iget-object v0, p0, mRequestQueue:Lcom/android/server/incident/RequestQueue;
...
.method public getPendingReports()Ljava/util/List;
    ...
    :try_start_0
    iget-object v1, p0, mPending:Ljava/util/ArrayList;
...
.method public synthetic lambda$authorizeReport$0$PendingReports(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;ILandroid/os/IIncidentAuthListener;)V
    ...
    invoke-direct/range {p0 .. p6}, authorizeReportImpl(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;ILandroid/os/IIncidentAuthListener;)V
...
.method public synthetic lambda$authorizeReportImpl$2$PendingReports(Landroid/os/IIncidentAuthListener;Landroid/content/ComponentName;I)V
    ...
    invoke-direct {p0, p1, p2, p3}, cancelReportImpl(Landroid/os/IIncidentAuthListener;Landroid/content/ComponentName;I)V
...
.method public synthetic lambda$cancelAuthorization$1$PendingReports(Landroid/os/IIncidentAuthListener;)V
    ...
    invoke-direct {p0, p1}, cancelReportImpl(Landroid/os/IIncidentAuthListener;)V
