...
.method static decodeCert([B)Ljava/security/cert/X509Certificate;
    ...
    invoke-static {v0}, decodeCert(Ljava/io/InputStream;)Ljava/security/cert/X509Certificate;
...
.method static varargs getXmlNodeContents(ILorg/w3c/dom/Element;[Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {v0, v2}, getXmlDirectChildren(Lorg/w3c/dom/Element;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {v0, v1}, getXmlDirectChildren(Lorg/w3c/dom/Element;Ljava/lang/String;)Ljava/util/List;
...
.method static validateCert(Ljava/util/Date;Ljava/security/cert/X509Certificate;Ljava/util/List;Ljava/security/cert/X509Certificate;)Ljava/security/cert/CertPath;
    ...
    invoke-static {p0, p1, p2, p3}, buildPkixParams(Ljava/util/Date;Ljava/security/cert/X509Certificate;Ljava/util/List;Ljava/security/cert/X509Certificate;)Ljava/security/cert/PKIXParameters;

    move-result-object v0

    invoke-static {v0}, buildCertPath(Ljava/security/cert/PKIXParameters;)Ljava/security/cert/CertPath;
...
.method public static validateCertPath(Ljava/security/cert/X509Certificate;Ljava/security/cert/CertPath;)V
    ...
    invoke-static {v0, p0, p1}, validateCertPath(Ljava/util/Date;Ljava/security/cert/X509Certificate;Ljava/security/cert/CertPath;)V
...
.method static validateCertPath(Ljava/util/Date;Ljava/security/cert/X509Certificate;Ljava/security/cert/CertPath;)V
    ...
    invoke-static {p0, p1, v2, v1}, validateCert(Ljava/util/Date;Ljava/security/cert/X509Certificate;Ljava/util/List;Ljava/security/cert/X509Certificate;)Ljava/security/cert/CertPath;
