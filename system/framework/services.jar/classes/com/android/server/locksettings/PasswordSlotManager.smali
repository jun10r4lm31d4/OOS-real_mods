...
.method private ensureSlotMapLoaded()V
    ...
    iget-object v0, p0, mSlotMap:Ljava/util/Map;

    if-nez v0, :cond_0

    invoke-direct {p0}, loadSlotMap()Ljava/util/Map;

    move-result-object v0

    iput-object v0, p0, mSlotMap:Ljava/util/Map;

    iget-object v0, p0, mActiveSlots:Ljava/util/Set;

    if-eqz v0, :cond_0

    invoke-virtual {p0, v0}, refreshActiveSlots(Ljava/util/Set;)V

    const/4 v0, 0x0

    iput-object v0, p0, mActiveSlots:Ljava/util/Set;
...
.method private getMode()Ljava/lang/String;
    ...
    invoke-virtual {p0}, getGsiImageNumber()I
...
.method private getSlotMapFile()Ljava/io/File;
    ...
    invoke-virtual {p0}, getSlotMapDir()Ljava/lang/String;
...
.method private loadSlotMap()Ljava/util/Map;
    ...
    invoke-direct {p0}, getSlotMapFile()Ljava/io/File;
    ...
    :try_start_1
    invoke-virtual {p0, v1}, loadSlotMap(Ljava/io/InputStream;)Ljava/util/Map;
...
.method private saveSlotMap()V
    ...
    :try_start_1
    invoke-virtual {p0, v0}, saveSlotMap(Ljava/io/OutputStream;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public getUsedSlots()Ljava/util/Set;
    ...
    invoke-direct {p0}, ensureSlotMapLoaded()V
...
.method public markSlotDeleted(I)V
    ...
    invoke-direct {p0}, getMode()Ljava/lang/String;
    ...
    invoke-direct {p0}, saveSlotMap()V
...
.method public refreshActiveSlots(Ljava/util/Set;)V
    ...
    iget-object v1, p0, mSlotMap:Ljava/util/Map;
    ...
    iget-object v3, p0, mSlotMap:Ljava/util/Map;
