...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverySessionStorage;Ljava/util/concurrent/ExecutorService;Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverySnapshotStorage;Lcom/android/server/locksettings/recoverablekeystore/RecoverySnapshotListenersStorage;Lcom/android/server/locksettings/recoverablekeystore/PlatformKeyManager;Lcom/android/server/locksettings/recoverablekeystore/storage/ApplicationKeyStorage;Lcom/android/server/locksettings/recoverablekeystore/TestOnlyInsecureCertificateHelper;Lcom/android/server/locksettings/recoverablekeystore/storage/CleanupManager;)V
    ...
    iput-object p2, p0, mDatabase:Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;

    iput-object p3, p0, mRecoverySessionStorage:Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverySessionStorage;

    iput-object p4, p0, mExecutorService:Ljava/util/concurrent/ExecutorService;

    iput-object p6, p0, mListenersStorage:Lcom/android/server/locksettings/recoverablekeystore/RecoverySnapshotListenersStorage;

    iput-object p5, p0, mSnapshotStorage:Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverySnapshotStorage;

    iput-object p7, p0, mPlatformKeyManager:Lcom/android/server/locksettings/recoverablekeystore/PlatformKeyManager;

    iput-object p8, p0, mApplicationKeyStorage:Lcom/android/server/locksettings/recoverablekeystore/storage/ApplicationKeyStorage;

    iput-object p9, p0, mTestCertHelper:Lcom/android/server/locksettings/recoverablekeystore/TestOnlyInsecureCertificateHelper;

    iput-object p10, p0, mCleanupManager:Lcom/android/server/locksettings/recoverablekeystore/storage/CleanupManager;

    iget-object v0, p0, mCleanupManager:Lcom/android/server/locksettings/recoverablekeystore/storage/CleanupManager;

    invoke-virtual {v0}, Lcom/android/server/locksettings/recoverablekeystore/storage/CleanupManager;->verifyKnownUsers()V

    :try_start_0
    iget-object v0, p0, mDatabase:Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;
    ...
    iput-object v0, p0, mRecoverableKeyGenerator:Lcom/android/server/locksettings/recoverablekeystore/RecoverableKeyGenerator;
    :try_end_0
...
.method private checkRecoverKeyStorePermission()V
    ...
    iget-object v2, p0, mCleanupManager:Lcom/android/server/locksettings/recoverablekeystore/storage/CleanupManager;
...
.method private getAlias(IILjava/lang/String;)Ljava/lang/String;
    ...
    iget-object v0, p0, mApplicationKeyStorage:Lcom/android/server/locksettings/recoverablekeystore/storage/ApplicationKeyStorage;
...
.method public static declared-synchronized getInstance(Landroid/content/Context;Landroid/security/KeyStore;)Lcom/android/server/locksettings/recoverablekeystore/RecoverableKeyStoreManager;
    ...
    :try_start_0
    sget-object v0, mInstance:Lcom/android/server/locksettings/recoverablekeystore/RecoverableKeyStoreManager;
    ...
    invoke-direct/range {v2 .. v12}, <init>(Landroid/content/Context;Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverySessionStorage;Ljava/util/concurrent/ExecutorService;Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverySnapshotStorage;Lcom/android/server/locksettings/recoverablekeystore/RecoverySnapshotListenersStorage;Lcom/android/server/locksettings/recoverablekeystore/PlatformKeyManager;Lcom/android/server/locksettings/recoverablekeystore/storage/ApplicationKeyStorage;Lcom/android/server/locksettings/recoverablekeystore/TestOnlyInsecureCertificateHelper;Lcom/android/server/locksettings/recoverablekeystore/storage/CleanupManager;)V

    sput-object v16, mInstance:Lcom/android/server/locksettings/recoverablekeystore/RecoverableKeyStoreManager;
...
.method private importKeyMaterials(IILjava/util/Map;)Ljava/util/Map;
    ...
    iget-object v3, p0, mApplicationKeyStorage:Lcom/android/server/locksettings/recoverablekeystore/storage/ApplicationKeyStorage;
    ...
    invoke-direct {p0, p1, p2, v2}, getAlias(IILjava/lang/String;)Ljava/lang/String;
...
.method public closeSession(Ljava/lang/String;)V
    ...
    invoke-direct {p0}, checkRecoverKeyStorePermission()V

    const-string v0, "invalid session"

    invoke-static {p1, v0}, Lcom/android/internal/util/Preconditions;->checkNotNull(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v0, p0, mRecoverySessionStorage:Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverySessionStorage;
...
.method public generateKey(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, v0}, generateKeyWithMetadata(Ljava/lang/String;[B)Ljava/lang/String;
...
.method public generateKeyWithMetadata(Ljava/lang/String;[B)Ljava/lang/String;
    ...
    :try_start_0
    iget-object v1, p0, mPlatformKeyManager:Lcom/android/server/locksettings/recoverablekeystore/PlatformKeyManager;
    ...
    :try_start_1
    iget-object v1, p0, mRecoverableKeyGenerator:Lcom/android/server/locksettings/recoverablekeystore/RecoverableKeyGenerator;
    ...
    invoke-direct {p0, v7, v0, p1}, getAlias(IILjava/lang/String;)Ljava/lang/String;
...
.method public getKey(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, v1, v0, p1}, getAlias(IILjava/lang/String;)Ljava/lang/String;
...
.method public getKeyChainSnapshot()Landroid/security/keystore/recovery/KeyChainSnapshot;
    ...
    iget-object v1, p0, mSnapshotStorage:Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverySnapshotStorage;
...
.method public importKey(Ljava/lang/String;[B)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, p2, v0}, importKeyWithMetadata(Ljava/lang/String;[B[B)Ljava/lang/String;
...
.method public importKeyWithMetadata(Ljava/lang/String;[B[B)Ljava/lang/String;
    ...
    :try_start_0
    iget-object v2, p0, mPlatformKeyManager:Lcom/android/server/locksettings/recoverablekeystore/PlatformKeyManager;
    ...
    :try_start_1
    iget-object v2, p0, mRecoverableKeyGenerator:Lcom/android/server/locksettings/recoverablekeystore/RecoverableKeyGenerator;
    ...
    iget-object v2, p0, mApplicationKeyStorage:Lcom/android/server/locksettings/recoverablekeystore/storage/ApplicationKeyStorage;
...
.method initRecoveryService(Ljava/lang/String;[B)V
    ...
    invoke-direct/range {p0 .. p0}, checkRecoverKeyStorePermission()V
    ...
    iget-object v0, v1, mTestCertHelper:Lcom/android/server/locksettings/recoverablekeystore/TestOnlyInsecureCertificateHelper;
    ...
    iget-object v0, v1, mDatabase:Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;
...
.method public initRecoveryServiceWithSigFile(Ljava/lang/String;[B[B)V
    ...
    iget-object v1, p0, mTestCertHelper:Lcom/android/server/locksettings/recoverablekeystore/TestOnlyInsecureCertificateHelper;
    ...
    iget-object v2, p0, mTestCertHelper:Lcom/android/server/locksettings/recoverablekeystore/TestOnlyInsecureCertificateHelper;
    ...
    invoke-virtual {p0, p1, p2}, initRecoveryService(Ljava/lang/String;[B)V
...
.method public lockScreenSecretAvailable(I[BI)V
    ...
    :try_start_0
    iget-object v1, p0, mExecutorService:Ljava/util/concurrent/ExecutorService;

    iget-object v2, p0, mContext:Landroid/content/Context;

    iget-object v3, p0, mDatabase:Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;

    iget-object v4, p0, mSnapshotStorage:Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverySnapshotStorage;

    iget-object v5, p0, mListenersStorage:Lcom/android/server/locksettings/recoverablekeystore/RecoverySnapshotListenersStorage;
...
.method public recoverKeyChainSnapshot(Ljava/lang/String;[BLjava/util/List;)Ljava/util/Map;
    ...
    iget-object v2, p0, mRecoverySessionStorage:Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverySessionStorage;
    ...
    :try_start_0
    invoke-direct {p0, v2, p2}, decryptRecoveryKey(Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverySessionStorage$Entry;[B)[B

    move-result-object v3

    invoke-direct {p0, v3, p3}, recoverApplicationKeys([BLjava/util/List;)Ljava/util/Map;

    move-result-object v4

    invoke-direct {p0, v0, v1, v4}, importKeyMaterials(IILjava/util/Map;)Ljava/util/Map;
    ...
    iget-object v6, p0, mRecoverySessionStorage:Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverySessionStorage;
    ...
    iget-object v4, p0, mRecoverySessionStorage:Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverySessionStorage;
...
.method public removeKey(Ljava/lang/String;)V
    ...
    iget-object v2, p0, mDatabase:Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;
...
.method public setSnapshotCreatedPendingIntent(Landroid/app/PendingIntent;)V
    ...
    iget-object v1, p0, mListenersStorage:Lcom/android/server/locksettings/recoverablekeystore/RecoverySnapshotListenersStorage;
...
.method startRecoverySession(Ljava/lang/String;[B[B[BLjava/util/List;)[B
    ...
    invoke-direct {p0, v2, p3}, publicKeysMatch(Ljava/security/PublicKey;[B)Z
    ...
    iget-object v5, p0, mRecoverySessionStorage:Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverySessionStorage;
...
.method public startRecoverySessionWithCertPath(Ljava/lang/String;Ljava/lang/String;Landroid/security/keystore/recovery/RecoveryCertPath;[B[BLjava/util/List;)[B
    ...
    iget-object v0, v7, mTestCertHelper:Lcom/android/server/locksettings/recoverablekeystore/TestOnlyInsecureCertificateHelper;
    ...
    invoke-virtual/range {v1 .. v6}, startRecoverySession(Ljava/lang/String;[B[B[BLjava/util/List;)[B
