...
.method public constructor <init>(Ljava/io/File;)V
    ...
    iput-object v0, p0, mSnapshotByUid:Landroid/util/SparseArray;

    iput-object p1, p0, rootDirectory:Ljava/io/File;
...
.method private getSnapshotFile(I)Ljava/io/File;
    ...
    invoke-direct {p0}, getStorageFolder()Ljava/io/File;

    move-result-object v0

    invoke-direct {p0, p1}, getSnapshotFileName(I)Ljava/lang/String;
...
.method private getStorageFolder()Ljava/io/File;
    ...
    iget-object v1, p0, rootDirectory:Ljava/io/File;
...
.method private readFromDisk(I)Landroid/security/keystore/recovery/KeyChainSnapshot;
    ...
    invoke-direct {p0, p1}, getSnapshotFile(I)Ljava/io/File;
...
.method public declared-synchronized get(I)Landroid/security/keystore/recovery/KeyChainSnapshot;
    ...
    :try_start_0
    iget-object v0, p0, mSnapshotByUid:Landroid/util/SparseArray;
    ...
    :cond_0
    :try_start_1
    invoke-direct {p0, p1}, readFromDisk(I)Landroid/security/keystore/recovery/KeyChainSnapshot;
...
.method public declared-synchronized put(ILandroid/security/keystore/recovery/KeyChainSnapshot;)V
    ...
    :try_start_1
    invoke-direct {p0, p1, p2}, writeToDisk(ILandroid/security/keystore/recovery/KeyChainSnapshot;)V
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0
