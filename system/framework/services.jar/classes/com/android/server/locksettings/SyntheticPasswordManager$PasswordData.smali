...
.method public static create(I)Lcom/android/server/locksettings/SyntheticPasswordManager$PasswordData;
    ...
    iput-byte v1, v0, scryptN:B

    const/4 v1, 0x3

    iput-byte v1, v0, scryptR:B

    const/4 v1, 0x1

    iput-byte v1, v0, scryptP:B

    iput p0, v0, passwordType:I
...
.method public static fromBytes([B)Lcom/android/server/locksettings/SyntheticPasswordManager$PasswordData;
    ...
    iput v2, v0, passwordType:I

    invoke-virtual {v1}, Ljava/nio/ByteBuffer;->get()B

    move-result v2

    iput-byte v2, v0, scryptN:B

    invoke-virtual {v1}, Ljava/nio/ByteBuffer;->get()B

    move-result v2

    iput-byte v2, v0, scryptR:B

    invoke-virtual {v1}, Ljava/nio/ByteBuffer;->get()B

    move-result v2

    iput-byte v2, v0, scryptP:B
    ...
    iput-object v3, v0, salt:[B

    iget-object v3, v0, salt:[B
    ...
    iput-object v4, v0, passwordHandle:[B

    iget-object v4, v0, passwordHandle:[B
...
.method public toBytes()[B
    ...
    iget-object v1, p0, passwordHandle:[B
    ...
    iget v1, p0, passwordType:I

    invoke-virtual {v0, v1}, Ljava/nio/ByteBuffer;->putInt(I)Ljava/nio/ByteBuffer;

    iget-byte v1, p0, scryptN:B

    invoke-virtual {v0, v1}, Ljava/nio/ByteBuffer;->put(B)Ljava/nio/ByteBuffer;

    iget-byte v1, p0, scryptR:B

    invoke-virtual {v0, v1}, Ljava/nio/ByteBuffer;->put(B)Ljava/nio/ByteBuffer;

    iget-byte v1, p0, scryptP:B

    invoke-virtual {v0, v1}, Ljava/nio/ByteBuffer;->put(B)Ljava/nio/ByteBuffer;

    iget-object v1, p0, salt:[B
