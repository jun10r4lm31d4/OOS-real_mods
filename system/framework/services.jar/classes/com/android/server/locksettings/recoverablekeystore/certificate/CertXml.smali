...
.method private constructor <init>(JLjava/util/List;Ljava/util/List;)V
    ...
    iput-wide p1, p0, serial:J

    iput-object p3, p0, intermediateCerts:Ljava/util/List;

    iput-object p4, p0, endpointCerts:Ljava/util/List;
...
.method public static parse([B)Lcom/android/server/locksettings/recoverablekeystore/certificate/CertXml;
    ...
    invoke-static {v0}, parseSerial(Lorg/w3c/dom/Element;)J
    ...
    invoke-static {v0}, parseEndpointCerts(Lorg/w3c/dom/Element;)Ljava/util/List;

    move-result-object v5

    invoke-direct {v1, v2, v3, v4, v5}, <init>(JLjava/util/List;Ljava/util/List;)V
...
.method getAllEndpointCerts()Ljava/util/List;
    ...
    iget-object v0, p0, endpointCerts:Ljava/util/List;
...
.method getEndpointCert(ILjava/util/Date;Ljava/security/cert/X509Certificate;)Ljava/security/cert/CertPath;
    ...
    iget-object v1, p0, intermediateCerts:Ljava/util/List;
...
.method public getRandomEndpointCert(Ljava/security/cert/X509Certificate;)Ljava/security/cert/CertPath;
    ...
    iget-object v1, p0, endpointCerts:Ljava/util/List;
    ...
    invoke-virtual {p0, v0, v1, p1}, getEndpointCert(ILjava/util/Date;Ljava/security/cert/X509Certificate;)Ljava/security/cert/CertPath;
