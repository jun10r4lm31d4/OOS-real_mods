...
.method static constructor <clinit>()V
    ...
    sput-object v1, COLUMNS_FOR_QUERY:[Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mCache:Lcom/android/server/locksettings/LockSettingsStorage$Cache;
    ...
    iput-object v0, p0, mOpenHelper:Lcom/android/server/locksettings/LockSettingsStorage$DatabaseHelper;
...
.method private deleteFile(Ljava/lang/String;)V
    ...
    iget-object v0, p0, mFileWriteLock:Ljava/lang/Object;
    ...
    iget-object v2, p0, mCache:Lcom/android/server/locksettings/LockSettingsStorage$Cache;
...
.method private ensureSyntheticPasswordDirectoryForUser(I)V
    ...
    invoke-virtual {p0, p1}, getSyntheticPasswordDirectoryForUser(I)Ljava/io/File;
...
.method private readFile(Ljava/lang/String;)[B
    ...
    iget-object v0, p0, mCache:Lcom/android/server/locksettings/LockSettingsStorage$Cache;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, mCache:Lcom/android/server/locksettings/LockSettingsStorage$Cache;
    ...
    :cond_1
    :goto_2
    iget-object v3, p0, mCache:Lcom/android/server/locksettings/LockSettingsStorage$Cache;
...
.method private readPasswordHashIfExists(I)Lcom/android/server/locksettings/LockSettingsStorage$CredentialHash;
    ...
    invoke-direct {p0, v0}, readFile(Ljava/lang/String;)[B
...
.method closeDatabase()V
    ...
    iget-object v0, p0, mOpenHelper:Lcom/android/server/locksettings/LockSettingsStorage$DatabaseHelper;
...
.method public deleteSyntheticPasswordState(IJLjava/lang/String;)V
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, getSynthenticPasswordStateFilePathForUser(IJLjava/lang/String;)Ljava/lang/String;
...
.method public getPersistentDataBlock()Lcom/android/server/PersistentDataBlockManagerInternal;
    ...
    iget-object v0, p0, mPersistentDataBlockManagerInternal:Lcom/android/server/PersistentDataBlockManagerInternal;
    ...
    iput-object v0, p0, mPersistentDataBlockManagerInternal:Lcom/android/server/PersistentDataBlockManagerInternal;
...
.method public hasChildProfileLock(I)Z
    ...
    invoke-virtual {p0, p1}, getChildProfileLockFile(I)Ljava/lang/String;
...
.method public hasCredential(I)Z
    ...
    invoke-virtual {p0, p1}, hasPassword(I)Z

    move-result v0

    if-nez v0, :cond_1

    invoke-virtual {p0, p1}, hasPattern(I)Z
...
.method public listSyntheticPasswordHandlesForAllUsers(Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-virtual {p0, p1, v5}, listSyntheticPasswordHandlesForUser(Ljava/lang/String;I)Ljava/util/List;
...
.method public listSyntheticPasswordHandlesForUser(Ljava/lang/String;I)Ljava/util/List;
    ...
    invoke-virtual {p0, p2}, getSyntheticPasswordDirectoryForUser(I)Ljava/io/File;
...
.method public prefetchUser(I)V
    ...
    sget-object v4, COLUMNS_FOR_PREFETCH:[Ljava/lang/String;
    ...
    iget-object v5, p0, mCache:Lcom/android/server/locksettings/LockSettingsStorage$Cache;
    ...
    :cond_2
    invoke-virtual {p0, p1}, readCredentialHash(I)Lcom/android/server/locksettings/LockSettingsStorage$CredentialHash;
...
.method public readCredentialHash(I)Lcom/android/server/locksettings/LockSettingsStorage$CredentialHash;
    ...
    invoke-direct {p0, p1}, readPasswordHashIfExists(I)Lcom/android/server/locksettings/LockSettingsStorage$CredentialHash;

    move-result-object v0

    invoke-direct {p0, p1}, readPatternHashIfExists(I)Lcom/android/server/locksettings/LockSettingsStorage$CredentialHash;
...
.method public readKeyValue(Ljava/lang/String;Ljava/lang/String;I)Ljava/lang/String;
    ...
    iget-object v2, p0, mOpenHelper:Lcom/android/server/locksettings/LockSettingsStorage$DatabaseHelper;
    ...
    sget-object v5, COLUMNS_FOR_QUERY:[Ljava/lang/String;
    ...
    sget-object v3, DEFAULT:Ljava/lang/Object;
...
.method public readPersistentDataBlock()Lcom/android/server/locksettings/LockSettingsStorage$PersistentData;
    ...
    invoke-virtual {p0}, getPersistentDataBlock()Lcom/android/server/PersistentDataBlockManagerInternal;
...
.method public removeChildProfileLock(I)V
    ...
    invoke-direct {p0, v0}, deleteFile(Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public removeUser(I)V
    ...
    iget-object v7, p0, mCache:Lcom/android/server/locksettings/LockSettingsStorage$Cache;
    ...
    :cond_2
    invoke-virtual {p0, p1}, removeChildProfileLock(I)V
...
.method public writeChildProfileLock(I[B)V
    ...
    invoke-direct {p0, v0, p2}, writeFile(Ljava/lang/String;[B)V
...
.method public writeCredentialHash(Lcom/android/server/locksettings/LockSettingsStorage$CredentialHash;I)V
    ...
    invoke-direct {p0, v2, v1}, writeFile(Ljava/lang/String;[B)V

    invoke-virtual {p0, p2}, getLockPatternFilename(I)Ljava/lang/String;

    move-result-object v2

    invoke-direct {p0, v2, v0}, writeFile(Ljava/lang/String;[B)V
...
.method public writeSyntheticPasswordState(IJLjava/lang/String;[B)V
    ...
    invoke-direct {p0, p1}, ensureSyntheticPasswordDirectoryForUser(I)V

    invoke-virtual {p0, p1, p2, p3, p4}, getSynthenticPasswordStateFilePathForUser(IJLjava/lang/String;)Ljava/lang/String;

    move-result-object v0

    invoke-direct {p0, v0, p5}, writeFile(Ljava/lang/String;[B)V
