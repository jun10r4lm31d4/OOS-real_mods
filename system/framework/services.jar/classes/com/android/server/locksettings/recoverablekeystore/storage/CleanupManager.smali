...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverySnapshotStorage;Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;Landroid/os/UserManager;Lcom/android/server/locksettings/recoverablekeystore/storage/ApplicationKeyStorage;)V
    ...
    iput-object p2, p0, mSnapshotStorage:Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverySnapshotStorage;

    iput-object p3, p0, mDatabase:Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;

    iput-object p4, p0, mUserManager:Landroid/os/UserManager;

    iput-object p5, p0, mApplicationKeyStorage:Lcom/android/server/locksettings/recoverablekeystore/storage/ApplicationKeyStorage;
...
.method public static getInstance(Landroid/content/Context;Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverySnapshotStorage;Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;Lcom/android/server/locksettings/recoverablekeystore/storage/ApplicationKeyStorage;)Lcom/android/server/locksettings/recoverablekeystore/storage/CleanupManager;
    ...
    invoke-direct/range {v0 .. v5}, <init>(Landroid/content/Context;Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverySnapshotStorage;Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;Landroid/os/UserManager;Lcom/android/server/locksettings/recoverablekeystore/storage/ApplicationKeyStorage;)V
...
.method private removeAllKeysForRecoveryAgent(II)V
    ...
    iget-object v1, p0, mDatabase:Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;
    ...
    :try_start_0
    iget-object v4, p0, mApplicationKeyStorage:Lcom/android/server/locksettings/recoverablekeystore/storage/ApplicationKeyStorage;
...
.method private removeDataForUser(I)V
    ...
    iget-object v3, p0, mSnapshotStorage:Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverySnapshotStorage;
    ...
    invoke-direct {p0, p1, v3}, removeAllKeysForRecoveryAgent(II)V
...
.method private storeUserSerialNumber(IJ)V
    ...
    iget-object v0, p0, mSerialNumbers:Ljava/util/Map;
...
.method public declared-synchronized registerRecoveryAgent(II)V
    ...
    invoke-virtual {p0}, verifyKnownUsers()V
    ...
    invoke-direct {p0, p1, v3, v4}, storeUserSerialNumber(IJ)V
    :try_end_1
...
.method public declared-synchronized verifyKnownUsers()V
    ...
    iput-object v0, p0, mSerialNumbers:Ljava/util/Map;
    ...
    iget-object v1, p0, mSerialNumbers:Ljava/util/Map;
    ...
    invoke-direct {p0, v5}, removeDataForUser(I)V
    ...
    invoke-direct {p0, v5, v7, v8}, storeUserSerialNumber(IJ)V
    ...
    iget-object v3, p0, mSerialNumbers:Ljava/util/Map;
