...
.method static constructor <clinit>()V
    ...
    sput-object v0, APPLICATION_ID_PERSONALIZATION:[B
...
.method public static createBlob(Ljava/lang/String;[B[BJ)[B
    ...
    sget-object v4, APPLICATION_ID_PERSONALIZATION:[B

    invoke-static {p2, v4, p1}, encrypt([B[B[B)[B

    move-result-object v4

    invoke-static {v1, v4}, encrypt(Ljavax/crypto/SecretKey;[B)[B
...
.method public static decrypt([B[B[B)[B
    ...
    invoke-static {p1, v0}, personalisedHash([B[[B)[B
    ...
    :try_start_0
    invoke-static {v1, p2}, decrypt(Ljavax/crypto/SecretKey;[B)[B
...
.method public static decryptBlob(Ljava/lang/String;[B[B)[B
    ...
    invoke-static {v1, p1}, decrypt(Ljavax/crypto/SecretKey;[B)[B

    move-result-object v2

    sget-object v3, APPLICATION_ID_PERSONALIZATION:[B

    invoke-static {p2, v3, v2}, decrypt([B[B[B)[B
...
.method public static decryptBlobV1(Ljava/lang/String;[B[B)[B
    ...
    sget-object v2, APPLICATION_ID_PERSONALIZATION:[B

    invoke-static {p2, v2, p1}, decrypt([B[B[B)[B

    move-result-object v2

    invoke-static {v1, v2}, decrypt(Ljavax/crypto/SecretKey;[B)[B
...
.method public static encrypt([B[B[B)[B
    ...
    :try_start_0
    invoke-static {v1, p2}, encrypt(Ljavax/crypto/SecretKey;[B)[B
