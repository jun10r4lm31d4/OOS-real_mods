...
.method static constructor <clinit>()V
    ...
    sget-object v1, VERSION:[B

    const/4 v3, 0x1

    aput-object v1, v0, v3

    invoke-static {v0}, concat([[B)[B

    move-result-object v0

    sput-object v0, HKDF_SALT:[B
    ...
    sput-object v0, HKDF_INFO_WITH_PUBLIC_KEY:[B
    ...
    sput-object v0, HKDF_INFO_WITHOUT_PUBLIC_KEY:[B

    new-array v0, v3, [B

    aput-byte v3, v0, v2

    sput-object v0, CONSTANT_01:[B
    ...
    sput-object v0, BIG_INT_02:Ljava/math/BigInteger;
    ...
    sput-object v0, EC_PARAM_P:Ljava/math/BigInteger;

    sget-object v0, EC_PARAM_P:Ljava/math/BigInteger;
    ...
    sput-object v0, EC_PARAM_A:Ljava/math/BigInteger;
    ...
    sput-object v0, EC_PARAM_B:Ljava/math/BigInteger;

    new-instance v0, Ljava/security/spec/EllipticCurve;

    new-instance v2, Ljava/security/spec/ECFieldFp;

    sget-object v4, EC_PARAM_P:Ljava/math/BigInteger;

    invoke-direct {v2, v4}, Ljava/security/spec/ECFieldFp;-><init>(Ljava/math/BigInteger;)V

    sget-object v4, EC_PARAM_A:Ljava/math/BigInteger;

    sget-object v5, EC_PARAM_B:Ljava/math/BigInteger;
    ...
    sput-object v4, EC_PARAM_SPEC:Ljava/security/spec/ECParameterSpec;
...
.method private static aesGcmDecrypt(Ljavax/crypto/SecretKey;[B[B[B)[B
    ...
    invoke-static {v0, p0, p1, p2, p3}, aesGcmInternal(Lcom/android/server/locksettings/recoverablekeystore/SecureBox$AesGcmOperation;Ljavax/crypto/SecretKey;[B[B[B)[B
...
.method static varargs concat([[B)[B
    ...
    sget-object v2, EMPTY_BYTE_ARRAY:[B
...
.method static decodePublicKey([B)Ljava/security/PublicKey;
    ...
    invoke-static {v0, v1}, validateEcPoint(Ljava/math/BigInteger;Ljava/math/BigInteger;)V
    ...
    sget-object v5, EC_PARAM_SPEC:Ljava/security/spec/ECParameterSpec;
...
.method public static decrypt(Ljava/security/PrivateKey;[B[B[B)[B
    ...
    invoke-static {p1}, emptyByteArrayIfNull([B)[B
    ...
    :cond_1
    :goto_0
    invoke-static {p2}, emptyByteArrayIfNull([B)[B
    ...
    invoke-static {v0, v1}, readEncryptedPayload(Ljava/nio/ByteBuffer;I)[B

    move-result-object v1

    sget-object v2, VERSION:[B
    ...
    sget-object v3, HKDF_INFO_WITHOUT_PUBLIC_KEY:[B
    ...
    invoke-static {v0, v2}, readEncryptedPayload(Ljava/nio/ByteBuffer;I)[B

    move-result-object v2

    invoke-static {v2}, decodePublicKey([B)Ljava/security/PublicKey;

    move-result-object v3

    invoke-static {p0, v3}, dhComputeSecret(Ljava/security/PrivateKey;Ljava/security/PublicKey;)[B

    move-result-object v3

    sget-object v2, HKDF_INFO_WITH_PUBLIC_KEY:[B
    ...
    invoke-static {v0, v4}, readEncryptedPayload(Ljava/nio/ByteBuffer;I)[B
    ...
    invoke-static {v0, v5}, readEncryptedPayload(Ljava/nio/ByteBuffer;I)[B
    ...
    invoke-static {v6}, concat([[B)[B

    move-result-object v6

    sget-object v7, HKDF_SALT:[B

    invoke-static {v6, v7, v3}, hkdfDeriveKey([B[B[B)Ljavax/crypto/SecretKey;

    move-result-object v7

    invoke-static {v7, v4, v5, p2}, aesGcmDecrypt(Ljavax/crypto/SecretKey;[B[B[B)[B
...
.method public static encrypt(Ljava/security/PublicKey;[B[B[B)[B
    ...
    invoke-static/range {p1 .. p1}, emptyByteArrayIfNull([B)[B
    ...
    :cond_1
    :goto_0
    invoke-static/range {p2 .. p2}, emptyByteArrayIfNull([B)[B

    move-result-object v2

    invoke-static/range {p3 .. p3}, emptyByteArrayIfNull([B)[B
    ...
    sget-object v5, EMPTY_BYTE_ARRAY:[B

    sget-object v6, HKDF_INFO_WITHOUT_PUBLIC_KEY:[B

    goto :goto_1

    :cond_2
    invoke-static {}, genKeyPair()Ljava/security/KeyPair;
    ...
    invoke-static {v5, v0}, dhComputeSecret(Ljava/security/PrivateKey;Ljava/security/PublicKey;)[B

    move-result-object v5

    sget-object v6, HKDF_INFO_WITH_PUBLIC_KEY:[B

    :goto_1
    invoke-static {}, genRandomNonce()[B
    ...
    invoke-static {v9}, concat([[B)[B

    move-result-object v9

    sget-object v12, HKDF_SALT:[B

    invoke-static {v9, v12, v6}, hkdfDeriveKey([B[B[B)Ljavax/crypto/SecretKey;

    move-result-object v12

    invoke-static {v12, v7, v3, v2}, aesGcmEncrypt(Ljavax/crypto/SecretKey;[B[B[B)[B
    ...
    invoke-static {v10}, encodePublicKey(Ljava/security/PublicKey;)[B
...
.method private static validateEcPoint(Ljava/math/BigInteger;Ljava/math/BigInteger;)V
    ...
    sget-object v3, EC_PARAM_B:Ljava/math/BigInteger;
