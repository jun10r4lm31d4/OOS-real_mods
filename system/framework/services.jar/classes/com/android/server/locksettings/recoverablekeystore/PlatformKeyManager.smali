...
.method static constructor <clinit>()V
    ...
    sput-object v0, GCM_INSECURE_NONCE_BYTES:[B
...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/locksettings/recoverablekeystore/KeyStoreProxy;Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;)V
    ...
    iput-object p2, p0, mKeyStore:Lcom/android/server/locksettings/recoverablekeystore/KeyStoreProxy;

    iput-object p1, p0, mContext:Landroid/content/Context;

    iput-object p3, p0, mDatabase:Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;
...
.method private ensureDecryptionKeyIsValid(ILcom/android/server/locksettings/recoverablekeystore/PlatformDecryptionKey;)V
    ...
    sget-object v5, GCM_INSECURE_NONCE_BYTES:[B
...
.method private generateAndLoadKey(II)V
    ...
    invoke-direct {p0, p1, p2}, getEncryptAlias(II)Ljava/lang/String;

    move-result-object v0

    invoke-direct {p0, p1, p2}, getDecryptAlias(II)Ljava/lang/String;

    move-result-object v1

    invoke-static {}, generateAesKey()Ljavax/crypto/SecretKey;
    ...
    :cond_0
    iget-object v5, p0, mKeyStore:Lcom/android/server/locksettings/recoverablekeystore/KeyStoreProxy;
    ...
    invoke-direct {p0, p1, p2}, setGenerationId(II)V
...
.method private getDecryptKeyInternal(I)Lcom/android/server/locksettings/recoverablekeystore/PlatformDecryptionKey;
    ...
    invoke-virtual {p0, p1}, getGenerationId(I)I

    move-result v0

    invoke-direct {p0, p1, v0}, getDecryptAlias(II)Ljava/lang/String;

    move-result-object v1

    invoke-direct {p0, p1, v0}, isKeyLoaded(II)Z

    move-result v2

    if-eqz v2, :cond_0

    iget-object v2, p0, mKeyStore:Lcom/android/server/locksettings/recoverablekeystore/KeyStoreProxy;
...
.method private getEncryptKeyInternal(I)Lcom/android/server/locksettings/recoverablekeystore/PlatformEncryptionKey;
    ...
    invoke-direct {p0, p1, v0}, getEncryptAlias(II)Ljava/lang/String;
...
.method public static getInstance(Landroid/content/Context;Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;)Lcom/android/server/locksettings/recoverablekeystore/PlatformKeyManager;
    ...
    invoke-static {}, getAndLoadAndroidKeyStore()Ljava/security/KeyStore;
    ...
    invoke-direct {v0, v1, v2, p1}, <init>(Landroid/content/Context;Lcom/android/server/locksettings/recoverablekeystore/KeyStoreProxy;Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;)V
...
.method private isKeyLoaded(II)Z
    ...
    iget-object v0, p0, mKeyStore:Lcom/android/server/locksettings/recoverablekeystore/KeyStoreProxy;
...
.method public getDecryptKey(I)Lcom/android/server/locksettings/recoverablekeystore/PlatformDecryptionKey;
    ...
    invoke-virtual {p0, p1}, init(I)V

    :try_start_0
    invoke-direct {p0, p1}, getDecryptKeyInternal(I)Lcom/android/server/locksettings/recoverablekeystore/PlatformDecryptionKey;

    move-result-object v0

    invoke-direct {p0, p1, v0}, ensureDecryptionKeyIsValid(ILcom/android/server/locksettings/recoverablekeystore/PlatformDecryptionKey;)V
    :try_end_0
    ...
    invoke-virtual {p0, p1}, regenerate(I)V
...
.method public getEncryptKey(I)Lcom/android/server/locksettings/recoverablekeystore/PlatformEncryptionKey;
    ...
    invoke-direct {p0, p1}, getEncryptKeyInternal(I)Lcom/android/server/locksettings/recoverablekeystore/PlatformEncryptionKey;
...
.method init(I)V
    ...
    invoke-virtual {p0, p1}, isAvailable(I)Z
    ...
    :goto_0
    invoke-direct {p0, p1, v0}, generateAndLoadKey(II)V
...
.method regenerate(I)V
    ...
    :cond_0
    invoke-virtual {p0, p1, v0}, invalidatePlatformKey(II)V

    add-int/lit8 v1, v0, 0x1

    :goto_0
    invoke-direct {p0, p1, v1}, generateAndLoadKey(II)V
