...
.method private constructor <init>(Ljava/util/List;Ljava/security/cert/X509Certificate;[B)V
    ...
    iput-object p1, p0, intermediateCerts:Ljava/util/List;

    iput-object p2, p0, signerCert:Ljava/security/cert/X509Certificate;

    iput-object p3, p0, signature:[B
...
.method public static parse([B)Lcom/android/server/locksettings/recoverablekeystore/certificate/SigXml;
    ...
    invoke-static {v0}, parseIntermediateCerts(Lorg/w3c/dom/Element;)Ljava/util/List;

    move-result-object v2

    invoke-static {v0}, parseSignerCert(Lorg/w3c/dom/Element;)Ljava/security/cert/X509Certificate;

    move-result-object v3

    invoke-static {v0}, parseFileSignature(Lorg/w3c/dom/Element;)[B

    move-result-object v4

    invoke-direct {v1, v2, v3, v4}, <init>(Ljava/util/List;Ljava/security/cert/X509Certificate;[B)V
...
.method public verifyFileSignature(Ljava/security/cert/X509Certificate;[B)V
    ...
    invoke-virtual {p0, p1, p2, v0}, verifyFileSignature(Ljava/security/cert/X509Certificate;[BLjava/util/Date;)V
...
.method verifyFileSignature(Ljava/security/cert/X509Certificate;[BLjava/util/Date;)V
    ...
    iget-object v0, p0, intermediateCerts:Ljava/util/List;

    iget-object v1, p0, signerCert:Ljava/security/cert/X509Certificate;
    ...
    iget-object v0, p0, signerCert:Ljava/security/cert/X509Certificate;

    invoke-virtual {v0}, Ljava/security/cert/X509Certificate;->getPublicKey()Ljava/security/PublicKey;

    move-result-object v0

    iget-object v1, p0, signature:[B
