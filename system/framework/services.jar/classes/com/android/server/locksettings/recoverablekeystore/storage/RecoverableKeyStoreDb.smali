...
.method private constructor <init>(Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDbHelper;)V
    ...
    iput-object p1, p0, mKeyStoreDbHelper:Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDbHelper;
    ...
    iput-object v0, p0, mTestOnlyInsecureCertificateHelper:Lcom/android/server/locksettings/recoverablekeystore/TestOnlyInsecureCertificateHelper;
...
.method private ensureRecoveryServiceMetadataEntryExists(II)V
    ...
    iget-object v0, p0, mKeyStoreDbHelper:Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDbHelper;
...
.method private getBytes(IILjava/lang/String;)[B
    ...
    iget-object v0, v2, mKeyStoreDbHelper:Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDbHelper;
...
.method private getBytes(IILjava/lang/String;Ljava/lang/String;)[B
    ...
    iget-object v0, v1, mKeyStoreDbHelper:Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDbHelper;
    ...
    invoke-static {v7, v4}, $closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
...
.method public static newInstance(Landroid/content/Context;)Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;
    ...
    invoke-direct {v1, v0}, <init>(Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDbHelper;)V
...
.method private setBytes(IILjava/lang/String;Ljava/lang/String;[B)J
    ...
    iget-object v0, p0, mTestOnlyInsecureCertificateHelper:Lcom/android/server/locksettings/recoverablekeystore/TestOnlyInsecureCertificateHelper;
    ...
    invoke-direct {p0, p1, p2, p3}, ensureRootOfTrustEntryExists(IILjava/lang/String;)V
...
.method private setBytes(IILjava/lang/String;[B)J
    ...
    invoke-direct {p0, p1, p2}, ensureRecoveryServiceMetadataEntryExists(II)V
...
.method public getActiveRootOfTrust(II)Ljava/lang/String;
    ...
    invoke-static {v5, v2}, $closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
...
.method public getCounterId(II)Ljava/lang/Long;
    ...
    invoke-direct {p0, p1, p2, v0}, getLong(IILjava/lang/String;)Ljava/lang/Long;
...
.method public getRecoveryAgents(I)Ljava/util/List;
    ...
    invoke-static {v6, v1}, $closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
...
.method public getRecoveryServiceCertPath(IILjava/lang/String;)Ljava/security/cert/CertPath;
    ...
    invoke-direct {p0, p1, p2, p3, v0}, getBytes(IILjava/lang/String;Ljava/lang/String;)[B
    ...
    :cond_0
    :try_start_0
    invoke-static {v0}, decodeCertPath([B)Ljava/security/cert/CertPath;
...
.method public getRecoveryServiceCertSerial(IILjava/lang/String;)Ljava/lang/Long;
    ...
    invoke-direct {p0, p1, p2, p3, v0}, getLong(IILjava/lang/String;Ljava/lang/String;)Ljava/lang/Long;
...
.method public getRecoveryServicePublicKey(II)Ljava/security/PublicKey;
    ...
    invoke-direct {p0, p1, p2, v0}, getBytes(IILjava/lang/String;)[B
    ...
    :cond_0
    :try_start_0
    invoke-static {v0}, decodeX509Key([B)Ljava/security/PublicKey;
...
.method public removeUserFromAllTables(I)V
    ...
    invoke-direct {p0, p1}, removeUserFromKeysTable(I)Z

    invoke-direct {p0, p1}, removeUserFromUserMetadataTable(I)Z

    invoke-direct {p0, p1}, removeUserFromRecoveryServiceMetadataTable(I)Z

    invoke-direct {p0, p1}, removeUserFromRootOfTrustTable(I)Z
...
.method public setCounterId(IIJ)J
    ...
    invoke-direct/range {v0 .. v5}, setLong(IILjava/lang/String;J)J
...
.method public setPlatformKeyGenerationId(II)J
    ...
    invoke-direct {p0, p1}, ensureUserMetadataEntryExists(I)V

    invoke-virtual {p0, p1}, invalidateKeysForUser(I)V
...
.method public setRecoveryServiceCertPath(IILjava/lang/String;Ljava/security/cert/CertPath;)J
    ...
    invoke-direct/range {v1 .. v6}, setBytes(IILjava/lang/String;Ljava/lang/String;[B)J
...
.method public setRecoveryServiceCertSerial(IILjava/lang/String;J)J
    ...
    invoke-direct/range {v0 .. v6}, setLong(IILjava/lang/String;Ljava/lang/String;J)J
...
.method public setRecoveryServicePublicKey(IILjava/security/PublicKey;)J
    ...
    invoke-direct {p0, p1, p2, v1, v0}, setBytes(IILjava/lang/String;[B)J
...
.method public setServerParams(II[B)J
    ...
    invoke-direct {p0, p1, p2, v0, p3}, setBytes(IILjava/lang/String;[B)J
...
.method public setShouldCreateSnapshot(IIZ)J
    ...
    invoke-direct/range {v2 .. v7}, setLong(IILjava/lang/String;J)J
