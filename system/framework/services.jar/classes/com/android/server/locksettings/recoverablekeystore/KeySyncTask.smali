...
.method constructor <init>(Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverySnapshotStorage;Lcom/android/server/locksettings/recoverablekeystore/RecoverySnapshotListenersStorage;II[BZLcom/android/server/locksettings/recoverablekeystore/PlatformKeyManager;Lcom/android/server/locksettings/recoverablekeystore/TestOnlyInsecureCertificateHelper;Landroid/security/Scrypt;)V
    ...
    iput-object p3, p0, mSnapshotListenersStorage:Lcom/android/server/locksettings/recoverablekeystore/RecoverySnapshotListenersStorage;

    iput-object p1, p0, mRecoverableKeyStoreDb:Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;

    iput p4, p0, mUserId:I

    iput p5, p0, mCredentialType:I

    iput-object p6, p0, mCredential:[B

    iput-boolean p7, p0, mCredentialUpdated:Z

    iput-object p8, p0, mPlatformKeyManager:Lcom/android/server/locksettings/recoverablekeystore/PlatformKeyManager;

    iput-object p2, p0, mRecoverySnapshotStorage:Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverySnapshotStorage;

    iput-object p9, p0, mTestOnlyInsecureCertificateHelper:Lcom/android/server/locksettings/recoverablekeystore/TestOnlyInsecureCertificateHelper;

    iput-object p10, p0, mScrypt:Landroid/security/Scrypt;
...
.method private generateAndStoreCounterId(I)J
    ...
    iget-object v2, p0, mRecoverableKeyStoreDb:Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;
...
.method private getKeysToSync(I)Ljava/util/Map;
    ...
    iget-object v0, p0, mPlatformKeyManager:Lcom/android/server/locksettings/recoverablekeystore/PlatformKeyManager;
    ...
    iget-object v1, p0, mRecoverableKeyStoreDb:Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;
...
.method private hashCredentialsByScrypt([B[B)[B
    ...
    iget-object v0, p0, mScrypt:Landroid/security/Scrypt;
...
.method public static newInstance(Landroid/content/Context;Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverySnapshotStorage;Lcom/android/server/locksettings/recoverablekeystore/RecoverySnapshotListenersStorage;II[BZ)Lcom/android/server/locksettings/recoverablekeystore/KeySyncTask;
    ...
    invoke-direct/range {v0 .. v10}, <init>(Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverySnapshotStorage;Lcom/android/server/locksettings/recoverablekeystore/RecoverySnapshotListenersStorage;II[BZLcom/android/server/locksettings/recoverablekeystore/PlatformKeyManager;Lcom/android/server/locksettings/recoverablekeystore/TestOnlyInsecureCertificateHelper;Landroid/security/Scrypt;)V
...
.method private shouldCreateSnapshot(I)Z
    ...
    iget-object v0, p0, mRecoverableKeyStoreDb:Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;
    ...
    :cond_0
    iget-boolean v1, p0, mCredentialUpdated:Z
...
.method private syncKeys()V
    ...
    :cond_0
    invoke-direct {p0}, isCustomLockScreen()Z
    ...
    :try_start_0
    invoke-direct {p0, v3}, syncKeysForAgent(I)V
    :try_end_0
...
.method private syncKeysForAgent(I)V
    ...
    invoke-direct/range {p0 .. p1}, shouldCreateSnapshot(I)Z
    ...
    iget-object v3, v1, mRecoverableKeyStoreDb:Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;
    ...
    iget-object v3, v1, mRecoverySnapshotStorage:Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverySnapshotStorage;
    ...
    :goto_1
    iget-object v0, v1, mRecoverableKeyStoreDb:Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;
    ...
    iget-object v6, v1, mTestOnlyInsecureCertificateHelper:Lcom/android/server/locksettings/recoverablekeystore/TestOnlyInsecureCertificateHelper;
    ...
    :cond_5
    iget-object v0, v1, mTestOnlyInsecureCertificateHelper:Lcom/android/server/locksettings/recoverablekeystore/TestOnlyInsecureCertificateHelper;
    ...
    iget v10, v1, mCredentialType:I

    iget-object v11, v1, mCredential:[B
    ...
    :cond_7
    :goto_3
    invoke-direct/range {p0 .. p0}, shouldUseScryptToHashCredential()Z

    move-result v10

    invoke-static {}, generateSalt()[B

    move-result-object v11

    if-eqz v10, :cond_8

    iget-object v0, v1, mCredential:[B

    invoke-direct {v1, v11, v0}, hashCredentialsByScrypt([B[B)[B
    ...
    invoke-static {v11, v0}, hashCredentialsBySaltedSha256([B[B)[B
    ...
    :goto_4
    :try_start_0
    invoke-direct/range {p0 .. p1}, getKeysToSync(I)Ljava/util/Map;
    ...
    iget-object v13, v1, mTestOnlyInsecureCertificateHelper:Lcom/android/server/locksettings/recoverablekeystore/TestOnlyInsecureCertificateHelper;
    ...
    :goto_5
    :try_start_1
    invoke-static {}, generateRecoveryKey()Ljavax/crypto/SecretKey;
    ...
    iget-boolean v0, v1, mCredentialUpdated:Z

    if-eqz v0, :cond_a

    invoke-direct/range {p0 .. p1}, generateAndStoreCounterId(I)J
    ...
    iget v8, v1, mCredentialType:I

    move/from16 v22, v10

    iget-object v10, v1, mCredential:[B

    invoke-static {v8, v10}, getUiFormat(I[B)I
    ...
    invoke-virtual {v1, v2, v3}, getSnapshotVersion(IZ)I
    ...
    invoke-static {v15, v13}, createApplicationKeyEntries(Ljava/util/Map;Ljava/util/Map;)Ljava/util/List;
    ...
    iget-object v0, v1, mRecoverySnapshotStorage:Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverySnapshotStorage;
    ...
    iget-object v0, v1, mSnapshotListenersStorage:Lcom/android/server/locksettings/recoverablekeystore/RecoverySnapshotListenersStorage;
