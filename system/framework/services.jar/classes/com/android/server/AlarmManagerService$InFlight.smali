...
.method constructor <init>(Lcom/android/server/AlarmManagerService;Lcom/android/server/AlarmManagerService$Alarm;J)V
    ...
    iput-wide p3, p0, mWhenElapsed:J
    ...
    :goto_0
    iput-object v0, p0, mListener:Landroid/os/IBinder;
    ...
    :goto_1
    iput-object v0, p0, mBroadcastStats:Lcom/android/server/AlarmManagerService$BroadcastStats;

    iget-object v0, p0, mBroadcastStats:Lcom/android/server/AlarmManagerService$BroadcastStats;
    ...
    iget-object v2, p0, mBroadcastStats:Lcom/android/server/AlarmManagerService$BroadcastStats;
...
.method public toString()Ljava/lang/String;
    ...
    iget-wide v1, p0, mWhenElapsed:J
    ...
    iget-object v1, p0, mFilterStats:Lcom/android/server/AlarmManagerService$FilterStats;
...
.method public writeToProto(Landroid/util/proto/ProtoOutputStream;J)V
    ...
    iget-wide v2, p0, mWhenElapsed:J

    const-wide v4, 0x10300000003L

    invoke-virtual {p1, v4, v5, v2, v3}, Landroid/util/proto/ProtoOutputStream;->write(JJ)V

    iget v2, p0, mAlarmType:I
    ...
    :cond_1
    iget-object v2, p0, mFilterStats:Lcom/android/server/AlarmManagerService$FilterStats;
    ...
    :cond_2
    iget-object v2, p0, mWorkSource:Landroid/os/WorkSource;
