...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/wm/WindowManagerService;)V
    ...
    iput-object v0, p0, mIcons:Landroid/util/ArrayMap;
    ...
    iput-object v0, p0, mSysUiVisToken:Landroid/os/IBinder;
    ...
    iput-object v0, p0, mDeathRecipient:Lcom/android/server/statusbar/StatusBarManagerService$DeathRecipient;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, mDisplayUiState:Landroid/util/SparseArray;
    ...
    iput-object v0, p0, mInternalService:Lcom/android/server/statusbar/StatusBarManagerInternal;
    ...
    iput-object v0, p0, mGlobalActionsProvider:Lcom/android/server/policy/GlobalActionsProvider;
    ...
    iget-object v2, p0, mGlobalActionsProvider:Lcom/android/server/policy/GlobalActionsProvider;
    ...
    iget-object v1, p0, mDisplayUiState:Landroid/util/SparseArray;
...
.method static synthetic access$1002(Z)Z
    ...
    sput-boolean p0, mTopIsFullscreen:Z
...
.method static synthetic access$1200(Lcom/android/server/statusbar/StatusBarManagerService;)Landroid/util/SparseArray;
    ...
    iget-object v0, p0, mDisplayUiState:Landroid/util/SparseArray;
...
.method static synthetic access$1400(Lcom/android/server/statusbar/StatusBarManagerService;)Lcom/android/server/policy/GlobalActionsProvider$GlobalActionsListener;
    ...
    iget-object v0, p0, mGlobalActionListener:Lcom/android/server/policy/GlobalActionsProvider$GlobalActionsListener;
...
.method static synthetic access$1402(Lcom/android/server/statusbar/StatusBarManagerService;Lcom/android/server/policy/GlobalActionsProvider$GlobalActionsListener;)Lcom/android/server/policy/GlobalActionsProvider$GlobalActionsListener;
    ...
    iput-object p1, p0, mGlobalActionListener:Lcom/android/server/policy/GlobalActionsProvider$GlobalActionsListener;
...
.method static synthetic access$200(Lcom/android/server/statusbar/StatusBarManagerService;)V
    ...
    invoke-direct {p0}, notifyBarAttachChanged()V
...
.method static synthetic access$300(Lcom/android/server/statusbar/StatusBarManagerService;)Lcom/android/server/statusbar/StatusBarManagerService$DeathRecipient;
    ...
    iget-object v0, p0, mDeathRecipient:Lcom/android/server/statusbar/StatusBarManagerService$DeathRecipient;
...
.method static synthetic access$600(Lcom/android/server/statusbar/StatusBarManagerService;IZ)V
    ...
    invoke-direct {p0, p1, p2}, topAppWindowChanged(IZ)V
...
.method static synthetic access$700(Lcom/android/server/statusbar/StatusBarManagerService;IIIIILandroid/graphics/Rect;Landroid/graphics/Rect;ZLjava/lang/String;)V
    ...
    invoke-direct/range {p0 .. p9}, setSystemUiVisibility(IIIIILandroid/graphics/Rect;Landroid/graphics/Rect;ZLjava/lang/String;)V
...
.method private disableLocked(IIILandroid/os/IBinder;Ljava/lang/String;I)V
    ...
    invoke-virtual/range {v0 .. v5}, manageDisableListLocked(IILandroid/os/IBinder;Ljava/lang/String;I)V

    iget v0, p0, mCurrentUserId:I

    const/4 v1, 0x1

    invoke-virtual {p0, v0, v1}, gatherDisableActionsLocked(II)I
    ...
    invoke-direct {p0, p1}, getUiState(I)Lcom/android/server/statusbar/StatusBarManagerService$UiState;
    ...
    iget-object v3, p0, mBar:Lcom/android/internal/statusbar/IStatusBar;
...
.method private findMatchingRecordLocked(Landroid/os/IBinder;I)Landroid/util/Pair;
    ...
    iget-object v0, p0, mDisableRecords:Ljava/util/ArrayList;
...
.method static synthetic lambda$reboot$6(Z)V
    ...
    invoke-static {}, getUiContext()Landroid/content/Context;
...
.method private setSystemUiVisibility(IIIIILandroid/graphics/Rect;Landroid/graphics/Rect;ZLjava/lang/String;)V
    ...
    :try_start_0
    invoke-direct/range {p0 .. p8}, updateUiVisibilityLocked(IIIIILandroid/graphics/Rect;Landroid/graphics/Rect;Z)V

    iget v3, v8, mCurrentUserId:I

    const/high16 v0, 0x3ff0000

    and-int v4, p2, v0

    iget-object v5, v8, mSysUiVisToken:Landroid/os/IBinder;
    ...
    invoke-direct/range {v1 .. v7}, disableLocked(IIILandroid/os/IBinder;Ljava/lang/String;I)V
...
.method private updateUiVisibilityLocked(IIIIILandroid/graphics/Rect;Landroid/graphics/Rect;Z)V
    ...
    invoke-direct/range {p0 .. p1}, getUiState(I)Lcom/android/server/statusbar/StatusBarManagerService$UiState;
...
.method public addTile(Landroid/content/ComponentName;)V
    ...
    invoke-direct {p0}, enforceStatusBarOrShell()V
...
.method public disable2(ILandroid/os/IBinder;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, disable2ForUser(ILandroid/os/IBinder;Ljava/lang/String;I)V
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    :goto_0
    :try_start_0
    iget-object v2, p0, mDisplayUiState:Landroid/util/SparseArray;
    ...
    iget-object v3, p0, mDisplayUiState:Landroid/util/SparseArray;
    ...
    :cond_1
    iget-object v1, p0, mDisableRecords:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, mIcons:Landroid/util/ArrayMap;
    ...
    iget-object v4, p0, mIcons:Landroid/util/ArrayMap;
...
.method public getDisableFlags(Landroid/os/IBinder;I)[I
    ...
    :try_start_0
    invoke-direct {p0, p1, p2}, findMatchingRecordLocked(Landroid/os/IBinder;I)Landroid/util/Pair;
...
.method public getTopIsFullscreen()Z
    ...
    sget-boolean v1, mTopIsFullscreen:Z
    ...
    sget-boolean v0, mTopIsFullscreen:Z
...
.method public hideBiometricDialog()V
    ...
    invoke-direct {p0}, enforceBiometricDialog()V
...
.method public synthetic lambda$updateUiVisibilityLocked$3$StatusBarManagerService(IIIIILandroid/graphics/Rect;Landroid/graphics/Rect;Z)V
    ...
    iget-object v0, v1, mBar:Lcom/android/internal/statusbar/IStatusBar;

    if-eqz v0, :cond_0

    :try_start_0
    iget-object v2, v1, mBar:Lcom/android/internal/statusbar/IStatusBar;
...
.method manageDisableListLocked(IILandroid/os/IBinder;Ljava/lang/String;I)V
    ...
    invoke-direct {p0, p3, p1}, findMatchingRecordLocked(Landroid/os/IBinder;I)Landroid/util/Pair;
...
.method public onGlobalActionsHidden()V
    ...
    :try_start_0
    iget-object v2, p0, mGlobalActionListener:Lcom/android/server/policy/GlobalActionsProvider$GlobalActionsListener;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public onNotificationActionClick(Ljava/lang/String;ILandroid/app/Notification$Action;Lcom/android/internal/statusbar/NotificationVisibility;Z)V
    ...
    :try_start_0
    iget-object v1, v13, mNotificationDelegate:Lcom/android/server/notification/NotificationDelegate;
...
.method public onNotificationClear(Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;IILcom/android/internal/statusbar/NotificationVisibility;)V
    ...
    invoke-direct/range {p0 .. p0}, enforceStatusBarService()V
    ...
    :try_start_0
    iget-object v1, v11, mNotificationDelegate:Lcom/android/server/notification/NotificationDelegate;
...
.method public onNotificationError(Ljava/lang/String;Ljava/lang/String;IIILjava/lang/String;I)V
    ...
    :try_start_0
    iget-object v1, v15, mNotificationDelegate:Lcom/android/server/notification/NotificationDelegate;
...
.method public registerStatusBar(Lcom/android/internal/statusbar/IStatusBar;)Lcom/android/internal/statusbar/RegisterStatusBarResult;
    ...
    iput-object v2, v1, mBar:Lcom/android/internal/statusbar/IStatusBar;

    iget-object v0, v1, mDeathRecipient:Lcom/android/server/statusbar/StatusBarManagerService$DeathRecipient;

    invoke-virtual {v0}, Lcom/android/server/statusbar/StatusBarManagerService$DeathRecipient;->linkToDeath()V

    invoke-direct/range {p0 .. p0}, notifyBarAttachChanged()V

    iget-object v3, v1, mIcons:Landroid/util/ArrayMap;
    ...
    iget-object v0, v1, mIcons:Landroid/util/ArrayMap;
    ...
    :try_start_1
    iget-object v0, v1, mDisplayUiState:Landroid/util/SparseArray;
    ...
    invoke-virtual {v1, v4, v6}, gatherDisableActionsLocked(II)I
    ...
    invoke-virtual {v1, v4, v12}, gatherDisableActionsLocked(II)I
...
.method public removeIcon(Ljava/lang/String;)V
    ...
    iget-object v0, p0, mIcons:Landroid/util/ArrayMap;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, mIcons:Landroid/util/ArrayMap;
...
.method public setSystemUiVisibility(IIILjava/lang/String;)V
    ...
    invoke-direct/range {v1 .. v10}, setSystemUiVisibility(IIIIILandroid/graphics/Rect;Landroid/graphics/Rect;ZLjava/lang/String;)V
