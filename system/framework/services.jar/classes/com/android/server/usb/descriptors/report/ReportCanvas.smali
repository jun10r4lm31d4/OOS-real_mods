...
.method public constructor <init>(Lcom/android/server/usb/descriptors/UsbDescriptorParser;)V
    ...
    iput-object p1, p0, mParser:Lcom/android/server/usb/descriptors/UsbDescriptorParser;
...
.method public dumpHexArray([BLjava/lang/StringBuilder;)V
    ...
    invoke-virtual {p0, v0}, openParagraph(Z)V
    ...
    invoke-static {v2}, getHexString(B)Ljava/lang/String;
    ...
    :cond_0
    invoke-virtual {p0}, closeParagraph()V
...
.method public getParser()Lcom/android/server/usb/descriptors/UsbDescriptorParser;
    ...
    iget-object v0, p0, mParser:Lcom/android/server/usb/descriptors/UsbDescriptorParser;
...
.method public writeHeader(ILjava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, openHeader(I)V

    invoke-virtual {p0, p2}, write(Ljava/lang/String;)V

    invoke-virtual {p0, p1}, closeHeader(I)V
...
.method public writeListItem(Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, openListItem()V

    invoke-virtual {p0, p1}, write(Ljava/lang/String;)V

    invoke-virtual {p0}, closeListItem()V
