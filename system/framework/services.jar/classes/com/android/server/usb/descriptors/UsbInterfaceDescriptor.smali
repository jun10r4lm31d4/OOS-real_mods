...
.method constructor <init>(IB)V
    ...
    iput-object v0, p0, mEndpointDescriptors:Ljava/util/ArrayList;
...
.method addEndpointDescriptor(Lcom/android/server/usb/descriptors/UsbEndpointDescriptor;)V
    ...
    iget-object v0, p0, mEndpointDescriptors:Ljava/util/ArrayList;
...
.method public getAlternateSetting()B
    ...
    iget-byte v0, p0, mAlternateSetting:B
...
.method public getNumEndpoints()B
    ...
    iget-byte v0, p0, mNumEndpoints:B
...
.method public parseRawDescriptors(Lcom/android/server/usb/descriptors/ByteStream;)I
    ...
    iput v0, p0, mInterfaceNumber:I

    invoke-virtual {p1}, Lcom/android/server/usb/descriptors/ByteStream;->getByte()B

    move-result v0

    iput-byte v0, p0, mAlternateSetting:B

    invoke-virtual {p1}, Lcom/android/server/usb/descriptors/ByteStream;->getByte()B

    move-result v0

    iput-byte v0, p0, mNumEndpoints:B

    invoke-virtual {p1}, Lcom/android/server/usb/descriptors/ByteStream;->getUnsignedByte()I

    move-result v0

    iput v0, p0, mUsbClass:I

    invoke-virtual {p1}, Lcom/android/server/usb/descriptors/ByteStream;->getUnsignedByte()I

    move-result v0

    iput v0, p0, mUsbSubclass:I
...
.method public report(Lcom/android/server/usb/descriptors/report/ReportCanvas;)V
    ...
    invoke-virtual {p0}, getUsbClass()I

    move-result v0

    invoke-virtual {p0}, getUsbSubclass()I

    move-result v1

    invoke-virtual {p0}, getProtocol()I
    ...
    invoke-virtual {p0}, getInterfaceNumber()I
    ...
    invoke-virtual {p0}, getNumEndpoints()B
...
.method toAndroid(Lcom/android/server/usb/descriptors/UsbDescriptorParser;)Landroid/hardware/usb/UsbInterface;
    ...
    iget v2, p0, mInterfaceNumber:I

    iget-byte v3, p0, mAlternateSetting:B

    iget v5, p0, mUsbClass:I

    iget v6, p0, mUsbSubclass:I

    iget v7, p0, mProtocol:I
    ...
    iget-object v2, p0, mEndpointDescriptors:Ljava/util/ArrayList;
    ...
    :goto_0
    iget-object v4, p0, mEndpointDescriptors:Ljava/util/ArrayList;
