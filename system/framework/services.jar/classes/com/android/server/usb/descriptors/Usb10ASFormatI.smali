...
.method public getBitDepths()[I
    ...
    iget-byte v1, p0, mBitResolution:B
...
.method public getBitResolution()B
    ...
    iget-byte v0, p0, mBitResolution:B
...
.method public getChannelCounts()[I
    ...
    iget-byte v1, p0, mNumChannels:B
...
.method public getSampleFreqType()B
    ...
    iget-byte v0, p0, mSampleFreqType:B
...
.method public getSubframeSize()B
    ...
    iget-byte v0, p0, mSubframeSize:B
...
.method public parseRawDescriptors(Lcom/android/server/usb/descriptors/ByteStream;)I
    ...
    iput-byte v0, p0, mSubframeSize:B

    invoke-virtual {p1}, Lcom/android/server/usb/descriptors/ByteStream;->getByte()B

    move-result v0

    iput-byte v0, p0, mBitResolution:B

    invoke-virtual {p1}, Lcom/android/server/usb/descriptors/ByteStream;->getByte()B

    move-result v0

    iput-byte v0, p0, mSampleFreqType:B
    ...
    :goto_0
    iget-byte v1, p0, mSampleFreqType:B
...
.method public report(Lcom/android/server/usb/descriptors/report/ReportCanvas;)V
    ...
    invoke-virtual {p0}, getSubframeSize()B
    ...
    invoke-virtual {p0}, getBitResolution()B
    ...
    invoke-virtual {p0}, getSampleFreqType()B

    move-result v0

    invoke-virtual {p0}, getSampleRates()[I
