...
.method constructor <init>(Landroid/content/Context;Landroid/os/UserHandle;Lcom/android/server/usb/UsbSettingsManager;Lcom/android/server/usb/UsbHandlerManager;)V
    ...
    iput-object v0, p0, mDevicePreferenceMap:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, mAccessoryPreferenceMap:Ljava/util/HashMap;
    ...
    iput-object v0, p0, mPackageMonitor:Lcom/android/server/usb/UsbProfileGroupSettingsManager$MyPackageMonitor;
    ...
    iput-object p3, p0, mSettingsManager:Lcom/android/server/usb/UsbSettingsManager;
    ...
    iput-object p2, p0, mParentUser:Landroid/os/UserHandle;
    ...
    iput-object v2, p0, mSettingsFile:Landroid/util/AtomicFile;
    ...
    iput-boolean v2, p0, mDisablePermissionDialogs:Z
    ...
    iget-object v2, p0, mPackageMonitor:Lcom/android/server/usb/UsbProfileGroupSettingsManager$MyPackageMonitor;
    ...
    iput-object v1, p0, mMtpNotificationManager:Lcom/android/server/usb/MtpNotificationManager;

    iput-object p4, p0, mUsbHandlerManager:Lcom/android/server/usb/UsbHandlerManager;
...
.method static synthetic access$000(Lcom/android/server/usb/UsbProfileGroupSettingsManager;)Landroid/os/UserHandle;
    ...
    iget-object v0, p0, mParentUser:Landroid/os/UserHandle;
...
.method static synthetic access$300(Lcom/android/server/usb/UsbProfileGroupSettingsManager;Lcom/android/server/usb/UsbProfileGroupSettingsManager$UserPackage;)V
    ...
    invoke-direct {p0, p1}, handlePackageAdded(Lcom/android/server/usb/UsbProfileGroupSettingsManager$UserPackage;)V
...
.method private clearCompatibleMatchesLocked(Lcom/android/server/usb/UsbProfileGroupSettingsManager$UserPackage;Landroid/hardware/usb/AccessoryFilter;)Z
    ...
    iget-object v1, p0, mAccessoryPreferenceMap:Ljava/util/HashMap;
...
.method private clearCompatibleMatchesLocked(Lcom/android/server/usb/UsbProfileGroupSettingsManager$UserPackage;Landroid/hardware/usb/DeviceFilter;)Z
    ...
    iget-object v1, p0, mDevicePreferenceMap:Ljava/util/HashMap;
...
.method private clearPackageDefaultsLocked(Lcom/android/server/usb/UsbProfileGroupSettingsManager$UserPackage;)Z
    ...
    iget-object v6, p0, mDevicePreferenceMap:Ljava/util/HashMap;
...
.method private getAccessoryMatchesLocked(Landroid/hardware/usb/UsbAccessory;Landroid/content/Intent;)Ljava/util/ArrayList;
    ...
    invoke-direct {p0, p2}, queryIntentActivitiesForAllProfiles(Landroid/content/Intent;)Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v4, v5, p1}, packageMatchesLocked(Landroid/content/pm/ResolveInfo;Landroid/hardware/usb/UsbDevice;Landroid/hardware/usb/UsbAccessory;)Z
    ...
    :cond_1
    invoke-direct {p0, v0}, preferHighPriority(Ljava/util/ArrayList;)Ljava/util/ArrayList;

    move-result-object v3

    invoke-direct {p0, v3}, removeForwardIntentIfNotNeeded(Ljava/util/ArrayList;)Ljava/util/ArrayList;
...
.method private getDefaultActivityLocked(Ljava/util/ArrayList;Lcom/android/server/usb/UsbProfileGroupSettingsManager$UserPackage;)Landroid/content/pm/ActivityInfo;
    ...
    iget-boolean v3, p0, mDisablePermissionDialogs:Z
...
.method private getDeviceMatchesLocked(Landroid/hardware/usb/UsbDevice;Landroid/content/Intent;)Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v4, p1, v5}, packageMatchesLocked(Landroid/content/pm/ResolveInfo;Landroid/hardware/usb/UsbDevice;Landroid/hardware/usb/UsbAccessory;)Z
...
.method private handlePackageAdded(Lcom/android/server/usb/UsbProfileGroupSettingsManager$UserPackage;)V
    ...
    invoke-direct {p0, p1, v5, v6}, handlePackageAddedLocked(Lcom/android/server/usb/UsbProfileGroupSettingsManager$UserPackage;Landroid/content/pm/ActivityInfo;Ljava/lang/String;)Z
    ...
    invoke-direct {p0}, scheduleWriteSettingsLocked()V
...
.method private handlePackageAddedLocked(Lcom/android/server/usb/UsbProfileGroupSettingsManager$UserPackage;Landroid/content/pm/ActivityInfo;Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1, v3}, clearCompatibleMatchesLocked(Lcom/android/server/usb/UsbProfileGroupSettingsManager$UserPackage;Landroid/hardware/usb/DeviceFilter;)Z
    ...
    invoke-direct {p0, p1, v3}, clearCompatibleMatchesLocked(Lcom/android/server/usb/UsbProfileGroupSettingsManager$UserPackage;Landroid/hardware/usb/AccessoryFilter;)Z
...
.method private packageMatchesLocked(Landroid/content/pm/ResolveInfo;Landroid/hardware/usb/UsbDevice;Landroid/hardware/usb/UsbAccessory;)Z
    ...
    invoke-direct {p0, p1}, isForwardMatch(Landroid/content/pm/ResolveInfo;)Z
    ...
    invoke-static {v0, p1}, getDeviceFilters(Landroid/content/pm/PackageManager;Landroid/content/pm/ResolveInfo;)Ljava/util/ArrayList;
    ...
    invoke-static {v0, p1}, getAccessoryFilters(Landroid/content/pm/PackageManager;Landroid/content/pm/ResolveInfo;)Ljava/util/ArrayList;
...
.method private preferHighPriority(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v5}, isForwardMatch(Landroid/content/pm/ResolveInfo;)Z
...
.method private queryIntentActivitiesForAllProfiles(Landroid/content/Intent;)Ljava/util/ArrayList;
    ...
    iget-object v1, p0, mParentUser:Landroid/os/UserHandle;
...
.method private readSettingsLocked()V
    ...
    :try_start_0
    iget-object v1, p0, mSettingsFile:Landroid/util/AtomicFile;
...
.method private removeForwardIntentIfNotNeeded(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v4}, isForwardMatch(Landroid/content/pm/ResolveInfo;)Z
    ...
    iget-object v6, p0, mParentUser:Landroid/os/UserHandle;
...
.method private resolveActivity(Landroid/content/Intent;Landroid/hardware/usb/UsbDevice;Z)V
    ...
    :try_start_0
    invoke-direct {p0, p2, p1}, getDeviceMatchesLocked(Landroid/hardware/usb/UsbDevice;Landroid/content/Intent;)Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v1, v2}, getDefaultActivityLocked(Ljava/util/ArrayList;Lcom/android/server/usb/UsbProfileGroupSettingsManager$UserPackage;)Landroid/content/pm/ActivityInfo;
    ...
    :cond_1
    iget-object v2, p0, mMtpNotificationManager:Lcom/android/server/usb/MtpNotificationManager;
    ...
    invoke-direct/range {v2 .. v7}, resolveActivity(Landroid/content/Intent;Ljava/util/ArrayList;Landroid/content/pm/ActivityInfo;Landroid/hardware/usb/UsbDevice;Landroid/hardware/usb/UsbAccessory;)V
...
.method private resolveActivity(Landroid/content/Intent;Ljava/util/ArrayList;Landroid/content/pm/ActivityInfo;Landroid/hardware/usb/UsbDevice;Landroid/hardware/usb/UsbAccessory;)V
    ...
    iget-object v0, p0, mUsbHandlerManager:Lcom/android/server/usb/UsbHandlerManager;
...
.method private scheduleWriteSettingsLocked()V
    ...
    iget-boolean v0, p0, mIsWriteSettingsScheduled:Z
    ...
    iput-boolean v0, p0, mIsWriteSettingsScheduled:Z
...
.method private upgradeSingleUserLocked()V
    ...
    sget-object v0, sSingleUserSettingsFile:Ljava/io/File;
    ...
    sget-object v2, sSingleUserSettingsFile:Ljava/io/File;
    ...
    sget-object v1, sSingleUserSettingsFile:Ljava/io/File;
...
.method public accessoryAttached(Landroid/hardware/usb/UsbAccessory;)V
    ...
    :try_start_0
    invoke-direct {p0, p1, v0}, getAccessoryMatchesLocked(Landroid/hardware/usb/UsbAccessory;Landroid/content/Intent;)Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v8, v2}, getDefaultActivityLocked(Ljava/util/ArrayList;Lcom/android/server/usb/UsbProfileGroupSettingsManager$UserPackage;)Landroid/content/pm/ActivityInfo;
...
.method clearDefaults(Ljava/lang/String;Landroid/os/UserHandle;)V
    ...
    :try_start_0
    invoke-direct {p0, v0}, clearPackageDefaultsLocked(Lcom/android/server/usb/UsbProfileGroupSettingsManager$UserPackage;)Z
...
.method public deviceAttached(Landroid/hardware/usb/UsbDevice;)V
    ...
    invoke-static {p1}, createDeviceAttachedIntent(Landroid/hardware/usb/UsbDevice;)Landroid/content/Intent;
    ...
    invoke-direct {p0, v0, p1, v1}, resolveActivity(Landroid/content/Intent;Landroid/hardware/usb/UsbDevice;Z)V
...
.method public deviceAttachedForFixedHandler(Landroid/hardware/usb/UsbDevice;Landroid/content/ComponentName;)V
    ...
    iget-object v4, p0, mParentUser:Landroid/os/UserHandle;
    ...
    iget-object v2, p0, mSettingsManager:Lcom/android/server/usb/UsbSettingsManager;
...
.method public dump(Lcom/android/internal/util/dump/DualDumpOutputStream;Ljava/lang/String;J)V
    ...
    iget-object v8, v1, mParentUser:Landroid/os/UserHandle;
    ...
    iget-object v0, v1, mDevicePreferenceMap:Ljava/util/HashMap;
    ...
    iget-object v9, v1, mDevicePreferenceMap:Ljava/util/HashMap;
    ...
    :cond_0
    iget-object v0, v1, mAccessoryPreferenceMap:Ljava/util/HashMap;
    ...
    iget-object v13, v1, mAccessoryPreferenceMap:Ljava/util/HashMap;
...
.method public synthetic lambda$scheduleWriteSettingsLocked$1$UsbProfileGroupSettingsManager()V
    ...
    invoke-direct {p0, v7}, getSerial(Landroid/os/UserHandle;)I
    ...
    iput-boolean v2, p0, mIsWriteSettingsScheduled:Z
...
.method usbDeviceRemoved(Landroid/hardware/usb/UsbDevice;)V
    ...
    iget-object v0, p0, mMtpNotificationManager:Lcom/android/server/usb/MtpNotificationManager;
