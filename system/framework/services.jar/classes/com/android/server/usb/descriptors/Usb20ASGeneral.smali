...
.method public getChannelNames()B
    ...
    iget-byte v0, p0, mChannelNames:B
...
.method public getNumChannels()B
    ...
    iget-byte v0, p0, mNumChannels:B
...
.method public getTerminalLink()B
    ...
    iget-byte v0, p0, mTerminalLink:B
...
.method public parseRawDescriptors(Lcom/android/server/usb/descriptors/ByteStream;)I
    ...
    iput-byte v0, p0, mTerminalLink:B

    invoke-virtual {p1}, Lcom/android/server/usb/descriptors/ByteStream;->getByte()B

    move-result v0

    iput-byte v0, p0, mControls:B

    invoke-virtual {p1}, Lcom/android/server/usb/descriptors/ByteStream;->getByte()B

    move-result v0

    iput-byte v0, p0, mFormatType:B

    invoke-virtual {p1}, Lcom/android/server/usb/descriptors/ByteStream;->unpackUsbInt()I

    move-result v0

    iput v0, p0, mFormats:I

    invoke-virtual {p1}, Lcom/android/server/usb/descriptors/ByteStream;->getByte()B

    move-result v0

    iput-byte v0, p0, mNumChannels:B

    invoke-virtual {p1}, Lcom/android/server/usb/descriptors/ByteStream;->unpackUsbInt()I

    move-result v0

    iput v0, p0, mChannelConfig:I

    invoke-virtual {p1}, Lcom/android/server/usb/descriptors/ByteStream;->getByte()B

    move-result v0

    iput-byte v0, p0, mChannelNames:B
...
.method public report(Lcom/android/server/usb/descriptors/report/ReportCanvas;)V
    ...
    invoke-virtual {p0}, getTerminalLink()B
    ...
    invoke-virtual {p0}, getControls()B
    ...
    invoke-virtual {p0}, getFormats()I
    ...
    invoke-virtual {p0}, getNumChannels()B
    ...
    invoke-virtual {p0}, getChannelConfig()I
    ...
    invoke-virtual {p0}, getChannelNames()B
