...
.method constructor <init>(Landroid/content/Context;Landroid/os/UserHandle;Lcom/android/server/usb/UsbPermissionManager;)V
    ...
    iput-object v0, p0, mUserContext:Landroid/content/Context;
    :try_end_0
    ...
    iput-object p3, p0, mUsbPermissionManager:Lcom/android/server/usb/UsbPermissionManager;
...
.method private canBeDefault(Landroid/hardware/usb/UsbAccessory;Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p2}, getPackageActivities(Ljava/lang/String;)[Landroid/content/pm/ActivityInfo;
...
.method private requestPermissionDialog(Landroid/hardware/usb/UsbDevice;Landroid/hardware/usb/UsbAccessory;ZLjava/lang/String;Landroid/app/PendingIntent;I)V
    ...
    iget-object v2, v1, mUsbPermissionManager:Lcom/android/server/usb/UsbPermissionManager;

    iget-object v8, v1, mUserContext:Landroid/content/Context;
...
.method public checkPermission(Landroid/hardware/usb/UsbAccessory;I)V
    ...
    invoke-virtual {p0, p1, p2}, hasPermission(Landroid/hardware/usb/UsbAccessory;I)Z
...
.method public checkPermission(Landroid/hardware/usb/UsbDevice;Ljava/lang/String;I)V
    ...
    invoke-virtual {p0, p1, p2, p3}, hasPermission(Landroid/hardware/usb/UsbDevice;Ljava/lang/String;I)Z
...
.method public dump(Lcom/android/internal/util/dump/DualDumpOutputStream;Ljava/lang/String;J)V
    ...
    iget-object v8, v1, mUser:Landroid/os/UserHandle;
    ...
    iget-object v0, v1, mUsbPermissionManager:Lcom/android/server/usb/UsbPermissionManager;
    ...
    invoke-virtual {v1, v0}, queryIntentActivities(Landroid/content/Intent;)Ljava/util/List;
    ...
    invoke-virtual {v1, v7}, queryIntentActivities(Landroid/content/Intent;)Ljava/util/List;
    ...
    iget-object v13, v1, mPackageManager:Landroid/content/pm/PackageManager;
...
.method public grantAccessoryPermission(Landroid/hardware/usb/UsbAccessory;I)V
    ...
    iget-object v0, p0, mUsbPermissionManager:Lcom/android/server/usb/UsbPermissionManager;
...
.method public hasPermission(Landroid/hardware/usb/UsbDevice;Ljava/lang/String;I)Z
    ...
    invoke-direct {p0, p1}, isCameraDevicePresent(Landroid/hardware/usb/UsbDevice;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-direct {p0, p2, p3}, isCameraPermissionGranted(Ljava/lang/String;I)Z
...
.method queryIntentActivities(Landroid/content/Intent;)Ljava/util/List;
    ...
    iget-object v1, p0, mUser:Landroid/os/UserHandle;
...
.method public requestPermission(Landroid/hardware/usb/UsbAccessory;Ljava/lang/String;Landroid/app/PendingIntent;I)V
    ...
    invoke-virtual {p0, p1, p4}, hasPermission(Landroid/hardware/usb/UsbAccessory;I)Z
    ...
    invoke-direct {p0, p1, p2}, canBeDefault(Landroid/hardware/usb/UsbAccessory;Ljava/lang/String;)Z
    ...
    invoke-direct/range {v2 .. v8}, requestPermissionDialog(Landroid/hardware/usb/UsbDevice;Landroid/hardware/usb/UsbAccessory;ZLjava/lang/String;Landroid/app/PendingIntent;I)V
...
.method public requestPermission(Landroid/hardware/usb/UsbDevice;Ljava/lang/String;Landroid/app/PendingIntent;I)V
    ...
    invoke-virtual {p0, p1, p2, p4}, hasPermission(Landroid/hardware/usb/UsbDevice;Ljava/lang/String;I)Z
    ...
    invoke-direct {p0, p2, p4}, isCameraPermissionGranted(Ljava/lang/String;I)Z
    ...
    invoke-direct {p0, p1, p2}, canBeDefault(Landroid/hardware/usb/UsbDevice;Ljava/lang/String;)Z
