...
.method private constructor <init>(III)V
    ...
    iput-object v0, p0, mCallback:Landroid/media/midi/MidiDeviceServer$Callback;
    ...
    iput-object v1, p0, mInputPortReceivers:[Lcom/android/server/usb/UsbMidiDevice$InputReceiverProxy;
...
.method private closeLocked()V
    ...
    iget-object v0, p0, mFileDescriptors:[Ljava/io/FileDescriptor;

    invoke-direct {p0, v0}, nativeClose([Ljava/io/FileDescriptor;)V
...
.method public static create(Landroid/content/Context;Landroid/os/Bundle;II)Lcom/android/server/usb/UsbMidiDevice;
    ...
    invoke-direct {v3, p2, p3, v0}, <init>(III)V

    invoke-direct {v3, p0, p1}, register(Landroid/content/Context;Landroid/os/Bundle;)Z
...
.method private openLocked()Z
    ...
    :cond_0
    iput-object v0, p0, mFileDescriptors:[Ljava/io/FileDescriptor;
    ...
    iput-object v4, p0, mPollFDs:[Landroid/system/StructPollfd;

    new-array v4, v1, [Ljava/io/FileInputStream;

    iput-object v4, p0, mInputStreams:[Ljava/io/FileInputStream;
    ...
    iget-object v7, p0, mPollFDs:[Landroid/system/StructPollfd;

    aput-object v6, v7, v4

    iget-object v7, p0, mInputStreams:[Ljava/io/FileInputStream;
    ...
    iput-object v4, p0, mOutputStreams:[Ljava/io/FileOutputStream;

    new-array v4, v2, [Lcom/android/internal/midi/MidiEventScheduler;

    iput-object v4, p0, mEventSchedulers:[Lcom/android/internal/midi/MidiEventScheduler;
    ...
    iget-object v5, p0, mOutputStreams:[Ljava/io/FileOutputStream;
    ...
    iget-object v6, p0, mEventSchedulers:[Lcom/android/internal/midi/MidiEventScheduler;

    aput-object v5, v6, v4

    iget-object v6, p0, mInputPortReceivers:[Lcom/android/server/usb/UsbMidiDevice$InputReceiverProxy;
    ...
    :cond_2
    iget-object v4, p0, mServer:Landroid/media/midi/MidiDeviceServer;
    ...
    iget-object v6, p0, mOutputStreams:[Ljava/io/FileOutputStream;
...
.method private register(Landroid/content/Context;Landroid/os/Bundle;)Z
    ...
    iget-object v8, p0, mCallback:Landroid/media/midi/MidiDeviceServer$Callback;
