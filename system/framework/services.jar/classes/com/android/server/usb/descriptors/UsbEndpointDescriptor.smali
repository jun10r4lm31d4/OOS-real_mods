...
.method public getSyncAddress()B
    ...
    iget-byte v0, p0, mSyncAddress:B
...
.method public parseRawDescriptors(Lcom/android/server/usb/descriptors/ByteStream;)I
    ...
    iput v0, p0, mEndpointAddress:I

    invoke-virtual {p1}, Lcom/android/server/usb/descriptors/ByteStream;->getUnsignedByte()I

    move-result v0

    iput v0, p0, mAttributes:I

    invoke-virtual {p1}, Lcom/android/server/usb/descriptors/ByteStream;->unpackUsbShort()I

    move-result v0

    iput v0, p0, mPacketSize:I
    ...
    iput-byte v0, p0, mRefresh:B

    invoke-virtual {p1}, Lcom/android/server/usb/descriptors/ByteStream;->getByte()B

    move-result v0

    iput-byte v0, p0, mSyncAddress:B
...
.method public report(Lcom/android/server/usb/descriptors/report/ReportCanvas;)V
    ...
    invoke-virtual {p0}, getEndpointAddress()I
    ...
    invoke-virtual {p0}, getAttributes()I
    ...
    invoke-virtual {p0}, getPacketSize()I
...
.method toAndroid(Lcom/android/server/usb/descriptors/UsbDescriptorParser;)Landroid/hardware/usb/UsbEndpoint;
    ...
    iget v1, p0, mEndpointAddress:I

    iget v2, p0, mAttributes:I

    iget v3, p0, mPacketSize:I

    iget v4, p0, mInterval:I
