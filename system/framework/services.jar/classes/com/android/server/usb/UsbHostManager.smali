...
.method static constructor <clinit>()V
    ...
    sput-object v0, sFormat:Ljava/text/SimpleDateFormat;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/usb/UsbAlsaManager;Lcom/android/server/usb/UsbSettingsManager;)V
    ...
    iput-object v0, p0, mConnections:Ljava/util/LinkedList;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, mConnected:Landroid/util/ArrayMap;
    ...
    invoke-virtual {p0, v1}, setUsbDeviceConnectionHandler(Landroid/content/ComponentName;)V
...
.method private addConnectionRecord(Ljava/lang/String;I[B)V
    ...
    iget v0, p0, mNumConnects:I

    add-int/lit8 v0, v0, 0x1

    iput v0, p0, mNumConnects:I

    :goto_0
    iget-object v0, p0, mConnections:Ljava/util/LinkedList;
    ...
    iget-object v1, p0, mConnections:Ljava/util/LinkedList;
    ...
    iput-object v0, p0, mLastConnect:Lcom/android/server/usb/UsbHostManager$ConnectionRecord;

    :cond_1
    if-nez p2, :cond_2

    iget-object v1, p0, mConnected:Landroid/util/ArrayMap;
...
.method private checkUsbInterfacesBlackListed(Lcom/android/server/usb/descriptors/UsbDescriptorParser;)Z
    ...
    invoke-direct {p0, v4, v5}, isBlackListed(II)Z
...
.method private getCurrentUserSettings()Lcom/android/server/usb/UsbProfileGroupSettingsManager;
    ...
    :try_start_0
    iget-object v1, p0, mCurrentSettings:Lcom/android/server/usb/UsbProfileGroupSettingsManager;
...
.method private getUsbDeviceConnectionHandler()Landroid/content/ComponentName;
    ...
    iget-object v0, p0, mHandlerLock:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, mUsbDeviceConnectionHandler:Landroid/content/ComponentName;
...
.method private isBlackListed(Ljava/lang/String;)Z
    ...
    iget-object v0, p0, mHostBlacklist:[Ljava/lang/String;
...
.method private usbDeviceAdded(Ljava/lang/String;II[B)Z
    ...
    invoke-direct {v1, v3, v5}, isBlackListed(II)Z
    ...
    invoke-direct {v1, v7}, checkUsbInterfacesBlackListed(Lcom/android/server/usb/descriptors/UsbDescriptorParser;)Z
    ...
    :cond_2
    invoke-direct {v1, v7}, logUsbDevice(Lcom/android/server/usb/descriptors/UsbDescriptorParser;)V
    ...
    :try_start_0
    iget-object v0, v1, mDevices:Ljava/util/HashMap;
    ...
    invoke-direct {v1, v2, v4, v9}, addConnectionRecord(Ljava/lang/String;I[B)V
    ...
    iget-object v11, v1, mSettingsManager:Lcom/android/server/usb/UsbSettingsManager;
    ...
    iget-object v11, v1, mDevices:Ljava/util/HashMap;
    ...
    invoke-direct/range {p0 .. p0}, getUsbDeviceConnectionHandler()Landroid/content/ComponentName;

    move-result-object v11

    if-nez v11, :cond_5

    invoke-direct/range {p0 .. p0}, getCurrentUserSettings()Lcom/android/server/usb/UsbProfileGroupSettingsManager;
    ...
    :goto_0
    iget-object v12, v1, mUsbAlsaManager:Lcom/android/server/usb/UsbAlsaManager;
    ...
    invoke-direct {v1, v2, v4, v12}, addConnectionRecord(Ljava/lang/String;I[B)V
...
.method private usbDeviceRemoved(Ljava/lang/String;)V
    ...
    iget-object v4, v1, mUsbAlsaManager:Lcom/android/server/usb/UsbAlsaManager;

    invoke-virtual {v4, v2}, Lcom/android/server/usb/UsbAlsaManager;->usbDeviceRemoved(Ljava/lang/String;)V

    iget-object v4, v1, mSettingsManager:Lcom/android/server/usb/UsbSettingsManager;
    ...
    iget-object v4, v1, mConnected:Landroid/util/ArrayMap;
    ...
    invoke-direct {v1, v2, v5, v6}, addConnectionRecord(Ljava/lang/String;I[B)V
...
.method public dump(Lcom/android/internal/util/dump/DualDumpOutputStream;Ljava/lang/String;J)V
    ...
    :try_start_0
    iget-object v3, p0, mUsbDeviceConnectionHandler:Landroid/content/ComponentName;
    ...
    iget-object v6, p0, mUsbDeviceConnectionHandler:Landroid/content/ComponentName;
    ...
    iget-object v8, p0, mDevices:Ljava/util/HashMap;
...
.method public dumpDescriptors(Lcom/android/internal/util/IndentingPrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v0, p0, mLastConnect:Lcom/android/server/usb/UsbHostManager$ConnectionRecord;
...
.method public setCurrentUserSettings(Lcom/android/server/usb/UsbProfileGroupSettingsManager;)V
    ...
    :try_start_0
    iput-object p1, p0, mCurrentSettings:Lcom/android/server/usb/UsbProfileGroupSettingsManager;
...
.method public setUsbDeviceConnectionHandler(Landroid/content/ComponentName;)V
    ...
    :try_start_0
    iput-object p1, p0, mUsbDeviceConnectionHandler:Landroid/content/ComponentName;
