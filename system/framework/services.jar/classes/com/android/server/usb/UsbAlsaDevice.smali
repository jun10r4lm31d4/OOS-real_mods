...
.method public constructor <init>(Landroid/media/IAudioService;IILjava/lang/String;ZZZZ)V
    ...
    iput-object p1, p0, mAudioService:Landroid/media/IAudioService;

    iput p2, p0, mCardNum:I

    iput p3, p0, mDeviceNum:I

    iput-object p4, p0, mDeviceAddress:Ljava/lang/String;

    iput-boolean p5, p0, mHasOutput:Z

    iput-boolean p6, p0, mHasInput:Z

    iput-boolean p7, p0, mIsInputHeadset:Z

    iput-boolean p8, p0, mIsOutputHeadset:Z
...
.method private declared-synchronized isInputJackConnected()Z
    ...
    :try_start_0
    iget-object v0, p0, mJackDetector:Lcom/android/server/usb/UsbAlsaJackDetector;
    :try_end_0
...
.method private declared-synchronized startJackDetect()V
    ...
    iput-object v0, p0, mJackDetector:Lcom/android/server/usb/UsbAlsaJackDetector;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized dump(Lcom/android/internal/util/dump/DualDumpOutputStream;Ljava/lang/String;J)V
    ...
    iget-boolean v5, p0, mHasOutput:Z
    ...
    iget-boolean v5, p0, mHasInput:Z
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget v3, v0, mCardNum:I

    if-ne v2, v3, :cond_1

    iget v2, p0, mDeviceNum:I

    iget v3, v0, mDeviceNum:I

    if-ne v2, v3, :cond_1

    iget-boolean v2, p0, mHasOutput:Z

    iget-boolean v3, v0, mHasOutput:Z

    if-ne v2, v3, :cond_1

    iget-boolean v2, p0, mHasInput:Z

    iget-boolean v3, v0, mHasInput:Z

    if-ne v2, v3, :cond_1

    iget-boolean v2, p0, mIsInputHeadset:Z

    iget-boolean v3, v0, mIsInputHeadset:Z

    if-ne v2, v3, :cond_1

    iget-boolean v2, p0, mIsOutputHeadset:Z

    iget-boolean v3, v0, mIsOutputHeadset:Z
...
.method public getAlsaCardDeviceString()Ljava/lang/String;
    ...
    iget v0, p0, mCardNum:I

    if-ltz v0, :cond_1

    iget v1, p0, mDeviceNum:I
...
.method public hasInput()Z
    ...
    iget-boolean v0, p0, mHasInput:Z
...
.method public hasOutput()Z
    ...
    iget-boolean v0, p0, mHasOutput:Z
...
.method public hashCode()I
    ...
    iget v3, p0, mCardNum:I

    add-int/2addr v2, v3

    mul-int/lit8 v1, v2, 0x1f

    iget v3, p0, mDeviceNum:I

    add-int/2addr v1, v3

    mul-int/lit8 v2, v1, 0x1f

    iget-boolean v3, p0, mHasOutput:Z
    ...
    iget-boolean v3, p0, mHasInput:Z
    ...
    iget-boolean v3, p0, mIsInputHeadset:Z
    ...
    iget-boolean v3, p0, mIsOutputHeadset:Z
...
.method public isInputHeadset()Z
    ...
    iget-boolean v0, p0, mIsInputHeadset:Z
...
.method public isOutputHeadset()Z
    ...
    iget-boolean v0, p0, mIsOutputHeadset:Z
...
.method declared-synchronized setDeviceNameAndDescription(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p2, p0, mDeviceDescription:Ljava/lang/String;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized start()V
    ...
    iput v1, p0, mInputState:I

    iput v1, p0, mOutputState:I

    invoke-direct {p0}, startJackDetect()V

    invoke-virtual {p0, v0}, updateWiredDeviceConnectionState(Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized stop()V
    ...
    :try_start_0
    invoke-direct {p0}, stopJackDetect()V
...
.method public declared-synchronized toString()Ljava/lang/String;
    ...
    iget-boolean v1, p0, mHasOutput:Z
    ...
    iget-boolean v1, p0, mHasInput:Z
...
.method public declared-synchronized updateWiredDeviceConnectionState(Z)V
    ...
    :cond_0
    :try_start_1
    invoke-virtual {p0}, getAlsaCardDeviceString()Ljava/lang/String;
    ...
    iget-boolean v1, p0, mIsOutputHeadset:Z
    ...
    invoke-direct {p0}, isOutputJackConnected()Z
    ...
    iget v1, p0, mOutputState:I

    if-eq v10, v1, :cond_4

    iput v10, p0, mOutputState:I
    ...
    iget-boolean v1, p0, mIsInputHeadset:Z
    ...
    invoke-direct {p0}, isInputJackConnected()Z
    ...
    :goto_3
    iget v1, p0, mInputState:I

    if-eq v7, v1, :cond_7

    iput v7, p0, mInputState:I
