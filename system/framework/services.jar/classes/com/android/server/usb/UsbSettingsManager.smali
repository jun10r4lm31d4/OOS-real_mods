...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mSettingsByUser:Landroid/util/SparseArray;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, mSettingsByProfileGroup:Landroid/util/SparseArray;
    ...
    iput-object v0, p0, mUsbHandlerManager:Lcom/android/server/usb/UsbHandlerManager;
...
.method dump(Lcom/android/internal/util/dump/DualDumpOutputStream;Ljava/lang/String;J)V
    ...
    iget-object v2, p0, mSettingsByUser:Landroid/util/SparseArray;
    ...
    invoke-virtual {p0, v6}, getSettingsForUser(I)Lcom/android/server/usb/UsbUserSettingsManager;
    ...
    iget-object v3, p0, mSettingsByProfileGroup:Landroid/util/SparseArray;

    monitor-enter v3

    :try_start_1
    iget-object v2, p0, mSettingsByProfileGroup:Landroid/util/SparseArray;
    ...
    iget-object v5, p0, mSettingsByProfileGroup:Landroid/util/SparseArray;
...
.method getSettingsForProfileGroup(Landroid/os/UserHandle;)Lcom/android/server/usb/UsbProfileGroupSettingsManager;
    ...
    iget-object v6, p0, mUsbHandlerManager:Lcom/android/server/usb/UsbHandlerManager;
    ...
    iget-object v4, p0, mSettingsByProfileGroup:Landroid/util/SparseArray;
...
.method remove(Landroid/os/UserHandle;)V
    ...
    iget-object v1, p0, mSettingsByProfileGroup:Landroid/util/SparseArray;

    monitor-enter v1

    :try_start_1
    iget-object v0, p0, mSettingsByProfileGroup:Landroid/util/SparseArray;
