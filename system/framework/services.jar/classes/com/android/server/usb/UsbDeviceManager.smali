...
.method static constructor <clinit>()V
    ...
    sput-object v0, sBlackListedInterfaces:Ljava/util/Set;

    sget-object v0, sBlackListedInterfaces:Ljava/util/Set;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/usb/UsbAlsaManager;Lcom/android/server/usb/UsbSettingsManager;)V
    ...
    iput-object v0, v7, mLock:Ljava/lang/Object;

    move-object v8, p1

    iput-object v8, v7, mContext:Landroid/content/Context;

    invoke-virtual {p1}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v0

    iput-object v0, v7, mContentResolver:Landroid/content/ContentResolver;
    ...
    iput-boolean v0, v7, mHasUsbAccessory:Z
    ...
    iput-object v1, v7, mControlFds:Ljava/util/HashMap;

    const-string/jumbo v1, "mtp"

    invoke-direct {p0, v1}, nativeOpenControl(Ljava/lang/String;)Ljava/io/FileDescriptor;
    ...
    :cond_0
    iget-object v1, v7, mControlFds:Ljava/util/HashMap;
    ...
    iput-object v12, v7, mHandler:Lcom/android/server/usb/UsbDeviceManager$UsbHandler;
    ...
    iget-object v6, v7, mContext:Landroid/content/Context;
    ...
    iput-object v6, v7, mUEventObserver:Landroid/os/UEventObserver;

    iget-object v6, v7, mUEventObserver:Landroid/os/UEventObserver;
...
.method private startAccessoryMode()V
    ...
    iget-boolean v0, p0, mHasUsbAccessory:Z
    ...
    iput-object v0, p0, mAccessoryStrings:[Ljava/lang/String;
    ...
    :goto_0
    iget-object v3, p0, mAccessoryStrings:[Ljava/lang/String;
    ...
    invoke-virtual {p0, v2, v3}, setCurrentFunctions(J)V
...
.method getAccessoryStrings()[Ljava/lang/String;
    ...
    :try_start_0
    iget-object v1, p0, mAccessoryStrings:[Ljava/lang/String;
...
.method public getControlFd(J)Landroid/os/ParcelFileDescriptor;
    ...
    iget-object v0, p0, mControlFds:Ljava/util/HashMap;
...
.method public setCurrentUser(ILcom/android/server/usb/UsbProfileGroupSettingsManager;)V
    ...
    :try_start_0
    iput-object p2, p0, mCurrentSettings:Lcom/android/server/usb/UsbProfileGroupSettingsManager;
