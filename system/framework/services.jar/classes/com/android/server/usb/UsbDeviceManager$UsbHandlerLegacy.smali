...
.method constructor <init>(Landroid/os/Looper;Landroid/content/Context;Lcom/android/server/usb/UsbDeviceManager;Lcom/android/server/usb/UsbAlsaManager;Lcom/android/server/usb/UsbSettingsManager;)V
    ...
    :try_start_0
    invoke-direct {p0, p2}, readOemUsbOverrideConfig(Landroid/content/Context;)V

    const/4 v1, 0x0

    invoke-direct {p0, v1}, getPersistProp(Z)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p0, v2, v0}, getSystemProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    iput-object v2, p0, mCurrentOemFunctions:Ljava/lang/String;

    invoke-direct {p0}, isNormalBoot()Z
    ...
    :try_start_1
    invoke-virtual {p0, v4, v0}, getSystemProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    iput-object v2, p0, mCurrentFunctionsStr:Ljava/lang/String;

    iget-object v2, p0, mCurrentFunctionsStr:Ljava/lang/String;

    invoke-virtual {p0, v3, v0}, getSystemProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    invoke-direct {p0, v5}, getPersistProp(Z)Ljava/lang/String;
    ...
    iput-wide v2, p0, mCurrentFunctions:J

    iput-boolean v5, p0, mCurrentUsbFunctionsReceived:Z
    ...
    invoke-virtual {p0, v0}, updateState(Ljava/lang/String;)V
    :try_end_1
...
.method private applyOemOverrideFunction(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v0, p0, mOemModeMap:Ljava/util/HashMap;
    ...
    invoke-virtual {p0, v1, v0}, getSystemProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v2, p0, mOemModeMap:Ljava/util/HashMap;
    ...
    invoke-static {v5, v3}, addFunction(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, v4}, getPersistProp(Z)Ljava/lang/String;
    ...
    invoke-virtual {p0, v4, v3}, setSystemProperty(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v6, v3}, addFunction(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v3, v6}, setSystemProperty(Ljava/lang/String;Ljava/lang/String;)V
...
.method private readOemUsbOverrideConfig(Landroid/content/Context;)V
    ...
    :cond_0
    iget-object v6, p0, mOemModeMap:Ljava/util/HashMap;
    ...
    iput-object v6, p0, mOemModeMap:Ljava/util/HashMap;
    ...
    iget-object v8, p0, mOemModeMap:Ljava/util/HashMap;
...
.method private setUsbConfig(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0, p1}, setSystemProperty(Ljava/lang/String;Ljava/lang/String;)V
...
.method private trySetEnabledFunctions(JZ)Z
    ...
    :cond_0
    iput-wide p1, p0, mCurrentFunctions:J
    ...
    invoke-virtual {p0, v0}, applyAdbFunction(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v3, v2}, getSystemProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, v0}, applyOemOverrideFunction(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v5, p0, mCurrentFunctionsStr:Ljava/lang/String;
    ...
    invoke-virtual {p0, v5, v0}, setSystemProperty(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-wide v7, p0, mCurrentFunctions:J
    ...
    iget-object v7, p0, mCurrentOemFunctions:Ljava/lang/String;
    ...
    iget-boolean v7, p0, mCurrentFunctionsApplied:Z
    ...
    iget-object v5, p0, mCurrentOemFunctions:Ljava/lang/String;
    ...
    iget-boolean v5, p0, mCurrentFunctionsApplied:Z
    ...
    iput-object v0, p0, mCurrentFunctionsStr:Ljava/lang/String;

    iput-object v3, p0, mCurrentOemFunctions:Ljava/lang/String;

    iput-boolean v4, p0, mCurrentFunctionsApplied:Z

    invoke-direct {p0, v2}, setUsbConfig(Ljava/lang/String;)V

    invoke-direct {p0, v2}, waitForState(Ljava/lang/String;)Z
    ...
    :cond_7
    invoke-direct {p0, v3}, setUsbConfig(Ljava/lang/String;)V
    ...
    invoke-static {v0, v2}, containsFunction(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :cond_8
    iget-wide v5, p0, mCurrentFunctions:J

    invoke-virtual {p0, v5, v6}, getAppliedFunctions(J)J

    move-result-wide v5

    invoke-virtual {p0, v5, v6}, updateUsbStateBroadcastIfNeeded(J)V

    :cond_9
    invoke-direct {p0, v3}, waitForState(Ljava/lang/String;)Z
...
.method private waitForState(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v2, v3}, getSystemProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method protected applyAdbFunction(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, v1}, addFunction(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_1
    invoke-static {p1, v1}, removeFunction(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method protected setEnabledFunctions(JZ)V
    ...
    invoke-virtual {p0, p1, p2}, isUsbDataTransferActive(J)Z
    ...
    iget-boolean v1, p0, mUsbDataUnlocked:Z

    const/4 v2, 0x0

    if-eq v0, v1, :cond_0

    iput-boolean v0, p0, mUsbDataUnlocked:Z

    invoke-virtual {p0, v2}, updateUsbNotification(Z)V
    ...
    invoke-direct {p0, p1, p2, p3}, trySetEnabledFunctions(JZ)Z
    ...
    invoke-direct {p0, v3, v4, v2}, trySetEnabledFunctions(JZ)Z
    ...
    invoke-direct {p0, v5, v6, v2}, trySetEnabledFunctions(JZ)Z
