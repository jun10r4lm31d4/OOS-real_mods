...
.method private constructor <init>(Lcom/android/server/usb/UsbAlsaDevice;)V
    ...
    iput-boolean v0, p0, mStopJackDetect:Z

    iput-object p1, p0, mAlsaDevice:Lcom/android/server/usb/UsbAlsaDevice;
...
.method public static startJackDetect(Lcom/android/server/usb/UsbAlsaDevice;)Lcom/android/server/usb/UsbAlsaJackDetector;
    ...
    invoke-static {v0}, nativeHasJackDetect(I)Z
    ...
    invoke-direct {v0, p0}, <init>(Lcom/android/server/usb/UsbAlsaDevice;)V
...
.method public isInputJackConnected()Z
    ...
    iget-object v0, p0, mAlsaDevice:Lcom/android/server/usb/UsbAlsaDevice;

    invoke-virtual {v0}, Lcom/android/server/usb/UsbAlsaDevice;->getCardNum()I

    move-result v0

    invoke-direct {p0, v0}, nativeInputJackConnected(I)Z
...
.method public isOutputJackConnected()Z
    ...
    invoke-direct {p0, v0}, nativeOutputJackConnected(I)Z
...
.method public jackDetectCallback()Z
    ...
    :try_start_0
    iget-boolean v0, p0, mStopJackDetect:Z
...
.method public run()V
    ...
    invoke-direct {p0, v0}, nativeJackDetect(I)Z
