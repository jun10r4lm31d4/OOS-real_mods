...
.method constructor <init>(Landroid/os/Looper;Landroid/content/Context;Lcom/android/server/usb/UsbDeviceManager;Lcom/android/server/usb/UsbAlsaManager;Lcom/android/server/usb/UsbSettingsManager;)V
    ...
    iput-object p3, p0, mUsbDeviceManager:Lcom/android/server/usb/UsbDeviceManager;

    iput-object p4, p0, mUsbAlsaManager:Lcom/android/server/usb/UsbAlsaManager;

    iput-object p5, p0, mSettingsManager:Lcom/android/server/usb/UsbSettingsManager;
    ...
    iput-boolean v0, p0, mScreenLocked:Z

    iget-object v1, p0, mContext:Landroid/content/Context;

    invoke-virtual {p0, v1}, getPinnedSharedPrefs(Landroid/content/Context;)Landroid/content/SharedPreferences;

    move-result-object v1

    iput-object v1, p0, mSettings:Landroid/content/SharedPreferences;

    iget-object v1, p0, mSettings:Landroid/content/SharedPreferences;
    ...
    iput-wide v3, p0, mScreenUnlockedFunctions:J
    ...
    :goto_3
    iput-boolean v0, p0, mUseUsbNotification:Z
...
.method private isUsbStateChanged(Landroid/content/Intent;)Z
    ...
    iget-object v1, p0, mBroadcastedIntent:Landroid/content/Intent;
    ...
    iget-object v6, p0, mBroadcastedIntent:Landroid/content/Intent;
...
.method private notifyAccessoryModeExit()V
    ...
    invoke-virtual {p0, v0, v1, v2}, setEnabledFunctions(JZ)V
    ...
    iput-object v0, p0, mCurrentAccessory:Landroid/hardware/usb/UsbAccessory;
...
.method private setAdbEnabled(Z)V
    ...
    invoke-virtual {p0, v0, v1}, setSystemProperty(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_0
    iget-wide v0, p0, mCurrentFunctions:J
    ...
    invoke-virtual {p0, v0}, updateAdbNotification(Z)V
...
.method private setScreenUnlockedFunctions()V
    ...
    iget-wide v0, p0, mScreenUnlockedFunctions:J
...
.method private updateCurrentAccessory()V
    ...
    invoke-virtual {p0, v0}, hasMessages(I)Z

    move-result v0

    iget-boolean v1, p0, mConfigured:Z

    if-eqz v1, :cond_2

    if-eqz v0, :cond_2

    iget-object v1, p0, mUsbDeviceManager:Lcom/android/server/usb/UsbDeviceManager;
    ...
    iput-object v3, p0, mCurrentAccessory:Landroid/hardware/usb/UsbAccessory;
    ...
    iget-object v5, p0, mCurrentAccessory:Landroid/hardware/usb/UsbAccessory;
    ...
    iget-object v3, p0, mUsbDeviceManager:Lcom/android/server/usb/UsbDeviceManager;
    ...
    invoke-direct {p0}, notifyAccessoryModeExit()V
...
.method private updateMidiFunction()V
    ...
    :goto_0
    iget-boolean v3, p0, mMidiEnabled:Z
    ...
    iput v4, p0, mMidiCard:I

    invoke-virtual {v3}, Ljava/util/Scanner;->nextInt()I

    move-result v4

    iput v4, p0, mMidiDevice:I
    :try_end_0
    ...
    :cond_2
    :goto_3
    iput-boolean v0, p0, mMidiEnabled:Z

    :cond_3
    iget-object v3, p0, mUsbAlsaManager:Lcom/android/server/usb/UsbAlsaManager;

    iget-boolean v4, p0, mMidiEnabled:Z
    ...
    :goto_4
    iget v2, p0, mMidiCard:I

    iget v4, p0, mMidiDevice:I
...
.method public dump(Lcom/android/internal/util/dump/DualDumpOutputStream;Ljava/lang/String;J)V
    ...
    iget-wide v6, v8, mCurrentFunctions:J
    ...
    invoke-direct/range {v1 .. v7}, dumpFunctions(Lcom/android/internal/util/dump/DualDumpOutputStream;Ljava/lang/String;JJ)V

    iget-boolean v0, v8, mCurrentFunctionsApplied:Z
    ...
    iget-wide v6, v8, mScreenUnlockedFunctions:J
    ...
    iget-boolean v0, v8, mScreenLocked:Z
    ...
    iget-boolean v0, v8, mConnected:Z
    ...
    iget-boolean v0, v8, mConfigured:Z
    ...
    iget-object v0, v8, mCurrentAccessory:Landroid/hardware/usb/UsbAccessory;
    ...
    iget-boolean v2, v8, mHostConnected:Z
    ...
    iget-boolean v2, v8, mSourcePower:Z
    ...
    iget-boolean v2, v8, mSinkPower:Z
    ...
    iget-boolean v2, v8, mUsbCharging:Z
    ...
    iget-boolean v2, v8, mHideUsbNotification:Z
    ...
    iget-boolean v2, v8, mAudioAccessoryConnected:Z
...
.method protected finishBoot()V
    ...
    iget-boolean v0, p0, mCurrentUsbFunctionsReceived:Z
    ...
    iget-boolean v0, p0, mPendingBootBroadcast:Z

    const/4 v1, 0x0

    if-eqz v0, :cond_0

    iget-wide v2, p0, mCurrentFunctions:J

    invoke-virtual {p0, v2, v3}, getAppliedFunctions(J)J

    move-result-wide v2

    invoke-virtual {p0, v2, v3}, updateUsbStateBroadcastIfNeeded(J)V

    iput-boolean v1, p0, mPendingBootBroadcast:Z
    ...
    iget-wide v4, p0, mScreenUnlockedFunctions:J

    cmp-long v0, v4, v2

    if-eqz v0, :cond_1

    invoke-direct {p0}, setScreenUnlockedFunctions()V

    goto :goto_0

    :cond_1
    invoke-virtual {p0, v2, v3, v1}, setEnabledFunctions(JZ)V
    ...
    iget-object v0, p0, mUsbDeviceManager:Lcom/android/server/usb/UsbDeviceManager;
    ...
    :cond_2
    invoke-virtual {p0, v1}, updateUsbNotification(Z)V

    invoke-virtual {p0, v1}, updateAdbNotification(Z)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    :goto_0
    iget-boolean v1, p0, mScreenLocked:Z
    ...
    :goto_1
    iput-boolean v8, p0, mScreenLocked:Z
    ...
    invoke-virtual {p0, v5, v6, v7}, setEnabledFunctions(JZ)V
    ...
    iput-wide v2, p0, mScreenUnlockedFunctions:J

    iget-object v0, p0, mSettings:Landroid/content/SharedPreferences;
    ...
    iget-wide v2, p0, mScreenUnlockedFunctions:J
    ...
    :pswitch_2
    invoke-virtual {p0, v8}, updateAdbNotification(Z)V

    invoke-virtual {p0, v8}, updateUsbNotification(Z)V
    ...
    iput-boolean v7, p0, mHideUsbNotification:Z
    ...
    iput-boolean v8, p0, mHideUsbNotification:Z
    ...
    :cond_a
    invoke-virtual {p0, v7}, updateUsbNotification(Z)V
    ...
    :goto_7
    iput-boolean v8, p0, mUsbCharging:Z
    ...
    iget-boolean v1, p0, mHostConnected:Z
    ...
    :goto_8
    iput-boolean v5, p0, mHostConnected:Z
    ...
    :goto_9
    iput-boolean v5, p0, mSourcePower:Z
    ...
    :goto_a
    iput-boolean v5, p0, mSinkPower:Z
    ...
    :goto_b
    iput-boolean v5, p0, mAudioAccessoryConnected:Z

    invoke-virtual {v2, v4}, Landroid/hardware/usb/UsbPort;->isModeSupported(I)Z

    move-result v4

    iput-boolean v4, p0, mAudioAccessorySupported:Z
    ...
    :goto_c
    iput-boolean v4, p0, mSupportsAllCombinations:Z
    ...
    iget-boolean v4, p0, mHostConnected:Z
    ...
    :cond_12
    iget-wide v4, p0, mCurrentFunctions:J

    invoke-virtual {p0, v4, v5}, getAppliedFunctions(J)J

    move-result-wide v4

    invoke-virtual {p0, v4, v5}, updateUsbStateBroadcastIfNeeded(J)V

    goto/16 :goto_11

    :cond_13
    iput-boolean v8, p0, mPendingBootBroadcast:Z
    ...
    invoke-virtual {p0, v0, v1}, isUsbDataTransferActive(J)Z

    move-result v0

    if-eqz v0, :cond_1f

    invoke-virtual {p0}, isUsbTransferAllowed()Z

    move-result v0

    if-nez v0, :cond_1f

    invoke-virtual {p0, v5, v6, v8}, setEnabledFunctions(JZ)V
    ...
    iput-wide v5, p0, mScreenUnlockedFunctions:J
    ...
    iput-wide v0, p0, mScreenUnlockedFunctions:J
    ...
    :pswitch_9
    iput-boolean v8, p0, mBootCompleted:Z

    invoke-virtual {p0}, finishBoot()V
    ...
    :cond_15
    iput-boolean v8, p0, mSystemReady:Z
    ...
    invoke-virtual {p0, v0, v1, v7}, setEnabledFunctions(JZ)V
    ...
    :goto_e
    iput-boolean v0, p0, mConfigured:Z
    ...
    invoke-virtual {p0, v7}, updateAdbNotification(Z)V
    ...
    invoke-virtual {p0, v0, v1}, getAppliedFunctions(J)J

    move-result-wide v0

    invoke-virtual {p0, v0, v1}, updateUsbStateBroadcastIfNeeded(J)V
...
.method public sendMessageDelayed(IZJ)V
    ...
    invoke-virtual {p0, v0, p3, p4}, sendMessageDelayed(Landroid/os/Message;J)Z
...
.method protected updateAdbNotification(Z)V
    ...
    iget-object v1, v0, mNotificationManager:Landroid/app/NotificationManager;
    ...
    invoke-virtual/range {p0 .. p0}, isAdbEnabled()Z
    ...
    iget-boolean v3, v0, mConnected:Z
    ...
    invoke-virtual {v0, v3, v7}, getSystemProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-boolean v3, v0, mAdbNotificationShown:Z

    if-eqz v3, :cond_2

    iput-boolean v6, v0, mAdbNotificationShown:Z
    ...
    iput-boolean v12, v0, mAdbNotificationShown:Z

    iget-object v11, v0, mNotificationManager:Landroid/app/NotificationManager;
...
.method public updateState(Ljava/lang/String;)V
    ...
    :goto_1
    invoke-virtual {p0, v2, v3, v4}, sendMessageDelayed(Landroid/os/Message;J)Z
...
.method protected updateUsbNotification(Z)V
    ...
    iget-boolean v1, v0, mUseUsbNotification:Z
    ...
    invoke-virtual {v0, v1, v2}, getSystemProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    iget-boolean v1, v0, mHideUsbNotification:Z
    ...
    iget-boolean v1, v0, mSupportsAllCombinations:Z

    if-nez v1, :cond_2

    iget v1, v0, mUsbNotificationId:I

    if-eqz v1, :cond_1

    iget-object v5, v0, mNotificationManager:Landroid/app/NotificationManager;

    sget-object v6, Landroid/os/UserHandle;->ALL:Landroid/os/UserHandle;

    invoke-virtual {v5, v3, v1, v6}, Landroid/app/NotificationManager;->cancelAsUser(Ljava/lang/String;ILandroid/os/UserHandle;)V

    iput v4, v0, mUsbNotificationId:I
    ...
    iget-boolean v8, v0, mAudioAccessoryConnected:Z

    if-eqz v8, :cond_3

    iget-boolean v8, v0, mAudioAccessorySupported:Z
    ...
    :cond_3
    iget-boolean v8, v0, mConnected:Z

    if-eqz v8, :cond_b

    iget-wide v8, v0, mCurrentFunctions:J
    ...
    :cond_8
    :goto_0
    iget-boolean v8, v0, mSourcePower:Z
    ...
    :cond_c
    iget-boolean v8, v0, mHostConnected:Z

    if-eqz v8, :cond_d

    iget-boolean v8, v0, mSinkPower:Z

    if-eqz v8, :cond_d

    iget-boolean v8, v0, mUsbCharging:Z
    ...
    :cond_d
    :goto_1
    iget v8, v0, mUsbNotificationId:I
    ...
    iget-object v9, v0, mNotificationManager:Landroid/app/NotificationManager;
    ...
    iput v1, v0, mUsbNotificationId:I
...
.method protected updateUsbStateBroadcastIfNeeded(J)V
    ...
    iget-wide v3, p0, mCurrentFunctions:J

    invoke-virtual {p0, v3, v4}, isUsbDataTransferActive(J)Z
    ...
    :cond_1
    invoke-direct {p0, v0}, isUsbStateChanged(Landroid/content/Intent;)Z
    ...
    invoke-virtual {p0, v0}, sendStickyBroadcast(Landroid/content/Intent;)V

    iput-object v0, p0, mBroadcastedIntent:Landroid/content/Intent;
