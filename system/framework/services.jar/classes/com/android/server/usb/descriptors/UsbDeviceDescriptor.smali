...
.method constructor <init>(IB)V
    ...
    iput-object v0, p0, mConfigDescriptors:Ljava/util/ArrayList;
...
.method addConfigDescriptor(Lcom/android/server/usb/descriptors/UsbConfigDescriptor;)V
    ...
    iget-object v0, p0, mConfigDescriptors:Ljava/util/ArrayList;
...
.method public getProductIndex()B
    ...
    iget-byte v0, p0, mProductIndex:B
...
.method public getSerialIndex()B
    ...
    iget-byte v0, p0, mSerialIndex:B
...
.method public parseRawDescriptors(Lcom/android/server/usb/descriptors/ByteStream;)I
    ...
    iput v0, p0, mDevClass:I

    invoke-virtual {p1}, Lcom/android/server/usb/descriptors/ByteStream;->getUnsignedByte()I

    move-result v0

    iput v0, p0, mDevSubClass:I
    ...
    iput v0, p0, mDeviceRelease:I

    invoke-virtual {p1}, Lcom/android/server/usb/descriptors/ByteStream;->getByte()B

    move-result v0

    iput-byte v0, p0, mMfgIndex:B

    invoke-virtual {p1}, Lcom/android/server/usb/descriptors/ByteStream;->getByte()B

    move-result v0

    iput-byte v0, p0, mProductIndex:B

    invoke-virtual {p1}, Lcom/android/server/usb/descriptors/ByteStream;->getByte()B

    move-result v0

    iput-byte v0, p0, mSerialIndex:B

    invoke-virtual {p1}, Lcom/android/server/usb/descriptors/ByteStream;->getByte()B

    move-result v0

    iput-byte v0, p0, mNumConfigs:B
...
.method public report(Lcom/android/server/usb/descriptors/report/ReportCanvas;)V
    ...
    invoke-virtual {p0}, getDevClass()I
    ...
    invoke-virtual {p0}, getDevSubClass()I
    ...
    invoke-virtual {p0}, getProductID()I
    ...
    invoke-virtual {p0}, getDeviceRelease()I
    ...
    invoke-virtual {p0}, getMfgIndex()B
    ...
    invoke-virtual {p0}, getProductIndex()B
...
.method public toAndroid(Lcom/android/server/usb/descriptors/UsbDescriptorParser;)Landroid/hardware/usb/UsbDevice$Builder;
    ...
    invoke-virtual/range {p0 .. p1}, getMfgString(Lcom/android/server/usb/descriptors/UsbDescriptorParser;)Ljava/lang/String;

    move-result-object v13

    invoke-virtual/range {p0 .. p1}, getProductString(Lcom/android/server/usb/descriptors/UsbDescriptorParser;)Ljava/lang/String;

    move-result-object v14

    invoke-virtual/range {p0 .. p0}, getDeviceReleaseString()Ljava/lang/String;

    move-result-object v15

    invoke-virtual/range {p0 .. p1}, getSerialString(Lcom/android/server/usb/descriptors/UsbDescriptorParser;)Ljava/lang/String;

    move-result-object v16

    iget-object v1, v0, mConfigDescriptors:Ljava/util/ArrayList;
    ...
    :goto_0
    iget-object v2, v0, mConfigDescriptors:Ljava/util/ArrayList;
    ...
    iget v3, v0, mVendorID:I

    iget v4, v0, mProductID:I

    iget v5, v0, mDevClass:I

    iget v6, v0, mDevSubClass:I

    iget v7, v0, mProtocol:I
