...
.method constructor <init>(Landroid/os/Looper;Landroid/content/Context;Lcom/android/server/usb/UsbDeviceManager;Lcom/android/server/usb/UsbAlsaManager;Lcom/android/server/usb/UsbSettingsManager;)V
    ...
    iput-object v0, p0, mGadgetProxyLock:Ljava/lang/Object;

    const/4 v0, 0x0

    iput v0, p0, mCurrentRequest:I
    ...
    :cond_0
    iget-object v3, p0, mGadgetProxyLock:Ljava/lang/Object;
    ...
    iput-object v5, p0, mGadgetProxy:Landroid/hardware/usb/gadget/V1_0/IUsbGadget;

    iget-object v5, p0, mGadgetProxy:Landroid/hardware/usb/gadget/V1_0/IUsbGadget;
    ...
    iput-wide v5, p0, mCurrentFunctions:J

    iput-boolean v4, p0, mCurrentUsbFunctionsRequested:Z

    iget-object v4, p0, mGadgetProxy:Landroid/hardware/usb/gadget/V1_0/IUsbGadget;
...
.method static synthetic access$500(Lcom/android/server/usb/UsbDeviceManager$UsbHandlerHal;)Ljava/lang/Object;
    ...
    iget-object v0, p0, mGadgetProxyLock:Ljava/lang/Object;
...
.method static synthetic access$602(Lcom/android/server/usb/UsbDeviceManager$UsbHandlerHal;Landroid/hardware/usb/gadget/V1_0/IUsbGadget;)Landroid/hardware/usb/gadget/V1_0/IUsbGadget;
    ...
    iput-object p1, p0, mGadgetProxy:Landroid/hardware/usb/gadget/V1_0/IUsbGadget;
...
.method private setUsbConfig(JZ)V
    ...
    iget v2, p0, mCurrentRequest:I

    add-int/lit8 v2, v2, 0x1

    iput v2, p0, mCurrentRequest:I
    ...
    iget-object v2, p0, mGadgetProxyLock:Ljava/lang/Object;

    monitor-enter v2

    :try_start_0
    iget-object v3, p0, mGadgetProxy:Landroid/hardware/usb/gadget/V1_0/IUsbGadget;
    ...
    invoke-virtual {p0, v3, v4}, setSystemProperty(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1, p3, v3, v4}, sendMessageDelayed(IZJ)V

    const-wide/16 v3, 0x1388

    invoke-virtual {p0, v0, p3, v3, v4}, sendMessageDelayed(IZJ)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    iget-object v5, p0, mGadgetProxyLock:Ljava/lang/Object;
    ...
    iput-object v1, p0, mGadgetProxy:Landroid/hardware/usb/gadget/V1_0/IUsbGadget;

    iget-object v1, p0, mGadgetProxy:Landroid/hardware/usb/gadget/V1_0/IUsbGadget;
    ...
    iget-wide v1, p0, mCurrentFunctions:J

    invoke-virtual {p0, v1, v2, v3}, setEnabledFunctions(JZ)V
    :try_end_0
    ...
    invoke-virtual {p0, v1, v2, v0}, setEnabledFunctions(JZ)V
    ...
    iput-boolean v4, p0, mCurrentUsbFunctionsReceived:Z

    iget-boolean v0, p0, mCurrentUsbFunctionsRequested:Z
    ...
    iput-wide v0, p0, mCurrentFunctions:J
...
.method protected setEnabledFunctions(JZ)V
    ...
    iget-boolean v0, p0, mCurrentFunctionsApplied:Z
    ...
    iput-boolean v0, p0, mCurrentUsbFunctionsRequested:Z
    ...
    :cond_1
    invoke-virtual {p0, p1, p2}, getAppliedFunctions(J)J

    move-result-wide p1

    invoke-direct {p0, p1, p2, v0}, setUsbConfig(JZ)V
    ...
    invoke-virtual {p0, p1, p2}, updateUsbStateBroadcastIfNeeded(J)V
