...
.method private addACInterface(Lcom/android/server/usb/descriptors/UsbACInterface;)V
    ...
    iget-object v0, p0, mInterfaceNode:Lcom/android/server/usb/descriptors/tree/UsbDescriptorsInterfaceNode;
...
.method private addConfigDescriptor(Lcom/android/server/usb/descriptors/UsbConfigDescriptor;)V
    ...
    iput-object v0, p0, mConfigNode:Lcom/android/server/usb/descriptors/tree/UsbDescriptorsConfigNode;

    iget-object v0, p0, mDeviceNode:Lcom/android/server/usb/descriptors/tree/UsbDescriptorsDeviceNode;

    iget-object v1, p0, mConfigNode:Lcom/android/server/usb/descriptors/tree/UsbDescriptorsConfigNode;
...
.method private addDeviceDescriptor(Lcom/android/server/usb/descriptors/UsbDeviceDescriptor;)V
    ...
    iput-object v0, p0, mDeviceNode:Lcom/android/server/usb/descriptors/tree/UsbDescriptorsDeviceNode;
...
.method private addInterfaceDescriptor(Lcom/android/server/usb/descriptors/UsbInterfaceDescriptor;)V
    ...
    iput-object v0, p0, mInterfaceNode:Lcom/android/server/usb/descriptors/tree/UsbDescriptorsInterfaceNode;

    iget-object v0, p0, mConfigNode:Lcom/android/server/usb/descriptors/tree/UsbDescriptorsConfigNode;

    iget-object v1, p0, mInterfaceNode:Lcom/android/server/usb/descriptors/tree/UsbDescriptorsInterfaceNode;
...
.method public parse(Lcom/android/server/usb/descriptors/UsbDescriptorParser;)V
    ...
    invoke-direct {p0, v3}, addACInterface(Lcom/android/server/usb/descriptors/UsbACInterface;)V
    ...
    invoke-direct {p0, v3}, addEndpointDescriptor(Lcom/android/server/usb/descriptors/UsbEndpointDescriptor;)V
    ...
    invoke-direct {p0, v3}, addInterfaceDescriptor(Lcom/android/server/usb/descriptors/UsbInterfaceDescriptor;)V
    ...
    invoke-direct {p0, v3}, addConfigDescriptor(Lcom/android/server/usb/descriptors/UsbConfigDescriptor;)V
    ...
    invoke-direct {p0, v3}, addDeviceDescriptor(Lcom/android/server/usb/descriptors/UsbDeviceDescriptor;)V
