...
.method static constructor <clinit>()V
    ...
    sput-object v0, originPortInfo:Ljava/util/ArrayList;
    ...
    sput-boolean v0, is_vbus_connected:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, mProxy:Landroid/hardware/usb/V1_0/IUsb;
    ...
    iput-object v2, p0, mHALCallback:Lcom/android/server/usb/UsbPortManager$HALCallback;
    ...
    iput-object v2, p0, mPorts:Landroid/util/ArrayMap;

    new-instance v2, Landroid/util/ArrayMap;

    invoke-direct {v2}, Landroid/util/ArrayMap;-><init>()V

    iput-object v2, p0, mSimulatedPorts:Landroid/util/ArrayMap;

    new-instance v2, Landroid/util/ArrayMap;

    invoke-direct {v2}, Landroid/util/ArrayMap;-><init>()V

    iput-object v2, p0, mConnected:Landroid/util/ArrayMap;

    new-instance v2, Landroid/util/ArrayMap;

    invoke-direct {v2}, Landroid/util/ArrayMap;-><init>()V

    iput-object v2, p0, mContaminantStatus:Landroid/util/ArrayMap;
    ...
    invoke-static {v4, v1, v0}, logAndPrint(ILcom/android/internal/util/IndentingPrintWriter;Ljava/lang/String;)V
    :try_end_0
    ...
    invoke-direct {p0, v1}, connectToProxy(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    invoke-static {v1, v0, v2}, logAndPrintException(Lcom/android/internal/util/IndentingPrintWriter;Ljava/lang/String;Ljava/lang/Exception;)V
...
.method static synthetic access$100(ILcom/android/internal/util/IndentingPrintWriter;Ljava/lang/String;)V
    ...
    invoke-static {p0, p1, p2}, logAndPrint(ILcom/android/internal/util/IndentingPrintWriter;Ljava/lang/String;)V
...
.method static synthetic access$1100(Lcom/android/server/usb/UsbPortManager;Ljava/lang/String;IIIZIZIZZIZILcom/android/internal/util/IndentingPrintWriter;)V
    ...
    invoke-direct/range {p0 .. p14}, addOrUpdatePortLocked(Ljava/lang/String;IIIZIZIZZIZILcom/android/internal/util/IndentingPrintWriter;)V
...
.method static synthetic access$200()Ljava/util/ArrayList;
    ...
    sget-object v0, originPortInfo:Ljava/util/ArrayList;
...
.method static synthetic access$300()Z
    ...
    sget-boolean v0, is_vbus_connected:Z
...
.method static synthetic access$302(Z)Z
    ...
    sput-boolean p0, is_vbus_connected:Z
...
.method static synthetic access$602(Lcom/android/server/usb/UsbPortManager;Landroid/hardware/usb/V1_0/IUsb;)Landroid/hardware/usb/V1_0/IUsb;
    ...
    iput-object p1, p0, mProxy:Landroid/hardware/usb/V1_0/IUsb;
...
.method static synthetic access$700(Lcom/android/server/usb/UsbPortManager;Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    invoke-direct {p0, p1}, connectToProxy(Lcom/android/internal/util/IndentingPrintWriter;)V
...
.method static synthetic access$800(Lcom/android/server/usb/UsbPortManager;Lcom/android/internal/util/IndentingPrintWriter;Ljava/util/ArrayList;)V
    ...
    invoke-direct {p0, p1, p2}, updatePortsLocked(Lcom/android/internal/util/IndentingPrintWriter;Ljava/util/ArrayList;)V
...
.method private addOrUpdatePortLocked(Ljava/lang/String;IIIZIZIZZIZILcom/android/internal/util/IndentingPrintWriter;)V
    ...
    invoke-static {v4, v11, v3}, logAndPrint(ILcom/android/internal/util/IndentingPrintWriter;Ljava/lang/String;)V
    ...
    sget v5, COMBO_SOURCE_HOST:I

    sget v6, COMBO_SOURCE_DEVICE:I

    or-int/2addr v5, v6

    sget v6, COMBO_SINK_HOST:I

    or-int/2addr v5, v6

    sget v6, COMBO_SINK_DEVICE:I
    ...
    :goto_1
    iget-object v1, v0, mPorts:Landroid/util/ArrayMap;
    ...
    invoke-static {v4, v6, v10}, logAndPrint(ILcom/android/internal/util/IndentingPrintWriter;Ljava/lang/String;)V
...
.method private connectToProxy(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    :try_start_0
    iget-object v1, p0, mProxy:Landroid/hardware/usb/V1_0/IUsb;
    ...
    iget-object v2, p0, mHALCallback:Lcom/android/server/usb/UsbPortManager$HALCallback;
    ...
    invoke-static {p1, v2, v1}, logAndPrintException(Lcom/android/internal/util/IndentingPrintWriter;Ljava/lang/String;Ljava/lang/Exception;)V
...
.method private enableContaminantDetectionIfNeeded(Lcom/android/server/usb/UsbPortManager$PortInfo;Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    iget-object v0, p0, mConnected:Landroid/util/ArrayMap;
    ...
    invoke-virtual {p0, v0, v1, p2}, enableContaminantDetection(Ljava/lang/String;ZLcom/android/internal/util/IndentingPrintWriter;)V
...
.method private handlePortAddedLocked(Lcom/android/server/usb/UsbPortManager$PortInfo;Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    invoke-static {v1, p2, v0}, logAndPrint(ILcom/android/internal/util/IndentingPrintWriter;Ljava/lang/String;)V

    invoke-direct {p0, p1, p2}, handlePortLocked(Lcom/android/server/usb/UsbPortManager$PortInfo;Lcom/android/internal/util/IndentingPrintWriter;)V
...
.method private handlePortChangedLocked(Lcom/android/server/usb/UsbPortManager$PortInfo;Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    invoke-direct {p0, p1, p2}, enableContaminantDetectionIfNeeded(Lcom/android/server/usb/UsbPortManager$PortInfo;Lcom/android/internal/util/IndentingPrintWriter;)V
...
.method private handlePortLocked(Lcom/android/server/usb/UsbPortManager$PortInfo;Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    invoke-direct {p0, p1, p2}, logToStatsd(Lcom/android/server/usb/UsbPortManager$PortInfo;Lcom/android/internal/util/IndentingPrintWriter;)V

    invoke-direct {p0}, updateContaminantNotification()V
...
.method private logToStatsd(Lcom/android/server/usb/UsbPortManager$PortInfo;Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    :cond_1
    iget-object v0, p0, mContaminantStatus:Landroid/util/ArrayMap;
    ...
    invoke-static {v2}, convertContaminantDetectionStatusToProto(I)I
...
.method private updateContaminantNotification()V
    ...
    iget-object v4, v0, mPorts:Landroid/util/ArrayMap;
    ...
    iget v10, v0, mIsPortContaminatedNotificationId:I
    ...
    :cond_3
    iput v8, v0, mIsPortContaminatedNotificationId:I
    ...
    iget-object v13, v0, mNotificationManager:Landroid/app/NotificationManager;

    iget v14, v0, mIsPortContaminatedNotificationId:I
    ...
    iget v6, v0, mIsPortContaminatedNotificationId:I

    if-ne v6, v8, :cond_5

    iget-object v8, v0, mNotificationManager:Landroid/app/NotificationManager;
    ...
    iput v6, v0, mIsPortContaminatedNotificationId:I

    const/4 v6, 0x2

    if-ne v3, v6, :cond_6

    iput v5, v0, mIsPortContaminatedNotificationId:I
    ...
    iget v12, v0, mIsPortContaminatedNotificationId:I
...
.method private updatePortsLocked(Lcom/android/internal/util/IndentingPrintWriter;Ljava/util/ArrayList;)V
    ...
    iget-object v0, v15, mPorts:Landroid/util/ArrayMap;
    ...
    :cond_0
    iget-object v0, v15, mSimulatedPorts:Landroid/util/ArrayMap;
    ...
    invoke-direct/range {v0 .. v14}, addOrUpdatePortLocked(Ljava/lang/String;IIIZIZIZZIZILcom/android/internal/util/IndentingPrintWriter;)V
    ...
    :cond_4
    iget-object v2, v15, mPorts:Landroid/util/ArrayMap;
    ...
    invoke-direct {v15, v0, v2}, handlePortRemovedLocked(Lcom/android/server/usb/UsbPortManager$PortInfo;Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    invoke-direct {v15, v0, v2}, handlePortChangedLocked(Lcom/android/server/usb/UsbPortManager$PortInfo;Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    invoke-direct {v15, v0, v2}, handlePortAddedLocked(Lcom/android/server/usb/UsbPortManager$PortInfo;Lcom/android/internal/util/IndentingPrintWriter;)V
...
.method public addSimulatedPort(Ljava/lang/String;ILcom/android/internal/util/IndentingPrintWriter;)V
    ...
    invoke-direct {p0, p3, v1}, updatePortsLocked(Lcom/android/internal/util/IndentingPrintWriter;Ljava/util/ArrayList;)V
...
.method public connectSimulatedPort(Ljava/lang/String;IZIZIZLcom/android/internal/util/IndentingPrintWriter;)V
    ...
    invoke-direct {p0, p8, v2}, updatePortsLocked(Lcom/android/internal/util/IndentingPrintWriter;Ljava/util/ArrayList;)V
...
.method public disconnectSimulatedPort(Ljava/lang/String;Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    invoke-direct {p0, p2, v2}, updatePortsLocked(Lcom/android/internal/util/IndentingPrintWriter;Ljava/util/ArrayList;)V
...
.method public dump(Lcom/android/internal/util/dump/DualDumpOutputStream;Ljava/lang/String;J)V
    ...
    iget-object v6, p0, mSimulatedPorts:Landroid/util/ArrayMap;
...
.method public enableContaminantDetection(Ljava/lang/String;ZLcom/android/internal/util/IndentingPrintWriter;)V
    ...
    iget-object v0, p0, mPorts:Landroid/util/ArrayMap;
    ...
    invoke-static {p3, v2, v1}, logAndPrintException(Lcom/android/internal/util/IndentingPrintWriter;Ljava/lang/String;Ljava/lang/Exception;)V
...
.method public getPorts()[Landroid/hardware/usb/UsbPort;
    ...
    iget-object v4, p0, mPorts:Landroid/util/ArrayMap;
...
.method public resetSimulation(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    invoke-direct {p0, p1, v1}, updatePortsLocked(Lcom/android/internal/util/IndentingPrintWriter;Ljava/util/ArrayList;)V
...
.method public setPortRoles(Ljava/lang/String;IILcom/android/internal/util/IndentingPrintWriter;)V
    ...
    iget-object v6, v1, mLock:Ljava/lang/Object;

    monitor-enter v6

    :try_start_0
    iget-object v0, v1, mPorts:Landroid/util/ArrayMap;
    ...
    invoke-static {v8, v5, v0}, logAndPrint(ILcom/android/internal/util/IndentingPrintWriter;Ljava/lang/String;)V
    ...
    invoke-static {v15, v5, v0}, logAndPrint(ILcom/android/internal/util/IndentingPrintWriter;Ljava/lang/String;)V

    iget-object v0, v1, mSimulatedPorts:Landroid/util/ArrayMap;
    ...
    invoke-direct {v1, v5, v0}, updatePortsLocked(Lcom/android/internal/util/IndentingPrintWriter;Ljava/util/ArrayList;)V
    ...
    iget-object v0, v1, mProxy:Landroid/hardware/usb/V1_0/IUsb;
    ...
    invoke-static {v7, v5, v0}, logAndPrint(ILcom/android/internal/util/IndentingPrintWriter;Ljava/lang/String;)V
    ...
    invoke-static {v5, v8, v0}, logAndPrintException(Lcom/android/internal/util/IndentingPrintWriter;Ljava/lang/String;Ljava/lang/Exception;)V
...
.method public simulateContaminantStatus(Ljava/lang/String;ZLcom/android/internal/util/IndentingPrintWriter;)V
    ...
    invoke-direct {p0, p3, v2}, updatePortsLocked(Lcom/android/internal/util/IndentingPrintWriter;Ljava/util/ArrayList;)V
...
.method public systemReady()V
    ...
    iget-object v0, p0, mProxy:Landroid/hardware/usb/V1_0/IUsb;
    ...
    invoke-static {v1, v2, v0}, logAndPrintException(Lcom/android/internal/util/IndentingPrintWriter;Ljava/lang/String;Ljava/lang/Exception;)V
