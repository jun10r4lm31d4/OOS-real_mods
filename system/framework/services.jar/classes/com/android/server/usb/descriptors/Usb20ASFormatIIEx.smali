...
.method public getHeaderLength()B
    ...
    iget-byte v0, p0, mHeaderLength:B
...
.method public getSidebandProtocol()B
    ...
    iget-byte v0, p0, mSidebandProtocol:B
...
.method public parseRawDescriptors(Lcom/android/server/usb/descriptors/ByteStream;)I
    ...
    iput v0, p0, mMaxBitRate:I

    invoke-virtual {p1}, Lcom/android/server/usb/descriptors/ByteStream;->unpackUsbShort()I

    move-result v0

    iput v0, p0, mSamplesPerFrame:I

    invoke-virtual {p1}, Lcom/android/server/usb/descriptors/ByteStream;->getByte()B

    move-result v0

    iput-byte v0, p0, mHeaderLength:B

    invoke-virtual {p1}, Lcom/android/server/usb/descriptors/ByteStream;->getByte()B

    move-result v0

    iput-byte v0, p0, mSidebandProtocol:B
...
.method public report(Lcom/android/server/usb/descriptors/report/ReportCanvas;)V
    ...
    invoke-virtual {p0}, getMaxBitRate()I
    ...
    invoke-virtual {p0}, getSamplesPerFrame()I
    ...
    invoke-virtual {p0}, getHeaderLength()B
    ...
    invoke-virtual {p0}, getSidebandProtocol()B
