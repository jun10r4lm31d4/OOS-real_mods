...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mAirplaneModeReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v1, p0, mEmergencyCallMccNumbers:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, mEmergencyCallMccNumbers:Ljava/util/ArrayList;
    ...
    :cond_0
    sput-object p0, sInstance:Lcom/android/server/emergency/EmergencyAffordanceService;
...
.method static synthetic access$000(Lcom/android/server/emergency/EmergencyAffordanceService;)Z
    ...
    invoke-direct {p0}, isEmergencyAffordanceNeeded()Z
...
.method static synthetic access$100(Lcom/android/server/emergency/EmergencyAffordanceService;)V
    ...
    invoke-direct {p0}, requestCellScan()V
...
.method static synthetic access$300(Lcom/android/server/emergency/EmergencyAffordanceService;)Lcom/android/server/emergency/EmergencyAffordanceService$MyHandler;
    ...
    iget-object v0, p0, mHandler:Lcom/android/server/emergency/EmergencyAffordanceService$MyHandler;
...
.method static synthetic access$400(Lcom/android/server/emergency/EmergencyAffordanceService;)V
    ...
    invoke-direct {p0}, handleInitializeState()V
...
.method static synthetic access$500(Lcom/android/server/emergency/EmergencyAffordanceService;)Z
    ...
    invoke-direct {p0}, handleUpdateCellInfo()Z
...
.method static synthetic access$600(Lcom/android/server/emergency/EmergencyAffordanceService;)Z
    ...
    invoke-direct {p0}, handleUpdateSimSubscriptionInfo()Z
...
.method public static getInstance()Lcom/android/server/emergency/EmergencyAffordanceService;
    ...
    sget-object v0, sInstance:Lcom/android/server/emergency/EmergencyAffordanceService;
...
.method private handleInitializeState()V
    ...
    invoke-direct {p0}, updateEmergencyAffordanceNeeded()V
...
.method private handleUpdateCellInfo()Z
    ...
    invoke-direct {p0, v5}, mccRequiresEmergencyAffordance(I)Z
    ...
    invoke-direct {p0, v1}, setNetworkNeedsEmergencyAffordance(Z)V
    ...
    :cond_7
    invoke-direct {p0}, onCellScanFinishedUnsuccessful()V
...
.method private handleUpdateSimSubscriptionInfo()Z
    ...
    invoke-direct {p0}, simNeededAffordanceBefore()Z
    ...
    invoke-direct {p0, v1}, setSimNeedsEmergencyAffordance(Z)V
    ...
    invoke-direct {p0, v6}, mccRequiresEmergencyAffordance(I)Z
    ...
    :cond_2
    iget-object v7, p0, mTelephonyManager:Landroid/telephony/TelephonyManager;
...
.method private isEmergencyAffordanceNeeded()Z
    ...
    :try_start_0
    iget-boolean v1, p0, mEmergencyAffordanceNeeded:Z
...
.method private mccRequiresEmergencyAffordance(I)Z
    ...
    iget-object v0, p0, mEmergencyCallMccNumbers:Ljava/util/ArrayList;
...
.method private onCellScanFinishedUnsuccessful()V
    ...
    :try_start_0
    iget v1, p0, mScansCompleted:I

    add-int/lit8 v1, v1, 0x1

    iput v1, p0, mScansCompleted:I
...
.method private setNetworkNeedsEmergencyAffordance(Z)V
    ...
    :try_start_0
    iput-boolean p1, p0, mNetworkNeedsEmergencyAffordance:Z
...
.method private setSimNeedsEmergencyAffordance(Z)V
    ...
    :cond_0
    iget-boolean v0, p0, mSimNeedsEmergencyAffordance:Z

    if-eq p1, v0, :cond_1

    iput-boolean p1, p0, mSimNeedsEmergencyAffordance:Z
...
.method private updateEmergencyAffordanceNeeded()V
    ...
    iget-boolean v3, p0, mSimNeedsEmergencyAffordance:Z
    ...
    iget-boolean v3, p0, mNetworkNeedsEmergencyAffordance:Z
    ...
    iget-boolean v1, p0, mSimNeedsEmergencyAffordance:Z

    if-nez v1, :cond_0

    iget-boolean v1, p0, mNetworkNeedsEmergencyAffordance:Z
    ...
    :goto_0
    iput-boolean v1, p0, mEmergencyAffordanceNeeded:Z
    ...
    iget-boolean v5, p0, mEmergencyAffordanceNeeded:Z
...
.method public onBootPhase(I)V
    ...
    iput-boolean v0, p0, mVoiceCapable:Z

    iget-boolean v0, p0, mVoiceCapable:Z
    ...
    iput-object v1, p0, mHandler:Lcom/android/server/emergency/EmergencyAffordanceService$MyHandler;

    iget-object v1, p0, mHandler:Lcom/android/server/emergency/EmergencyAffordanceService$MyHandler;
    ...
    iget-object v3, p0, mAirplaneModeReceiver:Landroid/content/BroadcastReceiver;

    invoke-virtual {v2, v3, v1}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    iget-object v2, p0, mSubscriptionManager:Landroid/telephony/SubscriptionManager;

    iget-object v3, p0, mSubscriptionChangedListener:Landroid/telephony/SubscriptionManager$OnSubscriptionsChangedListener;
