...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0, v1}, <init>(Landroid/content/Context;Ljava/io/File;Landroid/os/Looper;)V
...
.method public constructor <init>(Landroid/content/Context;Ljava/io/File;Landroid/os/Looper;)V
    ...
    iput-object v0, p0, mAllFiles:Lcom/android/server/DropBoxManagerService$FileList;

    iput-object v0, p0, mFilesByTag:Landroid/util/ArrayMap;

    const-wide/16 v1, 0x0

    iput-wide v1, p0, mLowPriorityRateLimitPeriod:J

    iput-object v0, p0, mLowPriorityTags:Landroid/util/ArraySet;

    iput-object v0, p0, mStatFs:Landroid/os/StatFs;

    const/4 v0, 0x0

    iput v0, p0, mBlockSize:I

    iput v0, p0, mCachedQuotaBlocks:I

    iput-wide v1, p0, mCachedQuotaUptimeMillis:J

    iput-boolean v0, p0, mBooted:Z

    const/4 v0, -0x1

    iput v0, p0, mMaxFiles:I

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, mObjEpitaphLock:Ljava/lang/Object;
    ...
    iput-object v0, p0, mStub:Lcom/android/internal/os/IDropBoxManagerService$Stub;
    ...
    iput-object v0, p0, mHandler:Lcom/android/server/DropBoxManagerService$DropBoxManagerBroadcastHandler;
...
.method static synthetic access$400(Lcom/android/server/DropBoxManagerService;J)V
    ...
    invoke-direct {p0, p1, p2}, setLowPriorityRateLimit(J)V
...
.method static synthetic access$500(Lcom/android/server/DropBoxManagerService;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, addLowPriorityTag(Ljava/lang/String;)V
...
.method static synthetic access$600(Lcom/android/server/DropBoxManagerService;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, removeLowPriorityTag(Ljava/lang/String;)V
...
.method static synthetic access$700(Lcom/android/server/DropBoxManagerService;)V
    ...
    invoke-direct {p0}, restoreDefaults()V
...
.method static synthetic access$900(Lcom/android/server/DropBoxManagerService;)J
    ...
    iget-wide v0, p0, mLowPriorityRateLimitPeriod:J
...
.method private declared-synchronized addLowPriorityTag(Ljava/lang/String;)V
    ...
    :try_start_0
    iget-object v0, p0, mLowPriorityTags:Landroid/util/ArraySet;
...
.method private declared-synchronized createEntry(Ljava/io/File;Ljava/lang/String;I)J
    ...
    iget-object v0, v1, mAllFiles:Lcom/android/server/DropBoxManagerService$FileList;
    ...
    :cond_0
    iget-object v5, v1, mAllFiles:Lcom/android/server/DropBoxManagerService$FileList;
    ...
    iget-object v3, v1, mAllFiles:Lcom/android/server/DropBoxManagerService$FileList;
    ...
    iget-object v3, v1, mFilesByTag:Landroid/util/ArrayMap;
    ...
    invoke-direct {v1, v0}, enrollEntry(Lcom/android/server/DropBoxManagerService$EntryFile;)V
    ...
    iget-object v6, v1, mDropBoxDir:Ljava/io/File;
    ...
    iget-object v2, v1, mDropBoxDir:Ljava/io/File;
...
.method private declared-synchronized enrollEntry(Lcom/android/server/DropBoxManagerService$EntryFile;)V
    ...
    :try_start_0
    iget-object v0, p0, mAllFiles:Lcom/android/server/DropBoxManagerService$FileList;
    ...
    iget-object v0, p0, mFilesByTag:Landroid/util/ArrayMap;
    ...
    iget-object v1, p0, mFilesByTag:Landroid/util/ArrayMap;
...
.method private getLowPriorityResourceConfigs()V
    ...
    iput-wide v0, p0, mLowPriorityRateLimitPeriod:J
    ...
    iput-object v2, p0, mLowPriorityTags:Landroid/util/ArraySet;
    ...
    iget-object v3, p0, mLowPriorityTags:Landroid/util/ArraySet;
...
.method private declared-synchronized init()V
    ...
    :try_start_0
    iget-object v0, p0, mStatFs:Landroid/os/StatFs;

    if-nez v0, :cond_2

    iget-object v0, p0, mDropBoxDir:Ljava/io/File;
    ...
    iget-object v2, p0, mDropBoxDir:Ljava/io/File;
    ...
    iget-object v1, p0, mDropBoxDir:Ljava/io/File;
    ...
    iget-object v3, p0, mDropBoxDir:Ljava/io/File;
    ...
    iput-object v1, p0, mAllFiles:Lcom/android/server/DropBoxManagerService$FileList;

    new-instance v1, Landroid/util/ArrayMap;

    invoke-direct {v1}, Landroid/util/ArrayMap;-><init>()V

    iput-object v1, p0, mFilesByTag:Landroid/util/ArrayMap;
    ...
    invoke-direct {p0, v4}, enrollEntry(Lcom/android/server/DropBoxManagerService$EntryFile;)V
...
.method private declared-synchronized restoreDefaults()V
    ...
    :try_start_0
    invoke-direct {p0}, getLowPriorityResourceConfigs()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private declared-synchronized setLowPriorityRateLimit(J)V
    ...
    :try_start_0
    iput-wide p1, p0, mLowPriorityRateLimitPeriod:J
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private declared-synchronized trimToFit()J
    ...
    :cond_1
    iget-object v5, v1, mFilesByTag:Landroid/util/ArrayMap;
    ...
    :cond_2
    iget-object v6, v1, mAllFiles:Lcom/android/server/DropBoxManagerService$FileList;
    ...
    iget-wide v7, v1, mCachedQuotaUptimeMillis:J
    ...
    iget-object v0, v1, mDropBoxDir:Ljava/io/File;
    ...
    :try_start_1
    iget-object v0, v1, mStatFs:Landroid/os/StatFs;
    ...
    iget-object v11, v1, mStatFs:Landroid/os/StatFs;
    ...
    iput v13, v1, mCachedQuotaBlocks:I

    iput-wide v5, v1, mCachedQuotaUptimeMillis:J
    ...
    iget-object v13, v1, mDropBoxDir:Ljava/io/File;
    ...
    iget v7, v1, mCachedQuotaBlocks:I
    ...
    iget-object v9, v1, mFilesByTag:Landroid/util/ArrayMap;
    ...
    iget v12, v1, mCachedQuotaBlocks:I
    ...
    :cond_7
    :goto_5
    iget v0, v1, mCachedQuotaBlocks:I
    ...
    iget v13, v1, mCachedQuotaBlocks:I
    ...
    iget-object v14, v1, mDropBoxDir:Ljava/io/File;
...
.method public add(Landroid/os/DropBoxManager$Entry;)V
    ...
    invoke-virtual {v1, v5}, isTagEnabled(Ljava/lang/String;)Z
    ...
    iget-object v15, v1, mOpDeviceManagerInjector:Lnet/oneplus/odm/OpDeviceManagerInjector;
    ...
    :goto_5
    iget-object v0, v1, mOpDeviceManagerInjector:Lnet/oneplus/odm/OpDeviceManagerInjector;
    ...
    invoke-direct {v1, v2, v5, v7}, createEntry(Ljava/io/File;Ljava/lang/String;I)J

    move-result-wide v8

    const/4 v2, 0x0

    iget-object v0, v1, mLowPriorityTags:Landroid/util/ArraySet;
    ...
    iget-object v0, v1, mHandler:Lcom/android/server/DropBoxManagerService$DropBoxManagerBroadcastHandler;
    ...
    :cond_11
    iget-object v9, v1, mObjEpitaphLock:Ljava/lang/Object;
...
.method public declared-synchronized dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-wide v9, v1, mLowPriorityRateLimitPeriod:J
    ...
    iget-object v10, v1, mAllFiles:Lcom/android/server/DropBoxManagerService$FileList;
...
.method public declared-synchronized getNextEntry(Ljava/lang/String;JLjava/lang/String;)Landroid/os/DropBoxManager$Entry;
    ...
    invoke-direct {p0, v0, v3}, checkPermission(ILjava/lang/String;)Z
    ...
    :cond_1
    iget-object v0, v1, mFilesByTag:Landroid/util/ArrayMap;
...
.method public getServiceStub()Lcom/android/internal/os/IDropBoxManagerService;
    ...
    iget-object v0, p0, mStub:Lcom/android/internal/os/IDropBoxManagerService$Stub;
