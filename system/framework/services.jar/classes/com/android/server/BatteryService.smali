...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mLastHealthInfo:Landroid/hardware/health/V1_0/HealthInfo;

    const/4 v0, 0x1

    iput v0, p0, mSequence:I

    const/4 v1, -0x1

    iput v1, p0, mLastPlugType:I

    const/4 v1, 0x0

    iput-boolean v1, p0, mSentLowBatteryBroadcast:Z

    iput-boolean v1, p0, mIsInitted:Z

    new-instance v1, Ljava/lang/Object;

    invoke-direct {v1}, Ljava/lang/Object;-><init>()V

    iput-object v1, p0, mReportLock:Ljava/lang/Object;

    const/4 v1, 0x0

    iput-object v1, p0, rl:Lcom/android/server/wm/OpPowerConsumpStatsInjector$ResetParamListener;
    ...
    iput-object v0, p0, mLed:Lcom/android/server/BatteryService$Led;
    ...
    iput v0, p0, mCriticalBatteryLevel:I
    ...
    iput v0, p0, mLowBatteryCloseWarningLevel:I
    ...
    iput v0, p0, mShutdownBatteryTemperature:I

    new-instance v0, Ljava/util/ArrayDeque;

    invoke-direct {v0}, Ljava/util/ArrayDeque;-><init>()V

    iput-object v0, p0, mBatteryLevelsEventQueue:Ljava/util/ArrayDeque;
...
.method static synthetic access$1000(Lcom/android/server/BatteryService;)Ljava/lang/Object;
    ...
    iget-object v0, p0, mReportLock:Ljava/lang/Object;
...
.method static synthetic access$1100(Lcom/android/server/BatteryService;)Z
    ...
    iget-boolean v0, p0, mIsInitted:Z
...
.method static synthetic access$1102(Lcom/android/server/BatteryService;Z)Z
    ...
    iput-boolean p1, p0, mIsInitted:Z
...
.method static synthetic access$1300(Lcom/android/server/BatteryService;)Landroid/hardware/health/V1_0/HealthInfo;
    ...
    iget-object v0, p0, mHealthInfo:Landroid/hardware/health/V1_0/HealthInfo;
...
.method static synthetic access$1500(Lcom/android/server/BatteryService;Landroid/hardware/health/V2_0/HealthInfo;)V
    ...
    invoke-direct {p0, p1}, update(Landroid/hardware/health/V2_0/HealthInfo;)V
...
.method static synthetic access$1600(Ljava/lang/String;)V
    ...
    invoke-static {p0}, traceBegin(Ljava/lang/String;)V
...
.method static synthetic access$2000(Lcom/android/server/BatteryService;)Lcom/android/server/BatteryService$HealthServiceWrapper;
    ...
    iget-object v0, p0, mHealthServiceWrapper:Lcom/android/server/BatteryService$HealthServiceWrapper;
...
.method private dumpInternal(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v3, p0, mBinderService:Lcom/android/server/BatteryService$BinderService;
    ...
    iget-boolean v1, p0, mUpdatesStopped:Z
    ...
    iget-object v2, p0, mHealthInfo:Landroid/hardware/health/V1_0/HealthInfo;
...
.method private dumpProto(Ljava/io/FileDescriptor;)V
    ...
    :try_start_0
    iget-boolean v4, p0, mUpdatesStopped:Z

    invoke-virtual {v0, v2, v3, v4}, Landroid/util/proto/ProtoOutputStream;->write(JZ)V

    const/4 v2, 0x0

    iget-object v3, p0, mHealthInfo:Landroid/hardware/health/V1_0/HealthInfo;
    ...
    iget-object v5, p0, mHealthInfo:Landroid/hardware/health/V1_0/HealthInfo;
...
.method private getIconLocked(I)I
    ...
    invoke-direct {p0, v0}, isPoweredLocked(I)Z
...
.method public static synthetic lambda$D1kwd7L7yyqN5niz3KWkTepVmUk(Lcom/android/server/BatteryService;)V
    ...
    invoke-direct {p0}, sendEnqueuedBatteryLevelChangedEvents()V
...
.method private logOutlierLocked(J)V
    ...
    iget v6, p0, mDischargeStartLevel:I

    iget-object v7, p0, mHealthInfo:Landroid/hardware/health/V1_0/HealthInfo;
...
.method private processValuesLocked(Z)V
    ...
    iget-object v0, v1, mHealthInfo:Landroid/hardware/health/V1_0/HealthInfo;
    ...
    iget v7, v1, mCriticalBatteryLevel:I
    ...
    :goto_0
    iput-boolean v0, v1, mBatteryLevelCritical:Z
    ...
    iput v7, v1, mPlugType:I

    goto :goto_1

    :cond_3
    iput v5, v1, mPlugType:I
    ...
    iget-object v11, v1, mReportLock:Ljava/lang/Object;
    ...
    :cond_6
    iget-object v0, v1, rl:Lcom/android/server/wm/OpPowerConsumpStatsInjector$ResetParamListener;
    ...
    iput-object v0, v1, rl:Lcom/android/server/wm/OpPowerConsumpStatsInjector$ResetParamListener;
    ...
    :goto_3
    :try_start_1
    iget-object v12, v1, mBatteryStats:Lcom/android/internal/app/IBatteryStats;
    ...
    iget v15, v1, mPlugType:I

    iget-object v0, v1, mHealthInfo:Landroid/hardware/health/V1_0/HealthInfo;

    iget v0, v0, Landroid/hardware/health/V1_0/HealthInfo;->batteryLevel:I

    iget-object v11, v1, mHealthInfo:Landroid/hardware/health/V1_0/HealthInfo;

    iget v11, v11, Landroid/hardware/health/V1_0/HealthInfo;->batteryTemperature:I

    iget-object v8, v1, mHealthInfo:Landroid/hardware/health/V1_0/HealthInfo;

    iget v8, v8, Landroid/hardware/health/V1_0/HealthInfo;->batteryVoltage:I

    iget-object v6, v1, mHealthInfo:Landroid/hardware/health/V1_0/HealthInfo;

    iget v6, v6, Landroid/hardware/health/V1_0/HealthInfo;->batteryChargeCounter:I

    iget-object v5, v1, mHealthInfo:Landroid/hardware/health/V1_0/HealthInfo;
    ...
    :goto_4
    invoke-direct/range {p0 .. p0}, shutdownIfNoPowerLocked()V

    invoke-direct/range {p0 .. p0}, shutdownIfOverTempLocked()V
    ...
    iget v12, v1, mLastBatteryVoltage:I

    iget v13, v1, mLastBatteryTemperature:I

    iget v14, v1, mLastMaxChargingCurrent:I

    iget v15, v1, mLastMaxChargingVoltage:I

    iget v6, v1, mLastChargeCounter:I
    ...
    iget v8, v1, mLastBatteryStatus:I
    ...
    iget v8, v1, mLastBatteryHealth:I
    ...
    iget-boolean v8, v1, mLastBatteryPresent:Z
    ...
    iget v8, v1, mLastBatteryLevel:I

    if-ne v6, v8, :cond_b

    iget v6, v1, mPlugType:I

    iget v8, v1, mLastPlugType:I

    if-ne v6, v8, :cond_b

    iget v6, v1, mInvalidCharger:I

    iget v8, v1, mLastInvalidCharger:I
    ...
    iput v6, v1, mChargeStartLevel:I

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J

    move-result-wide v13

    iput-wide v13, v1, mChargeStartTime:J
    ...
    iget-object v8, v1, mMetricsLogger:Lcom/android/internal/logging/MetricsLogger;

    invoke-virtual {v8, v6}, Lcom/android/internal/logging/MetricsLogger;->write(Landroid/metrics/LogMaker;)V

    iget-wide v11, v1, mDischargeStartTime:J
    ...
    iget v8, v1, mDischargeStartLevel:I
    ...
    iget-wide v13, v1, mDischargeStartTime:J
    ...
    iget v11, v1, mDischargeStartLevel:I
    ...
    iput-wide v11, v1, mDischargeStartTime:J
    ...
    iput-wide v13, v1, mDischargeStartTime:J

    iget-object v6, v1, mHealthInfo:Landroid/hardware/health/V1_0/HealthInfo;

    iget v6, v6, Landroid/hardware/health/V1_0/HealthInfo;->batteryLevel:I

    iput v6, v1, mDischargeStartLevel:I

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J

    move-result-wide v13

    iget-wide v7, v1, mChargeStartTime:J
    ...
    iget v8, v1, mChargeStartLevel:I
    ...
    iput-wide v7, v1, mChargeStartTime:J

    :cond_f
    :goto_6
    iget-object v7, v1, mHealthInfo:Landroid/hardware/health/V1_0/HealthInfo;
    ...
    iget v7, v1, mLastBatteryLevel:I
    ...
    :cond_12
    iget-boolean v6, v1, mBatteryLevelCritical:Z

    if-eqz v6, :cond_13

    iget-boolean v6, v1, mLastBatteryLevelCritical:Z
    ...
    :cond_13
    iget-boolean v6, v1, mBatteryLevelLow:Z
    ...
    iget v8, v1, mLowBatteryWarningLevel:I

    if-gt v6, v8, :cond_17

    iput-boolean v7, v1, mBatteryLevelLow:Z
    ...
    iput-boolean v6, v1, mBatteryLevelLow:Z
    ...
    iget v8, v1, mLowBatteryCloseWarningLevel:I
    ...
    :cond_17
    :goto_7
    iget v6, v1, mSequence:I

    const/4 v7, 0x1

    add-int/2addr v6, v7

    iput v6, v1, mSequence:I
    ...
    iget-object v8, v1, mHandler:Landroid/os/Handler;
    ...
    :cond_19
    :goto_8
    invoke-direct/range {p0 .. p0}, shouldSendBatteryLowLocked()Z
    ...
    iput-boolean v6, v1, mSentLowBatteryBroadcast:Z
    ...
    :cond_1a
    iget-boolean v6, v1, mSentLowBatteryBroadcast:Z
    ...
    :goto_a
    invoke-direct/range {p0 .. p0}, sendBatteryChangedIntentLocked()V

    iget v6, v1, mLastBatteryLevel:I
    ...
    :cond_1c
    invoke-direct/range {p0 .. p0}, sendBatteryLevelChangedIntentLocked()V
    ...
    iget-object v6, v1, mLed:Lcom/android/server/BatteryService$Led;
    ...
    invoke-direct {v1, v3, v4}, logOutlierLocked(J)V
    ...
    iput v6, v1, mLastBatteryStatus:I

    iget-object v6, v1, mHealthInfo:Landroid/hardware/health/V1_0/HealthInfo;

    iget v6, v6, Landroid/hardware/health/V1_0/HealthInfo;->batteryHealth:I

    iput v6, v1, mLastBatteryHealth:I

    iget-object v6, v1, mHealthInfo:Landroid/hardware/health/V1_0/HealthInfo;

    iget-boolean v6, v6, Landroid/hardware/health/V1_0/HealthInfo;->batteryPresent:Z

    iput-boolean v6, v1, mLastBatteryPresent:Z

    iget-object v6, v1, mHealthInfo:Landroid/hardware/health/V1_0/HealthInfo;

    iget v6, v6, Landroid/hardware/health/V1_0/HealthInfo;->batteryLevel:I

    iput v6, v1, mLastBatteryLevel:I

    iget v6, v1, mPlugType:I

    iput v6, v1, mLastPlugType:I

    iget-object v6, v1, mHealthInfo:Landroid/hardware/health/V1_0/HealthInfo;

    iget v6, v6, Landroid/hardware/health/V1_0/HealthInfo;->batteryVoltage:I

    iput v6, v1, mLastBatteryVoltage:I

    iget-object v6, v1, mHealthInfo:Landroid/hardware/health/V1_0/HealthInfo;

    iget v6, v6, Landroid/hardware/health/V1_0/HealthInfo;->batteryTemperature:I

    iput v6, v1, mLastBatteryTemperature:I

    iget-object v6, v1, mHealthInfo:Landroid/hardware/health/V1_0/HealthInfo;

    iget v6, v6, Landroid/hardware/health/V1_0/HealthInfo;->maxChargingCurrent:I

    iput v6, v1, mLastMaxChargingCurrent:I

    iget-object v6, v1, mHealthInfo:Landroid/hardware/health/V1_0/HealthInfo;

    iget v6, v6, Landroid/hardware/health/V1_0/HealthInfo;->maxChargingVoltage:I

    iput v6, v1, mLastMaxChargingVoltage:I

    iget-object v6, v1, mHealthInfo:Landroid/hardware/health/V1_0/HealthInfo;

    iget v6, v6, Landroid/hardware/health/V1_0/HealthInfo;->batteryChargeCounter:I

    iput v6, v1, mLastChargeCounter:I

    iget-boolean v6, v1, mBatteryLevelCritical:Z

    iput-boolean v6, v1, mLastBatteryLevelCritical:Z

    iget v6, v1, mInvalidCharger:I

    iput v6, v1, mLastInvalidCharger:I
...
.method private registerHealthCallback()V
    ...
    invoke-static {v0}, traceBegin(Ljava/lang/String;)V
    ...
    iput-object v0, p0, mHealthServiceWrapper:Lcom/android/server/BatteryService$HealthServiceWrapper;
    ...
    iput-object v0, p0, mHealthHalCallback:Lcom/android/server/BatteryService$HealthHalCallback;

    :try_start_0
    iget-object v0, p0, mHealthServiceWrapper:Lcom/android/server/BatteryService$HealthServiceWrapper;

    iget-object v1, p0, mHealthHalCallback:Lcom/android/server/BatteryService$HealthHalCallback;
...
.method private sendBatteryChangedIntentLocked()V
    ...
    iget-object v1, p0, mHealthInfo:Landroid/hardware/health/V1_0/HealthInfo;

    iget v1, v1, Landroid/hardware/health/V1_0/HealthInfo;->batteryLevel:I

    invoke-direct {p0, v1}, getIconLocked(I)I
    ...
    iget-boolean v2, p0, mSentLowBatteryBroadcast:Z
...
.method private sendBatteryLevelChangedIntentLocked()V
    ...
    iget-boolean v3, p0, mSentLowBatteryBroadcast:Z
    ...
    iget-object v4, p0, mHealthInfo:Landroid/hardware/health/V1_0/HealthInfo;
    ...
    iget-object v4, p0, mBatteryLevelsEventQueue:Ljava/util/ArrayDeque;

    invoke-virtual {v4}, Ljava/util/ArrayDeque;->isEmpty()Z

    move-result v4

    iget-object v5, p0, mBatteryLevelsEventQueue:Ljava/util/ArrayDeque;
    ...
    iget-object v3, p0, mBatteryLevelsEventQueue:Ljava/util/ArrayDeque;
    ...
    iget-wide v5, p0, mLastBatteryLevelChangedSentMs:J
...
.method private sendEnqueuedBatteryLevelChangedEvents()V
    ...
    iget-object v2, p0, mBatteryLevelsEventQueue:Ljava/util/ArrayDeque;
    ...
    iput-wide v2, p0, mLastBatteryLevelChangedSentMs:J
...
.method private shutdownIfNoPowerLocked()V
    ...
    invoke-direct {p0}, shouldShutdownLocked()Z
...
.method private shutdownIfOverTempLocked()V
    ...
    iget v1, p0, mShutdownBatteryTemperature:I
...
.method private update(Landroid/hardware/health/V2_0/HealthInfo;)V
    ...
    iput-object v1, p0, mHealthInfo:Landroid/hardware/health/V1_0/HealthInfo;

    const/4 v1, 0x0

    invoke-direct {p0, v1}, processValuesLocked(Z)V
    ...
    :cond_0
    iget-object v1, p0, mLastHealthInfo:Landroid/hardware/health/V1_0/HealthInfo;

    iget-object v2, p1, Landroid/hardware/health/V2_0/HealthInfo;->legacy:Landroid/hardware/health/V1_0/HealthInfo;

    invoke-static {v1, v2}, copy(Landroid/hardware/health/V1_0/HealthInfo;Landroid/hardware/health/V1_0/HealthInfo;)V
...
.method private updateBatteryWarningLevelLocked()V
    ...
    iput v3, p0, mLowBatteryWarningLevel:I
...
.method onShellCommand(Lcom/android/server/BatteryService$Shell;Ljava/lang/String;)I
    ...
    :cond_5
    invoke-virtual {p0, p1}, parseOptions(Lcom/android/server/BatteryService$Shell;)I
    ...
    iget-object v5, p0, mLastHealthInfo:Landroid/hardware/health/V1_0/HealthInfo;

    invoke-static {v4, v5}, copy(Landroid/hardware/health/V1_0/HealthInfo;Landroid/hardware/health/V1_0/HealthInfo;)V

    invoke-direct {p0, v0, v1}, processValuesFromShellLocked(Ljava/io/PrintWriter;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_9
    :try_start_1
    iget-boolean v8, p0, mUpdatesStopped:Z

    if-nez v8, :cond_a

    iget-object v8, p0, mLastHealthInfo:Landroid/hardware/health/V1_0/HealthInfo;

    iget-object v9, p0, mHealthInfo:Landroid/hardware/health/V1_0/HealthInfo;

    invoke-static {v8, v9}, copy(Landroid/hardware/health/V1_0/HealthInfo;Landroid/hardware/health/V1_0/HealthInfo;)V
    ...
    :try_start_2
    iput-boolean v5, p0, mUpdatesStopped:Z
    ...
    iget-boolean v2, p0, mUpdatesStopped:Z

    if-nez v2, :cond_12

    iget-object v2, p0, mLastHealthInfo:Landroid/hardware/health/V1_0/HealthInfo;

    iget-object v3, p0, mHealthInfo:Landroid/hardware/health/V1_0/HealthInfo;

    invoke-static {v2, v3}, copy(Landroid/hardware/health/V1_0/HealthInfo;Landroid/hardware/health/V1_0/HealthInfo;)V
...
.method public onStart()V
    ...
    invoke-direct {p0}, registerHealthCallback()V
    ...
    iput-object v0, p0, mBinderService:Lcom/android/server/BatteryService$BinderService;

    iget-object v0, p0, mBinderService:Lcom/android/server/BatteryService$BinderService;

    const-string v2, "battery"

    invoke-virtual {p0, v2, v0}, publishBinderService(Ljava/lang/String;Landroid/os/IBinder;)V
    ...
    iput-object v0, p0, mBatteryPropertiesRegistrar:Lcom/android/server/BatteryService$BatteryPropertiesRegistrar;

    iget-object v0, p0, mBatteryPropertiesRegistrar:Lcom/android/server/BatteryService$BatteryPropertiesRegistrar;
    ...
    invoke-virtual {p0, v0, v2}, publishLocalService(Ljava/lang/Class;Ljava/lang/Object;)V
