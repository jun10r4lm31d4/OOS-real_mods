...
.method constructor <init>(Landroid/content/Context;Landroid/hardware/oemlock/V1_0/IOemLock;)V
    ...
    iput-object p2, p0, mOemLock:Landroid/hardware/oemlock/V1_0/IOemLock;
...
.method getLockName()Ljava/lang/String;
    ...
    :try_start_0
    iget-object v4, p0, mOemLock:Landroid/hardware/oemlock/V1_0/IOemLock;
...
.method setOemUnlockAllowedByCarrier(Z[B)V
    ...
    :try_start_0
    invoke-direct {p0, p2}, toByteArrayList([B)Ljava/util/ArrayList;

    move-result-object v1

    iget-object v2, p0, mOemLock:Landroid/hardware/oemlock/V1_0/IOemLock;
...
.method setOemUnlockAllowedByDevice(Z)V
    ...
    :try_start_0
    iget-object v1, p0, mOemLock:Landroid/hardware/oemlock/V1_0/IOemLock;
