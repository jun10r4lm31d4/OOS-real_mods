...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mStatExpiredkeys:Landroid/util/ArraySet;
...
.method private getAggregatedStatsLocked(Lcom/android/server/notification/NotificationRecord;)[Lcom/android/server/notification/NotificationUsageStats$AggregatedStats;
    ...
    invoke-direct {p0, v0}, getAggregatedStatsLocked(Ljava/lang/String;)[Lcom/android/server/notification/NotificationUsageStats$AggregatedStats;
...
.method private getAggregatedStatsLocked(Ljava/lang/String;)[Lcom/android/server/notification/NotificationUsageStats$AggregatedStats;
    ...
    iget-object v0, p0, mStatsArrays:Ljava/util/ArrayDeque;
    ...
    invoke-direct {p0, p1}, getOrCreateAggregatedStatsLocked(Ljava/lang/String;)Lcom/android/server/notification/NotificationUsageStats$AggregatedStats;
...
.method public declared-synchronized emit()V
    ...
    invoke-direct {p0, v0}, getOrCreateAggregatedStatsLocked(Ljava/lang/String;)Lcom/android/server/notification/NotificationUsageStats$AggregatedStats;
    ...
    iget-object v3, p0, mStats:Ljava/util/Map;
    ...
    iget-wide v5, p0, mLastEmitTime:J

    cmp-long v3, v3, v5

    if-gez v3, :cond_0

    iget-object v3, p0, mStatExpiredkeys:Landroid/util/ArraySet;
    ...
    :cond_1
    iget-object v1, p0, mStatExpiredkeys:Landroid/util/ArraySet;
    ...
    iput-wide v1, p0, mLastEmitTime:J
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized registerEnqueuedByApp(Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-direct {p0, p1}, getAggregatedStatsLocked(Ljava/lang/String;)[Lcom/android/server/notification/NotificationUsageStats$AggregatedStats;
...
.method public declared-synchronized registerPostedByApp(Lcom/android/server/notification/NotificationRecord;)V
    ...
    :cond_0
    invoke-direct {p0, v2}, releaseAggregatedStatsLocked([Lcom/android/server/notification/NotificationUsageStats$AggregatedStats;)V

    iget-object v3, p0, mSQLiteLog:Lcom/android/server/notification/NotificationUsageStats$SQLiteLog;
...
.method public declared-synchronized registerRemovedByApp(Lcom/android/server/notification/NotificationRecord;)V
    ...
    iget-object v1, p0, mSQLiteLog:Lcom/android/server/notification/NotificationUsageStats$SQLiteLog;
