...
.method public constructor <init>(Landroid/content/Context;Landroid/content/pm/PackageManager;Lcom/android/server/notification/RankingHandler;Lcom/android/server/notification/ZenModeHelper;)V
    ...
    iput-object v0, p0, mPackagePreferences:Landroid/util/ArrayMap;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, mRestoredWithoutUids:Landroid/util/ArrayMap;

    const/4 v0, 0x0

    iput-boolean v0, p0, mHideSilentStatusBarIcons:Z

    iput-object p1, p0, mContext:Landroid/content/Context;

    iput-object p4, p0, mZenModeHelper:Lcom/android/server/notification/ZenModeHelper;

    iput-object p3, p0, mRankingHandler:Lcom/android/server/notification/RankingHandler;

    iput-object p2, p0, mPm:Landroid/content/pm/PackageManager;

    invoke-virtual {p0}, updateBadgingEnabled()V

    invoke-virtual {p0}, updateBubblesEnabled()V
    ...
    invoke-direct {p0, v0}, syncChannelsBypassingDnd(I)V
    ...
    iput-object v0, p0, mAppOrChannelList:[Ljava/lang/String;
...
.method private channelIsLiveLocked(Lcom/android/server/notification/PreferencesHelper$PackagePreferences;Landroid/app/NotificationChannel;)Z
    ...
    invoke-virtual {p0, v0, v1, v2}, isGroupBlocked(Ljava/lang/String;ILjava/lang/String;)Z
...
.method private createDefaultChannelIfNeededLocked(Lcom/android/server/notification/PreferencesHelper$PackagePreferences;)Z
    ...
    :cond_0
    invoke-direct {p0, p1}, shouldHaveDefaultChannel(Lcom/android/server/notification/PreferencesHelper$PackagePreferences;)Z
...
.method private getOrCreatePackagePreferencesLocked(Ljava/lang/String;I)Lcom/android/server/notification/PreferencesHelper$PackagePreferences;
    ...
    invoke-direct/range {v0 .. v7}, getOrCreatePackagePreferencesLocked(Ljava/lang/String;IIIIZZ)Lcom/android/server/notification/PreferencesHelper$PackagePreferences;
...
.method private getOrCreatePackagePreferencesLocked(Ljava/lang/String;IIIIZZ)Lcom/android/server/notification/PreferencesHelper$PackagePreferences;
    ...
    invoke-static {p1, p2}, packagePreferencesKey(Ljava/lang/String;I)Ljava/lang/String;
    ...
    :cond_0
    iget-object v2, p0, mPackagePreferences:Landroid/util/ArrayMap;
    ...
    :try_start_0
    invoke-direct {p0, v2}, createDefaultChannelIfNeededLocked(Lcom/android/server/notification/PreferencesHelper$PackagePreferences;)Z
    :try_end_0
    ...
    iget-object v1, p0, mRestoredWithoutUids:Landroid/util/ArrayMap;
    ...
    :cond_1
    iget-object v1, p0, mPackagePreferences:Landroid/util/ArrayMap;
...
.method private getPackageChannels()Ljava/util/Map;
    ...
    :goto_0
    :try_start_0
    iget-object v4, p0, mPackagePreferences:Landroid/util/ArrayMap;
...
.method private syncChannelsBypassingDnd(I)V
    ...
    :goto_0
    iput-boolean v1, p0, mAreChannelsBypassingDnd:Z

    invoke-direct {p0, p1}, updateChannelsBypassingDnd(I)V
...
.method private updateChannelsBypassingDnd(I)V
    ...
    iget-object v0, p0, mPackagePreferences:Landroid/util/ArrayMap;
    ...
    iget-object v3, p0, mPackagePreferences:Landroid/util/ArrayMap;
    ...
    invoke-direct {p0, v3, v5}, channelIsLiveLocked(Lcom/android/server/notification/PreferencesHelper$PackagePreferences;Landroid/app/NotificationChannel;)Z
    ...
    iget-boolean v4, p0, mAreChannelsBypassingDnd:Z

    if-nez v4, :cond_1

    const/4 v4, 0x1

    iput-boolean v4, p0, mAreChannelsBypassingDnd:Z

    invoke-virtual {p0, v4}, updateZenPolicy(Z)V
    ...
    iget-boolean v0, p0, mAreChannelsBypassingDnd:Z

    if-eqz v0, :cond_5

    const/4 v0, 0x0

    iput-boolean v0, p0, mAreChannelsBypassingDnd:Z

    invoke-virtual {p0, v0}, updateZenPolicy(Z)V
...
.method public areBubblesAllowed(Ljava/lang/String;I)Z
    ...
    :try_start_0
    invoke-direct {p0, p1, p2}, getOrCreatePackagePreferencesLocked(Ljava/lang/String;I)Lcom/android/server/notification/PreferencesHelper$PackagePreferences;
...
.method public badgingEnabled(Landroid/os/UserHandle;)Z
    ...
    :cond_0
    iget-object v2, p0, mBadgingEnabled:Landroid/util/SparseBooleanArray;
    ...
    :cond_2
    iget-object v1, p0, mBadgingEnabled:Landroid/util/SparseBooleanArray;
...
.method public bubblesEnabled(Landroid/os/UserHandle;)Z
    ...
    :cond_0
    iget-object v2, p0, mBubblesEnabled:Landroid/util/SparseBooleanArray;
    ...
    :cond_2
    iget-object v1, p0, mBubblesEnabled:Landroid/util/SparseBooleanArray;
...
.method public clearData(Ljava/lang/String;I)V
    ...
    :try_start_0
    invoke-direct {p0, p1, p2}, getPackagePreferencesLocked(Ljava/lang/String;I)Lcom/android/server/notification/PreferencesHelper$PackagePreferences;
    ...
    :try_start_1
    invoke-direct {p0, v1}, createDefaultChannelIfNeededLocked(Lcom/android/server/notification/PreferencesHelper$PackagePreferences;)Z

    invoke-direct {p0, v1}, deleteDefaultChannelIfNeededLocked(Lcom/android/server/notification/PreferencesHelper$PackagePreferences;)Z
    :try_end_1
...
.method public createNotificationChannel(Ljava/lang/String;ILandroid/app/NotificationChannel;ZZ)Z
    ...
    iget-object v6, v1, mPackagePreferences:Landroid/util/ArrayMap;

    monitor-enter v6

    :try_start_0
    invoke-direct/range {p0 .. p2}, getOrCreatePackagePreferencesLocked(Ljava/lang/String;I)Lcom/android/server/notification/PreferencesHelper$PackagePreferences;
    ...
    invoke-direct {v1, v3, v2}, getChannelLog(Landroid/app/NotificationChannel;Ljava/lang/String;)Landroid/metrics/LogMaker;
    ...
    iget-boolean v9, v1, mAreChannelsBypassingDnd:Z
    ...
    invoke-direct {v1, v9}, updateChannelsBypassingDnd(I)V

    :cond_9
    invoke-direct/range {p0 .. p0}, updateConfig()V
    ...
    :cond_d
    invoke-virtual {v1, v3}, clearLockedFieldsLocked(Landroid/app/NotificationChannel;)V
    ...
    :cond_e
    iget-object v10, v1, mAppOrChannelList:[Ljava/lang/String;
    ...
    iget-boolean v7, v1, mAreChannelsBypassingDnd:Z
    ...
    invoke-direct {v1, v4}, updateChannelsBypassingDnd(I)V
...
.method public createNotificationChannelGroup(Ljava/lang/String;ILandroid/app/NotificationChannelGroup;Z)V
    ...
    invoke-direct {p0, v4, p1}, getChannelGroupLog(Ljava/lang/String;Ljava/lang/String;)Landroid/metrics/LogMaker;
    ...
    invoke-direct {p0, v1}, updateChannelsBypassingDnd(I)V
...
.method public deleteNotificationChannel(Ljava/lang/String;ILjava/lang/String;)V
    ...
    invoke-direct {p0, v2, p1}, getChannelLog(Landroid/app/NotificationChannel;Ljava/lang/String;)Landroid/metrics/LogMaker;
    ...
    invoke-direct {p0, v4}, updateChannelsBypassingDnd(I)V
...
.method public dump(Landroid/util/proto/ProtoOutputStream;Lcom/android/server/notification/NotificationManagerService$DumpFilter;)V
    ...
    invoke-static {p1, v1, v2, p2, v3}, dumpPackagePreferencesLocked(Landroid/util/proto/ProtoOutputStream;JLcom/android/server/notification/NotificationManagerService$DumpFilter;Landroid/util/ArrayMap;)V
    ...
    invoke-static {p1, v0, v1, p2, v2}, dumpPackagePreferencesLocked(Landroid/util/proto/ProtoOutputStream;JLcom/android/server/notification/NotificationManagerService$DumpFilter;Landroid/util/ArrayMap;)V
...
.method public dump(Ljava/io/PrintWriter;Ljava/lang/String;Lcom/android/server/notification/NotificationManagerService$DumpFilter;)V
    ...
    invoke-static {p1, p2, p3, v1}, dumpPackagePreferencesLocked(Ljava/io/PrintWriter;Ljava/lang/String;Lcom/android/server/notification/NotificationManagerService$DumpFilter;Landroid/util/ArrayMap;)V
    ...
    iget-object v0, p0, mRestoredWithoutUids:Landroid/util/ArrayMap;

    invoke-static {p1, p2, p3, v0}, dumpPackagePreferencesLocked(Ljava/io/PrintWriter;Ljava/lang/String;Lcom/android/server/notification/NotificationManagerService$DumpFilter;Landroid/util/ArrayMap;)V
...
.method public dumpBansJson(Lcom/android/server/notification/NotificationManagerService$DumpFilter;)Lorg/json/JSONArray;
    ...
    invoke-virtual {p0}, getPackageBans()Ljava/util/Map;
...
.method public dumpChannelsJson(Lcom/android/server/notification/NotificationManagerService$DumpFilter;)Lorg/json/JSONArray;
    ...
    invoke-direct {p0}, getPackageChannels()Ljava/util/Map;
...
.method public dumpJson(Lcom/android/server/notification/NotificationManagerService$DumpFilter;)Lorg/json/JSONObject;
    ...
    iget-object v3, p0, mRestoredWithoutUids:Landroid/util/ArrayMap;
    ...
    iget-object v5, p0, mPackagePreferences:Landroid/util/ArrayMap;
...
.method public getAppsBypassingDndCount(I)I
    ...
    invoke-direct {p0, v4, v6}, channelIsLiveLocked(Lcom/android/server/notification/PreferencesHelper$PackagePreferences;Landroid/app/NotificationChannel;)Z
...
.method public getNotificationChannelGroup(Ljava/lang/String;Ljava/lang/String;I)Landroid/app/NotificationChannelGroup;
    ...
    :try_start_0
    invoke-direct {p0, p2, p3}, getPackagePreferencesLocked(Ljava/lang/String;I)Lcom/android/server/notification/PreferencesHelper$PackagePreferences;
...
.method public getNotificationChannelGroups(Ljava/lang/String;IZZZ)Landroid/content/pm/ParceledListSlice;
    ...
    iget-object v3, v2, mPackagePreferences:Landroid/util/ArrayMap;
...
.method public getNotificationChannelsBypassingDnd(Ljava/lang/String;I)Landroid/content/pm/ParceledListSlice;
    ...
    invoke-direct {p0, v2, v4}, channelIsLiveLocked(Lcom/android/server/notification/PreferencesHelper$PackagePreferences;Landroid/app/NotificationChannel;)Z
...
.method public lockChannelsForOEM([Ljava/lang/String;)V
    ...
    :goto_1
    iget-object v7, p0, mPackagePreferences:Landroid/util/ArrayMap;

    monitor-enter v7

    :try_start_0
    iget-object v9, p0, mPackagePreferences:Landroid/util/ArrayMap;
...
.method public onPackagesChanged(ZI[Ljava/lang/String;[I)Z
    ...
    :try_start_0
    iget-object v6, p0, mPackagePreferences:Landroid/util/ArrayMap;

    invoke-static {v3, v4}, packagePreferencesKey(Ljava/lang/String;I)Ljava/lang/String;
    ...
    iget-object v5, p0, mRestoredWithoutUids:Landroid/util/ArrayMap;
    ...
    iget-object v4, p0, mRestoredWithoutUids:Landroid/util/ArrayMap;
    ...
    invoke-static {v7, v8}, packagePreferencesKey(Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-direct {p0, v3, v6}, getPackagePreferencesLocked(Ljava/lang/String;I)Lcom/android/server/notification/PreferencesHelper$PackagePreferences;

    move-result-object v6

    if-eqz v6, :cond_4

    invoke-direct {p0, v6}, createDefaultChannelIfNeededLocked(Lcom/android/server/notification/PreferencesHelper$PackagePreferences;)Z

    move-result v7

    or-int/2addr v1, v7

    invoke-direct {p0, v6}, deleteDefaultChannelIfNeededLocked(Lcom/android/server/notification/PreferencesHelper$PackagePreferences;)Z
...
.method public onUserSwitched(I)V
    ...
    invoke-direct {p0, p1}, syncChannelsBypassingDnd(I)V
...
.method public readXml(Lorg/xmlpull/v1/XmlPullParser;ZI)V
    ...
    :cond_1
    iget-object v13, v9, mPackagePreferences:Landroid/util/ArrayMap;

    monitor-enter v13

    :try_start_0
    iget-object v0, v9, mRestoredWithoutUids:Landroid/util/ArrayMap;
    ...
    iput-boolean v0, v9, mHideSilentStatusBarIcons:Z
    :try_end_4
    ...
    :try_start_6
    iget-object v0, v9, mPm:Landroid/content/pm/PackageManager;
    ...
    :try_start_8
    invoke-direct/range {v1 .. v8}, getOrCreatePackagePreferencesLocked(Ljava/lang/String;IIIIZZ)Lcom/android/server/notification/PreferencesHelper$PackagePreferences;
    ...
    iget-object v15, v9, mContext:Landroid/content/Context;
    ...
    :cond_f
    :try_start_9
    invoke-direct {v9, v1}, deleteDefaultChannelIfNeededLocked(Lcom/android/server/notification/PreferencesHelper$PackagePreferences;)Z
    :try_end_9
...
.method public setEnabled(Ljava/lang/String;IZ)V
    ...
    invoke-virtual {p0, p1, p2}, getImportance(Ljava/lang/String;I)I
    ...
    :cond_2
    invoke-virtual {p0, p1, p2, v1}, setImportance(Ljava/lang/String;II)V
...
.method public setHideSilentStatusIcons(Z)V
    ...
    iput-boolean p1, p0, mHideSilentStatusBarIcons:Z
...
.method public shouldHideSilentStatusIcons()Z
    ...
    iget-boolean v0, p0, mHideSilentStatusBarIcons:Z
...
.method public updateBadgingEnabled()V
    ...
    iget-object v0, p0, mBadgingEnabled:Landroid/util/SparseBooleanArray;
    ...
    iput-object v0, p0, mBadgingEnabled:Landroid/util/SparseBooleanArray;
    ...
    iget-object v3, p0, mBadgingEnabled:Landroid/util/SparseBooleanArray;
    ...
    :goto_1
    iget-object v7, p0, mBadgingEnabled:Landroid/util/SparseBooleanArray;
...
.method public updateBubblesEnabled()V
    ...
    iget-object v0, p0, mBubblesEnabled:Landroid/util/SparseBooleanArray;
    ...
    iput-object v0, p0, mBubblesEnabled:Landroid/util/SparseBooleanArray;
    ...
    iget-object v3, p0, mBubblesEnabled:Landroid/util/SparseBooleanArray;
    ...
    :goto_1
    iget-object v7, p0, mBubblesEnabled:Landroid/util/SparseBooleanArray;
...
.method public updateDefaultApps(ILandroid/util/ArraySet;Landroid/util/ArraySet;)V
    ...
    invoke-direct {p0, v3, v4}, getOrCreatePackagePreferencesLocked(Ljava/lang/String;I)Lcom/android/server/notification/PreferencesHelper$PackagePreferences;
...
.method public updateNotificationChannel(Ljava/lang/String;ILandroid/app/NotificationChannel;Z)V
    ...
    invoke-virtual {p0, v2, p3}, lockFieldsForUpdateLocked(Landroid/app/NotificationChannel;Landroid/app/NotificationChannel;)V
    ...
    invoke-virtual {p0, p1, p2}, onlyHasDefaultChannel(Ljava/lang/String;I)Z
    ...
    invoke-direct {p0, p3, p1}, getChannelLog(Landroid/app/NotificationChannel;Ljava/lang/String;)Landroid/metrics/LogMaker;
    ...
    invoke-direct {p0, v3}, updateChannelsBypassingDnd(I)V
...
.method public writeXml(Lorg/xmlpull/v1/XmlSerializer;ZI)V
    ...
    iget-boolean v2, p0, mHideSilentStatusBarIcons:Z
