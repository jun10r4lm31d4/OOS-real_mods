...
.method constructor <init>(Lcom/android/server/notification/NotificationManagerService;Landroid/os/Handler;)V
    ...
    iput-object p1, p0, NOTIFICATION_BADGING_URI:Landroid/net/Uri;
    ...
    iput-object p1, p0, NOTIFICATION_BUBBLES_URI:Landroid/net/Uri;
    ...
    iput-object p1, p0, NOTIFICATION_LIGHT_PULSE_URI:Landroid/net/Uri;
    ...
    iput-object p1, p0, NOTIFICATION_RATE_LIMIT_URI:Landroid/net/Uri;
    ...
    iput-object p1, p0, NOTIFICATION_VIBRATE_WHEN_MUTE:Landroid/net/Uri;
    ...
    iput-object p1, p0, NOTIFICATION_LIGHT_PULSE_COLOR_URI:Landroid/net/Uri;

    const-string p1, "app_locker_switch"

    iput-object p1, p0, NOTIFICATION_APP_LOCKER_SWITCH_KEY:Ljava/lang/String;
    ...
    iput-object p1, p0, NOTIFICATION_APP_LOCKER_SWITCH:Landroid/net/Uri;

    const-string p1, "driving_mode_state"

    iput-object p1, p0, DRIVING_MODE_STATE:Ljava/lang/String;
    ...
    iput-object p1, p0, DRIVING_MODE_STATE_URI:Landroid/net/Uri;
    ...
    iput-object p1, p0, NOTIFICATION_HEADSET_MODE_URI:Landroid/net/Uri;

    const-string p1, "esport_mode_enabled"

    iput-object p1, p0, ESPORT_MODE_KEY:Ljava/lang/String;
    ...
    iput-object p1, p0, ESPORT_MODE_ENABLED:Landroid/net/Uri;
...
.method observe()V
    ...
    iget-object v1, p0, NOTIFICATION_BADGING_URI:Landroid/net/Uri;
    ...
    iget-object v1, p0, NOTIFICATION_RATE_LIMIT_URI:Landroid/net/Uri;

    invoke-virtual {v0, v1, v3, p0, v2}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;I)V

    iget-object v1, p0, NOTIFICATION_BUBBLES_URI:Landroid/net/Uri;

    invoke-virtual {v0, v1, v3, p0, v2}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;I)V

    iget-object v1, p0, NOTIFICATION_VIBRATE_WHEN_MUTE:Landroid/net/Uri;
    ...
    iget-object v1, p0, NOTIFICATION_LIGHT_PULSE_COLOR_URI:Landroid/net/Uri;

    invoke-virtual {v0, v1, v3, p0, v2}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;I)V

    iget-object v1, p0, NOTIFICATION_APP_LOCKER_SWITCH:Landroid/net/Uri;

    invoke-virtual {v0, v1, v3, p0, v2}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;I)V

    iget-object v1, p0, DRIVING_MODE_STATE_URI:Landroid/net/Uri;
    ...
    iget-object v1, p0, NOTIFICATION_HEADSET_MODE_URI:Landroid/net/Uri;

    invoke-virtual {v0, v1, v3, p0, v2}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;I)V

    :cond_0
    iget-object v1, p0, ESPORT_MODE_ENABLED:Landroid/net/Uri;
...
.method public update(Landroid/net/Uri;)V
    ...
    iget-object v4, p0, NOTIFICATION_LIGHT_PULSE_URI:Landroid/net/Uri;
    ...
    iget-object v4, p0, NOTIFICATION_RATE_LIMIT_URI:Landroid/net/Uri;
    ...
    iget-object v4, p0, NOTIFICATION_BADGING_URI:Landroid/net/Uri;
    ...
    iget-object v4, p0, NOTIFICATION_BUBBLES_URI:Landroid/net/Uri;
    ...
    iget-object v4, p0, NOTIFICATION_VIBRATE_WHEN_MUTE:Landroid/net/Uri;
    ...
    iget-object v4, p0, NOTIFICATION_LIGHT_PULSE_COLOR_URI:Landroid/net/Uri;
    ...
    iget-object v4, p0, NOTIFICATION_APP_LOCKER_SWITCH:Landroid/net/Uri;
    ...
    iget-object v4, p0, DRIVING_MODE_STATE_URI:Landroid/net/Uri;
    ...
    iget-object v4, p0, NOTIFICATION_HEADSET_MODE_URI:Landroid/net/Uri;
    ...
    iget-object v4, p0, ESPORT_MODE_ENABLED:Landroid/net/Uri;
