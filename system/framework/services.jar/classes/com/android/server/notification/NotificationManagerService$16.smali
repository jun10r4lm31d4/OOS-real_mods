...
.method constructor <init>(Lcom/android/server/notification/NotificationManagerService;Lcom/android/server/notification/ManagedServices$ManagedServiceInfo;IILjava/lang/String;IIIIZLjava/lang/String;)V
    ...
    iput p7, p0, val$mustHaveFlags:I

    iput p8, p0, val$mustNotHaveFlags:I

    iput p9, p0, val$reason:I

    iput-boolean p10, p0, val$doit:Z

    iput-object p11, p0, val$channelId:Ljava/lang/String;
...
.method public run()V
    ...
    iget-object v0, v1, val$listener:Lcom/android/server/notification/ManagedServices$ManagedServiceInfo;
    ...
    iget v2, v1, val$callingUid:I

    iget v3, v1, val$callingPid:I

    iget-object v4, v1, val$pkg:Ljava/lang/String;

    iget v5, v1, val$userId:I

    iget v6, v1, val$mustHaveFlags:I

    iget v7, v1, val$mustNotHaveFlags:I

    iget v8, v1, val$reason:I
    ...
    :try_start_0
    iget v0, v1, val$mustHaveFlags:I

    iget v3, v1, val$mustNotHaveFlags:I
    ...
    iget-object v10, v1, this$0:Lcom/android/server/notification/NotificationManagerService;

    iget-object v0, v1, this$0:Lcom/android/server/notification/NotificationManagerService;

    iget-object v11, v0, Lcom/android/server/notification/NotificationManagerService;->mNotificationList:Ljava/util/ArrayList;

    iget v12, v1, val$callingUid:I

    iget v13, v1, val$callingPid:I

    iget-object v14, v1, val$pkg:Ljava/lang/String;

    const/4 v15, 0x1

    iget-object v0, v1, val$channelId:Ljava/lang/String;

    const/16 v18, 0x0

    iget v3, v1, val$userId:I

    const/16 v20, 0x0

    iget v4, v1, val$reason:I
    ...
    iget v4, v1, val$callingUid:I

    iget v5, v1, val$callingPid:I

    iget-object v6, v1, val$pkg:Ljava/lang/String;

    const/16 v29, 0x1

    iget-object v7, v1, val$channelId:Ljava/lang/String;

    const/16 v32, 0x0

    iget v8, v1, val$userId:I

    const/16 v34, 0x0

    iget v10, v1, val$reason:I
