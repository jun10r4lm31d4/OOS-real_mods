...
.method static synthetic access$200(Lcom/android/server/notification/ValidateNotificationPeople;)I
    .locals 1
...
.method static synthetic access$208(Lcom/android/server/notification/ValidateNotificationPeople;)I
    .locals 2
...
.method private getContextAsUser(Landroid/os/UserHandle;)Landroid/content/Context;
    ...
    iget-object v0, p0, mUserToContextMap:Ljava/util/Map;
    ...
    :try_start_0
    iget-object v1, p0, mBaseContext:Landroid/content/Context;
    ...
    iget-object v1, p0, mUserToContextMap:Ljava/util/Map;
...
.method public static getExtraPeople(Landroid/os/Bundle;)[Ljava/lang/String;
    ...
    invoke-static {p0, v0}, getExtraPeopleForKey(Landroid/os/Bundle;Ljava/lang/String;)[Ljava/lang/String;

    move-result-object v0

    const-string v1, "android.people"

    invoke-static {p0, v1}, getExtraPeopleForKey(Landroid/os/Bundle;Ljava/lang/String;)[Ljava/lang/String;

    move-result-object v1

    invoke-static {v1, v0}, combineLists([Ljava/lang/String;[Ljava/lang/String;)[Ljava/lang/String;
...
.method private searchContacts(Landroid/content/Context;Landroid/net/Uri;)Lcom/android/server/notification/ValidateNotificationPeople$LookupResult;
    ...
    sget-object v5, LOOKUP_PROJECTION:[Ljava/lang/String;
...
.method private validatePeople(Landroid/content/Context;Lcom/android/server/notification/NotificationRecord;)Lcom/android/server/notification/RankingReconsideration;
    ...
    invoke-direct/range {v0 .. v5}, validatePeople(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;Ljava/util/List;[F)Lcom/android/server/notification/ValidateNotificationPeople$PeopleRankingReconsideration;
    ...
    iget-object v3, p0, mUsageStats:Lcom/android/server/notification/NotificationUsageStats;
...
.method private validatePeople(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;Ljava/util/List;[F)Lcom/android/server/notification/ValidateNotificationPeople$PeopleRankingReconsideration;
    ...
    invoke-static/range {p3 .. p3}, getExtraPeople(Landroid/os/Bundle;)[Ljava/lang/String;
    ...
    :cond_3
    iget-object v6, v7, mPeopleCache:Landroid/util/LruCache;
    ...
    invoke-direct {v7, v0, v5}, getCacheKey(ILjava/lang/String;)Ljava/lang/String;

    move-result-object v0

    iget-object v13, v7, mPeopleCache:Landroid/util/LruCache;
...
.method public getContactAffinity(Landroid/os/UserHandle;Landroid/os/Bundle;IF)F
    ...
    invoke-direct/range {v4 .. v9}, validatePeople(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;Ljava/util/List;[F)Lcom/android/server/notification/ValidateNotificationPeople$PeopleRankingReconsideration;
...
.method public process(Lcom/android/server/notification/NotificationRecord;)Lcom/android/server/notification/RankingReconsideration;
    ...
    invoke-direct {p0, v0}, getContextAsUser(Landroid/os/UserHandle;)Landroid/content/Context;
