...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mSnoozedForAlarm:Landroid/util/ArraySet;
...
.method private conditionSnoozed(Landroid/net/Uri;)Z
    ...
    iget-object v0, p0, mSnoozedForAlarm:Landroid/util/ArraySet;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, mSnoozedForAlarm:Landroid/util/ArraySet;
...
.method private evaluateSubscriptions()V
    ...
    iget-object v12, p0, mSubscriptions:Landroid/util/ArrayMap;

    monitor-enter v12

    :try_start_0
    iget-object v1, p0, mSubscriptions:Landroid/util/ArrayMap;
    ...
    :goto_0
    invoke-direct {p0, v1}, setRegistered(Z)V
    ...
    invoke-virtual/range {v1 .. v7}, evaluateSubscriptionLocked(Landroid/net/Uri;Landroid/service/notification/ScheduleCalendar;JJ)Landroid/service/notification/Condition;
    ...
    invoke-virtual {p0, v1}, notifyConditions([Landroid/service/notification/Condition;)V

    iget-wide v1, p0, mNextAlarmTime:J

    invoke-direct {p0, v8, v9, v1, v2}, updateAlarm(JJ)V
...
.method private readSnoozed()V
    ...
    :cond_1
    iget-object v7, p0, mSnoozedForAlarm:Landroid/util/ArraySet;
...
.method private removeSnoozed(Landroid/net/Uri;)V
    ...
    invoke-direct {p0}, saveSnoozedLocked()V
...
.method public dump(Ljava/io/PrintWriter;Lcom/android/server/notification/NotificationManagerService$DumpFilter;)V
    ...
    invoke-direct {p0, v3, v7, v8}, meetsSchedule(Landroid/service/notification/ScheduleCalendar;J)Z
...
.method evaluateSubscriptionLocked(Landroid/net/Uri;Landroid/service/notification/ScheduleCalendar;JJ)Landroid/service/notification/Condition;
    ...
    invoke-static {p5, p6}, ts(J)Ljava/lang/String;
    ...
    invoke-direct {p0, p1, v2, v0}, createCondition(Landroid/net/Uri;ILjava/lang/String;)Landroid/service/notification/Condition;

    move-result-object v0

    invoke-direct {p0, p1}, removeSnoozed(Landroid/net/Uri;)V
    ...
    invoke-direct {p0, p1}, conditionSnoozed(Landroid/net/Uri;)Z
    ...
    invoke-direct {p0, p1, v3, v0}, createCondition(Landroid/net/Uri;ILjava/lang/String;)Landroid/service/notification/Condition;
    ...
    invoke-virtual {p0, p1}, addSnoozed(Landroid/net/Uri;)V
    ...
    invoke-direct {p0, p1, v1, v0}, createCondition(Landroid/net/Uri;ILjava/lang/String;)Landroid/service/notification/Condition;
    ...
    iget-wide v5, p0, mNextAlarmTime:J
    ...
    :cond_5
    iput-wide v1, p0, mNextAlarmTime:J
...
.method public onConnected()V
    ...
    invoke-direct {p0}, readSnoozed()V
...
.method public onSubscribe(Landroid/net/Uri;)V
    ...
    invoke-direct {p0, p1, v0, v1}, createCondition(Landroid/net/Uri;ILjava/lang/String;)Landroid/service/notification/Condition;
