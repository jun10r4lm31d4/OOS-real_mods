...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Looper;Lcom/android/server/notification/ConditionProviders;)V
    ...
    iput-object v2, p0, mHandler:Lcom/android/server/notification/ZenModeHelper$H;

    iget-object v1, p0, mMetrics:Lcom/android/server/notification/ZenModeHelper$Metrics;

    invoke-virtual {p0, v1}, addCallback(Lcom/android/server/notification/ZenModeHelper$Callback;)V
    ...
    invoke-direct {p0, v1}, readDefaultConfig(Landroid/content/res/Resources;)Landroid/service/notification/ZenModeConfig;

    move-result-object v1

    iput-object v1, p0, mDefaultConfig:Landroid/service/notification/ZenModeConfig;

    invoke-direct {p0}, updateDefaultAutomaticRuleNames()V
    ...
    iput-object v0, p0, mServiceConfig:Lcom/android/server/notification/ManagedServices$Config;
...
.method static synthetic access$1300(Lcom/android/server/notification/ZenModeHelper;Landroid/service/notification/ZenModeConfig;Ljava/lang/String;Landroid/content/ComponentName;Z)V
    ...
    invoke-direct {p0, p1, p2, p3, p4}, applyConfig(Landroid/service/notification/ZenModeConfig;Ljava/lang/String;Landroid/content/ComponentName;Z)V
...
.method static synthetic access$600(Lcom/android/server/notification/ZenModeHelper;ILandroid/net/Uri;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-direct/range {p0 .. p5}, setManualZenMode(ILandroid/net/Uri;Ljava/lang/String;Ljava/lang/String;Z)V
...
.method private applyConfig(Landroid/service/notification/ZenModeConfig;Ljava/lang/String;Landroid/content/ComponentName;Z)V
    ...
    invoke-virtual {p0, p2, p4}, evaluateZenMode(Ljava/lang/String;Z)V

    iget-object v1, p0, mConditions:Lcom/android/server/notification/ZenModeConditions;
...
.method private cleanUpZenRules()V
    ...
    invoke-virtual {p0, v3, v4, v5}, setConfigLocked(Landroid/service/notification/ZenModeConfig;Landroid/content/ComponentName;Ljava/lang/String;)Z
...
.method private computeZenMode()I
    ...
    invoke-static {v4}, zenSeverity(I)I

    move-result v4

    invoke-static {v1}, zenSeverity(I)I
...
.method private findMatchingRule(Landroid/service/notification/ZenModeConfig;Landroid/net/Uri;Landroid/service/notification/Condition;)Landroid/service/notification/ZenModeConfig$ZenRule;
    ...
    invoke-direct {p0, p2, p3, v0}, ruleMatches(Landroid/net/Uri;Landroid/service/notification/Condition;Landroid/service/notification/ZenModeConfig$ZenRule;)Z
    ...
    invoke-direct {p0, p2, p3, v1}, ruleMatches(Landroid/net/Uri;Landroid/service/notification/Condition;Landroid/service/notification/ZenModeConfig$ZenRule;)Z
...
.method private getServiceInfo(Landroid/content/ComponentName;)Landroid/content/pm/ServiceInfo;
    ...
    iget-object v6, p0, mServiceConfig:Lcom/android/server/notification/ManagedServices$Config;
...
.method private loadConfigForUser(ILjava/lang/String;)V
    ...
    :try_start_0
    invoke-virtual {p0, v0, v2, p2}, setConfigLocked(Landroid/service/notification/ZenModeConfig;Landroid/content/ComponentName;Ljava/lang/String;)Z

    monitor-exit v1
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-direct {p0}, cleanUpZenRules()V
...
.method private setAutomaticZenRuleStateLocked(Landroid/service/notification/ZenModeConfig;Landroid/service/notification/ZenModeConfig$ZenRule;Landroid/service/notification/Condition;)V
    ...
    invoke-direct {p0, p2}, updateSnoozing(Landroid/service/notification/ZenModeConfig$ZenRule;)Z

    iget-object v0, p2, Landroid/service/notification/ZenModeConfig$ZenRule;->component:Landroid/content/ComponentName;

    const-string v1, "conditionChanged"

    invoke-virtual {p0, p1, v0, v1}, setConfigLocked(Landroid/service/notification/ZenModeConfig;Landroid/content/ComponentName;Ljava/lang/String;)Z
...
.method private setConfigLocked(Landroid/service/notification/ZenModeConfig;Ljava/lang/String;Landroid/content/ComponentName;Z)Z
    ...
    :goto_0
    iget-object v5, p0, mConfig:Landroid/service/notification/ZenModeConfig;
    ...
    invoke-direct {p0, p2}, updateConsolidatedPolicy(Ljava/lang/String;)V
    ...
    iget-object v5, p0, mHandler:Lcom/android/server/notification/ZenModeHelper$H;
...
.method private setManualZenMode(ILandroid/net/Uri;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    :goto_1
    invoke-direct {p0, v1, p3, v3, p5}, setConfigLocked(Landroid/service/notification/ZenModeConfig;Ljava/lang/String;Landroid/content/ComponentName;Z)Z
...
.method private showZenUpgradeNotification(I)V
    ...
    iget-boolean v1, p0, mIsBootComplete:Z
    ...
    iget-object v2, p0, mNotificationManager:Landroid/app/NotificationManager;

    const/16 v5, 0x30

    invoke-virtual {p0}, createZenUpgradeNotification()Landroid/app/Notification;
...
.method private updateConsolidatedPolicy(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v1, v2}, applyCustomPolicy(Landroid/service/notification/ZenPolicy;Landroid/service/notification/ZenModeConfig$ZenRule;)V
    ...
    invoke-direct {p0, v1, v3}, applyCustomPolicy(Landroid/service/notification/ZenPolicy;Landroid/service/notification/ZenModeConfig$ZenRule;)V
    ...
    iget-object v3, p0, mConsolidatedPolicy:Landroid/app/NotificationManager$Policy;
    ...
    iput-object v2, p0, mConsolidatedPolicy:Landroid/app/NotificationManager$Policy;

    invoke-direct {p0}, dispatchOnConsolidatedPolicyChanged()V
...
.method public addAutomaticZenRule(Landroid/app/AutomaticZenRule;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, p1}, isSystemRule(Landroid/app/AutomaticZenRule;)Z
    ...
    invoke-direct {p0, v0}, getServiceInfo(Landroid/content/ComponentName;)Landroid/content/pm/ServiceInfo;
    ...
    invoke-direct {p0, v2}, getActivityInfo(Landroid/content/ComponentName;)Landroid/content/pm/ActivityInfo;
    ...
    invoke-virtual {p0, v3}, getCurrentInstanceCount(Landroid/content/ComponentName;)I
    ...
    invoke-virtual {p0, v4}, getCurrentInstanceCount(Landroid/content/ComponentName;)I
    ...
    invoke-direct {p0, p1, v3, v1}, populateZenRule(Landroid/app/AutomaticZenRule;Landroid/service/notification/ZenModeConfig$ZenRule;Z)V
    ...
    invoke-direct {p0, v2, p2, v4, v1}, setConfigLocked(Landroid/service/notification/ZenModeConfig;Ljava/lang/String;Landroid/content/ComponentName;Z)Z
...
.method protected applyRestrictions()V
    ...
    :goto_2
    iget-object v8, v0, mConsolidatedPolicy:Landroid/app/NotificationManager$Policy;

    invoke-virtual {v8}, Landroid/app/NotificationManager$Policy;->allowCalls()Z

    move-result v8

    iget-object v9, v0, mConsolidatedPolicy:Landroid/app/NotificationManager$Policy;

    invoke-virtual {v9}, Landroid/app/NotificationManager$Policy;->allowRepeatCallers()Z

    move-result v9

    iget-object v10, v0, mConsolidatedPolicy:Landroid/app/NotificationManager$Policy;

    invoke-virtual {v10}, Landroid/app/NotificationManager$Policy;->allowSystem()Z

    move-result v10

    iget-object v11, v0, mConsolidatedPolicy:Landroid/app/NotificationManager$Policy;

    invoke-virtual {v11}, Landroid/app/NotificationManager$Policy;->allowMedia()Z

    move-result v11

    iget-object v12, v0, mConsolidatedPolicy:Landroid/app/NotificationManager$Policy;

    invoke-virtual {v12}, Landroid/app/NotificationManager$Policy;->allowAlarms()Z

    move-result v12

    iget-wide v13, v0, mSuppressedEffects:J
    ...
    :cond_4
    iget-wide v2, v0, mSuppressedEffects:J
    ...
    iget-object v14, v0, mConsolidatedPolicy:Landroid/app/NotificationManager$Policy;
    ...
    invoke-virtual {v0, v1, v7, v6}, applyRestrictions(ZZI)V
    ...
    :cond_f
    :goto_d
    invoke-virtual {v0, v1, v14, v6}, applyRestrictions(ZZI)V
    ...
    invoke-virtual {v0, v1, v14, v6, v2}, applyRestrictions(ZZII)V
    ...
    :goto_17
    invoke-virtual {v0, v1, v2, v6}, applyRestrictions(ZZI)V
...
.method protected applyRestrictions(ZZI)V
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, applyRestrictions(ZZII)V
...
.method protected applyRestrictions(ZZII)V
    ...
    iget-object v3, p0, mPriorityOnlyDndExemptPackages:[Ljava/lang/String;
...
.method protected createZenUpgradeNotification()Landroid/app/Notification;
    ...
    invoke-virtual {p0}, getConsolidatedNotificationPolicy()Landroid/app/NotificationManager$Policy;
...
.method dump(Landroid/util/proto/ProtoOutputStream;)V
    ...
    iget-wide v3, p0, mSuppressedEffects:J
...
.method public dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    iget-object v1, p0, mConsolidatedPolicy:Landroid/app/NotificationManager$Policy;
    ...
    iget-wide v1, p0, mSuppressedEffects:J

    invoke-virtual {p1, v1, v2}, Ljava/io/PrintWriter;->println(J)V

    iget-object v1, p0, mFiltering:Lcom/android/server/notification/ZenModeFiltering;
...
.method protected evaluateZenMode(Ljava/lang/String;Z)V
    ...
    :cond_1
    iget-object v0, p0, mConsolidatedPolicy:Landroid/app/NotificationManager$Policy;
    ...
    invoke-direct {p0}, computeZenMode()I
    ...
    iget v3, p0, mZenMode:I

    invoke-virtual {p0, v3}, setZenModeSetting(I)V

    invoke-direct {p0, p1}, updateConsolidatedPolicy(Ljava/lang/String;)V
    ...
    :cond_3
    invoke-virtual {p0}, applyZenToRingerMode()V

    :cond_4
    invoke-virtual {p0}, applyRestrictions()V

    if-eq v2, v1, :cond_5

    iget-object v3, p0, mHandler:Lcom/android/server/notification/ZenModeHelper$H;
...
.method public getAutomaticZenRule(Ljava/lang/String;)Landroid/app/AutomaticZenRule;
    ...
    :cond_1
    invoke-virtual {p0, v1}, canManageAutomaticZenRule(Landroid/service/notification/ZenModeConfig$ZenRule;)Z

    move-result v0

    if-eqz v0, :cond_2

    invoke-virtual {p0, v1}, createAutomaticZenRule(Landroid/service/notification/ZenModeConfig$ZenRule;)Landroid/app/AutomaticZenRule;
...
.method public getSuppressedEffects()J
    ...
    iget-wide v0, p0, mSuppressedEffects:J
...
.method public getZenRules()Ljava/util/List;
    ...
    invoke-virtual {p0, v3}, canManageAutomaticZenRule(Landroid/service/notification/ZenModeConfig$ZenRule;)Z
...
.method public initZenMode()V
    ...
    invoke-virtual {p0, v1, v0}, evaluateZenMode(Ljava/lang/String;Z)V
...
.method public onSystemReady()V
    ...
    iput-object v0, p0, mAudioManager:Landroid/media/AudioManagerInternal;

    iget-object v0, p0, mAudioManager:Landroid/media/AudioManagerInternal;

    if-eqz v0, :cond_1

    iget-object v2, p0, mRingerModeDelegate:Lcom/android/server/notification/ZenModeHelper$RingerModeDelegate;
    ...
    iput-boolean v0, p0, mIsBootComplete:Z

    iget v0, p0, mZenMode:I

    invoke-direct {p0, v0}, showZenUpgradeNotification(I)V
...
.method public onUserSwitched(I)V
    ...
    invoke-direct {p0, p1, v0}, loadConfigForUser(ILjava/lang/String;)V
...
.method public readXml(Lorg/xmlpull/v1/XmlPullParser;ZI)V
    ...
    iget-object v12, v1, mDefaultConfig:Landroid/service/notification/ZenModeConfig;
    ...
    :cond_8
    iget-object v9, v1, mConfig:Landroid/service/notification/ZenModeConfig;

    monitor-enter v9

    :try_start_0
    invoke-virtual {v1, v2, v4, v12}, setConfigLocked(Landroid/service/notification/ZenModeConfig;Landroid/content/ComponentName;Ljava/lang/String;)Z
...
.method public removeAutomaticZenRule(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v1, p2, v2, v4}, setConfigLocked(Landroid/service/notification/ZenModeConfig;Ljava/lang/String;Landroid/content/ComponentName;Z)Z
...
.method public removeAutomaticZenRules(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v4}, canManageAutomaticZenRule(Landroid/service/notification/ZenModeConfig$ZenRule;)Z
    ...
    invoke-direct {p0, v1, p2, v2, v3}, setConfigLocked(Landroid/service/notification/ZenModeConfig;Ljava/lang/String;Landroid/content/ComponentName;Z)Z
...
.method public requestFromListener(Landroid/content/ComponentName;I)V
    ...
    invoke-virtual {p0, v1, v0, v2, v3}, setManualZenMode(ILandroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)V
...
.method public setAutomaticZenRuleState(Landroid/net/Uri;Landroid/service/notification/Condition;)V
    ...
    invoke-direct {p0, v1, p1, p2}, findMatchingRule(Landroid/service/notification/ZenModeConfig;Landroid/net/Uri;Landroid/service/notification/Condition;)Landroid/service/notification/ZenModeConfig$ZenRule;

    move-result-object v2

    invoke-direct {p0, v1, v2, p2}, setAutomaticZenRuleStateLocked(Landroid/service/notification/ZenModeConfig;Landroid/service/notification/ZenModeConfig$ZenRule;Landroid/service/notification/Condition;)V
...
.method public setConfig(Landroid/service/notification/ZenModeConfig;Landroid/content/ComponentName;Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-virtual {p0, p1, p2, p3}, setConfigLocked(Landroid/service/notification/ZenModeConfig;Landroid/content/ComponentName;Ljava/lang/String;)Z
...
.method public setConfigLocked(Landroid/service/notification/ZenModeConfig;Landroid/content/ComponentName;Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1, p3, p2, v0}, setConfigLocked(Landroid/service/notification/ZenModeConfig;Ljava/lang/String;Landroid/content/ComponentName;Z)Z
...
.method public setManualZenMode(ILandroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct/range {v0 .. v5}, setManualZenMode(ILandroid/net/Uri;Ljava/lang/String;Ljava/lang/String;Z)V
...
.method public setNotificationPolicy(Landroid/app/NotificationManager$Policy;)V
    ...
    invoke-virtual {p0, v1, v2, v3}, setConfigLocked(Landroid/service/notification/ZenModeConfig;Landroid/content/ComponentName;Ljava/lang/String;)Z
...
.method setPriorityOnlyDndExemptPackages([Ljava/lang/String;)V
    ...
    iput-object p1, p0, mPriorityOnlyDndExemptPackages:[Ljava/lang/String;
...
.method public setSuppressedEffects(J)V
    ...
    :cond_0
    iput-wide p1, p0, mSuppressedEffects:J
...
.method protected setZenModeSetting(I)V
    ...
    invoke-direct {p0, p1}, showZenUpgradeNotification(I)V
...
.method public updateAutomaticZenRule(Ljava/lang/String;Landroid/app/AutomaticZenRule;Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p2, v3, v2}, populateZenRule(Landroid/app/AutomaticZenRule;Landroid/service/notification/ZenModeConfig$ZenRule;Z)V

    iget-object v2, v3, Landroid/service/notification/ZenModeConfig$ZenRule;->component:Landroid/content/ComponentName;

    const/4 v4, 0x1

    invoke-direct {p0, v1, p3, v2, v4}, setConfigLocked(Landroid/service/notification/ZenModeConfig;Ljava/lang/String;Landroid/content/ComponentName;Z)Z
...
.method protected updateDefaultZenRules()V
    ...
    invoke-virtual {p0, v2}, canManageAutomaticZenRule(Landroid/service/notification/ZenModeConfig$ZenRule;)Z
    ...
    invoke-virtual {p0, v2}, createAutomaticZenRule(Landroid/service/notification/ZenModeConfig$ZenRule;)Landroid/app/AutomaticZenRule;

    move-result-object v4

    const-string/jumbo v5, "locale changed"

    invoke-virtual {p0, v3, v4, v5}, updateAutomaticZenRule(Ljava/lang/String;Landroid/app/AutomaticZenRule;Ljava/lang/String;)Z
