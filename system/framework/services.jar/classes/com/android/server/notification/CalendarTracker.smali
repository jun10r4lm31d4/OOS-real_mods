...
.method private meetsAttendee(Landroid/service/notification/ZenModeConfig$EventInfo;ILjava/lang/String;)Z
    ...
    iget-object v4, v13, mUserContext:Landroid/content/Context;
    ...
    sget-object v6, ATTENDEE_PROJECTION:[Ljava/lang/String;
    ...
    invoke-static {v11, v0}, meetsReply(II)Z
    ...
    invoke-static {v0}, attendeeStatusToString(I)Ljava/lang/String;
...
.method public checkEvent(Landroid/service/notification/ZenModeConfig$EventInfo;J)Lcom/android/server/notification/CalendarTracker$CheckEventResult;
    ...
    iget-object v0, v1, mUserContext:Landroid/content/Context;

    invoke-virtual {v0}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v11

    sget-object v13, INSTANCE_PROJECTION:[Ljava/lang/String;
    ...
    :try_start_0
    invoke-direct/range {p0 .. p0}, getCalendarsWithAccess()Landroid/util/ArraySet;
    ...
    invoke-static/range {v30 .. v30}, availabilityToString(I)Ljava/lang/String;
    ...
    invoke-direct {v1, v2, v6, v10}, meetsAttendee(Landroid/service/notification/ZenModeConfig$EventInfo;ILjava/lang/String;)Z

    move-result v22

    if-eqz v22, :cond_f

    sget-boolean v23, DEBUG:Z
