...
.method private constructor <init>(Lcom/android/server/notification/ZenModeHelper;)V
    ...
    iput p1, p0, mPreviousZenMode:I

    const-wide/16 v0, 0x0

    iput-wide v0, p0, mModeLogTimeMs:J

    iput p1, p0, mNumZenRules:I

    iput-wide v0, p0, mRuleCountLogTime:J

    iput p1, p0, mPreviousZenType:I

    iput-wide v0, p0, mTypeLogTimeMs:J
...
.method private emit()V
    ...
    invoke-direct {p0}, emitZenMode()V

    invoke-direct {p0}, emitRules()V

    invoke-direct {p0}, emitDndType()V
...
.method private emitDndType()V
    ...
    iget-wide v2, p0, mTypeLogTimeMs:J
    ...
    :cond_1
    iget-object v7, p0, this$0:Lcom/android/server/notification/ZenModeHelper;
...
.method private emitRules()V
    ...
    iget-wide v2, p0, mRuleCountLogTime:J
    ...
    :cond_1
    iput v5, p0, mNumZenRules:I

    iput-wide v2, p0, mRuleCountLogTime:J
...
.method private emitZenMode()V
    ...
    iget-wide v2, p0, mModeLogTimeMs:J
