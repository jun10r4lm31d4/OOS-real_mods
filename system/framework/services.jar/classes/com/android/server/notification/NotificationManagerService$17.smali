...
.method constructor <init>(Lcom/android/server/notification/NotificationManagerService;Lcom/android/server/notification/ManagedServices$ManagedServiceInfo;IIIIZ)V
    ...
    iput p6, p0, val$reason:I

    iput-boolean p7, p0, val$includeCurrentProfiles:Z
...
.method public run()V
    ...
    :goto_1
    iget v3, v1, val$callingUid:I

    iget v4, v1, val$callingPid:I

    const/4 v5, 0x0

    iget v6, v1, val$userId:I

    const/4 v7, 0x0

    const/4 v8, 0x0

    iget v9, v1, val$reason:I
    ...
    iget-object v11, v1, this$0:Lcom/android/server/notification/NotificationManagerService;

    iget-object v0, v1, this$0:Lcom/android/server/notification/NotificationManagerService;

    iget-object v12, v0, Lcom/android/server/notification/NotificationManagerService;->mNotificationList:Ljava/util/ArrayList;

    iget v13, v1, val$callingUid:I

    iget v14, v1, val$callingPid:I
    ...
    iget-boolean v0, v1, val$includeCurrentProfiles:Z
    ...
    iget-boolean v6, v1, val$includeCurrentProfiles:Z

    iget v7, v1, val$userId:I
    ...
    iget-boolean v4, v1, val$includeCurrentProfiles:Z
