...
.method constructor <init>(Lcom/android/server/notification/NotificationManagerService;IILjava/lang/String;Ljava/lang/String;IIIZIIIILcom/android/server/notification/ManagedServices$ManagedServiceInfo;)V
    ...
    iput p3, p0, mCallingPid:I

    iput-object p4, p0, mPkg:Ljava/lang/String;

    iput-object p5, p0, mTag:Ljava/lang/String;

    iput p6, p0, mId:I

    iput p7, p0, mMustHaveFlags:I

    iput p8, p0, mMustNotHaveFlags:I

    iput-boolean p9, p0, mSendDelete:Z

    iput p10, p0, mUserId:I

    iput p11, p0, mReason:I

    iput p12, p0, mRank:I

    iput p13, p0, mCount:I

    iput-object p14, p0, mListener:Lcom/android/server/notification/ManagedServices$ManagedServiceInfo;
...
.method public run()V
    ...
    iget-object v0, v1, mListener:Lcom/android/server/notification/ManagedServices$ManagedServiceInfo;
    ...
    iget v2, v1, mCallingUid:I

    iget v3, v1, mCallingPid:I

    iget-object v4, v1, mPkg:Ljava/lang/String;

    iget v5, v1, mId:I

    iget-object v6, v1, mTag:Ljava/lang/String;

    iget v7, v1, mUserId:I

    iget v8, v1, mMustHaveFlags:I

    iget v9, v1, mMustNotHaveFlags:I

    iget v10, v1, mReason:I
    ...
    iget-object v5, v1, mPkg:Ljava/lang/String;
    ...
    iget v4, v1, mReason:I

    const/4 v5, 0x1

    if-ne v4, v5, :cond_3

    iget-object v4, v1, this$0:Lcom/android/server/notification/NotificationManagerService;
    ...
    iget v5, v1, mMustNotHaveFlags:I
    ...
    iget-boolean v5, v1, mSendDelete:Z

    iget v6, v1, mReason:I
    ...
    iget-object v12, v1, this$0:Lcom/android/server/notification/NotificationManagerService;

    iget v14, v1, mCallingUid:I

    iget v15, v1, mCallingPid:I

    iget-boolean v3, v1, mSendDelete:Z
    ...
    iget-object v6, v1, mPkg:Ljava/lang/String;

    iget-object v7, v1, mTag:Ljava/lang/String;
