...
.method private constructor <init>()V
    ...
    iput v1, p0, priority:I

    iput v0, p0, visibility:I

    const/4 v0, 0x1

    iput-boolean v0, p0, showBadge:Z

    iput-boolean v0, p0, allowBubble:Z

    iput v1, p0, lockedAppFields:I

    iput-boolean v1, p0, oemLockedImportance:Z

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, futureOemLockedChannels:Ljava/util/List;

    iput-boolean v1, p0, defaultAppLockedImportance:Z

    const/4 v0, 0x0

    iput-object v0, p0, delegate:Lcom/android/server/notification/PreferencesHelper$Delegate;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, channels:Landroid/util/ArrayMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, groups:Ljava/util/Map;
...
.method public isValidDelegate(Ljava/lang/String;I)Z
    ...
    iget-object v0, p0, delegate:Lcom/android/server/notification/PreferencesHelper$Delegate;
