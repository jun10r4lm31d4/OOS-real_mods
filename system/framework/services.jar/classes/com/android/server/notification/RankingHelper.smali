...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/notification/RankingHandler;Lcom/android/server/notification/RankingConfig;Lcom/android/server/notification/ZenModeHelper;Lcom/android/server/notification/NotificationUsageStats;[Ljava/lang/String;)V
    ...
    iput-object v2, p0, mFinalComparator:Lcom/android/server/notification/GlobalSortKeyComparator;

    new-instance v2, Landroid/util/ArrayMap;

    invoke-direct {v2}, Landroid/util/ArrayMap;-><init>()V

    iput-object v2, p0, mProxyByGroupTmp:Landroid/util/ArrayMap;

    iput-object p1, p0, mContext:Landroid/content/Context;

    iput-object p2, p0, mRankingHandler:Lcom/android/server/notification/RankingHandler;
    ...
    iput-object v2, p0, mPreliminaryComparator:Lcom/android/server/notification/NotificationComparator;

    array-length v2, p6

    new-array v3, v2, [Lcom/android/server/notification/NotificationSignalExtractor;

    iput-object v3, p0, mSignalExtractors:[Lcom/android/server/notification/NotificationSignalExtractor;
    ...
    iget-object v6, p0, mSignalExtractors:[Lcom/android/server/notification/NotificationSignalExtractor;
...
.method public dump(Landroid/util/proto/ProtoOutputStream;Lcom/android/server/notification/NotificationManagerService$DumpFilter;)V
    ...
    iget-object v0, p0, mSignalExtractors:[Lcom/android/server/notification/NotificationSignalExtractor;
    ...
    iget-object v4, p0, mSignalExtractors:[Lcom/android/server/notification/NotificationSignalExtractor;
...
.method public extractSignals(Lcom/android/server/notification/NotificationRecord;)V
    ...
    iget-object v4, p0, mRankingHandler:Lcom/android/server/notification/RankingHandler;
...
.method public sort(Ljava/util/ArrayList;)V
    ...
    :cond_0
    iget-object v1, p0, mPreliminaryComparator:Lcom/android/server/notification/NotificationComparator;

    invoke-static {p1, v1}, Ljava/util/Collections;->sort(Ljava/util/List;Ljava/util/Comparator;)V

    iget-object v1, p0, mProxyByGroupTmp:Landroid/util/ArrayMap;
    ...
    iget-object v5, p0, mProxyByGroupTmp:Landroid/util/ArrayMap;
    ...
    iget-object v6, p0, mProxyByGroupTmp:Landroid/util/ArrayMap;
    ...
    iget-object v4, p0, mProxyByGroupTmp:Landroid/util/ArrayMap;
    ...
    :cond_7
    iget-object v2, p0, mProxyByGroupTmp:Landroid/util/ArrayMap;
    ...
    iget-object v1, p0, mFinalComparator:Lcom/android/server/notification/GlobalSortKeyComparator;
