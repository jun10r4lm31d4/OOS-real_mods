...
.method private constructor <init>(Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;)V
    ...
    invoke-direct/range {v0 .. v8}, <init>(Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;)V
...
.method synthetic constructor <init>(Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Lcom/android/server/pm/PackageManagerService$1;)V
    ...
    invoke-direct/range {p0 .. p5}, <init>(Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;)V
...
.method private constructor <init>(Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;)V
    ...
    iput-object p1, p0, scannedPackages:Ljava/util/Map;

    iput-object p2, p0, installArgs:Ljava/util/Map;

    iput-object p3, p0, installResults:Ljava/util/Map;

    iput-object p4, p0, preparedPackages:Ljava/util/Map;

    iput-object p5, p0, sharedLibrarySource:Ljava/util/Map;

    iput-object p6, p0, allPackages:Ljava/util/Map;

    iput-object p7, p0, versionInfos:Ljava/util/Map;

    iput-object p8, p0, lastStaticSharedLibSettings:Ljava/util/Map;
...
.method synthetic constructor <init>(Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Lcom/android/server/pm/PackageManagerService$1;)V
    ...
    invoke-direct/range {p0 .. p8}, <init>(Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;)V
