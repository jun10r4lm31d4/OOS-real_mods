...
.method public constructor <init>(Lcom/android/server/pm/ShortcutService;)V
    ...
    iput-wide v0, p0, SAVE_WAIT_TIMEOUT_MS:J
    ...
    iput-object v0, p0, mExecutor:Ljava/util/concurrent/Executor;

    new-instance v0, Ljava/util/concurrent/LinkedBlockingDeque;

    invoke-direct {v0}, Ljava/util/concurrent/LinkedBlockingDeque;-><init>()V

    iput-object v0, p0, mPendingItems:Ljava/util/Deque;
...
.method private processPendingItems()Z
    ...
    :try_start_0
    iget-object v2, p0, mPendingItems:Ljava/util/Deque;
    ...
    :try_start_1
    iget-object v3, p0, mPendingItems:Ljava/util/Deque;
    ...
    invoke-virtual {p0, v0}, removeIcon(Landroid/content/pm/ShortcutInfo;)V
...
.method public dumpLocked(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    iget-object v0, p0, mPendingItems:Ljava/util/Deque;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, mPendingItems:Ljava/util/Deque;
    ...
    iget-object v3, p0, mExecutor:Ljava/util/concurrent/Executor;
...
.method public getBitmapPathMayWaitLocked(Landroid/content/pm/ShortcutInfo;)Ljava/lang/String;
    ...
    invoke-virtual {p0}, waitForAllSavesLocked()Z
...
.method public synthetic lambda$new$1$ShortcutBitmapSaver()V
    ...
    :goto_0
    invoke-direct {p0}, processPendingItems()Z
...
.method public saveBitmapLocked(Landroid/content/pm/ShortcutInfo;ILandroid/graphics/Bitmap$CompressFormat;I)V
    ...
    iget-object v6, p0, mPendingItems:Ljava/util/Deque;
    ...
    iget-object v6, p0, mRunnable:Ljava/lang/Runnable;
