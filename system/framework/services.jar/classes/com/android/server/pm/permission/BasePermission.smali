...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    iput-object p2, p0, sourcePackageName:Ljava/lang/String;
...
.method private static comparePermissionInfos(Landroid/content/pm/PermissionInfo;Landroid/content/pm/PermissionInfo;)Z
    ...
    invoke-static {v0, v1}, compareStrings(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Z
...
.method static createOrUpdate(Lcom/android/server/pm/permission/BasePermission;Landroid/content/pm/PackageParser$Permission;Landroid/content/pm/PackageParser$Package;Ljava/util/Collection;Z)Lcom/android/server/pm/permission/BasePermission;
    ...
    iget-object v3, p0, sourcePackageName:Ljava/lang/String;
    ...
    iget-object v3, p0, perm:Landroid/content/pm/PackageParser$Permission;
    ...
    iget-object v4, p0, perm:Landroid/content/pm/PackageParser$Permission;

    if-nez v4, :cond_1

    iput-object v0, p0, sourcePackageSetting:Lcom/android/server/pm/PackageSettingBase;

    iput-object p1, p0, perm:Landroid/content/pm/PackageParser$Permission;
    ...
    iput-object v4, p0, sourcePackageName:Ljava/lang/String;
    ...
    iget-object v5, p0, sourcePackageName:Ljava/lang/String;
    ...
    invoke-direct {v3, v4, v5, v2}, <init>(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    invoke-static {p3, v3}, findPermissionTree(Ljava/util/Collection;Ljava/lang/String;)Lcom/android/server/pm/permission/BasePermission;

    move-result-object v3

    if-eqz v3, :cond_7

    iget-object v9, v3, sourcePackageName:Ljava/lang/String;
    ...
    iget-object v4, v3, name:Ljava/lang/String;
    ...
    iget-object v4, v3, sourcePackageName:Ljava/lang/String;
    ...
    iput-object v7, p0, sourcePackageName:Ljava/lang/String;
    ...
    :cond_c
    :goto_7
    iget-object v1, p0, perm:Landroid/content/pm/PackageParser$Permission;
...
.method static enforcePermissionTree(Ljava/util/Collection;Ljava/lang/String;I)Lcom/android/server/pm/permission/BasePermission;
    ...
    invoke-static {p0, p1}, findPermissionTree(Ljava/util/Collection;Ljava/lang/String;)Lcom/android/server/pm/permission/BasePermission;
...
.method private static findPermissionTree(Ljava/util/Collection;Ljava/lang/String;)Lcom/android/server/pm/permission/BasePermission;
    ...
    iget-object v2, v1, name:Ljava/lang/String;
    ...
    iget-object v3, v1, name:Ljava/lang/String;
...
.method public static readLPw(Ljava/util/Map;Lorg/xmlpull/v1/XmlPullParser;)Z
    ...
    :goto_0
    invoke-direct {v9, v10, v4, v11}, <init>(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    invoke-static {p1, v1, v9, v2}, readInt(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;Ljava/lang/String;I)I

    move-result v9

    iput v9, v7, protectionLevel:I

    iget v9, v7, protectionLevel:I
    ...
    invoke-static {p1, v1, v10, v2}, readInt(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;Ljava/lang/String;I)I
    ...
    iget v1, v7, protectionLevel:I

    iput v1, v9, Landroid/content/pm/PermissionInfo;->protectionLevel:I

    iput-object v9, v7, pendingPermissionInfo:Landroid/content/pm/PermissionInfo;

    :cond_5
    iget-object v1, v7, name:Ljava/lang/String;
...
.method public addToTree(ILandroid/content/pm/PermissionInfo;Lcom/android/server/pm/permission/BasePermission;)Z
    ...
    iget-object v0, p0, perm:Landroid/content/pm/PackageParser$Permission;
    ...
    iget-object v1, p3, perm:Landroid/content/pm/PackageParser$Permission;
    ...
    invoke-static {v0, p2}, comparePermissionInfos(Landroid/content/pm/PermissionInfo;Landroid/content/pm/PermissionInfo;)Z
    ...
    iget-object v2, p3, perm:Landroid/content/pm/PackageParser$Permission;
    ...
    iput-object v1, p0, perm:Landroid/content/pm/PackageParser$Permission;
...
.method public calculateFootprint(Lcom/android/server/pm/permission/BasePermission;)I
    ...
    iget-object v1, p1, perm:Landroid/content/pm/PackageParser$Permission;
...
.method public dumpPermissionsLPr(Ljava/io/PrintWriter;Ljava/lang/String;Ljava/util/Set;ZZLcom/android/server/pm/DumpState;)Z
    ...
    iget-object v1, p0, sourcePackageName:Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, computeGids(I)[I
    ...
    :cond_5
    iget-object v0, p0, sourcePackageSetting:Lcom/android/server/pm/PackageSettingBase;
...
.method public enforceDeclaredUsedAndRuntimeOrDevelopment(Landroid/content/pm/PackageParser$Package;)V
    ...
    :cond_1
    :goto_0
    invoke-virtual {p0}, isRuntime()Z

    move-result v3

    if-nez v3, :cond_3

    invoke-virtual {p0}, isDevelopment()Z
...
.method public generatePermissionInfo(II)Landroid/content/pm/PermissionInfo;
    ...
    iget-object v2, p0, perm:Landroid/content/pm/PackageParser$Permission;
    ...
    iget-object v2, p0, sourcePackageName:Ljava/lang/String;
...
.method public generatePermissionInfo(Ljava/lang/String;I)Landroid/content/pm/PermissionInfo;
    ...
    invoke-virtual {p0, v0, p2}, generatePermissionInfo(II)Landroid/content/pm/PermissionInfo;
...
.method public isDevelopment()Z
    ...
    invoke-virtual {p0}, isSignature()Z
...
.method public setSourcePackageSetting(Lcom/android/server/pm/PackageSettingBase;)V
    ...
    iput-object p1, p0, sourcePackageSetting:Lcom/android/server/pm/PackageSettingBase;
...
.method public transfer(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v0, p0, perm:Landroid/content/pm/PackageParser$Permission;

    iget-object v1, p0, pendingPermissionInfo:Landroid/content/pm/PermissionInfo;
    ...
    invoke-virtual {p0, v0, v1}, setGids([IZ)V
...
.method public updateDynamicPermission(Ljava/util/Collection;)V
    ...
    iget-object v0, p0, pendingPermissionInfo:Landroid/content/pm/PermissionInfo;

    if-eqz v0, :cond_1

    iget-object v0, p0, name:Ljava/lang/String;

    invoke-static {p1, v0}, findPermissionTree(Ljava/util/Collection;Ljava/lang/String;)Lcom/android/server/pm/permission/BasePermission;

    move-result-object v0

    if-eqz v0, :cond_1

    iget-object v1, v0, perm:Landroid/content/pm/PackageParser$Permission;

    if-eqz v1, :cond_1

    iget-object v2, v0, sourcePackageSetting:Lcom/android/server/pm/PackageSettingBase;

    iput-object v2, p0, sourcePackageSetting:Lcom/android/server/pm/PackageSettingBase;
    ...
    iget-object v4, p0, pendingPermissionInfo:Landroid/content/pm/PermissionInfo;
    ...
    iput-object v2, p0, perm:Landroid/content/pm/PackageParser$Permission;

    iget-object v1, p0, perm:Landroid/content/pm/PackageParser$Permission;

    iget-object v1, v1, Landroid/content/pm/PackageParser$Permission;->info:Landroid/content/pm/PermissionInfo;

    iget-object v2, v0, perm:Landroid/content/pm/PackageParser$Permission;
...
.method public writeLPr(Lorg/xmlpull/v1/XmlSerializer;)V
    ...
    :cond_2
    iget-object v2, p0, pendingPermissionInfo:Landroid/content/pm/PermissionInfo;
