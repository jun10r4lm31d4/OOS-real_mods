...
.method constructor <init>(Ljava/lang/String;Ljava/io/File;Landroid/content/pm/IPackageInstallObserver2;Landroid/content/pm/PackageInstaller$SessionParams;Ljava/lang/String;ILandroid/os/UserHandle;Landroid/content/pm/PackageParser$SigningDetails;)V
    ...
    iput-object p2, p0, mStagedDir:Ljava/io/File;

    iput-object p3, p0, mObserver:Landroid/content/pm/IPackageInstallObserver2;

    iput-object p4, p0, mSessionParams:Landroid/content/pm/PackageInstaller$SessionParams;

    iput-object p5, p0, mInstallerPackageName:Ljava/lang/String;

    iput p6, p0, mInstallerUid:I

    iput-object p7, p0, mUser:Landroid/os/UserHandle;

    iput-object p8, p0, mSigningDetails:Landroid/content/pm/PackageParser$SigningDetails;
...
.method public getObserver()Landroid/content/pm/IPackageInstallObserver2;
    ...
    iget-object v0, p0, mObserver:Landroid/content/pm/IPackageInstallObserver2;
...
.method public getSessionParams()Landroid/content/pm/PackageInstaller$SessionParams;
    ...
    iget-object v0, p0, mSessionParams:Landroid/content/pm/PackageInstaller$SessionParams;
...
.method public getStagedDir()Ljava/io/File;
    ...
    iget-object v0, p0, mStagedDir:Ljava/io/File;
