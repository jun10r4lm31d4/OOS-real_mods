...
.method private constructor <init>(Lcom/android/server/pm/ShortcutRequestPinProcessor;Landroid/content/IntentSender;I)V
    ...
    iput-object p1, p0, mProcessor:Lcom/android/server/pm/ShortcutRequestPinProcessor;

    iput-object p2, p0, mResultIntent:Landroid/content/IntentSender;

    iput p3, p0, mLauncherUid:I
...
.method synthetic constructor <init>(Lcom/android/server/pm/ShortcutRequestPinProcessor;Landroid/content/IntentSender;ILcom/android/server/pm/ShortcutRequestPinProcessor$1;)V
    ...
    invoke-direct {p0, p1, p2, p3}, <init>(Lcom/android/server/pm/ShortcutRequestPinProcessor;Landroid/content/IntentSender;I)V
...
.method private isCallerValid()Z
    ...
    iget-object v0, p0, mProcessor:Lcom/android/server/pm/ShortcutRequestPinProcessor;

    iget v1, p0, mLauncherUid:I
...
.method public accept(Landroid/os/Bundle;)Z
    ...
    invoke-direct {p0}, isCallerValid()Z
    ...
    :try_start_1
    iget-boolean v1, p0, mAccepted:Z

    if-nez v1, :cond_2

    const/4 v1, 0x1

    iput-boolean v1, p0, mAccepted:Z

    monitor-exit p0
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    invoke-virtual {p0}, tryAccept()Z

    move-result v2

    if-eqz v2, :cond_1

    iget-object v2, p0, mProcessor:Lcom/android/server/pm/ShortcutRequestPinProcessor;

    iget-object v3, p0, mResultIntent:Landroid/content/IntentSender;
...
.method public isValid()Z
    ...
    :try_start_0
    iget-boolean v0, p0, mAccepted:Z
