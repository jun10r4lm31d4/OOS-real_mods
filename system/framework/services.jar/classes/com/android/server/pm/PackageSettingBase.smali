...
.method constructor <init>(Lcom/android/server/pm/PackageSettingBase;Ljava/lang/String;)V
    ...
    iput-object v0, p0, keySetData:Lcom/android/server/pm/PackageKeySetData;
    ...
    invoke-direct {p0, p1}, doCopy(Lcom/android/server/pm/PackageSettingBase;)V
...
.method constructor <init>(Ljava/lang/String;Ljava/lang/String;Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;JIILjava/lang/String;Ljava/util/List;[Ljava/lang/String;[J)V
    ...
    iput-object v0, v9, keySetData:Lcom/android/server/pm/PackageKeySetData;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, v9, mUserState:Landroid/util/SparseArray;

    const/4 v0, -0x1

    iput v0, v9, categoryHint:I

    move-object/from16 v13, p1

    iput-object v13, v9, name:Ljava/lang/String;

    move-object/from16 v14, p2

    iput-object v14, v9, realName:Ljava/lang/String;

    move-object/from16 v15, p13

    iput-object v15, v9, parentPackageName:Ljava/lang/String;
    ...
    :goto_0
    iput-object v0, v9, childPackageNames:Ljava/util/List;

    move-object/from16 v7, p15

    iput-object v7, v9, usesStaticLibraries:[Ljava/lang/String;

    move-object/from16 v8, p16

    iput-object v8, v9, usesStaticLibrariesVersions:[J
    ...
    invoke-virtual/range {v0 .. v8}, init(Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J)V
...
.method private doCopy(Lcom/android/server/pm/PackageSettingBase;)V
    ...
    iget-object v0, p1, childPackageNames:Ljava/util/List;
    ...
    :goto_0
    iput-object v2, p0, childPackageNames:Ljava/util/List;

    iget-object v0, p1, codePath:Ljava/io/File;

    iput-object v0, p0, codePath:Ljava/io/File;

    iget-object v0, p1, codePathString:Ljava/lang/String;

    iput-object v0, p0, codePathString:Ljava/lang/String;

    iget-object v0, p1, cpuAbiOverrideString:Ljava/lang/String;

    iput-object v0, p0, cpuAbiOverrideString:Ljava/lang/String;

    iget-wide v2, p1, firstInstallTime:J

    iput-wide v2, p0, firstInstallTime:J

    iget-boolean v0, p1, installPermissionsFixed:Z

    iput-boolean v0, p0, installPermissionsFixed:Z

    iget-object v0, p1, installerPackageName:Ljava/lang/String;

    iput-object v0, p0, installerPackageName:Ljava/lang/String;

    iget-boolean v0, p1, isOrphaned:Z

    iput-boolean v0, p0, isOrphaned:Z

    iget-object v0, p1, keySetData:Lcom/android/server/pm/PackageKeySetData;
    ...
    iget-object v0, p1, legacyNativeLibraryPathString:Ljava/lang/String;

    iput-object v0, p0, legacyNativeLibraryPathString:Ljava/lang/String;

    iget-object v0, p1, parentPackageName:Ljava/lang/String;

    iput-object v0, p0, parentPackageName:Ljava/lang/String;

    iget-object v0, p1, primaryCpuAbiString:Ljava/lang/String;

    iput-object v0, p0, primaryCpuAbiString:Ljava/lang/String;

    iget-object v0, p1, resourcePath:Ljava/io/File;

    iput-object v0, p0, resourcePath:Ljava/io/File;

    iget-object v0, p1, resourcePathString:Ljava/lang/String;

    iput-object v0, p0, resourcePathString:Ljava/lang/String;

    iget-object v0, p1, secondaryCpuAbiString:Ljava/lang/String;

    iput-object v0, p0, secondaryCpuAbiString:Ljava/lang/String;

    iget-object v0, p1, signatures:Lcom/android/server/pm/PackageSignatures;
    ...
    iget-boolean v0, p1, uidError:Z

    iput-boolean v0, p0, uidError:Z
    ...
    :goto_1
    iget-object v2, p1, mUserState:Landroid/util/SparseArray;
    ...
    iget-object v3, p1, mUserState:Landroid/util/SparseArray;

    invoke-virtual {v3, v0}, Landroid/util/SparseArray;->keyAt(I)I

    move-result v3

    iget-object v4, p1, mUserState:Landroid/util/SparseArray;
    ...
    :cond_1
    iget-object v0, p1, verificationInfo:Landroid/content/pm/IntentFilterVerificationInfo;

    iput-object v0, p0, verificationInfo:Landroid/content/pm/IntentFilterVerificationInfo;

    iget-wide v2, p1, versionCode:J

    iput-wide v2, p0, versionCode:J

    iget-object v0, p1, volumeUuid:Ljava/lang/String;

    iput-object v0, p0, volumeUuid:Ljava/lang/String;

    iget v0, p1, categoryHint:I

    iput v0, p0, categoryHint:I

    iget-object v0, p1, usesStaticLibraries:[Ljava/lang/String;
    ...
    :goto_2
    iput-object v0, p0, usesStaticLibraries:[Ljava/lang/String;

    iget-object v0, p1, usesStaticLibrariesVersions:[J
    ...
    :goto_3
    iput-object v1, p0, usesStaticLibrariesVersions:[J

    iget-boolean v0, p1, updateAvailable:Z

    iput-boolean v0, p0, updateAvailable:Z
...
.method disableComponentLPw(Ljava/lang/String;I)Z
    ...
    invoke-virtual {p0, p2, v1, v0}, modifyUserStateComponents(IZZ)Landroid/content/pm/PackageUserState;
...
.method public getNotInstalledUserIds()[I
    ...
    sget-object v2, EMPTY_INT_ARRAY:[I
    ...
    iget-object v5, p0, mUserState:Landroid/util/SparseArray;
...
.method public getSignatures()[Landroid/content/pm/Signature;
    ...
    iget-object v0, p0, signatures:Lcom/android/server/pm/PackageSignatures;
...
.method public isUpdateAvailable()Z
    ...
    iget-boolean v0, p0, updateAvailable:Z
...
.method queryInstalledUsers([IZ)[I
    ...
    invoke-virtual {p0, v4}, getInstalled(I)Z
...
.method public readUserState(I)Landroid/content/pm/PackageUserState;
    ...
    sget-object v1, DEFAULT_USER_STATE:Landroid/content/pm/PackageUserState;

    return-object v1

    :cond_0
    iget v1, p0, categoryHint:I
...
.method restoreComponentLPw(Ljava/lang/String;I)Z
    ...
    invoke-virtual {p0, p2, v0, v0}, modifyUserStateComponents(IZZ)Landroid/content/pm/PackageUserState;
...
.method setSuspended(ZLjava/lang/String;Landroid/content/pm/SuspendDialogInfo;Landroid/os/PersistableBundle;Landroid/os/PersistableBundle;I)V
    ...
    invoke-direct {p0, p6}, modifyUserState(I)Landroid/content/pm/PackageUserState;
...
.method public setUpdateAvailable(Z)V
    ...
    iput-boolean p1, p0, updateAvailable:Z
...
.method setUserState(IJIZZZZIZLjava/lang/String;Landroid/content/pm/SuspendDialogInfo;Landroid/os/PersistableBundle;Landroid/os/PersistableBundle;ZZLjava/lang/String;Landroid/util/ArraySet;Landroid/util/ArraySet;IIILjava/lang/String;)V
    ...
    invoke-direct/range {p0 .. p1}, modifyUserState(I)Landroid/content/pm/PackageUserState;
...
.method protected updateFrom(Lcom/android/server/pm/PackageSettingBase;)Lcom/android/server/pm/PackageSettingBase;
    ...
    iput-object v0, p0, childPackageNames:Ljava/util/List;
    ...
    iput-object v0, p0, usesStaticLibrariesVersions:[J
    ...
    iget-wide v0, p1, timeStamp:J

    iput-wide v0, p0, timeStamp:J

    iget-wide v0, p1, firstInstallTime:J

    iput-wide v0, p0, firstInstallTime:J

    iget-wide v0, p1, lastUpdateTime:J

    iput-wide v0, p0, lastUpdateTime:J

    iget-wide v0, p1, versionCode:J

    iput-wide v0, p0, versionCode:J
    ...
    iget-object v0, p0, mOldCodePaths:Ljava/util/Set;

    if-eqz v0, :cond_1

    iget-object v1, p1, mOldCodePaths:Ljava/util/Set;
    ...
    iput-object v0, p0, mOldCodePaths:Ljava/util/Set;
    ...
    :goto_1
    iget-object v1, p1, mUserState:Landroid/util/SparseArray;
