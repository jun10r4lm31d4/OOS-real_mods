...
.method static constructor <clinit>()V
    ...
    sput-object v0, PROTECTED_ACTIONS:Ljava/util/Set;

    sget-object v0, PROTECTED_ACTIONS:Ljava/util/Set;
    ...
    sput-object v0, RESOLVE_PRIORITY_SORTER:Ljava/util/Comparator;
...
.method constructor <init>(Lcom/android/server/pm/UserManagerService;Landroid/content/pm/PackageManagerInternal;Ljava/lang/Object;)V
    ...
    iput-object v0, p0, mActivities:Lcom/android/server/pm/ComponentResolver$ActivityIntentResolver;
    ...
    iput-object v0, p0, mProviders:Lcom/android/server/pm/ComponentResolver$ProviderIntentResolver;

    new-instance v0, Lcom/android/server/pm/ComponentResolver$ActivityIntentResolver;

    invoke-direct {v0, v1}, Lcom/android/server/pm/ComponentResolver$ActivityIntentResolver;-><init>(Lcom/android/server/pm/ComponentResolver$1;)V

    iput-object v0, p0, mReceivers:Lcom/android/server/pm/ComponentResolver$ActivityIntentResolver;
    ...
    iput-object v0, p0, mServices:Lcom/android/server/pm/ComponentResolver$ServiceIntentResolver;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, mProvidersByAuthority:Landroid/util/ArrayMap;

    const/4 v0, 0x1

    iput-boolean v0, p0, mDeferProtectedFilters:Z

    sput-object p2, sPackageManagerInternal:Landroid/content/pm/PackageManagerInternal;

    sput-object p1, sUserManager:Lcom/android/server/pm/UserManagerService;
...
.method static synthetic access$800()Lcom/android/server/pm/UserManagerService;
    ...
    sget-object v0, sUserManager:Lcom/android/server/pm/UserManagerService;
...
.method static synthetic access$900()Landroid/content/pm/PackageManagerInternal;
    ...
    sget-object v0, sPackageManagerInternal:Landroid/content/pm/PackageManagerInternal;
...
.method private addActivitiesLocked(Landroid/content/pm/PackageParser$Package;Ljava/util/List;Z)V
    ...
    iget-object v4, p0, mActivities:Lcom/android/server/pm/ComponentResolver$ActivityIntentResolver;
...
.method private addProvidersLocked(Landroid/content/pm/PackageParser$Package;Z)V
    ...
    iget-object v7, v0, mProviders:Lcom/android/server/pm/ComponentResolver$ProviderIntentResolver;
    ...
    :cond_0
    iget-object v11, v0, mProvidersByAuthority:Landroid/util/ArrayMap;
...
.method private addReceiversLocked(Landroid/content/pm/PackageParser$Package;Z)V
    ...
    iget-object v4, p0, mReceivers:Lcom/android/server/pm/ComponentResolver$ActivityIntentResolver;
...
.method private addServicesLocked(Landroid/content/pm/PackageParser$Package;Z)V
    ...
    iget-object v4, p0, mServices:Lcom/android/server/pm/ComponentResolver$ServiceIntentResolver;
...
.method private adjustPriority(Ljava/util/List;Landroid/content/pm/PackageParser$ActivityIntentInfo;Ljava/lang/String;)V
    ...
    invoke-static/range {p2 .. p2}, isProtectedAction(Landroid/content/pm/PackageParser$ActivityIntentInfo;)Z

    move-result v6

    if-eqz v6, :cond_6

    iget-boolean v6, v0, mDeferProtectedFilters:Z

    if-eqz v6, :cond_4

    iget-object v6, v0, mProtectedFilters:Ljava/util/List;
    ...
    iput-object v6, v0, mProtectedFilters:Ljava/util/List;
    ...
    invoke-static {v1, v3}, findMatchingActivity(Ljava/util/List;Landroid/content/pm/ActivityInfo;)Landroid/content/pm/PackageParser$Activity;
    ...
    iget-object v11, v0, mActivities:Lcom/android/server/pm/ComponentResolver$ActivityIntentResolver;
    ...
    invoke-static {v10, v13, v12}, getIntentListSubset(Ljava/util/List;Lcom/android/server/pm/ComponentResolver$IterGenerator;Ljava/util/Iterator;)V
    ...
    invoke-static {v10, v14, v13}, getIntentListSubset(Ljava/util/List;Lcom/android/server/pm/ComponentResolver$IterGenerator;Ljava/util/Iterator;)V
    ...
    invoke-static {v10, v15, v14}, getIntentListSubset(Ljava/util/List;Lcom/android/server/pm/ComponentResolver$IterGenerator;Ljava/util/Iterator;)V
    ...
    invoke-static {v10, v6, v15}, getIntentListSubset(Ljava/util/List;Lcom/android/server/pm/ComponentResolver$IterGenerator;Ljava/util/Iterator;)V
...
.method private assertProvidersNotDefinedLocked(Landroid/content/pm/PackageParser$Package;)V
    ...
    iget-object v5, p0, mProvidersByAuthority:Landroid/util/ArrayMap;
...
.method private static isProtectedAction(Landroid/content/pm/PackageParser$ActivityIntentInfo;)Z
    ...
    sget-object v2, PROTECTED_ACTIONS:Ljava/util/Set;
...
.method private removeAllComponentsLocked(Landroid/content/pm/PackageParser$Package;Z)V
    ...
    iget-object v6, p0, mActivities:Lcom/android/server/pm/ComponentResolver$ActivityIntentResolver;
    ...
    iget-object v8, p0, mProviders:Lcom/android/server/pm/ComponentResolver$ProviderIntentResolver;
    ...
    iget-object v10, p0, mProvidersByAuthority:Landroid/util/ArrayMap;
    ...
    iget-object v8, p0, mReceivers:Lcom/android/server/pm/ComponentResolver$ActivityIntentResolver;
    ...
    iget-object v8, p0, mServices:Lcom/android/server/pm/ComponentResolver$ServiceIntentResolver;
...
.method addAllComponents(Landroid/content/pm/PackageParser$Package;Z)V
    ...
    :try_start_0
    invoke-direct {p0, p1, v0, p2}, addActivitiesLocked(Landroid/content/pm/PackageParser$Package;Ljava/util/List;Z)V

    invoke-direct {p0, p1, p2}, addReceiversLocked(Landroid/content/pm/PackageParser$Package;Z)V

    invoke-direct {p0, p1, p2}, addProvidersLocked(Landroid/content/pm/PackageParser$Package;Z)V

    invoke-direct {p0, p1, p2}, addServicesLocked(Landroid/content/pm/PackageParser$Package;Z)V

    monitor-exit v1
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    sget-object v1, sPackageManagerInternal:Landroid/content/pm/PackageManagerInternal;
    ...
    sget-object v4, sPackageManagerInternal:Landroid/content/pm/PackageManagerInternal;
    ...
    :goto_1
    invoke-direct {p0, v5, v3, v1}, adjustPriority(Ljava/util/List;Landroid/content/pm/PackageParser$ActivityIntentInfo;Ljava/lang/String;)V
...
.method assertProvidersNotDefined(Landroid/content/pm/PackageParser$Package;)V
    ...
    :try_start_0
    invoke-direct {p0, p1}, assertProvidersNotDefinedLocked(Landroid/content/pm/PackageParser$Package;)V
...
.method dumpActivityResolvers(Ljava/io/PrintWriter;Lcom/android/server/pm/DumpState;Ljava/lang/String;)V
    ...
    iget-object v0, p0, mActivities:Lcom/android/server/pm/ComponentResolver$ActivityIntentResolver;
...
.method dumpContentProviders(Ljava/io/PrintWriter;Lcom/android/server/pm/DumpState;Ljava/lang/String;)V
    ...
    iget-object v1, p0, mProviders:Lcom/android/server/pm/ComponentResolver$ProviderIntentResolver;
    ...
    iget-object v1, p0, mProvidersByAuthority:Landroid/util/ArrayMap;
...
.method dumpProviderResolvers(Ljava/io/PrintWriter;Lcom/android/server/pm/DumpState;Ljava/lang/String;)V
    ...
    iget-object v0, p0, mProviders:Lcom/android/server/pm/ComponentResolver$ProviderIntentResolver;
...
.method dumpReceiverResolvers(Ljava/io/PrintWriter;Lcom/android/server/pm/DumpState;Ljava/lang/String;)V
    ...
    iget-object v0, p0, mReceivers:Lcom/android/server/pm/ComponentResolver$ActivityIntentResolver;
...
.method dumpServicePermissions(Ljava/io/PrintWriter;Lcom/android/server/pm/DumpState;Ljava/lang/String;)V
    ...
    iget-object v0, p0, mServices:Lcom/android/server/pm/ComponentResolver$ServiceIntentResolver;
...
.method fixProtectedFilterPriorities()V
    ...
    iget-boolean v0, p0, mDeferProtectedFilters:Z
    ...
    iget-object v1, p0, mProtectedFilters:Ljava/util/List;
    ...
    iput-object v2, p0, mProtectedFilters:Ljava/util/List;

    sget-object v2, sPackageManagerInternal:Landroid/content/pm/PackageManagerInternal;
...
.method getActivity(Landroid/content/ComponentName;)Landroid/content/pm/PackageParser$Activity;
    ...
    :try_start_0
    iget-object v1, p0, mActivities:Lcom/android/server/pm/ComponentResolver$ActivityIntentResolver;
...
.method getReceiver(Landroid/content/ComponentName;)Landroid/content/pm/PackageParser$Activity;
    ...
    :try_start_0
    iget-object v1, p0, mReceivers:Lcom/android/server/pm/ComponentResolver$ActivityIntentResolver;
...
.method getService(Landroid/content/ComponentName;)Landroid/content/pm/PackageParser$Service;
    ...
    :try_start_0
    iget-object v1, p0, mServices:Lcom/android/server/pm/ComponentResolver$ServiceIntentResolver;
...
.method queryProviders(Ljava/lang/String;Ljava/lang/String;III)Ljava/util/List;
    ...
    :try_start_0
    iget-object v2, p0, mProviders:Lcom/android/server/pm/ComponentResolver$ProviderIntentResolver;
    ...
    iget-object v3, p0, mProviders:Lcom/android/server/pm/ComponentResolver$ProviderIntentResolver;
...
.method querySyncProviders(Ljava/util/List;Ljava/util/List;ZI)V
    ...
    iget-object v2, p0, mProvidersByAuthority:Landroid/util/ArrayMap;
...
.method removeAllComponents(Landroid/content/pm/PackageParser$Package;Z)V
    ...
    :try_start_0
    invoke-direct {p0, p1, p2}, removeAllComponentsLocked(Landroid/content/pm/PackageParser$Package;Z)V
