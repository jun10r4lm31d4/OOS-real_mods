...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-wide v0, BIND_SERVICE_TIMEOUT_MS:J
    ...
    :goto_1
    sput-wide v0, CALL_SERVICE_TIMEOUT_MS:J

    sget-boolean v0, Landroid/os/Build;->IS_DEBUGGABLE:Z

    sput-boolean v0, DEBUG_INSTANT:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/content/ComponentName;Ljava/lang/String;)V
    ...
    iput-object v0, p0, mGetInstantAppResolveInfoCaller:Lcom/android/server/pm/InstantAppResolverConnection$GetInstantAppResolveInfoCaller;
...
.method static synthetic access$100()Z
    ...
    sget-boolean v0, DEBUG_INSTANT:Z
...
.method static synthetic access$302(Lcom/android/server/pm/InstantAppResolverConnection;Landroid/app/IInstantAppResolver;)Landroid/app/IInstantAppResolver;
    ...
    iput-object p1, p0, mRemoteInstance:Landroid/app/IInstantAppResolver;
...
.method static synthetic access$500(Lcom/android/server/pm/InstantAppResolverConnection;)V
    ...
    invoke-direct {p0}, handleBinderDiedLocked()V
...
.method static synthetic access$600()J
    ...
    sget-wide v0, CALL_SERVICE_TIMEOUT_MS:J
...
.method private bind(Ljava/lang/String;)Landroid/app/IInstantAppResolver;
    ...
    :try_start_0
    iget-object v2, p0, mRemoteInstance:Landroid/app/IInstantAppResolver;
    ...
    :cond_0
    iget v2, p0, mBindState:I

    const/4 v3, 0x2

    if-ne v2, v3, :cond_3

    sget-boolean v2, DEBUG_INSTANT:Z
    ...
    :cond_1
    :try_start_1
    invoke-direct {p0, p1}, waitForBindLocked(Ljava/lang/String;)V
    ...
    :try_start_3
    sget-boolean v6, DEBUG_INSTANT:Z
    ...
    iget-object v7, p0, mServiceConnection:Landroid/content/ServiceConnection;
    ...
    iget-object v9, p0, mServiceConnection:Landroid/content/ServiceConnection;
    ...
    iget-object v7, p0, mRemoteInstance:Landroid/app/IInstantAppResolver;
    ...
    :try_start_5
    iput v3, p0, mBindState:I

    goto :goto_1

    :cond_a
    iput v5, p0, mBindState:I
...
.method private getRemoteInstanceLazy(Ljava/lang/String;)Landroid/app/IInstantAppResolver;
    ...
    :try_start_0
    invoke-direct {p0, p1}, bind(Ljava/lang/String;)Landroid/app/IInstantAppResolver;
...
.method private handleBinderDiedLocked()V
    ...
    iget-object v0, p0, mRemoteInstance:Landroid/app/IInstantAppResolver;
    ...
    iput-object v0, p0, mRemoteInstance:Landroid/app/IInstantAppResolver;
...
.method private waitForBindLocked(Ljava/lang/String;)V
    ...
    sget-wide v4, BIND_SERVICE_TIMEOUT_MS:J
...
.method public binderDied()V
    ...
    invoke-virtual {p0}, optimisticBind()V
...
.method public getInstantAppIntentFilterList(Landroid/content/Intent;[IILjava/lang/String;Lcom/android/server/pm/InstantAppResolverConnection$PhaseTwoCallback;Landroid/os/Handler;J)V
    ...
    :try_start_0
    invoke-direct {p0, p4}, getRemoteInstanceLazy(Ljava/lang/String;)Landroid/app/IInstantAppResolver;
...
.method public getInstantAppResolveInfoList(Landroid/content/Intent;[IILjava/lang/String;)Ljava/util/List;
    ...
    :try_start_1
    iget-object v1, p0, mGetInstantAppResolveInfoCaller:Lcom/android/server/pm/InstantAppResolverConnection$GetInstantAppResolveInfoCaller;
...
.method public synthetic lambda$optimisticBind$0$InstantAppResolverConnection()V
    ...
    invoke-direct {p0, v1}, bind(Ljava/lang/String;)Landroid/app/IInstantAppResolver;

    move-result-object v1

    if-eqz v1, :cond_0

    sget-boolean v1, DEBUG_INSTANT:Z
