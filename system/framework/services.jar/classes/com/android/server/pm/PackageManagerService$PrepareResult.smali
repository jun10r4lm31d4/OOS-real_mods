...
.method private constructor <init>(ILjava/lang/String;Ljava/lang/String;Landroid/os/UserHandle;ZIILandroid/content/pm/PackageParser$Package;Landroid/content/pm/PackageParser$Package;ZZLjava/lang/String;Lcom/android/server/pm/PackageManagerService$PackageFreezer;Lcom/android/server/pm/PackageSetting;Lcom/android/server/pm/PackageSetting;[Lcom/android/server/pm/PackageSetting;)V
    ...
    iput v1, v0, installReason:I

    move-object/from16 v2, p2

    iput-object v2, v0, volumeUuid:Ljava/lang/String;

    move-object/from16 v3, p3

    iput-object v3, v0, installerPackageName:Ljava/lang/String;

    move-object/from16 v4, p4

    iput-object v4, v0, user:Landroid/os/UserHandle;

    move/from16 v5, p5

    iput-boolean v5, v0, replace:Z

    move/from16 v6, p6

    iput v6, v0, scanFlags:I

    move/from16 v7, p7

    iput v7, v0, parseFlags:I

    move-object/from16 v8, p8

    iput-object v8, v0, existingPackage:Landroid/content/pm/PackageParser$Package;

    move-object/from16 v9, p9

    iput-object v9, v0, packageToScan:Landroid/content/pm/PackageParser$Package;

    move/from16 v10, p10

    iput-boolean v10, v0, clearCodeCache:Z

    move/from16 v11, p11

    iput-boolean v11, v0, system:Z

    move-object/from16 v12, p12

    iput-object v12, v0, renamedPackage:Ljava/lang/String;

    move-object/from16 v13, p13

    iput-object v13, v0, freezer:Lcom/android/server/pm/PackageManagerService$PackageFreezer;

    move-object/from16 v14, p14

    iput-object v14, v0, originalPs:Lcom/android/server/pm/PackageSetting;

    move-object/from16 v15, p15

    iput-object v15, v0, disabledPs:Lcom/android/server/pm/PackageSetting;

    move-object/from16 v1, p16

    iput-object v1, v0, childPackageSettings:[Lcom/android/server/pm/PackageSetting;
...
.method synthetic constructor <init>(ILjava/lang/String;Ljava/lang/String;Landroid/os/UserHandle;ZIILandroid/content/pm/PackageParser$Package;Landroid/content/pm/PackageParser$Package;ZZLjava/lang/String;Lcom/android/server/pm/PackageManagerService$PackageFreezer;Lcom/android/server/pm/PackageSetting;Lcom/android/server/pm/PackageSetting;[Lcom/android/server/pm/PackageSetting;Lcom/android/server/pm/PackageManagerService$1;)V
    ...
    invoke-direct/range {p0 .. p16}, <init>(ILjava/lang/String;Ljava/lang/String;Landroid/os/UserHandle;ZIILandroid/content/pm/PackageParser$Package;Landroid/content/pm/PackageParser$Package;ZZLjava/lang/String;Lcom/android/server/pm/PackageManagerService$PackageFreezer;Lcom/android/server/pm/PackageSetting;Lcom/android/server/pm/PackageSetting;[Lcom/android/server/pm/PackageSetting;)V
