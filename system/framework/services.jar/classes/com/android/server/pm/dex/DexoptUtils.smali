...
.method static constructor <clinit>()V
    ...
    sput-object v0, SHARED_LIBRARY_LOADER_TYPE:Ljava/lang/String;
...
.method private static encodeClassLoader(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, p1}, encodeClassLoader(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private static encodeSharedLibraries(Ljava/util/List;)Ljava/lang/String;
    ...
    invoke-static {v3}, encodeSharedLibrary(Landroid/content/pm/SharedLibraryInfo;)Ljava/lang/String;
...
.method private static encodeSharedLibrary(Landroid/content/pm/SharedLibraryInfo;)Ljava/lang/String;
    ...
    invoke-static {v1}, encodeClasspath([Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    sget-object v2, SHARED_LIBRARY_LOADER_TYPE:Ljava/lang/String;

    invoke-static {v1, v2}, encodeClassLoader(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3}, encodeSharedLibraries(Ljava/util/List;)Ljava/lang/String;
...
.method public static getClassLoaderContext(Landroid/content/pm/SharedLibraryInfo;)Ljava/lang/String;
    ...
    invoke-static {v1}, encodeSharedLibraries(Ljava/util/List;)Ljava/lang/String;

    move-result-object v0

    :cond_0
    sget-object v1, SHARED_LIBRARY_LOADER_TYPE:Ljava/lang/String;

    const-string v2, ""

    invoke-static {v2, v1, v0}, encodeClassLoader(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static getClassLoaderContexts(Landroid/content/pm/ApplicationInfo;Ljava/util/List;[Z)[Ljava/lang/String;
    ...
    invoke-static/range {p1 .. p1}, encodeSharedLibraries(Ljava/util/List;)Ljava/lang/String;
    ...
    invoke-static {v3, v2, v1}, encodeClassLoader(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_1
    invoke-static/range {p0 .. p0}, getSplitRelativeCodePaths(Landroid/content/pm/ApplicationInfo;)[Ljava/lang/String;
    ...
    invoke-static {v11, v12}, encodeClassLoader(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v8, v9}, encodeClassLoader(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v13, v5, v11, v6, v9}, getParentDependencies(I[Ljava/lang/String;Landroid/util/SparseArray;[Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3, v13}, encodeClassLoader(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v13, v15}, encodeClassLoaderChain(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3, v9, v1}, encodeClassLoader(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3, v9}, encodeClasspath(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private static getParentDependencies(I[Ljava/lang/String;Landroid/util/SparseArray;[Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, p1, p2, p3, p4}, getParentDependencies(I[Ljava/lang/String;Landroid/util/SparseArray;[Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2, v1}, encodeClassLoaderChain(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method static processContextForDexLoad(Ljava/util/List;Ljava/util/List;)[Ljava/lang/String;
    ...
    invoke-static {v2}, encodeClasspath([Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2, v3}, encodeClassLoader(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    invoke-static {v0, v3}, encodeClassLoaderChain(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v4, v2}, encodeClassLoader(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v7

    invoke-static {v7, v0}, encodeClassLoaderChain(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v8

    aput-object v8, v3, v5

    invoke-static {v4, v6}, encodeClasspath(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
