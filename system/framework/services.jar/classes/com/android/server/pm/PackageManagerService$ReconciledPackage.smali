...
.method private constructor <init>(Lcom/android/server/pm/PackageManagerService$ReconcileRequest;Lcom/android/server/pm/PackageManagerService$InstallArgs;Lcom/android/server/pm/PackageSetting;Lcom/android/server/pm/PackageManagerService$PackageInstalledInfo;Lcom/android/server/pm/PackageManagerService$PrepareResult;Lcom/android/server/pm/PackageManagerService$ScanResult;Lcom/android/server/pm/PackageManagerService$DeletePackageAction;Ljava/util/List;Landroid/content/pm/PackageParser$SigningDetails;ZZ)V
    ...
    iput-object p1, p0, request:Lcom/android/server/pm/PackageManagerService$ReconcileRequest;

    iput-object p2, p0, installArgs:Lcom/android/server/pm/PackageManagerService$InstallArgs;

    iput-object p3, p0, pkgSetting:Lcom/android/server/pm/PackageSetting;

    iput-object p4, p0, installResult:Lcom/android/server/pm/PackageManagerService$PackageInstalledInfo;

    iput-object p5, p0, prepareResult:Lcom/android/server/pm/PackageManagerService$PrepareResult;

    iput-object p6, p0, scanResult:Lcom/android/server/pm/PackageManagerService$ScanResult;

    iput-object p7, p0, deletePackageAction:Lcom/android/server/pm/PackageManagerService$DeletePackageAction;

    iput-object p8, p0, allowedSharedLibraryInfos:Ljava/util/List;

    iput-object p9, p0, signingDetails:Landroid/content/pm/PackageParser$SigningDetails;

    iput-boolean p10, p0, sharedUserSignaturesChanged:Z

    iput-boolean p11, p0, removeAppKeySetData:Z
...
.method synthetic constructor <init>(Lcom/android/server/pm/PackageManagerService$ReconcileRequest;Lcom/android/server/pm/PackageManagerService$InstallArgs;Lcom/android/server/pm/PackageSetting;Lcom/android/server/pm/PackageManagerService$PackageInstalledInfo;Lcom/android/server/pm/PackageManagerService$PrepareResult;Lcom/android/server/pm/PackageManagerService$ScanResult;Lcom/android/server/pm/PackageManagerService$DeletePackageAction;Ljava/util/List;Landroid/content/pm/PackageParser$SigningDetails;ZZLcom/android/server/pm/PackageManagerService$1;)V
    ...
    invoke-direct/range {p0 .. p11}, <init>(Lcom/android/server/pm/PackageManagerService$ReconcileRequest;Lcom/android/server/pm/PackageManagerService$InstallArgs;Lcom/android/server/pm/PackageSetting;Lcom/android/server/pm/PackageManagerService$PackageInstalledInfo;Lcom/android/server/pm/PackageManagerService$PrepareResult;Lcom/android/server/pm/PackageManagerService$ScanResult;Lcom/android/server/pm/PackageManagerService$DeletePackageAction;Ljava/util/List;Landroid/content/pm/PackageParser$SigningDetails;ZZ)V
...
.method static synthetic access$2100(Lcom/android/server/pm/PackageManagerService$ReconciledPackage;)Ljava/util/Map;
    ...
    invoke-direct {p0}, getCombinedPackages()Ljava/util/Map;
...
.method private getCombinedPackages()Ljava/util/Map;
    ...
    iget-object v1, p0, request:Lcom/android/server/pm/PackageManagerService$ReconcileRequest;
    ...
    iget-object v2, p0, request:Lcom/android/server/pm/PackageManagerService$ReconcileRequest;
