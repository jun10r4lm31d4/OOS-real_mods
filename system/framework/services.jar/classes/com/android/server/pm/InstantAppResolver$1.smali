...
.method constructor <init>(Landroid/content/Intent;Landroid/content/pm/InstantAppRequest;Ljava/lang/String;Landroid/content/Intent;Landroid/content/pm/ActivityInfo;Landroid/content/Context;)V
    ...
    iput-object p1, p0, val$origIntent:Landroid/content/Intent;

    iput-object p2, p0, val$requestObj:Landroid/content/pm/InstantAppRequest;

    iput-object p3, p0, val$token:Ljava/lang/String;

    iput-object p4, p0, val$sanitizedIntent:Landroid/content/Intent;

    iput-object p5, p0, val$instantAppInstaller:Landroid/content/pm/ActivityInfo;

    iput-object p6, p0, val$context:Landroid/content/Context;
...
.method onPhaseTwoResolved(Ljava/util/List;J)V
    ...
    iget-object v2, v0, val$origIntent:Landroid/content/Intent;
    ...
    iget-object v1, v0, val$requestObj:Landroid/content/pm/InstantAppRequest;
    ...
    iget-object v7, v0, val$token:Ljava/lang/String;
    ...
    iget-object v4, v0, val$sanitizedIntent:Landroid/content/Intent;
    ...
    iget-object v11, v0, val$token:Ljava/lang/String;
    ...
    iget-object v4, v0, val$instantAppInstaller:Landroid/content/pm/ActivityInfo;

    iget-object v4, v4, Landroid/content/pm/ActivityInfo;->packageName:Ljava/lang/String;

    iget-object v5, v0, val$instantAppInstaller:Landroid/content/pm/ActivityInfo;
    ...
    iget-object v4, v0, val$token:Ljava/lang/String;

    iget-object v5, v0, val$requestObj:Landroid/content/pm/InstantAppRequest;
    ...
    iget-object v3, v0, val$context:Landroid/content/Context;
