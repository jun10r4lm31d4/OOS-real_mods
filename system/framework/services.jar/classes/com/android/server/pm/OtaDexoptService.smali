...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/pm/PackageManagerService;)V
    ...
    iput-object p2, p0, mPackageManagerService:Lcom/android/server/pm/PackageManagerService;

    new-instance v0, Lcom/android/internal/logging/MetricsLogger;

    invoke-direct {v0}, Lcom/android/internal/logging/MetricsLogger;-><init>()V

    iput-object v0, p0, metricsLogger:Lcom/android/internal/logging/MetricsLogger;
...
.method private declared-synchronized generatePackageDexopts(Landroid/content/pm/PackageParser$Package;I)Ljava/util/List;
    ...
    iget-object v3, p0, mPackageManagerService:Lcom/android/server/pm/PackageManagerService;
...
.method private getAvailableSpace()J
    ...
    invoke-direct {p0}, getMainLowSpaceThreshold()J
...
.method public static main(Landroid/content/Context;Lcom/android/server/pm/PackageManagerService;)Lcom/android/server/pm/OtaDexoptService;
    ...
    invoke-direct {v0, p0, p1}, <init>(Landroid/content/Context;Lcom/android/server/pm/PackageManagerService;)V
    ...
    invoke-direct {v0, v1}, moveAbArtifacts(Lcom/android/server/pm/Installer;)V
...
.method private moveAbArtifacts(Lcom/android/server/pm/Installer;)V
    ...
    iget-object v0, v1, mDexoptCommands:Ljava/util/List;
...
.method private performMetricsLogging()V
    ...
    iget-object v2, p0, metricsLogger:Lcom/android/internal/logging/MetricsLogger;

    iget-wide v3, p0, availableSpaceBefore:J

    invoke-static {v3, v4}, inMegabytes(J)I
    ...
    iget-wide v3, p0, availableSpaceAfterBulkDelete:J
    ...
    iget-wide v3, p0, availableSpaceAfterDexopt:J
    ...
    iget v3, p0, importantPackageCount:I
    ...
    iget v3, p0, otherPackageCount:I
    ...
    iget v3, p0, dexoptCommandCountTotal:I
    ...
    iget v3, p0, dexoptCommandCountExecuted:I
    ...
    iget-wide v3, p0, otaDexoptTimeStart:J
    ...
    iget-object v3, p0, metricsLogger:Lcom/android/internal/logging/MetricsLogger;
...
.method private prepareMetricsLogging(IIJJ)V
    ...
    iput-wide p3, p0, availableSpaceBefore:J

    iput-wide p5, p0, availableSpaceAfterBulkDelete:J

    const-wide/16 v0, 0x0

    iput-wide v0, p0, availableSpaceAfterDexopt:J

    iput p1, p0, importantPackageCount:I

    iput p2, p0, otherPackageCount:I

    iget-object v0, p0, mDexoptCommands:Ljava/util/List;

    invoke-interface {v0}, Ljava/util/List;->size()I

    move-result v0

    iput v0, p0, dexoptCommandCountTotal:I

    const/4 v0, 0x0

    iput v0, p0, dexoptCommandCountExecuted:I

    invoke-static {}, Ljava/lang/System;->nanoTime()J

    move-result-wide v0

    iput-wide v0, p0, otaDexoptTimeStart:J
...
.method public declared-synchronized cleanup()V
    ...
    iput-object v0, p0, mDexoptCommands:Ljava/util/List;

    invoke-direct {p0}, getAvailableSpace()J

    move-result-wide v0

    iput-wide v0, p0, availableSpaceAfterDexopt:J

    invoke-direct {p0}, performMetricsLogging()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized getProgress()F
    ...
    iget v1, p0, completeSize:I

    sub-int/2addr v1, v0

    int-to-float v1, v1

    iget v2, p0, completeSize:I
    :try_end_1
...
.method public declared-synchronized nextDexoptCommand()Ljava/lang/String;
    ...
    iget v1, p0, dexoptCommandCountExecuted:I

    add-int/lit8 v1, v1, 0x1

    iput v1, p0, dexoptCommandCountExecuted:I
    ...
    iget-object v3, p0, mDexoptCommands:Ljava/util/List;
    ...
    iget-object v1, p0, mDexoptCommands:Ljava/util/List;
...
.method public declared-synchronized prepare()V
    ...
    iget-object v4, p0, mPackageManagerService:Lcom/android/server/pm/PackageManagerService;
    ...
    iput-object v3, p0, mDexoptCommands:Ljava/util/List;
    ...
    iget-object v4, p0, mDexoptCommands:Ljava/util/List;

    const/4 v5, 0x4

    invoke-direct {p0, v3, v5}, generatePackageDexopts(Landroid/content/pm/PackageParser$Package;I)Ljava/util/List;
    ...
    iget-object v6, p0, mPackageManagerService:Lcom/android/server/pm/PackageManagerService;
    ...
    invoke-direct/range {v5 .. v11}, prepareMetricsLogging(IIJJ)V
    :try_end_2
