...
.method constructor <init>(Lcom/android/server/pm/Installer;Ljava/lang/Object;Landroid/content/Context;Z)V
    ...
    iput-boolean p4, p0, mOnlyCore:Z
...
.method private prepareUserDataLI(Ljava/lang/String;IIIZ)V
    ...
    iget-boolean v1, p0, mOnlyCore:Z

    if-nez v1, :cond_0

    invoke-virtual {p0, p1, p2}, getDataUserDeDirectory(Ljava/lang/String;I)Ljava/io/File;

    move-result-object v1

    invoke-virtual {p0, v1, p3}, enforceSerialNumber(Ljava/io/File;I)V
    ...
    invoke-virtual {p0, p2}, getDataSystemDeDirectory(I)Ljava/io/File;
    ...
    invoke-virtual {p0, p1, p2}, getDataUserCeDirectory(Ljava/lang/String;I)Ljava/io/File;
    ...
    invoke-virtual {p0, p2}, getDataSystemCeDirectory(I)Ljava/io/File;
    ...
    invoke-virtual {p0, p1, p2, p4}, destroyUserDataLI(Ljava/lang/String;II)V
    ...
    invoke-direct/range {v4 .. v9}, prepareUserDataLI(Ljava/lang/String;IIIZ)V
...
.method destroyUserData(II)V
    ...
    invoke-virtual {p0, v4, p1, p2}, destroyUserDataLI(Ljava/lang/String;II)V
...
.method destroyUserDataLI(Ljava/lang/String;II)V
    ...
    invoke-virtual {p0, p2}, getUserSystemDirectory(I)Ljava/io/File;
...
.method enforceSerialNumber(Ljava/io/File;I)V
    ...
    invoke-virtual {p0}, isFileEncryptedEmulatedOnly()Z
    ...
    :cond_1
    invoke-static {p1}, getSerialNumber(Ljava/io/File;)I
    ...
    :try_start_0
    invoke-static {p1, p2}, setSerialNumber(Ljava/io/File;I)V
    :try_end_0
...
.method reconcileUsers(Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-virtual {p0, p1, p2, v0}, reconcileUsers(Ljava/lang/String;Ljava/util/List;Ljava/util/List;)V
...
.method reconcileUsers(Ljava/lang/String;Ljava/util/List;Ljava/util/List;)V
    ...
    :cond_2
    iget-boolean v8, p0, mOnlyCore:Z
    ...
    invoke-virtual {p0, v3, v8}, enforceSerialNumber(Ljava/io/File;I)V
    :try_end_1
    ...
    :try_start_2
    invoke-virtual {p0, p1, v4, v8}, destroyUserDataLI(Ljava/lang/String;II)V
