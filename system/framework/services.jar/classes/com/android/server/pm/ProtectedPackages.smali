...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mDeviceProvisioningPackage:Ljava/lang/String;
...
.method private declared-synchronized hasDeviceOwnerOrProfileOwner(ILjava/lang/String;)Z
    ...
    :cond_0
    :try_start_0
    iget-object v1, p0, mDeviceOwnerPackage:Ljava/lang/String;
    ...
    :cond_1
    :try_start_1
    iget-object v1, p0, mProfileOwnerPackages:Landroid/util/SparseArray;
...
.method private declared-synchronized isProtectedPackage(Ljava/lang/String;)Z
    ...
    :try_start_0
    iget-object v0, p0, mDeviceProvisioningPackage:Ljava/lang/String;
...
.method public declared-synchronized getDeviceOwnerOrProfileOwnerPackage(I)Ljava/lang/String;
    ...
    iget-object v0, p0, mDeviceOwnerPackage:Ljava/lang/String;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_0
    :try_start_1
    iget-object v0, p0, mProfileOwnerPackages:Landroid/util/SparseArray;
...
.method public isPackageDataProtected(ILjava/lang/String;)Z
    ...
    invoke-direct {p0, p1, p2}, hasDeviceOwnerOrProfileOwner(ILjava/lang/String;)Z

    move-result v0

    if-nez v0, :cond_1

    invoke-direct {p0, p2}, isProtectedPackage(Ljava/lang/String;)Z
...
.method public declared-synchronized setDeviceAndProfileOwnerPackages(ILjava/lang/String;Landroid/util/SparseArray;)V
    ...
    :goto_0
    iput-object v0, p0, mDeviceOwnerPackage:Ljava/lang/String;
    ...
    :goto_1
    iput-object v1, p0, mProfileOwnerPackages:Landroid/util/SparseArray;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
