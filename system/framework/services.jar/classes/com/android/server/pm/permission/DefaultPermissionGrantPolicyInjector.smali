...
.method static constructor <clinit>()V
    ...
    sput-object v0, CARRIER_1_ADAPT_PERMISSIONS:Ljava/util/Set;

    sget-object v0, CARRIER_1_ADAPT_PERMISSIONS:Ljava/util/Set;
    ...
    sput-object v0, CARRIER_1_MYACCOUNT_PERMISSIONS:Ljava/util/Set;

    sget-object v0, CARRIER_1_MYACCOUNT_PERMISSIONS:Ljava/util/Set;
    ...
    sput-object v0, CARRIER_1_RSU_PERMISSIONS:Ljava/util/Set;

    sget-object v0, CARRIER_1_RSU_PERMISSIONS:Ljava/util/Set;
    ...
    sput-object v0, CARRIER_2_CE_PERMISSIONS:Ljava/util/Set;

    sget-object v0, CARRIER_2_CE_PERMISSIONS:Ljava/util/Set;
    ...
    sput-object v0, CARRIER_2_MS_PERMISSIONS:Ljava/util/Set;

    sget-object v0, CARRIER_2_MS_PERMISSIONS:Ljava/util/Set;
    ...
    sput-object v0, CARRIER_2_ECID_PERMISSIONS:Ljava/util/Set;

    sget-object v0, CARRIER_2_ECID_PERMISSIONS:Ljava/util/Set;
    ...
    sput-object v0, CARRIER_2_VVM_PERMISSIONS:Ljava/util/Set;

    sget-object v0, CARRIER_2_VVM_PERMISSIONS:Ljava/util/Set;
    ...
    sput-object v0, MARKET_PERMISSIONS:Ljava/util/Set;

    sget-object v0, MARKET_PERMISSIONS:Ljava/util/Set;
    ...
    sput-object v0, CLOUD_SERVICE_PERMISSIONS:Ljava/util/Set;

    sget-object v0, CLOUD_SERVICE_PERMISSIONS:Ljava/util/Set;
    ...
    sput-object v0, INSTANT_APP_PERMISSIONS:Ljava/util/Set;

    sget-object v0, INSTANT_APP_PERMISSIONS:Ljava/util/Set;
    ...
    sput-object v0, SPEECHASSIST_PERMISSIONS:Ljava/util/Set;

    sget-object v0, SPEECHASSIST_PERMISSIONS:Ljava/util/Set;
...
.method public static getInstance()Lcom/android/server/pm/permission/DefaultPermissionGrantPolicyInjector;
    ...
    sget-object v0, mDefaultPermissionGrantPolicyInjector:Lcom/android/server/pm/permission/DefaultPermissionGrantPolicyInjector;
    ...
    sput-object v0, mDefaultPermissionGrantPolicyInjector:Lcom/android/server/pm/permission/DefaultPermissionGrantPolicyInjector;
...
.method public static grantDefaultPermissionToCloudServiceApp([I)V
    ...
    sget-object v5, CLOUD_SERVICE_PERMISSIONS:Ljava/util/Set;

    aput-object v5, v4, v1

    const-string v5, "com.heytap.cloud"

    invoke-static {v5, v3, v4}, grantPermissionsToSystemPackage(Ljava/lang/String;I[Ljava/util/Set;)V
...
.method public static grantDefaultPermissionToInstantApp([I)V
    ...
    sget-object v5, INSTANT_APP_PERMISSIONS:Ljava/util/Set;
...
.method public static grantDefaultPermissionToMarketAndGameCenterApp([I)V
    ...
    sget-object v6, MARKET_PERMISSIONS:Ljava/util/Set;

    aput-object v6, v5, v1

    const-string v6, "com.oppo.market"

    invoke-static {v6, v3, v5}, grantPermissionsToSystemPackage(Ljava/lang/String;I[Ljava/util/Set;)V
    ...
    sget-object v5, MARKET_PERMISSIONS:Ljava/util/Set;
...
.method public static grantDefaultPermissionToSpeechAssist([I)V
    ...
    sget-object v5, SPEECHASSIST_PERMISSIONS:Ljava/util/Set;
...
.method public static grantDefaultPermissionToSystemAppsForInitializationOrUpgrading([I)V
    ...
    invoke-static {p0}, grantDefaultPermissionToMarketAndGameCenterApp([I)V

    invoke-static {p0}, grantDefaultPermissionToLocationApp([I)V

    invoke-static {p0}, grantDefaultPermissionToInstantApp([I)V

    invoke-static {p0}, grantDefaultPermissionToSpeechAssist([I)V
    ...
    sget-object v1, mDefaultPermissionGrantPolicy:Lcom/android/server/pm/permission/DefaultPermissionGrantPolicy;
...
.method public static varargs grantPermissionsToSystemPackage(Ljava/lang/String;I[Ljava/util/Set;)V
    ...
    sget-object v0, mDefaultPermissionGrantPolicy:Lcom/android/server/pm/permission/DefaultPermissionGrantPolicy;
...
.method public static initInstance(Lcom/android/server/pm/permission/DefaultPermissionGrantPolicy;)V
    ...
    sput-object p0, mDefaultPermissionGrantPolicy:Lcom/android/server/pm/permission/DefaultPermissionGrantPolicy;
...
.method public static revokeDefaultPermissionsFromBrowserApps([I)V
    ...
    sget-object v4, mDefaultPermissionGrantPolicy:Lcom/android/server/pm/permission/DefaultPermissionGrantPolicy;
...
.method public grantDefaultPermissionsToUssVVM(Landroid/content/Context;I)V
    ...
    sget-object v6, CARRIER_2_VVM_PERMISSIONS:Ljava/util/Set;
...
.method public setCarrierPackagePermissions(I)V
    ...
    sget-object v4, CARRIER_1_ADAPT_PERMISSIONS:Ljava/util/Set;
    ...
    sget-object v4, CARRIER_1_MYACCOUNT_PERMISSIONS:Ljava/util/Set;
    ...
    sget-object v4, CARRIER_1_RSU_PERMISSIONS:Ljava/util/Set;
    ...
    sget-object v4, CARRIER_2_CE_PERMISSIONS:Ljava/util/Set;
    ...
    sget-object v4, CARRIER_2_MS_PERMISSIONS:Ljava/util/Set;
    ...
    sget-object v3, CARRIER_2_ECID_PERMISSIONS:Ljava/util/Set;
