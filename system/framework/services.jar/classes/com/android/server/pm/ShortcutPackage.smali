...
.method public constructor <init>(Lcom/android/server/pm/ShortcutUser;ILjava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2, p3, v0}, <init>(Lcom/android/server/pm/ShortcutUser;ILjava/lang/String;Lcom/android/server/pm/ShortcutPackageInfo;)V
...
.method private constructor <init>(Lcom/android/server/pm/ShortcutUser;ILjava/lang/String;Lcom/android/server/pm/ShortcutPackageInfo;)V
    ...
    iput-object v0, p0, mShortcuts:Landroid/util/ArrayMap;
    ...
    iput-object v0, p0, mShareTargets:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, mShortcutTypeAndRankComparator:Ljava/util/Comparator;
    ...
    iput-object v0, p0, mShortcutRankComparator:Ljava/util/Comparator;
...
.method private areAllActivitiesStillEnabled()Z
    ...
    iget-object v0, p0, mShortcuts:Landroid/util/ArrayMap;
    ...
    iget-object v3, p0, mShortcuts:Landroid/util/ArrayMap;
    ...
    iget-object v4, p0, mShortcuts:Landroid/util/ArrayMap;
...
.method private deleteOrDisableWithId(Ljava/lang/String;ZZZI)Landroid/content/pm/ShortcutInfo;
    ...
    iget-object v2, p0, mShortcuts:Landroid/util/ArrayMap;
    ...
    invoke-direct {p0, v2, v0}, ensureNotImmutable(Landroid/content/pm/ShortcutInfo;Z)V
    ...
    :cond_6
    invoke-direct {p0, p1}, forceDeleteShortcutInner(Ljava/lang/String;)Landroid/content/pm/ShortcutInfo;
...
.method private disableDynamicWithId(Ljava/lang/String;ZI)Z
    ...
    invoke-direct/range {v0 .. v5}, deleteOrDisableWithId(Ljava/lang/String;ZZZI)Landroid/content/pm/ShortcutInfo;
...
.method private forceDeleteShortcutInner(Ljava/lang/String;)Landroid/content/pm/ShortcutInfo;
    ...
    iget-object v1, p0, mShortcutUser:Lcom/android/server/pm/ShortcutUser;
...
.method private forceReplaceShortcutInner(Landroid/content/pm/ShortcutInfo;)V
    ...
    invoke-direct {p0, v1}, forceDeleteShortcutInner(Ljava/lang/String;)Landroid/content/pm/ShortcutInfo;
    ...
    iget-object v1, p0, mShortcuts:Landroid/util/ArrayMap;
...
.method public static loadFromXml(Lcom/android/server/pm/ShortcutService;Lcom/android/server/pm/ShortcutUser;Lorg/xmlpull/v1/XmlPullParser;Z)Lcom/android/server/pm/ShortcutPackage;
    ...
    invoke-direct {v1, p1, v2, v0}, <init>(Lcom/android/server/pm/ShortcutUser;ILjava/lang/String;)V
    ...
    iput-wide v2, v1, mLastResetTime:J
    ...
    :cond_6
    iget-object v3, v1, mShareTargets:Ljava/util/ArrayList;
    ...
    invoke-static {p2, v0, v3, p3}, parseShortcut(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IZ)Landroid/content/pm/ShortcutInfo;

    move-result-object v3

    iget-object v5, v1, mShortcuts:Landroid/util/ArrayMap;
    ...
    :cond_8
    invoke-virtual {v1}, getPackageInfo()Lcom/android/server/pm/ShortcutPackageInfo;
...
.method private static parseShortcut(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IZ)Landroid/content/pm/ShortcutInfo;
    ...
    :cond_6
    invoke-static/range {p0 .. p0}, parsePerson(Lorg/xmlpull/v1/XmlPullParser;)Landroid/app/Person;
    ...
    :cond_9
    invoke-static/range {p0 .. p0}, parseIntent(Lorg/xmlpull/v1/XmlPullParser;)Landroid/content/Intent;
...
.method private publishManifestShortcuts(Ljava/util/List;)Z
    ...
    iget-object v7, p0, mShortcuts:Landroid/util/ArrayMap;
    ...
    :cond_5
    invoke-direct {p0, v4}, forceReplaceShortcutInner(Landroid/content/pm/ShortcutInfo;)V
    ...
    invoke-virtual/range {v4 .. v10}, disableWithId(Ljava/lang/String;Ljava/lang/String;IZZI)V
    ...
    :cond_8
    invoke-direct {p0}, removeOrphans()V

    :cond_9
    invoke-virtual {p0}, adjustRanks()V
...
.method private pushOutExcessShortcuts()Z
    ...
    invoke-direct {p0}, sortShortcutsToActivities()Landroid/util/ArrayMap;
    ...
    :cond_0
    iget-object v7, p0, mShortcutTypeAndRankComparator:Ljava/util/Comparator;
    ...
    invoke-virtual {p0, v9, v5}, deleteDynamicWithId(Ljava/lang/String;Z)Z
...
.method private removeOrphans()V
    ...
    invoke-direct {p0, v2}, forceDeleteShortcutInner(Ljava/lang/String;)Landroid/content/pm/ShortcutInfo;
...
.method private saveShortcut(Lorg/xmlpull/v1/XmlSerializer;Landroid/content/pm/ShortcutInfo;ZZ)V
    ...
    iget-object v2, v1, mShortcutUser:Lcom/android/server/pm/ShortcutUser;
    ...
    invoke-virtual/range {p0 .. p0}, getPackageInfo()Lcom/android/server/pm/ShortcutPackageInfo;
...
.method private sortShortcutsToActivities()Landroid/util/ArrayMap;
    ...
    iget-object v4, p0, mShortcutUser:Lcom/android/server/pm/ShortcutUser;
...
.method public addOrReplaceDynamicShortcut(Landroid/content/pm/ShortcutInfo;)V
    ...
    :cond_1
    invoke-direct {p0, p1}, forceReplaceShortcutInner(Landroid/content/pm/ShortcutInfo;)V
...
.method public adjustRanks()V
    ...
    iget-object v6, p0, mShortcutRankComparator:Ljava/util/Comparator;
...
.method public deleteAllDynamicShortcuts(Z)V
    ...
    iget-object v5, p0, mShortcuts:Landroid/util/ArrayMap;
...
.method public dump(Ljava/io/PrintWriter;Ljava/lang/String;Lcom/android/server/pm/ShortcutService$DumpFilter;)V
    ...
    invoke-virtual {p0, v1}, getApiCallCount(Z)I
    ...
    iget-wide v1, p0, mLastKnownForegroundElapsedTime:J
    ...
    iget-wide v1, p0, mLastResetTime:J
...
.method public enableWithId(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0, v1}, ensureNotImmutable(Landroid/content/pm/ShortcutInfo;Z)V
...
.method public enforceShortcutCountsBeforeOperation(Ljava/util/List;I)V
    ...
    invoke-direct {p0, v1, v5, v3}, incrementCountForActivity(Landroid/util/ArrayMap;Landroid/content/ComponentName;I)V
    ...
    invoke-direct {p0, v1, v6, v8}, incrementCountForActivity(Landroid/util/ArrayMap;Landroid/content/ComponentName;I)V
...
.method public ensureImmutableShortcutsNotIncluded(Ljava/util/List;Z)V
    ...
    invoke-virtual {p0, v1, p2}, ensureNotImmutable(Ljava/lang/String;Z)V
...
.method public ensureNotImmutable(Ljava/lang/String;Z)V
    ...
    invoke-direct {p0, v0, p2}, ensureNotImmutable(Landroid/content/pm/ShortcutInfo;Z)V
...
.method public findAll(Ljava/util/List;Ljava/util/function/Predicate;I)V
    ...
    invoke-virtual/range {v0 .. v6}, findAll(Ljava/util/List;Ljava/util/function/Predicate;ILjava/lang/String;IZ)V
...
.method getAllShareTargetsForTest()Ljava/util/List;
    ...
    iget-object v1, p0, mShareTargets:Ljava/util/ArrayList;
...
.method public getApiCallCount(Z)I
    ...
    iput-wide v1, p0, mLastKnownForegroundElapsedTime:J

    invoke-virtual {p0}, resetRateLimiting()V
    ...
    iget-wide v7, p0, mLastResetTime:J
    ...
    iput-wide v3, p0, mLastResetTime:J

    iput v6, p0, mApiCallCount:I

    iget v5, p0, mApiCallCount:I
...
.method public getMatchingShareTargets(Landroid/content/IntentFilter;)Ljava/util/List;
    ...
    :goto_0
    iget-object v2, p0, mShareTargets:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v1, v2, v3}, findAll(Ljava/util/List;Ljava/util/function/Predicate;I)V
...
.method getSharingShortcutCount()I
    ...
    iget-object v0, p0, mShareTargets:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v0, v1, v2}, findAll(Ljava/util/List;Ljava/util/function/Predicate;I)V
    ...
    :goto_1
    iget-object v5, p0, mShareTargets:Ljava/util/ArrayList;
    ...
    iget-object v6, p0, mShareTargets:Ljava/util/ArrayList;
...
.method public getUsedBitmapFiles()Landroid/util/ArraySet;
    ...
    invoke-static {v3}, getFileName(Ljava/lang/String;)Ljava/lang/String;
...
.method public isShortcutExistsAndInvisibleToPublisher(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1}, findShortcutById(Ljava/lang/String;)Landroid/content/pm/ShortcutInfo;
...
.method protected onRestored(I)V
    ...
    :cond_1
    invoke-virtual {p0}, refreshPinnedFlags()V
...
.method public rescanPackageIfNeeded(ZZ)Z
    ...
    iget-object v0, v1, mShortcutUser:Lcom/android/server/pm/ShortcutUser;
    ...
    invoke-virtual/range {p0 .. p0}, getPackageUserId()I
    ...
    invoke-direct/range {p0 .. p0}, areAllActivitiesStillEnabled()Z
    ...
    iget-object v11, v1, mShareTargets:Ljava/util/ArrayList;
    ...
    iget-object v11, v1, mShortcuts:Landroid/util/ArrayMap;
    ...
    iget-object v13, v1, mShortcuts:Landroid/util/ArrayMap;
    ...
    iget-object v14, v1, mShortcuts:Landroid/util/ArrayMap;
    ...
    invoke-direct {v1, v8, v15, v12}, disableDynamicWithId(Ljava/lang/String;ZI)Z
    ...
    invoke-virtual/range {p0 .. p0}, getPackageResources()Landroid/content/res/Resources;
    ...
    :goto_7
    invoke-direct {v1, v6}, publishManifestShortcuts(Ljava/util/List;)Z

    if-eqz v6, :cond_11

    invoke-direct/range {p0 .. p0}, pushOutExcessShortcuts()Z
...
.method public resetRateLimiting()V
    ...
    iget v0, p0, mApiCallCount:I

    if-lez v0, :cond_0

    const/4 v0, 0x0

    iput v0, p0, mApiCallCount:I
...
.method public resetRateLimitingForCommandLineNoSaving()V
    ...
    iput-wide v0, p0, mLastResetTime:J
...
.method public resolveResourceStrings()V
    ...
    invoke-virtual {p0}, getPackageResources()Landroid/content/res/Resources;
...
.method public saveToXml(Lorg/xmlpull/v1/XmlSerializer;Z)V
    ...
    iget-wide v4, p0, mLastResetTime:J
    ...
    invoke-direct {p0, p1, v5, p2, v6}, saveShortcut(Lorg/xmlpull/v1/XmlSerializer;Landroid/content/pm/ShortcutInfo;ZZ)V
...
.method public tryApiCall(Z)Z
    ...
    invoke-virtual {p0, p1}, getApiCallCount(Z)I
    ...
    :cond_0
    iget v1, p0, mApiCallCount:I

    const/4 v2, 0x1

    add-int/2addr v1, v2

    iput v1, p0, mApiCallCount:I
...
.method public verifyStates()V
    ...
    iget-object v9, p0, mShortcutUser:Lcom/android/server/pm/ShortcutUser;
    ...
    invoke-direct {p0, v5}, verifyRanksSequential(Ljava/util/List;)Z

    invoke-direct {p0, v6}, verifyRanksSequential(Ljava/util/List;)Z
