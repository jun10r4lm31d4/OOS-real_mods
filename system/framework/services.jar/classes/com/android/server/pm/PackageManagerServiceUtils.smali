...
.method private static applyPackageFilter(Ljava/util/function/Predicate;Ljava/util/Collection;Ljava/util/Collection;Ljava/util/List;Lcom/android/server/pm/PackageManagerService;)V
    ...
    :cond_1
    invoke-static {p3, p4}, sortPackagesByUsageDate(Ljava/util/List;Lcom/android/server/pm/PackageManagerService;)V
...
.method public static compressedFileExists(Ljava/lang/String;)Z
    ...
    invoke-static {p0}, getCompressedFiles(Ljava/lang/String;)[Ljava/io/File;
...
.method public static copyPackage(Ljava/lang/String;Ljava/io/File;)I
    ...
    invoke-static {v3, p1, v4}, copyFile(Ljava/lang/String;Ljava/io/File;Ljava/lang/String;)V
...
.method public static decompressFile(Ljava/io/File;Ljava/io/File;)I
    ...
    :try_start_3
    invoke-static {v4, v2}, $closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_2

    :try_start_4
    invoke-static {v4, v0}, $closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_4
    ...
    invoke-static {v2, v1}, logCriticalInfo(ILjava/lang/String;)V
...
.method public static dumpCriticalInfo(Landroid/util/proto/ProtoOutputStream;)V
    ...
    invoke-static {}, getSettingsProblemFile()Ljava/io/File;
...
.method public static getPackagesForDexopt(Ljava/util/Collection;Lcom/android/server/pm/PackageManagerService;)Ljava/util/List;
    ...
    invoke-static {p0, p1, v0}, getPackagesForDexopt(Ljava/util/Collection;Lcom/android/server/pm/PackageManagerService;Z)Ljava/util/List;
...
.method public static getPackagesForDexopt(Ljava/util/Collection;Lcom/android/server/pm/PackageManagerService;Z)Ljava/util/List;
    ...
    invoke-static {v3, v1, v0, v2, p1}, applyPackageFilter(Ljava/util/function/Predicate;Ljava/util/Collection;Ljava/util/Collection;Ljava/util/List;Lcom/android/server/pm/PackageManagerService;)V
    ...
    invoke-static {v3, v4}, getPackageNamesForIntent(Landroid/content/Intent;I)Landroid/util/ArraySet;
    ...
    invoke-static {v5, v1, v0, v2, p1}, applyPackageFilter(Ljava/util/function/Predicate;Ljava/util/Collection;Ljava/util/Collection;Ljava/util/List;Lcom/android/server/pm/PackageManagerService;)V
    ...
    invoke-static {v6, v1, v0, v2, p1}, applyPackageFilter(Ljava/util/function/Predicate;Ljava/util/Collection;Ljava/util/Collection;Ljava/util/List;Lcom/android/server/pm/PackageManagerService;)V
    ...
    :goto_0
    invoke-static {v0, p1}, sortPackagesByUsageDate(Ljava/util/List;Lcom/android/server/pm/PackageManagerService;)V
    ...
    :goto_1
    invoke-static {v12, v1, v0, v2, p1}, applyPackageFilter(Ljava/util/function/Predicate;Ljava/util/Collection;Ljava/util/Collection;Ljava/util/List;Lcom/android/server/pm/PackageManagerService;)V
    ...
    invoke-static {v1}, packagesToString(Ljava/util/Collection;)Ljava/lang/String;
    ...
    invoke-static {v0}, packagesToString(Ljava/util/Collection;)Ljava/lang/String;
...
.method static isApkVerificationForced(Lcom/android/server/pm/PackageSetting;)Z
    ...
    invoke-static {}, isApkVerityEnabled()Z

    move-result v0

    if-nez v0, :cond_0

    invoke-static {}, isLegacyApkVerityEnabled()Z
...
.method private static matchSignatureInSystem(Lcom/android/server/pm/PackageSetting;Lcom/android/server/pm/PackageSetting;)Z
    ...
    invoke-static {v1, v2}, logCriticalInfo(ILjava/lang/String;)V
    :try_end_0
    .catch Landroid/content/pm/PackageParser$PackageParserException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v1, v3}, logCriticalInfo(ILjava/lang/String;)V
...
.method private static matchSignaturesCompat(Ljava/lang/String;Lcom/android/server/pm/PackageSignatures;Landroid/content/pm/PackageParser$SigningDetails;)Z
    ...
    invoke-static {v2, v4}, logCriticalInfo(ILjava/lang/String;)V
...
.method public static verifySignatures(Lcom/android/server/pm/PackageSetting;Lcom/android/server/pm/PackageSetting;Landroid/content/pm/PackageParser$SigningDetails;ZZ)Z
    ...
    invoke-static {v0, v7, p2}, matchSignaturesCompat(Ljava/lang/String;Lcom/android/server/pm/PackageSignatures;Landroid/content/pm/PackageParser$SigningDetails;)Z
    ...
    invoke-static {v0, v7, p2, v5}, matchSignaturesRecover(Ljava/lang/String;Landroid/content/pm/PackageParser$SigningDetails;Landroid/content/pm/PackageParser$SigningDetails;I)Z
    ...
    invoke-static {v0, p2, v7, v6}, matchSignaturesRecover(Ljava/lang/String;Landroid/content/pm/PackageParser$SigningDetails;Landroid/content/pm/PackageParser$SigningDetails;I)Z
    ...
    invoke-static {p1}, isApkVerificationForced(Lcom/android/server/pm/PackageSetting;)Z

    move-result v6

    if-eqz v6, :cond_6

    invoke-static {p0, p1}, matchSignatureInSystem(Lcom/android/server/pm/PackageSetting;Lcom/android/server/pm/PackageSetting;)Z
    ...
    invoke-static {v0, v7, p2, v6}, matchSignaturesRecover(Ljava/lang/String;Landroid/content/pm/PackageParser$SigningDetails;Landroid/content/pm/PackageParser$SigningDetails;I)Z
