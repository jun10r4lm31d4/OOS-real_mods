...
.method static constructor <clinit>()V
    ...
    sput-object v0, sMacPermissions:Ljava/util/List;

    sget-object v0, sMacPermissions:Ljava/util/List;
    ...
    sget-object v1, sMacPermissions:Ljava/util/List;
    ...
    sget-object v2, sMacPermissions:Ljava/util/List;
    ...
    sget-object v3, sMacPermissions:Ljava/util/List;
...
.method public static getSeInfo(Landroid/content/pm/PackageParser$Package;ZII)Ljava/lang/String;
    ...
    sget-object v1, sPolicies:Ljava/util/List;

    monitor-enter v1

    :try_start_0
    sget-boolean v2, sPolicyRead:Z
    ...
    :cond_0
    sget-object v2, sPolicies:Ljava/util/List;
...
.method public static readInstallPolicy()Z
    ...
    sget-object v0, sPolicies:Ljava/util/List;

    monitor-enter v0

    :try_start_0
    sget-boolean v1, sPolicyRead:Z
    ...
    sget-object v4, sMacPermissions:Ljava/util/List;
    ...
    sget-object v7, sMacPermissions:Ljava/util/List;
    ...
    invoke-static {v3}, skip(Lorg/xmlpull/v1/XmlPullParser;)V

    goto :goto_3

    :cond_4
    invoke-static {v3}, readSignerOrThrow(Lorg/xmlpull/v1/XmlPullParser;)Lcom/android/server/pm/Policy;
    ...
    :cond_7
    sget-object v7, sPolicies:Ljava/util/List;
...
.method private static readSignerOrThrow(Lorg/xmlpull/v1/XmlPullParser;)Lcom/android/server/pm/Policy;
    ...
    invoke-static {p0, v2}, readPackageOrThrow(Lorg/xmlpull/v1/XmlPullParser;Lcom/android/server/pm/Policy$PolicyBuilder;)V
