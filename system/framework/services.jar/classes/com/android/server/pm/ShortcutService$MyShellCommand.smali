...
.method private handleClearDefaultLauncher()V
    ...
    :try_start_0
    invoke-direct {p0, v1}, parseOptionsLocked(Z)V

    invoke-direct {p0}, clearLauncher()V
...
.method private handleGetDefaultLauncher()V
    ...
    invoke-direct {p0}, showLauncher()V
...
.method private handleOverrideConfig()V
    ...
    :try_start_0
    iget-object v2, p0, this$0:Lcom/android/server/pm/ShortcutService;
...
.method public onCommand(Ljava/lang/String;)I
    ...
    :pswitch_0
    invoke-direct {p0}, handleVerifyStates()V

    goto :goto_1

    :pswitch_1
    invoke-direct {p0}, handleClearShortcuts()V

    goto :goto_1

    :pswitch_2
    invoke-direct {p0}, handleUnloadUser()V

    goto :goto_1

    :pswitch_3
    invoke-direct {p0}, handleGetDefaultLauncher()V

    goto :goto_1

    :pswitch_4
    invoke-direct {p0}, handleClearDefaultLauncher()V

    goto :goto_1

    :pswitch_5
    invoke-direct {p0}, handleResetConfig()V

    goto :goto_1

    :pswitch_6
    invoke-direct {p0}, handleOverrideConfig()V

    goto :goto_1

    :pswitch_7
    invoke-direct {p0}, handleResetAllThrottling()V

    goto :goto_1

    :pswitch_8
    invoke-direct {p0}, handleResetThrottling()V
    :try_end_0
