...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/pm/PackageManagerService;Lcom/android/server/pm/ApexManager;)V
    ...
    iput-boolean v0, p0, mOkToSendBroadcasts:Z
    ...
    iput-object v0, p0, mInternalCallback:Lcom/android/server/pm/PackageInstallerService$InternalCallback;
    ...
    iput-object v0, p0, mAllocatedSessions:Landroid/util/SparseBooleanArray;
    ...
    iput-object v0, p0, mHistoricalSessions:Ljava/util/List;

    new-instance v0, Landroid/util/SparseIntArray;

    invoke-direct {v0}, Landroid/util/SparseIntArray;-><init>()V

    iput-object v0, p0, mHistoricalSessionsByInstaller:Landroid/util/SparseIntArray;

    new-instance v0, Landroid/util/SparseBooleanArray;

    invoke-direct {v0}, Landroid/util/SparseBooleanArray;-><init>()V

    iput-object v0, p0, mLegacySessions:Landroid/util/SparseBooleanArray;
    ...
    iput-object v0, p0, mPermissionManager:Lcom/android/server/pm/permission/PermissionManagerServiceInternal;
    ...
    iput-object v0, p0, mInstallThread:Landroid/os/HandlerThread;

    iget-object v0, p0, mInstallThread:Landroid/os/HandlerThread;

    invoke-virtual {v0}, Landroid/os/HandlerThread;->start()V

    new-instance v0, Landroid/os/Handler;

    iget-object v1, p0, mInstallThread:Landroid/os/HandlerThread;
    ...
    iput-object v0, p0, mInstallHandler:Landroid/os/Handler;
    ...
    iput-object v0, p0, mCallbacks:Lcom/android/server/pm/PackageInstallerService$Callbacks;
    ...
    iput-object v0, p0, mSessionsFile:Landroid/util/AtomicFile;
    ...
    iput-object v0, p0, mSessionsDir:Ljava/io/File;

    iget-object v0, p0, mSessionsDir:Ljava/io/File;

    invoke-virtual {v0}, Ljava/io/File;->mkdirs()Z

    iput-object p3, p0, mApexManager:Lcom/android/server/pm/ApexManager;
    ...
    iput-object v0, p0, mStagingManager:Lcom/android/server/pm/StagingManager;
...
.method static synthetic access$1200(Lcom/android/server/pm/PackageInstallerService;Lcom/android/server/pm/PackageInstallerSession;)V
    ...
    invoke-direct {p0, p1}, addHistoricalSessionLocked(Lcom/android/server/pm/PackageInstallerSession;)V
...
.method static synthetic access$900(Lcom/android/server/pm/PackageInstallerService;)Z
    ...
    iget-boolean v0, p0, mOkToSendBroadcasts:Z
...
.method private addHistoricalSessionLocked(Lcom/android/server/pm/PackageInstallerSession;)V
    ...
    iget-object v2, p0, mHistoricalSessions:Ljava/util/List;
    ...
    iget-object v3, p0, mHistoricalSessionsByInstaller:Landroid/util/SparseIntArray;
...
.method private allocateSessionIdLocked()I
    ...
    iget-object v3, p0, mAllocatedSessions:Landroid/util/SparseBooleanArray;
...
.method private buildSessionDir(ILandroid/content/pm/PackageInstaller$SessionParams;)Ljava/io/File;
    ...
    invoke-direct {p0, p1, v0}, buildTmpSessionDir(ILjava/lang/String;)Ljava/io/File;
...
.method private buildTmpSessionDir(ILjava/lang/String;)Ljava/io/File;
    ...
    invoke-direct {p0, p2}, getTmpSessionDir(Ljava/lang/String;)Ljava/io/File;
...
.method private createSessionInternal(Landroid/content/pm/PackageInstaller$SessionParams;Ljava/lang/String;I)I
    ...
    iget-object v1, v15, mPermissionManager:Lcom/android/server/pm/permission/PermissionManagerServiceInternal;
    ...
    iget-object v0, v15, mPm:Lcom/android/server/pm/PackageManagerService;
    ...
    iget-object v0, v15, mAppOps:Landroid/app/AppOpsManager;
    ...
    invoke-direct {v15, v14}, isDowngradeAllowedForCaller(I)Z
    ...
    iget-object v0, v15, mApexManager:Lcom/android/server/pm/ApexManager;
    ...
    :cond_16
    :goto_9
    iget-object v1, v15, mSessions:Landroid/util/SparseArray;

    monitor-enter v1

    :try_start_1
    iget-object v0, v15, mSessions:Landroid/util/SparseArray;

    invoke-static {v0, v14}, getSessionCount(Landroid/util/SparseArray;I)I
    ...
    iget-object v2, v15, mHistoricalSessionsByInstaller:Landroid/util/SparseIntArray;
    ...
    invoke-direct {v15, v10, v13}, buildSessionDir(ILandroid/content/pm/PackageInstaller$SessionParams;)Ljava/io/File;
    ...
    :cond_17
    invoke-direct {v15, v10}, buildExternalStageCid(I)Ljava/lang/String;
    ...
    iget-object v2, v15, mInternalCallback:Lcom/android/server/pm/PackageInstallerService$InternalCallback;

    iget-object v3, v15, mContext:Landroid/content/Context;

    iget-object v4, v15, mPm:Lcom/android/server/pm/PackageManagerService;

    iget-object v5, v15, mInstallThread:Landroid/os/HandlerThread;

    invoke-virtual {v5}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v6

    iget-object v7, v15, mStagingManager:Lcom/android/server/pm/StagingManager;
    ...
    iget-object v4, v3, mSessions:Landroid/util/SparseArray;

    monitor-enter v4

    :try_start_3
    iget-object v0, v3, mSessions:Landroid/util/SparseArray;
    :try_end_3
    ...
    iget-object v0, v3, mStagingManager:Lcom/android/server/pm/StagingManager;
    ...
    iget-object v0, v3, mCallbacks:Lcom/android/server/pm/PackageInstallerService$Callbacks;
...
.method private openSessionInternal(I)Landroid/content/pm/IPackageInstallerSession;
    ...
    invoke-direct {p0, v1}, isCallingUidOwner(Lcom/android/server/pm/PackageInstallerSession;)Z
...
.method private readSessionsLocked()V
    ...
    :try_start_0
    iget-object v2, p0, mSessionsFile:Landroid/util/AtomicFile;
    ...
    :try_start_1
    iget-object v4, p0, mInternalCallback:Lcom/android/server/pm/PackageInstallerService$InternalCallback;

    iget-object v5, p0, mContext:Landroid/content/Context;

    iget-object v6, p0, mPm:Lcom/android/server/pm/PackageManagerService;

    iget-object v3, p0, mInstallThread:Landroid/os/HandlerThread;

    invoke-virtual {v3}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v7

    iget-object v8, p0, mStagingManager:Lcom/android/server/pm/StagingManager;

    iget-object v9, p0, mSessionsDir:Ljava/io/File;
    ...
    :cond_4
    invoke-direct {p0, v3}, addHistoricalSessionLocked(Lcom/android/server/pm/PackageInstallerSession;)V

    :goto_2
    iget-object v9, p0, mAllocatedSessions:Landroid/util/SparseBooleanArray;
...
.method private reconcileStagesLocked(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, getTmpSessionDir(Ljava/lang/String;)Ljava/io/File;

    move-result-object v0

    sget-object v1, sStageFilter:Ljava/io/FilenameFilter;

    invoke-virtual {v0, v1}, Ljava/io/File;->listFiles(Ljava/io/FilenameFilter;)[Ljava/io/File;

    move-result-object v1

    invoke-static {v1}, newArraySet([Ljava/lang/Object;)Landroid/util/ArraySet;
...
.method private writeSessionsLocked()V
    ...
    iget-object v0, p0, mSessionsFile:Landroid/util/AtomicFile;
...
.method public allocateExternalStageCidLegacy()Ljava/lang/String;
    ...
    iget-object v2, p0, mLegacySessions:Landroid/util/SparseBooleanArray;
...
.method public allocateStageDirLegacy(Ljava/lang/String;Z)Ljava/io/File;
    ...
    invoke-direct {p0, v1, p1}, buildTmpSessionDir(ILjava/lang/String;)Ljava/io/File;
...
.method dump(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    iget-object v3, p0, mHistoricalSessions:Ljava/util/List;
...
.method public getAllSessions(I)Landroid/content/pm/ParceledListSlice;
    ...
    iget-object v0, p0, mPermissionManager:Lcom/android/server/pm/permission/PermissionManagerServiceInternal;
...
.method public registerCallback(Landroid/content/pm/IPackageInstallerCallback;I)V
    ...
    invoke-virtual {p0, p1, v0}, registerCallback(Landroid/content/pm/IPackageInstallerCallback;Ljava/util/function/IntPredicate;)V
...
.method restoreAndApplyStagedSessionIfNeeded()V
    ...
    iget-object v3, p0, mStagingManager:Lcom/android/server/pm/StagingManager;
    ...
    iput-boolean v1, p0, mOkToSendBroadcasts:Z
...
.method public systemReady()V
    ...
    invoke-direct {p0, v1}, reconcileStagesLocked(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v4}, buildAppIconFile(I)Ljava/io/File;
...
.method public uninstall(Landroid/content/pm/VersionedPackage;Ljava/lang/String;ILandroid/content/IntentSender;I)V
    ...
    iget-object v5, v1, mPermissionManager:Lcom/android/server/pm/permission/PermissionManagerServiceInternal;
    ...
    :cond_3
    iget-object v6, v1, mPm:Lcom/android/server/pm/PackageManagerService;
...
.method public updateSessionAppIcon(ILandroid/graphics/Bitmap;)V
    ...
    iget-object v2, p0, mInternalCallback:Lcom/android/server/pm/PackageInstallerService$InternalCallback;
