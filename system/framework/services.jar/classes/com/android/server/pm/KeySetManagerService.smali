...
.method private addKeySetLPw(Landroid/util/ArraySet;)Lcom/android/server/pm/KeySetHandle;
    ...
    invoke-direct {p0, v3}, addPublicKeyLPw(Ljava/security/PublicKey;)J
    ...
    invoke-direct {p0, v5, v6}, decrementPublicKeyLPw(J)V
...
.method private addPublicKeyLPw(Ljava/security/PublicKey;)J
    ...
    iget-object v2, p0, mPublicKeys:Landroid/util/LongSparseArray;
...
.method private addRefCountsFromSavedPackagesLPw(Landroid/util/ArrayMap;)V
    ...
    iget-object v3, p0, mKeySets:Landroid/util/LongSparseArray;
    ...
    iget-object v5, p0, mKeySets:Landroid/util/LongSparseArray;
    ...
    iget-object v8, p0, mPublicKeys:Landroid/util/LongSparseArray;
    ...
    invoke-direct {p0, v5, v6}, decrementKeySetLPw(J)V
...
.method private decrementKeySetLPw(J)V
    ...
    iget-object v1, p0, mKeySetMapping:Landroid/util/LongSparseArray;
    ...
    iget-object v3, p0, mKeySetMapping:Landroid/util/LongSparseArray;
...
.method private decrementPublicKeyLPw(J)V
    ...
    iget-object v0, p0, mPublicKeys:Landroid/util/LongSparseArray;
...
.method addDefinedKeySetsToPackageLPw(Lcom/android/server/pm/PackageSetting;Landroid/util/ArrayMap;)V
    ...
    invoke-direct {p0, v5}, addKeySetLPw(Landroid/util/ArraySet;)Lcom/android/server/pm/KeySetHandle;
...
.method addSigningKeySetToPackageLPw(Lcom/android/server/pm/PackageSetting;Landroid/util/ArraySet;)V
    ...
    invoke-virtual {p0, v0, v1}, getPublicKeysFromKeySetLPr(J)Landroid/util/ArraySet;
    ...
    :cond_0
    invoke-direct {p0, v0, v1}, decrementKeySetLPw(J)V
...
.method public checkUpgradeKeySetLocked(Lcom/android/server/pm/PackageSettingBase;Landroid/content/pm/PackageParser$Package;)Z
    ...
    invoke-virtual {p0, v2, v3}, getPublicKeysFromKeySetLPr(J)Landroid/util/ArraySet;
...
.method public dumpLPr(Ljava/io/PrintWriter;Ljava/lang/String;Lcom/android/server/pm/DumpState;)V
    ...
    iget-object v4, v3, mPackages:Landroid/util/ArrayMap;
...
.method public getPublicKeysFromKeySetLPr(J)Landroid/util/ArraySet;
    ...
    iget-object v0, p0, mKeySetMapping:Landroid/util/LongSparseArray;
...
.method readPublicKeyLPw(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    iget-object v3, p0, mPublicKeys:Landroid/util/LongSparseArray;
...
.method public removeAppKeySetDataLPw(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v1, v2}, decrementKeySetLPw(J)V
    ...
    :cond_0
    invoke-direct {p0, v0}, clearPackageKeySetDataLPw(Lcom/android/server/pm/PackageSetting;)V
...
.method public shouldCheckUpgradeKeySetLocked(Lcom/android/server/pm/PackageSettingBase;I)Z
    ...
    invoke-virtual {p0, v3, v4}, isIdValidKeySetId(J)Z
...
.method writeKeySetManagerServiceLPr(Lorg/xmlpull/v1/XmlSerializer;)V
    ...
    iget-wide v3, p0, lastIssuedKeyId:J
    ...
    iget-wide v5, p0, lastIssuedKeySetId:J
...
.method writePublicKeysLPr(Lorg/xmlpull/v1/XmlSerializer;)V
    ...
    invoke-virtual {p0, v6}, encodePublicKey(Ljava/security/PublicKey;)Ljava/lang/String;
