...
.method constructor <init>(Lcom/android/server/pm/PackageManagerService$OriginInfo;Lcom/android/server/pm/PackageManagerService$MoveInfo;Landroid/content/pm/IPackageInstallObserver2;ILjava/lang/String;Ljava/lang/String;Landroid/os/UserHandle;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/util/List;Ljava/lang/String;ILandroid/content/pm/PackageParser$SigningDetails;ILcom/android/server/pm/PackageManagerService$MultiPackageInstallParams;)V
    ...
    iput-object v1, v0, origin:Lcom/android/server/pm/PackageManagerService$OriginInfo;

    move-object/from16 v2, p2

    iput-object v2, v0, move:Lcom/android/server/pm/PackageManagerService$MoveInfo;

    move/from16 v3, p4

    iput v3, v0, installFlags:I

    move-object/from16 v4, p3

    iput-object v4, v0, observer:Landroid/content/pm/IPackageInstallObserver2;

    move-object/from16 v5, p5

    iput-object v5, v0, installerPackageName:Ljava/lang/String;

    move-object/from16 v6, p6

    iput-object v6, v0, volumeUuid:Ljava/lang/String;

    move-object/from16 v7, p7

    iput-object v7, v0, user:Landroid/os/UserHandle;

    move-object/from16 v8, p8

    iput-object v8, v0, instructionSets:[Ljava/lang/String;

    move-object/from16 v9, p9

    iput-object v9, v0, abiOverride:Ljava/lang/String;

    move-object/from16 v10, p10

    iput-object v10, v0, installGrantPermissions:[Ljava/lang/String;

    move-object/from16 v11, p11

    iput-object v11, v0, whitelistedRestrictedPermissions:Ljava/util/List;

    move-object/from16 v12, p12

    iput-object v12, v0, traceMethod:Ljava/lang/String;

    move/from16 v13, p13

    iput v13, v0, traceCookie:I

    move-object/from16 v14, p14

    iput-object v14, v0, signingDetails:Landroid/content/pm/PackageParser$SigningDetails;

    move/from16 v15, p15

    iput v15, v0, installReason:I

    move-object/from16 v1, p16

    iput-object v1, v0, mMultiPackageInstallParams:Lcom/android/server/pm/PackageManagerService$MultiPackageInstallParams;
