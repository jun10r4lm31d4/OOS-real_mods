...
.method constructor <init>()V
    ...
    iput-object v0, p0, mPackageUseInfoMap:Ljava/util/Map;
...
.method private clonePackageUseInfoMap()Ljava/util/Map;
    ...
    iget-object v1, p0, mPackageUseInfoMap:Ljava/util/Map;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, mPackageUseInfoMap:Ljava/util/Map;
...
.method clear()V
    ...
    iget-object v0, p0, mPackageUseInfoMap:Ljava/util/Map;
...
.method dump()Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, write(Ljava/io/Writer;)V
...
.method maybeWriteAsync()V
    ...
    invoke-virtual {p0, v0}, maybeWriteAsync(Ljava/lang/Object;)Z
...
.method read()V
    ...
    invoke-virtual {p0, v0}, read(Ljava/lang/Object;)V
...
.method read(Ljava/io/Reader;)V
    ...
    invoke-direct {v1, v6}, isSupportedVersion(I)Z
    ...
    invoke-direct {v1, v4, v6}, maybeReadLoadingPackages(Ljava/io/BufferedReader;I)Ljava/util/Set;

    move-result-object v14

    invoke-direct {v1, v4, v6}, maybeReadClassLoaderContext(Ljava/io/BufferedReader;I)Ljava/lang/String;
    ...
    invoke-direct {v1, v11}, readBoolean(Ljava/lang/String;)Z
    ...
    iget-object v3, v1, mPackageUseInfoMap:Ljava/util/Map;

    monitor-enter v3

    :try_start_0
    iget-object v0, v1, mPackageUseInfoMap:Ljava/util/Map;
...
.method protected bridge synthetic readInternal(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, readInternal(Ljava/lang/Void;)V
...
.method protected readInternal(Ljava/lang/Void;)V
    ...
    invoke-virtual {p0}, getFile()Landroid/util/AtomicFile;
    ...
    invoke-virtual {p0, v1}, read(Ljava/io/Reader;)V
    :try_end_0
...
.method record(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;ZZLjava/lang/String;Ljava/lang/String;)Z
    ...
    iget-object v9, v1, mPackageUseInfoMap:Ljava/util/Map;
    ...
    invoke-direct {v1, v2, v7, v12}, maybeAddLoadingPackage(Ljava/lang/String;Ljava/lang/String;Ljava/util/Set;)Z
    ...
    :goto_0
    iget-object v11, v1, mPackageUseInfoMap:Ljava/util/Map;
...
.method removeDexFile(Ljava/lang/String;Ljava/lang/String;I)Z
    ...
    :cond_0
    invoke-direct {p0, v1, p2, p3}, removeDexFile(Lcom/android/server/pm/dex/PackageDexUsage$PackageUseInfo;Ljava/lang/String;I)Z
...
.method removeUserPackage(Ljava/lang/String;I)Z
    ...
    iget-object v4, p0, mPackageUseInfoMap:Ljava/util/Map;
...
.method write(Ljava/io/Writer;)V
    ...
    invoke-direct/range {p0 .. p0}, clonePackageUseInfoMap()Ljava/util/Map;
    ...
    invoke-direct {v0, v3}, writeBoolean(Z)Ljava/lang/String;
...
.method protected bridge synthetic writeInternal(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, writeInternal(Ljava/lang/Void;)V
...
.method protected writeInternal(Ljava/lang/Void;)V
    ...
    invoke-virtual {p0, v2}, write(Ljava/io/Writer;)V
...
.method writeNow()V
    ...
    invoke-virtual {p0, v0}, writeInternal(Ljava/lang/Void;)V
