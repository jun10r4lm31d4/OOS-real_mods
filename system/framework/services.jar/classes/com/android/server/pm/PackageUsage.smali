...
.method private readLine(Ljava/io/InputStream;Ljava/lang/StringBuffer;)Ljava/lang/String;
    ...
    invoke-direct {p0, p1, p2, v0}, readToken(Ljava/io/InputStream;Ljava/lang/StringBuffer;C)Ljava/lang/String;
...
.method private readVersion0LP(Ljava/util/Map;Ljava/io/InputStream;Ljava/lang/StringBuffer;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v4}, parseAsLong(Ljava/lang/String;)J
    ...
    :cond_1
    :goto_2
    invoke-direct {p0, p2, p3}, readLine(Ljava/io/InputStream;Ljava/lang/StringBuffer;)Ljava/lang/String;
...
.method private readVersion1LP(Ljava/util/Map;Ljava/io/InputStream;Ljava/lang/StringBuffer;)V
    ...
    invoke-direct {p0, v6}, parseAsLong(Ljava/lang/String;)J
...
.method protected bridge synthetic readInternal(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, readInternal(Ljava/util/Map;)V
...
.method protected readInternal(Ljava/util/Map;)V
    ...
    invoke-direct {p0, v1, v2}, readLine(Ljava/io/InputStream;Ljava/lang/StringBuffer;)Ljava/lang/String;
    ...
    invoke-direct {p0, p1, v1, v2}, readVersion1LP(Ljava/util/Map;Ljava/io/InputStream;Ljava/lang/StringBuffer;)V

    goto :goto_0

    :cond_1
    invoke-direct {p0, p1, v1, v2, v3}, readVersion0LP(Ljava/util/Map;Ljava/io/InputStream;Ljava/lang/StringBuffer;Ljava/lang/String;)V
    :try_end_0
    ...
    iput-boolean v3, p0, mIsHistoricalPackageUsageAvailable:Z
    :try_end_1
...
.method protected bridge synthetic writeInternal(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, writeInternal(Ljava/util/Map;)V
