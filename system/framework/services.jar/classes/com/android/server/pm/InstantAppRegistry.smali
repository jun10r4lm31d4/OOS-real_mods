...
.method public constructor <init>(Lcom/android/server/pm/PackageManagerService;)V
    ...
    iput-object v0, p0, mCookiePersistence:Lcom/android/server/pm/InstantAppRegistry$CookiePersistence;
...
.method static synthetic access$000(Ljava/lang/String;Ljava/lang/String;I)Ljava/io/File;
    ...
    invoke-static {p0, p1, p2}, computeInstantCookieFile(Ljava/lang/String;Ljava/lang/String;I)Ljava/io/File;
...
.method static synthetic access$100(Ljava/lang/String;I)Ljava/io/File;
    ...
    invoke-static {p0, p1}, peekInstantCookieFile(Ljava/lang/String;I)Ljava/io/File;
...
.method static synthetic access$200(Lcom/android/server/pm/InstantAppRegistry;[BLjava/lang/String;Ljava/io/File;I)V
    ...
    invoke-direct {p0, p1, p2, p3, p4}, persistInstantApplicationCookie([BLjava/lang/String;Ljava/io/File;I)V
...
.method private addUninstalledInstantAppLPw(Landroid/content/pm/PackageParser$Package;I)V
    ...
    invoke-direct {p0, p1, p2, v0}, createInstantAppInfoForPackage(Landroid/content/pm/PackageParser$Package;IZ)Landroid/content/pm/InstantAppInfo;
    ...
    :cond_0
    iget-object v1, p0, mUninstalledInstantApps:Landroid/util/SparseArray;
    ...
    iput-object v1, p0, mUninstalledInstantApps:Landroid/util/SparseArray;
    ...
    iget-object v2, p0, mUninstalledInstantApps:Landroid/util/SparseArray;
    ...
    invoke-direct {p0, v0, p2}, writeUninstalledInstantAppMetadata(Landroid/content/pm/InstantAppInfo;I)V

    invoke-direct {p0, p1, p2}, writeInstantApplicationIconLPw(Landroid/content/pm/PackageParser$Package;I)V
...
.method private static computeInstantCookieFile(Ljava/lang/String;Ljava/lang/String;I)Ljava/io/File;
    ...
    invoke-static {p0, p2}, getInstantApplicationDir(Ljava/lang/String;I)Ljava/io/File;
...
.method private static deleteDir(Ljava/io/File;)V
    ...
    invoke-static {v3}, deleteDir(Ljava/io/File;)V
...
.method private generateInstantAppAndroidIdLPw(Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-static {p1, p2}, getInstantApplicationDir(Ljava/lang/String;I)Ljava/io/File;
...
.method private getInstalledInstantApplicationsLPr(I)Ljava/util/List;
    ...
    invoke-direct {p0, v3, p1, v5}, createInstantAppInfoForPackage(Landroid/content/pm/PackageParser$Package;IZ)Landroid/content/pm/InstantAppInfo;
...
.method private static getInstantApplicationDir(Ljava/lang/String;I)Ljava/io/File;
    ...
    invoke-static {p1}, getInstantApplicationsDir(I)Ljava/io/File;
...
.method private getUninstalledInstantAppStatesLPr(I)Ljava/util/List;
    ...
    invoke-static {v6}, parseMetadataFile(Ljava/io/File;)Lcom/android/server/pm/InstantAppRegistry$UninstalledInstantAppState;
    ...
    iput-object v2, p0, mUninstalledInstantApps:Landroid/util/SparseArray;
...
.method private getUninstalledInstantApplicationsLPr(I)Ljava/util/List;
    ...
    invoke-direct {p0, p1}, getUninstalledInstantAppStatesLPr(I)Ljava/util/List;
...
.method private hasInstantAppMetadataLPr(Ljava/lang/String;I)Z
    ...
    invoke-static {p1, p2}, peekInstantCookieFile(Ljava/lang/String;I)Ljava/io/File;
...
.method private hasUninstalledInstantAppStateLPr(Ljava/lang/String;I)Z
    ...
    iget-object v0, p0, mUninstalledInstantApps:Landroid/util/SparseArray;
...
.method private static parseMetadata(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Landroid/content/pm/InstantAppInfo;
    ...
    invoke-static {p0, p1}, parsePackage(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Landroid/content/pm/InstantAppInfo;
...
.method private static parseMetadataFile(Ljava/io/File;)Lcom/android/server/pm/InstantAppRegistry$UninstalledInstantAppState;
    ...
    invoke-static {v5, v4}, parseMetadata(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Landroid/content/pm/InstantAppInfo;
...
.method private static parsePackage(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Landroid/content/pm/InstantAppInfo;
    ...
    invoke-static {p0, v1, v2}, parsePermissions(Lorg/xmlpull/v1/XmlPullParser;Ljava/util/List;Ljava/util/List;)V
...
.method private static peekInstantCookieFile(Ljava/lang/String;I)Ljava/io/File;
    ...
    invoke-static {p0, p1}, getInstantApplicationDir(Ljava/lang/String;I)Ljava/io/File;
...
.method private peekOrParseUninstalledInstantAppInfo(Ljava/lang/String;I)Landroid/content/pm/InstantAppInfo;
    ...
    invoke-static {v0}, parseMetadataFile(Ljava/io/File;)Lcom/android/server/pm/InstantAppRegistry$UninstalledInstantAppState;
...
.method private persistInstantApplicationCookie([BLjava/lang/String;Ljava/io/File;I)V
    ...
    :try_start_0
    invoke-static {p2, p4}, getInstantApplicationDir(Ljava/lang/String;I)Ljava/io/File;
...
.method private propagateInstantAppPermissionsIfNeeded(Landroid/content/pm/PackageParser$Package;I)V
    ...
    invoke-direct {p0, v0, p2}, peekOrParseUninstalledInstantAppInfo(Ljava/lang/String;I)Landroid/content/pm/InstantAppInfo;
...
.method private pruneInstantApps(JJJ)Z
    ...
    iget-object v0, v1, mService:Lcom/android/server/pm/PackageManagerService;
    ...
    :try_start_1
    iget-object v14, v1, mService:Lcom/android/server/pm/PackageManagerService;
    ...
    iget-object v12, v1, mService:Lcom/android/server/pm/PackageManagerService;
    ...
    invoke-direct {v1, v14, v13}, removeUninstalledInstantAppStateLPw(Ljava/util/function/Predicate;I)V

    invoke-static {v13}, getInstantApplicationsDir(I)Ljava/io/File;
    ...
    invoke-static {v7}, deleteDir(Ljava/io/File;)V
...
.method private removeAppLPw(II)V
    ...
    iget-object v0, p0, mInstantGrants:Landroid/util/SparseArray;
...
.method private removeInstantAppLPw(II)V
    ...
    iget-object v0, p0, mInstalledInstantAppUids:Landroid/util/SparseArray;
    ...
    iget-object v1, p0, mInstantGrants:Landroid/util/SparseArray;
...
.method private removeUninstalledInstantAppStateLPw(Ljava/util/function/Predicate;I)V
    ...
    iget-object v4, p0, mUninstalledInstantApps:Landroid/util/SparseArray;
    ...
    iput-object v4, p0, mUninstalledInstantApps:Landroid/util/SparseArray;
...
.method private writeInstantApplicationIconLPw(Landroid/content/pm/PackageParser$Package;I)V
    ...
    invoke-static {v0, p2}, getInstantApplicationDir(Ljava/lang/String;I)Ljava/io/File;
    ...
    iget-object v2, p0, mService:Lcom/android/server/pm/PackageManagerService;
    ...
    invoke-static {v4, p2}, getInstantApplicationDir(Ljava/lang/String;I)Ljava/io/File;
...
.method private writeUninstalledInstantAppMetadata(Landroid/content/pm/InstantAppInfo;I)V
    ...
    invoke-static {v3, v4}, getInstantApplicationDir(Ljava/lang/String;I)Ljava/io/File;
    ...
    :try_start_1
    iget-object v13, v12, mService:Lcom/android/server/pm/PackageManagerService;
...
.method public addInstantAppLPw(II)V
    ...
    iput-object v0, p0, mInstalledInstantAppUids:Landroid/util/SparseArray;
    ...
    iget-object v1, p0, mInstalledInstantAppUids:Landroid/util/SparseArray;
...
.method public deleteInstantApplicationMetadataLPw(Ljava/lang/String;I)V
    ...
    invoke-direct {p0, v0, p2}, removeUninstalledInstantAppStateLPw(Ljava/util/function/Predicate;I)V
...
.method public getInstantAppAndroidIdLPw(Ljava/lang/String;I)Ljava/lang/String;
    ...
    :cond_0
    invoke-direct {p0, p1, p2}, generateInstantAppAndroidIdLPw(Ljava/lang/String;I)Ljava/lang/String;
...
.method public getInstantAppCookieLPw(Ljava/lang/String;I)[B
    ...
    :cond_0
    iget-object v2, p0, mCookiePersistence:Lcom/android/server/pm/InstantAppRegistry$CookiePersistence;
...
.method public getInstantAppsLPr(I)Ljava/util/List;
    ...
    invoke-direct {p0, p1}, getInstalledInstantApplicationsLPr(I)Ljava/util/List;

    move-result-object v0

    invoke-direct {p0, p1}, getUninstalledInstantApplicationsLPr(I)Ljava/util/List;
...
.method public grantInstantAccessLPw(ILandroid/content/Intent;II)V
    ...
    iput-object v1, p0, mInstantGrants:Landroid/util/SparseArray;
    ...
    iget-object v2, p0, mInstantGrants:Landroid/util/SparseArray;
...
.method hasInstantApplicationMetadataLPr(Ljava/lang/String;I)Z
    ...
    invoke-direct {p0, p1, p2}, hasUninstalledInstantAppStateLPr(Ljava/lang/String;I)Z

    move-result v0

    if-nez v0, :cond_1

    invoke-direct {p0, p1, p2}, hasInstantAppMetadataLPr(Ljava/lang/String;I)Z
...
.method public onPackageInstalledLPw(Landroid/content/pm/PackageParser$Package;[I)V
    ...
    iget-object v8, v0, mService:Lcom/android/server/pm/PackageManagerService;
    ...
    :cond_1
    invoke-direct {v0, v1, v7}, propagateInstantAppPermissionsIfNeeded(Landroid/content/pm/PackageParser$Package;I)V
    ...
    invoke-virtual {v0, v7, v8}, addInstantAppLPw(II)V
    ...
    invoke-direct {v0, v8, v7}, removeUninstalledInstantAppStateLPw(Ljava/util/function/Predicate;I)V

    iget-object v8, v1, Landroid/content/pm/PackageParser$Package;->packageName:Ljava/lang/String;

    invoke-static {v8, v7}, getInstantApplicationDir(Ljava/lang/String;I)Ljava/io/File;
    ...
    invoke-static {v9, v7}, peekInstantCookieFile(Ljava/lang/String;I)Ljava/io/File;
    ...
    iget-object v13, v0, mCookiePersistence:Lcom/android/server/pm/InstantAppRegistry$CookiePersistence;
...
.method public onPackageUninstalledLPw(Landroid/content/pm/PackageParser$Package;[I)V
    ...
    invoke-direct {p0, p1, v3}, addUninstalledInstantAppLPw(Landroid/content/pm/PackageParser$Package;I)V

    iget v4, v0, Lcom/android/server/pm/PackageSetting;->appId:I

    invoke-direct {p0, v3, v4}, removeInstantAppLPw(II)V
    ...
    invoke-static {v4, v3}, getInstantApplicationDir(Ljava/lang/String;I)Ljava/io/File;

    move-result-object v4

    invoke-static {v4}, deleteDir(Ljava/io/File;)V

    iget-object v4, p0, mCookiePersistence:Lcom/android/server/pm/InstantAppRegistry$CookiePersistence;
    ...
    invoke-direct {p0, v3, v4}, removeAppLPw(II)V
...
.method public onUserRemovedLPw(I)V
    ...
    iput-object v1, p0, mInstalledInstantAppUids:Landroid/util/SparseArray;
    ...
    invoke-static {v0}, deleteDir(Ljava/io/File;)V
...
.method pruneInstalledInstantApps(JJ)Z
    ...
    :try_start_0
    invoke-direct/range {v0 .. v6}, pruneInstantApps(JJJ)Z
...
.method pruneInstantApps()V
    ...
    :try_start_0
    invoke-direct/range {v4 .. v10}, pruneInstantApps(JJJ)Z
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setInstantAppCookieLPw(Ljava/lang/String;[BI)Z
    ...
    :cond_1
    iget-object v0, p0, mCookiePersistence:Lcom/android/server/pm/InstantAppRegistry$CookiePersistence;
