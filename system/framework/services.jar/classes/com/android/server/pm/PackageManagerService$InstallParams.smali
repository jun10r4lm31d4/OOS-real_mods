...
.method constructor <init>(Lcom/android/server/pm/PackageManagerService;Lcom/android/server/pm/PackageManagerService$ActiveInstallSession;)V
    ...
    iput-object v0, p0, verificationInfo:Lcom/android/server/pm/PackageManagerService$VerificationInfo;
    ...
    iput-object v0, p0, origin:Lcom/android/server/pm/PackageManagerService$OriginInfo;

    const/4 v0, 0x0

    iput-object v0, p0, move:Lcom/android/server/pm/PackageManagerService$MoveInfo;
    ...
    iput-object v0, p0, observer:Landroid/content/pm/IPackageInstallObserver2;
    ...
    iput-object v0, p0, packageAbiOverride:Ljava/lang/String;
    ...
    iput-object v0, p0, grantedRuntimePermissions:[Ljava/lang/String;
    ...
    iput-object v0, p0, whitelistedRestrictedPermissions:Ljava/util/List;
    ...
    iput-object v0, p0, signingDetails:Landroid/content/pm/PackageParser$SigningDetails;
    ...
    iput-wide v0, p0, requiredInstalledVersionCode:J
...
.method constructor <init>(Lcom/android/server/pm/PackageManagerService;Lcom/android/server/pm/PackageManagerService$OriginInfo;Lcom/android/server/pm/PackageManagerService$MoveInfo;Landroid/content/pm/IPackageInstallObserver2;ILjava/lang/String;Ljava/lang/String;Lcom/android/server/pm/PackageManagerService$VerificationInfo;Landroid/os/UserHandle;Ljava/lang/String;[Ljava/lang/String;Ljava/util/List;Landroid/content/pm/PackageParser$SigningDetails;IJ)V
    ...
    iput-object v1, v0, this$0:Lcom/android/server/pm/PackageManagerService;
    ...
    iput-object v3, v0, origin:Lcom/android/server/pm/PackageManagerService$OriginInfo;

    move-object/from16 v4, p3

    iput-object v4, v0, move:Lcom/android/server/pm/PackageManagerService$MoveInfo;

    move-object/from16 v5, p4

    iput-object v5, v0, observer:Landroid/content/pm/IPackageInstallObserver2;

    move/from16 v6, p5

    iput v6, v0, installFlags:I

    move-object/from16 v7, p6

    iput-object v7, v0, installerPackageName:Ljava/lang/String;

    move-object/from16 v8, p7

    iput-object v8, v0, volumeUuid:Ljava/lang/String;

    move-object/from16 v9, p8

    iput-object v9, v0, verificationInfo:Lcom/android/server/pm/PackageManagerService$VerificationInfo;

    move-object/from16 v10, p10

    iput-object v10, v0, packageAbiOverride:Ljava/lang/String;

    move-object/from16 v11, p11

    iput-object v11, v0, grantedRuntimePermissions:[Ljava/lang/String;

    move-object/from16 v12, p12

    iput-object v12, v0, whitelistedRestrictedPermissions:Ljava/util/List;

    move-object/from16 v13, p13

    iput-object v13, v0, signingDetails:Landroid/content/pm/PackageParser$SigningDetails;

    move/from16 v14, p14

    iput v14, v0, installReason:I

    move-wide/from16 v1, p15

    iput-wide v1, v0, requiredInstalledVersionCode:J
...
.method private installLocationPolicy(Landroid/content/pm/PackageInfoLite;)I
    ...
    :cond_0
    iget-wide v5, p0, requiredInstalledVersionCode:J
    ...
    iget-wide v8, p0, requiredInstalledVersionCode:J
...
.method handleReturnCode()V
    ...
    iget-boolean v1, p0, mVerificationCompleted:Z

    if-eqz v1, :cond_2

    iget-boolean v1, p0, mEnableRollbackCompleted:Z
    ...
    iget-object v4, p0, origin:Lcom/android/server/pm/PackageManagerService$OriginInfo;
    ...
    :goto_0
    :try_start_1
    iget-object v2, p0, observer:Landroid/content/pm/IPackageInstallObserver2;
...
.method handleRollbackEnabled()V
    ...
    iput-boolean v0, p0, mEnableRollbackCompleted:Z
...
.method public handleStartCopy()V
    ...
    iget-object v0, v1, origin:Lcom/android/server/pm/PackageManagerService$OriginInfo;
    ...
    iget-object v7, v1, this$0:Lcom/android/server/pm/PackageManagerService;

    iget-object v7, v7, Lcom/android/server/pm/PackageManagerService;->mContext:Landroid/content/Context;

    iget-object v8, v1, origin:Lcom/android/server/pm/PackageManagerService$OriginInfo;

    iget-object v8, v8, Lcom/android/server/pm/PackageManagerService$OriginInfo;->resolvedPath:Ljava/lang/String;

    iget v9, v1, installFlags:I

    iget-object v10, v1, packageAbiOverride:Ljava/lang/String;
    ...
    iget-object v0, v1, this$0:Lcom/android/server/pm/PackageManagerService;
    ...
    iget-object v13, v1, packageAbiOverride:Ljava/lang/String;
    ...
    iget-object v15, v1, origin:Lcom/android/server/pm/PackageManagerService$OriginInfo;

    iget-object v15, v15, Lcom/android/server/pm/PackageManagerService$OriginInfo;->resolvedPath:Ljava/lang/String;

    iget v3, v1, installFlags:I

    iget-object v4, v1, packageAbiOverride:Ljava/lang/String;
    ...
    :cond_c
    invoke-direct {v1, v7}, installLocationPolicy(Landroid/content/pm/PackageInfoLite;)I
    ...
    iput-boolean v4, v1, mVerificationCompleted:Z

    iput-boolean v4, v1, mEnableRollbackCompleted:Z

    iput-object v3, v1, mArgs:Lcom/android/server/pm/PackageManagerService$InstallArgs;
    ...
    iget-object v0, v1, verificationInfo:Lcom/android/server/pm/PackageManagerService$VerificationInfo;
    ...
    iget-object v9, v1, origin:Lcom/android/server/pm/PackageManagerService$OriginInfo;
    ...
    iget-object v8, v1, this$0:Lcom/android/server/pm/PackageManagerService;
    ...
    :cond_1a
    iget-object v9, v1, this$0:Lcom/android/server/pm/PackageManagerService;
    ...
    iget-object v15, v1, installerPackageName:Ljava/lang/String;
    ...
    iget-object v13, v1, verificationInfo:Lcom/android/server/pm/PackageManagerService$VerificationInfo;
    ...
    iget-object v14, v1, this$0:Lcom/android/server/pm/PackageManagerService;
    ...
    iget-object v15, v1, this$0:Lcom/android/server/pm/PackageManagerService;
    ...
    iget-object v2, v1, this$0:Lcom/android/server/pm/PackageManagerService;
    ...
    iget-object v5, v1, this$0:Lcom/android/server/pm/PackageManagerService;
    ...
    :goto_c
    iget-object v3, v1, this$0:Lcom/android/server/pm/PackageManagerService;
    ...
    iget-object v6, v1, this$0:Lcom/android/server/pm/PackageManagerService;
    ...
    iget-object v10, v1, this$0:Lcom/android/server/pm/PackageManagerService;
    ...
    iput-boolean v5, v1, mVerificationCompleted:Z
    ...
    invoke-virtual/range {p0 .. p0}, getRollbackUser()Landroid/os/UserHandle;
    ...
    iput-boolean v5, v1, mEnableRollbackCompleted:Z
...
.method handleVerificationFinished()V
    ...
    iput-boolean v0, p0, mVerificationCompleted:Z
