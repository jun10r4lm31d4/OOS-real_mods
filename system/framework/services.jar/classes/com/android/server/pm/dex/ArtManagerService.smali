...
.method static constructor <clinit>()V
    ...
    invoke-static {}, verifyTronLoggingConstants()V
...
.method public constructor <init>(Landroid/content/Context;Landroid/content/pm/IPackageManager;Lcom/android/server/pm/Installer;Ljava/lang/Object;)V
    ...
    iput-object p3, p0, mInstaller:Lcom/android/server/pm/Installer;

    iput-object p4, p0, mInstallLock:Ljava/lang/Object;
...
.method static synthetic access$100(Ljava/lang/String;)I
    ...
    invoke-static {p0}, getCompilationFilterTronValue(Ljava/lang/String;)I
...
.method static synthetic access$200(Ljava/lang/String;)I
    ...
    invoke-static {p0}, getCompilationReasonTronValue(Ljava/lang/String;)I
...
.method private createProfileSnapshot(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILandroid/content/pm/dex/ISnapshotRuntimeProfileCallback;)V
    ...
    :try_start_0
    iget-object v2, p0, mInstaller:Lcom/android/server/pm/Installer;
    ...
    invoke-direct {p0, p5, p1, v1}, postError(Landroid/content/pm/dex/ISnapshotRuntimeProfileCallback;Ljava/lang/String;I)V
    :try_end_0
    ...
    :cond_1
    invoke-direct {p0, p1, v2, p5}, postSuccess(Ljava/lang/String;Landroid/os/ParcelFileDescriptor;Landroid/content/pm/dex/ISnapshotRuntimeProfileCallback;)V
...
.method private snapshotAppProfile(Ljava/lang/String;Ljava/lang/String;Landroid/content/pm/dex/ISnapshotRuntimeProfileCallback;)V
    ...
    invoke-direct {p0, p3, p1, v1}, postError(Landroid/content/pm/dex/ISnapshotRuntimeProfileCallback;Ljava/lang/String;I)V
    ...
    invoke-direct {p0, p3, p1, v4}, postError(Landroid/content/pm/dex/ISnapshotRuntimeProfileCallback;Ljava/lang/String;I)V
    ...
    invoke-direct {p0, p3, p1, v5}, postError(Landroid/content/pm/dex/ISnapshotRuntimeProfileCallback;Ljava/lang/String;I)V
    ...
    invoke-direct/range {v5 .. v10}, createProfileSnapshot(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILandroid/content/pm/dex/ISnapshotRuntimeProfileCallback;)V

    invoke-static {v2}, Landroid/content/pm/dex/ArtManager;->getProfileName(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v5

    invoke-direct {p0, p1, v5}, destroyProfileSnapshot(Ljava/lang/String;Ljava/lang/String;)V
...
.method private snapshotBootImageProfile(Landroid/content/pm/dex/ISnapshotRuntimeProfileCallback;)V
    ...
    invoke-direct/range {v2 .. v7}, createProfileSnapshot(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILandroid/content/pm/dex/ISnapshotRuntimeProfileCallback;)V

    const-string v1, "android"

    const-string v2, "android.prof"

    invoke-direct {p0, v1, v2}, destroyProfileSnapshot(Ljava/lang/String;Ljava/lang/String;)V
...
.method private static verifyTronLoggingConstants()V
    ...
    invoke-static {v1}, getCompilationReasonTronValue(Ljava/lang/String;)I
...
.method public clearAppProfiles(Landroid/content/pm/PackageParser$Package;)V
    ...
    :try_start_0
    invoke-direct {p0, p1}, getPackageProfileNames(Landroid/content/pm/PackageParser$Package;)Landroid/util/ArrayMap;
...
.method public compileLayouts(Landroid/content/pm/PackageParser$Package;)Z
    ...
    :try_start_2
    iget-object v8, p0, mInstaller:Lcom/android/server/pm/Installer;
...
.method public dumpProfiles(Landroid/content/pm/PackageParser$Package;)V
    ...
    :try_start_1
    iget-object v6, p0, mInstaller:Lcom/android/server/pm/Installer;
...
.method public isRuntimeProfilingEnabled(ILjava/lang/String;)Z
    ...
    invoke-direct {p0, v0, p2}, checkAndroidPermissions(ILjava/lang/String;)Z
...
.method public prepareAppProfiles(Landroid/content/pm/PackageParser$Package;IZ)V
    ...
    :cond_1
    :try_start_0
    invoke-direct/range {p0 .. p1}, getPackageProfileNames(Landroid/content/pm/PackageParser$Package;)Landroid/util/ArrayMap;
    ...
    :goto_2
    iget-object v9, v1, mInstaller:Lcom/android/server/pm/Installer;
...
.method public prepareAppProfiles(Landroid/content/pm/PackageParser$Package;[IZ)V
    ...
    invoke-virtual {p0, p1, v1, p3}, prepareAppProfiles(Landroid/content/pm/PackageParser$Package;IZ)V
...
.method public snapshotRuntimeProfile(ILjava/lang/String;Ljava/lang/String;Landroid/content/pm/dex/ISnapshotRuntimeProfileCallback;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2, v0}, checkShellPermissions(ILjava/lang/String;I)Z

    move-result v1

    if-nez v1, :cond_0

    invoke-direct {p0, v0, p5}, checkAndroidPermissions(ILjava/lang/String;)Z
    ...
    :cond_2
    invoke-virtual {p0, p1, p5}, isRuntimeProfilingEnabled(ILjava/lang/String;)Z
    ...
    invoke-direct {p0, p4}, snapshotBootImageProfile(Landroid/content/pm/dex/ISnapshotRuntimeProfileCallback;)V

    goto :goto_2

    :cond_4
    invoke-direct {p0, p2, p3, p4}, snapshotAppProfile(Ljava/lang/String;Ljava/lang/String;Landroid/content/pm/dex/ISnapshotRuntimeProfileCallback;)V
