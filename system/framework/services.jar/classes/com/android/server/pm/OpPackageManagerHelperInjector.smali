...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, mAdbConnected:Z

    sput-boolean v0, mCtsPackageInstalled:Z
    ...
    sput-object v1, CTSPACKAGE_SIGNATURES:[Landroid/content/pm/Signature;
    ...
    sput-object v0, WHITELISTED_USER_NAMES_FOR_UNINSTALL_SILENTLY:Ljava/util/Set;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, ORDINARY_APP_FOR_SIG_PERMS_MATCH_EXACTLY:Ljava/util/Map;
    ...
    sget-object v2, ORDINARY_APP_FOR_SIG_PERMS_MATCH_EXACTLY:Ljava/util/Map;
    ...
    sget-object v4, ORDINARY_APP_FOR_SIG_PERMS_MATCH_EXACTLY:Ljava/util/Map;
    ...
    sput-object v0, ORDINARY_APP_FOR_SIG_PERMS_MATCH_PARTIALLY:Ljava/util/Map;
    ...
    sget-object v2, ORDINARY_APP_FOR_SIG_PERMS_MATCH_PARTIALLY:Ljava/util/Map;
...
.method public static allowMarketToUninstallAppsSilently(Ljava/lang/String;)Z
    ...
    sget-object v3, WHITELISTED_USER_NAMES_FOR_UNINSTALL_SILENTLY:Ljava/util/Set;
...
.method public static allowOrdinaryAppGrantingSigPerms(Landroid/content/pm/PackageParser$Package;Ljava/lang/String;)Z
    ...
    :cond_0
    sget-object v1, ORDINARY_APP_FOR_SIG_PERMS_MATCH_EXACTLY:Ljava/util/Map;
    ...
    :cond_1
    sget-object v3, ORDINARY_APP_FOR_SIG_PERMS_MATCH_PARTIALLY:Ljava/util/Map;
...
.method public static getCtsPackageInstalled()Z
    ...
    sget-boolean v0, mCtsPackageInstalled:Z
...
.method public static isInSpecialTesting()Z
    ...
    sget-boolean v0, mAdbConnected:Z
...
.method public static isTrustedSystemSignature([Landroid/content/pm/Signature;)Z
    ...
    sget-object v0, sIOpPackageManagerHelper:Lcom/android/server/pm/IOpPackageManagerHelper;
...
.method private static makeSureInstanceInitialized()V
    ...
    sput-object v0, sIOpPackageManagerHelper:Lcom/android/server/pm/IOpPackageManagerHelper;
...
.method public static maybeChangePackageFlags(Landroid/content/pm/PackageInfo;)V
    ...
    invoke-static {}, isInSpecialTesting()Z
...
.method public static setAdbState(Z)V
    ...
    sput-boolean p0, mAdbConnected:Z
...
.method public static setCtsPackageInstalled(Ljava/lang/String;[Landroid/content/pm/Signature;Z)V
    ...
    sget-object v0, CTSPACKAGE_SIGNATURES:[Landroid/content/pm/Signature;

    invoke-static {p1, v0}, compareSignatures([Landroid/content/pm/Signature;[Landroid/content/pm/Signature;)I
...
.method public static showFMUninstallAlertDialog(Landroid/content/Context;)V
    ...
    sget-object v0, sAlertDialog:Landroid/app/AlertDialog;
    ...
    sput-object v0, sAlertDialog:Landroid/app/AlertDialog;
