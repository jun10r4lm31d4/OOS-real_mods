...
.method static constructor <clinit>()V
    ...
    sput-object v0, sSystemAppList:Ljava/util/ArrayList;
    ...
    sput-object v0, mOemPkgList:Ljava/util/List;
    ...
    sput-object v0, ACTION_LIST:Ljava/util/List;
    ...
    sput-object v0, RESTRICTED_PACKAGES_FOR_CTA_NETWORK:Ljava/util/List;
...
.method static synthetic access$000()Ljava/util/List;
    ...
    sget-object v0, RESTRICTED_PACKAGES_FOR_CTA_NETWORK:Ljava/util/List;
...
.method public static checkOemDeviceIdleWhitelist(Ljava/lang/String;)V
    ...
    invoke-static {p0}, isOemDeviceIdleWhitelist(Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p0}, addDozeWhitelist(Ljava/lang/String;)V
...
.method public static copyPackageThemes(Ljava/lang/String;Lcom/android/internal/os/IParcelFileDescriptorFactory;)I
    ...
    invoke-static {v0, p1}, copyPackageThemesInner(Landroid/content/pm/PackageParser$PackageLite;Lcom/android/internal/os/IParcelFileDescriptorFactory;)I
...
.method public static doCopyApkTheme(Lcom/android/server/pm/PackageManagerService$OriginInfo;I)I
    ...
    invoke-static {v1, v0}, copyPackageThemes(Ljava/lang/String;Lcom/android/internal/os/IParcelFileDescriptorFactory;)I
...
.method public static doSendOemBroadcast(Landroid/content/Intent;Landroid/app/IActivityManager;Landroid/content/IIntentReceiver;[Ljava/lang/String;IZ)V
    ...
    sget-boolean v0, sActivityManagerReady:Z
    ...
    :goto_0
    sget-object v0, mOemPkgList:Ljava/util/List;
...
.method public static filterIfParallel(ILjava/util/List;Landroid/content/Intent;Ljava/lang/String;ILcom/android/server/pm/ComponentResolver;Landroid/content/pm/PackageParser$Package;Lcom/android/server/pm/PackageManagerService;)Ljava/util/List;
    ...
    sget-object v0, ACTION_LIST:Ljava/util/List;
...
.method public static informActivityManagerReady()V
    ...
    sput-boolean v0, sActivityManagerReady:Z
...
.method private static isInSystemAppList(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    sget-object v0, sSystemAppList:Ljava/util/ArrayList;
...
.method public static isPkgNeedToBeHandleThemeAndOpSdk(Landroid/content/Context;Lcom/android/server/pm/PackageManagerService$OriginInfo;)Z
    ...
    invoke-static {p0, v2}, isInSystemAppList(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static maybeReplaceResultsWithParallelResults(Ljava/util/List;Landroid/content/Intent;Ljava/lang/String;IILcom/android/server/pm/ComponentResolver;Lcom/android/server/pm/PackageManagerService;)Ljava/util/List;
    ...
    sget-object v1, ACTION_LIST:Ljava/util/List;
...
.method public static purgeInstalledThemeApks(Landroid/content/Context;Ljava/lang/String;Lcom/android/server/pm/PackageManagerService;)V
    ...
    invoke-static {p0, p1}, isInSystemAppList(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static setUnifyAppStateForNewUser(Landroid/content/Context;Lcom/android/server/pm/PackageManagerService;Lcom/android/server/pm/UserManagerService;Lcom/android/server/pm/Settings;Landroid/util/ArrayMap;I)V
    ...
    invoke-static/range {v0 .. v6}, setAppsState(Lcom/android/server/pm/PackageManagerService;Lcom/android/server/pm/Settings;Lcom/android/server/pm/UserManagerService;Landroid/util/ArrayMap;Landroid/util/ArraySet;II)V
    ...
    invoke-static/range {v7 .. v13}, setAppsState(Lcom/android/server/pm/PackageManagerService;Lcom/android/server/pm/Settings;Lcom/android/server/pm/UserManagerService;Landroid/util/ArrayMap;Landroid/util/ArraySet;II)V
    ...
    invoke-static/range {v14 .. v20}, setAppsState(Lcom/android/server/pm/PackageManagerService;Lcom/android/server/pm/Settings;Lcom/android/server/pm/UserManagerService;Landroid/util/ArrayMap;Landroid/util/ArraySet;II)V
    ...
    invoke-static/range {v22 .. v28}, setAppsState(Lcom/android/server/pm/PackageManagerService;Lcom/android/server/pm/Settings;Lcom/android/server/pm/UserManagerService;Landroid/util/ArrayMap;Landroid/util/ArraySet;II)V
    ...
    invoke-static/range {v28 .. v34}, setAppsState(Lcom/android/server/pm/PackageManagerService;Lcom/android/server/pm/Settings;Lcom/android/server/pm/UserManagerService;Landroid/util/ArrayMap;Landroid/util/ArraySet;II)V
...
.method public static setUnifyAppsState(Landroid/content/Context;Lcom/android/server/pm/PackageManagerService;Lcom/android/server/pm/UserManagerService;Lcom/android/server/pm/Settings;Landroid/util/ArrayMap;Z)V
    ...
    invoke-static/range {v19 .. v25}, setAppsState(Lcom/android/server/pm/PackageManagerService;Lcom/android/server/pm/Settings;Lcom/android/server/pm/UserManagerService;Landroid/util/ArrayMap;Landroid/util/ArraySet;II)V
    ...
    invoke-static/range {v26 .. v32}, setAppsState(Lcom/android/server/pm/PackageManagerService;Lcom/android/server/pm/Settings;Lcom/android/server/pm/UserManagerService;Landroid/util/ArrayMap;Landroid/util/ArraySet;II)V
