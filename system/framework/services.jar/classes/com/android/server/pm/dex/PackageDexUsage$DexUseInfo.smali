...
.method private constructor <init>(Lcom/android/server/pm/dex/PackageDexUsage$DexUseInfo;)V
    ...
    iget-boolean v0, p1, mIsUsedByOtherApps:Z

    iput-boolean v0, p0, mIsUsedByOtherApps:Z

    iget v0, p1, mOwnerUserId:I

    iput v0, p0, mOwnerUserId:I

    iget-object v0, p1, mClassLoaderContext:Ljava/lang/String;

    iput-object v0, p0, mClassLoaderContext:Ljava/lang/String;

    new-instance v0, Ljava/util/HashSet;

    iget-object v1, p1, mLoaderIsas:Ljava/util/Set;

    invoke-direct {v0, v1}, Ljava/util/HashSet;-><init>(Ljava/util/Collection;)V

    iput-object v0, p0, mLoaderIsas:Ljava/util/Set;

    new-instance v0, Ljava/util/HashSet;

    iget-object v1, p1, mLoadingPackages:Ljava/util/Set;

    invoke-direct {v0, v1}, Ljava/util/HashSet;-><init>(Ljava/util/Collection;)V

    iput-object v0, p0, mLoadingPackages:Ljava/util/Set;
...
.method synthetic constructor <init>(Lcom/android/server/pm/dex/PackageDexUsage$DexUseInfo;Lcom/android/server/pm/dex/PackageDexUsage$1;)V
    ...
    invoke-direct {p0, p1}, <init>(Lcom/android/server/pm/dex/PackageDexUsage$DexUseInfo;)V
...
.method constructor <init>(ZILjava/lang/String;Ljava/lang/String;)V
    ...
    iput-boolean p1, p0, mIsUsedByOtherApps:Z

    iput p2, p0, mOwnerUserId:I

    iput-object p3, p0, mClassLoaderContext:Ljava/lang/String;
    ...
    iget-object v0, p0, mLoaderIsas:Ljava/util/Set;
...
.method static synthetic access$200(Lcom/android/server/pm/dex/PackageDexUsage$DexUseInfo;)Ljava/util/Set;
    ...
    iget-object v0, p0, mLoadingPackages:Ljava/util/Set;
...
.method static synthetic access$400(Lcom/android/server/pm/dex/PackageDexUsage$DexUseInfo;Lcom/android/server/pm/dex/PackageDexUsage$DexUseInfo;)Z
    ...
    invoke-direct {p0, p1}, merge(Lcom/android/server/pm/dex/PackageDexUsage$DexUseInfo;)Z
...
.method static synthetic access$600(Lcom/android/server/pm/dex/PackageDexUsage$DexUseInfo;)Z
    ...
    iget-boolean v0, p0, mIsUsedByOtherApps:Z
...
.method private merge(Lcom/android/server/pm/dex/PackageDexUsage$DexUseInfo;)Z
    ...
    iget-boolean v1, p0, mIsUsedByOtherApps:Z
    ...
    iget-boolean v1, p1, mIsUsedByOtherApps:Z
    ...
    :goto_1
    iput-boolean v1, p0, mIsUsedByOtherApps:Z

    iget-object v1, p0, mLoaderIsas:Ljava/util/Set;

    iget-object v4, p1, mLoaderIsas:Ljava/util/Set;

    invoke-interface {v1, v4}, Ljava/util/Set;->addAll(Ljava/util/Collection;)Z

    move-result v1

    iget-object v4, p0, mLoadingPackages:Ljava/util/Set;

    iget-object v5, p1, mLoadingPackages:Ljava/util/Set;

    invoke-interface {v4, v5}, Ljava/util/Set;->addAll(Ljava/util/Collection;)Z

    move-result v4

    iget-object v5, p0, mClassLoaderContext:Ljava/lang/String;

    iget-object v6, p0, mClassLoaderContext:Ljava/lang/String;
    ...
    iget-object v6, p1, mClassLoaderContext:Ljava/lang/String;

    iput-object v6, p0, mClassLoaderContext:Ljava/lang/String;
    ...
    iget-object v7, p1, mClassLoaderContext:Ljava/lang/String;
    ...
    iget-boolean v6, p0, mIsUsedByOtherApps:Z
...
.method public getClassLoaderContext()Ljava/lang/String;
    ...
    iget-object v0, p0, mClassLoaderContext:Ljava/lang/String;
