...
.method constructor <init>(Lcom/android/server/pm/PackageInstallerService;Lcom/android/server/pm/ApexManager;Landroid/content/Context;)V
    ...
    iput-object v0, p0, mStagedSessions:Landroid/util/SparseArray;

    iput-object p1, p0, mPi:Lcom/android/server/pm/PackageInstallerService;

    iput-object p2, p0, mApexManager:Lcom/android/server/pm/ApexManager;
...
.method private checkStateAndResume(Lcom/android/server/pm/PackageInstallerSession;)V
    ...
    :cond_2
    invoke-direct {p0, p1}, resumeSession(Lcom/android/server/pm/PackageInstallerSession;)V
...
.method private createAndWriteApkSession(Lcom/android/server/pm/PackageInstallerSession;Z)Lcom/android/server/pm/PackageInstallerSession;
    ...
    invoke-direct {v1, v0}, findAPKsInDir(Ljava/io/File;)Ljava/util/List;
    ...
    :goto_0
    iget-object v7, v1, mPi:Lcom/android/server/pm/PackageInstallerService;
    ...
    iget-object v0, v1, mPi:Lcom/android/server/pm/PackageInstallerService;
...
.method private installApksInSession(Lcom/android/server/pm/PackageInstallerSession;Z)Z
    ...
    invoke-static {p1}, isApexSession(Lcom/android/server/pm/PackageInstallerSession;)Z

    move-result v0

    if-nez v0, :cond_1

    invoke-direct {p0, p1, p2}, createAndWriteApkSession(Lcom/android/server/pm/PackageInstallerSession;Z)Lcom/android/server/pm/PackageInstallerSession;
    ...
    invoke-direct {p0, v0, v1, p2}, commitApkSession(Lcom/android/server/pm/PackageInstallerSession;IZ)Z
    ...
    iget-object v0, p0, mStagedSessions:Landroid/util/SparseArray;
    ...
    :cond_3
    iget-object v2, p0, mPi:Lcom/android/server/pm/PackageInstallerService;
    ...
    iget-object v4, p0, mPi:Lcom/android/server/pm/PackageInstallerService;
    ...
    invoke-direct {p0, v6, p2}, createAndWriteApkSession(Lcom/android/server/pm/PackageInstallerSession;Z)Lcom/android/server/pm/PackageInstallerSession;
    ...
    invoke-direct {p0, v4, v1, p2}, commitApkSession(Lcom/android/server/pm/PackageInstallerSession;IZ)Z
...
.method private isMultiPackageSessionComplete(Lcom/android/server/pm/PackageInstallerSession;)Z
    ...
    iget-object v5, p0, mStagedSessions:Landroid/util/SparseArray;
    ...
    :cond_3
    invoke-direct {p0, v0}, isMultiPackageSessionComplete(Lcom/android/server/pm/PackageInstallerSession;)Z
...
.method static synthetic lambda$installApksInSession$9(Lcom/android/server/pm/PackageInstallerSession;)Z
    ...
    invoke-static {p0}, isApexSession(Lcom/android/server/pm/PackageInstallerSession;)Z
...
.method private preRebootVerification(Lcom/android/server/pm/PackageInstallerSession;)V
    ...
    invoke-direct {p0, p1, v2, v1}, submitSessionToApexService(Lcom/android/server/pm/PackageInstallerSession;Ljava/util/List;Landroid/apex/ApexInfoList;)Z
    ...
    :cond_2
    invoke-direct {p0, p1}, sessionContainsApk(Lcom/android/server/pm/PackageInstallerSession;)Z
    ...
    invoke-direct {p0, p1, v3}, installApksInSession(Lcom/android/server/pm/PackageInstallerSession;Z)Z
    ...
    invoke-direct {p0, v7, v8}, validateApexSignature(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1}, sessionContainsApex(Lcom/android/server/pm/PackageInstallerSession;)Z

    move-result v2

    if-eqz v2, :cond_8

    iget-object v2, p0, mApexManager:Lcom/android/server/pm/ApexManager;
...
.method private resumeSession(Lcom/android/server/pm/PackageInstallerSession;)V
    ...
    iget-object v3, p0, mApexManager:Lcom/android/server/pm/ApexManager;
    ...
    :cond_0
    invoke-static {v3}, isApexSessionFailed(Landroid/apex/ApexSessionInfo;)Z
    ...
    iget-object v1, p0, mBgHandler:Landroid/os/Handler;
    ...
    :cond_4
    iget-object v1, p0, mApexManager:Lcom/android/server/pm/ApexManager;
...
.method private sessionContainsApex(Lcom/android/server/pm/PackageInstallerSession;)Z
    ...
    invoke-direct {p0, p1, v0}, sessionContains(Lcom/android/server/pm/PackageInstallerSession;Ljava/util/function/Predicate;)Z
...
.method private submitSessionToApexService(Lcom/android/server/pm/PackageInstallerSession;Ljava/util/List;Landroid/apex/ApexInfoList;)Z
    ...
    iget-object v3, v0, mApexManager:Lcom/android/server/pm/ApexManager;
    ...
    iget-object v10, v0, mApexManager:Lcom/android/server/pm/ApexManager;
    ...
    iget-object v4, v0, mApexManager:Lcom/android/server/pm/ApexManager;
...
.method private updateStoredSession(Lcom/android/server/pm/PackageInstallerSession;)V
    ...
    :try_start_0
    iget-object v1, p0, mStagedSessions:Landroid/util/SparseArray;
    ...
    iget-object v2, p0, mStagedSessions:Landroid/util/SparseArray;
...
.method private validateApexSignature(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    iget-object v5, p0, mApexManager:Lcom/android/server/pm/ApexManager;
...
.method abortCommittedSession(Lcom/android/server/pm/PackageInstallerSession;)V
    ...
    :cond_0
    invoke-virtual {p0, p1}, abortSession(Lcom/android/server/pm/PackageInstallerSession;)V
    ...
    invoke-direct {p0, v2}, isApexSessionFinalized(Landroid/apex/ApexSessionInfo;)Z
...
.method commitSession(Lcom/android/server/pm/PackageInstallerSession;)V
    ...
    invoke-direct {p0, p1}, updateStoredSession(Lcom/android/server/pm/PackageInstallerSession;)V
...
.method getSessions(I)Landroid/content/pm/ParceledListSlice;
    ...
    :goto_0
    :try_start_0
    iget-object v4, p0, mStagedSessions:Landroid/util/SparseArray;
...
.method public synthetic lambda$checkStateAndResume$11$StagingManager(Lcom/android/server/pm/PackageInstallerSession;)V
    ...
    invoke-direct {p0, p1}, preRebootVerification(Lcom/android/server/pm/PackageInstallerSession;)V
...
.method restoreSession(Lcom/android/server/pm/PackageInstallerSession;)V
    ...
    :cond_0
    invoke-direct {p0, p1}, isMultiPackageSessionComplete(Lcom/android/server/pm/PackageInstallerSession;)Z
    ...
    invoke-direct {p0, v0}, checkStateAndResume(Lcom/android/server/pm/PackageInstallerSession;)V
