...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mListeners:Lcom/android/server/pm/LauncherAppsService$LauncherAppsImpl$PackageCallbackList;
    ...
    iput-object v0, p0, mPackageMonitor:Lcom/android/server/pm/LauncherAppsService$LauncherAppsImpl$MyPackageMonitor;
    ...
    iput-object v0, p0, mUserManagerInternal:Landroid/os/UserManagerInternal;
    ...
    iput-object v0, p0, mUsageStatsManagerInternal:Landroid/app/usage/UsageStatsManagerInternal;
    ...
    iput-object v0, p0, mActivityTaskManagerInternal:Lcom/android/server/wm/ActivityTaskManagerInternal;
    ...
    iput-object v0, p0, mShortcutServiceInternal:Landroid/content/pm/ShortcutServiceInternal;

    iget-object v0, p0, mShortcutServiceInternal:Landroid/content/pm/ShortcutServiceInternal;

    iget-object v1, p0, mPackageMonitor:Lcom/android/server/pm/LauncherAppsService$LauncherAppsImpl$MyPackageMonitor;
    ...
    iput-object v0, p0, mLauncherIconWhiteList:Ljava/util/List;
...
.method static synthetic access$300(Lcom/android/server/pm/LauncherAppsService$LauncherAppsImpl;Landroid/os/UserHandle;Landroid/os/UserHandle;Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1, p2, p3}, isEnabledProfileOf(Landroid/os/UserHandle;Landroid/os/UserHandle;Ljava/lang/String;)Z
...
.method private canAccessProfile(ILjava/lang/String;)Z
    ...
    invoke-virtual {p0}, injectCallingUserId()I
...
.method private ensureShortcutPermission(Ljava/lang/String;)V
    ...
    :cond_0
    invoke-virtual {p0, p1}, verifyCallingPackage(Ljava/lang/String;)V
...
.method private getPackageInstallerService()Lcom/android/server/pm/PackageInstallerService;
    ...
    iget-object v0, p0, mPackageInstallerService:Lcom/android/server/pm/PackageInstallerService;
    ...
    iput-object v0, p0, mPackageInstallerService:Lcom/android/server/pm/PackageInstallerService;
...
.method private hasComponentsAndRequestsPermissions(Ljava/lang/String;)Z
    ...
    :cond_1
    invoke-direct {p0, v1}, hasApplicationDeclaredActivities(Landroid/content/pm/PackageParser$Package;)Z
    ...
    :cond_4
    iget-object v4, p0, mLauncherIconWhiteList:Ljava/util/List;
...
.method private isManagedProfileAdmin(Landroid/os/UserHandle;Ljava/lang/String;)Z
    ...
    :cond_0
    iget-object v3, p0, mDpm:Landroid/app/admin/DevicePolicyManager;
...
.method private queryActivitiesForUser(Ljava/lang/String;Landroid/content/Intent;Landroid/os/UserHandle;)Landroid/content/pm/ParceledListSlice;
    ...
    invoke-direct {p0, v0, v1}, canAccessProfile(ILjava/lang/String;)Z
...
.method private shouldShowSyntheticActivity(Landroid/os/UserHandle;Landroid/content/pm/ApplicationInfo;)Z
    ...
    invoke-direct {p0, p1, v1}, isManagedProfileAdmin(Landroid/os/UserHandle;Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v0}, hasComponentsAndRequestsPermissions(Ljava/lang/String;)Z
...
.method public getAllSessions(Ljava/lang/String;)Landroid/content/pm/ParceledListSlice;
    ...
    iget-object v1, p0, mUm:Landroid/os/UserManager;
    ...
    invoke-direct {p0}, getPackageInstallerService()Lcom/android/server/pm/PackageInstallerService;
...
.method public getAppUsageLimit(Ljava/lang/String;Ljava/lang/String;Landroid/os/UserHandle;)Landroid/content/pm/LauncherApps$AppUsageLimit;
    ...
    iget-object v0, p0, mUsageStatsManagerInternal:Landroid/app/usage/UsageStatsManagerInternal;
...
.method public getLauncherActivities(Ljava/lang/String;Ljava/lang/String;Landroid/os/UserHandle;)Landroid/content/pm/ParceledListSlice;
    ...
    invoke-direct {p0, p1, v0, p3}, queryActivitiesForUser(Ljava/lang/String;Landroid/content/Intent;Landroid/os/UserHandle;)Landroid/content/pm/ParceledListSlice;
    ...
    :cond_2
    :try_start_1
    iget-object v4, p0, mDpm:Landroid/app/admin/DevicePolicyManager;
    ...
    invoke-direct {p0, p3, v6}, shouldShowSyntheticActivity(Landroid/os/UserHandle;Landroid/content/pm/ApplicationInfo;)Z

    move-result v7

    if-eqz v7, :cond_5

    invoke-direct {p0, p2, v1, p3}, getHiddenAppActivityInfo(Ljava/lang/String;ILandroid/os/UserHandle;)Landroid/content/pm/ResolveInfo;
    ...
    invoke-direct {p0, p3, v9}, shouldShowSyntheticActivity(Landroid/os/UserHandle;Landroid/content/pm/ApplicationInfo;)Z
    ...
    invoke-direct {p0, v10, v1, p3}, getHiddenAppActivityInfo(Ljava/lang/String;ILandroid/os/UserHandle;)Landroid/content/pm/ResolveInfo;
...
.method public getShortcutConfigActivityIntent(Ljava/lang/String;Landroid/content/ComponentName;Landroid/os/UserHandle;)Landroid/content/IntentSender;
    ...
    invoke-direct {p0, p1}, ensureShortcutPermission(Ljava/lang/String;)V
...
.method public getShortcutIconFd(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)Landroid/os/ParcelFileDescriptor;
    ...
    invoke-direct {p0, p4, v0}, canAccessProfile(ILjava/lang/String;)Z
    ...
    :cond_0
    iget-object v1, p0, mShortcutServiceInternal:Landroid/content/pm/ShortcutServiceInternal;
...
.method public getShortcuts(Ljava/lang/String;JLjava/lang/String;Ljava/util/List;Landroid/content/ComponentName;ILandroid/os/UserHandle;)Landroid/content/pm/ParceledListSlice;
    ...
    invoke-direct/range {p0 .. p1}, ensureShortcutPermission(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v1, v2}, canAccessProfile(ILjava/lang/String;)Z
    ...
    iget-object v1, v0, mShortcutServiceInternal:Landroid/content/pm/ShortcutServiceInternal;
...
.method public synthetic lambda$registerPackageInstallerCallback$0$LauncherAppsService$LauncherAppsImpl(Landroid/os/UserHandle;I)Z
    ...
    invoke-direct {p0, p1, v0, v1}, isEnabledProfileOf(Landroid/os/UserHandle;Landroid/os/UserHandle;Ljava/lang/String;)Z
...
.method public showAppDetailsAsUser(Landroid/app/IApplicationThread;Ljava/lang/String;Landroid/content/ComponentName;Landroid/graphics/Rect;Landroid/os/Bundle;Landroid/os/UserHandle;)V
    ...
    invoke-direct {p0, v0, v2}, canAccessProfile(ILjava/lang/String;)Z
    ...
    iget-object v7, v1, mActivityTaskManagerInternal:Lcom/android/server/wm/ActivityTaskManagerInternal;
...
.method public startActivityAsUser(Landroid/app/IApplicationThread;Ljava/lang/String;Landroid/content/ComponentName;Landroid/graphics/Rect;Landroid/os/Bundle;Landroid/os/UserHandle;)V
    ...
    invoke-direct {v1, v0, v3}, canAccessProfile(ILjava/lang/String;)Z
    ...
    iget-object v5, v1, mActivityTaskManagerInternal:Lcom/android/server/wm/ActivityTaskManagerInternal;
...
.method public startSessionDetailsActivityAsUser(Landroid/app/IApplicationThread;Ljava/lang/String;Landroid/content/pm/PackageInstaller$SessionInfo;Landroid/graphics/Rect;Landroid/os/Bundle;Landroid/os/UserHandle;)V
    ...
    invoke-direct {p0, v6, v0}, canAccessProfile(ILjava/lang/String;)Z
...
.method public startShortcut(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/graphics/Rect;Landroid/os/Bundle;I)Z
    ...
    invoke-direct {p0, v9, v1}, canAccessProfile(ILjava/lang/String;)Z
    ...
    invoke-direct {p0, v1, p2, v4, v9}, startShortcutIntentsAsPublisher([Landroid/content/Intent;Ljava/lang/String;Landroid/os/Bundle;I)Z
