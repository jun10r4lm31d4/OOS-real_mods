...
.method constructor <init>([Ljava/lang/String;ZLandroid/util/DisplayMetrics;Ljava/io/File;Landroid/content/pm/PackageParser$Callback;)V
    ...
    iput-object v0, p0, mQueue:Ljava/util/concurrent/BlockingQueue;
    ...
    iput-object p3, p0, mMetrics:Landroid/util/DisplayMetrics;

    iput-object p4, p0, mCacheDir:Ljava/io/File;

    iput-object p5, p0, mPackageParserCallback:Landroid/content/pm/PackageParser$Callback;
...
.method public synthetic lambda$submit$0$ParallelPackageParser(Ljava/io/File;I)V
    ...
    iget-object v4, p0, mCacheDir:Ljava/io/File;

    invoke-virtual {v1, v4}, Landroid/content/pm/PackageParser;->setCacheDir(Ljava/io/File;)V

    iget-object v4, p0, mPackageParserCallback:Landroid/content/pm/PackageParser$Callback;
    ...
    invoke-virtual {p0, v1, p1, p2}, parsePackage(Landroid/content/pm/PackageParser;Ljava/io/File;I)Landroid/content/pm/PackageParser$Package;
    ...
    :try_start_2
    iget-object v1, p0, mQueue:Ljava/util/concurrent/BlockingQueue;
    ...
    iput-object v2, p0, mInterruptedInThread:Ljava/lang/String;
...
.method public take()Lcom/android/server/pm/ParallelPackageParser$ParseResult;
    ...
    :try_start_0
    iget-object v0, p0, mInterruptedInThread:Ljava/lang/String;

    if-nez v0, :cond_0

    iget-object v0, p0, mQueue:Ljava/util/concurrent/BlockingQueue;
    ...
    iget-object v2, p0, mInterruptedInThread:Ljava/lang/String;
