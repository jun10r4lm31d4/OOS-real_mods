...
.method private constructor <init>(JJLjava/util/ArrayList;Z)V
    ...
    iput-wide v0, p0, mVersionCode:J

    iput-wide v0, p0, mBackupSourceVersionCode:J

    iput-wide p1, p0, mVersionCode:J

    iput-wide p3, p0, mLastUpdateTime:J

    iput-boolean p6, p0, mIsShadow:Z

    iput-object p5, p0, mSigHashes:Ljava/util/ArrayList;

    const/4 v0, 0x0

    iput-boolean v0, p0, mBackupAllowed:Z

    iput-boolean v0, p0, mBackupSourceBackupAllowed:Z
...
.method public static generateForInstalledPackageForTest(Lcom/android/server/pm/ShortcutService;Ljava/lang/String;I)Lcom/android/server/pm/ShortcutPackageInfo;
    ...
    invoke-direct/range {v3 .. v9}, <init>(JJLjava/util/ArrayList;Z)V

    invoke-static {v0}, Lcom/android/server/pm/ShortcutService;->shouldBackupApp(Landroid/content/pm/PackageInfo;)Z

    move-result v4

    iput-boolean v4, v3, mBackupSourceBackupAllowed:Z

    invoke-virtual {v0}, Landroid/content/pm/PackageInfo;->getLongVersionCode()J

    move-result-wide v4

    iput-wide v4, v3, mBackupSourceVersionCode:J
...
.method public static newEmpty()Lcom/android/server/pm/ShortcutPackageInfo;
    ...
    invoke-direct/range {v0 .. v6}, <init>(JJLjava/util/ArrayList;Z)V
...
.method public canRestoreTo(Lcom/android/server/pm/ShortcutService;Landroid/content/pm/PackageInfo;Z)I
    ...
    iget-object v1, p0, mSigHashes:Ljava/util/ArrayList;
    ...
    iget-boolean v1, p0, mBackupSourceBackupAllowed:Z
    ...
    iget-wide v5, p0, mBackupSourceVersionCode:J
    ...
    iget-wide v4, p0, mBackupSourceVersionCode:J
...
.method public dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    iget-boolean v0, p0, mIsShadow:Z
    ...
    iget-wide v0, p0, mVersionCode:J

    invoke-virtual {p1, v0, v1}, Ljava/io/PrintWriter;->print(J)V

    invoke-virtual {p1}, Ljava/io/PrintWriter;->println()V

    iget-boolean v0, p0, mBackupAllowedInitialized:Z
    ...
    iget-boolean v0, p0, mBackupAllowed:Z
    ...
    :cond_1
    iget-wide v0, p0, mBackupSourceVersionCode:J
    ...
    iget-boolean v0, p0, mBackupSourceBackupAllowed:Z
    ...
    iget-wide v0, p0, mLastUpdateTime:J
...
.method public hasSignatures()Z
    ...
    iget-object v0, p0, mSigHashes:Ljava/util/ArrayList;
...
.method public loadFromXml(Lorg/xmlpull/v1/XmlPullParser;Z)V
    ...
    iput-wide v2, v0, mVersionCode:J

    iput-wide v4, v0, mBackupSourceVersionCode:J

    iput-boolean v13, v0, mBackupSourceBackupAllowed:Z

    goto :goto_8

    :cond_a
    iput-wide v4, v0, mVersionCode:J

    iput-wide v11, v0, mBackupSourceVersionCode:J

    iput-boolean v14, v0, mBackupSourceBackupAllowed:Z

    :goto_8
    iput-wide v6, v0, mLastUpdateTime:J

    iput-boolean v10, v0, mIsShadow:Z

    iput-object v15, v0, mSigHashes:Ljava/util/ArrayList;

    const/4 v2, 0x0

    iput-boolean v2, v0, mBackupAllowed:Z

    iput-boolean v2, v0, mBackupAllowedInitialized:Z
...
.method public refreshSignature(Lcom/android/server/pm/ShortcutService;Lcom/android/server/pm/ShortcutPackageItem;)V
    ...
    iput-object v3, p0, mSigHashes:Ljava/util/ArrayList;
...
.method public saveToXml(Lcom/android/server/pm/ShortcutService;Lorg/xmlpull/v1/XmlSerializer;Z)V
    ...
    iget-wide v2, p0, mVersionCode:J
    ...
    iget-boolean v2, p0, mIsShadow:Z
    ...
    iget-boolean v2, p0, mBackupAllowed:Z

    const-string v3, "allow-backup"

    invoke-static {p2, v3, v2}, Lcom/android/server/pm/ShortcutService;->writeAttr(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;Z)V

    iget-boolean v2, p0, mBackupAllowedInitialized:Z

    const-string v3, "allow-backup-initialized"

    invoke-static {p2, v3, v2}, Lcom/android/server/pm/ShortcutService;->writeAttr(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;Z)V

    iget-wide v2, p0, mBackupSourceVersionCode:J

    const-string v4, "bk_src_version"

    invoke-static {p2, v4, v2, v3}, Lcom/android/server/pm/ShortcutService;->writeAttr(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;J)V

    iget-boolean v2, p0, mBackupSourceBackupAllowed:Z
    ...
    :goto_0
    iget-object v3, p0, mSigHashes:Ljava/util/ArrayList;
    ...
    iget-object v5, p0, mSigHashes:Ljava/util/ArrayList;
...
.method public setShadow(Z)V
    ...
    iput-boolean p1, p0, mIsShadow:Z
...
.method public updateFromPackageInfo(Landroid/content/pm/PackageInfo;)V
    ...
    iput-boolean v0, p0, mBackupAllowedInitialized:Z
