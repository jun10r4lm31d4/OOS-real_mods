...
.method static constructor <clinit>()V
    ...
    sput-object v0, BOOT_TIMINGS_TRACE_LOG:Landroid/util/TimingsTraceLog;
...
.method public constructor <init>()V
    ...
    iput-wide v0, p0, mRuntimeStartElapsedTime:J

    invoke-static {}, Landroid/os/SystemClock;->uptimeMillis()J

    move-result-wide v0

    iput-wide v0, p0, mRuntimeStartUptime:J
    ...
    iput-boolean v0, p0, mRuntimeRestart:Z
...
.method static synthetic lambda$startOtherServices$2()V
    ...
    invoke-static {}, startHidlServices()V
...
.method private run()V
    ...
    invoke-static {v4}, traceBeginAndSlog(Ljava/lang/String;)V

    const-string/jumbo v4, "sys.system_server.start_count"

    iget v5, p0, mStartCount:I
    ...
    iget-wide v5, p0, mRuntimeStartElapsedTime:J
    ...
    iget-wide v5, p0, mRuntimeStartUptime:J
    ...
    iget-wide v8, p0, mRuntimeStartUptime:J
    ...
    iget-wide v9, p0, mRuntimeStartElapsedTime:J
    ...
    iget-boolean v3, p0, mRuntimeRestart:Z
    ...
    invoke-static {}, initZygoteChildHeapProfiling()V
    ...
    iget-object v6, p0, mSystemContext:Landroid/content/Context;

    invoke-direct {v3, v6}, Lcom/android/server/SystemServiceManager;-><init>(Landroid/content/Context;)V

    iput-object v3, p0, mSystemServiceManager:Lcom/android/server/SystemServiceManager;

    iget-object v7, p0, mSystemServiceManager:Lcom/android/server/SystemServiceManager;

    iget-boolean v8, p0, mRuntimeRestart:Z

    iget-wide v9, p0, mRuntimeStartElapsedTime:J

    iget-wide v11, p0, mRuntimeStartUptime:J
    ...
    iget-object v6, p0, mSystemServiceManager:Lcom/android/server/SystemServiceManager;
    ...
    invoke-static {v2}, traceBeginAndSlog(Ljava/lang/String;)V
    ...
    iget-boolean v0, p0, mRuntimeRestart:Z

    if-nez v0, :cond_6

    invoke-direct {p0}, isFirstBootOrUpgrade()Z
...
.method private startAttentionService(Landroid/content/Context;)V
    ...
    invoke-static {v0}, traceBeginAndSlog(Ljava/lang/String;)V
...
.method private startBootstrapServices()V
    ...
    invoke-static {v5}, traceBeginAndSlog(Ljava/lang/String;)V
    ...
    iget-object v5, p0, mSystemServiceManager:Lcom/android/server/SystemServiceManager;
    ...
    invoke-static {v6}, traceBeginAndSlog(Ljava/lang/String;)V
    ...
    iput-object v7, p0, mActivityManagerService:Lcom/android/server/am/ActivityManagerService;

    iget-object v7, p0, mActivityManagerService:Lcom/android/server/am/ActivityManagerService;

    iget-object v8, p0, mSystemServiceManager:Lcom/android/server/SystemServiceManager;
    ...
    iput-object v7, p0, mWindowManagerGlobalLock:Lcom/android/server/wm/WindowManagerGlobalLock;

    invoke-static {}, traceEnd()V

    const-string v7, "StartPowerManager"

    invoke-static {v7}, traceBeginAndSlog(Ljava/lang/String;)V
    ...
    iput-object v7, p0, mPowerManagerService:Lcom/android/server/power/PowerManagerService;
    ...
    iget-object v7, p0, mSystemContext:Landroid/content/Context;
    ...
    invoke-static {v8}, traceBeginAndSlog(Ljava/lang/String;)V
    ...
    iput-object v8, p0, mDisplayManagerService:Lcom/android/server/display/DisplayManagerService;
    ...
    iput-boolean v10, p0, mOnlyCore:Z
    ...
    invoke-static {v3}, traceBeginAndSlog(Ljava/lang/String;)V
    ...
    iget v11, p0, mFactoryTestMode:I
    ...
    :goto_1
    iget-boolean v11, p0, mOnlyCore:Z
    ...
    iput-object v3, p0, mPackageManagerService:Lcom/android/server/pm/PackageManagerService;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_2
    ...
    iput-boolean v0, p0, mFirstBoot:Z
    ...
    iget-object v9, p0, mPackageManagerService:Lcom/android/server/pm/PackageManagerService;
    ...
    invoke-direct {p0, v9, v3}, reportWtf(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_2
    ...
    iget-object v0, p0, mDisplayManagerService:Lcom/android/server/display/DisplayManagerService;
    ...
    iput-object v0, p0, mSensorServiceStart:Ljava/util/concurrent/Future;
...
.method private startCoreServices()V
    ...
    iput-object v0, p0, mWebViewUpdateService:Lcom/android/server/webkit/WebViewUpdateService;
...
.method private startOtherServices()V
    ...
    iget-object v15, v5, mSystemContext:Landroid/content/Context;
    ...
    iput-object v0, v5, mZygotePreload:Ljava/util/concurrent/Future;
    ...
    iget-object v0, v5, mSystemServiceManager:Lcom/android/server/SystemServiceManager;
    ...
    iput-object v0, v5, mEntropyMixer:Lcom/android/server/EntropyMixer;
    ...
    iput-object v0, v5, mContentResolver:Landroid/content/ContentResolver;
    ...
    iget-object v0, v5, mActivityManagerService:Lcom/android/server/am/ActivityManagerService;
    ...
    iget-object v0, v5, mSensorServiceStart:Ljava/util/concurrent/Future;
    ...
    iput-object v0, v5, mSensorServiceStart:Ljava/util/concurrent/Future;

    iget-boolean v0, v5, mFirstBoot:Z
    ...
    :goto_2
    iget-boolean v0, v5, mOnlyCore:Z
    ...
    iget-object v6, v5, mActivityManagerService:Lcom/android/server/am/ActivityManagerService;
    ...
    iget-object v0, v5, mDisplayManagerService:Lcom/android/server/display/DisplayManagerService;

    invoke-virtual {v0}, Lcom/android/server/display/DisplayManagerService;->windowManagerAndInputReady()V

    invoke-static {}, traceEnd()V

    iget v0, v5, mFactoryTestMode:I
    ...
    iget-object v0, v5, mSystemContext:Landroid/content/Context;
    ...
    invoke-direct {v5, v13, v0}, reportWtf(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-boolean v7, v5, mOnlyCore:Z

    if-nez v7, :cond_a

    invoke-direct/range {p0 .. p0}, isFirstBootOrUpgrade()Z
    ...
    invoke-direct {v5, v7, v0}, reportWtf(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-object v0, v5, mPackageManagerService:Lcom/android/server/pm/PackageManagerService;
    ...
    invoke-direct {v5, v3, v0}, reportWtf(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v5, v6, v0}, reportWtf(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :goto_14
    invoke-direct {v5, v15}, startContentCaptureService(Landroid/content/Context;)V

    invoke-direct {v5, v15}, startAttentionService(Landroid/content/Context;)V

    invoke-direct {v5, v15}, startSystemCaptionsManagerService(Landroid/content/Context;)V
    ...
    :try_start_1d
    iget-object v8, v5, mActivityManagerService:Lcom/android/server/am/ActivityManagerService;
    ...
    invoke-direct {v5, v8, v0}, reportWtf(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :cond_17
    iget-object v0, v5, mPackageManager:Landroid/content/pm/PackageManager;
    ...
    iget-object v7, v5, mSystemContext:Landroid/content/Context;
    ...
    invoke-direct {v5, v1, v0}, reportWtf(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :try_start_46
    iget-object v0, v5, mPowerManagerService:Lcom/android/server/power/PowerManagerService;

    iget-object v2, v5, mActivityManagerService:Lcom/android/server/am/ActivityManagerService;
    ...
    invoke-direct {v5, v2, v0}, reportWtf(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-boolean v2, v5, mOnlyCore:Z
    ...
    invoke-direct {v5, v10, v0}, reportWtf(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {v15}, startCoreServiceApp(Landroid/content/Context;)V
    ...
    sget-object v1, BOOT_TIMINGS_TRACE_LOG:Landroid/util/TimingsTraceLog;
...
.method private startSystemCaptionsManagerService(Landroid/content/Context;)V
    ...
    invoke-static {v1}, traceBeginAndSlog(Ljava/lang/String;)V
...
.method private static traceBeginAndSlog(Ljava/lang/String;)V
    ...
    sget-object v0, BOOT_TIMINGS_TRACE_LOG:Landroid/util/TimingsTraceLog;
...
.method public synthetic lambda$startOtherServices$3$SystemServer()V
    ...
    iget-object v0, p0, mZygotePreload:Ljava/util/concurrent/Future;
    ...
    iput-object v0, p0, mZygotePreload:Ljava/util/concurrent/Future;

    iget-object v0, p0, mWebViewUpdateService:Lcom/android/server/webkit/WebViewUpdateService;
...
.method public synthetic lambda$startOtherServices$4$SystemServer(Landroid/content/Context;Lcom/android/server/wm/WindowManagerService;ZLcom/android/server/ConnectivityService;Lcom/android/server/NetworkManagementService;Lcom/android/server/net/NetworkPolicyManagerService;Lcom/android/server/IpSecService;Lcom/android/server/net/NetworkStatsService;Lcom/android/server/LocationManagerService;Lcom/android/server/CountryDetectorService;Lcom/android/server/NetworkTimeUpdateService;Lcom/android/server/input/InputManagerService;Lcom/android/server/TelephonyRegistry;Lcom/android/server/media/MediaRouterService;Lcom/android/server/MmsServiceBroker;)V
    ...
    iget-object v0, v1, mSystemServiceManager:Lcom/android/server/SystemServiceManager;
    ...
    :try_start_0
    iget-object v0, v1, mActivityManagerService:Lcom/android/server/am/ActivityManagerService;
    ...
    invoke-direct {p0, v4, v0}, reportWtf(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-boolean v5, v1, mOnlyCore:Z

    const-string v6, "WebViewFactoryPreparation"

    if-nez v5, :cond_0

    iget-object v5, v1, mWebViewUpdateService:Lcom/android/server/webkit/WebViewUpdateService;
    ...
    :try_start_1
    invoke-static {p1, p2}, startSystemUi(Landroid/content/Context;Lcom/android/server/wm/WindowManagerService;)V
    :try_end_1
    ...
    invoke-direct {p0, v7, v0}, reportWtf(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {p0, v8, v0}, reportWtf(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-object v0, v1, mPackageManagerService:Lcom/android/server/pm/PackageManagerService;
    ...
    invoke-direct {p0, v6, v0}, reportWtf(Ljava/lang/String;Ljava/lang/Throwable;)V
