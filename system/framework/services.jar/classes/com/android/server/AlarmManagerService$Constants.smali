...
.method public constructor <init>(Lcom/android/server/AlarmManagerService;Landroid/os/Handler;)V
    ...
    iput-object v0, p0, KEYS_APP_STANDBY_QUOTAS:[Ljava/lang/String;
    ...
    iput-object v0, p0, KEYS_APP_STANDBY_DELAY:[Ljava/lang/String;
    ...
    iput-object v1, p0, DEFAULT_APP_STANDBY_QUOTAS:[I

    new-array v0, v0, [J

    fill-array-data v0, :array_1

    iput-object v0, p0, DEFAULT_APP_STANDBY_DELAYS:[J

    const-wide/16 v0, 0x1388

    iput-wide v0, p0, MIN_FUTURITY:J

    const-wide/32 v2, 0xea60

    iput-wide v2, p0, MIN_INTERVAL:J

    const-wide v2, 0x757b12c00L

    iput-wide v2, p0, MAX_INTERVAL:J

    iput-wide v0, p0, ALLOW_WHILE_IDLE_SHORT_TIME:J

    const-wide/32 v2, 0xafc80

    iput-wide v2, p0, ALLOW_WHILE_IDLE_LONG_TIME:J

    const-wide/16 v2, 0x2710

    iput-wide v2, p0, ALLOW_WHILE_IDLE_WHITELIST_DURATION:J

    iput-wide v0, p0, LISTENER_TIMEOUT:J

    const/16 v0, 0x1f4

    iput v0, p0, MAX_ALARMS_PER_UID:I

    const/4 v0, 0x1

    iput-boolean v0, p0, APP_STANDBY_QUOTAS_ENABLED:Z

    const-wide/32 v0, 0x6ddd00

    iput-wide v0, p0, APP_STANDBY_WINDOW:J

    iget-object v0, p0, DEFAULT_APP_STANDBY_DELAYS:[J

    array-length v0, v0

    new-array v0, v0, [J

    iput-object v0, p0, APP_STANDBY_MIN_DELAYS:[J

    iget-object v0, p0, DEFAULT_APP_STANDBY_QUOTAS:[I

    array-length v0, v0

    new-array v0, v0, [I

    iput-object v0, p0, APP_STANDBY_QUOTAS:[I
...
.method private updateConstants()V
    ...
    iput-wide v1, p0, MIN_FUTURITY:J
    ...
    iput-wide v1, p0, MIN_INTERVAL:J
    ...
    iput-wide v1, p0, MAX_INTERVAL:J
    ...
    iput-wide v1, p0, ALLOW_WHILE_IDLE_SHORT_TIME:J
    ...
    iput-wide v1, p0, ALLOW_WHILE_IDLE_LONG_TIME:J
    ...
    iput-wide v1, p0, ALLOW_WHILE_IDLE_WHITELIST_DURATION:J
    ...
    iput-wide v1, p0, LISTENER_TIMEOUT:J

    iget-object v1, p0, APP_STANDBY_MIN_DELAYS:[J

    iget-object v2, p0, mParser:Landroid/util/KeyValueListParser;

    iget-object v3, p0, KEYS_APP_STANDBY_DELAY:[Ljava/lang/String;

    const/4 v4, 0x0

    aget-object v3, v3, v4

    iget-object v5, p0, DEFAULT_APP_STANDBY_DELAYS:[J
    ...
    iget-object v3, p0, APP_STANDBY_MIN_DELAYS:[J

    iget-object v5, p0, mParser:Landroid/util/KeyValueListParser;

    iget-object v6, p0, KEYS_APP_STANDBY_DELAY:[Ljava/lang/String;

    aget-object v6, v6, v2

    iget-object v7, p0, APP_STANDBY_MIN_DELAYS:[J

    add-int/lit8 v8, v2, -0x1

    aget-wide v7, v7, v8

    iget-object v9, p0, DEFAULT_APP_STANDBY_DELAYS:[J
    ...
    iput-boolean v2, p0, APP_STANDBY_QUOTAS_ENABLED:Z
    ...
    iput-wide v2, p0, APP_STANDBY_WINDOW:J

    iget-wide v2, p0, APP_STANDBY_WINDOW:J
    ...
    iput-wide v5, p0, APP_STANDBY_WINDOW:J
    ...
    iget-wide v5, p0, APP_STANDBY_WINDOW:J
    ...
    :cond_2
    :goto_2
    iget-object v2, p0, APP_STANDBY_QUOTAS:[I

    iget-object v3, p0, mParser:Landroid/util/KeyValueListParser;

    iget-object v5, p0, KEYS_APP_STANDBY_QUOTAS:[Ljava/lang/String;

    aget-object v5, v5, v4

    iget-object v6, p0, DEFAULT_APP_STANDBY_QUOTAS:[I
    ...
    :goto_3
    iget-object v2, p0, KEYS_APP_STANDBY_QUOTAS:[Ljava/lang/String;
    ...
    iget-object v4, p0, KEYS_APP_STANDBY_QUOTAS:[Ljava/lang/String;

    aget-object v4, v4, v1

    iget-object v5, p0, APP_STANDBY_QUOTAS:[I
    ...
    iput v1, p0, MAX_ALARMS_PER_UID:I

    iget v1, p0, MAX_ALARMS_PER_UID:I
    ...
    iput v3, p0, MAX_ALARMS_PER_UID:I
...
.method dump(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    iget-wide v1, p0, MIN_FUTURITY:J
    ...
    iget-wide v1, p0, MIN_INTERVAL:J
    ...
    iget-wide v1, p0, MAX_INTERVAL:J
    ...
    iget-wide v1, p0, LISTENER_TIMEOUT:J
    ...
    iget-wide v1, p0, ALLOW_WHILE_IDLE_SHORT_TIME:J
    ...
    iget-wide v1, p0, ALLOW_WHILE_IDLE_LONG_TIME:J
    ...
    iget-wide v1, p0, ALLOW_WHILE_IDLE_WHITELIST_DURATION:J
    ...
    :goto_0
    iget-object v2, p0, KEYS_APP_STANDBY_DELAY:[Ljava/lang/String;
    ...
    iget-object v2, p0, APP_STANDBY_MIN_DELAYS:[J
    ...
    iget-boolean v1, p0, APP_STANDBY_QUOTAS_ENABLED:Z
    ...
    iget-wide v1, p0, APP_STANDBY_WINDOW:J
...
.method dumpProto(Landroid/util/proto/ProtoOutputStream;J)V
    ...
    iget-wide v2, p0, MIN_FUTURITY:J

    const-wide v4, 0x10300000001L

    invoke-virtual {p1, v4, v5, v2, v3}, Landroid/util/proto/ProtoOutputStream;->write(JJ)V

    iget-wide v2, p0, MIN_INTERVAL:J

    const-wide v4, 0x10300000002L

    invoke-virtual {p1, v4, v5, v2, v3}, Landroid/util/proto/ProtoOutputStream;->write(JJ)V

    iget-wide v2, p0, MAX_INTERVAL:J

    const-wide v4, 0x10300000007L

    invoke-virtual {p1, v4, v5, v2, v3}, Landroid/util/proto/ProtoOutputStream;->write(JJ)V

    iget-wide v2, p0, LISTENER_TIMEOUT:J

    const-wide v4, 0x10300000003L

    invoke-virtual {p1, v4, v5, v2, v3}, Landroid/util/proto/ProtoOutputStream;->write(JJ)V

    iget-wide v2, p0, ALLOW_WHILE_IDLE_SHORT_TIME:J

    const-wide v4, 0x10300000004L

    invoke-virtual {p1, v4, v5, v2, v3}, Landroid/util/proto/ProtoOutputStream;->write(JJ)V

    iget-wide v2, p0, ALLOW_WHILE_IDLE_LONG_TIME:J
...
.method public updateAllowWhileIdleWhitelistDurationLocked()V
    ...
    iget-wide v0, p0, mLastAllowWhileIdleWhitelistDuration:J
