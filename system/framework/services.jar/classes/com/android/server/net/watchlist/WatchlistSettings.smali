...
.method static constructor <clinit>()V
    ...
    sput-object v0, sInstance:Lcom/android/server/net/watchlist/WatchlistSettings;
...
.method private constructor <init>()V
    ...
    invoke-static {}, getSystemWatchlistFile()Ljava/io/File;
...
.method protected constructor <init>(Ljava/io/File;)V
    ...
    iput-object v0, p0, mPrivacySecretKey:[B
    ...
    iput-object v0, p0, mXmlFile:Landroid/util/AtomicFile;

    invoke-direct {p0}, reloadSettings()V

    iget-object v0, p0, mPrivacySecretKey:[B

    if-nez v0, :cond_0

    invoke-direct {p0}, generatePrivacySecretKey()[B

    move-result-object v0

    iput-object v0, p0, mPrivacySecretKey:[B

    invoke-direct {p0}, saveSettings()V
...
.method public static getInstance()Lcom/android/server/net/watchlist/WatchlistSettings;
    ...
    sget-object v0, sInstance:Lcom/android/server/net/watchlist/WatchlistSettings;
...
.method private reloadSettings()V
    ...
    iget-object v1, p0, mXmlFile:Landroid/util/AtomicFile;
    ...
    invoke-direct {p0, v2}, parseSecretKey(Lorg/xmlpull/v1/XmlPullParser;)[B

    move-result-object v4

    iput-object v4, p0, mPrivacySecretKey:[B
...
.method private saveSettings()V
    ...
    :try_start_0
    iget-object v3, p0, mXmlFile:Landroid/util/AtomicFile;
    ...
    iget-object v5, p0, mPrivacySecretKey:[B
    ...
    iget-object v0, p0, mXmlFile:Landroid/util/AtomicFile;
...
.method declared-synchronized getPrivacySecretKey()[B
    ...
    iget-object v2, p0, mPrivacySecretKey:[B
