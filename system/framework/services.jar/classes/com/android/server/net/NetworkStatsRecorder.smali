...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mCookie:Ljava/lang/String;

    const-wide v1, 0x7528ad000L

    iput-wide v1, p0, mBucketDuration:J

    const/4 v1, 0x0

    iput-boolean v1, p0, mOnlyTags:Z
    ...
    iput-object v1, p0, mSinceBoot:Lcom/android/server/net/NetworkStatsCollection;
...
.method private loadLocked(JJ)Lcom/android/server/net/NetworkStatsCollection;
    ...
    iget-wide v3, p0, mBucketDuration:J

    invoke-direct {v2, v3, v4}, Lcom/android/server/net/NetworkStatsCollection;-><init>(J)V

    :try_start_0
    iget-object v5, p0, mRotator:Lcom/android/internal/util/FileRotator;
    ...
    iget-object v3, p0, mPending:Lcom/android/server/net/NetworkStatsCollection;
...
.method private recoverFromWtf()V
    ...
    :goto_1
    iget-object v1, p0, mDropBox:Landroid/os/DropBoxManager;
...
.method public forcePersistLocked(J)V
    ...
    iget-object v3, p0, mPendingRewriter:Lcom/android/server/net/NetworkStatsRecorder$CombiningRewriter;
...
.method public getOrLoadCompleteLocked()Lcom/android/server/net/NetworkStatsCollection;
    ...
    invoke-direct {p0, v1, v2, v3, v4}, loadLocked(JJ)Lcom/android/server/net/NetworkStatsCollection;
...
.method public importLegacyNetworkLocked(Ljava/io/File;)V
    ...
    iget-wide v1, p0, mBucketDuration:J
...
.method public recordSnapshotLocked(Landroid/net/NetworkStats;Ljava/util/Map;[Lcom/android/internal/net/VpnInfo;J)V
    ...
    :cond_0
    iget-object v4, v0, mLastSnapshot:Landroid/net/NetworkStats;

    if-nez v4, :cond_1

    iput-object v1, v0, mLastSnapshot:Landroid/net/NetworkStats;

    return-void

    :cond_1
    iget-object v4, v0, mComplete:Ljava/lang/ref/WeakReference;
    ...
    :goto_0
    iget-object v5, v0, mLastSnapshot:Landroid/net/NetworkStats;

    iget-object v6, v0, mObserver:Landroid/net/NetworkStats$NonMonotonicObserver;

    iget-object v7, v0, mCookie:Ljava/lang/String;
    ...
    :goto_3
    iget-boolean v6, v0, mOnlyTags:Z

    if-eq v5, v6, :cond_b

    iget-object v5, v0, mPending:Lcom/android/server/net/NetworkStatsCollection;
    ...
    :goto_4
    iget-object v5, v0, mSinceBoot:Lcom/android/server/net/NetworkStatsCollection;
...
.method public removeUidsLocked([I)V
    ...
    :cond_2
    iget-object v0, p0, mLastSnapshot:Landroid/net/NetworkStats;
