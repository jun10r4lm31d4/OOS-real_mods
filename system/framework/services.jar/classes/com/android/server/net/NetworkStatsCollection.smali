...
.method private dumpCheckin(Ljava/io/PrintWriter;JJLandroid/net/NetworkTemplate;Ljava/lang/String;)V
    ...
    :goto_0
    iget-object v4, v0, mStats:Landroid/util/ArrayMap;
    ...
    iget-object v5, v0, mStats:Landroid/util/ArrayMap;
    ...
    invoke-static {v12, v6}, templateMatches(Landroid/net/NetworkTemplate;Lcom/android/server/net/NetworkIdentitySet;)Z
...
.method private findOrCreateHistory(Lcom/android/server/net/NetworkIdentitySet;III)Landroid/net/NetworkStatsHistory;
    ...
    iget-wide v5, p0, mBucketDuration:J
...
.method public dump(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    invoke-direct {p0}, getSortedKeys()Ljava/util/ArrayList;
...
.method public dumpCheckin(Ljava/io/PrintWriter;JJ)V
    ...
    invoke-direct/range {v8 .. v15}, dumpCheckin(Ljava/io/PrintWriter;JJLandroid/net/NetworkTemplate;Ljava/lang/String;)V
...
.method public getHistory(Landroid/net/NetworkTemplate;Landroid/telephony/SubscriptionPlan;IIIIJJII)Landroid/net/NetworkStatsHistory;
    ...
    iget-wide v6, v1, mBucketDuration:J
    ...
    iget-wide v4, v1, mBucketDuration:J
    ...
    invoke-virtual {v1, v4, v5}, roundUp(J)J

    move-result-wide v4

    invoke-virtual {v1, v13, v14}, roundDown(J)J

    move-result-wide v13

    invoke-virtual {v1, v6, v7}, roundDown(J)J

    move-result-wide v6

    invoke-virtual {v1, v9, v10}, roundUp(J)J
    ...
    :goto_5
    iget-object v4, v1, mStats:Landroid/util/ArrayMap;
    ...
    invoke-static {v6, v5}, templateMatches(Landroid/net/NetworkTemplate;Lcom/android/server/net/NetworkIdentitySet;)Z

    move-result v5

    if-eqz v5, :cond_9

    iget-object v5, v1, mStats:Landroid/util/ArrayMap;
    ...
    invoke-static/range {v29 .. v34}, multiplySafe(JJJ)J
    ...
    iget-wide v13, v1, mBucketDuration:J
...
.method public getRelevantUids(I)[I
    ...
    invoke-virtual {p0, p1, v0}, getRelevantUids(II)[I
...
.method public getSummary(Landroid/net/NetworkTemplate;JJII)Landroid/net/NetworkStats;
    ...
    :goto_0
    iget-object v1, v0, mStats:Landroid/util/ArrayMap;
    ...
    invoke-static {v8, v1}, templateMatches(Landroid/net/NetworkTemplate;Lcom/android/server/net/NetworkIdentitySet;)Z
...
.method public read(Ljava/io/DataInputStream;)V
    ...
    invoke-direct {p0, v10, v11}, recordHistory(Lcom/android/server/net/NetworkStatsCollection$Key;Landroid/net/NetworkStatsHistory;)V
...
.method public readLegacyNetwork(Ljava/io/File;)V
    ...
    invoke-direct {p0, v8, v7}, recordHistory(Lcom/android/server/net/NetworkStatsCollection$Key;Landroid/net/NetworkStatsHistory;)V
...
.method public readLegacyUid(Ljava/io/File;Z)V
    ...
    :try_start_1
    invoke-direct {v13, v5, v7}, recordHistory(Lcom/android/server/net/NetworkStatsCollection$Key;Landroid/net/NetworkStatsHistory;)V
...
.method public recordCollection(Lcom/android/server/net/NetworkStatsCollection;)V
    ...
    :goto_0
    iget-object v1, p1, mStats:Landroid/util/ArrayMap;
    ...
    iget-object v2, p1, mStats:Landroid/util/ArrayMap;
...
.method public recordData(Lcom/android/server/net/NetworkIdentitySet;IIIJJLandroid/net/NetworkStats$Entry;)V
    ...
    invoke-direct/range {v9 .. v15}, noteRecordedHistory(JJJ)V
...
.method public removeUids([I)V
    ...
    invoke-direct {p0, v4, v5, v6, v6}, findOrCreateHistory(Lcom/android/server/net/NetworkIdentitySet;III)Landroid/net/NetworkStatsHistory;
...
.method public roundDown(J)J
    ...
    :cond_0
    iget-wide v0, p0, mBucketDuration:J
...
.method public write(Ljava/io/DataOutputStream;)V
    ...
    iget-object v6, p0, mStats:Landroid/util/ArrayMap;
