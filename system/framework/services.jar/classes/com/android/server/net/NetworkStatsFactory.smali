...
.method static constructor <clinit>()V
    ...
    sput-object v0, sStackedIfaces:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0, v1}, <init>(Ljava/io/File;Z)V
...
.method public constructor <init>(Ljava/io/File;Z)V
    ...
    iput-boolean p2, p0, mUseBpfStats:Z
    ...
    iput-object v0, p0, mPersistSnapshot:Landroid/net/NetworkStats;
...
.method public static apply464xlatAdjustments(Landroid/net/NetworkStats;Landroid/net/NetworkStats;Z)V
    ...
    sget-object v0, sStackedIfaces:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static augmentWithStackedInterfaces([Ljava/lang/String;)[Ljava/lang/String;
    ...
    sget-object v1, sStackedIfaces:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static javaReadNetworkStatsDetail(Ljava/io/File;I[Ljava/lang/String;I)Landroid/net/NetworkStats;
    ...
    invoke-static {v7, v6}, protocolExceptionWithCause(Ljava/lang/String;Ljava/lang/Throwable;)Ljava/net/ProtocolException;
...
.method private readNetworkStatsDetailInternal(I[Ljava/lang/String;ILandroid/net/NetworkStats;)Landroid/net/NetworkStats;
    ...
    :goto_0
    iget-boolean v1, p0, mUseBpfStats:Z

    if-eqz v1, :cond_2

    iget-object v7, p0, mPersistSnapshot:Landroid/net/NetworkStats;

    monitor-enter v7

    :try_start_0
    invoke-direct {p0}, requestSwapActiveStatsMapLocked()V
    :try_end_0
    ...
    iget-boolean v6, p0, mUseBpfStats:Z

    move-object v1, v0

    invoke-static/range {v1 .. v6}, nativeReadNetworkStatsDetail(Landroid/net/NetworkStats;Ljava/lang/String;I[Ljava/lang/String;IZ)I

    move-result v1

    if-nez v1, :cond_1

    iget-object v1, p0, mPersistSnapshot:Landroid/net/NetworkStats;
...
.method private requestSwapActiveStatsMapLocked()V
    ...
    iget-boolean v0, p0, mUseBpfStats:Z
    ...
    iput-object v0, p0, mNetdService:Landroid/net/INetd;
...
.method public readBpfNetworkStatsDev()Landroid/net/NetworkStats;
    ...
    invoke-static {v0}, nativeReadNetworkStatsDev(Landroid/net/NetworkStats;)I
...
.method public readNetworkStatsDetail()Landroid/net/NetworkStats;
    ...
    invoke-virtual {p0, v1, v0, v1, v0}, readNetworkStatsDetail(I[Ljava/lang/String;ILandroid/net/NetworkStats;)Landroid/net/NetworkStats;
...
.method public readNetworkStatsDetail(I[Ljava/lang/String;ILandroid/net/NetworkStats;)Landroid/net/NetworkStats;
    ...
    invoke-direct {p0, p1, p2, p3, p4}, readNetworkStatsDetailInternal(I[Ljava/lang/String;ILandroid/net/NetworkStats;)Landroid/net/NetworkStats;

    move-result-object v0

    sget-object v1, sStackedIfaces:Ljava/util/concurrent/ConcurrentHashMap;

    iget-boolean v2, p0, mUseBpfStats:Z
...
.method public readNetworkStatsSummaryDev()Landroid/net/NetworkStats;
    ...
    invoke-virtual {p0}, readBpfNetworkStatsDev()Landroid/net/NetworkStats;
    ...
    iget-object v6, p0, mStatsXtIfaceAll:Ljava/io/File;
    ...
    invoke-static {v5, v4}, protocolExceptionWithCause(Ljava/lang/String;Ljava/lang/Throwable;)Ljava/net/ProtocolException;
...
.method public readNetworkStatsSummaryXt()Landroid/net/NetworkStats;
    ...
    iget-object v1, p0, mStatsXtIfaceFmt:Ljava/io/File;
