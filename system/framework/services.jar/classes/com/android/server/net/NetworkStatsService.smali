...
.method constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Landroid/app/AlarmManager;Landroid/os/PowerManager$WakeLock;Ljava/time/Clock;Landroid/telephony/TelephonyManager;Lcom/android/server/net/NetworkStatsService$NetworkStatsSettings;Lcom/android/server/net/NetworkStatsObservers;Ljava/io/File;Ljava/io/File;)V
    ...
    iput-object v0, p0, mStatsLock:Ljava/lang/Object;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, mActiveIfaces:Landroid/util/ArrayMap;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, mActiveUidIfaces:Landroid/util/ArrayMap;
    ...
    iput-object v1, p0, mDefaultNetworks:[Landroid/net/Network;

    new-array v0, v0, [Lcom/android/internal/net/VpnInfo;

    iput-object v0, p0, mVpnInfos:[Lcom/android/internal/net/VpnInfo;
    ...
    iput-object v0, p0, mNonMonotonicObserver:Lcom/android/server/net/NetworkStatsService$DropBoxNonMonotonicObserver;

    new-instance v0, Landroid/util/SparseIntArray;

    invoke-direct {v0}, Landroid/util/SparseIntArray;-><init>()V

    iput-object v0, p0, mActiveUidCounterSet:Landroid/util/SparseIntArray;
    ...
    iput-object v0, p0, mUidOperations:Landroid/net/NetworkStats;
    ...
    iput-object v0, p0, mOpenSessionCallsPerUid:Landroid/util/SparseIntArray;
    ...
    iput-object v0, p0, mTetherReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v0, p0, mPollReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v0, p0, mRemovedReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v0, p0, mShutdownReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v0, p0, mNetworkManager:Landroid/os/INetworkManagementService;
    ...
    iput-object v0, p0, mClock:Ljava/time/Clock;
    ...
    iput-object v0, p0, mSettings:Lcom/android/server/net/NetworkStatsService$NetworkStatsSettings;
    ...
    iput-object v0, p0, mTeleManager:Landroid/telephony/TelephonyManager;
    ...
    iput-object v0, p0, mStatsObservers:Lcom/android/server/net/NetworkStatsObservers;
    ...
    iput-object v0, p0, mBaseDir:Ljava/io/File;
    ...
    iput-boolean v0, p0, mUseBpfTrafficStats:Z
...
.method static synthetic access$1800(Lcom/android/server/net/NetworkStatsService;J)V
    ...
    invoke-direct {p0, p1, p2}, advisePersistThreshold(J)V
...
.method static synthetic access$200(Lcom/android/server/net/NetworkStatsService;Ljava/lang/String;)I
    ...
    invoke-direct {p0, p1}, checkAccessLevel(Ljava/lang/String;)I
...
.method static synthetic access$600(Lcom/android/server/net/NetworkStatsService;Landroid/net/NetworkTemplate;IJJII)Landroid/net/NetworkStats;
    ...
    invoke-direct/range {p0 .. p8}, internalGetSummaryForNetwork(Landroid/net/NetworkTemplate;IJJII)Landroid/net/NetworkStats;
...
.method static synthetic access$700(Lcom/android/server/net/NetworkStatsService;Landroid/net/NetworkTemplate;IIII)Landroid/net/NetworkStatsHistory;
    ...
    invoke-direct/range {p0 .. p5}, internalGetHistoryForNetwork(Landroid/net/NetworkTemplate;IIII)Landroid/net/NetworkStatsHistory;
...
.method private advisePersistThreshold(J)V
    ...
    iget-wide v1, p0, mPersistThreshold:J
    ...
    iget-object v2, p0, mStatsLock:Ljava/lang/Object;
    ...
    :cond_1
    invoke-direct {p0}, updatePersistThresholdsLocked()V

    iget-object v3, p0, mDevRecorder:Lcom/android/server/net/NetworkStatsRecorder;

    invoke-virtual {v3, v0, v1}, Lcom/android/server/net/NetworkStatsRecorder;->maybePersistLocked(J)V

    iget-object v3, p0, mXtRecorder:Lcom/android/server/net/NetworkStatsRecorder;

    invoke-virtual {v3, v0, v1}, Lcom/android/server/net/NetworkStatsRecorder;->maybePersistLocked(J)V

    iget-object v3, p0, mUidRecorder:Lcom/android/server/net/NetworkStatsRecorder;

    invoke-virtual {v3, v0, v1}, Lcom/android/server/net/NetworkStatsRecorder;->maybePersistLocked(J)V

    iget-object v3, p0, mUidTagRecorder:Lcom/android/server/net/NetworkStatsRecorder;
...
.method private buildRecorder(Ljava/lang/String;Lcom/android/server/net/NetworkStatsService$NetworkStatsSettings$Config;Z)Lcom/android/server/net/NetworkStatsRecorder;
    ...
    iget-object v3, p0, mNonMonotonicObserver:Lcom/android/server/net/NetworkStatsService$DropBoxNonMonotonicObserver;
...
.method private checkBpfStatsEnable()Z
    ...
    iget-boolean v0, p0, mUseBpfTrafficStats:Z
...
.method public static create(Landroid/content/Context;Landroid/os/INetworkManagementService;)Lcom/android/server/net/NetworkStatsService;
    ...
    invoke-static {}, getDefaultBaseDir()Ljava/io/File;
    ...
    invoke-direct/range {v0 .. v10}, <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Landroid/app/AlarmManager;Landroid/os/PowerManager$WakeLock;Ljava/time/Clock;Landroid/telephony/TelephonyManager;Lcom/android/server/net/NetworkStatsService$NetworkStatsSettings;Lcom/android/server/net/NetworkStatsObservers;Ljava/io/File;Ljava/io/File;)V

    invoke-direct {v0}, registerLocalService()V
    ...
    invoke-virtual {v0, v3, v2}, setHandler(Landroid/os/Handler;Landroid/os/Handler$Callback;)V
...
.method private dumpProtoLocked(Ljava/io/FileDescriptor;)V
    ...
    iget-object v1, p0, mActiveIfaces:Landroid/util/ArrayMap;

    const-wide v2, 0x20b00000001L

    invoke-static {v0, v2, v3, v1}, dumpInterfaces(Landroid/util/proto/ProtoOutputStream;JLandroid/util/ArrayMap;)V

    iget-object v1, p0, mActiveUidIfaces:Landroid/util/ArrayMap;

    const-wide v2, 0x20b00000002L

    invoke-static {v0, v2, v3, v1}, dumpInterfaces(Landroid/util/proto/ProtoOutputStream;JLandroid/util/ArrayMap;)V

    iget-object v1, p0, mDevRecorder:Lcom/android/server/net/NetworkStatsRecorder;
    ...
    iget-object v1, p0, mXtRecorder:Lcom/android/server/net/NetworkStatsRecorder;

    const-wide v2, 0x10b00000004L

    invoke-virtual {v1, v0, v2, v3}, Lcom/android/server/net/NetworkStatsRecorder;->writeToProtoLocked(Landroid/util/proto/ProtoOutputStream;J)V

    iget-object v1, p0, mUidRecorder:Lcom/android/server/net/NetworkStatsRecorder;

    const-wide v2, 0x10b00000005L

    invoke-virtual {v1, v0, v2, v3}, Lcom/android/server/net/NetworkStatsRecorder;->writeToProtoLocked(Landroid/util/proto/ProtoOutputStream;J)V

    iget-object v1, p0, mUidTagRecorder:Lcom/android/server/net/NetworkStatsRecorder;
...
.method private getNetworkStatsUidDetail([Ljava/lang/String;)Landroid/net/NetworkStats;
    ...
    invoke-direct {p0, v2}, getNetworkStatsTethering(I)Landroid/net/NetworkStats;

    move-result-object v3

    invoke-virtual {v3, v1, p1, v1}, Landroid/net/NetworkStats;->filter(I[Ljava/lang/String;I)V

    iget-boolean v4, p0, mUseBpfTrafficStats:Z
    ...
    iget-boolean v1, p0, mUseBpfTrafficStats:Z
    ...
    :cond_0
    iget-object v1, p0, mUidOperations:Landroid/net/NetworkStats;
...
.method private getNetworkTotalBytes(Landroid/net/NetworkTemplate;JJ)J
    ...
    invoke-direct {p0}, assertSystemReady()V
    ...
    invoke-direct/range {v0 .. v8}, internalGetSummaryForNetwork(Landroid/net/NetworkTemplate;IJJII)Landroid/net/NetworkStats;
...
.method private getTetherStats(Ljava/lang/String;I)J
    ...
    :try_start_0
    invoke-direct {p0, v3}, getNetworkStatsTethering(I)Landroid/net/NetworkStats;
...
.method private internalGetHistoryForNetwork(Landroid/net/NetworkTemplate;IIII)Landroid/net/NetworkStatsHistory;
    ...
    invoke-direct/range {p0 .. p2}, resolveSubscriptionPlan(Landroid/net/NetworkTemplate;I)Landroid/telephony/SubscriptionPlan;

    move-result-object v15

    iget-object v14, v1, mStatsLock:Ljava/lang/Object;

    monitor-enter v14

    :try_start_0
    iget-object v2, v1, mXtStatsCached:Lcom/android/server/net/NetworkStatsCollection;
    :try_end_0
...
.method private internalGetSummaryForNetwork(Landroid/net/NetworkTemplate;IJJII)Landroid/net/NetworkStats;
    ...
    invoke-direct/range {v0 .. v5}, internalGetHistoryForNetwork(Landroid/net/NetworkTemplate;IIII)Landroid/net/NetworkStatsHistory;
...
.method private isRateLimitedForPoll(I)Z
    ...
    iget-object v3, p0, mOpenSessionCallsPerUid:Landroid/util/SparseIntArray;

    monitor-enter v3

    :try_start_0
    iget-object v4, p0, mOpenSessionCallsPerUid:Landroid/util/SparseIntArray;

    invoke-virtual {v4, p1, v0}, Landroid/util/SparseIntArray;->get(II)I

    move-result v4

    iget-object v5, p0, mOpenSessionCallsPerUid:Landroid/util/SparseIntArray;

    add-int/lit8 v6, v4, 0x1

    invoke-virtual {v5, p1, v6}, Landroid/util/SparseIntArray;->put(II)V

    iget-wide v5, p0, mLastStatsSessionPoll:J

    iput-wide v1, p0, mLastStatsSessionPoll:J
...
.method private maybeUpgradeLegacyStatsLocked()V
    ...
    iget-object v3, p0, mSystemDir:Ljava/io/File;
    ...
    iget-object v4, p0, mSystemDir:Ljava/io/File;
...
.method private openSessionInternal(ILjava/lang/String;)Landroid/net/INetworkStatsSession;
    ...
    invoke-direct {p0, v0}, isRateLimitedForPoll(I)Z
    ...
    :try_start_0
    invoke-direct {p0, v4}, performPoll(I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private performPollLocked(I)V
    ...
    :try_start_0
    invoke-direct {p0, v7, v8}, recordSnapshotLocked(J)V
    :try_end_0
    .catch Ljava/lang/IllegalStateException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private performSampleLocked()V
    ...
    iget-object v1, v0, mClock:Ljava/time/Clock;
    ...
    iget-object v4, v3, mDevRecorder:Lcom/android/server/net/NetworkStatsRecorder;
    ...
    iget-object v5, v3, mXtRecorder:Lcom/android/server/net/NetworkStatsRecorder;
    ...
    iget-object v5, v3, mUidRecorder:Lcom/android/server/net/NetworkStatsRecorder;
...
.method private recordSnapshotLocked(J)V
    ...
    invoke-direct {v0, v3}, getNetworkStatsUidDetail([Ljava/lang/String;)Landroid/net/NetworkStats;
    ...
    invoke-direct/range {p0 .. p0}, getNetworkStatsXt()Landroid/net/NetworkStats;
    ...
    iget-object v4, v0, mNetworkManager:Landroid/os/INetworkManagementService;
    ...
    invoke-direct {v0, v4}, getNetworkStatsTethering(I)Landroid/net/NetworkStats;
    ...
    iget-object v5, v0, mDevRecorder:Lcom/android/server/net/NetworkStatsRecorder;

    iget-object v7, v0, mActiveIfaces:Landroid/util/ArrayMap;
    ...
    iget-object v5, v0, mXtRecorder:Lcom/android/server/net/NetworkStatsRecorder;
    ...
    iget-object v15, v0, mVpnInfos:[Lcom/android/internal/net/VpnInfo;
    ...
    iget-object v4, v0, mStatsObservers:Lcom/android/server/net/NetworkStatsObservers;

    new-instance v7, Landroid/util/ArrayMap;

    iget-object v1, v0, mActiveIfaces:Landroid/util/ArrayMap;

    invoke-direct {v7, v1}, Landroid/util/ArrayMap;-><init>(Landroid/util/ArrayMap;)V

    new-instance v8, Landroid/util/ArrayMap;

    iget-object v1, v0, mActiveUidIfaces:Landroid/util/ArrayMap;
...
.method private registerGlobalAlert()V
    ...
    iget-wide v3, p0, mGlobalAlertBytes:J
...
.method private registerPollAlarmLocked()V
    ...
    iget-object v7, p0, mPollIntent:Landroid/app/PendingIntent;
...
.method private varargs removeUidsLocked([I)V
    ...
    invoke-direct {p0, v0}, performPollLocked(I)V
...
.method private removeUserLocked(I)V
    ...
    :cond_1
    invoke-direct {p0, v0}, removeUidsLocked([I)V
...
.method private shutdownLocked()V
    ...
    iget-object v1, p0, mTetherReceiver:Landroid/content/BroadcastReceiver;

    invoke-virtual {v0, v1}, Landroid/content/Context;->unregisterReceiver(Landroid/content/BroadcastReceiver;)V

    iget-object v0, p0, mContext:Landroid/content/Context;

    iget-object v1, p0, mPollReceiver:Landroid/content/BroadcastReceiver;

    invoke-virtual {v0, v1}, Landroid/content/Context;->unregisterReceiver(Landroid/content/BroadcastReceiver;)V

    iget-object v0, p0, mContext:Landroid/content/Context;

    iget-object v1, p0, mRemovedReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v1, p0, mShutdownReceiver:Landroid/content/BroadcastReceiver;
...
.method private updateIfaces([Landroid/net/Network;[Lcom/android/internal/net/VpnInfo;[Landroid/net/NetworkState;Ljava/lang/String;)V
    ...
    :try_start_1
    iput-object p2, p0, mVpnInfos:[Lcom/android/internal/net/VpnInfo;

    iput-object p4, p0, mActiveIface:Ljava/lang/String;

    invoke-direct {p0, p1, p3}, updateIfacesLocked([Landroid/net/Network;[Landroid/net/NetworkState;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method private updateIfacesLocked([Landroid/net/Network;[Landroid/net/NetworkState;)V
    ...
    iget-boolean v3, v0, mSystemReady:Z
    ...
    invoke-direct {v0, v3}, performPollLocked(I)V
    ...
    iput-object v1, v0, mDefaultNetworks:[Landroid/net/Network;
    ...
    iget-object v8, v0, mDefaultNetworks:[Landroid/net/Network;
    ...
    iget-object v11, v0, mActiveIfaces:Landroid/util/ArrayMap;

    invoke-static {v11, v10}, findOrCreateNetworkIdentitySet(Landroid/util/ArrayMap;Ljava/lang/Object;)Lcom/android/server/net/NetworkIdentitySet;

    move-result-object v11

    invoke-virtual {v11, v9}, Lcom/android/server/net/NetworkIdentitySet;->add(Ljava/lang/Object;)Z

    iget-object v11, v0, mActiveUidIfaces:Landroid/util/ArrayMap;
    ...
    iget-object v12, v0, mActiveIfaces:Landroid/util/ArrayMap;

    const-string/jumbo v13, "vt_data0"

    invoke-static {v12, v13}, findOrCreateNetworkIdentitySet(Landroid/util/ArrayMap;Ljava/lang/Object;)Lcom/android/server/net/NetworkIdentitySet;

    move-result-object v12

    invoke-virtual {v12, v11}, Lcom/android/server/net/NetworkIdentitySet;->add(Ljava/lang/Object;)Z

    iget-object v12, v0, mActiveUidIfaces:Landroid/util/ArrayMap;
    ...
    iget-boolean v15, v0, mUseBpfTrafficStats:Z

    if-eqz v15, :cond_5

    iget-object v15, v0, mActiveIfaces:Landroid/util/ArrayMap;

    invoke-static {v15, v14}, findOrCreateNetworkIdentitySet(Landroid/util/ArrayMap;Ljava/lang/Object;)Lcom/android/server/net/NetworkIdentitySet;
    ...
    :cond_5
    iget-object v15, v0, mActiveUidIfaces:Landroid/util/ArrayMap;
    ...
    iput-object v4, v0, mMobileIfaces:[Ljava/lang/String;
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v7, v1, mStatsLock:Ljava/lang/Object;
    ...
    invoke-direct/range {p0 .. p1}, dumpProtoLocked(Ljava/io/FileDescriptor;)V
    ...
    invoke-direct {v1, v0}, performPollLocked(I)V
    ...
    iget-object v2, v1, mXtRecorder:Lcom/android/server/net/NetworkStatsRecorder;
    :try_end_3
    ...
    iget-object v2, v1, mUidRecorder:Lcom/android/server/net/NetworkStatsRecorder;
    ...
    iget-object v2, v1, mUidTagRecorder:Lcom/android/server/net/NetworkStatsRecorder;
    ...
    :goto_9
    iget-object v2, v1, mActiveIfaces:Landroid/util/ArrayMap;
    ...
    iget-object v3, v1, mActiveIfaces:Landroid/util/ArrayMap;
    ...
    :goto_a
    iget-object v2, v1, mActiveUidIfaces:Landroid/util/ArrayMap;
    ...
    iget-object v3, v1, mActiveUidIfaces:Landroid/util/ArrayMap;
    ...
    iget-object v2, v1, mOpenSessionCallsPerUid:Landroid/util/SparseIntArray;
    ...
    :try_start_a
    iget-object v0, v1, mOpenSessionCallsPerUid:Landroid/util/SparseIntArray;
    ...
    iget-object v5, v1, mDevRecorder:Lcom/android/server/net/NetworkStatsRecorder;
    ...
    iget-object v5, v1, mXtRecorder:Lcom/android/server/net/NetworkStatsRecorder;
    ...
    iget-object v5, v1, mUidRecorder:Lcom/android/server/net/NetworkStatsRecorder;
    ...
    iget-object v5, v1, mUidTagRecorder:Lcom/android/server/net/NetworkStatsRecorder;
...
.method public forceUpdateIfaces([Landroid/net/Network;[Lcom/android/internal/net/VpnInfo;[Landroid/net/NetworkState;Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-direct {p0, p1, p2, p3, p4}, updateIfaces([Landroid/net/Network;[Lcom/android/internal/net/VpnInfo;[Landroid/net/NetworkState;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public getDetailedUidStats([Ljava/lang/String;)Landroid/net/NetworkStats;
    ...
    invoke-direct {p0, v0}, getNetworkStatsUidDetail([Ljava/lang/String;)Landroid/net/NetworkStats;
...
.method public getIfaceStats(Ljava/lang/String;I)J
    ...
    invoke-direct {p0}, checkBpfStatsEnable()Z

    move-result v0

    invoke-static {p1, p2, v0}, nativeGetIfaceStat(Ljava/lang/String;IZ)J
    ...
    :cond_0
    invoke-direct {p0, p1, p2}, getTetherStats(Ljava/lang/String;I)J
...
.method public getTotalStats(I)J
    ...
    invoke-static {p1, v0}, nativeGetTotalStat(IZ)J
    ...
    invoke-direct {p0, v2, p1}, getTetherStats(Ljava/lang/String;I)J
...
.method public getUidStats(II)J
    ...
    invoke-static {p1, p2, v0}, nativeGetUidStat(IIZ)J
...
.method public incrementOperationCount(III)V
    ...
    :try_start_0
    iget-object v0, v1, mActiveUidCounterSet:Landroid/util/SparseIntArray;
    ...
    iget-object v2, v1, mUidOperations:Landroid/net/NetworkStats;

    iget-object v3, v1, mActiveIface:Ljava/lang/String;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_1
    ...
    iget-object v6, v1, mUidOperations:Landroid/net/NetworkStats;

    iget-object v7, v1, mActiveIface:Ljava/lang/String;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public openSession()Landroid/net/INetworkStatsSession;
    ...
    invoke-direct {p0, v0, v1}, openSessionInternal(ILjava/lang/String;)Landroid/net/INetworkStatsSession;
...
.method public openSessionForUsageStats(ILjava/lang/String;)Landroid/net/INetworkStatsSession;
    ...
    invoke-direct {p0, p1, p2}, openSessionInternal(ILjava/lang/String;)Landroid/net/INetworkStatsSession;
...
.method public registerUsageCallback(Ljava/lang/String;Landroid/net/DataUsageRequest;Landroid/os/Messenger;Landroid/os/IBinder;)Landroid/net/DataUsageRequest;
    ...
    :try_start_0
    iget-object v1, p0, mStatsObservers:Lcom/android/server/net/NetworkStatsObservers;
...
.method setHandler(Landroid/os/Handler;Landroid/os/Handler$Callback;)V
    ...
    iput-object p2, p0, mHandlerCallback:Landroid/os/Handler$Callback;
...
.method setUidForeground(IZ)V
    ...
    :goto_0
    :try_start_0
    iget-object v3, p0, mActiveUidCounterSet:Landroid/util/SparseIntArray;
...
.method public systemReady()V
    ...
    iget-object v3, p0, mSettings:Lcom/android/server/net/NetworkStatsService$NetworkStatsSettings;
    ...
    invoke-direct {p0, v2, v3, v4}, buildRecorder(Ljava/lang/String;Lcom/android/server/net/NetworkStatsService$NetworkStatsSettings$Config;Z)Lcom/android/server/net/NetworkStatsRecorder;

    move-result-object v2

    iput-object v2, p0, mDevRecorder:Lcom/android/server/net/NetworkStatsRecorder;
    ...
    iput-object v2, p0, mXtRecorder:Lcom/android/server/net/NetworkStatsRecorder;
    ...
    iput-object v2, p0, mUidRecorder:Lcom/android/server/net/NetworkStatsRecorder;
    ...
    invoke-direct {p0, v2, v3, v0}, buildRecorder(Ljava/lang/String;Lcom/android/server/net/NetworkStatsService$NetworkStatsSettings$Config;Z)Lcom/android/server/net/NetworkStatsRecorder;

    move-result-object v0

    iput-object v0, p0, mUidTagRecorder:Lcom/android/server/net/NetworkStatsRecorder;
    ...
    iput-object v0, p0, mXtStatsCached:Lcom/android/server/net/NetworkStatsCollection;
    ...
    iget-object v2, p0, mTetherReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v5, p0, mRemovedReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v6, p0, mUserReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v6, p0, mShutdownReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v6, p0, mAlertObserver:Landroid/net/INetworkManagementEventObserver;
...
.method public unregisterUsageRequest(Landroid/net/DataUsageRequest;)V
    ...
    :try_start_0
    iget-object v3, p0, mStatsObservers:Lcom/android/server/net/NetworkStatsObservers;
