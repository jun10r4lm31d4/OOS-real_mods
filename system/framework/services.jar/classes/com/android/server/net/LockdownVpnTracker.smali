...
.method public constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Lcom/android/server/ConnectivityService;Lcom/android/server/connectivity/Vpn;Lcom/android/internal/net/VpnProfile;)V
    ...
    iput-object v0, p0, mResetReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v0, p0, mNetService:Landroid/os/INetworkManagementService;
    ...
    iput-object v0, p0, mConnService:Lcom/android/server/ConnectivityService;
    ...
    iput-object v0, p0, mVpn:Lcom/android/server/connectivity/Vpn;
    ...
    iput-object v0, p0, mProfile:Lcom/android/internal/net/VpnProfile;
    ...
    iput-object v1, p0, mConfigIntent:Landroid/app/PendingIntent;
...
.method private handleStateChangedLocked()V
    ...
    iget-object v0, v1, mConnService:Lcom/android/server/ConnectivityService;
    ...
    iget-object v0, v1, mVpn:Lcom/android/server/connectivity/Vpn;
    ...
    iget-object v8, v1, mAcceptedEgressIface:Ljava/lang/String;
    ...
    iget-object v11, v1, mAcceptedEgressIface:Ljava/lang/String;
    ...
    :cond_6
    iput-object v8, v1, mAcceptedEgressIface:Ljava/lang/String;
    ...
    invoke-direct/range {p0 .. p0}, hideNotification()V
    ...
    invoke-direct {v1, v14, v15}, showNotification(II)V
    ...
    iget-object v0, v1, mProfile:Lcom/android/internal/net/VpnProfile;
    ...
    invoke-direct {v1, v0, v15}, showNotification(II)V
    ...
    iget-object v13, v1, mProfile:Lcom/android/internal/net/VpnProfile;
    ...
    invoke-direct {v1, v8, v15}, showNotification(II)V
    ...
    iget-object v13, v1, mAcceptedIface:Ljava/lang/String;
    ...
    iget-object v13, v1, mAcceptedSourceAddr:Ljava/util/List;
    ...
    invoke-direct {v1, v11, v13}, showNotification(II)V

    new-instance v11, Landroid/net/NetworkInfo;

    invoke-direct {v11, v2}, Landroid/net/NetworkInfo;-><init>(Landroid/net/NetworkInfo;)V

    invoke-virtual {v1, v11}, augmentNetworkInfo(Landroid/net/NetworkInfo;)V

    iget-object v13, v1, mConnService:Lcom/android/server/ConnectivityService;
...
.method private initLocked()V
    ...
    iget-object v0, p0, mVpn:Lcom/android/server/connectivity/Vpn;
...
.method private showNotification(II)V
    ...
    iget-object v1, p0, mConfigIntent:Landroid/app/PendingIntent;
    ...
    iget-object v2, p0, mResetIntent:Landroid/app/PendingIntent;
...
.method private shutdownLocked()V
    ...
    iput-object v0, p0, mAcceptedEgressIface:Ljava/lang/String;
    ...
    invoke-direct {p0}, hideNotification()V

    iget-object v0, p0, mContext:Landroid/content/Context;

    iget-object v1, p0, mResetReceiver:Landroid/content/BroadcastReceiver;
