...
.method constructor <init>(Landroid/content/Context;Landroid/os/Looper;)V
    ...
    iput v0, p0, mPrimaryUserId:I

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, mCachedUidDigestMap:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-object v0, p0, mDbHelper:Lcom/android/server/net/watchlist/WatchlistReportDbHelper;
    ...
    iput-object v0, p0, mConfig:Lcom/android/server/net/watchlist/WatchlistConfig;
    ...
    iput-object v0, p0, mSettings:Lcom/android/server/net/watchlist/WatchlistSettings;
    ...
    invoke-direct {p0}, getPrimaryUserId()I
...
.method private getDigestFromUid(I)[B
    ...
    iget-object v0, p0, mCachedUidDigestMap:Ljava/util/concurrent/ConcurrentHashMap;
...
.method static getLastMidnightTime()J
    ...
    invoke-static {v0}, getMidnightTimestamp(I)J
...
.method private handleNetworkEvent(Ljava/lang/String;[Ljava/lang/String;IJ)V
    ...
    :cond_1
    invoke-direct {p0, p1}, searchAllSubDomainsInWatchlist(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    if-eqz v0, :cond_2

    invoke-direct {p0, p3, v0, p4, p5}, insertRecord(ILjava/lang/String;J)Z

    goto :goto_0

    :cond_2
    invoke-direct {p0, p2}, searchIpInWatchlist([Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    if-eqz v1, :cond_3

    invoke-direct {p0, p3, v1, p4, p5}, insertRecord(ILjava/lang/String;J)Z
...
.method private insertRecord(ILjava/lang/String;J)Z
    ...
    iget-object v0, p0, mConfig:Lcom/android/server/net/watchlist/WatchlistConfig;
    ...
    invoke-direct {p0, p1}, isPackageTestOnly(I)Z
    ...
    :cond_0
    invoke-direct {p0, p1}, getDigestFromUid(I)[B
    ...
    :cond_1
    iget-object v1, p0, mDbHelper:Lcom/android/server/net/watchlist/WatchlistReportDbHelper;
...
.method private searchAllSubDomainsInWatchlist(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    invoke-static {p1}, getAllSubDomains(Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-direct {p0, v4}, isHostInWatchlist(Ljava/lang/String;)Z
...
.method private searchIpInWatchlist([Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, v2}, isIpInWatchlist(Ljava/lang/String;)Z
...
.method private shouldReportNetworkWatchlist(J)Z
    ...
    iget-object v2, p0, mDbHelper:Lcom/android/server/net/watchlist/WatchlistReportDbHelper;
...
.method private tryAggregateRecords(J)V
    ...
    :try_start_0
    invoke-direct {p0, p1, p2}, shouldReportNetworkWatchlist(J)Z
    ...
    iget-object v3, p0, mDropBoxManager:Landroid/os/DropBoxManager;
    ...
    :try_start_2
    iget-object v4, p0, mDbHelper:Lcom/android/server/net/watchlist/WatchlistReportDbHelper;
    ...
    :cond_1
    :try_start_4
    invoke-virtual {p0, v3}, getAllDigestsForReport(Lcom/android/server/net/watchlist/WatchlistReportDbHelper$AggregatedResult;)Ljava/util/List;

    move-result-object v4

    iget-object v5, p0, mSettings:Lcom/android/server/net/watchlist/WatchlistSettings;

    invoke-virtual {v5}, Lcom/android/server/net/watchlist/WatchlistSettings;->getPrivacySecretKey()[B

    move-result-object v5

    iget-object v6, p0, mConfig:Lcom/android/server/net/watchlist/WatchlistConfig;
    ...
    invoke-direct {p0, v6}, addEncodedReportToDropBox([B)V
    ...
    :goto_1
    iget-object v3, p0, mDbHelper:Lcom/android/server/net/watchlist/WatchlistReportDbHelper;
...
.method getAllDigestsForReport(Lcom/android/server/net/watchlist/WatchlistReportDbHelper$AggregatedResult;)Ljava/util/List;
    ...
    invoke-direct {p0, v4}, getDigestFromUid(I)[B
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-direct {p0, v0, v1}, tryAggregateRecords(J)V
    ...
    :cond_2
    invoke-static {}, getLastMidnightTime()J
    ...
    invoke-direct/range {v2 .. v7}, handleNetworkEvent(Ljava/lang/String;[Ljava/lang/String;IJ)V
