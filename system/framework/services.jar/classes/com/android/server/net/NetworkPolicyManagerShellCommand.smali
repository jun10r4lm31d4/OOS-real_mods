...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/net/NetworkPolicyManagerService;)V
    ...
    iput-object p2, p0, mInterface:Lcom/android/server/net/NetworkPolicyManagerService;
...
.method private addAppIdleWhitelist()I
    ...
    invoke-direct {p0, v0}, setAppIdleWhitelist(Z)I
...
.method private addRestrictBackgroundBlacklist()I
    ...
    invoke-direct {p0, v0}, setUidPolicy(I)I
...
.method private getRestrictBackground()I
    ...
    iget-object v1, p0, mInterface:Lcom/android/server/net/NetworkPolicyManagerService;
...
.method private listAppIdleWhitelist()I
    ...
    invoke-direct {p0, v2, v1}, listUidList(Ljava/lang/String;[I)I
...
.method private listRestrictBackgroundBlacklist()I
    ...
    invoke-direct {p0, v0, v1}, listUidPolicies(Ljava/lang/String;I)I
...
.method private listUidPolicies(Ljava/lang/String;I)I
    ...
    iget-object v0, p0, mInterface:Lcom/android/server/net/NetworkPolicyManagerService;

    invoke-virtual {v0, p2}, Lcom/android/server/net/NetworkPolicyManagerService;->getUidsWithPolicy(I)[I

    move-result-object v0

    invoke-direct {p0, p1, v0}, listUidList(Ljava/lang/String;[I)I
...
.method private listWifiNetworks()I
    ...
    invoke-static {v6}, overrideToString(I)Ljava/lang/String;
...
.method private removeRestrictBackgroundBlacklist()I
    ...
    invoke-direct {p0, v0, v1}, resetUidPolicy(Ljava/lang/String;I)I
...
.method private resetUidPolicy(Ljava/lang/String;I)I
    ...
    invoke-direct {p0}, getUidFromNextArg()I
    ...
    :cond_1
    iget-object v2, p0, mInterface:Lcom/android/server/net/NetworkPolicyManagerService;
...
.method private runAdd()I
    ...
    :cond_5
    invoke-direct {p0}, addAppIdleWhitelist()I
    ...
    :cond_6
    invoke-direct {p0}, addRestrictBackgroundBlacklist()I
    ...
    :cond_7
    invoke-direct {p0}, addRestrictBackgroundWhitelist()I
...
.method private runGet()I
    ...
    :cond_3
    invoke-direct {p0}, getRestrictBackground()I
...
.method private runList()I
    ...
    :cond_2
    invoke-direct {p0}, listRestrictBackgroundBlacklist()I
    ...
    :cond_3
    invoke-direct {p0}, listRestrictBackgroundWhitelist()I
    ...
    :cond_4
    invoke-direct {p0}, listWifiNetworks()I
    ...
    :cond_5
    invoke-direct {p0}, listAppIdleWhitelist()I
...
.method private runRemove()I
    ...
    :cond_5
    invoke-direct {p0}, removeAppIdleWhitelist()I
    ...
    :cond_6
    invoke-direct {p0}, removeRestrictBackgroundBlacklist()I
    ...
    :cond_7
    invoke-direct {p0}, removeRestrictBackgroundWhitelist()I
...
.method private runSet()I
    ...
    :cond_5
    invoke-direct {p0}, setSubPlanOwner()I
    ...
    :cond_6
    invoke-direct {p0}, setRestrictBackground()I
    ...
    :cond_7
    invoke-direct {p0}, setMeteredWifiNetwork()I
...
.method private setMeteredWifiNetwork()I
    ...
    :cond_1
    iget-object v4, p0, mInterface:Lcom/android/server/net/NetworkPolicyManagerService;

    invoke-static {v1}, Landroid/net/NetworkPolicyManager;->resolveNetworkId(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v5

    invoke-static {v3}, stringToOverride(Ljava/lang/String;)I
...
.method private setRestrictBackground()I
    ...
    invoke-direct {p0}, getNextBooleanArg()I
