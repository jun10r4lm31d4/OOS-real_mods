...
.method constructor <init>(Lcom/android/server/net/NetworkStatsObservers;Landroid/net/DataUsageRequest;Landroid/os/Messenger;Landroid/os/IBinder;II)V
    ...
    iput-object p1, p0, mStatsObserver:Lcom/android/server/net/NetworkStatsObservers;

    iput-object p2, p0, mRequest:Landroid/net/DataUsageRequest;

    iput-object p3, p0, mMessenger:Landroid/os/Messenger;

    iput-object p4, p0, mBinder:Landroid/os/IBinder;

    iput p5, p0, mCallingUid:I

    iput p6, p0, mAccessLevel:I
...
.method static synthetic access$300(Lcom/android/server/net/NetworkStatsObservers$RequestInfo;)V
    ...
    invoke-direct {p0}, unlinkDeathRecipient()V
...
.method static synthetic access$400(Lcom/android/server/net/NetworkStatsObservers$RequestInfo;I)V
    ...
    invoke-direct {p0, p1}, callCallback(I)V
...
.method static synthetic access$500(Lcom/android/server/net/NetworkStatsObservers$RequestInfo;Lcom/android/server/net/NetworkStatsObservers$StatsContext;)V
    ...
    invoke-direct {p0, p1}, updateStats(Lcom/android/server/net/NetworkStatsObservers$StatsContext;)V
...
.method private callCallback(I)V
    ...
    iget-object v1, p0, mRequest:Landroid/net/DataUsageRequest;
    ...
    iget-object v4, p0, mRequest:Landroid/net/DataUsageRequest;
...
.method private resetRecorder()V
    ...
    iput-object v0, p0, mRecorder:Lcom/android/server/net/NetworkStatsRecorder;

    iget-object v0, p0, mRecorder:Lcom/android/server/net/NetworkStatsRecorder;
...
.method private updateStats(Lcom/android/server/net/NetworkStatsObservers$StatsContext;)V
    ...
    invoke-direct {p0}, resetRecorder()V

    invoke-virtual {p0, p1}, recordSample(Lcom/android/server/net/NetworkStatsObservers$StatsContext;)V
    ...
    invoke-virtual {p0}, checkStats()Z
    ...
    invoke-direct {p0, v0}, callCallback(I)V
...
.method public binderDied()V
    ...
    iget-object v0, p0, mStatsObserver:Lcom/android/server/net/NetworkStatsObservers;
