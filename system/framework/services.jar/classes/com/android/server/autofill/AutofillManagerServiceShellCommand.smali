...
.method public constructor <init>(Lcom/android/server/autofill/AutofillManagerService;)V
    ...
    iput-object p1, p0, mService:Lcom/android/server/autofill/AutofillManagerService;
...
.method private getBindInstantService(Ljava/io/PrintWriter;)I
    ...
    iget-object v0, p0, mService:Lcom/android/server/autofill/AutofillManagerService;
...
.method private getDefaultAugmentedServiceEnabled(Ljava/io/PrintWriter;)I
    ...
    invoke-direct {p0}, getNextIntArgRequired()I

    move-result v0

    iget-object v1, p0, mService:Lcom/android/server/autofill/AutofillManagerService;
...
.method private getFieldClassificationScore(Ljava/io/PrintWriter;)I
    ...
    iget-object v5, p0, mService:Lcom/android/server/autofill/AutofillManagerService;
    ...
    invoke-direct {p0, p1, v4}, waitForLatch(Ljava/io/PrintWriter;Ljava/util/concurrent/CountDownLatch;)I
...
.method private requestDestroy(Ljava/io/PrintWriter;)I
    ...
    invoke-direct {p0, p1}, isNextArgSessions(Ljava/io/PrintWriter;)Z
    ...
    :cond_0
    invoke-direct {p0}, getUserIdFromArgsOrAllUsers()I
    ...
    invoke-direct {p0, p1, v1, v3}, requestSessionCommon(Ljava/io/PrintWriter;Ljava/util/concurrent/CountDownLatch;Ljava/lang/Runnable;)I
...
.method private requestGet(Ljava/io/PrintWriter;)I
    ...
    :pswitch_0
    invoke-direct {p0, p1}, getDefaultAugmentedServiceEnabled(Ljava/io/PrintWriter;)I
    ...
    :pswitch_1
    invoke-direct {p0, p1}, getBindInstantService(Ljava/io/PrintWriter;)I
    ...
    :pswitch_2
    invoke-direct {p0, p1}, getFullScreenMode(Ljava/io/PrintWriter;)I
    ...
    :pswitch_3
    invoke-direct {p0, p1}, getFieldClassificationScore(Ljava/io/PrintWriter;)I
    ...
    :pswitch_4
    invoke-direct {p0, p1}, getMaxVisibileDatasets(Ljava/io/PrintWriter;)I
    ...
    :pswitch_5
    invoke-direct {p0, p1}, getMaxPartitions(Ljava/io/PrintWriter;)I
    ...
    :pswitch_6
    invoke-direct {p0, p1}, getLogLevel(Ljava/io/PrintWriter;)I
...
.method private requestSessionCommon(Ljava/io/PrintWriter;Ljava/util/concurrent/CountDownLatch;Ljava/lang/Runnable;)I
    ...
    invoke-direct {p0, p1, p2}, waitForLatch(Ljava/io/PrintWriter;Ljava/util/concurrent/CountDownLatch;)I
...
.method private requestSet(Ljava/io/PrintWriter;)I
    ...
    :pswitch_0
    invoke-direct {p0, p1}, setDefaultAugmentedServiceEnabled(Ljava/io/PrintWriter;)I
    ...
    :pswitch_1
    invoke-direct {p0, p1}, setTemporaryAugmentedService(Ljava/io/PrintWriter;)I
    ...
    :pswitch_2
    invoke-direct {p0, p1}, setBindInstantService(Ljava/io/PrintWriter;)I
    ...
    :pswitch_3
    invoke-direct {p0, p1}, setFullScreenMode(Ljava/io/PrintWriter;)I
    ...
    :pswitch_4
    invoke-direct {p0}, setMaxVisibileDatasets()I
    ...
    :pswitch_5
    invoke-direct {p0}, setMaxPartitions()I
    ...
    :pswitch_6
    invoke-direct {p0, p1}, setLogLevel(Ljava/io/PrintWriter;)I
...
.method private setDefaultAugmentedServiceEnabled(Ljava/io/PrintWriter;)I
    ...
    iget-object v2, p0, mService:Lcom/android/server/autofill/AutofillManagerService;
...
.method private setTemporaryAugmentedService(Ljava/io/PrintWriter;)I
    ...
    iget-object v3, p0, mService:Lcom/android/server/autofill/AutofillManagerService;
    ...
    iget-object v4, p0, mService:Lcom/android/server/autofill/AutofillManagerService;
...
.method public onCommand(Ljava/lang/String;)I
    ...
    :cond_2
    invoke-direct {p0, v0}, requestSet(Ljava/io/PrintWriter;)I
    ...
    :cond_3
    invoke-direct {p0, v0}, requestGet(Ljava/io/PrintWriter;)I
    ...
    :cond_4
    invoke-direct {p0}, requestReset()I
    ...
    :cond_5
    invoke-direct {p0, v0}, requestDestroy(Ljava/io/PrintWriter;)I
    ...
    :cond_6
    invoke-direct {p0, v0}, requestList(Ljava/io/PrintWriter;)I
