...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/autofill/ui/PendingUi;Ljava/lang/CharSequence;Landroid/graphics/drawable/Drawable;Ljava/lang/String;Landroid/content/ComponentName;Landroid/service/autofill/SaveInfo;Landroid/service/autofill/ValueFinder;Lcom/android/server/autofill/ui/OverlayControl;Lcom/android/server/autofill/ui/SaveUi$OnSaveListener;ZZZ)V
    ...
    iput-object v3, v0, mHandler:Landroid/os/Handler;
    ...
    iput-object v3, v0, mMetricsLogger:Lcom/android/internal/logging/MetricsLogger;
    ...
    :goto_0
    iput v3, v0, mThemeId:I

    move-object/from16 v3, p2

    iput-object v3, v0, mPendingUi:Lcom/android/server/autofill/ui/PendingUi;
    ...
    iput-object v5, v0, mListener:Lcom/android/server/autofill/ui/SaveUi$OneActionThenDestroyListener;

    move-object/from16 v5, p9

    iput-object v5, v0, mOverlayControl:Lcom/android/server/autofill/ui/OverlayControl;

    move-object/from16 v7, p5

    iput-object v7, v0, mServicePackageName:Ljava/lang/String;

    move-object/from16 v8, p6

    iput-object v8, v0, mComponentName:Landroid/content/ComponentName;

    move/from16 v9, p13

    iput-boolean v9, v0, mCompatMode:Z

    new-instance v10, Landroid/view/ContextThemeWrapper;

    iget v11, v0, mThemeId:I
    ...
    iput-object v2, v0, mTitle:Ljava/lang/CharSequence;
    ...
    :goto_5
    iget-object v2, v0, mTitle:Ljava/lang/CharSequence;

    invoke-virtual {v14, v2}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    move-object/from16 v2, p4

    invoke-direct {v0, v10, v12, v2}, setServiceIcon(Landroid/content/Context;Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

    nop

    move-object/from16 v3, p8

    invoke-direct {v0, v10, v12, v3, v1}, applyCustomDescription(Landroid/content/Context;Landroid/view/View;Landroid/service/autofill/ValueFinder;Landroid/service/autofill/SaveInfo;)Z
    ...
    iput-object v2, v0, mSubTitle:Ljava/lang/CharSequence;
    ...
    iget-object v2, v0, mSubTitle:Ljava/lang/CharSequence;

    if-eqz v2, :cond_10

    const/16 v2, 0x46b

    invoke-direct {v0, v2, v13}, writeLog(II)V
    ...
    iget-object v5, v0, mSubTitle:Ljava/lang/CharSequence;
    ...
    iget-object v3, v0, mSubTitle:Ljava/lang/CharSequence;
    ...
    iget v5, v0, mThemeId:I

    invoke-direct {v4, v10, v5}, Landroid/app/Dialog;-><init>(Landroid/content/Context;I)V

    iput-object v4, v0, mDialog:Landroid/app/Dialog;

    iget-object v4, v0, mDialog:Landroid/app/Dialog;
    ...
    invoke-direct/range {p0 .. p0}, show()V
...
.method private applyCustomDescription(Landroid/content/Context;Landroid/view/View;Landroid/service/autofill/ValueFinder;Landroid/service/autofill/SaveInfo;)Z
    ...
    invoke-direct {v1, v0, v6}, writeLog(II)V
...
.method private newLogMaker(I)Landroid/metrics/LogMaker;
    ...
    iget-object v1, p0, mServicePackageName:Ljava/lang/String;

    iget-object v2, p0, mPendingUi:Lcom/android/server/autofill/ui/PendingUi;
...
.method private show()V
    ...
    iget-object v0, p0, mOverlayControl:Lcom/android/server/autofill/ui/OverlayControl;
...
.method private writeLog(II)V
    ...
    invoke-direct {p0, p1, p2}, newLogMaker(II)Landroid/metrics/LogMaker;
...
.method destroy()V
    ...
    iget-object v0, p0, mListener:Lcom/android/server/autofill/ui/SaveUi$OneActionThenDestroyListener;

    invoke-virtual {v0}, Lcom/android/server/autofill/ui/SaveUi$OneActionThenDestroyListener;->onDestroy()V

    iget-object v0, p0, mHandler:Landroid/os/Handler;

    iget-object v1, p0, mListener:Lcom/android/server/autofill/ui/SaveUi$OneActionThenDestroyListener;
    ...
    iget-object v1, p0, mOverlayControl:Lcom/android/server/autofill/ui/OverlayControl;
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    iget-object v0, p0, mPendingUi:Lcom/android/server/autofill/ui/PendingUi;
...
.method public synthetic lambda$applyCustomDescription$3$SaveUi(ILandroid/view/View;Landroid/app/PendingIntent;Landroid/widget/RemoteViews$RemoteResponse;)Z
    ...
    invoke-direct {p0, v1, p1}, newLogMaker(II)Landroid/metrics/LogMaker;

    move-result-object v1

    invoke-static {p3, v0}, isValidLink(Landroid/app/PendingIntent;Landroid/content/Intent;)Z
    ...
    :cond_1
    iget-object v4, p0, mPendingUi:Lcom/android/server/autofill/ui/PendingUi;
    ...
    :try_start_0
    iget-object v6, p0, mPendingUi:Lcom/android/server/autofill/ui/PendingUi;
    ...
    :cond_2
    invoke-virtual {p0}, hide()Lcom/android/server/autofill/ui/PendingUi;
...
.method onPendingUi(ILandroid/os/IBinder;)V
    ...
    invoke-direct {p0, v0}, newLogMaker(I)Landroid/metrics/LogMaker;
    ...
    iget-object v1, p0, mPendingUi:Lcom/android/server/autofill/ui/PendingUi;
