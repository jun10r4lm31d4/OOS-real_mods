...
.method static constructor <clinit>()V
    ...
    sput-object v0, sTempTypedValue:Landroid/util/TypedValue;
...
.method constructor <init>(Landroid/content/Context;Landroid/service/autofill/FillResponse;Landroid/view/autofill/AutofillId;Ljava/lang/String;Lcom/android/server/autofill/ui/OverlayControl;Ljava/lang/CharSequence;Landroid/graphics/drawable/Drawable;ZLcom/android/server/autofill/ui/FillUi$Callback;)V
    ...
    iput-object v0, v1, mTempPoint:Landroid/graphics/Point;
    ...
    iput-object v0, v1, mWindowPresenter:Lcom/android/server/autofill/ui/FillUi$AutofillWindowPresenter;
    ...
    :goto_0
    iput v0, v1, mThemeId:I

    move-object/from16 v7, p9

    iput-object v7, v1, mCallback:Lcom/android/server/autofill/ui/FillUi$Callback;

    invoke-static/range {p1 .. p1}, isFullScreen(Landroid/content/Context;)Z

    move-result v0

    iput-boolean v0, v1, mFullScreen:Z

    new-instance v0, Landroid/view/ContextThemeWrapper;

    iget v8, v1, mThemeId:I
    ...
    iget-boolean v0, v1, mFullScreen:Z
    ...
    :goto_3
    iget-boolean v15, v1, mFullScreen:Z

    if-eqz v15, :cond_7

    iget-object v15, v1, mTempPoint:Landroid/graphics/Point;
    ...
    iput v14, v1, mContentWidth:I

    iget v14, v15, Landroid/graphics/Point;->y:I

    div-int/lit8 v14, v14, 0x2

    iput v14, v1, mContentHeight:I
    ...
    iput v0, v1, mVisibleDatasetsMaxCount:I
    ...
    iget v14, v1, mVisibleDatasetsMaxCount:I
    ...
    iput-object v4, v1, mHeader:Landroid/view/View;

    iput-object v4, v1, mListView:Landroid/widget/ListView;

    iput-object v4, v1, mFooter:Landroid/view/View;

    iput-object v4, v1, mAdapter:Lcom/android/server/autofill/ui/FillUi$ItemsAdapter;
    ...
    iget-boolean v5, v1, mFullScreen:Z

    if-nez v5, :cond_b

    iget-object v5, v1, mTempPoint:Landroid/graphics/Point;

    iget-object v6, v1, mContext:Landroid/content/Context;

    invoke-static {v6, v5}, resolveMaxWindowSize(Landroid/content/Context;Landroid/graphics/Point;)V
    ...
    iput v15, v1, mContentWidth:I

    invoke-virtual {v0}, Landroid/view/View;->getMeasuredHeight()I

    move-result v15

    iput v15, v1, mContentHeight:I
    ...
    iput-object v4, v1, mWindow:Lcom/android/server/autofill/ui/FillUi$AnchoredWindow;

    invoke-virtual/range {p0 .. p0}, requestShowFillUi()V
    ...
    iget v5, v1, mVisibleDatasetsMaxCount:I
    ...
    invoke-direct/range {p0 .. p0}, newClickBlocker()Landroid/widget/RemoteViews$OnClickHandler;
    ...
    iput-object v5, v1, mHeader:Landroid/view/View;
    ...
    :cond_e
    iget-object v7, v1, mHeader:Landroid/view/View;
    ...
    iput-object v7, v1, mFooter:Landroid/view/View;
    ...
    :cond_11
    iget-object v7, v1, mFooter:Landroid/view/View;
    ...
    iput-object v0, v1, mAdapter:Lcom/android/server/autofill/ui/FillUi$ItemsAdapter;
    ...
    iput-object v0, v1, mListView:Landroid/widget/ListView;

    iget-object v0, v1, mListView:Landroid/widget/ListView;

    iget-object v4, v1, mAdapter:Lcom/android/server/autofill/ui/FillUi$ItemsAdapter;
    ...
    iput-object v4, v1, mFilterText:Ljava/lang/String;
    ...
    iput-object v0, v1, mFilterText:Ljava/lang/String;

    :goto_10
    invoke-direct/range {p0 .. p0}, applyNewFilterText()V
    ...
    iput-object v0, v1, mWindow:Lcom/android/server/autofill/ui/FillUi$AnchoredWindow;
...
.method static synthetic access$100(Lcom/android/server/autofill/ui/FillUi;)Lcom/android/server/autofill/ui/FillUi$AnchoredWindow;
    ...
    iget-object v0, p0, mWindow:Lcom/android/server/autofill/ui/FillUi$AnchoredWindow;
...
.method static synthetic access$200(Lcom/android/server/autofill/ui/FillUi;)Lcom/android/server/autofill/ui/FillUi$Callback;
    ...
    iget-object v0, p0, mCallback:Lcom/android/server/autofill/ui/FillUi$Callback;
...
.method static synthetic access$900(Lcom/android/server/autofill/ui/FillUi;)V
    ...
    invoke-direct {p0}, announceSearchResultIfNeeded()V
...
.method private announceSearchResultIfNeeded()V
    ...
    iget-object v0, p0, mAnnounceFilterResult:Lcom/android/server/autofill/ui/FillUi$AnnounceFilterResult;
    ...
    iput-object v0, p0, mAnnounceFilterResult:Lcom/android/server/autofill/ui/FillUi$AnnounceFilterResult;
...
.method private applyNewFilterText()V
    ...
    iget-object v0, p0, mAdapter:Lcom/android/server/autofill/ui/FillUi$ItemsAdapter;

    invoke-virtual {v0}, Lcom/android/server/autofill/ui/FillUi$ItemsAdapter;->getCount()I

    move-result v0

    iget-object v1, p0, mAdapter:Lcom/android/server/autofill/ui/FillUi$ItemsAdapter;

    invoke-virtual {v1}, Lcom/android/server/autofill/ui/FillUi$ItemsAdapter;->getFilter()Landroid/widget/Filter;

    move-result-object v1

    iget-object v2, p0, mFilterText:Ljava/lang/String;
...
.method private static resolveMaxWindowSize(Landroid/content/Context;Landroid/graphics/Point;)V
    ...
    sget-object v0, sTempTypedValue:Landroid/util/TypedValue;
...
.method private updateContentSize()Z
    ...
    invoke-static {v3, v0}, resolveMaxWindowSize(Landroid/content/Context;Landroid/graphics/Point;)V
    ...
    iget-object v4, p0, mAdapter:Lcom/android/server/autofill/ui/FillUi$ItemsAdapter;

    invoke-virtual {v4}, Lcom/android/server/autofill/ui/FillUi$ItemsAdapter;->getCount()I

    move-result v4

    iget-object v5, p0, mHeader:Landroid/view/View;
    ...
    invoke-direct {p0, v5, v0}, updateWidth(Landroid/view/View;Landroid/graphics/Point;)Z
    ...
    invoke-direct {p0, v5, v0}, updateHeight(Landroid/view/View;Landroid/graphics/Point;)Z
    ...
    iget-object v6, p0, mAdapter:Lcom/android/server/autofill/ui/FillUi$ItemsAdapter;
    ...
    invoke-direct {p0, v6, v0}, updateWidth(Landroid/view/View;Landroid/graphics/Point;)Z

    move-result v7

    or-int/2addr v2, v7

    iget v7, p0, mVisibleDatasetsMaxCount:I

    if-ge v5, v7, :cond_6

    invoke-direct {p0, v6, v0}, updateHeight(Landroid/view/View;Landroid/graphics/Point;)Z
    ...
    :cond_7
    iget-object v5, p0, mFooter:Landroid/view/View;
...
.method public dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    iget v0, p0, mVisibleDatasetsMaxCount:I

    invoke-virtual {p1, v0}, Ljava/io/PrintWriter;->println(I)V

    iget-object v0, p0, mHeader:Landroid/view/View;
    ...
    :cond_2
    iget-object v0, p0, mFooter:Landroid/view/View;
    ...
    :cond_4
    iget-object v0, p0, mFilterText:Ljava/lang/String;
    ...
    iget-object v3, p0, mWindow:Lcom/android/server/autofill/ui/FillUi$AnchoredWindow;
...
.method public synthetic lambda$applyNewFilterText$5$FillUi(II)V
    ...
    iget-object v1, p0, mFilterText:Ljava/lang/String;
    ...
    :cond_3
    invoke-direct {p0}, updateContentSize()Z

    move-result v1

    if-eqz v1, :cond_4

    invoke-virtual {p0}, requestShowFillUi()V
    ...
    iget v2, p0, mVisibleDatasetsMaxCount:I
...
.method public synthetic lambda$new$3$FillUi(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    iget-object v1, p0, mCallback:Lcom/android/server/autofill/ui/FillUi$Callback;
...
.method requestShowFillUi()V
    ...
    iget-object v3, p0, mWindowPresenter:Lcom/android/server/autofill/ui/FillUi$AutofillWindowPresenter;
...
.method public setFilterText(Ljava/lang/String;)V
    ...
    :cond_3
    iput-object p1, p0, mFilterText:Ljava/lang/String;

    invoke-direct {p0}, applyNewFilterText()V
