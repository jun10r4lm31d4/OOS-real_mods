...
.method public synthetic constructor <init>(Lcom/android/server/autofill/ui/AutoFillUI;Lcom/android/server/autofill/ui/AutoFillUI$AutoFillUiCallback;Lcom/android/server/autofill/ui/PendingUi;Ljava/lang/CharSequence;Landroid/graphics/drawable/Drawable;Ljava/lang/String;Landroid/content/ComponentName;Landroid/service/autofill/SaveInfo;Landroid/service/autofill/ValueFinder;Landroid/metrics/LogMaker;ZZ)V
    ...
    iput-object p1, p0, f$0:Lcom/android/server/autofill/ui/AutoFillUI;

    iput-object p2, p0, f$1:Lcom/android/server/autofill/ui/AutoFillUI$AutoFillUiCallback;

    iput-object p3, p0, f$2:Lcom/android/server/autofill/ui/PendingUi;

    iput-object p4, p0, f$3:Ljava/lang/CharSequence;

    iput-object p5, p0, f$4:Landroid/graphics/drawable/Drawable;

    iput-object p6, p0, f$5:Ljava/lang/String;

    iput-object p7, p0, f$6:Landroid/content/ComponentName;

    iput-object p8, p0, f$7:Landroid/service/autofill/SaveInfo;

    iput-object p9, p0, f$8:Landroid/service/autofill/ValueFinder;

    iput-object p10, p0, f$9:Landroid/metrics/LogMaker;

    iput-boolean p11, p0, f$10:Z

    iput-boolean p12, p0, f$11:Z
...
.method public final run()V
    ...
    iget-object v0, p0, f$0:Lcom/android/server/autofill/ui/AutoFillUI;

    iget-object v1, p0, f$1:Lcom/android/server/autofill/ui/AutoFillUI$AutoFillUiCallback;

    iget-object v2, p0, f$2:Lcom/android/server/autofill/ui/PendingUi;

    iget-object v3, p0, f$3:Ljava/lang/CharSequence;

    iget-object v4, p0, f$4:Landroid/graphics/drawable/Drawable;

    iget-object v5, p0, f$5:Ljava/lang/String;

    iget-object v6, p0, f$6:Landroid/content/ComponentName;

    iget-object v7, p0, f$7:Landroid/service/autofill/SaveInfo;

    iget-object v8, p0, f$8:Landroid/service/autofill/ValueFinder;

    iget-object v9, p0, f$9:Landroid/metrics/LogMaker;

    iget-boolean v10, p0, f$10:Z

    iget-boolean v11, p0, f$11:Z
