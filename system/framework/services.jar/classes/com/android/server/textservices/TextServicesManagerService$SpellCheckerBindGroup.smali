...
.method public constructor <init>(Lcom/android/server/textservices/TextServicesManagerService;Lcom/android/server/textservices/TextServicesManagerService$InternalServiceConnection;)V
    ...
    iput-object p1, p0, this$0:Lcom/android/server/textservices/TextServicesManagerService;
    ...
    iput-object p1, p0, mPendingSessionRequests:Ljava/util/ArrayList;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, mOnGoingSessionRequests:Ljava/util/ArrayList;

    iput-object p2, p0, mInternalConnection:Lcom/android/server/textservices/TextServicesManagerService$InternalServiceConnection;
    ...
    iput-object p1, p0, mListeners:Lcom/android/server/textservices/TextServicesManagerService$InternalDeathRecipients;
    ...
    iput-object p1, p0, mSpellCheckerBindGroups:Ljava/util/HashMap;
...
.method static synthetic access$100(Lcom/android/server/textservices/TextServicesManagerService$SpellCheckerBindGroup;)Lcom/android/server/textservices/TextServicesManagerService$InternalServiceConnection;
    ...
    iget-object v0, p0, mInternalConnection:Lcom/android/server/textservices/TextServicesManagerService$InternalServiceConnection;
...
.method static synthetic access$200(Lcom/android/server/textservices/TextServicesManagerService$SpellCheckerBindGroup;)Lcom/android/internal/textservice/ISpellCheckerService;
    ...
    iget-object v0, p0, mSpellChecker:Lcom/android/internal/textservice/ISpellCheckerService;
...
.method static synthetic access$300(Lcom/android/server/textservices/TextServicesManagerService$SpellCheckerBindGroup;)Z
    ...
    iget-boolean v0, p0, mUnbindCalled:Z
...
.method static synthetic access$500(Lcom/android/server/textservices/TextServicesManagerService$SpellCheckerBindGroup;)Ljava/util/ArrayList;
    ...
    iget-object v0, p0, mPendingSessionRequests:Ljava/util/ArrayList;
...
.method static synthetic access$600(Lcom/android/server/textservices/TextServicesManagerService$SpellCheckerBindGroup;)Ljava/util/ArrayList;
    ...
    iget-object v0, p0, mOnGoingSessionRequests:Ljava/util/ArrayList;
...
.method static synthetic access$700(Lcom/android/server/textservices/TextServicesManagerService$SpellCheckerBindGroup;)Lcom/android/server/textservices/TextServicesManagerService$InternalDeathRecipients;
    ...
    iget-object v0, p0, mListeners:Lcom/android/server/textservices/TextServicesManagerService$InternalDeathRecipients;
...
.method private cleanLocked()V
    ...
    iget-object v1, p0, mSpellCheckerBindGroups:Ljava/util/HashMap;
    ...
    :cond_4
    iget-object v2, p0, this$0:Lcom/android/server/textservices/TextServicesManagerService;
    ...
    iget-object v3, p0, mInternalConnection:Lcom/android/server/textservices/TextServicesManagerService$InternalServiceConnection;

    invoke-virtual {v2, v3}, Landroid/content/Context;->unbindService(Landroid/content/ServiceConnection;)V

    const/4 v2, 0x1

    iput-boolean v2, p0, mUnbindCalled:Z
...
.method public getISpellCheckerSessionOrQueueLocked(Lcom/android/server/textservices/TextServicesManagerService$SessionRequest;)V
    ...
    invoke-virtual {p0}, removeAllLocked()V
...
.method public onServiceConnectedLocked(Lcom/android/internal/textservice/ISpellCheckerService;)V
    ...
    iget-object v2, p0, mPendingSessionRequests:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, mSpellChecker:Lcom/android/internal/textservice/ISpellCheckerService;
    ...
    iget-object v3, p0, mOnGoingSessionRequests:Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object v1, p0, mPendingSessionRequests:Ljava/util/ArrayList;
...
.method public onServiceDisconnectedLocked()V
    ...
    iput-object v0, p0, mSpellChecker:Lcom/android/internal/textservice/ISpellCheckerService;
...
.method onSessionCreated(Lcom/android/internal/textservice/ISpellCheckerSession;Lcom/android/server/textservices/TextServicesManagerService$SessionRequest;)V
    ...
    iget-object v0, p0, this$0:Lcom/android/server/textservices/TextServicesManagerService;
    ...
    :try_start_0
    iget-boolean v1, p0, mUnbindCalled:Z
    ...
    :cond_0
    iget-object v1, p0, mOnGoingSessionRequests:Ljava/util/ArrayList;
...
.method public removeAllLocked()V
    ...
    iget-object v2, p0, mListeners:Lcom/android/server/textservices/TextServicesManagerService$InternalDeathRecipients;
...
.method public removeListener(Lcom/android/internal/textservice/ISpellCheckerSessionListener;)V
    ...
    :try_start_0
    iget-object v1, p0, mListeners:Lcom/android/server/textservices/TextServicesManagerService$InternalDeathRecipients;
    ...
    iget-object v3, p0, mPendingSessionRequests:Ljava/util/ArrayList;
