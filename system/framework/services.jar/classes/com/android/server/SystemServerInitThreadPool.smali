...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, IS_DEBUGGABLE:Z
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mService:Ljava/util/concurrent/ExecutorService;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mPendingTasks:Ljava/util/List;
...
.method public static declared-synchronized get()Lcom/android/server/SystemServerInitThreadPool;
    ...
    :try_start_0
    sget-object v1, sInstance:Lcom/android/server/SystemServerInitThreadPool;
    ...
    sput-object v1, sInstance:Lcom/android/server/SystemServerInitThreadPool;

    :cond_0
    sget-object v1, sInstance:Lcom/android/server/SystemServerInitThreadPool;

    iget-object v1, v1, mService:Ljava/util/concurrent/ExecutorService;
...
.method static declared-synchronized shutdown()V
    ...
    :try_start_2
    invoke-static {}, dumpStackTraces()V

    :cond_0
    sget-object v2, sInstance:Lcom/android/server/SystemServerInitThreadPool;

    iget-object v2, v2, mService:Ljava/util/concurrent/ExecutorService;
    ...
    sget-object v3, sInstance:Lcom/android/server/SystemServerInitThreadPool;

    const/4 v4, 0x0

    iput-object v4, v3, mService:Ljava/util/concurrent/ExecutorService;

    sget-object v3, sInstance:Lcom/android/server/SystemServerInitThreadPool;

    iput-object v4, v3, mPendingTasks:Ljava/util/List;
    ...
    sget-object v4, sInstance:Lcom/android/server/SystemServerInitThreadPool;

    iget-object v4, v4, mPendingTasks:Ljava/util/List;
    ...
    :try_start_3
    sget-object v5, sInstance:Lcom/android/server/SystemServerInitThreadPool;

    iget-object v5, v5, mPendingTasks:Ljava/util/List;
...
.method public synthetic lambda$submit$0$SystemServerInitThreadPool(Ljava/lang/String;Ljava/lang/Runnable;)V
    ...
    sget-boolean v0, IS_DEBUGGABLE:Z
    ...
    iget-object v0, p0, mPendingTasks:Ljava/util/List;

    monitor-enter v0

    :try_start_1
    iget-object v1, p0, mPendingTasks:Ljava/util/List;
...
.method public submit(Ljava/lang/Runnable;Ljava/lang/String;)Ljava/util/concurrent/Future;
    ...
    iget-object v0, p0, mService:Ljava/util/concurrent/ExecutorService;
