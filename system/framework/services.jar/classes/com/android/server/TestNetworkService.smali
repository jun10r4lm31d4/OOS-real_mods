...
.method static constructor <clinit>()V
    ...
    sput-object v0, sTestTunIndex:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method protected constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;)V
    ...
    iput-object v0, p0, mTestNetworkTracker:Landroid/util/SparseArray;
    ...
    iput-object v0, p0, mNMS:Landroid/os/INetworkManagementService;
    ...
    iput-object v0, p0, mNetd:Landroid/net/INetd;
...
.method static synthetic access$000(Lcom/android/server/TestNetworkService;)Landroid/util/SparseArray;
    ...
    iget-object v0, p0, mTestNetworkTracker:Landroid/util/SparseArray;
...
.method private createInterface(Z[Landroid/net/LinkAddress;)Landroid/net/TestNetworkInterface;
    ...
    invoke-static {v0}, enforceTestNetworkPermissions(Landroid/content/Context;)V
    ...
    sget-object v2, sTestTunIndex:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public createTapInterface()Landroid/net/TestNetworkInterface;
    ...
    invoke-direct {p0, v0, v1}, createInterface(Z[Landroid/net/LinkAddress;)Landroid/net/TestNetworkInterface;
...
.method public createTunInterface([Landroid/net/LinkAddress;)Landroid/net/TestNetworkInterface;
    ...
    invoke-direct {p0, v0, p1}, createInterface(Z[Landroid/net/LinkAddress;)Landroid/net/TestNetworkInterface;
...
.method public synthetic lambda$createInterface$0$TestNetworkService(ZLjava/lang/String;[Landroid/net/LinkAddress;)Landroid/net/TestNetworkInterface;
    ...
    :try_start_0
    invoke-static {p1, p2}, jniCreateTunTap(ZLjava/lang/String;)I
    ...
    iget-object v4, p0, mNetd:Landroid/net/INetd;
...
.method public synthetic lambda$setupTestNetwork$1$TestNetworkService(Ljava/lang/String;ILandroid/os/IBinder;)V
    ...
    invoke-direct/range {v2 .. v7}, registerTestNetworkAgent(Landroid/os/Looper;Landroid/content/Context;Ljava/lang/String;ILandroid/os/IBinder;)Lcom/android/server/TestNetworkService$TestNetworkAgent;

    move-result-object v1

    iget-object v2, p0, mTestNetworkTracker:Landroid/util/SparseArray;
...
.method public teardownTestNetwork(I)V
    ...
    :try_start_0
    iget-object v1, p0, mTestNetworkTracker:Landroid/util/SparseArray;
