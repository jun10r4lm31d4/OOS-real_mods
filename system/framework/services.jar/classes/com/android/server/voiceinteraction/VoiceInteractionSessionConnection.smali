...
.method public constructor <init>(Ljava/lang/Object;Landroid/content/ComponentName;ILandroid/content/Context;Lcom/android/server/voiceinteraction/VoiceInteractionSessionConnection$Callback;ILandroid/os/Handler;)V
    ...
    iput-object v0, v9, mToken:Landroid/os/IBinder;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, v9, mPendingShowCallbacks:Ljava/util/ArrayList;
    ...
    iput-object v0, v9, mShowCallback:Lcom/android/internal/app/IVoiceInteractionSessionShowCallback;
    ...
    iput-object v0, v9, mFullConnection:Landroid/content/ServiceConnection;
    ...
    iput-object v0, v9, mShowAssistDisclosureRunnable:Ljava/lang/Runnable;

    move-object/from16 v11, p1

    iput-object v11, v9, mLock:Ljava/lang/Object;

    move-object/from16 v12, p2

    iput-object v12, v9, mSessionComponentName:Landroid/content/ComponentName;

    move/from16 v13, p3

    iput v13, v9, mUser:I

    iput-object v10, v9, mContext:Landroid/content/Context;

    move-object/from16 v14, p5

    iput-object v14, v9, mCallback:Lcom/android/server/voiceinteraction/VoiceInteractionSessionConnection$Callback;

    move/from16 v15, p6

    iput v15, v9, mCallingUid:I

    move-object/from16 v8, p7

    iput-object v8, v9, mHandler:Landroid/os/Handler;

    invoke-static {}, Landroid/app/ActivityManager;->getService()Landroid/app/IActivityManager;

    move-result-object v0

    iput-object v0, v9, mAm:Landroid/app/IActivityManager;
    ...
    iput-object v0, v9, mUgmInternal:Lcom/android/server/uri/UriGrantsManagerInternal;
    ...
    iput-object v0, v9, mIWindowManager:Landroid/view/IWindowManager;
    ...
    iput-object v0, v9, mAppOps:Landroid/app/AppOpsManager;

    new-instance v0, Lcom/android/server/am/AssistDataRequester;

    iget-object v2, v9, mContext:Landroid/content/Context;

    iget-object v3, v9, mIWindowManager:Landroid/view/IWindowManager;
    ...
    iget-object v6, v9, mLock:Ljava/lang/Object;
    ...
    iput-object v0, v9, mAssistDataRequester:Lcom/android/server/am/AssistDataRequester;

    iget-object v0, v9, mUgmInternal:Lcom/android/server/uri/UriGrantsManagerInternal;
    ...
    iput-object v1, v9, mPermissionOwner:Landroid/os/IBinder;
    ...
    iput-object v0, v9, mBindIntent:Landroid/content/Intent;

    iget-object v0, v9, mBindIntent:Landroid/content/Intent;

    iget-object v2, v9, mSessionComponentName:Landroid/content/ComponentName;

    invoke-virtual {v0, v2}, Landroid/content/Intent;->setComponent(Landroid/content/ComponentName;)Landroid/content/Intent;

    iget-object v0, v9, mContext:Landroid/content/Context;

    iget-object v2, v9, mBindIntent:Landroid/content/Intent;
    ...
    iput-boolean v0, v9, mBound:Z

    iget-boolean v0, v9, mBound:Z
    ...
    :try_start_0
    iget-object v0, v9, mIWindowManager:Landroid/view/IWindowManager;

    iget-object v3, v9, mToken:Landroid/os/IBinder;
    ...
    iget-object v3, v9, mSessionComponentName:Landroid/content/ComponentName;
...
.method private notifyPendingShowCallbacksFailedLocked()V
    ...
    :cond_0
    iget-object v0, p0, mPendingShowCallbacks:Ljava/util/ArrayList;
...
.method public cancelLocked(Z)V
    ...
    iget-object v3, p0, mSession:Landroid/service/voice/IVoiceInteractionSession;
    ...
    :cond_2
    iget-boolean v0, p0, mFullyBound:Z
    ...
    iput-boolean v1, p0, mFullyBound:Z
...
.method public deliverNewSessionLocked(Landroid/service/voice/IVoiceInteractionSession;Lcom/android/internal/app/IVoiceInteractor;)Z
    ...
    :goto_0
    iget-object v0, p0, mAssistDataRequester:Lcom/android/server/am/AssistDataRequester;
...
.method grantClipDataItemPermission(Landroid/content/ClipData$Item;IIILjava/lang/String;)V
    ...
    invoke-virtual/range {v1 .. v6}, grantUriPermission(Landroid/net/Uri;IIILjava/lang/String;)V
    ...
    invoke-virtual/range {v2 .. v7}, grantUriPermission(Landroid/net/Uri;IIILjava/lang/String;)V
...
.method grantClipDataPermissions(Landroid/content/ClipData;IIILjava/lang/String;)V
    ...
    invoke-virtual/range {v2 .. v7}, grantClipDataItemPermission(Landroid/content/ClipData$Item;IIILjava/lang/String;)V
...
.method grantUriPermission(Landroid/net/Uri;IIILjava/lang/String;)V
    ...
    :try_start_0
    iget-object v5, v1, mUgmInternal:Lcom/android/server/uri/UriGrantsManagerInternal;
    ...
    iget-object v6, v1, mPermissionOwner:Landroid/os/IBinder;
...
.method public hideLocked()Z
    ...
    iput v1, p0, mShowFlags:I

    iget-object v2, p0, mAssistDataRequester:Lcom/android/server/am/AssistDataRequester;

    invoke-virtual {v2}, Lcom/android/server/am/AssistDataRequester;->cancel()V

    iget-object v2, p0, mPendingShowCallbacks:Ljava/util/ArrayList;
...
.method public onAssistDataReceivedLocked(Landroid/os/Bundle;II)V
    ...
    iget-object v9, v7, mSession:Landroid/service/voice/IVoiceInteractionSession;
    ...
    iget v5, v7, mCallingUid:I

    iget-object v1, v7, mSessionComponentName:Landroid/content/ComponentName;
    ...
    invoke-virtual/range {v1 .. v6}, grantClipDataPermissions(Landroid/content/ClipData;IIILjava/lang/String;)V
...
.method public onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    iget-object v3, p0, mShowArgs:Landroid/os/Bundle;

    iget v4, p0, mShowFlags:I
...
.method public showLocked(Landroid/os/Bundle;IILcom/android/internal/app/IVoiceInteractionSessionShowCallback;Ljava/util/List;)Z
    ...
    iget-object v3, p0, mFullConnection:Landroid/content/ServiceConnection;
    ...
    iget-object v4, p0, mShowAssistDisclosureRunnable:Ljava/lang/Runnable;
    ...
    iput-object v3, p0, mShowArgs:Landroid/os/Bundle;
    ...
    :goto_6
    iget-object v1, p0, mAssistDataRequester:Lcom/android/server/am/AssistDataRequester;
    ...
    :cond_9
    :goto_7
    iget-object v1, p0, mCallback:Lcom/android/server/voiceinteraction/VoiceInteractionSessionConnection$Callback;
