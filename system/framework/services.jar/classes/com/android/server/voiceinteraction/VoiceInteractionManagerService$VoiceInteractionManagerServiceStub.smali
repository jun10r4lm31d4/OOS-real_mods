...
.method constructor <init>(Lcom/android/server/voiceinteraction/VoiceInteractionManagerService;)V
    ...
    invoke-direct {p0, v0}, shouldEnableService(Landroid/content/Context;)Z
...
.method static synthetic access$200(Lcom/android/server/voiceinteraction/VoiceInteractionManagerService$VoiceInteractionManagerServiceStub;)V
    ...
    invoke-direct {p0}, unloadAllKeyphraseModels()V
...
.method static synthetic access$300(Lcom/android/server/voiceinteraction/VoiceInteractionManagerService$VoiceInteractionManagerServiceStub;Lcom/android/server/voiceinteraction/VoiceInteractionManagerServiceImpl;)V
    ...
    invoke-direct {p0, p1}, setImplLocked(Lcom/android/server/voiceinteraction/VoiceInteractionManagerServiceImpl;)V
...
.method private enforceIsCurrentVoiceInteractionService(Landroid/service/voice/IVoiceInteractionService;)V
    ...
    iget-object v1, p0, mImpl:Lcom/android/server/voiceinteraction/VoiceInteractionManagerServiceImpl;
...
.method private setImplLocked(Lcom/android/server/voiceinteraction/VoiceInteractionManagerServiceImpl;)V
    ...
    iput-object p1, p0, mImpl:Lcom/android/server/voiceinteraction/VoiceInteractionManagerServiceImpl;
...
.method private shouldEnableService(Landroid/content/Context;)Z
    ...
    invoke-direct {p0, v0}, getForceVoiceInteractionServicePackage(Landroid/content/res/Resources;)Ljava/lang/String;
...
.method private declared-synchronized unloadAllKeyphraseModels()V
    ...
    iget-object v6, p0, this$0:Lcom/android/server/voiceinteraction/VoiceInteractionManagerService;
...
.method public deleteKeyphraseSoundModel(ILjava/lang/String;)I
    ...
    :cond_0
    iget-object v5, p0, this$0:Lcom/android/server/voiceinteraction/VoiceInteractionManagerService;
    ...
    :try_start_1
    iget-object v6, p0, mImpl:Lcom/android/server/voiceinteraction/VoiceInteractionManagerServiceImpl;
...
.method public getDspModuleProperties(Landroid/service/voice/IVoiceInteractionService;)Landroid/hardware/soundtrigger/SoundTrigger$ModuleProperties;
    ...
    :try_start_0
    invoke-direct {p0, p1}, enforceIsCurrentVoiceInteractionService(Landroid/service/voice/IVoiceInteractionService;)V
...
.method public initForUser(I)V
    ...
    iget-boolean v3, p0, mEnableService:Z
    ...
    invoke-virtual {p0, p1, v3}, findAvailInteractor(ILjava/lang/String;)Landroid/service/voice/VoiceInteractionServiceInfo;
    ...
    invoke-direct {p0, v3}, getForceVoiceInteractionServicePackage(Landroid/content/res/Resources;)Ljava/lang/String;
    ...
    :cond_1
    iget-boolean v4, p0, mEnableService:Z
    ...
    invoke-virtual {p0, v5, p1}, setCurInteractor(Landroid/content/ComponentName;I)V
    ...
    invoke-virtual {p0, p1, v5}, findAvailInteractor(ILjava/lang/String;)Landroid/service/voice/VoiceInteractionServiceInfo;
    ...
    invoke-virtual {p0, v4, p1}, setCurInteractor(Landroid/content/ComponentName;I)V
    ...
    invoke-virtual {p0, v4, p1}, setCurRecognizer(Landroid/content/ComponentName;I)V

    return-void

    :cond_8
    invoke-virtual {p0, v2, p1}, initSimpleRecognizer(Landroid/service/voice/VoiceInteractionServiceInfo;I)V
...
.method public initSimpleRecognizer(Landroid/service/voice/VoiceInteractionServiceInfo;I)V
    ...
    invoke-virtual {p0, v0, p2}, findAvailRecognizer(Ljava/lang/String;I)Landroid/content/ComponentName;
    ...
    invoke-virtual {p0, v0, p2}, setCurInteractor(Landroid/content/ComponentName;I)V

    :cond_0
    invoke-virtual {p0, v1, p2}, setCurRecognizer(Landroid/content/ComponentName;I)V
...
.method public synthetic lambda$switchUser$0$VoiceInteractionManagerService$VoiceInteractionManagerServiceStub(I)V
    ...
    iput-boolean v0, p0, mCurUserUnlocked:Z
...
.method public performDirectAction(Landroid/os/IBinder;Ljava/lang/String;Landroid/os/Bundle;ILandroid/os/IBinder;Landroid/os/RemoteCallback;Landroid/os/RemoteCallback;)V
    ...
    :try_start_0
    iget-object v0, v1, mImpl:Lcom/android/server/voiceinteraction/VoiceInteractionManagerServiceImpl;
    ...
    :try_start_2
    iget-object v2, v1, mImpl:Lcom/android/server/voiceinteraction/VoiceInteractionManagerServiceImpl;
...
.method switchImplementationIfNeeded(Z)V
    ...
    :try_start_0
    invoke-virtual {p0, p1}, switchImplementationIfNeededLocked(Z)V
...
.method switchImplementationIfNeededLocked(Z)V
    ...
    invoke-direct {p0, v4}, setImplLocked(Lcom/android/server/voiceinteraction/VoiceInteractionManagerServiceImpl;)V
    ...
    :cond_6
    invoke-direct {p0, v6}, setImplLocked(Lcom/android/server/voiceinteraction/VoiceInteractionManagerServiceImpl;)V
