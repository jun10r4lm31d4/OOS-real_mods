...
.method static constructor <clinit>()V
    ...
    sput-object v0, sAllInstances:Ljava/util/List;
...
.method constructor <init>()V
    ...
    iput-object v0, p0, mNotification:Landroid/hidl/manager/V1_0/IServiceNotification;
    ...
    iput-object v0, p0, mLastService:Ljava/util/concurrent/atomic/AtomicReference;
...
.method static synthetic access$2400(Lcom/android/server/BatteryService$HealthServiceWrapper;)Ljava/lang/String;
    ...
    iget-object v0, p0, mInstanceName:Ljava/lang/String;
...
.method static synthetic access$2500(Lcom/android/server/BatteryService$HealthServiceWrapper;)Lcom/android/server/BatteryService$HealthServiceWrapper$IHealthSupplier;
    ...
    iget-object v0, p0, mHealthSupplier:Lcom/android/server/BatteryService$HealthServiceWrapper$IHealthSupplier;
...
.method static synthetic access$2600(Lcom/android/server/BatteryService$HealthServiceWrapper;)Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object v0, p0, mLastService:Ljava/util/concurrent/atomic/AtomicReference;
...
.method static synthetic access$2700(Lcom/android/server/BatteryService$HealthServiceWrapper;)Lcom/android/server/BatteryService$HealthServiceWrapper$Callback;
    ...
    iget-object v0, p0, mCallback:Lcom/android/server/BatteryService$HealthServiceWrapper$Callback;
...
.method init(Lcom/android/server/BatteryService$HealthServiceWrapper$Callback;Lcom/android/server/BatteryService$HealthServiceWrapper$IServiceManagerSupplier;Lcom/android/server/BatteryService$HealthServiceWrapper$IHealthSupplier;)V
    ...
    iput-object p1, p0, mCallback:Lcom/android/server/BatteryService$HealthServiceWrapper$Callback;

    iput-object p3, p0, mHealthSupplier:Lcom/android/server/BatteryService$HealthServiceWrapper$IHealthSupplier;

    const/4 v0, 0x0

    sget-object v1, sAllInstances:Ljava/util/List;
    ...
    iput-object v2, p0, mInstanceName:Ljava/lang/String;

    iget-object v1, p0, mLastService:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    :cond_1
    :goto_3
    iget-object v1, p0, mInstanceName:Ljava/lang/String;

    if-eqz v1, :cond_2

    if-eqz v0, :cond_2

    iget-object v2, p0, mCallback:Lcom/android/server/BatteryService$HealthServiceWrapper$Callback;
    ...
    iget-object v3, p0, mInstanceName:Ljava/lang/String;

    iget-object v4, p0, mNotification:Landroid/hidl/manager/V1_0/IServiceNotification;
    ...
    iget-object v2, p0, mInstanceName:Ljava/lang/String;
    ...
    sget-object v4, sAllInstances:Ljava/util/List;
