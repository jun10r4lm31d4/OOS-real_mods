...
.method private getGsiService()Landroid/gsi/IGsiService;
    ...
    :try_start_0
    iget-object v1, p0, mGsiService:Landroid/gsi/IGsiService;

    if-nez v1, :cond_1

    invoke-static {p0}, connect(Landroid/os/IBinder$DeathRecipient;)Landroid/gsi/IGsiService;

    move-result-object v1

    iput-object v1, p0, mGsiService:Landroid/gsi/IGsiService;
...
.method public abort()Z
    ...
    invoke-direct {p0}, getGsiService()Landroid/gsi/IGsiService;
...
.method public binderDied()V
    ...
    :try_start_0
    iput-object v0, p0, mGsiService:Landroid/gsi/IGsiService;
