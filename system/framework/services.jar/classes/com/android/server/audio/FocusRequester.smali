...
.method constructor <init>(Landroid/media/AudioAttributes;IILandroid/media/IAudioFocusDispatcher;Landroid/os/IBinder;Ljava/lang/String;Lcom/android/server/audio/MediaFocusControl$AudioFocusDeathHandler;Ljava/lang/String;ILcom/android/server/audio/MediaFocusControl;I)V
    ...
    iput v0, p0, mFocusLossReceived:I

    const/4 v0, 0x1

    iput-boolean v0, p0, mFocusLossWasNotified:Z

    iput-object p10, p0, mFocusController:Lcom/android/server/audio/MediaFocusControl;

    iput p11, p0, mSdkTarget:I
...
.method constructor <init>(Landroid/media/AudioFocusInfo;Landroid/media/IAudioFocusDispatcher;Landroid/os/IBinder;Lcom/android/server/audio/MediaFocusControl$AudioFocusDeathHandler;Lcom/android/server/audio/MediaFocusControl;)V
    ...
    iput-object v0, p0, mClientId:Ljava/lang/String;
    ...
    iput v0, p0, mFocusGainRequest:I
    ...
    iput v0, p0, mGrantFlags:I

    invoke-virtual {p1}, Landroid/media/AudioFocusInfo;->getSdkTarget()I

    move-result v0

    iput v0, p0, mSdkTarget:I

    iput-object p2, p0, mFocusDispatcher:Landroid/media/IAudioFocusDispatcher;

    iput-object p3, p0, mSourceRef:Landroid/os/IBinder;

    iput-object p4, p0, mDeathHandler:Lcom/android/server/audio/MediaFocusControl$AudioFocusDeathHandler;

    iput-object p5, p0, mFocusController:Lcom/android/server/audio/MediaFocusControl;
...
.method dispatchFocusChange(I)I
    ...
    iget-object v0, p0, mFocusDispatcher:Landroid/media/IAudioFocusDispatcher;
    ...
    iget-object v4, p0, mClientId:Ljava/lang/String;
...
.method dump(Ljava/io/PrintWriter;)V
    ...
    iget-boolean v1, p0, mFocusLossWasNotified:Z
...
.method handleFocusGain(I)V
    ...
    iget-boolean v2, p0, mFocusLossWasNotified:Z
    ...
    iget-object v5, p0, mClientId:Ljava/lang/String;
    ...
    iget-object v0, p0, mFocusController:Lcom/android/server/audio/MediaFocusControl;
...
.method handleFocusLoss(ILcom/android/server/audio/FocusRequester;Z)V
    ...
    iput-boolean v1, p0, mFocusLossWasNotified:Z

    iget-object v2, p0, mFocusController:Lcom/android/server/audio/MediaFocusControl;
    ...
    invoke-virtual {p0}, getSdkTarget()I
    ...
    :cond_2
    iget-object v3, p0, mFocusController:Lcom/android/server/audio/MediaFocusControl;
    ...
    :cond_4
    iget-object v3, p0, mFocusDispatcher:Landroid/media/IAudioFocusDispatcher;

    if-eqz v3, :cond_5

    iget-object v4, p0, mFocusController:Lcom/android/server/audio/MediaFocusControl;
    ...
    iput-boolean v6, p0, mFocusLossWasNotified:Z

    iget v4, p0, mFocusLossReceived:I
...
.method handleFocusLossFromGain(ILcom/android/server/audio/FocusRequester;Z)Z
    ...
    invoke-virtual {p0, v0, p2, p3}, handleFocusLoss(ILcom/android/server/audio/FocusRequester;Z)V
...
.method release()V
    ...
    iput-object v2, p0, mDeathHandler:Lcom/android/server/audio/MediaFocusControl$AudioFocusDeathHandler;

    iput-object v2, p0, mFocusDispatcher:Landroid/media/IAudioFocusDispatcher;
...
.method toAudioFocusInfo()Landroid/media/AudioFocusInfo;
    ...
    iget v5, p0, mFocusGainRequest:I

    iget v6, p0, mFocusLossReceived:I

    iget v7, p0, mGrantFlags:I

    iget v8, p0, mSdkTarget:I
