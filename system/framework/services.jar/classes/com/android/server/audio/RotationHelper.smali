...
.method static disable()V
    ...
    sget-object v1, sDisplayListener:Lcom/android/server/audio/RotationHelper$AudioDisplayListener;
...
.method static init(Landroid/content/Context;Landroid/os/Handler;)V
    ...
    sput-object v0, sDisplayListener:Lcom/android/server/audio/RotationHelper$AudioDisplayListener;

    invoke-static {}, enable()V
...
.method static updateOrientation()V
    ...
    sget-object v1, sRotationLock:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    sget v2, sDeviceRotation:I
    ...
    invoke-static {v2}, publishRotation(I)V
