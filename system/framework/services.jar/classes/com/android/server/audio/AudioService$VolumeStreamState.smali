...
.method private constructor <init>(Lcom/android/server/audio/AudioService;Ljava/lang/String;I)V
    ...
    iput-object p1, p0, mIndexMap:Landroid/util/SparseIntArray;
    ...
    iput-object p1, p0, mVolumeChanged:Landroid/content/Intent;

    iget-object p1, p0, mVolumeChanged:Landroid/content/Intent;
    ...
    iput-object p1, p0, mStreamDevicesChanged:Landroid/content/Intent;

    iget-object p1, p0, mStreamDevicesChanged:Landroid/content/Intent;
...
.method static synthetic access$1402(Lcom/android/server/audio/AudioService$VolumeStreamState;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object p1, p0, mVolumeIndexSettingName:Ljava/lang/String;
...
.method static synthetic access$2300(Lcom/android/server/audio/AudioService$VolumeStreamState;)Landroid/content/Intent;
    ...
    iget-object v0, p0, mVolumeChanged:Landroid/content/Intent;
...
.method static synthetic access$4600(Lcom/android/server/audio/AudioService$VolumeStreamState;)Z
    ...
    invoke-direct {p0}, hasValidSettingsName()Z
...
.method public applyAllVolumes()V
    ...
    invoke-virtual {p0, v3}, getIndex(I)I
    ...
    invoke-direct {p0, v4}, getAbsoluteVolumeIndex(I)I
    ...
    :goto_1
    invoke-direct {p0, v4, v3}, setStreamVolumeIndex(II)V
    ...
    :goto_2
    invoke-direct {p0, v2, v4}, setStreamVolumeIndex(II)V
...
.method applyDeviceVolume_syncVSS(IZ)V
    ...
    invoke-direct {p0, v0}, getAbsoluteVolumeIndex(I)I
    ...
    :cond_4
    invoke-direct {p0, v0, p1}, setStreamVolumeIndex(II)V
...
.method public checkFixedVolumeDevices()V
    ...
    :cond_1
    invoke-virtual {p0, v3, v0}, applyDeviceVolume_syncVSS(IZ)V
...
.method public getIndex(I)I
    ...
    iget-object v2, p0, mIndexMap:Landroid/util/SparseIntArray;
...
.method public getSettingNameForDevice(I)Ljava/lang/String;
    ...
    iget-object v1, p0, mVolumeIndexSettingName:Ljava/lang/String;
    ...
    iget-object v2, p0, mVolumeIndexSettingName:Ljava/lang/String;
...
.method public observeDevicesForStream_syncVSS(Z)I
    ...
    iget-object v3, p0, mStreamDevicesChanged:Landroid/content/Intent;
...
.method public readSettings()V
    ...
    :cond_4
    invoke-virtual {p0, v5}, getSettingNameForDevice(I)Ljava/lang/String;
...
.method public setAllIndexes(Lcom/android/server/audio/AudioService$VolumeStreamState;Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v1}, getIndex(I)I
    ...
    :cond_1
    iget-object v2, p1, mIndexMap:Landroid/util/SparseIntArray;
    ...
    invoke-virtual {p0, v1, v4, p2}, setIndex(IILjava/lang/String;)Z
...
.method public setIndex(IILjava/lang/String;)Z
    ...
    :cond_0
    iget v5, v1, mStreamType:I

    if-ne v5, v8, :cond_1

    if-ne v3, v9, :cond_1

    iget-object v5, v1, this$0:Lcom/android/server/audio/AudioService;
    ...
    iget-object v10, v1, this$0:Lcom/android/server/audio/AudioService;
    ...
    iget-object v8, v1, this$0:Lcom/android/server/audio/AudioService;
    ...
    :try_start_1
    invoke-virtual {v1, v3}, getIndex(I)I

    move-result v10

    invoke-direct/range {p0 .. p1}, getValidIndex(I)I
    ...
    :try_start_2
    iget v11, v1, mStreamType:I

    const/4 v12, 0x7

    if-ne v11, v12, :cond_6

    iget-object v11, v1, this$0:Lcom/android/server/audio/AudioService;
    ...
    iget v11, v1, mIndexMax:I

    move v2, v11

    :cond_6
    iget-object v11, v1, mIndexMap:Landroid/util/SparseIntArray;
    ...
    :goto_0
    iget-object v12, v1, this$0:Lcom/android/server/audio/AudioService;

    iget v13, v1, mStreamType:I
    ...
    iget-object v15, v1, this$0:Lcom/android/server/audio/AudioService;
    ...
    iget v0, v1, mStreamType:I

    if-ne v6, v0, :cond_a

    if-nez v11, :cond_9

    invoke-virtual {v15, v3}, hasIndexForDevice(I)Z
    ...
    :cond_9
    iget-object v0, v1, this$0:Lcom/android/server/audio/AudioService;
    ...
    invoke-virtual {v15, v0, v3, v4}, setIndex(IILjava/lang/String;)Z

    if-eqz v12, :cond_a

    iget-object v6, v1, this$0:Lcom/android/server/audio/AudioService;

    invoke-virtual {v6, v14}, Lcom/android/server/audio/AudioService;->getDeviceForStream(I)I

    move-result v6

    invoke-virtual {v15, v0, v6, v4}, setIndex(IILjava/lang/String;)Z
    ...
    :goto_3
    iget-object v6, v1, mIndexMap:Landroid/util/SparseIntArray;
    ...
    iget-object v14, v1, mIndexMap:Landroid/util/SparseIntArray;
    ...
    :cond_12
    iget-object v0, v1, mVolumeChanged:Landroid/content/Intent;
    ...
    iget-object v5, v1, mVolumeChanged:Landroid/content/Intent;
