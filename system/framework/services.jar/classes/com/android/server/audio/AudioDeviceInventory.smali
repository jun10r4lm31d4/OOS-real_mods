...
.method static constructor <clinit>()V
    ...
    sput-object v0, autoPlayBlackListedAddr:[Ljava/lang/String;

    const/4 v0, 0x0

    sput-object v0, prevDisconnectedDeviceAddress:Ljava/lang/String;
...
.method constructor <init>(Lcom/android/server/audio/AudioDeviceBroker;)V
    ...
    iput-boolean v0, p0, mPostA2dpDeviceConfigChange:Z

    const v0, 0xc027f8c

    iput v0, p0, mBecomingNoisyIntentDevices:I

    iput-object p1, p0, mDeviceBroker:Lcom/android/server/audio/AudioDeviceBroker;
...
.method private checkSendBecomingNoisyIntentInt(III)I
    ...
    :cond_0
    iget v1, p0, mBecomingNoisyIntentDevices:I
    ...
    iget v5, p0, mBecomingNoisyIntentDevices:I
...
.method private makeA2dpDeviceAvailable(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V
    ...
    iget-object v2, p0, mConnectedDevices:Landroid/util/ArrayMap;
    ...
    invoke-direct {p0, p2}, setCurrentAudioRouteNameIfPossible(Ljava/lang/String;)V
    ...
    :goto_0
    sget-object v1, autoPlayBlackListedAddr:[Ljava/lang/String;
...
.method private makeA2dpDeviceUnavailableNow(Ljava/lang/String;I)V
    ...
    invoke-direct {p0, v0}, setCurrentAudioRouteNameIfPossible(Ljava/lang/String;)V

    iget-object v1, p0, mDockAddress:Ljava/lang/String;

    if-ne v1, p1, :cond_4

    iput-object v0, p0, mDockAddress:Ljava/lang/String;
...
.method private sendDeviceConnectionIntent(IILjava/lang/String;Ljava/lang/String;)V
    ...
    :cond_2
    invoke-direct {p0, v0, p2}, configureHdmiPlugIntent(Landroid/content/Intent;I)V
...
.method private setCurrentAudioRouteNameIfPossible(Ljava/lang/String;)V
    ...
    invoke-direct {p0}, isCurrentDeviceConnected()Z
...
.method private updateAudioRoutes(II)V
    ...
    :goto_1
    iget-object v3, p0, mCurAudioRoutes:Landroid/media/AudioRoutesInfo;
...
.method checkSendBecomingNoisyIntent(III)I
    ...
    :try_start_0
    invoke-direct {p0, p1, p2, p3}, checkSendBecomingNoisyIntentInt(III)I
...
.method disconnectA2dp()V
    ...
    invoke-direct {p0, v2, v3, v3}, checkSendBecomingNoisyIntentInt(III)I
...
.method handleBluetoothA2dpActiveDeviceChangeExt(Landroid/bluetooth/BluetoothDevice;IIZI)V
    ...
    iget-object v2, v1, mDeviceBroker:Lcom/android/server/audio/AudioDeviceBroker;
    ...
    :cond_0
    iget-object v2, v1, mConnectedDevices:Landroid/util/ArrayMap;
    ...
    iget-object v3, v1, mDeviceBroker:Lcom/android/server/audio/AudioDeviceBroker;
    ...
    iget-object v6, v1, mConnectedDevices:Landroid/util/ArrayMap;
    ...
    sget-object v4, prevDisconnectedDeviceAddress:Ljava/lang/String;
    ...
    iput-boolean v4, v1, mPostA2dpDeviceConfigChange:Z

    :cond_1
    iget-object v4, v1, mDeviceBroker:Lcom/android/server/audio/AudioDeviceBroker;
    ...
    :goto_0
    iget-object v9, v1, mConnectedDevices:Landroid/util/ArrayMap;
    ...
    iget-object v10, v1, mConnectedDevices:Landroid/util/ArrayMap;
...
.method public synthetic lambda$disconnectA2dp$1$AudioDeviceInventory(ILjava/lang/String;)V
    ...
    invoke-direct {p0, p2, p1}, makeA2dpDeviceUnavailableLater(Ljava/lang/String;I)V
...
.method public synthetic lambda$disconnectHearingAid$5$AudioDeviceInventory(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, makeHearingAidDeviceUnavailable(Ljava/lang/String;)V
...
.method onBluetoothA2dpActiveDeviceChange(Lcom/android/server/audio/BtHelper$BluetoothA2dpDeviceInfo;I)V
    ...
    iput-boolean v0, v8, mPostA2dpDeviceConfigChange:Z
    ...
    iget-object v14, v8, mConnectedDevices:Landroid/util/ArrayMap;

    monitor-enter v14

    :try_start_0
    iget-object v1, v8, mDeviceBroker:Lcom/android/server/audio/AudioDeviceBroker;
    ...
    iget-object v2, v8, mConnectedDevices:Landroid/util/ArrayMap;
    ...
    iget-object v4, v8, mDeviceBroker:Lcom/android/server/audio/AudioDeviceBroker;
    ...
    iget-object v5, v8, mDeviceBroker:Lcom/android/server/audio/AudioDeviceBroker;

    invoke-virtual {v5}, Lcom/android/server/audio/AudioDeviceBroker;->isAvrcpAbsoluteVolumeSupported()Z

    move-result v5

    iget-object v6, v8, mDeviceBroker:Lcom/android/server/audio/AudioDeviceBroker;
    ...
    iget-object v0, v8, mDeviceBroker:Lcom/android/server/audio/AudioDeviceBroker;
    ...
    :goto_2
    sget-object v3, autoPlayBlackListedAddr:[Ljava/lang/String;
    ...
    iget-object v0, v8, mConnectedDevices:Landroid/util/ArrayMap;
    ...
    invoke-virtual/range {v1 .. v7}, setBluetoothA2dpDeviceConnectionState(Landroid/bluetooth/BluetoothDevice;IIZII)V
...
.method onMakeA2dpDeviceUnavailableNow(Ljava/lang/String;I)V
    ...
    :try_start_0
    invoke-direct {p0, p1, p2}, makeA2dpDeviceUnavailableNow(Ljava/lang/String;I)V
...
.method onReportNewRoutes()V
    ...
    iget-object v0, p0, mRoutesObservers:Landroid/os/RemoteCallbackList;
...
.method onSetA2dpSinkConnectionState(Lcom/android/server/audio/BtHelper$BluetoothA2dpDeviceInfo;I)V
    ...
    sget-object v0, prevDisconnectedDeviceAddress:Ljava/lang/String;
    ...
    iget-boolean v0, v1, mPostA2dpDeviceConfigChange:Z
    ...
    iget-object v7, v1, mConnectedDevices:Landroid/util/ArrayMap;
    ...
    invoke-direct {v1, v5, v8}, makeA2dpDeviceUnavailableLater(Ljava/lang/String;I)V
    ...
    invoke-direct {v1, v5, v8}, makeA2dpDeviceUnavailableNow(Ljava/lang/String;I)V
    ...
    iget-object v12, v1, mDeviceBroker:Lcom/android/server/audio/AudioDeviceBroker;

    invoke-virtual {v12}, Lcom/android/server/audio/AudioDeviceBroker;->cancelA2dpDockTimeout()V

    iput-object v5, v1, mDockAddress:Ljava/lang/String;
    ...
    iget-object v12, v1, mDockAddress:Ljava/lang/String;
    ...
    invoke-direct {v1, v12, v10}, makeA2dpDeviceUnavailableNow(Ljava/lang/String;I)V
    ...
    iget-object v14, v1, mDeviceBroker:Lcom/android/server/audio/AudioDeviceBroker;

    invoke-virtual {v14}, Lcom/android/server/audio/AudioDeviceBroker;->isAvrcpAbsoluteVolumeSupported()Z

    move-result v14

    iget-object v15, v1, mDeviceBroker:Lcom/android/server/audio/AudioDeviceBroker;
    ...
    iget-object v8, v1, mDeviceBroker:Lcom/android/server/audio/AudioDeviceBroker;
    ...
    invoke-direct {v1, v5, v0, v8, v6}, makeA2dpDeviceAvailable(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V

    iget-object v0, v1, mDeviceBroker:Lcom/android/server/audio/AudioDeviceBroker;

    iget-object v8, v1, mDockAddress:Ljava/lang/String;
...
.method onSetA2dpSourceConnectionState(Lcom/android/server/audio/BtHelper$BluetoothA2dpDeviceInfo;I)V
    ...
    invoke-direct {p0, v1}, makeA2dpSrcUnavailable(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v1}, makeA2dpSrcAvailable(Ljava/lang/String;)V
...
.method onSetHearingAidConnectionState(Landroid/bluetooth/BluetoothDevice;II)V
    ...
    invoke-direct {p0, v0}, makeHearingAidDeviceUnavailable(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0, v5, p3, v6}, makeHearingAidDeviceAvailable(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)V
...
.method onSetWiredDeviceConnectionState(Lcom/android/server/audio/AudioDeviceInventory$WiredDeviceConnectionState;)V
    ...
    invoke-virtual {p0, v3, v1, v5, v6}, handleDeviceConnection(ZILjava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v1, v2, v3, v4}, sendDeviceConnectionIntent(IILjava/lang/String;Ljava/lang/String;)V

    iget v1, p1, Lcom/android/server/audio/AudioDeviceInventory$WiredDeviceConnectionState;->mType:I

    iget v2, p1, Lcom/android/server/audio/AudioDeviceInventory$WiredDeviceConnectionState;->mState:I

    invoke-direct {p0, v1, v2}, updateAudioRoutes(II)V
...
.method onToggleHdmi()V
    ...
    invoke-virtual/range {v3 .. v8}, setWiredDeviceConnectionState(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual/range {v9 .. v14}, setWiredDeviceConnectionState(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
...
.method setBluetoothA2dpDeviceConnectionState(Landroid/bluetooth/BluetoothDevice;IIZII)V
    ...
    :try_start_0
    invoke-direct {p0, v3, v2, p5}, checkSendBecomingNoisyIntentInt(III)I
    ...
    invoke-virtual {p0, v4, p2}, onSetA2dpSinkConnectionState(Lcom/android/server/audio/BtHelper$BluetoothA2dpDeviceInfo;I)V
...
.method setBluetoothHearingAidDeviceConnectionState(Landroid/bluetooth/BluetoothDevice;IZI)I
    ...
    :try_start_0
    invoke-direct {p0, v2, v1, p4}, checkSendBecomingNoisyIntentInt(III)I
...
.method setWiredDeviceConnectionState(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    ...
    iget-object v9, v8, mConnectedDevices:Landroid/util/ArrayMap;
    ...
    :try_start_0
    invoke-direct {p0, p1, v11, v0}, checkSendBecomingNoisyIntentInt(III)I

    move-result v0

    iget-object v12, v8, mDeviceBroker:Lcom/android/server/audio/AudioDeviceBroker;
...
.method startWatchingRoutes(Landroid/media/IAudioRoutesObserver;)Landroid/media/AudioRoutesInfo;
    ...
    iget-object v2, p0, mRoutesObservers:Landroid/os/RemoteCallbackList;
