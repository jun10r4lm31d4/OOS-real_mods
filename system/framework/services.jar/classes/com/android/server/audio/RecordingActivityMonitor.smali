...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mRecordStates:Ljava/util/List;
    ...
    iput-object v0, p0, mPackMan:Landroid/content/pm/PackageManager;
...
.method private createRecordingConfiguration(III[IIZI[Landroid/media/audiofx/AudioEffect$Descriptor;[Landroid/media/audiofx/AudioEffect$Descriptor;)Landroid/media/AudioRecordingConfiguration;
    ...
    iget-object v2, v14, mPackMan:Landroid/content/pm/PackageManager;
...
.method private dispatchCallbacks(Ljava/util/List;)V
    ...
    invoke-static {p1}, anonymizeForPublicConsumption(Ljava/util/List;)Ljava/util/ArrayList;
...
.method private findStateByPortId(I)I
    ...
    iget-object v0, p0, mRecordStates:Ljava/util/List;
    ...
    :goto_0
    :try_start_0
    iget-object v2, p0, mRecordStates:Ljava/util/List;
...
.method private updateSnapshot(IILandroid/media/AudioRecordingConfiguration;)Ljava/util/List;
    ...
    iget-object v1, p0, mRecordStates:Ljava/util/List;
    ...
    :try_start_0
    invoke-direct {p0, p2}, findStateByRiid(I)I
    ...
    invoke-direct {p0, v4}, findStateByPortId(I)I
    ...
    iget-object v3, p0, mRecordStates:Ljava/util/List;
    ...
    iget-object v5, p0, mRecordStates:Ljava/util/List;
    ...
    sget-object v5, sEventLogger:Lcom/android/server/audio/AudioEventLogger;
    ...
    invoke-virtual {p0, v6}, getActiveRecordingConfigurations(Z)Ljava/util/List;
...
.method getActiveRecordingConfigurations(Z)Ljava/util/List;
    ...
    invoke-static {v0}, anonymizeForPublicConsumption(Ljava/util/List;)Ljava/util/ArrayList;
...
.method onAudioServerDied()V
    ...
    invoke-virtual {p0, v3}, getActiveRecordingConfigurations(Z)Ljava/util/List;
    ...
    invoke-direct {p0, v0}, dispatchCallbacks(Ljava/util/List;)V
...
.method public onRecordingConfigurationChanged(IIIIIIZ[I[Landroid/media/audiofx/AudioEffect$Descriptor;[Landroid/media/audiofx/AudioEffect$Descriptor;ILjava/lang/String;)V
    ...
    invoke-direct/range {v0 .. v9}, createRecordingConfiguration(III[IIZI[Landroid/media/audiofx/AudioEffect$Descriptor;[Landroid/media/audiofx/AudioEffect$Descriptor;)Landroid/media/AudioRecordingConfiguration;
    ...
    sget-object v1, sEventLogger:Lcom/android/server/audio/AudioEventLogger;
    ...
    :cond_0
    invoke-direct {p0, p1, p2, v0}, updateSnapshot(IILandroid/media/AudioRecordingConfiguration;)Ljava/util/List;

    move-result-object v1

    invoke-direct {p0, v1}, dispatchCallbacks(Ljava/util/List;)V
...
.method public recorderEvent(II)V
    ...
    :cond_2
    invoke-direct {p0, v0, p1, v2}, updateSnapshot(IILandroid/media/AudioRecordingConfiguration;)Ljava/util/List;
...
.method public releaseRecorder(I)V
    ...
    invoke-direct {p0, v0, p1, v1}, updateSnapshot(IILandroid/media/AudioRecordingConfiguration;)Ljava/util/List;
