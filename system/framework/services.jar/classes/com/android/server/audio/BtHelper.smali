...
.method constructor <init>(Lcom/android/server/audio/AudioDeviceBroker;)V
    ...
    iput-object v0, p0, mScoClientDevices:Ljava/util/HashMap;
...
.method static synthetic access$1000(Landroid/bluetooth/BluetoothHeadset;Landroid/bluetooth/BluetoothDevice;I)Z
    ...
    invoke-static {p0, p1, p2}, disconnectBluetoothScoAudioHelper(Landroid/bluetooth/BluetoothHeadset;Landroid/bluetooth/BluetoothDevice;I)Z
...
.method static synthetic access$900(Landroid/bluetooth/BluetoothHeadset;Landroid/bluetooth/BluetoothDevice;I)Z
    ...
    invoke-static {p0, p1, p2}, connectBluetoothScoAudioHelper(Landroid/bluetooth/BluetoothHeadset;Landroid/bluetooth/BluetoothDevice;I)Z
...
.method private checkAndUpdatTwsPlusScoState(Landroid/content/Intent;Ljava/lang/Integer;)Z
    ...
    invoke-direct {p0}, isAudioPathUp()Z
    ...
    :cond_1
    invoke-direct {p0, v1, p2}, updateTwsPlusScoState(Landroid/bluetooth/BluetoothDevice;Ljava/lang/Integer;)V
...
.method private getBluetoothHeadset()Z
    ...
    iget-object v3, p0, mBluetoothProfileServiceListener:Landroid/bluetooth/BluetoothProfile$ServiceListener;
...
.method private handleBtScoActiveDeviceChange(Landroid/bluetooth/BluetoothDevice;Z)Z
    ...
    :cond_4
    invoke-static {p1}, getName(Landroid/bluetooth/BluetoothDevice;)Ljava/lang/String;
    ...
    iget-object v8, p0, mDeviceBroker:Lcom/android/server/audio/AudioDeviceBroker;
    ...
    iget-object v11, p0, mDeviceBroker:Lcom/android/server/audio/AudioDeviceBroker;
...
.method private isAudioPathUp()Z
    ...
    iget-object v1, p0, mScoClientDevices:Ljava/util/HashMap;
    ...
    iget-object v2, p0, mScoClientDevices:Ljava/util/HashMap;
...
.method private setBtScoActiveDevice(Landroid/bluetooth/BluetoothDevice;)V
    ...
    iget-object v2, p0, mBluetoothHeadsetDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    iget-object v5, p0, mBluetoothHeadsetDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    invoke-direct {p0, v4, v5}, handleBtScoActiveDeviceChange(Landroid/bluetooth/BluetoothDevice;Z)Z
    ...
    invoke-virtual {p0}, resetBluetoothSco()V
...
.method private updateTwsPlusScoState(Landroid/bluetooth/BluetoothDevice;Ljava/lang/Integer;)V
    ...
    iget-object v0, p0, mScoClientDevices:Ljava/util/HashMap;
...
.method declared-synchronized disconnectBluetoothSco(I)V
    ...
    :try_start_1
    invoke-direct {p0, p1, v0}, clearAllScoClients(IZ)V
    :try_end_1
...
.method declared-synchronized disconnectHeadset()V
    ...
    :try_start_0
    invoke-direct {p0, v0}, setBtScoActiveDevice(Landroid/bluetooth/BluetoothDevice;)V

    iput-object v0, p0, mBluetoothHeadset:Landroid/bluetooth/BluetoothHeadset;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method declared-synchronized getA2dpCodec(Landroid/bluetooth/BluetoothDevice;)I
    ...
    invoke-direct {p0, v1}, mapBluetoothCodecToAudioFormat(I)I
...
.method isBluetoothAudioNotConnectedToEarbud()Z
    ...
    iget-object v6, p0, mBluetoothHeadset:Landroid/bluetooth/BluetoothHeadset;
    ...
    iget-object v5, p0, mBluetoothHeadset:Landroid/bluetooth/BluetoothHeadset;
...
.method declared-synchronized onA2dpProfileConnected(Landroid/bluetooth/BluetoothA2dp;)V
    ...
    iget-object v2, p0, mA2dp:Landroid/bluetooth/BluetoothA2dp;
...
.method declared-synchronized onBroadcastScoConnectionState(I)V
    ...
    :try_start_0
    iget v0, p0, mScoConnectionState:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method declared-synchronized onHeadsetProfileConnected(Landroid/bluetooth/BluetoothHeadset;)V
    ...
    iget v3, p0, mScoAudioMode:I

    invoke-static {v1, v2, v3}, disconnectBluetoothScoAudioHelper(Landroid/bluetooth/BluetoothHeadset;Landroid/bluetooth/BluetoothDevice;I)Z
    ...
    invoke-static {v1, v2, v3}, connectBluetoothScoAudioHelper(Landroid/bluetooth/BluetoothHeadset;Landroid/bluetooth/BluetoothDevice;I)Z
    ...
    invoke-direct {p0, v1}, broadcastScoConnectionState(I)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method declared-synchronized onHearingAidProfileConnected(Landroid/bluetooth/BluetoothHearingAid;)V
    ...
    :try_start_0
    iput-object p1, p0, mHearingAid:Landroid/bluetooth/BluetoothHearingAid;

    iget-object v0, p0, mHearingAid:Landroid/bluetooth/BluetoothHearingAid;
    ...
    iget-object v2, p0, mHearingAid:Landroid/bluetooth/BluetoothHearingAid;
...
.method declared-synchronized receiveBtEvent(Landroid/content/Intent;)V
    ...
    invoke-direct {p0, v1}, setBtScoActiveDevice(Landroid/bluetooth/BluetoothDevice;)V
    ...
    invoke-direct {p0, p1, v8}, checkAndUpdatTwsPlusScoState(Landroid/content/Intent;Ljava/lang/Integer;)Z
    ...
    invoke-direct {p0, p1, v4}, checkAndUpdatTwsPlusScoState(Landroid/content/Intent;Ljava/lang/Integer;)Z
    ...
    iget v9, p0, mScoAudioMode:I

    invoke-static {v4, v5, v9}, connectBluetoothScoAudioHelper(Landroid/bluetooth/BluetoothHeadset;Landroid/bluetooth/BluetoothDevice;I)Z

    move-result v4

    if-eqz v4, :cond_5

    iput v7, p0, mScoAudioState:I
    ...
    :goto_0
    invoke-direct {p0, v8, v6}, clearAllScoClients(IZ)V

    iput v8, p0, mScoAudioState:I
    ...
    invoke-direct {p0, v2}, broadcastScoConnectionState(I)V
    ...
    invoke-direct {p0, v4}, sendStickyBroadcastToAll(Landroid/content/Intent;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method declared-synchronized resetBluetoothSco()V
    ...
    invoke-direct {p0, v0, v0}, clearAllScoClients(IZ)V
...
.method declared-synchronized scoClientDied(Ljava/lang/Object;)V
    ...
    iget-object v2, p0, mScoClients:Ljava/util/ArrayList;
...
.method declared-synchronized setAvrcpAbsoluteVolumeSupported(Z)V
    ...
    :try_start_0
    iput-boolean p1, p0, mAvrcpAbsVolSupported:Z
...
.method declared-synchronized setHearingAidVolume(II)V
    ...
    iget-object v1, p0, mHearingAid:Landroid/bluetooth/BluetoothHearingAid;
...
.method declared-synchronized startBluetoothScoForClient(Landroid/os/IBinder;ILjava/lang/String;)V
    ...
    :try_start_0
    invoke-direct {p0, p1, v0}, getScoClient(Landroid/os/IBinder;Z)Lcom/android/server/audio/BtHelper$ScoClient;
