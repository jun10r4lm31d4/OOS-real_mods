...
.method constructor <init>(Lcom/android/server/audio/AudioService;Landroid/media/audiopolicy/AudioPolicyConfig;Landroid/media/audiopolicy/IAudioPolicyCallback;ZZZZLandroid/media/projection/IMediaProjection;)V
    ...
    iput-object v0, p0, mUidDeviceAffinities:Ljava/util/HashMap;

    const/4 v0, 0x0

    iput v0, p0, mFocusDuckBehavior:I

    iput-boolean v0, p0, mIsFocusPolicy:Z

    iput-boolean v0, p0, mIsTestFocusPolicy:Z
    ...
    iput-boolean p7, p0, mIsVolumeController:Z

    iput-object p8, p0, mProjection:Landroid/media/projection/IMediaProjection;
    ...
    iput-boolean p6, p0, mIsTestFocusPolicy:Z
    ...
    iget-boolean v2, p0, mIsTestFocusPolicy:Z
    ...
    :cond_0
    iget-boolean v0, p0, mIsVolumeController:Z

    if-eqz v0, :cond_1

    iget-object v0, p0, mPolicyCallback:Landroid/media/audiopolicy/IAudioPolicyCallback;
    ...
    :cond_1
    iget-object v0, p0, mProjection:Landroid/media/projection/IMediaProjection;
    ...
    iput-object v0, p0, mProjectionCallback:Lcom/android/server/audio/AudioService$AudioPolicyProxy$UnregisterOnStopCallback;

    :try_start_0
    iget-object v0, p0, mProjection:Landroid/media/projection/IMediaProjection;

    iget-object v1, p0, mProjectionCallback:Lcom/android/server/audio/AudioService$AudioPolicyProxy$UnregisterOnStopCallback;
    ...
    :cond_2
    :goto_0
    invoke-virtual {p0}, connectMixes()I
...
.method addMixes(Ljava/util/ArrayList;)I
    ...
    :try_start_0
    iget-object v1, p0, mMixes:Ljava/util/ArrayList;

    const/4 v2, 0x0

    invoke-static {v1, v2}, Landroid/media/AudioSystem;->registerPolicyMixes(Ljava/util/ArrayList;Z)I

    invoke-virtual {p0, p1}, add(Ljava/util/ArrayList;)V
...
.method release()V
    ...
    iget-boolean v0, p0, mIsFocusPolicy:Z
    ...
    :cond_2
    iget-object v0, p0, mProjectionCallback:Lcom/android/server/audio/AudioService$AudioPolicyProxy$UnregisterOnStopCallback;

    if-eqz v0, :cond_3

    :try_start_0
    iget-object v1, p0, mProjection:Landroid/media/projection/IMediaProjection;
    ...
    iget-object v3, p0, mMixes:Ljava/util/ArrayList;
...
.method removeMixes(Ljava/util/ArrayList;)I
    ...
    invoke-virtual {p0, p1}, remove(Ljava/util/ArrayList;)V
...
.method removeUidDeviceAffinities(I)I
    ...
    iget-object v0, p0, mUidDeviceAffinities:Ljava/util/HashMap;
...
.method setUidDeviceAffinities(I[I[Ljava/lang/String;)I
    ...
    iget-object v1, p0, mUidDeviceAffinities:Ljava/util/HashMap;
    ...
    iget-object v2, p0, mUidDeviceAffinities:Ljava/util/HashMap;
...
.method public toLogFriendlyString()Ljava/lang/String;
    ...
    iget-boolean v2, p0, mIsFocusPolicy:Z
    ...
    iget-boolean v1, p0, mIsFocusPolicy:Z
    ...
    iget v3, p0, mFocusDuckBehavior:I
    ...
    iget-boolean v3, p0, mIsTestFocusPolicy:Z
    ...
    iget-boolean v3, p0, mHasFocusListener:Z
    ...
    iget-object v3, p0, mProjection:Landroid/media/projection/IMediaProjection;
