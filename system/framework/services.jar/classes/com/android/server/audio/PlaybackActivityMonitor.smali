...
.method static constructor <clinit>()V
    ...
    sput-object v0, DUCK_VSHAPE:Landroid/media/VolumeShaper$Configuration;
    ...
    sput-object v0, DUCK_ID:Landroid/media/VolumeShaper$Configuration;
    ...
    sput-object v0, PLAY_CREATE_IF_NEEDED:Landroid/media/VolumeShaper$Operation;

    new-array v0, v2, [I

    fill-array-data v0, :array_2

    sput-object v0, UNDUCKABLE_PLAYER_TYPES:[I

    new-instance v0, Landroid/media/VolumeShaper$Operation$Builder;

    sget-object v1, PLAY_CREATE_IF_NEEDED:Landroid/media/VolumeShaper$Operation;
    ...
    sput-object v0, PLAY_SKIP_RAMP:Landroid/media/VolumeShaper$Operation;
    ...
    sput-object v0, sEventLogger:Lcom/android/server/audio/AudioEventLogger;
...
.method constructor <init>(Landroid/content/Context;I)V
    ...
    iput-object v0, p0, mClients:Ljava/util/ArrayList;

    const/4 v0, 0x0

    iput-boolean v0, p0, mHasPublicClients:Z

    new-instance v1, Ljava/lang/Object;

    invoke-direct {v1}, Ljava/lang/Object;-><init>()V

    iput-object v1, p0, mPlayerLock:Ljava/lang/Object;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, mPlayers:Ljava/util/HashMap;

    const/4 v1, -0x1

    iput v1, p0, mSavedAlarmVolume:I

    iput v0, p0, mPrivilegedAlarmActiveCount:I

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mBannedUids:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mMutedPlayers:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, mDuckingManager:Lcom/android/server/audio/PlaybackActivityMonitor$DuckingManager;

    iput-object p1, p0, mContext:Landroid/content/Context;

    iput p2, p0, mMaxAlarmVolume:I
...
.method static synthetic access$100()Lcom/android/server/audio/AudioEventLogger;
    ...
    sget-object v0, sEventLogger:Lcom/android/server/audio/AudioEventLogger;
...
.method static synthetic access$200()Landroid/media/VolumeShaper$Configuration;
    ...
    sget-object v0, DUCK_VSHAPE:Landroid/media/VolumeShaper$Configuration;
...
.method static synthetic access$300()Landroid/media/VolumeShaper$Operation;
    ...
    sget-object v0, PLAY_SKIP_RAMP:Landroid/media/VolumeShaper$Operation;
...
.method static synthetic access$400()Landroid/media/VolumeShaper$Operation;
    ...
    sget-object v0, PLAY_CREATE_IF_NEEDED:Landroid/media/VolumeShaper$Operation;
...
.method static synthetic access$500()Landroid/media/VolumeShaper$Configuration;
    ...
    sget-object v0, DUCK_ID:Landroid/media/VolumeShaper$Configuration;
...
.method private checkVolumeForPrivilegedAlarm(Landroid/media/AudioPlaybackConfiguration;I)V
    ...
    iget v1, p0, mPrivilegedAlarmActiveCount:I

    add-int/lit8 v3, v1, 0x1

    iput v3, p0, mPrivilegedAlarmActiveCount:I
    ...
    iput v1, p0, mPrivilegedAlarmActiveCount:I
    ...
    iget v3, p0, mMaxAlarmVolume:I

    if-ne v1, v3, :cond_2

    iget v1, p0, mSavedAlarmVolume:I
...
.method private dispatchPlaybackChange(Z)V
    ...
    iget-object v0, p0, mClients:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, mClients:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, mPlayerLock:Ljava/lang/Object;

    monitor-enter v1

    :try_start_1
    iget-object v0, p0, mPlayers:Ljava/util/HashMap;
    ...
    iget-object v2, p0, mPlayers:Ljava/util/HashMap;
    ...
    iget-object v2, p0, mClients:Ljava/util/ArrayList;
    ...
    :cond_2
    iget-boolean v1, p0, mHasPublicClients:Z

    if-eqz v1, :cond_3

    invoke-direct {p0, v0}, anonymizeForPublicConsumption(Ljava/util/List;)Ljava/util/ArrayList;
    ...
    :goto_0
    iget-object v3, p0, mClients:Ljava/util/ArrayList;
...
.method public disableAudioForUid(ZI)V
    ...
    iget-object v0, p0, mPlayerLock:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, mBannedUids:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, mBannedUids:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v3, p2}, checkBanPlayer(Landroid/media/AudioPlaybackConfiguration;I)Z
...
.method public duckPlayers(Lcom/android/server/audio/FocusRequester;Lcom/android/server/audio/FocusRequester;Z)Z
    ...
    :try_start_0
    iget-object v1, p0, mPlayers:Ljava/util/HashMap;
    ...
    :cond_1
    sget-object v6, UNDUCKABLE_PLAYER_TYPES:[I
    ...
    :cond_4
    iget-object v4, p0, mDuckingManager:Lcom/android/server/audio/PlaybackActivityMonitor$DuckingManager;
...
.method protected dump(Ljava/io/PrintWriter;)V
    ...
    iget-object v4, p0, mPlayers:Ljava/util/HashMap;
    ...
    iget-object v2, p0, mDuckingManager:Lcom/android/server/audio/PlaybackActivityMonitor$DuckingManager;
    ...
    iget-object v2, p0, mMutedPlayers:Ljava/util/ArrayList;
    ...
    sget-object v2, sEventLogger:Lcom/android/server/audio/AudioEventLogger;
...
.method getActivePlaybackConfigurations(Z)Ljava/util/List;
    ...
    iget-object v3, p0, mPlayers:Ljava/util/HashMap;
    ...
    invoke-direct {p0, v2}, anonymizeForPublicConsumption(Ljava/util/List;)Ljava/util/ArrayList;
...
.method public mutePlayersForCall([I)V
    ...
    :try_start_1
    sget-object v7, sEventLogger:Lcom/android/server/audio/AudioEventLogger;
    ...
    iget-object v7, p0, mMutedPlayers:Ljava/util/ArrayList;
...
.method public playerAttributes(ILandroid/media/AudioAttributes;I)V
    ...
    invoke-static {p1, v1, p3}, checkConfigurationCaller(ILandroid/media/AudioPlaybackConfiguration;I)Z
    ...
    invoke-direct {p0, v3}, dispatchPlaybackChange(Z)V
...
.method public playerDeath(I)V
    ...
    invoke-virtual {p0, p1, v0}, releasePlayer(II)V
...
.method public playerEvent(III)V
    ...
    iget-object v3, p0, mBannedUids:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v1, v5}, checkBanPlayer(Landroid/media/AudioPlaybackConfiguration;I)Z
    ...
    invoke-direct {p0, v1, p2}, checkVolumeForPrivilegedAlarm(Landroid/media/AudioPlaybackConfiguration;I)V
    ...
    :goto_2
    invoke-direct {p0, v0}, dispatchPlaybackChange(Z)V
...
.method registerPlaybackCallback(Landroid/media/IPlaybackConfigDispatcher;Z)V
    ...
    iput-boolean v2, p0, mHasPublicClients:Z
...
.method public releasePlayer(II)V
    ...
    invoke-static {p1, v2, p2}, checkConfigurationCaller(ILandroid/media/AudioPlaybackConfiguration;I)Z

    move-result v3

    if-eqz v3, :cond_0

    sget-object v3, sEventLogger:Lcom/android/server/audio/AudioEventLogger;
    ...
    iget-object v3, p0, mDuckingManager:Lcom/android/server/audio/PlaybackActivityMonitor$DuckingManager;
    ...
    invoke-direct {p0, v2, v3}, checkVolumeForPrivilegedAlarm(Landroid/media/AudioPlaybackConfiguration;I)V
    ...
    invoke-direct {p0, v1}, dispatchPlaybackChange(Z)V
...
.method public trackPlayer(Landroid/media/PlayerBase$PlayerIdCard;)I
    ...
    iget-object v2, p0, mPlayerLock:Ljava/lang/Object;
...
.method public unduckPlayers(Lcom/android/server/audio/FocusRequester;)V
    ...
    :try_start_0
    iget-object v1, p0, mDuckingManager:Lcom/android/server/audio/PlaybackActivityMonitor$DuckingManager;
...
.method public unmutePlayersForCall()V
    ...
    :try_start_0
    iget-object v1, p0, mMutedPlayers:Ljava/util/ArrayList;
    ...
    :try_start_1
    sget-object v4, sEventLogger:Lcom/android/server/audio/AudioEventLogger;
