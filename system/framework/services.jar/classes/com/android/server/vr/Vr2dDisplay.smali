...
.method public constructor <init>(Landroid/hardware/display/DisplayManager;Landroid/app/ActivityManagerInternal;Lcom/android/server/wm/WindowManagerInternal;Landroid/service/vr/IVrManager;)V
    ...
    iput-object v0, p0, mVdLock:Ljava/lang/Object;
    ...
    iput-object v0, p0, mVrStateCallbacks:Landroid/service/vr/IPersistentVrStateCallbacks;

    const/4 v0, 0x1

    iput-boolean v0, p0, mIsVirtualDisplayAllowed:Z

    const/4 v0, 0x0

    iput-boolean v0, p0, mBootsToVr:Z

    iput-object p1, p0, mDisplayManager:Landroid/hardware/display/DisplayManager;

    iput-object p2, p0, mActivityManagerInternal:Landroid/app/ActivityManagerInternal;

    iput-object p3, p0, mWindowManagerInternal:Lcom/android/server/wm/WindowManagerInternal;

    iput-object p4, p0, mVrManager:Landroid/service/vr/IVrManager;

    const/16 v0, 0x578

    iput v0, p0, mVirtualDisplayWidth:I

    const/16 v0, 0x708

    iput v0, p0, mVirtualDisplayHeight:I

    const/16 v0, 0x140

    iput v0, p0, mVirtualDisplayDpi:I
...
.method static synthetic access$000(Lcom/android/server/vr/Vr2dDisplay;)Z
    ...
    iget-boolean v0, p0, mIsPersistentVrModeEnabled:Z
...
.method static synthetic access$002(Lcom/android/server/vr/Vr2dDisplay;Z)Z
    ...
    iput-boolean p1, p0, mIsPersistentVrModeEnabled:Z
...
.method static synthetic access$100(Lcom/android/server/vr/Vr2dDisplay;)V
    ...
    invoke-direct {p0}, updateVirtualDisplay()V
...
.method static synthetic access$200(Lcom/android/server/vr/Vr2dDisplay;)Z
    ...
    invoke-direct {p0}, shouldRunVirtualDisplay()Z
...
.method static synthetic access$300(Lcom/android/server/vr/Vr2dDisplay;)Ljava/lang/Object;
    ...
    iget-object v0, p0, mVdLock:Ljava/lang/Object;
...
.method static synthetic access$400(Lcom/android/server/vr/Vr2dDisplay;I)V
    ...
    invoke-direct {p0, p1}, updateDisplayId(I)V
...
.method static synthetic access$500(Lcom/android/server/vr/Vr2dDisplay;Landroid/view/Surface;)V
    ...
    invoke-direct {p0, p1}, setSurfaceLocked(Landroid/view/Surface;)V
...
.method static synthetic access$602(Lcom/android/server/vr/Vr2dDisplay;Landroid/hardware/display/VirtualDisplay;)Landroid/hardware/display/VirtualDisplay;
    ...
    iput-object p1, p0, mVirtualDisplay:Landroid/hardware/display/VirtualDisplay;
...
.method static synthetic access$700(Lcom/android/server/vr/Vr2dDisplay;)V
    ...
    invoke-direct {p0}, stopImageReader()V
...
.method private shouldRunVirtualDisplay()Z
    ...
    iget-boolean v0, p0, mIsVirtualDisplayAllowed:Z
    ...
    iget-boolean v0, p0, mIsVrModeOverrideEnabled:Z
...
.method private startImageReader()V
    ...
    iget-object v0, p0, mImageReader:Landroid/media/ImageReader;

    if-nez v0, :cond_0

    iget v0, p0, mVirtualDisplayWidth:I

    iget v1, p0, mVirtualDisplayHeight:I
    ...
    iput-object v0, p0, mImageReader:Landroid/media/ImageReader;
    ...
    iget v1, p0, mVirtualDisplayWidth:I
    ...
    iget v1, p0, mVirtualDisplayDpi:I
    ...
    :try_start_0
    iget-object v1, p0, mImageReader:Landroid/media/ImageReader;

    invoke-virtual {v1}, Landroid/media/ImageReader;->getSurface()Landroid/view/Surface;

    move-result-object v1

    invoke-direct {p0, v1}, setSurfaceLocked(Landroid/view/Surface;)V
...
.method private startVirtualDisplay()V
    ...
    iget v5, p0, mVirtualDisplayWidth:I

    iget v6, p0, mVirtualDisplayHeight:I

    iget v7, p0, mVirtualDisplayDpi:I
    ...
    iput-object v2, p0, mVirtualDisplay:Landroid/hardware/display/VirtualDisplay;

    iget-object v2, p0, mVirtualDisplay:Landroid/hardware/display/VirtualDisplay;
    ...
    invoke-direct {p0, v2}, updateDisplayId(I)V

    invoke-direct {p0}, startImageReader()V
...
.method private startVrModeListener()V
    ...
    :try_start_0
    iget-object v1, p0, mVrStateCallbacks:Landroid/service/vr/IPersistentVrStateCallbacks;
...
.method private stopVirtualDisplay()V
    ...
    iget-object v0, p0, mStopVDRunnable:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mStopVDRunnable:Ljava/lang/Runnable;

    :cond_0
    iget-object v0, p0, mHandler:Landroid/os/Handler;

    iget-object v1, p0, mStopVDRunnable:Ljava/lang/Runnable;
...
.method private updateVirtualDisplay()V
    ...
    invoke-direct {p0}, startVirtualDisplay()V

    goto :goto_0

    :cond_0
    invoke-direct {p0}, stopVirtualDisplay()V
...
.method public init(Landroid/content/Context;Z)V
    ...
    invoke-direct {p0}, startVrModeListener()V

    invoke-direct {p0, p1}, startDebugOnlyBroadcastReceiver(Landroid/content/Context;)V

    iput-boolean p2, p0, mBootsToVr:Z
...
.method public setVirtualDisplayProperties(Landroid/app/Vr2dDisplayProperties;)V
    ...
    iput v1, p0, mVirtualDisplayWidth:I

    iput v2, p0, mVirtualDisplayHeight:I

    iput v3, p0, mVirtualDisplayDpi:I
    ...
    iput-boolean v5, p0, mIsVirtualDisplayAllowed:Z
    ...
    :cond_3
    :goto_2
    iget-object v5, p0, mVirtualDisplay:Landroid/hardware/display/VirtualDisplay;

    if-eqz v5, :cond_4

    if-eqz v4, :cond_4

    iget-boolean v5, p0, mIsVirtualDisplayAllowed:Z

    if-eqz v5, :cond_4

    iget-object v5, p0, mVirtualDisplay:Landroid/hardware/display/VirtualDisplay;

    iget v6, p0, mVirtualDisplayWidth:I

    iget v7, p0, mVirtualDisplayHeight:I

    iget v8, p0, mVirtualDisplayDpi:I

    invoke-virtual {v5, v6, v7, v8}, Landroid/hardware/display/VirtualDisplay;->resize(III)V

    iget-object v5, p0, mImageReader:Landroid/media/ImageReader;

    const/4 v6, 0x0

    iput-object v6, p0, mImageReader:Landroid/media/ImageReader;
