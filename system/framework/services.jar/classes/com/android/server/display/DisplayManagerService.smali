...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0}, <init>(Landroid/content/Context;Lcom/android/server/display/DisplayManagerService$Injector;)V
...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/display/DisplayManagerService$Injector;)V
    ...
    iput v1, p0, mNextBuiltInDisplayId:I
    ...
    iput v1, p0, mGlobalDisplayState:I
    ...
    iput-object v2, p0, mStableDisplaySize:Landroid/graphics/Point;

    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    iput-object v2, p0, mViewports:Ljava/util/ArrayList;
    ...
    iput-object v2, p0, mPersistentDataStore:Lcom/android/server/display/PersistentDataStore;

    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    iput-object v2, p0, mTempCallbacks:Ljava/util/ArrayList;

    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    iput-object v2, p0, mDelayDeliverCallbacks:Ljava/util/ArrayList;

    new-instance v2, Landroid/view/DisplayInfo;

    invoke-direct {v2}, Landroid/view/DisplayInfo;-><init>()V

    iput-object v2, p0, mTempDisplayInfo:Landroid/view/DisplayInfo;

    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    iput-object v2, p0, mTempViewports:Ljava/util/ArrayList;

    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    iput-object v2, p0, mTempDisplayStateWorkQueue:Ljava/util/ArrayList;

    new-instance v2, Landroid/util/SparseArray;

    invoke-direct {v2}, Landroid/util/SparseArray;-><init>()V

    iput-object v2, p0, mDisplayAccessUIDs:Landroid/util/SparseArray;

    iput-object p2, p0, mInjector:Lcom/android/server/display/DisplayManagerService$Injector;
    ...
    iput-object v2, p0, mHandler:Lcom/android/server/display/DisplayManagerService$DisplayManagerHandler;

    invoke-static {}, Lcom/android/server/UiThread;->getHandler()Landroid/os/Handler;

    move-result-object v2

    iput-object v2, p0, mUiHandler:Landroid/os/Handler;
    ...
    iput-object v2, p0, mDisplayAdapterListener:Lcom/android/server/display/DisplayManagerService$DisplayAdapterListener;
    ...
    iput-object v2, p0, mDisplayModeDirector:Lcom/android/server/display/DisplayModeDirector;
    ...
    iput-boolean v3, p0, mSingleDisplayDemoMode:Z
    ...
    iput v4, p0, mDefaultDisplayDefaultColorMode:I
    ...
    iput v1, p0, mDefaultDisplayTopInset:I
    ...
    invoke-static {v1}, getFloatArray(Landroid/content/res/TypedArray;)[F
    ...
    invoke-static {v4}, getFloatArray(Landroid/content/res/TypedArray;)[F
    ...
    iput-object v5, p0, mMinimumBrightnessCurve:Landroid/hardware/display/Curve;

    invoke-static {v1, v4}, Landroid/util/Spline;->createSpline([F[F)Landroid/util/Spline;

    move-result-object v5

    iput-object v5, p0, mMinimumBrightnessSpline:Landroid/util/Spline;
    ...
    iput v6, p0, mGlobalDisplayBrightness:I
    ...
    iput-object v0, p0, mWideColorSpace:Landroid/graphics/ColorSpace;
...
.method static synthetic access$1000(Lcom/android/server/display/DisplayManagerService;)V
    ...
    invoke-direct {p0}, loadBrightnessConfiguration()V
...
.method static synthetic access$1100(Lcom/android/server/display/DisplayManagerService;)V
    ...
    invoke-direct {p0}, deliverDelayDisplayEvent()V
...
.method static synthetic access$1700(Lcom/android/server/display/DisplayManagerService;II)Landroid/view/DisplayInfo;
    ...
    invoke-direct {p0, p1, p2}, getDisplayInfoInternal(II)Landroid/view/DisplayInfo;
...
.method static synthetic access$1900(Lcom/android/server/display/DisplayManagerService;II)Z
    ...
    invoke-direct {p0, p1, p2}, isUidPresentOnDisplayInternal(II)Z
...
.method static synthetic access$200(Lcom/android/server/display/DisplayManagerService;)V
    ...
    invoke-direct {p0}, registerDefaultDisplayAdapters()V
...
.method static synthetic access$2000(Lcom/android/server/display/DisplayManagerService;)Landroid/graphics/Point;
    ...
    invoke-direct {p0}, getStableDisplaySizeInternal()Landroid/graphics/Point;
...
.method static synthetic access$2100(Lcom/android/server/display/DisplayManagerService;Landroid/hardware/display/IDisplayManagerCallback;II)V
    ...
    invoke-direct {p0, p1, p2, p3}, registerCallbackInternal(Landroid/hardware/display/IDisplayManagerCallback;II)V
...
.method static synthetic access$3200(Lcom/android/server/display/DisplayManagerService;II)V
    ...
    invoke-direct {p0, p1, p2}, requestColorModeInternal(II)V
...
.method static synthetic access$3400(Lcom/android/server/display/DisplayManagerService;Landroid/hardware/display/IVirtualDisplayCallback;Landroid/media/projection/IMediaProjection;ILjava/lang/String;Ljava/lang/String;IIILandroid/view/Surface;ILjava/lang/String;)I
    ...
    invoke-direct/range {p0 .. p11}, createVirtualDisplayInternal(Landroid/hardware/display/IVirtualDisplayCallback;Landroid/media/projection/IMediaProjection;ILjava/lang/String;Ljava/lang/String;IIILandroid/view/Surface;ILjava/lang/String;)I
...
.method static synthetic access$3800(Lcom/android/server/display/DisplayManagerService;Landroid/os/IBinder;Z)V
    ...
    invoke-direct {p0, p1, p2}, setVirtualDisplayStateInternal(Landroid/os/IBinder;Z)V
...
.method static synthetic access$4100(Lcom/android/server/display/DisplayManagerService;Landroid/hardware/display/BrightnessConfiguration;ILjava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2, p3}, setBrightnessConfigurationForUserInternal(Landroid/hardware/display/BrightnessConfiguration;ILjava/lang/String;)V
...
.method static synthetic access$4600(Lcom/android/server/display/DisplayManagerService;I)Landroid/view/SurfaceControl$ScreenshotGraphicBuffer;
    ...
    invoke-direct {p0, p1}, screenshotInternal(I)Landroid/view/SurfaceControl$ScreenshotGraphicBuffer;
...
.method static synthetic access$4700(Lcom/android/server/display/DisplayManagerService;III)Landroid/view/SurfaceControl$ScreenshotGraphicBuffer;
    ...
    invoke-direct {p0, p1, p2, p3}, screenshotInternal(III)Landroid/view/SurfaceControl$ScreenshotGraphicBuffer;
...
.method static synthetic access$5100(Lcom/android/server/display/DisplayManagerService;ILandroid/view/DisplayInfo;)V
    ...
    invoke-direct {p0, p1, p2}, getNonOverrideDisplayInfoInternal(ILandroid/view/DisplayInfo;)V
...
.method static synthetic access$5400(Lcom/android/server/display/DisplayManagerService;IZ)V
    ...
    invoke-direct {p0, p1, p2}, setDisplayScalingDisabledInternal(IZ)V
...
.method static synthetic access$5500(Lcom/android/server/display/DisplayManagerService;Landroid/util/SparseArray;)V
    ...
    invoke-direct {p0, p1}, setDisplayAccessUIDsInternal(Landroid/util/SparseArray;)V
...
.method static synthetic access$5700(Lcom/android/server/display/DisplayManagerService;)V
    ...
    invoke-direct {p0}, onAllowedDisplayModesChangedInternal()V
...
.method static synthetic access$700(Lcom/android/server/display/DisplayManagerService;)Ljava/util/ArrayList;
    ...
    iget-object v0, p0, mViewports:Ljava/util/ArrayList;
...
.method static synthetic access$800(Lcom/android/server/display/DisplayManagerService;)Ljava/util/ArrayList;
    ...
    iget-object v0, p0, mTempViewports:Ljava/util/ArrayList;
...
.method private addLogicalDisplayLocked(Lcom/android/server/display/DisplayDevice;)Lcom/android/server/display/LogicalDisplay;
    ...
    iget-boolean v5, p0, mSingleDisplayDemoMode:Z
    ...
    invoke-direct {p0, v1, v5}, assignDisplayIdLocked(ZLandroid/view/DisplayAddress;)I

    move-result v5

    invoke-direct {p0, v5}, assignLayerStackLocked(I)I
    ...
    :cond_3
    invoke-direct {p0, v7, p1}, configureColorModeLocked(Lcom/android/server/display/LogicalDisplay;Lcom/android/server/display/DisplayDevice;)V

    if-eqz v1, :cond_4

    invoke-direct {p0, v7}, recordStableDisplayStatsIfNeededLocked(Lcom/android/server/display/LogicalDisplay;)V

    invoke-direct {p0, v7}, recordTopInsetLocked(Lcom/android/server/display/LogicalDisplay;)V
    ...
    :cond_5
    invoke-direct {p0, v5, v2}, sendDisplayEventLocked(II)V
...
.method private applyGlobalDisplayStateLocked(Ljava/util/List;)V
    ...
    invoke-direct {p0, v2}, updateDisplayStateLocked(Lcom/android/server/display/DisplayDevice;)Ljava/lang/Runnable;
...
.method private assignDisplayIdLocked(ZLandroid/view/DisplayAddress;)I
    ...
    iget v1, p0, mNextBuiltInDisplayId:I

    add-int/lit8 v2, v1, 0x1

    iput v2, p0, mNextBuiltInDisplayId:I

    return v1

    :cond_2
    invoke-direct {p0, p1}, assignDisplayIdLocked(Z)I
...
.method private configureColorModeLocked(Lcom/android/server/display/LogicalDisplay;Lcom/android/server/display/DisplayDevice;)V
    ...
    iget v0, p0, mDefaultDisplayDefaultColorMode:I
...
.method private configureDisplayLocked(Landroid/view/SurfaceControl$Transaction;Lcom/android/server/display/DisplayDevice;)V
    ...
    :goto_0
    invoke-direct {p0, p2}, findLogicalDisplayForDeviceLocked(Lcom/android/server/display/DisplayDevice;)Lcom/android/server/display/LogicalDisplay;
    ...
    invoke-direct {p0, v2, v3, p2, v5}, populateViewportLocked(IILcom/android/server/display/DisplayDevice;Ljava/lang/String;)V
...
.method private connectWifiDisplayInternal(Ljava/lang/String;)V
    ...
    :try_start_0
    iget-object v1, p0, mWifiDisplayAdapter:Lcom/android/server/display/WifiDisplayAdapter;
...
.method private createVirtualDisplayInternal(Landroid/hardware/display/IVirtualDisplayCallback;Landroid/media/projection/IMediaProjection;ILjava/lang/String;Ljava/lang/String;IIILandroid/view/Surface;ILjava/lang/String;)I
    ...
    iget-object v2, v1, mSyncRoot:Lcom/android/server/display/DisplayManagerService$SyncRoot;

    monitor-enter v2

    :try_start_0
    iget-object v0, v1, mVirtualDisplayAdapter:Lcom/android/server/display/VirtualDisplayAdapter;
    ...
    :cond_0
    iget-object v5, v1, mVirtualDisplayAdapter:Lcom/android/server/display/VirtualDisplayAdapter;
    ...
    :cond_1
    invoke-direct {v1, v0}, handleDisplayDeviceAddedLocked(Lcom/android/server/display/DisplayDevice;)V

    invoke-direct {v1, v0}, findLogicalDisplayForDeviceLocked(Lcom/android/server/display/DisplayDevice;)Lcom/android/server/display/LogicalDisplay;
    ...
    invoke-direct {v1, v0}, handleDisplayDeviceRemovedLocked(Lcom/android/server/display/DisplayDevice;)V
...
.method private deliverDelayDisplayEvent()V
    ...
    iget-object v0, p0, mDelayDeliverCallbacks:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, mDelayDeliverCallbacks:Ljava/util/ArrayList;
    ...
    iget v3, p0, mDelayDisplayId:I

    iget v4, p0, mDelayEvent:I
    ...
    :cond_0
    iget-object v1, p0, mDelayDeliverCallbacks:Ljava/util/ArrayList;

    invoke-virtual {v1}, Ljava/util/ArrayList;->clear()V

    const/4 v1, -0x1

    iput v1, p0, mDelayEvent:I

    iput v1, p0, mDelayDisplayId:I
...
.method private deliverDisplayEvent(II)V
    ...
    iget-object v3, p0, mTempCallbacks:Ljava/util/ArrayList;
    ...
    iput v0, p0, mDelayEvent:I

    iput v0, p0, mDelayDisplayId:I
    ...
    iget-object v4, p0, mTempCallbacks:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, mDelayDeliverCallbacks:Ljava/util/ArrayList;

    iget-object v5, p0, mTempCallbacks:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, mDelayDeliverCallbacks:Ljava/util/ArrayList;
    ...
    :cond_4
    iput p1, p0, mDelayDisplayId:I

    iput p2, p0, mDelayEvent:I
...
.method private dumpInternal(Ljava/io/PrintWriter;)V
    ...
    iget-boolean v2, p0, mSafeMode:Z
    ...
    iget v2, p0, mNextNonDefaultDisplayId:I
    ...
    iget-object v2, p0, mViewports:Ljava/util/ArrayList;
    ...
    iget v2, p0, mDefaultDisplayDefaultColorMode:I
    ...
    iget-boolean v2, p0, mSingleDisplayDemoMode:Z
    ...
    iget-object v2, p0, mStableDisplaySize:Landroid/graphics/Point;
    ...
    iget-object v2, p0, mMinimumBrightnessCurve:Landroid/hardware/display/Curve;
    ...
    iget-object v3, p0, mDisplayAdapters:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, mDisplayAdapters:Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object v2, p0, mLogicalDisplays:Landroid/util/SparseArray;
    ...
    iget-object v3, p0, mDisplayModeDirector:Lcom/android/server/display/DisplayModeDirector;
    ...
    iget-object v5, p0, mCallbacks:Landroid/util/SparseArray;
    ...
    :cond_3
    iget-object v4, p0, mDisplayPowerController:Lcom/android/server/display/DisplayPowerController;
...
.method private findLogicalDisplayForDeviceLocked(Lcom/android/server/display/DisplayDevice;)Lcom/android/server/display/LogicalDisplay;
    ...
    iget-object v0, p0, mLogicalDisplays:Landroid/util/SparseArray;
...
.method private getDisplayInfoInternal(II)Landroid/view/DisplayInfo;
    ...
    invoke-direct {p0, p2, p1}, isUidPresentOnDisplayInternal(II)Z
...
.method private getStableDisplaySizeInternal()Landroid/graphics/Point;
    ...
    iget-object v3, p0, mStableDisplaySize:Landroid/graphics/Point;
...
.method private handleDisplayDeviceAddedLocked(Lcom/android/server/display/DisplayDevice;)V
    ...
    invoke-direct {p0, p1}, addLogicalDisplayLocked(Lcom/android/server/display/DisplayDevice;)Lcom/android/server/display/LogicalDisplay;
    ...
    invoke-direct {p0, v3}, scheduleTraversalLocked(Z)V
...
.method private handleDisplayDeviceChanged(Lcom/android/server/display/DisplayDevice;)V
    ...
    :try_start_1
    iget-object v3, p0, mPersistentDataStore:Lcom/android/server/display/PersistentDataStore;
...
.method private handleLogicalDisplayChanged(ILcom/android/server/display/LogicalDisplay;)V
    ...
    invoke-direct {p0, p2}, recordTopInsetLocked(Lcom/android/server/display/LogicalDisplay;)V

    :cond_0
    const/4 v0, 0x2

    invoke-direct {p0, p1, v0}, sendDisplayEventLocked(II)V
...
.method private isBrightnessConfigurationTooDark(Landroid/hardware/display/BrightnessConfiguration;)Z
    ...
    iget-object v5, p0, mMinimumBrightnessSpline:Landroid/util/Spline;
...
.method private isUidPresentOnDisplayInternal(II)Z
    ...
    :try_start_0
    iget-object v1, p0, mDisplayAccessUIDs:Landroid/util/SparseArray;
...
.method private loadBrightnessConfiguration()V
    ...
    iget-object v2, p0, mPersistentDataStore:Lcom/android/server/display/PersistentDataStore;
...
.method private loadStableDisplayValuesLocked()V
    ...
    iget-object v1, p0, mStableDisplaySize:Landroid/graphics/Point;
    ...
    invoke-direct {p0, v2, v3}, setStableDisplaySizeLocked(II)V
...
.method private onAllowedDisplayModesChangedInternal()V
    ...
    iget-object v6, p0, mDisplayModeDirector:Lcom/android/server/display/DisplayModeDirector;
...
.method private performTraversalLocked(Landroid/view/SurfaceControl$Transaction;)V
    ...
    invoke-direct {p0, p1, v2}, configureDisplayLocked(Landroid/view/SurfaceControl$Transaction;Lcom/android/server/display/DisplayDevice;)V
...
.method private populateViewportLocked(IILcom/android/server/display/DisplayDevice;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p4}, getViewportLocked(ILjava/lang/String;)Landroid/hardware/display/DisplayViewport;
...
.method private recordStableDisplayStatsIfNeededLocked(Lcom/android/server/display/LogicalDisplay;)V
    ...
    iget-object v0, p0, mStableDisplaySize:Landroid/graphics/Point;
    ...
    invoke-direct {p0, v1, v2}, setStableDisplaySizeLocked(II)V
...
.method private recordTopInsetLocked(Lcom/android/server/display/LogicalDisplay;)V
    ...
    iget v1, p0, mDefaultDisplayTopInset:I
    ...
    :cond_1
    iput v0, p0, mDefaultDisplayTopInset:I
...
.method private registerDefaultDisplayAdapters()V
    ...
    invoke-direct {p0, v1}, registerDisplayAdapterLocked(Lcom/android/server/display/DisplayAdapter;)V

    iget-object v1, p0, mInjector:Lcom/android/server/display/DisplayManagerService$Injector;
    ...
    iput-object v1, p0, mVirtualDisplayAdapter:Lcom/android/server/display/VirtualDisplayAdapter;
...
.method private registerOverlayDisplayAdapterLocked()V
    ...
    invoke-direct {p0, v6}, registerDisplayAdapterLocked(Lcom/android/server/display/DisplayAdapter;)V
...
.method private registerWifiDisplayAdapterLocked()V
    ...
    iget-object v5, p0, mHandler:Lcom/android/server/display/DisplayManagerService$DisplayManagerHandler;

    iget-object v6, p0, mDisplayAdapterListener:Lcom/android/server/display/DisplayManagerService$DisplayAdapterListener;

    iget-object v7, p0, mPersistentDataStore:Lcom/android/server/display/PersistentDataStore;
...
.method private releaseVirtualDisplayInternal(Landroid/os/IBinder;)V
    ...
    invoke-direct {p0, v1}, handleDisplayDeviceRemovedLocked(Lcom/android/server/display/DisplayDevice;)V
...
.method private requestGlobalDisplayStateInternal(II)V
    ...
    :try_start_1
    iget v3, p0, mGlobalDisplayState:I

    if-ne v3, p1, :cond_5

    iget v3, p0, mGlobalDisplayBrightness:I
    ...
    :try_start_2
    iget-object v0, p0, mTempDisplayStateWorkQueue:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v3}, applyGlobalDisplayStateLocked(Ljava/util/List;)V
...
.method private screenshotInternal(I)Landroid/view/SurfaceControl$ScreenshotGraphicBuffer;
    ...
    invoke-direct {p0, p1}, getDisplayToken(I)Landroid/os/IBinder;
...
.method private setBrightnessConfigurationForUserInternal(Landroid/hardware/display/BrightnessConfiguration;ILjava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, validateBrightnessConfiguration(Landroid/hardware/display/BrightnessConfiguration;)V
    ...
    iget-object v2, p0, mDisplayPowerController:Lcom/android/server/display/DisplayPowerController;
...
.method private setDisplayAccessUIDsInternal(Landroid/util/SparseArray;)V
    ...
    iget-object v2, p0, mDisplayAccessUIDs:Landroid/util/SparseArray;
...
.method private setDisplayInfoOverrideFromWindowManagerInternal(ILandroid/view/DisplayInfo;)V
    ...
    invoke-direct {p0, p1, v1}, handleLogicalDisplayChanged(ILcom/android/server/display/LogicalDisplay;)V
...
.method private setDisplayPropertiesInternal(IZFIZ)V
    ...
    :cond_3
    iget-object v2, p0, mDisplayModeDirector:Lcom/android/server/display/DisplayModeDirector;
...
.method private setStableDisplaySizeLocked(II)V
    ...
    iput-object v0, p0, mStableDisplaySize:Landroid/graphics/Point;
...
.method private startWifiDisplayScanInternal(I)V
    ...
    invoke-direct {p0, v1}, startWifiDisplayScanLocked(Lcom/android/server/display/DisplayManagerService$CallbackRecord;)V
...
.method private stopWifiDisplayScanInternal(I)V
    ...
    invoke-direct {p0, v1}, stopWifiDisplayScanLocked(Lcom/android/server/display/DisplayManagerService$CallbackRecord;)V
...
.method private stopWifiDisplayScanLocked(Lcom/android/server/display/DisplayManagerService$CallbackRecord;)V
    ...
    iget v1, p0, mWifiDisplayScanRequestCount:I
...
.method private updateLogicalDisplaysLocked()Z
    ...
    iget-object v4, p0, mTempDisplayInfo:Landroid/view/DisplayInfo;
    ...
    invoke-direct {p0, v1, v4}, sendDisplayEventLocked(II)V
    ...
    invoke-direct {p0, v1, v3}, handleLogicalDisplayChanged(ILcom/android/server/display/LogicalDisplay;)V
...
.method getMinimumBrightnessCurveInternal()Landroid/hardware/display/Curve;
    ...
    iget-object v0, p0, mMinimumBrightnessCurve:Landroid/hardware/display/Curve;
...
.method getPreferredWideGamutColorSpaceIdInternal()I
    ...
    iget-object v0, p0, mWideColorSpace:Landroid/graphics/ColorSpace;
...
.method public onBootPhase(I)V
    ...
    iget-object v3, p0, mInjector:Lcom/android/server/display/DisplayManagerService$Injector;
    ...
    iget-object v3, p0, mVirtualDisplayAdapter:Lcom/android/server/display/VirtualDisplayAdapter;
    ...
    iget-object v4, p0, mVirtualDisplayAdapter:Lcom/android/server/display/VirtualDisplayAdapter;
...
.method public onStart()V
    ...
    invoke-direct {p0}, loadStableDisplayValuesLocked()V
    ...
    invoke-virtual {p0, v2, v0, v1}, publishBinderService(Ljava/lang/String;Landroid/os/IBinder;Z)V
...
.method performTraversalInternal(Landroid/view/SurfaceControl$Transaction;)V
    ...
    :try_start_0
    iget-boolean v1, p0, mPendingTraversal:Z
    ...
    iput-boolean v1, p0, mPendingTraversal:Z

    invoke-direct {p0, p1}, performTraversalLocked(Landroid/view/SurfaceControl$Transaction;)V
...
.method public systemReady(ZZ)V
    ...
    invoke-direct {p0, v1}, recordTopInsetLocked(Lcom/android/server/display/LogicalDisplay;)V

    monitor-exit v0
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object v0, p0, mDisplayModeDirector:Lcom/android/server/display/DisplayModeDirector;
...
.method validateBrightnessConfiguration(Landroid/hardware/display/BrightnessConfiguration;)V
    ...
    :cond_0
    invoke-direct {p0, p1}, isBrightnessConfigurationTooDark(Landroid/hardware/display/BrightnessConfiguration;)Z
...
.method public windowManagerAndInputReady()V
    ...
    iput-object v1, p0, mInputManagerInternal:Landroid/hardware/input/InputManagerInternal;
