...
.method static constructor <clinit>()V
    ...
    sput-object v0, PLOG:Lcom/android/server/display/utils/Plog;
...
.method static synthetic access$000()Lcom/android/server/display/utils/Plog;
    ...
    sget-object v0, PLOG:Lcom/android/server/display/utils/Plog;
...
.method public static create(Landroid/content/res/Resources;)Lcom/android/server/display/BrightnessMappingStrategy;
    ...
    invoke-static {v1}, getLuxLevels([I)[F
    ...
    :goto_1
    invoke-static {v13, v14}, isValidMapping([F[I)Z

    move-result v6

    if-eqz v6, :cond_6

    invoke-static {v1, v3}, isValidMapping([F[F)Z
    ...
    :cond_6
    invoke-static {v1, v2}, isValidMapping([F[I)Z
...
.method private insertControlPoint([F[FFF)Landroid/util/Pair;
    ...
    invoke-direct {p0, p1, p3}, findInsertionPoint([FF)I
    ...
    :goto_0
    invoke-direct {p0, v1, v2, v0}, smoothCurve([F[FI)V
...
.method private smoothCurve([F[FI)V
    ...
    invoke-direct {p0, v3, v0}, permissibleRatio(FF)F
    ...
    sget-object v2, PLOG:Lcom/android/server/display/utils/Plog;
...
.method protected getAdjustedCurve([F[FFFFF)Landroid/util/Pair;
    ...
    invoke-direct {p0, v0, v1, p3, p4}, insertControlPoint([F[FFF)Landroid/util/Pair;
    ...
    sget-object v3, PLOG:Lcom/android/server/display/utils/Plog;
    ...
    invoke-direct {p0, p1, p2, p3, p4}, insertControlPoint([F[FFF)Landroid/util/Pair;
...
.method public getBrightness(F)F
    ...
    invoke-virtual {p0, p1, v0, v1}, getBrightness(FLjava/lang/String;I)F
...
.method public getHBMBrightness(F)F
    ...
    invoke-virtual {p0, p1, v0, v1}, getHBMBrightness(FLjava/lang/String;I)F
