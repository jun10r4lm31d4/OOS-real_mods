...
.method constructor <init>()V
    ...
    iput-object v0, p0, mDisplayNominalWhiteXYZ:[F

    const/4 v0, 0x0

    iput-boolean v0, p0, mSetUp:Z

    const/16 v0, 0x10

    new-array v0, v0, [F

    iput-object v0, p0, mMatrixDisplayWhiteBalance:[F
...
.method private getDisplayColorSpaceFromResources(Landroid/content/res/Resources;)Landroid/graphics/ColorSpace$Rgb;
    ...
    :cond_1
    invoke-direct {p0, v1, v2}, makeRgbColorSpaceFromXYZ([F[F)Landroid/graphics/ColorSpace$Rgb;
...
.method private getDisplayColorSpaceFromSurfaceControl()Landroid/graphics/ColorSpace$Rgb;
    ...
    invoke-direct {p0, v1, v3}, makeRgbColorSpaceFromXYZ([F[F)Landroid/graphics/ColorSpace$Rgb;
...
.method private isColorMatrixValid([F)Z
    ...
    invoke-direct {p0, v2}, isColorMatrixCoeffValid(F)Z
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    iget v2, p0, mTemperatureDefault:I
    ...
    iget v2, p0, mCurrentColorTemperature:I
    ...
    iget-object v2, p0, mCurrentColorTemperatureXYZ:[F

    const/4 v3, 0x3

    invoke-direct {p0, v2, v3}, matrixToString([FI)Ljava/lang/String;
    ...
    iget-object v2, p0, mDisplayColorSpaceRGB:Landroid/graphics/ColorSpace$Rgb;
    ...
    iget-object v2, p0, mChromaticAdaptationMatrix:[F
    ...
    iget-object v2, p0, mMatrixDisplayWhiteBalance:[F
...
.method public getMatrix()[F
    ...
    iget-object v0, p0, mMatrixDisplayWhiteBalance:[F
...
.method public setMatrix(I)V
    ...
    iget p1, p0, mTemperatureMin:I

    goto :goto_0

    :cond_1
    iget v0, p0, mTemperatureMax:I
    ...
    iget-object v11, p0, mMatrixDisplayWhiteBalance:[F
    ...
    invoke-direct {p0, v12}, isColorMatrixCoeffValid(F)Z
...
.method public setUp(Landroid/content/Context;Z)V
    ...
    invoke-direct {p0}, getDisplayColorSpaceFromSurfaceControl()Landroid/graphics/ColorSpace$Rgb;
    ...
    invoke-direct {p0, v0}, getDisplayColorSpaceFromResources(Landroid/content/res/Resources;)Landroid/graphics/ColorSpace$Rgb;
    ...
    invoke-direct {p0, v2}, isColorMatrixValid([F)Z
    ...
    :try_start_0
    iput-object v1, p0, mDisplayColorSpaceRGB:Landroid/graphics/ColorSpace$Rgb;

    iput-object v3, p0, mDisplayNominalWhiteXYZ:[F

    iput v4, p0, mTemperatureMin:I

    iput v5, p0, mTemperatureMax:I

    iput v6, p0, mTemperatureDefault:I

    const/4 v8, 0x1

    iput-boolean v8, p0, mSetUp:Z

    monitor-exit v7
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget v7, p0, mTemperatureDefault:I

    invoke-virtual {p0, v7}, setMatrix(I)V
