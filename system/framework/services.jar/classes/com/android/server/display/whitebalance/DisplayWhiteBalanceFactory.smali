...
.method public static create(Landroid/os/Handler;Landroid/hardware/SensorManager;Landroid/content/res/Resources;)Lcom/android/server/display/whitebalance/DisplayWhiteBalanceController;
    ...
    invoke-static/range {p0 .. p2}, createBrightnessSensor(Landroid/os/Handler;Landroid/hardware/SensorManager;Landroid/content/res/Resources;)Lcom/android/server/display/whitebalance/AmbientSensor$AmbientBrightnessSensor;

    move-result-object v11

    invoke-static/range {p2 .. p2}, createBrightnessFilter(Landroid/content/res/Resources;)Lcom/android/server/display/whitebalance/AmbientFilter;

    move-result-object v12

    nop

    invoke-static/range {p0 .. p2}, createColorTemperatureSensor(Landroid/os/Handler;Landroid/hardware/SensorManager;Landroid/content/res/Resources;)Lcom/android/server/display/whitebalance/AmbientSensor$AmbientColorTemperatureSensor;

    move-result-object v13

    invoke-static/range {p2 .. p2}, createColorTemperatureFilter(Landroid/content/res/Resources;)Lcom/android/server/display/whitebalance/AmbientFilter;

    move-result-object v14

    invoke-static/range {p2 .. p2}, createThrottler(Landroid/content/res/Resources;)Lcom/android/server/display/whitebalance/DisplayWhiteBalanceThrottler;

    move-result-object v15

    const v1, 0x10500a0

    invoke-static {v0, v1}, getFloat(Landroid/content/res/Resources;I)F
    ...
    invoke-static {v0, v1}, getFloatArray(Landroid/content/res/Resources;I)[F
...
.method static createBrightnessFilter(Landroid/content/res/Resources;)Lcom/android/server/display/whitebalance/AmbientFilter;
    ...
    invoke-static {p0, v1}, getFloat(Landroid/content/res/Resources;I)F
...
.method private static createThrottler(Landroid/content/res/Resources;)Lcom/android/server/display/whitebalance/DisplayWhiteBalanceThrottler;
    ...
    invoke-static {p0, v1}, getFloatArray(Landroid/content/res/Resources;I)[F
