...
.method private constructor <init>()V
    ...
    iput-object v0, p0, mControllerRefs:Ljava/util/List;

    const/16 v0, 0x64

    iput v0, p0, mSaturationLevel:I

    const/16 v0, 0x9

    new-array v0, v0, [F

    iput-object v0, p0, mTransformMatrix:[F
...
.method static synthetic access$000(Lcom/android/server/display/color/AppSaturationController$SaturationController;Ljava/lang/ref/WeakReference;)Z
    ...
    invoke-direct {p0, p1}, addColorTransformController(Ljava/lang/ref/WeakReference;)Z
...
.method static synthetic access$100(Lcom/android/server/display/color/AppSaturationController$SaturationController;I)Z
    ...
    invoke-direct {p0, p1}, setSaturationLevel(I)Z
...
.method private addColorTransformController(Ljava/lang/ref/WeakReference;)Z
    ...
    iget-object v0, p0, mControllerRefs:Ljava/util/List;

    invoke-interface {v0, p1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    iget v0, p0, mSaturationLevel:I

    const/16 v1, 0x64

    if-eq v0, v1, :cond_0

    invoke-direct {p0}, updateState()Z
    ...
    :cond_0
    invoke-direct {p0}, clearExpiredReferences()V
...
.method private dump(Ljava/io/PrintWriter;)V
    ...
    iget-object v1, p0, mControllerRefs:Ljava/util/List;
...
.method private updateState()Z
    ...
    iget-object v1, p0, mTransformMatrix:[F
    ...
    iget-object v4, p0, mTransformMatrix:[F
