...
.method static constructor <clinit>()V
    ...
    sput-wide v3, LUX_EVENT_HORIZON:J
    ...
    sput-wide v0, COLOR_SAMPLE_DURATION:J
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/display/BrightnessTracker$Injector;)V
    ...
    iput-object v0, p0, mEventsLock:Ljava/lang/Object;
    ...
    iput-object v0, p0, mEvents:Lcom/android/internal/util/RingBuffer;
    ...
    iput-object v0, p0, mDataCollectionLock:Ljava/lang/Object;

    new-instance v0, Ljava/util/ArrayDeque;

    invoke-direct {v0}, Ljava/util/ArrayDeque;-><init>()V

    iput-object v0, p0, mLastSensorReadings:Ljava/util/Deque;

    const/high16 v0, 0x7fc00000    # Float.NaN

    iput v0, p0, mLastBatteryLevel:F

    const/high16 v0, -0x40800000    # -1.0f

    iput v0, p0, mLastBrightness:F
    ...
    iput-object p2, p0, mInjector:Lcom/android/server/display/BrightnessTracker$Injector;
    ...
    iput-object v0, p0, mInjector:Lcom/android/server/display/BrightnessTracker$Injector;

    :goto_0
    new-instance v0, Lcom/android/server/display/BrightnessTracker$TrackerHandler;

    iget-object v1, p0, mInjector:Lcom/android/server/display/BrightnessTracker$Injector;
...
.method static synthetic access$1000(Lcom/android/server/display/BrightnessTracker;)V
    ...
    invoke-direct {p0}, scheduleWriteBrightnessTrackerState()V
...
.method static synthetic access$1100(Lcom/android/server/display/BrightnessTracker;II)V
    ...
    invoke-direct {p0, p1, p2}, batteryLevelChanged(II)V
...
.method static synthetic access$1200(Lcom/android/server/display/BrightnessTracker;F)V
    ...
    invoke-direct {p0, p1}, backgroundStart(F)V
...
.method static synthetic access$1300(Lcom/android/server/display/BrightnessTracker;FZFZZJ)V
    ...
    invoke-direct/range {p0 .. p7}, handleBrightnessChanged(FZFZZJ)V
...
.method static synthetic access$1400(Lcom/android/server/display/BrightnessTracker;)V
    ...
    invoke-direct {p0}, startSensorListener()V
...
.method static synthetic access$1500(Lcom/android/server/display/BrightnessTracker;)V
    ...
    invoke-direct {p0}, enableColorSampling()V
...
.method static synthetic access$1600(Lcom/android/server/display/BrightnessTracker;)V
    ...
    invoke-direct {p0}, stopSensorListener()V
...
.method static synthetic access$1700(Lcom/android/server/display/BrightnessTracker;)V
    ...
    invoke-direct {p0}, disableColorSampling()V
...
.method static synthetic access$400(Lcom/android/server/display/BrightnessTracker;Landroid/hardware/SensorEvent;)V
    ...
    invoke-direct {p0, p1}, recordSensorEvent(Landroid/hardware/SensorEvent;)V
...
.method static synthetic access$500(Lcom/android/server/display/BrightnessTracker;Landroid/hardware/SensorEvent;)V
    ...
    invoke-direct {p0, p1}, recordAmbientBrightnessStats(Landroid/hardware/SensorEvent;)V
...
.method static synthetic access$600(Lcom/android/server/display/BrightnessTracker;)V
    ...
    invoke-direct {p0}, updateColorSampling()V
...
.method static synthetic access$800(Lcom/android/server/display/BrightnessTracker;)Lcom/android/server/display/BrightnessTracker$Injector;
    ...
    iget-object v0, p0, mInjector:Lcom/android/server/display/BrightnessTracker$Injector;
...
.method static synthetic access$900(Lcom/android/server/display/BrightnessTracker;)Landroid/os/Handler;
    ...
    iget-object v0, p0, mBgHandler:Landroid/os/Handler;
...
.method private backgroundStart(F)V
    ...
    invoke-direct {p0}, readEvents()V

    invoke-direct {p0}, readAmbientBrightnessStats()V
    ...
    iput-object v0, p0, mSensorListener:Lcom/android/server/display/BrightnessTracker$SensorListener;

    new-instance v0, Lcom/android/server/display/BrightnessTracker$SettingsObserver;

    iget-object v2, p0, mBgHandler:Landroid/os/Handler;
    ...
    iput-object v0, p0, mSettingsObserver:Lcom/android/server/display/BrightnessTracker$SettingsObserver;

    iget-object v0, p0, mInjector:Lcom/android/server/display/BrightnessTracker$Injector;

    iget-object v2, p0, mContentResolver:Landroid/content/ContentResolver;

    iget-object v3, p0, mSettingsObserver:Lcom/android/server/display/BrightnessTracker$SettingsObserver;
    ...
    iget-object v1, p0, mDataCollectionLock:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iput p1, p0, mLastBrightness:F
...
.method private batteryLevelChanged(II)V
    ...
    iget-object v0, p0, mDataCollectionLock:Ljava/lang/Object;
    ...
    :try_start_0
    iput v1, p0, mLastBatteryLevel:F
...
.method private disableColorSampling()V
    ...
    iget-boolean v0, p0, mColorSamplingEnabled:Z
    ...
    iput-boolean v1, p0, mColorSamplingEnabled:Z

    iget-object v0, p0, mDisplayListener:Lcom/android/server/display/BrightnessTracker$DisplayListener;
    ...
    iput-object v0, p0, mDisplayListener:Lcom/android/server/display/BrightnessTracker$DisplayListener;
...
.method private dumpLocal(Ljava/io/PrintWriter;)V
    ...
    iget-boolean v1, p0, mSensorRegistered:Z
    ...
    iget-boolean v1, p0, mColorSamplingEnabled:Z
    ...
    iget v1, p0, mNoFramesToSample:I
...
.method private enableColorSampling()V
    ...
    iput v0, p0, mFrameRate:F

    iget v0, p0, mFrameRate:F
    ...
    :cond_1
    sget-wide v1, COLOR_SAMPLE_DURATION:J
    ...
    iput v0, p0, mNoFramesToSample:I
    ...
    iget v3, p0, mNoFramesToSample:I
    ...
    iget-object v1, p0, mDisplayListener:Lcom/android/server/display/BrightnessTracker$DisplayListener;
    ...
    iput-object v1, p0, mDisplayListener:Lcom/android/server/display/BrightnessTracker$DisplayListener;

    iget-object v1, p0, mInjector:Lcom/android/server/display/BrightnessTracker$Injector;

    iget-object v2, p0, mContext:Landroid/content/Context;

    iget-object v3, p0, mDisplayListener:Lcom/android/server/display/BrightnessTracker$DisplayListener;

    iget-object v4, p0, mBgHandler:Landroid/os/Handler;
...
.method private handleBrightnessChanged(FZFZZJ)V
    ...
    iget-object v3, v1, mDataCollectionLock:Ljava/lang/Object;

    monitor-enter v3

    :try_start_0
    iget-boolean v0, v1, mStarted:Z
    ...
    :cond_0
    iget v0, v1, mLastBrightness:F

    iput v2, v1, mLastBrightness:F
    ...
    iget-object v10, v1, mLastSensorReadings:Ljava/util/Deque;
    ...
    iget-object v14, v1, mInjector:Lcom/android/server/display/BrightnessTracker$Injector;

    invoke-virtual {v14}, Lcom/android/server/display/BrightnessTracker$Injector;->currentTimeMillis()J

    move-result-wide v14

    iget-object v2, v1, mInjector:Lcom/android/server/display/BrightnessTracker$Injector;

    invoke-virtual {v2}, Lcom/android/server/display/BrightnessTracker$Injector;->elapsedRealtimeNanos()J

    move-result-wide v16

    iget-object v2, v1, mLastSensorReadings:Ljava/util/Deque;
    ...
    iget v2, v1, mLastBatteryLevel:F
    ...
    :try_start_3
    iget-object v0, v1, mInjector:Lcom/android/server/display/BrightnessTracker$Injector;
    ...
    iget-boolean v0, v1, mColorSamplingEnabled:Z

    if-eqz v0, :cond_4

    iget-object v0, v1, mInjector:Lcom/android/server/display/BrightnessTracker$Injector;

    iget v2, v1, mNoFramesToSample:I
    ...
    iget-object v3, v1, mEventsLock:Ljava/lang/Object;
    ...
    :try_start_4
    iput-boolean v0, v1, mEventsDirty:Z

    iget-object v0, v1, mEvents:Lcom/android/internal/util/RingBuffer;
...
.method private readAmbientBrightnessStats()V
    ...
    iput-object v0, p0, mAmbientBrightnessStatsTracker:Lcom/android/server/display/AmbientBrightnessStatsTracker;
    ...
    iget-object v2, p0, mAmbientBrightnessStatsTracker:Lcom/android/server/display/AmbientBrightnessStatsTracker;
...
.method private readEvents()V
    ...
    iget-object v0, p0, mEventsLock:Ljava/lang/Object;
    ...
    :try_start_0
    iput-boolean v1, p0, mEventsDirty:Z

    iget-object v1, p0, mEvents:Lcom/android/internal/util/RingBuffer;
    ...
    invoke-virtual {p0, v2}, readEventsLocked(Ljava/io/InputStream;)V
    :try_end_1
...
.method private recordAmbientBrightnessStats(Landroid/hardware/SensorEvent;)V
    ...
    iget-object v0, p0, mAmbientBrightnessStatsTracker:Lcom/android/server/display/AmbientBrightnessStatsTracker;
...
.method private recordSensorEvent(Landroid/hardware/SensorEvent;)V
    ...
    sget-wide v2, LUX_EVENT_HORIZON:J

    sub-long/2addr v0, v2

    iget-object v2, p0, mDataCollectionLock:Ljava/lang/Object;

    monitor-enter v2

    :try_start_0
    iget-object v3, p0, mLastSensorReadings:Ljava/util/Deque;
    ...
    iget-object v5, p0, mLastSensorReadings:Ljava/util/Deque;
    ...
    iget-object v4, p0, mLastSensorReadings:Ljava/util/Deque;
...
.method private scheduleWriteBrightnessTrackerState()V
    ...
    iget-boolean v0, p0, mWriteBrightnessTrackerStateScheduled:Z
    ...
    iput-boolean v0, p0, mWriteBrightnessTrackerStateScheduled:Z
...
.method private startSensorListener()V
    ...
    iget-boolean v0, p0, mSensorRegistered:Z
    ...
    iput-boolean v0, p0, mSensorRegistered:Z

    iget-object v0, p0, mInjector:Lcom/android/server/display/BrightnessTracker$Injector;

    iget-object v1, p0, mContext:Landroid/content/Context;

    iget-object v2, p0, mSensorListener:Lcom/android/server/display/BrightnessTracker$SensorListener;
...
.method private writeEvents()V
    ...
    :try_start_0
    iget-boolean v1, p0, mEventsDirty:Z
    ...
    :cond_1
    iget-object v2, p0, mEvents:Lcom/android/internal/util/RingBuffer;
    ...
    :cond_2
    iput-boolean v3, p0, mEventsDirty:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-virtual {p0, v2}, writeEventsLocked(Ljava/io/OutputStream;)V
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    iget v2, p0, mLastBatteryLevel:F
    ...
    iget-object v2, p0, mLastSensorReadings:Ljava/util/Deque;
    ...
    iget-object v1, p0, mLastSensorReadings:Ljava/util/Deque;
    ...
    iget-object v1, p0, mEventsLock:Ljava/lang/Object;
    ...
    iget-boolean v2, p0, mEventsDirty:Z
    ...
    iget-object v0, p0, mEvents:Lcom/android/internal/util/RingBuffer;
    ...
    sget-object v5, FORMAT:Ljava/text/SimpleDateFormat;
    ...
    iget-boolean v1, p0, mWriteBrightnessTrackerStateScheduled:Z
...
.method public synthetic lambda$scheduleWriteBrightnessTrackerState$0$BrightnessTracker()V
    ...
    invoke-direct {p0}, writeEvents()V

    invoke-direct {p0}, writeAmbientBrightnessStats()V
...
.method public notifyBrightnessChanged(FZFZZ)V
    ...
    iget-object v2, p0, mInjector:Lcom/android/server/display/BrightnessTracker$Injector;
...
.method readEventsLocked(Ljava/io/InputStream;)V
    ...
    iget-object v7, v1, mInjector:Lcom/android/server/display/BrightnessTracker$Injector;

    invoke-virtual {v7}, Lcom/android/server/display/BrightnessTracker$Injector;->currentTimeMillis()J

    move-result-wide v7

    sget-wide v9, MAX_EVENT_AGE:J
    ...
    iget-object v15, v1, mInjector:Lcom/android/server/display/BrightnessTracker$Injector;
    ...
    iget-object v2, v1, mEvents:Lcom/android/internal/util/RingBuffer;
    ...
    iput-object v2, v1, mEvents:Lcom/android/internal/util/RingBuffer;
...
.method stop()V
    ...
    iget-object v3, p0, mSensorListener:Lcom/android/server/display/BrightnessTracker$SensorListener;
...
.method writeEventsLocked(Ljava/io/OutputStream;)V
    ...
    iget-object v4, v0, mEvents:Lcom/android/internal/util/RingBuffer;
    ...
    iget-object v6, v0, mEvents:Lcom/android/internal/util/RingBuffer;

    invoke-virtual {v6}, Lcom/android/internal/util/RingBuffer;->clear()V

    iget-object v6, v0, mInjector:Lcom/android/server/display/BrightnessTracker$Injector;

    invoke-virtual {v6}, Lcom/android/server/display/BrightnessTracker$Injector;->currentTimeMillis()J

    move-result-wide v6

    sget-wide v8, MAX_EVENT_AGE:J
    ...
    iget-object v9, v0, mInjector:Lcom/android/server/display/BrightnessTracker$Injector;

    iget-object v10, v0, mUserManager:Landroid/os/UserManager;
    ...
    iget-object v10, v0, mEvents:Lcom/android/internal/util/RingBuffer;
