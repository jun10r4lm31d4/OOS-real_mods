...
.method public constructor <init>(Lcom/android/server/display/DisplayPowerState;)V
    ...
    iput v0, p0, mPendingBacklight:I

    iput p1, p0, mActualState:I
...
.method public run()V
    ...
    :goto_1
    iget v5, p0, mPendingBacklight:I

    iget v6, p0, mActualBacklight:I
    ...
    iput-boolean v4, p0, mStateChangeInProgress:Z

    :cond_2
    if-nez v3, :cond_3

    iput-boolean v4, p0, mBacklightChangeInProgress:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_4
    iput v1, p0, mActualState:I

    iput v5, p0, mActualBacklight:I
...
.method public setState(II)Z
    ...
    :goto_0
    iget v4, p0, mPendingBacklight:I
    ...
    iget-boolean v5, p0, mStateChangeInProgress:Z

    if-nez v5, :cond_5

    iget-boolean v5, p0, mBacklightChangeInProgress:Z
    ...
    :goto_5
    iput-boolean v6, p0, mStateChangeInProgress:Z
    ...
    :goto_7
    iput-boolean v6, p0, mBacklightChangeInProgress:Z
