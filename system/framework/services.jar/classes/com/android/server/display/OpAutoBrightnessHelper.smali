...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput v0, p0, mEnterLux:F

    const/4 v1, -0x1

    iput v1, p0, mExtremeState:I

    iput v1, p0, mOrigBrightnessLevel:I

    iput v1, p0, mAdjustedBrightnessLevel:I

    iput v0, p0, mLuxWhileAdjustment:F

    const/4 v0, 0x0

    iput v0, p0, mOptFuncOn:I

    const/4 v0, 0x1

    iput v0, p0, MSG_LOAD_BRIGHTNESS_CONF:I

    const/4 v1, 0x2

    iput v1, p0, MSG_STORE_BRIGHTNESS_CONF:I

    const-string v1, "/mnt/vendor/persist/display/BrightnessStatics"

    iput-object v1, p0, BRIGHTNESS_STATIC_FILE:Ljava/lang/String;
    ...
    iput-object v1, p0, mTime:Landroid/text/format/Time;

    new-instance v1, Landroid/text/format/Time;

    invoke-direct {v1}, Landroid/text/format/Time;-><init>()V

    iput-object v1, p0, mEnterTime:Landroid/text/format/Time;
...
.method static synthetic access$000(Lcom/android/server/display/OpAutoBrightnessHelper;)Lcom/android/server/display/BrightnessStaticBeans;
    ...
    iget-object v0, p0, mBrightnessUsageBean:Lcom/android/server/display/BrightnessStaticBeans;
...
.method static synthetic access$002(Lcom/android/server/display/OpAutoBrightnessHelper;Lcom/android/server/display/BrightnessStaticBeans;)Lcom/android/server/display/BrightnessStaticBeans;
    ...
    iput-object p1, p0, mBrightnessUsageBean:Lcom/android/server/display/BrightnessStaticBeans;
...
.method static synthetic access$100(Lcom/android/server/display/OpAutoBrightnessHelper;)I
    ...
    invoke-direct {p0}, currentHour()I
...
.method static synthetic access$200(Lcom/android/server/display/OpAutoBrightnessHelper;)Z
    ...
    invoke-direct {p0}, nightModeEnabled()Z
...
.method static synthetic access$300(Lcom/android/server/display/OpAutoBrightnessHelper;)I
    ...
    invoke-direct {p0}, nightModeCct()I
...
.method static synthetic access$400(Lcom/android/server/display/OpAutoBrightnessHelper;)I
    ...
    invoke-direct {p0}, nightModeBrightness()I
...
.method static synthetic access$500(Lcom/android/server/display/OpAutoBrightnessHelper;)Z
    ...
    invoke-direct {p0}, darkThemeEnabled()Z
...
.method private calculateDuration()J
    ...
    iget-object v4, p0, mEnterTime:Landroid/text/format/Time;
...
.method private currentHour()I
    ...
    iget-object v0, p0, mTime:Landroid/text/format/Time;
...
.method private getHandler()Landroid/os/Handler;
    ...
    iget-object v0, p0, sHandlerThread:Landroid/os/HandlerThread;
    ...
    iput-object v0, p0, sHandlerThread:Landroid/os/HandlerThread;
    ...
    iget-object v1, p0, sHandlerThread:Landroid/os/HandlerThread;
    ...
    iput-object v0, p0, sHandler:Landroid/os/Handler;

    :cond_0
    iget-object v0, p0, sHandler:Landroid/os/Handler;
...
.method public static getInstance(Landroid/content/Context;)Lcom/android/server/display/OpAutoBrightnessHelper;
    ...
    sget-object v0, sOpAutoBrightnessHelper:Lcom/android/server/display/OpAutoBrightnessHelper;
    ...
    sput-object v0, sOpAutoBrightnessHelper:Lcom/android/server/display/OpAutoBrightnessHelper;
...
.method private getScreenRGB()I
    ...
    invoke-direct {p0}, getSurfaceFlinger()Landroid/os/IBinder;
...
.method private setEnterTime()V
    ...
    iget-object v0, p0, mEnterTime:Landroid/text/format/Time;
...
.method public addRecord(JJ)V
    ...
    invoke-virtual/range {v0 .. v6}, addRecord(JJJ)V
...
.method public adjustBrightness(FII)V
    ...
    iput p1, p0, mLuxWhileAdjustment:F

    iput p2, p0, mOrigBrightnessLevel:I

    iput p3, p0, mAdjustedBrightnessLevel:I

    iget-object v1, p0, mPackageName:Ljava/lang/String;

    invoke-direct {p0}, getScreenRGB()I
    ...
    invoke-direct/range {v0 .. v5}, reportAdjustEvent(Ljava/lang/String;Ljava/lang/String;FII)V
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    iget v1, p0, mOrigBrightnessLevel:I
    ...
    iget v1, p0, mAdjustedBrightnessLevel:I
...
.method public enterExtremeState(FI)V
    ...
    invoke-direct {p0}, setEnterTime()V

    iput p1, p0, mEnterLux:F

    iput p2, p0, mExtremeState:I
...
.method public exitExtremeState()V
    ...
    invoke-direct {p0}, calculateDuration()J

    move-result-wide v3

    iget v5, p0, mEnterLux:F

    iget v6, p0, mExtremeState:I
    ...
    invoke-direct/range {v1 .. v7}, reportExtremeEvent(Ljava/lang/String;JFILjava/lang/String;)V
