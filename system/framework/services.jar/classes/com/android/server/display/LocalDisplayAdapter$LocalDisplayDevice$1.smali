...
.method constructor <init>(Lcom/android/server/display/LocalDisplayAdapter$LocalDisplayDevice;IIZIJLandroid/os/IBinder;)V
    ...
    iput-boolean p4, p0, val$brightnessChanged:Z

    iput p5, p0, val$brightness:I

    iput-wide p6, p0, val$physicalDisplayId:J

    iput-object p8, p0, val$token:Landroid/os/IBinder;
...
.method private setDisplayBrightness(I)V
    ...
    iget-wide v1, p0, val$physicalDisplayId:J
...
.method private setDisplayState(I)V
    ...
    iget-wide v5, p0, val$physicalDisplayId:J
    ...
    iget-object v1, p0, this$1:Lcom/android/server/display/LocalDisplayAdapter$LocalDisplayDevice;
    ...
    iget-object v4, p0, this$1:Lcom/android/server/display/LocalDisplayAdapter$LocalDisplayDevice;
...
.method public run()V
    ...
    :goto_3
    invoke-direct {p0, v2}, setVrMode(Z)V

    const/4 v1, 0x1

    :cond_9
    iget-boolean v2, p0, val$brightnessChanged:Z
    ...
    :cond_a
    iget v2, p0, val$brightness:I

    invoke-direct {p0, v2}, setDisplayBrightness(I)V
    ...
    invoke-direct {p0, v2}, setDisplayState(I)V
