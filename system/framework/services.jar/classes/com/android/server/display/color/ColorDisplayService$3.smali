...
.method constructor <init>(Lcom/android/server/display/color/ColorDisplayService;Lcom/android/server/display/color/DisplayTransformManager;Lcom/android/server/display/color/TintController;[F)V
    ...
    iput-object p2, p0, val$dtm:Lcom/android/server/display/color/DisplayTransformManager;

    iput-object p3, p0, val$tintController:Lcom/android/server/display/color/TintController;

    iput-object p4, p0, val$to:[F
...
.method public onAnimationEnd(Landroid/animation/Animator;)V
    ...
    iget-boolean v0, p0, mIsCancelled:Z

    if-nez v0, :cond_0

    iget-object v0, p0, val$dtm:Lcom/android/server/display/color/DisplayTransformManager;

    iget-object v1, p0, val$tintController:Lcom/android/server/display/color/TintController;

    invoke-virtual {v1}, Lcom/android/server/display/color/TintController;->getLevel()I

    move-result v1

    iget-object v2, p0, val$to:[F

    invoke-virtual {v0, v1, v2}, Lcom/android/server/display/color/DisplayTransformManager;->setColorMatrix(I[F)V

    :cond_0
    iget-object v0, p0, val$tintController:Lcom/android/server/display/color/TintController;
