...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0}, <init>(Lcom/android/server/display/PersistentDataStore$Injector;)V
...
.method constructor <init>(Lcom/android/server/display/PersistentDataStore$Injector;)V
    ...
    iput-object v0, p0, mDisplayStates:Ljava/util/HashMap;
    ...
    iput-object v0, p0, mStableDeviceValues:Lcom/android/server/display/PersistentDataStore$StableDeviceValues;
    ...
    iput-object v0, p0, mBrightnessConfigurations:Lcom/android/server/display/PersistentDataStore$BrightnessConfigurations;

    iput-object p1, p0, mInjector:Lcom/android/server/display/PersistentDataStore$Injector;
...
.method private getDisplayState(Ljava/lang/String;Z)Lcom/android/server/display/PersistentDataStore$DisplayState;
    ...
    invoke-virtual {p0}, loadIfNeeded()V

    iget-object v0, p0, mDisplayStates:Ljava/util/HashMap;
    ...
    iget-object v1, p0, mDisplayStates:Ljava/util/HashMap;
...
.method private load()V
    ...
    :try_start_0
    iget-object v2, p0, mInjector:Lcom/android/server/display/PersistentDataStore$Injector;
    ...
    invoke-direct {p0, v3}, loadFromXml(Lorg/xmlpull/v1/XmlPullParser;)V
    :try_end_1
...
.method private loadDisplaysFromXml(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    iget-object v3, p0, mDisplayStates:Ljava/util/HashMap;
...
.method private loadFromXml(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    invoke-direct {p0, p1}, loadDisplaysFromXml(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    iget-object v1, p0, mStableDeviceValues:Lcom/android/server/display/PersistentDataStore$StableDeviceValues;
    ...
    iget-object v1, p0, mBrightnessConfigurations:Lcom/android/server/display/PersistentDataStore$BrightnessConfigurations;
...
.method private loadRememberedWifiDisplaysFromXml(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    iget-object v11, p0, mRememberedWifiDisplays:Ljava/util/ArrayList;
...
.method private save()V
    ...
    :try_start_0
    iget-object v0, p0, mInjector:Lcom/android/server/display/PersistentDataStore$Injector;
    ...
    iget-object v3, p0, mInjector:Lcom/android/server/display/PersistentDataStore$Injector;
...
.method private saveToXml(Lorg/xmlpull/v1/XmlSerializer;)V
    ...
    iget-object v3, p0, mRememberedWifiDisplays:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, mStableDeviceValues:Lcom/android/server/display/PersistentDataStore$StableDeviceValues;
    ...
    iget-object v3, p0, mBrightnessConfigurations:Lcom/android/server/display/PersistentDataStore$BrightnessConfigurations;
...
.method public applyWifiDisplayAliases([Landroid/hardware/display/WifiDisplay;)[Landroid/hardware/display/WifiDisplay;
    ...
    invoke-virtual {p0, v3}, applyWifiDisplayAlias(Landroid/hardware/display/WifiDisplay;)Landroid/hardware/display/WifiDisplay;
...
.method public getBrightnessConfiguration(I)Landroid/hardware/display/BrightnessConfiguration;
    ...
    iget-object v0, p0, mBrightnessConfigurations:Lcom/android/server/display/PersistentDataStore$BrightnessConfigurations;
...
.method public getColorMode(Lcom/android/server/display/DisplayDevice;)I
    ...
    invoke-direct {p0, v0, v2}, getDisplayState(Ljava/lang/String;Z)Lcom/android/server/display/PersistentDataStore$DisplayState;
...
.method public getStableDisplaySize()Landroid/graphics/Point;
    ...
    iget-object v0, p0, mStableDeviceValues:Lcom/android/server/display/PersistentDataStore$StableDeviceValues;
