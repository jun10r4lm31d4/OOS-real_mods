...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;IIIIZLcom/android/server/display/OverlayDisplayWindow$Listener;)V
    ...
    iput v0, p0, MAX_SCALE:F

    const v1, 0x3f4ccccd    # 0.8f

    iput v1, p0, WINDOW_ALPHA:F

    const/4 v1, 0x0

    iput-boolean v1, p0, DISABLE_MOVE_AND_RESIZE:Z

    new-instance v2, Landroid/view/DisplayInfo;

    invoke-direct {v2}, Landroid/view/DisplayInfo;-><init>()V

    iput-object v2, p0, mDefaultDisplayInfo:Landroid/view/DisplayInfo;
    ...
    invoke-direct {p0, p3, p4, p5, v1}, resize(IIIZ)V
...
.method private createWindow()V
    ...
    iget-object v2, p0, mOnTouchListener:Landroid/view/View$OnTouchListener;
...
.method private updateWindowParams()V
    ...
    iget v4, p0, mWindowX:I

    int-to-float v4, v4

    iget v5, p0, mLiveTranslationX:F
    ...
    iget v5, p0, mWindowY:I

    int-to-float v5, v5

    iget v6, p0, mLiveTranslationY:F
