...
.method public constructor <init>([F[IF)V
    ...
    iput-object v2, p0, mLux:[F

    new-array v2, v0, [F

    iput-object v2, p0, mBrightness:[F
    ...
    iget-object v3, p0, mLux:[F

    aget v4, p1, v2

    aput v4, v3, v2

    iget-object v3, p0, mBrightness:[F

    aget v4, p2, v2

    invoke-virtual {p0, v4}, normalizeAbsoluteBrightness(I)F
...
.method private computeSpline()V
    ...
    iget-object v1, p0, mLux:[F

    iget-object v2, p0, mBrightness:[F

    iget v3, p0, mUserLux:F

    iget v4, p0, mUserBrightness:F

    iget v5, p0, mAutoBrightnessAdjustment:F

    iget v6, p0, mMaxGamma:F

    move-object v0, p0

    invoke-virtual/range {v0 .. v6}, getAdjustedCurve([F[FFFFF)Landroid/util/Pair;
    ...
    iput-object v1, p0, mSpline:Landroid/util/Spline;
...
.method private getUnadjustedBrightness(F)F
    ...
    iget-object v0, p0, mLux:[F

    iget-object v1, p0, mBrightness:[F
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    iget-object v1, p0, mSpline:Landroid/util/Spline;
...
.method public getBrightness(FLjava/lang/String;I)F
    ...
    iget-object v0, p0, mSpline:Landroid/util/Spline;
