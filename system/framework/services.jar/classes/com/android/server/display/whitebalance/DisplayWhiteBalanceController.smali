...
.method public constructor <init>(Lcom/android/server/display/whitebalance/AmbientSensor$AmbientBrightnessSensor;Lcom/android/server/display/whitebalance/AmbientFilter;Lcom/android/server/display/whitebalance/AmbientSensor$AmbientColorTemperatureSensor;Lcom/android/server/display/whitebalance/AmbientFilter;Lcom/android/server/display/whitebalance/DisplayWhiteBalanceThrottler;FF[F[F)V
    ...
    invoke-direct/range {p0 .. p5}, validateArguments(Lcom/android/server/display/whitebalance/AmbientSensor$AmbientBrightnessSensor;Lcom/android/server/display/whitebalance/AmbientFilter;Lcom/android/server/display/whitebalance/AmbientSensor$AmbientColorTemperatureSensor;Lcom/android/server/display/whitebalance/AmbientFilter;Lcom/android/server/display/whitebalance/DisplayWhiteBalanceThrottler;)V
    ...
    iput-object v0, p0, mCallbacks:Lcom/android/server/display/whitebalance/DisplayWhiteBalanceController$Callbacks;

    iput-object p1, p0, mBrightnessSensor:Lcom/android/server/display/whitebalance/AmbientSensor$AmbientBrightnessSensor;

    iput-object p2, p0, mBrightnessFilter:Lcom/android/server/display/whitebalance/AmbientFilter;

    iput-object p3, p0, mColorTemperatureSensor:Lcom/android/server/display/whitebalance/AmbientSensor$AmbientColorTemperatureSensor;

    iput-object p4, p0, mColorTemperatureFilter:Lcom/android/server/display/whitebalance/AmbientFilter;

    iput-object p5, p0, mThrottler:Lcom/android/server/display/whitebalance/DisplayWhiteBalanceThrottler;

    iput p6, p0, mLowLightAmbientBrightnessThreshold:F

    iput p7, p0, mLowLightAmbientColorTemperature:F

    const/high16 v1, -0x40800000    # -1.0f

    iput v1, p0, mAmbientColorTemperature:F

    iput v1, p0, mPendingAmbientColorTemperature:F

    iput v1, p0, mLastAmbientColorTemperature:F
    ...
    iput-object v2, p0, mAmbientColorTemperatureHistory:Lcom/android/server/display/utils/History;

    iput v1, p0, mAmbientColorTemperatureOverride:F
    ...
    iput-object v1, p0, mAmbientToDisplayColorTemperatureSpline:Landroid/util/Spline$LinearSpline;
    :try_end_0
    ...
    iput-object v0, p0, mAmbientToDisplayColorTemperatureSpline:Landroid/util/Spline$LinearSpline;
    ...
    iput-object v0, p0, mColorDisplayServiceInternal:Lcom/android/server/display/color/ColorDisplayService$ColorDisplayServiceInternal;
...
.method private disable()Z
    ...
    iget-object v0, p0, mBrightnessSensor:Lcom/android/server/display/whitebalance/AmbientSensor$AmbientBrightnessSensor;

    invoke-virtual {v0, v1}, Lcom/android/server/display/whitebalance/AmbientSensor$AmbientBrightnessSensor;->setEnabled(Z)Z

    iget-object v0, p0, mBrightnessFilter:Lcom/android/server/display/whitebalance/AmbientFilter;

    invoke-virtual {v0}, Lcom/android/server/display/whitebalance/AmbientFilter;->clear()V

    iget-object v0, p0, mColorTemperatureSensor:Lcom/android/server/display/whitebalance/AmbientSensor$AmbientColorTemperatureSensor;

    invoke-virtual {v0, v1}, Lcom/android/server/display/whitebalance/AmbientSensor$AmbientColorTemperatureSensor;->setEnabled(Z)Z

    iget-object v0, p0, mColorTemperatureFilter:Lcom/android/server/display/whitebalance/AmbientFilter;

    invoke-virtual {v0}, Lcom/android/server/display/whitebalance/AmbientFilter;->clear()V

    iget-object v0, p0, mThrottler:Lcom/android/server/display/whitebalance/DisplayWhiteBalanceThrottler;

    invoke-virtual {v0}, Lcom/android/server/display/whitebalance/DisplayWhiteBalanceThrottler;->clear()V

    const/high16 v0, -0x40800000    # -1.0f

    iput v0, p0, mAmbientColorTemperature:F

    iput v0, p0, mPendingAmbientColorTemperature:F

    iget-object v0, p0, mColorDisplayServiceInternal:Lcom/android/server/display/color/ColorDisplayService$ColorDisplayServiceInternal;
...
.method private enable()Z
    ...
    iget-object v1, p0, mBrightnessSensor:Lcom/android/server/display/whitebalance/AmbientSensor$AmbientBrightnessSensor;

    invoke-virtual {v1, v0}, Lcom/android/server/display/whitebalance/AmbientSensor$AmbientBrightnessSensor;->setEnabled(Z)Z

    iget-object v1, p0, mColorTemperatureSensor:Lcom/android/server/display/whitebalance/AmbientSensor$AmbientColorTemperatureSensor;
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    iget-object v1, p0, mCallbacks:Lcom/android/server/display/whitebalance/DisplayWhiteBalanceController$Callbacks;
    ...
    iget v1, p0, mLowLightAmbientBrightnessThreshold:F
    ...
    iget v1, p0, mLowLightAmbientColorTemperature:F
    ...
    iget v1, p0, mAmbientColorTemperature:F
    ...
    iget v1, p0, mPendingAmbientColorTemperature:F
    ...
    iget v1, p0, mLastAmbientColorTemperature:F
    ...
    iget-object v1, p0, mAmbientColorTemperatureHistory:Lcom/android/server/display/utils/History;
    ...
    iget v1, p0, mAmbientColorTemperatureOverride:F
    ...
    iget-object v1, p0, mAmbientToDisplayColorTemperatureSpline:Landroid/util/Spline$LinearSpline;
...
.method public onAmbientBrightnessChanged(F)V
    ...
    iget-object v2, p0, mBrightnessFilter:Lcom/android/server/display/whitebalance/AmbientFilter;

    invoke-virtual {v2, v0, v1, p1}, Lcom/android/server/display/whitebalance/AmbientFilter;->addValue(JF)Z

    invoke-virtual {p0}, updateAmbientColorTemperature()V
...
.method public onAmbientColorTemperatureChanged(F)V
    ...
    iget-object v2, p0, mColorTemperatureFilter:Lcom/android/server/display/whitebalance/AmbientFilter;
...
.method public setAmbientColorTemperatureOverride(F)Z
    ...
    iget v0, p0, mAmbientColorTemperatureOverride:F
    ...
    :cond_0
    iput p1, p0, mAmbientColorTemperatureOverride:F
...
.method public setCallbacks(Lcom/android/server/display/whitebalance/DisplayWhiteBalanceController$Callbacks;)Z
    ...
    iget-object v0, p0, mCallbacks:Lcom/android/server/display/whitebalance/DisplayWhiteBalanceController$Callbacks;
    ...
    :cond_0
    iput-object p1, p0, mCallbacks:Lcom/android/server/display/whitebalance/DisplayWhiteBalanceController$Callbacks;
...
.method public updateAmbientColorTemperature()V
    ...
    iget-object v3, p0, mAmbientToDisplayColorTemperatureSpline:Landroid/util/Spline$LinearSpline;
    ...
    :cond_0
    iget-object v3, p0, mBrightnessFilter:Lcom/android/server/display/whitebalance/AmbientFilter;

    invoke-virtual {v3, v0, v1}, Lcom/android/server/display/whitebalance/AmbientFilter;->getEstimate(J)F

    move-result v3

    iget v5, p0, mLowLightAmbientBrightnessThreshold:F
    ...
    iget-boolean v5, p0, mLoggingEnabled:Z
    ...
    iget v8, p0, mLowLightAmbientBrightnessThreshold:F
    ...
    iget v8, p0, mLowLightAmbientColorTemperature:F
    ...
    :cond_1
    iget v2, p0, mLowLightAmbientColorTemperature:F

    :cond_2
    iget v5, p0, mAmbientColorTemperatureOverride:F
    ...
    iget v6, p0, mAmbientColorTemperatureOverride:F
    ...
    :cond_3
    iget v2, p0, mAmbientColorTemperatureOverride:F
    ...
    iget-object v4, p0, mThrottler:Lcom/android/server/display/whitebalance/DisplayWhiteBalanceThrottler;
    ...
    :cond_6
    iput v2, p0, mPendingAmbientColorTemperature:F

    iget-object v4, p0, mCallbacks:Lcom/android/server/display/whitebalance/DisplayWhiteBalanceController$Callbacks;
...
.method public updateDisplayColorTemperature()V
    ...
    iget v0, p0, mLastAmbientColorTemperature:F
    ...
    iget v3, p0, mAmbientColorTemperature:F

    cmpl-float v1, v1, v3

    if-eqz v1, :cond_1

    iget v0, p0, mPendingAmbientColorTemperature:F
    ...
    iget v2, p0, mAmbientColorTemperature:F

    invoke-virtual {v1, v2}, Lcom/android/server/display/utils/History;->add(F)V

    iget-object v1, p0, mColorDisplayServiceInternal:Lcom/android/server/display/color/ColorDisplayService$ColorDisplayServiceInternal;
