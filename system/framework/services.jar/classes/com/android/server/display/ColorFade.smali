...
.method public constructor <init>(I)V
    ...
    iput-object v1, p0, mTexMatrix:[F
    ...
    invoke-static {v0}, createNativeFloatBuffer(I)Ljava/nio/FloatBuffer;

    move-result-object v1

    iput-object v1, p0, mVertexBuffer:Ljava/nio/FloatBuffer;
...
.method private attachEglContext()Z
    ...
    :cond_0
    iget-object v2, p0, mEglDisplay:Landroid/opengl/EGLDisplay;

    iget-object v3, p0, mEglContext:Landroid/opengl/EGLContext;
...
.method private captureScreenshotTextureAndSetViewport()Z
    ...
    iget-object v5, p0, mTexMatrix:[F
    ...
    iget-object v4, p0, mTexCoordBuffer:Ljava/nio/FloatBuffer;
    ...
    iget v4, p0, mDisplayWidth:I

    iget v5, p0, mDisplayHeight:I
    ...
    invoke-direct/range {v6 .. v12}, ortho(FFFFFF)V
    :try_end_5
...
.method private createEglContext()Z
    ...
    iput-object v1, p0, mEglDisplay:Landroid/opengl/EGLDisplay;
    ...
    iput-object v3, p0, mEglConfig:Landroid/opengl/EGLConfig;
    ...
    iput-object v3, p0, mEglContext:Landroid/opengl/EGLContext;
...
.method private createEglSurface()Z
    ...
    iput-object v2, p0, mEglSurface:Landroid/opengl/EGLSurface;
...
.method private createSurface()Z
    ...
    iget v2, p0, mDisplayLayerStack:I
...
.method private initGLBuffers()Z
    ...
    invoke-static {v0, v3, v3, v1, v2}, setQuad(Ljava/nio/FloatBuffer;FFFF)V
    ...
    iget-object v5, p0, mTexCoordBuffer:Ljava/nio/FloatBuffer;
...
.method private initGLShaders(Landroid/content/Context;)Z
    ...
    invoke-direct {p0, p1, v0, v1}, loadShader(Landroid/content/Context;II)I
    ...
    invoke-direct {p0, p1, v1, v2}, loadShader(Landroid/content/Context;II)I
...
.method private showSurface(F)Z
    ...
    iput-boolean v1, p0, mSurfaceVisible:Z
...
.method public draw(F)Z
    ...
    :cond_0
    iget-boolean v0, v1, mPrepared:Z
    ...
    invoke-direct {v1, v5}, showSurface(F)Z
    ...
    invoke-direct {v1, v0, v12}, drawFaded(FF)V

    const-string v12, "drawFrame"

    invoke-static {v12}, checkGlErrors(Ljava/lang/String;)Z
    ...
    :cond_5
    :try_start_1
    iget-object v3, v1, mEglDisplay:Landroid/opengl/EGLDisplay;

    iget-object v12, v1, mEglSurface:Landroid/opengl/EGLSurface;
...
.method public prepare(Landroid/content/Context;I)Z
    ...
    iput v1, p0, mDisplayLayerStack:I
    ...
    iput-boolean v1, p0, mCreatedResources:Z
