...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, DEBUG_BACKLIGHT:Z
...
.method public constructor <init>(Lcom/android/server/display/AutomaticBrightnessController$Callbacks;Landroid/os/Looper;Landroid/hardware/SensorManager;Landroid/hardware/Sensor;Lcom/android/server/display/BrightnessMappingStrategy;IIIFIIJJZLcom/android/server/display/HysteresisLevels;Lcom/android/server/display/HysteresisLevels;JLandroid/content/pm/PackageManager;Lcom/android/server/display/DisplayPowerController;)V
    ...
    iput v1, v0, mScreenAutoBrightness:I

    const/4 v2, 0x0

    iput v2, v0, mDisplayPolicy:I

    const v3, 0x3f19999a    # 0.6f

    iput v3, v0, SHORT_TERM_MODEL_THRESHOLD_RATIO:F

    iput-boolean v2, v0, mHBM_State:Z

    iput-boolean v2, v0, mIs18865N19801:Z
    ...
    iput-object v4, v0, mThresholdSAMin:[I

    new-array v4, v3, [I

    fill-array-data v4, :array_1

    iput-object v4, v0, mThresholdSAMax:[I

    new-array v4, v3, [I

    fill-array-data v4, :array_2

    iput-object v4, v0, mThresholdNSAMin:[I

    new-array v3, v3, [I

    fill-array-data v3, :array_3

    iput-object v3, v0, mThresholdNSAMax:[I

    iput-boolean v2, v0, mProximityPositive:Z

    iput-boolean v2, v0, mNeedUpdateFast:Z

    const/16 v3, 0x4e20

    iput v3, v0, HBM_THRESHOLD:I

    const-wide/16 v3, 0x5dc

    iput-wide v3, v0, FAST_BRIGHTEN_DEBOUNCE_TIME:J
    ...
    iput-object v3, v0, mLightSensorListener:Landroid/hardware/SensorEventListener;
    ...
    iput-object v3, v0, mProximitySensorListener:Landroid/hardware/SensorEventListener;

    move-object/from16 v3, p1

    iput-object v3, v0, mCallbacks:Lcom/android/server/display/AutomaticBrightnessController$Callbacks;

    move-object/from16 v4, p3

    iput-object v4, v0, mSensorManager:Landroid/hardware/SensorManager;

    move-object/from16 v5, p5

    iput-object v5, v0, mBrightnessMapper:Lcom/android/server/display/BrightnessMappingStrategy;

    move/from16 v6, p7

    iput v6, v0, mScreenBrightnessRangeMinimum:I

    move/from16 v7, p8

    iput v7, v0, mScreenBrightnessRangeMaximum:I

    move/from16 v8, p6

    iput v8, v0, mLightSensorWarmUpTimeConfig:I

    move/from16 v9, p9

    iput v9, v0, mDozeScaleFactor:F

    move/from16 v10, p10

    iput v10, v0, mNormalLightSensorRate:I

    move/from16 v11, p11

    iput v11, v0, mInitialLightSensorRate:I

    iput v1, v0, mCurrentLightSensorRate:I

    move-wide/from16 v12, p12

    iput-wide v12, v0, mBrighteningLightDebounceConfig:J

    move-wide/from16 v14, p14

    iput-wide v14, v0, mDarkeningLightDebounceConfig:J

    move/from16 v2, p16

    iput-boolean v2, v0, mResetAmbientLuxAfterWarmUpConfig:Z

    const/16 v1, 0x1770

    iput v1, v0, mAmbientLightHorizon:I

    iput v1, v0, mWeightingIntercept:I

    move-object/from16 v1, p17

    iput-object v1, v0, mAmbientBrightnessThresholds:Lcom/android/server/display/HysteresisLevels;

    move-object/from16 v1, p18

    iput-object v1, v0, mScreenBrightnessThresholds:Lcom/android/server/display/HysteresisLevels;

    move-wide/from16 v1, p19

    iput-wide v1, v0, mShortTermModelTimeout:J

    const/4 v1, 0x1

    iput-boolean v1, v0, mShortTermModelValid:Z

    const/high16 v2, -0x40800000    # -1.0f

    iput v2, v0, mShortTermModelAnchor:F
    ...
    iput-object v2, v0, mHandler:Lcom/android/server/display/AutomaticBrightnessController$AutomaticBrightnessHandler;

    new-instance v2, Lcom/android/server/display/AutomaticBrightnessController$AmbientLightRingBuffer;

    iget v1, v0, mNormalLightSensorRate:I

    int-to-long v3, v1

    iget v1, v0, mAmbientLightHorizon:I

    invoke-direct {v2, v3, v4, v1}, Lcom/android/server/display/AutomaticBrightnessController$AmbientLightRingBuffer;-><init>(JI)V

    iput-object v2, v0, mAmbientLightRingBuffer:Lcom/android/server/display/AutomaticBrightnessController$AmbientLightRingBuffer;

    move-object/from16 v1, p4

    iput-object v1, v0, mLightSensor:Landroid/hardware/Sensor;
    ...
    iput-object v2, v0, mOneplusColorDisplayManager:Lcom/oneplus/display/IOneplusColorDisplayManager;

    invoke-static {}, Landroid/app/ActivityTaskManager;->getService()Landroid/app/IActivityTaskManager;

    move-result-object v2

    iput-object v2, v0, mActivityTaskManager:Landroid/app/IActivityTaskManager;

    move-object/from16 v2, p21

    iput-object v2, v0, mPackageManager:Landroid/content/pm/PackageManager;
    ...
    iput-object v3, v0, mTaskStackListener:Lcom/android/server/display/AutomaticBrightnessController$TaskStackListenerImpl;

    const/4 v3, 0x0

    iput-object v3, v0, mForegroundAppPackageName:Ljava/lang/String;

    iput-object v3, v0, mPendingForegroundAppPackageName:Ljava/lang/String;

    const/4 v4, -0x1

    iput v4, v0, mForegroundAppCategory:I

    iput v4, v0, mPendingForegroundAppCategory:I
    ...
    iget-object v3, v0, mSensorManager:Landroid/hardware/SensorManager;
    ...
    iput-object v3, v0, mProximitySensor:Landroid/hardware/Sensor;
    ...
    iput-object v3, v0, mTime:Landroid/text/format/Time;

    move-object/from16 v3, p22

    iput-object v3, v0, mDisplayPowerController:Lcom/android/server/display/DisplayPowerController;

    invoke-direct/range {p0 .. p0}, isOnePlus18865N19801()Z

    move-result v4

    iput-boolean v4, v0, mIs18865N19801:Z
...
.method static synthetic access$000(Lcom/android/server/display/AutomaticBrightnessController;)Landroid/app/IActivityTaskManager;
    ...
    iget-object v0, p0, mActivityTaskManager:Landroid/app/IActivityTaskManager;
...
.method static synthetic access$100(Lcom/android/server/display/AutomaticBrightnessController;)Ljava/lang/String;
    ...
    iget-object v0, p0, mForegroundAppPackageName:Ljava/lang/String;
...
.method static synthetic access$1000(Lcom/android/server/display/AutomaticBrightnessController;)V
    ...
    invoke-direct {p0}, updateForegroundAppSync()V
...
.method static synthetic access$202(Lcom/android/server/display/AutomaticBrightnessController;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object p1, p0, mPendingForegroundAppPackageName:Ljava/lang/String;
...
.method static synthetic access$302(Lcom/android/server/display/AutomaticBrightnessController;I)I
    ...
    iput p1, p0, mPendingForegroundAppCategory:I
...
.method static synthetic access$800(Lcom/android/server/display/AutomaticBrightnessController;)V
    ...
    invoke-direct {p0}, invalidateShortTermModel()V
...
.method static synthetic access$900(Lcom/android/server/display/AutomaticBrightnessController;)V
    ...
    invoke-direct {p0}, updateForegroundApp()V
...
.method private adjustLightSensorRate(I)V
    ...
    iget v0, p0, mCurrentLightSensorRate:I
    ...
    iget v1, p0, mCurrentLightSensorRate:I
    ...
    :cond_0
    iput p1, p0, mCurrentLightSensorRate:I

    iget-object v0, p0, mSensorManager:Landroid/hardware/SensorManager;

    iget-object v1, p0, mLightSensorListener:Landroid/hardware/SensorEventListener;
    ...
    iget-object v4, p0, mHandler:Lcom/android/server/display/AutomaticBrightnessController$AutomaticBrightnessHandler;
...
.method private applyLightSensorMeasurement(JF)V
    ...
    iget v1, p0, mAmbientLightHorizon:I
...
.method private calculateAmbientLux(JJ)F
    ...
    iget-boolean v5, v0, mLoggingEnabled:Z
    ...
    :cond_0
    iget-object v5, v0, mAmbientLightRingBuffer:Lcom/android/server/display/AutomaticBrightnessController$AmbientLightRingBuffer;
    ...
    iget-object v13, v0, mAmbientLightRingBuffer:Lcom/android/server/display/AutomaticBrightnessController$AmbientLightRingBuffer;
    ...
    :cond_2
    iget-boolean v12, v0, mLoggingEnabled:Z
    ...
    iget-object v3, v0, mAmbientLightRingBuffer:Lcom/android/server/display/AutomaticBrightnessController$AmbientLightRingBuffer;
    ...
    invoke-direct {v0, v9, v10, v13, v14}, calculateWeight(JJ)F

    move-result v1

    iget-object v2, v0, mAmbientLightRingBuffer:Lcom/android/server/display/AutomaticBrightnessController$AmbientLightRingBuffer;
    ...
    iget-boolean v3, v0, mLoggingEnabled:Z
    ...
    iget-boolean v1, v0, mLoggingEnabled:Z
...
.method private calculateWeight(JJ)F
    ...
    invoke-direct {p0, p3, p4}, weightIntegral(J)F

    move-result v0

    invoke-direct {p0, p1, p2}, weightIntegral(J)F
...
.method private handleLightSensorEvent(JF)V
    ...
    iget v0, p0, mNormalLightSensorRate:I

    invoke-direct {p0, v0}, adjustLightSensorRate(I)V

    :cond_0
    invoke-direct {p0, p1, p2, p3}, applyLightSensorMeasurement(JF)V

    iget-object v0, p0, mCallbacks:Lcom/android/server/display/AutomaticBrightnessController$Callbacks;
...
.method private invalidateShortTermModel()V
    ...
    iput-boolean v0, p0, mShortTermModelValid:Z
...
.method private limitLuxValue(F)F
    ...
    iget-object v3, v2, mTime:Landroid/text/format/Time;
...
.method private nextAmbientLightBrighteningTransition(J)J
    ...
    iget v5, p0, mAmbientBrighteningThreshold:F
    ...
    :cond_1
    :goto_1
    iget-wide v3, p0, mBrighteningLightDebounceConfig:J
...
.method private nextAmbientLightDarkeningTransition(J)J
    ...
    iget v5, p0, mAmbientDarkeningThreshold:F
    ...
    :cond_1
    :goto_1
    iget-wide v3, p0, mDarkeningLightDebounceConfig:J
...
.method private nextFastBrighteningTransition(J)I
    ...
    iget v6, v0, mAmbientBrighteningThreshold:F

    iget v7, v0, mAmbientLux:F

    sub-float/2addr v6, v7

    iget v8, v0, mLastObservedLux:F
    ...
    iget-object v11, v0, mAmbientLightRingBuffer:Lcom/android/server/display/AutomaticBrightnessController$AmbientLightRingBuffer;
    ...
    :cond_7
    iget-boolean v12, v0, mIs18865N19801:Z
    ...
    iget v12, v0, mLastObservedLux:F
    ...
    iget-object v15, v0, mAmbientLightRingBuffer:Lcom/android/server/display/AutomaticBrightnessController$AmbientLightRingBuffer;

    invoke-virtual {v15, v12}, Lcom/android/server/display/AutomaticBrightnessController$AmbientLightRingBuffer;->getLux(I)F

    move-result v15

    iget-object v14, v0, mAmbientLightRingBuffer:Lcom/android/server/display/AutomaticBrightnessController$AmbientLightRingBuffer;
    ...
    :cond_b
    invoke-direct/range {p0 .. p0}, useScreenShotAlgo()Z
    ...
    iget-object v12, v0, mDisplayPowerController:Lcom/android/server/display/DisplayPowerController;
    ...
    :cond_11
    iget-boolean v7, v0, mIs18865N19801:Z
    ...
    :cond_16
    :goto_7
    iget-boolean v7, v0, mLoggingEnabled:Z
...
.method private registerForegroundAppUpdater()V
    ...
    iget-object v1, p0, mTaskStackListener:Lcom/android/server/display/AutomaticBrightnessController$TaskStackListenerImpl;
...
.method private reviseAmbientThreshold(Z)V
    ...
    iget-object v4, p0, mThresholdSAMin:[I
    ...
    iget-object v5, p0, mThresholdSAMax:[I
    ...
    iput v1, p0, mAmbientDarkeningThreshold:F

    aget v0, v5, v0

    int-to-float v0, v0

    iput v0, p0, mAmbientBrighteningThreshold:F
    ...
    iget-object v3, p0, mThresholdSAMin:[I
    ...
    iget-object v4, p0, mThresholdSAMax:[I
    ...
    iput v0, p0, mAmbientDarkeningThreshold:F
    ...
    iget-object v1, p0, mThresholdSAMin:[I
    ...
    iget-object v3, p0, mThresholdSAMax:[I
    ...
    iget-object v2, p0, mThresholdSAMin:[I
    ...
    iput v5, p0, mAmbientBrighteningThreshold:F

    iput v2, p0, mAmbientDarkeningThreshold:F
    ...
    iput v1, p0, mAmbientBrighteningThreshold:F

    iput v4, p0, mAmbientDarkeningThreshold:F
    ...
    iput v3, p0, mAmbientBrighteningThreshold:F

    iput v5, p0, mAmbientDarkeningThreshold:F

    goto/16 :goto_0

    :cond_e
    iget v6, p0, mAmbientLux:F
...
.method private setAmbientLux(F)V
    ...
    :cond_1
    invoke-direct {p0, p1}, reviseAmbientLux(F)F
    ...
    iget-object v2, p0, mAmbientBrightnessThresholds:Lcom/android/server/display/HysteresisLevels;

    invoke-virtual {v2, p1}, Lcom/android/server/display/HysteresisLevels;->getBrighteningThreshold(F)F

    move-result v2

    iput v2, p0, mAmbientBrighteningThreshold:F
    ...
    invoke-direct {p0, v0}, reviseAmbientThreshold(Z)V

    iget v2, p0, mAmbientLux:F

    invoke-direct {p0, v2}, limitLuxValue(F)F

    move-result v2

    iput v2, p0, mAmbientLux:F

    iget-boolean v2, p0, mShortTermModelValid:Z

    if-nez v2, :cond_4

    iget v2, p0, mShortTermModelAnchor:F
    ...
    iget v5, p0, SHORT_TERM_MODEL_THRESHOLD_RATIO:F
    ...
    iget-boolean v4, p0, mLoggingEnabled:Z
    ...
    :cond_2
    iput-boolean v1, p0, mShortTermModelValid:Z
    ...
    invoke-virtual {p0}, resetShortTermModel()V
...
.method private setDisplayPolicy(I)Z
    ...
    :cond_2
    invoke-static {p1}, isInteractivePolicy(I)Z

    move-result v1

    if-nez v1, :cond_3

    invoke-static {v0}, isInteractivePolicy(I)Z
    ...
    iget-wide v3, p0, mShortTermModelTimeout:J
...
.method private setLightSensorEnabled(Z)Z
    ...
    iget-boolean v3, p0, mLightSensorEnabled:Z

    if-nez v3, :cond_2

    iput-boolean v2, p0, mNeedUpdateFast:Z

    iget-object v3, p0, mHandler:Lcom/android/server/display/AutomaticBrightnessController$AutomaticBrightnessHandler;
    ...
    sput-boolean v3, DEBUG_BACKLIGHT:Z
    ...
    iput-wide v3, p0, mLightSensorEnableTime:J

    iget v3, p0, mInitialLightSensorRate:I

    iput v3, p0, mCurrentLightSensorRate:I

    invoke-direct {p0}, registerForegroundAppUpdater()V
    ...
    iget v6, p0, mCurrentLightSensorRate:I

    mul-int/lit16 v6, v6, 0x3e8

    iget-object v7, p0, mHandler:Lcom/android/server/display/AutomaticBrightnessController$AutomaticBrightnessHandler;
    ...
    iget-object v3, p0, mProximitySensorListener:Landroid/hardware/SensorEventListener;

    iget v4, p0, mCurrentLightSensorRate:I
    ...
    iget-boolean v3, p0, mResetAmbientLuxAfterWarmUpConfig:Z

    xor-int/2addr v3, v2

    iput-boolean v3, p0, mAmbientLuxValid:Z
    ...
    invoke-direct {p0}, unregisterForegroundAppUpdater()V
    ...
    iput-boolean v1, p0, mProximityPositive:Z
...
.method private setScreenBrightnessByUser(F)Z
    ...
    iput v2, p0, mShortTermModelAnchor:F

    iget-boolean v2, p0, mLoggingEnabled:Z
    ...
    iget v3, p0, mShortTermModelAnchor:F
    ...
    iget-boolean v2, p0, mHBM_State:Z

    if-ne v2, v0, :cond_2

    iput-boolean v1, p0, mHBM_State:Z
...
.method private unregisterForegroundAppUpdater()V
    ...
    iput-object v0, p0, mForegroundAppPackageName:Ljava/lang/String;

    const/4 v0, -0x1

    iput v0, p0, mForegroundAppCategory:I
...
.method private updateAmbientLux()V
    ...
    iget v3, p0, mAmbientLightHorizon:I
...
.method private updateAmbientLux(J)V
    ...
    iget-boolean v3, v0, mAmbientLuxValid:Z
    ...
    iget v3, v0, mLightSensorWarmUpTimeConfig:I

    int-to-long v10, v3

    iget-wide v12, v0, mLightSensorEnableTime:J
    ...
    :cond_0
    iget-object v3, v0, mHandler:Lcom/android/server/display/AutomaticBrightnessController$AutomaticBrightnessHandler;
    ...
    :cond_1
    invoke-direct {v0, v1, v2, v5, v6}, calculateAmbientLux(JJ)F

    move-result v3

    invoke-direct {v0, v3}, setAmbientLux(F)V

    iput-boolean v9, v0, mAmbientLuxValid:Z
    ...
    iget-object v12, v0, mAmbientLightRingBuffer:Lcom/android/server/display/AutomaticBrightnessController$AmbientLightRingBuffer;
    ...
    :cond_2
    invoke-direct {v0, v9, v8}, updateAutoBrightness(ZZ)V
    ...
    invoke-direct {v0, v1, v2, v14, v15}, calculateAmbientLux(JJ)F
    ...
    iget-object v14, v0, mOneplusColorDisplayManager:Lcom/oneplus/display/IOneplusColorDisplayManager;

    invoke-interface {v14, v5}, Lcom/oneplus/display/IOneplusColorDisplayManager;->updateAutoAssertiveDisplayStatus(F)V

    const/4 v14, 0x0

    iget-object v15, v0, mCallbacks:Lcom/android/server/display/AutomaticBrightnessController$Callbacks;
    ...
    invoke-direct/range {p0 .. p2}, nextFastBrighteningTransition(J)I

    move-result v14

    :cond_4
    iget v15, v0, mAmbientBrighteningThreshold:F
    ...
    :cond_5
    iget v15, v0, mAmbientDarkeningThreshold:F
    ...
    iget v8, v0, mAmbientBrighteningThreshold:F
    ...
    iget v8, v0, mAmbientDarkeningThreshold:F
    ...
    iget-object v8, v0, mAmbientLightRingBuffer:Lcom/android/server/display/AutomaticBrightnessController$AmbientLightRingBuffer;

    invoke-virtual {v15, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    invoke-virtual {v15, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v4, v0, mAmbientLux:F
    ...
    invoke-direct {v0, v5}, setAmbientLux(F)V

    const/4 v4, 0x0

    invoke-direct {v0, v9, v4}, updateAutoBrightness(ZZ)V
    ...
    invoke-direct {v0, v6}, setAmbientLux(F)V
    ...
    :cond_9
    iget-boolean v4, v0, mNeedUpdateFast:Z

    if-eqz v4, :cond_a

    iget v4, v0, mLastObservedLux:F
    ...
    invoke-direct {v0, v4}, setAmbientLux(F)V
    ...
    :cond_e
    iget v4, v0, mNormalLightSensorRate:I
    ...
    :goto_3
    iget-boolean v4, v0, mLoggingEnabled:Z
    ...
    :cond_f
    iget-object v4, v0, mHandler:Lcom/android/server/display/AutomaticBrightnessController$AutomaticBrightnessHandler;
...
.method private updateAutoBrightness(ZZ)V
    ...
    iget-object v4, p0, mBrightnessMapper:Lcom/android/server/display/BrightnessMappingStrategy;
    ...
    iput v3, p0, mScreenDarkeningThreshold:F

    iput v3, p0, mScreenBrighteningThreshold:F

    iget-object v3, p0, mCallbacks:Lcom/android/server/display/AutomaticBrightnessController$Callbacks;
    ...
    :cond_2
    iput-boolean v4, p0, mHBM_State:Z
    ...
    iget-object v4, p0, mForegroundAppPackageName:Ljava/lang/String;

    iget v5, p0, mForegroundAppCategory:I
    ...
    iget v4, p0, mScreenAutoBrightness:I
    ...
    iget v5, p0, mScreenDarkeningThreshold:F
    ...
    iget v5, p0, mScreenBrighteningThreshold:F
    ...
    iget v5, p0, mScreenAutoBrightness:I
    ...
    :cond_7
    iput v2, p0, mScreenAutoBrightness:I

    iget-object v3, p0, mScreenBrightnessThresholds:Lcom/android/server/display/HysteresisLevels;
...
.method private updateForegroundAppSync()V
    ...
    iget-object v1, p0, mPendingForegroundAppPackageName:Ljava/lang/String;
    ...
    iget v1, p0, mPendingForegroundAppCategory:I
    ...
    :cond_0
    iget-object v0, p0, mPendingForegroundAppPackageName:Ljava/lang/String;

    iput-object v0, p0, mForegroundAppPackageName:Ljava/lang/String;

    const/4 v0, 0x0

    iput-object v0, p0, mPendingForegroundAppPackageName:Ljava/lang/String;

    iget v0, p0, mPendingForegroundAppCategory:I

    iput v0, p0, mForegroundAppCategory:I

    const/4 v0, -0x1

    iput v0, p0, mPendingForegroundAppCategory:I

    const/4 v0, 0x1

    const/4 v1, 0x0

    invoke-direct {p0, v0, v1}, updateAutoBrightness(ZZ)V
...
.method private weightIntegral(J)F
    ...
    iget v2, p0, mWeightingIntercept:I
...
.method public adjustBrightenDebounceTime(I)V
    ...
    iput-wide v0, p0, mBrighteningLightDebounceConfig:J
...
.method public configure(ZLandroid/hardware/display/BrightnessConfiguration;FZFZI)V
    ...
    :goto_0
    invoke-virtual {p0, p2}, setBrightnessConfiguration(Landroid/hardware/display/BrightnessConfiguration;)Z

    move-result v3

    invoke-direct {p0, p7}, setDisplayPolicy(I)Z
    ...
    invoke-direct {p0, p5}, setAutoBrightnessAdjustment(F)Z
    ...
    invoke-direct {p0, p3}, setScreenBrightnessByUser(F)Z
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    iget v1, p0, mInitialLightSensorRate:I
    ...
    iget v1, p0, mNormalLightSensorRate:I
    ...
    iget-wide v1, p0, mBrighteningLightDebounceConfig:J
    ...
    iget-wide v1, p0, mDarkeningLightDebounceConfig:J
    ...
    iget v1, p0, mWeightingIntercept:I
    ...
    iget-wide v1, p0, mLightSensorEnableTime:J
    ...
    iget v1, p0, mAmbientBrighteningThreshold:F
    ...
    iget v1, p0, mAmbientDarkeningThreshold:F
    ...
    iget v1, p0, mScreenBrighteningThreshold:F
    ...
    iget v1, p0, mScreenDarkeningThreshold:F
    ...
    iget-wide v1, p0, mLastObservedLuxTime:J
    ...
    iget-wide v1, p0, mShortTermModelTimeout:J
    ...
    iget v1, p0, mShortTermModelAnchor:F
    ...
    iget-boolean v1, p0, mShortTermModelValid:Z
    ...
    iget-boolean v1, p0, mBrightnessAdjustmentSamplePending:Z
    ...
    iget v1, p0, mBrightnessAdjustmentSampleOldLux:F
    ...
    iget v1, p0, mBrightnessAdjustmentSampleOldBrightness:I
    ...
    iget-object v1, p0, mForegroundAppPackageName:Ljava/lang/String;
    ...
    iget v1, p0, mForegroundAppCategory:I
    ...
    iget-object v0, p0, mAmbientBrightnessThresholds:Lcom/android/server/display/HysteresisLevels;

    invoke-virtual {v0, p1}, Lcom/android/server/display/HysteresisLevels;->dump(Ljava/io/PrintWriter;)V

    iget-object v0, p0, mScreenBrightnessThresholds:Lcom/android/server/display/HysteresisLevels;
...
.method public resetShortTermModel()V
    ...
    iput v0, p0, mShortTermModelAnchor:F
