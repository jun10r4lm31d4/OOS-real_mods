...
.method public constructor <init>(Landroid/hardware/display/BrightnessConfiguration;[F[IF)V
    ...
    iput p4, p0, mMaxGamma:F

    iput v1, p0, mAutoBrightnessAdjustment:F

    const/high16 v0, -0x40800000    # -1.0f

    iput v0, p0, mUserLux:F

    iput v0, p0, mUserBrightness:F
    ...
    invoke-virtual {p0, v3}, normalizeAbsoluteBrightness(I)F
    ...
    iput-object v2, p0, mNitsToBacklightSpline:Landroid/util/Spline;

    invoke-static {v1, p2}, Landroid/util/Spline;->createSpline([F[F)Landroid/util/Spline;

    move-result-object v2

    iput-object v2, p0, mBacklightToNitsSpline:Landroid/util/Spline;

    iput-object p1, p0, mDefaultConfig:Landroid/hardware/display/BrightnessConfiguration;
    ...
    :cond_3
    iput-object p1, p0, mConfig:Landroid/hardware/display/BrightnessConfiguration;

    invoke-direct {p0}, computeSpline()V
...
.method private computeSpline()V
    ...
    iget-object v0, p0, mConfig:Landroid/hardware/display/BrightnessConfiguration;
    ...
    iget-object v3, p0, mNitsToBacklightSpline:Landroid/util/Spline;
    ...
    :cond_0
    iget v5, p0, mUserLux:F

    iget v6, p0, mUserBrightness:F

    iget v7, p0, mAutoBrightnessAdjustment:F

    iget v8, p0, mMaxGamma:F
    ...
    invoke-virtual/range {v2 .. v8}, getAdjustedCurve([F[FFFFF)Landroid/util/Pair;
    ...
    iget-object v7, p0, mBacklightToNitsSpline:Landroid/util/Spline;
    ...
    iput-object v6, p0, mBrightnessSpline:Landroid/util/Spline;
...
.method private getUnadjustedBrightness(F)F
    ...
    iget-object v2, p0, mNitsToBacklightSpline:Landroid/util/Spline;
...
.method public addUserDataPoint(FF)V
    ...
    invoke-direct {p0, p1}, getUnadjustedBrightness(F)F
    ...
    :cond_0
    iget v1, p0, mMaxGamma:F

    invoke-virtual {p0, v1, p2, v0}, inferAutoBrightnessAdjustment(FFF)F

    move-result v1

    iget-boolean v3, p0, mLoggingEnabled:Z
    ...
    iget v4, p0, mAutoBrightnessAdjustment:F
    ...
    iput p1, p0, mUserLux:F

    iput p2, p0, mUserBrightness:F
...
.method public clearUserDataPoints()V
    ...
    iget v2, p0, mAutoBrightnessAdjustment:F
    ...
    iget v2, p0, mUserLux:F

    iget v3, p0, mUserBrightness:F
    ...
    iput v0, p0, mAutoBrightnessAdjustment:F

    iput v1, p0, mUserLux:F

    iput v1, p0, mUserBrightness:F
...
.method public convertNitsToBrightness(F)F
    ...
    iget-object v0, p0, mNitsToBacklightSpline:Landroid/util/Spline;
...
.method public convertToNits(I)F
    ...
    iget-object v0, p0, mBacklightToNitsSpline:Landroid/util/Spline;

    invoke-virtual {p0, p1}, normalizeAbsoluteBrightness(I)F
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    iget-object v1, p0, mConfig:Landroid/hardware/display/BrightnessConfiguration;
    ...
    iget-object v1, p0, mBrightnessSpline:Landroid/util/Spline;
    ...
    iget-object v1, p0, mNitsToBacklightSpline:Landroid/util/Spline;
    ...
    iget-object v1, p0, mDefaultConfig:Landroid/hardware/display/BrightnessConfiguration;
...
.method public getBrightness(FLjava/lang/String;I)F
    ...
    iget-object v0, p0, mBrightnessSpline:Landroid/util/Spline;
    ...
    invoke-direct {p0, v1, p2, p3}, correctBrightness(FLjava/lang/String;I)F
...
.method public getDefaultConfig()Landroid/hardware/display/BrightnessConfiguration;
    ...
    iget-object v0, p0, mDefaultConfig:Landroid/hardware/display/BrightnessConfiguration;
...
.method public setBrightnessConfiguration(Landroid/hardware/display/BrightnessConfiguration;)Z
    ...
    iget-object p1, p0, mDefaultConfig:Landroid/hardware/display/BrightnessConfiguration;
