...
.method private addDisplayDeviceLocked(Landroid/hardware/display/WifiDisplay;Landroid/view/Surface;III)V
    ...
    invoke-direct/range {p0 .. p0}, removeDisplayDeviceLocked()V

    iget-object v0, v10, mPersistentDataStore:Lcom/android/server/display/PersistentDataStore;
    ...
    invoke-direct/range {p0 .. p0}, updateRememberedDisplaysLocked()V

    invoke-direct/range {p0 .. p0}, scheduleStatusChangedBroadcastLocked()V
    ...
    iget-boolean v1, v10, mSupportsProtectedBuffers:Z
    ...
    iput-object v12, v10, mDisplayDevice:Lcom/android/server/display/WifiDisplayAdapter$WifiDisplayDevice;

    iget-object v0, v10, mDisplayDevice:Lcom/android/server/display/WifiDisplayAdapter$WifiDisplayDevice;

    const/4 v1, 0x1

    invoke-virtual {v10, v0, v1}, sendDisplayDeviceEventLocked(Lcom/android/server/display/DisplayDevice;I)V
...
.method private fixRememberedDisplayNamesFromAvailableDisplaysLocked()V
    ...
    invoke-direct {p0, v3}, findAvailableDisplayLocked(Ljava/lang/String;)Landroid/hardware/display/WifiDisplay;
...
.method private scheduleStatusChangedBroadcastLocked()V
    ...
    iput-boolean v0, p0, mPendingStatusChangeBroadcast:Z

    iget-object v1, p0, mHandler:Lcom/android/server/display/WifiDisplayAdapter$WifiDisplayHandler;
...
.method private updateDisplaysLocked()V
    ...
    :goto_1
    iget-object v8, p0, mAvailableDisplays:[Landroid/hardware/display/WifiDisplay;
    ...
    :goto_3
    iget-object v3, p0, mAvailableDisplays:[Landroid/hardware/display/WifiDisplay;
    ...
    iput-object v2, p0, mDisplays:[Landroid/hardware/display/WifiDisplay;
...
.method public getWifiDisplayStatusLocked()Landroid/hardware/display/WifiDisplayStatus;
    ...
    iget v3, p0, mScanState:I

    iget v4, p0, mActiveDisplayState:I

    iget-object v5, p0, mActiveDisplay:Landroid/hardware/display/WifiDisplay;

    iget-object v6, p0, mDisplays:[Landroid/hardware/display/WifiDisplay;

    iget-object v7, p0, mSessionInfo:Landroid/hardware/display/WifiDisplaySessionInfo;
...
.method public requestRenameLocked(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0}, renameDisplayDeviceLocked(Ljava/lang/String;)V
