...
.method constructor <init>(Lcom/android/server/display/LocalDisplayAdapter;Landroid/os/IBinder;J[Landroid/view/SurfaceControl$PhysicalDisplayInfo;I[I[IIZ)V
    ...
    iput-object v0, v6, this$0:Lcom/android/server/display/LocalDisplayAdapter;
    ...
    iput-object v0, v6, mSupportedModes:Landroid/util/SparseArray;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, v6, mSupportedColorModes:Ljava/util/ArrayList;

    const/4 v10, 0x0

    iput v10, v6, mState:I

    const/4 v0, -0x1

    iput v0, v6, mBrightness:I

    iput-wide v7, v6, mPhysicalDisplayId:J

    move/from16 v11, p10

    iput-boolean v11, v6, mIsInternal:Z
    ...
    invoke-virtual/range {v0 .. v5}, updatePhysicalDisplayInfoLocked([Landroid/view/SurfaceControl$PhysicalDisplayInfo;I[I[II)Z

    move-object/from16 v0, p8

    move/from16 v1, p9

    invoke-direct {p0, v0, v1}, updateColorModesLocked([II)Z
    ...
    iput-object v2, v6, mSidekickInternal:Landroid/hardware/sidekick/SidekickInternal;

    iget-boolean v2, v6, mIsInternal:Z
    ...
    iput-object v3, v6, mBacklight:Lcom/android/server/lights/Light;
    ...
    iput-object v2, v6, mBacklight:Lcom/android/server/lights/Light;
    ...
    iput-object v2, v6, mHdrCapabilities:Landroid/view/Display$HdrCapabilities;
...
.method static synthetic access$300(Lcom/android/server/display/LocalDisplayAdapter$LocalDisplayDevice;)Z
    ...
    iget-boolean v0, p0, mSidekickActive:Z
...
.method static synthetic access$302(Lcom/android/server/display/LocalDisplayAdapter$LocalDisplayDevice;Z)Z
    ...
    iput-boolean p1, p0, mSidekickActive:Z
...
.method static synthetic access$400(Lcom/android/server/display/LocalDisplayAdapter$LocalDisplayDevice;)Landroid/hardware/sidekick/SidekickInternal;
    ...
    iget-object v0, p0, mSidekickInternal:Landroid/hardware/sidekick/SidekickInternal;
...
.method private findDisplayInfoIndexLocked(I)I
    ...
    iget-object v0, p0, mSupportedModes:Landroid/util/SparseArray;
...
.method private findMatchingModeIdLocked(I)I
    ...
    iget-object v0, p0, mDisplayInfos:[Landroid/view/SurfaceControl$PhysicalDisplayInfo;
...
.method private updateColorModesLocked([II)Z
    ...
    iget-object v6, p0, mSupportedColorModes:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, mSupportedColorModes:Ljava/util/ArrayList;
    ...
    :cond_5
    iput-boolean v5, p0, mHavePendingChanges:Z
    ...
    iput v1, p0, mActiveColorMode:I

    iput-boolean v5, p0, mActiveColorModeInvalid:Z
...
.method public dumpLocked(Ljava/io/PrintWriter;)V
    ...
    iget-wide v1, p0, mPhysicalDisplayId:J
    ...
    iget-object v1, p0, mAllowedPhysIndexes:[I
    ...
    iget-object v1, p0, mAllowedModeIds:[I
    ...
    iget-boolean v1, p0, mAllowedModeIdsInvalid:Z
    ...
    iget-object v1, p0, mBacklight:Lcom/android/server/lights/Light;
    ...
    iget-object v3, p0, mSupportedModes:Landroid/util/SparseArray;
    ...
    :goto_2
    iget-object v1, p0, mSupportedColorModes:Ljava/util/ArrayList;
...
.method public getDisplayDeviceInfoLocked()Lcom/android/server/display/DisplayDeviceInfo;
    ...
    iget v2, p0, mDefaultModeId:I

    iput v2, v1, Lcom/android/server/display/DisplayDeviceInfo;->defaultModeId:I

    iget-object v2, p0, mSupportedModes:Landroid/util/SparseArray;

    invoke-direct {p0, v2}, getDisplayModes(Landroid/util/SparseArray;)[Landroid/view/Display$Mode;
    ...
    iget v2, p0, mActiveColorMode:I

    iput v2, v1, Lcom/android/server/display/DisplayDeviceInfo;->colorMode:I

    iget-object v2, p0, mSupportedColorModes:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, mHdrCapabilities:Landroid/view/Display$HdrCapabilities;
    ...
    :cond_1
    iget-object v2, p0, this$0:Lcom/android/server/display/LocalDisplayAdapter;
    ...
    iget-object v3, p0, mInfo:Lcom/android/server/display/DisplayDeviceInfo;
    ...
    :goto_1
    iget-boolean v6, p0, mIsInternal:Z
    ...
    iget-object v6, p0, mInfo:Lcom/android/server/display/DisplayDeviceInfo;
    ...
    iget-object v7, p0, mInfo:Lcom/android/server/display/DisplayDeviceInfo;
    ...
    iget-object v5, p0, mInfo:Lcom/android/server/display/DisplayDeviceInfo;
    ...
    iget-object v8, p0, this$0:Lcom/android/server/display/LocalDisplayAdapter;
    ...
    :cond_c
    invoke-direct {p0, v1}, isDisplayPrivate(Landroid/view/DisplayAddress$Physical;)Z
...
.method public onActivePhysicalDisplayModeChangedLocked(I)V
    ...
    invoke-virtual {p0, p1}, updateActiveModeLocked(I)Z
...
.method public requestColorModeLocked(I)Z
    ...
    :cond_0
    iget-object v0, p0, mSupportedColorModes:Ljava/util/ArrayList;
    ...
    iput p1, p0, mActiveColorMode:I

    iput-boolean v1, p0, mActiveColorModeInvalid:Z
...
.method public requestDisplayStateLocked(II)Ljava/lang/Runnable;
    ...
    iget v0, v9, mBrightness:I

    if-eq v0, v11, :cond_1

    iget-object v0, v9, mBacklight:Lcom/android/server/lights/Light;
    ...
    :cond_3
    :goto_2
    iget-wide v14, v9, mPhysicalDisplayId:J

    invoke-virtual/range {p0 .. p0}, getDisplayTokenLocked()Landroid/os/IBinder;
    ...
    iput v10, v9, mState:I

    invoke-direct/range {p0 .. p0}, updateDeviceInfoLocked()V

    :cond_4
    if-eqz v13, :cond_5

    iput v11, v9, mBrightness:I
...
.method public setAllowedDisplayModesLocked([I)V
    ...
    invoke-virtual {p0, p1}, updateAllowedModesLocked([I)V
...
.method public setRequestedColorModeLocked(I)V
    ...
    invoke-virtual {p0, p1}, requestColorModeLocked(I)Z
...
.method public updateActiveModeLocked(I)Z
    ...
    :cond_0
    iput p1, p0, mActivePhysIndex:I

    invoke-direct {p0, p1}, findMatchingModeIdLocked(I)I

    move-result v0

    iput v0, p0, mActiveModeId:I

    iget v0, p0, mActiveModeId:I
    ...
    :cond_1
    iput-boolean v1, p0, mActiveModeInvalid:Z

    iget-boolean v0, p0, mActiveModeInvalid:Z
...
.method public updateAllowedModesInternalLocked([I)Z
    ...
    invoke-direct {p0, v5}, findDisplayInfoIndexLocked(I)I
    ...
    :cond_3
    iput-object p1, p0, mAllowedModeIds:[I

    iput-boolean v3, p0, mAllowedModeIdsInvalid:Z
    ...
    :cond_4
    iput-object v0, p0, mAllowedPhysIndexes:[I
    ...
    invoke-virtual {p0, v1}, updateActiveModeLocked(I)Z
...
.method public updateAllowedModesLocked([I)V
    ...
    iget-object v0, p0, mAllowedModeIds:[I
    ...
    iget-boolean v0, p0, mAllowedModeIdsInvalid:Z
    ...
    :cond_0
    invoke-virtual {p0, p1}, updateAllowedModesInternalLocked([I)Z
...
.method public updatePhysicalDisplayInfoLocked([Landroid/view/SurfaceControl$PhysicalDisplayInfo;I[I[II)Z
    ...
    iput-object v4, v0, mDisplayInfos:[Landroid/view/SurfaceControl$PhysicalDisplayInfo;

    iput v2, v0, mActivePhysIndex:I
    ...
    iput-object v4, v0, mAllowedPhysIndexes:[I
    ...
    :cond_2
    invoke-direct {v0, v7}, findDisplayModeRecord(Landroid/view/SurfaceControl$PhysicalDisplayInfo;)Lcom/android/server/display/LocalDisplayAdapter$DisplayModeRecord;
    ...
    iput-boolean v8, v0, mActiveModeInvalid:Z

    iget-object v7, v0, this$0:Lcom/android/server/display/LocalDisplayAdapter;
    ...
    iget-object v9, v0, mSupportedModes:Landroid/util/SparseArray;
    ...
    :cond_a
    iput-boolean v8, v0, mHavePendingChanges:Z
    ...
    iget-object v12, v0, mSupportedModes:Landroid/util/SparseArray;
    ...
    :cond_b
    iget v9, v0, mDefaultModeId:I

    invoke-direct {v0, v9}, findDisplayInfoIndexLocked(I)I
    ...
    iput v9, v0, mDefaultModeId:I

    :cond_d
    iget-object v9, v0, mSupportedModes:Landroid/util/SparseArray;

    iget v12, v0, mActiveModeId:I
    ...
    iget v11, v0, mActiveModeId:I

    aput v11, v9, v10

    iput-object v9, v0, mAllowedModeIds:[I

    iget-object v9, v0, mAllowedPhysIndexes:[I
    ...
    invoke-direct {v0, v14}, findMatchingModeIdLocked(I)I
    ...
    :cond_11
    iget-object v9, v0, mAllowedModeIds:[I
    ...
    iput-boolean v9, v0, mAllowedModeIdsInvalid:Z

    iget-object v9, v0, this$0:Lcom/android/server/display/LocalDisplayAdapter;
