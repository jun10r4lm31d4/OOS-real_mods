...
.method constructor <init>(II[F[F[F)V
    ...
    invoke-direct/range {v0 .. v5}, validateArguments(FF[F[F[F)V

    const/4 v0, 0x0

    iput-boolean v0, p0, mLoggingEnabled:Z

    iput p1, p0, mIncreaseDebounce:I

    iput p2, p0, mDecreaseDebounce:I

    iput-object p3, p0, mBaseThresholds:[F

    iput-object p4, p0, mIncreaseThresholds:[F

    iput-object p5, p0, mDecreaseThresholds:[F
...
.method private computeThresholds(F)V
    ...
    iget-object v0, p0, mBaseThresholds:[F

    invoke-direct {p0, p1, v0}, getHighestIndexBefore(F[F)I

    move-result v0

    iget-object v1, p0, mIncreaseThresholds:[F
    ...
    iput v1, p0, mIncreaseThreshold:F

    iget-object v1, p0, mDecreaseThresholds:[F
    ...
    iput v2, p0, mDecreaseThreshold:F
...
.method private tooClose(F)Z
    ...
    iget v0, p0, mIncreaseThreshold:F
    ...
    :cond_1
    iget v0, p0, mDecreaseThreshold:F
...
.method private tooSoon(F)Z
    ...
    iget v4, p0, mIncreaseDebounce:I
    ...
    iget v4, p0, mDecreaseDebounce:I
...
.method private validateArguments(FF[F[F[F)V
    ...
    invoke-static {p3, p4}, isValidMapping([F[F)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {p3, p5}, isValidMapping([F[F)Z
...
.method public clear()V
    ...
    iput v0, p0, mIncreaseThreshold:F

    iput v0, p0, mDecreaseThreshold:F

    iput v0, p0, mLastValue:F
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    iget v1, p0, mIncreaseDebounce:I
    ...
    iget v1, p0, mDecreaseDebounce:I
    ...
    iget-object v1, p0, mBaseThresholds:[F
    ...
    iget v1, p0, mIncreaseThreshold:F
    ...
    iget v1, p0, mDecreaseThreshold:F
...
.method public throttle(F)Z
    ...
    invoke-direct {p0, p1}, tooSoon(F)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-direct {p0, p1}, tooClose(F)Z
    ...
    :cond_1
    invoke-direct {p0, p1}, computeThresholds(F)V
