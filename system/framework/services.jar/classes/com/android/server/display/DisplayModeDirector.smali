...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;)V
    ...
    iput-object v0, p0, mHandler:Lcom/android/server/display/DisplayModeDirector$DisplayModeDirectorHandler;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, mVotesByDisplay:Landroid/util/SparseArray;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, mSupportedModesByDisplay:Landroid/util/SparseArray;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, mDefaultModeByDisplay:Landroid/util/SparseArray;
    ...
    iput-object v0, p0, mAppRequestObserver:Lcom/android/server/display/DisplayModeDirector$AppRequestObserver;
    ...
    iput-object v0, p0, mSettingsObserver:Lcom/android/server/display/DisplayModeDirector$SettingsObserver;
    ...
    iput-object v0, p0, mDisplayObserver:Lcom/android/server/display/DisplayModeDirector$DisplayObserver;
...
.method static synthetic access$100(Lcom/android/server/display/DisplayModeDirector;ILcom/android/server/display/DisplayModeDirector$Vote;)V
    ...
    invoke-direct {p0, p1, p2}, updateVoteLocked(ILcom/android/server/display/DisplayModeDirector$Vote;)V
...
.method static synthetic access$200(Lcom/android/server/display/DisplayModeDirector;IILcom/android/server/display/DisplayModeDirector$Vote;)V
    ...
    invoke-direct {p0, p1, p2, p3}, updateVoteLocked(IILcom/android/server/display/DisplayModeDirector$Vote;)V
...
.method static synthetic access$300(Lcom/android/server/display/DisplayModeDirector;)Landroid/util/SparseArray;
    ...
    iget-object v0, p0, mSupportedModesByDisplay:Landroid/util/SparseArray;
...
.method static synthetic access$400(Lcom/android/server/display/DisplayModeDirector;)Landroid/util/SparseArray;
    ...
    iget-object v0, p0, mDefaultModeByDisplay:Landroid/util/SparseArray;
...
.method static synthetic access$500(Lcom/android/server/display/DisplayModeDirector;)V
    ...
    invoke-direct {p0}, notifyAllowedModesChangedLocked()V
...
.method private getAllowedModesLocked(Landroid/util/SparseArray;[Landroid/view/Display$Mode;Landroid/view/Display$Mode;)[I
    ...
    invoke-direct/range {v6 .. v11}, filterModes([Landroid/view/Display$Mode;IIFF)[I
...
.method private getOrCreateVotesByDisplay(I)Landroid/util/SparseArray;
    ...
    iget-object v0, p0, mVotesByDisplay:Landroid/util/SparseArray;

    invoke-virtual {v0, p1}, Landroid/util/SparseArray;->indexOfKey(I)I

    move-result v0

    iget-object v1, p0, mVotesByDisplay:Landroid/util/SparseArray;
    ...
    iget-object v2, p0, mVotesByDisplay:Landroid/util/SparseArray;
...
.method private notifyAllowedModesChangedLocked()V
    ...
    iget-object v0, p0, mListener:Lcom/android/server/display/DisplayModeDirector$Listener;

    if-eqz v0, :cond_0

    iget-object v0, p0, mHandler:Lcom/android/server/display/DisplayModeDirector$DisplayModeDirectorHandler;
    ...
    iget-object v2, p0, mListener:Lcom/android/server/display/DisplayModeDirector$Listener;
...
.method private updateVoteLocked(IILcom/android/server/display/DisplayModeDirector$Vote;)V
    ...
    :cond_0
    invoke-direct {p0, p1}, getOrCreateVotesByDisplay(I)Landroid/util/SparseArray;
...
.method private updateVoteLocked(ILcom/android/server/display/DisplayModeDirector$Vote;)V
    ...
    invoke-direct {p0, v0, p1, p2}, updateVoteLocked(IILcom/android/server/display/DisplayModeDirector$Vote;)V
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    :goto_0
    iget-object v3, p0, mSupportedModesByDisplay:Landroid/util/SparseArray;
    ...
    iget-object v4, p0, mSupportedModesByDisplay:Landroid/util/SparseArray;
    ...
    :goto_1
    iget-object v3, p0, mDefaultModeByDisplay:Landroid/util/SparseArray;
    ...
    iget-object v4, p0, mDefaultModeByDisplay:Landroid/util/SparseArray;
    ...
    iget-object v3, p0, mVotesByDisplay:Landroid/util/SparseArray;
    ...
    :cond_4
    iget-object v1, p0, mSettingsObserver:Lcom/android/server/display/DisplayModeDirector$SettingsObserver;

    invoke-virtual {v1, p1}, Lcom/android/server/display/DisplayModeDirector$SettingsObserver;->dumpLocked(Ljava/io/PrintWriter;)V

    iget-object v1, p0, mAppRequestObserver:Lcom/android/server/display/DisplayModeDirector$AppRequestObserver;
...
.method public getAllowedModes(I)[I
    ...
    :try_start_0
    invoke-direct {p0, p1}, getVotesLocked(I)Landroid/util/SparseArray;

    move-result-object v1

    iget-object v2, p0, mSupportedModesByDisplay:Landroid/util/SparseArray;
    ...
    :cond_0
    invoke-direct {p0, v1, v2, v3}, getAllowedModesLocked(Landroid/util/SparseArray;[Landroid/view/Display$Mode;Landroid/view/Display$Mode;)[I
...
.method public getAppRequestObserver()Lcom/android/server/display/DisplayModeDirector$AppRequestObserver;
    ...
    iget-object v0, p0, mAppRequestObserver:Lcom/android/server/display/DisplayModeDirector$AppRequestObserver;
...
.method public setListener(Lcom/android/server/display/DisplayModeDirector$Listener;)V
    ...
    :try_start_0
    iput-object p1, p0, mListener:Lcom/android/server/display/DisplayModeDirector$Listener;
...
.method public start()V
    ...
    iget-object v0, p0, mSettingsObserver:Lcom/android/server/display/DisplayModeDirector$SettingsObserver;

    invoke-virtual {v0}, Lcom/android/server/display/DisplayModeDirector$SettingsObserver;->observe()V

    iget-object v0, p0, mDisplayObserver:Lcom/android/server/display/DisplayModeDirector$DisplayObserver;
