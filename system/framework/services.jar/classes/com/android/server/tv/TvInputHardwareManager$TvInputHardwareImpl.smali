...
.method public constructor <init>(Lcom/android/server/tv/TvInputHardwareManager;Landroid/media/tv/TvInputHardwareInfo;)V
    ...
    iput-object v1, p0, mImplLock:Ljava/lang/Object;
    ...
    iput-object v1, p0, mAudioListener:Landroid/media/AudioManager$OnAudioPortUpdateListener;

    iput v0, p0, mOverrideAudioType:I

    const-string v1, ""

    iput-object v1, p0, mOverrideAudioAddress:Ljava/lang/String;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, mAudioSink:Ljava/util/List;

    const/4 v1, 0x0

    iput-object v1, p0, mAudioPatch:Landroid/media/AudioPatch;
    ...
    iput v2, p0, mSourceVolume:F

    iput-object v1, p0, mActiveConfig:Landroid/media/tv/TvStreamConfig;

    iput v0, p0, mDesiredSamplingRate:I

    const/4 v0, 0x1

    iput v0, p0, mDesiredChannelMask:I

    iput v0, p0, mDesiredFormat:I
    ...
    iget-object v0, p0, mAudioListener:Landroid/media/AudioManager$OnAudioPortUpdateListener;
    ...
    iget-object p1, p0, mInfo:Landroid/media/tv/TvInputHardwareInfo;
    ...
    invoke-direct {p0, p1, v0}, findAudioDevicePort(ILjava/lang/String;)Landroid/media/AudioDevicePort;

    move-result-object p1

    iput-object p1, p0, mAudioSource:Landroid/media/AudioDevicePort;

    iget-object p1, p0, mAudioSink:Ljava/util/List;

    invoke-direct {p0, p1}, findAudioSinkFromAudioPolicy(Ljava/util/List;)V
...
.method private startCapture(Landroid/view/Surface;Landroid/media/tv/TvStreamConfig;)Z
    ...
    :try_start_0
    iget-boolean v1, p0, mReleased:Z
...
.method private updateAudioConfigLocked()V
    ...
    iget-object v3, v0, mAudioSource:Landroid/media/AudioDevicePort;

    if-eqz v3, :cond_1a

    iget-object v3, v0, mAudioSink:Ljava/util/List;
    ...
    iget-object v3, v0, mActiveConfig:Landroid/media/tv/TvStreamConfig;
    ...
    :cond_0
    iget-object v3, v0, this$0:Lcom/android/server/tv/TvInputHardwareManager;
    ...
    iget v3, v0, mSourceVolume:F

    iget-object v5, v0, this$0:Lcom/android/server/tv/TvInputHardwareManager;
    ...
    iget-object v6, v0, mAudioSource:Landroid/media/AudioDevicePort;
    ...
    iget-object v9, v0, mAudioSource:Landroid/media/AudioDevicePort;
    ...
    iget-object v11, v0, mAudioPatch:Landroid/media/AudioPatch;
    ...
    :goto_5
    iget-object v12, v0, mAudioSink:Ljava/util/List;
    ...
    iget v15, v0, mDesiredSamplingRate:I

    iget v4, v0, mDesiredChannelMask:I

    iget v8, v0, mDesiredFormat:I
    ...
    iget-object v8, v0, mAudioSource:Landroid/media/AudioDevicePort;
    ...
    iget-object v12, v0, mAudioSource:Landroid/media/AudioDevicePort;
    ...
    iget-object v2, v0, mAudioSource:Landroid/media/AudioDevicePort;
    ...
    iput v3, v0, mCommittedVolume:F

    iget-object v1, v0, mAudioPatch:Landroid/media/AudioPatch;

    if-eqz v1, :cond_18

    iget-object v1, v0, this$0:Lcom/android/server/tv/TvInputHardwareManager;
    ...
    iput-object v1, v0, mAudioPatch:Landroid/media/AudioPatch;
    ...
    iget-object v1, v0, mAudioSource:Landroid/media/AudioDevicePort;
...
.method private updateAudioSinkLocked()Z
    ...
    iget v1, p0, mOverrideAudioType:I

    if-nez v1, :cond_1

    iget-object v1, p0, mAudioSink:Ljava/util/List;

    invoke-direct {p0, v1}, findAudioSinkFromAudioPolicy(Ljava/util/List;)V

    goto :goto_0

    :cond_1
    iget-object v2, p0, mOverrideAudioAddress:Ljava/lang/String;

    invoke-direct {p0, v1, v2}, findAudioDevicePort(ILjava/lang/String;)Landroid/media/AudioDevicePort;

    move-result-object v1

    if-eqz v1, :cond_2

    iget-object v2, p0, mAudioSink:Ljava/util/List;
...
.method private updateAudioSourceLocked()Z
    ...
    iget-object v2, p0, mInfo:Landroid/media/tv/TvInputHardwareInfo;
    ...
    invoke-direct {p0, v2, v3}, findAudioDevicePort(ILjava/lang/String;)Landroid/media/AudioDevicePort;

    move-result-object v2

    iput-object v2, p0, mAudioSource:Landroid/media/AudioDevicePort;

    iget-object v2, p0, mAudioSource:Landroid/media/AudioDevicePort;
...
.method public release()V
    ...
    iget-object v1, p0, mAudioPatch:Landroid/media/AudioPatch;
...
.method public setSurface(Landroid/view/Surface;Landroid/media/tv/TvStreamConfig;)Z
    ...
    iget-object v6, p0, mInfo:Landroid/media/tv/TvInputHardwareInfo;

    invoke-virtual {v6}, Landroid/media/tv/TvInputHardwareInfo;->getDeviceId()I

    move-result v6

    iget-object v7, p0, mActiveConfig:Landroid/media/tv/TvStreamConfig;
    ...
    iput-object v2, p0, mActiveConfig:Landroid/media/tv/TvStreamConfig;
