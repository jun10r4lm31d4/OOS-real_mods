...
.method static constructor <clinit>()V
    ...
    sput-object v0, sAdapterDirPattern:Ljava/util/regex/Pattern;
    ...
    sput-object v0, sFrontEndInAdapterDirPattern:Ljava/util/regex/Pattern;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, v1}, getOrCreateUserStateLocked(I)Lcom/android/server/tv/TvInputManagerService$UserState;
...
.method private abortPendingCreateSessionRequestsLocked(Lcom/android/server/tv/TvInputManagerService$ServiceState;Ljava/lang/String;I)V
    ...
    invoke-direct {p0, v4, v5}, removeSessionStateLocked(Landroid/os/IBinder;I)V
    ...
    invoke-direct/range {v6 .. v11}, sendSessionTokenToClientLocked(Landroid/media/tv/ITvInputClient;Ljava/lang/String;Landroid/os/IBinder;Landroid/view/InputChannel;I)V
    ...
    invoke-direct {p0, v2, p3}, updateServiceConnectionLocked(Landroid/content/ComponentName;I)V
...
.method static synthetic access$4400(Lcom/android/server/tv/TvInputManagerService;Lcom/android/server/tv/TvInputManagerService$UserState;Landroid/media/tv/TvInputInfo;)V
    ...
    invoke-direct {p0, p1, p2}, updateTvInputInfoLocked(Lcom/android/server/tv/TvInputManagerService$UserState;Landroid/media/tv/TvInputInfo;)V
...
.method static synthetic access$4502(Lcom/android/server/tv/TvInputManagerService;Landroid/os/IBinder$DeathRecipient;)Landroid/os/IBinder$DeathRecipient;
    ...
    iput-object p1, p0, mDeathRecipient:Landroid/os/IBinder$DeathRecipient;
...
.method static synthetic access$4900(Lcom/android/server/tv/TvInputManagerService;Landroid/media/tv/ITvInputService;Landroid/os/IBinder;I)Z
    ...
    invoke-direct {p0, p1, p2, p3}, createSessionInternalLocked(Landroid/media/tv/ITvInputService;Landroid/os/IBinder;I)Z
...
.method static synthetic access$6000()Ljava/util/regex/Pattern;
    ...
    sget-object v0, sAdapterDirPattern:Ljava/util/regex/Pattern;
...
.method static synthetic access$6100()Ljava/util/regex/Pattern;
    ...
    sget-object v0, sFrontEndInAdapterDirPattern:Ljava/util/regex/Pattern;
...
.method static synthetic access$6800(Lcom/android/server/tv/TvInputManagerService;Lcom/android/server/tv/TvInputManagerService$SessionState;)V
    ...
    invoke-direct {p0, p1}, clearSessionAndNotifyClientLocked(Lcom/android/server/tv/TvInputManagerService$SessionState;)V
...
.method private buildTvInputListLocked(I[Ljava/lang/String;)V
    ...
    invoke-static {v1, v8}, hasHardwarePermission(Landroid/content/pm/PackageManager;Landroid/content/ComponentName;)Z
    ...
    invoke-direct {p0, v8, p1}, updateServiceConnectionLocked(Landroid/content/ComponentName;I)V
    ...
    invoke-direct {p0, v0, v6}, notifyInputAddedLocked(Lcom/android/server/tv/TvInputManagerService$UserState;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v7, p1}, updateServiceConnectionLocked(Landroid/content/ComponentName;I)V

    invoke-direct {p0, v0, v6}, notifyInputUpdatedLocked(Lcom/android/server/tv/TvInputManagerService$UserState;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v8, v6, p1}, abortPendingCreateSessionRequestsLocked(Lcom/android/server/tv/TvInputManagerService$ServiceState;Ljava/lang/String;I)V

    :cond_a
    invoke-direct {p0, v0, v6}, notifyInputRemovedLocked(Lcom/android/server/tv/TvInputManagerService$UserState;Ljava/lang/String;)V
...
.method private clearSessionAndNotifyClientLocked(Lcom/android/server/tv/TvInputManagerService$SessionState;)V
    ...
    invoke-direct {p0, v5, v6, v7}, releaseSessionLocked(Landroid/os/IBinder;II)V
    ...
    invoke-direct {p0, v1, v2}, removeSessionStateLocked(Landroid/os/IBinder;I)V
...
.method private createSessionInternalLocked(Landroid/media/tv/ITvInputService;Landroid/os/IBinder;I)Z
    ...
    invoke-direct {v7, v9}, getOrCreateUserStateLocked(I)Lcom/android/server/tv/TvInputManagerService$UserState;
    ...
    invoke-direct/range {v1 .. v6}, sendSessionTokenToClientLocked(Landroid/media/tv/ITvInputClient;Ljava/lang/String;Landroid/os/IBinder;Landroid/view/InputChannel;I)V
...
.method private releaseSessionLocked(Landroid/os/IBinder;II)V
    ...
    invoke-direct {p0, p1, v4, p2, p3}, setMainLocked(Landroid/os/IBinder;ZII)V
...
.method private removeSessionStateLocked(Landroid/os/IBinder;I)V
    ...
    invoke-direct {p0, v4, p2}, updateServiceConnectionLocked(Landroid/content/ComponentName;I)V
    ...
    iget-object v5, p0, mWatchLogHandler:Lcom/android/server/tv/TvInputManagerService$WatchLogHandler;
...
.method private setMainLocked(Landroid/os/IBinder;ZII)V
    ...
    invoke-direct {p0, v1, v2, p4}, getSessionStateLocked(Landroid/os/IBinder;II)Lcom/android/server/tv/TvInputManagerService$SessionState;
    ...
    invoke-direct {p0, v1, p4}, getServiceStateLocked(Landroid/content/ComponentName;I)Lcom/android/server/tv/TvInputManagerService$ServiceState;
...
.method private setStateLocked(Ljava/lang/String;II)V
    ...
    invoke-direct {p0, v0, p1, p2, v4}, notifyInputStateChangedLocked(Lcom/android/server/tv/TvInputManagerService$UserState;Ljava/lang/String;ILandroid/media/tv/ITvInputManagerCallback;)V
...
.method private switchUser(I)V
    ...
    :goto_2
    invoke-direct {p0, v4}, clearSessionAndNotifyClientLocked(Lcom/android/server/tv/TvInputManagerService$SessionState;)V
    ...
    invoke-direct {p0, p1, v3}, buildTvInputListLocked(I[Ljava/lang/String;)V

    invoke-direct {p0, p1}, buildTvContentRatingSystemListLocked(I)V

    iget-object v3, p0, mWatchLogHandler:Lcom/android/server/tv/TvInputManagerService$WatchLogHandler;
...
.method public onBootPhase(I)V
    ...
    invoke-direct {p0, v1, v2}, buildTvInputListLocked(I[Ljava/lang/String;)V

    iget v1, p0, mCurrentUserId:I

    invoke-direct {p0, v1}, buildTvContentRatingSystemListLocked(I)V
