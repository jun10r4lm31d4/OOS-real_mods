...
.method private processPendingHdmiDeviceEventsLocked()V
    ...
    invoke-direct {p0, v3}, findHardwareInfoForHdmiPortLocked(I)Landroid/media/tv/TvInputHardwareInfo;
...
.method public acquireHardware(ILandroid/media/tv/ITvInputHardwareCallback;Landroid/media/tv/TvInputInfo;II)Landroid/media/tv/ITvInputHardware;
    ...
    :cond_0
    invoke-direct {p0, v1, p4, p5}, checkUidChangedLocked(Lcom/android/server/tv/TvInputHardwareManager$Connection;II)Z
...
.method public addHardwareInput(ILandroid/media/tv/TvInputInfo;)V
    ...
    :try_start_0
    iget-object v1, p0, mHardwareInputIdMap:Landroid/util/SparseArray;
    ...
    :cond_1
    iget-object v6, p0, mHardwareInputIdMap:Landroid/util/SparseArray;
...
.method public addHdmiInput(ILandroid/media/tv/TvInputInfo;)V
    ...
    invoke-static {v2, v1}, indexOfEqualValue(Landroid/util/SparseArray;Ljava/lang/Object;)I
    ...
    :cond_0
    iget-object v4, p0, mHdmiInputIdMap:Landroid/util/SparseArray;
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    :goto_0
    iget-object v4, p0, mConnections:Landroid/util/SparseArray;
    ...
    iget-object v3, p0, mHardwareList:Ljava/util/List;
    ...
    iget-object v5, p0, mHardwareInputIdMap:Landroid/util/SparseArray;
...
.method public onBootPhase(I)V
    ...
    :try_start_0
    iget-object v1, p0, mHdmiHotplugEventListener:Landroid/hardware/hdmi/IHdmiHotplugEventListener;
    ...
    iget-object v1, p0, mHdmiDeviceEventListener:Landroid/hardware/hdmi/IHdmiDeviceEventListener;
    ...
    iget-object v1, p0, mHdmiSystemAudioModeChangeListener:Landroid/hardware/hdmi/IHdmiSystemAudioModeChangeListener;
    ...
    iget-object v3, p0, mVolumeReceiver:Landroid/content/BroadcastReceiver;
...
.method public releaseHardware(ILandroid/media/tv/ITvInputHardware;II)V
    ...
    invoke-direct {p0, v1, p3, p4}, checkUidChangedLocked(Lcom/android/server/tv/TvInputHardwareManager$Connection;II)Z
...
.method public removeHardwareInput(Ljava/lang/String;)V
    ...
    :try_start_0
    iget-object v1, p0, mInputMap:Ljava/util/Map;

    invoke-interface {v1, p1}, Ljava/util/Map;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v1, p0, mHardwareInputIdMap:Landroid/util/SparseArray;

    invoke-static {v1, p1}, indexOfEqualValue(Landroid/util/SparseArray;Ljava/lang/Object;)I
