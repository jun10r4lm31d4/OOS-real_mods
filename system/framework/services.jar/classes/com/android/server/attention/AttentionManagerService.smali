...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0, v1, v2}, <init>(Landroid/content/Context;Landroid/os/PowerManager;Ljava/lang/Object;Lcom/android/server/attention/AttentionManagerService$AttentionHandler;)V
    ...
    iput-object v0, p0, mAttentionHandler:Lcom/android/server/attention/AttentionManagerService$AttentionHandler;
...
.method constructor <init>(Landroid/content/Context;Landroid/os/PowerManager;Ljava/lang/Object;Lcom/android/server/attention/AttentionManagerService$AttentionHandler;)V
    ...
    iput-object p4, p0, mAttentionHandler:Lcom/android/server/attention/AttentionManagerService$AttentionHandler;
...
.method static synthetic access$1300(Lcom/android/server/attention/AttentionManagerService;)Z
    ...
    invoke-direct {p0}, isAttentionServiceSupported()Z
...
.method static synthetic access$1900(Lcom/android/server/attention/AttentionManagerService;Lcom/android/server/attention/AttentionManagerService$UserState;)V
    ...
    invoke-direct {p0, p1}, cancelAndUnbindLocked(Lcom/android/server/attention/AttentionManagerService$UserState;)V
...
.method static synthetic access$2202(Ljava/lang/String;)Ljava/lang/String;
    ...
    sput-object p0, sTestAttentionServicePackage:Ljava/lang/String;
...
.method static synthetic access$2400(Landroid/content/Context;)Landroid/content/ComponentName;
    ...
    invoke-static {p0}, resolveAttentionService(Landroid/content/Context;)Landroid/content/ComponentName;
...
.method static synthetic access$2600(Lcom/android/server/attention/AttentionManagerService;Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    invoke-direct {p0, p1}, dumpInternal(Lcom/android/internal/util/IndentingPrintWriter;)V
...
.method private cancelAfterTimeoutLocked(J)V
    ...
    iget-object v0, p0, mAttentionHandler:Lcom/android/server/attention/AttentionManagerService$AttentionHandler;
...
.method private cancelAndUnbindLocked(Lcom/android/server/attention/AttentionManagerService$UserState;)V
    ...
    :cond_0
    invoke-virtual {p0, p1}, cancel(Lcom/android/server/attention/AttentionManagerService$UserState;)V
    ...
    :cond_1
    iget-object v1, p0, mAttentionHandler:Lcom/android/server/attention/AttentionManagerService$AttentionHandler;
...
.method private dumpInternal(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    invoke-static {v1}, getServiceConfigPackage(Landroid/content/Context;)Ljava/lang/String;
...
.method private isAttentionServiceSupported()Z
    ...
    invoke-virtual {p0}, isServiceEnabled()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-direct {p0}, isServiceAvailable()Z
...
.method private isServiceAvailable()Z
    ...
    invoke-static {v0}, resolveAttentionService(Landroid/content/Context;)Landroid/content/ComponentName;
...
.method public static isServiceConfigured(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, getServiceConfigPackage(Landroid/content/Context;)Ljava/lang/String;
...
.method private static resolveAttentionService(Landroid/content/Context;)Landroid/content/ComponentName;
    ...
    sget-object v2, sTestAttentionServicePackage:Ljava/lang/String;
...
.method cancelAttentionCheck(Landroid/attention/AttentionManagerInternal$AttentionCallbackInternal;)V
    ...
    :try_start_0
    invoke-virtual {p0}, peekCurrentUserStateLocked()Lcom/android/server/attention/AttentionManagerService$UserState;
    ...
    :cond_1
    invoke-virtual {p0, v1}, cancel(Lcom/android/server/attention/AttentionManagerService$UserState;)V
...
.method checkAttention(JLandroid/attention/AttentionManagerInternal$AttentionCallbackInternal;)Z
    ...
    invoke-virtual {p0}, freeIfInactiveLocked()V

    invoke-virtual {p0}, getOrCreateCurrentUserStateLocked()Lcom/android/server/attention/AttentionManagerService$UserState;
    ...
    :cond_4
    invoke-direct {p0, p3, v4}, createAttentionCheck(Landroid/attention/AttentionManagerInternal$AttentionCallbackInternal;Lcom/android/server/attention/AttentionManagerService$UserState;)Lcom/android/server/attention/AttentionManagerService$AttentionCheck;
    ...
    :try_start_1
    invoke-direct {p0, p1, p2}, cancelAfterTimeoutLocked(J)V
...
.method protected getOrCreateCurrentUserStateLocked()Lcom/android/server/attention/AttentionManagerService$UserState;
    ...
    invoke-virtual {p0, v0}, getOrCreateUserStateLocked(I)Lcom/android/server/attention/AttentionManagerService$UserState;
...
.method protected getOrCreateUserStateLocked(I)Lcom/android/server/attention/AttentionManagerService$UserState;
    ...
    iget-object v5, p0, mAttentionHandler:Lcom/android/server/attention/AttentionManagerService$AttentionHandler;

    iget-object v6, p0, mComponentName:Landroid/content/ComponentName;
...
.method public onSwitchUser(I)V
    ...
    invoke-direct {p0, p1}, peekUserStateLocked(I)Lcom/android/server/attention/AttentionManagerService$UserState;

    move-result-object v0

    invoke-direct {p0, v0}, cancelAndUnbindLocked(Lcom/android/server/attention/AttentionManagerService$UserState;)V
...
.method protected peekCurrentUserStateLocked()Lcom/android/server/attention/AttentionManagerService$UserState;
    ...
    invoke-direct {p0, v0}, peekUserStateLocked(I)Lcom/android/server/attention/AttentionManagerService$UserState;
