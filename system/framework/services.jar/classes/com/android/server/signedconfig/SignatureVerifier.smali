...
.method public constructor <init>(Lcom/android/server/signedconfig/SignedConfigEvent;)V
    ...
    iput-object p1, p0, mEvent:Lcom/android/server/signedconfig/SignedConfigEvent;
    ...
    invoke-static {v0}, createKey(Ljava/lang/String;)Ljava/security/PublicKey;
    ...
    :goto_0
    iput-object v0, p0, mDebugKey:Ljava/security/PublicKey;
    ...
    iput-object v0, p0, mProdKey:Ljava/security/PublicKey;
...
.method public verifySignature(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    iget-object v4, p0, mDebugKey:Ljava/security/PublicKey;

    if-eqz v4, :cond_0

    invoke-direct {p0, v4, v3, v2}, verifyWithPublicKey(Ljava/security/PublicKey;[B[B)Z
    ...
    iget-object v0, p0, mEvent:Lcom/android/server/signedconfig/SignedConfigEvent;
    ...
    :cond_1
    iget-object v4, p0, mProdKey:Ljava/security/PublicKey;
    ...
    iget-object v3, p0, mEvent:Lcom/android/server/signedconfig/SignedConfigEvent;
