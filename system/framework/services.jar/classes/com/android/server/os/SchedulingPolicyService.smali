...
.method static constructor <clinit>()V
    ...
    sput-object v0, MEDIA_PROCESS_NAMES:[Ljava/lang/String;
...
.method private disableCpusetBoost(I)I
    ...
    iget v2, p0, mBoostedPid:I

    const/4 v3, -0x1

    iput v3, p0, mBoostedPid:I

    iget-object v4, p0, mClient:Landroid/os/IBinder;
    ...
    :try_start_0
    iget-object v7, p0, mDeathRecipient:Landroid/os/IBinder$DeathRecipient;
    ...
    iput-object v6, p0, mClient:Landroid/os/IBinder;
...
.method private enableCpusetBoost(ILandroid/os/IBinder;)I
    ...
    iput v1, p0, mBoostedPid:I

    iget-object v3, p0, mClient:Landroid/os/IBinder;
    ...
    :try_start_0
    iget-object v5, p0, mDeathRecipient:Landroid/os/IBinder$DeathRecipient;
    ...
    iput-object v4, p0, mClient:Landroid/os/IBinder;
    ...
    :cond_1
    :try_start_1
    iget-object v3, p0, mDeathRecipient:Landroid/os/IBinder$DeathRecipient;
    ...
    iput p1, p0, mBoostedPid:I

    iput-object p2, p0, mClient:Landroid/os/IBinder;
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_1
...
.method public synthetic lambda$new$0$SchedulingPolicyService()V
    ...
    sget-object v1, MEDIA_PROCESS_NAMES:[Ljava/lang/String;
    ...
    invoke-direct {p0, v2}, disableCpusetBoost(I)I
...
.method public requestCpusetBoost(ZLandroid/os/IBinder;)I
    ...
    :cond_0
    sget-object v0, MEDIA_PROCESS_NAMES:[Ljava/lang/String;
    ...
    invoke-direct {p0, v2, p2}, enableCpusetBoost(ILandroid/os/IBinder;)I
...
.method public requestPriority(IIIZ)I
    ...
    invoke-direct {p0}, isPermitted()Z
