...
.method static constructor <clinit>()V
    ...
    sput-object v0, HAL_INTERFACES_OF_INTEREST:Ljava/util/List;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, mOpenFdMonitor:Lcom/android/server/Watchdog$OpenFdMonitor;
...
.method private evaluateCheckerCompletionLocked()I
    ...
    :goto_0
    iget-object v2, p0, mHandlerCheckers:Ljava/util/ArrayList;
...
.method private static getInterestingHalPids()Ljava/util/ArrayList;
    ...
    :cond_0
    sget-object v5, HAL_INTERFACES_OF_INTEREST:Ljava/util/List;
...
.method static getInterestingNativePids()Ljava/util/ArrayList;
    ...
    invoke-static {}, getInterestingHalPids()Ljava/util/ArrayList;

    move-result-object v0

    sget-object v1, NATIVE_STACKS_OF_INTEREST:[Ljava/lang/String;
...
.method public run()V
    ...
    :goto_1
    :try_start_0
    iget-object v8, v1, mHandlerCheckers:Ljava/util/ArrayList;
    ...
    :try_start_6
    iget-object v12, v1, mOpenFdMonitor:Lcom/android/server/Watchdog$OpenFdMonitor;
    :try_end_6
    ...
    invoke-static {}, getInterestingNativePids()Ljava/util/ArrayList;
    ...
    invoke-direct {v1, v10, v11}, cleanupProcesses(J)V
    ...
    invoke-direct {v1, v10}, describeCheckersLocked(Ljava/util/List;)Ljava/lang/String;
    ...
    :goto_4
    iget-boolean v14, v1, mAllowRestart:Z
    ...
    invoke-direct/range {p0 .. p0}, binderStateRead()V
    ...
    iget-object v9, v1, mTraceDateFormat:Ljava/text/SimpleDateFormat;
    ...
    invoke-direct {v1, v14, v3}, appendFile(Ljava/io/File;Ljava/io/File;)V
    ...
    invoke-direct {v1, v14, v8}, appendFile(Ljava/io/File;Ljava/io/File;)V
    ...
    invoke-direct {v1, v0}, doSysRq(C)V
    ...
    :try_start_b
    iget-object v0, v1, mController:Landroid/app/IActivityController;
    ...
    invoke-direct {v1, v2, v3}, cleanupProcesses(J)V
