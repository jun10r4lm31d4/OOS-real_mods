...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mPinnedFiles:Ljava/util/ArrayList;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, mPinnedApps:Landroid/util/ArrayMap;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, mPendingRepin:Landroid/util/ArrayMap;

    new-instance v0, Landroid/util/ArraySet;

    invoke-direct {v0}, Landroid/util/ArraySet;-><init>()V

    iput-object v0, p0, mPinKeys:Landroid/util/ArraySet;

    const/4 v0, 0x0

    iput-object v0, p0, mPinnerHandler:Lcom/android/server/PinnerService$PinnerHandler;
    ...
    iget-object v2, p0, mPinKeys:Landroid/util/ArraySet;
    ...
    iput-object v2, p0, mPinnerHandler:Lcom/android/server/PinnerService$PinnerHandler;
    ...
    iput-object v2, p0, mAtmInternal:Lcom/android/server/wm/ActivityTaskManagerInternal;
    ...
    iput-object v2, p0, mAmInternal:Landroid/app/ActivityManagerInternal;
    ...
    invoke-direct {p0}, registerUidListener()V

    invoke-direct {p0}, registerUserSetupCompleteListener()V
...
.method static synthetic access$100(Lcom/android/server/PinnerService;IIZ)V
    ...
    invoke-direct {p0, p1, p2, p3}, sendPinAppMessage(IIZ)V
...
.method static synthetic access$1000(Lcom/android/server/PinnerService;I)Ljava/lang/String;
    ...
    invoke-direct {p0, p1}, getNameForKey(I)Ljava/lang/String;
...
.method static synthetic access$1100(Lcom/android/server/PinnerService;)Landroid/util/ArrayMap;
    ...
    iget-object v0, p0, mPendingRepin:Landroid/util/ArrayMap;
...
.method static synthetic access$1200(JJ)V
    ...
    invoke-static {p0, p1, p2, p3}, safeMunmap(JJ)V
...
.method static synthetic access$1400(Lcom/android/server/PinnerService;)V
    ...
    invoke-direct {p0}, handlePinOnStart()V
...
.method static synthetic access$200(Lcom/android/server/PinnerService;)Lcom/android/server/PinnerService$PinnerHandler;
    ...
    iget-object v0, p0, mPinnerHandler:Lcom/android/server/PinnerService$PinnerHandler;
...
.method static synthetic access$300(Lcom/android/server/PinnerService;I)V
    ...
    invoke-direct {p0, p1}, handleUidActive(I)V
...
.method static synthetic access$800(Lcom/android/server/PinnerService;)Ljava/util/ArrayList;
    ...
    iget-object v0, p0, mPinnedFiles:Ljava/util/ArrayList;
...
.method static synthetic access$900(Lcom/android/server/PinnerService;)Landroid/util/ArrayMap;
    ...
    iget-object v0, p0, mPinnedApps:Landroid/util/ArrayMap;
...
.method private getApplicationInfoForIntent(Landroid/content/Intent;IZ)Landroid/content/pm/ApplicationInfo;
    ...
    invoke-direct {p0, v3}, isResolverActivity(Landroid/content/pm/ActivityInfo;)Z
...
.method private getCameraInfo(I)Landroid/content/pm/ApplicationInfo;
    ...
    invoke-direct {p0, v0, p1, v2}, getApplicationInfoForIntent(Landroid/content/Intent;IZ)Landroid/content/pm/ApplicationInfo;
    ...
    invoke-direct {p0, v0, p1, v1}, getApplicationInfoForIntent(Landroid/content/Intent;IZ)Landroid/content/pm/ApplicationInfo;
...
.method private getHomeInfo(I)Landroid/content/pm/ApplicationInfo;
    ...
    iget-object v0, p0, mAtmInternal:Lcom/android/server/wm/ActivityTaskManagerInternal;
...
.method private getInfoForKey(II)Landroid/content/pm/ApplicationInfo;
    ...
    :cond_0
    invoke-direct {p0, p2}, getHomeInfo(I)Landroid/content/pm/ApplicationInfo;
    ...
    :cond_1
    invoke-direct {p0, p2}, getCameraInfo(I)Landroid/content/pm/ApplicationInfo;
...
.method private handlePinOnStart()V
    ...
    invoke-static {v5, v6, v3}, pinFile(Ljava/lang/String;IZ)Lcom/android/server/PinnerService$PinnedFile;
    ...
    :try_start_0
    iget-object v7, p0, mPinnedFiles:Ljava/util/ArrayList;
...
.method private handleUidActive(I)V
    ...
    invoke-direct {p0, p1, v0}, updateActiveState(IZ)V
...
.method private handleUidGone(I)V
    ...
    :try_start_0
    iget-object v1, p0, mPendingRepin:Landroid/util/ArrayMap;
    ...
    :cond_0
    iget-object v2, p0, mPendingRepin:Landroid/util/ArrayMap;
    ...
    invoke-direct {p0, v1, v2, v0}, pinApp(IIZ)V
...
.method public static synthetic lambda$6bekYOn4YXi0x7vYNWO40QyA-s8(Lcom/android/server/PinnerService;IIZ)V
    ...
    invoke-direct {p0, p1, p2, p3}, pinApp(IIZ)V
...
.method public static synthetic lambda$GeEX-8XoHeV0LEszxat7jOSlrs4(Lcom/android/server/PinnerService;I)V
    ...
    invoke-direct {p0, p1}, pinApps(I)V
...
.method private pinApp(IIZ)V
    ...
    invoke-direct {p0, p1}, getUidForKey(I)I
    ...
    :cond_0
    invoke-direct {p0, p1}, unpinApp(I)V

    invoke-direct {p0, p1, p2}, getInfoForKey(II)Landroid/content/pm/ApplicationInfo;

    move-result-object v1

    if-eqz v1, :cond_1

    invoke-direct {p0, p1, v1}, pinApp(ILandroid/content/pm/ApplicationInfo;)V
...
.method private pinApp(ILandroid/content/pm/ApplicationInfo;)V
    ...
    :try_start_0
    iget-object v1, p0, mPinnedApps:Landroid/util/ArrayMap;
    ...
    invoke-direct {p0, p1}, getSizeLimitForKey(I)I
    ...
    invoke-static {v2, v1, v3}, pinFile(Ljava/lang/String;IZ)Lcom/android/server/PinnerService$PinnedFile;
    ...
    invoke-static {v10, v1, v6}, pinFile(Ljava/lang/String;IZ)Lcom/android/server/PinnerService$PinnedFile;
...
.method private pinApps(I)V
    ...
    iget-object v0, p0, mPinKeys:Landroid/util/ArraySet;
    ...
    invoke-direct {p0, v2, p1, v1}, pinApp(IIZ)V
...
.method private static pinFile(Ljava/lang/String;IZ)Lcom/android/server/PinnerService$PinnedFile;
    ...
    :try_start_0
    invoke-static {p0}, maybeOpenZip(Ljava/lang/String;)Ljava/util/zip/ZipFile;
    ...
    invoke-static {v0, p0}, maybeOpenPinMetaInZip(Ljava/util/zip/ZipFile;Ljava/lang/String;)Ljava/io/InputStream;
    ...
    invoke-static {p0, p1, v2}, pinFileRanges(Ljava/lang/String;ILcom/android/server/PinnerService$PinRangeSource;)Lcom/android/server/PinnerService$PinnedFile;

    move-result-object v3
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-static {v1}, safeClose(Ljava/io/Closeable;)V

    invoke-static {v0}, safeClose(Ljava/io/Closeable;)V
...
.method private static pinFileRanges(Ljava/lang/String;ILcom/android/server/PinnerService$PinRangeSource;)Lcom/android/server/PinnerService$PinnedFile;
    ...
    invoke-static {v5, v1, v6}, clamp(III)I
    ...
    invoke-static {v5, v2, v3}, clamp(III)I
    ...
    invoke-static/range {v16 .. v16}, safeClose(Ljava/io/FileDescriptor;)V
    ...
    invoke-static {v2, v3, v4, v5}, safeMunmap(JJ)V
    ...
    invoke-static {v1}, safeClose(Ljava/io/FileDescriptor;)V
    ...
    invoke-static {v2, v3, v8, v9}, safeMunmap(JJ)V
    ...
    invoke-static {v10, v11, v1, v2}, safeMunmap(JJ)V
...
.method public onStart()V
    ...
    iput-object v0, p0, mBinderService:Lcom/android/server/PinnerService$BinderService;

    iget-object v0, p0, mBinderService:Lcom/android/server/PinnerService$BinderService;
    ...
    invoke-virtual {p0, v0, p0}, publishLocalService(Ljava/lang/Class;Ljava/lang/Object;)V
    ...
    invoke-direct {p0, v0}, sendPinAppsMessage(I)V
...
.method public onSwitchUser(I)V
    ...
    invoke-direct {p0, p1}, sendPinAppsMessage(I)V
...
.method public update(Landroid/util/ArraySet;Z)V
    ...
    iget-object v1, p0, mPinKeys:Landroid/util/ArraySet;
    ...
    invoke-direct {p0, v2, v0}, getInfoForKey(II)Landroid/content/pm/ApplicationInfo;
    ...
    invoke-direct {p0, v2, v0, p2}, sendPinAppMessage(IIZ)V
