...
.method private constructor <init>(Lcom/android/server/LocationManagerService;Landroid/location/ILocationListener;Landroid/app/PendingIntent;IILjava/lang/String;Landroid/os/WorkSource;Z)V
    ...
    invoke-virtual {p0, v0}, updateMonitoring(Z)V
    ...
    iget-object v1, p0, mCallerIdentity:Lcom/android/server/location/CallerIdentity;

    iget v1, v1, Lcom/android/server/location/CallerIdentity;->mUid:I

    iget-object v2, p0, mCallerIdentity:Lcom/android/server/location/CallerIdentity;
...
.method synthetic constructor <init>(Lcom/android/server/LocationManagerService;Landroid/location/ILocationListener;Landroid/app/PendingIntent;IILjava/lang/String;Landroid/os/WorkSource;ZLcom/android/server/LocationManagerService$1;)V
    ...
    invoke-direct/range {p0 .. p8}, <init>(Lcom/android/server/LocationManagerService;Landroid/location/ILocationListener;Landroid/app/PendingIntent;IILjava/lang/String;Landroid/os/WorkSource;Z)V
...
.method static synthetic access$3900(Lcom/android/server/LocationManagerService$Receiver;Ljava/lang/String;Z)Z
    ...
    invoke-direct {p0, p1, p2}, callProviderEnabledLocked(Ljava/lang/String;Z)Z
...
.method private callProviderEnabledLocked(Ljava/lang/String;Z)Z
    ...
    iget-object v1, p0, mListener:Landroid/location/ILocationListener;
    ...
    :try_start_1
    iget-object v3, p0, mPendingIntent:Landroid/app/PendingIntent;
    ...
    iget v7, p0, mAllowedResolutionLevel:I
...
.method private updateMonitoring(ZZI)Z
    ...
    iget-object v3, p0, mCallerIdentity:Lcom/android/server/location/CallerIdentity;
...
.method public binderDied()V
    ...
    iget-object v1, p0, mListenerName:Ljava/lang/String;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v1, v1, mKey:Ljava/lang/Object;
...
.method public toString()Ljava/lang/String;
    ...
    :goto_0
    iget-object v1, p0, mUpdateRecords:Ljava/util/HashMap;
    ...
    iget-boolean v1, p0, mOpMonitoring:Z
...
.method public updateMonitoring(Z)V
    ...
    iget-boolean v0, p0, mHideFromAppOps:Z
    ...
    iget-object v2, p0, mUpdateRecords:Ljava/util/HashMap;
    ...
    :cond_4
    :goto_1
    iget-boolean v2, p0, mOpMonitoring:Z

    const/16 v3, 0x29

    invoke-direct {p0, v0, v2, v3}, updateMonitoring(ZZI)Z

    move-result v2

    iput-boolean v2, p0, mOpMonitoring:Z

    iget-boolean v2, p0, mOpHighPowerMonitoring:Z

    iget-boolean v3, p0, mOpHighPowerMonitoring:Z

    const/16 v4, 0x2a

    invoke-direct {p0, v1, v3, v4}, updateMonitoring(ZZI)Z

    move-result v3

    iput-boolean v3, p0, mOpHighPowerMonitoring:Z
