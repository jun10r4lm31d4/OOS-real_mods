...
.method public constructor <init>(Ljava/lang/Object;)V
    ...
    iput v0, p0, mBatterySaverEnabledCount:I

    const-wide/16 v0, 0x0

    iput-wide v0, p0, mLastBatterySaverEnabledTime:J

    iput-wide v0, p0, mLastBatterySaverDisabledTime:J
...
.method private dumpLineLocked(Ljava/io/PrintWriter;Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)V
    ...
    invoke-direct {p0, v0, p3, p5}, getStat(III)Lcom/android/server/power/batterysaver/BatterySavingStats$Stat;

    move-result-object v1

    const/4 v2, 0x1

    invoke-direct {p0, v2, p3, p5}, getStat(III)Lcom/android/server/power/batterysaver/BatterySavingStats$Stat;
...
.method private endLastStateLocked(JII)V
    ...
    :cond_0
    invoke-virtual {v0, v1}, getStat(I)Lcom/android/server/power/batterysaver/BatterySavingStats$Stat;
...
.method private getStat(III)Lcom/android/server/power/batterysaver/BatterySavingStats$Stat;
    ...
    invoke-static {p1, p2, p3}, statesToIndex(III)I

    move-result v0

    invoke-virtual {p0, v0}, getStat(I)Lcom/android/server/power/batterysaver/BatterySavingStats$Stat;
...
.method private transitionStateLocked(I)V
    ...
    :cond_0
    invoke-virtual {p0}, injectCurrentTime()J

    move-result-wide v7

    invoke-virtual {p0}, injectBatteryLevel()I

    move-result v0

    invoke-virtual {p0}, injectBatteryPercent()I
    ...
    iput-boolean v11, p0, mIsBatterySaverEnabled:Z

    if-eqz v11, :cond_3

    iget v1, p0, mBatterySaverEnabledCount:I

    add-int/2addr v1, v3

    iput v1, p0, mBatterySaverEnabledCount:I

    invoke-virtual {p0}, injectCurrentTime()J

    move-result-wide v1

    iput-wide v1, p0, mLastBatterySaverEnabledTime:J
    ...
    iput-wide v1, p0, mLastBatterySaverDisabledTime:J

    :cond_4
    :goto_1
    invoke-direct {p0, v7, v8, v0, v9}, endLastStateLocked(JII)V
    ...
    invoke-direct/range {v1 .. v6}, startNewStateLocked(IJII)V
...
.method public dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    iget-object v10, v8, mLock:Ljava/lang/Object;
    ...
    invoke-virtual/range {p0 .. p0}, injectCurrentTime()J
    ...
    iget-boolean v1, v8, mIsBatterySaverEnabled:Z
    ...
    iget-wide v1, v8, mLastBatterySaverEnabledTime:J
    ...
    iget-wide v3, v8, mLastBatterySaverEnabledTime:J
    ...
    :cond_1
    iget-wide v1, v8, mLastBatterySaverDisabledTime:J
    ...
    iget-wide v4, v8, mLastBatterySaverDisabledTime:J
    ...
    iget v1, v8, mBatterySaverEnabledCount:I
    ...
    invoke-direct/range {v1 .. v7}, dumpLineLocked(Ljava/io/PrintWriter;Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)V
...
.method public startCharging()V
    ...
    :try_start_0
    invoke-direct {p0, v1}, transitionStateLocked(I)V
