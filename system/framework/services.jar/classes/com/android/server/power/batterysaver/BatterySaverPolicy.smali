...
.method static constructor <clinit>()V
    ...
    sput-object v21, OFF_POLICY:Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;

    sget-object v0, OFF_POLICY:Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;

    sput-object v0, DEFAULT_ADAPTIVE_POLICY:Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;
    ...
    sput-object v0, DEFAULT_FULL_POLICY:Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;
...
.method public constructor <init>(Ljava/lang/Object;Landroid/content/Context;Lcom/android/server/power/batterysaver/BatterySavingStats;)V
    ...
    sget-object v0, DEFAULT_ADAPTIVE_POLICY:Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;

    iput-object v0, p0, mDefaultAdaptivePolicy:Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;

    iput-object v0, p0, mAdaptivePolicy:Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;

    sget-object v0, DEFAULT_FULL_POLICY:Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;

    iput-object v0, p0, mFullPolicy:Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;

    const/4 v0, 0x0

    iput v0, p0, mPolicyLevel:I
    ...
    iput-object p3, p0, mBatterySavingStats:Lcom/android/server/power/batterysaver/BatterySavingStats;
...
.method private dumpPolicyLocked(Ljava/io/PrintWriter;Ljava/lang/String;Ljava/lang/String;Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;)V
    ...
    iget-boolean v1, p0, mAccessibilityEnabled:Z
    ...
    invoke-direct {p0, p1, v1, v0}, dumpMap(Ljava/io/PrintWriter;Ljava/lang/String;Landroid/util/ArrayMap;)V
...
.method private getCurrentPolicyLocked()Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;
    ...
    :cond_0
    iget-object v0, p0, mFullPolicy:Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;

    return-object v0

    :cond_1
    iget-object v0, p0, mAdaptivePolicy:Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;
...
.method private refreshSettings()V
    ...
    invoke-virtual {p0, v1}, getGlobalSetting(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    const-string v2, "battery_saver_device_specific_constants"

    invoke-virtual {p0, v2}, getGlobalSetting(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    const-string v3, "battery_saver_device_specific_constants"

    iput-object v3, p0, mDeviceSpecificSettingsSource:Ljava/lang/String;
    ...
    invoke-virtual {p0}, getDeviceSpecificConfigResId()I
    ...
    invoke-virtual {p0, v3}, getGlobalSetting(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    const-string v4, "battery_saver_adaptive_device_specific_constants"

    invoke-virtual {p0, v4}, getGlobalSetting(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    invoke-direct {p0, v1, v2, v3, v4}, updateConstantsLocked(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
...
.method private updateConstantsLocked(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    iget-object v0, p0, mSettings:Ljava/lang/String;
    ...
    iget-object v0, p0, mDeviceSpecificSettings:Ljava/lang/String;
    ...
    iget-object v0, p0, mAdaptiveSettings:Ljava/lang/String;
    ...
    iget-object v0, p0, mAdaptiveDeviceSpecificSettings:Ljava/lang/String;
    ...
    :cond_0
    iput-object p1, p0, mSettings:Ljava/lang/String;

    iput-object p2, p0, mDeviceSpecificSettings:Ljava/lang/String;

    iput-object p3, p0, mAdaptiveSettings:Ljava/lang/String;

    iput-object p4, p0, mAdaptiveDeviceSpecificSettings:Ljava/lang/String;

    const/4 v0, 0x0

    sget-object v1, DEFAULT_FULL_POLICY:Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;
    ...
    iget v2, p0, mPolicyLevel:I

    const/4 v3, 0x2

    if-ne v2, v3, :cond_1

    iget-object v2, p0, mFullPolicy:Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;
    ...
    :cond_1
    iput-object v1, p0, mFullPolicy:Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;

    sget-object v2, DEFAULT_ADAPTIVE_POLICY:Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;
    ...
    iput-object v2, p0, mDefaultAdaptivePolicy:Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;
    ...
    iget-object v2, p0, mAdaptivePolicy:Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;

    iget-object v3, p0, mDefaultAdaptivePolicy:Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;
    ...
    :cond_2
    iget-object v2, p0, mDefaultAdaptivePolicy:Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;

    iput-object v2, p0, mAdaptivePolicy:Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;

    invoke-direct {p0}, updatePolicyDependenciesLocked()V
...
.method private updatePolicyDependenciesLocked()V
    ...
    invoke-direct {p0}, getCurrentPolicyLocked()Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;
    ...
    :goto_0
    iput-boolean v1, p0, mDisableVibrationEffective:Z
    ...
    :cond_2
    iget-boolean v2, p0, mDisableVibrationEffective:Z
    ...
    iput-object v2, p0, mEventLogKeys:Ljava/lang/String;
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    iget-object v1, p0, mBatterySavingStats:Lcom/android/server/power/batterysaver/BatterySavingStats;
    ...
    iget-object v2, p0, mSettings:Ljava/lang/String;
    ...
    iget-object v2, p0, mDeviceSpecificSettingsSource:Ljava/lang/String;
    ...
    iget-object v2, p0, mDeviceSpecificSettings:Ljava/lang/String;
    ...
    iget-object v2, p0, mAdaptiveSettings:Ljava/lang/String;
    ...
    iget-object v2, p0, mAdaptiveDeviceSpecificSettings:Ljava/lang/String;
    ...
    iget-boolean v2, p0, mAccessibilityEnabled:Z
    ...
    iget-object v3, p0, mFullPolicy:Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;

    invoke-direct {p0, p1, v1, v2, v3}, dumpPolicyLocked(Ljava/io/PrintWriter;Ljava/lang/String;Ljava/lang/String;Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;)V
    ...
    iget-object v3, p0, mAdaptivePolicy:Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;
...
.method public getBatterySaverPolicy(I)Landroid/os/PowerSaveState;
    ...
    :pswitch_e
    iget-boolean v3, p0, mDisableVibrationEffective:Z
...
.method public synthetic lambda$systemReady$0$BatterySaverPolicy(Z)V
    ...
    :try_start_0
    iput-boolean p1, p0, mAccessibilityEnabled:Z

    monitor-exit v0
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-direct {p0}, refreshSettings()V
...
.method resetAdaptivePolicyLocked()Z
    ...
    iget-object v0, p0, mDefaultAdaptivePolicy:Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;

    invoke-virtual {p0, v0}, setAdaptivePolicyLocked(Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;)Z
...
.method setAdaptivePolicyLocked(Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;)Z
    ...
    :cond_0
    iget-object v1, p0, mAdaptivePolicy:Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;
    ...
    :cond_1
    iput-object p1, p0, mAdaptivePolicy:Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;

    iget v1, p0, mPolicyLevel:I
...
.method public systemReady()V
    ...
    :try_start_0
    iput-boolean v1, p0, mAccessibilityEnabled:Z
    ...
    invoke-virtual {p0, v2, v3}, onChange(ZLandroid/net/Uri;)V
...
.method public toEventLogString()Ljava/lang/String;
    ...
    :try_start_0
    iget-object v1, p0, mEventLogKeys:Ljava/lang/String;
...
.method updateConstantsLocked(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2, v0, v0}, updateConstantsLocked(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
