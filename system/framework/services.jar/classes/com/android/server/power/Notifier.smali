...
.method static constructor <clinit>()V
    ...
    sput-object v1, WIRELESS_VIBRATION_TIME:[J

    new-array v0, v0, [I

    fill-array-data v0, :array_1

    sput-object v0, WIRELESS_VIBRATION_AMPLITUDE:[I

    sget-object v0, WIRELESS_VIBRATION_TIME:[J

    sget-object v1, WIRELESS_VIBRATION_AMPLITUDE:[I
    ...
    sput-object v0, WIRELESS_CHARGING_VIBRATION_EFFECT:Landroid/os/VibrationEffect;
...
.method public constructor <init>(Landroid/os/Looper;Landroid/content/Context;Lcom/android/internal/app/IBatteryStats;Lcom/android/server/power/SuspendBlocker;Lcom/android/server/policy/WindowManagerPolicy;)V
    ...
    iput-object v1, p0, mScreeBrightnessBoostChangedDone:Landroid/content/BroadcastReceiver;
    ...
    iput-object v1, p0, mWakeUpBroadcastDone:Landroid/content/BroadcastReceiver;
    ...
    iput-object v1, p0, mGoToSleepBroadcastDone:Landroid/content/BroadcastReceiver;
    ...
    iput-object p4, p0, mSuspendBlocker:Lcom/android/server/power/SuspendBlocker;

    iput-object p5, p0, mPolicy:Lcom/android/server/policy/WindowManagerPolicy;
    ...
    iput-object v1, p0, mInputMethodManagerInternal:Lcom/android/server/inputmethod/InputMethodManagerInternal;
    ...
    iput-object v1, p0, mTrustManager:Landroid/app/trust/TrustManager;
    ...
    iput-object v1, p0, mHandler:Lcom/android/server/power/Notifier$NotifierHandler;
    ...
    iput-object v1, p0, mScreenOnIntent:Landroid/content/Intent;
    ...
    iput-object v1, p0, mScreenOffIntent:Landroid/content/Intent;
    ...
    iput-object v1, p0, mScreenBrightnessBoostIntent:Landroid/content/Intent;
...
.method static synthetic access$100(Lcom/android/server/power/Notifier;)I
    ...
    iget v0, p0, mInteractiveChangeReason:I
...
.method static synthetic access$1100(Lcom/android/server/power/Notifier;I)V
    ...
    invoke-direct {p0, p1}, showWiredChargingStarted(I)V
...
.method static synthetic access$200(I)I
    ...
    invoke-static {p0}, translateOnReason(I)I
...
.method static synthetic access$300(Lcom/android/server/power/Notifier;)Lcom/android/server/policy/WindowManagerPolicy;
    ...
    iget-object v0, p0, mPolicy:Lcom/android/server/policy/WindowManagerPolicy;
...
.method static synthetic access$800(Lcom/android/server/power/Notifier;II)V
    ...
    invoke-direct {p0, p1, p2}, showWirelessChargingStarted(II)V
...
.method private getBatteryStatsWakeLockMonitorType(I)I
    ...
    :cond_2
    iget-boolean v0, p0, mSuspendWhenScreenOffDueToProximityConfig:Z
...
.method private handleEarlyInteractiveChange()V
    ...
    iget-object v2, p0, mHandler:Lcom/android/server/power/Notifier$NotifierHandler;
...
.method private handleLateInteractiveChange()V
    ...
    iget-wide v3, p0, mInteractiveChangeStartTime:J
    ...
    iget v2, p0, mInteractiveChangeReason:I

    invoke-static {v2}, translateOnReason(I)I

    move-result v2

    iget-object v3, p0, mHandler:Lcom/android/server/power/Notifier$NotifierHandler;
    ...
    :cond_0
    iget-boolean v2, p0, mUserActivityPending:Z
    ...
    iput-boolean v2, p0, mUserActivityPending:Z
    ...
    invoke-static {v2}, translateOffReason(I)I

    move-result v2

    iget-object v4, p0, mHandler:Lcom/android/server/power/Notifier$NotifierHandler;
    ...
    iput v4, p0, mPendingInteractiveState:I

    iput-boolean v3, p0, mPendingGoToSleepBroadcast:Z
...
.method private playChargingStartedFeedback(I)V
    ...
    invoke-direct {p0, p1}, playChargingStartedVibration(I)V
...
.method private playChargingStartedVibration(I)V
    ...
    invoke-direct {p0, p1}, isChargingFeedbackEnabled(I)Z
    ...
    sget-object v2, WIRELESS_CHARGING_VIBRATION_EFFECT:Landroid/os/VibrationEffect;

    sget-object v3, VIBRATION_ATTRIBUTES:Landroid/media/AudioAttributes;
...
.method private sendBrightnessBoostChangedBroadcast()V
    ...
    iget-object v3, p0, mScreenBrightnessBoostIntent:Landroid/content/Intent;

    sget-object v4, Landroid/os/UserHandle;->ALL:Landroid/os/UserHandle;

    const/4 v5, 0x0

    iget-object v6, p0, mScreeBrightnessBoostChangedDone:Landroid/content/BroadcastReceiver;

    iget-object v7, p0, mHandler:Lcom/android/server/power/Notifier$NotifierHandler;
...
.method private sendGoToSleepBroadcast()V
    ...
    iget-object v3, p0, mScreenOffIntent:Landroid/content/Intent;

    sget-object v4, Landroid/os/UserHandle;->ALL:Landroid/os/UserHandle;

    const/4 v5, 0x0

    iget-object v6, p0, mGoToSleepBroadcastDone:Landroid/content/BroadcastReceiver;
...
.method private sendNextBroadcast()V
    ...
    iput-boolean v2, p0, mPendingWakeUpBroadcast:Z

    iput v3, p0, mBroadcastedInteractiveState:I
    ...
    :cond_2
    :goto_0
    iput-boolean v2, p0, mPendingGoToSleepBroadcast:Z

    iput v4, p0, mBroadcastedInteractiveState:I
...
.method private sendWakeUpBroadcast()V
    ...
    iget-object v3, p0, mScreenOnIntent:Landroid/content/Intent;

    sget-object v4, Landroid/os/UserHandle;->ALL:Landroid/os/UserHandle;

    const/4 v5, 0x0

    iget-object v6, p0, mWakeUpBroadcastDone:Landroid/content/BroadcastReceiver;
...
.method private showWiredChargingStarted(I)V
    ...
    invoke-direct {p0, p1}, playChargingStartedFeedback(I)V
...
.method private showWirelessChargingStarted(II)V
    ...
    invoke-direct {p0, p2}, playChargingStartedFeedback(I)V

    iget-object v0, p0, mStatusBarManagerInternal:Lcom/android/server/statusbar/StatusBarManagerInternal;
...
.method private updatePendingBroadcastLocked()V
    ...
    iget-boolean v0, p0, mBroadcastInProgress:Z

    if-nez v0, :cond_1

    iget v0, p0, mPendingInteractiveState:I
...
.method public onWakeLockAcquired(ILjava/lang/String;Ljava/lang/String;IILandroid/os/WorkSource;Ljava/lang/String;)V
    ...
    :goto_0
    invoke-direct/range {p0 .. p1}, getBatteryStatsWakeLockMonitorType(I)I
    ...
    :cond_2
    iget-object v4, v1, mBatteryStats:Lcom/android/internal/app/IBatteryStats;
...
.method public onWakeLockChanging(ILjava/lang/String;Ljava/lang/String;IILandroid/os/WorkSource;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;IILandroid/os/WorkSource;Ljava/lang/String;)V
    ...
    invoke-direct {v9, v10}, getBatteryStatsWakeLockMonitorType(I)I
    ...
    :try_start_0
    iget-object v12, v9, mBatteryStats:Lcom/android/internal/app/IBatteryStats;
    ...
    invoke-virtual/range {v1 .. v8}, onWakeLockAcquired(ILjava/lang/String;Ljava/lang/String;IILandroid/os/WorkSource;Ljava/lang/String;)V
...
.method public onWakeLockReleased(ILjava/lang/String;Ljava/lang/String;IILandroid/os/WorkSource;Ljava/lang/String;)V
    ...
    :cond_0
    invoke-direct {p0, p1}, getBatteryStatsWakeLockMonitorType(I)I
...
.method public onWakefulnessChangeStarted(IIJ)V
    ...
    iget-object v1, p0, mInputMethodManagerInternal:Lcom/android/server/inputmethod/InputMethodManagerInternal;
    ...
    iput-wide p3, p0, mInteractiveChangeStartTime:J

    iput-boolean v2, p0, mInteractiveChanging:Z
