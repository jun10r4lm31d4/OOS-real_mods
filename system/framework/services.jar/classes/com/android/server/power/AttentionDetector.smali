...
.method public constructor <init>(Ljava/lang/Runnable;Ljava/lang/Object;)V
    ...
    iput-object v0, p0, mConsecutiveTimeoutExtendedCount:Ljava/util/concurrent/atomic/AtomicLong;

    iput-object p1, p0, mOnUserAttention:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mRequested:Ljava/util/concurrent/atomic/AtomicBoolean;

    iput v1, p0, mRequestId:I
...
.method static synthetic access$100(Lcom/android/server/power/AttentionDetector;)Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v0, p0, mRequested:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method static synthetic access$400(Lcom/android/server/power/AttentionDetector;)Ljava/lang/Runnable;
    ...
    iget-object v0, p0, mOnUserAttention:Ljava/lang/Runnable;
...
.method static synthetic access$500(Lcom/android/server/power/AttentionDetector;)V
    ...
    invoke-direct {p0}, resetConsecutiveExtensionCount()V
...
.method private cancelCurrentRequestIfAny()V
    ...
    iget-object v0, p0, mAttentionManager:Landroid/attention/AttentionManagerInternal;

    iget-object v1, p0, mCallback:Lcom/android/server/power/AttentionDetector$AttentionCallbackInternalImpl;
...
.method private resetConsecutiveExtensionCount()V
    ...
    iget-object v0, p0, mConsecutiveTimeoutExtendedCount:Ljava/util/concurrent/atomic/AtomicLong;
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    iget-wide v1, p0, mMaximumExtensionMillis:J
    ...
    iget-wide v1, p0, mMaxAttentionApiTimeoutMillis:J
    ...
    invoke-virtual {p0}, isAttentionServiceSupported()Z
    ...
    iget-object v1, p0, mRequested:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method getAttentionTimeout()J
    ...
    iget-wide v0, p0, mMaxAttentionApiTimeoutMillis:J
...
.method public onUserActivity(JI)I
    ...
    :cond_1
    invoke-direct {p0}, cancelCurrentRequestIfAny()V
...
.method public systemReady(Landroid/content/Context;)V
    ...
    invoke-virtual {p0, p1}, updateEnabledFromSettings(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mAttentionManager:Landroid/attention/AttentionManagerInternal;
    ...
    iput-wide v0, p0, mMaximumExtensionMillis:J
    ...
    iput-wide v0, p0, mMaxAttentionApiTimeoutMillis:J
...
.method updateEnabledFromSettings(Landroid/content/Context;)V
    ...
    :cond_0
    iput-boolean v1, p0, mIsSettingEnabled:Z
...
.method public updateUserActivity(J)J
    ...
    iget-wide v0, p0, mLastActedOnNextScreenDimming:J
    ...
    :cond_0
    iget-boolean v0, p0, mIsSettingEnabled:Z
    ...
    :cond_2
    invoke-virtual {p0}, serviceHasSufficientPermissions()Z
    ...
    invoke-virtual {p0}, getAttentionTimeout()J

    move-result-wide v4

    sub-long v4, p1, v4

    iget-wide v6, p0, mLastUserActivityTime:J

    iget-wide v8, p0, mMaximumExtensionMillis:J
    ...
    iput-object v0, p0, mCallback:Lcom/android/server/power/AttentionDetector$AttentionCallbackInternalImpl;
    ...
    iget-object v10, p0, mCallback:Lcom/android/server/power/AttentionDetector$AttentionCallbackInternalImpl;
    ...
    iget-object v8, p0, mRequested:Ljava/util/concurrent/atomic/AtomicBoolean;
