...
.method static constructor <clinit>()V
    ...
    sput-object v0, TRON_METRICS:Landroid/util/ArrayMap;

    const-string/jumbo v0, "shutdown_system_server"

    sput-object v0, METRIC_SYSTEM_SERVER:Ljava/lang/String;

    const-string/jumbo v0, "shutdown_send_shutdown_broadcast"

    sput-object v0, METRIC_SEND_BROADCAST:Ljava/lang/String;

    const-string/jumbo v0, "shutdown_activity_manager"

    sput-object v0, METRIC_AM:Ljava/lang/String;

    const-string/jumbo v0, "shutdown_package_manager"

    sput-object v0, METRIC_PM:Ljava/lang/String;

    const-string/jumbo v0, "shutdown_radios"

    sput-object v0, METRIC_RADIOS:Ljava/lang/String;

    const-string/jumbo v0, "shutdown_radio"

    sput-object v0, METRIC_RADIO:Ljava/lang/String;

    const-string v0, "begin_shutdown"

    sput-object v0, METRIC_SHUTDOWN_TIME_START:Ljava/lang/String;

    const/4 v0, 0x1

    sput-boolean v0, sNeedShutdownDialog:Z
...
.method static synthetic access$000(Landroid/content/Context;)V
    ...
    invoke-static {p0}, beginShutdownSequence(Landroid/content/Context;)V
...
.method static synthetic access$200()Landroid/util/TimingsTraceLog;
    ...
    invoke-static {}, newTimingsLog()Landroid/util/TimingsTraceLog;
...
.method static synthetic access$300()Ljava/lang/String;
    ...
    sget-object v0, METRIC_RADIO:Ljava/lang/String;
...
.method static synthetic access$400(Ljava/lang/String;)V
    ...
    invoke-static {p0}, metricStarted(Ljava/lang/String;)V
...
.method static synthetic access$500()Z
    ...
    sget-boolean v0, mRebootHasProgressBar:Z
...
.method static synthetic access$800(Ljava/lang/String;)V
    ...
    invoke-static {p0}, metricEnded(Ljava/lang/String;)V
...
.method static synthetic access$900()Landroid/util/ArrayMap;
    ...
    sget-object v0, TRON_METRICS:Landroid/util/ArrayMap;
...
.method private static beginShutdownSequence(Landroid/content/Context;)V
    ...
    invoke-static {}, showShutdownAnimation()V
    ...
    invoke-static {p0}, showShutdownDialog(Landroid/content/Context;)Landroid/app/ProgressDialog;

    move-result-object v2

    iput-object v2, v0, mProgressDialog:Landroid/app/ProgressDialog;
    ...
    iput-object v5, v4, mPowerManager:Landroid/os/PowerManager;
    ...
    iput-object v5, v4, mCpuWakeLock:Landroid/os/PowerManager$WakeLock;

    :try_start_3
    iget-object v6, v4, mPowerManager:Landroid/os/PowerManager;
    ...
    iput-object v1, v4, mCpuWakeLock:Landroid/os/PowerManager$WakeLock;

    sget-object v1, sInstance:Lcom/android/server/power/ShutdownThread;

    iget-object v1, v1, mCpuWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    iput-object v5, v1, mScreenWakeLock:Landroid/os/PowerManager$WakeLock;

    iget-object v1, v1, mPowerManager:Landroid/os/PowerManager;
    ...
    iput-object v4, v1, mScreenWakeLock:Landroid/os/PowerManager$WakeLock;

    sget-object v1, sInstance:Lcom/android/server/power/ShutdownThread;

    iget-object v1, v1, mScreenWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    iput-object v5, v4, mScreenWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    iput-object v3, v1, mHandler:Landroid/os/Handler;
...
.method private static metricEnded(Ljava/lang/String;)V
    ...
    :try_start_0
    sget-object v1, TRON_METRICS:Landroid/util/ArrayMap;

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J

    move-result-wide v2

    sget-object v4, TRON_METRICS:Landroid/util/ArrayMap;
...
.method private static metricShutdownStart()V
    ...
    sget-object v2, METRIC_SHUTDOWN_TIME_START:Ljava/lang/String;
...
.method public static reboot(Landroid/content/Context;Ljava/lang/String;Z)V
    ...
    sput-boolean v0, mRebootHasProgressBar:Z

    sput-object p1, mReason:Ljava/lang/String;
    ...
    :cond_0
    invoke-static {p0, p2}, shutdownInner(Landroid/content/Context;Z)V
...
.method public static rebootSafeMode(Landroid/content/Context;Z)V
    ...
    sput-boolean v1, mRebootHasProgressBar:Z

    const/4 v1, 0x0

    sput-object v1, mReason:Ljava/lang/String;
    ...
    invoke-static {p0, p1}, shutdownInner(Landroid/content/Context;Z)V
...
.method private static saveMetrics(ZLjava/lang/String;)V
    ...
    sget-object v5, TRON_METRICS:Landroid/util/ArrayMap;
...
.method public static setShutdownDialogEnabled(Z)V
    ...
    sput-boolean p0, sNeedShutdownDialog:Z
...
.method private static showShutdownDialog(Landroid/content/Context;)Landroid/app/ProgressDialog;
    ...
    sget-boolean v1, sNeedShutdownDialog:Z
    ...
    sget-object v1, mReason:Ljava/lang/String;
    ...
    sget-boolean v1, mRebootHasProgressBar:Z
    ...
    :cond_1
    invoke-static {}, showSysuiReboot()Z
...
.method private static showSysuiReboot()Z
    ...
    sget-object v3, mReason:Ljava/lang/String;
...
.method private static shutdownInner(Landroid/content/Context;Z)V
    ...
    sget-boolean v1, mRebootSafeMode:Z
    ...
    sget-object v3, sConfirmDialog:Landroid/app/AlertDialog;
    ...
    sget-boolean v4, mRebootSafeMode:Z
    ...
    sput-object v3, sConfirmDialog:Landroid/app/AlertDialog;
...
.method actionDone()V
    ...
    :try_start_0
    iput-boolean v1, p0, mActionDone:Z
...
.method public run()V
    ...
    invoke-static {}, metricShutdownStart()V

    sget-object v0, METRIC_SYSTEM_SERVER:Ljava/lang/String;

    invoke-static {v0}, metricStarted(Ljava/lang/String;)V
    ...
    sget-boolean v0, mRebootSafeMode:Z
    ...
    :cond_2
    sget-object v0, METRIC_SEND_BROADCAST:Ljava/lang/String;
    ...
    iput-boolean v0, v1, mActionDone:Z
    ...
    iget-object v8, v1, mActionDoneSync:Ljava/lang/Object;

    monitor-enter v8

    :goto_2
    :try_start_0
    iget-boolean v0, v1, mActionDone:Z
    ...
    sget-object v13, sInstance:Lcom/android/server/power/ShutdownThread;

    invoke-direct {v13, v0, v9}, setRebootProgress(ILjava/lang/CharSequence;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :cond_4
    :try_start_1
    iget-object v0, v1, mActionDoneSync:Ljava/lang/Object;
    ...
    invoke-direct {v0, v5, v9}, setRebootProgress(ILjava/lang/CharSequence;)V
    ...
    invoke-static {v0}, metricEnded(Ljava/lang/String;)V
    ...
    sget-object v0, METRIC_AM:Ljava/lang/String;
    ...
    invoke-direct {v0, v6, v9}, setRebootProgress(ILjava/lang/CharSequence;)V
    ...
    sget-object v0, METRIC_PM:Ljava/lang/String;
    ...
    :cond_9
    sget-boolean v6, mRebootHasProgressBar:Z
    ...
    invoke-direct {v6, v8, v9}, setRebootProgress(ILjava/lang/CharSequence;)V

    :cond_a
    invoke-virtual {v2}, Landroid/util/TimingsTraceLog;->traceEnd()V

    sget-object v6, METRIC_PM:Ljava/lang/String;

    invoke-static {v6}, metricEnded(Ljava/lang/String;)V

    const-string v6, "ShutdownRadios"

    invoke-virtual {v2, v6}, Landroid/util/TimingsTraceLog;->traceBegin(Ljava/lang/String;)V

    sget-object v6, METRIC_RADIOS:Ljava/lang/String;

    invoke-static {v6}, metricStarted(Ljava/lang/String;)V

    const/16 v6, 0x2ee0

    invoke-direct {v1, v6}, shutdownRadios(I)V
    ...
    sget-object v6, METRIC_SYSTEM_SERVER:Ljava/lang/String;

    invoke-static {v6}, metricEnded(Ljava/lang/String;)V

    sget-boolean v6, mReboot:Z

    sget-object v8, mReason:Ljava/lang/String;

    invoke-static {v6, v8}, saveMetrics(ZLjava/lang/String;)V
    ...
    sget-object v9, mReason:Ljava/lang/String;

    invoke-static {v6, v8, v9}, rebootOrShutdown(Landroid/content/Context;ZLjava/lang/String;)V
