...
.method public constructor <init>(Ljava/lang/Object;Landroid/content/Context;Landroid/os/Looper;Lcom/android/server/power/batterysaver/BatterySaverPolicy;Lcom/android/server/power/batterysaver/BatterySavingStats;)V
    ...
    iput-object v0, p0, mHandler:Lcom/android/server/power/batterysaver/BatterySaverController$MyHandler;

    iput-object p4, p0, mBatterySaverPolicy:Lcom/android/server/power/batterysaver/BatterySaverPolicy;
    ...
    iput-object v0, p0, mFileUpdater:Lcom/android/server/power/batterysaver/FileUpdater;

    iput-object p5, p0, mBatterySavingStats:Lcom/android/server/power/batterysaver/BatterySavingStats;
    ...
    iput-object v0, p0, mPlugins:[Lcom/android/server/power/batterysaver/BatterySaverController$Plugin;
...
.method static synthetic access$000(Lcom/android/server/power/batterysaver/BatterySaverController;)Z
    ...
    invoke-direct {p0}, isPolicyEnabled()Z
...
.method static synthetic access$100(Lcom/android/server/power/batterysaver/BatterySaverController;)V
    ...
    invoke-direct {p0}, updateBatterySavingStats()V
...
.method static synthetic access$200(Lcom/android/server/power/batterysaver/BatterySaverController;)Lcom/android/server/power/batterysaver/BatterySaverController$MyHandler;
    ...
    iget-object v0, p0, mHandler:Lcom/android/server/power/batterysaver/BatterySaverController$MyHandler;
...
.method static synthetic access$402(Lcom/android/server/power/batterysaver/BatterySaverController;Z)Z
    ...
    iput-boolean p1, p0, mIsPluggedIn:Z
...
.method static synthetic access$500(Lcom/android/server/power/batterysaver/BatterySaverController;)[Lcom/android/server/power/batterysaver/BatterySaverController$Plugin;
    ...
    iget-object v0, p0, mPlugins:[Lcom/android/server/power/batterysaver/BatterySaverController$Plugin;
...
.method private isPolicyEnabled()Z
    ...
    :try_start_0
    iget-boolean v1, p0, mFullEnabled:Z

    if-nez v1, :cond_1

    iget-boolean v1, p0, mAdaptiveEnabled:Z
...
.method private updateBatterySavingStats()V
    ...
    invoke-direct {p0}, getPowerManager()Landroid/os/PowerManager;
    ...
    :try_start_0
    iget-boolean v7, p0, mIsPluggedIn:Z

    if-eqz v7, :cond_3

    iget-object v3, p0, mBatterySavingStats:Lcom/android/server/power/batterysaver/BatterySavingStats;
    ...
    :cond_3
    iget-object v7, p0, mBatterySavingStats:Lcom/android/server/power/batterysaver/BatterySavingStats;

    iget-boolean v8, p0, mFullEnabled:Z
    ...
    :cond_4
    iget-boolean v8, p0, mAdaptiveEnabled:Z
...
.method private updatePolicyLevelLocked()Z
    ...
    iget-boolean v0, p0, mFullEnabled:Z
    ...
    :cond_0
    iget-boolean v0, p0, mAdaptiveEnabled:Z
...
.method public enableBatterySaver(ZI)V
    ...
    :cond_0
    iput-boolean p1, p0, mFullEnabled:Z

    invoke-direct {p0}, updatePolicyLevelLocked()Z

    move-result v1

    if-eqz v1, :cond_1

    iget-object v1, p0, mHandler:Lcom/android/server/power/batterysaver/BatterySaverController$MyHandler;
...
.method handleBatterySaverStateChanged(ZI)V
    ...
    iget-boolean v1, p0, mFullPreviouslyEnabled:Z
    ...
    :goto_2
    iget-boolean v3, p0, mAdaptivePreviouslyEnabled:Z
    ...
    :goto_3
    iget-boolean v4, p0, mFullEnabled:Z
    ...
    :goto_4
    iget-boolean v5, p0, mAdaptiveEnabled:Z

    nop

    if-eqz v10, :cond_5

    iget-object v2, p0, mBatterySaverPolicy:Lcom/android/server/power/batterysaver/BatterySaverPolicy;
    ...
    iput-boolean v1, p0, mFullPreviouslyEnabled:Z

    iget-boolean v1, p0, mAdaptiveEnabled:Z

    iput-boolean v1, p0, mAdaptivePreviouslyEnabled:Z
    ...
    iget-object v4, p0, mFileUpdater:Lcom/android/server/power/batterysaver/FileUpdater;
    ...
    :goto_7
    iget-object v4, p0, mPlugins:[Lcom/android/server/power/batterysaver/BatterySaverController$Plugin;
...
.method public isInteractive()Z
    ...
    :try_start_0
    iget-boolean v1, p0, mIsInteractive:Z
...
.method setAdaptivePolicyEnabledLocked(ZI)Z
    ...
    :cond_0
    iput-boolean p1, p0, mAdaptiveEnabled:Z
...
.method setAdaptivePolicyLocked(Landroid/os/BatterySaverPolicyConfig;I)Z
    ...
    invoke-virtual {p0, v0, p2}, setAdaptivePolicyLocked(Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;I)Z
...
.method setAdaptivePolicyLocked(Ljava/lang/String;Ljava/lang/String;I)Z
    ...
    invoke-virtual {p0, v0, p3}, setAdaptivePolicyLocked(Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;I)Z
...
.method public systemReady()V
    ...
    iget-object v1, p0, mFileUpdater:Lcom/android/server/power/batterysaver/FileUpdater;
