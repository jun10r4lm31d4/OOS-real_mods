...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0, v1, v2}, <init>(Landroid/content/Context;Landroid/os/Looper;II)V
...
.method constructor <init>(Landroid/content/Context;Landroid/os/Looper;II)V
    ...
    iput-object v0, p0, mPendingWrites:Landroid/util/ArrayMap;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, mDefaultValues:Landroid/util/ArrayMap;
    ...
    iput-object v0, p0, mHandleWriteOnHandlerRunnable:Ljava/lang/Runnable;
    ...
    iput p3, p0, MAX_RETRIES:I

    int-to-long v0, p4

    iput-wide v0, p0, RETRY_INTERVAL_MS:J
...
.method private doWtf(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, v0}, injectWtf(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private ensureDefaultLoaded(Ljava/lang/String;)Z
    ...
    :try_start_0
    iget-object v1, p0, mDefaultValues:Landroid/util/ArrayMap;
    ...
    :try_start_1
    invoke-virtual {p0, p1}, injectReadFromFileTrimmed(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v1, v0}, injectWtf(Ljava/lang/String;Ljava/lang/Throwable;)V

    invoke-direct {p0, p1}, removePendingWrite(Ljava/lang/String;)V
...
.method private handleWriteOnHandler()V
    ...
    :try_start_0
    iget-object v1, p0, mPendingWrites:Landroid/util/ArrayMap;
    ...
    invoke-direct {p0, v1}, cloneMap(Landroid/util/ArrayMap;)Landroid/util/ArrayMap;
    ...
    invoke-direct {p0, v4}, ensureDefaultLoaded(Ljava/lang/String;)Z
    ...
    :cond_1
    :try_start_1
    invoke-virtual {p0, v4, v5}, injectWriteToFile(Ljava/lang/String;Ljava/lang/String;)V

    invoke-direct {p0, v4}, removePendingWrite(Ljava/lang/String;)V
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0
    ...
    invoke-direct {p0}, scheduleRetry()V
...
.method private saveDefaultValuesLocked()V
    ...
    invoke-virtual {p0}, injectDefaultValuesFilename()Ljava/io/File;
    ...
    iget-object v4, p0, mDefaultValues:Landroid/util/ArrayMap;
...
.method private scheduleRetry()V
    ...
    iget-object v2, p0, mPendingWrites:Landroid/util/ArrayMap;

    invoke-direct {p0, v2}, getKeysString(Ljava/util/Map;)Ljava/lang/String;
    ...
    invoke-direct {p0, v1}, doWtf(Ljava/lang/String;)V
    ...
    iget-object v2, p0, mHandleWriteOnHandlerRunnable:Ljava/lang/Runnable;
    ...
    iget-wide v3, p0, RETRY_INTERVAL_MS:J
...
.method getDefaultValuesForTest()Landroid/util/ArrayMap;
    ...
    iget-object v0, p0, mDefaultValues:Landroid/util/ArrayMap;
...
.method injectWriteToFile(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, injectShouldSkipWrite()Z
...
.method public synthetic lambda$new$0$FileUpdater()V
    ...
    invoke-direct {p0}, handleWriteOnHandler()V
...
.method loadDefaultValuesLocked()Z
    ...
    :try_start_3
    invoke-static {v9, v5}, $closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_3
...
.method public restoreDefault()V
    ...
    invoke-virtual {p0, v1}, writeFiles(Landroid/util/ArrayMap;)V
...
.method public systemReady(Z)V
    ...
    :try_start_0
    invoke-virtual {p0}, loadDefaultValuesLocked()Z
    ...
    invoke-virtual {p0}, restoreDefault()V
...
.method public writeFiles(Landroid/util/ArrayMap;)V
    ...
    iget-object v4, p0, mPendingWrites:Landroid/util/ArrayMap;
