...
.method private finishDetectionLocked()V
    ...
    :cond_1
    :goto_0
    iput-boolean v1, p0, mMustUpdateRestPosition:Z

    :cond_2
    iput-boolean v1, p0, mDetectionInProgress:Z
...
.method private processSampleLocked(FFF)V
    ...
    iget v3, p0, mFirstSampleY:F

    iget v4, p0, mFirstSampleZ:F
    ...
    invoke-static/range {v2 .. v7}, hasMoved(FFFFFF)Z
    ...
    invoke-static/range {v1 .. v6}, hasMoved(FFFFFF)Z
...
.method private startDetectionLocked()V
    ...
    iget-object v0, p0, mGravitySensor:Landroid/hardware/Sensor;
    ...
    iput-boolean v0, p0, mDetectionInProgress:Z

    invoke-static {}, Landroid/os/SystemClock;->uptimeMillis()J

    move-result-wide v1

    iput-wide v1, p0, mDetectionStartTime:J

    const/4 v1, 0x0

    iput v1, p0, mTotalSamples:I

    iput v1, p0, mMovingSamples:I
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    iget-wide v2, p0, mDetectionStartTime:J
...
.method public update(ZI)Z
    ...
    :try_start_0
    iget-boolean v1, p0, mPoweredWirelessly:Z
    ...
    iput-boolean v3, p0, mPoweredWirelessly:Z

    iput-boolean v3, p0, mMustUpdateRestPosition:Z
...
.method public writeToProto(Landroid/util/proto/ProtoOutputStream;J)V
    ...
    iget v0, v1, mFirstSampleX:F

    invoke-virtual {v2, v8, v9, v0}, Landroid/util/proto/ProtoOutputStream;->write(JF)V

    iget v0, v1, mFirstSampleY:F

    invoke-virtual {v2, v10, v11, v0}, Landroid/util/proto/ProtoOutputStream;->write(JF)V

    iget v0, v1, mFirstSampleZ:F
    ...
    iget v0, v1, mLastSampleX:F

    invoke-virtual {v2, v8, v9, v0}, Landroid/util/proto/ProtoOutputStream;->write(JF)V

    iget v0, v1, mLastSampleY:F

    invoke-virtual {v2, v10, v11, v0}, Landroid/util/proto/ProtoOutputStream;->write(JF)V

    iget v0, v1, mLastSampleZ:F
