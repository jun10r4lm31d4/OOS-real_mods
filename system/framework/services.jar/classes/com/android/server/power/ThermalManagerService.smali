...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0}, <init>(Landroid/content/Context;Lcom/android/server/power/ThermalManagerService$ThermalHalWrapper;)V
...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/power/ThermalManagerService$ThermalHalWrapper;)V
    ...
    iput-object v0, p0, mThermalEventListeners:Landroid/os/RemoteCallbackList;

    new-instance v0, Landroid/os/RemoteCallbackList;

    invoke-direct {v0}, Landroid/os/RemoteCallbackList;-><init>()V

    iput-object v0, p0, mThermalStatusListeners:Landroid/os/RemoteCallbackList;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, mTemperatureMap:Landroid/util/ArrayMap;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    iput-object v0, p0, mHalReady:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v0, p0, mService:Landroid/os/IThermalService$Stub;

    iput-object p2, p0, mHalWrapper:Lcom/android/server/power/ThermalManagerService$ThermalHalWrapper;
...
.method static synthetic access$100(Lcom/android/server/power/ThermalManagerService;)Landroid/os/RemoteCallbackList;
    ...
    iget-object v0, p0, mThermalEventListeners:Landroid/os/RemoteCallbackList;
...
.method static synthetic access$1000(Lcom/android/server/power/ThermalManagerService;)Landroid/util/ArrayMap;
    ...
    iget-object v0, p0, mTemperatureMap:Landroid/util/ArrayMap;
...
.method static synthetic access$1100(Lcom/android/server/power/ThermalManagerService;)V
    ...
    invoke-direct {p0}, onTemperatureMapChangedLocked()V
...
.method static synthetic access$1200(Lcom/android/server/power/ThermalManagerService;I)V
    ...
    invoke-direct {p0, p1}, setStatusLocked(I)V
...
.method static synthetic access$200(Lcom/android/server/power/ThermalManagerService;Landroid/os/IThermalEventListener;Ljava/lang/Integer;)V
    ...
    invoke-direct {p0, p1, p2}, postEventListenerCurrentTemperatures(Landroid/os/IThermalEventListener;Ljava/lang/Integer;)V
...
.method static synthetic access$300(Lcom/android/server/power/ThermalManagerService;)Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v0, p0, mHalReady:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method static synthetic access$400(Lcom/android/server/power/ThermalManagerService;)Lcom/android/server/power/ThermalManagerService$ThermalHalWrapper;
    ...
    iget-object v0, p0, mHalWrapper:Lcom/android/server/power/ThermalManagerService$ThermalHalWrapper;
...
.method static synthetic access$500(Lcom/android/server/power/ThermalManagerService;)Landroid/os/RemoteCallbackList;
    ...
    iget-object v0, p0, mThermalStatusListeners:Landroid/os/RemoteCallbackList;
...
.method static synthetic access$600(Lcom/android/server/power/ThermalManagerService;Landroid/os/IThermalStatusListener;)V
    ...
    invoke-direct {p0, p1}, postStatusListener(Landroid/os/IThermalStatusListener;)V
...
.method static synthetic access$900(Lcom/android/server/power/ThermalManagerService;)Z
    ...
    iget-boolean v0, p0, mIsStatusOverride:Z
...
.method static synthetic access$902(Lcom/android/server/power/ThermalManagerService;Z)Z
    ...
    iput-boolean p1, p0, mIsStatusOverride:Z
...
.method public static synthetic lambda$9JFHCKCwrnUIYoXDsqNamhlY5VU(Lcom/android/server/power/ThermalManagerService;Landroid/os/Temperature;)V
    ...
    invoke-direct {p0, p1}, onTemperatureChangedCallback(Landroid/os/Temperature;)V
...
.method private notifyEventListenersLocked(Landroid/os/Temperature;)V
    ...
    :try_start_0
    iget-object v2, p0, mThermalEventListeners:Landroid/os/RemoteCallbackList;
    ...
    iget-object v3, p0, mThermalEventListeners:Landroid/os/RemoteCallbackList;
    ...
    invoke-direct {p0, p1, v2, v3}, postEventListener(Landroid/os/Temperature;Landroid/os/IThermalEventListener;Ljava/lang/Integer;)V
    :try_end_0
    ...
    :cond_0
    iget-object v1, p0, mThermalEventListeners:Landroid/os/RemoteCallbackList;
...
.method private notifyStatusListenersLocked()V
    ...
    :try_start_0
    iget-object v2, p0, mThermalStatusListeners:Landroid/os/RemoteCallbackList;
    ...
    invoke-direct {p0, v2}, postStatusListener(Landroid/os/IThermalStatusListener;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_1
    iget-object v1, p0, mThermalStatusListeners:Landroid/os/RemoteCallbackList;
...
.method private onActivityManagerReady()V
    ...
    :try_start_0
    iget-object v1, p0, mHalWrapper:Lcom/android/server/power/ThermalManagerService$ThermalHalWrapper;
    ...
    iput-object v4, p0, mHalWrapper:Lcom/android/server/power/ThermalManagerService$ThermalHalWrapper;

    iget-object v4, p0, mHalWrapper:Lcom/android/server/power/ThermalManagerService$ThermalHalWrapper;
    ...
    invoke-direct {p0, v7, v3}, onTemperatureChanged(Landroid/os/Temperature;Z)V
    ...
    iget-object v3, p0, mHalReady:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private onTemperatureChanged(Landroid/os/Temperature;Z)V
    ...
    invoke-direct {p0, p1}, shutdownIfNeeded(Landroid/os/Temperature;)V
    ...
    :try_start_0
    iget-object v1, p0, mTemperatureMap:Landroid/util/ArrayMap;
    ...
    invoke-direct {p0, p1}, notifyEventListenersLocked(Landroid/os/Temperature;)V
...
.method private onTemperatureChangedCallback(Landroid/os/Temperature;)V
    ...
    :try_start_0
    invoke-direct {p0, p1, v2}, onTemperatureChanged(Landroid/os/Temperature;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private onTemperatureMapChangedLocked()V
    ...
    iget-object v3, p0, mTemperatureMap:Landroid/util/ArrayMap;
    ...
    :cond_1
    iget-boolean v2, p0, mIsStatusOverride:Z

    if-nez v2, :cond_2

    invoke-direct {p0, v0}, setStatusLocked(I)V
...
.method private postEventListenerCurrentTemperatures(Landroid/os/IThermalEventListener;Ljava/lang/Integer;)V
    ...
    invoke-direct {p0, v3, p1, p2}, postEventListener(Landroid/os/Temperature;Landroid/os/IThermalEventListener;Ljava/lang/Integer;)V
...
.method private setStatusLocked(I)V
    ...
    invoke-direct {p0}, notifyStatusListenersLocked()V
...
.method public onBootPhase(I)V
    ...
    invoke-direct {p0}, onActivityManagerReady()V
...
.method public onStart()V
    ...
    iget-object v0, p0, mService:Landroid/os/IThermalService$Stub;
