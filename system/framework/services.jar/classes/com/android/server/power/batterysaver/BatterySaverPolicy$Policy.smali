...
.method constructor <init>(FZZZZZZZZZZZZZZLandroid/util/ArrayMap;Landroid/util/ArrayMap;ZZI)V
    ...
    iput v4, v0, adjustBrightnessFactor:F

    move/from16 v4, p2

    iput-boolean v4, v0, advertiseIsEnabled:Z

    move/from16 v6, p3

    iput-boolean v6, v0, deferFullBackup:Z

    move/from16 v7, p4

    iput-boolean v7, v0, deferKeyValueBackup:Z

    move/from16 v8, p5

    iput-boolean v8, v0, disableAnimation:Z

    move/from16 v9, p6

    iput-boolean v9, v0, disableAod:Z

    move/from16 v10, p7

    iput-boolean v10, v0, disableLaunchBoost:Z

    move/from16 v11, p8

    iput-boolean v11, v0, disableOptionalSensors:Z

    move/from16 v12, p9

    iput-boolean v12, v0, disableSoundTrigger:Z

    move/from16 v13, p10

    iput-boolean v13, v0, disableVibration:Z

    move/from16 v14, p11

    iput-boolean v14, v0, enableAdjustBrightness:Z

    move/from16 v15, p12

    iput-boolean v15, v0, enableDataSaver:Z

    move/from16 v4, p13

    iput-boolean v4, v0, enableFirewall:Z

    move/from16 v4, p14

    iput-boolean v4, v0, enableNightMode:Z

    move/from16 v4, p15

    iput-boolean v4, v0, enableQuickDoze:Z

    iput-object v1, v0, filesForInteractive:Landroid/util/ArrayMap;

    iput-object v2, v0, filesForNoninteractive:Landroid/util/ArrayMap;

    move/from16 v4, p18

    iput-boolean v4, v0, forceAllAppsStandby:Z

    move/from16 v4, p19

    iput-boolean v4, v0, forceBackgroundCheck:Z
...
.method static fromConfig(Landroid/os/BatterySaverPolicyConfig;)Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;
    ...
    invoke-direct/range {v3 .. v23}, <init>(FZZZZZZZZZZZZZZLandroid/util/ArrayMap;Landroid/util/ArrayMap;ZZI)V
...
.method static fromSettings(Ljava/lang/String;Ljava/lang/String;)Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;
    ...
    invoke-static {p0, p1, v0}, fromSettings(Ljava/lang/String;Ljava/lang/String;Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;)Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;
...
.method static fromSettings(Ljava/lang/String;Ljava/lang/String;Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;)Lcom/android/server/power/batterysaver/BatterySaverPolicy$Policy;
    ...
    :goto_3
    iget v0, v3, adjustBrightnessFactor:F
    ...
    iget-boolean v5, v3, advertiseIsEnabled:Z
    ...
    iget-boolean v6, v3, deferFullBackup:Z
    ...
    iget-boolean v9, v3, deferKeyValueBackup:Z
    ...
    iget-boolean v9, v3, disableAnimation:Z
    ...
    iget-boolean v9, v3, disableAod:Z
    ...
    iget-boolean v9, v3, disableLaunchBoost:Z
    ...
    iget-boolean v9, v3, disableOptionalSensors:Z
    ...
    iget-boolean v9, v3, disableSoundTrigger:Z
    ...
    iget-boolean v9, v3, disableVibration:Z
    ...
    iget-boolean v9, v3, enableAdjustBrightness:Z
    ...
    iget-boolean v9, v3, enableDataSaver:Z
    ...
    iget-boolean v9, v3, enableFirewall:Z
    ...
    iget-boolean v9, v3, enableNightMode:Z
    ...
    iget-boolean v9, v3, enableQuickDoze:Z
    ...
    iget-boolean v9, v3, forceAllAppsStandby:Z
    ...
    iget-boolean v9, v3, forceBackgroundCheck:Z
    ...
    invoke-direct/range {v9 .. v29}, <init>(FZZZZZZZZZZZZZZLandroid/util/ArrayMap;Landroid/util/ArrayMap;ZZI)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget v3, v1, adjustBrightnessFactor:F

    iget v4, p0, adjustBrightnessFactor:F
    ...
    iget-boolean v3, p0, advertiseIsEnabled:Z

    iget-boolean v4, v1, advertiseIsEnabled:Z

    if-ne v3, v4, :cond_2

    iget-boolean v3, p0, deferFullBackup:Z

    iget-boolean v4, v1, deferFullBackup:Z

    if-ne v3, v4, :cond_2

    iget-boolean v3, p0, deferKeyValueBackup:Z

    iget-boolean v4, v1, deferKeyValueBackup:Z

    if-ne v3, v4, :cond_2

    iget-boolean v3, p0, disableAnimation:Z

    iget-boolean v4, v1, disableAnimation:Z

    if-ne v3, v4, :cond_2

    iget-boolean v3, p0, disableAod:Z

    iget-boolean v4, v1, disableAod:Z

    if-ne v3, v4, :cond_2

    iget-boolean v3, p0, disableLaunchBoost:Z

    iget-boolean v4, v1, disableLaunchBoost:Z

    if-ne v3, v4, :cond_2

    iget-boolean v3, p0, disableOptionalSensors:Z

    iget-boolean v4, v1, disableOptionalSensors:Z

    if-ne v3, v4, :cond_2

    iget-boolean v3, p0, disableSoundTrigger:Z

    iget-boolean v4, v1, disableSoundTrigger:Z

    if-ne v3, v4, :cond_2

    iget-boolean v3, p0, disableVibration:Z

    iget-boolean v4, v1, disableVibration:Z

    if-ne v3, v4, :cond_2

    iget-boolean v3, p0, enableAdjustBrightness:Z

    iget-boolean v4, v1, enableAdjustBrightness:Z

    if-ne v3, v4, :cond_2

    iget-boolean v3, p0, enableDataSaver:Z

    iget-boolean v4, v1, enableDataSaver:Z

    if-ne v3, v4, :cond_2

    iget-boolean v3, p0, enableFirewall:Z

    iget-boolean v4, v1, enableFirewall:Z

    if-ne v3, v4, :cond_2

    iget-boolean v3, p0, enableNightMode:Z

    iget-boolean v4, v1, enableNightMode:Z

    if-ne v3, v4, :cond_2

    iget-boolean v3, p0, enableQuickDoze:Z

    iget-boolean v4, v1, enableQuickDoze:Z

    if-ne v3, v4, :cond_2

    iget-boolean v3, p0, forceAllAppsStandby:Z

    iget-boolean v4, v1, forceAllAppsStandby:Z

    if-ne v3, v4, :cond_2

    iget-boolean v3, p0, forceBackgroundCheck:Z

    iget-boolean v4, v1, forceBackgroundCheck:Z

    if-ne v3, v4, :cond_2

    iget v3, p0, locationMode:I

    iget v4, v1, locationMode:I

    if-ne v3, v4, :cond_2

    iget-object v3, p0, filesForInteractive:Landroid/util/ArrayMap;

    iget-object v4, v1, filesForInteractive:Landroid/util/ArrayMap;
    ...
    iget-object v3, p0, filesForNoninteractive:Landroid/util/ArrayMap;

    iget-object v4, v1, filesForNoninteractive:Landroid/util/ArrayMap;
