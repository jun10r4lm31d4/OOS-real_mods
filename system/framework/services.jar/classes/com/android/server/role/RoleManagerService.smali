...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/role/RoleManagerService$RoleHoldersResolver;)V
    ...
    iput-object v0, p0, mControllers:Landroid/util/SparseArray;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, mListeners:Landroid/util/SparseArray;
    ...
    iput-object p2, p0, mLegacyRoleResolver:Lcom/android/server/role/RoleManagerService$RoleHoldersResolver;
    ...
    invoke-direct {p0}, registerUserRemovedReceiver()V
...
.method static synthetic access$1100(Lcom/android/server/role/RoleManagerService;I)Landroid/app/role/RoleControllerManager;
    ...
    invoke-direct {p0, p1}, getOrCreateController(I)Landroid/app/role/RoleControllerManager;
...
.method static synthetic access$1200(Lcom/android/server/role/RoleManagerService;I)Landroid/os/RemoteCallbackList;
    ...
    invoke-direct {p0, p1}, getOrCreateListeners(I)Landroid/os/RemoteCallbackList;
...
.method static synthetic access$1300(Lcom/android/server/role/RoleManagerService;I)Landroid/os/RemoteCallbackList;
    ...
    invoke-direct {p0, p1}, getListeners(I)Landroid/os/RemoteCallbackList;
...
.method static synthetic access$400(Lcom/android/server/role/RoleManagerService;I)V
    ...
    invoke-direct {p0, p1}, onRemoveUser(I)V
...
.method static synthetic access$600(Lcom/android/server/role/RoleManagerService;I)Ljava/util/concurrent/CompletableFuture;
    ...
    invoke-direct {p0, p1}, performInitialGrantsIfNecessaryAsync(I)Ljava/util/concurrent/CompletableFuture;
...
.method static synthetic access$700(Lcom/android/server/role/RoleManagerService;I)Lcom/android/server/role/RoleUserState;
    ...
    invoke-direct {p0, p1}, getOrCreateUserState(I)Lcom/android/server/role/RoleUserState;
...
.method private getListeners(I)Landroid/os/RemoteCallbackList;
    ...
    :try_start_0
    iget-object v1, p0, mListeners:Landroid/util/SparseArray;
...
.method private getOrCreateController(I)Landroid/app/role/RoleControllerManager;
    ...
    :try_start_0
    iget-object v1, p0, mControllers:Landroid/util/SparseArray;
    ...
    iget-object v4, p0, mControllers:Landroid/util/SparseArray;
...
.method private getOrCreateListeners(I)Landroid/os/RemoteCallbackList;
    ...
    iget-object v2, p0, mListeners:Landroid/util/SparseArray;
...
.method public static synthetic lambda$TCTA4I2bhEypguZihxs4ezif6t0(Lcom/android/server/role/RoleManagerService;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2, p3, p4}, notifyRoleHoldersChanged(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)V
...
.method private migrateRoleIfNecessary(Ljava/lang/String;I)V
    ...
    invoke-direct {p0, p2}, getOrCreateUserState(I)Lcom/android/server/role/RoleUserState;
    ...
    iget-object v1, p0, mLegacyRoleResolver:Lcom/android/server/role/RoleManagerService$RoleHoldersResolver;
...
.method private notifyRoleHoldersChanged(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p2}, getListeners(I)Landroid/os/RemoteCallbackList;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-direct {p0, v0, p1, p2}, notifyRoleHoldersChangedForListeners(Landroid/os/RemoteCallbackList;Ljava/lang/String;I)V

    :cond_0
    const/4 v1, -0x1

    invoke-direct {p0, v1}, getListeners(I)Landroid/os/RemoteCallbackList;

    move-result-object v1

    if-eqz v1, :cond_1

    invoke-direct {p0, v1, p1, p2}, notifyRoleHoldersChangedForListeners(Landroid/os/RemoteCallbackList;Ljava/lang/String;I)V
...
.method private onRemoveUser(I)V
    ...
    iget-object v2, p0, mControllers:Landroid/util/SparseArray;
...
.method private performInitialGrantsIfNecessaryAsync(I)Ljava/util/concurrent/CompletableFuture;
    ...
    invoke-static {p1}, computeComponentStateHash(I)Ljava/lang/String;
    ...
    invoke-direct {p0, v4, p1}, migrateRoleIfNecessary(Ljava/lang/String;I)V
...
.method public onStartUser(I)V
    ...
    invoke-direct {p0, p1}, performInitialGrantsIfNecessary(I)V
