...
.method public constructor <init>(ILcom/android/server/role/RoleUserState$Callback;)V
    ...
    iput-object v0, p0, mRoles:Landroid/util/ArrayMap;
    ...
    iput-object p2, p0, mCallback:Lcom/android/server/role/RoleUserState$Callback;

    invoke-direct {p0}, readFile()V
...
.method private parseRolesLocked(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    iput-object v1, p0, mPackagesHash:Ljava/lang/String;

    iget-object v1, p0, mRoles:Landroid/util/ArrayMap;
    ...
    invoke-direct {p0, p1}, parseRoleHoldersLocked(Lorg/xmlpull/v1/XmlPullParser;)Landroid/util/ArraySet;

    move-result-object v6

    iget-object v7, p0, mRoles:Landroid/util/ArrayMap;
...
.method private parseXmlLocked(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    invoke-direct {p0, p1}, parseRolesLocked(Lorg/xmlpull/v1/XmlPullParser;)V
...
.method private readFile()V
    ...
    invoke-static {v1}, getFile(I)Ljava/io/File;
    ...
    invoke-direct {p0, v3}, parseXmlLocked(Lorg/xmlpull/v1/XmlPullParser;)V
...
.method private serializeRoles(Lorg/xmlpull/v1/XmlSerializer;ILjava/lang/String;Landroid/util/ArrayMap;)V
    ...
    invoke-direct {p0, p1, v5}, serializeRoleHolders(Lorg/xmlpull/v1/XmlSerializer;Landroid/util/ArraySet;)V
...
.method private snapshotRolesLocked()Landroid/util/ArrayMap;
    ...
    iget-object v2, p0, mRoles:Landroid/util/ArrayMap;
    ...
    iget-object v3, p0, mRoles:Landroid/util/ArrayMap;
    ...
    iget-object v4, p0, mRoles:Landroid/util/ArrayMap;
...
.method private writeFile()V
    ...
    iget-object v2, p0, mPackagesHash:Ljava/lang/String;

    invoke-direct {p0}, snapshotRolesLocked()Landroid/util/ArrayMap;
    ...
    invoke-static {v4}, getFile(I)Ljava/io/File;
    ...
    invoke-direct {p0, v5, v1, v2, v3}, serializeRoles(Lorg/xmlpull/v1/XmlSerializer;ILjava/lang/String;Landroid/util/ArrayMap;)V

    invoke-interface {v5}, Lorg/xmlpull/v1/XmlSerializer;->endDocument()V

    invoke-virtual {v0, v4}, Landroid/util/AtomicFile;->finishWrite(Ljava/io/FileOutputStream;)V

    sget-object v6, LOG_TAG:Ljava/lang/String;
...
.method public addRoleHolder(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-direct {p0}, scheduleWriteFileLocked()V
    ...
    iget-object v0, p0, mCallback:Lcom/android/server/role/RoleUserState$Callback;
...
.method public dump(Lcom/android/internal/util/dump/DualDumpOutputStream;Ljava/lang/String;J)V
    ...
    :try_start_0
    invoke-direct/range {p0 .. p0}, throwIfDestroyedLocked()V

    iget v0, v1, mVersion:I

    iget-object v4, v1, mPackagesHash:Ljava/lang/String;

    invoke-direct/range {p0 .. p0}, snapshotRolesLocked()Landroid/util/ArrayMap;
...
.method public getPackagesHash()Ljava/lang/String;
    ...
    :try_start_0
    iget-object v1, p0, mPackagesHash:Ljava/lang/String;
...
.method public setPackagesHash(Ljava/lang/String;)V
    ...
    :cond_0
    iput-object p1, p0, mPackagesHash:Ljava/lang/String;
...
.method public setRoleNames(Ljava/util/List;)V
    ...
    sget-object v5, LOG_TAG:Ljava/lang/String;
    ...
    :cond_0
    iget-object v5, p0, mRoles:Landroid/util/ArrayMap;
    ...
    invoke-virtual {p0, v4}, addRoleName(Ljava/lang/String;)Z
