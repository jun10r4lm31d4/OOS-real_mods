...
.method static constructor <clinit>()V
    ...
    sput-object v2, ADDRESS_FAMILIES:[I
    ...
    sput-object v0, INADDR_ANY:Ljava/net/InetAddress;
    :try_end_0
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0}, <init>(Landroid/content/Context;Lcom/android/server/IpSecService$IpSecServiceConfiguration;)V
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/IpSecService$IpSecServiceConfiguration;)V
    ...
    invoke-direct {p0, p1, p2, v0}, <init>(Landroid/content/Context;Lcom/android/server/IpSecService$IpSecServiceConfiguration;Lcom/android/server/IpSecService$UidFdTagger;)V
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/IpSecService$IpSecServiceConfiguration;Lcom/android/server/IpSecService$UidFdTagger;)V
    ...
    iput-object v0, p0, mUserResourceTracker:Lcom/android/server/IpSecService$UserResourceTracker;

    new-instance v0, Landroid/util/SparseBooleanArray;

    invoke-direct {v0}, Landroid/util/SparseBooleanArray;-><init>()V

    iput-object v0, p0, mTunnelNetIds:Landroid/util/SparseBooleanArray;

    const/4 v0, 0x0

    iput v0, p0, mNextTunnelNetIdIndex:I

    iput-object p1, p0, mContext:Landroid/content/Context;

    iput-object p2, p0, mSrvConfig:Lcom/android/server/IpSecService$IpSecServiceConfiguration;

    iput-object p3, p0, mUidFdTagger:Lcom/android/server/IpSecService$UidFdTagger;
...
.method static synthetic access$000(Lcom/android/server/IpSecService;)Lcom/android/server/IpSecService$IpSecServiceConfiguration;
    ...
    iget-object v0, p0, mSrvConfig:Lcom/android/server/IpSecService$IpSecServiceConfiguration;
...
.method static synthetic access$100()[I
    ...
    sget-object v0, ADDRESS_FAMILIES:[I
...
.method private bindToRandomPort(Ljava/io/FileDescriptor;)I
    ...
    sget-object v2, INADDR_ANY:Ljava/net/InetAddress;
    ...
    sget-object v3, INADDR_ANY:Ljava/net/InetAddress;
...
.method private checkIpSecConfig(Landroid/net/IpSecConfig;)V
    ...
    iget-object v0, p0, mUserResourceTracker:Lcom/android/server/IpSecService$UserResourceTracker;
    ...
    :goto_1
    invoke-virtual {p0, p1}, validateAlgorithms(Landroid/net/IpSecConfig;)V
    ...
    invoke-static {v3}, checkInetAddress(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v3}, getFamily(Ljava/lang/String;)I

    move-result v5

    invoke-direct {p0, v4}, getFamily(Ljava/lang/String;)I
...
.method private createOrUpdateTransform(Landroid/net/IpSecConfig;ILcom/android/server/IpSecService$SpiRecord;Lcom/android/server/IpSecService$EncapSocketRecord;)V
    ...
    iget-object v1, v15, mSrvConfig:Lcom/android/server/IpSecService$IpSecServiceConfiguration;
...
.method public declared-synchronized addAddressToTunnelInterface(ILandroid/net/LinkAddress;Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-direct {p0, p3}, enforceTunnelFeatureAndPermissions(Ljava/lang/String;)V
    ...
    :try_start_1
    iget-object v2, p0, mSrvConfig:Lcom/android/server/IpSecService$IpSecServiceConfiguration;
...
.method public declared-synchronized allocateSecurityParameterIndex(Ljava/lang/String;ILandroid/os/IBinder;)Landroid/net/IpSecSpiResponse;
    ...
    :try_start_0
    invoke-static/range {p1 .. p1}, checkInetAddress(Ljava/lang/String;)V
    ...
    iget-object v0, v7, mUserResourceTracker:Lcom/android/server/IpSecService$UserResourceTracker;
    ...
    iget v0, v7, mNextResourceId:I

    add-int/lit8 v1, v0, 0x1

    iput v1, v7, mNextResourceId:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_2
    :try_start_2
    iget-object v0, v7, mSrvConfig:Lcom/android/server/IpSecService$IpSecServiceConfiguration;
...
.method public declared-synchronized applyTransportModeTransform(Landroid/os/ParcelFileDescriptor;II)V
    ...
    iget-object v1, p0, mUserResourceTracker:Lcom/android/server/IpSecService$UserResourceTracker;
    ...
    invoke-static {p2}, checkDirection(I)V
    ...
    iget-object v1, p0, mSrvConfig:Lcom/android/server/IpSecService$IpSecServiceConfiguration;
...
.method public declared-synchronized applyTunnelModeTransform(IIILjava/lang/String;)V
    ...
    :try_start_0
    invoke-direct {v1, v14}, enforceTunnelFeatureAndPermissions(Ljava/lang/String;)V

    invoke-static/range {p2 .. p2}, checkDirection(I)V
    ...
    iget-object v0, v1, mUserResourceTracker:Lcom/android/server/IpSecService$UserResourceTracker;
    ...
    :goto_3
    :try_start_3
    sget-object v5, ADDRESS_FAMILIES:[I
    ...
    iget-object v2, v1, mSrvConfig:Lcom/android/server/IpSecService$IpSecServiceConfiguration;
    ...
    :try_start_6
    invoke-direct {v1, v12, v13, v2, v3}, createOrUpdateTransform(Landroid/net/IpSecConfig;ILcom/android/server/IpSecService$SpiRecord;Lcom/android/server/IpSecService$EncapSocketRecord;)V
    :try_end_6
...
.method public declared-synchronized closeUdpEncapsulationSocket(I)V
    ...
    invoke-direct {p0, v1, p1}, releaseResource(Lcom/android/server/IpSecService$RefcountedResourceArray;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized createTransform(Landroid/net/IpSecConfig;Landroid/os/IBinder;Ljava/lang/String;)Landroid/net/IpSecTransformResponse;
    ...
    invoke-direct {v7, v8}, enforceTunnelFeatureAndPermissions(Ljava/lang/String;)V
    ...
    :goto_0
    invoke-direct/range {p0 .. p1}, checkIpSecConfig(Landroid/net/IpSecConfig;)V

    const-string v1, "Null Binder passed to createTransform"

    invoke-static {v0, v1}, Lcom/android/internal/util/Preconditions;->checkNotNull(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    iget v1, v7, mNextResourceId:I

    add-int/lit8 v3, v1, 0x1

    iput v3, v7, mNextResourceId:I

    move v9, v1

    iget-object v1, v7, mUserResourceTracker:Lcom/android/server/IpSecService$UserResourceTracker;
    ...
    invoke-direct {v7, v15, v9, v14, v12}, createOrUpdateTransform(Landroid/net/IpSecConfig;ILcom/android/server/IpSecService$SpiRecord;Lcom/android/server/IpSecService$EncapSocketRecord;)V
...
.method public declared-synchronized createTunnelInterface(Ljava/lang/String;Ljava/lang/String;Landroid/net/Network;Landroid/os/IBinder;Ljava/lang/String;)Landroid/net/IpSecTunnelInterfaceResponse;
    ...
    :try_start_0
    invoke-direct {v11, v13}, enforceTunnelFeatureAndPermissions(Ljava/lang/String;)V
    ...
    invoke-static/range {p2 .. p2}, checkInetAddress(Ljava/lang/String;)V
    ...
    iget-object v0, v11, mUserResourceTracker:Lcom/android/server/IpSecService$UserResourceTracker;
    ...
    :cond_0
    :try_start_1
    iget v0, v11, mNextResourceId:I

    add-int/lit8 v2, v0, 0x1

    iput v2, v11, mNextResourceId:I
    ...
    :try_start_2
    iget-object v0, v11, mSrvConfig:Lcom/android/server/IpSecService$IpSecServiceConfiguration;
    :try_end_2
    ...
    :try_start_b
    invoke-virtual {v11, v1}, releaseNetId(I)V

    move/from16 v4, v29

    invoke-virtual {v11, v4}, releaseNetId(I)V
...
.method public declared-synchronized deleteTunnelInterface(ILjava/lang/String;)V
    ...
    :try_start_0
    invoke-direct {p0, p2}, enforceTunnelFeatureAndPermissions(Ljava/lang/String;)V
...
.method protected declared-synchronized dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, isNetdAlive()Z
...
.method public declared-synchronized openUdpEncapsulationSocket(ILandroid/os/IBinder;)Landroid/net/IpSecUdpEncapResponse;
    ...
    iget v2, p0, mNextResourceId:I

    add-int/lit8 v3, v2, 0x1

    iput v3, p0, mNextResourceId:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget-object v5, p0, mUidFdTagger:Lcom/android/server/IpSecService$UidFdTagger;
    ...
    iget-object v5, p0, mSrvConfig:Lcom/android/server/IpSecService$IpSecServiceConfiguration;
    ...
    sget-object v5, INADDR_ANY:Ljava/net/InetAddress;
    ...
    :cond_3
    invoke-direct {p0, v3}, bindToRandomPort(Ljava/io/FileDescriptor;)I
...
.method releaseNetId(I)V
    ...
    iget-object v0, p0, mTunnelNetIds:Landroid/util/SparseBooleanArray;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, mTunnelNetIds:Landroid/util/SparseBooleanArray;
...
.method reserveNetId()I
    ...
    :try_start_0
    iget v3, p0, mNextTunnelNetIdIndex:I

    const v4, 0xfc00

    add-int/2addr v4, v3

    iget v5, p0, mNextTunnelNetIdIndex:I

    const/4 v6, 0x1

    add-int/2addr v5, v6

    iput v5, p0, mNextTunnelNetIdIndex:I

    if-lt v5, v2, :cond_0

    const/4 v2, 0x0

    iput v2, p0, mNextTunnelNetIdIndex:I

    :cond_0
    iget-object v2, p0, mTunnelNetIds:Landroid/util/SparseBooleanArray;
