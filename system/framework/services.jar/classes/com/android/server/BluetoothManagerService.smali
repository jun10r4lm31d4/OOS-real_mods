...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, isUserSwitchOnAirplaneMode:Z

    new-instance v1, Ljava/util/concurrent/locks/ReentrantReadWriteLock;

    invoke-direct {v1}, Ljava/util/concurrent/locks/ReentrantReadWriteLock;-><init>()V

    iput-object v1, p0, mBluetoothLock:Ljava/util/concurrent/locks/ReentrantReadWriteLock;

    iput-boolean v0, p0, mQuietEnable:Z

    new-instance v1, Ljava/util/LinkedList;

    invoke-direct {v1}, Ljava/util/LinkedList;-><init>()V

    iput-object v1, p0, mActiveLogs:Ljava/util/LinkedList;

    new-instance v1, Ljava/util/LinkedList;

    invoke-direct {v1}, Ljava/util/LinkedList;-><init>()V

    iput-object v1, p0, mCrashTimestamps:Ljava/util/LinkedList;

    new-instance v1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v1, p0, mBleApps:Ljava/util/Map;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, mProfileServices:Ljava/util/Map;
    ...
    iput-object v1, p0, mBluetoothCallback:Landroid/bluetooth/IBluetoothCallback;
    ...
    iput-object v1, p0, mUserRestrictionsListener:Landroid/os/UserManagerInternal$UserRestrictionsListener;
    ...
    iput-object v1, p0, mConnection:Lcom/android/server/BluetoothManagerService$BluetoothServiceConnection;
    ...
    iput-object v1, p0, mHandler:Lcom/android/server/BluetoothManagerService$BluetoothHandler;
    ...
    iput-boolean v1, p0, mWirelessConsentRequired:Z

    iput v0, p0, mCrashes:I

    iput-object v2, p0, mBluetooth:Landroid/bluetooth/IBluetooth;

    iput-object v2, p0, mBluetoothBinder:Landroid/os/IBinder;

    iput-object v2, p0, mBluetoothGatt:Landroid/bluetooth/IBluetoothGatt;

    iput-boolean v0, p0, mBinding:Z

    iput-boolean v0, p0, mUnbinding:Z

    iput-boolean v0, p0, mEnable:Z

    iput-boolean v0, p0, mEnableBLE:Z

    const/16 v1, 0xa

    iput v1, p0, mState:I

    iput-boolean v0, p0, mQuietEnableExternal:Z

    iput-boolean v0, p0, mEnableExternal:Z

    iput-object v2, p0, mAddress:Ljava/lang/String;

    iput-object v2, p0, mName:Ljava/lang/String;

    iput v0, p0, mErrorRecoveryRetryCounter:I
    ...
    iput-object v1, p0, mStateChangeCallbacks:Landroid/os/RemoteCallbackList;
    ...
    iput-boolean v1, p0, mIsHearingAidProfileSupported:Z
    ...
    iget-boolean v5, p0, mIsHearingAidProfileSupported:Z

    if-nez v5, :cond_0

    iput-boolean v3, p0, mIsHearingAidProfileSupported:Z
    ...
    iget-object v6, p0, mReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v8, p0, mAirplaneModeObserver:Landroid/database/ContentObserver;
    ...
    iput-object v0, p0, mCarkitIdentification:Lcom/oneplus/android/server/OpBluetoothCarkitIdentificationInjector;
...
.method static synthetic access$000(J)Ljava/lang/CharSequence;
    ...
    invoke-static {p0, p1}, timeToLog(J)Ljava/lang/CharSequence;
...
.method static synthetic access$100(I)Ljava/lang/String;
    ...
    invoke-static {p0}, getEnableDisableReasonString(I)Ljava/lang/String;
...
.method static synthetic access$1000(Lcom/android/server/BluetoothManagerService;)Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    iget-object v0, p0, mBluetoothLock:Ljava/util/concurrent/locks/ReentrantReadWriteLock;
...
.method static synthetic access$1300(Lcom/android/server/BluetoothManagerService;ILjava/lang/String;Z)V
    ...
    invoke-direct {p0, p1, p2, p3}, addActiveLog(ILjava/lang/String;Z)V
...
.method static synthetic access$1602(Lcom/android/server/BluetoothManagerService;Z)Z
    ...
    iput-boolean p1, p0, mQuietEnableExternal:Z
...
.method static synthetic access$1700(Lcom/android/server/BluetoothManagerService;ZILjava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2, p3}, sendEnableMsg(ZILjava/lang/String;)V
...
.method static synthetic access$300(Lcom/android/server/BluetoothManagerService;IZ)V
    ...
    invoke-direct {p0, p1, p2}, updateOppLauncherComponentState(IZ)V
...
.method static synthetic access$3000(Lcom/android/server/BluetoothManagerService;ZZ)Z
    ...
    invoke-direct {p0, p1, p2}, waitForMonitoredOnOff(ZZ)Z
...
.method static synthetic access$3800(Lcom/android/server/BluetoothManagerService;)V
    ...
    invoke-direct {p0}, continueFromBleOnState()V
...
.method static synthetic access$3902(Lcom/android/server/BluetoothManagerService;Landroid/os/IBinder;)Landroid/os/IBinder;
    ...
    iput-object p1, p0, mBluetoothBinder:Landroid/os/IBinder;
...
.method static synthetic access$4500(Lcom/android/server/BluetoothManagerService;Z)V
    ...
    invoke-direct {p0, p1}, recoverBluetoothServiceFromError(Z)V
...
.method static synthetic access$4700(Lcom/android/server/BluetoothManagerService;)V
    ...
    invoke-direct {p0}, addCrashLog()V
...
.method static synthetic access$500(Lcom/android/server/BluetoothManagerService;ILjava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2}, sendDisableMsg(ILjava/lang/String;)V
...
.method private addActiveLog(ILjava/lang/String;Z)V
    ...
    iget-object v0, p0, mActiveLogs:Ljava/util/LinkedList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, mActiveLogs:Ljava/util/LinkedList;
    ...
    invoke-direct {p0, p3, p1, p2}, reportEnableInfo(ZILjava/lang/String;)V
...
.method private addCrashLog()V
    ...
    iget-object v0, p0, mCrashTimestamps:Ljava/util/LinkedList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, mCrashTimestamps:Ljava/util/LinkedList;
    ...
    iget v1, p0, mCrashes:I

    add-int/lit8 v1, v1, 0x1

    iput v1, p0, mCrashes:I
...
.method private bluetoothStateChangeHandler(II)V
    ...
    iget-boolean v1, p0, isUserSwitchOnAirplaneMode:Z
    ...
    iput-boolean v5, p0, isUserSwitchOnAirplaneMode:Z
    ...
    invoke-direct {p0, v1}, sendBluetoothStateCallback(Z)V
    ...
    invoke-virtual {p0, v1, v2, v4, v5}, doBind(Landroid/content/Intent;Landroid/content/ServiceConnection;ILandroid/os/UserHandle;)Z
...
.method private continueFromBleOnState()V
    ...
    :try_start_0
    iget-object v1, p0, mBluetoothLock:Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    iget-boolean v3, p0, mQuietEnable:Z
    ...
    invoke-direct {p0, v2}, persistBluetoothSetting(I)V
    :try_end_2
...
.method private handleEnable(Z)V
    ...
    invoke-virtual {p0, v2, v3, v4, v5}, doBind(Landroid/content/Intent;Landroid/content/ServiceConnection;ILandroid/os/UserHandle;)Z
...
.method private isBluetoothPersistedStateOn()Z
    ...
    invoke-direct {p0}, supportBluetoothPersistedState()Z
...
.method private loadStoredNameAndAddress()V
    ...
    iput-object v1, p0, mName:Ljava/lang/String;
    ...
    iput-object v1, p0, mAddress:Ljava/lang/String;
...
.method private recoverBluetoothServiceFromError(Z)V
    ...
    iget-object v2, p0, mBluetoothCallback:Landroid/bluetooth/IBluetoothCallback;
    ...
    invoke-direct {p0, v1, v0}, waitForMonitoredOnOff(ZZ)Z
    ...
    iput v1, p0, mErrorRecoveryRetryCounter:I
...
.method private sendBluetoothStateCallback(Z)V
    ...
    :try_start_0
    iget-object v1, p0, mStateChangeCallbacks:Landroid/os/RemoteCallbackList;
...
.method private sendDisableMsg(ILjava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2, v0}, addActiveLog(ILjava/lang/String;Z)V
...
.method private sendEnableMsg(ZILjava/lang/String;)V
    ...
    invoke-direct {p0, p2, p3, v2}, addActiveLog(ILjava/lang/String;Z)V

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J

    move-result-wide v0

    iput-wide v0, p0, mLastEnabledTime:J
...
.method private startConsentUiIfNeeded(Ljava/lang/String;ILjava/lang/String;)Z
    ...
    invoke-direct {p0}, checkBluetoothPermissionWhenWirelessConsentRequired()Z
...
.method private waitForMonitoredOnOff(ZZ)Z
    ...
    invoke-direct {p0, v1, v4}, bluetoothStateChangeHandler(II)V
...
.method private waitForOnOff(ZZ)Z
    ...
    iget-object v3, p0, mBluetoothLock:Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    :goto_3
    iget-object v2, p0, mBluetoothLock:Ljava/util/concurrent/locks/ReentrantReadWriteLock;
...
.method public addCarkit(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, p0, mCarkitIdentification:Lcom/oneplus/android/server/OpBluetoothCarkitIdentificationInjector;
...
.method public bindBluetoothProfileService(ILandroid/bluetooth/IBluetoothProfileServiceConnection;)Z
    ...
    invoke-virtual {p0}, isBluetoothAvailableForBinding()Z
...
.method public disable(Ljava/lang/String;Z)Z
    ...
    invoke-direct {p0, v0, p1}, checkPackage(ILjava/lang/String;)V
    ...
    iget-boolean v4, p0, mWirelessConsentRequired:Z

    if-eqz v4, :cond_2

    const-string v4, "android.bluetooth.adapter.action.REQUEST_DISABLE"

    invoke-direct {p0, p1, v0, v4}, startConsentUiIfNeeded(Ljava/lang/String;ILjava/lang/String;)Z
    ...
    iget-object v5, p0, mBluetooth:Landroid/bluetooth/IBluetooth;
    ...
    invoke-direct {p0, p1}, checkIfUserSwitchOnAirplaneMode(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v2, p1}, sendDisableMsg(ILjava/lang/String;)V
    ...
    :try_start_2
    iget-object v5, p0, mBluetoothLock:Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    invoke-direct {p0, v3, p1}, sendDisableMsg(ILjava/lang/String;)V
    :try_end_2
    .catch Landroid/os/RemoteException; {:try_start_2 .. :try_end_2} :catch_0
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v8, v1, mAddress:Ljava/lang/String;
    ...
    iget-object v8, v1, mName:Ljava/lang/String;
    ...
    iget-wide v9, v1, mLastEnabledTime:J
    ...
    :cond_2
    iget-object v7, v1, mActiveLogs:Ljava/util/LinkedList;
    ...
    :cond_6
    iget-object v7, v1, mCrashTimestamps:Ljava/util/LinkedList;
    ...
    invoke-static {v13, v14}, timeToLog(J)Ljava/lang/CharSequence;
    ...
    iget-object v9, v1, mBleApps:Ljava/util/Map;
    ...
    iget-object v7, v1, mBleApps:Ljava/util/Map;
    ...
    :goto_6
    iget-object v0, v1, mBluetoothBinder:Landroid/os/IBinder;
...
.method public enable(Ljava/lang/String;)Z
    ...
    :goto_0
    invoke-direct {p0}, isBluetoothDisallowed()Z
    ...
    iget-boolean v5, p0, mEnableBLE:Z

    if-nez v5, :cond_4

    iput-boolean v2, p0, mEnableExternal:Z

    goto :goto_1

    :cond_4
    iput-boolean v3, p0, mEnableBLE:Z

    :goto_1
    invoke-direct {p0, v3, v2, p1}, sendEnableMsg(ZILjava/lang/String;)V
...
.method public enableNoAutoConnect(Ljava/lang/String;)Z
    ...
    :try_start_0
    iput-boolean v4, p0, mQuietEnableExternal:Z

    iput-boolean v4, p0, mEnableExternal:Z

    invoke-direct {p0, v4, v4, p1}, sendEnableMsg(ZILjava/lang/String;)V
...
.method public factoryReset()Z
    ...
    iget-boolean v5, p0, mQuietEnable:Z

    invoke-direct {p0, v5}, handleEnable(Z)V
...
.method public handleOnBootPhase()V
    ...
    iget-object v2, p0, mUserRestrictionsListener:Landroid/os/UserManagerInternal$UserRestrictionsListener;
    ...
    :cond_0
    iget-boolean v3, p0, mEnableExternal:Z
    ...
    invoke-direct {p0, v0, v3, v4}, sendEnableMsg(ZILjava/lang/String;)V
...
.method public isBleAppPresent()Z
    ...
    iget-object v1, p0, mBleApps:Ljava/util/Map;
...
.method public isCarkit(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :try_start_0
    iget-object v1, p0, mCarkitIdentification:Lcom/oneplus/android/server/OpBluetoothCarkitIdentificationInjector;
...
.method public isHearingAidProfileSupported()Z
    ...
    iget-boolean v0, p0, mIsHearingAidProfileSupported:Z
...
.method public unbindAndFinish()V
    ...
    iget-boolean v0, p0, mUnbinding:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iput-boolean v3, p0, mUnbinding:Z
...
.method public updateBleAppCount(Landroid/os/IBinder;ZLjava/lang/String;)I
    ...
    invoke-direct {p0, v0, p3}, checkPackage(ILjava/lang/String;)V

    :cond_1
    iget-object v4, p0, mBleApps:Ljava/util/Map;
    ...
    iget-object v8, p0, mBleApps:Ljava/util/Map;
    ...
    iget-object v7, p0, mBleApps:Ljava/util/Map;
    ...
    :try_start_1
    iget-object v8, p0, mBluetoothLock:Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    iget-object v8, p0, mBluetooth:Landroid/bluetooth/IBluetooth;
    ...
    :cond_4
    iput-boolean v2, p0, mEnableBLE:Z
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    :cond_6
    :goto_5
    iget-object v2, p0, mBleApps:Ljava/util/Map;
    ...
    :goto_7
    iget-object v6, p0, mBluetoothLock:Ljava/util/concurrent/locks/ReentrantReadWriteLock;
