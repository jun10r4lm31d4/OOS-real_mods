...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0, v1, v2}, <init>(Landroid/content/Context;Lcom/android/server/NetworkScorerAppManager;Ljava/util/function/Function;Landroid/os/Looper;)V
...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/NetworkScorerAppManager;Ljava/util/function/Function;Landroid/os/Looper;)V
    ...
    iput-object v0, p0, mPackageMonitorLock:Ljava/lang/Object;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, mServiceConnectionLock:Ljava/lang/Object;
    ...
    iput-object v0, p0, mLocationModeReceiver:Landroid/content/BroadcastReceiver;

    iput-object p1, p0, mContext:Landroid/content/Context;

    iput-object p2, p0, mNetworkScorerAppManager:Lcom/android/server/NetworkScorerAppManager;
    ...
    iget-object v2, p0, mUserIntentReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v6, p0, mLocationModeReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v0, p0, mRecommendationSettingsObserver:Lcom/android/server/NetworkScoreService$DispatchingContentObserver;

    iput-object p3, p0, mServiceConnProducer:Ljava/util/function/Function;
    ...
    iput-object v0, p0, mUseOpenWifiPackageObserver:Landroid/database/ContentObserver;
    ...
    iget-object v2, p0, mUseOpenWifiPackageObserver:Landroid/database/ContentObserver;
...
.method static synthetic access$100(Lcom/android/server/NetworkScoreService;)V
    ...
    invoke-direct {p0}, refreshBinding()V
...
.method static synthetic access$200(Lcom/android/server/NetworkScoreService;)Lcom/android/server/NetworkScorerAppManager;
    ...
    iget-object v0, p0, mNetworkScorerAppManager:Lcom/android/server/NetworkScorerAppManager;
...
.method static synthetic access$300(Lcom/android/server/NetworkScoreService;)V
    ...
    invoke-direct {p0}, unbindFromScoringServiceIfNeeded()V
...
.method static synthetic access$400(Lcom/android/server/NetworkScoreService;Landroid/net/NetworkScorerAppData;)V
    ...
    invoke-direct {p0, p1}, bindToScoringServiceIfNeeded(Landroid/net/NetworkScorerAppData;)V
...
.method private bindToScoringServiceIfNeeded()V
    ...
    invoke-direct {p0, v0}, bindToScoringServiceIfNeeded(Landroid/net/NetworkScorerAppData;)V
...
.method private bindToScoringServiceIfNeeded(Landroid/net/NetworkScorerAppData;)V
    ...
    iget-object v0, p0, mServiceConnectionLock:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, mServiceConnection:Lcom/android/server/NetworkScoreService$ScoringServiceConnection;
    ...
    iget-object v1, p0, mServiceConnProducer:Ljava/util/function/Function;
    ...
    iput-object v1, p0, mServiceConnection:Lcom/android/server/NetworkScoreService$ScoringServiceConnection;
...
.method private clearInternal()V
    ...
    invoke-direct {p0}, getScoreCacheLists()Ljava/util/Collection;

    move-result-object v1

    invoke-direct {p0, v0, v1}, sendCacheUpdateCallback(Ljava/util/function/BiConsumer;Ljava/util/Collection;)V
...
.method private enforceSystemOrIsActiveScorer(I)V
    ...
    invoke-virtual {p0, p1}, isCallerActiveScorer(I)Z
...
.method private refreshBinding()V
    ...
    invoke-direct {p0}, registerPackageMonitorIfNeeded()V

    invoke-direct {p0}, bindToScoringServiceIfNeeded()V
...
.method private registerPackageMonitorIfNeeded()V
    ...
    iget-object v1, p0, mPackageMonitorLock:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, mPackageMonitor:Lcom/android/server/NetworkScoreService$NetworkScorerPackageMonitor;
    ...
    iget-object v4, p0, mPackageMonitor:Lcom/android/server/NetworkScoreService$NetworkScorerPackageMonitor;
    ...
    iget-object v5, p0, mPackageMonitor:Lcom/android/server/NetworkScoreService$NetworkScorerPackageMonitor;
    ...
    iput-object v3, p0, mPackageMonitor:Lcom/android/server/NetworkScoreService$NetworkScorerPackageMonitor;
    ...
    iput-object v2, p0, mPackageMonitor:Lcom/android/server/NetworkScoreService$NetworkScorerPackageMonitor;
...
.method private registerRecommendationSettingsObserver()V
    ...
    iget-object v1, p0, mRecommendationSettingsObserver:Lcom/android/server/NetworkScoreService$DispatchingContentObserver;
    ...
    iget-object v2, p0, mRecommendationSettingsObserver:Lcom/android/server/NetworkScoreService$DispatchingContentObserver;
...
.method private unbindFromScoringServiceIfNeeded()V
    ...
    iget-object v3, p0, mServiceConnection:Lcom/android/server/NetworkScoreService$ScoringServiceConnection;
...
.method public clearScores()Z
    ...
    invoke-direct {p0, v0}, enforceSystemOrIsActiveScorer(I)V
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    :try_start_0
    iget-object v2, p0, mNetworkScorerAppManager:Lcom/android/server/NetworkScorerAppManager;
    ...
    invoke-direct {p0, v3, v4}, sendCacheUpdateCallback(Ljava/util/function/BiConsumer;Ljava/util/Collection;)V

    iget-object v3, p0, mServiceConnectionLock:Ljava/lang/Object;
    ...
    :try_start_2
    iget-object v4, p0, mServiceConnection:Lcom/android/server/NetworkScoreService$ScoringServiceConnection;
...
.method public getActiveScorer()Landroid/net/NetworkScorerAppData;
    ...
    invoke-direct {p0}, enforceSystemOnly()V
...
.method public getActiveScorerPackage()Ljava/lang/String;
    ...
    invoke-direct {p0}, enforceSystemOrHasScoreNetworks()V
...
.method public registerNetworkScoreCache(ILandroid/net/INetworkScoreCache;I)V
    ...
    :try_start_1
    iget-object v3, p0, mScoreCaches:Ljava/util/Map;
    ...
    iget-object v4, p0, mScoreCaches:Ljava/util/Map;
...
.method public requestScores([Landroid/net/NetworkKey;)Z
    ...
    :try_start_0
    invoke-direct {p0}, getRecommendationProvider()Landroid/net/INetworkRecommendationProvider;
...
.method systemReady()V
    ...
    :cond_0
    invoke-direct {p0}, registerRecommendationSettingsObserver()V
...
.method public updateScores([Landroid/net/ScoredNetwork;)Z
    ...
    invoke-virtual {p0, v0}, isCallerActiveScorer(I)Z
    ...
    iget-object v7, p0, mScoreCaches:Ljava/util/Map;
    ...
    :try_start_1
    iget-object v8, p0, mScoreCaches:Ljava/util/Map;
    ...
    invoke-direct {p0, v7, v9}, sendCacheUpdateCallback(Ljava/util/function/BiConsumer;Ljava/util/Collection;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_1
