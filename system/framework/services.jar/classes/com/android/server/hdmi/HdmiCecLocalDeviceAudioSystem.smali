...
.method protected constructor <init>(Lcom/android/server/hdmi/HdmiControlService;)V
    ...
    iput-object v0, p0, mTvSystemAudioModeSupport:Ljava/lang/Boolean;
    ...
    iput-boolean v1, p0, mArcIntentUsed:Z

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, mPortIdToTvInputs:Ljava/util/HashMap;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, mTvInputsToDeviceInfo:Ljava/util/HashMap;
    ...
    iput-object v1, p0, mSafeAllDeviceInfos:Ljava/util/List;

    new-instance v1, Landroid/util/SparseArray;

    invoke-direct {v1}, Landroid/util/SparseArray;-><init>()V

    iput-object v1, p0, mDeviceInfos:Landroid/util/SparseArray;
    ...
    iput-object v1, p0, mTvInputCallback:Landroid/media/tv/TvInputManager$TvInputCallback;
    ...
    iput-boolean v0, p0, mRoutingControlFeatureEnabled:Z
...
.method static synthetic access$000(Lcom/android/server/hdmi/HdmiCecLocalDeviceAudioSystem;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, addOrUpdateTvInput(Ljava/lang/String;)V
...
.method static synthetic access$200(Lcom/android/server/hdmi/HdmiCecLocalDeviceAudioSystem;Z)V
    ...
    invoke-direct {p0, p1}, setSystemAudioMode(Z)V
...
.method private addOrUpdateTvInput(Ljava/lang/String;)V
    ...
    :cond_1
    iget-object v3, p0, mPortIdToTvInputs:Ljava/util/HashMap;
    ...
    iget-object v3, p0, mTvInputsToDeviceInfo:Ljava/util/HashMap;
...
.method private getSupportedShortAudioDescriptor(Landroid/media/AudioDeviceInfo;I)[B
    ...
    :cond_0
    invoke-direct {p0, p1}, getLpcmShortAudioDescriptor(Landroid/media/AudioDeviceInfo;)[B
...
.method private getSupportedShortAudioDescriptors(Landroid/media/AudioDeviceInfo;[I)[B
    ...
    invoke-direct {p0, p1, v4}, getSupportedShortAudioDescriptor(Landroid/media/AudioDeviceInfo;I)[B
    ...
    :cond_2
    invoke-direct {p0, v0}, getShortAudioDescriptorBytes(Ljava/util/ArrayList;)[B
...
.method private getSupportedShortAudioDescriptorsFromConfig(Ljava/util/List;[I)[B
    ...
    :cond_5
    invoke-direct {p0, v2}, getShortAudioDescriptorBytes(Ljava/util/ArrayList;)[B
...
.method private handleRoutingChangeAndInformationForSwitch(Lcom/android/server/hdmi/HdmiCecMessage;)V
    ...
    invoke-virtual {p0}, getRoutingPort()I
    ...
    invoke-virtual {p0, v1}, routeToInputFromPortId(I)V
...
.method private handleRoutingChangeAndInformationForSystemAudio()V
    ...
    invoke-virtual {p0, v0}, routeToInputFromPortId(I)V
...
.method private removeTvInput(Ljava/lang/String;)V
    ...
    :try_start_0
    iget-object v1, p0, mTvInputsToDeviceInfo:Ljava/util/HashMap;
    ...
    iget-object v2, p0, mPortIdToTvInputs:Ljava/util/HashMap;
    ...
    iget-object v2, p0, mTvInputsToDeviceInfo:Ljava/util/HashMap;
...
.method private setSystemAudioMode(Z)V
    ...
    invoke-virtual {p0}, switchToAudioInput()V
    ...
    invoke-virtual {p0}, isDirectConnectToTv()Z
    ...
    invoke-virtual {p0}, isArcEnabled()Z
...
.method final addCecDevice(Landroid/hardware/hdmi/HdmiDeviceInfo;)V
    ...
    invoke-virtual {p0, p1}, addDeviceInfo(Landroid/hardware/hdmi/HdmiDeviceInfo;)Landroid/hardware/hdmi/HdmiDeviceInfo;
...
.method doManualPortSwitching(ILandroid/hardware/hdmi/IHdmiControlCallback;)V
    ...
    :cond_0
    invoke-virtual {p0}, getLocalActivePort()I
    ...
    invoke-virtual {p0, p1}, setRoutingPort(I)V

    invoke-virtual {p0, p1}, setLocalActivePort(I)V
...
.method protected dump(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    invoke-virtual {p0}, isRoutingControlFeatureEnabled()Z
    ...
    iget-object v1, p0, mTvSystemAudioModeSupport:Ljava/lang/Boolean;
    ...
    iget-boolean v1, p0, mArcIntentUsed:Z
    ...
    iget-object v0, p0, mPortIdToTvInputs:Ljava/util/HashMap;
    ...
    iget-object v0, p0, mTvInputsToDeviceInfo:Ljava/util/HashMap;
...
.method protected handleGiveAudioStatus(Lcom/android/server/hdmi/HdmiCecMessage;)Z
    ...
    invoke-virtual {p0, v0}, reportAudioStatus(I)V
...
.method protected handleReportPhysicalAddress(Lcom/android/server/hdmi/HdmiCecMessage;)Z
    ...
    :cond_0
    invoke-virtual {p0, v8}, getCecDeviceInfo(I)Landroid/hardware/hdmi/HdmiDeviceInfo;
    ...
    invoke-virtual {p0, v12}, addCecDevice(Landroid/hardware/hdmi/HdmiDeviceInfo;)V
...
.method protected handleRequestShortAudioDescriptor(Lcom/android/server/hdmi/HdmiCecMessage;)Z
    ...
    invoke-direct {p0, v0}, parseAudioFormatCodes([B)[I
    ...
    invoke-direct {p0, v1, v0}, getSupportedShortAudioDescriptorsFromConfig(Ljava/util/List;[I)[B
    ...
    :cond_3
    invoke-direct {p0}, getSystemAudioDeviceInfo()Landroid/media/AudioDeviceInfo;
    ...
    :cond_4
    invoke-direct {p0, v4, v0}, getSupportedShortAudioDescriptors(Landroid/media/AudioDeviceInfo;[I)[B
...
.method protected handleRoutingChangeAndInformation(ILcom/android/server/hdmi/HdmiCecMessage;)V
    ...
    invoke-direct {p0}, handleRoutingChangeAndInformationForSystemAudio()V
    ...
    invoke-direct {p0, p2}, handleRoutingChangeAndInformationForSwitch(Lcom/android/server/hdmi/HdmiCecMessage;)V
...
.method protected handleSetOsdName(Lcom/android/server/hdmi/HdmiCecMessage;)Z
    ...
    invoke-virtual {p0, v3}, updateCecDevice(Landroid/hardware/hdmi/HdmiDeviceInfo;)V
...
.method protected handleSetSystemAudioMode(Lcom/android/server/hdmi/HdmiCecMessage;)Z
    ...
    invoke-virtual {p0, v0}, checkSupportAndSetSystemAudioMode(Z)Z
...
.method handleSystemAudioModeOnFromNonTvDevice(Lcom/android/server/hdmi/HdmiCecMessage;)V
    ...
    invoke-direct {p0, v0}, setSystemAudioMode(Z)V
    ...
    invoke-virtual {p0, v0}, queryTvSystemAudioModeSupport(Lcom/android/server/hdmi/HdmiCecLocalDeviceAudioSystem$TvSystemAudioModeSupportedCallback;)V
...
.method protected handleSystemAudioModeRequest(Lcom/android/server/hdmi/HdmiCecMessage;)Z
    ...
    invoke-virtual {p0, p1}, handleSystemAudioModeOnFromNonTvDevice(Lcom/android/server/hdmi/HdmiCecMessage;)V

    return v1

    :cond_1
    invoke-virtual {p0, v1}, setTvSystemAudioModeSupport(Z)V
...
.method protected onAddressAllocated(II)V
    ...
    invoke-virtual {p0, v0, v1}, systemAudioControlOnPowerOn(IZ)V
...
.method onHotplug(IZ)V
    ...
    invoke-virtual {p0, v2}, removeCecDevice(I)V
...
.method protected onStandby(ZI)V
    ...
    invoke-virtual {p0}, terminateSystemAudioMode()V
...
.method onSystemAduioControlFeatureSupportChanged(Z)V
    ...
    invoke-virtual {p0, p1}, setSystemAudioControlFeatureEnabled(Z)V
...
.method queryTvSystemAudioModeSupport(Lcom/android/server/hdmi/HdmiCecLocalDeviceAudioSystem$TvSystemAudioModeSupportedCallback;)V
    ...
    iget-object v0, p0, mTvSystemAudioModeSupport:Ljava/lang/Boolean;
...
.method protected routeToInputFromPortId(I)V
    ...
    :cond_0
    iget-boolean v0, p0, mArcIntentUsed:Z

    if-eqz v0, :cond_1

    invoke-virtual {p0, p1}, routeToTvInputFromPortId(I)V
...
.method protected routeToTvInputFromPortId(I)V
    ...
    invoke-direct {p0}, switchToHomeTvInput()V
    ...
    invoke-direct {p0, v0}, switchToTvInput(Ljava/lang/String;)V
    ...
    :cond_2
    iget-object v1, p0, mPortIdToTvInputs:Ljava/util/HashMap;
    ...
    invoke-direct {p0, v1}, switchToTvInput(Ljava/lang/String;)V
...
.method setArcStatus(Z)V
    ...
    invoke-direct {p0, p1}, enableAudioReturnChannel(Z)V
...
.method setRoutingControlFeatureEnables(Z)V
    ...
    :try_start_0
    iput-boolean p1, p0, mRoutingControlFeatureEnabled:Z
...
.method protected switchInputOnReceivingNewActivePath(I)V
    ...
    :cond_0
    iget-boolean v1, p0, mIsSwitchDevice:Z
...
.method protected updateDevicePowerStatus(II)V
    ...
    invoke-virtual {p0, v1}, addDeviceInfo(Landroid/hardware/hdmi/HdmiDeviceInfo;)Landroid/hardware/hdmi/HdmiDeviceInfo;
