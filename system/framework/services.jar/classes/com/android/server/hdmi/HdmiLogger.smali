...
.method private errorInternal(Ljava/lang/String;)V
    ...
    iget-object v0, p0, mErrorTimingCache:Ljava/util/HashMap;

    invoke-static {v0, p1}, updateLog(Ljava/util/HashMap;Ljava/lang/String;)Ljava/lang/String;
...
.method private static getLogger()Lcom/android/server/hdmi/HdmiLogger;
    ...
    sget-object v0, sLogger:Ljava/lang/ThreadLocal;
...
.method private static updateLog(Ljava/util/HashMap;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2, v0, v1}, shouldLogNow(Landroid/util/Pair;J)Z

    move-result v3

    if-eqz v3, :cond_0

    invoke-static {p1, v2}, buildMessage(Ljava/lang/String;Landroid/util/Pair;)Ljava/lang/String;
...
.method private warningInternal(Ljava/lang/String;)V
    ...
    iget-object v0, p0, mWarningTimingCache:Ljava/util/HashMap;
