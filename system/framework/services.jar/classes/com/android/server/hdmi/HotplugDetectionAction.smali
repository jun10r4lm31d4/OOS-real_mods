...
.method private checkHotplug(Ljava/util/List;Z)V
    ...
    invoke-static {v0, p2}, infoListToBitSet(Ljava/util/List;Z)Ljava/util/BitSet;
    ...
    invoke-static {v0, v2}, complement(Ljava/util/BitSet;Ljava/util/BitSet;)Ljava/util/BitSet;
    ...
    invoke-direct {p0, v4}, removeDevice(I)V
    ...
    iput v1, p0, mAvrStatusCount:I

    :cond_2
    invoke-static {v2, v0}, complement(Ljava/util/BitSet;Ljava/util/BitSet;)Ljava/util/BitSet;
    ...
    invoke-direct {p0, v4}, addDevice(I)V
...
.method private mayCancelOneTouchRecord(I)V
    ...
    invoke-virtual {p0, v2}, removeAction(Lcom/android/server/hdmi/HdmiCecFeatureAction;)V
