...
.method private constructor <init>(Lcom/android/server/hdmi/HdmiControlService;Lcom/android/server/hdmi/HdmiCecController$NativeWrapper;)V
    ...
    iput-object v0, p0, mRemoteDeviceAddressPredicate:Ljava/util/function/Predicate;
    ...
    iput-object v0, p0, mSystemAudioAddressPredicate:Ljava/util/function/Predicate;
    ...
    iput-object v0, p0, mMessageHistory:Ljava/util/concurrent/ArrayBlockingQueue;

    iput-object p1, p0, mService:Lcom/android/server/hdmi/HdmiControlService;

    iput-object p2, p0, mNativeWrapperImpl:Lcom/android/server/hdmi/HdmiCecController$NativeWrapper;
    ...
    iput-object v0, p0, mNeverAssignLogicalAddresses:Ljava/util/List;
...
.method static synthetic access$1100(JI)I
    ...
    invoke-static {p0, p1, p2}, nativeAddLogicalAddress(JI)I
...
.method static synthetic access$1200(J)V
    ...
    invoke-static {p0, p1}, nativeClearLogicalAddress(J)V
...
.method static synthetic access$1300(J)I
    ...
    invoke-static {p0, p1}, nativeGetPhysicalAddress(J)I
...
.method static synthetic access$1400(J)I
    ...
    invoke-static {p0, p1}, nativeGetVersion(J)I
...
.method static synthetic access$1500(J)I
    ...
    invoke-static {p0, p1}, nativeGetVendorId(J)I
...
.method static synthetic access$1600(J)[Landroid/hardware/hdmi/HdmiPortInfo;
    ...
    invoke-static {p0, p1}, nativeGetPortInfos(J)[Landroid/hardware/hdmi/HdmiPortInfo;
...
.method static synthetic access$1700(JIZ)V
    ...
    invoke-static {p0, p1, p2, p3}, nativeSetOption(JIZ)V
...
.method static synthetic access$1800(JLjava/lang/String;)V
    ...
    invoke-static {p0, p1, p2}, nativeSetLanguage(JLjava/lang/String;)V
...
.method static synthetic access$1900(JIZ)V
    ...
    invoke-static {p0, p1, p2, p3}, nativeEnableAudioReturnChannel(JIZ)V
...
.method static synthetic access$2000(JI)Z
    ...
    invoke-static {p0, p1, p2}, nativeIsConnected(JI)Z
...
.method static synthetic access$800(Lcom/android/server/hdmi/HdmiCecController;)Lcom/android/server/hdmi/HdmiCecController$NativeWrapper;
    ...
    iget-object v0, p0, mNativeWrapperImpl:Lcom/android/server/hdmi/HdmiCecController$NativeWrapper;
...
.method static synthetic access$900(Lcom/android/server/hdmi/HdmiCecController;Landroid/os/MessageQueue;)J
    ...
    invoke-static {p0, p1}, nativeInit(Lcom/android/server/hdmi/HdmiCecController;Landroid/os/MessageQueue;)J
...
.method private addMessageToHistory(ZLcom/android/server/hdmi/HdmiCecMessage;)V
    ...
    iget-object v1, p0, mMessageHistory:Ljava/util/concurrent/ArrayBlockingQueue;
...
.method static create(Lcom/android/server/hdmi/HdmiControlService;)Lcom/android/server/hdmi/HdmiCecController;
    ...
    invoke-static {p0, v0}, createWithNativeWrapper(Lcom/android/server/hdmi/HdmiControlService;Lcom/android/server/hdmi/HdmiCecController$NativeWrapper;)Lcom/android/server/hdmi/HdmiCecController;
...
.method static createWithNativeWrapper(Lcom/android/server/hdmi/HdmiControlService;Lcom/android/server/hdmi/HdmiCecController$NativeWrapper;)Lcom/android/server/hdmi/HdmiCecController;
    ...
    invoke-direct {v0, p0, p1}, <init>(Lcom/android/server/hdmi/HdmiControlService;Lcom/android/server/hdmi/HdmiCecController$NativeWrapper;)V
    ...
    :cond_0
    invoke-direct {v0, v1, v2}, init(J)V
...
.method private handleAllocateLogicalAddress(IILcom/android/server/hdmi/HdmiCecController$AllocateAddressCallback;)V
    ...
    iget-object v8, p0, mNeverAssignLogicalAddresses:Ljava/util/List;
    ...
    invoke-direct {p0, v7, v7, v6}, sendPollMessage(III)Z
    ...
    invoke-direct {p0, v2}, runOnServiceThread(Ljava/lang/Runnable;)V
...
.method private handleIncomingCecCommand(II[B)V
    ...
    invoke-direct {p0, v1, v0}, addMessageToHistory(ZLcom/android/server/hdmi/HdmiCecMessage;)V
...
.method private pickPollCandidates(I)Ljava/util/List;
    ...
    iget-object v1, p0, mRemoteDeviceAddressPredicate:Ljava/util/function/Predicate;

    goto :goto_0

    :cond_0
    iget-object v1, p0, mSystemAudioAddressPredicate:Ljava/util/function/Predicate;
...
.method private runDevicePolling(ILjava/util/List;ILcom/android/server/hdmi/HdmiControlService$DevicePollingCallback;Ljava/util/List;)V
    ...
    invoke-direct {p0, v9}, runOnIoThread(Ljava/lang/Runnable;)V
...
.method private sendPollMessage(III)Z
    ...
    iget-object v2, p0, mNativeWrapperImpl:Lcom/android/server/hdmi/HdmiCecController$NativeWrapper;

    iget-wide v3, p0, mNativePtr:J

    sget-object v7, EMPTY_BODY:[B
...
.method dump(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    iget-object v2, p0, mLocalDevices:Landroid/util/SparseArray;
...
.method sendCommand(Lcom/android/server/hdmi/HdmiCecMessage;Lcom/android/server/hdmi/HdmiControlService$SendMessageCallback;)V
    ...
    invoke-direct {p0, v0, p1}, addMessageToHistory(ZLcom/android/server/hdmi/HdmiCecMessage;)V
