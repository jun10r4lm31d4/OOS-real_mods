...
.method protected dump(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    iget v1, p0, mActiveRoutingPath:I
...
.method protected handleGiveOsdName(Lcom/android/server/hdmi/HdmiCecMessage;)Z
    ...
    iget-object v2, p0, mDeviceInfo:Landroid/hardware/hdmi/HdmiDeviceInfo;
...
.method protected handleUserControlPressed(Lcom/android/server/hdmi/HdmiCecMessage;)Z
    ...
    :cond_2
    invoke-static {v3, v4, v2, v7, v9}, injectKeyEvent(JIII)V

    :cond_3
    :goto_0
    iput v5, p0, mLastKeycode:I

    iput v6, p0, mLastKeyRepeatCount:I

    if-eq v5, v8, :cond_4

    invoke-static {v3, v4, v9, v5, v6}, injectKeyEvent(JIII)V
...
.method protected handleUserControlReleased()Z
    ...
    invoke-static {v3, v4, v5, v1, v0}, injectKeyEvent(JIII)V

    iput v2, p0, mLastKeycode:I
...
.method protected final onMessage(Lcom/android/server/hdmi/HdmiCecMessage;)Z
    ...
    :pswitch_1
    invoke-virtual {p0, p1}, handleRequestArcTermination(Lcom/android/server/hdmi/HdmiCecMessage;)Z
    ...
    :pswitch_2
    invoke-virtual {p0, p1}, handleRequestArcInitiate(Lcom/android/server/hdmi/HdmiCecMessage;)Z
    ...
    :pswitch_3
    invoke-virtual {p0, p1}, handleReportArcTermination(Lcom/android/server/hdmi/HdmiCecMessage;)Z
    ...
    :pswitch_4
    invoke-virtual {p0, p1}, handleReportArcInitiate(Lcom/android/server/hdmi/HdmiCecMessage;)Z
    ...
    :pswitch_b
    invoke-virtual {p0, v1}, handleGiveDeviceVendorId(Lcom/android/server/hdmi/HdmiControlService$SendMessageCallback;)Z
    ...
    :pswitch_f
    invoke-virtual {p0, v1}, handleGivePhysicalAddress(Lcom/android/server/hdmi/HdmiControlService$SendMessageCallback;)Z
    ...
    :pswitch_14
    invoke-virtual {p0, p1}, handleGiveAudioStatus(Lcom/android/server/hdmi/HdmiCecMessage;)Z
    ...
    :pswitch_15
    invoke-virtual {p0, p1}, handleSystemAudioModeRequest(Lcom/android/server/hdmi/HdmiCecMessage;)Z
    ...
    :cond_1
    invoke-virtual {p0, p1}, handleRequestShortAudioDescriptor(Lcom/android/server/hdmi/HdmiCecMessage;)Z
    ...
    :cond_2
    invoke-virtual {p0, p1}, handleReportShortAudioDescriptor(Lcom/android/server/hdmi/HdmiCecMessage;)Z
    ...
    :cond_6
    invoke-virtual {p0, p1}, handleGiveSystemAudioModeStatus(Lcom/android/server/hdmi/HdmiCecMessage;)Z
...
.method protected sendKeyEvent(IZ)V
    ...
    invoke-virtual {p0}, findKeyReceiverAddress()I
...
.method protected sendVolumeKeyEvent(IZ)V
    ...
    invoke-virtual {p0}, findAudioReceiverAddress()I
