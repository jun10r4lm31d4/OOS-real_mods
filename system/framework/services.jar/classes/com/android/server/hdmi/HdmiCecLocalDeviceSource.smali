...
.method protected constructor <init>(Lcom/android/server/hdmi/HdmiControlService;I)V
    ...
    iput-boolean v1, p0, mIsSwitchDevice:Z

    iput v0, p0, mRoutingPort:I

    iput v0, p0, mLocalActivePort:I
...
.method protected handleActiveSource(Lcom/android/server/hdmi/HdmiCecMessage;)Z
    ...
    invoke-virtual {p0, v2}, setActiveSource(Lcom/android/server/hdmi/HdmiCecLocalDevice$ActiveSource;)V
    ...
    :goto_0
    invoke-virtual {p0, v3}, setIsActiveSource(Z)V

    invoke-virtual {p0, v0, v5}, updateDevicePowerStatus(II)V
    ...
    invoke-virtual {p0, v1}, switchInputOnReceivingNewActivePath(I)V
...
.method protected handleRequestActiveSource(Lcom/android/server/hdmi/HdmiCecMessage;)Z
    ...
    invoke-virtual {p0, v0}, maySendActiveSource(I)V
...
.method protected handleRoutingChange(Lcom/android/server/hdmi/HdmiCecMessage;)Z
    ...
    iget-boolean v2, p0, mIsSwitchDevice:Z
    ...
    invoke-virtual {p0, p1, v0}, setAndBroadcastActiveSource(Lcom/android/server/hdmi/HdmiCecMessage;I)V

    :cond_1
    invoke-virtual {p0, v0, p1}, handleRoutingChangeAndInformation(ILcom/android/server/hdmi/HdmiCecMessage;)V
...
.method protected handleSetStreamPath(Lcom/android/server/hdmi/HdmiCecMessage;)Z
    ...
    :cond_0
    invoke-virtual {p0, v0}, switchInputOnReceivingNewActivePath(I)V
...
.method isRoutingControlFeatureEnabled()Z
    ...
    :try_start_0
    iget-boolean v1, p0, mRoutingControlFeatureEnabled:Z
