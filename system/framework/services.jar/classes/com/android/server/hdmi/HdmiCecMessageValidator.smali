...
.method public constructor <init>(Lcom/android/server/hdmi/HdmiControlService;)V
    ...
    iput-object v1, v0, mValidationInfo:Landroid/util/SparseArray;

    move-object/from16 v1, p1

    iput-object v1, v0, mService:Lcom/android/server/hdmi/HdmiControlService;
    ...
    invoke-direct {v0, v5, v2, v4}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V

    const/4 v5, 0x1

    const/16 v6, 0x9d

    invoke-direct {v0, v6, v2, v5}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    invoke-direct {v0, v7, v6, v4}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    invoke-direct {v0, v6, v2, v4}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V

    const/4 v6, 0x2

    const/16 v7, 0x86

    invoke-direct {v0, v7, v2, v6}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    invoke-direct {v0, v3, v7, v5}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    invoke-direct {v0, v8, v3, v5}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    invoke-direct {v0, v9, v3, v8}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V

    const/16 v9, 0x71

    invoke-direct {v0, v9, v3, v5}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    invoke-direct {v0, v10, v3, v5}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    invoke-direct {v0, v10, v3, v4}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V

    const/4 v10, 0x7

    const/16 v11, 0x36

    invoke-direct {v0, v11, v3, v10}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V

    const/16 v11, 0xc5

    invoke-direct {v0, v11, v3, v5}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V

    const/16 v11, 0xd

    invoke-direct {v0, v11, v3, v5}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V

    invoke-direct {v0, v4, v3, v5}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    invoke-direct {v0, v12, v3, v11}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    invoke-direct {v0, v14, v13, v5}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V

    const/16 v13, 0xa

    invoke-direct {v0, v13, v12, v5}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    invoke-direct {v0, v14, v13, v6}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    invoke-direct {v0, v4, v15, v6}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    invoke-direct {v0, v15, v4, v8}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    invoke-direct {v0, v8, v4, v10}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V

    const/16 v4, 0x8a

    invoke-direct {v0, v4, v13, v10}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V

    const/16 v4, 0x64

    invoke-direct {v0, v4, v13, v5}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    invoke-direct {v0, v4, v12, v5}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    invoke-direct {v0, v8, v4, v5}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    invoke-direct {v0, v7, v4, v5}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    invoke-direct {v0, v6, v4, v5}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    invoke-direct {v0, v4, v12, v11}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
...
.method isValid(Lcom/android/server/hdmi/HdmiCecMessage;)I
    ...
    iget-object v1, p0, mValidationInfo:Landroid/util/SparseArray;
