...
.method private handleReportAudioStatus(Lcom/android/server/hdmi/HdmiCecMessage;)V
    ...
    invoke-virtual {p0, v3, v4}, sendUserControlPressedAndReleased(II)V
...
.method private handleSendGiveAudioStatusFailure()V
    ...
    invoke-virtual {p0, v0, v2}, sendUserControlPressedAndReleased(II)V

    invoke-direct {p0, v1}, finishWithCallback(I)V
