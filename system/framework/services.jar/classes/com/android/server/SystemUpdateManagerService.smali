...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v0, p0, mLastUid:I

    const/4 v0, 0x0

    iput v0, p0, mLastStatus:I
    ...
    :try_start_0
    invoke-direct {p0}, loadSystemUpdateInfoLocked()Landroid/os/Bundle;
...
.method private loadSystemUpdateInfoLocked()Landroid/os/Bundle;
    ...
    invoke-direct {p0, v3}, readInfoFileLocked(Lorg/xmlpull/v1/XmlPullParser;)Landroid/os/PersistableBundle;
    ...
    invoke-direct {p0}, removeInfoFileAndGetDefaultInfoBundleLocked()Landroid/os/Bundle;
    ...
    invoke-direct {p0}, getBootCount()I
    ...
    :cond_7
    iput v6, p0, mLastStatus:I

    iput v4, p0, mLastUid:I
...
.method private saveSystemUpdateInfoLocked(Landroid/os/PersistableBundle;I)V
    ...
    invoke-direct {p0, v0}, writeInfoFileLocked(Landroid/os/PersistableBundle;)Z

    move-result v1

    if-eqz v1, :cond_0

    iput p2, p0, mLastUid:I
...
.method public updateSystemUpdateInfo(Landroid/os/PersistableBundle;)V
    ...
    :try_start_0
    invoke-direct {p0, p1, v1}, saveSystemUpdateInfoLocked(Landroid/os/PersistableBundle;I)V
