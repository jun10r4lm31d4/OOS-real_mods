...
.method constructor <init>(Landroid/net/Uri;ILjava/lang/String;II)V
    ...
    iput-object v0, p0, mPermissionOwnerToken:Landroid/os/IBinder;

    iput-object p1, p0, mUri:Landroid/net/Uri;

    iput p2, p0, mSourceUid:I

    iput-object p3, p0, mTargetPackage:Ljava/lang/String;

    iput p4, p0, mSourceUserId:I

    iput p5, p0, mTargetUserId:I
...
.method private doTakeLocked(Landroid/os/IBinder;)V
    ...
    iget v4, p0, mSourceUid:I

    iget-object v5, p0, mTargetPackage:Ljava/lang/String;

    iget-object v6, p0, mUri:Landroid/net/Uri;

    const/4 v7, 0x1

    iget v8, p0, mSourceUserId:I

    iget v9, p0, mTargetUserId:I
...
.method public release()V
    ...
    :try_start_0
    iget-object v1, p0, mPermissionOwnerToken:Landroid/os/IBinder;
    ...
    iget-object v3, p0, mPermissionOwnerToken:Landroid/os/IBinder;

    iget-object v4, p0, mUri:Landroid/net/Uri;

    const/4 v5, 0x1

    iget v6, p0, mSourceUserId:I
    ...
    :try_start_2
    iput-object v1, p0, mPermissionOwnerToken:Landroid/os/IBinder;
...
.method public take()V
    ...
    invoke-direct {p0, v1}, doTakeLocked(Landroid/os/IBinder;)V
