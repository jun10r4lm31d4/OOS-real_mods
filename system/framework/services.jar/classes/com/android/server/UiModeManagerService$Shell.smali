...
.method constructor <init>(Landroid/app/IUiModeManager;)V
    ...
    iput-object p1, p0, mInterface:Landroid/app/IUiModeManager;
...
.method static synthetic access$1800(I)Ljava/lang/String;
    ...
    invoke-static {p0}, nightModeToStr(I)Ljava/lang/String;
...
.method private handleNightMode()I
    ...
    invoke-direct {p0}, printCurrentNightMode()V

    return v2

    :cond_0
    invoke-static {v1}, strToNightMode(Ljava/lang/String;)I

    move-result v3

    if-ltz v3, :cond_1

    iget-object v4, p0, mInterface:Landroid/app/IUiModeManager;
...
.method private printCurrentNightMode()V
    ...
    iget-object v1, p0, mInterface:Landroid/app/IUiModeManager;

    invoke-interface {v1}, Landroid/app/IUiModeManager;->getNightMode()I

    move-result v1

    invoke-static {v1}, nightModeToStr(I)Ljava/lang/String;
...
.method public onCommand(Ljava/lang/String;)I
    ...
    :cond_3
    invoke-direct {p0}, handleNightMode()I
