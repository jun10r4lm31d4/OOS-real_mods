...
.method static constructor <clinit>()V
    ...
    sput v0, DEFAULT_TRIGGER_FAILURE_DURATION_MS:I
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct/range {v0 .. v6}, <init>(Landroid/content/Context;Landroid/util/AtomicFile;Landroid/os/Handler;Landroid/os/Handler;Lcom/android/server/ExplicitHealthCheckController;Landroid/net/NetworkStackClient;)V
...
.method constructor <init>(Landroid/content/Context;Landroid/util/AtomicFile;Landroid/os/Handler;Landroid/os/Handler;Lcom/android/server/ExplicitHealthCheckController;Landroid/net/NetworkStackClient;)V
    ...
    iput-object v0, p0, mAllObservers:Landroid/util/ArrayMap;

    const/4 v0, 0x1

    iput-boolean v0, p0, mIsHealthCheckEnabled:Z

    sget v0, DEFAULT_TRIGGER_FAILURE_DURATION_MS:I

    iput v0, p0, mTriggerFailureDurationMs:I

    const/4 v0, 0x5

    iput v0, p0, mTriggerFailureCount:I

    iput-object p1, p0, mContext:Landroid/content/Context;

    iput-object p2, p0, mPolicyFile:Landroid/util/AtomicFile;

    iput-object p3, p0, mShortTaskHandler:Landroid/os/Handler;

    iput-object p4, p0, mLongTaskHandler:Landroid/os/Handler;

    iput-object p5, p0, mHealthCheckController:Lcom/android/server/ExplicitHealthCheckController;

    iput-object p6, p0, mNetworkStackClient:Landroid/net/NetworkStackClient;

    invoke-direct {p0}, loadFromFile()V
...
.method static synthetic access$300(Lcom/android/server/PackageWatchdog;)I
    ...
    iget v0, p0, mTriggerFailureDurationMs:I
...
.method static synthetic access$400(Lcom/android/server/PackageWatchdog;)I
    ...
    iget v0, p0, mTriggerFailureCount:I
...
.method public static getInstance(Landroid/content/Context;)Lcom/android/server/PackageWatchdog;
    ...
    :try_start_0
    sget-object v1, sPackageWatchdog:Lcom/android/server/PackageWatchdog;
    ...
    sput-object v1, sPackageWatchdog:Lcom/android/server/PackageWatchdog;
...
.method private getNextStateSyncMillisLocked()J
    ...
    :goto_0
    iget-object v3, p0, mAllObservers:Landroid/util/ArrayMap;
...
.method private getPackagesPendingHealthChecksLocked()Ljava/util/Set;
    ...
    iget-object v1, p0, mAllObservers:Landroid/util/ArrayMap;
...
.method public static synthetic lambda$CQuOnXthwwBaxcS5WoAlJJAz8Tk(Lcom/android/server/PackageWatchdog;)V
    ...
    invoke-direct {p0}, syncRequests()V
...
.method public static synthetic lambda$ZYXCPv-g8AolCxNNTIoK4ITZJpQ(Lcom/android/server/PackageWatchdog;)V
    ...
    invoke-direct {p0}, saveToFileAsync()V
...
.method public static synthetic lambda$vRKcIrucEj03dz6ypRVINZtns1s(Lcom/android/server/PackageWatchdog;)V
    ...
    invoke-direct {p0}, syncStateWithScheduledReason()V
...
.method private loadFromFile()V
    ...
    iget-object v4, p0, mAllObservers:Landroid/util/ArrayMap;
...
.method private onHealthCheckFailed(Lcom/android/server/PackageWatchdog$ObserverInternal;Ljava/util/Set;)V
    ...
    iget-object v0, p0, mLongTaskHandler:Landroid/os/Handler;
...
.method private onHealthCheckPassed(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v1}, syncState(Ljava/lang/String;)V
...
.method private onSupportedPackages(Ljava/util/List;)V
    ...
    invoke-direct {p0, v3}, syncState(Ljava/lang/String;)V
...
.method private pruneObserversLocked()V
    ...
    iget-wide v0, p0, mUptimeAtLastStateSync:J
    ...
    iget-wide v4, p0, mUptimeAtLastStateSync:J
    ...
    iget-object v2, p0, mAllObservers:Landroid/util/ArrayMap;
    ...
    invoke-direct {p0, v4, v5}, onHealthCheckFailed(Lcom/android/server/PackageWatchdog$ObserverInternal;Ljava/util/Set;)V
...
.method private registerNetworkStackHealthListener()V
    ...
    iget-object v0, p0, mNetworkStackClient:Landroid/net/NetworkStackClient;
...
.method private saveToFile()Z
    ...
    :goto_0
    iget-object v7, p0, mAllObservers:Landroid/util/ArrayMap;
    ...
    iget-object v5, p0, mPolicyFile:Landroid/util/AtomicFile;
...
.method private scheduleNextSyncStateLocked()V
    ...
    invoke-direct {p0}, getNextStateSyncMillisLocked()J

    move-result-wide v0

    iget-object v2, p0, mShortTaskHandler:Landroid/os/Handler;
    ...
    iput-wide v2, p0, mUptimeAtLastStateSync:J
...
.method private setExplicitHealthCheckEnabled(Z)V
    ...
    :try_start_0
    iput-boolean p1, p0, mIsHealthCheckEnabled:Z

    iget-object v1, p0, mHealthCheckController:Lcom/android/server/ExplicitHealthCheckController;
...
.method private syncRequests()V
    ...
    :try_start_0
    iget-boolean v2, p0, mIsPackagesReady:Z

    if-eqz v2, :cond_0

    invoke-direct {p0}, getPackagesPendingHealthChecksLocked()Ljava/util/Set;
...
.method private syncRequestsAsync()V
    ...
    iget-object v0, p0, mShortTaskHandler:Landroid/os/Handler;
...
.method private syncState(Ljava/lang/String;)V
    ...
    invoke-direct {p0}, pruneObserversLocked()V

    invoke-direct {p0}, saveToFileAsync()V

    invoke-direct {p0}, syncRequestsAsync()V

    invoke-direct {p0}, scheduleNextSyncStateLocked()V
...
.method private syncStateWithScheduledReason()V
    ...
    invoke-direct {p0, v0}, syncState(Ljava/lang/String;)V
...
.method private updateConfigs()V
    ...
    iput v1, p0, mTriggerFailureCount:I

    iget v1, p0, mTriggerFailureCount:I

    if-gtz v1, :cond_0

    iput v3, p0, mTriggerFailureCount:I
    ...
    sget v4, DEFAULT_TRIGGER_FAILURE_DURATION_MS:I

    invoke-static {v1, v2, v4}, Landroid/provider/DeviceConfig;->getInt(Ljava/lang/String;Ljava/lang/String;I)I

    move-result v1

    iput v1, p0, mTriggerFailureDurationMs:I

    iget v1, p0, mTriggerFailureDurationMs:I

    if-gtz v1, :cond_1

    iput v3, p0, mTriggerFailureDurationMs:I
    ...
    invoke-direct {p0, v1}, setExplicitHealthCheckEnabled(Z)V
...
.method public synthetic lambda$onHealthCheckFailed$4$PackageWatchdog(Lcom/android/server/PackageWatchdog$ObserverInternal;Ljava/util/Set;)V
    ...
    invoke-direct {p0, v3}, getVersionedPackage(Ljava/lang/String;)Landroid/content/pm/VersionedPackage;
...
.method public synthetic lambda$onPackagesReady$0$PackageWatchdog(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, onHealthCheckPassed(Ljava/lang/String;)V
...
.method public synthetic lambda$onPackagesReady$1$PackageWatchdog(Ljava/util/List;)V
    ...
    invoke-direct {p0, p1}, onSupportedPackages(Ljava/util/List;)V
...
.method public synthetic lambda$registerNetworkStackHealthListener$6$PackageWatchdog(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, getVersionedPackage(Ljava/lang/String;)Landroid/content/pm/VersionedPackage;
    ...
    invoke-virtual {p0}, getTriggerFailureCount()J
    ...
    invoke-virtual {p0, v1}, onPackageFailure(Ljava/util/List;)V
...
.method public synthetic lambda$setPropertyChangedListenerLocked$5$PackageWatchdog(Landroid/provider/DeviceConfig$Properties;)V
    ...
    :cond_0
    invoke-direct {p0}, updateConfigs()V
...
.method public onPackagesReady()V
    ...
    :try_start_0
    iput-boolean v1, p0, mIsPackagesReady:Z
    ...
    invoke-direct {p0}, setPropertyChangedListenerLocked()V

    invoke-direct {p0}, updateConfigs()V

    invoke-direct {p0}, registerNetworkStackHealthListener()V
...
.method public startObservingHealth(Lcom/android/server/PackageWatchdog$PackageHealthObserver;Ljava/util/List;J)V
    ...
    invoke-virtual {p0, p1}, registerHealthObserver(Lcom/android/server/PackageWatchdog$PackageHealthObserver;)V
...
.method public writeNow()V
    ...
    iget-object v1, p0, mLongTaskHandler:Landroid/os/Handler;
