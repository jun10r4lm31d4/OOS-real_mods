...
.method constructor <init>(Lcom/android/server/biometrics/BiometricService;Ljava/util/HashMap;Landroid/os/IBinder;JILandroid/hardware/biometrics/IBiometricServiceReceiver;Ljava/lang/String;Landroid/os/Bundle;IIIIZLandroid/hardware/biometrics/IBiometricConfirmDeviceCredentialCallback;)V
    ...
    iput-object v0, v1, this$0:Lcom/android/server/biometrics/BiometricService;
    ...
    iput-object v0, v1, mModalitiesMatched:Ljava/util/HashMap;
    ...
    iput-object v3, v1, mModalitiesWaiting:Ljava/util/HashMap;

    iput-object v2, v1, mToken:Landroid/os/IBinder;

    move-wide/from16 v4, p4

    iput-wide v4, v1, mSessionId:J

    move/from16 v6, p6

    iput v6, v1, mUserId:I

    move-object/from16 v7, p7

    iput-object v7, v1, mClientReceiver:Landroid/hardware/biometrics/IBiometricServiceReceiver;

    move-object/from16 v8, p8

    iput-object v8, v1, mOpPackageName:Ljava/lang/String;

    move-object/from16 v9, p9

    iput-object v9, v1, mBundle:Landroid/os/Bundle;

    move/from16 v10, p10

    iput v10, v1, mCallingUid:I

    move/from16 v11, p11

    iput v11, v1, mCallingPid:I

    move/from16 v12, p12

    iput v12, v1, mCallingUserId:I

    move/from16 v13, p13

    iput v13, v1, mModality:I

    move/from16 v14, p14

    iput-boolean v14, v1, mRequireConfirmation:Z

    move-object/from16 v15, p15

    iput-object v15, v1, mConfirmDeviceCredentialCallback:Landroid/hardware/biometrics/IBiometricConfirmDeviceCredentialCallback;

    invoke-virtual/range {p0 .. p0}, isFromConfirmDeviceCredential()Z
...
.method static synthetic access$2400(Lcom/android/server/biometrics/BiometricService$AuthSession;)J
    ...
    iget-wide v0, p0, mAuthenticatedTimeMs:J
...
.method static synthetic access$2402(Lcom/android/server/biometrics/BiometricService$AuthSession;J)J
    ...
    iput-wide p1, p0, mAuthenticatedTimeMs:J
...
.method static synthetic access$2600(Lcom/android/server/biometrics/BiometricService$AuthSession;)Landroid/hardware/biometrics/IBiometricConfirmDeviceCredentialCallback;
    ...
    iget-object v0, p0, mConfirmDeviceCredentialCallback:Landroid/hardware/biometrics/IBiometricConfirmDeviceCredentialCallback;
...
.method static synthetic access$2602(Lcom/android/server/biometrics/BiometricService$AuthSession;Landroid/hardware/biometrics/IBiometricConfirmDeviceCredentialCallback;)Landroid/hardware/biometrics/IBiometricConfirmDeviceCredentialCallback;
    ...
    iput-object p1, p0, mConfirmDeviceCredentialCallback:Landroid/hardware/biometrics/IBiometricConfirmDeviceCredentialCallback;
...
.method containsCookie(I)Z
    ...
    iget-object v0, p0, mModalitiesWaiting:Ljava/util/HashMap;
    ...
    :cond_0
    iget-object v0, p0, mModalitiesMatched:Ljava/util/HashMap;
...
.method public synthetic lambda$binderDied$0$BiometricService$AuthSession()V
    ...
    iget-object v1, p0, mConfirmDeviceCredentialCallback:Landroid/hardware/biometrics/IBiometricConfirmDeviceCredentialCallback;
    ...
    iput-object v1, p0, mConfirmDeviceCredentialCallback:Landroid/hardware/biometrics/IBiometricConfirmDeviceCredentialCallback;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
