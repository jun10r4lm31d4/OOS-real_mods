...
.method static constructor <clinit>()V
    ...
    sput-object v0, FINGERPRINT_SONFICATION_ATTRIBUTES:Landroid/media/AudioAttributes;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/biometrics/Constants;Lcom/android/server/biometrics/BiometricServiceBase$DaemonWrapper;JLandroid/os/IBinder;Lcom/android/server/biometrics/BiometricServiceBase$ServiceListener;IIZLjava/lang/String;I)V
    ...
    iput-object p2, p0, mConstants:Lcom/android/server/biometrics/Constants;

    iput-object p3, p0, mDaemon:Lcom/android/server/biometrics/BiometricServiceBase$DaemonWrapper;

    iput-wide p4, p0, mHalDeviceId:J

    iput-object p6, p0, mToken:Landroid/os/IBinder;

    iput-object p7, p0, mListener:Lcom/android/server/biometrics/BiometricServiceBase$ServiceListener;

    iput p8, p0, mTargetUserId:I

    iput p9, p0, mGroupId:I

    iput-boolean p10, p0, mIsRestricted:Z

    iput-object p11, p0, mOwner:Ljava/lang/String;

    iput p12, p0, mCookie:I
    ...
    iput-object v1, p0, mSuccessVibrationEffect:Landroid/os/VibrationEffect;
    ...
    iput-object v1, p0, mErrorVibrationEffect:Landroid/os/VibrationEffect;
    ...
    invoke-virtual {p0}, getLogTag()Ljava/lang/String;
...
.method public binderDied()V
    ...
    invoke-virtual {p0, v0}, stop(Z)I

    const/4 v0, 0x0

    iput-object v0, p0, mToken:Landroid/os/IBinder;

    iput-object v0, p0, mListener:Lcom/android/server/biometrics/BiometricServiceBase$ServiceListener;
...
.method protected blacklistContains(II)Z
    ...
    iget-object v0, p0, mConstants:Lcom/android/server/biometrics/Constants;
    ...
    :goto_0
    invoke-virtual {p0}, getAcquireVendorIgnorelist()[I
    ...
    :goto_1
    invoke-virtual {p0}, getAcquireIgnorelist()[I
...
.method public destroy()V
    ...
    :cond_0
    iput-object v1, p0, mListener:Lcom/android/server/biometrics/BiometricServiceBase$ServiceListener;
...
.method protected finalize()V
    ...
    invoke-virtual {p0, v0, v1, v2, v3}, onError(JII)Z
    :try_end_0
...
.method public final getDaemonWrapper()Lcom/android/server/biometrics/BiometricServiceBase$DaemonWrapper;
    ...
    iget-object v0, p0, mDaemon:Lcom/android/server/biometrics/BiometricServiceBase$DaemonWrapper;
...
.method public final getIsRestricted()Z
    ...
    iget-boolean v0, p0, mIsRestricted:Z
...
.method public final getListener()Lcom/android/server/biometrics/BiometricServiceBase$ServiceListener;
    ...
    iget-object v0, p0, mListener:Lcom/android/server/biometrics/BiometricServiceBase$ServiceListener;
...
.method public final getOwnerString()Ljava/lang/String;
    ...
    iget-object v0, p0, mOwner:Ljava/lang/String;
...
.method public isAlreadyDone()Z
    ...
    iget-boolean v0, p0, mAlreadyDone:Z
...
.method public onAcquired(II)Z
    ...
    invoke-virtual {p0}, getTargetUserId()I
    ...
    invoke-virtual {p0, p1, p2}, blacklistContains(II)Z
    ...
    invoke-virtual {p0}, notifyUserActivity()V
...
.method public onError(JII)Z
    ...
    iget-object v1, p0, mListener:Lcom/android/server/biometrics/BiometricServiceBase$ServiceListener;

    invoke-virtual {p0}, getCookie()I
...
.method public printClient()Ljava/lang/String;
    ...
    iget-boolean v1, p0, mAlreadyDone:Z
    ...
    iget-wide v1, p0, mHalDeviceId:J
    ...
    iget-object v1, p0, mOwner:Ljava/lang/String;
    ...
    iget-boolean v1, p0, mIsRestricted:Z
...
.method public final vibrateError()V
    ...
    iget-object v1, p0, mErrorVibrationEffect:Landroid/os/VibrationEffect;

    sget-object v2, FINGERPRINT_SONFICATION_ATTRIBUTES:Landroid/media/AudioAttributes;
...
.method public final vibrateSuccess()V
    ...
    iget-object v1, p0, mSuccessVibrationEffect:Landroid/os/VibrationEffect;
