...
.method constructor <init>(Lcom/android/server/biometrics/BiometricService;Landroid/os/Handler;)V
    ...
    iput-object v0, p0, FACE_UNLOCK_KEYGUARD_ENABLED:Landroid/net/Uri;
    ...
    iput-object v0, p0, FACE_UNLOCK_APP_ENABLED:Landroid/net/Uri;
    ...
    iput-object v0, p0, FACE_UNLOCK_ALWAYS_REQUIRE_CONFIRMATION:Landroid/net/Uri;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, mFaceEnabledOnKeyguard:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, mFaceEnabledForApps:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, mFaceAlwaysRequireConfirmation:Ljava/util/Map;
    ...
    invoke-virtual {p0}, updateContentObserver()V
...
.method getFaceAlwaysRequireConfirmation(I)Z
    ...
    iget-object v0, p0, mFaceAlwaysRequireConfirmation:Ljava/util/Map;
    ...
    iget-object v1, p0, FACE_UNLOCK_ALWAYS_REQUIRE_CONFIRMATION:Landroid/net/Uri;

    invoke-virtual {p0, v0, v1, p1}, onChange(ZLandroid/net/Uri;I)V
...
.method getFaceEnabledForApps(I)Z
    ...
    iget-object v0, p0, mFaceEnabledForApps:Ljava/util/Map;
    ...
    iget-object v0, p0, FACE_UNLOCK_APP_ENABLED:Landroid/net/Uri;

    invoke-virtual {p0, v1, v0, p1}, onChange(ZLandroid/net/Uri;I)V
...
.method getFaceEnabledOnKeyguard()Z
    ...
    iget-object v1, p0, mFaceEnabledOnKeyguard:Ljava/util/Map;
    ...
    iget-object v2, p0, FACE_UNLOCK_KEYGUARD_ENABLED:Landroid/net/Uri;

    invoke-virtual {p0, v1, v2, v0}, onChange(ZLandroid/net/Uri;I)V
...
.method notifyEnabledOnKeyguardCallbacks(I)V
    ...
    iget-object v4, p0, mFaceEnabledOnKeyguard:Ljava/util/Map;
...
.method public onChange(ZLandroid/net/Uri;I)V
    ...
    iget-object v0, p0, FACE_UNLOCK_KEYGUARD_ENABLED:Landroid/net/Uri;
    ...
    iget-object v0, p0, mFaceEnabledOnKeyguard:Ljava/util/Map;
    ...
    invoke-virtual {p0, p3}, notifyEnabledOnKeyguardCallbacks(I)V
    ...
    :cond_3
    iget-object v0, p0, FACE_UNLOCK_ALWAYS_REQUIRE_CONFIRMATION:Landroid/net/Uri;
...
.method updateContentObserver()V
    ...
    iget-object v1, p0, FACE_UNLOCK_KEYGUARD_ENABLED:Landroid/net/Uri;
    ...
    iget-object v1, p0, FACE_UNLOCK_APP_ENABLED:Landroid/net/Uri;
