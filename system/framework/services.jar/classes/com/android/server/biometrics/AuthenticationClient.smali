...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/biometrics/Constants;Lcom/android/server/biometrics/BiometricServiceBase$DaemonWrapper;JLandroid/os/IBinder;Lcom/android/server/biometrics/BiometricServiceBase$ServiceListener;IIJZLjava/lang/String;IZ)V
    ...
    iput-wide v0, v13, mOpId:J

    move/from16 v2, p15

    iput-boolean v2, v13, mRequireConfirmation:Z
...
.method private opHandleErrorVibration(III)V
    ...
    invoke-virtual {p0, p1, p2, p3}, vibrateErrorWithScene(III)Z
    ...
    :cond_1
    invoke-virtual {p0}, vibrateError()V
...
.method public getRequireConfirmation()Z
    ...
    iget-boolean v0, p0, mRequireConfirmation:Z
...
.method public onAuthenticated(Landroid/hardware/biometrics/BiometricAuthenticator$Identifier;ZLjava/util/ArrayList;)Z
    ...
    iget-boolean v4, p0, mRequireConfirmation:Z

    invoke-virtual {p0}, getTargetUserId()I

    move-result v5

    invoke-virtual {p0}, isBiometricPrompt()Z
    ...
    invoke-virtual {p0}, getListener()Lcom/android/server/biometrics/BiometricServiceBase$ServiceListener;

    move-result-object v1

    iget-object v2, p0, mMetricsLogger:Lcom/android/internal/logging/MetricsLogger;

    iget-object v3, p0, mConstants:Lcom/android/server/biometrics/Constants;
    ...
    iget-boolean v5, p0, mRequireConfirmation:Z
    ...
    iput-boolean v4, p0, mAlreadyDone:Z
    :try_end_0
    ...
    invoke-static {v6}, shouldVibrate(Landroid/content/Context;)Z
    ...
    invoke-virtual {p0, v6, v4}, vibrateSuccessWithScene(II)V
    ...
    :cond_2
    invoke-virtual {p0}, vibrateSuccess()V

    :cond_3
    :goto_0
    const/4 v2, 0x1

    invoke-virtual {p0}, shouldFrameworkHandleLockout()Z

    move-result v4

    if-eqz v4, :cond_4

    invoke-virtual {p0}, resetFailedAttempts()V
    ...
    :cond_5
    invoke-virtual {p0}, notifyFodAuthenticatedSuccess()V
    ...
    iget-boolean v3, p0, mRequireConfirmation:Z
    ...
    :try_start_2
    invoke-virtual {p0}, getIsRestricted()Z
    ...
    invoke-direct {p0, v5, v6, v7}, opHandleErrorVibration(III)V

    :cond_c
    invoke-virtual {p0}, handleFailedAttempt()I
    ...
    invoke-virtual {p0, v7, v8, v6, v3}, onError(JII)Z
    ...
    :cond_e
    invoke-virtual {p0}, notifyFodAuthenticatedFailed()V
    ...
    invoke-virtual {p0}, getRequireConfirmation()Z
...
.method public onError(JII)Z
    ...
    :cond_0
    invoke-virtual {p0}, wasUserDetected()Z
    ...
    invoke-direct {p0, v1, v2, v0}, opHandleErrorVibration(III)V
...
.method public start()I
    ...
    invoke-direct {p0}, notifySurfaceFlingerUpdateWhenSetDim()V
    ...
    iget-wide v3, p0, mOpId:J

    invoke-virtual {p0}, getGroupId()I
    ...
    iget-object v4, p0, mConstants:Lcom/android/server/biometrics/Constants;
    ...
    invoke-virtual {p0, v4, v5, v1, v3}, onError(JII)Z
...
.method public stop(Z)I
    ...
    iget-boolean v0, p0, mAlreadyCancelled:Z
    ...
    iput-boolean v0, p0, mAlreadyCancelled:Z
