...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, mIsColorCalibrationDisableByFingerPrint:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v1, p0, IS_SUPPORT_FINGERPRINT_POCKET:Z
    ...
    iput-boolean v1, p0, IS_SUPPORT_CUSTOM_FINGERPRINT:Z

    iput v2, p0, mBlockX:I

    iput v2, p0, mBlockY:I

    iput v2, p0, mBlockXEnd:I

    iput v2, p0, mBlockYEnd:I

    const/16 v1, 0x65

    iput v1, p0, mCurrentParam:I

    const-wide/32 v3, 0xea60

    iput-wide v3, p0, FAIL_ATTEMPT_COUNTING_DURATION:J

    const-wide/16 v3, 0xa

    iput-wide v3, p0, FAIL_ATTEMPT_MAX_AMOUNT:J

    const-wide/32 v3, 0x1b7740

    iput-wide v3, p0, ATTACK_DEFENDING_DURATION:J

    const-wide/16 v3, 0x0

    iput-wide v3, p0, mTimeStampStartCounting:J

    iput-wide v3, p0, mTimeStampRaisingCriteria:J

    iput-boolean v2, p0, mAttackDefending:Z

    const-string v1, "fps_color_correction"

    iput-object v1, p0, KEY_COLOR_CORRECTION:Ljava/lang/String;

    iput-boolean v2, p0, mTempDisableColorCorrection:Z

    const/4 v3, 0x0

    iput-object v3, p0, mOIMCServiceManager:Lcom/oneplus/core/oimc/OIMCServiceManager;
    ...
    iput-object v3, p0, mKeyguardPackage:Ljava/lang/String;
    ...
    iget-boolean v4, p0, IS_SUPPORT_CUSTOM_FINGERPRINT:Z
    ...
    iput v4, p0, mBlockY:I

    iget v4, p0, mBlockX:I
    ...
    iput v4, p0, mBlockXEnd:I

    iget v4, p0, mBlockY:I
    ...
    iput-object v4, p0, mFingerprintConfig:Lcom/oneplus/onlineconfig/OpFingerprintConfig;
    ...
    iput-object v4, p0, mOIMCServiceManager:Lcom/oneplus/core/oimc/OIMCServiceManager;
...
.method private allowUseCustomFingerprint(Ljava/lang/String;)Z
    ...
    :cond_1
    iget-object v0, p0, mFingerprintConfig:Lcom/oneplus/onlineconfig/OpFingerprintConfig;
...
.method private checkDefendRemaining()V
    ...
    iget-wide v2, p0, mTimeStampRaisingCriteria:J
    ...
    invoke-direct {p0, v4}, setParam(I)V

    const-wide/16 v5, 0x0

    iput-wide v5, p0, mTimeStampRaisingCriteria:J

    iput-boolean v4, p0, mAttackDefending:Z
...
.method private forceSendEvent(II)V
    ...
    invoke-direct {p0}, getCallbacks()Ljava/util/List;
...
.method private getCallbacks()Ljava/util/List;
    ...
    invoke-static {v0, p0, v1}, getValue(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
...
.method private handleFailAttemptForAttack()V
    ...
    iget v0, p0, mFailedAttemptsForAttack:I
    ...
    iget-wide v5, p0, mTimeStampStartCounting:J
    ...
    iput-wide v12, p0, mTimeStampRaisingCriteria:J

    const-wide/16 v12, 0x0

    iput-wide v12, p0, mTimeStampStartCounting:J

    iput v8, p0, mFailedAttemptsForAttack:I
    ...
    invoke-direct {p0, v2}, setParam(I)V
    ...
    :cond_8
    :goto_3
    iget v3, p0, mFailedAttemptsForAttack:I

    add-int/2addr v3, v2

    iput v3, p0, mFailedAttemptsForAttack:I
...
.method private setParam(I)V
    ...
    invoke-virtual {p0}, getExtFingerprintDaemon()Lvendor/oneplus/fingerprint/extension/V1_0/IVendorFingerprintExtensions;
...
.method protected canUseBiometric(Ljava/lang/String;ZIII)Z
    ...
    invoke-direct {p0, p1}, allowUseCustomFingerprint(Ljava/lang/String;)Z
...
.method protected dump(Ljava/io/PrintWriter;)V
    ...
    iget-boolean v1, p0, mTempDisableColorCorrection:Z
...
.method public declared-synchronized getExtFingerprintDaemon()Lvendor/oneplus/fingerprint/extension/V1_0/IVendorFingerprintExtensions;
    ...
    :try_start_0
    iget-object v0, p0, mExtDaemon:Lvendor/oneplus/fingerprint/extension/V1_0/IVendorFingerprintExtensions;
    ...
    iput-object v0, p0, mExtDaemon:Lvendor/oneplus/fingerprint/extension/V1_0/IVendorFingerprintExtensions;
    :try_end_1
...
.method protected handleAcquired(JII)V
    ...
    invoke-direct {p0, p3, p4}, forceSendEvent(II)V
...
.method protected handleAuthenticated(Landroid/hardware/biometrics/BiometricAuthenticator$Identifier;Ljava/util/ArrayList;)V
    ...
    iget-boolean v0, p0, IS_SUPPORT_FINGERPRINT_POCKET:Z
...
.method protected opHandleFailedAttempt()I
    ...
    iget-boolean v0, p0, mAttackDefending:Z

    if-nez v0, :cond_0

    invoke-direct {p0}, handleFailAttemptForAttack()V

    goto :goto_0

    :cond_0
    invoke-direct {p0}, checkDefendRemaining()V
...
.method protected opStartClient(Lcom/android/server/biometrics/ClientMonitor;Z)V
    ...
    invoke-virtual {p0, v0}, updateStatus(I)I
    ...
    iget v1, p0, mCurrentParam:I

    if-eq v1, v0, :cond_1

    iput v0, p0, mCurrentParam:I

    invoke-direct {p0, v0}, setParam(I)V
...
.method protected shouldBlockTouch(II)Z
    ...
    :cond_1
    iget v1, p0, mBlockX:I

    if-lt p1, v1, :cond_3

    iget v1, p0, mBlockXEnd:I

    if-gt p1, v1, :cond_3

    iget v1, p0, mBlockY:I

    if-lt p2, v1, :cond_3

    iget v1, p0, mBlockYEnd:I
