...
.method static constructor <clinit>()V
    ...
    sput-object v0, sIgnoreVendorList:[I
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/biometrics/Constants;Lcom/android/server/biometrics/BiometricServiceBase$DaemonWrapper;JLandroid/os/IBinder;Lcom/android/server/biometrics/BiometricServiceBase$ServiceListener;IIZLjava/lang/String;I)V
    ...
    iput v0, p0, FINGERPRINT_ACQUIRE_VENDOR_FAKE_FINGER:I

    const/4 v0, 0x5

    iput v0, p0, FINGERPRINT_ACQUIRE_VENDOR_FAKE_FINGER_TWICE:I

    const/4 v0, 0x6

    iput v0, p0, FINGERPRINT_ACQUIRE_VENDOR_FAKE_FINGER_THREE_TIMES:I

    iput v1, p0, mEnrollRemain:I

    const/16 v0, 0x64

    iput v0, p0, FINGERPRINT_ACQUIRED_VENDOR_DUPLICATED_FINGERPRINT:I

    const/4 v0, 0x2

    iput v0, p0, FINGERPRINT_ACQUIRED_VENDOR_TOO_SIMILAR:I
...
.method public destroy()V
    ...
    invoke-virtual {p0, v0}, notifyFodHide(Ljava/lang/String;)V
...
.method public getAcquireVendorIgnorelist()[I
    ...
    sget-object v0, sIgnoreVendorList:[I
...
.method protected notifyFodHide(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, v0}, notifyFodHide(Ljava/lang/String;Z)V
...
.method protected notifyFodHide(Ljava/lang/String;Z)V
    ...
    invoke-virtual {p0, v0}, packFodBundle(Landroid/os/Bundle;)V
...
.method protected notifyFodShow(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, v0}, notifyFodShow(Ljava/lang/String;Z)V
...
.method public onAcquired(II)Z
    ...
    invoke-virtual {p0, v1, v6, v3}, vibrateErrorWithScene(III)Z
    ...
    invoke-virtual {p0, p1, p2}, notifyFodAcquired(II)V
    ...
    iget-boolean v6, p0, IS_SUPPORT_CUSTOM_FINGERPRINT:Z
    ...
    invoke-static {v1, v10, v0, v6}, addMdmLogData(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, v0, v4, v3}, addMdmLogData(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_a
    invoke-static {v1, v10, v4, v3}, addMdmLogData(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public onError(JII)Z
    ...
    invoke-virtual {p0, p3}, notifyFodError(I)V
...
.method public resume()V
    ...
    invoke-virtual {p0, v0, v1}, notifyFodShow(Ljava/lang/String;Z)V
...
.method protected sendEnrollResult(I)V
    ...
    iget v0, p0, mEnrollRemain:I

    if-eq v0, p1, :cond_1

    iput p1, p0, mEnrollRemain:I
    ...
    invoke-virtual {p0, v0, v1}, vibrateSuccessWithScene(II)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, notifyFodEnrollResult(I)V
...
.method public start()I
    ...
    invoke-virtual {p0, v0}, notifyFodShow(Ljava/lang/String;)V
...
.method public suspend()V
    ...
    invoke-virtual {p0, v0, v1}, notifyFodHide(Ljava/lang/String;Z)V
