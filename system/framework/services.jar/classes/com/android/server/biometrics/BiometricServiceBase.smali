...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mTaskStackListener:Lcom/android/server/biometrics/BiometricServiceBase$BiometricTaskStackListener;
    ...
    iput-object v0, p0, mResetClientState:Lcom/android/server/biometrics/BiometricServiceBase$ResetClientStateRunnable;
    ...
    iput-object v0, p0, mAuthenticatorIds:Ljava/util/Map;
    ...
    iput-object v0, p0, mHandler:Lcom/android/server/biometrics/BiometricServiceBase$H;
    ...
    iput-object v0, p0, mUnknownHALTemplates:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, mPerformanceMap:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, mCryptoPerformanceMap:Ljava/util/HashMap;

    const/16 v0, 0x3e7

    iput v0, p0, DOUBLE_ACCOUNT_UID:I
    ...
    iput-object v0, p0, mStrongAuthTracker:Lcom/android/server/biometrics/BiometricServiceBase$StrongAuthTracker;
...
.method static synthetic access$1200(Lcom/android/server/biometrics/BiometricServiceBase;Lcom/android/server/biometrics/BiometricServiceBase$LockoutResetMonitor;)V
    ...
    invoke-direct {p0, p1}, removeLockoutResetCallback(Lcom/android/server/biometrics/BiometricServiceBase$LockoutResetMonitor;)V
...
.method static synthetic access$200(Lcom/android/server/biometrics/BiometricServiceBase;Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1}, isKeyguard(Ljava/lang/String;)Z
...
.method static synthetic access$300(Lcom/android/server/biometrics/BiometricServiceBase;)Lcom/android/server/biometrics/BiometricServiceBase$BiometricTaskStackListener;
    ...
    iget-object v0, p0, mTaskStackListener:Lcom/android/server/biometrics/BiometricServiceBase$BiometricTaskStackListener;
...
.method static synthetic access$600(Lcom/android/server/biometrics/BiometricServiceBase;)Lcom/android/server/biometrics/BiometricServiceBase$PerformanceStats;
    ...
    iget-object v0, p0, mPerformanceStats:Lcom/android/server/biometrics/BiometricServiceBase$PerformanceStats;
...
.method static synthetic access$700(Lcom/android/server/biometrics/BiometricServiceBase;)Lcom/android/server/biometrics/ClientMonitor;
    ...
    iget-object v0, p0, mCurrentClient:Lcom/android/server/biometrics/ClientMonitor;
...
.method static synthetic access$702(Lcom/android/server/biometrics/BiometricServiceBase;Lcom/android/server/biometrics/ClientMonitor;)Lcom/android/server/biometrics/ClientMonitor;
    ...
    iput-object p1, p0, mCurrentClient:Lcom/android/server/biometrics/ClientMonitor;
...
.method static synthetic access$800(Lcom/android/server/biometrics/BiometricServiceBase;)Lcom/android/server/biometrics/ClientMonitor;
    ...
    iget-object v0, p0, mPendingClient:Lcom/android/server/biometrics/ClientMonitor;
...
.method static synthetic access$900(Lcom/android/server/biometrics/BiometricServiceBase;Lcom/android/server/biometrics/ClientMonitor;Z)V
    ...
    invoke-direct {p0, p1, p2}, startClient(Lcom/android/server/biometrics/ClientMonitor;Z)V
...
.method private clearEnumerateState()V
    ...
    iget-object v0, p0, mUnknownHALTemplates:Ljava/util/ArrayList;
...
.method private enumerateUser(I)V
    ...
    invoke-virtual/range {p0 .. p0}, getTag()Ljava/lang/String;
    ...
    invoke-virtual/range {p0 .. p0}, getManageBiometricPermission()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {v14, v0}, hasPermission(Ljava/lang/String;)Z
    ...
    invoke-virtual/range {p0 .. p1}, getEnrolledTemplates(I)Ljava/util/List;
    ...
    invoke-virtual/range {p0 .. p0}, getDaemonWrapper()Lcom/android/server/biometrics/BiometricServiceBase$DaemonWrapper;

    move-result-object v3

    iget-wide v4, v14, mHalDeviceId:J

    iget-object v6, v14, mToken:Landroid/os/IBinder;
    ...
    invoke-virtual/range {p0 .. p0}, getBiometricUtils()Lcom/android/server/biometrics/BiometricUtils;
    ...
    invoke-virtual {v14, v0}, enumerateInternal(Lcom/android/server/biometrics/EnumerateClient;)V
...
.method private startAuthentication(Lcom/android/server/biometrics/BiometricServiceBase$AuthenticationClientImpl;Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, getLockoutMode()I
    ...
    invoke-virtual {p0}, getHalDeviceId()J
    ...
    :cond_2
    invoke-virtual {p0, p1, p2}, opCheckCanStartAuthentication(Lcom/android/server/biometrics/BiometricServiceBase$AuthenticationClientImpl;Ljava/lang/String;)Z
    ...
    :cond_3
    invoke-direct {p0, p1, v1}, startClient(Lcom/android/server/biometrics/ClientMonitor;Z)V
...
.method private startCleanupUnknownHALTemplates()V
    ...
    iget-object v1, p0, mUnknownHALTemplates:Ljava/util/ArrayList;

    invoke-virtual {v1, v0}, Ljava/util/ArrayList;->remove(Ljava/lang/Object;)Z

    invoke-virtual {p0}, getManageBiometricPermission()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0, v1}, hasPermission(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0}, getDaemonWrapper()Lcom/android/server/biometrics/BiometricServiceBase$DaemonWrapper;

    move-result-object v5

    iget-wide v6, p0, mHalDeviceId:J
    ...
    invoke-virtual {p0, v1}, removeInternal(Lcom/android/server/biometrics/RemovalClient;)V

    const/16 v2, 0x94

    invoke-virtual {p0}, statsModality()I
    ...
    :cond_0
    invoke-direct {p0}, clearEnumerateState()V
    ...
    invoke-direct {p0, v0, v1}, startClient(Lcom/android/server/biometrics/ClientMonitor;Z)V

    const/4 v0, 0x0

    iput-object v0, p0, mPendingClient:Lcom/android/server/biometrics/ClientMonitor;
...
.method private startClient(Lcom/android/server/biometrics/ClientMonitor;Z)V
    ...
    iget-object v1, p0, mHandler:Lcom/android/server/biometrics/BiometricServiceBase$H;

    iget-object v2, p0, mResetClientState:Lcom/android/server/biometrics/BiometricServiceBase$ResetClientStateRunnable;
    ...
    :cond_2
    :goto_1
    iput-object p1, p0, mPendingClient:Lcom/android/server/biometrics/ClientMonitor;
    ...
    iget-object v2, p0, mBiometricService:Landroid/hardware/biometrics/IBiometricService;
    ...
    iput-object v2, p0, mBiometricService:Landroid/hardware/biometrics/IBiometricService;
    ...
    iget-object v1, p0, mCurrentClient:Lcom/android/server/biometrics/ClientMonitor;

    invoke-virtual {v1}, Lcom/android/server/biometrics/ClientMonitor;->getCookie()I

    move-result v1

    invoke-virtual {p0, v1}, startCurrentClient(I)V

    invoke-virtual {p0, p1, p2}, opStartClient(Lcom/android/server/biometrics/ClientMonitor;Z)V

    invoke-virtual {p0}, getPendingClient()Lcom/android/server/biometrics/ClientMonitor;
    ...
    iput-object v1, p0, mPendingClient:Lcom/android/server/biometrics/ClientMonitor;
...
.method protected addLockoutResetCallback(Landroid/hardware/biometrics/IBiometricServiceLockoutResetCallback;)V
    ...
    :cond_0
    iget-object v0, p0, mHandler:Lcom/android/server/biometrics/BiometricServiceBase$H;
...
.method protected authenticateInternal(Lcom/android/server/biometrics/BiometricServiceBase$AuthenticationClientImpl;JLjava/lang/String;)V
    ...
    invoke-virtual/range {v0 .. v7}, authenticateInternal(Lcom/android/server/biometrics/BiometricServiceBase$AuthenticationClientImpl;JLjava/lang/String;III)V
...
.method protected authenticateInternal(Lcom/android/server/biometrics/BiometricServiceBase$AuthenticationClientImpl;JLjava/lang/String;III)V
    ...
    invoke-virtual/range {v1 .. v7}, canUseBiometric(Ljava/lang/String;ZIIII)Z
    ...
    iget-object v2, v1, mHandler:Lcom/android/server/biometrics/BiometricServiceBase$H;
...
.method protected canUseBiometric(Ljava/lang/String;ZIII)Z
    ...
    invoke-virtual/range {v0 .. v6}, canUseBiometric(Ljava/lang/String;ZIIII)Z
...
.method protected canUseBiometric(Ljava/lang/String;ZIIII)Z
    ...
    invoke-virtual {p0}, checkUseBiometricPermission()V
    ...
    invoke-direct {p0, p3, p4}, isForegroundActivity(II)Z

    move-result v0

    if-nez v0, :cond_1

    invoke-virtual {p0, p1}, opCheckForeground(Ljava/lang/String;)Z
    ...
    :cond_3
    invoke-virtual {p0, p5}, isCurrentUserOrProfile(I)Z
    ...
    :cond_4
    invoke-virtual {p0, p3, p1}, checkAppOps(ILjava/lang/String;)Z
    ...
    invoke-direct {p0, p1}, isCurrentClient(Ljava/lang/String;)Z
...
.method protected cancelAuthenticationInternal(Landroid/os/IBinder;Ljava/lang/String;)V
    ...
    invoke-virtual/range {v0 .. v6}, cancelAuthenticationInternal(Landroid/os/IBinder;Ljava/lang/String;IIIZ)V
...
.method protected cancelAuthenticationInternal(Landroid/os/IBinder;Ljava/lang/String;IIIZ)V
    ...
    invoke-virtual/range {v0 .. v5}, canUseBiometric(Ljava/lang/String;ZIII)Z
...
.method protected doTemplateCleanupForUser(I)V
    ...
    invoke-direct {p0, p1}, enumerateUser(I)V
...
.method protected enrollInternal(Lcom/android/server/biometrics/BiometricServiceBase$EnrollClientImpl;I)V
    ...
    invoke-virtual {p0, p2}, hasReachedEnrollmentLimit(I)Z
    ...
    :cond_0
    invoke-virtual {p0, p2}, isCurrentUserOrProfile(I)Z
...
.method protected getAuthenticatorId(Ljava/lang/String;)J
    ...
    invoke-virtual {p0, p1, v0}, getUserOrWorkProfileId(Ljava/lang/String;I)I

    move-result v0

    iget-object v1, p0, mAuthenticatorIds:Ljava/util/Map;
...
.method protected getUserOrWorkProfileId(Ljava/lang/String;I)I
    ...
    invoke-direct {p0, p2}, isWorkProfile(I)Z
    ...
    :cond_0
    invoke-direct {p0, p2}, getEffectiveUserId(I)I
...
.method protected handleAcquired(JII)V
    ...
    invoke-virtual {p0, v0}, removeClient(Lcom/android/server/biometrics/ClientMonitor;)V

    :cond_0
    iget-object v1, p0, mPerformanceStats:Lcom/android/server/biometrics/BiometricServiceBase$PerformanceStats;
...
.method protected handleAuthenticated(Landroid/hardware/biometrics/BiometricAuthenticator$Identifier;Ljava/util/ArrayList;)V
    ...
    iget-object v3, p0, mPerformanceStats:Lcom/android/server/biometrics/BiometricServiceBase$PerformanceStats;
...
.method protected handleEnrollResult(Landroid/hardware/biometrics/BiometricAuthenticator$Identifier;I)V
    ...
    invoke-virtual {p0, v1, v2}, updateActiveGroup(ILjava/lang/String;)V
...
.method protected handleEnumerate(Landroid/hardware/biometrics/BiometricAuthenticator$Identifier;I)V
    ...
    invoke-virtual {p0}, getCurrentClient()Lcom/android/server/biometrics/ClientMonitor;
    ...
    iget-object v3, p0, mUnknownHALTemplates:Ljava/util/ArrayList;
    ...
    invoke-direct {p0}, startCleanupUnknownHALTemplates()V
...
.method protected handleError(JII)V
    ...
    iget-object v1, p0, mPendingClient:Lcom/android/server/biometrics/ClientMonitor;
    ...
    iget-object v3, p0, mPendingClient:Lcom/android/server/biometrics/ClientMonitor;
    ...
    invoke-direct {p0, v1, v2}, startClient(Lcom/android/server/biometrics/ClientMonitor;Z)V
...
.method protected handleRemoved(Landroid/hardware/biometrics/BiometricAuthenticator$Identifier;I)V
    ...
    :cond_0
    invoke-virtual {p0, v1}, hasEnrolledBiometrics(I)Z
...
.method protected handleUserSwitching(I)V
    ...
    invoke-virtual {p0, p1, v0}, updateActiveGroup(ILjava/lang/String;)V

    invoke-virtual {p0, p1}, doTemplateCleanupForUser(I)V
...
.method public synthetic lambda$authenticateInternal$2$BiometricServiceBase(JLcom/android/server/biometrics/BiometricServiceBase$AuthenticationClientImpl;Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, getConstants()Lcom/android/server/biometrics/Constants;
    ...
    iget-object v0, p0, mPerformanceMap:Ljava/util/HashMap;

    goto :goto_1

    :cond_1
    iget-object v0, p0, mCryptoPerformanceMap:Ljava/util/HashMap;
    ...
    :cond_2
    iput-object v1, p0, mPerformanceStats:Lcom/android/server/biometrics/BiometricServiceBase$PerformanceStats;
    ...
    :goto_2
    iput-boolean v5, p0, mIsCrypto:Z

    invoke-direct {p0, p3, p4}, startAuthentication(Lcom/android/server/biometrics/BiometricServiceBase$AuthenticationClientImpl;Ljava/lang/String;)V
...
.method public synthetic lambda$cancelAuthenticationInternal$3$BiometricServiceBase(Landroid/os/IBinder;Z)V
    ...
    iget-object v4, p0, mPendingClient:Lcom/android/server/biometrics/ClientMonitor;
    ...
    iput-object v2, p0, mPendingClient:Lcom/android/server/biometrics/ClientMonitor;
    ...
    iget-object v5, p0, mPendingClient:Lcom/android/server/biometrics/ClientMonitor;
...
.method public synthetic lambda$enrollInternal$0$BiometricServiceBase(Lcom/android/server/biometrics/BiometricServiceBase$EnrollClientImpl;)V
    ...
    invoke-direct {p0, p1, v0}, startClient(Lcom/android/server/biometrics/ClientMonitor;Z)V
...
.method protected loadAuthenticatorIds()V
    ...
    iget-object v2, p0, mAuthenticatorIds:Ljava/util/Map;
    ...
    invoke-virtual {p0, v5, v4}, getUserOrWorkProfileId(Ljava/lang/String;I)I

    move-result v4

    iget-object v6, p0, mAuthenticatorIds:Ljava/util/Map;
    ...
    invoke-virtual {p0, v4, v5}, updateActiveGroup(ILjava/lang/String;)V
...
.method public onStart()V
    ...
    iget-object v1, p0, mStrongAuthTracker:Lcom/android/server/biometrics/BiometricServiceBase$StrongAuthTracker;
...
.method protected removeClient(Lcom/android/server/biometrics/ClientMonitor;)V
    ...
    iget-object v2, p0, mCurrentClient:Lcom/android/server/biometrics/ClientMonitor;
    ...
    iput-object v0, p0, mCurrentClient:Lcom/android/server/biometrics/ClientMonitor;
    ...
    invoke-virtual {p0, v0}, notifyClientActiveCallbacks(Z)V
...
.method public serviceDied(J)V
    ...
    iget v0, p0, mHALDeathCount:I

    add-int/2addr v0, v2

    iput v0, p0, mHALDeathCount:I
    ...
    invoke-virtual {p0, v0, v1, v2, v3}, handleError(JII)V
