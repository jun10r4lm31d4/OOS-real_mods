...
.method public synthetic constructor <init>(Lcom/android/server/biometrics/BiometricService;ILandroid/hardware/biometrics/IBiometricServiceReceiver;Landroid/os/IBinder;JLjava/lang/String;Landroid/os/Bundle;IIILandroid/hardware/biometrics/IBiometricConfirmDeviceCredentialCallback;)V
    ...
    iput-object p1, p0, f$0:Lcom/android/server/biometrics/BiometricService;

    iput p2, p0, f$1:I

    iput-object p3, p0, f$2:Landroid/hardware/biometrics/IBiometricServiceReceiver;

    iput-object p4, p0, f$3:Landroid/os/IBinder;

    iput-wide p5, p0, f$4:J

    iput-object p7, p0, f$5:Ljava/lang/String;

    iput-object p8, p0, f$6:Landroid/os/Bundle;
    ...
    iput-object p12, p0, f$10:Landroid/hardware/biometrics/IBiometricConfirmDeviceCredentialCallback;
...
.method public final run()V
    ...
    iget-object v0, p0, f$0:Lcom/android/server/biometrics/BiometricService;

    iget v1, p0, f$1:I

    iget-object v2, p0, f$2:Landroid/hardware/biometrics/IBiometricServiceReceiver;

    iget-object v3, p0, f$3:Landroid/os/IBinder;

    iget-wide v4, p0, f$4:J

    iget-object v6, p0, f$5:Ljava/lang/String;

    iget-object v7, p0, f$6:Landroid/os/Bundle;
    ...
    iget-object v11, p0, f$10:Landroid/hardware/biometrics/IBiometricConfirmDeviceCredentialCallback;
