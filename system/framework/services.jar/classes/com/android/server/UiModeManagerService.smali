...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v1, p0, mNightMode:I

    iput-boolean v0, p0, mForceDark:Z

    iput-boolean v0, p0, mCarModeEnabled:Z

    iput-boolean v0, p0, mCharging:Z

    iput-boolean v0, p0, mPowerSave:Z

    iput-boolean v1, p0, mEnableCarDockLaunch:Z

    iput-boolean v0, p0, mUiModeLocked:Z

    iput-boolean v0, p0, mNightModeLocked:Z

    iput v0, p0, mCurUiMode:I

    iput v0, p0, mSetUiMode:I
    ...
    iput-object v0, p0, mLocalService:Lcom/android/server/UiModeManagerService$LocalService;
    ...
    iput-object v0, p0, mSetupWizardObserver:Landroid/database/ContentObserver;
    ...
    iput-object v0, p0, mForceDarkObserver:Landroid/database/ContentObserver;
    ...
    iput-object v0, p0, mService:Landroid/app/IUiModeManager$Stub;
...
.method static synthetic access$1000(Lcom/android/server/UiModeManagerService;)Landroid/app/IUiModeManager$Stub;
    ...
    iget-object v0, p0, mService:Landroid/app/IUiModeManager$Stub;
...
.method static synthetic access$1400(Lcom/android/server/UiModeManagerService;)V
    ...
    invoke-direct {p0}, setThemeMode()V
...
.method static synthetic access$1500(Lcom/android/server/UiModeManagerService;)Z
    ...
    iget-boolean v0, p0, mForceDark:Z
...
.method static synthetic access$1502(Lcom/android/server/UiModeManagerService;Z)Z
    ...
    iput-boolean p1, p0, mForceDark:Z
...
.method static synthetic access$1600(Lcom/android/server/UiModeManagerService;)Z
    ...
    iget-boolean v0, p0, mUiModeLocked:Z
...
.method static synthetic access$1700(Lcom/android/server/UiModeManagerService;)Z
    ...
    iget-boolean v0, p0, mNightModeLocked:Z
...
.method static synthetic access$2000(Lcom/android/server/UiModeManagerService;Landroid/content/Context;I)Z
    ...
    invoke-direct {p0, p1, p2}, updateForceDarkFromSettings(Landroid/content/Context;I)Z
...
.method static synthetic access$502(Lcom/android/server/UiModeManagerService;Z)Z
    ...
    iput-boolean p1, p0, mVrHeadset:Z
...
.method static synthetic access$600(Lcom/android/server/UiModeManagerService;)Z
    ...
    invoke-direct {p0}, setupWizardCompleteForCurrentUser()Z
...
.method static synthetic access$702(Lcom/android/server/UiModeManagerService;Z)Z
    ...
    iput-boolean p1, p0, mSetupWizardComplete:Z
...
.method static synthetic access$800(Lcom/android/server/UiModeManagerService;)Landroid/database/ContentObserver;
    ...
    iget-object v0, p0, mSetupWizardObserver:Landroid/database/ContentObserver;
...
.method static synthetic access$900(Lcom/android/server/UiModeManagerService;Landroid/content/Context;Landroid/content/res/Resources;I)Z
    ...
    invoke-direct {p0, p1, p2, p3}, updateNightModeFromSettings(Landroid/content/Context;Landroid/content/res/Resources;I)Z
...
.method private registerVrStateListener()V
    ...
    :try_start_0
    iget-object v1, p0, mVrStateCallbacks:Landroid/service/vr/IVrStateCallbacks;
...
.method private sendConfigurationAndStartDreamOrDockAppLocked(Ljava/lang/String;)V
    ...
    iput-boolean v0, v1, mHoldingConfiguration:Z
    ...
    iget-object v13, v1, mConfiguration:Landroid/content/res/Configuration;
    :try_end_0
...
.method private setThemeMode()V
    ...
    iget-boolean v3, p0, mForceDark:Z
...
.method private updateAfterBroadcastLocked(Ljava/lang/String;II)V
    ...
    iget-boolean v1, p0, mEnableCarDockLaunch:Z
...
.method private updateConfigurationLocked()V
    ...
    iget-boolean v1, p0, mUiModeLocked:Z
    ...
    :cond_4
    iget-boolean v1, p0, mVrHeadset:Z
    ...
    iget-boolean v4, p0, mForceDark:Z

    and-int/2addr v4, v1

    iput-boolean v4, p0, mForceDark:Z
    ...
    :goto_4
    iget-boolean v3, p0, mPowerSave:Z
    ...
    iget-boolean v2, p0, mHoldingConfiguration:Z
...
.method private updateDockState(I)V
    ...
    :goto_0
    invoke-virtual {p0, v1, v4}, setCarModeLocked(ZI)V

    iget-boolean v1, p0, mSystemReady:Z

    if-eqz v1, :cond_1

    invoke-virtual {p0, v3, v4}, updateLocked(II)V
...
.method private updateNightModeFromSettings(Landroid/content/Context;Landroid/content/res/Resources;I)Z
    ...
    iget-boolean v2, p0, mSetupWizardComplete:Z
...
.method private verifySetupWizardCompleted()V
    ...
    iput-boolean v2, p0, mSetupWizardComplete:Z
    ...
    iget-object v5, p0, mSetupWizardObserver:Landroid/database/ContentObserver;
...
.method dumpImpl(Ljava/io/PrintWriter;)V
    ...
    iget v1, p0, mLastBroadcastState:I
    ...
    iget-boolean v1, p0, mNightModeLocked:Z
    ...
    iget v1, p0, mCarModeEnableFlags:I
...
.method public synthetic lambda$onStart$0$UiModeManagerService(Landroid/os/PowerSaveState;)V
    ...
    :try_start_0
    iget-boolean v1, p0, mPowerSave:Z
    ...
    iput-boolean v1, p0, mPowerSave:Z
    ...
    invoke-virtual {p0, v1, v1}, updateLocked(II)V
...
.method public onBootPhase(I)V
    ...
    iput-object v1, p0, mTwilightManager:Lcom/android/server/twilight/TwilightManager;
    ...
    invoke-direct {p0}, registerVrStateListener()V

    invoke-virtual {p0, v4, v4}, updateLocked(II)V
...
.method public onStart()V
    ...
    invoke-direct {p0}, verifySetupWizardCompleted()V
    ...
    iget-object v3, p0, mBatteryReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-boolean v5, p0, mPowerSave:Z
    ...
    iput-boolean v5, p0, mEnableCarDockLaunch:Z
    ...
    iput-boolean v5, p0, mUiModeLocked:Z
    ...
    iput-boolean v5, p0, mNightModeLocked:Z
    ...
    :cond_3
    iput-boolean v6, p0, mTelevision:Z
    ...
    iput-boolean v6, p0, mWatch:Z

    invoke-static {}, Landroid/os/UserHandle;->getCallingUserId()I

    move-result v6

    invoke-direct {p0, v0, v4, v6}, updateNightModeFromSettings(Landroid/content/Context;Landroid/content/res/Resources;I)Z

    invoke-static {}, Landroid/os/UserHandle;->getCallingUserId()I

    move-result v6

    invoke-direct {p0, v0, v6}, updateForceDarkFromSettings(Landroid/content/Context;I)Z
    ...
    iget-object v6, p0, mService:Landroid/app/IUiModeManager$Stub;

    const-string/jumbo v8, "uimode"

    invoke-virtual {p0, v8, v6}, publishBinderService(Ljava/lang/String;Landroid/os/IBinder;)V

    const-class v6, Lcom/android/server/UiModeManagerInternal;

    iget-object v8, p0, mLocalService:Lcom/android/server/UiModeManagerService$LocalService;

    invoke-virtual {p0, v6, v8}, publishLocalService(Ljava/lang/Class;Ljava/lang/Object;)V
    ...
    iget-object v10, p0, mForceDarkObserver:Landroid/database/ContentObserver;
...
.method public onSwitchUser(I)V
    ...
    iget-object v1, p0, mSetupWizardObserver:Landroid/database/ContentObserver;
...
.method setCarModeLocked(ZI)V
    ...
    invoke-direct {p0, v0, v1, v2}, updateNightModeFromSettings(Landroid/content/Context;Landroid/content/res/Resources;I)Z

    invoke-static {}, Landroid/os/UserHandle;->getCallingUserId()I

    move-result v1

    invoke-direct {p0, v0, v1}, updateForceDarkFromSettings(Landroid/content/Context;I)Z

    invoke-direct {p0}, enableThemeMode()V
...
.method updateLocked(II)V
    ...
    iget v5, v0, mLastBroadcastState:I

    const/4 v6, 0x2

    if-ne v5, v6, :cond_0

    invoke-direct/range {p0 .. p0}, adjustStatusBarCarModeLocked()V
    ...
    :cond_0
    invoke-static {v5}, isDeskDockState(I)Z
    ...
    :cond_1
    :goto_0
    iget-boolean v5, v0, mCarModeEnabled:Z
    ...
    invoke-direct {v0, v4}, sendForegroundBroadcastToAllUsers(Ljava/lang/String;)V

    :cond_2
    iput v6, v0, mLastBroadcastState:I
    ...
    iput v5, v0, mLastBroadcastState:I
    ...
    :cond_5
    iput v7, v0, mLastBroadcastState:I
    ...
    iget-object v13, v0, mResultReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-boolean v5, v0, mHoldingConfiguration:Z
    ...
    iget-boolean v9, v0, mCarModeEnabled:Z

    if-eqz v9, :cond_8

    iget-boolean v9, v0, mEnableCarDockLaunch:Z
    ...
    :cond_8
    iget v9, v0, mDockState:I

    invoke-static {v9}, isDeskDockState(I)Z
    ...
    :cond_a
    :goto_2
    invoke-direct {v0, v8}, sendConfigurationAndStartDreamOrDockAppLocked(Ljava/lang/String;)V
    ...
    iget-boolean v8, v0, mCarModeEnabled:Z

    if-eqz v8, :cond_b

    iget-boolean v8, v0, mCarModeKeepsScreenOn:Z

    if-eqz v8, :cond_b

    iget v8, v0, mCarModeEnableFlags:I
    ...
    :cond_b
    iget v8, v0, mCurUiMode:I

    if-ne v8, v6, :cond_d

    iget-boolean v6, v0, mDeskModeKeepsScreenOn:Z
    ...
    :goto_4
    iget-object v6, v0, mWakeLock:Landroid/os/PowerManager$WakeLock;
