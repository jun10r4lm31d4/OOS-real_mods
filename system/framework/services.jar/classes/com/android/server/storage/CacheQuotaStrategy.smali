...
.method public constructor <init>(Landroid/content/Context;Landroid/app/usage/UsageStatsManagerInternal;Lcom/android/server/pm/Installer;Landroid/util/ArrayMap;)V
    ...
    iput-object v0, p0, mQuotaMap:Landroid/util/ArrayMap;
    ...
    iput-object v0, p0, mPreviousValuesFile:Lcom/android/internal/os/AtomicFile;
...
.method static synthetic access$100(Lcom/android/server/storage/CacheQuotaStrategy;)Landroid/app/usage/ICacheQuotaService;
    ...
    iget-object v0, p0, mRemoteService:Landroid/app/usage/ICacheQuotaService;
...
.method static synthetic access$102(Lcom/android/server/storage/CacheQuotaStrategy;Landroid/app/usage/ICacheQuotaService;)Landroid/app/usage/ICacheQuotaService;
    ...
    iput-object p1, p0, mRemoteService:Landroid/app/usage/ICacheQuotaService;
...
.method static synthetic access$200(Lcom/android/server/storage/CacheQuotaStrategy;)Ljava/util/List;
    ...
    invoke-direct {p0}, getUnfulfilledRequests()Ljava/util/List;
...
.method private getUnfulfilledRequests()Ljava/util/List;
    ...
    iget-object v2, v1, mUsageStats:Landroid/app/usage/UsageStatsManagerInternal;
...
.method private insertIntoQuotaMap(Ljava/lang/String;IIJ)V
    ...
    iget-object v0, p0, mQuotaMap:Landroid/util/ArrayMap;
    ...
    iget-object v1, p0, mQuotaMap:Landroid/util/ArrayMap;
...
.method private pushProcessedQuotas(Ljava/util/List;)V
    ...
    invoke-direct/range {v3 .. v8}, insertIntoQuotaMap(Ljava/lang/String;IIJ)V
    :try_end_0
...
.method protected static readFromXml(Ljava/io/InputStream;)Landroid/util/Pair;
    ...
    invoke-static {v0}, getRequestFromXml(Lorg/xmlpull/v1/XmlPullParser;)Landroid/app/usage/CacheQuotaHint;
...
.method private writeXmlToFile(Ljava/util/List;)V
    ...
    iget-object v2, p0, mPreviousValuesFile:Lcom/android/internal/os/AtomicFile;
    ...
    invoke-static {v1, p1, v2, v3}, saveToXml(Lorg/xmlpull/v1/XmlSerializer;Ljava/util/List;J)V
...
.method public onResult(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v0}, pushProcessedQuotas(Ljava/util/List;)V

    invoke-direct {p0, v0}, writeXmlToFile(Ljava/util/List;)V
...
.method public recalculateQuotas()V
    ...
    invoke-direct {p0}, createServiceConnection()V

    invoke-direct {p0}, getServiceComponentName()Landroid/content/ComponentName;
...
.method public setupQuotasFromFile()J
    ...
    :try_start_0
    iget-object v3, p0, mPreviousValuesFile:Lcom/android/internal/os/AtomicFile;
    ...
    :try_start_1
    invoke-static {v3}, readFromXml(Ljava/io/InputStream;)Landroid/util/Pair;
    ...
    invoke-direct {p0, v1}, pushProcessedQuotas(Ljava/util/List;)V
