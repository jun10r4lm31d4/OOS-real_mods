...
.method static constructor <clinit>()V
    ...
    sput-object v0, EXTENSION_MAP:Ljava/util/Map;

    sget-object v0, EXTENSION_MAP:Ljava/util/Map;
...
.method private static collectFiles(Ljava/io/File;Lcom/android/server/storage/FileCollector$MeasurementResult;)Lcom/android/server/storage/FileCollector$MeasurementResult;
    ...
    :try_start_0
    invoke-static {v3, p1}, collectFiles(Ljava/io/File;Lcom/android/server/storage/FileCollector$MeasurementResult;)Lcom/android/server/storage/FileCollector$MeasurementResult;
    :try_end_0
    ...
    :cond_1
    invoke-static {p1, v3}, handleFile(Lcom/android/server/storage/FileCollector$MeasurementResult;Ljava/io/File;)V
...
.method public static getMeasurementResult(Ljava/io/File;)Lcom/android/server/storage/FileCollector$MeasurementResult;
    ...
    invoke-static {v0, v1}, collectFiles(Ljava/io/File;Lcom/android/server/storage/FileCollector$MeasurementResult;)Lcom/android/server/storage/FileCollector$MeasurementResult;
...
.method private static handleFile(Lcom/android/server/storage/FileCollector$MeasurementResult;Ljava/io/File;)V
    ...
    sget-object v2, EXTENSION_MAP:Ljava/util/Map;

    invoke-static {p1}, getExtensionForFile(Ljava/io/File;)Ljava/lang/String;
