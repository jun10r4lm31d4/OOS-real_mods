...
.method public constructor <init>(Lcom/android/server/storage/FileCollector$MeasurementResult;Lcom/android/server/storage/FileCollector$MeasurementResult;Ljava/util/List;J)V
    ...
    iput-object p1, p0, mResult:Lcom/android/server/storage/FileCollector$MeasurementResult;

    invoke-virtual {p2}, Lcom/android/server/storage/FileCollector$MeasurementResult;->totalAccountedSize()J

    move-result-wide v0

    iput-wide v0, p0, mDownloadsSize:J

    iput-wide p4, p0, mSystemSize:J

    iput-object p3, p0, mPackageStats:Ljava/util/List;
...
.method private addAppsToJson(Lorg/json/JSONObject;)V
    ...
    invoke-direct/range {p0 .. p0}, filterOnlyPrimaryUser()Landroid/util/ArrayMap;
...
.method private filterOnlyPrimaryUser()Landroid/util/ArrayMap;
    ...
    iget-object v1, p0, mPackageStats:Ljava/util/List;
...
.method private getJsonRepresentation()Lorg/json/JSONObject;
    ...
    iget-object v2, p0, mResult:Lcom/android/server/storage/FileCollector$MeasurementResult;
    ...
    iget-wide v2, p0, mDownloadsSize:J

    invoke-virtual {v0, v1, v2, v3}, Lorg/json/JSONObject;->put(Ljava/lang/String;J)Lorg/json/JSONObject;

    const-string/jumbo v1, "systemSize"

    iget-wide v2, p0, mSystemSize:J
    ...
    invoke-direct {p0, v0}, addAppsToJson(Lorg/json/JSONObject;)V
    :try_end_0
...
.method public dumpToFile(Ljava/io/File;)V
    ...
    invoke-direct {p0}, getJsonRepresentation()Lorg/json/JSONObject;
