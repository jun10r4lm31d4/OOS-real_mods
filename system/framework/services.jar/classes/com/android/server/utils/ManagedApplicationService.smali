...
.method private constructor <init>(Landroid/content/Context;Landroid/content/ComponentName;IILjava/lang/String;Lcom/android/server/utils/ManagedApplicationService$BinderChecker;ZILandroid/os/Handler;Lcom/android/server/utils/ManagedApplicationService$EventCallback;)V
    ...
    iput-object v0, p0, mRetryRunnable:Ljava/lang/Runnable;
    ...
    iput-wide v0, p0, mNextRetryDurationMs:J
    ...
    iput p4, p0, mClientLabel:I

    iput-object p5, p0, mSettingsAction:Ljava/lang/String;

    iput-object p6, p0, mChecker:Lcom/android/server/utils/ManagedApplicationService$BinderChecker;

    iput-boolean p7, p0, mIsImportant:Z

    iput p8, p0, mRetryType:I

    iput-object p9, p0, mHandler:Landroid/os/Handler;

    iput-object p10, p0, mEventCb:Lcom/android/server/utils/ManagedApplicationService$EventCallback;
...
.method static synthetic access$1000(Lcom/android/server/utils/ManagedApplicationService;)Lcom/android/server/utils/ManagedApplicationService$EventCallback;
    ...
    iget-object v0, p0, mEventCb:Lcom/android/server/utils/ManagedApplicationService$EventCallback;
...
.method static synthetic access$400(Lcom/android/server/utils/ManagedApplicationService;)Landroid/os/IInterface;
    ...
    iget-object v0, p0, mBoundInterface:Landroid/os/IInterface;
...
.method static synthetic access$402(Lcom/android/server/utils/ManagedApplicationService;Landroid/os/IInterface;)Landroid/os/IInterface;
    ...
    iput-object p1, p0, mBoundInterface:Landroid/os/IInterface;
...
.method static synthetic access$500(Lcom/android/server/utils/ManagedApplicationService;)V
    ...
    invoke-direct {p0}, startRetriesLocked()V
...
.method static synthetic access$600(Lcom/android/server/utils/ManagedApplicationService;)V
    ...
    invoke-direct {p0}, stopRetriesLocked()V
...
.method static synthetic access$700(Lcom/android/server/utils/ManagedApplicationService;)Lcom/android/server/utils/ManagedApplicationService$BinderChecker;
    ...
    iget-object v0, p0, mChecker:Lcom/android/server/utils/ManagedApplicationService$BinderChecker;
...
.method static synthetic access$800(Lcom/android/server/utils/ManagedApplicationService;)Lcom/android/server/utils/ManagedApplicationService$PendingEvent;
    ...
    iget-object v0, p0, mPendingEvent:Lcom/android/server/utils/ManagedApplicationService$PendingEvent;
...
.method static synthetic access$802(Lcom/android/server/utils/ManagedApplicationService;Lcom/android/server/utils/ManagedApplicationService$PendingEvent;)Lcom/android/server/utils/ManagedApplicationService$PendingEvent;
    ...
    iput-object p1, p0, mPendingEvent:Lcom/android/server/utils/ManagedApplicationService$PendingEvent;
...
.method public static build(Landroid/content/Context;Landroid/content/ComponentName;IILjava/lang/String;Lcom/android/server/utils/ManagedApplicationService$BinderChecker;ZILandroid/os/Handler;Lcom/android/server/utils/ManagedApplicationService$EventCallback;)Lcom/android/server/utils/ManagedApplicationService;
    ...
    invoke-direct/range {v0 .. v10}, <init>(Landroid/content/Context;Landroid/content/ComponentName;IILjava/lang/String;Lcom/android/server/utils/ManagedApplicationService$BinderChecker;ZILandroid/os/Handler;Lcom/android/server/utils/ManagedApplicationService$EventCallback;)V
...
.method private doRetry()V
    ...
    :cond_0
    iget-boolean v1, p0, mRetrying:Z
    ...
    invoke-direct {p0}, checkAndDeliverServiceDiedCbLocked()Z
    ...
    :cond_2
    invoke-direct {p0}, queueRetryLocked()V

    invoke-virtual {p0}, connect()V
...
.method private queueRetryLocked()V
    ...
    iget-wide v2, p0, mLastRetryTimeMs:J
    ...
    iput-wide v2, p0, mNextRetryDurationMs:J

    const/4 v2, 0x0

    iput v2, p0, mRetryCount:I

    :cond_0
    iput-wide v0, p0, mLastRetryTimeMs:J

    iget-object v2, p0, mHandler:Landroid/os/Handler;

    iget-object v3, p0, mRetryRunnable:Ljava/lang/Runnable;

    iget-wide v4, p0, mNextRetryDurationMs:J
...
.method private startRetriesLocked()V
    ...
    :cond_0
    iget-boolean v0, p0, mRetrying:Z
    ...
    iput-boolean v0, p0, mRetrying:Z
...
.method private stopRetriesLocked()V
    ...
    iget-object v1, p0, mRetryRunnable:Ljava/lang/Runnable;
...
.method public connect()V
    ...
    iget v2, p0, mClientLabel:I

    if-eqz v2, :cond_1

    const-string v2, "android.intent.extra.client_label"

    iget v3, p0, mClientLabel:I

    invoke-virtual {v1, v2, v3}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    :cond_1
    iget-object v2, p0, mSettingsAction:Ljava/lang/String;
    ...
    iget-object v5, p0, mSettingsAction:Ljava/lang/String;
    ...
    iget-boolean v3, p0, mIsImportant:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public disconnect()V
    ...
    iput-object v1, p0, mBoundInterface:Landroid/os/IInterface;
...
.method public disconnectIfNotMatching(Landroid/content/ComponentName;I)Z
    ...
    invoke-direct {p0, p1, p2}, matches(Landroid/content/ComponentName;I)Z
...
.method public sendEvent(Lcom/android/server/utils/ManagedApplicationService$PendingEvent;)V
    ...
    :try_start_0
    iget-object v1, p0, mBoundInterface:Landroid/os/IInterface;
