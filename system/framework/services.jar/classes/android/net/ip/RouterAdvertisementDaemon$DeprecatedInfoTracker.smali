...
.method private constructor <init>()V
    ...
    iput-object v0, p0, mPrefixes:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, mDnses:Ljava/util/HashMap;
...
.method static synthetic access$1100(Landroid/net/ip/RouterAdvertisementDaemon$DeprecatedInfoTracker;)Z
    ...
    invoke-direct {p0}, decrementCounters()Z
...
.method private decrementCounters()Z
    ...
    iget-object v0, p0, mPrefixes:Ljava/util/HashMap;

    invoke-direct {p0, v0}, decrementCounter(Ljava/util/HashMap;)Z

    move-result v0

    iget-object v1, p0, mDnses:Ljava/util/HashMap;

    invoke-direct {p0, v1}, decrementCounter(Ljava/util/HashMap;)Z
...
.method getDnses()Ljava/util/Set;
    ...
    iget-object v0, p0, mDnses:Ljava/util/HashMap;
...
.method putDnses(Ljava/util/Set;)V
    ...
    iget-object v2, p0, mDnses:Ljava/util/HashMap;
...
.method putPrefixes(Ljava/util/Set;)V
    ...
    iget-object v2, p0, mPrefixes:Ljava/util/HashMap;
