...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, hasDefaultRoute:Z

    const/16 v0, 0x41

    iput-byte v0, p0, hopLimit:B
    ...
    iput-object v0, p0, prefixes:Ljava/util/HashSet;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, dnses:Ljava/util/HashSet;
...
.method public constructor <init>(Landroid/net/ip/RouterAdvertisementDaemon$RaParams;)V
    ...
    iget-boolean v0, p1, hasDefaultRoute:Z

    iput-boolean v0, p0, hasDefaultRoute:Z

    iget-byte v0, p1, hopLimit:B
    ...
    iget-object v0, p1, prefixes:Ljava/util/HashSet;
    ...
    iget-object v0, p1, dnses:Ljava/util/HashSet;
...
.method public static getDeprecatedRaParams(Landroid/net/ip/RouterAdvertisementDaemon$RaParams;Landroid/net/ip/RouterAdvertisementDaemon$RaParams;)Landroid/net/ip/RouterAdvertisementDaemon$RaParams;
    ...
    iget-object v1, p0, prefixes:Ljava/util/HashSet;
    ...
    iget-object v3, p1, prefixes:Ljava/util/HashSet;
    ...
    :cond_0
    iget-object v3, v0, prefixes:Ljava/util/HashSet;
    ...
    :cond_2
    iget-object v1, p0, dnses:Ljava/util/HashSet;
    ...
    iget-object v3, p1, dnses:Ljava/util/HashSet;
    ...
    :cond_3
    iget-object v3, v0, dnses:Ljava/util/HashSet;
