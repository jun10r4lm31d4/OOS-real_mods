...
.method public constructor <init>(Ljava/lang/String;Landroid/os/Looper;ILandroid/net/util/SharedLog;Landroid/os/INetworkManagementService;Landroid/net/INetworkStatsService;Landroid/net/ip/IpServer$Callback;ZLandroid/net/ip/IpServer$Dependencies;)V
    ...
    iput v0, p0, mDhcpServerStartIndex:I

    invoke-virtual {p4, p1}, Landroid/net/util/SharedLog;->forSubComponent(Ljava/lang/String;)Landroid/net/util/SharedLog;

    move-result-object v1

    iput-object v1, p0, mLog:Landroid/net/util/SharedLog;

    iput-object p5, p0, mNMService:Landroid/os/INetworkManagementService;

    invoke-virtual {p9}, Landroid/net/ip/IpServer$Dependencies;->getNetdService()Landroid/net/INetd;

    move-result-object v1

    iput-object v1, p0, mNetd:Landroid/net/INetd;

    iput-object p6, p0, mStatsService:Landroid/net/INetworkStatsService;

    iput-object p7, p0, mCallback:Landroid/net/ip/IpServer$Callback;

    new-instance v1, Landroid/net/ip/InterfaceController;

    iget-object v2, p0, mNetd:Landroid/net/INetd;
    ...
    iput-object v1, p0, mInterfaceCtrl:Landroid/net/ip/InterfaceController;

    iput-object p1, p0, mIfaceName:Ljava/lang/String;

    iput p3, p0, mInterfaceType:I
    ...
    iput-boolean p8, p0, mUsingLegacyDhcp:Z

    iput-object p9, p0, mDeps:Landroid/net/ip/IpServer$Dependencies;

    invoke-direct {p0}, resetLinkProperties()V
    ...
    iput-boolean v1, p0, mV6OnlyTetherEnabled:Z

    iput v0, p0, mLastError:I

    const/4 v0, 0x1

    iput v0, p0, mServingMode:I
    ...
    iput-object v0, p0, mLocalHotspotState:Lcom/android/internal/util/State;
    ...
    iget-object v0, p0, mLocalHotspotState:Lcom/android/internal/util/State;
...
.method static synthetic access$1400(Landroid/net/ip/IpServer;Landroid/net/LinkProperties;)V
    ...
    invoke-direct {p0, p1}, updateUpstreamIPv6LinkProperties(Landroid/net/LinkProperties;)V
...
.method static synthetic access$200(Landroid/net/ip/IpServer;)I
    ...
    iget v0, p0, mDhcpServerStartIndex:I
...
.method static synthetic access$2300(Landroid/net/ip/IpServer;)V
    ...
    invoke-direct {p0}, sendLinkProperties()V
...
.method static synthetic access$2400(Landroid/net/ip/IpServer;)Landroid/net/util/InterfaceSet;
    ...
    iget-object v0, p0, mUpstreamIfaceSet:Landroid/net/util/InterfaceSet;
...
.method static synthetic access$2402(Landroid/net/ip/IpServer;Landroid/net/util/InterfaceSet;)Landroid/net/util/InterfaceSet;
    ...
    iput-object p1, p0, mUpstreamIfaceSet:Landroid/net/util/InterfaceSet;
...
.method static synthetic access$2700(Landroid/net/ip/IpServer;)Z
    ...
    iget-boolean v0, p0, mV6OnlyTetherEnabled:Z
...
.method static synthetic access$400(Landroid/net/ip/IpServer;)Landroid/net/dhcp/IDhcpServer;
    ...
    iget-object v0, p0, mDhcpServer:Landroid/net/dhcp/IDhcpServer;
...
.method static synthetic access$402(Landroid/net/ip/IpServer;Landroid/net/dhcp/IDhcpServer;)Landroid/net/dhcp/IDhcpServer;
    ...
    iput-object p1, p0, mDhcpServer:Landroid/net/dhcp/IDhcpServer;
...
.method static synthetic access$800(Landroid/net/ip/IpServer;I)V
    ...
    invoke-direct {p0, p1}, sendInterfaceState(I)V
...
.method private configureDhcp(ZLjava/net/Inet4Address;I)Z
    ...
    invoke-direct {p0, p2, p3}, startDhcp(Ljava/net/Inet4Address;I)Z
...
.method private configureIPv4(Z)Z
    ...
    :cond_2
    iget-object v2, p0, mCallerPkg:Ljava/lang/String;
    ...
    :cond_4
    invoke-direct {p0}, getRandomWifiIPv4Address()Ljava/lang/String;
    ...
    iget-object v5, p0, mIfaceName:Ljava/lang/String;
    ...
    iget-object v8, p0, mIfaceName:Ljava/lang/String;
    ...
    invoke-direct {p0, p1, v7, v1}, configureDhcp(ZLjava/net/Inet4Address;I)Z
    ...
    invoke-direct {p0, p1, v2, v3}, configureDhcp(ZLjava/net/Inet4Address;I)Z
...
.method private configureLocalIPv6Dns(Ljava/util/HashSet;Ljava/util/HashSet;)V
    ...
    iget-object v3, p0, mInterfaceCtrl:Landroid/net/ip/InterfaceController;
    ...
    iget-object v2, p0, mLastRaParams:Landroid/net/ip/RouterAdvertisementDaemon$RaParams;
    ...
    iget-object v4, p0, mInterfaceCtrl:Landroid/net/ip/InterfaceController;
...
.method private configureLocalIPv6Routes(Ljava/util/HashSet;Ljava/util/HashSet;)V
    ...
    invoke-static {v0, p1}, getLocalRoutesFor(Ljava/lang/String;Ljava/util/HashSet;)Ljava/util/ArrayList;
    ...
    iget-object v1, p0, mLastRaParams:Landroid/net/ip/RouterAdvertisementDaemon$RaParams;
    ...
    invoke-static {v1, v0}, getLocalRoutesFor(Ljava/lang/String;Ljava/util/HashSet;)Ljava/util/ArrayList;
...
.method private static getLocalDnsIpFor(Landroid/net/IpPrefix;)Ljava/net/Inet6Address;
    ...
    invoke-static {v2, v3}, getRandomSanitizedByte(B[B)B
...
.method private getRandomWifiIPv4Address()Ljava/lang/String;
    ...
    invoke-static {v2, v4}, getRandomSanitizedByte(B[B)B
...
.method private sendInterfaceState(I)V
    ...
    iput p1, p0, mServingMode:I

    iget-object v0, p0, mCallback:Landroid/net/ip/IpServer$Callback;

    iget v1, p0, mLastError:I
...
.method private setRaParams(Landroid/net/ip/RouterAdvertisementDaemon$RaParams;)V
    ...
    iget-object v0, p0, mRaDaemon:Landroid/net/ip/RouterAdvertisementDaemon;

    if-eqz v0, :cond_2

    iget-object v0, p0, mLastRaParams:Landroid/net/ip/RouterAdvertisementDaemon$RaParams;
    ...
    :goto_0
    invoke-direct {p0, v1, v3}, configureLocalIPv6Routes(Ljava/util/HashSet;Ljava/util/HashSet;)V
    ...
    :cond_1
    invoke-direct {p0, v1, v2}, configureLocalIPv6Dns(Ljava/util/HashSet;Ljava/util/HashSet;)V

    iget-object v1, p0, mRaDaemon:Landroid/net/ip/RouterAdvertisementDaemon;
    ...
    :cond_2
    iput-object p1, p0, mLastRaParams:Landroid/net/ip/RouterAdvertisementDaemon$RaParams;
...
.method private startDhcp(Ljava/net/Inet4Address;I)Z
    ...
    iget-boolean v0, p0, mUsingLegacyDhcp:Z
    ...
    iget v2, p0, mDhcpServerStartIndex:I

    add-int/2addr v2, v1

    iput v2, p0, mDhcpServerStartIndex:I

    iget-object v2, p0, mDeps:Landroid/net/ip/IpServer$Dependencies;

    iget-object v3, p0, mIfaceName:Ljava/lang/String;

    new-instance v4, Landroid/net/ip/IpServer$DhcpServerCallbacksImpl;

    iget v5, p0, mDhcpServerStartIndex:I
...
.method private startIPv4()Z
    ...
    invoke-direct {p0, v0}, configureIPv4(Z)Z
...
.method private startIPv6()Z
    ...
    iget-object v0, p0, mDeps:Landroid/net/ip/IpServer$Dependencies;
    ...
    iput-object v0, p0, mInterfaceParams:Landroid/net/util/InterfaceParams;

    iget-object v0, p0, mInterfaceParams:Landroid/net/util/InterfaceParams;
    ...
    iput-object v0, p0, mRaDaemon:Landroid/net/ip/RouterAdvertisementDaemon;
...
.method private stopDhcp()V
    ...
    iput-object v0, p0, mDhcpServer:Landroid/net/dhcp/IDhcpServer;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private stopIPv4()V
    ...
    iget v0, p0, mInterfaceType:I

    if-eqz v0, :cond_0

    iget-object v0, p0, mInterfaceCtrl:Landroid/net/ip/InterfaceController;
...
.method private stopIPv6()V
    ...
    invoke-direct {p0, v0}, setRaParams(Landroid/net/ip/RouterAdvertisementDaemon$RaParams;)V
...
.method private updateUpstreamIPv6LinkProperties(Landroid/net/LinkProperties;)V
    ...
    :cond_0
    iget-object v0, p0, mLastIPv6LinkProperties:Landroid/net/LinkProperties;
    ...
    invoke-direct {p0, v1}, getHopLimit(Ljava/lang/String;)B
    ...
    invoke-static {v3}, getLocalDnsIpFor(Landroid/net/IpPrefix;)Ljava/net/Inet6Address;
    ...
    iput-object p1, p0, mLastIPv6LinkProperties:Landroid/net/LinkProperties;
