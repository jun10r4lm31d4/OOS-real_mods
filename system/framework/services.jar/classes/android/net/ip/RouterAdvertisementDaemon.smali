...
.method static constructor <clinit>()V
    ...
    invoke-static {v0}, asByte(I)B

    move-result v0

    sput-byte v0, ICMPV6_ND_ROUTER_SOLICIT:B
    ...
    sput-byte v0, ICMPV6_ND_ROUTER_ADVERT:B
...
.method public constructor <init>(Landroid/net/util/InterfaceParams;)V
    ...
    iput-object v0, p0, mRA:[B

    iput-object p1, p0, mInterface:Landroid/net/util/InterfaceParams;

    new-instance v0, Ljava/net/InetSocketAddress;

    iget-object v1, p0, mInterface:Landroid/net/util/InterfaceParams;

    iget v1, v1, Landroid/net/util/InterfaceParams;->index:I

    invoke-static {v1}, getAllNodesForScopeId(I)Ljava/net/Inet6Address;
    ...
    iput-object v0, p0, mAllNodes:Ljava/net/InetSocketAddress;
    ...
    iput-object v0, p0, mDeprecatedInfoTracker:Landroid/net/ip/RouterAdvertisementDaemon$DeprecatedInfoTracker;
...
.method static synthetic access$1000(Landroid/net/ip/RouterAdvertisementDaemon;)Landroid/net/ip/RouterAdvertisementDaemon$DeprecatedInfoTracker;
    ...
    iget-object v0, p0, mDeprecatedInfoTracker:Landroid/net/ip/RouterAdvertisementDaemon$DeprecatedInfoTracker;
...
.method static synthetic access$1200(Landroid/net/ip/RouterAdvertisementDaemon;)V
    ...
    invoke-direct {p0}, assembleRaLocked()V
...
.method static synthetic access$300(Landroid/net/ip/RouterAdvertisementDaemon;)Z
    ...
    invoke-direct {p0}, isSocketValid()Z
...
.method static synthetic access$400(Landroid/net/ip/RouterAdvertisementDaemon;)Ljava/io/FileDescriptor;
    ...
    iget-object v0, p0, mSocket:Ljava/io/FileDescriptor;
...
.method static synthetic access$500()B
    ...
    sget-byte v0, ICMPV6_ND_ROUTER_SOLICIT:B
...
.method static synthetic access$700(Landroid/net/ip/RouterAdvertisementDaemon;Ljava/net/InetSocketAddress;)V
    ...
    invoke-direct {p0, p1}, maybeSendRA(Ljava/net/InetSocketAddress;)V
...
.method static synthetic access$800(Landroid/net/ip/RouterAdvertisementDaemon;)Ljava/net/InetSocketAddress;
    ...
    iget-object v0, p0, mAllNodes:Ljava/net/InetSocketAddress;
...
.method private assembleRaLocked()V
    ...
    iget-object v1, p0, mRaParams:Landroid/net/ip/RouterAdvertisementDaemon$RaParams;
    ...
    :try_start_0
    iget-object v5, p0, mRaParams:Landroid/net/ip/RouterAdvertisementDaemon$RaParams;
    ...
    :goto_2
    invoke-static {v0, v2, v5}, putHeader(Ljava/nio/ByteBuffer;ZB)V

    iget-object v2, p0, mInterface:Landroid/net/util/InterfaceParams;
    ...
    invoke-static {v0, v2}, putSlla(Ljava/nio/ByteBuffer;[B)V

    invoke-virtual {v0}, Ljava/nio/ByteBuffer;->position()I

    move-result v2

    iput v2, p0, mRaLength:I

    if-eqz v1, :cond_4

    iget-object v2, p0, mRaParams:Landroid/net/ip/RouterAdvertisementDaemon$RaParams;

    iget v2, v2, Landroid/net/ip/RouterAdvertisementDaemon$RaParams;->mtu:I

    invoke-static {v0, v2}, putMtu(Ljava/nio/ByteBuffer;I)V
    ...
    invoke-static {v0, v5, v6, v6}, putPio(Ljava/nio/ByteBuffer;Landroid/net/IpPrefix;II)V

    invoke-virtual {v0}, Ljava/nio/ByteBuffer;->position()I

    move-result v6

    iput v6, p0, mRaLength:I
    ...
    invoke-static {v0, v2, v6}, putRdnss(Ljava/nio/ByteBuffer;Ljava/util/Set;I)V
    ...
    :cond_4
    iget-object v2, p0, mDeprecatedInfoTracker:Landroid/net/ip/RouterAdvertisementDaemon$DeprecatedInfoTracker;
    ...
    invoke-static {v0, v5, v3, v3}, putPio(Ljava/nio/ByteBuffer;Landroid/net/IpPrefix;II)V
    ...
    invoke-static {v0, v2, v3}, putRdnss(Ljava/nio/ByteBuffer;Ljava/util/Set;I)V

    invoke-virtual {v0}, Ljava/nio/ByteBuffer;->position()I

    move-result v5

    iput v5, p0, mRaLength:I
    :try_end_0
...
.method private closeSocket()V
    ...
    iput-object v0, p0, mSocket:Ljava/io/FileDescriptor;
...
.method private createSocket()Z
    ...
    iput-object v2, p0, mSocket:Ljava/io/FileDescriptor;

    iget-object v2, p0, mSocket:Ljava/io/FileDescriptor;
    ...
    iget-object v5, p0, mInterface:Landroid/net/util/InterfaceParams;
    ...
    iget-object v3, p0, mInterface:Landroid/net/util/InterfaceParams;
...
.method private maybeNotifyMulticastTransmitter()V
    ...
    iget-object v0, p0, mMulticastTransmitter:Landroid/net/ip/RouterAdvertisementDaemon$MulticastTransmitter;
...
.method private maybeSendRA(Ljava/net/InetSocketAddress;)V
    ...
    invoke-direct {p0, p1}, isSuitableDestination(Ljava/net/InetSocketAddress;)Z
    ...
    :cond_0
    iget-object p1, p0, mAllNodes:Ljava/net/InetSocketAddress;
    ...
    iget-object v1, p0, mRA:[B

    const/4 v2, 0x0

    iget v3, p0, mRaLength:I
...
.method private static putHeader(Ljava/nio/ByteBuffer;ZB)V
    ...
    sget-byte v0, ICMPV6_ND_ROUTER_ADVERT:B
...
.method public buildNewRa(Landroid/net/ip/RouterAdvertisementDaemon$RaParams;Landroid/net/ip/RouterAdvertisementDaemon$RaParams;)V
    ...
    :try_start_0
    iget-object v1, p0, mDeprecatedInfoTracker:Landroid/net/ip/RouterAdvertisementDaemon$DeprecatedInfoTracker;
    ...
    :cond_1
    iput-object p2, p0, mRaParams:Landroid/net/ip/RouterAdvertisementDaemon$RaParams;
    ...
    invoke-direct {p0}, maybeNotifyMulticastTransmitter()V
...
.method public start()Z
    ...
    invoke-direct {p0}, createSocket()Z
    ...
    iput-object v0, p0, mMulticastTransmitter:Landroid/net/ip/RouterAdvertisementDaemon$MulticastTransmitter;
    ...
    iput-object v0, p0, mUnicastResponder:Landroid/net/ip/RouterAdvertisementDaemon$UnicastResponder;

    iget-object v0, p0, mUnicastResponder:Landroid/net/ip/RouterAdvertisementDaemon$UnicastResponder;
