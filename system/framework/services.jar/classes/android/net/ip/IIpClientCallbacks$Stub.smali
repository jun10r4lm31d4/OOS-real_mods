...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :cond_0
    invoke-virtual {p0, v1}, setNeighborDiscoveryOffload(Z)V
    ...
    :cond_1
    invoke-virtual {p0, v1}, setFallbackMulticastFilter(Z)V
    ...
    invoke-virtual {p0}, startReadPacketFilter()V
    ...
    invoke-virtual {p0, v1}, installPacketFilter([B)V
    ...
    invoke-virtual {p0, v1}, onReachabilityLost(Ljava/lang/String;)V
    ...
    :goto_0
    invoke-virtual {p0, v1}, onLinkPropertiesChange(Landroid/net/LinkProperties;)V
    ...
    :goto_1
    invoke-virtual {p0, v1}, onProvisioningFailure(Landroid/net/LinkProperties;)V
    ...
    :goto_2
    invoke-virtual {p0, v1}, onProvisioningSuccess(Landroid/net/LinkProperties;)V
    ...
    :goto_3
    invoke-virtual {p0, v1}, onNewDhcpResults(Landroid/net/DhcpResultsParcelable;)V
    ...
    invoke-virtual {p0}, onPostDhcpAction()V
    ...
    invoke-virtual {p0}, onPreDhcpAction()V
    ...
    invoke-virtual {p0, v1}, onIpClientCreated(Landroid/net/ip/IIpClient;)V
