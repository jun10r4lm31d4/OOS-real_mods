...
.method constructor <init>(Landroid/net/ip/IpServer;)V
    ...
    iput-object p1, p0, this$0:Landroid/net/ip/IpServer;
...
.method private cleanupUpstream()V
    ...
    iget-object v0, p0, this$0:Landroid/net/ip/IpServer;
    ...
    invoke-direct {p0, v1}, cleanupUpstreamInterface(Ljava/lang/String;)V
...
.method private cleanupUpstreamInterface(Ljava/lang/String;)V
    ...
    :try_start_0
    iget-object v2, p0, this$0:Landroid/net/ip/IpServer;
    ...
    iget-object v3, p0, this$0:Landroid/net/ip/IpServer;
    ...
    iget-object v4, p0, this$0:Landroid/net/ip/IpServer;
...
.method private upstreamInterfacesAdd(Landroid/net/util/InterfaceSet;)Ljava/util/Set;
    ...
    iget-object v1, p0, this$0:Landroid/net/ip/IpServer;
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-direct {p0, v1}, noChangeInUpstreamIfaceSet(Landroid/net/util/InterfaceSet;)Z
    ...
    :cond_3
    invoke-direct {p0, v1}, upstreamInterfacesRemoved(Landroid/net/util/InterfaceSet;)Ljava/util/Set;
    ...
    invoke-direct {p0, v6}, cleanupUpstreamInterface(Ljava/lang/String;)V

    goto :goto_0

    :cond_4
    invoke-direct {p0, v1}, upstreamInterfacesAdd(Landroid/net/util/InterfaceSet;)Ljava/util/Set;

    move-result-object v3

    iget-object v6, p0, this$0:Landroid/net/ip/IpServer;
    ...
    iget-object v11, p0, this$0:Landroid/net/ip/IpServer;
    ...
    iget-object v12, p0, this$0:Landroid/net/ip/IpServer;
