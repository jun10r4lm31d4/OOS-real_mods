...
.method private constructor <init>(Landroid/net/netlink/StructNlMsgHdr;)V
    ...
    iput-object v0, p0, mNdmsg:Landroid/net/netlink/StructNdMsg;

    iput-object v0, p0, mDestination:Ljava/net/InetAddress;

    iput-object v0, p0, mLinkLayerAddr:[B

    const/4 v1, 0x0

    iput v1, p0, mNumProbes:I

    iput-object v0, p0, mCacheInfo:Landroid/net/netlink/StructNdaCacheInfo;
...
.method public static newNewNeighborMessage(ILjava/net/InetAddress;SI[B)[B
    ...
    invoke-direct {v1, v0}, <init>(Landroid/net/netlink/StructNlMsgHdr;)V

    new-instance v2, Landroid/net/netlink/StructNdMsg;

    invoke-direct {v2}, Landroid/net/netlink/StructNdMsg;-><init>()V

    iput-object v2, v1, mNdmsg:Landroid/net/netlink/StructNdMsg;

    iget-object v2, v1, mNdmsg:Landroid/net/netlink/StructNdMsg;
    ...
    iput-object p1, v1, mDestination:Ljava/net/InetAddress;

    iput-object p4, v1, mLinkLayerAddr:[B

    invoke-virtual {v1}, getRequiredSpace()I
    ...
    invoke-virtual {v1, v3}, pack(Ljava/nio/ByteBuffer;)V
...
.method public static parse(Landroid/net/netlink/StructNlMsgHdr;Ljava/nio/ByteBuffer;)Landroid/net/netlink/RtNetlinkNeighborMessage;
    ...
    invoke-direct {v0, p0}, <init>(Landroid/net/netlink/StructNlMsgHdr;)V

    invoke-static {p1}, Landroid/net/netlink/StructNdMsg;->parse(Ljava/nio/ByteBuffer;)Landroid/net/netlink/StructNdMsg;

    move-result-object v1

    iput-object v1, v0, mNdmsg:Landroid/net/netlink/StructNdMsg;

    iget-object v1, v0, mNdmsg:Landroid/net/netlink/StructNdMsg;
    ...
    invoke-static {v2, p1}, findNextAttrOfType(SLjava/nio/ByteBuffer;)Landroid/net/netlink/StructNlAttr;
    ...
    iput-object v3, v0, mDestination:Ljava/net/InetAddress;
    ...
    invoke-static {v3, p1}, findNextAttrOfType(SLjava/nio/ByteBuffer;)Landroid/net/netlink/StructNlAttr;
    ...
    iput-object v3, v0, mLinkLayerAddr:[B
    ...
    iput-object v3, v0, mCacheInfo:Landroid/net/netlink/StructNdaCacheInfo;

    :cond_4
    const/16 v3, 0x1c

    iget-object v4, v0, mHeader:Landroid/net/netlink/StructNlMsgHdr;
...
.method public getCacheInfo()Landroid/net/netlink/StructNdaCacheInfo;
    ...
    iget-object v0, p0, mCacheInfo:Landroid/net/netlink/StructNdaCacheInfo;
...
.method public getDestination()Ljava/net/InetAddress;
    ...
    iget-object v0, p0, mDestination:Ljava/net/InetAddress;
...
.method public getLinkLayerAddress()[B
    ...
    iget-object v0, p0, mLinkLayerAddr:[B
...
.method public getNdHeader()Landroid/net/netlink/StructNdMsg;
    ...
    iget-object v0, p0, mNdmsg:Landroid/net/netlink/StructNdMsg;
...
.method public getRequiredSpace()I
    ...
    iget-object v1, p0, mDestination:Ljava/net/InetAddress;
    ...
    :cond_0
    iget-object v1, p0, mLinkLayerAddr:[B
...
.method public pack(Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {p0}, getHeader()Landroid/net/netlink/StructNlMsgHdr;
    ...
    invoke-static {v1, v0, p1}, packNlAttr(S[BLjava/nio/ByteBuffer;)V
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v3, p0, mHeader:Landroid/net/netlink/StructNlMsgHdr;
    ...
    iget-object v3, p0, mNdmsg:Landroid/net/netlink/StructNdMsg;
    ...
    iget-object v3, p0, mLinkLayerAddr:[B
    ...
    iget-object v3, p0, mCacheInfo:Landroid/net/netlink/StructNdaCacheInfo;
