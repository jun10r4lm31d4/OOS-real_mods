...
.method public constructor <init>()V
    ...
    iput-short v0, p0, nla_len:S

    invoke-static {}, Ljava/nio/ByteOrder;->nativeOrder()Ljava/nio/ByteOrder;

    move-result-object v0

    iput-object v0, p0, mByteOrder:Ljava/nio/ByteOrder;
...
.method public constructor <init>(Ljava/nio/ByteOrder;)V
    ...
    iput-object p1, p0, mByteOrder:Ljava/nio/ByteOrder;
...
.method public constructor <init>(SB)V
    ...
    iput-short p1, p0, nla_type:S

    const/4 v0, 0x1

    new-array v0, v0, [B

    invoke-direct {p0, v0}, setValue([B)V

    iget-object v0, p0, nla_value:[B
...
.method public constructor <init>(SI)V
    ...
    invoke-direct {p0, p1, p2, v0}, <init>(SILjava/nio/ByteOrder;)V
...
.method public constructor <init>(SILjava/nio/ByteOrder;)V
    ...
    invoke-direct {p0, p3}, <init>(Ljava/nio/ByteOrder;)V
    ...
    invoke-virtual {p0}, getValueAsByteBuffer()Ljava/nio/ByteBuffer;
...
.method public constructor <init>(SS)V
    ...
    invoke-direct {p0, p1, p2, v0}, <init>(SSLjava/nio/ByteOrder;)V
...
.method public varargs constructor <init>(S[Landroid/net/netlink/StructNlAttr;)V
    ...
    invoke-static {p1}, makeNestedType(S)S

    move-result v0

    iput-short v0, p0, nla_type:S
    ...
    invoke-virtual {v4}, getAlignedLength()I
    ...
    invoke-virtual {v4, v0}, pack(Ljava/nio/ByteBuffer;)V
...
.method public static parse(Ljava/nio/ByteBuffer;)Landroid/net/netlink/StructNlAttr;
    ...
    invoke-static {p0}, peek(Ljava/nio/ByteBuffer;)Landroid/net/netlink/StructNlAttr;
    ...
    invoke-virtual {v0}, getAlignedLength()I
    ...
    iput-object v3, v0, nla_value:[B

    iget-object v3, v0, nla_value:[B
...
.method public static peek(Ljava/nio/ByteBuffer;)Landroid/net/netlink/StructNlAttr;
    ...
    invoke-direct {v3, v4}, <init>(Ljava/nio/ByteOrder;)V
    ...
    iput-short v5, v3, nla_len:S

    invoke-virtual {p0}, Ljava/nio/ByteBuffer;->getShort()S

    move-result v5

    iput-short v5, v3, nla_type:S
    :try_end_0
...
.method public getValueAsByteBuffer()Ljava/nio/ByteBuffer;
    ...
    iget-object v1, p0, mByteOrder:Ljava/nio/ByteOrder;
...
.method public pack(Ljava/nio/ByteBuffer;)V
    ...
    :try_start_0
    iget-short v2, p0, nla_len:S

    invoke-virtual {p1, v2}, Ljava/nio/ByteBuffer;->putShort(S)Ljava/nio/ByteBuffer;

    iget-short v2, p0, nla_type:S

    invoke-virtual {p1, v2}, Ljava/nio/ByteBuffer;->putShort(S)Ljava/nio/ByteBuffer;

    iget-object v2, p0, nla_value:[B
    ...
    invoke-virtual {p0}, getAlignedLength()I
