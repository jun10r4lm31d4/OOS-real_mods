...
.method public constructor <init>()V
    ...
    iput v0, p0, nlmsg_len:I

    iput-short v0, p0, nlmsg_type:S

    iput-short v0, p0, nlmsg_flags:S

    iput v0, p0, nlmsg_seq:I

    iput v0, p0, nlmsg_pid:I
...
.method public static parse(Ljava/nio/ByteBuffer;)Landroid/net/netlink/StructNlMsgHdr;
    ...
    iput v2, v0, nlmsg_len:I

    invoke-virtual {p0}, Ljava/nio/ByteBuffer;->getShort()S

    move-result v2

    iput-short v2, v0, nlmsg_type:S

    invoke-virtual {p0}, Ljava/nio/ByteBuffer;->getShort()S

    move-result v2

    iput-short v2, v0, nlmsg_flags:S

    invoke-virtual {p0}, Ljava/nio/ByteBuffer;->getInt()I

    move-result v2

    iput v2, v0, nlmsg_seq:I

    invoke-virtual {p0}, Ljava/nio/ByteBuffer;->getInt()I

    move-result v2

    iput v2, v0, nlmsg_pid:I

    iget v2, v0, nlmsg_len:I
...
.method public pack(Ljava/nio/ByteBuffer;)V
    ...
    iget v0, p0, nlmsg_len:I

    invoke-virtual {p1, v0}, Ljava/nio/ByteBuffer;->putInt(I)Ljava/nio/ByteBuffer;

    iget-short v0, p0, nlmsg_type:S

    invoke-virtual {p1, v0}, Ljava/nio/ByteBuffer;->putShort(S)Ljava/nio/ByteBuffer;

    iget-short v0, p0, nlmsg_flags:S

    invoke-virtual {p1, v0}, Ljava/nio/ByteBuffer;->putShort(S)Ljava/nio/ByteBuffer;

    iget v0, p0, nlmsg_seq:I

    invoke-virtual {p1, v0}, Ljava/nio/ByteBuffer;->putInt(I)Ljava/nio/ByteBuffer;

    iget v0, p0, nlmsg_pid:I
...
.method public toString()Ljava/lang/String;
    ...
    iget-short v1, p0, nlmsg_flags:S
    ...
    invoke-static {v1}, stringForNlMsgFlags(S)Ljava/lang/String;
