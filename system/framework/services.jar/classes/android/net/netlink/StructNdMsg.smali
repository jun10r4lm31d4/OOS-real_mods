...
.method static constructor <clinit>()V
    ...
    sput-byte v0, NTF_USE:B

    const/4 v0, 0x2

    sput-byte v0, NTF_SELF:B

    const/4 v0, 0x4

    sput-byte v0, NTF_MASTER:B

    const/16 v0, 0x8

    sput-byte v0, NTF_PROXY:B

    const/16 v0, -0x80

    sput-byte v0, NTF_ROUTER:B
...
.method public static isNudStateValid(S)Z
    ...
    invoke-static {p0}, isNudStateConnected(S)Z
...
.method public static parse(Ljava/nio/ByteBuffer;)Landroid/net/netlink/StructNdMsg;
    ...
    invoke-static {p0}, hasAvailableSpace(Ljava/nio/ByteBuffer;)Z
    ...
    iput v3, v0, ndm_ifindex:I

    invoke-virtual {p0}, Ljava/nio/ByteBuffer;->getShort()S

    move-result v3

    iput-short v3, v0, ndm_state:S

    invoke-virtual {p0}, Ljava/nio/ByteBuffer;->get()B

    move-result v3

    iput-byte v3, v0, ndm_flags:B

    invoke-virtual {p0}, Ljava/nio/ByteBuffer;->get()B

    move-result v3

    iput-byte v3, v0, ndm_type:B
...
.method public nudConnected()Z
    ...
    iget-short v0, p0, ndm_state:S

    invoke-static {v0}, isNudStateConnected(S)Z
...
.method public nudValid()Z
    ...
    invoke-static {v0}, isNudStateValid(S)Z
...
.method public pack(Ljava/nio/ByteBuffer;)V
    ...
    iget-byte v0, p0, ndm_flags:B

    invoke-virtual {p1, v0}, Ljava/nio/ByteBuffer;->put(B)Ljava/nio/ByteBuffer;

    iget-byte v0, p0, ndm_type:B
...
.method public toString()Ljava/lang/String;
    ...
    iget-short v3, p0, ndm_state:S

    invoke-static {v3}, stringForNudState(S)Ljava/lang/String;
    ...
    invoke-static {v1}, stringForNudFlags(B)Ljava/lang/String;
