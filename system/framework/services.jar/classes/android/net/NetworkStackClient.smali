...
.method private constructor <init>()V
    ...
    iput-object v0, p0, mPendingNetStackRequests:Ljava/util/ArrayList;
    ...
    iput-boolean v0, p0, mWasSystemServerInitialized:Z

    new-instance v0, Landroid/util/ArraySet;

    invoke-direct {v0}, Landroid/util/ArraySet;-><init>()V

    iput-object v0, p0, mHealthListeners:Landroid/util/ArraySet;
...
.method static synthetic access$000(Landroid/net/NetworkStackClient;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, logi(Ljava/lang/String;)V
...
.method static synthetic access$100(Landroid/net/NetworkStackClient;Landroid/os/IBinder;)V
    ...
    invoke-direct {p0, p1}, registerNetworkStackService(Landroid/os/IBinder;)V
...
.method static synthetic access$200(Landroid/net/NetworkStackClient;Ljava/lang/String;Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2, p3}, maybeCrashWithTerribleFailure(Ljava/lang/String;Landroid/content/Context;Ljava/lang/String;)V
...
.method public static declared-synchronized getInstance()Landroid/net/NetworkStackClient;
    ...
    :try_start_0
    sget-object v1, sInstance:Landroid/net/NetworkStackClient;
    ...
    sput-object v1, sInstance:Landroid/net/NetworkStackClient;
...
.method private getNetworkStackIntent(Landroid/content/pm/PackageManager;Z)Landroid/content/Intent;
    ...
    invoke-direct {p0, v5, v2}, logWtf(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {p0, p1, v3}, checkNetworkStackPermission(Landroid/content/pm/PackageManager;Landroid/content/ComponentName;)V
...
.method private getRemoteConnector()Landroid/net/INetworkStackConnector;
    ...
    invoke-direct {p0, v3, v0}, loge(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_0
    ...
    invoke-direct {p0, v2, v1}, loge(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private getSharedPreferences(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    invoke-direct {p0, v1, v0}, logWtf(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private maybeCrashWithTerribleFailure(Ljava/lang/String;Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-direct {v1, v2, v0}, logWtf(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v1, v13}, getSharedPreferences(Landroid/content/Context;)Landroid/content/SharedPreferences;

    move-result-object v14

    invoke-direct {v1, v14}, tryGetLastCrashTime(Landroid/content/SharedPreferences;)J
    ...
    iget-object v4, v1, mHealthListeners:Landroid/util/ArraySet;
    ...
    iget-object v5, v1, mHealthListeners:Landroid/util/ArraySet;
    ...
    :goto_5
    invoke-direct {v1, v14, v6, v7}, tryWriteLastCrashTime(Landroid/content/SharedPreferences;J)V
...
.method private registerNetworkStackService(Landroid/os/IBinder;)V
    ...
    iget-object v1, p0, mPendingNetStackRequests:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, mPendingNetStackRequests:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, mConnector:Landroid/net/INetworkStackConnector;
...
.method private requestConnector(Landroid/net/NetworkStackClient$NetworkStackCallback;)V
    ...
    :cond_1
    :goto_0
    iget-boolean v1, p0, mWasSystemServerInitialized:Z

    if-nez v1, :cond_2

    invoke-direct {p0}, getRemoteConnector()Landroid/net/INetworkStackConnector;

    move-result-object v1

    iget-object v2, p0, mPendingNetStackRequests:Ljava/util/ArrayList;

    monitor-enter v2

    :try_start_0
    iput-object v1, p0, mConnector:Landroid/net/INetworkStackConnector;
    ...
    :try_start_2
    iget-object v2, p0, mConnector:Landroid/net/INetworkStackConnector;
...
.method private tryGetLastCrashTime(Landroid/content/SharedPreferences;)J
    ...
    invoke-direct {p0, v3, v2}, logWtf(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    iget-object v0, p0, mPendingNetStackRequests:Ljava/util/ArrayList;
...
.method public fetchIpMemoryStore(Landroid/net/IIpMemoryStoreCallbacks;)V
    ...
    invoke-direct {p0, v0}, requestConnector(Landroid/net/NetworkStackClient$NetworkStackCallback;)V
...
.method public registerHealthListener(Landroid/net/NetworkStackClient$NetworkStackHealthListener;)V
    ...
    iget-object v0, p0, mHealthListeners:Landroid/util/ArraySet;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, mHealthListeners:Landroid/util/ArraySet;
...
.method public start(Landroid/content/Context;)V
    ...
    invoke-direct {p0, v0, v1}, getNetworkStackIntent(Landroid/content/pm/PackageManager;Z)Landroid/content/Intent;
    ...
    invoke-direct {p0, v0, v2}, getNetworkStackIntent(Landroid/content/pm/PackageManager;Z)Landroid/content/Intent;
    ...
    invoke-direct {p0, v3, p1, v2}, maybeCrashWithTerribleFailure(Ljava/lang/String;Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v2, p1, v3}, maybeCrashWithTerribleFailure(Ljava/lang/String;Landroid/content/Context;Ljava/lang/String;)V
