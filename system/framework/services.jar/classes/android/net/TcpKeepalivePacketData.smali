...
.method public static tcpKeepalivePacket(Landroid/net/TcpKeepalivePacketDataParcelable;)Landroid/net/TcpKeepalivePacketData;
    ...
    invoke-static {p0}, buildV4Packet(Landroid/net/TcpKeepalivePacketDataParcelable;)[B

    move-result-object v1

    new-instance v2, Landroid/net/TcpKeepalivePacketData;

    invoke-direct {v2, p0, v1}, <init>(Landroid/net/TcpKeepalivePacketDataParcelable;[B)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v2, p0, srcAddress:Ljava/net/InetAddress;

    iget-object v3, v0, srcAddress:Ljava/net/InetAddress;
    ...
    iget-object v2, p0, dstAddress:Ljava/net/InetAddress;

    iget-object v3, v0, dstAddress:Ljava/net/InetAddress;
    ...
    iget v2, p0, srcPort:I

    iget v3, v0, srcPort:I

    if-ne v2, v3, :cond_1

    iget v2, p0, dstPort:I

    iget v3, v0, dstPort:I
    ...
    iget v2, p0, tcpWndScale:I

    iget v3, v0, tcpWndScale:I
...
.method public hashCode()I
    ...
    iget-object v1, p0, srcAddress:Ljava/net/InetAddress;

    const/4 v2, 0x0

    aput-object v1, v0, v2

    iget-object v1, p0, dstAddress:Ljava/net/InetAddress;

    const/4 v2, 0x1

    aput-object v1, v0, v2

    iget v1, p0, srcPort:I
