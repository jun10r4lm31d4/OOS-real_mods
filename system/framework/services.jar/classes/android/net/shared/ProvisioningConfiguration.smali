...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, mEnableIPv4:Z

    iput-boolean v0, p0, mEnableIPv6:Z

    iput-boolean v0, p0, mUsingMultinetworkPolicyTracker:Z

    iput-boolean v0, p0, mUsingIpReachabilityMonitor:Z

    const v0, 0x8ca0

    iput v0, p0, mProvisioningTimeoutMs:I

    const/4 v0, 0x2

    iput v0, p0, mIPv6AddrGenMode:I

    const/4 v0, 0x0

    iput-object v0, p0, mNetwork:Landroid/net/Network;
...
.method public constructor <init>(Landroid/net/shared/ProvisioningConfiguration;)V
    ...
    iget-boolean v1, p1, mEnableIPv4:Z

    iput-boolean v1, p0, mEnableIPv4:Z

    iget-boolean v1, p1, mEnableIPv6:Z

    iput-boolean v1, p0, mEnableIPv6:Z

    iget-boolean v1, p1, mUsingMultinetworkPolicyTracker:Z

    iput-boolean v1, p0, mUsingMultinetworkPolicyTracker:Z

    iget-boolean v1, p1, mUsingIpReachabilityMonitor:Z

    iput-boolean v1, p0, mUsingIpReachabilityMonitor:Z

    iget v1, p1, mRequestedPreDhcpActionMs:I

    iput v1, p0, mRequestedPreDhcpActionMs:I

    iget-object v1, p1, mInitialConfig:Landroid/net/shared/InitialConfiguration;
    ...
    iput-object v1, p0, mInitialConfig:Landroid/net/shared/InitialConfiguration;

    iget-object v1, p1, mStaticIpConfig:Landroid/net/StaticIpConfiguration;
    ...
    :goto_0
    iput-object v0, p0, mStaticIpConfig:Landroid/net/StaticIpConfiguration;

    iget-object v0, p1, mApfCapabilities:Landroid/net/apf/ApfCapabilities;

    iput-object v0, p0, mApfCapabilities:Landroid/net/apf/ApfCapabilities;

    iget v0, p1, mProvisioningTimeoutMs:I

    iput v0, p0, mProvisioningTimeoutMs:I

    iget-boolean v0, p1, mRapidCommit:Z

    iput-boolean v0, p0, mRapidCommit:Z

    iget-boolean v0, p1, mDiscoverSent:Z

    iput-boolean v0, p0, mDiscoverSent:Z

    iget v0, p1, mIPv6AddrGenMode:I

    iput v0, p0, mIPv6AddrGenMode:I

    iget-object v0, p1, mNetwork:Landroid/net/Network;

    iput-object v0, p0, mNetwork:Landroid/net/Network;

    iget-object v0, p1, mDisplayName:Ljava/lang/String;
...
.method public static fromStableParcelable(Landroid/net/ProvisioningConfigurationParcelable;)Landroid/net/shared/ProvisioningConfiguration;
    ...
    iput-object v2, v1, mInitialConfig:Landroid/net/shared/InitialConfiguration;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-boolean v2, p0, mEnableIPv4:Z

    iget-boolean v3, v0, mEnableIPv4:Z

    if-ne v2, v3, :cond_1

    iget-boolean v2, p0, mEnableIPv6:Z

    iget-boolean v3, v0, mEnableIPv6:Z

    if-ne v2, v3, :cond_1

    iget-boolean v2, p0, mUsingMultinetworkPolicyTracker:Z

    iget-boolean v3, v0, mUsingMultinetworkPolicyTracker:Z

    if-ne v2, v3, :cond_1

    iget-boolean v2, p0, mUsingIpReachabilityMonitor:Z

    iget-boolean v3, v0, mUsingIpReachabilityMonitor:Z

    if-ne v2, v3, :cond_1

    iget v2, p0, mRequestedPreDhcpActionMs:I

    iget v3, v0, mRequestedPreDhcpActionMs:I

    if-ne v2, v3, :cond_1

    iget-object v2, p0, mInitialConfig:Landroid/net/shared/InitialConfiguration;

    iget-object v3, v0, mInitialConfig:Landroid/net/shared/InitialConfiguration;
    ...
    iget-object v2, p0, mStaticIpConfig:Landroid/net/StaticIpConfiguration;

    iget-object v3, v0, mStaticIpConfig:Landroid/net/StaticIpConfiguration;
    ...
    iget-object v2, p0, mApfCapabilities:Landroid/net/apf/ApfCapabilities;

    iget-object v3, v0, mApfCapabilities:Landroid/net/apf/ApfCapabilities;
    ...
    iget v2, p0, mProvisioningTimeoutMs:I

    iget v3, v0, mProvisioningTimeoutMs:I

    if-ne v2, v3, :cond_1

    iget v2, p0, mIPv6AddrGenMode:I

    iget v3, v0, mIPv6AddrGenMode:I

    if-ne v2, v3, :cond_1

    iget-object v2, p0, mNetwork:Landroid/net/Network;

    iget-object v3, v0, mNetwork:Landroid/net/Network;
    ...
    iget-object v2, p0, mDisplayName:Ljava/lang/String;

    iget-object v3, v0, mDisplayName:Ljava/lang/String;
...
.method public isValid()Z
    ...
    iget-object v0, p0, mInitialConfig:Landroid/net/shared/InitialConfiguration;
...
.method public toStableParcelable()Landroid/net/ProvisioningConfigurationParcelable;
    ...
    iget-object v1, p0, mStaticIpConfig:Landroid/net/StaticIpConfiguration;
