...
.method static constructor <clinit>()V
    ...
    sput-object v0, INET6_ANY:Ljava/net/InetAddress;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, ipAddresses:Ljava/util/Set;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, directlyConnectedRoutes:Ljava/util/Set;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, dnsServers:Ljava/util/Set;
...
.method public static all(Ljava/lang/Iterable;Ljava/util/function/Predicate;)Z
    ...
    invoke-static {p1}, not(Ljava/util/function/Predicate;)Ljava/util/function/Predicate;

    move-result-object v0

    invoke-static {p0, v0}, any(Ljava/lang/Iterable;Ljava/util/function/Predicate;)Z
...
.method public static copy(Landroid/net/shared/InitialConfiguration;)Landroid/net/shared/InitialConfiguration;
    ...
    iget-object v1, v0, ipAddresses:Ljava/util/Set;

    iget-object v2, p0, ipAddresses:Ljava/util/Set;

    invoke-interface {v1, v2}, Ljava/util/Set;->addAll(Ljava/util/Collection;)Z

    iget-object v1, v0, directlyConnectedRoutes:Ljava/util/Set;

    iget-object v2, p0, directlyConnectedRoutes:Ljava/util/Set;

    invoke-interface {v1, v2}, Ljava/util/Set;->addAll(Ljava/util/Collection;)Z

    iget-object v1, v0, dnsServers:Ljava/util/Set;

    iget-object v2, p0, dnsServers:Ljava/util/Set;
...
.method private static isIPv6DefaultRoute(Landroid/net/IpPrefix;)Z
    ...
    sget-object v1, INET6_ANY:Ljava/net/InetAddress;
...
.method private static isPrefixLengthCompliant(Landroid/net/IpPrefix;)Z
    ...
    invoke-static {p0}, isIPv4(Landroid/net/IpPrefix;)Z
    ...
    invoke-static {v0}, isCompliantIPv6PrefixLength(I)Z
...
.method private static isPrefixLengthCompliant(Landroid/net/LinkAddress;)Z
    ...
    invoke-static {p0}, isIPv4(Landroid/net/LinkAddress;)Z
...
.method public static synthetic lambda$GEWT0gKtlkvLtgqIAII3RLQt3xQ(Landroid/net/IpPrefix;)Z
    ...
    invoke-static {p0}, isPrefixLengthCompliant(Landroid/net/IpPrefix;)Z
...
.method public static synthetic lambda$V8CoLWaph9IN8YQg4mdBlxzUFkI(Landroid/net/LinkAddress;)Z
    ...
    invoke-static {p0}, isPrefixLengthCompliant(Landroid/net/LinkAddress;)Z
...
.method static synthetic lambda$isProvisionedBy$3(Landroid/net/IpPrefix;Landroid/net/RouteInfo;)Z
    ...
    invoke-static {p1, p0}, isDirectlyConnectedRoute(Landroid/net/RouteInfo;Landroid/net/IpPrefix;)Z
...
.method public static synthetic lambda$p_tYzrU5UtVU6wwyLn0miHqz-00(Landroid/net/IpPrefix;)Z
    ...
    invoke-static {p0}, isIPv6DefaultRoute(Landroid/net/IpPrefix;)Z
...
.method public static synthetic lambda$w5pXtjcZU54QER7TNMAvC4NSrfg(Landroid/net/LinkAddress;)Z
    ...
    invoke-static {p0}, isIPv6GUA(Landroid/net/LinkAddress;)Z
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v3, v0, ipAddresses:Ljava/util/Set;
    ...
    iget-object v3, v0, directlyConnectedRoutes:Ljava/util/Set;
    ...
    iget-object v3, v0, dnsServers:Ljava/util/Set;
...
.method public isProvisionedBy(Ljava/util/List;Ljava/util/List;)Z
    ...
    iget-object v0, p0, ipAddresses:Ljava/util/Set;
    ...
    invoke-static {p1, v3}, any(Ljava/lang/Iterable;Ljava/util/function/Predicate;)Z
    ...
    iget-object v0, p0, directlyConnectedRoutes:Ljava/util/Set;
    ...
    invoke-static {p2, v3}, any(Ljava/lang/Iterable;Ljava/util/function/Predicate;)Z
...
.method public isValid()Z
    ...
    iget-object v3, p0, directlyConnectedRoutes:Ljava/util/Set;
    ...
    invoke-static {v3, v4}, any(Ljava/lang/Iterable;Ljava/util/function/Predicate;)Z
    ...
    :cond_2
    iget-object v0, p0, dnsServers:Ljava/util/Set;
    ...
    invoke-static {v2}, not(Ljava/util/function/Predicate;)Ljava/util/function/Predicate;

    move-result-object v2

    invoke-static {v0, v2}, any(Ljava/lang/Iterable;Ljava/util/function/Predicate;)Z
    ...
    invoke-static {v0, v2}, all(Ljava/lang/Iterable;Ljava/util/function/Predicate;)Z
...
.method public toStableParcelable()Landroid/net/InitialConfigurationParcelable;
    ...
    iget-object v1, p0, ipAddresses:Ljava/util/Set;
    ...
    iget-object v1, p0, directlyConnectedRoutes:Ljava/util/Set;
    ...
    iget-object v1, p0, dnsServers:Ljava/util/Set;
