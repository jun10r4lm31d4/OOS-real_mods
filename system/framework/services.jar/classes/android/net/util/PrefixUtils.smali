...
.method static constructor <clinit>()V
    ...
    invoke-static {v1}, pfx(Ljava/lang/String;)Landroid/net/IpPrefix;
    ...
    sput-object v0, MIN_NON_FORWARDABLE_PREFIXES:[Landroid/net/IpPrefix;

    const-string v0, "192.168.49.0/24"

    invoke-static {v0}, pfx(Ljava/lang/String;)Landroid/net/IpPrefix;

    move-result-object v0

    sput-object v0, DEFAULT_WIFI_P2P_PREFIX:Landroid/net/IpPrefix;
...
.method public static addNonForwardablePrefixes(Ljava/util/Set;)V
    ...
    sget-object v0, MIN_NON_FORWARDABLE_PREFIXES:[Landroid/net/IpPrefix;
...
.method public static getNonForwardablePrefixes()Ljava/util/Set;
    ...
    invoke-static {v0}, addNonForwardablePrefixes(Ljava/util/Set;)V
...
.method public static localPrefixesFrom(Landroid/net/LinkProperties;)Ljava/util/Set;
    ...
    :cond_1
    invoke-static {v2}, asIpPrefix(Landroid/net/LinkAddress;)Landroid/net/IpPrefix;
