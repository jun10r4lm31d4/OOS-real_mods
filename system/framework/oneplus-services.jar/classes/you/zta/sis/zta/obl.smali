...
.field private static final sTa:Ljava/math/BigInteger;

.field private static final tTa:Ljava/math/BigInteger;

.field private static final uTa:Ljava/math/BigInteger;

.field public static final vTa:B = 0x10t

.field public static final wTa:[Lyou/zta/sis/zta/vju;

.field public static final xTa:[[B

.field public static final yTa:[Lyou/zta/sis/zta/vju;

.field public static final zTa:[[B
...
.method static constructor <clinit>()V
    ...
    sput-object v0, sTa:Ljava/math/BigInteger;
    ...
    sput-object v0, tTa:Ljava/math/BigInteger;

    sget-object v0, Lyou/zta/sis/zta/sis;->pSa:Ljava/math/BigInteger;

    invoke-virtual {v0}, Ljava/math/BigInteger;->negate()Ljava/math/BigInteger;

    move-result-object v0

    sput-object v0, uTa:Ljava/math/BigInteger;
    ...
    sget-object v7, uTa:Ljava/math/BigInteger;

    sget-object v8, sTa:Ljava/math/BigInteger;
    ...
    sget-object v9, sTa:Ljava/math/BigInteger;
    ...
    sget-object v12, sTa:Ljava/math/BigInteger;
    ...
    sput-object v1, wTa:[Lyou/zta/sis/zta/vju;
    ...
    sget-object v12, uTa:Ljava/math/BigInteger;
    ...
    sput-object v0, yTa:[Lyou/zta/sis/zta/vju;
...
.method protected static ugm(Ljava/math/BigInteger;)I
    ...
    :cond_0
    sget-object v0, Lyou/zta/sis/zta/sis;->Qcb:Ljava/math/BigInteger;
...
.method public static you(BLyou/zta/sis/zta/vju;)[B
    ...
    :cond_1
    :goto_0
    invoke-static {p0, p1}, zta(BLyou/zta/sis/zta/vju;)Ljava/math/BigInteger;
    ...
    iget-object v2, p1, Lyou/zta/sis/zta/vju;->OLa:Ljava/math/BigInteger;
    ...
    sget-object v4, Lyou/zta/sis/zta/sis;->wDa:Ljava/math/BigInteger;
    ...
    sget-object v7, Lyou/zta/sis/zta/sis;->Qcb:Ljava/math/BigInteger;
...
.method public static you(Lyou/zta/sis/zta/rtg$zta;)[Ljava/math/BigInteger;
    ...
    invoke-virtual {p0}, Lyou/zta/sis/zta/rtg$zta;->Hk()Z
    ...
    invoke-static {p0}, ugm(Ljava/math/BigInteger;)I
    ...
    invoke-static {v2, v0, v1}, zta(BIZ)[Ljava/math/BigInteger;
...
.method public static zta(BI)Ljava/math/BigInteger;
    ...
    invoke-static {p0, p1, v1}, zta(BIZ)[Ljava/math/BigInteger;
    ...
    sget-object v2, Lyou/zta/sis/zta/sis;->wDa:Ljava/math/BigInteger;
...
.method public static zta(BLyou/zta/sis/zta/vju;)Ljava/math/BigInteger;
    ...
    iget-object v0, p1, Lyou/zta/sis/zta/vju;->OLa:Ljava/math/BigInteger;

    invoke-virtual {v0, v0}, Ljava/math/BigInteger;->multiply(Ljava/math/BigInteger;)Ljava/math/BigInteger;

    move-result-object v0

    iget-object v1, p1, Lyou/zta/sis/zta/vju;->OLa:Ljava/math/BigInteger;
...
.method public static zta(Ljava/math/BigInteger;IB[Ljava/math/BigInteger;BB)Lyou/zta/sis/zta/vju;
    ...
    invoke-static {v0, p1, v2}, zta(BIZ)[Ljava/math/BigInteger;
    ...
    invoke-static/range {v4 .. v9}, zta(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;BII)Lyou/zta/sis/zta/zgw;
    ...
    invoke-static {v12, v3, v0}, zta(Lyou/zta/sis/zta/zgw;Lyou/zta/sis/zta/zgw;B)Lyou/zta/sis/zta/vju;

    move-result-object v0

    iget-object v3, v0, Lyou/zta/sis/zta/vju;->OLa:Ljava/math/BigInteger;
    ...
    iget-object v4, v0, Lyou/zta/sis/zta/vju;->OLa:Ljava/math/BigInteger;
...
.method public static zta(Lyou/zta/sis/zta/zgw;Lyou/zta/sis/zta/zgw;B)Lyou/zta/sis/zta/vju;
    ...
    :cond_1
    :goto_0
    invoke-virtual {p0}, Lyou/zta/sis/zta/zgw;->tl()Ljava/math/BigInteger;

    move-result-object v2

    invoke-virtual {p1}, Lyou/zta/sis/zta/zgw;->tl()Ljava/math/BigInteger;
    ...
    sget-object p1, sTa:Ljava/math/BigInteger;
    ...
    :cond_5
    sget-object p1, Lyou/zta/sis/zta/sis;->wDa:Ljava/math/BigInteger;
    ...
    :goto_4
    sget-object v1, sTa:Ljava/math/BigInteger;
    ...
    :cond_8
    sget-object v0, tTa:Ljava/math/BigInteger;
...
.method public static zta(Lyou/zta/sis/zta/wtn$zta;)Lyou/zta/sis/zta/wtn$zta;
    ...
    invoke-virtual {p0}, Lyou/zta/sis/zta/wtn$zta;->nl()Lyou/zta/sis/zta/wtn$zta;
...
.method public static zta(Lyou/zta/sis/zta/wtn$zta;Ljava/math/BigInteger;)Lyou/zta/sis/zta/wtn$zta;
    ...
    invoke-virtual {v0}, Lyou/zta/sis/zta/rtg$zta;->Gk()[Ljava/math/BigInteger;
    ...
    invoke-static/range {v1 .. v6}, zta(Ljava/math/BigInteger;IB[Ljava/math/BigInteger;BB)Lyou/zta/sis/zta/vju;

    move-result-object p1

    invoke-static {p0, p1}, zta(Lyou/zta/sis/zta/wtn$zta;Lyou/zta/sis/zta/vju;)Lyou/zta/sis/zta/wtn$zta;
...
.method public static zta(Lyou/zta/sis/zta/wtn$zta;Lyou/zta/sis/zta/vju;)Lyou/zta/sis/zta/wtn$zta;
    ...
    invoke-static {v0}, ywr(Lyou/zta/sis/zta/cno;)B

    move-result v0

    invoke-static {v0, p1}, you(BLyou/zta/sis/zta/vju;)[B

    move-result-object p1

    invoke-static {p0, p1}, zta(Lyou/zta/sis/zta/wtn$zta;[B)Lyou/zta/sis/zta/wtn$zta;
...
.method public static zta(BLyou/zta/sis/zta/vju;BLjava/math/BigInteger;Ljava/math/BigInteger;[Lyou/zta/sis/zta/vju;)[B
    ...
    iget-object v5, v5, Lyou/zta/sis/zta/vju;->OLa:Ljava/math/BigInteger;
...
.method public static zta(BIZ)[Ljava/math/BigInteger;
    ...
    sget-object p2, Lyou/zta/sis/zta/sis;->wDa:Ljava/math/BigInteger;
...
.method public static zta(IILjava/math/BigInteger;)[Ljava/math/BigInteger;
    ...
    invoke-static {p1}, Ua(I)B

    move-result v0

    invoke-static {p2}, ugm(Ljava/math/BigInteger;)I
    ...
    invoke-static {v0, p0, p1}, zta(BIZ)[Ljava/math/BigInteger;
...
.method public static zta(Lyou/zta/sis/zta/wtn$zta;B)[Lyou/zta/sis/zta/wtn$zta;
    ...
    sget-object p1, xTa:[[B

    goto :goto_0

    :cond_0
    sget-object p1, zTa:[[B
    ...
    invoke-static {p0, v4}, zta(Lyou/zta/sis/zta/wtn$zta;[B)Lyou/zta/sis/zta/wtn$zta;
