...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, DEBUG_DUMP:Z

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    sput-object v1, effectMap:Ljava/util/Map;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    sput-object v1, durationMap:Ljava/util/Map;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    sput-object v1, minDurationMap:Ljava/util/Map;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    sput-object v1, maxDurationMap:Ljava/util/Map;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    sput-object v1, enhanceDefaultMap:Ljava/util/Map;

    sput-boolean v0, sShortVibrationOnlineConfigEnabled:Z
...
.method public constructor <init>()V
    ...
    iput v0, p0, intensityWeak:I

    const/16 v0, 0x5e4

    iput v0, p0, intensityMiddle:I

    const/16 v0, 0x776

    iput v0, p0, intensityStrong:I

    const/4 v0, -0x1

    iput v0, p0, oldIntensityEffectType:I

    const/4 v1, 0x0

    iput v1, p0, intensityEffectType:I

    const/4 v2, 0x1

    iput v2, p0, mVibrateOnTouchIntensity:I

    iput v2, p0, mNoticeVibrateIntensity:I

    iput-boolean v1, p0, repeatVibrate:Z

    iput v1, p0, intensityStrengthType:I

    iput-boolean v1, p0, isEffectChanged:Z

    iput-boolean v1, p0, isVibrating:Z

    const-string v1, ""

    iput-object v1, p0, imPkg:Ljava/lang/String;

    const-string v1, "/sys/class/leds/vibrator/vmax_mv"

    iput-object v1, p0, mVibratorIntensityPath:Ljava/lang/String;

    new-instance v1, Ljava/util/LinkedHashMap;

    invoke-direct {v1}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v1, p0, mEffectConfigs:Ljava/util/HashMap;
    ...
    iput-object v1, p0, mPackageNameList:Ljava/util/ArrayList;

    iput v0, p0, mMinDuration:I

    iput v0, p0, mMaxDuration:I

    iput v0, p0, mEffect:I
...
.method static synthetic access$200()Z
    ...
    sget-boolean v0, sShortVibrationOnlineConfigEnabled:Z
...
.method static synthetic access$202(Z)Z
    ...
    sput-boolean p0, sShortVibrationOnlineConfigEnabled:Z
...
.method static synthetic access$300(Lcom/android/server/OpVibratorService;)Ljava/util/HashMap;
    ...
    iget-object p0, p0, mEffectConfigs:Ljava/util/HashMap;
...
.method static synthetic access$400(Lcom/android/server/OpVibratorService;)Ljava/util/ArrayList;
    ...
    iget-object p0, p0, mPackageNameList:Ljava/util/ArrayList;
...
.method static synthetic access$800(Lcom/android/server/OpVibratorService;)V
    ...
    invoke-direct {p0}, clearConfig()V
...
.method private clearConfig()V
    ...
    iget-object v0, p0, mPackageNameList:Ljava/util/ArrayList;
...
.method private getVibrationRules(Ljava/lang/String;)V
    ...
    iget-object v3, p0, mPackageNameList:Ljava/util/ArrayList;
    ...
    iput v1, p0, mEffect:I

    const/4 v1, 0x0

    :goto_1
    iget-object v2, p0, mPackageNameList:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, mEffectConfigs:Ljava/util/HashMap;
    ...
    iget v5, p0, mMinDuration:I

    iget v6, p0, mMaxDuration:I

    iget v7, p0, mEffect:I
...
.method private grabOnlineConfig()V
    ...
    iget-object p0, p0, mConfigUpdater:Lcom/android/server/OpVibratorService$zta;
...
.method private writeNodeValue(I)V
    ...
    iget-object p0, p0, mVibratorIntensityPath:Ljava/lang/String;
...
.method public doVibratorOn(JI)V
    ...
    iget p3, p0, intensityEffectType:I
    ...
    iget p3, p0, intensityStrengthType:I
    ...
    iget p0, p0, intensityStrengthType:I
...
.method public doVibratorPerformEffect(II)J
    ...
    iget v1, p0, mVibrateOnTouchIntensity:I
    ...
    iget p0, p0, mVibrateOnTouchIntensity:I
...
.method public doVibratorSetAmplitude(I)V
    ...
    iget v2, p0, intensityStrengthType:I
...
.method public getDurationMap()Ljava/util/Map;
    ...
    sget-object p0, durationMap:Ljava/util/Map;
...
.method public getEffectMap()Ljava/util/Map;
    ...
    sget-object p0, effectMap:Ljava/util/Map;
...
.method public getImPkg()Ljava/lang/String;
    ...
    iget-object p0, p0, imPkg:Ljava/lang/String;
...
.method public getIntensityEffectType()I
    ...
    iget p0, p0, intensityEffectType:I
...
.method public getOldIntensityEffectType()I
    ...
    iget p0, p0, oldIntensityEffectType:I
...
.method public getRepeatVibrate()Z
    ...
    iget-boolean p0, p0, repeatVibrate:Z
...
.method public getVibratorEffectMap(Ljava/lang/String;)V
    ...
    sget-object v3, effectMap:Ljava/util/Map;
    ...
    sget-object v4, durationMap:Ljava/util/Map;
    ...
    :try_start_2
    sget-object v3, minDurationMap:Ljava/util/Map;
    ...
    sget-object v3, maxDurationMap:Ljava/util/Map;
    ...
    sget-object v3, enhanceDefaultMap:Ljava/util/Map;
...
.method public initCaliFile()V
    ...
    invoke-static {p0, v0}, readStringFromFile(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v1, p0}, writeStringToFile(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
...
.method public initVibratorEffectMap(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iput-object p1, p0, mVibratorIntensityPath:Ljava/lang/String;

    :cond_1
    const-string p1, "/system/etc/vibrator_effect_map.xml"

    invoke-virtual {p0, p1}, getVibratorEffectMap(Ljava/lang/String;)V
    ...
    invoke-direct {p1, p0, p2}, Lcom/android/server/OpVibratorService$zta;-><init>(Lcom/android/server/OpVibratorService;Lcom/android/server/n;)V

    iput-object p1, p0, mConfigUpdater:Lcom/android/server/OpVibratorService$zta;
    ...
    invoke-direct {p0, p1}, getVibrationRules(Ljava/lang/String;)V
...
.method public isVibrating()Z
    ...
    iget-boolean p0, p0, isVibrating:Z
...
.method public motorF0Calibration()V
    ...
    invoke-static {p0, v6, v4}, writeStringToFile(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p0, v6}, readStringFromFile(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2, v0, v1}, writeStringToFile(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z

    sget-object v0, TAG:Ljava/lang/String;

    invoke-static {v0, v6, p0}, writeStringToFile(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p0, v0, v1}, writeStringToFile(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
...
.method public setIntensityEffectType(I)V
    ...
    iput p1, p0, intensityEffectType:I
...
.method public setIsEffectChanged(Z)V
    ...
    iput-boolean p1, p0, isEffectChanged:Z
...
.method public setIsVibrating(Z)V
    ...
    iput-boolean p1, p0, isVibrating:Z
...
.method public setOldIntensityEffectType(I)V
    ...
    iput p1, p0, oldIntensityEffectType:I
...
.method public setRepeatVibrate(Z)V
    ...
    iput-boolean p1, p0, repeatVibrate:Z
...
.method public setVibratorEffect(Lcom/android/server/VibratorService$Vibration;ILjava/lang/Object;)I
    ...
    :cond_2
    sget-object v1, effectMap:Ljava/util/Map;
    ...
    iget p1, p0, intensityEffectType:I
    ...
    :cond_5
    iput v2, p0, oldIntensityEffectType:I
    ...
    :try_start_0
    iget-boolean p1, p0, isVibrating:Z
    ...
    iput-boolean v3, p0, isEffectChanged:Z
...
.method public updateVibrator()V
    ...
    iput-object v0, p0, imPkg:Ljava/lang/String;
    ...
    iput v0, p0, mVibrateOnTouchIntensity:I
    ...
    iput v0, p0, mNoticeVibrateIntensity:I
...
.method public vibrate(ILandroid/os/VibrationEffect;Ljava/lang/String;Ljava/lang/String;)Landroid/os/VibrationEffect;
    ...
    invoke-direct {v0, v9}, writeNodeValue(I)V

    iput v11, v0, intensityStrengthType:I
    ...
    invoke-direct {v0, v7}, writeNodeValue(I)V

    iput v10, v0, intensityStrengthType:I
    ...
    invoke-direct {v0, v6}, writeNodeValue(I)V

    iput v5, v0, intensityStrengthType:I
    ...
    :cond_3
    iget-boolean v6, v0, isEffectChanged:Z

    if-nez v6, :cond_5

    iget-boolean v6, v0, isVibrating:Z
    ...
    :cond_4
    iput v12, v0, intensityEffectType:I
    ...
    iget v6, v0, mNoticeVibrateIntensity:I

    add-int/2addr v6, v11

    iput v6, v0, intensityStrengthType:I
    ...
    iget v4, v0, mNoticeVibrateIntensity:I

    add-int/2addr v4, v11

    iput v4, v0, intensityStrengthType:I
    ...
    iget v14, v0, mVibrateOnTouchIntensity:I
    ...
    :cond_8
    iget v4, v0, mVibrateOnTouchIntensity:I
    ...
    :cond_c
    :goto_2
    sget-object v4, minDurationMap:Ljava/util/Map;
    ...
    sget-object v6, maxDurationMap:Ljava/util/Map;
    ...
    :cond_d
    iget-object v7, v0, imPkg:Ljava/lang/String;
    ...
    iput v7, v0, intensityStrengthType:I

    const/16 v7, 0x3e7

    iput v7, v0, intensityEffectType:I

    sget-object v7, enhanceDefaultMap:Ljava/util/Map;
    ...
    invoke-direct {v0, v2}, isSystemApp(Ljava/lang/String;)Z
    ...
    :cond_17
    iget-object v3, v0, imPkg:Ljava/lang/String;
    ...
    :goto_6
    iget-object v3, v0, mEffectConfigs:Ljava/util/HashMap;
    ...
    iget-object v5, v0, mEffectConfigs:Ljava/util/HashMap;
    ...
    invoke-virtual {v5}, Lcom/android/server/OpVibratorService$you;->ra()I

    move-result v6

    invoke-virtual {v5}, Lcom/android/server/OpVibratorService$you;->qa()I

    move-result v7

    invoke-virtual {v5}, Lcom/android/server/OpVibratorService$you;->pa()I
    ...
    iput v5, v0, intensityEffectType:I
    ...
    iget v0, v0, intensityEffectType:I
