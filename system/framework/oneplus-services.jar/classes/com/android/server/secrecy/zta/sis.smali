...
.field public static final YS:Z = false

.field public static final ZS:Z = true
...
# instance fields
.field private final OS:Lcom/android/server/secrecy/sis;

.field private PS:Lcom/android/server/secrecy/SecrecyService;
...
.field private VS:Lcom/android/server/secrecy/zta/you;

.field private WS:Lcom/android/server/secrecy/zta/zta;

.field private XS:Lcom/android/server/secrecy/zta/rtg;
...
.field private rtg:Lcom/android/server/secrecy/zta/tsu;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, OS:Lcom/android/server/secrecy/sis;
...
.method public static getInstance()Lcom/android/server/secrecy/zta/sis;
    ...
    :try_start_0
    sget-object v1, sInstance:Lcom/android/server/secrecy/zta/sis;
    ...
    sput-object v1, sInstance:Lcom/android/server/secrecy/zta/sis;
    ...
    sget-object v0, sInstance:Lcom/android/server/secrecy/zta/sis;
...
.method private iq()V
    ...
    iget-object v0, p0, VS:Lcom/android/server/secrecy/zta/you;

    invoke-virtual {v0}, Lcom/android/server/secrecy/zta/you;->ce()J

    move-result-wide v0

    iget-object v2, p0, VS:Lcom/android/server/secrecy/zta/you;

    invoke-virtual {v2}, Lcom/android/server/secrecy/zta/you;->de()J

    move-result-wide v2

    iget-object v4, p0, VS:Lcom/android/server/secrecy/zta/you;

    invoke-virtual {v4}, Lcom/android/server/secrecy/zta/you;->ee()Z
    ...
    invoke-virtual {p0, v0, v1}, zta(Ljava/util/Map;Z)V

    const-string v1, "newDownloadInternal"

    invoke-virtual {p0, v0, v1}, zta(Ljava/util/Map;Ljava/lang/String;)V
...
.method private jq()V
    ...
    iget-object v0, p0, OS:Lcom/android/server/secrecy/sis;
    ...
    iget-object p0, p0, OS:Lcom/android/server/secrecy/sis;

    invoke-virtual {p0}, Lcom/android/server/secrecy/sis;->veq()V
...
.method private ssp(Ljava/lang/String;Z)V
    ...
    iget-object p0, p0, rtg:Lcom/android/server/secrecy/zta/tsu;

    invoke-virtual {p0, p1}, Lcom/android/server/secrecy/zta/tsu;->fa(Ljava/lang/String;)V
...
.method private you(Ljava/util/Map;Ljava/lang/String;Z)V
    ...
    iput-boolean v3, p0, RS:Z

    invoke-static {v2}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v2

    iget-boolean v3, p0, RS:Z
    ...
    iput-boolean v3, p0, SS:Z

    invoke-static {v4}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v2

    iget-boolean v3, p0, SS:Z
    ...
    iput-boolean p1, p0, TS:Z

    invoke-static {v3}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object p1

    iget-boolean v2, p0, TS:Z
    ...
    :cond_3
    invoke-direct {p0, p2, v2}, ssp(Ljava/lang/String;Z)V
...
.method public ca(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/secrecy/zta/you;->ca(Ljava/lang/String;)V

    invoke-direct {p0}, iq()V

    return-void
.end method

.method public ce()Ljava/lang/Long;
    .locals 2

    iget-object p0, p0, VS:Lcom/android/server/secrecy/zta/you;

    invoke-virtual {p0}, Lcom/android/server/secrecy/zta/you;->ce()J
...
.method public cjf()V
    ...
    :cond_0
    iget-object v0, p0, XS:Lcom/android/server/secrecy/zta/rtg;

    invoke-virtual {v0}, Lcom/android/server/secrecy/zta/rtg;->qe()Z

    move-result v0

    iget-object v1, p0, XS:Lcom/android/server/secrecy/zta/rtg;

    invoke-virtual {v1}, Lcom/android/server/secrecy/zta/rtg;->le()Z

    move-result v1

    iget-object v2, p0, XS:Lcom/android/server/secrecy/zta/rtg;

    invoke-virtual {v2}, Lcom/android/server/secrecy/zta/rtg;->oe()Z

    move-result v2

    iget-object v3, p0, XS:Lcom/android/server/secrecy/zta/rtg;

    invoke-virtual {v3}, Lcom/android/server/secrecy/zta/rtg;->me()Z
    ...
    iget-object v0, p0, rtg:Lcom/android/server/secrecy/zta/tsu;

    iget-object v4, p0, XS:Lcom/android/server/secrecy/zta/rtg;

    invoke-virtual {v4}, Lcom/android/server/secrecy/zta/rtg;->pe()J

    move-result-wide v4

    iget-object v6, p0, XS:Lcom/android/server/secrecy/zta/rtg;

    invoke-virtual {v6}, Lcom/android/server/secrecy/zta/rtg;->ne()J
...
.method public da(Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, getImei()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/android/server/secrecy/sis;->aa(Ljava/lang/String;)V

    iget-object v0, p0, OS:Lcom/android/server/secrecy/sis;

    invoke-virtual {v0, p1}, Lcom/android/server/secrecy/sis;->ba(Ljava/lang/String;)V
...
.method public ge()Lcom/android/server/secrecy/zta/zta;
    .locals 0

    iget-object p0, p0, WS:Lcom/android/server/secrecy/zta/zta;
...
.method public he()Z
    ...
    iget-object v0, p0, PS:Lcom/android/server/secrecy/SecrecyService;

    invoke-virtual {v0}, Lcom/android/server/secrecy/SecrecyService;->Fa()Z
    ...
    invoke-virtual {v0}, Lcom/android/server/secrecy/zta/you;->ee()Z
    ...
    invoke-virtual {p0}, Lcom/android/server/secrecy/zta/you;->de()J
...
.method public systemReady(Z)V
    ...
    invoke-virtual {v0}, Lcom/android/server/secrecy/zta/you;->fe()V

    invoke-direct {p0}, jq()V

    if-eqz p1, :cond_0

    invoke-virtual {p0}, td()V
    ...
    :cond_0
    iget-object p1, p0, rtg:Lcom/android/server/secrecy/zta/tsu;

    iget-object v0, p0, XS:Lcom/android/server/secrecy/zta/rtg;

    invoke-virtual {v0}, Lcom/android/server/secrecy/zta/rtg;->pe()J

    move-result-wide v0

    iget-object p0, p0, XS:Lcom/android/server/secrecy/zta/rtg;

    invoke-virtual {p0}, Lcom/android/server/secrecy/zta/rtg;->ne()J
...
.method public tsu(Ljava/util/Map;)V
    ...
    invoke-direct {p0, p1}, rtg(Ljava/util/Map;)V
...
.method public zta(Landroid/content/Context;Lcom/android/server/secrecy/SecrecyService;Landroid/os/Looper;)V
    ...
    iput-object p2, p0, PS:Lcom/android/server/secrecy/SecrecyService;

    new-instance p2, Lcom/android/server/secrecy/zta/you;

    invoke-direct {p2}, Lcom/android/server/secrecy/zta/you;-><init>()V

    iput-object p2, p0, VS:Lcom/android/server/secrecy/zta/you;
    ...
    iput-object p2, p0, WS:Lcom/android/server/secrecy/zta/zta;
    ...
    iput-object p1, p0, rtg:Lcom/android/server/secrecy/zta/tsu;
    ...
    iput-object p1, p0, XS:Lcom/android/server/secrecy/zta/rtg;
...
.method public zta(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;)V
    ...
    iget-object v1, p0, PS:Lcom/android/server/secrecy/SecrecyService;

    invoke-virtual {v1}, Lcom/android/server/secrecy/SecrecyService;->Fa()Z
    ...
    iget-boolean v1, p0, SS:Z

    if-eqz v1, :cond_0

    iget-boolean v1, p0, TS:Z
...
.method public zta(Ljava/util/Map;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, p2, v0}, zta(Ljava/util/Map;Ljava/lang/String;Z)V
...
.method public zta(Ljava/util/Map;Ljava/lang/String;Z)V
    ...
    invoke-direct {p0, p1, p2, p3}, you(Ljava/util/Map;Ljava/lang/String;Z)V
