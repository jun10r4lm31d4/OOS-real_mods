...
.field private static final pS:I = 0x1
...
.field private static final sS:Ljava/lang/String; = "imei"

.field private static final tS:Ljava/lang/String; = "rc4_key"

.field private static final uS:Ljava/lang/String; = "last_download_time"

.field private static final vS:Ljava/lang/String; = "encrypt_app"

.field private static final wS:Ljava/lang/String; = "encrypt_log"

.field private static final xS:Ljava/lang/String; = "encrypt_adb"
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, lS:Ljava/lang/String;

    const/16 v0, 0x100

    new-array v0, v0, [B

    iput-object v0, p0, mS:[B
...
.method private fq()V
    ...
    invoke-static {}, Lcom/android/server/secrecy/zta/zta/tsu;->se()Z
    ...
    :cond_0
    invoke-direct {p0}, gq()Ljava/lang/String;
    ...
    :cond_1
    iget-object v6, p0, mPolicyManager:Lcom/android/server/secrecy/zta/sis;

    invoke-virtual {v6}, Lcom/android/server/secrecy/zta/sis;->he()Z
    ...
    iget-object v1, p0, mPolicyManager:Lcom/android/server/secrecy/zta/sis;
    ...
    iput-object v1, p0, nS:[B

    iget-object v1, p0, mS:[B

    iget-object v9, p0, nS:[B
    ...
    iput-object v1, p0, oS:Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/secrecy/zta/sis;->ca(Ljava/lang/String;)V
    :try_end_5
...
.method public static getInstance()Lcom/android/server/secrecy/sis;
    ...
    sget-object v0, sInstanceLock:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    sget-object v1, sInstance:Lcom/android/server/secrecy/sis;
    ...
    sput-object v1, sInstance:Lcom/android/server/secrecy/sis;
    ...
    sget-object v0, sInstance:Lcom/android/server/secrecy/sis;
...
.method private hq()V
    ...
    :try_start_1
    iget-object v3, p0, mPolicyManager:Lcom/android/server/secrecy/zta/sis;

    const/4 v4, 0x1

    invoke-virtual {v3, v4}, Lcom/android/server/secrecy/zta/sis;->z(I)Z

    move-result v3

    iget-object v4, p0, mPolicyManager:Lcom/android/server/secrecy/zta/sis;

    const/4 v5, 0x2

    invoke-virtual {v4, v5}, Lcom/android/server/secrecy/zta/sis;->z(I)Z

    move-result v4

    iget-object v5, p0, mPolicyManager:Lcom/android/server/secrecy/zta/sis;

    const/4 v6, 0x4

    invoke-virtual {v5, v6}, Lcom/android/server/secrecy/zta/sis;->z(I)Z

    move-result v5

    iget-object v6, p0, mPolicyManager:Lcom/android/server/secrecy/zta/sis;

    invoke-virtual {v6}, Lcom/android/server/secrecy/zta/sis;->ce()Ljava/lang/Long;
    ...
    iget-object v7, p0, oS:Ljava/lang/String;

    if-eqz v7, :cond_1

    const-string v7, "imei"

    iget-object v8, p0, oS:Ljava/lang/String;
    ...
    invoke-direct {p0, v0}, yc(Ljava/lang/String;)V
    :try_end_2
...
.method public aa(Ljava/lang/String;)V
    ...
    iput-object p1, p0, oS:Ljava/lang/String;
...
.method public zta(Lcom/android/server/secrecy/zta/sis;Landroid/os/Looper;)V
    ...
    iput-object p1, p0, mPolicyManager:Lcom/android/server/secrecy/zta/sis;
...
.method public zta(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    iget-object p0, p0, oS:Ljava/lang/String;
