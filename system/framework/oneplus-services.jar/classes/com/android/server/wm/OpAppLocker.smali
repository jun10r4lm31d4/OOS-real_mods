...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, mKeyguardDone:Z

    const/4 v0, 0x0

    sput-boolean v0, mHintConfirmed:Z
...
.method private getConfirmIntent()Landroid/content/Intent;
    ...
    iget-object v0, p0, mConfirmIntent:Landroid/content/Intent;
    ...
    iput-object v0, p0, mConfirmIntent:Landroid/content/Intent;
    ...
    iget-object v2, p0, mConfirmIntent:Landroid/content/Intent;
    ...
    :cond_1
    iget-object p0, p0, mConfirmIntent:Landroid/content/Intent;
...
.method private final oemStartActivityAsCaller(Landroid/app/IApplicationThread;Ljava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/os/IBinder;Ljava/lang/String;IILandroid/app/ProfilerInfo;Landroid/os/Bundle;ZI)I
    ...
    sget-object p0, mATMService:Lcom/android/server/wm/ActivityTaskManagerService;
...
.method public addAppLockerPassedPackage(Ljava/lang/String;)V
    ...
    :cond_0
    sget-object v0, mPassedPackageList:Ljava/util/ArrayList;
...
.method public clearAppLockerPassedList()V
    ...
    sget-object v0, mATMService:Lcom/android/server/wm/ActivityTaskManagerService;
    ...
    :try_start_1
    sget-object v3, mPassedPackageList:Ljava/util/ArrayList;

    invoke-virtual {v3}, Ljava/util/ArrayList;->clear()V

    sget-object v3, mATMService:Lcom/android/server/wm/ActivityTaskManagerService;
    ...
    :goto_0
    invoke-virtual {p0, v4, v5}, lockTopApp(Lcom/android/server/wm/ActivityStack;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v3, v4}, lockTopApp(Lcom/android/server/wm/ActivityStack;Ljava/lang/String;)V
    :try_end_1
...
.method public initOpAppLocker(Lcom/android/server/wm/ActivityTaskManagerService;)V
    ...
    sput-object p1, mATMService:Lcom/android/server/wm/ActivityTaskManagerService;
    ...
    sget-object v1, mATMService:Lcom/android/server/wm/ActivityTaskManagerService;
    ...
    :cond_0
    invoke-direct {p0}, getConfirmIntent()Landroid/content/Intent;
    ...
    sput p0, mRequestHashCode:I

    new-instance p0, Ljava/util/ArrayList;

    invoke-direct {p0}, Ljava/util/ArrayList;-><init>()V

    sput-object p0, mPassedPackageList:Ljava/util/ArrayList;

    new-instance p0, Ljava/util/ArrayList;

    sget-object p1, mATMService:Lcom/android/server/wm/ActivityTaskManagerService;
    ...
    sput-object p0, mAppLockerKeyguardWhiteList:Ljava/util/ArrayList;
    ...
    sput-object p0, mAppLockerWhiteList:Ljava/util/ArrayList;
...
.method public isAppLocked(Lcom/android/server/wm/ActivityRecord;)Z
    ...
    :cond_0
    sget-object v1, mConfirmResolveInfo:Landroid/content/pm/ResolveInfo;
    ...
    iget-object v3, p0, mConfirmIntent:Landroid/content/Intent;
    ...
    sput-object v1, mConfirmResolveInfo:Landroid/content/pm/ResolveInfo;
    ...
    :goto_3
    sput-boolean v3, mHintConfirmed:Z
    ...
    sget-boolean v3, mKeyguardDone:Z

    if-eqz v3, :cond_8

    sget-object v3, mATMService:Lcom/android/server/wm/ActivityTaskManagerService;

    invoke-virtual {v3}, Lcom/android/server/wm/ActivityTaskManagerService;->getAppOpsService()Lcom/android/server/appop/AppOpsService;
    ...
    invoke-virtual {v3, v4, v5, v6}, Lcom/android/server/appop/AppOpsService;->checkOperation(IILjava/lang/String;)I
    ...
    sget-object v3, mAppLockerWhiteList:Ljava/util/ArrayList;
    ...
    :cond_7
    invoke-virtual {p0, v1}, isAppLockerEnabled(I)Z
...
.method public isAppLocked(Ljava/lang/String;I)Z
    ...
    :try_start_0
    sget-object v2, mATMService:Lcom/android/server/wm/ActivityTaskManagerService;

    invoke-virtual {v2}, Lcom/android/server/wm/ActivityTaskManagerService;->getAppOpsService()Lcom/android/server/appop/AppOpsService;

    move-result-object v2

    const/16 v3, 0x3e9

    invoke-virtual {v2, v3, p2, p1}, Lcom/android/server/appop/AppOpsService;->checkOperation(IILjava/lang/String;)I

    move-result p2

    if-nez p2, :cond_0

    sget-object p2, mPassedPackageList:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v0}, isAppLockerEnabled(I)Z
...
.method public isKeyguardDone()Z
    ...
    sget-boolean p0, mKeyguardDone:Z
...
.method public isTopAppLocked(Landroid/app/ActivityManager$RecentTaskInfo;I)Z
    ...
    sget-object v4, mATMService:Lcom/android/server/wm/ActivityTaskManagerService;
    ...
    sget-object v4, mPassedPackageList:Ljava/util/ArrayList;
...
.method public lockAppIfNeed(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;)Z
    ...
    invoke-virtual {v14, v1}, isAppLocked(Lcom/android/server/wm/ActivityRecord;)Z
    ...
    invoke-direct/range {p0 .. p0}, getConfirmIntent()Landroid/content/Intent;
    ...
    invoke-direct/range {v1 .. v13}, oemStartActivityAsCaller(Landroid/app/IApplicationThread;Ljava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/os/IBinder;Ljava/lang/String;IILandroid/app/ProfilerInfo;Landroid/os/Bundle;ZI)I
...
.method public lockTopApp(Lcom/android/server/wm/ActivityStack;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v2}, isAppLocked(Lcom/android/server/wm/ActivityRecord;)Z
    ...
    sget-object v3, mAppLockerKeyguardWhiteList:Ljava/util/ArrayList;
    ...
    sget-object v1, mPassedPackageList:Ljava/util/ArrayList;
    ...
    iget-object v4, v0, mConfirmIntent:Landroid/content/Intent;
    ...
    invoke-direct/range {v0 .. v12}, oemStartActivityAsCaller(Landroid/app/IApplicationThread;Ljava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/os/IBinder;Ljava/lang/String;IILandroid/app/ProfilerInfo;Landroid/os/Bundle;ZI)I
...
.method public setKeyguardDone(Z)V
    ...
    :cond_2
    sput-boolean p1, mKeyguardDone:Z
...
.method public showHint(Lcom/android/server/wm/ActivityRecord;)V
    ...
    sget-boolean v2, mHintConfirmed:Z

    if-nez v2, :cond_1

    sget-object v2, mPassedPackageList:Ljava/util/ArrayList;
    ...
    invoke-direct/range {v2 .. v14}, oemStartActivityAsCaller(Landroid/app/IApplicationThread;Ljava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/os/IBinder;Ljava/lang/String;IILandroid/app/ProfilerInfo;Landroid/os/Bundle;ZI)I

    :goto_0
    sput-boolean v15, mHintConfirmed:Z
...
.method public unLockAppIfNeed(Lcom/android/server/wm/ActivityRecord;ILandroid/content/Intent;)Z
    ...
    sget-object p0, mPassedPackageList:Ljava/util/ArrayList;
    ...
    :cond_0
    sget-boolean p3, mHintConfirmed:Z

    if-nez p3, :cond_1

    if-ne p2, p0, :cond_1

    sput-boolean p1, mHintConfirmed:Z
