...
.field mi:Lcom/android/server/wm/OpPowerConsumpStats$oif;
...
.method constructor <init>(Lcom/android/server/wm/OpPowerConsumpStats;Ljava/lang/String;F)V
    ...
    new-instance p1, Lcom/android/server/wm/OpPowerConsumpStats$oif;

    iget-object v0, p0, this$0:Lcom/android/server/wm/OpPowerConsumpStats;

    invoke-direct {p1, v0}, Lcom/android/server/wm/OpPowerConsumpStats$oif;-><init>(Lcom/android/server/wm/OpPowerConsumpStats;)V

    iput-object p1, p0, mi:Lcom/android/server/wm/OpPowerConsumpStats$oif;
...
.method private getTime()J
    ...
    iget-object p0, p0, mi:Lcom/android/server/wm/OpPowerConsumpStats$oif;

    invoke-virtual {p0}, Lcom/android/server/wm/OpPowerConsumpStats$oif;->ia()J
...
# virtual methods
.method public declared-synchronized Ke()Z
    .locals 1

    monitor-enter p0

    :try_start_0
    iget-boolean v0, p0, Aaa:Z
    :try_end_0
...
.method public declared-synchronized flushToDisk()V
    ...
    invoke-direct {p0, v1, v0}, zta(Ljava/lang/String;F)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized reset()V
    ...
    iput-boolean v0, p0, Aaa:Z

    iget-object v0, p0, mi:Lcom/android/server/wm/OpPowerConsumpStats$oif;

    invoke-virtual {v0}, Lcom/android/server/wm/OpPowerConsumpStats$oif;->reset()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized start()V
    ...
    :cond_1
    iput-boolean v1, p0, Aaa:Z

    iget-object v0, p0, mi:Lcom/android/server/wm/OpPowerConsumpStats$oif;

    invoke-virtual {v0}, Lcom/android/server/wm/OpPowerConsumpStats$oif;->start()Lcom/android/server/wm/OpPowerConsumpStats$oif;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public declared-synchronized stop()V
    ...
    iget-object v2, p0, mi:Lcom/android/server/wm/OpPowerConsumpStats$oif;

    invoke-virtual {v2}, Lcom/android/server/wm/OpPowerConsumpStats$oif;->stop()J
