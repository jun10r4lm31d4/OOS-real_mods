...
.method static constructor <clinit>()V
    ...
    sput-object v0, STOREDCALLINGRELATIONS:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    sput-boolean v0, IS_PARALLEL_APP_FEATURED:Z
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, sourceIntent:Landroid/content/Intent;
...
.method private addUserIdtoClipData(Landroid/content/Intent;I)Landroid/content/Intent;
    ...
    invoke-direct {p0, v2, p2}, maybeAddUserId(Landroid/net/Uri;I)Landroid/net/Uri;
...
.method private dontShowParallelAppDialog(Landroid/content/Intent;)Z
    ...
    sget-object p1, sOneplusService:Lcom/oneplus/server/OnePlusService;
    ...
    sput-object p1, sOneplusService:Lcom/oneplus/server/OnePlusService;
...
.method private maybeAddOwnerUserIdtoIntent(Landroid/content/Intent;)Landroid/content/Intent;
    ...
    :cond_2
    invoke-direct {p0, p1, v2}, addUserIdtoClipData(Landroid/content/Intent;I)Landroid/content/Intent;
    ...
    invoke-direct {p0, v1, v2}, maybeAddUserId(Landroid/net/Uri;I)Landroid/net/Uri;
...
.method private maybeAddParallelUserIdtoIntent(Landroid/content/Intent;)Landroid/content/Intent;
    ...
    :cond_1
    invoke-direct {p0, p1, v8}, addUserIdtoClipData(Landroid/content/Intent;I)Landroid/content/Intent;
    ...
    invoke-direct {p0, v3, v8}, maybeAddUserId(Landroid/net/Uri;I)Landroid/net/Uri;
    ...
    invoke-direct {p0, v0, v8}, maybeAddUserId(Landroid/net/Uri;I)Landroid/net/Uri;
    ...
    invoke-direct {p0, v2, v8}, maybeAddUserId(Landroid/net/Uri;I)Landroid/net/Uri;
...
.method private maybeAddUserId(Landroid/net/Uri;I)Landroid/net/Uri;
    ...
    invoke-direct {p0, p1}, uriHasUserId(Landroid/net/Uri;)Z
...
.method public checkParallelAppControl(Landroid/app/IApplicationThread;ILjava/lang/String;ILjava/lang/String;ILandroid/content/pm/ActivityInfo;Landroid/content/Intent;Lcom/android/server/wm/SafeActivityOptions;)Z
    ...
    invoke-direct {p0, p7}, needSkipShareScene(Landroid/content/pm/ActivityInfo;)Z
    ...
    :cond_4
    invoke-direct {p0, p8}, dontShowParallelAppDialog(Landroid/content/Intent;)Z
    ...
    iput-object p5, p0, mAppOpsService:Lcom/android/server/appop/AppOpsService;

    iget-object p0, p0, mAppOpsService:Lcom/android/server/appop/AppOpsService;
...
.method public getBackUserIdFromStoredCallingRelation(Ljava/lang/String;Ljava/lang/String;)I
    ...
    sget-object p2, STOREDCALLINGRELATIONS:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public getSourceIntent()Landroid/content/Intent;
    ...
    iget-object p0, p0, sourceIntent:Landroid/content/Intent;
...
.method public maybeAddUserIdtoIntent(ILandroid/content/Intent;I)Landroid/content/Intent;
    ...
    invoke-direct {p0, p2}, maybeAddParallelUserIdtoIntent(Landroid/content/Intent;)Landroid/content/Intent;
    ...
    invoke-direct {p0, p2}, maybeAddOwnerUserIdtoIntent(Landroid/content/Intent;)Landroid/content/Intent;
...
.method resolveOtaWizardActivity(Landroid/content/Context;ILandroid/content/Intent;)Landroid/content/pm/ActivityInfo;
    ...
    invoke-virtual {p0, p1, p2}, getAppInfoForUser(Landroid/content/pm/ApplicationInfo;I)Landroid/content/pm/ApplicationInfo;
...
.method public setSourceIntent(Landroid/content/Intent;)V
    ...
    iput-object p1, p0, sourceIntent:Landroid/content/Intent;
...
.method public storeCallingRelation(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    sget-object p1, STOREDCALLINGRELATIONS:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public updateOtaWizardHomeIntent(Landroid/content/Intent;Landroid/content/Context;I)Landroid/content/pm/ActivityInfo;
    ...
    invoke-virtual {p0, p2, p3, p1}, resolveOtaWizardActivity(Landroid/content/Context;ILandroid/content/Intent;)Landroid/content/pm/ActivityInfo;
