...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, sIsResolutionAuto:Z
    ...
    sput v0, RECORD_MODE_DELAY_SHORT:I
...
.method public constructor <init>()V
    ...
    iput v0, p0, mScreenRateSettings:I

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mForcedRateList:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, mFixedRatePackage:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, mCtsRatePackage:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, mParamsMap:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, mModeRecordMap:Ljava/util/HashMap;

    const/4 v0, 0x0

    iput-boolean v0, p0, mServiceReady:Z

    iput v0, p0, mResolotionSettings:I

    const/4 v0, 0x0

    iput-object v0, p0, mScreenModeConfigObserver:Lcom/oneplus/config/ConfigObserver;

    iput-object v0, p0, mScreenModeHandler:Lcom/android/server/wm/OpScreenModeService$sis;
...
.method static synthetic access$000(Lcom/android/server/wm/OpScreenModeService;)Lcom/android/server/wm/OpScreenModeService$sis;
    ...
    iget-object p0, p0, mScreenModeHandler:Lcom/android/server/wm/OpScreenModeService$sis;
...
.method static synthetic access$300(Lcom/android/server/wm/OpScreenModeService;Lcom/android/server/wm/AppWindowToken;)V
    ...
    invoke-direct {p0, p1}, updateRefreshRate(Lcom/android/server/wm/AppWindowToken;)V
...
.method static synthetic access$400(Lcom/android/server/wm/OpScreenModeService;I)V
    ...
    invoke-direct {p0, p1}, handleUpdateScenario(I)V
...
.method private resolveConfigFromJSON(Lorg/json/JSONArray;)V
    ...
    :cond_0
    iget-object v0, p0, mFixedRatePackage:Ljava/util/HashMap;

    invoke-virtual {v0}, Ljava/util/HashMap;->clear()V

    iget-object v0, p0, mForcedRateList:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    invoke-virtual {p0}, initCtsRateList()V
    ...
    iget-object v6, p0, mFixedRatePackage:Ljava/util/HashMap;
    ...
    :try_start_1
    iget-object v7, p0, mFixedRatePackage:Ljava/util/HashMap;
    ...
    iget-object v4, p0, mForcedRateList:Ljava/util/ArrayList;
    ...
    :try_start_3
    iget-object v5, p0, mForcedRateList:Ljava/util/ArrayList;
...
.method private updateDynamicVsync(I)V
    ...
    sget-boolean v0, Lcom/oneplus/server/DynamicVsyncManager;->Mua:Z

    if-eqz v0, :cond_1

    iget-object p0, p0, mModeRecordMap:Ljava/util/HashMap;
    ...
    iget p0, p0, Lcom/android/server/wm/OpScreenModeService$zta;->qfa:I
    ...
    :goto_0
    invoke-virtual {p1, p0}, Lcom/oneplus/server/DynamicVsyncManager;->P(Z)V
...
.method private updateRefreshRate(Lcom/android/server/wm/AppWindowToken;)V
    ...
    iput-object p1, p0, mCurrentAppToken:Lcom/android/server/wm/AppWindowToken;
...
.method public adjustDensityForUser(II)I
    ...
    iget-object v1, p0, mDefaultMode:Lcom/android/server/wm/OpScreenModeService$zta;

    iget v1, v1, Lcom/android/server/wm/OpScreenModeService$zta;->rfa:I
    ...
    iget v2, p0, mResolotionSettings:I
    ...
    :cond_1
    iget v0, p0, mResolotionSettings:I

    if-eq p2, v0, :cond_5

    iget v0, p0, mScreenRateSettings:I

    invoke-virtual {p0, v0, p2}, getModeRecord(II)Lcom/android/server/wm/OpScreenModeService$zta;
    ...
    invoke-virtual {p0, v0, v2}, getModeRecord(II)Lcom/android/server/wm/OpScreenModeService$zta;
    ...
    iget-object p2, p2, Lcom/android/server/wm/OpScreenModeService$zta;->sfa:[I
    ...
    iget-object p0, p0, Lcom/android/server/wm/OpScreenModeService$zta;->sfa:[I
...
.method getModeRecord(II)Lcom/android/server/wm/OpScreenModeService$zta;
    ...
    iget-object p2, p0, mDefaultMode:Lcom/android/server/wm/OpScreenModeService$zta;

    iget p2, p2, Lcom/android/server/wm/OpScreenModeService$zta;->rfa:I
    ...
    :cond_2
    iget-object v0, p0, mParamsMap:Ljava/util/HashMap;
    ...
    :cond_3
    iget-object p0, p0, mDefaultMode:Lcom/android/server/wm/OpScreenModeService$zta;
...
.method getPackageRate(ILcom/android/server/wm/AppWindowToken;)I
    ...
    iget-object p1, p0, mForcedRateList:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, mForcedRateList:Ljava/util/ArrayList;
...
.method public getPreferredModeId(Lcom/android/server/wm/WindowState;I)I
    ...
    iget-boolean v0, p0, mServiceReady:Z
    ...
    :cond_1
    iget p1, p0, mResolotionSettings:I

    invoke-virtual {p0, v1, p1}, getModeRecord(II)Lcom/android/server/wm/OpScreenModeService$zta;
...
.method public init(Lcom/android/server/wm/WindowManagerService;Landroid/content/Context;)V
    ...
    iput-object p1, p0, mSettingsObserver:Lcom/android/server/wm/OpScreenModeService$tsu;
    ...
    iput-object p1, p0, mDisplayManager:Landroid/hardware/display/DisplayManager;

    iget-object p1, p0, mDisplayManager:Landroid/hardware/display/DisplayManager;
    ...
    iget-object p1, p0, mService:Lcom/android/server/wm/WindowManagerService;
    ...
    iput-object v0, p0, mModeRecords:[Lcom/android/server/wm/OpScreenModeService$zta;
    ...
    iget-object v0, p0, mModeRecords:[Lcom/android/server/wm/OpScreenModeService$zta;
    ...
    iget v2, v2, Lcom/android/server/wm/OpScreenModeService$zta;->qfa:I

    aget-object v0, v0, p2

    iget v0, v0, Lcom/android/server/wm/OpScreenModeService$zta;->rfa:I

    iget-object v3, p0, mParamsMap:Ljava/util/HashMap;
    ...
    iget-object v2, p0, mModeRecords:[Lcom/android/server/wm/OpScreenModeService$zta;

    aget-object v2, v2, p2

    invoke-virtual {v3, v0, v2}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v0, p0, mModeRecordMap:Ljava/util/HashMap;
    ...
    iget-object v3, p0, mModeRecords:[Lcom/android/server/wm/OpScreenModeService$zta;
    ...
    iput-object p1, p0, mDefaultMode:Lcom/android/server/wm/OpScreenModeService$zta;
    ...
    iget p1, p0, mScreenRateSettings:I

    iget-object p2, p0, mDefaultMode:Lcom/android/server/wm/OpScreenModeService$zta;

    iget p2, p2, Lcom/android/server/wm/OpScreenModeService$zta;->rfa:I

    invoke-virtual {p0, p1, p2}, getModeRecord(II)Lcom/android/server/wm/OpScreenModeService$zta;
    ...
    iput-object p1, p0, mScreenModeHandler:Lcom/android/server/wm/OpScreenModeService$sis;

    invoke-virtual {p0}, setResolution()V

    invoke-virtual {p0}, initCtsRateList()V

    invoke-virtual {p0}, initReceiver()V

    invoke-virtual {p0}, initOnlineConfig()V

    invoke-virtual {p0}, publish()V
...
.method initCtsRateList()V
    ...
    iget-object v0, p0, mCtsRatePackage:Ljava/util/HashMap;

    invoke-virtual {v0, v3, v2}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const/4 v0, 0x0

    invoke-virtual {p0, v0}, initLocalRateList(I)V

    invoke-virtual {p0, v1}, initLocalRateList(I)V
...
.method initLocalRateList(I)V
    ...
    iget-object v2, p0, mFixedRatePackage:Ljava/util/HashMap;
...
.method initOnlineConfig()V
    ...
    iget-object v0, p0, mScreenModeHandler:Lcom/android/server/wm/OpScreenModeService$sis;
...
.method initReceiver()V
    ...
    new-instance v0, Lcom/android/server/wm/v;

    invoke-direct {v0, p0}, Lcom/android/server/wm/v;-><init>(Lcom/android/server/wm/OpScreenModeService;)V
...
.method isCtsActivity(Lcom/android/server/wm/AppWindowToken;)Z
    ...
    iget-object p0, p0, mCtsRatePackage:Ljava/util/HashMap;
...
.method public isQHD()Z
    .locals 1

    iget p0, p0, mResolotionSettings:I
...
.method public synthetic n()V
    ...
    iget-object v2, p0, mScreenModeHandler:Lcom/android/server/wm/OpScreenModeService$sis;
    ...
    iget-object v0, p0, mScreenModeConfigObserver:Lcom/oneplus/config/ConfigObserver;
...
.method public setRefreshRate(Landroid/os/IBinder;I)V
    ...
    :cond_0
    invoke-virtual {p0, p1}, getAppToken(Landroid/os/IBinder;)Lcom/android/server/wm/AppWindowToken;
    ...
    :goto_0
    invoke-virtual {p0, p1, v0}, setRefreshRate(Lcom/android/server/wm/AppWindowToken;I)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/server/backlight/OpBacklightManager;->sis(Ljava/lang/String;I)V
...
.method public setRefreshRate(Lcom/android/server/wm/AppWindowToken;I)V
    ...
    invoke-virtual {p0, p2, p1}, getPackageRate(ILcom/android/server/wm/AppWindowToken;)I

    move-result p2

    iput p2, p1, Lcom/android/server/wm/AppWindowToken;->mTmpRefreshRate:I

    invoke-virtual {p0, p1}, isCtsActivity(Lcom/android/server/wm/AppWindowToken;)Z
    ...
    :cond_1
    iget-object p2, p0, mModeRecordMap:Ljava/util/HashMap;

    iget v0, p0, mCurrentModeId:I
    ...
    iget p2, p2, Lcom/android/server/wm/OpScreenModeService$zta;->qfa:I
    ...
    :cond_2
    sget p2, RECORD_MODE_DELAY:I

    goto :goto_1

    :cond_3
    :goto_0
    sget p2, RECORD_MODE_DELAY_SHORT:I
...
.method setResolution()V
    ...
    iget-object v2, p0, mDefaultMode:Lcom/android/server/wm/OpScreenModeService$zta;

    iget v2, v2, Lcom/android/server/wm/OpScreenModeService$zta;->rfa:I

    iput v2, p0, mResolotionSettings:I
    ...
    iget-object v3, p0, mDefaultMode:Lcom/android/server/wm/OpScreenModeService$zta;

    iget v3, v3, Lcom/android/server/wm/OpScreenModeService$zta;->rfa:I
    ...
    :goto_2
    sget-boolean v3, sIsResolutionAuto:Z

    if-eq v1, v3, :cond_4

    iget-object p0, p0, mModeRecords:[Lcom/android/server/wm/OpScreenModeService$zta;
    ...
    sput-boolean v1, sIsResolutionAuto:Z
...
.method public updateGlobalModeId(I)I
    ...
    iget v1, v0, Lcom/android/server/wm/OpScreenModeService$zta;->rfa:I

    iget v2, p0, mResolotionSettings:I

    if-eq v1, v2, :cond_1

    iget p1, v0, Lcom/android/server/wm/OpScreenModeService$zta;->qfa:I

    invoke-virtual {p0, p1, v2}, getModeRecord(II)Lcom/android/server/wm/OpScreenModeService$zta;
