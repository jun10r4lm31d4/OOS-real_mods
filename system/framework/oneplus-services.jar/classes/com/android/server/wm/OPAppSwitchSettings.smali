...
.method public constructor <init>(Lcom/android/server/wm/OPAppSwitchSettings$you;Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, mAppSwitchEnable:Z

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mStaticRuleList:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mBlackList:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mMatchAppDefaultList:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mMatchActivityDefaultList:Ljava/util/List;

    iput-object p1, p0, mListener:Lcom/android/server/wm/OPAppSwitchSettings$you;
...
.method static synthetic access$100(Lcom/android/server/wm/OPAppSwitchSettings;Z)V
    ...
    invoke-direct {p0, p1}, readConfigFromFile(Z)V
...
.method private getConfiguration(Lcom/android/server/wm/OPAppSwitchRuleInfo;)V
    ...
    :try_start_0
    iget-object v1, p0, mXmlPullParser:Lorg/xmlpull/v1/XmlPullParser;
    ...
    iget-object v3, p0, mXmlPullParser:Lorg/xmlpull/v1/XmlPullParser;

    invoke-interface {v3}, Lorg/xmlpull/v1/XmlPullParser;->getEventType()I

    move-result v3

    iget-object v4, p0, mXmlPullParser:Lorg/xmlpull/v1/XmlPullParser;
    ...
    invoke-direct {p0, v3}, getValue(Ljava/lang/String;)Ljava/lang/String;
...
.method private getRules()V
    ...
    iget-object p0, p0, mStaticRuleList:Ljava/util/List;
    ...
    invoke-direct {p0, v2}, getValue(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    :cond_3
    invoke-direct {p0, v1}, getConfiguration(Lcom/android/server/wm/OPAppSwitchRuleInfo;)V
...
.method private getValue(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_0
    iget-object v0, p0, mXmlPullParser:Lorg/xmlpull/v1/XmlPullParser;
    ...
    iget-object p0, p0, mXmlPullParser:Lorg/xmlpull/v1/XmlPullParser;
...
.method private loadRuleList()V
    ...
    :cond_1
    invoke-direct {p0, v0}, parseXml(Ljava/io/File;)V
...
.method private parseXml(Ljava/io/File;)V
    ...
    iput-object p1, p0, mXmlPullParser:Lorg/xmlpull/v1/XmlPullParser;

    iget-object p1, p0, mXmlPullParser:Lorg/xmlpull/v1/XmlPullParser;
    ...
    :cond_1
    iget-object v8, p0, mXmlPullParser:Lorg/xmlpull/v1/XmlPullParser;
    ...
    const-string v10, "parsexml     END_TAG---"
    ...
    iget-object v9, p0, mBlackList:Ljava/util/List;
    ...
    const-string v10, "parsexml  blackItem START_ attr == "
    ...
    const-string v10, "parsexml  whileItem START_ attr == "
    ...
    iget-object v9, p0, mMatchAppDefaultList:Ljava/util/List;
    ...
    invoke-direct {p0, v1}, getValue(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v9, p0, mMatchActivityDefaultList:Ljava/util/List;
    ...
    invoke-direct {p0, v0}, getValue(Ljava/lang/String;)Ljava/lang/String;
...
.method private readConfigFromFile(Z)V
    ...
    invoke-direct {p0}, loadRuleList()V

    if-eqz p1, :cond_0

    iget-object p0, p0, mListener:Lcom/android/server/wm/OPAppSwitchSettings$you;
...
.method private reset()V
    ...
    iget-object v0, p0, mBlackList:Ljava/util/List;

    invoke-interface {v0}, Ljava/util/List;->clear()V

    iget-object v0, p0, mMatchAppDefaultList:Ljava/util/List;

    invoke-interface {v0}, Ljava/util/List;->clear()V

    iget-object v0, p0, mMatchActivityDefaultList:Ljava/util/List;
...
.method public getBlackList()Ljava/util/List;
    ...
    iget-object p0, p0, mBlackList:Ljava/util/List;
...
.method public getMatchActivityDefaultList()Ljava/util/List;
    ...
    iget-object p0, p0, mMatchActivityDefaultList:Ljava/util/List;
...
.method public getMatchAppDefaultList()Ljava/util/List;
    ...
    iget-object p0, p0, mMatchAppDefaultList:Ljava/util/List;
...
.method public init()V
    ...
    invoke-direct {p0}, createFile()V

    const/4 v0, 0x1

    invoke-direct {p0, v0}, readConfigFromFile(Z)V
    ...
    iput-object v0, p0, mFileObserverPolicy:Lcom/android/server/wm/OPAppSwitchSettings$zta;

    iget-object p0, p0, mFileObserverPolicy:Lcom/android/server/wm/OPAppSwitchSettings$zta;
