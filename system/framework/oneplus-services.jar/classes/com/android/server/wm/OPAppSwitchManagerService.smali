...
.method static constructor <clinit>()V
    ...
    sput-object v0, URI_OEM_SPLASH_ADS_ENABLE:Landroid/net/Uri;

    const/4 v0, 0x1

    sput-boolean v0, mOpAdsEnable:Z

    sput-boolean v0, mOpAdsPermEnable:Z

    const-string v0, "OpAdsOn"

    sput-object v0, mOpAdsOn:Ljava/lang/String;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, mIntercepters:Ljava/util/HashMap;
    ...
    iput-boolean v1, p0, mIsKeyBlocked:Z

    iput-object v0, p0, permManagerInternal:Lcom/android/server/pm/permission/PermissionManagerServiceInternal;

    iput-object v0, p0, dangerousPerms:Ljava/util/ArrayList;

    new-instance v0, Lcom/android/server/wm/wtn;

    invoke-direct {v0, p0}, Lcom/android/server/wm/wtn;-><init>(Lcom/android/server/wm/OPAppSwitchManagerService;)V

    iput-object v0, p0, mCleanUpReceiver:Landroid/content/BroadcastReceiver;
...
.method static synthetic access$100()Z
    ...
    sget-boolean v0, mOpAdsEnable:Z
...
.method static synthetic access$200()Z
    ...
    sget-boolean v0, mOpAdsPermEnable:Z
...
.method static synthetic access$400()Landroid/net/Uri;
    ...
    sget-object v0, URI_OEM_SPLASH_ADS_ENABLE:Landroid/net/Uri;
...
.method static synthetic access$500(Lcom/android/server/wm/OPAppSwitchManagerService;)Z
    ...
    iget-boolean p0, p0, mOpAdsSettingsOn:Z
...
.method static synthetic access$502(Lcom/android/server/wm/OPAppSwitchManagerService;Z)Z
    ...
    iput-boolean p1, p0, mOpAdsSettingsOn:Z
...
.method static synthetic access$602(Lnet/oneplus/odm/OpDeviceManagerInjector;)Lnet/oneplus/odm/OpDeviceManagerInjector;
    ...
    sput-object p0, mOpDeviceManagerInjector:Lnet/oneplus/odm/OpDeviceManagerInjector;
...
.method static synthetic access$700(Lcom/android/server/wm/OPAppSwitchManagerService;Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;Z)V
    ...
    invoke-direct {p0, p1, p2, p3}, onActivityPaused(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;Z)V
...
.method static synthetic access$800(Lcom/android/server/wm/OPAppSwitchManagerService;Lcom/android/server/wm/ActivityRecord;Z)V
    ...
    invoke-direct {p0, p1, p2}, onActivityResumed(Lcom/android/server/wm/ActivityRecord;Z)V
...
.method static synthetic access$900(Lcom/android/server/wm/OPAppSwitchManagerService;Lorg/json/JSONArray;)V
    ...
    invoke-direct {p0, p1}, resolveOnlineConfig(Lorg/json/JSONArray;)V
...
.method private getGrantedAppPermissionsCount(Landroid/content/Context;Ljava/lang/String;)I
    ...
    invoke-direct {p0, v9}, isInDangerousPermsList(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1, v9, p2}, hasPermission(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)I
...
.method public static getInstance()Lcom/android/server/wm/OPAppSwitchManagerService;
    ...
    sget-object v0, sInstance:Lcom/android/server/wm/OPAppSwitchManagerService;
    ...
    :try_start_0
    sget-object v1, sInstance:Lcom/android/server/wm/OPAppSwitchManagerService;
    ...
    sput-object v1, sInstance:Lcom/android/server/wm/OPAppSwitchManagerService;
...
.method private isInDangerousPermsList(Ljava/lang/String;)Z
    ...
    iget-object v0, p0, dangerousPerms:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, dangerousPerms:Ljava/util/ArrayList;
...
.method private matchConfig(Lcom/android/server/wm/OPAppSwitchStateDispatcher;)V
    ...
    iget-object v0, p0, mSettings:Lcom/android/server/wm/OPAppSwitchSettings;
    ...
    invoke-direct/range {v0 .. v5}, matchConfig(Lcom/android/server/wm/OPAppSwitchStateDispatcher;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;Ljava/util/Map;)V
...
.method private notifyActivityEnter(Lcom/android/server/wm/ActivityRecord;Z)V
    ...
    :cond_0
    iget-object p0, p0, mIntercepters:Ljava/util/HashMap;
...
.method private notifyAppExit(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;Z)V
    ...
    iget-object v0, p0, mIntercepters:Ljava/util/HashMap;
    ...
    sget-boolean v3, mOpAdsPermEnable:Z
    ...
    invoke-direct {p0, v3, v4}, getGrantedAppPermissionsCount(Landroid/content/Context;Ljava/lang/String;)I
...
.method private onActivityPaused(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;Z)V
    ...
    iput-object v1, p0, mLastPausedActivity:Lcom/android/server/wm/ActivityRecord;

    goto :goto_0

    :cond_2
    iput-object p1, p0, mLastPausedActivity:Lcom/android/server/wm/ActivityRecord;

    :goto_0
    invoke-direct {p0, p1, p2, p3}, notifyActivityExit(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;Z)V

    if-eqz v0, :cond_3

    invoke-direct {p0, p1, p2, p3}, notifyAppExit(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;Z)V
...
.method private onActivityResumed(Lcom/android/server/wm/ActivityRecord;Z)V
    ...
    iget-object v1, p0, mLastResumedActivity:Lcom/android/server/wm/ActivityRecord;
    ...
    iget-object v1, p0, mLastPausedActivity:Lcom/android/server/wm/ActivityRecord;
    ...
    :cond_1
    iget-object v0, p0, mLastResumedActivity:Lcom/android/server/wm/ActivityRecord;
    ...
    :goto_1
    iget-object v3, p0, mLastPausedActivity:Lcom/android/server/wm/ActivityRecord;
    ...
    :cond_4
    iput-object p1, p0, mLastResumedActivity:Lcom/android/server/wm/ActivityRecord;

    if-eqz v1, :cond_5

    iget-object v1, p0, mLastPausedActivity:Lcom/android/server/wm/ActivityRecord;

    invoke-direct {p0, v1, p1, p2}, notifyAppExit(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;Z)V
    ...
    invoke-direct {p0, p1, p2}, notifyAppEnter(Lcom/android/server/wm/ActivityRecord;Z)V

    :cond_6
    invoke-direct {p0, p1, p2}, notifyActivityEnter(Lcom/android/server/wm/ActivityRecord;Z)V
...
.method private resolveOnlineConfig(Lorg/json/JSONArray;)V
    ...
    sput-boolean v3, mOpAdsEnable:Z
    ...
    sput-boolean v2, mOpAdsPermEnable:Z
    ...
    sget-boolean p1, mOpAdsEnable:Z
    ...
    sget-boolean p1, mOpAdsPermEnable:Z
...
.method private updateAppSwitchConfig()V
    ...
    iget-object v2, p0, mIntercepters:Ljava/util/HashMap;
    ...
    iget-object v3, p0, mIntercepters:Ljava/util/HashMap;
...
.method public getAdsSettings()Z
    ...
    iget-boolean v1, p0, mOpAdsSettingsOn:Z
    ...
    sget-boolean v1, mOpAdsEnable:Z
    ...
    sget-boolean p0, mOpAdsEnable:Z
...
.method public handleActivityPaused(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;)V
    ...
    :cond_4
    iget-object v1, p0, mNotifyHandler:Landroid/os/Handler;

    if-eqz v1, :cond_5

    iget-object v1, p0, mNotifyHandler:Landroid/os/Handler;

    new-instance v2, Lcom/android/server/wm/gck;

    invoke-direct {v2, p0, p1, p2, v3}, Lcom/android/server/wm/gck;-><init>(Lcom/android/server/wm/OPAppSwitchManagerService;Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;Z)V
...
.method public handleActivityResumed(Lcom/android/server/wm/ActivityRecord;)V
    ...
    iput-object p1, p0, nowTopr:Lcom/android/server/wm/ActivityRecord;
    ...
    new-instance v2, Lcom/android/server/wm/dma;

    invoke-direct {v2, p0, p1, v4}, Lcom/android/server/wm/dma;-><init>(Lcom/android/server/wm/OPAppSwitchManagerService;Lcom/android/server/wm/ActivityRecord;Z)V
...
.method public init(Landroid/content/Context;Lcom/android/server/am/ActivityManagerService;)V
    ...
    iput-object p2, p0, mAms:Lcom/android/server/am/ActivityManagerService;
    ...
    iput-object p2, p0, mAm:Landroid/app/ActivityManager;

    iget-object p2, p0, mNotifyHandler:Landroid/os/Handler;
    ...
    iput-object p2, p0, mNotifyThread:Lcom/android/server/ServiceThread;

    iget-object p2, p0, mNotifyThread:Lcom/android/server/ServiceThread;

    invoke-virtual {p2}, Lcom/android/server/ServiceThread;->start()V

    new-instance p2, Landroid/os/Handler;

    iget-object v1, p0, mNotifyThread:Lcom/android/server/ServiceThread;
    ...
    iput-object p2, p0, mNotifyHandler:Landroid/os/Handler;
    ...
    iput-object p2, p0, mSettings:Lcom/android/server/wm/OPAppSwitchSettings;

    iget-object p2, p0, mSettings:Lcom/android/server/wm/OPAppSwitchSettings;

    iget-object v1, p0, mNotifyHandler:Landroid/os/Handler;

    new-instance v2, Lcom/android/server/wm/igw;

    invoke-direct {v2, p0, p2}, Lcom/android/server/wm/igw;-><init>(Lcom/android/server/wm/OPAppSwitchManagerService;Lcom/android/server/wm/OPAppSwitchSettings;)V

    invoke-virtual {v1, v2}, Landroid/os/Handler;->post(Ljava/lang/Runnable;)Z

    iget-object p2, p0, mContext:Landroid/content/Context;

    iget-object v1, p0, mCleanUpReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object p2, p0, mSettingsObserver:Lcom/android/server/wm/OPAppSwitchManagerService$tsu;

    iget-object p2, p0, mSettingsObserver:Lcom/android/server/wm/OPAppSwitchManagerService$tsu;
    ...
    sget-object v3, mOpAdsOn:Ljava/lang/String;
    ...
    iput-object p2, p0, mConfigObserver:Lcom/oneplus/config/ConfigObserver;

    iget-object p2, p0, mConfigObserver:Lcom/oneplus/config/ConfigObserver;

    invoke-virtual {p2}, Lcom/oneplus/config/ConfigObserver;->register()V

    new-instance p2, Lcom/oneplus/config/ConfigGrabber;

    sget-object v1, mOpAdsOn:Ljava/lang/String;
    ...
    iput-object p1, p0, permManagerInternal:Lcom/android/server/pm/permission/PermissionManagerServiceInternal;

    iget-object p1, p0, permManagerInternal:Lcom/android/server/pm/permission/PermissionManagerServiceInternal;
    ...
    iput-object p1, p0, dangerousPerms:Ljava/util/ArrayList;
...
.method public isOposHotApp(Ljava/lang/String;)Z
    ...
    iget-object p0, p0, mPackageSet:Ljava/util/HashSet;
...
.method public onConfigChanged()V
    ...
    :cond_0
    invoke-direct {p0}, updateAppSwitchConfig()V
...
.method public registerAppSwitchObserver(Ljava/lang/String;Lcom/android/server/wm/IOPAppSwitchObserver;Lcom/color/app/ColorAppSwitchConfig;)Z
    ...
    iget-object v2, p0, mPackageSet:Ljava/util/HashSet;
    ...
    invoke-direct {p0, v0}, matchConfig(Lcom/android/server/wm/OPAppSwitchStateDispatcher;)V
