...
.field private mOpScreenDecor:Lcom/android/server/wm/u;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, IS_SUPPORT_CAMERA_NOTCH:Z
    ...
    sget-boolean v1, IS_SUPPORT_CAMERA_NOTCH:Z
    ...
    :goto_1
    sput-boolean v1, IS_SCREEN_COMPAT_ENABLED:Z
    ...
    :goto_2
    sput-boolean v1, IS_SUPPORT_HIDE_CAMERA_NOTCH:Z
    ...
    sput-boolean v1, IS_PARALLEL_APP_FEATURED:Z
    ...
    sput-boolean v0, OP_ENABLE_PARTIAL_COMPAT:Z

    sput-boolean v2, mEnableIgnoreCutoutMode:Z

    sput-boolean v2, mIsIgnoreCameraNotch:Z

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, mScreenCompatLock:Ljava/lang/Object;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mScreenCompatDefaultEnabledList:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mScreenCompatDefaultFullscreenList:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mScreenCompatSystemAppList:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mScreenCompatThirdPartyAppList:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mScreenCompatIgnoreCutoutList:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, mDisplayCompat2kList:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mDisplayCompatFhdList:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mSystemAppList:Ljava/util/ArrayList;
...
.method static synthetic access$100()Z
    ...
    sget-boolean v0, IS_SUPPORT_HIDE_CAMERA_NOTCH:Z
...
.method static synthetic access$200()Z
    ...
    sget-boolean v0, mIsIgnoreCameraNotch:Z
...
.method static synthetic access$202(Z)Z
    ...
    sput-boolean p0, mIsIgnoreCameraNotch:Z
...
.method static synthetic access$502(Lcom/android/server/wm/OpScreenCompat;I)I
    ...
    iput p1, p0, mDriveModeShowing:I
...
.method static synthetic access$800(Lcom/android/server/wm/OpScreenCompat;Lorg/json/JSONArray;)V
    ...
    invoke-direct {p0, p1}, resolveScreenCompatConfigFromJSON(Lorg/json/JSONArray;)V
...
.method private isNotchUnLimit(Lcom/android/server/wm/WindowState;)Z
    ...
    sget-boolean v0, IS_SUPPORT_CAMERA_NOTCH:Z
    ...
    invoke-virtual {p0, v0, v3}, getCompatMode(Ljava/lang/String;I)I
...
.method private resetFrame(Landroid/graphics/Rect;)V
    ...
    sget v1, sLimitedScreenSize:I

    if-le p0, v1, :cond_1

    sget v1, sMaxScreenSize:I
    ...
    :cond_1
    sget p0, sLimitedScreenSize:I

    if-le v0, p0, :cond_2

    sget p0, sMaxScreenSize:I
...
.method private resolveScreenCompatConfigFromJSON(Lorg/json/JSONArray;)V
    ...
    invoke-virtual/range {p0 .. p0}, updateDefaultForScreenCompat()V
    ...
    sget-boolean v11, IS_SCREEN_COMPAT_ENABLED:Z
    ...
    :cond_2
    sget-boolean v8, IS_SCREEN_COMPAT_ENABLED:Z
    ...
    sput-boolean v11, mEnableIgnoreCutoutMode:Z
    ...
    sput-boolean v13, mEnableIgnoreCutoutMode:Z

    const-string v13, "OpScreenCompat"

    const-string v14, "ignore all cutout."
    ...
    const-string v11, "add ignore config pkg:"
    ...
    :cond_e
    sget-object v1, mScreenCompatLock:Ljava/lang/Object;
    ...
    iput-object v2, v0, mScreenCompatDefaultEnabledList:Ljava/util/ArrayList;
    ...
    iput-object v3, v0, mScreenCompatDefaultFullscreenList:Ljava/util/ArrayList;
    ...
    iput-object v4, v0, mScreenCompatThirdPartyAppList:Ljava/util/ArrayList;
    ...
    iput-object v5, v0, mScreenCompatIgnoreCutoutList:Ljava/util/ArrayList;
    ...
    iput-object v6, v0, mDisplayCompat2kList:Ljava/util/ArrayList;
    ...
    iput-object v7, v0, mDisplayCompatFhdList:Ljava/util/ArrayList;
...
.method private updateDefaultForScreenCompatUser(Ljava/lang/String;I)V
    ...
    invoke-virtual {p0, p1, p2}, updateDefaultForScreenCompat(Ljava/lang/String;I)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public expandScreenDecor(Lcom/android/server/wm/WindowState;Lcom/android/server/wm/WindowState;)V
    ...
    iget-object v0, p0, mOpScreenDecor:Lcom/android/server/wm/u;
    ...
    sget-boolean v1, mIsIgnoreCameraNotch:Z
    ...
    :cond_1
    iget v1, p0, mDriveModeEnable:I

    if-ne v1, v2, :cond_2

    iget v1, p0, mDriveModeShowing:I
    ...
    :goto_1
    iget-object v3, p0, mOpScreenDecor:Lcom/android/server/wm/u;

    iget-boolean v3, v3, Lcom/android/server/wm/u;->lfa:Z
    ...
    sget-boolean v4, mIsIgnoreCameraNotch:Z
    ...
    :cond_4
    iget-object p0, p0, mOpScreenDecor:Lcom/android/server/wm/u;

    invoke-virtual {p0, v1}, Lcom/android/server/wm/u;->u(Z)V
...
.method public finishBooting()V
    ...
    iput-object v1, p0, mScreenCompatDefaultEnabledList:Ljava/util/ArrayList;
    ...
    :goto_0
    iput-object v1, p0, mSystemAppList:Ljava/util/ArrayList;
    ...
    iput-object v1, p0, mScreenCompatThirdPartyAppList:Ljava/util/ArrayList;

    new-instance v1, Lcom/android/server/wm/u;

    iget-object v2, p0, mContext:Landroid/content/Context;

    invoke-direct {v1, v2}, Lcom/android/server/wm/u;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, mOpScreenDecor:Lcom/android/server/wm/u;

    :cond_2
    sget-boolean v1, IS_SUPPORT_HIDE_CAMERA_NOTCH:Z

    if-eqz v1, :cond_3

    sput-boolean v3, mIsIgnoreCameraNotch:Z

    :cond_3
    invoke-virtual {p0}, updateDefaultForScreenCompat()V

    invoke-virtual {p0}, updateSizeForResolutionChanged()V
    ...
    iget-object v0, p0, mScrrenCompatConfigObserver:Lcom/oneplus/config/ConfigObserver;
    ...
    iput-object v0, p0, mScrrenCompatConfigObserver:Lcom/oneplus/config/ConfigObserver;
    ...
    invoke-direct {p0, v0}, resolveScreenCompatConfigFromJSON(Lorg/json/JSONArray;)V
...
.method public getCompatMode(Lcom/android/server/wm/ActivityRecord;)I
    ...
    :try_start_0
    sget-boolean v1, IS_PARALLEL_APP_FEATURED:Z
    ...
    invoke-virtual {p0, v2, v1}, getCompatMode(Ljava/lang/String;I)I
...
.method public getCompatMode(Ljava/lang/String;I)I
    ...
    :cond_2
    :goto_0
    sget-boolean p0, mIsIgnoreCameraNotch:Z
    :try_end_0
...
.method public getScreenExpandOffset(Lcom/android/server/wm/WindowState;)I
    ...
    iget-boolean v0, v0, Lcom/android/server/wm/u;->lfa:Z
    ...
    iget p0, p0, Lcom/android/server/wm/u;->mfa:I
...
.method public init(Lcom/android/server/wm/WindowManagerService;)V
    ...
    iput-object p1, p0, mAppOps:Landroid/app/AppOpsManager;
    ...
    iput-object p1, p0, mSettingsObserver:Lcom/android/server/wm/OpScreenCompat$you;
...
.method public isAppWindowCompat(Landroid/graphics/Rect;Lcom/android/server/wm/WindowState;)Z
    ...
    invoke-virtual {p0, v3, v4}, getCompatMode(Ljava/lang/String;I)I
    ...
    new-instance v2, Lcom/android/server/wm/r;

    invoke-direct {v2, p0, p1, p2, v0}, Lcom/android/server/wm/r;-><init>(Lcom/android/server/wm/OpScreenCompat;Landroid/graphics/Rect;Lcom/android/server/wm/WindowState;Z)V
...
.method public isDisplayCompat(Ljava/lang/String;I)Z
    ...
    :cond_0
    iget-object v1, p0, mDisplayCompatFhdList:Ljava/util/ArrayList;

    invoke-direct {p0, v1, p1}, checkContains(Ljava/util/ArrayList;Ljava/lang/String;)Z
    ...
    :cond_1
    sget-boolean v1, OP_ENABLE_PARTIAL_COMPAT:Z
    ...
    iget-object p2, p0, mSystemAppList:Ljava/util/ArrayList;
    ...
    iget-object p2, p0, mDisplayCompat2kList:Ljava/util/ArrayList;

    invoke-direct {p0, p2, p1}, checkContains(Ljava/util/ArrayList;Ljava/lang/String;)Z
...
.method public onConfigurationChanged()V
    ...
    invoke-virtual {p0}, Lcom/android/server/wm/u;->onConfigurationChanged()V
...
.method public overrideCompatInfoIfNeed(Landroid/content/pm/ApplicationInfo;)V
    ...
    invoke-virtual {p0, v0, v1}, isDisplayCompat(Ljava/lang/String;I)Z
...
.method public resetDisplayCutout(Lcom/android/server/wm/WindowState;Lcom/android/server/wm/DisplayFrames;)I
    ...
    invoke-direct {p0, p1}, isNotchUnLimit(Lcom/android/server/wm/WindowState;)Z
    ...
    :cond_1
    iget-object p0, p0, mScreenCompatIgnoreCutoutList:Ljava/util/ArrayList;
    ...
    sget-boolean p0, mEnableIgnoreCutoutMode:Z
...
.method public resetFrameForCompat(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Lcom/android/server/wm/WindowState;)V
    ...
    :cond_0
    invoke-virtual {p0, p1, p7}, isAppWindowCompat(Landroid/graphics/Rect;Lcom/android/server/wm/WindowState;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-direct {p0, p1}, resetFrame(Landroid/graphics/Rect;)V

    invoke-direct {p0, p2}, resetFrame(Landroid/graphics/Rect;)V

    invoke-direct {p0, p3}, resetFrame(Landroid/graphics/Rect;)V

    invoke-direct {p0, p4}, resetFrame(Landroid/graphics/Rect;)V

    invoke-direct {p0, p5}, resetFrame(Landroid/graphics/Rect;)V

    invoke-direct {p0, p6}, resetFrame(Landroid/graphics/Rect;)V
...
.method public resetModeIfNeed(IILjava/lang/String;I)I
    ...
    iget-object p0, p0, mScreenCompatDefaultEnabledList:Ljava/util/ArrayList;
...
.method public updateDefaultForScreenCompat()V
    ...
    invoke-direct {p0}, resetScreenCompatConfig()V
    ...
    :try_start_0
    iget-object v2, p0, mScreenCompatDefaultEnabledList:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v3, v0}, updateDefaultForScreenCompatUser(Ljava/lang/String;I)V

    goto :goto_0

    :cond_0
    iget-object v2, p0, mScreenCompatDefaultFullscreenList:Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object v2, p0, mScreenCompatSystemAppList:Ljava/util/ArrayList;
...
.method public updateDefaultForScreenCompat(Ljava/lang/String;I)V
    ...
    invoke-direct {p0, p1, v0}, updateDefaultForScreenCompatUser(Ljava/lang/String;I)V

    :cond_1
    sget-object v0, mScreenCompatLock:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, mScreenCompatDefaultEnabledList:Ljava/util/ArrayList;
    ...
    :cond_2
    iget-object v1, p0, mScreenCompatDefaultFullscreenList:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, mScreenCompatSystemAppList:Ljava/util/ArrayList;
...
.method public updateSizeForResolutionChanged()V
    ...
    sput p0, sLimitedScreenSize:I

    sget p0, sMaxScreenSize:I

    sget v0, sLimitedScreenSize:I

    sub-int v0, p0, v0

    div-int/lit8 v0, v0, 0x2

    sput v0, sDefaultMargin:I

    sget v0, sDefaultMargin:I
    ...
    sput v1, sPortBottom:I

    sub-int/2addr p0, v0

    sput p0, sLandRight:I
