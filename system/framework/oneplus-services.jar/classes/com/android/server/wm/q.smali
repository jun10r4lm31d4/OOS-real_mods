...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/wm/q$sis;,
        Lcom/android/server/wm/q$you;,
        Lcom/android/server/wm/q$zta;
    }
.end annotation


# static fields
.field public static final Aea:I = 0x30a

.field public static final Bea:I = 0x60

.field public static final Cea:I = 0x54

.field public static final Dea:I = 0x2a

.field public static final Eea:I = 0x3c

.field public static final Fea:I = 0x30

.field public static Gea:I = 0x0

.field public static Hea:I = 0x0

.field public static Iea:I = 0x0

.field public static Jea:I = 0x0

.field public static Kea:I = 0x0

.field public static Lea:I = 0x0

.field public static final Mea:I = 0x28

.field public static final Nea:I = 0x28

.field public static final Oea:I = 0x28

.field public static Pea:I = 0x0

.field public static Qea:I = 0x0

.field public static Rea:I = 0x0

.field public static final Sea:I = 0x12c

.field private static final TAG:Ljava/lang/String; = "OpQuickReply"

.field public static final Tea:I = 0x64

.field public static Uea:I = 0x0

.field public static Vea:I = 0x0

.field private static final Wea:Ljava/util/List;
...
.field private static final Xea:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
.field public static Yea:Ljava/util/List; = null
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
.field public static Zea:Ljava/util/List; = null
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
.field public static _ea:Ljava/util/List; = null
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
.field private static rea:Ljava/lang/Object; = null

.field public static sIMELimitWidth:I = 0x0

.field private static sInstance:Lcom/android/server/wm/q; = null

.field private static final sea:Ljava/lang/String; = "Quick_Reply_Config"

.field private static final tea:Ljava/lang/String; = "com.oneplus.action.QUICK_REPLY_SETTINGS"

.field private static final uea:Ljava/lang/String; = "com.android.settings"

.field public static final vea:F = 0.4f

.field public static wea:I = 0x0

.field public static final xea:I = 0x0
...
.field private Uda:Lcom/android/server/wm/WindowManagerService;

.field private Vda:Landroid/view/WindowManager$LayoutParams;

.field private Wda:Landroid/view/WindowManager$LayoutParams;

.field private Xda:Landroid/view/WindowManager$LayoutParams;

.field private Yda:Landroid/view/WindowManager$LayoutParams;

.field private Zda:Lcom/android/server/wm/q$zta;

.field private _da:Lcom/android/server/wm/ActivityRecord;
...
.field private cea:Lcom/android/internal/view/IInputMethodManager;

.field private dea:Lcom/oneplus/config/ConfigObserver;
...
.field private final iea:Landroid/util/ArrayMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private mSettingsObserver:Lcom/android/server/wm/q$sis;

.field private mWindowManager:Landroid/view/WindowManager;

.field mea:Landroid/view/View;

.field nea:Landroid/view/View;

.field oea:Landroid/view/View;

.field pea:Landroid/widget/FrameLayout;

.field qea:Landroid/widget/FrameLayout;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, rea:Ljava/lang/Object;
    ...
    sput-object v0, Wea:Ljava/util/List;
    ...
    sput-object v0, Xea:Ljava/util/List;
    ...
    sput-object v0, Yea:Ljava/util/List;
    ...
    sput-object v0, Zea:Ljava/util/List;
    ...
    sput-object v0, _ea:Ljava/util/List;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Sda:Z

    iput-boolean v0, p0, Tda:Z

    const/4 v0, -0x1

    iput v0, p0, mScreenHeight:I
    ...
    iput-object v0, p0, aea:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, iea:Landroid/util/ArrayMap;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, jea:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, kea:Ljava/util/List;
...
.method private Gc(I)V
    ...
    iget-object v0, p0, Yda:Landroid/view/WindowManager$LayoutParams;

    iput p1, v0, Landroid/view/WindowManager$LayoutParams;->height:I

    iget-object p1, p0, mea:Landroid/view/View;

    invoke-direct {p0}, Vs()V

    if-nez p1, :cond_1

    iget-object p1, p0, Yda:Landroid/view/WindowManager$LayoutParams;
    ...
    iput-object p1, p0, mea:Landroid/view/View;
    ...
    iput-object p1, p0, pea:Landroid/widget/FrameLayout;
    ...
    iput-object p1, p0, qea:Landroid/widget/FrameLayout;

    iget-object p1, p0, qea:Landroid/widget/FrameLayout;

    new-instance v0, Lcom/android/server/wm/n;

    invoke-direct {v0, p0}, Lcom/android/server/wm/n;-><init>(Lcom/android/server/wm/q;)V
    ...
    new-instance v0, Lcom/android/server/wm/o;

    invoke-direct {v0, p0}, Lcom/android/server/wm/o;-><init>(Lcom/android/server/wm/q;)V
    ...
    iget-object v0, p0, mea:Landroid/view/View;

    iget-object v1, p0, Yda:Landroid/view/WindowManager$LayoutParams;

    invoke-interface {p1, v0, v1}, Landroid/view/WindowManager;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    iget-object p1, p0, Zda:Lcom/android/server/wm/q$zta;

    const/4 v0, 0x5

    invoke-virtual {p1, v0}, Landroid/os/Handler;->removeMessages(I)V

    iget-object p0, p0, Zda:Lcom/android/server/wm/q$zta;
...
.method private Hc(I)V
    ...
    iget-object p0, p0, jea:Ljava/util/ArrayList;
...
.method private Ic(I)V
    ...
    iget-object p0, p0, mea:Landroid/view/View;
...
.method private Js()V
    ...
    iget-object v0, p0, mPerfLock:Lcom/oneplus/sdk/utils/OpBoostFramework;
    ...
    :cond_0
    iget-object p0, p0, mPerfLock:Lcom/oneplus/sdk/utils/OpBoostFramework;
...
.method private Ks()V
    ...
    iget-object v0, p0, lea:Landroid/view/View;
    ...
    iget-object v0, p0, Vda:Landroid/view/WindowManager$LayoutParams;
    ...
    iput-object v0, p0, lea:Landroid/view/View;

    iget-object v0, p0, lea:Landroid/view/View;

    new-instance v3, Lcom/android/server/wm/j;

    invoke-direct {v3, p0}, Lcom/android/server/wm/j;-><init>(Lcom/android/server/wm/q;)V
    ...
    new-instance v3, Lcom/android/server/wm/k;

    invoke-direct {v3, p0}, Lcom/android/server/wm/k;-><init>(Lcom/android/server/wm/q;)V
    ...
    iget-object v3, p0, lea:Landroid/view/View;

    iget-object v4, p0, Vda:Landroid/view/WindowManager$LayoutParams;

    invoke-interface {v0, v3, v4}, Landroid/view/WindowManager;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    :cond_0
    iget-object v0, p0, nea:Landroid/view/View;

    if-nez v0, :cond_1

    iget-object v0, p0, Wda:Landroid/view/WindowManager$LayoutParams;
    ...
    iput-object v0, p0, nea:Landroid/view/View;

    iget-object v0, p0, nea:Landroid/view/View;

    new-instance v1, Lcom/android/server/wm/l;

    invoke-direct {v1, p0}, Lcom/android/server/wm/l;-><init>(Lcom/android/server/wm/q;)V
    ...
    iget-object v1, p0, nea:Landroid/view/View;

    iget-object v3, p0, Wda:Landroid/view/WindowManager$LayoutParams;

    invoke-interface {v0, v1, v3}, Landroid/view/WindowManager;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    :cond_1
    iget-object v0, p0, oea:Landroid/view/View;
    ...
    iput-object v0, p0, oea:Landroid/view/View;

    iget-object v0, p0, oea:Landroid/view/View;

    new-instance v1, Lcom/android/server/wm/m;

    invoke-direct {v1, p0}, Lcom/android/server/wm/m;-><init>(Lcom/android/server/wm/q;)V
    ...
    iget-object v1, p0, oea:Landroid/view/View;

    iget-object p0, p0, Xda:Landroid/view/WindowManager$LayoutParams;
...
.method private Ns()Ljava/lang/String;
    ...
    iget-object v0, p0, Uda:Lcom/android/server/wm/WindowManagerService;
    ...
    iget-object p0, p0, Uda:Lcom/android/server/wm/WindowManagerService;
...
.method private Oc(Ljava/lang/String;)Z
    ...
    sget-object p0, Yea:Ljava/util/List;
...
.method private Os()V
    ...
    iget-object v0, p0, cea:Lcom/android/internal/view/IInputMethodManager;
    ...
    :goto_1
    iget-object v3, p0, Uda:Lcom/android/server/wm/WindowManagerService;
    ...
    invoke-direct {p0, v2}, Oc(Ljava/lang/String;)Z
    ...
    :cond_4
    invoke-direct {p0, v0}, Hc(I)V

    iget-object v4, p0, mAMS:Lcom/android/server/am/ActivityManagerService;
    ...
    invoke-direct {p0, v5}, Oc(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v6}, Hc(I)V

    iget-object v6, p0, mAMS:Lcom/android/server/am/ActivityManagerService;
...
.method private Ps()V
    ...
    iget-object v5, p0, iea:Landroid/util/ArrayMap;
...
.method private Qs()V
    ...
    iget-object v2, p0, lea:Landroid/view/View;

    invoke-interface {v0, v2}, Landroid/view/WindowManager;->removeView(Landroid/view/View;)V

    :cond_0
    iput-object v1, p0, lea:Landroid/view/View;
    ...
    iget-object v2, p0, nea:Landroid/view/View;

    invoke-interface {v0, v2}, Landroid/view/WindowManager;->removeView(Landroid/view/View;)V

    :cond_2
    iput-object v1, p0, nea:Landroid/view/View;
    ...
    iget-object v2, p0, oea:Landroid/view/View;

    invoke-interface {v0, v2}, Landroid/view/WindowManager;->removeView(Landroid/view/View;)V

    :cond_4
    iput-object v1, p0, oea:Landroid/view/View;
...
.method private Rs()V
    ...
    iget-object v0, p0, Zda:Lcom/android/server/wm/q$zta;
    ...
    iget-object v1, p0, mea:Landroid/view/View;
    ...
    iput-object v0, p0, mea:Landroid/view/View;
...
.method private Ss()V
    ...
    iget-object p0, p0, Yda:Landroid/view/WindowManager$LayoutParams;
...
.method private Ts()V
    ...
    iput-object v0, p0, Vda:Landroid/view/WindowManager$LayoutParams;
    ...
    iput-object v0, p0, Wda:Landroid/view/WindowManager$LayoutParams;

    iget-object v0, p0, Wda:Landroid/view/WindowManager$LayoutParams;

    iget-object v1, p0, Vda:Landroid/view/WindowManager$LayoutParams;
    ...
    iput-object v0, p0, Xda:Landroid/view/WindowManager$LayoutParams;

    iget-object v0, p0, Xda:Landroid/view/WindowManager$LayoutParams;
    ...
    iput-object v0, p0, Yda:Landroid/view/WindowManager$LayoutParams;
...
.method private Us()V
    ...
    invoke-direct {p0}, getAppBounds()Landroid/graphics/Rect;
    ...
    iget-object v1, p0, Wda:Landroid/view/WindowManager$LayoutParams;
    ...
    iget-object v1, p0, Xda:Landroid/view/WindowManager$LayoutParams;
    ...
    iget-object v1, p0, lea:Landroid/view/View;

    iget-object v2, p0, Vda:Landroid/view/WindowManager$LayoutParams;
    ...
    iget-object v2, p0, Wda:Landroid/view/WindowManager$LayoutParams;
...
.method private Vs()V
    ...
    iget-object v0, p0, mDisplayFrames:Lcom/android/server/wm/DisplayFrames;
    ...
    iget-object v3, p0, mDisplayFrames:Lcom/android/server/wm/DisplayFrames;
    ...
    :cond_1
    iget-object v1, p0, mDisplayFrames:Lcom/android/server/wm/DisplayFrames;

    iget-object v1, v1, Lcom/android/server/wm/DisplayFrames;->mDock:Landroid/graphics/Rect;

    iget v1, v1, Landroid/graphics/Rect;->right:I

    iget-object v3, p0, Yda:Landroid/view/WindowManager$LayoutParams;
    ...
    iget-object v2, p0, mDisplayFrames:Lcom/android/server/wm/DisplayFrames;
    ...
    iget-object v2, p0, Yda:Landroid/view/WindowManager$LayoutParams;
...
.method private Ws()V
    ...
    :try_start_0
    iget-object v0, p0, _da:Lcom/android/server/wm/ActivityRecord;
    ...
    invoke-virtual {p0, v0}, isQuickReplyIM(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0}, getImBound()Landroid/graphics/Rect;
...
.method static synthetic bio(Lcom/android/server/wm/q;)V
    .locals 0
...
.method static synthetic bvj(Lcom/android/server/wm/q;)Lcom/android/server/wm/q$zta;
    .locals 0
...
.method static synthetic cno(Lcom/android/server/wm/q;)V
    .locals 0
...
.method static synthetic dma(Lcom/android/server/wm/q;)V
    .locals 0
...
.method private eb(Z)V
    ...
    iget-object p1, p0, Uda:Lcom/android/server/wm/WindowManagerService;
...
.method static synthetic gck(Lcom/android/server/wm/q;)V
    .locals 0
...
.method public static getInstance(Landroid/content/Context;)Lcom/android/server/wm/q;
    .locals 2

    const-class v0, Lcom/android/server/wm/q;

    monitor-enter v0

    :try_start_0
    sget-object v1, sInstance:Lcom/android/server/wm/q;

    if-nez v1, :cond_0

    new-instance v1, Lcom/android/server/wm/q;

    invoke-direct {v1, p0}, <init>(Landroid/content/Context;)V

    sput-object v1, sInstance:Lcom/android/server/wm/q;

    :cond_0
    sget-object p0, sInstance:Lcom/android/server/wm/q;
...
.method static synthetic gwm(Lcom/android/server/wm/q;)Landroid/view/WindowManager$LayoutParams;
    .locals 0
...
.method static synthetic ibl(Lcom/android/server/wm/q;)I
    .locals 0
...
.method static synthetic igw(Lcom/android/server/wm/q;)V
    .locals 0
...
.method private igw(Lcom/android/server/wm/WindowState;)Z
    ...
    invoke-virtual {p0, v0}, isQuickReplyIME(Ljava/lang/String;)Z
...
.method private init()V
    ...
    iput-object v0, p0, cea:Lcom/android/internal/view/IInputMethodManager;
    ...
    new-instance v1, Lcom/android/server/wm/q$zta;

    invoke-virtual {v0}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v0

    invoke-direct {v1, p0, v0}, Lcom/android/server/wm/q$zta;-><init>(Lcom/android/server/wm/q;Landroid/os/Looper;)V

    iput-object v1, p0, Zda:Lcom/android/server/wm/q$zta;

    new-instance v0, Lcom/android/server/wm/q$sis;

    iget-object v1, p0, Zda:Lcom/android/server/wm/q$zta;

    invoke-direct {v0, p0, v1}, Lcom/android/server/wm/q$sis;-><init>(Lcom/android/server/wm/q;Lcom/android/server/wm/q$zta;)V

    iput-object v0, p0, mSettingsObserver:Lcom/android/server/wm/q$sis;
...
.method static synthetic kth(Lcom/android/server/wm/q;)V
    .locals 0
...
.method static synthetic oif(Lcom/android/server/wm/q;)Lcom/android/server/wm/ActivityRecord;
    .locals 0

    iget-object p0, p0, _da:Lcom/android/server/wm/ActivityRecord;

    return-object p0
.end method

.method static synthetic qbh(Lcom/android/server/wm/q;)V
    .locals 0
...
.method static synthetic rtg(Lcom/android/server/wm/q;)Lcom/android/server/am/ActivityManagerService;
    .locals 0
...
.method static synthetic sis(Lcom/android/server/wm/q;I)I
    .locals 0
...
.method static synthetic sis(Lcom/android/server/wm/q;)V
    .locals 0
...
.method static synthetic ssp(Lcom/android/server/wm/q;)V
    .locals 0
...
.method static synthetic tsu(Lcom/android/server/wm/q;)Z
    .locals 0

    iget-boolean p0, p0, Sda:Z

    return p0
.end method

.method static synthetic ugm(Lcom/android/server/wm/q;)I
    .locals 0
...
.method private updateSettings()V
    ...
    :goto_0
    iget-boolean v2, p0, bea:Z

    const-string v3, "OpQuickReply"

    if-eq v2, v1, :cond_1

    iput-boolean v1, p0, bea:Z
...
.method static synthetic vdb(Lcom/android/server/wm/q;)I
    .locals 0
...
.method static synthetic wtn(Lcom/android/server/wm/q;)V
    .locals 0
...
.method private wtn(Lorg/json/JSONArray;)V
    ...
    :cond_5
    sget-object p1, rea:Ljava/lang/Object;
    ...
    sput-object p0, Yea:Ljava/util/List;
...
.method static synthetic you(Lcom/android/server/wm/q;)Landroid/util/ArrayMap;
    .locals 0

    iget-object p0, p0, iea:Landroid/util/ArrayMap;

    return-object p0
.end method

.method static synthetic you(Lcom/android/server/wm/q;I)V
    .locals 0

    invoke-direct {p0, p1}, Ic(I)V

    return-void
.end method

.method static synthetic ywr(Lcom/android/server/wm/q;)V
    .locals 0
...
.method static synthetic zta(Lcom/android/server/wm/q;)Landroid/content/Context;
    .locals 0
...
.method private zta(Landroid/os/IBinder;)V
    ...
    :cond_0
    iget-object v1, p0, Uda:Lcom/android/server/wm/WindowManagerService;
...
.method private zta(Landroid/os/IBinder;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1}, isQuickReplyIM(Lcom/android/server/wm/AppWindowToken;)Z
    ...
    :cond_2
    invoke-virtual {p0, p1}, setQuickReplyRunning(Z)V
...
.method private zta(Lcom/android/server/wm/ActivityRecord;)V
    ...
    iget-boolean v0, p0, Sda:Z

    if-nez v0, :cond_5

    iget-object p1, p1, Lcom/android/server/wm/ActivityRecord;->packageName:Ljava/lang/String;

    invoke-virtual {p0, p1}, isQuickReplyIME(Ljava/lang/String;)Z
    ...
    iput-boolean p1, p0, Tda:Z

    iget-object p1, p0, aea:Ljava/util/ArrayList;
    ...
    :cond_3
    iget-object v3, p0, mAMS:Lcom/android/server/am/ActivityManagerService;
    ...
    iget-object v3, p0, _da:Lcom/android/server/wm/ActivityRecord;
...
.method static synthetic zta(Lcom/android/server/wm/q;I)V
    .locals 0

    invoke-direct {p0, p1}, Gc(I)V

    return-void
.end method

.method static synthetic zta(Lcom/android/server/wm/q;Landroid/os/IBinder;)V
    .locals 0

    invoke-direct {p0, p1}, zta(Landroid/os/IBinder;)V

    return-void
.end method

.method static synthetic zta(Lcom/android/server/wm/q;Lcom/android/server/wm/ActivityRecord;)V
    .locals 0

    invoke-direct {p0, p1}, zta(Lcom/android/server/wm/ActivityRecord;)V

    return-void
.end method

.method static synthetic zta(Lcom/android/server/wm/q;Lorg/json/JSONArray;)V
    .locals 0

    invoke-direct {p0, p1}, wtn(Lorg/json/JSONArray;)V

    return-void
.end method

.method static synthetic zta(Lcom/android/server/wm/q;Z)V
    .locals 0

    invoke-direct {p0, p1}, eb(Z)V
...
.method private zta(Ljava/lang/String;Lcom/android/server/wm/WindowState;)Z
    ...
    invoke-direct {p0, p2}, igw(Lcom/android/server/wm/WindowState;)Z
...
.method public bootComplete()V
    ...
    iget-object v0, p0, dea:Lcom/oneplus/config/ConfigObserver;
    ...
    iget-object v3, p0, Zda:Lcom/android/server/wm/q$zta;

    new-instance v4, Lcom/android/server/wm/q$you;

    invoke-direct {v4, p0}, Lcom/android/server/wm/q$you;-><init>(Lcom/android/server/wm/q;)V
    ...
    iput-object v0, p0, dea:Lcom/oneplus/config/ConfigObserver;
    ...
    invoke-direct {p0, v0}, wtn(Lorg/json/JSONArray;)V
...
.method public checkAndAddWindow(Lcom/android/server/wm/WindowState;Lcom/android/server/wm/DisplayContent;)V
    ...
    invoke-virtual {p0}, isQuickReplyRunning()Z

    move-result v0

    if-eqz v0, :cond_2

    invoke-virtual {p0, p1}, isQuickReplyIMEWin(Lcom/android/server/wm/WindowState;)Z
...
.method public exitQuickReply()V
    ...
    iget-object v2, p0, _da:Lcom/android/server/wm/ActivityRecord;
    ...
    :cond_0
    iget-object v2, p0, Zda:Lcom/android/server/wm/q$zta;
...
.method public focusChangedLw(Lcom/android/server/wm/WindowState;Lcom/android/server/wm/WindowState;)V
    ...
    invoke-direct {p0}, Ns()Ljava/lang/String;

    move-result-object p1

    invoke-direct {p0, p1, p2}, zta(Ljava/lang/String;Lcom/android/server/wm/WindowState;)Z
    ...
    invoke-virtual {p0, p1}, isQuickReplyIM(Ljava/lang/String;)Z
...
.method public getQuickReplyList(I)Ljava/util/List;
    ...
    :cond_0
    iget-boolean p0, p0, bea:Z

    if-eqz p0, :cond_1

    sget-object v1, Yea:Ljava/util/List;

    :cond_1
    return-object v1

    :cond_2
    sget-object p0, Xea:Ljava/util/List;
...
.method public getQuickReplyOrientation(Lcom/android/server/wm/TaskStack;Lcom/android/server/wm/AppWindowToken;)I
    ...
    invoke-virtual {p0}, exitQuickReply()V

    :cond_0
    if-eqz p2, :cond_3

    invoke-virtual {p0, p2}, isQuickReplyIM(Lcom/android/server/wm/AppWindowToken;)Z
...
.method public isInCameraActivityList(Ljava/lang/String;)Z
    ...
    sget-object p0, Zea:Ljava/util/List;
...
.method public isQuickReplyIM(Lcom/android/server/wm/AppWindowToken;)Z
    ...
    invoke-virtual {p0, v1}, isQuickReplyIM(Ljava/lang/String;)Z
...
.method public isQuickReplyIM(Ljava/lang/String;)Z
    ...
    sget-object v0, Wea:Ljava/util/List;
    ...
    sget-object v0, Xea:Ljava/util/List;
    ...
    iget-object p0, p0, kea:Ljava/util/List;
...
.method public killApplicationProcess(Lcom/android/server/wm/ActivityTaskManagerService;Landroid/content/pm/ActivityInfo;)V
    ...
    invoke-direct {v1, p0, p1, p2}, Lcom/android/server/wm/p;-><init>(Lcom/android/server/wm/q;Lcom/android/server/wm/ActivityTaskManagerService;Landroid/content/pm/ActivityInfo;)V
...
.method public notifyImeShow(Ljava/lang/String;)V
    ...
    iget-object v0, p0, iea:Landroid/util/ArrayMap;
    ...
    new-instance v2, Lcom/android/server/wm/h;

    invoke-direct {v2, p0, p1, v0}, Lcom/android/server/wm/h;-><init>(Lcom/android/server/wm/q;Ljava/lang/String;Ljava/lang/Integer;)V
...
.method public setAMandWM(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/wm/WindowManagerService;)V
    ...
    iput-object p2, p0, Uda:Lcom/android/server/wm/WindowManagerService;
...
.method public setDisplayFrames(Lcom/android/server/wm/DisplayFrames;)V
    ...
    iput-object p1, p0, mDisplayFrames:Lcom/android/server/wm/DisplayFrames;
...
.method public setKeyguardDone(Z)V
    ...
    iget-object p1, p0, _da:Lcom/android/server/wm/ActivityRecord;

    if-eqz p1, :cond_0

    iget-object p1, p0, mAMS:Lcom/android/server/am/ActivityManagerService;
...
.method public setQuickReplyRunning(Z)V
    ...
    iput-boolean p1, p0, Sda:Z

    iget-object v0, p0, Zda:Lcom/android/server/wm/q$zta;

    new-instance v1, Lcom/android/server/wm/i;

    invoke-direct {v1, p0}, Lcom/android/server/wm/i;-><init>(Lcom/android/server/wm/q;)V
...
.method public setResumedApp(Lcom/android/server/wm/ActivityRecord;)V
    ...
    invoke-direct {p0, v1, v2}, zta(Landroid/os/IBinder;Ljava/lang/String;)V

    iget-boolean v1, p0, Sda:Z

    if-eqz v1, :cond_3

    iget-object v1, p0, aea:Ljava/util/ArrayList;
    ...
    sget-object v1, _ea:Ljava/util/List;
    ...
    :cond_4
    :goto_0
    iput-object p1, p0, _da:Lcom/android/server/wm/ActivityRecord;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
