...
.field private static final hc:F = 0.6f

.field public static final ic:J = 0x12cL

.field private static final jc:Landroid/view/animation/Interpolator;

.field private static final kc:Landroid/view/animation/Interpolator;
...
.field private final _b:Landroid/graphics/Rect;
...
.field private cc:Lcom/android/server/wm/zta/zta$zta;

.field private dc:Lcom/android/server/wm/zta/zta$zta;

.field private ec:Lcom/android/server/wm/zta/zta$zta;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, LINEAR:Landroid/view/animation/Interpolator;
    ...
    sput-object v0, jc:Landroid/view/animation/Interpolator;
    ...
    sput-object v1, kc:Landroid/view/animation/Interpolator;
...
.method public constructor <init>(Landroid/graphics/Rect;Landroid/graphics/Rect;F)V
    ...
    iput-wide v0, p0, Ub:J

    const-wide/16 v0, 0xf0

    iput-wide v0, p0, Vb:J

    const-wide/16 v0, 0x78

    iput-wide v0, p0, Wb:J

    const-wide/16 v0, 0x32

    iput-wide v0, p0, Xb:J

    const-wide/16 v0, 0x28

    iput-wide v0, p0, Yb:J

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, ac:Landroid/graphics/RectF;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, bc:Ljava/util/ArrayList;

    iput-object p1, p0, Zb:Landroid/graphics/Rect;

    iput-object p2, p0, _b:Landroid/graphics/Rect;

    invoke-direct {p0, p3}, you(F)V
...
.method private Zl()V
    ...
    iget-object v0, p0, Zb:Landroid/graphics/Rect;
    ...
    iget-object v1, p0, cc:Lcom/android/server/wm/zta/zta$zta;

    iget v1, v1, Lcom/android/server/wm/zta/zta$zta;->value:F

    mul-float/2addr v0, v1

    iget-object v1, p0, Zb:Landroid/graphics/Rect;
    ...
    iget-object v2, p0, cc:Lcom/android/server/wm/zta/zta$zta;

    iget v2, v2, Lcom/android/server/wm/zta/zta$zta;->value:F

    mul-float/2addr v1, v2

    iget-object v2, p0, ec:Lcom/android/server/wm/zta/zta$zta;

    iget v2, v2, Lcom/android/server/wm/zta/zta$zta;->value:F

    float-to-int v2, v2

    iget-object v3, p0, _b:Landroid/graphics/Rect;
    ...
    iget-object v0, p0, ac:Landroid/graphics/RectF;
    ...
    iget-object v1, p0, mDx:Lcom/android/server/wm/zta/zta$zta;

    iget v1, v1, Lcom/android/server/wm/zta/zta$zta;->value:F

    iget-object v4, p0, mDy:Lcom/android/server/wm/zta/zta$zta;
    ...
    invoke-direct {p0, v0, v1}, zta(Landroid/graphics/RectF;F)V
...
.method private irq(J)V
    .locals 6

    iget-object v0, p0, bc:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, bc:Ljava/util/ArrayList;
...
.method private you(F)V
    ...
    iget-object v0, v7, _b:Landroid/graphics/Rect;
    ...
    iget-object v1, v7, Zb:Landroid/graphics/Rect;
    ...
    iget-object v1, v7, _b:Landroid/graphics/Rect;
    ...
    iget-object v2, v7, Zb:Landroid/graphics/Rect;
    ...
    sget-object v6, jc:Landroid/view/animation/Interpolator;
    ...
    iput-object v15, v7, mDx:Lcom/android/server/wm/zta/zta$zta;
    ...
    iput-object v15, v7, mDy:Lcom/android/server/wm/zta/zta$zta;
    ...
    sget-object v6, kc:Landroid/view/animation/Interpolator;
    ...
    iput-object v9, v7, cc:Lcom/android/server/wm/zta/zta$zta;
    ...
    sget-object v6, LINEAR:Landroid/view/animation/Interpolator;
    ...
    iput-object v8, v7, dc:Lcom/android/server/wm/zta/zta$zta;
    ...
    iput-object v8, v7, ec:Lcom/android/server/wm/zta/zta$zta;

    iget-object v0, v7, bc:Ljava/util/ArrayList;

    iget-object v1, v7, mDx:Lcom/android/server/wm/zta/zta$zta;

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v0, v7, bc:Ljava/util/ArrayList;

    iget-object v1, v7, mDy:Lcom/android/server/wm/zta/zta$zta;

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v0, v7, bc:Ljava/util/ArrayList;

    iget-object v1, v7, cc:Lcom/android/server/wm/zta/zta$zta;

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v0, v7, bc:Ljava/util/ArrayList;

    iget-object v1, v7, dc:Lcom/android/server/wm/zta/zta$zta;

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v0, v7, bc:Ljava/util/ArrayList;

    iget-object v1, v7, ec:Lcom/android/server/wm/zta/zta$zta;
...
.method protected applyTransformation(FLandroid/view/animation/Transformation;)V
    ...
    iget-object p1, p0, dc:Lcom/android/server/wm/zta/zta$zta;
    ...
    iget-object p2, p0, dc:Lcom/android/server/wm/zta/zta$zta;
    ...
    iget-object p0, p0, Zb:Landroid/graphics/Rect;
...
.method public getTransformation(JLandroid/view/animation/Transformation;)Z
    ...
    invoke-direct {p0, v0, v1}, irq(J)V
