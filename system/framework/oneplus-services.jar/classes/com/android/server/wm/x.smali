.class public Lcom/android/server/wm/x;
...
# static fields
.field private static final Afa:I = 0x4
...
.field private static final yfa:I = 0x2

.field private static final zfa:I = 0x3
...
.field private vfa:Landroid/graphics/Color;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mOriginalDisplayRect:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, vfa:Landroid/graphics/Color;
...
.method private zta(Landroid/graphics/Bitmap;II)I
    ...
    :cond_6
    new-instance p1, Lcom/android/server/wm/w;

    invoke-direct {p1, p0}, Lcom/android/server/wm/w;-><init>(Lcom/android/server/wm/x;)V
...
.method private zta(ILandroid/view/animation/Animation;Landroid/view/animation/Animation;II)V
    ...
    iget v4, v0, mOriginalWidth:I

    iget v5, v0, mOriginalHeight:I
    ...
    :cond_4
    :goto_2
    iget v1, v0, mOriginalWidth:I

    iget v2, v0, mOriginalHeight:I
...
.method public init(Lcom/android/server/wm/DisplayContent;ZZLcom/android/server/wm/WindowManagerService;Landroid/view/SurfaceControl;Landroid/view/SurfaceControl$ScreenshotGraphicBuffer;)V
    ...
    iput-object p5, p0, mSurfaceControl:Landroid/view/SurfaceControl;

    iput-object p1, p0, mDisplayContent:Lcom/android/server/wm/DisplayContent;

    iget-object p3, p0, mOriginalDisplayRect:Landroid/graphics/Rect;
    ...
    :goto_2
    iput p4, p0, mOriginalRotation:I

    iput p2, p0, mOriginalWidth:I

    iput p1, p0, mOriginalHeight:I
    ...
    invoke-direct {p0, p1, p2, p3}, zta(Landroid/graphics/Bitmap;II)I
...
.method public loadAnimation(IZII)Landroid/view/animation/Animation;
    ...
    invoke-direct/range {v2 .. v7}, zta(ILandroid/view/animation/Animation;Landroid/view/animation/Animation;II)V
...
.method public stepAnimation(JILandroid/view/animation/Animation;)V
    ...
    invoke-direct {p0, p1}, sis(F)Landroid/graphics/Color;

    move-result-object p1

    iput-object p1, p0, vfa:Landroid/graphics/Color;
    ...
    iget p1, p0, mOriginalRotation:I
    ...
    iget p2, p0, mOriginalRotation:I
...
.method public updateEnteringBlackFrame(Landroid/view/SurfaceControl$Transaction;Lcom/android/server/wm/BlackFrame;)Lcom/android/server/wm/BlackFrame;
    ...
    iget-object v1, p0, vfa:Landroid/graphics/Color;
    ...
    iget-object p0, p0, vfa:Landroid/graphics/Color;
