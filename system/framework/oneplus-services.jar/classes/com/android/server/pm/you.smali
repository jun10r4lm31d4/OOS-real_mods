...
.field private static final JJ:Ljava/lang/String; = "/data/system/opdom"
...
.field private static mInstance:Lcom/android/server/pm/you;
...
.field private volatile EJ:Ljava/lang/String;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, FJ:Z

    sput-boolean v0, GJ:Z

    sput-boolean v0, HJ:Z

    sput-boolean v0, IJ:Z

    const/4 v0, 0x0

    sput-object v0, mInstance:Lcom/android/server/pm/you;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, xJ:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mBlackList:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, yJ:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, zJ:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, AJ:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, BJ:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, CJ:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, EJ:Ljava/lang/String;
    ...
    sput-boolean v1, FJ:Z

    sget-boolean v1, FJ:Z
    ...
    iput-object v0, p0, mHandler:Lcom/android/server/pm/you$zta;

    iget-object v0, p0, xJ:Ljava/util/ArrayList;
    ...
    iget-object v0, p0, mBlackList:Ljava/util/ArrayList;

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object p0, p0, mBlackList:Ljava/util/ArrayList;
...
.method static synthetic cno(Lcom/android/server/pm/you;)Ljava/util/ArrayList;
    ...
    iget-object p0, p0, CJ:Ljava/util/ArrayList;

    return-object p0
.end method

.method public static getInstance(Landroid/content/Context;)Lcom/android/server/pm/you;
    .locals 1

    sget-object v0, mInstance:Lcom/android/server/pm/you;
    ...
    sget-object p0, mInstance:Lcom/android/server/pm/you;

    return-object p0
.end method

.method static synthetic rtg(Lcom/android/server/pm/you;)Ljava/util/ArrayList;
    .locals 0

    iget-object p0, p0, AJ:Ljava/util/ArrayList;
...
.method static synthetic sis(Lcom/android/server/pm/you;)Ljava/lang/String;
    ...
    iget-object p0, p0, EJ:Ljava/lang/String;

    return-object p0
.end method

.method private sis(ILjava/lang/String;Ljava/lang/String;)V
    .locals 2

    iget-object v0, p0, mHandler:Lcom/android/server/pm/you$zta;
    ...
    iget-object p0, p0, mHandler:Lcom/android/server/pm/you$zta;
...
.method static synthetic ssp(Lcom/android/server/pm/you;)Ljava/util/ArrayList;
    .locals 0

    iget-object p0, p0, BJ:Ljava/util/ArrayList;
...
.method private ssp(Lorg/json/JSONArray;)V
    ...
    iget-object v2, p0, AJ:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, BJ:Ljava/util/ArrayList;
    ...
    :try_start_1
    iget-object v4, p0, BJ:Ljava/util/ArrayList;
    ...
    sget-boolean v3, GJ:Z

    if-eq v2, v3, :cond_8

    sput-boolean v2, GJ:Z
    ...
    invoke-virtual {p0, v2}, setEnable(Z)V
...
.method static synthetic tsu(Lcom/android/server/pm/you;)V
    .locals 0

    invoke-direct {p0}, xp()V

    return-void
.end method

.method private declared-synchronized wp()V
    .locals 3
    ...
    iget-object v0, p0, yJ:Ljava/util/ArrayList;
    ...
    :goto_0
    iget-object v2, p0, yJ:Ljava/util/ArrayList;
...
.method private xp()V
    ...
    iget-object p0, p0, yJ:Ljava/util/ArrayList;
...
.method static synthetic zta(Lcom/android/server/pm/you;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object p1, p0, EJ:Ljava/lang/String;
...
.method static synthetic zta(Lcom/android/server/pm/you;Lorg/json/JSONArray;)V
    .locals 0

    invoke-direct {p0, p1}, ssp(Lorg/json/JSONArray;)V

    return-void
.end method

.method static synthetic zta(Lcom/android/server/pm/you;Ljava/lang/String;Ljava/lang/String;Z)Z
    .locals 0

    invoke-direct {p0, p1, p2, p3}, you(Ljava/lang/String;Ljava/lang/String;Z)Z
...
.method public dumpState(Ljava/io/PrintWriter;)V
    ...
    iget-object v1, p0, AJ:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, yJ:Ljava/util/ArrayList;
...
.method public frontPackageChanged(Ljava/lang/String;IILjava/lang/String;II)V
    ...
    :cond_0
    iget-object p2, p0, xJ:Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object p1, p0, zJ:Ljava/util/ArrayList;

    monitor-enter p1

    :try_start_0
    iget-object p2, p0, zJ:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, zJ:Ljava/util/ArrayList;
...
.method public initOnlineConfig()V
    ...
    iget-object v2, p0, mHandler:Lcom/android/server/pm/you$zta;
...
.method public notifyDexoptSecondaryDex(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_0
    iget-object v0, p0, BJ:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, BJ:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, CJ:Ljava/util/ArrayList;

    monitor-enter v1

    :try_start_1
    iget-object v0, p0, CJ:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v0, p1, p2}, sis(ILjava/lang/String;Ljava/lang/String;)V
...
.method public packageRemoved(Ljava/lang/String;)V
    ...
    :cond_0
    iget-object v0, p0, zJ:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, zJ:Ljava/util/ArrayList;
...
.method public setEnable(Z)V
    ...
    invoke-direct {p0, v0, p1}, zgw(Ljava/lang/String;Ljava/lang/String;)V
