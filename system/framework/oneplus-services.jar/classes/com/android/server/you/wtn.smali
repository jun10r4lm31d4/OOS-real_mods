...
# static fields
.field private static final AU:I = 0xe1

.field static final BU:I = 0x96

.field private static final CU:I = 0x12c

.field private static final DEBUG:Z

.field static final DU:I = 0x0

.field static final EU:I = 0x1

.field static final FU:I = 0x2

.field static final GU:I = 0x3

.field private static final TAG:Ljava/lang/String; = "OpVCWindow"

.field private static final zU:I = 0x145


# instance fields
.field private kU:Lcom/android/server/you/wtn$you;
...
.field private final mU:Landroid/graphics/Rect;

.field private mWindow:Landroid/view/Window;

.field private mWindowManager:Landroid/view/WindowManager;

.field private nU:Landroid/animation/AnimatorSet;

.field private oU:Landroid/animation/AnimatorSet;

.field private pU:Landroid/animation/ValueAnimator;
...
.field xU:Landroid/animation/Animator$AnimatorListener;

.field yU:Landroid/animation/Animator$AnimatorListener;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, mU:Landroid/graphics/Rect;

    iput-boolean v0, p0, qU:Z

    iput-boolean v0, p0, rU:Z
    ...
    iput-object v1, p0, xU:Landroid/animation/Animator$AnimatorListener;
    ...
    iput-object v1, p0, yU:Landroid/animation/Animator$AnimatorListener;
    ...
    invoke-static {v1}, logi(Ljava/lang/String;)V
    ...
    iput-object p1, p0, sU:Landroid/content/res/Configuration;
...
.method private Ac(Ljava/lang/String;)V
    ...
    :cond_1
    iget-object p0, p0, mDecor:Landroid/view/View;
...
.method static synthetic gck(Lcom/android/server/you/wtn;)Landroid/animation/ValueAnimator;
    ...
    iget-object p0, p0, pU:Landroid/animation/ValueAnimator;
...
.method private qq()V
    ...
    iget-object v0, p0, oU:Landroid/animation/AnimatorSet;
    ...
    iget-object p0, p0, oU:Landroid/animation/AnimatorSet;
...
.method private rq()V
    ...
    iget-object v0, p0, nU:Landroid/animation/AnimatorSet;
    ...
    iget-object p0, p0, nU:Landroid/animation/AnimatorSet;
...
.method static synthetic sis(Lcom/android/server/you/wtn;)Lcom/android/server/you/wtn$you;
    ...
    iget-object p0, p0, kU:Lcom/android/server/you/wtn$you;
...
.method private sq()V
    ...
    iput-object v1, p0, mDecor:Landroid/view/View;
    ...
    iput-object v1, p0, kU:Lcom/android/server/you/wtn$you;
    ...
    invoke-static {p0}, logd(Ljava/lang/String;)V
...
.method private tq()V
    ...
    iget-object v1, p0, mU:Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, v0}, zta(Landroid/view/WindowManager$LayoutParams;)V
...
.method private uq()V
    ...
    iget-object v1, p0, mDecor:Landroid/view/View;
    ...
    :cond_0
    iget-object v1, p0, nU:Landroid/animation/AnimatorSet;
    ...
    invoke-static {p0}, logi(Ljava/lang/String;)V
    ...
    iput-object v2, p0, nU:Landroid/animation/AnimatorSet;

    iget-object v2, p0, nU:Landroid/animation/AnimatorSet;
    ...
    iget-object v1, p0, yU:Landroid/animation/Animator$AnimatorListener;

    invoke-virtual {v0, v1}, Landroid/animation/AnimatorSet;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    iput-boolean v10, p0, qU:Z
...
.method static synthetic you(Lcom/android/server/you/wtn;Landroid/animation/AnimatorSet;)Landroid/animation/AnimatorSet;
    ...
    iput-object p1, p0, nU:Landroid/animation/AnimatorSet;
...
.method private you(Landroid/view/WindowManager$LayoutParams;)V
    ...
    invoke-direct {p0, v1, v2}, tsu(Landroid/content/Context;I)I
    ...
    invoke-virtual {p0, p1}, zta(Landroid/view/WindowManager$LayoutParams;)V
...
.method static synthetic zta(Lcom/android/server/you/wtn;Landroid/content/Context;I)I
    ...
    invoke-direct {p0, p1, p2}, tsu(Landroid/content/Context;I)I
...
.method static synthetic zta(Lcom/android/server/you/wtn;Landroid/animation/AnimatorSet;)Landroid/animation/AnimatorSet;
    ...
    iput-object p1, p0, oU:Landroid/animation/AnimatorSet;
...
.method static synthetic zta(Lcom/android/server/you/wtn;Landroid/animation/ValueAnimator;)Landroid/animation/ValueAnimator;
    ...
    iput-object p1, p0, pU:Landroid/animation/ValueAnimator;
...
.method public C(I)V
    ...
    iput-object v0, p0, oU:Landroid/animation/AnimatorSet;
    ...
    iget-object p1, p0, oU:Landroid/animation/AnimatorSet;
    ...
    iget-object v0, p0, xU:Landroid/animation/Animator$AnimatorListener;

    invoke-virtual {p1, v0}, Landroid/animation/AnimatorSet;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    iput-boolean v7, p0, rU:Z
...
.method public xe()Z
    ...
    :try_start_0
    iget-object v1, p0, sU:Landroid/content/res/Configuration;
...
.method zta(Landroid/view/WindowManager$LayoutParams;)V
    ...
    iget-object v0, p0, mU:Landroid/graphics/Rect;
    ...
    invoke-direct {p0, v0, v1}, tsu(Landroid/content/Context;I)I
...
.method public zta(Lcom/android/server/you/wtn$you;)V
    ...
    iput-object p1, p0, kU:Lcom/android/server/you/wtn$you;
...
.method public zta(Ljava/lang/String;Landroid/graphics/Rect;)V
    ...
    iget-boolean p2, p0, lU:Z

    if-eqz p2, :cond_1

    iget-object p2, p0, mDecor:Landroid/view/View;

    if-eqz p2, :cond_0

    invoke-direct {p0}, qq()V

    invoke-direct {p0, p1}, Ac(Ljava/lang/String;)V

    invoke-direct {p0}, tq()V

    iget-object p1, p0, mDecor:Landroid/view/View;

    const/4 p2, 0x0

    invoke-virtual {p1, p2}, Landroid/view/View;->setVisibility(I)V

    invoke-direct {p0}, uq()V
    ...
    invoke-virtual {p0, p2}, dispatchOnCreate(Landroid/os/Bundle;)V
    ...
    iput-object p2, p0, mDecor:Landroid/view/View;
    ...
    invoke-direct {p0, p1}, you(Landroid/view/View;)V
    ...
    invoke-direct {p0, p1}, you(Landroid/view/WindowManager$LayoutParams;)V
