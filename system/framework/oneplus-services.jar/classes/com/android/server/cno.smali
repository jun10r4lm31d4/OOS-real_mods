.class public final Lcom/android/server/cno;
...
.field private static final Rd:Z

.field private static final Sd:Ljava/lang/String; = "vendor_app_installed"

.field private static final TAG:Ljava/lang/String; = "OnePlusExPostInstaller"

.field private static final Td:Ljava/lang/String; = "com.oneplus.exservice.INTENT_PACKAGE_INSTALL_COMMIT"
...
.field private Nd:Landroid/content/pm/PackageInstaller;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Vd:[Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Md:Ljava/util/HashMap;
    ...
    iput-boolean v0, p0, Qd:Z

    new-instance v1, Lcom/android/server/rtg;

    invoke-direct {v1, p0}, Lcom/android/server/rtg;-><init>(Lcom/android/server/cno;)V
...
.method static synthetic access$800()[Ljava/lang/String;
    ...
    sget-object v0, Vd:[Ljava/lang/String;

    return-object v0
.end method

.method static synthetic cno(Lcom/android/server/cno;)V
    .locals 0
...
.method private em()V
    ...
    :goto_0
    iget-object v0, p0, mSession:Landroid/content/pm/PackageInstaller$Session;
...
.method private oif(ILjava/lang/String;)Landroid/content/IntentSender;
    .locals 2
...
.method private qb(Ljava/lang/String;)V
    ...
    iget-object p1, p0, mPackageManager:Landroid/content/pm/PackageManager;

    invoke-virtual {p1}, Landroid/content/pm/PackageManager;->getPackageInstaller()Landroid/content/pm/PackageInstaller;

    move-result-object p1

    iput-object p1, p0, Nd:Landroid/content/pm/PackageInstaller;
    ...
    :cond_1
    invoke-direct {p0, v3}, zta(Ljava/io/File;)V
...
.method static synthetic rtg(Lcom/android/server/cno;)I
    .locals 0
...
.method static synthetic sis(Lcom/android/server/cno;)I
    .locals 2
...
.method static synthetic ssp(Lcom/android/server/cno;)V
    .locals 0
...
.method static synthetic tsu(Lcom/android/server/cno;)Ljava/util/HashMap;
    .locals 0

    iget-object p0, p0, Md:Ljava/util/HashMap;

    return-object p0
.end method

.method static synthetic you(Lcom/android/server/cno;)I
    .locals 0
...
.method static synthetic zta(Lcom/android/server/cno;)Landroid/content/Context;
    .locals 0
...
.method static synthetic zta(Lcom/android/server/cno;Ljava/lang/String;)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
.method private zta(Ljava/io/File;)V
    ...
    :cond_2
    invoke-direct {p0, v2}, zta(Landroid/content/pm/PackageInfo;)Z
    ...
    iget-object v2, p0, Md:Ljava/util/HashMap;
    ...
    iget-object v4, p0, Nd:Landroid/content/pm/PackageInstaller;
    ...
    iput-object v4, p0, mSession:Landroid/content/pm/PackageInstaller$Session;
    ...
    :try_start_1
    iget-object v5, p0, mSession:Landroid/content/pm/PackageInstaller$Session;
    ...
    :cond_7
    iget-object p1, p0, mSession:Landroid/content/pm/PackageInstaller$Session;
    ...
    invoke-direct {p0, v2, v1}, oif(ILjava/lang/String;)Landroid/content/IntentSender;

    move-result-object v0

    invoke-virtual {p1, v0}, Landroid/content/pm/PackageInstaller$Session;->commit(Landroid/content/IntentSender;)V

    iget-object p0, p0, mSession:Landroid/content/pm/PackageInstaller$Session;
...
.method public zta(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-direct {v0, p0, p2}, Lcom/android/server/ssp;-><init>(Lcom/android/server/cno;Ljava/lang/String;)V
