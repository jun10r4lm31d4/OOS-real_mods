...
# static fields
.field static Ae:Landroid/util/ArrayMap; = null
...
.field private static final Be:I = 0xdac0

.field private static final Ce:J = 0x320L
...
.field static ye:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList<",
            "Ljava/lang/Integer;",
...
.field static ze:Landroid/util/ArrayMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/util/ArrayMap<",
            "Ljava/lang/String;",
...
.field private mHandler:Lcom/android/server/bvj$zta;
...
.field public te:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList<",
            "Ljava/lang/String;",
...
.field xe:Landroid/content/Intent;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, ye:Ljava/util/ArrayList;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    sput-object v0, ze:Landroid/util/ArrayMap;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    sput-object v0, Ae:Landroid/util/ArrayMap;

    const-class v0, Lcom/android/server/bvj;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, se:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, te:Ljava/util/ArrayList;

    const-wide/16 v0, -0x1

    iput-wide v0, p0, ue:J

    const/4 v0, 0x0

    iput-boolean v0, p0, ve:Z
    ...
    iput-object v0, p0, xe:Landroid/content/Intent;

    iput-object v0, p0, mPendingIntent:Landroid/app/PendingIntent;

    new-instance v0, Lcom/android/server/oif;

    invoke-direct {v0, p0}, Lcom/android/server/oif;-><init>(Lcom/android/server/bvj;)V
...
.method private gm()Z
    ...
    :cond_0
    iget-object p0, p0, mLocationManager:Landroid/location/LocationManager;
...
.method static synthetic sis(Lcom/android/server/bvj;)Lcom/android/server/bvj$zta;
    .locals 0

    iget-object p0, p0, mHandler:Lcom/android/server/bvj$zta;

    return-object p0
.end method

.method static synthetic tsu(Lcom/android/server/bvj;)Landroid/app/NotificationManager;
    .locals 0
...
.method static synthetic you(Lcom/android/server/bvj;)Landroid/app/ActivityManager;
    .locals 0
...
.method static synthetic zta(Lcom/android/server/bvj;J)J
    .locals 0

    iput-wide p1, p0, ue:J

    return-wide p1
.end method

.method static synthetic zta(Lcom/android/server/bvj;)Ljava/lang/String;
    .locals 0

    iget-object p0, p0, mAction:Ljava/lang/String;

    return-object p0
.end method

.method static synthetic zta(Lcom/android/server/bvj;Z)Z
    .locals 0

    iput-boolean p1, p0, ve:Z
...
.method public J()V
    ...
    iget-object v0, p0, se:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, te:Ljava/util/ArrayList;

    invoke-virtual {v1}, Ljava/util/ArrayList;->clear()V

    iget-object v1, p0, te:Ljava/util/ArrayList;

    iget-object v2, p0, se:Ljava/util/ArrayList;

    invoke-virtual {v1, v2}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    iget-object v1, p0, se:Ljava/util/ArrayList;
    ...
    :goto_0
    iget-object v4, p0, se:Ljava/util/ArrayList;
    ...
    :try_start_1
    iget-object v7, p0, se:Ljava/util/ArrayList;
    ...
    iget-object v8, p0, se:Ljava/util/ArrayList;
    ...
    iget-object v9, p0, xe:Landroid/content/Intent;
    ...
    iput-object v4, p0, mPendingIntent:Landroid/app/PendingIntent;
...
.method public getCurrentProviderPackageList(Ljava/lang/String;ZLjava/util/HashMap;)Ljava/util/List;
    ...
    iget-object v1, p0, mLocationManagerService:Lcom/android/server/LocationManagerService;
    ...
    iput-object v1, p0, mLocationManagerService:Lcom/android/server/LocationManagerService;
    ...
    sget-object v2, oe:Ljava/util/ArrayList;
...
.method public systemReady()V
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/server/bvj$zta;-><init>(Lcom/android/server/bvj;Landroid/os/Looper;)V

    iput-object v0, p0, mHandler:Lcom/android/server/bvj$zta;
    ...
    iget-object v0, p0, xe:Landroid/content/Intent;

    const/high16 v1, 0x4000000

    invoke-virtual {v0, v1}, Landroid/content/Intent;->addFlags(I)Landroid/content/Intent;

    iget-object p0, p0, xe:Landroid/content/Intent;
