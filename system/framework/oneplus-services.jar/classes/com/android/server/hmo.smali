...
.field private static final dg:I = 0x0

.field private static final eg:I = 0x1

.field private static final fg:I = 0x2

.field private static final gg:I = 0x3

.field static hg:Ljava/util/List;
...
# instance fields
.field private Ef:Lcom/android/server/AlarmManagerService$AmsInner;

.field Uf:[I

.field private Vf:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
.field private final Xf:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap<",
            "Ljava/lang/String;",
...
.field private Yf:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap<",
            "Ljava/lang/String;",
...
.field private cg:Lcom/oneplus/config/ConfigObserver;

.field final mConfigHandler:Lcom/android/server/hmo$zta;

.field private mContext:Landroid/content/Context;

.field private mEnableLogDump:Z

.field mOpAlarmAlignment:Lcom/android/server/ire;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, hg:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    iput-object v1, p0, Uf:[I

    new-instance v1, Lcom/android/server/hmo$zta;
    ...
    invoke-direct {v1, p0, v2}, Lcom/android/server/hmo$zta;-><init>(Lcom/android/server/hmo;Landroid/os/Looper;)V

    iput-object v1, p0, mConfigHandler:Lcom/android/server/hmo$zta;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, Xf:Ljava/util/HashMap;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, Yf:Ljava/util/HashMap;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Zf:Ljava/util/List;

    iput-boolean v0, p0, _f:Z

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, ag:Ljava/util/HashMap;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, bg:Ljava/util/List;
...
.method private kth(Ljava/util/List;)V
    ...
    iget-object v0, p0, Xf:Ljava/util/HashMap;
    ...
    new-instance v3, Lcom/android/server/hmo$you;

    invoke-direct {v3, v2, v1, v0}, Lcom/android/server/hmo$you;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v1, p0, Xf:Ljava/util/HashMap;
...
.method private zta(Ljava/lang/String;Landroid/app/PendingIntent;I)J
    ...
    iget-object p0, p0, Xf:Ljava/util/HashMap;
    ...
    check-cast p3, Lcom/android/server/hmo$you;

    if-eqz p3, :cond_1

    iget-object v0, p3, Lcom/android/server/hmo$you;->Tf:Ljava/lang/String;
    ...
    :cond_0
    iget-wide p0, p3, Lcom/android/server/hmo$you;->Sf:J
...
.method static synthetic zta(Lcom/android/server/hmo;)Landroid/content/Context;
    .locals 0
...
.method static synthetic zta(Lcom/android/server/hmo;Lorg/json/JSONArray;)V
    ...
    invoke-direct {p0, p1}, zta(Lorg/json/JSONArray;)V
...
.method private zta(Lorg/json/JSONArray;)V
    ...
    iget-object p0, p0, Wf:Ljava/util/List;
    ...
    iget-object v4, p0, Wf:Ljava/util/List;
    ...
    :try_start_1
    iget-object v6, p0, Wf:Ljava/util/List;
    ...
    iget-object v7, p0, Wf:Ljava/util/List;
    ...
    sget-object v6, hg:Ljava/util/List;
    ...
    :try_start_3
    sget-object v7, hg:Ljava/util/List;
    ...
    sget-object v8, hg:Ljava/util/List;
    ...
    iget-object v6, p0, Zf:Ljava/util/List;
    ...
    :try_start_5
    iget-object v7, p0, Zf:Ljava/util/List;
    ...
    :cond_5
    iget-object v8, p0, Zf:Ljava/util/List;
    ...
    :cond_6
    iget-object v4, p0, Yf:Ljava/util/HashMap;

    iget-object v7, p0, Zf:Ljava/util/List;

    invoke-direct {p0, v4, v7, v0}, zta(Ljava/util/HashMap;Ljava/util/List;Z)V
    ...
    iget-object v4, p0, bg:Ljava/util/List;
    ...
    :try_start_7
    iget-object v6, p0, bg:Ljava/util/List;
    ...
    :cond_8
    iget-object v7, p0, bg:Ljava/util/List;
    ...
    :cond_9
    iget-object v3, p0, ag:Ljava/util/HashMap;

    iget-object v6, p0, bg:Ljava/util/List;

    invoke-direct {p0, v3, v6, v5}, zta(Ljava/util/HashMap;Ljava/util/List;Z)V
    ...
    iget-object v1, p0, Wf:Ljava/util/List;
    ...
    sget-object v1, hg:Ljava/util/List;
    ...
    iget-object p1, p0, Wf:Ljava/util/List;

    invoke-direct {p0, p1}, kth(Ljava/util/List;)V
    :try_end_8
...
.method public alleviateFirePendingLocked(Ljava/util/ArrayList;)Z
    ...
    iget-object v1, v0, Ef:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    :cond_3
    iget-object v4, v0, Ef:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    iget-object v4, v0, mOpAlarmAlignment:Lcom/android/server/ire;
    ...
    check-cast v4, Lcom/android/server/ire;

    iput-object v4, v0, mOpAlarmAlignment:Lcom/android/server/ire;
    ...
    invoke-virtual {v4, v3}, Lcom/android/server/ire;->gwm(Ljava/lang/String;)Z
    ...
    invoke-static {v5, v6}, clampPositive(J)J
    ...
    iget-object v5, v0, Ef:Lcom/android/server/AlarmManagerService$AmsInner;
...
.method public dumpNextWakeFromIdleInfo()V
    ...
    sget-object p0, mAms:Lcom/android/server/AlarmManagerService;
    ...
    sget-object v0, mAms:Lcom/android/server/AlarmManagerService;
    ...
    sget-object v5, mAms:Lcom/android/server/AlarmManagerService;
    ...
    sget-object v4, mAms:Lcom/android/server/AlarmManagerService;
    ...
    sget-object v3, mAms:Lcom/android/server/AlarmManagerService;
    ...
    sget-object v2, mAms:Lcom/android/server/AlarmManagerService;
...
.method public ifDropPkgAlarm(Lcom/android/server/AlarmManagerService$Alarm;Z)Z
    ...
    iget-object v0, p0, Yf:Ljava/util/HashMap;

    const/4 v1, 0x0

    invoke-direct {p0, v0, p1, v1, p2}, zta(Ljava/util/HashMap;Lcom/android/server/AlarmManagerService$Alarm;ZZ)Z
    ...
    :cond_0
    iget-boolean v0, p0, _f:Z

    if-eqz v0, :cond_1

    iget-object v0, p0, ag:Ljava/util/HashMap;

    invoke-direct {p0, v0, p1, v2, p2}, zta(Ljava/util/HashMap;Lcom/android/server/AlarmManagerService$Alarm;ZZ)Z
...
.method public ifHandleCommand(Ljava/io/PrintWriter;[Ljava/lang/String;)Z
    ...
    iget-object p2, p0, Yf:Ljava/util/HashMap;

    invoke-direct {p0, p2, p1, v0}, zta(Ljava/util/HashMap;Ljava/io/PrintWriter;Z)V

    iget-object p2, p0, ag:Ljava/util/HashMap;

    invoke-direct {p0, p2, p1, v3}, zta(Ljava/util/HashMap;Ljava/io/PrintWriter;Z)V
    ...
    invoke-virtual {p0, p1, p2, v1}, zta(Ljava/io/PrintWriter;[Ljava/lang/String;I)V
...
.method public ifNeedPending(Lcom/android/server/AlarmManagerService$Alarm;)Z
    ...
    sget-boolean v0, mIsDeepSleep:Z
    ...
    iget-object v0, p0, mOpAlarmAlignment:Lcom/android/server/ire;
    ...
    :cond_1
    invoke-virtual {v0, p1}, Lcom/android/server/ire;->zta(Lcom/android/server/AlarmManagerService$Alarm;)Z
    ...
    invoke-virtual {p0, p1}, vdb(Ljava/lang/String;)Z
...
.method public initInstance(Lcom/android/server/AlarmManagerService;Landroid/content/Context;)V
    ...
    :cond_0
    sput-object p1, mAms:Lcom/android/server/AlarmManagerService;
...
.method public modifyMinTrigger(JJJILandroid/app/PendingIntent;ILjava/lang/String;J)[J
    ...
    invoke-direct {p0, v0, p8, p7}, zta(Ljava/lang/String;Landroid/app/PendingIntent;I)J
...
.method public onStart(Lcom/android/server/AlarmManagerService$AmsInner;)V
    ...
    :cond_0
    iput-object p1, p0, Ef:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    iget-object v2, p0, ag:Ljava/util/HashMap;

    invoke-direct {p0, v2, v0, p1}, zta(Ljava/util/HashMap;Ljava/util/List;Z)V
    ...
    iput-object p1, p0, Wf:Ljava/util/List;
    ...
    iget-object v0, p0, Wf:Ljava/util/List;
    ...
    iget-object v1, p0, mConfigHandler:Lcom/android/server/hmo$zta;

    new-instance v2, Lcom/android/server/hmo$sis;

    invoke-direct {v2, p0}, Lcom/android/server/hmo$sis;-><init>(Lcom/android/server/hmo;)V
    ...
    iput-object p1, p0, cg:Lcom/oneplus/config/ConfigObserver;

    iget-object p1, p0, cg:Lcom/oneplus/config/ConfigObserver;
    ...
    iput-object p1, p0, Vf:Ljava/util/List;

    sget-object p1, hg:Ljava/util/List;
    ...
    iget-object p0, p0, mConfigHandler:Lcom/android/server/hmo$zta;
...
.method public setDeepSleepMode(Z)V
    ...
    :cond_0
    sput-boolean p1, mIsDeepSleep:Z
...
.method public updateFlag(Ljava/lang/String;ILandroid/app/AlarmManager$AlarmClockInfo;)I
    ...
    iget-object p0, p0, Vf:Ljava/util/List;
...
.method public vdb(Ljava/lang/String;)Z
    ...
    sget-object p0, hg:Ljava/util/List;
    ...
    :goto_0
    :try_start_0
    sget-object v2, hg:Ljava/util/List;
...
.method protected zta(Ljava/io/PrintWriter;[Ljava/lang/String;I)V
    ...
    iput-boolean p1, p0, mEnableLogDump:Z

    if-eqz v0, :cond_3

    :goto_0
    invoke-virtual {v0, p1}, Lcom/android/server/ire;->dma(Z)Z
