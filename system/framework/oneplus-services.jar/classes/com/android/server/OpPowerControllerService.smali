...
.field mOnePlusChargingGuarder:Lcom/android/server/tsu;

.field mOnePlusSensorManager:Lcom/android/server/zgw;

.field private mOpAlarmAlignment:Lcom/android/server/ire;

.field private mOpAlarmManager:Lcom/android/server/hmo;
...
.field mOverHeatingDiagnosis:Lcom/android/server/p;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, mDebugOneplus:Z

    const/4 v0, 0x0

    sput-boolean v0, mDebugKmeans:Z

    sput-boolean v0, mDebugIdleStats:Z

    sput-boolean v0, mDebugSleepState:Z

    new-instance v1, Ljava/lang/Object;

    invoke-direct {v1}, Ljava/lang/Object;-><init>()V

    sput-object v1, mLock:Ljava/lang/Object;
    ...
    sput-object v1, FULL_DATE_FORMAT:Ljava/text/SimpleDateFormat;

    invoke-static {v2}, Ljava/time/format/DateTimeFormatter;->ofPattern(Ljava/lang/String;)Ljava/time/format/DateTimeFormatter;

    move-result-object v1

    sput-object v1, SIMPLE_DATE_FORMAT:Ljava/time/format/DateTimeFormatter;

    sget-object v1, Ljava/time/format/DateTimeFormatter;->ISO_LOCAL_TIME:Ljava/time/format/DateTimeFormatter;

    sput-object v1, SIMPLE_TIME_FORMAT:Ljava/time/format/DateTimeFormatter;

    const/4 v1, 0x1

    sput-boolean v1, mFirstChange:Z

    sput-boolean v0, mIsDeepSleep:Z
    ...
    sput-object v2, sPkgFirewallList:Ljava/util/ArrayList;

    sput-boolean v0, mAggressive:Z

    sput-boolean v1, mOnlineConfigEnabled:Z

    sput-boolean v0, mShuttingDown:Z

    const/16 v2, 0x1e6c

    sput v2, mSleepState:I
    ...
    sput v2, mTimeOutAfterScreenOff:I

    const v2, 0x1b7740

    sput v2, mTimeOutBeforeUserAwake:I
    ...
    invoke-direct {v0}, Lcom/android/server/a;-><init>()V

    sput-object v0, CREATOR:Landroid/util/Singleton;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mDeepSleepWhitelistApps:Landroid/util/ArrayMap;

    new-instance v0, Landroid/util/SparseBooleanArray;

    invoke-direct {v0}, Landroid/util/SparseBooleanArray;-><init>()V

    iput-object v0, p0, mDeepSleepWhitelistAppIds:Landroid/util/SparseBooleanArray;

    const/4 v0, 0x0

    iput-boolean v0, p0, mIsDoneInit:Z
    ...
    iput-object v1, p0, mAlarmManagerInternal:Lcom/android/server/AlarmManagerInternal;
    ...
    iput-object v2, p0, mIsUnderRestriction:Lcom/android/server/OpPowerControllerService$PkgRestrictType;

    const/4 v2, 0x1

    iput-boolean v2, p0, mListenToConnEvent:Z

    iput-boolean v0, p0, mIsAfter1stLightIdle:Z

    new-instance v3, Ljava/util/ArrayList;

    invoke-direct {v3}, Ljava/util/ArrayList;-><init>()V

    iput-object v3, p0, unRestrictRules:Ljava/util/ArrayList;

    new-instance v3, Ljava/util/ArrayList;

    invoke-direct {v3}, Ljava/util/ArrayList;-><init>()V

    iput-object v3, p0, mFirewallList:Ljava/util/ArrayList;

    const-wide/32 v3, 0xf731400

    iput-wide v3, p0, mRestrictTimeGap:J
    ...
    iput-object v3, p0, mRestrictType:Lcom/oneplus/android/server/am/highpower/IHighPowerDetector$RestrictType;

    iput-boolean v2, p0, mDailyProtoReportEnabled:Z

    iput-boolean v2, p0, mUserSleep:Z

    iput-boolean v0, p0, mSensorRestrict:Z

    iput-boolean v2, p0, mSensorEnabled:Z

    iput v0, p0, mDozeState:I
    ...
    iput-object v1, p0, mMdmExtraData:Ljava/util/HashMap;

    new-instance v1, Landroid/util/ArrayMap;

    invoke-direct {v1}, Landroid/util/ArrayMap;-><init>()V

    iput-object v1, p0, mOemDeviceIdleWhitelistApps:Landroid/util/ArrayMap;

    new-instance v1, Landroid/util/SparseBooleanArray;

    invoke-direct {v1}, Landroid/util/SparseBooleanArray;-><init>()V

    iput-object v1, p0, mOemDeviceIdleWhitelistAppIds:Landroid/util/SparseBooleanArray;

    new-array v0, v0, [I

    iput-object v0, p0, mOemDeviceIdleWhitelistAppIdArray:[I
    ...
    iput-object v0, p0, mRestrictAlarmListener:Landroid/app/AlarmManager$OnAlarmListener;
    ...
    iput-object v0, p0, mEarlyRestrictionAlarmListener:Landroid/app/AlarmManager$OnAlarmListener;
    ...
    iput-object v0, p0, mSleepStateChangeAlarmListener:Landroid/app/AlarmManager$OnAlarmListener;

    new-instance v0, Lcom/android/server/g;

    invoke-direct {v0, p0}, Lcom/android/server/g;-><init>(Lcom/android/server/OpPowerControllerService;)V

    iput-object v0, p0, mBroadcastReceiver:Landroid/content/BroadcastReceiver;

    new-instance v0, Lcom/android/server/h;

    invoke-direct {v0, p0}, Lcom/android/server/h;-><init>(Lcom/android/server/OpPowerControllerService;)V

    iput-object v0, p0, mSubscriptionChangedListener:Landroid/telephony/SubscriptionManager$OnSubscriptionsChangedListener;

    const-string v0, "http://www.google.com/gen_204"

    invoke-direct {p0, v0}, makeURL(Ljava/lang/String;)Ljava/net/URL;

    move-result-object v0

    iput-object v0, p0, mHttpPublicGoogleAtChinaUrl:Ljava/net/URL;
    ...
    iput-object v0, p0, mHttpsPublicGoogleAtChinaUrl:Ljava/net/URL;

    const-wide/16 v0, 0x1388

    iput-wide v0, p0, timeout:J

    sget-boolean p0, mDebugOneplus:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    sput v0, mMaxIdleItems:I

    const v0, 0x112a880

    sput v0, mMinIdleLength:I

    const v0, 0x337f980

    sput v0, mMaxIdleLength:I

    const/4 v0, 0x2

    sput v0, mMinIdleItems:I

    const v1, 0x36ee80

    sput v1, mMinRecordTime:I

    sput v0, mNumCluster:I

    const/16 v0, 0x64

    sput v0, mRandomSeed:I

    sput v2, mTolerance:I

    const-wide v0, 0x3fd999999999999aL    # 0.4

    sput-wide v0, mCoefVar:D

    iget-object v0, p0, mMdmExtraData:Ljava/util/HashMap;
    ...
    iput-object v0, p0, mOemDeviceIdleWhitelist:Ljava/util/Set;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, mAddedDeviceIdleWhitelist:Ljava/util/Set;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, mRemovedDeviceIdleWhitelist:Ljava/util/Set;

    sget-boolean v0, mDebugOneplus:Z
    ...
    iget-object p0, p0, mOemDeviceIdleWhitelist:Ljava/util/Set;
...
.method static synthetic access$102(Lcom/android/server/OpPowerControllerService;J)J
    ...
    iput-wide p1, p0, mNextAlarmFromOPSM:J
...
.method static synthetic access$1700(Lcom/android/server/OpPowerControllerService;)Ljava/time/LocalDateTime;
    ...
    iget-object p0, p0, mScreenOffStart:Ljava/time/LocalDateTime;
...
.method static synthetic access$1900(Lcom/android/server/OpPowerControllerService;)Z
    ...
    iget-boolean p0, p0, mIsConnected:Z
...
.method static synthetic access$200(Lcom/android/server/OpPowerControllerService;)Z
    ...
    iget-boolean p0, p0, mOPSMActive:Z
...
.method static synthetic access$2000(Lcom/android/server/OpPowerControllerService;Lcom/android/server/OpPowerControllerService$PkgRestrictType;Lcom/android/server/OpPowerControllerService$PurposeType;)V
    ...
    invoke-direct {p0, p1, p2}, enableRestriction(Lcom/android/server/OpPowerControllerService$PkgRestrictType;Lcom/android/server/OpPowerControllerService$PurposeType;)V
...
.method static synthetic access$2100(Lcom/android/server/OpPowerControllerService;)Z
    ...
    iget-boolean p0, p0, mListenToConnEvent:Z
...
.method static synthetic access$2200(Lcom/android/server/OpPowerControllerService;)Lcom/android/server/OpPowerControllerService$PkgRestrictType;
    ...
    iget-object p0, p0, mIsUnderRestriction:Lcom/android/server/OpPowerControllerService$PkgRestrictType;
...
.method static synthetic access$3200(Lcom/android/server/OpPowerControllerService;)Z
    ...
    iget-boolean p0, p0, mUserSleep:Z
...
.method static synthetic access$3400(Lcom/android/server/OpPowerControllerService;)Lcom/android/server/OpPowerControllerService$rtg;
    ...
    iget-object p0, p0, mIdleStats:Lcom/android/server/OpPowerControllerService$rtg;
...
.method static synthetic access$3500(Lcom/android/server/OpPowerControllerService;)Lcom/android/server/OpPowerControllerService$ssp;
    ...
    iget-object p0, p0, mKMeans:Lcom/android/server/OpPowerControllerService$ssp;
...
.method static synthetic access$3800()Z
    ...
    sget-boolean v0, mDebugKmeans:Z
...
.method static synthetic access$3900()Z
    ...
    sget-boolean v0, mShuttingDown:Z
...
.method static synthetic access$400(Lcom/android/server/OpPowerControllerService;)Z
    ...
    invoke-direct {p0}, isMusicPlaying()Z
...
.method static synthetic access$4000(Lcom/android/server/OpPowerControllerService;)Landroid/app/AlarmManager$OnAlarmListener;
    ...
    iget-object p0, p0, mEarlyRestrictionAlarmListener:Landroid/app/AlarmManager$OnAlarmListener;
...
.method static synthetic access$4200(Lcom/android/server/OpPowerControllerService;Ljava/time/LocalDateTime;)J
    ...
    invoke-direct {p0, p1}, convertLocalDateTimeToUtcMillis(Ljava/time/LocalDateTime;)J
...
.method static synthetic access$4300(Lcom/android/server/OpPowerControllerService;)Landroid/app/Notification;
    ...
    invoke-direct {p0}, createNotification()Landroid/app/Notification;
...
.method static synthetic access$4500()Z
    ...
    sget-boolean v0, mFirstChange:Z
...
.method static synthetic access$4502(Z)Z
    ...
    sput-boolean p0, mFirstChange:Z
...
.method static synthetic access$4800(Lcom/android/server/OpPowerControllerService;)Z
    ...
    invoke-direct {p0}, sendParallelHttpChinaH2Probes()Z
...
.method static synthetic access$4900(Lcom/android/server/OpPowerControllerService;)Ljava/net/URL;
    ...
    iget-object p0, p0, mHttpPublicGoogleAtChinaUrl:Ljava/net/URL;
...
.method static synthetic access$5000(Lcom/android/server/OpPowerControllerService;Ljava/net/URL;)Z
    ...
    invoke-direct {p0, p1}, sendHttpProbe(Ljava/net/URL;)Z
...
.method static synthetic access$5100(Lcom/android/server/OpPowerControllerService;)Ljava/net/URL;
    ...
    iget-object p0, p0, mHttpsPublicGoogleAtChinaUrl:Ljava/net/URL;
...
.method static synthetic access$5200()Z
    ...
    sget-boolean v0, mDebugIdleStats:Z
...
.method static synthetic access$5300(Lcom/android/server/OpPowerControllerService;)Ljava/time/LocalDateTime;
    ...
    iget-object p0, p0, mSleepStartOverridden:Ljava/time/LocalDateTime;
...
.method static synthetic access$5400(Lcom/android/server/OpPowerControllerService;)Ljava/time/LocalDateTime;
    ...
    iget-object p0, p0, mSleepEndOverridden:Ljava/time/LocalDateTime;
...
.method static synthetic access$900(Lcom/android/server/OpPowerControllerService;)Lcom/android/server/OpPowerControllerService$cno;
    ...
    iget-object p0, p0, mHandler:Lcom/android/server/OpPowerControllerService$cno;
...
.method private applyGMSFirewallLocked(Z)V
    ...
    invoke-direct {p0, v0, v2}, dumpFirewallRules(Ljava/util/List;Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_0
    iget-object v7, p0, mFirewallList:Ljava/util/ArrayList;
    ...
    iget-object v8, p0, mFirewallList:Ljava/util/ArrayList;
    ...
    sget-boolean v7, mDebugOneplus:Z
    ...
    iput-boolean v5, v7, Lcom/android/server/OpPowerControllerService$sis;->Yg:Z
    ...
    :cond_6
    sget-boolean p1, mDebugOneplus:Z
    ...
    iget-boolean v7, v7, Lcom/android/server/OpPowerControllerService$sis;->Yg:Z
    ...
    iput-boolean v6, v7, Lcom/android/server/OpPowerControllerService$sis;->Yg:Z
    ...
    sget-boolean v8, mDebugOneplus:Z
    ...
    :goto_6
    invoke-direct {p0, p1, v0}, dumpFirewallRules(Ljava/util/List;Ljava/lang/String;)Ljava/lang/String;
...
.method private applyIdleWhitelistForSmart()V
    ...
    check-cast v0, Lcom/android/server/m;

    iget-object v1, p0, mAddedDeviceIdleWhitelist:Ljava/util/Set;
    ...
    invoke-virtual {v0, v2}, Lcom/android/server/m;->isSmartOptApp(Ljava/lang/String;)Z
    ...
    :cond_1
    iget-object p0, p0, mRemovedDeviceIdleWhitelist:Ljava/util/Set;
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/m;->isSmartOptApp(Ljava/lang/String;)Z
...
.method private dumpDailyProtoConfig(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    iget-boolean v2, p0, mDailyProtoReportEnabled:Z
    ...
    iget-boolean p0, p0, mDailyProtoReportEnabled:Z
...
.method private dumpFirewallInfo(Ljava/lang/StringBuilder;)V
    ...
    :goto_0
    iget-object v1, p0, mFirewallList:Ljava/util/ArrayList;
...
.method private dumpFirewallRules(Ljava/util/List;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v1, p2}, Lcom/android/server/power/zta/zta;->X(Ljava/lang/String;)Ljava/lang/String;
...
.method private dumpRestrictInfo(Ljava/io/PrintWriter;)V
    ...
    iget-object v7, p0, mHttpPublicGoogleAtChinaUrl:Ljava/net/URL;
    ...
    iget-object v9, p0, mHttpsPublicGoogleAtChinaUrl:Ljava/net/URL;
    ...
    iget-object v9, p0, mIsUnderRestriction:Lcom/android/server/OpPowerControllerService$PkgRestrictType;
    ...
    iget-object v9, p0, mRestrictType:Lcom/oneplus/android/server/am/highpower/IHighPowerDetector$RestrictType;
    ...
    iget-wide v9, p0, mRestrictTimeGap:J
    ...
    iget-boolean v1, p0, mListenToConnEvent:Z
    ...
    invoke-direct {p0, v2}, dumpFirewallInfo(Ljava/lang/StringBuilder;)V
    ...
    invoke-direct {p0, v0, v1}, dumpFirewallRules(Ljava/util/List;Ljava/lang/String;)Ljava/lang/String;
...
.method private dumpUseSleep(Ljava/io/PrintWriter;)V
    ...
    iget v1, p0, mDozeState:I

    invoke-virtual {p0, v1}, convertToString(I)Ljava/lang/String;
    ...
    iget-boolean v1, p0, mUserSleep:Z
    ...
    iget v1, p0, mOPSMEnabled:I

    invoke-virtual {p0, v1}, convertOPSMEnabledToString(I)Ljava/lang/String;
    ...
    iget-boolean v1, p0, mOPSMActive:Z
    ...
    iget-boolean v1, p0, mSensorRestrict:Z
    ...
    iget-boolean v1, p0, mSavedWifiState:Z
    ...
    iget-boolean v1, p0, mSavedDataState:Z
    ...
    iget-object v1, p0, mSavedTetheredIfaces:[Ljava/lang/String;
    ...
    iget-boolean v1, p0, mSavedBluetoothState:Z
    ...
    iget v1, p0, mSavedBleScanAlwaysAvailable:I
    ...
    iget-object v0, p0, mScreenOffStart:Ljava/time/LocalDateTime;
    ...
    iget-object v1, p0, mScreenOffStart:Ljava/time/LocalDateTime;

    sget-object v2, SIMPLE_DATE_FORMAT:Ljava/time/format/DateTimeFormatter;
    ...
    :goto_0
    iget-object v0, p0, mLastEnterOpsmTime:Ljava/time/LocalDateTime;
    ...
    iget-object v1, p0, mLastEnterOpsmTime:Ljava/time/LocalDateTime;
    ...
    :cond_3
    iget-object v0, p0, mLastExitOpsmTime:Ljava/time/LocalDateTime;
    ...
    iget-object v1, p0, mLastExitOpsmTime:Ljava/time/LocalDateTime;
    ...
    sget v1, mTimeOutAfterScreenOff:I
    ...
    sget v1, mTimeOutBeforeUserAwake:I
    ...
    iget-object v0, p0, mIdleStats:Lcom/android/server/OpPowerControllerService$rtg;

    if-eqz v0, :cond_a

    invoke-virtual {v0}, Lcom/android/server/OpPowerControllerService$rtg;->ba()Ljava/time/LocalTime;

    move-result-object v0

    iget-object v1, p0, mIdleStats:Lcom/android/server/OpPowerControllerService$rtg;

    invoke-virtual {v1}, Lcom/android/server/OpPowerControllerService$rtg;->aa()Ljava/time/Duration;

    move-result-object v1

    iget-object v2, p0, mIdleStats:Lcom/android/server/OpPowerControllerService$rtg;

    invoke-virtual {v2}, Lcom/android/server/OpPowerControllerService$rtg;->ea()Ljava/time/LocalDateTime;

    move-result-object v2

    iget-object v3, p0, mIdleStats:Lcom/android/server/OpPowerControllerService$rtg;

    invoke-virtual {v3}, Lcom/android/server/OpPowerControllerService$rtg;->da()Ljava/time/LocalDateTime;
    ...
    iget-object v5, p0, mIdleStats:Lcom/android/server/OpPowerControllerService$rtg;
    ...
    iget-object v4, p0, mIdleStats:Lcom/android/server/OpPowerControllerService$rtg;

    invoke-virtual {v4, p1}, Lcom/android/server/OpPowerControllerService$rtg;->you(Ljava/io/PrintWriter;)V

    iget-object v4, p0, mIdleStats:Lcom/android/server/OpPowerControllerService$rtg;

    invoke-virtual {v4}, Lcom/android/server/OpPowerControllerService$rtg;->ca()Ljava/time/LocalDateTime;
    ...
    sget-object v6, SIMPLE_DATE_FORMAT:Ljava/time/format/DateTimeFormatter;
    ...
    sget-object v5, SIMPLE_TIME_FORMAT:Ljava/time/format/DateTimeFormatter;
    ...
    iget-object v0, p0, mSleepStartOverridden:Ljava/time/LocalDateTime;
    ...
    iget-object v1, p0, mSleepStartOverridden:Ljava/time/LocalDateTime;
    ...
    sget-object v1, SIMPLE_DATE_FORMAT:Ljava/time/format/DateTimeFormatter;
    ...
    :cond_8
    :goto_4
    iget-object v0, p0, mSleepEndOverridden:Ljava/time/LocalDateTime;
    ...
    sget-object v0, SIMPLE_DATE_FORMAT:Ljava/time/format/DateTimeFormatter;
...
.method private declared-synchronized enableRestriction(Lcom/android/server/OpPowerControllerService$PkgRestrictType;Lcom/android/server/OpPowerControllerService$PurposeType;)V
    ...
    iget-object v0, p0, mIsUnderRestriction:Lcom/android/server/OpPowerControllerService$PkgRestrictType;
    ...
    iput-object p1, p0, mIsUnderRestriction:Lcom/android/server/OpPowerControllerService$PkgRestrictType;
    ...
    :goto_0
    iput-object p1, p0, mRestrictType:Lcom/oneplus/android/server/am/highpower/IHighPowerDetector$RestrictType;

    goto :goto_1

    :cond_1
    invoke-direct {p0}, isPartialRestrict()Lcom/oneplus/android/server/am/highpower/IHighPowerDetector$RestrictType;
    ...
    iget-object v0, p0, mRestrictType:Lcom/oneplus/android/server/am/highpower/IHighPowerDetector$RestrictType;
    ...
    iget-object p1, p0, mRestrictType:Lcom/oneplus/android/server/am/highpower/IHighPowerDetector$RestrictType;
    ...
    iget-boolean p1, p0, mIsAfter1stLightIdle:Z
    ...
    invoke-virtual {p1, v2}, Lcom/android/server/am/ibl;->ear(Z)V
    ...
    invoke-direct {p0, v2}, applyGMSFirewallLocked(Z)V
    ...
    invoke-direct {p0, p1}, applyGMSFirewallLocked(Z)V

    sget-boolean p2, Lcom/android/server/am/ibl;->sInUsing:Z
    ...
    invoke-virtual {p2, p1}, Lcom/android/server/am/ibl;->ear(Z)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method private ifaceNameToType(Ljava/lang/String;)I
    ...
    iget-object v0, p0, tetherableWifiRegexs:[Ljava/lang/String;

    invoke-static {p1, v0}, matchesDownstreamRegexs(Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    :cond_1
    iget-object v0, p0, tetherableUsbRegexs:[Ljava/lang/String;
    ...
    :cond_2
    iget-object p0, p0, tetherableBluetoothRegexs:[Ljava/lang/String;

    invoke-static {p1, p0}, matchesDownstreamRegexs(Ljava/lang/String;[Ljava/lang/String;)Z
...
.method private isMusicPlaying()Z
    ...
    sget-boolean v1, mDebugOneplus:Z
...
.method private isPartialRestrict()Lcom/oneplus/android/server/am/highpower/IHighPowerDetector$RestrictType;
    ...
    iget-wide v2, p0, mRestrictTimeGap:J
...
.method private parseDailyProtoConfig(Lorg/json/JSONObject;)V
    ...
    iput-boolean p1, p0, mDailyProtoReportEnabled:Z

    const-string p1, "[OnlineConfig] "

    const/4 v0, 0x0

    invoke-direct {p0, p1, v0}, dumpDailyProtoConfig(Ljava/lang/String;Ljava/io/PrintWriter;)V
...
.method private parseDeepCleanWhitelist(Lorg/json/JSONObject;)V
    ...
    sget-boolean v3, mDebugOneplus:Z
    ...
    :cond_1
    sget-object p1, mLock:Ljava/lang/Object;

    monitor-enter p1

    :try_start_0
    iput-object v0, p0, mDeepCleanWhitelist:Ljava/util/List;

    invoke-direct {p0}, updateDeepCleanWhitelist()V
...
.method private parseDozeWhitelist(Lorg/json/JSONObject;)V
    ...
    :try_start_0
    iget-object v2, p0, mAddedDeviceIdleWhitelist:Ljava/util/Set;

    invoke-interface {v2}, Ljava/util/Set;->clear()V

    iget-object v2, p0, mRemovedDeviceIdleWhitelist:Ljava/util/Set;
    ...
    iget-object v4, p0, mOemDeviceIdleWhitelist:Ljava/util/Set;
    ...
    iget-object v4, p0, mAddedDeviceIdleWhitelist:Ljava/util/Set;

    invoke-interface {v4, v3}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    sget-boolean v4, mDebugOneplus:Z
    ...
    :cond_1
    iget-object p1, p0, mOemDeviceIdleWhitelist:Ljava/util/Set;
    ...
    iget-object v3, p0, mRemovedDeviceIdleWhitelist:Ljava/util/Set;
    ...
    invoke-direct {p0}, updateOemDeviceIdleWhitelistMap()V

    invoke-direct {p0}, applyIdleWhitelistForSmart()V
...
.method private parseNetworkRestrict(Lorg/json/JSONObject;)V
    ...
    invoke-direct {p0, v3}, makeURL(Ljava/lang/String;)Ljava/net/URL;

    move-result-object v5

    iput-object v5, p0, mHttpPublicGoogleAtChinaUrl:Ljava/net/URL;

    sget-boolean v5, mDebugOneplus:Z
    ...
    invoke-direct {p0, v2}, makeURL(Ljava/lang/String;)Ljava/net/URL;

    move-result-object v3

    iput-object v3, p0, mHttpsPublicGoogleAtChinaUrl:Ljava/net/URL;
    ...
    iput-wide v1, p0, mRestrictTimeGap:J
    ...
    invoke-static {p0}, Lcom/android/server/am/ibl;->zta(Lcom/android/server/pm/PackageManagerService;)Lcom/android/server/am/ibl;

    move-result-object p0

    invoke-virtual {p0, p1}, Lcom/android/server/am/ibl;->sis(Ljava/util/List;)V
...
.method private parseOPSM(Lorg/json/JSONObject;)V
    ...
    sget-boolean v3, BETA_OR_ALPHA_ROM:Z
    ...
    sput v1, mTimeOutAfterScreenOff:I
    ...
    sput v1, mTimeOutBeforeUserAwake:I
    ...
    :try_start_1
    invoke-virtual {p0, v2}, addPackageToWhitelist(Ljava/lang/String;)V
    :try_end_1
    ...
    iget-object v1, p0, mDeepSleepWhitelistApps:Landroid/util/ArrayMap;

    iget-object v2, p0, mDeepSleepWhitelistAppIds:Landroid/util/SparseBooleanArray;

    invoke-static {p1, v1, v2}, buildAppIdArray(Landroid/util/ArrayMap;Landroid/util/ArrayMap;Landroid/util/SparseBooleanArray;)[I

    move-result-object p1

    iput-object p1, p0, mDeepSleepWhitelistAppIdArray:[I

    iget-object p1, p0, mOpAlarmManager:Lcom/android/server/hmo;

    iget-object v1, p0, mDeepSleepWhitelistAppIdArray:[I

    invoke-virtual {p1, v1}, Lcom/android/server/hmo;->setDeepSleepWhitelist([I)V

    iget-object p1, p0, mOpPowerManager:Lcom/android/server/power/ugm;
    ...
    :cond_5
    :goto_2
    sget-boolean p1, mDebugIdleStats:Z
    ...
    iget-object p0, p0, mDeepSleepWhitelistAppIdArray:[I
...
.method private parseUserSleep(Lorg/json/JSONObject;)V
    ...
    iput-boolean v1, p0, mUserSleep:Z
    ...
    :goto_1
    iput-boolean v2, p0, mSensorRestrict:Z

    iget-boolean v2, p0, mSensorRestrict:Z
    ...
    iget-boolean v3, p0, mSensorEnabled:Z
...
.method private parseWakeLock(Lorg/json/JSONObject;)V
    ...
    :try_start_1
    iget-object v3, p0, mOpPowerManager:Lcom/android/server/power/ugm;
    ...
    iget-object v9, p0, mHandler:Lcom/android/server/OpPowerControllerService$cno;
    ...
    iget-object v6, p0, mHandler:Lcom/android/server/OpPowerControllerService$cno;
    ...
    iget-object v4, p0, mOpPowerManager:Lcom/android/server/power/ugm;
...
.method private resolveConfigFromJSON(Lorg/json/JSONArray;)V
    ...
    :cond_0
    sget-boolean v2, mOnlineConfigEnabled:Z
    ...
    :pswitch_0
    iget-object v5, p0, mOnePlusChargingGuarder:Lcom/android/server/tsu;

    if-eqz v5, :cond_3

    iget-object v5, p0, mOnePlusChargingGuarder:Lcom/android/server/tsu;

    invoke-virtual {v5, v4}, Lcom/android/server/tsu;->zta(Lorg/json/JSONObject;)V
    ...
    invoke-direct {p0, v4}, parseDailyProtoConfig(Lorg/json/JSONObject;)V

    goto :goto_4

    :pswitch_2
    invoke-direct {p0, v4}, parseDeepCleanWhitelist(Lorg/json/JSONObject;)V

    goto :goto_4

    :pswitch_3
    invoke-direct {p0, v4}, parseDozeWhitelist(Lorg/json/JSONObject;)V
    ...
    invoke-direct {p0, v4}, parseNetworkRestrict(Lorg/json/JSONObject;)V

    goto :goto_4

    :pswitch_5
    invoke-direct {p0, v4}, parseBadProcess(Lorg/json/JSONObject;)V
    ...
    invoke-direct {p0, v4}, parseOPSM(Lorg/json/JSONObject;)V

    goto :goto_4

    :pswitch_7
    invoke-direct {p0, v4}, parseUserSleep(Lorg/json/JSONObject;)V

    goto :goto_4

    :pswitch_8
    invoke-direct {p0, v4}, parseWakeLock(Lorg/json/JSONObject;)V
    :try_end_0
...
.method private sendParallelHttpChinaH2Probes()Z
    ...
    invoke-direct {v2, p0, v3, v1}, Lcom/android/server/b;-><init>(Lcom/android/server/OpPowerControllerService;ILjava/util/concurrent/CountDownLatch;)V

    new-instance v4, Lcom/android/server/b;

    const/4 v5, 0x1

    invoke-direct {v4, p0, v5, v1}, Lcom/android/server/b;-><init>(Lcom/android/server/OpPowerControllerService;ILjava/util/concurrent/CountDownLatch;)V
    ...
    invoke-virtual {v2}, Lcom/android/server/b;->Eg()Z

    move-result p0

    invoke-virtual {v4}, Lcom/android/server/b;->Eg()Z
...
.method private updateDeepCleanWhitelist()V
    ...
    iget-object p0, p0, mDeepCleanWhitelist:Ljava/util/List;
...
.method private updateOemDeviceIdleWhitelistMap()V
    ...
    :try_start_0
    iget-object v2, p0, mOemDeviceIdleWhitelist:Ljava/util/Set;
    ...
    iget-object v5, p0, mOemDeviceIdleWhitelistApps:Landroid/util/ArrayMap;
    ...
    iget-object v2, p0, mOemDeviceIdleWhitelistApps:Landroid/util/ArrayMap;

    iget-object v3, p0, mOemDeviceIdleWhitelistAppIds:Landroid/util/SparseBooleanArray;

    invoke-static {v0, v2, v3}, buildAppIdArray(Landroid/util/ArrayMap;Landroid/util/ArrayMap;Landroid/util/SparseBooleanArray;)[I
    ...
    iget-object p0, p0, mOemDeviceIdleWhitelistAppIdArray:[I
...
.method public acquireNetworkTemp()V
    ...
    :try_start_0
    invoke-virtual {p0}, acquireNetworkTempInternal()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method acquireNetworkTempInternal()V
    ...
    iget-wide v0, p0, mNextAlarmFromOPSM:J
    ...
    iget-object v1, p0, mRestrictAlarmListener:Landroid/app/AlarmManager$OnAlarmListener;
    ...
    :cond_0
    iget-boolean v0, p0, mOPSMActive:Z

    const/4 v1, 0x1

    if-ne v0, v1, :cond_1

    invoke-virtual {p0}, restoreNetwork()V
    ...
    iget-object v9, p0, mRestrictAlarmListener:Landroid/app/AlarmManager$OnAlarmListener;

    iget-object v10, p0, mHandler:Lcom/android/server/OpPowerControllerService$cno;
...
.method addPackageToWhitelist(Ljava/lang/String;)V
    ...
    iget-object p0, p0, mDeepSleepWhitelistApps:Landroid/util/ArrayMap;
...
.method applyEarlyRestriction()V
    ...
    :try_start_0
    iget-boolean v1, p0, mEarlyRestrictionEnabled:Z
    ...
    iget-object v1, p0, mOpPowerManager:Lcom/android/server/power/ugm;

    invoke-virtual {v1, v2}, Lcom/android/server/power/ugm;->o(Z)Z

    invoke-static {v2}, Lcom/android/server/job/JobSchedulerServiceInjector;->onDeviceIdleStateChanged(Z)V

    iget-object v1, p0, mOpAlarmAlignment:Lcom/android/server/ire;

    if-eqz v1, :cond_1

    iget-object v1, p0, mOpAlarmAlignment:Lcom/android/server/ire;

    invoke-virtual {v1, v2}, Lcom/android/server/ire;->ywr(Z)V

    :cond_1
    iput-boolean v2, p0, mEarlyRestrictionEnabled:Z
...
.method public bootCompleted()V
    ...
    check-cast v0, Lcom/android/server/hmo;

    iput-object v0, p0, mOpAlarmManager:Lcom/android/server/hmo;
    ...
    iput-object v0, p0, mOpAlarmAlignment:Lcom/android/server/ire;
    ...
    iput-object v0, p0, mOpPowerManager:Lcom/android/server/power/ugm;

    iget-object v0, p0, mHandler:Lcom/android/server/OpPowerControllerService$cno;
    ...
    invoke-direct {p0, v4, v1}, dumpDailyProtoConfig(Ljava/lang/String;Ljava/io/PrintWriter;)V

    iget-object v1, p0, mHandler:Lcom/android/server/OpPowerControllerService$cno;
    ...
    iget-object v4, p0, mHandler:Lcom/android/server/OpPowerControllerService$cno;
    ...
    iget-object v8, p0, mBroadcastReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v7, p0, mHandler:Lcom/android/server/OpPowerControllerService$cno;
    ...
    iget-object v1, p0, mOverHeatingDiagnosis:Lcom/android/server/p;

    invoke-virtual {v1}, Lcom/android/server/p;->start()V
    ...
    iput-wide v3, p0, mBootCompletedElapsedTime:J
    ...
    iput-object v1, p0, tetherableUsbRegexs:[Ljava/lang/String;
    ...
    :goto_5
    iput-object v0, p0, tetherableWifiRegexs:[Ljava/lang/String;
    ...
    iput-object v0, p0, tetherableBluetoothRegexs:[Ljava/lang/String;
    ...
    iput-object v0, p0, mNotificationLight:Lcom/android/server/lights/Light;
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, dumpInternal(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
...
.method dumpInternal(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-static {p2}, dumpHelp(Ljava/io/PrintWriter;)V
    ...
    invoke-direct {p0, p2}, dumpUseSleep(Ljava/io/PrintWriter;)V
    ...
    iget-object p1, p0, mOverHeatingDiagnosis:Lcom/android/server/p;

    invoke-virtual {p1, p2}, Lcom/android/server/p;->dump(Ljava/io/PrintWriter;)V
    ...
    invoke-direct {p0, p2, p1}, dumpDiagnosisRecords(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p2}, dumpRestrictInfo(Ljava/io/PrintWriter;)V
...
.method enterOPSMIfAppropriated(Z)V
    ...
    sget v7, mSleepState:I

    invoke-virtual {p0, v7}, convertToString(I)Ljava/lang/String;
    ...
    invoke-static {v6, p1}, Lcom/android/server/you$zta;->d(Ljava/lang/String;Ljava/lang/String;)I
    ...
    :cond_2
    iget-boolean p1, p0, mIsCharging:Z
    ...
    :cond_3
    iget-boolean p1, p0, mOPSMActive:Z
    ...
    :cond_4
    iget-object p1, p0, mScreenOffStart:Ljava/time/LocalDateTime;
    ...
    sget p1, mTimeOutAfterScreenOff:I
    ...
    iget-object p1, p0, mOpDeviceManagerInjector:Lnet/oneplus/odm/OpDeviceManagerInjector;

    if-eqz p1, :cond_7

    iget-object v1, p0, mContext:Landroid/content/Context;

    iget-object p0, p0, mMdmExtraData:Ljava/util/HashMap;

    invoke-virtual {p1, v1, v3, v0, p0}, Lnet/oneplus/odm/OpDeviceManagerInjector;->preserveOsData(Landroid/content/Context;Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;)V
    ...
    iput-object v2, p0, mLastEnterOpsmTime:Ljava/time/LocalDateTime;

    iget-object p1, p0, mSleepEndOverridden:Ljava/time/LocalDateTime;
    ...
    iget-object v7, p0, mSleepEndOverridden:Ljava/time/LocalDateTime;

    sget-object v8, SIMPLE_DATE_FORMAT:Ljava/time/format/DateTimeFormatter;
    ...
    sget v7, mTimeOutAfterScreenOff:I
    ...
    :cond_9
    iget-object p1, p0, mIdleStats:Lcom/android/server/OpPowerControllerService$rtg;

    invoke-virtual {p1}, Lcom/android/server/OpPowerControllerService$rtg;->da()Ljava/time/LocalDateTime;
    ...
    invoke-virtual {p1}, Lcom/android/server/OpPowerControllerService$rtg;->aa()Ljava/time/Duration;
    ...
    iput-object p1, p0, mSavedTetheredIfaces:[Ljava/lang/String;

    iget-object p1, p0, mWifiManager:Landroid/net/wifi/WifiManager;

    invoke-virtual {p1}, Landroid/net/wifi/WifiManager;->isWifiEnabled()Z

    move-result p1

    iput-boolean p1, p0, mSavedWifiState:Z
    ...
    :goto_4
    iput-boolean p1, p0, mSavedWifiScanState:Z

    iget-object p1, p0, mTelephonyManager:Landroid/telephony/TelephonyManager;

    invoke-virtual {p1}, Landroid/telephony/TelephonyManager;->getDataEnabled()Z

    move-result p1

    iput-boolean p1, p0, mSavedDataState:Z
    ...
    iput-boolean v2, p0, mSavedBluetoothState:Z
    ...
    iput v2, p0, mSavedBleScanAlwaysAvailable:I
    ...
    iget-boolean v7, p0, mSavedBluetoothState:Z
    ...
    iget v7, p0, mSavedBleScanAlwaysAvailable:I
    ...
    invoke-static {v6, v2}, Lcom/android/server/you$zta;->d(Ljava/lang/String;Ljava/lang/String;)I
    ...
    iget-object v7, p0, mSavedTetheredIfaces:[Ljava/lang/String;
    ...
    iget-object v2, p0, mSavedTetheredIfaces:[Ljava/lang/String;
    ...
    iget-object v10, p0, mConnectivityManager:Landroid/net/ConnectivityManager;

    invoke-direct {p0, v9}, ifaceNameToType(Ljava/lang/String;)I
    ...
    invoke-static {v6, v9}, Lcom/android/server/you$zta;->d(Ljava/lang/String;Ljava/lang/String;)I
    ...
    :cond_d
    invoke-virtual {p0}, restrictNetwork()V

    invoke-static {v5}, Lcom/android/server/BatteryServiceInjector;->setDeepSleepMode(Z)V

    iget-object v2, p0, mOpAlarmManager:Lcom/android/server/hmo;

    invoke-virtual {v2, v5}, Lcom/android/server/hmo;->setDeepSleepMode(Z)V

    iget-object v2, p0, mOpPowerManager:Lcom/android/server/power/ugm;

    invoke-virtual {v2, v5}, Lcom/android/server/power/ugm;->setDeepSleepMode(Z)Z

    iget-object v2, p0, mSensorManager:Landroid/hardware/SensorManager;

    if-eqz v2, :cond_e

    iget-boolean v7, p0, mSensorRestrict:Z

    if-eqz v7, :cond_e

    invoke-virtual {v2}, Landroid/hardware/SensorManager;->enterOPSM()V

    iput-boolean v4, p0, mSensorEnabled:Z
    ...
    iput-boolean v2, p0, mSavedNfcState:Z

    iget-boolean v2, p0, mSavedNfcState:Z
    ...
    invoke-static {v6, v1}, Lcom/android/server/you$zta;->d(Ljava/lang/String;Ljava/lang/String;)I
    ...
    :cond_10
    iget-boolean p1, p0, mSavedBluetoothState:Z
    ...
    :cond_11
    iput-boolean v5, p0, mOPSMActive:Z
    ...
    iget-object v0, p0, mOpDeviceManagerInjector:Lnet/oneplus/odm/OpDeviceManagerInjector;

    if-eqz v0, :cond_12

    iget-object v1, p0, mContext:Landroid/content/Context;

    iget-object v2, p0, mMdmExtraData:Ljava/util/HashMap;
    ...
    :cond_12
    sget p1, mActivationCount:I

    if-nez p1, :cond_13

    iget-object p1, p0, mHandler:Lcom/android/server/OpPowerControllerService$cno;
...
.method getSleepState(Ljava/time/LocalDateTime;)I
    ...
    invoke-virtual {v3}, Lcom/android/server/OpPowerControllerService$rtg;->ba()Ljava/time/LocalTime;
    ...
    invoke-virtual {v3}, Lcom/android/server/OpPowerControllerService$rtg;->aa()Ljava/time/Duration;

    move-result-object v3

    sget v5, mTimeOutBeforeUserAwake:I
    ...
    iget-object v5, p0, mSleepStartOverridden:Ljava/time/LocalDateTime;
    ...
    :cond_0
    iget-object v5, p0, mSleepEndOverridden:Ljava/time/LocalDateTime;
    ...
    sget v3, mTimeOutBeforeUserAwake:I
...
.method public declared-synchronized inform1stLightIdle()V
    ...
    iget-object v2, p0, mIsUnderRestriction:Lcom/android/server/OpPowerControllerService$PkgRestrictType;
    ...
    iget-object v1, p0, mIsUnderRestriction:Lcom/android/server/OpPowerControllerService$PkgRestrictType;
    ...
    iget-object v1, p0, mRestrictType:Lcom/oneplus/android/server/am/highpower/IHighPowerDetector$RestrictType;
    ...
    invoke-virtual {v1, v0}, Lcom/android/server/am/ibl;->ear(Z)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public informDeviceActive()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/am/ibl;->ear(Z)V
...
.method public init()V
    ...
    iput-object v0, p0, mHandler:Lcom/android/server/OpPowerControllerService$cno;
    ...
    iput-object v0, p0, mLocalPowerManager:Landroid/os/PowerManagerInternal;

    new-instance v0, Lcom/oneplus/config/ConfigObserver;

    iget-object v1, p0, mContext:Landroid/content/Context;

    iget-object v2, p0, mHandler:Lcom/android/server/OpPowerControllerService$cno;

    new-instance v3, Lcom/android/server/OpPowerControllerService$you;

    const/4 v4, 0x0

    invoke-direct {v3, p0, v4}, Lcom/android/server/OpPowerControllerService$you;-><init>(Lcom/android/server/OpPowerControllerService;Lcom/android/server/a;)V
    ...
    new-instance v1, Lcom/android/server/p;

    iget-object v3, p0, mContext:Landroid/content/Context;

    invoke-direct {v1, v3}, Lcom/android/server/p;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, mOverHeatingDiagnosis:Lcom/android/server/p;
    ...
    iget-object v5, p0, mSensorManager:Landroid/hardware/SensorManager;

    iget-object v6, p0, mPowerManager:Landroid/os/PowerManager;

    invoke-direct {v1, v3, v5, v6}, Lcom/android/server/zgw;-><init>(Landroid/content/Context;Landroid/hardware/SensorManager;Landroid/os/PowerManager;)V

    iput-object v1, p0, mOnePlusSensorManager:Lcom/android/server/zgw;
    ...
    invoke-static {v1}, Lcom/android/server/tsu;->getInstance(Landroid/content/Context;)Lcom/android/server/tsu;

    move-result-object v1

    iput-object v1, p0, mOnePlusChargingGuarder:Lcom/android/server/tsu;
    ...
    iput-object v1, p0, mIdleStats:Lcom/android/server/OpPowerControllerService$rtg;
    ...
    iput-object v1, p0, mKMeans:Lcom/android/server/OpPowerControllerService$ssp;

    new-instance v1, Lcom/android/server/OpPowerControllerService$igw;

    invoke-direct {v1, v4}, Lcom/android/server/OpPowerControllerService$igw;-><init>(Lcom/android/server/a;)V

    iput-object v1, p0, mStartTetheringCallback:Lcom/android/server/OpPowerControllerService$igw;
    ...
    new-instance v1, Lcom/android/server/f;

    iget-object v3, p0, mHandler:Lcom/android/server/OpPowerControllerService$cno;

    invoke-direct {v1, p0, v3}, Lcom/android/server/f;-><init>(Lcom/android/server/OpPowerControllerService;Landroid/os/Handler;)V
    ...
    iget-object v4, p0, mContentObserver:Landroid/database/ContentObserver;
    ...
    iget-object v5, p0, mContentObserver:Landroid/database/ContentObserver;
    ...
    iget-object v1, p0, mSubscriptionManager:Landroid/telephony/SubscriptionManager;

    if-eqz v1, :cond_4

    iget-object v5, p0, mSubscriptionChangedListener:Landroid/telephony/SubscriptionManager$OnSubscriptionsChangedListener;
    ...
    iput-object v1, p0, mBatteryManagerInternal:Landroid/os/BatteryManagerInternal;
    ...
    invoke-direct {p0, v1}, createNotificationChannel(Landroid/app/NotificationManager;)V
    ...
    iput-object v0, p0, mNetworkManagementService:Landroid/os/INetworkManagementService;
    ...
    :goto_0
    sget-object v1, sPkgFirewallList:Ljava/util/ArrayList;
    ...
    iget-object v5, p0, mFirewallList:Ljava/util/ArrayList;
...
.method public isAggressive()Z
    ...
    :cond_0
    invoke-virtual {p0}, isAggressiveInternal()Z
...
.method public isChinaRegion()Z
    ...
    :cond_0
    invoke-virtual {p0}, isChinaRegionInternal()Z
...
.method public isInDeepIdle()Z
    ...
    :cond_0
    invoke-virtual {p0}, isInDeepIdleInternal()Z
...
.method public isInDeepSleep()Z
    ...
    :cond_0
    invoke-virtual {p0}, isInDeepSleepInternal()Z
...
.method public isInSleep()Z
    ...
    :cond_0
    invoke-virtual {p0}, isInSleepInternal()Z
...
.method public isIndiaRegion()Z
    ...
    :cond_0
    invoke-virtual {p0}, isIndiaRegionInternal()Z
...
.method leaveOPSM()V
    ...
    iput-object v1, p0, mLastExitOpsmTime:Ljava/time/LocalDateTime;
    ...
    iget-object v3, p0, mSavedTetheredIfaces:[Ljava/lang/String;
    ...
    iget-object v8, p0, mConnectivityManager:Landroid/net/ConnectivityManager;

    invoke-direct {p0, v7}, ifaceNameToType(Ljava/lang/String;)I

    move-result v7

    iget-object v9, p0, mStartTetheringCallback:Lcom/android/server/OpPowerControllerService$igw;
    ...
    iget-boolean v3, p0, mSavedNfcState:Z
    ...
    iget v3, p0, mSavedBleScanAlwaysAvailable:I
    ...
    :cond_3
    iget-boolean v3, p0, mSavedBluetoothState:Z
    ...
    iget-object v0, p0, mOpAlarmManager:Lcom/android/server/hmo;

    invoke-virtual {v0, v5}, Lcom/android/server/hmo;->setDeepSleepMode(Z)V

    iget-object v0, p0, mOpPowerManager:Lcom/android/server/power/ugm;

    invoke-virtual {v0, v5}, Lcom/android/server/power/ugm;->setDeepSleepMode(Z)Z
...
.method public noteCameraOn(Z)V
    ...
    :cond_0
    invoke-virtual {p0, p1}, noteCameraOnInternal(Z)V
...
.method public notifyScreenState(I)V
    ...
    iget-boolean v0, p0, mUserSleep:Z

    if-eqz v0, :cond_1

    invoke-virtual {p0, p1}, notifyScreenStateInternal(I)V
...
.method notifyScreenStateInternal(I)V
    ...
    iput-object p1, p0, mScreenOffStart:Ljava/time/LocalDateTime;
    ...
    iget-object v5, p0, mScreenOffStart:Ljava/time/LocalDateTime;
    ...
    invoke-virtual {p0}, scheduleAlarmToEnterOPSM()V
    ...
    iget-object v5, p0, mHandler:Lcom/android/server/OpPowerControllerService$cno;
    ...
    :cond_3
    invoke-virtual {p0}, releaseEarlyRestriction()V

    :cond_4
    :goto_0
    iget-object v3, p0, mScreenOffStart:Ljava/time/LocalDateTime;
    ...
    sget-object v5, SIMPLE_DATE_FORMAT:Ljava/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v3}, Lcom/android/server/OpPowerControllerService$rtg;->ca()Ljava/time/LocalDateTime;
...
.method onShellCommand(Lcom/android/server/OpPowerControllerService$wtn;Ljava/lang/String;)I
    ...
    sput-boolean v3, mDebugOneplus:Z

    sput-boolean v3, Lcom/android/server/you$zta;->Tc:Z
    ...
    sput-boolean v4, mDebugOneplus:Z

    sput-boolean v4, Lcom/android/server/you$zta;->Tc:Z
    ...
    sget-boolean p2, mDebugOneplus:Z
    ...
    sput-boolean v3, mOnlineConfigEnabled:Z
    ...
    sput-boolean v4, mOnlineConfigEnabled:Z
    ...
    sget-boolean p2, mOnlineConfigEnabled:Z
    ...
    invoke-direct {p0, v0}, dumpRestrictInfo(Ljava/io/PrintWriter;)V
    ...
    iput-boolean v4, p0, mListenToConnEvent:Z
    ...
    iput-boolean v3, p0, mListenToConnEvent:Z
    :try_end_e
    ...
    sput-boolean v3, mDebugKmeans:Z

    sput-boolean v3, mDebugIdleStats:Z

    sput-boolean v3, mDebugSleepState:Z
    ...
    :cond_19
    sput-boolean v4, mDebugKmeans:Z

    sput-boolean v4, mDebugIdleStats:Z

    sput-boolean v4, mDebugSleepState:Z
    ...
    :try_start_12
    sget-object p2, SIMPLE_DATE_FORMAT:Ljava/time/format/DateTimeFormatter;
    ...
    iput-object p1, p0, mSleepStartOverridden:Ljava/time/LocalDateTime;
    ...
    invoke-virtual {p0}, scheduleNextAlarmIfNeededLocked()V
    ...
    iput-object p1, p0, mSleepEndOverridden:Ljava/time/LocalDateTime;
    ...
    sput p1, mSleepState:I

    iget-object p2, p0, mHandler:Lcom/android/server/OpPowerControllerService$cno;
    ...
    iput-object v2, p0, mSleepStartOverridden:Ljava/time/LocalDateTime;

    iput-object v2, p0, mSleepEndOverridden:Ljava/time/LocalDateTime;

    const p1, 0x44aa20

    sput p1, mTimeOutAfterScreenOff:I

    const p1, 0x1b7740

    sput p1, mTimeOutBeforeUserAwake:I
    ...
    sput p2, mTimeOutAfterScreenOff:I
    ...
    sget p2, mTimeOutAfterScreenOff:I
    ...
    sput p2, mTimeOutBeforeUserAwake:I
    ...
    sget p2, mTimeOutBeforeUserAwake:I
    ...
    invoke-virtual {p0, v3}, enterOPSMIfAppropriated(Z)V
    ...
    iput-boolean v3, p0, mSensorRestrict:Z
    ...
    iput-boolean v4, p0, mSensorRestrict:Z
    ...
    iget-boolean p2, p0, mSensorRestrict:Z
    ...
    :cond_32
    invoke-direct {p0, v0}, dumpUseSleep(Ljava/io/PrintWriter;)V
    :try_end_15
    ...
    invoke-virtual {p1, v3}, Lcom/android/server/p;->ibl(Z)V
    ...
    invoke-virtual {p1, v4}, Lcom/android/server/p;->ibl(Z)V
    ...
    iget-object p2, p0, mOverHeatingDiagnosis:Lcom/android/server/p;

    invoke-static {p1}, Ljava/lang/Integer;->parseInt(Ljava/lang/String;)I

    move-result p1

    invoke-virtual {p2, p1}, Lcom/android/server/p;->zgw(I)V
    ...
    invoke-virtual {p2, p1}, Lcom/android/server/p;->obl(I)V
    ...
    invoke-virtual {p2, v5, v6}, Lcom/android/server/p;->gck(J)V
    ...
    invoke-virtual {p1, v3}, Lcom/android/server/p;->gwm(Z)V
    ...
    invoke-virtual {p1, v4}, Lcom/android/server/p;->gwm(Z)V
    ...
    invoke-virtual {p1}, Lcom/android/server/p;->startMonitor()V
    ...
    invoke-virtual {p1}, Lcom/android/server/p;->Aa()V
    ...
    invoke-virtual {p1}, Lcom/android/server/p;->wa()V
    ...
    invoke-virtual {p1, v3}, Lcom/android/server/p;->ugm(Z)V
    ...
    invoke-virtual {p1, v4}, Lcom/android/server/p;->ugm(Z)V
    ...
    invoke-virtual {p1, v3}, Lcom/android/server/p;->oif(Z)V
    ...
    invoke-virtual {p1, v4}, Lcom/android/server/p;->oif(Z)V
    ...
    invoke-virtual {p1, v3}, Lcom/android/server/p;->bvj(Z)V
    ...
    invoke-virtual {p1, v4}, Lcom/android/server/p;->bvj(Z)V
    ...
    invoke-virtual {p2, p1}, Lcom/android/server/p;->vdb(I)V
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/p;->dump(Ljava/io/PrintWriter;)V
    ...
    invoke-direct {p0, v0, p1}, dumpDiagnosisRecords(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    iget-object p2, p0, mSensorManager:Landroid/hardware/SensorManager;
    ...
    :cond_4f
    iget-object p1, p0, mOnePlusSensorManager:Lcom/android/server/zgw;

    invoke-virtual {p1, v0}, Lcom/android/server/zgw;->dump(Ljava/io/PrintWriter;)V
    ...
    iget-object p1, p0, mOnePlusChargingGuarder:Lcom/android/server/tsu;

    invoke-virtual {p1}, Lcom/android/server/tsu;->y()V
    ...
    invoke-virtual {p1}, Lcom/android/server/tsu;->z()V
    ...
    iget-object v0, p0, mOnePlusChargingGuarder:Lcom/android/server/tsu;

    invoke-virtual {v0, p1, p2}, Lcom/android/server/tsu;->tsu(J)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/server/tsu;->sis(J)V
    ...
    invoke-virtual {p1}, Lcom/android/server/tsu;->H()V
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/tsu;->dump(Ljava/io/PrintWriter;)V
    ...
    invoke-virtual {p0, v1}, addPackageToWhitelist(Ljava/lang/String;)V
    :try_end_20
    ...
    :cond_59
    iget-object p1, p0, mDeepSleepWhitelistApps:Landroid/util/ArrayMap;

    iget-object p2, p0, mDeepSleepWhitelistAppIds:Landroid/util/SparseBooleanArray;

    invoke-static {v2, p1, p2}, buildAppIdArray(Landroid/util/ArrayMap;Landroid/util/ArrayMap;Landroid/util/SparseBooleanArray;)[I
    ...
    iget-object p2, p0, mDeepSleepWhitelistAppIdArray:[I

    invoke-virtual {p1, p2}, Lcom/android/server/hmo;->setDeepSleepWhitelist([I)V
    ...
    iget-object p0, p0, mOpPowerManager:Lcom/android/server/power/ugm;
    ...
    invoke-direct {p0, p1, v0}, printStringList(Ljava/util/Set;Ljava/io/PrintWriter;)V

    const-string p1, "*** Added whitelist ***"

    invoke-virtual {v0, p1}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    iget-object p1, p0, mAddedDeviceIdleWhitelist:Ljava/util/Set;
    ...
    iget-object p1, p0, mRemovedDeviceIdleWhitelist:Ljava/util/Set;
    ...
    iget-object p0, p0, mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    iget-object p2, p0, mConnectivityManager:Landroid/net/ConnectivityManager;
    ...
    iget-object p2, p0, mStartTetheringCallback:Lcom/android/server/OpPowerControllerService$igw;
    ...
    iget-object p0, p0, mStartTetheringCallback:Lcom/android/server/OpPowerControllerService$igw;
    ...
    invoke-direct {p0, v1}, ifaceNameToType(Ljava/lang/String;)I
    ...
    iget-object v2, p0, mConnectivityManager:Landroid/net/ConnectivityManager;
    ...
    invoke-direct {p0, v3}, enableDisableData(Z)V
    ...
    check-cast p0, Lcom/android/server/m;
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/m;->sis(Ljava/io/PrintWriter;)V
    ...
    :cond_75
    invoke-virtual {p0, v0}, Lcom/android/server/m;->shellCommand(Ljava/io/PrintWriter;)Z
...
.method restoreNetwork()V
    ...
    iget-boolean v0, p0, mSavedWifiScanState:Z
    ...
    :cond_0
    iget-boolean v0, p0, mSavedWifiState:Z
    ...
    :cond_1
    iget-boolean v0, p0, mSavedDataState:Z

    if-ne v0, v2, :cond_2

    invoke-direct {p0, v0}, enableDisableData(Z)V
...
.method restrictNetwork()V
    ...
    invoke-direct {p0, v2}, enableDisableData(Z)V
    ...
    iget-boolean v4, p0, mSavedWifiState:Z
    ...
    iget-boolean v4, p0, mSavedWifiScanState:Z
...
.method scheduleAlarmToEnterOPSM()V
    ...
    sget-boolean p0, mDebugSleepState:Z
    ...
    sget-object v1, FULL_DATE_FORMAT:Ljava/text/SimpleDateFormat;
...
.method scheduleNextAlarmIfNeededLocked()V
    ...
    iget-object v1, p0, mSleepStateChangeAlarmListener:Landroid/app/AlarmManager$OnAlarmListener;
    ...
    invoke-virtual {p0, v0}, getSleepState(Ljava/time/LocalDateTime;)I

    move-result v0

    sput v0, mSleepState:I
    ...
    :goto_1
    invoke-virtual {p0, v0}, scheduleNextAlarmIfNeededLocked(Ljava/time/LocalDateTime;)V
    ...
    invoke-virtual {v0}, Lcom/android/server/OpPowerControllerService$rtg;->da()Ljava/time/LocalDateTime;
    ...
    invoke-virtual {v0}, Lcom/android/server/OpPowerControllerService$rtg;->ea()Ljava/time/LocalDateTime;
...
.method scheduleNextAlarmIfNeededLocked(Ljava/time/LocalDateTime;)V
    ...
    iget-object v5, p0, mSleepStateChangeAlarmListener:Landroid/app/AlarmManager$OnAlarmListener;
...
.method public setDozeState(I)V
    ...
    :cond_0
    invoke-virtual {p0, p1}, setDozeStateInternal(I)V
...
.method setDozeStateInternal(I)V
    ...
    sget p1, mTimeOutBeforeUserAwake:I
...
.method public shutdown()V
    ...
    :try_start_0
    invoke-virtual {p0}, shutdownInternal()V
...
.method shutdownInternal()V
    ...
    sput-boolean p0, mShuttingDown:Z
