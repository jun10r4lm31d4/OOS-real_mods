...
.field private static final cM:I = 0x9c4

.field static final dM:F = 2.5f

.field static final eM:I = 0xc9

.field static final fM:I = 0xca

.field static final gM:I = 0xcb

.field static final hM:J = 0xbb8L

.field private static final iM:J = 0x78L

.field private static final jM:I = 0x3

.field private static final kM:I = 0x5

.field static final lM:I = 0x0

.field static final mM:I = 0x1

.field static final nM:I = 0x2

.field static final oM:I = 0x3

.field private static final pM:Landroid/net/Uri;

.field private static final qM:I = 0x0

.field private static final rM:I = 0x1


# instance fields
.field SL:Lcom/android/server/policy/PhoneWindowManager;
...
.field ZL:Lcom/android/server/GestureLauncherService;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, pM:Landroid/net/Uri;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, TL:Z

    iput-boolean v0, p0, UL:Z

    iput v0, p0, VL:I

    iput-boolean v0, p0, XL:Z
...
.method private Kp()Landroid/content/ComponentName;
    .locals 5
    ...
    iget-object v2, p0, SL:Lcom/android/server/policy/PhoneWindowManager;
...
.method private Lp()Z
    ...
    sget-object v2, pM:Landroid/net/Uri;
...
.method private Mp()V
    ...
    iget-object v0, p0, SL:Lcom/android/server/policy/PhoneWindowManager;

    iput-boolean v3, v0, Lcom/android/server/policy/PhoneWindowManager;->mPowerKeyHandled:Z

    iget-boolean v4, p0, UL:Z
    ...
    :cond_3
    invoke-direct {p0}, Kp()Landroid/content/ComponentName;
    ...
    :cond_f
    :goto_5
    iput-boolean v1, p0, XL:Z

    iget-object p0, p0, SL:Lcom/android/server/policy/PhoneWindowManager;
...
.method public handleEmergency(Landroid/util/MutableBoolean;)Z
    ...
    iget v3, p0, mPowerButtonConsecutiveTaps:I
...
.method public init(Landroid/content/Context;Landroid/os/Handler;Lcom/android/server/policy/PhoneWindowManager;)V
    ...
    iput-object p3, p0, SL:Lcom/android/server/policy/PhoneWindowManager;

    iget-object p1, p0, SL:Lcom/android/server/policy/PhoneWindowManager;
    ...
    iput-object p1, p0, mEmergencyAffordanceManager:Lcom/android/internal/util/EmergencyAffordanceManager;
...
.method public initGestureLauncherService(Lcom/android/server/GestureLauncherService;)V
    ...
    iput-object p1, p0, ZL:Lcom/android/server/GestureLauncherService;
...
.method public processEmergencyTap(Landroid/view/KeyEvent;ZZ)Z
    ...
    iput-boolean v2, p0, YL:Z

    :cond_1
    iput-boolean p3, p0, mCameraDoubleTapPowerEnabled:Z

    invoke-virtual {p1}, Landroid/view/KeyEvent;->getEventTime()J

    move-result-wide v3

    iget-wide v5, p0, mLastPowerDown:J
    ...
    iget-object p3, p0, mEmergencyAffordanceManager:Lcom/android/internal/util/EmergencyAffordanceManager;
    ...
    :cond_3
    :goto_0
    sget-boolean p3, DEBUG_ONEPLUS:Z
    ...
    iget-boolean v0, p0, mCameraDoubleTapPowerEnabled:Z
    ...
    iget v0, p0, mPowerButtonConsecutiveTaps:I
    ...
    iget-boolean p3, p0, mCameraDoubleTapPowerEnabled:Z

    if-eqz p3, :cond_5

    iget p3, p0, mPowerButtonConsecutiveTaps:I
    ...
    iput p3, p0, mPowerButtonConsecutiveTaps:I
    ...
    iput v9, p0, mPowerButtonConsecutiveTaps:I
    ...
    iput-wide v0, p0, mLastPowerDown:J
...
.method public updateSettings(Landroid/content/ContentResolver;)V
    ...
    :goto_0
    iput-boolean v1, p0, TL:Z

    invoke-direct {p0, p1}, you(Landroid/content/ContentResolver;)I
