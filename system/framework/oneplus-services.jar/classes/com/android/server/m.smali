.class public Lcom/android/server/m;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/m$zta;,
        Lcom/android/server/m$you;
    }
.end annotation
...
.field private static final Yh:J = 0x1f4L

.field private static Zh:J = 0x0L

.field private static _h:Ljava/lang/String; = null
...
.field public static final fi:Ljava/lang/String; = "smart_power_control_changed"
...
.field private static mInstance:Lcom/android/server/m;
...
.field private Qh:Landroid/app/WallpaperManager;

.field private final Rh:Landroid/util/ArrayMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private final Sh:Landroid/util/ArrayMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/util/ArrayMap<",
            "Ljava/lang/String;",
...
.field private Th:Landroid/util/SparseBooleanArray;

.field private Uh:Landroid/util/SparseBooleanArray;
...
.field private final mHandler:Lcom/android/server/m$zta;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, _h:Ljava/lang/String;

    sput-object v0, ai:Ljava/lang/String;

    sput-object v0, bi:Ljava/lang/String;

    sput-object v0, di:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Rh:Landroid/util/ArrayMap;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, Sh:Landroid/util/ArrayMap;

    new-instance v0, Landroid/util/SparseBooleanArray;

    invoke-direct {v0}, Landroid/util/SparseBooleanArray;-><init>()V

    iput-object v0, p0, Th:Landroid/util/SparseBooleanArray;

    new-instance v0, Landroid/util/SparseBooleanArray;

    invoke-direct {v0}, Landroid/util/SparseBooleanArray;-><init>()V

    iput-object v0, p0, Uh:Landroid/util/SparseBooleanArray;

    const/4 v0, 0x0

    new-array v1, v0, [I

    iput-object v1, p0, Vh:[I

    new-array v0, v0, [I

    iput-object v0, p0, Wh:[I

    new-instance v0, Lcom/android/server/l;

    invoke-direct {v0, p0}, Lcom/android/server/l;-><init>(Lcom/android/server/m;)V
    ...
    iput-object p1, p0, mConfigFile:Lcom/android/internal/os/AtomicFile;

    new-instance p1, Lcom/android/server/m$zta;
    ...
    invoke-direct {p1, p0, v0}, Lcom/android/server/m$zta;-><init>(Lcom/android/server/m;Landroid/os/Looper;)V

    iput-object p1, p0, mHandler:Lcom/android/server/m$zta;
...
.method public static getInstance(Landroid/content/Context;)Lcom/android/server/m;
    .locals 1

    sget-object v0, mInstance:Lcom/android/server/m;

    if-nez v0, :cond_0

    new-instance v0, Lcom/android/server/m;

    invoke-direct {v0, p0}, <init>(Landroid/content/Context;)V

    sput-object v0, mInstance:Lcom/android/server/m;

    :cond_0
    sget-object p0, mInstance:Lcom/android/server/m;
...
.method private readConfigFileLocked(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    invoke-virtual {p0, v3}, cjf(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v3}, oxb(Ljava/lang/String;)Z
...
.method private sb(Ljava/lang/String;)V
    ...
    sget-object p0, Xh:Lcom/android/server/OpPowerControllerService;
...
.method private tb(Ljava/lang/String;)Z
    ...
    sget-object v0, _h:Ljava/lang/String;
    ...
    :cond_0
    sget-object v0, ai:Ljava/lang/String;

    if-nez v0, :cond_1

    invoke-direct {p0}, um()Ljava/lang/String;
    ...
    :cond_1
    sget-object v0, bi:Ljava/lang/String;

    if-nez v0, :cond_2

    invoke-direct {p0}, vm()Ljava/lang/String;
    ...
    :cond_6
    sget-object v0, di:Ljava/lang/String;
    ...
    :cond_7
    iget-object p0, p0, Ph:Ljava/util/List;
...
.method private tm()Ljava/lang/String;
    ...
    iget-object p0, p0, mImm:Landroid/view/inputmethod/InputMethodManager;
...
.method private ub(Ljava/lang/String;)I
    .locals 2
...
.method private vm()Ljava/lang/String;
    ...
    :try_start_0
    iget-object v1, p0, Qh:Landroid/app/WallpaperManager;
    ...
    iget-object p0, p0, Qh:Landroid/app/WallpaperManager;
...
.method private wm()V
    ...
    iget-object v0, p0, mAppWidgetManager:Landroid/appwidget/AppWidgetManager;
    ...
    iput-object v0, p0, Ph:Ljava/util/List;
...
.method private xm()V
    ...
    sput-object v2, _h:Ljava/lang/String;
    ...
    sput-object v2, ai:Ljava/lang/String;
    ...
    sput-object v2, bi:Ljava/lang/String;
    ...
    :cond_5
    sput-object v1, di:Ljava/lang/String;

    iget-object v1, p0, mAm:Landroid/app/ActivityManager;
    ...
    sput-object v2, di:Ljava/lang/String;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method private you(Landroid/content/pm/ApplicationInfo;)Z
    .locals 3
...
.method private zm()V
    ...
    :try_start_0
    iget-object v0, p0, Rh:Landroid/util/ArrayMap;

    iget-object v1, p0, Th:Landroid/util/SparseBooleanArray;
    ...
    iput-object v0, p0, Vh:[I

    iget-object v0, p0, Sh:Landroid/util/ArrayMap;

    iget-object v1, p0, Uh:Landroid/util/SparseBooleanArray;
...
.method private zta(ILjava/lang/String;I)V
    ...
    invoke-direct {p0, p2}, vb(Ljava/lang/String;)Z
    ...
    :cond_0
    iget-object p0, p0, mAppOpsManager:Landroid/app/AppOpsManager;
...
.method static synthetic zta(Lcom/android/server/m;)V
    .locals 0
...
.method private zta(Landroid/content/pm/ApplicationInfo;)Z
    .locals 2
...
.method public addForcedOptApp(Ljava/lang/String;)Z
    ...
    :try_start_0
    invoke-virtual {p0, p1}, oxb(Ljava/lang/String;)Z
...
.method public cjf(Ljava/lang/String;)Z
    ...
    iget-object v4, p0, Sh:Landroid/util/ArrayMap;
    ...
    sget-boolean v4, DEBUG_ONEPLUS:Z
    ...
    invoke-direct {p0, v1, p1, v0}, zta(ILjava/lang/String;I)V
    :try_end_2
...
.method public fto(Ljava/lang/String;)Z
    .locals 3
    ...
    iget-object p0, p0, Sh:Landroid/util/ArrayMap;
...
.method public getForcedOptApps()Landroid/util/ArrayMap;
    ...
    iget-object p0, p0, Rh:Landroid/util/ArrayMap;
...
.method handleWriteConfigFile()V
    ...
    iget-object p0, p0, mConfigFile:Lcom/android/internal/os/AtomicFile;
...
.method public hmo(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v0, p1, v2}, zta(ILjava/lang/String;I)V
...
.method public isDeepClean(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1}, isOptApp(Ljava/lang/String;)Z
    ...
    :cond_0
    invoke-virtual {p0, p1}, ire(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1}, tb(Ljava/lang/String;)Z
...
.method public na()Landroid/util/ArrayMap;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method oa()V
    ...
    iget-object v6, p0, Sh:Landroid/util/ArrayMap;
...
.method public onBootComplete()V
    ...
    iput-object v0, p0, mAppWidgetManager:Landroid/appwidget/AppWidgetManager;
    ...
    iput-object v0, p0, Qh:Landroid/app/WallpaperManager;

    invoke-virtual {p0}, readConfigFileLocked()V

    invoke-virtual {p0}, oa()V
    ...
    sput-object v0, Xh:Lcom/android/server/OpPowerControllerService;
...
.method public oxb(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v2}, zta(Landroid/content/pm/ApplicationInfo;)Z

    move-result v3

    if-nez v3, :cond_4

    invoke-direct {p0, v2}, you(Landroid/content/pm/ApplicationInfo;)Z
    ...
    iget-object v4, p0, Rh:Landroid/util/ArrayMap;
    ...
    invoke-direct {p0, v1, p1, v4}, zta(ILjava/lang/String;I)V
...
.method readConfigFileLocked()V
    ...
    :cond_0
    iget-object v1, p0, Rh:Landroid/util/ArrayMap;
    ...
    invoke-direct {p0, v3}, readConfigFileLocked(Lorg/xmlpull/v1/XmlPullParser;)V
    :try_end_1
...
.method public shellCommand(Ljava/io/PrintWriter;)Z
    ...
    new-instance v3, Lcom/android/server/m$you;

    iget-object v4, p0, Rh:Landroid/util/ArrayMap;

    invoke-direct {v3, p0, v4}, Lcom/android/server/m$you;-><init>(Lcom/android/server/m;Ljava/util/Map;)V
...
.method public sis(Ljava/io/PrintWriter;)V
    ...
    sget-object v1, _h:Ljava/lang/String;
    ...
    sget-object v1, ai:Ljava/lang/String;
    ...
    sget-object v1, bi:Ljava/lang/String;
    ...
    sget-object v1, di:Ljava/lang/String;
    ...
    :goto_0
    iget-object v1, p0, Ph:Ljava/util/List;
    ...
    iget-object v2, p0, Ph:Ljava/util/List;
...
.method writeConfigFileLocked()V
    ...
    iget-object v0, p0, mHandler:Lcom/android/server/m$zta;

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Landroid/os/Handler;->removeMessages(I)V

    iget-object p0, p0, mHandler:Lcom/android/server/m$zta;
...
.method writeConfigFileLocked(Lorg/xmlpull/v1/XmlSerializer;)V
    ...
    iget-object v6, p0, Rh:Landroid/util/ArrayMap;
    ...
    :cond_0
    :goto_1
    iget-object v3, p0, Sh:Landroid/util/ArrayMap;
...
.method public zta(Ljava/lang/String;I)Z
    ...
    :try_start_0
    invoke-virtual {p0, p1}, hmo(Ljava/lang/String;)Z

    move-result p2

    invoke-virtual {p0, p1}, fto(Ljava/lang/String;)Z

    move-result v0

    or-int/2addr p2, v0

    invoke-direct {p0, p1}, sb(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, cjf(Ljava/lang/String;)Z
