...
.field private static TE:Z = true

.field private static UE:Z = false

.field public static final VE:I = -0x63
...
# instance fields
.field private JE:Lcom/oneplus/config/ConfigObserver;

.field private KE:Lcom/android/server/wm/OpScreenModeService;
...
.field private final ME:Ljava/util/HashSet;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashSet<",
            "Ljava/lang/String;",
...
.field private mDockDividerVisibilityListener:Lcom/android/server/backlight/OpBacklightManager$DockDividerVisibilityListener;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, UE:Z

    const/4 v0, 0x0

    sput-object v0, sInstance:Lcom/android/server/backlight/OpBacklightManager;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, mCurrentConfig:Lcom/android/server/backlight/zta;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, LE:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, ME:Ljava/util/HashSet;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, NE:Ljava/util/HashMap;
    ...
    iput v0, p0, mAdjustBrightnessInterval:I

    const/4 v0, 0x0

    iput-boolean v0, p0, QE:Z
    ...
    iput-object v0, p0, RE:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mHandler:Lcom/android/server/backlight/OpBacklightManager$you;
    ...
    iput-object v0, p0, mDockDividerVisibilityListener:Lcom/android/server/backlight/OpBacklightManager$DockDividerVisibilityListener;
    ...
    iget-object p0, p0, NE:Ljava/util/HashMap;
...
.method private Ha(Z)V
    ...
    sput-boolean p1, TE:Z

    sget-boolean p1, TE:Z

    if-nez p1, :cond_2

    iget-object p1, p0, mHandler:Lcom/android/server/backlight/OpBacklightManager$you;

    iget-object v1, p0, RE:Ljava/lang/Runnable;
    ...
    :cond_1
    iget-object p1, p0, mCurrentConfig:Lcom/android/server/backlight/zta;

    invoke-virtual {p1}, Lcom/android/server/backlight/zta;->ed()I
    ...
    iget-object p0, p0, RE:Ljava/lang/Runnable;
...
.method private Ia(Z)V
    ...
    sput-boolean p1, SE:Z

    sget-boolean p1, SE:Z
...
.method private ac(I)V
    ...
    :try_start_0
    iput p1, p0, mAdjustBrightnessInterval:I
...
.method static synthetic cno(Lcom/android/server/backlight/OpBacklightManager;)I
    ...
    iget p0, p0, mAdjustBrightnessInterval:I
...
.method private dump(Ljava/io/PrintWriter;)V
    ...
    iget v2, p0, mAdjustBrightnessInterval:I
    ...
    iget-object v2, p0, mCurrentConfig:Lcom/android/server/backlight/zta;
    ...
    iget-object v1, p0, LE:Ljava/util/ArrayList;
    ...
    iget-object v0, p0, LE:Ljava/util/ArrayList;
    ...
    iget-object v0, p0, ME:Ljava/util/HashSet;
    ...
    iget-object v1, p0, ME:Ljava/util/HashSet;
    ...
    iget-object v1, p0, NE:Ljava/util/HashMap;
...
.method public static declared-synchronized getInstance()Lcom/android/server/backlight/OpBacklightManager;
    ...
    :try_start_0
    sget-object v1, sInstance:Lcom/android/server/backlight/OpBacklightManager;
    ...
    sput-object v1, sInstance:Lcom/android/server/backlight/OpBacklightManager;
...
.method private ic(Ljava/lang/String;)Lcom/android/server/backlight/zta;
    .locals 4
    ...
    :try_start_1
    iget-object p0, p0, LE:Ljava/util/ArrayList;
    ...
    invoke-virtual {v0}, Lcom/android/server/backlight/zta;->kb()Ljava/lang/String;
...
.method private jc(Ljava/lang/String;)Z
    ...
    iget-object p0, p0, KE:Lcom/android/server/wm/OpScreenModeService;
...
.method static synthetic kth(Lcom/android/server/backlight/OpBacklightManager;)Lcom/android/server/display/IOpBacklightController;
    ...
    iget-object p0, p0, mDisplayPowerController:Lcom/android/server/display/IOpBacklightController;
...
.method private lp()I
    ...
    iget-object v0, p0, mCurrentConfig:Lcom/android/server/backlight/zta;

    invoke-direct {p0, v0}, you(Lcom/android/server/backlight/zta;)Lcom/android/server/backlight/zta$zta;
    ...
    iget-object p0, p0, mCurrentConfig:Lcom/android/server/backlight/zta;
    ...
    :cond_0
    invoke-virtual {v0}, Lcom/android/server/backlight/zta$zta;->ad()I
...
.method private mp()I
    ...
    :cond_0
    invoke-virtual {v0}, Lcom/android/server/backlight/zta$zta;->_c()I
...
.method private np()D
    ...
    :cond_0
    invoke-virtual {v0}, Lcom/android/server/backlight/zta$zta;->Zc()D
...
.method private oif(Ljava/lang/String;I)V
    ...
    invoke-direct {p0, p1}, jc(Ljava/lang/String;)Z
    ...
    iget-object p2, p0, RE:Ljava/lang/Runnable;
...
.method private op()I
    ...
    :cond_0
    iget-object v1, p0, mCurrentConfig:Lcom/android/server/backlight/zta;

    invoke-virtual {v1}, Lcom/android/server/backlight/zta;->ed()I
    ...
    invoke-virtual {p0}, Lcom/android/server/backlight/zta;->ed()I
    ...
    invoke-virtual {v0}, Lcom/android/server/backlight/zta$zta;->bd()I
...
.method private resolvePerfConfigFromJSON(Lorg/json/JSONArray;)V
    ...
    iget-object v6, v0, LE:Ljava/util/ArrayList;
    ...
    :try_start_1
    iget-object v7, v0, LE:Ljava/util/ArrayList;
    ...
    :cond_3
    iget-object v6, v0, ME:Ljava/util/HashSet;
    ...
    :try_start_3
    iget-object v7, v0, ME:Ljava/util/HashSet;
    ...
    iget-object v2, v0, NE:Ljava/util/HashMap;
    ...
    :try_start_5
    iget-object v6, v0, NE:Ljava/util/HashMap;
...
.method static synthetic rtg(Lcom/android/server/backlight/OpBacklightManager;Lcom/android/server/backlight/zta;)I
    ...
    invoke-direct {p0, p1}, zta(Lcom/android/server/backlight/zta;)I
...
.method private rtg(Lcom/android/server/backlight/zta;)V
    ...
    invoke-direct {p0, p1}, sis(Lcom/android/server/backlight/zta;)V

    iget-object p1, p0, mHandler:Lcom/android/server/backlight/OpBacklightManager$you;

    iget-object v3, p0, RE:Ljava/lang/Runnable;
    ...
    invoke-virtual {p1}, Lcom/android/server/backlight/zta;->kb()Ljava/lang/String;
    ...
    iget-object v0, p0, RE:Ljava/lang/Runnable;
...
.method static synthetic sis(Lcom/android/server/backlight/OpBacklightManager;)Lcom/android/server/backlight/OpBacklightManager$you;
    ...
    iget-object p0, p0, mHandler:Lcom/android/server/backlight/OpBacklightManager$you;
...
.method static synthetic sis(Lcom/android/server/backlight/OpBacklightManager;Lcom/android/server/backlight/zta;)V
    ...
    invoke-direct {p0, p1}, rtg(Lcom/android/server/backlight/zta;)V
...
.method private sis(Lcom/android/server/backlight/zta;)V
    ...
    invoke-virtual {v0}, Lcom/android/server/backlight/zta;->ed()I
    ...
    invoke-direct {p0, p1, v0}, zta(Lcom/android/server/backlight/zta;Lcom/android/server/backlight/zta$zta;)I

    move-result v0

    invoke-virtual {p1, v0}, Lcom/android/server/backlight/zta;->u(I)I

    :cond_0
    iput-object p1, p0, mCurrentConfig:Lcom/android/server/backlight/zta;
...
.method static synthetic tsu(Lcom/android/server/backlight/OpBacklightManager;Lcom/android/server/backlight/zta;)Lcom/android/server/backlight/zta$zta;
    ...
    invoke-direct {p0, p1}, you(Lcom/android/server/backlight/zta;)Lcom/android/server/backlight/zta$zta;
...
.method private you(Lcom/android/server/backlight/zta;)Lcom/android/server/backlight/zta$zta;
    ...
    iget-object v0, p0, NE:Ljava/util/HashMap;
    ...
    invoke-virtual {p1}, Lcom/android/server/backlight/zta;->dd()I
...
.method static synthetic you(Lcom/android/server/backlight/OpBacklightManager;Lcom/android/server/backlight/zta;)Z
    ...
    invoke-direct {p0, p1}, tsu(Lcom/android/server/backlight/zta;)Z
...
.method private zta(Lcom/android/server/backlight/zta;Lcom/android/server/backlight/zta$zta;)I
    ...
    invoke-virtual {v4}, Lcom/android/server/backlight/zta$zta;->Zc()D

    move-result-wide v4

    invoke-virtual {p2}, Lcom/android/server/backlight/zta$zta;->Zc()D
...
.method static synthetic zta(Lcom/android/server/backlight/OpBacklightManager;Ljava/lang/String;)Lcom/android/server/backlight/zta;
    ...
    invoke-direct {p0, p1}, ic(Ljava/lang/String;)Lcom/android/server/backlight/zta;
...
.method public hookDisplayPowerController(Lcom/android/server/display/IOpBacklightController;)V
    ...
    iput-object p1, p0, mDisplayPowerController:Lcom/android/server/display/IOpBacklightController;
...
.method public initOnlineConfig(Landroid/content/Context;)V
    ...
    iget-object v1, p0, mHandler:Lcom/android/server/backlight/OpBacklightManager$you;
    ...
    iput-object p1, p0, JE:Lcom/oneplus/config/ConfigObserver;

    iget-object p1, p0, JE:Lcom/oneplus/config/ConfigObserver;
    ...
    iget-object p0, p0, mDockDividerVisibilityListener:Lcom/android/server/backlight/OpBacklightManager$DockDividerVisibilityListener;
...
.method public sis(Ljava/lang/String;I)V
    ...
    iget-boolean v1, p0, QE:Z

    if-nez v1, :cond_5

    iget-object v1, p0, mDisplayPowerController:Lcom/android/server/display/IOpBacklightController;
    ...
    invoke-virtual {v1}, Lcom/android/server/backlight/zta;->kb()Ljava/lang/String;
    ...
    invoke-direct {p0, p1, p2}, oif(Ljava/lang/String;I)V

    :cond_2
    iget-object p0, p0, mCurrentConfig:Lcom/android/server/backlight/zta;

    invoke-virtual {p0, p2}, Lcom/android/server/backlight/zta;->v(I)V
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/backlight/zta;->v(I)V
...
.method public zta(Lcom/android/server/wm/OpScreenModeService;)V
    ...
    iput-object p1, p0, KE:Lcom/android/server/wm/OpScreenModeService;
...
.method public zta(Ljava/io/PrintWriter;[Ljava/lang/String;)Z
    ...
    sput-boolean p0, mDebug:Z

    sput-boolean p0, UE:Z
    ...
    iget-object v4, p0, LE:Ljava/util/ArrayList;
    ...
    :try_start_1
    iget-object v5, p0, LE:Ljava/util/ArrayList;
    ...
    invoke-virtual {v6}, Lcom/android/server/backlight/zta;->kb()Ljava/lang/String;
    ...
    iget-object v7, p0, LE:Ljava/util/ArrayList;
    ...
    :try_start_5
    iget-object v6, p0, ME:Ljava/util/HashSet;
    ...
    :try_start_9
    iget-object v3, p0, NE:Ljava/util/HashMap;
    ...
    iget-object p2, p0, NE:Ljava/util/HashMap;
