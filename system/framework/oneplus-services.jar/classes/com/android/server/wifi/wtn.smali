...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/android/server/wifi/ire;->Rq()V
.end annotation
...
.method public frontPackageChanged(Ljava/lang/String;IILjava/lang/String;II)V
    ...
    iget-object p5, p0, this$0:Lcom/android/server/wifi/ire;

    invoke-static {p5, p2}, Lcom/android/server/wifi/ire;->cno(Lcom/android/server/wifi/ire;I)Z

    move-result p5

    iget-object v0, p0, this$0:Lcom/android/server/wifi/ire;

    invoke-static {v0, p2}, Lcom/android/server/wifi/ire;->kth(Lcom/android/server/wifi/ire;I)Z
    ...
    iget-object v2, p0, this$0:Lcom/android/server/wifi/ire;

    invoke-static {v2}, Lcom/android/server/wifi/ire;->lqr(Lcom/android/server/wifi/ire;)Ljava/util/ArrayList;

    move-result-object v2

    iget-object v3, p0, this$0:Lcom/android/server/wifi/ire;

    invoke-static {v3, p1, p3}, Lcom/android/server/wifi/ire;->zta(Lcom/android/server/wifi/ire;Ljava/lang/String;I)V
    ...
    :cond_0
    iget-object p2, p0, this$0:Lcom/android/server/wifi/ire;

    invoke-static {p2}, Lcom/android/server/wifi/ire;->vdb(Lcom/android/server/wifi/ire;)Z
    ...
    invoke-static {p2, v3}, Lcom/android/server/wifi/ire;->cno(Lcom/android/server/wifi/ire;Z)Z

    iget-object p2, p0, this$0:Lcom/android/server/wifi/ire;

    invoke-static {p2, v3}, Lcom/android/server/wifi/ire;->bio(Lcom/android/server/wifi/ire;Z)V
    ...
    invoke-static {p1}, Lcom/android/server/wifi/ire;->ear(Lcom/android/server/wifi/ire;)I
    ...
    invoke-static {p1, p3}, Lcom/android/server/wifi/ire;->cno(Lcom/android/server/wifi/ire;Z)Z

    iget-object p0, p0, this$0:Lcom/android/server/wifi/ire;

    invoke-static {p0, p3}, Lcom/android/server/wifi/ire;->bio(Lcom/android/server/wifi/ire;Z)V
    ...
    invoke-static {p1, p3}, Lcom/android/server/wifi/ire;->rtg(Lcom/android/server/wifi/ire;Z)Z
