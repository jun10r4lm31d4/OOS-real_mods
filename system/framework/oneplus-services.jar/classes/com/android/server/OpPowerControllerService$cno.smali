...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-virtual {p0}, Lcom/android/server/am/m;->zc()V
    ...
    :pswitch_5
    iget-object p1, p0, this$0:Lcom/android/server/OpPowerControllerService;
    ...
    invoke-virtual {p1}, Lcom/android/server/OpPowerControllerService$rtg;->ea()Ljava/time/LocalDateTime;
    ...
    invoke-virtual {v0}, Lcom/android/server/OpPowerControllerService$rtg;->ha()V
    ...
    invoke-virtual {p1}, Lcom/android/server/OpPowerControllerService$rtg;->Z()[[D
    ...
    invoke-virtual {v1, p1}, Lcom/android/server/OpPowerControllerService$ssp;->bvj(I)I
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/OpPowerControllerService$ssp;->bvj(I)I
    ...
    iget-object v3, p0, this$0:Lcom/android/server/OpPowerControllerService;
    ...
    invoke-virtual {v3, p1}, Lcom/android/server/OpPowerControllerService$ssp;->bvj(I)I
    ...
    invoke-virtual {v3, p1}, Lcom/android/server/OpPowerControllerService$ssp;->oif(I)J
    ...
    invoke-virtual {v1, p1}, Lcom/android/server/OpPowerControllerService$ssp;->oif(I)J
    ...
    invoke-virtual {p1, v1}, Lcom/android/server/OpPowerControllerService$ssp;->qbh(I)J
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/OpPowerControllerService$ssp;->oif(I)J
    ...
    invoke-virtual {v3, v0}, Lcom/android/server/OpPowerControllerService$rtg;->you(Ljava/time/Duration;)V

    iget-object v0, p0, this$0:Lcom/android/server/OpPowerControllerService;

    iget-object v0, v0, Lcom/android/server/OpPowerControllerService;->mOnePlusChargingGuarder:Lcom/android/server/tsu;

    if-eqz v0, :cond_c

    invoke-virtual {v0, p1}, Lcom/android/server/tsu;->zta(Ljava/time/LocalTime;)V

    iget-object p1, p0, this$0:Lcom/android/server/OpPowerControllerService;

    iget-object v0, p1, Lcom/android/server/OpPowerControllerService;->mOnePlusChargingGuarder:Lcom/android/server/tsu;

    invoke-static {p1}, Lcom/android/server/OpPowerControllerService;->access$3500(Lcom/android/server/OpPowerControllerService;)Lcom/android/server/OpPowerControllerService$ssp;

    move-result-object p1

    invoke-virtual {p1, v1}, Lcom/android/server/OpPowerControllerService$ssp;->oif(I)J

    move-result-wide v3

    invoke-virtual {v0, v3, v4}, Lcom/android/server/tsu;->sis(J)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/server/OpPowerControllerService$ssp;->bvj(I)I
    ...
    invoke-virtual {v0, v2}, Lcom/android/server/OpPowerControllerService$ssp;->qbh(I)J
    ...
    invoke-virtual {v0, v2}, Lcom/android/server/OpPowerControllerService$ssp;->oif(I)J
    ...
    invoke-virtual {p0}, Lcom/android/server/OpPowerControllerService$rtg;->fa()V
