...
.field private static final BQ:I = 0x3
...
.field public static final DQ:I = 0x124f800

.field public static final EQ:Ljava/lang/String; = "tp"

.field public static final FQ:Ljava/lang/String; = "dl"

.field public static final GQ:Ljava/lang/String; = "pn"

.field static HQ:Z = false

.field public static final INVALID:I = -0x1

.field public static final INVALID_UID:I = -0x3e7

.field public static IQ:I = 0x0

.field private static JQ:I = 0x0

.field private static KQ:Ljava/lang/String; = null

.field static final LQ:I = 0x3e8

.field private static final Lj:I = 0x28

.field public static final MDM_EVENT:Ljava/lang/String; = "standby"

.field static final MQ:I = 0x3e9

.field static final NQ:I = 0x3ec

.field static final OQ:I = 0x3ed

.field static final PQ:I = 0x3ee

.field static final RQ:I = 0x3ef

.field static final SQ:I = 0x3f0
...
.field static final TQ:I = 0x3f1

.field static final UQ:I = 0x3f2

.field private static final VQ:Ljava/lang/String; = "PowerManagerService.WakeLocks"

.field public static WQ:Ljava/lang/String; = null

.field public static XQ:Ljava/lang/String; = null

.field public static YQ:Ljava/lang/String; = null

.field public static ZQ:Ljava/lang/String; = null

.field public static final _Q:Ljava/lang/String; = "/data/system/power/diagnosis_assist.txt"

.field public static final aR:Ljava/lang/String; = "/data/system/power/diagnosis_rpm.txt"

.field static final aa:I = 0x3ea

.field static final ar:J = 0x2710L

.field private static final bR:J = 0x1388L

.field static final ba:I = 0x3eb

.field public static cR:Ljava/lang/String; = null

.field public static dR:Ljava/lang/String; = null

.field private static eR:F = 0.0f

.field private static fR:F = 0.0f

.field private static gR:I = 0x0

.field private static hR:F = 0.0f

.field private static iR:F = 0.0f

.field private static jR:F = 0.0f

.field private static kR:F = 0.0f

.field private static lR:F = 0.0f

.field private static final mVersion:Ljava/lang/String; = "2.03"

.field private static nR:F = 0.0f

.field private static oR:I = 0x0

.field private static pR:F = 0.0f

.field private static qR:F = 0.0f

.field private static rR:F = 0.0f

.field private static sR:J = 0x0L

.field private static tR:F = 0.0f

.field private static uR:J = 0x0L

.field private static final wQ:Ljava/lang/String; = "persist.sys.standby_debug"

.field public static final xQ:Ljava/lang/String; = "persist.sys.standby_qxdm_recording"

.field public static final yQ:Ljava/lang/String; = "persist.sys.standby_qxdm"

.field public static final zQ:Ljava/lang/String; = "persist.sys.qxdm_clean_old"


# instance fields
.field private AO:Z

.field AP:Ljava/util/Map;
...
.field private PO:Lcom/android/server/power/OnePlusStandbyAnalyzer$cno;

.field private PP:Ljava/util/regex/Pattern;

.field private QO:Z

.field private QP:Ljava/util/regex/Pattern;

.field private RP:Ljava/util/regex/Pattern;
...
.field private VO:Lcom/android/server/power/you;
...
.field private XP:Ljava/util/regex/Pattern;

.field YO:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Lcom/android/internal/os/BatterySipper;",
...
.field private jQ:Lcom/android/internal/os/BatterySipper;

.field private kO:Ljava/lang/String;

.field kP:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Ljava/lang/String;",
...
.field private mQ:Landroid/content/IntentFilter;
...
.field private nQ:Lcom/android/server/power/OnePlusStandbyAnalyzer$gck;

.field private oO:Z

.field oP:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Ljava/lang/String;",
...
.field private pQ:Lcom/android/server/power/OnePlusStandbyAnalyzer$ssp;

.field private qO:Z

.field qP:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Lcom/android/server/power/OnePlusStandbyAnalyzer$bvj;",
...
.field rQ:Ljava/util/Comparator;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private sO:Lcom/android/server/power/OnePlusStandbyAnalyzer$TRIGGER_QXDM_REASON;

.field sP:J

.field sQ:Ljava/util/Comparator;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Comparator<",
            "Lcom/android/server/power/OnePlusStandbyAnalyzer$kth;",
...
.field tQ:Ljava/util/Comparator;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Comparator<",
            "Lcom/android/server/power/OnePlusStandbyAnalyzer$ibl;",
...
.field uQ:Ljava/util/Comparator;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Comparator<",
            "Lcom/android/server/power/OnePlusStandbyAnalyzer$zta;",
...
.field private zO:Landroid/os/BatteryManagerInternal;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, DEBUG_STANDBY:Z
    ...
    sput-object v0, KQ:Ljava/lang/String;

    const-string v0, "/d/rpm_stats"

    sput-object v0, WQ:Ljava/lang/String;

    const-string v0, "/d/rpmh/stats"

    sput-object v0, XQ:Ljava/lang/String;

    const-string v0, "/d/rpm_master_stats"

    sput-object v0, YQ:Ljava/lang/String;

    const-string v0, "/d/rpmh/master_stats"

    sput-object v0, ZQ:Ljava/lang/String;
...
.method public constructor <init>(Lcom/android/server/DeviceIdleController;Z)V
    ...
    iput-boolean v0, p0, hO:Z

    iput-boolean v0, p0, iO:Z

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, jO:Ljava/util/Map;

    iput-boolean v0, p0, mO:Z

    iput-boolean v0, p0, nO:Z

    iput-boolean v0, p0, oO:Z

    iput-boolean v0, p0, pO:Z

    iput-boolean v0, p0, qO:Z

    iput-boolean v0, p0, rO:Z

    sget-object v1, Lcom/android/server/power/OnePlusStandbyAnalyzer$TRIGGER_QXDM_REASON;->vwa:Lcom/android/server/power/OnePlusStandbyAnalyzer$TRIGGER_QXDM_REASON;

    iput-object v1, p0, sO:Lcom/android/server/power/OnePlusStandbyAnalyzer$TRIGGER_QXDM_REASON;

    const-wide/32 v1, 0xa4cb800

    iput-wide v1, p0, tO:J

    const-wide/32 v1, 0x6ddd00

    iput-wide v1, p0, uO:J

    const-wide/32 v1, 0xa4cb80

    iput-wide v1, p0, vO:J

    const-wide/16 v1, 0x0

    iput-wide v1, p0, wO:J

    iput v0, p0, xO:I

    iput-boolean v0, p0, yO:Z

    iput-boolean v0, p0, AO:Z

    iput-boolean v0, p0, CO:Z
    ...
    iput-wide v1, p0, JO:J

    iput-wide v1, p0, KO:J
    ...
    iput-wide v1, p0, cO:J

    const/4 v1, 0x5

    iput v1, p0, mBatteryLevelLow:I

    const/4 v1, 0x1

    iput-boolean v1, p0, QO:Z

    iput-boolean v0, p0, m1stLightIdle:Z

    const-wide/16 v2, 0x2710

    iput-wide v2, p0, SO:J

    iput-boolean v0, p0, UO:Z

    iput-boolean v1, p0, WO:Z

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, KP:Ljava/util/List;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, LP:Ljava/util/List;

    iput-boolean v0, p0, MP:Z

    iput-boolean v0, p0, NP:Z
    ...
    iput-object v2, p0, PP:Ljava/util/regex/Pattern;
    ...
    iput-object v2, p0, QP:Ljava/util/regex/Pattern;
    ...
    iput-object v2, p0, RP:Ljava/util/regex/Pattern;
    ...
    iput-object v1, p0, XP:Ljava/util/regex/Pattern;

    iput-boolean v0, p0, oQ:Z
    ...
    iput-object v1, p0, pQ:Lcom/android/server/power/OnePlusStandbyAnalyzer$ssp;

    iput-boolean v0, p0, qQ:Z
    ...
    iput-object v0, p0, rQ:Ljava/util/Comparator;
    ...
    iput-object v0, p0, sQ:Ljava/util/Comparator;
    ...
    iput-object v0, p0, tQ:Ljava/util/Comparator;
    ...
    iput-object v0, p0, uQ:Ljava/util/Comparator;
    ...
    iput-object v0, p0, vQ:Ljava/util/Comparator;
    ...
    iput-object v0, p0, zq:Ljava/util/Comparator;
    ...
    iput-object p1, p0, mDeviceIdleController:Lcom/android/server/DeviceIdleController;

    iput-boolean p2, p0, oO:Z
...
.method private Ma(Z)V
    ...
    iget-object p0, p0, PO:Lcom/android/server/power/OnePlusStandbyAnalyzer$cno;
...
.method private Rp()V
    ...
    iget-wide v3, v0, rP:J

    iget-wide v5, v0, hP:J

    sub-long/2addr v3, v5

    iput-wide v3, v0, YP:J

    iget-wide v3, v0, sP:J

    iget-wide v5, v0, iP:J

    sub-long/2addr v3, v5

    iput-wide v3, v0, _P:J

    iget-wide v3, v0, tP:J

    iget-wide v5, v0, jP:J

    sub-long/2addr v3, v5

    iput-wide v3, v0, iQ:J

    new-instance v3, Ljava/util/HashMap;

    invoke-direct {v3}, Ljava/util/HashMap;-><init>()V

    iput-object v3, v0, fP:Ljava/util/Map;

    const-wide/16 v3, 0x0

    iput-wide v3, v0, eQ:J

    iget-object v5, v0, eP:Ljava/util/Map;

    if-eqz v5, :cond_3

    iget-object v6, v0, dP:Ljava/util/Map;
    ...
    iget-object v8, v0, dP:Ljava/util/Map;
    ...
    :goto_1
    iget-object v10, v0, fP:Ljava/util/Map;
    ...
    iput-object v3, v0, gP:Ljava/util/List;

    iget-object v3, v0, gP:Ljava/util/List;

    iget-object v4, v0, fP:Ljava/util/Map;
    ...
    iget-object v4, v0, zq:Ljava/util/Comparator;
    ...
    iput-object v3, v0, pP:Ljava/util/Map;

    const-wide/16 v3, 0x0

    iput-wide v3, v0, gQ:J

    iget-object v3, v0, oP:Ljava/util/Map;

    const/4 v4, 0x0

    if-eqz v3, :cond_6

    iget-object v5, v0, nP:Ljava/util/Map;
    ...
    iget-object v8, v0, nP:Ljava/util/Map;
    ...
    :goto_3
    iget-object v9, v0, pP:Ljava/util/Map;
    ...
    iget-wide v6, v0, gQ:J

    int-to-long v8, v5

    add-long/2addr v6, v8

    iput-wide v6, v0, gQ:J
    ...
    iput-object v3, v0, qP:Ljava/util/List;

    iget-object v3, v0, qP:Ljava/util/List;

    iget-object v5, v0, pP:Ljava/util/Map;
    ...
    iput-object v3, v0, wP:Ljava/util/List;

    const-wide/16 v5, 0x0

    iput-wide v5, v0, hQ:J

    iget-object v3, v0, vP:Ljava/util/List;

    if-eqz v3, :cond_8

    iget-object v3, v0, uP:Ljava/util/List;
    ...
    iget-object v5, v0, vP:Ljava/util/List;
    ...
    iget-object v7, v0, uP:Ljava/util/List;
    ...
    iget-object v7, v0, wP:Ljava/util/List;
    ...
    iget-wide v7, v0, hQ:J

    add-long/2addr v7, v5

    iput-wide v7, v0, hQ:J
    ...
    :cond_8
    iget-object v3, v0, XO:Ljava/util/List;

    iget-object v5, v0, YO:Ljava/util/List;

    invoke-direct {v0, v3, v5}, zta(Ljava/util/List;Ljava/util/List;)V

    iget-object v3, v0, aP:Ljava/util/Map;

    iget-object v5, v0, bP:Ljava/util/Map;

    invoke-direct {v0, v3, v5}, you(Ljava/util/Map;Ljava/util/Map;)V

    iget-object v3, v0, HP:Ljava/util/Map;

    invoke-virtual {v0, v3}, you(Ljava/util/Map;)Ljava/util/List;

    move-result-object v3

    iput-object v3, v0, JP:Ljava/util/List;

    iget-object v3, v0, EP:Ljava/util/Map;

    iget-object v5, v0, GP:Ljava/util/Map;

    invoke-direct {v0, v3, v5}, sis(Ljava/util/Map;Ljava/util/Map;)V

    iget-object v3, v0, AP:Ljava/util/Map;

    iget-object v5, v0, BP:Ljava/util/Map;

    invoke-direct {v0, v3, v5}, tsu(Ljava/util/Map;Ljava/util/Map;)V

    iget-wide v5, v0, _P:J

    iget-wide v7, v0, eQ:J

    sub-long/2addr v5, v7

    iput-wide v5, v0, fQ:J

    sget-boolean v3, DEBUG_STANDBY:Z

    if-eqz v3, :cond_9

    iget-object v3, v0, cP:Ljava/util/List;

    invoke-direct {v0, v3}, ibl(Ljava/util/List;)V
    ...
    invoke-direct {v0, v3}, oif(Ljava/util/List;)V
    ...
    invoke-direct {v0, v3}, gwm(Ljava/util/List;)V
    ...
    iget-object v3, v0, JP:Ljava/util/List;

    invoke-direct {v0, v3}, bvj(Ljava/util/List;)V
    ...
    iget-object v3, v0, wP:Ljava/util/List;

    const-string v5, "Diff-Signal"

    invoke-direct {v0, v5, v3}, sis(Ljava/lang/String;Ljava/util/List;)V
    ...
    iget-object v3, v0, xP:Ljava/util/List;

    const-string v5, "Diff-RPM"

    invoke-direct {v0, v5, v3}, you(Ljava/lang/String;Ljava/util/List;)V
    ...
    iget-object v3, v0, yP:Ljava/util/List;

    const-string v5, "Diff-RPMMaster"

    invoke-direct {v0, v5, v3}, zta(Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-direct {v0, v5, v3, v4}, rtg(Ljava/lang/String;Ljava/util/List;Z)V
...
.method private Sp()V
    ...
    iget-object v0, p0, zP:Ljava/util/List;
    ...
    :goto_0
    iget-object v1, p0, zP:Ljava/util/List;
...
.method private Up()V
    ...
    iget-object v1, p0, mDeviceIdleController:Lcom/android/server/DeviceIdleController;
    ...
    iput-object v0, p0, zO:Landroid/os/BatteryManagerInternal;
    ...
    iget-object v0, p0, zO:Landroid/os/BatteryManagerInternal;
    ...
    iput v0, p0, mCurrentBatteryLevel:I
    ...
    :cond_1
    iget-object v0, p0, OB:Lcom/oneplus/os/IOnePlusExService;
    ...
    iput-object v0, p0, OB:Lcom/oneplus/os/IOnePlusExService;

    :cond_2
    iget-object v0, p0, PO:Lcom/android/server/power/OnePlusStandbyAnalyzer$cno;

    invoke-virtual {v0}, Lcom/android/server/power/OnePlusStandbyAnalyzer$cno;->Dg()V
    ...
    iget-object v2, p0, PO:Lcom/android/server/power/OnePlusStandbyAnalyzer$cno;
...
.method private Vp()V
    ...
    iput-object v0, p0, WP:Ljava/util/Map;

    iget-boolean v0, p0, NP:Z
    ...
    iget-object v0, p0, WP:Ljava/util/Map;

    sget-object v6, Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MASTER_TYPE;->Yya:Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MASTER_TYPE;
    ...
    iget-object v8, p0, VP:Ljava/lang/String;
    ...
    sget-object v6, Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MASTER_TYPE;->Xya:Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MASTER_TYPE;
    ...
    sget-object v6, Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MASTER_TYPE;->Wya:Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MASTER_TYPE;
    ...
    sget-object v6, Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MASTER_TYPE;->Zya:Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MASTER_TYPE;
    ...
    iget-object p0, p0, VP:Ljava/lang/String;
    ...
    iget-object v8, p0, TP:Ljava/lang/String;
    ...
    iget-object p0, p0, TP:Ljava/lang/String;
...
.method private Wp()V
    ...
    iget-boolean v0, p0, m1stLightIdle:Z
    ...
    :cond_1
    iget v0, p0, mCurrentBatteryLevel:I
    ...
    sget-object v2, Lcom/android/server/power/OnePlusStandbyAnalyzer$STATISTIC_TYPE;->lza:Lcom/android/server/power/OnePlusStandbyAnalyzer$STATISTIC_TYPE;

    invoke-virtual {p0, v0, v2}, zta(Lcom/android/server/power/OnePlusStandbyAnalyzer$SNAPSHOT_TYPE;Lcom/android/server/power/OnePlusStandbyAnalyzer$STATISTIC_TYPE;)V
    :try_end_0
...
.method private Xp()Ljava/lang/String;
    ...
    iget-object v2, v0, xP:Ljava/util/List;
    ...
    iget-object v2, v0, yP:Ljava/util/List;
    ...
    invoke-direct {v0, v2}, dma(Ljava/util/List;)Z
    ...
    :goto_0
    iget-object v13, v0, yP:Ljava/util/List;
    ...
    iget-wide v4, v13, Lcom/android/server/power/OnePlusStandbyAnalyzer$wtn;->UN:J

    cmp-long v4, v11, v4

    if-gez v4, :cond_1

    iget-object v4, v0, yP:Ljava/util/List;
    ...
    iget-wide v4, v4, Lcom/android/server/power/OnePlusStandbyAnalyzer$wtn;->UN:J
    ...
    iget-object v10, v0, yP:Ljava/util/List;
    ...
    sget-object v1, Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_CATEGORY;->Uya:Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_CATEGORY;
    ...
    sget-object v4, Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MASTER_TYPE;->Zya:Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MASTER_TYPE;
    ...
    iget-wide v4, v4, Lcom/android/server/power/OnePlusStandbyAnalyzer$wtn;->RN:J
    ...
    iget-wide v3, v3, Lcom/android/server/power/OnePlusStandbyAnalyzer$wtn;->RN:J
    ...
    sget-object v1, Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_CATEGORY;->Vya:Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_CATEGORY;
    ...
    sget-object v1, Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MASTER_TYPE;->Zya:Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MASTER_TYPE;
    ...
    sget-object v10, Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MASTER_CHECK_ORDER_SDM845;->Zya:Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MASTER_CHECK_ORDER_SDM845;
    ...
    :goto_5
    iget-object v11, v0, yP:Ljava/util/List;
    ...
    iget-object v12, v0, yP:Ljava/util/List;
    ...
    iget-object v11, v11, Lcom/android/server/power/OnePlusStandbyAnalyzer$wtn;->QN:Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_CX_STATE;
    ...
    invoke-direct {v0, v11}, zta(Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MASTER_TYPE;)J
    ...
    iget-object v14, v0, yP:Ljava/util/List;
    ...
    invoke-static {v13}, myLog(Ljava/lang/String;)V
    ...
    iget-wide v13, v13, Lcom/android/server/power/OnePlusStandbyAnalyzer$wtn;->UN:J
    ...
    iget-object v15, v0, yP:Ljava/util/List;
    ...
    invoke-static {v14}, myLog(Ljava/lang/String;)V
    ...
    sget-object v1, Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_CATEGORY;->Sya:Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_CATEGORY;
...
.method private Yp()Z
    ...
    iget-wide v2, v0, hP:J

    invoke-virtual {v1, v2, v3}, Ljava/lang/StringBuilder;->append(J)Ljava/lang/StringBuilder;

    invoke-virtual {v1, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-wide v2, v0, rP:J
    ...
    iput-boolean v7, v0, iO:Z

    iget-object v4, v0, jO:Ljava/util/Map;

    invoke-interface {v4}, Ljava/util/Map;->clear()V

    const/4 v4, 0x0

    iput-object v4, v0, lO:Ljava/lang/String;

    iget-object v5, v0, VO:Lcom/android/server/power/you;

    const-string v6, "/data/system/power/diagnosis_assist.txt"

    invoke-virtual {v5, v6}, Lcom/android/server/power/you;->U(Ljava/lang/String;)V
    ...
    sget-object v8, Lcom/android/server/power/OnePlusStandbyAnalyzer$BATTERY_OUTLIER_TYPE;->Gwa:Lcom/android/server/power/OnePlusStandbyAnalyzer$BATTERY_OUTLIER_TYPE;
    ...
    iget-object v11, v0, jO:Ljava/util/Map;
    ...
    sget-object v15, Lcom/android/server/power/OnePlusStandbyAnalyzer$DIAGNOSIS_DATA_TYPE;->Axa:Lcom/android/server/power/OnePlusStandbyAnalyzer$DIAGNOSIS_DATA_TYPE;
    ...
    sget-object v11, Lcom/android/server/power/OnePlusStandbyAnalyzer$DIAGNOSIS_DATA_TYPE;->Bxa:Lcom/android/server/power/OnePlusStandbyAnalyzer$DIAGNOSIS_DATA_TYPE;
    ...
    invoke-static/range {v20 .. v20}, myLog(Ljava/lang/String;)V
    ...
    sget-boolean v14, DEBUG_STANDBY:Z

    if-eqz v14, :cond_4

    iget-object v14, v0, FP:Ljava/util/List;

    const-string v7, "Diff"

    invoke-direct {v0, v7, v14, v13}, tsu(Ljava/lang/String;Ljava/util/List;Z)V
    ...
    invoke-static {v7}, myLog(Ljava/lang/String;)V

    iget-object v7, v0, gP:Ljava/util/List;

    invoke-direct {v0, v7}, ugm(Ljava/util/List;)V

    iget-object v7, v0, xP:Ljava/util/List;

    const-string v13, "Diff-RPM"

    invoke-direct {v0, v13, v7}, you(Ljava/lang/String;Ljava/util/List;)V

    iget-object v7, v0, yP:Ljava/util/List;

    const-string v13, "Diff-RPMMaster"

    invoke-direct {v0, v13, v7}, zta(Ljava/lang/String;Ljava/util/List;)V

    iget-object v7, v0, xP:Ljava/util/List;

    iget-object v13, v0, yP:Ljava/util/List;

    invoke-direct {v0, v7, v13}, you(Ljava/util/List;Ljava/util/List;)Ljava/util/List;

    move-result-object v7

    iget-object v13, v0, VO:Lcom/android/server/power/you;

    move-object v14, v5

    move-object/from16 v24, v6

    iget-wide v5, v0, YP:J
    ...
    iput-object v1, v0, kO:Ljava/lang/String;

    iget-object v1, v0, xP:Ljava/util/List;

    iget-object v5, v0, yP:Ljava/util/List;

    const-string v6, "Diff-RPM"

    invoke-direct {v0, v6, v1, v5}, zta(Ljava/lang/String;Ljava/util/List;Ljava/util/List;)Ljava/lang/String;

    move-result-object v1

    iget-object v5, v0, yP:Ljava/util/List;

    invoke-direct {v0, v5}, vdb(Ljava/util/List;)Ljava/lang/String;
    ...
    iget-object v5, v0, CP:Ljava/util/List;

    const-string v7, "Diff-WiFiWakeUp"

    const/4 v13, 0x1

    invoke-direct {v0, v7, v5, v13}, rtg(Ljava/lang/String;Ljava/util/List;Z)V
    ...
    iget-object v5, v0, zP:Ljava/util/List;

    invoke-direct {v0, v5}, zgw(Ljava/util/List;)Ljava/lang/String;
    ...
    invoke-direct {v0, v5}, oxb(Ljava/util/List;)Lcom/android/server/power/OnePlusStandbyAnalyzer$qbh;
    ...
    sget-boolean v7, DEBUG_STANDBY:Z

    if-eqz v7, :cond_5

    iget-object v7, v0, kQ:Ljava/util/List;

    const-string v10, "Diff - totalPowerMah"

    const/4 v13, 0x1

    invoke-direct {v0, v10, v7, v13}, sis(Ljava/lang/String;Ljava/util/List;Z)V
    ...
    :cond_6
    iget-object v7, v0, jO:Ljava/util/Map;

    sget-object v10, Lcom/android/server/power/OnePlusStandbyAnalyzer$DIAGNOSIS_DATA_TYPE;->xxa:Lcom/android/server/power/OnePlusStandbyAnalyzer$DIAGNOSIS_DATA_TYPE;
    ...
    invoke-static {v10}, myLog(Ljava/lang/String;)V

    iget-object v10, v0, jO:Ljava/util/Map;

    sget-object v13, Lcom/android/server/power/OnePlusStandbyAnalyzer$DIAGNOSIS_DATA_TYPE;->yxa:Lcom/android/server/power/OnePlusStandbyAnalyzer$DIAGNOSIS_DATA_TYPE;
    ...
    iget-object v3, v0, jO:Ljava/util/Map;

    sget-object v10, Lcom/android/server/power/OnePlusStandbyAnalyzer$DIAGNOSIS_DATA_TYPE;->Cxa:Lcom/android/server/power/OnePlusStandbyAnalyzer$DIAGNOSIS_DATA_TYPE;
    ...
    sget-object v10, Lcom/android/server/power/OnePlusStandbyAnalyzer$DIAGNOSIS_DATA_TYPE;->Dxa:Lcom/android/server/power/OnePlusStandbyAnalyzer$DIAGNOSIS_DATA_TYPE;
    ...
    sget-object v10, Lcom/android/server/power/OnePlusStandbyAnalyzer$DIAGNOSIS_DATA_TYPE;->Exa:Lcom/android/server/power/OnePlusStandbyAnalyzer$DIAGNOSIS_DATA_TYPE;
    ...
    sget-object v10, Lcom/android/server/power/OnePlusStandbyAnalyzer$DIAGNOSIS_DATA_TYPE;->Fxa:Lcom/android/server/power/OnePlusStandbyAnalyzer$DIAGNOSIS_DATA_TYPE;
    ...
    sget-object v14, Lcom/android/server/power/OnePlusStandbyAnalyzer$DIAGNOSIS_DATA_TYPE;->Gxa:Lcom/android/server/power/OnePlusStandbyAnalyzer$DIAGNOSIS_DATA_TYPE;
    ...
    invoke-direct/range {p0 .. p0}, Xp()Ljava/lang/String;
    ...
    iget-object v14, v0, jO:Ljava/util/Map;

    move-object/from16 v26, v6

    sget-object v6, Lcom/android/server/power/OnePlusStandbyAnalyzer$DIAGNOSIS_DATA_TYPE;->Ixa:Lcom/android/server/power/OnePlusStandbyAnalyzer$DIAGNOSIS_DATA_TYPE;
    ...
    iget-object v6, v0, jO:Ljava/util/Map;

    sget-object v8, Lcom/android/server/power/OnePlusStandbyAnalyzer$DIAGNOSIS_DATA_TYPE;->exa:Lcom/android/server/power/OnePlusStandbyAnalyzer$DIAGNOSIS_DATA_TYPE;

    move-object/from16 v30, v10

    move v14, v11

    iget-wide v10, v0, gQ:J
    ...
    iget-object v6, v0, jQ:Lcom/android/internal/os/BatterySipper;

    if-eqz v6, :cond_8

    iget-wide v10, v0, lQ:D
    ...
    iget-object v14, v0, jQ:Lcom/android/internal/os/BatterySipper;
    ...
    sget-object v14, Lcom/android/server/power/OnePlusStandbyAnalyzer$DIAGNOSIS_DATA_TYPE;->Hxa:Lcom/android/server/power/OnePlusStandbyAnalyzer$DIAGNOSIS_DATA_TYPE;
    ...
    sget-object v10, Lcom/android/server/power/OnePlusStandbyAnalyzer$DIAGNOSIS_DATA_TYPE;->Hxa:Lcom/android/server/power/OnePlusStandbyAnalyzer$DIAGNOSIS_DATA_TYPE;
    ...
    sget-object v14, Lcom/android/server/power/OnePlusStandbyAnalyzer$DIAGNOSIS_DATA_TYPE;->zxa:Lcom/android/server/power/OnePlusStandbyAnalyzer$DIAGNOSIS_DATA_TYPE;

    const-string v15, "1"

    invoke-interface {v6, v14, v15}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    invoke-direct/range {p0 .. p0}, _p()V

    iget-boolean v6, v0, rO:Z

    const-string v14, ";"

    if-eqz v6, :cond_e

    sget-object v1, Lcom/android/server/power/kth;->qN:[I

    iget-object v2, v0, sO:Lcom/android/server/power/OnePlusStandbyAnalyzer$TRIGGER_QXDM_REASON;
    ...
    :cond_9
    sget-object v8, Lcom/android/server/power/OnePlusStandbyAnalyzer$BATTERY_OUTLIER_TYPE;->Xwa:Lcom/android/server/power/OnePlusStandbyAnalyzer$BATTERY_OUTLIER_TYPE;
    ...
    sget-object v1, Lcom/android/server/power/OnePlusStandbyAnalyzer$BATTERY_OUTLIER_TYPE;->Xwa:Lcom/android/server/power/OnePlusStandbyAnalyzer$BATTERY_OUTLIER_TYPE;
    ...
    sget-object v1, Lcom/android/server/power/kth;->kN:[I
    ...
    :cond_b
    sget-object v8, Lcom/android/server/power/OnePlusStandbyAnalyzer$BATTERY_OUTLIER_TYPE;->bxa:Lcom/android/server/power/OnePlusStandbyAnalyzer$BATTERY_OUTLIER_TYPE;

    goto :goto_6

    :cond_c
    sget-object v8, Lcom/android/server/power/OnePlusStandbyAnalyzer$BATTERY_OUTLIER_TYPE;->Zwa:Lcom/android/server/power/OnePlusStandbyAnalyzer$BATTERY_OUTLIER_TYPE;
    ...
    invoke-virtual {v5}, Lcom/android/server/power/OnePlusStandbyAnalyzer$qbh;->Hd()Ljava/lang/String;
    ...
    :cond_e
    iget-boolean v6, v0, yO:Z

    if-nez v6, :cond_f

    iget-boolean v6, v0, MP:Z

    if-nez v6, :cond_f

    sget-object v8, Lcom/android/server/power/OnePlusStandbyAnalyzer$BATTERY_OUTLIER_TYPE;->Iwa:Lcom/android/server/power/OnePlusStandbyAnalyzer$BATTERY_OUTLIER_TYPE;
    ...
    iget-object v1, v0, jO:Ljava/util/Map;

    sget-object v2, Lcom/android/server/power/OnePlusStandbyAnalyzer$DIAGNOSIS_DATA_TYPE;->zxa:Lcom/android/server/power/OnePlusStandbyAnalyzer$DIAGNOSIS_DATA_TYPE;

    const-string v3, "0"

    invoke-interface {v1, v2, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/android/server/power/OnePlusStandbyAnalyzer$MDM_FIXED_TYPE;->Gya:Lcom/android/server/power/OnePlusStandbyAnalyzer$MDM_FIXED_TYPE;
    ...
    sget-object v8, Lcom/android/server/power/OnePlusStandbyAnalyzer$BATTERY_OUTLIER_TYPE;->Lwa:Lcom/android/server/power/OnePlusStandbyAnalyzer$BATTERY_OUTLIER_TYPE;
    ...
    iget-object v1, v0, qP:Ljava/util/List;
    ...
    sget-object v3, Lcom/android/server/power/OnePlusStandbyAnalyzer$MDM_FIXED_TYPE;->Hya:Lcom/android/server/power/OnePlusStandbyAnalyzer$MDM_FIXED_TYPE;

    invoke-virtual {v3}, Ljava/lang/Enum;->toString()Ljava/lang/String;

    move-result-object v3

    sget-object v4, Lcom/android/server/power/kth;->rN:[I
    ...
    :goto_c
    iget-object v2, v0, qP:Ljava/util/List;
    ...
    iget-object v2, v0, CP:Ljava/util/List;
    ...
    iget-object v4, v0, CP:Ljava/util/List;
    ...
    :cond_13
    iget-object v2, v0, FP:Ljava/util/List;
    ...
    invoke-virtual {v2}, Lcom/android/server/power/OnePlusStandbyAnalyzer$oif;->Ad()Ljava/lang/String;
    ...
    :cond_15
    :goto_e
    iget-object v2, v0, gP:Ljava/util/List;
    ...
    sget-object v8, Lcom/android/server/power/OnePlusStandbyAnalyzer$BATTERY_OUTLIER_TYPE;->Mwa:Lcom/android/server/power/OnePlusStandbyAnalyzer$BATTERY_OUTLIER_TYPE;
    ...
    sget-object v1, Lcom/android/server/power/OnePlusStandbyAnalyzer$MDM_FIXED_TYPE;->Jya:Lcom/android/server/power/OnePlusStandbyAnalyzer$MDM_FIXED_TYPE;
    ...
    invoke-direct {v0, v2}, gck(Ljava/util/List;)Z
    ...
    sget-object v2, Lcom/android/server/power/OnePlusStandbyAnalyzer$BATTERY_OUTLIER_TYPE;->Owa:Lcom/android/server/power/OnePlusStandbyAnalyzer$BATTERY_OUTLIER_TYPE;
    ...
    sget-object v3, Lcom/android/server/power/OnePlusStandbyAnalyzer$MDM_FIXED_TYPE;->Lya:Lcom/android/server/power/OnePlusStandbyAnalyzer$MDM_FIXED_TYPE;
    ...
    sget-object v1, Lcom/android/server/power/OnePlusStandbyAnalyzer$BATTERY_OUTLIER_TYPE;->Nwa:Lcom/android/server/power/OnePlusStandbyAnalyzer$BATTERY_OUTLIER_TYPE;
    ...
    iget v6, v5, Lcom/android/server/power/OnePlusStandbyAnalyzer$qbh;->dO:I
    ...
    sget-object v7, Lcom/android/server/power/OnePlusStandbyAnalyzer$MDM_FIXED_TYPE;->Lya:Lcom/android/server/power/OnePlusStandbyAnalyzer$MDM_FIXED_TYPE;
    ...
    iget v1, v5, Lcom/android/server/power/OnePlusStandbyAnalyzer$qbh;->dO:I
    ...
    :cond_21
    sget-object v8, Lcom/android/server/power/OnePlusStandbyAnalyzer$BATTERY_OUTLIER_TYPE;->axa:Lcom/android/server/power/OnePlusStandbyAnalyzer$BATTERY_OUTLIER_TYPE;
    ...
    sget-object v8, Lcom/android/server/power/OnePlusStandbyAnalyzer$BATTERY_OUTLIER_TYPE;->Ywa:Lcom/android/server/power/OnePlusStandbyAnalyzer$BATTERY_OUTLIER_TYPE;
    ...
    sget-object v1, Lcom/android/server/power/OnePlusStandbyAnalyzer$MDM_FIXED_TYPE;->Kya:Lcom/android/server/power/OnePlusStandbyAnalyzer$MDM_FIXED_TYPE;
    ...
    sget-object v1, Lcom/android/server/power/OnePlusStandbyAnalyzer$MDM_FIXED_TYPE;->Mya:Lcom/android/server/power/OnePlusStandbyAnalyzer$MDM_FIXED_TYPE;
    ...
    sget-object v8, Lcom/android/server/power/OnePlusStandbyAnalyzer$BATTERY_OUTLIER_TYPE;->Jwa:Lcom/android/server/power/OnePlusStandbyAnalyzer$BATTERY_OUTLIER_TYPE;
    ...
    iget-object v1, v0, cP:Ljava/util/List;
    ...
    iget-object v2, v0, kQ:Ljava/util/List;
    ...
    :goto_18
    iget-object v3, v0, kQ:Ljava/util/List;
    ...
    :goto_19
    iget-object v4, v0, kQ:Ljava/util/List;
    ...
    iget-object v1, v0, kQ:Ljava/util/List;
    ...
    invoke-direct {v0, v2, v1}, you(Ljava/lang/String;Lcom/android/internal/os/BatterySipper;)Ljava/lang/String;
    ...
    invoke-direct {v0, v1, v4}, you(Ljava/lang/String;Lcom/android/internal/os/BatterySipper;)Ljava/lang/String;
    ...
    :cond_2b
    :goto_1b
    invoke-direct {v0, v4}, zta(Lcom/android/internal/os/BatterySipper;)Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lcom/android/server/power/OnePlusStandbyAnalyzer$bio;->Ad()Ljava/lang/String;
    ...
    invoke-virtual {v3}, Lcom/android/server/power/OnePlusStandbyAnalyzer$bio;->Bd()Ljava/lang/String;
    ...
    iget-object v6, v1, Lcom/android/server/power/OnePlusStandbyAnalyzer$bio;->MN:Ljava/lang/String;

    iget-object v1, v0, LP:Ljava/util/List;
    ...
    invoke-virtual {v3}, Lcom/android/server/power/OnePlusStandbyAnalyzer$bio;->Ad()Ljava/lang/String;

    move-result-object v3

    invoke-interface {v2, v3}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    iget-object v3, v0, VO:Lcom/android/server/power/you;
    ...
    iput-object v2, v0, lO:Ljava/lang/String;

    invoke-direct/range {p0 .. p0}, Zp()Z
    ...
    sget-object v8, Lcom/android/server/power/OnePlusStandbyAnalyzer$BATTERY_OUTLIER_TYPE;->Kwa:Lcom/android/server/power/OnePlusStandbyAnalyzer$BATTERY_OUTLIER_TYPE;
    ...
    iget-object v1, v0, gP:Ljava/util/List;

    if-eqz v1, :cond_37

    invoke-direct {v0, v1}, obl(Ljava/util/List;)Lcom/android/server/power/OnePlusStandbyAnalyzer$sis;
    ...
    :cond_30
    iget-object v2, v0, JP:Ljava/util/List;
    ...
    :goto_20
    sget-object v3, Lcom/android/server/power/OnePlusStandbyAnalyzer$MDM_FIXED_TYPE;->Iya:Lcom/android/server/power/OnePlusStandbyAnalyzer$MDM_FIXED_TYPE;
    ...
    invoke-virtual/range {v16 .. v16}, Lcom/android/server/power/OnePlusStandbyAnalyzer$kth;->Ad()Ljava/lang/String;
    ...
    iget-object v1, v0, VO:Lcom/android/server/power/you;
    ...
    iput-object v1, v0, lO:Ljava/lang/String;
    ...
    iget-boolean v1, v0, WO:Z

    if-eqz v1, :cond_3a

    iget-boolean v1, v0, iO:Z
    ...
    iget-object v3, v0, mOpDeviceManagerInjector:Lnet/oneplus/odm/OpDeviceManagerInjector;

    if-eqz v3, :cond_3a

    iget-object v0, v0, mDeviceIdleController:Lcom/android/server/DeviceIdleController;
...
.method private Zp()Z
    ...
    iget-object v0, p0, cP:Ljava/util/List;
    ...
    :goto_0
    iget-object v6, p0, cP:Ljava/util/List;
    ...
    iget-object v7, p0, cP:Ljava/util/List;
    ...
    invoke-virtual {v7}, Lcom/android/server/power/OnePlusStandbyAnalyzer$bio;->Bd()Ljava/lang/String;
    ...
    iget-object v6, p0, LP:Ljava/util/List;
    ...
    iget-object v7, v7, Lcom/android/server/power/OnePlusStandbyAnalyzer$bio;->MN:Ljava/lang/String;
    ...
    iget-object v3, p0, cP:Ljava/util/List;
...
.method private _p()V
    ...
    :cond_0
    iget-object v3, p0, mDeviceIdleController:Lcom/android/server/DeviceIdleController;
    ...
    iget-object v4, p0, cP:Ljava/util/List;
    ...
    invoke-direct {p0, v3}, tc(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v4}, Lcom/android/server/power/OnePlusStandbyAnalyzer$KnownUIDs;->va(I)Lcom/android/server/power/OnePlusStandbyAnalyzer$KnownUIDs;
    ...
    invoke-virtual {v4, v3}, Lcom/android/server/power/OnePlusStandbyAnalyzer$bio;->V(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_2
    :goto_1
    iget-object v0, p0, FP:Ljava/util/List;
    ...
    :goto_2
    iget-object v3, p0, FP:Ljava/util/List;
    ...
    iget-object v4, p0, FP:Ljava/util/List;
    ...
    invoke-virtual {v4, v3}, Lcom/android/server/power/OnePlusStandbyAnalyzer$oif;->V(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_5
    :goto_3
    iget-object v0, p0, JP:Ljava/util/List;
    ...
    :cond_6
    iget-object v0, p0, mDeviceIdleController:Lcom/android/server/DeviceIdleController;
    ...
    iget-object v3, p0, JP:Ljava/util/List;
    ...
    invoke-direct {p0, v0}, tc(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3}, Lcom/android/server/power/OnePlusStandbyAnalyzer$KnownUIDs;->va(I)Lcom/android/server/power/OnePlusStandbyAnalyzer$KnownUIDs;
    ...
    invoke-virtual {v3, v0}, Lcom/android/server/power/OnePlusStandbyAnalyzer$kth;->V(Ljava/lang/String;)Ljava/lang/String;
...
.method static synthetic access$200()Ljava/lang/String;
    ...
    sget-object v0, KQ:Ljava/lang/String;
...
.method private aq()V
    ...
    iput-object v0, p0, mQ:Landroid/content/IntentFilter;
    ...
    iget-object v1, p0, nQ:Lcom/android/server/power/OnePlusStandbyAnalyzer$gck;

    iget-object p0, p0, mQ:Landroid/content/IntentFilter;
...
.method private bq()V
    ...
    iput-object v0, p0, zP:Ljava/util/List;
    ...
    iget-object v4, p0, zP:Ljava/util/List;
...
.method private bvj(Ljava/io/PrintWriter;)V
    ...
    iget-object p0, p0, kO:Ljava/lang/String;
...
.method private static cjf(Ljava/util/List;)Ljava/util/List;
    ...
    :cond_0
    invoke-static {v6}, isSystemUid(I)Z
...
.method private cq()V
    ...
    iget-object p0, p0, mDeviceIdleController:Lcom/android/server/DeviceIdleController;
...
.method private dma(Ljava/io/PrintWriter;)V
    ...
    sget-object v1, Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_S_TYPE;->cxa:Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_S_TYPE;
    ...
    sget-object v4, Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_S_TYPE;->dxa:Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_S_TYPE;
    ...
    sget-object v4, Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_S_TYPE;->exa:Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_S_TYPE;
    ...
    sget-object v4, Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_S_TYPE;->fxa:Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_S_TYPE;
    ...
    sget-object v4, Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_S_TYPE;->gxa:Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_S_TYPE;
    ...
    sget-object v4, Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_S_TYPE;->hxa:Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_S_TYPE;
    ...
    sget-object v2, Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_S_TYPE;->ixa:Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_S_TYPE;
    ...
    sget-object v2, Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_S_TYPE;->jxa:Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_S_TYPE;
    ...
    sget-object v2, Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_S_TYPE;->kxa:Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_S_TYPE;
    ...
    sget-object v0, Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_S_TYPE;->lxa:Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_S_TYPE;
...
.method private dma(Ljava/util/List;)Z
    ...
    invoke-virtual {v1}, Lcom/android/server/power/OnePlusStandbyAnalyzer$igw;->Ed()Z
...
.method private gck(Ljava/io/PrintWriter;)V
    ...
    iget-object p0, p0, lO:Ljava/lang/String;
...
.method private gck(Ljava/util/List;)Z
    ...
    invoke-virtual {v1}, Lcom/android/server/power/OnePlusStandbyAnalyzer$igw;->Fd()Z
...
.method private gwm(Ljava/io/PrintWriter;)V
    ...
    :goto_0
    iget-object v1, p0, cP:Ljava/util/List;
...
.method private ibl(Ljava/io/PrintWriter;)V
    ...
    invoke-virtual {v1}, Lcom/android/server/power/OnePlusStandbyAnalyzer$qbh;->Hd()Ljava/lang/String;
...
.method private ibl(Ljava/util/List;)V
    ...
    invoke-virtual {v2}, Lcom/android/server/power/OnePlusStandbyAnalyzer$bio;->Bd()Ljava/lang/String;
...
.method private kth(Lorg/json/JSONArray;)V
    ...
    iput-boolean v6, p0, AO:Z

    iget-boolean v6, p0, AO:Z

    invoke-virtual {p0, v6}, k(Z)V

    sget-boolean v6, DEBUG_ONEPLUS:Z
    ...
    sget-object v8, Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;->Jwa:Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;

    invoke-virtual {p0, v8, v6}, zta(Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;F)V

    sget-boolean v8, DEBUG_ONEPLUS:Z
    ...
    sget-object v8, Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;->mxa:Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;
    ...
    sget-object v8, Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;->Kwa:Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;
    ...
    sget-object v8, Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;->nxa:Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;
    ...
    sget-object v8, Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;->Lwa:Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;

    int-to-float v9, v6

    invoke-virtual {p0, v8, v9}, zta(Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;F)V
    ...
    sget-object v8, Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;->oxa:Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;
    ...
    sget-object v8, Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;->Mwa:Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;
    ...
    sget-object v8, Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;->pxa:Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;
    ...
    sget-object v8, Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;->vxa:Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;
    ...
    sget-object v8, Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;->wxa:Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;
    ...
    sget-object v8, Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;->Nwa:Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;
    ...
    sget-object v8, Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;->qxa:Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;
    ...
    sget-object v8, Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;->rxa:Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;
    ...
    sget-object v8, Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;->sxa:Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;
    ...
    sget-object v8, Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;->txa:Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;
    ...
    sget-object v8, Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;->uxa:Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;
    ...
    invoke-virtual {p0, v8, v9}, ire(J)V
    ...
    invoke-virtual {p0, v8, v9}, ear(J)V
    ...
    invoke-virtual {p0, v8, v9}, hmo(J)V
    ...
    iput-boolean v5, p0, AO:Z

    iget-boolean v5, p0, AO:Z

    invoke-virtual {p0, v5}, k(Z)V

    :cond_1e
    sget-boolean v5, DEBUG_ONEPLUS:Z
...
.method private obl(Ljava/util/List;)Lcom/android/server/power/OnePlusStandbyAnalyzer$sis;
    ...
    iget-object v3, p0, KP:Ljava/util/List;
...
.method private oif(Ljava/io/PrintWriter;)V
    ...
    :goto_0
    iget-object v1, p0, JP:Ljava/util/List;
...
.method private oxb(Ljava/util/List;)Lcom/android/server/power/OnePlusStandbyAnalyzer$qbh;
    ...
    sget-object v1, Lcom/android/server/power/OnePlusStandbyAnalyzer$TELEPHONY_TYPE;->qza:Lcom/android/server/power/OnePlusStandbyAnalyzer$TELEPHONY_TYPE;
    ...
    sget-object v1, Lcom/android/server/power/OnePlusStandbyAnalyzer$TELEPHONY_TYPE;->rza:Lcom/android/server/power/OnePlusStandbyAnalyzer$TELEPHONY_TYPE;
...
.method private qbh(Ljava/io/PrintWriter;)V
    ...
    iget-object v0, p0, gP:Ljava/util/List;
    ...
    :goto_0
    iget-object v2, p0, gP:Ljava/util/List;
...
.method private sis(Lcom/android/internal/os/BatterySipper;Lcom/android/internal/os/BatterySipper;)V
    ...
    invoke-direct {p0, v0, p1}, you(Ljava/lang/String;Lcom/android/internal/os/BatterySipper;)Ljava/lang/String;

    const-string p1, "Abn-End"

    invoke-direct {p0, p1, p2}, you(Ljava/lang/String;Lcom/android/internal/os/BatterySipper;)Ljava/lang/String;
...
.method private sis(Ljava/lang/String;Ljava/util/List;Z)V
    ...
    :cond_0
    invoke-direct {p0, p1, v4}, you(Ljava/lang/String;Lcom/android/internal/os/BatterySipper;)Ljava/lang/String;
...
.method private sis(Ljava/util/Map;Ljava/util/Map;)V
    ...
    iput-object v0, p0, FP:Ljava/util/List;
    ...
    :goto_1
    iget-object v5, p0, FP:Ljava/util/List;
    ...
    :cond_1
    iget-object p1, p0, FP:Ljava/util/List;

    iget-object p0, p0, rQ:Ljava/util/Comparator;
...
.method static synthetic ssp(Lcom/android/server/power/OnePlusStandbyAnalyzer;Z)Z
    ...
    iput-boolean p1, p0, rO:Z

    return p1
.end method

.method private tc(Ljava/lang/String;)Ljava/lang/String;
    .locals 2
...
.method private tsu(Ljava/util/Map;Ljava/util/Map;)V
    ...
    iput-object v0, p0, CP:Ljava/util/List;
    ...
    :cond_1
    iget-object p1, p0, CP:Ljava/util/List;

    iget-object p0, p0, tQ:Ljava/util/Comparator;
...
.method private ugm(Ljava/io/PrintWriter;)V
    ...
    iget-object v0, p0, qP:Ljava/util/List;
    ...
    :goto_0
    iget-object v1, p0, qP:Ljava/util/List;
...
.method private vdb(Ljava/util/List;)Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lcom/android/server/power/OnePlusStandbyAnalyzer$wtn;->Gd()Ljava/lang/String;
...
.method static synthetic you(Lcom/android/server/power/OnePlusStandbyAnalyzer;)Lcom/android/server/power/OnePlusStandbyAnalyzer$ssp;
    ...
    iget-object p0, p0, pQ:Lcom/android/server/power/OnePlusStandbyAnalyzer$ssp;
...
.method private you(Ljava/lang/String;Lcom/android/internal/os/BatterySipper;)Ljava/lang/String;
    ...
    iget-object p1, p0, mDeviceIdleController:Lcom/android/server/DeviceIdleController;
    ...
    iget-object p1, p0, mBatteryStatsHelper:Lcom/android/internal/os/BatteryStatsHelper;
    ...
    iget-object p0, p0, mBatteryStatsHelper:Lcom/android/internal/os/BatteryStatsHelper;
...
.method private you(Ljava/util/Map;Ljava/util/Map;)V
    ...
    :goto_1
    iget-object v10, p0, cP:Ljava/util/List;
...
.method private ywr(Ljava/io/PrintWriter;)V
    ...
    iget-object v0, p0, jO:Ljava/util/Map;
    ...
    iget-object v4, p0, jO:Ljava/util/Map;
...
.method private zta(Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MASTER_TYPE;)J
    ...
    :goto_0
    iget-object v3, p0, yP:Ljava/util/List;
    ...
    iget-wide v3, v3, Lcom/android/server/power/OnePlusStandbyAnalyzer$wtn;->UN:J

    cmp-long v3, v0, v3

    if-gez v3, :cond_1

    iget-object v0, p0, yP:Ljava/util/List;
    ...
    iget-wide v0, v0, Lcom/android/server/power/OnePlusStandbyAnalyzer$wtn;->UN:J
...
.method static synthetic zta(Lcom/android/server/power/OnePlusStandbyAnalyzer;Lcom/android/server/power/OnePlusStandbyAnalyzer$TRIGGER_QXDM_REASON;)Lcom/android/server/power/OnePlusStandbyAnalyzer$TRIGGER_QXDM_REASON;
    ...
    iput-object p1, p0, sO:Lcom/android/server/power/OnePlusStandbyAnalyzer$TRIGGER_QXDM_REASON;
...
.method static synthetic zta(Lcom/android/server/power/OnePlusStandbyAnalyzer;Landroid/telephony/ServiceState;)V
    ...
    invoke-direct {p0, p1}, zta(Landroid/telephony/ServiceState;)V
...
.method static synthetic zta(Lcom/android/server/power/OnePlusStandbyAnalyzer;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2}, ear(Ljava/lang/String;Ljava/lang/String;)V
...
.method static synthetic zta(Lcom/android/server/power/OnePlusStandbyAnalyzer;Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-direct {p0, p1, p2}, sis(Ljava/lang/String;Ljava/util/List;)V
...
.method static synthetic zta(Lcom/android/server/power/OnePlusStandbyAnalyzer;Ljava/lang/String;Ljava/util/List;Z)V
    ...
    invoke-direct {p0, p1, p2, p3}, sis(Ljava/lang/String;Ljava/util/List;Z)V
...
.method static synthetic zta(Lcom/android/server/power/OnePlusStandbyAnalyzer;Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-direct {p0, p1, p2}, sis(Ljava/lang/String;Ljava/util/Map;)V
...
.method static synthetic zta(Lcom/android/server/power/OnePlusStandbyAnalyzer;Ljava/lang/String;Ljava/util/Map;Z)V
    ...
    invoke-direct {p0, p1, p2, p3}, you(Ljava/lang/String;Ljava/util/Map;Z)V
...
.method static synthetic zta(Lcom/android/server/power/OnePlusStandbyAnalyzer;Lorg/json/JSONArray;)V
    ...
    invoke-direct {p0, p1}, kth(Lorg/json/JSONArray;)V
...
.method private zta(Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-direct {p0, p2}, ywr(Ljava/util/List;)Ljava/util/List;

    move-result-object v0

    iput-object v0, p0, kQ:Ljava/util/List;

    const/4 v0, 0x0

    iput-object v0, p0, jQ:Lcom/android/internal/os/BatterySipper;

    const-wide/16 v0, 0x0

    iput-wide v0, p0, lQ:D
    ...
    iget-object p2, p0, kQ:Ljava/util/List;
    ...
    :goto_0
    iget-object v2, p0, kQ:Ljava/util/List;
    ...
    iput-object v2, p0, jQ:Lcom/android/internal/os/BatterySipper;
    ...
    invoke-direct {p0, v2, v4}, you(Lcom/android/internal/os/BatterySipper;Lcom/android/internal/os/BatterySipper;)Z

    move-result v5

    if-eqz v5, :cond_1

    invoke-direct {p0, v4, v2}, sis(Lcom/android/internal/os/BatterySipper;Lcom/android/internal/os/BatterySipper;)V
    ...
    invoke-direct {p0, v3, v2}, you(Ljava/lang/String;Lcom/android/internal/os/BatterySipper;)Ljava/lang/String;

    :cond_3
    iget-wide v3, p0, lQ:D

    iget-wide v5, v2, Lcom/android/internal/os/BatterySipper;->totalPowerMah:D

    add-double/2addr v3, v5

    iput-wide v3, p0, lQ:D
    ...
    :cond_4
    iget-object p1, p0, kQ:Ljava/util/List;
...
.method private zta(Ljava/util/Map;Ljava/util/Map;)V
    ...
    iput-object v0, p0, xP:Ljava/util/List;
    ...
    :goto_1
    iget-object v4, p0, xP:Ljava/util/List;
...
.method public Ld()V
    ...
    :try_start_0
    iget-object v2, p0, OB:Lcom/oneplus/os/IOnePlusExService;

    if-eqz v2, :cond_0

    iget-object p0, p0, OB:Lcom/oneplus/os/IOnePlusExService;
...
.method public Qd()J
    ...
    iget-wide v0, p0, tO:J

    return-wide v0
.end method

.method public declared-synchronized Rd()Z
    .locals 1

    monitor-enter p0

    :try_start_0
    iget-boolean v0, p0, qO:Z
    :try_end_0
...
.method public Wd()V
    ...
    iget-wide v2, p0, hP:J

    sub-long/2addr v0, v2

    iget-wide v2, p0, vO:J
    ...
    sget-object v0, Lcom/android/server/power/OnePlusStandbyAnalyzer$SNAPSHOT_TYPE;->iza:Lcom/android/server/power/OnePlusStandbyAnalyzer$SNAPSHOT_TYPE;

    sget-object v1, WQ:Ljava/lang/String;

    invoke-virtual {p0, v0, v1}, zta(Lcom/android/server/power/OnePlusStandbyAnalyzer$SNAPSHOT_TYPE;Ljava/lang/String;)V

    sget-object v0, Lcom/android/server/power/OnePlusStandbyAnalyzer$SNAPSHOT_TYPE;->iza:Lcom/android/server/power/OnePlusStandbyAnalyzer$SNAPSHOT_TYPE;

    sget-object v1, YQ:Ljava/lang/String;

    invoke-virtual {p0, v0, v1}, you(Lcom/android/server/power/OnePlusStandbyAnalyzer$SNAPSHOT_TYPE;Ljava/lang/String;)V

    iget-object v0, p0, xP:Ljava/util/List;

    invoke-direct {p0, v0}, gck(Ljava/util/List;)Z
    ...
    invoke-direct {p0}, Xp()Ljava/lang/String;
    ...
    sget-object v1, Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MASTER_TYPE;->Yya:Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MASTER_TYPE;
    ...
    sget-object v1, Lcom/android/server/power/OnePlusStandbyAnalyzer$TELEPHONY_TYPE;->mza:Lcom/android/server/power/OnePlusStandbyAnalyzer$TELEPHONY_TYPE;

    sget-object v2, Lcom/android/server/power/OnePlusStandbyAnalyzer$QXDM_REASON;->Oya:Lcom/android/server/power/OnePlusStandbyAnalyzer$QXDM_REASON;

    const/4 v3, 0x0

    invoke-virtual {p0, v0, v1, v2, v3}, zta(ZLcom/android/server/power/OnePlusStandbyAnalyzer$TELEPHONY_TYPE;Lcom/android/server/power/OnePlusStandbyAnalyzer$QXDM_REASON;Z)V
...
.method public checkIfHitBatteryLowLocked(Landroid/content/Intent;)V
    ...
    iput p1, p0, mCurrentBatteryLevel:I

    iget p1, p0, mCurrentBatteryLevel:I
    ...
    iget-boolean p1, p0, mScreenOn:Z

    if-nez p1, :cond_4

    iget-boolean p1, p0, m1stLightIdle:Z

    if-eqz p1, :cond_4

    iget-boolean p1, p0, IO:Z

    if-eqz p1, :cond_1

    iget-wide v2, p0, JO:J
    ...
    invoke-virtual {p0, p1}, leavingDeepIdleLocked(Z)V
...
.method public dumpStandbyStats(Ljava/io/PrintWriter;)V
    ...
    invoke-direct {p0, p1}, dma(Ljava/io/PrintWriter;)V

    invoke-direct {p0, p1}, ywr(Ljava/io/PrintWriter;)V

    invoke-direct {p0, p1}, gwm(Ljava/io/PrintWriter;)V

    invoke-direct {p0, p1}, qbh(Ljava/io/PrintWriter;)V

    invoke-direct {p0, p1}, ugm(Ljava/io/PrintWriter;)V

    invoke-virtual {p0, p1}, rtg(Ljava/io/PrintWriter;)V

    invoke-direct {p0, p1}, vdb(Ljava/io/PrintWriter;)V

    invoke-direct {p0, p1}, oif(Ljava/io/PrintWriter;)V

    invoke-direct {p0, p1}, gck(Ljava/io/PrintWriter;)V

    invoke-direct {p0, p1}, bvj(Ljava/io/PrintWriter;)V

    invoke-direct {p0, p1}, ibl(Ljava/io/PrintWriter;)V
...
.method public f(Z)V
    ...
    iput-boolean p1, p0, m1stLightIdle:Z
...
.method public gck(Ljava/lang/String;Ljava/lang/String;)Ljava/util/Map;
    ...
    iget-object p2, p0, XP:Ljava/util/regex/Pattern;
    ...
    sget-object v6, Lcom/android/server/power/OnePlusStandbyAnalyzer$WIFI_WAKEUP_TYPE;->sza:Lcom/android/server/power/OnePlusStandbyAnalyzer$WIFI_WAKEUP_TYPE;
    ...
    sget-object v6, Lcom/android/server/power/OnePlusStandbyAnalyzer$WIFI_WAKEUP_TYPE;->tza:Lcom/android/server/power/OnePlusStandbyAnalyzer$WIFI_WAKEUP_TYPE;
    ...
    sget-object v6, Lcom/android/server/power/OnePlusStandbyAnalyzer$WIFI_WAKEUP_TYPE;->uza:Lcom/android/server/power/OnePlusStandbyAnalyzer$WIFI_WAKEUP_TYPE;
    ...
    sget-object v6, Lcom/android/server/power/OnePlusStandbyAnalyzer$WIFI_WAKEUP_TYPE;->vza:Lcom/android/server/power/OnePlusStandbyAnalyzer$WIFI_WAKEUP_TYPE;
    ...
    sget-object v6, Lcom/android/server/power/OnePlusStandbyAnalyzer$WIFI_WAKEUP_TYPE;->wza:Lcom/android/server/power/OnePlusStandbyAnalyzer$WIFI_WAKEUP_TYPE;
    ...
    sget-object v6, Lcom/android/server/power/OnePlusStandbyAnalyzer$WIFI_WAKEUP_TYPE;->xza:Lcom/android/server/power/OnePlusStandbyAnalyzer$WIFI_WAKEUP_TYPE;
    ...
    sget-object v6, Lcom/android/server/power/OnePlusStandbyAnalyzer$WIFI_WAKEUP_TYPE;->yza:Lcom/android/server/power/OnePlusStandbyAnalyzer$WIFI_WAKEUP_TYPE;
    ...
    sget-object v6, Lcom/android/server/power/OnePlusStandbyAnalyzer$WIFI_WAKEUP_TYPE;->zza:Lcom/android/server/power/OnePlusStandbyAnalyzer$WIFI_WAKEUP_TYPE;
    ...
    sget-object v6, Lcom/android/server/power/OnePlusStandbyAnalyzer$WIFI_WAKEUP_TYPE;->Aza:Lcom/android/server/power/OnePlusStandbyAnalyzer$WIFI_WAKEUP_TYPE;
    ...
    sget-object v6, Lcom/android/server/power/OnePlusStandbyAnalyzer$WIFI_WAKEUP_TYPE;->Bza:Lcom/android/server/power/OnePlusStandbyAnalyzer$WIFI_WAKEUP_TYPE;
    ...
    sget-object v6, Lcom/android/server/power/OnePlusStandbyAnalyzer$WIFI_WAKEUP_TYPE;->Cza:Lcom/android/server/power/OnePlusStandbyAnalyzer$WIFI_WAKEUP_TYPE;
    ...
    sget-object v6, Lcom/android/server/power/OnePlusStandbyAnalyzer$WIFI_WAKEUP_TYPE;->Dza:Lcom/android/server/power/OnePlusStandbyAnalyzer$WIFI_WAKEUP_TYPE;
    ...
    sget-object v6, Lcom/android/server/power/OnePlusStandbyAnalyzer$WIFI_WAKEUP_TYPE;->Eza:Lcom/android/server/power/OnePlusStandbyAnalyzer$WIFI_WAKEUP_TYPE;
    ...
    sget-object v6, Lcom/android/server/power/OnePlusStandbyAnalyzer$WIFI_WAKEUP_TYPE;->Fza:Lcom/android/server/power/OnePlusStandbyAnalyzer$WIFI_WAKEUP_TYPE;
    ...
    sget-object v2, Lcom/android/server/power/OnePlusStandbyAnalyzer$WIFI_WAKEUP_TYPE;->Gza:Lcom/android/server/power/OnePlusStandbyAnalyzer$WIFI_WAKEUP_TYPE;
...
.method public declared-synchronized h(Z)V
    ...
    iget-object v1, p0, PO:Lcom/android/server/power/OnePlusStandbyAnalyzer$cno;
    ...
    sget-object p1, Lcom/android/server/power/OnePlusStandbyAnalyzer$QXDM_REASON;->Qya:Lcom/android/server/power/OnePlusStandbyAnalyzer$QXDM_REASON;

    goto :goto_0

    :cond_0
    sget-object p1, Lcom/android/server/power/OnePlusStandbyAnalyzer$QXDM_REASON;->Rya:Lcom/android/server/power/OnePlusStandbyAnalyzer$QXDM_REASON;

    :goto_0
    invoke-virtual {p0, v0, v1, p1, v0}, zta(ZLcom/android/server/power/OnePlusStandbyAnalyzer$TELEPHONY_TYPE;Lcom/android/server/power/OnePlusStandbyAnalyzer$QXDM_REASON;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized i(Z)V
    ...
    sget-object v2, Lcom/android/server/power/OnePlusStandbyAnalyzer$QXDM_REASON;->Nya:Lcom/android/server/power/OnePlusStandbyAnalyzer$QXDM_REASON;

    invoke-virtual {p0, v0, v1, v2, p1}, zta(ZLcom/android/server/power/OnePlusStandbyAnalyzer$TELEPHONY_TYPE;Lcom/android/server/power/OnePlusStandbyAnalyzer$QXDM_REASON;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public leavingDeepIdleLocked(Z)V
    ...
    iget-boolean v3, p0, m1stLightIdle:Z
    ...
    iget-wide v3, p0, JO:J

    goto :goto_1

    :cond_2
    iget-wide v3, p0, cO:J
    ...
    iget v3, p0, mCurrentBatteryLevel:I
    ...
    :cond_5
    invoke-virtual {p0, p1, v1, v2}, you(IJ)Z
...
.method public rtg(Ljava/io/PrintWriter;)V
    ...
    :goto_0
    iget-object v1, p0, FP:Ljava/util/List;
    ...
    invoke-virtual {v1}, Lcom/android/server/power/OnePlusStandbyAnalyzer$oif;->Ad()Ljava/lang/String;
...
.method public setInBatteryStatsService(Lcom/android/server/am/BatteryStatsService;)V
    ...
    iput-object p1, p0, mBatteryStatsService:Lcom/android/server/am/BatteryStatsService;
    ...
    iput-object p1, p0, VO:Lcom/android/server/power/you;
    ...
    iput-object p1, p0, mBatteryStatsHelper:Lcom/android/internal/os/BatteryStatsHelper;
    ...
    iput-object p1, p0, nQ:Lcom/android/server/power/OnePlusStandbyAnalyzer$gck;
    ...
    iput-object p1, p0, PO:Lcom/android/server/power/OnePlusStandbyAnalyzer$cno;

    invoke-direct {p0}, Up()V
    ...
    :cond_0
    iput-boolean v1, p0, NP:Z

    sget-object p1, XQ:Ljava/lang/String;

    sput-object p1, WQ:Ljava/lang/String;

    sget-object p1, ZQ:Ljava/lang/String;

    sput-object p1, YQ:Ljava/lang/String;

    sget-object p1, dR:Ljava/lang/String;

    sput-object p1, cR:Ljava/lang/String;

    :cond_1
    iget-object p1, p0, KP:Ljava/util/List;
    ...
    iget-object p1, p0, LP:Ljava/util/List;
    ...
    invoke-direct {p0}, Vp()V

    invoke-direct {p0}, aq()V

    invoke-direct {p0}, bq()V

    iput-boolean v1, p0, hO:Z
...
.method public shellCommand(Ljava/lang/String;Ljava/io/PrintWriter;Landroid/os/ShellCommand;)Z
    ...
    iput-boolean v10, v0, AO:Z

    iget-boolean v1, v0, AO:Z

    invoke-virtual {v0, v1}, k(Z)V
    ...
    sget-boolean v14, DEBUG_ONEPLUS:Z
    ...
    invoke-virtual/range {p0 .. p0}, Jd()Z

    move-result v1

    invoke-virtual/range {p0 .. p0}, Pd()Z

    move-result v3

    invoke-virtual/range {p0 .. p0}, Rd()Z

    move-result v7

    invoke-virtual/range {p0 .. p0}, Qd()J

    move-result-wide v8

    invoke-virtual/range {p0 .. p0}, Od()J

    move-result-wide v14

    invoke-virtual/range {p0 .. p0}, Sd()J

    move-result-wide v16

    invoke-virtual/range {p0 .. p0}, Md()J

    move-result-wide v18

    invoke-virtual/range {p0 .. p0}, Nd()J
    ...
    invoke-virtual {v0, v5, v6}, cjf(J)V
    ...
    :cond_13
    invoke-virtual {v0, v7, v8}, cjf(J)V
    ...
    :cond_15
    invoke-virtual {v0, v7, v8}, ire(J)V
    ...
    :cond_17
    invoke-virtual {v0, v7, v8}, ear(J)V
    ...
    :goto_7
    invoke-virtual {v0, v7, v8}, hmo(J)V
    :try_end_8
...
.method public wtn(Ljava/lang/String;Ljava/lang/String;)Ljava/util/Map;
    ...
    iget-boolean p2, p0, NP:Z

    if-eqz p2, :cond_1

    iget-object p2, p0, RP:Ljava/util/regex/Pattern;
    ...
    sget-object v5, Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MASTER_TYPE;->Yya:Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MASTER_TYPE;
    ...
    sget-object v1, Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MASTER_TYPE;->Xya:Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MASTER_TYPE;
...
.method public you(Ljava/util/Map;)Ljava/util/List;
    ...
    iget-object p0, p0, sQ:Ljava/util/Comparator;
...
.method public you(Lcom/android/server/power/OnePlusStandbyAnalyzer$SNAPSHOT_TYPE;IJJJJ)V
    ...
    iget-object v0, v0, HP:Ljava/util/Map;
    ...
    :cond_0
    iget-object v1, v0, HP:Ljava/util/Map;
...
.method public you(Lcom/android/server/power/OnePlusStandbyAnalyzer$SNAPSHOT_TYPE;Ljava/lang/String;)V
    ...
    iput-object v2, v0, yP:Ljava/util/List;
    ...
    iget-object v2, v0, WP:Ljava/util/Map;
    ...
    :cond_3
    sget-object v12, Lcom/android/server/power/OnePlusStandbyAnalyzer$SNAPSHOT_TYPE;->iza:Lcom/android/server/power/OnePlusStandbyAnalyzer$SNAPSHOT_TYPE;
    ...
    iget-object v8, v0, yP:Ljava/util/List;
    ...
    invoke-static {v8}, myLog(Ljava/lang/String;)V
...
.method public zta(Lcom/android/internal/os/BatteryStatsImpl;JLcom/android/server/power/OnePlusStandbyAnalyzer$SNAPSHOT_TYPE;)Ljava/util/Map;
    ...
    iput-object v2, v12, aP:Ljava/util/Map;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, v12, HP:Ljava/util/Map;

    goto :goto_0

    :cond_0
    iput-object v2, v12, bP:Ljava/util/Map;
    ...
    invoke-virtual/range {v1 .. v11}, you(Lcom/android/server/power/OnePlusStandbyAnalyzer$SNAPSHOT_TYPE;IJJJJ)V
    ...
    iput-object v14, v1, aP:Ljava/util/Map;

    goto :goto_7

    :cond_8
    iput-object v14, v1, bP:Ljava/util/Map;
...
.method public zta(Lcom/android/server/power/OnePlusStandbyAnalyzer$CRITERIA_TYPE;F)V
    ...
    sget-object p0, Lcom/android/server/power/kth;->mN:[I
...
.method public zta(Lcom/android/server/power/OnePlusStandbyAnalyzer$SNAPSHOT_TYPE;)V
    ...
    sget-object v0, Lcom/android/server/power/kth;->nN:[I
    ...
    :cond_0
    iget-object p1, p0, YO:Ljava/util/List;

    const-string v0, "End"

    if-eqz p1, :cond_1

    invoke-direct {p0, v0, p1, v1}, sis(Ljava/lang/String;Ljava/util/List;Z)V

    :cond_1
    iget-object p1, p0, bP:Ljava/util/Map;

    if-eqz p1, :cond_2

    const-string v2, "End-WL"

    invoke-direct {p0, v2, p1, v1}, you(Ljava/lang/String;Ljava/util/Map;Z)V

    :cond_2
    iget-object p1, p0, GP:Ljava/util/Map;

    if-eqz p1, :cond_3

    invoke-virtual {p0, v0, p1, v1}, zta(Ljava/lang/String;Ljava/util/Map;Z)V

    :cond_3
    iget-object p1, p0, vP:Ljava/util/List;

    if-eqz p1, :cond_4

    const-string v0, "End-Signal"

    invoke-direct {p0, v0, p1}, sis(Ljava/lang/String;Ljava/util/List;)V
    ...
    :cond_5
    iget-object p1, p0, XO:Ljava/util/List;
    ...
    :cond_6
    iget-object p1, p0, aP:Ljava/util/Map;
    ...
    :cond_7
    iget-object p1, p0, EP:Ljava/util/Map;
    ...
    :cond_8
    iget-object p1, p0, uP:Ljava/util/List;
    ...
    :goto_0
    invoke-direct {p0, v0, p1}, sis(Ljava/lang/String;Ljava/util/Map;)V
...
.method public zta(Lcom/android/server/power/OnePlusStandbyAnalyzer$SNAPSHOT_TYPE;Lcom/android/server/power/OnePlusStandbyAnalyzer$STATISTIC_TYPE;IFFJZ)V
    ...
    iget-object v10, v1, PO:Lcom/android/server/power/OnePlusStandbyAnalyzer$cno;
...
.method public zta(Lcom/android/server/power/OnePlusStandbyAnalyzer$SNAPSHOT_TYPE;Ljava/lang/String;)V
    ...
    iget-object p2, p0, QP:Ljava/util/regex/Pattern;
    ...
    :cond_2
    iget-object p2, p0, PP:Ljava/util/regex/Pattern;
    ...
    iget-boolean v7, p0, NP:Z

    if-eqz v7, :cond_3

    sget-object v7, Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MODE_TYPE;->eza:Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MODE_TYPE;

    goto :goto_2

    :cond_3
    sget-object v7, Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MODE_TYPE;->cza:Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MODE_TYPE;
    ...
    sget-object v7, Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MODE_TYPE;->fza:Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MODE_TYPE;

    goto :goto_3

    :cond_4
    sget-object v7, Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MODE_TYPE;->dza:Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MODE_TYPE;
    ...
    :cond_5
    sget-object v10, Lcom/android/server/power/OnePlusStandbyAnalyzer$SNAPSHOT_TYPE;->iza:Lcom/android/server/power/OnePlusStandbyAnalyzer$SNAPSHOT_TYPE;

    if-ne p1, v10, :cond_6

    iget-object v10, p0, xP:Ljava/util/List;
    ...
    iget-object v7, p0, xP:Ljava/util/List;
    ...
    iget-object v5, p0, xP:Ljava/util/List;
...
.method public zta(Ljava/lang/String;Ljava/util/Map;Z)V
    ...
    iget-object p2, p0, rQ:Ljava/util/Comparator;

    invoke-static {v0, p2}, Ljava/util/Collections;->sort(Ljava/util/List;Ljava/util/Comparator;)V

    invoke-direct {p0, p1, v0, p3}, tsu(Ljava/lang/String;Ljava/util/List;Z)V
...
.method public declared-synchronized zta(ZLcom/android/server/power/OnePlusStandbyAnalyzer$TELEPHONY_TYPE;Lcom/android/server/power/OnePlusStandbyAnalyzer$QXDM_REASON;Z)V
    ...
    :cond_0
    :try_start_1
    invoke-virtual {p0}, Jd()Z

    move-result v4

    if-eqz v4, :cond_e

    iget-boolean v5, p0, oO:Z

    if-eqz v5, :cond_e

    iget-boolean v5, p0, pO:Z
    ...
    iget-wide v6, p0, wO:J

    sub-long/2addr v4, v6

    iget-wide v6, p0, tO:J
    ...
    :cond_2
    :try_start_2
    iget-boolean v4, p0, rO:Z

    if-nez v4, :cond_c

    const/4 v4, 0x1

    iput-boolean v4, p0, rO:Z

    const-string v5, "it\'s time to enable 1st-QXDM-recording now under this round of standby period"

    invoke-static {v5}, myLog(Ljava/lang/String;)V

    sget-object v5, Lcom/android/server/power/kth;->lN:[I
    ...
    :cond_3
    sget-object p3, Lcom/android/server/power/OnePlusStandbyAnalyzer$TRIGGER_QXDM_REASON;->Oya:Lcom/android/server/power/OnePlusStandbyAnalyzer$TRIGGER_QXDM_REASON;

    :goto_0
    iput-object p3, p0, sO:Lcom/android/server/power/OnePlusStandbyAnalyzer$TRIGGER_QXDM_REASON;

    goto :goto_1

    :cond_4
    sget-object p3, Lcom/android/server/power/OnePlusStandbyAnalyzer$TRIGGER_QXDM_REASON;->Nya:Lcom/android/server/power/OnePlusStandbyAnalyzer$TRIGGER_QXDM_REASON;
    ...
    iget-object v6, p0, sO:Lcom/android/server/power/OnePlusStandbyAnalyzer$TRIGGER_QXDM_REASON;
    ...
    iput-boolean v4, p0, nO:Z

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J

    move-result-wide v6

    iput-wide v6, p0, wO:J

    iput v0, p0, xO:I

    sget-object p1, Lcom/android/server/power/kth;->kN:[I
    ...
    iget-object p1, p0, PO:Lcom/android/server/power/OnePlusStandbyAnalyzer$cno;
    ...
    invoke-direct {p0, v0}, Oa(Z)V

    const-string p1, "diag_mdlog_stop"

    invoke-static {p1}, Landroid/os/SystemService;->start(Ljava/lang/String;)V

    sget-object p1, Lcom/android/server/power/kth;->lN:[I
