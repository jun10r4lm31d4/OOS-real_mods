...
.field private static final Nf:Ljava/lang/String; = "ProcessManagement"

.field private static final RR:Z = false

.field private static final SR:Z = false
...
.field private static final WR:Ljava/lang/String; = "com.oppo.market"

.field public static XR:Lcom/android/server/OnePlusUtil$you; = null

.field private static final eg:I = 0x0

.field private static final gg:I = 0x2
...
.field private BR:Lcom/oneplus/config/ConfigObserver;
...
.field private final FR:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap<",
            "Ljava/lang/String;",
...
.field private final zR:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList<",
            "Ljava/lang/Integer;",
...
.method public constructor <init>()V
    ...
    iput-object v1, p0, zR:Ljava/util/ArrayList;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, FR:Ljava/util/HashMap;

    new-array v1, v0, [I

    iput-object v1, p0, GR:[I

    new-array v0, v0, [I

    iput-object v0, p0, Uf:[I

    const/4 v0, 0x0

    iput-object v0, p0, IR:Ljava/lang/String;

    const/4 v0, 0x1

    iput-boolean v0, p0, MR:Z
...
.method private bio(Lorg/json/JSONArray;)V
    ...
    iget-object v0, p0, AR:Ljava/util/List;
    ...
    iget-object v0, p0, ER:Ljava/util/List;
    ...
    iget-object v0, p0, OR:Ljava/util/List;
    ...
    iget-object v0, p0, QR:Ljava/util/List;
    ...
    iget-object p0, p0, JR:Ljava/util/List;
    ...
    iget-object v4, p0, AR:Ljava/util/List;
    ...
    :try_start_1
    iget-object v5, p0, AR:Ljava/util/List;
    ...
    iget-object v6, p0, AR:Ljava/util/List;
    ...
    iget-object v4, p0, ER:Ljava/util/List;
    ...
    :try_start_3
    iget-object v5, p0, ER:Ljava/util/List;
    ...
    iget-object v6, p0, ER:Ljava/util/List;
    ...
    :cond_3
    iget-object v3, p0, ER:Ljava/util/List;

    invoke-direct {p0, v3}, ear(Ljava/util/List;)V
    ...
    iget-object v4, p0, OR:Ljava/util/List;
    ...
    :try_start_5
    iget-object v5, p0, OR:Ljava/util/List;
    ...
    iget-object v6, p0, OR:Ljava/util/List;
    ...
    iget-object v4, p0, QR:Ljava/util/List;
    ...
    :try_start_7
    iget-object v5, p0, QR:Ljava/util/List;
    ...
    iget-object v6, p0, QR:Ljava/util/List;
    ...
    iget-object v4, p0, JR:Ljava/util/List;
    ...
    :try_start_9
    iget-object v5, p0, JR:Ljava/util/List;
    ...
    iget-object v6, p0, JR:Ljava/util/List;
    ...
    iget-object v3, p0, KR:Ljava/util/HashMap;
    ...
    invoke-direct {p0, v6, v8}, ire(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v1, p0, AR:Ljava/util/List;
    ...
    iget-object v1, p0, ER:Ljava/util/List;
    ...
    iget-object v1, p0, OR:Ljava/util/List;
    ...
    iget-object v1, p0, QR:Ljava/util/List;
...
.method private cno(Lcom/android/server/power/PowerManagerService$WakeLock;)Z
    ...
    iget-object p0, p0, FR:Ljava/util/HashMap;
...
.method private dq()[Ljava/lang/String;
    ...
    iget-object v0, p0, mPmsInner:Lcom/android/server/power/PowerManagerService$PmsInner;
    ...
    :goto_0
    invoke-direct {p0, v0}, _b(Ljava/lang/String;)[Ljava/lang/String;
...
.method private ear(Ljava/util/List;)V
    ...
    iget-object v0, p0, FR:Ljava/util/HashMap;
    ...
    iget-object v2, p0, FR:Ljava/util/HashMap;
    ...
    iget-object v3, p0, FR:Ljava/util/HashMap;
...
.method private eq()V
    ...
    invoke-direct {p0, v7}, lc(I)Z

    move-result v8

    if-eqz v8, :cond_0

    invoke-direct {p0, v4}, sis(Lcom/android/server/power/PowerManagerService$WakeLock;)Z
    ...
    invoke-direct {p0, v7}, vc(Ljava/lang/String;)Z
...
.method private ire(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, p0, KR:Ljava/util/HashMap;
    ...
    iget-object p0, p0, KR:Ljava/util/HashMap;
...
.method private kth(Lcom/android/server/power/PowerManagerService$WakeLock;)Z
    ...
    iget-object v5, p0, mPmsInner:Lcom/android/server/power/PowerManagerService$PmsInner;
    ...
    iget-object v5, p0, KR:Ljava/util/HashMap;
    ...
    invoke-direct {p0, v4}, vc(Ljava/lang/String;)Z
...
.method private lc(I)Z
    ...
    iget-object p0, p0, AR:Ljava/util/List;
...
.method private mc(I)Z
    ...
    iget-boolean v1, p0, mIsDeepSleep:Z
...
.method private rtg(Lcom/android/server/power/PowerManagerService$WakeLock;)Z
    ...
    iget-object v2, p0, zR:Ljava/util/ArrayList;
...
.method private sis(Lcom/android/server/power/PowerManagerService$WakeLock;)Z
    ...
    invoke-direct {p0}, dq()[Ljava/lang/String;
...
.method private ssp(Lcom/android/server/power/PowerManagerService$WakeLock;)Z
    ...
    iget-object v0, p0, zR:Ljava/util/ArrayList;
    ...
    :cond_0
    invoke-direct {p0, p1}, rtg(Lcom/android/server/power/PowerManagerService$WakeLock;)Z
...
.method private uc(Ljava/lang/String;)Z
    ...
    iget-object v0, p0, JR:Ljava/util/List;
...
.method private vdw(IZ)Z
    ...
    :cond_3
    iget-object p0, p0, zR:Ljava/util/ArrayList;
...
.method private wc(Ljava/lang/String;)Z
    ...
    :try_start_0
    iget-object p0, p0, OR:Ljava/util/List;
...
.method private xc(Ljava/lang/String;)Z
    ...
    :goto_0
    :try_start_0
    iget-object v3, p0, QR:Ljava/util/List;
...
.method static synthetic zta(Lcom/android/server/power/ugm;Lorg/json/JSONArray;)V
    ...
    invoke-direct {p0, p1}, bio(Lorg/json/JSONArray;)V
...
.method public CheckWakeUpOrDoze(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1}, xc(Ljava/lang/String;)Z
    ...
    iget-object p1, p0, IR:Ljava/lang/String;

    if-eqz p1, :cond_3

    invoke-direct {p0, p1}, wc(Ljava/lang/String;)Z
    ...
    iget-object p2, p0, IR:Ljava/lang/String;
    ...
    iput-object p1, p0, IR:Ljava/lang/String;

    return v1

    :cond_2
    invoke-direct {p0, p2}, wc(Ljava/lang/String;)Z
...
.method public addExclusiveWakeLock(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-virtual {p0, p1, p2, p3}, zta(Ljava/lang/String;Ljava/lang/String;Z)V
...
.method public checkForKeepWakeLocks(Lcom/android/server/power/PowerManagerService$WakeLock;)Z
    ...
    sget-object v2, XR:Lcom/android/server/OnePlusUtil$you;

    iget v3, v0, Lcom/android/server/power/PowerManagerService$UidState;->mUid:I

    invoke-virtual {v2, v3}, Lcom/android/server/OnePlusUtil$you;->ywr(I)Z
    ...
    invoke-direct {p0, p1}, uc(Ljava/lang/String;)Z
...
.method public checkWakeLock(Lcom/android/server/power/PowerManagerService$WakeLock;ZZ)Z
    ...
    invoke-direct {p0, p1}, tsu(Lcom/android/server/power/PowerManagerService$WakeLock;)Z
...
.method public getExclusiveWakeLock(Z)Ljava/util/HashMap;
    ...
    iget-object p0, p0, xR:Ljava/util/HashMap;

    return-object p0

    :cond_0
    iget-object p0, p0, vR:Ljava/util/HashMap;
...
.method public handleOnlineConfig()V
    ...
    iget-object v1, p0, mPmsInner:Lcom/android/server/power/PowerManagerService$PmsInner;
    ...
    invoke-direct {p0, v0}, bio(Lorg/json/JSONArray;)V
...
.method public ifHandleCommand(Ljava/io/PrintWriter;[Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1, p2}, you(Ljava/io/PrintWriter;[Ljava/lang/String;)Z
...
.method public init(Landroid/content/res/Resources;)V
    ...
    iput-object v1, p0, ER:Ljava/util/List;
    ...
    iget-object v2, p0, ER:Ljava/util/List;
    ...
    invoke-direct {p0, v1}, ear(Ljava/util/List;)V
    ...
    iput-object v1, p0, AR:Ljava/util/List;
    ...
    iget-object v3, p0, mPmsInner:Lcom/android/server/power/PowerManagerService$PmsInner;
    ...
    iput-object p1, p0, BR:Lcom/oneplus/config/ConfigObserver;

    iget-object p1, p0, BR:Lcom/oneplus/config/ConfigObserver;

    invoke-virtual {p1}, Lcom/oneplus/config/ConfigObserver;->register()V

    iget-object p1, p0, mPmsInner:Lcom/android/server/power/PowerManagerService$PmsInner;
    ...
    iput-object p1, p0, OR:Ljava/util/List;

    iget-object p1, p0, OR:Ljava/util/List;
    ...
    iput-object p1, p0, QR:Ljava/util/List;

    iget-object p1, p0, QR:Ljava/util/List;
    ...
    iput-object p1, p0, JR:Ljava/util/List;

    iget-object p1, p0, JR:Ljava/util/List;
    ...
    iput-object p1, p0, vR:Ljava/util/HashMap;

    iput-boolean v0, p0, wR:Z

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, xR:Ljava/util/HashMap;

    iput-boolean v0, p0, yR:Z

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, KR:Ljava/util/HashMap;

    const-string p1, "com.google.android.googlequicksearchbox"

    const-string v0, "AudioIn"

    invoke-direct {p0, p1, v0}, ire(Ljava/lang/String;Ljava/lang/String;)V
...
.method public setDeepSleepMode(Z)Z
    ...
    :cond_1
    iput-boolean p1, p0, mIsDeepSleep:Z
...
.method public setWakelockDisabled(Lcom/android/server/power/PowerManagerService$WakeLock;)Z
    ...
    iget-object v2, p0, mPmsInner:Lcom/android/server/power/PowerManagerService$PmsInner;
    ...
    iget-object v6, p0, mPmsInner:Lcom/android/server/power/PowerManagerService$PmsInner;
    ...
    :cond_2
    invoke-direct {p0, p1}, kth(Lcom/android/server/power/PowerManagerService$WakeLock;)Z
    ...
    iget v11, p1, Lcom/android/server/power/PowerManagerService$WakeLock;->mOwnerUid:I

    invoke-static {v11}, Lcom/android/server/OpSmartDozeInjector;->isSmartDozeWhitelisted(I)Z
    ...
    invoke-direct {p0, p1}, sis(Lcom/android/server/power/PowerManagerService$WakeLock;)Z
    ...
    :cond_4
    iget-boolean v11, p0, mIsDeepSleep:Z
    ...
    iget-object v11, p0, mPmsInner:Lcom/android/server/power/PowerManagerService$PmsInner;
    ...
    :cond_b
    invoke-direct {p0, p1}, cno(Lcom/android/server/power/PowerManagerService$WakeLock;)Z
    ...
    :goto_2
    iget-boolean v2, p0, wR:Z

    if-eqz v2, :cond_f

    if-nez v1, :cond_f

    invoke-virtual {p0, p1}, zta(Lcom/android/server/power/PowerManagerService$WakeLock;)Z
    ...
    :cond_f
    iget-boolean v2, p0, yR:Z

    if-eqz v2, :cond_11

    if-nez v1, :cond_11

    invoke-virtual {p0, p1}, you(Lcom/android/server/power/PowerManagerService$WakeLock;)Z
    ...
    invoke-direct {p0, p1}, ssp(Lcom/android/server/power/PowerManagerService$WakeLock;)Z
    ...
    invoke-direct {p0, v3}, getPackageNameForUid(I)Ljava/lang/String;

    move-result-object v0

    invoke-direct {p0, v0}, vc(Ljava/lang/String;)Z
...
.method protected ssp(Ljava/io/PrintWriter;)V
    .locals 0
...
.method public updateBlockedUids(IZ)V
    ...
    :try_start_0
    invoke-direct {p0, p1, p2}, vdw(IZ)Z
...
.method you(Lcom/android/server/power/PowerManagerService$WakeLock;)Z
    ...
    iget-object v0, p0, xR:Ljava/util/HashMap;
...
.method protected you(Ljava/io/PrintWriter;[Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1}, ssp(Ljava/io/PrintWriter;)V
    ...
    :goto_1
    iput-boolean p2, p0, mEnableLogDump:Z
...
.method zta(Lcom/android/server/power/PowerManagerService$WakeLock;)Z
    ...
    iget-object v0, p0, vR:Ljava/util/HashMap;
