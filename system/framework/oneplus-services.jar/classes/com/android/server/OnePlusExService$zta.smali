...
.method private constructor <init>(Lcom/android/server/OnePlusExService;)V
    ...
    iput-object p1, p0, this$0:Lcom/android/server/OnePlusExService;
    ...
    iput-boolean p1, p0, _d:Z

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, ae:Ljava/util/Map;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, be:Ljava/util/Map;
    ...
    iput-object p1, p0, ce:[Ljava/lang/String;

    return-void
.end method

.method synthetic constructor <init>(Lcom/android/server/OnePlusExService;Lcom/android/server/kth;)V
    .locals 0

    invoke-direct {p0, p1}, <init>(Lcom/android/server/OnePlusExService;)V
...
.method private zta(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    :cond_1
    :try_start_2
    iget-object v8, p0, ce:[Ljava/lang/String;
    ...
    invoke-direct {p0, v0}, zta(Landroid/database/Cursor;)I
...
.method private zta(Landroid/content/Context;Landroid/net/Uri;I)I
    .locals 7
    ...
    iget-object v3, p0, be:Ljava/util/Map;
    ...
    invoke-direct {p0, p1, p2}, zta(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    iget-object p2, p0, be:Ljava/util/Map;

    invoke-interface {p2, v0}, Ljava/util/Map;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object p0, p0, be:Ljava/util/Map;
    ...
    :goto_1
    const-string p2, "getUserVibratorSceneId failed: "
    ...
    const-string p2, "getUserVibratorSceneId: sceneId = "
...
.method static synthetic zta(Lcom/android/server/OnePlusExService$zta;Landroid/content/Context;Landroid/net/Uri;I)I
    .locals 0

    invoke-direct {p0, p1, p2, p3}, zta(Landroid/content/Context;Landroid/net/Uri;I)I
...
.method private zta(Landroid/content/Context;Ljava/util/Map;I)V
    .locals 1
    ...
    iget-object v0, p0, be:Ljava/util/Map;
...
.method static synthetic zta(Lcom/android/server/OnePlusExService$zta;Landroid/content/Context;Ljava/util/Map;I)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, zta(Landroid/content/Context;Ljava/util/Map;I)V
