...
.field private final mInstallTask:Lcom/android/server/cno;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, debugOnePlus:Z

    const/4 v0, 0x0

    sput-boolean v0, disableDuplicate:Z

    sput-boolean v0, ifBootCompleted:Z

    new-instance v0, Lcom/android/server/kth;

    invoke-direct {v0}, Lcom/android/server/kth;-><init>()V

    sput-object v0, SCREATOR:Landroid/util/Singleton;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, mCarChargerNotificationShown:Z
    ...
    iput-object v1, p0, nb:Landroid/app/Notification$Builder;

    iput-object v1, p0, outStream:Ljava/io/FileOutputStream;

    new-instance v2, Lcom/android/server/cno;

    invoke-direct {v2}, Lcom/android/server/cno;-><init>()V

    iput-object v2, p0, mInstallTask:Lcom/android/server/cno;

    new-instance v2, Lcom/android/server/OnePlusExService$zta;

    invoke-direct {v2, p0, v1}, Lcom/android/server/OnePlusExService$zta;-><init>(Lcom/android/server/OnePlusExService;Lcom/android/server/kth;)V

    iput-object v2, p0, mRingtoneUtils:Lcom/android/server/OnePlusExService$zta;
    ...
    invoke-direct {v2, p0, v3, v1, v0}, Lcom/android/server/bio;-><init>(Lcom/android/server/OnePlusExService;Landroid/os/Looper;Landroid/os/Handler$Callback;Z)V
    ...
    invoke-direct {v0, p0}, Lcom/android/server/ywr;-><init>(Lcom/android/server/OnePlusExService;)V

    iput-object v0, p0, mCarModeReceiver:Landroid/content/BroadcastReceiver;
...
.method static synthetic access$1100(Lcom/android/server/OnePlusExService;Landroid/content/Context;Landroid/app/Notification$Builder;)V
    ...
    invoke-direct {p0, p1, p2}, overrideNotificationAppName(Landroid/content/Context;Landroid/app/Notification$Builder;)V
...
.method static synthetic access$1300(Lcom/android/server/OnePlusExService;)Landroid/app/Notification$Builder;
    ...
    iget-object p0, p0, nb:Landroid/app/Notification$Builder;
...
.method static synthetic access$1302(Lcom/android/server/OnePlusExService;Landroid/app/Notification$Builder;)Landroid/app/Notification$Builder;
    ...
    iput-object p1, p0, nb:Landroid/app/Notification$Builder;
...
.method static synthetic access$1400(Lcom/android/server/OnePlusExService;ILandroid/content/Context;IILandroid/app/Notification$Builder;)V
    ...
    invoke-direct/range {p0 .. p5}, showCarModeNotification(ILandroid/content/Context;IILandroid/app/Notification$Builder;)V
...
.method static synthetic access$1600(Lcom/android/server/OnePlusExService;)Landroid/os/Handler;
    ...
    iget-object p0, p0, mHandlerCarMode:Landroid/os/Handler;
...
.method static synthetic access$1700()Z
    ...
    sget-boolean v0, ifBootCompleted:Z
...
.method static synthetic access$1702(Z)Z
    ...
    sput-boolean p0, ifBootCompleted:Z
...
.method static synthetic access$1800()Z
    ...
    sget-boolean v0, disableDuplicate:Z
...
.method static synthetic access$1802(Z)Z
    ...
    sput-boolean p0, disableDuplicate:Z
...
.method static synthetic access$1900(Lcom/android/server/OnePlusExService;)V
    ...
    invoke-direct {p0}, createNotificationChannel()V
...
.method static synthetic access$2000(Lcom/android/server/OnePlusExService;Landroid/content/Context;)Landroid/app/Notification$Builder;
    ...
    invoke-direct {p0, p1}, createNotificationBuilder(Landroid/content/Context;)Landroid/app/Notification$Builder;
...
.method static synthetic access$2100(Lcom/android/server/OnePlusExService;)V
    ...
    invoke-direct {p0}, createNotificationChannelForPopup()V
...
.method static synthetic access$2200(Lcom/android/server/OnePlusExService;Landroid/content/Context;)Landroid/app/Notification$Builder;
    ...
    invoke-direct {p0, p1}, createNotificationBuilderForPopup(Landroid/content/Context;)Landroid/app/Notification$Builder;
...
.method static synthetic access$2300(Lcom/android/server/OnePlusExService;Z)V
    ...
    invoke-direct {p0, p1}, saveDNDStateToFile(Z)V
...
.method static synthetic access$2400(Lcom/android/server/OnePlusExService;)Z
    ...
    iget-boolean p0, p0, mCarChargerNotificationShown:Z
...
.method static synthetic access$2402(Lcom/android/server/OnePlusExService;Z)Z
    ...
    iput-boolean p1, p0, mCarChargerNotificationShown:Z
...
.method static synthetic access$2500(Lcom/android/server/OnePlusExService;)V
    ...
    invoke-direct {p0}, setDontDisturbForCarMode()V
...
.method static synthetic access$2600(Lcom/android/server/OnePlusExService;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, startSelectApp(Ljava/lang/String;)V
...
.method static synthetic access$2700(Lcom/android/server/OnePlusExService;)Ljava/lang/Runnable;
    ...
    iget-object p0, p0, mCarModeRunnable:Ljava/lang/Runnable;
...
.method static synthetic access$2800(Lcom/android/server/OnePlusExService;)I
    ...
    invoke-direct {p0}, getDNDStateFromFile()I
...
.method static synthetic access$2900(Lcom/android/server/OnePlusExService;)V
    ...
    invoke-direct {p0}, disableDontDisturbForCarMode()V
...
.method static synthetic access$300(Lcom/android/server/OnePlusExService;)Lcom/oneplus/android/server/scene/a;
    ...
    iget-object p0, p0, mSceneModeController:Lcom/oneplus/android/server/scene/a;
...
.method static synthetic access$500(Lcom/android/server/OnePlusExService;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, trackRfData(Ljava/lang/String;)V
...
.method static synthetic access$600(Lcom/android/server/OnePlusExService;)I
    ...
    invoke-direct {p0}, getParamSwId()I
...
.method static synthetic access$700(Lcom/android/server/OnePlusExService;I)V
    ...
    invoke-direct {p0, p1}, trackSwIdData(I)V
...
.method static synthetic access$800(Lcom/android/server/OnePlusExService;I)V
    ...
    invoke-direct {p0, p1}, setParamSwId(I)V
...
.method static synthetic access$900(Lcom/android/server/OnePlusExService;)Ljava/lang/String;
    ...
    invoke-direct {p0}, getCountryFromLocation()Ljava/lang/String;
...
.method private createNotificationBuilder(Landroid/content/Context;)Landroid/app/Notification$Builder;
    ...
    invoke-direct {p0}, pendingActivity()Landroid/app/PendingIntent;
...
.method private getCountryFromLocation()Ljava/lang/String;
    ...
    invoke-direct {p0}, getLocation()Landroid/location/Location;
...
.method public static getDefault()Lcom/oneplus/os/IOnePlusExService;
    ...
    sget-object v0, SCREATOR:Landroid/util/Singleton;
...
.method private getLocation()Landroid/location/Location;
    ...
    invoke-direct {p0, v0}, getLastKnownLocation(Landroid/location/LocationManager;)Landroid/location/Location;
    ...
    iget-object v6, p0, mLocationListener:Landroid/location/LocationListener;
    ...
    iget-object v2, p0, mLocationListener:Landroid/location/LocationListener;
...
.method private onSystemReady()V
    ...
    sput-object v2, mDropbox:Landroid/os/DropBoxManager;
    ...
    iget-object v4, p0, mCarModeReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v2, p0, mHandlerCarMode:Landroid/os/Handler;
    ...
    invoke-direct {p0}, setParamSwId()V
    ...
    invoke-static {}, Lcom/oneplus/custom/utils/OpCustomizeSettings;->qg()Lcom/oneplus/custom/utils/OpCustomizeSettings$CUSTOM_TYPE;
    ...
    invoke-virtual {p0, v0}, startApkInstall(Ljava/lang/String;)V
...
.method private saveDNDStateToFile(Z)V
    ...
    iput-object v0, p0, outStream:Ljava/io/FileOutputStream;

    if-eqz p1, :cond_0

    iget-object p1, p0, outStream:Ljava/io/FileOutputStream;
    ...
    :goto_1
    iget-object p0, p0, outStream:Ljava/io/FileOutputStream;
...
.method private setParamSwId()V
    ...
    invoke-direct {v2, p0, v0}, Lcom/android/server/wtn;-><init>(Lcom/android/server/OnePlusExService;Ljava/lang/String;)V
...
.method private showCarModeNotification(ILandroid/content/Context;IILandroid/app/Notification$Builder;)V
    ...
    new-instance v7, Lcom/android/server/dma;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/server/dma;-><init>(Lcom/android/server/OnePlusExService;Landroid/app/Notification$Builder;Landroid/content/Context;III)V

    iput-object v7, p0, mCarModeRunnable:Ljava/lang/Runnable;

    if-nez p1, :cond_0

    iget-object p1, p0, mHandlerCarMode:Landroid/os/Handler;
...
.method private trackRfData(Ljava/lang/String;)V
    ...
    :cond_1
    :goto_0
    sget-boolean p0, debugOnePlus:Z
...
.method public bootComplete()V
    ...
    invoke-direct {v1, p0}, Lcom/android/server/igw;-><init>(Lcom/android/server/OnePlusExService;)V
...
.method public dumpJankBugreport(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, dumpJankInfo(Ljava/lang/StringBuilder;)V
    ...
    sget-object p0, mDropbox:Landroid/os/DropBoxManager;
...
.method public dumpLightBugreport(Ljava/lang/String;)V
    ...
    sget-object v1, mDropbox:Landroid/os/DropBoxManager;
...
.method public getUserVibratorSceneId(Landroid/net/Uri;I)I
    ...
    iget-object v1, p0, mRingtoneUtils:Lcom/android/server/OnePlusExService$zta;
...
.method public monitorSceneChanging(Z)V
    ...
    sget-boolean v0, debugOnePlus:Z
    ...
    invoke-virtual {p0}, Lcom/oneplus/android/server/scene/a;->hg()V
    ...
    invoke-virtual {p0}, Lcom/oneplus/android/server/scene/a;->jg()V
...
.method public shutdown()V
    ...
    :cond_1
    iget-object v0, p0, mSceneModeController:Lcom/oneplus/android/server/scene/a;
    ...
    iput-object v0, p0, mSceneModeController:Lcom/oneplus/android/server/scene/a;
    ...
    invoke-virtual {p0}, Lcom/oneplus/android/server/scene/a;->ig()V
...
.method public startApkInstall(Ljava/lang/String;)V
    ...
    iget-object p0, p0, mInstallTask:Lcom/android/server/cno;

    invoke-virtual {p0, v0, p1}, Lcom/android/server/cno;->zta(Landroid/content/Context;Ljava/lang/String;)V
...
.method public updateUserVibratorSceneIds(Ljava/util/Map;I)V
    ...
    iget-object p0, p0, mRingtoneUtils:Lcom/android/server/OnePlusExService$zta;
