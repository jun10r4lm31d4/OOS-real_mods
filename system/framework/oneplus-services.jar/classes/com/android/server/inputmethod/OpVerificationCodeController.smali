...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, mPreImeVisible:Z

    iput-boolean v0, p0, mInputTypeNum:Z

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, mOpLatestImeBounds:Landroid/graphics/Rect;

    const/16 v0, 0x64

    iput v0, p0, mCommitTimeInterval:I

    const-wide/16 v0, -0x1

    iput-wide v0, p0, mLatestCodeTimeStamp:J
    ...
    iput-object v0, p0, mActionProviderImpl:Lcom/android/server/you/zta;
...
.method static synthetic access$100(Lcom/android/server/inputmethod/OpVerificationCodeController;)I
    ...
    iget p0, p0, mCommitTimeInterval:I
...
.method static synthetic access$1000(Lcom/android/server/inputmethod/OpVerificationCodeController;Ljava/lang/CharSequence;)V
    ...
    invoke-direct {p0, p1}, commitCodeOneByOne(Ljava/lang/CharSequence;)V
...
.method static synthetic access$102(Lcom/android/server/inputmethod/OpVerificationCodeController;I)I
    ...
    iput p1, p0, mCommitTimeInterval:I
...
.method static synthetic access$1100(Lcom/android/server/inputmethod/OpVerificationCodeController;Ljava/lang/CharSequence;I)V
    ...
    invoke-direct {p0, p1, p2}, singleCommit(Ljava/lang/CharSequence;I)V
...
.method static synthetic access$200(Lcom/android/server/inputmethod/OpVerificationCodeController;JJ)Z
    ...
    invoke-direct {p0, p1, p2, p3, p4}, checkTimeStamp(JJ)Z
...
.method static synthetic access$300(Lcom/android/server/inputmethod/OpVerificationCodeController;)J
    ...
    iget-wide v0, p0, mLatestCodeTimeStamp:J
...
.method static synthetic access$400(Lcom/android/server/inputmethod/OpVerificationCodeController;Ljava/lang/String;J)V
    ...
    invoke-direct {p0, p1, p2, p3}, printSecureCodeDebug(Ljava/lang/String;J)V
...
.method static synthetic access$500(Lcom/android/server/inputmethod/OpVerificationCodeController;)Lcom/android/server/you/tsu;
    ...
    iget-object p0, p0, mOpVCAction:Lcom/android/server/you/tsu;
...
.method static synthetic access$600(Lcom/android/server/inputmethod/OpVerificationCodeController;)Lcom/android/server/inputmethod/InputMethodManagerService;
    ...
    iget-object p0, p0, mIMMService:Lcom/android/server/inputmethod/InputMethodManagerService;
...
.method static synthetic access$700(Lcom/android/server/inputmethod/OpVerificationCodeController;)Z
    ...
    iget-boolean p0, p0, mPreImeVisible:Z
...
.method static synthetic access$800(Lcom/android/server/inputmethod/OpVerificationCodeController;)Landroid/graphics/Rect;
    ...
    iget-object p0, p0, mOpLatestImeBounds:Landroid/graphics/Rect;
...
.method static synthetic access$902(Lcom/android/server/inputmethod/OpVerificationCodeController;Lcom/android/server/you/zta$zta;)Lcom/android/server/you/zta$zta;
    ...
    iput-object p1, p0, mActionListener:Lcom/android/server/you/zta$zta;
...
.method private checkTimeStamp(JJ)Z
    ...
    iput-wide v2, p0, mLatestCodeTimeStamp:J
    ...
    invoke-direct {p0, p1, p2}, debugVisibleTime(J)Ljava/lang/String;

    move-result-object p1

    aput-object p1, v0, v1

    invoke-direct {p0, p3, p4}, debugVisibleTime(J)Ljava/lang/String;
    ...
    iget-wide p2, p0, mLatestCodeTimeStamp:J

    invoke-direct {p0, p2, p3}, debugVisibleTime(J)Ljava/lang/String;
...
.method private commitCodeOneByOne(Ljava/lang/CharSequence;)V
    ...
    iget v2, p0, mCommitTimeInterval:I
...
.method private initActionIfPossible()V
    ...
    iget-object v0, p0, mOpVCAction:Lcom/android/server/you/tsu;
    ...
    iget-object v2, p0, mIMMService:Lcom/android/server/inputmethod/InputMethodManagerService;
    ...
    iget-object v2, p0, mActionProviderImpl:Lcom/android/server/you/zta;

    invoke-direct {v1, v0, v2}, Lcom/android/server/you/tsu;-><init>(Landroid/content/Context;Lcom/android/server/you/zta;)V

    iput-object v1, p0, mOpVCAction:Lcom/android/server/you/tsu;
...
.method private isSensitiveAttrChanged(IZ)Z
    ...
    :cond_0
    iget-boolean p1, p0, mInputTypeNum:Z

    if-eq p1, p2, :cond_2

    iput-boolean p2, p0, mInputTypeNum:Z
...
.method public initController(Landroid/content/Context;Lcom/android/server/inputmethod/InputMethodManagerService;)V
    ...
    iput-object p2, p0, mIMMService:Lcom/android/server/inputmethod/InputMethodManagerService;

    invoke-direct {p0}, initActionIfPossible()V
...
.method public notifyIMELayoutChanged(ZLcom/android/server/wm/DisplayFrames;)V
    ...
    iget-boolean v0, p0, mPreImeVisible:Z

    if-eq p1, v0, :cond_0

    iput-boolean p1, p0, mPreImeVisible:Z
    ...
    iget-object v1, p0, mOpLatestImeBounds:Landroid/graphics/Rect;
    ...
    :cond_1
    iget-object v0, p0, mOpLatestImeBounds:Landroid/graphics/Rect;
    ...
    iget-object p0, p0, mActionListener:Lcom/android/server/you/zta$zta;
...
.method public notifyImeAttributeChanged(IZ)V
    ...
    invoke-direct {p0, p1, p2}, isSensitiveAttrChanged(IZ)Z
