...
.field private static Mf:Z = false

.field private static final Nf:Ljava/lang/String; = "ProcessManagement"

.field private static Of:Landroid/util/ArrayMap; = null
...
.field private static Pf:Landroid/util/ArrayMap; = null
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/util/ArrayMap<",
            "Ljava/lang/String;",
...
.field private static Qf:Ljava/util/List; = null
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
.field private static Rf:Ljava/lang/Object; = null
...
.field private Gf:Landroid/util/ArrayMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/util/ArrayMap<",
...
.field private If:Landroid/util/ArrayMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/util/ArrayMap<",
            "Ljava/lang/String;",
...
.field private Jf:Landroid/util/ArrayMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/util/ArrayMap<",
            "Ljava/lang/String;",
...
.field private final Kf:Ljava/lang/Object;

.field private mAlignment:Lcom/android/server/ire$zta;

.field private final mConfigHandler:Lcom/android/server/ire$you;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Mf:Z

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    sput-object v0, Of:Landroid/util/ArrayMap;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    sput-object v0, Pf:Landroid/util/ArrayMap;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Qf:Ljava/util/List;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Rf:Ljava/lang/Object;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mAlignment:Lcom/android/server/ire$zta;
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/server/ire$you;-><init>(Lcom/android/server/ire;Landroid/os/Looper;)V

    iput-object v0, p0, mConfigHandler:Lcom/android/server/ire$you;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, Gf:Landroid/util/ArrayMap;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Hf:Ljava/util/ArrayList;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, If:Landroid/util/ArrayMap;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, Jf:Landroid/util/ArrayMap;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Kf:Ljava/lang/Object;
...
.method static synthetic sis(Lcom/android/server/ire;)Lcom/android/server/AlarmManagerService$AmsInner;
    .locals 0

    iget-object p0, p0, Ef:Lcom/android/server/AlarmManagerService$AmsInner;

    return-object p0
.end method

.method static synthetic you(Lcom/android/server/ire;)Lcom/android/server/ire$zta;
    .locals 0

    iget-object p0, p0, mAlignment:Lcom/android/server/ire$zta;

    return-object p0
.end method

.method static synthetic zta(Lcom/android/server/ire;)Landroid/content/Context;
    .locals 0
...
.method private zta(Ljava/lang/String;ZI)V
    .locals 2
    ...
    sget-object p2, Rf:Ljava/lang/Object;

    monitor-enter p2

    :try_start_0
    sget-object p0, Of:Landroid/util/ArrayMap;
    ...
    sget-object p0, Pf:Landroid/util/ArrayMap;
    ...
    iget-object p3, p0, Ef:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    sget-object p0, Rf:Ljava/lang/Object;

    monitor-enter p0

    :try_start_1
    sget-object p2, Of:Landroid/util/ArrayMap;

    invoke-virtual {p2, p1}, Landroid/util/ArrayMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    sget-object p2, Pf:Landroid/util/ArrayMap;
...
.method private zta(Lcom/android/server/AlarmManagerService$Alarm;JJ)Z
    ...
    sget-object v0, Rf:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    sget-object v1, Of:Landroid/util/ArrayMap;
    ...
    iget-object v1, p0, Hf:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v1}, gwm(Ljava/lang/String;)Z

    move-result v1

    if-eqz v1, :cond_5

    invoke-virtual {p0, p2, p3}, bio(J)J
    ...
    invoke-direct {p0}, getTimeDelta()J
    ...
    iget-object p2, p0, Ef:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    :cond_3
    iget-object p2, p0, Hf:Ljava/util/ArrayList;
    ...
    iget-object p2, p0, Kf:Ljava/lang/Object;

    monitor-enter p2

    :try_start_1
    iget-object p3, p0, Gf:Landroid/util/ArrayMap;
    ...
    iget-object p1, p0, Jf:Landroid/util/ArrayMap;
    ...
    iget-object p0, p0, Jf:Landroid/util/ArrayMap;
    ...
    :cond_5
    iget-object p2, p0, Jf:Landroid/util/ArrayMap;
    ...
    iget-object p0, p0, Hf:Ljava/util/ArrayList;
...
.method public deliverDelayAlarm(Landroid/os/Message;)V
    ...
    iget-object v3, p0, Kf:Ljava/lang/Object;
    ...
    :goto_0
    :try_start_0
    iget-object v6, p0, Gf:Landroid/util/ArrayMap;
    ...
    iget-object v3, p0, Ef:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    iget-object v0, p0, Kf:Ljava/lang/Object;
    ...
    iget-object v3, p0, Gf:Landroid/util/ArrayMap;
    ...
    :goto_2
    iget-object v1, p0, Jf:Landroid/util/ArrayMap;
    ...
    iget-object v5, p0, Hf:Ljava/util/ArrayList;

    invoke-virtual {v5, v3}, Ljava/util/ArrayList;->remove(Ljava/lang/Object;)Z

    iget-object v5, p0, If:Landroid/util/ArrayMap;
...
.method public dma(Z)Z
    ...
    sget-boolean p0, Mf:Z

    sput-boolean p1, Mf:Z
...
.method public gck(Z)Z
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/ire$zta;->bio(Z)Z
...
.method public gwm(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1}, ugm(Ljava/lang/String;)Z
...
.method public initAlarmAlignment(II)V
    ...
    :goto_0
    iget-object p1, p0, mAlignment:Lcom/android/server/ire$zta;

    invoke-virtual {p1, v0}, Lcom/android/server/ire$zta;->bio(Z)Z

    iget-object p1, p0, mAlignment:Lcom/android/server/ire$zta;

    invoke-virtual {p1}, Lcom/android/server/ire$zta;->V()V

    iget-object p1, p0, mAlignment:Lcom/android/server/ire$zta;

    invoke-virtual {p1}, Lcom/android/server/ire$zta;->registerOnlineConfig()V

    iget-object p0, p0, mConfigHandler:Lcom/android/server/ire$you;
...
.method public initInstance(Lcom/android/server/AlarmManagerService$AmsInner;Landroid/content/Context;)V
    ...
    new-instance p1, Lcom/android/server/ire$zta;

    iget-object p2, p0, mContext:Landroid/content/Context;

    iget-object v0, p0, Ef:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    iget-object v1, p0, mConfigHandler:Lcom/android/server/ire$you;

    invoke-direct {p1, p0, p2, v0, v1}, Lcom/android/server/ire$zta;-><init>(Lcom/android/server/ire;Landroid/content/Context;Landroid/os/Handler;Landroid/os/Handler;)V

    iput-object p1, p0, mAlignment:Lcom/android/server/ire$zta;
...
.method public setAlarmAlignment(Lcom/android/server/AlarmManagerService$Alarm;Lcom/android/server/AlarmManagerService$AlarmAlignmentReason;JJ)Z
    ...
    iget-object v0, p0, mAlignment:Lcom/android/server/ire$zta;
    ...
    sget-object v2, Lcom/android/server/ear;->of:[I
    ...
    invoke-direct/range {v0 .. v5}, zta(Lcom/android/server/AlarmManagerService$Alarm;JJ)Z
    ...
    :cond_7
    iget-object p2, p0, mAlignment:Lcom/android/server/ire$zta;

    invoke-virtual {p2, p1, v1}, Lcom/android/server/ire$zta;->zta(Lcom/android/server/AlarmManagerService$Alarm;Z)J
    ...
    :cond_8
    iget-object v1, p0, Ef:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/server/ire$zta;->zta(Lcom/android/server/AlarmManagerService$Alarm;Z)J
...
.method public setBlackAlarm(Ljava/util/List;)V
    ...
    sget-object p0, Qf:Ljava/util/List;
    ...
    sget-object p1, Qf:Ljava/util/List;
...
.method public setBlockAlarmUid(Ljava/lang/String;ZI)V
    ...
    invoke-direct {p0, p1, p2, p3}, zta(Ljava/lang/String;ZI)V
...
.method public shellCommand(Ljava/io/PrintWriter;[Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/server/ire$zta;->cno(J)V
    :try_end_0
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/ire$zta;->dump(Ljava/io/PrintWriter;)V
    ...
    invoke-virtual {p0, v3}, Lcom/android/server/ire$zta;->wtn(Z)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/ire$zta;->wtn(Z)V
...
.method public ywr(Z)V
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/ire$zta;->igw(Z)Z

    iget-object p1, p0, mAlignment:Lcom/android/server/ire$zta;

    invoke-virtual {p1, v0}, Lcom/android/server/ire$zta;->kth(Z)Z
    ...
    invoke-virtual {p1, v2}, Lcom/android/server/ire$zta;->igw(Z)Z

    iget-object p1, p0, mAlignment:Lcom/android/server/ire$zta;

    invoke-virtual {p1, v2}, Lcom/android/server/ire$zta;->kth(Z)Z
    ...
    :goto_0
    invoke-virtual {p0, v0, v1}, Lcom/android/server/ire$zta;->kth(J)J
...
.method public zta(Lcom/android/server/AlarmManagerService$Alarm;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/ire$zta;->zta(Lcom/android/server/AlarmManagerService$Alarm;)Z
