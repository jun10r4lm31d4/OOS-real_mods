...
.field private static final Tg:Ljava/lang/String; = "/sys/class/power_supply/battery/fastchg_status"
...
.method static synthetic access$100()Lcom/android/server/qeg$zta;
    ...
    sget-object v0, Wg:Lcom/android/server/qeg$zta;
...
.method private qm()V
    ...
    sget-object v2, Wg:Lcom/android/server/qeg$zta;

    invoke-virtual {v2, v0, v1, p0}, Lcom/android/server/qeg$zta;->tsu(III)V

    sget-object p0, Wg:Lcom/android/server/qeg$zta;
...
.method private rm()V
    ...
    iget-boolean v0, p0, Og:Z

    if-eqz v0, :cond_0

    invoke-direct {p0}, pm()Z
...
.method static synthetic sis(Lcom/android/server/qeg;)I
    ...
    iget p0, p0, mDefLowBatteryWarningLevel:I
...
.method public addIntentExtra(Landroid/content/Intent;)V
    ...
    iget-boolean v0, p0, Pg:Z

    const/4 v1, 0x1

    if-ne v0, v1, :cond_0

    invoke-direct {p0}, om()I
    ...
    invoke-virtual {p0, v4}, zgw(Ljava/lang/String;)Ljava/lang/String;
...
.method public init(Landroid/content/Context;)V
    ...
    iput v0, p0, mDefLowBatteryWarningLevel:I
    ...
    sput-object v0, Wg:Lcom/android/server/qeg$zta;
