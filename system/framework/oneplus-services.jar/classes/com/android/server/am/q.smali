...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mGeneralAppConfig:Lcom/android/server/am/q$zta;
    ...
    iput-object v0, p0, mGlobalFallbackConfig:Lcom/android/server/am/q$you;
...
.method private findTargetAppThread(Ljava/lang/String;I)Ljava/util/List;
    ...
    invoke-direct {p0, p1}, ec(Ljava/lang/String;)Z
...
.method private getEffectiveConfigForApp(Ljava/lang/String;Z)Lcom/android/server/am/q$zta;
    ...
    iget-object p2, p0, mRawOnlineConfigs:Ljava/util/HashMap;
    ...
    iget-object p0, p0, mGeneralAppConfig:Lcom/android/server/am/q$zta;

    invoke-virtual {p0}, Lcom/android/server/am/q$zta;->clone()Lcom/android/server/am/q$zta;

    move-result-object v1

    invoke-virtual {v1, p1}, Lcom/android/server/am/q$zta;->y(Ljava/lang/String;)V
...
.method private parseAppsConfig(Lorg/json/JSONArray;)V
    ...
    invoke-virtual {v4}, Lcom/android/server/am/q$zta;->kb()Ljava/lang/String;
    ...
    invoke-virtual {v4}, Lcom/android/server/am/q$zta;->Ac()Ljava/lang/String;
...
.method private parseGlobalDefConfig(Lorg/json/JSONArray;)V
    ...
    iget-object p1, p0, mGeneralAppConfig:Lcom/android/server/am/q$zta;
    ...
    iget-object v1, p0, mGeneralAppConfig:Lcom/android/server/am/q$zta;

    invoke-virtual {v1}, Lcom/android/server/am/q$zta;->Ac()Ljava/lang/String;
...
.method static synthetic you(Lcom/android/server/am/q;)Lcom/android/server/am/q$you;
    ...
    iget-object p0, p0, mGlobalFallbackConfig:Lcom/android/server/am/q$you;
...
.method static synthetic zta(Lcom/android/server/am/q;Lcom/android/server/am/q$zta;I)V
    ...
    invoke-direct {p0, p1, p2}, zta(Lcom/android/server/am/q$zta;I)V
...
.method public dispatchConfig(Landroid/app/IApplicationThread;Landroid/content/pm/ApplicationInfo;)V
    ...
    invoke-direct {p0, v1}, ec(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v1, v2}, getEffectiveConfigForApp(Ljava/lang/String;Z)Lcom/android/server/am/q$zta;

    move-result-object v1

    iget v3, p2, Landroid/content/pm/ApplicationInfo;->uid:I

    invoke-virtual {v1, v3}, Lcom/android/server/am/q$zta;->q(I)Ljava/lang/String;
...
.method public init(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/wm/ActivityTaskManagerService;Landroid/content/pm/IPackageManager;)V
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/am/q$zta;->y(Ljava/lang/String;)V

    iget-object p1, p0, mGlobalFallbackConfig:Lcom/android/server/am/q$you;

    const/4 p2, 0x1

    iput-boolean p2, p1, Lcom/android/server/am/q$you;->FB:Z
