...
# static fields
.field public static final ORM_PACKAGE:Ljava/lang/String; = "com.oneplus.orm"

.field public static final ORM_RESTART:Ljava/lang/String; = "persist.vendor.orm.restart"

.field public static final ORM_SERVICE:Ljava/lang/String; = "com.oneplus.orm.OPManagerService"

.field public static final TAG:Ljava/lang/String; = "LORM-AppRecordTransition"

.field private static debug:Z = false

.field public static final pl:Ljava/lang/String; = "persist.sys.orm.debug"

.field public static final ql:Ljava/lang/String; = "persist.sys.orm.test"

.field private static final sl:Z

.field static final tl:Z

.field private static ul:Z
...
.method static constructor <clinit>()V
    ...
    const-string v1, "persist.sys.orm.debug"

    invoke-static {v1, v0}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v1

    sput-boolean v1, sl:Z

    sput-boolean v0, debug:Z

    const-string v1, "persist.sys.orm.test"

    invoke-static {v1, v0}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v1

    sput-boolean v1, tl:Z

    sget-boolean v1, sl:Z
...
.method private static cno(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    invoke-virtual/range {v2 .. v7}, Lcom/android/server/am/N;->you(Ljava/lang/String;IIJ)Lorg/json/JSONObject;
    ...
    invoke-static {p0, p1}, Lcom/android/server/am/N;->zta([BLjava/nio/ByteBuffer;)Z
...
.method static dumpsysOMM(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    :pswitch_0
    invoke-static {p1, p0}, tsu(Ljava/io/PrintWriter;Ljava/lang/String;)V

    goto :goto_3

    :pswitch_1
    invoke-static {p1, p0}, cno(Ljava/io/PrintWriter;Ljava/lang/String;)V

    goto :goto_3

    :pswitch_2
    invoke-static {p1, p0}, ssp(Ljava/io/PrintWriter;Ljava/lang/String;)V

    goto :goto_3

    :pswitch_3
    invoke-static {p1, p0}, rtg(Ljava/io/PrintWriter;Ljava/lang/String;)V

    goto :goto_3

    :pswitch_4
    invoke-static {p1}, bio(Ljava/io/PrintWriter;)V

    goto :goto_3

    :pswitch_5
    invoke-static {p1}, igw(Ljava/io/PrintWriter;)V

    goto :goto_3

    :pswitch_6
    invoke-static {p1, v7}, sis(Ljava/io/PrintWriter;Ljava/lang/String;)V

    goto :goto_3

    :pswitch_7
    invoke-static {p1, v8}, sis(Ljava/io/PrintWriter;Ljava/lang/String;)V
...
.method public static ivd(Ljava/lang/String;)V
    .locals 1
...
.method static qeg(Ljava/lang/String;)V
    .locals 1

    sget-boolean v0, ul:Z
...
.method private static rtg(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    invoke-virtual/range {v2 .. v7}, Lcom/android/server/am/N;->sis(Ljava/lang/String;IIJ)Lorg/json/JSONObject;
...
.method private static ssp(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    invoke-virtual/range {v3 .. v8}, Lcom/android/server/am/N;->zta(Ljava/lang/String;IILjava/lang/String;I)Lorg/json/JSONObject;
    ...
    invoke-virtual/range {v3 .. v9}, Lcom/android/server/am/N;->zta(Ljava/lang/String;IILjava/lang/String;II)Lorg/json/JSONObject;
...
.method private static tsu(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    invoke-static {v0, v2, v3, v4, v5}, Lcom/android/server/am/N;->zta(Ljava/lang/String;IIJ)Lorg/json/JSONObject;
