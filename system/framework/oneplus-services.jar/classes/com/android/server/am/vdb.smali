...
.field private static Jo:Landroid/os/IDeviceIdleController; = null

.field private static final Ko:I = 0x0

.field private static final Lo:I = 0x1

.field private static final Mo:Ljava/lang/String; = "doze_mode_policy"
...
.field private static Po:Lcom/android/server/am/vdb; = null

.field private static Qo:Ljava/util/Set; = null
...
.field private static final Ro:Ljava/lang/String; = "setted_pkg_list"

.field private static final SEPARATOR:Ljava/lang/String; = "|"

.field public static final TAG:Ljava/lang/String; = "OnePlusAppBootManager"

.field private static final gi:I = 0x0

.field private static final hi:I = 0x1

.field private static final ii:I = 0x2

.field private static mContext:Landroid/content/Context;

.field private static opSmartPowerControl:Lcom/android/server/m;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Jo:Landroid/os/IDeviceIdleController;

    sput-object v0, mContext:Landroid/content/Context;

    sput-object v0, Po:Lcom/android/server/am/vdb;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    sput-object v0, Qo:Ljava/util/Set;
...
.method private C()V
    ...
    invoke-static {}, Lcom/android/server/am/ibl;->pb()Ljava/util/Set;

    move-result-object p0

    sput-object p0, Qo:Ljava/util/Set;
...
.method private static Kb(Ljava/lang/String;)Z
    ...
    sput-object v0, opSmartPowerControl:Lcom/android/server/m;

    sget-object v0, opSmartPowerControl:Lcom/android/server/m;

    if-eqz v0, :cond_1

    invoke-virtual {v0, p0}, Lcom/android/server/m;->ear(Ljava/lang/String;)Z
...
.method private Lb(Ljava/lang/String;)V
    ...
    sget-object p1, Qo:Ljava/util/Set;
    ...
    sget-object v0, Qo:Ljava/util/Set;
...
.method private static an()Landroid/os/IDeviceIdleController;
    .locals 1

    sget-object v0, Jo:Landroid/os/IDeviceIdleController;
...
.method private static bn()Lcom/android/server/m;
    .locals 1
...
.method private static cn()V
    ...
    sget-object v2, Qo:Ljava/util/Set;
    ...
    sget-object v3, Qo:Ljava/util/Set;
...
.method public static getAllAppControlModes(I)Ljava/util/List;
    ...
    invoke-static {}, bn()Lcom/android/server/m;

    move-result-object v4

    invoke-virtual {v4}, Lcom/android/server/m;->na()Landroid/util/ArrayMap;
    ...
    :cond_4
    :try_start_2
    invoke-static {}, an()Landroid/os/IDeviceIdleController;
    ...
    invoke-virtual {v1, v0}, Lcom/android/server/am/ibl;->qeg(I)Ljava/util/List;
    ...
    invoke-static {v10, v9, v8}, zta(Ljava/lang/String;ZZ)Z
...
.method public static getAppControlMode(Ljava/lang/String;I)I
    ...
    invoke-static {p0}, Kb(Ljava/lang/String;)Z
    ...
    :cond_1
    invoke-static {p0}, isWhitelisted(Ljava/lang/String;)Z
    ...
    invoke-virtual {v3, p0}, Lcom/android/server/am/ibl;->d(Ljava/lang/String;)I
    ...
    :goto_2
    invoke-static {p0, v0, v2}, zta(Ljava/lang/String;ZZ)Z
...
.method public static final getInstance(Landroid/content/Context;)Lcom/android/server/am/vdb;
    ...
    sget-object v0, Po:Lcom/android/server/am/vdb;
    ...
    :cond_0
    sget-object p0, Po:Lcom/android/server/am/vdb;
...
.method private static isWhitelisted(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, p0}, Lcom/android/server/m;->isWhitelisted(Ljava/lang/String;)Z
...
.method public static ob()Z
    ...
    invoke-virtual {v0}, Lcom/android/server/am/ibl;->ob()Z
...
.method public static setAppControlMode(Ljava/lang/String;II)I
    ...
    invoke-virtual {p1, p0, v4}, Lcom/android/server/m;->zta(Ljava/lang/String;I)Z
    ...
    invoke-virtual {p2, p0, p1}, Lcom/android/server/m;->zta(Ljava/lang/String;I)Z
    ...
    invoke-virtual {p1, p0, v0}, Lcom/android/server/m;->zta(Ljava/lang/String;I)Z
    ...
    :goto_1
    invoke-static {p0}, Mb(Ljava/lang/String;)V
...
.method public static zta(Landroid/content/Context;I)I
    ...
    invoke-static {p0, p1, v4}, zta(Landroid/content/Context;II)I
...
.method public static zta(Landroid/content/Context;II)I
    ...
    invoke-virtual {p1, v6}, Lcom/android/server/am/ibl;->cjf(Z)V
    ...
    invoke-virtual {p1, v5}, Lcom/android/server/am/ibl;->cjf(Z)V
    ...
    :cond_5
    invoke-virtual {p0, v5}, Lcom/android/server/am/ibl;->cjf(Z)V
