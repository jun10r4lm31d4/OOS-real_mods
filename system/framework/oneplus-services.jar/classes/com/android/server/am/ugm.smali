...
.field private static final Ao:Ljava/lang/String; = "/data/system/appboot/record.xml"

.field private static Bo:I = 0x0

.field public static final Co:Ljava/lang/String; = "OPABR"

.field public static final DEBUG:Z

.field private static final Do:Ljava/lang/String; = "recorder"

.field private static final Eo:Ljava/lang/String; = "record"

.field private static final Fo:Ljava/lang/String; = "reason"

.field private static final Go:Ljava/lang/String; = "background"

.field private static final Ho:Ljava/lang/String; = "canal"

.field private static final Io:Ljava/lang/String; = "detail"
...
.field public static xo:Z = false

.field public static yo:Z = false

.field public static final zo:Ljava/lang/String; = "persist.sys.opabr.local"
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, xo:Z

    sput-boolean v0, yo:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/content/ContentResolver;)V
    ...
    iput-object v0, p0, wo:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, extraData:Ljava/util/HashMap;
    ...
    sput-boolean p1, xo:Z

    sget-boolean p1, yo:Z
...
.method private _m()Ljava/lang/String;
    .locals 2
...
.method private cno(Ljava/util/ArrayList;)I
    ...
    check-cast v2, Lcom/android/server/am/ugm$zta;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-virtual {v2}, Lcom/android/server/am/ugm$zta;->ub()Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lcom/android/server/am/ugm$zta;->tb()Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lcom/android/server/am/ugm$zta;->getReason()Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lcom/android/server/am/ugm$zta;->vb()Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lcom/android/server/am/ugm$zta;->getLevel()I
    ...
    invoke-virtual {v2}, Lcom/android/server/am/ugm$zta;->wb()Z
    ...
    invoke-virtual {v2}, Lcom/android/server/am/ugm$zta;->getDetail()Ljava/lang/String;
    ...
    const-string p0, "/data/system/appboot/record.xml"
...
.method private zta(Ljava/lang/String;Lcom/android/server/am/ugm$zta;)V
    .locals 5

    sget-boolean v0, xo:Z
    ...
    :cond_0
    invoke-virtual {p2}, Lcom/android/server/am/ugm$zta;->xb()Ljava/util/Map;
...
.method public ivd(I)V
    ...
    check-cast v3, Lcom/android/server/am/ugm$zta;

    invoke-virtual {v3}, Lcom/android/server/am/ugm$zta;->toString()Ljava/lang/String;
...
.method public yb()V
    ...
    :cond_2
    invoke-direct {p0, v1}, cno(Ljava/util/ArrayList;)I
...
.method public you(Lcom/android/server/am/ugm$zta;)V
    .locals 3

    invoke-virtual {p1}, Lcom/android/server/am/ugm$zta;->getLevel()I
    ...
    :cond_0
    invoke-virtual {p1}, Lcom/android/server/am/ugm$zta;->ub()Ljava/lang/String;
    ...
    invoke-direct {p0}, _m()Ljava/lang/String;
    ...
    :cond_1
    iget-object v0, p0, wo:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, wo:Ljava/util/ArrayList;
    ...
    invoke-virtual {p1}, Lcom/android/server/am/ugm$zta;->vb()Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lcom/android/server/am/ugm$zta;->toString()Ljava/lang/String;
    ...
    invoke-direct {p0, v0, p1}, zta(Ljava/lang/String;Lcom/android/server/am/ugm$zta;)V
...
.method public zta(Ljava/util/ArrayList;)V
    ...
    iget-object v3, p0, wo:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, wo:Ljava/util/ArrayList;
