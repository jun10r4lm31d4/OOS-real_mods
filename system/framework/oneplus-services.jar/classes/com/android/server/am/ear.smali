...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    iget-object p0, p0, this$0:Lcom/android/server/am/OnePlusBGController;

    iget-object p1, p0, Lcom/android/server/am/OnePlusBGController;->lq:Ljava/util/List;

    const-string p2, "ONESHOT"

    invoke-static {p0, p2, p1, v2}, Lcom/android/server/am/OnePlusBGController;->zta(Lcom/android/server/am/OnePlusBGController;Ljava/lang/String;Ljava/util/List;Z)V
    ...
    sput-boolean v3, Lcom/android/server/am/OnePlusBGController;->Mq:Z
    ...
    sput-boolean v2, Lcom/android/server/am/OnePlusBGController;->Mq:Z
    ...
    :goto_2
    iget-object p1, p0, this$0:Lcom/android/server/am/OnePlusBGController;
    ...
    invoke-virtual {p1}, Lcom/android/server/am/OnePlusBGController$gck;->getState()I

    move-result p2

    invoke-virtual {p1, p2, v3}, Lcom/android/server/am/OnePlusBGController$gck;->bio(IZ)V

    invoke-virtual {p1}, Lcom/android/server/am/OnePlusBGController$gck;->dump()V
    ...
    invoke-static {p0}, Lcom/android/server/am/OnePlusBGController;->zta(Lcom/android/server/am/OnePlusBGController;)V
    ...
    invoke-static {p1}, Lcom/android/server/am/OnePlusBGController;->you(Lcom/android/server/am/OnePlusBGController;)V
    ...
    iget-object p2, p0, this$0:Lcom/android/server/am/OnePlusBGController;

    invoke-static {p2}, Lcom/android/server/am/OnePlusBGController;->vdw(Lcom/android/server/am/OnePlusBGController;)Landroid/util/SparseArray;
    ...
    invoke-virtual {p2}, Lcom/android/server/am/OnePlusBGController$wtn;->toString()Ljava/lang/String;

    move-result-object v0

    invoke-static {v0}, Lcom/android/server/am/OnePlusBGController;->myLog(Ljava/lang/String;)V

    invoke-virtual {p2}, Lcom/android/server/am/OnePlusBGController$wtn;->Bb()V
    ...
    invoke-static {p0}, Lcom/android/server/am/OnePlusBGController;->rtg(Lcom/android/server/am/OnePlusBGController;)Landroid/util/SparseArray;
    ...
    invoke-virtual {p0}, Lcom/android/server/am/OnePlusBGController$gck;->dump()V
    ...
    invoke-static {p0}, Lcom/android/server/am/OnePlusBGController;->sis(Lcom/android/server/am/OnePlusBGController;)V
    ...
    invoke-static {v3}, Lcom/android/server/am/OnePlusBGController;->access$1702(Z)Z
    ...
    invoke-static {v2}, Lcom/android/server/am/OnePlusBGController;->access$1702(Z)Z
    ...
    iget-object v0, p0, this$0:Lcom/android/server/am/OnePlusBGController;

    invoke-static {v0}, Lcom/android/server/am/OnePlusBGController;->tsu(Lcom/android/server/am/OnePlusBGController;)Lcom/android/server/am/BatteryStatsService;
    ...
    invoke-static {p0, p2}, Lcom/android/server/am/OnePlusBGController;->zta(Lcom/android/server/am/OnePlusBGController;I)V
    ...
    invoke-static {p0}, Lcom/android/server/am/OnePlusBGController;->access$2102(Z)Z
    ...
    invoke-static {}, Lcom/android/server/am/OnePlusBGController;->access$2200()Landroid/content/Context;
    ...
    invoke-static {v0}, Lcom/android/server/am/OnePlusBGController;->cno(Lcom/android/server/am/OnePlusBGController;)Ljava/util/HashMap;
    ...
    iget-object v1, p0, this$0:Lcom/android/server/am/OnePlusBGController;

    invoke-static {v1}, Lcom/android/server/am/OnePlusBGController;->cno(Lcom/android/server/am/OnePlusBGController;)Ljava/util/HashMap;
    ...
    invoke-static {p0}, Lcom/android/server/am/OnePlusBGController;->cno(Lcom/android/server/am/OnePlusBGController;)Ljava/util/HashMap;
    ...
    invoke-static {p2}, Lcom/android/server/am/OnePlusBGController;->cno(Lcom/android/server/am/OnePlusBGController;)Ljava/util/HashMap;
    ...
    invoke-static {p1}, Lcom/android/server/am/OnePlusBGController;->tsu(Lcom/android/server/am/OnePlusBGController;)Lcom/android/server/am/BatteryStatsService;
    ...
    invoke-static {p1}, Lcom/android/server/am/OnePlusBGController;->kth(Lcom/android/server/am/OnePlusBGController;)Lcom/android/internal/os/MyBatteryStatsHelper;
    ...
    iput-object v1, p2, Lcom/android/server/am/OnePlusBGController;->lq:Ljava/util/List;
    ...
    invoke-static {p2, v1, v3}, Lcom/android/server/am/OnePlusBGController;->zta(Lcom/android/server/am/OnePlusBGController;Ljava/lang/String;Lcom/android/internal/os/BatterySipper;)Ljava/lang/String;
    ...
    invoke-static {p2}, Lcom/android/server/am/OnePlusBGController;->bio(Lcom/android/server/am/OnePlusBGController;)Lcom/android/server/m;
    ...
    invoke-static {p2, v0}, Lcom/android/server/am/OnePlusBGController;->zta(Lcom/android/server/am/OnePlusBGController;Lcom/android/server/m;)Lcom/android/server/m;
    ...
    invoke-static {p0}, Lcom/android/server/am/OnePlusBGController;->bio(Lcom/android/server/am/OnePlusBGController;)Lcom/android/server/m;
    ...
    invoke-static {p2}, Lcom/android/server/am/OnePlusBGController;->igw(Lcom/android/server/am/OnePlusBGController;)Lcom/android/server/am/OnePlusBGController$RomType;
    ...
    invoke-static {p2}, Lcom/android/server/am/OnePlusBGController;->wtn(Lcom/android/server/am/OnePlusBGController;)Z
    ...
    invoke-static {p2}, Lcom/android/server/am/OnePlusBGController;->gck(Lcom/android/server/am/OnePlusBGController;)Z
    ...
    invoke-static {p2}, Lcom/android/server/am/OnePlusBGController;->dma(Lcom/android/server/am/OnePlusBGController;)I
    ...
    invoke-static {p2}, Lcom/android/server/am/OnePlusBGController;->ywr(Lcom/android/server/am/OnePlusBGController;)F
    ...
    invoke-static {p2}, Lcom/android/server/am/OnePlusBGController;->qbh(Lcom/android/server/am/OnePlusBGController;)F
    ...
    invoke-static {p2}, Lcom/android/server/am/OnePlusBGController;->oif(Lcom/android/server/am/OnePlusBGController;)F
    ...
    invoke-static {p2}, Lcom/android/server/am/OnePlusBGController;->bvj(Lcom/android/server/am/OnePlusBGController;)F
    ...
    invoke-static {p0}, Lcom/android/server/am/OnePlusBGController;->gwm(Lcom/android/server/am/OnePlusBGController;)V
