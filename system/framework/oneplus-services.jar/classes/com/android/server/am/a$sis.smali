.class public Lcom/android/server/am/a$sis;
...
.field private static mInstance:Lcom/android/server/am/a$sis;
...
.method static final checkAppInLaunchingProviders(Lcom/android/server/am/ProcessRecord;)V
    ...
    invoke-static {}, Lcom/android/server/am/a;->access$500()Lcom/android/server/am/ActivityManagerService;
...
.method static final checkProcessCanRestart(Lcom/android/server/am/ProcessRecord;)Z
    ...
    :cond_1
    invoke-static {}, getInstance()Lcom/android/server/am/a$sis;

    move-result-object v0

    invoke-direct {v0, p0}, vdb(Lcom/android/server/am/ProcessRecord;)Z
...
.method private static getInstance()Lcom/android/server/am/a$sis;
    .locals 1

    sget-object v0, mInstance:Lcom/android/server/am/a$sis;

    if-nez v0, :cond_0

    new-instance v0, Lcom/android/server/am/a$sis;

    invoke-direct {v0}, <init>()V

    sput-object v0, mInstance:Lcom/android/server/am/a$sis;
