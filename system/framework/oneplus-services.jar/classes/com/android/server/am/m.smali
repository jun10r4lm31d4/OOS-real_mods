...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/am/m$sis;,
        Lcom/android/server/am/m$zta;,
        Lcom/android/server/am/m$tsu;
    }
.end annotation


# static fields
.field private static final BA:Ljava/lang/String; = "persist.sys.ramboost.oliop"

.field private static final CA:Ljava/lang/String; = "/sys/module/fsc/parameters/enable"

.field private static final CONFIG_NAME:Ljava/lang/String; = "RamBoost"

.field private static final DA:Ljava/lang/String; = "persist.sys.ramboost.olmemplus"

.field private static final EA:Ljava/lang/String; = "persist.sys.ramboost.olmemplus_option"

.field private static final FA:Ljava/lang/String; = "persist.vendor.memplus.enable"

.field private static final GA:Ljava/lang/String; = "persist.sys.memplus.swappiness"

.field private static final HA:Ljava/lang/String; = "/proc/sys/vm/swappiness"

.field public static final IN_USING:Z

.field private static final JA:Ljava/lang/String; = "persist.sys.memplus.direct_swappiness"

.field private static final KA:Ljava/lang/String; = "/proc/sys/vm/direct_swappiness"
...
.field private static UA:I = 0x0

.field private static final VA:Ljava/lang/String; = "/system/etc/ramboost.xml"

.field private static final WA:J = 0x2710L

.field private static final XA:I = 0x384
...
.field private static final YA:Ljava/lang/String; = "0"

.field private static ZA:Ljava/io/File; = null

.field private static _A:Ljava/lang/String; = null

.field private static final aB:I = 0x3

.field private static final bB:I = 0x4

.field private static final bn:J = 0x5265c00L

.field private static final cB:I = 0x5

.field private static final dB:I = 0x6

.field private static final eB:I = 0x7

.field private static final fB:I = 0x8

.field private static final gB:I = 0x9

.field private static final hB:I = 0xa

.field private static final iB:I = 0xb

.field private static final jB:I = 0xc

.field private static final kB:I = 0xd

.field private static final lB:I = 0xe

.field private static mInstance:Lcom/android/server/am/m; = null

.field private static final nB:I = 0x10

.field private static final oB:Ljava/lang/String; = "ramboost"

.field private static final pB:Ljava/lang/String; = "ramboost"

.field private static final qB:Ljava/lang/String; = "hotcount"

.field private static final rB:Ljava/lang/String; = "ioppreload"

.field private static final sB:Ljava/lang/String; = "iop"

.field private static sDebug:Z = false

.field private static sEnable:Z = false

.field private static uA:Z = false

.field private static vA:Z = false

.field private static wA:Z = false

.field private static final xA:Ljava/lang/String; = "persist.sys.ramboost.ioppreload"

.field private static final yA:Ljava/lang/String; = "/sys/module/smartboost_core/parameters/page_cache_reside_switch"

.field private static final zA:Ljava/lang/String; = "persist.sys.ramboost.olhotcount"


# instance fields
.field private fA:Landroid/os/HandlerThread;

.field private gA:Lcom/android/server/am/m$sis;

.field private hA:Lcom/android/server/am/m$tsu;
...
.field private nA:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList<",
            "Ljava/lang/String;",
...
.field private qA:Lcom/android/server/am/H;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, IN_USING:Z

    sget-boolean v1, IN_USING:Z

    sput-boolean v1, sEnable:Z

    sput-boolean v1, uA:Z

    sput-boolean v0, vA:Z

    sput-boolean v2, sDebug:Z

    sput-boolean v1, wA:Z

    sput v1, UA:I

    const/4 v0, 0x0

    sput-object v0, mInstance:Lcom/android/server/am/m;

    const-string v0, "sys/module/memplus_core/parameters/memory_plus_wake_gcd"

    sput-object v0, _A:Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, fA:Landroid/os/HandlerThread;

    iput-object v0, p0, gA:Lcom/android/server/am/m$sis;

    iput-object v0, p0, mMyConfigObserver:Lcom/oneplus/config/ConfigObserver;
    ...
    iput-object v1, p0, jA:Ljava/util/HashMap;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, kA:Ljava/util/ArrayList;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, lA:Ljava/util/ArrayList;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, nA:Ljava/util/ArrayList;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, oA:Ljava/util/HashMap;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, pA:Ljava/util/ArrayList;

    iput-object v0, p0, qA:Lcom/android/server/am/H;
    ...
    iput-object v0, p0, sA:Ljava/util/List;

    const-string v0, ""

    iput-object v0, p0, tA:Ljava/lang/String;

    sget-boolean v0, IN_USING:Z
    ...
    iget-object v0, p0, fA:Landroid/os/HandlerThread;

    invoke-virtual {v0}, Landroid/os/HandlerThread;->start()V

    new-instance v0, Lcom/android/server/am/m$sis;

    iget-object v1, p0, fA:Landroid/os/HandlerThread;

    invoke-virtual {v1}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v1

    invoke-direct {v0, p0, v1}, Lcom/android/server/am/m$sis;-><init>(Lcom/android/server/am/m;Landroid/os/Looper;)V

    iput-object v0, p0, gA:Lcom/android/server/am/m$sis;

    sget-boolean p0, sEnable:Z
    ...
    sput-boolean p0, sEnable:Z

    sget-boolean p0, uA:Z
...
.method private Fa(Z)V
    ...
    :cond_0
    invoke-direct {p0}, Ko()Z

    move-result v0

    sput-boolean v0, wA:Z

    sget-boolean v0, wA:Z
    ...
    sget-boolean v2, wA:Z

    :cond_3
    sput-boolean v2, uA:Z
    ...
    invoke-direct {p0, v2, v1}, zgw(Ljava/lang/String;Ljava/lang/String;)V

    sget-boolean v1, uA:Z
    ...
    invoke-direct {p0, v4, p1}, echo(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1, v1}, echo(Ljava/lang/String;Ljava/lang/String;)Z
...
.method private Ho()Landroid/net/LocalSocket;
    .locals 2
...
.method private Io()V
    ...
    :cond_0
    iget-object v0, p0, oA:Ljava/util/HashMap;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, oA:Ljava/util/HashMap;
    ...
    iget-object v3, p0, oA:Ljava/util/HashMap;

    invoke-virtual {v3, v2}, Ljava/util/HashMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Lcom/android/server/am/m$zta;

    invoke-virtual {v2}, Ljava/lang/Integer;->intValue()I

    move-result v2

    invoke-direct {p0, v2}, Xb(I)Ljava/lang/String;

    move-result-object v2

    const-string v3, "0"

    invoke-direct {p0, v2, v3}, echo(Ljava/lang/String;Ljava/lang/String;)Z

    goto :goto_0

    :cond_1
    iget-object p0, p0, oA:Ljava/util/HashMap;
...
.method private Jo()Ljava/lang/String;
    ...
    iget-object v1, p0, pA:Ljava/util/ArrayList;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, pA:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, pA:Ljava/util/ArrayList;
...
.method private Lo()I
    ...
    iget-object v7, p0, jA:Ljava/util/HashMap;
    ...
    :try_start_1
    iget-object v8, p0, jA:Ljava/util/HashMap;
    ...
    :cond_7
    iget-object v5, p0, pA:Ljava/util/ArrayList;
    ...
    :try_start_5
    iget-object v6, p0, pA:Ljava/util/ArrayList;
...
.method private Mo()I
    ...
    :cond_0
    invoke-direct {p0}, Jo()Ljava/lang/String;
    ...
    invoke-direct {p0}, Ho()Landroid/net/LocalSocket;
...
.method private Vm()V
    ...
    iget-object v1, p0, jA:Ljava/util/HashMap;
    ...
    iget-object p0, p0, kA:Ljava/util/ArrayList;
...
.method private bc(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v0, p0, lA:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, lA:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, kA:Ljava/util/ArrayList;
...
.method private bio(III)Z
    ...
    invoke-direct {p0, p2, v1}, echo(Ljava/lang/String;Ljava/lang/String;)Z
...
.method private c(J)V
    ...
    :cond_0
    iget-object v0, p0, kA:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, qA:Lcom/android/server/am/H;

    const/4 v2, 0x0

    invoke-virtual {v1, v2}, Lcom/android/server/am/H;->qeg(Z)Ljava/util/ArrayList;
    ...
    iget-object p0, p0, gA:Lcom/android/server/am/m$sis;
...
.method private dc(Ljava/lang/String;)I
    .locals 4
...
.method private filterSuffix(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object p0, p0, sA:Ljava/util/List;
...
.method public static final getInstance()Lcom/android/server/am/m;
    .locals 2

    sget-object v0, mInstance:Lcom/android/server/am/m;
    ...
    sget-object v1, _A:Ljava/lang/String;

    invoke-direct {v0, v1}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    sput-object v0, ZA:Ljava/io/File;
...
.method private resolveConfigFromJSON(Lorg/json/JSONArray;)V
    ...
    iget-object v3, p0, jA:Ljava/util/HashMap;
    ...
    :try_start_1
    iget-object v4, p0, jA:Ljava/util/HashMap;
    ...
    iget-object v3, p0, pA:Ljava/util/ArrayList;
    ...
    :try_start_7
    iget-object v4, p0, pA:Ljava/util/ArrayList;
    ...
    :try_start_9
    iget-object v7, p0, pA:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, lA:Ljava/util/ArrayList;
    ...
    :try_start_d
    iget-object v4, p0, lA:Ljava/util/ArrayList;
    ...
    iget-object v6, p0, lA:Ljava/util/ArrayList;
    ...
    :try_start_f
    iget-object v7, p0, lA:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, nA:Ljava/util/ArrayList;
    ...
    :try_start_13
    iget-object v4, p0, nA:Ljava/util/ArrayList;
    ...
    iget-object v6, p0, nA:Ljava/util/ArrayList;
    ...
    :try_start_15
    iget-object v7, p0, nA:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v4, v3}, zgw(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v4, v3}, zta(Ljava/lang/String;Lorg/json/JSONArray;)V
    ...
    invoke-direct {p0, v3, v2}, zta(Ljava/lang/String;Lorg/json/JSONArray;)V
...
.method static synthetic rtg(Lcom/android/server/am/m;)I
    .locals 0
...
.method static synthetic sis(Lcom/android/server/am/m;)I
    .locals 0

    invoke-direct {p0}, Mo()I
...
.method private ssp(IILjava/lang/String;)Z
    ...
    invoke-direct {p0, p3, p1, v0}, you(Ljava/lang/String;IZ)I

    move-result v0

    invoke-direct {p0, p1, p2, v0}, bio(III)Z
...
.method static synthetic tsu(Lcom/android/server/am/m;)V
    .locals 0
...
.method private updateOnlineConfig()V
    ...
    invoke-direct {p0, v0}, resolveConfigFromJSON(Lorg/json/JSONArray;)V

    return-void
.end method

.method private you(ILjava/lang/String;Ljava/lang/String;)I
    .locals 6

    iget-object v0, p0, pA:Ljava/util/ArrayList;
    ...
    iput-object p1, p0, tA:Ljava/lang/String;

    iget-object p1, p0, gA:Lcom/android/server/am/m$sis;
...
.method static synthetic you(Lcom/android/server/am/m;)V
    ...
    invoke-direct {p0}, updateOnlineConfig()V
...
.method private you(Ljava/lang/String;Ljava/lang/String;I)Z
    ...
    invoke-direct {p0, p3}, Xb(I)Ljava/lang/String;

    move-result-object v0

    invoke-direct {p0, v0, p2}, echo(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :try_start_0
    iget-object v2, p0, oA:Ljava/util/HashMap;

    invoke-static {p3}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v3

    new-instance v4, Lcom/android/server/am/m$zta;

    invoke-direct {v4, p0, p1, p2, p3}, Lcom/android/server/am/m$zta;-><init>(Lcom/android/server/am/m;Ljava/lang/String;Ljava/lang/String;I)V
...
.method static synthetic zta(Lcom/android/server/am/m;ILjava/lang/String;Ljava/lang/String;)I
    .locals 0

    invoke-direct {p0, p1, p2, p3}, you(ILjava/lang/String;Ljava/lang/String;)I
...
.method static synthetic zta(Lcom/android/server/am/m;Ljava/lang/String;)I
    .locals 0

    invoke-direct {p0, p1}, dc(Ljava/lang/String;)I
...
.method static synthetic zta(Lcom/android/server/am/m;Ljava/lang/String;IZ)I
    .locals 0

    invoke-direct {p0, p1, p2, p3}, you(Ljava/lang/String;IZ)I
...
.method static synthetic zta(Lcom/android/server/am/m;)Lcom/android/server/am/m$sis;
    .locals 0
...
.method static synthetic zta(Lcom/android/server/am/m;J)V
    .locals 0

    invoke-direct {p0, p1, p2}, c(J)V

    return-void
.end method

.method static synthetic zta(Lcom/android/server/am/m;Lorg/json/JSONArray;)V
    .locals 0
...
.method static synthetic zta(Lcom/android/server/am/m;Z)V
    .locals 0

    invoke-direct {p0, p1}, Fa(Z)V
...
.method private zta(Ljava/lang/String;Lorg/json/JSONArray;)V
    ...
    invoke-direct {p0, p1, v3}, zgw(Ljava/lang/String;Ljava/lang/String;)V
...
.method static synthetic zta(Lcom/android/server/am/m;I)Z
    .locals 0

    invoke-direct {p0, p1}, Yb(I)Z
...
.method static synthetic zta(Lcom/android/server/am/m;III)Z
    .locals 0

    invoke-direct {p0, p1, p2, p3}, bio(III)Z
...
.method static synthetic zta(Lcom/android/server/am/m;IILjava/lang/String;)Z
    .locals 0

    invoke-direct {p0, p1, p2, p3}, ssp(IILjava/lang/String;)Z
...
.method static synthetic zta(Lcom/android/server/am/m;Ljava/lang/String;Ljava/lang/String;I)Z
    .locals 0

    invoke-direct {p0, p1, p2, p3}, you(Ljava/lang/String;Ljava/lang/String;I)Z
...
.method public initEnv(Landroid/content/Context;)V
    ...
    new-instance v0, Lcom/android/server/am/m$tsu;

    iget-object v1, p0, gA:Lcom/android/server/am/m$sis;

    invoke-direct {v0, p0, p1, v1}, Lcom/android/server/am/m$tsu;-><init>(Lcom/android/server/am/m;Landroid/content/Context;Landroid/os/Handler;)V

    iput-object v0, p0, hA:Lcom/android/server/am/m$tsu;
    ...
    iput-object p1, p0, iA:Landroid/net/Uri;

    invoke-static {}, Lcom/android/server/am/H;->getInstance()Lcom/android/server/am/H;

    move-result-object p1

    iput-object p1, p0, qA:Lcom/android/server/am/H;
    ...
    iget-object v0, p0, iA:Landroid/net/Uri;

    const/4 v1, 0x0

    iget-object p0, p0, hA:Lcom/android/server/am/m$tsu;
...
.method public initOnlineConfig(Landroid/content/Context;)V
    ...
    invoke-direct {v2, p0}, Lcom/android/server/am/m$you;-><init>(Lcom/android/server/am/m;)V
...
.method public notifyIOPrefetchStart(ILjava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p2, p0, tA:Ljava/lang/String;

    goto :goto_0

    :cond_1
    iget-object v0, p0, tA:Ljava/lang/String;
    ...
    :cond_2
    :goto_0
    iget-object v0, p0, nA:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, nA:Ljava/util/ArrayList;
...
.method public notifyRamBoost(Ljava/lang/String;IZ)V
    ...
    iget-object p3, p0, jA:Ljava/util/HashMap;

    monitor-enter p3

    :try_start_0
    iget-object v2, p0, jA:Ljava/util/HashMap;
    ...
    invoke-direct {p0, p1}, bc(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_4
    iget-object p1, p0, oA:Ljava/util/HashMap;
...
.method public zc()V
    ...
    :try_start_0
    sget-object p0, ZA:Ljava/io/File;
    ...
    sget-object v0, ZA:Ljava/io/File;
