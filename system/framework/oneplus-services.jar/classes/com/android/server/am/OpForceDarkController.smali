...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/am/OpForceDarkController$zta;,
        Lcom/android/server/am/OpForceDarkController$tsu;,
        Lcom/android/server/am/OpForceDarkController$sis;
    }
.end annotation
...
.field private final mGeneralAppConfig:Lcom/android/server/am/OpForceDarkController$zta;

.field private final mGlobalFallbackConfig:Lcom/android/server/am/OpForceDarkController$you;
...
.method static constructor <clinit>()V
    ...
    const-string v1, "persist.oneplus.debug.fd_log_high"

    invoke-static {v1, v0}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v1

    sput-boolean v1, sDevHighFreqLogEnable:Z

    sget-boolean v1, Landroid/os/Build;->DEBUG_ONEPLUS:Z

    if-eqz v1, :cond_0

    sget-boolean v1, sDevHighFreqLogEnable:Z
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, mOnlineFetched:Z

    iput-boolean v0, p0, mIsInit:Z

    iput v0, p0, mSysVersionCode:I

    new-instance v0, Lcom/android/server/am/OpForceDarkController$zta;

    invoke-direct {v0, p0}, Lcom/android/server/am/OpForceDarkController$zta;-><init>(Lcom/android/server/am/OpForceDarkController;)V

    iput-object v0, p0, mGeneralAppConfig:Lcom/android/server/am/OpForceDarkController$zta;

    new-instance v0, Lcom/android/server/am/OpForceDarkController$you;

    invoke-direct {v0, p0}, Lcom/android/server/am/OpForceDarkController$you;-><init>(Lcom/android/server/am/OpForceDarkController;)V

    iput-object v0, p0, mGlobalFallbackConfig:Lcom/android/server/am/OpForceDarkController$you;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, mRawOnlineConfigs:Ljava/util/HashMap;
    ...
    iput-object v0, p0, mRefinedEffectiveConfigs:Landroid/util/LruCache;

    const-wide/16 v0, -0x1

    iput-wide v0, p0, mLastChangeTime:J

    new-instance v0, Lcom/android/server/am/w;

    iget-object v1, p0, mHandler:Landroid/os/Handler;

    invoke-direct {v0, p0, v1}, Lcom/android/server/am/w;-><init>(Lcom/android/server/am/OpForceDarkController;Landroid/os/Handler;)V

    iput-object v0, p0, mOnOffObserver:Landroid/database/ContentObserver;
    ...
    iput-object v0, p0, mSpecialVisibleApps:Ljava/util/HashSet;
...
.method static synthetic access$000(Lcom/android/server/am/OpForceDarkController;)J
    ...
    iget-wide v0, p0, mLastChangeTime:J
...
.method static synthetic access$002(Lcom/android/server/am/OpForceDarkController;J)J
    ...
    iput-wide p1, p0, mLastChangeTime:J
...
.method static synthetic access$100(Lcom/android/server/am/OpForceDarkController;)V
    ...
    invoke-direct {p0}, killAbnormalApp()V
...
.method static synthetic access$1000(Lcom/android/server/am/OpForceDarkController;Z)V
    ...
    invoke-direct {p0, p1}, scheduleFetchConfig(Z)V
...
.method static synthetic access$1100(Lcom/android/server/am/OpForceDarkController;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, handleFetchConfig(Ljava/lang/String;)V
...
.method static synthetic access$1300(Lcom/android/server/am/OpForceDarkController;)V
    ...
    invoke-direct {p0}, updateAppOps()V
...
.method static synthetic access$1400(Lcom/android/server/am/OpForceDarkController;Landroid/os/Message;)V
    ...
    invoke-direct {p0, p1}, handlePackageChange(Landroid/os/Message;)V

    return-void
.end method

.method static synthetic access$1500(Lcom/android/server/am/OpForceDarkController;Ljava/lang/String;I)I
    .locals 0

    invoke-direct {p0, p1, p2}, getPackageUid(Ljava/lang/String;I)I
...
.method static synthetic access$1600(Lcom/android/server/am/OpForceDarkController;I)Ljava/lang/String;
    .locals 0

    invoke-direct {p0, p1}, debugGetStateDesc(I)Ljava/lang/String;
...
.method static synthetic access$1700(Lcom/android/server/am/OpForceDarkController;)Landroid/content/Context;
    .locals 0
...
.method static synthetic access$1900(Lcom/android/server/am/OpForceDarkController;Lcom/android/server/am/OpForceDarkController$zta;I)V
    .locals 0

    invoke-direct {p0, p1, p2}, scheduleNotifyChangedApp(Lcom/android/server/am/OpForceDarkController$zta;I)V
...
.method static synthetic access$200(Lcom/android/server/am/OpForceDarkController;Ljava/lang/String;Z)V
    ...
    invoke-direct {p0, p1, p2}, debugLog(Ljava/lang/String;Z)V

    return-void
.end method

.method static synthetic access$2000(Lcom/android/server/am/OpForceDarkController;)Lcom/android/server/am/OpForceDarkController$you;
    .locals 0

    iget-object p0, p0, mGlobalFallbackConfig:Lcom/android/server/am/OpForceDarkController$you;
...
.method static synthetic access$400(Lcom/android/server/am/OpForceDarkController;Ljava/lang/String;I)Ljava/util/List;
    ...
    invoke-direct {p0, p1, p2}, findTargetAppThread(Ljava/lang/String;I)Ljava/util/List;
...
.method static synthetic access$700(Lcom/android/server/am/OpForceDarkController;Ljava/lang/String;Z)Lcom/android/server/am/OpForceDarkController$zta;
    .locals 0

    invoke-direct {p0, p1, p2}, getEffectiveConfigForApp(Ljava/lang/String;Z)Lcom/android/server/am/OpForceDarkController$zta;
...
.method static synthetic access$800(Lcom/android/server/am/OpForceDarkController;)Landroid/app/AppOpsManager;
    ...
    iget-object p0, p0, mAppOps:Landroid/app/AppOpsManager;
...
.method static synthetic access$900(Lcom/android/server/am/OpForceDarkController;Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1}, hasEnableParallel(Ljava/lang/String;)Z
...
.method private cacheEffectiveConfig(Lcom/android/server/am/OpForceDarkController$zta;)V
    .locals 3
    ...
    :cond_0
    iget-object v0, p0, mRefinedEffectiveConfigs:Landroid/util/LruCache;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, mRefinedEffectiveConfigs:Landroid/util/LruCache;

    invoke-virtual {p1}, Lcom/android/server/am/OpForceDarkController$zta;->kb()Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lcom/android/server/am/OpForceDarkController$zta;->Ac()Ljava/lang/String;
    ...
    iget-object p1, p0, mRefinedEffectiveConfigs:Landroid/util/LruCache;
    ...
    invoke-direct {p0, p1, v1}, debugLog(Ljava/lang/String;Z)V
...
.method private fetchLocalDefaultConfigs()V
    ...
    :try_start_0
    invoke-direct {p0}, readLocalConfigJsonString()Ljava/lang/String;
    ...
    invoke-direct {p0, v1}, parseGlobalDefConfig(Lorg/json/JSONArray;)V

    invoke-direct {p0, v1}, parseAppsConfig(Lorg/json/JSONArray;)V
...
.method private findTargetAppThread(Ljava/lang/String;I)Ljava/util/List;
    ...
    invoke-direct {p0, p1}, isUserVisibleApplication(Ljava/lang/String;)Z
    ...
    :goto_0
    :try_start_0
    iget-object v2, p0, mAMS:Lcom/android/server/am/ActivityManagerService;
    ...
    invoke-direct {p0, v3, v4}, debugLog(Ljava/lang/String;Z)V
...
.method private getAllPackages()Ljava/util/List;
    ...
    iget-object p0, p0, mPM:Landroid/content/pm/IPackageManager;
...
.method private getCopyOfRawConfigForApp(Ljava/lang/String;)Lcom/android/server/am/OpForceDarkController$zta;
    .locals 2

    iget-object v0, p0, mRawOnlineConfigs:Ljava/util/HashMap;

    invoke-virtual {v0, p1}, Ljava/util/HashMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcom/android/server/am/OpForceDarkController$zta;
    ...
    invoke-direct {p0, v0, v1}, debugLog(Ljava/lang/String;Z)V

    iget-object p0, p0, mGeneralAppConfig:Lcom/android/server/am/OpForceDarkController$zta;

    invoke-virtual {p0}, Lcom/android/server/am/OpForceDarkController$zta;->clone()Lcom/android/server/am/OpForceDarkController$zta;

    move-result-object p0

    invoke-virtual {p0, p1}, Lcom/android/server/am/OpForceDarkController$zta;->y(Ljava/lang/String;)V

    goto :goto_0

    :cond_0
    invoke-virtual {v0}, Lcom/android/server/am/OpForceDarkController$zta;->clone()Lcom/android/server/am/OpForceDarkController$zta;

    move-result-object p0

    :goto_0
    invoke-static {p0}, Lcom/android/server/am/OpForceDarkController$zta;->you(Lcom/android/server/am/OpForceDarkController$zta;)V

    return-object p0
.end method

.method private getEffectiveConfigForApp(Ljava/lang/String;Z)Lcom/android/server/am/OpForceDarkController$zta;
    .locals 2
    ...
    check-cast v1, Lcom/android/server/am/OpForceDarkController$zta;
    ...
    invoke-direct {p0, p1, p2}, updatePkgAppOpsForUser(Ljava/lang/String;I)V

    iget-object p2, p0, mRefinedEffectiveConfigs:Landroid/util/LruCache;

    invoke-virtual {p2, p1}, Landroid/util/LruCache;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p2

    check-cast p2, Lcom/android/server/am/OpForceDarkController$zta;
    ...
    invoke-virtual {v1, p1}, Lcom/android/server/am/OpForceDarkController$zta;->y(Ljava/lang/String;)V
...
.method private getUserVisiblePackages()Ljava/util/HashSet;
    ...
    invoke-direct {p0, v5, v2}, debugLog(Ljava/lang/String;Z)V
    ...
    :cond_1
    iget-object v3, p0, mSpecialVisibleApps:Ljava/util/HashSet;
    ...
    invoke-direct {p0, v0, v2}, debugLog(Ljava/lang/String;Z)V
...
.method private getVersionCode(Ljava/lang/String;)I
    ...
    iget-object v0, p0, mPM:Landroid/content/pm/IPackageManager;
...
.method private handleFetchConfig(Ljava/lang/String;)V
    ...
    iget-boolean v0, p0, mOnlineFetched:Z
    ...
    invoke-direct {p0}, fetchLocalDefaultConfigs()V
    ...
    invoke-direct {p0, p1}, parseGlobalDefConfig(Lorg/json/JSONArray;)V

    invoke-direct {p0, p1}, parseAppsConfig(Lorg/json/JSONArray;)V

    const-string p1, "Update Config Done----------------"

    invoke-static {v2, p1}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    iput-boolean v1, p0, mOnlineFetched:Z
...
.method private handlePackageChange(Landroid/os/Message;)V
    ...
    :try_start_0
    iget-object p0, p0, mRefinedEffectiveConfigs:Landroid/util/LruCache;
    ...
    :cond_3
    invoke-direct {p0, v0, p1}, updatePkgAppOpsForUser(Ljava/lang/String;I)V
...
.method private initAppOps()V
    ...
    invoke-direct {p0}, registerAppOpsChangeListener()V
...
.method private initOnlineConfig()V
    ...
    invoke-direct {v0, p0}, Lcom/android/server/am/z;-><init>(Lcom/android/server/am/OpForceDarkController;)V
    ...
    invoke-direct {p0, v0}, scheduleFetchConfig(Z)V
...
.method private isNewDifferentConfig(Lcom/android/server/am/OpForceDarkController$zta;)Z
    .locals 3
    ...
    check-cast p0, Lcom/android/server/am/OpForceDarkController$zta;

    if-eqz p0, :cond_1

    invoke-virtual {p0, p1}, Lcom/android/server/am/OpForceDarkController$zta;->sis(Lcom/android/server/am/OpForceDarkController$zta;)Z
...
.method private isUserVisibleApplication(Ljava/lang/String;)Z
    ...
    :goto_0
    iget-object p0, p0, mSpecialVisibleApps:Ljava/util/HashSet;
...
.method private killAbnormalApp()V
    ...
    invoke-direct {p0, v0}, killPidForce(Ljava/util/ArrayList;)V
...
.method private killPidForce(Ljava/util/ArrayList;)V
    ...
    invoke-direct {p0, p1, v0}, debugLog(Ljava/lang/String;Z)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method private parseAppsConfig(Lorg/json/JSONArray;)V
    ...
    :cond_0
    iget-object v2, p0, mRawOnlineConfigs:Ljava/util/HashMap;
    ...
    new-instance v4, Lcom/android/server/am/OpForceDarkController$zta;

    invoke-direct {v4, p0}, Lcom/android/server/am/OpForceDarkController$zta;-><init>(Lcom/android/server/am/OpForceDarkController;)V

    invoke-virtual {v4, v3}, Lcom/android/server/am/OpForceDarkController$zta;->you(Lorg/json/JSONObject;)Z

    move-result v3

    if-eqz v3, :cond_1

    iget-object v3, p0, mRawOnlineConfigs:Ljava/util/HashMap;

    invoke-virtual {v4}, Lcom/android/server/am/OpForceDarkController$zta;->kb()Ljava/lang/String;
    ...
    iget-object p0, p0, mRawOnlineConfigs:Ljava/util/HashMap;
...
.method private parseGlobalDefConfig(Lorg/json/JSONArray;)V
    ...
    iget-object p1, p0, mGeneralAppConfig:Lcom/android/server/am/OpForceDarkController$zta;

    invoke-virtual {p1, v2}, Lcom/android/server/am/OpForceDarkController$zta;->you(Lorg/json/JSONObject;)Z
    ...
    iget-object v1, p0, mGeneralAppConfig:Lcom/android/server/am/OpForceDarkController$zta;

    invoke-virtual {v1}, Lcom/android/server/am/OpForceDarkController$zta;->Ac()Ljava/lang/String;
...
.method private parseOPFDVersionCode()V
    ...
    iput-object v1, p0, mVersionDesc:Ljava/lang/String;
    ...
    iget-object p0, p0, mVersionDesc:Ljava/lang/String;
...
.method private registerAppOpsChangeListener()V
    ...
    invoke-direct {p0}, getUserVisiblePackages()Ljava/util/HashSet;
    ...
    iget-object v4, p0, mAppOpsChangedListener:Landroid/app/AppOpsManager$OnOpChangedListener;
...
.method private scheduleNotifyChangedApp(Lcom/android/server/am/OpForceDarkController$zta;I)V
    .locals 2
    ...
    new-instance v1, Lcom/android/server/am/OpForceDarkController$sis;

    invoke-direct {v1, p0, p1, p2}, Lcom/android/server/am/OpForceDarkController$sis;-><init>(Lcom/android/server/am/OpForceDarkController;Lcom/android/server/am/OpForceDarkController$zta;I)V
...
.method private scheduleUpdateAppOpsDelay(J)V
    ...
    invoke-direct {v1, p0, p1, p2}, Lcom/android/server/am/A;-><init>(Lcom/android/server/am/OpForceDarkController;J)V
...
.method private shouldForceDarkStartingWindow(Ljava/lang/String;I)Z
    ...
    invoke-direct {p0, p1, v0}, getEffectiveConfigForApp(Ljava/lang/String;Z)Lcom/android/server/am/OpForceDarkController$zta;

    move-result-object p1

    iget-object v1, p0, mContext:Landroid/content/Context;

    invoke-direct {p0, v1}, isNightMode(Landroid/content/Context;)Z

    move-result v1

    iget-object v2, p0, mContext:Landroid/content/Context;

    invoke-direct {p0, v2}, isForceDarkMode(Landroid/content/Context;)Z

    move-result p0

    invoke-virtual {p1, p2}, Lcom/android/server/am/OpForceDarkController$zta;->r(I)Lcom/android/server/am/OpForceDarkController$you;

    move-result-object p2

    iget p2, p2, Lcom/android/server/am/OpForceDarkController$you;->enable:I
    ...
    invoke-static {p1}, Lcom/android/server/am/OpForceDarkController$zta;->zta(Lcom/android/server/am/OpForceDarkController$zta;)Z
...
.method private startWatchChange(Landroid/content/Context;)V
    ...
    iget-object p0, p0, mOnOffObserver:Landroid/database/ContentObserver;
...
.method private updateAppOps()V
    ...
    invoke-direct {p0, v1, v2}, updatePkgAppOpsForUser(Ljava/lang/String;I)V

    invoke-direct {p0, v1}, hasEnableParallel(Ljava/lang/String;)Z
...
.method private updatePkgAppOps(Ljava/lang/String;II)V
    ...
    invoke-direct {p0, p1, v0}, updatePkgAppOpsForUser(Ljava/lang/String;I)V
    ...
    invoke-direct {p0, p1}, getCopyOfRawConfigForApp(Ljava/lang/String;)Lcom/android/server/am/OpForceDarkController$zta;

    move-result-object v2

    invoke-virtual {v2, v0, p2}, Lcom/android/server/am/OpForceDarkController$zta;->oif(II)I

    move-result v3

    if-ne v3, v0, :cond_3

    invoke-direct {p0, v2}, isNewDifferentConfig(Lcom/android/server/am/OpForceDarkController$zta;)Z
    ...
    :cond_3
    :goto_0
    invoke-direct {p0, v2}, cacheEffectiveConfig(Lcom/android/server/am/OpForceDarkController$zta;)V

    :goto_1
    invoke-direct {p0, v2, p2}, scheduleNotifyChangedApp(Lcom/android/server/am/OpForceDarkController$zta;I)V
    ...
    :cond_5
    invoke-virtual {v2}, Lcom/android/server/am/OpForceDarkController$zta;->Dc()Z
    ...
    invoke-direct {p0, v0, p3}, debugLog(Ljava/lang/String;Z)V
...
.method private updatePkgAppOpsForUser(Ljava/lang/String;I)V
    ...
    invoke-direct {p0, p1, v0, p2}, updatePkgAppOps(Ljava/lang/String;II)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public dispatchForceDarkConfig(Landroid/app/IApplicationThread;Landroid/content/pm/ApplicationInfo;)V
    ...
    invoke-direct {p0, v1}, isUserVisibleApplication(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1, v2}, debugLog(Ljava/lang/String;Z)V

    return-void

    :cond_1
    iget-boolean v1, p0, mIsInit:Z
    ...
    invoke-direct {p0, v1, v2}, getEffectiveConfigForApp(Ljava/lang/String;Z)Lcom/android/server/am/OpForceDarkController$zta;

    move-result-object v1

    iget v3, p2, Landroid/content/pm/ApplicationInfo;->uid:I

    invoke-virtual {v1, v3}, Lcom/android/server/am/OpForceDarkController$zta;->q(I)Ljava/lang/String;
...
.method public handleStartingWindow(Landroid/view/View;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p2, v0}, shouldForceDarkStartingWindow(Ljava/lang/String;I)Z
    ...
    const-string v3, "handle Starting Window for { "
    ...
    invoke-direct {p0, p2, v2}, debugLog(Ljava/lang/String;Z)V
    ...
    invoke-static {p1, p1, p1, p1}, Lcom/oneplus/theme/OpForceDarkInjector;->convertToOPFDStateSet(ZZZZ)I
    ...
    :cond_1
    invoke-static {v2, v2, v2, v2}, Lcom/oneplus/theme/OpForceDarkInjector;->convertToOPFDStateSet(ZZZZ)I

    move-result p1

    :goto_0
    invoke-virtual {p0, p1}, Landroid/view/ViewRootImpl;->opSysForceONOFF(I)V

    goto :goto_1

    :cond_2
    new-instance p2, Lcom/android/server/am/x;

    invoke-direct {p2, p0, v0, p1}, Lcom/android/server/am/x;-><init>(Lcom/android/server/am/OpForceDarkController;ZLandroid/view/View;)V
...
.method public init(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/wm/ActivityTaskManagerService;Landroid/content/pm/IPackageManager;)V
    ...
    invoke-direct {p0, v0, p2}, debugLog(Ljava/lang/String;Z)V
    ...
    iput-object p3, p0, mPM:Landroid/content/pm/IPackageManager;

    iput-object p1, p0, mAMS:Lcom/android/server/am/ActivityManagerService;

    new-instance p1, Lcom/android/server/am/OpForceDarkController$tsu;

    iget-object p2, p0, mAMS:Lcom/android/server/am/ActivityManagerService;
    ...
    invoke-direct {p1, p0, p2}, Lcom/android/server/am/OpForceDarkController$tsu;-><init>(Lcom/android/server/am/OpForceDarkController;Landroid/os/Looper;)V
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/am/OpForceDarkController$zta;->y(Ljava/lang/String;)V

    iget-object p1, p0, mGlobalFallbackConfig:Lcom/android/server/am/OpForceDarkController$you;

    const/4 p2, 0x1

    iput-boolean p2, p1, Lcom/android/server/am/OpForceDarkController$you;->FB:Z

    invoke-direct {p0}, parseOPFDVersionCode()V

    invoke-direct {p0}, initOnlineConfig()V

    invoke-direct {p0}, initAppOps()V

    const-wide/16 v0, 0x2710

    invoke-direct {p0, v0, v1}, scheduleUpdateAppOpsDelay(J)V

    iget-object p1, p0, mContext:Landroid/content/Context;

    invoke-direct {p0, p1}, startWatchChange(Landroid/content/Context;)V

    iput-boolean p2, p0, mIsInit:Z
...
.method public notifyPackageChanged(Ljava/lang/String;ILjava/lang/String;)V
    ...
    invoke-direct {p0, v1, v2}, debugLog(Ljava/lang/String;Z)V
