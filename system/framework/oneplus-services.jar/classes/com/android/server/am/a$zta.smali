.class public Lcom/android/server/am/a$zta;
...
.field private static mInstance:Lcom/android/server/am/a$zta;

.field private static mv:Ljava/util/List;
...
.field private static nv:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
.field private static ov:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private static pv:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList<",
            "Ljava/lang/String;",
...
.field private static rv:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
.field private static sv:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
.field private static tv:Landroid/util/ArrayMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method static constructor <clinit>()V
    ...
    sput-object v0, mv:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, nv:Ljava/util/List;
    ...
    sput-object v0, ov:Ljava/util/ArrayList;
    ...
    sput-object v0, pv:Ljava/util/ArrayList;
    ...
    sput-object v0, qv:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, rv:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, sv:Ljava/util/List;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    sput-object v0, tv:Landroid/util/ArrayMap;
...
.method private constructor <init>()V
    ...
    sget-object v1, tv:Landroid/util/ArrayMap;

    const-string v2, "android.intent.action.ANY_DATA_STATE"

    invoke-virtual {v1, v2, v0}, Landroid/util/ArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    invoke-direct {p0}, ho()V
...
.method private Vb(Ljava/lang/String;)Z
    ...
    sget-object p0, pv:Ljava/util/ArrayList;

    monitor-enter p0

    :try_start_0
    sget-object v0, pv:Ljava/util/ArrayList;
...
.method private Wb(Ljava/lang/String;)Z
    ...
    sget-object p0, ov:Ljava/util/ArrayList;

    monitor-enter p0

    :try_start_0
    sget-object v0, ov:Ljava/util/ArrayList;
...
.method static synthetic access$200()Ljava/util/List;
    ...
    sget-object v0, sv:Ljava/util/List;
...
.method static final checkBroadcastIsPackageCanStart(Lcom/android/server/am/BroadcastQueue;Landroid/content/pm/ResolveInfo;Lcom/android/server/am/BroadcastRecord;)Z
    ...
    :cond_3
    invoke-static {}, getInstance()Lcom/android/server/am/a$zta;

    move-result-object v2

    invoke-direct {v2, v1, p2}, zta(Landroid/content/pm/ApplicationInfo;Lcom/android/server/am/BroadcastRecord;)Z
...
.method private static getInstance()Lcom/android/server/am/a$zta;
    .locals 1

    sget-object v0, mInstance:Lcom/android/server/am/a$zta;

    if-nez v0, :cond_0

    new-instance v0, Lcom/android/server/am/a$zta;

    invoke-direct {v0}, <init>()V

    sput-object v0, mInstance:Lcom/android/server/am/a$zta;
...
.method public static hc()V
    ...
    invoke-static {v0}, Lcom/android/server/am/a;->q(Ljava/lang/String;)Ljava/util/List;
    ...
    sget-object v1, nv:Ljava/util/List;
    ...
    sget-object v2, mv:Ljava/util/List;
    ...
    sget-object v2, rv:Ljava/util/List;
    ...
    sget-object v1, rv:Ljava/util/List;

    invoke-direct {v0, v1}, setBlackAlarm(Ljava/util/List;)V
...
.method private ho()V
    ...
    sget-object p0, sv:Ljava/util/List;
...
.method public static rtg(Ljava/util/List;)V
    ...
    sget-object v0, mv:Ljava/util/List;

    monitor-enter v0

    :try_start_0
    sget-object v1, mv:Ljava/util/List;
...
.method private setBlackAlarm(Ljava/util/List;)V
    ...
    sget-boolean p0, Lcom/android/server/am/a;->DEBUG:Z
...
.method static final skipBroadcastLocked(Lcom/android/server/am/BroadcastFilter;Lcom/android/server/am/BroadcastRecord;Z)Z
    ...
    invoke-direct {v2, v3, p1, p2}, zta(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/BroadcastRecord;Z)Z
...
.method static final skipBroadcastLocked(Lcom/android/server/am/BroadcastQueue;Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/BroadcastRecord;)Z
    ...
    invoke-direct {v2, p1, p2, v3}, zta(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/BroadcastRecord;Z)Z
...
.method public static ssp(Ljava/util/List;)V
    ...
    sget-object v0, rv:Ljava/util/List;
    ...
    invoke-direct {p0, v0}, setBlackAlarm(Ljava/util/List;)V
...
.method public static tsu(Ljava/util/List;)V
    ...
    sget-object v0, nv:Ljava/util/List;
...
.method private vdb(Ljava/lang/String;Ljava/lang/String;)Z
    .locals 1

    sget-object p0, tv:Landroid/util/ArrayMap;

    monitor-enter p0

    :try_start_0
    sget-object v0, tv:Landroid/util/ArrayMap;
...
.method private zta(Landroid/content/pm/ApplicationInfo;Lcom/android/server/am/BroadcastRecord;)Z
    ...
    invoke-static {p0}, Lcom/android/server/am/ivd;->j(I)Z
    ...
    invoke-static {p0}, Lcom/android/server/am/ivd;->k(I)Z
    ...
    invoke-virtual {p0, v3}, Lcom/android/server/OnePlusUtil$you;->ywr(I)Z
...
.method private zta(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/BroadcastRecord;Z)Z
    ...
    :cond_3
    invoke-static {p1}, Lcom/android/server/am/a;->you(Lcom/android/server/am/ProcessRecord;)Z
    ...
    invoke-direct {p0, v0, v4}, vdb(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :cond_5
    sget-object v4, mv:Ljava/util/List;

    monitor-enter v4

    :try_start_0
    sget-object v5, mv:Ljava/util/List;
    ...
    invoke-virtual {p0, v1}, Lcom/android/server/OnePlusUtil$you;->ywr(I)Z
    ...
    sget-object p0, qv:Ljava/util/ArrayList;
    ...
    :cond_c
    :goto_0
    invoke-static {}, Lcom/android/server/am/a;->access$400()Z
    ...
    sget-object v2, sv:Ljava/util/List;
    ...
    :cond_e
    invoke-direct {p0, v0}, Wb(Ljava/lang/String;)Z
    ...
    invoke-virtual {v1}, Lcom/android/server/OnePlusUtil$zta;->P()I
    ...
    invoke-virtual {v1, v2}, Lcom/android/server/OnePlusUtil$you;->ywr(I)Z

    move-result v1

    if-nez v1, :cond_14

    invoke-direct {p0, v0}, Vb(Ljava/lang/String;)Z
    ...
    :cond_12
    sget-object p0, rv:Ljava/util/List;
