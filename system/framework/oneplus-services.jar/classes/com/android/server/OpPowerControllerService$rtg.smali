...
# static fields
.field private static final fh:Ljava/lang/String; = "idle-records.xml"
...
.field private ch:Ljava/time/LocalTime;

.field private dh:Ljava/time/Duration;

.field private eh:Ljava/time/LocalDateTime;
...
.method public constructor <init>(Lcom/android/server/OpPowerControllerService;)V
    ...
    iput-object p1, p0, this$0:Lcom/android/server/OpPowerControllerService;
    ...
    iput-object p1, p0, bh:Ljava/util/ArrayList;
...
.method private you(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    iget-object v12, v1, this$0:Lcom/android/server/OpPowerControllerService;
    ...
    invoke-virtual {v12, v11}, sis(Ljava/time/LocalDateTime;)V
    :try_end_2
    ...
    iget-object v5, v1, this$0:Lcom/android/server/OpPowerControllerService;
    ...
    invoke-virtual {v5, v11}, sis(Ljava/time/LocalDateTime;)V
    ...
    iget-object v9, v1, this$0:Lcom/android/server/OpPowerControllerService;
    ...
    :cond_9
    invoke-virtual {v8}, Lcom/android/server/OpPowerControllerService$tsu;->Y()Ljava/time/LocalDateTime;

    move-result-object v9

    if-eqz v9, :cond_a

    invoke-virtual {v8}, Lcom/android/server/OpPowerControllerService$tsu;->X()Ljava/time/LocalDateTime;
    ...
    iget-object v9, v1, bh:Ljava/util/ArrayList;
    ...
    iget-object v11, v1, this$0:Lcom/android/server/OpPowerControllerService;
    ...
    invoke-virtual {v11, v9}, zta(Ljava/time/LocalTime;)V
    :try_end_5
    ...
    invoke-virtual {v11, v8}, zta(Ljava/time/LocalTime;)V
    ...
    invoke-virtual {v11, v8}, you(Ljava/time/Duration;)V
    ...
    invoke-virtual {v9, v8}, you(Ljava/time/Duration;)V
    :try_end_7
    ...
    iget-object v8, v1, this$0:Lcom/android/server/OpPowerControllerService;
    ...
    invoke-virtual {v8, v10}, you(Ljava/time/Duration;)V
...
.method private zta(Lorg/xmlpull/v1/XmlSerializer;)V
    ...
    iget-object v0, p0, bh:Ljava/util/ArrayList;
    ...
    :goto_0
    :try_start_0
    iget-object v3, p0, bh:Ljava/util/ArrayList;
    ...
    invoke-virtual {v3}, Lcom/android/server/OpPowerControllerService$tsu;->Y()Ljava/time/LocalDateTime;
    ...
    invoke-virtual {v3}, Lcom/android/server/OpPowerControllerService$tsu;->X()Ljava/time/LocalDateTime;
    ...
    iget-object v0, p0, this$0:Lcom/android/server/OpPowerControllerService;
    ...
    invoke-virtual {v0}, ba()Ljava/time/LocalTime;

    move-result-object v0

    iget-object p0, p0, this$0:Lcom/android/server/OpPowerControllerService;
    ...
    invoke-virtual {p0}, aa()Ljava/time/Duration;
...
.method public Z()[[D
    ...
    :try_start_0
    iget-object v1, p0, bh:Ljava/util/ArrayList;
    ...
    :goto_0
    iget-object v4, p0, bh:Ljava/util/ArrayList;
    ...
    iget-object v5, p0, bh:Ljava/util/ArrayList;
    ...
    invoke-virtual {v5}, Lcom/android/server/OpPowerControllerService$tsu;->Y()Ljava/time/LocalDateTime;
...
.method public aa()Ljava/time/Duration;
    .locals 0

    iget-object p0, p0, dh:Ljava/time/Duration;

    return-object p0
.end method

.method public ba()Ljava/time/LocalTime;
    .locals 0

    iget-object p0, p0, ch:Ljava/time/LocalTime;

    return-object p0
.end method

.method public ca()Ljava/time/LocalDateTime;
    .locals 0

    iget-object p0, p0, eh:Ljava/time/LocalDateTime;

    return-object p0
.end method

.method public da()Ljava/time/LocalDateTime;
    .locals 2
...
.method public ea()Ljava/time/LocalDateTime;
    .locals 2
    ...
    :cond_0
    iget-object v0, p0, ch:Ljava/time/LocalTime;
...
.method public fa()V
    ...
    invoke-virtual {p0, v1}, sis(Ljava/time/LocalDateTime;)V
    ...
    invoke-direct {p0, v1}, zta(Lorg/xmlpull/v1/XmlSerializer;)V

    invoke-static {}, Lcom/android/internal/os/BackgroundThread;->getHandler()Landroid/os/Handler;

    move-result-object v1

    new-instance v2, Lcom/android/server/i;

    invoke-direct {v2, p0, v0}, Lcom/android/server/i;-><init>(Lcom/android/server/OpPowerControllerService$rtg;Ljava/io/ByteArrayOutputStream;)V
...
.method public ga()V
    ...
    iput-object v0, p0, ch:Ljava/time/LocalTime;

    iput-object v0, p0, dh:Ljava/time/Duration;

    iput-object v0, p0, eh:Ljava/time/LocalDateTime;
...
.method public getSize()I
    ...
    :try_start_0
    iget-object p0, p0, bh:Ljava/util/ArrayList;
...
.method public ha()V
    ...
    invoke-direct {p0, v1}, you(Lorg/xmlpull/v1/XmlPullParser;)V
    :try_end_2
...
.method public sis(Ljava/time/LocalDateTime;)V
    ...
    iput-object p1, p0, eh:Ljava/time/LocalDateTime;
...
.method you(Ljava/time/Duration;)V
    ...
    iput-object p1, p0, dh:Ljava/time/Duration;
...
.method public zta(Ljava/time/LocalDateTime;Ljava/time/LocalDateTime;)V
    ...
    iget-object v1, p0, this$0:Lcom/android/server/OpPowerControllerService;
    ...
    iget-object p1, p0, bh:Ljava/util/ArrayList;

    monitor-enter p1

    :try_start_0
    iget-object p2, p0, bh:Ljava/util/ArrayList;
...
.method zta(Ljava/time/LocalTime;)V
    ...
    iput-object p1, p0, ch:Ljava/time/LocalTime;
