...
# static fields
.field private static final AF:I = 0x1e8480

.field private static final BF:I = 0x9
...
.field private static final JF:Ljava/util/regex/Pattern;
...
.field private static final MF:I = 0x2

.field private static final NF:Ljava/util/regex/Pattern;

.field private static final OF:I = 0x6

.field private static final PF:Ljava/lang/String; = "1.3.6.1.4.1.11129.2.1.17"

.field private static final QF:I = 0x0

.field private static final RF:I = 0x1

.field private static final SF:I = 0x3

.field static final TAG:Ljava/lang/String; = "KeyAttestationTest"

.field private static final TF:I = 0x4

.field private static final UF:I = 0x6

.field private static final VF:I = 0x7

.field private static final WF:I = 0x2

.field public static final xF:I = 0x0

.field public static final yF:I = 0x1

.field private static final zF:I = 0xf4240
...
.method static constructor <clinit>()V
    ...
    sput-object v0, JF:Ljava/util/regex/Pattern;
    ...
    sput-object v0, NF:Ljava/util/regex/Pattern;
...
.method private static hc(I)Ljava/lang/String;
    .locals 1
...
.method public static zta(Lorg/bouncycastle/asn1/ssp;)I
    ...
    :goto_0
    invoke-static {p0}, you(Ljava/math/BigInteger;)I
...
.method private zta(I[BI[[Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-direct/range {v2 .. v7}, zta([BZII[Ljava/lang/String;)V
...
.method private zta([BZII[Ljava/lang/String;)V
    ...
    invoke-direct {p0, p5, p2}, zta(Ljava/lang/String;Landroid/security/keystore/KeyGenParameterSpec;)V
    ...
    invoke-direct {p0, p5}, zta([Ljava/security/cert/Certificate;)V

    const/4 p0, 0x1

    invoke-static {p5, p0, p1, p3, p4}, zta([Ljava/security/cert/Certificate;I[BII)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private zta([BZLjava/lang/String;II)V
    ...
    invoke-direct {p0, p3, p2}, zta(Ljava/lang/String;Landroid/security/keystore/KeyGenParameterSpec;)V
    ...
    invoke-direct {p0, p3}, zta([Ljava/security/cert/Certificate;)V

    const/4 p0, 0x3

    invoke-static {p3, p0, p1, p4, p5}, zta([Ljava/security/cert/Certificate;I[BII)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static zta([Ljava/security/cert/Certificate;I[BII)V
    ...
    invoke-static {p0}, zta(Ljava/security/cert/Certificate;)Lorg/bouncycastle/asn1/obl;
    ...
    invoke-static {p4}, zta(Lorg/bouncycastle/asn1/ssp;)I
    ...
    invoke-static {v3}, zta(Lorg/bouncycastle/asn1/ssp;)I
    ...
    invoke-static {p4}, hc(I)Ljava/lang/String;
    ...
    invoke-static {v3}, hc(I)Ljava/lang/String;
    ...
    invoke-static {p0, v1}, zta([Lorg/bouncycastle/asn1/ssp;I)Lorg/bouncycastle/asn1/vdb;

    move-result-object p2

    invoke-static {p2}, zta(Lorg/bouncycastle/asn1/ssp;)I
    ...
    invoke-static {p0, v0}, zta([Lorg/bouncycastle/asn1/ssp;I)Lorg/bouncycastle/asn1/vdb;
    ...
    invoke-static {p0, p1}, zta([Lorg/bouncycastle/asn1/ssp;I)Lorg/bouncycastle/asn1/vdb;

    move-result-object p0

    invoke-static {p0}, zta(Lorg/bouncycastle/asn1/ssp;)I
...
.method public fd()V
    ...
    invoke-direct/range {v9 .. v14}, zta([BZLjava/lang/String;II)V
    ...
    invoke-direct/range {v15 .. v20}, zta([BZLjava/lang/String;II)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public gd()V
    ...
    invoke-direct {v0, v15}, fc(I)Z

    move-result v16

    if-eqz v16, :cond_0

    invoke-direct {v0, v9, v12, v15, v6}, zta(I[BI[[Ljava/lang/String;)V

    goto :goto_3

    :cond_0
    invoke-direct {v0, v9, v12, v15, v1}, zta(I[BI[[Ljava/lang/String;)V
