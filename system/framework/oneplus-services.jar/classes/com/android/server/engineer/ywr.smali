...
.field private wb:Lcom/android/server/engineer/OneplusEngineerService;

.field private xb:Ljava/io/PrintWriter;
...
.method public constructor <init>(Lcom/android/server/engineer/OneplusEngineerService;Landroid/content/Context;)V
    ...
    iput-object p1, p0, wb:Lcom/android/server/engineer/OneplusEngineerService;
    ...
    iget-object p0, p0, mIntentReceiver:Landroid/content/BroadcastReceiver;
...
.method private Yl()Ljava/lang/String;
    ...
    :goto_1
    invoke-static {}, Lcom/android/server/engineer/rtg;->jd()[B
    ...
    :goto_4
    invoke-direct {p0}, isMultiSimEnabled()Z
...
.method private cno(Ljava/io/PrintWriter;)V
    ...
    invoke-direct {p0, p1, v0}, sis(Landroid/content/Context;Ljava/lang/String;)V
...
.method private kth(Ljava/io/PrintWriter;)V
    ...
    invoke-virtual {p0}, Lcom/android/server/engineer/zta;->gd()V

    new-instance p0, Lcom/android/server/engineer/zta;

    invoke-direct {p0}, Lcom/android/server/engineer/zta;-><init>()V

    invoke-virtual {p0}, Lcom/android/server/engineer/zta;->fd()V
...
.method private rtg(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    :cond_4
    iget-object p0, p0, wb:Lcom/android/server/engineer/OneplusEngineerService;

    invoke-virtual {p0}, Lcom/android/server/engineer/OneplusEngineerService;->Ea()Z
    ...
    :cond_5
    invoke-static {v1}, Lcom/android/server/secrecy/zta/zta/sis;->A(I)Z
...
.method private sis(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    invoke-static {v1}, Lcom/android/server/engineer/qbh;->H(Ljava/lang/String;)Z

    move-result v3

    if-eqz v3, :cond_4

    invoke-static {v0}, Lcom/android/server/engineer/qbh;->J(Ljava/lang/String;)Z
    ...
    invoke-direct {v0, v1, v2}, sis(Landroid/content/Context;Ljava/lang/String;)V

    sput-boolean v7, waitResult:Z

    :goto_5
    sget-boolean v0, waitResult:Z
    ...
    invoke-direct {v0, v0}, zta(Landroid/os/ShellCommand;)Landroid/content/Intent;
    ...
    invoke-direct {v0, v3, v1, v8}, zta(Landroid/content/Context;Landroid/content/Intent;I)I
    ...
    invoke-direct {v0, v1, v3, v8}, zta(Landroid/content/Context;Landroid/content/Intent;I)I
...
.method private ssp(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    invoke-static {p0}, Lcom/android/server/engineer/qbh;->I(Ljava/lang/String;)Z
    ...
    invoke-static {p0}, Lcom/android/server/secrecy/zta/zta/sis;->A(I)Z
...
.method private tsu(B)I
    ...
    invoke-static {}, Lcom/android/server/engineer/qbh;->md()Ljava/lang/Object;
...
.method private tsu(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    :pswitch_0
    invoke-direct {p0}, Yl()Ljava/lang/String;
    ...
    invoke-static {p0, v1}, Lcom/android/server/engineer/qbh;->tsu(Ljava/lang/String;I)I
    ...
    invoke-static {p1, v2}, Lcom/android/server/engineer/qbh;->tsu(Ljava/lang/String;I)I
...
.method private you(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    invoke-direct {p0, p1, p2}, sis(Landroid/content/Context;Ljava/lang/String;)V

    sput-boolean v2, waitResult:Z
...
.method static synthetic zta(Lcom/android/server/engineer/ywr;)Ljava/io/PrintWriter;
    ...
    iget-object p0, p0, xb:Ljava/io/PrintWriter;
...
.method public onCommand(Ljava/lang/String;)I
    ...
    iput-object v5, v1, xb:Ljava/io/PrintWriter;
    ...
    :try_start_0
    iget-object v5, v1, wb:Lcom/android/server/engineer/OneplusEngineerService;

    invoke-virtual {v5, v2}, Lcom/android/server/engineer/OneplusEngineerService;->vju(Ljava/lang/String;)Z
    ...
    iget-object v3, v1, xb:Ljava/io/PrintWriter;
    ...
    invoke-static {v5, v14}, Lcom/android/server/engineer/qbh;->tsu(Ljava/lang/String;I)I
    ...
    iget-object v6, v1, xb:Ljava/io/PrintWriter;
    ...
    invoke-static {v3, v14}, Lcom/android/server/engineer/qbh;->tsu(Ljava/lang/String;I)I
    ...
    iget-object v5, v1, xb:Ljava/io/PrintWriter;
    ...
    iget-object v4, v1, xb:Ljava/io/PrintWriter;
    ...
    :pswitch_3
    :try_start_7
    iget-object v3, v1, wb:Lcom/android/server/engineer/OneplusEngineerService;

    invoke-virtual {v3}, Lcom/android/server/engineer/OneplusEngineerService;->Ca()Ljava/lang/String;
    ...
    iget-object v2, v1, xb:Ljava/io/PrintWriter;
    ...
    iget-object v1, v1, xb:Ljava/io/PrintWriter;
    ...
    iget-object v2, v1, wb:Lcom/android/server/engineer/OneplusEngineerService;

    invoke-virtual {v2}, Lcom/android/server/engineer/OneplusEngineerService;->Ea()Z
    ...
    invoke-static {v3}, Lcom/android/server/secrecy/zta/zta/sis;->A(I)Z
    ...
    invoke-static {v2}, Lcom/android/server/engineer/qbh;->G(Ljava/lang/String;)Z
    ...
    invoke-static {v2}, Lcom/android/server/secrecy/zta/zta/sis;->A(I)Z
    ...
    invoke-direct {v1, v2}, cno(Ljava/io/PrintWriter;)V
    :try_end_14
    ...
    invoke-direct {v1, v2, v3}, zta(Ljava/lang/String;Ljava/io/PrintWriter;)V
    :try_end_16
    ...
    invoke-direct {v1, v2}, kth(Ljava/io/PrintWriter;)V
    :try_end_17
    ...
    invoke-direct {v1, v2, v3}, you(Ljava/lang/String;Ljava/io/PrintWriter;)V
    :try_end_18
    ...
    invoke-direct {v1, v2, v3}, sis(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    invoke-direct {v1, v2, v3}, rtg(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    invoke-direct {v1, v2, v3}, ssp(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    invoke-direct {v1, v2, v3}, tsu(Ljava/lang/String;Ljava/io/PrintWriter;)V
    :try_end_19
