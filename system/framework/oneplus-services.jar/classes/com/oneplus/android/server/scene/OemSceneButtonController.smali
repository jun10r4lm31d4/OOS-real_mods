...
.method static constructor <clinit>()V
    ...
    invoke-static {v2}, makeParam([Ljava/lang/String;)Ljava/lang/String;
    ...
    sput-object v0, RULE_KEYBLOCKING_ZENMODE:Lcom/oneplus/core/oimc/OIMCRule;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, mIsFunctionOn:Z
    ...
    iput-object v0, p0, mGestureButtonBlockListener:Lcom/oneplus/android/server/scene/OemSceneButtonController$zta;
...
.method public static getInstance(Landroid/content/Context;)Lcom/oneplus/android/server/scene/OemSceneButtonController;
    ...
    sget-object v0, sInstance:Lcom/oneplus/android/server/scene/OemSceneButtonController;
    ...
    sput-object v0, sInstance:Lcom/oneplus/android/server/scene/OemSceneButtonController;

    :cond_0
    sget-object p0, sInstance:Lcom/oneplus/android/server/scene/OemSceneButtonController;
...
.method private handleBlockScreenGestures()V
    ...
    :cond_0
    iget-object v0, p0, mGestureButtonBlockListener:Lcom/oneplus/android/server/scene/OemSceneButtonController$zta;
    ...
    invoke-direct {p0, v0, v1}, setProptValue(Ljava/lang/String;Ljava/lang/String;)V
...
.method private isBlockScreenGestures(Ljava/lang/Object;)Z
    ...
    sget-object v0, Lcom/oneplus/android/server/scene/OemSceneButtonController$Param;->Pza:Lcom/oneplus/android/server/scene/OemSceneButtonController$Param;
    ...
    sget-object p1, Lcom/oneplus/android/server/scene/OemSceneButtonController$Param;->Pza:Lcom/oneplus/android/server/scene/OemSceneButtonController$Param;
...
.method private operateSpecialParams(Ljava/util/ArrayList;I)V
    ...
    invoke-direct {p0}, isNaviBarHidden()Z

    move-result v1

    if-nez v1, :cond_3

    invoke-virtual {p0, v3}, setEnable(Z)V
    ...
    invoke-virtual {p0, v0}, setEnable(Z)V
...
.method public onConfig(Ljava/lang/String;)I
    ...
    :cond_0
    invoke-direct {p0, p1}, getSpecialParams(Ljava/lang/Object;)Ljava/util/ArrayList;

    move-result-object v0

    const/4 v1, 0x3

    invoke-direct {p0, v0, v1}, operateSpecialParams(Ljava/util/ArrayList;I)V

    invoke-direct {p0, p1}, isBlockScreenGestures(Ljava/lang/Object;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-direct {p0}, handleBlockScreenGestures()V
    ...
    invoke-direct {p0}, isOperatedScreenGestures()Z

    move-result v0

    if-eqz v0, :cond_2

    invoke-direct {p0}, handleRecoverScreenGestures()V
...
.method public onStop([Ljava/lang/String;)I
    ...
    invoke-direct {p0, p1, v0}, operateSpecialParams(Ljava/util/ArrayList;I)V
...
.method public registerGestureButtonBlockListener(Lcom/oneplus/android/server/scene/OemSceneButtonController$zta;)V
    ...
    iput-object p1, p0, mGestureButtonBlockListener:Lcom/oneplus/android/server/scene/OemSceneButtonController$zta;
...
.method public setEnable(Z)V
    ...
    invoke-direct {p0, p1}, setKeyMode(I)V

    goto :goto_1

    :cond_0
    invoke-direct {p0}, getOnScreenNaviBarEnable()Z
    ...
    sget-object p1, Lcom/oneplus/android/server/scene/OemSceneButtonController$KeyLockMode;->Fwa:Lcom/oneplus/android/server/scene/OemSceneButtonController$KeyLockMode;
