...
.field private static sAwinicEffect:Lcom/oneplus/android/server/scene/bio;
...
.method static constructor <clinit>()V
    ...
    sput-object v1, URI_OP_GAME_MODE_VIBRATE_FEEDBACK:Landroid/net/Uri;

    const/4 v1, 0x0

    sput-object v1, sAwinicEffect:Lcom/oneplus/android/server/scene/bio;
    ...
    sput-object v1, RULE_XLVMOTOR_CONTROLLER:Lcom/oneplus/core/oimc/OIMCRule;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, mLastEnableAwinic:Z

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, configs:Ljava/util/HashMap;

    iput-boolean v0, p0, mGlobalBluetoothA2dpOn:Z

    const/4 v1, 0x0

    iput-object v1, p0, tManager:Landroid/telephony/TelephonyManager;
    ...
    iput-object v1, p0, mBluetoothReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v1, p0, updateVolumeRunnable:Ljava/lang/Runnable;
    ...
    iput-object v1, p0, updateVolumeRunnableForDP:Ljava/lang/Runnable;
    ...
    new-instance v1, Lcom/oneplus/android/server/scene/f;

    invoke-direct {v1, p0}, Lcom/oneplus/android/server/scene/f;-><init>(Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;)V
    ...
    iget-object v5, p0, mBluetoothReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object p1, p0, mVibrateFeedbackModeObserver:Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController$you;

    iget-object p1, p0, mResolver:Landroid/content/ContentResolver;

    sget-object v1, URI_OP_GAME_MODE_VIBRATE_FEEDBACK:Landroid/net/Uri;

    iget-object v2, p0, mVibrateFeedbackModeObserver:Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController$you;
    ...
    iget-object v1, p0, mTestReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object p1, p0, mGameVibrateManager:Lcom/oneplus/core/gamevibrate/GameVibrateManager;
...
.method static synthetic access$000(Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;)Z
    ...
    iget-boolean p0, p0, mGlobalBluetoothA2dpOn:Z
...
.method static synthetic access$002(Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;Z)Z
    ...
    iput-boolean p1, p0, mGlobalBluetoothA2dpOn:Z
...
.method static synthetic access$100(Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;)Z
    ...
    iget-boolean p0, p0, mEnable:Z

    return p0
.end method

.method static synthetic access$1000(Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;Ljava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1}, setParameters(Ljava/lang/String;)V
...
.method static synthetic access$200(Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;Z)V
    ...
    invoke-direct {p0, p1}, updateFunctionRule(Z)V
...
.method static synthetic access$500()Lcom/oneplus/android/server/scene/bio;
    .locals 1

    sget-object v0, sAwinicEffect:Lcom/oneplus/android/server/scene/bio;
...
.method static synthetic access$600(Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;)Z
    ...
    iget-boolean p0, p0, mLastEnableAwinic:Z
...
.method static synthetic access$700(Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;)Landroid/telephony/TelephonyManager;
    ...
    iget-object p0, p0, tManager:Landroid/telephony/TelephonyManager;
...
.method static synthetic access$702(Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;Landroid/telephony/TelephonyManager;)Landroid/telephony/TelephonyManager;
    ...
    iput-object p1, p0, tManager:Landroid/telephony/TelephonyManager;
...
.method static synthetic access$800(Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;)V
    ...
    invoke-direct {p0}, updateVibrateFeedbackEnabled()V

    return-void
.end method

.method static synthetic access$900(Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;)V
    .locals 0
...
.method private dump()V
    ...
    iget-object v0, p0, configs:Ljava/util/HashMap;
    ...
    iget-object v3, p0, configs:Ljava/util/HashMap;
    ...
    iget-object v1, p0, configs:Ljava/util/HashMap;
    ...
    iget-object v5, p0, configs:Ljava/util/HashMap;
...
.method private enableAwinicHaptic(Z)V
    ...
    iput-boolean p1, p0, mLastEnableAwinic:Z
    ...
    :cond_0
    sget-object p1, sAwinicEffect:Lcom/oneplus/android/server/scene/bio;

    invoke-virtual {p1, v4}, Lcom/oneplus/android/server/scene/bio;->zta(S)I

    sget-object p1, sAwinicEffect:Lcom/oneplus/android/server/scene/bio;

    invoke-virtual {p1, v4}, Lcom/oneplus/android/server/scene/bio;->setEnabled(Z)I
    ...
    iget-object p1, p0, mGameVibrateManager:Lcom/oneplus/core/gamevibrate/GameVibrateManager;
    ...
    iget-object p0, p0, mGameVibrateManager:Lcom/oneplus/core/gamevibrate/GameVibrateManager;
    ...
    invoke-virtual {v5}, Lcom/android/server/OnePlusUtil$zta;->O()Ljava/lang/String;

    move-result-object v5

    invoke-direct {p0, v5}, getParametersFromConfig(Ljava/lang/String;)I
    ...
    invoke-virtual {p1, v3}, Lcom/oneplus/android/server/scene/bio;->setEnabled(Z)I

    sget-object p1, sAwinicEffect:Lcom/oneplus/android/server/scene/bio;

    int-to-short v1, v6

    invoke-virtual {p1, v1}, Lcom/oneplus/android/server/scene/bio;->zta(S)I
...
.method public static getInstance(Landroid/content/Context;)Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;
    ...
    sget-object v0, sInstance:Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;
    ...
    sput-object v0, sInstance:Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;

    :cond_0
    sget-object p0, sInstance:Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;
...
.method private getParametersFromConfig(Ljava/lang/String;)I
    ...
    :try_start_0
    iget-object p0, p0, configs:Ljava/util/HashMap;
    ...
    iget p0, p0, Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController$zta;->yta:I
...
.method private loadConfig()V
    ...
    iget-object v4, p0, configs:Ljava/util/HashMap;
...
.method public static setHapticEffect(Lcom/oneplus/android/server/scene/bio;)V
    .locals 0

    sput-object p0, sAwinicEffect:Lcom/oneplus/android/server/scene/bio;
...
.method private updateFunctionRule(Z)V
    ...
    sget-object p1, RULE_XLVMOTOR_CONTROLLER:Lcom/oneplus/core/oimc/OIMCRule;
...
.method private declared-synchronized updateVibrateFeedbackEnabled()V
    ...
    :cond_1
    iget-boolean v0, p0, mGlobalBluetoothA2dpOn:Z

    if-nez v0, :cond_2

    iget-boolean v0, p0, mEnable:Z

    invoke-direct {p0, v0}, updateFunctionRule(Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private updateVolume()V
    ...
    invoke-virtual {v0, p0}, Lcom/oneplus/android/server/scene/bio;->setVolume(F)I
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public disableFeatureWhenException()V
    ...
    iget-object v1, p0, mBluetoothReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v1, p0, mVibrateFeedbackModeObserver:Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController$you;
...
.method public onStart([Ljava/lang/String;)I
    ...
    invoke-direct {p0, p1}, enableAwinicHaptic(Z)V
