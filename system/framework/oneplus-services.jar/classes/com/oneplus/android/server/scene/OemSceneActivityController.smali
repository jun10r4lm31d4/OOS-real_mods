...
.field private static lra:Lcom/oneplus/android/server/scene/OemSceneActivityController$AllowWhiteActivity;

.field private static final mra:I

.field private static final nra:I
...
.method static constructor <clinit>()V
    ...
    sget-object v0, Lcom/oneplus/android/server/scene/OemSceneActivityController$ActivityMode;->Mza:Lcom/oneplus/android/server/scene/OemSceneActivityController$ActivityMode;
    ...
    sget-object v0, Lcom/oneplus/android/server/scene/OemSceneActivityController$ActivityMode;->Nza:Lcom/oneplus/android/server/scene/OemSceneActivityController$ActivityMode;
...
.method public static canActivityGo(Landroid/content/pm/ActivityInfo;)Z
    ...
    :cond_0
    sget-object v1, sInstance:Lcom/oneplus/android/server/scene/OemSceneActivityController;
    ...
    invoke-static {v0}, getInstance(Landroid/content/Context;)Lcom/oneplus/android/server/scene/OemSceneActivityController;

    move-result-object v0

    invoke-direct {v0, p0}, tsu(Landroid/content/pm/ActivityInfo;)Z
...
.method public static getInstance(Landroid/content/Context;)Lcom/oneplus/android/server/scene/OemSceneActivityController;
    ...
    sget-object v0, sInstance:Lcom/oneplus/android/server/scene/OemSceneActivityController;
    ...
    sput-object v0, sInstance:Lcom/oneplus/android/server/scene/OemSceneActivityController;

    :cond_0
    sget-object p0, sInstance:Lcom/oneplus/android/server/scene/OemSceneActivityController;
...
.method private tsu(Landroid/content/pm/ActivityInfo;)Z
    ...
    invoke-direct {p0, p1}, rtg(Landroid/content/pm/ActivityInfo;)Z
...
# virtual methods
.method public Rf()Lcom/oneplus/android/server/scene/OemSceneActivityController$AllowWhiteActivity;
    .locals 1

    sget-object v0, lra:Lcom/oneplus/android/server/scene/OemSceneActivityController$AllowWhiteActivity;
    ...
    sput-object v0, lra:Lcom/oneplus/android/server/scene/OemSceneActivityController$AllowWhiteActivity;

    :cond_0
    sget-object p0, lra:Lcom/oneplus/android/server/scene/OemSceneActivityController$AllowWhiteActivity;
