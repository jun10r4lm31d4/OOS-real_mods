...
.method static constructor <clinit>()V
    ...
    sput-object v0, URI_BLOCK_AUTO_BACKLIGHT_SETTING:Landroid/net/Uri;
    ...
    sput-object v0, URI_AUTO_BACKLIGHT_SETTING:Landroid/net/Uri;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, mIsAutoBackSettingChangedByUs:Z

    iput-boolean v0, p0, mIsAutoBackSettingChangedByUsWhenBoot:Z
    ...
    :goto_0
    invoke-direct {p0}, getNeedToRestoreAutoBacklight()Z
    ...
    iput-boolean v3, p0, mIsAutoBackSettingChangedByUsWhenBoot:Z

    invoke-direct {p0, v0}, setNeedToRestoreAutoBacklight(Z)V
    ...
    iput-object p1, p0, mBlockAutoBackLightSettingsContentObserver:Lcom/oneplus/android/server/scene/OemSceneAutoBrightnessController$you;

    iget-object p1, p0, mResolver:Landroid/content/ContentResolver;

    sget-object v2, URI_BLOCK_AUTO_BACKLIGHT_SETTING:Landroid/net/Uri;

    iget-object v3, p0, mBlockAutoBackLightSettingsContentObserver:Lcom/oneplus/android/server/scene/OemSceneAutoBrightnessController$you;
    ...
    iput-object p1, p0, mAutoBackLightSettingsContentObserver:Lcom/oneplus/android/server/scene/OemSceneAutoBrightnessController$zta;

    iget-object p1, p0, mResolver:Landroid/content/ContentResolver;

    sget-object v2, URI_AUTO_BACKLIGHT_SETTING:Landroid/net/Uri;

    iget-object p0, p0, mAutoBackLightSettingsContentObserver:Lcom/oneplus/android/server/scene/OemSceneAutoBrightnessController$zta;
...
.method static synthetic access$200(Lcom/oneplus/android/server/scene/OemSceneAutoBrightnessController;)Z
    ...
    iget-boolean p0, p0, mIsAutoBackSettingChangedByUsWhenBoot:Z
...
.method static synthetic access$202(Lcom/oneplus/android/server/scene/OemSceneAutoBrightnessController;Z)Z
    ...
    iput-boolean p1, p0, mIsAutoBackSettingChangedByUsWhenBoot:Z
...
.method static synthetic access$300(Lcom/oneplus/android/server/scene/OemSceneAutoBrightnessController;)Z
    ...
    iget-boolean p0, p0, mIsAutoBackSettingChangedByUs:Z
...
.method static synthetic access$302(Lcom/oneplus/android/server/scene/OemSceneAutoBrightnessController;Z)Z
    ...
    iput-boolean p1, p0, mIsAutoBackSettingChangedByUs:Z
...
.method static synthetic access$500(Lcom/oneplus/android/server/scene/OemSceneAutoBrightnessController;Z)V
    ...
    invoke-direct {p0, p1}, setNeedToRestoreAutoBacklight(Z)V
...
.method public static getInstance(Landroid/content/Context;)Lcom/oneplus/android/server/scene/OemSceneAutoBrightnessController;
    ...
    sget-object v0, sInstance:Lcom/oneplus/android/server/scene/OemSceneAutoBrightnessController;
    ...
    sput-object v0, sInstance:Lcom/oneplus/android/server/scene/OemSceneAutoBrightnessController;

    :cond_0
    sget-object p0, sInstance:Lcom/oneplus/android/server/scene/OemSceneAutoBrightnessController;
...
.method private setupAutoBrightnessMode(Z)V
    ...
    iput-boolean v4, p0, mIsAutoBackSettingChangedByUs:Z

    invoke-direct {p0, v4}, setNeedToRestoreAutoBacklight(Z)V
    ...
    :cond_4
    invoke-direct {p0, v3}, setNeedToRestoreAutoBacklight(Z)V
...
.method public onStart([Ljava/lang/String;)I
    ...
    invoke-direct {p0, p1}, setupAutoBrightnessMode(Z)V
...
.method public updateFunctionRule(I)V
    ...
    :cond_2
    invoke-direct {p0}, getGameModeAutoBrightnessBlocked()Z
