...
.field private static final ena:I = 0xc
...
.field private dna:Landroid/os/CountDownTimer;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Zma:Z

    iput-boolean v0, p0, _ma:Z

    iput-boolean v0, p0, ana:Z

    iput-boolean v0, p0, bna:Z

    iput-boolean v0, p0, cna:Z
...
.method public disablelightSensor()V
    ...
    iget-object v0, p0, dna:Landroid/os/CountDownTimer;
    ...
    iput-object v0, p0, dna:Landroid/os/CountDownTimer;
    ...
    iget-boolean v1, p0, cna:Z

    if-eqz v1, :cond_1

    :try_start_0
    iget-object v1, p0, mDaemon:Lsis/you/you/zta/zta/you;
...
.method public updateAutoAssertiveDisplayStatus(F)V
    ...
    iget-boolean v0, p0, Zma:Z

    if-nez v0, :cond_1

    iput-boolean v3, p0, Zma:Z

    iput-boolean v3, p0, ana:Z

    iget-object p1, p0, dna:Landroid/os/CountDownTimer;

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Landroid/os/CountDownTimer;->cancel()V

    iput-object v1, p0, dna:Landroid/os/CountDownTimer;
    ...
    iput-object p1, p0, dna:Landroid/os/CountDownTimer;
    ...
    iget-boolean p1, p0, _ma:Z

    if-nez p1, :cond_3

    iput-boolean v3, p0, _ma:Z

    iput-boolean v3, p0, bna:Z
