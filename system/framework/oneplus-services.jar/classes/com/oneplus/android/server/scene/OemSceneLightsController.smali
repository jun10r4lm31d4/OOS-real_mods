...
.field private static final Tra:I

.field private static final Ura:I

.field private static sInstance:Lcom/oneplus/android/server/scene/OemSceneLightsController;


# instance fields
.field private Rra:Lcom/oneplus/android/server/scene/OemSceneLightsController$ZenModeLedController;
...
.method static constructor <clinit>()V
    ...
    sget-object v0, Lcom/oneplus/android/server/scene/OemSceneLightsController$LightsMode;->Mza:Lcom/oneplus/android/server/scene/OemSceneLightsController$LightsMode;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, mLightsManager:Lcom/android/server/lights/LightsManager;

    iget-object p1, p0, mLightsManager:Lcom/android/server/lights/LightsManager;
    ...
    iput-object p1, p0, mBatteryManagerInternal:Landroid/os/BatteryManagerInternal;
...
.method public static canSetLights(III)Z
    ...
    sget-object v0, sInstance:Lcom/oneplus/android/server/scene/OemSceneLightsController;
    ...
    invoke-static {v0}, getInstance(Landroid/content/Context;)Lcom/oneplus/android/server/scene/OemSceneLightsController;

    move-result-object v0

    invoke-direct {v0, p0, p1, p2}, wtn(III)Z
...
.method public static getInstance(Landroid/content/Context;)Lcom/oneplus/android/server/scene/OemSceneLightsController;
    ...
    sput-object v0, sInstance:Lcom/oneplus/android/server/scene/OemSceneLightsController;

    :cond_0
    sget-object p0, sInstance:Lcom/oneplus/android/server/scene/OemSceneLightsController;
...
.method private wtn(III)Z
    ...
    invoke-direct {p0, p1, p2, p3}, gck(III)Z
...
.method static synthetic zta(Lcom/oneplus/android/server/scene/OemSceneLightsController;)Lcom/android/server/lights/Light;
    ...
    iget-object p0, p0, mNotificationLight:Lcom/android/server/lights/Light;
...
# virtual methods
.method public ag()Lcom/oneplus/android/server/scene/OemSceneLightsController$ZenModeLedController;
    .locals 1

    iget-object v0, p0, Rra:Lcom/oneplus/android/server/scene/OemSceneLightsController$ZenModeLedController;
    ...
    iput-object v0, p0, Rra:Lcom/oneplus/android/server/scene/OemSceneLightsController$ZenModeLedController;

    :cond_0
    iget-object p0, p0, Rra:Lcom/oneplus/android/server/scene/OemSceneLightsController$ZenModeLedController;
