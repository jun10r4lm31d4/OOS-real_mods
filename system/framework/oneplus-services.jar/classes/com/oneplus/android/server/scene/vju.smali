...
.field private static final Kra:Ljava/lang/String; = "-1"

.field private static final Lra:Ljava/lang/String; = "android.intent.action.PHONE_STATE"

.field private static final Mra:J = 0x1f4L

.field private static final Nra:Landroid/net/Uri;

.field private static Ora:Lcom/oneplus/android/server/scene/bud; = null

.field private static Pra:Lcom/oneplus/android/server/scene/bud; = null

.field private static Qra:Landroid/view/View; = null
...
.field private Cra:Landroid/animation/ValueAnimator;

.field private Dra:Landroid/animation/ValueAnimator;

.field private Era:Lcom/oneplus/android/server/scene/bud;

.field private Fra:Lcom/oneplus/android/server/scene/vju$zta;
...
.field private Jra:Ljava/util/ArrayList;
...
.field private Nb:Landroid/view/WindowManager$LayoutParams;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ora:Lcom/oneplus/android/server/scene/bud;

    sput-object v0, Pra:Lcom/oneplus/android/server/scene/bud;
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;)V
    ...
    iput-object v0, p0, Bra:Landroid/view/WindowManager;

    iput-object v0, p0, Era:Lcom/oneplus/android/server/scene/bud;

    iput-object v0, p0, mESportGuider:Lcom/oneplus/android/server/scene/rtg;

    const-string v0, ""

    iput-object v0, p0, Gra:Ljava/lang/String;

    const/4 v0, 0x0

    iput-boolean v0, p0, Hra:Z
    ...
    iput-object v1, p0, Jra:Ljava/util/ArrayList;
    ...
    iput-object p2, p0, Bra:Landroid/view/WindowManager;

    invoke-static {}, Landroid/view/WindowManagerGlobal;->getWindowManagerService()Landroid/view/IWindowManager;

    move-result-object p2

    iput-object p2, p0, mWindowManagerService:Landroid/view/IWindowManager;
    ...
    iput-object p2, p0, mWindowManagerInternal:Lcom/android/server/wm/WindowManagerInternal;
    ...
    iput-object v1, p0, Cra:Landroid/animation/ValueAnimator;
    ...
    iput-object p2, p0, Dra:Landroid/animation/ValueAnimator;
    ...
    iput-object p2, p0, mESportGuider:Lcom/oneplus/android/server/scene/rtg;

    iget-object p2, p0, mESportGuider:Lcom/oneplus/android/server/scene/rtg;
    ...
    iput-object p2, p0, Fra:Lcom/oneplus/android/server/scene/vju$zta;
    ...
    sget-object p2, Nra:Landroid/net/Uri;

    iget-object v1, p0, Fra:Lcom/oneplus/android/server/scene/vju$zta;
...
.method public static Xf()I
    ...
    sget-object v0, Qra:Landroid/view/View;
...
.method private av()V
    ...
    iget-object v4, p0, Jra:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Jra:Ljava/util/ArrayList;
...
.method private dv()V
    ...
    iget-object v0, p0, Era:Lcom/oneplus/android/server/scene/bud;
    ...
    iget-object v1, p0, Era:Lcom/oneplus/android/server/scene/bud;
    ...
    invoke-direct {p0, v0}, dd(Ljava/lang/String;)Z
    ...
    iput-object v1, p0, Era:Lcom/oneplus/android/server/scene/bud;
    ...
    iput-object v0, p0, Nb:Landroid/view/WindowManager$LayoutParams;

    iget-object v0, p0, Nb:Landroid/view/WindowManager$LayoutParams;
    ...
    iget-object v0, p0, Bra:Landroid/view/WindowManager;

    iget-object v1, p0, Era:Lcom/oneplus/android/server/scene/bud;

    iget-object v2, p0, Nb:Landroid/view/WindowManager$LayoutParams;
...
.method private fv()V
    ...
    iget-object v0, p0, Cra:Landroid/animation/ValueAnimator;
    ...
    iget-object p0, p0, Cra:Landroid/animation/ValueAnimator;
...
.method private hide(Z)V
    ...
    iget-object v0, p0, Dra:Landroid/animation/ValueAnimator;
    ...
    invoke-direct {p0}, ev()V

    goto :goto_0

    :cond_0
    iget-object p1, p0, Era:Lcom/oneplus/android/server/scene/bud;

    if-eqz p1, :cond_1

    iget-object v1, p0, Bra:Landroid/view/WindowManager;
    ...
    :cond_1
    :goto_0
    iget-object p0, p0, mESportGuider:Lcom/oneplus/android/server/scene/rtg;

    invoke-virtual {p0}, Lcom/oneplus/android/server/scene/rtg;->hide()V

    sput-object v0, Qra:Landroid/view/View;
...
.method static synthetic rtg(Lcom/oneplus/android/server/scene/vju;)Landroid/view/WindowManager;
    ...
    iget-object p0, p0, Bra:Landroid/view/WindowManager;
...
.method private sb(Z)V
    ...
    iget-object p1, p0, Dra:Landroid/animation/ValueAnimator;
    ...
    :cond_0
    iget-object p0, p0, Dra:Landroid/animation/ValueAnimator;
...
.method private show(Z)V
    ...
    :cond_0
    iget-object p1, p0, Cra:Landroid/animation/ValueAnimator;
...
.method static synthetic sis(Lcom/oneplus/android/server/scene/vju;)Lcom/oneplus/android/server/scene/bud;
    ...
    iget-object p0, p0, Era:Lcom/oneplus/android/server/scene/bud;
...
.method static synthetic zta(Lcom/oneplus/android/server/scene/vju;Lcom/oneplus/android/server/scene/bud;)Lcom/oneplus/android/server/scene/bud;
    ...
    iput-object p1, p0, Era:Lcom/oneplus/android/server/scene/bud;
...
.method public Yf()Ljava/lang/String;
    ...
    iget-object p0, p0, Gra:Ljava/lang/String;
...
.method public frontPackageChanged(Ljava/lang/String;IILjava/lang/String;II)V
    ...
    :cond_0
    iget-object p2, p0, Gra:Ljava/lang/String;

    iput-object p1, p0, Gra:Ljava/lang/String;
    ...
    iget-object p1, p0, Gra:Ljava/lang/String;
