...
.method static constructor <clinit>()V
    ...
    sput-object v0, whiteListInESportMode:Ljava/util/ArrayList;
    ...
    sput-object v0, whiteListTagInSystemUI:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, mPis:Ljava/util/List;
...
.method private constructor <init>()V
    ...
    iput-boolean v0, p0, mIsFetched:Z

    iput-boolean v0, p0, mIsNotifyBlocked:Z

    new-instance v0, Lcom/oneplus/util/MultiMap;

    invoke-direct {v0}, Lcom/oneplus/util/MultiMap;-><init>()V

    iput-object v0, p0, mImComponentLists:Lcom/oneplus/util/MultiMap;

    new-instance v0, Lcom/oneplus/util/MultiMap;

    invoke-direct {v0}, Lcom/oneplus/util/MultiMap;-><init>()V

    iput-object v0, p0, mImSpecialIntents:Lcom/oneplus/util/MultiMap;

    new-instance v0, Lcom/oneplus/util/MultiMap;

    invoke-direct {v0}, Lcom/oneplus/util/MultiMap;-><init>()V

    iput-object v0, p0, mImSpecialActions:Lcom/oneplus/util/MultiMap;

    const/4 v0, 0x0

    iput-object v0, p0, mPoppedComponentName:Ljava/lang/String;

    iput-object v0, p0, mInCallClickedPackage:Ljava/lang/String;
    ...
    iput-object v0, p0, whiteListInBreathMode:Ljava/util/ArrayList;
...
.method static synthetic access$400(Lcom/oneplus/android/server/scene/OemSceneCallBlock;ILjava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2}, hideView(ILjava/lang/String;)V
...
.method static synthetic access$602(Lcom/oneplus/android/server/scene/OemSceneCallBlock;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object p1, p0, mInCallClickedPackage:Ljava/lang/String;
...
.method static synthetic access$700(Lcom/oneplus/android/server/scene/OemSceneCallBlock;Ljava/lang/String;Ljava/lang/String;I)V
    ...
    invoke-direct {p0, p1, p2, p3}, checkLaunchedApp(Ljava/lang/String;Ljava/lang/String;I)V
...
.method private blockerEnabled(IZ)Z
    ...
    :cond_4
    iput-boolean v2, p0, mIsNotifyBlocked:Z
    ...
    invoke-static {p2}, Lcom/oneplus/android/server/scene/OemSceneCallBlock$zta;->cno(Landroid/content/Context;)Z
...
.method private checkLaunchedApp(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    :cond_0
    invoke-direct {p0, p1, p2, v1}, isForegroundAppWithUid(Ljava/lang/String;Ljava/lang/String;I)Z
...
.method public static getInstance()Lcom/oneplus/android/server/scene/OemSceneCallBlock;
    ...
    sget-object v0, sOemSceneCallBlock:Lcom/oneplus/android/server/scene/OemSceneCallBlock;
    ...
    sput-object v0, sOemSceneCallBlock:Lcom/oneplus/android/server/scene/OemSceneCallBlock;
...
.method private hideView(ILjava/lang/String;)V
    ...
    invoke-direct {p0, p1}, resetPopedStatus(I)V
    ...
    iget-object v0, p0, mOemSceneCallBlock:Lcom/oneplus/util/notification/SimpleHeadsUpController;
    ...
    :cond_1
    iget-object p0, p0, mOemSceneCallBlock:Lcom/oneplus/util/notification/SimpleHeadsUpController;
...
.method private initHandler()V
    ...
    invoke-direct {v1, p0, v0}, Lcom/oneplus/android/server/scene/vdb;-><init>(Lcom/oneplus/android/server/scene/OemSceneCallBlock;Landroid/os/Looper;)V
...
.method private initOnlineConfig()V
    ...
    iput-object v0, p0, mSceneCallBlockConfigObserver:Lcom/oneplus/config/ConfigObserver;

    iget-object v0, p0, mSceneCallBlockConfigObserver:Lcom/oneplus/config/ConfigObserver;
...
.method private isCallBlocked(Ljava/lang/String;ILandroid/content/Intent;Landroid/content/pm/ResolveInfo;)Z
    ...
    :goto_0
    invoke-direct {p0, v1}, isCallBlockedOnForUser(I)Z

    move-result v3

    if-eqz v3, :cond_12

    invoke-direct {p0, v1}, isValidUserId(I)Z
    ...
    iget-object v3, p0, mImComponentLists:Lcom/oneplus/util/MultiMap;
    ...
    :goto_2
    invoke-direct {p0, p1, v3, v5}, isForegroundAppWithUid(Ljava/lang/String;Ljava/lang/String;I)Z
    ...
    :cond_d
    iget-object v1, p0, mImSpecialActions:Lcom/oneplus/util/MultiMap;
    ...
    :cond_f
    iget-boolean v0, p0, mIsNotifyBlocked:Z

    if-nez v0, :cond_10

    :try_start_2
    invoke-direct {p0, p1, p2, p3, p4}, popNotify(Ljava/lang/String;ILandroid/content/Intent;Landroid/content/pm/ResolveInfo;)V
    :try_end_2
...
.method private isCallBlockedOn()Z
    ...
    invoke-direct {p0, v0, v1}, isCallBlockedOnForUser(IZ)Z
...
.method private isCallBlockedOnForUser(I)Z
    ...
    invoke-direct {p0, p1, v0}, isCallBlockedOnForUser(IZ)Z
...
.method private isCallBlockedOnForUser(IZ)Z
    ...
    :cond_0
    invoke-direct {p0, p1, p2}, blockerEnabled(IZ)Z

    move-result p1

    sget-boolean p2, DBG_LOGV:Z
    ...
    invoke-direct {p0}, isScreenAwake()Z

    move-result p1

    if-eqz p1, :cond_2

    invoke-direct {p0}, isScreenLocked()Z
...
.method private isForegroundAppWithUid(Ljava/lang/String;Ljava/lang/String;I)Z
    ...
    sget-object v7, mPis:Ljava/util/List;
...
.method private isForegroundCalling(Ljava/lang/String;)Z
    ...
    :cond_0
    invoke-direct {p0}, getPopedStatus()Ljava/lang/String;
    ...
    invoke-direct {p0, p1, v1, v0}, isForegroundAppWithUid(Ljava/lang/String;Ljava/lang/String;I)Z
...
.method private isHandledByBrickMode(Ljava/lang/String;)Z
    ...
    iget-object v1, p0, whiteListInBreathMode:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, whiteListInBreathMode:Ljava/util/ArrayList;
...
.method private isHandledByCallBlocker()Z
    ...
    iget-object p0, p0, mImComponentLists:Lcom/oneplus/util/MultiMap;
...
.method private loadDefaultConfigs()V
    ...
    :cond_1
    iget-object v2, p0, mImComponentLists:Lcom/oneplus/util/MultiMap;
    ...
    :cond_4
    iget-object v9, p0, mImSpecialIntents:Lcom/oneplus/util/MultiMap;
    ...
    :cond_7
    iget-object v9, p0, mImSpecialActions:Lcom/oneplus/util/MultiMap;
...
.method private popNotify(Ljava/lang/String;ILandroid/content/Intent;Landroid/content/pm/ResolveInfo;)V
    ...
    :cond_0
    iget-object v1, v7, mOemSceneCallBlock:Lcom/oneplus/util/notification/SimpleHeadsUpController;
    ...
    iput-object v1, v7, mOemSceneCallBlock:Lcom/oneplus/util/notification/SimpleHeadsUpController;
    ...
    invoke-direct {v7, v13, v0}, getAppNameFromPkgName(Ljava/lang/String;Landroid/content/pm/ResolveInfo;)Ljava/lang/String;
    ...
    iget-object v4, v7, mOemSceneCallBlock:Lcom/oneplus/util/notification/SimpleHeadsUpController;
    ...
    iget v4, v7, mCurrentAppUid:I

    if-ne v4, v3, :cond_3

    iget-object v0, v7, mOemSceneCallBlock:Lcom/oneplus/util/notification/SimpleHeadsUpController;
    ...
    invoke-direct/range {v0 .. v6}, setOnClickListenerView(Landroid/view/View;Landroid/content/Intent;IILjava/lang/String;Ljava/lang/String;)V

    return-void

    :cond_3
    iput v3, v7, mCurrentAppUid:I
    ...
    invoke-direct/range {p0 .. p0}, getPopedStatus()Ljava/lang/String;
    ...
    iget-object v15, v7, mPoppedComponentName:Ljava/lang/String;
    ...
    iget-object v1, v7, mPoppedComponentName:Ljava/lang/String;
    ...
    invoke-direct {v7, v15, v13, v3}, isForegroundAppWithUid(Ljava/lang/String;Ljava/lang/String;I)Z

    move-result v1

    if-nez v1, :cond_c

    iget-object v1, v7, mInCallClickedPackage:Ljava/lang/String;
    ...
    :cond_8
    iput-object v4, v7, mPoppedComponentName:Ljava/lang/String;

    invoke-direct {v7, v8, v13}, hideView(ILjava/lang/String;)V
    ...
    invoke-direct {v7, v0}, drawableToBitmap(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Bitmap;
    ...
    new-instance v1, Lcom/oneplus/android/server/scene/bvj;

    invoke-direct {v1, v7, v8, v13}, Lcom/oneplus/android/server/scene/bvj;-><init>(Lcom/oneplus/android/server/scene/OemSceneCallBlock;ILjava/lang/String;)V
    ...
    invoke-direct/range {v0 .. v5}, showView(Landroid/view/View;Ljava/lang/String;JI)V
...
.method private resetPopedStatus(I)V
    ...
    invoke-direct {p0, v0, p1}, putPopedStatus(Ljava/lang/String;I)V
...
.method private resolveAdditionalConfig(Ljava/lang/String;)V
    ...
    new-instance v0, Lcom/oneplus/android/server/scene/ugm;

    invoke-direct {v0, p0, p1}, Lcom/oneplus/android/server/scene/ugm;-><init>(Lcom/oneplus/android/server/scene/OemSceneCallBlock;Ljava/lang/String;)V
...
.method private resolveImConfigFromJSON(Lorg/json/JSONArray;)V
    ...
    :try_start_1
    iget-object v7, v1, mImComponentLists:Lcom/oneplus/util/MultiMap;
    ...
    :cond_1
    iget-object v0, v1, mImComponentLists:Lcom/oneplus/util/MultiMap;
    ...
    iget-object v0, v1, mImSpecialIntents:Lcom/oneplus/util/MultiMap;
    ...
    iget-object v0, v1, mImSpecialActions:Lcom/oneplus/util/MultiMap;
    ...
    :cond_8
    iget-boolean v0, v1, mIsFetched:Z

    if-nez v0, :cond_9

    const/4 v2, 0x1

    iput-boolean v2, v1, mIsFetched:Z
    ...
    iget-object v2, v1, mImComponentLists:Lcom/oneplus/util/MultiMap;
    ...
    iget-object v2, v1, mImSpecialIntents:Lcom/oneplus/util/MultiMap;
    ...
    iget-object v1, v1, mImSpecialActions:Lcom/oneplus/util/MultiMap;
    ...
    :goto_4
    iget-boolean v2, v1, mIsFetched:Z
    ...
    iget-object v5, v1, mImComponentLists:Lcom/oneplus/util/MultiMap;
    ...
    iget-object v4, v1, mImSpecialIntents:Lcom/oneplus/util/MultiMap;
...
.method private setOnClickListenerView(Landroid/view/View;Landroid/content/Intent;IILjava/lang/String;Ljava/lang/String;)V
    ...
    new-instance v7, Lcom/oneplus/android/server/scene/gwm;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/oneplus/android/server/scene/gwm;-><init>(Lcom/oneplus/android/server/scene/OemSceneCallBlock;Landroid/content/Intent;ILjava/lang/String;Ljava/lang/String;I)V
...
.method private showView(Landroid/view/View;Ljava/lang/String;JI)V
    ...
    :cond_3
    :try_start_1
    invoke-direct {p0, v6, p5}, putPopedStatus(Ljava/lang/String;I)V
    ...
    iget-object v5, p0, mOemSceneCallBlock:Lcom/oneplus/util/notification/SimpleHeadsUpController;
...
.method public isCallBlockedWithUid(Ljava/lang/String;ILandroid/content/Intent;Landroid/content/pm/ResolveInfo;IZ)Z
    ...
    :cond_0
    invoke-direct {p0, p1, p2, p3, p4}, isCallBlocked(Ljava/lang/String;ILandroid/content/Intent;Landroid/content/pm/ResolveInfo;)Z
...
.method public isMutedByCallBlocker(Ljava/lang/String;Landroid/media/AudioAttributes;)Z
    ...
    :cond_0
    invoke-virtual {p0, p1}, updatePis(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v3}, isForegroundCalling(Ljava/lang/String;)Z
    ...
    :cond_3
    invoke-direct {p0}, isCallBlockedOn()Z
    ...
    invoke-direct {p0}, isHandledByCallBlocker()Z

    move-result v3

    if-eqz v3, :cond_4

    invoke-direct {p0, p1}, isForegroundCalling(Ljava/lang/String;)Z
    ...
    :cond_7
    invoke-direct {p0}, isBrickModeOn()Z

    move-result v1

    if-eqz v1, :cond_8

    invoke-direct {p0, p1}, isHandledByBrickMode(Ljava/lang/String;)Z
...
.method public isNotificationMutedByCallBlocker(Ljava/lang/String;ILandroid/service/notification/StatusBarNotification;)Z
    ...
    invoke-direct {p0, p1, p2, p3, v0}, isCallBlocked(Ljava/lang/String;ILandroid/content/Intent;Landroid/content/pm/ResolveInfo;)Z
...
.method public isNotificationMutedByESport(Landroid/service/notification/StatusBarNotification;)Z
    ...
    sget-object v2, whiteListInESportMode:Ljava/util/ArrayList;
    ...
    sget-object v1, whiteListTagInSystemUI:Ljava/util/ArrayList;
...
.method public isVibratorUsageMutedByCallBlocker(Ljava/lang/String;ILjava/lang/String;)Z
    ...
    :cond_0
    invoke-virtual {p0, p3}, updatePis(Ljava/lang/String;)V
    ...
    iget-object v0, p0, mImComponentLists:Lcom/oneplus/util/MultiMap;
...
.method public systemReady(Landroid/content/Context;)V
    ...
    invoke-direct {p0}, loadDefaultConfigs()V
    ...
    invoke-direct {v2, p0, v3}, Lcom/oneplus/android/server/scene/OemSceneCallBlock$ProcessObserver;-><init>(Lcom/oneplus/android/server/scene/OemSceneCallBlock;Lcom/oneplus/android/server/scene/bvj;)V
...
.method public updatePis(Ljava/lang/String;)V
    .locals 3
    ...
    const-string p0, "no need to updatePis"
    ...
    sput-object p0, mPis:Ljava/util/List;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string p1, "updatePis error:"
