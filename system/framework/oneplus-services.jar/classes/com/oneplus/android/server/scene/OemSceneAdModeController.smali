...
.method static constructor <clinit>()V
    ...
    sput-object v1, URI_GAME_MODE_AD_ENABLE:Landroid/net/Uri;

    sput-boolean v2, mManualAdStatus:Z
    ...
    sput-object v1, RULE_ADMODE_CONTROLLER:Lcom/oneplus/core/oimc/OIMCRule;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput v1, p0, mOpAdModeManual:I

    const/16 v1, 0xe

    iput v1, p0, mOpAdModeStrength:I

    const/16 v1, 0x12c

    iput v1, p0, mOpAdStrengthDefault:I

    const/4 v1, 0x0

    iput-object v1, p0, mDaemon:Lsis/you/you/zta/zta/you;

    const/16 v1, 0x14

    iput v1, p0, mInterval:I

    const/16 v1, 0x3c

    iput v1, p0, mTimes:I

    iput-boolean v0, p0, mLastEnabled:Z

    new-instance v0, Lcom/oneplus/android/server/scene/ywr;

    invoke-direct {v0, p0}, Lcom/oneplus/android/server/scene/ywr;-><init>(Lcom/oneplus/android/server/scene/OemSceneAdModeController;)V

    iput-object v0, p0, mTestReceiver:Landroid/content/BroadcastReceiver;

    invoke-direct {p0, p1}, initEnv(Landroid/content/Context;)V
    ...
    iput-object p1, p0, mDaemon:Lsis/you/you/zta/zta/you;
    :try_end_0
...
.method static synthetic access$000(Lcom/oneplus/android/server/scene/OemSceneAdModeController;ZI)V
    ...
    invoke-direct {p0, p1, p2}, setModeSmoothly(ZI)V
...
.method static synthetic access$200(Lcom/oneplus/android/server/scene/OemSceneAdModeController;)Lsis/you/you/zta/zta/you;
    ...
    iget-object p0, p0, mDaemon:Lsis/you/you/zta/zta/you;
...
.method static synthetic access$300(Lcom/oneplus/android/server/scene/OemSceneAdModeController;)V
    ...
    invoke-direct {p0}, updateAdEnabled()V
...
.method public static getInstance(Landroid/content/Context;)Lcom/oneplus/android/server/scene/OemSceneAdModeController;
    ...
    sget-object v0, sInstance:Lcom/oneplus/android/server/scene/OemSceneAdModeController;
    ...
    sput-object v0, sInstance:Lcom/oneplus/android/server/scene/OemSceneAdModeController;

    :cond_0
    sget-object p0, sInstance:Lcom/oneplus/android/server/scene/OemSceneAdModeController;
...
.method private initEnv(Landroid/content/Context;)V
    ...
    iget-object v2, p0, mTestReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object p1, p0, mAdModeObserver:Lcom/oneplus/android/server/scene/OemSceneAdModeController$zta;

    iget-object p1, p0, mResolver:Landroid/content/ContentResolver;

    sget-object v0, URI_GAME_MODE_AD_ENABLE:Landroid/net/Uri;

    iget-object v1, p0, mAdModeObserver:Lcom/oneplus/android/server/scene/OemSceneAdModeController$zta;
...
.method private setModeByDefault(ZI)V
    ...
    iput-boolean p1, p0, mLastEnabled:Z

    sput-boolean p1, mManualAdStatus:Z

    iget-object v0, p0, mDaemon:Lsis/you/you/zta/zta/you;
    ...
    new-instance v1, Lcom/oneplus/android/server/scene/gck;

    invoke-direct {v1, p0, p1, p2}, Lcom/oneplus/android/server/scene/gck;-><init>(Lcom/oneplus/android/server/scene/OemSceneAdModeController;ZI)V
...
.method private setModeSmoothly(ZI)V
    ...
    iget-object v0, p0, mTimer:Landroid/os/CountDownTimer;
    ...
    iput-object v0, p0, mTimer:Landroid/os/CountDownTimer;
    ...
    invoke-direct/range {v1 .. v8}, Lcom/oneplus/android/server/scene/dma;-><init>(Lcom/oneplus/android/server/scene/OemSceneAdModeController;JJIZ)V

    invoke-virtual {v0}, Landroid/os/CountDownTimer;->start()Landroid/os/CountDownTimer;

    move-result-object p1

    iput-object p1, p0, mTimer:Landroid/os/CountDownTimer;
...
.method private declared-synchronized updateAdEnabled()V
    ...
    :cond_1
    invoke-virtual {p0}, updateFunctionRule()V
    :try_end_0
...
.method public onStart([Ljava/lang/String;)I
    ...
    iget v0, p0, mOpAdStrengthDefault:I

    invoke-direct {p0, p1, v0}, setModeByDefault(ZI)V
...
.method public onStop([Ljava/lang/String;)I
    ...
    :cond_0
    iget p1, p0, mOpAdStrengthDefault:I

    const/4 v0, 0x0

    invoke-direct {p0, v0, p1}, setModeByDefault(ZI)V
...
.method public updateFunctionRule()V
    ...
    sget-object p0, RULE_ADMODE_CONTROLLER:Lcom/oneplus/core/oimc/OIMCRule;
