...
.field private static final OP_NOTIFY_DITHER_STATUS:I = 0x17
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, IS_SUPPORT_DECR_BL_CJ:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, mHasFingerprint:Z

    iput-boolean v0, p0, mWBReadModeState:Z

    iput-boolean v0, p0, mNightModeState:Z

    iput-boolean v0, p0, mColorReadModeState:Z

    iput v0, p0, mDisableColorState:I

    const/4 v1, 0x0

    iput v1, p0, mGlobaAmbientLux:F

    iput v0, p0, mVivdAndNaturalCCT:I
    ...
    iput-object v0, p0, mColorGamutManager:Lcom/oneplus/android/server/display/dma;
    ...
    iput-object v0, p0, mColorDisplayThread:Landroid/os/HandlerThread;

    iget-object v0, p0, mColorDisplayThread:Landroid/os/HandlerThread;

    invoke-virtual {v0}, Landroid/os/HandlerThread;->start()V

    new-instance v0, Lcom/oneplus/android/server/display/OpColorDisplayService$zta;

    iget-object v1, p0, mColorDisplayThread:Landroid/os/HandlerThread;
    ...
    iput-object v0, p0, mCDHHandler:Lcom/oneplus/android/server/display/OpColorDisplayService$zta;
    ...
    iput-object v0, p0, mOpColorModeManager:Lcom/oneplus/android/server/display/OpColorModeManager;
    ...
    iput-object v0, p0, mColorTintManager:Lcom/oneplus/android/server/display/bvj;
    ...
    iput-object v0, p0, mAssertiveDisplayManager:Lcom/oneplus/android/server/display/tsu;

    iget-object p1, p0, mColorGamutManager:Lcom/oneplus/android/server/display/dma;

    iget-object v0, p0, mColorTintManager:Lcom/oneplus/android/server/display/bvj;

    invoke-virtual {p1, v0}, Lcom/oneplus/android/server/display/dma;->zta(Lcom/oneplus/android/server/display/bvj;)V

    iget-object p1, p0, mColorGamutManager:Lcom/oneplus/android/server/display/dma;

    iget-object p0, p0, mOpColorModeManager:Lcom/oneplus/android/server/display/OpColorModeManager;
...
.method static synthetic access$000(Lcom/oneplus/android/server/display/OpColorDisplayService;Z)V
    ...
    invoke-direct {p0, p1}, revertStatus(Z)V
...
.method static synthetic access$100(Lcom/oneplus/android/server/display/OpColorDisplayService;)Lcom/oneplus/android/server/display/bvj;
    ...
    iget-object p0, p0, mColorTintManager:Lcom/oneplus/android/server/display/bvj;
...
.method static synthetic access$1000(Lcom/oneplus/android/server/display/OpColorDisplayService;)I
    ...
    iget p0, p0, mDisableColorState:I
...
.method static synthetic access$1100(Lcom/oneplus/android/server/display/OpColorDisplayService;Z)V
    ...
    invoke-direct {p0, p1}, processScreenOn(Z)V
...
.method static synthetic access$1200(Lcom/oneplus/android/server/display/OpColorDisplayService;)V
    ...
    invoke-direct {p0}, dcStatusChange()V
...
.method static synthetic access$1300(Lcom/oneplus/android/server/display/OpColorDisplayService;)V
    ...
    invoke-direct {p0}, nightStrengthChanged()V
...
.method static synthetic access$1400(Lcom/oneplus/android/server/display/OpColorDisplayService;)V
    ...
    invoke-direct {p0}, nightBrightnessChanged()V
...
.method static synthetic access$1500(Lcom/oneplus/android/server/display/OpColorDisplayService;)Z
    ...
    iget-boolean p0, p0, mColorReadModeState:Z
...
.method static synthetic access$1700(Lcom/oneplus/android/server/display/OpColorDisplayService;)Lcom/oneplus/android/server/display/tsu;
    ...
    iget-object p0, p0, mAssertiveDisplayManager:Lcom/oneplus/android/server/display/tsu;
...
.method static synthetic access$400(Lcom/oneplus/android/server/display/OpColorDisplayService;)Lcom/oneplus/android/server/display/dma;
    ...
    iget-object p0, p0, mColorGamutManager:Lcom/oneplus/android/server/display/dma;
...
.method static synthetic access$600(Lcom/oneplus/android/server/display/OpColorDisplayService;)I
    ...
    iget p0, p0, mVivdAndNaturalCCT:I
...
.method static synthetic access$602(Lcom/oneplus/android/server/display/OpColorDisplayService;I)I
    ...
    iput p1, p0, mVivdAndNaturalCCT:I
...
.method static synthetic access$700(Lcom/oneplus/android/server/display/OpColorDisplayService;)Z
    ...
    iget-boolean p0, p0, mNightModeState:Z
...
.method static synthetic access$800(Lcom/oneplus/android/server/display/OpColorDisplayService;)Z
    ...
    iget-boolean p0, p0, mWBReadModeState:Z
...
.method private dcStatusChange()V
    ...
    const-string v4, "persist.vendor.dc.enable"
    ...
    iget-object v1, p0, mOpColorModeManager:Lcom/oneplus/android/server/display/OpColorModeManager;

    invoke-virtual {v1, v3, v2}, Lcom/oneplus/android/server/display/OpColorModeManager;->ibl(IZ)V
    ...
    invoke-virtual {v2, v3, v1}, Lcom/oneplus/android/server/display/OpColorModeManager;->ibl(IZ)V
    ...
    invoke-virtual {v1, v2, v0}, Lcom/oneplus/android/server/display/OpColorModeManager;->ibl(IZ)V

    iget-object p0, p0, mColorGamutManager:Lcom/oneplus/android/server/display/dma;

    invoke-virtual {p0, v0}, Lcom/oneplus/android/server/display/dma;->D(Z)V
...
.method private nightStrengthChanged()V
    ...
    invoke-virtual {p0}, Lcom/oneplus/android/server/display/bvj;->Ff()V
...
.method private processScreenOn(Z)V
    ...
    iput-object v3, p0, mFpm:Landroid/hardware/fingerprint/FingerprintManager;
    ...
    iget-boolean v0, p0, mHasFingerprint:Z
    ...
    :cond_4
    invoke-direct {p0, v4}, revertStatus(Z)V

    :cond_5
    iget-object p0, p0, mColorGamutManager:Lcom/oneplus/android/server/display/dma;

    invoke-virtual {p0, p1}, Lcom/oneplus/android/server/display/dma;->G(Z)V
...
.method private revertStatus(Z)V
    ...
    invoke-virtual {p1, v1}, Lcom/oneplus/android/server/display/OpColorModeManager;->na(I)V
    ...
    invoke-virtual {p1}, Lcom/oneplus/android/server/display/bvj;->Df()V
    ...
    invoke-virtual {v1, v2}, Lcom/oneplus/android/server/display/OpColorModeManager;->na(I)V
    ...
    invoke-virtual {p1, v2}, Lcom/oneplus/android/server/display/bvj;->C(Z)V
    ...
    invoke-virtual {v1, p1}, Lcom/oneplus/android/server/display/OpColorModeManager;->na(I)V
    ...
    invoke-virtual {p1, v9}, Lcom/oneplus/android/server/display/OpColorModeManager;->na(I)V
    ...
    invoke-virtual {p1}, Lcom/oneplus/android/server/display/bvj;->Cf()V
    ...
    invoke-virtual {v1, v4}, Lcom/oneplus/android/server/display/OpColorModeManager;->na(I)V
    ...
    invoke-virtual {p0, v0}, Lcom/oneplus/android/server/display/dma;->fa(I)V
...
.method private setUp()V
    ...
    invoke-direct {p0, v0}, revertStatus(Z)V
    ...
    invoke-virtual {v1, v0}, Lcom/oneplus/android/server/display/OpColorModeManager;->ja(I)Z
...
.method public disableColor(I)V
    ...
    iput p1, p0, mDisableColorState:I

    const/4 p1, 0x4

    invoke-virtual {p0, p1}, sendMsg(I)V
...
.method public disablelightSensor()V
    ...
    invoke-virtual {p0, v0}, sendMsg(I)V
...
.method public resetStatus(I)V
    ...
    :cond_0
    invoke-direct {p0, v5}, revertStatus(Z)V

    iget-object v1, p0, mColorTintManager:Lcom/oneplus/android/server/display/bvj;

    invoke-virtual {v1}, Lcom/oneplus/android/server/display/bvj;->Ef()V
    ...
    invoke-virtual {v1, v0, v6}, Lcom/oneplus/android/server/display/OpColorModeManager;->ibl(IZ)V
    ...
    invoke-virtual {v0, v2, v6}, Lcom/oneplus/android/server/display/OpColorModeManager;->ibl(IZ)V
    ...
    invoke-virtual {v1}, Lcom/oneplus/android/server/display/bvj;->zf()V

    iget-object v1, p0, mOpColorModeManager:Lcom/oneplus/android/server/display/OpColorModeManager;

    const/4 v7, 0x7

    invoke-virtual {v1, v7}, Lcom/oneplus/android/server/display/OpColorModeManager;->na(I)V

    iget-object v1, p0, mOpColorModeManager:Lcom/oneplus/android/server/display/OpColorModeManager;

    const/16 v7, 0x11

    invoke-virtual {v1, v7, v6}, Lcom/oneplus/android/server/display/OpColorModeManager;->ibl(IZ)V
    ...
    invoke-virtual {v0, v2, v5}, Lcom/oneplus/android/server/display/OpColorModeManager;->ibl(IZ)V
    ...
    invoke-virtual {p0, v5}, Lcom/oneplus/android/server/display/dma;->E(Z)V
...
.method public sendMsg(I)V
    ...
    iget-object p1, p0, mCDHHandler:Lcom/oneplus/android/server/display/OpColorDisplayService$zta;
    ...
    iget-object p0, p0, mCDHHandler:Lcom/oneplus/android/server/display/OpColorDisplayService$zta;
...
.method public setGrayColorActivated(Z)V
    ...
    iput-boolean p1, p0, mWBReadModeState:Z
...
.method public setMediaCodecState(Z)V
    ...
    invoke-virtual {p0, p1}, Lcom/oneplus/android/server/display/dma;->F(Z)V
...
.method public setPaperColorActivated(Z)V
    ...
    iput-boolean p1, p0, mColorReadModeState:Z
...
.method public systemReady()V
    ...
    iget-object v1, p0, mColorGamutManager:Lcom/oneplus/android/server/display/dma;

    invoke-virtual {v1, v0}, Lcom/oneplus/android/server/display/dma;->fa(I)V
