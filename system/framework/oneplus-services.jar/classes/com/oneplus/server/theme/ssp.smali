...
.field private static final iva:Ljava/lang/String; = "android.settings.oneplus_theme_enable"

.field private static final jva:Ljava/lang/String; = "android.settings.oneplus_theme_disable"

.field private static final kva:Ljava/lang/String; = "android.settings.oneplus_theme_enable_single"

.field private static final lva:Ljava/lang/String; = "android.settings.oneplus_theme_disable_single"

.field private static mInstance:Lcom/oneplus/server/theme/ssp; = null

.field private static final mva:Ljava/lang/String; = "android.settings.OEM_FONT_MODE"

.field private static final nva:Ljava/lang/String; = "android.settings.oneplus_basiccolor_ready"

.field private static final ova:Ljava/lang/String; = "com.oem.intent.action.PKG_ADDED_UPDATED"

.field private static final pva:Ljava/lang/String; = "android.settings.oneplus_theme_ready"

.field private static final qva:Ljava/lang/String; = "com.oem.intent.action.parallel_overlay_ready"

.field private static final rva:Ljava/lang/String; = "persist.sys.theme_first_launch"

.field private static final sva:Ljava/lang/String; = "persist.sys.theme_version"

.field public static final tva:I = 0x2

.field public static final uva:I = 0x1

.field public static final vva:I = 0x0

.field private static final wva:Ljava/lang/String; = "oneplus_basiccolor_black"

.field private static final xva:Ljava/lang/String; = "oneplus_basiccolor_white"

.field private static final yva:Ljava/lang/String; = "oneplus_shape_circle"

.field private static final zva:I = 0x1


# instance fields
.field private eva:Landroid/content/om/IOverlayManager;

.field private fva:Landroid/app/IUiModeManager;

.field private gva:Landroid/os/IUserManager;

.field private hva:Landroid/content/BroadcastReceiver;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, mInstance:Lcom/oneplus/server/theme/ssp;

    const/4 v0, 0x0

    sput-boolean v0, Ava:Z
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, gva:Landroid/os/IUserManager;
    ...
    iput-object p1, p0, eva:Landroid/content/om/IOverlayManager;
    ...
    iput-object p1, p0, fva:Landroid/app/IUiModeManager;
    ...
    :goto_0
    iput-object p1, p0, mSystemAppList:Ljava/util/ArrayList;
...
.method private Ov()V
    ...
    sput-boolean v1, Ava:Z

    const-string v0, "android.settings.oneplus_theme_ready"

    const-string v1, "com.android.settings"

    invoke-direct {p0, v0, v1}, les(Ljava/lang/String;Ljava/lang/String;)V
...
.method private Qv()V
    ...
    iput-object v0, p0, hva:Landroid/content/BroadcastReceiver;
    ...
    iget-object v2, p0, hva:Landroid/content/BroadcastReceiver;
    ...
    iget-object p0, p0, hva:Landroid/content/BroadcastReceiver;
...
.method private Sv()Z
    ...
    :try_start_0
    iget-object v2, p0, gva:Landroid/os/IUserManager;
    ...
    iget-object p0, p0, gva:Landroid/os/IUserManager;
...
.method public static getInstance(Landroid/content/Context;)Lcom/oneplus/server/theme/ssp;
    ...
    sget-object v0, mInstance:Lcom/oneplus/server/theme/ssp;
    ...
    :cond_0
    sget-object p0, mInstance:Lcom/oneplus/server/theme/ssp;
...
.method private les(Ljava/lang/String;Ljava/lang/String;)V
    .locals 1
...
.method private md(Ljava/lang/String;)Ljava/util/ArrayList;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_0
    iget-object p0, p0, eva:Landroid/content/om/IOverlayManager;
...
.method static synthetic you(Lcom/oneplus/server/theme/ssp;)Landroid/app/IUiModeManager;
    ...
    iget-object p0, p0, fva:Landroid/app/IUiModeManager;
...
.method public cno(Ljava/lang/String;I)V
    ...
    invoke-direct {p0, p1}, md(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    :try_start_0
    iget-object v2, p0, eva:Landroid/content/om/IOverlayManager;
...
.method public enableTheme(Ljava/lang/String;)V
    ...
    :try_start_0
    iget-object v3, p0, eva:Landroid/content/om/IOverlayManager;
...
.method public processDisableThemeCategory(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p2}, ld(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, disableTheme(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, p2}, cno(Ljava/lang/String;I)V

    :cond_4
    :goto_1
    invoke-direct {p0}, Ov()V
...
.method public processEnableThemeCategory(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, enableTheme(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, p2}, kth(Ljava/lang/String;I)V

    const-string p1, "android.settings.oneplus_basiccolor_ready"

    invoke-direct {p0, p1}, nd(Ljava/lang/String;)V
...
.method public vg()V
    ...
    invoke-virtual {p0, v1}, enableTheme(Ljava/lang/String;)V
