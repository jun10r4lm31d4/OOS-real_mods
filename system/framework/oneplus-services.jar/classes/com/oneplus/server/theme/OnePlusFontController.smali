...
.method static constructor <clinit>()V
    ...
    sput-object v0, sInstance:Lcom/oneplus/server/theme/OnePlusFontController;
...
.method static synthetic access$100(Lcom/oneplus/server/theme/OnePlusFontController;)V
    ...
    invoke-direct {p0}, handleNotifyZygote()V
...
.method static synthetic access$200(Lcom/oneplus/server/theme/OnePlusFontController;)V
    ...
    invoke-direct {p0}, restoreUserFontAfterReboot()V
...
.method private dispatchNewConfigs(Landroid/content/res/Configuration;)V
    ...
    :try_start_0
    invoke-direct {p0}, getAm()Landroid/app/IActivityManager;
    ...
    :cond_0
    invoke-static {p0, p1}, updateConfigurationReflect(Landroid/app/IActivityManager;Landroid/content/res/Configuration;)V
    ...
    invoke-static {p1, p0}, loge(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private initHandler()V
    ...
    invoke-direct {v0, p0, v1}, Lcom/oneplus/server/theme/zta;-><init>(Lcom/oneplus/server/theme/OnePlusFontController;Landroid/os/Looper;)V
...
.method private prepareDebugEnv(Landroid/content/Context;)V
    ...
    new-instance v0, Lcom/oneplus/server/theme/sis;

    invoke-direct {v0, p0}, Lcom/oneplus/server/theme/sis;-><init>(Lcom/oneplus/server/theme/OnePlusFontController;)V
...
.method private restoreUserFontAfterReboot()V
    ...
    invoke-virtual {p0, v1, v0}, changeFontForUser(II)V
    :try_end_0
...
.method private scheduleRestoreFontWhenBootComplete(Landroid/content/Context;)V
    ...
    new-instance v0, Lcom/oneplus/server/theme/you;

    invoke-direct {v0, p0}, Lcom/oneplus/server/theme/you;-><init>(Lcom/oneplus/server/theme/OnePlusFontController;)V
...
.method public changeFontForUser(II)V
    ...
    invoke-direct {p0}, checkEnvAndPermission()Z
    ...
    invoke-static {v0, p1, p2}, modifyOpFontConfig(Landroid/content/res/OnePlusExtraConfiguration;II)V

    const/high16 p1, 0x2000000

    invoke-static {v1, p1}, Lcom/oneplus/theme/OpFontHelperInjector;->changeFont(Landroid/content/res/Configuration;I)V

    invoke-direct {p0, v1}, dispatchNewConfigs(Landroid/content/res/Configuration;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public initForFontCtrl(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1}, scheduleRestoreFontWhenBootComplete(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1}, prepareDebugEnv(Landroid/content/Context;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onFactoryReset()V
    ...
    invoke-direct {p0}, handleFactoryReset()V
