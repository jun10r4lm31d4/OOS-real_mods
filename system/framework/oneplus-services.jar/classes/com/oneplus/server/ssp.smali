...
.field private static Tua:Lcom/oneplus/android/server/scene/OemSceneAutoBrightnessController;

.field private static Uua:Lcom/oneplus/android/server/scene/OemSceneButtonController;

.field private static Vua:Lcom/oneplus/android/server/scene/OemSceneVibrationController;

.field private static Wua:Lcom/oneplus/android/server/scene/OemSceneActivityController;

.field private static Xua:Lcom/oneplus/android/server/scene/OemSceneLightsController;

.field private static Yua:Lcom/oneplus/android/server/scene/OemSceneFloatingWindowController;

.field private static Zua:Lcom/oneplus/android/server/scene/OemSceneAudioController;

.field private static _ua:Lcom/oneplus/android/server/scene/ESportMode;

.field private static ava:Lcom/oneplus/android/server/scene/oif;

.field private static bva:Landroid/content/BroadcastReceiver;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, bva:Landroid/content/BroadcastReceiver;
...
.method public static sis(Landroid/content/Context;I)V
    ...
    sput-object p0, ava:Lcom/oneplus/android/server/scene/oif;

    sget-object p0, ava:Lcom/oneplus/android/server/scene/oif;

    if-eqz p0, :cond_0

    sget-object p0, ava:Lcom/oneplus/android/server/scene/oif;

    invoke-virtual {p0}, Lcom/oneplus/android/server/scene/oif;->Sf()V

    sget-object p0, ava:Lcom/oneplus/android/server/scene/oif;

    invoke-virtual {p0, p1}, Lcom/oneplus/android/server/scene/oif;->ua(I)V
    :try_end_0
...
.method public static wtn(Landroid/content/Context;)V
    .locals 2
    ...
    sget-object v1, bva:Landroid/content/BroadcastReceiver;
...
.method public static you(Lcom/oneplus/core/oimc/IOIMCServiceManager;Landroid/content/Context;)V
    ...
    :try_start_0
    sget-object v0, Uua:Lcom/oneplus/android/server/scene/OemSceneButtonController;
    ...
    invoke-virtual {p0, v0}, Lcom/oneplus/android/server/scene/oif;->ua(I)V
    ...
    :cond_3
    sget-object p0, Tua:Lcom/oneplus/android/server/scene/OemSceneAutoBrightnessController;
...
.method public static zta(Lcom/oneplus/core/oimc/IOIMCServiceManager;Landroid/content/Context;)V
    ...
    sput-object v0, Uua:Lcom/oneplus/android/server/scene/OemSceneButtonController;
    ...
    sget-object v1, Uua:Lcom/oneplus/android/server/scene/OemSceneButtonController;
    ...
    sput-object v0, Wua:Lcom/oneplus/android/server/scene/OemSceneActivityController;

    sget-object v0, Wua:Lcom/oneplus/android/server/scene/OemSceneActivityController;

    if-eqz v0, :cond_1

    const-string v0, "AllowWhiteActivity"

    sget-object v1, Wua:Lcom/oneplus/android/server/scene/OemSceneActivityController;

    invoke-virtual {v1}, Lcom/oneplus/android/server/scene/OemSceneActivityController;->Rf()Lcom/oneplus/android/server/scene/OemSceneActivityController$AllowWhiteActivity;
    ...
    sput-object v0, Vua:Lcom/oneplus/android/server/scene/OemSceneVibrationController;

    sget-object v0, Vua:Lcom/oneplus/android/server/scene/OemSceneVibrationController;

    if-eqz v0, :cond_2

    const-string v0, "AllowWhiteVibration"

    sget-object v1, Vua:Lcom/oneplus/android/server/scene/OemSceneVibrationController;

    invoke-virtual {v1}, Lcom/oneplus/android/server/scene/OemSceneVibrationController;->kg()Lcom/oneplus/android/server/scene/OemSceneVibrationController$AllowWhiteVibration;
    ...
    sput-object v0, Xua:Lcom/oneplus/android/server/scene/OemSceneLightsController;

    sget-object v0, Xua:Lcom/oneplus/android/server/scene/OemSceneLightsController;

    if-eqz v0, :cond_3

    const-string v0, "ZenModeLedController"

    sget-object v1, Xua:Lcom/oneplus/android/server/scene/OemSceneLightsController;

    invoke-virtual {v1}, Lcom/oneplus/android/server/scene/OemSceneLightsController;->ag()Lcom/oneplus/android/server/scene/OemSceneLightsController$ZenModeLedController;
    ...
    sput-object v0, Yua:Lcom/oneplus/android/server/scene/OemSceneFloatingWindowController;

    sget-object v0, Yua:Lcom/oneplus/android/server/scene/OemSceneFloatingWindowController;

    if-eqz v0, :cond_4

    const-string v0, "FloatingWindowController"

    sget-object v1, Yua:Lcom/oneplus/android/server/scene/OemSceneFloatingWindowController;

    invoke-virtual {v1}, Lcom/oneplus/android/server/scene/OemSceneFloatingWindowController;->Uf()Lcom/oneplus/android/server/scene/OemSceneFloatingWindowController$FloatingWindowController;
    ...
    sput-object v0, Zua:Lcom/oneplus/android/server/scene/OemSceneAudioController;

    sget-object v0, Zua:Lcom/oneplus/android/server/scene/OemSceneAudioController;

    if-eqz v0, :cond_5

    const-string v0, "AudioProcessesController"

    sget-object v1, Zua:Lcom/oneplus/android/server/scene/OemSceneAudioController;

    invoke-virtual {v1}, Lcom/oneplus/android/server/scene/OemSceneAudioController;->Tf()Lcom/oneplus/android/server/scene/OemSceneAudioController$AudioProcessesController;
    ...
    sget-object v1, sOemSceneCallBlock:Lcom/oneplus/android/server/scene/OemSceneCallBlock;
    ...
    sput-object v0, _ua:Lcom/oneplus/android/server/scene/ESportMode;

    sget-object v0, _ua:Lcom/oneplus/android/server/scene/ESportMode;

    if-eqz v0, :cond_7

    const-string v0, "ESportMode"

    sget-object v1, _ua:Lcom/oneplus/android/server/scene/ESportMode;
    ...
    iget-object v2, v0, Lcom/oneplus/android/server/display/OpOIMCColorManager;->Cpa:Lcom/oneplus/android/server/display/OpOIMCColorManager$GrayColor;
    ...
    iget-object v2, v0, Lcom/oneplus/android/server/display/OpOIMCColorManager;->Bpa:Lcom/oneplus/android/server/display/OpOIMCColorManager$ColorBalance;

    invoke-interface {p0, v1, v2}, Lcom/oneplus/core/oimc/IOIMCServiceManager;->registerRemoteAction(Ljava/lang/String;Lcom/oneplus/core/oimc/IOIMCRemoteAction;)V

    const-string v1, "ColorDisable"

    iget-object v2, v0, Lcom/oneplus/android/server/display/OpOIMCColorManager;->Epa:Lcom/oneplus/android/server/display/OpOIMCColorManager$ColorDisable;

    invoke-interface {p0, v1, v2}, Lcom/oneplus/core/oimc/IOIMCServiceManager;->registerRemoteAction(Ljava/lang/String;Lcom/oneplus/core/oimc/IOIMCRemoteAction;)V

    const-string v1, "PaperColor"

    iget-object v2, v0, Lcom/oneplus/android/server/display/OpOIMCColorManager;->Dpa:Lcom/oneplus/android/server/display/OpOIMCColorManager$PaperColor;

    invoke-interface {p0, v1, v2}, Lcom/oneplus/core/oimc/IOIMCServiceManager;->registerRemoteAction(Ljava/lang/String;Lcom/oneplus/core/oimc/IOIMCRemoteAction;)V

    const-string v1, "gooleMatrix"

    iget-object v0, v0, Lcom/oneplus/android/server/display/OpOIMCColorManager;->Fpa:Lcom/oneplus/android/server/display/OpOIMCColorManager$GoogleMatrix;
    ...
    sput-object p1, Tua:Lcom/oneplus/android/server/scene/OemSceneAutoBrightnessController;

    sget-object p1, Tua:Lcom/oneplus/android/server/scene/OemSceneAutoBrightnessController;

    if-eqz p1, :cond_b

    const-string p1, "TurnOffAutoBacklight"

    sget-object v0, Tua:Lcom/oneplus/android/server/scene/OemSceneAutoBrightnessController;
