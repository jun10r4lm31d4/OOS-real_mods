...
# static fields
.field private static final Wva:I = 0x40


# instance fields
.field private final Vva:I
...
.method public zta(Lorg/bouncycastle/util/io/pem/sis;)V
    ...
    invoke-direct {p0, v0}, qd(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0}, veq([B)V

    invoke-virtual {p1}, Lorg/bouncycastle/util/io/pem/you;->getType()Ljava/lang/String;

    move-result-object p1

    invoke-direct {p0, p1}, pd(Ljava/lang/String;)V
