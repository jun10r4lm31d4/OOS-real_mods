...
.method protected constructor <init>()V
    ...
    iput-object v0, p0, attrCarrier:Lorg/bouncycastle/jcajce/provider/asymmetric/util/wtn;
...
.method public constructor <init>(Ljava/lang/String;Ljava/security/spec/ECPrivateKeySpec;)V
    ...
    iput-object p1, p0, algorithm:Ljava/lang/String;

    invoke-virtual {p2}, Ljava/security/spec/ECPrivateKeySpec;->getS()Ljava/math/BigInteger;

    move-result-object p1

    iput-object p1, p0, d:Ljava/math/BigInteger;

    invoke-virtual {p2}, Ljava/security/spec/ECPrivateKeySpec;->getParams()Ljava/security/spec/ECParameterSpec;

    move-result-object p1

    iput-object p1, p0, ecSpec:Ljava/security/spec/ECParameterSpec;
...
.method public constructor <init>(Ljava/lang/String;Lorg/bouncycastle/crypto/wtn/zgw;Lorg/bouncycastle/jce/provider/JCEECPublicKey;Ljava/security/spec/ECParameterSpec;)V
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/crypto/wtn/ibl;->wj()Ljava/math/BigInteger;

    move-result-object v1

    invoke-virtual {p1}, Lorg/bouncycastle/crypto/wtn/ibl;->vj()Ljava/math/BigInteger;
    ...
    :cond_0
    iput-object p4, p0, ecSpec:Ljava/security/spec/ECParameterSpec;

    invoke-direct {p0, p3}, zta(Lorg/bouncycastle/jce/provider/JCEECPublicKey;)Lorg/bouncycastle/asn1/n;

    move-result-object p1

    iput-object p1, p0, publicKey:Lorg/bouncycastle/asn1/n;
...
.method public constructor <init>(Ljava/lang/String;Lorg/bouncycastle/crypto/wtn/zgw;Lorg/bouncycastle/jce/provider/JCEECPublicKey;Lyou/zta/you/you/rtg;)V
    ...
    invoke-virtual {p4}, Lyou/zta/you/you/rtg;->wj()Ljava/math/BigInteger;

    move-result-object v1

    invoke-virtual {p4}, Lyou/zta/you/you/rtg;->vj()Ljava/math/BigInteger;
    ...
    iput-object p2, p0, ecSpec:Ljava/security/spec/ECParameterSpec;
...
.method public constructor <init>(Ljava/lang/String;Lorg/bouncycastle/jce/provider/JCEECPrivateKey;)V
    ...
    iget-object p1, p2, d:Ljava/math/BigInteger;

    iput-object p1, p0, d:Ljava/math/BigInteger;

    iget-object p1, p2, ecSpec:Ljava/security/spec/ECParameterSpec;

    iput-object p1, p0, ecSpec:Ljava/security/spec/ECParameterSpec;

    iget-boolean p1, p2, withCompression:Z

    iput-boolean p1, p0, withCompression:Z

    iget-object p1, p2, attrCarrier:Lorg/bouncycastle/jcajce/provider/asymmetric/util/wtn;

    iput-object p1, p0, attrCarrier:Lorg/bouncycastle/jcajce/provider/asymmetric/util/wtn;

    iget-object p1, p2, publicKey:Lorg/bouncycastle/asn1/n;
...
.method public constructor <init>(Ljava/security/interfaces/ECPrivateKey;)V
    ...
    iput-object v0, p0, d:Ljava/math/BigInteger;
...
.method constructor <init>(Lorg/bouncycastle/asn1/dma/vdb;)V
    ...
    invoke-direct {p0, p1}, rtg(Lorg/bouncycastle/asn1/dma/vdb;)V
...
.method private readObject(Ljava/io/ObjectInputStream;)V
    ...
    invoke-direct {p0, v0}, rtg(Lorg/bouncycastle/asn1/dma/vdb;)V
    ...
    iput-boolean v0, p0, withCompression:Z
    ...
    iget-object p0, p0, attrCarrier:Lorg/bouncycastle/jcajce/provider/asymmetric/util/wtn;
...
.method private rtg(Lorg/bouncycastle/asn1/dma/vdb;)V
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/asn1/ibl/veq;->rj()Z
    ...
    invoke-virtual {v1}, Lorg/bouncycastle/asn1/ibl/vju;->wj()Ljava/math/BigInteger;

    move-result-object v8

    invoke-virtual {v1}, Lorg/bouncycastle/asn1/ibl/vju;->vj()Ljava/math/BigInteger;
    ...
    :goto_0
    iput-object v2, p0, ecSpec:Ljava/security/spec/ECParameterSpec;

    goto :goto_1

    :cond_0
    invoke-virtual {v0}, Lorg/bouncycastle/asn1/ibl/veq;->qj()Z
    ...
    iput-object v0, p0, ecSpec:Ljava/security/spec/ECParameterSpec;
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/asn1/ibl/vju;->wj()Ljava/math/BigInteger;

    move-result-object v4

    invoke-virtual {v0}, Lorg/bouncycastle/asn1/ibl/vju;->vj()Ljava/math/BigInteger;
...
.method private writeObject(Ljava/io/ObjectOutputStream;)V
    ...
    iget-boolean v0, p0, withCompression:Z
...
.method public equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0}, tsu()Ljava/math/BigInteger;

    move-result-object v0

    invoke-virtual {p1}, tsu()Ljava/math/BigInteger;
    ...
    invoke-virtual {p0}, mk()Lyou/zta/you/you/rtg;

    move-result-object p0

    invoke-virtual {p1}, mk()Lyou/zta/you/you/rtg;
...
.method public getAlgorithm()Ljava/lang/String;
    ...
    iget-object p0, p0, algorithm:Ljava/lang/String;
...
.method public getEncoded()[B
    ...
    iget-object v0, p0, ecSpec:Ljava/security/spec/ECParameterSpec;
    ...
    invoke-static {v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/bio;->Ya(Ljava/lang/String;)Lorg/bouncycastle/asn1/bvj;
    ...
    iget-object v1, p0, ecSpec:Ljava/security/spec/ECParameterSpec;
    ...
    iget-boolean v3, p0, withCompression:Z
    ...
    :goto_0
    iget-object v0, p0, publicKey:Lorg/bouncycastle/asn1/n;

    if-eqz v0, :cond_3

    new-instance v0, Lorg/bouncycastle/asn1/ywr/you;

    invoke-virtual {p0}, getS()Ljava/math/BigInteger;

    move-result-object v2

    iget-object p0, p0, publicKey:Lorg/bouncycastle/asn1/n;
...
.method public getParameters()Lyou/zta/you/you/rtg;
    ...
    :cond_0
    iget-boolean p0, p0, withCompression:Z
...
.method public getParams()Ljava/security/spec/ECParameterSpec;
    ...
    iget-object p0, p0, ecSpec:Ljava/security/spec/ECParameterSpec;
...
.method public getS()Ljava/math/BigInteger;
    ...
    iget-object p0, p0, d:Ljava/math/BigInteger;
...
.method mk()Lyou/zta/you/you/rtg;
    .locals 1
    ...
    invoke-interface {p0}, Lorg/bouncycastle/jcajce/provider/config/sis;->ibl()Lyou/zta/you/you/rtg;
...
.method public ugm()Ljava/util/Enumeration;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/wtn;->ugm()Ljava/util/Enumeration;
