...
# static fields
.field private static ARa:Ljava/security/Permission;

.field private static BRa:Ljava/security/Permission;

.field private static CRa:Ljava/security/Permission;

.field private static DRa:Ljava/security/Permission;

.field private static yRa:Ljava/security/Permission;

.field private static zRa:Ljava/security/Permission;


# instance fields
.field private sRa:Ljava/lang/ThreadLocal;

.field private tRa:Ljava/lang/ThreadLocal;

.field private volatile uRa:Lyou/zta/you/you/rtg;

.field private volatile vRa:Ljava/lang/Object;

.field private volatile wRa:Ljava/util/Set;

.field private volatile xRa:Ljava/util/Map;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, yRa:Ljava/security/Permission;
    ...
    sput-object v0, zRa:Ljava/security/Permission;
    ...
    sput-object v0, ARa:Ljava/security/Permission;
    ...
    sput-object v0, BRa:Ljava/security/Permission;
    ...
    sput-object v0, CRa:Ljava/security/Permission;
    ...
    sput-object v0, DRa:Ljava/security/Permission;
...
.method constructor <init>()V
    ...
    iput-object v0, p0, sRa:Ljava/lang/ThreadLocal;

    new-instance v0, Ljava/lang/ThreadLocal;

    invoke-direct {v0}, Ljava/lang/ThreadLocal;-><init>()V

    iput-object v0, p0, tRa:Ljava/lang/ThreadLocal;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, wRa:Ljava/util/Set;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, xRa:Ljava/util/Map;
...
.method public bio(I)Ljavax/crypto/spec/DHParameterSpec;
    ...
    iget-object v0, p0, tRa:Ljava/lang/ThreadLocal;
    ...
    iget-object v0, p0, vRa:Ljava/lang/Object;
...
.method public fto()Ljava/util/Map;
    .locals 0

    iget-object p0, p0, xRa:Ljava/util/Map;
...
.method public ibl()Lyou/zta/you/you/rtg;
    .locals 1

    iget-object v0, p0, sRa:Ljava/lang/ThreadLocal;
    ...
    :cond_0
    iget-object p0, p0, uRa:Lyou/zta/you/you/rtg;

    return-object p0
.end method

.method public oxb()Ljava/util/Set;
    .locals 0

    iget-object p0, p0, wRa:Ljava/util/Set;
...
.method public rtg(I)Ljava/security/spec/DSAParameterSpec;
    ...
    sget-object p0, Lorg/bouncycastle/crypto/igw$zta;->FLa:Lorg/bouncycastle/crypto/igw$zta;
...
.method setParameter(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    sget-object p1, yRa:Ljava/security/Permission;
    ...
    :goto_1
    iget-object p0, p0, sRa:Ljava/lang/ThreadLocal;
    ...
    sget-object p1, zRa:Ljava/security/Permission;
    ...
    iput-object p1, p0, uRa:Lyou/zta/you/you/rtg;
    ...
    iput-object p2, p0, uRa:Lyou/zta/you/you/rtg;
    ...
    sget-object p1, ARa:Ljava/security/Permission;
    ...
    :cond_b
    :goto_4
    iget-object p0, p0, tRa:Ljava/lang/ThreadLocal;
    ...
    sget-object p1, BRa:Ljava/security/Permission;
    ...
    :cond_10
    :goto_5
    iput-object p2, p0, vRa:Ljava/lang/Object;
    ...
    sget-object p1, CRa:Ljava/security/Permission;
    ...
    iput-object p2, p0, wRa:Ljava/util/Set;
    ...
    sget-object p1, DRa:Ljava/security/Permission;
    ...
    iput-object p2, p0, xRa:Ljava/util/Map;
