...
# instance fields
.field private ZBa:Ljava/lang/Exception;
...
.method public engineBuild(Ljava/security/cert/CertPathParameters;)Ljava/security/cert/CertPathBuilderResult;
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/x509/tsu;->Ig()Ljava/util/List;
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/x509/sis;->Sg()Ljava/util/Set;
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/jcajce/bio;->gk()Lorg/bouncycastle/jcajce/wtn;

    move-result-object v1

    invoke-virtual {v1}, Lorg/bouncycastle/jcajce/wtn;->Ng()Lorg/bouncycastle/jcajce/cno;
    ...
    invoke-virtual {v2}, Lorg/bouncycastle/jcajce/wtn;->ik()Ljava/util/List;
    ...
    invoke-virtual {p0, v1, p1, v0}, zta(Ljava/security/cert/X509Certificate;Lorg/bouncycastle/jcajce/bio;Ljava/util/List;)Ljava/security/cert/CertPathBuilderResult;
    ...
    iget-object p1, p0, ZBa:Ljava/lang/Exception;
    ...
    iget-object p0, p0, ZBa:Ljava/lang/Exception;
...
.method protected zta(Ljava/security/cert/X509Certificate;Lorg/bouncycastle/jcajce/bio;Ljava/util/List;)Ljava/security/cert/CertPathBuilderResult;
    ...
    :cond_0
    invoke-virtual {p2}, Lorg/bouncycastle/jcajce/bio;->Sg()Ljava/util/Set;
    ...
    :try_start_1
    invoke-virtual {p2}, Lorg/bouncycastle/jcajce/bio;->gk()Lorg/bouncycastle/jcajce/wtn;
    ...
    :try_start_5
    sget-object v2, Lorg/bouncycastle/asn1/x509/gwm;->pGa:Lorg/bouncycastle/asn1/bvj;
    ...
    invoke-virtual {v3}, Lorg/bouncycastle/jcajce/wtn;->kk()Ljava/util/Map;
    ...
    invoke-virtual {p0, v2, p2, p3}, zta(Ljava/security/cert/X509Certificate;Lorg/bouncycastle/jcajce/bio;Ljava/util/List;)Ljava/security/cert/CertPathBuilderResult;
    ...
    iput-object p2, p0, ZBa:Ljava/lang/Exception;
