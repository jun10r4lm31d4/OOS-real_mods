...
.method public constructor <init>(Lorg/bouncycastle/asn1/x509/gck;)V
    ...
    iput-object v0, p0, attrCarrier:Lorg/bouncycastle/jce/interfaces/tsu;

    iput-object p1, p0, c:Lorg/bouncycastle/asn1/x509/gck;

    :try_start_0
    const-string p1, "2.5.29.19"

    invoke-direct {p0, p1}, ud(Ljava/lang/String;)[B
    ...
    iput-object p1, p0, basicConstraints:Lorg/bouncycastle/asn1/x509/kth;
    :try_end_0
...
.method private bw()I
    ...
    :try_start_0
    invoke-virtual {p0}, getEncoded()[B
...
.method private ud(Ljava/lang/String;)[B
    .locals 1

    iget-object p0, p0, c:Lorg/bouncycastle/asn1/x509/gck;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/asn1/x509/gwm;->Mi()Lorg/bouncycastle/asn1/ibl;
...
.method private static vju([B)Ljava/util/Collection;
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertificateParsingException;
...
.method private you(Ljava/security/PublicKey;Ljava/security/Signature;)V
    ...
    iget-object v0, p0, c:Lorg/bouncycastle/asn1/x509/gck;

    invoke-virtual {v0}, Lorg/bouncycastle/asn1/x509/gck;->Fh()Lorg/bouncycastle/asn1/x509/zta;

    move-result-object v0

    iget-object v1, p0, c:Lorg/bouncycastle/asn1/x509/gck;
    ...
    invoke-direct {p0, v0, v1}, zta(Lorg/bouncycastle/asn1/x509/zta;Lorg/bouncycastle/asn1/x509/zta;)Z
    ...
    invoke-virtual {p0}, getTBSCertificate()[B

    move-result-object p1

    invoke-virtual {p2, p1}, Ljava/security/Signature;->update([B)V

    invoke-virtual {p0}, getSignature()[B
...
.method public checkValidity()V
    ...
    invoke-virtual {p0, v0}, checkValidity(Ljava/util/Date;)V
...
.method public checkValidity(Ljava/util/Date;)V
    ...
    invoke-virtual {p0}, getNotAfter()Ljava/util/Date;
    ...
    invoke-virtual {p0}, getNotBefore()Ljava/util/Date;
...
.method public getBasicConstraints()I
    ...
    iget-object v0, p0, basicConstraints:Lorg/bouncycastle/asn1/x509/kth;
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/asn1/x509/kth;->Bi()Ljava/math/BigInteger;
    ...
    :cond_0
    iget-object p0, p0, basicConstraints:Lorg/bouncycastle/asn1/x509/kth;
...
.method public getCriticalExtensionOIDs()Ljava/util/Set;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/asn1/x509/ugm;->Pi()Ljava/util/Enumeration;
...
.method public getEncoded()[B
    ...
    iput-object v0, p0, encoded:[B

    :cond_0
    iget-object p0, p0, encoded:[B
    :try_end_0
...
.method public getExtendedKeyUsage()Ljava/util/List;
    ...
    invoke-direct {p0, v0}, ud(Ljava/lang/String;)[B
...
.method public getIssuerAlternativeNames()Ljava/util/Collection;
    ...
    sget-object v0, Lorg/bouncycastle/asn1/x509/gwm;->pGa:Lorg/bouncycastle/asn1/bvj;
    ...
    invoke-static {p0}, vju([B)Ljava/util/Collection;
...
.method public getIssuerUniqueID()[Z
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/asn1/x509/f;->kj()Lorg/bouncycastle/asn1/n;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/asn1/sis;->mh()I
...
.method public getPublicKey()Ljava/security/PublicKey;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/asn1/x509/gck;->Vh()Lorg/bouncycastle/asn1/x509/c;
...
.method public getSigAlgName()Ljava/lang/String;
    ...
    invoke-virtual {p0}, getSigAlgOID()Ljava/lang/String;
...
.method public getSigAlgOID()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/asn1/x509/gck;->Fh()Lorg/bouncycastle/asn1/x509/zta;
...
.method public getSubjectUniqueID()[Z
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/asn1/x509/f;->lj()Lorg/bouncycastle/asn1/n;
...
.method public getVersion()I
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/asn1/x509/gck;->Ei()I
...
.method public hasUnsupportedCriticalExtension()Z
    ...
    sget-object v3, Lorg/bouncycastle/jce/provider/oif;->MRa:Ljava/lang/String;
    ...
    sget-object v3, Lorg/bouncycastle/jce/provider/oif;->HRa:Ljava/lang/String;
    ...
    sget-object v3, Lorg/bouncycastle/jce/provider/oif;->JRa:Ljava/lang/String;
    ...
    sget-object v3, Lorg/bouncycastle/jce/provider/oif;->NRa:Ljava/lang/String;
    ...
    sget-object v3, Lorg/bouncycastle/jce/provider/oif;->SRa:Ljava/lang/String;
    ...
    sget-object v3, Lorg/bouncycastle/jce/provider/oif;->ORa:Ljava/lang/String;
    ...
    sget-object v3, Lorg/bouncycastle/jce/provider/oif;->PRa:Ljava/lang/String;
    ...
    sget-object v3, Lorg/bouncycastle/jce/provider/oif;->QRa:Ljava/lang/String;
    ...
    sget-object v3, Lorg/bouncycastle/jce/provider/oif;->IRa:Ljava/lang/String;
    ...
    sget-object v3, Lorg/bouncycastle/jce/provider/oif;->KRa:Ljava/lang/String;
    ...
    sget-object v3, Lorg/bouncycastle/jce/provider/oif;->LRa:Ljava/lang/String;
...
.method public declared-synchronized hashCode()I
    ...
    :try_start_0
    iget-boolean v0, p0, hashValueSet:Z

    if-nez v0, :cond_0

    invoke-direct {p0}, bw()I

    move-result v0

    iput v0, p0, hashValue:I

    const/4 v0, 0x1

    iput-boolean v0, p0, hashValueSet:Z

    :cond_0
    iget v0, p0, hashValue:I
    :try_end_0
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, getIssuerDN()Ljava/security/Principal;
    ...
    invoke-virtual {p0}, getSubjectDN()Ljava/security/Principal;
    ...
    invoke-virtual {p0}, getPublicKey()Ljava/security/PublicKey;
    ...
    invoke-virtual {p0}, getSigAlgName()Ljava/lang/String;
    ...
    invoke-virtual {v5}, Lorg/bouncycastle/asn1/x509/gwm;->Mi()Lorg/bouncycastle/asn1/ibl;
    ...
    :cond_4
    sget-object v5, Lorg/bouncycastle/asn1/kth/zta;->xZa:Lorg/bouncycastle/asn1/bvj;
    ...
    :cond_5
    sget-object v5, Lorg/bouncycastle/asn1/kth/zta;->zZa:Lorg/bouncycastle/asn1/bvj;
    ...
    :cond_6
    sget-object v5, Lorg/bouncycastle/asn1/kth/zta;->GZa:Lorg/bouncycastle/asn1/bvj;
...
.method public ugm()Ljava/util/Enumeration;
    .locals 0

    iget-object p0, p0, attrCarrier:Lorg/bouncycastle/jce/interfaces/tsu;

    invoke-interface {p0}, Lorg/bouncycastle/jce/interfaces/tsu;->ugm()Ljava/util/Enumeration;
...
.method public final verify(Ljava/security/PublicKey;)V
    ...
    :goto_0
    invoke-direct {p0, p1, v0}, you(Ljava/security/PublicKey;Ljava/security/Signature;)V
...
.method public final verify(Ljava/security/PublicKey;Ljava/lang/String;)V
    ...
    :goto_0
    invoke-direct {p0, p1, p2}, you(Ljava/security/PublicKey;Ljava/security/Signature;)V
