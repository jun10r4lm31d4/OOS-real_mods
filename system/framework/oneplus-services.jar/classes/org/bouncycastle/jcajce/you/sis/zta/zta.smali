...
.field private static final mBa:I = 0x14

.field private static final nBa:Ljava/lang/String; = "PBEWithSHAAndTwofish-CBC"

.field private static final oBa:I = 0x14

.field private static final pBa:I = 0x400
...
.field protected kBa:Ljava/util/Hashtable;
...
.method public constructor <init>(I)V
    ...
    iput-object v0, p0, kBa:Ljava/util/Hashtable;
...
.method static synthetic zta(Lorg/bouncycastle/jcajce/you/sis/zta/zta;Ljava/io/DataInputStream;)Ljava/security/Key;
    ...
    invoke-direct {p0, p1}, you(Ljava/io/DataInputStream;)Ljava/security/Key;
...
.method static synthetic zta(Lorg/bouncycastle/jcajce/you/sis/zta/zta;Ljava/security/Key;Ljava/io/DataOutputStream;)V
    ...
    invoke-direct {p0, p1, p2}, zta(Ljava/security/Key;Ljava/io/DataOutputStream;)V
...
.method public engineAliases()Ljava/util/Enumeration;
    ...
    iget-object p0, p0, kBa:Ljava/util/Hashtable;
...
.method public engineDeleteEntry(Ljava/lang/String;)V
    ...
    iget-object v0, p0, kBa:Ljava/util/Hashtable;
...
.method public engineLoad(Ljava/io/InputStream;[C)V
    ...
    invoke-virtual {p0, p1}, zta(Ljava/io/InputStream;)V
    ...
    :cond_5
    invoke-virtual {p0, v0}, zta(Ljava/io/InputStream;)V
...
.method public engineStore(Ljava/io/OutputStream;[C)V
    ...
    iget-object v1, p0, XAa:Ljava/security/SecureRandom;
    ...
    iget-object v2, p0, XAa:Ljava/security/SecureRandom;
    ...
    invoke-virtual {p0, p2}, zta(Ljava/io/OutputStream;)V
...
.method protected zta(Ljava/lang/String;I[C[BI)Ljavax/crypto/Cipher;
    ...
    iget-object p3, p0, helper:Lorg/bouncycastle/jcajce/tsu/tsu;
...
.method protected zta(Ljava/io/InputStream;)V
    ...
    invoke-direct {p0, v0}, zta(Ljava/io/DataInputStream;)Ljava/security/cert/Certificate;
    ...
    iget-object v8, p0, kBa:Ljava/util/Hashtable;
    ...
    :cond_3
    invoke-direct {p0, v0}, you(Ljava/io/DataInputStream;)Ljava/security/Key;

    move-result-object v11

    iget-object v1, p0, kBa:Ljava/util/Hashtable;
...
.method protected zta(Ljava/io/OutputStream;)V
    ...
    invoke-direct {p0, v4, v1}, zta(Ljava/security/cert/Certificate;Ljava/io/DataOutputStream;)V
    ...
    invoke-direct {p0, p1, v1}, zta(Ljava/security/Key;Ljava/io/DataOutputStream;)V
    ...
    invoke-direct {p0, p1, v1}, zta(Ljava/security/cert/Certificate;Ljava/io/DataOutputStream;)V
