...
# static fields
.field private static RQa:Ljava/util/Map;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, RQa:Ljava/util/Map;
    ...
    sget-object v3, RQa:Ljava/util/Map;
...
.method public static you(Ljava/security/spec/ECParameterSpec;Z)Lyou/zta/you/you/rtg;
    ...
    invoke-static {v0}, zta(Ljava/security/spec/EllipticCurve;)Lyou/zta/sis/zta/rtg;
    ...
    invoke-static {v0, v1, p1}, zta(Lyou/zta/sis/zta/rtg;Ljava/security/spec/ECPoint;Z)Lyou/zta/sis/zta/wtn;
...
.method public static zta(Lyou/zta/sis/you/you;)Ljava/security/spec/ECField;
    ...
    invoke-interface {p0}, Lyou/zta/sis/you/cno;->i()Lyou/zta/sis/you/ssp;

    move-result-object p0

    invoke-interface {p0}, Lyou/zta/sis/you/ssp;->j()[I
...
.method public static zta(Ljava/security/spec/EllipticCurve;Lyou/zta/you/you/rtg;)Ljava/security/spec/ECParameterSpec;
    ...
    invoke-static {v1}, you(Lyou/zta/sis/zta/wtn;)Ljava/security/spec/ECPoint;
...
.method public static zta(Lorg/bouncycastle/asn1/ibl/veq;Lyou/zta/sis/zta/rtg;)Ljava/security/spec/ECParameterSpec;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/asn1/ibl/veq;->rj()Z
    ...
    invoke-interface {v1}, Lorg/bouncycastle/jcajce/provider/config/sis;->fto()Ljava/util/Map;
    ...
    invoke-static {p1, v1}, zta(Lyou/zta/sis/zta/rtg;[B)Ljava/security/spec/EllipticCurve;
    ...
    invoke-static {p0}, you(Lyou/zta/sis/zta/wtn;)Ljava/security/spec/ECPoint;
    ...
    :cond_1
    invoke-virtual {p0}, Lorg/bouncycastle/asn1/ibl/veq;->qj()Z
    ...
    invoke-static {p1, v0}, zta(Lyou/zta/sis/zta/rtg;[B)Ljava/security/spec/EllipticCurve;

    move-result-object p1

    invoke-virtual {p0}, Lorg/bouncycastle/asn1/ibl/vju;->vj()Ljava/math/BigInteger;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/asn1/ibl/vju;->wj()Ljava/math/BigInteger;
...
.method public static zta(Lorg/bouncycastle/asn1/ibl/vju;)Ljava/security/spec/ECParameterSpec;
    ...
    invoke-static {v1, v2}, zta(Lyou/zta/sis/zta/rtg;[B)Ljava/security/spec/EllipticCurve;
    ...
    invoke-static {v2}, you(Lyou/zta/sis/zta/wtn;)Ljava/security/spec/ECPoint;
...
.method public static zta(Lorg/bouncycastle/crypto/wtn/ibl;)Ljava/security/spec/ECParameterSpec;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/crypto/wtn/ibl;->wj()Ljava/math/BigInteger;

    move-result-object v3

    invoke-virtual {p0}, Lorg/bouncycastle/crypto/wtn/ibl;->vj()Ljava/math/BigInteger;
...
.method public static zta(Lyou/zta/sis/zta/rtg;[B)Ljava/security/spec/EllipticCurve;
    ...
    invoke-static {p1}, zta(Lyou/zta/sis/you/you;)Ljava/security/spec/ECField;
...
.method public static zta(Lorg/bouncycastle/jcajce/provider/config/sis;Ljava/security/spec/ECParameterSpec;)Lorg/bouncycastle/crypto/wtn/ibl;
    ...
    invoke-virtual {p0}, Lyou/zta/you/you/rtg;->wj()Ljava/math/BigInteger;

    move-result-object v3

    invoke-virtual {p0}, Lyou/zta/you/you/rtg;->vj()Ljava/math/BigInteger;
    ...
    invoke-static {p1, v0}, you(Ljava/security/spec/ECParameterSpec;Z)Lyou/zta/you/you/rtg;
...
.method public static zta(Ljava/security/spec/EllipticCurve;)Lyou/zta/sis/zta/rtg;
    ...
    sget-object v0, RQa:Ljava/util/Map;
...
.method public static zta(Lorg/bouncycastle/jcajce/provider/config/sis;Lorg/bouncycastle/asn1/ibl/veq;)Lyou/zta/sis/zta/rtg;
    ...
    invoke-interface {p0}, Lorg/bouncycastle/jcajce/provider/config/sis;->oxb()Ljava/util/Set;

    move-result-object v0

    invoke-virtual {p1}, Lorg/bouncycastle/asn1/ibl/veq;->rj()Z
    ...
    :cond_3
    invoke-virtual {p1}, Lorg/bouncycastle/asn1/ibl/veq;->qj()Z
...
.method public static zta(Ljava/security/spec/ECParameterSpec;Ljava/security/spec/ECPoint;Z)Lyou/zta/sis/zta/wtn;
    ...
    invoke-static {p0}, zta(Ljava/security/spec/EllipticCurve;)Lyou/zta/sis/zta/rtg;

    move-result-object p0

    invoke-static {p0, p1, p2}, zta(Lyou/zta/sis/zta/rtg;Ljava/security/spec/ECPoint;Z)Lyou/zta/sis/zta/wtn;
