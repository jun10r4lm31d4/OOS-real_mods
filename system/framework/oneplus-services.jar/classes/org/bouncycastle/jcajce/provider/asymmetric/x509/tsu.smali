...
# instance fields
.field private TBa:Ljava/lang/String;
...
.method protected constructor <init>(Lorg/bouncycastle/jcajce/tsu/tsu;Lorg/bouncycastle/asn1/x509/dma;)V
    ...
    iput-boolean v0, p0, WBa:Z

    iput-object p1, p0, bcHelper:Lorg/bouncycastle/jcajce/tsu/tsu;

    iput-object p2, p0, c:Lorg/bouncycastle/asn1/x509/dma;

    :try_start_0
    invoke-virtual {p2}, Lorg/bouncycastle/asn1/x509/dma;->Fh()Lorg/bouncycastle/asn1/x509/zta;
    ...
    iput-object p1, p0, TBa:Ljava/lang/String;
    ...
    :goto_0
    invoke-static {p0}, zta(Ljava/security/cert/X509CRL;)Z

    move-result p1

    iput-boolean p1, p0, VBa:Z
    :try_end_0
...
.method private Ab(Z)Ljava/util/Set;
    ...
    iget-object p0, p0, c:Lorg/bouncycastle/asn1/x509/dma;
...
.method private aw()Ljava/util/Set;
    ...
    iget-object v1, p0, c:Lorg/bouncycastle/asn1/x509/dma;

    invoke-virtual {v1}, Lorg/bouncycastle/asn1/x509/dma;->Fi()Ljava/util/Enumeration;
    ...
    sget-object v4, Lorg/bouncycastle/asn1/x509/gwm;->vCa:Lorg/bouncycastle/asn1/bvj;
    ...
    invoke-virtual {v3}, Lorg/bouncycastle/asn1/x509/gwm;->Ni()Lorg/bouncycastle/asn1/ssp;
...
.method private zta(Ljava/security/PublicKey;Ljava/security/Signature;)V
    ...
    iget-object v0, p0, c:Lorg/bouncycastle/asn1/x509/dma;

    invoke-virtual {v0}, Lorg/bouncycastle/asn1/x509/dma;->Fh()Lorg/bouncycastle/asn1/x509/zta;
    ...
    invoke-virtual {p0}, getTBSCertList()[B
...
.method static zta(Ljava/security/cert/X509CRL;)Z
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/asn1/x509/ire;->Vi()Z
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-boolean v0, p0, WBa:Z

    if-eqz v0, :cond_2

    iget-boolean v0, p1, WBa:Z
    ...
    iget-object p1, p1, c:Lorg/bouncycastle/asn1/x509/dma;
...
.method public getCriticalExtensionOIDs()Ljava/util/Set;
    ...
    invoke-direct {p0, v0}, Ab(Z)Ljava/util/Set;
...
.method public getRevokedCertificate(Ljava/math/BigInteger;)Ljava/security/cert/X509CRLEntry;
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/asn1/x509/dma;->Fi()Ljava/util/Enumeration;
    ...
    invoke-virtual {v3}, Lorg/bouncycastle/asn1/x509/e$zta;->jj()Lorg/bouncycastle/asn1/ywr;
...
.method public getRevokedCertificates()Ljava/util/Set;
    ...
    invoke-direct {p0}, aw()Ljava/util/Set;
...
.method public getSigAlgName()Ljava/lang/String;
    ...
    iget-object p0, p0, TBa:Ljava/lang/String;
...
.method public getSigAlgOID()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/asn1/x509/dma;->Fh()Lorg/bouncycastle/asn1/x509/zta;
...
.method public getVersion()I
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/asn1/x509/dma;->Ei()I
...
.method public hasUnsupportedCriticalExtension()Z
    ...
    invoke-virtual {p0}, getCriticalExtensionOIDs()Ljava/util/Set;
...
.method public isRevoked(Ljava/security/cert/Certificate;)Z
    ...
    sget-object v7, Lorg/bouncycastle/asn1/x509/gwm;->vCa:Lorg/bouncycastle/asn1/bvj;
    ...
    invoke-virtual {v6}, Lorg/bouncycastle/asn1/x509/gwm;->Ni()Lorg/bouncycastle/asn1/ssp;
    ...
    :cond_1
    invoke-virtual {v5}, Lorg/bouncycastle/asn1/x509/e$zta;->jj()Lorg/bouncycastle/asn1/ywr;
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, getThisUpdate()Ljava/util/Date;
    ...
    invoke-virtual {p0}, getNextUpdate()Ljava/util/Date;
    ...
    :cond_1
    iget-object v3, p0, c:Lorg/bouncycastle/asn1/x509/dma;
    ...
    invoke-virtual {v3}, Lorg/bouncycastle/asn1/x509/ugm;->Pi()Ljava/util/Enumeration;
    ...
    invoke-virtual {v6}, Lorg/bouncycastle/asn1/x509/gwm;->Mi()Lorg/bouncycastle/asn1/ibl;
    ...
    :try_start_0
    sget-object v6, Lorg/bouncycastle/asn1/x509/gwm;->qGa:Lorg/bouncycastle/asn1/bvj;
    ...
    invoke-virtual {v7}, Lorg/bouncycastle/asn1/ywr;->wh()Ljava/math/BigInteger;
    ...
    :cond_4
    sget-object v6, Lorg/bouncycastle/asn1/x509/gwm;->xCa:Lorg/bouncycastle/asn1/bvj;
    ...
    invoke-virtual {v8}, Lorg/bouncycastle/asn1/ywr;->wh()Ljava/math/BigInteger;
    ...
    :cond_5
    sget-object v6, Lorg/bouncycastle/asn1/x509/gwm;->ACa:Lorg/bouncycastle/asn1/bvj;
    ...
    :cond_6
    sget-object v6, Lorg/bouncycastle/asn1/x509/gwm;->uGa:Lorg/bouncycastle/asn1/bvj;
    ...
    :cond_7
    sget-object v6, Lorg/bouncycastle/asn1/x509/gwm;->AGa:Lorg/bouncycastle/asn1/bvj;
    ...
    :cond_9
    invoke-virtual {p0}, getRevokedCertificates()Ljava/util/Set;
...
.method public verify(Ljava/security/PublicKey;)V
    ...
    :try_start_0
    iget-object v0, p0, bcHelper:Lorg/bouncycastle/jcajce/tsu/tsu;
    ...
    :goto_0
    invoke-direct {p0, p1, v0}, zta(Ljava/security/PublicKey;Ljava/security/Signature;)V
...
.method public verify(Ljava/security/PublicKey;Ljava/lang/String;)V
    ...
    :goto_0
    invoke-direct {p0, p1, p2}, zta(Ljava/security/PublicKey;Ljava/security/Signature;)V
