...
# static fields
.field private static iBa:Ljava/util/Hashtable;


# instance fields
.field XAa:Ljava/security/SecureRandom;

.field algorithm:Ljava/lang/String;

.field configuration:Lorg/bouncycastle/jcajce/provider/config/sis;

.field fBa:Lorg/bouncycastle/crypto/ssp/bio;

.field gBa:Z

.field hBa:Ljava/lang/Object;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, iBa:Ljava/util/Hashtable;

    sget-object v0, iBa:Ljava/util/Hashtable;
...
.method public constructor <init>()V
    ...
    iput-object v1, p0, fBa:Lorg/bouncycastle/crypto/ssp/bio;

    const/4 v1, 0x0

    iput-object v1, p0, hBa:Ljava/lang/Object;

    const/16 v1, 0x100

    iput v1, p0, strength:I

    invoke-static {}, Lorg/bouncycastle/crypto/igw;->Mj()Ljava/security/SecureRandom;

    move-result-object v1

    iput-object v1, p0, XAa:Ljava/security/SecureRandom;
...
.method public constructor <init>(Ljava/lang/String;Lorg/bouncycastle/jcajce/provider/config/sis;)V
    ...
    iput-object v0, p0, fBa:Lorg/bouncycastle/crypto/ssp/bio;

    const/4 v0, 0x0

    iput-object v0, p0, hBa:Ljava/lang/Object;

    const/16 v0, 0x100

    iput v0, p0, strength:I
...
# virtual methods
.method protected Ja(Ljava/lang/String;)Lyou/zta/you/you/tsu;
    .locals 8
    ...
    invoke-static {p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/you;->Wa(Ljava/lang/String;)Lorg/bouncycastle/asn1/ibl/vju;
    ...
    invoke-interface {p0}, Lorg/bouncycastle/jcajce/provider/config/sis;->fto()Ljava/util/Map;
...
.method public generateKeyPair()Ljava/security/KeyPair;
    ...
    iget v0, p0, strength:I

    new-instance v1, Ljava/security/SecureRandom;

    invoke-direct {v1}, Ljava/security/SecureRandom;-><init>()V

    invoke-virtual {p0, v0, v1}, initialize(ILjava/security/SecureRandom;)V

    :cond_0
    iget-object v0, p0, fBa:Lorg/bouncycastle/crypto/ssp/bio;
    ...
    iget-object v0, p0, hBa:Ljava/lang/Object;
    ...
    iget-object v2, p0, algorithm:Ljava/lang/String;
    ...
    iget-object v7, p0, configuration:Lorg/bouncycastle/jcajce/provider/config/sis;
    ...
    iget-object v5, p0, configuration:Lorg/bouncycastle/jcajce/provider/config/sis;
...
.method public initialize(ILjava/security/SecureRandom;)V
    ...
    :try_start_0
    invoke-virtual {p0, p1, p2}, initialize(Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    :try_end_0
...
.method public initialize(Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    iget-object p2, p0, XAa:Ljava/security/SecureRandom;

    :cond_0
    if-nez p1, :cond_2

    iget-object p1, p0, configuration:Lorg/bouncycastle/jcajce/provider/config/sis;
    ...
    iput-object p1, p0, hBa:Ljava/lang/Object;

    check-cast p1, Lyou/zta/you/you/rtg;

    :goto_0
    invoke-virtual {p0, p1, p2}, zta(Lyou/zta/you/you/rtg;Ljava/security/SecureRandom;)Lorg/bouncycastle/crypto/wtn/gwm;

    move-result-object p1

    :goto_1
    iput-object p1, p0, param:Lorg/bouncycastle/crypto/wtn/gwm;
    ...
    invoke-virtual {p0, p1, p2}, zta(Ljava/security/spec/ECParameterSpec;Ljava/security/SecureRandom;)Lorg/bouncycastle/crypto/wtn/gwm;
    ...
    :goto_2
    invoke-virtual {p0, p1, p2}, zta(Ljava/lang/String;Ljava/security/SecureRandom;)V
    ...
    :goto_3
    iget-object p1, p0, fBa:Lorg/bouncycastle/crypto/ssp/bio;

    iget-object p2, p0, param:Lorg/bouncycastle/crypto/wtn/gwm;

    invoke-virtual {p1, p2}, Lorg/bouncycastle/crypto/ssp/bio;->zta(Lorg/bouncycastle/crypto/bvj;)V

    const/4 p1, 0x1

    iput-boolean p1, p0, gBa:Z
...
.method protected zta(Lyou/zta/you/you/rtg;Ljava/security/SecureRandom;)Lorg/bouncycastle/crypto/wtn/gwm;
    ...
    invoke-virtual {p1}, Lyou/zta/you/you/rtg;->wj()Ljava/math/BigInteger;

    move-result-object v3

    invoke-virtual {p1}, Lyou/zta/you/you/rtg;->vj()Ljava/math/BigInteger;
...
.method protected zta(Ljava/lang/String;Ljava/security/SecureRandom;)V
    ...
    invoke-virtual {p0, p1}, Ja(Ljava/lang/String;)Lyou/zta/you/you/tsu;
