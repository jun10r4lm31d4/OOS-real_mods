...
# instance fields
.field private RBa:Lorg/bouncycastle/crypto/zta;

.field private RCa:Ljava/security/AlgorithmParameters;

.field private TCa:Ljava/security/spec/AlgorithmParameterSpec;

.field private UCa:Z

.field private VCa:Z

.field private WCa:Lorg/bouncycastle/jcajce/provider/asymmetric/util/sis$zta;
...
.method public constructor <init>(Ljavax/crypto/spec/OAEPParameterSpec;)V
    ...
    iput-boolean v0, p0, UCa:Z

    iput-boolean v0, p0, VCa:Z
    ...
    iput-object v0, p0, WCa:Lorg/bouncycastle/jcajce/provider/asymmetric/util/sis$zta;

    :try_start_0
    invoke-direct {p0, p1}, zta(Ljavax/crypto/spec/OAEPParameterSpec;)V
    :try_end_0
...
.method public constructor <init>(Lorg/bouncycastle/crypto/zta;)V
    ...
    iput-object p1, p0, RBa:Lorg/bouncycastle/crypto/zta;
...
.method public constructor <init>(ZZLorg/bouncycastle/crypto/zta;)V
    ...
    iput-boolean p1, p0, UCa:Z

    iput-boolean p2, p0, VCa:Z

    iput-object p3, p0, RBa:Lorg/bouncycastle/crypto/zta;
...
.method private dw()[B
    ...
    :try_start_0
    iget-object v1, p0, RBa:Lorg/bouncycastle/crypto/zta;

    iget-object v2, p0, WCa:Lorg/bouncycastle/jcajce/provider/asymmetric/util/sis$zta;

    invoke-virtual {v2}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/sis$zta;->zg()[B

    move-result-object v2

    const/4 v3, 0x0

    iget-object v4, p0, WCa:Lorg/bouncycastle/jcajce/provider/asymmetric/util/sis$zta;
    ...
    iget-object p0, p0, WCa:Lorg/bouncycastle/jcajce/provider/asymmetric/util/sis$zta;
...
.method private zta(Ljavax/crypto/spec/OAEPParameterSpec;)V
    ...
    invoke-static {v1}, Lorg/bouncycastle/jcajce/provider/util/tsu;->Za(Ljava/lang/String;)Lorg/bouncycastle/crypto/qbh;
    ...
    iput-object v0, p0, RBa:Lorg/bouncycastle/crypto/zta;

    iput-object p1, p0, TCa:Ljava/security/spec/AlgorithmParameterSpec;
...
.method protected engineDoFinal([BII[BI)I
    ...
    iget-object v0, p0, WCa:Lorg/bouncycastle/jcajce/provider/asymmetric/util/sis$zta;

    invoke-virtual {v0, p1, p2, p3}, Ljava/io/ByteArrayOutputStream;->write([BII)V

    :cond_0
    iget-object p1, p0, RBa:Lorg/bouncycastle/crypto/zta;
    ...
    iget-object p1, p0, WCa:Lorg/bouncycastle/jcajce/provider/asymmetric/util/sis$zta;

    invoke-virtual {p1}, Ljava/io/ByteArrayOutputStream;->size()I

    move-result p1

    iget-object p3, p0, RBa:Lorg/bouncycastle/crypto/zta;

    invoke-interface {p3}, Lorg/bouncycastle/crypto/zta;->c()I
...
.method protected engineGetBlockSize()I
    ...
    :try_start_0
    iget-object p0, p0, RBa:Lorg/bouncycastle/crypto/zta;
...
.method protected engineGetOutputSize(I)I
    ...
    invoke-interface {p0}, Lorg/bouncycastle/crypto/zta;->qeg()I
...
.method protected engineGetParameters()Ljava/security/AlgorithmParameters;
    ...
    iget-object v0, p0, RCa:Ljava/security/AlgorithmParameters;

    if-nez v0, :cond_0

    iget-object v0, p0, TCa:Ljava/security/spec/AlgorithmParameterSpec;

    if-eqz v0, :cond_0

    :try_start_0
    iget-object v0, p0, helper:Lorg/bouncycastle/jcajce/tsu/tsu;

    const-string v1, "OAEP"

    invoke-interface {v0, v1}, Lorg/bouncycastle/jcajce/tsu/tsu;->ssp(Ljava/lang/String;)Ljava/security/AlgorithmParameters;

    move-result-object v0

    iput-object v0, p0, RCa:Ljava/security/AlgorithmParameters;

    iget-object v0, p0, RCa:Ljava/security/AlgorithmParameters;

    iget-object v1, p0, TCa:Ljava/security/spec/AlgorithmParameterSpec;
    ...
    :cond_0
    :goto_0
    iget-object p0, p0, RCa:Ljava/security/AlgorithmParameters;
...
.method protected engineInit(ILjava/security/Key;Ljava/security/AlgorithmParameters;Ljava/security/SecureRandom;)V
    ...
    :goto_0
    iput-object p3, p0, RCa:Ljava/security/AlgorithmParameters;
...
.method protected engineInit(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    iput-object p3, p0, TCa:Ljava/security/spec/AlgorithmParameterSpec;
    ...
    invoke-static {p3}, Lorg/bouncycastle/jcajce/provider/util/tsu;->Za(Ljava/lang/String;)Lorg/bouncycastle/crypto/qbh;
    ...
    invoke-static {v3}, Lorg/bouncycastle/jcajce/provider/util/tsu;->Za(Ljava/lang/String;)Lorg/bouncycastle/crypto/qbh;
    ...
    iput-object v2, p0, RBa:Lorg/bouncycastle/crypto/zta;
    ...
    :goto_6
    iget-object p2, p0, WCa:Lorg/bouncycastle/jcajce/provider/asymmetric/util/sis$zta;
...
.method protected engineSetMode(Ljava/lang/String;)V
    ...
    iput-boolean v3, p0, VCa:Z

    iput-boolean v2, p0, UCa:Z
    ...
    iput-boolean v2, p0, VCa:Z

    iput-boolean v3, p0, UCa:Z
...
.method protected engineUpdate([BII[BI)I
    ...
    iget-object p4, p0, WCa:Lorg/bouncycastle/jcajce/provider/asymmetric/util/sis$zta;
