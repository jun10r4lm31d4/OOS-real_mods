...
# static fields
.field private static final fCa:Lorg/bouncycastle/jcajce/provider/asymmetric/x509/you;

.field private static final gCa:Lorg/bouncycastle/jcajce/provider/asymmetric/x509/you;

.field private static final hCa:Lorg/bouncycastle/jcajce/provider/asymmetric/x509/you;


# instance fields
.field private _Ba:Lorg/bouncycastle/asn1/ear;

.field private aCa:I

.field private bCa:Ljava/io/InputStream;

.field private final bcHelper:Lorg/bouncycastle/jcajce/tsu/tsu;

.field private cCa:Lorg/bouncycastle/asn1/ear;

.field private dCa:I

.field private eCa:Ljava/io/InputStream;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, fCa:Lorg/bouncycastle/jcajce/provider/asymmetric/x509/you;
    ...
    sput-object v0, gCa:Lorg/bouncycastle/jcajce/provider/asymmetric/x509/you;
    ...
    sput-object v0, hCa:Lorg/bouncycastle/jcajce/provider/asymmetric/x509/you;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, _Ba:Lorg/bouncycastle/asn1/ear;

    const/4 v1, 0x0

    iput v1, p0, aCa:I

    iput-object v0, p0, bCa:Ljava/io/InputStream;

    iput-object v0, p0, cCa:Lorg/bouncycastle/asn1/ear;

    iput v1, p0, dCa:I

    iput-object v0, p0, eCa:Ljava/io/InputStream;
...
.method private bio(Ljava/io/InputStream;)Ljava/security/cert/Certificate;
    ...
    sget-object v0, fCa:Lorg/bouncycastle/jcajce/provider/asymmetric/x509/you;
    ...
    invoke-direct {p0, p1}, ssp(Lorg/bouncycastle/asn1/obl;)Ljava/security/cert/Certificate;
...
.method private cw()Ljava/security/cert/CRL;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    iget-object v0, p0, cCa:Lorg/bouncycastle/asn1/ear;
    ...
    invoke-virtual {p0, v0}, zta(Lorg/bouncycastle/asn1/x509/dma;)Ljava/security/cert/CRL;
...
.method private getCertificate()Ljava/security/cert/Certificate;
    ...
    iget-object v0, p0, _Ba:Lorg/bouncycastle/asn1/ear;
    ...
    iget-object v1, p0, _Ba:Lorg/bouncycastle/asn1/ear;
    ...
    iget-object p0, p0, bcHelper:Lorg/bouncycastle/jcajce/tsu/tsu;
...
.method private kth(Ljava/io/InputStream;)Ljava/security/cert/CRL;
    ...
    sget-object v0, gCa:Lorg/bouncycastle/jcajce/provider/asymmetric/x509/you;

    invoke-virtual {v0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/you;->tsu(Ljava/io/InputStream;)Lorg/bouncycastle/asn1/obl;

    move-result-object p1

    invoke-direct {p0, p1}, rtg(Lorg/bouncycastle/asn1/obl;)Ljava/security/cert/CRL;
...
.method private rtg(Lorg/bouncycastle/asn1/obl;)Ljava/security/cert/CRL;
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/asn1/dma/hmo;->Hh()Lorg/bouncycastle/asn1/ear;

    move-result-object p1

    iput-object p1, p0, cCa:Lorg/bouncycastle/asn1/ear;

    invoke-direct {p0}, cw()Ljava/security/cert/CRL;
    ...
    invoke-virtual {p0, p1}, zta(Lorg/bouncycastle/asn1/x509/dma;)Ljava/security/cert/CRL;
...
.method private ssp(Lorg/bouncycastle/asn1/obl;)Ljava/security/cert/Certificate;
    ...
    iput-object p1, p0, _Ba:Lorg/bouncycastle/asn1/ear;

    invoke-direct {p0}, getCertificate()Ljava/security/cert/Certificate;
...
.method public engineGenerateCRL(Ljava/io/InputStream;)Ljava/security/cert/CRL;
    ...
    iget-object v0, p0, eCa:Ljava/io/InputStream;
    ...
    :goto_0
    iput-object p1, p0, eCa:Ljava/io/InputStream;

    iput-object v2, p0, cCa:Lorg/bouncycastle/asn1/ear;
    ...
    invoke-direct {p0, p1}, kth(Ljava/io/InputStream;)Ljava/security/cert/CRL;
    ...
    invoke-direct {p0, v1}, zta(Lorg/bouncycastle/asn1/dma;)Ljava/security/cert/CRL;
...
.method public engineGenerateCRLs(Ljava/io/InputStream;)Ljava/util/Collection;
    ...
    :goto_0
    invoke-virtual {p0, v1}, engineGenerateCRL(Ljava/io/InputStream;)Ljava/security/cert/CRL;
...
.method public engineGenerateCertPath(Ljava/io/InputStream;)Ljava/security/cert/CertPath;
    ...
    invoke-virtual {p0, p1, v0}, engineGenerateCertPath(Ljava/io/InputStream;Ljava/lang/String;)Ljava/security/cert/CertPath;
...
.method public engineGenerateCertificate(Ljava/io/InputStream;)Ljava/security/cert/Certificate;
    ...
    iget-object v0, p0, bCa:Ljava/io/InputStream;
    ...
    :goto_0
    iput-object p1, p0, bCa:Ljava/io/InputStream;

    iput-object v2, p0, _Ba:Lorg/bouncycastle/asn1/ear;
    ...
    invoke-direct {p0, v0}, bio(Ljava/io/InputStream;)Ljava/security/cert/Certificate;
    ...
    invoke-direct {p0, p1}, you(Lorg/bouncycastle/asn1/dma;)Ljava/security/cert/Certificate;
...
.method public engineGenerateCertificates(Ljava/io/InputStream;)Ljava/util/Collection;
    ...
    :goto_0
    invoke-virtual {p0, p1}, engineGenerateCertificate(Ljava/io/InputStream;)Ljava/security/cert/Certificate;
...
.method public engineGetCertPathEncodings()Ljava/util/Iterator;
    ...
    sget-object p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->YBa:Ljava/util/List;
