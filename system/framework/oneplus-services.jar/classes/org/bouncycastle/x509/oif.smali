...
.field private final VUa:Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;

.field private WUa:Lorg/bouncycastle/asn1/x509/k;

.field private XUa:Lorg/bouncycastle/asn1/bvj;

.field private aVa:Lorg/bouncycastle/asn1/x509/p;

.field private final bcHelper:Lorg/bouncycastle/jcajce/tsu/tsu;

.field private dFa:Lorg/bouncycastle/asn1/x509/zta;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, bcHelper:Lorg/bouncycastle/jcajce/tsu/tsu;
...
.method private yw()Lorg/bouncycastle/asn1/x509/f;
    .locals 2

    iget-object v0, p0, aVa:Lorg/bouncycastle/asn1/x509/p;
    ...
    iget-object v0, p0, WUa:Lorg/bouncycastle/asn1/x509/k;

    iget-object v1, p0, aVa:Lorg/bouncycastle/asn1/x509/p;
    ...
    :cond_0
    iget-object p0, p0, WUa:Lorg/bouncycastle/asn1/x509/k;
...
.method private zta(Lorg/bouncycastle/asn1/x509/f;[B)Ljava/security/cert/X509Certificate;
    ...
    iget-object p1, p0, dFa:Lorg/bouncycastle/asn1/x509/zta;
    ...
    iget-object p0, p0, VUa:Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;
...
# virtual methods
.method public Wl()Ljava/util/Iterator;
    .locals 0

    invoke-static {}, Lorg/bouncycastle/x509/dma;->Vl()Ljava/util/Iterator;
...
.method public generate(Ljava/security/PrivateKey;)Ljava/security/cert/X509Certificate;
    ...
    invoke-virtual {p0, p1, v0}, you(Ljava/security/PrivateKey;Ljava/security/SecureRandom;)Ljava/security/cert/X509Certificate;
...
.method public generate(Ljava/security/PrivateKey;Ljava/lang/String;)Ljava/security/cert/X509Certificate;
    ...
    invoke-virtual {p0, p1, p2, v0}, zta(Ljava/security/PrivateKey;Ljava/lang/String;Ljava/security/SecureRandom;)Ljava/security/cert/X509Certificate;
...
.method public reset()V
    ...
    iget-object p0, p0, aVa:Lorg/bouncycastle/asn1/x509/p;
...
.method public setSignatureAlgorithm(Ljava/lang/String;)V
    ...
    iput-object p1, p0, HEa:Ljava/lang/String;

    :try_start_0
    invoke-static {p1}, Lorg/bouncycastle/x509/dma;->lb(Ljava/lang/String;)Lorg/bouncycastle/asn1/bvj;

    move-result-object v0

    iput-object v0, p0, XUa:Lorg/bouncycastle/asn1/bvj;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    iget-object v0, p0, XUa:Lorg/bouncycastle/asn1/bvj;
    ...
    iput-object p1, p0, dFa:Lorg/bouncycastle/asn1/x509/zta;

    iget-object p1, p0, WUa:Lorg/bouncycastle/asn1/x509/k;

    iget-object p0, p0, dFa:Lorg/bouncycastle/asn1/x509/zta;
...
.method public sis(Ljava/security/PrivateKey;)Ljava/security/cert/X509Certificate;
    ...
    invoke-virtual {p0, p1, v0, v1}, you(Ljava/security/PrivateKey;Ljava/lang/String;Ljava/security/SecureRandom;)Ljava/security/cert/X509Certificate;
...
.method public sis(Ljava/security/PrivateKey;Ljava/security/SecureRandom;)Ljava/security/cert/X509Certificate;
    ...
    invoke-virtual {p0, p1, v0, p2}, you(Ljava/security/PrivateKey;Ljava/lang/String;Ljava/security/SecureRandom;)Ljava/security/cert/X509Certificate;
...
.method public you(Ljava/security/PrivateKey;Ljava/lang/String;Ljava/security/SecureRandom;)Ljava/security/cert/X509Certificate;
    ...
    :try_start_0
    invoke-virtual {p0, p1, p2, p3}, zta(Ljava/security/PrivateKey;Ljava/lang/String;Ljava/security/SecureRandom;)Ljava/security/cert/X509Certificate;
...
.method public you(Ljava/security/PrivateKey;Ljava/security/SecureRandom;)Ljava/security/cert/X509Certificate;
    ...
    invoke-direct {p0}, yw()Lorg/bouncycastle/asn1/x509/f;

    move-result-object v0

    :try_start_0
    iget-object v1, p0, XUa:Lorg/bouncycastle/asn1/bvj;

    iget-object v2, p0, HEa:Ljava/lang/String;
    ...
    :try_start_1
    invoke-direct {p0, v0, p1}, zta(Lorg/bouncycastle/asn1/x509/f;[B)Ljava/security/cert/X509Certificate;
...
.method public you([Z)V
    ...
    invoke-direct {p0, p1}, sis([Z)Lorg/bouncycastle/asn1/n;
...
.method public zta(Ljava/security/PrivateKey;Ljava/lang/String;)Ljava/security/cert/X509Certificate;
    ...
    invoke-virtual {p0, p1, p2, v0}, you(Ljava/security/PrivateKey;Ljava/lang/String;Ljava/security/SecureRandom;)Ljava/security/cert/X509Certificate;
...
.method public zta(Ljava/security/PrivateKey;Ljava/lang/String;Ljava/security/SecureRandom;)Ljava/security/cert/X509Certificate;
    ...
    iget-object v1, p0, HEa:Ljava/lang/String;
    ...
    :try_start_1
    invoke-direct {p0, v6, p1}, zta(Lorg/bouncycastle/asn1/x509/f;[B)Ljava/security/cert/X509Certificate;
...
.method public zta(Ljava/lang/String;ZLjava/security/cert/X509Certificate;)V
    ...
    :try_start_0
    invoke-static {p3}, Lorg/bouncycastle/x509/zta/you;->fto([B)Lorg/bouncycastle/asn1/vdb;

    move-result-object p3

    invoke-virtual {p0, p1, p2, p3}, zta(Ljava/lang/String;ZLorg/bouncycastle/asn1/ssp;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public zta(Ljava/lang/String;ZLorg/bouncycastle/asn1/ssp;)V
    ...
    invoke-virtual {p0, v0, p2, p3}, zta(Lorg/bouncycastle/asn1/bvj;ZLorg/bouncycastle/asn1/ssp;)V
...
.method public zta(Ljava/lang/String;Z[B)V
    ...
    invoke-virtual {p0, v0, p2, p3}, zta(Lorg/bouncycastle/asn1/bvj;Z[B)V
...
.method public zta(Lorg/bouncycastle/asn1/bvj;ZLjava/security/cert/X509Certificate;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, zta(Ljava/lang/String;ZLjava/security/cert/X509Certificate;)V
