...
# instance fields
.field private YUa:Lorg/bouncycastle/asn1/x509/rtg;

.field private ZUa:Ljava/util/Date;

.field private _Ua:Ljava/util/Date;
...
.method public constructor <init>(Ljava/io/InputStream;)V
    ...
    invoke-static {p1}, wtn(Ljava/io/InputStream;)Lorg/bouncycastle/asn1/x509/rtg;

    move-result-object p1

    invoke-direct {p0, p1}, <init>(Lorg/bouncycastle/asn1/x509/rtg;)V
...
.method constructor <init>(Lorg/bouncycastle/asn1/x509/rtg;)V
    ...
    iput-object p1, p0, YUa:Lorg/bouncycastle/asn1/x509/rtg;

    :try_start_0
    invoke-virtual {p1}, Lorg/bouncycastle/asn1/x509/rtg;->wi()Lorg/bouncycastle/asn1/x509/ssp;

    move-result-object v0

    invoke-virtual {v0}, Lorg/bouncycastle/asn1/x509/ssp;->yi()Lorg/bouncycastle/asn1/x509/sis;

    move-result-object v0

    invoke-virtual {v0}, Lorg/bouncycastle/asn1/x509/sis;->ui()Lorg/bouncycastle/asn1/wtn;
    ...
    iput-object v0, p0, _Ua:Ljava/util/Date;

    invoke-virtual {p1}, Lorg/bouncycastle/asn1/x509/rtg;->wi()Lorg/bouncycastle/asn1/x509/ssp;

    move-result-object p1

    invoke-virtual {p1}, Lorg/bouncycastle/asn1/x509/ssp;->yi()Lorg/bouncycastle/asn1/x509/sis;

    move-result-object p1

    invoke-virtual {p1}, Lorg/bouncycastle/asn1/x509/sis;->vi()Lorg/bouncycastle/asn1/wtn;
    ...
    iput-object p1, p0, ZUa:Ljava/util/Date;
    :try_end_0
...
.method public constructor <init>([B)V
    ...
    invoke-direct {p0, v0}, <init>(Ljava/io/InputStream;)V
...
.method private Ab(Z)Ljava/util/Set;
    ...
    iget-object p0, p0, YUa:Lorg/bouncycastle/asn1/x509/rtg;

    invoke-virtual {p0}, Lorg/bouncycastle/asn1/x509/rtg;->wi()Lorg/bouncycastle/asn1/x509/ssp;
...
.method public getAttributes(Ljava/lang/String;)[Lorg/bouncycastle/x509/ssp;
    ...
    invoke-virtual {v2}, Lorg/bouncycastle/x509/ssp;->Dj()Ljava/lang/String;
...
.method public getNotAfter()Ljava/util/Date;
    ...
    iget-object p0, p0, _Ua:Ljava/util/Date;
...
.method public getNotBefore()Ljava/util/Date;
    ...
    iget-object p0, p0, ZUa:Ljava/util/Date;
...
.method public getSignature()[B
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/asn1/x509/rtg;->xi()Lorg/bouncycastle/asn1/n;
...
.method public final verify(Ljava/security/PublicKey;Ljava/lang/String;)V
    ...
    iget-object v0, p0, YUa:Lorg/bouncycastle/asn1/x509/rtg;

    invoke-virtual {v0}, Lorg/bouncycastle/asn1/x509/rtg;->Fh()Lorg/bouncycastle/asn1/x509/zta;

    move-result-object v0

    iget-object v1, p0, YUa:Lorg/bouncycastle/asn1/x509/rtg;

    invoke-virtual {v1}, Lorg/bouncycastle/asn1/x509/rtg;->wi()Lorg/bouncycastle/asn1/x509/ssp;
    ...
    :try_start_0
    iget-object p1, p0, YUa:Lorg/bouncycastle/asn1/x509/rtg;
