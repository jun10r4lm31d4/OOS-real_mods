...
# instance fields
.field private iCa:Ljava/util/List;

.field private jCa:Z

.field private kCa:Ljava/util/List;

.field private lCa:Ljava/util/Set;

.field private mCa:Ljava/util/Set;

.field private nCa:Ljava/util/Set;

.field private oCa:Ljava/util/Set;
...
.method public constructor <init>(Ljava/util/Set;)V
    ...
    iput-boolean p1, p0, qCa:Z

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, iCa:Ljava/util/List;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, kCa:Ljava/util/List;

    new-instance p1, Ljava/util/HashSet;

    invoke-direct {p1}, Ljava/util/HashSet;-><init>()V

    iput-object p1, p0, lCa:Ljava/util/Set;

    new-instance p1, Ljava/util/HashSet;

    invoke-direct {p1}, Ljava/util/HashSet;-><init>()V

    iput-object p1, p0, mCa:Ljava/util/Set;

    new-instance p1, Ljava/util/HashSet;

    invoke-direct {p1}, Ljava/util/HashSet;-><init>()V

    iput-object p1, p0, nCa:Ljava/util/Set;

    new-instance p1, Ljava/util/HashSet;

    invoke-direct {p1}, Ljava/util/HashSet;-><init>()V

    iput-object p1, p0, oCa:Ljava/util/Set;
...
.method public static zta(Ljava/security/cert/PKIXParameters;)Lorg/bouncycastle/x509/tsu;
    ...
    invoke-direct {v0, v1}, <init>(Ljava/util/Set;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    invoke-virtual {v0, p0}, you(Ljava/security/cert/PKIXParameters;)V
...
.method public Ig()Ljava/util/List;
    ...
    iget-object p0, p0, kCa:Ljava/util/List;
...
.method public Jg()Ljava/util/Set;
    ...
    iget-object p0, p0, oCa:Ljava/util/Set;
...
.method public Kg()Ljava/util/Set;
    ...
    iget-object p0, p0, mCa:Ljava/util/Set;
...
.method public Lg()Ljava/util/Set;
    ...
    iget-object p0, p0, nCa:Ljava/util/Set;
...
.method public Mg()Ljava/util/List;
    ...
    iget-object p0, p0, iCa:Ljava/util/List;
...
.method public Ng()Lorg/bouncycastle/util/dma;
    .locals 0

    iget-object p0, p0, selector:Lorg/bouncycastle/util/dma;
...
.method public Og()Ljava/util/Set;
    ...
    iget-object p0, p0, lCa:Ljava/util/Set;
...
.method public cno(Ljava/util/List;)V
    ...
    iput-object v0, p0, iCa:Ljava/util/List;
...
.method public setTargetCertConstraints(Ljava/security/cert/CertSelector;)V
    ...
    :goto_0
    iput-object p1, p0, selector:Lorg/bouncycastle/util/dma;
...
.method public sis(Ljava/util/Set;)V
    ...
    :cond_2
    iget-object v0, p0, nCa:Ljava/util/Set;
...
.method public tsu(Ljava/util/Set;)V
    ...
    :cond_2
    iget-object v0, p0, lCa:Ljava/util/Set;
...
.method protected you(Ljava/security/cert/PKIXParameters;)V
    ...
    invoke-virtual {p0, v0}, setCertStores(Ljava/util/List;)V
    ...
    invoke-virtual {p0, v0}, setTargetCertConstraints(Ljava/security/cert/CertSelector;)V
    ...
    iget-boolean v0, p1, qCa:Z

    iput-boolean v0, p0, qCa:Z

    iget-boolean v0, p1, jCa:Z

    iput-boolean v0, p0, jCa:Z

    iget-object v0, p1, selector:Lorg/bouncycastle/util/dma;
    ...
    :goto_0
    iput-object v0, p0, selector:Lorg/bouncycastle/util/dma;

    new-instance v0, Ljava/util/ArrayList;

    iget-object v1, p1, iCa:Ljava/util/List;
    ...
    iget-object v1, p1, kCa:Ljava/util/List;

    invoke-direct {v0, v1}, Ljava/util/ArrayList;-><init>(Ljava/util/Collection;)V

    iput-object v0, p0, kCa:Ljava/util/List;

    new-instance v0, Ljava/util/HashSet;

    iget-object v1, p1, lCa:Ljava/util/Set;

    invoke-direct {v0, v1}, Ljava/util/HashSet;-><init>(Ljava/util/Collection;)V

    iput-object v0, p0, lCa:Ljava/util/Set;

    new-instance v0, Ljava/util/HashSet;

    iget-object v1, p1, nCa:Ljava/util/Set;

    invoke-direct {v0, v1}, Ljava/util/HashSet;-><init>(Ljava/util/Collection;)V

    iput-object v0, p0, nCa:Ljava/util/Set;

    new-instance v0, Ljava/util/HashSet;

    iget-object v1, p1, mCa:Ljava/util/Set;

    invoke-direct {v0, v1}, Ljava/util/HashSet;-><init>(Ljava/util/Collection;)V

    iput-object v0, p0, mCa:Ljava/util/Set;

    new-instance v0, Ljava/util/HashSet;

    iget-object p1, p1, oCa:Ljava/util/Set;

    invoke-direct {v0, p1}, Ljava/util/HashSet;-><init>(Ljava/util/Collection;)V

    iput-object v0, p0, oCa:Ljava/util/Set;
...
.method public you(Ljava/util/Set;)V
    ...
    :cond_2
    iget-object v0, p0, mCa:Ljava/util/Set;
...
.method public zta(Ljava/util/Set;)V
    ...
    :cond_2
    iget-object v0, p0, oCa:Ljava/util/Set;
...
.method public zta(Lorg/bouncycastle/util/ywr;)V
    ...
    invoke-virtual {p0, p1}, you(Lorg/bouncycastle/util/ywr;)V
