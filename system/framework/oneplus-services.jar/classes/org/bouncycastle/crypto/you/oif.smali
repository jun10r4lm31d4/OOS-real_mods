...
# static fields
.field private static final jMa:I = 0x40
...
.method public constructor <init>([B)V
    ...
    invoke-virtual {p0, p1}, Lorg/bouncycastle/crypto/you/cno;->qbh([B)V
...
.method public copy()Lorg/bouncycastle/util/bio;
    ...
    invoke-direct {v0, p0}, <init>(Lorg/bouncycastle/crypto/you/oif;)V
...
.method public doFinal([BI)I
    ...
    iget-wide v0, p0, Lorg/bouncycastle/crypto/you/cno;->gMa:J
    ...
    iget-wide v0, p0, Lorg/bouncycastle/crypto/you/cno;->hMa:J

    add-int/lit8 v2, p2, 0x18

    invoke-static {v0, v1, p1, v2}, Lorg/bouncycastle/util/igw;->zta(J[BI)V

    iget-wide v0, p0, Lorg/bouncycastle/crypto/you/cno;->AMa:J

    add-int/lit8 v2, p2, 0x20

    invoke-static {v0, v1, p1, v2}, Lorg/bouncycastle/util/igw;->zta(J[BI)V

    iget-wide v0, p0, Lorg/bouncycastle/crypto/you/cno;->FMa:J
...
.method public ear()[B
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/crypto/you/cno;->Qj()I

    move-result v0

    new-array v0, v0, [B

    invoke-super {p0, v0}, Lorg/bouncycastle/crypto/you/cno;->ywr([B)V
...
.method public reset()V
    ...
    iput-wide v0, p0, Lorg/bouncycastle/crypto/you/cno;->gMa:J
    ...
    iput-wide v0, p0, Lorg/bouncycastle/crypto/you/cno;->hMa:J

    const-wide v0, 0x510e527fade682d1L    # 2.876275032471325E82

    iput-wide v0, p0, Lorg/bouncycastle/crypto/you/cno;->AMa:J

    const-wide v0, -0x64fa9773d4c193e1L

    iput-wide v0, p0, Lorg/bouncycastle/crypto/you/cno;->FMa:J
