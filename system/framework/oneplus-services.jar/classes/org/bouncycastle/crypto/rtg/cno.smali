...
# static fields
.field private static final TNa:[B


# instance fields
.field private RNa:Lorg/bouncycastle/crypto/wtn/ire;

.field SNa:Lorg/bouncycastle/crypto/qbh;

.field private bDa:Z

.field digest:[B

.field private fBa:Lorg/bouncycastle/crypto/bio/you;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, SNa:Lorg/bouncycastle/crypto/qbh;

    const/16 v0, 0x14

    new-array v0, v0, [B

    iput-object v0, p0, digest:[B
...
.method private qeg([B)[B
    ...
    iget-object v2, p0, SNa:Lorg/bouncycastle/crypto/qbh;
    ...
    iget-object p1, p0, SNa:Lorg/bouncycastle/crypto/qbh;

    iget-object v2, p0, digest:[B

    invoke-interface {p1, v2, v4}, Lorg/bouncycastle/crypto/qbh;->doFinal([BI)I

    iget-object p0, p0, digest:[B
...
.method public tsu([BII)[B
    ...
    iget-boolean v0, p0, bDa:Z

    if-nez v0, :cond_5

    if-eqz p1, :cond_4

    iget-object v0, p0, fBa:Lorg/bouncycastle/crypto/bio/you;
    ...
    iget-object v2, p0, param:Lorg/bouncycastle/crypto/wtn/cjf;

    sget-object v3, TNa:[B

    invoke-direct {v1, v2, v3}, Lorg/bouncycastle/crypto/wtn/ire;-><init>(Lorg/bouncycastle/crypto/kth;[B)V

    iget-object v2, p0, fBa:Lorg/bouncycastle/crypto/bio/you;
    ...
    iget-object v4, p0, fBa:Lorg/bouncycastle/crypto/bio/you;
    ...
    iget-object v1, p0, param:Lorg/bouncycastle/crypto/wtn/cjf;

    iget-object v2, p0, iv:[B

    invoke-direct {p1, v1, v2}, Lorg/bouncycastle/crypto/wtn/ire;-><init>(Lorg/bouncycastle/crypto/kth;[B)V

    iput-object p1, p0, RNa:Lorg/bouncycastle/crypto/wtn/ire;

    iget-object p1, p0, fBa:Lorg/bouncycastle/crypto/bio/you;

    iget-object v1, p0, RNa:Lorg/bouncycastle/crypto/wtn/ire;
    ...
    invoke-direct {p0, p3, v0}, ibl([B[B)Z
...
.method public wrap([BII)[B
    ...
    iget-object p3, p0, fBa:Lorg/bouncycastle/crypto/bio/you;

    iget-object v0, p0, RNa:Lorg/bouncycastle/crypto/wtn/ire;
    ...
    iget-object v3, p0, fBa:Lorg/bouncycastle/crypto/bio/you;
    ...
    invoke-static {v0}, obl([B)[B

    move-result-object p2

    new-instance p3, Lorg/bouncycastle/crypto/wtn/ire;

    iget-object v0, p0, param:Lorg/bouncycastle/crypto/wtn/cjf;
...
.method public zta(ZLorg/bouncycastle/crypto/kth;)V
    ...
    iput-object p1, p0, fBa:Lorg/bouncycastle/crypto/bio/you;
    ...
    invoke-virtual {p2}, Lorg/bouncycastle/crypto/wtn/hmo;->Nj()Ljava/security/SecureRandom;
    ...
    iput-object p1, p0, param:Lorg/bouncycastle/crypto/wtn/cjf;
    ...
    iput-object p1, p0, iv:[B

    iget-object p1, p0, iv:[B

    invoke-virtual {p2, p1}, Ljava/security/SecureRandom;->nextBytes([B)V

    new-instance p1, Lorg/bouncycastle/crypto/wtn/ire;

    iget-object p2, p0, param:Lorg/bouncycastle/crypto/wtn/cjf;
    ...
    iget-object p1, p0, RNa:Lorg/bouncycastle/crypto/wtn/ire;
