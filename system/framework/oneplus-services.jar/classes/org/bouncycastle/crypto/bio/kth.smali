...
.field private final RBa:Lorg/bouncycastle/crypto/rtg;
...
.method public constructor <init>(Lorg/bouncycastle/crypto/rtg;)V
    ...
    iget-object p1, p0, RBa:Lorg/bouncycastle/crypto/rtg;
    ...
    iput-object v0, p0, TLa:[B

    new-array v0, p1, [B

    iput-object v0, p0, counter:[B

    new-array p1, p1, [B

    iput-object p1, p0, aMa:[B
...
.method private mw()V
    ...
    :goto_0
    iget-object v1, p0, TLa:[B

    array-length v2, v1

    if-eq v0, v2, :cond_1

    iget-object v2, p0, counter:[B
...
.method public seekTo(J)J
    ...
    invoke-virtual {p0, p1, p2}, skip(J)J
...
.method protected sis(B)B
    ...
    invoke-direct {p0, v1}, ud(I)V

    invoke-direct {p0}, mw()V
