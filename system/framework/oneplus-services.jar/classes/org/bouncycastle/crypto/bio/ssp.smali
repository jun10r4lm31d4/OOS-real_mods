...
.field private static final sPa:J = 0xfffffffe0L


# instance fields
.field private POa:I

.field private RBa:Lorg/bouncycastle/crypto/rtg;
...
.field private ePa:Lorg/bouncycastle/crypto/bio/zta/sis;

.field private fPa:Lorg/bouncycastle/crypto/bio/zta/you;
...
.method public constructor <init>(Lorg/bouncycastle/crypto/rtg;)V
    ...
    invoke-direct {p0, p1, v0}, <init>(Lorg/bouncycastle/crypto/rtg;Lorg/bouncycastle/crypto/bio/zta/sis;)V
...
.method public constructor <init>(Lorg/bouncycastle/crypto/rtg;Lorg/bouncycastle/crypto/bio/zta/sis;)V
    ...
    :cond_0
    iput-object p1, p0, RBa:Lorg/bouncycastle/crypto/rtg;

    iput-object p2, p0, ePa:Lorg/bouncycastle/crypto/bio/zta/sis;
...
.method private Rd(I)J
    .locals 4

    iget-wide v0, p0, nPa:J
...
.method private a([B)V
    ...
    iget-object p0, p0, RBa:Lorg/bouncycastle/crypto/rtg;
...
.method private gwm([B[B)V
    ...
    iget-object p0, p0, ePa:Lorg/bouncycastle/crypto/bio/zta/sis;
...
.method private reset(Z)V
    ...
    iget-object v0, p0, RBa:Lorg/bouncycastle/crypto/rtg;
    ...
    iput-object v1, p0, S:[B

    new-array v1, v0, [B

    iput-object v1, p0, kPa:[B

    new-array v1, v0, [B

    iput-object v1, p0, lPa:[B

    new-array v0, v0, [B

    iput-object v0, p0, oPa:[B
    ...
    iput-wide v1, p0, qPa:J

    iput-wide v1, p0, rPa:J

    iget-object v3, p0, iPa:[B

    invoke-static {v3}, Lorg/bouncycastle/util/zta;->zgw([B)[B

    move-result-object v3

    iput-object v3, p0, counter:[B
    ...
    iput-wide v1, p0, nPa:J

    iget-object v1, p0, jPa:[B
    ...
    iput-object p1, p0, cPa:[B

    :cond_1
    iget-boolean p1, p0, yLa:Z

    if-eqz p1, :cond_2

    iput-boolean v0, p0, gBa:Z

    goto :goto_0

    :cond_2
    iget-object p1, p0, aPa:[B

    if-eqz p1, :cond_3

    array-length v1, p1

    invoke-virtual {p0, p1, v0, v1}, sis([BII)V
...
.method private sis([BII[BI)V
    ...
    invoke-direct {p0, v0}, a([B)V

    iget-boolean v1, p0, yLa:Z
    ...
    iget-object v0, p0, S:[B

    invoke-direct {p0, v0, p1, p2, p3}, you([B[BII)V

    goto :goto_0

    :cond_0
    iget-object v1, p0, S:[B

    invoke-direct {p0, v1, p1, p2, p3}, you([B[BII)V
    ...
    iget-wide p1, p0, nPa:J

    int-to-long p3, p3

    add-long/2addr p1, p3

    iput-wide p1, p0, nPa:J
...
.method private sis([B[BI)V
    ...
    invoke-direct {p0, p1, p2, v0, v1}, you([B[BII)V
...
.method private tw()V
    ...
    iget-boolean v0, p0, gBa:Z

    if-nez v0, :cond_1

    iget-boolean p0, p0, yLa:Z
...
.method private uw()V
    ...
    iget-object v6, p0, oPa:[B

    invoke-direct {p0, v5, v6, v4, v0}, you([B[BII)V

    iget-wide v5, p0, rPa:J
    ...
    iget-object v0, p0, lPa:[B

    iget-object p0, p0, S:[B
...
.method private zta([BI[BI)V
    ...
    invoke-direct {p0}, uw()V

    :cond_0
    new-array v2, v1, [B

    invoke-direct {p0, v2}, a([B)V

    iget-boolean v0, p0, yLa:Z

    if-eqz v0, :cond_1

    invoke-static {v2, p1, p2}, Lorg/bouncycastle/crypto/bio/zta/tsu;->you([B[BI)V

    iget-object p1, p0, S:[B

    invoke-direct {p0, p1, v2}, gwm([B[B)V
    ...
    invoke-direct {p0, v0, p1, p2}, tsu([B[BI)V
...
# virtual methods
.method public a()Lorg/bouncycastle/crypto/rtg;
    .locals 0
...
.method public cgv()Ljava/lang/String;
    .locals 1
    ...
    invoke-interface {p0}, Lorg/bouncycastle/crypto/rtg;->cgv()Ljava/lang/String;
...
.method public doFinal([BI)I
    ...
    invoke-direct/range {v5 .. v10}, sis([BII[BI)V

    :cond_3
    iget-wide v4, p0, qPa:J
    ...
    iput-wide v4, p0, qPa:J

    iget-wide v4, p0, qPa:J

    iget-wide v6, p0, rPa:J
    ...
    iget-object v4, p0, kPa:[B

    iget-object v9, p0, oPa:[B

    invoke-direct {p0, v4, v9, v8, v1}, you([B[BII)V

    :cond_4
    iget-wide v9, p0, rPa:J

    cmp-long v1, v9, v2

    if-lez v1, :cond_5

    iget-object v1, p0, kPa:[B

    iget-object v2, p0, lPa:[B

    invoke-static {v1, v2}, Lorg/bouncycastle/crypto/bio/zta/tsu;->you([B[B)V

    :cond_5
    iget-wide v1, p0, nPa:J
    ...
    iget-object v4, p0, fPa:Lorg/bouncycastle/crypto/bio/zta/you;
    ...
    iput-object v4, p0, fPa:Lorg/bouncycastle/crypto/bio/zta/you;

    iget-object v4, p0, fPa:Lorg/bouncycastle/crypto/bio/zta/you;

    iget-object v9, p0, hPa:[B
    ...
    iget-object v2, p0, S:[B

    invoke-direct {p0, v2, v1}, gwm([B[B)V

    new-array v1, v7, [B

    iget-object v2, p0, RBa:Lorg/bouncycastle/crypto/rtg;
    ...
    iput-object v3, p0, cPa:[B

    iget-object v3, p0, cPa:[B
...
.method public getMac()[B
    ...
    :cond_0
    invoke-static {v0}, Lorg/bouncycastle/util/zta;->zgw([B)[B
...
.method public sis([BII)V
    ...
    iget-object v3, p0, kPa:[B

    invoke-direct {p0, v3, v2}, gwm([B[B)V
...
.method public zta(B[BI)I
    ...
    invoke-direct {p0, v1, v0, p2, p3}, zta([BI[BI)V
...
.method public zta([BII[BI)I
    ...
    invoke-direct {p0, v0, v2, p4, p5}, zta([BI[BI)V
    ...
    invoke-direct {p0, p1, p2, p4, v3}, zta([BI[BI)V
    ...
    invoke-direct {p0, v4, v2, p4, v5}, zta([BI[BI)V
...
.method public zta(B)V
    ...
    iget-object p1, p0, kPa:[B

    invoke-direct {p0, p1, v1}, gwm([B[B)V
...
.method public zta(ZLorg/bouncycastle/crypto/kth;)V
    ...
    iput-boolean p1, p0, yLa:Z

    const/4 v0, 0x0

    iput-object v0, p0, cPa:[B

    const/4 v1, 0x1

    iput-boolean v1, p0, gBa:Z
    ...
    invoke-virtual {p2}, Lorg/bouncycastle/crypto/wtn/zta;->Xj()[B

    move-result-object v5

    iput-object v5, p0, aPa:[B
    ...
    iput-object p2, p0, hPa:[B

    iget-object p2, p0, RBa:Lorg/bouncycastle/crypto/rtg;

    iget-object v2, p0, hPa:[B

    invoke-interface {p2, v2, p1, v2, p1}, Lorg/bouncycastle/crypto/rtg;->zta([BI[BI)I

    iget-object p2, p0, ePa:Lorg/bouncycastle/crypto/bio/zta/sis;

    iget-object v2, p0, hPa:[B

    invoke-interface {p2, v2}, Lorg/bouncycastle/crypto/bio/zta/sis;->init([B)V

    iput-object v0, p0, fPa:Lorg/bouncycastle/crypto/bio/zta/you;

    goto :goto_3

    :cond_7
    iget-object p2, p0, hPa:[B
    ...
    iput-object p2, p0, iPa:[B

    iget-object p2, p0, nonce:[B
    ...
    invoke-direct {p0, v0, p2, v1}, sis([B[BI)V

    new-array p2, v4, [B

    iget-object v0, p0, nonce:[B
    ...
    invoke-direct {p0, v0, p2}, gwm([B[B)V

    :goto_4
    new-array p2, v4, [B

    iput-object p2, p0, S:[B

    new-array p2, v4, [B

    iput-object p2, p0, kPa:[B

    new-array p2, v4, [B

    iput-object p2, p0, lPa:[B

    new-array p2, v4, [B

    iput-object p2, p0, oPa:[B
    ...
    iput-wide v0, p0, rPa:J

    iget-object p2, p0, iPa:[B

    invoke-static {p2}, Lorg/bouncycastle/util/zta;->zgw([B)[B

    move-result-object p2

    iput-object p2, p0, counter:[B
    ...
    iput-wide v0, p0, nPa:J

    iget-object p2, p0, aPa:[B

    if-eqz p2, :cond_9

    array-length v0, p2

    invoke-virtual {p0, p2, p1, v0}, sis([BII)V
