...
.method protected cno(Ljava/math/BigInteger;)Z
    ...
    iget-object v1, p0, param:Lorg/bouncycastle/crypto/wtn/lqr;

    invoke-virtual {v1}, Lorg/bouncycastle/crypto/wtn/lqr;->getCertainty()I

    move-result v1

    invoke-static {v0, v1}, h(II)I
    ...
    iget-object p0, p0, param:Lorg/bouncycastle/crypto/wtn/lqr;

    invoke-virtual {p0}, Lorg/bouncycastle/crypto/bvj;->Nj()Ljava/security/SecureRandom;
...
.method public generateKeyPair()Lorg/bouncycastle/crypto/you;
    ...
    iget-object v1, v0, param:Lorg/bouncycastle/crypto/wtn/lqr;
    ...
    sget-object v7, ONE:Ljava/math/BigInteger;
    ...
    iget-object v12, v0, param:Lorg/bouncycastle/crypto/wtn/lqr;
    ...
    :goto_1
    invoke-virtual {v0, v2, v15, v7}, zta(ILjava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;

    move-result-object v12

    :goto_2
    invoke-virtual {v0, v3, v15, v7}, zta(ILjava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
...
.method protected zta(ILjava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-virtual {v1}, Lorg/bouncycastle/crypto/bvj;->Nj()Ljava/security/SecureRandom;
    ...
    sget-object v3, ONE:Ljava/math/BigInteger;
    ...
    :cond_1
    invoke-virtual {p0, v1}, cno(Ljava/math/BigInteger;)Z
...
.method public zta(Lorg/bouncycastle/crypto/bvj;)V
    ...
    iput-object p1, p0, param:Lorg/bouncycastle/crypto/wtn/lqr;
