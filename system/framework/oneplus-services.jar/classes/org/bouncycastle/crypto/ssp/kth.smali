...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0}, <init>(Lorg/bouncycastle/crypto/qbh;)V
...
.method public constructor <init>(Lorg/bouncycastle/crypto/qbh;)V
    ...
    iput-object p1, p0, digest:Lorg/bouncycastle/crypto/qbh;
...
.method private pw()Lorg/bouncycastle/crypto/wtn/ywr;
    .locals 15
    ...
    iget-object v6, p0, digest:Lorg/bouncycastle/crypto/qbh;

    invoke-interface {v6}, Lorg/bouncycastle/crypto/qbh;->cgv()Ljava/lang/String;
    ...
    :cond_0
    :goto_0
    iget-object v6, p0, XAa:Ljava/security/SecureRandom;
    ...
    invoke-static {v6, v1, v2, v7}, zta(Lorg/bouncycastle/crypto/qbh;[B[BI)V

    array-length v6, v1

    invoke-static {v1, v7, v3, v7, v6}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    invoke-static {v3}, ivd([B)V

    iget-object v6, p0, digest:Lorg/bouncycastle/crypto/qbh;

    invoke-static {v6, v3, v3, v7}, zta(Lorg/bouncycastle/crypto/qbh;[B[BI)V
    ...
    invoke-direct {p0, v6}, cno(Ljava/math/BigInteger;)Z
    ...
    :cond_2
    invoke-static {v1}, Lorg/bouncycastle/util/zta;->zgw([B)[B

    move-result-object v8

    invoke-static {v8}, ivd([B)V
    ...
    iget-object v12, p0, digest:Lorg/bouncycastle/crypto/qbh;
    ...
    invoke-static {v12, v8, v4, v13}, zta(Lorg/bouncycastle/crypto/qbh;[B[BI)V
    ...
    invoke-static {v12, v8, v2, v7}, zta(Lorg/bouncycastle/crypto/qbh;[B[BI)V
    ...
    sget-object v13, ONE:Ljava/math/BigInteger;
    ...
    :cond_4
    invoke-direct {p0, v11}, cno(Ljava/math/BigInteger;)Z
    ...
    invoke-static {v11, v6, p0}, sis(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/security/SecureRandom;)Ljava/math/BigInteger;
...
.method private qw()Lorg/bouncycastle/crypto/wtn/ywr;
    .locals 14

    iget-object v0, p0, digest:Lorg/bouncycastle/crypto/qbh;
    ...
    :cond_0
    :goto_0
    iget-object v5, p0, XAa:Ljava/security/SecureRandom;

    invoke-virtual {v5, v2}, Ljava/security/SecureRandom;->nextBytes([B)V

    const/4 v5, 0x0

    invoke-static {v0, v2, v3, v5}, zta(Lorg/bouncycastle/crypto/qbh;[B[BI)V
    ...
    sget-object v8, ONE:Ljava/math/BigInteger;
    ...
    :cond_1
    invoke-static {v2}, Lorg/bouncycastle/util/zta;->zgw([B)[B
    ...
    invoke-static {v0, v8, v1, v12}, zta(Lorg/bouncycastle/crypto/qbh;[B[BI)V
    ...
    invoke-static {v0, v8, v3, v5}, zta(Lorg/bouncycastle/crypto/qbh;[B[BI)V
    ...
    invoke-static {v0, v11, v6, v2, v1}, zta(Lorg/bouncycastle/crypto/qbh;Ljava/math/BigInteger;Ljava/math/BigInteger;[BI)Ljava/math/BigInteger;
    ...
    invoke-static {v11, v6, p0}, tsu(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/security/SecureRandom;)Ljava/math/BigInteger;
...
.method private static sis(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/security/SecureRandom;)Ljava/math/BigInteger;
    ...
    sget-object v0, ONE:Ljava/math/BigInteger;
    ...
    sget-object v0, wDa:Ljava/math/BigInteger;
    ...
    :cond_0
    sget-object v1, wDa:Ljava/math/BigInteger;
...
.method private static tsu(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/security/SecureRandom;)Ljava/math/BigInteger;
    ...
    invoke-static {p0, p1, p2}, sis(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/security/SecureRandom;)Ljava/math/BigInteger;
...
.method private static zta(Lorg/bouncycastle/crypto/qbh;Ljava/math/BigInteger;Ljava/math/BigInteger;[BI)Ljava/math/BigInteger;
    ...
    invoke-interface {p0}, Lorg/bouncycastle/crypto/qbh;->bud()I
    ...
    invoke-static {v1}, ivd([B)V

    invoke-static {p0, v1, p3, v4}, zta(Lorg/bouncycastle/crypto/qbh;[B[BI)V
    ...
    sget-object v3, wDa:Ljava/math/BigInteger;
...
.method public generateParameters()Lorg/bouncycastle/crypto/wtn/ywr;
    ...
    iget-boolean v0, p0, NOa:Z

    if-eqz v0, :cond_0

    invoke-direct {p0}, qw()Lorg/bouncycastle/crypto/wtn/ywr;
    ...
    :cond_0
    invoke-direct {p0}, pw()Lorg/bouncycastle/crypto/wtn/ywr;
...
.method public zta(IILjava/security/SecureRandom;)V
    ...
    iput-object p3, p0, XAa:Ljava/security/SecureRandom;

    const/4 p1, 0x0

    iput-boolean p1, p0, NOa:Z
...
.method public zta(Lorg/bouncycastle/crypto/wtn/dma;)V
    ...
    :cond_5
    :goto_2
    iget-object v2, p0, digest:Lorg/bouncycastle/crypto/qbh;

    invoke-interface {v2}, Lorg/bouncycastle/crypto/qbh;->bud()I
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/crypto/wtn/dma;->Nj()Ljava/security/SecureRandom;

    move-result-object v0

    iput-object v0, p0, XAa:Ljava/security/SecureRandom;

    iput-boolean v2, p0, NOa:Z

    invoke-virtual {p1}, Lorg/bouncycastle/crypto/wtn/dma;->ck()I
