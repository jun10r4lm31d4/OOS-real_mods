...
# static fields
.field public static final YMa:Ljava/lang/String; = "org.bouncycastle.pkcs1.strict"

.field public static final ZMa:Ljava/lang/String; = "org.bouncycastle.pkcs1.not_strict"

.field private static final _Ma:I = 0xa
...
.method public constructor <init>(Lorg/bouncycastle/crypto/zta;)V
    ...
    iput-object v0, p0, WMa:[B

    iput-object p1, p0, fBa:Lorg/bouncycastle/crypto/zta;

    invoke-direct {p0}, ow()Z

    move-result p1

    iput-boolean p1, p0, UMa:Z
...
.method private qbh([BII)[B
    ...
    iget-object p3, p0, XAa:Ljava/security/SecureRandom;

    invoke-virtual {p3, p2}, Ljava/security/SecureRandom;->nextBytes([B)V

    :cond_0
    iget-boolean p3, p0, UMa:Z

    array-length v0, p1

    iget-object v1, p0, fBa:Lorg/bouncycastle/crypto/zta;

    invoke-interface {v1}, Lorg/bouncycastle/crypto/zta;->qeg()I
    ...
    iget-object p1, p0, XMa:[B

    :cond_2
    iget p3, p0, VMa:I

    invoke-static {p1, p3}, bvj([BI)I
...
.method private rtg([BII)[B
    ...
    invoke-direct {p0, p1, p2, p3}, qbh([BII)[B
    ...
    :goto_2
    invoke-direct {p0, p3, p1}, zta(B[B)I
...
.method public you([BII)[B
    ...
    invoke-direct {p0, p1, p2, p3}, ssp([BII)[B
    ...
    :cond_0
    invoke-direct {p0, p1, p2, p3}, rtg([BII)[B
...
.method public zta(ZLorg/bouncycastle/crypto/kth;)V
    ...
    iput-boolean p2, p0, TMa:Z

    iput-boolean p1, p0, yLa:Z

    iget-object p1, p0, fBa:Lorg/bouncycastle/crypto/zta;

    invoke-interface {p1}, Lorg/bouncycastle/crypto/zta;->qeg()I

    move-result p1

    new-array p1, p1, [B

    iput-object p1, p0, XMa:[B

    iget p1, p0, VMa:I

    if-lez p1, :cond_3

    iget-object p1, p0, WMa:[B
