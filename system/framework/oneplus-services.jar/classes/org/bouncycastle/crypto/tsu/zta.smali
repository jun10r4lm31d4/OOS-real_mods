...
.field private SMa:Lorg/bouncycastle/crypto/qbh;

.field private XAa:Ljava/security/SecureRandom;

.field private fBa:Lorg/bouncycastle/crypto/zta;
...
.method public constructor <init>(Lorg/bouncycastle/crypto/zta;)V
    ...
    invoke-direct {p0, p1, v0, v1}, <init>(Lorg/bouncycastle/crypto/zta;Lorg/bouncycastle/crypto/qbh;[B)V
...
.method public constructor <init>(Lorg/bouncycastle/crypto/zta;Lorg/bouncycastle/crypto/qbh;)V
    ...
    invoke-direct {p0, p1, p2, v0}, <init>(Lorg/bouncycastle/crypto/zta;Lorg/bouncycastle/crypto/qbh;[B)V
...
.method public constructor <init>(Lorg/bouncycastle/crypto/zta;Lorg/bouncycastle/crypto/qbh;Lorg/bouncycastle/crypto/qbh;[B)V
    ...
    iput-object p1, p0, fBa:Lorg/bouncycastle/crypto/zta;

    iput-object p3, p0, SMa:Lorg/bouncycastle/crypto/qbh;

    invoke-interface {p2}, Lorg/bouncycastle/crypto/qbh;->bud()I

    move-result p1

    new-array p1, p1, [B

    iput-object p1, p0, RMa:[B
...
.method public constructor <init>(Lorg/bouncycastle/crypto/zta;Lorg/bouncycastle/crypto/qbh;[B)V
    ...
    invoke-direct {p0, p1, p2, p2, p3}, <init>(Lorg/bouncycastle/crypto/zta;Lorg/bouncycastle/crypto/qbh;Lorg/bouncycastle/crypto/qbh;[B)V
...
.method private zta([BIII)[B
    ...
    iget-object v1, p0, SMa:Lorg/bouncycastle/crypto/qbh;

    invoke-interface {v1}, Lorg/bouncycastle/crypto/qbh;->bud()I
    ...
    iget-object v3, p0, SMa:Lorg/bouncycastle/crypto/qbh;
    ...
    invoke-direct {p0, v4, v2}, sis(I[B)V

    iget-object v5, p0, SMa:Lorg/bouncycastle/crypto/qbh;
    ...
    iget-object p4, p0, SMa:Lorg/bouncycastle/crypto/qbh;

    invoke-interface {p4, p1, p2, p3}, Lorg/bouncycastle/crypto/qbh;->update([BII)V

    iget-object p1, p0, SMa:Lorg/bouncycastle/crypto/qbh;

    array-length p2, v2

    invoke-interface {p1, v2, v3, p2}, Lorg/bouncycastle/crypto/qbh;->update([BII)V

    iget-object p0, p0, SMa:Lorg/bouncycastle/crypto/qbh;
...
# virtual methods
.method public a()Lorg/bouncycastle/crypto/zta;
    .locals 0

    iget-object p0, p0, fBa:Lorg/bouncycastle/crypto/zta;
...
.method public c()I
    ...
    iget-object v0, p0, fBa:Lorg/bouncycastle/crypto/zta;
...
.method public qeg()I
    ...
    invoke-interface {v0}, Lorg/bouncycastle/crypto/zta;->qeg()I
...
.method public rtg([BII)[B
    ...
    iget-object p2, p0, fBa:Lorg/bouncycastle/crypto/zta;

    invoke-interface {p2}, Lorg/bouncycastle/crypto/zta;->qeg()I
    ...
    invoke-direct {p0, p2, v0, v3, p1}, zta([BIII)[B
    ...
    invoke-direct {p0, p2, v2, p1, v0}, zta([BIII)[B
...
.method public ssp([BII)[B
    ...
    invoke-direct {p0, p1, v1, p2, p3}, zta([BIII)[B

    move-result-object p2

    iget-object p3, p0, RMa:[B
    ...
    invoke-direct {p0, v0, p2, p3, p1}, zta([BIII)[B
...
.method public you([BII)[B
    ...
    invoke-virtual {p0, p1, p2, p3}, ssp([BII)[B
    ...
    :cond_0
    invoke-virtual {p0, p1, p2, p3}, rtg([BII)[B
...
.method public zta(ZLorg/bouncycastle/crypto/kth;)V
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/crypto/wtn/hmo;->Nj()Ljava/security/SecureRandom;
