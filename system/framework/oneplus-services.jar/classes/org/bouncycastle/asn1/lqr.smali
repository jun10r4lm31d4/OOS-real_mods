...
.method public constructor <init>(ZILorg/bouncycastle/asn1/ssp;)V
    ...
    iput-boolean v0, p0, empty:Z

    const/4 v0, 0x1

    iput-boolean v0, p0, DEa:Z

    const/4 v1, 0x0

    iput-object v1, p0, obj:Lorg/bouncycastle/asn1/ssp;
    ...
    :cond_0
    iput-boolean p1, p0, DEa:Z

    :goto_0
    iput p2, p0, CEa:I

    iget-boolean p1, p0, DEa:Z

    if-eqz p1, :cond_1

    :goto_1
    iput-object p3, p0, obj:Lorg/bouncycastle/asn1/ssp;
...
.method public static getInstance(Ljava/lang/Object;)Lorg/bouncycastle/asn1/lqr;
    ...
    invoke-static {p0}, getInstance(Ljava/lang/Object;)Lorg/bouncycastle/asn1/lqr;
...
.method public static zta(Lorg/bouncycastle/asn1/lqr;Z)Lorg/bouncycastle/asn1/lqr;
    ...
    invoke-virtual {p0}, getObject()Lorg/bouncycastle/asn1/vdb;
...
.method zta(Lorg/bouncycastle/asn1/vdb;)Z
    ...
    iget-boolean v0, p0, empty:Z

    iget-boolean v2, p1, empty:Z

    if-ne v0, v2, :cond_4

    iget-boolean v0, p0, DEa:Z

    iget-boolean v2, p1, DEa:Z
    ...
    iget-object p0, p1, obj:Lorg/bouncycastle/asn1/ssp;
    ...
    iget-object p1, p1, obj:Lorg/bouncycastle/asn1/ssp;
