...
# static fields
.field public static final LGa:I = 0x1

.field public static final MGa:I = 0x3

.field public static final NGa:I = 0x4

.field public static final OGa:I = 0x5

.field public static final PGa:I = 0x6

.field public static final QGa:I = 0x8
...
.method public constructor <init>(ILjava/lang/String;)V
    ...
    invoke-direct {p0, p2}, zd(Ljava/lang/String;)[B
    ...
    iput-object p2, p0, obj:Lorg/bouncycastle/asn1/ssp;
    ...
    :goto_1
    iput-object p1, p0, obj:Lorg/bouncycastle/asn1/ssp;
...
.method public static getInstance(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x509/zgw;
    ...
    invoke-direct {p0, v1, v0}, <init>(ILorg/bouncycastle/asn1/ssp;)V
    ...
    invoke-static {p0}, getInstance(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x509/zgw;
...
.method private zd(Ljava/lang/String;)[B
    ...
    invoke-static {p1}, Lorg/bouncycastle/util/ssp;->eb(Ljava/lang/String;)Z
    ...
    invoke-static {p1}, Lorg/bouncycastle/util/ssp;->db(Ljava/lang/String;)Z
    ...
    :cond_0
    invoke-static {p1}, Lorg/bouncycastle/util/ssp;->cb(Ljava/lang/String;)Z

    move-result v0

    if-nez v0, :cond_2

    invoke-static {p1}, Lorg/bouncycastle/util/ssp;->bb(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1, v0, v2}, you(Ljava/lang/String;[BI)V
    ...
    invoke-direct {p0, v4, v3, v2}, you(Ljava/lang/String;[BI)V
    ...
    invoke-direct {p0, p1, v3, v1}, you(Ljava/lang/String;[BI)V

    goto :goto_1

    :cond_4
    invoke-direct {p0, p1, v3, v1}, sis(Ljava/lang/String;[BI)V
    ...
    invoke-direct {p0, p1}, xd(Ljava/lang/String;)[I

    move-result-object p1

    invoke-direct {p0, p1, v0, v2}, sis([I[BI)V
    ...
    invoke-direct {p0, v4}, xd(Ljava/lang/String;)[I

    move-result-object v4

    invoke-direct {p0, v4, v3, v2}, sis([I[BI)V
    ...
    :cond_7
    invoke-direct {p0, p1}, yd(Ljava/lang/String;)[I

    move-result-object p1

    :goto_3
    invoke-direct {p0, p1, v3, v1}, sis([I[BI)V
...
.method public getName()Lorg/bouncycastle/asn1/ssp;
    ...
    iget-object p0, p0, obj:Lorg/bouncycastle/asn1/ssp;
