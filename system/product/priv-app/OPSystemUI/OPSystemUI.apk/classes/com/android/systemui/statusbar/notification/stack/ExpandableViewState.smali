...
.method static synthetic access$300()I
    ...
    sget v0, TAG_ANIMATOR_TOP_INSET:I
...
.method private startInsetAnimation(Lcom/android/systemui/statusbar/notification/row/ExpandableView;Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;)V
    ...
    :cond_0
    sget v3, TAG_ANIMATOR_TOP_INSET:I
    ...
    sget p0, TAG_ANIMATOR_TOP_INSET:I
...
.method public animateTo(Landroid/view/View;Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;)V
    ...
    invoke-direct {p0, v0, p2}, startHeightAnimation(Lcom/android/systemui/statusbar/notification/row/ExpandableView;Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;)V

    goto :goto_0

    :cond_1
    sget v1, TAG_ANIMATOR_HEIGHT:I
    ...
    invoke-direct {p0, v0, p2}, startInsetAnimation(Lcom/android/systemui/statusbar/notification/row/ExpandableView;Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;)V

    goto :goto_1

    :cond_2
    sget v1, TAG_ANIMATOR_TOP_INSET:I

    invoke-virtual {p0, p1, v1}, Lcom/android/systemui/statusbar/notification/stack/ViewState;->abortAnimation(Landroid/view/View;I)V

    :goto_1
    iget-boolean v1, p0, dimmed:Z
    ...
    iget-boolean p0, p0, headsUpIsVisible:Z
...
.method public copyFrom(Lcom/android/systemui/statusbar/notification/stack/ViewState;)V
    ...
    iget-boolean v0, p1, dimmed:Z

    iput-boolean v0, p0, dimmed:Z

    iget-boolean v0, p1, dark:Z

    iput-boolean v0, p0, dark:Z

    iget-boolean v0, p1, hideSensitive:Z

    iput-boolean v0, p0, hideSensitive:Z

    iget-boolean v0, p1, belowSpeedBump:Z

    iput-boolean v0, p0, belowSpeedBump:Z

    iget v0, p1, clipTopAmount:I

    iput v0, p0, clipTopAmount:I

    iget v0, p1, notGoneIndex:I

    iput v0, p0, notGoneIndex:I

    iget v0, p1, location:I

    iput v0, p0, location:I

    iget-boolean p1, p1, headsUpIsVisible:Z

    iput-boolean p1, p0, headsUpIsVisible:Z
