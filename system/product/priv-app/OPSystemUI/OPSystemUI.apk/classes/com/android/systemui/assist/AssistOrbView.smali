...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object p2, p0, mBackgroundPaint:Landroid/graphics/Paint;

    new-instance p2, Landroid/graphics/Rect;

    invoke-direct {p2}, Landroid/graphics/Rect;-><init>()V

    iput-object p2, p0, mCircleRect:Landroid/graphics/Rect;

    new-instance p2, Landroid/graphics/Rect;

    invoke-direct {p2}, Landroid/graphics/Rect;-><init>()V

    iput-object p2, p0, mStaticRect:Landroid/graphics/Rect;

    new-instance p2, Landroid/view/animation/OvershootInterpolator;

    invoke-direct {p2}, Landroid/view/animation/OvershootInterpolator;-><init>()V

    iput-object p2, p0, mOvershootInterpolator:Landroid/view/animation/Interpolator;
    ...
    iput-object p2, p0, mCircleUpdateListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    iput-object p2, p0, mClearAnimatorListener:Landroid/animation/AnimatorListenerAdapter;
    ...
    iput-object p2, p0, mOffsetUpdateListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
...
.method static synthetic access$000(Lcom/android/systemui/assist/AssistOrbView;F)V
    ...
    invoke-direct {p0, p1}, applyCircleSize(F)V
...
.method static synthetic access$100(Lcom/android/systemui/assist/AssistOrbView;)V
    ...
    invoke-direct {p0}, updateElevation()V
...
.method static synthetic access$1000(Lcom/android/systemui/assist/AssistOrbView;)Landroid/view/animation/Interpolator;
    ...
    iget-object p0, p0, mOvershootInterpolator:Landroid/view/animation/Interpolator;
...
.method static synthetic access$1200(Lcom/android/systemui/assist/AssistOrbView;FJJLandroid/view/animation/Interpolator;)V
    ...
    invoke-direct/range {p0 .. p6}, animateOffset(FJJLandroid/view/animation/Interpolator;)V
...
.method static synthetic access$400(Lcom/android/systemui/assist/AssistOrbView;)V
    ...
    invoke-direct {p0}, updateLayout()V
...
.method static synthetic access$600(Lcom/android/systemui/assist/AssistOrbView;)Landroid/graphics/Rect;
    ...
    iget-object p0, p0, mCircleRect:Landroid/graphics/Rect;
...
.method static synthetic access$802(Lcom/android/systemui/assist/AssistOrbView;Landroid/animation/ValueAnimator;)Landroid/animation/ValueAnimator;
    ...
    iput-object p1, p0, mOffsetAnimator:Landroid/animation/ValueAnimator;
...
.method private animateOffset(FJJLandroid/view/animation/Interpolator;)V
    ...
    iget-object p1, p0, mOffsetAnimator:Landroid/animation/ValueAnimator;

    iget-object v0, p0, mOffsetUpdateListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    iget-object p0, p0, mOffsetAnimator:Landroid/animation/ValueAnimator;
...
.method private drawBackground(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, mCircleRect:Landroid/graphics/Rect;
    ...
    iget-object v1, p0, mCircleRect:Landroid/graphics/Rect;
...
.method private updateCircleRect()V
    ...
    invoke-direct {p0, v0, v1, v2}, updateCircleRect(Landroid/graphics/Rect;FZ)V
...
.method private updateClipping()V
    ...
    iget v0, p0, mCircleSize:F

    iget v1, p0, mCircleMinSize:I
    ...
    :goto_0
    iget-boolean v1, p0, mClipToOutline:Z

    if-eq v0, v1, :cond_1

    invoke-virtual {p0, v0}, Landroid/widget/FrameLayout;->setClipToOutline(Z)V

    iput-boolean v0, p0, mClipToOutline:Z
...
.method private updateLayout()V
    ...
    invoke-direct {p0}, updateCircleRect()V

    invoke-direct {p0}, updateLogo()V
...
.method private updateLogo()V
    ...
    iget-object v2, p0, mLogo:Landroid/widget/ImageView;
    ...
    iget-object v2, p0, mCircleRect:Landroid/graphics/Rect;
    ...
    iget-object v3, p0, mLogo:Landroid/widget/ImageView;
    ...
    iget v3, p0, mStaticOffset:I

    int-to-float v4, v3

    iget v5, p0, mOffset:F
    ...
    iget-object v1, p0, mLogo:Landroid/widget/ImageView;

    invoke-virtual {v1, v0}, Landroid/widget/ImageView;->setTranslationX(F)V

    iget-object p0, p0, mLogo:Landroid/widget/ImageView;
...
.method public animateCircleSize(FJJLandroid/view/animation/Interpolator;)V
    ...
    iget v0, p0, mCircleAnimationEndValue:F
    ...
    iget-object v1, p0, mCircleUpdateListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;

    invoke-virtual {v0, v1}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    iget-object v0, p0, mCircleAnimator:Landroid/animation/ValueAnimator;

    iget-object v1, p0, mClearAnimatorListener:Landroid/animation/AnimatorListenerAdapter;
    ...
    iget-object p6, p0, mCircleAnimator:Landroid/animation/ValueAnimator;
    ...
    iput p1, p0, mCircleAnimationEndValue:F
...
.method protected onFinishInflate()V
    ...
    iput-object v0, p0, mLogo:Landroid/widget/ImageView;
...
.method protected onLayout(ZIIII)V
    ...
    iget-object p2, p0, mLogo:Landroid/widget/ImageView;

    invoke-virtual {p2}, Landroid/widget/ImageView;->getMeasuredWidth()I

    move-result p3

    iget-object p4, p0, mLogo:Landroid/widget/ImageView;
    ...
    iget-object p1, p0, mStaticRect:Landroid/graphics/Rect;

    iget p2, p0, mStaticOffset:I

    int-to-float p2, p2

    const/4 p3, 0x1

    invoke-direct {p0, p1, p2, p3}, updateCircleRect(Landroid/graphics/Rect;FZ)V
...
.method public reset()V
    ...
    iget-object v0, p0, mBackgroundPaint:Landroid/graphics/Paint;
...
.method public startEnterAnimation()V
    ...
    invoke-direct {p0, v0}, applyCircleSize(F)V
...
.method public startExitAnimation(J)V
    ...
    invoke-virtual/range {v0 .. v6}, animateCircleSize(FJJLandroid/view/animation/Interpolator;)V
    ...
    invoke-direct/range {v7 .. v13}, animateOffset(FJJLandroid/view/animation/Interpolator;)V
