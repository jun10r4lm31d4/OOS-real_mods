...
.method static constructor <clinit>()V
    ...
    sput-object v0, FALLBACK_HOME_COMPONENT:Landroid/content/ComponentName;
    ...
    sput-boolean v0, CORE_APPS_ONLY:Z
    :try_end_0
...
.method protected constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mSimDatas:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, mServiceStates:Ljava/util/HashMap;
    ...
    iput v0, p0, mFingerprintRunningState:I

    iput v0, p0, mFaceRunningState:I

    iput v0, p0, mHardwareFingerprintUnavailableRetryCount:I

    iput v0, p0, mHardwareFaceUnavailableRetryCount:I
    ...
    iput-object v0, p0, mHandler:Lcom/oneplus/keyguard/OpKeyguardUpdateMonitor$OpHandler;
    ...
    iput-object v0, p0, mBiometricEnabledCallback:Landroid/hardware/biometrics/IBiometricEnabledOnKeyguardCallback;
    ...
    iput-object v0, p0, mSubscriptionListener:Landroid/telephony/SubscriptionManager$OnSubscriptionsChangedListener;
    ...
    iput-object v0, p0, mUserFingerprintAuthenticated:Landroid/util/SparseBooleanArray;

    new-instance v0, Landroid/util/SparseBooleanArray;

    invoke-direct {v0}, Landroid/util/SparseBooleanArray;-><init>()V

    iput-object v0, p0, mUserFaceAuthenticated:Landroid/util/SparseBooleanArray;

    new-instance v0, Landroid/util/SparseBooleanArray;

    invoke-direct {v0}, Landroid/util/SparseBooleanArray;-><init>()V

    iput-object v0, p0, mUserFaceUnlockRunning:Landroid/util/SparseBooleanArray;
    ...
    iput-object v0, p0, mUpdateBiometricListeningState:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mRetryFingerprintAuthentication:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mRetryFaceAuthentication:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mDisplayClientState:Lcom/android/keyguard/KeyguardUpdateMonitor$DisplayClientState;
    ...
    iput-object v0, p0, mBroadcastAllReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v0, p0, mFingerprintLockoutResetCallback:Landroid/hardware/fingerprint/FingerprintManager$LockoutResetCallback;
    ...
    iput-object v0, p0, mFaceLockoutResetCallback:Landroid/hardware/face/FaceManager$LockoutResetCallback;
    ...
    iput-object v0, p0, mFingerprintAuthenticationCallback:Landroid/hardware/fingerprint/FingerprintManager$AuthenticationCallback;
    ...
    iput-object v0, p0, mFaceAuthenticationCallback:Landroid/hardware/face/FaceManager$AuthenticationCallback;
    ...
    iput-object v0, p0, mTaskStackListener:Lcom/android/systemui/shared/system/TaskStackChangeListener;
    ...
    iput-object v0, p0, mSubscriptionManager:Landroid/telephony/SubscriptionManager;

    invoke-direct {p0}, isDeviceProvisionedInSettingsDb()Z

    move-result v0

    iput-boolean v0, p0, mDeviceProvisioned:Z
    ...
    iput-object v0, p0, mStrongAuthTracker:Lcom/android/keyguard/KeyguardUpdateMonitor$StrongAuthTracker;

    iget-boolean v0, p0, mDeviceProvisioned:Z

    if-nez v0, :cond_0

    invoke-direct {p0}, watchForDeviceProvisioning()V
    ...
    iput-object v0, p0, mBatteryStatus:Lcom/android/keyguard/KeyguardUpdateMonitor$BatteryStatus;
    ...
    iget-object v3, p0, mHandler:Lcom/oneplus/keyguard/OpKeyguardUpdateMonitor$OpHandler;
    ...
    iget-object v6, p0, mBroadcastAllReceiver:Landroid/content/BroadcastReceiver;

    sget-object v7, Landroid/os/UserHandle;->ALL:Landroid/os/UserHandle;

    const/4 v9, 0x0

    iget-object v10, p0, mHandler:Lcom/oneplus/keyguard/OpKeyguardUpdateMonitor$OpHandler;
    ...
    iput-object v0, p0, mTrustManager:Landroid/app/trust/TrustManager;

    iget-object v0, p0, mTrustManager:Landroid/app/trust/TrustManager;
    ...
    iget-object v1, p0, mStrongAuthTracker:Lcom/android/keyguard/KeyguardUpdateMonitor$StrongAuthTracker;
    ...
    iput-object v0, p0, mFpm:Landroid/hardware/fingerprint/FingerprintManager;
    ...
    iput-object v0, p0, mFaceManager:Landroid/hardware/face/FaceManager;
    ...
    iget-object v0, p0, mFaceManager:Landroid/hardware/face/FaceManager;
    ...
    iput-object v0, p0, mBiometricManager:Landroid/hardware/biometrics/BiometricManager;

    iget-object v0, p0, mBiometricManager:Landroid/hardware/biometrics/BiometricManager;

    iget-object v1, p0, mBiometricEnabledCallback:Landroid/hardware/biometrics/IBiometricEnabledOnKeyguardCallback;
    ...
    :cond_5
    invoke-virtual {p0}, updateBiometricListeningState()V

    iget-object v0, p0, mFpm:Landroid/hardware/fingerprint/FingerprintManager;

    if-eqz v0, :cond_6

    iget-object v1, p0, mFingerprintLockoutResetCallback:Landroid/hardware/fingerprint/FingerprintManager$LockoutResetCallback;
    ...
    iget-object v1, p0, mFaceLockoutResetCallback:Landroid/hardware/face/FaceManager$LockoutResetCallback;
    ...
    iget-object v1, p0, mTaskStackListener:Lcom/android/systemui/shared/system/TaskStackChangeListener;
    ...
    iput-boolean v0, p0, mIsPrimaryUser:Z
    ...
    iput-object p1, p0, mDevicePolicyManager:Landroid/app/admin/DevicePolicyManager;

    iget-object p1, p0, mDevicePolicyManager:Landroid/app/admin/DevicePolicyManager;

    invoke-virtual {p1}, Landroid/app/admin/DevicePolicyManager;->isLogoutEnabled()Z

    move-result p1

    iput-boolean p1, p0, mLogoutEnabled:Z

    invoke-direct {p0}, updateAirplaneModeState()V
...
.method static synthetic access$000(Lcom/android/keyguard/KeyguardUpdateMonitor;)V
    ...
    invoke-direct {p0}, handleTimeUpdate()V
...
.method static synthetic access$100(Lcom/android/keyguard/KeyguardUpdateMonitor;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, handleTimeZoneUpdate(Ljava/lang/String;)V
...
.method static synthetic access$1000(Lcom/android/keyguard/KeyguardUpdateMonitor;)V
    ...
    invoke-direct {p0}, handleKeyguardReset()V
...
.method static synthetic access$1100(Lcom/android/keyguard/KeyguardUpdateMonitor;I)V
    ...
    invoke-direct {p0, p1}, handleKeyguardBouncerChanged(I)V
...
.method static synthetic access$1200(Lcom/android/keyguard/KeyguardUpdateMonitor;)V
    ...
    invoke-direct {p0}, handleBootCompleted()V
...
.method static synthetic access$1300(Lcom/android/keyguard/KeyguardUpdateMonitor;I)V
    ...
    invoke-direct {p0, p1}, handleUserInfoChanged(I)V
...
.method static synthetic access$1400(Lcom/android/keyguard/KeyguardUpdateMonitor;)V
    ...
    invoke-direct {p0}, handleReportEmergencyCallAction()V
...
.method static synthetic access$1500(Lcom/android/keyguard/KeyguardUpdateMonitor;ZI)V
    ...
    invoke-direct {p0, p1, p2}, handleFaceUnlockStateChanged(ZI)V
...
.method static synthetic access$1900(Lcom/android/keyguard/KeyguardUpdateMonitor;)V
    ...
    invoke-direct {p0}, handleSimSubscriptionInfoChanged()V
...
.method static synthetic access$200(Lcom/android/keyguard/KeyguardUpdateMonitor;Lcom/android/keyguard/KeyguardUpdateMonitor$BatteryStatus;)V
    ...
    invoke-direct {p0, p1}, handleBatteryUpdate(Lcom/android/keyguard/KeyguardUpdateMonitor$BatteryStatus;)V
...
.method static synthetic access$2000(Lcom/android/keyguard/KeyguardUpdateMonitor;)V
    ...
    invoke-direct {p0}, handleAirplaneModeChanged()V
...
.method static synthetic access$2100(Lcom/android/keyguard/KeyguardUpdateMonitor;)V
    ...
    invoke-direct {p0}, handleScreenTurnedOn()V
...
.method static synthetic access$2200(Lcom/android/keyguard/KeyguardUpdateMonitor;)V
    ...
    invoke-direct {p0}, handleScreenTurnedOff()V
...
.method static synthetic access$2300(Lcom/android/keyguard/KeyguardUpdateMonitor;I)V
    ...
    invoke-direct {p0, p1}, handleDreamingStateChanged(I)V
...
.method static synthetic access$2400(Lcom/android/keyguard/KeyguardUpdateMonitor;)V
    ...
    invoke-direct {p0}, handleUserUnlocked()V
...
.method static synthetic access$2500(Lcom/android/keyguard/KeyguardUpdateMonitor;)V
    ...
    invoke-direct {p0}, updateLogoutEnabled()V
...
.method static synthetic access$2602(Lcom/android/keyguard/KeyguardUpdateMonitor;Z)Z
    ...
    iput-boolean p1, p0, mFaceSettingEnabledForUser:Z
...
.method static synthetic access$2700(Lcom/android/keyguard/KeyguardUpdateMonitor;)V
    ...
    invoke-direct {p0}, updateFaceListeningState()V
...
.method static synthetic access$2800(Lcom/android/keyguard/KeyguardUpdateMonitor;)Lcom/oneplus/keyguard/OpKeyguardUpdateMonitor$OpHandler;
    ...
    iget-object p0, p0, mHandler:Lcom/oneplus/keyguard/OpKeyguardUpdateMonitor$OpHandler;
...
.method static synthetic access$2900(Lcom/android/keyguard/KeyguardUpdateMonitor;)I
    ...
    iget p0, p0, mHardwareFingerprintUnavailableRetryCount:I
...
.method static synthetic access$3000(Lcom/android/keyguard/KeyguardUpdateMonitor;)V
    ...
    invoke-direct {p0}, updateFingerprintListeningState()V
...
.method static synthetic access$3100(Lcom/android/keyguard/KeyguardUpdateMonitor;)I
    ...
    iget p0, p0, mHardwareFaceUnavailableRetryCount:I
...
.method static synthetic access$3300(Lcom/android/keyguard/KeyguardUpdateMonitor;)V
    ...
    invoke-direct {p0}, handleFingerprintLockoutReset()V
...
.method static synthetic access$3400(Lcom/android/keyguard/KeyguardUpdateMonitor;)V
    ...
    invoke-direct {p0}, handleFaceLockoutReset()V
...
.method static synthetic access$3700(Lcom/android/keyguard/KeyguardUpdateMonitor;)V
    ...
    invoke-direct {p0}, handleFingerprintAuthFailed()V
...
.method static synthetic access$400(Lcom/android/keyguard/KeyguardUpdateMonitor;I)V
    ...
    invoke-direct {p0, p1}, handleRingerModeChange(I)V
...
.method static synthetic access$4000(Lcom/android/keyguard/KeyguardUpdateMonitor;I)V
    ...
    invoke-direct {p0, p1}, handleFingerprintAuthenticated(I)V
...
.method static synthetic access$4300(Lcom/android/keyguard/KeyguardUpdateMonitor;ILjava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2}, handleFingerprintHelp(ILjava/lang/String;)V
...
.method static synthetic access$4400(Lcom/android/keyguard/KeyguardUpdateMonitor;)I
    ...
    iget p0, p0, mFingerprintRunningState:I
...
.method static synthetic access$4600(Lcom/android/keyguard/KeyguardUpdateMonitor;I)V
    ...
    invoke-direct {p0, p1}, setFingerprintRunningState(I)V
...
.method static synthetic access$4900(Lcom/android/keyguard/KeyguardUpdateMonitor;ILjava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2}, handleFingerprintError(ILjava/lang/String;)V
...
.method static synthetic access$500(Lcom/android/keyguard/KeyguardUpdateMonitor;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, handlePhoneStateChanged(Ljava/lang/String;)V
...
.method static synthetic access$5000(Lcom/android/keyguard/KeyguardUpdateMonitor;I)V
    ...
    invoke-direct {p0, p1}, handleFingerprintAcquired(I)V
...
.method static synthetic access$5100(Lcom/android/keyguard/KeyguardUpdateMonitor;)V
    ...
    invoke-direct {p0}, handleFaceAuthFailed()V
...
.method static synthetic access$5200(Lcom/android/keyguard/KeyguardUpdateMonitor;I)V
    ...
    invoke-direct {p0, p1}, handleFaceAuthenticated(I)V
...
.method static synthetic access$5300(Lcom/android/keyguard/KeyguardUpdateMonitor;ILjava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2}, handleFaceHelp(ILjava/lang/String;)V
...
.method static synthetic access$5400(Lcom/android/keyguard/KeyguardUpdateMonitor;ILjava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2}, handleFaceError(ILjava/lang/String;)V
...
.method static synthetic access$5500(Lcom/android/keyguard/KeyguardUpdateMonitor;I)V
    ...
    invoke-direct {p0, p1}, handleFaceAcquired(I)V
...
.method static synthetic access$5600(Lcom/android/keyguard/KeyguardUpdateMonitor;)Z
    ...
    iget-boolean p0, p0, mDeviceProvisioned:Z
...
.method static synthetic access$5602(Lcom/android/keyguard/KeyguardUpdateMonitor;Z)Z
    ...
    iput-boolean p1, p0, mDeviceProvisioned:Z
...
.method static synthetic access$600(Lcom/android/keyguard/KeyguardUpdateMonitor;)V
    ...
    invoke-direct {p0}, handleDeviceProvisioned()V
...
.method static synthetic access$700(Lcom/android/keyguard/KeyguardUpdateMonitor;)V
    ...
    invoke-direct {p0}, handleDevicePolicyManagerStateChanged()V
...
.method static synthetic access$800(Lcom/android/keyguard/KeyguardUpdateMonitor;ILandroid/os/IRemoteCallback;)V
    ...
    invoke-direct {p0, p1, p2}, handleUserSwitching(ILandroid/os/IRemoteCallback;)V
...
.method static synthetic access$900(Lcom/android/keyguard/KeyguardUpdateMonitor;I)V
    ...
    invoke-direct {p0, p1}, handleUserSwitchComplete(I)V
...
.method private checkIsHandlerThread()V
    ...
    sget-boolean v0, sDisableHandlerCheckForTesting:Z
    ...
    :cond_0
    iget-object v0, p0, mHandler:Lcom/oneplus/keyguard/OpKeyguardUpdateMonitor$OpHandler;
...
.method public static disableHandlerCheckForTesting(Landroid/app/Instrumentation;)V
    ...
    sput-boolean p0, sDisableHandlerCheckForTesting:Z
...
.method public static getInstance(Landroid/content/Context;)Lcom/android/keyguard/KeyguardUpdateMonitor;
    ...
    sget-object v0, sInstance:Lcom/android/keyguard/KeyguardUpdateMonitor;
    ...
    sput-object v0, sInstance:Lcom/android/keyguard/KeyguardUpdateMonitor;

    :cond_0
    sget-object p0, sInstance:Lcom/android/keyguard/KeyguardUpdateMonitor;
...
.method private handleBatteryUpdate(Lcom/android/keyguard/KeyguardUpdateMonitor$BatteryStatus;)V
    ...
    :cond_0
    iget-object v0, p0, mBatteryStatus:Lcom/android/keyguard/KeyguardUpdateMonitor$BatteryStatus;

    invoke-direct {p0, v0, p1}, isBatteryUpdateInteresting(Lcom/android/keyguard/KeyguardUpdateMonitor$BatteryStatus;Lcom/android/keyguard/KeyguardUpdateMonitor$BatteryStatus;)Z

    move-result v0

    iput-object p1, p0, mBatteryStatus:Lcom/android/keyguard/KeyguardUpdateMonitor$BatteryStatus;
...
.method private handleBootCompleted()V
    ...
    const-string v1, "reset cbt applocker2.0 param"
    ...
    const-string v3, "applocker_private_password_main_switch"
    ...
    const-string v3, "privacy_password_ota_hint_alarm_set_up"
    ...
    const-string v0, "privacy_password_ota_hint_done"
...
.method private handleDeviceProvisioned()V
    ...
    :cond_1
    iget-object v0, p0, mDeviceProvisionedObserver:Landroid/database/ContentObserver;
    ...
    iget-object v1, p0, mDeviceProvisionedObserver:Landroid/database/ContentObserver;

    invoke-virtual {v0, v1}, Landroid/content/ContentResolver;->unregisterContentObserver(Landroid/database/ContentObserver;)V

    const/4 v0, 0x0

    iput-object v0, p0, mDeviceProvisionedObserver:Landroid/database/ContentObserver;
...
.method private handleDreamingStateChanged(I)V
    ...
    :goto_0
    iput-boolean v2, p0, mIsDreaming:Z

    :goto_1
    if-ge v1, v0, :cond_2

    iget-object p1, p0, mCallbacks:Ljava/util/ArrayList;
    ...
    iget-boolean v2, p0, mIsDreaming:Z
...
.method private handleFaceAuthFailed()V
    ...
    invoke-direct {p0, v0}, setFaceRunningState(I)V
    ...
    invoke-direct {p0, v0, v1}, handleFaceHelp(ILjava/lang/String;)V
...
.method private handleFaceAuthenticated(I)V
    ...
    invoke-direct {p0, v1}, setFaceRunningState(I)V

    return-void

    :cond_0
    :try_start_2
    invoke-direct {p0, v2}, isFaceDisabled(I)Z
    ...
    :cond_1
    :try_start_3
    invoke-virtual {p0, v2}, onFaceAuthenticated(I)V
    :try_end_3
...
.method private handleFaceError(ILjava/lang/String;)V
    ...
    iget v2, p0, mFaceRunningState:I
    ...
    iget v3, p0, mHardwareFaceUnavailableRetryCount:I

    if-ge v3, v0, :cond_1

    add-int/2addr v3, v2

    iput v3, p0, mHardwareFaceUnavailableRetryCount:I

    iget-object v0, p0, mHandler:Lcom/oneplus/keyguard/OpKeyguardUpdateMonitor$OpHandler;

    iget-object v2, p0, mRetryFaceAuthentication:Ljava/lang/Runnable;
    ...
    invoke-static {}, getCurrentUser()I
...
.method private handleFaceUnlockStateChanged(ZI)V
    ...
    invoke-direct {p0}, checkIsHandlerThread()V

    iget-object v0, p0, mUserFaceUnlockRunning:Landroid/util/SparseBooleanArray;
...
.method private handleFingerprintAuthFailed()V
    ...
    invoke-direct {p0, v0, v1}, handleFingerprintHelp(ILjava/lang/String;)V
...
.method private handleFingerprintAuthenticated(I)V
    ...
    invoke-direct {p0, v1}, setFingerprintRunningState(I)V

    return-void

    :cond_0
    :try_start_2
    invoke-direct {p0, v2}, isFingerprintDisabled(I)Z
    ...
    :cond_1
    :try_start_3
    invoke-virtual {p0, v2}, onFingerprintAuthenticated(I)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
...
.method private handleFingerprintError(ILjava/lang/String;)V
    ...
    iget v2, p0, mFingerprintRunningState:I
    ...
    iget v3, p0, mHardwareFingerprintUnavailableRetryCount:I

    if-ge v3, v0, :cond_1

    add-int/2addr v3, v2

    iput v3, p0, mHardwareFingerprintUnavailableRetryCount:I

    iget-object v0, p0, mHandler:Lcom/oneplus/keyguard/OpKeyguardUpdateMonitor$OpHandler;

    iget-object v2, p0, mRetryFingerprintAuthentication:Ljava/lang/Runnable;
...
.method private handleKeyguardReset()V
    ...
    invoke-direct {p0}, resolveNeedsSlowUnlockTransition()Z

    move-result v0

    iput-boolean v0, p0, mNeedsSlowUnlockTransition:Z
...
.method private handleScreenTurnedOff()V
    ...
    iput-boolean v0, p0, mLockIconPressed:Z
...
.method private handleSimSubscriptionInfoChanged()V
    ...
    invoke-virtual {p0, v0}, getSubscriptionInfo(Z)Ljava/util/List;
    ...
    invoke-direct {p0, v5, v6}, refreshSimState(II)Z
    ...
    iget-object v3, p0, mSimDatas:Ljava/util/HashMap;
    ...
    :goto_3
    iget-object v5, p0, mCallbacks:Ljava/util/ArrayList;
...
.method private isFaceDisabled(I)Z
    ...
    :cond_0
    invoke-virtual {p0}, isSimPinSecure()Z
...
.method public static synthetic lambda$-GZaxeQabrHzh5b8rORPTQGQVD8(Lcom/android/keyguard/KeyguardUpdateMonitor;I)V
    ...
    invoke-direct {p0, p1}, notifyStrongAuthStateChanged(I)V
...
.method private notifyFaceRunningStateChanged()V
    ...
    invoke-virtual {p0}, isFaceDetectionRunning()Z
...
.method private notifyFingerprintRunningStateChanged()V
    ...
    invoke-virtual {p0}, isFingerprintDetectionRunning()Z
...
.method private refreshSimState(II)Z
    ...
    :goto_0
    iget-object v2, p0, mSimDatas:Ljava/util/HashMap;
    ...
    iget-object p0, p0, mSimDatas:Ljava/util/HashMap;
...
.method private resolveNeedsSlowUnlockTransition()Z
    ...
    sget-object v0, FALLBACK_HOME_COMPONENT:Landroid/content/ComponentName;
...
.method private setFaceRunningState(I)V
    ...
    iget v0, p0, mFaceRunningState:I
    ...
    :cond_1
    iput p1, p0, mFaceRunningState:I
    ...
    invoke-direct {p0}, notifyFaceRunningStateChanged()V
...
.method private setFingerprintRunningState(I)V
    ...
    iget v0, p0, mFingerprintRunningState:I
    ...
    iput p1, p0, mFingerprintRunningState:I

    if-eq v0, v1, :cond_2

    invoke-direct {p0}, notifyFingerprintRunningStateChanged()V
...
.method private shouldListenForFace()Z
    ...
    iget-boolean v4, p0, mBouncer:Z

    if-nez v4, :cond_1

    iget-boolean v4, p0, mAuthInterruptActive:Z

    if-nez v4, :cond_1

    if-nez v0, :cond_1

    invoke-direct {p0}, shouldListenForFaceAssistant()Z
    ...
    :cond_1
    iget-boolean v0, p0, mSwitchingUser:Z

    if-nez v0, :cond_2

    invoke-virtual {p0, v3}, getUserCanSkipBouncer(I)Z

    move-result v0

    if-nez v0, :cond_2

    invoke-direct {p0, v3}, isFaceDisabled(I)Z

    move-result v0

    if-nez v0, :cond_2

    iget-boolean v0, p0, mKeyguardGoingAway:Z

    if-nez v0, :cond_2

    iget-boolean v0, p0, mFaceSettingEnabledForUser:Z

    if-eqz v0, :cond_2

    iget-boolean v0, p0, mLockIconPressed:Z
    ...
    iget-boolean p0, p0, mIsPrimaryUser:Z
...
.method private shouldListenForFaceAssistant()Z
    ...
    iget-boolean v0, p0, mAssistantVisible:Z
    ...
    iget-object v0, p0, mUserFaceAuthenticated:Landroid/util/SparseBooleanArray;
    ...
    iget-object p0, p0, mUserHasTrust:Landroid/util/SparseBooleanArray;
...
.method private shouldListenForFingerprint()Z
    ...
    iget-boolean v0, p0, mIsDreaming:Z
    ...
    invoke-direct {p0, v0}, isFingerprintDisabled(I)Z
    ...
    :cond_2
    iget-boolean v0, p0, mIsPrimaryUser:Z
    ...
    iget-boolean v4, p0, mKeyguardIsVisible:Z
    ...
    iget-boolean v4, p0, mKeyguardGoingAway:Z
    ...
    iget-boolean v4, p0, mGoingToSleep:Z
    ...
    iget-boolean v4, p0, mKeyguardOccluded:Z
    ...
    iget-boolean v4, p0, mIsDreaming:Z
    ...
    iget-boolean v4, p0, mSwitchingUser:Z
    ...
    invoke-direct {p0, v4}, isFingerprintDisabled(I)Z
    ...
    iget-boolean v4, p0, mIsPrimaryUser:Z
...
.method private startListeningForFace()V
    ...
    iget v1, p0, mFaceRunningState:I
    ...
    invoke-virtual {p0, v7}, isUnlockWithFacePossible(I)Z

    move-result v0

    if-eqz v0, :cond_2

    iget-object v0, p0, mFaceCancelSignal:Landroid/os/CancellationSignal;
    ...
    iput-object v0, p0, mFaceCancelSignal:Landroid/os/CancellationSignal;

    iget-object v1, p0, mFaceManager:Landroid/hardware/face/FaceManager;

    const/4 v2, 0x0

    iget-object v3, p0, mFaceCancelSignal:Landroid/os/CancellationSignal;

    const/4 v4, 0x0

    iget-object v5, p0, mFaceAuthenticationCallback:Landroid/hardware/face/FaceManager$AuthenticationCallback;
...
.method private startListeningForFingerprint()V
    ...
    iget v1, p0, mFingerprintRunningState:I
    ...
    invoke-virtual {p0, v9}, isUnlockWithFingerprintPossible(I)Z

    move-result v0

    if-eqz v0, :cond_3

    iget-object v0, p0, mFingerprintCancelSignal:Landroid/os/CancellationSignal;
    ...
    iput-object v0, p0, mFingerprintCancelSignal:Landroid/os/CancellationSignal;

    iget-object v3, p0, mFpm:Landroid/hardware/fingerprint/FingerprintManager;

    const/4 v4, 0x0

    iget-object v5, p0, mFingerprintCancelSignal:Landroid/os/CancellationSignal;

    const/4 v6, 0x0

    iget-object v7, p0, mFingerprintAuthenticationCallback:Landroid/hardware/fingerprint/FingerprintManager$AuthenticationCallback;
    ...
    invoke-direct {p0, v0}, setFingerprintRunningState(I)V
...
.method private updateFaceListeningState()V
    ...
    iget-object v1, p0, mRetryFaceAuthentication:Ljava/lang/Runnable;

    invoke-virtual {v0, v1}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    invoke-direct {p0}, shouldListenForFace()Z
    ...
    invoke-direct {p0}, stopListeningForFace()V
    ...
    invoke-direct {p0}, startListeningForFace()V
...
.method private updateFingerprintListeningState()V
    ...
    invoke-direct {p0}, shouldListenForFingerprint()Z
    ...
    iget v4, p0, mFingerprintRunningState:I
    ...
    invoke-direct {p0}, stopListeningForFingerprint()V
    ...
    invoke-direct {p0}, startListeningForFingerprint()V
...
.method private updateLogoutEnabled()V
    ...
    iget-boolean v1, p0, mLogoutEnabled:Z

    if-eq v1, v0, :cond_1

    iput-boolean v0, p0, mLogoutEnabled:Z
...
.method private watchForDeviceProvisioning()V
    ...
    iget-object v1, p0, mHandler:Lcom/oneplus/keyguard/OpKeyguardUpdateMonitor$OpHandler;
    ...
    iget-object v2, p0, mDeviceProvisionedObserver:Landroid/database/ContentObserver;
    ...
    iget-boolean v1, p0, mDeviceProvisioned:Z
...
.method public clearBiometricRecognized()V
    ...
    iget-object v0, p0, mUserFingerprintAuthenticated:Landroid/util/SparseBooleanArray;
    ...
    iget-object p0, p0, mTrustManager:Landroid/app/trust/TrustManager;
...
.method public dispatchFinishedGoingToSleep(I)V
    ...
    :try_start_0
    iput-boolean v0, p0, mDeviceInteractive:Z
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v0, p0, mSimDatas:Ljava/util/HashMap;
    ...
    iget-object v0, p0, mSubscriptionInfo:Ljava/util/List;
    ...
    :goto_1
    iget-object v1, p0, mSubscriptionInfo:Ljava/util/List;
    ...
    iget-object v3, p0, mSubscriptionInfo:Ljava/util/List;
    ...
    iget-object v0, p0, mServiceStates:Ljava/util/HashMap;
    ...
    iget-object v4, p0, mServiceStates:Ljava/util/HashMap;
    ...
    iget-object v9, p0, mStrongAuthTracker:Lcom/android/keyguard/KeyguardUpdateMonitor$StrongAuthTracker;
    ...
    invoke-virtual {p0}, isUnlockingWithBiometricAllowed()Z
    ...
    iget-object v11, p0, mUserFingerprintAuthenticated:Landroid/util/SparseBooleanArray;
    ...
    invoke-virtual {p0}, getStrongAuthTracker()Lcom/android/keyguard/KeyguardUpdateMonitor$StrongAuthTracker;
    ...
    invoke-virtual {p0, v0}, isUnlockWithFingerprintPossible(I)Z
    ...
    iget v11, p0, mFingerprintRunningState:I
    ...
    invoke-virtual {p0, v0}, getUserTrustIsManaged(I)Z
    ...
    iget-object v6, p0, mUserFaceAuthenticated:Landroid/util/SparseBooleanArray;
    ...
    invoke-direct {p0, v0}, isFaceDisabled(I)Z
    ...
    invoke-virtual {p0, v0}, isUnlockWithFacePossible(I)Z
    ...
    iget-boolean v1, p0, mFaceSettingEnabledForUser:Z
    ...
    :cond_4
    iget-object v0, p0, mStrongAuthTracker:Lcom/android/keyguard/KeyguardUpdateMonitor$StrongAuthTracker;
    ...
    const-string v1, "    Tracker.isWeakFaceTimeout="

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v1, p0, mStrongAuthTracker:Lcom/android/keyguard/KeyguardUpdateMonitor$StrongAuthTracker;

    invoke-virtual {v1}, Lcom/android/keyguard/KeyguardUpdateMonitor$StrongAuthTracker;->isWeakFaceTimeout()Z
...
.method public getBiometricTimeoutStringWhenLock()I
    .locals 3
    ...
    :cond_0
    invoke-virtual {p0}, isWeakFaceTimeout()Z
    ...
    invoke-virtual {p0, v2}, isUnlockWithFingerprintPossible(I)Z
    ...
    sget v1, Lcom/android/keyguard/R$string;->op_kg_prompt_reason_face_timeout_swipe:I
    ...
    sget v1, Lcom/android/keyguard/R$string;->op_kg_prompt_reason_timeout_swipe:I
...
.method public getBiometricTimeoutStringWhenPrompt(Landroid/hardware/biometrics/BiometricSourceType;Lcom/android/keyguard/KeyguardSecurityModel$SecurityMode;)I
    ...
    invoke-virtual {p0, p1}, isUnlockWithFingerprintPossible(I)Z

    move-result p0

    if-eqz p0, :cond_4

    sget-object p0, Lcom/android/keyguard/KeyguardUpdateMonitor$15;->$SwitchMap$com$android$keyguard$KeyguardSecurityModel$SecurityMode:[I
    ...
    :cond_1
    sget v0, Lcom/android/keyguard/R$string;->op_kg_prompt_reason_face_timeout_bouncer_password:I

    goto :goto_0

    :cond_2
    sget v0, Lcom/android/keyguard/R$string;->op_kg_prompt_reason_face_timeout_bouncer_pin:I

    goto :goto_0

    :cond_3
    sget v0, Lcom/android/keyguard/R$string;->op_kg_prompt_reason_face_timeout_bouncer_pattern:I
    ...
    :cond_5
    sget v0, Lcom/android/keyguard/R$string;->op_kg_prompt_reason_face_timeout_password:I

    goto :goto_0

    :cond_6
    sget v0, Lcom/android/keyguard/R$string;->op_kg_prompt_reason_face_timeout_pin:I

    goto :goto_0

    :cond_7
    sget v0, Lcom/android/keyguard/R$string;->op_kg_prompt_reason_face_timeout_pattern:I
...
.method public getNextSubIdForState(Lcom/android/internal/telephony/IccCardConstants$State;)I
    ...
    invoke-virtual {p0, v4}, getSimState(I)Lcom/android/internal/telephony/IccCardConstants$State;
...
.method public getServiceState(I)Landroid/telephony/ServiceState;
    ...
    iget-object p0, p0, mServiceStates:Ljava/util/HashMap;
...
.method public getStrongAuthTracker()Lcom/android/keyguard/KeyguardUpdateMonitor$StrongAuthTracker;
    ...
    iget-object p0, p0, mStrongAuthTracker:Lcom/android/keyguard/KeyguardUpdateMonitor$StrongAuthTracker;
...
.method public getSubscriptionInfo(Z)Ljava/util/List;
    ...
    :cond_0
    iget-object p1, p0, mSubscriptionManager:Landroid/telephony/SubscriptionManager;
    ...
    iput-object p1, p0, mSubscriptionInfo:Ljava/util/List;

    goto :goto_0

    :cond_2
    iput-object v0, p0, mSubscriptionInfo:Ljava/util/List;

    :goto_0
    iget-object p0, p0, mSubscriptionInfo:Ljava/util/List;
...
.method public getUserCanSkipBouncer(I)Z
    ...
    invoke-virtual {p0, p1}, getUserHasTrust(I)Z

    move-result v0

    if-nez v0, :cond_1

    invoke-virtual {p0, p1}, getUserUnlockedWithBiometric(I)Z
...
.method handleServiceStateChange(ILandroid/telephony/ServiceState;)V
    ...
    invoke-virtual {p0, v0}, updateTelephonyCapable(Z)V
...
.method handleSimStateChange(IILcom/android/internal/telephony/IccCardConstants$State;)V
    ...
    invoke-virtual {p0, v3}, updateTelephonyCapable(Z)V
    ...
    :goto_2
    iget-object v4, p0, mSimDatas:Ljava/util/HashMap;
    ...
    iget-object v6, p0, mSimDatas:Ljava/util/HashMap;
...
.method protected handleStartedGoingToSleep(I)V
    ...
    invoke-virtual {p0}, clearBiometricRecognized()V
    ...
    iget-object v3, p0, mCallbacks:Ljava/util/ArrayList;
    ...
    iput-boolean p1, p0, mGoingToSleep:Z
...
.method public hasBootCompleted()Z
    ...
    iget-boolean p0, p0, mBootCompleted:Z
...
.method public hasLockscreenWallpaper()Z
    ...
    iget-boolean p0, p0, mHasLockscreenWallpaper:Z
...
.method public isDreaming()Z
    ...
    iget-boolean p0, p0, mIsDreaming:Z
...
.method public isFaceDetectionRunning()Z
    ...
    iget p0, p0, mFaceRunningState:I
...
.method public isGoingToSleep()Z
    ...
    iget-boolean p0, p0, mGoingToSleep:Z
...
.method public isKeyguardVisible()Z
    ...
    iget-boolean p0, p0, mKeyguardIsVisible:Z
...
.method public isLogoutEnabled()Z
    ...
    iget-boolean p0, p0, mLogoutEnabled:Z
...
.method public isOOS()Z
    ...
    iget-object v7, p0, mServiceStates:Ljava/util/HashMap;
...
.method public isSimPinSecure()Z
    ...
    invoke-virtual {p0, v2}, getSimState(I)Lcom/android/internal/telephony/IccCardConstants$State;

    move-result-object v2

    invoke-static {v2}, isSimPinSecure(Lcom/android/internal/telephony/IccCardConstants$State;)Z
...
.method public isSwitchingUser()Z
    ...
    iget-boolean p0, p0, mSwitchingUser:Z
...
.method public isUnlockWithFacePossible(I)Z
    ...
    invoke-direct {p0, p1}, isFaceDisabled(I)Z

    move-result v0

    if-nez v0, :cond_0

    iget-object p0, p0, mFaceManager:Landroid/hardware/face/FaceManager;
...
.method public isUnlockWithFingerprintPossible(I)Z
    ...
    invoke-direct {p0, p1}, isFingerprintDisabled(I)Z

    move-result v0

    if-nez v0, :cond_0

    iget-object p0, p0, mFpm:Landroid/hardware/fingerprint/FingerprintManager;
...
.method public isUnlockingWithBiometricsPossible(I)Z
    ...
    invoke-virtual {p0, p1}, isUnlockWithFacePossible(I)Z
...
.method public needsSlowUnlockTransition()Z
    ...
    iget-boolean p0, p0, mNeedsSlowUnlockTransition:Z
...
.method public onAuthInterruptDetected(Z)V
    ...
    iget-boolean v0, p0, mAuthInterruptActive:Z
    ...
    :cond_0
    iput-boolean p1, p0, mAuthInterruptActive:Z
...
.method protected onFaceAuthenticated(I)V
    ...
    invoke-virtual {p0, p1}, getUserCanSkipBouncer(I)Z
    ...
    :cond_2
    iget-object p1, p0, mHandler:Lcom/oneplus/keyguard/OpKeyguardUpdateMonitor$OpHandler;
    ...
    iput-boolean v0, p0, mAssistantVisible:Z
...
.method public onKeyguardVisibilityChanged(Z)V
    ...
    iput-boolean p1, p0, mKeyguardIsVisible:Z
...
.method public onTrustError(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {p0, p1}, dispatchErrorMessage(Ljava/lang/CharSequence;)V
...
.method public registerCallback(Lcom/android/keyguard/KeyguardUpdateMonitorCallback;)V
    ...
    invoke-virtual {p0, v0}, removeCallback(Lcom/android/keyguard/KeyguardUpdateMonitorCallback;)V

    invoke-direct {p0, p1}, sendUpdates(Lcom/android/keyguard/KeyguardUpdateMonitorCallback;)V
...
.method setAssistantVisible(Z)V
    ...
    iput-boolean p1, p0, mAssistantVisible:Z
...
.method public setHasLockscreenWallpaper(Z)V
    ...
    iget-boolean v0, p0, mHasLockscreenWallpaper:Z

    if-eq p1, v0, :cond_1

    iput-boolean p1, p0, mHasLockscreenWallpaper:Z
...
.method public setKeyguardGoingAway(Z)V
    ...
    iput-boolean p1, p0, mKeyguardGoingAway:Z
...
.method public setSwitchingUser(Z)V
    ...
    iput-boolean p1, p0, mSwitchingUser:Z

    iget-object p1, p0, mHandler:Lcom/oneplus/keyguard/OpKeyguardUpdateMonitor$OpHandler;

    iget-object p0, p0, mUpdateBiometricListeningState:Ljava/lang/Runnable;
...
.method updateTelephonyCapable(Z)V
    ...
    :cond_0
    iput-boolean p1, p0, mTelephonyCapable:Z
    ...
    iget-boolean v1, p0, mTelephonyCapable:Z
