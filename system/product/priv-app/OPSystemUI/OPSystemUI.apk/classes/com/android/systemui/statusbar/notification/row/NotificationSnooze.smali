...
.method static constructor <clinit>()V
    ...
    sput-object v0, OPTIONS_OPEN_LOG:Landroid/metrics/LogMaker;
    ...
    sput-object v0, OPTIONS_CLOSE_LOG:Landroid/metrics/LogMaker;
    ...
    sput-object v0, UNDO_LOG:Landroid/metrics/LogMaker;
    ...
    sput-object v0, sAccessibilityActions:[I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p1, p0, mMetricsLogger:Lcom/android/internal/logging/MetricsLogger;
    ...
    iput-object p1, p0, mParser:Landroid/util/KeyValueListParser;
...
.method static synthetic access$000(Lcom/android/systemui/statusbar/notification/row/NotificationSnooze;)Landroid/view/ViewGroup;
    ...
    iget-object p0, p0, mSnoozeOptionContainer:Landroid/view/ViewGroup;
...
.method private animateSnoozeOptions(Z)V
    ...
    :cond_0
    iget-object v0, p0, mDivider:Landroid/view/View;
    ...
    iget-object v1, p0, mSnoozeOptionContainer:Landroid/view/ViewGroup;
    ...
    iget-object v3, p0, mSnoozeOptionContainer:Landroid/view/ViewGroup;
    ...
    iput-object v3, p0, mExpandAnimation:Landroid/animation/AnimatorSet;

    iget-object v3, p0, mExpandAnimation:Landroid/animation/AnimatorSet;
...
.method private createOptionViews()V
    ...
    iget-object v0, p0, mSnoozeOptionContainer:Landroid/view/ViewGroup;
    ...
    :goto_0
    iget-object v3, p0, mSnoozeOptions:Ljava/util/List;
    ...
    iget-object v5, p0, mSnoozeOptionContainer:Landroid/view/ViewGroup;
...
.method private hideSelectedOption()V
    ...
    iget-object v5, p0, mSelectedOption:Lcom/android/systemui/plugins/statusbar/NotificationSwipeActionHelper$SnoozeOption;
...
.method private logOptionSelection(ILcom/android/systemui/plugins/statusbar/NotificationSwipeActionHelper$SnoozeOption;)V
    ...
    iget-object v0, p0, mSnoozeOptions:Ljava/util/List;
...
.method private setSelected(Lcom/android/systemui/plugins/statusbar/NotificationSwipeActionHelper$SnoozeOption;Z)V
    ...
    iput-object p1, p0, mSelectedOption:Lcom/android/systemui/plugins/statusbar/NotificationSwipeActionHelper$SnoozeOption;

    iget-object v0, p0, mSelectedOptionText:Landroid/widget/TextView;
    ...
    invoke-direct {p0, v0}, showSnoozeOptions(Z)V

    invoke-direct {p0}, hideSelectedOption()V
    ...
    invoke-direct {p0, p2, p1}, logOptionSelection(ILcom/android/systemui/plugins/statusbar/NotificationSwipeActionHelper$SnoozeOption;)V
...
.method private showSnoozeOptions(Z)V
    ...
    :goto_0
    iget-object v1, p0, mExpandButton:Landroid/widget/ImageView;
    ...
    invoke-direct {p0, p1}, animateSnoozeOptions(Z)V
...
.method private undoSnooze(Landroid/view/View;)V
    ...
    iput-object v0, p0, mSelectedOption:Lcom/android/systemui/plugins/statusbar/NotificationSwipeActionHelper$SnoozeOption;
...
.method public getContentView()Landroid/view/View;
    ...
    iget-object v0, p0, mDefaultOption:Lcom/android/systemui/plugins/statusbar/NotificationSwipeActionHelper$SnoozeOption;

    const/4 v1, 0x0

    invoke-direct {p0, v0, v1}, setSelected(Lcom/android/systemui/plugins/statusbar/NotificationSwipeActionHelper$SnoozeOption;Z)V
...
.method getDefaultOption()Lcom/android/systemui/plugins/statusbar/NotificationSwipeActionHelper$SnoozeOption;
    ...
    iget-object p0, p0, mDefaultOption:Lcom/android/systemui/plugins/statusbar/NotificationSwipeActionHelper$SnoozeOption;
...
.method getDefaultSnoozeOptions()Ljava/util/ArrayList;
    ...
    sget-object v4, sAccessibilityActions:[I
    ...
    invoke-direct {p0, v5, v4}, createOption(II)Lcom/android/systemui/plugins/statusbar/NotificationSwipeActionHelper$SnoozeOption;
    ...
    :cond_0
    iput-object v4, p0, mDefaultOption:Lcom/android/systemui/plugins/statusbar/NotificationSwipeActionHelper$SnoozeOption;
...
.method public handleCloseControls(ZZ)Z
    ...
    invoke-direct {p0, v1}, showSnoozeOptions(Z)V

    return v0

    :cond_0
    iget-object p1, p0, mSnoozeListener:Lcom/android/systemui/plugins/statusbar/NotificationSwipeActionHelper;

    if-eqz p1, :cond_1

    iget-object p2, p0, mSelectedOption:Lcom/android/systemui/plugins/statusbar/NotificationSwipeActionHelper$SnoozeOption;

    if-eqz p2, :cond_1

    iput-boolean v0, p0, mSnoozing:Z
    ...
    :cond_1
    iget-object p1, p0, mSnoozeOptions:Ljava/util/List;
    ...
    invoke-direct {p0, p1, v1}, setSelected(Lcom/android/systemui/plugins/statusbar/NotificationSwipeActionHelper$SnoozeOption;Z)V
...
.method protected onAttachedToWindow()V
    ...
    invoke-direct {p0, v1, v0}, logOptionSelection(ILcom/android/systemui/plugins/statusbar/NotificationSwipeActionHelper$SnoozeOption;)V
...
.method public onClick(Landroid/view/View;)V
    ...
    invoke-direct {p0, v1, v2}, setSelected(Lcom/android/systemui/plugins/statusbar/NotificationSwipeActionHelper$SnoozeOption;Z)V
    ...
    invoke-direct {p0, p1}, showSnoozeOptions(Z)V
    ...
    sget-object p0, OPTIONS_OPEN_LOG:Landroid/metrics/LogMaker;

    goto :goto_0

    :cond_2
    sget-object p0, OPTIONS_CLOSE_LOG:Landroid/metrics/LogMaker;
    ...
    :cond_3
    invoke-direct {p0, p1}, undoSnooze(Landroid/view/View;)V

    iget-object p0, p0, mMetricsLogger:Lcom/android/internal/logging/MetricsLogger;

    sget-object p1, UNDO_LOG:Landroid/metrics/LogMaker;
...
.method protected onFinishInflate()V
    ...
    iput-object v0, p0, mSelectedOptionText:Landroid/widget/TextView;
    ...
    iput-object v0, p0, mUndoButton:Landroid/widget/TextView;

    iget-object v0, p0, mUndoButton:Landroid/widget/TextView;
    ...
    iput-object v0, p0, mExpandButton:Landroid/widget/ImageView;
    ...
    iput-object v0, p0, mSnoozeOptionContainer:Landroid/view/ViewGroup;
    ...
    invoke-virtual {p0}, getDefaultSnoozeOptions()Ljava/util/ArrayList;

    move-result-object v0

    iput-object v0, p0, mSnoozeOptions:Ljava/util/List;

    invoke-direct {p0}, createOptionViews()V
...
.method public onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    iget-object p0, p0, mSelectedOptionText:Landroid/widget/TextView;
...
.method public onInitializeAccessibilityNodeInfo(Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    iget-object v2, p0, mSnoozeOptions:Ljava/util/List;
...
.method public performAccessibilityActionInternal(ILandroid/os/Bundle;)Z
    ...
    iget-object p1, p0, mUndoButton:Landroid/widget/TextView;
    ...
    invoke-direct {p0, v2, v0}, setSelected(Lcom/android/systemui/plugins/statusbar/NotificationSwipeActionHelper$SnoozeOption;Z)V
...
.method public setSnoozeListener(Lcom/android/systemui/plugins/statusbar/NotificationSwipeActionHelper;)V
    ...
    iput-object p1, p0, mSnoozeListener:Lcom/android/systemui/plugins/statusbar/NotificationSwipeActionHelper;
...
.method public setStatusBarNotification(Landroid/service/notification/StatusBarNotification;)V
    ...
    iput-object p1, p0, mSbn:Landroid/service/notification/StatusBarNotification;
...
.method public willBeRemoved()Z
    ...
    iget-boolean p0, p0, mSnoozing:Z
