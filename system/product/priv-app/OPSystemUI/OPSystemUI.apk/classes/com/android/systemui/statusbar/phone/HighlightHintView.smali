...
.field private static TAG:Ljava/lang/String; = "HighlightHintView"
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-boolean p2, p0, mShowBreathingEffect:Z

    iput-boolean p2, p0, mShowHighlightHint:Z

    iput p2, p0, mContentWidth:I
...
.method static synthetic access$100(Lcom/android/systemui/statusbar/phone/HighlightHintView;)Z
    ...
    iget-boolean p0, p0, mShowHighlightHint:Z
...
.method private playBreathingAnimation(II)V
    ...
    const-string v2, "playBreathingAnimation, Start with color["

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v1, p1}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v2, "] to color["
    ...
    :cond_0
    iget-object v0, p0, breathingAnimatorSet:Landroid/animation/AnimatorSet;
    ...
    iput-object v0, p0, breathingAnimatorSet:Landroid/animation/AnimatorSet;
    ...
    iget-object p2, p0, breathingAnimatorSet:Landroid/animation/AnimatorSet;
    ...
    iget-object p1, p0, breathingAnimatorSet:Landroid/animation/AnimatorSet;
    ...
    iget-object p0, p0, breathingAnimatorSet:Landroid/animation/AnimatorSet;
...
.method private updateHint()V
    ...
    iput-boolean v2, p0, mShowBreathingEffect:Z
    ...
    iget-boolean v4, p0, mShowBreathingEffect:Z

    if-eqz v4, :cond_2

    invoke-direct {p0, v2, v3}, playBreathingAnimation(II)V
    ...
    iput v2, p0, mBackgroundColor:I

    iget-object v2, p0, mBackgroundDrawable:Landroid/graphics/drawable/Drawable;

    if-eqz v2, :cond_3

    iget-object v2, p0, mBackgroundDrawable:Landroid/graphics/drawable/Drawable;

    iget v3, p0, mBackgroundColor:I
    ...
    iget-object v7, p0, mHint:Landroid/widget/TextView;
    ...
    iget-object v2, p0, mHint:Landroid/widget/TextView;

    invoke-virtual {v2, v4}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    invoke-direct {p0}, getMaxHighlightHintTextWidth()I

    move-result v2

    if-lez v2, :cond_5

    iget-object v4, p0, mHint:Landroid/widget/TextView;
    ...
    :cond_7
    :goto_2
    iget-object v2, p0, mChronometerContainer:Landroid/widget/FrameLayout;
    ...
    iget-object v1, p0, mChronometerContainer:Landroid/widget/FrameLayout;
    ...
    :cond_a
    iget-object p0, p0, mChronometerContainer:Landroid/widget/FrameLayout;
...
.method protected onFinishInflate()V
    ...
    iput-object v0, p0, mHint:Landroid/widget/TextView;
    ...
    iput-object v0, p0, mChronometerContainer:Landroid/widget/FrameLayout;
...
.method public onHighlightHintStateChange()V
    ...
    iput-boolean v0, p0, mShowHighlightHint:Z

    iget-boolean v0, p0, mShowHighlightHint:Z
