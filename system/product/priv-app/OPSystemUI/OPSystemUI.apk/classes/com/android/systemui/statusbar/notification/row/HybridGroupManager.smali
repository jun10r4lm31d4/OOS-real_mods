...
.method public constructor <init>(Landroid/content/Context;Landroid/view/ViewGroup;)V
    ...
    iput-object p2, p0, mParent:Landroid/view/ViewGroup;

    invoke-virtual {p0}, initDimens()V
...
.method private bindFromNotificationWithStyle(Lcom/android/systemui/statusbar/notification/row/HybridNotificationView;Landroid/app/Notification;I)Lcom/android/systemui/statusbar/notification/row/HybridNotificationView;
    ...
    invoke-direct {p0, p3}, inflateHybridViewWithStyle(I)Lcom/android/systemui/statusbar/notification/row/HybridNotificationView;

    move-result-object p1

    :cond_0
    invoke-direct {p0, p2}, resolveTitle(Landroid/app/Notification;)Ljava/lang/CharSequence;

    move-result-object p3

    invoke-direct {p0, p2}, resolveText(Landroid/app/Notification;)Ljava/lang/CharSequence;
...
.method private inflateOverflowNumber()Landroid/widget/TextView;
    ...
    iget-object v2, p0, mParent:Landroid/view/ViewGroup;
    ...
    invoke-direct {p0, v0}, updateOverFlowNumberColor(Landroid/widget/TextView;)V
...
.method private updateOverFlowNumberColor(Landroid/widget/TextView;)V
    ...
    iget p0, p0, mOverflowNumberColor:I
...
.method public bindFromNotification(Lcom/android/systemui/statusbar/notification/row/HybridNotificationView;Landroid/app/Notification;)Lcom/android/systemui/statusbar/notification/row/HybridNotificationView;
    ...
    invoke-direct {p0, p1, p2, v0}, bindFromNotificationWithStyle(Lcom/android/systemui/statusbar/notification/row/HybridNotificationView;Landroid/app/Notification;I)Lcom/android/systemui/statusbar/notification/row/HybridNotificationView;
...
.method public bindOverflowNumber(Landroid/widget/TextView;I)Landroid/widget/TextView;
    ...
    invoke-direct {p0}, inflateOverflowNumber()Landroid/widget/TextView;
    ...
    iget p2, p0, mOverflowNumberSize:F
    ...
    iget v1, p0, mOverflowNumberPadding:I
    ...
    invoke-direct {p0, p1}, updateOverFlowNumberColor(Landroid/widget/TextView;)V
...
.method public initDimens()V
    ...
    iput v1, p0, mOverflowNumberSize:F
    ...
    iput v0, p0, mOverflowNumberPadding:I
...
.method public setOverflowNumberColor(Landroid/widget/TextView;I)V
    ...
    iput p2, p0, mOverflowNumberColor:I
