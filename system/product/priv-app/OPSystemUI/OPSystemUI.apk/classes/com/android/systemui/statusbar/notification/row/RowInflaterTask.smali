...
.method public inflate(Landroid/content/Context;Landroid/view/ViewGroup;Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;Lcom/android/systemui/statusbar/notification/row/RowInflaterTask$RowInflationFinishedListener;)V
    ...
    iput-object v0, p0, mInflateOrigin:Ljava/lang/Throwable;

    iput-object p4, p0, mListener:Lcom/android/systemui/statusbar/notification/row/RowInflaterTask$RowInflationFinishedListener;
    ...
    iput-object p3, p0, mEntry:Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;
...
.method public onInflateFinished(Landroid/view/View;ILandroid/view/ViewGroup;)V
    ...
    iget-boolean p2, p0, mCancelled:Z

    if-nez p2, :cond_1

    :try_start_0
    iget-object p2, p0, mEntry:Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;

    invoke-virtual {p2}, Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;->onInflationTaskFinished()V

    iget-object p2, p0, mListener:Lcom/android/systemui/statusbar/notification/row/RowInflaterTask$RowInflationFinishedListener;
    ...
    iget-object p2, p0, mInflateOrigin:Ljava/lang/Throwable;
    ...
    iget-object p3, p0, mInflateOrigin:Ljava/lang/Throwable;

    const-string v0, "RowInflaterTask"

    invoke-static {v0, p2, p3}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I

    iget-object p0, p0, mInflateOrigin:Ljava/lang/Throwable;
