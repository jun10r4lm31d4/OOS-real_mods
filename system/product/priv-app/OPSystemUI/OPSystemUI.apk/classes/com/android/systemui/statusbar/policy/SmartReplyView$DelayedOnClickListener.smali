...
.method constructor <init>(Landroid/view/View$OnClickListener;J)V
    ...
    iput-object p1, p0, mActualListener:Landroid/view/View$OnClickListener;

    iput-wide p2, p0, mInitDelayMs:J

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J

    move-result-wide p1

    iput-wide p1, p0, mInitTimeMs:J
...
.method private hasFinishedInitialization()Z
    ...
    iget-wide v2, p0, mInitTimeMs:J

    iget-wide v4, p0, mInitDelayMs:J
...
.method public onClick(Landroid/view/View;)V
    ...
    invoke-direct {p0}, hasFinishedInitialization()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object p0, p0, mActualListener:Landroid/view/View$OnClickListener;
    ...
    iget-wide v0, p0, mInitDelayMs:J
