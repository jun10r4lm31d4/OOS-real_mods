...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mListeners:Ljava/util/HashSet;
    ...
    iput-object v0, p0, mAccessibilityMgr:Lcom/android/systemui/statusbar/policy/AccessibilityManagerWrapper;
    ...
    iput v1, p0, mTouchAcceptanceDelay:I

    new-instance v1, Landroid/util/ArrayMap;

    invoke-direct {v1}, Landroid/util/ArrayMap;-><init>()V

    iput-object v1, p0, mSnoozedPackages:Landroid/util/ArrayMap;
...
.method private hasPinnedNotificationInternal()Z
    ...
    invoke-virtual {p0, v1}, getHeadsUpEntry(Ljava/lang/String;)Lcom/android/systemui/statusbar/policy/HeadsUpManager$HeadsUpEntry;
...
.method public addListener(Lcom/android/systemui/statusbar/policy/OnHeadsUpChangedListener;)V
    ...
    iget-object p0, p0, mListeners:Ljava/util/HashSet;
...
.method public compare(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)I
    ...
    invoke-virtual {p0, p1}, getHeadsUpEntry(Ljava/lang/String;)Lcom/android/systemui/statusbar/policy/HeadsUpManager$HeadsUpEntry;

    move-result-object p1

    iget-object p2, p2, Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;->key:Ljava/lang/String;

    invoke-virtual {p0, p2}, getHeadsUpEntry(Ljava/lang/String;)Lcom/android/systemui/statusbar/policy/HeadsUpManager$HeadsUpEntry;
...
.method protected dumpInternal(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget p1, p0, mTouchAcceptanceDelay:I
    ...
    :cond_0
    iget-object p1, p0, mSnoozedPackages:Landroid/util/ArrayMap;
    ...
    iget-object v0, p0, mSnoozedPackages:Landroid/util/ArrayMap;
...
.method public getTopEntry()Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;
    ...
    invoke-virtual {p0}, getTopHeadsUpEntry()Lcom/android/systemui/statusbar/policy/HeadsUpManager$HeadsUpEntry;
...
.method public hasPinnedHeadsUp()Z
    ...
    iget-boolean p0, p0, mHasPinnedNotification:Z
...
.method public isSnoozed(Ljava/lang/String;)Z
    ...
    invoke-static {p1, v0}, snoozeKey(Ljava/lang/String;I)Ljava/lang/String;

    move-result-object v0

    iget-object v1, p0, mSnoozedPackages:Landroid/util/ArrayMap;
    ...
    :cond_1
    iget-object p0, p0, mSnoozedPackages:Landroid/util/ArrayMap;
...
.method protected onAlertEntryAdded(Lcom/android/systemui/statusbar/AlertingNotificationManager$AlertEntry;)V
    ...
    invoke-virtual {p0, v0}, shouldHeadsUpBecomePinned(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)Z

    move-result v2

    invoke-virtual {p0, p1, v2}, setEntryPinned(Lcom/android/systemui/statusbar/policy/HeadsUpManager$HeadsUpEntry;Z)V
...
.method protected onAlertEntryRemoved(Lcom/android/systemui/statusbar/AlertingNotificationManager$AlertEntry;)V
    ...
    invoke-virtual {p0, p1, v1}, setEntryPinned(Lcom/android/systemui/statusbar/policy/HeadsUpManager$HeadsUpEntry;Z)V
...
.method protected setEntryPinned(Lcom/android/systemui/statusbar/policy/HeadsUpManager$HeadsUpEntry;Z)V
    ...
    invoke-virtual {p0}, updatePinnedMode()V
...
.method public setExpanded(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;Z)V
    ...
    invoke-virtual {p0, v0}, getHeadsUpEntry(Ljava/lang/String;)Lcom/android/systemui/statusbar/policy/HeadsUpManager$HeadsUpEntry;
...
.method protected shouldHeadsUpBecomePinned(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)Z
    ...
    invoke-virtual {p0, p1}, hasFullScreenIntent(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)Z
...
.method public snooze()V
    ...
    iget-object v3, p0, mSnoozedPackages:Landroid/util/ArrayMap;

    iget v4, p0, mUser:I

    invoke-static {v2, v4}, snoozeKey(Ljava/lang/String;I)Ljava/lang/String;
...
.method public unpinAll(Z)V
    ...
    invoke-virtual {p0, v1, v2}, setEntryPinned(Lcom/android/systemui/statusbar/policy/HeadsUpManager$HeadsUpEntry;Z)V
...
.method public updateNotification(Ljava/lang/String;Z)V
    ...
    invoke-virtual {p0, p2}, shouldHeadsUpBecomePinned(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)Z

    move-result p2

    invoke-virtual {p0, p1, p2}, setEntryPinned(Lcom/android/systemui/statusbar/policy/HeadsUpManager$HeadsUpEntry;Z)V
...
.method protected updatePinnedMode()V
    ...
    invoke-direct {p0}, hasPinnedNotificationInternal()Z

    move-result v0

    iget-boolean v1, p0, mHasPinnedNotification:Z
    ...
    iget-boolean v3, p0, mHasPinnedNotification:Z
    ...
    :cond_1
    iput-boolean v0, p0, mHasPinnedNotification:Z
