...
.method private updateChildOrdering()V
    ...
    invoke-virtual {p0}, shouldReverseListItems()Z
...
.method protected getAnimationDistance()F
    ...
    invoke-virtual {p0}, getGridItemSize()F
...
.method public getAnimationOffsetX()F
    ...
    invoke-virtual {p0}, getAnimationDistance()F
...
.method public synthetic lambda$onLayout$0$GlobalActionsColumnLayout()V
    ...
    invoke-virtual {p0}, updateSnap()V
...
.method public onUpdateList()V
    ...
    invoke-direct {p0}, updateChildOrdering()V
...
.method protected shouldSnapToPowerButton()Z
    ...
    invoke-virtual {p0}, getPowerButtonOffsetDistance()I
...
.method protected updateSnap()V
    ...
    invoke-virtual {p0}, shouldSnapToPowerButton()Z

    move-result v0

    iget-boolean v1, p0, mLastSnap:Z

    if-eq v0, v1, :cond_1

    if-eqz v0, :cond_0

    invoke-virtual {p0}, snapToPowerButton()V

    goto :goto_0

    :cond_0
    invoke-virtual {p0}, centerAlongEdge()V

    :cond_1
    :goto_0
    iput-boolean v0, p0, mLastSnap:Z
