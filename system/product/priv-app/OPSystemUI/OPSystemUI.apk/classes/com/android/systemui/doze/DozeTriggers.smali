...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, sWakeDisplaySensorState:Z
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/doze/DozeMachine;Lcom/android/systemui/doze/DozeHost;Landroid/app/AlarmManager;Landroid/hardware/display/AmbientDisplayConfiguration;Lcom/android/systemui/statusbar/phone/DozeParameters;Landroid/hardware/SensorManager;Landroid/os/Handler;Lcom/android/systemui/util/wakelock/WakeLock;ZLcom/android/systemui/dock/DockManager;)V
    ...
    iput-object v1, v0, mBroadcastReceiver:Lcom/android/systemui/doze/DozeTriggers$TriggerReceiver;
    ...
    iput-object v1, v0, mDockEventListener:Lcom/android/systemui/doze/DozeTriggers$DockEventListener;
    ...
    iput-object v1, v0, mHostCallback:Lcom/android/systemui/doze/DozeHost$Callback;
    ...
    iput-object v2, v0, mMachine:Lcom/android/systemui/doze/DozeMachine;

    move-object/from16 v2, p3

    iput-object v2, v0, mDozeHost:Lcom/android/systemui/doze/DozeHost;

    move-object/from16 v7, p5

    iput-object v7, v0, mConfig:Landroid/hardware/display/AmbientDisplayConfiguration;

    move-object/from16 v6, p6

    iput-object v6, v0, mDozeParameters:Lcom/android/systemui/statusbar/phone/DozeParameters;

    move-object/from16 v2, p7

    iput-object v2, v0, mSensorManager:Landroid/hardware/SensorManager;
    ...
    iput-object v8, v0, mWakeLock:Lcom/android/systemui/util/wakelock/WakeLock;

    move/from16 v2, p10

    iput-boolean v2, v0, mAllowPulseTriggers:Z

    new-instance v12, Lcom/android/systemui/doze/DozeSensors;

    iget-object v5, v0, mSensorManager:Landroid/hardware/SensorManager;
    ...
    iput-object v12, v0, mDozeSensors:Lcom/android/systemui/doze/DozeSensors;
    ...
    iput-object v1, v0, mUiModeManager:Landroid/app/UiModeManager;

    move-object/from16 v1, p11

    iput-object v1, v0, mDockManager:Lcom/android/systemui/dock/DockManager;
    ...
    iput-object v1, v0, mAodDisplayViewManager:Lcom/oneplus/aod/OpAodDisplayViewManager;
...
.method static synthetic access$1100(Lcom/android/systemui/doze/DozeTriggers;)V
    ...
    invoke-direct {p0}, onNotification()V
...
.method static synthetic access$500(Lcom/android/systemui/doze/DozeTriggers;)Lcom/android/systemui/doze/DozeSensors;
    ...
    iget-object p0, p0, mDozeSensors:Lcom/android/systemui/doze/DozeSensors;
...
.method static synthetic access$700(Lcom/android/systemui/doze/DozeTriggers;)Lcom/android/systemui/util/wakelock/WakeLock;
    ...
    iget-object p0, p0, mWakeLock:Lcom/android/systemui/util/wakelock/WakeLock;
...
.method static synthetic access$800(Lcom/android/systemui/doze/DozeTriggers;IZ)V
    ...
    invoke-direct {p0, p1, p2}, requestPulse(IZ)V
...
.method static synthetic access$900(Lcom/android/systemui/doze/DozeTriggers;)Lcom/android/systemui/doze/DozeMachine;
    ...
    iget-object p0, p0, mMachine:Lcom/android/systemui/doze/DozeMachine;
...
.method private checkTriggersAtInit()V
    ...
    iget-object v0, p0, mDozeHost:Lcom/android/systemui/doze/DozeHost;
...
.method private continuePulseRequest(I)V
    ...
    iput-boolean v0, p0, mPulsePending:Z
    ...
    iget-object v1, p0, mMachine:Lcom/android/systemui/doze/DozeMachine;
    ...
    iget-object v0, p0, mMachine:Lcom/android/systemui/doze/DozeMachine;
    ...
    iget-boolean v0, p0, mPulsePending:Z
    ...
    iget-object p0, p0, mDozeHost:Lcom/android/systemui/doze/DozeHost;
...
.method private gentleWakeUp(I)V
    ...
    iget-object p1, p0, mDozeHost:Lcom/android/systemui/doze/DozeHost;
...
.method public static synthetic lambda$ulqUMEXi8OgK7771oZ9BOr21BBk(Lcom/android/systemui/doze/DozeTriggers;Z)V
    ...
    invoke-direct {p0, p1}, onProximityFar(Z)V
...
.method private onNotification()V
    ...
    iput-wide v0, p0, mNotificationPulseTime:J
    ...
    invoke-direct {p0, v0, v1}, requestPulse(IZ)V
...
.method private onProximityFar(Z)V
    ...
    iget-object v2, p0, mMachine:Lcom/android/systemui/doze/DozeMachine;
    ...
    :cond_5
    iget-object v2, p0, mDozeHost:Lcom/android/systemui/doze/DozeHost;
...
.method private onWakeScreen(ZLcom/android/systemui/doze/DozeMachine$State;)V
    ...
    sput-boolean p1, sWakeDisplaySensorState:Z
    ...
    invoke-direct {p0, p1, v1, v0}, proximityCheckThenCall(Ljava/util/function/IntConsumer;ZI)V
    ...
    iget-object p1, p0, mMachine:Lcom/android/systemui/doze/DozeMachine;
...
.method private proximityCheckThenCall(Ljava/util/function/IntConsumer;ZI)V
    ...
    iget-object v0, p0, mDozeSensors:Lcom/android/systemui/doze/DozeSensors;
    ...
    iget-object p2, p0, mDozeSensors:Lcom/android/systemui/doze/DozeSensors;
...
.method private requestPulse(IZ)V
    ...
    iget-boolean v0, p0, mAllowPulseTriggers:Z
    ...
    iget-object v2, p0, mDozeParameters:Lcom/android/systemui/statusbar/phone/DozeParameters;
    ...
    :cond_4
    :goto_0
    invoke-direct {p0, v1, v0, p1}, proximityCheckThenCall(Ljava/util/function/IntConsumer;ZI)V
    ...
    :cond_5
    :goto_1
    iget-boolean p1, p0, mAllowPulseTriggers:Z

    if-eqz p1, :cond_6

    iget-object p1, p0, mContext:Landroid/content/Context;

    iget-boolean p2, p0, mPulsePending:Z
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    iget-wide v1, p0, mNotificationPulseTime:J
...
.method public synthetic lambda$onSensor$0$DozeTriggers(ZZFFIZZI)V
    ...
    invoke-direct {p0, p5, p7}, requestPulse(IZ)V
    ...
    :cond_4
    invoke-direct {p0, p5}, gentleWakeUp(I)V
...
.method public synthetic lambda$requestPulse$2$DozeTriggers(II)V
    ...
    iput-boolean p1, p0, mPulsePending:Z

    goto :goto_0

    :cond_0
    invoke-direct {p0, p1}, continuePulseRequest(I)V
...
.method onSensor(IZFF[F)V
    ...
    iget-object v0, v9, mDozeHost:Lcom/android/systemui/doze/DozeHost;
    ...
    iget-object v1, v9, mMachine:Lcom/android/systemui/doze/DozeMachine;
    ...
    :goto_8
    invoke-direct {p0, v0, v1}, onWakeScreen(ZLcom/android/systemui/doze/DozeMachine$State;)V
    ...
    invoke-direct/range {p0 .. p2}, requestPulse(IZ)V
    ...
    iget-object v0, v9, mDockManager:Lcom/android/systemui/dock/DockManager;
    ...
    :goto_a
    invoke-direct {p0, v14, v0, v10}, proximityCheckThenCall(Ljava/util/function/IntConsumer;ZI)V
    ...
    iget-wide v2, v9, mNotificationPulseTime:J

    sub-long/2addr v0, v2

    iget-object v2, v9, mDozeParameters:Lcom/android/systemui/statusbar/phone/DozeParameters;
...
.method public transitionTo(Lcom/android/systemui/doze/DozeMachine$State;Lcom/android/systemui/doze/DozeMachine$State;)V
    ...
    :pswitch_0
    iget-object p1, p0, mBroadcastReceiver:Lcom/android/systemui/doze/DozeTriggers$TriggerReceiver;
    ...
    iget-object p2, p0, mHostCallback:Lcom/android/systemui/doze/DozeHost$Callback;

    invoke-interface {p1, p2}, Lcom/android/systemui/doze/DozeHost;->removeCallback(Lcom/android/systemui/doze/DozeHost$Callback;)V

    iget-object p1, p0, mDozeSensors:Lcom/android/systemui/doze/DozeSensors;
    ...
    iget-object p2, p0, mDockEventListener:Lcom/android/systemui/doze/DozeTriggers$DockEventListener;
    ...
    sget-boolean p1, sWakeDisplaySensorState:Z

    if-nez p1, :cond_4

    invoke-direct {p0, v1, p2}, onWakeScreen(ZLcom/android/systemui/doze/DozeMachine$State;)V
    ...
    invoke-direct {p0}, checkTriggersAtInit()V
