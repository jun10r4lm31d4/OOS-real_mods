...
.method constructor <init>(Landroid/content/Context;)V
    ...
    sget-object v1, DEFAULT_HOME_CHANGE_ACTIONS:[Ljava/lang/String;
    ...
    invoke-direct {p0, v0}, isLauncherShowing(Landroid/app/ActivityManager$RunningTaskInfo;)Z

    move-result v0

    iput-boolean v0, p0, mLauncherShowing:Z
...
.method static synthetic access$202(Lcom/android/systemui/assist/PhoneStateMonitor;Z)Z
    ...
    iput-boolean p1, p0, mLauncherShowing:Z
...
.method static synthetic access$300(Lcom/android/systemui/assist/PhoneStateMonitor;Landroid/app/ActivityManager$RunningTaskInfo;)Z
    ...
    invoke-direct {p0, p1}, isLauncherShowing(Landroid/app/ActivityManager$RunningTaskInfo;)Z
...
.method private getPhoneAppState()I
    ...
    invoke-direct {p0}, isAppImmersive()Z
    ...
    :cond_0
    invoke-direct {p0}, isAppFullscreen()Z
...
.method private getPhoneLauncherState()I
    ...
    invoke-direct {p0}, isLauncherInOverview()Z
    ...
    :cond_0
    invoke-direct {p0}, isLauncherInAllApps()Z
...
.method private getPhoneLockscreenState()I
    ...
    :cond_0
    invoke-direct {p0}, isBouncerShowing()Z
...
.method private isLauncherShowing(Landroid/app/ActivityManager$RunningTaskInfo;)Z
    ...
    iget-object p0, p0, mDefaultHome:Landroid/content/ComponentName;
...
.method getPhoneState()I
    ...
    invoke-direct {p0}, isShadeFullscreen()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-direct {p0}, getPhoneLockscreenState()I
    ...
    :cond_0
    iget-boolean v0, p0, mLauncherShowing:Z

    if-eqz v0, :cond_1

    invoke-direct {p0}, getPhoneLauncherState()I
    ...
    :cond_1
    invoke-direct {p0}, getPhoneAppState()I
