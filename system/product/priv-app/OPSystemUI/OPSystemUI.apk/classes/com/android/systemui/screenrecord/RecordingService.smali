...
.method private createRecordingNotification()V
    ...
    iput-object v0, p0, mRecordingNotificationBuilder:Landroid/app/Notification$Builder;

    const/4 v0, 0x0

    invoke-direct {p0, v0, v3}, setNotificationActions(ZLandroid/app/NotificationManager;)V

    iget-object v0, p0, mRecordingNotificationBuilder:Landroid/app/Notification$Builder;
...
.method private createSaveNotification(Ljava/nio/file/Path;)Landroid/app/Notification;
    ...
    invoke-static {p0, v4}, getShareIntent(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {p0, v7}, getDeleteIntent(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;
...
.method private setNotificationActions(ZLandroid/app/NotificationManager;)V
    ...
    invoke-static {p0}, getResumeIntent(Landroid/content/Context;)Landroid/content/Intent;
    ...
    :cond_1
    invoke-static {p0}, getPauseIntent(Landroid/content/Context;)Landroid/content/Intent;

    move-result-object p1

    :goto_1
    iget-object v1, p0, mRecordingNotificationBuilder:Landroid/app/Notification$Builder;
    ...
    invoke-static {p0}, getStopIntent(Landroid/content/Context;)Landroid/content/Intent;
    ...
    invoke-static {p0}, getCancelIntent(Landroid/content/Context;)Landroid/content/Intent;
    ...
    iget-object p0, p0, mRecordingNotificationBuilder:Landroid/app/Notification$Builder;
...
.method private startRecording()V
    ...
    iput-object v0, p0, mTempFile:Ljava/io/File;
    ...
    iget-object v2, p0, mTempFile:Ljava/io/File;
    ...
    iget-boolean v0, p0, mShowTaps:Z

    invoke-direct {p0, v0}, setTapsVisible(Z)V

    new-instance v0, Landroid/media/MediaRecorder;

    invoke-direct {v0}, Landroid/media/MediaRecorder;-><init>()V

    iput-object v0, p0, mMediaRecorder:Landroid/media/MediaRecorder;

    iget-boolean v0, p0, mUseAudio:Z
    ...
    iget-object v3, p0, mMediaRecorder:Landroid/media/MediaRecorder;

    invoke-virtual {v3, v2}, Landroid/media/MediaRecorder;->setVideoEncoder(I)V

    iget-object v2, p0, mMediaRecorder:Landroid/media/MediaRecorder;
    ...
    iget-boolean v2, p0, mUseAudio:Z
    ...
    iput-object v1, p0, mInputSurface:Landroid/view/Surface;

    iget-object v3, p0, mMediaProjection:Landroid/media/projection/MediaProjection;
    ...
    iget-object v9, p0, mInputSurface:Landroid/view/Surface;
    ...
    invoke-direct {p0}, createRecordingNotification()V
...
.method private stopRecording()V
    ...
    iget-object v1, p0, mMediaProjection:Landroid/media/projection/MediaProjection;

    invoke-virtual {v1}, Landroid/media/projection/MediaProjection;->stop()V

    iput-object v0, p0, mMediaProjection:Landroid/media/projection/MediaProjection;

    iget-object v0, p0, mInputSurface:Landroid/view/Surface;
...
.method public onCreate()V
    ...
    iput-object v0, p0, mMediaProjectionManager:Landroid/media/projection/MediaProjectionManager;
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    :pswitch_2
    iget-object p1, p0, mMediaRecorder:Landroid/media/MediaRecorder;

    invoke-virtual {p1}, Landroid/media/MediaRecorder;->resume()V

    invoke-direct {p0, v4, v1}, setNotificationActions(ZLandroid/app/NotificationManager;)V
    ...
    invoke-direct {p0, v5, v1}, setNotificationActions(ZLandroid/app/NotificationManager;)V

    goto/16 :goto_3

    :pswitch_4
    invoke-direct {p0}, stopRecording()V
    ...
    :try_start_0
    iget-object p2, p0, mTempFile:Ljava/io/File;
    ...
    invoke-direct {p0, p1}, createSaveNotification(Ljava/nio/file/Path;)Landroid/app/Notification;
    ...
    iget-object p1, p0, mTempFile:Ljava/io/File;
    ...
    iput-boolean p3, p0, mUseAudio:Z
    ...
    iput-boolean p3, p0, mShowTaps:Z
    ...
    iget-object p3, p0, mMediaProjectionManager:Landroid/media/projection/MediaProjectionManager;
    ...
    iput-object p1, p0, mMediaProjection:Landroid/media/projection/MediaProjection;

    invoke-direct {p0}, startRecording()V
