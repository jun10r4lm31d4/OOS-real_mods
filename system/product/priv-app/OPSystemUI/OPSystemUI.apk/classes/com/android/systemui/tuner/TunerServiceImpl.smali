...
.method static constructor <clinit>()V
    ...
    sput-object v0, RESET_BLACKLIST:[Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;Lcom/android/systemui/util/leak/LeakDetector;)V
    ...
    iput-object v0, p0, mObserver:Lcom/android/systemui/tuner/TunerServiceImpl$Observer;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, mListeningUris:Landroid/util/ArrayMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, mTunableLookup:Ljava/util/HashMap;
    ...
    :goto_0
    iput-object v0, p0, mTunables:Ljava/util/HashSet;
    ...
    iput-object p3, p0, mLeakDetector:Lcom/android/systemui/util/leak/LeakDetector;
    ...
    invoke-virtual {p0, v0, p3}, getValue(Ljava/lang/String;I)I
    ...
    invoke-direct {p0, p3, v2, p2}, upgradeTuner(IILandroid/os/Handler;)V
    ...
    iget-object p1, p0, mUserTracker:Lcom/android/systemui/settings/CurrentUserTracker;
    ...
    iput-object p1, p0, mTM:Landroid/telephony/TelephonyManager;
...
.method static synthetic access$200(Lcom/android/systemui/tuner/TunerServiceImpl;Landroid/net/Uri;)V
    ...
    invoke-direct {p0, p1}, reloadSetting(Landroid/net/Uri;)V
...
.method private addTunable(Lcom/android/systemui/tuner/TunerService$Tunable;Ljava/lang/String;)V
    ...
    iget-object v0, p0, mTunableLookup:Ljava/util/HashMap;
    ...
    iget-object v0, p0, mTunables:Ljava/util/HashSet;

    invoke-virtual {v0, p1}, Ljava/util/HashSet;->add(Ljava/lang/Object;)Z

    iget-object v0, p0, mLeakDetector:Lcom/android/systemui/util/leak/LeakDetector;

    iget-object v1, p0, mTunables:Ljava/util/HashSet;
    ...
    iget-object v1, p0, mListeningUris:Landroid/util/ArrayMap;
    ...
    iget-object v3, p0, mObserver:Lcom/android/systemui/tuner/TunerServiceImpl$Observer;
...
.method private reloadAll()V
    ...
    iget-object v3, p0, mTunableLookup:Ljava/util/HashMap;
...
.method private reloadSetting(Landroid/net/Uri;)V
    ...
    iget-object v0, p0, mListeningUris:Landroid/util/ArrayMap;
...
.method private upgradeTuner(IILandroid/os/Handler;)V
    ...
    invoke-virtual {p0, p1}, getValue(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v0, p0, mTM:Landroid/telephony/TelephonyManager;
    ...
    invoke-virtual {p0, p1, p2}, setValue(Ljava/lang/String;I)V
...
.method public varargs addTunable(Lcom/android/systemui/tuner/TunerService$Tunable;[Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, v2}, addTunable(Lcom/android/systemui/tuner/TunerService$Tunable;Ljava/lang/String;)V
...
.method public clearAll()V
    ...
    invoke-virtual {p0, v0}, clearAllFromUser(I)V
...
.method public clearAllFromUser(I)V
    ...
    sget-object v3, RESET_BLACKLIST:[Ljava/lang/String;
...
.method public removeTunable(Lcom/android/systemui/tuner/TunerService$Tunable;)V
    ...
    iget-object p0, p0, mTunables:Ljava/util/HashSet;
...
.method protected reregisterAll()V
    ...
    iget-object v1, p0, mObserver:Lcom/android/systemui/tuner/TunerServiceImpl$Observer;
    ...
    iget-object v4, p0, mObserver:Lcom/android/systemui/tuner/TunerServiceImpl$Observer;
