...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/qs/customize/TileQueryHelper$TileStateListener;)V
    ...
    iput-object v0, p0, mTiles:Ljava/util/ArrayList;

    new-instance v0, Landroid/util/ArraySet;

    invoke-direct {v0}, Landroid/util/ArraySet;-><init>()V

    iput-object v0, p0, mSpecs:Landroid/util/ArraySet;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mAllTiles:Ljava/util/ArrayList;
    ...
    iput-object p2, p0, mListener:Lcom/android/systemui/qs/customize/TileQueryHelper$TileStateListener;
    ...
    iput-object p1, p0, mBgHandler:Landroid/os/Handler;
...
.method private addCurrentAndStockTiles(Lcom/android/systemui/qs/QSTileHost;)V
    ...
    iget-object v2, p0, mAllTiles:Ljava/util/ArrayList;
...
.method private addTile(Ljava/lang/String;Ljava/lang/CharSequence;Lcom/android/systemui/plugins/qs/QSTile$State;Z)V
    ...
    iget-object v0, p0, mSpecs:Landroid/util/ArraySet;
    ...
    iget-object p2, p0, mTiles:Ljava/util/ArrayList;

    invoke-virtual {p2, v0}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object p0, p0, mSpecs:Landroid/util/ArraySet;
...
.method private createStateAndAddTile(Ljava/lang/String;Landroid/graphics/drawable/Drawable;Ljava/lang/CharSequence;Ljava/lang/CharSequence;)V
    ...
    invoke-direct {p0, p1, p4, v0, p2}, addTile(Ljava/lang/String;Ljava/lang/CharSequence;Lcom/android/systemui/plugins/qs/QSTile$State;Z)V
...
.method private notifyTilesChanged(Z)V
    ...
    iget-object v1, p0, mTiles:Ljava/util/ArrayList;

    invoke-direct {v0, v1}, Ljava/util/ArrayList;-><init>(Ljava/util/Collection;)V

    iget-object v1, p0, mMainHandler:Landroid/os/Handler;
...
.method public destroyTiles()V
    ...
    iget-object v0, p0, mAllTiles:Ljava/util/ArrayList;
    ...
    :cond_0
    iget-object p0, p0, mAllTiles:Ljava/util/ArrayList;
...
.method public synthetic lambda$addCurrentAndStockTiles$0$TileQueryHelper(Ljava/util/ArrayList;)V
    ...
    invoke-direct {p0, v0, v2, v1, v3}, addTile(Ljava/lang/String;Ljava/lang/CharSequence;Lcom/android/systemui/plugins/qs/QSTile$State;Z)V
    ...
    invoke-direct {p0, p1}, notifyTilesChanged(Z)V
...
.method public synthetic lambda$addPackageTiles$1$TileQueryHelper(Lcom/android/systemui/qs/QSTileHost;)V
    ...
    invoke-direct {p0, v0, v7}, getState(Ljava/util/Collection;Ljava/lang/String;)Lcom/android/systemui/plugins/qs/QSTile$State;
    ...
    :cond_3
    invoke-direct {p0, v7, v6, v8, v4}, addTile(Ljava/lang/String;Ljava/lang/CharSequence;Lcom/android/systemui/plugins/qs/QSTile$State;Z)V
    ...
    :goto_1
    invoke-direct {p0, v7, v8, v5, v6}, createStateAndAddTile(Ljava/lang/String;Landroid/graphics/drawable/Drawable;Ljava/lang/CharSequence;Ljava/lang/CharSequence;)V
...
.method public synthetic lambda$notifyTilesChanged$2$TileQueryHelper(Ljava/util/ArrayList;Z)V
    ...
    iget-object v0, p0, mListener:Lcom/android/systemui/qs/customize/TileQueryHelper$TileStateListener;
    ...
    iput-boolean p2, p0, mFinished:Z

    iget-boolean p1, p0, mFinished:Z

    if-eqz p1, :cond_0

    iget-object p0, p0, mListener:Lcom/android/systemui/qs/customize/TileQueryHelper$TileStateListener;
...
.method public queryTiles(Lcom/android/systemui/qs/QSTileHost;)V
    ...
    invoke-direct {p0, p1}, addCurrentAndStockTiles(Lcom/android/systemui/qs/QSTileHost;)V

    invoke-direct {p0, p1}, addPackageTiles(Lcom/android/systemui/qs/QSTileHost;)V
