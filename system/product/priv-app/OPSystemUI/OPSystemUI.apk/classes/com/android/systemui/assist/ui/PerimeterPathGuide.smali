...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/assist/ui/CornerPathRenderer;III)V
    ...
    iput-object v0, p0, mScratchPath:Landroid/graphics/Path;

    new-instance v0, Landroid/graphics/PathMeasure;

    iget-object v1, p0, mScratchPath:Landroid/graphics/Path;

    const/4 v2, 0x0

    invoke-direct {v0, v1, v2}, Landroid/graphics/PathMeasure;-><init>(Landroid/graphics/Path;Z)V

    iput-object v0, p0, mScratchPathMeasure:Landroid/graphics/PathMeasure;

    iput v2, p0, mRotation:I

    iput-object p2, p0, mCornerPathRenderer:Lcom/android/systemui/assist/ui/CornerPathRenderer;

    iput p4, p0, mDeviceWidthPx:I

    iput p5, p0, mDeviceHeightPx:I

    invoke-static {p1}, Lcom/android/systemui/assist/ui/DisplayUtils;->getCornerRadiusTop(Landroid/content/Context;)I

    move-result p2

    iput p2, p0, mTopCornerRadiusPx:I

    invoke-static {p1}, Lcom/android/systemui/assist/ui/DisplayUtils;->getCornerRadiusBottom(Landroid/content/Context;)I

    move-result p1

    iput p1, p0, mBottomCornerRadiusPx:I

    iput p3, p0, mEdgeInset:I

    const/16 p1, 0x8

    new-array p1, p1, [Lcom/android/systemui/assist/ui/PerimeterPathGuide$RegionAttributes;

    iput-object p1, p0, mRegions:[Lcom/android/systemui/assist/ui/PerimeterPathGuide$RegionAttributes;

    :goto_0
    iget-object p1, p0, mRegions:[Lcom/android/systemui/assist/ui/PerimeterPathGuide$RegionAttributes;
    ...
    :cond_0
    invoke-direct {p0}, computeRegions()V
...
.method private computeRegions()V
    ...
    iget v0, p0, mDeviceWidthPx:I

    iget v1, p0, mDeviceHeightPx:I
    ...
    iget v8, p0, mDeviceWidthPx:I

    div-int/2addr v8, v6

    int-to-float v8, v8

    iget v9, p0, mDeviceHeightPx:I
    ...
    :cond_3
    iget v1, p0, mDeviceWidthPx:I

    iget v0, p0, mDeviceHeightPx:I
    ...
    invoke-direct {p0, v2}, getRotatedCorner(Lcom/android/systemui/assist/ui/CornerPathRenderer$Corner;)Lcom/android/systemui/assist/ui/CornerPathRenderer$Corner;
    ...
    invoke-direct {p0, v3}, getRotatedCorner(Lcom/android/systemui/assist/ui/CornerPathRenderer$Corner;)Lcom/android/systemui/assist/ui/CornerPathRenderer$Corner;
    ...
    invoke-direct {p0, v4}, getRotatedCorner(Lcom/android/systemui/assist/ui/CornerPathRenderer$Corner;)Lcom/android/systemui/assist/ui/CornerPathRenderer$Corner;
    ...
    invoke-direct {p0, v6}, getRotatedCorner(Lcom/android/systemui/assist/ui/CornerPathRenderer$Corner;)Lcom/android/systemui/assist/ui/CornerPathRenderer$Corner;

    move-result-object v6

    iget-object v8, p0, mRegions:[Lcom/android/systemui/assist/ui/PerimeterPathGuide$RegionAttributes;
    ...
    iget-object v9, p0, mCornerPathRenderer:Lcom/android/systemui/assist/ui/CornerPathRenderer;

    iget v10, p0, mEdgeInset:I
    ...
    invoke-direct {p0, v2}, getPhysicalCornerRadius(Lcom/android/systemui/assist/ui/CornerPathRenderer$Corner;)I

    move-result v8

    int-to-float v8, v8

    iget v9, p0, mEdgeInset:I
    ...
    invoke-direct {p0, v3}, getPhysicalCornerRadius(Lcom/android/systemui/assist/ui/CornerPathRenderer$Corner;)I
    ...
    invoke-direct {p0, v6}, getPhysicalCornerRadius(Lcom/android/systemui/assist/ui/CornerPathRenderer$Corner;)I
    ...
    invoke-direct {p0, v4}, getPhysicalCornerRadius(Lcom/android/systemui/assist/ui/CornerPathRenderer$Corner;)I
    ...
    iget-object v0, p0, mRegions:[Lcom/android/systemui/assist/ui/PerimeterPathGuide$RegionAttributes;
    ...
    iget-object v1, p0, mRegions:[Lcom/android/systemui/assist/ui/PerimeterPathGuide$RegionAttributes;
    ...
    :goto_1
    iget-object v4, p0, mRegions:[Lcom/android/systemui/assist/ui/PerimeterPathGuide$RegionAttributes;
...
.method private getPhysicalCornerRadius(Lcom/android/systemui/assist/ui/CornerPathRenderer$Corner;)I
    ...
    :cond_0
    iget p0, p0, mTopCornerRadiusPx:I

    return p0

    :cond_1
    :goto_0
    iget p0, p0, mBottomCornerRadiusPx:I
...
.method private placePoint(F)Landroid/util/Pair;
    ...
    :cond_1
    invoke-direct {p0, p1}, getRegionForPoint(F)Lcom/android/systemui/assist/ui/PerimeterPathGuide$Region;
    ...
    iget-object p0, p0, mRegions:[Lcom/android/systemui/assist/ui/PerimeterPathGuide$RegionAttributes;
...
.method private strokeRegion(Landroid/graphics/Path;Lcom/android/systemui/assist/ui/PerimeterPathGuide$Region;FF)V
    ...
    :cond_0
    iget-object v0, p0, mScratchPathMeasure:Landroid/graphics/PathMeasure;
    ...
    iget-object p2, p0, mScratchPathMeasure:Landroid/graphics/PathMeasure;
    ...
    iget-object p0, p0, mScratchPathMeasure:Landroid/graphics/PathMeasure;
...
.method private strokeSegmentInternal(Landroid/graphics/Path;FF)V
    ...
    invoke-direct {p0, p2}, placePoint(F)Landroid/util/Pair;

    move-result-object p2

    invoke-direct {p0, p3}, placePoint(F)Landroid/util/Pair;
    ...
    invoke-direct {p0, p1, v0, p2, p3}, strokeRegion(Landroid/graphics/Path;Lcom/android/systemui/assist/ui/PerimeterPathGuide$Region;FF)V
    ...
    invoke-direct {p0, p1, v0, v1, v2}, strokeRegion(Landroid/graphics/Path;Lcom/android/systemui/assist/ui/PerimeterPathGuide$Region;FF)V
    ...
    invoke-direct {p0, p1, v5, v7, v2}, strokeRegion(Landroid/graphics/Path;Lcom/android/systemui/assist/ui/PerimeterPathGuide$Region;FF)V
    ...
    invoke-direct {p0, p1, v5, v7, p2}, strokeRegion(Landroid/graphics/Path;Lcom/android/systemui/assist/ui/PerimeterPathGuide$Region;FF)V
...
.method public strokeSegment(Landroid/graphics/Path;FF)V
    ...
    invoke-direct {p0, p1, p2, v0}, strokeSegmentInternal(Landroid/graphics/Path;FF)V

    const/4 p2, 0x0

    :cond_1
    invoke-direct {p0, p1, p2, p3}, strokeSegmentInternal(Landroid/graphics/Path;FF)V
