...
.method public onCheckedChanged(Landroid/widget/CompoundButton;Z)V
    ...
    iget-object p0, p0, mClearDefaultHint:Landroid/widget/TextView;
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    iget-object p2, p0, mResolveInfo:Landroid/content/pm/ResolveInfo;
    ...
    iget-object v1, p0, mAlwaysUse:Landroid/widget/CheckBox;

    invoke-virtual {v1}, Landroid/widget/CheckBox;->isChecked()Z

    move-result v1

    iget-object v2, p0, mDevice:Landroid/hardware/usb/UsbDevice;
    ...
    iget-object v5, p0, mDevice:Landroid/hardware/usb/UsbDevice;

    invoke-virtual {v2, v4, v5}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;

    iget-object v4, p0, mDevice:Landroid/hardware/usb/UsbDevice;

    invoke-interface {p1, v4, p2}, Landroid/hardware/usb/IUsbManager;->grantDevicePermission(Landroid/hardware/usb/UsbDevice;I)V

    if-eqz v1, :cond_0

    iget-object p2, p0, mDevice:Landroid/hardware/usb/UsbDevice;
    ...
    :cond_1
    iget-object v2, p0, mAccessory:Landroid/hardware/usb/UsbAccessory;
    ...
    iget-object v5, p0, mAccessory:Landroid/hardware/usb/UsbAccessory;

    invoke-virtual {v2, v4, v5}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;

    iget-object v4, p0, mAccessory:Landroid/hardware/usb/UsbAccessory;
    ...
    iget-object p2, p0, mAccessory:Landroid/hardware/usb/UsbAccessory;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, mDevice:Landroid/hardware/usb/UsbDevice;
    ...
    iput-object v0, p0, mAccessory:Landroid/hardware/usb/UsbAccessory;
    ...
    iput-object p1, p0, mResolveInfo:Landroid/content/pm/ResolveInfo;
    ...
    iget-object v6, p0, mAccessory:Landroid/hardware/usb/UsbAccessory;
    ...
    iput-object v1, p0, mDisconnectedReceiver:Lcom/android/systemui/usb/UsbDisconnectedReceiver;
    ...
    iput-object v1, p0, mAlwaysUse:Landroid/widget/CheckBox;
    ...
    iget-object p1, p0, mAccessory:Landroid/hardware/usb/UsbAccessory;
    ...
    :cond_1
    iget-object v5, p0, mAlwaysUse:Landroid/widget/CheckBox;
    ...
    :goto_1
    iget-object p1, p0, mAlwaysUse:Landroid/widget/CheckBox;
    ...
    iput-object p1, p0, mClearDefaultHint:Landroid/widget/TextView;

    iget-object p1, p0, mClearDefaultHint:Landroid/widget/TextView;
...
.method protected onDestroy()V
    ...
    iget-object v0, p0, mDisconnectedReceiver:Lcom/android/systemui/usb/UsbDisconnectedReceiver;
