...
.method public constructor <init>(Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;)V
    ...
    iput-object p1, p0, mView:Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;

    iget-object p1, p0, mView:Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;
    ...
    iput p1, p0, mIconAlphaWhenOpaque:F
...
.method private applyMode(IZ)V
    ...
    iget-object v0, p0, mLeftSide:Landroid/view/View;
    ...
    :cond_0
    invoke-direct {p0, p1}, getNonBatteryClockAlphaFor(I)F

    move-result v0

    invoke-direct {p0, p1}, getBatteryClockAlpha(I)F

    move-result v1

    iget-object v2, p0, mCurrentAnimation:Landroid/animation/Animator;
    ...
    iget-object v4, p0, mLeftSide:Landroid/view/View;

    invoke-virtual {p0, v4, v0}, animateTransitionTo(Landroid/view/View;F)Landroid/animation/ObjectAnimator;
    ...
    iget-object v4, p0, mStatusIcons:Landroid/view/View;
    ...
    iget-object v3, p0, mBattery:Landroid/view/View;

    invoke-virtual {p0, v3, v1}, animateTransitionTo(Landroid/view/View;F)Landroid/animation/ObjectAnimator;
    ...
    iput-object p2, p0, mCurrentAnimation:Landroid/animation/Animator;

    goto :goto_0

    :cond_3
    iget-object p1, p0, mLeftSide:Landroid/view/View;

    invoke-virtual {p1, v0}, Landroid/view/View;->setAlpha(F)V

    iget-object p1, p0, mStatusIcons:Landroid/view/View;

    invoke-virtual {p1, v0}, Landroid/view/View;->setAlpha(F)V

    iget-object p0, p0, mBattery:Landroid/view/View;
...
.method private getNonBatteryClockAlphaFor(I)F
    ...
    :cond_0
    invoke-direct {p0, p1}, isOpaque(I)Z
    ...
    :cond_1
    iget p0, p0, mIconAlphaWhenOpaque:F
...
.method public init()V
    ...
    iget-object v0, p0, mView:Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;
    ...
    iput-object v0, p0, mLeftSide:Landroid/view/View;
    ...
    iput-object v0, p0, mStatusIcons:Landroid/view/View;
    ...
    iput-object v0, p0, mBattery:Landroid/view/View;
    ...
    invoke-direct {p0, v0, v1}, applyMode(IZ)V
...
.method protected onTransition(IIZ)V
    ...
    invoke-direct {p0, p2, p3}, applyMode(IZ)V
