...
.method public constructor <init>(Lcom/android/systemui/UiOffloadThread;)V
    ...
    iput-object v0, p0, mExpansionStates:Ljava/util/Map;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, mLoggedExpansionState:Ljava/util/Map;

    iput-object p1, p0, mUiOffloadThread:Lcom/android/systemui/UiOffloadThread;
...
.method private getState(Ljava/lang/String;)Lcom/android/systemui/statusbar/notification/logging/NotificationLogger$ExpansionStateLogger$State;
    ...
    iget-object v0, p0, mExpansionStates:Ljava/util/Map;
    ...
    iget-object p0, p0, mExpansionStates:Ljava/util/Map;
...
.method private maybeNotifyOnNotificationExpansionChanged(Ljava/lang/String;Lcom/android/systemui/statusbar/notification/logging/NotificationLogger$ExpansionStateLogger$State;)V
    ...
    :cond_1
    iget-object v0, p0, mLoggedExpansionState:Ljava/util/Map;
...
.method onEntryReinflated(Ljava/lang/String;)V
    ...
    iget-object p0, p0, mLoggedExpansionState:Ljava/util/Map;
...
.method onExpansionChanged(Ljava/lang/String;ZZLcom/android/internal/statusbar/NotificationVisibility$NotificationLocation;)V
    ...
    invoke-direct {p0, p1}, getState(Ljava/lang/String;)Lcom/android/systemui/statusbar/notification/logging/NotificationLogger$ExpansionStateLogger$State;
    ...
    invoke-direct {p0, p1, v0}, maybeNotifyOnNotificationExpansionChanged(Ljava/lang/String;Lcom/android/systemui/statusbar/notification/logging/NotificationLogger$ExpansionStateLogger$State;)V
...
.method onVisibilityChanged(Ljava/util/Collection;Ljava/util/Collection;)V
    ...
    invoke-direct {p0, v4}, getState(Ljava/lang/String;)Lcom/android/systemui/statusbar/notification/logging/NotificationLogger$ExpansionStateLogger$State;
    ...
    invoke-direct {p0, v3, v4}, maybeNotifyOnNotificationExpansionChanged(Ljava/lang/String;Lcom/android/systemui/statusbar/notification/logging/NotificationLogger$ExpansionStateLogger$State;)V
    ...
    invoke-direct {p0, v2}, getState(Ljava/lang/String;)Lcom/android/systemui/statusbar/notification/logging/NotificationLogger$ExpansionStateLogger$State;
