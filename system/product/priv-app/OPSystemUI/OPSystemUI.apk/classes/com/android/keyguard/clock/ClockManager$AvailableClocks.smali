...
.method private constructor <init>(Lcom/android/keyguard/clock/ClockManager;)V
    ...
    iput-object p1, p0, this$0:Lcom/android/keyguard/clock/ClockManager;
    ...
    iput-object p1, p0, mClocks:Ljava/util/Map;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, mClockInfo:Ljava/util/List;
...
.method synthetic constructor <init>(Lcom/android/keyguard/clock/ClockManager;Lcom/android/keyguard/clock/ClockManager$1;)V
    ...
    invoke-direct {p0, p1}, <init>(Lcom/android/keyguard/clock/ClockManager;)V
...
.method private getClockPlugin()Lcom/android/systemui/plugins/ClockPlugin;
    ...
    iget-object v0, p0, this$0:Lcom/android/keyguard/clock/ClockManager;
    ...
    iget-object v1, p0, this$0:Lcom/android/keyguard/clock/ClockManager;
    ...
    iget-object v1, p0, mClocks:Ljava/util/Map;
    ...
    iget-object v2, p0, this$0:Lcom/android/keyguard/clock/ClockManager;
    ...
    iget-object p0, p0, mClocks:Ljava/util/Map;
...
.method private removeClockPlugin(Lcom/android/systemui/plugins/ClockPlugin;)V
    ...
    iget-object v0, p0, mClocks:Ljava/util/Map;
    ...
    :goto_0
    iget-object v1, p0, mClockInfo:Ljava/util/List;
    ...
    iget-object p0, p0, mClockInfo:Ljava/util/List;
...
.method getCurrentClock()Lcom/android/systemui/plugins/ClockPlugin;
    ...
    iget-object p0, p0, mCurrentClock:Lcom/android/systemui/plugins/ClockPlugin;
...
.method public synthetic lambda$addClockPlugin$0$ClockManager$AvailableClocks(Lcom/android/systemui/plugins/ClockPlugin;)Landroid/graphics/Bitmap;
    ...
    iget-object p0, p0, this$0:Lcom/android/keyguard/clock/ClockManager;
...
.method public onPluginConnected(Lcom/android/systemui/plugins/ClockPlugin;Landroid/content/Context;)V
    ...
    invoke-virtual {p0, p1}, addClockPlugin(Lcom/android/systemui/plugins/ClockPlugin;)V

    invoke-virtual {p0}, reload()V

    iget-object p2, p0, mCurrentClock:Lcom/android/systemui/plugins/ClockPlugin;
...
.method public bridge synthetic onPluginConnected(Lcom/android/systemui/plugins/Plugin;Landroid/content/Context;)V
    ...
    invoke-virtual {p0, p1, p2}, onPluginConnected(Lcom/android/systemui/plugins/ClockPlugin;Landroid/content/Context;)V
...
.method public onPluginDisconnected(Lcom/android/systemui/plugins/ClockPlugin;)V
    ...
    iget-object v0, p0, mCurrentClock:Lcom/android/systemui/plugins/ClockPlugin;
    ...
    :goto_0
    invoke-direct {p0, p1}, removeClockPlugin(Lcom/android/systemui/plugins/ClockPlugin;)V
...
.method public bridge synthetic onPluginDisconnected(Lcom/android/systemui/plugins/Plugin;)V
    ...
    invoke-virtual {p0, p1}, onPluginDisconnected(Lcom/android/systemui/plugins/ClockPlugin;)V
...
.method reload()V
    ...
    invoke-direct {p0}, getClockPlugin()Lcom/android/systemui/plugins/ClockPlugin;

    move-result-object v0

    iput-object v0, p0, mCurrentClock:Lcom/android/systemui/plugins/ClockPlugin;
