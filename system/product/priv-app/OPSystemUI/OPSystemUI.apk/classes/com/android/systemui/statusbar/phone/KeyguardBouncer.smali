...
.method public constructor <init>(Landroid/content/Context;Lcom/android/keyguard/ViewMediatorCallback;Lcom/android/internal/widget/LockPatternUtils;Landroid/view/ViewGroup;Lcom/android/systemui/keyguard/DismissCallbackRegistry;Lcom/android/systemui/plugins/FalsingManager;Lcom/android/systemui/statusbar/phone/KeyguardBouncer$BouncerExpansionCallback;Lcom/android/keyguard/KeyguardUpdateMonitor;Landroid/os/Handler;)V
    ...
    iput-object v0, p0, mRemoveViewRunnable:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mResetRunnable:Ljava/lang/Runnable;

    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, p0, mExpansion:F

    const/4 v0, 0x0

    iput-boolean v0, p0, mNoAnim:Z
    ...
    iput-object v1, p0, mShowRunnable:Ljava/lang/Runnable;

    iput-boolean v0, p0, mHideNavBar:Z

    iput-object p1, p0, mContext:Landroid/content/Context;

    iput-object p2, p0, mCallback:Lcom/android/keyguard/ViewMediatorCallback;

    iput-object p3, p0, mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;

    iput-object p4, p0, mContainer:Landroid/view/ViewGroup;

    iput-object p8, p0, mKeyguardUpdateMonitor:Lcom/android/keyguard/KeyguardUpdateMonitor;

    iput-object p6, p0, mFalsingManager:Lcom/android/systemui/plugins/FalsingManager;

    iput-object p5, p0, mDismissCallbackRegistry:Lcom/android/systemui/keyguard/DismissCallbackRegistry;

    iput-object p7, p0, mExpansionCallback:Lcom/android/systemui/statusbar/phone/KeyguardBouncer$BouncerExpansionCallback;

    iput-object p9, p0, mHandler:Landroid/os/Handler;
...
.method static synthetic access$000(Lcom/android/systemui/statusbar/phone/KeyguardBouncer;)I
    ...
    iget p0, p0, mBouncerPromptReason:I
...
.method static synthetic access$002(Lcom/android/systemui/statusbar/phone/KeyguardBouncer;I)I
    ...
    iput p1, p0, mBouncerPromptReason:I
...
.method static synthetic access$200(Lcom/android/systemui/statusbar/phone/KeyguardBouncer;)V
    ...
    invoke-direct {p0}, showPrimarySecurityScreen()V
...
.method static synthetic access$502(Lcom/android/systemui/statusbar/phone/KeyguardBouncer;Z)Z
    ...
    iput-boolean p1, p0, mShowingSoon:Z
...
.method private cancelShowRunnable()V
    ...
    iget-object v0, p0, mShowRunnable:Ljava/lang/Runnable;
    ...
    iput-boolean v0, p0, mShowingSoon:Z
...
.method private onFullyHidden()V
    ...
    invoke-direct {p0}, cancelShowRunnable()V
    ...
    iget-object p0, p0, mResetRunnable:Ljava/lang/Runnable;
...
.method private onFullyShown()V
    ...
    iget-object p0, p0, mKeyguardView:Lcom/android/keyguard/KeyguardHostView;
...
.method private showPrimarySecurityScreen()V
    ...
    iget-object v0, p0, mKeyguardView:Lcom/android/keyguard/KeyguardHostView;
    ...
    iput-object v0, p0, mLockIconContainer:Landroid/view/ViewGroup;
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    iget-object v1, p0, mKeyguardView:Lcom/android/keyguard/KeyguardHostView;
    ...
    iget v1, p0, mBouncerPromptReason:I
    ...
    iget-boolean p0, p0, mIsAnimatingAway:Z
...
.method protected ensureView()V
    ...
    iget-object v1, p0, mRemoveViewRunnable:Ljava/lang/Runnable;

    invoke-virtual {v0, v1}, Landroid/os/Handler;->hasCallbacks(Ljava/lang/Runnable;)Z

    move-result v0

    iget-object v1, p0, mRoot:Landroid/view/ViewGroup;
    ...
    :cond_0
    invoke-virtual {p0}, inflateView()V
...
.method public forceHide()V
    ...
    :cond_0
    iget-object p0, p0, mRoot:Landroid/view/ViewGroup;
...
.method public hide(Z)V
    ...
    iput-boolean v0, p0, mIsScrimmed:Z
    ...
    iget-object v1, p0, mCallback:Lcom/android/keyguard/ViewMediatorCallback;
    ...
    :cond_1
    iput-boolean v0, p0, mIsAnimatingAway:Z
    ...
    iget-object p0, p0, mRemoveViewRunnable:Ljava/lang/Runnable;
...
.method protected inflateView()V
    ...
    invoke-virtual {p0}, removeView()V
    ...
    iput-object v0, p0, mKeyguardView:Lcom/android/keyguard/KeyguardHostView;
    ...
    iget-boolean v1, p0, mHideNavBar:Z
...
.method public interceptMediaKey(Landroid/view/KeyEvent;)Z
    ...
    invoke-virtual {p0}, ensureView()V
...
.method public isPartiallyVisible()Z
    ...
    iget-boolean v0, p0, mShowingSoon:Z
    ...
    invoke-virtual {p0}, isAnimatingAway()Z
...
.method public isScrimmed()Z
    ...
    iget-boolean p0, p0, mIsScrimmed:Z
...
.method public prepare()V
    ...
    :cond_1
    iget-object v0, p0, mCallback:Lcom/android/keyguard/ViewMediatorCallback;

    invoke-interface {v0}, Lcom/android/keyguard/ViewMediatorCallback;->getBouncerPromptReason()I

    move-result v0

    iput v0, p0, mBouncerPromptReason:I
...
.method protected removeView()V
    ...
    iget-object v1, p0, mContainer:Landroid/view/ViewGroup;
...
.method public setExpansion(F)V
    ...
    iget-boolean v1, p0, mIsAnimatingAway:Z
    ...
    iget-object v4, p0, mKeyguardView:Lcom/android/keyguard/KeyguardHostView;
    ...
    :goto_0
    iget-object v4, p0, mRoot:Landroid/view/ViewGroup;
    ...
    invoke-direct {p0}, onFullyShown()V

    iget-object p0, p0, mExpansionCallback:Lcom/android/systemui/statusbar/phone/KeyguardBouncer$BouncerExpansionCallback;
    ...
    invoke-direct {p0}, onFullyHidden()V
    ...
    iget-object p1, p0, mExpansionCallback:Lcom/android/systemui/statusbar/phone/KeyguardBouncer$BouncerExpansionCallback;
...
.method public show(Z)V
    ...
    invoke-virtual {p0, p1, v0}, show(ZZ)V
...
.method public show(ZZ)V
    ...
    iput-boolean p2, p0, mIsScrimmed:Z

    if-eqz p2, :cond_1

    const/4 p2, 0x0

    invoke-virtual {p0, p2}, setExpansion(F)V
    ...
    :cond_2
    iget-object p1, p0, mRoot:Landroid/view/ViewGroup;
    ...
    iget-boolean p1, p0, mShowingSoon:Z
    ...
    iget-object p2, p0, mKeyguardView:Lcom/android/keyguard/KeyguardHostView;
    ...
    iput-boolean p2, p0, mNoAnim:Z

    iget-boolean p2, p0, mNoAnim:Z
    ...
    :cond_8
    iput-boolean v3, p0, mShowingSoon:Z

    iget-object p1, p0, mResetRunnable:Ljava/lang/Runnable;
    ...
    iget-object p2, p0, mShowRunnable:Ljava/lang/Runnable;
    ...
    :cond_9
    iget-object p1, p0, mShowRunnable:Ljava/lang/Runnable;

    invoke-static {p1}, Lcom/android/systemui/DejankUtils;->postAfterTraversal(Ljava/lang/Runnable;)V

    :goto_1
    iget-object p1, p0, mCallback:Lcom/android/keyguard/ViewMediatorCallback;
