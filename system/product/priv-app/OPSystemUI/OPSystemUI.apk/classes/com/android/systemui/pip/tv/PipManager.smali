...
.method private constructor <init>()V
    ...
    iput v0, p0, mResumeResizePinnedStackRunnableState:I
    ...
    iput-object v1, p0, mListeners:Ljava/util/List;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, mMediaListeners:Ljava/util/List;

    new-instance v1, Landroid/graphics/Rect;

    invoke-direct {v1}, Landroid/graphics/Rect;-><init>()V

    iput-object v1, p0, mDefaultPipBounds:Landroid/graphics/Rect;

    iput v0, p0, mLastOrientation:I

    const/4 v0, -0x1

    iput v0, p0, mPipTaskId:I

    iput v0, p0, mPinnedStackId:I
    ...
    iput-object v0, p0, mPinnedStackListener:Lcom/android/systemui/pip/tv/PipManager$PinnedStackListener;
    ...
    iput-object v0, p0, mResizePinnedStackRunnable:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mClosePipRunnable:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mActiveMediaSessionListener:Landroid/media/session/MediaSessionManager$OnActiveSessionsChangedListener;
...
.method static synthetic access$100(Lcom/android/systemui/pip/tv/PipManager;)I
    ...
    iget p0, p0, mResumeResizePinnedStackRunnableState:I
...
.method static synthetic access$1000(Lcom/android/systemui/pip/tv/PipManager;)Ljava/util/List;
    ...
    iget-object p0, p0, mListeners:Ljava/util/List;
...
.method static synthetic access$1100(Lcom/android/systemui/pip/tv/PipManager;)Landroid/graphics/Rect;
    ...
    iget-object p0, p0, mDefaultPipBounds:Landroid/graphics/Rect;
...
.method static synthetic access$1300(Lcom/android/systemui/pip/tv/PipManager;)Landroid/app/ActivityManager$StackInfo;
    ...
    invoke-direct {p0}, getPinnedStackInfo()Landroid/app/ActivityManager$StackInfo;
...
.method static synthetic access$1400(Lcom/android/systemui/pip/tv/PipManager;Z)V
    ...
    invoke-direct {p0, p1}, closePipInternal(Z)V
...
.method static synthetic access$1600(Lcom/android/systemui/pip/tv/PipManager;)Z
    ...
    invoke-direct {p0}, isSettingsShown()Z
...
.method static synthetic access$1700(Lcom/android/systemui/pip/tv/PipManager;)Landroid/graphics/Rect;
    ...
    iget-object p0, p0, mSettingsPipBounds:Landroid/graphics/Rect;
...
.method static synthetic access$1902(Lcom/android/systemui/pip/tv/PipManager;Landroid/content/ComponentName;)Landroid/content/ComponentName;
    ...
    iput-object p1, p0, mPipComponentName:Landroid/content/ComponentName;
...
.method static synthetic access$200(Lcom/android/systemui/pip/tv/PipManager;[Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, handleMediaResourceGranted([Ljava/lang/String;)V
...
.method static synthetic access$2002(Lcom/android/systemui/pip/tv/PipManager;Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    iput-object p1, p0, mCurrentPipBounds:Landroid/graphics/Rect;
...
.method static synthetic access$2100(Lcom/android/systemui/pip/tv/PipManager;)Landroid/media/session/MediaSessionManager$OnActiveSessionsChangedListener;
    ...
    iget-object p0, p0, mActiveMediaSessionListener:Landroid/media/session/MediaSessionManager$OnActiveSessionsChangedListener;
...
.method static synthetic access$2200(Lcom/android/systemui/pip/tv/PipManager;)Landroid/media/session/MediaSessionManager;
    ...
    iget-object p0, p0, mMediaSessionManager:Landroid/media/session/MediaSessionManager;
...
.method static synthetic access$2300(Lcom/android/systemui/pip/tv/PipManager;Z)V
    ...
    invoke-direct {p0, p1}, updatePipVisibility(Z)V
...
.method static synthetic access$2400(Lcom/android/systemui/pip/tv/PipManager;)V
    ...
    invoke-direct {p0}, showPipMenu()V
...
.method static synthetic access$300(Lcom/android/systemui/pip/tv/PipManager;Ljava/util/List;)V
    ...
    invoke-direct {p0, p1}, updateMediaController(Ljava/util/List;)V
...
.method static synthetic access$500(Lcom/android/systemui/pip/tv/PipManager;)Z
    ...
    iget-boolean p0, p0, mImeVisible:Z
...
.method static synthetic access$600(Lcom/android/systemui/pip/tv/PipManager;)Landroid/graphics/Rect;
    ...
    iget-object p0, p0, mPipBounds:Landroid/graphics/Rect;
...
.method static synthetic access$602(Lcom/android/systemui/pip/tv/PipManager;Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    iput-object p1, p0, mPipBounds:Landroid/graphics/Rect;
...
.method static synthetic access$700(Lcom/android/systemui/pip/tv/PipManager;)I
    ...
    iget p0, p0, mImeHeightAdjustment:I
...
.method static synthetic access$702(Lcom/android/systemui/pip/tv/PipManager;I)I
    ...
    iput p1, p0, mImeHeightAdjustment:I
...
.method static synthetic access$900(Lcom/android/systemui/pip/tv/PipManager;)Landroid/content/pm/ParceledListSlice;
    ...
    iget-object p0, p0, mCustomActions:Landroid/content/pm/ParceledListSlice;
...
.method static synthetic access$902(Lcom/android/systemui/pip/tv/PipManager;Landroid/content/pm/ParceledListSlice;)Landroid/content/pm/ParceledListSlice;
    ...
    iput-object p1, p0, mCustomActions:Landroid/content/pm/ParceledListSlice;
...
.method private closePipInternal(Z)V
    ...
    iput v1, p0, mPipTaskId:I

    const/4 v2, 0x0

    iput-object v2, p0, mPipMediaController:Landroid/media/session/MediaController;

    iget-object v2, p0, mMediaSessionManager:Landroid/media/session/MediaSessionManager;

    iget-object v3, p0, mActiveMediaSessionListener:Landroid/media/session/MediaSessionManager$OnActiveSessionsChangedListener;
    ...
    :try_start_0
    iget-object p1, p0, mActivityTaskManager:Landroid/app/IActivityTaskManager;

    iget v2, p0, mPinnedStackId:I
    ...
    iget-object v1, p0, mClosePipRunnable:Ljava/lang/Runnable;

    invoke-virtual {p1, v1}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    invoke-direct {p0, v0}, updatePipVisibility(Z)V
...
.method public static getInstance()Lcom/android/systemui/pip/tv/PipManager;
    ...
    sget-object v0, sPipManager:Lcom/android/systemui/pip/tv/PipManager;
    ...
    sput-object v0, sPipManager:Lcom/android/systemui/pip/tv/PipManager;
...
.method private getState()I
    ...
    iget v0, p0, mSuspendPipResizingReason:I
...
.method private handleMediaResourceGranted([Ljava/lang/String;)V
    ...
    iput-object p1, p0, mLastPackagesResourceGranted:[Ljava/lang/String;

    goto :goto_3

    :cond_0
    iget-object v0, p0, mLastPackagesResourceGranted:[Ljava/lang/String;
...
.method private isSettingsShown()Z
    ...
    :try_start_0
    iget-object p0, p0, mActivityTaskManager:Landroid/app/IActivityTaskManager;
    ...
    sget-object v2, sSettingsPackageAndClassNamePairList:Ljava/util/List;
...
.method private loadConfigurationsAndApply(Landroid/content/res/Configuration;)V
    ...
    iput-object v0, p0, mSettingsPipBounds:Landroid/graphics/Rect;
    ...
    iput-object p1, p0, mMenuModePipBounds:Landroid/graphics/Rect;
    ...
    iget-object p1, p0, mSettingsPipBounds:Landroid/graphics/Rect;

    goto :goto_0

    :cond_1
    iget-object p1, p0, mDefaultPipBounds:Landroid/graphics/Rect;
    ...
    :goto_1
    invoke-virtual {p0, p1}, resizePinnedStack(I)V
...
.method private showPipMenu()V
    ...
    iget-object v1, p0, mCustomActions:Landroid/content/pm/ParceledListSlice;
...
.method private updateMediaController(Ljava/util/List;)V
    ...
    iget-object v0, p0, mPipComponentName:Landroid/content/ComponentName;
    ...
    iget-object v3, p0, mPipComponentName:Landroid/content/ComponentName;
    ...
    :goto_1
    iget-object p1, p0, mPipMediaController:Landroid/media/session/MediaController;

    if-eq p1, v1, :cond_4

    iput-object v1, p0, mPipMediaController:Landroid/media/session/MediaController;

    iget-object p1, p0, mMediaListeners:Ljava/util/List;
    ...
    iget-object v0, p0, mMediaListeners:Ljava/util/List;
    ...
    iget-object p0, p0, mClosePipRunnable:Ljava/lang/Runnable;
...
.method public addMediaListener(Lcom/android/systemui/pip/tv/PipManager$MediaListener;)V
    ...
    iget-object p0, p0, mMediaListeners:Ljava/util/List;
...
.method public closePip()V
    ...
    invoke-direct {p0, v0}, closePipInternal(Z)V
...
.method getMediaController()Landroid/media/session/MediaController;
    ...
    iget-object p0, p0, mPipMediaController:Landroid/media/session/MediaController;
...
.method getPlaybackState()I
    ...
    iget-object v0, p0, mPipMediaController:Landroid/media/session/MediaController;
...
.method public initialize(Landroid/content/Context;)V
    ...
    iput-object v1, p0, mActivityTaskManager:Landroid/app/IActivityTaskManager;
    ...
    iget-object v2, p0, mTaskStackListener:Lcom/android/systemui/shared/system/TaskStackChangeListener;
    ...
    sget-object v1, sSettingsPackageAndClassNamePairList:Ljava/util/List;
    ...
    sput-object v4, sSettingsPackageAndClassNamePairList:Ljava/util/List;
    ...
    sget-object v5, sSettingsPackageAndClassNamePairList:Ljava/util/List;
    ...
    invoke-direct {p0, v0}, loadConfigurationsAndApply(Landroid/content/res/Configuration;)V
    ...
    iput-object v0, p0, mMediaSessionManager:Landroid/media/session/MediaSessionManager;

    :try_start_0
    iget-object v0, p0, mWindowManager:Landroid/view/IWindowManager;

    iget-object v1, p0, mPinnedStackListener:Lcom/android/systemui/pip/tv/PipManager$PinnedStackListener;
    ...
    iput-object v0, p0, mPipNotification:Lcom/android/systemui/pip/tv/PipNotification;
...
.method movePipToFullscreen()V
    ...
    invoke-virtual {p0, v0}, resizePinnedStack(I)V
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-direct {p0, p1}, loadConfigurationsAndApply(Landroid/content/res/Configuration;)V

    iget-object p1, p0, mPipNotification:Lcom/android/systemui/pip/tv/PipNotification;
...
.method resizePinnedStack(I)V
    ...
    :cond_2
    iget v3, p0, mSuspendPipResizingReason:I

    if-eqz v3, :cond_4

    iput p1, p0, mResumeResizePinnedStackRunnableState:I
    ...
    iget-object p1, p0, mPipBounds:Landroid/graphics/Rect;
    ...
    :cond_5
    iget-object p1, p0, mMenuModePipBounds:Landroid/graphics/Rect;
    ...
    iget v3, p0, mPinnedStackId:I

    iget-object v4, p0, mCurrentPipBounds:Landroid/graphics/Rect;
...
.method public resumePipResizing(I)V
    ...
    iput p1, p0, mSuspendPipResizingReason:I

    iget-object p1, p0, mHandler:Landroid/os/Handler;

    iget-object p0, p0, mResizePinnedStackRunnable:Ljava/lang/Runnable;
