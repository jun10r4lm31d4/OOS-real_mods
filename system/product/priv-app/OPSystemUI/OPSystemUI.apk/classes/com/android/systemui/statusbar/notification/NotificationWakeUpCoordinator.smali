...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/statusbar/AmbientPulseManager;Lcom/android/systemui/plugins/statusbar/StatusBarStateController;)V
    ...
    iput-object p2, p0, mAmbientPulseManager:Lcom/android/systemui/statusbar/AmbientPulseManager;
    ...
    iput-object p1, p0, mNotificationVisibility:Lcom/android/systemui/statusbar/notification/NotificationWakeUpCoordinator$mNotificationVisibility$1;

    sget-object p1, Lcom/android/systemui/Interpolators;->FAST_OUT_SLOW_IN_REVERSE:Landroid/view/animation/Interpolator;

    iput-object p1, p0, mVisibilityInterpolator:Landroid/view/animation/Interpolator;

    new-instance p1, Ljava/util/LinkedHashSet;

    invoke-direct {p1}, Ljava/util/LinkedHashSet;-><init>()V

    iput-object p1, p0, mEntrySetToClearWhenFinished:Ljava/util/Set;
...
.method public static final synthetic access$getMLinearVisibilityAmount$p(Lcom/android/systemui/statusbar/notification/NotificationWakeUpCoordinator;)F
    ...
    iget p0, p0, mLinearVisibilityAmount:F
...
.method public static final synthetic access$setVisibilityAmount(Lcom/android/systemui/statusbar/notification/NotificationWakeUpCoordinator;F)V
    ...
    invoke-direct {p0, p1}, setVisibilityAmount(F)V
...
.method private final handleAnimationFinished()V
    ...
    iget v0, p0, mLinearDozeAmount:F
    ...
    iget v0, p0, mLinearVisibilityAmount:F
    ...
    :cond_0
    iget-object v0, p0, mEntrySetToClearWhenFinished:Ljava/util/Set;
    ...
    :cond_1
    iget-object p0, p0, mEntrySetToClearWhenFinished:Ljava/util/Set;
...
.method private final setNotificationsVisible(ZZZ)V
    ...
    iget-boolean v0, p0, mNotificationsVisible:Z
    ...
    :cond_0
    iput-boolean p1, p0, mNotificationsVisible:Z

    iget-object v0, p0, mDarkAnimator:Landroid/animation/ObjectAnimator;
    ...
    invoke-direct {p0, p1}, notifyAnimationStart(Z)V

    invoke-direct {p0, p3}, startVisibilityAnimation(Z)V
...
.method private final setVisibilityAmount(F)V
    ...
    iput p1, p0, mLinearVisibilityAmount:F

    iget-object v0, p0, mVisibilityInterpolator:Landroid/view/animation/Interpolator;

    invoke-interface {v0, p1}, Landroid/view/animation/Interpolator;->getInterpolation(F)F

    move-result p1

    iput p1, p0, mVisibilityAmount:F

    invoke-direct {p0}, handleAnimationFinished()V

    invoke-direct {p0}, updateDarkAmount()V
...
.method private final startVisibilityAnimation(Z)V
    ...
    iget v0, p0, mNotificationVisibleAmount:F
    ...
    :goto_0
    iput-object v0, p0, mVisibilityInterpolator:Landroid/view/animation/Interpolator;
    ...
    :cond_3
    iget-object v0, p0, mNotificationVisibility:Lcom/android/systemui/statusbar/notification/NotificationWakeUpCoordinator$mNotificationVisibility$1;
    ...
    iput-object v0, p0, mDarkAnimator:Landroid/animation/ObjectAnimator;
...
.method private final updateDarkAmount()V
    ...
    iget v2, p0, mLinearDozeAmount:F

    invoke-static {v0, v2}, Ljava/lang/Math;->min(FF)F

    move-result v0

    iget v2, p0, mVisibilityAmount:F

    sub-float/2addr v1, v2

    iget v2, p0, mDozeAmount:F
...
.method private final updateNotificationVisibility(ZZ)V
    ...
    iget-boolean v0, p0, mNotificationsVisibleForExpansion:Z
    ...
    iget-boolean v1, p0, mNotificationsVisible:Z

    if-eqz v1, :cond_3

    iget-boolean v1, p0, mWakingUp:Z

    if-nez v1, :cond_2

    iget-boolean v1, p0, willWakeUp:Z

    if-eqz v1, :cond_3

    :cond_2
    iget v1, p0, mDozeAmount:F
    ...
    :cond_3
    invoke-direct {p0, v0, p1, p2}, setNotificationsVisible(ZZZ)V
...
.method public onAmbientStateChanged(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;Z)V
    ...
    invoke-direct {p0}, shouldAnimateVisibility()Z
    ...
    iget p2, p0, mLinearDozeAmount:F
    ...
    iget p2, p0, mLinearVisibilityAmount:F
    ...
    :cond_0
    iget-boolean p2, p0, mWakingUp:Z

    if-nez p2, :cond_2

    iget-boolean p2, p0, willWakeUp:Z
    ...
    iget-object p2, p0, mEntrySetToClearWhenFinished:Ljava/util/Set;
    ...
    :cond_2
    :goto_0
    invoke-direct {p0, v0, v1}, updateNotificationVisibility(ZZ)V
...
.method public onDozeAmountChanged(FF)V
    ...
    iget v1, p0, mLinearDozeAmount:F
    ...
    :goto_0
    invoke-direct {p0, v0}, notifyAnimationStart(Z)V

    :cond_2
    iput p1, p0, mLinearDozeAmount:F

    iput p2, p0, mDozeAmount:F

    iget-object p2, p0, mStackScroller:Lcom/android/systemui/statusbar/notification/stack/NotificationStackScrollLayout;
    ...
    invoke-direct {p0, v3, v3, v3}, setNotificationsVisible(ZZZ)V

    invoke-virtual {p0, v3, v3, v3}, setNotificationsVisibleForExpansion(ZZZ)V
...
.method public onDozingChanged(Z)V
    ...
    invoke-direct {p0, p1, p1, p1}, setNotificationsVisible(ZZZ)V
...
.method public final setNotificationsVisibleForExpansion(ZZZ)V
    ...
    iput-boolean p1, p0, mNotificationsVisibleForExpansion:Z

    invoke-direct {p0, p2, p3}, updateNotificationVisibility(ZZ)V

    if-nez p1, :cond_0

    iget-boolean p1, p0, mNotificationsVisible:Z
...
.method public final setPulsing(Z)V
    ...
    invoke-direct {p0, p1, v0}, updateNotificationVisibility(ZZ)V
...
.method public final setWakingUp(Z)V
    ...
    invoke-virtual {p0, v0}, setWillWakeUp(Z)V

    iput-boolean p1, p0, mWakingUp:Z
    ...
    iget-boolean p1, p0, mNotificationsVisibleForExpansion:Z
...
.method public final setWillWakeUp(Z)V
    ...
    :cond_0
    iput-boolean p1, p0, willWakeUp:Z
