...
.method constructor <init>(Landroid/content/Context;Lcom/android/settingslib/wifi/WifiTracker$WifiListener;Landroid/net/wifi/WifiManager;Landroid/net/ConnectivityManager;Landroid/net/NetworkScoreManager;Landroid/content/IntentFilter;)V
    ...
    iput-object v0, p0, mConnected:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v0, p0, mInternalAccessPoints:Ljava/util/List;

    new-instance v0, Landroid/util/ArraySet;

    invoke-direct {v0}, Landroid/util/ArraySet;-><init>()V

    iput-object v0, p0, mRequestedScores:Ljava/util/Set;

    const/4 v0, 0x1

    iput-boolean v0, p0, mStaleScanResults:Z

    iput-boolean v0, p0, mLastScanSucceeded:Z

    new-instance v2, Ljava/util/HashMap;

    invoke-direct {v2}, Ljava/util/HashMap;-><init>()V

    iput-object v2, p0, mScanResultCache:Ljava/util/HashMap;
    ...
    iput-object p3, p0, mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    iput-object p1, p0, mListener:Lcom/android/settingslib/wifi/WifiTracker$WifiListenerExecutor;

    iput-object p4, p0, mConnectivityManager:Landroid/net/ConnectivityManager;
    ...
    :cond_0
    sput-boolean v1, sVerboseLogging:Z

    iput-object p6, p0, mFilter:Landroid/content/IntentFilter;
    ...
    iput-object p1, p0, mNetworkRequest:Landroid/net/NetworkRequest;

    iput-object p5, p0, mNetworkScoreManager:Landroid/net/NetworkScoreManager;
    ...
    invoke-virtual {p0, p1}, setWorkThread(Landroid/os/HandlerThread;)V
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/settingslib/wifi/WifiTracker$WifiListener;ZZ)V
    ...
    invoke-static {}, newIntentFilter()Landroid/content/IntentFilter;
    ...
    invoke-direct/range {v0 .. v6}, <init>(Landroid/content/Context;Lcom/android/settingslib/wifi/WifiTracker$WifiListener;Landroid/net/wifi/WifiManager;Landroid/net/ConnectivityManager;Landroid/net/NetworkScoreManager;Landroid/content/IntentFilter;)V
...
.method static synthetic access$000(Lcom/android/settingslib/wifi/WifiTracker;)Z
    ...
    iget-boolean p0, p0, mRegistered:Z
...
.method static synthetic access$100(Lcom/android/settingslib/wifi/WifiTracker;)V
    ...
    invoke-direct {p0}, updateNetworkScores()V
...
.method static synthetic access$500(Lcom/android/settingslib/wifi/WifiTracker;I)V
    ...
    invoke-direct {p0, p1}, updateWifiState(I)V
...
.method static synthetic access$602(Lcom/android/settingslib/wifi/WifiTracker;Z)Z
    ...
    iput-boolean p1, p0, mStaleScanResults:Z
...
.method static synthetic access$702(Lcom/android/settingslib/wifi/WifiTracker;Z)Z
    ...
    iput-boolean p1, p0, mLastScanSucceeded:Z
...
.method static synthetic access$800(Lcom/android/settingslib/wifi/WifiTracker;)V
    ...
    invoke-direct {p0}, fetchScansAndConfigsAndUpdateAccessPoints()V
...
.method static synthetic access$900(Lcom/android/settingslib/wifi/WifiTracker;Landroid/net/NetworkInfo;)V
    ...
    invoke-direct {p0, p1}, updateNetworkInfo(Landroid/net/NetworkInfo;)V
...
.method private clearAccessPointsAndConditionallyUpdate()V
    ...
    :try_start_0
    iget-object v1, p0, mInternalAccessPoints:Ljava/util/List;
    ...
    invoke-direct {p0}, conditionallyNotifyListeners()V
...
.method private conditionallyNotifyListeners()V
    ...
    iget-boolean v0, p0, mStaleScanResults:Z
    ...
    :cond_0
    iget-object p0, p0, mListener:Lcom/android/settingslib/wifi/WifiTracker$WifiListenerExecutor;
...
.method private evictOldScans()V
    ...
    iget-boolean v0, p0, mLastScanSucceeded:Z
    ...
    iget-object p0, p0, mScanResultCache:Ljava/util/HashMap;
...
.method private fetchScansAndConfigsAndUpdateAccessPoints()V
    ...
    invoke-direct {p0, v0}, filterScanResultsByCapabilities(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-direct {p0, v0, v1}, updateAccessPoints(Ljava/util/List;Ljava/util/List;)V
...
.method private getCachedOrCreate(Ljava/util/List;Ljava/util/List;)Lcom/android/settingslib/wifi/AccessPoint;
    ...
    invoke-direct {p0, p2, v0}, getCachedByKey(Ljava/util/List;Ljava/lang/String;)Lcom/android/settingslib/wifi/AccessPoint;
...
.method private getCachedOrCreateOsu(Landroid/net/wifi/hotspot2/OsuProvider;Ljava/util/List;Ljava/util/List;)Lcom/android/settingslib/wifi/AccessPoint;
    ...
    invoke-direct {p0, p3, v0}, getCachedByKey(Ljava/util/List;Ljava/lang/String;)Lcom/android/settingslib/wifi/AccessPoint;
...
.method private getCachedOrCreatePasspoint(Landroid/net/wifi/WifiConfiguration;Ljava/util/List;Ljava/util/List;Ljava/util/List;)Lcom/android/settingslib/wifi/AccessPoint;
    ...
    invoke-direct {p0, p4, v0}, getCachedByKey(Ljava/util/List;Ljava/lang/String;)Lcom/android/settingslib/wifi/AccessPoint;
...
.method private getWifiConfigurationForNetworkId(ILjava/util/List;)Landroid/net/wifi/WifiConfiguration;
    ...
    iget-object v1, p0, mLastInfo:Landroid/net/wifi/WifiInfo;
...
.method private static isVerboseLoggingEnabled()Z
    ...
    sget-boolean v0, sVerboseLogging:Z
...
.method private pauseScanning()V
    ...
    :try_start_0
    iget-object v1, p0, mScanner:Lcom/android/settingslib/wifi/WifiTracker$Scanner;
    ...
    iput-object v1, p0, mScanner:Lcom/android/settingslib/wifi/WifiTracker$Scanner;
...
.method private registerScoreCache()V
    ...
    iget-object v0, p0, mNetworkScoreManager:Landroid/net/NetworkScoreManager;

    iget-object p0, p0, mScoreCache:Landroid/net/wifi/WifiNetworkScoreCache;
...
.method private requestScoresForNetworkKeys(Ljava/util/Collection;)V
    ...
    :try_start_0
    iget-object p0, p0, mRequestedScores:Ljava/util/Set;
...
.method private unregisterScoreCache()V
    ...
    iget-object v1, p0, mScoreCache:Landroid/net/wifi/WifiNetworkScoreCache;
...
.method private updateAccessPoints(Ljava/util/List;Ljava/util/List;)V
    ...
    iget-object v2, p0, mLastInfo:Landroid/net/wifi/WifiInfo;
    ...
    invoke-direct {p0, v1, p2}, getWifiConfigurationForNetworkId(ILjava/util/List;)Landroid/net/wifi/WifiConfiguration;
    ...
    :try_start_0
    invoke-direct {p0, p1}, updateScanResultCache(Ljava/util/List;)Landroid/util/ArrayMap;

    move-result-object p1

    new-instance v3, Ljava/util/ArrayList;

    iget-object v4, p0, mInternalAccessPoints:Ljava/util/List;
    ...
    :cond_2
    invoke-virtual {p0, v8, v3}, getCachedOrCreate(Landroid/net/wifi/WifiConfiguration;Ljava/util/List;)Lcom/android/settingslib/wifi/AccessPoint;

    move-result-object v8

    iget-object v9, p0, mLastInfo:Landroid/net/wifi/WifiInfo;

    if-eqz v9, :cond_3

    iget-object v9, p0, mLastNetworkInfo:Landroid/net/NetworkInfo;

    if-eqz v9, :cond_3

    iget-object v9, p0, mLastInfo:Landroid/net/wifi/WifiInfo;

    iget-object v10, p0, mLastNetworkInfo:Landroid/net/NetworkInfo;
    ...
    invoke-direct {p0, v8, v10}, SecurityMatch(Lcom/android/settingslib/wifi/AccessPoint;Landroid/net/wifi/ScanResult;)Z
    ...
    iget-object v10, p0, mRequestedScores:Ljava/util/Set;
    ...
    invoke-direct {p0, p2, v3}, getCachedOrCreate(Ljava/util/List;Ljava/util/List;)Lcom/android/settingslib/wifi/AccessPoint;

    move-result-object p2

    iget-object v8, p0, mLastInfo:Landroid/net/wifi/WifiInfo;

    if-eqz v8, :cond_d

    iget-object v8, p0, mLastNetworkInfo:Landroid/net/NetworkInfo;
    ...
    iget-object p2, p0, mScanResultCache:Ljava/util/HashMap;
    ...
    iget-object p2, p0, mWifiManager:Landroid/net/wifi/WifiManager;

    invoke-virtual {p2, p1}, Landroid/net/wifi/WifiManager;->getAllMatchingWifiConfigs(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    invoke-virtual {p0, p2, v3}, updatePasspointAccessPoints(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {p0, p1, v3}, updateOsuAccessPoints(Ljava/util/Map;Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    invoke-virtual {v4, p1}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    iget-object p1, p0, mLastInfo:Landroid/net/wifi/WifiInfo;

    if-eqz p1, :cond_f

    iget-object p1, p0, mLastNetworkInfo:Landroid/net/NetworkInfo;
    ...
    iget-object v0, p0, mLastInfo:Landroid/net/wifi/WifiInfo;

    iget-object v3, p0, mLastNetworkInfo:Landroid/net/NetworkInfo;
    ...
    iget-object p2, p0, mLastInfo:Landroid/net/wifi/WifiInfo;

    iget-object v0, p0, mLastNetworkInfo:Landroid/net/NetworkInfo;
    ...
    :cond_10
    invoke-direct {p0, v5}, requestScoresForNetworkKeys(Ljava/util/Collection;)V
    ...
    iget-object v0, p0, mScoreCache:Landroid/net/wifi/WifiNetworkScoreCache;

    iget-boolean v1, p0, mNetworkScoringUiEnabled:Z

    iget-wide v8, p0, mMaxSpeedLabelScoreCacheAge:J
    ...
    iget-object p1, p0, mInternalAccessPoints:Ljava/util/List;
...
.method private updateNetworkInfo(Landroid/net/NetworkInfo;)V
    ...
    invoke-virtual {p0}, isWifiEnabled()Z

    move-result v0

    if-nez v0, :cond_0

    invoke-direct {p0}, clearAccessPointsAndConditionallyUpdate()V
    ...
    iput-object p1, p0, mLastNetworkInfo:Landroid/net/NetworkInfo;
    ...
    iget-object v1, p0, mLastNetworkInfo:Landroid/net/NetworkInfo;
    ...
    iget-object v1, p0, mConnected:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object p1, p0, mListener:Lcom/android/settingslib/wifi/WifiTracker$WifiListenerExecutor;
    ...
    iput-object v0, p0, mLastInfo:Landroid/net/wifi/WifiInfo;
    ...
    invoke-direct {p0, p1, v0}, getWifiConfigurationForNetworkId(ILjava/util/List;)Landroid/net/wifi/WifiConfiguration;
    ...
    iget-object v5, p0, mInternalAccessPoints:Ljava/util/List;
    ...
    iget-object v7, p0, mLastInfo:Landroid/net/wifi/WifiInfo;
    ...
    :cond_6
    :goto_2
    iget-object v6, p0, mScoreCache:Landroid/net/wifi/WifiNetworkScoreCache;

    iget-boolean v7, p0, mNetworkScoringUiEnabled:Z
...
.method private updateNetworkScores()V
    ...
    :goto_0
    :try_start_0
    iget-object v3, p0, mInternalAccessPoints:Ljava/util/List;
    ...
    iget-object v4, p0, mScoreCache:Landroid/net/wifi/WifiNetworkScoreCache;

    iget-boolean v5, p0, mNetworkScoringUiEnabled:Z

    iget-wide v6, p0, mMaxSpeedLabelScoreCacheAge:J
...
.method private updateScanResultCache(Ljava/util/List;)Landroid/util/ArrayMap;
    ...
    :cond_1
    iget-object v1, p0, mScanResultCache:Ljava/util/HashMap;
    ...
    :cond_2
    invoke-direct {p0}, evictOldScans()V
...
.method private updateWifiState(I)V
    ...
    iput-object v0, p0, mLastNetworkInfo:Landroid/net/NetworkInfo;
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    invoke-virtual {p0}, getAccessPoints()Ljava/util/List;
...
.method public getAccessPoints()Ljava/util/List;
    ...
    iget-object p0, p0, mInternalAccessPoints:Ljava/util/List;
...
.method public onDestroy()V
    ...
    iget-object p0, p0, mWorkThread:Landroid/os/HandlerThread;
...
.method public onStart()V
    ...
    invoke-virtual {p0}, forceUpdate()V

    invoke-direct {p0}, registerScoreCache()V
    ...
    :cond_0
    iput-boolean v1, p0, mNetworkScoringUiEnabled:Z
    ...
    iput-wide v0, p0, mMaxSpeedLabelScoreCacheAge:J

    invoke-virtual {p0}, resumeScanning()V
    ...
    iget-object v3, p0, mFilter:Landroid/content/IntentFilter;

    iget-object v4, p0, mWorkHandler:Landroid/os/Handler;
    ...
    iput-object v0, p0, mNetworkCallback:Lcom/android/settingslib/wifi/WifiTracker$WifiTrackerNetworkCallback;

    iget-object v0, p0, mConnectivityManager:Landroid/net/ConnectivityManager;

    iget-object v1, p0, mNetworkRequest:Landroid/net/NetworkRequest;

    iget-object v3, p0, mNetworkCallback:Lcom/android/settingslib/wifi/WifiTracker$WifiTrackerNetworkCallback;
...
.method public onStop()V
    ...
    iget-object v1, p0, mNetworkCallback:Lcom/android/settingslib/wifi/WifiTracker$WifiTrackerNetworkCallback;
    ...
    :cond_0
    invoke-direct {p0}, unregisterScoreCache()V

    invoke-direct {p0}, pauseScanning()V

    iget-object p0, p0, mWorkHandler:Landroid/os/Handler;
...
.method public resumeScanning()V
    ...
    iget-object p0, p0, mScanner:Lcom/android/settingslib/wifi/WifiTracker$Scanner;
...
.method setWorkThread(Landroid/os/HandlerThread;)V
    ...
    iput-object p1, p0, mWorkThread:Landroid/os/HandlerThread;
    ...
    iput-object v0, p0, mWorkHandler:Landroid/os/Handler;
    ...
    iget-object v2, p0, mWorkHandler:Landroid/os/Handler;
    ...
    iput-object p1, p0, mScoreCache:Landroid/net/wifi/WifiNetworkScoreCache;
...
.method updateOsuAccessPoints(Ljava/util/Map;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-direct {p0, v3, v4, p2}, getCachedOrCreateOsu(Landroid/net/wifi/hotspot2/OsuProvider;Ljava/util/List;Ljava/util/List;)Lcom/android/settingslib/wifi/AccessPoint;
...
.method updatePasspointAccessPoints(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-direct {p0, v3, v4, v2, p2}, getCachedOrCreatePasspoint(Landroid/net/wifi/WifiConfiguration;Ljava/util/List;Ljava/util/List;Ljava/util/List;)Lcom/android/settingslib/wifi/AccessPoint;
