...
.method constructor <init>(Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;ZLcom/android/systemui/statusbar/notification/row/NotificationContentInflater$ApplyCallback;Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;Ljava/util/HashMap;ILcom/android/systemui/statusbar/notification/row/NotificationContentInflater$InflationProgress;ILandroid/util/ArrayMap;Lcom/android/systemui/statusbar/notification/row/NotificationContentInflater$InflationCallback;ZLandroid/view/View;Landroid/widget/RemoteViews;Lcom/android/systemui/statusbar/notification/row/NotificationContentView;Landroid/widget/RemoteViews$OnClickHandler;)V
    ...
    iput-object p1, p0, val$row:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;

    iput-boolean p2, p0, val$isNewView:Z

    iput-object p3, p0, val$applyCallback:Lcom/android/systemui/statusbar/notification/row/NotificationContentInflater$ApplyCallback;

    iput-object p4, p0, val$existingWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;

    iput-object p5, p0, val$runningInflations:Ljava/util/HashMap;

    iput p6, p0, val$inflationId:I

    iput-object p7, p0, val$result:Lcom/android/systemui/statusbar/notification/row/NotificationContentInflater$InflationProgress;

    iput p8, p0, val$reInflateFlags:I

    iput-object p9, p0, val$cachedContentViews:Landroid/util/ArrayMap;

    iput-object p10, p0, val$callback:Lcom/android/systemui/statusbar/notification/row/NotificationContentInflater$InflationCallback;

    iput-boolean p11, p0, val$redactAmbient:Z

    iput-object p12, p0, val$existingView:Landroid/view/View;

    iput-object p13, p0, val$newContentView:Landroid/widget/RemoteViews;

    iput-object p14, p0, val$parentLayout:Lcom/android/systemui/statusbar/notification/row/NotificationContentView;

    iput-object p15, p0, val$remoteViewClickHandler:Landroid/widget/RemoteViews$OnClickHandler;
...
.method public onError(Ljava/lang/Exception;)V
    ...
    :try_start_0
    iget-object v0, p0, val$existingView:Landroid/view/View;

    iget-boolean v1, p0, val$isNewView:Z

    if-eqz v1, :cond_0

    iget-object v0, p0, val$newContentView:Landroid/widget/RemoteViews;

    iget-object v1, p0, val$result:Lcom/android/systemui/statusbar/notification/row/NotificationContentInflater$InflationProgress;
    ...
    iget-object v2, p0, val$parentLayout:Lcom/android/systemui/statusbar/notification/row/NotificationContentView;

    iget-object v3, p0, val$remoteViewClickHandler:Landroid/widget/RemoteViews$OnClickHandler;
    ...
    :cond_0
    iget-object v1, p0, val$newContentView:Landroid/widget/RemoteViews;

    iget-object v2, p0, val$result:Lcom/android/systemui/statusbar/notification/row/NotificationContentInflater$InflationProgress;
    ...
    iget-object v3, p0, val$existingView:Landroid/view/View;

    iget-object v4, p0, val$remoteViewClickHandler:Landroid/widget/RemoteViews$OnClickHandler;
    ...
    invoke-virtual {p0, v0}, onViewApplied(Landroid/view/View;)V
    :try_end_0
    ...
    :catch_0
    iget-object v0, p0, val$runningInflations:Ljava/util/HashMap;

    iget v1, p0, val$inflationId:I
    ...
    iget-object v1, p0, val$row:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;
    ...
    iget-object p0, p0, val$callback:Lcom/android/systemui/statusbar/notification/row/NotificationContentInflater$InflationCallback;
...
.method public onViewApplied(Landroid/view/View;)V
    ...
    iget-boolean v0, p0, val$isNewView:Z
    ...
    iget-object v0, p0, val$applyCallback:Lcom/android/systemui/statusbar/notification/row/NotificationContentInflater$ApplyCallback;
    ...
    :cond_0
    iget-object p1, p0, val$existingWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
    ...
    :cond_1
    :goto_0
    iget-object p1, p0, val$runningInflations:Ljava/util/HashMap;

    iget v0, p0, val$inflationId:I
    ...
    iget v2, p0, val$reInflateFlags:I

    iget-object v3, p0, val$cachedContentViews:Landroid/util/ArrayMap;

    iget-object v4, p0, val$runningInflations:Ljava/util/HashMap;

    iget-object v5, p0, val$callback:Lcom/android/systemui/statusbar/notification/row/NotificationContentInflater$InflationCallback;

    iget-object v6, p0, val$row:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;

    iget-boolean v7, p0, val$redactAmbient:Z
...
.method public onViewInflated(Landroid/view/View;)V
    ...
    iget-object p0, p0, val$row:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;
