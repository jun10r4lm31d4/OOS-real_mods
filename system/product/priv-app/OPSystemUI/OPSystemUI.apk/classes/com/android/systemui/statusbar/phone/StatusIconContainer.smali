...
.method static constructor <clinit>()V
    ...
    sput-object v0, X_ANIMATION_PROPERTIES:Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;
    ...
    sput-object v0, ANIMATE_ALL_PROPERTIES:Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput p1, p0, DELAY_INTERVAL:I

    const/4 p1, 0x0

    iput p1, p0, mReRequestLayoutTimes:I

    const/4 p2, 0x2

    iput p2, p0, MAX_RETRY_TIMES:I

    iput p1, p0, mUnderflowStart:I

    const/4 p1, 0x1

    iput-boolean p1, p0, mShouldRestrictIcons:Z

    new-instance p2, Ljava/util/ArrayList;

    invoke-direct {p2}, Ljava/util/ArrayList;-><init>()V

    iput-object p2, p0, mLayoutStates:Ljava/util/ArrayList;

    new-instance p2, Ljava/util/ArrayList;

    invoke-direct {p2}, Ljava/util/ArrayList;-><init>()V

    iput-object p2, p0, mMeasureViews:Ljava/util/ArrayList;

    new-instance p2, Ljava/util/ArrayList;

    invoke-direct {p2}, Ljava/util/ArrayList;-><init>()V

    iput-object p2, p0, mIgnoredSlots:Ljava/util/ArrayList;

    const-string p2, ""

    iput-object p2, p0, mOpTag:Ljava/lang/String;
    ...
    iput-object p2, p0, mReRequestLayout:Ljava/lang/Runnable;
...
.method static synthetic access$000(Lcom/android/systemui/statusbar/phone/StatusIconContainer;)Ljava/lang/Runnable;
    ...
    iget-object p0, p0, mReRequestLayout:Ljava/lang/Runnable;
...
.method static synthetic access$200(Lcom/android/systemui/statusbar/phone/StatusIconContainer;)I
    ...
    iget p0, p0, mReRequestLayoutTimes:I
...
.method static synthetic access$208(Lcom/android/systemui/statusbar/phone/StatusIconContainer;)I
    ...
    iget v0, p0, mReRequestLayoutTimes:I

    add-int/lit8 v1, v0, 0x1

    iput v1, p0, mReRequestLayoutTimes:I
...
.method static synthetic access$400()Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;
    ...
    sget-object v0, X_ANIMATION_PROPERTIES:Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;
...
.method private applyIconStates()V
    ...
    invoke-static {v1}, getViewStateFromChild(Landroid/view/View;)Lcom/android/systemui/statusbar/phone/StatusIconContainer$StatusIconState;
...
.method private calculateIconTranslations()V
    ...
    iget-object v0, p0, mLayoutStates:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    invoke-direct {p0}, getOpWidth()I
    ...
    invoke-static {v7}, getViewStateFromChild(Landroid/view/View;)Lcom/android/systemui/statusbar/phone/StatusIconContainer$StatusIconState;
    ...
    iget-object v10, p0, mIgnoredSlots:Ljava/util/ArrayList;
    ...
    invoke-static {v7}, getViewTotalWidth(Landroid/view/View;)I
    ...
    iget-object v5, p0, mLayoutStates:Ljava/util/ArrayList;
    ...
    :cond_2
    iget-object v1, p0, mLayoutStates:Ljava/util/ArrayList;
    ...
    iget-object v10, p0, mLayoutStates:Ljava/util/ArrayList;
    ...
    :cond_4
    iget-boolean v11, p0, mShouldRestrictIcons:Z
    ...
    iget v2, p0, mStaticDotDiameter:I

    iget v4, p0, mDotPadding:I

    add-int/2addr v2, v4

    iget v4, p0, mUnderflowStart:I

    iget v8, p0, mUnderflowWidth:I

    add-int/2addr v4, v8

    iget v8, p0, mIconDotFrameWidth:I
    ...
    iget-object v9, p0, mLayoutStates:Ljava/util/ArrayList;
...
.method private getOpMaxWidth(I)I
    ...
    iget-object v0, p0, mOpTag:Ljava/lang/String;
...
.method private getOpWidth()I
    ...
    invoke-direct {p0, v0}, getOpMaxWidth(I)I
...
.method private initDimens()V
    ...
    iput v0, p0, mIconDotFrameWidth:I
    ...
    iget v0, p0, mIconDotFrameWidth:I
...
.method private resetViewStates()V
    ...
    invoke-static {v2}, getViewStateFromChild(Landroid/view/View;)Lcom/android/systemui/statusbar/phone/StatusIconContainer$StatusIconState;
...
.method public isRestrictingIcons()Z
    ...
    iget-boolean p0, p0, mShouldRestrictIcons:Z
...
.method protected onLayout(ZIIII)V
    ...
    :cond_0
    invoke-direct {p0}, resetViewStates()V

    invoke-direct {p0}, calculateIconTranslations()V

    invoke-direct {p0}, applyIconStates()V
...
.method protected onMeasure(II)V
    ...
    iget-object v0, p0, mMeasureViews:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, p1}, getOpMaxWidth(I)I
    ...
    iget-object v5, p0, mIgnoredSlots:Ljava/util/ArrayList;
    ...
    iget-object v5, p0, mMeasureViews:Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object v1, p0, mMeasureViews:Ljava/util/ArrayList;
    ...
    iget-boolean v7, p0, mShouldRestrictIcons:Z
    ...
    :goto_2
    iput-boolean v3, p0, mNeedsUnderflow:Z
    ...
    :goto_3
    iget-object v9, p0, mMeasureViews:Ljava/util/ArrayList;
    ...
    iget-boolean v10, p0, mShouldRestrictIcons:Z
    ...
    invoke-static {v9}, getViewTotalMeasuredWidth(Landroid/view/View;)I
    ...
    iget-boolean v0, p0, mNeedsUnderflow:Z

    if-nez v0, :cond_8

    if-le v5, p1, :cond_8

    iput-boolean v8, p0, mNeedsUnderflow:Z
...
.method public setOpTag(Ljava/lang/String;)V
    ...
    iput-object p1, p0, mOpTag:Ljava/lang/String;
