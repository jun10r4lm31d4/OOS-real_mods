...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p2, p0, mTmpRect:Landroid/graphics/RectF;

    new-instance p2, Landroid/graphics/Paint;

    invoke-direct {p2}, Landroid/graphics/Paint;-><init>()V

    iput-object p2, p0, mTmpPaint:Landroid/graphics/Paint;
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-wide v10, p0, mLimitLevel:J
    ...
    iget v4, p0, mUsageColor:I

    invoke-virtual {v1, v4}, Landroid/graphics/Paint;->setColor(I)V

    invoke-virtual {p1, v0, v1}, Landroid/graphics/Canvas;->drawRect(Landroid/graphics/RectF;Landroid/graphics/Paint;)V

    iget-wide v6, p0, mWarningLevel:J

    long-to-float v4, v6

    iget-wide v6, p0, mMaxLevel:J
...
.method public setLevels(JJJ)V
    ...
    iput-wide p1, p0, mLimitLevel:J

    invoke-static {v0, v1, p3, p4}, Ljava/lang/Math;->max(JJ)J

    move-result-wide p1

    iput-wide p1, p0, mWarningLevel:J

    invoke-static {v0, v1, p5, p6}, Ljava/lang/Math;->max(JJ)J

    move-result-wide p1

    iput-wide p1, p0, mUsageLevel:J

    iget-wide p1, p0, mLimitLevel:J

    iget-wide p3, p0, mWarningLevel:J

    invoke-static {p1, p2, p3, p4}, Ljava/lang/Math;->max(JJ)J

    move-result-wide p1

    iget-wide p3, p0, mUsageLevel:J
