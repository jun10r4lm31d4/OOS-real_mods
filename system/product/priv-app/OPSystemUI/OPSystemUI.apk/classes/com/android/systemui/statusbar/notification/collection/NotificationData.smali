...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mNotificationFilter:Lcom/android/systemui/statusbar/notification/NotificationFilter;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, mEntries:Landroid/util/ArrayMap;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mSortedAndFiltered:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mFilteredForUser:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, mTmpRanking:Landroid/service/notification/NotificationListenerService$Ranking;
    ...
    iput-object v0, p0, mRankingComparator:Ljava/util/Comparator;
...
.method static synthetic access$000(Lcom/android/systemui/statusbar/notification/collection/NotificationData;)Landroid/service/notification/NotificationListenerService$RankingMap;
    ...
    iget-object p0, p0, mRankingMap:Landroid/service/notification/NotificationListenerService$RankingMap;
...
.method static synthetic access$100(Lcom/android/systemui/statusbar/notification/collection/NotificationData;)Lcom/android/systemui/statusbar/NotificationMediaManager;
    ...
    invoke-direct {p0}, getMediaManager()Lcom/android/systemui/statusbar/NotificationMediaManager;
...
.method static synthetic access$200(Landroid/service/notification/StatusBarNotification;)Z
    ...
    invoke-static {p0}, isSystemNotification(Landroid/service/notification/StatusBarNotification;)Z
...
.method private dumpEntry(Ljava/io/PrintWriter;Ljava/lang/String;ILcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V
    ...
    iget-object v1, p0, mTmpRanking:Landroid/service/notification/NotificationListenerService$Ranking;

    invoke-virtual {p0, v0, v1}, getRanking(Ljava/lang/String;Landroid/service/notification/NotificationListenerService$Ranking;)Z
    ...
    iget-object p0, p0, mTmpRanking:Landroid/service/notification/NotificationListenerService$Ranking;
...
.method private getEnvironment()Lcom/android/systemui/statusbar/notification/collection/NotificationData$KeyguardEnvironment;
    ...
    iget-object v0, p0, mEnvironment:Lcom/android/systemui/statusbar/notification/collection/NotificationData$KeyguardEnvironment;
    ...
    iput-object v0, p0, mEnvironment:Lcom/android/systemui/statusbar/notification/collection/NotificationData$KeyguardEnvironment;

    :cond_0
    iget-object p0, p0, mEnvironment:Lcom/android/systemui/statusbar/notification/collection/NotificationData$KeyguardEnvironment;
...
.method private hasHighPriorityCharacteristics(Landroid/app/NotificationChannel;Landroid/service/notification/StatusBarNotification;)Z
    ...
    invoke-direct {p0, v0}, isImportantOngoing(Landroid/app/Notification;)Z
    ...
    invoke-direct {p0, v0}, hasPerson(Landroid/app/Notification;)Z
    ...
    invoke-direct {p0, p2, v0}, hasStyle(Landroid/app/Notification;Ljava/lang/Class;)Z
...
.method private updateRankingAndSort(Landroid/service/notification/NotificationListenerService$RankingMap;)V
    ...
    iput-object p1, p0, mRankingMap:Landroid/service/notification/NotificationListenerService$RankingMap;

    iget-object p1, p0, mEntries:Landroid/util/ArrayMap;

    monitor-enter p1

    :try_start_0
    iget-object v0, p0, mEntries:Landroid/util/ArrayMap;
    ...
    iget-object v2, p0, mEntries:Landroid/util/ArrayMap;
    ...
    iget-object v4, p0, mTmpRanking:Landroid/service/notification/NotificationListenerService$Ranking;

    invoke-virtual {p0, v3, v4}, getRanking(Ljava/lang/String;Landroid/service/notification/NotificationListenerService$Ranking;)Z
    ...
    invoke-virtual {p0, v4}, getOverrideGroupKey(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_1
    iget-object v3, p0, mTmpRanking:Landroid/service/notification/NotificationListenerService$Ranking;
    ...
    invoke-virtual {p0, v3}, isHighPriority(Landroid/service/notification/StatusBarNotification;)Z
    ...
    :cond_3
    :goto_2
    invoke-virtual {p0}, filterAndSort()V
...
.method public add(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V
    ...
    :try_start_0
    iget-object v1, p0, mEntries:Landroid/util/ArrayMap;
    ...
    iget-object p1, p0, mRankingMap:Landroid/service/notification/NotificationListenerService$RankingMap;

    invoke-direct {p0, p1}, updateRankingAndSort(Landroid/service/notification/NotificationListenerService$RankingMap;)V
...
.method public dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    iget-object v0, p0, mSortedAndFiltered:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, mSortedAndFiltered:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, p1, p2, v2, v3}, dumpEntry(Ljava/io/PrintWriter;Ljava/lang/String;ILcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V
    ...
    :try_start_0
    iget-object v3, p0, mEntries:Landroid/util/ArrayMap;
    ...
    iget-object v4, p0, mEntries:Landroid/util/ArrayMap;
    ...
    iget-object v5, p0, mSortedAndFiltered:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, p1, p2, v2, v4}, dumpEntry(Ljava/io/PrintWriter;Ljava/lang/String;ILcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V
...
.method public get(Ljava/lang/String;)Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;
    ...
    iget-object p0, p0, mEntries:Landroid/util/ArrayMap;
...
.method public getActiveNotifications()Ljava/util/ArrayList;
    ...
    iget-object p0, p0, mSortedAndFiltered:Ljava/util/ArrayList;
...
.method public getNotificationsForCurrentUser()Ljava/util/ArrayList;
    ...
    iget-object v0, p0, mFilteredForUser:Ljava/util/ArrayList;
    ...
    invoke-direct {p0}, getEnvironment()Lcom/android/systemui/statusbar/notification/collection/NotificationData$KeyguardEnvironment;
    ...
    :cond_0
    iget-object v4, p0, mFilteredForUser:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, mFilteredForUser:Ljava/util/ArrayList;
...
.method public getOverrideGroupKey(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v0, p0, mTmpRanking:Landroid/service/notification/NotificationListenerService$Ranking;

    invoke-virtual {p0, p1, v0}, getRanking(Ljava/lang/String;Landroid/service/notification/NotificationListenerService$Ranking;)Z
...
.method public isHighPriority(Landroid/service/notification/StatusBarNotification;)Z
    ...
    invoke-direct {p0, v0, p1}, hasHighPriorityCharacteristics(Landroid/app/NotificationChannel;Landroid/service/notification/StatusBarNotification;)Z
    ...
    invoke-virtual {p0, v0}, isHighPriority(Landroid/service/notification/StatusBarNotification;)Z
...
.method public remove(Ljava/lang/String;Landroid/service/notification/NotificationListenerService$RankingMap;)Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;
    ...
    iget-object p2, p0, mRankingMap:Landroid/service/notification/NotificationListenerService$RankingMap;
    ...
    invoke-direct {p0, p2}, updateRankingAndSort(Landroid/service/notification/NotificationListenerService$RankingMap;)V
...
.method public update(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;Landroid/service/notification/NotificationListenerService$RankingMap;Landroid/service/notification/StatusBarNotification;)V
    ...
    invoke-virtual {p0, p2}, updateRanking(Landroid/service/notification/NotificationListenerService$RankingMap;)V
