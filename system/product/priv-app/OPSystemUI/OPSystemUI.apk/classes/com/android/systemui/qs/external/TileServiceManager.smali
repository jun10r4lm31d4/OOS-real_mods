...
.method constructor <init>(Lcom/android/systemui/qs/external/TileServices;Landroid/os/Handler;Landroid/content/ComponentName;Landroid/service/quicksettings/Tile;)V
    ...
    invoke-direct {p0, p1, p2, v7}, <init>(Lcom/android/systemui/qs/external/TileServices;Landroid/os/Handler;Lcom/android/systemui/qs/external/TileLifecycleManager;)V
...
.method constructor <init>(Lcom/android/systemui/qs/external/TileServices;Landroid/os/Handler;Lcom/android/systemui/qs/external/TileLifecycleManager;)V
    ...
    iput-boolean v0, p0, mPendingBind:Z
    ...
    iput-object v0, p0, mUnbind:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mJustBoundOver:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mUninstallReceiver:Landroid/content/BroadcastReceiver;

    iput-object p1, p0, mServices:Lcom/android/systemui/qs/external/TileServices;

    iput-object p2, p0, mHandler:Landroid/os/Handler;

    iput-object p3, p0, mStateManager:Lcom/android/systemui/qs/external/TileLifecycleManager;
    ...
    iget-object p1, p0, mServices:Lcom/android/systemui/qs/external/TileServices;

    invoke-virtual {p1}, Lcom/android/systemui/qs/external/TileServices;->getContext()Landroid/content/Context;

    move-result-object v1

    iget-object v2, p0, mUninstallReceiver:Landroid/content/BroadcastReceiver;
...
.method static synthetic access$100(Lcom/android/systemui/qs/external/TileServiceManager;)Z
    ...
    iget-boolean p0, p0, mBindRequested:Z
...
.method static synthetic access$200(Lcom/android/systemui/qs/external/TileServiceManager;)V
    ...
    invoke-direct {p0}, unbindService()V
...
.method static synthetic access$302(Lcom/android/systemui/qs/external/TileServiceManager;Z)Z
    ...
    iput-boolean p1, p0, mJustBound:Z
...
.method static synthetic access$500(Lcom/android/systemui/qs/external/TileServiceManager;)Lcom/android/systemui/qs/external/TileLifecycleManager;
    ...
    iget-object p0, p0, mStateManager:Lcom/android/systemui/qs/external/TileLifecycleManager;
...
.method private bindService()V
    ...
    iput-boolean v0, p0, mJustBound:Z

    iget-object v1, p0, mHandler:Landroid/os/Handler;

    iget-object v2, p0, mJustBoundOver:Ljava/lang/Runnable;
...
.method public calculateBindPriority(J)V
    ...
    iget-object v0, p0, mStateManager:Lcom/android/systemui/qs/external/TileLifecycleManager;
    ...
    :cond_0
    iget-boolean v0, p0, mShowingDialog:Z
    ...
    :cond_1
    iget-boolean v0, p0, mJustBound:Z
    ...
    :cond_2
    iget-boolean v0, p0, mBindRequested:Z
...
.method public handleDestroy()V
    ...
    invoke-virtual {p0, v0}, setBindAllowed(Z)V

    iget-object v0, p0, mServices:Lcom/android/systemui/qs/external/TileServices;

    invoke-virtual {v0}, Lcom/android/systemui/qs/external/TileServices;->getContext()Landroid/content/Context;

    move-result-object v0

    iget-object v1, p0, mUninstallReceiver:Landroid/content/BroadcastReceiver;
...
.method public hasPendingBind()Z
    ...
    iget-boolean p0, p0, mPendingBind:Z
...
.method public setBindAllowed(Z)V
    ...
    iget-boolean v0, p0, mBindAllowed:Z
    ...
    :cond_0
    iput-boolean p1, p0, mBindAllowed:Z

    iget-boolean p1, p0, mBindAllowed:Z
    ...
    iget-boolean p1, p0, mBindRequested:Z
...
.method public setBindRequested(Z)V
    ...
    :cond_0
    iput-boolean p1, p0, mBindRequested:Z
    ...
    iget-object v0, p0, mUnbind:Ljava/lang/Runnable;
    ...
    iget-object p0, p0, mUnbind:Ljava/lang/Runnable;
...
.method public setLastUpdate(J)V
    ...
    iput-wide p1, p0, mLastUpdate:J

    iget-boolean p1, p0, mBound:Z

    if-eqz p1, :cond_0

    invoke-virtual {p0}, isActiveTile()Z

    move-result p1

    if-eqz p1, :cond_0

    iget-object p1, p0, mStateManager:Lcom/android/systemui/qs/external/TileLifecycleManager;

    invoke-virtual {p1}, Lcom/android/systemui/qs/external/TileLifecycleManager;->onStopListening()V

    const/4 p1, 0x0

    invoke-virtual {p0, p1}, setBindRequested(Z)V
...
.method public setShowingDialog(Z)V
    ...
    iput-boolean p1, p0, mShowingDialog:Z
...
.method startLifecycleManagerAndAddTile()V
    ...
    iget-object v1, p0, mStateManager:Lcom/android/systemui/qs/external/TileLifecycleManager;

    invoke-virtual {v1}, Lcom/android/systemui/qs/external/TileLifecycleManager;->getComponent()Landroid/content/ComponentName;

    move-result-object v1

    iget-object v2, p0, mServices:Lcom/android/systemui/qs/external/TileServices;
