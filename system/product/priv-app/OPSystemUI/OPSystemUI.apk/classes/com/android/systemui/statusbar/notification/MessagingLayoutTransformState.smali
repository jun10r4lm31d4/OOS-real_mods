...
.method private adaptGroupAppear(Lcom/android/internal/widget/MessagingGroup;FFZ)V
    ...
    iget p0, p0, mRelativeTranslationOffset:F
...
.method private appear(Lcom/android/internal/widget/MessagingGroup;F)V
    ...
    invoke-direct {p0, v2}, isGone(Landroid/view/View;)Z
    ...
    :cond_0
    invoke-direct {p0, v2, p2}, appear(Landroid/view/View;F)V
    ...
    invoke-direct {p0, v0, p2}, appear(Landroid/view/View;F)V
...
.method private disappear(Lcom/android/internal/widget/MessagingGroup;F)V
    ...
    :cond_0
    invoke-direct {p0, v2, p2}, disappear(Landroid/view/View;F)V
    ...
    invoke-direct {p0, v0, p2}, disappear(Landroid/view/View;F)V
...
.method private filterHiddenGroups(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v1}, isGone(Landroid/view/View;)Z
...
.method private findPairs(Ljava/util/ArrayList;Ljava/util/ArrayList;)Ljava/util/HashMap;
    ...
    iget-object v4, p0, mGroupMap:Ljava/util/HashMap;
...
.method private setVisible(Landroid/view/View;ZZ)V
    ...
    invoke-direct {p0, p1}, isGone(Landroid/view/View;)Z
...
.method private transformGroups(Lcom/android/internal/widget/MessagingGroup;Lcom/android/internal/widget/MessagingGroup;FZ)V
    ...
    invoke-direct/range {v0 .. v6}, transformView(FZLandroid/view/View;Landroid/view/View;ZZ)V
    ...
    invoke-direct {v7, v6}, isGone(Landroid/view/View;)Z
    ...
    invoke-direct {v7, v1}, isGone(Landroid/view/View;)Z
...
.method private transformViewInternal(Lcom/android/systemui/statusbar/notification/MessagingLayoutTransformState;FZ)V
    ...
    iget-object v0, p0, mMessagingLayout:Lcom/android/internal/widget/MessagingLayout;

    invoke-virtual {v0}, Lcom/android/internal/widget/MessagingLayout;->getMessagingGroups()Ljava/util/ArrayList;

    move-result-object v0

    invoke-direct {p0, v0}, filterHiddenGroups(Ljava/util/ArrayList;)Ljava/util/ArrayList;

    move-result-object v0

    iget-object p1, p1, mMessagingLayout:Lcom/android/internal/widget/MessagingLayout;

    invoke-virtual {p1}, Lcom/android/internal/widget/MessagingLayout;->getMessagingGroups()Ljava/util/ArrayList;

    move-result-object p1

    invoke-direct {p0, p1}, filterHiddenGroups(Ljava/util/ArrayList;)Ljava/util/ArrayList;

    move-result-object p1

    invoke-direct {p0, v0, p1}, findPairs(Ljava/util/ArrayList;Ljava/util/ArrayList;)Ljava/util/HashMap;
    ...
    invoke-direct {p0, v5}, isGone(Landroid/view/View;)Z
    ...
    invoke-direct {p0, v5, v6, p2, p3}, transformGroups(Lcom/android/internal/widget/MessagingGroup;Lcom/android/internal/widget/MessagingGroup;FZ)V
    ...
    invoke-direct {p0, v5, p2, v4, p3}, adaptGroupAppear(Lcom/android/internal/widget/MessagingGroup;FFZ)V
    ...
    invoke-direct {p0, v5, v6}, disappear(Lcom/android/internal/widget/MessagingGroup;F)V

    goto :goto_4

    :cond_5
    invoke-direct {p0, v5, v6}, appear(Lcom/android/internal/widget/MessagingGroup;F)V
...
.method public initFrom(Landroid/view/View;Lcom/android/systemui/statusbar/notification/TransformState$TransformInfo;)V
    ...
    iput-object p2, p0, mMessageContainer:Lcom/android/internal/widget/MessagingLinearLayout;

    iget-object p2, p0, mMessageContainer:Lcom/android/internal/widget/MessagingLinearLayout;
    ...
    iput-object p2, p0, mMessagingLayout:Lcom/android/internal/widget/MessagingLayout;
    ...
    iput p1, p0, mRelativeTranslationOffset:F
...
.method public prepareFadeIn()V
    ...
    invoke-virtual {p0, v0, v1}, setVisible(ZZ)V
...
.method protected reset()V
    ...
    iput-object v0, p0, mMessageContainer:Lcom/android/internal/widget/MessagingLinearLayout;

    iput-object v0, p0, mMessagingLayout:Lcom/android/internal/widget/MessagingLayout;
...
.method protected resetTransformedView()V
    ...
    invoke-direct {p0, v3}, isGone(Landroid/view/View;)Z
    ...
    invoke-direct {p0, v6}, isGone(Landroid/view/View;)Z
    ...
    :cond_0
    invoke-direct {p0, v6}, resetTransformedView(Landroid/view/View;)V
    ...
    invoke-direct {p0, v4}, resetTransformedView(Landroid/view/View;)V
...
.method public setVisible(ZZ)V
    ...
    invoke-direct {p0, v6, p1, p2}, setVisible(Landroid/view/View;ZZ)V
    ...
    invoke-direct {p0, v4, p1, p2}, setVisible(Landroid/view/View;ZZ)V
    ...
    invoke-direct {p0, v3, p1, p2}, setVisible(Landroid/view/View;ZZ)V
...
.method public transformViewFrom(Lcom/android/systemui/statusbar/notification/TransformState;F)V
    ...
    invoke-direct {p0, p1, p2, v0}, transformViewInternal(Lcom/android/systemui/statusbar/notification/MessagingLayoutTransformState;FZ)V
