...
.method public constructor <init>(Lcom/android/systemui/statusbar/phone/NavigationBarView;)V
    ...
    iput-object v1, p0, mWallpaperVisibilityListener:Landroid/view/IWallpaperVisibilityListener;

    iput-object p1, p0, mView:Lcom/android/systemui/statusbar/phone/NavigationBarView;
    ...
    iput-object v1, p0, mBarService:Lcom/android/internal/statusbar/IStatusBarService;
    ...
    iput-object v1, p0, mLightTransitionsController:Lcom/android/systemui/statusbar/phone/LightBarTransitionsController;
    ...
    iput-boolean p1, p0, mAllowAutoDimWallpaperNotVisible:Z

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, mDarkIntensityListeners:Ljava/util/List;
    ...
    :try_start_0
    iget-object v1, p0, mWallpaperVisibilityListener:Landroid/view/IWallpaperVisibilityListener;
    ...
    iput-boolean p1, p0, mWallpaperVisible:Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0

    :catch_0
    iget-object p1, p0, mView:Lcom/android/systemui/statusbar/phone/NavigationBarView;
    ...
    iput-object p1, p0, mNavButtons:Landroid/view/View;
...
.method static synthetic access$200(Lcom/android/systemui/statusbar/phone/NavigationBarTransitions;ZZ)V
    ...
    invoke-direct {p0, p1, p2}, applyLightsOut(ZZ)V
...
.method private applyLightsOut(ZZ)V
    ...
    invoke-virtual {p0, v0}, isLightsOut(I)Z

    move-result v0

    invoke-direct {p0, v0, p1, p2}, applyLightsOut(ZZZ)V
...
.method private applyLightsOut(ZZZ)V
    ...
    iget-boolean p3, p0, mLightsOut:Z
    ...
    :cond_0
    iput-boolean p1, p0, mLightsOut:Z

    iget-object p3, p0, mNavButtons:Landroid/view/View;
    ...
    iget-object p3, p0, mLightTransitionsController:Lcom/android/systemui/statusbar/phone/LightBarTransitionsController;
    ...
    iget-object p0, p0, mNavButtons:Landroid/view/View;
...
.method public addDarkIntensityListener(Lcom/android/systemui/statusbar/phone/NavigationBarTransitions$DarkIntensityListener;)F
    ...
    iget-object v0, p0, mDarkIntensityListeners:Ljava/util/List;

    invoke-interface {v0, p1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    iget-object p0, p0, mLightTransitionsController:Lcom/android/systemui/statusbar/phone/LightBarTransitionsController;
...
.method public applyDarkIntensity(F)V
    ...
    iget-object v0, p0, mView:Lcom/android/systemui/statusbar/phone/NavigationBarView;
    ...
    iget-object p0, p0, mView:Lcom/android/systemui/statusbar/phone/NavigationBarView;
    ...
    :cond_5
    iget-boolean p1, p0, mAutoDim:Z

    if-eqz p1, :cond_6

    invoke-direct {p0, v1, v2}, applyLightsOut(ZZ)V
...
.method public destroy()V
    ...
    :try_start_0
    iget-object p0, p0, mWallpaperVisibilityListener:Landroid/view/IWallpaperVisibilityListener;
...
.method public init()V
    ...
    invoke-direct {p0, v1, v0}, applyLightsOut(ZZ)V
...
.method protected isLightsOut(I)Z
    ...
    iget-boolean v0, p0, mAllowAutoDimWallpaperNotVisible:Z

    if-eqz v0, :cond_0

    iget-boolean v0, p0, mAutoDim:Z

    if-eqz v0, :cond_0

    iget-boolean p0, p0, mWallpaperVisible:Z
...
.method protected onTransition(IIZ)V
    ...
    invoke-direct {p0, p3, p1}, applyLightsOut(ZZ)V
...
.method public reapplyDarkIntensity()V
    ...
    iget-object v0, p0, mLightTransitionsController:Lcom/android/systemui/statusbar/phone/LightBarTransitionsController;

    invoke-virtual {v0}, Lcom/android/systemui/statusbar/phone/LightBarTransitionsController;->getCurrentDarkIntensity()F

    move-result v0

    invoke-virtual {p0, v0}, applyDarkIntensity(F)V
...
.method public removeDarkIntensityListener(Lcom/android/systemui/statusbar/phone/NavigationBarTransitions$DarkIntensityListener;)V
    ...
    iget-object p0, p0, mDarkIntensityListeners:Ljava/util/List;
...
.method public setAutoDim(Z)V
    ...
    :cond_1
    iput-boolean p1, p0, mAutoDim:Z

    const/4 p1, 0x1

    const/4 v0, 0x0

    invoke-direct {p0, p1, v0}, applyLightsOut(ZZ)V
