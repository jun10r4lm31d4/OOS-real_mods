...
.method public constructor <init>(Landroid/content/res/Resources;Landroid/view/LayoutInflater;Lcom/android/systemui/colorextraction/SysuiColorExtractor;)V
    ...
    iput-object v0, p0, mRenderer:Lcom/android/keyguard/clock/ViewPreviewer;

    iput-object p1, p0, mResources:Landroid/content/res/Resources;

    iput-object p2, p0, mLayoutInflater:Landroid/view/LayoutInflater;

    iput-object p3, p0, mColorExtractor:Lcom/android/systemui/colorextraction/SysuiColorExtractor;
    ...
    iput-object p2, p0, mClockPosition:Lcom/android/keyguard/clock/SmallClockPosition;
...
.method private createViews()V
    ...
    iput-object v0, p0, mView:Lcom/android/keyguard/clock/ClockLayout;

    iget-object v0, p0, mView:Lcom/android/keyguard/clock/ClockLayout;
    ...
    iput-object v0, p0, mAnalogClock:Lcom/android/keyguard/clock/ImageClock;
    ...
    iput-object v0, p0, mLockClockContainer:Landroid/view/View;

    iget-object v0, p0, mLockClockContainer:Landroid/view/View;
    ...
    iput-object v0, p0, mLockClock:Landroid/widget/TextClock;
...
.method public getBigClockView()Landroid/view/View;
    ...
    invoke-direct {p0}, createViews()V

    :cond_0
    iget-object p0, p0, mView:Lcom/android/keyguard/clock/ClockLayout;
...
.method public getPreferredY(I)I
    ...
    iget-object p0, p0, mClockPosition:Lcom/android/keyguard/clock/SmallClockPosition;
...
.method public getPreview(II)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0}, getBigClockView()Landroid/view/View;

    move-result-object v0

    const/high16 v1, 0x3f800000    # 1.0f

    invoke-virtual {p0, v1}, setDarkAmount(F)V

    const/4 v1, -0x1

    invoke-virtual {p0, v1}, setTextColor(I)V

    iget-object v1, p0, mColorExtractor:Lcom/android/systemui/colorextraction/SysuiColorExtractor;
    ...
    invoke-virtual {p0, v2, v1}, setColorPalette(Z[I)V

    invoke-virtual {p0}, onTimeTick()V

    iget-object p0, p0, mRenderer:Lcom/android/keyguard/clock/ViewPreviewer;
...
.method public getView()Landroid/view/View;
    ...
    :cond_0
    iget-object p0, p0, mLockClockContainer:Landroid/view/View;
...
.method public onTimeTick()V
    ...
    iget-object v0, p0, mAnalogClock:Lcom/android/keyguard/clock/ImageClock;
    ...
    iget-object p0, p0, mLockClock:Landroid/widget/TextClock;
...
.method public onTimeZoneChanged(Ljava/util/TimeZone;)V
    ...
    iget-object p0, p0, mAnalogClock:Lcom/android/keyguard/clock/ImageClock;
...
.method public setColorPalette(Z[I)V
    ...
    iget-object p2, p0, mLockClock:Landroid/widget/TextClock;
...
.method public setDarkAmount(F)V
    ...
    iget-object v0, p0, mClockPosition:Lcom/android/keyguard/clock/SmallClockPosition;
