...
.method static constructor <clinit>()V
    ...
    sput-object v0, TOP_ROUNDNESS:Lcom/android/systemui/statusbar/notification/AnimatableProperty;
    ...
    sput-object v0, BOTTOM_ROUNDNESS:Lcom/android/systemui/statusbar/notification/AnimatableProperty;
    ...
    sput-object v0, ROUNDNESS_PROPERTIES:Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0}, Landroid/graphics/Path;-><init>()V

    sput-object v0, EMPTY_PATH:Landroid/graphics/Path;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p1, p0, mOutlineRect:Landroid/graphics/Rect;

    new-instance p1, Landroid/graphics/Path;

    invoke-direct {p1}, Landroid/graphics/Path;-><init>()V

    iput-object p1, p0, mClipPath:Landroid/graphics/Path;

    const/high16 p1, -0x40800000    # -1.0f

    iput p1, p0, mOutlineAlpha:F

    new-instance p2, Landroid/graphics/Path;

    invoke-direct {p2}, Landroid/graphics/Path;-><init>()V

    iput-object p2, p0, mTmpPath:Landroid/graphics/Path;

    iput p1, p0, mDistanceToTopRoundness:F
    ...
    iput-object p1, p0, mProvider:Landroid/view/ViewOutlineProvider;

    iget-object p1, p0, mProvider:Landroid/view/ViewOutlineProvider;
...
.method static synthetic access$000(Lcom/android/systemui/statusbar/notification/row/ExpandableOutlineView;)Z
    ...
    iget-boolean p0, p0, mCustomOutline:Z
...
.method static synthetic access$100(Lcom/android/systemui/statusbar/notification/row/ExpandableOutlineView;)F
    ...
    iget p0, p0, mCurrentTopRoundness:F
...
.method static synthetic access$200(Lcom/android/systemui/statusbar/notification/row/ExpandableOutlineView;)F
    ...
    iget p0, p0, mCurrentBottomRoundness:F
...
.method static synthetic access$300(Lcom/android/systemui/statusbar/notification/row/ExpandableOutlineView;)Z
    ...
    iget-boolean p0, p0, mAlwaysRoundBothCorners:Z
...
.method static synthetic access$400(Lcom/android/systemui/statusbar/notification/row/ExpandableOutlineView;)Z
    ...
    iget-boolean p0, p0, mTopAmountRounded:Z
...
.method private initDimens()V
    ...
    iput-boolean v1, p0, mShouldTranslateContents:Z
    ...
    iput-boolean v1, p0, mAlwaysRoundBothCorners:Z

    iget-boolean v1, p0, mAlwaysRoundBothCorners:Z
    ...
    iput v0, p0, mOutlineRadius:F

    :cond_0
    iget-boolean v0, p0, mAlwaysRoundBothCorners:Z
...
.method public static synthetic lambda$ZLqiUGCQzNj3P4m8kfbTwbzfyaI(Lcom/android/systemui/statusbar/notification/row/ExpandableOutlineView;F)V
    ...
    invoke-direct {p0, p1}, setBottomRoundnessInternal(F)V
...
.method public static synthetic lambda$lgIjKBD4iaJhFeEZ5izPzOddhds(Lcom/android/systemui/statusbar/notification/row/ExpandableOutlineView;F)V
    ...
    invoke-direct {p0, p1}, setTopRoundnessInternal(F)V
...
.method private setBottomRoundnessInternal(F)V
    ...
    iput p1, p0, mCurrentBottomRoundness:F

    invoke-virtual {p0}, applyRoundness()V
...
.method private setTopRoundnessInternal(F)V
    ...
    iput p1, p0, mCurrentTopRoundness:F
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    iget-boolean v0, p0, mTopAmountRounded:Z

    if-eqz v0, :cond_0

    invoke-virtual {p0}, topAmountNeedsClipping()Z
    ...
    iget v2, p0, mDistanceToTopRoundness:F
    ...
    iget v5, p0, mOutlineRadius:F

    const/4 v6, 0x0

    iget-object v7, p0, mClipPath:Landroid/graphics/Path;

    invoke-static/range {v1 .. v7}, getRoundedRectPath(IIIIFFLandroid/graphics/Path;)V

    iget-object v0, p0, mClipPath:Landroid/graphics/Path;
    ...
    :goto_0
    invoke-virtual {p0, p2}, childNeedsClipping(Landroid/view/View;)Z
    ...
    invoke-virtual {p0, p2}, getCustomClipPath(Landroid/view/View;)Landroid/graphics/Path;

    move-result-object v1

    if-nez v1, :cond_1

    invoke-virtual {p0, v2}, getClipPath(Z)Landroid/graphics/Path;
...
.method protected getClipPath(Z)Landroid/graphics/Path;
    ...
    iget v0, p0, mOutlineRadius:F

    goto :goto_0

    :cond_0
    invoke-virtual {p0}, getCurrentBackgroundRadiusTop()F

    move-result v0

    :goto_0
    iget-boolean v1, p0, mCustomOutline:Z

    if-nez v1, :cond_2

    iget-boolean v1, p0, mShouldTranslateContents:Z
    ...
    :cond_2
    iget-object p1, p0, mOutlineRect:Landroid/graphics/Rect;
    ...
    sget-object p0, EMPTY_PATH:Landroid/graphics/Path;
    ...
    iget v1, p0, mOutlineRadius:F

    goto :goto_3

    :cond_4
    invoke-virtual {p0}, getCurrentBackgroundRadiusBottom()F
    ...
    iget p1, p0, mCurrentTopRoundness:F

    mul-float v3, v2, p1

    iget v4, p0, mCurrentBottomRoundness:F
    ...
    iget-object v12, p0, mTmpPath:Landroid/graphics/Path;

    invoke-static/range {v6 .. v12}, getRoundedRectPath(IIIIFFLandroid/graphics/Path;)V

    iget-object p0, p0, mTmpPath:Landroid/graphics/Path;
...
.method protected getCurrentBackgroundRadiusBottom()F
    ...
    iget v0, p0, mCurrentBottomRoundness:F

    iget p0, p0, mOutlineRadius:F
...
.method public getCurrentBackgroundRadiusTop()F
    ...
    :cond_0
    iget v0, p0, mCurrentTopRoundness:F
...
.method public getOutlineTranslation()I
    ...
    iget-boolean v0, p0, mCustomOutline:Z

    if-eqz v0, :cond_0

    iget-object p0, p0, mOutlineRect:Landroid/graphics/Rect;
...
.method public setBottomRoundness(FZ)Z
    ...
    iget v0, p0, mBottomRoundness:F

    cmpl-float v0, v0, p1

    if-eqz v0, :cond_0

    iput p1, p0, mBottomRoundness:F

    sget-object v0, BOTTOM_ROUNDNESS:Lcom/android/systemui/statusbar/notification/AnimatableProperty;

    sget-object v1, ROUNDNESS_PROPERTIES:Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;
...
.method public setDistanceToTopRoundness(F)V
    ...
    iget v0, p0, mDistanceToTopRoundness:F
    ...
    :goto_0
    iput-boolean v0, p0, mTopAmountRounded:Z
...
.method protected setOutlineRect(FFFF)V
    ...
    iput-boolean v0, p0, mCustomOutline:Z

    iget-object v0, p0, mOutlineRect:Landroid/graphics/Rect;
    ...
    iget-object p3, p0, mOutlineRect:Landroid/graphics/Rect;
    ...
    iget-object p2, p0, mOutlineRect:Landroid/graphics/Rect;
...
.method protected setOutlineRect(Landroid/graphics/RectF;)V
    ...
    invoke-virtual {p0, v0, v1, v2, p1}, setOutlineRect(FFFF)V
    ...
    iput-boolean p1, p0, mCustomOutline:Z
...
.method public setTopRoundness(FZ)Z
    ...
    iget v0, p0, mTopRoundness:F

    cmpl-float v0, v0, p1

    if-eqz v0, :cond_0

    iput p1, p0, mTopRoundness:F

    sget-object v0, TOP_ROUNDNESS:Lcom/android/systemui/statusbar/notification/AnimatableProperty;
...
.method public updateOutline()V
    ...
    :cond_0
    invoke-virtual {p0}, needsOutline()Z

    move-result v0

    if-eqz v0, :cond_1

    iget-object v0, p0, mProvider:Landroid/view/ViewOutlineProvider;
