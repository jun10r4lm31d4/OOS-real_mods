...
.method static synthetic access$000(Lcom/android/systemui/biometrics/FingerprintDialogView;)V
    ...
    invoke-direct {p0}, hideFodImmediately()V
...
.method private hideFodImmediately()V
    ...
    invoke-direct {p0}, getFodDialogImpl()Lcom/oneplus/systemui/biometrics/OpBiometricDialogImpl;
    ...
    iput-boolean v0, p0, mFodShowing:Z
...
.method protected updateIcon(II)V
    ...
    iget-boolean v2, p0, mFodShowing:Z
    ...
    :cond_1
    iget-boolean p1, p0, mFodShowing:Z
    ...
    :cond_4
    invoke-virtual {p0, p1, p2}, getAnimationForTransition(II)Landroid/graphics/drawable/Drawable;
    ...
    :goto_2
    invoke-direct {p0, v1}, opUpdateAccentColor(Landroid/graphics/drawable/AnimatedVectorDrawable;)V
    ...
    invoke-virtual {p0, p1, p2}, shouldAnimateForTransition(II)Z
