...
.method static constructor <clinit>()V
    ...
    sput-object v0, mClipRect:Landroid/graphics/Rect;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput p1, p0, mMinimumHeightForClipping:I

    const/4 p2, 0x0

    iput p2, p0, mExtraWidthForClipping:F

    new-instance p2, Ljava/util/ArrayList;

    invoke-direct {p2}, Ljava/util/ArrayList;-><init>()V

    iput-object p2, p0, mMatchParentViews:Ljava/util/ArrayList;

    iput p1, p0, mMinClipTopAmount:I

    const/4 p2, 0x1

    iput-boolean p2, p0, mClipToActualHeight:Z

    iput-boolean p1, p0, mChangingPosition:Z

    invoke-virtual {p0}, createExpandableViewState()Lcom/android/systemui/statusbar/notification/stack/ExpandableViewState;

    move-result-object p1

    iput-object p1, p0, mViewState:Lcom/android/systemui/statusbar/notification/stack/ExpandableViewState;
...
.method public applyViewState()V
    ...
    iget-object v0, p0, mViewState:Lcom/android/systemui/statusbar/notification/stack/ExpandableViewState;
...
.method public getBoundsOnScreen(Landroid/graphics/Rect;Z)V
    ...
    invoke-virtual {p0}, getActualHeight()I
    ...
    invoke-virtual {p0}, getClipTopAmount()I
...
.method public getClipBottomAmount()I
    ...
    iget p0, p0, mClipBottomAmount:I
...
.method public getTransientContainer()Landroid/view/ViewGroup;
    ...
    iget-object p0, p0, mTransientContainer:Landroid/view/ViewGroup;
...
.method public getViewState()Lcom/android/systemui/statusbar/notification/stack/ExpandableViewState;
    ...
    iget-object p0, p0, mViewState:Lcom/android/systemui/statusbar/notification/stack/ExpandableViewState;
...
.method public isChangingPosition()Z
    ...
    iget-boolean p0, p0, mChangingPosition:Z
...
.method public isTransformingIntoShelf()Z
    ...
    iget-boolean p0, p0, mTransformingInShelf:Z
...
.method public notifyHeightChanged(Z)V
    ...
    iget-object v0, p0, mOnHeightChangedListener:Lcom/android/systemui/statusbar/notification/row/ExpandableView$OnHeightChangedListener;
...
.method protected onMeasure(II)V
    ...
    :cond_4
    iget-object v7, p0, mMatchParentViews:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, mMatchParentViews:Ljava/util/ArrayList;
    ...
    :cond_7
    iget-object p2, p0, mMatchParentViews:Ljava/util/ArrayList;
...
.method public resetViewState()Lcom/android/systemui/statusbar/notification/stack/ExpandableViewState;
    ...
    invoke-virtual {v1}, resetViewState()Lcom/android/systemui/statusbar/notification/stack/ExpandableViewState;
...
.method public setActualHeight(I)V
    ...
    invoke-virtual {p0, p1, v0}, setActualHeight(IZ)V
...
.method public setExtraWidthForClipping(F)V
    ...
    iput p1, p0, mExtraWidthForClipping:F
...
.method public setTransformingInShelf(Z)V
    ...
    iput-boolean p1, p0, mTransformingInShelf:Z
...
.method public setTransientContainer(Landroid/view/ViewGroup;)V
    ...
    iput-object p1, p0, mTransientContainer:Landroid/view/ViewGroup;
...
.method public setWillBeGone(Z)V
    ...
    iput-boolean p1, p0, mWillBeGone:Z
...
.method protected updateClipping()V
    ...
    invoke-virtual {p0}, shouldClipToActualHeight()Z
    ...
    invoke-virtual {p0}, getExtraBottomPadding()I
    ...
    iget v2, p0, mMinimumHeightForClipping:I

    invoke-static {v1, v2}, Ljava/lang/Math;->max(II)I

    move-result v1

    iget v2, p0, mExtraWidthForClipping:F
    ...
    sget-object v3, mClipRect:Landroid/graphics/Rect;
    ...
    sget-object v0, mClipRect:Landroid/graphics/Rect;
...
.method public willBeGone()Z
    ...
    iget-boolean p0, p0, mWillBeGone:Z
