...
.method static constructor <clinit>()V
    ...
    sput-object v1, WIFI_PIE:[I

    new-array v1, v0, [I

    fill-array-data v1, :array_0

    sput-object v1, WIFI_4_PIE:[I

    new-array v1, v0, [I

    fill-array-data v1, :array_1

    sput-object v1, WIFI_5_PIE:[I

    new-array v0, v0, [I

    fill-array-data v0, :array_2

    sput-object v0, WIFI_6_PIE:[I
    ...
    sput-object v0, UNIT_OF_STORAGE:[Ljava/lang/String;
    ...
    sput-object v0, UNIT_OF_STORAGE_REPLACE:[Ljava/lang/String;
...
.method public static applyAlphaAttr(Landroid/content/Context;II)I
    ...
    invoke-static {p1, p2}, applyAlpha(FI)I
...
.method public static formatFileSize(Landroid/content/Context;J)Ljava/lang/String;
    ...
    :goto_0
    sget-object p2, UNIT_OF_STORAGE:[Ljava/lang/String;
    ...
    sget-object v0, UNIT_OF_STORAGE_REPLACE:[Ljava/lang/String;
...
.method public static formatPercentage(I)Ljava/lang/String;
    ...
    invoke-static {v0, v1}, formatPercentage(D)Ljava/lang/String;
...
.method public static formatPercentage(JJ)Ljava/lang/String;
    ...
    invoke-static {p0, p1}, formatPercentage(D)Ljava/lang/String;
...
.method public static getColorAccent(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0, v0}, getColorAttr(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method public static getColorAccentDefaultColor(Landroid/content/Context;)I
    ...
    invoke-static {p0, v0}, getColorAttrDefaultColor(Landroid/content/Context;I)I
...
.method public static getDisabled(Landroid/content/Context;I)I
    ...
    invoke-static {p0, v0, p1}, applyAlphaAttr(Landroid/content/Context;II)I
...
.method private static getSystemSignature(Landroid/content/pm/PackageManager;)Landroid/content/pm/Signature;
    ...
    invoke-static {p0}, getFirstSignature(Landroid/content/pm/PackageInfo;)Landroid/content/pm/Signature;
...
.method public static isInService(Landroid/telephony/ServiceState;)Z
    ...
    :cond_0
    invoke-static {p0}, getCombinedServiceState(Landroid/telephony/ServiceState;)I
...
.method public static isSystemPackage(Landroid/content/res/Resources;Landroid/content/pm/PackageManager;Landroid/content/pm/PackageInfo;)Z
    ...
    sget-object v0, sSystemSignature:[Landroid/content/pm/Signature;
    ...
    invoke-static {p1}, getSystemSignature(Landroid/content/pm/PackageManager;)Landroid/content/pm/Signature;

    move-result-object v3

    aput-object v3, v0, v2

    sput-object v0, sSystemSignature:[Landroid/content/pm/Signature;

    :cond_0
    sget-object v0, sPermissionControllerPackageName:Ljava/lang/String;
    ...
    sput-object v0, sPermissionControllerPackageName:Ljava/lang/String;

    :cond_1
    sget-object v0, sServicesSystemSharedLibPackageName:Ljava/lang/String;
    ...
    sput-object v0, sServicesSystemSharedLibPackageName:Ljava/lang/String;

    :cond_2
    sget-object v0, sSharedSystemSharedLibPackageName:Ljava/lang/String;
    ...
    sput-object p1, sSharedSystemSharedLibPackageName:Ljava/lang/String;

    :cond_3
    sget-object p1, sSystemSignature:[Landroid/content/pm/Signature;
    ...
    invoke-static {p2}, getFirstSignature(Landroid/content/pm/PackageInfo;)Landroid/content/pm/Signature;
    ...
    invoke-static {p0, p1}, isDeviceProvisioningPackage(Landroid/content/res/Resources;Ljava/lang/String;)Z
