...
.method public constructor <init>(Ljava/lang/String;Lcom/android/systemui/statusbar/phone/StatusBarIconHolder;)V
    ...
    iput-object p2, p0, mHolder:Lcom/android/systemui/statusbar/phone/StatusBarIconHolder;
...
.method private getIndexForTag(I)I
    ...
    :goto_0
    iget-object v1, p0, mSubSlots:Ljava/util/ArrayList;
...
.method private setSubSlot(Lcom/android/systemui/statusbar/phone/StatusBarIconHolder;I)V
    ...
    iget-object v0, p0, mSubSlots:Ljava/util/ArrayList;
    ...
    iput-object p2, p0, mSubSlots:Ljava/util/ArrayList;

    iget-object p0, p0, mSubSlots:Ljava/util/ArrayList;
    ...
    :cond_0
    invoke-direct {p0, p2}, getIndexForTag(I)I
    ...
    :cond_1
    iget-object p2, p0, mSubSlots:Ljava/util/ArrayList;
    ...
    iget-object p1, p0, mSubSlots:Ljava/util/ArrayList;
...
.method public addHolder(Lcom/android/systemui/statusbar/phone/StatusBarIconHolder;)V
    ...
    iput-object p1, p0, mHolder:Lcom/android/systemui/statusbar/phone/StatusBarIconHolder;

    goto :goto_0

    :cond_0
    invoke-direct {p0, p1, v0}, setSubSlot(Lcom/android/systemui/statusbar/phone/StatusBarIconHolder;I)V
...
.method public clear()V
    ...
    iput-object v0, p0, mHolder:Lcom/android/systemui/statusbar/phone/StatusBarIconHolder;

    iget-object v1, p0, mSubSlots:Ljava/util/ArrayList;

    if-eqz v1, :cond_0

    iput-object v0, p0, mSubSlots:Ljava/util/ArrayList;
...
.method public getHolderForTag(I)Lcom/android/systemui/statusbar/phone/StatusBarIconHolder;
    ...
    iget-object p0, p0, mHolder:Lcom/android/systemui/statusbar/phone/StatusBarIconHolder;
...
.method public getHolderList()Ljava/util/List;
    ...
    iget-object v1, p0, mHolder:Lcom/android/systemui/statusbar/phone/StatusBarIconHolder;
...
.method public getHolderListInViewOrder()Ljava/util/List;
    ...
    iget-object v2, p0, mSubSlots:Ljava/util/ArrayList;
...
.method public hasIconsInSlot()Z
    ...
    iget-object v0, p0, mHolder:Lcom/android/systemui/statusbar/phone/StatusBarIconHolder;
...
.method public removeForTag(I)V
    ...
    :cond_0
    invoke-direct {p0, p1}, getIndexForTag(I)I
...
.method public toString()Ljava/lang/String;
    ...
    invoke-direct {p0}, subSlotsString()Ljava/lang/String;
