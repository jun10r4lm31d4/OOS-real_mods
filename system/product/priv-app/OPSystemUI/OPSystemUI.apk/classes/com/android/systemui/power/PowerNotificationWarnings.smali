...
.method static constructor <clinit>()V
    ...
    sput-object v0, SHOWING_STRINGS:[Ljava/lang/String;
    ...
    sput-object v0, AUDIO_ATTRIBUTES:Landroid/media/AudioAttributes;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/plugins/ActivityStarter;)V
    ...
    iput-object v0, p0, mReceiver:Lcom/android/systemui/power/PowerNotificationWarnings$Receiver;

    const-string v0, "android.intent.action.POWER_USAGE_SUMMARY"

    invoke-static {v0}, settings(Ljava/lang/String;)Landroid/content/Intent;

    move-result-object v0

    iput-object v0, p0, mOpenBatterySettings:Landroid/content/Intent;
    ...
    iput-object v0, p0, mNoMan:Landroid/app/NotificationManager;
    ...
    iput-object p1, p0, mPowerMan:Landroid/os/PowerManager;
    ...
    iput-object p1, p0, mKeyguard:Landroid/app/KeyguardManager;

    iget-object p1, p0, mReceiver:Lcom/android/systemui/power/PowerNotificationWarnings$Receiver;
...
.method static synthetic access$100(Lcom/android/systemui/power/PowerNotificationWarnings;)Lcom/android/systemui/statusbar/phone/SystemUIDialog;
    ...
    iget-object p0, p0, mSaverConfirmation:Lcom/android/systemui/statusbar/phone/SystemUIDialog;
...
.method static synthetic access$1000(Lcom/android/systemui/power/PowerNotificationWarnings;)V
    ...
    invoke-direct {p0}, showThermalShutdownDialog()V
...
.method static synthetic access$1100(Lcom/android/systemui/power/PowerNotificationWarnings;)V
    ...
    invoke-direct {p0}, showAutoSaverSuggestion()V
...
.method static synthetic access$1200(Lcom/android/systemui/power/PowerNotificationWarnings;)V
    ...
    invoke-direct {p0}, dismissAutoSaverSuggestion()V
...
.method static synthetic access$1300(Lcom/android/systemui/power/PowerNotificationWarnings;)V
    ...
    invoke-direct {p0}, startBatterySaverSchedulePage()V
...
.method static synthetic access$400(Lcom/android/systemui/power/PowerNotificationWarnings;)V
    ...
    invoke-direct {p0}, dismissLowBatteryNotification()V
...
.method static synthetic access$500(Lcom/android/systemui/power/PowerNotificationWarnings;)Landroid/content/Intent;
    ...
    iget-object p0, p0, mOpenBatterySettings:Landroid/content/Intent;
...
.method static synthetic access$600(Lcom/android/systemui/power/PowerNotificationWarnings;ZZ)V
    ...
    invoke-direct {p0, p1, p2}, setSaverMode(ZZ)V
...
.method static synthetic access$700(Lcom/android/systemui/power/PowerNotificationWarnings;Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, p1}, showStartSaverConfirmation(Landroid/os/Bundle;)V
...
.method static synthetic access$800(Lcom/android/systemui/power/PowerNotificationWarnings;)V
    ...
    invoke-direct {p0}, dismissHighTemperatureWarningInternal()V
...
.method static synthetic access$900(Lcom/android/systemui/power/PowerNotificationWarnings;)V
    ...
    invoke-direct {p0}, showHighTemperatureDialog()V
...
.method private dismissAutoSaverSuggestion()V
    ...
    iput-boolean v0, p0, mShowAutoSaverSuggestion:Z
...
.method private dismissHighTemperatureWarningInternal()V
    ...
    iput-boolean v0, p0, mHighTempWarning:Z
...
.method private dismissInvalidChargerNotification()V
    ...
    iget-boolean v0, p0, mInvalidCharger:Z
    ...
    iput-boolean v0, p0, mInvalidCharger:Z
...
.method private getHybridContentString(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v1, p0, mCurrentBatterySnapshot:Lcom/android/systemui/power/BatteryStateSnapshot;

    invoke-virtual {v1}, Lcom/android/systemui/power/BatteryStateSnapshot;->getTimeRemainingMillis()J

    move-result-wide v1

    iget-object p0, p0, mCurrentBatterySnapshot:Lcom/android/systemui/power/BatteryStateSnapshot;
...
.method private hasBatterySettings()Z
    ...
    iget-object v0, p0, mOpenBatterySettings:Landroid/content/Intent;
...
.method private showAutoSaverSuggestionNotification()V
    ...
    invoke-direct {p0, v2}, pendingBroadcast(Ljava/lang/String;)Landroid/app/PendingIntent;
    ...
    invoke-direct {p0, v3}, pendingBroadcast(Ljava/lang/String;)Landroid/app/PendingIntent;
...
.method private showHighTemperatureDialog()V
    ...
    iget-object v0, p0, mHighTempDialog:Lcom/android/systemui/statusbar/phone/SystemUIDialog;
    ...
    iput-object v0, p0, mHighTempDialog:Lcom/android/systemui/statusbar/phone/SystemUIDialog;
...
.method private showInvalidChargerNotification()V
    ...
    iget-object v1, p0, mNoMan:Landroid/app/NotificationManager;
...
.method private showStartSaverConfirmation(Landroid/os/Bundle;)V
    ...
    iget-object v0, p0, mSaverConfirmation:Lcom/android/systemui/statusbar/phone/SystemUIDialog;
    ...
    :cond_2
    invoke-direct {p0}, getBatterySaverDescription()Ljava/lang/CharSequence;

    move-result-object p1

    invoke-virtual {v0, p1}, Landroid/app/AlertDialog;->setMessage(Ljava/lang/CharSequence;)V

    invoke-direct {p0}, isEnglishLocale()Z
    ...
    iput-object v0, p0, mSaverConfirmation:Lcom/android/systemui/statusbar/phone/SystemUIDialog;
...
.method private showThermalShutdownDialog()V
    ...
    iget-object v0, p0, mThermalShutdownDialog:Lcom/android/systemui/statusbar/phone/SystemUIDialog;
    ...
    iput-object v0, p0, mThermalShutdownDialog:Lcom/android/systemui/statusbar/phone/SystemUIDialog;
...
.method private showUsbHighTemperatureAlarmInternal()V
    ...
    iget-object v0, p0, mUsbHighTempDialog:Lcom/android/systemui/statusbar/phone/SystemUIDialog;
    ...
    iput-object v0, p0, mUsbHighTempDialog:Lcom/android/systemui/statusbar/phone/SystemUIDialog;
    ...
    iget-object p0, p0, mKeyguard:Landroid/app/KeyguardManager;
...
.method private updateNotification()V
    ...
    iget-boolean v1, p0, mPlaySound:Z
    ...
    iget-boolean v1, p0, mInvalidCharger:Z
    ...
    invoke-direct {p0}, showInvalidChargerNotification()V

    iput v1, p0, mShowing:I
    ...
    invoke-virtual {p0}, showWarningNotification()V
    ...
    :cond_2
    iget-boolean v0, p0, mShowAutoSaverSuggestion:Z

    if-eqz v0, :cond_4

    iget v0, p0, mShowing:I

    const/4 v1, 0x4

    if-eq v0, v1, :cond_3

    invoke-direct {p0}, showAutoSaverSuggestionNotification()V
...
.method public dismissHighTemperatureWarning()V
    ...
    iget-boolean v0, p0, mHighTempWarning:Z
...
.method public dismissInvalidChargerWarning()V
    ...
    invoke-direct {p0}, dismissInvalidChargerNotification()V
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    iget-boolean v0, p0, mPlaySound:Z
    ...
    sget-object v0, SHOWING_STRINGS:[Ljava/lang/String;

    iget v1, p0, mShowing:I
    ...
    iget-object p0, p0, mUsbHighTempDialog:Lcom/android/systemui/statusbar/phone/SystemUIDialog;
...
.method public isInvalidChargerWarningShowing()Z
    ...
    iget-boolean p0, p0, mInvalidCharger:Z
...
.method public synthetic lambda$showHighTemperatureDialog$0$PowerNotificationWarnings(Landroid/content/DialogInterface;)V
    ...
    iput-object p1, p0, mHighTempDialog:Lcom/android/systemui/statusbar/phone/SystemUIDialog;
...
.method public synthetic lambda$showStartSaverConfirmation$9$PowerNotificationWarnings(Landroid/content/DialogInterface;)V
    ...
    iput-object p1, p0, mSaverConfirmation:Lcom/android/systemui/statusbar/phone/SystemUIDialog;
...
.method public synthetic lambda$showThermalShutdownDialog$1$PowerNotificationWarnings(Landroid/content/DialogInterface;)V
    ...
    iput-object p1, p0, mThermalShutdownDialog:Lcom/android/systemui/statusbar/phone/SystemUIDialog;
...
.method public synthetic lambda$showUsbHighTemperatureAlarm$2$PowerNotificationWarnings()V
    ...
    invoke-direct {p0}, showUsbHighTemperatureAlarmInternal()V
...
.method public synthetic lambda$showUsbHighTemperatureAlarmInternal$3$PowerNotificationWarnings(Landroid/content/DialogInterface;I)V
    ...
    iput-object p1, p0, mUsbHighTempDialog:Lcom/android/systemui/statusbar/phone/SystemUIDialog;
...
.method public showHighTemperatureWarning()V
    ...
    invoke-direct {p0, v1}, pendingBroadcast(Ljava/lang/String;)Landroid/app/PendingIntent;
...
.method public showLowBatteryWarning(Z)V
    ...
    iput-boolean p1, p0, mPlaySound:Z

    const/4 p1, 0x1

    iput-boolean p1, p0, mWarning:Z
...
.method protected showWarningNotification()V
    ...
    iget-object v2, p0, mCurrentBatterySnapshot:Lcom/android/systemui/power/BatteryStateSnapshot;
    ...
    invoke-direct {p0, v0}, getHybridContentString(Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_0
    iget-boolean v2, p0, mPlaySound:Z
    ...
    iget-wide v3, p0, mWarningTriggerTimeMs:J
    ...
    invoke-direct {p0, v4}, pendingBroadcast(Ljava/lang/String;)Landroid/app/PendingIntent;
    ...
    invoke-direct {p0}, hasBatterySettings()Z
    ...
    :cond_4
    iget-object v1, p0, mPowerMan:Landroid/os/PowerManager;
    ...
    iput-boolean v3, p0, mPlaySound:Z
...
.method public update(IIJ)V
    ...
    iput-wide v0, p0, mWarningTriggerTimeMs:J

    goto :goto_0

    :cond_0
    iget p1, p0, mBucket:I
    ...
    :cond_1
    :goto_0
    iput p2, p0, mBucket:I

    iput-wide p3, p0, mScreenOffTime:J
...
.method public updateSnapshot(Lcom/android/systemui/power/BatteryStateSnapshot;)V
    ...
    iput-object p1, p0, mCurrentBatterySnapshot:Lcom/android/systemui/power/BatteryStateSnapshot;
