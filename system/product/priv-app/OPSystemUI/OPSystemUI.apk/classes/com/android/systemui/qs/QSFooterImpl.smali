...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct/range {v1 .. v6}, <init>(Landroid/content/Context;Landroid/util/AttributeSet;Lcom/android/systemui/plugins/ActivityStarter;Lcom/android/systemui/statusbar/policy/UserInfoController;Lcom/android/systemui/statusbar/policy/DeviceProvisionedController;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;Lcom/android/systemui/plugins/ActivityStarter;Lcom/android/systemui/statusbar/policy/UserInfoController;Lcom/android/systemui/statusbar/policy/DeviceProvisionedController;)V
    ...
    iput-boolean p1, p0, mShowEditIcon:Z
    ...
    iput-object p1, p0, mDeveloperSettingsObserver:Landroid/database/ContentObserver;

    iput-object p3, p0, mActivityStarter:Lcom/android/systemui/plugins/ActivityStarter;

    iput-object p4, p0, mUserInfoController:Lcom/android/systemui/statusbar/policy/UserInfoController;

    iput-object p5, p0, mDeviceProvisionedController:Lcom/android/systemui/statusbar/policy/DeviceProvisionedController;
...
.method static synthetic access$000(Lcom/android/systemui/qs/QSFooterImpl;)V
    ...
    invoke-direct {p0}, setBuildText()V
...
.method private canShowEditIcon()Z
    ...
    iget-boolean v0, p0, mShowEditIcon:Z

    if-eqz v0, :cond_0

    iget-boolean p0, p0, mIsGuestUser:Z
...
.method private createDragHandleAnimator()Lcom/android/systemui/qs/TouchAnimator;
    ...
    iget-object p0, p0, mDragHandle:Landroid/view/View;
...
.method private createFooterAnimator()Lcom/android/systemui/qs/TouchAnimator;
    ...
    invoke-direct {p0}, canShowEditIcon()Z
    ...
    iget-object v1, p0, mEdit:Landroid/view/View;
    ...
    :cond_0
    iget-object v1, p0, mMultiUserSwitch:Lcom/android/systemui/statusbar/phone/MultiUserSwitch;
    ...
    iget-object p0, p0, mPageIndicator:Lcom/android/systemui/qs/PageIndicator;
...
.method private showUserSwitcher()Z
    ...
    iget-object v0, p0, mMultiUserSwitch:Lcom/android/systemui/statusbar/phone/MultiUserSwitch;
    ...
    iget-object p0, p0, mMultiUserSwitch:Lcom/android/systemui/statusbar/phone/MultiUserSwitch;
...
.method private updateAnimator(I)V
    ...
    iget p1, p0, mExpansionAmount:F

    invoke-virtual {p0, p1}, setExpansion(F)V
...
.method private updateClickabilities()V
    ...
    iget-object v0, p0, mEdit:Landroid/view/View;
    ...
    iget-object p0, p0, mSettingsButton:Lcom/android/systemui/statusbar/phone/SettingsButton;
...
.method private updateDragHandleAnimator()V
    ...
    invoke-direct {p0}, createDragHandleAnimator()Lcom/android/systemui/qs/TouchAnimator;

    move-result-object v0

    iput-object v0, p0, mDragHandleAnimator:Lcom/android/systemui/qs/TouchAnimator;
...
.method private updateFooterAnimator()V
    ...
    invoke-direct {p0}, createFooterAnimator()Lcom/android/systemui/qs/TouchAnimator;

    move-result-object v0

    iput-object v0, p0, mFooterAnimator:Lcom/android/systemui/qs/TouchAnimator;
...
.method private updateListeners()V
    ...
    iget-object v0, p0, mUserInfoController:Lcom/android/systemui/statusbar/policy/UserInfoController;
...
.method private updateResources()V
    ...
    invoke-direct {p0}, updateFooterAnimator()V

    invoke-direct {p0}, updateDragHandleAnimator()V
...
.method private updateThemeColor()V
    ...
    iget-object v1, p0, mSettingsButton:Lcom/android/systemui/statusbar/phone/SettingsButton;
    ...
    iget-object v2, p0, mDivider:Landroid/view/View;
    ...
    iget-object p0, p0, mWlbButton:Landroid/widget/ImageView;
...
.method private updateVisibilities()V
    ...
    iget-object v0, p0, mSettingsContainer:Landroid/view/View;

    iget-boolean v1, p0, mQsDisabled:Z
    ...
    iget-object v2, p0, mMultiUserSwitch:Lcom/android/systemui/statusbar/phone/MultiUserSwitch;

    invoke-direct {p0}, showUserSwitcher()Z
...
.method public synthetic lambda$onFinishInflate$2$QSFooterImpl(Landroid/view/View;IIIIIIII)V
    ...
    invoke-direct {p0, p4}, updateAnimator(I)V
...
.method public synthetic lambda$updateEverything$3$QSFooterImpl()V
    ...
    invoke-direct {p0}, updateVisibilities()V

    invoke-direct {p0}, updateClickabilities()V
...
.method protected onAttachedToWindow()V
    ...
    iget-object p0, p0, mDeveloperSettingsObserver:Landroid/database/ContentObserver;
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object v0, p0, mSettingsButton:Lcom/android/systemui/statusbar/phone/SettingsButton;
    ...
    invoke-direct {p0}, startSettingsActivity()V
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    :goto_0
    iput-boolean p1, p0, mIsLandscape:Z

    iget-boolean p1, p0, mIsLandscape:Z

    if-eqz p1, :cond_1

    iput-boolean v1, p0, mShowEditIcon:Z

    goto :goto_1

    :cond_1
    iput-boolean v0, p0, mShowEditIcon:Z
    ...
    iget-object p1, p0, mEdit:Landroid/view/View;
...
.method public onDetachedFromWindow()V
    ...
    iget-object v1, p0, mDeveloperSettingsObserver:Landroid/database/ContentObserver;
...
.method protected onFinishInflate()V
    ...
    iput-object v0, p0, mEdit:Landroid/view/View;
    ...
    iput-object v0, p0, mDivider:Landroid/view/View;
    ...
    iput-object v0, p0, mPageIndicator:Lcom/android/systemui/qs/PageIndicator;
    ...
    iput-object v0, p0, mSettingsButton:Lcom/android/systemui/statusbar/phone/SettingsButton;
    ...
    iput-object v0, p0, mSettingsContainer:Landroid/view/View;
    ...
    iput-object v0, p0, mMultiUserSwitch:Lcom/android/systemui/statusbar/phone/MultiUserSwitch;
    ...
    iput-object v0, p0, mMultiUserAvatar:Landroid/widget/ImageView;
    ...
    iput-object v0, p0, mWlbSwitch:Lcom/android/systemui/statusbar/phone/WLBSwitch;
    ...
    iput-object v0, p0, mWlbButton:Landroid/widget/ImageView;
    ...
    :cond_1
    iget-object v0, p0, mWlbSwitch:Lcom/android/systemui/statusbar/phone/WLBSwitch;
    ...
    iput-object v0, p0, mDragHandle:Landroid/view/View;
    ...
    iput-object v0, p0, mActionsContainer:Landroid/view/View;
    ...
    iput-object v0, p0, mCarrierGroup:Lcom/android/systemui/qs/QSCarrierGroup;
...
.method public onUserInfoChanged(Ljava/lang/String;Landroid/graphics/drawable/Drawable;Ljava/lang/String;)V
    ...
    iput-boolean p1, p0, mIsGuestUser:Z

    invoke-direct {p0}, updateResources()V

    invoke-virtual {p0}, updateEverything()V

    iget-object p0, p0, mMultiUserAvatar:Landroid/widget/ImageView;
...
.method public performAccessibilityAction(ILandroid/os/Bundle;)Z
    ...
    iget-object v0, p0, mExpandClickListener:Landroid/view/View$OnClickListener;
...
.method public setExpansion(F)V
    ...
    iput p1, p0, mExpansionAmount:F

    iget-object v0, p0, mSettingsCogAnimator:Lcom/android/systemui/qs/TouchAnimator;
    ...
    :cond_0
    iget-object v0, p0, mFooterAnimator:Lcom/android/systemui/qs/TouchAnimator;
    ...
    :cond_1
    iget-object p0, p0, mDragHandleAnimator:Lcom/android/systemui/qs/TouchAnimator;
...
.method public setListening(Z)V
    ...
    iget-object p1, p0, mCarrierGroup:Lcom/android/systemui/qs/QSCarrierGroup;

    iget-boolean v0, p0, mListening:Z

    invoke-virtual {p1, v0}, Lcom/android/systemui/qs/QSCarrierGroup;->setListening(Z)V

    invoke-direct {p0}, updateListeners()V
...
.method public setQSPanel(Lcom/android/systemui/qs/QSPanel;)V
    ...
    iget-object v1, p0, mPageIndicator:Lcom/android/systemui/qs/PageIndicator;
    ...
    iget-object p0, p0, mWlbSwitch:Lcom/android/systemui/statusbar/phone/WLBSwitch;
