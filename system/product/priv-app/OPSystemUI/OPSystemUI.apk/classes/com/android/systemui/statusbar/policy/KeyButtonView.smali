...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p1, p2, p3, v0}, <init>(Landroid/content/Context;Landroid/util/AttributeSet;ILandroid/hardware/input/InputManager;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;ILandroid/hardware/input/InputManager;)V
    ...
    iput-object v0, p0, mOvalBgPaint:Landroid/graphics/Paint;

    const/4 v0, 0x0

    iput-boolean v0, p0, mHasOvalBg:Z
    ...
    iput-object v1, p0, mCheckLongPress:Ljava/lang/Runnable;
    ...
    iput-boolean p3, p0, mPlaySounds:Z
    ...
    iput p3, p0, mContentDescriptionRes:I
    ...
    iput-object p2, p0, mRipple:Lcom/android/systemui/statusbar/policy/KeyButtonRipple;
    ...
    iput-object p4, p0, mInputManager:Landroid/hardware/input/InputManager;

    iget-object p1, p0, mRipple:Lcom/android/systemui/statusbar/policy/KeyButtonRipple;
    ...
    invoke-direct {p0}, determineKey()I
...
.method static synthetic access$002(Lcom/android/systemui/statusbar/policy/KeyButtonView;Z)Z
    ...
    iput-boolean p1, p0, mLongClicked:Z
...
.method private sendEvent(IIJ)V
    ...
    iget-object v6, v0, mOverviewProxyService:Lcom/android/systemui/recents/OverviewProxyService;
    ...
    :cond_6
    iget-object v0, v0, mInputManager:Landroid/hardware/input/InputManager;
...
.method public abortCurrentGesture()V
    ...
    iget-object v0, p0, mRipple:Lcom/android/systemui/statusbar/policy/KeyButtonRipple;

    invoke-virtual {v0}, Lcom/android/systemui/statusbar/policy/KeyButtonRipple;->abortDelayedRipple()V

    const/4 v0, 0x1

    iput-boolean v0, p0, mGestureAborted:Z
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v0, p0, mHasOvalBg:Z
    ...
    iget-object v7, p0, mOvalBgPaint:Landroid/graphics/Paint;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iput-boolean v2, p0, mGestureAborted:Z

    :cond_0
    iget-boolean v3, p0, mGestureAborted:Z
    ...
    invoke-virtual {p0, v3, v4}, sendEvent(II)V

    :cond_3
    iget-object p1, p0, mCheckLongPress:Ljava/lang/Runnable;
    ...
    iget-boolean p1, p0, mLongClicked:Z
    ...
    iget-boolean v0, p0, mLongClicked:Z
    ...
    :cond_b
    invoke-virtual {p0, v3, v2}, sendEvent(II)V
    ...
    iput-wide v4, p0, mDownTime:J

    iput-boolean v2, p0, mLongClicked:Z
    ...
    :cond_10
    iget-wide v4, p0, mDownTime:J

    invoke-direct {p0, v2, v2, v4, v5}, sendEvent(IIJ)V
...
.method public performAccessibilityActionInternal(ILandroid/os/Bundle;)Z
    ...
    invoke-direct {p0, v1, v1, p1, p2}, sendEvent(IIJ)V

    invoke-virtual {p0, v0, v1}, sendEvent(II)V
    ...
    invoke-virtual {p0, v1, p1}, sendEvent(II)V
...
.method public playSoundEffect(I)V
    ...
    iget-boolean v0, p0, mPlaySounds:Z
...
.method public sendEvent(II)V
    ...
    invoke-direct {p0, p1, p2, v0, v1}, sendEvent(IIJ)V
...
.method public setDarkIntensity(F)V
    ...
    :cond_0
    iget-object p0, p0, mRipple:Lcom/android/systemui/statusbar/policy/KeyButtonRipple;
...
.method public setImageDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v0, p0, mOvalBgPaint:Landroid/graphics/Paint;
    ...
    invoke-direct {p0}, updateThemeColorInternal()V
