...
.method public constructor <init>(Landroid/content/Context;Landroid/content/pm/ApplicationInfo;J)V
    ...
    iput-object v0, p0, apkFile:Ljava/io/File;
    ...
    iput-wide p2, p0, size:J

    const/4 p2, 0x1

    iput-boolean p2, p0, sizeStale:Z

    invoke-virtual {p0, p1}, ensureLabel(Landroid/content/Context;)V
...
.method ensureIconLocked(Landroid/content/Context;Landroid/util/IconDrawableFactory;)Z
    ...
    iget-object v0, p0, icon:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, apkFile:Ljava/io/File;
    ...
    iget-object p1, p0, info:Landroid/content/pm/ApplicationInfo;
    ...
    iput-object p1, p0, icon:Landroid/graphics/drawable/Drawable;

    return v2

    :cond_0
    iput-boolean v1, p0, mounted:Z
    ...
    :cond_1
    iget-boolean p1, p0, mounted:Z

    if-nez p1, :cond_2

    iget-object p1, p0, apkFile:Ljava/io/File;
