...
.method public constructor <init>(Landroid/view/ViewConfiguration;Landroid/os/Handler;Ljava/lang/Runnable;)V
    ...
    iput-wide v0, p0, mDownTouchTime:J

    iput-wide v0, p0, mLastDownTouchTime:J

    iput-wide v0, p0, mUpTouchTime:J

    new-instance v0, Landroid/graphics/PointF;

    invoke-direct {v0}, Landroid/graphics/PointF;-><init>()V

    iput-object v0, p0, mDownTouch:Landroid/graphics/PointF;
    ...
    iput-object v0, p0, mLastTouch:Landroid/graphics/PointF;

    new-instance v0, Landroid/graphics/PointF;

    invoke-direct {v0}, Landroid/graphics/PointF;-><init>()V

    iput-object v0, p0, mLastDelta:Landroid/graphics/PointF;

    new-instance v0, Landroid/graphics/PointF;

    invoke-direct {v0}, Landroid/graphics/PointF;-><init>()V

    iput-object v0, p0, mVelocity:Landroid/graphics/PointF;
    ...
    iput-boolean v0, p0, mIsUserInteracting:Z

    iput-boolean v0, p0, mIsDoubleTap:Z

    iput-boolean v0, p0, mIsWaitingForDoubleTap:Z

    iput-boolean v0, p0, mIsDragging:Z

    iput-boolean v0, p0, mPreviouslyDragging:Z

    iput-boolean v0, p0, mStartedDragging:Z

    iput-boolean v0, p0, mAllowDraggingOffscreen:Z

    iput-object p1, p0, mViewConfig:Landroid/view/ViewConfiguration;

    iput-object p2, p0, mHandler:Landroid/os/Handler;

    iput-object p3, p0, mDoubleTapTimeoutCallback:Ljava/lang/Runnable;
...
.method public allowDraggingOffscreen()Z
    ...
    iget-boolean p0, p0, mAllowDraggingOffscreen:Z
...
.method public dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    iget-boolean v1, p0, mAllowTouches:Z
    ...
    iget-object v1, p0, mDownTouch:Landroid/graphics/PointF;
    ...
    iget-object v1, p0, mDownDelta:Landroid/graphics/PointF;
    ...
    iget-object v1, p0, mLastTouch:Landroid/graphics/PointF;
    ...
    iget-object v1, p0, mLastDelta:Landroid/graphics/PointF;
    ...
    iget-object v1, p0, mVelocity:Landroid/graphics/PointF;
    ...
    iget-boolean v1, p0, mIsUserInteracting:Z
    ...
    iget-boolean v1, p0, mStartedDragging:Z
...
.method getDoubleTapTimeoutCallbackDelay()J
    ...
    iget-boolean v0, p0, mIsWaitingForDoubleTap:Z
    ...
    iget-wide v4, p0, mUpTouchTime:J

    iget-wide v6, p0, mDownTouchTime:J
...
.method public getDownTouchPosition()Landroid/graphics/PointF;
    ...
    iget-object p0, p0, mDownTouch:Landroid/graphics/PointF;
...
.method public getLastTouchDelta()Landroid/graphics/PointF;
    ...
    iget-object p0, p0, mLastDelta:Landroid/graphics/PointF;
...
.method public getLastTouchPosition()Landroid/graphics/PointF;
    ...
    iget-object p0, p0, mLastTouch:Landroid/graphics/PointF;
...
.method public getVelocity()Landroid/graphics/PointF;
    ...
    iget-object p0, p0, mVelocity:Landroid/graphics/PointF;
...
.method public isDoubleTap()Z
    ...
    iget-boolean p0, p0, mIsDoubleTap:Z
...
.method public isDragging()Z
    ...
    iget-boolean p0, p0, mIsDragging:Z
...
.method public isUserInteracting()Z
    ...
    iget-boolean p0, p0, mIsUserInteracting:Z
...
.method public isWaitingForDoubleTap()Z
    ...
    iget-boolean p0, p0, mIsWaitingForDoubleTap:Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;)V
    ...
    :cond_0
    iget-boolean v0, p0, mIsUserInteracting:Z
    ...
    iget-object v0, p0, mLastDelta:Landroid/graphics/PointF;

    iget-object v2, p0, mLastTouch:Landroid/graphics/PointF;
    ...
    iget-object v2, p0, mDownTouch:Landroid/graphics/PointF;
    ...
    iget-object v2, p0, mViewConfig:Landroid/view/ViewConfiguration;
    ...
    iput-boolean v4, p0, mStartedDragging:Z

    goto :goto_1

    :cond_7
    iput-boolean v3, p0, mStartedDragging:Z
    ...
    iget-object v8, p0, mViewConfig:Landroid/view/ViewConfiguration;
    ...
    iget-object v0, p0, mVelocity:Landroid/graphics/PointF;
    ...
    iput-wide v5, p0, mUpTouchTime:J

    iget-object v5, p0, mLastTouch:Landroid/graphics/PointF;
    ...
    iget-boolean p1, p0, mIsDragging:Z

    iput-boolean p1, p0, mPreviouslyDragging:Z

    iget-boolean v0, p0, mIsDoubleTap:Z

    if-nez v0, :cond_c

    if-nez p1, :cond_c

    iget-wide v5, p0, mUpTouchTime:J

    iget-wide v7, p0, mDownTouchTime:J
    ...
    :cond_c
    iput-boolean v3, p0, mIsWaitingForDoubleTap:Z
    ...
    iget-object v0, p0, mLastTouch:Landroid/graphics/PointF;
    ...
    iget-object v0, p0, mDownTouch:Landroid/graphics/PointF;

    iget-object v5, p0, mLastTouch:Landroid/graphics/PointF;

    invoke-virtual {v0, v5}, Landroid/graphics/PointF;->set(Landroid/graphics/PointF;)V

    iput-boolean v4, p0, mAllowDraggingOffscreen:Z

    iput-boolean v4, p0, mIsUserInteracting:Z

    invoke-virtual {p1}, Landroid/view/MotionEvent;->getEventTime()J

    move-result-wide v5

    iput-wide v5, p0, mDownTouchTime:J

    iget-boolean p1, p0, mPreviouslyDragging:Z

    if-nez p1, :cond_10

    iget-wide v5, p0, mDownTouchTime:J

    iget-wide v7, p0, mLastDownTouchTime:J
    ...
    :goto_2
    iput-boolean v4, p0, mIsDoubleTap:Z

    iput-boolean v3, p0, mIsWaitingForDoubleTap:Z

    iget-wide v0, p0, mDownTouchTime:J

    iput-wide v0, p0, mLastDownTouchTime:J

    iget-object p1, p0, mDoubleTapTimeoutCallback:Ljava/lang/Runnable;
...
.method public scheduleDoubleTapTimeoutCallback()V
    ...
    invoke-virtual {p0}, getDoubleTapTimeoutCallbackDelay()J

    move-result-wide v0

    iget-object v2, p0, mHandler:Landroid/os/Handler;

    iget-object v3, p0, mDoubleTapTimeoutCallback:Ljava/lang/Runnable;

    invoke-virtual {v2, v3}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    iget-object v2, p0, mHandler:Landroid/os/Handler;

    iget-object p0, p0, mDoubleTapTimeoutCallback:Ljava/lang/Runnable;
...
.method public setAllowTouches(Z)V
    ...
    iget-boolean p1, p0, mIsUserInteracting:Z
...
.method public startedDragging()Z
    ...
    iget-boolean p0, p0, mStartedDragging:Z
