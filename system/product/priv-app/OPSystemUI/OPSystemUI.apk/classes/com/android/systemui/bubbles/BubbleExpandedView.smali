...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-boolean p2, p0, mActivityViewReady:Z
    ...
    iput-object p2, p0, mBubbleController:Lcom/android/systemui/bubbles/BubbleController;
    ...
    iput-object p2, p0, mStateCallback:Landroid/app/ActivityView$StateCallback;
    ...
    iput-object p1, p0, mNotificationManagerService:Landroid/app/INotificationManager;
    :try_end_0
...
.method static synthetic access$000(Lcom/android/systemui/bubbles/BubbleExpandedView;)Z
    ...
    iget-boolean p0, p0, mActivityViewReady:Z
...
.method static synthetic access$002(Lcom/android/systemui/bubbles/BubbleExpandedView;Z)Z
    ...
    iput-boolean p1, p0, mActivityViewReady:Z
...
.method static synthetic access$300(Lcom/android/systemui/bubbles/BubbleExpandedView;)Landroid/app/PendingIntent;
    ...
    iget-object p0, p0, mBubbleIntent:Landroid/app/PendingIntent;
...
.method static synthetic access$400(Lcom/android/systemui/bubbles/BubbleExpandedView;)Landroid/app/ActivityView;
    ...
    iget-object p0, p0, mActivityView:Landroid/app/ActivityView;
...
.method private logBubbleClickEvent(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;I)V
    ...
    iget-object v1, p0, mStackView:Lcom/android/systemui/bubbles/BubbleStackView;
...
.method private updateExpandedView()V
    ...
    invoke-direct {p0, v0}, getBubbleIntent(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)Landroid/app/PendingIntent;

    move-result-object v0

    iput-object v0, p0, mBubbleIntent:Landroid/app/PendingIntent;

    iget-object v0, p0, mBubbleIntent:Landroid/app/PendingIntent;

    if-eqz v0, :cond_1

    iget-object v0, p0, mNotifRow:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;
    ...
    iput-object v0, p0, mNotifRow:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;

    :cond_0
    iget-object v0, p0, mActivityView:Landroid/app/ActivityView;
    ...
    :cond_1
    invoke-virtual {p0}, updateView()V
...
.method private updateSettingsContentDescription()V
    ...
    iget-object v0, p0, mSettingsIcon:Lcom/android/systemui/statusbar/AlphaOptimizedButton;
...
.method applyThemeAttrs()V
    ...
    iget-object v0, p0, mPointerDrawable:Landroid/graphics/drawable/ShapeDrawable;
...
.method public cleanUpExpandedState()V
    ...
    :cond_0
    iget-boolean v1, p0, mActivityViewReady:Z
    ...
    iput-object v0, p0, mActivityView:Landroid/app/ActivityView;

    const/4 v0, 0x0

    iput-boolean v0, p0, mActivityViewReady:Z
...
.method public getVirtualDisplayId()I
    ...
    invoke-direct {p0}, usingActivityView()Z
...
.method public synthetic lambda$onClick$1$BubbleExpandedView(Landroid/content/Intent;)V
    ...
    invoke-direct {p0, p1, v0}, logBubbleClickEvent(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;I)V
...
.method public synthetic lambda$onFinishInflate$0$BubbleExpandedView(Landroid/view/View;Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    :goto_0
    iput-boolean v0, p0, mKeyboardVisible:Z

    iget-boolean v0, p0, mKeyboardVisible:Z

    if-nez v0, :cond_1

    iget-boolean v0, p0, mNeedsNewHeight:Z

    if-eqz v0, :cond_1

    invoke-virtual {p0}, updateHeight()V
...
.method public onClick(Landroid/view/View;)V
    ...
    invoke-direct {p0, p1, v0}, getSettingsIntent(Ljava/lang/String;I)Landroid/content/Intent;

    move-result-object p1

    iget-object v0, p0, mStackView:Lcom/android/systemui/bubbles/BubbleStackView;
...
.method protected onDetachedFromWindow()V
    ...
    iput-boolean v0, p0, mNeedsNewHeight:Z
...
.method protected onFinishInflate()V
    ...
    iput-object v1, p0, mPointerView:Landroid/view/View;
    ...
    iput v0, p0, mPointerHeight:I

    new-instance v0, Landroid/graphics/drawable/ShapeDrawable;

    iget v1, p0, mPointerWidth:I

    int-to-float v1, v1

    iget v2, p0, mPointerHeight:I
    ...
    iput-object v0, p0, mPointerDrawable:Landroid/graphics/drawable/ShapeDrawable;

    iget-object v0, p0, mPointerView:Landroid/view/View;

    iget-object v1, p0, mPointerDrawable:Landroid/graphics/drawable/ShapeDrawable;
    ...
    iput v0, p0, mSettingsIconHeight:I
    ...
    iput-object v0, p0, mSettingsIcon:Lcom/android/systemui/statusbar/AlphaOptimizedButton;
    ...
    invoke-virtual {p0}, applyThemeAttrs()V
...
.method public populateExpandedView()V
    ...
    iget-object p0, p0, mStateCallback:Landroid/app/ActivityView$StateCallback;
    ...
    iget-object v1, p0, mNotifRow:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;
...
.method public setEntry(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;Lcom/android/systemui/bubbles/BubbleStackView;Ljava/lang/String;)V
    ...
    iput-object p2, p0, mStackView:Lcom/android/systemui/bubbles/BubbleStackView;
    ...
    :try_start_0
    iget-object p2, p0, mPm:Landroid/content/pm/PackageManager;
    ...
    iput-object p1, p0, mAppIcon:Landroid/graphics/drawable/Drawable;
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0

    :catch_0
    :cond_0
    iget-object p1, p0, mAppIcon:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0}, showSettingsIcon()V

    invoke-direct {p0}, updateExpandedView()V
...
.method public setOnBlockedListener(Lcom/android/systemui/bubbles/BubbleExpandedView$OnBubbleBlockedListener;)V
    ...
    iput-object p1, p0, mOnBubbleBlockedListener:Lcom/android/systemui/bubbles/BubbleExpandedView$OnBubbleBlockedListener;
...
.method public setPointerPosition(F)V
    ...
    iget-object p0, p0, mPointerView:Landroid/view/View;
...
.method showSettingsIcon()V
    ...
    invoke-direct {p0}, updateSettingsContentDescription()V

    iget-object p0, p0, mSettingsIcon:Lcom/android/systemui/statusbar/AlphaOptimizedButton;
...
.method updateHeight()V
    ...
    iget-object v3, p0, mEntry:Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;
    ...
    invoke-direct {p0, v0, v3, v4}, getDimenForPackageUser(ILjava/lang/String;I)I
    ...
    :goto_3
    iget-object v3, p0, mStackView:Lcom/android/systemui/bubbles/BubbleStackView;

    invoke-virtual {v3}, Lcom/android/systemui/bubbles/BubbleStackView;->getMaxExpandedHeight()I

    move-result v3

    iget v4, p0, mSettingsIconHeight:I

    sub-int/2addr v3, v4

    iget v4, p0, mPointerHeight:I

    sub-int/2addr v3, v4

    iget v4, p0, mPointerMargin:I
    ...
    iget-object v3, p0, mActivityView:Landroid/app/ActivityView;
    ...
    :goto_4
    iput-boolean v1, p0, mNeedsNewHeight:Z

    iget-boolean v1, p0, mKeyboardVisible:Z
...
.method updateInsets(Landroid/view/WindowInsets;)V
    ...
    iget-object v1, p0, mActivityView:Landroid/app/ActivityView;
    ...
    iget-object v2, p0, mActivityView:Landroid/app/ActivityView;
...
.method public updateView()V
    ...
    invoke-direct {p0, v0}, applyRowState(Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;)V
