...
.method constructor <init>(Ljava/lang/String;Ljava/util/List;[Ljava/lang/CharSequence;)V
    ...
    :goto_0
    iput-object p1, p0, smartActions:Ljava/util/List;
    ...
    :goto_1
    iput-object p1, p0, smartReplies:[Ljava/lang/CharSequence;
...
.method public static areDifferent(Ljava/util/List;Ljava/util/List;)Z
    ...
    invoke-static {v5, v6}, areDifferent(Landroid/graphics/drawable/Icon;Landroid/graphics/drawable/Icon;)Z
    ...
    invoke-static {v3, v4}, areDifferent([Landroid/app/RemoteInput;[Landroid/app/RemoteInput;)Z
...
.method private static areDifferent([Landroid/app/RemoteInput;[Landroid/app/RemoteInput;)Z
    ...
    invoke-static {v3, v4}, areDifferent([Ljava/lang/CharSequence;[Ljava/lang/CharSequence;)Z
...
.method public static extractFromNotificationEntry(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)Lcom/android/systemui/statusbar/NotificationUiAdjustment;
    ...
    invoke-direct {v0, v1, v2, p0}, <init>(Ljava/lang/String;Ljava/util/List;[Ljava/lang/CharSequence;)V
...
.method public static needReinflate(Lcom/android/systemui/statusbar/NotificationUiAdjustment;Lcom/android/systemui/statusbar/NotificationUiAdjustment;)Z
    ...
    :cond_0
    iget-object v1, p0, smartActions:Ljava/util/List;

    iget-object v2, p1, smartActions:Ljava/util/List;

    invoke-static {v1, v2}, areDifferent(Ljava/util/List;Ljava/util/List;)Z
    ...
    :cond_1
    iget-object p0, p0, smartReplies:[Ljava/lang/CharSequence;

    iget-object p1, p1, smartReplies:[Ljava/lang/CharSequence;
