...
.method public constructor <init>(Lcom/android/systemui/qs/QSHost;)V
    ...
    iput-object p1, p0, mManager:Landroid/hardware/display/ColorDisplayManager;
    ...
    iput-object p1, p0, mListener:Landroid/hardware/display/NightDisplayListener;
    ...
    iput-object p1, p0, mInversionSetting:Lcom/android/systemui/qs/SecureSetting;
    ...
    iput-object p1, p0, mDaltonizerSetting:Lcom/android/systemui/qs/SecureSetting;
    ...
    iput-object p1, p0, mGrayModeSetting:Lcom/oneplus/util/SystemSetting;
...
.method private getSecondaryLabel(Z)Ljava/lang/String;
    ...
    iget-object v0, p0, mManager:Landroid/hardware/display/ColorDisplayManager;
    ...
    iget-object p1, p0, mManager:Landroid/hardware/display/ColorDisplayManager;
...
.method private isColorCalibrationAvailable()Z
    ...
    iget-object v0, p0, mInversionSetting:Lcom/android/systemui/qs/SecureSetting;
    ...
    :goto_0
    iget-object v3, p0, mDaltonizerSetting:Lcom/android/systemui/qs/SecureSetting;
    ...
    :goto_1
    invoke-direct {p0}, isGrayEnabled()Z
...
.method private isGrayEnabled()Z
    ...
    iget-object p0, p0, mGrayModeSetting:Lcom/oneplus/util/SystemSetting;
...
.method protected handleClick()V
    ...
    invoke-direct {p0}, isColorCalibrationAvailable()Z
    ...
    iget-object p0, p0, mManager:Landroid/hardware/display/ColorDisplayManager;
...
.method protected handleSetListening(Z)V
    ...
    iput-boolean p1, p0, mIsListening:Z

    iget-object v0, p0, mInversionSetting:Lcom/android/systemui/qs/SecureSetting;

    invoke-virtual {v0, p1}, Lcom/android/systemui/qs/SecureSetting;->setListening(Z)V

    iget-object v0, p0, mDaltonizerSetting:Lcom/android/systemui/qs/SecureSetting;

    invoke-virtual {v0, p1}, Lcom/android/systemui/qs/SecureSetting;->setListening(Z)V

    iget-object v0, p0, mGrayModeSetting:Lcom/oneplus/util/SystemSetting;

    invoke-virtual {v0, p1}, Lcom/oneplus/util/SystemSetting;->setListening(Z)V

    if-eqz p1, :cond_0

    iget-object p1, p0, mListener:Landroid/hardware/display/NightDisplayListener;
    ...
    :cond_0
    iget-object p0, p0, mListener:Landroid/hardware/display/NightDisplayListener;
...
.method protected handleUpdateState(Lcom/android/systemui/plugins/qs/QSTile$BooleanState;Ljava/lang/Object;)V
    ...
    iget-object p2, p0, mManager:Landroid/hardware/display/ColorDisplayManager;
    ...
    invoke-direct {p0, p2}, getSecondaryLabel(Z)Ljava/lang/String;
...
.method protected handleUserSwitch(I)V
    ...
    iget-boolean v0, p0, mIsListening:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, mListener:Landroid/hardware/display/NightDisplayListener;
    ...
    iput-object v0, p0, mListener:Landroid/hardware/display/NightDisplayListener;
