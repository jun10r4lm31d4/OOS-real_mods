...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v1, p0, mFalsingCheck:Ljava/lang/Runnable;
...
.method static synthetic access$000(Lcom/android/systemui/statusbar/notification/row/NotificationGuts;)Z
    ...
    iget-boolean p0, p0, mNeedsFalsingProtection:Z
...
.method animateClose(IIZ)V
    ...
    iget-object p3, p0, mGutsContent:Lcom/android/systemui/statusbar/notification/row/NotificationGuts$GutsContent;
    ...
    iget-object p0, p0, mGutsContent:Lcom/android/systemui/statusbar/notification/row/NotificationGuts$GutsContent;
...
.method public closeControls(IIZZ)V
    ...
    iget-object p1, p0, mClosedListener:Lcom/android/systemui/statusbar/notification/row/NotificationGuts$OnGutsClosedListener;
    ...
    :cond_1
    iget-object v1, p0, mGutsContent:Lcom/android/systemui/statusbar/notification/row/NotificationGuts$GutsContent;
    ...
    invoke-virtual {p0, p1, p2, p3}, animateClose(IIZ)V

    const/4 p1, 0x0

    iget-boolean p2, p0, mNeedsFalsingProtection:Z

    invoke-virtual {p0, p1, p2}, setExposed(ZZ)V
...
.method public closeControls(ZZIIZ)V
    ...
    iget-object v0, p0, mGutsContent:Lcom/android/systemui/statusbar/notification/row/NotificationGuts$GutsContent;
    ...
    :cond_0
    iget-object p1, p0, mGutsContent:Lcom/android/systemui/statusbar/notification/row/NotificationGuts$GutsContent;
    ...
    invoke-virtual {p0, p3, p4, p1, p5}, closeControls(IIZZ)V
...
.method public drawableHotspotChanged(FF)V
    ...
    iget-object p0, p0, mBackground:Landroid/graphics/drawable/Drawable;
...
.method protected drawableStateChanged()V
    ...
    invoke-direct {p0, v0}, drawableStateChanged(Landroid/graphics/drawable/Drawable;)V
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-direct {p0, p1, v0}, draw(Landroid/graphics/Canvas;Landroid/graphics/drawable/Drawable;)V
...
.method protected onHeightChanged()V
    ...
    iget-object v0, p0, mHeightListener:Lcom/android/systemui/statusbar/notification/row/NotificationGuts$OnHeightChangedListener;
...
.method public openControls(ZIIZLjava/lang/Runnable;)V
    ...
    invoke-direct {p0, p1, p2, p3, p5}, animateOpen(ZIILjava/lang/Runnable;)V

    const/4 p1, 0x1

    invoke-virtual {p0, p1, p4}, setExposed(ZZ)V
...
.method public resetFalsingCheck()V
    ...
    iget-object v1, p0, mFalsingCheck:Ljava/lang/Runnable;

    invoke-virtual {v0, v1}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    iget-boolean v0, p0, mNeedsFalsingProtection:Z

    if-eqz v0, :cond_0

    iget-boolean v0, p0, mExposed:Z
...
.method public setClosedListener(Lcom/android/systemui/statusbar/notification/row/NotificationGuts$OnGutsClosedListener;)V
    ...
    iput-object p1, p0, mClosedListener:Lcom/android/systemui/statusbar/notification/row/NotificationGuts$OnGutsClosedListener;
...
.method setExposed(ZZ)V
    ...
    iput-boolean p1, p0, mExposed:Z

    iput-boolean p2, p0, mNeedsFalsingProtection:Z

    iget-boolean p1, p0, mExposed:Z

    if-eqz p1, :cond_0

    iget-boolean p1, p0, mNeedsFalsingProtection:Z

    if-eqz p1, :cond_0

    invoke-virtual {p0}, resetFalsingCheck()V
    ...
    iget-object p2, p0, mFalsingCheck:Ljava/lang/Runnable;
...
.method public setGutsContent(Lcom/android/systemui/statusbar/notification/row/NotificationGuts$GutsContent;)V
    ...
    iput-object p1, p0, mGutsContent:Lcom/android/systemui/statusbar/notification/row/NotificationGuts$GutsContent;
...
.method public setHeightChangedListener(Lcom/android/systemui/statusbar/notification/row/NotificationGuts$OnHeightChangedListener;)V
    ...
    iput-object p1, p0, mHeightListener:Lcom/android/systemui/statusbar/notification/row/NotificationGuts$OnHeightChangedListener;
