...
.method constructor <init>(Landroid/content/Context;Z)V
    ...
    iput-object v0, p0, mMenuItemsByView:Ljava/util/Map;

    const/4 v0, 0x2

    new-array v1, v0, [I

    iput-object v1, p0, mIconLocation:[I

    new-array v0, v0, [I

    iput-object v0, p0, mParentLocation:[I

    const/4 v0, -0x1

    iput v0, p0, mHorizSpaceForIcon:I

    iput v0, p0, mVertSpaceForIcons:I

    iput v0, p0, mIconPadding:I
    ...
    iput-boolean p1, p0, mShouldShowMenu:Z
    ...
    iput-object p1, p0, mLeftMenuItems:Ljava/util/ArrayList;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, mRightMenuItems:Ljava/util/ArrayList;

    iput-boolean p2, p0, mIsUsingBidirectionalSwipe:Z
...
.method static synthetic access$200(Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow;)Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;
    ...
    iget-object p0, p0, mParent:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;
...
.method static synthetic access$300(Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow;)Z
    ...
    invoke-direct {p0}, isMenuLocationChange()Z
...
.method static synthetic access$400(Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow;F)V
    ...
    invoke-direct {p0, p1}, fadeInMenu(F)V
...
.method static synthetic access$500(Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow;)Z
    ...
    iget-boolean p0, p0, mMenuFadedIn:Z
...
.method static synthetic access$502(Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow;Z)Z
    ...
    iput-boolean p1, p0, mMenuFadedIn:Z
...
.method private addMenuView(Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$MenuItem;Landroid/view/ViewGroup;)V
    ...
    iget v1, p0, mHorizSpaceForIcon:I
    ...
    :cond_0
    iget-object p0, p0, mMenuItemsByView:Ljava/util/Map;
...
.method private createMenuViews(ZZ)V
    ...
    iput-boolean p2, p0, mIsForeground:Z
    ...
    iput v1, p0, mHorizSpaceForIcon:I
    ...
    iget-object v0, p0, mLeftMenuItems:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    iget-object v0, p0, mRightMenuItems:Ljava/util/ArrayList;
    ...
    invoke-static {v3}, createSnoozeItem(Landroid/content/Context;)Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$MenuItem;

    move-result-object v3

    iput-object v3, p0, mSnoozeItem:Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$MenuItem;

    :cond_1
    iget-object v3, p0, mContext:Landroid/content/Context;

    invoke-static {v3}, createAppOpsItem(Landroid/content/Context;)Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$MenuItem;

    move-result-object v3

    iput-object v3, p0, mAppOpsItem:Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$MenuItem;

    iget-boolean v3, p0, mIsUsingBidirectionalSwipe:Z

    if-eqz v3, :cond_2

    iget-object v3, p0, mContext:Landroid/content/Context;

    iget-object v4, p0, mParent:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;
    ...
    invoke-static {v3, v2}, createInfoItem(Landroid/content/Context;Z)Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow$NotificationMenuItem;

    move-result-object v2

    iput-object v2, p0, mInfoItem:Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow$NotificationMenuItem;
    ...
    invoke-static {v2}, createInfoItem(Landroid/content/Context;)Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow$NotificationMenuItem;
    ...
    :goto_1
    iget-boolean v2, p0, mIsUsingBidirectionalSwipe:Z
    ...
    iget-object p2, p0, mRightMenuItems:Ljava/util/ArrayList;

    iget-object v0, p0, mSnoozeItem:Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$MenuItem;
    ...
    iget-object v0, p0, mInfoItem:Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow$NotificationMenuItem;

    invoke-virtual {p2, v0}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object p2, p0, mRightMenuItems:Ljava/util/ArrayList;

    iget-object v0, p0, mAppOpsItem:Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$MenuItem;

    invoke-virtual {p2, v0}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object p2, p0, mLeftMenuItems:Ljava/util/ArrayList;
    ...
    :cond_4
    iget-boolean p2, p0, mDismissRtl:Z
    ...
    :goto_3
    invoke-direct {p0}, populateMenuViews()V

    if-eqz p1, :cond_6

    invoke-direct {p0, v1}, resetState(Z)V

    goto :goto_4

    :cond_6
    iput-boolean v1, p0, mIconsPlaced:Z

    invoke-direct {p0}, setMenuLocation()V

    iget-boolean p1, p0, mIsUserTouching:Z

    if-nez p1, :cond_7

    invoke-virtual {p0}, onSnapOpen()V
...
.method private fadeInMenu(F)V
    ...
    iget-boolean v0, p0, mDismissing:Z
    ...
    invoke-virtual {p0, v1}, setMenuAlpha(F)V

    :cond_1
    iget v0, p0, mTranslation:F
    ...
    iput-object v2, p0, mFadeAnimator:Landroid/animation/ValueAnimator;

    iget-object v2, p0, mFadeAnimator:Landroid/animation/ValueAnimator;
    ...
    iget-object p1, p0, mFadeAnimator:Landroid/animation/ValueAnimator;
    ...
    iget-object p0, p0, mFadeAnimator:Landroid/animation/ValueAnimator;
...
.method private isMenuLocationChange()Z
    ...
    :goto_0
    iget v3, p0, mTranslation:F

    iget v4, p0, mIconPadding:I
    ...
    :goto_1
    invoke-virtual {p0}, isMenuOnLeft()Z
...
.method private populateMenuViews()V
    ...
    iget-object v0, p0, mMenuContainer:Landroid/widget/FrameLayout;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Landroid/widget/FrameLayout;->removeAllViews()V

    iget-object v0, p0, mMenuItemsByView:Ljava/util/Map;
    ...
    iput-object v0, p0, mMenuContainer:Landroid/widget/FrameLayout;

    :goto_0
    iget-boolean v0, p0, mOnLeft:Z
    ...
    iget-object v3, p0, mMenuContainer:Landroid/widget/FrameLayout;

    invoke-direct {p0, v2, v3}, addMenuView(Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$MenuItem;Landroid/view/ViewGroup;)V
...
.method private resetState(Z)V
    ...
    invoke-virtual {p0, v0}, setMenuAlpha(F)V

    const/4 v0, 0x0

    iput-boolean v0, p0, mIconsPlaced:Z

    iput-boolean v0, p0, mMenuFadedIn:Z

    iput-boolean v0, p0, mAnimating:Z

    iput-boolean v0, p0, mSnapping:Z

    iput-boolean v0, p0, mDismissing:Z

    iput-boolean v0, p0, mMenuSnapped:Z

    invoke-direct {p0}, setMenuLocation()V

    iget-object v0, p0, mMenuListener:Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$OnMenuEventListener;
...
.method private setMenuLocation()V
    ...
    :goto_0
    iget-boolean v3, p0, mIconsPlaced:Z
    ...
    :cond_1
    invoke-virtual {p0}, isSnapping()Z
    ...
    :cond_2
    iget-boolean v3, p0, mOnLeft:Z

    iput-boolean v0, p0, mOnLeft:Z
    ...
    iget-object v4, p0, mMenuContainer:Landroid/widget/FrameLayout;

    invoke-virtual {v4, v1}, Landroid/widget/FrameLayout;->getChildAt(I)Landroid/view/View;

    move-result-object v4

    iget v5, p0, mHorizSpaceForIcon:I

    mul-int/2addr v5, v1

    int-to-float v5, v5

    iget-object v6, p0, mParent:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;

    invoke-virtual {v6}, Landroid/widget/FrameLayout;->getWidth()I

    move-result v6

    iget v7, p0, mHorizSpaceForIcon:I
    ...
    :cond_5
    iput-boolean v2, p0, mIconsPlaced:Z
...
.method protected beginDrag()V
    ...
    iget-object v0, p0, mFadeAnimator:Landroid/animation/ValueAnimator;
    ...
    iget-object v1, p0, mCheckForDrag:Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow$CheckForDrag;

    invoke-virtual {v0, v1}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    const/4 v0, 0x0

    iput-object v0, p0, mCheckForDrag:Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow$CheckForDrag;

    const/4 v0, 0x1

    iput-boolean v0, p0, mIsUserTouching:Z
...
.method public canBeDismissed()Z
    ...
    invoke-virtual {p0}, getParent()Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;
...
.method protected cancelDrag()V
    ...
    iget-object p0, p0, mCheckForDrag:Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow$CheckForDrag;
...
.method public createMenu(Landroid/view/ViewGroup;Landroid/service/notification/StatusBarNotification;)V
    ...
    iput-object p1, p0, mParent:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;
    ...
    :goto_0
    invoke-direct {p0, p1, p2}, createMenuViews(ZZ)V
...
.method public getAppOpsMenuItem(Landroid/content/Context;)Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$MenuItem;
    ...
    iget-object p0, p0, mAppOpsItem:Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$MenuItem;
...
.method public getLongpressMenuItem(Landroid/content/Context;)Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$MenuItem;
    ...
    iget-object p0, p0, mInfoItem:Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow$NotificationMenuItem;
...
.method protected getMaximumSwipeDistance()F
    ...
    iget p0, p0, mHorizSpaceForIcon:I
...
.method public getMenuItems(Landroid/content/Context;)Ljava/util/ArrayList;
    ...
    iget-boolean p1, p0, mOnLeft:Z

    if-eqz p1, :cond_0

    iget-object p0, p0, mLeftMenuItems:Ljava/util/ArrayList;

    goto :goto_0

    :cond_0
    iget-object p0, p0, mRightMenuItems:Ljava/util/ArrayList;
...
.method public getMenuSnapTarget()I
    ...
    invoke-virtual {p0}, getSpaceForMenu()I
...
.method public getMenuView()Landroid/view/View;
    ...
    iget-object p0, p0, mMenuContainer:Landroid/widget/FrameLayout;
...
.method protected getSnapBackThreshold()F
    ...
    invoke-virtual {p0}, getMaximumSwipeDistance()F
...
.method public getSnoozeMenuItem(Landroid/content/Context;)Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$MenuItem;
    ...
    iget-object p0, p0, mSnoozeItem:Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$MenuItem;
...
.method protected getSpaceForMenu()I
    ...
    iget v0, p0, mHorizSpaceForIcon:I
...
.method protected isDismissing()Z
    ...
    iget-boolean p0, p0, mDismissing:Z
...
.method protected isMenuSnapped()Z
    ...
    iget-boolean p0, p0, mMenuSnapped:Z
...
.method protected isMenuSnappedOnLeft()Z
    ...
    iget-boolean p0, p0, mMenuSnappedOnLeft:Z
...
.method public isSnappedAndOnSameSide()Z
    ...
    invoke-virtual {p0}, isMenuSnapped()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, isMenuVisible()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, isMenuSnappedOnLeft()Z
...
.method protected isSnapping()Z
    ...
    iget-boolean p0, p0, mSnapping:Z
...
.method public isSwipedEnoughToShowMenu()Z
    ...
    invoke-virtual {p0}, getMinimumSwipeDistance()F
...
.method protected isUserTouching()Z
    ...
    iget-boolean p0, p0, mIsUserTouching:Z
...
.method public isWithinSnapMenuThreshold()Z
    ...
    invoke-virtual {p0}, getSnapBackThreshold()F

    move-result v1

    invoke-virtual {p0}, getDismissThreshold()F
...
.method public menuItemToExposeOnSnap()Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$MenuItem;
    ...
    iget-boolean v0, p0, mIsUsingBidirectionalSwipe:Z
...
.method public onClick(Landroid/view/View;)V
    ...
    :cond_0
    iget-object v0, p0, mIconLocation:[I

    invoke-virtual {p1, v0}, Landroid/view/View;->getLocationOnScreen([I)V

    iget-object v0, p0, mParent:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;

    iget-object v1, p0, mParentLocation:[I
    ...
    iget-object v2, p0, mIconLocation:[I

    const/4 v3, 0x0

    aget v4, v2, v3

    iget-object v5, p0, mParentLocation:[I
    ...
    iget-object v1, p0, mParent:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;
...
.method public onDismiss()V
    ...
    invoke-virtual {p0}, cancelDrag()V
...
.method public onNotificationUpdated(Landroid/service/notification/StatusBarNotification;)V
    ...
    :goto_0
    invoke-direct {p0, v0, v1}, createMenuViews(ZZ)V
...
.method public onParentHeightUpdate()V
    ...
    iget v1, p0, mVertSpaceForIcons:I
...
.method public onParentTranslationUpdate(F)V
    ...
    iput p1, p0, mTranslation:F

    iget-boolean v0, p0, mAnimating:Z

    if-nez v0, :cond_3

    iget-boolean v0, p0, mMenuFadedIn:Z
...
.method public onSnapOpen()V
    ...
    iput-boolean v0, p0, mMenuSnappedOnLeft:Z
    ...
    invoke-direct {p0, v0}, fadeInMenu(F)V
...
.method public onTouchMove(F)V
    ...
    invoke-virtual {p0, p1}, isTowardsMenu(F)Z
    ...
    iget-object v0, p0, mCheckForDrag:Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow$CheckForDrag;
    ...
    iput-object v1, p0, mCheckForDrag:Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow$CheckForDrag;
    ...
    invoke-virtual {p0, p1}, setMenuAlpha(F)V

    invoke-direct {p0}, setMenuLocation()V

    :cond_1
    :goto_0
    iget-boolean p1, p0, mShouldShowMenu:Z
    ...
    iget-object p1, p0, mParent:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;
    ...
    iget-object p1, p0, mCheckForDrag:Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow$CheckForDrag;
    ...
    iput-object p1, p0, mCheckForDrag:Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow$CheckForDrag;
...
.method public resetMenu()V
    ...
    invoke-direct {p0, v0}, resetState(Z)V
...
.method public setAppName(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, v0}, setAppName(Ljava/lang/String;Ljava/util/ArrayList;)V
...
.method public setDismissRtl(Z)V
    ...
    iget-object p1, p0, mMenuContainer:Landroid/widget/FrameLayout;

    if-eqz p1, :cond_0

    const/4 p1, 0x1

    iget-boolean v0, p0, mIsForeground:Z

    invoke-direct {p0, p1, v0}, createMenuViews(ZZ)V
...
.method protected setMenuAlpha(F)V
    ...
    iput-boolean v1, p0, mMenuFadedIn:Z
...
.method public setMenuClickListener(Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$OnMenuEventListener;)V
    ...
    iput-object p1, p0, mMenuListener:Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$OnMenuEventListener;
...
.method public shouldShowGutsOnSnapOpen()Z
    ...
    iget-boolean p0, p0, mIsUsingBidirectionalSwipe:Z
...
.method public shouldShowMenu()Z
    ...
    iget-boolean p0, p0, mShouldShowMenu:Z
