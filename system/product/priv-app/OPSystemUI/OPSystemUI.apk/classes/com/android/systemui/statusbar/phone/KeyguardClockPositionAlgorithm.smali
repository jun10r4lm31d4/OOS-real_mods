...
.method private burnInPreventionOffsetX()F
    ...
    iget v0, p0, mBurnInPreventionOffsetX:I
    ...
    iget p0, p0, mBurnInPreventionOffsetX:I
...
.method private burnInPreventionOffsetY()F
    ...
    iget v0, p0, mBurnInPreventionOffsetY:I
    ...
    iget p0, p0, mBurnInPreventionOffsetY:I
...
.method private getClockAlpha(I)F
    ...
    invoke-direct {p0}, getExpandedPreferredClockY()I
...
.method private getClockY()I
    ...
    iget-boolean v0, p0, mHasCustomClock:Z

    if-eqz v0, :cond_0

    invoke-direct {p0}, getPreferredClockY()I
    ...
    :cond_0
    invoke-direct {p0}, getMaxClockY()I
    ...
    invoke-direct {p0}, burnInPreventionOffsetY()F
    ...
    iget v2, p0, mKeyguardStatusHeight:I
...
.method private getExpandedPreferredClockY()I
    ...
    iget-boolean v0, p0, mHasVisibleNotifs:Z
    ...
    :cond_0
    invoke-virtual {p0}, getExpandedClockPosition()I
...
.method public getExpandedClockPosition()I
    ...
    iget v0, p0, mMaxShadeBottom:I

    iget v1, p0, mMinTopMargin:I
    ...
    sget v3, CLOCK_HEIGHT_WEIGHT:F

    mul-float/2addr v2, v3

    sub-float/2addr v0, v2

    iget v2, p0, mClockNotificationsMargin:I

    int-to-float v2, v2

    sub-float/2addr v0, v2

    iget v2, p0, mNotificationStackHeight:I
...
.method public getMinStackScrollerPadding()F
    ...
    iget v0, p0, mMinTopMargin:I

    iget v1, p0, mKeyguardStatusHeight:I

    add-int/2addr v0, v1

    iget p0, p0, mClockNotificationsMargin:I
...
.method public loadDimens(Landroid/content/res/Resources;)V
    ...
    iput v0, p0, mClockNotificationsMargin:I
    ...
    iput v0, p0, mContainerTopPadding:I
    ...
    iput v0, p0, mBurnInPreventionOffsetX:I
    ...
    iput v0, p0, mBurnInPreventionOffsetY:I

    sget-boolean v0, ONEPLUS_PORTING:Z
...
.method public run(Lcom/android/systemui/statusbar/phone/KeyguardClockPositionAlgorithm$Result;)V
    ...
    invoke-direct {p0}, burnInPreventionOffsetX()F
...
.method public setup(IIIFIIIZZFF)V
    ...
    iget v0, p0, mContainerTopPadding:I

    add-int/2addr v0, p1

    iput v0, p0, mMinTopMargin:I

    iput p2, p0, mMaxShadeBottom:I

    iput p3, p0, mNotificationStackHeight:I

    iput p4, p0, mPanelExpansion:F

    iput p5, p0, mHeight:I

    iput p6, p0, mKeyguardStatusHeight:I

    iput p7, p0, mClockPreferredY:I

    iput-boolean p8, p0, mHasCustomClock:Z

    iput-boolean p9, p0, mHasVisibleNotifs:Z

    iput p10, p0, mDarkAmount:F

    iput p11, p0, mEmptyDragAmount:F
