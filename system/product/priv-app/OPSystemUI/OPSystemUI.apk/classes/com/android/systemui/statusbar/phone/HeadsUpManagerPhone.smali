...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;Lcom/android/systemui/statusbar/phone/NotificationGroupManager;Lcom/android/systemui/statusbar/phone/StatusBar;Lcom/android/systemui/statusbar/notification/VisualStabilityManager;)V
    ...
    iput-object v0, p0, mSwipedOutKeys:Ljava/util/HashSet;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, mEntriesToRemoveAfterExpand:Ljava/util/HashSet;

    new-instance v0, Landroidx/collection/ArraySet;

    invoke-direct {v0}, Landroidx/collection/ArraySet;-><init>()V

    iput-object v0, p0, mEntriesToRemoveWhenReorderingAllowed:Landroidx/collection/ArraySet;

    const/4 v0, 0x2

    new-array v0, v0, [I

    iput-object v0, p0, mTmpTwoArray:[I
    ...
    iput-object v0, p0, mEntryPool:Landroid/util/Pools$Pool;

    iput-object p2, p0, mStatusBarWindowView:Landroid/view/View;
    ...
    iput-object v0, p0, mStatusBarTouchableRegionManager:Lcom/android/systemui/statusbar/phone/StatusBarTouchableRegionManager;

    iput-object p3, p0, mGroupManager:Lcom/android/systemui/statusbar/phone/NotificationGroupManager;

    iput-object p5, p0, mVisualStabilityManager:Lcom/android/systemui/statusbar/notification/VisualStabilityManager;

    invoke-direct {p0}, initResources()V
...
.method static synthetic access$000(Lcom/android/systemui/statusbar/phone/HeadsUpManagerPhone;)Lcom/android/systemui/statusbar/phone/StatusBarTouchableRegionManager;
    ...
    iget-object p0, p0, mStatusBarTouchableRegionManager:Lcom/android/systemui/statusbar/phone/StatusBarTouchableRegionManager;
...
.method static synthetic access$100(Lcom/android/systemui/statusbar/phone/HeadsUpManagerPhone;)Ljava/util/HashSet;
    ...
    iget-object p0, p0, mEntriesToRemoveAfterExpand:Ljava/util/HashSet;
...
.method static synthetic access$200(Lcom/android/systemui/statusbar/phone/HeadsUpManagerPhone;)Landroidx/collection/ArraySet;
    ...
    iget-object p0, p0, mEntriesToRemoveWhenReorderingAllowed:Landroidx/collection/ArraySet;
...
.method private initResources()V
    ...
    iput v0, p0, mDisplayCutoutTouchableRegionSize:I
...
.method private updateRegionForNotch(Landroid/graphics/Region;)V
    ...
    iget-object v0, p0, mStatusBarWindowView:Landroid/view/View;
    ...
    iget p0, p0, mDisplayCutoutTouchableRegionSize:I
...
.method public addSwipedOutNotification(Ljava/lang/String;)V
    ...
    iget-object p0, p0, mSwipedOutKeys:Ljava/util/HashSet;
...
.method public calculateTouchableRegion()Landroid/graphics/Region;
    ...
    :cond_0
    invoke-virtual {p0}, removeOversizeEntries()V
    ...
    iget-object v1, p0, mTmpTwoArray:[I
    ...
    iget-object v4, p0, mTouchableRegion:Landroid/graphics/Region;

    iget v5, p0, mHeadsUpInset:I
    ...
    iget-object v1, p0, mStatusBarWindowView:Landroid/view/View;
    ...
    invoke-direct {p0, v0}, updateRegionForNotch(Landroid/graphics/Region;)V

    :goto_1
    iget-object p0, p0, mTouchableRegion:Landroid/graphics/Region;
...
.method protected canRemoveImmediately(Ljava/lang/String;)Z
    ...
    iget-object v0, p0, mSwipedOutKeys:Ljava/util/HashSet;
    ...
    :cond_1
    invoke-direct {p0, p1}, getHeadsUpEntryPhone(Ljava/lang/String;)Lcom/android/systemui/statusbar/phone/HeadsUpManagerPhone$HeadsUpEntryPhone;

    move-result-object v0

    invoke-direct {p0}, getTopHeadsUpEntryPhone()Lcom/android/systemui/statusbar/phone/HeadsUpManagerPhone$HeadsUpEntryPhone;
...
.method protected bridge synthetic createAlertEntry()Lcom/android/systemui/statusbar/AlertingNotificationManager$AlertEntry;
    ...
    invoke-virtual {p0}, createAlertEntry()Lcom/android/systemui/statusbar/policy/HeadsUpManager$HeadsUpEntry;
...
.method protected createAlertEntry()Lcom/android/systemui/statusbar/policy/HeadsUpManager$HeadsUpEntry;
    ...
    iget-object p0, p0, mEntryPool:Landroid/util/Pools$Pool;
...
.method public isHeadsUpGoingAway()Z
    ...
    iget-boolean p0, p0, mHeadsUpGoingAway:Z
...
.method public onExpandingFinished()V
    ...
    iget-boolean v0, p0, mReleaseOnExpandFinish:Z
    ...
    iput-boolean v0, p0, mReleaseOnExpandFinish:Z

    goto :goto_1

    :cond_0
    iget-object v0, p0, mEntriesToRemoveAfterExpand:Ljava/util/HashSet;
...
.method public onReorderingAllowed()V
    ...
    iget-object v0, p0, mAnimationStateHandler:Lcom/android/systemui/statusbar/phone/HeadsUpManagerPhone$AnimationStateHandler;
    ...
    iget-object v0, p0, mEntriesToRemoveWhenReorderingAllowed:Landroidx/collection/ArraySet;
    ...
    iget-object p0, p0, mAnimationStateHandler:Lcom/android/systemui/statusbar/phone/HeadsUpManagerPhone$AnimationStateHandler;
...
.method protected removeOversizeEntries()V
    ...
    invoke-direct {p0, v2}, getHeadsUpEntryPhone(Ljava/lang/String;)Lcom/android/systemui/statusbar/phone/HeadsUpManagerPhone$HeadsUpEntryPhone;
...
.method public setAnimationStateHandler(Lcom/android/systemui/statusbar/phone/HeadsUpManagerPhone$AnimationStateHandler;)V
    ...
    iput-object p1, p0, mAnimationStateHandler:Lcom/android/systemui/statusbar/phone/HeadsUpManagerPhone$AnimationStateHandler;
...
.method public setHeadsUpGoingAway(Z)V
    ...
    iget-boolean v0, p0, mHeadsUpGoingAway:Z

    if-eq p1, v0, :cond_1

    iput-boolean p1, p0, mHeadsUpGoingAway:Z
...
.method public setIsPanelExpanded(Z)V
    ...
    iput-boolean v0, p0, mHeadsUpGoingAway:Z

    :cond_0
    iget-object v0, p0, mStatusBarTouchableRegionManager:Lcom/android/systemui/statusbar/phone/StatusBarTouchableRegionManager;
...
.method public setTrackingHeadsUp(Z)V
    ...
    iput-boolean p1, p0, mTrackingHeadsUp:Z
...
.method public updateTouchableRegion(Landroid/view/ViewTreeObserver$InternalInsetsInfo;)V
    ...
    invoke-virtual {p0}, calculateTouchableRegion()Landroid/graphics/Region;
