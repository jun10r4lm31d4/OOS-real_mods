...
.method static constructor <clinit>()V
    ...
    sput-object v0, TILE_COMPARATOR:Ljava/util/Comparator;
...
.method constructor <init>(Landroid/os/Parcel;)V
    ...
    iput-object v0, p0, userHandle:Ljava/util/ArrayList;

    invoke-virtual {p1}, Landroid/os/Parcel;->readString()Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, mActivityPackage:Ljava/lang/String;

    invoke-virtual {p1}, Landroid/os/Parcel;->readString()Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, mActivityName:Ljava/lang/String;

    new-instance v0, Landroid/content/Intent;

    invoke-direct {v0}, Landroid/content/Intent;-><init>()V

    iget-object v1, p0, mActivityPackage:Ljava/lang/String;

    iget-object v2, p0, mActivityName:Ljava/lang/String;
    ...
    iget-object v2, p0, userHandle:Ljava/util/ArrayList;
...
.method public getOrder()I
    ...
    invoke-virtual {p0}, hasOrder()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object p0, p0, mMetaData:Landroid/os/Bundle;
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    iget-object v0, p0, mActivityPackage:Ljava/lang/String;

    invoke-virtual {p1, v0}, Landroid/os/Parcel;->writeString(Ljava/lang/String;)V

    iget-object v0, p0, mActivityName:Ljava/lang/String;

    invoke-virtual {p1, v0}, Landroid/os/Parcel;->writeString(Ljava/lang/String;)V

    iget-object v0, p0, userHandle:Ljava/util/ArrayList;
    ...
    :cond_0
    iget-object p2, p0, mCategory:Ljava/lang/String;
