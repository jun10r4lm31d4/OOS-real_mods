...
.method static constructor <clinit>()V
    ...
    sput-object v0, NR_STATUS_STRING_TO_INDEX:Ljava/util/Map;

    sget-object v0, NR_STATUS_STRING_TO_INDEX:Ljava/util/Map;
...
.method constructor <init>()V
    ...
    iput-object v0, p0, nr5GIconMap:Ljava/util/Map;

    const/4 v0, 0x0

    iput-boolean v0, p0, showAtLeast3G:Z

    iput-boolean v0, p0, alwaysShowCdmaRssi:Z

    iput-boolean v0, p0, show4gForLte:Z

    iput-boolean v0, p0, hideLtePlus:Z

    iput-boolean v0, p0, inflateSignalStrengths:Z

    iput-boolean v0, p0, alwaysShowDataRatIcon:Z

    const-string v1, ""

    iput-object v1, p0, patternOfCarrierSpecificDataIcon:Ljava/lang/String;

    iput-boolean v0, p0, showRsrpSignalLevelforLTE:Z

    iput-boolean v0, p0, hideNoInternetState:Z

    iput-boolean v0, p0, showVolteIcon:Z

    iput-boolean v0, p0, alwaysShowNetworkTypeIcon:Z
...
.method static add5GIconMapping(Ljava/lang/String;Lcom/android/systemui/statusbar/policy/NetworkControllerImpl$Config;)V
    ...
    :cond_2
    sget-object v1, NR_STATUS_STRING_TO_INDEX:Ljava/util/Map;
    ...
    iget-object p1, p1, nr5GIconMap:Ljava/util/Map;
...
.method static readConfig(Landroid/content/Context;)Lcom/android/systemui/statusbar/policy/NetworkControllerImpl$Config;
    ...
    iput-boolean v2, v0, showAtLeast3G:Z
    ...
    iput-boolean v2, v0, alwaysShowCdmaRssi:Z
    ...
    iput-boolean v2, v0, hspaDataDistinguishable:Z

    const/4 v2, 0x0

    iput-boolean v2, v0, inflateSignalStrengths:Z
    ...
    iput-boolean v3, v0, alwaysShowNetworkTypeIcon:Z
    ...
    iput-boolean v3, v0, showRsrpSignalLevelforLTE:Z
    ...
    iput-boolean v3, v0, hideNoInternetState:Z
    ...
    iput-boolean v3, v0, showVolteIcon:Z
    ...
    iput-boolean v3, v0, alwaysShowDataRatIcon:Z
    ...
    iput-boolean v3, v0, show4gForLte:Z
    ...
    iput-boolean v3, v0, hideLtePlus:Z
    ...
    iput-object v3, v0, patternOfCarrierSpecificDataIcon:Ljava/lang/String;
    ...
    invoke-static {v4, v0}, add5GIconMapping(Ljava/lang/String;Lcom/android/systemui/statusbar/policy/NetworkControllerImpl$Config;)V
    ...
    iput-boolean p0, v0, readIconsFromXml:Z
    ...
    iput-boolean p0, v0, showRsrpSignalLevelforLTE:Z
    ...
    iput-boolean p0, v0, showVolteIcon:Z
