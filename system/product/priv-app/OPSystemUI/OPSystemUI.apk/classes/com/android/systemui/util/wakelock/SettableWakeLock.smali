...
.method public constructor <init>(Lcom/android/systemui/util/wakelock/WakeLock;Ljava/lang/String;)V
    ...
    iput-object p1, p0, mInner:Lcom/android/systemui/util/wakelock/WakeLock;

    iput-object p2, p0, mWhy:Ljava/lang/String;
...
.method public declared-synchronized setAcquired(Z)V
    ...
    :try_start_0
    iget-boolean v0, p0, mAcquired:Z

    if-eq v0, p1, :cond_1

    if-eqz p1, :cond_0

    iget-object v0, p0, mInner:Lcom/android/systemui/util/wakelock/WakeLock;

    iget-object v1, p0, mWhy:Ljava/lang/String;
    ...
    :goto_0
    iput-boolean p1, p0, mAcquired:Z
    :try_end_0
