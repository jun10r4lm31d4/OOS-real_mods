...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;)V
    ...
    iput v0, p0, mGlowAlpha:F

    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, p0, mGlowScale:F
    ...
    iput-object v0, p0, mRunningAnimations:Ljava/util/HashSet;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mTmpArray:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, mType:Lcom/android/systemui/statusbar/policy/KeyButtonRipple$Type;
    ...
    iput-object p2, p0, mTargetView:Landroid/view/View;
...
.method static synthetic access$100(Lcom/android/systemui/statusbar/policy/KeyButtonRipple;)Ljava/util/HashSet;
    ...
    iget-object p0, p0, mRunningAnimations:Ljava/util/HashSet;
...
.method static synthetic access$402(Lcom/android/systemui/statusbar/policy/KeyButtonRipple;Z)Z
    ...
    iput-boolean p1, p0, mDrawingHardwareGlow:Z
...
.method private cancelAnimations()V
    ...
    iget-object v1, p0, mTmpArray:Ljava/util/ArrayList;

    iget-object v2, p0, mRunningAnimations:Ljava/util/HashSet;
    ...
    iget-object v2, p0, mTmpArray:Ljava/util/ArrayList;
    ...
    :cond_0
    iget-object v0, p0, mTmpArray:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    iget-object v0, p0, mRunningAnimations:Ljava/util/HashSet;
...
.method private drawHardware(Landroid/graphics/RecordingCanvas;)V
    ...
    iget-boolean v0, p0, mDrawingHardwareGlow:Z

    if-eqz v0, :cond_1

    iget-object v0, p0, mType:Lcom/android/systemui/statusbar/policy/KeyButtonRipple$Type;
    ...
    iget-object v3, p0, mLeftProp:Landroid/graphics/CanvasProperty;

    iget-object v4, p0, mTopProp:Landroid/graphics/CanvasProperty;

    iget-object v5, p0, mRightProp:Landroid/graphics/CanvasProperty;

    iget-object v6, p0, mBottomProp:Landroid/graphics/CanvasProperty;

    iget-object v7, p0, mRxProp:Landroid/graphics/CanvasProperty;

    iget-object v8, p0, mRyProp:Landroid/graphics/CanvasProperty;

    iget-object v9, p0, mPaintProp:Landroid/graphics/CanvasProperty;
    ...
    iget-object p0, p0, mPaintProp:Landroid/graphics/CanvasProperty;
...
.method private drawSoftware(Landroid/graphics/Canvas;)V
    ...
    invoke-direct {p0}, getRipplePaint()Landroid/graphics/Paint;

    move-result-object v0

    iget v1, p0, mGlowAlpha:F
    ...
    :goto_0
    invoke-direct {p0}, getRippleSize()I

    move-result v4

    int-to-float v4, v4

    iget v5, p0, mGlowScale:F
    ...
    :goto_2
    iget-object p0, p0, mType:Lcom/android/systemui/statusbar/policy/KeyButtonRipple$Type;
...
.method private enterHardware()V
    ...
    invoke-direct {p0}, cancelAnimations()V

    const/4 v0, 0x1

    iput-boolean v0, p0, mVisible:Z

    iput-boolean v0, p0, mDrawingHardwareGlow:Z

    invoke-direct {p0}, getExtendSize()I
    ...
    invoke-direct {p0, v0}, setExtendStart(Landroid/graphics/CanvasProperty;)V

    new-instance v0, Landroid/view/RenderNodeAnimator;

    invoke-direct {p0}, getExtendStart()Landroid/graphics/CanvasProperty;
    ...
    iget-object v3, p0, mInterpolator:Landroid/view/animation/Interpolator;

    invoke-virtual {v0, v3}, Landroid/view/RenderNodeAnimator;->setInterpolator(Landroid/animation/TimeInterpolator;)V

    iget-object v3, p0, mAnimatorListener:Landroid/animation/AnimatorListenerAdapter;
    ...
    invoke-direct {p0, v3}, setExtendEnd(Landroid/graphics/CanvasProperty;)V

    new-instance v3, Landroid/view/RenderNodeAnimator;

    invoke-direct {p0}, getExtendEnd()Landroid/graphics/CanvasProperty;
    ...
    iget-object v1, p0, mAnimatorListener:Landroid/animation/AnimatorListenerAdapter;
    ...
    iput-object v1, p0, mTopProp:Landroid/graphics/CanvasProperty;
    ...
    iput-object v1, p0, mBottomProp:Landroid/graphics/CanvasProperty;
    ...
    iput-object v1, p0, mRxProp:Landroid/graphics/CanvasProperty;
    ...
    iput-object v1, p0, mRyProp:Landroid/graphics/CanvasProperty;
    ...
    iput-object v1, p0, mLeftProp:Landroid/graphics/CanvasProperty;
    ...
    iput-object v1, p0, mRightProp:Landroid/graphics/CanvasProperty;
    ...
    :goto_0
    iput v4, p0, mGlowScale:F

    invoke-direct {p0}, getMaxGlowAlpha()F

    move-result v1

    iput v1, p0, mGlowAlpha:F

    invoke-direct {p0}, getRipplePaint()Landroid/graphics/Paint;

    move-result-object v1

    iput-object v1, p0, mRipplePaint:Landroid/graphics/Paint;

    iget-object v1, p0, mRipplePaint:Landroid/graphics/Paint;

    iget v2, p0, mGlowAlpha:F
    ...
    iput-object v1, p0, mPaintProp:Landroid/graphics/CanvasProperty;

    invoke-virtual {v0}, Landroid/view/RenderNodeAnimator;->start()V

    invoke-virtual {v3}, Landroid/view/RenderNodeAnimator;->start()V

    iget-object v1, p0, mRunningAnimations:Ljava/util/HashSet;
    ...
    iget-boolean v0, p0, mDelayTouchFeedback:Z

    if-eqz v0, :cond_1

    iget-boolean v0, p0, mPressed:Z

    if-nez v0, :cond_1

    invoke-direct {p0}, exitHardware()V
...
.method private enterSoftware()V
    ...
    invoke-direct {p0}, exitSoftware()V
...
.method private exitHardware()V
    ...
    iput-object v0, p0, mPaintProp:Landroid/graphics/CanvasProperty;

    new-instance v0, Landroid/view/RenderNodeAnimator;

    iget-object v1, p0, mPaintProp:Landroid/graphics/CanvasProperty;
...
.method private getExtendEnd()Landroid/graphics/CanvasProperty;
    ...
    iget-object p0, p0, mRightProp:Landroid/graphics/CanvasProperty;

    goto :goto_0

    :cond_0
    iget-object p0, p0, mBottomProp:Landroid/graphics/CanvasProperty;
...
.method private getExtendStart()Landroid/graphics/CanvasProperty;
    ...
    iget-object p0, p0, mLeftProp:Landroid/graphics/CanvasProperty;

    goto :goto_0

    :cond_0
    iget-object p0, p0, mTopProp:Landroid/graphics/CanvasProperty;
...
.method private getMaxGlowAlpha()F
    ...
    iget-boolean p0, p0, mLastDark:Z
...
.method private getRipplePaint()Landroid/graphics/Paint;
    ...
    iget-object v0, p0, mRipplePaint:Landroid/graphics/Paint;
    ...
    iput-object v0, p0, mRipplePaint:Landroid/graphics/Paint;
    ...
    iget-boolean v1, p0, mLastDark:Z
    ...
    :cond_1
    iget-object p0, p0, mRipplePaint:Landroid/graphics/Paint;
...
.method public static synthetic lambda$Xl4rWJU_4TFxkXeTg6i8PM566MQ(Lcom/android/systemui/statusbar/policy/KeyButtonRipple;)V
    ...
    invoke-direct {p0}, enterHardware()V
...
.method public static synthetic lambda$_NjSlP8uc8G3rFUDxQkVsRHA4H4(Lcom/android/systemui/statusbar/policy/KeyButtonRipple;)V
    ...
    invoke-direct {p0}, enterSoftware()V
...
.method private setExtendEnd(Landroid/graphics/CanvasProperty;)V
    ...
    iput-object p1, p0, mRightProp:Landroid/graphics/CanvasProperty;

    goto :goto_0

    :cond_0
    iput-object p1, p0, mBottomProp:Landroid/graphics/CanvasProperty;
...
.method private setExtendStart(Landroid/graphics/CanvasProperty;)V
    ...
    iput-object p1, p0, mLeftProp:Landroid/graphics/CanvasProperty;

    goto :goto_0

    :cond_0
    iput-object p1, p0, mTopProp:Landroid/graphics/CanvasProperty;
...
.method private setPressedHardware(Z)V
    ...
    iget-boolean p1, p0, mDelayTouchFeedback:Z

    if-eqz p1, :cond_1

    iget-object p1, p0, mRunningAnimations:Ljava/util/HashSet;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-direct {p0, p1}, drawHardware(Landroid/graphics/RecordingCanvas;)V

    goto :goto_0

    :cond_0
    invoke-direct {p0, p1}, drawSoftware(Landroid/graphics/Canvas;)V
...
.method protected onStateChange([I)Z
    ...
    :goto_1
    iget-boolean v1, p0, mPressed:Z

    if-eq p1, v1, :cond_2

    invoke-virtual {p0, p1}, setPressed(Z)V

    iput-boolean p1, p0, mPressed:Z
...
.method public setDelayTouchFeedback(Z)V
    ...
    iput-boolean p1, p0, mDelayTouchFeedback:Z
...
.method public setPressed(Z)V
    ...
    iput-boolean v0, p0, mLastDark:Z
    ...
    invoke-direct {p0, p1}, setPressedHardware(Z)V

    goto :goto_0

    :cond_1
    invoke-direct {p0, p1}, setPressedSoftware(Z)V
...
.method public setType(Lcom/android/systemui/statusbar/policy/KeyButtonRipple$Type;)V
    ...
    iput-object p1, p0, mType:Lcom/android/systemui/statusbar/policy/KeyButtonRipple$Type;
