...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, mCameraManager:Landroid/hardware/camera2/CameraManager;

    invoke-direct {p0}, tryInitCamera()V
...
.method static synthetic access$000(Lcom/android/systemui/statusbar/policy/FlashlightControllerImpl;)Ljava/lang/String;
    ...
    iget-object p0, p0, mCameraId:Ljava/lang/String;
...
.method static synthetic access$200(Lcom/android/systemui/statusbar/policy/FlashlightControllerImpl;)Z
    ...
    iget-boolean p0, p0, mTorchAvailable:Z
...
.method static synthetic access$202(Lcom/android/systemui/statusbar/policy/FlashlightControllerImpl;Z)Z
    ...
    iput-boolean p1, p0, mTorchAvailable:Z
...
.method static synthetic access$300(Lcom/android/systemui/statusbar/policy/FlashlightControllerImpl;Z)V
    ...
    invoke-direct {p0, p1}, dispatchAvailabilityChanged(Z)V
...
.method static synthetic access$400(Lcom/android/systemui/statusbar/policy/FlashlightControllerImpl;)Z
    ...
    iget-boolean p0, p0, mFlashlightEnabled:Z
...
.method static synthetic access$402(Lcom/android/systemui/statusbar/policy/FlashlightControllerImpl;Z)Z
    ...
    iput-boolean p1, p0, mFlashlightEnabled:Z
...
.method static synthetic access$500(Lcom/android/systemui/statusbar/policy/FlashlightControllerImpl;Z)V
    ...
    invoke-direct {p0, p1}, dispatchModeChanged(Z)V
...
.method private dispatchAvailabilityChanged(Z)V
    ...
    invoke-direct {p0, v0, p1}, dispatchListeners(IZ)V
...
.method private dispatchError()V
    ...
    invoke-direct {p0, v0, v1}, dispatchListeners(IZ)V
...
.method private dispatchListeners(IZ)V
    ...
    invoke-direct {p0, p1}, cleanUpListenersLocked(Lcom/android/systemui/statusbar/policy/FlashlightController$FlashlightListener;)V
...
.method private getCameraId()Ljava/lang/String;
    ...
    iget-object v0, p0, mCameraManager:Landroid/hardware/camera2/CameraManager;
    ...
    iget-object v4, p0, mCameraManager:Landroid/hardware/camera2/CameraManager;
...
.method private tryInitCamera()V
    ...
    iput-object v0, p0, mCameraId:Ljava/lang/String;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object v0, p0, mCameraId:Ljava/lang/String;

    if-eqz v0, :cond_0

    invoke-direct {p0}, ensureHandler()V

    iget-object v0, p0, mCameraManager:Landroid/hardware/camera2/CameraManager;

    iget-object v1, p0, mTorchCallback:Landroid/hardware/camera2/CameraManager$TorchCallback;
...
.method public addCallback(Lcom/android/systemui/statusbar/policy/FlashlightController$FlashlightListener;)V
    ...
    :try_start_0
    iget-object v1, p0, mCameraId:Ljava/lang/String;
    ...
    iget-boolean v1, p0, mTorchAvailable:Z
...
.method public bridge synthetic addCallback(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, addCallback(Lcom/android/systemui/statusbar/policy/FlashlightController$FlashlightListener;)V
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object p1, p0, mCameraId:Ljava/lang/String;
    ...
    iget-boolean p1, p0, mFlashlightEnabled:Z
...
.method public declared-synchronized isAvailable()Z
    ...
    :try_start_0
    iget-boolean v0, p0, mTorchAvailable:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized isEnabled()Z
    ...
    :try_start_0
    iget-boolean v0, p0, mFlashlightEnabled:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public bridge synthetic removeCallback(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, removeCallback(Lcom/android/systemui/statusbar/policy/FlashlightController$FlashlightListener;)V
...
.method public setFlashlight(Z)V
    ...
    iget-object v3, p0, mCameraId:Ljava/lang/String;
    ...
    iget-object v2, p0, mCameraId:Ljava/lang/String;
    ...
    iput-boolean v1, p0, mFlashlightEnabled:Z
    ...
    invoke-direct {p0}, dispatchError()V
