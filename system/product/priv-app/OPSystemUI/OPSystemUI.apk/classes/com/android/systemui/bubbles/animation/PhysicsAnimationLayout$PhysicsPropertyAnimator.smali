...
.method protected constructor <init>(Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;Landroid/view/View;)V
    ...
    iput-object p1, p0, this$0:Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    const p1, -0x800001

    iput p1, p0, mDefaultStartVelocity:F
    ...
    iput p1, p0, mDampingRatio:F

    iput p1, p0, mStiffness:F

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, mEndActionsForProperty:Ljava/util/Map;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, mPositionStartVelocities:Ljava/util/Map;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, mAnimatedProperties:Ljava/util/Map;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, mInitialPropertyValues:Ljava/util/Map;
...
.method static synthetic access$000(Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;)V
    ...
    invoke-direct {p0}, clearAnimator()V
...
.method static synthetic access$100(Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsAnimationController;)V
    ...
    invoke-direct {p0, p1}, setAssociatedController(Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsAnimationController;)V
...
.method private clearAnimator()V
    ...
    iget-object v0, p0, mInitialPropertyValues:Ljava/util/Map;

    invoke-interface {v0}, Ljava/util/Map;->clear()V

    iget-object v0, p0, mAnimatedProperties:Ljava/util/Map;

    invoke-interface {v0}, Ljava/util/Map;->clear()V

    iget-object v0, p0, mPositionStartVelocities:Ljava/util/Map;

    invoke-interface {v0}, Ljava/util/Map;->clear()V

    const v0, -0x800001

    iput v0, p0, mDefaultStartVelocity:F
    ...
    iput v0, p0, mStiffness:F

    iput v0, p0, mDampingRatio:F

    iget-object p0, p0, mEndActionsForProperty:Ljava/util/Map;
...
.method private setAssociatedController(Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsAnimationController;)V
    ...
    iput-object p1, p0, mAssociatedController:Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsAnimationController;
...
.method public varargs alpha(FF[Ljava/lang/Runnable;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
    ...
    invoke-virtual {p0, p2, p3}, alpha(F[Ljava/lang/Runnable;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
...
.method public varargs alpha(F[Ljava/lang/Runnable;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
    ...
    invoke-virtual {p0, v0, p1, p2}, property(Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;F[Ljava/lang/Runnable;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
...
.method protected animateValueForChild(Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;Landroid/view/View;FFJFF[Ljava/lang/Runnable;)V
    ...
    iget-object v5, v0, this$0:Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;
    ...
    iget-object v0, v0, this$0:Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;
...
.method protected getAnimatedProperties()Ljava/util/Set;
    ...
    iget-object p0, p0, mAnimatedProperties:Ljava/util/Map;
...
.method public synthetic lambda$start$1$PhysicsAnimationLayout$PhysicsPropertyAnimator(Landroidx/dynamicanimation/animation/SpringAnimation;Landroidx/dynamicanimation/animation/SpringAnimation;)V
    ...
    iget-object p1, p0, mPositionEndActions:[Ljava/lang/Runnable;
    ...
    iput-object p1, p0, mPositionEndActions:[Ljava/lang/Runnable;
...
.method public varargs position(FF[Ljava/lang/Runnable;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
    ...
    iput-object p3, p0, mPositionEndActions:[Ljava/lang/Runnable;

    const/4 p3, 0x0

    new-array v0, p3, [Ljava/lang/Runnable;

    invoke-virtual {p0, p1, v0}, translationX(F[Ljava/lang/Runnable;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;

    new-array p1, p3, [Ljava/lang/Runnable;

    invoke-virtual {p0, p2, p1}, translationY(F[Ljava/lang/Runnable;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
...
.method public varargs property(Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;F[Ljava/lang/Runnable;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
    ...
    iget-object p2, p0, mEndActionsForProperty:Ljava/util/Map;
...
.method public varargs scaleX(FF[Ljava/lang/Runnable;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
    ...
    invoke-virtual {p0, p2, p3}, scaleX(F[Ljava/lang/Runnable;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
...
.method public varargs scaleY(FF[Ljava/lang/Runnable;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
    ...
    invoke-virtual {p0, p2, p3}, scaleY(F[Ljava/lang/Runnable;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
...
.method public varargs start([Ljava/lang/Runnable;)V
    ...
    iget-object v0, p0, this$0:Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;

    iget-object v1, p0, mAssociatedController:Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsAnimationController;
    ...
    :cond_0
    invoke-virtual {p0}, getAnimatedProperties()Ljava/util/Set;
    ...
    iget-object v3, p0, this$0:Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;
    ...
    iget-object p1, p0, this$0:Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;
    ...
    iget-object v2, p0, this$0:Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;
    ...
    iget-object p1, p0, mEndActionsForProperty:Ljava/util/Map;
    ...
    iget-object v1, p0, mInitialPropertyValues:Ljava/util/Map;
    ...
    iget-object v1, p0, mAnimatedProperties:Ljava/util/Map;
    ...
    iget-object v1, p0, mPositionStartVelocities:Ljava/util/Map;

    iget v5, p0, mDefaultStartVelocity:F
    ...
    :goto_2
    iget-object v1, p0, mEndActionsForProperty:Ljava/util/Map;
    ...
    invoke-virtual/range {v1 .. v10}, animateValueForChild(Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;Landroid/view/View;FFJFF[Ljava/lang/Runnable;)V
...
.method public varargs translationX(FF[Ljava/lang/Runnable;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
    ...
    invoke-virtual {p0, p2, p3}, translationX(F[Ljava/lang/Runnable;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
...
.method public varargs translationY(FF[Ljava/lang/Runnable;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
    ...
    invoke-virtual {p0, p2, p3}, translationY(F[Ljava/lang/Runnable;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
...
.method public withPositionStartVelocities(FF)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
    ...
    iget-object p1, p0, mPositionStartVelocities:Ljava/util/Map;
