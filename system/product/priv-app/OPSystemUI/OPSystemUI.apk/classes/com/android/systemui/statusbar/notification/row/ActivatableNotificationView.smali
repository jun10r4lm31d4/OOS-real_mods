...
.method static constructor <clinit>()V
    ...
    sput-object v0, ACTIVATE_INVERSE_INTERPOLATOR:Landroid/view/animation/Interpolator;

    new-instance v0, Landroid/view/animation/PathInterpolator;

    invoke-direct {v0, v3, v3, v2, v1}, Landroid/view/animation/PathInterpolator;-><init>(FFFF)V

    sput-object v0, ACTIVATE_INVERSE_ALPHA_INTERPOLATOR:Landroid/view/animation/Interpolator;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput p2, p0, mBgTint:I

    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, p0, mBgAlpha:F

    new-instance v1, Landroid/graphics/RectF;

    invoke-direct {v1}, Landroid/graphics/RectF;-><init>()V

    iput-object v1, p0, mAppearAnimationRect:Landroid/graphics/RectF;

    const/high16 v1, -0x40800000    # -1.0f

    iput v1, p0, mAppearAnimationFraction:F

    iput v1, p0, mDimmedBackgroundFadeInAmount:F
    ...
    iput-object v1, p0, mBackgroundVisibilityUpdater:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    iput-object v1, p0, mTapTimeoutRunnable:Ljava/lang/Runnable;
    ...
    iput-object v1, p0, mSlowOutFastInInterpolator:Landroid/view/animation/Interpolator;

    new-instance v1, Landroid/view/animation/PathInterpolator;

    invoke-direct {v1, v3, v2, v0, v0}, Landroid/view/animation/PathInterpolator;-><init>(FFFF)V

    iput-object v1, p0, mSlowOutLinearInInterpolator:Landroid/view/animation/Interpolator;
    ...
    invoke-direct {p0}, updateColors()V
    ...
    iput-object p1, p0, mFalsingManager:Lcom/android/systemui/plugins/FalsingManager;
    ...
    iget-object p2, p0, mFalsingManager:Lcom/android/systemui/plugins/FalsingManager;
    ...
    iput-object p1, p0, mDoubleTapHelper:Lcom/android/systemui/statusbar/phone/DoubleTapHelper;
...
.method static synthetic access$002(Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;F)F
    ...
    iput p1, p0, mDimmedBackgroundFadeInAmount:F
...
.method static synthetic access$100(Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;)Lcom/android/systemui/statusbar/notification/row/NotificationBackgroundView;
    ...
    iget-object p0, p0, mBackgroundDimmed:Lcom/android/systemui/statusbar/notification/row/NotificationBackgroundView;
...
.method static synthetic access$402(Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;Landroid/animation/ValueAnimator;)Landroid/animation/ValueAnimator;
    ...
    iput-object p1, p0, mBackgroundColorAnimator:Landroid/animation/ValueAnimator;
...
.method static synthetic access$502(Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;Landroid/animation/ObjectAnimator;)Landroid/animation/ObjectAnimator;
    ...
    iput-object p1, p0, mBackgroundAnimator:Landroid/animation/ObjectAnimator;
...
.method static synthetic access$602(Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;F)F
    ...
    iput p1, p0, mAppearAnimationFraction:F
...
.method static synthetic access$700(Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;)V
    ...
    invoke-direct {p0}, updateAppearAnimationAlpha()V
...
.method static synthetic access$800(Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;)V
    ...
    invoke-direct {p0}, updateAppearRect()V
...
.method static synthetic access$900(Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;Z)V
    ...
    invoke-direct {p0, p1}, enableAppearDrawing(Z)V
...
.method private calculateBgColor(ZZ)I
    ...
    iget p2, p0, mOverrideTint:I

    if-eqz p2, :cond_0

    const/4 p2, 0x0

    invoke-direct {p0, p1, p2}, calculateBgColor(ZZ)I

    move-result p1

    iget p2, p0, mOverrideTint:I

    iget p0, p0, mOverrideAmount:F
...
.method private cancelAppearAnimation()V
    ...
    iget-object v0, p0, mAppearAnimator:Landroid/animation/ValueAnimator;
    ...
    iput-object v0, p0, mAppearAnimator:Landroid/animation/ValueAnimator;
...
.method private cancelFadeAnimations()V
    ...
    iget-object v0, p0, mBackgroundAnimator:Landroid/animation/ObjectAnimator;
    ...
    :cond_0
    iget-object v0, p0, mBackgroundDimmed:Lcom/android/systemui/statusbar/notification/row/NotificationBackgroundView;
    ...
    iget-object p0, p0, mBackgroundNormal:Lcom/android/systemui/statusbar/notification/row/NotificationBackgroundView;
...
.method private enableAppearDrawing(Z)V
    ...
    iget-boolean v0, p0, mDrawingAppearAnimation:Z

    if-eq p1, v0, :cond_1

    iput-boolean p1, p0, mDrawingAppearAnimation:Z

    if-nez p1, :cond_0

    const/high16 p1, 0x3f800000    # 1.0f

    invoke-direct {p0, p1}, setContentAlpha(F)V
...
.method private fadeDimmedBackground()V
    ...
    iget-object v0, p0, mBackgroundNormal:Lcom/android/systemui/statusbar/notification/row/NotificationBackgroundView;
    ...
    iget-boolean v0, p0, mActivated:Z

    if-eqz v0, :cond_0

    invoke-virtual {p0}, updateBackground()V

    return-void

    :cond_0
    invoke-virtual {p0}, shouldHideBackground()Z
    ...
    iget-object v4, p0, mBackgroundAnimator:Landroid/animation/ObjectAnimator;
    ...
    iget-object v3, p0, mBackgroundAnimator:Landroid/animation/ObjectAnimator;
    ...
    :cond_5
    iget-object v4, p0, mBackgroundNormal:Lcom/android/systemui/statusbar/notification/row/NotificationBackgroundView;
    ...
    iput-object v0, p0, mBackgroundAnimator:Landroid/animation/ObjectAnimator;
    ...
    iget-object v1, p0, mBackgroundVisibilityUpdater:Landroid/animation/ValueAnimator$AnimatorUpdateListener;

    invoke-virtual {v0, v1}, Landroid/animation/ObjectAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    iget-object p0, p0, mBackgroundAnimator:Landroid/animation/ObjectAnimator;
...
.method private handleTouchEventDimmed(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v0, p0, mNeedsDimming:Z
    ...
    :cond_0
    iget-object v0, p0, mDoubleTapHelper:Lcom/android/systemui/statusbar/phone/DoubleTapHelper;
...
.method private initDimens()V
    ...
    iput v0, p0, mHeadsUpAddStartLocation:I
...
.method private makeActive()V
    ...
    invoke-direct {p0, v0}, startActivateAnimation(Z)V

    const/4 v0, 0x1

    iput-boolean v0, p0, mActivated:Z

    iget-object v0, p0, mOnActivatedListener:Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView$OnActivatedListener;
...
.method private setContentAlpha(F)V
    ...
    invoke-virtual {p0}, getContentView()Landroid/view/View;
...
.method private startActivateAnimation(Z)V
    ...
    :cond_0
    invoke-virtual {p0}, isDimmable()Z
    ...
    iget-object v1, p0, mBackgroundNormal:Lcom/android/systemui/statusbar/notification/row/NotificationBackgroundView;
    ...
    :cond_3
    sget-object v1, ACTIVATE_INVERSE_INTERPOLATOR:Landroid/view/animation/Interpolator;

    sget-object v2, ACTIVATE_INVERSE_ALPHA_INTERPOLATOR:Landroid/view/animation/Interpolator;
    ...
    iget-object v6, p0, mBackgroundNormal:Lcom/android/systemui/statusbar/notification/row/NotificationBackgroundView;
...
.method private startAppearAnimation(ZFJJLjava/lang/Runnable;Landroid/animation/AnimatorListenerAdapter;)V
    ...
    invoke-direct {p0}, cancelAppearAnimation()V
    ...
    iput p2, p0, mAnimationTranslationY:F

    iget p2, p0, mAppearAnimationFraction:F
    ...
    iget p2, p0, mAnimationTranslationY:F

    iput p2, p0, mAppearAnimationTranslation:F

    goto :goto_0

    :cond_0
    iput v0, p0, mAppearAnimationFraction:F

    iput v1, p0, mAppearAnimationTranslation:F

    :cond_1
    :goto_0
    iput-boolean p1, p0, mIsAppearing:Z

    if-eqz p1, :cond_2

    iget-object p2, p0, mSlowOutFastInInterpolator:Landroid/view/animation/Interpolator;

    iput-object p2, p0, mCurrentAppearInterpolator:Landroid/view/animation/Interpolator;

    sget-object p2, Lcom/android/systemui/Interpolators;->LINEAR_OUT_SLOW_IN:Landroid/view/animation/Interpolator;

    iput-object p2, p0, mCurrentAlphaInterpolator:Landroid/view/animation/Interpolator;
    ...
    iget-object p2, p0, mSlowOutLinearInInterpolator:Landroid/view/animation/Interpolator;
    ...
    iget v2, p0, mAppearAnimationFraction:F
    ...
    iput-object p2, p0, mAppearAnimator:Landroid/animation/ValueAnimator;

    iget-object p2, p0, mAppearAnimator:Landroid/animation/ValueAnimator;
    ...
    iget p6, p0, mAppearAnimationFraction:F
    ...
    iget-object p0, p0, mAppearAnimator:Landroid/animation/ValueAnimator;
...
.method private updateAppearAnimationAlpha()V
    ...
    iget v0, p0, mAppearAnimationFraction:F
    ...
    iget-object v1, p0, mCurrentAlphaInterpolator:Landroid/view/animation/Interpolator;

    invoke-interface {v1, v0}, Landroid/view/animation/Interpolator;->getInterpolation(F)F

    move-result v0

    invoke-direct {p0, v0}, setContentAlpha(F)V
...
.method private updateAppearRect()V
    ...
    iget-object v2, p0, mCurrentAppearInterpolator:Landroid/view/animation/Interpolator;

    invoke-interface {v2, v0}, Landroid/view/animation/Interpolator;->getInterpolation(F)F

    move-result v2

    iget v3, p0, mAnimationTranslationY:F

    mul-float/2addr v2, v3

    iput v2, p0, mAppearAnimationTranslation:F
    ...
    iget-object v5, p0, mCurrentAppearInterpolator:Landroid/view/animation/Interpolator;

    invoke-interface {v5, v4}, Landroid/view/animation/Interpolator;->getInterpolation(F)F

    move-result v4

    iget-boolean v5, p0, mIsHeadsUpAnimation:Z

    if-eqz v5, :cond_0

    iget-boolean v5, p0, mIsAppearing:Z
    ...
    iget-boolean v6, p0, mIsHeadsUpAnimation:Z

    if-eqz v6, :cond_1

    iget v6, p0, mHeadsUpLocation:F
    ...
    iget-object v6, p0, mCurrentAppearInterpolator:Landroid/view/animation/Interpolator;
    ...
    iget v7, p0, mAnimationTranslationY:F
    ...
    :goto_2
    iget-object v2, p0, mAppearAnimationRect:Landroid/graphics/RectF;

    invoke-virtual {v2, v4, v0, v5, v1}, Landroid/graphics/RectF;->set(FFFF)V

    iget v2, p0, mAppearAnimationTranslation:F
...
.method private updateBackgroundTint(Z)V
    ...
    iget-object v0, p0, mBackgroundColorAnimator:Landroid/animation/ValueAnimator;
    ...
    :cond_0
    invoke-virtual {p0}, getRippleColor()I

    move-result v0

    iget-object v1, p0, mBackgroundDimmed:Lcom/android/systemui/statusbar/notification/row/NotificationBackgroundView;
    ...
    invoke-virtual {p0}, calculateBgColor()I

    move-result v0

    if-nez p1, :cond_1

    invoke-virtual {p0, v0}, setBackgroundTintColor(I)V

    goto :goto_0

    :cond_1
    iget p1, p0, mCurrentBackgroundTint:I

    if-eq v0, p1, :cond_2

    iput p1, p0, mStartTint:I

    iput v0, p0, mTargetTint:I
    ...
    iget-object p1, p0, mBackgroundColorAnimator:Landroid/animation/ValueAnimator;
    ...
    iget-object p0, p0, mBackgroundColorAnimator:Landroid/animation/ValueAnimator;
...
.method private updateColors()V
    ...
    iput v0, p0, mTintedRippleColor:I
    ...
    iput v0, p0, mNormalRippleColor:I
...
.method private updateOutlineAlpha()V
    ...
    iget v0, p0, mNormalBackgroundVisibilityAmount:F
...
.method protected applyRoundness()V
    ...
    invoke-virtual {p0, v0, v1}, applyBackgroundRoundness(FF)V
...
.method public calculateBgColor()I
    ...
    invoke-direct {p0, v0, v0}, calculateBgColor(ZZ)I
...
.method public cancelAppearDrawing()V
    ...
    invoke-direct {p0, v0}, enableAppearDrawing(Z)V
...
.method protected dispatchDraw(Landroid/graphics/Canvas;)V
    ...
    iget v1, p0, mAppearAnimationTranslation:F
    ...
    iget-boolean p0, p0, mDrawingAppearAnimation:Z
...
.method public getCurrentBackgroundTint()I
    ...
    iget p0, p0, mCurrentBackgroundTint:I
...
.method protected getRippleColor()I
    ...
    iget v0, p0, mBgTint:I

    if-eqz v0, :cond_0

    iget p0, p0, mTintedRippleColor:I

    return p0

    :cond_0
    iget p0, p0, mNormalRippleColor:I
...
.method public isBelowSpeedBump()Z
    ...
    iget-boolean p0, p0, mIsBelowSpeedBump:Z
...
.method public isFirstInSection()Z
    ...
    iget-boolean p0, p0, mFirstInSection:Z
...
.method public isLastInSection()Z
    ...
    iget-boolean p0, p0, mLastInSection:Z
...
.method public synthetic lambda$new$0$ActivatableNotificationView(Z)V
    ...
    invoke-virtual {p0, p1}, makeInactive(Z)V
...
.method public makeInactive(Z)V
    ...
    invoke-direct {p0, p1}, startActivateAnimation(Z)V
    ...
    :cond_1
    :goto_0
    iget-object p1, p0, mOnActivatedListener:Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView$OnActivatedListener;
    ...
    :cond_2
    iget-object p1, p0, mTapTimeoutRunnable:Ljava/lang/Runnable;
...
.method protected onFinishInflate()V
    ...
    iput-object v0, p0, mBackgroundNormal:Lcom/android/systemui/statusbar/notification/row/NotificationBackgroundView;
    ...
    iput-object v0, p0, mFakeShadow:Lcom/android/systemui/statusbar/notification/FakeShadowView;

    iget-object v0, p0, mFakeShadow:Lcom/android/systemui/statusbar/notification/FakeShadowView;
    ...
    :goto_0
    iput-boolean v0, p0, mShadowHidden:Z
    ...
    iput-object v0, p0, mBackgroundDimmed:Lcom/android/systemui/statusbar/notification/row/NotificationBackgroundView;

    invoke-virtual {p0}, initBackground()V

    invoke-virtual {p0}, updateBackground()V

    invoke-virtual {p0}, updateBackgroundTint()V

    invoke-direct {p0}, updateOutlineAlpha()V
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p0, p1}, disallowSingleClick(Landroid/view/MotionEvent;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-direct {p0}, isTouchExplorationEnabled()Z
    ...
    iput-boolean v1, p0, mBlockNextTouch:Z

    invoke-virtual {p0, v1}, makeInactive(Z)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v0, p0, mBlockNextTouch:Z

    if-eqz v0, :cond_0

    const/4 p1, 0x0

    iput-boolean p1, p0, mBlockNextTouch:Z
    ...
    invoke-direct {p0, p1}, handleTouchEventDimmed(Landroid/view/MotionEvent;)Z
...
.method public performAddAnimation(JJZ)V
    ...
    iput-boolean p5, p0, mIsHeadsUpAnimation:Z

    iget v0, p0, mHeadsUpAddStartLocation:I

    int-to-float v0, v0

    iput v0, p0, mHeadsUpLocation:F
    ...
    invoke-direct/range {v1 .. v9}, startAppearAnimation(ZFJJLjava/lang/Runnable;Landroid/animation/AnimatorListenerAdapter;)V
...
.method public performRemoveAnimation(JJFZFLjava/lang/Runnable;Landroid/animation/AnimatorListenerAdapter;)J
    ...
    invoke-direct {p0, v1}, enableAppearDrawing(Z)V

    move v1, p6

    iput-boolean v1, v0, mIsHeadsUpAnimation:Z

    move/from16 v1, p7

    iput v1, v0, mHeadsUpLocation:F

    iget-boolean v1, v0, mDrawingAppearAnimation:Z
    ...
    invoke-direct/range {v0 .. v8}, startAppearAnimation(ZFJJLjava/lang/Runnable;Landroid/animation/AnimatorListenerAdapter;)V
...
.method protected resetBackgroundAlpha()V
    ...
    invoke-virtual {p0, v0}, updateBackgroundAlpha(F)V
...
.method public setActualHeight(IZ)V
    ...
    iget-object p2, p0, mBackgroundNormal:Lcom/android/systemui/statusbar/notification/row/NotificationBackgroundView;
...
.method protected setBackgroundTintColor(I)V
    ...
    iget v0, p0, mCurrentBackgroundTint:I

    if-eq p1, v0, :cond_1

    iput p1, p0, mCurrentBackgroundTint:I

    iget v0, p0, mNormalColor:I
...
.method public setBelowSpeedBump(Z)V
    ...
    iget-boolean v0, p0, mIsBelowSpeedBump:Z

    if-eq p1, v0, :cond_0

    iput-boolean p1, p0, mIsBelowSpeedBump:Z

    invoke-virtual {p0}, updateBackgroundTint()V

    invoke-virtual {p0}, onBelowSpeedBumpChanged()V
...
.method public setDark(ZZJ)V
    ...
    invoke-direct {p0, p1}, updateBackgroundTint(Z)V
...
.method public setDimmed(ZZ)V
    ...
    iput-boolean p1, p0, mNeedsDimming:Z
    ...
    iput-boolean p1, p0, mDimmed:Z

    invoke-virtual {p0}, resetBackgroundAlpha()V

    if-eqz p2, :cond_0

    invoke-direct {p0}, fadeDimmedBackground()V
...
.method public setFakeShadowIntensity(FFII)V
    ...
    iget-boolean v0, p0, mShadowHidden:Z
    ...
    :goto_0
    iput-boolean v1, p0, mShadowHidden:Z

    iget-boolean v1, p0, mShadowHidden:Z
...
.method public setFirstInSection(Z)V
    ...
    iget-boolean v0, p0, mFirstInSection:Z

    if-eq p1, v0, :cond_0

    iput-boolean p1, p0, mFirstInSection:Z
...
.method public setLastInSection(Z)V
    ...
    iget-boolean v0, p0, mLastInSection:Z

    if-eq p1, v0, :cond_0

    iput-boolean p1, p0, mLastInSection:Z
...
.method public setNormalBackgroundVisibilityAmount(F)V
    ...
    iput p1, p0, mNormalBackgroundVisibilityAmount:F
...
.method public setOnActivatedListener(Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView$OnActivatedListener;)V
    ...
    iput-object p1, p0, mOnActivatedListener:Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView$OnActivatedListener;
...
.method public setOverrideTintColor(IF)V
    ...
    :cond_0
    iput p1, p0, mOverrideTint:I

    iput p2, p0, mOverrideAmount:F

    invoke-virtual {p0}, calculateBgColor()I

    move-result p1

    invoke-virtual {p0, p1}, setBackgroundTintColor(I)V
    ...
    iget-boolean p1, p0, mNeedsDimming:Z

    if-eqz p1, :cond_1

    iget-object p1, p0, mBackgroundNormal:Lcom/android/systemui/statusbar/notification/row/NotificationBackgroundView;

    const/high16 v0, 0x437f0000    # 255.0f

    iget p0, p0, mDimmedAlpha:I
...
.method public setTintColor(I)V
    ...
    invoke-virtual {p0, p1, v0}, setTintColor(IZ)V
...
.method public setTintColor(IZ)V
    ...
    iput p1, p0, mBgTint:I

    invoke-direct {p0, p2}, updateBackgroundTint(Z)V
...
.method protected updateBackground()V
    ...
    iget-boolean v4, p0, mActivated:Z
    ...
    :goto_0
    iget-object v4, p0, mBackgroundDimmed:Lcom/android/systemui/statusbar/notification/row/NotificationBackgroundView;
    ...
    iget-boolean v5, p0, mActivated:Z
    ...
    iget-object v0, p0, mTapTimeoutRunnable:Ljava/lang/Runnable;

    invoke-virtual {p0, v0}, Landroid/widget/FrameLayout;->removeCallbacks(Ljava/lang/Runnable;)Z

    invoke-virtual {p0, v3}, makeInactive(Z)V
    ...
    :goto_3
    invoke-virtual {p0, v1}, setNormalBackgroundVisibilityAmount(F)V
...
.method protected updateBackgroundAlpha(F)V
    ...
    :goto_0
    iput p1, p0, mBgAlpha:F

    iget p1, p0, mDimmedBackgroundFadeInAmount:F
    ...
    :cond_1
    iget-object p1, p0, mBackgroundDimmed:Lcom/android/systemui/statusbar/notification/row/NotificationBackgroundView;

    iget p0, p0, mBgAlpha:F
...
.method protected updateBackgroundTint()V
    ...
    invoke-direct {p0, v0}, updateBackgroundTint(Z)V
