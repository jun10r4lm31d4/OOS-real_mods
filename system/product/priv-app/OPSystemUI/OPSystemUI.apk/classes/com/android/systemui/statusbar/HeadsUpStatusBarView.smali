...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object p1, p0, mLayoutedIconRect:Landroid/graphics/Rect;

    const/4 p1, 0x2

    new-array p1, p1, [I

    iput-object p1, p0, mTmpPosition:[I
    ...
    iput-object p1, p0, mIconDrawingRect:Landroid/graphics/Rect;
    ...
    iput p2, p0, mAbsoluteStartPadding:I
    ...
    iput p1, p0, mEndMargin:I

    iget p1, p0, mAbsoluteStartPadding:I

    iget p2, p0, mEndMargin:I

    const/4 p3, 0x0

    invoke-virtual {p0, p1, p3, p2, p3}, Landroid/widget/LinearLayout;->setPaddingRelative(IIII)V

    invoke-direct {p0}, updateMaxWidth()V
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;Landroid/widget/TextView;)V
    ...
    iput-object p2, p0, mIconPlaceholder:Landroid/view/View;

    iput-object p3, p0, mTextView:Landroid/widget/TextView;
...
.method private updateDrawingRect()V
    ...
    iget-object v0, p0, mIconDrawingRect:Landroid/graphics/Rect;

    iget v1, v0, Landroid/graphics/Rect;->left:I

    int-to-float v1, v1

    iget-object v2, p0, mLayoutedIconRect:Landroid/graphics/Rect;
    ...
    iget-object p0, p0, mOnDrawingRectChangedListener:Ljava/lang/Runnable;
...
.method private updatePosition()V
    ...
    iget-object v0, p0, mIconPlaceholder:Landroid/view/View;

    iget-object v1, p0, mTmpPosition:[I

    invoke-virtual {v0, v1}, Landroid/view/View;->getLocationOnScreen([I)V

    iget-object v0, p0, mTmpPosition:[I
    ...
    iget-object v2, p0, mTmpPosition:[I

    const/4 v3, 0x1

    aget v2, v2, v3

    iget-object v3, p0, mIconPlaceholder:Landroid/view/View;
    ...
    iget-object v4, p0, mIconPlaceholder:Landroid/view/View;
    ...
    iget-object v5, p0, mLayoutedIconRect:Landroid/graphics/Rect;

    invoke-virtual {v5, v0, v2, v3, v4}, Landroid/graphics/Rect;->set(IIII)V

    invoke-direct {p0}, updateDrawingRect()V

    iget v2, p0, mAbsoluteStartPadding:I

    iget v4, p0, mSysWinInset:I

    add-int/2addr v2, v4

    iget v4, p0, mCutOutInset:I
    ...
    iget-object v5, p0, mDisplayCutout:Landroid/view/DisplayCutout;
    ...
    iget-object v6, p0, mDisplayCutout:Landroid/view/DisplayCutout;
...
.method protected fitSystemWindows(Landroid/graphics/Rect;)Z
    ...
    iput-object v1, p0, mDisplayCutout:Landroid/view/DisplayCutout;
    ...
    :goto_1
    iput v0, p0, mCutOutInset:I

    invoke-direct {p0}, getDisplaySize()V

    const/4 v0, 0x0

    iput-object v0, p0, mCutOutBounds:Ljava/util/List;
    ...
    :cond_3
    iget v0, p0, mSysWinInset:I

    if-eqz v0, :cond_4

    iput v2, p0, mCutOutInset:I
...
.method public getIconDrawingRect()Landroid/graphics/Rect;
    ...
    iget-object p0, p0, mIconDrawingRect:Landroid/graphics/Rect;
...
.method public getShowingEntry()Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;
    ...
    iget-object p0, p0, mShowingEntry:Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;
...
.method protected onFinishInflate()V
    ...
    iput-object v0, p0, mIconPlaceholder:Landroid/view/View;
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    iput-boolean v0, p0, mPublicMode:Z
...
.method public onSaveInstanceState()Landroid/os/Bundle;
    ...
    iget-boolean v1, p0, mPublicMode:Z
...
.method public bridge synthetic onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-virtual {p0}, onSaveInstanceState()Landroid/os/Bundle;
...
.method public setEntry(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V
    ...
    iput-object p1, p0, mShowingEntry:Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;
...
.method public setOnDrawingRectChangedListener(Ljava/lang/Runnable;)V
    ...
    iput-object p1, p0, mOnDrawingRectChangedListener:Ljava/lang/Runnable;
...
.method public setPublicMode(Z)V
    ...
    iput-boolean p1, p0, mPublicMode:Z
