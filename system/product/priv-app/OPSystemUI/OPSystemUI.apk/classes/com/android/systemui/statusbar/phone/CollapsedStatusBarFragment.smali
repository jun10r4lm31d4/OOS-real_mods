...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mSignalCallback:Lcom/android/systemui/statusbar/policy/NetworkController$SignalCallback;
...
.method private animateHide(Landroid/view/View;Z)V
    ...
    invoke-direct {p0, p1, v0, p2}, animateHiddenState(Landroid/view/View;IZ)V
...
.method private clockHiddenMode()I
    ...
    iget-object v0, p0, mStatusBar:Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;
...
.method private initEmergencyCryptkeeperText()V
    ...
    iget-object v1, p0, mNetworkController:Lcom/android/systemui/statusbar/policy/NetworkController;
    ...
    :cond_0
    iget-object v0, p0, mNetworkController:Lcom/android/systemui/statusbar/policy/NetworkController;

    iget-object p0, p0, mSignalCallback:Lcom/android/systemui/statusbar/policy/NetworkController$SignalCallback;
...
.method private initOperatorName()V
    ...
    iput-object v0, p0, mOperatorNameFrame:Landroid/view/View;
...
.method private shouldHideNotificationIcons()Z
    ...
    iget-object v0, p0, mStatusBarComponent:Lcom/android/systemui/statusbar/phone/StatusBar;
    ...
    :cond_1
    iget-object p0, p0, mStatusBarComponent:Lcom/android/systemui/statusbar/phone/StatusBar;
...
.method protected adjustDisableFlags(I)I
    ...
    invoke-direct {p0}, shouldHideNotificationIcons()Z
...
.method public disable(IIIZ)V
    ...
    invoke-virtual {p0, p2}, adjustDisableFlags(I)I

    move-result p1

    iget p2, p0, mDisabled1:I

    xor-int/2addr p2, p1

    iput p1, p0, mDisabled1:I
    ...
    invoke-virtual {p0, p4}, hideSystemIconArea(Z)V

    invoke-virtual {p0, p4}, hideOperatorName(Z)V

    goto :goto_0

    :cond_1
    invoke-virtual {p0, p4}, showSystemIconArea(Z)V

    invoke-virtual {p0, p4}, showOperatorName(Z)V
    ...
    invoke-virtual {p0, p4}, hideNotificationIconArea(Z)V

    goto :goto_1

    :cond_3
    invoke-virtual {p0, p4}, showNotificationIconArea(Z)V
    ...
    iget-object p2, p0, mClockView:Landroid/view/View;

    invoke-virtual {p2}, Landroid/view/View;->getVisibility()I

    move-result p2

    invoke-direct {p0}, clockHiddenMode()I
    ...
    invoke-virtual {p0, p4}, hideClock(Z)V

    goto :goto_2

    :cond_6
    invoke-virtual {p0, p4}, showClock(Z)V
...
.method public hideClock(Z)V
    ...
    iget-object v0, p0, mClockView:Landroid/view/View;

    invoke-direct {p0}, clockHiddenMode()I

    move-result v1

    invoke-direct {p0, v0, v1, p1}, animateHiddenState(Landroid/view/View;IZ)V
...
.method public hideNotificationIconArea(Z)V
    ...
    iget-object v0, p0, mNotificationIconAreaInner:Landroid/view/View;

    invoke-direct {p0, v0, p1}, animateHide(Landroid/view/View;Z)V

    iget-object v0, p0, mCenteredIconArea:Landroid/view/View;
...
.method public hideOperatorName(Z)V
    ...
    iget-object v0, p0, mOperatorNameFrame:Landroid/view/View;
...
.method public hideSystemIconArea(Z)V
    ...
    iget-object v0, p0, mSystemIconArea:Landroid/widget/LinearLayout;
...
.method public initNotificationIconArea(Lcom/android/systemui/statusbar/phone/NotificationIconAreaController;)V
    ...
    iput-object v1, p0, mNotificationIconAreaInner:Landroid/view/View;

    iget-object v1, p0, mNotificationIconAreaInner:Landroid/view/View;
    ...
    iget-object v2, p0, mNotificationIconAreaInner:Landroid/view/View;
    ...
    iget-object v1, p0, mCenteredIconArea:Landroid/view/View;
    ...
    invoke-virtual {p0, p1}, showNotificationIconArea(Z)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object p1, p0, mKeyguardMonitor:Lcom/android/systemui/statusbar/policy/KeyguardMonitor;
    ...
    iput-object p1, p0, mStatusBarComponent:Lcom/android/systemui/statusbar/phone/StatusBar;
...
.method public onDestroyView()V
    ...
    iget-object v1, p0, mDarkIconManager:Lcom/android/systemui/statusbar/phone/StatusBarIconController$DarkIconManager;
...
.method public onDozingChanged(Z)V
    ...
    invoke-virtual {p0, p1, v0, v0, v1}, disable(IIIZ)V
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget-object p0, p0, mStatusBar:Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, mStatusBar:Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;
    ...
    iget-object v1, p0, mStatusBar:Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;
    ...
    iput-object p2, p0, mDarkIconManager:Lcom/android/systemui/statusbar/phone/StatusBarIconController$DarkIconManager;

    iget-object p2, p0, mDarkIconManager:Lcom/android/systemui/statusbar/phone/StatusBarIconController$DarkIconManager;
    ...
    iget-object v0, p0, mDarkIconManager:Lcom/android/systemui/statusbar/phone/StatusBarIconController$DarkIconManager;
    ...
    iget-object p2, p0, mStatusBar:Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;
    ...
    iput-object p2, p0, mSystemIconArea:Landroid/widget/LinearLayout;

    iget-object p2, p0, mSystemIconArea:Landroid/widget/LinearLayout;
    ...
    iput-object p2, p0, mClockView:Landroid/view/View;

    const/4 p2, 0x0

    invoke-virtual {p0, p2}, showSystemIconArea(Z)V

    invoke-virtual {p0, p2}, showClock(Z)V

    invoke-direct {p0}, initEmergencyCryptkeeperText()V

    invoke-direct {p0}, initOperatorName()V
...
.method public showClock(Z)V
    ...
    invoke-direct {p0, v0, p1}, animateShow(Landroid/view/View;Z)V
