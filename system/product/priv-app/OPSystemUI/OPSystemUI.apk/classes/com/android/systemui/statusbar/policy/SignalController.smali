...
.method public constructor <init>(Ljava/lang/String;Landroid/content/Context;ILcom/android/systemui/statusbar/policy/CallbackHandler;Lcom/android/systemui/statusbar/policy/NetworkControllerImpl;)V
    ...
    iput-object p5, p0, mNetworkController:Lcom/android/systemui/statusbar/policy/NetworkControllerImpl;

    iput p3, p0, mTransportType:I

    iput-object p2, p0, mContext:Landroid/content/Context;

    iput-object p4, p0, mCallbackHandler:Lcom/android/systemui/statusbar/policy/CallbackHandler;

    invoke-virtual {p0}, cleanState()Lcom/android/systemui/statusbar/policy/SignalController$State;

    move-result-object p1

    iput-object p1, p0, mCurrentState:Lcom/android/systemui/statusbar/policy/SignalController$State;

    invoke-virtual {p0}, cleanState()Lcom/android/systemui/statusbar/policy/SignalController$State;

    move-result-object p1

    iput-object p1, p0, mLastState:Lcom/android/systemui/statusbar/policy/SignalController$State;

    const/16 p1, 0x40

    new-array p2, p1, [Lcom/android/systemui/statusbar/policy/SignalController$State;

    iput-object p2, p0, mHistory:[Lcom/android/systemui/statusbar/policy/SignalController$State;
    ...
    iget-object p3, p0, mHistory:[Lcom/android/systemui/statusbar/policy/SignalController$State;
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    iget-object v1, p0, mCurrentState:Lcom/android/systemui/statusbar/policy/SignalController$State;
    ...
    iget-object v2, p0, mHistory:[Lcom/android/systemui/statusbar/policy/SignalController$State;
    ...
    iget-object v4, p0, mHistory:[Lcom/android/systemui/statusbar/policy/SignalController$State;
...
.method public getContentDescription()I
    ...
    iget-object v0, p0, mCurrentState:Lcom/android/systemui/statusbar/policy/SignalController$State;

    iget-boolean v0, v0, Lcom/android/systemui/statusbar/policy/SignalController$State;->connected:Z

    if-eqz v0, :cond_0

    invoke-virtual {p0}, getIcons()Lcom/android/systemui/statusbar/policy/SignalController$IconGroup;

    move-result-object v0

    iget-object v0, v0, Lcom/android/systemui/statusbar/policy/SignalController$IconGroup;->mContentDesc:[I

    iget-object p0, p0, mCurrentState:Lcom/android/systemui/statusbar/policy/SignalController$State;
...
.method public isDirty()Z
    ...
    iget-object v0, p0, mLastState:Lcom/android/systemui/statusbar/policy/SignalController$State;
    ...
    iget-object v2, p0, mLastState:Lcom/android/systemui/statusbar/policy/SignalController$State;
...
.method public final notifyListeners()V
    ...
    invoke-virtual {p0, v0}, notifyListeners(Lcom/android/systemui/statusbar/policy/NetworkController$SignalCallback;)V
...
.method public notifyListenersIfNecessary()V
    ...
    invoke-virtual {p0, v0}, notifyListenersIfNecessary(Z)V
...
.method public notifyListenersIfNecessary(Z)V
    ...
    :cond_0
    iget-object p1, p0, mCurrentState:Lcom/android/systemui/statusbar/policy/SignalController$State;

    iget-wide v0, p1, Lcom/android/systemui/statusbar/policy/SignalController$State;->time:J

    iget-object p1, p0, mLastState:Lcom/android/systemui/statusbar/policy/SignalController$State;
    ...
    invoke-virtual {p0}, saveLastState()V
    ...
    invoke-virtual {p0}, notifyListeners()V
...
.method protected recordLastState()V
    ...
    iget-object v0, p0, mHistory:[Lcom/android/systemui/statusbar/policy/SignalController$State;

    iget v1, p0, mHistoryIndex:I

    add-int/lit8 v2, v1, 0x1

    iput v2, p0, mHistoryIndex:I

    and-int/lit8 v1, v1, 0x3f

    aget-object v0, v0, v1

    iget-object p0, p0, mLastState:Lcom/android/systemui/statusbar/policy/SignalController$State;
...
.method public saveLastState()V
    ...
    invoke-virtual {p0}, recordLastState()V
...
.method public updateConnectivity(Ljava/util/BitSet;Ljava/util/BitSet;)V
    ...
    invoke-virtual {p0}, notifyListenersIfNecessary()V
