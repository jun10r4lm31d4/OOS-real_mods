...
.method static constructor <clinit>()V
    ...
    sput-object v0, BUBBLES_BY_SORT_KEY_DESCENDING:Ljava/util/Comparator;
    ...
    sput-object v0, GROUPS_BY_MAX_SORT_KEY_DESCENDING:Ljava/util/Comparator;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mTimeSource:Lcom/android/systemui/bubbles/BubbleData$TimeSource;
    ...
    iput-object p1, p0, mBubbles:Ljava/util/List;

    new-instance p1, Lcom/android/systemui/bubbles/BubbleData$Update;

    iget-object v0, p0, mBubbles:Ljava/util/List;
    ...
    iput-object p1, p0, mStateChange:Lcom/android/systemui/bubbles/BubbleData$Update;
...
.method private dispatchPendingChanges()V
    ...
    iget-object v0, p0, mListener:Lcom/android/systemui/bubbles/BubbleData$Listener;

    if-eqz v0, :cond_0

    iget-object v0, p0, mStateChange:Lcom/android/systemui/bubbles/BubbleData$Update;
    ...
    iget-object v1, p0, mStateChange:Lcom/android/systemui/bubbles/BubbleData$Update;
    ...
    iget-object v1, p0, mBubbles:Ljava/util/List;
    ...
    iput-object v0, p0, mStateChange:Lcom/android/systemui/bubbles/BubbleData$Update;
...
.method private doAdd(Lcom/android/systemui/bubbles/Bubble;)V
    ...
    invoke-direct {p0, v0}, hasBubbleWithGroupId(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v0}, findFirstIndexForGroup(Ljava/lang/String;)I
    ...
    :goto_1
    invoke-direct {p0, v0, p1}, insertBubble(ILcom/android/systemui/bubbles/Bubble;)I

    move-result v0

    iget-object v2, p0, mBubbles:Ljava/util/List;
    ...
    invoke-direct {p0, p1}, findFirstIndexForGroup(Ljava/lang/String;)I

    move-result p1

    invoke-direct {p0, p1}, packGroup(I)Z
    ...
    iget-object p1, p0, mBubbles:Ljava/util/List;
    ...
    invoke-direct {p0, p1}, setSelectedBubbleInternal(Lcom/android/systemui/bubbles/Bubble;)V
...
.method private doRemove(Ljava/lang/String;I)V
    ...
    invoke-direct {p0, p1}, indexForKey(Ljava/lang/String;)I
    ...
    invoke-direct {p0, v1}, setExpandedInternal(Z)V

    const/4 v1, 0x0

    invoke-direct {p0, v1}, setSelectedBubbleInternal(Lcom/android/systemui/bubbles/Bubble;)V
    ...
    :cond_3
    iget-object v1, p0, mSelectedBubble:Lcom/android/systemui/bubbles/Bubble;
    ...
    invoke-direct {p0, p2, p1}, maybeSendDeleteIntent(ILcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V
...
.method private doUpdate(Lcom/android/systemui/bubbles/Bubble;)V
    ...
    invoke-direct {p0, v1, p1}, insertBubble(ILcom/android/systemui/bubbles/Bubble;)I
    ...
    iget-object p1, p0, mStateChange:Lcom/android/systemui/bubbles/BubbleData$Update;
...
.method private hasBubbleWithGroupId(Ljava/lang/String;)Z
    ...
    iget-object p0, p0, mBubbles:Ljava/util/List;
...
.method private insertBubble(ILcom/android/systemui/bubbles/Bubble;)I
    ...
    invoke-static {p2}, sortKey(Lcom/android/systemui/bubbles/Bubble;)J
    ...
    :goto_0
    iget-object v3, p0, mBubbles:Ljava/util/List;
    ...
    invoke-static {v3}, sortKey(Lcom/android/systemui/bubbles/Bubble;)J
...
.method public static synthetic lambda$vPZCImnk7rTPTX1c7nr0PX7FO2o(Lcom/android/systemui/bubbles/Bubble;)J
    ...
    invoke-static {p0}, sortKey(Lcom/android/systemui/bubbles/Bubble;)J
...
.method private packGroup(I)Z
    ...
    iget-object v5, p0, mBubbles:Ljava/util/List;
...
.method private repackAll()Z
    ...
    sget-object v2, GROUPS_BY_MAX_SORT_KEY_DESCENDING:Ljava/util/Comparator;
    ...
    iget-object v4, p0, mBubbles:Ljava/util/List;
    ...
    sget-object v4, BUBBLES_BY_SORT_KEY_DESCENDING:Ljava/util/Comparator;
...
.method private setExpandedInternal(Z)V
    ...
    :cond_1
    iget-object v0, p0, mSelectedBubble:Lcom/android/systemui/bubbles/Bubble;
    ...
    :cond_2
    iget-object v1, p0, mTimeSource:Lcom/android/systemui/bubbles/BubbleData$TimeSource;
    ...
    invoke-direct {p0, v0}, setSelectedBubbleInternal(Lcom/android/systemui/bubbles/Bubble;)V
    ...
    iget-object v2, p0, mSelectedBubble:Lcom/android/systemui/bubbles/Bubble;
    ...
    invoke-direct {p0, v1}, packGroup(I)Z

    :cond_5
    :goto_0
    iput-boolean p1, p0, mExpanded:Z

    iget-object p0, p0, mStateChange:Lcom/android/systemui/bubbles/BubbleData$Update;
...
.method private setSelectedBubbleInternal(Lcom/android/systemui/bubbles/Bubble;)V
    ...
    iget-object v0, p0, mTimeSource:Lcom/android/systemui/bubbles/BubbleData$TimeSource;
    ...
    :cond_2
    iput-object p1, p0, mSelectedBubble:Lcom/android/systemui/bubbles/Bubble;
...
.method public dismissAll(I)V
    ...
    invoke-direct {p0, v0}, setExpandedInternal(Z)V
    ...
    invoke-direct {p0, p1, v2}, maybeSendDeleteIntent(ILcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V

    iget-object v2, p0, mStateChange:Lcom/android/systemui/bubbles/BubbleData$Update;
    ...
    :cond_1
    invoke-direct {p0}, dispatchPendingChanges()V
...
.method public hasBubbleWithKey(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1}, getBubbleWithKey(Ljava/lang/String;)Lcom/android/systemui/bubbles/Bubble;
...
.method public synthetic lambda$trim$0$BubbleData(Lcom/android/systemui/bubbles/Bubble;)Z
    ...
    iget-object p0, p0, mSelectedBubble:Lcom/android/systemui/bubbles/Bubble;
...
.method public synthetic lambda$trim$1$BubbleData(Lcom/android/systemui/bubbles/Bubble;)V
    ...
    invoke-direct {p0, p1, v0}, doRemove(Ljava/lang/String;I)V
...
.method public notificationEntryRemoved(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;I)V
    ...
    invoke-direct {p0, p1, p2}, doRemove(Ljava/lang/String;I)V
...
.method public notificationEntryUpdated(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V
    ...
    invoke-virtual {p0, v0}, getBubbleWithKey(Ljava/lang/String;)Lcom/android/systemui/bubbles/Bubble;
    ...
    invoke-direct {p0, v0}, doAdd(Lcom/android/systemui/bubbles/Bubble;)V

    invoke-direct {p0}, trim()V
    ...
    invoke-direct {p0, v0}, doUpdate(Lcom/android/systemui/bubbles/Bubble;)V

    :goto_0
    invoke-virtual {p0, p1}, shouldAutoExpand(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)Z
    ...
    invoke-direct {p0, p1}, setExpandedInternal(Z)V

    goto :goto_1

    :cond_1
    iget-object p1, p0, mSelectedBubble:Lcom/android/systemui/bubbles/Bubble;
...
.method public notificationRankingUpdated(Landroid/service/notification/NotificationListenerService$RankingMap;)V
    ...
    invoke-virtual {p0, v2}, hasBubbleWithKey(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v2, v3}, doRemove(Ljava/lang/String;I)V
...
.method public setListener(Lcom/android/systemui/bubbles/BubbleData$Listener;)V
    ...
    iput-object p1, p0, mListener:Lcom/android/systemui/bubbles/BubbleData$Listener;
...
.method setTimeSource(Lcom/android/systemui/bubbles/BubbleData$TimeSource;)V
    ...
    iput-object p1, p0, mTimeSource:Lcom/android/systemui/bubbles/BubbleData$TimeSource;
