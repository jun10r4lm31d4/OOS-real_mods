...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput p1, p0, mMaxCountdownTimes:I
    ...
    iput-object p1, p0, mPanelCallback:Lcom/oneplus/keyguard/OpEmergencyPanel$PanelCallback;
    ...
    iput-object p1, p0, mUpdateCallback:Lcom/android/keyguard/KeyguardUpdateMonitorCallback;
...
.method static synthetic access$600(Lcom/android/keyguard/KeyguardAbsKeyInputView;)Ljava/lang/String;
    ...
    invoke-direct {p0}, getSecurityModeLabel()Ljava/lang/String;
...
.method static synthetic access$700(Lcom/android/keyguard/KeyguardAbsKeyInputView;IZIZ)V
    ...
    invoke-direct {p0, p1, p2, p3, p4}, onPasswordChecked(IZIZ)V
...
.method private onPasswordChecked(IZIZ)V
    ...
    iget-object p3, p0, mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;

    invoke-virtual {p3}, Lcom/android/internal/widget/LockPatternUtils;->sanitizePassword()V

    iget-object p3, p0, mCallback:Lcom/android/keyguard/KeyguardSecurityCallback;

    invoke-interface {p3, p1, v2, v1}, Lcom/android/keyguard/KeyguardSecurityCallback;->reportUnlockAttempt(IZI)V

    if-eqz v0, :cond_5

    iput-boolean v2, p0, mDismissing:Z
    ...
    iget-object p4, p0, mCallback:Lcom/android/keyguard/KeyguardSecurityCallback;

    invoke-interface {p4, p1, v1, p3}, Lcom/android/keyguard/KeyguardSecurityCallback;->reportUnlockAttempt(IZI)V

    iget p4, p0, mMaxCountdownTimes:I

    if-gtz p4, :cond_2

    if-lez p3, :cond_2

    iget-object p4, p0, mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;

    invoke-virtual {p4, p1, p3}, Lcom/android/internal/widget/LockPatternUtils;->setLockoutAttemptDeadline(II)J

    move-result-wide v0

    invoke-virtual {p0, v0, v1}, handleAttemptLockout(J)V

    :cond_2
    if-nez p3, :cond_3

    iget-object p1, p0, mSecurityMessageDisplay:Lcom/android/keyguard/SecurityMessageDisplay;

    if-eqz p1, :cond_3

    invoke-virtual {p0}, getWrongPasswordStringId()I
    ...
    invoke-virtual {p0, v2, p1}, resetPasswordText(ZZ)V
...
.method private showEmergencyPanel(ZZ)V
    ...
    :cond_1
    iget-boolean v0, p0, mEmergencyPanelShow:Z
...
.method protected handleAttemptLockout(J)V
    ...
    invoke-virtual {p0, v0}, setPasswordEntryEnabled(Z)V
    ...
    iget-object v2, p0, mCallback:Lcom/android/keyguard/KeyguardSecurityCallback;
...
.method protected onAttachedToWindow()V
    ...
    iput-object v0, p0, mSecurityMessageDisplay:Lcom/android/keyguard/SecurityMessageDisplay;
    ...
    iget-object p0, p0, mUpdateCallback:Lcom/android/keyguard/KeyguardUpdateMonitorCallback;
...
.method protected onFinishInflate()V
    ...
    iput v1, p0, mMaxCountdownTimes:I
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    :cond_2
    invoke-virtual {p0}, onUserInput()V
...
.method public onPause()V
    ...
    iget-object v1, p0, mCountdownTimer:Landroid/os/CountDownTimer;
    ...
    iput-object v2, p0, mCountdownTimer:Landroid/os/CountDownTimer;

    :cond_0
    iget-object v1, p0, mPendingLockCheck:Landroid/os/AsyncTask;

    if-eqz v1, :cond_1

    invoke-virtual {v1, v0}, Landroid/os/AsyncTask;->cancel(Z)Z

    iput-object v2, p0, mPendingLockCheck:Landroid/os/AsyncTask;
    ...
    invoke-direct {p0, v0, v1}, showEmergencyPanel(ZZ)V
...
.method public onResume(I)V
    ...
    iput-boolean p1, p0, mResumed:Z

    const/4 v0, 0x0

    invoke-direct {p0, v0, p1}, showEmergencyPanel(ZZ)V
...
.method protected onUserInput()V
    ...
    :cond_0
    iget-object p0, p0, mSecurityMessageDisplay:Lcom/android/keyguard/SecurityMessageDisplay;
...
.method public reset()V
    ...
    invoke-virtual {p0, v0, v0}, resetPasswordText(ZZ)V
    ...
    invoke-virtual {p0, v1, v2}, shouldLockout(J)Z

    move-result v3

    if-eqz v3, :cond_0

    invoke-virtual {p0, v1, v2}, handleAttemptLockout(J)V
...
.method public showMessage(Ljava/lang/CharSequence;Landroid/content/res/ColorStateList;)V
    ...
    iget-object v0, p0, mSecurityMessageDisplay:Lcom/android/keyguard/SecurityMessageDisplay;
...
.method public showPromptReason(I)V
    ...
    invoke-virtual {p0, p1}, getPromptReasonStringRes(I)I
...
.method protected verifyPasswordAndUnlock()V
    ...
    :cond_0
    invoke-virtual {p0}, getPasswordText()[B

    move-result-object v0

    const/4 v1, 0x0

    invoke-virtual {p0, v1}, setPasswordEntryInputEnabled(Z)V

    iget-object v2, p0, mPendingLockCheck:Landroid/os/AsyncTask;
    ...
    invoke-virtual {p0, v3}, setPasswordEntryInputEnabled(Z)V

    invoke-direct {p0, v2, v1, v1, v1}, onPasswordChecked(IZIZ)V
    ...
    iput-object v0, p0, mPendingLockCheck:Landroid/os/AsyncTask;
