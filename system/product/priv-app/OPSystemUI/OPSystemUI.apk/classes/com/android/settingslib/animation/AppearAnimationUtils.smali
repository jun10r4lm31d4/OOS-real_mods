...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct/range {v1 .. v7}, <init>(Landroid/content/Context;JFFLandroid/view/animation/Interpolator;)V
...
.method public constructor <init>(Landroid/content/Context;JFFLandroid/view/animation/Interpolator;)V
    ...
    iput-object v0, p0, mProperties:Lcom/android/settingslib/animation/AppearAnimationUtils$AppearAnimationProperties;
    ...
    iput p1, p0, mStartTranslation:F

    iput p5, p0, mDelayScale:F
...
.method private getDelays([Ljava/lang/Object;)Lcom/android/settingslib/animation/AppearAnimationUtils$AppearAnimationProperties;
    ...
    iget-object v0, p0, mProperties:Lcom/android/settingslib/animation/AppearAnimationUtils$AppearAnimationProperties;
    ...
    iget-object v4, p0, mProperties:Lcom/android/settingslib/animation/AppearAnimationUtils$AppearAnimationProperties;
    ...
    invoke-virtual {p0, v1, v0}, calculateDelay(II)J

    move-result-wide v4

    iget-object v6, p0, mProperties:Lcom/android/settingslib/animation/AppearAnimationUtils$AppearAnimationProperties;
    ...
    :cond_1
    iget-object p0, p0, mProperties:Lcom/android/settingslib/animation/AppearAnimationUtils$AppearAnimationProperties;
...
.method private getDelays([[Ljava/lang/Object;)Lcom/android/settingslib/animation/AppearAnimationUtils$AppearAnimationProperties;
    ...
    iget-object v5, p0, mProperties:Lcom/android/settingslib/animation/AppearAnimationUtils$AppearAnimationProperties;
    ...
    invoke-virtual {p0, v1, v2}, calculateDelay(II)J

    move-result-wide v7

    iget-object v3, p0, mProperties:Lcom/android/settingslib/animation/AppearAnimationUtils$AppearAnimationProperties;
...
.method private startAnimations(Lcom/android/settingslib/animation/AppearAnimationUtils$AppearAnimationProperties;[Ljava/lang/Object;Ljava/lang/Runnable;Lcom/android/settingslib/animation/AppearAnimationCreator;)V
    ...
    :goto_1
    iget-object v4, v0, mRowTranslationScaler:Lcom/android/settingslib/animation/AppearAnimationUtils$RowTranslationScaler;
    ...
    :goto_2
    iget v5, v0, mStartTranslation:F

    mul-float/2addr v4, v5

    aget-object v6, p2, v3

    iget-wide v9, v0, mDuration:J

    iget-boolean v5, v0, mAppearing:Z
    ...
    iget-boolean v12, v0, mAppearing:Z

    iget-object v13, v0, mInterpolator:Landroid/view/animation/Interpolator;
...
.method private startAnimations(Lcom/android/settingslib/animation/AppearAnimationUtils$AppearAnimationProperties;[[Ljava/lang/Object;Ljava/lang/Runnable;Lcom/android/settingslib/animation/AppearAnimationCreator;)V
    ...
    iget-object v6, v0, mRowTranslationScaler:Lcom/android/settingslib/animation/AppearAnimationUtils$RowTranslationScaler;
    ...
    :goto_1
    iget v6, v0, mStartTranslation:F
    ...
    iget-wide v12, v0, mDuration:J

    iget-boolean v7, v0, mAppearing:Z
    ...
    :goto_4
    iget-boolean v15, v0, mAppearing:Z

    iget-object v7, v0, mInterpolator:Landroid/view/animation/Interpolator;
...
.method public createAnimation(Landroid/view/View;JJFZLandroid/view/animation/Interpolator;Ljava/lang/Runnable;)V
    ...
    invoke-static/range {v0 .. v6}, startTranslationYAnimation(Landroid/view/View;JJFLandroid/view/animation/Interpolator;)V
...
.method public bridge synthetic createAnimation(Ljava/lang/Object;JJFZLandroid/view/animation/Interpolator;Ljava/lang/Runnable;)V
    ...
    invoke-virtual/range {p0 .. p9}, createAnimation(Landroid/view/View;JJFZLandroid/view/animation/Interpolator;Ljava/lang/Runnable;)V
...
.method public getStartTranslation()F
    ...
    iget p0, p0, mStartTranslation:F
...
.method public startAnimation([Landroid/view/View;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p0, p1, p2, p0}, startAnimation([Ljava/lang/Object;Ljava/lang/Runnable;Lcom/android/settingslib/animation/AppearAnimationCreator;)V
...
.method public startAnimation([Ljava/lang/Object;Ljava/lang/Runnable;Lcom/android/settingslib/animation/AppearAnimationCreator;)V
    ...
    invoke-direct {p0, p1}, getDelays([Ljava/lang/Object;)Lcom/android/settingslib/animation/AppearAnimationUtils$AppearAnimationProperties;

    move-result-object v0

    invoke-direct {p0, v0, p1, p2, p3}, startAnimations(Lcom/android/settingslib/animation/AppearAnimationUtils$AppearAnimationProperties;[Ljava/lang/Object;Ljava/lang/Runnable;Lcom/android/settingslib/animation/AppearAnimationCreator;)V
...
.method public startAnimation2d([[Landroid/view/View;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p0, p1, p2, p0}, startAnimation2d([[Ljava/lang/Object;Ljava/lang/Runnable;Lcom/android/settingslib/animation/AppearAnimationCreator;)V
