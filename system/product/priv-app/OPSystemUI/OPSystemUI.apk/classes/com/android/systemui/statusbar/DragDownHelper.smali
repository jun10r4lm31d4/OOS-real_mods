...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;Lcom/android/systemui/ExpandHelper$Callback;Lcom/android/systemui/statusbar/DragDownHelper$DragDownCallback;)V
    ...
    iput-object p3, p0, mCallback:Lcom/android/systemui/ExpandHelper$Callback;

    iput-object p4, p0, mDragDownCallback:Lcom/android/systemui/statusbar/DragDownHelper$DragDownCallback;

    iput-object p2, p0, mHost:Landroid/view/View;
...
.method private captureStartingChild(FF)V
    ...
    iget v0, p0, mEmptyDragAmountCache:F
...
.method private findView(FF)Lcom/android/systemui/statusbar/notification/row/ExpandableView;
    ...
    iget-object v0, p0, mHost:Landroid/view/View;

    iget-object v1, p0, mTemp2:[I
...
.method private isFalseTouch()Z
    ...
    iget-object v0, p0, mDragDownCallback:Lcom/android/systemui/statusbar/DragDownHelper$DragDownCallback;
    ...
    iget-boolean p0, p0, mDraggedFarEnough:Z
...
.method private stopDragging()V
    ...
    invoke-direct {p0, v0}, cancelExpansion(Lcom/android/systemui/statusbar/notification/row/ExpandableView;)V

    const/4 v0, 0x0

    iput-object v0, p0, mStartingChild:Lcom/android/systemui/statusbar/notification/row/ExpandableView;
    ...
    iput-boolean v0, p0, mDraggingDown:Z
...
.method public isDraggingDown()Z
    ...
    iget-boolean p0, p0, mDraggingDown:Z
...
.method public synthetic lambda$cancelExpansion$0$DragDownHelper(Landroid/animation/ValueAnimator;)V
    ...
    iput v0, p0, mEmptyDragAmountCache:F
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iput-boolean p1, p0, mDraggingDown:Z

    iget v2, p0, mInitialTouchX:F

    iget v3, p0, mInitialTouchY:F

    invoke-direct {p0, v2, v3}, captureStartingChild(FF)V
    ...
    :cond_1
    iput-boolean v2, p0, mDraggedFarEnough:Z

    iput-boolean v2, p0, mDraggingDown:Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v0, p0, mDraggingDown:Z
    ...
    :cond_1
    invoke-direct {p0}, checkStopDragging()V
    ...
    iput v0, p0, mLastHeight:F

    iget v0, p0, mInitialTouchX:F

    invoke-direct {p0, v0, p1}, captureStartingChild(FF)V

    iget-object p1, p0, mStartingChild:Lcom/android/systemui/statusbar/notification/row/ExpandableView;

    if-eqz p1, :cond_3

    iget v0, p0, mLastHeight:F

    invoke-direct {p0, v0, p1}, handleExpansion(FLcom/android/systemui/statusbar/notification/row/ExpandableView;)V

    goto :goto_0

    :cond_3
    iget p1, p0, mLastHeight:F

    iput p1, p0, mEmptyDragAmountCache:F
    ...
    iget-boolean p1, p0, mDraggedFarEnough:Z
    ...
    iget-object p1, p0, mDragDownCallback:Lcom/android/systemui/statusbar/DragDownHelper$DragDownCallback;
    ...
    :cond_7
    iget-object v0, p0, mCallback:Lcom/android/systemui/ExpandHelper$Callback;
    ...
    :goto_2
    iput-boolean v1, p0, mDraggingDown:Z
