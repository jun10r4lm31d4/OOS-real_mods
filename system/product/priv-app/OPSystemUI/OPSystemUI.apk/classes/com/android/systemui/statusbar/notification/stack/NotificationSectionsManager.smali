...
.method constructor <init>(Lcom/android/systemui/statusbar/notification/stack/NotificationStackScrollLayout;Lcom/android/systemui/plugins/ActivityStarter;Lcom/android/systemui/plugins/statusbar/StatusBarStateController;Lcom/android/systemui/statusbar/policy/ConfigurationController;Z)V
    ...
    iput-boolean v0, p0, mGentleHeaderVisible:Z
    ...
    iput-object v0, p0, mConfigurationListener:Lcom/android/systemui/statusbar/policy/ConfigurationController$ConfigurationListener;

    iput-object p1, p0, mParent:Lcom/android/systemui/statusbar/notification/stack/NotificationStackScrollLayout;
    ...
    iput-object p4, p0, mConfigurationController:Lcom/android/systemui/statusbar/policy/ConfigurationController;

    iput-boolean p5, p0, mUseMultipleSections:Z
...
.method static synthetic access$000(Lcom/android/systemui/statusbar/notification/stack/NotificationSectionsManager;)Lcom/android/systemui/statusbar/notification/stack/SectionHeaderView;
    ...
    iget-object p0, p0, mGentleHeader:Lcom/android/systemui/statusbar/notification/stack/SectionHeaderView;
...
.method private adjustGentleHeaderVisibilityAndPosition(I)V
    ...
    :goto_0
    iget-object v3, p0, mParent:Lcom/android/systemui/statusbar/notification/stack/NotificationStackScrollLayout;

    iget-object v4, p0, mGentleHeader:Lcom/android/systemui/statusbar/notification/stack/SectionHeaderView;
    ...
    iget-boolean p1, p0, mGentleHeaderVisible:Z

    if-eqz p1, :cond_5

    iput-boolean v0, p0, mGentleHeaderVisible:Z

    iget-object p1, p0, mParent:Lcom/android/systemui/statusbar/notification/stack/NotificationStackScrollLayout;
    ...
    :cond_1
    iget-boolean v0, p0, mGentleHeaderVisible:Z

    if-nez v0, :cond_3

    iput-boolean v2, p0, mGentleHeaderVisible:Z

    iget-object v0, p0, mGentleHeader:Lcom/android/systemui/statusbar/notification/stack/SectionHeaderView;
    ...
    iget-object v1, p0, mGentleHeader:Lcom/android/systemui/statusbar/notification/stack/SectionHeaderView;
    ...
    :cond_2
    iget-object v0, p0, mParent:Lcom/android/systemui/statusbar/notification/stack/NotificationStackScrollLayout;
...
.method private getFirstLowPriorityChild()Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;
    ...
    :cond_0
    iget-object p0, p0, mFirstGentleNotif:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;
...
.method public static synthetic lambda$BXFcLGpgdZnd7PRimoedNDlJa8o(Lcom/android/systemui/statusbar/notification/stack/NotificationSectionsManager;Landroid/view/View;)V
    ...
    invoke-direct {p0, p1}, onClearGentleNotifsClick(Landroid/view/View;)V
...
.method public static synthetic lambda$Lm4LNd4tUWZPNzSmZnkDovE-xCU(Lcom/android/systemui/statusbar/notification/stack/NotificationSectionsManager;Landroid/view/View;)V
    ...
    invoke-direct {p0, p1}, onGentleHeaderClick(Landroid/view/View;)V
...
.method private onClearGentleNotifsClick(Landroid/view/View;)V
    ...
    iget-object p0, p0, mOnClearGentleNotifsClickListener:Landroid/view/View$OnClickListener;
...
.method public beginsSection(Landroid/view/View;)Z
    ...
    invoke-direct {p0}, getFirstLowPriorityChild()Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;
...
.method initialize(Landroid/view/LayoutInflater;)V
    ...
    invoke-virtual {p0, p1}, reinflateViews(Landroid/view/LayoutInflater;)V

    iget-object p1, p0, mConfigurationController:Lcom/android/systemui/statusbar/policy/ConfigurationController;

    iget-object p0, p0, mConfigurationListener:Lcom/android/systemui/statusbar/policy/ConfigurationController$ConfigurationListener;
...
.method reinflateViews(Landroid/view/LayoutInflater;)V
    ...
    iget-object v2, p0, mGentleHeader:Lcom/android/systemui/statusbar/notification/stack/SectionHeaderView;
    ...
    iget-object v2, p0, mParent:Lcom/android/systemui/statusbar/notification/stack/NotificationStackScrollLayout;

    iget-object v3, p0, mGentleHeader:Lcom/android/systemui/statusbar/notification/stack/SectionHeaderView;
    ...
    iput-object p1, p0, mGentleHeader:Lcom/android/systemui/statusbar/notification/stack/SectionHeaderView;

    iget-object p1, p0, mGentleHeader:Lcom/android/systemui/statusbar/notification/stack/SectionHeaderView;
...
.method setOnClearGentleNotifsClickListener(Landroid/view/View$OnClickListener;)V
    ...
    iput-object p1, p0, mOnClearGentleNotifsClickListener:Landroid/view/View$OnClickListener;
...
.method updateFirstAndLastViewsInSections(Lcom/android/systemui/statusbar/notification/stack/NotificationSection;Lcom/android/systemui/statusbar/notification/stack/NotificationSection;Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;)Z
    ...
    iget-boolean v0, p0, mUseMultipleSections:Z
    ...
    invoke-direct {p0}, getLastHighPriorityChild()Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;
...
.method updateSectionBoundaries()V
    ...
    iput-object v0, p0, mFirstGentleNotif:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;

    const/4 v0, -0x1

    iget-object v1, p0, mParent:Lcom/android/systemui/statusbar/notification/stack/NotificationStackScrollLayout;
    ...
    iput-object v3, p0, mFirstGentleNotif:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;
    ...
    :cond_2
    :goto_1
    invoke-direct {p0, v0}, adjustGentleHeaderVisibilityAndPosition(I)V

    iget-object v0, p0, mGentleHeader:Lcom/android/systemui/statusbar/notification/stack/SectionHeaderView;

    iget-object p0, p0, mParent:Lcom/android/systemui/statusbar/notification/stack/NotificationStackScrollLayout;
