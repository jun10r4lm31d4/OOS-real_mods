...
.method public constructor <init>(ZZLandroid/content/Context;)V
    ...
    invoke-static {p3, p1, p2}, getLayers(Landroid/content/Context;ZZ)[Landroid/graphics/drawable/Drawable;

    move-result-object p2

    invoke-direct {p0, p1, p2}, <init>(Z[Landroid/graphics/drawable/Drawable;)V
...
.method public constructor <init>(Z[Landroid/graphics/drawable/Drawable;)V
    ...
    iput-boolean p1, p0, mRoundTop:Z

    iput-object p2, p0, mLayers:[Landroid/graphics/drawable/Drawable;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    :cond_0
    iget-boolean v3, p0, mRoundTop:Z

    const/4 v4, 0x1

    if-eqz v3, :cond_1

    iget-object v3, p0, mLayers:[Landroid/graphics/drawable/Drawable;
    ...
    :goto_0
    iget-boolean v0, p0, mRoundTop:Z

    if-eqz v0, :cond_2

    iget-object v0, p0, mLayers:[Landroid/graphics/drawable/Drawable;

    aget-object v0, v0, v4

    invoke-virtual {v0, p1}, Landroid/graphics/drawable/Drawable;->draw(Landroid/graphics/Canvas;)V

    iget-object p0, p0, mLayers:[Landroid/graphics/drawable/Drawable;
...
.method public setRotatedBackground(Z)V
    ...
    iput-boolean p1, p0, mRotatedBackground:Z
