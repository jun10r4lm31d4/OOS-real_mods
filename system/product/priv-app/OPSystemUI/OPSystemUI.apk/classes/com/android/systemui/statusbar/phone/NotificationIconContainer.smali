...
.method static constructor <clinit>()V
    ...
    sput-object v0, DOT_ANIMATION_PROPERTIES:Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;
    ...
    sput-object v0, ICON_ANIMATION_PROPERTIES:Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;
    ...
    sput-object v0, sTempProperties:Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;
    ...
    sput-object v0, ADD_ICON_PROPERTIES:Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;
    ...
    sput-object v0, UNISOLATION_PROPERTY_OTHERS:Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;
    ...
    sput-object v0, UNISOLATION_PROPERTY:Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-boolean p1, p0, mIsStaticLayout:Z

    new-instance p2, Ljava/util/HashMap;

    invoke-direct {p2}, Ljava/util/HashMap;-><init>()V

    iput-object p2, p0, mIconStates:Ljava/util/HashMap;

    const/high16 p2, -0x80000000

    iput p2, p0, mActualLayoutWidth:I

    const/high16 p2, -0x31000000

    iput p2, p0, mActualPaddingEnd:F

    iput p2, p0, mActualPaddingStart:F

    const/4 p2, -0x1

    iput p2, p0, mAddAnimationStartIndex:I

    iput p2, p0, mCannedAnimationStartIndex:I

    iput p2, p0, mSpeedBumpIndex:I

    const/4 p2, 0x0

    iput p2, p0, mOpenedAmount:F
    ...
    iput-object p2, p0, mAbsolutePosition:[I
...
.method static synthetic access$1000()Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;
    ...
    sget-object v0, UNISOLATION_PROPERTY:Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;
...
.method static synthetic access$1100(Lcom/android/systemui/statusbar/phone/NotificationIconContainer;)Lcom/android/systemui/statusbar/StatusBarIconView;
    ...
    iget-object p0, p0, mIsolatedIcon:Lcom/android/systemui/statusbar/StatusBarIconView;
...
.method static synthetic access$1200()Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;
    ...
    sget-object v0, UNISOLATION_PROPERTY_OTHERS:Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;
...
.method static synthetic access$200(Lcom/android/systemui/statusbar/phone/NotificationIconContainer;)Z
    ...
    iget-boolean p0, p0, mDisallowNextAnimation:Z
...
.method static synthetic access$300()Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;
    ...
    sget-object v0, ADD_ICON_PROPERTIES:Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;
...
.method static synthetic access$400()Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;
    ...
    sget-object v0, DOT_ANIMATION_PROPERTIES:Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;
...
.method static synthetic access$500(Lcom/android/systemui/statusbar/phone/NotificationIconContainer;)I
    ...
    iget p0, p0, mAddAnimationStartIndex:I
...
.method static synthetic access$600()Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;
    ...
    sget-object v0, sTempProperties:Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;
...
.method static synthetic access$700()Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;
    ...
    sget-object v0, ICON_ANIMATION_PROPERTIES:Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;
...
.method static synthetic access$800(Lcom/android/systemui/statusbar/phone/NotificationIconContainer;)I
    ...
    iget p0, p0, mCannedAnimationStartIndex:I
...
.method static synthetic access$802(Lcom/android/systemui/statusbar/phone/NotificationIconContainer;I)I
    ...
    iput p1, p0, mCannedAnimationStartIndex:I
...
.method static synthetic access$900(Lcom/android/systemui/statusbar/phone/NotificationIconContainer;)Landroid/view/View;
    ...
    iget-object p0, p0, mIsolatedIconForAnimation:Landroid/view/View;
...
.method private getActualPaddingEnd()F
    ...
    iget v0, p0, mActualPaddingEnd:F
...
.method private getActualPaddingStart()F
    ...
    iget v0, p0, mActualPaddingStart:F
...
.method private getLayoutEnd()F
    ...
    invoke-virtual {p0}, getActualWidth()I

    move-result v0

    int-to-float v0, v0

    invoke-direct {p0}, getActualPaddingEnd()F
...
.method private getMaxOverflowStart()F
    ...
    invoke-direct {p0}, getLayoutEnd()F

    move-result v0

    iget p0, p0, mOverflowWidth:I
...
.method private initDimens()V
    ...
    iput v0, p0, mStaticDotRadius:I

    iget v0, p0, mStaticDotRadius:I

    mul-int/lit8 v0, v0, 0x2

    iput v0, p0, mStaticDotDiameter:I
...
.method private isReplacingIcon(Landroid/view/View;)Z
    ...
    iget-object v0, p0, mReplacingIcons:Landroidx/collection/ArrayMap;
    ...
    iget-object p0, p0, mReplacingIcons:Landroidx/collection/ArrayMap;
...
.method private setIconSize(I)V
    ...
    iput p1, p0, mIconSize:I

    iget p1, p0, mIconSize:I

    iget v0, p0, mStaticDotDiameter:I

    iget v1, p0, mDotPadding:I

    invoke-virtual {p0, p1, v0, v1}, Lcom/oneplus/systemui/statusbar/phone/OpNotificationIconContainer;->setOverflowWidth(III)I

    move-result p1

    iput p1, p0, mOverflowWidth:I
...
.method private updateState()V
    ...
    invoke-virtual {p0}, resetViewStates()V

    invoke-virtual {p0}, calculateIconTranslations()V

    invoke-virtual {p0}, applyIconStates()V
...
.method public applyIconStates()V
    ...
    iget-object v3, p0, mIconStates:Ljava/util/HashMap;
    ...
    iput v1, p0, mAddAnimationStartIndex:I

    iput v1, p0, mCannedAnimationStartIndex:I

    iput-boolean v0, p0, mDisallowNextAnimation:Z

    const/4 v0, 0x0

    iput-object v0, p0, mIsolatedIconForAnimation:Landroid/view/View;
...
.method public calculateIconTranslations()V
    ...
    invoke-direct/range {p0 .. p0}, getActualPaddingStart()F
    ...
    :cond_0
    iget-boolean v3, v0, mIsStaticLayout:Z
    ...
    :goto_0
    invoke-direct/range {p0 .. p0}, getLayoutEnd()F

    move-result v4

    invoke-direct/range {p0 .. p0}, getMaxOverflowStart()F

    move-result v5

    const/4 v6, 0x0

    iput v6, v0, mVisualOverflowStart:F

    const/4 v7, 0x0

    iput-object v7, v0, mFirstVisibleIconState:Lcom/android/systemui/statusbar/phone/NotificationIconContainer$IconState;

    iget v7, v0, mSpeedBumpIndex:I
    ...
    iget-object v14, v0, mIconStates:Ljava/util/HashMap;
    ...
    iget-object v9, v0, mFirstVisibleIconState:Lcom/android/systemui/statusbar/phone/NotificationIconContainer$IconState;

    if-nez v9, :cond_3

    iput-object v14, v0, mFirstVisibleIconState:Lcom/android/systemui/statusbar/phone/NotificationIconContainer$IconState;

    :cond_3
    iget v9, v0, mSpeedBumpIndex:I
    ...
    :goto_a
    iget v8, v0, mOverflowWidth:I

    int-to-float v8, v8

    sub-float v8, v4, v8

    iput v8, v0, mVisualOverflowStart:F

    if-nez v9, :cond_10

    iget-boolean v8, v0, mIsStaticLayout:Z

    if-eqz v8, :cond_11

    :cond_10
    iget v8, v0, mVisualOverflowStart:F
    ...
    iput v1, v0, mNumDots:I

    const/4 v1, -0x1

    if-eq v12, v1, :cond_17

    iget v1, v0, mVisualOverflowStart:F
    ...
    iget-object v4, v0, mIconStates:Ljava/util/HashMap;
    ...
    iget v6, v0, mNumDots:I

    add-int/2addr v6, v5

    iput v6, v0, mNumDots:I
    ...
    iput-object v3, v0, mLastVisibleIconState:Lcom/android/systemui/statusbar/phone/NotificationIconContainer$IconState;
    ...
    iget-object v3, v0, mIconStates:Ljava/util/HashMap;
    ...
    iput-object v1, v0, mLastVisibleIconState:Lcom/android/systemui/statusbar/phone/NotificationIconContainer$IconState;

    iget-object v1, v0, mIconStates:Ljava/util/HashMap;
    ...
    iput-object v1, v0, mFirstVisibleIconState:Lcom/android/systemui/statusbar/phone/NotificationIconContainer$IconState;

    :cond_18
    iget-boolean v1, v0, mDark:Z
    ...
    iget-object v1, v0, mFirstVisibleIconState:Lcom/android/systemui/statusbar/phone/NotificationIconContainer$IconState;
    ...
    :goto_e
    iget-object v1, v0, mLastVisibleIconState:Lcom/android/systemui/statusbar/phone/NotificationIconContainer$IconState;

    if-eqz v1, :cond_1a

    iget v1, v1, Lcom/android/systemui/statusbar/notification/stack/ViewState;->xTranslation:F

    iget v4, v0, mIconSize:I
    ...
    iget v5, v0, mVisualOverflowStart:F
    ...
    iget-object v6, v0, mIconStates:Ljava/util/HashMap;
    ...
    iget-object v5, v0, mIconStates:Ljava/util/HashMap;
    ...
    :cond_1d
    iget-object v1, v0, mIsolatedIcon:Lcom/android/systemui/statusbar/StatusBarIconView;

    if-eqz v1, :cond_1e

    iget-object v2, v0, mIconStates:Ljava/util/HashMap;
    ...
    iget-object v2, v0, mIsolatedIconLocation:Landroid/graphics/Rect;

    iget v2, v2, Landroid/graphics/Rect;->left:I

    iget-object v4, v0, mAbsolutePosition:[I
    ...
    iget-object v4, v0, mIsolatedIcon:Lcom/android/systemui/statusbar/StatusBarIconView;
    ...
    iget-object v0, v0, mIsolatedIcon:Lcom/android/systemui/statusbar/StatusBarIconView;
...
.method public getActualWidth()I
    ...
    iget v0, p0, mActualLayoutWidth:I
...
.method public getFinalTranslationX()I
    ...
    iget-object v0, p0, mLastVisibleIconState:Lcom/android/systemui/statusbar/phone/NotificationIconContainer$IconState;
    ...
    iget-object v1, p0, mLastVisibleIconState:Lcom/android/systemui/statusbar/phone/NotificationIconContainer$IconState;
...
.method public getIconState(Lcom/android/systemui/statusbar/StatusBarIconView;)Lcom/android/systemui/statusbar/phone/NotificationIconContainer$IconState;
    ...
    iget-object p0, p0, mIconStates:Ljava/util/HashMap;
...
.method public getNoOverflowExtraPadding()I
    ...
    invoke-virtual {p0}, getFinalTranslationX()I
...
.method public getPartialOverflowExtraPadding()I
    ...
    invoke-virtual {p0}, hasPartialOverflow()Z
    ...
    iget v1, p0, mNumDots:I

    sub-int/2addr v0, v1

    iget v1, p0, mStaticDotDiameter:I

    iget v2, p0, mDotPadding:I
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-direct {p0}, getActualPaddingStart()F
...
.method protected onLayout(ZIIII)V
    ...
    invoke-direct {p0, p5}, setIconSize(I)V
    ...
    :cond_1
    iget-object p1, p0, mAbsolutePosition:[I

    invoke-virtual {p0, p1}, Landroid/widget/FrameLayout;->getLocationOnScreen([I)V

    iget-boolean p1, p0, mIsStaticLayout:Z
...
.method public onViewAdded(Landroid/view/View;)V
    ...
    invoke-direct {p0, p1}, isReplacingIcon(Landroid/view/View;)Z

    move-result v0

    iget-boolean v1, p0, mChangingViewPositions:Z
    ...
    :cond_0
    iget-object v4, p0, mIconStates:Ljava/util/HashMap;
    ...
    iget-object v0, p0, mIconStates:Ljava/util/HashMap;
    ...
    iget v0, p0, mAddAnimationStartIndex:I
    ...
    iput v0, p0, mAddAnimationStartIndex:I
...
.method public onViewRemoved(Landroid/view/View;)V
    ...
    iget-boolean v2, p0, mAnimationsEnabled:Z
    ...
    invoke-direct {p0, v2}, findFirstViewIndexAfter(F)I

    move-result v2

    iget v3, p0, mAddAnimationStartIndex:I

    if-gez v3, :cond_0

    iput v2, p0, mAddAnimationStartIndex:I
    ...
    :cond_1
    :goto_0
    iget-boolean v2, p0, mChangingViewPositions:Z

    if-nez v2, :cond_6

    iget-object v2, p0, mIconStates:Ljava/util/HashMap;
    ...
    iget-object v2, p0, mIsolatedIcon:Lcom/android/systemui/statusbar/StatusBarIconView;
...
.method public resetViewStates()V
    ...
    iget-object v4, p0, mIsolatedIcon:Lcom/android/systemui/statusbar/StatusBarIconView;
...
.method public setActualLayoutWidth(I)V
    ...
    iput p1, p0, mActualLayoutWidth:I
...
.method public setActualPaddingEnd(F)V
    ...
    iput p1, p0, mActualPaddingEnd:F
...
.method public setActualPaddingStart(F)V
    ...
    iput p1, p0, mActualPaddingStart:F
...
.method public setChangingViewPositions(Z)V
    ...
    iput-boolean p1, p0, mChangingViewPositions:Z
...
.method public setDark(ZZJ)V
    ...
    iget-boolean v0, p0, mDisallowNextAnimation:Z
...
.method public setIsolatedIconLocation(Landroid/graphics/Rect;Z)V
    ...
    iput-object p1, p0, mIsolatedIconLocation:Landroid/graphics/Rect;
...
.method public setReplacingIcons(Landroidx/collection/ArrayMap;)V
    ...
    iput-object p1, p0, mReplacingIcons:Landroidx/collection/ArrayMap;
...
.method public showIconIsolated(Lcom/android/systemui/statusbar/StatusBarIconView;Z)V
    ...
    :cond_0
    iget-object p2, p0, mIsolatedIcon:Lcom/android/systemui/statusbar/StatusBarIconView;

    :goto_0
    iput-object p2, p0, mIsolatedIconForAnimation:Landroid/view/View;

    :cond_1
    iput-object p1, p0, mIsolatedIcon:Lcom/android/systemui/statusbar/StatusBarIconView;
