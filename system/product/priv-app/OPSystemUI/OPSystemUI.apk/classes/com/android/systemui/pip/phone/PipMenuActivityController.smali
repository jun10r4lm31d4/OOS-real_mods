...
.method public constructor <init>(Landroid/content/Context;Landroid/app/IActivityManager;Lcom/android/systemui/pip/phone/PipMediaController;Lcom/android/systemui/shared/system/InputConsumerController;)V
    ...
    iput-object v0, p0, mTmpDismissFractionData:Landroid/os/Bundle;
    ...
    iput-object v0, p0, mStartActivityRequestedTimeoutRunnable:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mMediaActionListener:Lcom/android/systemui/pip/phone/PipMediaController$ActionListener;

    iput-object p1, p0, mContext:Landroid/content/Context;

    iput-object p2, p0, mActivityManager:Landroid/app/IActivityManager;

    iput-object p3, p0, mMediaController:Lcom/android/systemui/pip/phone/PipMediaController;

    iput-object p4, p0, mInputConsumerController:Lcom/android/systemui/shared/system/InputConsumerController;
...
.method static synthetic access$000(Lcom/android/systemui/pip/phone/PipMenuActivityController;IZ)V
    ...
    invoke-direct {p0, p1, p2}, onMenuStateChanged(IZ)V
...
.method static synthetic access$200(Lcom/android/systemui/pip/phone/PipMenuActivityController;)Lcom/android/systemui/shared/system/InputConsumerController;
    ...
    iget-object p0, p0, mInputConsumerController:Lcom/android/systemui/shared/system/InputConsumerController;
...
.method static synthetic access$300(Lcom/android/systemui/pip/phone/PipMenuActivityController;)Landroid/os/Messenger;
    ...
    iget-object p0, p0, mToActivityMessenger:Landroid/os/Messenger;
...
.method static synthetic access$302(Lcom/android/systemui/pip/phone/PipMenuActivityController;Landroid/os/Messenger;)Landroid/os/Messenger;
    ...
    iput-object p1, p0, mToActivityMessenger:Landroid/os/Messenger;
...
.method static synthetic access$400(Lcom/android/systemui/pip/phone/PipMenuActivityController;Z)V
    ...
    invoke-direct {p0, p1}, setStartActivityRequested(Z)V
...
.method static synthetic access$500(Lcom/android/systemui/pip/phone/PipMenuActivityController;)Ljava/lang/Runnable;
    ...
    iget-object p0, p0, mOnAnimationEndRunnable:Ljava/lang/Runnable;
...
.method static synthetic access$502(Lcom/android/systemui/pip/phone/PipMenuActivityController;Ljava/lang/Runnable;)Ljava/lang/Runnable;
    ...
    iput-object p1, p0, mOnAnimationEndRunnable:Ljava/lang/Runnable;
...
.method static synthetic access$602(Lcom/android/systemui/pip/phone/PipMenuActivityController;Landroid/content/pm/ParceledListSlice;)Landroid/content/pm/ParceledListSlice;
    ...
    iput-object p1, p0, mMediaActions:Landroid/content/pm/ParceledListSlice;
...
.method static synthetic access$700(Lcom/android/systemui/pip/phone/PipMenuActivityController;)V
    ...
    invoke-direct {p0}, updateMenuActions()V
...
.method private isStartActivityRequestedElapsed()Z
    ...
    iget-wide v2, p0, mStartActivityRequestedTime:J
...
.method private onMenuStateChanged(IZ)V
    ...
    iget-object v0, p0, mInputConsumerController:Lcom/android/systemui/shared/system/InputConsumerController;
    ...
    iget-object p2, p0, mMediaController:Lcom/android/systemui/pip/phone/PipMediaController;

    iget-object v0, p0, mMediaActionListener:Lcom/android/systemui/pip/phone/PipMediaController$ActionListener;
...
.method private resolveMenuActions()Landroid/content/pm/ParceledListSlice;
    ...
    iget-object v0, p0, mAppActions:Landroid/content/pm/ParceledListSlice;

    invoke-direct {p0, v0}, isValidActions(Landroid/content/pm/ParceledListSlice;)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object p0, p0, mAppActions:Landroid/content/pm/ParceledListSlice;

    return-object p0

    :cond_0
    iget-object p0, p0, mMediaActions:Landroid/content/pm/ParceledListSlice;
...
.method private setStartActivityRequested(Z)V
    ...
    iget-object v1, p0, mStartActivityRequestedTimeoutRunnable:Ljava/lang/Runnable;

    invoke-virtual {v0, v1}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    iput-boolean p1, p0, mStartActivityRequested:Z
    ...
    :goto_0
    iput-wide v0, p0, mStartActivityRequestedTime:J
...
.method private startMenuActivity(ILandroid/graphics/Rect;Landroid/graphics/Rect;ZZ)V
    ...
    iget-object v5, p0, mMessenger:Landroid/os/Messenger;

    invoke-virtual {v3, v4, v5}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;

    const-string v4, "actions"

    invoke-direct {p0}, resolveMenuActions()Landroid/content/pm/ParceledListSlice;
    ...
    invoke-direct {p0, p4}, setStartActivityRequested(Z)V
    ...
    invoke-direct {p0, v1}, setStartActivityRequested(Z)V
...
.method private updateMenuActions()V
    ...
    iget-object v1, p0, mToActivityMessenger:Landroid/os/Messenger;
...
.method public dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    iget-boolean v1, p0, mStartActivityRequested:Z
    ...
    iget-wide v0, p0, mStartActivityRequestedTime:J
...
.method public hideMenu()V
    ...
    iget-object v0, p0, mToActivityMessenger:Landroid/os/Messenger;
...
.method public hideMenuWithoutResize()V
    ...
    invoke-direct {p0, v0, v0}, onMenuStateChanged(IZ)V
...
.method public synthetic lambda$new$0$PipMenuActivityController()V
    ...
    invoke-direct {p0, v0}, setStartActivityRequested(Z)V

    iget-object v0, p0, mOnAnimationEndRunnable:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mOnAnimationEndRunnable:Ljava/lang/Runnable;
...
.method public setAppActions(Landroid/content/pm/ParceledListSlice;)V
    ...
    iput-object p1, p0, mAppActions:Landroid/content/pm/ParceledListSlice;
...
.method public setDismissFraction(F)V
    ...
    iget-object v0, p0, mTmpDismissFractionData:Landroid/os/Bundle;
    ...
    :cond_0
    iget-boolean p1, p0, mStartActivityRequested:Z

    if-eqz p1, :cond_1

    invoke-direct {p0}, isStartActivityRequestedElapsed()Z
    ...
    invoke-direct/range {v0 .. v5}, startMenuActivity(ILandroid/graphics/Rect;Landroid/graphics/Rect;ZZ)V
...
.method public showMenu(ILandroid/graphics/Rect;Landroid/graphics/Rect;ZZ)V
    ...
    :cond_0
    iget-boolean v0, p0, mStartActivityRequested:Z
    ...
    :cond_1
    invoke-direct/range {p0 .. p5}, startMenuActivity(ILandroid/graphics/Rect;Landroid/graphics/Rect;ZZ)V
