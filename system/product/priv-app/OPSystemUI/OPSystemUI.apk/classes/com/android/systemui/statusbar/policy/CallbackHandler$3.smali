...
.method constructor <init>(Lcom/android/systemui/statusbar/policy/CallbackHandler;Lcom/android/systemui/statusbar/policy/NetworkController$IconState;Lcom/android/systemui/statusbar/policy/NetworkController$IconState;IIZZI[I[ILjava/lang/String;Ljava/lang/String;ZIZZ)V
    ...
    iput-object v1, v0, this$0:Lcom/android/systemui/statusbar/policy/CallbackHandler;

    move-object v1, p2

    iput-object v1, v0, val$statusIcon:Lcom/android/systemui/statusbar/policy/NetworkController$IconState;

    move-object v1, p3

    iput-object v1, v0, val$qsIcon:Lcom/android/systemui/statusbar/policy/NetworkController$IconState;

    move v1, p4

    iput v1, v0, val$statusType:I

    move v1, p5

    iput v1, v0, val$qsType:I

    move v1, p6

    iput-boolean v1, v0, val$activityIn:Z

    move v1, p7

    iput-boolean v1, v0, val$activityOut:Z

    move v1, p8

    iput v1, v0, val$dataActivityId:I

    move-object v1, p9

    iput-object v1, v0, val$stackedDataIcon:[I

    move-object v1, p10

    iput-object v1, v0, val$stackedVoiceIcon:[I

    move-object v1, p11

    iput-object v1, v0, val$typeContentDescription:Ljava/lang/String;

    move-object v1, p12

    iput-object v1, v0, val$description:Ljava/lang/String;

    move v1, p13

    iput-boolean v1, v0, val$isWide:Z

    move/from16 v1, p14

    iput v1, v0, val$subId:I

    move/from16 v1, p15

    iput-boolean v1, v0, val$roaming:Z

    move/from16 v1, p16

    iput-boolean v1, v0, val$connected:Z
...
.method public run()V
    ...
    iget-object v1, v0, this$0:Lcom/android/systemui/statusbar/policy/CallbackHandler;
    ...
    iget-object v4, v0, val$statusIcon:Lcom/android/systemui/statusbar/policy/NetworkController$IconState;

    iget-object v5, v0, val$qsIcon:Lcom/android/systemui/statusbar/policy/NetworkController$IconState;

    iget v6, v0, val$statusType:I

    iget v7, v0, val$qsType:I

    iget-boolean v8, v0, val$activityIn:Z

    iget-boolean v9, v0, val$activityOut:Z

    iget v10, v0, val$dataActivityId:I

    iget-object v11, v0, val$stackedDataIcon:[I

    iget-object v12, v0, val$stackedVoiceIcon:[I

    iget-object v13, v0, val$typeContentDescription:Ljava/lang/String;

    iget-object v14, v0, val$description:Ljava/lang/String;

    iget-boolean v15, v0, val$isWide:Z

    iget v2, v0, val$subId:I

    move-object/from16 v19, v1

    iget-boolean v1, v0, val$roaming:Z

    move/from16 v17, v1

    iget-boolean v1, v0, val$connected:Z
