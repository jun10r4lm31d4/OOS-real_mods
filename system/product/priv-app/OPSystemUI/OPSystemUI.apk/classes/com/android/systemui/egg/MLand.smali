...
.method static constructor <clinit>()V
    ...
    sput-object v2, hsv:[F

    new-instance v2, Landroid/graphics/Rect;

    invoke-direct {v2}, Landroid/graphics/Rect;-><init>()V

    sput-object v2, sTmpRect:Landroid/graphics/Rect;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p2, p0, mPlayers:Ljava/util/ArrayList;

    new-instance p2, Ljava/util/ArrayList;

    invoke-direct {p2}, Ljava/util/ArrayList;-><init>()V

    iput-object p2, p0, mObstaclesInPlay:Ljava/util/ArrayList;

    const/4 p2, 0x0

    iput p2, p0, mCountdown:I

    new-instance p3, Ljava/util/ArrayList;

    invoke-direct {p3}, Ljava/util/ArrayList;-><init>()V

    iput-object p3, p0, mGameControllers:Ljava/util/ArrayList;
    ...
    iput-object p3, p0, mVibrator:Landroid/os/Vibrator;
    ...
    sput-object p3, PARAMS:Lcom/android/systemui/egg/MLand$Params;

    sget-object p3, SKIES:[[I

    array-length p3, p3

    sub-int/2addr p3, p1

    invoke-static {p2, p3}, irand(II)I

    move-result p3

    iput p3, p0, mTimeOfDay:I
    ...
    iput-object p3, p0, mTouchPaint:Landroid/graphics/Paint;

    iget-object p3, p0, mTouchPaint:Landroid/graphics/Paint;
    ...
    iput-object p3, p0, mPlayerTracePaint:Landroid/graphics/Paint;

    iget-object p3, p0, mPlayerTracePaint:Landroid/graphics/Paint;
    ...
    invoke-virtual {p0, p1}, setupPlayers(I)V
...
.method static synthetic access$100(Lcom/android/systemui/egg/MLand;JJ)V
    ...
    invoke-direct {p0, p1, p2, p3, p4}, step(JJ)V
...
.method static synthetic access$1000()Lcom/android/systemui/egg/MLand$Params;
    ...
    sget-object v0, PARAMS:Lcom/android/systemui/egg/MLand$Params;
...
.method static synthetic access$210(Lcom/android/systemui/egg/MLand;)I
    ...
    iget v0, p0, mCountdown:I

    add-int/lit8 v1, v0, -0x1

    iput v1, p0, mCountdown:I
...
.method static synthetic access$300(Lcom/android/systemui/egg/MLand;)Landroid/view/View;
    ...
    iget-object p0, p0, mSplash:Landroid/view/View;
...
.method private addPlayerInternal(Lcom/android/systemui/egg/MLand$Player;)I
    ...
    iget-object v0, p0, mPlayers:Ljava/util/ArrayList;

    invoke-virtual {v0, p1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-direct {p0}, realignPlayers()V
    ...
    iget-object v1, p0, mScoreFields:Landroid/view/ViewGroup;
    ...
    iget-object p0, p0, mPlayers:Ljava/util/ArrayList;
...
.method private clearPlayers()V
    ...
    invoke-direct {p0, v0}, removePlayerInternal(Lcom/android/systemui/egg/MLand$Player;)V
...
.method public static final frand(FF)F
    ...
    invoke-static {}, frand()F

    move-result v0

    invoke-static {v0, p0, p1}, lerp(FFF)F
...
.method public static final irand(II)I
    ...
    invoke-static {p0, p1}, frand(FF)F
...
.method public static pick([I)I
    ...
    invoke-static {v1, v0}, irand(II)I
...
.method private poke(I)V
    ...
    invoke-direct {p0, p1, v0, v0}, poke(IFF)V
...
.method private poke(IFF)V
    ...
    invoke-static {v2, v1}, L(Ljava/lang/String;[Ljava/lang/Object;)V

    iget-boolean v1, p0, mFrozen:Z
    ...
    :cond_1
    iget-boolean v1, p0, mPlaying:Z

    if-nez v1, :cond_2

    invoke-virtual {p0, v0}, start(Z)V

    goto :goto_0

    :cond_2
    invoke-virtual {p0, p1}, getPlayer(I)Lcom/android/systemui/egg/MLand$Player;
...
.method private realignPlayers()V
    ...
    sget-object v3, PARAMS:Lcom/android/systemui/egg/MLand$Params;
    ...
    iget-object v3, p0, mPlayers:Ljava/util/ArrayList;
...
.method private removePlayerInternal(Lcom/android/systemui/egg/MLand$Player;)V
    ...
    iget-object v0, p0, mScoreFields:Landroid/view/ViewGroup;
...
.method private step(JJ)V
    ...
    :goto_1
    iget-object v3, v0, mPlayers:Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v14}, getPlayer(I)Lcom/android/systemui/egg/MLand$Player;
    ...
    sget-boolean v4, DEBUG_IDDQD:Z

    if-eqz v4, :cond_3

    invoke-direct {v0, v14}, poke(I)V

    invoke-direct {v0, v14}, unpoke(I)V
    ...
    invoke-static {v7, v4}, L(Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-direct {v0, v14, v5, v6}, thump(IJ)V

    invoke-virtual {v3}, Lcom/android/systemui/egg/MLand$Player;->die()V

    :cond_4
    :goto_2
    iget-object v4, v0, mObstaclesInPlay:Ljava/util/ArrayList;
    ...
    invoke-static {v9, v4}, L(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual/range {p0 .. p0}, stop()V
    ...
    iget-object v1, v0, mPlayers:Ljava/util/ArrayList;
    ...
    iget-object v4, v0, mPlayers:Ljava/util/ArrayList;
    ...
    iget-object v3, v0, mObstaclesInPlay:Ljava/util/ArrayList;
    ...
    iget v4, v0, mLastPipeTime:F

    sub-float v4, v1, v4

    sget-object v5, PARAMS:Lcom/android/systemui/egg/MLand$Params;
    ...
    iput v1, v0, mLastPipeTime:F

    iget v1, v0, mCurrentPipeId:I

    add-int/2addr v1, v2

    iput v1, v0, mCurrentPipeId:I
    ...
    invoke-static {v13, v6}, irand(II)I
    ...
    sget-object v10, PARAMS:Lcom/android/systemui/egg/MLand$Params;
    ...
    sget-object v9, PARAMS:Lcom/android/systemui/egg/MLand$Params;
    ...
    sget-object v11, PARAMS:Lcom/android/systemui/egg/MLand$Params;
    ...
    iget-object v6, v0, mObstaclesInPlay:Ljava/util/ArrayList;

    invoke-virtual {v6, v3}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    const/16 v3, 0xfa

    invoke-static {v13, v3}, irand(II)I
    ...
    sget-object v1, PARAMS:Lcom/android/systemui/egg/MLand$Params;
    ...
    sget-object v2, PARAMS:Lcom/android/systemui/egg/MLand$Params;
    ...
    iget-object v1, v0, mObstaclesInPlay:Ljava/util/ArrayList;
    ...
    sget-object v8, PARAMS:Lcom/android/systemui/egg/MLand$Params;
    ...
    sget-object v7, PARAMS:Lcom/android/systemui/egg/MLand$Params;
    ...
    iget-object v2, v0, mObstaclesInPlay:Ljava/util/ArrayList;
...
.method private thump(IJ)V
    ...
    :cond_0
    iget-object v0, p0, mGameControllers:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, mAudioAttrs:Landroid/media/AudioAttributes;
    ...
    :cond_1
    iget-object p1, p0, mVibrator:Landroid/os/Vibrator;
...
.method private unpoke(I)V
    ...
    invoke-static {v1, v0}, L(Ljava/lang/String;[Ljava/lang/Object;)V

    iget-boolean v0, p0, mFrozen:Z
...
.method public addPlayer()V
    ...
    invoke-virtual {p0}, getNumPlayers()I
    ...
    invoke-direct {p0, v0}, addPlayerInternal(Lcom/android/systemui/egg/MLand$Player;)I
...
.method public getGameControllers()Ljava/util/ArrayList;
    ...
    invoke-static {v4}, isGamePad(Landroid/view/InputDevice;)Z

    move-result v4

    if-eqz v4, :cond_0

    iget-object v4, p0, mGameControllers:Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object p0, p0, mGameControllers:Ljava/util/ArrayList;
...
.method public hideSplash()V
    ...
    iget-object v0, p0, mSplash:Landroid/view/View;
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v2, p0, mTouchPaint:Landroid/graphics/Paint;
    ...
    iget-object v2, p0, mPlayerTracePaint:Landroid/graphics/Paint;
    ...
    iget-object v5, p0, mTouchPaint:Landroid/graphics/Paint;
    ...
    iget-object v11, p0, mPlayerTracePaint:Landroid/graphics/Paint;
...
.method public onGenericMotionEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-static {p1, p0}, L(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {p0, p1}, getControllerPlayer(I)I

    move-result p1

    invoke-direct {p0, p1}, poke(I)V
...
.method public onKeyUp(ILandroid/view/KeyEvent;)Z
    ...
    invoke-direct {p0, p1}, unpoke(I)V
...
.method protected onSizeChanged(IIII)V
    ...
    invoke-virtual {p0, p1}, start(Z)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-static {v3, v1}, L(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    :cond_1
    invoke-direct {p0, v4}, unpoke(I)V

    return v0

    :cond_2
    invoke-direct {p0, v4, v3, v1}, poke(IFF)V
...
.method public onTrackballEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    invoke-direct {p0, v2}, unpoke(I)V

    return v0

    :cond_1
    invoke-direct {p0, v2}, poke(I)V
...
.method public reset()V
    ...
    sget-object v3, SKIES:[[I

    iget v4, p0, mTimeOfDay:I
    ...
    :goto_0
    iput-boolean v1, p0, mFlipped:Z

    iget-boolean v1, p0, mFlipped:Z
    ...
    :cond_3
    iget-object v1, p0, mObstaclesInPlay:Ljava/util/ArrayList;

    invoke-virtual {v1}, Ljava/util/ArrayList;->clear()V

    iput v0, p0, mCurrentPipeId:I
    ...
    invoke-static {v11, v10}, frand(FF)F
    ...
    invoke-static {v4, v9}, frand(FF)F
    ...
    sget-object v6, PARAMS:Lcom/android/systemui/egg/MLand$Params;

    iget v6, v6, Lcom/android/systemui/egg/MLand$Params;->BUILDING_HEIGHT_MIN:I

    invoke-static {v6, v1}, irand(II)I
    ...
    invoke-static {v7, v6}, frand(FF)F
    ...
    iget-object v0, p0, mAnim:Landroid/animation/TimeAnimator;
    ...
    iput-object v0, p0, mAnim:Landroid/animation/TimeAnimator;
...
.method public setScoreFieldHolder(Landroid/view/ViewGroup;)V
    ...
    iput-object p1, p0, mScoreFields:Landroid/view/ViewGroup;
    ...
    :cond_0
    iget-object p1, p0, mPlayers:Ljava/util/ArrayList;
...
.method public setSplash(Landroid/view/View;)V
    ...
    iput-object p1, p0, mSplash:Landroid/view/View;
...
.method public setupPlayers(I)V
    ...
    invoke-direct {p0}, clearPlayers()V
    ...
    invoke-direct {p0, v1}, addPlayerInternal(Lcom/android/systemui/egg/MLand$Player;)I
...
.method public start(Z)V
    ...
    iget p1, p0, mCountdown:I

    if-gtz p1, :cond_1

    invoke-virtual {p0}, showSplash()V

    iget-object p1, p0, mSplash:Landroid/view/View;
    ...
    iget-object v1, p0, mSplash:Landroid/view/View;
    ...
    iget-object p1, p0, mAnim:Landroid/animation/TimeAnimator;
...
.method public startPlaying()V
    ...
    iput-boolean v0, p0, mPlaying:Z

    const/4 v0, 0x0

    iput v0, p0, t:F

    invoke-virtual {p0}, getGameTime()F
    ...
    iput v0, p0, mLastPipeTime:F

    invoke-virtual {p0}, hideSplash()V
    ...
    iget-object v1, p0, mPlayers:Ljava/util/ArrayList;
...
.method public stop()V
    ...
    invoke-static {v0, v1}, irand(II)I

    move-result v1

    iput v1, p0, mTimeOfDay:I
