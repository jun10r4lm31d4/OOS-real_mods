...
.method constructor <init>(Lcom/android/systemui/ImageWallpaper;Landroid/content/Context;)V
    ...
    iput-object p1, p0, this$0:Lcom/android/systemui/ImageWallpaper;
    ...
    iput-object p1, p0, mFinishRenderingTask:Ljava/lang/Runnable;

    new-instance p1, Ljava/lang/Object;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, mMonitor:Ljava/lang/Object;

    const/4 p1, 0x0

    iput-boolean p1, p0, mNeedTransition:Z
    ...
    iput-object p1, p0, mController:Lcom/android/systemui/plugins/statusbar/StatusBarStateController;

    iget-object p1, p0, mController:Lcom/android/systemui/plugins/statusbar/StatusBarStateController;
    ...
    iput-object p1, p0, mEglHelper:Lcom/android/systemui/glwallpaper/EglHelper;
    ...
    iput-object p1, p0, mRenderer:Lcom/android/systemui/glwallpaper/GLWallpaperRenderer;
...
.method private cancelFinishRenderingTask()V
    ...
    iget-object v0, p0, this$0:Lcom/android/systemui/ImageWallpaper;
    ...
    iget-object p0, p0, mFinishRenderingTask:Ljava/lang/Runnable;
...
.method private finishRendering()V
    ...
    iget-object v0, p0, mEglHelper:Lcom/android/systemui/glwallpaper/EglHelper;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lcom/android/systemui/glwallpaper/EglHelper;->destroyEglSurface()V

    invoke-direct {p0}, needPreserveEglContext()Z

    move-result v0

    if-nez v0, :cond_0

    iget-object p0, p0, mEglHelper:Lcom/android/systemui/glwallpaper/EglHelper;
...
.method public static synthetic lambda$4IwqG_0jMNtMT6yCqqj-KAFKSvE(Lcom/android/systemui/ImageWallpaper$GLEngine;)V
    ...
    invoke-direct {p0}, finishRendering()V
...
.method public static synthetic lambda$8Tw1AsmyFt-Lr4VSDxpiW6fEz7g(Lcom/android/systemui/ImageWallpaper$GLEngine;)V
    ...
    invoke-direct {p0}, scheduleFinishRendering()V
...
.method private needPreserveEglContext()Z
    ...
    iget-boolean v0, p0, mNeedTransition:Z

    const/4 v1, 0x1

    if-eqz v0, :cond_0

    iget-object p0, p0, mController:Lcom/android/systemui/plugins/statusbar/StatusBarStateController;
...
.method private notifyWaitingThread()V
    ...
    iget-object v0, p0, mMonitor:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-boolean v1, p0, mWaitingForRendering:Z
    :try_end_0
    ...
    :try_start_1
    iput-boolean v1, p0, mWaitingForRendering:Z

    iget-object p0, p0, mMonitor:Ljava/lang/Object;
...
.method private preRenderInternal()V
    ...
    invoke-direct {p0}, cancelFinishRenderingTask()V

    iget-object v1, p0, mEglHelper:Lcom/android/systemui/glwallpaper/EglHelper;
    ...
    :goto_1
    iget-object v2, p0, mEglHelper:Lcom/android/systemui/glwallpaper/EglHelper;
    ...
    iget-object v1, p0, mRenderer:Lcom/android/systemui/glwallpaper/GLWallpaperRenderer;

    invoke-interface {v1}, Lcom/android/systemui/glwallpaper/GLWallpaperRenderer;->onSurfaceCreated()V

    iget-object p0, p0, mRenderer:Lcom/android/systemui/glwallpaper/GLWallpaperRenderer;
...
.method private requestRenderInternal()V
    ...
    iget-object v0, p0, mRenderer:Lcom/android/systemui/glwallpaper/GLWallpaperRenderer;
    ...
    iget-object v3, p0, mEglHelper:Lcom/android/systemui/glwallpaper/EglHelper;
...
.method private waitForBackgroundRendering()V
    ...
    :try_start_0
    iput-boolean v2, p0, mWaitingForRendering:Z

    move v3, v2

    :goto_0
    iget-boolean v4, p0, mWaitingForRendering:Z

    if-eqz v4, :cond_1

    iget-object v4, p0, mMonitor:Ljava/lang/Object;
    ...
    iput-boolean v4, p0, mWaitingForRendering:Z
    :try_end_0
...
.method protected dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v0, p0, mController:Lcom/android/systemui/plugins/statusbar/StatusBarStateController;
...
.method public synthetic lambda$onDestroy$2$ImageWallpaper$GLEngine()V
    ...
    iput-object v0, p0, mRenderer:Lcom/android/systemui/glwallpaper/GLWallpaperRenderer;

    iget-object v1, p0, mEglHelper:Lcom/android/systemui/glwallpaper/EglHelper;

    invoke-virtual {v1}, Lcom/android/systemui/glwallpaper/EglHelper;->finish()V

    iput-object v0, p0, mEglHelper:Lcom/android/systemui/glwallpaper/EglHelper;
...
.method public synthetic lambda$onSurfaceChanged$4$ImageWallpaper$GLEngine(II)V
    ...
    iput-boolean p1, p0, mNeedRedraw:Z
...
.method public synthetic lambda$onSurfaceRedrawNeeded$5$ImageWallpaper$GLEngine()V
    ...
    iget-boolean v0, p0, mNeedRedraw:Z

    if-eqz v0, :cond_0

    invoke-virtual {p0}, preRender()V

    invoke-virtual {p0}, requestRender()V

    invoke-virtual {p0}, postRender()V

    const/4 v0, 0x0

    iput-boolean v0, p0, mNeedRedraw:Z
...
.method public onAmbientModeChanged(ZJ)V
    ...
    invoke-direct {p0}, waitForBackgroundRendering()V
...
.method public onCreate(Landroid/view/SurfaceHolder;)V
    ...
    invoke-direct {p0}, updateSurfaceSize()V
...
.method public onDestroy()V
    ...
    iput-object v0, p0, mController:Lcom/android/systemui/plugins/statusbar/StatusBarStateController;
...
.method public onOffsetsChanged(FFFFII)V
    ...
    iget-object p3, p0, this$0:Lcom/android/systemui/ImageWallpaper;
...
.method public onSurfaceChanged(Landroid/view/SurfaceHolder;III)V
    ...
    iget-object p1, p0, this$0:Lcom/android/systemui/ImageWallpaper;
...
.method public postRender()V
    ...
    invoke-direct {p0}, notifyWaitingThread()V
...
.method public preRender()V
    ...
    invoke-direct {p0}, preRenderInternal()V
...
.method public requestRender()V
    ...
    invoke-direct {p0}, requestRenderInternal()V
