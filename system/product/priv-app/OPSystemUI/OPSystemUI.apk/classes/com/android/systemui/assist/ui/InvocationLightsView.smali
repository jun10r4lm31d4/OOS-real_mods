...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object p2, p0, mAssistInvocationLights:Ljava/util/ArrayList;
    ...
    iput-object p2, p0, mPath:Landroid/graphics/Path;

    const/4 p2, 0x2

    new-array p3, p2, [I

    iput-object p3, p0, mScreenLocation:[I

    const/4 p3, 0x0

    iput-boolean p3, p0, mRegistered:Z

    const/4 p4, 0x1

    iput-boolean p4, p0, mUseNavBarColor:Z
    ...
    iput v0, p0, mStrokeWidth:I

    iget-object v0, p0, mPaint:Landroid/graphics/Paint;

    iget v1, p0, mStrokeWidth:I
    ...
    invoke-virtual {p0, p1}, createCornerPathRenderer(Landroid/content/Context;)Lcom/android/systemui/assist/ui/CornerPathRenderer;

    move-result-object v3

    iget v0, p0, mStrokeWidth:I
    ...
    iput-object p4, p0, mGuide:Lcom/android/systemui/assist/ui/PerimeterPathGuide;
    ...
    iget-object p2, p0, mAssistInvocationLights:Ljava/util/ArrayList;
...
.method private attemptRegisterNavBarListener()V
    ...
    invoke-virtual {p0, v0}, updateDarkness(F)V
...
.method private renderLight(Lcom/android/systemui/assist/ui/EdgeLight;Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, mGuide:Lcom/android/systemui/assist/ui/PerimeterPathGuide;
    ...
    iget-object p1, p0, mPath:Landroid/graphics/Path;
...
.method public hide()V
    ...
    iget-object v0, p0, mAssistInvocationLights:Ljava/util/ArrayList;
    ...
    :cond_0
    invoke-direct {p0}, attemptUnregisterNavBarListener()V
...
.method public onDarkIntensity(F)V
    ...
    invoke-virtual {p0, p1}, updateDarkness(F)V
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, mScreenLocation:[I
    ...
    iget-boolean v0, p0, mUseNavBarColor:Z
    ...
    invoke-direct {p0, v1, p1}, renderLight(Lcom/android/systemui/assist/ui/EdgeLight;Landroid/graphics/Canvas;)V
    ...
    invoke-direct {p0, v0, p1}, renderLight(Lcom/android/systemui/assist/ui/EdgeLight;Landroid/graphics/Canvas;)V
...
.method public onInvocationProgress(F)V
    ...
    :cond_0
    invoke-direct {p0}, attemptRegisterNavBarListener()V
    ...
    iget-object v4, p0, mGuide:Lcom/android/systemui/assist/ui/PerimeterPathGuide;
    ...
    iget-object p1, p0, mGuide:Lcom/android/systemui/assist/ui/PerimeterPathGuide;
    ...
    invoke-virtual {p0, v0, v4, v1}, setLight(IFF)V

    const/4 v2, 0x1

    add-float/2addr v4, v1

    invoke-virtual {p0, v2, v4, v1}, setLight(IFF)V
    ...
    invoke-virtual {p0, v2, v3, v1}, setLight(IFF)V

    const/4 v2, 0x3

    sub-float/2addr p1, v1

    invoke-virtual {p0, v2, p1, v1}, setLight(IFF)V
...
.method protected onLayout(ZIIII)V
    ...
    iget-object p0, p0, mGuide:Lcom/android/systemui/assist/ui/PerimeterPathGuide;
...
.method protected setLight(IFF)V
    ...
    iget-object p0, p0, mAssistInvocationLights:Ljava/util/ArrayList;
...
.method protected updateDarkness(F)V
    ...
    iget v1, p0, mLightColor:I

    invoke-static {v1}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v1

    iget v2, p0, mDarkColor:I
