...
.method constructor <init>(Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;JJFZFLjava/lang/Runnable;Landroid/animation/AnimatorListenerAdapter;)V
    ...
    iput-object p1, p0, this$0:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;

    iput-wide p2, p0, val$duration:J

    iput-wide p4, p0, val$delay:J

    iput p6, p0, val$translationDirection:F

    iput-boolean p7, p0, val$isHeadsUpAnimation:Z

    iput p8, p0, val$endLocation:F

    iput-object p9, p0, val$onFinishedRunnable:Ljava/lang/Runnable;

    iput-object p10, p0, val$animationListener:Landroid/animation/AnimatorListenerAdapter;
...
.method public onAnimationEnd(Landroid/animation/Animator;)V
    ...
    iget-object v0, p0, this$0:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;

    iget-wide v1, p0, val$duration:J

    iget-wide v3, p0, val$delay:J

    iget v5, p0, val$translationDirection:F

    iget-boolean v6, p0, val$isHeadsUpAnimation:Z

    iget v7, p0, val$endLocation:F

    iget-object v8, p0, val$onFinishedRunnable:Ljava/lang/Runnable;

    iget-object v9, p0, val$animationListener:Landroid/animation/AnimatorListenerAdapter;
