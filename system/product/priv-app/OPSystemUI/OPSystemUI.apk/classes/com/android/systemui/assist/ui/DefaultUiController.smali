...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mProgressInterpolator:Landroid/view/animation/PathInterpolator;

    const/4 v0, 0x0

    iput-boolean v0, p0, mAttached:Z

    iput-boolean v0, p0, mInvocationInProgress:Z

    iput v1, p0, mLastInvocationProgress:F

    new-instance v1, Landroid/animation/ValueAnimator;

    invoke-direct {v1}, Landroid/animation/ValueAnimator;-><init>()V

    iput-object v1, p0, mInvocationAnimator:Landroid/animation/ValueAnimator;

    new-instance v1, Landroid/widget/FrameLayout;

    invoke-direct {v1, p1}, Landroid/widget/FrameLayout;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, mRoot:Landroid/widget/FrameLayout;
    ...
    iput-object v1, p0, mLayoutParams:Landroid/view/WindowManager$LayoutParams;
    ...
    iget-object v2, p0, mRoot:Landroid/widget/FrameLayout;
    ...
    iput-object p1, p0, mInvocationLightsView:Lcom/android/systemui/assist/ui/InvocationLightsView;

    iget-object p1, p0, mRoot:Landroid/widget/FrameLayout;

    iget-object p0, p0, mInvocationLightsView:Lcom/android/systemui/assist/ui/InvocationLightsView;
...
.method static synthetic access$002(Lcom/android/systemui/assist/ui/DefaultUiController;Z)Z
    ...
    iput-boolean p1, p0, mInvocationInProgress:Z
...
.method static synthetic access$102(Lcom/android/systemui/assist/ui/DefaultUiController;F)F
    ...
    iput p1, p0, mLastInvocationProgress:F
...
.method private animateInvocationCompletion(IF)V
    ...
    iget v0, p0, mLastInvocationProgress:F
    ...
    iput-object p2, p0, mInvocationAnimator:Landroid/animation/ValueAnimator;

    iget-object p2, p0, mInvocationAnimator:Landroid/animation/ValueAnimator;
    ...
    iget-object p1, p0, mInvocationAnimator:Landroid/animation/ValueAnimator;
    ...
    iget-object p0, p0, mInvocationAnimator:Landroid/animation/ValueAnimator;
...
.method private attach()V
    ...
    iget-object v1, p0, mRoot:Landroid/widget/FrameLayout;

    iget-object v2, p0, mLayoutParams:Landroid/view/WindowManager$LayoutParams;
...
.method private setProgressInternal(IF)V
    ...
    iget-object p1, p0, mInvocationLightsView:Lcom/android/systemui/assist/ui/InvocationLightsView;

    iget-object p0, p0, mProgressInterpolator:Landroid/view/animation/PathInterpolator;
...
.method private updateAssistHandleVisibility()V
    ...
    iget-object v0, p0, mRoot:Landroid/widget/FrameLayout;
    ...
    iget-boolean p0, p0, mInvocationInProgress:Z
...
.method public hide()V
    ...
    iget-object v0, p0, mInvocationAnimator:Landroid/animation/ValueAnimator;
    ...
    :cond_0
    iget-object v0, p0, mInvocationLightsView:Lcom/android/systemui/assist/ui/InvocationLightsView;
    ...
    invoke-direct {p0}, updateAssistHandleVisibility()V
...
.method public synthetic lambda$animateInvocationCompletion$0$DefaultUiController(ILandroid/animation/ValueAnimator;)V
    ...
    invoke-direct {p0, p1, p2}, setProgressInternal(IF)V
...
.method public onGestureCompletion(F)V
    ...
    invoke-direct {p0, v0, p1}, animateInvocationCompletion(IF)V
...
.method public onInvocationProgress(IF)V
    ...
    iget-boolean v0, p0, mInvocationInProgress:Z
    ...
    invoke-direct {p0, p1, v3}, animateInvocationCompletion(IF)V
    ...
    invoke-direct {p0}, attach()V

    const/4 v1, 0x1

    iput-boolean v1, p0, mInvocationInProgress:Z
    ...
    :goto_0
    iput p2, p0, mLastInvocationProgress:F

    invoke-static {p1, p2, v0}, logInvocationProgressMetrics(IFZ)V
