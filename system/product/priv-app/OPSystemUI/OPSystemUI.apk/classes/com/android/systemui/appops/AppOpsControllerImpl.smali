...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Looper;)V
    ...
    iput-object v0, p0, mCallbacksByCode:Landroid/util/ArrayMap;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mActiveItems:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mNotedItems:Ljava/util/List;
    ...
    iput-object p1, p0, mBGHandler:Lcom/android/systemui/appops/AppOpsControllerImpl$H;

    sget-object p1, OPS:[I
    ...
    iget-object v0, p0, mCallbacksByCode:Landroid/util/ArrayMap;

    sget-object v1, OPS:[I
...
.method static synthetic access$000(Lcom/android/systemui/appops/AppOpsControllerImpl;IILjava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2, p3}, removeNoted(IILjava/lang/String;)V
...
.method private addNoted(IILjava/lang/String;)Z
    ...
    iget-object v0, p0, mNotedItems:Ljava/util/List;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, mNotedItems:Ljava/util/List;

    invoke-direct {p0, v1, p1, p2, p3}, getAppOpItem(Ljava/util/List;IILjava/lang/String;)Lcom/android/systemui/appops/AppOpItem;
    ...
    iget-object p1, p0, mNotedItems:Ljava/util/List;
    ...
    iget-object p2, p0, mBGHandler:Lcom/android/systemui/appops/AppOpsControllerImpl$H;

    invoke-virtual {p2, v1}, Landroid/os/Handler;->removeCallbacksAndMessages(Ljava/lang/Object;)V

    iget-object p0, p0, mBGHandler:Lcom/android/systemui/appops/AppOpsControllerImpl$H;
...
.method private notifySuscribers(IILjava/lang/String;Z)V
    ...
    iget-object p0, p0, mCallbacksByCode:Landroid/util/ArrayMap;
...
.method private removeNoted(IILjava/lang/String;)V
    ...
    :cond_0
    iget-object v2, p0, mNotedItems:Ljava/util/List;
    ...
    iget-object v1, p0, mActiveItems:Ljava/util/List;

    monitor-enter v1

    :try_start_1
    iget-object v0, p0, mActiveItems:Ljava/util/List;

    invoke-direct {p0, v0, p1, p2, p3}, getAppOpItem(Ljava/util/List;IILjava/lang/String;)Lcom/android/systemui/appops/AppOpItem;
    ...
    invoke-direct {p0, p1, p2, p3, v2}, notifySuscribers(IILjava/lang/String;Z)V
...
.method private updateActives(IILjava/lang/String;Z)Z
    ...
    iget-object p0, p0, mActiveItems:Ljava/util/List;
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    :goto_1
    iget-object p3, p0, mNotedItems:Ljava/util/List;
...
.method public synthetic lambda$onOpActiveChanged$0$AppOpsControllerImpl(IILjava/lang/String;Z)V
    ...
    invoke-direct {p0, p1, p2, p3, p4}, notifySuscribers(IILjava/lang/String;Z)V
...
.method public synthetic lambda$onOpNoted$1$AppOpsControllerImpl(IILjava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2, p3, v0}, notifySuscribers(IILjava/lang/String;Z)V
...
.method public onOpActiveChanged(IILjava/lang/String;Z)V
    ...
    invoke-direct {p0, p1, p2, p3, p4}, updateActives(IILjava/lang/String;Z)Z
    ...
    iget-object v0, p0, mBGHandler:Lcom/android/systemui/appops/AppOpsControllerImpl$H;
...
.method public onOpNoted(IILjava/lang/String;I)V
    ...
    :cond_0
    invoke-direct {p0, p1, p2, p3}, addNoted(IILjava/lang/String;)Z
    ...
    :cond_1
    iget-object p4, p0, mActiveItems:Ljava/util/List;
    ...
    iget-object p4, p0, mBGHandler:Lcom/android/systemui/appops/AppOpsControllerImpl$H;
...
.method protected setListening(Z)V
    ...
    iget-object p1, p0, mAppOps:Landroid/app/AppOpsManager;

    sget-object v0, OPS:[I
    ...
    iget-object p1, p0, mBGHandler:Lcom/android/systemui/appops/AppOpsControllerImpl$H;

    const/4 v0, 0x0

    invoke-virtual {p1, v0}, Landroid/os/Handler;->removeCallbacksAndMessages(Ljava/lang/Object;)V

    iget-object p1, p0, mActiveItems:Ljava/util/List;
    ...
    :try_start_1
    iget-object p0, p0, mNotedItems:Ljava/util/List;
