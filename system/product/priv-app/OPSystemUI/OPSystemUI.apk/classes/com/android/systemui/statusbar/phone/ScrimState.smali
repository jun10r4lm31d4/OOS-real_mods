...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v2, v1, v3}, <init>(Ljava/lang/String;II)V

    sput-object v0, UNINITIALIZED:Lcom/android/systemui/statusbar/phone/ScrimState;
    ...
    sput-object v0, KEYGUARD:Lcom/android/systemui/statusbar/phone/ScrimState;
    ...
    sput-object v0, BOUNCER:Lcom/android/systemui/statusbar/phone/ScrimState;
    ...
    sput-object v0, BOUNCER_SCRIMMED:Lcom/android/systemui/statusbar/phone/ScrimState;
    ...
    sput-object v0, BRIGHTNESS_MIRROR:Lcom/android/systemui/statusbar/phone/ScrimState;
    ...
    sput-object v0, AOD:Lcom/android/systemui/statusbar/phone/ScrimState;
    ...
    sput-object v0, PULSING:Lcom/android/systemui/statusbar/phone/ScrimState;
    ...
    sput-object v0, UNLOCKED:Lcom/android/systemui/statusbar/phone/ScrimState;
    ...
    sput-object v0, BUBBLE_EXPANDED:Lcom/android/systemui/statusbar/phone/ScrimState;
    ...
    sput-object v0, BOUNCER_TO_KEYGUARD:Lcom/android/systemui/statusbar/phone/ScrimState;

    const/16 v0, 0xa

    new-array v0, v0, [Lcom/android/systemui/statusbar/phone/ScrimState;

    sget-object v11, UNINITIALIZED:Lcom/android/systemui/statusbar/phone/ScrimState;

    aput-object v11, v0, v1

    sget-object v1, KEYGUARD:Lcom/android/systemui/statusbar/phone/ScrimState;

    aput-object v1, v0, v2

    sget-object v1, BOUNCER:Lcom/android/systemui/statusbar/phone/ScrimState;

    aput-object v1, v0, v3

    sget-object v1, BOUNCER_SCRIMMED:Lcom/android/systemui/statusbar/phone/ScrimState;

    aput-object v1, v0, v4

    sget-object v1, BRIGHTNESS_MIRROR:Lcom/android/systemui/statusbar/phone/ScrimState;

    aput-object v1, v0, v5

    sget-object v1, AOD:Lcom/android/systemui/statusbar/phone/ScrimState;

    aput-object v1, v0, v6

    sget-object v1, PULSING:Lcom/android/systemui/statusbar/phone/ScrimState;

    aput-object v1, v0, v7

    sget-object v1, UNLOCKED:Lcom/android/systemui/statusbar/phone/ScrimState;

    aput-object v1, v0, v8

    sget-object v1, BUBBLE_EXPANDED:Lcom/android/systemui/statusbar/phone/ScrimState;

    aput-object v1, v0, v9

    sget-object v1, BOUNCER_TO_KEYGUARD:Lcom/android/systemui/statusbar/phone/ScrimState;

    aput-object v1, v0, v10

    sput-object v0, $VALUES:[Lcom/android/systemui/statusbar/phone/ScrimState;
...
.method private constructor <init>(Ljava/lang/String;II)V
    ...
    iput-boolean p1, p0, mBlankScreen:Z

    const-wide/16 v0, 0xdc

    iput-wide v0, p0, mAnimationDuration:J

    iput p1, p0, mCurrentInFrontTint:I

    iput p1, p0, mCurrentBehindTint:I

    const/4 p1, 0x1

    iput-boolean p1, p0, mAnimateChange:Z
...
.method synthetic constructor <init>(Ljava/lang/String;IILcom/android/systemui/statusbar/phone/ScrimState$1;)V
    ...
    invoke-direct {p0, p1, p2, p3}, <init>(Ljava/lang/String;II)V
...
.method public static values()[Lcom/android/systemui/statusbar/phone/ScrimState;
    ...
    sget-object v0, $VALUES:[Lcom/android/systemui/statusbar/phone/ScrimState;
...
.method public getAnimateChange()Z
    ...
    iget-boolean p0, p0, mAnimateChange:Z
...
.method public getAnimationDuration()J
    ...
    iget-wide v0, p0, mAnimationDuration:J
...
.method public getBlanksScreen()Z
    ...
    iget-boolean p0, p0, mBlankScreen:Z
...
.method public init(Lcom/android/systemui/statusbar/ScrimView;Lcom/android/systemui/statusbar/ScrimView;Lcom/android/systemui/statusbar/phone/DozeParameters;)V
    ...
    iput-object p1, p0, mScrimInFront:Lcom/android/systemui/statusbar/ScrimView;

    iput-object p2, p0, mScrimBehind:Lcom/android/systemui/statusbar/ScrimView;

    iput-object p3, p0, mDozeParameters:Lcom/android/systemui/statusbar/phone/DozeParameters;

    invoke-virtual {p3}, Lcom/android/systemui/statusbar/phone/DozeParameters;->getDisplayNeedsBlanking()Z

    move-result p1

    iput-boolean p1, p0, mDisplayRequiresBlanking:Z
...
.method public setAodFrontScrimAlpha(F)V
    ...
    iput p1, p0, mAodFrontScrimAlpha:F
...
.method public setHasBackdrop(Z)V
    ...
    iput-boolean p1, p0, mHasBackdrop:Z
...
.method public setLaunchingAffordanceWithPreview(Z)V
    ...
    iput-boolean p1, p0, mLaunchingAffordanceWithPreview:Z
...
.method public setScrimBehindAlphaKeyguard(F)V
    ...
    iput p1, p0, mScrimBehindAlphaKeyguard:F
...
.method public setWakeLockScreenSensorActive(Z)V
    ...
    iput-boolean p1, p0, mWakeLockScreenSensorActive:Z
