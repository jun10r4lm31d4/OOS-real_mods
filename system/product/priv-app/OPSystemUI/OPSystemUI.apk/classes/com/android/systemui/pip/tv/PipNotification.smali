...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mPipManager:Lcom/android/systemui/pip/tv/PipManager;
    ...
    iput-object v0, p0, mPipListener:Lcom/android/systemui/pip/tv/PipManager$Listener;
    ...
    iput-object v0, p0, mMediaControllerCallback:Landroid/media/session/MediaController$Callback;
    ...
    iput-object v0, p0, mPipMediaListener:Lcom/android/systemui/pip/tv/PipManager$MediaListener;
    ...
    iput-object v0, p0, mEventReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-static {p1, v2}, createPendingIntent(Landroid/content/Context;Ljava/lang/String;)Landroid/app/PendingIntent;
    ...
    invoke-static {p1, v3}, createPendingIntent(Landroid/content/Context;Ljava/lang/String;)Landroid/app/PendingIntent;
    ...
    iget-object v1, p0, mPipListener:Lcom/android/systemui/pip/tv/PipManager$Listener;
    ...
    iget-object v1, p0, mEventReceiver:Landroid/content/BroadcastReceiver;

    invoke-virtual {p1, v1, v0}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    invoke-virtual {p0, p1}, onConfigurationChanged(Landroid/content/Context;)V
...
.method static synthetic access$000(Lcom/android/systemui/pip/tv/PipNotification;)Z
    ...
    invoke-direct {p0}, updateMediaControllerMetadata()Z
...
.method static synthetic access$100(Lcom/android/systemui/pip/tv/PipNotification;)V
    ...
    invoke-direct {p0}, notifyPipNotification()V
...
.method static synthetic access$200(Lcom/android/systemui/pip/tv/PipNotification;)V
    ...
    invoke-direct {p0}, dismissPipNotification()V
...
.method static synthetic access$300(Lcom/android/systemui/pip/tv/PipNotification;)Z
    ...
    iget-boolean p0, p0, mNotified:Z
...
.method private dismissPipNotification()V
    ...
    iput-boolean v0, p0, mNotified:Z

    iget-object p0, p0, mNotificationManager:Landroid/app/NotificationManager;

    sget-object v0, NOTIFICATION_TAG:Ljava/lang/String;
...
.method private notifyPipNotification()V
    ...
    iget-object v1, p0, mNotificationBuilder:Landroid/app/Notification$Builder;
    ...
    iget v1, p0, mDefaultIconResId:I
    ...
    :cond_0
    iget-object v1, p0, mDefaultTitle:Ljava/lang/String;

    :goto_0
    invoke-virtual {v0, v1}, Landroid/app/Notification$Builder;->setContentTitle(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    iget-object v0, p0, mArt:Landroid/graphics/Bitmap;
    ...
    iget-object v2, p0, mArt:Landroid/graphics/Bitmap;
    ...
    sget-object v1, NOTIFICATION_TAG:Ljava/lang/String;

    const/16 v2, 0x44c

    iget-object p0, p0, mNotificationBuilder:Landroid/app/Notification$Builder;
...
.method private updateMediaControllerMetadata()Z
    ...
    iput-object v0, p0, mArt:Landroid/graphics/Bitmap;
...
.method onConfigurationChanged(Landroid/content/Context;)V
    ...
    iput-object p1, p0, mDefaultTitle:Ljava/lang/String;

    sget p1, Lcom/android/systemui/R$drawable;->pip_icon:I

    iput p1, p0, mDefaultIconResId:I

    iget-boolean p1, p0, mNotified:Z
