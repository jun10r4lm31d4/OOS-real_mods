...
.method public constructor <init>(Landroid/content/Context;Landroid/app/IActivityManager;Landroid/app/IActivityTaskManager;Lcom/android/systemui/pip/phone/PipMenuActivityController;Lcom/android/systemui/shared/system/InputConsumerController;)V
    ...
    iput-object v0, p0, mMenuListener:Lcom/android/systemui/pip/phone/PipTouchHandler$PipMenuListener;

    const/4 v0, 0x0

    iput-boolean v0, p0, mShowPipMenuOnAnimationEnd:Z

    new-instance v1, Landroid/graphics/Rect;

    invoke-direct {v1}, Landroid/graphics/Rect;-><init>()V

    iput-object v1, p0, mMovementBounds:Landroid/graphics/Rect;

    new-instance v1, Landroid/graphics/Rect;

    invoke-direct {v1}, Landroid/graphics/Rect;-><init>()V

    iput-object v1, p0, mInsetBounds:Landroid/graphics/Rect;

    new-instance v1, Landroid/graphics/Rect;

    invoke-direct {v1}, Landroid/graphics/Rect;-><init>()V

    iput-object v1, p0, mNormalBounds:Landroid/graphics/Rect;

    new-instance v1, Landroid/graphics/Rect;

    invoke-direct {v1}, Landroid/graphics/Rect;-><init>()V

    iput-object v1, p0, mNormalMovementBounds:Landroid/graphics/Rect;

    new-instance v1, Landroid/graphics/Rect;

    invoke-direct {v1}, Landroid/graphics/Rect;-><init>()V

    iput-object v1, p0, mExpandedBounds:Landroid/graphics/Rect;

    new-instance v1, Landroid/graphics/Rect;

    invoke-direct {v1}, Landroid/graphics/Rect;-><init>()V

    iput-object v1, p0, mExpandedMovementBounds:Landroid/graphics/Rect;

    const/4 v1, -0x1

    iput v1, p0, mDeferResizeToNormalBoundsUntilRotation:I
    ...
    iput-object v1, p0, mShowDismissAffordance:Ljava/lang/Runnable;
    ...
    iput-object v1, p0, mUpdateScrimListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;

    iput v0, p0, mMenuState:I

    const/high16 v1, -0x40800000    # -1.0f

    iput v1, p0, mSavedSnapFraction:F

    new-instance v1, Landroid/graphics/Rect;

    invoke-direct {v1}, Landroid/graphics/Rect;-><init>()V

    iput-object v1, p0, mTmpBounds:Landroid/graphics/Rect;
    ...
    iput-object v1, p0, mDefaultMovementGesture:Lcom/android/systemui/pip/phone/PipTouchGesture;

    iput-object p1, p0, mContext:Landroid/content/Context;

    iput-object p2, p0, mActivityManager:Landroid/app/IActivityManager;

    iput-object p3, p0, mActivityTaskManager:Landroid/app/IActivityTaskManager;
    ...
    iput-object p2, p0, mViewConfig:Landroid/view/ViewConfiguration;

    iput-object p4, p0, mMenuController:Lcom/android/systemui/pip/phone/PipMenuActivityController;

    iget-object p2, p0, mMenuController:Lcom/android/systemui/pip/phone/PipMenuActivityController;

    iget-object p3, p0, mMenuListener:Lcom/android/systemui/pip/phone/PipTouchHandler$PipMenuListener;
    ...
    iput-object p2, p0, mDismissViewController:Lcom/android/systemui/pip/phone/PipDismissViewController;
    ...
    iput-object p2, p0, mSnapAlgorithm:Lcom/android/internal/policy/PipSnapAlgorithm;
    ...
    iget-object p3, p0, mDefaultMovementGesture:Lcom/android/systemui/pip/phone/PipTouchGesture;

    aput-object p3, p2, v0

    iput-object p2, p0, mGestures:[Lcom/android/systemui/pip/phone/PipTouchGesture;
    ...
    iget-object v4, p0, mActivityTaskManager:Landroid/app/IActivityTaskManager;

    iget-object v5, p0, mMenuController:Lcom/android/systemui/pip/phone/PipMenuActivityController;

    iget-object v6, p0, mSnapAlgorithm:Lcom/android/internal/policy/PipSnapAlgorithm;

    iget-object v7, p0, mFlingAnimationUtils:Lcom/android/systemui/statusbar/FlingAnimationUtils;
    ...
    iput-object p2, p0, mMotionHelper:Lcom/android/systemui/pip/phone/PipMotionHelper;

    new-instance p2, Lcom/android/systemui/pip/phone/PipTouchState;

    iget-object p3, p0, mViewConfig:Landroid/view/ViewConfiguration;

    iget-object p4, p0, mHandler:Landroid/os/Handler;
    ...
    iput-object p2, p0, mTouchState:Lcom/android/systemui/pip/phone/PipTouchState;
    ...
    iput p2, p0, mExpandedShortestEdgeSize:I
    ...
    iput-boolean p1, p0, mEnableDimissDragToEdge:Z
    ...
    invoke-direct {p0, p1}, onRegistrationChanged(Z)V
...
.method static synthetic access$100(Lcom/android/systemui/pip/phone/PipTouchHandler;)Z
    ...
    iget-boolean p0, p0, mEnableDimissDragToEdge:Z
...
.method static synthetic access$1000(Lcom/android/systemui/pip/phone/PipTouchHandler;)Landroid/app/IActivityManager;
    ...
    iget-object p0, p0, mActivityManager:Landroid/app/IActivityManager;
...
.method static synthetic access$1100(Lcom/android/systemui/pip/phone/PipTouchHandler;)Z
    ...
    invoke-direct {p0}, willResizeMenu()Z
...
.method static synthetic access$1200(Lcom/android/systemui/pip/phone/PipTouchHandler;)Lcom/android/systemui/pip/phone/PipMenuActivityController;
    ...
    iget-object p0, p0, mMenuController:Lcom/android/systemui/pip/phone/PipMenuActivityController;
...
.method static synthetic access$1300(Lcom/android/systemui/pip/phone/PipTouchHandler;)Z
    ...
    iget-boolean p0, p0, mMovementWithinMinimize:Z
...
.method static synthetic access$1302(Lcom/android/systemui/pip/phone/PipTouchHandler;Z)Z
    ...
    iput-boolean p1, p0, mMovementWithinMinimize:Z
...
.method static synthetic access$1400(Lcom/android/systemui/pip/phone/PipTouchHandler;)Z
    ...
    iget-boolean p0, p0, mMovementWithinDismiss:Z
...
.method static synthetic access$1402(Lcom/android/systemui/pip/phone/PipTouchHandler;Z)Z
    ...
    iput-boolean p1, p0, mMovementWithinDismiss:Z
...
.method static synthetic access$1600(Lcom/android/systemui/pip/phone/PipTouchHandler;)Ljava/lang/Runnable;
    ...
    iget-object p0, p0, mShowDismissAffordance:Ljava/lang/Runnable;
...
.method static synthetic access$1802(Lcom/android/systemui/pip/phone/PipTouchHandler;F)F
    ...
    iput p1, p0, mSavedSnapFraction:F
...
.method static synthetic access$200(Lcom/android/systemui/pip/phone/PipTouchHandler;)Lcom/android/systemui/pip/phone/PipDismissViewController;
    ...
    iget-object p0, p0, mDismissViewController:Lcom/android/systemui/pip/phone/PipDismissViewController;
...
.method static synthetic access$2000(Lcom/android/systemui/pip/phone/PipTouchHandler;)V
    ...
    invoke-direct {p0}, cleanUpDismissTarget()V
...
.method static synthetic access$2200(Lcom/android/systemui/pip/phone/PipTouchHandler;)Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    iget-object p0, p0, mUpdateScrimListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
...
.method static synthetic access$2300(Lcom/android/systemui/pip/phone/PipTouchHandler;)Lcom/android/systemui/pip/phone/PipTouchState;
    ...
    iget-object p0, p0, mTouchState:Lcom/android/systemui/pip/phone/PipTouchState;
...
.method static synthetic access$300(Lcom/android/systemui/pip/phone/PipTouchHandler;)V
    ...
    invoke-direct {p0}, updateDismissFraction()V
...
.method static synthetic access$400(Lcom/android/systemui/pip/phone/PipTouchHandler;IZ)V
    ...
    invoke-direct {p0, p1, p2}, setMenuState(IZ)V
...
.method static synthetic access$500(Lcom/android/systemui/pip/phone/PipTouchHandler;)Z
    ...
    iget-boolean p0, p0, mIsMinimized:Z
...
.method static synthetic access$600(Lcom/android/systemui/pip/phone/PipTouchHandler;)Lcom/android/systemui/pip/phone/PipMotionHelper;
    ...
    iget-object p0, p0, mMotionHelper:Lcom/android/systemui/pip/phone/PipMotionHelper;
...
.method static synthetic access$700(Lcom/android/systemui/pip/phone/PipTouchHandler;Z)V
    ...
    invoke-direct {p0, p1}, setMinimizedStateInternal(Z)V
...
.method static synthetic access$800(Lcom/android/systemui/pip/phone/PipTouchHandler;)Landroid/graphics/Rect;
    ...
    iget-object p0, p0, mMovementBounds:Landroid/graphics/Rect;
...
.method private cleanUp()V
    ...
    iget-boolean v0, p0, mIsMinimized:Z

    if-eqz v0, :cond_0

    const/4 v0, 0x0

    invoke-direct {p0, v0}, setMinimizedStateInternal(Z)V
...
.method private cleanUpDismissTarget()V
    ...
    iget-object v1, p0, mShowDismissAffordance:Ljava/lang/Runnable;
...
.method private handleTouchEvent(Landroid/view/InputEvent;)Z
    ...
    :cond_0
    iget-object v0, p0, mPinnedStackController:Landroid/view/IPinnedStackController;
    ...
    iget-object v0, p0, mTouchState:Lcom/android/systemui/pip/phone/PipTouchState;
    ...
    iget-boolean p1, p0, mSendingHoverAccessibilityEvents:Z
    ...
    iput-boolean v0, p0, mSendingHoverAccessibilityEvents:Z
    ...
    iput-boolean v1, p0, mSendingHoverAccessibilityEvents:Z

    goto :goto_4

    :cond_4
    iget-object p1, p0, mGestures:[Lcom/android/systemui/pip/phone/PipTouchGesture;
    ...
    iget-object v5, p0, mTouchState:Lcom/android/systemui/pip/phone/PipTouchState;
    ...
    :cond_6
    iget p1, p0, mMenuState:I

    invoke-direct {p0, p1}, updateMovementBounds(I)V
    ...
    :cond_8
    :goto_2
    iget-object p1, p0, mTouchState:Lcom/android/systemui/pip/phone/PipTouchState;
    ...
    :cond_9
    iget-object p1, p0, mMotionHelper:Lcom/android/systemui/pip/phone/PipMotionHelper;
...
.method public static synthetic lambda$1nY3kLe318Fm3UtIAbDmSK80h7w(Lcom/android/systemui/pip/phone/PipTouchHandler;)V
    ...
    invoke-direct {p0}, onAccessibilityShowMenu()V
...
.method public static synthetic lambda$A78OVgVs8H_2SG6WUxzMSclOdX0(Lcom/android/systemui/pip/phone/PipTouchHandler;Landroid/view/InputEvent;)Z
    ...
    invoke-direct {p0, p1}, handleTouchEvent(Landroid/view/InputEvent;)Z
...
.method private onAccessibilityShowMenu()V
    ...
    iget-object v0, p0, mMenuController:Lcom/android/systemui/pip/phone/PipMenuActivityController;

    iget-object v1, p0, mMotionHelper:Lcom/android/systemui/pip/phone/PipMotionHelper;

    invoke-virtual {v1}, Lcom/android/systemui/pip/phone/PipMotionHelper;->getBounds()Landroid/graphics/Rect;

    move-result-object v2

    iget-object v3, p0, mMovementBounds:Landroid/graphics/Rect;
...
.method private onRegistrationChanged(Z)V
    ...
    iget-object v2, p0, mMotionHelper:Lcom/android/systemui/pip/phone/PipMotionHelper;
...
.method private setMenuState(IZ)V
    ...
    iget-object p2, p0, mMotionHelper:Lcom/android/systemui/pip/phone/PipMotionHelper;

    iget-object v3, p0, mMovementBounds:Landroid/graphics/Rect;

    iget-object v4, p0, mExpandedMovementBounds:Landroid/graphics/Rect;
    ...
    iput p2, p0, mSavedSnapFraction:F
    ...
    iget p2, p0, mDeferResizeToNormalBoundsUntilRotation:I
    ...
    :try_start_0
    iget-object p2, p0, mPinnedStackController:Landroid/view/IPinnedStackController;

    invoke-interface {p2}, Landroid/view/IPinnedStackController;->getDisplayRotation()I

    move-result p2

    iget v4, p0, mDisplayRotation:I

    if-eq v4, p2, :cond_1

    iput p2, p0, mDeferResizeToNormalBoundsUntilRotation:I
    :try_end_0
    ...
    iget-object p2, p0, mNormalBounds:Landroid/graphics/Rect;

    invoke-direct {v5, p2}, Landroid/graphics/Rect;-><init>(Landroid/graphics/Rect;)V

    iget-object v4, p0, mMotionHelper:Lcom/android/systemui/pip/phone/PipMotionHelper;

    iget v6, p0, mSavedSnapFraction:F

    iget-object v7, p0, mNormalMovementBounds:Landroid/graphics/Rect;

    iget-object v8, p0, mMovementBounds:Landroid/graphics/Rect;

    iget-boolean v9, p0, mIsMinimized:Z
    ...
    iput v2, p0, mSavedSnapFraction:F

    goto :goto_1

    :cond_2
    invoke-virtual {p0, v0}, setTouchEnabled(Z)V

    iput v2, p0, mSavedSnapFraction:F

    :cond_3
    :goto_1
    iput p1, p0, mMenuState:I
...
.method private updateDismissFraction()V
    ...
    iget-boolean v0, p0, mIsImeShowing:Z

    if-nez v0, :cond_2

    iget-object v0, p0, mMotionHelper:Lcom/android/systemui/pip/phone/PipMotionHelper;

    invoke-virtual {v0}, Lcom/android/systemui/pip/phone/PipMotionHelper;->getBounds()Landroid/graphics/Rect;

    move-result-object v0

    iget-object v1, p0, mInsetBounds:Landroid/graphics/Rect;
    ...
    iget-object v1, p0, mMenuController:Lcom/android/systemui/pip/phone/PipMenuActivityController;
...
.method private updateMovementBounds(I)V
    ...
    iget-object v1, p0, mExpandedMovementBounds:Landroid/graphics/Rect;

    goto :goto_1

    :cond_1
    iget-object v1, p0, mNormalMovementBounds:Landroid/graphics/Rect;

    :goto_1
    iput-object v1, p0, mMovementBounds:Landroid/graphics/Rect;

    :try_start_0
    iget-object v1, p0, mPinnedStackController:Landroid/view/IPinnedStackController;
    ...
    iget v0, p0, mExpandedShortestEdgeSize:I
...
.method private willResizeMenu()Z
    ...
    iget-object v1, p0, mNormalBounds:Landroid/graphics/Rect;
    ...
    iget-object p0, p0, mNormalBounds:Landroid/graphics/Rect;
...
.method public dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    iget-object v1, p0, mMovementBounds:Landroid/graphics/Rect;
    ...
    iget-boolean v1, p0, mIsMinimized:Z
    ...
    iget-boolean v1, p0, mIsImeShowing:Z
    ...
    iget-boolean v1, p0, mIsShelfShowing:Z
    ...
    iget v1, p0, mSavedSnapFraction:F
    ...
    iget-boolean v1, p0, mEnableDimissDragToEdge:Z
    ...
    iget-object p2, p0, mSnapAlgorithm:Lcom/android/internal/policy/PipSnapAlgorithm;

    invoke-virtual {p2, p1, v0}, Lcom/android/internal/policy/PipSnapAlgorithm;->dump(Ljava/io/PrintWriter;Ljava/lang/String;)V

    iget-object p2, p0, mTouchState:Lcom/android/systemui/pip/phone/PipTouchState;
...
.method public onImeVisibilityChanged(ZI)V
    ...
    iput-boolean p1, p0, mIsImeShowing:Z

    iput p2, p0, mImeHeight:I
...
.method public onMovementBoundsChanged(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;ZZI)V
    ...
    :goto_0
    iput-object p2, p0, mNormalBounds:Landroid/graphics/Rect;

    new-instance v2, Landroid/graphics/Rect;

    invoke-direct {v2}, Landroid/graphics/Rect;-><init>()V

    iget-object v3, p0, mSnapAlgorithm:Lcom/android/internal/policy/PipSnapAlgorithm;

    iget-object v4, p0, mNormalBounds:Landroid/graphics/Rect;
    ...
    iget-object v5, p0, mSnapAlgorithm:Lcom/android/internal/policy/PipSnapAlgorithm;

    iget v6, p0, mExpandedShortestEdgeSize:I
    ...
    iget-object v4, p0, mExpandedBounds:Landroid/graphics/Rect;
    ...
    iget-object v4, p0, mSnapAlgorithm:Lcom/android/internal/policy/PipSnapAlgorithm;

    iget-object v5, p0, mExpandedBounds:Landroid/graphics/Rect;
    ...
    :goto_1
    iget-boolean v4, p0, mIsImeShowing:Z

    if-nez v4, :cond_2

    iget-boolean v4, p0, mIsShelfShowing:Z
    ...
    :cond_3
    iget-object p4, p0, mTouchState:Lcom/android/systemui/pip/phone/PipTouchState;
    ...
    iget-object p5, p0, mContext:Landroid/content/Context;
    ...
    iget v4, p0, mMovementBoundsExtraOffsets:I
    ...
    iget-object p4, p0, mMotionHelper:Lcom/android/systemui/pip/phone/PipMotionHelper;
    ...
    :cond_7
    :goto_4
    iput-object v2, p0, mNormalMovementBounds:Landroid/graphics/Rect;

    iput-object v3, p0, mExpandedMovementBounds:Landroid/graphics/Rect;

    iput p6, p0, mDisplayRotation:I

    iget-object p3, p0, mInsetBounds:Landroid/graphics/Rect;
    ...
    iput v0, p0, mMovementBoundsExtraOffsets:I

    iget p1, p0, mDeferResizeToNormalBoundsUntilRotation:I

    if-ne p1, p6, :cond_8

    iget-object v0, p0, mMotionHelper:Lcom/android/systemui/pip/phone/PipMotionHelper;

    iget v2, p0, mSavedSnapFraction:F

    iget-object v3, p0, mNormalMovementBounds:Landroid/graphics/Rect;

    iget-object v4, p0, mMovementBounds:Landroid/graphics/Rect;

    iget-boolean v5, p0, mIsMinimized:Z
    ...
    iput p1, p0, mDeferResizeToNormalBoundsUntilRotation:I
...
.method public onPinnedStackAnimationEnded()V
    ...
    iget-boolean v0, p0, mShowPipMenuOnAnimationEnd:Z
...
.method public onShelfVisibilityChanged(ZI)V
    ...
    iput-boolean p1, p0, mIsShelfShowing:Z

    iput p2, p0, mShelfHeight:I
...
.method setPinnedStackController(Landroid/view/IPinnedStackController;)V
    ...
    iput-object p1, p0, mPinnedStackController:Landroid/view/IPinnedStackController;
