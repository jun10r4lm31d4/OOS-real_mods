...
.method public constructor <init>(Landroid/graphics/Point;I)V
    ...
    iput-boolean v0, p0, mIndividualBubbleWithinDismissTarget:Z

    iput-boolean v0, p0, mAnimatingExpand:Z

    iput-boolean v0, p0, mAnimatingCollapse:Z

    iput-boolean v0, p0, mSpringingBubbleToTouch:Z

    iput-boolean v0, p0, mBubbleDraggedOutEnough:Z

    iput-object p1, p0, mDisplaySize:Landroid/graphics/Point;

    iput p2, p0, mExpandedViewPadding:I
...
.method private getXForChildAtIndex(I)F
    ...
    iget v0, p0, mBubblePaddingPx:F

    iget p0, p0, mBubbleSizePx:F
...
.method private startOrUpdateCollapseAnimation()V
    ...
    iget-object v1, p0, mCollapsePoint:Landroid/graphics/PointF;
...
.method private updateBubblePositions()V
    ...
    iget-boolean v0, p0, mAnimatingExpand:Z

    if-nez v0, :cond_2

    iget-boolean v0, p0, mAnimatingCollapse:Z
    ...
    iget-object v3, p0, mBubbleDraggingOut:Landroid/view/View;
    ...
    invoke-virtual {p0, v1}, getBubbleLeft(I)F
...
.method public collapseBackToStack(Landroid/graphics/PointF;Ljava/lang/Runnable;)V
    ...
    iput-object p2, p0, mAfterCollapse:Ljava/lang/Runnable;

    iput-object p1, p0, mCollapsePoint:Landroid/graphics/PointF;

    invoke-direct {p0}, startOrUpdateCollapseAnimation()V
...
.method public demagnetizeBubbleTo(FFFF)V
    ...
    iput-boolean v1, p0, mSpringingBubbleToTouch:Z

    iget-object v1, p0, mBubbleDraggingOut:Landroid/view/View;
...
.method public dismissDraggedOutBubble(Landroid/view/View;Ljava/lang/Runnable;)V
    ...
    invoke-direct {p0}, updateBubblePositions()V
...
.method public dragBubbleOut(Landroid/view/View;FF)V
    ...
    iget-boolean v0, p0, mSpringingBubbleToTouch:Z
    ...
    iget-object v0, p0, mBubbleDraggingOut:Landroid/view/View;
    ...
    :cond_0
    iput-boolean v2, p0, mSpringingBubbleToTouch:Z
    ...
    iget-boolean v0, p0, mIndividualBubbleWithinDismissTarget:Z
    ...
    :cond_2
    invoke-virtual {p0}, getExpandedY()F

    move-result p1

    iget p2, p0, mBubbleSizePx:F
    ...
    :cond_4
    :goto_1
    iget-boolean p1, p0, mBubbleDraggedOutEnough:Z

    if-eq v1, p1, :cond_5

    invoke-direct {p0}, updateBubblePositions()V

    iput-boolean v1, p0, mBubbleDraggedOutEnough:Z
...
.method public expandFromStack(Ljava/lang/Runnable;)V
    ...
    iput-object p1, p0, mAfterExpand:Ljava/lang/Runnable;

    invoke-direct {p0}, startOrUpdateExpandAnimation()V
...
.method public getBubbleLeft(I)F
    ...
    iget v0, p0, mBubbleSizePx:F

    iget v1, p0, mBubblePaddingPx:F

    add-float/2addr v0, v1

    mul-float/2addr p1, v0

    invoke-direct {p0}, getRowLeft()F
...
.method public getDraggedOutBubble()Landroid/view/View;
    ...
    iget-object p0, p0, mBubbleDraggingOut:Landroid/view/View;
...
.method public getExpandedY()F
    ...
    iget v2, p0, mBubblePaddingPx:F

    iget p0, p0, mStatusBarHeight:F
...
.method public synthetic lambda$startOrUpdateCollapseAnimation$2$ExpandedAnimationController(FILcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;)V
    ...
    iget-object v0, p0, mCollapsePoint:Landroid/graphics/PointF;
...
.method public synthetic lambda$startOrUpdateCollapseAnimation$3$ExpandedAnimationController()V
    ...
    iget-object v0, p0, mAfterCollapse:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mAfterCollapse:Ljava/lang/Runnable;
...
.method public synthetic lambda$startOrUpdateExpandAnimation$0$ExpandedAnimationController(ILcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;)V
    ...
    invoke-virtual {p0, p1}, getBubbleLeft(I)F
...
.method public synthetic lambda$startOrUpdateExpandAnimation$1$ExpandedAnimationController()V
    ...
    iget-object v0, p0, mAfterExpand:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mAfterExpand:Ljava/lang/Runnable;
...
.method onActiveControllerForLayout(Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;)V
    ...
    iput p1, p0, mPipDismissHeight:F
...
.method onChildAdded(Landroid/view/View;I)V
    ...
    :cond_1
    invoke-direct {p0, p2}, getXForChildAtIndex(I)F
...
.method onChildRemoved(Landroid/view/View;ILjava/lang/Runnable;)V
    ...
    iput-object p1, p0, mBubbleDraggingOut:Landroid/view/View;
...
.method public onGestureFinished()V
    ...
    iput-object v0, p0, mBubbleDraggingOut:Landroid/view/View;
...
.method public snapBubbleBack(Landroid/view/View;FF)V
    ...
    invoke-virtual {p0, v0}, getBubbleLeft(I)F
