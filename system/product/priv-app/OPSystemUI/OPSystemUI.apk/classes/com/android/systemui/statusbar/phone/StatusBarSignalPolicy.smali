...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/statusbar/phone/StatusBarIconController;)V
    ...
    iput-boolean v0, p0, mIsAirplaneMode:Z

    iput-boolean v0, p0, mWifiVisible:Z

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, mMobileStates:Ljava/util/ArrayList;
    ...
    iput-object v1, p0, mWifiIconState:Lcom/android/systemui/statusbar/phone/StatusBarSignalPolicy$WifiIconState;

    const/4 v1, 0x1

    iput-boolean v1, p0, mShowNoSim:Z

    iput-boolean v0, p0, mCTA:Z

    iput-boolean v0, p0, mIsVoWifiEnable:Z

    iput-boolean v0, p0, mIsVoLteEnable:Z

    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    iput-object v2, p0, mLTEIconStates:Ljava/util/List;
    ...
    iput-object v2, p0, mBlockLTE:[Z

    const/4 v2, 0x0

    iput-object v2, p0, mBlackList:Ljava/lang/String;
    ...
    iput-object v2, p0, mProvisionState:[I
    ...
    iput-object v2, p0, mSlotAirplane:Ljava/lang/String;
    ...
    iput-object v2, p0, mSlotMobile:Ljava/lang/String;
    ...
    iput-object v2, p0, mSlotWifi:Ljava/lang/String;
    ...
    iput-object v2, p0, mSlotEthernet:Ljava/lang/String;
    ...
    iput-object v2, p0, mSlotVpn:Ljava/lang/String;
    ...
    iput-boolean v2, p0, mActivityEnabled:Z

    invoke-static {p1}, Lcom/oneplus/util/OpUtils;->hasCtaFeature(Landroid/content/Context;)Z

    move-result p1

    iput-boolean p1, p0, mCTA:Z

    iget-boolean p1, p0, mShowNoSim:Z

    if-nez p1, :cond_0

    iget-boolean p1, p0, mCTA:Z
    ...
    :cond_1
    iput-boolean v0, p0, mShowNoSim:Z
    ...
    iput-object p1, p0, mNetworkController:Lcom/android/systemui/statusbar/policy/NetworkController;
    ...
    iput-object p1, p0, mSecurityController:Lcom/android/systemui/statusbar/policy/SecurityController;
    ...
    iget-object p1, p0, mNetworkController:Lcom/android/systemui/statusbar/policy/NetworkController;
    ...
    iget-object p1, p0, mSecurityController:Lcom/android/systemui/statusbar/policy/SecurityController;
...
.method private dumpMobileStates()V
    ...
    :goto_0
    iget-object v1, p0, mMobileStates:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, mMobileStates:Ljava/util/ArrayList;
...
.method private getFirstMobileState()Lcom/android/systemui/statusbar/phone/StatusBarSignalPolicy$MobileIconState;
    ...
    iget-object v0, p0, mMobileStates:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, mMobileStates:Ljava/util/ArrayList;
...
.method private hasCorrectSubs(Ljava/util/List;)Z
    ...
    iget-object v3, p0, mMobileStates:Ljava/util/ArrayList;
...
.method private initLTEIcon()V
    ...
    iget-object v0, p0, mLTEIconStates:Ljava/util/List;
    ...
    iget-object v5, p0, mLTEIconStates:Ljava/util/List;
...
.method private isDataDisable(I)Z
    ...
    iget-object p0, p0, mProvisionState:[I
...
.method private updateShowWifiSignalSpacer(Lcom/android/systemui/statusbar/phone/StatusBarSignalPolicy$WifiIconState;)V
    ...
    invoke-direct {p0}, getFirstMobileState()Lcom/android/systemui/statusbar/phone/StatusBarSignalPolicy$MobileIconState;
...
.method private updateVpn()V
    ...
    iget-object p0, p0, mSlotVpn:Ljava/lang/String;
...
.method private updateWifiIconWithState(Lcom/android/systemui/statusbar/phone/StatusBarSignalPolicy$WifiIconState;)V
    ...
    iget-object v1, p0, mSlotWifi:Ljava/lang/String;
    ...
    iget-object p0, p0, mSlotWifi:Ljava/lang/String;
...
.method public onTuningChanged(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    iput-object p2, p0, mBlackList:Ljava/lang/String;

    invoke-static {p2}, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->getIconBlacklist(Ljava/lang/String;)Landroid/util/ArraySet;

    move-result-object p1

    iget-object p2, p0, mSlotAirplane:Ljava/lang/String;

    invoke-virtual {p1, p2}, Landroid/util/ArraySet;->contains(Ljava/lang/Object;)Z

    move-result p2

    iget-object v0, p0, mSlotMobile:Ljava/lang/String;
    ...
    iget-object v2, p0, mSlotEthernet:Ljava/lang/String;
    ...
    iget-boolean v4, p0, mBlockAirplane:Z
    ...
    iget-boolean v4, p0, mBlockMobile:Z

    if-ne v0, v4, :cond_2

    iget-boolean v4, p0, mBlockEthernet:Z

    if-ne v2, v4, :cond_2

    iget-boolean v4, p0, mBlockWifi:Z

    if-ne v1, v4, :cond_2

    iget-object v4, p0, mBlockLTE:[Z
    ...
    :cond_2
    iput-boolean p2, p0, mBlockAirplane:Z

    iput-boolean v0, p0, mBlockMobile:Z

    iput-boolean v2, p0, mBlockEthernet:Z

    if-nez v1, :cond_4

    iget-boolean p2, p0, mForceBlockWifi:Z
    ...
    :goto_1
    iput-boolean p2, p0, mBlockWifi:Z

    iget-object p2, p0, mBlockLTE:[Z
...
.method public setEthernetIndicators(Lcom/android/systemui/statusbar/policy/NetworkController$IconState;)V
    ...
    iget-boolean v0, p0, mBlockEthernet:Z
    ...
    iget-object p0, p0, mSlotEthernet:Ljava/lang/String;
...
.method public setIsAirplaneMode(Lcom/android/systemui/statusbar/policy/NetworkController$IconState;)V
    ...
    iget-boolean v0, p0, mBlockAirplane:Z
    ...
    iget-boolean v3, p0, mIsAirplaneMode:Z
    ...
    iget-object v4, p0, mSlotAirplane:Ljava/lang/String;
    ...
    iget-object v0, p0, mSlotAirplane:Ljava/lang/String;
    ...
    :goto_1
    iget-object p1, p0, mMobileStates:Ljava/util/ArrayList;
    ...
    iget-boolean v3, p0, mBlockMobile:Z
...
.method public setLTEStatus([Lcom/android/systemui/statusbar/policy/NetworkController$IconState;)V
    ...
    :goto_0
    iget-object v3, p0, mLTEIconStates:Ljava/util/List;
    ...
    iget-object v4, p0, mIconController:Lcom/android/systemui/statusbar/phone/StatusBarIconController;
    ...
    iget-object p0, p0, mLTEIconStates:Ljava/util/List;
...
.method public setMobileDataIndicators(Lcom/android/systemui/statusbar/policy/NetworkController$IconState;Lcom/android/systemui/statusbar/policy/NetworkController$IconState;IIZZI[I[ILjava/lang/String;Ljava/lang/String;ZIZZ)V
    ...
    invoke-direct {p0, p13}, getState(I)Lcom/android/systemui/statusbar/phone/StatusBarSignalPolicy$MobileIconState;
    ...
    iget-boolean p12, p0, mBlockMobile:Z
    ...
    iget-boolean p1, p0, mActivityEnabled:Z
    ...
    iget-object p2, p0, mSlotMobile:Ljava/lang/String;

    iget-object p3, p0, mMobileStates:Ljava/util/ArrayList;
    ...
    iget-object p1, p0, mWifiIconState:Lcom/android/systemui/statusbar/phone/StatusBarSignalPolicy$WifiIconState;
    ...
    invoke-direct {p0, p1}, updateShowWifiSignalSpacer(Lcom/android/systemui/statusbar/phone/StatusBarSignalPolicy$WifiIconState;)V

    iget-object p2, p0, mWifiIconState:Lcom/android/systemui/statusbar/phone/StatusBarSignalPolicy$WifiIconState;
    ...
    invoke-direct {p0, p1}, updateWifiIconWithState(Lcom/android/systemui/statusbar/phone/StatusBarSignalPolicy$WifiIconState;)V

    iput-object p1, p0, mWifiIconState:Lcom/android/systemui/statusbar/phone/StatusBarSignalPolicy$WifiIconState;
...
.method public setProvision(II)V
    ...
    invoke-direct {p0, p1}, getStateByPhoneId(I)Lcom/android/systemui/statusbar/phone/StatusBarSignalPolicy$MobileIconState;
    ...
    :cond_1
    invoke-direct {p0, p1}, isDataDisable(I)Z
...
.method public setSubs(Ljava/util/List;)V
    ...
    invoke-direct {p0, p1}, hasCorrectSubs(Ljava/util/List;)Z
    ...
    invoke-direct {p0}, initLTEIcon()V

    iget-object v1, p0, mIconController:Lcom/android/systemui/statusbar/phone/StatusBarIconController;

    iget-object v2, p0, mSlotMobile:Ljava/lang/String;
    ...
    :cond_3
    iget-boolean v2, p0, mShowNoSim:Z
    ...
    iget-object v7, p0, mMobileStates:Ljava/util/ArrayList;

    invoke-virtual {v7, v3}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-boolean v7, p0, mIsAirplaneMode:Z

    if-nez v7, :cond_6

    iget-boolean v7, p0, mBlockMobile:Z
    ...
    iget-object v1, p0, mSlotMobile:Ljava/lang/String;
    ...
    invoke-direct {p0}, dumpMobileStates()V
...
.method public setWifiIndicators(ZLcom/android/systemui/statusbar/policy/NetworkController$IconState;Lcom/android/systemui/statusbar/policy/NetworkController$IconState;ZZLjava/lang/String;ZLjava/lang/String;)V
    ...
    iget-boolean p1, p0, mBlockWifi:Z
    ...
    iget-boolean p4, p0, mActivityEnabled:Z
    ...
    iget-boolean p5, p0, mActivityEnabled:Z
    ...
    :goto_2
    iget-object p7, p0, mWifiIconState:Lcom/android/systemui/statusbar/phone/StatusBarSignalPolicy$WifiIconState;
    ...
    invoke-direct {p0, p7}, updateWifiIconWithState(Lcom/android/systemui/statusbar/phone/StatusBarSignalPolicy$WifiIconState;)V

    iput-object p7, p0, mWifiIconState:Lcom/android/systemui/statusbar/phone/StatusBarSignalPolicy$WifiIconState;
