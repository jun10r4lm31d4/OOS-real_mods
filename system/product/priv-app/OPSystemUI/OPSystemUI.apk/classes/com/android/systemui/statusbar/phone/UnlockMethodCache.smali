...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, mDebugUnlocked:Z
    ...
    iget-object v0, p0, mCallback:Lcom/android/keyguard/KeyguardUpdateMonitorCallback;
    ...
    invoke-direct {p0, p1}, update(Z)V
...
.method public static getInstance(Landroid/content/Context;)Lcom/android/systemui/statusbar/phone/UnlockMethodCache;
    ...
    sget-object v0, sInstance:Lcom/android/systemui/statusbar/phone/UnlockMethodCache;
    ...
    sput-object v0, sInstance:Lcom/android/systemui/statusbar/phone/UnlockMethodCache;

    :cond_0
    sget-object p0, sInstance:Lcom/android/systemui/statusbar/phone/UnlockMethodCache;
...
.method private update(Z)V
    ...
    iget-object v4, p0, mKeyguardUpdateMonitor:Lcom/android/keyguard/KeyguardUpdateMonitor;
    ...
    :goto_0
    iget-object v5, p0, mKeyguardUpdateMonitor:Lcom/android/keyguard/KeyguardUpdateMonitor;

    invoke-virtual {v5, v0}, Lcom/android/keyguard/KeyguardUpdateMonitor;->getUserTrustIsManaged(I)Z

    move-result v5

    iget-object v6, p0, mKeyguardUpdateMonitor:Lcom/android/keyguard/KeyguardUpdateMonitor;

    invoke-virtual {v6, v0}, Lcom/android/keyguard/KeyguardUpdateMonitor;->getUserHasTrust(I)Z

    move-result v0

    iget-boolean v6, p0, mSecure:Z

    if-ne v1, v6, :cond_1

    iget-boolean v6, p0, mCanSkipBouncer:Z

    if-ne v4, v6, :cond_1

    iget-boolean v6, p0, mTrustManaged:Z
    ...
    :cond_3
    iput-boolean v1, p0, mSecure:Z

    iput-boolean v4, p0, mCanSkipBouncer:Z

    iput-boolean v0, p0, mTrusted:Z

    iput-boolean v5, p0, mTrustManaged:Z
...
.method public canSkipBouncer()Z
    ...
    iget-boolean p0, p0, mCanSkipBouncer:Z
...
.method public isTrustManaged()Z
    ...
    iget-boolean p0, p0, mTrustManaged:Z
