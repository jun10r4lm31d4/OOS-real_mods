...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;Lcom/android/systemui/statusbar/policy/NextAlarmController;Lcom/android/systemui/statusbar/policy/ZenModeController;Lcom/android/systemui/statusbar/phone/StatusBarIconController;Lcom/android/systemui/plugins/ActivityStarter;)V
    ...
    iput-object p2, p0, mRingerReceiver:Landroid/content/BroadcastReceiver;

    const/4 p2, 0x0

    iput-boolean p2, p0, mHasTopCutout:Z

    iput-object p3, p0, mAlarmController:Lcom/android/systemui/statusbar/policy/NextAlarmController;

    iput-object p4, p0, mZenController:Lcom/android/systemui/statusbar/policy/ZenModeController;

    iput-object p5, p0, mStatusBarIconController:Lcom/android/systemui/statusbar/phone/StatusBarIconController;

    iput-object p6, p0, mActivityStarter:Lcom/android/systemui/plugins/ActivityStarter;
    ...
    iput-object p2, p0, mDualToneHandler:Lcom/android/systemui/DualToneHandler;
...
.method static synthetic access$100(Lcom/android/systemui/qs/QuickStatusBarHeader;)V
    ...
    invoke-direct {p0}, updateStatusText()V
...
.method private updateAlarmStatus()Z
    ...
    iget-object v0, p0, mNextAlarmTextView:Landroid/widget/TextView;
    ...
    :goto_0
    iget-object v3, p0, mNextAlarmTextView:Landroid/widget/TextView;

    invoke-virtual {v3}, Landroid/widget/TextView;->getText()Ljava/lang/CharSequence;

    move-result-object v3

    iget-object v4, p0, mNextAlarm:Landroid/app/AlarmManager$AlarmClockInfo;

    if-eqz v4, :cond_1

    iget-object v5, p0, mNextAlarmTextView:Landroid/widget/TextView;

    invoke-direct {p0, v4}, formatNextAlarm(Landroid/app/AlarmManager$AlarmClockInfo;)Ljava/lang/String;
    ...
    :goto_1
    iget-object v5, p0, mNextAlarmIcon:Landroid/widget/ImageView;
    ...
    iget-object v5, p0, mNextAlarmContainer:Landroid/view/View;
    ...
    iget-object p0, p0, mNextAlarmTextView:Landroid/widget/TextView;
...
.method private updateHeaderTextContainerAlphaAnimator()V
    ...
    iget-object v1, p0, mHeaderTextContainerView:Landroid/view/View;
    ...
    iput-object v0, p0, mHeaderTextContainerAlphaAnimator:Lcom/android/systemui/qs/TouchAnimator;
...
.method private updateResources()V
    ...
    invoke-direct {p0}, updateMinimumHeight()V
    ...
    iget-object v1, p0, mSystemIconsView:Landroid/view/View;
    ...
    iget-boolean v3, p0, mQsDisabled:Z
    ...
    invoke-direct {p0}, updateStatusIconAlphaAnimator()V

    invoke-direct {p0}, updateHeaderTextContainerAlphaAnimator()V
...
.method private updateRingerStatus()Z
    ...
    iget-object v0, p0, mRingerModeTextView:Landroid/widget/TextView;
    ...
    :goto_0
    iget-object v3, p0, mRingerModeTextView:Landroid/widget/TextView;
    ...
    iget-object v5, p0, mZenController:Lcom/android/systemui/statusbar/policy/ZenModeController;
    ...
    iget-object v4, p0, mRingerModeIcon:Landroid/widget/ImageView;

    sget v5, Lcom/android/systemui/R$drawable;->ic_volume_ringer_vibrate:I

    invoke-virtual {v4, v5}, Landroid/widget/ImageView;->setImageResource(I)V

    iget-object v4, p0, mRingerModeTextView:Landroid/widget/TextView;
    ...
    :goto_2
    iget-object v5, p0, mRingerModeIcon:Landroid/widget/ImageView;
    ...
    iget-object v5, p0, mRingerModeTextView:Landroid/widget/TextView;
    ...
    iget-object v5, p0, mRingerContainer:Landroid/view/View;
    ...
    iget-object p0, p0, mRingerModeTextView:Landroid/widget/TextView;
...
.method private updateStatusIconAlphaAnimator()V
    ...
    iget-object v1, p0, mQuickQsStatusIcons:Landroid/view/View;
    ...
    iput-object v0, p0, mStatusIconsAlphaAnimator:Lcom/android/systemui/qs/TouchAnimator;
...
.method private updateStatusText()V
    ...
    invoke-direct {p0}, updateRingerStatus()Z
    ...
    invoke-direct {p0}, updateAlarmStatus()Z
    ...
    :goto_3
    iget-object p0, p0, mStatusSeparator:Landroid/view/View;
...
.method private updateThemeColor()V
    ...
    iget-object v3, p0, mDateView:Lcom/android/systemui/statusbar/policy/DateView;

    invoke-virtual {v3, v2}, Landroid/widget/TextView;->setTextColor(I)V

    iget-object v3, p0, mNextAlarmIcon:Landroid/widget/ImageView;
    ...
    iget-object v3, p0, mStatusSeparator:Landroid/view/View;
    ...
    iget-object v3, p0, mRingerModeIcon:Landroid/widget/ImageView;
    ...
    iget-object v3, p0, mBatteryRemainingIcon:Lcom/android/systemui/BatteryMeterView;

    invoke-virtual {v3, v0, v1, v0}, Lcom/android/systemui/BatteryMeterView;->updateColors(III)V

    iget-object p0, p0, mIconManager:Lcom/android/systemui/statusbar/phone/StatusBarIconController$TintedIconManager;
...
.method public disable(IIZ)V
    ...
    :goto_0
    iget-boolean p2, p0, mQsDisabled:Z
    ...
    :cond_1
    iput-boolean p1, p0, mQsDisabled:Z

    iget-object p2, p0, mHeaderQsPanel:Lcom/android/systemui/qs/QuickQSPanel;

    invoke-virtual {p2, p1}, Lcom/android/systemui/qs/QuickQSPanel;->setDisabledByPolicy(Z)V

    iget-object p1, p0, mHeaderTextContainerView:Landroid/view/View;
    ...
    iget-object p1, p0, mQuickQsStatusIcons:Landroid/view/View;
    ...
    invoke-direct {p0}, updateResources()V
...
.method public onApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    iget-object v0, p0, mSystemIconsView:Landroid/view/View;
    ...
    :cond_0
    iget-object v2, p0, mSystemIconsView:Landroid/view/View;
...
.method public onAttachedToWindow()V
    ...
    iget-object v0, p0, mStatusBarIconController:Lcom/android/systemui/statusbar/phone/StatusBarIconController;

    iget-object v1, p0, mIconManager:Lcom/android/systemui/statusbar/phone/StatusBarIconController$TintedIconManager;
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object v0, p0, mClockView:Lcom/android/systemui/statusbar/policy/Clock;
    ...
    :cond_0
    iget-object v0, p0, mNextAlarmContainer:Landroid/view/View;
    ...
    iget-object p1, p0, mNextAlarm:Landroid/app/AlarmManager$AlarmClockInfo;
    ...
    iget-object p1, p0, mActivityStarter:Lcom/android/systemui/plugins/ActivityStarter;

    iget-object p0, p0, mNextAlarm:Landroid/app/AlarmManager$AlarmClockInfo;
    ...
    :cond_2
    iget-object v0, p0, mRingerContainer:Landroid/view/View;
    ...
    :cond_3
    iget-object p0, p0, mBatteryRemainingIcon:Lcom/android/systemui/BatteryMeterView;
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object p0, p0, mClockView:Lcom/android/systemui/statusbar/policy/Clock;
...
.method public onDetachedFromWindow()V
    ...
    invoke-virtual {p0, v0}, setListening(Z)V
...
.method protected onFinishInflate()V
    ...
    iput-object v0, p0, mHeaderQsPanel:Lcom/android/systemui/qs/QuickQSPanel;
    ...
    iput-object v0, p0, mSystemIconsView:Landroid/view/View;
    ...
    iput-object v0, p0, mQuickQsStatusIcons:Landroid/view/View;
    ...
    iput-object v2, p0, mIconManager:Lcom/android/systemui/statusbar/phone/StatusBarIconController$TintedIconManager;
    ...
    iput-object v0, p0, mHeaderTextContainerView:Landroid/view/View;
    ...
    iput-object v0, p0, mStatusSeparator:Landroid/view/View;
    ...
    iput-object v0, p0, mNextAlarmIcon:Landroid/widget/ImageView;
    ...
    iput-object v0, p0, mNextAlarmTextView:Landroid/widget/TextView;
    ...
    iput-object v0, p0, mNextAlarmContainer:Landroid/view/View;
    ...
    iput-object v0, p0, mRingerModeIcon:Landroid/widget/ImageView;
    ...
    iput-object v0, p0, mRingerModeTextView:Landroid/widget/TextView;
    ...
    iput-object v0, p0, mRingerContainer:Landroid/view/View;
    ...
    invoke-static {v1}, getColorIntensity(I)F

    move-result v1

    iget-object v2, p0, mDualToneHandler:Lcom/android/systemui/DualToneHandler;
    ...
    invoke-direct {p0, v2, v0, v3, v4}, applyDarkness(ILandroid/graphics/Rect;FI)V

    iget-object v0, p0, mIconManager:Lcom/android/systemui/statusbar/phone/StatusBarIconController$TintedIconManager;

    invoke-virtual {v0, v1}, Lcom/android/systemui/statusbar/phone/StatusBarIconController$TintedIconManager;->setTint(I)V

    iget-object v0, p0, mNextAlarmIcon:Landroid/widget/ImageView;
    ...
    iget-object v0, p0, mRingerModeIcon:Landroid/widget/ImageView;
    ...
    iput-object v0, p0, mClockView:Lcom/android/systemui/statusbar/policy/Clock;
    ...
    iput-object v0, p0, mDateView:Lcom/android/systemui/statusbar/policy/DateView;
    ...
    iput-object v0, p0, mBatteryRemainingIcon:Lcom/android/systemui/BatteryMeterView;

    iget-object v0, p0, mBatteryRemainingIcon:Lcom/android/systemui/BatteryMeterView;
    ...
    invoke-direct {p0}, updateThemeColor()V
...
.method public setCallback(Lcom/android/systemui/qs/QSDetail$Callback;)V
    ...
    iget-object p0, p0, mHeaderQsPanel:Lcom/android/systemui/qs/QuickQSPanel;
...
.method public setExpanded(Z)V
    ...
    iget-object v0, p0, mHeaderQsPanel:Lcom/android/systemui/qs/QuickQSPanel;

    invoke-virtual {v0, p1}, Lcom/android/systemui/qs/QSPanel;->setExpanded(Z)V

    invoke-virtual {p0}, updateEverything()V
...
.method public setExpansion(ZFF)V
    ...
    :cond_0
    iget-object v0, p0, mStatusIconsAlphaAnimator:Lcom/android/systemui/qs/TouchAnimator;
    ...
    :goto_0
    iget-object p1, p0, mHeaderTextContainerAlphaAnimator:Lcom/android/systemui/qs/TouchAnimator;
    ...
    iget-object p0, p0, mHeaderTextContainerView:Landroid/view/View;
...
.method public setListening(Z)V
    ...
    iget-object p1, p0, mAlarmController:Lcom/android/systemui/statusbar/policy/NextAlarmController;

    invoke-interface {p1, p0}, Lcom/android/systemui/statusbar/policy/CallbackController;->addCallback(Ljava/lang/Object;)V

    iget-object p1, p0, Landroid/widget/RelativeLayout;->mContext:Landroid/content/Context;

    iget-object p0, p0, mRingerReceiver:Landroid/content/BroadcastReceiver;
...
.method public setMargins(I)V
    ...
    iget-object v2, p0, mQuickQsStatusIcons:Landroid/view/View;

    if-eq v1, v2, :cond_1

    iget-object v2, p0, mHeaderQsPanel:Lcom/android/systemui/qs/QuickQSPanel;

    if-eq v1, v2, :cond_1

    iget-object v2, p0, mHeaderTextContainerView:Landroid/view/View;
...
.method public setQSPanel(Lcom/android/systemui/qs/QSPanel;)V
    ...
    invoke-virtual {p0, p1}, setupHost(Lcom/android/systemui/qs/QSTileHost;)V
...
.method public setupHost(Lcom/android/systemui/qs/QSTileHost;)V
    ...
    iget-object v1, p0, mQsPanel:Lcom/android/systemui/qs/QSPanel;
