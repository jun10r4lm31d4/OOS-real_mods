...
.method public constructor <init>(Landroid/content/Context;Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, p2, v0}, <init>(Landroid/content/Context;Landroid/content/Context;Lcom/android/systemui/statusbar/notification/ImageGradientColorizer;)V
...
.method constructor <init>(Landroid/content/Context;Landroid/content/Context;Lcom/android/systemui/statusbar/notification/ImageGradientColorizer;)V
    ...
    iput-object v0, p0, mBlackWhiteFilter:Landroidx/palette/graphics/Palette$Filter;

    iput-object p1, p0, mContext:Landroid/content/Context;

    iput-object p2, p0, mPackageContext:Landroid/content/Context;

    iput-object p3, p0, mColorizer:Lcom/android/systemui/statusbar/notification/ImageGradientColorizer;
...
.method private static findBackgroundSwatch(Landroidx/palette/graphics/Palette;)Landroidx/palette/graphics/Palette$Swatch;
    ...
    invoke-static {v1}, isWhiteOrBlack([F)Z
    ...
    invoke-static {v4}, isWhiteOrBlack([F)Z
...
.method private static isWhiteOrBlack([F)Z
    ...
    invoke-static {p0}, isBlack([F)Z

    move-result v0

    if-nez v0, :cond_1

    invoke-static {p0}, isWhite([F)Z
...
.method static synthetic lambda$new$0(I[F)Z
    ...
    invoke-static {p1}, isWhiteOrBlack([F)Z
...
.method private selectForegroundColor(ILandroidx/palette/graphics/Palette;)I
    ...
    invoke-direct/range {v0 .. v6}, selectForegroundColorForSwatches(Landroidx/palette/graphics/Palette$Swatch;Landroidx/palette/graphics/Palette$Swatch;Landroidx/palette/graphics/Palette$Swatch;Landroidx/palette/graphics/Palette$Swatch;Landroidx/palette/graphics/Palette$Swatch;I)I
...
.method private selectForegroundColorForSwatches(Landroidx/palette/graphics/Palette$Swatch;Landroidx/palette/graphics/Palette$Swatch;Landroidx/palette/graphics/Palette$Swatch;Landroidx/palette/graphics/Palette$Swatch;Landroidx/palette/graphics/Palette$Swatch;I)I
    ...
    invoke-direct {p0, p1, p2}, selectVibrantCandidate(Landroidx/palette/graphics/Palette$Swatch;Landroidx/palette/graphics/Palette$Swatch;)Landroidx/palette/graphics/Palette$Swatch;

    move-result-object p1

    if-nez p1, :cond_0

    invoke-direct {p0, p4, p3}, selectMutedCandidate(Landroidx/palette/graphics/Palette$Swatch;Landroidx/palette/graphics/Palette$Swatch;)Landroidx/palette/graphics/Palette$Swatch;
    ...
    :cond_3
    invoke-direct {p0, p5}, hasEnoughPopulation(Landroidx/palette/graphics/Palette$Swatch;)Z
...
.method private selectMutedCandidate(Landroidx/palette/graphics/Palette$Swatch;Landroidx/palette/graphics/Palette$Swatch;)Landroidx/palette/graphics/Palette$Swatch;
    ...
    invoke-direct {p0, p1}, hasEnoughPopulation(Landroidx/palette/graphics/Palette$Swatch;)Z

    move-result v0

    invoke-direct {p0, p2}, hasEnoughPopulation(Landroidx/palette/graphics/Palette$Swatch;)Z
...
.method public processNotification(Landroid/app/Notification;Landroid/app/Notification$Builder;)V
    ...
    iget-object v2, p0, mPackageContext:Landroid/content/Context;
    ...
    invoke-static {v4}, generateArtworkPaletteBuilder(Landroid/graphics/Bitmap;)Landroidx/palette/graphics/Palette$Builder;
    ...
    invoke-static {v3}, findBackgroundSwatch(Landroidx/palette/graphics/Palette;)Landroidx/palette/graphics/Palette$Swatch;
    ...
    :cond_1
    iget-object v3, p0, mBlackWhiteFilter:Landroidx/palette/graphics/Palette$Filter;
    ...
    invoke-direct {p0, v5, p1}, selectForegroundColor(ILandroidx/palette/graphics/Palette;)I
    ...
    :goto_0
    iget-object p1, p0, mColorizer:Lcom/android/systemui/statusbar/notification/ImageGradientColorizer;
