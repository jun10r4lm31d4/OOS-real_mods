...
.method public constructor <init>(Landroid/content/Context;Landroid/view/ViewStub;Lcom/android/systemui/statusbar/phone/KeyguardStatusBarView;Lcom/android/systemui/statusbar/phone/NotificationPanelView;)V
    ...
    iput-object p2, p0, mUserSwitcherContainer:Lcom/android/systemui/statusbar/policy/KeyguardUserSwitcher$Container;
    ...
    iput-object p2, p0, mBackground:Lcom/android/systemui/statusbar/policy/KeyguardUserSwitcherScrim;

    invoke-direct {p0}, reinflateViews()V

    iput-object p3, p0, mStatusBarView:Lcom/android/systemui/statusbar/phone/KeyguardStatusBarView;

    iget-object p2, p0, mStatusBarView:Lcom/android/systemui/statusbar/phone/KeyguardStatusBarView;
    ...
    iput-object p2, p0, mAdapter:Lcom/android/systemui/statusbar/policy/KeyguardUserSwitcher$Adapter;

    iget-object p2, p0, mAdapter:Lcom/android/systemui/statusbar/policy/KeyguardUserSwitcher$Adapter;

    iget-object p3, p0, mDataSetObserver:Landroid/database/DataSetObserver;
    ...
    iput-object p2, p0, mAppearAnimationUtils:Lcom/android/settingslib/animation/AppearAnimationUtils;

    iget-object p1, p0, mUserSwitcherContainer:Lcom/android/systemui/statusbar/policy/KeyguardUserSwitcher$Container;
    ...
    iput-object p1, p0, mUserSwitcherContainer:Lcom/android/systemui/statusbar/policy/KeyguardUserSwitcher$Container;

    iput-object p1, p0, mStatusBarView:Lcom/android/systemui/statusbar/phone/KeyguardStatusBarView;

    iput-object p1, p0, mAdapter:Lcom/android/systemui/statusbar/policy/KeyguardUserSwitcher$Adapter;

    iput-object p1, p0, mAppearAnimationUtils:Lcom/android/settingslib/animation/AppearAnimationUtils;

    iput-object p1, p0, mBackground:Lcom/android/systemui/statusbar/policy/KeyguardUserSwitcherScrim;
...
.method static synthetic access$000(Lcom/android/systemui/statusbar/policy/KeyguardUserSwitcher;)Landroid/view/ViewGroup;
    ...
    iget-object p0, p0, mUserSwitcher:Landroid/view/ViewGroup;
...
.method static synthetic access$102(Lcom/android/systemui/statusbar/policy/KeyguardUserSwitcher;Landroid/animation/ObjectAnimator;)Landroid/animation/ObjectAnimator;
    ...
    iput-object p1, p0, mBgAnimator:Landroid/animation/ObjectAnimator;
...
.method static synthetic access$300(Lcom/android/systemui/statusbar/policy/KeyguardUserSwitcher;)Lcom/android/systemui/statusbar/policy/KeyguardUserSwitcher$Container;
    ...
    iget-object p0, p0, mUserSwitcherContainer:Lcom/android/systemui/statusbar/policy/KeyguardUserSwitcher$Container;
...
.method private cancelAnimations()V
    ...
    iget-object v0, p0, mUserSwitcher:Landroid/view/ViewGroup;
    ...
    iget-object v3, p0, mUserSwitcher:Landroid/view/ViewGroup;
    ...
    :cond_0
    iget-object v0, p0, mBgAnimator:Landroid/animation/ObjectAnimator;
...
.method private hide(Z)Z
    ...
    iget-object v0, p0, mUserSwitcherContainer:Lcom/android/systemui/statusbar/policy/KeyguardUserSwitcher$Container;
    ...
    invoke-direct {p0}, startDisappearAnimation()V
    ...
    :goto_0
    iget-object p0, p0, mStatusBarView:Lcom/android/systemui/statusbar/phone/KeyguardStatusBarView;
...
.method private refresh()V
    ...
    iget-object v1, p0, mAdapter:Lcom/android/systemui/statusbar/policy/KeyguardUserSwitcher$Adapter;
    ...
    iget-object v4, p0, mUserSwitcher:Landroid/view/ViewGroup;
    ...
    :cond_0
    iget-object v5, p0, mAdapter:Lcom/android/systemui/statusbar/policy/KeyguardUserSwitcher$Adapter;

    iget-object v6, p0, mUserSwitcher:Landroid/view/ViewGroup;
    ...
    iget-object v5, p0, mUserSwitcher:Landroid/view/ViewGroup;
...
.method private reinflateViews()V
    ...
    iget-object v1, p0, mBackground:Lcom/android/systemui/statusbar/policy/KeyguardUserSwitcherScrim;
    ...
    iget-object v2, p0, mUserSwitcherContainer:Lcom/android/systemui/statusbar/policy/KeyguardUserSwitcher$Container;
    ...
    iput-object v0, p0, mUserSwitcher:Landroid/view/ViewGroup;
    ...
    iget-object p0, p0, mBackground:Lcom/android/systemui/statusbar/policy/KeyguardUserSwitcherScrim;
...
.method private shouldExpandByDefault()Z
    ...
    iget-object p0, p0, mUserSwitcherController:Lcom/android/systemui/statusbar/policy/UserSwitcherController;
...
.method private startAppearAnimation()V
    ...
    iget-object v0, p0, mAppearAnimationUtils:Lcom/android/settingslib/animation/AppearAnimationUtils;
    ...
    iget-object v0, p0, mBackground:Lcom/android/systemui/statusbar/policy/KeyguardUserSwitcherScrim;
    ...
    iput-object v0, p0, mBgAnimator:Landroid/animation/ObjectAnimator;
    ...
    iget-object p0, p0, mBgAnimator:Landroid/animation/ObjectAnimator;
...
.method public setKeyguard(ZZ)V
    ...
    invoke-direct {p0}, shouldExpandByDefault()Z

    move-result p1

    if-eqz p1, :cond_0

    invoke-virtual {p0, p2}, show(Z)V

    goto :goto_0

    :cond_0
    invoke-direct {p0, p2}, hide(Z)Z
...
.method public show(Z)V
    ...
    iget-object v0, p0, mAdapter:Lcom/android/systemui/statusbar/policy/KeyguardUserSwitcher$Adapter;
    ...
    iget-object v0, p0, mStatusBarView:Lcom/android/systemui/statusbar/phone/KeyguardStatusBarView;
    ...
    invoke-direct {p0}, startAppearAnimation()V
