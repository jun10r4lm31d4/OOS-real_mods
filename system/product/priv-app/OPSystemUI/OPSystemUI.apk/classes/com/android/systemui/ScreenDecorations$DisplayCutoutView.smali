...
.method public constructor <init>(Landroid/content/Context;ZLjava/lang/Runnable;Lcom/android/systemui/ScreenDecorations;)V
    ...
    iput-object p1, p0, mInfo:Landroid/view/DisplayInfo;

    new-instance p1, Landroid/graphics/Paint;

    invoke-direct {p1}, Landroid/graphics/Paint;-><init>()V

    iput-object p1, p0, mPaint:Landroid/graphics/Paint;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, mBounds:Ljava/util/List;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, mBoundingRect:Landroid/graphics/Rect;

    new-instance p1, Landroid/graphics/Path;

    invoke-direct {p1}, Landroid/graphics/Path;-><init>()V

    iput-object p1, p0, mBoundingPath:Landroid/graphics/Path;

    const/4 p1, 0x2

    new-array p1, p1, [I

    iput-object p1, p0, mLocation:[I

    const/high16 p1, -0x1000000

    iput p1, p0, mColor:I

    iput-boolean p2, p0, mInitialStart:Z

    iput-object p3, p0, mVisibilityChangedListener:Ljava/lang/Runnable;

    iput-object p4, p0, mDecorations:Lcom/android/systemui/ScreenDecorations;
...
.method private isStart()Z
    ...
    iget-boolean p0, p0, mInitialStart:Z
    ...
    :cond_2
    iget-boolean v1, p0, mInitialStart:Z
...
.method private localBounds(Landroid/graphics/Rect;)V
    ...
    invoke-direct {p0, v0}, getGravity(Landroid/view/DisplayCutout;)I

    move-result p0

    invoke-static {v1, v0, p0, p1}, boundsFromDirection(Landroid/content/Context;Landroid/view/DisplayCutout;ILandroid/graphics/Rect;)V
...
.method private update()V
    ...
    iget-object v0, p0, mDecorations:Lcom/android/systemui/ScreenDecorations;
    ...
    iget-object v0, p0, mBounds:Ljava/util/List;

    invoke-interface {v0}, Ljava/util/List;->clear()V

    iget-object v0, p0, mBoundingRect:Landroid/graphics/Rect;

    invoke-virtual {v0}, Landroid/graphics/Rect;->setEmpty()V

    iget-object v0, p0, mBoundingPath:Landroid/graphics/Path;
    ...
    invoke-direct {p0, v0}, localBounds(Landroid/graphics/Rect;)V

    invoke-direct {p0}, updateGravity()V

    invoke-direct {p0}, updateBoundingPath()V
...
.method private updateBoundingPath()V
    ...
    :goto_2
    iget-object v2, p0, mBoundingPath:Landroid/graphics/Path;
    ...
    iget-object v3, p0, mInfo:Landroid/view/DisplayInfo;

    iget v3, v3, Landroid/view/DisplayInfo;->rotation:I

    invoke-static {v3, v0, v1, v2}, transformPhysicalToLogicalCoordinates(IIILandroid/graphics/Matrix;)V

    iget-object p0, p0, mBoundingPath:Landroid/graphics/Path;
...
.method private updateGravity()V
    ...
    invoke-direct {p0, v1}, getGravity(Landroid/view/DisplayCutout;)I
...
.method public getInterceptRegion()Landroid/graphics/Region;
    ...
    iget-object v2, p0, mLocation:[I

    invoke-virtual {v0, v2}, Landroid/view/View;->getLocationOnScreen([I)V

    iget-object p0, p0, mLocation:[I
