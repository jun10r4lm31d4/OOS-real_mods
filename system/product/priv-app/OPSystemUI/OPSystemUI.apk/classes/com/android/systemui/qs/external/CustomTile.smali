...
.method private constructor <init>(Lcom/android/systemui/qs/QSTileHost;Ljava/lang/String;)V
    ...
    iput-object p2, p0, mTile:Landroid/service/quicksettings/Tile;

    invoke-direct {p0}, updateDefaultTileAndIcon()V
    ...
    iput-object p1, p0, mServiceManager:Lcom/android/systemui/qs/external/TileServiceManager;

    iget-object p1, p0, mServiceManager:Lcom/android/systemui/qs/external/TileServiceManager;
    ...
    iput-object p1, p0, mService:Landroid/service/quicksettings/IQSTileService;
...
.method public static create(Lcom/android/systemui/qs/QSTileHost;Ljava/lang/String;)Lcom/android/systemui/qs/external/CustomTile;
    ...
    invoke-direct {v0, p0, p1}, <init>(Lcom/android/systemui/qs/QSTileHost;Ljava/lang/String;)V
...
.method private isSystemApp(Landroid/content/pm/PackageManager;)Z
    ...
    iget-object p0, p0, mComponent:Landroid/content/ComponentName;
...
.method private updateDefaultTileAndIcon()V
    ...
    invoke-direct {p0, v1}, isSystemApp(Landroid/content/pm/PackageManager;)Z
    ...
    :goto_0
    iget-object v4, p0, mTile:Landroid/service/quicksettings/Tile;
    ...
    iget-object v7, p0, mDefaultIcon:Landroid/graphics/drawable/Icon;

    invoke-direct {p0, v4, v7}, iconEquals(Landroid/graphics/drawable/Icon;Landroid/graphics/drawable/Icon;)Z
    ...
    iget-object v7, p0, mComponent:Landroid/content/ComponentName;
    ...
    :goto_3
    iput-object v7, p0, mDefaultIcon:Landroid/graphics/drawable/Icon;
    ...
    iget-object v9, p0, mTile:Landroid/service/quicksettings/Tile;
    ...
    iget-object v3, p0, mDefaultIcon:Landroid/graphics/drawable/Icon;
    ...
    iget-object v3, p0, mTile:Landroid/service/quicksettings/Tile;

    iget-object v4, p0, mDefaultIcon:Landroid/graphics/drawable/Icon;
    ...
    iget-object v4, p0, mDefaultLabel:Ljava/lang/CharSequence;
    ...
    iput-object v1, p0, mDefaultLabel:Ljava/lang/CharSequence;

    if-eqz v5, :cond_a

    iget-object v1, p0, mTile:Landroid/service/quicksettings/Tile;

    iget-object v2, p0, mDefaultLabel:Ljava/lang/CharSequence;
    ...
    :catch_0
    iput-object v0, p0, mDefaultIcon:Landroid/graphics/drawable/Icon;

    iput-object v0, p0, mDefaultLabel:Ljava/lang/CharSequence;
...
.method public getLongClickIntent()Landroid/content/Intent;
    ...
    invoke-direct {p0, v0}, resolveIntent(Landroid/content/Intent;)Landroid/content/Intent;
    ...
    iget-object p0, p0, mTile:Landroid/service/quicksettings/Tile;
...
.method protected handleClick()V
    ...
    iget-object v0, p0, mTile:Landroid/service/quicksettings/Tile;
    ...
    iput-boolean v0, p0, mIsTokenGranted:Z
    :try_end_0
    ...
    :cond_2
    iget-object v1, p0, mServiceManager:Lcom/android/systemui/qs/external/TileServiceManager;
    ...
    :cond_4
    iget-object v0, p0, mService:Landroid/service/quicksettings/IQSTileService;
...
.method protected handleDestroy()V
    ...
    iget-boolean v0, p0, mIsTokenGranted:Z
...
.method public handleSetListening(Z)V
    ...
    iget-object p0, p0, mService:Landroid/service/quicksettings/IQSTileService;
    ...
    :cond_1
    iget-object p1, p0, mService:Landroid/service/quicksettings/IQSTileService;

    invoke-interface {p1}, Landroid/service/quicksettings/IQSTileService;->onStopListening()V

    iget-boolean p1, p0, mIsTokenGranted:Z

    const/4 v0, 0x0

    if-eqz p1, :cond_3

    iget-boolean p1, p0, mIsShowingDialog:Z
    :try_end_0
    ...
    :cond_2
    iget-object p1, p0, mWindowManager:Landroid/view/IWindowManager;
    ...
    :cond_3
    iput-boolean v0, p0, mIsShowingDialog:Z

    iget-object p0, p0, mServiceManager:Lcom/android/systemui/qs/external/TileServiceManager;
...
.method protected handleUpdateState(Lcom/android/systemui/plugins/qs/QSTile$State;Ljava/lang/Object;)V
    ...
    iget-object p2, p0, mTile:Landroid/service/quicksettings/Tile;

    invoke-virtual {p2}, Landroid/service/quicksettings/Tile;->getState()I

    move-result p2

    iget-object v0, p0, mServiceManager:Lcom/android/systemui/qs/external/TileServiceManager;
    ...
    iget-object p2, p0, mDefaultIcon:Landroid/graphics/drawable/Icon;
...
.method public isAvailable()Z
    ...
    iget-object p0, p0, mDefaultIcon:Landroid/graphics/drawable/Icon;
