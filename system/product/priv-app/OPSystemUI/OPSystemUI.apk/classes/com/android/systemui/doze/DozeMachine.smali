...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, ONEPLUS_DEBUG:Z
...
.method public constructor <init>(Lcom/android/systemui/doze/DozeMachine$Service;Landroid/hardware/display/AmbientDisplayConfiguration;Lcom/android/systemui/util/wakelock/WakeLock;)V
    ...
    iput-object v0, p0, mQueuedRequests:Ljava/util/ArrayList;

    sget-object v0, Lcom/android/systemui/doze/DozeMachine$State;->UNINITIALIZED:Lcom/android/systemui/doze/DozeMachine$State;

    iput-object v0, p0, mState:Lcom/android/systemui/doze/DozeMachine$State;

    const/4 v0, 0x0

    iput-boolean v0, p0, mWakeLockHeldForCurrentState:Z

    iput-object p1, p0, mDozeService:Lcom/android/systemui/doze/DozeMachine$Service;

    iput-object p2, p0, mConfig:Landroid/hardware/display/AmbientDisplayConfiguration;

    iput-object p3, p0, mWakeLock:Lcom/android/systemui/util/wakelock/WakeLock;
...
.method private performTransitionOnComponents(Lcom/android/systemui/doze/DozeMachine$State;Lcom/android/systemui/doze/DozeMachine$State;)V
    ...
    iget-object v0, p0, mParts:[Lcom/android/systemui/doze/DozeMachine$Part;
    ...
    sget-boolean v4, ONEPLUS_DEBUG:Z
    ...
    :cond_3
    iget-object p0, p0, mDozeService:Lcom/android/systemui/doze/DozeMachine$Service;
...
.method private requestState(Lcom/android/systemui/doze/DozeMachine$State;I)V
    ...
    iget-object v2, p0, mState:Lcom/android/systemui/doze/DozeMachine$State;
    ...
    :cond_0
    invoke-virtual {p0}, isExecutingTransition()Z

    move-result v0

    xor-int/lit8 v0, v0, 0x1

    iget-object v2, p0, mQueuedRequests:Ljava/util/ArrayList;

    invoke-virtual {v2, p1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    if-eqz v0, :cond_2

    iget-object p1, p0, mWakeLock:Lcom/android/systemui/util/wakelock/WakeLock;
    ...
    invoke-direct {p0, v2, p2}, transitionTo(Lcom/android/systemui/doze/DozeMachine$State;I)V
    ...
    iget-object v3, p0, mQueuedRequests:Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object p1, p0, mQueuedRequests:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, mQueuedRequests:Ljava/util/ArrayList;
...
.method private resolveIntermediateState(Lcom/android/systemui/doze/DozeMachine$State;)V
    ...
    :cond_0
    iget-object p1, p0, mConfig:Landroid/hardware/display/AmbientDisplayConfiguration;
    ...
    invoke-direct {p0, p1, v0}, transitionTo(Lcom/android/systemui/doze/DozeMachine$State;I)V
...
.method private transitionPolicy(Lcom/android/systemui/doze/DozeMachine$State;)Lcom/android/systemui/doze/DozeMachine$State;
    ...
    iget-object v0, p0, mState:Lcom/android/systemui/doze/DozeMachine$State;
    ...
    iget-object p0, p0, mState:Lcom/android/systemui/doze/DozeMachine$State;
...
.method private transitionTo(Lcom/android/systemui/doze/DozeMachine$State;I)V
    ...
    invoke-direct {p0, p1}, transitionPolicy(Lcom/android/systemui/doze/DozeMachine$State;)Lcom/android/systemui/doze/DozeMachine$State;
    ...
    :cond_0
    iget-object p1, p0, mState:Lcom/android/systemui/doze/DozeMachine$State;
    ...
    :cond_1
    invoke-direct {p0, v0}, validateTransition(Lcom/android/systemui/doze/DozeMachine$State;)V
    ...
    invoke-direct {p0, v0, p1, p2}, updatePulseReason(Lcom/android/systemui/doze/DozeMachine$State;Lcom/android/systemui/doze/DozeMachine$State;I)V

    invoke-direct {p0, p1, v0}, performTransitionOnComponents(Lcom/android/systemui/doze/DozeMachine$State;Lcom/android/systemui/doze/DozeMachine$State;)V

    invoke-direct {p0, v0}, updateWakeLockState(Lcom/android/systemui/doze/DozeMachine$State;)V

    invoke-direct {p0, v0}, resolveIntermediateState(Lcom/android/systemui/doze/DozeMachine$State;)V
...
.method private updateWakeLockState(Lcom/android/systemui/doze/DozeMachine$State;)V
    ...
    iget-boolean v0, p0, mWakeLockHeldForCurrentState:Z
    ...
    iput-boolean p1, p0, mWakeLockHeldForCurrentState:Z
...
.method private validateTransition(Lcom/android/systemui/doze/DozeMachine$State;)V
    ...
    iget-object v1, p0, mState:Lcom/android/systemui/doze/DozeMachine$State;
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    iget-object p0, p0, mParts:[Lcom/android/systemui/doze/DozeMachine$Part;
...
.method public requestPulse(I)V
    ...
    invoke-direct {p0, v0, p1}, requestState(Lcom/android/systemui/doze/DozeMachine$State;I)V
...
.method public requestState(Lcom/android/systemui/doze/DozeMachine$State;)V
    ...
    invoke-direct {p0, p1, v0}, requestState(Lcom/android/systemui/doze/DozeMachine$State;I)V
...
.method public setParts([Lcom/android/systemui/doze/DozeMachine$Part;)V
    ...
    iput-object p1, p0, mParts:[Lcom/android/systemui/doze/DozeMachine$Part;
