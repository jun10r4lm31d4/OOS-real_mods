...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mDisplayDisabled:Landroid/util/SparseArray;

    const/4 v0, -0x1

    iput v0, p0, mLastUpdatedImeDisplayId:I
    ...
    invoke-direct {p0, p1, p1, p1}, setDisabled(III)V
...
.method static synthetic access$200(Lcom/android/systemui/statusbar/CommandQueue;ILandroid/os/IBinder;IIZ)V
    ...
    invoke-direct/range {p0 .. p5}, handleShowImeButton(ILandroid/os/IBinder;IIZ)V
...
.method private getDisabled(I)Landroid/util/Pair;
    ...
    iget-object v0, p0, mDisplayDisabled:Landroid/util/SparseArray;
    ...
    iget-object p0, p0, mDisplayDisabled:Landroid/util/SparseArray;
...
.method private getDisabled1(I)I
    ...
    invoke-direct {p0, p1}, getDisabled(I)Landroid/util/Pair;
...
.method private handleShowImeButton(ILandroid/os/IBinder;IIZ)V
    ...
    iget v1, p0, mLastUpdatedImeDisplayId:I

    if-eq v1, p1, :cond_1

    if-eq v1, v0, :cond_1

    invoke-direct {p0}, sendImeInvisibleStatusForPrevNavBar()V
    ...
    :cond_2
    iput p1, p0, mLastUpdatedImeDisplayId:I
...
.method private sendImeInvisibleStatusForPrevNavBar()V
    ...
    iget v3, p0, mLastUpdatedImeDisplayId:I
...
.method public addCallback(Lcom/android/systemui/statusbar/CommandQueue$Callbacks;)V
    ...
    :goto_0
    iget-object v2, p0, mDisplayDisabled:Landroid/util/SparseArray;
    ...
    invoke-direct {p0, v2}, getDisabled1(I)I

    move-result v3

    invoke-direct {p0, v2}, getDisabled2(I)I
...
.method public bridge synthetic addCallback(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, addCallback(Lcom/android/systemui/statusbar/CommandQueue$Callbacks;)V
...
.method public appTransitionPending(I)V
    ...
    invoke-virtual {p0, p1, v0}, appTransitionPending(IZ)V
...
.method public appTransitionStarting(IJJ)V
    ...
    invoke-virtual/range {v0 .. v6}, appTransitionStarting(IJJZ)V
...
.method public disable(III)V
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, disable(IIIZ)V
...
.method public disable(IIIZ)V
    ...
    invoke-direct {p0, p1}, getDisabled1(I)I

    move-result v1

    invoke-direct {p0, p1}, getDisabled2(I)I
    ...
    :cond_1
    invoke-direct {p0, p1, p2, p3}, setDisabled(III)V
...
.method public onDisplayRemoved(I)V
    ...
    :try_start_0
    iget-object v1, p0, mDisplayDisabled:Landroid/util/SparseArray;
...
.method public panelsEnabled()Z
    ...
    invoke-direct {p0, v0}, getDisabled1(I)I

    move-result v1

    invoke-direct {p0, v0}, getDisabled2(I)I
...
.method public recomputeDisableFlags(IZ)V
    ...
    invoke-virtual {p0, p1, v1, v2, p2}, disable(IIIZ)V
...
.method public bridge synthetic removeCallback(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, removeCallback(Lcom/android/systemui/statusbar/CommandQueue$Callbacks;)V
...
.method public toggleWxBus()V
    ...
    const-string/jumbo v3, "toggleWxBus, callingPid:"
    ...
    :cond_0
    const-string p0, "CommandQueue"

    const-string/jumbo v0, "toggleWxBus, permission denied"
