...
.method static constructor <clinit>()V
    ...
    sput-object v0, POSITION:Landroid/util/FloatProperty;
...
.method private constructor <init>([Ljava/lang/Object;[Lcom/android/systemui/qs/TouchAnimator$KeyframeSet;FFLandroid/view/animation/Interpolator;Lcom/android/systemui/qs/TouchAnimator$Listener;)V
    ...
    iput-object p1, p0, mTargets:[Ljava/lang/Object;

    iput-object p2, p0, mKeyframeSets:[Lcom/android/systemui/qs/TouchAnimator$KeyframeSet;

    iput p3, p0, mStartDelay:F

    iput p4, p0, mEndDelay:F

    iget p1, p0, mEndDelay:F

    const/high16 p2, 0x3f800000    # 1.0f

    sub-float/2addr p2, p1

    iget p1, p0, mStartDelay:F

    sub-float/2addr p2, p1

    iput p2, p0, mSpan:F

    iput-object p5, p0, mInterpolator:Landroid/view/animation/Interpolator;

    iput-object p6, p0, mListener:Lcom/android/systemui/qs/TouchAnimator$Listener;
...
.method synthetic constructor <init>([Ljava/lang/Object;[Lcom/android/systemui/qs/TouchAnimator$KeyframeSet;FFLandroid/view/animation/Interpolator;Lcom/android/systemui/qs/TouchAnimator$Listener;Lcom/android/systemui/qs/TouchAnimator$1;)V
    ...
    invoke-direct/range {p0 .. p6}, <init>([Ljava/lang/Object;[Lcom/android/systemui/qs/TouchAnimator$KeyframeSet;FFLandroid/view/animation/Interpolator;Lcom/android/systemui/qs/TouchAnimator$Listener;)V
...
.method static synthetic access$100()Landroid/util/FloatProperty;
    ...
    sget-object v0, POSITION:Landroid/util/FloatProperty;
...
.method public setPosition(F)V
    ...
    :cond_1
    iget-object v3, p0, mListener:Lcom/android/systemui/qs/TouchAnimator$Listener;
    ...
    :cond_4
    iget-object v0, p0, mListener:Lcom/android/systemui/qs/TouchAnimator$Listener;
    ...
    :goto_1
    iget-object v1, p0, mTargets:[Ljava/lang/Object;

    array-length v2, v1

    if-ge v0, v2, :cond_7

    iget-object v2, p0, mKeyframeSets:[Lcom/android/systemui/qs/TouchAnimator$KeyframeSet;
