...
.method public constructor <init>(Lcom/android/systemui/statusbar/policy/DeviceProvisionedController;Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, mIsPowerLongPressWithAssistant:Z

    iput-boolean v0, p0, mIsPowerLongPressWithGoogleAssistant:Z
    ...
    iput-object v1, p0, mShowCallback:Lcom/android/internal/app/IVoiceInteractionSessionShowCallback;
    ...
    iput-object v1, p0, mHideRunnable:Ljava/lang/Runnable;

    iput-object p2, p0, mContext:Landroid/content/Context;

    iput-object p1, p0, mDeviceProvisionedController:Lcom/android/systemui/statusbar/policy/DeviceProvisionedController;
    ...
    iput-object p1, p0, mAssistUtils:Lcom/android/internal/app/AssistUtils;
    ...
    iput-object p1, p0, mAssistDisclosure:Lcom/android/systemui/assist/AssistDisclosure;
    ...
    iput-object p1, p0, mPhoneStateMonitor:Lcom/android/systemui/assist/PhoneStateMonitor;

    new-instance p1, Lcom/android/systemui/assist/AssistHandleBehaviorController;

    iget-object v1, p0, mAssistUtils:Lcom/android/internal/app/AssistUtils;
    ...
    iput-object p1, p0, mHandleController:Lcom/android/systemui/assist/AssistHandleBehaviorController;

    invoke-virtual {p0}, registerVoiceInteractionSessionListener()V
    ...
    iput-boolean v0, p0, mShouldEnableOrb:Z
    ...
    iput-object p1, p0, mUiController:Lcom/android/systemui/assist/AssistManager$UiController;
...
.method static synthetic access$100(Lcom/android/systemui/assist/AssistManager;)Lcom/android/systemui/assist/AssistOrbContainer;
    ...
    iget-object p0, p0, mView:Lcom/android/systemui/assist/AssistOrbContainer;
...
.method private getAssistInfo()Landroid/content/ComponentName;
    ...
    invoke-virtual {p0, v0}, getAssistInfoForUser(I)Landroid/content/ComponentName;
...
.method private isVoiceSessionRunning()Z
    ...
    iget-object p0, p0, mAssistUtils:Lcom/android/internal/app/AssistUtils;
...
.method private maybeSwapSearchIcon(Landroid/content/ComponentName;Z)V
    ...
    iget-object v0, p0, mView:Lcom/android/systemui/assist/AssistOrbContainer;
    ...
    invoke-virtual {p0, v0, p1, v1, p2}, replaceDrawable(Landroid/widget/ImageView;Landroid/content/ComponentName;Ljava/lang/String;Z)V
...
.method private showOrb(Landroid/content/ComponentName;Z)V
    ...
    invoke-direct {p0, p1, p2}, maybeSwapSearchIcon(Landroid/content/ComponentName;Z)V

    iget-boolean p1, p0, mShouldEnableOrb:Z

    if-eqz p1, :cond_0

    iget-boolean p1, p0, mIsPowerLongPressWithAssistant:Z

    if-nez p1, :cond_0

    iget-boolean p1, p0, mIsPowerLongPressWithGoogleAssistant:Z
...
.method private startAssistActivity(Landroid/os/Bundle;Landroid/content/ComponentName;)V
    ...
    invoke-virtual {p0}, showDisclosure()V
...
.method private startAssistInternal(Landroid/os/Bundle;Landroid/content/ComponentName;Z)V
    ...
    invoke-direct {p0, p1}, startVoiceInteractor(Landroid/os/Bundle;)V

    goto :goto_0

    :cond_0
    invoke-direct {p0, p1, p2}, startAssistActivity(Landroid/os/Bundle;Landroid/content/ComponentName;)V
...
.method private startVoiceInteractor(Landroid/os/Bundle;)V
    ...
    iget-object p0, p0, mShowCallback:Lcom/android/internal/app/IVoiceInteractionSessionShowCallback;
...
.method private toLoggingSubType(II)I
    ...
    iget-object p0, p0, mHandleController:Lcom/android/systemui/assist/AssistHandleBehaviorController;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object p1, p0, mInterestingConfigChanges:Lcom/android/settingslib/applications/InterestingConfigChanges;
    ...
    :cond_0
    iget-object p1, p0, mView:Lcom/android/systemui/assist/AssistOrbContainer;
    ...
    iget-object v2, p0, mView:Lcom/android/systemui/assist/AssistOrbContainer;
    ...
    iput-object v1, p0, mView:Lcom/android/systemui/assist/AssistOrbContainer;

    iget-object v1, p0, mView:Lcom/android/systemui/assist/AssistOrbContainer;
    ...
    invoke-direct {p0}, getLayoutParams()Landroid/view/WindowManager$LayoutParams;
    ...
    iget-object v3, p0, mView:Lcom/android/systemui/assist/AssistOrbContainer;
...
.method public onGestureCompletion(F)V
    ...
    iget-object p0, p0, mUiController:Lcom/android/systemui/assist/AssistManager$UiController;
...
.method public showDisclosure()V
    ...
    iget-boolean v0, p0, mIsPowerLongPressWithAssistant:Z

    if-nez v0, :cond_0

    iget-boolean v0, p0, mIsPowerLongPressWithGoogleAssistant:Z
    ...
    iget-object p0, p0, mAssistDisclosure:Lcom/android/systemui/assist/AssistDisclosure;
...
.method public startAssist(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0}, getAssistInfo()Landroid/content/ComponentName;
    ...
    iput-boolean v2, p0, mIsPowerLongPressWithAssistant:Z
    ...
    iput-boolean v2, p0, mIsPowerLongPressWithGoogleAssistant:Z

    iget-boolean v2, p0, mIsPowerLongPressWithGoogleAssistant:Z
    ...
    :cond_1
    iput-boolean v1, p0, mIsPowerLongPressWithAssistant:Z

    iput-boolean v1, p0, mIsPowerLongPressWithGoogleAssistant:Z

    :cond_2
    invoke-virtual {p0}, getVoiceInteractorComponentName()Landroid/content/ComponentName;
    ...
    invoke-direct {p0}, isVoiceSessionRunning()Z

    move-result v3

    if-nez v3, :cond_5

    invoke-virtual {p0}, shouldShowOrb()Z
    ...
    :cond_3
    invoke-direct {p0, v0, v2}, showOrb(Landroid/content/ComponentName;Z)V

    iget-object v3, p0, mView:Lcom/android/systemui/assist/AssistOrbContainer;

    iget-object v4, p0, mHideRunnable:Ljava/lang/Runnable;
    ...
    iget-object v5, p0, mHandleController:Lcom/android/systemui/assist/AssistHandleBehaviorController;

    invoke-virtual {v5}, Lcom/android/systemui/assist/AssistHandleBehaviorController;->onAssistantGesturePerformed()V

    :cond_7
    iget-object v5, p0, mPhoneStateMonitor:Lcom/android/systemui/assist/PhoneStateMonitor;
    ...
    invoke-direct {p0, v3, v5}, toLoggingSubType(II)I
    ...
    invoke-virtual {p0}, launchHeyTapVoiceAssist()V

    goto :goto_1

    :cond_8
    invoke-direct {p0, p1, v0, v2}, startAssistInternal(Landroid/os/Bundle;Landroid/content/ComponentName;Z)V
...
.method public toLoggingSubType(I)I
    ...
    iget-object v0, p0, mPhoneStateMonitor:Lcom/android/systemui/assist/PhoneStateMonitor;

    invoke-virtual {v0}, Lcom/android/systemui/assist/PhoneStateMonitor;->getPhoneState()I

    move-result v0

    invoke-direct {p0, p1, v0}, toLoggingSubType(II)I
