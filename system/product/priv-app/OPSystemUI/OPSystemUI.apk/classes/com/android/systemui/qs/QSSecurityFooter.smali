...
.method public constructor <init>(Lcom/android/systemui/qs/QSPanel;Landroid/content/Context;)V
    ...
    iput-object v0, p0, mCallback:Lcom/android/systemui/qs/QSSecurityFooter$Callback;

    iput-object v1, p0, mFooterTextContent:Ljava/lang/CharSequence;

    const/4 v0, 0x0

    iput-boolean v0, p0, mIsExpanding:Z

    iput-boolean v0, p0, mNeedToRefresh:Z
    ...
    iput-object v2, p0, mUpdateIcon:Ljava/lang/Runnable;
    ...
    iput-object v2, p0, mUpdateDisplayState:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mFooterText:Landroid/widget/TextView;
    ...
    iput-object v0, p0, mFooterIcon:Landroid/widget/ImageView;

    sget v0, Lcom/android/systemui/R$drawable;->ic_info_outline:I

    iput v0, p0, mFooterIconId:I
    ...
    iput-object p2, p0, mSecurityController:Lcom/android/systemui/statusbar/policy/SecurityController;
    ...
    iput-object p2, p0, mHandler:Lcom/android/systemui/qs/QSSecurityFooter$H;
    ...
    :goto_0
    iput-object v1, p0, mDivider:Landroid/view/View;
...
.method static synthetic access$1100(Lcom/android/systemui/qs/QSSecurityFooter;)V
    ...
    invoke-direct {p0}, handleRefreshState()V
...
.method static synthetic access$1200(Lcom/android/systemui/qs/QSSecurityFooter;)V
    ...
    invoke-direct {p0}, handleClick()V
...
.method static synthetic access$1400(Lcom/android/systemui/qs/QSSecurityFooter;)Landroid/app/AlertDialog;
    ...
    iget-object p0, p0, mDialog:Landroid/app/AlertDialog;
...
.method static synthetic access$300(Lcom/android/systemui/qs/QSSecurityFooter;)Landroid/widget/ImageView;
    ...
    iget-object p0, p0, mFooterIcon:Landroid/widget/ImageView;
...
.method static synthetic access$502(Lcom/android/systemui/qs/QSSecurityFooter;Z)Z
    ...
    iput-boolean p1, p0, mNeedToRefresh:Z
...
.method static synthetic access$600(Lcom/android/systemui/qs/QSSecurityFooter;)Ljava/lang/CharSequence;
    ...
    iget-object p0, p0, mFooterTextContent:Ljava/lang/CharSequence;
...
.method static synthetic access$700(Lcom/android/systemui/qs/QSSecurityFooter;)Landroid/widget/TextView;
    ...
    iget-object p0, p0, mFooterText:Landroid/widget/TextView;
...
.method static synthetic access$800(Lcom/android/systemui/qs/QSSecurityFooter;)Z
    ...
    iget-boolean p0, p0, mIsVisible:Z
...
.method static synthetic access$900(Lcom/android/systemui/qs/QSSecurityFooter;)Landroid/view/View;
    ...
    iget-object p0, p0, mRootView:Landroid/view/View;
...
.method private createDialog()V
    ...
    iget-object v0, v6, mSecurityController:Lcom/android/systemui/statusbar/policy/SecurityController;

    invoke-interface {v0}, Lcom/android/systemui/statusbar/policy/SecurityController;->isDeviceManaged()Z

    move-result v0

    iget-object v1, v6, mSecurityController:Lcom/android/systemui/statusbar/policy/SecurityController;

    invoke-interface {v1}, Lcom/android/systemui/statusbar/policy/SecurityController;->hasWorkProfile()Z

    move-result v1

    iget-object v2, v6, mSecurityController:Lcom/android/systemui/statusbar/policy/SecurityController;
    ...
    iget-object v3, v6, mSecurityController:Lcom/android/systemui/statusbar/policy/SecurityController;

    invoke-interface {v3}, Lcom/android/systemui/statusbar/policy/SecurityController;->hasCACertInCurrentUser()Z

    move-result v3

    iget-object v4, v6, mSecurityController:Lcom/android/systemui/statusbar/policy/SecurityController;

    invoke-interface {v4}, Lcom/android/systemui/statusbar/policy/SecurityController;->hasCACertInWorkProfile()Z

    move-result v4

    iget-object v5, v6, mSecurityController:Lcom/android/systemui/statusbar/policy/SecurityController;

    invoke-interface {v5}, Lcom/android/systemui/statusbar/policy/SecurityController;->isNetworkLoggingEnabled()Z

    move-result v5

    iget-object v7, v6, mSecurityController:Lcom/android/systemui/statusbar/policy/SecurityController;

    invoke-interface {v7}, Lcom/android/systemui/statusbar/policy/SecurityController;->getPrimaryVpnName()Ljava/lang/String;

    move-result-object v7

    iget-object v8, v6, mSecurityController:Lcom/android/systemui/statusbar/policy/SecurityController;
    ...
    iget-object v10, v6, mContext:Landroid/content/Context;

    invoke-direct {v9, v10}, Lcom/android/systemui/statusbar/phone/SystemUIDialog;-><init>(Landroid/content/Context;)V

    iput-object v9, v6, mDialog:Landroid/app/AlertDialog;

    iget-object v9, v6, mDialog:Landroid/app/AlertDialog;
    ...
    iget-object v12, v6, mContext:Landroid/content/Context;
    ...
    iget-object v11, v6, mDialog:Landroid/app/AlertDialog;

    invoke-virtual {v11, v9}, Landroid/app/AlertDialog;->setView(Landroid/view/View;)V

    iget-object v11, v6, mDialog:Landroid/app/AlertDialog;

    invoke-direct/range {p0 .. p0}, getPositiveButton()Ljava/lang/String;
    ...
    invoke-virtual {v6, v0, v2}, getManagementMessage(ZLjava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    iget-object v15, v6, mDialog:Landroid/app/AlertDialog;

    invoke-direct/range {p0 .. p0}, getSettingsButton()Ljava/lang/String;
    ...
    :goto_1
    invoke-virtual {v6, v0, v3, v4}, getCaCertsMessage(ZZZ)Ljava/lang/CharSequence;
    ...
    :goto_2
    invoke-virtual {v6, v5}, getNetworkLoggingMessage(Z)Ljava/lang/CharSequence;
    ...
    :goto_3
    invoke-virtual {v6, v0, v1, v7, v8}, getVpnMessage(ZZLjava/lang/String;Ljava/lang/String;)Ljava/lang/CharSequence;
    ...
    invoke-virtual/range {v0 .. v5}, configSubtitleVisibility(ZZZZLandroid/view/View;)V

    iget-object v0, v6, mDialog:Landroid/app/AlertDialog;
...
.method private handleClick()V
    ...
    invoke-virtual {p0}, showDeviceMonitoringDialog()V
...
.method private handleRefreshState()V
    ...
    :cond_3
    :goto_1
    iput-boolean v3, p0, mIsVisible:Z
    ...
    invoke-virtual/range {v1 .. v10}, getFooterText(ZZZZZLjava/lang/String;Ljava/lang/String;Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/CharSequence;

    move-result-object v0

    iput-object v0, p0, mFooterTextContent:Ljava/lang/CharSequence;
    ...
    iget-object v1, p0, mUpdateIcon:Ljava/lang/Runnable;
    ...
    iget-object v1, p0, mUpdateDisplayState:Ljava/lang/Runnable;

    invoke-virtual {v0, v1}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    iget-object v0, p0, mMainHandler:Landroid/os/Handler;

    iget-object p0, p0, mUpdateDisplayState:Ljava/lang/Runnable;
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    iget-object p2, p0, mDialog:Landroid/app/AlertDialog;
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object p0, p0, mHandler:Lcom/android/systemui/qs/QSSecurityFooter$H;
...
.method public setIsExpanding(Z)V
    ...
    :cond_0
    iput-boolean p1, p0, mIsExpanding:Z

    iget-boolean p1, p0, mIsExpanding:Z

    if-nez p1, :cond_1

    iget-boolean p1, p0, mNeedToRefresh:Z
    ...
    iget-object p1, p0, mMainHandler:Landroid/os/Handler;

    iget-object v0, p0, mUpdateDisplayState:Ljava/lang/Runnable;
...
.method public setListening(Z)V
    ...
    iget-object v0, p0, mCallback:Lcom/android/systemui/qs/QSSecurityFooter$Callback;

    invoke-interface {p1, v0}, Lcom/android/systemui/statusbar/policy/CallbackController;->addCallback(Ljava/lang/Object;)V

    invoke-virtual {p0}, refreshState()V
    ...
    iget-object p0, p0, mCallback:Lcom/android/systemui/qs/QSSecurityFooter$Callback;
...
.method public showDeviceMonitoringDialog()V
    ...
    invoke-direct {p0}, createDialog()V
...
.method public updateThemeColor()V
    ...
    iget-object v2, p0, mRootView:Landroid/view/View;

    invoke-virtual {v2, v0}, Landroid/view/View;->setBackgroundColor(I)V

    iget-object v0, p0, mFooterText:Landroid/widget/TextView;
