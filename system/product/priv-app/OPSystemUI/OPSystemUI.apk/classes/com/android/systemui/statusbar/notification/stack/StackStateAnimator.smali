...
.method static constructor <clinit>()V
    ...
    sput v0, ANIMATION_DURATION_HEADS_UP_APPEAR_CLOSED:I
...
.method public constructor <init>(Lcom/android/systemui/statusbar/notification/stack/NotificationStackScrollLayout;)V
    ...
    iput-object v0, p0, mTmpState:Lcom/android/systemui/statusbar/notification/stack/ExpandableViewState;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mNewEvents:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mNewAddChildren:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, mHeadsUpAppearChildren:Ljava/util/HashSet;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, mHeadsUpDisappearChildren:Ljava/util/HashSet;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, mAnimatorSet:Ljava/util/HashSet;

    new-instance v0, Ljava/util/Stack;

    invoke-direct {v0}, Ljava/util/Stack;-><init>()V

    iput-object v0, p0, mAnimationListenerPool:Ljava/util/Stack;
    ...
    iput-object v0, p0, mAnimationFilter:Lcom/android/systemui/statusbar/notification/stack/AnimationFilter;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mTransientViewsToRemove:Ljava/util/ArrayList;
    ...
    iput-object p1, p0, mHostLayout:Lcom/android/systemui/statusbar/notification/stack/NotificationStackScrollLayout;
    ...
    iput v0, p0, mGoToFullShadeAppearingTranslation:I
    ...
    iput p1, p0, mPulsingAppearingTranslation:I
    ...
    iput-object p1, p0, mAnimationProperties:Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;
...
.method static synthetic access$000(Lcom/android/systemui/statusbar/notification/stack/StackStateAnimator;)Lcom/android/systemui/statusbar/notification/stack/AnimationFilter;
    ...
    iget-object p0, p0, mAnimationFilter:Lcom/android/systemui/statusbar/notification/stack/AnimationFilter;
...
.method static synthetic access$100(Lcom/android/systemui/statusbar/notification/stack/StackStateAnimator;)Landroid/animation/AnimatorListenerAdapter;
    ...
    invoke-direct {p0}, getGlobalAnimationFinishedListener()Landroid/animation/AnimatorListenerAdapter;
...
.method static synthetic access$200(Lcom/android/systemui/statusbar/notification/stack/StackStateAnimator;)Ljava/util/ArrayList;
    ...
    iget-object p0, p0, mNewAddChildren:Ljava/util/ArrayList;
...
.method static synthetic access$300(Lcom/android/systemui/statusbar/notification/stack/StackStateAnimator;)Ljava/util/HashSet;
    ...
    iget-object p0, p0, mHeadsUpAppearChildren:Ljava/util/HashSet;
...
.method static synthetic access$400(Lcom/android/systemui/statusbar/notification/stack/StackStateAnimator;)Ljava/util/HashSet;
    ...
    iget-object p0, p0, mAnimatorSet:Ljava/util/HashSet;
...
.method static synthetic access$500(Lcom/android/systemui/statusbar/notification/stack/StackStateAnimator;)V
    ...
    invoke-direct {p0}, onAnimationFinished()V
...
.method static synthetic access$600(Lcom/android/systemui/statusbar/notification/stack/StackStateAnimator;)Ljava/util/Stack;
    ...
    iget-object p0, p0, mAnimationListenerPool:Ljava/util/Stack;
...
.method static synthetic access$702(Lcom/android/systemui/statusbar/notification/stack/StackStateAnimator;Landroid/animation/ValueAnimator;)Landroid/animation/ValueAnimator;
    ...
    iput-object p1, p0, mTopOverScrollAnimator:Landroid/animation/ValueAnimator;
...
.method static synthetic access$802(Lcom/android/systemui/statusbar/notification/stack/StackStateAnimator;Landroid/animation/ValueAnimator;)Landroid/animation/ValueAnimator;
    ...
    iput-object p1, p0, mBottomOverScrollAnimator:Landroid/animation/ValueAnimator;
...
.method private adaptDurationWhenGoingToFullShade(Lcom/android/systemui/statusbar/notification/row/ExpandableView;Lcom/android/systemui/statusbar/notification/stack/ExpandableViewState;ZI)V
    ...
    iget-object p2, p0, mAnimationFilter:Lcom/android/systemui/statusbar/notification/stack/AnimationFilter;
    ...
    iget p3, p0, mGoToFullShadeAppearingTranslation:I
    ...
    iget-object p0, p0, mAnimationProperties:Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;
...
.method private applyWithoutAnimation(Lcom/android/systemui/statusbar/notification/row/ExpandableView;Lcom/android/systemui/statusbar/notification/stack/ExpandableViewState;)Z
    ...
    iget-boolean v0, p0, mShadeExpanded:Z
    ...
    :cond_1
    iget-object v0, p0, mHeadsUpDisappearChildren:Ljava/util/HashSet;
...
.method private calculateChildAnimationDelay(Lcom/android/systemui/statusbar/notification/stack/ExpandableViewState;I)J
    ...
    iget-object v0, p0, mAnimationFilter:Lcom/android/systemui/statusbar/notification/stack/AnimationFilter;

    iget-boolean v1, v0, Lcom/android/systemui/statusbar/notification/stack/AnimationFilter;->hasGoToFullShadeEvent:Z

    if-eqz v1, :cond_0

    invoke-direct {p0, p1, p2}, calculateDelayGoToFullShade(Lcom/android/systemui/statusbar/notification/stack/ExpandableViewState;I)J
    ...
    iget-object p2, p0, mNewEvents:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, mHostLayout:Lcom/android/systemui/statusbar/notification/stack/NotificationStackScrollLayout;
...
.method private getGlobalAnimationFinishedListener()Landroid/animation/AnimatorListenerAdapter;
    ...
    iget-object v0, p0, mAnimationListenerPool:Ljava/util/Stack;
...
.method private initAnimationProperties(Lcom/android/systemui/statusbar/notification/row/ExpandableView;Lcom/android/systemui/statusbar/notification/stack/ExpandableViewState;I)V
    ...
    iget-object v0, p0, mAnimationProperties:Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;
    ...
    iget-object v1, p0, mAnimationProperties:Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;

    iget-wide v2, p0, mCurrentLength:J

    iput-wide v2, v1, Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;->duration:J

    invoke-direct {p0, p1, p2, v0, p3}, adaptDurationWhenGoingToFullShade(Lcom/android/systemui/statusbar/notification/row/ExpandableView;Lcom/android/systemui/statusbar/notification/stack/ExpandableViewState;ZI)V
    ...
    :cond_0
    iget-object p1, p0, mAnimationProperties:Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;

    iget-wide v0, p0, mCurrentAdditionalDelay:J

    invoke-direct {p0, p2, p3}, calculateChildAnimationDelay(Lcom/android/systemui/statusbar/notification/stack/ExpandableViewState;I)J
...
.method static synthetic lambda$processAnimationEvents$0(Lcom/android/systemui/statusbar/notification/row/ExpandableView;)V
    ...
    invoke-static {p0}, removeTransientView(Lcom/android/systemui/statusbar/notification/row/ExpandableView;)V
...
.method private onAnimationFinished()V
    ...
    iget-object v0, p0, mHostLayout:Lcom/android/systemui/statusbar/notification/stack/NotificationStackScrollLayout;
    ...
    iget-object v0, p0, mTransientViewsToRemove:Ljava/util/ArrayList;
    ...
    :cond_0
    iget-object p0, p0, mTransientViewsToRemove:Ljava/util/ArrayList;
...
.method private processAnimationEvents(Ljava/util/ArrayList;)V
    ...
    iget-object v1, p0, mNewAddChildren:Ljava/util/ArrayList;
    ...
    invoke-static {v7}, removeTransientView(Lcom/android/systemui/statusbar/notification/row/ExpandableView;)V
    ...
    iget-object v2, p0, mTmpState:Lcom/android/systemui/statusbar/notification/stack/ExpandableViewState;
    ...
    iget-object v1, p0, mTmpState:Lcom/android/systemui/statusbar/notification/stack/ExpandableViewState;

    iget v2, p0, mHeadsUpAppearHeightBottom:I
    ...
    sget v1, ANIMATION_DURATION_HEADS_UP_APPEAR_CLOSED:I
    ...
    :goto_2
    iget-object v1, p0, mHeadsUpAppearChildren:Ljava/util/HashSet;
    ...
    :cond_b
    iget-object v1, p0, mHeadsUpDisappearChildren:Ljava/util/HashSet;
    ...
    iget-object v5, p0, mAnimationFilter:Lcom/android/systemui/statusbar/notification/stack/AnimationFilter;

    iput-boolean v2, v5, Lcom/android/systemui/statusbar/notification/stack/AnimationFilter;->animateY:Z

    iget-object v5, p0, mAnimationProperties:Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;
    ...
    iget-object v4, p0, mTmpLocation:[I
    ...
    iget-object v5, p0, mTmpLocation:[I
    ...
    iget-object v3, p0, mAnimationProperties:Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;
    ...
    :cond_10
    :goto_4
    iget-object v1, p0, mNewEvents:Ljava/util/ArrayList;
...
.method public animateOverScrollToAmount(FZZ)V
    ...
    :cond_0
    invoke-virtual {p0, p2}, cancelOverScrollAnimators(Z)V
...
.method public cancelOverScrollAnimators(Z)V
    ...
    iget-object p0, p0, mTopOverScrollAnimator:Landroid/animation/ValueAnimator;

    goto :goto_0

    :cond_0
    iget-object p0, p0, mBottomOverScrollAnimator:Landroid/animation/ValueAnimator;
...
.method public setHeadsUpAppearHeightBottom(I)V
    ...
    iput p1, p0, mHeadsUpAppearHeightBottom:I
...
.method public setShadeExpanded(Z)V
    ...
    iput-boolean p1, p0, mShadeExpanded:Z
...
.method public startAnimationForEvents(Ljava/util/ArrayList;J)V
    ...
    invoke-direct {p0, p1}, processAnimationEvents(Ljava/util/ArrayList;)V

    iget-object p1, p0, mHostLayout:Lcom/android/systemui/statusbar/notification/stack/NotificationStackScrollLayout;
    ...
    iput-wide p2, p0, mCurrentAdditionalDelay:J
    ...
    iput-wide p2, p0, mCurrentLength:J
    ...
    invoke-direct {p0, v0, v1}, applyWithoutAnimation(Lcom/android/systemui/statusbar/notification/row/ExpandableView;Lcom/android/systemui/statusbar/notification/stack/ExpandableViewState;)Z
    ...
    :cond_0
    iget-object v2, p0, mAnimationProperties:Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;
    ...
    :cond_1
    invoke-direct {p0, v0, v1, p3}, initAnimationProperties(Lcom/android/systemui/statusbar/notification/row/ExpandableView;Lcom/android/systemui/statusbar/notification/stack/ExpandableViewState;I)V
    ...
    :cond_4
    iget-object p1, p0, mHeadsUpAppearChildren:Ljava/util/HashSet;

    invoke-virtual {p1}, Ljava/util/HashSet;->clear()V

    iget-object p1, p0, mHeadsUpDisappearChildren:Ljava/util/HashSet;

    invoke-virtual {p1}, Ljava/util/HashSet;->clear()V

    iget-object p1, p0, mNewEvents:Ljava/util/ArrayList;
