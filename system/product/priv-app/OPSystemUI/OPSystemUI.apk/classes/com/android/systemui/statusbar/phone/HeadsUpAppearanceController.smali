...
.method public constructor <init>(Lcom/android/systemui/statusbar/phone/NotificationIconAreaController;Lcom/android/systemui/statusbar/phone/HeadsUpManagerPhone;Landroid/view/View;)V
    ...
    invoke-direct/range {v1 .. v9}, <init>(Lcom/android/systemui/statusbar/phone/NotificationIconAreaController;Lcom/android/systemui/statusbar/phone/HeadsUpManagerPhone;Lcom/android/systemui/statusbar/HeadsUpStatusBarView;Lcom/android/systemui/statusbar/notification/stack/NotificationStackScrollLayout;Lcom/android/systemui/statusbar/phone/NotificationPanelView;Landroid/view/View;Landroid/view/View;Landroid/view/View;)V
...
.method public constructor <init>(Lcom/android/systemui/statusbar/phone/NotificationIconAreaController;Lcom/android/systemui/statusbar/phone/HeadsUpManagerPhone;Lcom/android/systemui/statusbar/HeadsUpStatusBarView;Lcom/android/systemui/statusbar/notification/stack/NotificationStackScrollLayout;Lcom/android/systemui/statusbar/phone/NotificationPanelView;Landroid/view/View;Landroid/view/View;Landroid/view/View;)V
    ...
    iput-object v0, p0, mSetTrackingHeadsUp:Ljava/util/function/Consumer;
    ...
    iput-object v0, p0, mUpdatePanelTranslation:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mSetExpandedHeight:Ljava/util/function/BiConsumer;
    ...
    iput-object v0, p0, mStackScrollLayoutChangeListener:Landroid/view/View$OnLayoutChangeListener;
    ...
    iput-object v0, p0, mParentClippingParams:Lcom/android/internal/widget/ViewClippingUtil$ClippingParameters;

    const/4 v0, 0x1

    iput-boolean v0, p0, mAnimationsEnabled:Z
    ...
    iput-object p1, p0, mNotificationIconAreaController:Lcom/android/systemui/statusbar/phone/NotificationIconAreaController;

    iput-object p2, p0, mHeadsUpManager:Lcom/android/systemui/statusbar/phone/HeadsUpManagerPhone;
    ...
    iput-object p3, p0, mHeadsUpStatusBarView:Lcom/android/systemui/statusbar/HeadsUpStatusBarView;

    iput-object p8, p0, mCenteredIconView:Landroid/view/View;
    ...
    iput-object p4, p0, mStackScroller:Lcom/android/systemui/statusbar/notification/stack/NotificationStackScrollLayout;

    iput-object p5, p0, mPanelView:Lcom/android/systemui/statusbar/phone/NotificationPanelView;

    iget-object p1, p0, mSetTrackingHeadsUp:Ljava/util/function/Consumer;
    ...
    iget-object p1, p0, mUpdatePanelTranslation:Ljava/lang/Runnable;
    ...
    iget-object p2, p0, mSetExpandedHeight:Ljava/util/function/BiConsumer;
    ...
    iget-object p2, p0, mStackScrollLayoutChangeListener:Landroid/view/View$OnLayoutChangeListener;
    ...
    iput-object p6, p0, mClockView:Landroid/view/View;

    iput-object p7, p0, mOperatorNameView:Landroid/view/View;
    ...
    iput-object p1, p0, mDarkIconDispatcher:Lcom/android/systemui/plugins/DarkIconDispatcher;

    iget-object p1, p0, mDarkIconDispatcher:Lcom/android/systemui/plugins/DarkIconDispatcher;
    ...
    iget-object p1, p0, mHeadsUpStatusBarView:Lcom/android/systemui/statusbar/HeadsUpStatusBarView;
...
.method static synthetic access$100(Lcom/android/systemui/statusbar/phone/HeadsUpAppearanceController;)Lcom/android/systemui/statusbar/HeadsUpStatusBarView;
    ...
    iget-object p0, p0, mHeadsUpStatusBarView:Lcom/android/systemui/statusbar/HeadsUpStatusBarView;
...
.method private getRtlTranslation()I
    ...
    iget-object v0, p0, mPoint:Landroid/graphics/Point;
    ...
    iput-object v0, p0, mPoint:Landroid/graphics/Point;
    ...
    iget-object v2, p0, mPoint:Landroid/graphics/Point;
...
.method private hide(Landroid/view/View;I)V
    ...
    invoke-direct {p0, p1, p2, v0}, hide(Landroid/view/View;ILjava/lang/Runnable;)V
...
.method private setShown(Z)V
    ...
    invoke-direct {p0, p1}, updateParentClipping(Z)V

    iget-object v1, p0, mHeadsUpStatusBarView:Lcom/android/systemui/statusbar/HeadsUpStatusBarView;

    invoke-virtual {v1, p1}, Landroid/widget/LinearLayout;->setVisibility(I)V

    iget-object p1, p0, mHeadsUpStatusBarView:Lcom/android/systemui/statusbar/HeadsUpStatusBarView;

    invoke-direct {p0, p1}, show(Landroid/view/View;)V

    iget-object p1, p0, mClockView:Landroid/view/View;

    const/4 v1, 0x4

    invoke-direct {p0, p1, v1}, hide(Landroid/view/View;I)V

    iget-object p1, p0, mCenteredIconView:Landroid/view/View;
    ...
    :cond_0
    iget-object p1, p0, mOperatorNameView:Landroid/view/View;
    ...
    :cond_1
    iget-object p1, p0, mOpSceneModeObserver:Lcom/oneplus/scene/OpSceneModeObserver;
    ...
    invoke-direct {p0, p1, v0, v1}, hide(Landroid/view/View;ILjava/lang/Runnable;)V
...
.method private updateParentClipping(Z)V
    ...
    iget-object v0, p0, mHeadsUpStatusBarView:Lcom/android/systemui/statusbar/HeadsUpStatusBarView;

    xor-int/lit8 p1, p1, 0x1

    iget-object p0, p0, mParentClippingParams:Lcom/android/internal/widget/ViewClippingUtil$ClippingParameters;
...
.method public destroy()V
    ...
    iget-object v2, p0, mSetTrackingHeadsUp:Ljava/util/function/Consumer;
    ...
    iget-object v2, p0, mUpdatePanelTranslation:Ljava/lang/Runnable;
    ...
    iget-object v1, p0, mSetExpandedHeight:Ljava/util/function/BiConsumer;
    ...
    iget-object v1, p0, mStackScrollLayoutChangeListener:Landroid/view/View$OnLayoutChangeListener;

    invoke-virtual {v0, v1}, Landroid/view/ViewGroup;->removeOnLayoutChangeListener(Landroid/view/View$OnLayoutChangeListener;)V

    iget-object v0, p0, mDarkIconDispatcher:Lcom/android/systemui/plugins/DarkIconDispatcher;
...
.method public synthetic lambda$new$0$HeadsUpAppearanceController(Landroid/view/View;IIIIIIII)V
    ...
    invoke-virtual {p0}, updatePanelTranslation()V
...
.method public synthetic lambda$new$1$HeadsUpAppearanceController()V
    ...
    invoke-direct {p0, v0}, updateIsolatedIconLocation(Z)V
...
.method public synthetic lambda$setShown$2$HeadsUpAppearanceController()V
    ...
    invoke-direct {p0, v0}, updateParentClipping(Z)V
...
.method public synthetic lambda$updateHeadsUpHeaders$4$HeadsUpAppearanceController(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V
    ...
    invoke-virtual {p0, p1}, updateHeader(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V
...
.method public onHeadsUpPinned(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V
    ...
    invoke-virtual {p0}, updateTopEntry()V
...
.method readFrom(Lcom/android/systemui/statusbar/phone/HeadsUpAppearanceController;)V
    ...
    iget-object v0, p1, mTrackedChild:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;

    iput-object v0, p0, mTrackedChild:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;

    iget v0, p1, mExpandedHeight:F

    iput v0, p0, mExpandedHeight:F

    iget-boolean v0, p1, mIsExpanded:Z

    iput-boolean v0, p0, mIsExpanded:Z

    iget p1, p1, mExpandFraction:F

    iput p1, p0, mExpandFraction:F
...
.method public setExpandedHeight(FF)V
    ...
    invoke-direct {p0}, updateHeadsUpHeaders()V
    ...
    iput-boolean v1, p0, mIsExpanded:Z
...
.method public setTrackingHeadsUp(Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;)V
    ...
    iget-object v0, p0, mTrackedChild:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;

    iput-object p1, p0, mTrackedChild:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;
...
.method public updatePanelTranslation()V
    ...
    invoke-direct {p0}, getRtlTranslation()I
    ...
    iget-object v1, p0, mStackScroller:Lcom/android/systemui/statusbar/notification/stack/NotificationStackScrollLayout;
...
.method public updateTopEntry()V
    ...
    iget-object v0, p0, mOpSceneModeObserver:Lcom/oneplus/scene/OpSceneModeObserver;
    ...
    :goto_0
    iget-object v2, p0, mHeadsUpStatusBarView:Lcom/android/systemui/statusbar/HeadsUpStatusBarView;
    ...
    iget-object v3, p0, mHeadsUpStatusBarView:Lcom/android/systemui/statusbar/HeadsUpStatusBarView;
    ...
    invoke-direct {p0, v4}, setShown(Z)V
    ...
    invoke-direct {p0, v3}, setShown(Z)V
    ...
    :goto_2
    invoke-direct {p0, v4}, updateIsolatedIconLocation(Z)V

    iget-object p0, p0, mNotificationIconAreaController:Lcom/android/systemui/statusbar/phone/NotificationIconAreaController;
