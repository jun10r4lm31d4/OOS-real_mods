...
.method public constructor <init>()V
    ...
    iput v0, p0, mBearerAllocationStatus:I

    iput v0, p0, mPlmn:I

    iput v0, p0, mUpperLayerInd:I

    iput v0, p0, mDcnr:I

    iput v0, p0, mLevel:I

    iput v0, p0, mNrConfigType:I

    const/4 v0, -0x1

    iput v0, p0, mNrIconType:I
    ...
    iput-object v0, p0, mIconGroup:Lcom/android/systemui/statusbar/policy/MobileSignalController$MobileIconGroup;
...
.method static synthetic access$102(Lcom/android/systemui/statusbar/policy/FiveGServiceClient$FiveGServiceState;Lcom/android/systemui/statusbar/policy/MobileSignalController$MobileIconGroup;)Lcom/android/systemui/statusbar/policy/MobileSignalController$MobileIconGroup;
    ...
    iput-object p1, p0, mIconGroup:Lcom/android/systemui/statusbar/policy/MobileSignalController$MobileIconGroup;
...
.method static synthetic access$400(Lcom/android/systemui/statusbar/policy/FiveGServiceClient$FiveGServiceState;)I
    ...
    iget p0, p0, mBearerAllocationStatus:I
...
.method static synthetic access$402(Lcom/android/systemui/statusbar/policy/FiveGServiceClient$FiveGServiceState;I)I
    ...
    iput p1, p0, mBearerAllocationStatus:I
...
.method public copyFrom(Lcom/android/systemui/statusbar/policy/FiveGServiceClient$FiveGServiceState;)V
    ...
    iget v0, p1, mBearerAllocationStatus:I
    ...
    iget v0, p1, mNrConfigType:I

    iput v0, p0, mNrConfigType:I

    iget-object v0, p1, mIconGroup:Lcom/android/systemui/statusbar/policy/MobileSignalController$MobileIconGroup;

    iput-object v0, p0, mIconGroup:Lcom/android/systemui/statusbar/policy/MobileSignalController$MobileIconGroup;

    iget v0, p1, mNrIconType:I
...
.method public equals(Lcom/android/systemui/statusbar/policy/FiveGServiceClient$FiveGServiceState;)Z
    ...
    iget v0, p0, mBearerAllocationStatus:I

    iget v1, p1, mBearerAllocationStatus:I
    ...
    iget v0, p0, mUpperLayerInd:I

    iget v1, p1, mUpperLayerInd:I
    ...
    iget v0, p0, mNrConfigType:I

    iget v1, p1, mNrConfigType:I

    if-ne v0, v1, :cond_0

    iget-object v0, p0, mIconGroup:Lcom/android/systemui/statusbar/policy/MobileSignalController$MobileIconGroup;

    iget-object v1, p1, mIconGroup:Lcom/android/systemui/statusbar/policy/MobileSignalController$MobileIconGroup;

    if-ne v0, v1, :cond_0

    iget p0, p0, mNrIconType:I

    iget p1, p1, mNrIconType:I
...
.method public getIconGroup()Lcom/android/systemui/statusbar/policy/MobileSignalController$MobileIconGroup;
    ...
    iget-object p0, p0, mIconGroup:Lcom/android/systemui/statusbar/policy/MobileSignalController$MobileIconGroup;
...
.method public toString()Ljava/lang/String;
    ...
    iget v1, p0, mBearerAllocationStatus:I
    ...
    iget-object v1, p0, mIconGroup:Lcom/android/systemui/statusbar/policy/MobileSignalController$MobileIconGroup;
