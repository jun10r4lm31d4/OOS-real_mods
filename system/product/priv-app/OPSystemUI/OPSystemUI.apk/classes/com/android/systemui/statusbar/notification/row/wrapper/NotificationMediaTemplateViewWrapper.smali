...
.method protected constructor <init>(Landroid/content/Context;Landroid/view/View;Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;)V
    ...
    iput-object p2, p0, mSeekListener:Landroid/widget/SeekBar$OnSeekBarChangeListener;
    ...
    iput-object p2, p0, mMediaCallback:Landroid/media/session/MediaController$Callback;
    ...
    iput-object p2, p0, mOnUpdateTimerTick:Ljava/lang/Runnable;
    ...
    iput-object p2, p0, mMediaManager:Lcom/android/systemui/statusbar/NotificationMediaManager;
...
.method static synthetic access$000(Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationMediaTemplateViewWrapper;)Landroid/media/session/MediaController;
    ...
    iget-object p0, p0, mMediaController:Landroid/media/session/MediaController;
...
.method static synthetic access$100(Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationMediaTemplateViewWrapper;)Landroid/widget/SeekBar;
    ...
    iget-object p0, p0, mSeekBar:Landroid/widget/SeekBar;
...
.method static synthetic access$1000(Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationMediaTemplateViewWrapper;)V
    ...
    invoke-direct {p0}, updateDuration()V
...
.method static synthetic access$1200(Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationMediaTemplateViewWrapper;)V
    ...
    invoke-direct {p0}, handleProgressUpdate()V
...
.method static synthetic access$200(Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationMediaTemplateViewWrapper;I)Landroid/metrics/LogMaker;
    ...
    invoke-direct {p0, p1}, newLog(I)Landroid/metrics/LogMaker;
...
.method static synthetic access$500(Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationMediaTemplateViewWrapper;Landroid/media/session/PlaybackState;)V
    ...
    invoke-direct {p0, p1}, updatePlaybackUi(Landroid/media/session/PlaybackState;)V
...
.method static synthetic access$600(Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationMediaTemplateViewWrapper;)Ljava/util/Timer;
    ...
    iget-object p0, p0, mSeekBarTimer:Ljava/util/Timer;
...
.method static synthetic access$700(Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationMediaTemplateViewWrapper;)Landroid/view/View;
    ...
    iget-object p0, p0, mSeekBarView:Landroid/view/View;
...
.method private clearTimer()V
    ...
    iget-object v0, p0, mSeekBarTimer:Ljava/util/Timer;
    ...
    iput-object v0, p0, mSeekBarTimer:Ljava/util/Timer;

    :cond_0
    iget-object v0, p0, mHandler:Landroid/os/Handler;

    iget-object p0, p0, mOnUpdateTimerTick:Ljava/lang/Runnable;
...
.method private handleProgressUpdate()V
    ...
    iget-object v1, p0, mOnUpdateTimerTick:Ljava/lang/Runnable;
...
.method private resolveViews()V
    ...
    iput-object v0, p0, mActions:Landroid/view/View;
    ...
    iget-object v5, p0, mMediaCallback:Landroid/media/session/MediaController$Callback;
    ...
    iput-object v1, p0, mMediaController:Landroid/media/session/MediaController;
    ...
    iput-object v1, p0, mMediaMetadata:Landroid/media/MediaMetadata;
    ...
    iget-object v1, p0, mSeekBarView:Landroid/view/View;
    ...
    iget-object v0, p0, mSeekBarView:Landroid/view/View;

    invoke-virtual {v0, v2}, Landroid/view/View;->setVisibility(I)V

    iget-object v0, p0, mMetricsLogger:Lcom/android/internal/logging/MetricsLogger;

    invoke-direct {p0, v3}, newLog(I)Landroid/metrics/LogMaker;
    ...
    invoke-direct {p0, v4}, newLog(I)Landroid/metrics/LogMaker;
    ...
    iput-object v0, p0, mSeekBarView:Landroid/view/View;
    ...
    iput-object v0, p0, mSeekBar:Landroid/widget/SeekBar;

    iget-object v0, p0, mSeekBar:Landroid/widget/SeekBar;

    iget-object v1, p0, mSeekListener:Landroid/widget/SeekBar$OnSeekBarChangeListener;
    ...
    iput-object v0, p0, mSeekBarElapsedTime:Landroid/widget/TextView;
    ...
    iput-object v0, p0, mSeekBarTotalTime:Landroid/widget/TextView;
    ...
    invoke-direct {p0, v0}, canSeekMedia(Landroid/media/session/PlaybackState;)Z
    ...
    invoke-direct {p0, v1, v4}, newLog(II)Landroid/metrics/LogMaker;
    ...
    :cond_8
    invoke-direct {p0, v3}, setScrubberVisible(Z)V
    ...
    iget-object v1, p0, mMediaCallback:Landroid/media/session/MediaController$Callback;
    ...
    invoke-direct {p0, v0}, updateSeekBarTint(Landroid/view/View;)V
...
.method private setScrubberVisible(Z)V
    ...
    invoke-direct {p0, v1, p1}, newLog(II)Landroid/metrics/LogMaker;
...
.method private startTimer()V
    ...
    :cond_0
    invoke-direct {p0, v0}, updatePlaybackUi(Landroid/media/session/PlaybackState;)V
...
.method private updateDuration()V
    ...
    iget-object v2, p0, mSeekBar:Landroid/widget/SeekBar;

    iget-wide v3, p0, mDuration:J

    long-to-int v3, v3

    invoke-virtual {v2, v3}, Landroid/widget/SeekBar;->setMax(I)V

    iget-object v2, p0, mSeekBarTotalTime:Landroid/widget/TextView;

    invoke-direct {p0, v0, v1}, millisecondsToTimeString(J)Ljava/lang/String;
...
.method private updatePlaybackUi(Landroid/media/session/PlaybackState;)V
    ...
    iget-object v2, p0, mSeekBarElapsedTime:Landroid/widget/TextView;
    ...
    invoke-direct {p0, p1}, canSeekMedia(Landroid/media/session/PlaybackState;)Z

    move-result p1

    invoke-direct {p0, p1}, setScrubberVisible(Z)V
...
.method private updateSeekBarTint(Landroid/view/View;)V
    ...
    iget-object v0, p0, mSeekBarElapsedTime:Landroid/widget/TextView;

    invoke-virtual {v0, p1}, Landroid/widget/TextView;->setTextColor(I)V

    iget-object v0, p0, mSeekBarTotalTime:Landroid/widget/TextView;
...
.method public onContentUpdated(Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;)V
    ...
    invoke-direct {p0}, resolveViews()V
...
.method protected updateTransformedTypes()V
    ...
    iget-object v0, p0, mActions:Landroid/view/View;
