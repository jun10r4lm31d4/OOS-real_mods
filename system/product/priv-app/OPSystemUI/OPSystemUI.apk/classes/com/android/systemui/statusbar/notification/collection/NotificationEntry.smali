...
.method public constructor <init>(Landroid/service/notification/StatusBarNotification;Landroid/service/notification/NotificationListenerService$Ranking;)V
    ...
    iput-wide v0, p0, lastFullScreenIntentLaunchTime:J

    const/4 v2, 0x0

    iput v2, p0, userSentiment:I

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object v3

    iput-object v3, p0, systemGeneratedSmartActions:Ljava/util/List;

    new-array v2, v2, [Ljava/lang/CharSequence;

    iput-object v2, p0, systemGeneratedSmartReplies:[Ljava/lang/CharSequence;

    const/4 v2, 0x1

    iput v2, p0, mCachedContrastColor:I

    iput v2, p0, mCachedContrastColorIsFor:I

    const/4 v2, 0x0

    iput-object v2, p0, mRunningTask:Lcom/android/systemui/statusbar/InflationTask;

    iput-wide v0, p0, lastRemoteInputSent:J
    ...
    iput-object v0, p0, mActiveAppOps:Landroid/util/ArraySet;

    const-wide/16 v0, -0x1

    iput-wide v0, p0, initializationTime:J

    iput-object v2, p0, statusBarChronometer:Landroid/widget/Chronometer;

    iput-object v2, p0, keyguardChronometer:Landroid/widget/Chronometer;
    ...
    iput-object p1, p0, notification:Landroid/service/notification/StatusBarNotification;

    if-eqz p2, :cond_0

    invoke-virtual {p0, p2}, populateFromRanking(Landroid/service/notification/NotificationListenerService$Ranking;)V
    ...
    iput-boolean p2, p0, mIsGamingModeNotification:Z

    iget-boolean p2, p0, mIsGamingModeNotification:Z
    ...
    iput-boolean p1, p0, mIsGamingModeNotification:Z
    :try_end_0
...
.method private initChronometers(Landroid/content/Context;Landroid/app/Notification;)V
    ...
    iput-object v0, p0, statusBarChronometer:Landroid/widget/Chronometer;

    iget-object v0, p0, statusBarChronometer:Landroid/widget/Chronometer;
    ...
    iput-object v0, p0, keyguardChronometer:Landroid/widget/Chronometer;

    iget-object p0, p0, keyguardChronometer:Landroid/widget/Chronometer;
...
.method private static isNotificationBlockedByPolicy(Landroid/app/Notification;)Z
    ...
    invoke-static {v0, p0}, isCategory(Ljava/lang/String;Landroid/app/Notification;)Z
...
.method private shouldSuppressVisualEffect(I)Z
    ...
    invoke-virtual {p0}, isExemptFromDndVisualSuppression()Z
    ...
    :cond_0
    iget p0, p0, suppressedVisualEffects:I
...
.method public abortTask()V
    ...
    iget-object v0, p0, mRunningTask:Lcom/android/systemui/statusbar/InflationTask;
    ...
    iput-object v0, p0, mRunningTask:Lcom/android/systemui/statusbar/InflationTask;
...
.method public areChildrenExpanded()Z
    ...
    iget-object p0, p0, row:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;
...
.method public areGutsExposed()Z
    ...
    iget-object v0, p0, row:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;
...
.method public createChronometer(Landroid/content/Context;)V
    ...
    iget-object v0, p0, notification:Landroid/service/notification/StatusBarNotification;
    ...
    invoke-direct {p0, p1, v0}, initChronometers(Landroid/content/Context;Landroid/app/Notification;)V

    goto :goto_0

    :cond_0
    iget-object v1, p0, statusBarChronometer:Landroid/widget/Chronometer;
    ...
    iget-object p1, p0, keyguardChronometer:Landroid/widget/Chronometer;
    ...
    iget-object p1, p0, statusBarChronometer:Landroid/widget/Chronometer;
...
.method public createIcons(Landroid/content/Context;Landroid/service/notification/StatusBarNotification;)V
    ...
    iput-object v1, p0, icon:Lcom/android/systemui/statusbar/StatusBarIconView;

    iget-object v1, p0, icon:Lcom/android/systemui/statusbar/StatusBarIconView;
    ...
    iput-object v1, p0, expandedIcon:Lcom/android/systemui/statusbar/StatusBarIconView;

    iget-object v1, p0, expandedIcon:Lcom/android/systemui/statusbar/StatusBarIconView;
    ...
    iget-object v0, p0, icon:Lcom/android/systemui/statusbar/StatusBarIconView;
    ...
    iget-object v0, p0, expandedIcon:Lcom/android/systemui/statusbar/StatusBarIconView;
    ...
    iput-object v0, p0, centeredIcon:Lcom/android/systemui/statusbar/StatusBarIconView;

    iget-object p1, p0, centeredIcon:Lcom/android/systemui/statusbar/StatusBarIconView;
    ...
    :cond_0
    iput-object v1, p0, centeredIcon:Lcom/android/systemui/statusbar/StatusBarIconView;
...
.method public getBubbleMetadata()Landroid/app/Notification$BubbleMetadata;
    ...
    iget-object p0, p0, notification:Landroid/service/notification/StatusBarNotification;
...
.method public getContrastedColor(Landroid/content/Context;ZI)I
    ...
    :cond_0
    iget-object p2, p0, notification:Landroid/service/notification/StatusBarNotification;
    ...
    :goto_0
    iget v0, p0, mCachedContrastColorIsFor:I

    if-ne v0, p2, :cond_1

    iget v0, p0, mCachedContrastColor:I
    ...
    iput p2, p0, mCachedContrastColorIsFor:I

    iput p1, p0, mCachedContrastColor:I

    iget p0, p0, mCachedContrastColor:I
...
.method public getDebugThrowable()Ljava/lang/Throwable;
    ...
    iget-object p0, p0, mDebugThrowable:Ljava/lang/Throwable;
...
.method public getRunningTask()Lcom/android/systemui/statusbar/InflationTask;
    ...
    iget-object p0, p0, mRunningTask:Lcom/android/systemui/statusbar/InflationTask;
...
.method public hasFinishedInitialization()Z
    ...
    iget-wide v0, p0, initializationTime:J
    ...
    iget-wide v2, p0, initializationTime:J
...
.method public hasInterrupted()Z
    ...
    iget-boolean p0, p0, interruption:Z
...
.method public hasJustLaunchedFullScreenIntent()Z
    ...
    iget-wide v2, p0, lastFullScreenIntentLaunchTime:J
...
.method public hasJustSentRemoteInput()Z
    ...
    iget-wide v2, p0, lastRemoteInputSent:J
...
.method public isBubbleDismissed()Z
    ...
    iget-boolean p0, p0, mUserDismissedBubble:Z
...
.method public isChildInGroup()Z
    ...
    iget-object p0, p0, parent:Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;
...
.method public isClearable()Z
    ...
    :cond_0
    invoke-virtual {p0}, getChildren()Ljava/util/List;
    ...
    invoke-virtual {v2}, isClearable()Z
...
.method isExemptFromDndVisualSuppression()Z
    ...
    invoke-static {v0}, isNotificationBlockedByPolicy(Landroid/app/Notification;)Z
    ...
    :cond_2
    iget-object p0, p0, mIsSystemNotification:Ljava/lang/Boolean;
...
.method public isHighPriority()Z
    ...
    iget-boolean p0, p0, mHighPriority:Z
...
.method public isLastMessageFromReply()Z
    ...
    iget-boolean v0, p0, hasSentReply:Z
...
.method public notifyFullScreenIntentLaunched()V
    ...
    invoke-virtual {p0}, setInterruption()V
...
.method public onRemoteInputInserted()V
    ...
    iput-object v0, p0, remoteInputTextWhenReset:Ljava/lang/CharSequence;
...
.method public populateFromRanking(Landroid/service/notification/NotificationListenerService$Ranking;)V
    ...
    :goto_0
    iput-object v0, p0, systemGeneratedSmartActions:Ljava/util/List;
...
.method public setBubbleDismissed(Z)V
    ...
    iput-boolean p1, p0, mUserDismissedBubble:Z
...
.method public setDebugThrowable(Ljava/lang/Throwable;)V
    ...
    iput-object p1, p0, mDebugThrowable:Ljava/lang/Throwable;
...
.method public setHasSentReply()V
    ...
    iput-boolean v0, p0, hasSentReply:Z
...
.method public setIconTag(ILjava/lang/Object;)V
    ...
    :cond_0
    iget-object p0, p0, centeredIcon:Lcom/android/systemui/statusbar/StatusBarIconView;
...
.method public setInflationTask(Lcom/android/systemui/statusbar/InflationTask;)V
    ...
    invoke-virtual {p0}, abortTask()V

    iput-object p1, p0, mRunningTask:Lcom/android/systemui/statusbar/InflationTask;
...
.method public setInitializationTime(J)V
    ...
    iput-wide p1, p0, initializationTime:J
...
.method public setInterruption()V
    ...
    iput-boolean v0, p0, interruption:Z
...
.method public setIsHighPriority(Z)V
    ...
    iput-boolean p1, p0, mHighPriority:Z
...
.method public setRow(Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;)V
    ...
    iput-object p1, p0, row:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;
...
.method public setShowInShadeWhenBubble(Z)V
    ...
    iput-boolean p1, p0, mShowInShadeWhenBubble:Z
...
.method public shouldSuppressAmbient()Z
    ...
    invoke-direct {p0, v0}, shouldSuppressVisualEffect(I)Z
...
.method public showInShadeWhenBubble()Z
    ...
    invoke-virtual {p0}, isRowDismissed()Z

    move-result v0

    if-nez v0, :cond_1

    invoke-virtual {p0}, isClearable()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-boolean p0, p0, mShowInShadeWhenBubble:Z
...
.method public updateIcons(Landroid/content/Context;Landroid/service/notification/StatusBarNotification;)V
    ...
    iget-object v1, p0, notification:Landroid/service/notification/StatusBarNotification;
    ...
    iget-object p1, p0, icon:Lcom/android/systemui/statusbar/StatusBarIconView;
    ...
    iget-object p1, p0, expandedIcon:Lcom/android/systemui/statusbar/StatusBarIconView;
