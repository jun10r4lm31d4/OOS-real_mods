...
.method public constructor <init>(Landroid/view/ViewGroup;)V
    ...
    iput-boolean v0, p0, mShouldLog:Z

    const/4 v1, 0x1

    iput-boolean v1, p0, mDemoable:Z

    const-string/jumbo v1, "statusbar"

    iput-object v1, p0, mTag:Ljava/lang/String;

    iput-object p1, p0, mGroup:Landroid/view/ViewGroup;
    ...
    iget-object v0, p0, mGroup:Landroid/view/ViewGroup;
    ...
    iget-object p0, p0, mGroup:Landroid/view/ViewGroup;
...
.method public constructor <init>(Landroid/view/ViewGroup;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, <init>(Landroid/view/ViewGroup;)V
...
.method protected addHolder(ILjava/lang/String;ZLcom/android/systemui/statusbar/phone/StatusBarIconHolder;)Lcom/android/systemui/statusbar/StatusIconDisplayable;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, addText(ILjava/lang/String;IZ)Lcom/oneplus/networkspeed/StatusBarOPCustView;
    ...
    invoke-virtual {p0, p1, p2, p3}, addMobileIcon(ILjava/lang/String;Lcom/android/systemui/statusbar/phone/StatusBarSignalPolicy$MobileIconState;)Lcom/android/systemui/statusbar/StatusBarMobileView;
    ...
    invoke-virtual {p0, p1, p2, p3}, addSignalIcon(ILjava/lang/String;Lcom/android/systemui/statusbar/phone/StatusBarSignalPolicy$WifiIconState;)Lcom/android/systemui/statusbar/StatusBarWifiView;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, addIcon(ILjava/lang/String;ZLcom/android/internal/statusbar/StatusBarIcon;)Lcom/android/systemui/statusbar/StatusBarIconView;
...
.method protected addIcon(ILjava/lang/String;ZLcom/android/internal/statusbar/StatusBarIcon;)Lcom/android/systemui/statusbar/StatusBarIconView;
    ...
    invoke-direct {p0, p2, p3}, onCreateStatusBarIconView(Ljava/lang/String;Z)Lcom/android/systemui/statusbar/StatusBarIconView;
    ...
    iget-object p3, p0, mGroup:Landroid/view/ViewGroup;

    invoke-virtual {p0}, onCreateLayoutParams()Landroid/widget/LinearLayout$LayoutParams;
...
.method protected addMobileIcon(ILjava/lang/String;Lcom/android/systemui/statusbar/phone/StatusBarSignalPolicy$MobileIconState;)Lcom/android/systemui/statusbar/StatusBarMobileView;
    ...
    invoke-direct {p0, p2}, onCreateStatusBarMobileView(Ljava/lang/String;)Lcom/android/systemui/statusbar/StatusBarMobileView;
    ...
    iget-boolean p1, p0, mIsInDemoMode:Z

    if-eqz p1, :cond_0

    iget-object p0, p0, mDemoStatusIcons:Lcom/android/systemui/statusbar/phone/DemoStatusIcons;
...
.method protected addSignalIcon(ILjava/lang/String;Lcom/android/systemui/statusbar/phone/StatusBarSignalPolicy$WifiIconState;)Lcom/android/systemui/statusbar/StatusBarWifiView;
    ...
    invoke-direct {p0, p2}, onCreateStatusBarWifiView(Ljava/lang/String;)Lcom/android/systemui/statusbar/StatusBarWifiView;
...
.method protected addText(ILjava/lang/String;IZ)Lcom/oneplus/networkspeed/StatusBarOPCustView;
    ...
    invoke-direct {p0, p2, p3}, onCreateStatusBarText(Ljava/lang/String;I)Lcom/oneplus/networkspeed/StatusBarOPCustView;
...
.method protected createDemoStatusIcons()Lcom/android/systemui/statusbar/phone/DemoStatusIcons;
    ...
    iget-object v1, p0, mGroup:Landroid/view/ViewGroup;
...
.method public dispatchDemoCommand(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    iget-boolean v0, p0, mDemoable:Z
    ...
    iget-object v0, p0, mDemoStatusIcons:Lcom/android/systemui/statusbar/phone/DemoStatusIcons;
    ...
    invoke-virtual {p0}, exitDemoMode()V

    :cond_1
    const/4 p1, 0x0

    iput-boolean p1, p0, mIsInDemoMode:Z
    ...
    iput-boolean v0, p0, mIsInDemoMode:Z

    invoke-virtual {p0}, createDemoStatusIcons()Lcom/android/systemui/statusbar/phone/DemoStatusIcons;

    move-result-object v0

    iput-object v0, p0, mDemoStatusIcons:Lcom/android/systemui/statusbar/phone/DemoStatusIcons;
...
.method public isDemoable()Z
    ...
    iget-boolean p0, p0, mDemoable:Z
...
.method protected onIconAdded(ILjava/lang/String;ZLcom/android/systemui/statusbar/phone/StatusBarIconHolder;)V
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, addHolder(ILjava/lang/String;ZLcom/android/systemui/statusbar/phone/StatusBarIconHolder;)Lcom/android/systemui/statusbar/StatusIconDisplayable;
...
.method protected onIconExternal(II)V
    ...
    invoke-direct {p0, p1, p2}, setHeightAndCenter(Landroid/widget/ImageView;I)V
...
.method protected onRemoveIcon(I)V
    ...
    iget-boolean v0, p0, mIsInDemoMode:Z
...
.method public onSetIconHolder(ILcom/android/systemui/statusbar/phone/StatusBarIconHolder;)V
    ...
    invoke-virtual {p0, p1, p2}, onSetTextVisible(IZ)V
    ...
    invoke-virtual {p0, p1, p2}, onSetMobileIcon(ILcom/android/systemui/statusbar/phone/StatusBarSignalPolicy$MobileIconState;)V
    ...
    invoke-virtual {p0, p1, p2}, onSetSignalIcon(ILcom/android/systemui/statusbar/phone/StatusBarSignalPolicy$WifiIconState;)V
    ...
    invoke-virtual {p0, p1, p2}, onSetIcon(ILcom/android/internal/statusbar/StatusBarIcon;)V
...
.method public setShouldLog(Z)V
    ...
    iput-boolean p1, p0, mShouldLog:Z
...
.method public shouldLog()Z
    ...
    iget-boolean p0, p0, mShouldLog:Z
