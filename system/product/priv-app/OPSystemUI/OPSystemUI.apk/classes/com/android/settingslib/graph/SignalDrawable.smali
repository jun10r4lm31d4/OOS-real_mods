...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mForegroundPaint:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0, v1}, Landroid/graphics/Paint;-><init>(I)V

    iput-object v0, p0, mTransparentPaint:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0}, Landroid/graphics/Path;-><init>()V

    iput-object v0, p0, mCutoutPath:Landroid/graphics/Path;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0}, Landroid/graphics/Path;-><init>()V

    iput-object v0, p0, mForegroundPath:Landroid/graphics/Path;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0}, Landroid/graphics/Path;-><init>()V

    iput-object v0, p0, mXPath:Landroid/graphics/Path;

    const/high16 v0, -0x40800000    # -1.0f

    iput v0, p0, mDarkIntensity:F
    ...
    iput-object v0, p0, mChangeDot:Ljava/lang/Runnable;
    ...
    iput v0, p0, mDarkModeFillColor:I
    ...
    iput v0, p0, mLightModeFillColor:I
    ...
    iput v0, p0, mIntrinsicSize:I

    iget-object v0, p0, mTransparentPaint:Landroid/graphics/Paint;
    ...
    iget-object p1, p0, mTransparentPaint:Landroid/graphics/Paint;
    ...
    invoke-virtual {p0, p1}, setDarkIntensity(F)V
...
.method static synthetic access$004(Lcom/android/settingslib/graph/SignalDrawable;)I
    ...
    iget v0, p0, mCurrentDot:I

    add-int/lit8 v0, v0, 0x1

    iput v0, p0, mCurrentDot:I
...
.method static synthetic access$100(Lcom/android/settingslib/graph/SignalDrawable;)Ljava/lang/Runnable;
    ...
    iget-object p0, p0, mChangeDot:Ljava/lang/Runnable;
...
.method private drawDotAndPadding(FFFFI)V
    ...
    iget v1, p0, mCurrentDot:I

    if-ne p5, v1, :cond_0

    iget-object v1, p0, mForegroundPath:Landroid/graphics/Path;
    ...
    iget-object v0, p0, mCutoutPath:Landroid/graphics/Path;
...
.method private getFillColor(F)I
    ...
    iget v0, p0, mLightModeFillColor:I

    iget v1, p0, mDarkModeFillColor:I

    invoke-direct {p0, p1, v0, v1}, getColorForDarkIntensity(FII)I
...
.method private updateAnimation()V
    ...
    invoke-direct {p0, v0}, isInState(I)Z
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v6, p0, mCutoutPath:Landroid/graphics/Path;
    ...
    invoke-direct {p0, v7}, isInState(I)Z
    ...
    iget-object v6, p0, mForegroundPath:Landroid/graphics/Path;
    ...
    invoke-direct/range {v7 .. v12}, drawDotAndPadding(FFFFI)V
    ...
    iget-object v1, p0, mTransparentPaint:Landroid/graphics/Paint;

    invoke-virtual {p1, v0, v1}, Landroid/graphics/Canvas;->drawPath(Landroid/graphics/Path;Landroid/graphics/Paint;)V

    iget-object v0, p0, mForegroundPath:Landroid/graphics/Path;

    iget-object p0, p0, mForegroundPaint:Landroid/graphics/Paint;
    ...
    iget-object v8, p0, mCutoutPath:Landroid/graphics/Path;
    ...
    iget-object v5, p0, mCutoutPath:Landroid/graphics/Path;

    iget-object v6, p0, mTransparentPaint:Landroid/graphics/Paint;

    invoke-virtual {p1, v5, v6}, Landroid/graphics/Canvas;->drawPath(Landroid/graphics/Path;Landroid/graphics/Paint;)V

    iget-object v5, p0, mXPath:Landroid/graphics/Path;

    invoke-virtual {v5}, Landroid/graphics/Path;->reset()V

    iget-object v5, p0, mXPath:Landroid/graphics/Path;

    sget-object v6, X_PATH:[[F
    ...
    iget-object v7, p0, mXPath:Landroid/graphics/Path;
    ...
    :cond_3
    iget-object v0, p0, mXPath:Landroid/graphics/Path;
...
.method protected onLevelChange(I)Z
    ...
    invoke-direct {p0, p1}, unpackLevel(I)I

    move-result p1

    invoke-super {p0, p1}, Landroid/graphics/drawable/DrawableWrapper;->onLevelChange(I)Z

    invoke-direct {p0}, updateAnimation()V

    iget-object p1, p0, mForegroundPaint:Landroid/graphics/Paint;
...
.method public setDarkIntensity(F)V
    ...
    :cond_0
    invoke-direct {p0, p1}, getFillColor(F)I
...
.method public setTintList(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v0, p0, mForegroundPaint:Landroid/graphics/Paint;

    invoke-virtual {v0}, Landroid/graphics/Paint;->getColor()I

    move-result v0

    iget-object v1, p0, mForegroundPaint:Landroid/graphics/Paint;
