...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mCurrentSession:Lcom/android/systemui/analytics/SensorLoggerSession;

    const/4 v1, 0x0

    iput-boolean v1, p0, mEnableCollector:Z

    iput-boolean v1, p0, mCollectBadTouches:Z

    iput-boolean v1, p0, mCornerSwiping:Z

    iput-boolean v1, p0, mTrackingStarted:Z

    iput-boolean v1, p0, mAllowReportRejectedTouch:Z

    iput-boolean v1, p0, mDisableUnlocking:Z

    iput-object v0, p0, mFalsingPlugin:Lcom/android/systemui/plugins/FalsingPlugin;
    ...
    iput-object v0, p0, mPluginListener:Lcom/android/systemui/plugins/PluginListener;
    ...
    iget-object p0, p0, mPluginListener:Lcom/android/systemui/plugins/PluginListener;
...
.method static synthetic access$100(Lcom/android/systemui/analytics/DataCollector;)Lcom/android/systemui/plugins/FalsingPlugin;
    ...
    iget-object p0, p0, mFalsingPlugin:Lcom/android/systemui/plugins/FalsingPlugin;
...
.method static synthetic access$102(Lcom/android/systemui/analytics/DataCollector;Lcom/android/systemui/plugins/FalsingPlugin;)Lcom/android/systemui/plugins/FalsingPlugin;
    ...
    iput-object p1, p0, mFalsingPlugin:Lcom/android/systemui/plugins/FalsingPlugin;
...
.method static synthetic access$300(Lcom/android/systemui/analytics/DataCollector;)Z
    ...
    iget-boolean p0, p0, mDisableUnlocking:Z
...
.method static synthetic access$400(Lcom/android/systemui/analytics/DataCollector;)Z
    ...
    iget-boolean p0, p0, mCollectBadTouches:Z
...
.method private addEvent(I)V
    ...
    iget-object p0, p0, mCurrentSession:Lcom/android/systemui/analytics/SensorLoggerSession;
...
.method public static getInstance(Landroid/content/Context;)Lcom/android/systemui/analytics/DataCollector;
    ...
    sget-object v0, sInstance:Lcom/android/systemui/analytics/DataCollector;
    ...
    sput-object v0, sInstance:Lcom/android/systemui/analytics/DataCollector;

    :cond_0
    sget-object p0, sInstance:Lcom/android/systemui/analytics/DataCollector;
...
.method private onSessionEnd(I)V
    ...
    iget-object v0, p0, mCurrentSession:Lcom/android/systemui/analytics/SensorLoggerSession;

    const/4 v1, 0x0

    iput-object v1, p0, mCurrentSession:Lcom/android/systemui/analytics/SensorLoggerSession;

    iget-boolean v1, p0, mEnableCollector:Z

    if-nez v1, :cond_0

    iget-boolean v1, p0, mDisableUnlocking:Z
    ...
    invoke-direct {p0, v0}, queueSession(Lcom/android/systemui/analytics/SensorLoggerSession;)V
...
.method private onSessionStart()V
    ...
    iput-boolean v0, p0, mCornerSwiping:Z

    iput-boolean v0, p0, mTrackingStarted:Z
...
.method private sessionExitpoint(I)V
    ...
    invoke-direct {p0, p1}, onSessionEnd(I)V
...
.method private updateConfiguration()V
    ...
    :goto_0
    iput-boolean v0, p0, mEnableCollector:Z

    iget-boolean v0, p0, mEnableCollector:Z
    ...
    :goto_1
    iput-boolean v0, p0, mCollectBadTouches:Z
    ...
    :goto_2
    iput-boolean v0, p0, mAllowReportRejectedTouch:Z
...
.method public isEnabled()Z
    ...
    iget-boolean v0, p0, mAllowReportRejectedTouch:Z
...
.method public isEnabledFull()Z
    ...
    iget-boolean p0, p0, mEnableCollector:Z
...
.method public isReportingEnabled()Z
    ...
    iget-boolean p0, p0, mAllowReportRejectedTouch:Z
...
.method public onAffordanceSwipingAborted()V
    ...
    iget-boolean v0, p0, mCornerSwiping:Z
    ...
    invoke-direct {p0, v0}, addEvent(I)V
...
.method public onAffordanceSwipingStarted(Z)V
    ...
    invoke-direct {p0, p1}, addEvent(I)V
...
.method public onScreenOff()V
    ...
    invoke-direct {p0, v0}, sessionExitpoint(I)V
...
.method public onTrackingStopped()V
    ...
    iget-boolean v0, p0, mTrackingStarted:Z
