...
.method constructor <init>()V
    ...
    iput-object v0, p0, mRunning:[Ljava/lang/String;

    const-wide/16 v0, 0x0

    iput-wide v0, p0, mServiceStartTime:J
    ...
    iput-object v0, p0, mImportantNotifications:Landroid/util/ArrayMap;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0, v1}, Landroid/util/ArrayMap;-><init>(I)V

    iput-object v0, p0, mStandardLayoutNotifications:Landroid/util/ArrayMap;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0, v1}, Landroid/util/ArrayMap;-><init>(I)V

    iput-object v0, p0, mAppOps:Landroid/util/ArrayMap;
...
.method public addImportantNotification(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, p0, mImportantNotifications:Landroid/util/ArrayMap;

    invoke-virtual {p0, v0, p1, p2}, addNotification(Landroid/util/ArrayMap;Ljava/lang/String;Ljava/lang/String;)V
...
.method public addOp(Ljava/lang/String;I)V
    ...
    iget-object v0, p0, mAppOps:Landroid/util/ArrayMap;
    ...
    :cond_0
    iget-object p0, p0, mAppOps:Landroid/util/ArrayMap;
...
.method public addStandardLayoutNotification(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, p0, mStandardLayoutNotifications:Landroid/util/ArrayMap;
...
.method public getStandardLayoutKey(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object p0, p0, mStandardLayoutNotifications:Landroid/util/ArrayMap;
...
.method public isDisclosureNeeded()Z
    ...
    iget-object v0, p0, mRunning:[Ljava/lang/String;
    ...
    iget-wide v4, p0, mServiceStartTime:J
    ...
    iget-object v5, p0, mImportantNotifications:Landroid/util/ArrayMap;
...
.method public removeImportantNotification(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v0, p1, p2}, removeNotification(Landroid/util/ArrayMap;Ljava/lang/String;Ljava/lang/String;)Z
...
.method public removeNotification(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1, p2}, removeImportantNotification(Ljava/lang/String;Ljava/lang/String;)Z

    move-result v0

    or-int/lit8 v0, v0, 0x0

    invoke-virtual {p0, p1, p2}, removeStandardLayoutNotification(Ljava/lang/String;Ljava/lang/String;)Z
...
.method public setRunningServices([Ljava/lang/String;J)V
    ...
    :goto_0
    iput-object p1, p0, mRunning:[Ljava/lang/String;

    iput-wide p2, p0, mServiceStartTime:J
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, mRunning:[Ljava/lang/String;
    ...
    iget-wide v1, p0, mServiceStartTime:J
    ...
    iget-object v1, p0, mImportantNotifications:Landroid/util/ArrayMap;
