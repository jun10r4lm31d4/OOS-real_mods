...
.method static constructor <clinit>()V
    ...
    sput-wide v0, SEVEN_MINUTES_MILLIS:J
    ...
    sput-wide v0, FIFTEEN_MINUTES_MILLIS:J
    ...
    sput-wide v3, TWO_DAYS_MILLIS:J
    ...
    sput-wide v0, ONE_HOUR_MILLIS:J
...
.method public static getBatteryRemainingShortStringFormatted(Landroid/content/Context;J)Ljava/lang/String;
    ...
    :cond_0
    sget-wide v0, ONE_DAY_MILLIS:J

    cmp-long v0, p1, v0

    if-gtz v0, :cond_1

    invoke-static {p0, p1, p2}, getRegularTimeRemainingShortString(Landroid/content/Context;J)Ljava/lang/String;
    ...
    invoke-static {p0, p1, p2, v0}, getMoreThanOneDayShortString(Landroid/content/Context;JI)Ljava/lang/String;
...
.method public static getBatteryRemainingStringFormatted(Landroid/content/Context;JLjava/lang/String;Z)Ljava/lang/String;
    ...
    sget-wide v0, SEVEN_MINUTES_MILLIS:J

    cmp-long v0, p1, v0

    if-gtz v0, :cond_0

    invoke-static {p0, p3}, getShutdownImminentString(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    sget-wide v0, FIFTEEN_MINUTES_MILLIS:J
    ...
    invoke-static {p0, p1, p3}, getUnderFifteenString(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_1
    sget-wide v0, TWO_DAYS_MILLIS:J

    cmp-long v0, p1, v0

    if-ltz v0, :cond_2

    invoke-static {p0, p3}, getMoreThanTwoDaysString(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, p1, p2, p3, p4}, getMoreThanOneDayString(Landroid/content/Context;JLjava/lang/String;Z)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {p0, p1, p2, p3, p4}, getRegularTimeRemainingString(Landroid/content/Context;JLjava/lang/String;Z)Ljava/lang/String;
...
.method private static getDateTimeStringFromMs(Landroid/content/Context;J)Ljava/lang/CharSequence;
    ...
    sget-wide p1, FIFTEEN_MINUTES_MILLIS:J

    invoke-static {v0, v1, p1, p2}, roundTimeToNearestThreshold(JJ)J
...
.method private static getMoreThanOneDayShortString(Landroid/content/Context;JI)Ljava/lang/String;
    ...
    sget-wide v0, ONE_HOUR_MILLIS:J

    invoke-static {p1, p2, v0, v1}, roundTimeToNearestThreshold(JJ)J
...
.method private static getRegularTimeRemainingString(Landroid/content/Context;JLjava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-static {p0, p1, p2}, getDateTimeStringFromMs(Landroid/content/Context;J)Ljava/lang/CharSequence;
