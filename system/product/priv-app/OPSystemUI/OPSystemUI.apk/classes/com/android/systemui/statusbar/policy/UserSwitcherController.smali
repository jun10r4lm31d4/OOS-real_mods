...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/statusbar/policy/KeyguardMonitor;Landroid/os/Handler;Lcom/android/systemui/plugins/ActivityStarter;)V
    ...
    iput-object v0, p0, mAdapters:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, mGuestResumeSessionReceiver:Lcom/android/systemui/GuestResumeSessionReceiver;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mUsers:Ljava/util/ArrayList;

    const/4 v0, 0x0

    iput v0, p0, mLastNonGuestUser:I

    const/4 v1, 0x1

    iput-boolean v1, p0, mResumeUserOnGuestLogout:Z

    const/16 v2, -0x2710

    iput v2, p0, mSecondaryUser:I
    ...
    iput-object v3, p0, mForcePictureLoadForUserId:Landroid/util/SparseBooleanArray;
    ...
    iput-object v3, p0, mUnpauseRefreshUsers:Ljava/lang/Runnable;
    ...
    iput-object v3, p0, mSettingsObserver:Landroid/database/ContentObserver;
    ...
    iput-object v3, p0, userDetailAdapter:Lcom/android/systemui/plugins/qs/DetailAdapter;
    ...
    iput-object v3, p0, mCallback:Lcom/android/systemui/statusbar/policy/KeyguardMonitor$Callback;
    ...
    iget-object v3, p0, mGuestResumeSessionReceiver:Lcom/android/systemui/GuestResumeSessionReceiver;
    ...
    iput-object p4, p0, mActivityStarter:Lcom/android/systemui/plugins/ActivityStarter;
    ...
    iput-object p3, p0, mSecondaryUserServiceIntent:Landroid/content/Intent;
    ...
    iget-object p4, p0, mSettingsObserver:Landroid/database/ContentObserver;
    ...
    iget-object p1, p0, mSettingsObserver:Landroid/database/ContentObserver;

    invoke-virtual {p1, v0}, Landroid/database/ContentObserver;->onChange(Z)V

    iget-object p1, p0, mCallback:Lcom/android/systemui/statusbar/policy/KeyguardMonitor$Callback;
    ...
    invoke-direct {p0, v2}, refreshUsers(I)V
...
.method static synthetic access$000(Lcom/android/systemui/statusbar/policy/UserSwitcherController;)Z
    ...
    iget-boolean p0, p0, mSimpleUserSwitcher:Z
...
.method static synthetic access$002(Lcom/android/systemui/statusbar/policy/UserSwitcherController;Z)Z
    ...
    iput-boolean p1, p0, mSimpleUserSwitcher:Z
...
.method static synthetic access$100(Lcom/android/systemui/statusbar/policy/UserSwitcherController;Lcom/android/systemui/statusbar/policy/UserSwitcherController$UserRecord;)V
    ...
    invoke-direct {p0, p1}, checkIfAddUserDisallowedByAdminOnly(Lcom/android/systemui/statusbar/policy/UserSwitcherController$UserRecord;)V
...
.method static synthetic access$1002(Lcom/android/systemui/statusbar/policy/UserSwitcherController;Z)Z
    ...
    iput-boolean p1, p0, mPauseRefreshUsers:Z
...
.method static synthetic access$1102(Lcom/android/systemui/statusbar/policy/UserSwitcherController;Z)Z
    ...
    iput-boolean p1, p0, mAddUsersWhenLocked:Z
...
.method static synthetic access$200(Lcom/android/systemui/statusbar/policy/UserSwitcherController;)Ljava/util/ArrayList;
    ...
    iget-object p0, p0, mUsers:Ljava/util/ArrayList;
...
.method static synthetic access$202(Lcom/android/systemui/statusbar/policy/UserSwitcherController;Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    iput-object p1, p0, mUsers:Ljava/util/ArrayList;
...
.method static synthetic access$300(Lcom/android/systemui/statusbar/policy/UserSwitcherController;)V
    ...
    invoke-direct {p0}, notifyAdapters()V
...
.method static synthetic access$400(Lcom/android/systemui/statusbar/policy/UserSwitcherController;I)V
    ...
    invoke-direct {p0, p1}, refreshUsers(I)V
...
.method static synthetic access$500(Lcom/android/systemui/statusbar/policy/UserSwitcherController;)Landroid/app/Dialog;
    ...
    iget-object p0, p0, mExitGuestDialog:Landroid/app/Dialog;
...
.method static synthetic access$502(Lcom/android/systemui/statusbar/policy/UserSwitcherController;Landroid/app/Dialog;)Landroid/app/Dialog;
    ...
    iput-object p1, p0, mExitGuestDialog:Landroid/app/Dialog;
...
.method static synthetic access$602(Lcom/android/systemui/statusbar/policy/UserSwitcherController;I)I
    ...
    iput p1, p0, mLastNonGuestUser:I
...
.method static synthetic access$800(Lcom/android/systemui/statusbar/policy/UserSwitcherController;)Landroid/content/Intent;
    ...
    iget-object p0, p0, mSecondaryUserServiceIntent:Landroid/content/Intent;
...
.method static synthetic access$900(Lcom/android/systemui/statusbar/policy/UserSwitcherController;)Ljava/lang/Runnable;
    ...
    iget-object p0, p0, mUnpauseRefreshUsers:Ljava/lang/Runnable;
...
.method private notifyAdapters()V
    ...
    iget-object v0, p0, mAdapters:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, mAdapters:Ljava/util/ArrayList;
...
.method private pauseRefreshUsers()V
    ...
    iget-boolean v0, p0, mPauseRefreshUsers:Z

    if-nez v0, :cond_0

    iget-object v0, p0, mHandler:Landroid/os/Handler;

    iget-object v1, p0, mUnpauseRefreshUsers:Ljava/lang/Runnable;
    ...
    iput-boolean v0, p0, mPauseRefreshUsers:Z
...
.method private refreshUsers(I)V
    ...
    iget-object v1, p0, mForcePictureLoadForUserId:Landroid/util/SparseBooleanArray;

    invoke-virtual {v1, p1, v0}, Landroid/util/SparseBooleanArray;->put(IZ)V

    :cond_0
    iget-boolean p1, p0, mPauseRefreshUsers:Z
    ...
    :cond_1
    iget-object p1, p0, mForcePictureLoadForUserId:Landroid/util/SparseBooleanArray;
    ...
    iget-object v2, p0, mUsers:Ljava/util/ArrayList;
    ...
    iget-object v5, p0, mUsers:Ljava/util/ArrayList;
    ...
    iget-object v7, p0, mForcePictureLoadForUserId:Landroid/util/SparseBooleanArray;
    ...
    iget-boolean p1, p0, mAddUsersWhenLocked:Z
...
.method private showExitGuestDialog(I)V
    ...
    iget-boolean v0, p0, mResumeUserOnGuestLogout:Z

    if-eqz v0, :cond_0

    iget v0, p0, mLastNonGuestUser:I
    ...
    :goto_0
    invoke-virtual {p0, p1, v0}, showExitGuestDialog(II)V
...
.method public addAdapter(Ljava/lang/ref/WeakReference;)V
    ...
    iget-object p0, p0, mAdapters:Ljava/util/ArrayList;
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget p3, p0, mLastNonGuestUser:I
    ...
    iget-object p1, p0, mUsers:Ljava/util/ArrayList;
    ...
    :goto_0
    iget-object p3, p0, mUsers:Ljava/util/ArrayList;
...
.method protected exitGuest(II)V
    ...
    invoke-virtual {p0, p2}, switchToUserId(I)V
...
.method public getCurrentUserName(Landroid/content/Context;)Ljava/lang/String;
    ...
    iget-object v0, p0, mUsers:Ljava/util/ArrayList;
...
.method public getSwitchableUserCount()I
    ...
    iget-object v3, p0, mUsers:Ljava/util/ArrayList;
...
.method public onDensityOrFontScaleChanged()V
    ...
    invoke-direct {p0, v0}, refreshUsers(I)V
...
.method public showAddUserDialog()V
    ...
    iget-object v0, p0, mAddUserDialog:Landroid/app/Dialog;
    ...
    iput-object v0, p0, mAddUserDialog:Landroid/app/Dialog;

    iget-object p0, p0, mAddUserDialog:Landroid/app/Dialog;
...
.method protected showExitGuestDialog(II)V
    ...
    iget-object v0, p0, mExitGuestDialog:Landroid/app/Dialog;
    ...
    iput-object v0, p0, mExitGuestDialog:Landroid/app/Dialog;
...
.method public switchTo(Lcom/android/systemui/statusbar/policy/UserSwitcherController$UserRecord;)V
    ...
    invoke-virtual {p0}, showAddUserDialog()V
    ...
    invoke-direct {p0, v0}, showExitGuestDialog(I)V
    ...
    invoke-virtual {p0, v1, p1}, showExitGuestDialog(II)V

    return-void

    :cond_4
    invoke-virtual {p0, v0}, switchToUserId(I)V
...
.method protected switchToUserId(I)V
    ...
    :cond_0
    invoke-direct {p0}, pauseRefreshUsers()V
