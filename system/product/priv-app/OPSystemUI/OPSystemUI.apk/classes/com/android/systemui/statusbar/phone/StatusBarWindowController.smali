...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0, v1, v2}, <init>(Landroid/content/Context;Landroid/view/WindowManager;Landroid/app/IActivityManager;Lcom/android/systemui/statusbar/phone/DozeParameters;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/WindowManager;Landroid/app/IActivityManager;Lcom/android/systemui/statusbar/phone/DozeParameters;)V
    ...
    iput-object v0, p0, mCurrentState:Lcom/android/systemui/statusbar/phone/StatusBarWindowController$State;
    ...
    iput-object v0, p0, mStateListener:Lcom/android/systemui/plugins/statusbar/StatusBarStateController$StateListener;

    iput-object p1, p0, mContext:Landroid/content/Context;

    iput-object p2, p0, mWindowManager:Landroid/view/WindowManager;

    iput-object p3, p0, mActivityManager:Landroid/app/IActivityManager;

    invoke-direct {p0}, shouldEnableKeyguardScreenRotation()Z

    move-result p1

    iput-boolean p1, p0, mKeyguardScreenRotation:Z

    iput-object p4, p0, mDozeParameters:Lcom/android/systemui/statusbar/phone/DozeParameters;
    ...
    iput p1, p0, mScreenBrightnessDoze:F

    new-instance p1, Landroid/view/WindowManager$LayoutParams;

    invoke-direct {p1}, Landroid/view/WindowManager$LayoutParams;-><init>()V

    iput-object p1, p0, mLpChanged:Landroid/view/WindowManager$LayoutParams;
    ...
    iget-object p2, p0, mStateListener:Lcom/android/systemui/plugins/statusbar/StatusBarStateController$StateListener;
...
.method private adjustScreenOrientation(Lcom/android/systemui/statusbar/phone/StatusBarWindowController$State;)V
    ...
    :cond_1
    iget-object p0, p0, mLpChanged:Landroid/view/WindowManager$LayoutParams;
    ...
    :cond_2
    :goto_0
    iget-boolean p1, p0, mKeyguardScreenRotation:Z
...
.method private apply(Lcom/android/systemui/statusbar/phone/StatusBarWindowController$State;)V
    ...
    invoke-direct {p0, p1}, applyKeyguardFlags(Lcom/android/systemui/statusbar/phone/StatusBarWindowController$State;)V

    invoke-direct {p0, p1}, applyForceStatusBarVisibleFlag(Lcom/android/systemui/statusbar/phone/StatusBarWindowController$State;)V

    invoke-direct {p0, p1}, applyFocusableFlag(Lcom/android/systemui/statusbar/phone/StatusBarWindowController$State;)V

    invoke-direct {p0, p1}, applyForceShowNavigationFlag(Lcom/android/systemui/statusbar/phone/StatusBarWindowController$State;)V

    invoke-direct {p0, p1}, adjustScreenOrientation(Lcom/android/systemui/statusbar/phone/StatusBarWindowController$State;)V

    invoke-direct {p0, p1}, applyHeight(Lcom/android/systemui/statusbar/phone/StatusBarWindowController$State;)V

    invoke-direct {p0, p1}, applyUserActivityTimeout(Lcom/android/systemui/statusbar/phone/StatusBarWindowController$State;)V

    invoke-direct {p0, p1}, applyInputFeatures(Lcom/android/systemui/statusbar/phone/StatusBarWindowController$State;)V

    invoke-direct {p0, p1}, applyFitsSystemWindows(Lcom/android/systemui/statusbar/phone/StatusBarWindowController$State;)V

    invoke-direct {p0, p1}, applyModalFlag(Lcom/android/systemui/statusbar/phone/StatusBarWindowController$State;)V

    invoke-direct {p0, p1}, applyBrightness(Lcom/android/systemui/statusbar/phone/StatusBarWindowController$State;)V

    invoke-direct {p0, p1}, applyHasTopUi(Lcom/android/systemui/statusbar/phone/StatusBarWindowController$State;)V

    invoke-direct {p0, p1}, applySleepToken(Lcom/android/systemui/statusbar/phone/StatusBarWindowController$State;)V

    invoke-direct {p0, p1}, applyNotTouchable(Lcom/android/systemui/statusbar/phone/StatusBarWindowController$State;)V

    invoke-direct {p0, p1}, applyStatusBarColorSpaceAgnosticFlag(Lcom/android/systemui/statusbar/phone/StatusBarWindowController$State;)V

    iget-object p1, p0, mLp:Landroid/view/WindowManager$LayoutParams;

    if-eqz p1, :cond_0

    iget-object v0, p0, mLpChanged:Landroid/view/WindowManager$LayoutParams;
    ...
    iget-object v0, p0, mStatusBarView:Landroid/view/ViewGroup;

    iget-object v1, p0, mLp:Landroid/view/WindowManager$LayoutParams;

    invoke-interface {p1, v0, v1}, Landroid/view/WindowManager;->updateViewLayout(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    :cond_0
    iget-boolean p1, p0, mHasTopUi:Z

    iget-boolean v0, p0, mHasTopUiChanged:Z

    if-eq p1, v0, :cond_1

    :try_start_0
    iget-object p1, p0, mActivityManager:Landroid/app/IActivityManager;
    ...
    :goto_0
    iget-boolean p1, p0, mHasTopUiChanged:Z

    iput-boolean p1, p0, mHasTopUi:Z

    :cond_1
    invoke-virtual {p0}, notifyStateChangedCallbacks()V
...
.method private applyBrightness(Lcom/android/systemui/statusbar/phone/StatusBarWindowController$State;)V
    ...
    iget-object p1, p0, mLpChanged:Landroid/view/WindowManager$LayoutParams;

    iget p0, p0, mScreenBrightnessDoze:F
...
.method private applyFitsSystemWindows(Lcom/android/systemui/statusbar/phone/StatusBarWindowController$State;)V
    ...
    iget-object p0, p0, mStatusBarView:Landroid/view/ViewGroup;
...
.method private applyForceStatusBarVisibleFlag(Lcom/android/systemui/statusbar/phone/StatusBarWindowController$State;)V
    ...
    invoke-direct {p0, p1}, isExpanded(Lcom/android/systemui/statusbar/phone/StatusBarWindowController$State;)Z
    ...
    iget-object v1, p0, mListener:Lcom/android/systemui/statusbar/phone/StatusBarWindowController$OtherwisedCollapsedListener;
...
.method private applyHasTopUi(Lcom/android/systemui/statusbar/phone/StatusBarWindowController$State;)V
    ...
    iput-boolean p1, p0, mHasTopUiChanged:Z
...
.method private applyHeight(Lcom/android/systemui/statusbar/phone/StatusBarWindowController$State;)V
    ...
    iget-object p1, p0, mListener:Lcom/android/systemui/statusbar/phone/StatusBarWindowController$OtherwisedCollapsedListener;
...
.method private applyKeyguardFlags(Lcom/android/systemui/statusbar/phone/StatusBarWindowController$State;)V
    ...
    iget-object v1, p0, mDozeParameters:Lcom/android/systemui/statusbar/phone/DozeParameters;
...
.method private setStatusBarState(I)V
    ...
    iget-object v0, p0, mCurrentState:Lcom/android/systemui/statusbar/phone/StatusBarWindowController$State;

    iput p1, v0, Lcom/android/systemui/statusbar/phone/StatusBarWindowController$State;->statusBarState:I

    invoke-direct {p0, v0}, apply(Lcom/android/systemui/statusbar/phone/StatusBarWindowController$State;)V
...
.method public add(Landroid/view/ViewGroup;I)V
    ...
    iput-object v6, p0, mLp:Landroid/view/WindowManager$LayoutParams;

    iget-object v0, p0, mLp:Landroid/view/WindowManager$LayoutParams;
    ...
    iput-object p1, p0, mStatusBarView:Landroid/view/ViewGroup;

    iput p2, p0, mBarHeight:I

    iget-object p1, p0, mWindowManager:Landroid/view/WindowManager;

    iget-object p2, p0, mStatusBarView:Landroid/view/ViewGroup;

    invoke-interface {p1, p2, v0}, Landroid/view/WindowManager;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    iget-object p1, p0, mLpChanged:Landroid/view/WindowManager$LayoutParams;

    iget-object p2, p0, mLp:Landroid/view/WindowManager$LayoutParams;
...
.method public debugBarHeight()V
    ...
    iget-object v1, p0, mCurrentState:Lcom/android/systemui/statusbar/phone/StatusBarWindowController$State;
    ...
    iget-object p0, p0, mCurrentState:Lcom/android/systemui/statusbar/phone/StatusBarWindowController$State;
...
.method public notifyStateChangedCallbacks()V
    ...
    iget-object v2, p0, mCurrentState:Lcom/android/systemui/statusbar/phone/StatusBarWindowController$State;
...
.method public onThemeChanged()V
    ...
    invoke-direct {p0, v0}, setKeyguardDark(Z)V
...
.method public setBarHeight(I)V
    ...
    iput p1, p0, mBarHeight:I

    iget-object p1, p0, mCurrentState:Lcom/android/systemui/statusbar/phone/StatusBarWindowController$State;

    invoke-direct {p0, p1}, apply(Lcom/android/systemui/statusbar/phone/StatusBarWindowController$State;)V
...
.method public setStateListener(Lcom/android/systemui/statusbar/phone/StatusBarWindowController$OtherwisedCollapsedListener;)V
    ...
    iput-object p1, p0, mListener:Lcom/android/systemui/statusbar/phone/StatusBarWindowController$OtherwisedCollapsedListener;
