...
.method static constructor <clinit>()V
    ...
    sput-object v0, SCROLL_CUBIC:Landroid/view/animation/Interpolator;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p2, p0, mTiles:Ljava/util/ArrayList;

    new-instance p2, Ljava/util/ArrayList;

    invoke-direct {p2}, Ljava/util/ArrayList;-><init>()V

    iput-object p2, p0, mPages:Ljava/util/ArrayList;

    const/4 p2, 0x0

    iput-boolean p2, p0, mDistributeTiles:Z

    const/4 v0, -0x1

    iput v0, p0, mPageToRestore:I

    iput v0, p0, mLastMaxHeight:I
    ...
    iput-object v0, p0, mOnPageChangeListener:Landroidx/viewpager/widget/ViewPager$OnPageChangeListener;
    ...
    iput-object v0, p0, mAdapter:Landroidx/viewpager/widget/PagerAdapter;

    new-instance v0, Landroid/widget/Scroller;

    sget-object v1, SCROLL_CUBIC:Landroid/view/animation/Interpolator;
    ...
    iget-object p1, p0, mOnPageChangeListener:Landroidx/viewpager/widget/ViewPager$OnPageChangeListener;
    ...
    invoke-virtual {p0, p2, p2}, setCurrentItem(IZ)V
    ...
    iput p1, p0, mLayoutOrientation:I
    ...
    iput-object p1, p0, mClippingRect:Landroid/graphics/Rect;
...
.method static synthetic access$002(Lcom/android/systemui/qs/PagedTileLayout;Landroid/animation/AnimatorSet;)Landroid/animation/AnimatorSet;
    ...
    iput-object p1, p0, mBounceAnimatorSet:Landroid/animation/AnimatorSet;
...
.method static synthetic access$100(Lcom/android/systemui/qs/PagedTileLayout;)V
    ...
    invoke-direct {p0}, updateSelected()V
...
.method static synthetic access$300(Lcom/android/systemui/qs/PagedTileLayout;)Lcom/android/systemui/qs/PagedTileLayout$PageListener;
    ...
    iget-object p0, p0, mPageListener:Lcom/android/systemui/qs/PagedTileLayout$PageListener;
...
.method static synthetic access$400(Lcom/android/systemui/qs/PagedTileLayout;)Ljava/util/ArrayList;
    ...
    iget-object p0, p0, mPages:Ljava/util/ArrayList;
...
.method static synthetic access$500(Lcom/android/systemui/qs/PagedTileLayout;)F
    ...
    iget p0, p0, mPageIndicatorPosition:F
...
.method static synthetic access$502(Lcom/android/systemui/qs/PagedTileLayout;F)F
    ...
    iput p1, p0, mPageIndicatorPosition:F
...
.method static synthetic access$600(Lcom/android/systemui/qs/PagedTileLayout;)V
    ...
    invoke-direct {p0}, updateListening()V
...
.method private distributeTiles()V
    ...
    invoke-direct {p0}, emptyAndInflateOrRemovePages()V

    iget-object v0, p0, mPages:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, mTiles:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, mTiles:Ljava/util/ArrayList;
    ...
    iget-object v5, p0, mPages:Ljava/util/ArrayList;
...
.method private emptyAndInflateOrRemovePages()V
    ...
    iget-object v0, p0, mTiles:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->size()I

    move-result v0

    iget-object v1, p0, mPages:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, mPages:Ljava/util/ArrayList;
    ...
    :cond_5
    iget-object v0, p0, mPageIndicator:Lcom/android/systemui/qs/PageIndicator;
...
.method private updateSelected()V
    ...
    invoke-direct {p0}, getCurrentPageNumber()I
...
.method public addTile(Lcom/android/systemui/qs/QSPanel$TileRecord;)V
    ...
    iput-boolean p1, p0, mDistributeTiles:Z
...
.method public computeScroll()V
    ...
    iget-object v0, p0, mBounceAnimatorSet:Landroid/animation/AnimatorSet;
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget v0, p0, mLayoutOrientation:I
    ...
    invoke-virtual {p0, p1, p1}, setCurrentItem(IZ)V

    iput p1, p0, mPageToRestore:I
...
.method protected onLayout(ZIIII)V
    ...
    iget-object p1, p0, mClippingRect:Landroid/graphics/Rect;

    iget v0, p0, mHorizontalClipBound:I
...
.method protected onMeasure(II)V
    ...
    iget-boolean v1, p0, mDistributeTiles:Z

    const/4 v2, 0x0

    if-nez v1, :cond_0

    iget v1, p0, mLastMaxHeight:I
    ...
    iget-boolean v0, p0, mDistributeTiles:Z

    if-eqz v0, :cond_2

    :cond_1
    iput-boolean v2, p0, mDistributeTiles:Z

    invoke-direct {p0}, distributeTiles()V
    ...
    :goto_0
    iget-object v3, p0, mPages:Ljava/util/ArrayList;
...
.method public setPageIndicator(Lcom/android/systemui/qs/PageIndicator;)V
    ...
    iput-object p1, p0, mPageIndicator:Lcom/android/systemui/qs/PageIndicator;

    iget-object p1, p0, mPageIndicator:Lcom/android/systemui/qs/PageIndicator;
...
.method public setPageListener(Lcom/android/systemui/qs/PagedTileLayout$PageListener;)V
    ...
    iput-object p1, p0, mPageListener:Lcom/android/systemui/qs/PagedTileLayout$PageListener;
...
.method public startTileReveal(Ljava/util/Set;Ljava/lang/Runnable;)V
    ...
    invoke-static {v3, v4}, setupBounceAnimator(Landroid/view/View;I)Landroid/animation/Animator;
    ...
    iget-object p1, p0, mBounceAnimatorSet:Landroid/animation/AnimatorSet;
...
.method public updateResources()Z
    ...
    iput v0, p0, mHorizontalClipBound:I
    ...
    :goto_0
    iget-object v2, p0, mPages:Ljava/util/ArrayList;
    ...
    iput-boolean v1, p0, mDistributeTiles:Z
