...
.method public constructor <init>(Landroid/content/Context;Ldagger/Lazy;Ldagger/Lazy;Lcom/android/systemui/statusbar/notification/NotificationEntryManager;Lcom/android/systemui/statusbar/MediaArtworkProcessor;)V
    ...
    iput-object v0, p0, mProcessArtworkTasks:Ljava/util/Set;
    ...
    iput-object v0, p0, mPropertiesChangedListener:Landroid/provider/DeviceConfig$OnPropertiesChangedListener;
    ...
    iput-object v0, p0, mMediaListener:Landroid/media/session/MediaController$Callback;
    ...
    iput-object v0, p0, mHideBackdropFront:Ljava/lang/Runnable;

    iput-object p1, p0, mContext:Landroid/content/Context;

    iput-object p5, p0, mMediaArtworkProcessor:Lcom/android/systemui/statusbar/MediaArtworkProcessor;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, mMediaListeners:Ljava/util/ArrayList;
    ...
    iput-object p1, p0, mMediaSessionManager:Landroid/media/session/MediaSessionManager;

    iput-object p2, p0, mShadeController:Ldagger/Lazy;

    iput-object p3, p0, mStatusBarWindowController:Ldagger/Lazy;

    iput-object p4, p0, mEntryManager:Lcom/android/systemui/statusbar/notification/NotificationEntryManager;
    ...
    iput-boolean p2, p0, mShowCompactMediaSeekbar:Z
    ...
    iget-object p0, p0, mPropertiesChangedListener:Landroid/provider/DeviceConfig$OnPropertiesChangedListener;
...
.method static synthetic access$002(Lcom/android/systemui/statusbar/NotificationMediaManager;Z)Z
    ...
    iput-boolean p1, p0, mShowCompactMediaSeekbar:Z
...
.method static synthetic access$100(Lcom/android/systemui/statusbar/NotificationMediaManager;I)Z
    ...
    invoke-direct {p0, p1}, isPlaybackActive(I)Z
...
.method static synthetic access$200(Lcom/android/systemui/statusbar/NotificationMediaManager;ZZ)V
    ...
    invoke-direct {p0, p1, p2}, dispatchUpdateMediaMetaData(ZZ)V
...
.method static synthetic access$300(Lcom/android/systemui/statusbar/NotificationMediaManager;)Lcom/android/systemui/statusbar/MediaArtworkProcessor;
    ...
    iget-object p0, p0, mMediaArtworkProcessor:Lcom/android/systemui/statusbar/MediaArtworkProcessor;
...
.method static synthetic access$500(Lcom/android/systemui/statusbar/NotificationMediaManager;)Landroid/widget/ImageView;
    ...
    iget-object p0, p0, mBackdropFront:Landroid/widget/ImageView;
...
.method static synthetic access$600(Lcom/android/systemui/statusbar/NotificationMediaManager;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {p0, p1}, processArtwork(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
...
.method static synthetic access$700(Lcom/android/systemui/statusbar/NotificationMediaManager;Landroid/os/AsyncTask;)V
    ...
    invoke-direct {p0, p1}, removeTask(Landroid/os/AsyncTask;)V
...
.method static synthetic access$800(Lcom/android/systemui/statusbar/NotificationMediaManager;ZZLandroid/graphics/Bitmap;)V
    ...
    invoke-direct {p0, p1, p2, p3}, finishUpdateMediaMetaData(ZZLandroid/graphics/Bitmap;)V
...
.method private clearCurrentMediaNotificationSession()V
    ...
    iget-object v0, p0, mMediaArtworkProcessor:Lcom/android/systemui/statusbar/MediaArtworkProcessor;

    invoke-virtual {v0}, Lcom/android/systemui/statusbar/MediaArtworkProcessor;->clearCache()V

    const/4 v0, 0x0

    iput-object v0, p0, mMediaMetadata:Landroid/media/MediaMetadata;

    iget-object v1, p0, mMediaController:Landroid/media/session/MediaController;

    if-eqz v1, :cond_1

    sget-boolean v1, DEBUG_MEDIA:Z
    ...
    iget-object v2, p0, mMediaController:Landroid/media/session/MediaController;
    ...
    iget-object v2, p0, mMediaListener:Landroid/media/session/MediaController$Callback;

    invoke-virtual {v1, v2}, Landroid/media/session/MediaController;->unregisterCallback(Landroid/media/session/MediaController$Callback;)V

    :cond_1
    iput-object v0, p0, mMediaController:Landroid/media/session/MediaController;
...
.method private dispatchUpdateMediaMetaData(ZZ)V
    ...
    :cond_0
    iget-object p1, p0, mMediaController:Landroid/media/session/MediaController;

    invoke-direct {p0, p1}, getMediaControllerPlaybackState(Landroid/media/session/MediaController;)I

    move-result p1

    new-instance p2, Ljava/util/ArrayList;

    iget-object v0, p0, mMediaListeners:Ljava/util/ArrayList;
...
.method private finishUpdateMediaMetaData(ZZLandroid/graphics/Bitmap;)V
    ...
    iget-object v2, p0, mBackdropBack:Landroid/widget/ImageView;
    ...
    iget-object v4, p0, mLockscreenWallpaper:Lcom/android/systemui/statusbar/phone/LockscreenWallpaper;
    ...
    iget-object v5, p0, mBackdropBack:Landroid/widget/ImageView;
    ...
    iget-object v4, p0, mStatusBarStateController:Lcom/android/systemui/plugins/statusbar/StatusBarStateController;
    ...
    :goto_3
    iget-object v5, p0, mShadeController:Ldagger/Lazy;
    ...
    iget-object v6, p0, mStatusBarWindowController:Ldagger/Lazy;
    ...
    iget-object v11, p0, mBackdrop:Lcom/android/systemui/statusbar/BackDropView;
    ...
    iget-object v11, p0, mStatusBarStateController:Lcom/android/systemui/plugins/statusbar/StatusBarStateController;
    ...
    iget-object v11, p0, mBiometricUnlockController:Lcom/android/systemui/statusbar/phone/BiometricUnlockController;
    ...
    :cond_8
    iget-object v9, p0, mColorExtractor:Lcom/android/systemui/colorextraction/SysuiColorExtractor;

    invoke-virtual {v9, v3}, Lcom/android/systemui/colorextraction/SysuiColorExtractor;->setHasMediaArtwork(Z)V

    iget-object v3, p0, mScrimController:Lcom/android/systemui/statusbar/phone/ScrimController;
    ...
    :cond_a
    iget-object v8, p0, mStatusBarStateController:Lcom/android/systemui/plugins/statusbar/StatusBarStateController;
    ...
    :cond_b
    iget-object v4, p0, mBiometricUnlockController:Lcom/android/systemui/statusbar/phone/BiometricUnlockController;
    ...
    iget-object v0, p0, mBackdrop:Lcom/android/systemui/statusbar/BackDropView;
    ...
    iget-object p1, p0, mBackdrop:Lcom/android/systemui/statusbar/BackDropView;
    ...
    iget-object p1, p0, mBackdropBack:Landroid/widget/ImageView;
    ...
    iget-object p2, p0, mBackdropFront:Landroid/widget/ImageView;
    ...
    iget-object p1, p0, mBackdropFront:Landroid/widget/ImageView;
    ...
    iget-object p2, p0, mBackdropBack:Landroid/widget/ImageView;
    ...
    iget-object p0, p0, mHideBackdropFront:Ljava/lang/Runnable;
    ...
    :goto_a
    iget-object p1, p0, mBiometricUnlockController:Lcom/android/systemui/statusbar/phone/BiometricUnlockController;
    ...
    iget-object p0, p0, mBackdrop:Lcom/android/systemui/statusbar/BackDropView;
    ...
    iget-object p2, p0, mKeyguardMonitor:Lcom/android/systemui/statusbar/policy/KeyguardMonitor;
    ...
    iget-object p0, p0, mBackdropBack:Landroid/widget/ImageView;
...
.method private removeTask(Landroid/os/AsyncTask;)V
    ...
    iget-object p0, p0, mProcessArtworkTasks:Ljava/util/Set;
...
.method public addCallback(Lcom/android/systemui/statusbar/NotificationMediaManager$MediaListener;)V
    ...
    invoke-direct {p0, v1}, getMediaControllerPlaybackState(Landroid/media/session/MediaController;)I
...
.method public clearCurrentMediaNotification()V
    ...
    iput-object v0, p0, mMediaNotificationKey:Ljava/lang/String;

    invoke-direct {p0}, clearCurrentMediaNotificationSession()V
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object p1, p0, mMediaSessionManager:Landroid/media/session/MediaSessionManager;
    ...
    iget-object p1, p0, mMediaNotificationKey:Ljava/lang/String;
    ...
    iget-object p3, p0, mMediaController:Landroid/media/session/MediaController;
    ...
    iget-object p1, p0, mMediaMetadata:Landroid/media/MediaMetadata;
    ...
    iget-object p0, p0, mMediaMetadata:Landroid/media/MediaMetadata;
...
.method public findAndUpdateMediaNotifications()V
    ...
    invoke-direct {p0, v9}, getMediaControllerPlaybackState(Landroid/media/session/MediaController;)I

    move-result v8

    if-ne v5, v8, :cond_0

    sget-boolean v4, DEBUG_MEDIA:Z
    ...
    iget-object v4, p0, mMediaSessionManager:Landroid/media/session/MediaSessionManager;
    ...
    invoke-direct {p0, v6}, getMediaControllerPlaybackState(Landroid/media/session/MediaController;)I
    ...
    invoke-direct {p0, v2, v9}, sameSessions(Landroid/media/session/MediaController;Landroid/media/session/MediaController;)Z
    ...
    iput-object v9, p0, mMediaController:Landroid/media/session/MediaController;

    iget-object v2, p0, mMediaController:Landroid/media/session/MediaController;

    iget-object v3, p0, mMediaListener:Landroid/media/session/MediaController$Callback;
    ...
    iput-object v2, p0, mMediaMetadata:Landroid/media/MediaMetadata;

    sget-boolean v2, DEBUG_MEDIA:Z
    ...
    iget-object v4, p0, mMediaMetadata:Landroid/media/MediaMetadata;
    ...
    iget-object v4, p0, mMediaNotificationKey:Ljava/lang/String;
    ...
    iput-object v2, p0, mMediaNotificationKey:Ljava/lang/String;
    ...
    iget-object v5, p0, mMediaNotificationKey:Ljava/lang/String;
    ...
    :cond_a
    invoke-direct {p0, v3, v1}, dispatchUpdateMediaMetaData(ZZ)V
...
.method public getMediaIcon()Landroid/graphics/drawable/Icon;
    ...
    iget-object v0, p0, mMediaNotificationKey:Ljava/lang/String;
    ...
    iget-object p0, p0, mMediaNotificationKey:Ljava/lang/String;
...
.method public getShowCompactMediaSeekbar()Z
    ...
    iget-boolean p0, p0, mShowCompactMediaSeekbar:Z
...
.method public synthetic lambda$finishUpdateMediaMetaData$0$NotificationMediaManager()V
    ...
    iget-object v0, p0, mBackdropFront:Landroid/widget/ImageView;
    ...
    iget-object v0, p0, mBackdropBack:Landroid/widget/ImageView;
...
.method public onNotificationRemoved(Ljava/lang/String;)V
    ...
    iget-object v1, p0, mMediaNotificationKey:Ljava/lang/String;
    ...
    invoke-virtual {p0}, clearCurrentMediaNotification()V

    const/4 p1, 0x1

    invoke-direct {p0, p1, p1}, dispatchUpdateMediaMetaData(ZZ)V
...
.method public removeCallback(Lcom/android/systemui/statusbar/NotificationMediaManager$MediaListener;)V
    ...
    iget-object p0, p0, mMediaListeners:Ljava/util/ArrayList;
...
.method public setBiometricUnlockController(Lcom/android/systemui/statusbar/phone/BiometricUnlockController;)V
    ...
    iput-object p1, p0, mBiometricUnlockController:Lcom/android/systemui/statusbar/phone/BiometricUnlockController;
...
.method public setUpWithPresenter(Lcom/android/systemui/statusbar/NotificationPresenter;)V
    ...
    iput-object p1, p0, mPresenter:Lcom/android/systemui/statusbar/NotificationPresenter;
...
.method public setup(Lcom/android/systemui/statusbar/BackDropView;Landroid/widget/ImageView;Landroid/widget/ImageView;Lcom/android/systemui/statusbar/phone/ScrimController;Lcom/android/systemui/statusbar/phone/LockscreenWallpaper;)V
    ...
    iput-object p1, p0, mBackdrop:Lcom/android/systemui/statusbar/BackDropView;

    iput-object p2, p0, mBackdropFront:Landroid/widget/ImageView;

    iput-object p3, p0, mBackdropBack:Landroid/widget/ImageView;

    iput-object p4, p0, mScrimController:Lcom/android/systemui/statusbar/phone/ScrimController;

    iput-object p5, p0, mLockscreenWallpaper:Lcom/android/systemui/statusbar/phone/LockscreenWallpaper;
...
.method public updateMediaMetaData(ZZ)V
    ...
    :cond_2
    invoke-virtual {p0}, getMediaMetadata()Landroid/media/MediaMetadata;

    move-result-object v0

    sget-boolean v3, DEBUG_MEDIA:Z
    ...
    invoke-virtual {p0}, getMediaNotificationKey()Ljava/lang/String;
    ...
    iget-object v5, p0, mStatusBarStateController:Lcom/android/systemui/plugins/statusbar/StatusBarStateController;
    ...
    iget-object v5, p0, mProcessArtworkTasks:Ljava/util/Set;
    ...
    iget-object v5, p0, mKeyguardMonitor:Lcom/android/systemui/statusbar/policy/KeyguardMonitor;
    ...
    :try_start_0
    iget-object v3, p0, mProcessArtworkTasks:Ljava/util/Set;
    ...
    :cond_9
    invoke-direct {p0, p1, p2, v3}, finishUpdateMediaMetaData(ZZLandroid/graphics/Bitmap;)V
