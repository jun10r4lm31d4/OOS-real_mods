...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p1, p0, mTmp2:[I

    const/4 p1, 0x1

    iput-boolean p1, p0, mSwapOrientation:Z
    ...
    iput-object p1, p0, mInsetsListener:Landroid/view/ViewTreeObserver$OnComputeInternalInsetsListener;
...
.method private rotateLeft()V
    ...
    invoke-direct {p0, p0}, rotateLeft(Landroid/view/View;)V

    iget-object v0, p0, mList:Landroid/view/ViewGroup;

    invoke-direct {p0, v0}, rotateLeft(Landroid/view/View;)V

    invoke-direct {p0, p0}, swapDimens(Landroid/view/View;)V
    ...
    invoke-direct {p0, v1}, rotateGravityLeft(I)I

    move-result v1

    iput v1, v0, Landroid/widget/LinearLayout$LayoutParams;->gravity:I

    iget-object v1, p0, mList:Landroid/view/ViewGroup;

    invoke-virtual {v1, v0}, Landroid/view/ViewGroup;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    iget-object v0, p0, mSeparatedView:Landroid/view/ViewGroup;
    ...
    iget-object v1, p0, mSeparatedView:Landroid/view/ViewGroup;
    ...
    invoke-direct {p0, v0}, rotateGravityLeft(I)I
...
.method private rotateRight()V
    ...
    invoke-direct {p0, p0}, rotateRight(Landroid/view/View;)V

    iget-object v0, p0, mList:Landroid/view/ViewGroup;

    invoke-direct {p0, v0}, rotateRight(Landroid/view/View;)V
    ...
    invoke-direct {p0, v1}, rotateGravityRight(I)I
    ...
    invoke-direct {p0, v0}, rotateGravityRight(I)I
...
.method private setCutPoint(I)V
    ...
    iget-object v0, p0, mListBackground:Lcom/android/systemui/HardwareBgDrawable;
    ...
    :cond_1
    iget-object v1, p0, mAnimator:Landroid/animation/Animator;

    if-eqz v1, :cond_3

    iget v2, p0, mEndPoint:I
    ...
    :cond_3
    iput p1, p0, mEndPoint:I

    iget-object v1, p0, mListBackground:Lcom/android/systemui/HardwareBgDrawable;
    ...
    iput-object p1, p0, mAnimator:Landroid/animation/Animator;

    iget-boolean p1, p0, mCollapse:Z

    if-eqz p1, :cond_4

    iget-object p1, p0, mAnimator:Landroid/animation/Animator;

    const-wide/16 v0, 0x12c

    invoke-virtual {p1, v0, v1}, Landroid/animation/Animator;->setStartDelay(J)V

    iput-boolean v3, p0, mCollapse:Z

    :cond_4
    iget-object p0, p0, mAnimator:Landroid/animation/Animator;
    ...
    :cond_5
    :goto_0
    iget-object p0, p0, mListBackground:Lcom/android/systemui/HardwareBgDrawable;
...
.method private updateEdgeMargin(I)V
    ...
    :goto_0
    iget-object v3, p0, mList:Landroid/view/ViewGroup;
    ...
    :goto_1
    iget-object p0, p0, mSeparatedView:Landroid/view/ViewGroup;
...
.method private updatePaddingAndGravityIfTooTall()V
    ...
    iget-object v5, p0, mSeparatedView:Landroid/view/ViewGroup;
...
.method private updatePosition()V
    ...
    iget-object v1, p0, mSeparatedViewBackground:Lcom/android/systemui/HardwareBgDrawable;

    invoke-virtual {v1, v0}, Lcom/android/systemui/HardwareBgDrawable;->setRotatedBackground(Z)V

    iget-object v0, p0, mDivision:Landroid/view/View;
    ...
    iget-boolean v0, p0, mRotatedBackground:Z

    xor-int/lit8 v0, v0, 0x1

    iget-object v1, p0, mDivision:Landroid/view/View;

    iget-object v2, p0, mTmp2:[I

    invoke-virtual {v1, v2}, Landroid/view/View;->getLocationOnScreen([I)V

    iget-boolean v1, p0, mRotatedBackground:Z
    ...
    invoke-direct {p0, v1}, setCutPoint(I)V
    ...
    invoke-direct {p0, v0}, setCutPoint(I)V
...
.method private updateRotation()V
    ...
    invoke-virtual {p0, v1, v0}, rotate(II)V
...
.method private updateSettings()V
    ...
    :goto_0
    iput-boolean v0, p0, mEdgeBleed:Z
    ...
    :goto_1
    iput-boolean v0, p0, mRoundedDivider:Z

    iget-boolean v0, p0, mEdgeBleed:Z
    ...
    :cond_2
    invoke-direct {p0}, getEdgePadding()I

    move-result v1

    :goto_2
    invoke-direct {p0, v1}, updateEdgeMargin(I)V

    new-instance v0, Lcom/android/systemui/HardwareBgDrawable;

    iget-boolean v1, p0, mRoundedDivider:Z

    iget-boolean v3, p0, mEdgeBleed:Z
    ...
    iput-object v0, p0, mListBackground:Lcom/android/systemui/HardwareBgDrawable;
    ...
    iput-object v0, p0, mSeparatedViewBackground:Lcom/android/systemui/HardwareBgDrawable;
...
.method public getAnimationOffsetX()F
    ...
    invoke-direct {p0}, getAnimationDistance()F
...
.method public synthetic lambda$new$5$HardwareUiLayout(Landroid/view/ViewTreeObserver$InternalInsetsInfo;)V
    ...
    iget-object v2, p0, mList:Landroid/view/ViewGroup;
    ...
    iget-object p0, p0, mList:Landroid/view/ViewGroup;
...
.method public synthetic lambda$onMeasure$0$HardwareUiLayout()V
    ...
    invoke-direct {p0}, updatePaddingAndGravityIfTooTall()V
...
.method protected onAttachedToWindow()V
    ...
    iget-object p0, p0, mInsetsListener:Landroid/view/ViewTreeObserver$OnComputeInternalInsetsListener;
...
.method protected onDetachedFromWindow()V
    ...
    iget-object v1, p0, mInsetsListener:Landroid/view/ViewTreeObserver$OnComputeInternalInsetsListener;
...
.method protected onMeasure(II)V
    ...
    iget-object p1, p0, mList:Landroid/view/ViewGroup;
    ...
    invoke-virtual {p0}, getListView()Landroid/view/ViewGroup;

    move-result-object p1

    iput-object p1, p0, mList:Landroid/view/ViewGroup;

    iget-object p1, p0, mList:Landroid/view/ViewGroup;

    iget-object p2, p0, mListBackground:Lcom/android/systemui/HardwareBgDrawable;

    invoke-virtual {p1, p2}, Landroid/view/ViewGroup;->setBackground(Landroid/graphics/drawable/Drawable;)V

    invoke-virtual {p0}, getSeparatedView()Landroid/view/ViewGroup;

    move-result-object p1

    iput-object p1, p0, mSeparatedView:Landroid/view/ViewGroup;

    iget-object p1, p0, mSeparatedView:Landroid/view/ViewGroup;

    iget-object p2, p0, mSeparatedViewBackground:Lcom/android/systemui/HardwareBgDrawable;

    invoke-virtual {p1, p2}, Landroid/view/ViewGroup;->setBackground(Landroid/graphics/drawable/Drawable;)V

    iget-boolean p1, p0, mEdgeBleed:Z
    ...
    :goto_0
    invoke-direct {p0, p1}, updateEdgeMargin(I)V
    ...
    iput p1, p0, mOldHeight:I

    invoke-direct {p0}, updateRotation()V
    ...
    iget p2, p0, mOldHeight:I

    if-eq p1, p2, :cond_3

    invoke-direct {p0, p2, p1}, animateChild(II)V
...
.method protected rotate(II)V
    ...
    invoke-virtual {p0, p1, v0}, rotate(II)V

    invoke-virtual {p0, v0, p2}, rotate(II)V
    ...
    :cond_1
    invoke-direct {p0}, rotateLeft()V

    goto :goto_1

    :cond_2
    :goto_0
    invoke-direct {p0}, rotateRight()V
    ...
    invoke-direct {p0, p1}, rotateRight(Landroid/view/View;)V
    ...
    invoke-direct {p0, p1}, rotateLeft(Landroid/view/View;)V
    ...
    invoke-direct {p0, p1}, swapLeftAndTop(Landroid/view/View;)V
    ...
    iput-boolean v2, p0, mRotatedBackground:Z

    iget-object p1, p0, mListBackground:Lcom/android/systemui/HardwareBgDrawable;

    invoke-virtual {p1, v2}, Lcom/android/systemui/HardwareBgDrawable;->setRotatedBackground(Z)V

    iget-object p1, p0, mSeparatedViewBackground:Lcom/android/systemui/HardwareBgDrawable;
    ...
    iget-boolean p2, p0, mSwapOrientation:Z
    ...
    invoke-direct {p0, p1}, swapDimens(Landroid/view/View;)V
    ...
    iput-boolean v0, p0, mRotatedBackground:Z
