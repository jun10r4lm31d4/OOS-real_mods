...
.method protected constructor <init>(Lcom/android/systemui/statusbar/AlertingNotificationManager;)V
    ...
    iput-object p1, p0, this$0:Lcom/android/systemui/statusbar/AlertingNotificationManager;
...
.method protected calculateFinishTime()J
    ...
    iget-wide v0, p0, mPostTime:J

    iget-object p0, p0, this$0:Lcom/android/systemui/statusbar/AlertingNotificationManager;
...
.method public compareTo(Lcom/android/systemui/statusbar/AlertingNotificationManager$AlertEntry;)I
    ...
    iget-object p1, p1, mEntry:Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;
...
.method public bridge synthetic compareTo(Ljava/lang/Object;)I
    ...
    invoke-virtual {p0, p1}, compareTo(Lcom/android/systemui/statusbar/AlertingNotificationManager$AlertEntry;)I
...
.method public remove()V
    ...
    iget-object v0, p0, mRemoveAlertRunnable:Ljava/lang/Runnable;

    if-eqz v0, :cond_0

    invoke-virtual {p0}, removeAutoRemovalCallbacks()V

    iget-object v0, p0, this$0:Lcom/android/systemui/statusbar/AlertingNotificationManager;

    iget-object v0, v0, Lcom/android/systemui/statusbar/AlertingNotificationManager;->mHandler:Landroid/os/Handler;

    iget-object p0, p0, mRemoveAlertRunnable:Ljava/lang/Runnable;
...
.method public removeAsSoonAsPossible()V
    ...
    iget-object v2, p0, mRemoveAlertRunnable:Ljava/lang/Runnable;

    iget-wide v3, p0, mEarliestRemovaltime:J
...
.method public reset()V
    ...
    iput-object v0, p0, mEntry:Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;

    invoke-virtual {p0}, removeAutoRemovalCallbacks()V

    iput-object v0, p0, mRemoveAlertRunnable:Ljava/lang/Runnable;
...
.method public setEntry(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V
    ...
    invoke-virtual {p0, p1, v0}, setEntry(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;Ljava/lang/Runnable;)V
...
.method public setEntry(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;Ljava/lang/Runnable;)V
    ...
    iput-object p2, p0, mRemoveAlertRunnable:Ljava/lang/Runnable;

    invoke-virtual {p0}, calculatePostTime()J

    move-result-wide p1

    iput-wide p1, p0, mPostTime:J

    const/4 p1, 0x1

    invoke-virtual {p0, p1}, updateEntry(Z)V
...
.method public updateEntry(Z)V
    ...
    iget-object v2, p0, this$0:Lcom/android/systemui/statusbar/AlertingNotificationManager;
    ...
    iput-wide v2, p0, mEarliestRemovaltime:J

    if-eqz p1, :cond_1

    iget-wide v2, p0, mPostTime:J

    invoke-static {v2, v3, v0, v1}, Ljava/lang/Math;->max(JJ)J

    move-result-wide v2

    iput-wide v2, p0, mPostTime:J

    :cond_1
    invoke-virtual {p0}, removeAutoRemovalCallbacks()V

    invoke-virtual {p0}, isSticky()Z

    move-result p1

    if-nez p1, :cond_2

    invoke-virtual {p0}, calculateFinishTime()J

    move-result-wide v2

    sub-long/2addr v2, v0

    iget-object p1, p0, this$0:Lcom/android/systemui/statusbar/AlertingNotificationManager;
...
.method public wasShownLongEnough()Z
    ...
    iget-wide v0, p0, mEarliestRemovaltime:J
