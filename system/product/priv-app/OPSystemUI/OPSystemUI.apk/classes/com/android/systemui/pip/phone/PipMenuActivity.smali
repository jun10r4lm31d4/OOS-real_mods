...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, mAllowMenuTimeout:Z

    iput-boolean v0, p0, mAllowTouches:Z
    ...
    iput-object v0, p0, mMenuBgUpdateListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;

    new-instance v0, Landroid/graphics/PointF;

    invoke-direct {v0}, Landroid/graphics/PointF;-><init>()V

    iput-object v0, p0, mDownPosition:Landroid/graphics/PointF;

    new-instance v0, Landroid/graphics/PointF;

    invoke-direct {v0}, Landroid/graphics/PointF;-><init>()V

    iput-object v0, p0, mDownDelta:Landroid/graphics/PointF;
...
.method static synthetic access$000(Lcom/android/systemui/pip/phone/PipMenuActivity;)Landroid/graphics/drawable/Drawable;
    ...
    iget-object p0, p0, mBackgroundDrawable:Landroid/graphics/drawable/Drawable;
...
.method static synthetic access$100(Lcom/android/systemui/pip/phone/PipMenuActivity;ILandroid/graphics/Rect;Landroid/graphics/Rect;ZZ)V
    ...
    invoke-direct/range {p0 .. p5}, showMenu(ILandroid/graphics/Rect;Landroid/graphics/Rect;ZZ)V
...
.method static synthetic access$200(Lcom/android/systemui/pip/phone/PipMenuActivity;)V
    ...
    invoke-direct {p0}, cancelDelayedFinish()V
...
.method static synthetic access$300(Lcom/android/systemui/pip/phone/PipMenuActivity;Ljava/lang/Runnable;)V
    ...
    invoke-direct {p0, p1}, hideMenu(Ljava/lang/Runnable;)V
...
.method static synthetic access$400(Lcom/android/systemui/pip/phone/PipMenuActivity;Landroid/graphics/Rect;Ljava/util/List;)V
    ...
    invoke-direct {p0, p1, p2}, setActions(Landroid/graphics/Rect;Ljava/util/List;)V
...
.method static synthetic access$500(Lcom/android/systemui/pip/phone/PipMenuActivity;F)V
    ...
    invoke-direct {p0, p1}, updateDismissFraction(F)V
...
.method static synthetic access$602(Lcom/android/systemui/pip/phone/PipMenuActivity;Z)Z
    ...
    iput-boolean p1, p0, mAllowTouches:Z
...
.method static synthetic access$800(Lcom/android/systemui/pip/phone/PipMenuActivity;I)V
    ...
    invoke-direct {p0, p1}, repostDelayedFinish(I)V
...
.method private cancelDelayedFinish()V
    ...
    iget-object p0, p0, mFinishRunnable:Ljava/lang/Runnable;
...
.method private dismissPip()V
    ...
    invoke-direct {p0, v0, v1, v2}, hideMenu(Ljava/lang/Runnable;ZZ)V
...
.method private expandPip()V
    ...
    invoke-direct {p0, v0, v1, v1}, hideMenu(Ljava/lang/Runnable;ZZ)V
...
.method private hideMenu()V
    ...
    invoke-direct {p0, v0}, hideMenu(Ljava/lang/Runnable;)V
...
.method private hideMenu(Ljava/lang/Runnable;)V
    ...
    invoke-direct {p0, p1, v0, v1}, hideMenu(Ljava/lang/Runnable;ZZ)V
...
.method private hideMenu(Ljava/lang/Runnable;ZZ)V
    ...
    invoke-direct {p0, v0}, notifyMenuStateChange(I)V
    ...
    iput-object p2, p0, mMenuContainerAnimator:Landroid/animation/AnimatorSet;

    iget-object p2, p0, mMenuContainer:Landroid/view/View;
    ...
    iget-object v1, p0, mMenuBgUpdateListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    iget-object v1, p0, mSettingsButton:Landroid/view/View;
    ...
    iget-object v3, p0, mDismissButton:Landroid/view/View;
    ...
    iget-object v4, p0, mMenuContainerAnimator:Landroid/animation/AnimatorSet;
    ...
    iget-object p2, p0, mMenuContainerAnimator:Landroid/animation/AnimatorSet;
    ...
    iget-object p0, p0, mMenuContainerAnimator:Landroid/animation/AnimatorSet;
...
.method private notifyActivityCallback(Landroid/os/Messenger;)V
    ...
    invoke-direct {p0, v0, p1}, sendMessage(Landroid/os/Message;Ljava/lang/String;)V
...
.method private notifyRegisterInputConsumer()V
    ...
    invoke-direct {p0, v0, v1}, sendMessage(Landroid/os/Message;Ljava/lang/String;)V
...
.method private repostDelayedFinish(I)V
    ...
    iget-object v1, p0, mFinishRunnable:Ljava/lang/Runnable;
...
.method private sendEmptyMessage(ILjava/lang/String;)V
    ...
    invoke-direct {p0, v0, p2}, sendMessage(Landroid/os/Message;Ljava/lang/String;)V
...
.method private sendMessage(Landroid/os/Message;Ljava/lang/String;)V
    ...
    iget-object p0, p0, mToControllerMessenger:Landroid/os/Messenger;
...
.method private setActions(Landroid/graphics/Rect;Ljava/util/List;)V
    ...
    invoke-direct {p0, p1}, updateActionViews(Landroid/graphics/Rect;)V
...
.method private showMenu(ILandroid/graphics/Rect;Landroid/graphics/Rect;ZZ)V
    ...
    iput-boolean p4, p0, mAllowMenuTimeout:Z

    iget p3, p0, mMenuState:I
    ...
    iput-boolean p3, p0, mAllowTouches:Z

    invoke-direct {p0}, cancelDelayedFinish()V

    invoke-direct {p0, p2}, updateActionViews(Landroid/graphics/Rect;)V
    ...
    :cond_2
    invoke-direct {p0, p1}, notifyMenuStateChange(I)V
    ...
    iget-object p3, p0, mMenuBgUpdateListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    iget-object p3, p0, mSettingsButton:Landroid/view/View;
    ...
    iget-object p5, p0, mDismissButton:Landroid/view/View;
    ...
    iget-object p1, p0, mMenuContainerAnimator:Landroid/animation/AnimatorSet;
    ...
    :cond_6
    invoke-direct {p0}, notifyUnregisterInputConsumer()V
...
.method private updateActionViews(Landroid/graphics/Rect;)V
    ...
    iget-object v2, p0, mActions:Ljava/util/List;
    ...
    iget-object v1, p0, mActionsGroup:Landroid/widget/LinearLayout;
    ...
    :goto_0
    iget-object v4, p0, mActionsGroup:Landroid/widget/LinearLayout;

    invoke-virtual {v4}, Landroid/widget/LinearLayout;->getChildCount()I

    move-result v4

    iget-object v5, p0, mActions:Ljava/util/List;
    ...
    iget-object v5, p0, mActionsGroup:Landroid/widget/LinearLayout;
    ...
    :goto_4
    iget-object v1, p0, mActions:Ljava/util/List;
    ...
    iget v4, p0, mBetweenActionPaddingLand:I
...
.method private updateDismissFraction(F)V
    ...
    iget-object v1, p0, mDismissButton:Landroid/view/View;
...
.method private updateFromIntent(Landroid/content/Intent;)V
    ...
    iput-object v0, p0, mToControllerMessenger:Landroid/os/Messenger;

    iget-object v0, p0, mToControllerMessenger:Landroid/os/Messenger;
    ...
    invoke-direct {p0, v0}, notifyActivityCallback(Landroid/os/Messenger;)V
    ...
    invoke-direct/range {v2 .. v7}, showMenu(ILandroid/graphics/Rect;Landroid/graphics/Rect;ZZ)V
...
.method public dispatchTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v0, p0, mAllowTouches:Z
    ...
    :cond_2
    iget-object v0, p0, mDownDelta:Landroid/graphics/PointF;

    invoke-virtual {p1}, Landroid/view/MotionEvent;->getX()F

    move-result v1

    iget-object v2, p0, mDownPosition:Landroid/graphics/PointF;
    ...
    iget-object v3, p0, mDownPosition:Landroid/graphics/PointF;
    ...
    iget-object v1, p0, mViewConfig:Landroid/view/ViewConfiguration;
    ...
    invoke-direct {p0}, notifyRegisterInputConsumer()V
    ...
    :cond_3
    iget-object v0, p0, mDownPosition:Landroid/graphics/PointF;
...
.method public synthetic lambda$dismissPip$8$PipMenuActivity()V
    ...
    invoke-direct {p0, v0, v1}, sendEmptyMessage(ILjava/lang/String;)V
...
.method public synthetic lambda$onCreate$2$PipMenuActivity(Landroid/view/View;)V
    ...
    invoke-direct {p0}, showSettings()V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, mViewConfig:Landroid/view/ViewConfiguration;
    ...
    iput-object v0, p0, mTouchState:Lcom/android/systemui/pip/phone/PipTouchState;
    ...
    iget-object p1, p0, mBackgroundDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iput-object p1, p0, mViewRoot:Landroid/view/View;

    iget-object p1, p0, mViewRoot:Landroid/view/View;

    iget-object v0, p0, mBackgroundDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iput-object p1, p0, mMenuContainer:Landroid/view/View;

    iget-object p1, p0, mMenuContainer:Landroid/view/View;
    ...
    iput-object p1, p0, mSettingsButton:Landroid/view/View;

    iget-object p1, p0, mSettingsButton:Landroid/view/View;
    ...
    iput-object p1, p0, mDismissButton:Landroid/view/View;

    iget-object p1, p0, mDismissButton:Landroid/view/View;
    ...
    iput-object p1, p0, mActionsGroup:Landroid/widget/LinearLayout;
    ...
    iput p1, p0, mBetweenActionPaddingLand:I
    ...
    iput-object p1, p0, mExpandButton:Landroid/widget/ImageView;

    invoke-virtual {p0}, Landroid/app/Activity;->getIntent()Landroid/content/Intent;

    move-result-object p1

    invoke-direct {p0, p1}, updateFromIntent(Landroid/content/Intent;)V
...
.method public onUserInteraction()V
    ...
    iget-boolean v0, p0, mAllowMenuTimeout:Z

    if-eqz v0, :cond_0

    const/16 v0, 0x7d0

    invoke-direct {p0, v0}, repostDelayedFinish(I)V
