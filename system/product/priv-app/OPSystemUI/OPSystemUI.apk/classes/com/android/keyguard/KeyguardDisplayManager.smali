...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/util/InjectionInflationController;)V
    ...
    iput-object v0, p0, mTmpDisplayInfo:Landroid/view/DisplayInfo;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, mPresentations:Landroid/util/SparseArray;
    ...
    iput-object v0, p0, mNavBarController:Lcom/android/systemui/statusbar/NavigationBarController;
    ...
    iput-object v0, p0, mMediaRouterCallback:Landroid/media/MediaRouter$SimpleCallback;

    iput-object p1, p0, mContext:Landroid/content/Context;

    iput-object p2, p0, mInjectableInflater:Lcom/android/systemui/util/InjectionInflationController;
    ...
    iput-object p1, p0, mMediaRouter:Landroid/media/MediaRouter;
    ...
    iput-object p1, p0, mDisplayService:Landroid/hardware/display/DisplayManager;

    iget-object p1, p0, mDisplayService:Landroid/hardware/display/DisplayManager;

    iget-object p0, p0, mDisplayListener:Landroid/hardware/display/DisplayManager$DisplayListener;
...
.method static synthetic access$000(Lcom/android/keyguard/KeyguardDisplayManager;)Landroid/hardware/display/DisplayManager;
    ...
    iget-object p0, p0, mDisplayService:Landroid/hardware/display/DisplayManager;
...
.method static synthetic access$200(Lcom/android/keyguard/KeyguardDisplayManager;IZ)V
    ...
    invoke-direct {p0, p1, p2}, updateNavigationBarVisibility(IZ)V
...
.method static synthetic access$300(Lcom/android/keyguard/KeyguardDisplayManager;Landroid/view/Display;)Z
    ...
    invoke-direct {p0, p1}, showPresentation(Landroid/view/Display;)Z
...
.method static synthetic access$400(Lcom/android/keyguard/KeyguardDisplayManager;)Landroid/util/SparseArray;
    ...
    iget-object p0, p0, mPresentations:Landroid/util/SparseArray;
...
.method static synthetic access$500(Lcom/android/keyguard/KeyguardDisplayManager;I)V
    ...
    invoke-direct {p0, p1}, hidePresentation(I)V
...
.method private hidePresentation(I)V
    ...
    iget-object v0, p0, mPresentations:Landroid/util/SparseArray;
...
.method private isKeyguardShowable(Landroid/view/Display;)Z
    ...
    :cond_3
    iget-object v2, p0, mTmpDisplayInfo:Landroid/view/DisplayInfo;

    invoke-virtual {p1, v2}, Landroid/view/Display;->getDisplayInfo(Landroid/view/DisplayInfo;)Z

    iget-object p0, p0, mTmpDisplayInfo:Landroid/view/DisplayInfo;
...
.method private showPresentation(Landroid/view/Display;)Z
    ...
    invoke-direct {p0, p1}, isKeyguardShowable(Landroid/view/Display;)Z
    ...
    iget-object v3, p0, mPresentations:Landroid/util/SparseArray;
    ...
    iget-object v5, p0, mInjectableInflater:Lcom/android/systemui/util/InjectionInflationController;
...
.method private updateNavigationBarVisibility(IZ)V
    ...
    :cond_0
    iget-object p0, p0, mNavBarController:Lcom/android/systemui/statusbar/NavigationBarController;
...
.method public hide()V
    ...
    iget-object v2, p0, mMediaRouterCallback:Landroid/media/MediaRouter$SimpleCallback;

    invoke-virtual {v0, v2}, Landroid/media/MediaRouter;->removeCallback(Landroid/media/MediaRouter$Callback;)V

    invoke-virtual {p0, v1}, updateDisplays(Z)Z
...
.method public synthetic lambda$showPresentation$0$KeyguardDisplayManager(ILandroid/content/DialogInterface;)V
    ...
    iget-object p2, p0, mPresentations:Landroid/util/SparseArray;
...
.method public show()V
    ...
    iget-object v3, p0, mMediaRouterCallback:Landroid/media/MediaRouter$SimpleCallback;
...
.method protected updateDisplays(Z)Z
    ...
    invoke-direct {p0, v5, v0}, updateNavigationBarVisibility(IZ)V

    invoke-direct {p0, v4}, showPresentation(Landroid/view/Display;)Z
    ...
    :cond_0
    iget-object p1, p0, mPresentations:Landroid/util/SparseArray;
    ...
    invoke-direct {p0, v0, v1}, updateNavigationBarVisibility(IZ)V
