...
.method static constructor <clinit>()V
    ...
    sput-object v0, SET_DARK_AMOUNT_PROPERTY:Landroid/util/FloatProperty;
...
.method public constructor <init>()V
    ...
    iput v0, p0, mHistoryIndex:I

    const/16 v1, 0x20

    new-array v2, v1, [Lcom/android/systemui/statusbar/StatusBarStateControllerImpl$HistoricalState;

    iput-object v2, p0, mHistoricalRecords:[Lcom/android/systemui/statusbar/StatusBarStateControllerImpl$HistoricalState;

    sget-object v2, Lcom/android/systemui/Interpolators;->FAST_OUT_SLOW_IN:Landroid/view/animation/Interpolator;

    iput-object v2, p0, mDozeInterpolator:Landroid/view/animation/Interpolator;

    :goto_0
    if-ge v0, v1, :cond_0

    iget-object v2, p0, mHistoricalRecords:[Lcom/android/systemui/statusbar/StatusBarStateControllerImpl$HistoricalState;
...
.method static synthetic access$000(Lcom/android/systemui/statusbar/StatusBarStateControllerImpl;F)V
    ...
    invoke-direct {p0, p1}, setDozeAmountInternal(F)V
...
.method private addListenerInternalLocked(Lcom/android/systemui/plugins/statusbar/StatusBarStateController$StateListener;I)V
    ...
    sget-object p1, sComparator:Ljava/util/Comparator;
...
.method private recordHistoricalState(II)V
    ...
    iget-object v0, p0, mHistoricalRecords:[Lcom/android/systemui/statusbar/StatusBarStateControllerImpl$HistoricalState;

    iget p0, p0, mHistoryIndex:I
...
.method private setDozeAmountInternal(F)V
    ...
    iget-object v0, p0, mDozeInterpolator:Landroid/view/animation/Interpolator;
...
.method private startDozeAnimation()V
    ...
    :goto_0
    iput-object v0, p0, mDozeInterpolator:Landroid/view/animation/Interpolator;

    :cond_2
    sget-object v0, SET_DARK_AMOUNT_PROPERTY:Landroid/util/FloatProperty;
    ...
    iget v3, p0, mDozeAmountTarget:F
    ...
    iput-object v0, p0, mDarkAnimator:Landroid/animation/ValueAnimator;

    iget-object v0, p0, mDarkAnimator:Landroid/animation/ValueAnimator;
    ...
    iget-object p0, p0, mDarkAnimator:Landroid/animation/ValueAnimator;
...
.method public addCallback(Lcom/android/systemui/plugins/statusbar/StatusBarStateController$StateListener;)V
    ...
    :try_start_0
    invoke-direct {p0, p1, v1}, addListenerInternalLocked(Lcom/android/systemui/plugins/statusbar/StatusBarStateController$StateListener;I)V
...
.method public addCallback(Lcom/android/systemui/plugins/statusbar/StatusBarStateController$StateListener;I)V
    ...
    :try_start_0
    invoke-direct {p0, p1, p2}, addListenerInternalLocked(Lcom/android/systemui/plugins/statusbar/StatusBarStateController$StateListener;I)V
...
.method public bridge synthetic addCallback(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, addCallback(Lcom/android/systemui/plugins/statusbar/StatusBarStateController$StateListener;)V
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-static {v0}, describe(I)Ljava/lang/String;
    ...
    iget v1, p0, mLastState:I

    invoke-virtual {p1, v1}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    invoke-virtual {p1, p3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget p3, p0, mLastState:I

    invoke-static {p3}, describe(I)Ljava/lang/String;
    ...
    iget-boolean p3, p0, mLeaveOpenOnKeyguardHide:Z
    ...
    iget-boolean p3, p0, mKeyguardRequested:Z
    ...
    iget-boolean p3, p0, mIsDozing:Z
    ...
    iget-object v1, p0, mHistoricalRecords:[Lcom/android/systemui/statusbar/StatusBarStateControllerImpl$HistoricalState;
    ...
    :cond_1
    iget p1, p0, mHistoryIndex:I

    add-int/2addr p1, v1

    :goto_1
    iget v2, p0, mHistoryIndex:I
    ...
    iget-object v3, p0, mHistoricalRecords:[Lcom/android/systemui/statusbar/StatusBarStateControllerImpl$HistoricalState;
...
.method public goingToFullShade()Z
    ...
    iget-boolean p0, p0, mLeaveOpenOnKeyguardHide:Z
...
.method public isDozing()Z
    ...
    iget-boolean p0, p0, mIsDozing:Z
...
.method public isKeyguardRequested()Z
    ...
    iget-boolean p0, p0, mKeyguardRequested:Z
...
.method public bridge synthetic removeCallback(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, removeCallback(Lcom/android/systemui/plugins/statusbar/StatusBarStateController$StateListener;)V
...
.method public setDozeAmount(FZ)V
    ...
    iget v0, p0, mDozeAmountTarget:F
    ...
    :cond_1
    iput p1, p0, mDozeAmountTarget:F

    if-eqz p2, :cond_2

    invoke-direct {p0}, startDozeAnimation()V
...
.method public setKeyguardRequested(Z)V
    ...
    iput-boolean p1, p0, mKeyguardRequested:Z
...
.method public setLeaveOpenOnKeyguardHide(Z)V
    ...
    iput-boolean p1, p0, mLeaveOpenOnKeyguardHide:Z
...
.method public setState(I)Z
    ...
    invoke-direct {p0, p1, v0}, recordHistoricalState(II)V
