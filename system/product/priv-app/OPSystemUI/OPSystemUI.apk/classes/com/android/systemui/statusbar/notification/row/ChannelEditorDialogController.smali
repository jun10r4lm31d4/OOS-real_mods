...
.method public constructor <init>(Landroid/content/Context;Landroid/app/INotificationManager;)V
    ...
    iput-object p2, p0, noMan:Landroid/app/INotificationManager;
    ...
    iput-object p1, p0, providedChannels:Ljava/util/List;

    new-instance p1, Ljava/util/LinkedHashMap;

    invoke-direct {p1}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object p1, p0, edits:Ljava/util/Map;

    const/4 p1, 0x1

    iput-boolean p1, p0, appNotificationsEnabled:Z

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, groupNameLookup:Ljava/util/HashMap;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, channelGroupList:Ljava/util/List;

    const p1, -0x7efbff00

    iput p1, p0, wmFlags:I
...
.method private final applyAppNotificationsOn(Z)V
    ...
    :try_start_0
    iget-object v0, p0, noMan:Landroid/app/INotificationManager;
    ...
    iget-object p0, p0, appUid:Ljava/lang/Integer;
...
.method private final done()V
    ...
    iget-object p0, p0, onFinishListener:Lcom/android/systemui/statusbar/notification/row/OnChannelEditorDialogFinishedListener;
...
.method private final resetState()V
    ...
    iput-object v0, p0, appIcon:Landroid/graphics/drawable/Drawable;

    iput-object v0, p0, appUid:Ljava/lang/Integer;

    iput-object v0, p0, packageName:Ljava/lang/String;

    iput-object v0, p0, appName:Ljava/lang/String;

    iget-object v0, p0, edits:Ljava/util/Map;

    invoke-interface {v0}, Ljava/util/Map;->clear()V

    iget-object v0, p0, providedChannels:Ljava/util/List;

    invoke-interface {v0}, Ljava/util/List;->clear()V

    iget-object p0, p0, groupNameLookup:Ljava/util/HashMap;
...
.method private final setChannelImportance(Landroid/app/NotificationChannel;I)V
    ...
    iget-object p2, p0, noMan:Landroid/app/INotificationManager;
...
.method public final apply()V
    ...
    invoke-direct {p0, v2, v1}, setChannelImportance(Landroid/app/NotificationChannel;I)V

    goto :goto_0

    :cond_1
    iget-boolean v0, p0, appNotificationsEnabled:Z

    invoke-direct {p0}, checkAreAppNotificationsOn()Z
    ...
    invoke-direct {p0, v0}, applyAppNotificationsOn(Z)V
...
.method public final launchSettings(Landroid/view/View;)V
    ...
    iget-object v0, p0, onSettingsClickListener:Lcom/android/systemui/statusbar/notification/row/NotificationInfo$OnSettingsClickListener;
...
.method public final proposeEditForChannel(Landroid/app/NotificationChannel;I)V
    ...
    iget-object p0, p0, edits:Ljava/util/Map;
...
.method public final setOnFinishListener(Lcom/android/systemui/statusbar/notification/row/OnChannelEditorDialogFinishedListener;)V
    ...
    iput-object p1, p0, onFinishListener:Lcom/android/systemui/statusbar/notification/row/OnChannelEditorDialogFinishedListener;
