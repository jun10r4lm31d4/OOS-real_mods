...
.method private getRowTop(I)I
    ...
    iget v0, p0, mCellHeight:I

    iget v1, p0, mCellMarginVertical:I

    add-int/2addr v0, v1

    mul-int/2addr p1, v0

    iget p0, p0, mCellMarginTop:I
...
.method public addTile(Lcom/android/systemui/qs/QSPanel$TileRecord;)V
    ...
    invoke-virtual {p0, p1}, addTileView(Lcom/android/systemui/qs/QSPanel$TileRecord;)V
...
.method protected getColumnStart(I)I
    ...
    iget v1, p0, mSidePadding:I

    add-int/2addr v0, v1

    iget v1, p0, mCellMarginHorizontal:I
...
.method protected layoutTileRecords(I)V
    ...
    invoke-direct {p0, v5}, getRowTop(I)I

    move-result v7

    if-eqz v0, :cond_2

    iget v8, p0, mColumns:I
    ...
    :goto_2
    invoke-virtual {p0, v8}, getColumnStart(I)I

    move-result v8

    iget v9, p0, mCellWidth:I
...
.method protected onLayout(ZIIII)V
    ...
    invoke-virtual {p0, p1}, layoutTileRecords(I)V
...
.method protected onMeasure(II)V
    ...
    :cond_0
    iget p2, p0, mSidePadding:I

    mul-int/lit8 p2, p2, 0x2

    sub-int/2addr v1, p2

    iget p2, p0, mCellMarginHorizontal:I
    ...
    iput v1, p0, mCellWidth:I

    iget-object p2, p0, mRecords:Ljava/util/ArrayList;
    ...
    invoke-static {v3}, exactly(I)I

    move-result v3

    iget v4, p0, mCellHeight:I

    invoke-static {v4}, exactly(I)I
    ...
    :cond_2
    iget p2, p0, mCellHeight:I

    iget v0, p0, mCellMarginVertical:I
...
.method public updateResources()Z
    ...
    iput v3, p0, mCellMarginHorizontal:I
    ...
    iput v3, p0, mCellMarginVertical:I
