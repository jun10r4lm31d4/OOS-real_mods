...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mLockscreenPublicMode:Landroid/util/SparseBooleanArray;

    new-instance v0, Landroid/util/SparseBooleanArray;

    invoke-direct {v0}, Landroid/util/SparseBooleanArray;-><init>()V

    iput-object v0, p0, mUsersWithSeperateWorkChallenge:Landroid/util/SparseBooleanArray;

    new-instance v0, Landroid/util/SparseBooleanArray;

    invoke-direct {v0}, Landroid/util/SparseBooleanArray;-><init>()V

    iput-object v0, p0, mUsersAllowingPrivateNotifications:Landroid/util/SparseBooleanArray;

    new-instance v0, Landroid/util/SparseBooleanArray;

    invoke-direct {v0}, Landroid/util/SparseBooleanArray;-><init>()V

    iput-object v0, p0, mUsersAllowingNotifications:Landroid/util/SparseBooleanArray;
    ...
    iput-object v1, p0, mAllUsersReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v1, p0, mBaseBroadcastReceiver:Landroid/content/BroadcastReceiver;

    new-instance v1, Landroid/util/SparseArray;

    invoke-direct {v1}, Landroid/util/SparseArray;-><init>()V

    iput-object v1, p0, mCurrentProfiles:Landroid/util/SparseArray;
    ...
    iput-object p1, p0, mKeyguardManager:Landroid/app/KeyguardManager;
...
.method static synthetic access$000(Lcom/android/systemui/statusbar/NotificationLockscreenUserManagerImpl;)Landroid/util/SparseBooleanArray;
    ...
    iget-object p0, p0, mUsersAllowingPrivateNotifications:Landroid/util/SparseBooleanArray;
...
.method static synthetic access$400(Lcom/android/systemui/statusbar/NotificationLockscreenUserManagerImpl;)V
    ...
    invoke-direct {p0}, updateCurrentProfilesCache()V
...
.method static synthetic access$800(Lcom/android/systemui/statusbar/NotificationLockscreenUserManagerImpl;)Landroid/util/SparseBooleanArray;
    ...
    iget-object p0, p0, mUsersAllowingNotifications:Landroid/util/SparseBooleanArray;
...
.method private setLockscreenAllowRemoteInput(Z)V
    ...
    iput-boolean p1, p0, mAllowLockscreenRemoteInput:Z
...
.method private setShowLockscreenNotifications(Z)V
    ...
    iput-boolean p1, p0, mShowLockscreenNotifications:Z
...
.method private userAllowsNotificationsInPublic(I)Z
    ...
    invoke-virtual {p0, p1}, isCurrentProfile(I)Z
    ...
    :cond_0
    iget-object v0, p0, mUsersAllowingNotifications:Landroid/util/SparseBooleanArray;
    ...
    invoke-direct {p0, p1, v3}, adminAllowsKeyguardFeature(II)Z
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-boolean v0, p0, mShowLockscreenNotifications:Z
    ...
    iget-boolean v0, p0, mAllowLockscreenRemoteInput:Z
...
.method public getCurrentProfiles()Landroid/util/SparseArray;
    ...
    iget-object p0, p0, mCurrentProfiles:Landroid/util/SparseArray;
...
.method public isAnyProfilePublicMode()Z
    ...
    iget-object v2, p0, mCurrentProfiles:Landroid/util/SparseArray;
    ...
    invoke-virtual {p0, v2}, isLockscreenPublicMode(I)Z
...
.method public isLockscreenPublicMode(I)Z
    ...
    iget-object p1, p0, mLockscreenPublicMode:Landroid/util/SparseBooleanArray;
    ...
    :cond_0
    iget-object p0, p0, mLockscreenPublicMode:Landroid/util/SparseBooleanArray;
...
.method public needsRedaction(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)Z
    ...
    invoke-virtual {p0, v1}, userAllowsPrivateNotificationsInPublic(I)Z
    ...
    invoke-virtual {p0, v0}, userAllowsPrivateNotificationsInPublic(I)Z
    ...
    invoke-direct {p0, p1}, packageHasVisibilityOverride(Ljava/lang/String;)Z
...
.method public needsSeparateWorkChallenge(I)Z
    ...
    iget-object p0, p0, mUsersWithSeperateWorkChallenge:Landroid/util/SparseBooleanArray;
...
.method public onStateChanged(I)V
    ...
    invoke-virtual {p0}, updatePublicMode()V
...
.method public setUpWithPresenter(Lcom/android/systemui/statusbar/NotificationPresenter;)V
    ...
    iput-object p1, p0, mLockscreenSettingsObserver:Landroid/database/ContentObserver;
    ...
    iput-object p1, p0, mSettingsObserver:Landroid/database/ContentObserver;
    ...
    iget-object v1, p0, mLockscreenSettingsObserver:Landroid/database/ContentObserver;
    ...
    iget-object v1, p0, mSettingsObserver:Landroid/database/ContentObserver;
    ...
    iget-object v5, p0, mAllUsersReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v1, p0, mBaseBroadcastReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object p0, p0, mSettingsObserver:Landroid/database/ContentObserver;
...
.method public shouldAllowLockscreenRemoteInput()Z
    ...
    iget-boolean p0, p0, mAllowLockscreenRemoteInput:Z
...
.method public shouldHideNotifications(I)Z
    ...
    invoke-virtual {p0, p1}, isLockscreenPublicMode(I)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-direct {p0, p1}, userAllowsNotificationsInPublic(I)Z
    ...
    invoke-virtual {p0, v0}, shouldHideNotifications(I)Z
    ...
    :cond_1
    invoke-direct {p0, p1}, shouldTemporarilyHideNotifications(I)Z
...
.method public shouldHideNotifications(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v0}, isLockscreenPublicMode(I)Z
...
.method public shouldShowLockscreenNotifications()Z
    ...
    iget-boolean p0, p0, mShowLockscreenNotifications:Z
...
.method public shouldShowOnKeyguard(Landroid/service/notification/StatusBarNotification;)Z
    ...
    invoke-direct {p0}, hideSilentNotificationsOnLockscreen()Z
    ...
    iget-boolean v2, p0, mShowLockscreenNotifications:Z
...
.method protected updateLockscreenNotificationSetting()V
    ...
    :goto_0
    iget-object v3, p0, mDevicePolicyManager:Landroid/app/admin/DevicePolicyManager;
    ...
    :goto_2
    invoke-direct {p0, v2}, setShowLockscreenNotifications(Z)V

    invoke-direct {p0, v1}, setLockscreenAllowRemoteInput(Z)V
...
.method public updatePublicMode()V
    ...
    invoke-direct {p0, v3}, isSecure(I)Z
    ...
    :goto_2
    invoke-virtual {p0}, getCurrentProfiles()Landroid/util/SparseArray;

    move-result-object v4

    iget-object v5, p0, mUsersWithSeperateWorkChallenge:Landroid/util/SparseBooleanArray;
    ...
    invoke-direct {p0, v6}, isSecure(I)Z
    ...
    iget-object v8, p0, mKeyguardManager:Landroid/app/KeyguardManager;
    ...
    :goto_5
    invoke-virtual {p0, v8, v6}, setLockscreenPublicMode(ZI)V

    iget-object v8, p0, mUsersWithSeperateWorkChallenge:Landroid/util/SparseBooleanArray;
...
.method public userAllowsPrivateNotificationsInPublic(I)Z
    ...
    :cond_0
    iget-object v1, p0, mUsersAllowingPrivateNotifications:Landroid/util/SparseBooleanArray;
