...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p1, p0, mDetailViews:Landroid/util/SparseArray;
    ...
    iput-object p1, p0, mQsPanelCallback:Lcom/android/systemui/qs/QSDetail$Callback;
    ...
    iput-object p1, p0, mHideGridContentWhenDone:Landroid/animation/AnimatorListenerAdapter;
    ...
    iput-object p1, p0, mTeardownDetailWhenDone:Landroid/animation/AnimatorListenerAdapter;
...
.method static synthetic access$1000(Lcom/android/systemui/qs/QSDetail;)Landroid/view/View;
    ...
    iget-object p0, p0, mFooter:Landroid/view/View;
...
.method static synthetic access$1100(Lcom/android/systemui/qs/QSDetail;)Landroid/view/ViewGroup;
    ...
    iget-object p0, p0, mDetailContent:Landroid/view/ViewGroup;
...
.method static synthetic access$200(Lcom/android/systemui/qs/QSDetail;)Lcom/android/systemui/plugins/qs/DetailAdapter;
    ...
    iget-object p0, p0, mDetailAdapter:Lcom/android/systemui/plugins/qs/DetailAdapter;
...
.method static synthetic access$300(Lcom/android/systemui/qs/QSDetail;ZZ)V
    ...
    invoke-direct {p0, p1, p2}, handleToggleStateChanged(ZZ)V
...
.method static synthetic access$400(Lcom/android/systemui/qs/QSDetail;)Z
    ...
    iget-boolean p0, p0, mAnimatingOpen:Z
...
.method static synthetic access$402(Lcom/android/systemui/qs/QSDetail;Z)Z
    ...
    iput-boolean p1, p0, mAnimatingOpen:Z
...
.method static synthetic access$500(Lcom/android/systemui/qs/QSDetail;)Z
    ...
    iget-boolean p0, p0, mClosingDetail:Z
...
.method static synthetic access$502(Lcom/android/systemui/qs/QSDetail;Z)Z
    ...
    iput-boolean p1, p0, mClosingDetail:Z
...
.method static synthetic access$600(Lcom/android/systemui/qs/QSDetail;Z)V
    ...
    invoke-direct {p0, p1}, handleScanStateChanged(Z)V
...
.method static synthetic access$700(Lcom/android/systemui/qs/QSDetail;)Landroid/widget/LinearLayout;
    ...
    iget-object p0, p0, mLayoutWlbIndicators:Landroid/widget/LinearLayout;
...
.method static synthetic access$800(Lcom/android/systemui/qs/QSDetail;)V
    ...
    invoke-direct {p0}, checkPendingAnimations()V
...
.method static synthetic access$900(Lcom/android/systemui/qs/QSDetail;)Lcom/android/systemui/qs/QuickStatusBarHeader;
    ...
    iget-object p0, p0, mHeader:Lcom/android/systemui/qs/QuickStatusBarHeader;
...
.method private checkPendingAnimations()V
    ...
    iget-boolean v0, p0, mSwitchState:Z

    iget-object v1, p0, mDetailAdapter:Lcom/android/systemui/plugins/qs/DetailAdapter;
    ...
    :goto_0
    invoke-direct {p0, v0, v1}, handleToggleStateChanged(ZZ)V
...
.method private handleScanStateChanged(Z)V
    ...
    iget-boolean v0, p0, mScanState:Z
    ...
    :cond_0
    iput-boolean p1, p0, mScanState:Z

    iget-object v0, p0, mQsDetailHeaderProgress:Landroid/widget/ImageView;
    ...
    iget-object p1, p0, mQsDetailHeaderProgress:Landroid/widget/ImageView;
    ...
    iget-object p0, p0, mQsDetailHeaderProgress:Landroid/widget/ImageView;
...
.method private handleToggleStateChanged(ZZ)V
    ...
    iput-boolean p1, p0, mSwitchState:Z

    iget-boolean v0, p0, mAnimatingOpen:Z
    ...
    :cond_0
    iget-object v0, p0, mQsDetailHeaderSwitch:Landroid/widget/Switch;

    invoke-virtual {v0, p1}, Landroid/widget/Switch;->setChecked(Z)V

    iget-object p1, p0, mQsDetailHeader:Landroid/view/View;

    invoke-virtual {p1, p2}, Landroid/view/View;->setEnabled(Z)V

    iget-object p0, p0, mQsDetailHeaderSwitch:Landroid/widget/Switch;
...
.method private updateDetailText()V
    ...
    iget-object v0, p0, mDetailDoneButton:Landroid/widget/TextView;

    sget v1, Lcom/android/systemui/R$string;->quick_settings_done:I

    invoke-virtual {v0, v1}, Landroid/widget/TextView;->setText(I)V

    iget-object p0, p0, mDetailSettingsButton:Landroid/widget/TextView;
...
.method protected animateDetailVisibleDiff(IIZLandroid/animation/Animator$AnimatorListener;)V
    ...
    iget-object p3, p0, mDetailAdapter:Lcom/android/systemui/plugins/qs/DetailAdapter;
    ...
    :goto_0
    iput-boolean p3, p0, mAnimatingOpen:Z

    iget-boolean p3, p0, mFullyExpanded:Z
    ...
    iget-object p3, p0, mClipper:Lcom/android/systemui/qs/QSDetailClipper;
...
.method public handleShowingDetail(Lcom/android/systemui/plugins/qs/DetailAdapter;IIZ)V
    ...
    invoke-virtual {p0, p1}, setupDetailHeader(Lcom/android/systemui/plugins/qs/DetailAdapter;)V

    if-eqz p4, :cond_1

    iget-boolean p4, p0, mFullyExpanded:Z

    if-nez p4, :cond_1

    iput-boolean v0, p0, mTriggeredExpand:Z
    ...
    :cond_1
    iput-boolean v1, p0, mTriggeredExpand:Z
    ...
    iget-boolean p4, p0, mTriggeredExpand:Z
    ...
    :cond_3
    :goto_2
    iget-object p4, p0, mDetailAdapter:Lcom/android/systemui/plugins/qs/DetailAdapter;
    ...
    iget-object v2, p0, mDetailAdapter:Lcom/android/systemui/plugins/qs/DetailAdapter;
    ...
    iget-object v4, p0, mDetailViews:Landroid/util/SparseArray;
    ...
    iget-object v5, p0, mDetailContent:Landroid/view/ViewGroup;
    ...
    invoke-virtual {p0, p1}, setupDetailFooter(Lcom/android/systemui/plugins/qs/DetailAdapter;)V

    iget-object v4, p0, mDetailContent:Landroid/view/ViewGroup;
    ...
    iput-object p1, p0, mDetailAdapter:Lcom/android/systemui/plugins/qs/DetailAdapter;

    iget-object p1, p0, mHideGridContentWhenDone:Landroid/animation/AnimatorListenerAdapter;
    ...
    :cond_9
    iget-object p1, p0, mDetailAdapter:Lcom/android/systemui/plugins/qs/DetailAdapter;
    ...
    :cond_a
    iput-boolean v0, p0, mClosingDetail:Z

    iput-object v3, p0, mDetailAdapter:Lcom/android/systemui/plugins/qs/DetailAdapter;

    iget-object p1, p0, mTeardownDetailWhenDone:Landroid/animation/AnimatorListenerAdapter;

    iget-object v2, p0, mHeader:Lcom/android/systemui/qs/QuickStatusBarHeader;

    invoke-virtual {v2, v1}, Landroid/widget/RelativeLayout;->setVisibility(I)V

    iget-object v2, p0, mFooter:Landroid/view/View;

    invoke-virtual {v2, v1}, Landroid/view/View;->setVisibility(I)V

    iget-object v2, p0, mQsPanel:Lcom/android/systemui/qs/QSPanel;

    invoke-virtual {v2, v0}, Lcom/android/systemui/qs/QSPanel;->setGridContentVisibility(Z)V

    iget-object v0, p0, mQsPanelCallback:Lcom/android/systemui/qs/QSDetail$Callback;
    ...
    invoke-virtual {p0, p2, p3, p4, p1}, animateDetailVisibleDiff(IIZLandroid/animation/Animator$AnimatorListener;)V
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object v0, p0, mDetailSettingsButton:Landroid/widget/TextView;
    ...
    :goto_0
    iget-object v1, p0, mDetailViews:Landroid/util/SparseArray;
...
.method protected onFinishInflate()V
    ...
    iput-object v0, p0, mDetailContent:Landroid/view/ViewGroup;
    ...
    iput-object v0, p0, mDetailSettingsButton:Landroid/widget/TextView;
    ...
    iput-object v0, p0, mDetailDoneButton:Landroid/widget/TextView;
    ...
    iput-object v0, p0, mQsDetailHeader:Landroid/view/View;

    iget-object v0, p0, mQsDetailHeader:Landroid/view/View;
    ...
    iput-object v0, p0, mQsDetailHeaderTitle:Landroid/widget/TextView;
    ...
    iput-object v0, p0, mQsDetailHeaderSwitch:Landroid/widget/Switch;
    ...
    iput-object v0, p0, mQsDetailHeaderProgress:Landroid/widget/ImageView;
    ...
    iput-object v0, p0, mLayoutWlbIndicators:Landroid/widget/LinearLayout;

    invoke-direct {p0}, updateDetailText()V
    ...
    iput-object v0, p0, mClipper:Lcom/android/systemui/qs/QSDetailClipper;
    ...
    iget-object v1, p0, mDetailDoneButton:Landroid/widget/TextView;

    invoke-virtual {v1, v0}, Landroid/widget/TextView;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v1, p0, mQsDetailHeader:Landroid/view/View;
    ...
    iput-object v1, p0, mQsDetailHeaderBack:Landroid/widget/ImageView;

    iget-object v1, p0, mQsDetailHeaderBack:Landroid/widget/ImageView;
...
.method public onRtlPropertiesChanged(I)V
    ...
    iget-object p0, p0, mQsDetailHeaderBack:Landroid/widget/ImageView;
...
.method public setExpanded(Z)V
    ...
    iput-boolean p1, p0, mTriggeredExpand:Z
...
.method public setFullyExpanded(Z)V
    ...
    iget-boolean v0, p0, mFullyExpanded:Z
    ...
    :cond_0
    iput-boolean p1, p0, mFullyExpanded:Z
...
.method public setQsPanel(Lcom/android/systemui/qs/QSPanel;Lcom/android/systemui/qs/QuickStatusBarHeader;Landroid/view/View;)V
    ...
    iput-object p2, p0, mHeader:Lcom/android/systemui/qs/QuickStatusBarHeader;

    iput-object p3, p0, mFooter:Landroid/view/View;

    iget-object p1, p0, mHeader:Lcom/android/systemui/qs/QuickStatusBarHeader;

    iget-object p2, p0, mQsPanelCallback:Lcom/android/systemui/qs/QSDetail$Callback;
    ...
    iget-object p0, p0, mQsPanelCallback:Lcom/android/systemui/qs/QSDetail$Callback;
...
.method protected setupDetailFooter(Lcom/android/systemui/plugins/qs/DetailAdapter;)V
    ...
    iget-object v1, p0, mDetailSettingsButton:Landroid/widget/TextView;
...
.method protected setupDetailHeader(Lcom/android/systemui/plugins/qs/DetailAdapter;)V
    ...
    iget-object v0, p0, mQsDetailHeaderTitle:Landroid/widget/TextView;
    ...
    iget-object v0, p0, mLayoutWlbIndicators:Landroid/widget/LinearLayout;
    ...
    iget-object p1, p0, mQsDetailHeaderSwitch:Landroid/widget/Switch;

    const/4 v0, 0x4

    invoke-virtual {p1, v0}, Landroid/widget/Switch;->setVisibility(I)V

    iget-object p0, p0, mQsDetailHeader:Landroid/view/View;
    ...
    :cond_1
    iget-object v2, p0, mQsDetailHeaderSwitch:Landroid/widget/Switch;
...
.method protected updateThemeColor()V
    ...
    iget-object v3, p0, mDetailSettingsButton:Landroid/widget/TextView;

    invoke-virtual {v3, v1}, Landroid/widget/TextView;->setTextColor(I)V

    iget-object v3, p0, mDetailDoneButton:Landroid/widget/TextView;

    invoke-virtual {v3, v1}, Landroid/widget/TextView;->setTextColor(I)V

    iget-object v3, p0, mQsDetailHeaderTitle:Landroid/widget/TextView;

    invoke-virtual {v3, v0}, Landroid/widget/TextView;->setTextColor(I)V

    iget-object v0, p0, mQsDetailHeaderBack:Landroid/widget/ImageView;
