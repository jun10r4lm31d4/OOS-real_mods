...
.method private constructor <init>(Landroid/service/notification/StatusBarNotification;ZILandroid/util/ArrayMap;Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;ZZZZZLcom/android/systemui/statusbar/notification/row/NotificationContentInflater$InflationCallback;Landroid/widget/RemoteViews$OnClickHandler;)V
    ...
    iput-object p5, p0, mRow:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;

    iput-object p1, p0, mSbn:Landroid/service/notification/StatusBarNotification;

    iput-boolean p2, p0, mInflateSynchronously:Z

    iput p3, p0, mReInflateFlags:I

    iput-object p4, p0, mCachedContentViews:Landroid/util/ArrayMap;
    ...
    iput-boolean p6, p0, mIsLowPriority:Z

    iput-boolean p7, p0, mIsChildInGroup:Z

    iput-boolean p8, p0, mUsesIncreasedHeight:Z

    iput-boolean p9, p0, mUsesIncreasedHeadsUpHeight:Z

    iput-boolean p10, p0, mRedactAmbient:Z

    iput-object p12, p0, mRemoteViewClickHandler:Landroid/widget/RemoteViews$OnClickHandler;

    iput-object p11, p0, mCallback:Lcom/android/systemui/statusbar/notification/row/NotificationContentInflater$InflationCallback;
...
.method synthetic constructor <init>(Landroid/service/notification/StatusBarNotification;ZILandroid/util/ArrayMap;Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;ZZZZZLcom/android/systemui/statusbar/notification/row/NotificationContentInflater$InflationCallback;Landroid/widget/RemoteViews$OnClickHandler;Lcom/android/systemui/statusbar/notification/row/NotificationContentInflater$1;)V
    ...
    invoke-direct/range {p0 .. p12}, <init>(Landroid/service/notification/StatusBarNotification;ZILandroid/util/ArrayMap;Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;ZZZZZLcom/android/systemui/statusbar/notification/row/NotificationContentInflater$InflationCallback;Landroid/widget/RemoteViews$OnClickHandler;)V
...
.method private handleError(Ljava/lang/Exception;)V
    ...
    iget-object p0, p0, mCallback:Lcom/android/systemui/statusbar/notification/row/NotificationContentInflater$InflationCallback;
...
.method public abort()V
    ...
    iget-object p0, p0, mCancellationSignal:Landroid/os/CancellationSignal;
...
.method protected varargs doInBackground([Ljava/lang/Void;)Lcom/android/systemui/statusbar/notification/row/NotificationContentInflater$InflationProgress;
    ...
    iget-object v2, v1, mSbn:Landroid/service/notification/StatusBarNotification;
    ...
    iget-object v0, v1, mSbn:Landroid/service/notification/StatusBarNotification;
    ...
    :cond_0
    iget v3, v1, mReInflateFlags:I

    iget-boolean v5, v1, mIsLowPriority:Z

    iget-boolean v6, v1, mIsChildInGroup:Z

    iget-boolean v7, v1, mUsesIncreasedHeight:Z

    iget-boolean v8, v1, mUsesIncreasedHeadsUpHeight:Z

    iget-boolean v9, v1, mRedactAmbient:Z
    ...
    iget v12, v1, mReInflateFlags:I

    iget-object v2, v1, mRow:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;
    ...
    iput-object v0, v1, mError:Ljava/lang/Exception;
...
.method protected bridge synthetic doInBackground([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, doInBackground([Ljava/lang/Void;)Lcom/android/systemui/statusbar/notification/row/NotificationContentInflater$InflationProgress;
...
.method public handleInflationException(Landroid/service/notification/StatusBarNotification;Ljava/lang/Exception;)V
    ...
    invoke-direct {p0, p2}, handleError(Ljava/lang/Exception;)V
...
.method public onAsyncInflationFinished(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;I)V
    ...
    iget-object p1, p0, mCallback:Lcom/android/systemui/statusbar/notification/row/NotificationContentInflater$InflationCallback;
...
.method protected onPostExecute(Lcom/android/systemui/statusbar/notification/row/NotificationContentInflater$InflationProgress;)V
    ...
    iget-object v0, p0, mError:Ljava/lang/Exception;

    if-nez v0, :cond_0

    iget-boolean v1, p0, mInflateSynchronously:Z

    iget v3, p0, mReInflateFlags:I

    iget-object v4, p0, mCachedContentViews:Landroid/util/ArrayMap;

    iget-object v5, p0, mRow:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;

    iget-boolean v6, p0, mRedactAmbient:Z

    iget-object v7, p0, mRemoteViewClickHandler:Landroid/widget/RemoteViews$OnClickHandler;
    ...
    iput-object p1, p0, mCancellationSignal:Landroid/os/CancellationSignal;

    goto :goto_0

    :cond_0
    invoke-direct {p0, v0}, handleError(Ljava/lang/Exception;)V
...
.method protected bridge synthetic onPostExecute(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, onPostExecute(Lcom/android/systemui/statusbar/notification/row/NotificationContentInflater$InflationProgress;)V
