...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2, v0}, <init>(Landroid/content/Context;Landroid/util/AttributeSet;Landroid/content/res/Configuration;)V
...
.method constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;Landroid/content/res/Configuration;)V
    ...
    iput-object p1, p0, mClickableChildren:Ljava/util/ArrayList;

    const/4 p1, 0x2

    new-array p2, p1, [I

    iput-object p2, p0, mTmpInt:[I

    new-array p1, p1, [I

    iput-object p1, p0, mOffset:[I
...
.method private addClickableChildren(Landroid/view/ViewGroup;)V
    ...
    iget-object v3, p0, mClickableChildren:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v2}, addClickableChildren(Landroid/view/ViewGroup;)V
...
.method private findNearestChild(Landroid/view/MotionEvent;)Landroid/view/View;
    ...
    iget-object v0, p0, mClickableChildren:Ljava/util/ArrayList;
...
.method public synthetic lambda$findNearestChild$0$NearestTouchFrame(Landroid/view/MotionEvent;Landroid/view/View;)Landroid/util/Pair;
    ...
    invoke-direct {p0, p2, p1}, distance(Landroid/view/View;Landroid/view/MotionEvent;)I
...
.method protected onMeasure(II)V
    ...
    iget-object p1, p0, mClickableChildren:Ljava/util/ArrayList;

    invoke-virtual {p1}, Ljava/util/ArrayList;->clear()V

    invoke-direct {p0, p0}, addClickableChildren(Landroid/view/ViewGroup;)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-direct {p0, p1}, findNearestChild(Landroid/view/MotionEvent;)Landroid/view/View;

    move-result-object v0

    iput-object v0, p0, mTouchingChild:Landroid/view/View;

    :cond_0
    iget-object v0, p0, mTouchingChild:Landroid/view/View;
    ...
    iget-object v1, p0, mTouchingChild:Landroid/view/View;
    ...
    iget-object p0, p0, mTouchingChild:Landroid/view/View;
