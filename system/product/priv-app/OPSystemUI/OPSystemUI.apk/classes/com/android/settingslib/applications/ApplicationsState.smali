...
.method static constructor <clinit>()V
    ...
    sput-object v0, REMOVE_DIACRITICALS_PATTERN:Ljava/util/regex/Pattern;
    ...
    sput-object v0, THEME_OVERLAY_CATEGORYS:Ljava/util/ArrayList;
    ...
    sput-object v0, SIZE_COMPARATOR:Ljava/util/Comparator;
    ...
    sput-object v0, INTERNAL_SIZE_COMPARATOR:Ljava/util/Comparator;
    ...
    sput-object v0, EXTERNAL_SIZE_COMPARATOR:Ljava/util/Comparator;
    ...
    sput-object v0, FILTER_PERSONAL:Lcom/android/settingslib/applications/ApplicationsState$AppFilter;
    ...
    sput-object v0, FILTER_WITHOUT_DISABLED_UNTIL_USED:Lcom/android/settingslib/applications/ApplicationsState$AppFilter;
    ...
    sput-object v0, FILTER_WORK:Lcom/android/settingslib/applications/ApplicationsState$AppFilter;
    ...
    sput-object v0, FILTER_DOWNLOADED_AND_LAUNCHER:Lcom/android/settingslib/applications/ApplicationsState$AppFilter;
    ...
    sput-object v0, FILTER_DOWNLOADED_AND_LAUNCHER_AND_INSTANT:Lcom/android/settingslib/applications/ApplicationsState$AppFilter;
    ...
    sput-object v0, FILTER_THIRD_PARTY:Lcom/android/settingslib/applications/ApplicationsState$AppFilter;
    ...
    sput-object v0, FILTER_DISABLED:Lcom/android/settingslib/applications/ApplicationsState$AppFilter;
    ...
    sput-object v0, FILTER_INSTANT:Lcom/android/settingslib/applications/ApplicationsState$AppFilter;
    ...
    sput-object v0, FILTER_ALL_ENABLED:Lcom/android/settingslib/applications/ApplicationsState$AppFilter;
    ...
    sput-object v0, FILTER_EVERYTHING:Lcom/android/settingslib/applications/ApplicationsState$AppFilter;
    ...
    sput-object v0, FILTER_WITH_DOMAIN_URLS:Lcom/android/settingslib/applications/ApplicationsState$AppFilter;
    ...
    sput-object v0, FILTER_NOT_HIDE:Lcom/android/settingslib/applications/ApplicationsState$AppFilter;
    ...
    sput-object v0, FILTER_GAMES:Lcom/android/settingslib/applications/ApplicationsState$AppFilter;
    ...
    sput-object v0, FILTER_AUDIO:Lcom/android/settingslib/applications/ApplicationsState$AppFilter;
    ...
    sput-object v0, FILTER_MOVIES:Lcom/android/settingslib/applications/ApplicationsState$AppFilter;
    ...
    sput-object v0, FILTER_PHOTOS:Lcom/android/settingslib/applications/ApplicationsState$AppFilter;
    ...
    sput-object v0, FILTER_OTHER_APPS:Lcom/android/settingslib/applications/ApplicationsState$AppFilter;
...
.method private constructor <init>(Landroid/app/Application;Landroid/content/pm/IPackageManager;)V
    ...
    iput-object v0, p0, mRebuildingSessions:Ljava/util/ArrayList;

    new-instance v0, Lcom/android/settingslib/applications/InterestingConfigChanges;

    invoke-direct {v0}, Lcom/android/settingslib/applications/InterestingConfigChanges;-><init>()V

    iput-object v0, p0, mInterestingConfigChanges:Lcom/android/settingslib/applications/InterestingConfigChanges;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, mEntriesMap:Landroid/util/SparseArray;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mAppEntries:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mApplications:Ljava/util/List;

    const-wide/16 v0, 0x1

    iput-wide v0, p0, mCurId:J

    new-instance v2, Ljava/util/HashMap;

    invoke-direct {v2}, Ljava/util/HashMap;-><init>()V

    iput-object v2, p0, mSystemModules:Ljava/util/HashMap;

    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    iput-object v2, p0, mActiveSessions:Ljava/util/ArrayList;
    ...
    iput-object v2, p0, mMainHandler:Lcom/android/settingslib/applications/ApplicationsState$MainHandler;

    new-instance v2, Ljava/util/HashMap;

    invoke-direct {v2}, Ljava/util/HashMap;-><init>()V

    iput-object v2, p0, mSystemPersistApplications:Ljava/util/HashMap;
    ...
    iput-object p1, p0, mDrawableFactory:Landroid/util/IconDrawableFactory;

    iput-object p2, p0, mIpm:Landroid/content/pm/IPackageManager;
    ...
    iput-object p1, p0, mUm:Landroid/os/UserManager;
    ...
    iput-object p1, p0, mStats:Landroid/app/usage/StorageStatsManager;

    iget-object p1, p0, mUm:Landroid/os/UserManager;
    ...
    iget-object v5, p0, mEntriesMap:Landroid/util/SparseArray;
    ...
    iput-object p1, p0, mThread:Landroid/os/HandlerThread;

    iget-object p1, p0, mThread:Landroid/os/HandlerThread;

    invoke-virtual {p1}, Landroid/os/HandlerThread;->start()V

    new-instance p1, Lcom/android/settingslib/applications/ApplicationsState$BackgroundHandler;

    iget-object p2, p0, mThread:Landroid/os/HandlerThread;
    ...
    iput-object p1, p0, mBackgroundHandler:Lcom/android/settingslib/applications/ApplicationsState$BackgroundHandler;

    const p1, 0x408200

    iput p1, p0, mAdminRetrieveFlags:I

    const p1, 0x8200

    iput p1, p0, mRetrieveFlags:I

    iget-object p1, p0, mPm:Landroid/content/pm/PackageManager;
    ...
    iget-object v3, p0, mSystemModules:Ljava/util/HashMap;
    ...
    invoke-direct {p0, v2}, isSystemApp(Landroid/content/pm/ApplicationInfo;)Z
    ...
    invoke-direct {p0, v2}, getSystemPersistMetaData(Landroid/content/pm/ApplicationInfo;)Z
    ...
    invoke-direct {p0, p2}, addForceStopWhiteList(Landroid/content/pm/ApplicationInfo;)V

    goto :goto_2

    :cond_3
    iget-object p1, p0, mEntriesMap:Landroid/util/SparseArray;

    monitor-enter p1

    :try_start_0
    iget-object p0, p0, mEntriesMap:Landroid/util/SparseArray;
...
.method static synthetic access$100()Ljava/util/ArrayList;
    ...
    sget-object v0, THEME_OVERLAY_CATEGORYS:Ljava/util/ArrayList;
...
.method static synthetic access$200(Lcom/android/settingslib/applications/ApplicationsState;Landroid/content/pm/ApplicationInfo;)Lcom/android/settingslib/applications/ApplicationsState$AppEntry;
    ...
    invoke-direct {p0, p1}, getEntryLocked(Landroid/content/pm/ApplicationInfo;)Lcom/android/settingslib/applications/ApplicationsState$AppEntry;
...
.method static synthetic access$300(II)Z
    ...
    invoke-static {p0, p1}, hasFlag(II)Z
...
.method static synthetic access$500(Lcom/android/settingslib/applications/ApplicationsState;Landroid/content/pm/PackageStats;)J
    ...
    invoke-direct {p0, p1}, getTotalInternalSize(Landroid/content/pm/PackageStats;)J
...
.method static synthetic access$600(Lcom/android/settingslib/applications/ApplicationsState;J)Ljava/lang/String;
    ...
    invoke-direct {p0, p1, p2}, getSizeStr(J)Ljava/lang/String;
...
.method static synthetic access$700(Lcom/android/settingslib/applications/ApplicationsState;Landroid/content/pm/PackageStats;)J
    ...
    invoke-direct {p0, p1}, getTotalExternalSize(Landroid/content/pm/PackageStats;)J
...
.method static synthetic access$800(Lcom/android/settingslib/applications/ApplicationsState;I)V
    ...
    invoke-direct {p0, p1}, addUser(I)V
...
.method private addForceStopWhiteList(Landroid/content/pm/ApplicationInfo;)V
    ...
    iget-object p0, p0, mSystemPersistApplications:Ljava/util/HashMap;
...
.method private addUser(I)V
    ...
    iget-object v0, p0, mEntriesMap:Landroid/util/SparseArray;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, mEntriesMap:Landroid/util/SparseArray;
    ...
    iget-boolean p1, p0, mResumed:Z

    if-eqz p1, :cond_0

    invoke-virtual {p0}, doPauseLocked()V

    invoke-virtual {p0}, doResumeIfNeededLocked()V

    :cond_0
    iget-object p1, p0, mMainHandler:Lcom/android/settingslib/applications/ApplicationsState$MainHandler;
    ...
    iget-object p0, p0, mMainHandler:Lcom/android/settingslib/applications/ApplicationsState$MainHandler;
...
.method private static anyAppIsRemoved(Ljava/util/List;Ljava/util/List;)Z
    ...
    invoke-static {v5, v4}, hasFlag(II)Z
    ...
    invoke-static {v2, v4}, hasFlag(II)Z
...
.method private getEntryLocked(Landroid/content/pm/ApplicationInfo;)Lcom/android/settingslib/applications/ApplicationsState$AppEntry;
    ...
    invoke-virtual {p0, v1}, isHiddenModule(Ljava/lang/String;)Z
    ...
    iget-wide v3, p0, mCurId:J

    const-wide/16 v5, 0x1

    add-long/2addr v5, v3

    iput-wide v5, p0, mCurId:J
    ...
    iget-object v2, p0, mEntriesMap:Landroid/util/SparseArray;
    ...
    iget-object p0, p0, mAppEntries:Ljava/util/ArrayList;
...
.method static getInstance(Landroid/app/Application;Landroid/content/pm/IPackageManager;)Lcom/android/settingslib/applications/ApplicationsState;
    ...
    :try_start_0
    sget-object v1, sInstance:Lcom/android/settingslib/applications/ApplicationsState;

    if-nez v1, :cond_0

    new-instance v1, Lcom/android/settingslib/applications/ApplicationsState;

    invoke-direct {v1, p0, p1}, <init>(Landroid/app/Application;Landroid/content/pm/IPackageManager;)V

    sput-object v1, sInstance:Lcom/android/settingslib/applications/ApplicationsState;

    :cond_0
    sget-object p0, sInstance:Lcom/android/settingslib/applications/ApplicationsState;
...
.method private getSystemPersistMetaData(Landroid/content/pm/ApplicationInfo;)Z
    ...
    :try_start_0
    iget-object p0, p0, mPm:Landroid/content/pm/PackageManager;
...
.method private removeUser(I)V
    ...
    iget-object v3, p0, mAppEntries:Ljava/util/ArrayList;

    invoke-virtual {v3, v2}, Ljava/util/ArrayList;->remove(Ljava/lang/Object;)Z

    iget-object v3, p0, mApplications:Ljava/util/List;
...
.method addPackage(Ljava/lang/String;I)V
    ...
    :cond_0
    invoke-virtual {p0, p1, p2}, indexOfApplicationInfoLocked(Ljava/lang/String;I)I
    ...
    :cond_1
    iget-object v1, p0, mIpm:Landroid/content/pm/IPackageManager;

    iget-object v2, p0, mUm:Landroid/os/UserManager;
    ...
    iget v2, p0, mAdminRetrieveFlags:I

    goto :goto_0

    :cond_2
    iget v2, p0, mRetrieveFlags:I
    ...
    :cond_4
    iput-boolean v1, p0, mHaveDisabledApps:Z
    ...
    iput-boolean v1, p0, mHaveInstantApps:Z

    :cond_6
    iget-object p2, p0, mApplications:Ljava/util/List;

    invoke-interface {p2, p1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    iget-object p1, p0, mBackgroundHandler:Lcom/android/settingslib/applications/ApplicationsState$BackgroundHandler;
...
.method doPauseLocked()V
    ...
    iget-object v0, p0, mPackageIntentReceiver:Lcom/android/settingslib/applications/ApplicationsState$PackageIntentReceiver;
    ...
    iput-object v0, p0, mPackageIntentReceiver:Lcom/android/settingslib/applications/ApplicationsState$PackageIntentReceiver;
...
.method doResumeIfNeededLocked()V
    ...
    iget-object v1, p0, mPackageIntentReceiver:Lcom/android/settingslib/applications/ApplicationsState$PackageIntentReceiver;
    ...
    iput-object v1, p0, mPackageIntentReceiver:Lcom/android/settingslib/applications/ApplicationsState$PackageIntentReceiver;
    ...
    :cond_1
    iget-object v1, p0, mApplications:Ljava/util/List;

    new-instance v3, Ljava/util/ArrayList;

    invoke-direct {v3}, Ljava/util/ArrayList;-><init>()V

    iput-object v3, p0, mApplications:Ljava/util/List;
    ...
    :cond_2
    iget-object v5, p0, mIpm:Landroid/content/pm/IPackageManager;
    ...
    iget v6, p0, mAdminRetrieveFlags:I

    goto :goto_1

    :cond_3
    iget v6, p0, mRetrieveFlags:I
    ...
    iget-object v5, p0, mApplications:Ljava/util/List;
    ...
    :cond_4
    iget-object v3, p0, mInterestingConfigChanges:Lcom/android/settingslib/applications/InterestingConfigChanges;
    ...
    invoke-virtual {p0}, clearEntries()V
    ...
    :goto_2
    iget-object v5, p0, mAppEntries:Ljava/util/ArrayList;
    ...
    :cond_6
    :goto_3
    iput-boolean v4, p0, mHaveDisabledApps:Z

    iput-boolean v4, p0, mHaveInstantApps:Z
    ...
    :cond_7
    iput-boolean v0, p0, mHaveDisabledApps:Z

    :cond_8
    iget-object v5, v3, Landroid/content/pm/ApplicationInfo;->packageName:Ljava/lang/String;

    invoke-virtual {p0, v5}, isHiddenModule(Ljava/lang/String;)Z
    ...
    :cond_9
    iget-boolean v5, p0, mHaveInstantApps:Z
    ...
    iput-boolean v0, p0, mHaveInstantApps:Z
    ...
    :cond_b
    iget-object v6, p0, mEntriesMap:Landroid/util/SparseArray;
    ...
    :cond_d
    iget-object v0, p0, mApplications:Ljava/util/List;

    invoke-static {v1, v0}, anyAppIsRemoved(Ljava/util/List;Ljava/util/List;)Z
    ...
    :cond_e
    iput-object v2, p0, mCurComputingSizePkg:Ljava/lang/String;

    iget-object v0, p0, mBackgroundHandler:Lcom/android/settingslib/applications/ApplicationsState$BackgroundHandler;
    ...
    iget-object p0, p0, mBackgroundHandler:Lcom/android/settingslib/applications/ApplicationsState$BackgroundHandler;
...
.method public invalidatePackage(Ljava/lang/String;I)V
    ...
    invoke-virtual {p0, p1, p2}, removePackage(Ljava/lang/String;I)V

    invoke-virtual {p0, p1, p2}, addPackage(Ljava/lang/String;I)V
...
.method isHiddenModule(Ljava/lang/String;)Z
    ...
    iget-object p0, p0, mSystemModules:Ljava/util/HashMap;
...
.method rebuildActiveSessions()V
    ...
    :try_start_0
    iget-boolean v1, p0, mSessionsChanged:Z
    ...
    :cond_0
    iget-object v1, p0, mActiveSessions:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, mActiveSessions:Ljava/util/ArrayList;
...
.method public removePackage(Ljava/lang/String;I)V
    ...
    iget-object v3, p0, mEntriesMap:Landroid/util/SparseArray;
    ...
    iget-object p1, p0, mAppEntries:Ljava/util/ArrayList;

    invoke-virtual {p1, v2}, Ljava/util/ArrayList;->remove(Ljava/lang/Object;)Z

    :cond_0
    iget-object p1, p0, mApplications:Ljava/util/List;
    ...
    iput-boolean v2, p0, mHaveDisabledApps:Z
    ...
    iput-boolean v2, p0, mHaveInstantApps:Z
...
.method setInterestingConfigChanges(Lcom/android/settingslib/applications/InterestingConfigChanges;)V
    ...
    iput-object p1, p0, mInterestingConfigChanges:Lcom/android/settingslib/applications/InterestingConfigChanges;
