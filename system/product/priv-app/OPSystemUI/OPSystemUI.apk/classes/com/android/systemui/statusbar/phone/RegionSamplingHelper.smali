...
.method public constructor <init>(Landroid/view/View;Lcom/android/systemui/statusbar/phone/RegionSamplingHelper$SamplingCallback;)V
    ...
    iput-object v0, p0, mUpdateSamplingListener:Ljava/lang/Runnable;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, mSamplingRequestBounds:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, mRegisteredSamplingBounds:Landroid/graphics/Rect;

    const/4 v0, 0x0

    iput-boolean v0, p0, mSamplingEnabled:Z

    iput-boolean v0, p0, mSamplingListenerRegistered:Z

    const/4 v0, 0x0

    iput-object v0, p0, mRegisteredStopLayer:Landroid/view/SurfaceControl;
    ...
    iput-object v0, p0, mUpdateOnDraw:Landroid/view/ViewTreeObserver$OnDrawListener;
    ...
    iput-object v0, p0, mRemoveDrawRunnable:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mSamplingListener:Landroid/view/CompositionSamplingListener;

    iput-object p1, p0, mSampledView:Landroid/view/View;

    iget-object v0, p0, mSampledView:Landroid/view/View;
    ...
    iput v0, p0, mLuminanceThreshold:F
    ...
    iput p1, p0, mLuminanceChangeThreshold:F

    iput-object p2, p0, mCallback:Lcom/android/systemui/statusbar/phone/RegionSamplingHelper$SamplingCallback;
...
.method static synthetic access$000(Lcom/android/systemui/statusbar/phone/RegionSamplingHelper;)Ljava/lang/Runnable;
    ...
    iget-object p0, p0, mRemoveDrawRunnable:Ljava/lang/Runnable;
...
.method static synthetic access$300(Lcom/android/systemui/statusbar/phone/RegionSamplingHelper;)Landroid/view/ViewTreeObserver$OnDrawListener;
    ...
    iget-object p0, p0, mUpdateOnDraw:Landroid/view/ViewTreeObserver$OnDrawListener;
...
.method static synthetic access$400(Lcom/android/systemui/statusbar/phone/RegionSamplingHelper;)Landroid/view/View;
    ...
    iget-object p0, p0, mSampledView:Landroid/view/View;
...
.method static synthetic access$500(Lcom/android/systemui/statusbar/phone/RegionSamplingHelper;)Z
    ...
    iget-boolean p0, p0, mSamplingEnabled:Z
...
.method static synthetic access$600(Lcom/android/systemui/statusbar/phone/RegionSamplingHelper;F)V
    ...
    invoke-direct {p0, p1}, updateMediaLuma(F)V
...
.method public static synthetic lambda$pSsfVRzQ1H9WUV0xYw9vQmpq4Cw(Lcom/android/systemui/statusbar/phone/RegionSamplingHelper;)V
    ...
    invoke-direct {p0}, updateSamplingListener()V
...
.method private onDraw()V
    ...
    iget-boolean v0, p0, mWaitingOnDraw:Z

    if-eqz v0, :cond_0

    const/4 v0, 0x0

    iput-boolean v0, p0, mWaitingOnDraw:Z
...
.method private postUpdateSamplingListener()V
    ...
    iget-object v1, p0, mUpdateSamplingListener:Ljava/lang/Runnable;

    invoke-virtual {v0, v1}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    iget-object v0, p0, mHandler:Landroid/os/Handler;

    iget-object p0, p0, mUpdateSamplingListener:Ljava/lang/Runnable;
...
.method private unregisterSamplingListener()V
    ...
    iget-boolean v0, p0, mSamplingListenerRegistered:Z
    ...
    iget-object v0, p0, mRegisteredSamplingBounds:Landroid/graphics/Rect;

    invoke-virtual {v0}, Landroid/graphics/Rect;->setEmpty()V

    iget-object p0, p0, mSamplingListener:Landroid/view/CompositionSamplingListener;
...
.method private updateMediaLuma(F)V
    ...
    iput p1, p0, mCurrentMedianLuma:F

    iget v0, p0, mCurrentMedianLuma:F

    iget v1, p0, mLastMedianLuma:F
    ...
    iget v1, p0, mLuminanceChangeThreshold:F

    cmpl-float v0, v0, v1

    if-lez v0, :cond_1

    iget-object v0, p0, mCallback:Lcom/android/systemui/statusbar/phone/RegionSamplingHelper$SamplingCallback;

    iget v1, p0, mLuminanceThreshold:F
...
.method private updateSamplingListener()V
    ...
    iget-boolean v0, p0, mSamplingEnabled:Z
    ...
    iget-object v0, p0, mSamplingRequestBounds:Landroid/graphics/Rect;
    ...
    iget-boolean v0, p0, mFirstSamplingAfterStart:Z
    ...
    iput-boolean v1, p0, mWaitingOnDraw:Z

    iget-object v0, p0, mHandler:Landroid/os/Handler;

    iget-object v4, p0, mRemoveDrawRunnable:Ljava/lang/Runnable;
    ...
    iget-object v4, p0, mUpdateOnDraw:Landroid/view/ViewTreeObserver$OnDrawListener;
    ...
    :cond_6
    iget-object v4, p0, mSamplingRequestBounds:Landroid/graphics/Rect;

    iget-object v5, p0, mRegisteredSamplingBounds:Landroid/graphics/Rect;
    ...
    iget-object v4, p0, mRegisteredStopLayer:Landroid/view/SurfaceControl;

    if-eq v4, v0, :cond_9

    :cond_7
    invoke-direct {p0}, unregisterSamplingListener()V

    iput-boolean v1, p0, mSamplingListenerRegistered:Z

    iget-object v1, p0, mSamplingListener:Landroid/view/CompositionSamplingListener;
    ...
    iget-object v1, p0, mRegisteredSamplingBounds:Landroid/graphics/Rect;

    iget-object v3, p0, mSamplingRequestBounds:Landroid/graphics/Rect;
    ...
    :cond_9
    iput-boolean v2, p0, mFirstSamplingAfterStart:Z
...
.method public onLayoutChange(Landroid/view/View;IIIIIIII)V
    ...
    invoke-virtual {p0}, updateSamplingRect()V
...
.method public onViewDetachedFromWindow(Landroid/view/View;)V
    ...
    invoke-direct {p0}, postUpdateSamplingListener()V
...
.method start(Landroid/graphics/Rect;)V
    ...
    iput-boolean p1, p0, mSamplingEnabled:Z

    const/high16 v0, -0x40800000    # -1.0f

    iput v0, p0, mLastMedianLuma:F

    iput-boolean p1, p0, mFirstSamplingAfterStart:Z
...
.method public updateSamplingRect()V
    ...
    iget-object v1, p0, mSampledView:Landroid/view/View;
    ...
    iget-object v1, p0, mSamplingRequestBounds:Landroid/graphics/Rect;
