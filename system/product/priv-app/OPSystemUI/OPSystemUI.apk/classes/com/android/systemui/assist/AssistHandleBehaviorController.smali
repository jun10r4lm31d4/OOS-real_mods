...
.method static constructor <clinit>()V
    ...
    sput-wide v0, DEFAULT_SHOW_AND_GO_DURATION_MS:J
    ...
    sput-object v0, DEFAULT_BEHAVIOR:Lcom/android/systemui/assist/AssistHandleBehavior;
...
.method constructor <init>(Landroid/content/Context;Lcom/android/internal/app/AssistUtils;Landroid/os/Handler;)V
    ...
    invoke-direct/range {v0 .. v6}, <init>(Landroid/content/Context;Lcom/android/internal/app/AssistUtils;Landroid/os/Handler;Ljava/util/function/Supplier;Lcom/android/systemui/assist/PhenotypeHelper;Lcom/android/systemui/assist/AssistHandleBehaviorController$BehaviorController;)V
...
.method constructor <init>(Landroid/content/Context;Lcom/android/internal/app/AssistUtils;Landroid/os/Handler;Ljava/util/function/Supplier;Lcom/android/systemui/assist/PhenotypeHelper;Lcom/android/systemui/assist/AssistHandleBehaviorController$BehaviorController;)V
    ...
    iput-object v0, p0, mHideHandles:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mShowAndGo:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mBehaviorMap:Ljava/util/Map;

    const/4 v0, 0x0

    iput-boolean v0, p0, mHandlesShowing:Z

    sget-object v0, Lcom/android/systemui/assist/AssistHandleBehavior;->OFF:Lcom/android/systemui/assist/AssistHandleBehavior;

    iput-object v0, p0, mCurrentBehavior:Lcom/android/systemui/assist/AssistHandleBehavior;

    iput-object p1, p0, mContext:Landroid/content/Context;

    iput-object p2, p0, mAssistUtils:Lcom/android/internal/app/AssistUtils;

    iput-object p3, p0, mHandler:Landroid/os/Handler;

    iput-object p4, p0, mScreenDecorationsSupplier:Ljava/util/function/Supplier;

    iput-object p5, p0, mPhenotypeHelper:Lcom/android/systemui/assist/PhenotypeHelper;

    iget-object p1, p0, mBehaviorMap:Ljava/util/Map;
    ...
    invoke-direct {p0}, getBehaviorMode()Ljava/lang/String;

    move-result-object p1

    invoke-direct {p0, p1}, setBehavior(Ljava/lang/String;)V

    iget-object p1, p0, mPhenotypeHelper:Lcom/android/systemui/assist/PhenotypeHelper;
...
.method private clearPendingCommands()V
    ...
    iget-object v1, p0, mHideHandles:Ljava/lang/Runnable;

    invoke-virtual {v0, v1}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    iget-object v0, p0, mHandler:Landroid/os/Handler;

    iget-object p0, p0, mShowAndGo:Ljava/lang/Runnable;
...
.method private getBehaviorMode()Ljava/lang/String;
    ...
    sget-object v0, DEFAULT_BEHAVIOR:Lcom/android/systemui/assist/AssistHandleBehavior;
...
.method private getShowAndGoDuration()J
    ...
    sget-wide v0, DEFAULT_SHOW_AND_GO_DURATION_MS:J
...
.method private handleNavigationModeChange(I)V
    ...
    iget-object v0, p0, mCurrentBehavior:Lcom/android/systemui/assist/AssistHandleBehavior;
...
.method private handlesUnblocked(Z)Z
    ...
    iget-wide v2, p0, mHandlesLastHiddenAt:J
    ...
    invoke-direct {p0}, getShownFrequencyThreshold()J
...
.method private hideHandles()V
    ...
    iget-boolean v0, p0, mHandlesShowing:Z
    ...
    :cond_0
    iget-object v0, p0, mScreenDecorationsSupplier:Ljava/util/function/Supplier;
    ...
    iput-boolean v1, p0, mHandlesShowing:Z

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J

    move-result-wide v2

    iput-wide v2, p0, mHandlesLastHiddenAt:J
...
.method public static synthetic lambda$UX7PPcltnlTgxyL7MxmLbVmQRcI(Lcom/android/systemui/assist/AssistHandleBehaviorController;I)V
    ...
    invoke-direct {p0, p1}, handleNavigationModeChange(I)V
...
.method public static synthetic lambda$XubZVLOT9vWCBnL-QqZRgbOELVA(Lcom/android/systemui/assist/AssistHandleBehaviorController;)V
    ...
    invoke-direct {p0}, hideHandles()V
...
.method public static synthetic lambda$oeveMWAQo5jd5bG1H5Ci7Dy4X74(Lcom/android/systemui/assist/AssistHandleBehaviorController;)V
    ...
    invoke-direct {p0}, showAndGoInternal()V
...
.method private maybeShowHandles(Z)V
    ...
    :cond_0
    invoke-direct {p0, p1}, handlesUnblocked(Z)Z

    move-result p1

    if-eqz p1, :cond_2

    iget-object p1, p0, mScreenDecorationsSupplier:Ljava/util/function/Supplier;
...
.method private setBehavior(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, setBehavior(Lcom/android/systemui/assist/AssistHandleBehavior;)V
    :try_end_0
...
.method private showAndGoInternal()V
    ...
    invoke-direct {p0, v0}, maybeShowHandles(Z)V

    iget-object v0, p0, mHandler:Landroid/os/Handler;

    iget-object v1, p0, mHideHandles:Ljava/lang/Runnable;

    invoke-direct {p0}, getShowAndGoDuration()J
...
.method areHandlesShowing()Z
    ...
    iget-boolean p0, p0, mHandlesShowing:Z
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-boolean p3, p0, mHandlesShowing:Z
    ...
    iget-wide v0, p0, mHandlesLastHiddenAt:J
    ...
    iget-boolean p3, p0, mInGesturalMode:Z
    ...
    iget-object p3, p0, mCurrentBehavior:Lcom/android/systemui/assist/AssistHandleBehavior;
    ...
    iget-object p0, p0, mCurrentBehavior:Lcom/android/systemui/assist/AssistHandleBehavior;
...
.method public hide()V
    ...
    invoke-direct {p0}, clearPendingCommands()V

    iget-object v0, p0, mHandler:Landroid/os/Handler;

    iget-object p0, p0, mHideHandles:Ljava/lang/Runnable;
...
.method onAssistantGesturePerformed()V
    ...
    iget-object v0, p0, mBehaviorMap:Ljava/util/Map;
...
.method setBehavior(Lcom/android/systemui/assist/AssistHandleBehavior;)V
    ...
    iget-object v1, p0, mCurrentBehavior:Lcom/android/systemui/assist/AssistHandleBehavior;
    ...
    :cond_2
    iput-object p1, p0, mCurrentBehavior:Lcom/android/systemui/assist/AssistHandleBehavior;
...
.method public showAndGoDelayed(JZ)V
    ...
    iget-object v0, p0, mHideHandles:Ljava/lang/Runnable;
