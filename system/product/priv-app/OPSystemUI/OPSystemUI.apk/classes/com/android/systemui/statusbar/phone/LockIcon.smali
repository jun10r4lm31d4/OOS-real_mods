...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;Lcom/android/systemui/plugins/statusbar/StatusBarStateController;Lcom/android/systemui/statusbar/policy/ConfigurationController;Lcom/android/systemui/statusbar/policy/AccessibilityController;Lcom/android/systemui/statusbar/policy/KeyguardMonitor;Lcom/android/systemui/dock/DockManager;Landroid/os/Handler;)V
    ...
    iput-object p2, p0, mKeyguardMonitorCallback:Lcom/android/systemui/statusbar/policy/KeyguardMonitor$Callback;
    ...
    iput-object p2, p0, mDockEventListener:Lcom/android/systemui/dock/DockManager$DockEventListener;
    ...
    iput-object p5, p0, mAccessibilityController:Lcom/android/systemui/statusbar/policy/AccessibilityController;
    ...
    iput-object p6, p0, mKeyguardMonitor:Lcom/android/systemui/statusbar/policy/KeyguardMonitor;

    iput-object p7, p0, mDockManager:Lcom/android/systemui/dock/DockManager;

    iput-object p8, p0, mMainHandler:Landroid/os/Handler;
...
.method static synthetic access$400(Lcom/android/systemui/statusbar/phone/LockIcon;)Z
    ...
    iget-boolean p0, p0, mSimLocked:Z
...
.method static synthetic access$402(Lcom/android/systemui/statusbar/phone/LockIcon;Z)Z
    ...
    iput-boolean p1, p0, mSimLocked:Z
...
.method public synthetic lambda$setPulsing$0$LockIcon()V
    ...
    iput-boolean v0, p0, mWasPulsingOnThisFrame:Z
...
.method protected onAttachedToWindow()V
    ...
    iget-object v0, p0, mConfigurationController:Lcom/android/systemui/statusbar/policy/ConfigurationController;

    invoke-interface {v0, p0}, Lcom/android/systemui/statusbar/policy/CallbackController;->addCallback(Ljava/lang/Object;)V

    iget-object v0, p0, mKeyguardMonitor:Lcom/android/systemui/statusbar/policy/KeyguardMonitor;

    iget-object v1, p0, mKeyguardMonitorCallback:Lcom/android/systemui/statusbar/policy/KeyguardMonitor$Callback;
    ...
    iput-boolean v0, p0, mSimLocked:Z

    iget-object v0, p0, mDockManager:Lcom/android/systemui/dock/DockManager;

    if-eqz v0, :cond_0

    iget-object v1, p0, mDockEventListener:Lcom/android/systemui/dock/DockManager$DockEventListener;
...
.method public onBiometricAuthModeChanged(Z)V
    ...
    iput-boolean p1, p0, mWakeAndUnlockRunning:Z
...
.method protected onDetachedFromWindow()V
    ...
    iget-object p0, p0, mDockEventListener:Lcom/android/systemui/dock/DockManager$DockEventListener;
...
.method public onDozeAmountChanged(FF)V
    ...
    invoke-direct {p0}, updateDarkTint()V
...
.method public onInitializeAccessibilityNodeInfo(Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    :cond_0
    iget-boolean v0, p0, mIsFaceUnlockState:Z
...
.method public onScrimVisibilityChanged(I)V
    ...
    iget-boolean v0, p0, mWakeAndUnlockRunning:Z
...
.method public onShowingLaunchAffordanceChanged(Z)V
    ...
    iput-boolean p1, p0, mShowingLaunchAffordance:Z
...
.method public opUpdate(Z)V
    ...
    :goto_4
    iput-boolean v3, p0, mIsFaceUnlockState:Z

    iget v3, p0, mLastState:I
    ...
    iget-boolean v4, p0, mLastScreenOn:Z
    ...
    iget-boolean v8, p0, mLastScreenOn:Z
    ...
    iget-boolean p1, p0, mIsFaceUnlockState:Z
    ...
    iput-boolean p1, p0, mLastScreenOn:Z
    ...
    invoke-direct {p0}, updateClickability()V
...
.method public setBouncerVisible(Z)V
    ...
    iget-boolean v0, p0, mBouncerVisible:Z
    ...
    :cond_0
    iput-boolean p1, p0, mBouncerVisible:Z
...
.method public setPulsing(Z)V
    ...
    iget-boolean p1, p0, mPulsing:Z

    if-nez p1, :cond_0

    const/4 p1, 0x1

    iput-boolean p1, p0, mWasPulsingOnThisFrame:Z
...
.method public setTransientBiometricsError(Z)V
    ...
    iput-boolean p1, p0, mTransientBiometricsError:Z
...
.method public update(Z)V
    ...
    invoke-virtual {p0, p1}, opUpdate(Z)V
