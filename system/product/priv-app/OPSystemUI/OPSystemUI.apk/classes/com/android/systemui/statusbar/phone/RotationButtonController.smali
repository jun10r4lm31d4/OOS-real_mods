...
.method constructor <init>(Landroid/content/Context;ILcom/android/systemui/statusbar/phone/RotationButton;)V
    ...
    iput-object v0, p0, mViewRippler:Lcom/android/systemui/statusbar/phone/RotationButtonController$ViewRippler;

    const/4 v0, 0x0

    iput-boolean v0, p0, mListenersRegistered:Z
    ...
    iput-object v0, p0, mRemoveRotationProposal:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mCancelPendingRotationProposal:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mRotationWatcher:Landroid/view/IRotationWatcher$Stub;

    iput-object p1, p0, mContext:Landroid/content/Context;

    iput-object p3, p0, mRotationButton:Lcom/android/systemui/statusbar/phone/RotationButton;

    iget-object p1, p0, mRotationButton:Lcom/android/systemui/statusbar/phone/RotationButton;
    ...
    iput p2, p0, mStyleRes:I

    const/4 p1, 0x1

    iput-boolean p1, p0, mIsNavigationBarShowing:Z
    ...
    iput-object p1, p0, mRotationLockController:Lcom/android/systemui/statusbar/policy/RotationLockController;
    ...
    iput-object p1, p0, mTaskStackListener:Lcom/android/systemui/statusbar/phone/RotationButtonController$TaskStackListenerImpl;
...
.method static synthetic access$200(Lcom/android/systemui/statusbar/phone/RotationButtonController;)Lcom/android/systemui/statusbar/policy/RotationLockController;
    ...
    iget-object p0, p0, mRotationLockController:Lcom/android/systemui/statusbar/policy/RotationLockController;
...
.method static synthetic access$300(Lcom/android/systemui/statusbar/phone/RotationButtonController;I)Z
    ...
    invoke-direct {p0, p1}, shouldOverrideUserLockPrefs(I)Z
...
.method static synthetic access$400(Lcom/android/systemui/statusbar/phone/RotationButtonController;)Ljava/util/function/Consumer;
    ...
    iget-object p0, p0, mRotWatcherListener:Ljava/util/function/Consumer;
...
.method static synthetic access$600(Lcom/android/systemui/statusbar/phone/RotationButtonController;)Lcom/android/systemui/statusbar/phone/RotationButton;
    ...
    iget-object p0, p0, mRotationButton:Lcom/android/systemui/statusbar/phone/RotationButton;
...
.method private computeRotationProposalTimeout()I
    ...
    iget-boolean p0, p0, mHoveringRotationSuggestion:Z
...
.method public static synthetic lambda$ITAepcsPx2pDX6xNt-4OEwYvoRc(Lcom/android/systemui/statusbar/phone/RotationButtonController;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    invoke-direct {p0, p1, p2}, onRotateSuggestionHover(Landroid/view/View;Landroid/view/MotionEvent;)Z
...
.method public static synthetic lambda$nGgIS1iCjy5uWWIfPZ9LUPKtUUc(Lcom/android/systemui/statusbar/phone/RotationButtonController;Landroid/view/View;)V
    ...
    invoke-direct {p0, p1}, onRotateSuggestionClick(Landroid/view/View;)V
...
.method private onRotateSuggestionClick(Landroid/view/View;)V
    ...
    invoke-direct {p0}, incrementNumAcceptedRotationSuggestionsIfNeeded()V

    iget p1, p0, mLastRotationSuggestion:I

    invoke-virtual {p0, p1}, setRotationLockedAtAngle(I)V
...
.method private onRotateSuggestionHover(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    :goto_1
    iput-boolean p1, p0, mHoveringRotationSuggestion:Z

    invoke-direct {p0, v0}, rescheduleRotationTimeout(Z)V
...
.method private onRotationSuggestionsDisabled()V
    ...
    invoke-virtual {p0, v0, v1}, setRotateSuggestionButtonState(ZZ)V

    iget-object v0, p0, mMainThreadHandler:Landroid/os/Handler;

    iget-object p0, p0, mRemoveRotationProposal:Ljava/lang/Runnable;
...
.method private rescheduleRotationTimeout(Z)V
    ...
    iget-object p1, p0, mRotateHideAnimator:Landroid/animation/Animator;
    ...
    iget-object v0, p0, mRemoveRotationProposal:Ljava/lang/Runnable;
    ...
    invoke-direct {p0}, computeRotationProposalTimeout()I
...
.method private showAndLogRotationSuggestion()V
    ...
    invoke-virtual {p0, v0}, setRotateSuggestionButtonState(Z)V
...
.method addRotationCallback(Ljava/util/function/Consumer;)V
    ...
    iput-object p1, p0, mRotWatcherListener:Ljava/util/function/Consumer;
...
.method public synthetic lambda$new$1$RotationButtonController()V
    ...
    iput-boolean v0, p0, mPendingRotationSuggestion:Z
...
.method onDisable2FlagChanged(I)V
    ...
    invoke-static {p1}, hasDisable2RotateSuggestionFlag(I)Z

    move-result p1

    if-eqz p1, :cond_0

    invoke-direct {p0}, onRotationSuggestionsDisabled()V
...
.method onNavigationBarWindowVisibilityChange(Z)V
    ...
    iget-boolean v0, p0, mIsNavigationBarShowing:Z
    ...
    iget-boolean p1, p0, mPendingRotationSuggestion:Z

    if-eqz p1, :cond_0

    invoke-direct {p0}, showAndLogRotationSuggestion()V
...
.method onRotationProposal(IIZ)V
    ...
    iget-object v0, p0, mRotationButton:Lcom/android/systemui/statusbar/phone/RotationButton;
    ...
    iget-object p2, p0, mRemoveRotationProposal:Ljava/lang/Runnable;
    ...
    :cond_2
    iput p1, p0, mLastRotationSuggestion:I

    invoke-direct {p0, p2, p1}, isRotationAnimationCCW(II)Z
    ...
    iput-boolean p1, p0, mPendingRotationSuggestion:Z

    iget-object p1, p0, mMainThreadHandler:Landroid/os/Handler;

    iget-object p2, p0, mCancelPendingRotationProposal:Ljava/lang/Runnable;

    invoke-virtual {p1, p2}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    iget-object p1, p0, mMainThreadHandler:Landroid/os/Handler;

    iget-object p0, p0, mCancelPendingRotationProposal:Ljava/lang/Runnable;
...
.method registerListeners()V
    ...
    iget-boolean v0, p0, mListenersRegistered:Z
    ...
    iget-object v1, p0, mRotationWatcher:Landroid/view/IRotationWatcher$Stub;
    ...
    iget-object p0, p0, mTaskStackListener:Lcom/android/systemui/statusbar/phone/RotationButtonController$TaskStackListenerImpl;
...
.method setRotateSuggestionButtonState(Z)V
    ...
    invoke-virtual {p0, p1, v0}, setRotateSuggestionButtonState(ZZ)V
...
.method setRotateSuggestionButtonState(ZZ)V
    ...
    :cond_1
    iget-object v1, p0, mRotationButton:Lcom/android/systemui/statusbar/phone/RotationButton;
    ...
    iput-boolean v2, p0, mPendingRotationSuggestion:Z

    iget-object v3, p0, mMainThreadHandler:Landroid/os/Handler;

    iget-object v4, p0, mCancelPendingRotationProposal:Ljava/lang/Runnable;
    ...
    iput-object p1, p0, mRotateHideAnimator:Landroid/animation/Animator;
    ...
    :cond_4
    invoke-direct {p0}, isRotateSuggestionIntroduced()Z

    move-result p1

    if-nez p1, :cond_5

    iget-object p1, p0, mViewRippler:Lcom/android/systemui/statusbar/phone/RotationButtonController$ViewRippler;
