...
.method public constructor <init>(Landroid/content/Context;Landroid/app/IActivityManager;)V
    ...
    iput-object v0, p0, mPlayPauseActionReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v0, p0, mPlaybackChangedListener:Landroid/media/session/MediaController$Callback;
    ...
    iput-object v0, p0, mSessionsChangedListener:Landroid/media/session/MediaSessionManager$OnActiveSessionsChangedListener;
    ...
    iget-object v1, p0, mPlayPauseActionReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-direct {p0}, createMediaActions()V
...
.method static synthetic access$100(Lcom/android/systemui/pip/phone/PipMediaController;)V
    ...
    invoke-direct {p0}, notifyActionsChanged()V
...
.method static synthetic access$200(Lcom/android/systemui/pip/phone/PipMediaController;Ljava/util/List;)V
    ...
    invoke-direct {p0, p1}, resolveActiveMediaController(Ljava/util/List;)V
...
.method private createMediaActions()V
    ...
    iput-object v1, p0, mPauseAction:Landroid/app/RemoteAction;
    ...
    iput-object v1, p0, mPlayAction:Landroid/app/RemoteAction;
    ...
    iput-object v1, p0, mNextAction:Landroid/app/RemoteAction;
    ...
    iput-object v1, p0, mPrevAction:Landroid/app/RemoteAction;
...
.method private getMediaActions()Ljava/util/List;
    ...
    iget-object v4, p0, mPrevAction:Landroid/app/RemoteAction;
    ...
    iget-object v1, p0, mPlayAction:Landroid/app/RemoteAction;
    ...
    iget-object v1, p0, mPauseAction:Landroid/app/RemoteAction;

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    :cond_3
    :goto_1
    iget-object v1, p0, mNextAction:Landroid/app/RemoteAction;
    ...
    iget-object p0, p0, mNextAction:Landroid/app/RemoteAction;
...
.method private notifyActionsChanged()V
    ...
    invoke-direct {p0}, getMediaActions()Ljava/util/List;
...
.method private registerSessionListenerForCurrentUser()V
    ...
    iget-object v0, p0, mMediaSessionManager:Landroid/media/session/MediaSessionManager;

    iget-object v1, p0, mSessionsChangedListener:Landroid/media/session/MediaSessionManager$OnActiveSessionsChangedListener;

    invoke-virtual {v0, v1}, Landroid/media/session/MediaSessionManager;->removeOnActiveSessionsChangedListener(Landroid/media/session/MediaSessionManager$OnActiveSessionsChangedListener;)V

    iget-object v0, p0, mMediaSessionManager:Landroid/media/session/MediaSessionManager;

    iget-object p0, p0, mSessionsChangedListener:Landroid/media/session/MediaSessionManager$OnActiveSessionsChangedListener;
...
.method private resolveActiveMediaController(Ljava/util/List;)V
    ...
    invoke-direct {p0, v2}, setActiveMediaController(Landroid/media/session/MediaController;)V
    ...
    invoke-direct {p0, p1}, setActiveMediaController(Landroid/media/session/MediaController;)V
...
.method private setActiveMediaController(Landroid/media/session/MediaController;)V
    ...
    iget-object v1, p0, mPlaybackChangedListener:Landroid/media/session/MediaController$Callback;
    ...
    iget-object v0, p0, mPlaybackChangedListener:Landroid/media/session/MediaController$Callback;
...
.method public synthetic lambda$new$0$PipMediaController(Ljava/lang/String;Landroid/graphics/drawable/Drawable;Ljava/lang/String;)V
    ...
    invoke-direct {p0}, registerSessionListenerForCurrentUser()V
...
.method public onActivityPinned()V
    ...
    invoke-direct {p0, v0}, resolveActiveMediaController(Ljava/util/List;)V
