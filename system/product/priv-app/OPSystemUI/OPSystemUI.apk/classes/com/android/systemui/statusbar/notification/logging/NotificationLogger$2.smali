...
.method constructor <init>(Lcom/android/systemui/statusbar/notification/logging/NotificationLogger;)V
    ...
    iput-object p1, p0, this$0:Lcom/android/systemui/statusbar/notification/logging/NotificationLogger;
    ...
    iput-object p1, p0, mTmpNewlyVisibleNotifications:Landroid/util/ArraySet;

    new-instance p1, Landroid/util/ArraySet;

    invoke-direct {p1}, Landroid/util/ArraySet;-><init>()V

    iput-object p1, p0, mTmpCurrentlyVisibleNotifications:Landroid/util/ArraySet;

    new-instance p1, Landroid/util/ArraySet;

    invoke-direct {p1}, Landroid/util/ArraySet;-><init>()V

    iput-object p1, p0, mTmpNoLongerVisibleNotifications:Landroid/util/ArraySet;
...
.method public run()V
    ...
    iget-object v0, p0, this$0:Lcom/android/systemui/statusbar/notification/logging/NotificationLogger;
    ...
    iget-object v5, p0, this$0:Lcom/android/systemui/statusbar/notification/logging/NotificationLogger;
    ...
    iget-object v4, p0, this$0:Lcom/android/systemui/statusbar/notification/logging/NotificationLogger;
    ...
    iget-object v5, p0, mTmpCurrentlyVisibleNotifications:Landroid/util/ArraySet;

    invoke-virtual {v5, v3}, Landroid/util/ArraySet;->add(Ljava/lang/Object;)Z

    if-nez v4, :cond_1

    iget-object v4, p0, mTmpNewlyVisibleNotifications:Landroid/util/ArraySet;
    ...
    :cond_2
    iget-object v0, p0, mTmpNoLongerVisibleNotifications:Landroid/util/ArraySet;

    iget-object v1, p0, this$0:Lcom/android/systemui/statusbar/notification/logging/NotificationLogger;
    ...
    iget-object v1, p0, mTmpCurrentlyVisibleNotifications:Landroid/util/ArraySet;

    invoke-virtual {v0, v1}, Landroid/util/ArraySet;->removeAll(Landroid/util/ArraySet;)Z

    iget-object v0, p0, this$0:Lcom/android/systemui/statusbar/notification/logging/NotificationLogger;

    iget-object v1, p0, mTmpNewlyVisibleNotifications:Landroid/util/ArraySet;

    iget-object v2, p0, mTmpNoLongerVisibleNotifications:Landroid/util/ArraySet;
    ...
    iget-object v1, p0, mTmpNoLongerVisibleNotifications:Landroid/util/ArraySet;

    invoke-static {v0, v1}, Lcom/android/systemui/statusbar/notification/logging/NotificationLogger;->access$500(Lcom/android/systemui/statusbar/notification/logging/NotificationLogger;Landroid/util/ArraySet;)V

    iget-object v0, p0, mTmpCurrentlyVisibleNotifications:Landroid/util/ArraySet;

    invoke-virtual {v0}, Landroid/util/ArraySet;->clear()V

    iget-object v0, p0, mTmpNewlyVisibleNotifications:Landroid/util/ArraySet;

    invoke-virtual {v0}, Landroid/util/ArraySet;->clear()V

    iget-object p0, p0, mTmpNoLongerVisibleNotifications:Landroid/util/ArraySet;
