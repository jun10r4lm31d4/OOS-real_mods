...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/statusbar/phone/StatusBar;Lcom/android/systemui/plugins/statusbar/StatusBarStateController;Lcom/android/systemui/statusbar/NotificationMediaManager;)V
    ...
    iput-object v0, p0, mUpdateStatusBarIcons:Ljava/lang/Runnable;

    const/4 v0, -0x1

    iput v0, p0, mIconTint:I

    iput v0, p0, mCenteredIconTint:I

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, mTintArea:Landroid/graphics/Rect;

    const/4 v0, 0x1

    iput-boolean v0, p0, mShowLowPriority:Z
    ...
    iput-object v0, p0, mSettingsListener:Lcom/android/systemui/statusbar/NotificationListener$NotificationSettingsListener;

    iput-object p2, p0, mStatusBar:Lcom/android/systemui/statusbar/phone/StatusBar;
    ...
    iput-object p2, p0, mContrastColorUtil:Lcom/android/internal/util/ContrastColorUtil;
    ...
    iput-object p2, p0, mEntryManager:Lcom/android/systemui/statusbar/notification/NotificationEntryManager;

    iput-object p3, p0, mStatusBarStateController:Lcom/android/systemui/plugins/statusbar/StatusBarStateController;

    iget-object p2, p0, mStatusBarStateController:Lcom/android/systemui/plugins/statusbar/StatusBarStateController;
    ...
    iput-object p4, p0, mMediaManager:Lcom/android/systemui/statusbar/NotificationMediaManager;
    ...
    iget-object p3, p0, mSettingsListener:Lcom/android/systemui/statusbar/NotificationListener$NotificationSettingsListener;
    ...
    invoke-virtual {p0, p1}, initializeNotificationAreaViews(Landroid/content/Context;)V
...
.method static synthetic access$002(Lcom/android/systemui/statusbar/phone/NotificationIconAreaController;Z)Z
    ...
    iput-boolean p1, p0, mShowLowPriority:Z
...
.method static synthetic access$100(Lcom/android/systemui/statusbar/phone/NotificationIconAreaController;)Landroid/view/ViewGroup;
    ...
    iget-object p0, p0, mNotificationScrollLayout:Landroid/view/ViewGroup;
...
.method private applyNotificationIconsTint()V
    ...
    :goto_0
    iget-object v2, p0, mNotificationIcons:Lcom/android/systemui/statusbar/phone/NotificationIconContainer;
    ...
    iget v3, p0, mIconTint:I

    invoke-direct {p0, v2, v3}, updateTintForIcon(Lcom/android/systemui/statusbar/StatusBarIconView;I)V
    ...
    :cond_1
    :goto_2
    iget-object v1, p0, mCenteredIcon:Lcom/android/systemui/statusbar/phone/NotificationIconContainer;
    ...
    iget v2, p0, mCenteredIconTint:I

    invoke-direct {p0, v1, v2}, updateTintForIcon(Lcom/android/systemui/statusbar/StatusBarIconView;I)V
...
.method private updateAnimations()V
    ...
    :goto_0
    iget-object v3, p0, mCenteredIcon:Lcom/android/systemui/statusbar/phone/NotificationIconContainer;

    iget-boolean v4, p0, mAnimationsEnabled:Z
    ...
    iget-object v3, p0, mNotificationIcons:Lcom/android/systemui/statusbar/phone/NotificationIconContainer;
...
.method private updateCenterIcon()V
    ...
    iget-object v2, p0, mCenteredIcon:Lcom/android/systemui/statusbar/phone/NotificationIconContainer;

    iget-boolean v7, p0, mFullyDark:Z
    ...
    invoke-direct/range {v0 .. v8}, updateIconsForLayout(Ljava/util/function/Function;Lcom/android/systemui/statusbar/phone/NotificationIconContainer;ZZZZZZ)V
...
.method private updateIconsForLayout(Ljava/util/function/Function;Lcom/android/systemui/statusbar/phone/NotificationIconContainer;ZZZZZZ)V
    ...
    iget-object v0, v9, mNotificationScrollLayout:Landroid/view/ViewGroup;
    ...
    iget-object v0, v9, mNotificationIcons:Lcom/android/systemui/statusbar/phone/NotificationIconContainer;

    invoke-virtual {v10, v0}, Ljava/lang/Object;->equals(Ljava/lang/Object;)Z

    move-result v12

    iget-object v0, v9, mShelfIcons:Lcom/android/systemui/statusbar/phone/NotificationIconContainer;
    ...
    :cond_10
    invoke-direct/range {p0 .. p0}, generateIconLayoutParams()Landroid/widget/FrameLayout$LayoutParams;
    ...
    iget-object v3, v9, mUpdateStatusBarIcons:Ljava/lang/Runnable;
    ...
    iget-object v0, v9, mStatusBar:Lcom/android/systemui/statusbar/phone/StatusBar;
...
.method private updateTintForIcon(Lcom/android/systemui/statusbar/StatusBarIconView;I)V
    ...
    iget-object v4, p0, mContrastColorUtil:Lcom/android/internal/util/ContrastColorUtil;

    iget-object v5, p0, mTintArea:Landroid/graphics/Rect;
...
.method public getCenteredNotificationAreaView()Landroid/view/View;
    ...
    iget-object p0, p0, mCenteredIconArea:Landroid/view/View;
...
.method public getNotificationInnerAreaView()Landroid/view/View;
    ...
    iget-object p0, p0, mNotificationIconArea:Landroid/view/View;
...
.method protected initializeNotificationAreaViews(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1}, reloadDimens(Landroid/content/Context;)V

    invoke-static {p1}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;

    move-result-object p1

    invoke-virtual {p0, p1}, inflateIconArea(Landroid/view/LayoutInflater;)Landroid/view/View;

    move-result-object v0

    iput-object v0, p0, mNotificationIconArea:Landroid/view/View;

    iget-object v0, p0, mNotificationIconArea:Landroid/view/View;
    ...
    iput-object v0, p0, mNotificationIcons:Lcom/android/systemui/statusbar/phone/NotificationIconContainer;
    ...
    iput-object v0, p0, mNotificationScrollLayout:Landroid/view/ViewGroup;
    ...
    iput-object p1, p0, mCenteredIconArea:Landroid/view/View;

    iget-object p1, p0, mCenteredIconArea:Landroid/view/View;
    ...
    iput-object p1, p0, mCenteredIcon:Lcom/android/systemui/statusbar/phone/NotificationIconContainer;
...
.method public synthetic lambda$applyNotificationIconsTint$3$NotificationIconAreaController(Lcom/android/systemui/statusbar/StatusBarIconView;)V
    ...
    invoke-direct {p0, p1, v0}, updateTintForIcon(Lcom/android/systemui/statusbar/StatusBarIconView;I)V
...
.method public synthetic lambda$applyNotificationIconsTint$4$NotificationIconAreaController(Lcom/android/systemui/statusbar/StatusBarIconView;)V
    ...
    iget v0, p0, mCenteredIconTint:I
...
.method public onDarkChanged(Landroid/graphics/Rect;FI)V
    ...
    iget-object p2, p0, mTintArea:Landroid/graphics/Rect;
    ...
    :goto_0
    iget-object p2, p0, mNotificationIconArea:Landroid/view/View;
    ...
    :cond_2
    :goto_1
    iget-object p2, p0, mCenteredIconArea:Landroid/view/View;
    ...
    iput p3, p0, mCenteredIconTint:I
    ...
    :cond_4
    :goto_2
    invoke-direct {p0}, applyNotificationIconsTint()V
...
.method public onDensityOrFontScaleChanged(Landroid/content/Context;)V
    ...
    invoke-direct {p0}, generateIconLayoutParams()Landroid/widget/FrameLayout$LayoutParams;
...
.method public onDozeAmountChanged(FF)V
    ...
    :goto_0
    iget-boolean p2, p0, mFullyDark:Z

    if-eq p2, p1, :cond_1

    iput-boolean p1, p0, mFullyDark:Z

    invoke-direct {p0}, updateShelfIcons()V
...
.method public onStateChanged(I)V
    ...
    invoke-direct {p0}, updateAnimations()V
...
.method public setIsolatedIconLocation(Landroid/graphics/Rect;Z)V
    ...
    iget-object p0, p0, mNotificationIcons:Lcom/android/systemui/statusbar/phone/NotificationIconContainer;
...
.method public updateNotificationIcons()V
    ...
    invoke-virtual {p0}, updateStatusBarIcons()V

    invoke-direct {p0}, updateShelfIcons()V

    invoke-direct {p0}, updateCenterIcon()V
...
.method public updateStatusBarIcons()V
    ...
    iget-boolean v4, p0, mShowLowPriority:Z
