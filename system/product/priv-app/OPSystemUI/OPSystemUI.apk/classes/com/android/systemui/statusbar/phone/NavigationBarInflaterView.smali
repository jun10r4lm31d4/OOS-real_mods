...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-boolean p1, p0, mIsCustomNavBar:Z

    invoke-virtual {p0}, createInflaters()V
...
.method private addAll(Lcom/android/systemui/statusbar/phone/ButtonDispatcher;Landroid/view/ViewGroup;)V
    ...
    invoke-direct {p0, p1, v1}, addAll(Lcom/android/systemui/statusbar/phone/ButtonDispatcher;Landroid/view/ViewGroup;)V
...
.method private addToDispatchers(Landroid/view/View;)V
    ...
    invoke-direct {p0, v2}, addToDispatchers(Landroid/view/View;)V
...
.method private applySize(Landroid/view/View;Ljava/lang/String;ZZ)Landroid/view/View;
    ...
    invoke-static {p2}, extractSize(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, p1}, convertDpToPx(Landroid/content/Context;F)F
...
.method private clearViews()V
    ...
    :cond_0
    iget-object v0, p0, mHorizontal:Landroid/widget/FrameLayout;
    ...
    invoke-direct {p0, v0}, clearAllChildren(Landroid/view/ViewGroup;)V

    iget-object v0, p0, mVertical:Landroid/widget/FrameLayout;
...
.method private createView(Ljava/lang/String;Landroid/view/ViewGroup;Landroid/view/LayoutInflater;)Landroid/view/View;
    ...
    invoke-static {p1}, extractButton(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2}, extractButton(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1}, extractButton(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-boolean p0, p0, mIsCustomNavBar:Z
    ...
    iget-boolean p2, p0, mIsCustomNavBar:Z
    ...
    invoke-static {p1}, extractImage(Ljava/lang/String;)Ljava/lang/String;

    move-result-object p0

    invoke-static {p1}, extractKeycode(Ljava/lang/String;)I
...
.method private inflateButtons([Ljava/lang/String;Landroid/view/ViewGroup;ZZ)V
    ...
    invoke-virtual {p0, v1, p2, p3, p4}, inflateButton(Ljava/lang/String;Landroid/view/ViewGroup;ZZ)Landroid/view/View;
...
.method private inflateChildren()V
    ...
    iput-object v0, p0, mHorizontal:Landroid/widget/FrameLayout;

    iget-boolean v0, p0, mIsCustomNavBar:Z
    ...
    :goto_1
    iget-object v1, p0, mHorizontal:Landroid/widget/FrameLayout;
    ...
    iput-object v1, p0, mVertical:Landroid/widget/FrameLayout;

    iget-object v1, p0, mVertical:Landroid/widget/FrameLayout;
    ...
    invoke-direct {p0}, updateAlternativeOrder()V
...
.method private initiallyFill(Lcom/android/systemui/statusbar/phone/ButtonDispatcher;)V
    ...
    invoke-direct {p0, p1, v0}, addAll(Lcom/android/systemui/statusbar/phone/ButtonDispatcher;Landroid/view/ViewGroup;)V
...
.method private updateAlternativeOrder()V
    ...
    invoke-direct {p0, v0}, updateAlternativeOrder(Landroid/view/View;)V
...
.method private updateAlternativeOrder(Landroid/view/View;)V
    ...
    iget-boolean p0, p0, mAlternativeOrder:Z
...
.method private updateChildrenMargin()V
    ...
    :goto_1
    iget-object v2, p0, mHorizontal:Landroid/widget/FrameLayout;
    ...
    iget-object v3, p0, mHorizontal:Landroid/widget/FrameLayout;
    ...
    iget-object v2, p0, mVertical:Landroid/widget/FrameLayout;
...
.method createInflaters()V
    ...
    iput-object v0, p0, mLandscapeInflater:Landroid/view/LayoutInflater;
...
.method protected inflateButton(Ljava/lang/String;Landroid/view/ViewGroup;ZZ)Landroid/view/View;
    ...
    iget-object v0, p0, mLandscapeInflater:Landroid/view/LayoutInflater;
    ...
    :goto_0
    invoke-direct {p0, p1, p2, v0}, createView(Ljava/lang/String;Landroid/view/ViewGroup;Landroid/view/LayoutInflater;)Landroid/view/View;
    ...
    :cond_1
    invoke-direct {p0, v0, p1, p3, p4}, applySize(Landroid/view/View;Ljava/lang/String;ZZ)Landroid/view/View;

    move-result-object p1

    invoke-virtual {p2, p1}, Landroid/view/ViewGroup;->addView(Landroid/view/View;)V

    invoke-direct {p0, p1}, addToDispatchers(Landroid/view/View;)V

    if-eqz p3, :cond_2

    iget-object p2, p0, mLastLandscape:Landroid/view/View;

    goto :goto_1

    :cond_2
    iget-object p2, p0, mLastPortrait:Landroid/view/View;
    ...
    iput-object p4, p0, mLastLandscape:Landroid/view/View;

    goto :goto_3

    :cond_5
    iput-object p4, p0, mLastPortrait:Landroid/view/View;
...
.method protected inflateLayout(Ljava/lang/String;)V
    ...
    iput-object p1, p0, mCurrentLayout:Ljava/lang/String;

    if-nez p1, :cond_0

    invoke-virtual {p0}, getDefaultLayout()Ljava/lang/String;
    ...
    invoke-direct {p0, v1, v2, v0, v3}, inflateButtons([Ljava/lang/String;Landroid/view/ViewGroup;ZZ)V
    ...
    invoke-direct {p0, v1, v2, v3, v3}, inflateButtons([Ljava/lang/String;Landroid/view/ViewGroup;ZZ)V
    ...
    invoke-direct {p0, v4, v1, v0, v0}, inflateButtons([Ljava/lang/String;Landroid/view/ViewGroup;ZZ)V
    ...
    invoke-direct {p0, v4, v1, v3, v0}, inflateButtons([Ljava/lang/String;Landroid/view/ViewGroup;ZZ)V
    ...
    invoke-direct {p0, v1}, addGravitySpacer(Landroid/widget/LinearLayout;)V
    ...
    invoke-direct {p0, p1, v1, v0, v0}, inflateButtons([Ljava/lang/String;Landroid/view/ViewGroup;ZZ)V
    ...
    invoke-direct {p0, p1, v1, v3, v0}, inflateButtons([Ljava/lang/String;Landroid/view/ViewGroup;ZZ)V
    ...
    :cond_3
    invoke-virtual {p0}, updateButtonDispatchersCurrentView()V
...
.method protected onAttachedToWindow()V
    ...
    invoke-virtual {p0}, onLikelyDefaultLayoutChange()V
...
.method protected onFinishInflate()V
    ...
    invoke-direct {p0}, inflateChildren()V

    invoke-direct {p0}, clearViews()V

    invoke-virtual {p0}, getDefaultLayout()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p0, v0}, inflateLayout(Ljava/lang/String;)V
...
.method public onLikelyDefaultLayoutChange()V
    ...
    iget-boolean v0, p0, mUsingCustomLayout:Z
    ...
    iget-object v1, p0, mCurrentLayout:Ljava/lang/String;
    ...
    invoke-direct {p0}, updateChildrenMargin()V
...
.method setAlternativeOrder(Z)V
    ...
    iget-boolean v0, p0, mAlternativeOrder:Z

    if-eq p1, v0, :cond_0

    iput-boolean p1, p0, mAlternativeOrder:Z
...
.method public setButtonDispatchers(Landroid/util/SparseArray;)V
    ...
    iput-object p1, p0, mButtonDispatchers:Landroid/util/SparseArray;
    ...
    invoke-direct {p0, v1}, initiallyFill(Lcom/android/systemui/statusbar/phone/ButtonDispatcher;)V
...
.method setVertical(Z)V
    ...
    iput-boolean p1, p0, mIsVertical:Z
...
.method updateButtonDispatchersCurrentView()V
    ...
    :goto_1
    iget-object v2, p0, mButtonDispatchers:Landroid/util/SparseArray;
...
.method public updateCurrentView()V
    ...
    iget v1, p0, mScreenResolution:I
