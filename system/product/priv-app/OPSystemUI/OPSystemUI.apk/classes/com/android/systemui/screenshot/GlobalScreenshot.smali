...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, mScreenshotLayout:Landroid/view/View;

    iget-object v1, p0, mScreenshotLayout:Landroid/view/View;
    ...
    iput-object v1, p0, mBackgroundView:Landroid/widget/ImageView;
    ...
    iput-object v1, p0, mScreenshotView:Landroid/widget/ImageView;
    ...
    iput-object v1, p0, mScreenshotFlash:Landroid/widget/ImageView;
    ...
    iput-object v1, p0, mScreenshotSelectorView:Lcom/android/systemui/screenshot/ScreenshotSelectorView;
    ...
    iget-object v1, p0, mScreenshotSelectorView:Lcom/android/systemui/screenshot/ScreenshotSelectorView;
    ...
    iput-object v1, p0, mWindowLayoutParams:Landroid/view/WindowManager$LayoutParams;
    ...
    iput p1, p0, mNotificationIconSize:I
    ...
    iput p1, p0, mBgPadding:F

    iget p1, p0, mBgPadding:F
    ...
    iput v0, p0, mPreviewHeight:I

    new-instance v0, Landroid/media/MediaActionSound;

    invoke-direct {v0}, Landroid/media/MediaActionSound;-><init>()V

    iput-object v0, p0, mCameraSound:Landroid/media/MediaActionSound;

    iget-object p0, p0, mCameraSound:Landroid/media/MediaActionSound;
...
.method static synthetic access$000(Lcom/android/systemui/screenshot/GlobalScreenshot;)Landroid/view/View;
    ...
    iget-object p0, p0, mScreenshotLayout:Landroid/view/View;
...
.method static synthetic access$1100(Lcom/android/systemui/screenshot/GlobalScreenshot;)Landroid/widget/ImageView;
    ...
    iget-object p0, p0, mScreenshotFlash:Landroid/widget/ImageView;
...
.method static synthetic access$1200(Landroid/content/Context;)V
    ...
    invoke-static {p0}, cancelScreenshotNotification(Landroid/content/Context;)V
...
.method static synthetic access$200(Lcom/android/systemui/screenshot/GlobalScreenshot;Ljava/lang/Runnable;ZZLandroid/graphics/Rect;)V
    ...
    invoke-direct {p0, p1, p2, p3, p4}, takeScreenshot(Ljava/lang/Runnable;ZZLandroid/graphics/Rect;)V
...
.method static synthetic access$300(Lcom/android/systemui/screenshot/GlobalScreenshot;)Lcom/android/systemui/screenshot/ScreenshotSelectorView;
    ...
    iget-object p0, p0, mScreenshotSelectorView:Lcom/android/systemui/screenshot/ScreenshotSelectorView;
...
.method static synthetic access$400(Lcom/android/systemui/screenshot/GlobalScreenshot;Ljava/lang/Runnable;)V
    ...
    invoke-direct {p0, p1}, saveScreenshotInWorkerThread(Ljava/lang/Runnable;)V
...
.method static synthetic access$502(Lcom/android/systemui/screenshot/GlobalScreenshot;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    iput-object p1, p0, mScreenBitmap:Landroid/graphics/Bitmap;
...
.method static synthetic access$600(Lcom/android/systemui/screenshot/GlobalScreenshot;)Landroid/widget/ImageView;
    ...
    iget-object p0, p0, mScreenshotView:Landroid/widget/ImageView;
...
.method static synthetic access$800(Lcom/android/systemui/screenshot/GlobalScreenshot;)Landroid/animation/AnimatorSet;
    ...
    iget-object p0, p0, mScreenshotAnimation:Landroid/animation/AnimatorSet;
...
.method static synthetic access$900(Lcom/android/systemui/screenshot/GlobalScreenshot;)Landroid/widget/ImageView;
    ...
    iget-object p0, p0, mBackgroundView:Landroid/widget/ImageView;
...
.method private createScreenshotDropInAnimation()Landroid/animation/ValueAnimator;
    ...
    iget-object v2, p0, mScreenshotView:Landroid/widget/ImageView;
...
.method private saveScreenshotInWorkerThread(Ljava/lang/Runnable;)V
    ...
    iput-object p1, p0, mSaveInBgTask:Landroid/os/AsyncTask;
...
.method private startAnimation(Ljava/lang/Runnable;IIZZ)V
    ...
    :cond_0
    iget-object v0, p0, mScreenshotView:Landroid/widget/ImageView;

    iget-object v2, p0, mScreenBitmap:Landroid/graphics/Bitmap;

    invoke-virtual {v0, v2}, Landroid/widget/ImageView;->setImageBitmap(Landroid/graphics/Bitmap;)V

    iget-object v0, p0, mScreenshotLayout:Landroid/view/View;

    invoke-virtual {v0}, Landroid/view/View;->requestFocus()Z

    iget-object v0, p0, mScreenshotAnimation:Landroid/animation/AnimatorSet;
    ...
    iget-object v2, p0, mScreenshotLayout:Landroid/view/View;

    iget-object v3, p0, mWindowLayoutParams:Landroid/view/WindowManager$LayoutParams;

    invoke-interface {v0, v2, v3}, Landroid/view/WindowManager;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    invoke-direct {p0}, createScreenshotDropInAnimation()Landroid/animation/ValueAnimator;

    move-result-object v0

    invoke-direct {p0, p2, p3, p4, p5}, createScreenshotDropOutAnimation(IIZZ)Landroid/animation/ValueAnimator;
    ...
    iput-object p3, p0, mScreenshotAnimation:Landroid/animation/AnimatorSet;

    iget-object p3, p0, mScreenshotAnimation:Landroid/animation/AnimatorSet;
    ...
    iget-object p2, p0, mScreenshotAnimation:Landroid/animation/AnimatorSet;
    ...
    iget-object p1, p0, mScreenshotLayout:Landroid/view/View;
...
.method private takeScreenshot(Ljava/lang/Runnable;ZZLandroid/graphics/Rect;)V
    ...
    iput-object p4, p0, mScreenBitmap:Landroid/graphics/Bitmap;

    iget-object p4, p0, mScreenBitmap:Landroid/graphics/Bitmap;
    ...
    invoke-static {p2, p0, p3}, notifyScreenshotError(Landroid/content/Context;Landroid/app/NotificationManager;I)V
    ...
    iget-object p4, p0, mDisplayMetrics:Landroid/util/DisplayMetrics;
    ...
    invoke-direct/range {v0 .. v5}, startAnimation(Ljava/lang/Runnable;IIZZ)V
...
.method stopScreenshot()V
    ...
    iget-object v0, p0, mScreenshotSelectorView:Lcom/android/systemui/screenshot/ScreenshotSelectorView;
...
.method takeScreenshot(Ljava/lang/Runnable;ZZ)V
    ...
    invoke-direct {p0, p1, p2, p3, v0}, takeScreenshot(Ljava/lang/Runnable;ZZLandroid/graphics/Rect;)V
