...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p1, p0, mCornerRadii:[F

    const/4 p1, 0x1

    iput-boolean p1, p0, mBottomAmountClips:Z

    const/16 p1, 0xff

    iput p1, p0, mDrawableAlpha:I
    ...
    iput-boolean p1, p0, mDontModifyCorners:Z
...
.method private draw(Landroid/graphics/Canvas;Landroid/graphics/drawable/Drawable;)V
    ...
    iget v0, p0, mBackgroundTop:I

    iget v1, p0, mActualHeight:I

    iget-boolean v2, p0, mBottomIsRounded:Z

    if-eqz v2, :cond_0

    iget-boolean v2, p0, mBottomAmountClips:Z
    ...
    iget-boolean v2, p0, mLastInSection:Z
    ...
    :cond_1
    iget-boolean v4, p0, mTopAmountRounded:Z

    if-eqz v4, :cond_4

    iget v4, p0, mClipTopAmount:I

    int-to-float v4, v4

    iget v5, p0, mDistanceToTopRoundness:F
    ...
    iget-boolean v5, p0, mFirstInSection:Z
...
.method private updateBackgroundRadii()V
    ...
    iget-boolean v0, p0, mDontModifyCorners:Z
    ...
    iget-object p0, p0, mCornerRadii:[F
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget v1, p0, mClipBottomAmount:I

    add-int/2addr v0, v1

    iget v1, p0, mActualHeight:I

    iget v2, p0, mBackgroundTop:I
    ...
    iget v1, p0, mClipTopAmount:I

    invoke-virtual {p0}, Landroid/view/View;->getWidth()I

    move-result v2

    iget v3, p0, mActualHeight:I

    iget v4, p0, mClipBottomAmount:I
...
.method public setBottomAmountClips(Z)V
    ...
    iget-boolean v0, p0, mBottomAmountClips:Z
...
.method public setCustomBackground(I)V
    ...
    invoke-virtual {p0, p1}, setCustomBackground(Landroid/graphics/drawable/Drawable;)V
...
.method public setCustomBackground(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object p1, p0, mBackground:Landroid/graphics/drawable/Drawable;
    ...
    iget p1, p0, mTintColor:I

    invoke-virtual {p0, p1}, setTint(I)V
    ...
    :cond_2
    invoke-direct {p0}, updateBackgroundRadii()V
...
.method public setExpandAnimationRunning(Z)V
    ...
    iget p1, p0, mDrawableAlpha:I

    invoke-virtual {p0, p1}, setDrawableAlpha(I)V
...
.method public setPressedAllowed(Z)V
    ...
    iput-boolean p1, p0, mIsPressedAllowed:Z
...
.method public setRoundness(FF)V
    ...
    iget-object v0, p0, mCornerRadii:[F
    ...
    :goto_0
    iput-boolean v0, p0, mBottomIsRounded:Z
...
.method public setState([I)V
    ...
    iget-boolean v0, p0, mIsPressedAllowed:Z
