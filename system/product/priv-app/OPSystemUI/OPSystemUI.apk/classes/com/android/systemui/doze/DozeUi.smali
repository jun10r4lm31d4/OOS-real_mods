...
.method public constructor <init>(Landroid/content/Context;Landroid/app/AlarmManager;Lcom/android/systemui/doze/DozeMachine;Lcom/android/systemui/util/wakelock/WakeLock;Lcom/android/systemui/doze/DozeHost;Landroid/os/Handler;Lcom/android/systemui/statusbar/phone/DozeParameters;Lcom/android/keyguard/KeyguardUpdateMonitor;)V
    ...
    iput-object v0, p0, mKeyguardVisibilityCallback:Lcom/android/keyguard/KeyguardUpdateMonitorCallback;

    const-wide/16 v0, 0x0

    iput-wide v0, p0, mLastTimeTickElapsed:J

    iput-object p1, p0, mContext:Landroid/content/Context;

    iput-object p3, p0, mMachine:Lcom/android/systemui/doze/DozeMachine;

    iput-object p4, p0, mWakeLock:Lcom/android/systemui/util/wakelock/WakeLock;

    iput-object p5, p0, mHost:Lcom/android/systemui/doze/DozeHost;

    iput-object p6, p0, mHandler:Landroid/os/Handler;
    ...
    iput-boolean p1, p0, mCanAnimateTransition:Z

    iput-object p7, p0, mDozeParameters:Lcom/android/systemui/statusbar/phone/DozeParameters;
    ...
    iget-object p0, p0, mKeyguardVisibilityCallback:Lcom/android/keyguard/KeyguardUpdateMonitorCallback;
...
.method static synthetic access$100(Lcom/android/systemui/doze/DozeUi;)V
    ...
    invoke-direct {p0}, updateAnimateScreenOff()V
...
.method private onTimeTick()V
    ...
    invoke-direct {p0}, verifyLastTimeTick()V

    iget-object v0, p0, mHost:Lcom/android/systemui/doze/DozeHost;

    invoke-interface {v0}, Lcom/android/systemui/doze/DozeHost;->dozeTimeTick()V

    iget-object v0, p0, mHandler:Landroid/os/Handler;

    iget-object v1, p0, mWakeLock:Lcom/android/systemui/util/wakelock/WakeLock;
    ...
    invoke-direct {p0}, scheduleTimeTick()V
...
.method private scheduleTimeTick()V
    ...
    iget-object v0, p0, mTimeTicker:Lcom/android/systemui/util/AlarmTimeout;
    ...
    invoke-direct {p0, v0, v1}, roundToNextMinute(J)J
    ...
    iget-object v4, p0, mTimeTicker:Lcom/android/systemui/util/AlarmTimeout;
...
.method private unscheduleTimeTick()V
    ...
    iget-object p0, p0, mTimeTicker:Lcom/android/systemui/util/AlarmTimeout;
...
.method private updateAnimateScreenOff()V
    ...
    iget-boolean v0, p0, mCanAnimateTransition:Z
    ...
    iget-object p0, p0, mHost:Lcom/android/systemui/doze/DozeHost;
...
.method private updateAnimateWakeup(Lcom/android/systemui/doze/DozeMachine$State;)V
    ...
    :pswitch_0
    iget-object p1, p0, mHost:Lcom/android/systemui/doze/DozeHost;

    iget-boolean v1, p0, mCanAnimateTransition:Z
...
.method private verifyLastTimeTick()V
    ...
    iget-wide v2, p0, mLastTimeTickElapsed:J
...
.method public transitionTo(Lcom/android/systemui/doze/DozeMachine$State;Lcom/android/systemui/doze/DozeMachine$State;)V
    ...
    invoke-direct {p0}, unscheduleTimeTick()V
    ...
    invoke-direct {p0, p1}, pulseWhileDozing(I)V
    ...
    iget-object v1, p0, mHost:Lcom/android/systemui/doze/DozeHost;
    ...
    :goto_0
    invoke-direct {p0, p2}, updateAnimateWakeup(Lcom/android/systemui/doze/DozeMachine$State;)V
