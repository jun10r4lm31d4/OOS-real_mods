...
.method public constructor <init>(Landroid/view/View;Lcom/android/systemui/statusbar/phone/DoubleTapHelper$ActivationListener;Lcom/android/systemui/statusbar/phone/DoubleTapHelper$DoubleTapListener;Lcom/android/systemui/statusbar/phone/DoubleTapHelper$SlideBackListener;Lcom/android/systemui/statusbar/phone/DoubleTapHelper$DoubleTapLogListener;)V
    ...
    iput-object v0, p0, mTapTimeoutRunnable:Ljava/lang/Runnable;
    ...
    iput v0, p0, mDoubleTapSlop:F

    iput-object p1, p0, mView:Landroid/view/View;

    iput-object p2, p0, mActivationListener:Lcom/android/systemui/statusbar/phone/DoubleTapHelper$ActivationListener;

    iput-object p3, p0, mDoubleTapListener:Lcom/android/systemui/statusbar/phone/DoubleTapHelper$DoubleTapListener;

    iput-object p4, p0, mSlideBackListener:Lcom/android/systemui/statusbar/phone/DoubleTapHelper$SlideBackListener;

    iput-object p5, p0, mDoubleTapLogListener:Lcom/android/systemui/statusbar/phone/DoubleTapHelper$DoubleTapLogListener;
...
.method public static synthetic lambda$GFsC9BR8swazZioXO_-_Yt7_6kU(Lcom/android/systemui/statusbar/phone/DoubleTapHelper;)V
    ...
    invoke-direct {p0}, makeInactive()V
...
.method private makeActive()V
    ...
    iget-object p0, p0, mActivationListener:Lcom/android/systemui/statusbar/phone/DoubleTapHelper$ActivationListener;
...
.method public onTouchEvent(Landroid/view/MotionEvent;I)Z
    ...
    iput-boolean v2, p0, mTrackTouch:Z

    goto/16 :goto_0

    :cond_1
    invoke-direct {p0, p1}, isWithinTouchSlop(Landroid/view/MotionEvent;)Z
    ...
    iget-object p2, p0, mSlideBackListener:Lcom/android/systemui/statusbar/phone/DoubleTapHelper$SlideBackListener;
    ...
    :cond_3
    iget-boolean p2, p0, mActivated:Z

    if-nez p2, :cond_4

    invoke-direct {p0}, makeActive()V

    iget-object p2, p0, mView:Landroid/view/View;
    ...
    iput p2, p0, mActivationX:F

    invoke-virtual {p1}, Landroid/view/MotionEvent;->getY()F

    move-result p1

    iput p1, p0, mActivationY:F

    goto :goto_0

    :cond_4
    invoke-virtual {p0, p1}, isWithinDoubleTapSlop(Landroid/view/MotionEvent;)Z

    move-result p2

    iget-object v0, p0, mDoubleTapLogListener:Lcom/android/systemui/statusbar/phone/DoubleTapHelper$DoubleTapLogListener;
    ...
    iget-object p1, p0, mDoubleTapListener:Lcom/android/systemui/statusbar/phone/DoubleTapHelper$DoubleTapListener;
    ...
    iput-boolean v1, p0, mTrackTouch:Z
    ...
    :cond_9
    :goto_0
    iget-boolean p0, p0, mTrackTouch:Z
