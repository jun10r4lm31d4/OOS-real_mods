...
.method constructor <init>(Landroid/content/Context;Lcom/android/settingslib/bluetooth/LocalBluetoothProfileManager;Landroid/bluetooth/BluetoothDevice;)V
    ...
    iput-object v0, p0, mProfileLock:Ljava/lang/Object;
    ...
    iput-object v0, p0, mRemovedProfiles:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mCallbacks:Ljava/util/Collection;

    const/4 v0, 0x0

    iput-boolean v0, p0, mIsActiveDeviceA2dp:Z

    iput-boolean v0, p0, mIsActiveDeviceHeadset:Z

    iput-boolean v0, p0, mIsActiveDeviceHearingAid:Z
    ...
    iput-object p1, p0, mLocalAdapter:Landroid/bluetooth/BluetoothAdapter;

    iput-object p2, p0, mProfileManager:Lcom/android/settingslib/bluetooth/LocalBluetoothProfileManager;

    iput-object p3, p0, mDevice:Landroid/bluetooth/BluetoothDevice;

    invoke-direct {p0}, fillData()V

    const-wide/16 p1, 0x0

    iput-wide p1, p0, mHiSyncId:J

    const/4 p1, -0x1

    iput p1, p0, mTwspBatteryState:I

    iput p1, p0, mTwspBatteryLevel:I
...
.method private connectAutoConnectableProfiles()V
    ...
    invoke-direct {p0}, ensurePaired()Z
    ...
    :cond_0
    iget-object v0, p0, mProfileLock:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, mProfiles:Ljava/util/List;
    ...
    invoke-virtual {p0, v2}, connectInt(Lcom/android/settingslib/bluetooth/LocalBluetoothProfile;)V
...
.method private connectWithoutResettingTimer(Z)V
    ...
    iget-object p0, p0, mDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    invoke-virtual {p0, v3}, connectInt(Lcom/android/settingslib/bluetooth/LocalBluetoothProfile;)V
    ...
    invoke-direct {p0}, connectAutoConnectableProfiles()V
...
.method private ensurePaired()Z
    ...
    invoke-virtual {p0}, getBondState()I
    ...
    invoke-virtual {p0}, startPairing()Z
...
.method private fillData()V
    ...
    invoke-direct {p0}, updateProfiles()Z

    invoke-direct {p0}, fetchActiveDevices()V

    invoke-direct {p0}, migratePhonebookPermissionChoice()V

    invoke-direct {p0}, migrateMessagePermissionChoice()V

    invoke-virtual {p0}, dispatchAttributesChanged()V
...
.method private updateProfiles()Z
    ...
    :cond_0
    iget-object v1, p0, mLocalAdapter:Landroid/bluetooth/BluetoothAdapter;
    ...
    :cond_1
    invoke-direct {p0}, processPhonebookAccess()V

    iget-object v9, p0, mProfileLock:Ljava/lang/Object;
    ...
    iget-object v4, p0, mProfiles:Ljava/util/List;

    iget-object v5, p0, mRemovedProfiles:Ljava/util/List;

    iget-boolean v6, p0, mLocalNapRoleConnected:Z

    iget-object v7, p0, mDevice:Landroid/bluetooth/BluetoothDevice;
...
.method public compareTo(Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;)I
    ...
    invoke-virtual {p1}, isConnected()Z
    ...
    :cond_0
    invoke-virtual {p1}, getBondState()I
    ...
    :cond_3
    iget-boolean v0, p1, mJustDiscovered:Z

    iget-boolean v1, p0, mJustDiscovered:Z
    ...
    :cond_4
    iget-short v0, p1, mRssi:S

    iget-short v1, p0, mRssi:S
    ...
    invoke-virtual {p1}, getName()Ljava/lang/String;
...
.method public bridge synthetic compareTo(Ljava/lang/Object;)I
    ...
    invoke-virtual {p0, p1}, compareTo(Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;)I
...
.method public connect(Z)V
    ...
    iput-wide v0, p0, mConnectAttempted:J

    invoke-direct {p0, p1}, connectWithoutResettingTimer(Z)V
...
.method declared-synchronized connectInt(Lcom/android/settingslib/bluetooth/LocalBluetoothProfile;)V
    ...
    invoke-direct {p0, p1}, describe(Lcom/android/settingslib/bluetooth/LocalBluetoothProfile;)Ljava/lang/String;
...
.method public disconnect()V
    ...
    invoke-virtual {p0, v2}, disconnect(Lcom/android/settingslib/bluetooth/LocalBluetoothProfile;)V
    ...
    invoke-virtual {p0, v0}, isConnectedProfile(Lcom/android/settingslib/bluetooth/LocalBluetoothProfile;)Z
...
.method dispatchAttributesChanged()V
    ...
    iget-object v0, p0, mCallbacks:Ljava/util/Collection;

    monitor-enter v0

    :try_start_0
    iget-object p0, p0, mCallbacks:Ljava/util/Collection;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object p1, p1, mDevice:Landroid/bluetooth/BluetoothDevice;
...
.method public getMaxConnectionState()I
    ...
    :try_start_0
    invoke-virtual {p0}, getProfiles()Ljava/util/List;
    ...
    invoke-virtual {p0, v3}, getProfileConnectionState(Lcom/android/settingslib/bluetooth/LocalBluetoothProfile;)I
...
.method public getProfiles()Ljava/util/List;
    ...
    iget-object p0, p0, mProfiles:Ljava/util/List;
...
.method public getSubDevice()Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;
    ...
    iget-object p0, p0, mSubDevice:Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;
...
.method public isActiveDevice(I)Z
    ...
    :cond_0
    iget-boolean p0, p0, mIsActiveDeviceHearingAid:Z

    return p0

    :cond_1
    iget-boolean p0, p0, mIsActiveDeviceA2dp:Z

    return p0

    :cond_2
    iget-boolean p0, p0, mIsActiveDeviceHeadset:Z
...
.method public isConnected()Z
    ...
    invoke-virtual {p0, v2}, getProfileConnectionState(Lcom/android/settingslib/bluetooth/LocalBluetoothProfile;)I
...
.method public isConnectedProfile(Lcom/android/settingslib/bluetooth/LocalBluetoothProfile;)Z
    ...
    invoke-virtual {p0, p1}, getProfileConnectionState(Lcom/android/settingslib/bluetooth/LocalBluetoothProfile;)I
...
.method public onActiveDeviceChanged(ZI)V
    ...
    :cond_0
    iget-boolean p2, p0, mIsActiveDeviceHearingAid:Z
    ...
    :cond_1
    iput-boolean p1, p0, mIsActiveDeviceHearingAid:Z

    goto :goto_0

    :cond_2
    iget-boolean p2, p0, mIsActiveDeviceA2dp:Z
    ...
    :cond_3
    iput-boolean p1, p0, mIsActiveDeviceA2dp:Z

    goto :goto_0

    :cond_4
    iget-boolean p2, p0, mIsActiveDeviceHeadset:Z
    ...
    :cond_5
    iput-boolean p1, p0, mIsActiveDeviceHeadset:Z
...
.method onBondingDockConnect()V
    ...
    invoke-virtual {p0, v0}, connect(Z)V
...
.method onBondingStateChanged(I)V
    ...
    iget-object v1, p0, mProfileLock:Ljava/lang/Object;
    ...
    iget-object p1, p0, mDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    invoke-virtual {p0}, onBondingDockConnect()V
...
.method onProfileStateChanged(Lcom/android/settingslib/bluetooth/LocalBluetoothProfile;I)V
    ...
    iget-object v0, p0, mLocalAdapter:Landroid/bluetooth/BluetoothAdapter;
    ...
    iget-object p2, p0, mDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    :cond_1
    iget-object p2, p0, mProfiles:Ljava/util/List;
    ...
    iget-object p2, p0, mRemovedProfiles:Ljava/util/List;
    ...
    iput-boolean v1, p0, mLocalNapRoleConnected:Z
    ...
    :cond_3
    iget-boolean v1, p0, mLocalNapRoleConnected:Z
    ...
    iput-boolean v2, p0, mLocalNapRoleConnected:Z
...
.method onUuidChanged()V
    ...
    iget-wide v5, p0, mConnectAttempted:J
    ...
    iget-wide v2, p0, mConnectAttempted:J
    ...
    invoke-direct {p0, v0}, connectWithoutResettingTimer(Z)V
...
.method public setActive()Z
    ...
    invoke-virtual {p0}, getDevice()Landroid/bluetooth/BluetoothDevice;
    ...
    :goto_0
    iget-object v3, p0, mProfileManager:Lcom/android/settingslib/bluetooth/LocalBluetoothProfileManager;
    ...
    invoke-virtual {p0, v3}, isConnectedProfile(Lcom/android/settingslib/bluetooth/LocalBluetoothProfile;)Z
...
.method public setJustDiscovered(Z)V
    ...
    iget-boolean v0, p0, mJustDiscovered:Z

    if-eq v0, p1, :cond_0

    iput-boolean p1, p0, mJustDiscovered:Z
...
.method setRssi(S)V
    ...
    iget-short v0, p0, mRssi:S

    if-eq v0, p1, :cond_0

    iput-short p1, p0, mRssi:S
...
.method public setSubDevice(Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;)V
    ...
    iput-object p1, p0, mSubDevice:Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;
...
.method public switchSubDeviceContent()V
    ...
    iget-boolean v2, p0, mJustDiscovered:Z

    iget-object v3, p0, mSubDevice:Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;

    iget-object v4, v3, mDevice:Landroid/bluetooth/BluetoothDevice;

    iput-object v4, p0, mDevice:Landroid/bluetooth/BluetoothDevice;

    iget-short v4, v3, mRssi:S

    iput-short v4, p0, mRssi:S

    iget-boolean v4, v3, mJustDiscovered:Z

    iput-boolean v4, p0, mJustDiscovered:Z

    iput-object v0, v3, mDevice:Landroid/bluetooth/BluetoothDevice;

    iput-short v1, v3, mRssi:S

    iput-boolean v2, v3, mJustDiscovered:Z
...
.method public unpair()V
    ...
    invoke-direct {p0}, getTwsPeerDevice()Landroid/bluetooth/BluetoothDevice;
    ...
    invoke-direct {p0, v1}, describe(Lcom/android/settingslib/bluetooth/LocalBluetoothProfile;)Ljava/lang/String;
