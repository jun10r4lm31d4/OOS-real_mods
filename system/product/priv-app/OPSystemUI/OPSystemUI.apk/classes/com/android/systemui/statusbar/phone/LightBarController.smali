...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/plugins/DarkIconDispatcher;Lcom/android/systemui/statusbar/policy/BatteryController;)V
    ...
    iput-object v0, p0, mLastFullscreenBounds:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, mLastDockedBounds:Landroid/graphics/Rect;
    ...
    iput-object p1, p0, mDarkModeColor:Landroid/graphics/Color;

    check-cast p2, Lcom/android/systemui/statusbar/phone/SysuiDarkIconDispatcher;

    iput-object p2, p0, mStatusBarIconController:Lcom/android/systemui/statusbar/phone/SysuiDarkIconDispatcher;

    iput-object p3, p0, mBatteryController:Lcom/android/systemui/statusbar/policy/BatteryController;
...
.method private reevaluate()V
    ...
    iget v1, p0, mFullscreenStackVisibility:I

    iget v2, p0, mDockedStackVisibility:I

    iget-object v4, p0, mLastFullscreenBounds:Landroid/graphics/Rect;

    iget-object v5, p0, mLastDockedBounds:Landroid/graphics/Rect;

    iget v7, p0, mLastStatusBarMode:I

    iget-boolean v8, p0, mNavbarColorManagedByIme:Z
    ...
    invoke-virtual/range {v0 .. v8}, onSystemUiVisibilityChanged(IIILandroid/graphics/Rect;Landroid/graphics/Rect;ZIZ)V

    iget v10, p0, mSystemUiVisibility:I

    iget v13, p0, mLastNavigationBarMode:I

    iget-boolean v14, p0, mNavbarColorManagedByIme:Z
    ...
    invoke-virtual/range {v9 .. v14}, onNavigationVisibilityChanged(IIZIZ)V
...
.method private updateNavigation()V
    ...
    iget-object v0, p0, mNavigationBarController:Lcom/android/systemui/statusbar/phone/LightBarTransitionsController;

    if-eqz v0, :cond_0

    iget-boolean v1, p0, mNavigationLight:Z

    invoke-direct {p0}, animateChange()Z
...
.method private updateStatus(Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    iget-boolean v2, p0, mFullscreenLight:Z

    const/4 v3, 0x0

    if-eqz v2, :cond_0

    iget-boolean v2, p0, mDockedLight:Z
    ...
    :cond_1
    iget-object p1, p0, mStatusBarIconController:Lcom/android/systemui/statusbar/phone/SysuiDarkIconDispatcher;
    ...
    :cond_5
    iget-boolean v0, p0, mFullscreenLight:Z
    ...
    :cond_7
    iget-object p2, p0, mStatusBarIconController:Lcom/android/systemui/statusbar/phone/SysuiDarkIconDispatcher;
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget v0, p0, mFullscreenStackVisibility:I
    ...
    iget v0, p0, mDockedStackVisibility:I
    ...
    iget-boolean v0, p0, mDockedLight:Z
    ...
    iget-object v0, p0, mLastFullscreenBounds:Landroid/graphics/Rect;
    ...
    iget-object v0, p0, mLastDockedBounds:Landroid/graphics/Rect;
    ...
    iget-boolean v0, p0, mNavigationLight:Z
    ...
    iget-boolean v0, p0, mHasLightNavigationBar:Z
    ...
    iget v0, p0, mLastStatusBarMode:I
    ...
    iget v0, p0, mLastNavigationBarMode:I
    ...
    iget-boolean v0, p0, mForceDarkForScrim:Z
    ...
    iget-boolean v0, p0, mQsCustomizing:Z
    ...
    iget-boolean v0, p0, mDirectReplying:Z
    ...
    iget-boolean v0, p0, mNavbarColorManagedByIme:Z

    invoke-virtual {p2, v0}, Ljava/io/PrintWriter;->println(Z)V

    invoke-virtual {p2}, Ljava/io/PrintWriter;->println()V

    iget-object v0, p0, mStatusBarIconController:Lcom/android/systemui/statusbar/phone/SysuiDarkIconDispatcher;
    ...
    iget-object p0, p0, mNavigationBarController:Lcom/android/systemui/statusbar/phone/LightBarTransitionsController;
...
.method public onNavigationVisibilityChanged(IIZIZ)V
    ...
    :cond_0
    iget-boolean p3, p0, mNavigationLight:Z

    invoke-direct {p0, p1, p4, v1}, isLight(III)Z

    move-result p1

    iput-boolean p1, p0, mHasLightNavigationBar:Z

    iget-boolean p1, p0, mHasLightNavigationBar:Z

    if-eqz p1, :cond_3

    iget-boolean p1, p0, mDirectReplying:Z

    if-eqz p1, :cond_1

    iget-boolean p1, p0, mNavbarColorManagedByIme:Z

    if-nez p1, :cond_2

    :cond_1
    iget-boolean p1, p0, mForceDarkForScrim:Z

    if-nez p1, :cond_3

    :cond_2
    iget-boolean p1, p0, mQsCustomizing:Z
    ...
    :goto_0
    iput-boolean p1, p0, mNavigationLight:Z
    ...
    iget-boolean p1, p0, mNavigationLight:Z

    if-eq p1, p3, :cond_4

    invoke-direct {p0}, updateNavigation()V

    :cond_4
    iput p2, p0, mSystemUiVisibility:I

    iput p4, p0, mLastNavigationBarMode:I

    iput-boolean p5, p0, mNavbarColorManagedByIme:Z
...
.method public onSystemUiVisibilityChanged(IIILandroid/graphics/Rect;Landroid/graphics/Rect;ZIZ)V
    ...
    iget-object p3, p0, mLastFullscreenBounds:Landroid/graphics/Rect;
    ...
    iget-object p3, p0, mLastDockedBounds:Landroid/graphics/Rect;
    ...
    :cond_0
    invoke-direct {p0, p1, p7, v1}, isLight(III)Z

    move-result p3

    iput-boolean p3, p0, mFullscreenLight:Z

    invoke-direct {p0, p2, p7, v1}, isLight(III)Z

    move-result p3

    iput-boolean p3, p0, mDockedLight:Z

    invoke-direct {p0, p4, p5}, updateStatus(Landroid/graphics/Rect;Landroid/graphics/Rect;)V

    :cond_1
    iput p1, p0, mFullscreenStackVisibility:I

    iput p2, p0, mDockedStackVisibility:I

    iput p7, p0, mLastStatusBarMode:I

    iput-boolean p8, p0, mNavbarColorManagedByIme:Z

    iget-object p1, p0, mLastFullscreenBounds:Landroid/graphics/Rect;

    invoke-virtual {p1, p4}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V

    iget-object p0, p0, mLastDockedBounds:Landroid/graphics/Rect;
...
.method public setDirectReplying(Z)V
    ...
    :cond_0
    iput-boolean p1, p0, mDirectReplying:Z
...
.method public setNavigationBar(Lcom/android/systemui/statusbar/phone/LightBarTransitionsController;)V
    ...
    iput-object p1, p0, mNavigationBarController:Lcom/android/systemui/statusbar/phone/LightBarTransitionsController;
...
.method public setQsCustomizing(Z)V
    ...
    :cond_0
    iput-boolean p1, p0, mQsCustomizing:Z
...
.method public setScrimState(Lcom/android/systemui/statusbar/phone/ScrimState;FLcom/android/internal/colorextraction/ColorExtractor$GradientColors;)V
    ...
    :goto_0
    iput-boolean p1, p0, mForceDarkForScrim:Z
