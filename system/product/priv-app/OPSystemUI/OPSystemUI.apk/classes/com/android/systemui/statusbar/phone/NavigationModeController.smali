...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/statusbar/policy/DeviceProvisionedController;Lcom/android/systemui/UiOffloadThread;)V
    ...
    iput-object v2, v0, mRestoreGesturalNavBarMode:Landroid/util/SparseBooleanArray;
    ...
    iput-object v3, v0, mListeners:Ljava/util/ArrayList;
    ...
    iput-object v3, v0, mReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v3, v0, mDeviceProvisionedCallback:Lcom/android/systemui/statusbar/policy/DeviceProvisionedController$DeviceProvisionedListener;

    iput-object v1, v0, mContext:Landroid/content/Context;

    iput-object v1, v0, mCurrentUserContext:Landroid/content/Context;
    ...
    iput-object v1, v0, mOverlayManager:Landroid/content/om/IOverlayManager;

    move-object/from16 v1, p3

    iput-object v1, v0, mUiOffloadThread:Lcom/android/systemui/UiOffloadThread;

    move-object/from16 v1, p2

    iput-object v1, v0, mDeviceProvisionedController:Lcom/android/systemui/statusbar/policy/DeviceProvisionedController;

    iget-object v1, v0, mDeviceProvisionedController:Lcom/android/systemui/statusbar/policy/DeviceProvisionedController;

    iget-object v3, v0, mDeviceProvisionedCallback:Lcom/android/systemui/statusbar/policy/DeviceProvisionedController$DeviceProvisionedListener;
    ...
    iget-object v5, v0, mReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-direct {v0, v1}, getDefaultLauncherPackageName(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v1

    iput-object v1, v0, mLastDefaultLauncher:Ljava/lang/String;

    invoke-virtual {v0, v2}, updateCurrentInteractionMode(Z)V

    invoke-direct/range {p0 .. p0}, switchFromGestureNavModeIfNotSupportedByDefaultLauncher()V

    invoke-direct/range {p0 .. p0}, deferGesturalNavOverlayIfNecessary()V
...
.method static synthetic access$100(Lcom/android/systemui/statusbar/phone/NavigationModeController;)Landroid/content/Context;
    ...
    iget-object p0, p0, mCurrentUserContext:Landroid/content/Context;
...
.method static synthetic access$200(Lcom/android/systemui/statusbar/phone/NavigationModeController;Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-direct {p0, p1}, getDefaultLauncherPackageName(Landroid/content/Context;)Ljava/lang/String;
...
.method static synthetic access$300(Lcom/android/systemui/statusbar/phone/NavigationModeController;)Ljava/lang/String;
    ...
    iget-object p0, p0, mLastDefaultLauncher:Ljava/lang/String;
...
.method static synthetic access$302(Lcom/android/systemui/statusbar/phone/NavigationModeController;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object p1, p0, mLastDefaultLauncher:Ljava/lang/String;
...
.method static synthetic access$400(Lcom/android/systemui/statusbar/phone/NavigationModeController;)V
    ...
    invoke-direct {p0}, switchFromGestureNavModeIfNotSupportedByDefaultLauncher()V
...
.method static synthetic access$500(Lcom/android/systemui/statusbar/phone/NavigationModeController;)V
    ...
    invoke-direct {p0}, showNotificationIfDefaultLauncherSupportsGestureNav()V
...
.method static synthetic access$700(Lcom/android/systemui/statusbar/phone/NavigationModeController;)V
    ...
    invoke-direct {p0}, restoreGesturalNavOverlayIfNecessary()V
...
.method static synthetic access$800(Lcom/android/systemui/statusbar/phone/NavigationModeController;)V
    ...
    invoke-direct {p0}, deferGesturalNavOverlayIfNecessary()V
...
.method private deferGesturalNavOverlayIfNecessary()V
    ...
    iget-object v1, p0, mRestoreGesturalNavBarMode:Landroid/util/SparseBooleanArray;

    const/4 v2, 0x0

    invoke-virtual {v1, v0, v2}, Landroid/util/SparseBooleanArray;->put(IZ)V

    iget-object v1, p0, mDeviceProvisionedController:Lcom/android/systemui/statusbar/policy/DeviceProvisionedController;
    ...
    :try_start_0
    iget-object v2, p0, mOverlayManager:Landroid/content/om/IOverlayManager;
    ...
    invoke-virtual {p0, v2, v1}, setModeOverlay(Ljava/lang/String;I)V

    iget-object p0, p0, mRestoreGesturalNavBarMode:Landroid/util/SparseBooleanArray;
...
.method private isGestureNavSupportedByDefaultLauncher(Landroid/content/Context;)Ljava/lang/Boolean;
    ...
    :cond_1
    invoke-direct {p0, p1, v0}, isSystemApp(Landroid/content/Context;Ljava/lang/String;)Z
...
.method private restoreGesturalNavOverlayIfNecessary()V
    ...
    iget-object v2, p0, mRestoreGesturalNavBarMode:Landroid/util/SparseBooleanArray;
...
.method private showNotificationIfDefaultLauncherSupportsGestureNav()V
    ...
    invoke-direct {p0, v0}, getCurrentInteractionMode(Landroid/content/Context;)I
    ...
    invoke-direct {p0, v0}, isGestureNavSupportedByDefaultLauncher(Landroid/content/Context;)Ljava/lang/Boolean;
    ...
    invoke-direct {p0, v0, v4}, showNotification(Landroid/content/Context;I)V
...
.method public addListener(Lcom/android/systemui/statusbar/phone/NavigationModeController$ModeChangedListener;)I
    ...
    :cond_0
    iget-object p1, p0, mCurrentUserContext:Landroid/content/Context;

    invoke-direct {p0, p1}, getCurrentInteractionMode(Landroid/content/Context;)I
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object p3, p0, mOverlayManager:Landroid/content/om/IOverlayManager;
    ...
    invoke-direct {p0, p1}, dumpAssetPaths(Landroid/content/Context;)V
    ...
    iget-object p3, p0, mLastDefaultLauncher:Ljava/lang/String;
...
.method public synthetic lambda$setModeOverlay$1$NavigationModeController(Ljava/lang/String;I)V
    ...
    :try_start_0
    iget-object p0, p0, mOverlayManager:Landroid/content/om/IOverlayManager;
...
.method public removeListener(Lcom/android/systemui/statusbar/phone/NavigationModeController$ModeChangedListener;)V
    ...
    iget-object p0, p0, mListeners:Ljava/util/ArrayList;
...
.method public updateCurrentInteractionMode(Z)V
    ...
    invoke-virtual {p0}, getCurrentUserContext()Landroid/content/Context;

    move-result-object v0

    iput-object v0, p0, mCurrentUserContext:Landroid/content/Context;
    ...
    iget-object v3, p0, mCurrentUserContext:Landroid/content/Context;
    ...
    iget-object v1, p0, mCurrentUserContext:Landroid/content/Context;

    invoke-direct {p0, v1}, dumpAssetPaths(Landroid/content/Context;)V
