...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/statusbar/CommandQueue;Lcom/android/systemui/assist/AssistManager;Lcom/android/systemui/statusbar/phone/NotificationPanelView;Lcom/android/systemui/statusbar/NotificationPresenter;Lcom/android/systemui/statusbar/notification/NotificationEntryManager;Lcom/android/systemui/statusbar/phone/HeadsUpManagerPhone;Lcom/android/systemui/plugins/ActivityStarter;Lcom/android/systemui/statusbar/notification/ActivityLaunchAnimator;Lcom/android/internal/statusbar/IStatusBarService;Lcom/android/systemui/plugins/statusbar/StatusBarStateController;Landroid/app/KeyguardManager;Landroid/service/dreams/IDreamManager;Lcom/android/systemui/statusbar/NotificationRemoteInputManager;Lcom/android/systemui/statusbar/phone/StatusBarRemoteInputCallback;Lcom/android/systemui/statusbar/phone/NotificationGroupManager;Lcom/android/systemui/statusbar/NotificationLockscreenUserManager;Lcom/android/systemui/statusbar/phone/ShadeController;Lcom/android/systemui/statusbar/policy/KeyguardMonitor;Lcom/android/systemui/statusbar/notification/NotificationInterruptionStateProvider;Lcom/android/internal/logging/MetricsLogger;Lcom/android/internal/widget/LockPatternUtils;Landroid/os/Handler;Landroid/os/Handler;Lcom/android/systemui/ActivityIntentHelper;Lcom/android/systemui/bubbles/BubbleController;)V
    ...
    iput-object v1, v0, mOpNotificationController:Lcom/oneplus/notification/OpNotificationController;
    ...
    iput-object v1, v0, mNotificationPanel:Lcom/android/systemui/statusbar/phone/NotificationPanelView;

    move-object v1, p5

    iput-object v1, v0, mPresenter:Lcom/android/systemui/statusbar/NotificationPresenter;

    move-object v1, p7

    iput-object v1, v0, mHeadsUpManager:Lcom/android/systemui/statusbar/phone/HeadsUpManagerPhone;
    ...
    iput-object v1, v0, mBarService:Lcom/android/internal/statusbar/IStatusBarService;

    move-object v1, p2

    iput-object v1, v0, mCommandQueue:Lcom/android/systemui/statusbar/CommandQueue;
    ...
    iput-object v1, v0, mDreamManager:Landroid/service/dreams/IDreamManager;

    move-object/from16 v1, p14

    iput-object v1, v0, mRemoteInputManager:Lcom/android/systemui/statusbar/NotificationRemoteInputManager;

    move-object/from16 v1, p17

    iput-object v1, v0, mLockscreenUserManager:Lcom/android/systemui/statusbar/NotificationLockscreenUserManager;

    move-object/from16 v1, p18

    iput-object v1, v0, mShadeController:Lcom/android/systemui/statusbar/phone/ShadeController;

    move-object/from16 v1, p19

    iput-object v1, v0, mKeyguardMonitor:Lcom/android/systemui/statusbar/policy/KeyguardMonitor;

    move-object v1, p8

    iput-object v1, v0, mActivityStarter:Lcom/android/systemui/plugins/ActivityStarter;

    move-object v1, p6

    iput-object v1, v0, mEntryManager:Lcom/android/systemui/statusbar/notification/NotificationEntryManager;

    move-object v1, p11

    iput-object v1, v0, mStatusBarStateController:Lcom/android/systemui/plugins/statusbar/StatusBarStateController;

    move-object/from16 v1, p20

    iput-object v1, v0, mNotificationInterruptionStateProvider:Lcom/android/systemui/statusbar/notification/NotificationInterruptionStateProvider;
    ...
    iput-object v1, v0, mAssistManager:Lcom/android/systemui/assist/AssistManager;

    move-object/from16 v1, p16

    iput-object v1, v0, mGroupManager:Lcom/android/systemui/statusbar/phone/NotificationGroupManager;
    ...
    iput-object v1, v0, mBackgroundHandler:Landroid/os/Handler;
    ...
    iput-object v1, v0, mStatusBarRemoteInputCallback:Lcom/android/systemui/statusbar/phone/StatusBarRemoteInputCallback;

    move-object/from16 v1, p23

    iput-object v1, v0, mMainThreadHandler:Landroid/os/Handler;

    move-object/from16 v1, p25

    iput-object v1, v0, mActivityIntentHelper:Lcom/android/systemui/ActivityIntentHelper;

    move-object/from16 v1, p26

    iput-object v1, v0, mBubbleController:Lcom/android/systemui/bubbles/BubbleController;
...
.method static synthetic access$000(Lcom/android/systemui/statusbar/phone/StatusBarNotificationActivityStarter;Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V
    ...
    invoke-direct {p0, p1}, handleFullScreenIntent(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V
...
.method private collapseOnMainThread()V
    ...
    :cond_0
    iget-object v0, p0, mMainThreadHandler:Landroid/os/Handler;
...
.method private handleFullScreenIntent(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V
    ...
    iget-object v0, p0, mNotificationInterruptionStateProvider:Lcom/android/systemui/statusbar/notification/NotificationInterruptionStateProvider;
    ...
    :cond_0
    invoke-direct {p0, p1}, shouldSuppressFullScreenIntent(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)Z
...
.method private handleNotificationClickAfterKeyguardDismissed(Landroid/service/notification/StatusBarNotification;Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;Lcom/android/systemui/statusbar/RemoteInputController;Landroid/app/PendingIntent;Ljava/lang/String;ZZZ)Z
    ...
    iget-object v0, v10, mHeadsUpManager:Lcom/android/systemui/statusbar/phone/HeadsUpManagerPhone;
    ...
    iget-object v0, v10, mPresenter:Lcom/android/systemui/statusbar/NotificationPresenter;
    ...
    invoke-static {p1}, shouldAutoCancel(Landroid/service/notification/StatusBarNotification;)Z

    move-result v1

    if-eqz v1, :cond_3

    iget-object v1, v10, mGroupManager:Lcom/android/systemui/statusbar/phone/NotificationGroupManager;
    ...
    invoke-static {v1}, shouldAutoCancel(Landroid/service/notification/StatusBarNotification;)Z
    ...
    iget-object v0, v10, mShadeController:Lcom/android/systemui/statusbar/phone/ShadeController;
    ...
    :cond_4
    iget-object v0, v10, mKeyguardMonitor:Lcom/android/systemui/statusbar/policy/KeyguardMonitor;
    ...
    :cond_5
    iget-object v0, v10, mBackgroundHandler:Landroid/os/Handler;

    invoke-virtual {v0, v12}, Landroid/os/Handler;->postAtFrontOfQueue(Ljava/lang/Runnable;)Z

    :goto_2
    iget-object v0, v10, mNotificationPanel:Lcom/android/systemui/statusbar/phone/NotificationPanelView;
...
.method private handleNotificationClickAfterPanelCollapsed(Landroid/service/notification/StatusBarNotification;Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;Lcom/android/systemui/statusbar/RemoteInputController;Landroid/app/PendingIntent;Ljava/lang/String;ZZLandroid/service/notification/StatusBarNotification;)V
    ...
    iget-object v1, v6, mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;
    ...
    iget-object v1, v6, mKeyguardManager:Landroid/app/KeyguardManager;
    ...
    iget-object v1, v6, mStatusBarRemoteInputCallback:Lcom/android/systemui/statusbar/phone/StatusBarRemoteInputCallback;
    ...
    invoke-direct {p0}, collapseOnMainThread()V
    ...
    invoke-direct {p0, p5}, expandBubbleStackOnMainThread(Ljava/lang/String;)V
    ...
    invoke-direct/range {v0 .. v5}, startNotificationIntent(Landroid/app/PendingIntent;Landroid/content/Intent;Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;ZZ)V
    ...
    :cond_4
    iget-object v0, v6, mAssistManager:Lcom/android/systemui/assist/AssistManager;

    invoke-virtual {v0}, Lcom/android/systemui/assist/AssistManager;->hideAssist()V

    :cond_5
    invoke-direct {p0}, shouldCollapse()Z
    ...
    iget-object v1, v6, mEntryManager:Lcom/android/systemui/statusbar/notification/NotificationEntryManager;
    ...
    iget-object v2, v6, mEntryManager:Lcom/android/systemui/statusbar/notification/NotificationEntryManager;
    ...
    :try_start_1
    iget-object v1, v6, mBarService:Lcom/android/internal/statusbar/IStatusBarService;
    ...
    invoke-direct {p0, v8}, removeNotification(Landroid/service/notification/StatusBarNotification;)V
    ...
    iget-object v0, v6, mRemoteInputManager:Lcom/android/systemui/statusbar/NotificationRemoteInputManager;
    ...
    :cond_8
    invoke-direct {p0, p1}, removeNotification(Landroid/service/notification/StatusBarNotification;)V

    :cond_9
    const/4 v0, 0x0

    iput-boolean v0, v6, mIsCollapsingToShowActivityOverLockscreen:Z
...
.method private startNotificationIntent(Landroid/app/PendingIntent;Landroid/content/Intent;Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;ZZ)V
    ...
    iget-object p3, p0, mShadeController:Lcom/android/systemui/statusbar/phone/ShadeController;
    ...
    :cond_1
    iget-object v1, p0, mOpNotificationController:Lcom/oneplus/notification/OpNotificationController;
...
.method public isCollapsingToShowActivityOverLockscreen()Z
    ...
    iget-boolean p0, p0, mIsCollapsingToShowActivityOverLockscreen:Z
...
.method public synthetic lambda$handleNotificationClickAfterKeyguardDismissed$1$StatusBarNotificationActivityStarter(Landroid/service/notification/StatusBarNotification;Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;Lcom/android/systemui/statusbar/RemoteInputController;Landroid/app/PendingIntent;Ljava/lang/String;ZZLandroid/service/notification/StatusBarNotification;)V
    ...
    invoke-direct/range {p0 .. p8}, handleNotificationClickAfterPanelCollapsed(Landroid/service/notification/StatusBarNotification;Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;Lcom/android/systemui/statusbar/RemoteInputController;Landroid/app/PendingIntent;Ljava/lang/String;ZZLandroid/service/notification/StatusBarNotification;)V
...
.method public synthetic lambda$startNotificationGutsIntent$5$StatusBarNotificationActivityStarter(Landroid/content/Intent;Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;I)V
    ...
    iget-object v1, p0, mShadeController:Lcom/android/systemui/statusbar/phone/ShadeController;
    ...
    iget-object p2, p0, mActivityLaunchAnimator:Lcom/android/systemui/statusbar/notification/ActivityLaunchAnimator;
    ...
    iget-object p1, p0, mMainThreadHandler:Landroid/os/Handler;
...
.method public onNotificationClicked(Landroid/service/notification/StatusBarNotification;Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;)V
    ...
    iget-object v0, v10, mRemoteInputManager:Lcom/android/systemui/statusbar/NotificationRemoteInputManager;
    ...
    iget-object v0, v10, mActivityIntentHelper:Lcom/android/systemui/ActivityIntentHelper;

    invoke-virtual {v5}, Landroid/app/PendingIntent;->getIntent()Landroid/content/Intent;

    move-result-object v2

    iget-object v3, v10, mLockscreenUserManager:Lcom/android/systemui/statusbar/NotificationLockscreenUserManager;
    ...
    iput-boolean v11, v10, mIsCollapsingToShowActivityOverLockscreen:Z
    ...
    :cond_8
    iget-object v0, v10, mActivityStarter:Lcom/android/systemui/plugins/ActivityStarter;
