...
.method static constructor <clinit>()V
    ...
    sput-object v0, KEY_DRAWABLE_ROTATE:Landroid/util/FloatProperty;
    ...
    sput-object v0, KEY_DRAWABLE_TRANSLATE_Y:Landroid/util/FloatProperty;
...
.method public constructor <init>(Landroid/graphics/drawable/Drawable;IIZLandroid/graphics/Color;)V
    ...
    invoke-direct {p0, p1, v6}, <init>(Landroid/graphics/drawable/Drawable;Lcom/android/systemui/statusbar/policy/KeyButtonDrawable$ShadowDrawableState;)V
...
.method private constructor <init>(Landroid/graphics/drawable/Drawable;Lcom/android/systemui/statusbar/policy/KeyButtonDrawable$ShadowDrawableState;)V
    ...
    iput-object v0, p0, mShadowPaint:Landroid/graphics/Paint;

    iput-object p2, p0, mState:Lcom/android/systemui/statusbar/policy/KeyButtonDrawable$ShadowDrawableState;

    if-eqz p1, :cond_0

    iget-object p2, p0, mState:Lcom/android/systemui/statusbar/policy/KeyButtonDrawable$ShadowDrawableState;
    ...
    :cond_0
    invoke-virtual {p0}, canAnimate()Z

    move-result p1

    if-eqz p1, :cond_1

    iget-object p1, p0, mState:Lcom/android/systemui/statusbar/policy/KeyButtonDrawable$ShadowDrawableState;
    ...
    iput-object p1, p0, mAnimatedDrawable:Landroid/graphics/drawable/AnimatedVectorDrawable;

    iget-object p1, p0, mAnimatedDrawable:Landroid/graphics/drawable/AnimatedVectorDrawable;

    invoke-direct {p0, p1}, setDrawableBounds(Landroid/graphics/drawable/Drawable;)V
...
.method synthetic constructor <init>(Landroid/graphics/drawable/Drawable;Lcom/android/systemui/statusbar/policy/KeyButtonDrawable$ShadowDrawableState;Lcom/android/systemui/statusbar/policy/KeyButtonDrawable$1;)V
    ...
    invoke-direct {p0, p1, p2}, <init>(Landroid/graphics/drawable/Drawable;Lcom/android/systemui/statusbar/policy/KeyButtonDrawable$ShadowDrawableState;)V
...
.method public static create(Landroid/content/Context;IIIZLandroid/graphics/Color;)Lcom/android/systemui/statusbar/policy/KeyButtonDrawable;
    ...
    invoke-direct/range {v4 .. v9}, <init>(Landroid/graphics/drawable/Drawable;IIZLandroid/graphics/Color;)V
    ...
    invoke-virtual {p3, p1, p2, p4, p0}, setShadowProperties(IIII)V
...
.method public static create(Landroid/content/Context;IZ)Lcom/android/systemui/statusbar/policy/KeyButtonDrawable;
    ...
    invoke-static {p0, p1, p2, v0}, create(Landroid/content/Context;IZLandroid/graphics/Color;)Lcom/android/systemui/statusbar/policy/KeyButtonDrawable;
...
.method public static create(Landroid/content/Context;IZLandroid/graphics/Color;)Lcom/android/systemui/statusbar/policy/KeyButtonDrawable;
    ...
    invoke-static {v2, v1, p1, p2, p3}, create(Landroid/content/Context;Landroid/content/Context;IZLandroid/graphics/Color;)Lcom/android/systemui/statusbar/policy/KeyButtonDrawable;
...
.method public static create(Landroid/content/Context;Landroid/content/Context;IZLandroid/graphics/Color;)Lcom/android/systemui/statusbar/policy/KeyButtonDrawable;
    ...
    invoke-static/range {v1 .. v6}, create(Landroid/content/Context;IIIZLandroid/graphics/Color;)Lcom/android/systemui/statusbar/policy/KeyButtonDrawable;
...
.method private regenerateBitmapIconCache()V
    ...
    iget-object v4, p0, mState:Lcom/android/systemui/statusbar/policy/KeyButtonDrawable$ShadowDrawableState;
    ...
    invoke-direct {p0, v4}, setDrawableBounds(Landroid/graphics/drawable/Drawable;)V

    invoke-virtual {v3}, Landroid/graphics/Canvas;->save()I

    iget-object v5, p0, mState:Lcom/android/systemui/statusbar/policy/KeyButtonDrawable$ShadowDrawableState;
    ...
    iget-object v0, p0, mState:Lcom/android/systemui/statusbar/policy/KeyButtonDrawable$ShadowDrawableState;
    ...
    :cond_1
    iget-object p0, p0, mState:Lcom/android/systemui/statusbar/policy/KeyButtonDrawable$ShadowDrawableState;
...
.method private regenerateBitmapShadowCache()V
    ...
    invoke-direct {p0, v5}, setDrawableBounds(Landroid/graphics/drawable/Drawable;)V

    invoke-virtual {v4}, Landroid/graphics/Canvas;->save()I

    iget-object v6, p0, mState:Lcom/android/systemui/statusbar/policy/KeyButtonDrawable$ShadowDrawableState;
...
.method private updateShadowAlpha()V
    ...
    iget-object v1, p0, mShadowPaint:Landroid/graphics/Paint;
...
.method public clearAnimationCallbacks()V
    ...
    iget-object p0, p0, mAnimatedDrawable:Landroid/graphics/drawable/AnimatedVectorDrawable;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    :cond_0
    iget-object v1, p0, mAnimatedDrawable:Landroid/graphics/drawable/AnimatedVectorDrawable;
    ...
    :cond_1
    iget-object v1, p0, mState:Lcom/android/systemui/statusbar/policy/KeyButtonDrawable$ShadowDrawableState;
    ...
    iget-object v2, p0, mState:Lcom/android/systemui/statusbar/policy/KeyButtonDrawable$ShadowDrawableState;
    ...
    :cond_4
    invoke-direct {p0}, regenerateBitmapIconCache()V
    ...
    :cond_6
    invoke-direct {p0}, regenerateBitmapShadowCache()V
    ...
    iget-object v7, p0, mState:Lcom/android/systemui/statusbar/policy/KeyButtonDrawable$ShadowDrawableState;
    ...
    iget-object v4, p0, mShadowPaint:Landroid/graphics/Paint;
...
.method public setAlpha(I)V
    ...
    invoke-direct {p0}, updateShadowAlpha()V
...
.method public setColorFilter(Landroid/graphics/ColorFilter;)V
    ...
    iget-object v0, p0, mAnimatedDrawable:Landroid/graphics/drawable/AnimatedVectorDrawable;

    if-eqz v0, :cond_1

    invoke-virtual {p0}, hasOvalBg()Z
...
.method public setShadowProperties(IIII)V
    ...
    iget-object p1, p0, mShadowPaint:Landroid/graphics/Paint;
...
.method public setTranslationY(F)V
    ...
    invoke-virtual {p0, v0, p1}, setTranslation(FF)V
