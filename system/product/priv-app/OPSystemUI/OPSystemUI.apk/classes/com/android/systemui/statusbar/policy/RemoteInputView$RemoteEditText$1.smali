...
.method constructor <init>(Lcom/android/systemui/statusbar/policy/RemoteInputView$RemoteEditText;Landroid/view/inputmethod/InputMethodManager;)V
    ...
    iput-object p1, p0, this$0:Lcom/android/systemui/statusbar/policy/RemoteInputView$RemoteEditText;

    iput-object p2, p0, val$imm:Landroid/view/inputmethod/InputMethodManager;
...
.method public run()V
    ...
    iget-object v0, p0, val$imm:Landroid/view/inputmethod/InputMethodManager;

    iget-object v1, p0, this$0:Lcom/android/systemui/statusbar/policy/RemoteInputView$RemoteEditText;

    invoke-virtual {v0, v1}, Landroid/view/inputmethod/InputMethodManager;->viewClicked(Landroid/view/View;)V

    iget-object v0, p0, val$imm:Landroid/view/inputmethod/InputMethodManager;

    iget-object p0, p0, this$0:Lcom/android/systemui/statusbar/policy/RemoteInputView$RemoteEditText;
