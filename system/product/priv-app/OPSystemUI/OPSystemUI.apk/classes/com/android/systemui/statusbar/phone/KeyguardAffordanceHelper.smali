...
.method constructor <init>(Lcom/android/systemui/statusbar/phone/KeyguardAffordanceHelper$Callback;Landroid/content/Context;)V
    ...
    iput-object v0, p0, mFlingEndListener:Landroid/animation/AnimatorListenerAdapter;
    ...
    iput-object v0, p0, mAnimationEndRunnable:Ljava/lang/Runnable;

    iput-object p2, p0, mContext:Landroid/content/Context;

    iput-object p1, p0, mCallback:Lcom/android/systemui/statusbar/phone/KeyguardAffordanceHelper$Callback;

    invoke-direct {p0}, initIcons()V

    iget-object v1, p0, mLeftIcon:Lcom/android/systemui/statusbar/KeyguardAffordanceView;
    ...
    invoke-direct/range {v0 .. v7}, updateIcon(Lcom/android/systemui/statusbar/KeyguardAffordanceView;FFZZZZ)V

    iget-object v1, p0, mRightIcon:Lcom/android/systemui/statusbar/KeyguardAffordanceView;
...
.method static synthetic access$002(Lcom/android/systemui/statusbar/phone/KeyguardAffordanceHelper;Landroid/animation/Animator;)Landroid/animation/Animator;
    ...
    iput-object p1, p0, mSwipeAnimator:Landroid/animation/Animator;
...
.method static synthetic access$202(Lcom/android/systemui/statusbar/phone/KeyguardAffordanceHelper;Landroid/view/View;)Landroid/view/View;
    ...
    iput-object p1, p0, mTargetedView:Landroid/view/View;
...
.method static synthetic access$300(Lcom/android/systemui/statusbar/phone/KeyguardAffordanceHelper;)Lcom/android/systemui/statusbar/phone/KeyguardAffordanceHelper$Callback;
    ...
    iget-object p0, p0, mCallback:Lcom/android/systemui/statusbar/phone/KeyguardAffordanceHelper$Callback;
...
.method static synthetic access$400(Lcom/android/systemui/statusbar/phone/KeyguardAffordanceHelper;ZLjava/lang/Runnable;)V
    ...
    invoke-direct {p0, p1, p2}, startUnlockHintAnimationPhase2(ZLjava/lang/Runnable;)V
...
.method static synthetic access$500(Lcom/android/systemui/statusbar/phone/KeyguardAffordanceHelper;F)F
    ...
    invoke-direct {p0, p1}, getTranslationFromRadius(F)F
...
.method static synthetic access$700(Lcom/android/systemui/statusbar/phone/KeyguardAffordanceHelper;Lcom/android/systemui/statusbar/KeyguardAffordanceView;)V
    ...
    invoke-direct {p0, p1}, updateIconsFromTranslation(Lcom/android/systemui/statusbar/KeyguardAffordanceView;)V
...
.method private cancelAnimation()V
    ...
    iget-object p0, p0, mSwipeAnimator:Landroid/animation/Animator;
...
.method private endMotion(ZFF)V
    ...
    invoke-direct {p0, p1, p2, p3}, flingWithCurrentVelocity(ZFF)V

    goto :goto_0

    :cond_0
    iput-object v1, p0, mTargetedView:Landroid/view/View;
...
.method private fling(FZZ)V
    ...
    iget-object v0, p0, mCallback:Lcom/android/systemui/statusbar/phone/KeyguardAffordanceHelper$Callback;
    ...
    iget-object v0, p0, mFlingEndListener:Landroid/animation/AnimatorListenerAdapter;
    ...
    iget-object v2, p0, mAnimationEndRunnable:Ljava/lang/Runnable;

    invoke-direct {p0, v0, v2, p3}, startFinishingCircleAnimation(FLjava/lang/Runnable;Z)V

    iget-object v0, p0, mCallback:Lcom/android/systemui/statusbar/phone/KeyguardAffordanceHelper$Callback;

    iget v2, p0, mTranslation:F
    ...
    :cond_2
    invoke-virtual {p0, v2}, reset(Z)V

    :goto_1
    invoke-virtual {v1}, Landroid/animation/ValueAnimator;->start()V

    iput-object v1, p0, mSwipeAnimator:Landroid/animation/Animator;
...
.method private flingWithCurrentVelocity(ZFF)V
    ...
    invoke-direct {p0, p2, p3}, getCurrentVelocity(FF)F

    move-result p2

    iget-object p3, p0, mCallback:Lcom/android/systemui/statusbar/phone/KeyguardAffordanceHelper$Callback;
    ...
    iget-object p3, p0, mFalsingManager:Lcom/android/systemui/plugins/FalsingManager;
    ...
    invoke-direct {p0}, isBelowFalsingThreshold()Z
    ...
    :goto_7
    invoke-direct {p0, p2, p1, v0}, fling(FZZ)V
...
.method private getAnimatorToRadius(ZI)Landroid/animation/ValueAnimator;
    ...
    iget-object v0, p0, mRightIcon:Lcom/android/systemui/statusbar/KeyguardAffordanceView;

    goto :goto_0

    :cond_0
    iget-object v0, p0, mLeftIcon:Lcom/android/systemui/statusbar/KeyguardAffordanceView;
...
.method private getCurrentVelocity(FF)F
    ...
    iget-object p1, p0, mTargetedView:Landroid/view/View;

    iget-object p0, p0, mRightIcon:Lcom/android/systemui/statusbar/KeyguardAffordanceView;
...
.method private getIconAtPosition(FF)Landroid/view/View;
    ...
    invoke-direct {p0}, leftSwipePossible()Z
    ...
    invoke-direct {p0, v0, p1, p2}, isOnIcon(Landroid/view/View;FF)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object p0, p0, mLeftIcon:Lcom/android/systemui/statusbar/KeyguardAffordanceView;

    return-object p0

    :cond_0
    invoke-direct {p0}, rightSwipePossible()Z
...
.method private getMinTranslationAmount()I
    ...
    iget p0, p0, mMinTranslationAmount:I
...
.method private getRadiusFromTranslation(F)F
    ...
    iget p0, p0, mMinBackgroundRadius:I
...
.method private getTranslationFromRadius(F)F
    ...
    iget v0, p0, mMinBackgroundRadius:I
...
.method private initDimens()V
    ...
    iput v0, p0, mMinFlingVelocity:I
    ...
    iput v0, p0, mMinTranslationAmount:I
    ...
    iput v0, p0, mMinBackgroundRadius:I
    ...
    iput-object v0, p0, mFalsingManager:Lcom/android/systemui/plugins/FalsingManager;
...
.method private initIcons()V
    ...
    iput-object v0, p0, mLeftIcon:Lcom/android/systemui/statusbar/KeyguardAffordanceView;
    ...
    iput-object v0, p0, mRightIcon:Lcom/android/systemui/statusbar/KeyguardAffordanceView;

    invoke-virtual {p0}, updatePreviews()V
...
.method private isBelowFalsingThreshold()Z
    ...
    iget v1, p0, mTranslationOnDown:F

    invoke-static {v1}, Ljava/lang/Math;->abs(F)F

    move-result v1

    invoke-direct {p0}, getMinTranslationAmount()I
...
.method private setTranslation(FZZ)V
    ...
    invoke-direct/range {p0 .. p0}, rightSwipePossible()Z
    ...
    :goto_0
    invoke-direct/range {p0 .. p0}, leftSwipePossible()Z
    ...
    iget-object v3, v8, mLeftIcon:Lcom/android/systemui/statusbar/KeyguardAffordanceView;

    goto :goto_2

    :cond_3
    iget-object v3, v8, mRightIcon:Lcom/android/systemui/statusbar/KeyguardAffordanceView;

    :goto_2
    if-lez v2, :cond_4

    iget-object v2, v8, mRightIcon:Lcom/android/systemui/statusbar/KeyguardAffordanceView;

    goto :goto_3

    :cond_4
    iget-object v2, v8, mLeftIcon:Lcom/android/systemui/statusbar/KeyguardAffordanceView;

    :goto_3
    move-object v10, v2

    invoke-direct/range {p0 .. p0}, getMinTranslationAmount()I
    ...
    :goto_5
    invoke-direct {v8, v0}, getRadiusFromTranslation(F)F

    move-result v5

    if-eqz p2, :cond_7

    invoke-direct/range {p0 .. p0}, isBelowFalsingThreshold()Z
...
.method private startHintAnimationPhase1(ZLjava/lang/Runnable;)V
    ...
    :goto_0
    iget v1, p0, mHintGrowAmount:I

    invoke-direct {p0, p1, v1}, getAnimatorToRadius(ZI)Landroid/animation/ValueAnimator;
    ...
    iput-object v0, p0, mTargetedView:Landroid/view/View;
...
.method private startSwiping(Landroid/view/View;)V
    ...
    iput-boolean v2, p0, mSwipingInProgress:Z
...
.method private startUnlockHintAnimationPhase2(ZLjava/lang/Runnable;)V
    ...
    invoke-direct {p0, p1, v0}, getAnimatorToRadius(ZI)Landroid/animation/ValueAnimator;
...
.method private updateIcon(Lcom/android/systemui/statusbar/KeyguardAffordanceView;FFZZZZ)V
    ...
    :goto_0
    invoke-direct {p0, p1, p3, p4}, updateIconAlpha(Lcom/android/systemui/statusbar/KeyguardAffordanceView;FZ)V
...
.method private updateIconAlpha(Lcom/android/systemui/statusbar/KeyguardAffordanceView;FZ)V
    ...
    invoke-direct {p0, p2, p1}, getScale(FLcom/android/systemui/statusbar/KeyguardAffordanceView;)F
...
.method private updateIconsFromTranslation(Lcom/android/systemui/statusbar/KeyguardAffordanceView;)V
    ...
    iget-object v2, p0, mRightIcon:Lcom/android/systemui/statusbar/KeyguardAffordanceView;

    if-ne p1, v2, :cond_0

    iget-object v2, p0, mLeftIcon:Lcom/android/systemui/statusbar/KeyguardAffordanceView;
    ...
    invoke-direct {p0, p1, v0, v3}, updateIconAlpha(Lcom/android/systemui/statusbar/KeyguardAffordanceView;FZ)V
    ...
    invoke-direct {p0, v2, v1, v3}, updateIconAlpha(Lcom/android/systemui/statusbar/KeyguardAffordanceView;FZ)V
...
.method public isSwipingInProgress()Z
    ...
    iget-boolean p0, p0, mSwipingInProgress:Z
...
.method public launchAffordance(ZZ)V
    ...
    invoke-direct {p0, v0}, startSwiping(Landroid/view/View;)V
    ...
    invoke-direct {p0, v1, v2, p1}, fling(FZZ)V
    ...
    invoke-direct/range {v2 .. v9}, updateIcon(Lcom/android/systemui/statusbar/KeyguardAffordanceView;FFZZZZ)V
    ...
    iget-object p1, p0, mRightIcon:Lcom/android/systemui/statusbar/KeyguardAffordanceView;

    invoke-virtual {p1, v4}, Lcom/android/systemui/statusbar/KeyguardAffordanceView;->setCircleColorToInverse(Z)V

    :cond_5
    iget-object p1, p0, mCallback:Lcom/android/systemui/statusbar/phone/KeyguardAffordanceHelper$Callback;
    ...
    iget-object p1, p0, mFlingEndListener:Landroid/animation/AnimatorListenerAdapter;

    const/4 p2, 0x0

    invoke-virtual {p1, p2}, Landroid/animation/AnimatorListenerAdapter;->onAnimationEnd(Landroid/animation/Animator;)V

    iget-object p0, p0, mAnimationEndRunnable:Ljava/lang/Runnable;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v1, p0, mMotionCancelled:Z
    ...
    :cond_1
    iput-boolean v4, p0, mMotionCancelled:Z

    invoke-direct {p0, v4, v3, v1}, endMotion(ZFF)V
    ...
    iget-boolean v0, p0, mTouchSlopExeeded:Z
    ...
    iput-boolean v4, p0, mTouchSlopExeeded:Z
    ...
    iget-object v0, p0, mTargetedView:Landroid/view/View;
    ...
    iget v0, p0, mTranslationOnDown:F
    ...
    :goto_0
    invoke-direct {p0, p1, v2, v2}, setTranslation(FZZ)V
    ...
    :goto_1
    iget-object v5, p0, mTargetedView:Landroid/view/View;

    iget-object v6, p0, mRightIcon:Lcom/android/systemui/statusbar/KeyguardAffordanceView;
    ...
    invoke-direct {p0, p1, v3, v1}, endMotion(ZFF)V

    iget-boolean p1, p0, mTouchSlopExeeded:Z
    ...
    :cond_8
    invoke-direct {p0, v3, v1}, getIconAtPosition(FF)Landroid/view/View;
    ...
    :cond_a
    iput-boolean v2, p0, mTouchSlopExeeded:Z
    ...
    iput v0, p0, mTranslationOnDown:F

    invoke-direct {p0}, initVelocityTracker()V

    invoke-direct {p0, p1}, trackMovement(Landroid/view/MotionEvent;)V

    iput-boolean v2, p0, mMotionCancelled:Z
...
.method public reset(Z)V
    ...
    invoke-direct {p0, v1, v0, p1}, setTranslation(FZZ)V

    iput-boolean v0, p0, mMotionCancelled:Z

    iget-boolean p1, p0, mSwipingInProgress:Z
...
.method public startHintAnimation(ZLjava/lang/Runnable;)V
    ...
    invoke-direct {p0, p1, p2}, startHintAnimationPhase1(ZLjava/lang/Runnable;)V
...
.method public updatePreviews()V
    ...
    iget-object v1, p0, mCallback:Lcom/android/systemui/statusbar/phone/KeyguardAffordanceHelper$Callback;
