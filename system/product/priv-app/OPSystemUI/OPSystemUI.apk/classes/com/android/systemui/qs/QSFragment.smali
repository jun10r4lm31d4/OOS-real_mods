...
.method public constructor <init>(Lcom/android/systemui/statusbar/policy/RemoteInputQuickSettingsDisabler;Lcom/android/systemui/util/InjectionInflationController;Landroid/content/Context;Lcom/android/systemui/qs/QSTileHost;)V
    ...
    iput-object v0, p0, mQsBounds:Landroid/graphics/Rect;

    const/high16 v0, -0x40800000    # -1.0f

    iput v0, p0, mLastQSExpansion:F
    ...
    iput-object v0, p0, mStartHeaderSlidingIn:Landroid/view/ViewTreeObserver$OnPreDrawListener;
    ...
    iput-object v0, p0, mAnimateHeaderSlidingInListener:Landroid/animation/Animator$AnimatorListener;

    iput-object p1, p0, mRemoteInputQuickSettingsDisabler:Lcom/android/systemui/statusbar/policy/RemoteInputQuickSettingsDisabler;

    iput-object p2, p0, mInjectionInflater:Lcom/android/systemui/util/InjectionInflationController;
    ...
    iput-object p4, p0, mHost:Lcom/android/systemui/qs/QSTileHost;
...
.method static synthetic access$002(Lcom/android/systemui/qs/QSFragment;Z)Z
    ...
    iput-boolean p1, p0, mHeaderAnimating:Z
...
.method static synthetic access$200(Lcom/android/systemui/qs/QSFragment;)Landroid/animation/Animator$AnimatorListener;
    ...
    iget-object p0, p0, mAnimateHeaderSlidingInListener:Landroid/animation/Animator$AnimatorListener;
...
.method private setEditLocation(Landroid/view/View;)V
    ...
    iget-object p0, p0, mQSCustomizer:Lcom/android/systemui/qs/customize/QSCustomizer;
...
.method private updateQsState()V
    ...
    iget-boolean v0, p0, mHeaderAnimating:Z
    ...
    :goto_1
    iget-object v3, p0, mQSPanel:Lcom/android/systemui/qs/QSPanel;

    iget-boolean v4, p0, mQsExpanded:Z

    invoke-virtual {v3, v4}, Lcom/android/systemui/qs/QSPanel;->setExpanded(Z)V

    iget-object v3, p0, mQSDetail:Lcom/android/systemui/qs/QSDetail;

    iget-boolean v4, p0, mQsExpanded:Z

    invoke-virtual {v3, v4}, Lcom/android/systemui/qs/QSDetail;->setExpanded(Z)V

    iget-object v3, p0, mHeader:Lcom/android/systemui/qs/QuickStatusBarHeader;
    ...
    iget-boolean v4, p0, mHeaderAnimating:Z
    ...
    iget-boolean v4, p0, mStackScrollerOverscrolling:Z
    ...
    iget-object v3, p0, mFooter:Lcom/android/systemui/qs/QSFooter;

    iget-boolean v4, p0, mQsDisabled:Z
...
.method public animateHeaderSlidingIn(J)V
    ...
    iput-boolean v0, p0, mHeaderAnimating:Z

    iput-wide p1, p0, mDelay:J
    ...
    iget-object p0, p0, mStartHeaderSlidingIn:Landroid/view/ViewTreeObserver$OnPreDrawListener;
...
.method public animateHeaderSlidingOut()V
    ...
    iget-object v1, p0, mHeader:Lcom/android/systemui/qs/QuickStatusBarHeader;
...
.method public disable(IIIZ)V
    ...
    :cond_0
    iget-object p1, p0, mRemoteInputQuickSettingsDisabler:Lcom/android/systemui/statusbar/policy/RemoteInputQuickSettingsDisabler;
    ...
    :cond_2
    iput-boolean p3, p0, mQsDisabled:Z

    iget-object p3, p0, mContainer:Lcom/android/systemui/qs/QSContainerImpl;

    invoke-virtual {p3, p2, p1, p4}, Lcom/android/systemui/qs/QSContainerImpl;->disable(IIZ)V

    iget-object p3, p0, mHeader:Lcom/android/systemui/qs/QuickStatusBarHeader;

    invoke-virtual {p3, p2, p1, p4}, Lcom/android/systemui/qs/QuickStatusBarHeader;->disable(IIZ)V

    iget-object p3, p0, mFooter:Lcom/android/systemui/qs/QSFooter;
...
.method public getDesiredHeight()I
    ...
    iget-object v0, p0, mQSCustomizer:Lcom/android/systemui/qs/customize/QSCustomizer;
    ...
    :cond_0
    iget-object v0, p0, mQSDetail:Lcom/android/systemui/qs/QSDetail;
...
.method isListening()Z
    ...
    iget-boolean p0, p0, mListening:Z
...
.method public isShowingDetail()Z
    ...
    iget-object p0, p0, mQSDetail:Lcom/android/systemui/qs/QSDetail;
...
.method public notifyCustomizeChanged()V
    ...
    iget-object v0, p0, mContainer:Lcom/android/systemui/qs/QSContainerImpl;

    invoke-virtual {v0}, Lcom/android/systemui/qs/QSContainerImpl;->updateExpansion()V

    iget-object v0, p0, mQSPanel:Lcom/android/systemui/qs/QSPanel;

    iget-object v1, p0, mQSCustomizer:Lcom/android/systemui/qs/customize/QSCustomizer;
    ...
    iget-object v0, p0, mFooter:Lcom/android/systemui/qs/QSFooter;
    ...
    iget-object p0, p0, mPanelView:Lcom/android/systemui/plugins/qs/QS$HeightListener;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-direct {p0, v0}, setEditLocation(Landroid/view/View;)V
    ...
    iget-object p0, p0, mQSAnimator:Lcom/android/systemui/qs/QSAnimator;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iget-object p3, p0, mInjectionInflater:Lcom/android/systemui/util/InjectionInflationController;
...
.method public onDestroy()V
    ...
    invoke-virtual {p0, v1}, setListening(Z)V
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p0}, isCustomizing()Z
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, mQSPanel:Lcom/android/systemui/qs/QSPanel;
    ...
    iput-object v0, p0, mQSDetail:Lcom/android/systemui/qs/QSDetail;
    ...
    iput-object v0, p0, mHeader:Lcom/android/systemui/qs/QuickStatusBarHeader;
    ...
    iput-object v0, p0, mFooter:Lcom/android/systemui/qs/QSFooter;
    ...
    iput-object v0, p0, mContainer:Lcom/android/systemui/qs/QSContainerImpl;
    ...
    iput-object v0, p0, mQSAnimator:Lcom/android/systemui/qs/QSAnimator;
    ...
    iput-object v0, p0, mQSCustomizer:Lcom/android/systemui/qs/customize/QSCustomizer;
    ...
    invoke-virtual {p0, v0}, setExpanded(Z)V
    ...
    invoke-direct {p0, p1}, setEditLocation(Landroid/view/View;)V

    iget-object p1, p0, mQSCustomizer:Lcom/android/systemui/qs/customize/QSCustomizer;
    ...
    invoke-virtual {p0, p1}, setHost(Lcom/android/systemui/qs/QSTileHost;)V
...
.method public setExpandClickListener(Landroid/view/View$OnClickListener;)V
    ...
    iget-object p0, p0, mFooter:Lcom/android/systemui/qs/QSFooter;
...
.method public setHeaderListening(Z)V
    ...
    iget-object v0, p0, mHeader:Lcom/android/systemui/qs/QuickStatusBarHeader;
...
.method public setHeightOverride(I)V
    ...
    iget-object p0, p0, mContainer:Lcom/android/systemui/qs/QSContainerImpl;
...
.method public setKeyguardShowing(Z)V
    ...
    iget-object v0, p0, mQSAnimator:Lcom/android/systemui/qs/QSAnimator;
...
.method public setPanelView(Lcom/android/systemui/plugins/qs/QS$HeightListener;)V
    ...
    iput-object p1, p0, mPanelView:Lcom/android/systemui/plugins/qs/QS$HeightListener;
...
.method public setQsExpansion(FF)V
    ...
    iget-boolean v2, p0, mHeaderAnimating:Z
    ...
    iget-object p2, p0, mHeader:Lcom/android/systemui/qs/QuickStatusBarHeader;
    ...
    :goto_0
    iget-object v4, p0, mQSPanel:Lcom/android/systemui/qs/QSPanel;

    invoke-virtual {v4}, Landroid/widget/LinearLayout;->getBottom()I

    move-result v4

    iget-object v5, p0, mHeader:Lcom/android/systemui/qs/QuickStatusBarHeader;
    ...
    iget-object v5, p0, mFooter:Lcom/android/systemui/qs/QSFooter;
    ...
    iget-object v4, p0, mHeader:Lcom/android/systemui/qs/QuickStatusBarHeader;
    ...
    iget-object v4, p0, mFooter:Lcom/android/systemui/qs/QSFooter;
    ...
    iget-object v1, p0, mQSDetail:Lcom/android/systemui/qs/QSDetail;
    ...
    iget-object p2, p0, mQSPanel:Lcom/android/systemui/qs/QSPanel;
    ...
    :cond_6
    iget-object p2, p0, mQsBounds:Landroid/graphics/Rect;
    ...
    iget-object v0, p0, mQsBounds:Landroid/graphics/Rect;
