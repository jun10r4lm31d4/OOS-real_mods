...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput p2, p0, mLeftInset:I

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0}, Landroid/graphics/Paint;-><init>()V

    iput-object v0, p0, mTransparentSrcPaint:Landroid/graphics/Paint;
    ...
    iput-object v0, p0, mGestureListener:Landroid/view/GestureDetector$SimpleOnGestureListener;
    ...
    iput-object v0, p0, mTunable:Lcom/android/systemui/tuner/TunerService$Tunable;
    ...
    iput-object v0, p0, mFakeWindow:Landroid/view/Window;

    invoke-virtual {p0, p2}, Landroid/widget/FrameLayout;->setMotionEventSplittingEnabled(Z)V

    iget-object v0, p0, mTransparentSrcPaint:Landroid/graphics/Paint;

    invoke-virtual {v0, p2}, Landroid/graphics/Paint;->setColor(I)V

    iget-object p2, p0, mTransparentSrcPaint:Landroid/graphics/Paint;
    ...
    iget-object v0, p0, mGestureListener:Landroid/view/GestureDetector$SimpleOnGestureListener;
    ...
    iput-object p1, p0, mStatusBarStateController:Lcom/android/systemui/plugins/statusbar/StatusBarStateController;
    ...
    iget-object p0, p0, mTunable:Lcom/android/systemui/tuner/TunerService$Tunable;
...
.method static synthetic access$000(Lcom/android/systemui/statusbar/phone/StatusBarWindowView;)Z
    ...
    iget-boolean p0, p0, mSingleTapEnabled:Z
...
.method static synthetic access$100(Lcom/android/systemui/statusbar/phone/StatusBarWindowView;)Z
    ...
    iget-boolean p0, p0, mSuppressingWakeUpGesture:Z
...
.method static synthetic access$200(Lcom/android/systemui/statusbar/phone/StatusBarWindowView;)Lcom/android/systemui/statusbar/phone/StatusBar;
    ...
    iget-object p0, p0, mService:Lcom/android/systemui/statusbar/phone/StatusBar;
...
.method static synthetic access$300(Lcom/android/systemui/statusbar/phone/StatusBarWindowView;)Z
    ...
    iget-boolean p0, p0, mDoubleTapEnabled:Z
...
.method static synthetic access$400(Lcom/android/systemui/statusbar/phone/StatusBarWindowView;)Landroid/view/ActionMode;
    ...
    iget-object p0, p0, mFloatingActionMode:Landroid/view/ActionMode;
...
.method private applyMargins()V
    ...
    iget v5, p0, mRightInset:I

    if-ne v4, v5, :cond_0

    iget v4, v3, Landroid/widget/FrameLayout$LayoutParams;->leftMargin:I

    iget v5, p0, mLeftInset:I

    if-eq v4, v5, :cond_1

    :cond_0
    iget v4, p0, mRightInset:I

    iput v4, v3, Landroid/widget/FrameLayout$LayoutParams;->rightMargin:I

    iget v4, p0, mLeftInset:I
...
.method private cleanupFloatingActionModeViews()V
    ...
    iput-object v1, p0, mFloatingToolbar:Lcom/android/internal/widget/FloatingToolbar;
    ...
    iget-object v2, p0, mFloatingToolbarPreDrawListener:Landroid/view/ViewTreeObserver$OnPreDrawListener;
    ...
    :cond_1
    iput-object v1, p0, mFloatingActionModeOriginatingView:Landroid/view/View;
...
.method private createFloatingActionMode(Landroid/view/View;Landroid/view/ActionMode$Callback2;)Landroid/view/ActionMode;
    ...
    iget-object v1, p0, mFakeWindow:Landroid/view/Window;
    ...
    iput-object p1, p0, mFloatingToolbarPreDrawListener:Landroid/view/ViewTreeObserver$OnPreDrawListener;
...
.method private setHandledFloatingActionMode(Landroid/view/ActionMode;)V
    ...
    iget-object p1, p0, mFloatingActionMode:Landroid/view/ActionMode;

    invoke-virtual {p1}, Landroid/view/ActionMode;->invalidate()V

    iget-object p1, p0, mFloatingActionModeOriginatingView:Landroid/view/View;

    invoke-virtual {p1}, Landroid/view/View;->getViewTreeObserver()Landroid/view/ViewTreeObserver;

    move-result-object p1

    iget-object p0, p0, mFloatingToolbarPreDrawListener:Landroid/view/ViewTreeObserver$OnPreDrawListener;
...
.method private startActionMode(Landroid/view/View;Landroid/view/ActionMode$Callback;I)Landroid/view/ActionMode;
    ...
    invoke-direct {p0, p1, p3}, createFloatingActionMode(Landroid/view/View;Landroid/view/ActionMode$Callback2;)Landroid/view/ActionMode;
    ...
    invoke-direct {p0, p1}, setHandledFloatingActionMode(Landroid/view/ActionMode;)V
...
.method public cancelCurrentTouch()V
    ...
    iget-boolean v0, p0, mTouchActive:Z
    ...
    invoke-virtual {p0, v0}, dispatchTouchEvent(Landroid/view/MotionEvent;)Z

    invoke-virtual {v0}, Landroid/view/MotionEvent;->recycle()V

    const/4 v0, 0x1

    iput-boolean v0, p0, mTouchCancelled:Z
...
.method public cancelExpandHelper()V
    ...
    invoke-virtual {p0}, getStackScrollLayout()Lcom/android/systemui/statusbar/notification/stack/NotificationStackScrollLayout;
...
.method public dispatchKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    iget-object v0, p0, mService:Lcom/android/systemui/statusbar/phone/StatusBar;
...
.method public dispatchTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :goto_2
    iget-boolean v6, p0, mExpandingBelowNotch:Z
    ...
    :cond_3
    iput-boolean v2, p0, mExpandingBelowNotch:Z

    :cond_4
    if-nez v4, :cond_5

    iget-object v3, p0, mService:Lcom/android/systemui/statusbar/phone/StatusBar;
    ...
    invoke-virtual {p0, v1}, setTouchActive(Z)V

    iput-boolean v2, p0, mTouchCancelled:Z
    ...
    :cond_8
    invoke-virtual {p0, v2}, setTouchActive(Z)V
    ...
    iget-boolean v4, p0, mTouchCancelled:Z
    ...
    iget-boolean v4, p0, mExpandAnimationRunning:Z
    ...
    iget-boolean v4, p0, mExpandAnimationPending:Z
    ...
    :cond_a
    iget-boolean v3, p0, mTouchCancelled:Z

    if-nez v3, :cond_13

    iget-boolean v3, p0, mExpandAnimationRunning:Z

    if-nez v3, :cond_13

    iget-boolean v3, p0, mExpandAnimationPending:Z
    ...
    :cond_b
    iget-object v3, p0, mFalsingManager:Lcom/android/systemui/plugins/FalsingManager;
    ...
    iget-object v3, p0, mBrightnessMirror:Landroid/view/View;
    ...
    :cond_d
    iget-object v2, p0, mService:Lcom/android/systemui/statusbar/phone/StatusBar;
    ...
    iput-boolean v1, p0, mExpandingBelowNotch:Z
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-boolean p1, p0, mExpandAnimationPending:Z
    ...
    iget-boolean p1, p0, mExpandAnimationRunning:Z
    ...
    iget-boolean p1, p0, mTouchCancelled:Z
    ...
    iget-boolean p0, p0, mTouchActive:Z
...
.method protected fitSystemWindows(Landroid/graphics/Rect;)Z
    ...
    invoke-virtual {p0}, isAppFullscreen()Z
    ...
    :cond_4
    iput v0, p0, mRightInset:I

    iput v3, p0, mLeftInset:I

    invoke-direct {p0}, applyMargins()V
    ...
    :cond_8
    iput v2, p0, mRightInset:I

    iput v2, p0, mLeftInset:I
...
.method protected getStackScrollLayout()Lcom/android/systemui/statusbar/notification/stack/NotificationStackScrollLayout;
    ...
    iget-object p0, p0, mStackScrollLayout:Lcom/android/systemui/statusbar/notification/stack/NotificationStackScrollLayout;
...
.method public synthetic lambda$new$0$StatusBarWindowView(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-boolean p1, p0, mSingleTapEnabled:Z
    ...
    iput-boolean p1, p0, mDoubleTapEnabled:Z
...
.method protected onFinishInflate()V
    ...
    iput-object v0, p0, mStackScrollLayout:Lcom/android/systemui/statusbar/notification/stack/NotificationStackScrollLayout;
    ...
    iput-object v0, p0, mNotificationPanel:Lcom/android/systemui/statusbar/phone/NotificationPanelView;
    ...
    iput-object v0, p0, mLockIcon:Lcom/android/systemui/statusbar/phone/LockIcon;
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v1, p0, mService:Lcom/android/systemui/statusbar/phone/StatusBar;
    ...
    iget-object v3, p0, mStatusBarStateController:Lcom/android/systemui/plugins/statusbar/StatusBarStateController;
    ...
    iget-object v1, p0, mDragDownHelper:Lcom/android/systemui/statusbar/DragDownHelper;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_1
    iget-object v3, p0, mDragDownHelper:Lcom/android/systemui/statusbar/DragDownHelper;
    ...
    :cond_2
    iget-object v0, p0, mDragDownHelper:Lcom/android/systemui/statusbar/DragDownHelper;
...
.method public onViewAdded(Landroid/view/View;)V
    ...
    iput-object p1, p0, mBrightnessMirror:Landroid/view/View;
...
.method setDragDownHelper(Lcom/android/systemui/statusbar/DragDownHelper;)V
    ...
    iput-object p1, p0, mDragDownHelper:Lcom/android/systemui/statusbar/DragDownHelper;
...
.method public setExpandAnimationPending(Z)V
    ...
    iput-boolean p1, p0, mExpandAnimationPending:Z
...
.method public setExpandAnimationRunning(Z)V
    ...
    iput-boolean p1, p0, mExpandAnimationRunning:Z
...
.method public setService(Lcom/android/systemui/statusbar/phone/StatusBar;)V
    ...
    iput-object p1, p0, mService:Lcom/android/systemui/statusbar/phone/StatusBar;
    ...
    invoke-virtual {p0, v1}, setDragDownHelper(Lcom/android/systemui/statusbar/DragDownHelper;)V
...
.method public setStatusBarView(Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;)V
    ...
    iput-object p1, p0, mStatusBarView:Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;
...
.method public setTouchActive(Z)V
    ...
    iput-boolean p1, p0, mTouchActive:Z
...
.method suppressWakeUpGesture(Z)V
    ...
    iput-boolean p1, p0, mSuppressingWakeUpGesture:Z
