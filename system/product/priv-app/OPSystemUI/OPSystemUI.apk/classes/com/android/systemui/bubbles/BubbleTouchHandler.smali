...
.method constructor <init>(Lcom/android/systemui/bubbles/BubbleStackView;Lcom/android/systemui/bubbles/BubbleData;Landroid/content/Context;)V
    ...
    iput-object v0, p0, mTouchDown:Landroid/graphics/PointF;

    new-instance v0, Landroid/graphics/PointF;

    invoke-direct {v0}, Landroid/graphics/PointF;-><init>()V

    iput-object v0, p0, mViewPositionOnTouchDown:Landroid/graphics/PointF;
    ...
    iput-object v0, p0, mController:Lcom/android/systemui/bubbles/BubbleController;
    ...
    iput p3, p0, mTouchSlopSquared:I

    iput-object p2, p0, mBubbleData:Lcom/android/systemui/bubbles/BubbleData;

    iput-object p1, p0, mStack:Lcom/android/systemui/bubbles/BubbleStackView;
...
.method private isFastFlingTowardsDismissTarget(FFFF)Z
    ...
    iget-object p1, p0, mStack:Lcom/android/systemui/bubbles/BubbleStackView;
    ...
    :cond_1
    iget-object p2, p0, mStack:Lcom/android/systemui/bubbles/BubbleStackView;
    ...
    iget-object p0, p0, mStack:Lcom/android/systemui/bubbles/BubbleStackView;
...
.method private resetForNextGesture()V
    ...
    :cond_0
    iput-object v1, p0, mTouchedView:Landroid/view/View;

    const/4 v0, 0x0

    iput-boolean v0, p0, mMovedEnough:Z

    iput-boolean v0, p0, mInDismissTarget:Z
...
.method public synthetic lambda$onTouch$0$BubbleTouchHandler(ZLjava/lang/String;)V
    ...
    iget-object p0, p0, mController:Lcom/android/systemui/bubbles/BubbleController;
...
.method public onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    iget-object v3, v0, mTouchedView:Landroid/view/View;

    if-nez v3, :cond_0

    iget-object v3, v0, mStack:Lcom/android/systemui/bubbles/BubbleStackView;
    ...
    iput-object v3, v0, mTouchedView:Landroid/view/View;
    ...
    :cond_1
    iget-object v5, v0, mStack:Lcom/android/systemui/bubbles/BubbleStackView;
    ...
    iget-object v6, v0, mTouchedView:Landroid/view/View;
    ...
    iget-object v8, v0, mViewPositionOnTouchDown:Landroid/graphics/PointF;

    iget v9, v8, Landroid/graphics/PointF;->x:F

    add-float/2addr v9, v6

    iget-object v10, v0, mTouchDown:Landroid/graphics/PointF;
    ...
    :cond_2
    invoke-direct/range {p0 .. p0}, resetForNextGesture()V

    goto/16 :goto_6

    :cond_3
    invoke-direct {v0, v1}, trackMovement(Landroid/view/MotionEvent;)V

    iget-object v2, v0, mTouchDown:Landroid/graphics/PointF;
    ...
    iget v4, v0, mTouchSlopSquared:I
    ...
    iget-boolean v2, v0, mMovedEnough:Z

    if-nez v2, :cond_4

    iput-boolean v10, v0, mMovedEnough:Z
    ...
    iget-object v2, v0, mStack:Lcom/android/systemui/bubbles/BubbleStackView;
    ...
    iget-boolean v2, v0, mInDismissTarget:Z

    if-eq v1, v2, :cond_19

    iput-boolean v1, v0, mInDismissTarget:Z

    iget-object v1, v0, mVelocityTracker:Landroid/view/VelocityTracker;
    ...
    iget-object v12, v0, mStack:Lcom/android/systemui/bubbles/BubbleStackView;

    iget-object v13, v0, mTouchedView:Landroid/view/View;

    iget-boolean v14, v0, mInDismissTarget:Z
    ...
    iget-boolean v11, v0, mInDismissTarget:Z

    if-nez v11, :cond_b

    invoke-direct {v0, v6, v7, v1, v2}, isFastFlingTowardsDismissTarget(FFFF)Z
    ...
    :cond_9
    iget-boolean v7, v0, mInDismissTarget:Z
    ...
    iget-boolean v11, v0, mMovedEnough:Z

    if-eqz v11, :cond_c

    iget-object v2, v0, mStack:Lcom/android/systemui/bubbles/BubbleStackView;

    iget-object v3, v0, mTouchDown:Landroid/graphics/PointF;
    ...
    :cond_d
    iget-object v4, v0, mTouchedView:Landroid/view/View;
    ...
    iget-object v1, v0, mBubbleData:Lcom/android/systemui/bubbles/BubbleData;
    ...
    iget-boolean v1, v0, mMovedEnough:Z
    ...
    :cond_f
    iget-boolean v6, v0, mMovedEnough:Z
    ...
    :cond_11
    iget-object v1, v0, mTouchedView:Landroid/view/View;
    ...
    iget-object v2, v0, mBubbleData:Lcom/android/systemui/bubbles/BubbleData;
    ...
    iget-object v1, v0, mTouchDown:Landroid/graphics/PointF;

    invoke-virtual {v1, v6, v7}, Landroid/graphics/PointF;->set(FF)V

    iget-object v1, v0, mStack:Lcom/android/systemui/bubbles/BubbleStackView;

    invoke-virtual {v1}, Lcom/android/systemui/bubbles/BubbleStackView;->onGestureStart()V

    if-eqz v3, :cond_17

    iget-object v1, v0, mViewPositionOnTouchDown:Landroid/graphics/PointF;
    ...
    iget-object v0, v0, mStack:Lcom/android/systemui/bubbles/BubbleStackView;
    ...
    iget-object v2, v0, mTouchedView:Landroid/view/View;
    ...
    iget-object v0, v0, mTouchedView:Landroid/view/View;
