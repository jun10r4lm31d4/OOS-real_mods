...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object p3, p0, mTempPoint:[I

    const/high16 p3, 0x3f800000    # 1.0f

    iput p3, p0, mImageScale:F

    iput p3, p0, mRestingAlpha:F

    const/4 p3, 0x1

    iput-boolean p3, p0, mShouldTint:Z
    ...
    iput-object p4, p0, mClipEndListener:Landroid/animation/AnimatorListenerAdapter;
    ...
    iput-object p4, p0, mCircleEndListener:Landroid/animation/AnimatorListenerAdapter;
    ...
    iput-object p4, p0, mScaleEndListener:Landroid/animation/AnimatorListenerAdapter;
    ...
    iput-object p4, p0, mAlphaEndListener:Landroid/animation/AnimatorListenerAdapter;

    const/4 p4, 0x0

    iput p4, p0, mCustomizeCenterX:I

    iput p4, p0, mCustomizeCenterY:I
    ...
    iput-object p2, p0, mCirclePaint:Landroid/graphics/Paint;

    iget-object p2, p0, mCirclePaint:Landroid/graphics/Paint;

    invoke-virtual {p2, p3}, Landroid/graphics/Paint;->setAntiAlias(Z)V

    const/4 p2, -0x1

    iput p2, p0, mCircleColor:I

    iget-object p3, p0, mCirclePaint:Landroid/graphics/Paint;

    iget p4, p0, mCircleColor:I
    ...
    iput p2, p0, mNormalColor:I

    const/high16 p2, -0x1000000

    iput p2, p0, mDarkIconColor:I
    ...
    iput p2, p0, mMinBackgroundRadius:I

    new-instance p2, Landroid/animation/ArgbEvaluator;

    invoke-direct {p2}, Landroid/animation/ArgbEvaluator;-><init>()V

    iput-object p2, p0, mColorInterpolator:Landroid/animation/ArgbEvaluator;
...
.method static synthetic access$002(Lcom/android/systemui/statusbar/KeyguardAffordanceView;Landroid/animation/Animator;)Landroid/animation/Animator;
    ...
    iput-object p1, p0, mPreviewClipper:Landroid/animation/Animator;
...
.method static synthetic access$102(Lcom/android/systemui/statusbar/KeyguardAffordanceView;Landroid/animation/ValueAnimator;)Landroid/animation/ValueAnimator;
    ...
    iput-object p1, p0, mCircleAnimator:Landroid/animation/ValueAnimator;
...
.method static synthetic access$202(Lcom/android/systemui/statusbar/KeyguardAffordanceView;Landroid/animation/ValueAnimator;)Landroid/animation/ValueAnimator;
    ...
    iput-object p1, p0, mScaleAnimator:Landroid/animation/ValueAnimator;
...
.method static synthetic access$302(Lcom/android/systemui/statusbar/KeyguardAffordanceView;Landroid/animation/ValueAnimator;)Landroid/animation/ValueAnimator;
    ...
    iput-object p1, p0, mAlphaAnimator:Landroid/animation/ValueAnimator;
...
.method static synthetic access$402(Lcom/android/systemui/statusbar/KeyguardAffordanceView;Z)Z
    ...
    iput-boolean p1, p0, mFinishing:Z
...
.method static synthetic access$600(Lcom/android/systemui/statusbar/KeyguardAffordanceView;)Landroid/view/View;
    ...
    iget-object p0, p0, mPreviewView:Landroid/view/View;
...
.method private drawBackgroundCircle(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v0, p0, mFinishing:Z
    ...
    iget-boolean v0, p0, mSupportHardware:Z

    if-eqz v0, :cond_1

    iget-object v0, p0, mHwCenterX:Landroid/graphics/CanvasProperty;

    if-eqz v0, :cond_1

    check-cast p1, Landroid/graphics/RecordingCanvas;

    iget-object v1, p0, mHwCenterY:Landroid/graphics/CanvasProperty;

    iget-object v2, p0, mHwCircleRadius:Landroid/graphics/CanvasProperty;

    iget-object p0, p0, mHwCirclePaint:Landroid/graphics/CanvasProperty;
    ...
    iget v1, p0, mNormalColor:I

    if-eq v0, v1, :cond_2

    iget v0, p0, mCircleRadius:F

    invoke-direct {p0}, getMaxCircleSize()F
    ...
    :cond_2
    invoke-direct {p0}, updateCircleColor()V
    ...
    iget v2, p0, mCircleRadius:F

    iget-object p0, p0, mCirclePaint:Landroid/graphics/Paint;
...
.method private getAnimatorToRadius(F)Landroid/animation/ValueAnimator;
    ...
    iput-object v0, p0, mCircleAnimator:Landroid/animation/ValueAnimator;

    iget v3, p0, mCircleRadius:F

    iput v3, p0, mCircleStartValue:F
    ...
    :goto_0
    iput-boolean v1, p0, mCircleWillBeHidden:Z
    ...
    iget-object p0, p0, mCircleEndListener:Landroid/animation/AnimatorListenerAdapter;
...
.method private getMaxCircleSize()F
    ...
    iget-object v0, p0, mTempPoint:[I
    ...
    iget-object v1, p0, mTempPoint:[I
...
.method private getRtAnimatorToRadius(F)Landroid/animation/Animator;
    ...
    iget-object v1, p0, mHwCircleRadius:Landroid/graphics/CanvasProperty;
...
.method private initHwProperties()V
    ...
    iput-object v0, p0, mHwCenterX:Landroid/graphics/CanvasProperty;
    ...
    iput-object v0, p0, mHwCenterY:Landroid/graphics/CanvasProperty;
    ...
    iput-object v0, p0, mHwCirclePaint:Landroid/graphics/CanvasProperty;
    ...
    iput-object v0, p0, mHwCircleRadius:Landroid/graphics/CanvasProperty;
...
.method private setCircleRadius(FZZ)V
    ...
    iget-object v0, p0, mCircleAnimator:Landroid/animation/ValueAnimator;
    ...
    iget-boolean v0, p0, mCircleWillBeHidden:Z
    ...
    iget-object p2, p0, mCircleAnimator:Landroid/animation/ValueAnimator;
    ...
    :cond_6
    iget-boolean p3, p0, mCircleWillBeHidden:Z

    if-nez p3, :cond_a

    iget p3, p0, mMinBackgroundRadius:I
    ...
    iget v1, p0, mCircleStartValue:F
    ...
    iget-object p0, p0, mCircleAnimator:Landroid/animation/ValueAnimator;
    ...
    :cond_7
    iget-object p3, p0, mCircleAnimator:Landroid/animation/ValueAnimator;

    invoke-direct {p0, p3}, cancelAnimator(Landroid/animation/Animator;)V

    iget-object p3, p0, mPreviewClipper:Landroid/animation/Animator;

    invoke-direct {p0, p3}, cancelAnimator(Landroid/animation/Animator;)V

    invoke-direct {p0, p1}, getAnimatorToRadius(F)Landroid/animation/ValueAnimator;
    ...
    iget v1, p0, mMinBackgroundRadius:I
    ...
    iget-object p2, p0, mPreviewView:Landroid/view/View;
    ...
    iget v4, p0, mCenterY:I

    add-int/2addr v3, v4

    iget v4, p0, mCircleRadius:F
    ...
    iget-object p1, p0, mPreviewClipper:Landroid/animation/Animator;
    ...
    iget-object p2, p0, mClipEndListener:Landroid/animation/AnimatorListenerAdapter;
    ...
    iget-object p0, p0, mPreviewClipper:Landroid/animation/Animator;
...
.method private startRtAlphaFadeIn()V
    ...
    iget-object v0, p0, mPreviewView:Landroid/view/View;
    ...
    iget-object v1, p0, mHwCirclePaint:Landroid/graphics/CanvasProperty;
...
.method private updateCircleColor()V
    ...
    iget-object v2, p0, mPreviewView:Landroid/view/View;
    ...
    iget v4, p0, mCircleStartRadius:F
    ...
    iget v2, p0, mCircleColor:I

    invoke-static {v2}, Landroid/graphics/Color;->green(I)I

    move-result v2

    iget v3, p0, mCircleColor:I
...
.method private updateIconColor()V
    ...
    iget-boolean v0, p0, mShouldTint:Z
    ...
    iget v2, p0, mMinBackgroundRadius:I
    ...
    iget-object v2, p0, mColorInterpolator:Landroid/animation/ArgbEvaluator;

    iget v3, p0, mNormalColor:I

    invoke-static {v3}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v3

    iget p0, p0, mDarkIconColor:I
...
.method public finishAnimation(FLjava/lang/Runnable;)V
    ...
    invoke-direct {p0, v0}, cancelAnimator(Landroid/animation/Animator;)V

    iget-object v0, p0, mPreviewClipper:Landroid/animation/Animator;

    invoke-direct {p0, v0}, cancelAnimator(Landroid/animation/Animator;)V

    const/4 v0, 0x1

    iput-boolean v0, p0, mFinishing:Z

    iget v1, p0, mCircleRadius:F

    iput v1, p0, mCircleStartRadius:F

    invoke-direct {p0}, getMaxCircleSize()F

    move-result v1

    iget-boolean v2, p0, mSupportHardware:Z

    if-eqz v2, :cond_0

    invoke-direct {p0}, initHwProperties()V

    invoke-direct {p0, v1}, getRtAnimatorToRadius(F)Landroid/animation/Animator;

    move-result-object v2

    invoke-direct {p0}, startRtAlphaFadeIn()V

    goto :goto_0

    :cond_0
    invoke-direct {p0, v1}, getAnimatorToRadius(F)Landroid/animation/ValueAnimator;
    ...
    invoke-virtual {p0, p2, v0}, setImageAlpha(FZ)V
    ...
    iput-object p2, p0, mPreviewClipper:Landroid/animation/Animator;

    iget-object v2, p0, mFlingAnimationUtils:Lcom/android/systemui/statusbar/FlingAnimationUtils;

    iget-object v3, p0, mPreviewClipper:Landroid/animation/Animator;
    ...
    iget-boolean p1, p0, mSupportHardware:Z
    ...
    invoke-direct {p0, p1, p2}, startRtCircleFadeOut(J)V
...
.method public instantFinishAnimation()V
    ...
    invoke-virtual {p0, v0, v1}, setImageAlpha(FZ)V
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iput-boolean v0, p0, mSupportHardware:Z

    invoke-direct {p0, p1}, drawBackgroundCircle(Landroid/graphics/Canvas;)V

    invoke-virtual {p1}, Landroid/graphics/Canvas;->save()I

    iget v0, p0, mImageScale:F
...
.method protected onLayout(ZIIII)V
    ...
    iget p1, p0, mCustomizeCenterX:I
    ...
    iget p1, p0, mCustomizeCenterY:I
...
.method protected onVisibilityChanged(Landroid/view/View;I)V
    ...
    invoke-virtual {p0, p1}, setCircleColorToInverse(Z)V
...
.method public setCenter(II)V
    ...
    iput p1, p0, mCustomizeCenterX:I

    iput p2, p0, mCustomizeCenterY:I
...
.method public setCircleRadius(FZ)V
    ...
    invoke-direct {p0, p1, p2, v0}, setCircleRadius(FZZ)V
...
.method public setCircleRadiusWithoutAnimation(F)V
    ...
    invoke-direct {p0, p1, v0, v1}, setCircleRadius(FZZ)V
...
.method public setImageAlpha(FZ)V
    ...
    invoke-virtual/range {v0 .. v6}, setImageAlpha(FZJLandroid/view/animation/Interpolator;Ljava/lang/Runnable;)V
...
.method public setImageAlpha(FZJLandroid/view/animation/Interpolator;Ljava/lang/Runnable;)V
    ...
    iget-object v0, p0, mAlphaAnimator:Landroid/animation/ValueAnimator;
    ...
    iput-object v4, p0, mAlphaAnimator:Landroid/animation/ValueAnimator;
    ...
    iget-object v3, p0, mAlphaEndListener:Landroid/animation/AnimatorListenerAdapter;
    ...
    invoke-direct {p0, p6}, getEndListener(Ljava/lang/Runnable;)Landroid/animation/Animator$AnimatorListener;
...
.method public setImageDrawable(Landroid/graphics/drawable/Drawable;Z)V
    ...
    iput-boolean p2, p0, mShouldTint:Z
...
.method public setImageScale(FZ)V
    ...
    invoke-virtual/range {v0 .. v5}, setImageScale(FZJLandroid/view/animation/Interpolator;)V
...
.method public setImageScale(FZJLandroid/view/animation/Interpolator;)V
    ...
    :cond_0
    iget-object v0, p0, mScaleAnimator:Landroid/animation/ValueAnimator;
    ...
    iput-object p2, p0, mScaleAnimator:Landroid/animation/ValueAnimator;
    ...
    iget-object v0, p0, mScaleEndListener:Landroid/animation/AnimatorListenerAdapter;
...
.method public setLaunchingAffordance(Z)V
    ...
    iput-boolean p1, p0, mLaunchingAffordance:Z
...
.method public setPreviewView(Landroid/view/View;)V
    ...
    :cond_0
    iput-object p1, p0, mPreviewView:Landroid/view/View;

    iget-object p1, p0, mPreviewView:Landroid/view/View;

    if-eqz p1, :cond_2

    iget-boolean p0, p0, mLaunchingAffordance:Z
...
.method public shouldTint()Z
    ...
    iget-boolean p0, p0, mShouldTint:Z
