...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mRoutes:Landroid/util/ArrayMap;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, mDiscoveringLock:Ljava/lang/Object;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, mProjectionLock:Ljava/lang/Object;
    ...
    iput-object v0, p0, mMediaCallback:Landroid/media/MediaRouter$SimpleCallback;
    ...
    iput-object v0, p0, mProjectionCallback:Landroid/media/projection/MediaProjectionManager$Callback;
    ...
    iput-object p1, p0, mProjectionManager:Landroid/media/projection/MediaProjectionManager;

    iget-object p1, p0, mProjectionManager:Landroid/media/projection/MediaProjectionManager;
    ...
    iput-object p1, p0, mProjection:Landroid/media/projection/MediaProjectionInfo;

    iget-object p1, p0, mProjectionManager:Landroid/media/projection/MediaProjectionManager;

    iget-object p0, p0, mProjectionCallback:Landroid/media/projection/MediaProjectionManager$Callback;
...
.method static synthetic access$100(Landroid/media/MediaRouter$RouteInfo;)Ljava/lang/String;
    ...
    invoke-static {p0}, routeToString(Landroid/media/MediaRouter$RouteInfo;)Ljava/lang/String;
...
.method static synthetic access$200(Lcom/android/systemui/statusbar/policy/CastControllerImpl;)V
    ...
    invoke-direct {p0}, updateRemoteDisplays()V
...
.method static synthetic access$300(Lcom/android/systemui/statusbar/policy/CastControllerImpl;Landroid/media/projection/MediaProjectionInfo;Z)V
    ...
    invoke-direct {p0, p1, p2}, setProjection(Landroid/media/projection/MediaProjectionInfo;Z)V
...
.method private handleDiscoveryChangeLocked()V
    ...
    iget-object v1, p0, mMediaCallback:Landroid/media/MediaRouter$SimpleCallback;
    ...
    :cond_0
    iget-boolean v0, p0, mDiscovering:Z
    ...
    iget-object v3, p0, mMediaCallback:Landroid/media/MediaRouter$SimpleCallback;
...
.method private setProjection(Landroid/media/projection/MediaProjectionInfo;Z)V
    ...
    iget-object v0, p0, mProjection:Landroid/media/projection/MediaProjectionInfo;

    iget-object v1, p0, mProjectionLock:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, mProjection:Landroid/media/projection/MediaProjectionInfo;
    ...
    iget-object p2, p0, mProjection:Landroid/media/projection/MediaProjectionInfo;
    ...
    :cond_2
    invoke-virtual {p0}, fireOnCastDevicesChanged()V
...
.method private updateRemoteDisplays()V
    ...
    iget-object v0, p0, mRoutes:Landroid/util/ArrayMap;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, mRoutes:Landroid/util/ArrayMap;

    invoke-virtual {v1}, Landroid/util/ArrayMap;->clear()V

    iget-object v1, p0, mMediaRouter:Landroid/media/MediaRouter;
    ...
    iget-object v4, p0, mMediaRouter:Landroid/media/MediaRouter;
    ...
    :cond_1
    invoke-direct {p0, v4}, ensureTagExists(Landroid/media/MediaRouter$RouteInfo;)V

    iget-object v3, p0, mRoutes:Landroid/util/ArrayMap;
    ...
    invoke-direct {p0, v1}, ensureTagExists(Landroid/media/MediaRouter$RouteInfo;)V

    iget-object v2, p0, mRoutes:Landroid/util/ArrayMap;
...
.method public addCallback(Lcom/android/systemui/statusbar/policy/CastController$Callback;)V
    ...
    invoke-direct {p0, p1}, fireOnCastDevicesChanged(Lcom/android/systemui/statusbar/policy/CastController$Callback;)V

    iget-object p1, p0, mDiscoveringLock:Ljava/lang/Object;

    monitor-enter p1

    :try_start_1
    invoke-direct {p0}, handleDiscoveryChangeLocked()V
...
.method public bridge synthetic addCallback(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, addCallback(Lcom/android/systemui/statusbar/policy/CastController$Callback;)V
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-boolean p1, p0, mDiscovering:Z
    ...
    iget-boolean p1, p0, mCallbackRegistered:Z
    ...
    :try_start_0
    iget-object p3, p0, mCallbacks:Ljava/util/ArrayList;
    ...
    iget-object p1, p0, mRoutes:Landroid/util/ArrayMap;
    ...
    :goto_0
    iget-object p3, p0, mRoutes:Landroid/util/ArrayMap;
    ...
    invoke-static {p3}, routeToString(Landroid/media/MediaRouter$RouteInfo;)Ljava/lang/String;
    ...
    iget-object p0, p0, mProjection:Landroid/media/projection/MediaProjectionInfo;
...
.method fireOnCastDevicesChanged()V
    ...
    invoke-direct {p0, v2}, fireOnCastDevicesChanged(Lcom/android/systemui/statusbar/policy/CastController$Callback;)V
...
.method public getCastDevices()Ljava/util/List;
    ...
    iget-object v2, p0, mProjectionLock:Ljava/lang/Object;

    monitor-enter v2

    :try_start_1
    iget-object v1, p0, mProjection:Landroid/media/projection/MediaProjectionInfo;
    ...
    iget-object v3, p0, mProjection:Landroid/media/projection/MediaProjectionInfo;
...
.method public bridge synthetic removeCallback(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, removeCallback(Lcom/android/systemui/statusbar/policy/CastController$Callback;)V
...
.method public setCurrentUserId(I)V
    ...
    iget-object p0, p0, mMediaRouter:Landroid/media/MediaRouter;
...
.method public setDiscovering(Z)V
    ...
    iget-object v0, p0, mDiscoveringLock:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-boolean v1, p0, mDiscovering:Z
    ...
    :cond_0
    iput-boolean p1, p0, mDiscovering:Z
...
.method public startCasting(Lcom/android/systemui/statusbar/policy/CastController$CastDevice;)V
    ...
    invoke-static {p1}, routeToString(Landroid/media/MediaRouter$RouteInfo;)Ljava/lang/String;
...
.method public stopCasting(Lcom/android/systemui/statusbar/policy/CastController$CastDevice;)V
    ...
    iget-object v0, p0, mProjectionManager:Landroid/media/projection/MediaProjectionManager;
    ...
    iget-object p0, p0, mProjectionManager:Landroid/media/projection/MediaProjectionManager;
