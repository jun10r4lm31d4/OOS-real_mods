...
.method static constructor <clinit>()V
    ...
    sput-object v0, BOLD_STYLE:Landroid/text/style/StyleSpan;
...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0}, <init>(Landroid/os/Handler;)V
...
.method constructor <init>(Landroid/os/Handler;)V
    ...
    iput-object v0, p0, mCurrentTime:Ljava/util/Date;
    ...
    iput-object v0, p0, mUpdateNextAlarm:Landroid/app/AlarmManager$OnAlarmListener;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, mMediaToken:Ljava/lang/Object;
    ...
    iput-object p1, p0, mSliceUri:Landroid/net/Uri;
    ...
    iput-object p1, p0, mHeaderUri:Landroid/net/Uri;
    ...
    iput-object p1, p0, mDateUri:Landroid/net/Uri;
    ...
    iput-object p1, p0, mAlarmUri:Landroid/net/Uri;
    ...
    iput-object p1, p0, mDndUri:Landroid/net/Uri;
    ...
    iput-object p1, p0, mMediaUri:Landroid/net/Uri;

    new-instance p1, Ljava/util/HashSet;

    invoke-direct {p1}, Ljava/util/HashSet;-><init>()V

    iput-object p1, p0, mMediaInvisibleStates:Ljava/util/HashSet;

    iget-object p1, p0, mMediaInvisibleStates:Ljava/util/HashSet;
    ...
    iget-object p0, p0, mMediaInvisibleStates:Ljava/util/HashSet;
...
.method public static getAttachedInstance()Lcom/android/systemui/keyguard/KeyguardSliceProvider;
    ...
    sget-object v0, sInstance:Lcom/android/systemui/keyguard/KeyguardSliceProvider;
...
.method public static synthetic lambda$IhzByd8TsqFuOrSyuGurVskyPLo(Lcom/android/systemui/keyguard/KeyguardSliceProvider;)V
    ...
    invoke-direct {p0}, updateNextAlarm()V
...
.method private updateMediaStateLocked(Landroid/media/MediaMetadata;I)V
    ...
    iget-object v0, p0, mMediaInvisibleStates:Ljava/util/HashSet;
    ...
    :goto_1
    iget-boolean p1, p0, mMediaIsVisible:Z

    if-ne p2, p1, :cond_3

    iget-object p1, p0, mMediaTitle:Ljava/lang/CharSequence;
    ...
    iget-object p1, p0, mMediaArtist:Ljava/lang/CharSequence;
    ...
    :cond_3
    iput-object v1, p0, mMediaTitle:Ljava/lang/CharSequence;

    iput-object v0, p0, mMediaArtist:Ljava/lang/CharSequence;

    iput-boolean p2, p0, mMediaIsVisible:Z

    invoke-virtual {p0}, notifyChange()V
...
.method private updateNextAlarm()V
    ...
    :try_start_0
    iget-object v0, p0, mNextAlarmInfo:Landroid/app/AlarmManager$AlarmClockInfo;

    const/16 v1, 0xc

    invoke-direct {p0, v0, v1}, withinNHoursLocked(Landroid/app/AlarmManager$AlarmClockInfo;I)Z
    ...
    :goto_0
    iget-object v1, p0, mNextAlarmInfo:Landroid/app/AlarmManager$AlarmClockInfo;
    ...
    iput-object v0, p0, mNextAlarm:Ljava/lang/String;
...
.method private withinNHoursLocked(Landroid/app/AlarmManager$AlarmClockInfo;I)Z
    ...
    iget-object p0, p0, mNextAlarmInfo:Landroid/app/AlarmManager$AlarmClockInfo;
...
.method protected addMediaLocked(Landroidx/slice/builders/ListBuilder;)V
    ...
    iget-object v0, p0, mMediaTitle:Ljava/lang/CharSequence;
    ...
    iget-object v1, p0, mHeaderUri:Landroid/net/Uri;

    invoke-direct {v0, v1}, Landroidx/slice/builders/ListBuilder$HeaderBuilder;-><init>(Landroid/net/Uri;)V

    iget-object v1, p0, mMediaTitle:Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, mMediaArtist:Ljava/lang/CharSequence;
    ...
    iget-object v1, p0, mMediaUri:Landroid/net/Uri;

    invoke-direct {v0, v1}, Landroidx/slice/builders/ListBuilder$RowBuilder;-><init>(Landroid/net/Uri;)V

    iget-object v1, p0, mMediaArtist:Ljava/lang/CharSequence;
...
.method protected addNextAlarmLocked(Landroidx/slice/builders/ListBuilder;)V
    ...
    iget-object v0, p0, mNextAlarm:Ljava/lang/String;
...
.method protected addPrimaryActionLocked(Landroidx/slice/builders/ListBuilder;)V
    ...
    iget-object p0, p0, mLastText:Ljava/lang/String;
...
.method protected addZenModeLocked(Landroidx/slice/builders/ListBuilder;)V
    ...
    iget-object v1, p0, mDndUri:Landroid/net/Uri;
...
.method cleanDateFormatLocked()V
    ...
    iput-object v0, p0, mDateFormat:Landroid/icu/text/DateFormat;
...
.method protected getFormattedDateLocked()Ljava/lang/String;
    ...
    iget-object v0, p0, mDateFormat:Landroid/icu/text/DateFormat;
    ...
    iget-object v1, p0, mDatePattern:Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, p0, mCurrentTime:Ljava/util/Date;
    ...
    iget-object p0, p0, mCurrentTime:Ljava/util/Date;
...
.method public initDependencies(Lcom/android/systemui/statusbar/NotificationMediaManager;Lcom/android/systemui/plugins/statusbar/StatusBarStateController;)V
    ...
    iget-object p1, p0, mMediaManager:Lcom/android/systemui/statusbar/NotificationMediaManager;
    ...
    iput-object p2, p0, mStatusBarStateController:Lcom/android/systemui/plugins/statusbar/StatusBarStateController;
...
.method protected isDndOn()Z
    ...
    iget-object p0, p0, mZenModeController:Lcom/android/systemui/statusbar/policy/ZenModeController;
...
.method public synthetic lambda$onMetadataOrStateChanged$0$KeyguardSliceProvider(Landroid/media/MediaMetadata;I)V
    ...
    invoke-direct {p0, p1, p2}, updateMediaStateLocked(Landroid/media/MediaMetadata;I)V

    iget-object p0, p0, mMediaWakeLock:Lcom/android/systemui/util/wakelock/SettableWakeLock;
...
.method protected needsMediaLocked()Z
    ...
    iget-boolean v0, p0, mMediaIsVisible:Z
    ...
    :goto_0
    iget-object v3, p0, mMediaTitle:Ljava/lang/CharSequence;
    ...
    iget-boolean v3, p0, mMediaIsVisible:Z
...
.method protected notifyChange()V
    ...
    iget-object p0, p0, mSliceUri:Landroid/net/Uri;
...
.method public onBindSlice(Landroid/net/Uri;)Landroidx/slice/Slice;
    ...
    iget-object v1, p0, mSliceUri:Landroid/net/Uri;

    const-wide/16 v2, -0x1

    invoke-direct {p1, v0, v1, v2, v3}, Landroidx/slice/builders/ListBuilder;-><init>(Landroid/content/Context;Landroid/net/Uri;J)V

    invoke-virtual {p0}, needsMediaLocked()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0, p1}, addMediaLocked(Landroidx/slice/builders/ListBuilder;)V
    ...
    iget-object v1, p0, mDateUri:Landroid/net/Uri;

    invoke-direct {v0, v1}, Landroidx/slice/builders/ListBuilder$RowBuilder;-><init>(Landroid/net/Uri;)V

    iget-object v1, p0, mLastText:Ljava/lang/String;
    ...
    :goto_0
    invoke-virtual {p0, p1}, addNextAlarmLocked(Landroidx/slice/builders/ListBuilder;)V

    invoke-virtual {p0, p1}, addZenModeLocked(Landroidx/slice/builders/ListBuilder;)V

    invoke-virtual {p0, p1}, addPrimaryActionLocked(Landroidx/slice/builders/ListBuilder;)V
...
.method public onCreateSliceProvider()Z
    ...
    iput-object v0, p0, mNextAlarmController:Lcom/android/systemui/statusbar/policy/NextAlarmController;

    iget-object v0, p0, mNextAlarmController:Lcom/android/systemui/statusbar/policy/NextAlarmController;
    ...
    iput-object v0, p0, mZenModeController:Lcom/android/systemui/statusbar/policy/ZenModeController;

    iget-object v0, p0, mZenModeController:Lcom/android/systemui/statusbar/policy/ZenModeController;
    ...
    iput-object v0, p0, mDatePattern:Ljava/lang/String;
    ...
    iput-object v0, p0, mMediaWakeLock:Lcom/android/systemui/util/wakelock/SettableWakeLock;

    sput-object p0, sInstance:Lcom/android/systemui/keyguard/KeyguardSliceProvider;

    invoke-virtual {p0}, registerClockUpdate()V

    invoke-virtual {p0}, updateClockLocked()V
...
.method protected onDestroy()V
    ...
    iget-object v0, p0, mMediaWakeLock:Lcom/android/systemui/util/wakelock/SettableWakeLock;
    ...
    iget-object v2, p0, mUpdateNextAlarm:Landroid/app/AlarmManager$OnAlarmListener;
    ...
    invoke-virtual {p0}, getKeyguardUpdateMonitor()Lcom/android/keyguard/KeyguardUpdateMonitor;

    move-result-object v0

    iget-object v1, p0, mKeyguardUpdateMonitorCallback:Lcom/android/keyguard/KeyguardUpdateMonitorCallback;
...
.method public onMetadataOrStateChanged(Landroid/media/MediaMetadata;I)V
    ...
    iget-object v4, p0, mMediaToken:Ljava/lang/Object;
    ...
    iget-object p1, p0, mMediaToken:Ljava/lang/Object;
...
.method public onNextAlarmChanged(Landroid/app/AlarmManager$AlarmClockInfo;)V
    ...
    :try_start_0
    iput-object p1, p0, mNextAlarmInfo:Landroid/app/AlarmManager$AlarmClockInfo;

    iget-object p1, p0, mAlarmManager:Landroid/app/AlarmManager;

    iget-object v0, p0, mUpdateNextAlarm:Landroid/app/AlarmManager$OnAlarmListener;

    invoke-virtual {p1, v0}, Landroid/app/AlarmManager;->cancel(Landroid/app/AlarmManager$OnAlarmListener;)V

    iget-object p1, p0, mNextAlarmInfo:Landroid/app/AlarmManager$AlarmClockInfo;
    ...
    iget-object v7, p0, mUpdateNextAlarm:Landroid/app/AlarmManager$OnAlarmListener;
...
.method protected updateClockLocked()V
    ...
    invoke-virtual {p0}, getFormattedDateLocked()Ljava/lang/String;
    ...
    iput-object v0, p0, mLastText:Ljava/lang/String;
