...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/power/EnhancedEstimates;)V
    ...
    invoke-direct {p0, p1, p2, v0}, <init>(Landroid/content/Context;Lcom/android/systemui/power/EnhancedEstimates;Landroid/os/PowerManager;)V
...
.method constructor <init>(Landroid/content/Context;Lcom/android/systemui/power/EnhancedEstimates;Landroid/os/PowerManager;)V
    ...
    iput-object v0, p0, mFetchCallbacks:Ljava/util/ArrayList;

    const/4 v0, 0x0

    iput-boolean v0, p0, mTestmode:Z

    iput-boolean v0, p0, mHasReceivedBattery:Z

    iput-boolean v0, p0, mFetchingEstimate:Z

    iput v0, p0, mFastchargeType:I

    iput-boolean v0, p0, mShowPercent:Z
    ...
    iput-object v1, p0, mSettingObserver:Lcom/android/systemui/statusbar/policy/BatteryControllerImpl$SettingObserver;
    ...
    iput-object p2, p0, mEstimates:Lcom/android/systemui/power/EnhancedEstimates;

    invoke-direct {p0}, registerReceiver()V

    invoke-direct {p0}, updatePowerSave()V

    invoke-direct {p0}, updateEstimate()V
...
.method static synthetic access$000(Lcom/android/systemui/statusbar/policy/BatteryControllerImpl;)Z
    ...
    iget-boolean p0, p0, mTestmode:Z
...
.method static synthetic access$002(Lcom/android/systemui/statusbar/policy/BatteryControllerImpl;Z)Z
    ...
    iput-boolean p1, p0, mTestmode:Z
...
.method static synthetic access$300(Lcom/android/systemui/statusbar/policy/BatteryControllerImpl;)Z
    ...
    iget-boolean p0, p0, mShowPercent:Z
...
.method static synthetic access$302(Lcom/android/systemui/statusbar/policy/BatteryControllerImpl;Z)Z
    ...
    iput-boolean p1, p0, mShowPercent:Z
...
.method static synthetic access$600(Lcom/android/systemui/statusbar/policy/BatteryControllerImpl;)V
    ...
    invoke-direct {p0}, fireBatteryStylechange()V
...
.method static synthetic access$700(Lcom/android/systemui/statusbar/policy/BatteryControllerImpl;)V
    ...
    invoke-direct {p0}, fireOptimizatedStatusChange()V
...
.method private fireBatteryStylechange()V
    ...
    iget-object v0, p0, mChangeCallbacks:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, mChangeCallbacks:Ljava/util/ArrayList;
    ...
    iget-boolean v4, p0, mShowPercent:Z
    ...
    :try_start_1
    iget-object v3, p0, mChangeCallbacks:Ljava/util/ArrayList;
...
.method private fireOptimizatedStatusChange()V
    ...
    iget-boolean v4, p0, mIsOptimizatedCharge:Z
...
.method private firePowerSaveChanged()V
    ...
    iget-boolean v4, p0, mPowerSave:Z
...
.method private generateTimeRemainingString()Ljava/lang/String;
    ...
    iget-object v0, p0, mFetchCallbacks:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, mEstimate:Lcom/android/settingslib/fuelgauge/Estimate;
    ...
    iget-object p0, p0, mEstimate:Lcom/android/settingslib/fuelgauge/Estimate;
...
.method public static synthetic lambda$xVvPxv9usTpbGvWx3jH4_VH1nvI(Lcom/android/systemui/statusbar/policy/BatteryControllerImpl;)V
    ...
    invoke-direct {p0}, notifyEstimateFetchCallbacks()V
...
.method private notifyEstimateFetchCallbacks()V
    ...
    :try_start_0
    invoke-direct {p0}, generateTimeRemainingString()Ljava/lang/String;

    move-result-object v1

    iget-object v2, p0, mFetchCallbacks:Ljava/util/ArrayList;
    ...
    :cond_0
    iget-object p0, p0, mFetchCallbacks:Ljava/util/ArrayList;
...
.method private registerReceiver()V
    ...
    iget-object p0, p0, mSettingObserver:Lcom/android/systemui/statusbar/policy/BatteryControllerImpl$SettingObserver;
...
.method private setPowerSave(Z)V
    ...
    iget-boolean v0, p0, mPowerSave:Z
    ...
    :cond_0
    iput-boolean p1, p0, mPowerSave:Z
    ...
    iput-boolean p1, p0, mAodPowerSave:Z
    ...
    :cond_2
    invoke-direct {p0}, firePowerSaveChanged()V
...
.method private updateEstimate()V
    ...
    iput-object v0, p0, mEstimate:Lcom/android/settingslib/fuelgauge/Estimate;

    iget-object v0, p0, mEstimate:Lcom/android/settingslib/fuelgauge/Estimate;

    if-nez v0, :cond_0

    iget-object v0, p0, mEstimates:Lcom/android/systemui/power/EnhancedEstimates;
...
.method private updateEstimateInBackground()V
    ...
    iget-boolean v0, p0, mFetchingEstimate:Z
...
.method private updatePowerSave()V
    ...
    invoke-direct {p0, v0}, setPowerSave(Z)V
...
.method public addCallback(Lcom/android/systemui/statusbar/policy/BatteryController$BatteryStateChangeCallback;)V
    ...
    iget-boolean v0, p0, mHasReceivedBattery:Z
    ...
    iget-boolean v1, p0, mPluggedIn:Z
...
.method public bridge synthetic addCallback(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, addCallback(Lcom/android/systemui/statusbar/policy/BatteryController$BatteryStateChangeCallback;)V
...
.method public dispatchDemoCommand(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    iput-boolean p1, p0, mDemoMode:Z
    ...
    iput-boolean p1, p0, mPluggedIn:Z
    ...
    :cond_5
    invoke-virtual {p0}, fireBatteryLevelChanged()V
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-boolean p1, p0, mPluggedIn:Z
    ...
    iget-boolean p1, p0, mPowerSave:Z
    ...
    iget-boolean p1, p0, mShowPercent:Z
...
.method protected fireBatteryLevelChanged()V
    ...
    iget-boolean v1, p0, mShowPercent:Z
    ...
    iget-boolean v5, p0, mPluggedIn:Z

    iget-boolean v6, p0, mCharging:Z
...
.method public getEstimatedTimeRemainingString(Lcom/android/systemui/statusbar/policy/BatteryController$EstimateFetchCompletion;)V
    ...
    :try_start_0
    iget-object v1, p0, mFetchCallbacks:Ljava/util/ArrayList;
    ...
    invoke-direct {p0}, updateEstimateInBackground()V
...
.method public isAodPowerSave()Z
    ...
    iget-boolean p0, p0, mAodPowerSave:Z
...
.method public isPowerSave()Z
    ...
    iget-boolean p0, p0, mPowerSave:Z
...
.method public synthetic lambda$updateEstimateInBackground$0$BatteryControllerImpl()V
    ...
    :try_start_0
    iput-object v1, p0, mEstimate:Lcom/android/settingslib/fuelgauge/Estimate;

    iget-object v1, p0, mEstimates:Lcom/android/systemui/power/EnhancedEstimates;
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    iget-boolean p1, p0, mTestmode:Z
    ...
    :cond_0
    iget-boolean p1, p0, mHasReceivedBattery:Z

    xor-int/2addr p1, v2

    iput-boolean v2, p0, mHasReceivedBattery:Z
    ...
    :goto_0
    iput-boolean v0, p0, mPluggedIn:Z
    ...
    :goto_1
    iput-boolean v1, p0, mCharged:Z

    iget-boolean v1, p0, mCharged:Z
    ...
    invoke-direct {p0, p1}, setPowerSave(Z)V
    ...
    iput-boolean v2, p0, mTestmode:Z
...
.method public bridge synthetic removeCallback(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, removeCallback(Lcom/android/systemui/statusbar/policy/BatteryController$BatteryStateChangeCallback;)V
