...
.method private constructor <init>(Lcom/android/systemui/volume/ZenModePanel;)V
    ...
    iput v0, p0, mNoneDangerousThreshold:I
    ...
    invoke-direct {p0}, updateMinuteIndex()V

    invoke-direct {p0}, updateNoneSelected()V

    invoke-direct {p0}, updateConfirmedPriorityIntroduction()V

    invoke-direct {p0}, updateConfirmedSilenceIntroduction()V

    invoke-direct {p0}, updateConfirmedAlarmIntroduction()V
...
.method static synthetic access$300(Lcom/android/systemui/volume/ZenModePanel$ZenPrefs;)Z
    ...
    iget-boolean p0, p0, mConfirmedPriorityIntroduction:Z
...
.method static synthetic access$400(Lcom/android/systemui/volume/ZenModePanel$ZenPrefs;)Z
    ...
    iget-boolean p0, p0, mConfirmedSilenceIntroduction:Z
...
.method static synthetic access$500(Lcom/android/systemui/volume/ZenModePanel$ZenPrefs;)Z
    ...
    iget-boolean p0, p0, mConfirmedAlarmIntroduction:Z
...
.method private updateConfirmedAlarmIntroduction()V
    ...
    iget-boolean v1, p0, mConfirmedAlarmIntroduction:Z
    ...
    :cond_0
    iput-boolean v0, p0, mConfirmedAlarmIntroduction:Z
...
.method private updateConfirmedPriorityIntroduction()V
    ...
    iget-boolean v1, p0, mConfirmedPriorityIntroduction:Z
    ...
    :cond_0
    iput-boolean v0, p0, mConfirmedPriorityIntroduction:Z
...
.method private updateConfirmedSilenceIntroduction()V
    ...
    iget-boolean v1, p0, mConfirmedSilenceIntroduction:Z
    ...
    :cond_0
    iput-boolean v0, p0, mConfirmedSilenceIntroduction:Z
...
.method private updateMinuteIndex()V
    ...
    invoke-direct {p0, v0}, clampIndex(I)I

    move-result v0

    iput v0, p0, mMinuteIndex:I
...
.method private updateNoneSelected()V
    ...
    invoke-direct {p0, v0}, clampNoneSelected(I)I

    move-result v0

    iput v0, p0, mNoneSelected:I
...
.method public setMinuteIndex(I)V
    ...
    invoke-direct {p0, p1}, clampIndex(I)I

    move-result p1

    iget v0, p0, mMinuteIndex:I
    ...
    iget-object p1, p0, this$0:Lcom/android/systemui/volume/ZenModePanel;
...
.method public trackNoneSelected()V
    ...
    iget v2, p0, mNoneDangerousThreshold:I
