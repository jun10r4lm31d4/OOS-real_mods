...
.method static constructor <clinit>()V
    ...
    sput v0, MEASURE_SPEC_ANY_LENGTH:I
    ...
    sput-object v0, DECREASING_MEASURED_WIDTH_WITHOUT_PADDING_COMPARATOR:Ljava/util/Comparator;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-boolean v0, p0, mSmartRepliesGeneratedByAssistant:Z
    ...
    iput v1, p0, mHeightUpperLimit:I
    ...
    iput v1, p0, mCurrentBackgroundColor:I

    iget v1, p0, mCurrentBackgroundColor:I

    iput v1, p0, mDefaultBackgroundColor:I
    ...
    iput v1, p0, mDefaultTextColor:I
    ...
    iput v1, p0, mDefaultTextColorDarkBg:I
    ...
    iput v1, p0, mDefaultStrokeColor:I
    ...
    iput v1, p0, mRippleColor:I

    iget v1, p0, mRippleColor:I
    ...
    iput v1, p0, mRippleColorDarkBg:I

    iget v1, p0, mDefaultStrokeColor:I

    iget v2, p0, mDefaultBackgroundColor:I

    invoke-static {v1, v2}, Lcom/android/internal/util/ContrastColorUtil;->calculateContrast(II)D

    move-result-wide v1

    iput-wide v1, p0, mMinStrokeContrast:D
    ...
    iput v2, p0, mStrokeWidth:I

    iput v3, p0, mSpacing:I

    iput v4, p0, mSingleLineButtonPaddingHorizontal:I

    iput v5, p0, mDoubleLineButtonPaddingHorizontal:I

    sub-int/2addr v5, v4

    mul-int/lit8 v5, v5, 0x2

    iput v5, p0, mSingleToDoubleLineButtonWidthIncrease:I

    invoke-static {}, Ljava/text/BreakIterator;->getLineInstance()Ljava/text/BreakIterator;

    move-result-object p1

    iput-object p1, p0, mBreakIterator:Ljava/text/BreakIterator;

    invoke-direct {p0}, reallocateCandidateButtonQueueForSqueezing()V
...
.method private estimateOptimalSqueezedButtonTextWidth(Landroid/widget/Button;)I
    ...
    iget-object v2, p0, mBreakIterator:Ljava/text/BreakIterator;
    ...
    :goto_1
    sget-object v7, mConstants:Lcom/android/systemui/statusbar/policy/SmartReplyConstants;
    ...
    iget-object v9, p0, mBreakIterator:Ljava/text/BreakIterator;
...
.method private gotEnoughSmartReplies(Ljava/util/List;)Z
    ...
    sget-object p0, mConstants:Lcom/android/systemui/statusbar/policy/SmartReplyConstants;
...
.method public static inflate(Landroid/content/Context;)Lcom/android/systemui/statusbar/policy/SmartReplyView;
    ...
    sput-object v0, mConstants:Lcom/android/systemui/statusbar/policy/SmartReplyConstants;
    ...
    sput-object v0, mKeyguardDismissUtil:Lcom/android/systemui/statusbar/phone/KeyguardDismissUtil;
    ...
    sput-object v0, mRemoteInputManager:Lcom/android/systemui/statusbar/NotificationRemoteInputManager;
...
.method static inflateActionButton(Lcom/android/systemui/statusbar/policy/SmartReplyView;Landroid/content/Context;ILcom/android/systemui/statusbar/policy/SmartReplyView$SmartActions;Lcom/android/systemui/statusbar/SmartReplyController;Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;Lcom/android/systemui/statusbar/policy/HeadsUpManager;Z)Landroid/widget/Button;
    ...
    sget-object v1, mConstants:Lcom/android/systemui/statusbar/policy/SmartReplyConstants;
...
.method static inflateReplyButton(Lcom/android/systemui/statusbar/policy/SmartReplyView;Landroid/content/Context;ILcom/android/systemui/statusbar/policy/SmartReplyView$SmartReplies;Lcom/android/systemui/statusbar/SmartReplyController;Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;Z)Landroid/widget/Button;
    ...
    sget-object v2, mConstants:Lcom/android/systemui/statusbar/policy/SmartReplyConstants;
    ...
    iget v0, v9, mCurrentBackgroundColor:I

    iget v1, v9, mDefaultStrokeColor:I

    iget v2, v9, mDefaultTextColor:I

    iget v3, v9, mRippleColor:I

    iget v4, v9, mStrokeWidth:I
    ...
    invoke-static/range {p0 .. p5}, setButtonColors(Landroid/widget/Button;IIIII)V
...
.method static synthetic lambda$inflateActionButton$4(Lcom/android/systemui/statusbar/policy/SmartReplyView;Landroid/app/Notification$Action;Lcom/android/systemui/statusbar/SmartReplyController;Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;ILcom/android/systemui/statusbar/policy/SmartReplyView$SmartActions;Lcom/android/systemui/statusbar/policy/HeadsUpManager;Landroid/view/View;)V
    ...
    invoke-direct {p0}, getActivityStarter()Lcom/android/systemui/plugins/ActivityStarter;
...
.method static synthetic lambda$inflateReplyButton$1(Lcom/android/systemui/statusbar/policy/SmartReplyView;Lcom/android/systemui/statusbar/policy/SmartReplyView$SmartReplies;Ljava/lang/CharSequence;ILandroid/widget/Button;Lcom/android/systemui/statusbar/SmartReplyController;Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;Landroid/content/Context;)Z
    ...
    sget-object v4, mRemoteInputManager:Lcom/android/systemui/statusbar/NotificationRemoteInputManager;
    ...
    iget-object v0, v1, mSmartReplyContainer:Landroid/view/View;
...
.method static synthetic lambda$inflateReplyButton$2(Lcom/android/systemui/statusbar/policy/SmartReplyView;Lcom/android/systemui/plugins/ActivityStarter$OnDismissAction;Landroid/view/View;)V
    ...
    sget-object p0, mKeyguardDismissUtil:Lcom/android/systemui/statusbar/phone/KeyguardDismissUtil;
...
.method private reallocateCandidateButtonQueueForSqueezing()V
    ...
    sget-object v2, DECREASING_MEASURED_WIDTH_WITHOUT_PADDING_COMPARATOR:Ljava/util/Comparator;

    invoke-direct {v0, v1, v2}, Ljava/util/PriorityQueue;-><init>(ILjava/util/Comparator;)V

    iput-object v0, p0, mCandidateButtonQueueForSqueezing:Ljava/util/PriorityQueue;
...
.method private remeasureButtonsIfNecessary(II)V
    ...
    iget v5, p0, mSingleLineButtonPaddingHorizontal:I

    if-ne p1, v5, :cond_2

    iget v5, p0, mSingleToDoubleLineButtonWidthIncrease:I
...
.method private squeezeButton(Landroid/widget/Button;I)I
    ...
    invoke-direct {p0, p1}, estimateOptimalSqueezedButtonTextWidth(Landroid/widget/Button;)I
    ...
    :cond_0
    invoke-direct {p0, p1, p2, v0}, squeezeButtonToTextWidth(Landroid/widget/Button;II)I
...
.method private squeezeButtonToTextWidth(Landroid/widget/Button;II)I
    ...
    iget v2, p0, mDoubleLineButtonPaddingHorizontal:I

    if-eq v1, v2, :cond_0

    iget v1, p0, mSingleToDoubleLineButtonWidthIncrease:I

    add-int/2addr v0, v1

    :cond_0
    iget v1, p0, mDoubleLineButtonPaddingHorizontal:I

    invoke-virtual {p1}, Landroid/widget/Button;->getPaddingTop()I

    move-result v2

    iget v3, p0, mDoubleLineButtonPaddingHorizontal:I
    ...
    invoke-direct {p0, p1}, getLeftCompoundDrawableWidthWithPadding(Landroid/widget/Button;)I
...
.method protected bridge synthetic generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0}, generateDefaultLayoutParams()Lcom/android/systemui/statusbar/policy/SmartReplyView$LayoutParams;
...
.method public bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, generateLayoutParams(Landroid/util/AttributeSet;)Lcom/android/systemui/statusbar/policy/SmartReplyView$LayoutParams;
...
.method public getHeightUpperLimit()I
    ...
    iget p0, p0, mHeightUpperLimit:I
...
.method public inflateRepliesFromRemoteInput(Lcom/android/systemui/statusbar/policy/SmartReplyView$SmartReplies;Lcom/android/systemui/statusbar/SmartReplyController;Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;Z)Ljava/util/List;
    ...
    invoke-static/range {v2 .. v8}, inflateReplyButton(Lcom/android/systemui/statusbar/policy/SmartReplyView;Landroid/content/Context;ILcom/android/systemui/statusbar/policy/SmartReplyView$SmartReplies;Lcom/android/systemui/statusbar/SmartReplyController;Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;Z)Landroid/widget/Button;
    ...
    iput-boolean p1, p0, mSmartRepliesGeneratedByAssistant:Z
...
.method public inflateSmartActions(Lcom/android/systemui/statusbar/policy/SmartReplyView$SmartActions;Lcom/android/systemui/statusbar/SmartReplyController;Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;Lcom/android/systemui/statusbar/policy/HeadsUpManager;Z)Ljava/util/List;
    ...
    invoke-static/range {v0 .. v7}, inflateActionButton(Lcom/android/systemui/statusbar/policy/SmartReplyView;Landroid/content/Context;ILcom/android/systemui/statusbar/policy/SmartReplyView$SmartActions;Lcom/android/systemui/statusbar/SmartReplyController;Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;Lcom/android/systemui/statusbar/policy/HeadsUpManager;Z)Landroid/widget/Button;
...
.method protected onMeasure(II)V
    ...
    :goto_0
    invoke-direct/range {p0 .. p0}, resetButtonsLayoutParams()V

    iget-object v3, v0, mCandidateButtonQueueForSqueezing:Ljava/util/PriorityQueue;
    ...
    iget v5, v0, mSingleLineButtonPaddingHorizontal:I
    ...
    invoke-direct {v0, v4}, filterActionsOrReplies(Lcom/android/systemui/statusbar/policy/SmartReplyView$SmartButtonType;)Ljava/util/List;
    ...
    invoke-direct {v0, v5}, filterActionsOrReplies(Lcom/android/systemui/statusbar/policy/SmartReplyView$SmartButtonType;)Ljava/util/List;
    ...
    sget-object v9, mConstants:Lcom/android/systemui/statusbar/policy/SmartReplyConstants;
    ...
    sget v6, MEASURE_SPEC_ANY_LENGTH:I
    ...
    iget-object v10, v0, mCandidateButtonQueueForSqueezing:Ljava/util/PriorityQueue;
    ...
    iget v10, v0, mSingleLineButtonPaddingHorizontal:I
    ...
    iget v10, v0, mSingleToDoubleLineButtonWidthIncrease:I
    ...
    iget v6, v0, mDoubleLineButtonPaddingHorizontal:I
    ...
    iget-object v6, v0, mCandidateButtonQueueForSqueezing:Ljava/util/PriorityQueue;
    ...
    invoke-direct {v0, v6, v1}, squeezeButton(Landroid/widget/Button;I)I
    ...
    invoke-direct {v0, v6, v4}, markButtonsWithPendingSqueezeStatusAs(ILjava/util/List;)V
    ...
    :cond_f
    iget-boolean v2, v0, mSmartRepliesGeneratedByAssistant:Z

    if-eqz v2, :cond_11

    invoke-direct {v0, v5}, gotEnoughSmartReplies(Ljava/util/List;)Z
    ...
    :cond_11
    iget-object v2, v0, mCandidateButtonQueueForSqueezing:Ljava/util/PriorityQueue;
    ...
    invoke-direct {v0, v2, v3}, remeasureButtonsIfNecessary(II)V
    ...
    invoke-direct {v0, v4, v5}, setCornerRadius(Landroid/widget/Button;F)V
...
.method public resetSmartSuggestions(Landroid/view/View;)V
    ...
    iput-object p1, p0, mSmartReplyContainer:Landroid/view/View;

    invoke-virtual {p0}, Landroid/view/ViewGroup;->removeAllViews()V

    iget p1, p0, mDefaultBackgroundColor:I

    iput p1, p0, mCurrentBackgroundColor:I
...
.method public setBackgroundTintColor(I)V
    ...
    iget v0, p0, mCurrentBackgroundColor:I
    ...
    iget v1, p0, mDefaultTextColorDarkBg:I

    goto :goto_0

    :cond_1
    iget v1, p0, mDefaultTextColor:I
    ...
    iget v3, p0, mDefaultStrokeColor:I

    iget-wide v4, p0, mMinStrokeContrast:D
    ...
    iget v0, p0, mRippleColorDarkBg:I

    goto :goto_1

    :cond_2
    iget v0, p0, mRippleColor:I
    ...
    invoke-static/range {v3 .. v8}, setButtonColors(Landroid/widget/Button;IIIII)V
