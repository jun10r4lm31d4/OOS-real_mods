...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/biometrics/DialogViewCallback;Z)V
    ...
    iput-object v0, p0, mShowAnimationRunnable:Ljava/lang/Runnable;
    ...
    invoke-virtual {p0, p2}, needWrap(Lcom/android/systemui/biometrics/DialogViewCallback;)Lcom/android/systemui/biometrics/DialogViewCallback;

    move-result-object p2

    iput-object p2, p0, mCallback:Lcom/android/systemui/biometrics/DialogViewCallback;

    sget-object p2, Lcom/android/systemui/Interpolators;->LINEAR_OUT_SLOW_IN:Landroid/view/animation/Interpolator;

    iput-object p2, p0, mLinearOutSlowIn:Landroid/view/animation/Interpolator;
    ...
    iput p2, p0, mAnimationTranslationOffset:F
    ...
    iput-object p1, p0, mLayout:Landroid/view/ViewGroup;
    ...
    iget-object v3, p0, mLayout:Landroid/view/ViewGroup;
    ...
    iget-object v4, p0, mLayout:Landroid/view/ViewGroup;
    ...
    iput-object v4, p0, mDialog:Landroid/widget/LinearLayout;
    ...
    iput-object v4, p0, mTitleText:Landroid/widget/TextView;
    ...
    iput-object v4, p0, mSubtitleText:Landroid/widget/TextView;
    ...
    iput-object v4, p0, mDescriptionText:Landroid/widget/TextView;
    ...
    iput-object v4, p0, mBiometricIcon:Landroid/widget/ImageView;

    iget-object v4, p0, mLayout:Landroid/view/ViewGroup;

    invoke-direct {p0, v4, p2, v0, p3}, shouldAdjustForOpUIDesign(Landroid/view/ViewGroup;Landroid/util/DisplayMetrics;Landroid/util/DisplayMetrics;Z)V

    iget-object p2, p0, mLayout:Landroid/view/ViewGroup;
    ...
    iput-object p2, p0, mTryAgainButton:Landroid/widget/Button;
    ...
    iget-object p3, p0, mPositiveButton:Landroid/widget/Button;

    invoke-virtual {p3, p2}, Landroid/widget/Button;->setTextColor(I)V

    iget-object p3, p0, mNegativeButton:Landroid/widget/Button;

    invoke-virtual {p3, p2}, Landroid/widget/Button;->setTextColor(I)V

    iget-object p3, p0, mTryAgainButton:Landroid/widget/Button;

    invoke-virtual {p3, p2}, Landroid/widget/Button;->setTextColor(I)V

    iget-object p2, p0, mBiometricIcon:Landroid/widget/ImageView;

    invoke-virtual {p0}, Landroid/widget/LinearLayout;->getResources()Landroid/content/res/Resources;

    move-result-object p3

    invoke-virtual {p0}, getIconDescriptionResourceId()I
    ...
    invoke-direct {p0, p1}, setDismissesDialog(Landroid/view/View;)V

    invoke-direct {p0, v2}, setDismissesDialog(Landroid/view/View;)V

    invoke-direct {p0, v3}, setDismissesDialog(Landroid/view/View;)V

    iget-object p1, p0, mNegativeButton:Landroid/widget/Button;
    ...
    iget-object p1, p0, mPositiveButton:Landroid/widget/Button;
    ...
    iget-object p1, p0, mTryAgainButton:Landroid/widget/Button;
...
.method static synthetic access$000(Lcom/android/systemui/biometrics/BiometricDialogView;)Landroid/view/animation/Interpolator;
    ...
    iget-object p0, p0, mLinearOutSlowIn:Landroid/view/animation/Interpolator;
...
.method static synthetic access$300(Lcom/android/systemui/biometrics/BiometricDialogView;)F
    ...
    iget p0, p0, mAnimationTranslationOffset:F
...
.method private getFodIconBottomSpace(Landroid/util/DisplayMetrics;)I
    ...
    invoke-direct {p0}, getFodAnimationSize()F

    move-result v0

    invoke-direct {p0}, getFodIconSize()F
...
.method private shouldAdjustForOpUIDesign(Landroid/view/ViewGroup;Landroid/util/DisplayMetrics;Landroid/util/DisplayMetrics;Z)V
    ...
    invoke-direct {p0, p2}, getFodIconBottomSpace(Landroid/util/DisplayMetrics;)I
    ...
    iput-object v0, p0, mErrorText:Landroid/widget/TextView;

    iget-object v0, p0, mErrorText:Landroid/widget/TextView;
    ...
    iget-object v0, p0, mBiometricIcon:Landroid/widget/ImageView;
    ...
    iput-object p1, p0, mNegativeButton:Landroid/widget/Button;
    ...
    iput-object p1, p0, mPositiveButton:Landroid/widget/Button;
...
.method private updateFingerprintStatus()V
    ...
    iget-object v3, p0, mAuthenticatePkg:Ljava/lang/String;
    ...
    iget-object p0, p0, mAuthenticatePkg:Ljava/lang/String;
...
.method public forceRemove()V
    ...
    iput-boolean v0, p0, mWasForceRemoved:Z
...
.method public bridge synthetic getLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0}, getLayoutParams()Landroid/view/WindowManager$LayoutParams;
...
.method public getLayoutParams()Landroid/view/WindowManager$LayoutParams;
    ...
    iget-object p0, p0, mWindowToken:Landroid/os/IBinder;
...
.method public synthetic lambda$new$0$BiometricDialogView(Landroid/view/View;)V
    ...
    :cond_0
    iget-object p0, p0, mCallback:Lcom/android/systemui/biometrics/DialogViewCallback;
...
.method public synthetic lambda$new$2$BiometricDialogView(Landroid/view/View;)V
    ...
    invoke-virtual {p0, p1}, updateState(I)V
    ...
    invoke-virtual {p0}, getDelayAfterAuthenticatedDurationMs()I
...
.method public synthetic lambda$new$3$BiometricDialogView(Landroid/view/View;)V
    ...
    invoke-virtual {p0}, handleResetMessage()V
    ...
    invoke-virtual {p0, p1}, showTryAgainButton(Z)V
...
.method public synthetic lambda$setDismissesDialog$4$BiometricDialogView(Landroid/view/View;)V
    ...
    invoke-virtual {p0}, shouldGrayAreaDismissDialog()Z
...
.method public onAttachedToWindow()V
    ...
    iget-object v2, p0, mDevicePolicyManager:Landroid/app/admin/DevicePolicyManager;
    ...
    :goto_0
    iget-object v0, p0, mNegativeButton:Landroid/widget/Button;
    ...
    :cond_1
    iget-object v0, p0, mRestoredState:Landroid/os/Bundle;

    if-nez v0, :cond_2

    const/4 v0, 0x1

    invoke-virtual {p0, v0}, updateState(I)V

    iget-object v0, p0, mErrorText:Landroid/widget/TextView;

    invoke-virtual {p0}, getHintStringResourceId()I
    ...
    iput-object v0, p0, mAuthenticatePkg:Ljava/lang/String;
    ...
    iget-object v2, p0, mTitleText:Landroid/widget/TextView;
    ...
    iget-object v0, p0, mSubtitleText:Landroid/widget/TextView;
    ...
    :cond_3
    iget-object v2, p0, mSubtitleText:Landroid/widget/TextView;
    ...
    iget-object v0, p0, mDescriptionText:Landroid/widget/TextView;
    ...
    :cond_4
    iget-object v2, p0, mDescriptionText:Landroid/widget/TextView;
    ...
    iget-object v2, p0, mBundle:Landroid/os/Bundle;
    ...
    invoke-virtual {p0}, requiresConfirmation()Z
    ...
    iget-object v0, p0, mPositiveButton:Landroid/widget/Button;
    ...
    :cond_5
    iget-boolean v0, p0, mWasForceRemoved:Z

    const/4 v2, 0x0

    if-nez v0, :cond_7

    iget-boolean v0, p0, mSkipIntro:Z
    ...
    iget v3, p0, mAnimationTranslationOffset:F
    ...
    iget-object v0, p0, mShowAnimationRunnable:Ljava/lang/Runnable;
    ...
    invoke-virtual {p0}, onBiometricPromptReady()V

    :goto_5
    iput-boolean v1, p0, mWasForceRemoved:Z

    iput-boolean v1, p0, mSkipIntro:Z
...
.method public onAuthenticationFailed(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, showTemporaryMessage(Ljava/lang/String;)V
...
.method public onSaveState(Landroid/os/Bundle;)V
    ...
    iget-object v0, p0, mTryAgainButton:Landroid/widget/Button;
    ...
    iget-object p0, p0, mErrorText:Landroid/widget/TextView;
...
.method public onWindowFocusChanged(Z)V
    ...
    iget-boolean v1, p0, mAnimatingAway:Z
    ...
    iget-boolean v1, p0, mWasForceRemoved:Z
    ...
    iget-boolean v0, p0, mAnimatingAway:Z
    ...
    iput-boolean p1, p0, mPause:Z

    invoke-direct {p0}, updateFingerprintStatus()V
...
.method public requiresConfirmation()Z
    ...
    iget-boolean p0, p0, mRequireConfirmation:Z
...
.method public restoreState(Landroid/os/Bundle;)V
    ...
    iput-object p1, p0, mRestoredState:Landroid/os/Bundle;
...
.method public setBundle(Landroid/os/Bundle;)V
    ...
    iput-object p1, p0, mBundle:Landroid/os/Bundle;
...
.method public setRequireConfirmation(Z)V
    ...
    iput-boolean p1, p0, mRequireConfirmation:Z
...
.method public setSkipIntro(Z)V
    ...
    iput-boolean p1, p0, mSkipIntro:Z
...
.method public updateState(I)V
    ...
    iget-object v2, p0, mErrorText:Landroid/widget/TextView;

    invoke-virtual {v2, v1}, Landroid/widget/TextView;->setVisibility(I)V

    iget-object v2, p0, mPositiveButton:Landroid/widget/Button;
    ...
    iget-object v2, p0, mNegativeButton:Landroid/widget/Button;
    ...
    invoke-virtual {p0, v0, p1}, updateIcon(II)V
