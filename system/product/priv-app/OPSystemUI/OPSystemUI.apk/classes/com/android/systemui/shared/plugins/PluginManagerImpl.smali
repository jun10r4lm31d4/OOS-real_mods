...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/shared/plugins/PluginInitializer;)V
    ...
    invoke-direct/range {v0 .. v5}, <init>(Landroid/content/Context;Lcom/android/systemui/shared/plugins/PluginManagerImpl$PluginInstanceManagerFactory;ZLjava/lang/Thread$UncaughtExceptionHandler;Lcom/android/systemui/shared/plugins/PluginInitializer;)V
...
.method constructor <init>(Landroid/content/Context;Lcom/android/systemui/shared/plugins/PluginManagerImpl$PluginInstanceManagerFactory;ZLjava/lang/Thread$UncaughtExceptionHandler;Lcom/android/systemui/shared/plugins/PluginInitializer;)V
    ...
    iput-object v0, p0, mPluginMap:Landroid/util/ArrayMap;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, mClassLoaders:Ljava/util/Map;

    new-instance v0, Landroid/util/ArraySet;

    invoke-direct {v0}, Landroid/util/ArraySet;-><init>()V

    iput-object v0, p0, mOneShotPackages:Landroid/util/ArraySet;

    new-instance v0, Landroid/util/ArraySet;

    invoke-direct {v0}, Landroid/util/ArraySet;-><init>()V

    iput-object v0, p0, mWhitelistedPlugins:Landroid/util/ArraySet;

    iput-object p1, p0, mContext:Landroid/content/Context;

    iput-object p2, p0, mFactory:Lcom/android/systemui/shared/plugins/PluginManagerImpl$PluginInstanceManagerFactory;
    ...
    iput-boolean p3, p0, isDebuggable:Z

    iget-object p1, p0, mWhitelistedPlugins:Landroid/util/ArraySet;
    ...
    iput-object p1, p0, mPluginPrefs:Lcom/android/systemui/shared/plugins/PluginPrefs;
    ...
    iput-object p1, p0, mPluginEnabler:Lcom/android/systemui/shared/plugins/PluginEnabler;

    iput-object p5, p0, mPluginInitializer:Lcom/android/systemui/shared/plugins/PluginInitializer;
    ...
    iget-object p2, p0, mLooper:Landroid/os/Looper;
...
.method static synthetic access$100(Lcom/android/systemui/shared/plugins/PluginManagerImpl;)Landroid/util/ArrayMap;
    ...
    iget-object p0, p0, mPluginMap:Landroid/util/ArrayMap;
...
.method private clearClassLoader(Ljava/lang/String;)Z
    ...
    iget-object p0, p0, mClassLoaders:Ljava/util/Map;
...
.method private isPluginPackageWhitelisted(Ljava/lang/String;)Z
    ...
    iget-object p0, p0, mWhitelistedPlugins:Landroid/util/ArraySet;
...
.method private stopListening()V
    ...
    iget-boolean v0, p0, mHasOneShot:Z
...
.method public addPluginListener(Lcom/android/systemui/plugins/PluginListener;Ljava/lang/Class;)V
    ...
    invoke-virtual {p0, p1, p2, v0}, addPluginListener(Lcom/android/systemui/plugins/PluginListener;Ljava/lang/Class;Z)V
...
.method public addPluginListener(Lcom/android/systemui/plugins/PluginListener;Ljava/lang/Class;Z)V
    ...
    invoke-virtual {p0, v0, p1, p2, p3}, addPluginListener(Ljava/lang/String;Lcom/android/systemui/plugins/PluginListener;Ljava/lang/Class;Z)V
...
.method public addPluginListener(Ljava/lang/String;Lcom/android/systemui/plugins/PluginListener;Ljava/lang/Class;)V
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, addPluginListener(Ljava/lang/String;Lcom/android/systemui/plugins/PluginListener;Ljava/lang/Class;Z)V
...
.method public addPluginListener(Ljava/lang/String;Lcom/android/systemui/plugins/PluginListener;Ljava/lang/Class;Z)V
    ...
    iget-object v0, p0, mPluginPrefs:Lcom/android/systemui/shared/plugins/PluginPrefs;

    invoke-virtual {v0, p1}, Lcom/android/systemui/shared/plugins/PluginPrefs;->addAction(Ljava/lang/String;)V

    iget-object v1, p0, mFactory:Lcom/android/systemui/shared/plugins/PluginManagerImpl$PluginInstanceManagerFactory;
    ...
    iget-object p3, p0, mPluginMap:Landroid/util/ArrayMap;
...
.method public dependsOn(Lcom/android/systemui/plugins/Plugin;Ljava/lang/Class;)Z
    ...
    :goto_0
    iget-object v2, p0, mPluginMap:Landroid/util/ArrayMap;
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v0, p0, mPluginMap:Landroid/util/ArrayMap;
    ...
    iget-object v3, p0, mPluginMap:Landroid/util/ArrayMap;
...
.method public getClassLoader(Landroid/content/pm/ApplicationInfo;)Ljava/lang/ClassLoader;
    ...
    iget-boolean v0, p0, isDebuggable:Z
    ...
    invoke-direct {p0, v0}, isPluginPackageWhitelisted(Ljava/lang/String;)Z
    ...
    :cond_0
    iget-object v0, p0, mClassLoaders:Ljava/util/Map;
    ...
    invoke-virtual {p0}, getParentClassLoader()Ljava/lang/ClassLoader;
...
.method getParentClassLoader()Ljava/lang/ClassLoader;
    ...
    iget-object v0, p0, mParentClassLoader:Lcom/android/systemui/shared/plugins/PluginManagerImpl$ClassLoaderFilter;
    ...
    iput-object v0, p0, mParentClassLoader:Lcom/android/systemui/shared/plugins/PluginManagerImpl$ClassLoaderFilter;

    :cond_0
    iget-object p0, p0, mParentClassLoader:Lcom/android/systemui/shared/plugins/PluginManagerImpl$ClassLoaderFilter;
...
.method public getPluginEnabler()Lcom/android/systemui/shared/plugins/PluginEnabler;
    ...
    iget-object p0, p0, mPluginEnabler:Lcom/android/systemui/shared/plugins/PluginEnabler;
...
.method public handleWtfs()V
    ...
    iget-object p0, p0, mPluginInitializer:Lcom/android/systemui/shared/plugins/PluginInitializer;
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-direct {p0, p1}, isPluginWhitelisted(Landroid/content/ComponentName;)Z
    ...
    :cond_1
    invoke-virtual {p0}, getPluginEnabler()Lcom/android/systemui/shared/plugins/PluginEnabler;
    ...
    iget-object v3, p0, mOneShotPackages:Landroid/util/ArraySet;
    ...
    :cond_3
    invoke-direct {p0, p1}, clearClassLoader(Ljava/lang/String;)Z
...
.method public removePluginListener(Lcom/android/systemui/plugins/PluginListener;)V
    ...
    iget-object p1, p0, mPluginMap:Landroid/util/ArrayMap;
