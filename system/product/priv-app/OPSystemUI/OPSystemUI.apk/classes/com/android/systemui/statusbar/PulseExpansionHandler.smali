...
.method static constructor <clinit>()V
    ...
    sput-object v0, Companion:Lcom/android/systemui/statusbar/PulseExpansionHandler$Companion;

    const/high16 v0, 0x3e800000    # 0.25f

    sput v0, RUBBERBAND_FACTOR_STATIC:F

    const/16 v0, 0x177

    sput v0, SPRING_BACK_ANIMATION_LENGTH_MS:I
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/statusbar/notification/NotificationWakeUpCoordinator;)V
    ...
    iput-object p2, p0, mWakeUpCoordinator:Lcom/android/systemui/statusbar/notification/NotificationWakeUpCoordinator;

    const/4 p2, 0x2

    new-array p2, p2, [I

    iput-object p2, p0, mTemp2:[I
...
.method public static final synthetic access$setEmptyDragAmount(Lcom/android/systemui/statusbar/PulseExpansionHandler;F)V
    ...
    invoke-direct {p0, p1}, setEmptyDragAmount(F)V
...
.method public static final synthetic access$setUserLocked(Lcom/android/systemui/statusbar/PulseExpansionHandler;Lcom/android/systemui/statusbar/notification/row/ExpandableView;Z)V
    ...
    invoke-direct {p0, p1, p2}, setUserLocked(Lcom/android/systemui/statusbar/notification/row/ExpandableView;Z)V
...
.method private final cancelExpansion()V
    ...
    iget-object v0, p0, mStartingChild:Lcom/android/systemui/statusbar/notification/row/ExpandableView;
    ...
    invoke-direct {p0, v0}, reset(Lcom/android/systemui/statusbar/notification/row/ExpandableView;)V

    iput-object v1, p0, mStartingChild:Lcom/android/systemui/statusbar/notification/row/ExpandableView;
    ...
    iput-boolean v2, p0, isExpanding:Z
...
.method private final captureStartingChild(FF)V
    ...
    invoke-direct {p0, p1, p2}, findView(FF)Lcom/android/systemui/statusbar/notification/row/ExpandableView;

    move-result-object p1

    iput-object p1, p0, mStartingChild:Lcom/android/systemui/statusbar/notification/row/ExpandableView;

    iget-object p1, p0, mStartingChild:Lcom/android/systemui/statusbar/notification/row/ExpandableView;
...
.method private final finishExpansion()V
    ...
    invoke-direct {p0, v0, v1}, setUserLocked(Lcom/android/systemui/statusbar/notification/row/ExpandableView;Z)V

    iput-object v2, p0, mStartingChild:Lcom/android/systemui/statusbar/notification/row/ExpandableView;
    ...
    :cond_1
    :goto_0
    iput-boolean v1, p0, isExpanding:Z

    const/4 v0, 0x1

    iput-boolean v0, p0, isWakingToShadeLocked:Z

    iget-object v1, p0, mWakeUpCoordinator:Lcom/android/systemui/statusbar/notification/NotificationWakeUpCoordinator;
    ...
    iget-object v3, p0, mStartingChild:Lcom/android/systemui/statusbar/notification/row/ExpandableView;

    invoke-interface {v1, v3}, Lcom/android/systemui/statusbar/phone/ShadeController;->goToLockedShade(Landroid/view/View;)V

    iget-object p0, p0, mStartingChild:Lcom/android/systemui/statusbar/notification/row/ExpandableView;
...
.method private final maybeStartExpansion(Landroid/view/MotionEvent;)Z
    ...
    iput-boolean p1, p0, isExpanding:Z

    iget v3, p0, mInitialTouchX:F

    iget v4, p0, mInitialTouchY:F

    invoke-direct {p0, v3, v4}, captureStartingChild(FF)V
    ...
    iput v0, p0, mWakeUpHeight:F

    iput-boolean v1, p0, mReachedWakeUpHeight:Z

    return p1

    :cond_2
    iput-boolean v1, p0, mDraggedFarEnough:Z
...
.method private final reset(Lcom/android/systemui/statusbar/notification/row/ExpandableView;)V
    ...
    invoke-direct {p0, p1, v2}, setUserLocked(Lcom/android/systemui/statusbar/notification/row/ExpandableView;Z)V
    ...
    sget v1, SPRING_BACK_ANIMATION_LENGTH_MS:I
...
.method private final setEmptyDragAmount(F)V
    ...
    iget-object p0, p0, mExpansionCallback:Lcom/android/systemui/statusbar/PulseExpansionHandler$ExpansionCallback;
...
.method private final updateExpansionHeight(F)V
    ...
    iget-boolean v2, p0, mReachedWakeUpHeight:Z

    const/4 v3, 0x1

    if-nez v2, :cond_0

    iget v2, p0, mWakeUpHeight:F

    cmpl-float v2, p1, v2

    if-lez v2, :cond_0

    iput-boolean v3, p0, mReachedWakeUpHeight:Z

    :cond_0
    iget-object v2, p0, mStartingChild:Lcom/android/systemui/statusbar/notification/row/ExpandableView;
    ...
    iget v0, p0, mWakeUpHeight:F

    :cond_3
    iget-object v2, p0, mWakeUpCoordinator:Lcom/android/systemui/statusbar/notification/NotificationWakeUpCoordinator;
    ...
    sget v0, RUBBERBAND_FACTOR_STATIC:F
...
.method public final isWakingToShadeLocked()Z
    ...
    iget-boolean p0, p0, isWakingToShadeLocked:Z
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-direct {p0, p1}, maybeStartExpansion(Landroid/view/MotionEvent;)Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v0, p0, isExpanding:Z
    ...
    :cond_1
    invoke-direct {p0}, cancelExpansion()V
    ...
    invoke-direct {p0, v0}, updateExpansionHeight(F)V
    ...
    invoke-direct {p0}, finishExpansion()V
    ...
    :goto_0
    iget-boolean p0, p0, isExpanding:Z
...
.method public final setUp(Lcom/android/systemui/statusbar/notification/stack/NotificationStackScrollLayout;Lcom/android/systemui/statusbar/PulseExpansionHandler$ExpansionCallback;Lcom/android/systemui/statusbar/phone/ShadeController;)V
    ...
    iput-object p2, p0, mExpansionCallback:Lcom/android/systemui/statusbar/PulseExpansionHandler$ExpansionCallback;

    iput-object p3, p0, mShadeController:Lcom/android/systemui/statusbar/phone/ShadeController;

    iput-object p1, p0, mStackScroller:Lcom/android/systemui/statusbar/notification/stack/NotificationStackScrollLayout;
