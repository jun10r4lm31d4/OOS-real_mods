...
.method static constructor <clinit>()V
    ...
    sput-object v0, RECT_EVALUATOR:Landroid/animation/RectEvaluator;
...
.method public constructor <init>(Landroid/content/Context;Landroid/app/IActivityManager;Landroid/app/IActivityTaskManager;Lcom/android/systemui/pip/phone/PipMenuActivityController;Lcom/android/internal/policy/PipSnapAlgorithm;Lcom/android/systemui/statusbar/FlingAnimationUtils;)V
    ...
    iput-object v0, p0, mBoundsAnimator:Landroid/animation/ValueAnimator;
    ...
    iput-object p5, p0, mSnapAlgorithm:Lcom/android/internal/policy/PipSnapAlgorithm;

    iput-object p6, p0, mFlingAnimationUtils:Lcom/android/systemui/statusbar/FlingAnimationUtils;

    new-instance p1, Landroid/animation/AnimationHandler;

    invoke-direct {p1}, Landroid/animation/AnimationHandler;-><init>()V

    iput-object p1, p0, mAnimationHandler:Landroid/animation/AnimationHandler;

    iget-object p1, p0, mAnimationHandler:Landroid/animation/AnimationHandler;
    ...
    invoke-virtual {p0}, onConfigurationChanged()V
...
.method static synthetic access$000(Lcom/android/systemui/pip/phone/PipMotionHelper;)Landroid/animation/AnimationHandler;
    ...
    iget-object p0, p0, mAnimationHandler:Landroid/animation/AnimationHandler;
...
.method private createAnimationToBounds(Landroid/graphics/Rect;Landroid/graphics/Rect;ILandroid/view/animation/Interpolator;)Landroid/animation/ValueAnimator;
    ...
    sget-object p1, RECT_EVALUATOR:Landroid/animation/RectEvaluator;
...
.method animateDismiss(Landroid/graphics/Rect;FFLandroid/animation/ValueAnimator$AnimatorUpdateListener;)Landroid/graphics/Rect;
    ...
    invoke-virtual {p0}, cancelAnimations()V

    invoke-static {p2, p3}, Landroid/graphics/PointF;->length(FF)F

    move-result v0

    iget-object v1, p0, mFlingAnimationUtils:Lcom/android/systemui/statusbar/FlingAnimationUtils;
    ...
    :goto_0
    invoke-direct {p0, p1, p2, p3, v1}, getDismissEndPoint(Landroid/graphics/Rect;FFZ)Landroid/graphics/Point;
    ...
    iget-object p1, p0, mBounds:Landroid/graphics/Rect;

    const/16 p2, 0xaf

    sget-object v2, Lcom/android/systemui/Interpolators;->FAST_OUT_LINEAR_IN:Landroid/view/animation/Interpolator;

    invoke-direct {p0, p1, p3, p2, v2}, createAnimationToBounds(Landroid/graphics/Rect;Landroid/graphics/Rect;ILandroid/view/animation/Interpolator;)Landroid/animation/ValueAnimator;

    move-result-object p1

    iput-object p1, p0, mBoundsAnimator:Landroid/animation/ValueAnimator;

    iget-object p1, p0, mBoundsAnimator:Landroid/animation/ValueAnimator;
    ...
    iget-object p2, p0, mBoundsAnimator:Landroid/animation/ValueAnimator;

    const/4 v1, 0x0

    iget-object v2, p0, mBounds:Landroid/graphics/Rect;

    invoke-direct {p0, v2, p3}, distanceBetweenRectOffsets(Landroid/graphics/Rect;Landroid/graphics/Rect;)F
    ...
    :cond_2
    iget-object p0, p0, mBoundsAnimator:Landroid/animation/ValueAnimator;
...
.method animateToClosestMinimizedState(Landroid/graphics/Rect;Landroid/animation/ValueAnimator$AnimatorUpdateListener;)Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, v0, p1}, getClosestMinimizedBounds(Landroid/graphics/Rect;Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    invoke-direct {p0, v0, p1, v1, v2}, createAnimationToBounds(Landroid/graphics/Rect;Landroid/graphics/Rect;ILandroid/view/animation/Interpolator;)Landroid/animation/ValueAnimator;
    ...
    iget-object v0, p0, mBoundsAnimator:Landroid/animation/ValueAnimator;
...
.method animateToClosestSnapTarget(Landroid/graphics/Rect;Landroid/animation/ValueAnimator$AnimatorUpdateListener;Landroid/animation/Animator$AnimatorListener;)Landroid/graphics/Rect;
    ...
    iget-object v0, p0, mSnapAlgorithm:Lcom/android/internal/policy/PipSnapAlgorithm;
...
.method animateToExpandedState(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)F
    ...
    invoke-direct {p0, p1, p3}, resizeAndAnimatePipUnchecked(Landroid/graphics/Rect;I)V
...
.method animateToOffset(Landroid/graphics/Rect;I)V
    ...
    invoke-direct {p0, p1, p2, v0}, adjustAndAnimatePipOffset(Landroid/graphics/Rect;II)V
...
.method animateToUnexpandedState(Landroid/graphics/Rect;FLandroid/graphics/Rect;Landroid/graphics/Rect;ZZ)V
    ...
    :cond_0
    iget-object p4, p0, mSnapAlgorithm:Lcom/android/internal/policy/PipSnapAlgorithm;
    ...
    invoke-virtual {p0, p1, p3}, getClosestMinimizedBounds(Landroid/graphics/Rect;Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, p1}, movePip(Landroid/graphics/Rect;)V
    ...
    invoke-direct {p0, p1, p2}, resizeAndAnimatePipUnchecked(Landroid/graphics/Rect;I)V
...
.method expandPip()V
    ...
    invoke-virtual {p0, v0}, expandPip(Z)V
...
.method flingToSnapTarget(FFFLandroid/graphics/Rect;Landroid/animation/ValueAnimator$AnimatorUpdateListener;Landroid/animation/Animator$AnimatorListener;Landroid/graphics/Point;)Landroid/graphics/Rect;
    ...
    iget-object p3, p0, mBounds:Landroid/graphics/Rect;
    ...
    invoke-direct {p0, p3, p2, p4, p7}, createAnimationToBounds(Landroid/graphics/Rect;Landroid/graphics/Rect;ILandroid/view/animation/Interpolator;)Landroid/animation/ValueAnimator;

    move-result-object p3

    iput-object p3, p0, mBoundsAnimator:Landroid/animation/ValueAnimator;

    iget-object p3, p0, mFlingAnimationUtils:Lcom/android/systemui/statusbar/FlingAnimationUtils;

    iget-object p4, p0, mBoundsAnimator:Landroid/animation/ValueAnimator;

    const/4 p7, 0x0

    iget-object v0, p0, mBounds:Landroid/graphics/Rect;

    invoke-direct {p0, v0, p2}, distanceBetweenRectOffsets(Landroid/graphics/Rect;Landroid/graphics/Rect;)F
...
.method getBounds()Landroid/graphics/Rect;
    ...
    iget-object p0, p0, mBounds:Landroid/graphics/Rect;
...
.method getClosestMinimizedBounds(Landroid/graphics/Rect;Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    iget-object v1, p0, mSnapAlgorithm:Lcom/android/internal/policy/PipSnapAlgorithm;
...
.method public handleMessage(Landroid/os/Message;)Z
    ...
    :cond_1
    iget-object v5, p0, mActivityTaskManager:Landroid/app/IActivityTaskManager;
...
.method public synthetic lambda$createAnimationToBounds$2$PipMotionHelper(Landroid/animation/ValueAnimator;)V
    ...
    invoke-direct {p0, p1}, resizePipUnchecked(Landroid/graphics/Rect;)V
