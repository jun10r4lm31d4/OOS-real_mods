...
.method public constructor <init>(I)V
    ...
    iput-object v0, p0, mIconMatrix:Landroid/graphics/Matrix;

    const/4 v0, 0x0

    iput v0, p0, mPadding:F
    ...
    iput-boolean v1, p0, mInvalidated:Z

    const/4 v2, 0x0

    iput-object v2, p0, mTintColor:Landroid/content/res/ColorStateList;

    sget-object v3, Landroid/graphics/PorterDuff$Mode;->SRC_ATOP:Landroid/graphics/PorterDuff$Mode;

    iput-object v3, p0, mTintMode:Landroid/graphics/PorterDuff$Mode;

    iput-object v2, p0, mFrameColor:Landroid/content/res/ColorStateList;

    iget-object v3, p0, mIconPaint:Landroid/graphics/Paint;
    ...
    invoke-virtual {p0, p1}, setIntrinsicSize(I)V

    :cond_0
    invoke-virtual {p0, v2}, setIcon(Landroid/graphics/Bitmap;)Lcom/android/settingslib/drawable/UserIconDrawable;
...
.method private initFramePaint()V
    ...
    iget-object p0, p0, mFramePaint:Landroid/graphics/Paint;
...
.method private rebake()V
    ...
    iget-object v1, p0, mUserDrawable:Landroid/graphics/drawable/Drawable;

    if-nez v1, :cond_0

    iget-object v1, p0, mUserIcon:Landroid/graphics/Bitmap;
    ...
    iget-object v2, p0, mUserDrawable:Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    iget-object v2, p0, mUserIcon:Landroid/graphics/Bitmap;
    ...
    iget-object v4, p0, mIconMatrix:Landroid/graphics/Matrix;

    invoke-virtual {v1, v4}, Landroid/graphics/Canvas;->concat(Landroid/graphics/Matrix;)V

    iget-object v4, p0, mUserIcon:Landroid/graphics/Bitmap;
    ...
    iget-object v5, p0, mUserIcon:Landroid/graphics/Bitmap;
    ...
    iget v6, p0, mIntrinsicRadius:F

    iget-object v7, p0, mIconPaint:Landroid/graphics/Paint;
    ...
    :cond_2
    :goto_0
    iget-object v2, p0, mFrameColor:Landroid/content/res/ColorStateList;

    if-eqz v2, :cond_3

    iget-object v4, p0, mFramePaint:Landroid/graphics/Paint;
    ...
    :cond_3
    iget v0, p0, mFrameWidth:F

    iget v2, p0, mFramePadding:F
    ...
    iget v2, p0, mDisplayRadius:F

    iget v5, p0, mPadding:F
    ...
    iget-object v6, p0, mFramePaint:Landroid/graphics/Paint;
    ...
    iget-object v5, p0, mBadge:Landroid/graphics/drawable/Drawable;
    ...
    iget v3, p0, mBadgeMargin:F

    add-float/2addr v0, v3

    iget v3, p0, mBadgeRadius:F

    add-float/2addr v4, v3

    add-float/2addr v2, v3

    iget-object v3, p0, mClearPaint:Landroid/graphics/Paint;

    invoke-virtual {v1, v4, v2, v0, v3}, Landroid/graphics/Canvas;->drawCircle(FFFLandroid/graphics/Paint;)V

    iget-object p0, p0, mBadge:Landroid/graphics/drawable/Drawable;
...
.method public bake()Lcom/android/settingslib/drawable/UserIconDrawable;
    ...
    invoke-virtual {p0, v1}, onBoundsChange(Landroid/graphics/Rect;)V

    invoke-direct {p0}, rebake()V

    const/4 v0, 0x0

    iput-object v0, p0, mFrameColor:Landroid/content/res/ColorStateList;

    iput-object v0, p0, mFramePaint:Landroid/graphics/Paint;

    iput-object v0, p0, mClearPaint:Landroid/graphics/Paint;
    ...
    iput-object v0, p0, mUserDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, mUserIcon:Landroid/graphics/Bitmap;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v0, p0, mInvalidated:Z
    ...
    iget-object v0, p0, mTintColor:Landroid/content/res/ColorStateList;
    ...
    iget-object v2, p0, mTintColor:Landroid/content/res/ColorStateList;
    ...
    invoke-direct {p0, v0, v1}, shouldUpdateColorFilter(ILandroid/graphics/PorterDuff$Mode;)Z
    ...
    iget-object v3, p0, mTintMode:Landroid/graphics/PorterDuff$Mode;
...
.method public getConstantState()Landroid/graphics/drawable/Drawable$ConstantState;
    ...
    iget-object p0, p0, mBitmap:Landroid/graphics/Bitmap;
...
.method public getIntrinsicHeight()I
    ...
    invoke-virtual {p0}, getIntrinsicWidth()I
...
.method public isStateful()Z
    ...
    iget-object p0, p0, mFrameColor:Landroid/content/res/ColorStateList;
...
.method protected onBoundsChange(Landroid/graphics/Rect;)V
    ...
    iget-object v0, p0, mUserIcon:Landroid/graphics/Bitmap;

    if-nez v0, :cond_0

    iget-object v0, p0, mUserDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, mBitmap:Landroid/graphics/Bitmap;
    ...
    iget v0, p0, mDisplayRadius:F

    iget v2, p0, mFrameWidth:F
    ...
    iget-object p1, p0, mUserDrawable:Landroid/graphics/drawable/Drawable;
    ...
    :cond_4
    iget-object p1, p0, mUserIcon:Landroid/graphics/Bitmap;
    ...
    iput v1, p0, mIntrinsicRadius:F

    new-instance v1, Landroid/graphics/RectF;

    iget v3, p0, mIntrinsicRadius:F
    ...
    iget-object p1, p0, mIconMatrix:Landroid/graphics/Matrix;
...
.method public setBadge(Landroid/graphics/drawable/Drawable;)Lcom/android/settingslib/drawable/UserIconDrawable;
    ...
    iput-object p1, p0, mBadge:Landroid/graphics/drawable/Drawable;

    iget-object p1, p0, mBadge:Landroid/graphics/drawable/Drawable;

    if-eqz p1, :cond_1

    iget-object p1, p0, mClearPaint:Landroid/graphics/Paint;
    ...
    iput-object p1, p0, mClearPaint:Landroid/graphics/Paint;
    ...
    invoke-virtual {p0, p1}, onBoundsChange(Landroid/graphics/Rect;)V
...
.method public setBadgeIfManagedUser(Landroid/content/Context;I)Lcom/android/settingslib/drawable/UserIconDrawable;
    ...
    invoke-static {p1, p2}, getDrawableForDisplayDensity(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :goto_1
    invoke-virtual {p0, p1}, setBadge(Landroid/graphics/drawable/Drawable;)Lcom/android/settingslib/drawable/UserIconDrawable;
...
.method public setFrameColor(Landroid/content/res/ColorStateList;)V
    ...
    invoke-direct {p0}, initFramePaint()V

    iput-object p1, p0, mFrameColor:Landroid/content/res/ColorStateList;
...
.method public setIcon(Landroid/graphics/Bitmap;)Lcom/android/settingslib/drawable/UserIconDrawable;
    ...
    iput-object v1, p0, mUserDrawable:Landroid/graphics/drawable/Drawable;

    :cond_0
    iput-object p1, p0, mUserIcon:Landroid/graphics/Bitmap;

    iget-object v0, p0, mUserIcon:Landroid/graphics/Bitmap;

    if-nez v0, :cond_1

    iget-object p1, p0, mIconPaint:Landroid/graphics/Paint;

    invoke-virtual {p1, v1}, Landroid/graphics/Paint;->setShader(Landroid/graphics/Shader;)Landroid/graphics/Shader;

    iput-object v1, p0, mBitmap:Landroid/graphics/Bitmap;

    goto :goto_0

    :cond_1
    iget-object v0, p0, mIconPaint:Landroid/graphics/Paint;
...
.method public setIconDrawable(Landroid/graphics/drawable/Drawable;)Lcom/android/settingslib/drawable/UserIconDrawable;
    ...
    :cond_0
    iput-object v1, p0, mUserIcon:Landroid/graphics/Bitmap;

    iput-object p1, p0, mUserDrawable:Landroid/graphics/drawable/Drawable;
...
.method public setTintList(Landroid/content/res/ColorStateList;)V
    ...
    iput-object p1, p0, mTintColor:Landroid/content/res/ColorStateList;
