...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/CharSequence;ZZ)V
    ...
    iput-object v0, p0, mCallback:Lcom/android/keyguard/KeyguardUpdateMonitorCallback;

    const/4 v0, -0x1

    iput v0, p0, mActiveMobileDataSubscription:I
    ...
    iput-boolean v0, p0, mIsEmergencyCallCapable:Z

    iput-boolean p3, p0, mShowAirplaneMode:Z

    iput-boolean p4, p0, mShowMissingSim:Z
    ...
    iput-object p2, p0, mSeparator:Ljava/lang/CharSequence;
    ...
    iput p1, p0, mSimSlotsNumber:I

    iget p1, p0, mSimSlotsNumber:I

    new-array p1, p1, [Z

    iput-object p1, p0, mSimErrorState:[Z
    ...
    invoke-virtual {p0, p1}, updateDisplayOpportunisticSubscriptionCarrierText(Z)V
...
.method static synthetic access$000(Lcom/android/keyguard/CarrierTextController;)Lcom/android/keyguard/CarrierTextController$CarrierTextCallback;
    ...
    iget-object p0, p0, mCarrierTextCallback:Lcom/android/keyguard/CarrierTextController$CarrierTextCallback;
...
.method static synthetic access$200(Lcom/android/keyguard/CarrierTextController;)Z
    ...
    iget-boolean p0, p0, mTelephonyCapable:Z
...
.method static synthetic access$400(Lcom/android/keyguard/CarrierTextController;Lcom/android/internal/telephony/IccCardConstants$State;)Lcom/android/keyguard/CarrierTextController$StatusMode;
    ...
    invoke-direct {p0, p1}, getStatusForIccState(Lcom/android/internal/telephony/IccCardConstants$State;)Lcom/android/keyguard/CarrierTextController$StatusMode;
...
.method static synthetic access$500(Lcom/android/keyguard/CarrierTextController;)[Z
    ...
    iget-object p0, p0, mSimErrorState:[Z
...
.method private get5GNetworkClass(Landroid/telephony/SubscriptionInfo;)Ljava/lang/String;
    ...
    iget-object v1, p0, mFiveGServiceClient:Lcom/android/systemui/statusbar/policy/FiveGServiceClient;
    ...
    iput-object v1, p0, mFiveGServiceClient:Lcom/android/systemui/statusbar/policy/FiveGServiceClient;

    iget-object v1, p0, mFiveGServiceClient:Lcom/android/systemui/statusbar/policy/FiveGServiceClient;

    iget-object v2, p0, mCallback:Lcom/android/keyguard/KeyguardUpdateMonitorCallback;
    ...
    invoke-direct {p0, p1}, isDataRegisteredOnLte(I)Z
...
.method private getAirplaneModeMessage()Ljava/lang/String;
    ...
    iget-boolean v0, p0, mShowAirplaneMode:Z
...
.method private getCarrierTextForSimState(Lcom/android/internal/telephony/IccCardConstants$State;Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    invoke-direct {p0, p1, p2}, makeCarrierStringOnEmergencyCapable(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    invoke-direct {p0, p1, p2}, makeCarrierStringOnLocked(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
...
.method private getCustomizeCarrierName(Ljava/lang/CharSequence;Landroid/telephony/SubscriptionInfo;)Ljava/lang/String;
    ...
    invoke-direct {p0, v0}, getNetworkType(I)I
    ...
    invoke-direct {p0, v0}, networkClassToString(I)Ljava/lang/String;

    invoke-direct {p0, p2}, get5GNetworkClass(Landroid/telephony/SubscriptionInfo;)Ljava/lang/String;
...
.method private getMissingSimMessage()Ljava/lang/String;
    ...
    iget-boolean v0, p0, mShowMissingSim:Z
...
.method private updateCarrierTextWithSimIoError(Ljava/lang/CharSequence;[Ljava/lang/CharSequence;[IZ)Ljava/lang/CharSequence;
    ...
    invoke-direct {p0, v0, v1}, getCarrierTextForSimState(Lcom/android/internal/telephony/IccCardConstants$State;Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    :goto_0
    iget-object v2, p0, mSimErrorState:[Z
    ...
    iget-object p0, p0, mSeparator:Ljava/lang/CharSequence;

    invoke-static {v0, p1, p0}, concatenate(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    iget-object v4, p0, mSeparator:Ljava/lang/CharSequence;

    invoke-static {v0, v3, v4}, concatenate(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    :cond_2
    iget-object v2, p0, mSeparator:Ljava/lang/CharSequence;

    invoke-static {p1, v0, v2}, concatenate(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
...
.method protected getSubscriptionInfo()Ljava/util/List;
    ...
    iget-boolean v0, p0, mDisplayOpportunisticSubscriptionCarrierText:Z
...
.method public setListening(Lcom/android/keyguard/CarrierTextController$CarrierTextCallback;)V
    ...
    iput-object p1, p0, mCarrierTextCallback:Lcom/android/keyguard/CarrierTextController$CarrierTextCallback;
    ...
    iget-object v1, p0, mCallback:Lcom/android/keyguard/KeyguardUpdateMonitorCallback;
    ...
    iget-object p1, p0, mWakefulnessLifecycle:Lcom/android/systemui/keyguard/WakefulnessLifecycle;
    ...
    :cond_0
    iput-object v2, p0, mKeyguardUpdateMonitor:Lcom/android/keyguard/KeyguardUpdateMonitor;
    ...
    :cond_1
    iput-object v2, p0, mCarrierTextCallback:Lcom/android/keyguard/CarrierTextController$CarrierTextCallback;
    ...
    iget-object v2, p0, mWakefulnessObserver:Lcom/android/systemui/keyguard/WakefulnessLifecycle$Observer;
...
.method protected updateCarrierText()V
    ...
    invoke-direct/range {p0 .. p0}, getContext()Landroid/content/Context;
    ...
    invoke-virtual/range {p0 .. p0}, getSubscriptionInfo()Ljava/util/List;
    ...
    iget-object v12, v0, mKeyguardUpdateMonitor:Lcom/android/keyguard/KeyguardUpdateMonitor;
    ...
    invoke-direct {v0, v14, v15}, getCustomizeCarrierName(Ljava/lang/CharSequence;Landroid/telephony/SubscriptionInfo;)Ljava/lang/String;

    move-result-object v14

    invoke-direct {v0, v12, v14}, getCarrierTextForSimState(Lcom/android/internal/telephony/IccCardConstants$State;Ljava/lang/CharSequence;)Ljava/lang/CharSequence;

    move-result-object v15

    sget-boolean v16, DEBUG:Z
    ...
    iget-object v4, v0, mKeyguardUpdateMonitor:Lcom/android/keyguard/KeyguardUpdateMonitor;
    ...
    iget-object v9, v0, mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    invoke-direct/range {p0 .. p0}, getMissingSimMessage()Ljava/lang/String;
    ...
    invoke-direct {v0, v2, v1}, makeCarrierStringOnEmergencyCapable(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    :cond_c
    iget-object v2, v0, mSeparator:Ljava/lang/CharSequence;

    invoke-static {v12, v1, v2}, concatenate(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    :goto_5
    invoke-direct {v0, v4, v5, v3, v10}, updateCarrierTextWithSimIoError(Ljava/lang/CharSequence;[Ljava/lang/CharSequence;[IZ)Ljava/lang/CharSequence;
    ...
    invoke-direct/range {p0 .. p0}, getAirplaneModeMessage()Ljava/lang/String;
    ...
    iget-object v1, v0, mSeparator:Ljava/lang/CharSequence;

    invoke-static {v1, v5}, joinNotEmpty(Ljava/lang/CharSequence;[Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v0, v1}, postToCallback(Lcom/android/keyguard/CarrierTextController$CarrierTextCallbackInfo;)V
...
.method public updateDisplayOpportunisticSubscriptionCarrierText(Z)V
    ...
    iput-boolean p1, p0, mDisplayOpportunisticSubscriptionCarrierText:Z
