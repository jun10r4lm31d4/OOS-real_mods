...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p1, p0, mClipBounds:Landroid/graphics/Rect;

    const/4 p1, 0x0

    iput p1, p0, mVisibleType:I

    new-instance p2, Landroid/util/ArrayMap;

    invoke-direct {p2}, Landroid/util/ArrayMap;-><init>()V

    iput-object p2, p0, mOnContentViewInactiveListeners:Landroid/util/ArrayMap;
    ...
    iput-object p2, p0, mEnableAnimationPredrawListener:Landroid/view/ViewTreeObserver$OnPreDrawListener;

    const/4 p2, 0x1

    iput-boolean p2, p0, mClipToActualHeight:Z

    const/4 v0, -0x1

    iput v0, p0, mAnimationStartVisibleType:I

    iput-boolean p2, p0, mForceSelectNextLayout:Z

    iput v0, p0, mContentHeightAtAnimationStart:I

    iput-boolean p1, p0, mIsQuickReply:Z

    iput-boolean p2, p0, mFirstSeen:Z
    ...
    iput-object p1, p0, mHybridGroupManager:Lcom/android/systemui/statusbar/notification/row/HybridGroupManager;
    ...
    iput-object p1, p0, mMediaTransferManager:Lcom/android/systemui/statusbar/MediaTransferManager;
    ...
    iput-object p1, p0, mSmartReplyConstants:Lcom/android/systemui/statusbar/policy/SmartReplyConstants;
    ...
    iput-object p1, p0, mSmartReplyController:Lcom/android/systemui/statusbar/SmartReplyController;

    invoke-virtual {p0}, initView()V
...
.method static synthetic access$200(Lcom/android/systemui/statusbar/notification/row/NotificationContentView;I)Lcom/android/systemui/statusbar/TransformableView;
    ...
    invoke-direct {p0, p1}, getTransformableViewForVisibleType(I)Lcom/android/systemui/statusbar/TransformableView;
...
.method static synthetic access$302(Lcom/android/systemui/statusbar/notification/row/NotificationContentView;I)I
    ...
    iput p1, p0, mAnimationStartVisibleType:I
...
.method private animateToVisibleType(I)V
    ...
    iget v1, p0, mVisibleType:I

    invoke-direct {p0, v1}, getTransformableViewForVisibleType(I)Lcom/android/systemui/statusbar/TransformableView;
    ...
    :cond_0
    iget v2, p0, mVisibleType:I

    iput v2, p0, mAnimationStartVisibleType:I
    ...
    invoke-direct {p0, p1}, getViewForVisibleType(I)Landroid/view/View;
    ...
    invoke-direct {p0}, fireExpandedVisibleListenerIfVisible()V
...
.method private applyMediaTransfer(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V
    ...
    iget-object v0, p0, mExpandedChild:Landroid/view/View;
    ...
    :cond_1
    iget-object p0, p0, mMediaTransferManager:Lcom/android/systemui/statusbar/MediaTransferManager;
...
.method private applyRemoteInput(Landroid/view/View;Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;ZLandroid/app/PendingIntent;Lcom/android/systemui/statusbar/policy/RemoteInputView;Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;)Lcom/android/systemui/statusbar/policy/RemoteInputView;
    ...
    iget-object p5, p0, mRemoteInputController:Lcom/android/systemui/statusbar/RemoteInputController;
...
.method private applyRemoteInput(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;Z)V
    ...
    iget-object v1, p0, mExpandedChild:Landroid/view/View;

    const/4 v7, 0x0

    if-eqz v1, :cond_0

    iget-object v4, p0, mPreviousExpandedRemoteInputIntent:Landroid/app/PendingIntent;

    iget-object v5, p0, mCachedExpandedRemoteInput:Lcom/android/systemui/statusbar/policy/RemoteInputView;

    iget-object v6, p0, mExpandedWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
    ...
    invoke-direct/range {v0 .. v6}, applyRemoteInput(Landroid/view/View;Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;ZLandroid/app/PendingIntent;Lcom/android/systemui/statusbar/policy/RemoteInputView;Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;)Lcom/android/systemui/statusbar/policy/RemoteInputView;

    move-result-object v0

    iput-object v0, p0, mExpandedRemoteInput:Lcom/android/systemui/statusbar/policy/RemoteInputView;

    goto :goto_0

    :cond_0
    iput-object v7, p0, mExpandedRemoteInput:Lcom/android/systemui/statusbar/policy/RemoteInputView;

    :goto_0
    iget-object v0, p0, mCachedExpandedRemoteInput:Lcom/android/systemui/statusbar/policy/RemoteInputView;

    if-eqz v0, :cond_1

    iget-object v1, p0, mExpandedRemoteInput:Lcom/android/systemui/statusbar/policy/RemoteInputView;
    ...
    :cond_1
    iput-object v7, p0, mCachedExpandedRemoteInput:Lcom/android/systemui/statusbar/policy/RemoteInputView;

    iget-object v1, p0, mHeadsUpChild:Landroid/view/View;

    if-eqz v1, :cond_2

    iget-object v4, p0, mPreviousHeadsUpRemoteInputIntent:Landroid/app/PendingIntent;

    iget-object v5, p0, mCachedHeadsUpRemoteInput:Lcom/android/systemui/statusbar/policy/RemoteInputView;

    iget-object v6, p0, mHeadsUpWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
    ...
    iput-object v0, p0, mHeadsUpRemoteInput:Lcom/android/systemui/statusbar/policy/RemoteInputView;

    goto :goto_1

    :cond_2
    iput-object v7, p0, mHeadsUpRemoteInput:Lcom/android/systemui/statusbar/policy/RemoteInputView;

    :goto_1
    iget-object v0, p0, mCachedHeadsUpRemoteInput:Lcom/android/systemui/statusbar/policy/RemoteInputView;

    if-eqz v0, :cond_3

    iget-object v1, p0, mHeadsUpRemoteInput:Lcom/android/systemui/statusbar/policy/RemoteInputView;
    ...
    :cond_3
    iput-object v7, p0, mCachedHeadsUpRemoteInput:Lcom/android/systemui/statusbar/policy/RemoteInputView;
...
.method private applyRemoteInputAndSmartReply(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V
    ...
    iget-object v0, p0, mRemoteInputController:Lcom/android/systemui/statusbar/RemoteInputController;
    ...
    invoke-direct {p0, p1, v0}, applyRemoteInput(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;Z)V

    iget-object v0, p0, mExpandedInflatedSmartReplies:Lcom/android/systemui/statusbar/policy/InflatedSmartReplies;

    const-string v1, "NotificationContentView"

    if-nez v0, :cond_2

    iget-object v0, p0, mHeadsUpInflatedSmartReplies:Lcom/android/systemui/statusbar/policy/InflatedSmartReplies;
    ...
    :goto_0
    iput-object v0, p0, mCurrentSmartRepliesAndActions:Lcom/android/systemui/statusbar/policy/InflatedSmartReplies$SmartRepliesAndActions;
    ...
    iget-object v4, p0, mCurrentSmartRepliesAndActions:Lcom/android/systemui/statusbar/policy/InflatedSmartReplies$SmartRepliesAndActions;
    ...
    :cond_6
    iget-object v0, p0, mCurrentSmartRepliesAndActions:Lcom/android/systemui/statusbar/policy/InflatedSmartReplies$SmartRepliesAndActions;

    invoke-direct {p0, v0, p1}, applySmartReplyView(Lcom/android/systemui/statusbar/policy/InflatedSmartReplies$SmartRepliesAndActions;Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V
...
.method private applySmartReplyView(Lcom/android/systemui/statusbar/policy/InflatedSmartReplies$SmartRepliesAndActions;Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V
    ...
    iget-object v1, p0, mExpandedInflatedSmartReplies:Lcom/android/systemui/statusbar/policy/InflatedSmartReplies;

    invoke-direct {p0, v0, p1, p2, v1}, applySmartReplyView(Landroid/view/View;Lcom/android/systemui/statusbar/policy/InflatedSmartReplies$SmartRepliesAndActions;Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;Lcom/android/systemui/statusbar/policy/InflatedSmartReplies;)Lcom/android/systemui/statusbar/policy/SmartReplyView;

    move-result-object v0

    iput-object v0, p0, mExpandedSmartReplyView:Lcom/android/systemui/statusbar/policy/SmartReplyView;

    iget-object v0, p0, mExpandedSmartReplyView:Lcom/android/systemui/statusbar/policy/SmartReplyView;
    ...
    iget-object v2, p0, mSmartReplyConstants:Lcom/android/systemui/statusbar/policy/SmartReplyConstants;
    ...
    iget-object v2, p0, mSmartReplyController:Lcom/android/systemui/statusbar/SmartReplyController;
    ...
    :cond_5
    iget-object v0, p0, mHeadsUpChild:Landroid/view/View;

    if-eqz v0, :cond_6

    iget-object v0, p0, mSmartReplyConstants:Lcom/android/systemui/statusbar/policy/SmartReplyConstants;
    ...
    iget-object v1, p0, mHeadsUpInflatedSmartReplies:Lcom/android/systemui/statusbar/policy/InflatedSmartReplies;

    invoke-direct {p0, v0, p1, p2, v1}, applySmartReplyView(Landroid/view/View;Lcom/android/systemui/statusbar/policy/InflatedSmartReplies$SmartRepliesAndActions;Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;Lcom/android/systemui/statusbar/policy/InflatedSmartReplies;)Lcom/android/systemui/statusbar/policy/SmartReplyView;

    move-result-object p1

    iput-object p1, p0, mHeadsUpSmartReplyView:Lcom/android/systemui/statusbar/policy/SmartReplyView;
...
.method private calculateTransformationAmount()F
    ...
    iget v0, p0, mTransformationStartVisibleType:I

    invoke-direct {p0, v0}, getViewHeight(I)I

    move-result v0

    iget v1, p0, mVisibleType:I

    invoke-direct {p0, v1}, getViewHeight(I)I
    ...
    iget v3, p0, mTransformationStartVisibleType:I
...
.method private fireExpandedVisibleListenerIfVisible()V
    ...
    iget-object v0, p0, mExpandedVisibleListener:Ljava/lang/Runnable;
    ...
    iput-object v1, p0, mExpandedVisibleListener:Ljava/lang/Runnable;
...
.method private focusExpandButtonIfNecessary()V
    ...
    iget-boolean v0, p0, mFocusOnVisibilityChange:Z
    ...
    iput-boolean v0, p0, mFocusOnVisibilityChange:Z
...
.method private forceUpdateVisibilities()V
    ...
    iget-object v0, p0, mContractedChild:Landroid/view/View;

    iget-object v1, p0, mContractedWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;

    const/4 v2, 0x0

    invoke-direct {p0, v2, v0, v1}, forceUpdateVisibility(ILandroid/view/View;Lcom/android/systemui/statusbar/TransformableView;)V

    iget-object v0, p0, mExpandedChild:Landroid/view/View;

    iget-object v1, p0, mExpandedWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
    ...
    iget-object v1, p0, mHeadsUpWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;

    const/4 v2, 0x2

    invoke-direct {p0, v2, v0, v1}, forceUpdateVisibility(ILandroid/view/View;Lcom/android/systemui/statusbar/TransformableView;)V

    iget-object v0, p0, mSingleLineView:Lcom/android/systemui/statusbar/notification/row/HybridNotificationView;

    const/4 v1, 0x3

    invoke-direct {p0, v1, v0, v0}, forceUpdateVisibility(ILandroid/view/View;Lcom/android/systemui/statusbar/TransformableView;)V

    iget-object v0, p0, mAmbientChild:Landroid/view/View;

    iget-object v1, p0, mAmbientWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;

    const/4 v2, 0x4

    invoke-direct {p0, v2, v0, v1}, forceUpdateVisibility(ILandroid/view/View;Lcom/android/systemui/statusbar/TransformableView;)V

    iget-object v0, p0, mQuickReplyChild:Landroid/view/View;

    iget-object v1, p0, mQuickReplyContractedWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;

    const/4 v2, 0x6

    invoke-direct {p0, v2, v0, v1}, forceUpdateVisibility(ILandroid/view/View;Lcom/android/systemui/statusbar/TransformableView;)V

    iget-object v0, p0, mQuickReplyHeadsUpChild:Landroid/view/View;

    iget-object v1, p0, mQuickReplyHeadsUpWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
...
.method private forceUpdateVisibility(ILandroid/view/View;Lcom/android/systemui/statusbar/TransformableView;)V
    ...
    iget p0, p0, mTransformationStartVisibleType:I
...
.method private getMinContentHeightHint()I
    ...
    iget-boolean v0, p0, mIsChildInGroup:Z
    ...
    invoke-direct {p0, v0}, isVisibleOrTransitioning(I)Z
    ...
    invoke-direct {p0, v3, v4}, isTransitioningFromTo(II)Z

    move-result v0

    if-nez v0, :cond_2

    invoke-direct {p0, v4, v3}, isTransitioningFromTo(II)Z
    ...
    :goto_1
    invoke-direct {p0, v2}, isVisibleOrTransitioning(I)Z

    move-result v5

    if-nez v5, :cond_4

    iget-boolean v5, p0, mIsHeadsUp:Z

    if-nez v5, :cond_3

    iget-boolean v5, p0, mHeadsUpAnimatingAway:Z

    if-eqz v5, :cond_4

    :cond_3
    iget-object v5, p0, mContainingNotification:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;
    ...
    :cond_5
    invoke-direct {p0, v3}, getViewHeight(I)I

    move-result v0

    invoke-direct {p0, v4}, getViewHeight(I)I
    ...
    iget v0, p0, mContentHeightAtAnimationStart:I

    if-ltz v0, :cond_7

    iget-object v5, p0, mExpandedChild:Landroid/view/View;
    ...
    invoke-direct {p0, v3}, isVisibleOrTransitioning(I)Z
    ...
    :cond_c
    invoke-direct {p0, v2}, getViewHeight(I)I
    ...
    invoke-direct {p0, v4}, isVisibleOrTransitioning(I)Z
...
.method private getRemoteInputForView(Landroid/view/View;)Lcom/android/systemui/statusbar/policy/RemoteInputView;
    ...
    iget-object p0, p0, mExpandedRemoteInput:Lcom/android/systemui/statusbar/policy/RemoteInputView;
    ...
    iget-object p0, p0, mHeadsUpRemoteInput:Lcom/android/systemui/statusbar/policy/RemoteInputView;
...
.method private getTransformableViewForVisibleType(I)Lcom/android/systemui/statusbar/TransformableView;
    ...
    iget-object p0, p0, mContractedWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;

    return-object p0

    :cond_0
    iget-object p0, p0, mQuickReplyHeadsUpWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;

    return-object p0

    :cond_1
    iget-object p0, p0, mQuickReplyContractedWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;

    return-object p0

    :cond_2
    iget-object p0, p0, mAmbientWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;

    return-object p0

    :cond_3
    iget-object p0, p0, mSingleLineView:Lcom/android/systemui/statusbar/notification/row/HybridNotificationView;

    return-object p0

    :cond_4
    iget-object p0, p0, mHeadsUpWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;

    return-object p0

    :cond_5
    iget-object p0, p0, mExpandedWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
...
.method private getViewForVisibleType(I)Landroid/view/View;
    ...
    iget-object p0, p0, mContractedChild:Landroid/view/View;

    return-object p0

    :cond_0
    iget-object p0, p0, mQuickReplyHeadsUpChild:Landroid/view/View;

    return-object p0

    :cond_1
    iget-object p0, p0, mQuickReplyChild:Landroid/view/View;

    return-object p0

    :cond_2
    iget-object p0, p0, mAmbientChild:Landroid/view/View;
    ...
    :cond_4
    iget-object p0, p0, mHeadsUpChild:Landroid/view/View;

    return-object p0

    :cond_5
    iget-object p0, p0, mExpandedChild:Landroid/view/View;
...
.method private getViewHeight(I)I
    ...
    :cond_0
    iget-object v1, p0, mContainingNotification:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;
    ...
    :goto_0
    invoke-direct {p0, v0}, getWrapperForView(Landroid/view/View;)Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
...
.method private getVisualTypeForHeight(F)I
    ...
    :cond_1
    iget-object v3, p0, mContainingNotification:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;

    invoke-virtual {v3}, Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;->isOnAmbient()Z

    move-result v3

    iget-boolean v4, p0, mUserExpanding:Z

    if-nez v4, :cond_2

    iget-boolean v4, p0, mIsChildInGroup:Z

    if-eqz v4, :cond_2

    invoke-direct {p0}, isGroupExpanded()Z
    ...
    :cond_2
    iget-boolean v4, p0, mIsQuickReply:Z

    if-eqz v4, :cond_4

    iget-boolean v4, p0, mIsHeadsUp:Z

    if-eqz v4, :cond_3

    iget-object v4, p0, mQuickReplyHeadsUpChild:Landroid/view/View;
    ...
    :cond_3
    iget-object v4, p0, mQuickReplyChild:Landroid/view/View;
    ...
    iget-boolean v4, p0, mHeadsUpAnimatingAway:Z

    if-eqz v4, :cond_8

    :cond_5
    iget-object v4, p0, mHeadsUpChild:Landroid/view/View;

    if-eqz v4, :cond_8

    iget-object v4, p0, mContainingNotification:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;
    ...
    iget-object v3, p0, mAmbientChild:Landroid/view/View;
    ...
    iget-boolean p1, p0, mIsChildInGroup:Z
    ...
    iget-object p0, p0, mContainingNotification:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;
...
.method private isContentViewInactive(Landroid/view/View;)Z
    ...
    invoke-direct {p0, v1}, getViewForVisibleType(I)Landroid/view/View;
...
.method private isTransitioningFromTo(II)Z
    ...
    iget v0, p0, mAnimationStartVisibleType:I
...
.method private isVisibleOrTransitioning(I)Z
    ...
    iget p0, p0, mAnimationStartVisibleType:I
...
.method private selectLayout(ZZ)V
    ...
    :cond_0
    iget-boolean v0, p0, mUserExpanding:Z
    ...
    :cond_1
    invoke-virtual {p0}, calculateVisibleType()I
    ...
    :cond_3
    invoke-direct {p0, v0}, getViewForVisibleType(I)Landroid/view/View;
    ...
    invoke-direct {p0, v0}, transferRemoteInputFocus(I)V

    iget-boolean p2, p0, mFirstSeen:Z
    ...
    :cond_4
    iget-object p2, p0, mQuickReplyHeadsUpChild:Landroid/view/View;
    ...
    :cond_5
    iget-object p2, p0, mQuickReplyChild:Landroid/view/View;
    ...
    iput-boolean v3, p0, mFirstSeen:Z
    ...
    iget-object p2, p0, mExpandedChild:Landroid/view/View;
    ...
    iget-object p2, p0, mHeadsUpChild:Landroid/view/View;
    ...
    iget-object p2, p0, mSingleLineView:Lcom/android/systemui/statusbar/notification/row/HybridNotificationView;
    ...
    :cond_d
    invoke-direct {p0, v0}, animateToVisibleType(I)V

    goto :goto_1

    :cond_e
    invoke-direct {p0, v0}, updateViewVisibilities(I)V

    :goto_1
    iput v0, p0, mVisibleType:I

    if-eqz v1, :cond_f

    invoke-direct {p0}, focusExpandButtonIfNecessary()V

    :cond_f
    invoke-virtual {p0, v0}, getVisibleWrapper(I)Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;

    move-result-object p2

    if-eqz p2, :cond_10

    iget v0, p0, mUnrestrictedContentHeight:I

    invoke-direct {p0}, getMinContentHeightHint()I
    ...
    :cond_10
    invoke-virtual {p0, p1}, updateBackgroundColor(Z)V
...
.method private setVisible(Z)V
    ...
    iget-object v0, p0, mEnableAnimationPredrawListener:Landroid/view/ViewTreeObserver$OnPreDrawListener;
    ...
    iget-object p0, p0, mEnableAnimationPredrawListener:Landroid/view/ViewTreeObserver$OnPreDrawListener;
...
.method private shouldClipToRounding(IZZ)Z
    ...
    invoke-virtual {p0, p1}, getVisibleWrapper(I)Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
...
.method private transferRemoteInputFocus(I)V
    ...
    iget-object v0, p0, mHeadsUpRemoteInput:Lcom/android/systemui/statusbar/policy/RemoteInputView;

    if-eqz v0, :cond_0

    iget-object v0, p0, mExpandedRemoteInput:Lcom/android/systemui/statusbar/policy/RemoteInputView;
    ...
    iget-object p1, p0, mExpandedRemoteInput:Lcom/android/systemui/statusbar/policy/RemoteInputView;

    if-eqz p1, :cond_1

    iget-object p1, p0, mHeadsUpRemoteInput:Lcom/android/systemui/statusbar/policy/RemoteInputView;
...
.method private updateAllSingleLineViews()V
    ...
    invoke-direct {p0}, updateSingleLineView()V
...
.method private updateBackgroundTransformation(F)V
    ...
    invoke-virtual {p0, v0}, getBackgroundColor(I)I

    move-result v0

    iget v1, p0, mTransformationStartVisibleType:I

    invoke-virtual {p0, v1}, getBackgroundColor(I)I
    ...
    iget-object v0, p0, mContainingNotification:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;
    ...
    iget-object p1, p0, mContainingNotification:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;
...
.method private updateClipping()V
    ...
    iget-boolean v0, p0, mClipToActualHeight:Z

    if-eqz v0, :cond_0

    iget v0, p0, mClipTopAmount:I
    ...
    iget v1, p0, mUnrestrictedContentHeight:I

    iget v2, p0, mClipBottomAmount:I
...
.method private updateContentTransformation()V
    ...
    iput v1, p0, mTransformationStartVisibleType:I

    invoke-direct {p0, v0}, getTransformableViewForVisibleType(I)Lcom/android/systemui/statusbar/TransformableView;

    move-result-object v1

    iget v3, p0, mTransformationStartVisibleType:I

    invoke-direct {p0, v3}, getTransformableViewForVisibleType(I)Lcom/android/systemui/statusbar/TransformableView;
    ...
    invoke-virtual {p0, v1}, updateBackgroundColor(Z)V
    ...
    :cond_2
    :goto_1
    iget-boolean v1, p0, mForceSelectNextLayout:Z

    if-eqz v1, :cond_3

    invoke-direct {p0}, forceUpdateVisibilities()V
    ...
    :cond_4
    invoke-direct {p0}, calculateTransformationAmount()F
    ...
    invoke-direct {p0, v2}, updateBackgroundTransformation(F)V
    ...
    invoke-virtual {p0, v2}, updateBackgroundColor(Z)V
...
.method private updateContractedHeaderWidth()Z
    ...
    iget-object v0, p0, mContractedWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
    ...
    iget-object v2, p0, mExpandedChild:Landroid/view/View;

    const/4 v3, 0x1

    if-eqz v2, :cond_0

    iget-object v2, p0, mExpandedWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
    ...
    :cond_0
    iget p0, p0, mNotificationContentMarginEnd:I
...
.method private updateIconVisibilities()V
    ...
    iget-boolean v1, p0, mIconsVisible:Z
    ...
    :cond_0
    iget-object v0, p0, mHeadsUpWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
    ...
    :cond_1
    iget-object v0, p0, mExpandedWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
    ...
    iget-boolean p0, p0, mIconsVisible:Z
...
.method private updateLegacy()V
    ...
    iget-object v0, p0, mQuickReplyContractedWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
...
.method private updateSingleLineView()V
    ...
    :goto_0
    iget-object v1, p0, mHybridGroupManager:Lcom/android/systemui/statusbar/notification/row/HybridGroupManager;

    iget-object v2, p0, mSingleLineView:Lcom/android/systemui/statusbar/notification/row/HybridNotificationView;
    ...
    iput-object v1, p0, mSingleLineView:Lcom/android/systemui/statusbar/notification/row/HybridNotificationView;
    ...
    invoke-direct {p0, v0, v1, v2, v2}, updateViewVisibility(IILandroid/view/View;Lcom/android/systemui/statusbar/TransformableView;)V
    ...
    iput-object v0, p0, mSingleLineView:Lcom/android/systemui/statusbar/notification/row/HybridNotificationView;
...
.method private updateViewVisibilities(I)V
    ...
    invoke-direct {p0, p1, v2, v0, v1}, updateViewVisibility(IILandroid/view/View;Lcom/android/systemui/statusbar/TransformableView;)V
    ...
    invoke-direct {p0, p1, v1, v0, v0}, updateViewVisibility(IILandroid/view/View;Lcom/android/systemui/statusbar/TransformableView;)V
...
.method private updateVisibility()V
    ...
    invoke-direct {p0, v0}, setVisible(Z)V
...
.method public calculateVisibleType()I
    ...
    invoke-virtual {v0}, getMinHeight()I
    ...
    invoke-direct {p0, v0}, getVisualTypeForHeight(F)I

    move-result v0

    iget-boolean v1, p0, mIsChildInGroup:Z
    ...
    invoke-direct {p0, v1}, getVisualTypeForHeight(F)I
...
.method public disallowSingleClick(FF)Z
    ...
    invoke-virtual {p0}, getVisibleType()I
...
.method public dispatchTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-direct {p0, v1}, getRemoteInputForView(Landroid/view/View;)Lcom/android/systemui/statusbar/policy/RemoteInputView;
    ...
    iget v2, p0, mUnrestrictedContentHeight:I
    ...
    iget v3, p0, mUnrestrictedContentHeight:I
...
.method public getCurrentSmartRepliesAndActions()Lcom/android/systemui/statusbar/policy/InflatedSmartReplies$SmartRepliesAndActions;
    ...
    iget-object p0, p0, mCurrentSmartRepliesAndActions:Lcom/android/systemui/statusbar/policy/InflatedSmartReplies$SmartRepliesAndActions;
...
.method public getExpandHeight()I
    ...
    invoke-direct {p0, v1}, getExtraRemoteInputHeight(Lcom/android/systemui/statusbar/policy/RemoteInputView;)I
...
.method public getMaxHeight()I
    ...
    :cond_0
    iget-boolean v0, p0, mIsQuickReply:Z
    ...
    invoke-virtual {p0}, getShowingAmbientView()Landroid/view/View;
...
.method public getMinHeight()I
    ...
    invoke-virtual {p0, v0}, getMinHeight(Z)I
...
.method public getMinHeight(Z)I
    ...
    invoke-direct {p0, p1}, getViewHeight(I)I
    ...
    :cond_5
    :goto_0
    iget-object p1, p0, mContractedChild:Landroid/view/View;
    ...
    :cond_6
    iget p0, p0, mMinContractedHeight:I
...
.method public getNotificationHeader()Landroid/view/NotificationHeaderView;
    ...
    iget-object v1, p0, mAmbientChild:Landroid/view/View;
...
.method public initView()V
    ...
    iput v0, p0, mMinContractedHeight:I
    ...
    iput v0, p0, mNotificationContentMarginEnd:I
    ...
    iput v0, p0, mQuickReplyHeight:I
...
.method public isContentExpandable()Z
    ...
    iget-boolean p0, p0, mIsContentExpandable:Z
...
.method public isContentViewInactive(I)Z
    ...
    invoke-direct {p0, p1}, isContentViewInactive(Landroid/view/View;)Z
...
.method public isQuickReply()Z
    ...
    iget-boolean p0, p0, mIsQuickReply:Z
...
.method protected onAttachedToWindow()V
    ...
    invoke-direct {p0}, updateVisibility()V
...
.method protected onChildVisibilityChanged(Landroid/view/View;II)V
    ...
    iget-object p0, p0, mOnContentViewInactiveListeners:Landroid/util/ArrayMap;
...
.method protected onLayout(ZIIII)V
    ...
    iget-object p1, p0, mExpandedChild:Landroid/view/View;
    ...
    :cond_1
    invoke-direct {p0}, updateClipping()V

    invoke-virtual {p0}, Landroid/widget/FrameLayout;->invalidateOutline()V

    iget-boolean p1, p0, mForceSelectNextLayout:Z

    invoke-direct {p0, v1, p1}, selectLayout(ZZ)V

    iput-boolean v1, p0, mForceSelectNextLayout:Z

    iget-boolean p1, p0, mExpandable:Z

    invoke-virtual {p0, p1}, updateExpandButtons(Z)V
...
.method protected onMeasure(II)V
    ...
    iget-object v0, v6, mExpandedChild:Landroid/view/View;

    if-eqz v0, :cond_7

    iget v0, v6, mNotificationMaxHeight:I

    iget-object v1, v6, mExpandedSmartReplyView:Lcom/android/systemui/statusbar/policy/SmartReplyView;
    ...
    :cond_4
    iget-object v1, v6, mExpandedWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
    ...
    iget-object v1, v6, mExpandedChild:Landroid/view/View;
    ...
    :goto_4
    iget-object v0, v6, mContractedChild:Landroid/view/View;

    if-eqz v0, :cond_d

    iget v1, v6, mSmallHeight:I
    ...
    :goto_5
    invoke-direct/range {p0 .. p0}, shouldContractedBeFixedSize()Z
    ...
    iget-object v1, v6, mContractedChild:Landroid/view/View;
    ...
    iget v0, v6, mMinContractedHeight:I
    ...
    invoke-direct/range {p0 .. p0}, updateContractedHeaderWidth()Z
    ...
    :cond_d
    iget-object v0, v6, mHeadsUpChild:Landroid/view/View;

    if-eqz v0, :cond_11

    iget v0, v6, mHeadsUpHeight:I

    iget-object v1, v6, mHeadsUpSmartReplyView:Lcom/android/systemui/statusbar/policy/SmartReplyView;
    ...
    :cond_e
    iget-object v1, v6, mHeadsUpWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
    ...
    iget-object v1, v6, mHeadsUpChild:Landroid/view/View;
    ...
    :goto_9
    iget-object v2, v6, mHeadsUpChild:Landroid/view/View;
    ...
    :cond_11
    iget-object v0, v6, mSingleLineView:Lcom/android/systemui/statusbar/notification/row/HybridNotificationView;

    if-eqz v0, :cond_13

    iget v0, v6, mSingleLineWidthIndention:I
    ...
    iget-object v1, v6, mSingleLineView:Lcom/android/systemui/statusbar/notification/row/HybridNotificationView;
    ...
    iget v2, v6, mNotificationMaxHeight:I
    ...
    :cond_13
    iget-object v0, v6, mAmbientChild:Landroid/view/View;

    if-eqz v0, :cond_16

    iget v1, v6, mNotificationAmbientHeight:I
    ...
    :goto_d
    iget-object v1, v6, mQuickReplyChild:Landroid/view/View;

    if-eqz v1, :cond_17

    const/4 v3, 0x0

    iget v0, v6, mQuickReplyHeight:I
    ...
    iget-object v0, v6, mQuickReplyChild:Landroid/view/View;
    ...
    :cond_17
    iget-object v1, v6, mQuickReplyHeadsUpChild:Landroid/view/View;
    ...
    iget-object v0, v6, mQuickReplyHeadsUpChild:Landroid/view/View;
...
.method public onNotificationUpdated(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V
    ...
    iput-object v0, p0, mStatusBarNotification:Landroid/service/notification/StatusBarNotification;

    iget-object v0, p0, mOnContentViewInactiveListeners:Landroid/util/ArrayMap;
    ...
    :goto_0
    iput-boolean v0, p0, mBeforeN:Z

    invoke-direct {p0}, updateAllSingleLineViews()V

    invoke-virtual {p1}, Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;->getRow()Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;

    move-result-object v0

    iget-object v3, p0, mContractedChild:Landroid/view/View;

    if-eqz v3, :cond_1

    iget-object v3, p0, mContractedWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
    ...
    :cond_1
    iget-object v3, p0, mExpandedChild:Landroid/view/View;

    if-eqz v3, :cond_2

    iget-object v3, p0, mExpandedWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;

    invoke-virtual {v3, v0}, Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;->onContentUpdated(Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;)V

    :cond_2
    iget-object v3, p0, mHeadsUpChild:Landroid/view/View;

    if-eqz v3, :cond_3

    iget-object v3, p0, mHeadsUpWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
    ...
    iget-object v3, p0, mAmbientWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;

    invoke-virtual {v3, v0}, Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;->onContentUpdated(Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;)V

    :cond_4
    invoke-direct {p0, p1}, applyRemoteInputAndSmartReply(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V

    invoke-direct {p0, p1}, applyMediaTransfer(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V

    invoke-direct {p0}, updateLegacy()V

    iput-boolean v1, p0, mForceSelectNextLayout:Z

    iget-boolean p1, p0, mDark:Z

    const-wide/16 v0, 0x0

    invoke-virtual {p0, p1, v2, v0, v1}, setDark(ZZJ)V

    const/4 p1, 0x0

    iput-object p1, p0, mPreviousExpandedRemoteInputIntent:Landroid/app/PendingIntent;

    iput-object p1, p0, mPreviousHeadsUpRemoteInputIntent:Landroid/app/PendingIntent;
...
.method protected onVisibilityChanged(Landroid/view/View;I)V
    ...
    iget-object p1, p0, mOnContentViewInactiveListeners:Landroid/util/ArrayMap;
...
.method public performWhenContentInactive(ILjava/lang/Runnable;)V
    ...
    invoke-virtual {p0, p1}, isContentViewInactive(I)Z
...
.method public requestSelectLayout(Z)V
    ...
    invoke-direct {p0, p1, v0}, selectLayout(ZZ)V
...
.method public setAmbientChild(Landroid/view/View;)V
    ...
    iput-object p1, p0, mAmbientChild:Landroid/view/View;

    iput-object p1, p0, mAmbientWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;

    iget p1, p0, mTransformationStartVisibleType:I
    ...
    iput p1, p0, mTransformationStartVisibleType:I
...
.method public setBackgroundTintColor(I)V
    ...
    :cond_0
    iget-object p0, p0, mHeadsUpSmartReplyView:Lcom/android/systemui/statusbar/policy/SmartReplyView;
...
.method public setClipBottomAmount(I)V
    ...
    iput p1, p0, mClipBottomAmount:I
...
.method public setClipChildren(Z)V
    ...
    iget-boolean p1, p0, mRemoteInputVisible:Z
...
.method public setClipToActualHeight(Z)V
    ...
    iput-boolean p1, p0, mClipToActualHeight:Z
...
.method public setContainingNotification(Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;)V
    ...
    iput-object p1, p0, mContainingNotification:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;
...
.method public setContentHeight(I)V
    ...
    invoke-virtual {p0}, getMinHeight()I
    ...
    iput p1, p0, mUnrestrictedContentHeight:I
    ...
    invoke-direct {p0, v0}, getExtraRemoteInputHeight(Lcom/android/systemui/statusbar/policy/RemoteInputView;)I
...
.method public setContentHeightAnimating(Z)V
    ...
    iput p1, p0, mContentHeightAtAnimationStart:I
...
.method public setContractedChild(Landroid/view/View;)V
    ...
    iput-object p1, p0, mContractedChild:Landroid/view/View;

    iput-object p1, p0, mContractedWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
...
.method public setDark(ZZJ)V
    ...
    iget-object p3, p0, mContractedChild:Landroid/view/View;
    ...
    :goto_0
    invoke-direct {p0, p1, p3}, selectLayout(ZZ)V
...
.method public setExpandClickListener(Landroid/view/View$OnClickListener;)V
    ...
    iput-object p1, p0, mExpandClickListener:Landroid/view/View$OnClickListener;
...
.method public setExpandedChild(Landroid/view/View;)V
    ...
    iput-object v1, p0, mPreviousExpandedRemoteInputIntent:Landroid/app/PendingIntent;
    ...
    iput-object v0, p0, mPreviousExpandedRemoteInputIntent:Landroid/app/PendingIntent;

    iget-object v0, p0, mExpandedRemoteInput:Lcom/android/systemui/statusbar/policy/RemoteInputView;

    iput-object v0, p0, mCachedExpandedRemoteInput:Lcom/android/systemui/statusbar/policy/RemoteInputView;
    ...
    iget-object v2, p0, mExpandedRemoteInput:Lcom/android/systemui/statusbar/policy/RemoteInputView;
    ...
    iput-object v1, p0, mExpandedRemoteInput:Lcom/android/systemui/statusbar/policy/RemoteInputView;

    :cond_1
    if-nez p1, :cond_4

    iput-object v1, p0, mExpandedChild:Landroid/view/View;

    iput-object v1, p0, mExpandedWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
    ...
    iput-object p1, p0, mExpandedChild:Landroid/view/View;
    ...
    iput-object p1, p0, mExpandedWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
...
.method public setExpandedInflatedSmartReplies(Lcom/android/systemui/statusbar/policy/InflatedSmartReplies;)V
    ...
    iput-object p1, p0, mExpandedInflatedSmartReplies:Lcom/android/systemui/statusbar/policy/InflatedSmartReplies;

    if-nez p1, :cond_0

    const/4 p1, 0x0

    iput-object p1, p0, mExpandedSmartReplyView:Lcom/android/systemui/statusbar/policy/SmartReplyView;
...
.method public setHeadsUpChild(Landroid/view/View;)V
    ...
    iput-object v1, p0, mPreviousHeadsUpRemoteInputIntent:Landroid/app/PendingIntent;
    ...
    :try_start_0
    iget-object v2, p0, mHeadsUpRemoteInput:Lcom/android/systemui/statusbar/policy/RemoteInputView;
    ...
    iput-object v2, p0, mPreviousHeadsUpRemoteInputIntent:Landroid/app/PendingIntent;

    iget-object v2, p0, mHeadsUpRemoteInput:Lcom/android/systemui/statusbar/policy/RemoteInputView;

    iput-object v2, p0, mCachedHeadsUpRemoteInput:Lcom/android/systemui/statusbar/policy/RemoteInputView;
    ...
    iget-object v3, p0, mHeadsUpRemoteInput:Lcom/android/systemui/statusbar/policy/RemoteInputView;

    invoke-virtual {v2, v3}, Landroid/view/ViewGroup;->removeView(Landroid/view/View;)V

    :cond_0
    iget-object v2, p0, mHeadsUpChild:Landroid/view/View;
    ...
    iput-object v1, p0, mHeadsUpRemoteInput:Lcom/android/systemui/statusbar/policy/RemoteInputView;
    ...
    iput-object v1, p0, mHeadsUpChild:Landroid/view/View;

    iput-object v1, p0, mHeadsUpWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
    ...
    iput-object p1, p0, mHeadsUpChild:Landroid/view/View;
    ...
    iput-object p1, p0, mHeadsUpWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
...
.method public setHeadsUpInflatedSmartReplies(Lcom/android/systemui/statusbar/policy/InflatedSmartReplies;)V
    ...
    iput-object p1, p0, mHeadsUpInflatedSmartReplies:Lcom/android/systemui/statusbar/policy/InflatedSmartReplies;
...
.method public setHeights(IIII)V
    ...
    iput p1, p0, mSmallHeight:I

    iput p2, p0, mHeadsUpHeight:I

    iput p3, p0, mNotificationMaxHeight:I

    iput p4, p0, mNotificationAmbientHeight:I
...
.method public setIsChildInGroup(Z)V
    ...
    iput-boolean p1, p0, mIsChildInGroup:Z

    iget-object p1, p0, mContractedChild:Landroid/view/View;

    if-eqz p1, :cond_0

    iget-object p1, p0, mContractedWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
    ...
    iget-object p1, p0, mExpandedWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
    ...
    :cond_1
    iget-object p1, p0, mHeadsUpChild:Landroid/view/View;

    if-eqz p1, :cond_2

    iget-object p1, p0, mHeadsUpWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
    ...
    :cond_2
    iget-object p1, p0, mAmbientChild:Landroid/view/View;

    if-eqz p1, :cond_3

    iget-object p1, p0, mAmbientWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
...
.method public setOnExpandedVisibleListener(Ljava/lang/Runnable;)V
    ...
    iput-object p1, p0, mExpandedVisibleListener:Ljava/lang/Runnable;
...
.method public setQuickReplyContractedChild(Landroid/view/View;)V
    ...
    iput-object p1, p0, mQuickReplyChild:Landroid/view/View;
    ...
    iput-object p1, p0, mQuickReplyContractedWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
...
.method public setQuickReplyHeadsUpChild(Landroid/view/View;)V
    ...
    iput-object p1, p0, mQuickReplyHeadsUpChild:Landroid/view/View;

    iput-object p1, p0, mQuickReplyHeadsUpWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
...
.method public setRemoteInputController(Lcom/android/systemui/statusbar/RemoteInputController;)V
    ...
    iput-object p1, p0, mRemoteInputController:Lcom/android/systemui/statusbar/RemoteInputController;
...
.method public setRemoteInputVisible(Z)V
    ...
    iput-boolean p1, p0, mRemoteInputVisible:Z

    xor-int/lit8 p1, p1, 0x1

    invoke-virtual {p0, p1}, setClipChildren(Z)V
...
.method public setSingleLineWidthIndention(I)V
    ...
    iget v0, p0, mSingleLineWidthIndention:I

    if-eq p1, v0, :cond_0

    iput p1, p0, mSingleLineWidthIndention:I
...
.method public setUserExpanding(Z)V
    ...
    iput-boolean p1, p0, mUserExpanding:Z
    ...
    invoke-direct {p0, p1}, updateViewVisibilities(I)V
...
.method public shouldClipToRounding(ZZ)Z
    ...
    invoke-direct {p0, v0, p1, p2}, shouldClipToRounding(IZZ)Z

    move-result v0

    iget-boolean v1, p0, mUserExpanding:Z

    if-eqz v1, :cond_0

    iget v1, p0, mTransformationStartVisibleType:I

    invoke-direct {p0, v1, p1, p2}, shouldClipToRounding(IZZ)Z
...
.method public updateExpandButtons(Z)V
    ...
    iget-object v2, p0, mContractedChild:Landroid/view/View;
    ...
    :cond_8
    iput-boolean p1, p0, mIsContentExpandable:Z
