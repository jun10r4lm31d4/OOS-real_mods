...
.method public constructor <init>(Landroid/os/Handler;Landroid/content/Context;)V
    ...
    iput-boolean p2, p0, mDefaultEnabled:Z
    ...
    iput-boolean p2, p0, mDefaultRequiresP:Z
    ...
    iput p2, p0, mDefaultMaxSqueezeRemeasureAttempts:I
    ...
    iput-boolean p2, p0, mDefaultEditChoicesBeforeSending:Z
    ...
    iput-boolean p2, p0, mDefaultShowInHeadsUp:Z
    ...
    iput p2, p0, mDefaultMinNumSystemGeneratedReplies:I
    ...
    iput p2, p0, mDefaultMaxNumActions:I
    ...
    iput p1, p0, mDefaultOnClickInitDelay:I

    invoke-direct {p0}, registerDeviceConfigListener()V
...
.method public static synthetic lambda$6OXW9pAAXeePuUfPuGxYU98bifc(Lcom/android/systemui/statusbar/policy/SmartReplyConstants;Ljava/lang/Runnable;)V
    ...
    invoke-direct {p0, p1}, postToHandler(Ljava/lang/Runnable;)V
...
.method private updateConstants()V
    ...
    iget-boolean v1, p0, mDefaultEnabled:Z

    invoke-static {v0, v1}, readDeviceConfigBooleanOrDefaultIfEmpty(Ljava/lang/String;Z)Z
    ...
    iget-boolean v1, p0, mDefaultRequiresP:Z

    invoke-static {v0, v1}, readDeviceConfigBooleanOrDefaultIfEmpty(Ljava/lang/String;Z)Z

    move-result v0

    iput-boolean v0, p0, mRequiresTargetingP:Z

    const-string/jumbo v0, "systemui"

    const-string v1, "ssin_max_squeeze_remeasure_attempts"

    iget v2, p0, mDefaultMaxSqueezeRemeasureAttempts:I

    invoke-static {v0, v1, v2}, Landroid/provider/DeviceConfig;->getInt(Ljava/lang/String;Ljava/lang/String;I)I

    move-result v0

    iput v0, p0, mMaxSqueezeRemeasureAttempts:I

    const-string v0, "ssin_edit_choices_before_sending"

    iget-boolean v1, p0, mDefaultEditChoicesBeforeSending:Z

    invoke-static {v0, v1}, readDeviceConfigBooleanOrDefaultIfEmpty(Ljava/lang/String;Z)Z

    move-result v0

    iput-boolean v0, p0, mEditChoicesBeforeSending:Z

    const-string v0, "ssin_show_in_heads_up"

    iget-boolean v1, p0, mDefaultShowInHeadsUp:Z

    invoke-static {v0, v1}, readDeviceConfigBooleanOrDefaultIfEmpty(Ljava/lang/String;Z)Z

    move-result v0

    iput-boolean v0, p0, mShowInHeadsUp:Z

    const-string/jumbo v0, "systemui"

    const-string v1, "ssin_min_num_system_generated_replies"

    iget v2, p0, mDefaultMinNumSystemGeneratedReplies:I

    invoke-static {v0, v1, v2}, Landroid/provider/DeviceConfig;->getInt(Ljava/lang/String;Ljava/lang/String;I)I

    move-result v0

    iput v0, p0, mMinNumSystemGeneratedReplies:I

    const-string/jumbo v0, "systemui"

    const-string v1, "ssin_max_num_actions"

    iget v2, p0, mDefaultMaxNumActions:I

    invoke-static {v0, v1, v2}, Landroid/provider/DeviceConfig;->getInt(Ljava/lang/String;Ljava/lang/String;I)I

    move-result v0

    iput v0, p0, mMaxNumActions:I

    const-string/jumbo v0, "systemui"

    const-string v1, "ssin_onclick_init_delay"

    iget v2, p0, mDefaultOnClickInitDelay:I
    ...
    iput-wide v0, p0, mOnClickInitDelay:J
...
.method public getEffectiveEditChoicesBeforeSending(I)Z
    ...
    iget-boolean p0, p0, mEditChoicesBeforeSending:Z
...
.method public getMaxSqueezeRemeasureAttempts()I
    ...
    iget p0, p0, mMaxSqueezeRemeasureAttempts:I
...
.method public getMinNumSystemGeneratedReplies()I
    ...
    iget p0, p0, mMinNumSystemGeneratedReplies:I
...
.method public getOnClickInitDelay()J
    ...
    iget-wide v0, p0, mOnClickInitDelay:J
...
.method public getShowInHeadsUp()Z
    ...
    iget-boolean p0, p0, mShowInHeadsUp:Z
...
.method public synthetic lambda$registerDeviceConfigListener$0$SmartReplyConstants(Landroid/provider/DeviceConfig$Properties;)V
    ...
    invoke-virtual {p0, p1}, onDeviceConfigPropertiesChanged(Ljava/lang/String;)V
...
.method public requiresTargetingP()Z
    ...
    iget-boolean p0, p0, mRequiresTargetingP:Z
