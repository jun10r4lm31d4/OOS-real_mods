...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/ExpandHelper$Callback;II)V
    ...
    iput-object v2, p0, mScaleGestureListener:Landroid/view/ScaleGestureDetector$OnScaleGestureListener;

    iput p3, p0, mSmallSize:I

    iget p3, p0, mSmallSize:I
    ...
    iput p3, p0, mMaximumStretch:F

    iput p4, p0, mLargeSize:I

    iput-object p1, p0, mContext:Landroid/content/Context;

    iput-object p2, p0, mCallback:Lcom/android/systemui/ExpandHelper$Callback;
    ...
    iput-object p2, p0, mScaler:Lcom/android/systemui/ExpandHelper$ViewScaler;

    const/16 p2, 0x30

    iput p2, p0, mGravity:I

    iget-object p2, p0, mScaler:Lcom/android/systemui/ExpandHelper$ViewScaler;
    ...
    iput-object p2, p0, mScaleAnimation:Landroid/animation/ObjectAnimator;
    ...
    iput p2, p0, mPullGestureMinXSpan:F
    ...
    iget-object p3, p0, mScaleGestureListener:Landroid/view/ScaleGestureDetector$OnScaleGestureListener;

    invoke-direct {p2, p1, p3}, Landroid/view/ScaleGestureDetector;-><init>(Landroid/content/Context;Landroid/view/ScaleGestureDetector$OnScaleGestureListener;)V

    iput-object p2, p0, mSGD:Landroid/view/ScaleGestureDetector;

    iget-object p2, p0, mSGD:Landroid/view/ScaleGestureDetector;
...
.method static synthetic access$000(Lcom/android/systemui/ExpandHelper;)Z
    ...
    iget-boolean p0, p0, mOnlyMovements:Z
...
.method static synthetic access$100(Lcom/android/systemui/ExpandHelper;)Lcom/android/systemui/statusbar/notification/row/ExpandableView;
    ...
    iget-object p0, p0, mResizedView:Lcom/android/systemui/statusbar/notification/row/ExpandableView;
...
.method static synthetic access$200(Lcom/android/systemui/ExpandHelper;)Z
    ...
    iget-boolean p0, p0, mExpanding:Z
...
.method static synthetic access$400(Lcom/android/systemui/ExpandHelper;)Lcom/android/systemui/ExpandHelper$Callback;
    ...
    iget-object p0, p0, mCallback:Lcom/android/systemui/ExpandHelper$Callback;
...
.method static synthetic access$500(Lcom/android/systemui/ExpandHelper;)Lcom/android/systemui/ExpandHelper$ViewScaler;
    ...
    iget-object p0, p0, mScaler:Lcom/android/systemui/ExpandHelper$ViewScaler;
...
.method static synthetic access$600(Lcom/android/systemui/ExpandHelper;)Landroid/animation/ObjectAnimator;
    ...
    iget-object p0, p0, mScaleAnimation:Landroid/animation/ObjectAnimator;
...
.method private cancel(Z)V
    ...
    invoke-direct {p0, v0, v1, p1}, finishExpanding(ZFZ)V

    invoke-direct {p0}, clearView()V

    new-instance p1, Landroid/view/ScaleGestureDetector;

    iget-object v0, p0, mContext:Landroid/content/Context;

    iget-object v1, p0, mScaleGestureListener:Landroid/view/ScaleGestureDetector$OnScaleGestureListener;

    invoke-direct {p1, v0, v1}, Landroid/view/ScaleGestureDetector;-><init>(Landroid/content/Context;Landroid/view/ScaleGestureDetector$OnScaleGestureListener;)V

    iput-object p1, p0, mSGD:Landroid/view/ScaleGestureDetector;

    iget-object p1, p0, mSGD:Landroid/view/ScaleGestureDetector;
...
.method private clearView()V
    ...
    iput-object v0, p0, mResizedView:Lcom/android/systemui/statusbar/notification/row/ExpandableView;
...
.method private findView(FF)Lcom/android/systemui/statusbar/notification/row/ExpandableView;
    ...
    iget-object v0, p0, mEventSource:Landroid/view/View;
...
.method private finishExpanding(ZFZ)V
    ...
    :cond_0
    iget-object v0, p0, mScaler:Lcom/android/systemui/ExpandHelper$ViewScaler;

    invoke-virtual {v0}, Lcom/android/systemui/ExpandHelper$ViewScaler;->getHeight()F

    move-result v0

    iget v1, p0, mOldHeight:F

    iget v2, p0, mSmallSize:I
    ...
    :goto_2
    iget v1, p0, mNaturalHeight:F

    iget v5, p0, mSmallSize:I
    ...
    :goto_4
    iget-object v1, p0, mScaleAnimation:Landroid/animation/ObjectAnimator;
    ...
    :cond_7
    iget-object v1, p0, mCallback:Lcom/android/systemui/ExpandHelper$Callback;

    invoke-interface {v1, v3}, Lcom/android/systemui/ExpandHelper$Callback;->expansionStateChanged(Z)V

    iget-object v1, p0, mScaler:Lcom/android/systemui/ExpandHelper$ViewScaler;
    ...
    iget-object p3, p0, mScaleAnimation:Landroid/animation/ObjectAnimator;
    ...
    iget-object p3, p0, mResizedView:Lcom/android/systemui/statusbar/notification/row/ExpandableView;

    iget-object v5, p0, mScaleAnimation:Landroid/animation/ObjectAnimator;
    ...
    :goto_7
    iget-object p1, p0, mFlingAnimationUtils:Lcom/android/systemui/statusbar/FlingAnimationUtils;
    ...
    iget-object p1, p0, mScaleAnimation:Landroid/animation/ObjectAnimator;
    ...
    :cond_c
    iget-object p2, p0, mCallback:Lcom/android/systemui/ExpandHelper$Callback;

    iget-object p3, p0, mResizedView:Lcom/android/systemui/statusbar/notification/row/ExpandableView;

    invoke-interface {p2, p3, p1}, Lcom/android/systemui/ExpandHelper$Callback;->setUserExpandedChild(Landroid/view/View;Z)V

    iget-object p1, p0, mCallback:Lcom/android/systemui/ExpandHelper$Callback;

    iget-object p2, p0, mResizedView:Lcom/android/systemui/statusbar/notification/row/ExpandableView;

    invoke-interface {p1, p2, v3}, Lcom/android/systemui/ExpandHelper$Callback;->setUserLockedChild(Landroid/view/View;Z)V

    iget-object p1, p0, mScaler:Lcom/android/systemui/ExpandHelper$ViewScaler;
    ...
    :goto_8
    iput-boolean v3, p0, mExpanding:Z

    iput v3, p0, mExpansionStyle:I
...
.method private isInside(Landroid/view/View;FF)Z
    ...
    :cond_0
    iget-object p0, p0, mEventSource:Landroid/view/View;
...
.method public cancel()V
    ...
    invoke-direct {p0, v0}, cancel(Z)V
...
.method finishExpanding(ZF)V
    ...
    invoke-direct {p0, p1, p2, v0}, finishExpanding(ZFZ)V
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    invoke-direct {p0, p1}, trackVelocity(Landroid/view/MotionEvent;)V

    invoke-virtual {p1}, Landroid/view/MotionEvent;->getAction()I

    move-result v0

    iget-object v2, p0, mSGD:Landroid/view/ScaleGestureDetector;
    ...
    iget-object v3, p0, mSGD:Landroid/view/ScaleGestureDetector;
    ...
    iput v3, p0, mInitialTouchFocusY:F

    iget-object v4, p0, mSGD:Landroid/view/ScaleGestureDetector;

    invoke-virtual {v4}, Landroid/view/ScaleGestureDetector;->getCurrentSpan()F

    move-result v4

    iput v4, p0, mInitialTouchSpan:F

    iget v4, p0, mInitialTouchFocusY:F

    iput v4, p0, mLastFocusY:F

    iget v4, p0, mInitialTouchSpan:F

    iput v4, p0, mLastSpanY:F

    iget-boolean v4, p0, mExpanding:Z
    ...
    invoke-direct {p0, p1}, maybeRecycleVelocityTracker(Landroid/view/MotionEvent;)V
    ...
    :cond_3
    iget-object v0, p0, mSGD:Landroid/view/ScaleGestureDetector;

    invoke-virtual {v0}, Landroid/view/ScaleGestureDetector;->getCurrentSpanX()F

    move-result v0

    iget v2, p0, mPullGestureMinXSpan:F
    ...
    iget-object v0, p0, mResizedView:Lcom/android/systemui/statusbar/notification/row/ExpandableView;

    invoke-virtual {p0, v0, v4}, startExpanding(Lcom/android/systemui/statusbar/notification/row/ExpandableView;I)Z

    iput-boolean v1, p0, mWatchingForPull:Z

    :cond_4
    iget-boolean v0, p0, mWatchingForPull:Z
    ...
    invoke-direct {p0, v0}, isFullyExpanded(Lcom/android/systemui/statusbar/notification/row/ExpandableView;)Z
    ...
    invoke-virtual {p0, v0, v5}, startExpanding(Lcom/android/systemui/statusbar/notification/row/ExpandableView;I)Z
    ...
    iput-boolean v1, p0, mHasPopped:Z
    ...
    :cond_6
    invoke-direct {p0}, getCurrentVelocity()F

    move-result v0

    invoke-virtual {p0, v1, v0}, finishExpanding(ZF)V
    ...
    :cond_7
    iget-object v0, p0, mScrollAdapter:Lcom/android/systemui/statusbar/policy/ScrollAdapter;
    ...
    invoke-direct {p0, v0, v4, v3}, isInside(Landroid/view/View;FF)Z
    ...
    :goto_0
    iput-boolean v5, p0, mWatchingForPull:Z

    int-to-float v0, v2

    invoke-direct {p0, v0, v3}, findView(FF)Lcom/android/systemui/statusbar/notification/row/ExpandableView;
    ...
    iget-object v2, p0, mCallback:Lcom/android/systemui/ExpandHelper$Callback;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v4, p0, mOnlyMovements:Z
    ...
    iget v0, p0, mInitialTouchSpan:F
    ...
    iget v3, p0, mLastSpanY:F

    sub-float/2addr v2, v3

    add-float/2addr v0, v2

    iput v0, p0, mInitialTouchSpan:F
    ...
    iget v2, p0, mCurrentHeight:F

    add-float/2addr v0, v2

    invoke-direct {p0, v0}, clamp(F)F

    move-result v2

    iget v3, p0, mNaturalHeight:F
    ...
    :cond_6
    iget-boolean v0, p0, mHasPopped:Z
    ...
    :cond_7
    iput-boolean v4, p0, mHasPopped:Z
    ...
    invoke-virtual {p0}, updateExpansion()V
    ...
    invoke-virtual {p0, v0, v2}, finishExpanding(ZF)V
    ...
    invoke-direct {p0, v0, v5, v6}, isInside(Landroid/view/View;FF)Z
    ...
    :goto_4
    iput-boolean v0, p0, mWatchingForPull:Z

    int-to-float v0, v2

    int-to-float v2, v3

    invoke-direct {p0, v0, v2}, findView(FF)Lcom/android/systemui/statusbar/notification/row/ExpandableView;
...
.method public onlyObserveMovements(Z)V
    ...
    iput-boolean p1, p0, mOnlyMovements:Z
...
.method public setEventSource(Landroid/view/View;)V
    ...
    iput-object p1, p0, mEventSource:Landroid/view/View;
...
.method public setScrollAdapter(Lcom/android/systemui/statusbar/policy/ScrollAdapter;)V
    ...
    iput-object p1, p0, mScrollAdapter:Lcom/android/systemui/statusbar/policy/ScrollAdapter;
...
.method startExpanding(Lcom/android/systemui/statusbar/notification/row/ExpandableView;I)Z
    ...
    :cond_0
    iput p2, p0, mExpansionStyle:I

    iget-boolean p2, p0, mExpanding:Z
    ...
    iput p2, p0, mOldHeight:F

    iget p2, p0, mOldHeight:F

    iput p2, p0, mCurrentHeight:F
    ...
    iput p2, p0, mNaturalHeight:F

    invoke-virtual {p1}, Lcom/android/systemui/statusbar/notification/row/ExpandableView;->getCollapsedHeight()I

    move-result p1

    iput p1, p0, mSmallSize:I
...
.method updateExpansion()V
    ...
    iget v1, p0, mInitialTouchSpan:F
    ...
    iget v3, p0, mInitialTouchFocusY:F
    ...
    iget v0, p0, mOldHeight:F

    add-float/2addr v2, v0

    invoke-direct {p0, v2}, clamp(F)F
