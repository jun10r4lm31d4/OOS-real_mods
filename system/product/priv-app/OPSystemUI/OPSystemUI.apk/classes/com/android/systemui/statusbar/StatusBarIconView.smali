...
.method static constructor <clinit>()V
    ...
    sput-object v0, ICON_APPEAR_AMOUNT:Landroid/util/Property;
    ...
    sput-object v0, DOT_APPEAR_AMOUNT:Landroid/util/Property;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput p2, p0, mSystemIconDesiredHeight:F

    const/high16 p2, 0x41880000    # 17.0f

    iput p2, p0, mSystemIconIntrinsicHeight:F

    iget p2, p0, mSystemIconDesiredHeight:F

    iget v0, p0, mSystemIconIntrinsicHeight:F

    div-float/2addr p2, v0

    iput p2, p0, mSystemIconDefaultScale:F

    const/16 p2, 0x64

    iput p2, p0, ANIMATION_DURATION_FAST:I

    const/4 p2, 0x1

    iput p2, p0, mStatusBarIconDrawingSizeDark:I

    iput p2, p0, mStatusBarIconDrawingSize:I

    iput p2, p0, mStatusBarIconSize:I

    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, p0, mIconScale:F

    new-instance v1, Landroid/graphics/Paint;

    invoke-direct {v1, p2}, Landroid/graphics/Paint;-><init>(I)V

    iput-object v1, p0, mDotPaint:Landroid/graphics/Paint;

    const/4 v1, 0x0

    iput v1, p0, mVisibleState:I

    iput v0, p0, mIconAppearAmount:F

    iput v1, p0, mCurrentSetColor:I

    iput v1, p0, mAnimationStartColor:I
    ...
    iput-object v0, p0, mColorUpdater:Landroid/animation/ValueAnimator$AnimatorUpdateListener;

    iput v1, p0, mCachedContrastBackgroundColor:I

    iput-boolean p2, p0, mDirty:Z
    ...
    iput-object v0, p0, mDozer:Lcom/android/systemui/statusbar/notification/NotificationIconDozeHelper;

    iput-boolean v1, p0, mBlocked:Z

    iput-boolean p2, p0, mAlwaysScaleIcon:Z

    invoke-direct {p0}, reloadDimens()V

    invoke-direct {p0}, maybeUpdateIconScaleDimens()V
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/service/notification/StatusBarNotification;)V
    ...
    invoke-direct {p0, p1, p2, p3, v0}, <init>(Landroid/content/Context;Ljava/lang/String;Landroid/service/notification/StatusBarNotification;Z)V
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/service/notification/StatusBarNotification;Z)V
    ...
    iput v0, p0, mSystemIconDesiredHeight:F

    const/high16 v0, 0x41880000    # 17.0f

    iput v0, p0, mSystemIconIntrinsicHeight:F

    iget v0, p0, mSystemIconDesiredHeight:F

    iget v1, p0, mSystemIconIntrinsicHeight:F

    div-float/2addr v0, v1

    iput v0, p0, mSystemIconDefaultScale:F

    const/16 v0, 0x64

    iput v0, p0, ANIMATION_DURATION_FAST:I

    const/4 v0, 0x1

    iput v0, p0, mStatusBarIconDrawingSizeDark:I

    iput v0, p0, mStatusBarIconDrawingSize:I

    iput v0, p0, mStatusBarIconSize:I

    const/high16 v1, 0x3f800000    # 1.0f

    iput v1, p0, mIconScale:F

    new-instance v2, Landroid/graphics/Paint;

    invoke-direct {v2, v0}, Landroid/graphics/Paint;-><init>(I)V

    iput-object v2, p0, mDotPaint:Landroid/graphics/Paint;

    const/4 v2, 0x0

    iput v2, p0, mVisibleState:I

    iput v1, p0, mIconAppearAmount:F

    iput v2, p0, mCurrentSetColor:I

    iput v2, p0, mAnimationStartColor:I
    ...
    iput-object v1, p0, mColorUpdater:Landroid/animation/ValueAnimator$AnimatorUpdateListener;

    iput v2, p0, mCachedContrastBackgroundColor:I
    ...
    iput-object v1, p0, mDozer:Lcom/android/systemui/statusbar/notification/NotificationIconDozeHelper;

    iput-boolean p4, p0, mBlocked:Z

    iput-object p2, p0, mSlot:Ljava/lang/String;

    new-instance p2, Landroid/graphics/Paint;

    invoke-direct {p2}, Landroid/graphics/Paint;-><init>()V

    iput-object p2, p0, mNumberPain:Landroid/graphics/Paint;

    iget-object p2, p0, mNumberPain:Landroid/graphics/Paint;
    ...
    invoke-virtual {p0, p3}, setNotification(Landroid/service/notification/StatusBarNotification;)V
    ...
    :goto_0
    iput-boolean v0, p0, mNightMode:Z

    invoke-direct {p0}, initializeDecorColor()V
...
.method static synthetic access$002(Lcom/android/systemui/statusbar/StatusBarIconView;Landroid/animation/ValueAnimator;)Landroid/animation/ValueAnimator;
    ...
    iput-object p1, p0, mColorAnimator:Landroid/animation/ValueAnimator;
...
.method static synthetic access$102(Lcom/android/systemui/statusbar/StatusBarIconView;I)I
    ...
    iput p1, p0, mAnimationStartColor:I
...
.method static synthetic access$202(Lcom/android/systemui/statusbar/StatusBarIconView;Landroid/animation/ObjectAnimator;)Landroid/animation/ObjectAnimator;
    ...
    iput-object p1, p0, mIconAppearAnimator:Landroid/animation/ObjectAnimator;
...
.method static synthetic access$300(Lcom/android/systemui/statusbar/StatusBarIconView;Ljava/lang/Runnable;)V
    ...
    invoke-direct {p0, p1}, runRunnable(Ljava/lang/Runnable;)V
...
.method static synthetic access$402(Lcom/android/systemui/statusbar/StatusBarIconView;Landroid/animation/ObjectAnimator;)Landroid/animation/ObjectAnimator;
    ...
    iput-object p1, p0, mDotAnimator:Landroid/animation/ObjectAnimator;
...
.method private applyIconAndColors()V
    ...
    invoke-virtual {p0}, getSlot()Ljava/lang/String;
    ...
    invoke-virtual {p0}, getStatusBarIcon()Lcom/android/internal/statusbar/StatusBarIcon;
    ...
    invoke-virtual {p0, v0}, setDecorColor(I)V
...
.method private getIcon(Lcom/android/internal/statusbar/StatusBarIcon;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, p1}, getIcon(Landroid/content/Context;Lcom/android/internal/statusbar/StatusBarIcon;)Landroid/graphics/drawable/Drawable;
...
.method private initializeDecorColor()V
    ...
    iget-object v0, p0, mNotification:Landroid/service/notification/StatusBarNotification;
    ...
    iget-boolean v1, p0, mNightMode:Z
...
.method private maybeUpdateIconScaleDimens()V
    ...
    iget-boolean v0, p0, mAlwaysScaleIcon:Z
    ...
    :cond_0
    invoke-direct {p0}, updateIconScaleForSystemIcons()V

    goto :goto_1

    :cond_1
    :goto_0
    invoke-direct {p0}, updateIconScaleForNotifications()V
...
.method private reloadDimens()V
    ...
    iget v0, p0, mDotRadius:F

    iget v1, p0, mStaticDotRadius:I
    ...
    iput v2, p0, mStatusBarIconSize:I
    ...
    iput v2, p0, mStatusBarIconDrawingSizeDark:I
    ...
    iput v2, p0, mStatusBarIconDrawingSize:I

    if-eqz v0, :cond_1

    iget v0, p0, mStaticDotRadius:I

    int-to-float v0, v0

    iput v0, p0, mDotRadius:F
...
.method private setColorInternal(I)V
    ...
    iput p1, p0, mCurrentSetColor:I

    invoke-direct {p0}, updateIconColor()V
...
.method private setContentDescription(Landroid/app/Notification;)V
    ...
    invoke-static {v0, p1}, contentDescForNotification(Landroid/content/Context;Landroid/app/Notification;)Ljava/lang/String;
...
.method private updateContrastedStaticColor()V
    ...
    iget v0, p0, mCachedContrastBackgroundColor:I
    ...
    iget v0, p0, mDrawableColor:I

    iput v0, p0, mContrastedDrawableColor:I
    ...
    iget v1, p0, mCachedContrastBackgroundColor:I
    ...
    iget v3, p0, mCachedContrastBackgroundColor:I
...
.method private updateDrawable(Z)Z
    ...
    iget-object v1, p0, mIcon:Lcom/android/internal/statusbar/StatusBarIcon;
    ...
    :cond_0
    :try_start_0
    invoke-direct {p0, v1}, getIcon(Lcom/android/internal/statusbar/StatusBarIcon;)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, p0, mSlot:Ljava/lang/String;
    ...
    iget-object p0, p0, mIcon:Lcom/android/internal/statusbar/StatusBarIcon;
    ...
    iget-object p0, p0, mSlot:Ljava/lang/String;
...
.method private updateIconColor()V
    ...
    iget v0, p0, mCurrentSetColor:I

    if-eqz v0, :cond_2

    iget-object v0, p0, mMatrixColorFilter:Landroid/graphics/ColorMatrixColorFilter;
    ...
    iput-object v0, p0, mMatrix:[F

    new-instance v0, Landroid/graphics/ColorMatrixColorFilter;

    iget-object v1, p0, mMatrix:[F

    invoke-direct {v0, v1}, Landroid/graphics/ColorMatrixColorFilter;-><init>([F)V

    iput-object v0, p0, mMatrixColorFilter:Landroid/graphics/ColorMatrixColorFilter;
    ...
    iget v3, p0, mDarkAmount:F

    mul-float/2addr v3, v2

    invoke-static {v1, v0, v3}, updateTintMatrix([FIF)V
    ...
    :cond_2
    iget-object v0, p0, mDozer:Lcom/android/systemui/statusbar/notification/NotificationIconDozeHelper;

    iget v1, p0, mDarkAmount:F
...
.method private updateIconScaleForNotifications()V
    ...
    iget v0, p0, mStatusBarIconDrawingSize:I

    int-to-float v0, v0

    iget v1, p0, mStatusBarIconDrawingSizeDark:I
    ...
    iget v1, p0, mStatusBarIconSize:I
    ...
    invoke-direct {p0}, updatePivot()V
...
.method private updateIconScaleForSystemIcons()V
    ...
    iget v0, p0, mSystemIconDefaultScale:F
...
.method public executeOnLayout(Ljava/lang/Runnable;)V
    ...
    iput-object p1, p0, mLayoutRunnable:Ljava/lang/Runnable;
...
.method getContrastedStaticDrawableColor(I)I
    ...
    iput p1, p0, mCachedContrastBackgroundColor:I

    invoke-direct {p0}, updateContrastedStaticColor()V

    :cond_0
    iget p0, p0, mContrastedDrawableColor:I
...
.method public getIconAppearAmount()F
    ...
    iget p0, p0, mIconAppearAmount:F
...
.method public getIconScaleFullyDark()F
    ...
    iget v0, p0, mStatusBarIconDrawingSizeDark:I

    int-to-float v0, v0

    iget p0, p0, mStatusBarIconDrawingSize:I
...
.method public getNotification()Landroid/service/notification/StatusBarNotification;
    ...
    iget-object p0, p0, mNotification:Landroid/service/notification/StatusBarNotification;
...
.method public synthetic lambda$new$0$StatusBarIconView(Landroid/animation/ValueAnimator;)V
    ...
    iget v0, p0, mAnimationStartColor:I

    iget v1, p0, mIconColor:I
    ...
    invoke-direct {p0, p1}, setColorInternal(I)V
...
.method public synthetic lambda$setDark$1$StatusBarIconView(Ljava/lang/Float;)V
    ...
    invoke-direct {p0}, updateDecorColor()V

    invoke-direct {p0}, updateIconColor()V

    invoke-direct {p0}, updateAllowAnimation()V
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    :goto_0
    iget-boolean v0, p0, mNightMode:Z

    if-eq p1, v0, :cond_2

    iput-boolean p1, p0, mNightMode:Z
...
.method public onDarkChanged(Landroid/graphics/Rect;FI)V
    ...
    iput p2, p0, mDarkIntensity:F

    iput p3, p0, mTint:I

    invoke-direct {p0}, applyIconAndColors()V
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget v0, p0, mIconAppearAmount:F
    ...
    iget v2, p0, mIconAppearAmount:F
    ...
    :cond_0
    iget-object v0, p0, mNumberBackground:Landroid/graphics/drawable/Drawable;

    if-eqz v0, :cond_1

    invoke-virtual {v0, p1}, Landroid/graphics/drawable/Drawable;->draw(Landroid/graphics/Canvas;)V

    iget-object v0, p0, mNumberText:Ljava/lang/String;

    iget v2, p0, mNumberX:I

    int-to-float v2, v2

    iget v3, p0, mNumberY:I

    int-to-float v3, v3

    iget-object v4, p0, mNumberPain:Landroid/graphics/Paint;

    invoke-virtual {p1, v0, v2, v3, v4}, Landroid/graphics/Canvas;->drawText(Ljava/lang/String;FFLandroid/graphics/Paint;)V

    :cond_1
    iget v0, p0, mDotAppearAmount:F
    ...
    :goto_0
    iget-object v2, p0, mDotPaint:Landroid/graphics/Paint;
    ...
    iget v0, p0, mStatusBarIconSize:I
    ...
    iget-object p0, p0, mDotPaint:Landroid/graphics/Paint;
...
.method protected onLayout(ZIIII)V
    ...
    iget-object p1, p0, mLayoutRunnable:Ljava/lang/Runnable;
    ...
    iget-object p1, p0, mNotification:Landroid/service/notification/StatusBarNotification;

    if-nez p1, :cond_1

    iget-boolean p1, p0, mDirty:Z
...
.method protected onSizeChanged(IIII)V
    ...
    iget-object p1, p0, mNumberBackground:Landroid/graphics/drawable/Drawable;

    if-eqz p1, :cond_0

    invoke-virtual {p0}, placeNumber()V
...
.method placeNumber()V
    ...
    :goto_0
    iput-object v0, p0, mNumberText:Ljava/lang/String;
    ...
    iget-object v5, p0, mNumberBackground:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v6, p0, mNumberBackground:Landroid/graphics/drawable/Drawable;
    ...
    iput v7, p0, mNumberY:I

    iget-object p0, p0, mNumberBackground:Landroid/graphics/drawable/Drawable;
...
.method public set(Lcom/android/internal/statusbar/StatusBarIcon;)Z
    ...
    iget-object v0, p0, mIcon:Lcom/android/internal/statusbar/StatusBarIcon;
    ...
    invoke-virtual {p0, v0, v3}, equalIcons(Landroid/graphics/drawable/Icon;Landroid/graphics/drawable/Icon;)Z
    ...
    iget-object v3, p0, mIcon:Lcom/android/internal/statusbar/StatusBarIcon;
    ...
    :goto_1
    iget-object v4, p0, mIcon:Lcom/android/internal/statusbar/StatusBarIcon;
    ...
    :goto_2
    iget-object v5, p0, mIcon:Lcom/android/internal/statusbar/StatusBarIcon;
    ...
    iput-object v6, p0, mIcon:Lcom/android/internal/statusbar/StatusBarIcon;
    ...
    invoke-direct {p0, v2}, updateDrawable(Z)Z
    ...
    iput-object v0, p0, mNumberBackground:Landroid/graphics/drawable/Drawable;
    ...
    :cond_8
    iput-object v6, p0, mNumberBackground:Landroid/graphics/drawable/Drawable;

    iput-object v6, p0, mNumberText:Ljava/lang/String;
...
.method public setDismissed()V
    ...
    iget-object p0, p0, mOnDismissListener:Ljava/lang/Runnable;
...
.method public setIconAppearAmount(F)V
    ...
    iput p1, p0, mIconAppearAmount:F
...
.method public setIconColor(IZ)V
    ...
    iget v0, p0, mIconColor:I

    if-eq v0, p1, :cond_3

    iput p1, p0, mIconColor:I

    iget-object v0, p0, mColorAnimator:Landroid/animation/ValueAnimator;
    ...
    iput v0, p0, mAnimationStartColor:I
    ...
    iget-object p1, p0, mColorAnimator:Landroid/animation/ValueAnimator;
    ...
    iget-object p2, p0, mColorUpdater:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    iget-object p0, p0, mColorAnimator:Landroid/animation/ValueAnimator;
...
.method public setIsInShelf(Z)V
    ...
    iput-boolean p1, p0, mIsInShelf:Z
...
.method public setNotification(Landroid/service/notification/StatusBarNotification;)V
    ...
    iput-object p1, p0, mNotification:Landroid/service/notification/StatusBarNotification;
    ...
    invoke-direct {p0, p1}, setContentDescription(Landroid/app/Notification;)V
...
.method public setOnDismissListener(Ljava/lang/Runnable;)V
    ...
    iput-object p1, p0, mOnDismissListener:Ljava/lang/Runnable;
...
.method public setOnVisibilityChangedListener(Lcom/android/systemui/statusbar/StatusBarIconView$OnVisibilityChangedListener;)V
    ...
    iput-object p1, p0, mOnVisibilityChangedListener:Lcom/android/systemui/statusbar/StatusBarIconView$OnVisibilityChangedListener;
...
.method public setStaticDrawableColor(I)V
    ...
    iget-object p0, p0, mDozer:Lcom/android/systemui/statusbar/notification/NotificationIconDozeHelper;
...
.method public setVisibility(I)V
    ...
    iget-object v0, p0, mOnVisibilityChangedListener:Lcom/android/systemui/statusbar/StatusBarIconView$OnVisibilityChangedListener;
...
.method public setVisibleState(I)V
    ...
    invoke-virtual {p0, p1, v0, v1}, setVisibleState(IZLjava/lang/Runnable;)V
...
.method public setVisibleState(IZ)V
    ...
    invoke-virtual {p0, p1, p2, v0}, setVisibleState(IZLjava/lang/Runnable;)V
...
.method public setVisibleState(IZLjava/lang/Runnable;)V
    ...
    invoke-virtual/range {v0 .. v5}, setVisibleState(IZLjava/lang/Runnable;J)V
...
.method public setVisibleState(IZLjava/lang/Runnable;J)V
    ...
    iget v3, v0, mVisibleState:I

    const/4 v4, 0x0

    if-eq v1, v3, :cond_d

    iput v1, v0, mVisibleState:I

    iget-object v3, v0, mIconAppearAnimator:Landroid/animation/ObjectAnimator;
    ...
    :cond_0
    iget-object v3, v0, mDotAnimator:Landroid/animation/ObjectAnimator;
    ...
    :goto_0
    invoke-virtual/range {p0 .. p0}, getIconAppearAmount()F
    ...
    sget-object v11, ICON_APPEAR_AMOUNT:Landroid/util/Property;
    ...
    iput-object v5, v0, mIconAppearAnimator:Landroid/animation/ObjectAnimator;

    iget-object v5, v0, mIconAppearAnimator:Landroid/animation/ObjectAnimator;
    ...
    :cond_6
    invoke-virtual/range {p0 .. p0}, getDotAppearAmount()F
    ...
    sget-object v8, DOT_APPEAR_AMOUNT:Landroid/util/Property;
    ...
    iput-object v1, v0, mDotAnimator:Landroid/animation/ObjectAnimator;

    iget-object v1, v0, mDotAnimator:Landroid/animation/ObjectAnimator;
    ...
    :goto_5
    invoke-virtual {v0, v3}, setIconAppearAmount(F)V
    ...
    :cond_c
    :goto_6
    invoke-virtual {v0, v6}, setDotAppearAmount(F)V

    :cond_d
    :goto_7
    if-nez v4, :cond_e

    invoke-direct {v0, v2}, runRunnable(Ljava/lang/Runnable;)V
...
.method public updateDrawable()V
    ...
    invoke-direct {p0, v0}, updateDrawable(Z)Z
