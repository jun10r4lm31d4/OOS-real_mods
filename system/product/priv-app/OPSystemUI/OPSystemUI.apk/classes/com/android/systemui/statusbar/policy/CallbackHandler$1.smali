...
.method constructor <init>(Lcom/android/systemui/statusbar/policy/CallbackHandler;ZLcom/android/systemui/statusbar/policy/NetworkController$IconState;Lcom/android/systemui/statusbar/policy/NetworkController$IconState;ZZLjava/lang/String;ZLjava/lang/String;)V
    ...
    iput-object p1, p0, this$0:Lcom/android/systemui/statusbar/policy/CallbackHandler;

    iput-boolean p2, p0, val$enabled:Z

    iput-object p3, p0, val$statusIcon:Lcom/android/systemui/statusbar/policy/NetworkController$IconState;

    iput-object p4, p0, val$qsIcon:Lcom/android/systemui/statusbar/policy/NetworkController$IconState;

    iput-boolean p5, p0, val$activityIn:Z

    iput-boolean p6, p0, val$activityOut:Z

    iput-object p7, p0, val$description:Ljava/lang/String;

    iput-boolean p8, p0, val$isTransient:Z

    iput-object p9, p0, val$secondaryLabel:Ljava/lang/String;
...
.method public run()V
    ...
    iget-object v0, p0, this$0:Lcom/android/systemui/statusbar/policy/CallbackHandler;
    ...
    iget-boolean v3, p0, val$enabled:Z

    iget-object v4, p0, val$statusIcon:Lcom/android/systemui/statusbar/policy/NetworkController$IconState;

    iget-object v5, p0, val$qsIcon:Lcom/android/systemui/statusbar/policy/NetworkController$IconState;

    iget-boolean v6, p0, val$activityIn:Z

    iget-boolean v7, p0, val$activityOut:Z

    iget-object v8, p0, val$description:Ljava/lang/String;

    iget-boolean v9, p0, val$isTransient:Z

    iget-object v10, p0, val$secondaryLabel:Ljava/lang/String;
