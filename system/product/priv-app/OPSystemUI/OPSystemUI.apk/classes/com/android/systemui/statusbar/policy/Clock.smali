...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-boolean p3, p0, mClockVisibleByPolicy:Z

    iput-boolean p3, p0, mClockVisibleByUser:Z

    const/4 v0, 0x0

    iput v0, p0, mTimeTickCount:I
    ...
    iput-object v1, p0, mSecondTick:Ljava/lang/Runnable;
    ...
    iput-boolean p3, p0, mShowDark:Z

    invoke-virtual {p0}, Landroid/widget/TextView;->getCurrentTextColor()I

    move-result p3

    iput p3, p0, mNonAdaptedColor:I
    :try_end_0
    ...
    iput-object p2, p0, mCurrentUserTracker:Lcom/android/systemui/settings/CurrentUserTracker;
...
.method static synthetic access$1000(Lcom/android/systemui/statusbar/policy/Clock;)V
    ...
    invoke-direct {p0}, runSecondTick()V
...
.method static synthetic access$200(Lcom/android/systemui/statusbar/policy/Clock;)Z
    ...
    invoke-direct {p0}, showSeconds()Z
...
.method static synthetic access$300(Lcom/android/systemui/statusbar/policy/Clock;)Landroid/os/Handler;
    ...
    iget-object p0, p0, mSecondsHandler:Landroid/os/Handler;
...
.method static synthetic access$400(Lcom/android/systemui/statusbar/policy/Clock;)Ljava/lang/Runnable;
    ...
    iget-object p0, p0, mSecondTick:Ljava/lang/Runnable;
...
.method static synthetic access$508(Lcom/android/systemui/statusbar/policy/Clock;)I
    ...
    iget v0, p0, mTimeTickCount:I

    add-int/lit8 v1, v0, 0x1

    iput v1, p0, mTimeTickCount:I
...
.method static synthetic access$600(Lcom/android/systemui/statusbar/policy/Clock;)Ljava/util/Locale;
    ...
    iget-object p0, p0, mLocale:Ljava/util/Locale;
...
.method static synthetic access$702(Lcom/android/systemui/statusbar/policy/Clock;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object p1, p0, mClockFormatString:Ljava/lang/String;
...
.method static synthetic access$800(Lcom/android/systemui/statusbar/policy/Clock;)Ljava/util/Calendar;
    ...
    iget-object p0, p0, mCalendar:Ljava/util/Calendar;
...
.method static synthetic access$802(Lcom/android/systemui/statusbar/policy/Clock;Ljava/util/Calendar;)Ljava/util/Calendar;
    ...
    iput-object p1, p0, mCalendar:Ljava/util/Calendar;
...
.method static synthetic access$900(Lcom/android/systemui/statusbar/policy/Clock;)Ljava/text/SimpleDateFormat;
    ...
    iget-object p0, p0, mClockFormat:Ljava/text/SimpleDateFormat;
...
.method private final getSmallTime()Ljava/lang/CharSequence;
    ...
    :goto_0
    iget-object v1, p0, mClockFormatString:Ljava/lang/String;
    ...
    iput-object v1, p0, mContentDescriptionFormat:Ljava/text/SimpleDateFormat;

    iget v1, p0, mAmPmStyle:I
    ...
    iput-object v1, p0, mClockFormat:Ljava/text/SimpleDateFormat;

    iput-object v0, p0, mClockFormatString:Ljava/lang/String;

    goto :goto_4

    :cond_8
    iget-object v1, p0, mClockFormat:Ljava/text/SimpleDateFormat;
...
.method private releaseReceiver()V
    ...
    iget-object v0, p0, mSecondsHandler:Landroid/os/Handler;
    ...
    iget-object v1, p0, mScreenReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v1, p0, mSecondTick:Ljava/lang/Runnable;

    invoke-virtual {v0, v1}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    const/4 v0, 0x0

    iput-object v0, p0, mSecondsHandler:Landroid/os/Handler;

    invoke-virtual {p0}, updateClock()V
...
.method private shouldBeVisible()Z
    ...
    iget-boolean v0, p0, mClockVisibleByPolicy:Z

    if-eqz v0, :cond_0

    iget-boolean p0, p0, mClockVisibleByUser:Z
...
.method private showSeconds()Z
    ...
    iget-boolean p0, p0, mShowSeconds:Z
...
.method private updateClockVisibility()V
    ...
    invoke-direct {p0}, shouldBeVisible()Z
...
.method public disable(IIIZ)V
    ...
    :goto_0
    iget-boolean p2, p0, mClockVisibleByPolicy:Z

    if-eq p1, p2, :cond_2

    invoke-virtual {p0, p1}, setClockVisibilityByPolicy(Z)V
...
.method public dispatchDemoCommand(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    iget-object p2, p0, mCalendar:Ljava/util/Calendar;
    ...
    :cond_4
    :goto_1
    invoke-direct {p0}, getSmallTime()Ljava/lang/CharSequence;

    move-result-object p1

    invoke-virtual {p0, p1}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget-object p1, p0, mContentDescriptionFormat:Ljava/text/SimpleDateFormat;
...
.method protected onAttachedToWindow()V
    ...
    iget-object v2, p0, mScreenReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-boolean v0, p0, mShowDark:Z
    ...
    :cond_0
    iget-object v0, p0, mCurrentUserTracker:Lcom/android/systemui/settings/CurrentUserTracker;
    ...
    invoke-direct {p0}, updateClockVisibility()V

    invoke-direct {p0}, updateShowSeconds()V
...
.method public onDarkChanged(Landroid/graphics/Rect;FI)V
    ...
    iput p1, p0, mNonAdaptedColor:I

    iget-boolean p1, p0, mUseWallpaperTextColor:Z

    if-nez p1, :cond_0

    iget p1, p0, mNonAdaptedColor:I
...
.method protected onDetachedFromWindow()V
    ...
    invoke-direct {p0}, releaseReceiver()V
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    iput-boolean v1, p0, mClockVisibleByPolicy:Z
    ...
    iput-boolean v0, p0, mClockVisibleByUser:Z
    ...
    iput-boolean v0, p0, mShowSeconds:Z
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iget-boolean v1, p0, mClockVisibleByPolicy:Z

    const-string/jumbo v2, "visible_by_policy"

    invoke-virtual {v0, v2, v1}, Landroid/os/Bundle;->putBoolean(Ljava/lang/String;Z)V

    iget-boolean v1, p0, mClockVisibleByUser:Z

    const-string/jumbo v2, "visible_by_user"

    invoke-virtual {v0, v2, v1}, Landroid/os/Bundle;->putBoolean(Ljava/lang/String;Z)V

    iget-boolean v1, p0, mShowSeconds:Z
...
.method public onTuningChanged(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-boolean p1, p0, mShowSeconds:Z
    ...
    invoke-virtual {p0, p1}, setClockVisibleByUser(Z)V
...
.method public setClockVisibilityByPolicy(Z)V
    ...
    iput-boolean p1, p0, mClockVisibleByPolicy:Z
...
.method public setClockVisibleByUser(Z)V
    ...
    iput-boolean p1, p0, mClockVisibleByUser:Z
...
.method final updateClock()V
    ...
    iget-object v0, p0, mContentDescriptionFormat:Ljava/text/SimpleDateFormat;
...
.method public useWallpaperTextColor(Z)V
    ...
    iget-boolean v0, p0, mUseWallpaperTextColor:Z
    ...
    :cond_0
    iput-boolean p1, p0, mUseWallpaperTextColor:Z
