...
.method static constructor <clinit>()V
    ...
    sput-object v0, sTextViewComparator:Lcom/android/systemui/statusbar/NotificationHeaderUtil$TextViewComparator;
    ...
    sput-object v0, sVisibilityApplicator:Lcom/android/systemui/statusbar/NotificationHeaderUtil$VisibilityApplicator;
    ...
    sput-object v0, sIconExtractor:Lcom/android/systemui/statusbar/NotificationHeaderUtil$DataExtractor;
    ...
    sput-object v0, sIconVisibilityComparator:Lcom/android/systemui/statusbar/NotificationHeaderUtil$IconComparator;
    ...
    sput-object v0, sGreyComparator:Lcom/android/systemui/statusbar/NotificationHeaderUtil$IconComparator;
    ...
    sput-object v0, mGreyApplicator:Lcom/android/systemui/statusbar/NotificationHeaderUtil$ResultApplicator;
...
.method public constructor <init>(Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;)V
    ...
    iput-object v0, p0, mComparators:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, mDividers:Ljava/util/HashSet;

    iput-object p1, p0, mRow:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;

    iget-object p1, p0, mComparators:Ljava/util/ArrayList;

    new-instance v6, Lcom/android/systemui/statusbar/NotificationHeaderUtil$HeaderProcessor;

    iget-object v1, p0, mRow:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;

    sget-object v3, sIconExtractor:Lcom/android/systemui/statusbar/NotificationHeaderUtil$DataExtractor;

    sget-object v4, sIconVisibilityComparator:Lcom/android/systemui/statusbar/NotificationHeaderUtil$IconComparator;

    sget-object v5, sVisibilityApplicator:Lcom/android/systemui/statusbar/NotificationHeaderUtil$VisibilityApplicator;
    ...
    sget-object v4, sGreyComparator:Lcom/android/systemui/statusbar/NotificationHeaderUtil$IconComparator;

    sget-object v5, mGreyApplicator:Lcom/android/systemui/statusbar/NotificationHeaderUtil$ResultApplicator;
    ...
    iget-object p1, p0, mDividers:Ljava/util/HashSet;
    ...
    iget-object p0, p0, mDividers:Ljava/util/HashSet;
...
.method static synthetic access$300()Lcom/android/systemui/statusbar/NotificationHeaderUtil$TextViewComparator;
    ...
    sget-object v0, sTextViewComparator:Lcom/android/systemui/statusbar/NotificationHeaderUtil$TextViewComparator;
...
.method static synthetic access$400()Lcom/android/systemui/statusbar/NotificationHeaderUtil$VisibilityApplicator;
    ...
    sget-object v0, sVisibilityApplicator:Lcom/android/systemui/statusbar/NotificationHeaderUtil$VisibilityApplicator;
...
.method private sanitizeChild(Landroid/view/View;)V
    ...
    invoke-direct {p0, p1}, sanitizeHeader(Landroid/view/NotificationHeaderView;)V
...
.method private sanitizeHeader(Landroid/view/NotificationHeaderView;)V
    ...
    iget-object v8, p0, mDividers:Ljava/util/HashSet;
    ...
    iget-object v7, p0, mDividers:Ljava/util/HashSet;
...
.method private sanitizeHeaderViews(Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;)V
    ...
    invoke-direct {p0, v0}, sanitizeChild(Landroid/view/View;)V
    ...
    invoke-direct {p0, p1}, sanitizeChild(Landroid/view/View;)V
...
.method public restoreNotificationHeader(Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;)V
    ...
    :goto_0
    iget-object v1, p0, mComparators:Ljava/util/ArrayList;
    ...
    :cond_0
    invoke-direct {p0, p1}, sanitizeHeaderViews(Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;)V
...
.method public updateChildrenHeaderAppearance()V
    ...
    :goto_0
    iget-object v3, p0, mComparators:Ljava/util/ArrayList;
    ...
    :goto_2
    iget-object v5, p0, mComparators:Ljava/util/ArrayList;
    ...
    :cond_4
    invoke-direct {p0, v3}, sanitizeHeaderViews(Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;)V
