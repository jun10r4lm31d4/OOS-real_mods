...
.method public constructor <init>(Landroid/content/Context;F)V
    ...
    invoke-direct {p0, p1, p2, v0}, <init>(Landroid/content/Context;FF)V
...
.method public constructor <init>(Landroid/content/Context;FF)V
    ...
    invoke-direct/range {v0 .. v5}, <init>(Landroid/content/Context;FFFF)V
...
.method public constructor <init>(Landroid/content/Context;FFFF)V
    ...
    iput-object v0, p0, mAnimatorProperties:Lcom/android/systemui/statusbar/FlingAnimationUtils$AnimatorProperties;

    const/high16 v0, -0x40800000    # -1.0f

    iput v0, p0, mCachedStartGradient:F

    iput v0, p0, mCachedVelocityFactor:F

    iput p2, p0, mMaxLengthSeconds:F

    iput p3, p0, mSpeedUpFactor:F
    ...
    iput p3, p0, mMinVelocityPxPerSecond:F
    ...
    iput p1, p0, mHighVelocityPxPerSecond:F
...
.method private calculateLinearOutFasterInY2(F)F
    ...
    iget v0, p0, mMinVelocityPxPerSecond:F

    sub-float/2addr p1, v0

    iget p0, p0, mHighVelocityPxPerSecond:F
...
.method private getDismissingProperties(FFFF)Lcom/android/systemui/statusbar/FlingAnimationUtils$AnimatorProperties;
    ...
    iget v0, p0, mMaxLengthSeconds:F
    ...
    invoke-direct {p0, p3}, calculateLinearOutFasterInY2(F)F
    ...
    iget-object p1, p0, mAnimatorProperties:Lcom/android/systemui/statusbar/FlingAnimationUtils$AnimatorProperties;
    ...
    :cond_0
    iget p4, p0, mMinVelocityPxPerSecond:F
    ...
    iget-object p3, p0, mAnimatorProperties:Lcom/android/systemui/statusbar/FlingAnimationUtils$AnimatorProperties;
    ...
    :cond_1
    iget-object p2, p0, mAnimatorProperties:Lcom/android/systemui/statusbar/FlingAnimationUtils$AnimatorProperties;
    ...
    :goto_0
    iget-object p0, p0, mAnimatorProperties:Lcom/android/systemui/statusbar/FlingAnimationUtils$AnimatorProperties;
...
.method private getInterpolator(FF)Landroid/view/animation/Interpolator;
    ...
    :cond_0
    iget v0, p0, mCachedStartGradient:F

    cmpl-float v0, p1, v0

    if-nez v0, :cond_1

    iget v0, p0, mCachedVelocityFactor:F
    ...
    iget v2, p0, mLinearOutSlowInX2:F
    ...
    iput-object v4, p0, mInterpolator:Landroid/view/animation/PathInterpolator;
    :try_end_0
    .catch Ljava/lang/IllegalArgumentException; {:try_start_0 .. :try_end_0} :catch_0

    iput p1, p0, mCachedStartGradient:F

    iput p2, p0, mCachedVelocityFactor:F

    :cond_2
    iget-object p0, p0, mInterpolator:Landroid/view/animation/PathInterpolator;
...
.method private getProperties(FFFF)Lcom/android/systemui/statusbar/FlingAnimationUtils$AnimatorProperties;
    ...
    invoke-direct {p0, p4, v0}, getInterpolator(FF)Landroid/view/animation/Interpolator;
...
.method public apply(Landroid/animation/Animator;FFF)V
    ...
    invoke-virtual/range {v1 .. v6}, apply(Landroid/animation/Animator;FFFF)V
...
.method public apply(Landroid/animation/Animator;FFFF)V
    ...
    invoke-direct {p0, p2, p3, p4, p5}, getProperties(FFFF)Lcom/android/systemui/statusbar/FlingAnimationUtils$AnimatorProperties;
...
.method public applyDismissing(Landroid/animation/Animator;FFFF)V
    ...
    invoke-direct {p0, p2, p3, p4, p5}, getDismissingProperties(FFFF)Lcom/android/systemui/statusbar/FlingAnimationUtils$AnimatorProperties;
...
.method public getMinVelocityPxPerSecond()F
    ...
    iget p0, p0, mMinVelocityPxPerSecond:F
