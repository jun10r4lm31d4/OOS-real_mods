...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mDividerState:Lcom/android/systemui/stackdivider/DividerState;

    const/4 v0, 0x0

    iput-boolean v0, p0, mVisible:Z

    iput-boolean v0, p0, mMinimized:Z

    iput-boolean v0, p0, mAdjustedForIme:Z

    iput-boolean v0, p0, mHomeStackResizable:Z
...
.method static synthetic access$100(Lcom/android/systemui/stackdivider/Divider;)Lcom/android/systemui/stackdivider/DividerView;
    ...
    iget-object p0, p0, mView:Lcom/android/systemui/stackdivider/DividerView;
...
.method static synthetic access$200(Lcom/android/systemui/stackdivider/Divider;)Z
    ...
    iget-boolean p0, p0, mMinimized:Z
...
.method static synthetic access$202(Lcom/android/systemui/stackdivider/Divider;Z)Z
    ...
    iput-boolean p1, p0, mMinimized:Z
...
.method static synthetic access$300(Lcom/android/systemui/stackdivider/Divider;)Z
    ...
    iget-boolean p0, p0, mHomeStackResizable:Z
...
.method static synthetic access$302(Lcom/android/systemui/stackdivider/Divider;Z)Z
    ...
    iput-boolean p1, p0, mHomeStackResizable:Z
...
.method static synthetic access$400(Lcom/android/systemui/stackdivider/Divider;)V
    ...
    invoke-direct {p0}, updateTouchable()V
...
.method static synthetic access$500(Lcom/android/systemui/stackdivider/Divider;)Lcom/android/systemui/stackdivider/ForcedResizableInfoActivityController;
    ...
    iget-object p0, p0, mForcedResizableController:Lcom/android/systemui/stackdivider/ForcedResizableInfoActivityController;
...
.method static synthetic access$600(Lcom/android/systemui/stackdivider/Divider;Z)V
    ...
    invoke-direct {p0, p1}, updateVisibility(Z)V
...
.method static synthetic access$700(Lcom/android/systemui/stackdivider/Divider;Z)V
    ...
    invoke-direct {p0, p1}, notifyDockedStackExistsChanged(Z)V
...
.method static synthetic access$800(Lcom/android/systemui/stackdivider/Divider;ZJZ)V
    ...
    invoke-direct {p0, p1, p2, p3, p4}, updateMinimizedDockedStack(ZJZ)V
...
.method static synthetic access$900(Lcom/android/systemui/stackdivider/Divider;)Z
    ...
    iget-boolean p0, p0, mAdjustedForIme:Z
...
.method private addDivider(Landroid/content/res/Configuration;)V
    ...
    iput-object v0, p0, mView:Lcom/android/systemui/stackdivider/DividerView;

    iget-object v0, p0, mView:Lcom/android/systemui/stackdivider/DividerView;

    iget-object v1, p0, mWindowManager:Lcom/android/systemui/stackdivider/DividerWindowManager;

    iget-object v2, p0, mDividerState:Lcom/android/systemui/stackdivider/DividerState;
    ...
    iget-boolean v1, p0, mMinimized:Z

    iget-boolean v3, p0, mHomeStackResizable:Z
...
.method private removeDivider()V
    ...
    :cond_0
    iget-object p0, p0, mWindowManager:Lcom/android/systemui/stackdivider/DividerWindowManager;
...
.method private update(Landroid/content/res/Configuration;)V
    ...
    invoke-direct {p0}, removeDivider()V

    invoke-direct {p0, p1}, addDivider(Landroid/content/res/Configuration;)V

    iget-boolean p1, p0, mMinimized:Z

    if-eqz p1, :cond_0

    iget-object p1, p0, mView:Lcom/android/systemui/stackdivider/DividerView;
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-direct {p0, p1}, update(Landroid/content/res/Configuration;)V
...
.method public start()V
    ...
    iput-object v0, p0, mWindowManager:Lcom/android/systemui/stackdivider/DividerWindowManager;
    ...
    invoke-direct {p0, v0}, update(Landroid/content/res/Configuration;)V
    ...
    iput-object v0, p0, mDockDividerVisibilityListener:Lcom/android/systemui/stackdivider/Divider$DockDividerVisibilityListener;
    ...
    iget-object v1, p0, mDockDividerVisibilityListener:Lcom/android/systemui/stackdivider/Divider$DockDividerVisibilityListener;
    ...
    iput-object v0, p0, mForcedResizableController:Lcom/android/systemui/stackdivider/ForcedResizableInfoActivityController;
