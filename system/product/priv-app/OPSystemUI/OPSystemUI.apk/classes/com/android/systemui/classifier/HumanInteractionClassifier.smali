...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mBufferedEvents:Ljava/util/ArrayDeque;

    const/4 v0, 0x0

    iput-boolean v0, p0, mEnableClassifier:Z

    const/4 v1, 0x7

    iput v1, p0, mCurrentType:I
    ...
    iput-object p1, p0, mHistoryEvaluator:Lcom/android/systemui/classifier/HistoryEvaluator;
    ...
    iput-object p1, p0, mStrokeClassifiers:[Lcom/android/systemui/classifier/StrokeClassifier;
    ...
    iput-object p1, p0, mGestureClassifiers:[Lcom/android/systemui/classifier/GestureClassifier;
...
.method private addTouchEvent(Landroid/view/MotionEvent;)V
    ...
    :cond_0
    iget-object v2, v0, mStrokeClassifiers:[Lcom/android/systemui/classifier/StrokeClassifier;
    ...
    :cond_1
    iget-object v2, v0, mGestureClassifiers:[Lcom/android/systemui/classifier/GestureClassifier;
    ...
    :cond_3
    iget-object v12, v0, mStrokeClassifiers:[Lcom/android/systemui/classifier/StrokeClassifier;
    ...
    :cond_7
    iget-object v4, v0, mHistoryEvaluator:Lcom/android/systemui/classifier/HistoryEvaluator;
    ...
    :cond_e
    iget-object v2, v0, mHistoryEvaluator:Lcom/android/systemui/classifier/HistoryEvaluator;

    invoke-virtual {v2, v10}, Lcom/android/systemui/classifier/HistoryEvaluator;->addGesture(F)V

    const/4 v2, 0x7

    invoke-virtual {v0, v2}, setType(I)V
...
.method public static getInstance(Landroid/content/Context;)Lcom/android/systemui/classifier/HumanInteractionClassifier;
    ...
    sget-object v0, sInstance:Lcom/android/systemui/classifier/HumanInteractionClassifier;
    ...
    sput-object v0, sInstance:Lcom/android/systemui/classifier/HumanInteractionClassifier;

    :cond_0
    sget-object p0, sInstance:Lcom/android/systemui/classifier/HumanInteractionClassifier;
...
.method private updateConfiguration()V
    ...
    iput-boolean v1, p0, mEnableClassifier:Z
...
.method public isEnabled()Z
    ...
    iget-boolean p0, p0, mEnableClassifier:Z
...
.method public isFalseTouch()Z
    ...
    iget-boolean v0, p0, mEnableClassifier:Z

    const/4 v1, 0x0

    if-eqz v0, :cond_1

    iget-object p0, p0, mHistoryEvaluator:Lcom/android/systemui/classifier/HistoryEvaluator;
...
.method public onSensorChanged(Landroid/hardware/SensorEvent;)V
    ...
    iget-object v0, p0, mStrokeClassifiers:[Lcom/android/systemui/classifier/StrokeClassifier;
    ...
    :cond_0
    iget-object p0, p0, mGestureClassifiers:[Lcom/android/systemui/classifier/GestureClassifier;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)V
    ...
    :cond_1
    invoke-direct {p0, p1}, addTouchEvent(Landroid/view/MotionEvent;)V

    goto/16 :goto_2

    :cond_2
    :goto_0
    iget-object v0, p0, mBufferedEvents:Ljava/util/ArrayDeque;
    ...
    iget-object v2, p0, mBufferedEvents:Ljava/util/ArrayDeque;
    ...
    iget-object v3, p0, mBufferedEvents:Ljava/util/ArrayDeque;
    ...
    iget-object v1, p0, mBufferedEvents:Ljava/util/ArrayDeque;
    ...
    invoke-direct {p0, v1}, addTouchEvent(Landroid/view/MotionEvent;)V
    ...
    iget-object p1, p0, mBufferedEvents:Ljava/util/ArrayDeque;
    ...
    iget-object p0, p0, mBufferedEvents:Ljava/util/ArrayDeque;
