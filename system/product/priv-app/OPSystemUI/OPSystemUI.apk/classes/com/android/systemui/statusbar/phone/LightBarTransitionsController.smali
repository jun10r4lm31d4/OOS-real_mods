...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/statusbar/phone/LightBarTransitionsController$DarkIntensityApplier;)V
    ...
    iput-object v0, p0, mTransitionDeferringDoneRunnable:Ljava/lang/Runnable;

    iput-object p2, p0, mApplier:Lcom/android/systemui/statusbar/phone/LightBarTransitionsController$DarkIntensityApplier;
    ...
    iget-object p0, p0, mApplier:Lcom/android/systemui/statusbar/phone/LightBarTransitionsController$DarkIntensityApplier;
...
.method static synthetic access$002(Lcom/android/systemui/statusbar/phone/LightBarTransitionsController;Z)Z
    ...
    iput-boolean p1, p0, mTransitionDeferring:Z
...
.method private animateIconTint(FJJ)V
    ...
    iget v0, p0, mNextDarkIntensity:F
    ...
    :cond_0
    iget-object v0, p0, mTintAnimator:Landroid/animation/ValueAnimator;
    ...
    :cond_1
    iput p1, p0, mNextDarkIntensity:F
    ...
    iput-object p1, p0, mTintAnimator:Landroid/animation/ValueAnimator;

    iget-object p1, p0, mTintAnimator:Landroid/animation/ValueAnimator;
    ...
    iget-object p0, p0, mTintAnimator:Landroid/animation/ValueAnimator;
...
.method private deferIconTintChange(F)V
    ...
    iget-boolean v0, p0, mTintChangePending:Z

    if-eqz v0, :cond_0

    iget v0, p0, mPendingDarkIntensity:F
    ...
    iput-boolean v0, p0, mTintChangePending:Z

    iput p1, p0, mPendingDarkIntensity:F
...
.method private dispatchDark()V
    ...
    iget-object v0, p0, mApplier:Lcom/android/systemui/statusbar/phone/LightBarTransitionsController$DarkIntensityApplier;
...
.method private setIconTintInternal(F)V
    ...
    iput p1, p0, mDarkIntensity:F

    invoke-direct {p0}, dispatchDark()V
...
.method public appTransitionCancelled(I)V
    ...
    :cond_0
    iget-boolean p1, p0, mTransitionPending:Z

    const/4 v0, 0x0

    if-eqz p1, :cond_1

    iget-boolean p1, p0, mTintChangePending:Z

    if-eqz p1, :cond_1

    iput-boolean v0, p0, mTintChangePending:Z

    iget v2, p0, mPendingDarkIntensity:F

    const-wide/16 v3, 0x0

    iget-object p1, p0, mApplier:Lcom/android/systemui/statusbar/phone/LightBarTransitionsController$DarkIntensityApplier;
    ...
    invoke-direct/range {v1 .. v6}, animateIconTint(FJJ)V

    :cond_1
    iput-boolean v0, p0, mTransitionPending:Z
...
.method public appTransitionPending(IZ)V
    ...
    iput-boolean p1, p0, mTransitionPending:Z
...
.method public appTransitionStarting(IJJZ)V
    ...
    iget-object v1, p0, mApplier:Lcom/android/systemui/statusbar/phone/LightBarTransitionsController$DarkIntensityApplier;
    ...
    iget v1, p0, mPendingDarkIntensity:F
    ...
    iget p6, p0, mNextDarkIntensity:F
    ...
    iput-wide p2, p0, mTransitionDeferringStartTime:J

    iput-wide p4, p0, mTransitionDeferringDuration:J

    iget-object p1, p0, mHandler:Landroid/os/Handler;

    iget-object p4, p0, mTransitionDeferringDoneRunnable:Ljava/lang/Runnable;
...
.method public bypassTransition(Z)V
    ...
    iput-boolean p1, p0, mBypassTransition:Z
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-boolean p1, p0, mTransitionDeferring:Z
    ...
    iget-wide v0, p0, mTransitionDeferringStartTime:J
    ...
    iget-wide v0, p0, mTransitionDeferringDuration:J
    ...
    iget p1, p0, mPendingDarkIntensity:F
    ...
    iget p0, p0, mNextDarkIntensity:F
...
.method public synthetic lambda$animateIconTint$0$LightBarTransitionsController(Landroid/animation/ValueAnimator;)V
    ...
    invoke-direct {p0, p1}, setIconTintInternal(F)V
...
.method public setIconsDark(ZZ)V
    ...
    iget-object v3, p0, mApplier:Lcom/android/systemui/statusbar/phone/LightBarTransitionsController$DarkIntensityApplier;
    ...
    iget-boolean v4, p0, mTransitionPending:Z

    invoke-virtual {v2, v4}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v4, p0, mTransitionDeferring:Z

    invoke-virtual {v2, v4}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v3, p0, mNextDarkIntensity:F
    ...
    iget v3, p0, mPendingDarkIntensity:F
    ...
    :goto_0
    invoke-direct {p0, v1}, setIconTintInternal(F)V
    ...
    :goto_1
    iput v2, p0, mNextDarkIntensity:F

    goto :goto_5

    :cond_3
    iget-boolean v1, p0, mTransitionPending:Z

    if-eqz v1, :cond_5

    iget-boolean v1, p0, mBypassTransition:Z
    ...
    :goto_2
    invoke-direct {p0, v2}, deferIconTintChange(F)V

    goto :goto_5

    :cond_5
    iget-boolean v1, p0, mTransitionDeferring:Z
    ...
    iget-wide v4, p0, mTransitionDeferringStartTime:J
    ...
    iget-wide v4, p0, mTransitionDeferringDuration:J

    move-object v0, p0

    invoke-direct/range {v0 .. v5}, animateIconTint(FJJ)V
    ...
    :goto_5
    iget-boolean v0, p0, mBypassTransition:Z

    if-eqz v0, :cond_9

    const/4 v0, 0x0

    iput-boolean v0, p0, mBypassTransition:Z
