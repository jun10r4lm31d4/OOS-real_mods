...
.method static constructor <clinit>()V
    ...
    sput-object v0, ALPHA_FADE_IN:Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object p1, p0, mDividers:Ljava/util/List;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, mChildren:Ljava/util/List;

    const/4 p1, 0x0

    iput p1, p0, mCurrentHeaderTranslation:I
    ...
    iput-object p2, p0, mHybridGroupManager:Lcom/android/systemui/statusbar/notification/row/HybridGroupManager;
...
.method private calculateDesiredHeader()Landroid/view/ViewGroup;
    ...
    invoke-virtual {p0}, showingAsLowPriority()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object p0, p0, mNotificationHeaderLowPriority:Landroid/view/NotificationHeaderView;

    goto :goto_0

    :cond_0
    iget-object p0, p0, mNotificationHeader:Landroid/view/NotificationHeaderView;
...
.method private getIntrinsicHeight(F)I
    ...
    :cond_0
    iget v0, p0, mNotificationHeaderMargin:I

    iget v1, p0, mCurrentHeaderTranslation:I

    add-int/2addr v0, v1

    iget-object v1, p0, mChildren:Ljava/util/List;

    invoke-interface {v1}, Ljava/util/List;->size()I

    move-result v1

    iget-boolean v2, p0, mUserLocked:Z

    const/4 v3, 0x0

    if-eqz v2, :cond_1

    invoke-virtual {p0}, getGroupExpandFraction()F
    ...
    :goto_0
    iget-boolean v4, p0, mChildrenExpanded:Z
    ...
    iget-boolean v9, p0, mUserLocked:Z

    if-eqz v9, :cond_3

    int-to-float v8, v8

    iget v9, p0, mChildPadding:I
    ...
    :cond_5
    iget-boolean v7, p0, mUserLocked:Z

    if-eqz v7, :cond_6

    int-to-float v7, v8

    iget v8, p0, mNotificatonTopPadding:I
    ...
    iget v7, p0, mNotificatonTopPadding:I
    ...
    :goto_5
    iget-object v9, p0, mChildren:Ljava/util/List;
    ...
    :cond_8
    :goto_6
    iget-boolean p1, p0, mUserLocked:Z

    if-eqz p1, :cond_9

    int-to-float p1, v8

    iget p0, p0, mCollapsedBottompadding:F
...
.method private getMinHeight(IZ)I
    ...
    :cond_0
    iget p2, p0, mNotificationHeaderMargin:I

    iget v0, p0, mCurrentHeaderTranslation:I
    ...
    :goto_1
    iget-object v5, p0, mChildren:Ljava/util/List;
...
.method private getVisibleChildrenExpandHeight()I
    ...
    iget v1, p0, mNotificatonTopPadding:I
    ...
    invoke-virtual {p0, v2}, getMaxAllowedVisibleChildren(Z)I
    ...
    :cond_0
    iget-object v6, p0, mChildren:Ljava/util/List;
...
.method private getWrapperForView(Landroid/view/View;)Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
    ...
    iget-object v0, p0, mNotificationHeader:Landroid/view/NotificationHeaderView;

    if-ne p1, v0, :cond_0

    iget-object p0, p0, mNotificationHeaderWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;

    return-object p0

    :cond_0
    iget-object p0, p0, mNotificationHeaderWrapperLowPriority:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
...
.method private initDimens()V
    ...
    iput v1, p0, mNotificationHeaderMargin:I
    ...
    iput v1, p0, mNotificatonTopPadding:I

    iget v1, p0, mNotificationHeaderMargin:I

    iget v2, p0, mNotificatonTopPadding:I

    add-int/2addr v1, v2

    iput v1, p0, mHeaderHeight:I
    ...
    iput v2, p0, mCollapsedBottompadding:F
    ...
    iput-boolean v2, p0, mEnableShadowOnChildNotifications:Z
    ...
    iput-boolean v2, p0, mShowDividersWhenExpanded:Z
    ...
    iput-boolean v2, p0, mHideDividersDuringExpand:Z
    ...
    iput v0, p0, mTranslationForHeader:I

    iget-object p0, p0, mHybridGroupManager:Lcom/android/systemui/statusbar/notification/row/HybridGroupManager;
...
.method private recreateLowPriorityHeader(Landroid/app/Notification$Builder;)V
    ...
    iget-object v0, p0, mNotificationHeaderLowPriority:Landroid/view/NotificationHeaderView;
    ...
    iput-object p1, p0, mNotificationHeaderLowPriority:Landroid/view/NotificationHeaderView;

    iget-object p1, p0, mNotificationHeaderLowPriority:Landroid/view/NotificationHeaderView;
    ...
    iget-object v1, p0, mHeaderClickListener:Landroid/view/View$OnClickListener;
    ...
    iget-object v1, p0, mNotificationHeaderLowPriority:Landroid/view/NotificationHeaderView;

    iget-object v2, p0, mContainingNotification:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;
    ...
    iput-object p1, p0, mNotificationHeaderWrapperLowPriority:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
    ...
    :goto_0
    iget-object p1, p0, mNotificationHeaderWrapperLowPriority:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
    ...
    invoke-direct {p0}, calculateDesiredHeader()Landroid/view/ViewGroup;

    move-result-object v0

    invoke-direct {p0, p1, v0}, resetHeaderVisibilityIfNeeded(Landroid/view/View;Landroid/view/View;)V
...
.method private removeFromPossibleParent(Landroid/view/View;)V
    .locals 2
    ...
    const-string v1, "### removeFromPossibleParent: view="
...
.method private resetHeaderVisibilityIfNeeded(Landroid/view/View;Landroid/view/View;)V
    ...
    :cond_0
    iget-object v0, p0, mCurrentHeader:Landroid/view/ViewGroup;
    ...
    invoke-direct {p0, p1}, getWrapperForView(Landroid/view/View;)Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
...
.method private startChildAlphaAnimations(Z)V
    ...
    sget-object v5, ALPHA_FADE_IN:Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;
...
.method private updateChildrenClipping()V
    ...
    iget-object v4, p0, mChildren:Ljava/util/List;
...
.method private updateHeaderTouchability()V
    ...
    iget-boolean v1, p0, mChildrenExpanded:Z

    if-nez v1, :cond_1

    iget-boolean p0, p0, mUserLocked:Z
...
.method private updateHeaderTransformation()V
    ...
    iget-object v1, p0, mNotificationHeaderWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;

    iget-object v2, p0, mNotificationHeaderWrapperLowPriority:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
    ...
    iget-object v1, p0, mNotificationHeader:Landroid/view/NotificationHeaderView;

    const/4 v2, 0x0

    invoke-virtual {v1, v2}, Landroid/view/NotificationHeaderView;->setVisibility(I)V

    iget-object v1, p0, mNotificationHeaderWrapperLowPriority:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
...
.method private updateHeaderVisibility(Z)V
    ...
    invoke-direct {p0, v1}, getWrapperForView(Landroid/view/View;)Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
    ...
    iget-object v4, p0, mNotificationHeader:Landroid/view/NotificationHeaderView;
    ...
    :goto_0
    invoke-direct {p0, v4}, startChildAlphaAnimations(Z)V
    ...
    :cond_6
    iget-object p1, p0, mNotificationHeader:Landroid/view/NotificationHeaderView;

    invoke-direct {p0, p1, v1}, resetHeaderVisibilityIfNeeded(Landroid/view/View;Landroid/view/View;)V

    iget-object p1, p0, mNotificationHeaderLowPriority:Landroid/view/NotificationHeaderView;

    invoke-direct {p0, p1, v1}, resetHeaderVisibilityIfNeeded(Landroid/view/View;Landroid/view/View;)V

    iput-object v1, p0, mCurrentHeader:Landroid/view/ViewGroup;
...
.method public addNotification(Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;I)V
    ...
    iget-object p2, p0, mChildren:Ljava/util/List;
    ...
    invoke-direct {p0, p1}, removeFromPossibleParent(Landroid/view/View;)V
    ...
    invoke-direct {p0}, inflateDivider()Landroid/view/View;

    move-result-object v0

    invoke-direct {p0, v0}, removeFromPossibleParent(Landroid/view/View;)V

    invoke-virtual {p0, v0}, Landroid/view/ViewGroup;->addView(Landroid/view/View;)V

    iget-object v1, p0, mDividers:Ljava/util/List;

    invoke-interface {v1, p2, v0}, Ljava/util/List;->add(ILjava/lang/Object;)V

    invoke-virtual {p0}, updateGroupOverflow()V
...
.method public applyChildOrder(Ljava/util/List;Lcom/android/systemui/statusbar/notification/VisualStabilityManager;Lcom/android/systemui/statusbar/notification/VisualStabilityManager$Callback;)Z
    ...
    :goto_0
    iget-object v2, p0, mChildren:Ljava/util/List;
    ...
    :cond_3
    invoke-direct {p0}, updateExpansionStates()V
...
.method public applyState()V
    ...
    :goto_0
    iget-boolean v4, p0, mUserLocked:Z
    ...
    iget-boolean v4, p0, mShowDividersWhenExpanded:Z
    ...
    iget-boolean v4, p0, mHideDividersDuringExpand:Z
    ...
    iget-object v8, p0, mChildren:Ljava/util/List;
    ...
    iget-object v10, p0, mDividers:Ljava/util/List;
    ...
    iget-boolean v11, p0, mChildrenExpanded:Z
    ...
    :goto_3
    iget-boolean v12, p0, mUserLocked:Z
    ...
    :cond_7
    iget-object v0, p0, mGroupOverFlowState:Lcom/android/systemui/statusbar/notification/stack/ViewState;

    if-eqz v0, :cond_8

    iget-object v1, p0, mOverflowNumber:Landroid/widget/TextView;

    invoke-virtual {v0, v1}, Lcom/android/systemui/statusbar/notification/stack/ViewState;->applyToView(Landroid/view/View;)V

    iput-boolean v6, p0, mNeverAppliedGroupState:Z

    :cond_8
    iget-object v0, p0, mHeaderViewState:Lcom/android/systemui/statusbar/notification/stack/ViewState;
    ...
    :cond_9
    invoke-direct {p0}, updateChildrenClipping()V
...
.method public getCollapsedHeight()I
    ...
    invoke-virtual {p0, v0}, getMaxAllowedVisibleChildren(Z)I

    move-result v0

    const/4 v1, 0x0

    invoke-direct {p0, v0, v1}, getMinHeight(IZ)I
...
.method public getCurrentHeaderView()Landroid/view/ViewGroup;
    ...
    iget-object p0, p0, mCurrentHeader:Landroid/view/ViewGroup;
...
.method public getGroupExpandFraction()F
    ...
    invoke-virtual {p0}, getMaxContentHeight()I
    ...
    :cond_0
    invoke-direct {p0}, getVisibleChildrenExpandHeight()I
...
.method public getIntrinsicHeight()I
    ...
    invoke-virtual {p0}, getMaxAllowedVisibleChildren()I

    move-result v0

    int-to-float v0, v0

    invoke-direct {p0, v0}, getIntrinsicHeight(F)I
...
.method getMaxAllowedVisibleChildren(Z)I
    ...
    iget-boolean p1, p0, mChildrenExpanded:Z
    ...
    :cond_1
    iget-boolean p1, p0, mIsLowPriority:Z
...
.method public getMaxContentHeight()I
    ...
    iget v2, p0, mCurrentHeaderTranslation:I
...
.method public getNotificationChildCount()I
    ...
    iget-object p0, p0, mChildren:Ljava/util/List;
...
.method public synthetic lambda$updateHeaderVisibility$0$NotificationChildrenContainer()V
    ...
    invoke-direct {p0, v0}, updateHeaderVisibility(Z)V
...
.method public onExpansionChanged()V
    ...
    invoke-virtual {p0, v0}, setUserLocked(Z)V
...
.method protected onLayout(ZIIII)V
    ...
    iget-object p1, p0, mChildren:Ljava/util/List;
    ...
    iget-object p4, p0, mChildren:Ljava/util/List;
    ...
    iget-object p4, p0, mDividers:Ljava/util/List;
    ...
    :cond_0
    iget-object p1, p0, mOverflowNumber:Landroid/widget/TextView;
    ...
    iget-object p3, p0, mOverflowNumber:Landroid/widget/TextView;
    ...
    iget-object p4, p0, mOverflowNumber:Landroid/widget/TextView;
    ...
    iget-object p4, p0, mNotificationHeader:Landroid/view/NotificationHeaderView;
...
.method protected onMeasure(II)V
    ...
    iget-object v10, v0, mOverflowNumber:Landroid/widget/TextView;
    ...
    :cond_4
    iget v7, v0, mDividerHeight:I

    invoke-static {v7, v3}, Landroid/view/View$MeasureSpec;->makeMeasureSpec(II)I

    move-result v7

    iget v10, v0, mNotificationHeaderMargin:I

    iget v11, v0, mNotificatonTopPadding:I

    add-int/2addr v10, v11

    iget-object v11, v0, mChildren:Ljava/util/List;
    ...
    invoke-virtual {v0, v5}, getMaxAllowedVisibleChildren(Z)I
    ...
    iget-object v15, v0, mChildren:Ljava/util/List;
    ...
    iget-object v4, v0, mOverflowNumber:Landroid/widget/TextView;
    ...
    iget-object v4, v0, mDividers:Ljava/util/List;
    ...
    :cond_a
    iget v2, v0, mHeaderHeight:I

    invoke-static {v2, v3}, Landroid/view/View$MeasureSpec;->makeMeasureSpec(II)I

    move-result v2

    iget-object v4, v0, mNotificationHeader:Landroid/view/NotificationHeaderView;
    ...
    :cond_b
    iget-object v2, v0, mNotificationHeaderLowPriority:Landroid/view/NotificationHeaderView;
    ...
    iget-object v3, v0, mNotificationHeaderLowPriority:Landroid/view/NotificationHeaderView;
...
.method public onNotificationUpdated()V
    ...
    iget-object v0, p0, mHybridGroupManager:Lcom/android/systemui/statusbar/notification/row/HybridGroupManager;
...
.method public reInflateViews(Landroid/view/View$OnClickListener;Landroid/service/notification/StatusBarNotification;)V
    ...
    iget-object p2, p0, mNotificationHeader:Landroid/view/NotificationHeaderView;
    ...
    iput-object v0, p0, mNotificationHeader:Landroid/view/NotificationHeaderView;

    :cond_0
    iget-object p2, p0, mNotificationHeaderLowPriority:Landroid/view/NotificationHeaderView;

    if-eqz p2, :cond_1

    invoke-virtual {p0, p2}, Landroid/view/ViewGroup;->removeView(Landroid/view/View;)V

    iput-object v0, p0, mNotificationHeaderLowPriority:Landroid/view/NotificationHeaderView;

    :cond_1
    invoke-virtual {p0, p1}, recreateNotificationHeader(Landroid/view/View$OnClickListener;)V
    ...
    :goto_0
    iget-object p2, p0, mDividers:Ljava/util/List;
    ...
    iput-object v0, p0, mOverflowNumber:Landroid/widget/TextView;

    iput-object v0, p0, mGroupOverFlowState:Lcom/android/systemui/statusbar/notification/stack/ViewState;
...
.method public recreateNotificationHeader(Landroid/view/View$OnClickListener;)V
    ...
    iput-object p1, p0, mHeaderClickListener:Landroid/view/View$OnClickListener;
    ...
    iput-object v0, p0, mNotificationHeaderWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
    ...
    iget-object v3, p0, mNotificationHeader:Landroid/view/NotificationHeaderView;

    invoke-virtual {v0, v1, v3}, Landroid/widget/RemoteViews;->reapply(Landroid/content/Context;Landroid/view/View;)V

    :goto_0
    iget-object v0, p0, mNotificationHeaderWrapper:Lcom/android/systemui/statusbar/notification/row/wrapper/NotificationViewWrapper;
    ...
    invoke-direct {p0, p1}, recreateLowPriorityHeader(Landroid/app/Notification$Builder;)V

    invoke-direct {p0, v2}, updateHeaderVisibility(Z)V
...
.method public removeNotification(Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;)V
    ...
    iget-object p0, p0, mHeaderUtil:Lcom/android/systemui/statusbar/NotificationHeaderUtil;
...
.method public setActualHeight(I)V
    ...
    invoke-direct {p0}, updateHeaderTransformation()V

    const/4 v1, 0x1

    invoke-virtual {p0, v1}, getMaxAllowedVisibleChildren(Z)I
...
.method public setChildrenExpanded(Z)V
    ...
    :cond_1
    invoke-direct {p0}, updateHeaderTouchability()V
...
.method public setContainingNotification(Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;)V
    ...
    iput-object p1, p0, mHeaderUtil:Lcom/android/systemui/statusbar/NotificationHeaderUtil;
...
.method public setHeaderVisibleAmount(F)V
    ...
    iget p1, p0, mTranslationForHeader:I
...
.method public setIsLowPriority(Z)V
    ...
    invoke-direct {p0, p1}, updateHeaderVisibility(Z)V
    ...
    invoke-virtual {p0, p1}, setUserLocked(Z)V
...
.method public setUserLocked(Z)V
    ...
    invoke-direct {p0, v1}, updateHeaderVisibility(Z)V
...
.method public startAnimationToState(Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;)V
    ...
    iget-boolean v3, p0, mUserLocked:Z
    ...
    :cond_0
    iget-boolean v3, p0, mChildrenExpanded:Z

    if-eqz v3, :cond_1

    iget-boolean v3, p0, mShowDividersWhenExpanded:Z
    ...
    iget-boolean v3, p0, mHideDividersDuringExpand:Z
    ...
    iget-object v7, p0, mChildren:Ljava/util/List;
    ...
    iget-object v9, p0, mDividers:Ljava/util/List;
    ...
    iget-boolean v10, p0, mChildrenExpanded:Z
    ...
    :cond_6
    iget-object v0, p0, mOverflowNumber:Landroid/widget/TextView;

    if-eqz v0, :cond_8

    iget-boolean v1, p0, mNeverAppliedGroupState:Z

    if-eqz v1, :cond_7

    iget-object v1, p0, mGroupOverFlowState:Lcom/android/systemui/statusbar/notification/stack/ViewState;
    ...
    iput-boolean v5, p0, mNeverAppliedGroupState:Z
...
.method public updateGroupOverflow()V
    ...
    iget-object v2, p0, mHybridGroupManager:Lcom/android/systemui/statusbar/notification/row/HybridGroupManager;

    iget-object v3, p0, mOverflowNumber:Landroid/widget/TextView;
    ...
    iput-boolean v1, p0, mNeverAppliedGroupState:Z
...
.method public updateState(Lcom/android/systemui/statusbar/notification/stack/ExpandableViewState;Lcom/android/systemui/statusbar/notification/stack/AmbientState;)V
    ...
    iget-object v2, v0, mChildren:Ljava/util/List;

    invoke-interface {v2}, Ljava/util/List;->size()I

    move-result v2

    iget v3, v0, mNotificationHeaderMargin:I

    iget v4, v0, mCurrentHeaderTranslation:I

    add-int/2addr v3, v4

    invoke-virtual/range {p0 .. p0}, getMaxAllowedVisibleChildren()I
    ...
    iget-boolean v7, v0, mUserLocked:Z

    if-eqz v7, :cond_0

    invoke-virtual/range {p0 .. p0}, showingAsLowPriority()Z
    ...
    :goto_0
    iget-boolean v9, v0, mUserLocked:Z

    const/4 v10, 0x0

    if-eqz v9, :cond_1

    invoke-virtual/range {p0 .. p0}, getGroupExpandFraction()F
    ...
    :goto_1
    iget-boolean v11, v0, mChildrenExpanded:Z

    if-eqz v11, :cond_2

    iget-object v11, v0, mContainingNotification:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;
    ...
    iget v5, v0, mChildPadding:I

    int-to-float v5, v5

    iget v8, v0, mDividerHeight:I
    ...
    :cond_3
    iget-boolean v5, v0, mChildrenExpanded:Z

    if-eqz v5, :cond_4

    iget v5, v0, mDividerHeight:I
    ...
    iget v8, v0, mNotificatonTopPadding:I

    iget v12, v0, mDividerHeight:I
    ...
    iget v5, v0, mNotificatonTopPadding:I
    ...
    iget-boolean v10, v0, mEnableShadowOnChildNotifications:Z
    ...
    :cond_d
    iget-object v3, v0, mOverflowNumber:Landroid/widget/TextView;

    if-eqz v3, :cond_11

    iget-object v3, v0, mChildren:Ljava/util/List;

    const/4 v4, 0x1

    invoke-virtual {v0, v4}, getMaxAllowedVisibleChildren(Z)I
    ...
    iget-object v3, v0, mGroupOverFlowState:Lcom/android/systemui/statusbar/notification/stack/ViewState;
    ...
    iget-boolean v3, v0, mChildrenExpanded:Z
    ...
    :goto_b
    iget-object v4, v0, mGroupOverFlowState:Lcom/android/systemui/statusbar/notification/stack/ViewState;
    ...
    :cond_10
    iget-object v2, v0, mGroupOverFlowState:Lcom/android/systemui/statusbar/notification/stack/ViewState;

    iget v3, v2, Lcom/android/systemui/statusbar/notification/stack/ViewState;->yTranslation:F

    iget v4, v0, mNotificationHeaderMargin:I
    ...
    :goto_d
    iget-object v2, v0, mNotificationHeader:Landroid/view/NotificationHeaderView;

    if-eqz v2, :cond_14

    iget-object v2, v0, mHeaderViewState:Lcom/android/systemui/statusbar/notification/stack/ViewState;
    ...
    iput-object v2, v0, mHeaderViewState:Lcom/android/systemui/statusbar/notification/stack/ViewState;

    :cond_12
    iget-object v2, v0, mHeaderViewState:Lcom/android/systemui/statusbar/notification/stack/ViewState;

    iget-object v3, v0, mNotificationHeader:Landroid/view/NotificationHeaderView;
    ...
    iget-object v1, v0, mHeaderViewState:Lcom/android/systemui/statusbar/notification/stack/ViewState;

    iget v2, v0, mCurrentHeaderTranslation:I

    int-to-float v2, v2

    iput v2, v1, Lcom/android/systemui/statusbar/notification/stack/ViewState;->yTranslation:F

    iget v0, v0, mHeaderVisibleAmount:F
