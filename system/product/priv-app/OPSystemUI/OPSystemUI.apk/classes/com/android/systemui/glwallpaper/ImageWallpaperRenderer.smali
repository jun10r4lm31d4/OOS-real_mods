...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/glwallpaper/GLWallpaperRenderer$SurfaceProxy;)V
    ...
    iput-object v0, p0, mSurfaceSize:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, mViewport:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, mWallpaperManager:Landroid/app/WallpaperManager;

    iget-object v0, p0, mWallpaperManager:Landroid/app/WallpaperManager;
    ...
    iput-object v1, p0, mScissor:Landroid/graphics/Rect;

    iput-object p2, p0, mProxy:Lcom/android/systemui/glwallpaper/GLWallpaperRenderer$SurfaceProxy;
    ...
    iput-object p2, p0, mProgram:Lcom/android/systemui/glwallpaper/ImageGLProgram;

    new-instance p1, Lcom/android/systemui/glwallpaper/ImageGLWallpaper;

    iget-object p2, p0, mProgram:Lcom/android/systemui/glwallpaper/ImageGLProgram;
    ...
    iput-object p1, p0, mWallpaper:Lcom/android/systemui/glwallpaper/ImageGLWallpaper;
    ...
    iput-object p1, p0, mImageProcessHelper:Lcom/android/systemui/glwallpaper/ImageProcessHelper;
    ...
    iput-object p1, p0, mImageRevealHelper:Lcom/android/systemui/glwallpaper/ImageRevealHelper;

    invoke-direct {p0}, loadBitmap()Z

    move-result p1

    if-eqz p1, :cond_1

    iget-object p1, p0, mImageProcessHelper:Lcom/android/systemui/glwallpaper/ImageProcessHelper;
...
.method private scaleViewport(F)V
    ...
    iget-object v0, p0, mScissor:Landroid/graphics/Rect;
    ...
    iget-object v3, p0, mScissor:Landroid/graphics/Rect;
    ...
    iget-object v5, p0, mViewport:Landroid/graphics/Rect;
    ...
    iget-object p0, p0, mViewport:Landroid/graphics/Rect;
...
.method public dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v0, p0, mProxy:Lcom/android/systemui/glwallpaper/GLWallpaperRenderer$SurfaceProxy;
    ...
    iget-object v0, p0, mViewport:Landroid/graphics/Rect;
    ...
    iget-boolean v0, p0, mScissorMode:Z
    ...
    iget-object v0, p0, mImageProcessHelper:Lcom/android/systemui/glwallpaper/ImageProcessHelper;
    ...
    iget-object p0, p0, mWallpaper:Lcom/android/systemui/glwallpaper/ImageGLWallpaper;
...
.method public finish()V
    ...
    iput-object v0, p0, mProxy:Lcom/android/systemui/glwallpaper/GLWallpaperRenderer$SurfaceProxy;
...
.method public onDrawFrame()V
    ...
    iget-object v1, p0, mImageRevealHelper:Lcom/android/systemui/glwallpaper/ImageRevealHelper;

    invoke-virtual {v1}, Lcom/android/systemui/glwallpaper/ImageRevealHelper;->getReveal()F

    move-result v1

    iget-object v2, p0, mWallpaper:Lcom/android/systemui/glwallpaper/ImageGLWallpaper;
    ...
    iget-object v0, p0, mWallpaper:Lcom/android/systemui/glwallpaper/ImageGLWallpaper;
    ...
    invoke-direct {p0, v1}, scaleViewport(F)V
    ...
    iget-object v1, p0, mSurfaceSize:Landroid/graphics/Rect;
...
.method public onRevealEnd()V
    ...
    iput-boolean v0, p0, mScissorMode:Z
    ...
    :cond_0
    iget-object p0, p0, mProxy:Lcom/android/systemui/glwallpaper/GLWallpaperRenderer$SurfaceProxy;
...
.method public onRevealStart(Z)V
    ...
    iput-boolean p1, p0, mScissorMode:Z

    iget-object p1, p0, mWallpaper:Lcom/android/systemui/glwallpaper/ImageGLWallpaper;

    iget-object v0, p0, mSurfaceSize:Landroid/graphics/Rect;

    iget-object v1, p0, mScissor:Landroid/graphics/Rect;

    iget v2, p0, mXOffset:F

    iget v3, p0, mYOffset:F
...
.method public onSurfaceCreated()V
    ...
    iget-object v0, p0, mProgram:Lcom/android/systemui/glwallpaper/ImageGLProgram;
...
.method public reportSurfaceSize()Landroid/util/Size;
    ...
    iget-object p0, p0, mSurfaceSize:Landroid/graphics/Rect;
...
.method public updateAmbientMode(ZJ)V
    ...
    iget-object p0, p0, mImageRevealHelper:Lcom/android/systemui/glwallpaper/ImageRevealHelper;
...
.method public updateOffsets(FF)V
    ...
    iput p1, p0, mXOffset:F

    iput p2, p0, mYOffset:F

    iget-object p2, p0, mSurfaceSize:Landroid/graphics/Rect;
    ...
    iget-object p2, p0, mScissor:Landroid/graphics/Rect;
    ...
    iget-object p0, p0, mScissor:Landroid/graphics/Rect;
