...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mStackPosition:Landroid/graphics/PointF;

    const/4 v0, 0x0

    iput-boolean v0, p0, mStackMovedToStartPosition:Z

    const/4 v1, 0x0

    iput v1, p0, mImeHeight:F

    const/4 v1, 0x1

    iput v1, p0, mPreImeY:F

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, mStackPositionAnimations:Ljava/util/HashMap;

    iput-boolean v0, p0, mIsMovingFromFlinging:Z

    iput-boolean v0, p0, mWithinDismissTarget:Z

    iput-boolean v0, p0, mFirstBubbleSpringingToTouch:Z
...
.method static synthetic access$100(Lcom/android/systemui/bubbles/animation/StackAnimationController;Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;F)V
    ...
    invoke-direct {p0, p1, p2}, moveFirstBubbleWithStackFollowing(Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;F)V
...
.method private animateInBubble(Landroid/view/View;)V
    ...
    :cond_0
    iget-object v0, p0, mStackPosition:Landroid/graphics/PointF;
    ...
    invoke-virtual {p0, v0}, getOffsetForChainedPropertyAnimation(Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;)F
    ...
    iget-object p0, p0, mStackPosition:Landroid/graphics/PointF;
...
.method private cancelStackPositionAnimation(Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;)V
    ...
    iget-object v0, p0, mStackPositionAnimations:Ljava/util/HashMap;
    ...
    iget-object p0, p0, mStackPositionAnimations:Ljava/util/HashMap;
...
.method private getDefaultStartPosition()Landroid/graphics/PointF;
    ...
    invoke-virtual {p0}, getAllowableStackPositionRegion()Landroid/graphics/RectF;
    ...
    iget p0, p0, mStackStartingVerticalOffset:I
...
.method private isStackPositionSet()Z
    ...
    iget-boolean p0, p0, mStackMovedToStartPosition:Z
...
.method private moveFirstBubbleWithStackFollowing(Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;F)V
    ...
    invoke-virtual {p0, p1}, getOffsetForChainedPropertyAnimation(Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;)F
...
.method private setStackPosition(Landroid/graphics/PointF;)V
    ...
    invoke-virtual {p0}, cancelStackPositionAnimations()V
    ...
    invoke-virtual {p0, v1}, getOffsetForChainedPropertyAnimation(Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;)F
...
.method public animateForImeVisibility(Z)V
    ...
    iget-object p1, p0, mStackPosition:Landroid/graphics/PointF;
    ...
    iget v2, p0, mPreImeY:F

    cmpl-float v2, v2, v1

    if-nez v2, :cond_1

    iput p1, p0, mPreImeY:F

    goto :goto_0

    :cond_0
    iget v0, p0, mPreImeY:F
    ...
    invoke-virtual {p0, p1, v1}, getSpringForce(Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;Landroid/view/View;)Landroidx/dynamicanimation/animation/SpringForce;
    ...
    invoke-virtual {p0, p1, v1, v2, v0}, springFirstBubbleWithStackFollowing(Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;Landroidx/dynamicanimation/animation/SpringForce;FF)V
...
.method public cancelStackPositionAnimations()V
    ...
    invoke-direct {p0, v0}, cancelStackPositionAnimation(Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;)V
...
.method public demagnetizeFromDismissToPoint(FFFF)V
    ...
    invoke-virtual {p0, v0, v1, p3, p1}, springFirstBubbleWithStackFollowing(Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;Landroidx/dynamicanimation/animation/SpringForce;FF)V
    ...
    invoke-virtual {p0, p1, p3, p4, p2}, springFirstBubbleWithStackFollowing(Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;Landroidx/dynamicanimation/animation/SpringForce;FF)V
...
.method public flingStackThenSpringToEdge(FFF)F
    ...
    iget v1, v6, mIndividualBubbleSize:I
    ...
    invoke-virtual/range {v0 .. v5}, flingThenSpringFirstBubbleWithStackFollowing(Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;FFLandroidx/dynamicanimation/animation/SpringForce;Ljava/lang/Float;)V
    ...
    iput-boolean v9, v6, mFirstBubbleSpringingToTouch:Z

    iput-boolean v8, v6, mIsMovingFromFlinging:Z
...
.method protected flingThenSpringFirstBubbleWithStackFollowing(Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;FFLandroidx/dynamicanimation/animation/SpringForce;Ljava/lang/Float;)V
    ...
    invoke-direct {p0, p1}, cancelStackPositionAnimation(Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;)V

    iget-object v0, v7, mStackPositionAnimations:Ljava/util/HashMap;
...
.method public getAllowableStackPositionRegion()Landroid/graphics/RectF;
    ...
    iget v3, p0, mIndividualBubbleSize:I

    sub-int/2addr v2, v3

    iget v3, p0, mBubbleOffscreen:I
    ...
    iget v2, p0, mBubblePadding:I

    int-to-float v2, v2

    iget v3, p0, mStatusBarHeight:F
    ...
    iget v3, p0, mBubblePadding:I

    sub-int/2addr v2, v3

    int-to-float v2, v2

    iget p0, p0, mImeHeight:F
...
.method getNextAnimationInChain(Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;I)I
    ...
    :cond_0
    iget-boolean p0, p0, mWithinDismissTarget:Z
...
.method getOffsetForChainedPropertyAnimation(Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;)F
    ...
    iget-boolean p1, p0, mWithinDismissTarget:Z
...
.method getSpringForce(Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;Landroid/view/View;)Landroidx/dynamicanimation/animation/SpringForce;
    ...
    iget-boolean p0, p0, mIsMovingFromFlinging:Z
...
.method public isStackOnLeftSide()Z
    ...
    invoke-direct {p0}, isStackPositionSet()Z
    ...
    iget v2, p0, mIndividualBubbleSize:I
...
.method public synthetic lambda$flingStackThenSpringToEdge$0$StackAnimationController()V
    ...
    iput-object v0, p0, mRestingStackPosition:Landroid/graphics/PointF;

    iget-object v0, p0, mRestingStackPosition:Landroid/graphics/PointF;

    iget-object v1, p0, mStackPosition:Landroid/graphics/PointF;
...
.method public synthetic lambda$flingThenSpringFirstBubbleWithStackFollowing$1$StackAnimationController(Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;Landroidx/dynamicanimation/animation/SpringForce;Ljava/lang/Float;FFLandroidx/dynamicanimation/animation/DynamicAnimation;ZFF)V
    ...
    :goto_0
    invoke-virtual {p0, p1, p2, p9, p3}, springFirstBubbleWithStackFollowing(Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;Landroidx/dynamicanimation/animation/SpringForce;FF)V
...
.method public synthetic lambda$implodeStack$2$StackAnimationController(Ljava/lang/Runnable;)V
    ...
    iput-boolean p1, p0, mWithinDismissTarget:Z
...
.method public synthetic lambda$moveStackToStartPosition$3$StackAnimationController()V
    ...
    invoke-direct {p0}, getDefaultStartPosition()Landroid/graphics/PointF;

    move-result-object v0

    :cond_0
    invoke-direct {p0, v0}, setStackPosition(Landroid/graphics/PointF;)V
    ...
    invoke-direct {p0, v0}, animateInBubble(Landroid/view/View;)V
...
.method public magnetToDismiss(FFFLjava/lang/Runnable;)V
    ...
    iput-boolean v1, p0, mFirstBubbleSpringingToTouch:Z
    ...
    iget p0, p0, mIndividualBubbleSize:I
...
.method public moveFirstBubbleWithStackFollowing(FF)V
    ...
    iput v0, p0, mPreImeY:F

    sget-object v0, Landroidx/dynamicanimation/animation/DynamicAnimation;->TRANSLATION_X:Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;

    invoke-direct {p0, v0, p1}, moveFirstBubbleWithStackFollowing(Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;F)V
    ...
    iput-boolean p1, p0, mIsMovingFromFlinging:Z
...
.method public moveStackFromTouch(FF)V
    ...
    iget-boolean v0, p0, mFirstBubbleSpringingToTouch:Z
    ...
    iget-object v1, p0, mStackPositionAnimations:Ljava/util/HashMap;
    ...
    iget-boolean v0, p0, mWithinDismissTarget:Z

    if-nez v0, :cond_3

    invoke-virtual {p0, p1, p2}, moveFirstBubbleWithStackFollowing(FF)V
...
.method public moveStackToSimilarPositionAfterRotation(ZF)V
    ...
    invoke-direct {p0, p2}, setStackPosition(Landroid/graphics/PointF;)V
...
.method onActiveControllerForLayout(Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;)V
    ...
    iput v0, p0, mIndividualBubbleSize:I
    ...
    iput v0, p0, mStackStartingVerticalOffset:I
...
.method onChildAdded(Landroid/view/View;I)V
    ...
    invoke-direct {p0}, moveStackToStartPosition()V
    ...
    invoke-direct {p0, p1}, animateInBubble(Landroid/view/View;)V
...
.method onChildRemoved(Landroid/view/View;ILjava/lang/Runnable;)V
    ...
    invoke-virtual {p0, p2}, getOffsetForChainedPropertyAnimation(Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;)F
    ...
    iget-object p3, p0, mStackPosition:Landroid/graphics/PointF;
    ...
    iput-object p1, p0, mStackPosition:Landroid/graphics/PointF;
...
.method public springStack(FF)V
    ...
    invoke-virtual {p0, v0, v1, v4, p1}, springFirstBubbleWithStackFollowing(Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;Landroidx/dynamicanimation/animation/SpringForce;FF)V
    ...
    invoke-virtual {p0, p1, v0, v4, p2}, springFirstBubbleWithStackFollowing(Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;Landroidx/dynamicanimation/animation/SpringForce;FF)V
