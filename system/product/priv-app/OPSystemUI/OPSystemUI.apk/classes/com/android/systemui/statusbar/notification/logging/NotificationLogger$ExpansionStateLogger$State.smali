...
.method private constructor <init>(Lcom/android/systemui/statusbar/notification/logging/NotificationLogger$ExpansionStateLogger$State;)V
    ...
    iget-object v0, p1, mIsUserAction:Ljava/lang/Boolean;

    iput-object v0, p0, mIsUserAction:Ljava/lang/Boolean;

    iget-object v0, p1, mIsExpanded:Ljava/lang/Boolean;

    iput-object v0, p0, mIsExpanded:Ljava/lang/Boolean;

    iget-object v0, p1, mIsVisible:Ljava/lang/Boolean;

    iput-object v0, p0, mIsVisible:Ljava/lang/Boolean;

    iget-object p1, p1, mLocation:Lcom/android/internal/statusbar/NotificationVisibility$NotificationLocation;

    iput-object p1, p0, mLocation:Lcom/android/internal/statusbar/NotificationVisibility$NotificationLocation;
...
.method synthetic constructor <init>(Lcom/android/systemui/statusbar/notification/logging/NotificationLogger$ExpansionStateLogger$State;Lcom/android/systemui/statusbar/notification/logging/NotificationLogger$1;)V
    ...
    invoke-direct {p0, p1}, <init>(Lcom/android/systemui/statusbar/notification/logging/NotificationLogger$ExpansionStateLogger$State;)V
...
.method private isFullySet()Z
    ...
    iget-object v0, p0, mIsUserAction:Ljava/lang/Boolean;

    if-eqz v0, :cond_0

    iget-object v0, p0, mIsExpanded:Ljava/lang/Boolean;

    if-eqz v0, :cond_0

    iget-object v0, p0, mIsVisible:Ljava/lang/Boolean;

    if-eqz v0, :cond_0

    iget-object p0, p0, mLocation:Lcom/android/internal/statusbar/NotificationVisibility$NotificationLocation;
