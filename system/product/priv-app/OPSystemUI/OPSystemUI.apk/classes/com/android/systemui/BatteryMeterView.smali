...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput v2, p0, mDarkIntensity:F

    iput-boolean v0, p0, mBatteryPercentShow:Z
    ...
    iput v0, p0, mPercentageStyleId:I
    ...
    iput-object p2, p0, mSettingObserver:Lcom/android/systemui/BatteryMeterView$SettingObserver;
    ...
    iput-boolean p2, p0, mShowPercentAvailable:Z
    ...
    invoke-direct {p0}, setupLayoutTransition()V
    ...
    iput-object p2, p0, mSlotBattery:Ljava/lang/String;

    new-instance p2, Landroid/widget/ImageView;

    invoke-direct {p2, p1}, Landroid/widget/ImageView;-><init>(Landroid/content/Context;)V

    iput-object p2, p0, mBatteryIconView:Landroid/widget/ImageView;

    iget-object p2, p0, mBatteryIconView:Landroid/widget/ImageView;
    ...
    iget-object v1, p0, mBatteryIconView:Landroid/widget/ImageView;
    ...
    invoke-direct {p0}, updateShowPercent()V
    ...
    invoke-virtual {p0, p1, v2, p2}, onDarkChanged(Landroid/graphics/Rect;FI)V
    ...
    iput-object p1, p0, mUserTracker:Lcom/android/systemui/settings/CurrentUserTracker;
...
.method static synthetic access$100(Lcom/android/systemui/BatteryMeterView;)Lcom/android/systemui/BatteryMeterView$SettingObserver;
    ...
    iget-object p0, p0, mSettingObserver:Lcom/android/systemui/BatteryMeterView$SettingObserver;
...
.method static synthetic access$300(Lcom/android/systemui/BatteryMeterView;)V
    ...
    invoke-direct {p0}, updatePercentText()V
...
.method private scaleBatteryMeterViews()V
    ...
    iget-object v0, p0, mBatteryIconView:Landroid/widget/ImageView;
    ...
    iget-object v2, p0, mBatteryPercentView:Landroid/widget/TextView;
...
.method private setPercentTextAtCurrentLevel()V
    ...
    iget-object v0, p0, mBatteryPercentView:Landroid/widget/TextView;
...
.method private subscribeForTunerUpdates()V
    ...
    iget-boolean v0, p0, mIsSubscribedForTunerUpdates:Z

    if-nez v0, :cond_1

    iget-boolean v0, p0, mIgnoreTunerUpdates:Z
    ...
    iput-boolean v0, p0, mIsSubscribedForTunerUpdates:Z
...
.method private updateAllBatteryColors()V
    ...
    :goto_0
    iget-object v1, p0, mDualToneHandler:Lcom/android/systemui/DualToneHandler;

    invoke-virtual {v1, v0}, Lcom/android/systemui/DualToneHandler;->getSingleColor(F)I

    move-result v1

    iput v1, p0, mNonAdaptedSingleToneColor:I
    ...
    iput v1, p0, mNonAdaptedForegroundColor:I
    ...
    iput v0, p0, mNonAdaptedBackgroundColor:I
    ...
    iget v1, p0, mNonAdaptedBackgroundColor:I

    iget v2, p0, mNonAdaptedSingleToneColor:I

    invoke-virtual {p0, v0, v1, v2}, updateColors(III)V
...
.method private updateBatteryMeterVisibility()V
    ...
    invoke-direct {p0}, showFastCharge()Z
    ...
    :cond_0
    iget-object p0, p0, mBatteryIconView:Landroid/widget/ImageView;
...
.method private declared-synchronized updatePercentText()V
    ...
    :cond_1
    invoke-direct {p0}, setPercentTextAtCurrentLevel()V
...
.method private updateShowPercent()V
    ...
    iget-boolean v3, p0, mBatteryPercentShow:Z
    ...
    iget-boolean v3, p0, mForceShowPercent:Z
    ...
    :cond_1
    iget-boolean v2, p0, mBatteryPercentShow:Z

    if-nez v2, :cond_3

    iget-boolean v2, p0, mForceShowPercent:Z
    ...
    iput-object v0, p0, mBatteryPercentView:Landroid/widget/TextView;
    ...
    invoke-direct {p0}, loadPercentView()Landroid/widget/TextView;

    move-result-object v0

    iput-object v0, p0, mBatteryPercentView:Landroid/widget/TextView;

    iget v0, p0, mPercentageStyleId:I
    ...
    invoke-direct {p0}, scaleBatteryMeterViews()V
...
.method private updateTunerSubscription()V
    ...
    invoke-direct {p0}, unsubscribeFromTunerUpdates()V

    goto :goto_0

    :cond_0
    invoke-direct {p0}, subscribeForTunerUpdates()V
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-boolean p0, p0, mForceShowPercent:Z
...
.method public onAttachedToWindow()V
    ...
    iget-object v3, p0, mSettingObserver:Lcom/android/systemui/BatteryMeterView$SettingObserver;
    ...
    :cond_0
    iput-boolean v5, p0, mBatteryPercentShow:Z

    invoke-direct {p0}, updateShowPercent()V

    invoke-direct {p0}, subscribeForTunerUpdates()V

    iget-object v0, p0, mUserTracker:Lcom/android/systemui/settings/CurrentUserTracker;

    invoke-virtual {v0}, Lcom/android/systemui/settings/CurrentUserTracker;->startTracking()V

    invoke-direct {p0}, scaleBatteryMeterViews()V

    invoke-direct {p0}, updateBatteryMeterVisibility()V
...
.method public onBatteryLevelChanged(IZZ)V
    ...
    iput-boolean p2, p0, mCharging:Z

    iput p1, p0, mLevel:I

    invoke-direct {p0}, updatePercentText()V

    invoke-virtual {p0}, updateDashChargeView()V
...
.method public onBatteryPercentShowChange(Z)V
    ...
    iget-boolean v0, p0, mBatteryPercentShow:Z

    if-eq v0, p1, :cond_0

    iput-boolean p1, p0, mBatteryPercentShow:Z
...
.method public onDarkChanged(Landroid/graphics/Rect;FI)V
    ...
    invoke-direct {p0}, updateAllBatteryColors()V
...
.method public onDetachedFromWindow()V
    ...
    iget-object v1, p0, mSettingObserver:Lcom/android/systemui/BatteryMeterView$SettingObserver;
...
.method public setColorsFromContext(Landroid/content/Context;)V
    ...
    :cond_0
    iget-object p0, p0, mDualToneHandler:Lcom/android/systemui/DualToneHandler;
...
.method public setForceShowPercent(Z)V
    ...
    iget-boolean v1, p0, mForceShowPercent:Z
    ...
    iput-boolean p1, p0, mForceShowPercent:Z

    invoke-virtual {p0, p1}, setPercentShowMode(I)V
...
.method public setIgnoreTunerUpdates(Z)V
    ...
    iput-boolean p1, p0, mIgnoreTunerUpdates:Z

    invoke-direct {p0}, updateTunerSubscription()V
...
.method public setTextColor(I)V
    ...
    iget-object p0, p0, mBatteryPercentView:Landroid/widget/TextView;
