...
.method public constructor <init>(Lcom/android/systemui/egg/MLand;Landroid/content/Context;FZ)V
    ...
    iput-object p1, p0, this$0:Lcom/android/systemui/egg/MLand;
    ...
    iput-object p2, p0, mShadow:Landroid/graphics/Path;

    new-instance p2, Landroid/graphics/drawable/GradientDrawable;

    invoke-direct {p2}, Landroid/graphics/drawable/GradientDrawable;-><init>()V

    iput-object p2, p0, mGradient:Landroid/graphics/drawable/GradientDrawable;
    ...
    iput-boolean p4, p0, mDrawShadow:Z

    const/4 p1, 0x0

    invoke-virtual {p0, p1}, Landroid/view/View;->setBackground(Landroid/graphics/drawable/Drawable;)V

    iget-object p1, p0, mGradient:Landroid/graphics/drawable/GradientDrawable;
    ...
    iput-object p1, p0, mJandystripe:Landroid/graphics/Path;

    new-instance p1, Landroid/graphics/Paint;

    invoke-direct {p1}, Landroid/graphics/Paint;-><init>()V

    iput-object p1, p0, mPaint2:Landroid/graphics/Paint;

    iget-object p1, p0, mPaint2:Landroid/graphics/Paint;

    const/high16 p2, -0x10000

    invoke-virtual {p1, p2}, Landroid/graphics/Paint;->setColor(I)V

    iget-object p0, p0, mPaint2:Landroid/graphics/Paint;
    ...
    :cond_0
    iget-object p0, p0, mGradient:Landroid/graphics/drawable/GradientDrawable;
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v2, p0, mGradient:Landroid/graphics/drawable/GradientDrawable;
    ...
    iget-object v2, p0, mJandystripe:Landroid/graphics/Path;
    ...
    iget-object v6, p0, mPaint2:Landroid/graphics/Paint;
    ...
    :cond_0
    iget-boolean v0, p0, mDrawShadow:Z
    ...
    :cond_1
    iget-object v0, p0, mShadow:Landroid/graphics/Path;
