...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, USE_ANIMATIONS_WHEN_OPENING:Z
    ...
    sput-boolean v0, ICON_ANMATIONS_WHILE_SCROLLING:Z

    sget v0, Lcom/android/systemui/R$id;->continuous_clipping_tag:I

    sput v0, TAG_CONTINUOUS_CLIPPING:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p1, p0, mClipRect:Landroid/graphics/Rect;
...
.method static synthetic access$1000(Lcom/android/systemui/statusbar/NotificationShelf;)Lcom/android/systemui/statusbar/phone/NotificationIconContainer;
    ...
    iget-object p0, p0, mShelfIcons:Lcom/android/systemui/statusbar/phone/NotificationIconContainer;
...
.method static synthetic access$400()I
    ...
    sget v0, TAG_CONTINUOUS_CLIPPING:I
...
.method static synthetic access$500(Lcom/android/systemui/statusbar/NotificationShelf;Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;)V
    ...
    invoke-direct {p0, p1}, updateIconClipAmount(Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;)V
...
.method static synthetic access$600(Lcom/android/systemui/statusbar/NotificationShelf;)Z
    ...
    iget-boolean p0, p0, mShowNotificationShelf:Z
...
.method static synthetic access$700(Lcom/android/systemui/statusbar/NotificationShelf;F)V
    ...
    invoke-direct {p0, p1}, setOpenedAmount(F)V
...
.method static synthetic access$800(Lcom/android/systemui/statusbar/NotificationShelf;Z)V
    ...
    invoke-direct {p0, p1}, setHasItemsInStableShelf(Z)V
...
.method private clipTransientViews()V
    ...
    :goto_0
    iget-object v1, p0, mHostLayout:Lcom/android/systemui/statusbar/notification/stack/NotificationStackScrollLayout;
    ...
    invoke-direct {p0, v1, v2, v3}, updateNotificationClipHeight(Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;FI)I
...
.method private initDimens()V
    ...
    iput v1, p0, mIconAppearTopPadding:I
    ...
    iput v1, p0, mStatusBarPaddingStart:I
    ...
    iput v1, p0, mPaddingBetweenElements:I
    ...
    iput v1, p0, mShelfAppearTranslation:I
    ...
    iput v1, p0, mDarkShelfPadding:F
    ...
    iget-object v2, p0, mShelfIcons:Lcom/android/systemui/statusbar/phone/NotificationIconContainer;
    ...
    iput v1, p0, mScrollFastThreshold:I
    ...
    iput-boolean v1, p0, mShowNotificationShelf:Z
    ...
    iput v1, p0, mDarkShelfIconSize:F
    ...
    iput v0, p0, mGapHeight:I

    iget-boolean v0, p0, mShowNotificationShelf:Z
...
.method private setFirstElementRoundness(F)V
    ...
    iget v0, p0, mFirstElementRoundness:F

    cmpl-float v0, v0, p1

    if-eqz v0, :cond_0

    iput p1, p0, mFirstElementRoundness:F
...
.method private setHasItemsInStableShelf(Z)V
    ...
    iget-boolean v0, p0, mHasItemsInStableShelf:Z

    if-eq v0, p1, :cond_0

    iput-boolean p1, p0, mHasItemsInStableShelf:Z

    invoke-direct {p0}, updateInteractiveness()V
...
.method private setHideBackground(Z)V
    ...
    iget-boolean v0, p0, mHideBackground:Z

    if-eq v0, p1, :cond_0

    iput-boolean p1, p0, mHideBackground:Z
...
.method private setIconTransformationAmount(Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;FFZZ)V
    ...
    invoke-direct {p0, v0}, getIconState(Lcom/android/systemui/statusbar/StatusBarIconView;)Lcom/android/systemui/statusbar/phone/NotificationIconContainer$IconState;
    ...
    :cond_2
    iget p4, p0, mIconAppearTopPadding:I
    ...
    iget v7, p0, mDarkShelfIconSize:F
...
.method private setOpenedAmount(F)V
    ...
    :goto_0
    iput-boolean v1, p0, mNoAnimationsInThisFrame:Z

    iput p1, p0, mOpenedAmount:F
    ...
    iget-object v0, p0, mCollapsedIcons:Lcom/android/systemui/statusbar/phone/NotificationIconContainer;
    ...
    :cond_3
    iget-object v1, p0, mCollapsedIcons:Lcom/android/systemui/statusbar/phone/NotificationIconContainer;
    ...
    iget-object v2, p0, mCollapsedIcons:Lcom/android/systemui/statusbar/phone/NotificationIconContainer;
    ...
    iget-object v1, p0, mShelfIcons:Lcom/android/systemui/statusbar/phone/NotificationIconContainer;
...
.method private updateContinuousClipping(Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;)V
    ...
    :goto_0
    sget v4, TAG_CONTINUOUS_CLIPPING:I
    ...
    sget p0, TAG_CONTINUOUS_CLIPPING:I
...
.method private updateIconAppearance(Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;FZZZZ)F
    ...
    invoke-direct {v0, v2}, getIconState(Lcom/android/systemui/statusbar/StatusBarIconView;)Lcom/android/systemui/statusbar/phone/NotificationIconContainer$IconState;
    ...
    iget v6, v0, mPaddingBetweenElements:I
    ...
    iget-object v12, v0, mAmbientState:Lcom/android/systemui/statusbar/notification/stack/AmbientState;
    ...
    iget-object v13, v0, mHostLayout:Lcom/android/systemui/statusbar/notification/stack/NotificationStackScrollLayout;
    ...
    iget v13, v0, mMaxLayoutHeight:I
    ...
    iget-object v7, v0, mAmbientState:Lcom/android/systemui/statusbar/notification/stack/AmbientState;
    ...
    invoke-direct/range {v0 .. v8}, updateIconPositioning(Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;FFFZZZZ)V
...
.method private updateIconPositioning(Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;FFFZZZZ)V
    ...
    invoke-direct {p0, v1}, getIconState(Lcom/android/systemui/statusbar/StatusBarIconView;)Lcom/android/systemui/statusbar/phone/NotificationIconContainer$IconState;
    ...
    sget-boolean v10, ICON_ANMATIONS_WHILE_SCROLLING:Z
    ...
    iget-object v10, v0, mAmbientState:Lcom/android/systemui/statusbar/notification/stack/AmbientState;
    ...
    iget v10, v0, mMaxLayoutHeight:I
    ...
    :cond_d
    iget-object v1, v0, mAmbientState:Lcom/android/systemui/statusbar/notification/stack/AmbientState;
    ...
    sget-boolean v1, USE_ANIMATIONS_WHEN_OPENING:Z
    ...
    iget-boolean v1, v0, mNoAnimationsInThisFrame:Z
    ...
    invoke-direct/range {v0 .. v5}, setIconTransformationAmount(Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;FFZZ)V
...
.method private updateNotificationClipHeight(Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;FI)I
    ...
    iget-object v4, p0, mAmbientState:Lcom/android/systemui/statusbar/notification/stack/AmbientState;
...
.method private updateRelativeOffset()V
    ...
    iget-object v1, p0, mTmp:[I

    invoke-virtual {v0, v1}, Landroid/widget/FrameLayout;->getLocationOnScreen([I)V

    iget-object v0, p0, mTmp:[I

    const/4 v1, 0x0

    aget v2, v0, v1

    iput v2, p0, mRelativeOffset:I

    invoke-virtual {p0, v0}, Landroid/widget/FrameLayout;->getLocationOnScreen([I)V

    iget v0, p0, mRelativeOffset:I

    iget-object v2, p0, mTmp:[I

    aget v1, v2, v1

    sub-int/2addr v0, v1

    iput v0, p0, mRelativeOffset:I
...
.method public bind(Lcom/android/systemui/statusbar/notification/stack/AmbientState;Lcom/android/systemui/statusbar/notification/stack/NotificationStackScrollLayout;)V
    ...
    iput-object p1, p0, mAmbientState:Lcom/android/systemui/statusbar/notification/stack/AmbientState;

    iput-object p2, p0, mHostLayout:Lcom/android/systemui/statusbar/notification/stack/NotificationStackScrollLayout;
...
.method public fadeInTranslating()V
    ...
    iget-object v0, p0, mShelfIcons:Lcom/android/systemui/statusbar/phone/NotificationIconContainer;

    iget v1, p0, mShelfAppearTranslation:I
...
.method protected isInteractive()Z
    ...
    iget-boolean p0, p0, mInteractive:Z
...
.method public onFinishInflate()V
    ...
    iput-object v0, p0, mShelfIcons:Lcom/android/systemui/statusbar/phone/NotificationIconContainer;
...
.method protected onLayout(ZIIII)V
    ...
    invoke-direct {p0}, updateRelativeOffset()V
    ...
    iget-object p2, p0, mClipRect:Landroid/graphics/Rect;
    ...
    iget-object p1, p0, mShelfIcons:Lcom/android/systemui/statusbar/phone/NotificationIconContainer;

    iget-object p0, p0, mClipRect:Landroid/graphics/Rect;
...
.method public setCollapsedIcons(Lcom/android/systemui/statusbar/phone/NotificationIconContainer;)V
    ...
    iput-object p1, p0, mCollapsedIcons:Lcom/android/systemui/statusbar/phone/NotificationIconContainer;

    iget-object p1, p0, mCollapsedIcons:Lcom/android/systemui/statusbar/phone/NotificationIconContainer;
...
.method public updateAppearance()V
    ...
    iget-boolean v0, v7, mShowNotificationShelf:Z
    ...
    :cond_0
    iget-object v0, v7, mShelfIcons:Lcom/android/systemui/statusbar/phone/NotificationIconContainer;
    ...
    iget-object v0, v7, mAmbientState:Lcom/android/systemui/statusbar/notification/stack/AmbientState;
    ...
    iput v10, v7, mNotGoneIndex:I

    iget v0, v7, mMaxLayoutHeight:I
    ...
    :goto_0
    iget-boolean v0, v7, mHideBackground:Z
    ...
    iget v1, v7, mScrollFastThreshold:I
    ...
    iget-object v1, v7, mAmbientState:Lcom/android/systemui/statusbar/notification/stack/AmbientState;
    ...
    iget v2, v7, mScrollFastThreshold:I
    ...
    :goto_6
    iget-object v12, v7, mHostLayout:Lcom/android/systemui/statusbar/notification/stack/NotificationStackScrollLayout;
    ...
    :cond_c
    iget v1, v7, mPaddingBetweenElements:I
    ...
    invoke-virtual/range {p0 .. p0}, getNotificationMergeSize()I
    ...
    :goto_b
    invoke-direct {v7, v10, v1, v2}, updateNotificationClipHeight(Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;FI)I
    ...
    invoke-direct/range {v0 .. v6}, updateIconAppearance(Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;FZZZZ)F
    ...
    iget v2, v7, mNotGoneIndex:I

    const/4 v3, -0x1

    if-ne v2, v3, :cond_11

    iput v12, v7, mNotGoneIndex:I
    ...
    invoke-direct {v7, v0}, getIconState(Lcom/android/systemui/statusbar/StatusBarIconView;)Lcom/android/systemui/statusbar/phone/NotificationIconContainer$IconState;
    ...
    invoke-direct/range {p0 .. p0}, clipTransientViews()V
    ...
    invoke-direct {v7, v3}, setFirstElementRoundness(F)V
    ...
    :goto_17
    iget-object v1, v7, mHostLayout:Lcom/android/systemui/statusbar/notification/stack/NotificationStackScrollLayout;
    ...
    invoke-direct {v7, v1}, updateIconClipAmount(Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;)V

    invoke-direct {v7, v1}, updateContinuousClipping(Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;)V
    ...
    :cond_22
    invoke-direct {v7, v5}, setHideBackground(Z)V

    iget v0, v7, mNotGoneIndex:I
...
.method public updateState(Lcom/android/systemui/statusbar/notification/stack/AmbientState;)V
    ...
    iget-boolean v2, p0, mShowNotificationShelf:Z
    ...
    invoke-direct {p0}, getFullyClosedTranslation()F
    ...
    iget-object v6, p0, mAmbientState:Lcom/android/systemui/statusbar/notification/stack/AmbientState;
    ...
    :goto_0
    iget v7, p0, mDarkShelfPadding:F
