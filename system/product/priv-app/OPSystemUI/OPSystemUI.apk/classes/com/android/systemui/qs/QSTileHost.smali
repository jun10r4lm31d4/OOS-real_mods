...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/statusbar/phone/StatusBarIconController;Lcom/android/systemui/qs/tileimpl/QSFactoryImpl;Landroid/os/Handler;Landroid/os/Looper;Lcom/android/systemui/shared/plugins/PluginManager;Lcom/android/systemui/tuner/TunerService;Ljavax/inject/Provider;Lcom/android/systemui/DumpController;)V
    ...
    iput-object v0, p0, mTiles:Ljava/util/LinkedHashMap;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mTileSpecs:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, mQsFactories:Ljava/util/ArrayList;

    iput-object p2, p0, mIconController:Lcom/android/systemui/statusbar/phone/StatusBarIconController;

    iput-object p1, p0, mContext:Landroid/content/Context;

    iput-object p7, p0, mTunerService:Lcom/android/systemui/tuner/TunerService;

    iput-object p6, p0, mPluginManager:Lcom/android/systemui/shared/plugins/PluginManager;

    iput-object p9, p0, mDumpController:Lcom/android/systemui/DumpController;
    ...
    iput-object p1, p0, mServices:Lcom/android/systemui/qs/external/TileServices;

    invoke-virtual {p3, p0}, Lcom/android/systemui/qs/tileimpl/QSFactoryImpl;->setHost(Lcom/android/systemui/qs/QSTileHost;)V

    iget-object p1, p0, mQsFactories:Ljava/util/ArrayList;
    ...
    iget-object p1, p0, mDumpController:Lcom/android/systemui/DumpController;
    ...
    iput-object p1, p0, mOperatorCustom:Lcom/android/systemui/qs/QSTileHost$OperatorCustom;

    iget-object p0, p0, mOperatorCustom:Lcom/android/systemui/qs/QSTileHost$OperatorCustom;
...
.method private changeTileSpecs(Ljava/util/function/Predicate;)V
    ...
    invoke-static {v1, v0}, loadTileSpecs(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
...
.method public addTile(Landroid/content/ComponentName;)V
    ...
    iget-object v1, p0, mTileSpecs:Ljava/util/ArrayList;
    ...
    iget-object p1, p0, mTileSpecs:Ljava/util/ArrayList;

    invoke-virtual {p0, p1, v0}, changeTiles(Ljava/util/List;Ljava/util/List;)V
...
.method public addTile(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0}, changeTileSpecs(Ljava/util/function/Predicate;)V
...
.method public changeTiles(Ljava/util/List;Ljava/util/List;)V
    ...
    iget-object v9, p0, mServices:Lcom/android/systemui/qs/external/TileServices;
...
.method public createTile(Ljava/lang/String;)Lcom/android/systemui/plugins/qs/QSTile;
    ...
    :goto_0
    iget-object v1, p0, mQsFactories:Ljava/util/ArrayList;
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object p0, p0, mTiles:Ljava/util/LinkedHashMap;
...
.method public getTileServices()Lcom/android/systemui/qs/external/TileServices;
    ...
    iget-object p0, p0, mServices:Lcom/android/systemui/qs/external/TileServices;
...
.method public indexOf(Ljava/lang/String;)I
    ...
    iget-object p0, p0, mTileSpecs:Ljava/util/ArrayList;
...
.method public isNeedToHide(Ljava/lang/String;)Z
    ...
    iget-object v0, p0, mOperatorCustom:Lcom/android/systemui/qs/QSTileHost$OperatorCustom;
...
.method public synthetic lambda$new$0$QSTileHost(Lcom/android/systemui/tuner/TunerService;Ljavax/inject/Provider;)V
    ...
    iput-object p1, p0, mAutoTiles:Lcom/android/systemui/statusbar/phone/AutoTileManager;
...
.method public bridge synthetic onPluginConnected(Lcom/android/systemui/plugins/Plugin;Landroid/content/Context;)V
    ...
    invoke-virtual {p0, p1, p2}, onPluginConnected(Lcom/android/systemui/plugins/qs/QSFactory;Landroid/content/Context;)V
...
.method public onPluginConnected(Lcom/android/systemui/plugins/qs/QSFactory;Landroid/content/Context;)V
    ...
    iget-object p2, p0, mQsFactories:Ljava/util/ArrayList;

    const/4 v0, 0x0

    invoke-virtual {p2, v0, p1}, Ljava/util/ArrayList;->add(ILjava/lang/Object;)V

    iget-object p1, p0, mTunerService:Lcom/android/systemui/tuner/TunerService;
    ...
    invoke-virtual {p0, p2, v0}, onTuningChanged(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, p2, p1}, onTuningChanged(Ljava/lang/String;Ljava/lang/String;)V
...
.method public bridge synthetic onPluginDisconnected(Lcom/android/systemui/plugins/Plugin;)V
    ...
    invoke-virtual {p0, p1}, onPluginDisconnected(Lcom/android/systemui/plugins/qs/QSFactory;)V
...
.method public onPluginDisconnected(Lcom/android/systemui/plugins/qs/QSFactory;)V
    ...
    iget-object v0, p0, mQsFactories:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v0, v1}, onTuningChanged(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, v0, p1}, onTuningChanged(Ljava/lang/String;Ljava/lang/String;)V
...
.method public onTuningChanged(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1, p2}, loadTileSpecs(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    :cond_3
    iget-object v1, p0, mTiles:Ljava/util/LinkedHashMap;
    ...
    iget-object v4, p0, mTiles:Ljava/util/LinkedHashMap;
    ...
    :cond_c
    :try_start_0
    invoke-virtual {p0, v3}, createTile(Ljava/lang/String;)Lcom/android/systemui/plugins/qs/QSTile;
    ...
    :cond_e
    iput p2, p0, mCurrentUser:I

    new-instance p2, Ljava/util/ArrayList;

    iget-object v2, p0, mTileSpecs:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, mTiles:Ljava/util/LinkedHashMap;
    ...
    invoke-static {p1, v0}, loadTileSpecs(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;

    move-result-object p1

    invoke-virtual {p0, p2, p1}, changeTiles(Ljava/util/List;Ljava/util/List;)V
    ...
    :goto_1
    iget-object p2, p0, mCallbacks:Ljava/util/List;
...
.method public unmarkTileAsAutoAdded(Ljava/lang/String;)V
    ...
    iget-object p0, p0, mAutoTiles:Lcom/android/systemui/statusbar/phone/AutoTileManager;
