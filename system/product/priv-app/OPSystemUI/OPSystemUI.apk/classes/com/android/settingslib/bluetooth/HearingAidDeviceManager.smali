...
.method constructor <init>(Lcom/android/settingslib/bluetooth/LocalBluetoothManager;Ljava/util/List;)V
    ...
    iput-object p1, p0, mBtManager:Lcom/android/settingslib/bluetooth/LocalBluetoothManager;

    iput-object p2, p0, mCachedDevices:Ljava/util/List;
...
.method private getCachedDevice(J)Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;
    ...
    iget-object v0, p0, mCachedDevices:Ljava/util/List;
    ...
    iget-object v1, p0, mCachedDevices:Ljava/util/List;
...
.method private getHiSyncId(Landroid/bluetooth/BluetoothDevice;)J
    ...
    iget-object p0, p0, mBtManager:Lcom/android/settingslib/bluetooth/LocalBluetoothManager;
...
.method findMainDevice(Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;)Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;
    ...
    invoke-direct {p0, v2, v3}, isValidHiSyncId(J)Z
...
.method initHearingAidDeviceIfNeeded(Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;)V
    ...
    invoke-direct {p0, v0}, getHiSyncId(Landroid/bluetooth/BluetoothDevice;)J

    move-result-wide v0

    invoke-direct {p0, v0, v1}, isValidHiSyncId(J)Z
...
.method onHiSyncIdChanged(J)V
    ...
    iget-object v3, p0, mCachedDevices:Ljava/util/List;
...
.method onProfileConnectionStateChangedIfProcessed(Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;I)Z
    ...
    invoke-virtual {p0, v1, v2}, onHiSyncIdChanged(J)V

    invoke-virtual {p0, p1}, findMainDevice(Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;)Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;
    ...
    :cond_1
    iget-object p2, p0, mBtManager:Lcom/android/settingslib/bluetooth/LocalBluetoothManager;
...
.method setSubDeviceIfNeeded(Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;)Z
    ...
    invoke-direct {p0, v0, v1}, getCachedDevice(J)Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;
...
.method updateHearingAidsDevices()V
    ...
    invoke-direct {p0, v3, v4}, isValidHiSyncId(J)Z
    ...
    invoke-direct {p0, v3}, getHiSyncId(Landroid/bluetooth/BluetoothDevice;)J
