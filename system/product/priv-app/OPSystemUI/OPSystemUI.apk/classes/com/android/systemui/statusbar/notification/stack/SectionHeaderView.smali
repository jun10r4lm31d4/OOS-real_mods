...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p1, p0, mOnClearClickListener:Landroid/view/View$OnClickListener;

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, mTmpRect:Landroid/graphics/RectF;
...
.method private bindContents()V
    ...
    iput-object v0, p0, mLabelView:Landroid/widget/TextView;
    ...
    iput-object v0, p0, mClearAllButton:Landroid/widget/ImageView;

    iget-object v0, p0, mOnClearClickListener:Landroid/view/View$OnClickListener;

    if-eqz v0, :cond_0

    iget-object p0, p0, mClearAllButton:Landroid/widget/ImageView;
...
.method protected disallowSingleClick(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, mTmpRect:Landroid/graphics/RectF;

    iget-object v1, p0, mClearAllButton:Landroid/widget/ImageView;
    ...
    iget-object v2, p0, mClearAllButton:Landroid/widget/ImageView;
    ...
    iget-object v3, p0, mClearAllButton:Landroid/widget/ImageView;

    invoke-virtual {v3}, Landroid/widget/ImageView;->getLeft()I

    move-result v3

    iget-object v4, p0, mClearAllButton:Landroid/widget/ImageView;
    ...
    iget-object v5, p0, mClearAllButton:Landroid/widget/ImageView;
    ...
    iget-object p0, p0, mTmpRect:Landroid/graphics/RectF;
...
.method protected getContentView()Landroid/view/View;
    ...
    iget-object p0, p0, mContents:Landroid/view/ViewGroup;
...
.method protected onFinishInflate()V
    ...
    iput-object v0, p0, mContents:Landroid/view/ViewGroup;

    invoke-direct {p0}, bindContents()V
...
.method onUiModeChanged()V
    ...
    iget-object v0, p0, mLabelView:Landroid/widget/TextView;
    ...
    iget-object v0, p0, mClearAllButton:Landroid/widget/ImageView;
...
.method reinflateContents()V
    ...
    iget-object v0, p0, mContents:Landroid/view/ViewGroup;
    ...
    iget-object v2, p0, mContents:Landroid/view/ViewGroup;
