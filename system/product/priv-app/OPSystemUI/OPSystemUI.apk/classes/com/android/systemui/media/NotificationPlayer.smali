...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput-object v0, p0, mCompletionHandlingLock:Ljava/lang/Object;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, mPlayerLock:Ljava/lang/Object;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, mQueueAudioFocusLock:Ljava/lang/Object;

    const/4 v0, 0x0

    iput v0, p0, mNotificationRampTimeMs:I
...
.method private abandonAudioFocusAfterError()V
    ...
    iget-object v0, p0, mQueueAudioFocusLock:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, mAudioManagerWithAudioFocus:Landroid/media/AudioManager;
    ...
    iput-object v2, p0, mAudioManagerWithAudioFocus:Landroid/media/AudioManager;
...
.method static synthetic access$000(Lcom/android/systemui/media/NotificationPlayer;)Landroid/os/Looper;
    ...
    iget-object p0, p0, mLooper:Landroid/os/Looper;
...
.method static synthetic access$100(Lcom/android/systemui/media/NotificationPlayer;)Ljava/lang/Object;
    ...
    iget-object p0, p0, mQueueAudioFocusLock:Ljava/lang/Object;
...
.method static synthetic access$1000(Lcom/android/systemui/media/NotificationPlayer;)Ljava/lang/Object;
    ...
    iget-object p0, p0, mCompletionHandlingLock:Ljava/lang/Object;
...
.method static synthetic access$1102(Lcom/android/systemui/media/NotificationPlayer;Lcom/android/systemui/media/NotificationPlayer$CmdThread;)Lcom/android/systemui/media/NotificationPlayer$CmdThread;
    ...
    iput-object p1, p0, mThread:Lcom/android/systemui/media/NotificationPlayer$CmdThread;
...
.method static synthetic access$200(Lcom/android/systemui/media/NotificationPlayer;)Landroid/media/AudioManager;
    ...
    iget-object p0, p0, mAudioManagerWithAudioFocus:Landroid/media/AudioManager;
...
.method static synthetic access$202(Lcom/android/systemui/media/NotificationPlayer;Landroid/media/AudioManager;)Landroid/media/AudioManager;
    ...
    iput-object p1, p0, mAudioManagerWithAudioFocus:Landroid/media/AudioManager;
...
.method static synthetic access$300(Lcom/android/systemui/media/NotificationPlayer;)I
    ...
    iget p0, p0, mNotificationRampTimeMs:I
...
.method static synthetic access$302(Lcom/android/systemui/media/NotificationPlayer;I)I
    ...
    iput p1, p0, mNotificationRampTimeMs:I
...
.method static synthetic access$500(Lcom/android/systemui/media/NotificationPlayer;)V
    ...
    invoke-direct {p0}, abandonAudioFocusAfterError()V
...
.method static synthetic access$600(Lcom/android/systemui/media/NotificationPlayer;)Ljava/lang/Object;
    ...
    iget-object p0, p0, mPlayerLock:Ljava/lang/Object;
...
.method static synthetic access$700(Lcom/android/systemui/media/NotificationPlayer;)Landroid/media/MediaPlayer;
    ...
    iget-object p0, p0, mPlayer:Landroid/media/MediaPlayer;
...
.method static synthetic access$800(Lcom/android/systemui/media/NotificationPlayer;)Ljava/util/LinkedList;
    ...
    iget-object p0, p0, mCmdQueue:Ljava/util/LinkedList;
...
.method static synthetic access$900(Lcom/android/systemui/media/NotificationPlayer;Lcom/android/systemui/media/NotificationPlayer$Command;)V
    ...
    invoke-direct {p0, p1}, startSound(Lcom/android/systemui/media/NotificationPlayer$Command;)V
...
.method private enqueueLocked(Lcom/android/systemui/media/NotificationPlayer$Command;)V
    ...
    iget-object p1, p0, mThread:Lcom/android/systemui/media/NotificationPlayer$CmdThread;
    ...
    iget-object p0, p0, mThread:Lcom/android/systemui/media/NotificationPlayer$CmdThread;
...
.method private startSound(Lcom/android/systemui/media/NotificationPlayer$Command;)V
    ...
    :try_start_0
    iget-object v0, p0, mCompletionHandlingLock:Ljava/lang/Object;
    ...
    iput-object v1, p0, mCompletionThread:Lcom/android/systemui/media/NotificationPlayer$CreationAndCompletionThread;

    iget-object v1, p0, mCompletionThread:Lcom/android/systemui/media/NotificationPlayer$CreationAndCompletionThread;
    ...
    :try_start_2
    iget-object v2, p0, mCompletionThread:Lcom/android/systemui/media/NotificationPlayer$CreationAndCompletionThread;
...
.method public onCompletion(Landroid/media/MediaPlayer;)V
    ...
    iget-object v1, p0, mCmdQueue:Ljava/util/LinkedList;
    ...
    :try_start_2
    iget-object v3, p0, mCmdQueue:Ljava/util/LinkedList;
    ...
    :cond_1
    iput-object v2, p0, mCompletionThread:Lcom/android/systemui/media/NotificationPlayer$CreationAndCompletionThread;
    ...
    :try_start_4
    iget-object v1, p0, mPlayer:Landroid/media/MediaPlayer;

    if-ne p1, v1, :cond_3

    iput-object v2, p0, mPlayer:Landroid/media/MediaPlayer;
...
.method public onError(Landroid/media/MediaPlayer;II)Z
    ...
    invoke-virtual {p0, p1}, onCompletion(Landroid/media/MediaPlayer;)V
...
.method public play(Landroid/content/Context;Landroid/net/Uri;ZLandroid/media/AudioAttributes;)V
    ...
    iget-object p1, p0, mCmdQueue:Ljava/util/LinkedList;

    monitor-enter p1

    :try_start_0
    invoke-direct {p0, v0}, enqueueLocked(Lcom/android/systemui/media/NotificationPlayer$Command;)V
...
.method public setUsesWakeLock(Landroid/content/Context;)V
    ...
    iget-object v1, p0, mThread:Lcom/android/systemui/media/NotificationPlayer$CmdThread;
...
.method public stop()V
    ...
    invoke-direct {p0, v1}, enqueueLocked(Lcom/android/systemui/media/NotificationPlayer$Command;)V
