...
.method public constructor <init>(Landroid/content/Context;ILandroid/view/View;)V
    ...
    iput p3, p0, mWarning:I

    invoke-virtual {p1, p2}, Landroid/content/Context;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object p1

    iput-object p1, p0, mGradient:Landroid/graphics/drawable/Drawable;
...
.method public applyModeBackground(IIZ)V
    ...
    iput-boolean p3, p0, mAnimating:Z
    ...
    iput-wide p1, p0, mEndTime:J

    iget p1, p0, mGradientAlpha:I

    iput p1, p0, mGradientAlphaStart:I

    iget p1, p0, mColor:I

    iput p1, p0, mColorStart:I
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget v3, p0, mGradientAlphaStart:I
    ...
    iget v1, p0, mColorStart:I

    invoke-static {v1}, Landroid/graphics/Color;->red(I)I

    move-result v1

    iget v2, p0, mColorStart:I

    invoke-static {v2}, Landroid/graphics/Color;->green(I)I

    move-result v2

    iget v3, p0, mColorStart:I
    ...
    :goto_2
    iget v0, p0, mGradientAlpha:I

    if-lez v0, :cond_c

    iget-object v1, p0, mGradient:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v1, v0}, Landroid/graphics/drawable/Drawable;->setAlpha(I)V

    iget-object v0, p0, mGradient:Landroid/graphics/drawable/Drawable;
...
.method protected onBoundsChange(Landroid/graphics/Rect;)V
    ...
    iget-object p0, p0, mGradient:Landroid/graphics/drawable/Drawable;
...
.method public setFrame(Landroid/graphics/Rect;)V
    ...
    iput-object p1, p0, mFrame:Landroid/graphics/Rect;
