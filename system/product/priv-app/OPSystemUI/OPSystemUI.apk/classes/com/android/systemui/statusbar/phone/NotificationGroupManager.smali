...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mGroupMap:Ljava/util/HashMap;

    new-instance v0, Landroid/util/ArraySet;

    invoke-direct {v0}, Landroid/util/ArraySet;-><init>()V

    iput-object v0, p0, mListeners:Landroid/util/ArraySet;

    const/4 v0, -0x1

    iput v0, p0, mBarState:I

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, mIsolatedEntries:Ljava/util/HashMap;
...
.method private getGroupSummary(Ljava/lang/String;)Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;
    ...
    iget-object p0, p0, mGroupMap:Ljava/util/HashMap;
...
.method private getIsolatedChild(Ljava/lang/String;)Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;
    ...
    iget-object v0, p0, mIsolatedEntries:Ljava/util/HashMap;
    ...
    invoke-direct {p0, v1}, isIsolated(Landroid/service/notification/StatusBarNotification;)Z
...
.method private getNumberOfIsolatedChildren(Ljava/lang/String;)I
    ...
    invoke-direct {p0, v2}, isIsolated(Landroid/service/notification/StatusBarNotification;)Z
...
.method private getTotalNumberOfChildren(Landroid/service/notification/StatusBarNotification;)I
    ...
    invoke-direct {p0, v0}, getNumberOfIsolatedChildren(Ljava/lang/String;)I
...
.method private hasIsolatedChildren(Lcom/android/systemui/statusbar/phone/NotificationGroupManager$NotificationGroup;)Z
    ...
    invoke-direct {p0, p1}, getNumberOfIsolatedChildren(Ljava/lang/String;)I
...
.method private isIsolated(Landroid/service/notification/StatusBarNotification;)Z
    ...
    iget-object p0, p0, mIsolatedEntries:Ljava/util/HashMap;
...
.method private isOnlyChild(Landroid/service/notification/StatusBarNotification;)Z
    ...
    invoke-direct {p0, p1}, getTotalNumberOfChildren(Landroid/service/notification/StatusBarNotification;)I
...
.method private isolateNotification(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V
    ...
    invoke-direct {p0, p1, v0}, onEntryRemovedInternal(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;Landroid/service/notification/StatusBarNotification;)V

    iget-object v1, p0, mIsolatedEntries:Ljava/util/HashMap;
    ...
    invoke-virtual {p0, p1}, onEntryAdded(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V

    iget-object v0, p0, mGroupMap:Ljava/util/HashMap;
    ...
    invoke-direct {p0, p1}, updateSuppression(Lcom/android/systemui/statusbar/phone/NotificationGroupManager$NotificationGroup;)V

    iget-object p0, p0, mListeners:Landroid/util/ArraySet;
...
.method private onAlertStateChanged(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;Z)V
    ...
    invoke-direct {p0, p1}, shouldIsolate(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)Z

    move-result p2

    if-eqz p2, :cond_1

    invoke-direct {p0, p1}, isolateNotification(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V

    goto :goto_0

    :cond_0
    invoke-direct {p0, p1}, stopIsolatingNotification(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V
...
.method private onEntryRemovedInternal(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;Landroid/service/notification/StatusBarNotification;)V
    ...
    invoke-virtual {p0, p2}, getGroupKey(Landroid/service/notification/StatusBarNotification;)Ljava/lang/String;

    move-result-object v0

    iget-object v1, p0, mGroupMap:Ljava/util/HashMap;
    ...
    :cond_0
    invoke-virtual {p0, p2}, isGroupChild(Landroid/service/notification/StatusBarNotification;)Z
    ...
    :goto_0
    invoke-direct {p0, v1}, updateSuppression(Lcom/android/systemui/statusbar/phone/NotificationGroupManager$NotificationGroup;)V
    ...
    iget-object p1, p0, mGroupMap:Ljava/util/HashMap;
...
.method private setStatusBarState(I)V
    ...
    invoke-virtual {p0}, collapseAllGroups()V
...
.method private shouldIsolate(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)Z
    ...
    :cond_0
    iget-object v2, p0, mHeadsUpManager:Lcom/android/systemui/statusbar/policy/HeadsUpManager;
    ...
    iget-object v2, p0, mAmbientPulseManager:Lcom/android/systemui/statusbar/AmbientPulseManager;
    ...
    invoke-direct {p0, v1}, isGroupNotFullyVisible(Lcom/android/systemui/statusbar/phone/NotificationGroupManager$NotificationGroup;)Z
...
.method private stopIsolatingNotification(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V
    ...
    invoke-direct {p0, p1, v1}, onEntryRemovedInternal(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;Landroid/service/notification/StatusBarNotification;)V
...
.method private updateSuppression(Lcom/android/systemui/statusbar/phone/NotificationGroupManager$NotificationGroup;)V
    ...
    invoke-direct {p0, p1}, hasIsolatedChildren(Lcom/android/systemui/statusbar/phone/NotificationGroupManager$NotificationGroup;)Z
    ...
    iget-object v0, p0, mListeners:Landroid/util/ArraySet;
    ...
    iget-boolean v2, p0, mIsUpdatingUnchangedGroup:Z
...
.method public collapseAllGroups()V
    ...
    invoke-direct {p0, v4, v2}, setGroupExpanded(Lcom/android/systemui/statusbar/phone/NotificationGroupManager$NotificationGroup;Z)V

    :cond_0
    invoke-direct {p0, v4}, updateSuppression(Lcom/android/systemui/statusbar/phone/NotificationGroupManager$NotificationGroup;)V
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object p3, p0, mGroupMap:Ljava/util/HashMap;
    ...
    iget-object p3, p0, mIsolatedEntries:Ljava/util/HashMap;
...
.method public getGroupKey(Landroid/service/notification/StatusBarNotification;)Ljava/lang/String;
    ...
    invoke-direct {p0, p1}, isIsolated(Landroid/service/notification/StatusBarNotification;)Z
...
.method public getGroupSummary(Landroid/service/notification/StatusBarNotification;)Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;
    ...
    invoke-virtual {p0, p1}, getGroupKey(Landroid/service/notification/StatusBarNotification;)Ljava/lang/String;

    move-result-object p1

    invoke-direct {p0, p1}, getGroupSummary(Ljava/lang/String;)Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;
...
.method public getLogicalChildren(Landroid/service/notification/StatusBarNotification;)Ljava/util/ArrayList;
    ...
    invoke-direct {p0, p1}, getIsolatedChild(Ljava/lang/String;)Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;
...
.method public isChildInGroupWithSummary(Landroid/service/notification/StatusBarNotification;)Z
    ...
    invoke-virtual {p0, p1}, isGroupChild(Landroid/service/notification/StatusBarNotification;)Z
...
.method public isOnlyChildInGroup(Landroid/service/notification/StatusBarNotification;)Z
    ...
    invoke-direct {p0, p1}, isOnlyChild(Landroid/service/notification/StatusBarNotification;)Z
    ...
    :cond_0
    invoke-virtual {p0, p1}, getLogicalGroupSummary(Landroid/service/notification/StatusBarNotification;)Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;
...
.method public isSummaryOfGroup(Landroid/service/notification/StatusBarNotification;)Z
    ...
    invoke-virtual {p0, p1}, isGroupSummary(Landroid/service/notification/StatusBarNotification;)Z
...
.method public isSummaryOfSuppressedGroup(Landroid/service/notification/StatusBarNotification;)Z
    ...
    invoke-direct {p0, v0}, isGroupSuppressed(Ljava/lang/String;)Z
...
.method public onAmbientStateChanged(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;Z)V
    ...
    invoke-direct {p0, p1, p2}, onAlertStateChanged(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;Z)V
...
.method public onEntryAdded(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V
    ...
    invoke-virtual {p0, v0}, isGroupChild(Landroid/service/notification/StatusBarNotification;)Z

    move-result v1

    invoke-virtual {p0, v0}, getGroupKey(Landroid/service/notification/StatusBarNotification;)Ljava/lang/String;

    move-result-object v0

    iget-object v2, p0, mGroupMap:Ljava/util/HashMap;
    ...
    iget-object v3, p0, mGroupMap:Ljava/util/HashMap;

    invoke-virtual {v3, v0, v2}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v3, p0, mListeners:Landroid/util/ArraySet;
    ...
    invoke-direct {p0, v2}, updateSuppression(Lcom/android/systemui/statusbar/phone/NotificationGroupManager$NotificationGroup;)V
    ...
    invoke-direct {p0, v0}, onEntryBecomingChild(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V
...
.method public onEntryUpdated(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;Landroid/service/notification/StatusBarNotification;)V
    ...
    invoke-virtual {p0, v5}, isGroupChild(Landroid/service/notification/StatusBarNotification;)Z
    ...
    :goto_0
    iput-boolean v3, p0, mIsUpdatingUnchangedGroup:Z
    ...
    invoke-direct {p0, p1, p2}, onEntryRemovedInternal(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;Landroid/service/notification/StatusBarNotification;)V

    :cond_1
    invoke-virtual {p0, p1}, onEntryAdded(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V

    iput-boolean v6, p0, mIsUpdatingUnchangedGroup:Z
    ...
    invoke-direct {p0, p2}, isIsolated(Landroid/service/notification/StatusBarNotification;)Z

    move-result p2

    if-eqz p2, :cond_2

    iget-object p2, p0, mIsolatedEntries:Ljava/util/HashMap;
    ...
    invoke-direct {p0, p1}, onEntryBecomingChild(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V
...
.method public onStateChanged(I)V
    ...
    invoke-direct {p0, p1}, setStatusBarState(I)V
...
.method public setGroupExpanded(Landroid/service/notification/StatusBarNotification;Z)V
    ...
    :cond_0
    invoke-direct {p0, p1, p2}, setGroupExpanded(Lcom/android/systemui/statusbar/phone/NotificationGroupManager$NotificationGroup;Z)V
...
.method public toggleGroupExpansion(Landroid/service/notification/StatusBarNotification;)Z
    ...
    invoke-direct {p0, p1, v0}, setGroupExpanded(Lcom/android/systemui/statusbar/phone/NotificationGroupManager$NotificationGroup;Z)V
