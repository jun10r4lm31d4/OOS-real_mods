...
.method public constructor <init>(Lcom/android/systemui/statusbar/policy/BatteryControllerImpl;)V
    ...
    iput-object p1, p0, this$0:Lcom/android/systemui/statusbar/policy/BatteryControllerImpl;
    ...
    iput p1, p0, BATTERY_BAR_STYLE:I

    const/4 p1, 0x3

    iput p1, p0, BATTERY_PERCENT_STYLE:I
    ...
    iput-object p1, p0, SHOW_BATTERY_PERCENT:Landroid/net/Uri;
    ...
    iput-object p1, p0, STATUS_BAR_BATTERY_STYLE:Landroid/net/Uri;
    ...
    iput-object p1, p0, CHARING_OPTIMIZATED_STATUS_URI:Landroid/net/Uri;
...
.method observe()V
    ...
    iget-object v0, p0, this$0:Lcom/android/systemui/statusbar/policy/BatteryControllerImpl;
    ...
    iget-object v1, p0, SHOW_BATTERY_PERCENT:Landroid/net/Uri;
    ...
    iget-object v1, p0, STATUS_BAR_BATTERY_STYLE:Landroid/net/Uri;

    invoke-virtual {v0, v1, v3, p0, v2}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;I)V

    iget-object v1, p0, CHARING_OPTIMIZATED_STATUS_URI:Landroid/net/Uri;
...
.method public update(Landroid/net/Uri;)V
    ...
    iget-object v4, p0, SHOW_BATTERY_PERCENT:Landroid/net/Uri;
    ...
    :cond_1
    :goto_0
    iget-object v4, p0, this$0:Lcom/android/systemui/statusbar/policy/BatteryControllerImpl;
    ...
    iget-object v6, p0, STATUS_BAR_BATTERY_STYLE:Landroid/net/Uri;
    ...
    :cond_7
    :goto_3
    iget-object v1, p0, this$0:Lcom/android/systemui/statusbar/policy/BatteryControllerImpl;
    ...
    iget-object p1, p0, this$0:Lcom/android/systemui/statusbar/policy/BatteryControllerImpl;
    ...
    iget-object p0, p0, this$0:Lcom/android/systemui/statusbar/policy/BatteryControllerImpl;
