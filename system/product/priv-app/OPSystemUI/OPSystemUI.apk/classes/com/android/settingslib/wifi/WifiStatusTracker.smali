...
.method public constructor <init>(Landroid/content/Context;Landroid/net/wifi/WifiManager;Landroid/net/NetworkScoreManager;Landroid/net/ConnectivityManager;Ljava/lang/Runnable;)V
    ...
    iput-object v0, p0, mCacheListener:Landroid/net/wifi/WifiNetworkScoreCache$CacheListener;
    ...
    iput-object p2, p0, mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    iput-object p2, p0, mWifiNetworkScoreCache:Landroid/net/wifi/WifiNetworkScoreCache;

    iput-object p3, p0, mNetworkScoreManager:Landroid/net/NetworkScoreManager;

    iput-object p4, p0, mConnectivityManager:Landroid/net/ConnectivityManager;

    iput-object p5, p0, mCallback:Ljava/lang/Runnable;
...
.method static synthetic access$000(Lcom/android/settingslib/wifi/WifiStatusTracker;)V
    ...
    invoke-direct {p0}, updateStatusLabel()V
...
.method static synthetic access$100(Lcom/android/settingslib/wifi/WifiStatusTracker;)Ljava/lang/Runnable;
    ...
    iget-object p0, p0, mCallback:Ljava/lang/Runnable;
...
.method private maybeRequestNetworkScore()V
    ...
    iget-object v0, p0, mWifiInfo:Landroid/net/wifi/WifiInfo;

    invoke-static {v0}, Landroid/net/NetworkKey;->createFromWifiInfo(Landroid/net/wifi/WifiInfo;)Landroid/net/NetworkKey;

    move-result-object v0

    iget-object v1, p0, mWifiNetworkScoreCache:Landroid/net/wifi/WifiNetworkScoreCache;
    ...
    iget-object p0, p0, mNetworkScoreManager:Landroid/net/NetworkScoreManager;
...
.method private updateStatusLabel()V
    ...
    iput-object v0, p0, statusLabel:Ljava/lang/String;
    ...
    :cond_2
    iget-object v0, p0, mWifiNetworkScoreCache:Landroid/net/wifi/WifiNetworkScoreCache;

    iget-object v1, p0, mWifiInfo:Landroid/net/wifi/WifiInfo;
...
.method public handleBroadcast(Landroid/content/Intent;)V
    ...
    invoke-direct {p0}, updateWifiState()V
    ...
    :goto_0
    iput-boolean p1, p0, connected:Z

    const/4 p1, 0x0

    iput-object p1, p0, mWifiInfo:Landroid/net/wifi/WifiInfo;

    iput-object p1, p0, ssid:Ljava/lang/String;

    iget-boolean p1, p0, connected:Z
    ...
    iget-object p1, p0, mWifiInfo:Landroid/net/wifi/WifiInfo;
    ...
    invoke-direct {p0, p1}, getValidSsid(Landroid/net/wifi/WifiInfo;)Ljava/lang/String;
    ...
    invoke-direct {p0, p1}, updateRssi(I)V

    invoke-direct {p0}, maybeRequestNetworkScore()V
    ...
    iput-boolean p1, p0, vhtMax8SpatialStreamsSupport:Z
    ...
    iput-boolean p1, p0, twtSupport:Z
...
.method public setListening(Z)V
    ...
    iget-object p1, p0, mNetworkScoreManager:Landroid/net/NetworkScoreManager;
    ...
    iget-object p1, p0, mWifiNetworkScoreCache:Landroid/net/wifi/WifiNetworkScoreCache;

    iget-object v0, p0, mCacheListener:Landroid/net/wifi/WifiNetworkScoreCache$CacheListener;
    ...
    iget-object v0, p0, mNetworkRequest:Landroid/net/NetworkRequest;

    iget-object v1, p0, mNetworkCallback:Landroid/net/ConnectivityManager$NetworkCallback;
    ...
    iget-object p0, p0, mNetworkCallback:Landroid/net/ConnectivityManager$NetworkCallback;
