...
.method static synthetic access$100(Lcom/android/systemui/usb/StorageNotification;)Landroid/os/storage/StorageManager;
    ...
    iget-object p0, p0, mStorageManager:Landroid/os/storage/StorageManager;
...
.method static synthetic access$400(Lcom/android/systemui/usb/StorageNotification;Landroid/os/storage/DiskInfo;)V
    ...
    invoke-direct {p0, p1}, onDiskDestroyedInternal(Landroid/os/storage/DiskInfo;)V
...
.method static synthetic access$600(Lcom/android/systemui/usb/StorageNotification;)Landroid/util/SparseArray;
    ...
    iget-object p0, p0, mMoves:Landroid/util/SparseArray;
...
.method private buildBrowsePendingIntent(Landroid/os/storage/VolumeInfo;)Landroid/app/PendingIntent;
    ...
    :try_start_0
    invoke-virtual {p0, p1}, buildOneplusBrowseIntentForUser(Landroid/os/storage/VolumeInfo;)Landroid/content/Intent;
...
.method private buildNotificationBuilder(Landroid/os/storage/VolumeInfo;Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;
    ...
    invoke-direct {p0, v1, p1}, getSmallIcon(Landroid/os/storage/DiskInfo;I)I
...
.method private onMoveFinished(Lcom/android/systemui/usb/StorageNotification$MoveInfo;I)V
    ...
    invoke-direct {p0, v0}, buildWizardReadyPendingIntent(Landroid/os/storage/DiskInfo;)Landroid/app/PendingIntent;
    ...
    invoke-direct {p0, v0}, buildVolumeSettingsPendingIntent(Landroid/os/storage/VolumeInfo;)Landroid/app/PendingIntent;
...
.method private onVolumeBadRemoval(Landroid/os/storage/VolumeInfo;)Landroid/app/Notification;
    ...
    invoke-direct {p0, p1, v1, v0}, buildNotificationBuilder(Landroid/os/storage/VolumeInfo;Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;
...
.method private onVolumeMounted(Landroid/os/storage/VolumeInfo;)Landroid/app/Notification;
    ...
    invoke-direct {p0, p1, v0, v1}, buildNotificationBuilder(Landroid/os/storage/VolumeInfo;Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;
    ...
    invoke-direct {p0, p1}, buildSnoozeIntent(Ljava/lang/String;)Landroid/app/PendingIntent;
    ...
    invoke-direct {p0, p1, v0, v2}, buildNotificationBuilder(Landroid/os/storage/VolumeInfo;Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;
...
.method private updateMissingPrivateVolumes()V
    ...
    invoke-direct {p0, v1}, buildForgetPendingIntent(Landroid/os/storage/VolumeRecord;)Landroid/app/PendingIntent;
    ...
    invoke-direct {p0, v2}, buildSnoozeIntent(Ljava/lang/String;)Landroid/app/PendingIntent;
...
.method public start()V
    ...
    iget-object v1, p0, mListener:Landroid/os/storage/StorageEventListener;

    invoke-virtual {v0, v1}, Landroid/os/storage/StorageManager;->registerListener(Landroid/os/storage/StorageEventListener;)V

    iget-object v0, p0, Lcom/android/systemui/SystemUI;->mContext:Landroid/content/Context;

    iget-object v1, p0, mSnoozeReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v1, p0, mFinishReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-direct {p0, v1, v2}, onDiskScannedInternal(Landroid/os/storage/DiskInfo;I)V
    ...
    invoke-direct {p0, v1}, onVolumeStateChangedInternal(Landroid/os/storage/VolumeInfo;)V
    ...
    iget-object v1, p0, mMoveCallback:Landroid/content/pm/PackageManager$MoveCallback;
