...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mKeyguardUpdateMonitorCallbacks:Ljava/util/ArrayList;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, mStatesListeners:Landroid/util/SparseArray;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, mCurrentServiceStates:Landroid/util/SparseArray;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, mLastServiceStates:Landroid/util/SparseArray;

    const/4 v0, 0x0

    iput v0, p0, mBindRetryTimes:I

    iput v0, p0, mInitRetryTimes:I
    ...
    iput-object v0, p0, mCallback:Lorg/codeaurora/internal/INetworkCallback;
    ...
    iput-object p1, p0, mRsrpThresholds:[I
    ...
    iput-object p1, p0, mSnrThresholds:[I
    ...
    iput-object p1, p0, mFivebarRsrpThresholds:[I
...
.method static synthetic access$1102(Lcom/android/systemui/statusbar/policy/FiveGServiceClient;Z)Z
    ...
    iput-boolean p1, p0, mServiceConnected:Z
...
.method static synthetic access$1600(Lcom/android/systemui/statusbar/policy/FiveGServiceClient;I)V
    ...
    invoke-direct {p0, p1}, notifyListenersIfNecessary(I)V

    return-void
.end method

.method static synthetic access$1800(Lcom/android/systemui/statusbar/policy/FiveGServiceClient;I)I
    .locals 0

    invoke-direct {p0, p1}, getRsrpLevel(I)I
...
.method static synthetic access$500(Lcom/android/systemui/statusbar/policy/FiveGServiceClient;)V
    ...
    invoke-direct {p0}, binderService()V
...
.method static synthetic access$600(Lcom/android/systemui/statusbar/policy/FiveGServiceClient;)V
    ...
    invoke-direct {p0}, initFiveGServiceState()V
...
.method static synthetic access$700(Lcom/android/systemui/statusbar/policy/FiveGServiceClient;)V
    ...
    invoke-direct {p0}, notifyMonitorCallback()V
...
.method static synthetic access$800(Lcom/android/systemui/statusbar/policy/FiveGServiceClient;)Lorg/codeaurora/internal/IExtTelephony;
    ...
    iget-object p0, p0, mNetworkService:Lorg/codeaurora/internal/IExtTelephony;
...
.method static synthetic access$802(Lcom/android/systemui/statusbar/policy/FiveGServiceClient;Lorg/codeaurora/internal/IExtTelephony;)Lorg/codeaurora/internal/IExtTelephony;
    ...
    iput-object p1, p0, mNetworkService:Lorg/codeaurora/internal/IExtTelephony;
...
.method static synthetic access$900(Lcom/android/systemui/statusbar/policy/FiveGServiceClient;)Lorg/codeaurora/internal/Client;
    ...
    iget-object p0, p0, mClient:Lorg/codeaurora/internal/Client;
...
.method static synthetic access$902(Lcom/android/systemui/statusbar/policy/FiveGServiceClient;Lorg/codeaurora/internal/Client;)Lorg/codeaurora/internal/Client;
    ...
    iput-object p1, p0, mClient:Lorg/codeaurora/internal/Client;
...
.method public static getInstance(Landroid/content/Context;)Lcom/android/systemui/statusbar/policy/FiveGServiceClient;
    ...
    sget-object v0, sInstance:Lcom/android/systemui/statusbar/policy/FiveGServiceClient;
    ...
    sput-object v0, sInstance:Lcom/android/systemui/statusbar/policy/FiveGServiceClient;

    :cond_0
    sget-object p0, sInstance:Lcom/android/systemui/statusbar/policy/FiveGServiceClient;
...
.method private getLastServiceState(I)Lcom/android/systemui/statusbar/policy/FiveGServiceClient$FiveGServiceState;
    ...
    iget-object p0, p0, mLastServiceStates:Landroid/util/SparseArray;

    invoke-static {p1, p0}, getServiceState(ILandroid/util/SparseArray;)Lcom/android/systemui/statusbar/policy/FiveGServiceClient$FiveGServiceState;
...
.method private getLevel(I[I)I
    .locals 1

    const/4 v0, 0x1

    invoke-direct {p0, p1, p2, v0}, getLevel(I[IZ)I
...
.method private getRsrpLevel(I)I
    ...
    iget-object v0, p0, mFivebarRsrpThresholds:[I

    const/4 v1, 0x0

    invoke-direct {p0, p1, v0, v1}, getLevel(I[IZ)I
    ...
    :cond_0
    iget-object v0, p0, mRsrpThresholds:[I

    invoke-direct {p0, p1, v0}, getLevel(I[I)I
...
.method private initFiveGServiceState()V
    ...
    iget-object v1, p0, mStatesListeners:Landroid/util/SparseArray;
    ...
    invoke-direct {p0, v1}, initFiveGServiceState(I)V
...
.method private initFiveGServiceState(I)V
    ...
    iget-object v2, p0, mNetworkService:Lorg/codeaurora/internal/IExtTelephony;
    ...
    iget-object v2, p0, mClient:Lorg/codeaurora/internal/Client;
    ...
    iget-object v1, p0, mNetworkService:Lorg/codeaurora/internal/IExtTelephony;

    if-eqz v1, :cond_0

    iget-object v1, p0, mClient:Lorg/codeaurora/internal/Client;
    ...
    iget-object v3, p0, mClient:Lorg/codeaurora/internal/Client;
...
.method private notifyListenersIfNecessary(I)V
    ...
    invoke-virtual {p0, p1}, getCurrentServiceState(I)Lcom/android/systemui/statusbar/policy/FiveGServiceClient$FiveGServiceState;

    move-result-object v0

    invoke-direct {p0, p1}, getLastServiceState(I)Lcom/android/systemui/statusbar/policy/FiveGServiceClient$FiveGServiceState;
...
.method private notifyMonitorCallback()V
    ...
    :goto_0
    iget-object v1, p0, mKeyguardUpdateMonitorCallbacks:Ljava/util/ArrayList;
...
.method private showFake5GIcon(I)Z
    ...
    iget-object v1, p0, mRsrpThresholds:[I
    ...
    const-string v3, "showFake5GIcon:"
    ...
    iget-object v3, p0, mRsrpThresholds:[I
    ...
    iget-object p0, p0, mRsrpThresholds:[I
...
.method public getCurrentServiceState(I)Lcom/android/systemui/statusbar/policy/FiveGServiceClient$FiveGServiceState;
    ...
    iget-object p0, p0, mCurrentServiceStates:Landroid/util/SparseArray;
...
.method public isServiceConnected()Z
    ...
    iget-boolean p0, p0, mServiceConnected:Z
...
.method public registerCallback(Lcom/android/keyguard/KeyguardUpdateMonitorCallback;)V
    ...
    iget-object p0, p0, mKeyguardUpdateMonitorCallbacks:Ljava/util/ArrayList;
...
.method public registerListener(ILcom/android/systemui/statusbar/policy/FiveGServiceClient$IFiveGStateListener;)V
    ...
    iget-object v0, p0, mStatesListeners:Landroid/util/SparseArray;

    invoke-virtual {v0, p1, p2}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    invoke-virtual {p0}, isServiceConnected()Z
    ...
    :cond_0
    invoke-direct {p0, p1}, initFiveGServiceState(I)V
...
.method public unregisterListener(I)V
    ...
    iget-object v0, p0, mCurrentServiceStates:Landroid/util/SparseArray;
...
.method update5GIcon(Lcom/android/systemui/statusbar/policy/FiveGServiceClient$FiveGServiceState;I)V
    ...
    invoke-direct {p0, p1}, getSaIcon(Lcom/android/systemui/statusbar/policy/FiveGServiceClient$FiveGServiceState;)Lcom/android/systemui/statusbar/policy/MobileSignalController$MobileIconGroup;
    ...
    invoke-direct {p0, p2}, showFake5GIcon(I)Z
    ...
    invoke-direct {p0, v0, p2}, getNrIconGroup(II)Lcom/android/systemui/statusbar/policy/MobileSignalController$MobileIconGroup;
