...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;Lcom/android/systemui/plugins/ActivityStarter;Lcom/android/systemui/statusbar/policy/ConfigurationController;)V
    ...
    iput-object p2, p0, mClickActions:Ljava/util/HashMap;
    ...
    iput p1, p0, mRowWithHeaderPadding:I
    ...
    iput-object p1, p0, mLayoutTransition:Landroid/animation/LayoutTransition;

    iget-object p1, p0, mLayoutTransition:Landroid/animation/LayoutTransition;
    ...
    iget-object p0, p0, mLayoutTransition:Landroid/animation/LayoutTransition;
...
.method private showSlice()V
    ...
    iget-object v0, p0, mSlice:Landroidx/slice/Slice;
    ...
    iget-object v0, p0, mTitle:Landroid/widget/TextView;

    invoke-virtual {v0, v1}, Landroid/widget/TextView;->setVisibility(I)V

    iget-object v0, p0, mRow:Lcom/android/keyguard/KeyguardSliceView$Row;

    invoke-virtual {v0, v1}, Landroid/widget/LinearLayout;->setVisibility(I)V

    iput-boolean v2, p0, mHasHeader:Z

    iget-object p0, p0, mContentChangeListener:Ljava/lang/Runnable;
    ...
    :cond_1
    iget-object v0, p0, mClickActions:Ljava/util/HashMap;
    ...
    iget-object v4, p0, mSlice:Landroidx/slice/Slice;
    ...
    :goto_0
    iput-boolean v3, p0, mHasHeader:Z
    ...
    :cond_4
    iget-boolean v5, p0, mHasHeader:Z
    ...
    :cond_5
    iget-object v5, p0, mTitle:Landroid/widget/TextView;
    ...
    :goto_2
    iget-object v7, p0, mTitle:Landroid/widget/TextView;
    ...
    iget-object v5, p0, mClickActions:Ljava/util/HashMap;
    ...
    invoke-virtual {p0}, getTextColor()I

    move-result v5

    iget-boolean v7, p0, mHasHeader:Z

    iget-object v8, p0, mRow:Lcom/android/keyguard/KeyguardSliceView$Row;
    ...
    iget-object v1, p0, mRow:Lcom/android/keyguard/KeyguardSliceView$Row;
    ...
    iget-boolean v8, p0, mHasHeader:Z

    if-eqz v8, :cond_9

    iget v8, p0, mRowWithHeaderPadding:I

    goto :goto_4

    :cond_9
    iget v8, p0, mRowPadding:I
    ...
    iget-object v10, p0, mRow:Lcom/android/keyguard/KeyguardSliceView$Row;
    ...
    iget-boolean v9, p0, mHasHeader:Z

    sub-int v9, v7, v9

    iget-object v11, p0, mRow:Lcom/android/keyguard/KeyguardSliceView$Row;
    ...
    :goto_6
    iget-object v11, p0, mClickActions:Ljava/util/HashMap;
    ...
    iget-boolean v1, p0, mHasHeader:Z

    if-eqz v1, :cond_d

    iget v1, p0, mRowWithHeaderTextSize:F

    goto :goto_8

    :cond_d
    iget v1, p0, mRowTextSize:F
    ...
    iget v8, p0, mIconSizeWithHeader:I
    ...
    iget-object v1, p0, mClickActions:Ljava/util/HashMap;
...
.method private updateTextColors()V
    ...
    iget-object v1, p0, mTitle:Landroid/widget/TextView;
    ...
    iget-object v3, p0, mRow:Lcom/android/keyguard/KeyguardSliceView$Row;
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object p3, p0, mClickActions:Ljava/util/HashMap;
    ...
    iget-object p3, p0, mTitle:Landroid/widget/TextView;
    ...
    iget-object p3, p0, mRow:Lcom/android/keyguard/KeyguardSliceView$Row;
    ...
    iget-object p3, p0, mSlice:Landroidx/slice/Slice;
    ...
    iget-boolean p0, p0, mHasHeader:Z
...
.method protected onAttachedToWindow()V
    ...
    iget-object v0, p0, mLiveData:Landroidx/lifecycle/LiveData;
...
.method public onChanged(Landroidx/slice/Slice;)V
    ...
    iput-object p1, p0, mSlice:Landroidx/slice/Slice;

    invoke-direct {p0}, showSlice()V
...
.method public onDensityOrFontScaleChanged()V
    ...
    iput v0, p0, mIconSizeWithHeader:I
    ...
    iput v0, p0, mRowWithHeaderTextSize:F
...
.method protected onFinishInflate()V
    ...
    iput-object v0, p0, mTitle:Landroid/widget/TextView;
    ...
    iput-object v0, p0, mRow:Lcom/android/keyguard/KeyguardSliceView$Row;
...
.method public onTuningChanged(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p2}, setupUri(Ljava/lang/String;)V
...
.method public refresh()V
    ...
    iget-object v0, p0, mKeyguardSliceUri:Landroid/net/Uri;
    ...
    iget-object v1, p0, mKeyguardSliceUri:Landroid/net/Uri;
    ...
    :goto_0
    invoke-virtual {p0, v0}, onChanged(Landroidx/slice/Slice;)V
...
.method public setContentChangeListener(Ljava/lang/Runnable;)V
    ...
    iput-object p1, p0, mContentChangeListener:Ljava/lang/Runnable;
...
.method public setupUri(Ljava/lang/String;)V
    ...
    iget-object v1, p0, mLiveData:Landroidx/lifecycle/LiveData;
    ...
    iput-object p1, p0, mKeyguardSliceUri:Landroid/net/Uri;
    ...
    iput-object p1, p0, mLiveData:Landroidx/lifecycle/LiveData;

    if-eqz v0, :cond_2

    iget-object p1, p0, mLiveData:Landroidx/lifecycle/LiveData;
