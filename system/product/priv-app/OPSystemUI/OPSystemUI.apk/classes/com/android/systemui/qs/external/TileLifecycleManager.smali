...
.method public constructor <init>(Landroid/os/Handler;Landroid/content/Context;Landroid/service/quicksettings/IQSService;Landroid/service/quicksettings/Tile;Landroid/content/Intent;Landroid/os/UserHandle;)V
    ...
    invoke-direct/range {v0 .. v7}, <init>(Landroid/os/Handler;Landroid/content/Context;Landroid/service/quicksettings/IQSService;Landroid/service/quicksettings/Tile;Landroid/content/Intent;Landroid/os/UserHandle;Lcom/android/systemui/qs/external/PackageManagerAdapter;)V
...
.method constructor <init>(Landroid/os/Handler;Landroid/content/Context;Landroid/service/quicksettings/IQSService;Landroid/service/quicksettings/Tile;Landroid/content/Intent;Landroid/os/UserHandle;Lcom/android/systemui/qs/external/PackageManagerAdapter;)V
    ...
    iget-object p2, p0, mToken:Landroid/os/IBinder;

    const-string/jumbo p3, "token"

    invoke-virtual {p1, p3, p2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Landroid/os/IBinder;)Landroid/content/Intent;

    iput-object p6, p0, mUser:Landroid/os/UserHandle;

    iput-object p7, p0, mPackageManagerAdapter:Lcom/android/systemui/qs/external/PackageManagerAdapter;
...
.method private checkComponentState()Z
    ...
    invoke-direct {p0}, isPackageAvailable()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-direct {p0}, isComponentAvailable()Z
    ...
    :cond_1
    :goto_0
    invoke-direct {p0}, startPackageListening()V
...
.method private handleDeath()V
    ...
    iget-object v0, p0, mWrapper:Lcom/android/systemui/qs/external/QSTileServiceWrapper;
    ...
    iput-object v0, p0, mWrapper:Lcom/android/systemui/qs/external/QSTileServiceWrapper;
    ...
    :cond_1
    invoke-direct {p0}, checkComponentState()Z
...
.method private handlePendingMessages()V
    ...
    iget-object v0, p0, mQueuedMessages:Ljava/util/Set;
    ...
    iget-object v2, p0, mQueuedMessages:Ljava/util/Set;
    ...
    invoke-virtual {p0}, onTileAdded()V

    :cond_0
    iget-boolean v2, p0, mListening:Z

    if-eqz v2, :cond_1

    invoke-virtual {p0}, onStartListening()V
    ...
    :cond_2
    iget-object v2, p0, mClickBinder:Landroid/os/IBinder;

    invoke-virtual {p0, v2}, onClick(Landroid/os/IBinder;)V
    ...
    :cond_4
    invoke-virtual {p0}, onUnlockComplete()V
    ...
    invoke-virtual {p0}, onStopListening()V

    :cond_6
    invoke-virtual {p0}, onTileRemoved()V

    :cond_7
    iget-boolean v1, p0, mUnbindImmediate:Z

    if-eqz v1, :cond_8

    iput-boolean v0, p0, mUnbindImmediate:Z

    invoke-virtual {p0, v0}, setBindService(Z)V
...
.method private isComponentAvailable()Z
    ...
    :try_start_0
    iget-object v1, p0, mPackageManagerAdapter:Lcom/android/systemui/qs/external/PackageManagerAdapter;
    ...
    iget-object p0, p0, mUser:Landroid/os/UserHandle;
...
.method private isPackageAvailable()Z
    ...
    :try_start_0
    iget-object v2, p0, mPackageManagerAdapter:Lcom/android/systemui/qs/external/PackageManagerAdapter;
...
.method private queueMessage(I)V
    ...
    :try_start_0
    iget-object p0, p0, mQueuedMessages:Ljava/util/Set;
...
.method private startPackageListening()V
    ...
    iget-object v2, p0, mUser:Landroid/os/UserHandle;
    ...
    iget-object v8, p0, mUser:Landroid/os/UserHandle;
    ...
    iput-boolean v0, p0, mReceiverRegistered:Z
...
.method public asBinder()Landroid/os/IBinder;
    ...
    iget-object p0, p0, mWrapper:Lcom/android/systemui/qs/external/QSTileServiceWrapper;
...
.method public binderDied()V
    ...
    invoke-direct {p0}, handleDeath()V
...
.method public getToken()Landroid/os/IBinder;
    ...
    iget-object p0, p0, mToken:Landroid/os/IBinder;
...
.method public handleDestroy()V
    ...
    iget-boolean v0, p0, mReceiverRegistered:Z

    if-eqz v0, :cond_0

    invoke-direct {p0}, stopPackageListening()V
...
.method public onClick(Landroid/os/IBinder;)V
    ...
    :cond_0
    iput-object p1, p0, mClickBinder:Landroid/os/IBinder;

    const/4 p1, 0x2

    invoke-direct {p0, p1}, queueMessage(I)V
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    iget-object p1, p0, mChangeListener:Lcom/android/systemui/qs/external/TileLifecycleManager$TileChangeListener;

    if-eqz p1, :cond_1

    iget-object p2, p0, mIntent:Landroid/content/Intent;
    ...
    iget-boolean p1, p0, mBound:Z

    if-eqz p1, :cond_2

    const/4 p1, 0x1

    invoke-virtual {p0, p1}, setBindService(Z)V
...
.method public onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    invoke-direct {p0}, handlePendingMessages()V
...
.method public onTileAdded()V
    ...
    invoke-direct {p0, v0}, queueMessage(I)V
...
.method public setBindService(Z)V
    ...
    iget-boolean v0, p0, mUnbindImmediate:Z

    if-eqz v0, :cond_0

    iput-boolean v1, p0, mUnbindImmediate:Z
    ...
    :cond_3
    iput v1, p0, mBindTryCount:I

    const/4 p1, 0x0

    iput-object p1, p0, mWrapper:Lcom/android/systemui/qs/external/QSTileServiceWrapper;

    iget-boolean p1, p0, mIsBound:Z
...
.method public setTileChangeListener(Lcom/android/systemui/qs/external/TileLifecycleManager$TileChangeListener;)V
    ...
    iput-object p1, p0, mChangeListener:Lcom/android/systemui/qs/external/TileLifecycleManager$TileChangeListener;
