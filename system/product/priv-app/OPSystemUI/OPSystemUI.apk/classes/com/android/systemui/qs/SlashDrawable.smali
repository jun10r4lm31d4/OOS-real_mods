...
.method public constructor <init>(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object v0, p0, mSlashRect:Landroid/graphics/RectF;

    iput-boolean v1, p0, mAnimationEnabled:Z
    ...
    iput-object v0, p0, mSlashLengthProp:Landroid/util/FloatProperty;
...
.method static synthetic access$000(Lcom/android/systemui/qs/SlashDrawable;)F
    ...
    iget p0, p0, mCurrentSlashLength:F
...
.method static synthetic access$002(Lcom/android/systemui/qs/SlashDrawable;F)F
    ...
    iput p1, p0, mCurrentSlashLength:F
...
.method private updateRect(FFFF)V
    ...
    iget-object p0, p0, mSlashRect:Landroid/graphics/RectF;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-direct {p0, v3, v1}, scale(FI)F

    move-result v4

    invoke-direct {p0, v3, v2}, scale(FI)F

    move-result v5

    const v6, 0x3ecf96ed

    invoke-direct {p0, v6, v1}, scale(FI)F

    move-result v6

    const v7, -0x424a2cd0

    invoke-direct {p0, v7, v2}, scale(FI)F

    move-result v8

    const v9, 0x3ef6cf78

    invoke-direct {p0, v9, v1}, scale(FI)F

    move-result v9

    iget v10, p0, mCurrentSlashLength:F

    add-float/2addr v10, v7

    invoke-direct {p0, v10, v2}, scale(FI)F

    move-result v7

    invoke-direct {p0, v6, v8, v9, v7}, updateRect(FFFF)V
    ...
    iget-object v7, p0, mSlashRect:Landroid/graphics/RectF;
    ...
    iget-object v4, p0, mSlashRect:Landroid/graphics/RectF;
    ...
    iget-object v8, p0, mSlashRect:Landroid/graphics/RectF;
    ...
    iget-object p0, p0, mDrawable:Landroid/graphics/drawable/Drawable;
...
.method public setAnimationEnabled(Z)V
    ...
    iput-boolean p1, p0, mAnimationEnabled:Z
...
.method public setDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object p1, p0, mDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iget-object p1, p0, mTintMode:Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_0
    iget-object p1, p0, mTintList:Landroid/content/res/ColorStateList;
...
.method public setSlashed(Z)V
    ...
    :cond_0
    iput-boolean p1, p0, mSlashed:Z

    iget-boolean p1, p0, mSlashed:Z
    ...
    :cond_2
    iget-boolean v1, p0, mAnimationEnabled:Z

    if-eqz v1, :cond_3

    iget-object v1, p0, mSlashLengthProp:Landroid/util/FloatProperty;
...
.method public setTintList(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {p0, p1}, setDrawableTintList(Landroid/content/res/ColorStateList;)V
