...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p2, p0, mKeyguardCallback:Lcom/android/systemui/statusbar/policy/KeyguardMonitor$Callback;
    ...
    iput-object p2, p0, mExpandAnimationListener:Landroid/animation/Animator$AnimatorListener;
    ...
    iput-object p2, p0, mCollapseAnimationListener:Landroid/animation/Animator$AnimatorListener;
    ...
    iput-object p2, p0, mContainer:Landroid/view/View;
    ...
    iput-object p2, p0, mClipper:Lcom/android/systemui/qs/QSDetailClipper;
    ...
    iput-object p2, p0, mToolbar:Landroid/widget/Toolbar;
    ...
    iget-object p2, p0, mToolbar:Landroid/widget/Toolbar;
    ...
    iput-object p2, p0, mLightBarController:Lcom/android/systemui/statusbar/phone/LightBarController;
    ...
    iput-object p2, p0, mUpperPages:Lcom/android/systemui/qs/customize/QSEditViewPager;
    ...
    iput-object p2, p0, mLowerPages:Lcom/android/systemui/qs/customize/QSEditViewPager;

    iget-object p2, p0, mUpperPages:Lcom/android/systemui/qs/customize/QSEditViewPager;
    ...
    iget-object p2, p0, mLowerPages:Lcom/android/systemui/qs/customize/QSEditViewPager;
    ...
    iput-object p2, p0, mDragLabel:Landroid/widget/TextView;

    new-instance p2, Lcom/android/systemui/qs/customize/QSEditPageManager;

    iget-object v0, p0, mUpperPages:Lcom/android/systemui/qs/customize/QSEditViewPager;

    iget-object v1, p0, mLowerPages:Lcom/android/systemui/qs/customize/QSEditViewPager;

    iget-object v2, p0, mDragLabel:Landroid/widget/TextView;
    ...
    iput-object p2, p0, mPageManager:Lcom/android/systemui/qs/customize/QSEditPageManager;

    iget-object p2, p0, mPageManager:Lcom/android/systemui/qs/customize/QSEditPageManager;
    ...
    iget-object v0, p0, mPageManager:Lcom/android/systemui/qs/customize/QSEditPageManager;
    ...
    iput-object p2, p0, mTileQueryHelper:Lcom/android/systemui/qs/customize/TileQueryHelper;
    ...
    invoke-direct {p0, p1}, updateNavBackDrop(Landroid/content/res/Configuration;)V
    ...
    iput-object p1, p0, mDivider:Landroid/view/View;

    iget-object p1, p0, mDragLabel:Landroid/widget/TextView;
    ...
    iget-object p1, p0, mToolbar:Landroid/widget/Toolbar;
...
.method static synthetic access$100(Lcom/android/systemui/qs/customize/QSCustomizer;Z)V
    ...
    invoke-direct {p0, p1}, setCustomizing(Z)V
...
.method static synthetic access$300(Lcom/android/systemui/qs/customize/QSCustomizer;)Lcom/android/systemui/statusbar/phone/NotificationsQuickSettingsContainer;
    ...
    iget-object p0, p0, mNotifQsContainer:Lcom/android/systemui/statusbar/phone/NotificationsQuickSettingsContainer;
...
.method static synthetic access$400(Lcom/android/systemui/qs/customize/QSCustomizer;)Lcom/android/systemui/qs/customize/QSEditPageManager;
    ...
    iget-object p0, p0, mPageManager:Lcom/android/systemui/qs/customize/QSEditPageManager;
...
.method private queryTiles()V
    ...
    iget-object v0, p0, mTileQueryHelper:Lcom/android/systemui/qs/customize/TileQueryHelper;
...
.method private reset()V
    ...
    :cond_0
    iget-object v1, p0, mPageManager:Lcom/android/systemui/qs/customize/QSEditPageManager;
...
.method private setCustomizing(Z)V
    ...
    iput-boolean p1, p0, mCustomizing:Z
...
.method private setTileSpecs()V
    ...
    iget-object v1, p0, mHost:Lcom/android/systemui/qs/QSTileHost;
...
.method private updateNavBackDrop(Landroid/content/res/Configuration;)V
    ...
    :goto_0
    iput-boolean p1, p0, mIsShowingNavBackdrop:Z

    if-eqz v0, :cond_3

    iget-boolean p1, p0, mIsShowingNavBackdrop:Z
    ...
    :cond_3
    invoke-direct {p0}, updateNavColors()V
...
.method private updateNavColors()V
    ...
    iget-boolean v1, p0, mIsShowingNavBackdrop:Z
...
.method public hide()V
    ...
    iput-boolean v0, p0, isShown:Z

    iget-object v1, p0, mToolbar:Landroid/widget/Toolbar;

    invoke-virtual {v1}, Landroid/widget/Toolbar;->dismissPopupMenus()V

    invoke-direct {p0, v0}, setCustomizing(Z)V

    invoke-direct {p0}, save()V

    iget-object v1, p0, mClipper:Lcom/android/systemui/qs/QSDetailClipper;

    iget v2, p0, mX:I

    iget v3, p0, mY:I

    iget-object v4, p0, mCollapseAnimationListener:Landroid/animation/Animator$AnimatorListener;
    ...
    iget-object v1, p0, mNotifQsContainer:Lcom/android/systemui/statusbar/phone/NotificationsQuickSettingsContainer;
    ...
    iget-object p0, p0, mTileQueryHelper:Lcom/android/systemui/qs/customize/TileQueryHelper;
...
.method public isCustomizing()Z
    ...
    iget-boolean p0, p0, mCustomizing:Z
...
.method public synthetic lambda$new$0$QSCustomizer()V
    ...
    iget-boolean v0, p0, mOpening:Z

    if-nez v0, :cond_1

    invoke-virtual {p0}, hideNoAnimation()V
...
.method protected onAttachedToWindow()V
    ...
    iget-object p0, p0, mKeyguardCallback:Lcom/android/systemui/statusbar/policy/KeyguardMonitor$Callback;
...
.method protected onDetachedFromWindow()V
    ...
    iput-object v0, p0, mNotifQsContainer:Lcom/android/systemui/statusbar/phone/NotificationsQuickSettingsContainer;
    ...
    iget-object v1, p0, mKeyguardCallback:Lcom/android/systemui/statusbar/policy/KeyguardMonitor$Callback;
...
.method public onRtlPropertiesChanged(I)V
    ...
    iget-object p1, p0, mPageManager:Lcom/android/systemui/qs/customize/QSEditPageManager;
...
.method public setContainer(Lcom/android/systemui/statusbar/phone/NotificationsQuickSettingsContainer;)V
    ...
    iput-object p1, p0, mNotifQsContainer:Lcom/android/systemui/statusbar/phone/NotificationsQuickSettingsContainer;
...
.method public show(II)V
    ...
    iput-boolean p1, p0, isShown:Z

    iput-boolean p1, p0, mOpening:Z

    invoke-direct {p0}, setTileSpecs()V

    invoke-virtual {p0, v1}, Landroid/widget/LinearLayout;->setVisibility(I)V

    iget-object p2, p0, mClipper:Lcom/android/systemui/qs/QSDetailClipper;

    iget v0, p0, mX:I

    iget v1, p0, mY:I

    iget-object v2, p0, mExpandAnimationListener:Landroid/animation/Animator$AnimatorListener;
    ...
    iget-object p2, p0, mNotifQsContainer:Lcom/android/systemui/statusbar/phone/NotificationsQuickSettingsContainer;
...
.method public showImmediately()V
    ...
    iput-boolean v1, p0, isShown:Z

    invoke-direct {p0}, setTileSpecs()V

    invoke-direct {p0, v1}, setCustomizing(Z)V

    invoke-direct {p0}, queryTiles()V

    iget-object v2, p0, mNotifQsContainer:Lcom/android/systemui/statusbar/phone/NotificationsQuickSettingsContainer;
    ...
    iget-object v0, p0, mNotifQsContainer:Lcom/android/systemui/statusbar/phone/NotificationsQuickSettingsContainer;
...
.method protected updateThemeColor()V
    ...
    iget-object v7, p0, mToolbar:Landroid/widget/Toolbar;
    ...
    iget-object v8, p0, mToolbar:Landroid/widget/Toolbar;
    ...
    iget-object v2, p0, mContainer:Landroid/view/View;
    ...
    iget-object v2, p0, mLowerPages:Lcom/android/systemui/qs/customize/QSEditViewPager;

    invoke-virtual {v2, v5}, Landroid/view/ViewGroup;->setBackgroundColor(I)V

    iget-object v2, p0, mUpperPages:Lcom/android/systemui/qs/customize/QSEditViewPager;
