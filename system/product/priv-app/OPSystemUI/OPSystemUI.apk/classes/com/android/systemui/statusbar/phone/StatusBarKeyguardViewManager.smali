...
.method public constructor <init>(Landroid/content/Context;Lcom/android/keyguard/ViewMediatorCallback;Lcom/android/internal/widget/LockPatternUtils;)V
    ...
    iput-object v0, p0, mExpansionCallback:Lcom/android/systemui/statusbar/phone/KeyguardBouncer$BouncerExpansionCallback;
    ...
    iput-object v0, p0, mDockEventListener:Lcom/android/systemui/dock/DockManager$DockEventListener;

    const/4 v0, 0x1

    iput-boolean v0, p0, mFirstUpdate:Z

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mAfterKeyguardGoneRunnables:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, mKeyguardMonitor:Lcom/android/systemui/statusbar/policy/KeyguardMonitorImpl;
    ...
    iput-object v0, p0, mStatusBarStateController:Lcom/android/systemui/plugins/statusbar/StatusBarStateController;
    ...
    iput-object v0, p0, mMakeNavigationBarVisibleRunnable:Ljava/lang/Runnable;

    iput-object p1, p0, mContext:Landroid/content/Context;

    iput-object p2, p0, mViewMediatorCallback:Lcom/android/keyguard/ViewMediatorCallback;
    ...
    iput-object p2, p0, mStatusBarWindowController:Lcom/android/systemui/statusbar/phone/StatusBarWindowController;

    invoke-static {p1}, Lcom/android/keyguard/KeyguardUpdateMonitor;->getInstance(Landroid/content/Context;)Lcom/android/keyguard/KeyguardUpdateMonitor;

    move-result-object p1

    iget-object p2, p0, mUpdateMonitorCallback:Lcom/android/keyguard/KeyguardUpdateMonitorCallback;
    ...
    iput-boolean p1, p0, mGesturalNav:Z
    ...
    iput-object p1, p0, mDockManager:Lcom/android/systemui/dock/DockManager;

    iget-object p1, p0, mDockManager:Lcom/android/systemui/dock/DockManager;

    if-eqz p1, :cond_0

    iget-object p2, p0, mDockEventListener:Lcom/android/systemui/dock/DockManager$DockEventListener;
    ...
    iput-boolean p1, p0, mIsDocked:Z
...
.method static synthetic access$000(Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;)Landroid/view/ViewGroup;
    ...
    iget-object p0, p0, mContainer:Landroid/view/ViewGroup;
...
.method static synthetic access$100(Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;)V
    ...
    invoke-direct {p0}, updateLockIcon()V
...
.method static synthetic access$500(Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;Z)V
    ...
    invoke-direct {p0, p1}, hideBouncer(Z)V
...
.method static synthetic access$600(Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;)V
    ...
    invoke-direct {p0}, executeAfterKeyguardGoneAction()V
...
.method private executeAfterKeyguardGoneAction()V
    ...
    iget-object v0, p0, mAfterKeyguardGoneAction:Lcom/android/systemui/plugins/ActivityStarter$OnDismissAction;
    ...
    iput-object v0, p0, mAfterKeyguardGoneAction:Lcom/android/systemui/plugins/ActivityStarter$OnDismissAction;

    :cond_0
    const/4 v0, 0x0

    :goto_0
    iget-object v1, p0, mAfterKeyguardGoneRunnables:Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object p0, p0, mAfterKeyguardGoneRunnables:Ljava/util/ArrayList;
...
.method private getNavBarShowDelay()J
    ...
    iget-object v0, p0, mKeyguardMonitor:Lcom/android/systemui/statusbar/policy/KeyguardMonitorImpl;
    ...
    iget-object p0, p0, mKeyguardMonitor:Lcom/android/systemui/statusbar/policy/KeyguardMonitorImpl;
    ...
    :cond_0
    iget-object p0, p0, mBouncer:Lcom/android/systemui/statusbar/phone/KeyguardBouncer;
...
.method private hideBouncer(Z)V
    ...
    iget-object v0, p0, mBouncer:Lcom/android/systemui/statusbar/phone/KeyguardBouncer;
    ...
    invoke-virtual {p0}, cancelPendingWakeupAction()V
...
.method private setDozing(Z)V
    ...
    :cond_0
    invoke-virtual {p0, p1}, reset(Z)V

    :cond_1
    invoke-virtual {p0}, updateStates()V

    if-nez p1, :cond_2

    invoke-virtual {p0}, launchPendingWakeupAction()V
...
.method private updateLockIcon()V
    ...
    iget-object v0, p0, mLockIconContainer:Landroid/view/ViewGroup;
    ...
    iget-object v0, p0, mNotificationPanelView:Lcom/android/systemui/statusbar/phone/NotificationPanelView;
    ...
    :goto_0
    iget-object v3, p0, mBouncer:Lcom/android/systemui/statusbar/phone/KeyguardBouncer;
    ...
    :goto_1
    iget-boolean v0, p0, mLastLockVisible:Z

    if-eq v0, v1, :cond_5

    iput-boolean v1, p0, mLastLockVisible:Z

    if-eqz v1, :cond_4

    iget-object p0, p0, mLockIconContainer:Landroid/view/ViewGroup;
...
.method public cancelPendingWakeupAction()V
    ...
    iget-object v0, p0, mPendingWakeupAction:Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager$DismissWithActionRequest;

    const/4 v1, 0x0

    iput-object v1, p0, mPendingWakeupAction:Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager$DismissWithActionRequest;
...
.method public dismissWithAction(Lcom/android/systemui/plugins/ActivityStarter$OnDismissAction;Ljava/lang/Runnable;Z)V
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, dismissWithAction(Lcom/android/systemui/plugins/ActivityStarter$OnDismissAction;Ljava/lang/Runnable;ZLjava/lang/String;)V
...
.method public dismissWithAction(Lcom/android/systemui/plugins/ActivityStarter$OnDismissAction;Ljava/lang/Runnable;ZLjava/lang/String;)V
    ...
    invoke-direct {p0}, isWakeAndUnlocking()Z
    ...
    iput-object v0, p0, mPendingWakeupAction:Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager$DismissWithActionRequest;
    ...
    iget-object p3, p0, mBouncer:Lcom/android/systemui/statusbar/phone/KeyguardBouncer;
    ...
    :cond_1
    iput-object p1, p0, mAfterKeyguardGoneAction:Lcom/android/systemui/plugins/ActivityStarter$OnDismissAction;

    iget-object p1, p0, mBouncer:Lcom/android/systemui/statusbar/phone/KeyguardBouncer;
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    iget-boolean v1, p0, mOccluded:Z
    ...
    iget-boolean v1, p0, mRemoteInputActive:Z
    ...
    iget-boolean v1, p0, mGoingToSleepVisibleNotOccluded:Z
    ...
    iget-object v1, p0, mAfterKeyguardGoneAction:Lcom/android/systemui/plugins/ActivityStarter$OnDismissAction;
    ...
    iget-object v1, p0, mPendingWakeupAction:Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager$DismissWithActionRequest;
...
.method protected getLastNavBarVisible()Z
    ...
    iget-boolean v0, p0, mLastShowing:Z
    ...
    iget-boolean v0, p0, mLastOccluded:Z
    ...
    :goto_0
    iget-boolean v3, p0, mLastDozing:Z

    if-eqz v3, :cond_1

    iget v3, p0, mLastBiometricMode:I
    ...
    iget-boolean v4, p0, mLastDozing:Z

    if-eqz v4, :cond_3

    :cond_2
    iget-boolean v4, p0, mLastPulsing:Z

    if-eqz v4, :cond_4

    iget-boolean v4, p0, mLastIsDocked:Z

    if-nez v4, :cond_4

    :cond_3
    iget-boolean v4, p0, mLastGesturalNav:Z
    ...
    :cond_5
    iget-boolean v0, p0, mLastBouncerShowing:Z

    if-nez v0, :cond_7

    iget-boolean p0, p0, mLastRemoteInputActive:Z
...
.method public hide(JJ)V
    ...
    iput-boolean v1, v0, mShowing:Z

    iget-object v2, v0, mKeyguardMonitor:Lcom/android/systemui/statusbar/policy/KeyguardMonitorImpl;

    iget-boolean v3, v0, mShowing:Z

    invoke-virtual {v2}, Lcom/android/systemui/statusbar/policy/KeyguardMonitorImpl;->isSecure()Z

    move-result v4

    iget-object v5, v0, mKeyguardMonitor:Lcom/android/systemui/statusbar/policy/KeyguardMonitorImpl;
    ...
    iget-object v6, v0, mStatusBar:Lcom/android/systemui/statusbar/phone/StatusBar;
    ...
    iget-object v1, v0, mStatusBar:Lcom/android/systemui/statusbar/phone/StatusBar;
    ...
    iget-object v6, v0, mBiometricUnlockController:Lcom/android/systemui/statusbar/phone/BiometricUnlockController;
    ...
    iget-object v2, v0, mBiometricUnlockController:Lcom/android/systemui/statusbar/phone/BiometricUnlockController;

    invoke-virtual {v2}, Lcom/android/systemui/statusbar/phone/BiometricUnlockController;->startKeyguardFadingAway()V

    invoke-direct {p0, v13}, hideBouncer(Z)V

    if-eqz v14, :cond_3

    iget-object v2, v0, mStatusBar:Lcom/android/systemui/statusbar/phone/StatusBar;

    invoke-virtual {v2}, Lcom/android/systemui/statusbar/phone/StatusBar;->fadeKeyguardWhilePulsing()V

    invoke-direct {p0}, wakeAndUnlockDejank()V
    ...
    iget-object v2, v0, mStatusBarWindowController:Lcom/android/systemui/statusbar/phone/StatusBarWindowController;
    ...
    iget-object v0, v0, mViewMediatorCallback:Lcom/android/keyguard/ViewMediatorCallback;
...
.method public isGoingToSleepVisibleNotOccluded()Z
    ...
    iget-boolean p0, p0, mGoingToSleepVisibleNotOccluded:Z
...
.method protected isNavBarVisible()Z
    ...
    :cond_2
    iget-boolean v4, p0, mPulsing:Z

    if-eqz v4, :cond_4

    iget-boolean v4, p0, mIsDocked:Z

    if-nez v4, :cond_4

    :cond_3
    iget-boolean v4, p0, mGesturalNav:Z
    ...
    iget-boolean p0, p0, mRemoteInputActive:Z
...
.method public launchPendingWakeupAction()V
    ...
    invoke-virtual {p0, v1, v2, v3, v0}, dismissWithAction(Lcom/android/systemui/plugins/ActivityStarter$OnDismissAction;Ljava/lang/Runnable;ZLjava/lang/String;)V
...
.method public onBackPressed(Z)Z
    ...
    invoke-direct {p0, v1}, hideBouncer(Z)V
...
.method public onDensityOrFontScaleChanged()V
    ...
    invoke-direct {p0, v0}, hideBouncer(Z)V
...
.method public onDozingChanged(Z)V
    ...
    invoke-direct {p0, p1}, setDozing(Z)V
...
.method public onFinishedGoingToSleep()V
    ...
    iput-boolean v0, p0, mGoingToSleepVisibleNotOccluded:Z
...
.method public onNavigationModeChanged(I)V
    ...
    iget-boolean v0, p0, mGesturalNav:Z
...
.method public onPanelExpansionChanged(FZ)V
    ...
    :cond_0
    invoke-virtual {p0}, bouncerNeedsScrimming()Z
...
.method public onRemoteInputActive(Z)V
    ...
    iput-boolean p1, p0, mRemoteInputActive:Z
...
.method public onStartedGoingToSleep()V
    ...
    invoke-virtual {p0}, isOccluded()Z
...
.method public registerStatusBar(Lcom/android/systemui/statusbar/phone/StatusBar;Landroid/view/ViewGroup;Lcom/android/systemui/statusbar/phone/NotificationPanelView;Lcom/android/systemui/statusbar/phone/BiometricUnlockController;Lcom/android/systemui/keyguard/DismissCallbackRegistry;Landroid/view/ViewGroup;)V
    ...
    iput-object p2, p0, mContainer:Landroid/view/ViewGroup;

    iput-object p6, p0, mLockIconContainer:Landroid/view/ViewGroup;

    iget-object p1, p0, mLockIconContainer:Landroid/view/ViewGroup;
    ...
    :goto_0
    iput-boolean p1, p0, mLastLockVisible:Z

    :cond_1
    iput-object p4, p0, mBiometricUnlockController:Lcom/android/systemui/statusbar/phone/BiometricUnlockController;
    ...
    iget-object v2, p0, mViewMediatorCallback:Lcom/android/keyguard/ViewMediatorCallback;

    iget-object v3, p0, mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;

    iget-object v6, p0, mExpansionCallback:Lcom/android/systemui/statusbar/phone/KeyguardBouncer$BouncerExpansionCallback;
    ...
    iput-object p1, p0, mBouncer:Lcom/android/systemui/statusbar/phone/KeyguardBouncer;

    iput-object p3, p0, mNotificationPanelView:Lcom/android/systemui/statusbar/phone/NotificationPanelView;
    ...
    iput-object p1, p0, mINotificationManager:Landroid/app/INotificationManager;
...
.method public reset(Z)V
    ...
    iget-boolean v4, p0, mOccluded:Z
    ...
    :cond_4
    invoke-virtual {p0, p1}, showBouncerOrKeyguard(Z)V
...
.method public setOccluded(ZZ)V
    ...
    iget-boolean v2, p0, mOccluded:Z
    ...
    iget-object v3, p0, mMediaManager:Lcom/android/systemui/statusbar/NotificationMediaManager;
...
.method public show(Landroid/os/Bundle;)V
    ...
    iget-object v3, p0, mKeyguardMonitor:Lcom/android/systemui/statusbar/policy/KeyguardMonitorImpl;
    ...
    :try_start_0
    iget-object p0, p0, mINotificationManager:Landroid/app/INotificationManager;
...
.method protected showBouncerOrKeyguard(Z)V
    ...
    invoke-virtual {p0}, shouldDestroyViewOnReset()Z
...
.method public startPreHideAnimation(Ljava/lang/Runnable;)V
    ...
    iget-object p1, p0, mNotificationPanelView:Lcom/android/systemui/statusbar/phone/NotificationPanelView;
...
.method protected updateNavigationBarVisibility(Z)V
    ...
    invoke-direct {p0}, getNavBarShowDelay()J
    ...
    iget-object p0, p0, mMakeNavigationBarVisibleRunnable:Ljava/lang/Runnable;
    ...
    :cond_0
    iget-object p1, p0, mContainer:Landroid/view/ViewGroup;
    ...
    iget-object v0, p0, mMakeNavigationBarVisibleRunnable:Ljava/lang/Runnable;
...
.method protected updateStates()V
    ...
    iget-object v4, p0, mBouncer:Lcom/android/systemui/statusbar/phone/KeyguardBouncer;
    ...
    iget-boolean v6, p0, mRemoteInputActive:Z
    ...
    :goto_1
    iget-boolean v9, p0, mLastBouncerDismissible:Z

    if-nez v9, :cond_3

    iget-boolean v9, p0, mLastShowing:Z

    if-eqz v9, :cond_3

    iget-boolean v9, p0, mLastRemoteInputActive:Z
    ...
    :cond_5
    iget-object v8, p0, mContainer:Landroid/view/ViewGroup;
    ...
    :cond_7
    :goto_5
    invoke-virtual {p0}, isNavBarVisible()Z

    move-result v8

    invoke-virtual {p0}, getLastNavBarVisible()Z

    move-result v9

    if-ne v8, v9, :cond_8

    iget-boolean v10, p0, mFirstUpdate:Z

    if-eqz v10, :cond_9

    :cond_8
    invoke-virtual {p0, v8}, updateNavigationBarVisibility(Z)V
    ...
    iget-boolean v0, p0, mLastBouncerDismissible:Z
    ...
    iget v0, p0, mLastBiometricMode:I
    ...
    iget-boolean v0, p0, mLastRemoteInputActive:Z
    ...
    iget-boolean v9, p0, mLastOccluded:Z
    ...
    iget-object v8, p0, mStatusBar:Lcom/android/systemui/statusbar/phone/StatusBar;
    ...
    :cond_12
    iget-boolean v5, p0, mLastBouncerShowing:Z

    if-ne v3, v5, :cond_13

    iget-boolean v5, p0, mFirstUpdate:Z
    ...
    iput-boolean v1, p0, mLastShowing:Z

    iput-boolean v2, p0, mLastOccluded:Z

    iput-boolean v3, p0, mLastBouncerShowing:Z

    iput-boolean v4, p0, mLastBouncerDismissible:Z

    iput-boolean v6, p0, mLastRemoteInputActive:Z

    iget-boolean v0, p0, mDozing:Z

    iput-boolean v0, p0, mLastDozing:Z

    iget-boolean v0, p0, mPulsing:Z

    iput-boolean v0, p0, mLastPulsing:Z
    ...
    iput v0, p0, mLastBiometricMode:I

    iget-boolean v0, p0, mGesturalNav:Z

    iput-boolean v0, p0, mLastGesturalNav:Z

    iget-boolean v0, p0, mIsDocked:Z

    iput-boolean v0, p0, mLastIsDocked:Z
