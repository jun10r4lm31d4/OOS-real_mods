...
.method private constructor <init>(Lcom/android/settingslib/bluetooth/LocalBluetoothAdapter;Landroid/content/Context;Landroid/os/Handler;Landroid/os/UserHandle;)V
    ...
    iput-object p1, p0, mCachedDeviceManager:Lcom/android/settingslib/bluetooth/CachedBluetoothDeviceManager;

    new-instance p1, Lcom/android/settingslib/bluetooth/BluetoothEventManager;

    iget-object v1, p0, mLocalAdapter:Lcom/android/settingslib/bluetooth/LocalBluetoothAdapter;

    iget-object v2, p0, mCachedDeviceManager:Lcom/android/settingslib/bluetooth/CachedBluetoothDeviceManager;
    ...
    iput-object p1, p0, mEventManager:Lcom/android/settingslib/bluetooth/BluetoothEventManager;

    new-instance p1, Lcom/android/settingslib/bluetooth/LocalBluetoothProfileManager;

    iget-object p2, p0, mContext:Landroid/content/Context;

    iget-object p3, p0, mLocalAdapter:Lcom/android/settingslib/bluetooth/LocalBluetoothAdapter;

    iget-object p4, p0, mCachedDeviceManager:Lcom/android/settingslib/bluetooth/CachedBluetoothDeviceManager;
...
.method public static create(Landroid/content/Context;Landroid/os/Handler;Landroid/os/UserHandle;)Lcom/android/settingslib/bluetooth/LocalBluetoothManager;
    ...
    invoke-direct {v1, v0, p0, p1, p2}, <init>(Lcom/android/settingslib/bluetooth/LocalBluetoothAdapter;Landroid/content/Context;Landroid/os/Handler;Landroid/os/UserHandle;)V
...
.method public declared-synchronized setForegroundActivity(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mForegroundActivity:Ljava/lang/ref/WeakReference;

    goto :goto_0

    :cond_0
    iget-object p1, p0, mForegroundActivity:Ljava/lang/ref/WeakReference;
    ...
    iput-object p1, p0, mForegroundActivity:Ljava/lang/ref/WeakReference;
    :try_end_0
