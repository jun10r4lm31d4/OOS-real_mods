...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Looper;Lcom/android/settingslib/volume/MediaSessions$Callbacks;)V
    ...
    iput-object v0, p0, mRecords:Ljava/util/Map;
    ...
    iput-object v0, p0, mSessionsListener:Landroid/media/session/MediaSessionManager$OnActiveSessionsChangedListener;
    ...
    iput-object v0, p0, mRvc:Landroid/media/IRemoteVolumeController;
    ...
    iput-object v0, p0, mHandler:Lcom/android/settingslib/volume/MediaSessions$H;
    ...
    iput-object p1, p0, mMgr:Landroid/media/session/MediaSessionManager;

    iput-object p3, p0, mCallbacks:Lcom/android/settingslib/volume/MediaSessions$Callbacks;
...
.method static synthetic access$300(Landroid/media/session/MediaController$PlaybackInfo;)Z
    ...
    invoke-static {p0}, isRemote(Landroid/media/session/MediaController$PlaybackInfo;)Z
...
.method static synthetic access$400(Lcom/android/settingslib/volume/MediaSessions;)Lcom/android/settingslib/volume/MediaSessions$Callbacks;
    ...
    iget-object p0, p0, mCallbacks:Lcom/android/settingslib/volume/MediaSessions$Callbacks;
...
.method static synthetic access$500(Lcom/android/settingslib/volume/MediaSessions;Landroid/media/session/MediaSession$Token;Ljava/lang/String;Landroid/media/session/MediaController$PlaybackInfo;)V
    ...
    invoke-direct {p0, p1, p2, p3}, updateRemoteH(Landroid/media/session/MediaSession$Token;Ljava/lang/String;Landroid/media/session/MediaController$PlaybackInfo;)V
...
.method static synthetic access$600(Lcom/android/settingslib/volume/MediaSessions;)Lcom/android/settingslib/volume/MediaSessions$H;
    ...
    iget-object p0, p0, mHandler:Lcom/android/settingslib/volume/MediaSessions$H;
...
.method static synthetic access$700(Lcom/android/settingslib/volume/MediaSessions;)Landroid/media/session/MediaSessionManager;
    ...
    iget-object p0, p0, mMgr:Landroid/media/session/MediaSessionManager;
...
.method static synthetic access$800(Lcom/android/settingslib/volume/MediaSessions;Landroid/media/session/MediaSession$Token;I)V
    ...
    invoke-direct {p0, p1, p2}, onRemoteVolumeChangedH(Landroid/media/session/MediaSession$Token;I)V
...
.method static synthetic access$900(Lcom/android/settingslib/volume/MediaSessions;Landroid/media/session/MediaSession$Token;)V
    ...
    invoke-direct {p0, p1}, onUpdateRemoteControllerH(Landroid/media/session/MediaSession$Token;)V
...
.method private onUpdateRemoteControllerH(Landroid/media/session/MediaSession$Token;)V
    ...
    :cond_2
    invoke-virtual {p0}, postUpdateSessions()V
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    iget-object v0, p0, mRecords:Ljava/util/Map;
    ...
    iget-object p0, p0, mRecords:Ljava/util/Map;
    ...
    invoke-static {v0, p1, v1}, dump(ILjava/io/PrintWriter;Landroid/media/session/MediaController;)V
...
.method public init()V
    ...
    :cond_0
    iget-object v0, p0, mMgr:Landroid/media/session/MediaSessionManager;

    iget-object v1, p0, mSessionsListener:Landroid/media/session/MediaSessionManager$OnActiveSessionsChangedListener;

    const/4 v2, 0x0

    iget-object v3, p0, mHandler:Lcom/android/settingslib/volume/MediaSessions$H;
    ...
    iput-boolean v0, p0, mInit:Z

    invoke-virtual {p0}, postUpdateSessions()V

    iget-object v0, p0, mMgr:Landroid/media/session/MediaSessionManager;

    iget-object p0, p0, mRvc:Landroid/media/IRemoteVolumeController;
...
.method protected onActiveSessionsUpdatedH(Ljava/util/List;)V
    ...
    iget-object v1, p0, mRecords:Ljava/util/Map;
    ...
    iget-object v4, p0, mRecords:Ljava/util/Map;
    ...
    invoke-virtual {p0, v1}, getControllerName(Landroid/media/session/MediaController;)Ljava/lang/String;

    move-result-object v5

    iput-object v5, v4, Lcom/android/settingslib/volume/MediaSessions$MediaControllerRecord;->name:Ljava/lang/String;

    iget-object v5, p0, mRecords:Ljava/util/Map;

    invoke-interface {v5, v2, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v5, p0, mHandler:Lcom/android/settingslib/volume/MediaSessions$H;
    ...
    invoke-static {v3}, isRemote(Landroid/media/session/MediaController$PlaybackInfo;)Z
    ...
    invoke-direct {p0, v2, v4, v3}, updateRemoteH(Landroid/media/session/MediaSession$Token;Ljava/lang/String;Landroid/media/session/MediaController$PlaybackInfo;)V
    ...
    iget-object v2, p0, mRecords:Ljava/util/Map;
    ...
    iget-object v2, p0, mCallbacks:Lcom/android/settingslib/volume/MediaSessions$Callbacks;
