...
.method static constructor <clinit>()V
    ...
    sput-object v0, CLASSIFIER_SENSORS:[I
    ...
    sput-object v0, COLLECTOR_SENSORS:[I
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, mEnforceBouncer:Z

    iput-boolean v0, p0, mBouncerOn:Z

    iput-boolean v0, p0, mBouncerOffOnDown:Z

    iput-boolean v0, p0, mSessionActive:Z

    const/4 v1, 0x1

    iput-boolean v1, p0, mIsTouchScreen:Z

    iput-boolean v0, p0, mJustUnlockedWithFace:Z
    ...
    iput-object v1, p0, mStatusBarStateListener:Lcom/android/systemui/plugins/statusbar/StatusBarStateController$StateListener;
    ...
    iput-object v1, p0, mKeyguardUpdateCallback:Lcom/android/keyguard/KeyguardUpdateMonitorCallback;
    ...
    iput-object v1, p0, mDataCollector:Lcom/android/systemui/analytics/DataCollector;
    ...
    iput-object v1, p0, mHumanInteractionClassifier:Lcom/android/systemui/classifier/HumanInteractionClassifier;
    ...
    iput-object v1, p0, mUiOffloadThread:Lcom/android/systemui/UiOffloadThread;
    ...
    iput-object v1, p0, mMetricsLogger:Lcom/android/internal/logging/MetricsLogger;
    ...
    iget-object v3, p0, mSettingsObserver:Landroid/database/ContentObserver;
    ...
    iget-object p0, p0, mKeyguardUpdateCallback:Lcom/android/keyguard/KeyguardUpdateMonitorCallback;
...
.method static synthetic access$000(Lcom/android/systemui/classifier/FalsingManagerImpl;)Lcom/android/systemui/analytics/DataCollector;
    ...
    iget-object p0, p0, mDataCollector:Lcom/android/systemui/analytics/DataCollector;
...
.method static synthetic access$100(Lcom/android/systemui/classifier/FalsingManagerImpl;)Lcom/android/systemui/classifier/HumanInteractionClassifier;
    ...
    iget-object p0, p0, mHumanInteractionClassifier:Lcom/android/systemui/classifier/HumanInteractionClassifier;
...
.method static synthetic access$402(Lcom/android/systemui/classifier/FalsingManagerImpl;Z)Z
    ...
    iput-boolean p1, p0, mJustUnlockedWithFace:Z
...
.method private clearPendingWtf()V
    ...
    iget-object v0, p0, mPendingWtf:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mPendingWtf:Ljava/lang/Runnable;
...
.method private isEnabled()Z
    ...
    iget-object v0, p0, mHumanInteractionClassifier:Lcom/android/systemui/classifier/HumanInteractionClassifier;
...
.method private onSessionStart()V
    ...
    invoke-virtual {p0}, isClassiferEnabled()Z
    ...
    invoke-direct {p0}, clearPendingWtf()V
    ...
    iput-boolean v1, p0, mSessionActive:Z

    iput-boolean v0, p0, mJustUnlockedWithFace:Z

    iput v0, p0, mIsFalseTouchCalls:I
    ...
    sget-object v0, CLASSIFIER_SENSORS:[I

    invoke-direct {p0, v0}, registerSensors([I)V

    :cond_1
    iget-object v0, p0, mDataCollector:Lcom/android/systemui/analytics/DataCollector;
    ...
    sget-object v0, COLLECTOR_SENSORS:[I
...
.method private sessionEntrypoint()Z
    ...
    iget-boolean v0, p0, mSessionActive:Z

    if-nez v0, :cond_0

    invoke-direct {p0}, shouldSessionBeActive()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-direct {p0}, onSessionStart()V
...
.method private sessionExitpoint(Z)V
    ...
    iput-boolean p1, p0, mSessionActive:Z

    iget v0, p0, mIsFalseTouchCalls:I
    ...
    iget v1, p0, mIsFalseTouchCalls:I
    ...
    iput p1, p0, mIsFalseTouchCalls:I
...
.method private shouldSessionBeActive()Z
    ...
    iget-boolean p0, p0, mShowingAod:Z
...
.method private updateConfiguration()V
    ...
    :cond_0
    iput-boolean v1, p0, mEnforceBouncer:Z
...
.method public isFalseTouch()Z
    ...
    iget-boolean v4, p0, mScreenOn:Z
    ...
    iget-object v1, p0, mPendingWtf:Ljava/lang/Runnable;
    ...
    :cond_1
    iget-boolean v0, p0, mIsTouchScreen:Z
    ...
    :cond_2
    iget-boolean v0, p0, mJustUnlockedWithFace:Z
    ...
    iget v3, p0, mIsFalseTouchCalls:I
    ...
    iput v1, p0, mIsFalseTouchCalls:I
...
.method public synthetic lambda$isFalseTouch$2$FalsingManagerImpl(IILjava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-boolean p2, p0, mScreenOn:Z
...
.method public synthetic lambda$registerSensors$1$FalsingManagerImpl(Landroid/hardware/Sensor;)V
    ...
    iget-object p0, p0, mSensorEventListener:Landroid/hardware/SensorEventListener;
...
.method public onBouncerHidden()V
    ...
    iget-boolean v1, p0, mBouncerOn:Z
    ...
    :cond_0
    iget-boolean v0, p0, mBouncerOn:Z
...
.method public onScreenOff()V
    ...
    invoke-direct {p0, v0}, sessionExitpoint(Z)V
...
.method public onScreenOnFromTouch()V
    ...
    invoke-direct {p0}, sessionEntrypoint()Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;II)V
    ...
    iput-boolean v0, p0, mIsTouchScreen:Z
    ...
    :cond_1
    iget-boolean p2, p0, mBouncerOffOnDown:Z
...
.method public setShowingAod(Z)V
    ...
    iput-boolean p1, p0, mShowingAod:Z

    invoke-virtual {p0}, updateSessionActive()V
...
.method public shouldEnforceBouncer()Z
    ...
    iget-boolean p0, p0, mEnforceBouncer:Z
