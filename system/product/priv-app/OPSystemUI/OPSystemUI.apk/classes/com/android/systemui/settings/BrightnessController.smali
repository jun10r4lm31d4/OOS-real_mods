...
.method public constructor <init>(Landroid/content/Context;Landroid/widget/ImageView;Landroid/widget/ImageView;Lcom/android/systemui/settings/ToggleSlider;)V
    ...
    iput-object v0, p0, mMirrorIcon:Landroid/widget/ImageView;

    iput-object v0, p0, mMirrorLevelIcon:Landroid/widget/ImageView;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mChangeCallbacks:Ljava/util/ArrayList;

    const/4 v0, 0x0

    iput v0, p0, AUTO_BRIGHTNESS_MINIMUM:I

    iput-boolean v0, p0, mNewController:Z

    iput v0, p0, mSliderMax:I

    iput v0, p0, mSliderValue:I
    ...
    iput-object v0, p0, mStartListeningRunnable:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mStopListeningRunnable:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mUpdateModeRunnable:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mUpdateSliderRunnable:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mUpdateSliderNoAnimRunnable:Ljava/lang/Runnable;
    ...
    iput-object p3, p0, mIcon:Landroid/widget/ImageView;

    iput-object p2, p0, mLevelIcon:Landroid/widget/ImageView;

    iget-object p2, p0, mIcon:Landroid/widget/ImageView;
    ...
    iput p2, p0, mSliderMax:I

    iput-object p4, p0, mControl:Lcom/android/systemui/settings/ToggleSlider;

    iget-object p3, p0, mControl:Lcom/android/systemui/settings/ToggleSlider;
    ...
    iput-object p2, p0, mBackgroundHandler:Landroid/os/Handler;
    ...
    iput-object p2, p0, mUserTracker:Lcom/android/systemui/settings/CurrentUserTracker;
    ...
    iput-object p2, p0, mBrightnessObserver:Lcom/android/systemui/settings/BrightnessController$BrightnessObserver;
    ...
    iput-boolean p2, p0, mAutomaticAvailable:Z
    ...
    iput-object p1, p0, mVrManager:Landroid/service/vr/IVrManager;
    ...
    iput-boolean p1, p0, mNewController:Z
    ...
    iget-boolean p2, p0, mNewController:Z
    ...
    iput p1, p0, AUTO_BRIGHTNESS_MINIMUM:I
    ...
    iget p0, p0, AUTO_BRIGHTNESS_MINIMUM:I
...
.method static synthetic access$000(Lcom/android/systemui/settings/BrightnessController;)Ljava/lang/Runnable;
    ...
    iget-object p0, p0, mUpdateModeRunnable:Ljava/lang/Runnable;
...
.method static synthetic access$100(Lcom/android/systemui/settings/BrightnessController;)Landroid/os/Handler;
    ...
    iget-object p0, p0, mBackgroundHandler:Landroid/os/Handler;
...
.method static synthetic access$1000(Lcom/android/systemui/settings/BrightnessController;)Z
    ...
    iget-boolean p0, p0, mAutomatic:Z
...
.method static synthetic access$1002(Lcom/android/systemui/settings/BrightnessController;Z)Z
    ...
    iput-boolean p1, p0, mAutomatic:Z
...
.method static synthetic access$1100(Lcom/android/systemui/settings/BrightnessController;)Z
    ...
    iget-boolean p0, p0, mNewController:Z
...
.method static synthetic access$1300(Lcom/android/systemui/settings/BrightnessController;)Z
    ...
    iget-boolean p0, p0, mIsVrModeEnabled:Z
...
.method static synthetic access$1400(Lcom/android/systemui/settings/BrightnessController;)Z
    ...
    iget-boolean p0, p0, mAutomaticAvailable:Z
...
.method static synthetic access$1500(Lcom/android/systemui/settings/BrightnessController;)I
    ...
    iget p0, p0, mDefaultBacklightForVr:I
...
.method static synthetic access$1600(Lcom/android/systemui/settings/BrightnessController;)I
    ...
    iget p0, p0, mDefaultBacklight:I
...
.method static synthetic access$1702(Lcom/android/systemui/settings/BrightnessController;Z)Z
    ...
    iput-boolean p1, p0, mExternalChange:Z
...
.method static synthetic access$1800(Lcom/android/systemui/settings/BrightnessController;Z)V
    ...
    invoke-direct {p0, p1}, updateIcon(Z)V
...
.method static synthetic access$1900(Lcom/android/systemui/settings/BrightnessController;IZZ)V
    ...
    invoke-direct {p0, p1, p2, p3}, updateSlider(IZZ)V
...
.method static synthetic access$200(Lcom/android/systemui/settings/BrightnessController;)Ljava/lang/Runnable;
    ...
    iget-object p0, p0, mUpdateSliderRunnable:Ljava/lang/Runnable;
...
.method static synthetic access$2000(Lcom/android/systemui/settings/BrightnessController;)Lcom/android/systemui/settings/ToggleSlider;
    ...
    iget-object p0, p0, mControl:Lcom/android/systemui/settings/ToggleSlider;
...
.method static synthetic access$2100(Lcom/android/systemui/settings/BrightnessController;Z)V
    ...
    invoke-direct {p0, p1}, updateVrMode(Z)V
...
.method static synthetic access$400(Lcom/android/systemui/settings/BrightnessController;)Ljava/util/ArrayList;
    ...
    iget-object p0, p0, mChangeCallbacks:Ljava/util/ArrayList;
...
.method static synthetic access$500(Lcom/android/systemui/settings/BrightnessController;)Lcom/android/systemui/settings/BrightnessController$BrightnessObserver;
    ...
    iget-object p0, p0, mBrightnessObserver:Lcom/android/systemui/settings/BrightnessController$BrightnessObserver;
...
.method static synthetic access$600(Lcom/android/systemui/settings/BrightnessController;)Lcom/android/systemui/settings/CurrentUserTracker;
    ...
    iget-object p0, p0, mUserTracker:Lcom/android/systemui/settings/CurrentUserTracker;
...
.method static synthetic access$700(Lcom/android/systemui/settings/BrightnessController;)Ljava/lang/Runnable;
    ...
    iget-object p0, p0, mUpdateSliderNoAnimRunnable:Ljava/lang/Runnable;
...
.method static synthetic access$902(Lcom/android/systemui/settings/BrightnessController;Z)Z
    ...
    iput-boolean p1, p0, mTracking:Z
...
.method private animateSliderTo(IZ)V
    ...
    iget-boolean v0, p0, mControlValueInitialized:Z
    ...
    iget-object p2, p0, mControl:Lcom/android/systemui/settings/ToggleSlider;

    invoke-interface {p2, p1}, Lcom/android/systemui/settings/ToggleSlider;->setValue(I)V

    iput-boolean v1, p0, mControlValueInitialized:Z

    :cond_0
    iget-object p2, p0, mSliderAnimator:Landroid/animation/ValueAnimator;
    ...
    iget-object v3, p0, mControl:Lcom/android/systemui/settings/ToggleSlider;
    ...
    iput-object p2, p0, mSliderAnimator:Landroid/animation/ValueAnimator;
    ...
    iget-object v0, p0, mControl:Lcom/android/systemui/settings/ToggleSlider;
    ...
    iget-object v0, p0, mSliderAnimator:Landroid/animation/ValueAnimator;

    invoke-virtual {v0, p1, p2}, Landroid/animation/ValueAnimator;->setDuration(J)Landroid/animation/ValueAnimator;

    iget-object p0, p0, mSliderAnimator:Landroid/animation/ValueAnimator;
...
.method private setBrightness(I)V
    ...
    :cond_0
    iget-object p0, p0, mDisplayManager:Landroid/hardware/display/DisplayManager;
...
.method private updateIcon(Z)V
    ...
    iget-object v1, p0, mLevelIcon:Landroid/widget/ImageView;

    invoke-direct {p0, p1, v0, v1}, updateIconInternal(ZLandroid/widget/ImageView;Landroid/widget/ImageView;)V

    iget-object v0, p0, mMirrorIcon:Landroid/widget/ImageView;

    iget-object v1, p0, mMirrorLevelIcon:Landroid/widget/ImageView;
...
.method private updateIconInternal(ZLandroid/widget/ImageView;Landroid/widget/ImageView;)V
    ...
    iget-boolean p1, p0, mIsVrModeEnabled:Z

    if-eqz p1, :cond_4

    iget p1, p0, mSliderValue:I

    iget p2, p0, mMinimumBacklightForVr:I
    ...
    iget p2, p0, mMinimumBacklight:I
...
.method private updateSlider(IZZ)V
    ...
    iget v0, p0, mMaximumBacklightForVr:I
    ...
    iget v0, p0, mMaximumBacklight:I

    :goto_0
    iget-object v1, p0, mControl:Lcom/android/systemui/settings/ToggleSlider;
    ...
    iput p1, p0, mSliderValue:I

    invoke-direct {p0, p1, p3}, animateSliderTo(IZ)V
...
.method private updateVrMode(Z)V
    ...
    iget-object p1, p0, mBackgroundHandler:Landroid/os/Handler;
...
.method public checkRestrictionAndSetEnabled()V
    ...
    iget-object v0, p0, mBackgroundHandler:Landroid/os/Handler;
...
.method public synthetic lambda$animateSliderTo$0$BrightnessController(Landroid/animation/ValueAnimator;)V
    ...
    iput-boolean v0, p0, mExternalChange:Z
...
.method public onChanged(Lcom/android/systemui/settings/ToggleSlider;ZZIZ)V
    ...
    iget-boolean v0, p0, mExternalChange:Z
    ...
    :cond_0
    iput p4, p0, mSliderValue:I

    iput-boolean p2, p0, mTracking:Z

    iget-boolean p1, p0, mAutomatic:Z

    invoke-direct {p0, p1}, updateIcon(Z)V

    iget-boolean p1, p0, mExternalChange:Z
    ...
    :cond_1
    iget-object p1, p0, mSliderAnimator:Landroid/animation/ValueAnimator;
    ...
    iget p3, p0, mMinimumBacklightForVr:I
    ...
    :goto_0
    iget p3, p0, mMinimumBacklight:I
    ...
    :cond_5
    invoke-direct {p0, p3}, setBrightness(I)V
...
.method public onClickAutomaticIcon()V
    ...
    iget-boolean v0, p0, mAutomatic:Z

    xor-int/lit8 v0, v0, 0x1

    invoke-direct {p0, v0}, setMode(I)V
...
.method public registerCallbacks()V
    ...
    iget-object v1, p0, mVrManager:Landroid/service/vr/IVrManager;
    ...
    iput-boolean v1, p0, mIsVrModeEnabled:Z
    :try_end_0
    ...
    iget-object v1, p0, mStartListeningRunnable:Ljava/lang/Runnable;
...
.method public setMirrorView(Landroid/view/View;)V
    ...
    iput-object p1, p0, mMirrorLevelIcon:Landroid/widget/ImageView;
...
.method public unregisterCallbacks()V
    ...
    iget-object v1, p0, mStopListeningRunnable:Ljava/lang/Runnable;
    ...
    iput-boolean v0, p0, mControlValueInitialized:Z
