...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mFlyoutSpring:Landroidx/dynamicanimation/animation/SpringAnimation;
    ...
    iput-object v0, p0, mBgPaint:Landroid/graphics/Paint;
    ...
    iput-boolean v0, p0, mArrowPointingLeft:Z

    new-instance v1, Landroid/graphics/Outline;

    invoke-direct {v1}, Landroid/graphics/Outline;-><init>()V

    iput-object v1, p0, mTriangleOutline:Landroid/graphics/Outline;

    new-instance v1, Landroid/graphics/RectF;

    invoke-direct {v1}, Landroid/graphics/RectF;-><init>()V

    iput-object v1, p0, mBgRect:Landroid/graphics/RectF;

    const/high16 v1, 0x3f800000    # 1.0f

    iput v1, p0, mPercentTransitionedToDot:F

    const/4 v1, 0x0

    iput v1, p0, mPercentStillFlyout:F

    iput v1, p0, mFlyoutToDotWidthDelta:F

    iput v1, p0, mFlyoutToDotHeightDelta:F

    iput v1, p0, mTranslationXWhenDot:F

    iput v1, p0, mTranslationYWhenDot:F

    iput v1, p0, mRestingTranslationX:F
    ...
    iput-object v1, p0, mFlyoutTextContainer:Landroid/view/ViewGroup;

    iget-object v1, p0, mFlyoutTextContainer:Landroid/view/ViewGroup;
    ...
    iput-object v1, p0, mFlyoutText:Landroid/widget/TextView;
    ...
    iput v2, p0, mFlyoutSpaceFromBubble:I
    ...
    iput v2, p0, mFloatingBackgroundColor:I
    ...
    iput v2, p0, mCornerRadius:F

    iget v2, p0, mNewDotRadius:F

    iget v3, p0, mCornerRadius:F

    sub-float/2addr v2, v3

    iput v2, p0, mFlyoutToDotCornerRadiusDelta:F

    invoke-virtual {p1}, Landroid/content/res/TypedArray;->recycle()V

    iget p1, p0, mPointerSize:I
    ...
    iget-object p1, p0, mBgPaint:Landroid/graphics/Paint;

    iget v2, p0, mFloatingBackgroundColor:I

    invoke-virtual {p1, v2}, Landroid/graphics/Paint;->setColor(I)V

    new-instance p1, Landroid/graphics/drawable/ShapeDrawable;

    iget v2, p0, mPointerSize:I
    ...
    iput-object p1, p0, mLeftTriangleShape:Landroid/graphics/drawable/ShapeDrawable;

    iget-object p1, p0, mLeftTriangleShape:Landroid/graphics/drawable/ShapeDrawable;
    ...
    iget v0, p0, mFloatingBackgroundColor:I
    ...
    iput-object p1, p0, mRightTriangleShape:Landroid/graphics/drawable/ShapeDrawable;

    iget-object p1, p0, mRightTriangleShape:Landroid/graphics/drawable/ShapeDrawable;
    ...
    iget p0, p0, mFloatingBackgroundColor:I
...
.method static synthetic access$000(Lcom/android/systemui/bubbles/BubbleFlyoutView;Landroid/graphics/Outline;)V
    ...
    invoke-direct {p0, p1}, getOutline(Landroid/graphics/Outline;)V
...
.method private getOutline(Landroid/graphics/Outline;)V
    ...
    iget-object v0, p0, mTriangleOutline:Landroid/graphics/Outline;
    ...
    iget-object v1, p0, mBgRect:Landroid/graphics/RectF;
    ...
    iget v0, p0, mPercentStillFlyout:F
    ...
    iget-object v1, p0, mTriangleOutline:Landroid/graphics/Outline;
    ...
    iget v3, p0, mBgTranslationY:F

    add-float/2addr v2, v3

    invoke-virtual {v0, v1, v2}, Landroid/graphics/Matrix;->postTranslate(FF)Z

    iget v1, p0, mPercentTransitionedToDot:F
...
.method private renderBackground(Landroid/graphics/Canvas;)V
    ...
    iget v1, p0, mFlyoutToDotWidthDelta:F

    iget v2, p0, mPercentTransitionedToDot:F
    ...
    iget v2, p0, mFlyoutToDotHeightDelta:F

    iget v3, p0, mPercentTransitionedToDot:F
    ...
    iget v4, p0, mFlyoutToDotCornerRadiusDelta:F

    mul-float/2addr v4, v3

    sub-float/2addr v2, v4

    iget v4, p0, mTranslationXWhenDot:F

    mul-float/2addr v4, v3

    iput v4, p0, mBgTranslationX:F

    iget v4, p0, mTranslationYWhenDot:F

    mul-float/2addr v4, v3

    iput v4, p0, mBgTranslationY:F

    iget-object v3, p0, mBgRect:Landroid/graphics/RectF;

    iget v4, p0, mPointerSize:I

    int-to-float v5, v4

    iget v6, p0, mPercentStillFlyout:F
    ...
    iget-object v3, p0, mBgPaint:Landroid/graphics/Paint;

    iget-object v4, p0, mArgbEvaluator:Landroid/animation/ArgbEvaluator;

    iget v5, p0, mPercentTransitionedToDot:F

    iget v6, p0, mFloatingBackgroundColor:I

    invoke-static {v6}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v6

    iget v7, p0, mDotColor:I
    ...
    iget v3, p0, mBgTranslationX:F

    iget v4, p0, mBgTranslationY:F

    invoke-virtual {p1, v3, v4}, Landroid/graphics/Canvas;->translate(FF)V

    invoke-direct {p0, p1, v0, v1}, renderPointerTriangle(Landroid/graphics/Canvas;FF)V

    iget-object v0, p0, mBgRect:Landroid/graphics/RectF;

    iget-object p0, p0, mBgPaint:Landroid/graphics/Paint;
...
.method private renderPointerTriangle(Landroid/graphics/Canvas;FF)V
    ...
    iget-boolean v0, p0, mArrowPointingLeft:Z
    ...
    iget-boolean v1, p0, mArrowPointingLeft:Z
    ...
    iget-boolean p2, p0, mArrowPointingLeft:Z

    if-eqz p2, :cond_2

    iget-object p2, p0, mLeftTriangleShape:Landroid/graphics/drawable/ShapeDrawable;

    goto :goto_2

    :cond_2
    iget-object p2, p0, mRightTriangleShape:Landroid/graphics/drawable/ShapeDrawable;
    ...
    iget v2, p0, mPercentStillFlyout:F
    ...
    iget-object p0, p0, mTriangleOutline:Landroid/graphics/Outline;
...
.method getRestingTranslationX()F
    ...
    iget p0, p0, mRestingTranslationX:F
...
.method hideFlyout()V
    ...
    iget-object v0, p0, mOnHide:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mOnHide:Ljava/lang/Runnable;
...
.method public synthetic lambda$showFlyout$0$BubbleFlyoutView(Landroid/graphics/PointF;Z)V
    ...
    iget-object v0, p0, mFlyoutText:Landroid/widget/TextView;
    ...
    iget-object v3, p0, mFlyoutTextContainer:Landroid/view/ViewGroup;
    ...
    iget v0, p0, mBubbleSize:I

    int-to-float v0, v0

    add-float/2addr p1, v0

    iget v0, p0, mFlyoutSpaceFromBubble:I
    ...
    :goto_1
    iput p1, p0, mRestingTranslationX:F

    iget p1, p0, mRestingTranslationX:F

    if-eqz p2, :cond_2

    iget p2, p0, mBubbleSize:I
    ...
    iget-object p1, p0, mFlyoutSpring:Landroidx/dynamicanimation/animation/SpringAnimation;

    iget p2, p0, mRestingTranslationX:F
    ...
    iget p2, p0, mNewDotSize:F

    sub-float/2addr p1, p2

    iput p1, p0, mFlyoutToDotWidthDelta:F
    ...
    iput p1, p0, mFlyoutToDotHeightDelta:F

    iget p1, p0, mFlyoutSpaceFromBubble:I

    int-to-float p1, p1

    iget p2, p0, mNewDotOffsetFromBubbleBounds:F
    ...
    iget p2, p0, mNewDotRadius:F

    sub-float/2addr p1, p2

    iput p1, p0, mTranslationXWhenDot:F
    ...
    iput p2, p0, mTranslationXWhenDot:F
    ...
    iput p1, p0, mTranslationYWhenDot:F
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-direct {p0, p1}, renderBackground(Landroid/graphics/Canvas;)V
...
.method setCollapsePercent(F)V
    ...
    iput p1, p0, mPercentTransitionedToDot:F

    iget p1, p0, mPercentTransitionedToDot:F

    sub-float/2addr v0, p1

    iput v0, p0, mPercentStillFlyout:F

    iget-object p1, p0, mFlyoutText:Landroid/widget/TextView;
    ...
    invoke-direct {p0, v0}, clampPercentage(F)F
...
.method showFlyout(Ljava/lang/CharSequence;Landroid/graphics/PointF;FZILjava/lang/Runnable;)V
    ...
    iput-boolean p4, p0, mArrowPointingLeft:Z

    iput p5, p0, mDotColor:I

    iput-object p6, p0, mOnHide:Ljava/lang/Runnable;

    const/4 p5, 0x0

    invoke-virtual {p0, p5}, setCollapsePercent(F)V
    ...
    iget-object p5, p0, mFlyoutText:Landroid/widget/TextView;
    ...
    iget-object p3, p0, mFlyoutText:Landroid/widget/TextView;
