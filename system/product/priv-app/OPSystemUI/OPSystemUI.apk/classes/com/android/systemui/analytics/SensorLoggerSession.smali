...
.method public constructor <init>(JJ)V
    ...
    iput-object v0, p0, mMotionEvents:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mSensorEvents:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mPhoneEvents:Ljava/util/ArrayList;

    const/4 v0, 0x2

    iput v0, p0, mResult:I

    iput-wide p1, p0, mStartTimestampMillis:J

    iput-wide p3, p0, mStartSystemTimeNanos:J
...
.method private motionEventToProto(Landroid/view/MotionEvent;)Lcom/android/systemui/statusbar/phone/nano/TouchAnalyticsProto$Session$TouchEvent;
    ...
    iget-wide v4, p0, mStartSystemTimeNanos:J
...
.method private phoneEventToProto(IJ)Lcom/android/systemui/statusbar/phone/nano/TouchAnalyticsProto$Session$PhoneEvent;
    ...
    iget-wide p0, p0, mStartSystemTimeNanos:J
...
.method private sensorEventToProto(Landroid/hardware/SensorEvent;J)Lcom/android/systemui/statusbar/phone/nano/TouchAnalyticsProto$Session$SensorEvent;
    ...
    iget-wide v1, p0, mStartSystemTimeNanos:J
...
.method public addMotionEvent(Landroid/view/MotionEvent;)V
    ...
    invoke-direct {p0, p1}, motionEventToProto(Landroid/view/MotionEvent;)Lcom/android/systemui/statusbar/phone/nano/TouchAnalyticsProto$Session$TouchEvent;

    move-result-object p1

    iget-object p0, p0, mMotionEvents:Ljava/util/ArrayList;
...
.method public addPhoneEvent(IJ)V
    ...
    invoke-direct {p0, p1, p2, p3}, phoneEventToProto(IJ)Lcom/android/systemui/statusbar/phone/nano/TouchAnalyticsProto$Session$PhoneEvent;

    move-result-object p1

    iget-object p0, p0, mPhoneEvents:Ljava/util/ArrayList;
...
.method public addSensorEvent(Landroid/hardware/SensorEvent;J)V
    ...
    invoke-direct {p0, p1, p2, p3}, sensorEventToProto(Landroid/hardware/SensorEvent;J)Lcom/android/systemui/statusbar/phone/nano/TouchAnalyticsProto$Session$SensorEvent;

    move-result-object p1

    iget-object p0, p0, mSensorEvents:Ljava/util/ArrayList;
...
.method public end(JI)V
    ...
    iput p3, p0, mResult:I

    iput-wide p1, p0, mEndTimestampMillis:J
...
.method public setTouchArea(II)V
    ...
    iput p1, p0, mTouchAreaWidth:I

    iput p2, p0, mTouchAreaHeight:I
...
.method public toProto()Lcom/android/systemui/statusbar/phone/nano/TouchAnalyticsProto$Session;
    ...
    iget-object v1, p0, mSensorEvents:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, mMotionEvents:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, mPhoneEvents:Ljava/util/ArrayList;
...
.method public toString()Ljava/lang/String;
    ...
    iget-wide v1, p0, mEndTimestampMillis:J
    ...
    iget-object v2, p0, mSensorEvents:Ljava/util/ArrayList;
