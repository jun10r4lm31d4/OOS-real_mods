...
.method static constructor <clinit>()V
    ...
    sput-object v0, SLOWDOWN_INTERPOLATOR:Landroid/view/animation/PathInterpolator;
    ...
    sput-object v0, DIM_INTERPOLATOR:Landroid/view/animation/PathInterpolator;
    ...
    sput-object v0, IME_ADJUST_INTERPOLATOR:Landroid/view/animation/Interpolator;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object p2, p0, mTempInt2:[I

    new-instance p2, Landroid/graphics/Rect;

    invoke-direct {p2}, Landroid/graphics/Rect;-><init>()V

    iput-object p2, p0, mDockedRect:Landroid/graphics/Rect;

    new-instance p2, Landroid/graphics/Rect;

    invoke-direct {p2}, Landroid/graphics/Rect;-><init>()V

    iput-object p2, p0, mDockedTaskRect:Landroid/graphics/Rect;

    new-instance p2, Landroid/graphics/Rect;

    invoke-direct {p2}, Landroid/graphics/Rect;-><init>()V

    iput-object p2, p0, mOtherTaskRect:Landroid/graphics/Rect;

    new-instance p2, Landroid/graphics/Rect;

    invoke-direct {p2}, Landroid/graphics/Rect;-><init>()V

    iput-object p2, p0, mOtherRect:Landroid/graphics/Rect;

    new-instance p2, Landroid/graphics/Rect;

    invoke-direct {p2}, Landroid/graphics/Rect;-><init>()V

    iput-object p2, p0, mDockedInsetRect:Landroid/graphics/Rect;

    new-instance p2, Landroid/graphics/Rect;

    invoke-direct {p2}, Landroid/graphics/Rect;-><init>()V

    iput-object p2, p0, mOtherInsetRect:Landroid/graphics/Rect;

    new-instance p2, Landroid/graphics/Rect;

    invoke-direct {p2}, Landroid/graphics/Rect;-><init>()V

    iput-object p2, p0, mLastResizeRect:Landroid/graphics/Rect;

    new-instance p2, Landroid/graphics/Rect;

    invoke-direct {p2}, Landroid/graphics/Rect;-><init>()V

    iput-object p2, p0, mTmpRect:Landroid/graphics/Rect;

    invoke-static {}, Lcom/android/systemui/stackdivider/WindowManagerProxy;->getInstance()Lcom/android/systemui/stackdivider/WindowManagerProxy;

    move-result-object p2

    iput-object p2, p0, mWindowManagerProxy:Lcom/android/systemui/stackdivider/WindowManagerProxy;

    new-instance p2, Landroid/graphics/Rect;

    invoke-direct {p2}, Landroid/graphics/Rect;-><init>()V

    iput-object p2, p0, mStableInsets:Landroid/graphics/Rect;
    ...
    iput-object p2, p0, mHandleDelegate:Landroid/view/View$AccessibilityDelegate;
    ...
    iput-object p2, p0, mResetBackgroundRunnable:Ljava/lang/Runnable;
    ...
    iput-object p2, p0, mSfChoreographer:Lcom/android/internal/view/SurfaceFlingerVsyncChoreographer;
    ...
    iput-object p1, p0, mDefaultDisplay:Landroid/view/Display;
...
.method static synthetic access$1000(Lcom/android/systemui/stackdivider/DividerView;)Lcom/android/internal/policy/DividerSnapAlgorithm;
    ...
    iget-object p0, p0, mSnapAlgorithm:Lcom/android/internal/policy/DividerSnapAlgorithm;
...
.method static synthetic access$1100(Lcom/android/systemui/stackdivider/DividerView;)V
    ...
    invoke-direct {p0}, resetBackground()V
...
.method static synthetic access$1300(Lcom/android/systemui/stackdivider/DividerView;)Lcom/android/internal/view/SurfaceFlingerVsyncChoreographer;
    ...
    iget-object p0, p0, mSfChoreographer:Lcom/android/internal/view/SurfaceFlingerVsyncChoreographer;
...
.method private applyDismissingParallax(Landroid/graphics/Rect;ILcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;II)V
    ...
    iget-object p3, p0, mSnapAlgorithm:Lcom/android/internal/policy/DividerSnapAlgorithm;
    ...
    iget-object v1, p0, mSnapAlgorithm:Lcom/android/internal/policy/DividerSnapAlgorithm;
    ...
    invoke-static {p2}, dockSideTopLeft(I)Z
    ...
    :cond_0
    iget-object p5, p0, mSnapAlgorithm:Lcom/android/internal/policy/DividerSnapAlgorithm;
    ...
    invoke-static {p2}, dockSideBottomRight(I)Z
    ...
    invoke-static {p5, p4, p2}, isDismissing(Lcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;II)Z

    move-result p4

    if-eqz p4, :cond_6

    invoke-static {p3, p2}, calculateParallaxDismissingFraction(FI)F
...
.method private applyExitAnimationParallax(Landroid/graphics/Rect;I)V
    ...
    iget p0, p0, mExitStartPosition:I
...
.method private static calculateParallaxDismissingFraction(FI)F
    ...
    sget-object v0, SLOWDOWN_INTERPOLATOR:Landroid/view/animation/PathInterpolator;
...
.method private calculatePosition(II)I
    ...
    invoke-virtual {p0}, isHorizontalDivision()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-direct {p0, p2}, calculateYPosition(I)I
    ...
    :cond_0
    invoke-direct {p0, p1}, calculateXPosition(I)I
...
.method private calculateXPosition(I)I
    ...
    iget v0, p0, mStartPosition:I

    add-int/2addr v0, p1

    iget p0, p0, mStartX:I
...
.method private cancelFlingAnimation()V
    ...
    iget-object p0, p0, mCurrentAnimator:Landroid/animation/ValueAnimator;
...
.method private commitSnapFlags(Lcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;)V
    ...
    iget-object p1, p0, mWindowManagerProxy:Lcom/android/systemui/stackdivider/WindowManagerProxy;
    ...
    :goto_1
    iget-object p0, p0, mWindowManagerProxy:Lcom/android/systemui/stackdivider/WindowManagerProxy;
...
.method private fling(IFZZ)V
    ...
    invoke-virtual {p0}, getSnapAlgorithm()Lcom/android/internal/policy/DividerSnapAlgorithm;
    ...
    invoke-direct {p0, v1}, logResizeEvent(Lcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;)V

    :cond_1
    const-wide/16 p3, 0x0

    invoke-direct {p0, p1, v1, p3, p4}, getFlingAnimator(ILcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;J)Landroid/animation/ValueAnimator;

    move-result-object p3

    iget-object p0, p0, mFlingAnimationUtils:Lcom/android/systemui/statusbar/FlingAnimationUtils;
...
.method private flingTo(ILcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;JJJLandroid/view/animation/Interpolator;)V
    ...
    invoke-direct {p0, p1, p2, p7, p8}, getFlingAnimator(ILcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;J)Landroid/animation/ValueAnimator;
...
.method private getDimFraction(ILcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;)F
    ...
    iget-boolean v0, p0, mEntranceAnimationRunning:Z
    ...
    sget-object v0, DIM_INTERPOLATOR:Landroid/view/animation/PathInterpolator;

    invoke-virtual {v0, p1}, Landroid/view/animation/PathInterpolator;->getInterpolation(F)F

    move-result p1

    invoke-direct {p0, p2}, hasInsetsAtDismissTarget(Lcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;)Z
...
.method private getFlingAnimator(ILcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;J)Landroid/animation/ValueAnimator;
    ...
    iget-object v0, p0, mCurrentAnimator:Landroid/animation/ValueAnimator;

    if-eqz v0, :cond_0

    invoke-direct {p0}, cancelFlingAnimation()V

    invoke-direct {p0}, updateDockSide()V
    ...
    iput-object p1, p0, mCurrentAnimator:Landroid/animation/ValueAnimator;
...
.method private getWindowingModeForDismissTarget(Lcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;)I
    ...
    invoke-static {v0}, dockSideTopLeft(I)Z
    ...
    iget p0, p0, mDockSide:I

    invoke-static {p0}, dockSideBottomRight(I)Z
...
.method private hasInsetsAtDismissTarget(Lcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;)Z
    ...
    iget-object p0, p0, mStableInsets:Landroid/graphics/Rect;
...
.method private initializeSnapAlgorithm()V
    ...
    iget-object v0, p0, mSnapAlgorithm:Lcom/android/internal/policy/DividerSnapAlgorithm;
    ...
    iget v5, p0, mDividerSize:I

    invoke-virtual {p0}, isHorizontalDivision()Z

    move-result v6

    iget-object v7, p0, mStableInsets:Landroid/graphics/Rect;

    iget v8, p0, mDockSide:I
    ...
    iput-object v0, p0, mSnapAlgorithm:Lcom/android/internal/policy/DividerSnapAlgorithm;

    iget-object v0, p0, mSnapTargetBeforeMinimized:Lcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;
    ...
    iput-object v0, p0, mSnapTargetBeforeMinimized:Lcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;

    :cond_0
    iget-object v0, p0, mMinimizedSnapAlgorithm:Lcom/android/internal/policy/DividerSnapAlgorithm;
    ...
    iget-boolean v1, p0, mDockedStackMinimized:Z

    if-eqz v1, :cond_1

    iget-boolean v1, p0, mHomeStackResizable:Z
    ...
    iput-object v0, p0, mMinimizedSnapAlgorithm:Lcom/android/internal/policy/DividerSnapAlgorithm;
...
.method private liftBackground()V
    ...
    iget-boolean v0, p0, mBackgroundLifted:Z
    ...
    iget-object v0, p0, mBackground:Landroid/view/View;
    ...
    iget-object v0, p0, mHandle:Lcom/android/systemui/stackdivider/DividerHandleView;
    ...
    iput-boolean v0, p0, mBackgroundLifted:Z
...
.method private logResizeEvent(Lcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;)V
    ...
    invoke-static {p0}, dockSideTopLeft(I)Z
...
.method private repositionSnapTargetBeforeMinimized()V
    ...
    iget-object v0, p0, mState:Lcom/android/systemui/stackdivider/DividerState;
    ...
    iput-object v1, p0, mSnapAlgorithm:Lcom/android/internal/policy/DividerSnapAlgorithm;

    invoke-direct {p0}, initializeSnapAlgorithm()V
...
.method private resetBackground()V
    ...
    iget-object p0, p0, mMinimizedShadow:Lcom/android/systemui/stackdivider/MinimizedDockShadow;
...
.method private resizeStack(Lcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;)V
    ...
    invoke-virtual {p0, v0, v0, p1}, resizeStack(IILcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;)V
...
.method private restrictDismissingTaskPosition(IILcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;)I
    ...
    iget-object p1, p0, mSnapAlgorithm:Lcom/android/internal/policy/DividerSnapAlgorithm;
...
.method private saveSnapTargetBeforeMinimized(Lcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;)V
    ...
    iput-object p1, p0, mSnapTargetBeforeMinimized:Lcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;
    ...
    iget p0, p0, mDisplayHeight:I

    goto :goto_0

    :cond_0
    iget p0, p0, mDisplayWidth:I
...
.method private stopDragging()V
    ...
    iget-object v0, p0, mWindowManager:Lcom/android/systemui/stackdivider/DividerWindowManager;

    invoke-virtual {v0, v1}, Lcom/android/systemui/stackdivider/DividerWindowManager;->setSlippery(Z)V

    invoke-direct {p0}, releaseBackground()V
...
.method private updateDisplayInfo()V
    ...
    iput v0, p0, mDisplayRotation:I

    new-instance v0, Landroid/view/DisplayInfo;

    invoke-direct {v0}, Landroid/view/DisplayInfo;-><init>()V

    iget-object v1, p0, mDefaultDisplay:Landroid/view/Display;
...
.method private updateDockSide()V
    ...
    iget-object v0, p0, mWindowManagerProxy:Lcom/android/systemui/stackdivider/WindowManagerProxy;

    invoke-virtual {v0}, Lcom/android/systemui/stackdivider/WindowManagerProxy;->getDockSide()I

    move-result v0

    iput v0, p0, mDockSide:I

    iget-object v0, p0, mMinimizedShadow:Lcom/android/systemui/stackdivider/MinimizedDockShadow;
...
.method public getNonMinimizedSplitScreenSecondaryBounds()Landroid/graphics/Rect;
    ...
    iget-object v2, p0, mOtherTaskRect:Landroid/graphics/Rect;

    invoke-virtual {p0, v0, v1, v2}, calculateBoundsForPosition(IILandroid/graphics/Rect;)V

    iget-object v0, p0, mOtherTaskRect:Landroid/graphics/Rect;

    iget v1, v0, Landroid/graphics/Rect;->bottom:I

    iget-object v2, p0, mStableInsets:Landroid/graphics/Rect;
    ...
    :goto_0
    iget-object p0, p0, mOtherTaskRect:Landroid/graphics/Rect;
...
.method public getSnapAlgorithm()Lcom/android/internal/policy/DividerSnapAlgorithm;
    ...
    iget-boolean v0, p0, mDockedStackMinimized:Z

    if-eqz v0, :cond_0

    iget-boolean v0, p0, mHomeStackResizable:Z

    if-eqz v0, :cond_0

    iget-object p0, p0, mMinimizedSnapAlgorithm:Lcom/android/internal/policy/DividerSnapAlgorithm;
...
.method public injectDependencies(Lcom/android/systemui/stackdivider/DividerWindowManager;Lcom/android/systemui/stackdivider/DividerState;Lcom/android/systemui/stackdivider/DividerView$DividerCallbacks;)V
    ...
    iput-object p1, p0, mWindowManager:Lcom/android/systemui/stackdivider/DividerWindowManager;

    iput-object p2, p0, mState:Lcom/android/systemui/stackdivider/DividerState;

    iput-object p3, p0, mCallback:Lcom/android/systemui/stackdivider/DividerView$DividerCallbacks;

    iget-object p1, p0, mStableInsets:Landroid/graphics/Rect;
    ...
    iget-object p2, p0, mStableInsets:Landroid/graphics/Rect;

    invoke-virtual {p1, p2}, Lcom/android/systemui/shared/system/WindowManagerWrapper;->getStableInsets(Landroid/graphics/Rect;)V

    :cond_0
    iget-object p1, p0, mState:Lcom/android/systemui/stackdivider/DividerState;
    ...
    :cond_1
    invoke-direct {p0}, repositionSnapTargetBeforeMinimized()V
...
.method public synthetic lambda$getFlingAnimator$0$DividerView(ZLcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;Landroid/animation/ValueAnimator;)V
    ...
    :goto_0
    invoke-virtual {p0, v0, p1, p2}, resizeStackDelayed(IILcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;)V
...
.method public synthetic lambda$getFlingAnimator$1$DividerView(Lcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;)V
    ...
    invoke-direct {p0, p1}, commitSnapFlags(Lcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;)V
    ...
    iput-object v0, p0, mCurrentAnimator:Landroid/animation/ValueAnimator;

    iput-boolean v1, p0, mEntranceAnimationRunning:Z

    iput-boolean v1, p0, mExitAnimationRunning:Z

    iget-object v0, p0, mCallback:Lcom/android/systemui/stackdivider/DividerView$DividerCallbacks;
    ...
    iget-boolean v0, p0, mIsInMinimizeInteraction:Z
    ...
    invoke-direct {p0, p1}, saveSnapTargetBeforeMinimized(Lcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;)V
...
.method public synthetic lambda$getFlingAnimator$2$DividerView()V
    ...
    iput-boolean v0, p0, mIsInMinimizeInteraction:Z
...
.method public synthetic lambda$onRecentsDrawn$3$DividerView(I)V
    ...
    iget v0, p0, mLongPressEntraceAnimDuration:I
    ...
    invoke-virtual/range {v1 .. v8}, stopDragging(ILcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;JLandroid/view/animation/Interpolator;J)V
...
.method public notifyDockSideChanged(I)V
    ...
    iput p1, p0, mDockSide:I

    iget-object p1, p0, mMinimizedShadow:Lcom/android/systemui/stackdivider/MinimizedDockShadow;
    ...
    iput-object p1, p0, mMinimizedSnapAlgorithm:Lcom/android/internal/policy/DividerSnapAlgorithm;
    ...
    :cond_2
    iget-boolean p1, p0, mHomeStackResizable:Z

    if-eqz p1, :cond_3

    iget-boolean p1, p0, mDockedStackMinimized:Z

    if-eqz p1, :cond_3

    iget-object p1, p0, mMinimizedSnapAlgorithm:Lcom/android/internal/policy/DividerSnapAlgorithm;

    invoke-virtual {p1}, Lcom/android/internal/policy/DividerSnapAlgorithm;->getMiddleTarget()Lcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;

    move-result-object p1

    invoke-direct {p0, p1}, resizeStack(Lcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;)V
...
.method protected onAttachedToWindow()V
    ...
    invoke-direct {p0, v0}, saveSnapTargetBeforeMinimized(Lcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;)V
...
.method public onComputeInternalInsets(Landroid/view/ViewTreeObserver$InternalInsetsInfo;)V
    ...
    iget-object v1, p0, mHandle:Lcom/android/systemui/stackdivider/DividerHandleView;

    invoke-virtual {v1}, Landroid/view/View;->getLeft()I

    move-result v1

    iget-object v2, p0, mHandle:Lcom/android/systemui/stackdivider/DividerHandleView;

    invoke-virtual {v2}, Landroid/view/View;->getTop()I

    move-result v2

    iget-object v3, p0, mHandle:Lcom/android/systemui/stackdivider/DividerHandleView;

    invoke-virtual {v3}, Landroid/view/View;->getRight()I

    move-result v3

    iget-object v4, p0, mHandle:Lcom/android/systemui/stackdivider/DividerHandleView;
    ...
    iget-object p1, p0, mBackground:Landroid/view/View;
    ...
    iget-object p0, p0, mBackground:Landroid/view/View;
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-direct {p0}, updateDisplayInfo()V
...
.method onDividerRemoved()V
    ...
    iput-object v0, p0, mCallback:Lcom/android/systemui/stackdivider/DividerView$DividerCallbacks;
...
.method protected onFinishInflate()V
    ...
    iput-object v0, p0, mHandle:Lcom/android/systemui/stackdivider/DividerHandleView;
    ...
    iput-object v0, p0, mBackground:Landroid/view/View;
    ...
    iput-object v0, p0, mMinimizedShadow:Lcom/android/systemui/stackdivider/MinimizedDockShadow;
    ...
    iput v0, p0, mDividerWindowWidth:I
    ...
    iput v0, p0, mDividerInsets:I

    iget v0, p0, mDividerWindowWidth:I

    iget v1, p0, mDividerInsets:I
    ...
    iput v0, p0, mLongPressEntraceAnimDuration:I
    ...
    iput-boolean v0, p0, mGrowRecents:Z
    ...
    iget-object p0, p0, mHandleDelegate:Landroid/view/View$AccessibilityDelegate;
...
.method protected onLayout(ZIIII)V
    ...
    iget-object p2, p0, mBackground:Landroid/view/View;
    ...
    iget-object p4, p0, mMinimizedShadow:Lcom/android/systemui/stackdivider/MinimizedDockShadow;
    ...
    iget-object p3, p0, mHandle:Lcom/android/systemui/stackdivider/DividerHandleView;

    invoke-virtual {p3}, Landroid/view/View;->getLeft()I

    move-result p3

    iget-object p4, p0, mHandle:Lcom/android/systemui/stackdivider/DividerHandleView;

    invoke-virtual {p4}, Landroid/view/View;->getTop()I

    move-result p4

    iget-object p5, p0, mHandle:Lcom/android/systemui/stackdivider/DividerHandleView;

    invoke-virtual {p5}, Landroid/view/View;->getRight()I

    move-result p5

    iget-object p0, p0, mHandle:Lcom/android/systemui/stackdivider/DividerHandleView;
...
.method onRecentsDrawn()V
    ...
    invoke-direct {p0}, calculatePositionForInsetBounds()I
    ...
    invoke-virtual/range {v0 .. v5}, stopDragging(ILcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;JLandroid/view/animation/Interpolator;)V
...
.method public onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    invoke-direct {p0, p2}, convertToScreenCoordinates(Landroid/view/MotionEvent;)V
    ...
    iput-boolean v1, p0, mMoving:Z

    :cond_4
    iget-boolean v2, p0, mMoving:Z
    ...
    invoke-direct {p0, p1, p2}, calculatePosition(II)I

    move-result p1

    iget p2, p0, mStartPosition:I

    invoke-virtual {p0, p1, p2, v0}, resizeStackDelayed(IILcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;)V
    ...
    iget-object p2, p0, mVelocityTracker:Landroid/view/VelocityTracker;
    ...
    :goto_1
    invoke-virtual {p0, p1, p2, v0, v1}, stopDragging(IFZZ)V
    ...
    iput p1, p0, mStartY:I

    invoke-virtual {p0, v1, v1}, startDragging(ZZ)Z

    move-result p1

    if-nez p1, :cond_9

    invoke-direct {p0}, stopDragging()V

    :cond_9
    invoke-virtual {p0}, getCurrentPosition()I

    move-result p2

    iput p2, p0, mStartPosition:I
...
.method onUndockingTask()V
    ...
    iput-boolean v0, p0, mExitAnimationRunning:Z

    invoke-virtual {p0}, getCurrentPosition()I

    move-result v0

    iput v0, p0, mExitStartPosition:I

    iget v2, p0, mExitStartPosition:I
    ...
    invoke-virtual/range {v1 .. v10}, stopDragging(ILcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;JJJLandroid/view/animation/Interpolator;)V
...
.method public resizeStack(IILcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;)V
    ...
    :cond_0
    iget v1, v6, mDockSide:I

    iget-object v2, v6, mDockedRect:Landroid/graphics/Rect;

    invoke-virtual {v6, v7, v1, v2}, calculateBoundsForPosition(IILandroid/graphics/Rect;)V

    iget-object v1, v6, mDockedRect:Landroid/graphics/Rect;

    iget-object v2, v6, mLastResizeRect:Landroid/graphics/Rect;
    ...
    iget-boolean v1, v6, mEntranceAnimationRunning:Z
    ...
    :cond_1
    iget-object v1, v6, mBackground:Landroid/view/View;
    ...
    :cond_2
    iget-object v1, v6, mLastResizeRect:Landroid/graphics/Rect;

    iget-object v2, v6, mDockedRect:Landroid/graphics/Rect;

    invoke-virtual {v1, v2}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V

    iget-boolean v1, v6, mHomeStackResizable:Z
    ...
    iget-boolean v1, v6, mIsInMinimizeInteraction:Z

    if-eqz v1, :cond_4

    iget-object v0, v6, mSnapTargetBeforeMinimized:Lcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;

    iget v0, v0, Lcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;->position:I

    iget v1, v6, mDockSide:I

    iget-object v3, v6, mDockedTaskRect:Landroid/graphics/Rect;

    invoke-virtual {v6, v0, v1, v3}, calculateBoundsForPosition(IILandroid/graphics/Rect;)V
    ...
    iget-object v3, v6, mOtherTaskRect:Landroid/graphics/Rect;

    invoke-virtual {v6, v0, v1, v3}, calculateBoundsForPosition(IILandroid/graphics/Rect;)V

    iget v0, v6, mDockSide:I

    if-ne v0, v2, :cond_3

    iget-object v0, v6, mDockedTaskRect:Landroid/graphics/Rect;

    iget-object v1, v6, mStableInsets:Landroid/graphics/Rect;

    iget v1, v1, Landroid/graphics/Rect;->left:I

    iget v2, v6, mDividerSize:I
    ...
    iget-object v2, v6, mDockedTaskRect:Landroid/graphics/Rect;
    ...
    :cond_3
    iget-object v2, v6, mWindowManagerProxy:Lcom/android/systemui/stackdivider/WindowManagerProxy;

    iget-object v3, v6, mDockedRect:Landroid/graphics/Rect;

    iget-object v5, v6, mDockedTaskRect:Landroid/graphics/Rect;

    iget-object v6, v6, mOtherTaskRect:Landroid/graphics/Rect;
    ...
    iget-object v1, v6, mDockedTaskRect:Landroid/graphics/Rect;

    iget-object v2, v6, mStableInsets:Landroid/graphics/Rect;

    iget v2, v2, Landroid/graphics/Rect;->left:I

    iget v3, v6, mDividerSize:I
    ...
    iget-object v2, v6, mOtherTaskRect:Landroid/graphics/Rect;

    invoke-virtual {v6, v0, v1, v2}, calculateBoundsForPosition(IILandroid/graphics/Rect;)V

    iget-object v11, v6, mWindowManagerProxy:Lcom/android/systemui/stackdivider/WindowManagerProxy;

    iget-object v12, v6, mDockedRect:Landroid/graphics/Rect;

    iget-object v13, v6, mDockedTaskRect:Landroid/graphics/Rect;

    const/4 v14, 0x0

    iget-object v15, v6, mOtherTaskRect:Landroid/graphics/Rect;
    ...
    :cond_6
    iget-boolean v1, v6, mExitAnimationRunning:Z
    ...
    iget-object v0, v6, mDockedInsetRect:Landroid/graphics/Rect;

    iget-object v1, v6, mDockedTaskRect:Landroid/graphics/Rect;

    invoke-virtual {v0, v1}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V

    iget v0, v6, mExitStartPosition:I
    ...
    iget-object v0, v6, mOtherInsetRect:Landroid/graphics/Rect;

    iget-object v1, v6, mOtherTaskRect:Landroid/graphics/Rect;

    invoke-virtual {v0, v1}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V

    iget-object v0, v6, mOtherTaskRect:Landroid/graphics/Rect;

    invoke-direct {v6, v0, v7}, applyExitAnimationParallax(Landroid/graphics/Rect;I)V
    ...
    iget-object v14, v6, mDockedInsetRect:Landroid/graphics/Rect;
    ...
    iget-object v2, v6, mOtherRect:Landroid/graphics/Rect;
    ...
    invoke-direct {v6, v0, v1, v8}, restrictDismissingTaskPosition(IILcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;)I

    move-result v5

    invoke-direct {v6, v0, v11, v8}, restrictDismissingTaskPosition(IILcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;)I
    ...
    invoke-virtual {v6, v5, v0, v1}, calculateBoundsForPosition(IILandroid/graphics/Rect;)V

    iget-object v0, v6, mOtherTaskRect:Landroid/graphics/Rect;

    invoke-virtual {v6, v12, v11, v0}, calculateBoundsForPosition(IILandroid/graphics/Rect;)V

    iget-object v0, v6, mTmpRect:Landroid/graphics/Rect;

    iget v1, v6, mDisplayWidth:I

    iget v2, v6, mDisplayHeight:I

    invoke-virtual {v0, v10, v10, v1, v2}, Landroid/graphics/Rect;->set(IIII)V

    iget-object v0, v6, mDockedRect:Landroid/graphics/Rect;

    iget-object v1, v6, mDockedTaskRect:Landroid/graphics/Rect;

    invoke-direct {v6, v0, v1}, alignTopLeft(Landroid/graphics/Rect;Landroid/graphics/Rect;)V

    iget-object v0, v6, mOtherRect:Landroid/graphics/Rect;
    ...
    iget-object v1, v6, mDockedInsetRect:Landroid/graphics/Rect;

    invoke-direct {v6, v0, v1}, alignTopLeft(Landroid/graphics/Rect;Landroid/graphics/Rect;)V

    iget-object v0, v6, mTmpRect:Landroid/graphics/Rect;

    iget-object v1, v6, mOtherInsetRect:Landroid/graphics/Rect;

    invoke-direct {v6, v0, v1}, alignBottomRight(Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    invoke-direct/range {v0 .. v5}, applyDismissingParallax(Landroid/graphics/Rect;ILcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;II)V
    ...
    iget-object v13, v6, mWindowManagerProxy:Lcom/android/systemui/stackdivider/WindowManagerProxy;

    iget-object v14, v6, mDockedRect:Landroid/graphics/Rect;

    iget-object v15, v6, mDockedTaskRect:Landroid/graphics/Rect;

    iget-object v0, v6, mDockedInsetRect:Landroid/graphics/Rect;

    iget-object v1, v6, mOtherTaskRect:Landroid/graphics/Rect;

    iget-object v2, v6, mOtherInsetRect:Landroid/graphics/Rect;
    ...
    :cond_a
    iget-object v0, v6, mWindowManagerProxy:Lcom/android/systemui/stackdivider/WindowManagerProxy;
    ...
    :goto_1
    invoke-virtual/range {p0 .. p0}, getSnapAlgorithm()Lcom/android/internal/policy/DividerSnapAlgorithm;
    ...
    invoke-direct {v6, v7, v0}, getDimFraction(ILcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;)F
    ...
    :cond_b
    invoke-direct {v6, v0}, getWindowingModeForDismissTarget(Lcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;)I
...
.method public resizeStackDelayed(IILcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;)V
    ...
    iget-object p2, p0, mSfChoreographer:Lcom/android/internal/view/SurfaceFlingerVsyncChoreographer;
...
.method public setAdjustedForIme(Z)V
    ...
    :cond_2
    :goto_1
    iput-boolean p1, p0, mAdjustedForIme:Z
...
.method public setAdjustedForIme(ZJ)V
    ...
    sget-object v1, IME_ADJUST_INTERPOLATOR:Landroid/view/animation/Interpolator;
    ...
    iget-object v1, p0, mResetBackgroundRunnable:Ljava/lang/Runnable;
...
.method public setMinimizedDockStack(ZJZ)V
    ...
    iput-boolean p4, p0, mHomeStackResizable:Z
    ...
    iget p4, p0, mDockSide:I

    const/4 v3, 0x2

    if-ne p4, v3, :cond_3

    iget-object p4, p0, mBackground:Landroid/view/View;
    ...
    :cond_7
    :goto_3
    iput-boolean p1, p0, mDockedStackMinimized:Z

    goto :goto_6

    :cond_8
    iget-boolean p4, p0, mDockedStackMinimized:Z
    ...
    iput-object p4, p0, mMinimizedSnapAlgorithm:Lcom/android/internal/policy/DividerSnapAlgorithm;
    ...
    iget-object p4, p0, mSnapTargetBeforeMinimized:Lcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;
    ...
    iget-object p4, p0, mMinimizedSnapAlgorithm:Lcom/android/internal/policy/DividerSnapAlgorithm;
    ...
    invoke-virtual/range {v0 .. v7}, stopDragging(ILcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;JLandroid/view/animation/Interpolator;J)V

    const/4 p4, 0x0

    invoke-virtual {p0, p4, p2, p3}, setAdjustedForIme(ZJ)V
    ...
    iget-object p4, p0, mResetBackgroundRunnable:Ljava/lang/Runnable;
...
.method public setMinimizedDockStack(ZZ)V
    ...
    iput-boolean p2, p0, mHomeStackResizable:Z
    ...
    iget-object v2, p0, mBackground:Landroid/view/View;
    ...
    :cond_4
    :goto_1
    iget-object v2, p0, mMinimizedShadow:Lcom/android/systemui/stackdivider/MinimizedDockShadow;
    ...
    iget-object p2, p0, mHandle:Lcom/android/systemui/stackdivider/DividerHandleView;
    ...
    :cond_7
    iget-boolean p2, p0, mDockedStackMinimized:Z

    if-eq p2, p1, :cond_b

    iput-boolean p1, p0, mDockedStackMinimized:Z

    iget p2, p0, mDisplayRotation:I
    ...
    iput-object p2, p0, mMinimizedSnapAlgorithm:Lcom/android/internal/policy/DividerSnapAlgorithm;

    invoke-direct {p0}, initializeSnapAlgorithm()V

    :goto_4
    iget-boolean p2, p0, mIsInMinimizeInteraction:Z

    if-ne p2, p1, :cond_9

    iget-object p2, p0, mCurrentAnimator:Landroid/animation/ValueAnimator;
    ...
    :cond_a
    iget-object p1, p0, mSnapTargetBeforeMinimized:Lcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;

    invoke-direct {p0, p1}, resizeStack(Lcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;)V

    const/4 p1, 0x0

    iput-boolean p1, p0, mIsInMinimizeInteraction:Z
...
.method public startDragging(ZZ)Z
    ...
    iget-object p2, p0, mWindowManager:Lcom/android/systemui/stackdivider/DividerWindowManager;

    invoke-virtual {p2, p1}, Lcom/android/systemui/stackdivider/DividerWindowManager;->setSlippery(Z)V

    invoke-direct {p0}, liftBackground()V

    :cond_2
    iget-object p2, p0, mCallback:Lcom/android/systemui/stackdivider/DividerView$DividerCallbacks;
...
.method public stopDragging(IFZZ)V
    ...
    invoke-direct {p0, p1, p2, p3, p4}, fling(IFZZ)V

    iget-object p1, p0, mWindowManager:Lcom/android/systemui/stackdivider/DividerWindowManager;
...
.method public stopDragging(ILcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;JJJLandroid/view/animation/Interpolator;)V
    ...
    invoke-direct/range {p0 .. p9}, flingTo(ILcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;JJJLandroid/view/animation/Interpolator;)V
...
.method public stopDragging(ILcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;JLandroid/view/animation/Interpolator;)V
    ...
    invoke-virtual/range {v0 .. v9}, stopDragging(ILcom/android/internal/policy/DividerSnapAlgorithm$SnapTarget;JJJLandroid/view/animation/Interpolator;)V
