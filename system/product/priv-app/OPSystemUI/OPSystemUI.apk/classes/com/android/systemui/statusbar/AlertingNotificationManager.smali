...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mClock:Lcom/android/systemui/statusbar/AlertingNotificationManager$Clock;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, mAlertEntries:Landroid/util/ArrayMap;

    new-instance v0, Landroid/util/ArraySet;

    invoke-direct {v0}, Landroid/util/ArraySet;-><init>()V

    iput-object v0, p0, mExtendedLifetimeAlertEntries:Landroid/util/ArraySet;
...
.method protected final addAlertEntry(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V
    ...
    invoke-virtual {p0}, createAlertEntry()Lcom/android/systemui/statusbar/AlertingNotificationManager$AlertEntry;
    ...
    iget-object v1, p0, mAlertEntries:Landroid/util/ArrayMap;
    ...
    invoke-virtual {p0, v0}, onAlertEntryAdded(Lcom/android/systemui/statusbar/AlertingNotificationManager$AlertEntry;)V
...
.method protected canRemoveImmediately(Ljava/lang/String;)Z
    ...
    iget-object p0, p0, mAlertEntries:Landroid/util/ArrayMap;
...
.method public releaseAllImmediately()V
    ...
    invoke-virtual {p0, v1}, removeAlertEntry(Ljava/lang/String;)V
...
.method protected final removeAlertEntry(Ljava/lang/String;)V
    ...
    iget-object v0, p0, mAlertEntries:Landroid/util/ArrayMap;
    ...
    iget-object v2, p0, mAlertEntries:Landroid/util/ArrayMap;

    invoke-virtual {v2, p1}, Landroid/util/ArrayMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    invoke-virtual {p0, v0}, onAlertEntryRemoved(Lcom/android/systemui/statusbar/AlertingNotificationManager$AlertEntry;)V
    ...
    iget-object v0, p0, mExtendedLifetimeAlertEntries:Landroid/util/ArraySet;
    ...
    iget-object v0, p0, mNotificationLifetimeFinishedCallback:Lcom/android/systemui/statusbar/NotificationLifetimeExtender$NotificationSafeToRemoveCallback;
    ...
    :cond_1
    iget-object p0, p0, mExtendedLifetimeAlertEntries:Landroid/util/ArraySet;
...
.method public removeNotification(Ljava/lang/String;Z)Z
    ...
    invoke-virtual {p0, p1}, canRemoveImmediately(Ljava/lang/String;)Z
    ...
    :cond_3
    :goto_0
    invoke-virtual {p0, p1}, removeAlertEntry(Ljava/lang/String;)V
...
.method public setShouldManageLifetime(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;Z)V
    ...
    iget-object p2, p0, mExtendedLifetimeAlertEntries:Landroid/util/ArraySet;
...
.method public showNotification(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V
    ...
    :cond_0
    invoke-virtual {p0, p1}, addAlertEntry(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V

    iget-object v0, p1, Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;->key:Ljava/lang/String;

    const/4 v1, 0x1

    invoke-virtual {p0, v0, v1}, updateNotification(Ljava/lang/String;Z)V
