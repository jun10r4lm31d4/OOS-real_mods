...
.method static constructor <clinit>()V
    ...
    sget-wide v0, DEFAULT_DURATION:J

    const-wide/16 v2, 0x3

    div-long/2addr v0, v2

    sput-wide v0, SHORT_DURATION:J
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, v0}, addTrafficView(I)Landroid/widget/ImageView;
    ...
    iput v0, p0, mWideOverlayIconStartPadding:I
    ...
    iput v0, p0, mSignalIndicatorToIconFrameSpacing:I
    ...
    iput p1, p0, mSignalIndicatorShiftDownAmount:I
...
.method private layoutIndicator(Landroid/view/View;)V
    ...
    iget v1, p0, mSignalIndicatorToIconFrameSpacing:I
    ...
    iget v3, p0, mSignalIndicatorShiftDownAmount:I
    ...
    iget p0, p0, mSignalIndicatorShiftDownAmount:I
...
.method private setVisibility(Landroid/view/View;ZZ)V
    ...
    sget-wide p2, SHORT_DURATION:J

    goto :goto_1

    :cond_2
    sget-wide p2, DEFAULT_DURATION:J
...
.method protected createIcon()Landroid/view/View;
    ...
    iput-object v0, p0, mIconFrame:Landroid/widget/FrameLayout;

    iget-object v0, p0, Landroid/view/ViewGroup;->mContext:Landroid/content/Context;

    invoke-virtual {p0, v0}, createSlashImageView(Landroid/content/Context;)Lcom/android/systemui/qs/tileimpl/SlashImageView;

    move-result-object v0

    iput-object v0, p0, mSignal:Landroid/widget/ImageView;

    iget-object v0, p0, mIconFrame:Landroid/widget/FrameLayout;

    iget-object v1, p0, mSignal:Landroid/widget/ImageView;
    ...
    iput-object v0, p0, mOverlay:Landroid/widget/ImageView;

    iget-object v0, p0, mIconFrame:Landroid/widget/FrameLayout;

    iget-object v1, p0, mOverlay:Landroid/widget/ImageView;
...
.method protected onLayout(ZIIII)V
    ...
    iget-object p1, p0, mIn:Landroid/widget/ImageView;

    invoke-direct {p0, p1}, layoutIndicator(Landroid/view/View;)V

    iget-object p1, p0, mOut:Landroid/widget/ImageView;
...
.method protected onMeasure(II)V
    ...
    iget-object p1, p0, mIconFrame:Landroid/widget/FrameLayout;
    ...
    iget-object v0, p0, mIn:Landroid/widget/ImageView;

    invoke-virtual {v0, p2, p1}, Landroid/widget/ImageView;->measure(II)V

    iget-object p0, p0, mOut:Landroid/widget/ImageView;
...
.method public setIcon(Lcom/android/systemui/plugins/qs/QSTile$State;Z)V
    ...
    iget v3, p0, mWideOverlayIconStartPadding:I
    ...
    iget-object v1, p0, mIn:Landroid/widget/ImageView;

    invoke-virtual {v1, p1}, Landroid/widget/ImageView;->setColorFilter(I)V

    iget-object v1, p0, mOut:Landroid/widget/ImageView;
    ...
    invoke-direct {p0, p1, v2, p2}, setVisibility(Landroid/view/View;ZZ)V
