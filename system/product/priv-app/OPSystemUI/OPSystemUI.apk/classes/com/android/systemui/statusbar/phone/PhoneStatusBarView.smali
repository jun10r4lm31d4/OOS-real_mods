...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-boolean p2, p0, mIsFullyOpenedPanel:Z
    ...
    iput-object v0, p0, mHideExpandedRunnable:Ljava/lang/Runnable;

    iput p2, p0, mCutoutSideNudge:I

    const-string p2, ""

    iput-object p2, p0, mTopActivityPackage:Ljava/lang/String;
    ...
    iput-object p2, p0, mBarTransitions:Lcom/android/systemui/statusbar/phone/PhoneStatusBarTransitions;
...
.method private checkFullScreenMode(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1}, isFullAndNotchEnabled(Ljava/lang/String;)Z

    move-result p0

    sget-boolean p1, mIsFullScreenMode:Z

    if-eq p0, p1, :cond_0

    sput-boolean p0, mIsFullScreenMode:Z
...
.method private getCompatMode(Landroid/app/AppOpsManager;Ljava/lang/String;I)I
    ...
    iget-object p0, p0, mBar:Lcom/android/systemui/statusbar/phone/StatusBar;
...
.method private isFullAndNotchEnabled(Ljava/lang/String;)Z
    ...
    :cond_0
    iget-object v1, p0, mBar:Lcom/android/systemui/statusbar/phone/StatusBar;
    ...
    invoke-direct {p0, v4, p1, v3}, getCompatMode(Landroid/app/AppOpsManager;Ljava/lang/String;I)I
...
.method private updateCutoutLocation(Landroid/util/Pair;)V
    ...
    :cond_0
    iget-object v0, p0, mDisplayCutout:Landroid/view/DisplayCutout;
    ...
    :cond_1
    iget-object p1, p0, mCenterIconSpace:Landroid/view/View;
    ...
    iget-object v2, p0, mDisplayCutout:Landroid/view/DisplayCutout;
    ...
    iget-object p0, p0, mCutoutSpace:Landroid/view/View;
...
.method private updateLayoutForCutout()V
    ...
    iget-object v1, p0, mDisplayCutout:Landroid/view/DisplayCutout;

    invoke-virtual {p0}, Landroid/widget/FrameLayout;->getDisplay()Landroid/view/Display;

    move-result-object v2

    invoke-static {v0, v1, v2}, cornerCutoutMargins(Landroid/content/Context;Landroid/view/DisplayCutout;Landroid/view/Display;)Landroid/util/Pair;

    move-result-object v0

    invoke-direct {p0, v0}, updateCutoutLocation(Landroid/util/Pair;)V

    invoke-direct {p0, v0}, updateSafeInsets(Landroid/util/Pair;)V
...
.method private updateOrientationAndCutout(I)Z
    ...
    iput-object p1, p0, mDisplayCutout:Landroid/view/DisplayCutout;
...
.method public getBarTransitions()Lcom/android/systemui/statusbar/phone/BarTransitions;
    ...
    iget-object p0, p0, mBarTransitions:Lcom/android/systemui/statusbar/phone/PhoneStatusBarTransitions;
...
.method public onApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    invoke-direct {p0, v0}, updateOrientationAndCutout(I)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-direct {p0}, updateLayoutForCutout()V
...
.method protected onAttachedToWindow()V
    ...
    iget-object v1, p0, mBattery:Lcom/android/systemui/plugins/DarkIconDispatcher$DarkReceiver;
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-direct {p0, p1}, updateOrientationAndCutout(I)Z
...
.method protected onDetachedFromWindow()V
    ...
    iput-object v0, p0, mDisplayCutout:Landroid/view/DisplayCutout;
...
.method public onFinishInflate()V
    ...
    iget-object v0, p0, mBarTransitions:Lcom/android/systemui/statusbar/phone/PhoneStatusBarTransitions;
    ...
    iput-object v0, p0, mBattery:Lcom/android/systemui/plugins/DarkIconDispatcher$DarkReceiver;
    ...
    iput-object v0, p0, mCenterIconSpace:Landroid/view/View;
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, mBar:Lcom/android/systemui/statusbar/phone/StatusBar;
...
.method public onPanelCollapsed()V
    ...
    iget-object v0, p0, mHideExpandedRunnable:Ljava/lang/Runnable;

    invoke-virtual {p0, v0}, Landroid/widget/FrameLayout;->post(Ljava/lang/Runnable;)Z

    const/4 v0, 0x0

    iput-boolean v0, p0, mIsFullyOpenedPanel:Z
...
.method public onPanelFullyOpened()V
    ...
    iget-boolean v0, p0, mIsFullyOpenedPanel:Z
...
.method public onTrackingStarted()V
    ...
    invoke-virtual {p0}, removePendingHideExpandedRunnables()V
...
.method public panelExpansionChanged(FZ)V
    ...
    invoke-direct {p0}, updateScrimFraction()V
    ...
    :cond_0
    iget-object v2, p0, mBar:Lcom/android/systemui/statusbar/phone/StatusBar;
    ...
    :cond_3
    iget-object p2, p0, mBar:Lcom/android/systemui/statusbar/phone/StatusBar;
...
.method public panelScrimMinFractionChanged(F)V
    ...
    iget v0, p0, mMinFraction:F

    cmpl-float v0, v0, p1

    if-eqz v0, :cond_0

    iput p1, p0, mMinFraction:F
...
.method public updateTopPackage(Ljava/lang/String;)V
    ...
    iget-object v0, p0, mTopActivityPackage:Ljava/lang/String;
    ...
    :cond_3
    iput-object p1, p0, mTopActivityPackage:Ljava/lang/String;

    invoke-direct {p0, p1}, checkFullScreenMode(Ljava/lang/String;)Z
