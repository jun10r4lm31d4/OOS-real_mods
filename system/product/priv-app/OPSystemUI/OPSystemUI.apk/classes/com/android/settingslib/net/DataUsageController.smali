...
.method static constructor <clinit>()V
    ...
    sput-object v0, PERIOD_BUILDER:Ljava/lang/StringBuilder;

    new-instance v0, Ljava/util/Formatter;

    sget-object v1, PERIOD_BUILDER:Ljava/lang/StringBuilder;
    ...
    sput-object v0, PERIOD_FORMATTER:Ljava/util/Formatter;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mStatsService:Landroid/net/INetworkStatsService;
    ...
    iput-object p1, p0, mNetworkStatsManager:Landroid/app/usage/NetworkStatsManager;

    const/4 p1, -0x1

    iput p1, p0, mSubscriptionId:I
...
.method private formatDateRange(JJ)Ljava/lang/String;
    ...
    sget-object v0, PERIOD_BUILDER:Ljava/lang/StringBuilder;
    ...
    sget-object v4, PERIOD_FORMATTER:Ljava/util/Formatter;
...
.method private getUsageLevel(Landroid/net/NetworkTemplate;JJ)J
    ...
    :try_start_0
    iget-object v1, p0, mNetworkStatsManager:Landroid/app/usage/NetworkStatsManager;
...
.method public getDataUsageInfo()Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;
    ...
    invoke-virtual {p0, v0}, getDataUsageInfo(Landroid/net/NetworkTemplate;)Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;
...
.method public getDataUsageInfo(Landroid/net/NetworkTemplate;)Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;
    ...
    invoke-direct {p0, p1}, findNetworkPolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
    ...
    invoke-direct/range {v5 .. v10}, getUsageLevel(Landroid/net/NetworkTemplate;JJ)J
    ...
    invoke-direct {p0, p1}, warn(Ljava/lang/String;)Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;
    ...
    invoke-direct {p0, v2, v3, v11, v12}, formatDateRange(JJ)Ljava/lang/String;
    ...
    :cond_5
    invoke-virtual {p0}, getDefaultWarningLevel()J
    ...
    :goto_4
    iget-object p0, p0, mNetworkController:Lcom/android/settingslib/net/DataUsageController$NetworkNameProvider;
...
.method public setCallback(Lcom/android/settingslib/net/DataUsageController$Callback;)V
    ...
    iput-object p1, p0, mCallback:Lcom/android/settingslib/net/DataUsageController$Callback;
...
.method public setMobileDataEnabled(Z)V
    ...
    iget-object p0, p0, mCallback:Lcom/android/settingslib/net/DataUsageController$Callback;
...
.method public setNetworkController(Lcom/android/settingslib/net/DataUsageController$NetworkNameProvider;)V
    ...
    iput-object p1, p0, mNetworkController:Lcom/android/settingslib/net/DataUsageController$NetworkNameProvider;
