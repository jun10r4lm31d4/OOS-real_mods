...
.method constructor <init>(Landroid/content/Context;Lcom/android/systemui/util/InjectionInflationController;Lcom/android/systemui/shared/plugins/PluginManager;Lcom/android/systemui/colorextraction/SysuiColorExtractor;Landroid/content/ContentResolver;Lcom/android/systemui/settings/CurrentUserObservable;Lcom/android/keyguard/clock/SettingsWrapper;Lcom/android/systemui/dock/DockManager;)V
    ...
    iput-object v0, p0, mBuiltinClocks:Ljava/util/List;
    ...
    iput-object v0, p0, mCurrentUserObserver:Landroidx/lifecycle/Observer;
    ...
    iput-object p3, p0, mPluginManager:Lcom/android/systemui/shared/plugins/PluginManager;

    iput-object p5, p0, mContentResolver:Landroid/content/ContentResolver;

    iput-object p7, p0, mSettingsWrapper:Lcom/android/keyguard/clock/SettingsWrapper;

    iput-object p6, p0, mCurrentUserObservable:Lcom/android/systemui/settings/CurrentUserObservable;

    iput-object p8, p0, mDockManager:Lcom/android/systemui/dock/DockManager;
    ...
    iput-object p3, p0, mPreviewClocks:Lcom/android/keyguard/clock/ClockManager$AvailableClocks;
    ...
    invoke-direct {p0, p2}, addBuiltinClock(Ljava/util/function/Supplier;)V
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/util/InjectionInflationController;Lcom/android/systemui/shared/plugins/PluginManager;Lcom/android/systemui/colorextraction/SysuiColorExtractor;Lcom/android/systemui/dock/DockManager;)V
    ...
    invoke-direct/range {v0 .. v8}, <init>(Landroid/content/Context;Lcom/android/systemui/util/InjectionInflationController;Lcom/android/systemui/shared/plugins/PluginManager;Lcom/android/systemui/colorextraction/SysuiColorExtractor;Landroid/content/ContentResolver;Lcom/android/systemui/settings/CurrentUserObservable;Lcom/android/keyguard/clock/SettingsWrapper;Lcom/android/systemui/dock/DockManager;)V
...
.method static synthetic access$000(Lcom/android/keyguard/clock/ClockManager;)Lcom/android/systemui/settings/CurrentUserObservable;
    ...
    iget-object p0, p0, mCurrentUserObservable:Lcom/android/systemui/settings/CurrentUserObservable;
...
.method static synthetic access$400(Lcom/android/keyguard/clock/ClockManager;)Lcom/android/keyguard/clock/SettingsWrapper;
    ...
    iget-object p0, p0, mSettingsWrapper:Lcom/android/keyguard/clock/SettingsWrapper;
...
.method private addBuiltinClock(Ljava/util/function/Supplier;)V
    ...
    iget-object v1, p0, mPreviewClocks:Lcom/android/keyguard/clock/ClockManager$AvailableClocks;
    ...
    iget-object p0, p0, mBuiltinClocks:Ljava/util/List;
...
.method private reload()V
    ...
    iget-object v0, p0, mPreviewClocks:Lcom/android/keyguard/clock/ClockManager$AvailableClocks;

    invoke-virtual {v0}, Lcom/android/keyguard/clock/ClockManager$AvailableClocks;->reload()V

    iget-object p0, p0, mListeners:Ljava/util/Map;
...
.method getClockInfos()Ljava/util/List;
    ...
    iget-object p0, p0, mPreviewClocks:Lcom/android/keyguard/clock/ClockManager$AvailableClocks;
...
.method getContentObserver()Landroid/database/ContentObserver;
    ...
    iget-object p0, p0, mContentObserver:Landroid/database/ContentObserver;
...
.method isDocked()Z
    ...
    iget-boolean p0, p0, mIsDocked:Z
