...
.method public constructor <init>(ILcom/android/systemui/SwipeHelper$Callback;Landroid/content/Context;)V
    ...
    iput v0, p0, mMinSwipeProgress:F

    const/high16 v1, 0x3f800000    # 1.0f

    iput v1, p0, mMaxSwipeProgress:F

    iput v0, p0, mTranslation:F

    const/4 v0, 0x2

    new-array v0, v0, [I

    iput-object v0, p0, mTmpPos:[I

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, mDismissPendingMap:Landroid/util/ArrayMap;

    iput-object p3, p0, mContext:Landroid/content/Context;

    iput-object p2, p0, mCallback:Lcom/android/systemui/SwipeHelper$Callback;
    ...
    iput-wide p1, p0, mLongPressTimeout:J
    ...
    iput p2, p0, mFalsingThreshold:I
    ...
    iput-boolean p1, p0, mFadeDependingOnAmountSwiped:Z
    ...
    invoke-virtual {p0}, getMaxEscapeAnimDuration()J
    ...
    iput-object p1, p0, mFlingAnimationUtils:Lcom/android/systemui/statusbar/FlingAnimationUtils;
...
.method static synthetic access$000(Lcom/android/systemui/SwipeHelper;)Landroid/view/View;
    ...
    iget-object p0, p0, mCurrView:Landroid/view/View;
...
.method static synthetic access$100(Lcom/android/systemui/SwipeHelper;)Z
    ...
    iget-boolean p0, p0, mLongPressSent:Z
...
.method static synthetic access$102(Lcom/android/systemui/SwipeHelper;Z)Z
    ...
    iput-boolean p1, p0, mLongPressSent:Z
...
.method static synthetic access$300(Lcom/android/systemui/SwipeHelper;Landroid/view/View;Z)V
    ...
    invoke-direct {p0, p1, p2}, updateSwipeProgressFromOffset(Landroid/view/View;Z)V
...
.method static synthetic access$400(Lcom/android/systemui/SwipeHelper;)Landroid/util/ArrayMap;
    ...
    iget-object p0, p0, mDismissPendingMap:Landroid/util/ArrayMap;
...
.method static synthetic access$500(Lcom/android/systemui/SwipeHelper;)Lcom/android/systemui/SwipeHelper$Callback;
    ...
    iget-object p0, p0, mCallback:Lcom/android/systemui/SwipeHelper$Callback;
...
.method static synthetic access$600(Lcom/android/systemui/SwipeHelper;)Z
    ...
    iget-boolean p0, p0, mDisableHwLayers:Z
...
.method static synthetic access$702(Lcom/android/systemui/SwipeHelper;Z)Z
    ...
    iput-boolean p1, p0, mSnappingChild:Z
...
.method private getFalsingThreshold()I
    ...
    iget-object v0, p0, mCallback:Lcom/android/systemui/SwipeHelper$Callback;

    invoke-interface {v0}, Lcom/android/systemui/SwipeHelper$Callback;->getFalsingThresholdFactor()F

    move-result v0

    iget p0, p0, mFalsingThreshold:I
...
.method private getSwipeAlpha(F)F
    ...
    iget-boolean p0, p0, mFadeDependingOnAmountSwiped:Z
...
.method private getSwipeProgressForOffset(Landroid/view/View;F)F
    ...
    invoke-virtual {p0, p1}, getSize(Landroid/view/View;)F
    ...
    iget p2, p0, mMinSwipeProgress:F

    invoke-static {p2, p1}, Ljava/lang/Math;->max(FF)F

    move-result p1

    iget p0, p0, mMaxSwipeProgress:F
...
.method public static invalidateGlobalRegion(Landroid/view/View;)V
    ...
    invoke-static {p0, v0}, invalidateGlobalRegion(Landroid/view/View;Landroid/graphics/RectF;)V
...
.method private snapChildInstantly(Landroid/view/View;)V
    ...
    invoke-virtual {p0, p1, v1}, setTranslation(Landroid/view/View;F)V

    invoke-direct {p0, p1, v0}, updateSwipeProgressFromOffset(Landroid/view/View;Z)V
...
.method private updateSwipeProgressFromOffset(Landroid/view/View;Z)V
    ...
    invoke-virtual {p0, p1}, getTranslation(Landroid/view/View;)F

    move-result v0

    invoke-direct {p0, p1, p2, v0}, updateSwipeProgressFromOffset(Landroid/view/View;ZF)V
...
.method private updateSwipeProgressFromOffset(Landroid/view/View;ZF)V
    ...
    invoke-direct {p0, p1, p3}, getSwipeProgressForOffset(Landroid/view/View;F)F
    ...
    iget-boolean p2, p0, mDisableHwLayers:Z
    ...
    :cond_1
    :goto_0
    invoke-direct {p0, p3}, getSwipeAlpha(F)F
    ...
    :cond_2
    invoke-static {p1}, invalidateGlobalRegion(Landroid/view/View;)V
...
.method public cancelLongPress()V
    ...
    iget-object v0, p0, mWatchLongPress:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mWatchLongPress:Ljava/lang/Runnable;
...
.method public dismissChild(Landroid/view/View;FLjava/lang/Runnable;JZJZ)V
    ...
    iget-object v2, v0, mCallback:Lcom/android/systemui/SwipeHelper$Callback;
    ...
    invoke-virtual {p0}, getEscapeVelocity()F
    ...
    :goto_5
    iget-boolean v4, v0, mDisableHwLayers:Z
    ...
    invoke-virtual {p0, p1, v5, v4}, getViewTranslationAnimator(Landroid/view/View;FLandroid/animation/ValueAnimator$AnimatorUpdateListener;)Landroid/animation/Animator;
    ...
    :cond_e
    iget-object v2, v0, mFlingAnimationUtils:Lcom/android/systemui/statusbar/FlingAnimationUtils;
    ...
    invoke-virtual {p0, p1, v13}, prepareDismissAnimation(Landroid/view/View;Landroid/animation/Animator;)V

    iget-object v0, v0, mDismissPendingMap:Landroid/util/ArrayMap;
...
.method public dismissChild(Landroid/view/View;FZ)V
    ...
    invoke-virtual/range {v0 .. v9}, dismissChild(Landroid/view/View;FLjava/lang/Runnable;JZJZ)V
...
.method protected getEscapeVelocity()F
    ...
    invoke-virtual {p0}, getUnscaledEscapeVelocity()F
...
.method protected getViewTranslationAnimator(Landroid/view/View;FLandroid/animation/ValueAnimator$AnimatorUpdateListener;)Landroid/animation/Animator;
    ...
    invoke-virtual {p0, p1, p2}, createTranslationAnimation(Landroid/view/View;F)Landroid/animation/ObjectAnimator;
...
.method public isDismissGesture(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, mCurrView:Landroid/view/View;

    invoke-virtual {p0, v0}, getTranslation(Landroid/view/View;)F
    ...
    invoke-virtual {p0, p1}, isFalseGesture(Landroid/view/MotionEvent;)Z

    move-result p1

    if-nez p1, :cond_2

    invoke-virtual {p0}, swipedFastEnough()Z

    move-result p1

    if-nez p1, :cond_0

    invoke-virtual {p0}, swipedFarEnough()Z
    ...
    :cond_0
    iget-object p1, p0, mCallback:Lcom/android/systemui/SwipeHelper$Callback;
...
.method public isFalseGesture(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean p0, p0, mTouchAboveFalsingThreshold:Z
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v1, p0, mCurrView:Landroid/view/View;
    ...
    iput-boolean v0, p0, mMenuRowIntercepting:Z
    ...
    iget-boolean v0, p0, mLongPressSent:Z
    ...
    invoke-direct {p0, p1}, getPos(Landroid/view/MotionEvent;)F

    move-result v0

    invoke-direct {p0, p1}, getPerpendicularPos(Landroid/view/MotionEvent;)F

    move-result v3

    iget v4, p0, mInitialTouchPos:F

    sub-float/2addr v0, v4

    iget v4, p0, mPerpendicularInitialTouchPos:F
    ...
    iget-object v3, p0, mCurrView:Landroid/view/View;
    ...
    iput-boolean v1, p0, mDragging:Z

    invoke-direct {p0, p1}, getPos(Landroid/view/MotionEvent;)F

    move-result p1

    iput p1, p0, mInitialTouchPos:F

    iget-object p1, p0, mCurrView:Landroid/view/View;
    ...
    :cond_3
    iget-boolean p1, p0, mDragging:Z

    if-nez p1, :cond_5

    iget-boolean p1, p0, mLongPressSent:Z

    if-nez p1, :cond_5

    iget-boolean p1, p0, mMenuRowIntercepting:Z
    ...
    iput-object v0, p0, mCurrView:Landroid/view/View;

    iput-boolean v2, p0, mLongPressSent:Z

    iput-boolean v2, p0, mMenuRowIntercepting:Z
    ...
    iput-boolean v2, p0, mSnappingChild:Z
    ...
    invoke-virtual {p0, v0, p1}, onDownUpdate(Landroid/view/View;Landroid/view/MotionEvent;)V
    ...
    iput-boolean v0, p0, mCanCurrViewBeDimissed:Z
    ...
    iput v0, p0, mInitialTouchPos:F

    invoke-direct {p0, p1}, getPerpendicularPos(Landroid/view/MotionEvent;)F

    move-result v0

    iput v0, p0, mPerpendicularInitialTouchPos:F
    ...
    iget-wide v3, p0, mLongPressTimeout:J
    ...
    iget-boolean p0, p0, mMenuRowIntercepting:Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v0, p0, mMenuRowIntercepting:Z
    ...
    :cond_4
    iget-object v5, p0, mCallback:Lcom/android/systemui/SwipeHelper$Callback;

    iget-object v6, p0, mCurrView:Landroid/view/View;
    ...
    iget-object v2, p0, mCurrView:Landroid/view/View;

    invoke-virtual {p0, v2}, getSize(Landroid/view/View;)F
    ...
    :cond_7
    iget-object v3, p0, mCallback:Lcom/android/systemui/SwipeHelper$Callback;
    ...
    invoke-virtual {p0, v2, v3}, setTranslation(Landroid/view/View;F)V

    iget-object v2, p0, mCurrView:Landroid/view/View;

    iget-boolean v3, p0, mCanCurrViewBeDimissed:Z

    invoke-direct {p0, v2, v3}, updateSwipeProgressFromOffset(Landroid/view/View;Z)V
    ...
    invoke-virtual {p0, v2, p1, v3, v0}, onMoveUpdate(Landroid/view/View;Landroid/view/MotionEvent;FF)V
    ...
    invoke-direct {p0}, getMaxVelocity()F
    ...
    invoke-direct {p0, v0}, getVelocity(Landroid/view/VelocityTracker;)F

    move-result v0

    iget-object v4, p0, mCurrView:Landroid/view/View;

    invoke-virtual {p0, v4}, getTranslation(Landroid/view/View;)F

    move-result v5

    invoke-virtual {p0, p1, v4, v0, v5}, handleUpEvent(Landroid/view/MotionEvent;Landroid/view/View;FF)Z

    move-result v4

    if-nez v4, :cond_c

    invoke-virtual {p0, p1}, isDismissGesture(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p0, p1, v0, v3}, dismissChild(Landroid/view/View;FZ)V
    ...
    invoke-virtual {p0, p1, v3, v0}, snapChild(Landroid/view/View;FF)V

    :goto_1
    const/4 p1, 0x0

    iput-object p1, p0, mCurrView:Landroid/view/View;
...
.method public onTranslationUpdate(Landroid/view/View;FZ)V
    ...
    invoke-direct {p0, p1, p3, p2}, updateSwipeProgressFromOffset(Landroid/view/View;ZF)V
...
.method public snapChild(Landroid/view/View;FF)V
    ...
    invoke-virtual {p0, p1, p2, v1}, getViewTranslationAnimator(Landroid/view/View;FLandroid/animation/ValueAnimator$AnimatorUpdateListener;)Landroid/animation/Animator;
    ...
    invoke-virtual {p0, p1, v1}, prepareSnapBackAnimation(Landroid/view/View;Landroid/animation/Animator;)V

    const/4 v0, 0x1

    iput-boolean v0, p0, mSnappingChild:Z
...
.method public snapChildIfNeeded(Landroid/view/View;ZF)V
    ...
    :cond_0
    iget-boolean v0, p0, mSnappingChild:Z
    ...
    iget-object v1, p0, mDismissPendingMap:Landroid/util/ArrayMap;
    ...
    invoke-virtual {p0, p1, p3, v3}, snapChild(Landroid/view/View;FF)V

    goto :goto_1

    :cond_5
    invoke-direct {p0, p1}, snapChildInstantly(Landroid/view/View;)V
...
.method protected swipedFarEnough()Z
    ...
    invoke-virtual {p0, v1}, getSize(Landroid/view/View;)F
...
.method protected swipedFastEnough()Z
    ...
    invoke-virtual {p0, v1}, getTranslation(Landroid/view/View;)F
