...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/plugins/qs/QSIconView;Z)V
    ...
    iput-object v0, p0, mHandler:Lcom/android/systemui/qs/tileimpl/QSTileBaseView$H;

    const/4 v0, 0x2

    new-array v0, v0, [I

    iput-object v0, p0, mLocInScreen:[I

    const/4 v0, 0x1

    iput-boolean v0, p0, mShowRippleEffect:Z
    ...
    iput-object v1, p0, mIconFrame:Landroid/widget/FrameLayout;
    ...
    iget-object v2, p0, mIconFrame:Landroid/widget/FrameLayout;
    ...
    iput-object v1, p0, mBg:Landroid/widget/ImageView;
    ...
    iget-object v4, p0, mBg:Landroid/widget/ImageView;
    ...
    iget-object v3, p0, mIconFrame:Landroid/widget/FrameLayout;

    iget-object v5, p0, mBg:Landroid/widget/ImageView;

    invoke-virtual {v3, v5, v1}, Landroid/widget/FrameLayout;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    iget-object v3, p0, mBg:Landroid/widget/ImageView;

    invoke-virtual {v3, v1}, Landroid/widget/ImageView;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    iput-object p2, p0, mIcon:Lcom/android/systemui/plugins/qs/QSIconView;
    ...
    iget-object v1, p0, mIconFrame:Landroid/widget/FrameLayout;

    iget-object v3, p0, mIcon:Lcom/android/systemui/plugins/qs/QSIconView;

    invoke-virtual {v1, v3, p2}, Landroid/widget/FrameLayout;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    iget-object p2, p0, mIconFrame:Landroid/widget/FrameLayout;
    ...
    invoke-virtual {p0}, newTileBackground()Landroid/graphics/drawable/Drawable;

    move-result-object p2

    iput-object p2, p0, mTileBackground:Landroid/graphics/drawable/Drawable;

    iget-object p2, p0, mTileBackground:Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p2}, setRipple(Landroid/graphics/drawable/RippleDrawable;)V
    ...
    iput-boolean p3, p0, mCollapsedView:Z

    invoke-virtual {p0, v0}, Landroid/widget/LinearLayout;->setFocusable(Z)V

    iget-object p1, p0, mLottieUtils:Lcom/oneplus/util/OpLottieUtils;
    ...
    iget-object p3, p0, mBg:Landroid/widget/ImageView;

    iget-object v0, p0, mIcon:Lcom/android/systemui/plugins/qs/QSIconView;
    ...
    iput-object p1, p0, mLottieUtils:Lcom/oneplus/util/OpLottieUtils;
...
.method private setRipple(Landroid/graphics/drawable/RippleDrawable;)V
    ...
    iput-object p1, p0, mRipple:Landroid/graphics/drawable/RippleDrawable;
    ...
    invoke-direct {p0}, updateRippleSize()V
...
.method private updateRippleSize()V
    ...
    iget-object v0, p0, mIconFrame:Landroid/widget/FrameLayout;
    ...
    iget-object v2, p0, mIcon:Lcom/android/systemui/plugins/qs/QSIconView;
    ...
    iget-object p0, p0, mRipple:Landroid/graphics/drawable/RippleDrawable;
...
.method protected animationsEnabled()Z
    ...
    :cond_1
    iget-object v0, p0, mLocInScreen:[I
...
.method public getIcon()Lcom/android/systemui/plugins/qs/QSIconView;
    ...
    iget-object p0, p0, mIcon:Lcom/android/systemui/plugins/qs/QSIconView;
...
.method public getIconWithBackground()Landroid/view/View;
    ...
    iget-object p0, p0, mIconFrame:Landroid/widget/FrameLayout;
...
.method protected handleStateChanged(Lcom/android/systemui/plugins/qs/QSTile$State;)V
    ...
    invoke-direct {p0, v0}, getCircleColor(I)I

    move-result v0

    invoke-virtual {p0}, animationsEnabled()Z

    move-result v1

    iget-object v2, p0, mBg:Landroid/widget/ImageView;
    ...
    iget-object v5, p0, mLottieUtils:Lcom/oneplus/util/OpLottieUtils;

    iget-object v6, p0, mIconFrame:Landroid/widget/FrameLayout;
    ...
    iget-object v0, p0, mLottieUtils:Lcom/oneplus/util/OpLottieUtils;
    ...
    :goto_3
    iput-object v0, p0, mAccessibilityClass:Ljava/lang/String;
    ...
    iget-boolean v0, p0, mTileState:Z

    if-eq v0, p1, :cond_7

    iput-boolean v3, p0, mClicked:Z

    iput-boolean p1, p0, mTileState:Z
...
.method public init(Lcom/android/systemui/plugins/qs/QSTile;)V
    ...
    invoke-virtual {p0, v0, v1, v2}, init(Landroid/view/View$OnClickListener;Landroid/view/View$OnClickListener;Landroid/view/View$OnLongClickListener;)V
...
.method public synthetic lambda$handleStateChanged$3$QSTileBaseView(Landroid/animation/ValueAnimator;)V
    ...
    iget-object p0, p0, mBg:Landroid/widget/ImageView;
...
.method public onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    iget-object v0, p0, mAccessibilityClass:Ljava/lang/String;
    ...
    iget-object v1, p0, mAccessibilityClass:Ljava/lang/String;
...
.method public onInitializeAccessibilityNodeInfo(Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    iget-object v2, p0, mAccessibilityClass:Ljava/lang/String;
    ...
    iget-boolean v1, p0, mClicked:Z

    const/4 v2, 0x1

    if-eqz v1, :cond_0

    iget-boolean v1, p0, mTileState:Z
...
.method protected onLayout(ZIIII)V
    ...
    iget-object p1, p0, mRipple:Landroid/graphics/drawable/RippleDrawable;
...
.method public onStateChanged(Lcom/android/systemui/plugins/qs/QSTile$State;)V
    ...
    iget-object v0, p0, mHandler:Lcom/android/systemui/qs/tileimpl/QSTileBaseView$H;

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Landroid/os/Handler;->removeMessages(I)V

    iget-object p0, p0, mHandler:Lcom/android/systemui/qs/tileimpl/QSTileBaseView$H;
...
.method public setClickable(Z)V
    ...
    iget-boolean p1, p0, mShowRippleEffect:Z
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, mLocInScreen:[I
    ...
    iget-boolean p0, p0, mTileState:Z
