...
.method static constructor <clinit>()V
    ...
    sput v0, ONEPLUS_GRADIENT_SCRIM_ALPHA_BUSY:F

    sget v0, Lcom/android/systemui/R$id;->scrim:I

    sput v0, TAG_KEY_ANIM:I
...
.method public constructor <init>(Lcom/android/systemui/statusbar/ScrimView;Lcom/android/systemui/statusbar/ScrimView;Lcom/android/internal/util/function/TriConsumer;Ljava/util/function/Consumer;Lcom/android/systemui/statusbar/phone/DozeParameters;Landroid/app/AlarmManager;)V
    ...
    iput-object v0, p0, mState:Lcom/android/systemui/statusbar/phone/ScrimState;

    const v0, 0x3e4ccccd    # 0.2f

    iput v0, p0, mScrimBehindAlphaKeyguard:F

    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, p0, mExpansionFraction:F

    const/4 v0, 0x1

    iput-boolean v0, p0, mExpansionAffectsAlpha:Z

    const-wide/16 v1, -0x1

    iput-wide v1, p0, mAnimationDuration:J
    ...
    iput v1, p0, mCurrentInFrontAlpha:F

    iput v1, p0, mCurrentBehindAlpha:F

    iput-object p1, p0, mScrimBehind:Lcom/android/systemui/statusbar/ScrimView;

    iput-object p2, p0, mScrimInFront:Lcom/android/systemui/statusbar/ScrimView;

    iput-object p3, p0, mScrimStateListener:Lcom/android/internal/util/function/TriConsumer;

    iput-object p4, p0, mScrimVisibleListener:Ljava/util/function/Consumer;
    ...
    iput-object p1, p0, mUnlockMethodCache:Lcom/android/systemui/statusbar/phone/UnlockMethodCache;
    ...
    iput-boolean p1, p0, mDarkenWhileDragging:Z
    ...
    iput-object p1, p0, mKeyguardUpdateMonitor:Lcom/android/keyguard/KeyguardUpdateMonitor;
    ...
    iput-object p1, p0, mKeyguardVisibilityCallback:Lcom/android/systemui/statusbar/phone/ScrimController$KeyguardVisibilityCallback;

    iget-object p1, p0, mKeyguardUpdateMonitor:Lcom/android/keyguard/KeyguardUpdateMonitor;

    iget-object p2, p0, mKeyguardVisibilityCallback:Lcom/android/systemui/statusbar/phone/ScrimController$KeyguardVisibilityCallback;
    ...
    iput p1, p0, mScrimBehindAlphaResValue:F
    ...
    iput-object p1, p0, mTimeTicker:Lcom/android/systemui/util/AlarmTimeout;

    invoke-virtual {p0}, createWakeLock()Lcom/android/systemui/util/wakelock/WakeLock;

    move-result-object p1

    iput-object p1, p0, mWakeLock:Lcom/android/systemui/util/wakelock/WakeLock;

    iget p1, p0, mScrimBehindAlphaResValue:F

    iput p1, p0, mScrimBehindAlpha:F

    iput-object p5, p0, mDozeParameters:Lcom/android/systemui/statusbar/phone/DozeParameters;
    ...
    iput-object p1, p0, mColorExtractor:Lcom/android/systemui/colorextraction/SysuiColorExtractor;

    iget-object p1, p0, mColorExtractor:Lcom/android/systemui/colorextraction/SysuiColorExtractor;
    ...
    iput-object p1, p0, mColors:Lcom/android/internal/colorextraction/ColorExtractor$GradientColors;

    iput-boolean v0, p0, mNeedsDrawableColorUpdate:Z
    ...
    sput p1, ONEPLUS_GRADIENT_SCRIM_ALPHA_BUSY:F
    ...
    sput p1, mDefaultBacklight:F

    sget p1, mMaximumBacklight:F

    const p2, 0x3e19999a    # 0.15f

    mul-float/2addr p1, p2

    sput p1, mMidBacklight:F
    ...
    iput-object p1, p0, mBrightnessObserver:Lcom/android/systemui/statusbar/phone/ScrimController$BrightnessObserver;

    iget-object p1, p0, mBrightnessObserver:Lcom/android/systemui/statusbar/phone/ScrimController$BrightnessObserver;
    ...
    iget-object p5, p0, mScrimInFront:Lcom/android/systemui/statusbar/ScrimView;

    iget-object p6, p0, mScrimBehind:Lcom/android/systemui/statusbar/ScrimView;
    ...
    iget p5, p0, mScrimBehindAlphaKeyguard:F
    ...
    :cond_0
    iget-object p1, p0, mScrimBehind:Lcom/android/systemui/statusbar/ScrimView;

    invoke-virtual {p1, p2}, Landroid/view/View;->setDefaultFocusHighlightEnabled(Z)V

    iget-object p1, p0, mScrimInFront:Lcom/android/systemui/statusbar/ScrimView;

    invoke-virtual {p1, p2}, Landroid/view/View;->setDefaultFocusHighlightEnabled(Z)V

    invoke-virtual {p0}, updateScrims()V
...
.method static synthetic access$100(Lcom/android/systemui/statusbar/phone/ScrimController;)Lcom/android/systemui/statusbar/phone/ScrimController$Callback;
    ...
    iget-object p0, p0, mCallback:Lcom/android/systemui/statusbar/phone/ScrimController$Callback;
...
.method static synthetic access$1300(Lcom/android/systemui/statusbar/phone/ScrimController;)V
    ...
    invoke-direct {p0}, applyExpansionToAlpha()V
...
.method static synthetic access$200(Lcom/android/systemui/statusbar/phone/ScrimController;)Z
    ...
    iget-boolean p0, p0, mPlayScrimAnimation:Z
...
.method static synthetic access$202(Lcom/android/systemui/statusbar/phone/ScrimController;Z)Z
    ...
    iput-boolean p1, p0, mPlayScrimAnimation:Z
...
.method static synthetic access$300(Lcom/android/systemui/statusbar/phone/ScrimController;Lcom/android/systemui/statusbar/phone/ScrimController$Callback;)V
    ...
    invoke-direct {p0, p1}, onFinished(Lcom/android/systemui/statusbar/phone/ScrimController$Callback;)V
...
.method static synthetic access$400(Lcom/android/systemui/statusbar/phone/ScrimController;)V
    ...
    invoke-direct {p0}, dispatchScrimsVisible()V
...
.method static synthetic access$500(Lcom/android/systemui/statusbar/phone/ScrimController;)Z
    ...
    iget-boolean p0, p0, mDeferFinishedListener:Z
...
.method static synthetic access$600(Lcom/android/systemui/statusbar/phone/ScrimController;)Ljava/lang/Runnable;
    ...
    iget-object p0, p0, mOnAnimationFinished:Ljava/lang/Runnable;
...
.method static synthetic access$602(Lcom/android/systemui/statusbar/phone/ScrimController;Ljava/lang/Runnable;)Ljava/lang/Runnable;
    ...
    iput-object p1, p0, mOnAnimationFinished:Ljava/lang/Runnable;
...
.method static synthetic access$702(Lcom/android/systemui/statusbar/phone/ScrimController;Z)Z
    ...
    iput-boolean p1, p0, mNeedsDrawableColorUpdate:Z
...
.method private applyExpansionToAlpha()V
    ...
    iget-boolean v0, p0, mExpansionAffectsAlpha:Z
    ...
    :cond_0
    iget-object v0, p0, mState:Lcom/android/systemui/statusbar/phone/ScrimState;
    ...
    invoke-direct {p0}, getInterpolatedFraction()F
    ...
    invoke-direct {p0}, getGradientScrimAlphaBusyValue()F

    move-result v1

    mul-float/2addr v0, v1

    iput v0, p0, mCurrentBehindAlpha:F

    iput v2, p0, mCurrentInFrontAlpha:F
    ...
    iget-boolean v3, p0, mDarkenWhileDragging:Z
    ...
    iget-object v3, p0, mKeyguardUpdateMonitor:Lcom/android/keyguard/KeyguardUpdateMonitor;
    ...
    iput-boolean v1, p0, mPlayScrimAnimation:Z

    iput v5, p0, mCurrentBehindAlpha:F
    ...
    iget-object v2, p0, mState:Lcom/android/systemui/statusbar/phone/ScrimState;
    ...
    iput v0, p0, mCurrentBehindTint:I
...
.method private blankDisplay()V
    ...
    iget-object v0, p0, mScrimInFront:Lcom/android/systemui/statusbar/ScrimView;

    const/high16 v1, 0x3f800000    # 1.0f

    const/high16 v2, -0x1000000

    invoke-direct {p0, v0, v1, v2}, updateScrimColor(Landroid/view/View;FI)V
    ...
    iput-object v0, p0, mPendingFrameCallback:Ljava/lang/Runnable;

    iget-object v0, p0, mPendingFrameCallback:Ljava/lang/Runnable;

    invoke-virtual {p0, v0}, doOnTheNextFrame(Ljava/lang/Runnable;)V
...
.method private dispatchScrimState(F)V
    ...
    iget-object v0, p0, mScrimStateListener:Lcom/android/internal/util/function/TriConsumer;

    iget-object v1, p0, mState:Lcom/android/systemui/statusbar/phone/ScrimState;

    invoke-static {p1}, Ljava/lang/Float;->valueOf(F)Ljava/lang/Float;

    move-result-object p1

    iget-object p0, p0, mScrimInFront:Lcom/android/systemui/statusbar/ScrimView;
...
.method private dispatchScrimsVisible()V
    ...
    iget-object v0, p0, mScrimBehind:Lcom/android/systemui/statusbar/ScrimView;
    ...
    :goto_1
    iget v1, p0, mScrimsVisibility:I

    if-eq v1, v0, :cond_3

    iput v0, p0, mScrimsVisibility:I

    iget-object p0, p0, mScrimVisibleListener:Ljava/util/function/Consumer;
...
.method private getCurrentScrimAlpha(Landroid/view/View;)F
    ...
    iget p0, p0, mCurrentInFrontAlpha:F
    ...
    iget p0, p0, mCurrentBehindAlpha:F
...
.method private getCurrentScrimTint(Landroid/view/View;)I
    ...
    iget p0, p0, mCurrentInFrontTint:I
    ...
    iget p0, p0, mCurrentBehindTint:I
...
.method private getGradientScrimAlphaBusyValue()F
    ...
    sget p0, ONEPLUS_GRADIENT_SCRIM_ALPHA_BUSY:F
...
.method private getInterpolatedFraction()F
    ...
    iget p0, p0, mExpansionFraction:F
...
.method private holdWakeLock()V
    ...
    iget-boolean v0, p0, mWakeLockHeld:Z

    if-nez v0, :cond_1

    iget-object v0, p0, mWakeLock:Lcom/android/systemui/util/wakelock/WakeLock;
    ...
    iput-boolean v2, p0, mWakeLockHeld:Z
...
.method private onFinished()V
    ...
    iget-object v0, p0, mCallback:Lcom/android/systemui/statusbar/phone/ScrimController$Callback;

    invoke-direct {p0, v0}, onFinished(Lcom/android/systemui/statusbar/phone/ScrimController$Callback;)V
...
.method private onFinished(Lcom/android/systemui/statusbar/phone/ScrimController$Callback;)V
    ...
    iput-boolean v1, p0, mWakeLockHeld:Z
    ...
    iput-object p1, p0, mCallback:Lcom/android/systemui/statusbar/phone/ScrimController$Callback;

    :cond_1
    iget-object p1, p0, mState:Lcom/android/systemui/statusbar/phone/ScrimState;
    ...
    iput v1, p0, mCurrentInFrontTint:I

    iput v1, p0, mCurrentBehindTint:I
...
.method private setOrAdaptCurrentAnimation(Landroid/view/View;)V
    ...
    invoke-direct {p0, p1}, isAnimating(Landroid/view/View;)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-direct {p0, p1}, getCurrentScrimAlpha(Landroid/view/View;)F

    move-result v0

    invoke-direct {p0, p1}, getCurrentScrimTint(Landroid/view/View;)I

    move-result v1

    invoke-direct {p0, p1, v0, v1}, updateScrimColor(Landroid/view/View;FI)V

    goto :goto_0

    :cond_0
    sget v0, TAG_KEY_ANIM:I
...
.method private setScrimAlpha(Lcom/android/systemui/statusbar/ScrimView;F)V
    ...
    :goto_0
    invoke-direct {p0, p1, p2}, updateScrim(Lcom/android/systemui/statusbar/ScrimView;F)V
...
.method private setScrimBehindAlpha(F)V
    ...
    invoke-direct {p0, v0, p1}, setScrimAlpha(Lcom/android/systemui/statusbar/ScrimView;F)V
...
.method private shouldFadeAwayWallpaper()Z
    ...
    iget-boolean v0, p0, mWallpaperSupportsAmbientMode:Z
...
.method private startScrimAnimation(Landroid/view/View;F)V
    ...
    iget-wide v1, p0, mAnimationDelay:J

    invoke-virtual {v0, v1, v2}, Landroid/animation/ValueAnimator;->setStartDelay(J)V

    iget-wide v1, p0, mAnimationDuration:J
...
.method private updateScrim(Lcom/android/systemui/statusbar/ScrimView;F)V
    ...
    iget-boolean v4, p0, mAnimateChange:Z

    if-eqz v4, :cond_0

    iput-boolean v3, p0, mDeferFinishedListener:Z

    :cond_0
    invoke-virtual {p0, v1}, cancelAnimator(Landroid/animation/ValueAnimator;)V

    iput-boolean v2, p0, mDeferFinishedListener:Z

    :cond_1
    iget-object v1, p0, mPendingFrameCallback:Ljava/lang/Runnable;
    ...
    :cond_2
    iget-boolean v1, p0, mBlankScreen:Z

    if-eqz v1, :cond_3

    invoke-direct {p0}, blankDisplay()V

    return-void

    :cond_3
    iget-boolean v1, p0, mScreenBlankingCallbackCalled:Z

    if-nez v1, :cond_4

    iget-object v1, p0, mCallback:Lcom/android/systemui/statusbar/phone/ScrimController$Callback;

    if-eqz v1, :cond_4

    invoke-interface {v1}, Lcom/android/systemui/statusbar/phone/ScrimController$Callback;->onDisplayBlanked()V

    iput-boolean v3, p0, mScreenBlankingCallbackCalled:Z

    :cond_4
    iget-object v1, p0, mScrimBehind:Lcom/android/systemui/statusbar/ScrimView;

    if-ne p1, v1, :cond_5

    invoke-direct {p0, p2}, dispatchScrimState(F)V
    ...
    :cond_8
    invoke-direct {p0}, onFinished()V

    goto :goto_2

    :cond_9
    :goto_1
    iget-boolean v1, p0, mAnimateChange:Z

    if-eqz v1, :cond_a

    invoke-direct {p0, p1, v0}, startScrimAnimation(Landroid/view/View;F)V
    ...
    invoke-direct {p0, p1, p2, v0}, updateScrimColor(Landroid/view/View;FI)V
...
.method private updateScrimColor(Landroid/view/View;FI)V
    ...
    iget-object v1, p0, mScrimInFront:Lcom/android/systemui/statusbar/ScrimView;
...
.method protected doOnTheNextFrame(Ljava/lang/Runnable;)V
    ...
    iget-object p0, p0, mScrimBehind:Lcom/android/systemui/statusbar/ScrimView;
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object p3, p0, mScrimInFront:Lcom/android/systemui/statusbar/ScrimView;
    ...
    iget v0, p0, mCurrentInFrontAlpha:F
    ...
    iget p1, p0, mCurrentBehindAlpha:F
...
.method public forceHideScrims(ZZ)V
    ...
    iput-boolean p1, p0, mForceHideScrims:Z

    iput-boolean p2, p0, mAnimateChange:Z

    invoke-virtual {p0}, scheduleUpdate()V
...
.method public getBackgroundColor()I
    ...
    iget-object v0, p0, mColors:Lcom/android/internal/colorextraction/ColorExtractor$GradientColors;
...
.method public getState()Lcom/android/systemui/statusbar/phone/ScrimState;
    ...
    iget-object p0, p0, mState:Lcom/android/systemui/statusbar/phone/ScrimState;
...
.method public synthetic lambda$blankDisplay$1$ScrimController()V
    ...
    iput-object v0, p0, mBlankingTransitionRunnable:Ljava/lang/Runnable;

    iput-object v0, p0, mPendingFrameCallback:Ljava/lang/Runnable;

    const/4 v0, 0x0

    iput-boolean v0, p0, mBlankScreen:Z
...
.method public synthetic lambda$blankDisplay$2$ScrimController()V
    ...
    iput-boolean v0, p0, mScreenBlankingCallbackCalled:Z
    ...
    iget-object p0, p0, mBlankingTransitionRunnable:Ljava/lang/Runnable;
...
.method public synthetic lambda$startScrimAnimation$0$ScrimController(Landroid/view/View;ILandroid/animation/ValueAnimator;)V
    ...
    invoke-direct {p0, p1, v0, p2}, updateScrimColor(Landroid/view/View;FI)V
...
.method protected onHideWallpaperTimeout()V
    ...
    :cond_0
    invoke-direct {p0}, holdWakeLock()V

    const/4 v0, 0x1

    iput-boolean v0, p0, mWallpaperVisibilityTimedOut:Z

    iput-boolean v0, p0, mAnimateChange:Z
...
.method public onPreDraw()Z
    ...
    iput-boolean v0, p0, mUpdatePending:Z
    ...
    iget-object v0, p0, mOnAnimationFinished:Ljava/lang/Runnable;

    if-eqz v0, :cond_1

    iget-object v0, p0, mScrimInFront:Lcom/android/systemui/statusbar/ScrimView;

    invoke-direct {p0, v0}, isAnimating(Landroid/view/View;)Z
    ...
    iput-object v0, p0, mOnAnimationFinished:Ljava/lang/Runnable;
...
.method public onScreenTurnedOn()V
    ...
    iget-object v1, p0, mBlankingTransitionRunnable:Ljava/lang/Runnable;
...
.method public onTrackingStarted()V
    ...
    iput-boolean v0, p0, mDarkenWhileDragging:Z
...
.method public resetForceHide()V
    ...
    iput-boolean v0, p0, mForceHideScrims:Z
...
.method protected scheduleUpdate()V
    ...
    iget-boolean v0, p0, mUpdatePending:Z
...
.method public setAodFrontScrimAlpha(F)V
    ...
    iput p1, p0, mCurrentInFrontAlpha:F
...
.method public setExpansionAffectsAlpha(Z)V
    ...
    iput-boolean p1, p0, mExpansionAffectsAlpha:Z
...
.method public setHasBackdrop(Z)V
    ...
    iget v0, p0, mCurrentBehindAlpha:F

    cmpl-float v0, v0, p1

    if-eqz v0, :cond_2

    iput p1, p0, mCurrentBehindAlpha:F
...
.method public setPanelExpansion(F)V
    ...
    iget v0, p0, mExpansionFraction:F

    cmpl-float v0, v0, p1

    if-eqz v0, :cond_4

    iput p1, p0, mExpansionFraction:F
    ...
    iget-boolean p1, p0, mExpansionAffectsAlpha:Z
    ...
    iget-boolean p1, p0, mUpdatePending:Z
    ...
    invoke-direct {p0, p1}, setOrAdaptCurrentAnimation(Landroid/view/View;)V
    ...
    invoke-direct {p0, p1}, dispatchScrimState(F)V

    iget-boolean p1, p0, mWallpaperVisibilityTimedOut:Z

    if-eqz p1, :cond_4

    iput-boolean v1, p0, mWallpaperVisibilityTimedOut:Z

    iget-object p1, p0, mTimeTicker:Lcom/android/systemui/util/AlarmTimeout;
...
.method public setWallpaperSupportsAmbientMode(Z)V
    ...
    iput-boolean p1, p0, mWallpaperSupportsAmbientMode:Z
...
.method public transitionTo(Lcom/android/systemui/statusbar/phone/ScrimState;)V
    ...
    invoke-virtual {p0, p1, v0}, transitionTo(Lcom/android/systemui/statusbar/phone/ScrimState;Lcom/android/systemui/statusbar/phone/ScrimController$Callback;)V
...
.method public transitionTo(Lcom/android/systemui/statusbar/phone/ScrimState;Lcom/android/systemui/statusbar/phone/ScrimController$Callback;)V
    ...
    const-string v1, " mPlayScrimAnimation:"

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v1, p0, mPlayScrimAnimation:Z
    ...
    iget-boolean v0, p0, mPlayScrimAnimation:Z
    ...
    invoke-virtual {v0, v2}, Lcom/android/systemui/statusbar/phone/StatusBarWindowController;->setNotTouchable(Z)V

    iput-boolean v2, p0, mPlayScrimAnimation:Z
    ...
    iput-object p1, p0, mState:Lcom/android/systemui/statusbar/phone/ScrimState;
    ...
    :cond_4
    iput-object p2, p0, mCallback:Lcom/android/systemui/statusbar/phone/ScrimController$Callback;
    ...
    iput-boolean v2, p0, mScreenBlankingCallbackCalled:Z

    const-wide/16 v3, 0x0

    iput-wide v3, p0, mAnimationDelay:J

    invoke-virtual {p1}, Lcom/android/systemui/statusbar/phone/ScrimState;->getBlanksScreen()Z

    move-result p2

    iput-boolean p2, p0, mBlankScreen:Z
    ...
    iget-object p2, p0, mScrimBehind:Lcom/android/systemui/statusbar/ScrimView;
    ...
    iget-object p2, p0, mPendingFrameCallback:Ljava/lang/Runnable;

    const/4 v1, 0x0

    if-eqz p2, :cond_5

    iget-object v4, p0, mScrimBehind:Lcom/android/systemui/statusbar/ScrimView;

    invoke-virtual {v4, p2}, Landroid/view/View;->removeCallbacks(Ljava/lang/Runnable;)Z

    iput-object v1, p0, mPendingFrameCallback:Ljava/lang/Runnable;

    :cond_5
    iget-object p2, p0, mHandler:Landroid/os/Handler;

    iget-object v4, p0, mBlankingTransitionRunnable:Ljava/lang/Runnable;
    ...
    iput-object v1, p0, mBlankingTransitionRunnable:Ljava/lang/Runnable;
    ...
    :cond_8
    iput-boolean v2, p0, mWallpaperVisibilityTimedOut:Z

    invoke-direct {p0}, shouldFadeAwayWallpaper()Z
    ...
    iget-object p2, p0, mDozeParameters:Lcom/android/systemui/statusbar/phone/DozeParameters;
    ...
    iput-wide p1, p0, mAnimationDelay:J

    goto :goto_2

    :cond_a
    iget-object p1, p0, mDozeParameters:Lcom/android/systemui/statusbar/phone/DozeParameters;
...
.method protected updateScrims()V
    ...
    iget-boolean v1, p0, mForceHideScrims:Z
    ...
    iget-boolean v1, p0, mDarkenWhileDragging:Z
    ...
    iget-object v1, p0, mColors:Lcom/android/internal/colorextraction/ColorExtractor$GradientColors;
    ...
    :cond_0
    iget-boolean v0, p0, mNeedsDrawableColorUpdate:Z
    ...
    iput-boolean v3, p0, mNeedsDrawableColorUpdate:Z
    ...
    iget-boolean v0, p0, mBlankScreen:Z
    ...
    iget-boolean v4, p0, mBlankScreen:Z
    ...
    :goto_1
    iget-object v5, p0, mScrimInFront:Lcom/android/systemui/statusbar/ScrimView;

    iget-object v6, p0, mColors:Lcom/android/internal/colorextraction/ColorExtractor$GradientColors;
    ...
    iget-object v5, p0, mColors:Lcom/android/internal/colorextraction/ColorExtractor$GradientColors;
    ...
    :goto_2
    iget-object v4, p0, mColors:Lcom/android/internal/colorextraction/ColorExtractor$GradientColors;
    ...
    iget v4, p0, mScrimBehindAlphaResValue:F

    invoke-static {v4, v0}, Ljava/lang/Math;->max(FF)F

    move-result v0

    iput v0, p0, mScrimBehindAlpha:F
    ...
    invoke-direct {p0, v0}, dispatchScrimState(F)V
    ...
    :cond_5
    iget-boolean v0, p0, mWallpaperVisibilityTimedOut:Z
    ...
    :goto_3
    iget-object v4, p0, mState:Lcom/android/systemui/statusbar/phone/ScrimState;
    ...
    :cond_a
    iget-boolean v0, p0, mForceHideScrims:Z

    if-eqz v0, :cond_b

    iput-boolean v3, p0, mAnimateChange:Z

    invoke-direct {p0, v2}, setScrimInFrontAlpha(F)V

    invoke-direct {p0, v2}, setScrimBehindAlpha(F)V
    ...
    invoke-direct {p0, v0}, setScrimInFrontAlpha(F)V

    iget v0, p0, mCurrentBehindAlpha:F

    invoke-direct {p0, v0}, setScrimBehindAlpha(F)V
