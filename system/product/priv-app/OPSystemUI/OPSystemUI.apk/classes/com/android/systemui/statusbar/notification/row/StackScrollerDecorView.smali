...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-boolean p1, p0, mContentVisible:Z

    iput-boolean p1, p0, mIsSecondaryVisible:Z
    ...
    iput-object p1, p0, mContentVisibilityEndRunnable:Ljava/lang/Runnable;
...
.method private setContentVisible(ZZ)V
    ...
    iget-boolean v0, p0, mContentVisible:Z

    if-eq v0, p1, :cond_0

    iput-boolean p2, p0, mContentAnimating:Z

    iget-object v0, p0, mContent:Landroid/view/View;

    iget-object v1, p0, mContentVisibilityEndRunnable:Ljava/lang/Runnable;

    invoke-direct {p0, v0, p1, p2, v1}, setViewVisible(Landroid/view/View;ZZLjava/lang/Runnable;)V

    iput-boolean p1, p0, mContentVisible:Z

    :cond_0
    iget-boolean p1, p0, mContentAnimating:Z

    if-nez p1, :cond_1

    iget-object p0, p0, mContentVisibilityEndRunnable:Ljava/lang/Runnable;
...
.method public isContentVisible()Z
    ...
    iget-boolean p0, p0, mContentVisible:Z
...
.method isSecondaryVisible()Z
    ...
    iget-boolean p0, p0, mIsSecondaryVisible:Z
...
.method public synthetic lambda$new$0$StackScrollerDecorView()V
    ...
    iput-boolean v0, p0, mContentAnimating:Z
...
.method protected onFinishInflate()V
    ...
    invoke-virtual {p0}, findContentView()Landroid/view/View;

    move-result-object v0

    iput-object v0, p0, mContent:Landroid/view/View;

    invoke-virtual {p0}, findSecondaryView()Landroid/view/View;

    move-result-object v0

    iput-object v0, p0, mSecondaryView:Landroid/view/View;

    const/4 v0, 0x0

    invoke-virtual {p0, v0, v0}, setVisible(ZZ)V

    invoke-virtual {p0, v0, v0}, setSecondaryVisible(ZZ)V
...
.method public performAddAnimation(JJZ)V
    ...
    invoke-virtual {p0, p1}, setContentVisible(Z)V
...
.method public setContentVisible(Z)V
    ...
    invoke-direct {p0, p1, v0}, setContentVisible(ZZ)V
...
.method public setSecondaryVisible(ZZ)V
    ...
    iget-boolean v0, p0, mIsSecondaryVisible:Z

    if-eq v0, p1, :cond_0

    iget-object v0, p0, mSecondaryView:Landroid/view/View;
...
.method public setVisible(ZZ)V
    ...
    :goto_0
    invoke-direct {p0, p1, p2}, setContentVisible(ZZ)V
