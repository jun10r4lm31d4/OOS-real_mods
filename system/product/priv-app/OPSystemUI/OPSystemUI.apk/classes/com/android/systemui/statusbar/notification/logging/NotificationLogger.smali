...
.method public constructor <init>(Lcom/android/systemui/statusbar/NotificationListener;Lcom/android/systemui/UiOffloadThread;Lcom/android/systemui/statusbar/notification/NotificationEntryManager;Lcom/android/systemui/plugins/statusbar/StatusBarStateController;Lcom/android/systemui/statusbar/notification/logging/NotificationLogger$ExpansionStateLogger;)V
    ...
    iput-object v0, p0, mCurrentlyVisibleNotifications:Landroid/util/ArraySet;
    ...
    iput-object v0, p0, mDozingLock:Ljava/lang/Object;
    ...
    iput-object v0, p0, mNotificationLocationsChangedListener:Lcom/android/systemui/statusbar/notification/logging/NotificationLogger$OnChildLocationsChangedListener;
    ...
    iput-object v0, p0, mVisibilityReporter:Ljava/lang/Runnable;

    iput-object p1, p0, mNotificationListener:Landroid/service/notification/NotificationListenerService;

    iput-object p2, p0, mUiOffloadThread:Lcom/android/systemui/UiOffloadThread;

    iput-object p3, p0, mEntryManager:Lcom/android/systemui/statusbar/notification/NotificationEntryManager;
    ...
    iput-object p5, p0, mExpansionStateLogger:Lcom/android/systemui/statusbar/notification/logging/NotificationLogger$ExpansionStateLogger;
...
.method static synthetic access$000(Lcom/android/systemui/statusbar/notification/logging/NotificationLogger;)J
    ...
    iget-wide v0, p0, mLastVisibilityReportUptimeMs:J
...
.method static synthetic access$002(Lcom/android/systemui/statusbar/notification/logging/NotificationLogger;J)J
    ...
    iput-wide p1, p0, mLastVisibilityReportUptimeMs:J
...
.method static synthetic access$300(Lcom/android/systemui/statusbar/notification/logging/NotificationLogger;)Landroid/util/ArraySet;
    ...
    iget-object p0, p0, mCurrentlyVisibleNotifications:Landroid/util/ArraySet;
...
.method static synthetic access$400(Lcom/android/systemui/statusbar/notification/logging/NotificationLogger;Ljava/util/Collection;Ljava/util/Collection;)V
    ...
    invoke-direct {p0, p1, p2}, logNotificationVisibilityChanges(Ljava/util/Collection;Ljava/util/Collection;)V
...
.method static synthetic access$500(Lcom/android/systemui/statusbar/notification/logging/NotificationLogger;Landroid/util/ArraySet;)V
    ...
    invoke-direct {p0, p1}, recycleAllVisibilityObjects(Landroid/util/ArraySet;)V
...
.method static synthetic access$600(Lcom/android/systemui/statusbar/notification/logging/NotificationLogger;)Lcom/android/systemui/statusbar/notification/logging/NotificationLogger$ExpansionStateLogger;
    ...
    iget-object p0, p0, mExpansionStateLogger:Lcom/android/systemui/statusbar/notification/logging/NotificationLogger$ExpansionStateLogger;
...
.method static synthetic access$700(Lcom/android/systemui/statusbar/notification/logging/NotificationLogger;Ljava/lang/String;Landroid/service/notification/StatusBarNotification;Lcom/android/internal/statusbar/NotificationVisibility;)V
    ...
    invoke-direct {p0, p1, p2, p3}, logNotificationClear(Ljava/lang/String;Landroid/service/notification/StatusBarNotification;Lcom/android/internal/statusbar/NotificationVisibility;)V
...
.method static synthetic access$800(Lcom/android/systemui/statusbar/notification/logging/NotificationLogger;Landroid/service/notification/StatusBarNotification;Ljava/lang/Exception;)V
    ...
    invoke-direct {p0, p1, p2}, logNotificationError(Landroid/service/notification/StatusBarNotification;Ljava/lang/Exception;)V
...
.method static synthetic access$900(Ljava/util/Collection;)[Lcom/android/internal/statusbar/NotificationVisibility;
    ...
    invoke-static {p0}, cloneVisibilitiesAsArr(Ljava/util/Collection;)[Lcom/android/internal/statusbar/NotificationVisibility;
...
.method public static getNotificationLocation(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)Lcom/android/internal/statusbar/NotificationVisibility$NotificationLocation;
    ...
    invoke-static {p0}, convertNotificationLocation(I)Lcom/android/internal/statusbar/NotificationVisibility$NotificationLocation;
...
.method private logNotificationClear(Ljava/lang/String;Landroid/service/notification/StatusBarNotification;Lcom/android/internal/statusbar/NotificationVisibility;)V
    ...
    :try_start_0
    iget-object v5, p0, mHeadsUpManager:Lcom/android/systemui/statusbar/policy/HeadsUpManager;
    ...
    :cond_0
    iget-object p1, p0, mListContainer:Lcom/android/systemui/statusbar/notification/stack/NotificationListContainer;
...
.method private logNotificationVisibilityChanges(Ljava/util/Collection;Ljava/util/Collection;)V
    ...
    :cond_0
    invoke-static {p1}, cloneVisibilitiesAsArr(Ljava/util/Collection;)[Lcom/android/internal/statusbar/NotificationVisibility;

    move-result-object p1

    invoke-static {p2}, cloneVisibilitiesAsArr(Ljava/util/Collection;)[Lcom/android/internal/statusbar/NotificationVisibility;
...
.method private setDozing(Z)V
    ...
    iget-object v0, p0, mDozingLock:Ljava/lang/Object;
...
.method public getVisibilityReporter()Ljava/lang/Runnable;
    ...
    iget-object p0, p0, mVisibilityReporter:Ljava/lang/Runnable;
...
.method public synthetic lambda$logNotificationVisibilityChanges$0$NotificationLogger([Lcom/android/internal/statusbar/NotificationVisibility;[Lcom/android/internal/statusbar/NotificationVisibility;)V
    ...
    :try_start_2
    iget-object v2, p0, mNotificationListener:Landroid/service/notification/NotificationListenerService;
    ...
    :cond_2
    :goto_2
    invoke-direct {p0, p1}, recycleAllVisibilityObjects([Lcom/android/internal/statusbar/NotificationVisibility;)V

    invoke-direct {p0, p2}, recycleAllVisibilityObjects([Lcom/android/internal/statusbar/NotificationVisibility;)V
...
.method public onExpansionChanged(Ljava/lang/String;ZZ)V
    ...
    invoke-static {v0}, getNotificationLocation(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)Lcom/android/internal/statusbar/NotificationVisibility$NotificationLocation;
...
.method public setUpWithContainer(Lcom/android/systemui/statusbar/notification/stack/NotificationListContainer;)V
    ...
    iput-object p1, p0, mListContainer:Lcom/android/systemui/statusbar/notification/stack/NotificationListContainer;
...
.method public startNotificationLogging()V
    ...
    iget-object v1, p0, mNotificationLocationsChangedListener:Lcom/android/systemui/statusbar/notification/logging/NotificationLogger$OnChildLocationsChangedListener;
    ...
    iget-object p0, p0, mNotificationLocationsChangedListener:Lcom/android/systemui/statusbar/notification/logging/NotificationLogger$OnChildLocationsChangedListener;
...
.method public stopNotificationLogging()V
    ...
    iget-object v0, p0, mCurrentlyVisibleNotifications:Landroid/util/ArraySet;
    ...
    iget-object v1, p0, mCurrentlyVisibleNotifications:Landroid/util/ArraySet;

    invoke-direct {p0, v0, v1}, logNotificationVisibilityChanges(Ljava/util/Collection;Ljava/util/Collection;)V

    iget-object v0, p0, mCurrentlyVisibleNotifications:Landroid/util/ArraySet;

    invoke-direct {p0, v0}, recycleAllVisibilityObjects(Landroid/util/ArraySet;)V

    :cond_0
    iget-object v0, p0, mHandler:Landroid/os/Handler;

    iget-object v1, p0, mVisibilityReporter:Ljava/lang/Runnable;
