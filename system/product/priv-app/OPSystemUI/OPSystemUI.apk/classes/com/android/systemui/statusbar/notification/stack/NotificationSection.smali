...
.method constructor <init>(Landroid/view/View;)V
    ...
    iput-object v0, p0, mCurrentBounds:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, mStartAnimationRect:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, mEndAnimationRect:Landroid/graphics/Rect;

    const/4 v0, 0x0

    iput-object v0, p0, mTopAnimator:Landroid/animation/ObjectAnimator;

    iput-object v0, p0, mBottomAnimator:Landroid/animation/ObjectAnimator;

    iput-object p1, p0, mOwningView:Landroid/view/View;
...
.method static synthetic access$000(Lcom/android/systemui/statusbar/notification/stack/NotificationSection;)Landroid/graphics/Rect;
    ...
    iget-object p0, p0, mStartAnimationRect:Landroid/graphics/Rect;
...
.method static synthetic access$100(Lcom/android/systemui/statusbar/notification/stack/NotificationSection;)Landroid/graphics/Rect;
    ...
    iget-object p0, p0, mEndAnimationRect:Landroid/graphics/Rect;
...
.method static synthetic access$202(Lcom/android/systemui/statusbar/notification/stack/NotificationSection;Landroid/animation/ObjectAnimator;)Landroid/animation/ObjectAnimator;
    ...
    iput-object p1, p0, mTopAnimator:Landroid/animation/ObjectAnimator;
...
.method static synthetic access$302(Lcom/android/systemui/statusbar/notification/stack/NotificationSection;Landroid/animation/ObjectAnimator;)Landroid/animation/ObjectAnimator;
    ...
    iput-object p1, p0, mBottomAnimator:Landroid/animation/ObjectAnimator;
...
.method private setBackgroundBottom(I)V
    ...
    iget-object v0, p0, mCurrentBounds:Landroid/graphics/Rect;

    iput p1, v0, Landroid/graphics/Rect;->bottom:I

    iget-object p0, p0, mOwningView:Landroid/view/View;
...
.method private startBottomAnimation(Z)V
    ...
    iget-object v0, p0, mStartAnimationRect:Landroid/graphics/Rect;

    iget v0, v0, Landroid/graphics/Rect;->bottom:I

    iget-object v1, p0, mEndAnimationRect:Landroid/graphics/Rect;
    ...
    iget-object v3, p0, mBottomAnimator:Landroid/animation/ObjectAnimator;
    ...
    iget-object p1, p0, mStartAnimationRect:Landroid/graphics/Rect;
    ...
    :cond_1
    invoke-direct {p0, v2}, setBackgroundBottom(I)V
    ...
    iget-object v1, p0, mCurrentBounds:Landroid/graphics/Rect;

    iget v1, v1, Landroid/graphics/Rect;->bottom:I

    iput v1, v0, Landroid/graphics/Rect;->bottom:I

    iget-object v0, p0, mEndAnimationRect:Landroid/graphics/Rect;
...
.method private startTopAnimation(Z)V
    ...
    iget-object v2, p0, mTopAnimator:Landroid/animation/ObjectAnimator;
    ...
    :cond_1
    invoke-direct {p0, v1}, setBackgroundTop(I)V
    ...
    iget-object v2, p0, mCurrentBounds:Landroid/graphics/Rect;
...
.method public areBoundsAnimating()Z
    ...
    iget-object v0, p0, mBottomAnimator:Landroid/animation/ObjectAnimator;

    if-nez v0, :cond_1

    iget-object p0, p0, mTopAnimator:Landroid/animation/ObjectAnimator;
...
.method public getCurrentBounds()Landroid/graphics/Rect;
    ...
    iget-object p0, p0, mCurrentBounds:Landroid/graphics/Rect;
...
.method public getFirstVisibleChild()Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;
    ...
    iget-object p0, p0, mFirstVisibleChild:Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;
...
.method public getLastVisibleChild()Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;
    ...
    iget-object p0, p0, mLastVisibleChild:Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;
...
.method public isTargetTop(I)Z
    ...
    iget-object v0, p0, mTopAnimator:Landroid/animation/ObjectAnimator;
...
.method public setFirstVisibleChild(Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;)V
    ...
    iput-object p1, p0, mFirstVisibleChild:Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;
...
.method public setLastVisibleChild(Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;)V
    ...
    iput-object p1, p0, mLastVisibleChild:Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;
...
.method public startBackgroundAnimation(ZZ)V
    ...
    invoke-direct {p0, p2}, startBottomAnimation(Z)V

    invoke-direct {p0, p1}, startTopAnimation(Z)V
...
.method public updateBounds(IIZ)I
    ...
    invoke-virtual {p0}, getFirstVisibleChild()Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;
    ...
    invoke-virtual {p0, v1}, isTargetTop(I)Z
    ...
    invoke-virtual {p0}, getLastVisibleChild()Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;
    ...
    invoke-virtual {p0, v0}, isTargetBottom(I)Z
