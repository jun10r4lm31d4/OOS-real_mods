...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mCurrentNotifs:Landroid/util/ArraySet;
    ...
    iput-object v0, p0, mUserSwitchListener:Landroid/app/SynchronousUserSwitchObserver;
    ...
    iput-object v0, p0, mTaskListener:Lcom/android/systemui/shared/system/TaskStackChangeListener;
...
.method static synthetic access$100(Lcom/android/systemui/statusbar/notification/InstantAppNotifier;)V
    ...
    invoke-direct {p0}, updateForegroundInstantApps()V
...
.method private checkAndPostForPrimaryScreen(Landroid/util/ArraySet;Landroid/app/NotificationManager;Landroid/content/pm/IPackageManager;)V
    ...
    invoke-direct {p0, v0, p1, p2, p3}, checkAndPostForStack(Landroid/app/ActivityManager$StackInfo;Landroid/util/ArraySet;Landroid/app/NotificationManager;Landroid/content/pm/IPackageManager;)V
    :try_end_0
...
.method private checkAndPostForStack(Landroid/app/ActivityManager$StackInfo;Landroid/util/ArraySet;Landroid/app/NotificationManager;Landroid/content/pm/IPackageManager;)V
    ...
    invoke-direct/range {v1 .. v6}, postInstantAppNotif(Ljava/lang/String;ILandroid/content/pm/ApplicationInfo;Landroid/app/NotificationManager;I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private postInstantAppNotif(Ljava/lang/String;ILandroid/content/pm/ApplicationInfo;Landroid/app/NotificationManager;I)V
    ...
    iget-object v0, v1, mCurrentNotifs:Landroid/util/ArraySet;
    ...
    :goto_1
    invoke-direct {v1, v0, v3}, getTaskIntent(II)Landroid/content/Intent;
...
.method private updateForegroundInstantApps()V
    ...
    iget-object v2, p0, mUiOffloadThread:Lcom/android/systemui/UiOffloadThread;
...
.method public synthetic lambda$updateForegroundInstantApps$1$InstantAppNotifier(Landroid/app/NotificationManager;Landroid/util/Pair;)V
    ...
    iget-object p0, p0, mCurrentNotifs:Landroid/util/ArraySet;
...
.method public synthetic lambda$updateForegroundInstantApps$2$InstantAppNotifier(Landroid/app/NotificationManager;Landroid/content/pm/IPackageManager;)V
    ...
    iget-object v1, p0, mCurrentNotifs:Landroid/util/ArraySet;
    ...
    iget-object v2, p0, mOpNotificationController:Lcom/oneplus/notification/OpNotificationController;
    ...
    :cond_2
    invoke-direct {p0, v1, v0, p1, p2}, checkAndPostForStack(Landroid/app/ActivityManager$StackInfo;Landroid/util/ArraySet;Landroid/app/NotificationManager;Landroid/content/pm/IPackageManager;)V
    ...
    invoke-direct {p0, v0, p1, p2}, checkAndPostForPrimaryScreen(Landroid/util/ArraySet;Landroid/app/NotificationManager;Landroid/content/pm/IPackageManager;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public start()V
    ...
    iget-object v1, p0, mUserSwitchListener:Landroid/app/SynchronousUserSwitchObserver;
