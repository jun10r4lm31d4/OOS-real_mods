...
.method static constructor <clinit>()V
    ...
    sput-wide v0, SIX_HOURS_MILLIS:J
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mReceiver:Lcom/android/systemui/power/PowerUI$Receiver;
    ...
    iput v0, p0, mInvalidCharger:I

    const-wide/16 v0, -0x1

    iput-wide v0, p0, mScreenOffTime:J
...
.method static synthetic access$1000(Lcom/android/systemui/power/PowerUI;)Lcom/android/systemui/power/PowerUI$WarningsUI;
    ...
    iget-object p0, p0, mWarnings:Lcom/android/systemui/power/PowerUI$WarningsUI;
...
.method static synthetic access$1100(Lcom/android/systemui/power/PowerUI;)Ljava/util/concurrent/Future;
    ...
    iget-object p0, p0, mLastShowWarningTask:Ljava/util/concurrent/Future;
...
.method static synthetic access$1102(Lcom/android/systemui/power/PowerUI;Ljava/util/concurrent/Future;)Ljava/util/concurrent/Future;
    ...
    iput-object p1, p0, mLastShowWarningTask:Ljava/util/concurrent/Future;
...
.method static synthetic access$300(Lcom/android/systemui/power/PowerUI;I)I
    ...
    invoke-direct {p0, p1}, findBatteryLevelBucket(I)I
...
.method static synthetic access$800(Lcom/android/systemui/power/PowerUI;)I
    ...
    iget p0, p0, mLowBatteryAlertCloseLevel:I
...
.method static synthetic access$900(Lcom/android/systemui/power/PowerUI;)J
    ...
    iget-wide v0, p0, mScreenOffTime:J
...
.method private findBatteryLevelBucket(I)I
    ...
    iget v0, p0, mLowBatteryAlertCloseLevel:I
...
.method private initThermalEventListeners()V
    ...
    invoke-virtual {p0}, doSkinThermalEventListenerRegistration()V

    invoke-virtual {p0}, doUsbThermalEventListenerRegistration()V
...
.method public static synthetic lambda$QV7l9YjJI0jIQa7PQUr5PFep9Kg(Lcom/android/systemui/power/PowerUI;)V
    ...
    invoke-direct {p0}, initThermalEventListeners()V
...
.method declared-synchronized doSkinThermalEventListenerRegistration()V
    ...
    :try_start_0
    iget-boolean v0, p0, mEnableSkinTemperatureWarning:Z
    ...
    :goto_0
    iput-boolean v1, p0, mEnableSkinTemperatureWarning:Z

    iget-boolean v1, p0, mEnableSkinTemperatureWarning:Z
    :try_end_0
    ...
    :try_start_1
    iget-object v0, p0, mSkinThermalEventListener:Landroid/os/IThermalEventListener;
    ...
    iput-object v0, p0, mSkinThermalEventListener:Landroid/os/IThermalEventListener;

    :cond_1
    iget-object v0, p0, mThermalService:Landroid/os/IThermalService;
    ...
    iput-object v0, p0, mThermalService:Landroid/os/IThermalService;
    ...
    iget-object v1, p0, mSkinThermalEventListener:Landroid/os/IThermalEventListener;
    ...
    :goto_2
    iput-boolean v2, p0, mEnableSkinTemperatureWarning:Z
...
.method declared-synchronized doUsbThermalEventListenerRegistration()V
    ...
    :try_start_0
    iget-boolean v0, p0, mEnableUsbTemperatureAlarm:Z
    ...
    :goto_0
    iput-boolean v1, p0, mEnableUsbTemperatureAlarm:Z

    iget-boolean v1, p0, mEnableUsbTemperatureAlarm:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :try_start_1
    iget-object v0, p0, mUsbThermalEventListener:Landroid/os/IThermalEventListener;
    ...
    iput-object v0, p0, mUsbThermalEventListener:Landroid/os/IThermalEventListener;
    ...
    iget-object v1, p0, mUsbThermalEventListener:Landroid/os/IThermalEventListener;
    ...
    :goto_2
    iput-boolean v2, p0, mEnableUsbTemperatureAlarm:Z
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget p1, p0, mLowBatteryAlertCloseLevel:I
    ...
    iget-wide v2, p0, mScreenOffTime:J
    ...
    iget-boolean p1, p0, mEnableSkinTemperatureWarning:Z
    ...
    iget-boolean p1, p0, mEnableUsbTemperatureAlarm:Z
...
.method protected maybeShowBatteryWarningV2(ZI)V
    ...
    iget-object v1, v0, mEnhancedEstimates:Lcom/android/systemui/power/EnhancedEstimates;
    ...
    :cond_1
    invoke-virtual/range {p0 .. p0}, refreshEstimateIfNeeded()Lcom/android/settingslib/fuelgauge/Estimate;
    ...
    iget-object v6, v0, mEnhancedEstimates:Lcom/android/systemui/power/EnhancedEstimates;
    ...
    iput-object v2, v0, mCurrentBatteryStateSnapshot:Lcom/android/systemui/power/BatteryStateSnapshot;
    ...
    iput-object v1, v0, mCurrentBatteryStateSnapshot:Lcom/android/systemui/power/BatteryStateSnapshot;

    :goto_0
    iget-object v1, v0, mWarnings:Lcom/android/systemui/power/PowerUI$WarningsUI;

    iget-object v2, v0, mCurrentBatteryStateSnapshot:Lcom/android/systemui/power/BatteryStateSnapshot;
    ...
    iget-object v1, v0, mCurrentBatteryStateSnapshot:Lcom/android/systemui/power/BatteryStateSnapshot;
    ...
    iget-object v2, v0, mLastBatteryStateSnapshot:Lcom/android/systemui/power/BatteryStateSnapshot;

    invoke-virtual {v0, v1, v2}, maybeShowHybridWarning(Lcom/android/systemui/power/BatteryStateSnapshot;Lcom/android/systemui/power/BatteryStateSnapshot;)V
    ...
    invoke-virtual {v0, v1, v2}, maybeShowBatteryWarning(Lcom/android/systemui/power/BatteryStateSnapshot;Lcom/android/systemui/power/BatteryStateSnapshot;)V
...
.method refreshEstimateIfNeeded()Lcom/android/settingslib/fuelgauge/Estimate;
    ...
    iget-object v0, p0, mLastBatteryStateSnapshot:Lcom/android/systemui/power/BatteryStateSnapshot;
    ...
    iget-object v1, p0, mLastBatteryStateSnapshot:Lcom/android/systemui/power/BatteryStateSnapshot;
    ...
    iget-object p0, p0, mLastBatteryStateSnapshot:Lcom/android/systemui/power/BatteryStateSnapshot;
    ...
    :cond_1
    :goto_0
    iget-object p0, p0, mEnhancedEstimates:Lcom/android/systemui/power/EnhancedEstimates;
...
.method shouldShowHybridWarning(Lcom/android/systemui/power/BatteryStateSnapshot;)Z
    ...
    iget-boolean v0, p0, mLowWarningShownThisChargeCycle:Z
    ...
    :goto_0
    iget-boolean v4, p0, mSevereWarningShownThisChargeCycle:Z
    ...
    iget-boolean v3, p0, mLowWarningShownThisChargeCycle:Z
    ...
    iget-boolean p0, p0, mSevereWarningShownThisChargeCycle:Z
...
.method public start()V
    ...
    iput-object v0, p0, mWarnings:Lcom/android/systemui/power/PowerUI$WarningsUI;
    ...
    iput-object v0, p0, mEnhancedEstimates:Lcom/android/systemui/power/EnhancedEstimates;
    ...
    invoke-virtual {p0}, updateBatteryWarningLevels()V

    iget-object v0, p0, mReceiver:Lcom/android/systemui/power/PowerUI$Receiver;
