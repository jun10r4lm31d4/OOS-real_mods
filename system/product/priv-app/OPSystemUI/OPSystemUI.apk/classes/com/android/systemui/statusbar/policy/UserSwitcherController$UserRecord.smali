...
.method public constructor <init>(Landroid/content/pm/UserInfo;Landroid/graphics/Bitmap;ZZZZZ)V
    ...
    iput-object p1, p0, info:Landroid/content/pm/UserInfo;

    iput-object p2, p0, picture:Landroid/graphics/Bitmap;

    iput-boolean p3, p0, isGuest:Z

    iput-boolean p4, p0, isCurrent:Z

    iput-boolean p5, p0, isAddUser:Z

    iput-boolean p6, p0, isRestricted:Z

    iput-boolean p7, p0, isSwitchToEnabled:Z
...
.method public copyWithIsCurrent(Z)Lcom/android/systemui/statusbar/policy/UserSwitcherController$UserRecord;
    ...
    iget-object v1, p0, info:Landroid/content/pm/UserInfo;

    iget-object v2, p0, picture:Landroid/graphics/Bitmap;

    iget-boolean v3, p0, isGuest:Z

    iget-boolean v5, p0, isAddUser:Z

    iget-boolean v6, p0, isRestricted:Z

    iget-boolean v7, p0, isSwitchToEnabled:Z

    move-object v0, v8

    move v4, p1

    invoke-direct/range {v0 .. v7}, <init>(Landroid/content/pm/UserInfo;Landroid/graphics/Bitmap;ZZZZZ)V
...
.method public resolveId()I
    ...
    iget-boolean v0, p0, isGuest:Z

    if-nez v0, :cond_1

    iget-object p0, p0, info:Landroid/content/pm/UserInfo;
...
.method public toString()Ljava/lang/String;
    ...
    :cond_1
    iget-boolean v1, p0, isAddUser:Z
    ...
    :cond_4
    iget-boolean v1, p0, isCurrent:Z
    ...
    :cond_5
    iget-object v1, p0, picture:Landroid/graphics/Bitmap;
    ...
    :cond_6
    iget-boolean v1, p0, isRestricted:Z
    ...
    :cond_7
    iget-boolean v1, p0, isDisabledByAdmin:Z
    ...
    iget-object v1, p0, enforcedAdmin:Lcom/android/settingslib/RestrictedLockUtils$EnforcedAdmin;

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    :cond_8
    iget-boolean p0, p0, isSwitchToEnabled:Z
