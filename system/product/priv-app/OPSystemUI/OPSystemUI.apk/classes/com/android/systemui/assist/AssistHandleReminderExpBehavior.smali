...
.method static constructor <clinit>()V
    ...
    sput-wide v3, DEFAULT_LEARNING_TIME_MS:J
    ...
    sput-wide v3, DEFAULT_SHOW_AND_GO_DELAYED_LONG_DELAY_MS:J
    ...
    sput-wide v0, DEFAULT_SHOW_AND_GO_DELAY_RESET_TIMEOUT_MS:J
...
.method constructor <init>(Landroid/os/Handler;Lcom/android/systemui/assist/PhenotypeHelper;)V
    ...
    iput-object v0, p0, mStatusBarStateListener:Lcom/android/systemui/plugins/statusbar/StatusBarStateController$StateListener;
    ...
    iput-object v0, p0, mTaskStackChangeListener:Lcom/android/systemui/shared/system/TaskStackChangeListener;
    ...
    iput-object v0, p0, mOverviewProxyListener:Lcom/android/systemui/recents/OverviewProxyService$OverviewProxyListener;
    ...
    iput-object v0, p0, mDefaultHomeBroadcastReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v0, p0, mResetConsecutiveTaskSwitches:Ljava/lang/Runnable;

    iput-object p1, p0, mHandler:Landroid/os/Handler;

    iput-object p2, p0, mPhenotypeHelper:Lcom/android/systemui/assist/PhenotypeHelper;
    ...
    iget-object v2, p0, mDefaultHomeIntentFilter:Landroid/content/IntentFilter;
...
.method static synthetic access$000(Lcom/android/systemui/assist/AssistHandleReminderExpBehavior;I)V
    ...
    invoke-direct {p0, p1}, handleStatusBarStateChanged(I)V
...
.method static synthetic access$100(Lcom/android/systemui/assist/AssistHandleReminderExpBehavior;Z)V
    ...
    invoke-direct {p0, p1}, handleDozingChanged(Z)V
...
.method static synthetic access$200(Lcom/android/systemui/assist/AssistHandleReminderExpBehavior;ILandroid/content/ComponentName;)V
    ...
    invoke-direct {p0, p1, p2}, handleTaskStackTopChanged(ILandroid/content/ComponentName;)V
...
.method static synthetic access$300(Lcom/android/systemui/assist/AssistHandleReminderExpBehavior;)V
    ...
    invoke-direct {p0}, handleOverviewShown()V
...
.method static synthetic access$400(Lcom/android/systemui/assist/AssistHandleReminderExpBehavior;I)V
    ...
    invoke-direct {p0, p1}, handleSystemUiStateChanged(I)V
...
.method static synthetic access$502(Lcom/android/systemui/assist/AssistHandleReminderExpBehavior;Landroid/content/ComponentName;)Landroid/content/ComponentName;
    ...
    iput-object p1, p0, mDefaultHome:Landroid/content/ComponentName;
...
.method static synthetic access$600()Landroid/content/ComponentName;
    ...
    invoke-static {}, getCurrentDefaultHome()Landroid/content/ComponentName;
...
.method private callbackForCurrentState(Z)V
    ...
    invoke-direct {p0}, updateLearningStatus()V

    iget-boolean v0, p0, mIsLearned:Z

    if-eqz v0, :cond_0

    invoke-direct {p0, p1}, callbackForLearnedState(Z)V

    goto :goto_0

    :cond_0
    invoke-direct {p0}, callbackForUnlearnedState()V
...
.method private callbackForLearnedState(Z)V
    ...
    iget-object v0, p0, mAssistHandleCallbacks:Lcom/android/systemui/assist/AssistHandleCallbacks;
    ...
    :cond_0
    iget-boolean v0, p0, mIsDozing:Z

    if-nez v0, :cond_3

    iget-boolean v0, p0, mIsNavBarHidden:Z

    if-nez v0, :cond_3

    iget-boolean v0, p0, mOnLockscreen:Z

    if-nez v0, :cond_3

    invoke-direct {p0}, getShowWhenTaught()Z
    ...
    iget-wide v2, p0, mLearnedHintLastShownEpochDay:J
    ...
    :cond_2
    iput-wide v0, p0, mLearnedHintLastShownEpochDay:J

    iget-object p0, p0, mAssistHandleCallbacks:Lcom/android/systemui/assist/AssistHandleCallbacks;
...
.method private callbackForUnlearnedState()V
    ...
    invoke-direct {p0}, isSuppressed()Z
    ...
    :cond_2
    iget-boolean v0, p0, mIsLauncherShowing:Z
    ...
    :cond_3
    iget v0, p0, mConsecutiveTaskSwitches:I
    ...
    invoke-direct {p0}, getShowAndGoDelayedShortDelayMs()J
    ...
    invoke-direct {p0}, getShowAndGoDelayedLongDelayMs()J
...
.method private getLearningCount()I
    ...
    iget-object p0, p0, mPhenotypeHelper:Lcom/android/systemui/assist/PhenotypeHelper;
...
.method private getLearningTimeMs()J
    ...
    sget-wide v0, DEFAULT_LEARNING_TIME_MS:J
...
.method private getShowAndGoDelayResetTimeoutMs()J
    ...
    sget-wide v0, DEFAULT_SHOW_AND_GO_DELAY_RESET_TIMEOUT_MS:J
...
.method private getShowAndGoDelayedLongDelayMs()J
    ...
    sget-wide v0, DEFAULT_SHOW_AND_GO_DELAYED_LONG_DELAY_MS:J
...
.method private handleDozingChanged(Z)V
    ...
    :cond_0
    invoke-direct {p0}, resetConsecutiveTaskSwitches()V

    iput-boolean p1, p0, mIsDozing:Z

    const/4 p1, 0x0

    invoke-direct {p0, p1}, callbackForCurrentState(Z)V
...
.method private handleOverviewShown()V
    ...
    invoke-direct {p0, v0}, callbackForCurrentState(Z)V
...
.method private handleStatusBarStateChanged(I)V
    ...
    invoke-direct {p0, p1}, onLockscreen(I)Z
    ...
    iput-boolean p1, p0, mOnLockscreen:Z
...
.method private handleSystemUiStateChanged(I)V
    ...
    invoke-static {p1}, isNavBarHidden(I)Z
    ...
    iput-boolean p1, p0, mIsNavBarHidden:Z
...
.method private handleTaskStackTopChanged(ILandroid/content/ComponentName;)V
    ...
    :cond_0
    iput p1, p0, mRunningTaskId:I

    iget-object p1, p0, mDefaultHome:Landroid/content/ComponentName;

    invoke-virtual {p2, p1}, Landroid/content/ComponentName;->equals(Ljava/lang/Object;)Z

    move-result p1

    iput-boolean p1, p0, mIsLauncherShowing:Z

    iget-boolean p1, p0, mIsLauncherShowing:Z
    ...
    :cond_1
    invoke-direct {p0}, rescheduleConsecutiveTaskSwitchesReset()V

    iget p1, p0, mConsecutiveTaskSwitches:I

    add-int/lit8 p1, p1, 0x1

    iput p1, p0, mConsecutiveTaskSwitches:I
...
.method private isSuppressed()Z
    ...
    invoke-direct {p0}, getSuppressOnLockscreen()Z
    ...
    invoke-direct {p0}, getSuppressOnLauncher()Z
    ...
    :cond_1
    invoke-direct {p0}, getSuppressOnApps()Z
...
.method private rescheduleConsecutiveTaskSwitchesReset()V
    ...
    iget-object v1, p0, mResetConsecutiveTaskSwitches:Ljava/lang/Runnable;
    ...
    invoke-direct {p0}, getShowAndGoDelayResetTimeoutMs()J
...
.method private resetConsecutiveTaskSwitches()V
    ...
    iput v0, p0, mConsecutiveTaskSwitches:I
...
.method private updateLearningStatus()V
    ...
    iget-wide v2, p0, mLearningTimeElapsed:J

    iget-wide v4, p0, mLastLearningTimestamp:J

    sub-long v4, v0, v4

    add-long/2addr v2, v4

    iput-wide v2, p0, mLearningTimeElapsed:J

    iput-wide v0, p0, mLastLearningTimestamp:J
    ...
    iget-wide v1, p0, mLearningTimeElapsed:J
    ...
    iget v0, p0, mLearningCount:I

    invoke-direct {p0}, getLearningCount()I

    move-result v1

    if-ge v0, v1, :cond_2

    iget-wide v0, p0, mLearningTimeElapsed:J

    invoke-direct {p0}, getLearningTimeMs()J
    ...
    :goto_1
    iput-boolean v0, p0, mIsLearned:Z
...
.method public dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    iget-boolean v1, p0, mOnLockscreen:Z
    ...
    iget-boolean v1, p0, mIsDozing:Z
    ...
    iget-object v1, p0, mDefaultHome:Landroid/content/ComponentName;
    ...
    iget-boolean v1, p0, mIsNavBarHidden:Z
    ...
    iget-boolean v1, p0, mIsLauncherShowing:Z
    ...
    iget v1, p0, mConsecutiveTaskSwitches:I
    ...
    iget-boolean v1, p0, mIsLearned:Z
    ...
    iget-wide v1, p0, mLastLearningTimestamp:J
    ...
    iget-wide v1, p0, mLearnedHintLastShownEpochDay:J
    ...
    iget-object v1, p0, mAssistHandleCallbacks:Lcom/android/systemui/assist/AssistHandleCallbacks;
...
.method public onModeActivated(Landroid/content/Context;Lcom/android/systemui/assist/AssistHandleCallbacks;)V
    ...
    iput-object p2, p0, mAssistHandleCallbacks:Lcom/android/systemui/assist/AssistHandleCallbacks;

    const/4 p2, 0x0

    iput p2, p0, mConsecutiveTaskSwitches:I

    invoke-static {}, getCurrentDefaultHome()Landroid/content/ComponentName;

    move-result-object v0

    iput-object v0, p0, mDefaultHome:Landroid/content/ComponentName;

    iget-object v0, p0, mDefaultHomeBroadcastReceiver:Landroid/content/BroadcastReceiver;

    iget-object v1, p0, mDefaultHomeIntentFilter:Landroid/content/IntentFilter;
    ...
    invoke-direct {p0, v0}, onLockscreen(I)Z

    move-result v0

    iput-boolean v0, p0, mOnLockscreen:Z
    ...
    iput-boolean v0, p0, mIsDozing:Z

    iget-object v0, p0, mStatusBarStateController:Lcom/android/systemui/plugins/statusbar/StatusBarStateController;

    iget-object v1, p0, mStatusBarStateListener:Lcom/android/systemui/plugins/statusbar/StatusBarStateController$StateListener;
    ...
    iput-wide v3, p0, mLearningTimeElapsed:J
    ...
    invoke-direct {p0, p2}, callbackForCurrentState(Z)V
...
.method public onModeDeactivated()V
    ...
    iput-object v0, p0, mAssistHandleCallbacks:Lcom/android/systemui/assist/AssistHandleCallbacks;

    iget-object v1, p0, mContext:Landroid/content/Context;

    if-eqz v1, :cond_0

    iget-object v2, p0, mDefaultHomeBroadcastReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object p0, p0, mOverviewProxyListener:Lcom/android/systemui/recents/OverviewProxyService$OverviewProxyListener;
