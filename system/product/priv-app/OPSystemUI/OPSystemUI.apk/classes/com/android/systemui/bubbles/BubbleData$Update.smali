...
.method private constructor <init>(Ljava/util/List;)V
    ...
    iput-object v0, p0, removedBubbles:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, bubbles:Ljava/util/List;
...
.method anythingChanged()Z
    ...
    iget-boolean v0, p0, expandedChanged:Z

    if-nez v0, :cond_1

    iget-boolean v0, p0, selectionChanged:Z

    if-nez v0, :cond_1

    iget-object v0, p0, addedBubble:Lcom/android/systemui/bubbles/Bubble;

    if-nez v0, :cond_1

    iget-object v0, p0, updatedBubble:Lcom/android/systemui/bubbles/Bubble;

    if-nez v0, :cond_1

    iget-object v0, p0, removedBubbles:Ljava/util/List;
    ...
    iget-boolean p0, p0, orderChanged:Z
...
.method bubbleRemoved(Lcom/android/systemui/bubbles/Bubble;I)V
    ...
    iget-object p0, p0, removedBubbles:Ljava/util/List;
