...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;Lcom/android/systemui/plugins/statusbar/StatusBarStateController;Lcom/android/systemui/colorextraction/SysuiColorExtractor;Lcom/android/keyguard/clock/ClockManager;)V
    ...
    iput-object p1, p0, mStateListener:Lcom/android/systemui/plugins/statusbar/StatusBarStateController$StateListener;
    ...
    iput-object p1, p0, mClockChangedListener:Lcom/android/keyguard/clock/ClockManager$ClockChangedListener;
    ...
    iput-object p1, p0, mColorsListener:Lcom/android/internal/colorextraction/ColorExtractor$OnColorsChangedListener;

    iput-object p3, p0, mStatusBarStateController:Lcom/android/systemui/plugins/statusbar/StatusBarStateController;
    ...
    iput-object p4, p0, mSysuiColorExtractor:Lcom/android/systemui/colorextraction/SysuiColorExtractor;

    iput-object p5, p0, mClockManager:Lcom/android/keyguard/clock/ClockManager;
    ...
    iput-object p1, p0, mClockTransition:Lcom/android/keyguard/KeyguardClockSwitch$ClockVisibilityTransition;

    iget-object p1, p0, mClockTransition:Lcom/android/keyguard/KeyguardClockSwitch$ClockVisibilityTransition;
    ...
    iput-object p1, p0, mBoldClockTransition:Lcom/android/keyguard/KeyguardClockSwitch$ClockVisibilityTransition;

    iget-object p1, p0, mBoldClockTransition:Lcom/android/keyguard/KeyguardClockSwitch$ClockVisibilityTransition;
    ...
    iget-object p2, p0, mClockTransition:Lcom/android/keyguard/KeyguardClockSwitch$ClockVisibilityTransition;

    invoke-virtual {p1, p2}, Landroid/transition/TransitionSet;->addTransition(Landroid/transition/Transition;)Landroid/transition/TransitionSet;

    move-result-object p1

    iget-object p2, p0, mBoldClockTransition:Lcom/android/keyguard/KeyguardClockSwitch$ClockVisibilityTransition;
...
.method static synthetic access$100(Lcom/android/keyguard/KeyguardClockSwitch;)V
    ...
    invoke-direct {p0}, updateBigClockVisibility()V
...
.method static synthetic access$200(Lcom/android/keyguard/KeyguardClockSwitch;)Z
    ...
    iget-boolean p0, p0, mShowingHeader:Z
...
.method static synthetic access$300(Lcom/android/keyguard/KeyguardClockSwitch;)Landroid/widget/TextClock;
    ...
    iget-object p0, p0, mClockView:Landroid/widget/TextClock;
...
.method public static synthetic lambda$H31kNGqlEfE-tZQZgrBtirdKZKc(Lcom/android/keyguard/KeyguardClockSwitch;Lcom/android/systemui/plugins/ClockPlugin;)V
    ...
    invoke-direct {p0, p1}, setClockPlugin(Lcom/android/systemui/plugins/ClockPlugin;)V
...
.method private setClockPlugin(Lcom/android/systemui/plugins/ClockPlugin;)V
    ...
    iget-object v0, p0, mClockPlugin:Lcom/android/systemui/plugins/ClockPlugin;
    ...
    iget-object v2, p0, mSmallClockFrame:Landroid/widget/FrameLayout;
    ...
    iput-object v0, p0, mClockPlugin:Lcom/android/systemui/plugins/ClockPlugin;

    :cond_2
    if-nez p1, :cond_3

    iget-object p1, p0, mClockView:Landroid/widget/TextClock;

    const/4 v0, 0x0

    invoke-virtual {p1, v0}, Landroid/widget/TextClock;->setVisibility(I)V

    iget-object p1, p0, mClockViewBold:Landroid/widget/TextClock;

    const/4 v1, 0x4

    invoke-virtual {p1, v1}, Landroid/widget/TextClock;->setVisibility(I)V

    iget-object p0, p0, mKeyguardStatusArea:Landroid/view/View;
    ...
    iget-object v0, p0, mClockView:Landroid/widget/TextClock;

    invoke-virtual {v0, v1}, Landroid/widget/TextClock;->setVisibility(I)V

    iget-object v0, p0, mClockViewBold:Landroid/widget/TextClock;
    ...
    iget-object v2, p0, mBigClockContainer:Landroid/view/ViewGroup;
    ...
    iget-object v0, p0, mKeyguardStatusArea:Landroid/view/View;

    invoke-virtual {v0, v1}, Landroid/view/View;->setVisibility(I)V

    :cond_6
    iput-object p1, p0, mClockPlugin:Lcom/android/systemui/plugins/ClockPlugin;

    iget-object p1, p0, mClockPlugin:Lcom/android/systemui/plugins/ClockPlugin;

    invoke-virtual {p0}, getPaint()Landroid/graphics/Paint;
    ...
    invoke-virtual {p0}, getCurrentTextColor()I
    ...
    iget-object p1, p0, mColorPalette:[I

    if-eqz p1, :cond_7

    iget-object v0, p0, mClockPlugin:Lcom/android/systemui/plugins/ClockPlugin;

    iget-boolean p0, p0, mSupportsDarkText:Z
...
.method private updateColors()V
    ...
    iget-object v0, p0, mSysuiColorExtractor:Lcom/android/systemui/colorextraction/SysuiColorExtractor;
    ...
    iput-boolean v1, p0, mSupportsDarkText:Z

    invoke-virtual {v0}, Lcom/android/internal/colorextraction/ColorExtractor$GradientColors;->getColorPalette()[I

    move-result-object v0

    iput-object v0, p0, mColorPalette:[I

    iget-object v0, p0, mClockPlugin:Lcom/android/systemui/plugins/ClockPlugin;

    if-eqz v0, :cond_0

    iget-boolean v1, p0, mSupportsDarkText:Z

    iget-object p0, p0, mColorPalette:[I
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object p3, p0, mClockPlugin:Lcom/android/systemui/plugins/ClockPlugin;
    ...
    iget-object p3, p0, mClockView:Landroid/widget/TextClock;
    ...
    iget-object p3, p0, mClockViewBold:Landroid/widget/TextClock;
    ...
    iget-object p3, p0, mSmallClockFrame:Landroid/widget/FrameLayout;
    ...
    iget-object p3, p0, mBigClockContainer:Landroid/view/ViewGroup;
    ...
    iget-object p3, p0, mKeyguardStatusArea:Landroid/view/View;
    ...
    iget-boolean p3, p0, mShowingHeader:Z
    ...
    iget-boolean p3, p0, mSupportsDarkText:Z
...
.method getClockChangedListener()Lcom/android/keyguard/clock/ClockManager$ClockChangedListener;
    ...
    iget-object p0, p0, mClockChangedListener:Lcom/android/keyguard/clock/ClockManager$ClockChangedListener;
...
.method getPreferredY(I)I
    ...
    iget-object p0, p0, mClockPlugin:Lcom/android/systemui/plugins/ClockPlugin;
...
.method getStateListener()Lcom/android/systemui/plugins/statusbar/StatusBarStateController$StateListener;
    ...
    iget-object p0, p0, mStateListener:Lcom/android/systemui/plugins/statusbar/StatusBarStateController$StateListener;
...
.method protected onAttachedToWindow()V
    ...
    iget-object v1, p0, mColorsListener:Lcom/android/internal/colorextraction/ColorExtractor$OnColorsChangedListener;
...
.method protected onDetachedFromWindow()V
    ...
    invoke-direct {p0, v0}, setClockPlugin(Lcom/android/systemui/plugins/ClockPlugin;)V
...
.method protected onFinishInflate()V
    ...
    iput-object v0, p0, mClockView:Landroid/widget/TextClock;
    ...
    iput-object v0, p0, mClockViewBold:Landroid/widget/TextClock;
    ...
    iput-object v0, p0, mSmallClockFrame:Landroid/widget/FrameLayout;
    ...
    iput-object v0, p0, mKeyguardStatusArea:Landroid/view/View;

    invoke-virtual {p0}, setClockViewTypeface()V
...
.method public setBigClockContainer(Landroid/view/ViewGroup;)V
    ...
    :cond_0
    iput-object p1, p0, mBigClockContainer:Landroid/view/ViewGroup;
...
.method setKeyguardShowingHeader(Z)V
    ...
    iget-boolean v0, p0, mShowingHeader:Z

    if-eq v0, p1, :cond_6

    invoke-virtual {p0}, hasCustomClock()Z
    ...
    :cond_0
    iput-boolean p1, p0, mShowingHeader:Z
    ...
    iget-object v2, p0, mClockTransition:Lcom/android/keyguard/KeyguardClockSwitch$ClockVisibilityTransition;
    ...
    iget-object v2, p0, mBoldClockTransition:Lcom/android/keyguard/KeyguardClockSwitch$ClockVisibilityTransition;
    ...
    iget-object v0, p0, mTransition:Landroid/transition/Transition;
    ...
    iget-object v1, p0, mTransition:Landroid/transition/Transition;
    ...
    iget-object v2, p0, mClockView:Landroid/widget/TextClock;

    invoke-virtual {v2}, Landroid/widget/TextClock;->getPaddingTop()I

    move-result v2

    iget-object v3, p0, mClockView:Landroid/widget/TextClock;
    ...
    iget-object v2, p0, mClockViewBold:Landroid/widget/TextClock;

    invoke-virtual {v2}, Landroid/widget/TextClock;->getPaddingTop()I

    move-result v2

    iget-object p0, p0, mClockViewBold:Landroid/widget/TextClock;
