...
.method static constructor <clinit>()V
    ...
    sput-object v0, INSTANT_APP_BASE_URI:Landroid/net/Uri;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-boolean p1, p0, mPresentingChannelEditorDialog:Z

    const-string p2, "blocking_helper_dismissed"

    iput-object p2, p0, mExitReason:Ljava/lang/String;

    iput-boolean p1, p0, mIsInstantApp:Z

    const/4 p1, -0x1

    iput p1, p0, mCurrentAlertingBehavior:I
    ...
    iput-object p1, p0, mOnAlert:Landroid/view/View$OnClickListener;
    ...
    iput-object p1, p0, mOnSilent:Landroid/view/View$OnClickListener;
    ...
    iput-object p1, p0, mOnDismissSettings:Landroid/view/View$OnClickListener;
    ...
    iput-object p1, p0, mOnKeepShowing:Landroid/view/View$OnClickListener;
    ...
    iput-object p1, p0, mOnDeliverSilently:Landroid/view/View$OnClickListener;
    ...
    iput-object p1, p0, mOnStopOrMinimizeNotifications:Landroid/view/View$OnClickListener;
    ...
    iput-object p1, p0, mOnUndo:Landroid/view/View$OnClickListener;
...
.method static synthetic access$000()Landroid/net/Uri;
    ...
    sget-object v0, INSTANT_APP_BASE_URI:Landroid/net/Uri;
...
.method private applyAlertingBehavior(IZ)V
    ...
    iget p2, p0, mCurrentAlertingBehavior:I
    ...
    iget-object v4, p0, mSilentDescriptionView:Landroid/widget/TextView;

    invoke-virtual {v4, v1}, Landroid/widget/TextView;->setVisibility(I)V

    iget-object v4, p0, mPriorityDescriptionView:Landroid/widget/TextView;
    ...
    :goto_0
    iget-boolean p2, p0, mWasShownHighPriority:Z
...
.method private bindBlockingHelper()V
    ...
    iget-object v3, p0, mOnUndo:Landroid/view/View$OnClickListener;
    ...
    invoke-direct {p0}, getSettingsOnClickListener()Landroid/view/View$OnClickListener;
    ...
    iget-object v1, p0, mOnKeepShowing:Landroid/view/View$OnClickListener;
    ...
    iget-object p0, p0, mOnDeliverSilently:Landroid/view/View$OnClickListener;
...
.method private bindChannelDetails()V
    ...
    invoke-direct {p0}, bindName()V

    invoke-direct {p0}, bindGroup()V
...
.method private bindDelegate()V
    ...
    iget-object p0, p0, mDelegatePkg:Ljava/lang/String;
...
.method private bindGroup()V
    ...
    iget-object v0, p0, mSingleNotificationChannel:Landroid/app/NotificationChannel;
    ...
    iget-object v0, p0, mINotificationManager:Landroid/app/INotificationManager;

    iget-object v1, p0, mSingleNotificationChannel:Landroid/app/NotificationChannel;
...
.method private bindHeader()V
    ...
    iput-object v0, p0, mPkgIcon:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v1, p0, mAppName:Ljava/lang/String;
    ...
    iget-object v1, p0, mPkgIcon:Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0}, bindDelegate()V
    ...
    iget-object v4, p0, mSingleNotificationChannel:Landroid/app/NotificationChannel;

    iget-object v1, p0, mSbn:Landroid/service/notification/StatusBarNotification;
    ...
    invoke-direct/range {v1 .. v6}, getAppSettingsIntent(Landroid/content/pm/PackageManager;Ljava/lang/String;Landroid/app/NotificationChannel;ILjava/lang/String;)Landroid/content/Intent;
    ...
    iget-object v4, p0, mSbn:Landroid/service/notification/StatusBarNotification;
...
.method private bindInlineControls()V
    ...
    iget-boolean v0, p0, mIsNonblockable:Z
    ...
    :cond_0
    iget v0, p0, mNumUniqueChannelsInRow:I
    ...
    :cond_1
    iget-boolean v0, p0, mIsInstantApp:Z
    ...
    iget-object v4, p0, mOnStopOrMinimizeNotifications:Landroid/view/View$OnClickListener;
    ...
    iget-boolean v4, p0, mIsNonblockable:Z
    ...
    iget-object v2, p0, mOnDismissSettings:Landroid/view/View$OnClickListener;
    ...
    iget-object v4, p0, mOnSilent:Landroid/view/View$OnClickListener;

    invoke-virtual {v0, v4}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v0, p0, mOnAlert:Landroid/view/View$OnClickListener;

    invoke-virtual {v2, v0}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-boolean v0, p0, mWasShownHighPriority:Z

    xor-int/2addr v0, v3

    invoke-direct {p0, v0, v1}, applyAlertingBehavior(IZ)V
...
.method private bindName()V
    ...
    iget-boolean v1, p0, mIsSingleDefaultChannel:Z

    if-nez v1, :cond_1

    iget v1, p0, mNumUniqueChannelsInRow:I
    ...
    :cond_0
    iget-object p0, p0, mSingleNotificationChannel:Landroid/app/NotificationChannel;
...
.method private getLogMaker()Landroid/metrics/LogMaker;
    ...
    iget-object p0, p0, mSbn:Landroid/service/notification/StatusBarNotification;
...
.method private getSettingsOnClickListener()Landroid/view/View$OnClickListener;
    ...
    iget v0, p0, mAppUid:I

    if-ltz v0, :cond_0

    iget-object v1, p0, mOnSettingsClickListener:Lcom/android/systemui/statusbar/notification/row/NotificationInfo$OnSettingsClickListener;

    if-eqz v1, :cond_0

    iget-boolean v1, p0, mIsDeviceProvisioned:Z
...
.method private handleSaveImportance(II)V
    ...
    iget-object p1, p0, mCheckSaveListener:Lcom/android/systemui/statusbar/notification/row/NotificationInfo$CheckSaveListener;
...
.method private importanceChangeLogMaker()Landroid/metrics/LogMaker;
    ...
    iget-object v0, p0, mChosenImportance:Ljava/lang/Integer;
    ...
    :cond_0
    iget v0, p0, mStartingChannelImportance:I
    ...
    invoke-direct {p0}, getLogMaker()Landroid/metrics/LogMaker;
    ...
    iget p0, p0, mStartingChannelImportance:I
...
.method private notificationControlsLogMaker()Landroid/metrics/LogMaker;
    ...
    iget-boolean p0, p0, mIsForBlockingHelper:Z
...
.method private saveImportance()V
    ...
    iget-object v0, p0, mExitReason:Ljava/lang/String;
    ...
    iput-object v0, p0, mChosenImportance:Ljava/lang/Integer;

    :cond_1
    invoke-direct {p0}, updateImportance()V
...
.method private saveImportanceAndExitReason(I)V
    ...
    iput-object p1, p0, mExitReason:Ljava/lang/String;

    iget-boolean p1, p0, mWasShownHighPriority:Z
    ...
    :cond_0
    iget p1, p0, mStartingChannelImportance:I
    ...
    iput-object p1, p0, mChosenImportance:Ljava/lang/Integer;
    ...
    iget-boolean p1, p0, mIsInstantApp:Z
    ...
    sget-object v3, INSTANT_APP_BASE_URI:Landroid/net/Uri;

    iget-object v4, p0, mInstantAppPkg:Ljava/lang/String;
    ...
    :goto_1
    iput-boolean v2, p0, mPressedApply:Z
...
.method private swapContent(IZ)V
    ...
    iget-object v0, p0, mExpandAnimation:Landroid/animation/AnimatorSet;
    ...
    iget-object v4, p0, mOnUndo:Landroid/view/View$OnClickListener;

    invoke-virtual {v3, v4}, Landroid/widget/TextView;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-direct {p0, p1}, saveImportanceAndExitReason(I)V
    ...
    :cond_3
    invoke-direct {p0}, bindInlineControls()V
    ...
    iput-object v6, p0, mExpandAnimation:Landroid/animation/AnimatorSet;

    iget-object v6, p0, mExpandAnimation:Landroid/animation/AnimatorSet;
    ...
    iget-object p2, p0, mExpandAnimation:Landroid/animation/AnimatorSet;
    ...
    iget-object p1, p0, mExpandAnimation:Landroid/animation/AnimatorSet;

    invoke-virtual {p1}, Landroid/animation/AnimatorSet;->start()V

    :cond_c
    iget-object p0, p0, mGutsContainer:Lcom/android/systemui/statusbar/notification/row/NotificationGuts;
...
.method private updateImportance()V
    ...
    invoke-direct {p0}, importanceChangeLogMaker()Landroid/metrics/LogMaker;
    ...
    iget-object v2, p0, mINotificationManager:Landroid/app/INotificationManager;

    iget-object v3, p0, mPackageName:Ljava/lang/String;

    iget v4, p0, mAppUid:I
    ...
    iget v6, p0, mStartingChannelImportance:I

    iget-object v8, p0, Landroid/widget/LinearLayout;->mContext:Landroid/content/Context;

    iget-object v9, p0, mSbn:Landroid/service/notification/StatusBarNotification;

    iget-boolean v10, p0, mIsInstantApp:Z
    ...
    iget-object p0, p0, mVisualStabilityManager:Lcom/android/systemui/statusbar/notification/VisualStabilityManager;
...
.method public bindNotification(Landroid/content/pm/PackageManager;Landroid/app/INotificationManager;Lcom/android/systemui/statusbar/notification/VisualStabilityManager;Ljava/lang/String;Landroid/app/NotificationChannel;Ljava/util/Set;Landroid/service/notification/StatusBarNotification;Lcom/android/systemui/statusbar/notification/row/NotificationInfo$CheckSaveListener;Lcom/android/systemui/statusbar/notification/row/NotificationInfo$OnSettingsClickListener;Lcom/android/systemui/statusbar/notification/row/NotificationInfo$OnAppSettingsClickListener;ZZZIZ)V
    ...
    iput-object p2, p0, mINotificationManager:Landroid/app/INotificationManager;
    ...
    iput-object p3, p0, mVisualStabilityManager:Lcom/android/systemui/statusbar/notification/VisualStabilityManager;
    ...
    iput-object p2, p0, mChannelEditorDialogController:Lcom/android/systemui/statusbar/notification/row/ChannelEditorDialogController;

    iput-object p4, p0, mPackageName:Ljava/lang/String;

    iput-object p6, p0, mUniqueChannelsInRow:Ljava/util/Set;

    invoke-interface {p6}, Ljava/util/Set;->size()I

    move-result p2

    iput p2, p0, mNumUniqueChannelsInRow:I

    iput-object p7, p0, mSbn:Landroid/service/notification/StatusBarNotification;

    iput-object p1, p0, mPm:Landroid/content/pm/PackageManager;

    iput-object p10, p0, mAppSettingsClickListener:Lcom/android/systemui/statusbar/notification/row/NotificationInfo$OnAppSettingsClickListener;

    iget-object p1, p0, mPackageName:Ljava/lang/String;

    iput-object p1, p0, mAppName:Ljava/lang/String;

    iput-object p8, p0, mCheckSaveListener:Lcom/android/systemui/statusbar/notification/row/NotificationInfo$CheckSaveListener;

    iput-object p9, p0, mOnSettingsClickListener:Lcom/android/systemui/statusbar/notification/row/NotificationInfo$OnSettingsClickListener;

    iput-object p5, p0, mSingleNotificationChannel:Landroid/app/NotificationChannel;

    iget-object p1, p0, mSingleNotificationChannel:Landroid/app/NotificationChannel;

    invoke-virtual {p1}, Landroid/app/NotificationChannel;->getImportance()I

    move-result p1

    iput p1, p0, mStartingChannelImportance:I

    iput-boolean p15, p0, mWasShownHighPriority:Z

    iput-boolean p12, p0, mIsNonblockable:Z

    iput-boolean p13, p0, mIsForBlockingHelper:Z

    iget-object p1, p0, mSbn:Landroid/service/notification/StatusBarNotification;

    invoke-virtual {p1}, Landroid/service/notification/StatusBarNotification;->getUid()I

    move-result p1

    iput p1, p0, mAppUid:I
    ...
    iput-object p1, p0, mDelegatePkg:Ljava/lang/String;

    iput-boolean p11, p0, mIsDeviceProvisioned:Z
    ...
    iget-object p1, p0, mINotificationManager:Landroid/app/INotificationManager;

    iget p2, p0, mAppUid:I
    ...
    iget p2, p0, mNumUniqueChannelsInRow:I
    ...
    iget-object p2, p0, mSingleNotificationChannel:Landroid/app/NotificationChannel;
    ...
    :goto_0
    iput-boolean p4, p0, mIsSingleDefaultChannel:Z

    invoke-direct {p0}, bindHeader()V

    invoke-direct {p0}, bindChannelDetails()V

    iget-boolean p1, p0, mIsForBlockingHelper:Z

    if-eqz p1, :cond_1

    invoke-direct {p0}, bindBlockingHelper()V
    ...
    iput-object p1, p0, mInstantAppPkg:Ljava/lang/String;
    ...
    sget-object p1, INSTANT_APP_BASE_URI:Landroid/net/Uri;

    iget-object p2, p0, mInstantAppPkg:Ljava/lang/String;
    ...
    iput-object p4, p0, mPkgIcon:Landroid/graphics/drawable/Drawable;
    :try_end_0
    ...
    iget-object p2, p0, mPkgIcon:Landroid/graphics/drawable/Drawable;
    ...
    iget-object p2, p0, mAppName:Ljava/lang/String;
    ...
    invoke-direct {p0}, notificationControlsLogMaker()Landroid/metrics/LogMaker;
    ...
    iput p1, p0, mSecondaryColor:I

    iget p1, p0, mOneplusAccentColor:I
    ...
    iget p2, p0, mOneplusAccentColor:I
    ...
    iget p3, p0, mImportanceButtonStroke:I

    if-eqz p1, :cond_6

    iget p4, p0, mOneplusAccentColor:I

    goto :goto_5

    :cond_6
    iget p4, p0, mSecondaryColor:I
    ...
    iget p3, p0, mOneplusAccentColor:I

    goto :goto_6

    :cond_7
    iget p3, p0, mSecondaryColor:I
    ...
    iget p0, p0, mOneplusAccentColor:I

    goto :goto_a

    :cond_b
    iget p0, p0, mSecondaryColor:I
...
.method closeControls(Landroid/view/View;Z)V
    ...
    iget-object v3, p0, mGutsContainer:Lcom/android/systemui/statusbar/notification/row/NotificationGuts;
...
.method public handleCloseControls(ZZ)Z
    ...
    iget-boolean p2, p0, mPresentingChannelEditorDialog:Z

    const/4 v0, 0x0

    if-eqz p2, :cond_0

    iget-object p2, p0, mChannelEditorDialogController:Lcom/android/systemui/statusbar/notification/row/ChannelEditorDialogController;

    if-eqz p2, :cond_0

    iput-boolean v0, p0, mPresentingChannelEditorDialog:Z
    ...
    invoke-direct {p0}, saveImportance()V

    :cond_1
    iget-object p1, p0, mExitReason:Ljava/lang/String;

    invoke-virtual {p0, p1}, logBlockingHelperCounter(Ljava/lang/String;)V
...
.method public isAnimating()Z
    ...
    iget-object p0, p0, mExpandAnimation:Landroid/animation/AnimatorSet;
...
.method public synthetic lambda$applyAlertingBehavior$12$NotificationInfo(Landroid/view/View;Landroid/view/View;)V
    ...
    iget v0, p0, mOneplusAccentColor:I
    ...
    iget v0, p0, mImportanceButtonStroke:I

    iget v1, p0, mSecondaryColor:I
    ...
    iget p2, p0, mImportanceButtonStroke:I
...
.method public synthetic lambda$bindHeader$8$NotificationInfo(Landroid/content/Intent;Landroid/view/View;)V
    ...
    iget-object p0, p0, mAppSettingsClickListener:Lcom/android/systemui/statusbar/notification/row/NotificationInfo$OnAppSettingsClickListener;
...
.method public synthetic lambda$getSettingsOnClickListener$9$NotificationInfo(ILandroid/view/View;)V
    ...
    invoke-virtual {p0, v0}, logBlockingHelperCounter(Ljava/lang/String;)V

    iget-object v0, p0, mOnSettingsClickListener:Lcom/android/systemui/statusbar/notification/row/NotificationInfo$OnSettingsClickListener;
...
.method public synthetic lambda$handleSaveImportance$6$NotificationInfo(II)V
    ...
    iget-boolean v0, p0, mIsForBlockingHelper:Z

    if-eqz v0, :cond_0

    const/4 v0, 0x1

    invoke-direct {p0, p1, v0}, swapContent(IZ)V
...
.method public synthetic lambda$new$0$NotificationInfo(Landroid/view/View;)V
    ...
    invoke-direct {p0, p1, v0}, applyAlertingBehavior(IZ)V
...
.method public synthetic lambda$new$1$NotificationInfo(Landroid/view/View;)V
    ...
    invoke-direct {p0, p1, p1}, applyAlertingBehavior(IZ)V
...
.method public synthetic lambda$new$2$NotificationInfo(Landroid/view/View;)V
    ...
    iput-boolean v0, p0, mPressedApply:Z

    invoke-virtual {p0, p1, v0}, closeControls(Landroid/view/View;Z)V
...
.method public synthetic lambda$new$3$NotificationInfo(Landroid/view/View;)V
    ...
    iput-object v0, p0, mExitReason:Ljava/lang/String;
...
.method public synthetic lambda$new$4$NotificationInfo(Landroid/view/View;)V
    ...
    invoke-direct {p0, p1, v0}, handleSaveImportance(II)V
...
.method public synthetic lambda$new$7$NotificationInfo(Landroid/view/View;)V
    ...
    invoke-direct {p0, p1, p1}, swapContent(IZ)V
...
.method protected onFinishInflate()V
    ...
    iput-object v0, p0, mPriorityDescriptionView:Landroid/widget/TextView;
    ...
    iput-object v0, p0, mSilentDescriptionView:Landroid/widget/TextView;
...
.method public onFinishedClosing()V
    ...
    iput v0, p0, mStartingChannelImportance:I
...
.method public onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    iget-object v0, p0, mGutsContainer:Lcom/android/systemui/statusbar/notification/row/NotificationGuts;
...
.method public setGutsParent(Lcom/android/systemui/statusbar/notification/row/NotificationGuts;)V
    ...
    iput-object p1, p0, mGutsContainer:Lcom/android/systemui/statusbar/notification/row/NotificationGuts;
...
.method public shouldBeSaved()Z
    ...
    iget-boolean p0, p0, mPressedApply:Z
