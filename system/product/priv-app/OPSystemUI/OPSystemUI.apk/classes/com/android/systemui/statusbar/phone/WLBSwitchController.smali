...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v0, p0, mPreviousExpansion:F

    const/4 v0, 0x1

    iput-boolean v0, p0, isAdminUser:Z
    ...
    iput-object v1, p0, mMessenger:Landroid/os/Messenger;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, mModes:Ljava/util/ArrayList;

    const/4 v1, 0x0

    iput v1, p0, mCurrentMode:I

    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    iput-object v2, p0, mAdapters:Ljava/util/ArrayList;

    const/high16 v2, -0x40800000    # -1.0f

    iput v2, p0, mHeaderExpansion:F

    iput-boolean v0, p0, isWLBDetailClosed:Z
    ...
    iput-object v0, p0, wlbDetailAdapter:Lcom/android/systemui/plugins/qs/DetailAdapter;
    ...
    invoke-virtual {p0, p1}, setCurrentMode(I)V

    invoke-direct {p0}, processModes()V
...
.method static synthetic access$100(Lcom/android/systemui/statusbar/phone/WLBSwitchController;)Z
    ...
    iget-boolean p0, p0, mIsFullyExpanded:Z
...
.method static synthetic access$200(Lcom/android/systemui/statusbar/phone/WLBSwitchController;)Landroid/os/Messenger;
    ...
    iget-object p0, p0, mService:Landroid/os/Messenger;
...
.method static synthetic access$400(Lcom/android/systemui/statusbar/phone/WLBSwitchController;)Landroid/os/Messenger;
    ...
    iget-object p0, p0, mMessenger:Landroid/os/Messenger;
...
.method static synthetic access$500(Lcom/android/systemui/statusbar/phone/WLBSwitchController;Ljava/lang/ref/WeakReference;)V
    ...
    invoke-direct {p0, p1}, addAdapter(Ljava/lang/ref/WeakReference;)V
...
.method static synthetic access$900(Lcom/android/systemui/statusbar/phone/WLBSwitchController;)Lcom/android/systemui/statusbar/phone/WLBSwitchController$WLBControllerCallbacks;
    ...
    iget-object p0, p0, mDetailViewCallBack:Lcom/android/systemui/statusbar/phone/WLBSwitchController$WLBControllerCallbacks;
...
.method private processModes()V
    ...
    invoke-virtual {p0}, getCurrentMode()I
    ...
    :goto_6
    iget-object v3, p0, mModes:Ljava/util/ArrayList;
...
.method doBindService()V
    ...
    iget-object p0, p0, mConnection:Landroid/content/ServiceConnection;
...
.method doUnbindService()V
    ...
    iget-object v0, p0, mService:Landroid/os/Messenger;
...
.method public getModes()Ljava/util/ArrayList;
    ...
    iget-object p0, p0, mModes:Ljava/util/ArrayList;
...
.method public hideStatusBarIcon()V
    ...
    iget-object v2, p0, mCallBacks:Lcom/android/systemui/statusbar/phone/WLBSwitchController$WLBControllerCallbacks;
    ...
    iget-object p0, p0, mCallBacks:Lcom/android/systemui/statusbar/phone/WLBSwitchController$WLBControllerCallbacks;
...
.method public onWLBModeChanged()V
    ...
    iget-object v2, p0, mDetailViewCallBack:Lcom/android/systemui/statusbar/phone/WLBSwitchController$WLBControllerCallbacks;
    ...
    iget-boolean v0, p0, isAdminUser:Z
    ...
    :cond_0
    iget-object v0, p0, mCallBacks:Lcom/android/systemui/statusbar/phone/WLBSwitchController$WLBControllerCallbacks;
    ...
    :cond_1
    iget-object v0, p0, mDetailViewCallBack:Lcom/android/systemui/statusbar/phone/WLBSwitchController$WLBControllerCallbacks;
...
.method public setAdminUser(Z)V
    ...
    iput-boolean p1, p0, isAdminUser:Z
...
.method public setCallBacks(Lcom/android/systemui/statusbar/phone/WLBSwitchController$WLBControllerCallbacks;)V
    ...
    iput-object p1, p0, mCallBacks:Lcom/android/systemui/statusbar/phone/WLBSwitchController$WLBControllerCallbacks;
...
.method public setDetailViewCallBack(Lcom/android/systemui/statusbar/phone/WLBSwitchController$WLBControllerCallbacks;)V
    ...
    iput-object p1, p0, mDetailViewCallBack:Lcom/android/systemui/statusbar/phone/WLBSwitchController$WLBControllerCallbacks;
...
.method public setIsFullyExpanded(Z)V
    ...
    iput-boolean p1, p0, mIsFullyExpanded:Z
...
.method public setSwitchCallbacks(Lcom/android/systemui/statusbar/phone/WLBSwitchController$WLBSwitchCallbacks;)V
    ...
    iput-object p1, p0, mSwitchCallbacks:Lcom/android/systemui/statusbar/phone/WLBSwitchController$WLBSwitchCallbacks;
...
.method public updateExpansionState(F)V
    ...
    iget v0, p0, mPreviousExpansion:F
    ...
    :cond_0
    iput p1, p0, mPreviousExpansion:F
    ...
    :cond_1
    iget-object p0, p0, mSwitchCallbacks:Lcom/android/systemui/statusbar/phone/WLBSwitchController$WLBSwitchCallbacks;
...
.method public updateHeaderExpansion(F)V
    ...
    iget-boolean p1, p0, isWLBDetailClosed:Z
    ...
    iput-boolean p1, p0, isWLBDetailClosed:Z
