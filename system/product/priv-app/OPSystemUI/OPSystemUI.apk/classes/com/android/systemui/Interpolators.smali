...
.method static constructor <clinit>()V
    ...
    sput-object v0, FAST_OUT_SLOW_IN:Landroid/view/animation/Interpolator;
    ...
    sput-object v0, FAST_OUT_SLOW_IN_REVERSE:Landroid/view/animation/Interpolator;

    new-instance v0, Landroid/view/animation/PathInterpolator;

    invoke-direct {v0, v2, v4, v3, v3}, Landroid/view/animation/PathInterpolator;-><init>(FFFF)V

    sput-object v0, FAST_OUT_LINEAR_IN:Landroid/view/animation/Interpolator;

    new-instance v0, Landroid/view/animation/PathInterpolator;

    invoke-direct {v0, v4, v4, v1, v3}, Landroid/view/animation/PathInterpolator;-><init>(FFFF)V

    sput-object v0, LINEAR_OUT_SLOW_IN:Landroid/view/animation/Interpolator;

    new-instance v0, Landroid/view/animation/PathInterpolator;

    invoke-direct {v0, v2, v4, v3, v3}, Landroid/view/animation/PathInterpolator;-><init>(FFFF)V

    sput-object v0, ALPHA_IN:Landroid/view/animation/Interpolator;

    new-instance v0, Landroid/view/animation/PathInterpolator;

    invoke-direct {v0, v4, v4, v6, v3}, Landroid/view/animation/PathInterpolator;-><init>(FFFF)V

    sput-object v0, ALPHA_OUT:Landroid/view/animation/Interpolator;
    ...
    sput-object v0, ACCELERATE:Landroid/view/animation/Interpolator;

    new-instance v0, Landroid/view/animation/AccelerateDecelerateInterpolator;

    invoke-direct {v0}, Landroid/view/animation/AccelerateDecelerateInterpolator;-><init>()V

    sput-object v0, ACCELERATE_DECELERATE:Landroid/view/animation/Interpolator;
    ...
    sput-object v0, CUSTOM_40_40:Landroid/view/animation/Interpolator;
    ...
    sput-object v0, HEADS_UP_APPEAR:Landroid/view/animation/Interpolator;
    ...
    sput-object v0, ICON_OVERSHOT:Landroid/view/animation/Interpolator;
    ...
    sput-object v0, PANEL_CLOSE_ACCELERATED:Landroid/view/animation/Interpolator;

    new-instance v0, Landroid/view/animation/BounceInterpolator;

    invoke-direct {v0}, Landroid/view/animation/BounceInterpolator;-><init>()V

    sput-object v0, BOUNCE:Landroid/view/animation/Interpolator;
    ...
    sput-object v0, TOUCH_RESPONSE:Landroid/view/animation/Interpolator;
    ...
    sput-object v0, TOUCH_RESPONSE_REVERSE:Landroid/view/animation/Interpolator;
