...
.method static constructor <clinit>()V
    ...
    sput-object v0, sInstancePool:Landroid/util/Pools$SimplePool;
    ...
    sput-object v0, CLIPPING_PARAMETERS:Lcom/android/internal/widget/ViewClippingUtil$ClippingParameters;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mOwnPosition:[I

    const/high16 v0, -0x40800000    # -1.0f

    iput v0, p0, mTransformationEndY:F

    iput v0, p0, mTransformationEndX:F
...
.method public static createFrom(Landroid/view/View;Lcom/android/systemui/statusbar/notification/TransformState$TransformInfo;)Lcom/android/systemui/statusbar/notification/TransformState;
    ...
    invoke-virtual {v0, p0, p1}, initFrom(Landroid/view/View;Lcom/android/systemui/statusbar/notification/TransformState$TransformInfo;)V
    ...
    invoke-virtual {v0, p0}, setIsSameAsAnyView(Z)V
    ...
    :cond_6
    invoke-static {}, obtain()Lcom/android/systemui/statusbar/notification/TransformState;
...
.method public static obtain()Lcom/android/systemui/statusbar/notification/TransformState;
    ...
    sget-object v0, sInstancePool:Landroid/util/Pools$SimplePool;
...
.method private setTransformationStartScaleX(F)V
    ...
    iget-object p0, p0, mTransformedView:Landroid/view/View;

    sget v0, TRANSFORMATION_START_SCLALE_X:I
...
.method private setTransformationStartScaleY(F)V
    ...
    sget v0, TRANSFORMATION_START_SCLALE_Y:I
...
.method private transformViewTo(Lcom/android/systemui/statusbar/notification/TransformState;ILcom/android/systemui/statusbar/ViewTransformationHelper$CustomTransformation;F)V
    ...
    iget-object v4, v0, mTransformedView:Landroid/view/View;
    ...
    :goto_1
    invoke-virtual/range {p0 .. p1}, transformScale(Lcom/android/systemui/statusbar/notification/TransformState;)Z
    ...
    invoke-virtual/range {p0 .. p0}, getTransformationStartX()F
    ...
    :goto_2
    invoke-virtual {v0, v12}, setTransformationStartX(F)V

    :cond_3
    if-eqz v9, :cond_5

    invoke-virtual/range {p0 .. p0}, getTransformationStartY()F
    ...
    :goto_3
    invoke-virtual {v0, v12}, setTransformationStartY(F)V

    :cond_5
    invoke-virtual/range {p1 .. p1}, getTransformedView()Landroid/view/View;

    if-eqz v10, :cond_6

    invoke-virtual/range {p1 .. p1}, getViewWidth()I

    move-result v12

    invoke-virtual/range {p0 .. p0}, getViewWidth()I
    ...
    invoke-direct {v0, v12}, setTransformationStartScaleX(F)V
    ...
    :cond_6
    invoke-direct {v0, v13}, setTransformationStartScaleX(F)V

    :goto_4
    if-eqz v10, :cond_7

    invoke-virtual/range {p1 .. p1}, getViewHeight()I

    move-result v12

    invoke-virtual/range {p0 .. p0}, getViewHeight()I
    ...
    invoke-direct {v0, v12}, setTransformationStartScaleY(F)V
    ...
    :cond_7
    invoke-direct {v0, v13}, setTransformationStartScaleY(F)V

    :goto_5
    invoke-virtual {v0, v4, v7}, setClippingDeactivated(Landroid/view/View;Z)V

    :cond_8
    iget-object v11, v0, mDefaultInterpolator:Landroid/view/animation/Interpolator;

    invoke-interface {v11, v3}, Landroid/view/animation/Interpolator;->getInterpolation(F)F

    move-result v11

    invoke-virtual/range {p1 .. p1}, getLaidOutLocationOnScreen()[I

    move-result-object v12

    invoke-virtual/range {p0 .. p0}, getLaidOutLocationOnScreen()[I
    ...
    iget v5, v0, mTransformationEndX:F
    ...
    iget v5, v0, mTransformationEndY:F
    ...
    invoke-virtual/range {p0 .. p0}, getTransformationStartScaleX()F
    ...
    :cond_f
    invoke-virtual/range {p0 .. p0}, getTransformationStartScaleY()F
...
.method public abortTransformation()V
    ...
    iget-object v0, p0, mTransformedView:Landroid/view/View;

    sget v1, TRANSFORMATION_START_X:I
    ...
    sget v1, TRANSFORMATION_START_Y:I

    invoke-virtual {v0, v1, v2}, Landroid/view/View;->setTag(ILjava/lang/Object;)V

    iget-object v0, p0, mTransformedView:Landroid/view/View;

    sget v1, TRANSFORMATION_START_SCLALE_X:I
...
.method public appear(FLcom/android/systemui/statusbar/TransformableView;)V
    ...
    invoke-virtual {p0}, prepareFadeIn()V
...
.method public getLaidOutLocationOnScreen()[I
    ...
    invoke-virtual {p0}, getLocationOnScreen()[I
    ...
    iget-object v3, p0, mTransformedView:Landroid/view/View;
...
.method public getLocationOnScreen()[I
    ...
    iget-object v1, p0, mOwnPosition:[I

    invoke-virtual {v0, v1}, Landroid/view/View;->getLocationOnScreen([I)V

    iget-object v0, p0, mOwnPosition:[I
    ...
    iget-object v5, p0, mTransformedView:Landroid/view/View;
    ...
    iget-object v4, p0, mTransformedView:Landroid/view/View;
    ...
    iget-object p0, p0, mOwnPosition:[I
...
.method public getTransformationStartX()F
    ...
    sget v0, TRANSFORMATION_START_X:I
...
.method public getTransformationStartY()F
    ...
    sget v0, TRANSFORMATION_START_Y:I
...
.method public initFrom(Landroid/view/View;Lcom/android/systemui/statusbar/notification/TransformState$TransformInfo;)V
    ...
    iput-object p1, p0, mTransformedView:Landroid/view/View;

    iput-object p2, p0, mTransformInfo:Lcom/android/systemui/statusbar/notification/TransformState$TransformInfo;
...
.method public prepareFadeIn()V
    ...
    invoke-virtual {p0}, resetTransformedView()V
...
.method protected reset()V
    ...
    iput-object v0, p0, mTransformedView:Landroid/view/View;

    iput-object v0, p0, mTransformInfo:Lcom/android/systemui/statusbar/notification/TransformState$TransformInfo;

    const/4 v0, 0x0

    iput-boolean v0, p0, mSameAsAny:Z
...
.method protected resetTransformedView()V
    ...
    invoke-virtual {p0, v0, v1}, setClippingDeactivated(Landroid/view/View;Z)V

    invoke-virtual {p0}, abortTransformation()V
...
.method protected sameAs(Lcom/android/systemui/statusbar/notification/TransformState;)Z
    ...
    iget-boolean p0, p0, mSameAsAny:Z
...
.method protected setClippingDeactivated(Landroid/view/View;Z)V
    ...
    sget-object p0, CLIPPING_PARAMETERS:Lcom/android/internal/widget/ViewClippingUtil$ClippingParameters;
...
.method public setDefaultInterpolator(Landroid/view/animation/Interpolator;)V
    ...
    iput-object p1, p0, mDefaultInterpolator:Landroid/view/animation/Interpolator;
...
.method public setIsSameAsAnyView(Z)V
    ...
    iput-boolean p1, p0, mSameAsAny:Z
...
.method public setTransformationEndY(F)V
    ...
    iput p1, p0, mTransformationEndY:F
...
.method public setVisible(ZZ)V
    ...
    iget-object p2, p0, mTransformedView:Landroid/view/View;
...
.method public transformViewFrom(Lcom/android/systemui/statusbar/notification/TransformState;F)V
    ...
    invoke-virtual {p0, p1}, sameAs(Lcom/android/systemui/statusbar/notification/TransformState;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, ensureVisible()V
    ...
    :goto_0
    invoke-virtual {p0, p1, p2}, transformViewFullyFrom(Lcom/android/systemui/statusbar/notification/TransformState;F)V
...
.method protected transformViewFrom(Lcom/android/systemui/statusbar/notification/TransformState;ILcom/android/systemui/statusbar/ViewTransformationHelper$CustomTransformation;F)V
    ...
    iget-object v3, v0, mTransformedView:Landroid/view/View;
    ...
    :cond_a
    invoke-virtual/range {p1 .. p1}, getLocationOnScreen()[I
    ...
    invoke-virtual {v0, v5}, setTransformationStartX(F)V
    ...
    invoke-virtual {v0, v5}, setTransformationStartY(F)V
    ...
    invoke-direct {v0, v7}, setTransformationStartScaleX(F)V
    ...
    invoke-direct {v0, v7}, setTransformationStartScaleY(F)V
    ...
    invoke-direct {v0, v5}, setTransformationStartScaleY(F)V
    ...
    invoke-direct {v0, v5}, setTransformationStartScaleX(F)V

    invoke-direct {v0, v5}, setTransformationStartScaleY(F)V

    :cond_13
    invoke-virtual {v0, v3, v6}, setClippingDeactivated(Landroid/view/View;Z)V

    :cond_14
    iget-object v5, v0, mDefaultInterpolator:Landroid/view/animation/Interpolator;
...
.method public transformViewFullyFrom(Lcom/android/systemui/statusbar/notification/TransformState;F)V
    ...
    invoke-virtual {p0, p1, v0, v1, p2}, transformViewFrom(Lcom/android/systemui/statusbar/notification/TransformState;ILcom/android/systemui/statusbar/ViewTransformationHelper$CustomTransformation;F)V
...
.method public transformViewFullyFrom(Lcom/android/systemui/statusbar/notification/TransformState;Lcom/android/systemui/statusbar/ViewTransformationHelper$CustomTransformation;F)V
    ...
    invoke-virtual {p0, p1, v0, p2, p3}, transformViewFrom(Lcom/android/systemui/statusbar/notification/TransformState;ILcom/android/systemui/statusbar/ViewTransformationHelper$CustomTransformation;F)V
...
.method public transformViewFullyTo(Lcom/android/systemui/statusbar/notification/TransformState;F)V
    ...
    invoke-direct {p0, p1, v0, v1, p2}, transformViewTo(Lcom/android/systemui/statusbar/notification/TransformState;ILcom/android/systemui/statusbar/ViewTransformationHelper$CustomTransformation;F)V
...
.method public transformViewFullyTo(Lcom/android/systemui/statusbar/notification/TransformState;Lcom/android/systemui/statusbar/ViewTransformationHelper$CustomTransformation;F)V
    ...
    invoke-direct {p0, p1, v0, p2, p3}, transformViewTo(Lcom/android/systemui/statusbar/notification/TransformState;ILcom/android/systemui/statusbar/ViewTransformationHelper$CustomTransformation;F)V
...
.method public transformViewTo(Lcom/android/systemui/statusbar/notification/TransformState;F)Z
    ...
    iget-object p1, p0, mTransformedView:Landroid/view/View;
    ...
    invoke-virtual {p0, p1, p2}, transformViewFullyTo(Lcom/android/systemui/statusbar/notification/TransformState;F)V
