...
.method constructor <init>(Lcom/android/systemui/statusbar/AmbientPulseManager;)V
    ...
    iput-object v1, p0, mFirstInSectionViews:[Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;

    new-array v1, v0, [Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;

    iput-object v1, p0, mLastInSectionViews:[Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;

    new-array v1, v0, [Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;

    iput-object v1, p0, mTmpFirstInSectionViews:[Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;

    new-array v0, v0, [Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;

    iput-object v0, p0, mTmpLastInSectionViews:[Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;
...
.method private getRoundness(Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;Z)F
    ...
    invoke-direct {p0, p1, v0}, isFirstInSection(Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;Z)Z
    ...
    :cond_2
    invoke-direct {p0, p1, v0}, isLastInSection(Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;Z)Z
    ...
    :cond_3
    iget-object p2, p0, mTrackedHeadsUp:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;

    const/4 v0, 0x0

    if-ne p1, p2, :cond_4

    iget p2, p0, mAppearFraction:F
    ...
    :cond_4
    iget-object p0, p0, mTrackedAmbient:Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;
...
.method private handleAddedNewViews([Lcom/android/systemui/statusbar/notification/stack/NotificationSection;[Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;Z)Z
    ...
    iget-object v3, p0, mAnimatedChildren:Ljava/util/HashSet;
    ...
    :goto_4
    invoke-direct {p0, v4, v3}, updateViewWithoutCallback(Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;Z)Z
...
.method private handleRemovedOldViews([Lcom/android/systemui/statusbar/notification/stack/NotificationSection;[Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;Z)Z
    ...
    invoke-direct {p0, v4, v1}, isFirstInSection(Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;Z)Z
    ...
    invoke-direct {p0, v4, v1}, isLastInSection(Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;Z)Z
...
.method private isFirstInSection(Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;Z)Z
    ...
    :goto_0
    iget-object v3, p0, mFirstInSectionViews:[Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;
...
.method private isLastInSection(Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;Z)Z
    ...
    iget-object v0, p0, mLastInSectionViews:[Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;
    ...
    iget-object v4, p0, mLastInSectionViews:[Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;
...
.method private updateView(Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;Z)V
    ...
    invoke-direct {p0, p1, p2}, updateViewWithoutCallback(Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;Z)Z

    move-result p1

    if-eqz p1, :cond_0

    iget-object p0, p0, mRoundingChangedCallback:Ljava/lang/Runnable;
...
.method private updateViewWithoutCallback(Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;Z)Z
    ...
    invoke-direct {p0, p1, v0}, getRoundness(Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;Z)F

    move-result v1

    const/4 v2, 0x0

    invoke-direct {p0, p1, v2}, getRoundness(Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;Z)F
    ...
    invoke-direct {p0, p1, v2}, isFirstInSection(Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;Z)Z

    move-result v3

    invoke-direct {p0, p1, v2}, isLastInSection(Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;Z)Z
...
.method public onAmbientStateChanged(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;Z)V
    ...
    iput-object p1, p0, mTrackedAmbient:Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;

    goto :goto_0

    :cond_0
    iget-object p2, p0, mTrackedAmbient:Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;

    if-ne p2, p1, :cond_1

    const/4 p2, 0x0

    iput-object p2, p0, mTrackedAmbient:Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;

    :cond_1
    :goto_0
    const/4 p2, 0x0

    invoke-direct {p0, p1, p2}, updateView(Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;Z)V
...
.method public onHeadsUpPinned(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V
    ...
    invoke-direct {p0, p1, v0}, updateView(Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;Z)V
...
.method public setAnimatedChildren(Ljava/util/HashSet;)V
    ...
    iput-object p1, p0, mAnimatedChildren:Ljava/util/HashSet;
...
.method public setExpanded(FF)V
    ...
    iput p2, p0, mAppearFraction:F

    iget-object p1, p0, mTrackedHeadsUp:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;
...
.method public setOnRoundingChangedCallback(Ljava/lang/Runnable;)V
    ...
    iput-object p1, p0, mRoundingChangedCallback:Ljava/lang/Runnable;
...
.method public setTrackingHeadsUp(Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;)V
    ...
    iput-object p1, p0, mTrackedHeadsUp:Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;
...
.method public updateRoundedChildren([Lcom/android/systemui/statusbar/notification/stack/NotificationSection;)V
    ...
    iget-object v2, p0, mTmpFirstInSectionViews:[Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;
    ...
    iget-object v2, p0, mTmpLastInSectionViews:[Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;
    ...
    iget-object v2, p0, mLastInSectionViews:[Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;
    ...
    :cond_0
    iget-object v1, p0, mTmpFirstInSectionViews:[Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;

    const/4 v2, 0x1

    invoke-direct {p0, p1, v1, v2}, handleRemovedOldViews([Lcom/android/systemui/statusbar/notification/stack/NotificationSection;[Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;Z)Z

    move-result v1

    or-int/2addr v1, v0

    iget-object v3, p0, mTmpLastInSectionViews:[Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;

    invoke-direct {p0, p1, v3, v0}, handleRemovedOldViews([Lcom/android/systemui/statusbar/notification/stack/NotificationSection;[Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;Z)Z

    move-result v3

    or-int/2addr v1, v3

    iget-object v3, p0, mTmpFirstInSectionViews:[Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;

    invoke-direct {p0, p1, v3, v2}, handleAddedNewViews([Lcom/android/systemui/statusbar/notification/stack/NotificationSection;[Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;Z)Z
    ...
    invoke-direct {p0, p1, v2, v0}, handleAddedNewViews([Lcom/android/systemui/statusbar/notification/stack/NotificationSection;[Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;Z)Z
