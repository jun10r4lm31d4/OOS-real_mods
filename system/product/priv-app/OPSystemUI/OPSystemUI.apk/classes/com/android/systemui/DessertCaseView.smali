...
.method static constructor <clinit>()V
    ...
    sput-object v1, RARE_PASTRIES:[I
    ...
    sput-object v1, XRARE_PASTRIES:[I
    ...
    sput-object v1, XXRARE_PASTRIES:[I

    sget-object v0, PASTRIES:[I

    array-length v0, v0

    sget-object v1, RARE_PASTRIES:[I

    array-length v1, v1

    add-int/2addr v0, v1

    sget-object v1, XRARE_PASTRIES:[I

    array-length v1, v1

    add-int/2addr v0, v1

    sget-object v1, XXRARE_PASTRIES:[I

    array-length v1, v1

    add-int/2addr v0, v1

    sput v0, NUM_PASTRIES:I
    ...
    sput-object v1, MASK:[F

    new-array v1, v0, [F

    fill-array-data v1, :array_1

    sput-object v1, ALPHA_MASK:[F

    new-array v0, v0, [F

    fill-array-data v0, :array_2

    sput-object v0, WHITE_MASK:[F
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget p2, NUM_PASTRIES:I

    invoke-direct {p1, p2}, Landroid/util/SparseArray;-><init>(I)V

    iput-object p1, p0, mDrawables:Landroid/util/SparseArray;

    new-instance p1, Ljava/util/HashSet;

    invoke-direct {p1}, Ljava/util/HashSet;-><init>()V

    iput-object p1, p0, mFreeList:Ljava/util/Set;
    ...
    iput-object p1, p0, mJuggle:Ljava/lang/Runnable;
    ...
    iput-object p2, p0, hsv:[F

    new-instance p2, Ljava/util/HashSet;

    invoke-direct {p2}, Ljava/util/HashSet;-><init>()V

    iput-object p2, p0, tmpSet:Ljava/util/HashSet;
    ...
    iput v0, p0, mCellSize:I

    new-instance v0, Landroid/graphics/BitmapFactory$Options;

    invoke-direct {v0}, Landroid/graphics/BitmapFactory$Options;-><init>()V

    iget v1, p0, mCellSize:I
    ...
    sget-object v5, PASTRIES:[I

    aput-object v5, v4, p3

    sget-object v5, RARE_PASTRIES:[I
    ...
    invoke-static {v6}, convertToAlphaMask(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
...
.method static synthetic access$100(Lcom/android/systemui/DessertCaseView;)Ljava/lang/Runnable;
    ...
    iget-object p0, p0, mJuggle:Ljava/lang/Runnable;
...
.method public fillFreeList()V
    ...
    invoke-virtual {p0, v0}, fillFreeList(I)V
...
.method public declared-synchronized fillFreeList(I)V
    ...
    iget v2, p0, mCellSize:I

    iget v3, p0, mCellSize:I

    invoke-direct {v1, v2, v3}, Landroid/widget/FrameLayout$LayoutParams;-><init>(II)V

    :cond_0
    :goto_0
    iget-object v2, p0, mFreeList:Ljava/util/Set;
    ...
    iget-object v3, p0, mFreeList:Ljava/util/Set;
    ...
    iget-object v5, p0, mCells:[Landroid/view/View;
    ...
    invoke-virtual {p0}, random_color()I
    ...
    iget-object v4, p0, mDrawables:Landroid/util/SparseArray;

    sget-object v5, XXRARE_PASTRIES:[I

    invoke-virtual {p0, v5}, pick([I)I
    ...
    sget-object v5, XRARE_PASTRIES:[I
    ...
    invoke-virtual {p0, v3, v2, v4}, place(Landroid/view/View;Landroid/graphics/Point;Z)V
...
.method protected declared-synchronized onSizeChanged(IIII)V
    ...
    iput-object p1, p0, mCells:[Landroid/view/View;

    invoke-virtual {p0}, Landroid/widget/FrameLayout;->removeAllViewsInLayout()V

    iget-object p1, p0, mFreeList:Ljava/util/Set;

    invoke-interface {p1}, Ljava/util/Set;->clear()V

    iget p1, p0, mHeight:I

    iget p2, p0, mCellSize:I
    ...
    iget-object v0, p0, mFreeList:Ljava/util/Set;
...
.method public declared-synchronized place(Landroid/view/View;Landroid/graphics/Point;Z)V
    ...
    invoke-direct/range {p0 .. p1}, getOccupied(Landroid/view/View;)[Landroid/graphics/Point;
    ...
    iget-object v13, v1, mFreeList:Ljava/util/Set;

    invoke-interface {v13, v12}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    iget-object v13, v1, mCells:[Landroid/view/View;

    iget v14, v12, Landroid/graphics/Point;->y:I

    iget v15, v1, mColumns:I
    ...
    iget-object v2, v1, tmpSet:Ljava/util/HashSet;
    ...
    iget-object v11, v1, mCells:[Landroid/view/View;

    iget v13, v15, Landroid/graphics/Point;->y:I

    iget v12, v1, mColumns:I
    ...
    iget-object v12, v1, tmpSet:Ljava/util/HashSet;
    ...
    :cond_5
    iget-object v7, v1, tmpSet:Ljava/util/HashSet;
    ...
    invoke-direct {v1, v11}, getOccupied(Landroid/view/View;)[Landroid/graphics/Point;
    ...
    iget-object v12, v1, mFreeList:Ljava/util/Set;

    invoke-interface {v12, v10}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    iget-object v12, v1, mCells:[Landroid/view/View;

    iget v13, v10, Landroid/graphics/Point;->y:I

    iget v6, v1, mColumns:I
    ...
    iget-object v9, v1, mCells:[Landroid/view/View;

    iget v10, v8, Landroid/graphics/Point;->y:I

    iget v11, v1, mColumns:I
    ...
    iget-object v9, v1, mFreeList:Ljava/util/Set;
    ...
    invoke-static {v6, v2}, irand(II)I
    ...
    iget v11, v1, mCellSize:I

    mul-int/2addr v3, v11

    sub-int/2addr v5, v10

    iget v10, v1, mCellSize:I
    ...
    invoke-direct/range {p0 .. p1}, makeHardwareLayerListener(Landroid/view/View;)Landroid/animation/Animator$AnimatorListener;
    ...
    :cond_b
    iget v6, v1, mCellSize:I

    mul-int/2addr v3, v6

    add-int/lit8 v6, v5, -0x1

    iget v7, v1, mCellSize:I
...
.method public place(Landroid/view/View;Z)V
    ...
    invoke-static {v2, v1}, irand(II)I

    move-result v1

    iget v3, p0, mRows:I

    invoke-static {v2, v3}, irand(II)I

    move-result v2

    invoke-direct {v0, v1, v2}, Landroid/graphics/Point;-><init>(II)V

    invoke-virtual {p0, p1, v0, p2}, place(Landroid/view/View;Landroid/graphics/Point;Z)V
...
.method random_color()I
    ...
    iget-object v0, p0, hsv:[F

    const/4 v1, 0x0

    const/16 v2, 0xc

    invoke-static {v1, v2}, irand(II)I
