...
.method public constructor <init>(ILcom/android/systemui/statusbar/notification/stack/NotificationSwipeHelper$NotificationCallback;Landroid/content/Context;Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$OnMenuEventListener;)V
    ...
    iput-object p4, p0, mMenuListener:Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$OnMenuEventListener;

    iput-object p2, p0, mCallback:Lcom/android/systemui/statusbar/notification/stack/NotificationSwipeHelper$NotificationCallback;
    ...
    iput-object p1, p0, mFalsingCheck:Ljava/lang/Runnable;
...
.method private handleSwipeFromClosedState(Landroid/view/MotionEvent;Landroid/view/View;FLcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin;)V
    ...
    :goto_4
    invoke-direct {p0, p4}, swipedEnoughToShowMenu(Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin;)Z
    ...
    invoke-virtual {p0, p2, v2, p3}, snapOpen(Landroid/view/View;IF)V
    ...
    invoke-virtual {p0, p2, p3}, dismiss(Landroid/view/View;F)V
    ...
    :cond_e
    invoke-virtual {p0, p2, p3}, snapClosed(Landroid/view/View;F)V
...
.method private handleSwipeFromOpenState(Landroid/view/MotionEvent;Landroid/view/View;FLcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin;)V
    ...
    invoke-virtual {p0, p2, p1, p3}, snapOpen(Landroid/view/View;IF)V
...
.method public clearCurrentMenuRow()V
    ...
    invoke-virtual {p0, v0}, setCurrentMenuRow(Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin;)V
...
.method public clearExposedMenuView()V
    ...
    invoke-virtual {p0, v0}, setExposedMenuView(Landroid/view/View;)V
...
.method public clearTranslatingParentView()V
    ...
    invoke-virtual {p0, v0}, setTranslatingParentView(Landroid/view/View;)V
...
.method public dismiss(Landroid/view/View;F)V
    ...
    invoke-virtual {p0, p1, p2, v0}, dismissChild(Landroid/view/View;FZ)V
...
.method public dismissChild(Landroid/view/View;FZ)V
    ...
    invoke-virtual {p0, p1, p2, p3}, superDismissChild(Landroid/view/View;FZ)V

    iget-object p2, p0, mCallback:Lcom/android/systemui/statusbar/notification/stack/NotificationSwipeHelper$NotificationCallback;
    ...
    :cond_0
    iget-object p1, p0, mCallback:Lcom/android/systemui/statusbar/notification/stack/NotificationSwipeHelper$NotificationCallback;
    ...
    invoke-virtual {p0}, handleMenuCoveredOrDismissed()V
...
.method public getCurrentMenuRow()Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin;
    ...
    iget-object p0, p0, mCurrMenuRow:Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin;
...
.method public getExposedMenuView()Landroid/view/View;
    ...
    iget-object p0, p0, mMenuExposedView:Landroid/view/View;
...
.method protected getFalsingCheck()Ljava/lang/Runnable;
    ...
    iget-object p0, p0, mFalsingCheck:Ljava/lang/Runnable;
...
.method public getTranslatingParentView()Landroid/view/View;
    ...
    iget-object p0, p0, mTranslatingParentView:Landroid/view/View;
...
.method public getViewTranslationAnimator(Landroid/view/View;FLandroid/animation/ValueAnimator$AnimatorUpdateListener;)Landroid/animation/Animator;
    ...
    :cond_0
    invoke-virtual {p0, p1, p2, p3}, superGetViewTranslationAnimator(Landroid/view/View;FLandroid/animation/ValueAnimator$AnimatorUpdateListener;)Landroid/animation/Animator;
...
.method protected handleMenuCoveredOrDismissed()V
    ...
    invoke-virtual {p0}, getExposedMenuView()Landroid/view/View;

    move-result-object v0

    if-eqz v0, :cond_0

    iget-object v1, p0, mTranslatingParentView:Landroid/view/View;

    if-ne v0, v1, :cond_0

    invoke-virtual {p0}, clearExposedMenuView()V
...
.method protected handleMenuRowSwipe(Landroid/view/MotionEvent;Landroid/view/View;FLcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin;)V
    ...
    invoke-direct {p0, p1, p2, p3, p4}, handleSwipeFromOpenState(Landroid/view/MotionEvent;Landroid/view/View;FLcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin;)V

    goto :goto_1

    :cond_2
    invoke-direct {p0, p1, p2, p3, p4}, handleSwipeFromClosedState(Landroid/view/MotionEvent;Landroid/view/View;FLcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin;)V
...
.method public handleUpEvent(Landroid/view/MotionEvent;Landroid/view/View;FF)Z
    ...
    invoke-virtual {p0}, getCurrentMenuRow()Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, handleMenuRowSwipe(Landroid/view/MotionEvent;Landroid/view/View;FLcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin;)V
...
.method protected initializeRow(Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;)V
    ...
    iput-object p1, p0, mCurrMenuRow:Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin;

    iget-object p1, p0, mCurrMenuRow:Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin;
...
.method public onDownUpdate(Landroid/view/View;Landroid/view/MotionEvent;)V
    ...
    iput-object p1, p0, mTranslatingParentView:Landroid/view/View;
    ...
    :cond_0
    invoke-virtual {p0}, clearCurrentMenuRow()V

    invoke-virtual {p0}, getHandler()Landroid/os/Handler;

    move-result-object p2

    invoke-virtual {p0}, getFalsingCheck()Ljava/lang/Runnable;
    ...
    invoke-virtual {p0, p2, v0}, resetExposedMenuView(ZZ)V
    ...
    invoke-virtual {p0, p1}, initializeRow(Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;)V
...
.method public onMenuShown(Landroid/view/View;)V
    ...
    invoke-virtual {p0}, getTranslatingParentView()Landroid/view/View;

    move-result-object v0

    invoke-virtual {p0, v0}, setExposedMenuView(Landroid/view/View;)V

    iget-object v0, p0, mCallback:Lcom/android/systemui/statusbar/notification/stack/NotificationSwipeHelper$NotificationCallback;
...
.method public resetExposedMenuView(ZZ)V
    ...
    invoke-virtual {p0, p2}, shouldResetMenu(Z)Z
    ...
    invoke-virtual {p0, p2, p1, v0}, getViewTranslationAnimator(Landroid/view/View;FLandroid/animation/ValueAnimator$AnimatorUpdateListener;)Landroid/animation/Animator;
...
.method public setExposedMenuView(Landroid/view/View;)V
    ...
    iput-object p1, p0, mMenuExposedView:Landroid/view/View;
...
.method protected shouldResetMenu(Z)Z
    ...
    iget-object v0, p0, mMenuExposedView:Landroid/view/View;
...
.method public snapChild(Landroid/view/View;FF)V
    ...
    invoke-virtual {p0, p1, p2, p3}, superSnapChild(Landroid/view/View;FF)V

    iget-object p3, p0, mCallback:Lcom/android/systemui/statusbar/notification/stack/NotificationSwipeHelper$NotificationCallback;
...
.method protected snapClosed(Landroid/view/View;F)V
    ...
    invoke-virtual {p0, p1, v0, p2}, snapChild(Landroid/view/View;FF)V
...
.method public snapOpen(Landroid/view/View;IF)V
    ...
    invoke-virtual {p0, p1, p2, p3}, snapChild(Landroid/view/View;FF)V
...
.method public snooze(Landroid/service/notification/StatusBarNotification;Lcom/android/systemui/plugins/statusbar/NotificationSwipeActionHelper$SnoozeOption;)V
    ...
    iget-object p0, p0, mCallback:Lcom/android/systemui/statusbar/notification/stack/NotificationSwipeHelper$NotificationCallback;
