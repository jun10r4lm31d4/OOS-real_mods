...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mFingerprintState:Lcom/oneplus/systemui/biometrics/OpFodHelper$FingerprintState;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mOnFingerprintStateChangeListeners:Ljava/util/ArrayList;
    ...
    iput-object p1, p0, mService:Landroid/hardware/fingerprint/IFingerprintService;
...
.method private changeState(Lcom/oneplus/systemui/biometrics/OpFodHelper$FingerprintState;Z)V
    ...
    iget-object v0, p0, mFingerprintState:Lcom/oneplus/systemui/biometrics/OpFodHelper$FingerprintState;
    ...
    iget-object v1, p0, mFingerprintState:Lcom/oneplus/systemui/biometrics/OpFodHelper$FingerprintState;
    ...
    iput-object p1, p0, mFingerprintState:Lcom/oneplus/systemui/biometrics/OpFodHelper$FingerprintState;

    iget-object p1, p0, mOnFingerprintStateChangeListeners:Ljava/util/ArrayList;

    monitor-enter p1

    :try_start_0
    iget-object p0, p0, mOnFingerprintStateChangeListeners:Ljava/util/ArrayList;
...
.method public static getInstance()Lcom/oneplus/systemui/biometrics/OpFodHelper;
    ...
    sget-object v0, sInstance:Lcom/oneplus/systemui/biometrics/OpFodHelper;
...
.method public static init(Landroid/content/Context;)V
    ...
    :try_start_0
    sget-object v1, sInstance:Lcom/oneplus/systemui/biometrics/OpFodHelper;
    ...
    sput-object v1, sInstance:Lcom/oneplus/systemui/biometrics/OpFodHelper;
...
.method public static isKeyguard(Ljava/lang/String;)Z
    ...
    invoke-static {p0}, isSystemUI(Ljava/lang/String;)Z

    move-result v0

    if-nez v0, :cond_1

    invoke-static {p0}, isForceShow(Ljava/lang/String;)Z
...
.method public addFingerprintStateChangeListener(Lcom/oneplus/systemui/biometrics/OpFodHelper$OnFingerprintStateChangeListener;)V
    ...
    iget-object v0, p0, mOnFingerprintStateChangeListeners:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, mOnFingerprintStateChangeListeners:Ljava/util/ArrayList;
...
.method public changeState(Lcom/oneplus/systemui/biometrics/OpFodHelper$FingerprintState;)V
    ...
    invoke-direct {p0, p1, v0}, changeState(Lcom/oneplus/systemui/biometrics/OpFodHelper$FingerprintState;Z)V
...
.method public getCurrentOwner()Ljava/lang/String;
    ...
    iget-object p0, p0, mCurrentClient:Ljava/lang/String;
...
.method public getLastOwner()Ljava/lang/String;
    ...
    iget-object p0, p0, mLastClient:Ljava/lang/String;
...
.method public handleQSExpandChanged(Z)V
    ...
    iget-object v0, p0, mService:Landroid/hardware/fingerprint/IFingerprintService;
    ...
    :cond_0
    invoke-static {v0}, isKeyguard(Ljava/lang/String;)Z
    ...
    :cond_1
    iget-object p0, p0, mService:Landroid/hardware/fingerprint/IFingerprintService;
...
.method public isBiometricPromptReadyToShow()Z
    ...
    invoke-virtual {p0}, isFromBiometricPrompt()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-boolean p0, p0, mBiometricPromptVisible:Z
...
.method public isDoingEnroll()Z
    ...
    iget-boolean p0, p0, mActionEnroll:Z
...
.method public isFingerprintDetecting()Z
    ...
    iget-object p0, p0, mFingerprintState:Lcom/oneplus/systemui/biometrics/OpFodHelper$FingerprintState;
...
.method public isKeyguardAuthenticating()Z
    ...
    invoke-static {p0}, isKeyguard(Ljava/lang/String;)Z
...
.method public updateBiometricPromptReady(I)Z
    ...
    iput-boolean p1, p0, mBiometricPromptVisible:Z
...
.method public updateOwner(Landroid/os/Bundle;)V
    ...
    :goto_0
    iget-object v5, p0, mCurrentClient:Ljava/lang/String;

    iput-object v5, p0, mLastClient:Ljava/lang/String;

    iput-object v1, p0, mCurrentClient:Ljava/lang/String;

    iput v2, p0, mCookie:I

    iput-boolean v0, p0, mBiometricPromptVisible:Z

    iput-boolean p1, p0, mActionEnroll:Z
    ...
    iget-object v6, p0, mCurrentClient:Ljava/lang/String;
    ...
    iget-object v6, p0, mLastClient:Ljava/lang/String;
    ...
    iget-boolean v0, p0, mActionEnroll:Z
    ...
    iget-object v0, p0, mLastClient:Ljava/lang/String;
    ...
    invoke-direct {p0, v0, p1}, changeState(Lcom/oneplus/systemui/biometrics/OpFodHelper$FingerprintState;Z)V
