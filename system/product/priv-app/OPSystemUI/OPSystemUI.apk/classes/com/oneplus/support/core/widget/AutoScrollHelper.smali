...
.method public constructor <init>(Landroid/view/View;)V
    ...
    invoke-virtual {p0, v0, v0}, setMaximumVelocity(FF)Lcom/oneplus/support/core/widget/AutoScrollHelper;

    int-to-float p1, p1

    invoke-virtual {p0, p1, p1}, setMinimumVelocity(FF)Lcom/oneplus/support/core/widget/AutoScrollHelper;

    const/4 p1, 0x1

    invoke-virtual {p0, p1}, setEdgeType(I)Lcom/oneplus/support/core/widget/AutoScrollHelper;

    const p1, 0x7f7fffff    # Float.MAX_VALUE

    invoke-virtual {p0, p1, p1}, setMaximumEdges(FF)Lcom/oneplus/support/core/widget/AutoScrollHelper;

    const p1, 0x3e4ccccd    # 0.2f

    invoke-virtual {p0, p1, p1}, setRelativeEdges(FF)Lcom/oneplus/support/core/widget/AutoScrollHelper;

    const/high16 p1, 0x3f800000    # 1.0f

    invoke-virtual {p0, p1, p1}, setRelativeVelocity(FF)Lcom/oneplus/support/core/widget/AutoScrollHelper;

    sget p1, DEFAULT_ACTIVATION_DELAY:I

    invoke-virtual {p0, p1}, setActivationDelay(I)Lcom/oneplus/support/core/widget/AutoScrollHelper;

    const/16 p1, 0x1f4

    invoke-virtual {p0, p1}, setRampUpDuration(I)Lcom/oneplus/support/core/widget/AutoScrollHelper;

    invoke-virtual {p0, p1}, setRampDownDuration(I)Lcom/oneplus/support/core/widget/AutoScrollHelper;
...
.method private requestStop()V
    ...
    :cond_0
    iget-object p0, p0, mScroller:Lcom/oneplus/support/core/widget/AutoScrollHelper$ClampedScroller;
...
.method public onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    iget-object p2, p0, mScroller:Lcom/oneplus/support/core/widget/AutoScrollHelper$ClampedScroller;
