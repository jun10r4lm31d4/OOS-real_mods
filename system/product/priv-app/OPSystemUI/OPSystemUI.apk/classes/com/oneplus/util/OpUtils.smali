...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, mIsHomeApp:Z

    sput-boolean v0, mIsSystemUI:Z

    sput-boolean v0, mIsScreenCompat:Z

    sput-boolean v0, mIsCTS:Z

    sput-boolean v0, mIsCTSAdded:Z

    sput-boolean v0, mIsNeedDarkNavBar:Z

    invoke-static {}, isSupportWarpCharging()Z

    move-result v1

    sput-boolean v1, SUPPORT_WARP_CHARGING:Z

    new-instance v1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    sput-object v1, mTypefaceCache:Ljava/util/concurrent/ConcurrentHashMap;

    sput-boolean v0, mIsSupportResolutionSwitch:Z

    sput-boolean v0, mIsOnePlusHomeApp:Z

    sput-boolean v0, mIsFullScreenListApp:Z

    const-string v1, ""

    sput-object v1, mTopClassName:Ljava/lang/String;
    ...
    sput-object v1, SprintMmcMnc:[Ljava/lang/String;
    ...
    sput-object v1, DETmoMmcMnc:[Ljava/lang/String;

    sput-boolean v0, mIsCutoutEmulationEnabled:Z
...
.method public static convertDpToFixedPx(F)I
    ...
    invoke-static {}, getCurrentDefaultDpi()I

    move-result v0

    int-to-float v0, v0

    sget v1, mDensityDpi:I
...
.method public static convertSpToFixedPx(FF)I
    ...
    invoke-static {}, getCurrentDefaultDensity()F
...
.method private static getCurrentDefaultDensity()F
    ...
    sget-boolean v0, mIsSupportResolutionSwitch:Z
...
.method public static getMaxDotsForNotificationIconContainer(Landroid/content/Context;)I
    ...
    invoke-static {p0}, isCutoutHide(Landroid/content/Context;)Z
...
.method public static getMclTypeface(I)Landroid/graphics/Typeface;
    ...
    sget-object v0, mTypefaceCache:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static getTopClassName()Ljava/lang/String;
    ...
    sget-object v0, mTopClassName:Ljava/lang/String;
...
.method public static init(Landroid/content/Context;)V
    ...
    invoke-static {v0}, updateDensityDpi(I)V
    ...
    sput-object v0, mSettingsObserver:Lcom/oneplus/util/OpUtils$SettingsObserver;

    invoke-static {p0}, checkIsSupportResolutionSwitch(Landroid/content/Context;)Z

    move-result p0

    sput-boolean p0, mIsSupportResolutionSwitch:Z

    invoke-static {}, loadMCLTypeface()V
    ...
    sput-object p0, mOverlayManager:Landroid/content/om/IOverlayManager;
...
.method public static isCutoutEmulationEnabled()Z
    ...
    sget-boolean v0, mIsCutoutEmulationEnabled:Z
...
.method public static isDETmoMccMnc(Landroid/content/Context;)Z
    ...
    invoke-static {p0, v0}, getMmcMnc(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :goto_0
    sget-object v2, DETmoMmcMnc:[Ljava/lang/String;
...
.method public static isInFullScreenListApp()Z
    ...
    sget-boolean v0, mIsFullScreenListApp:Z
...
.method public static isNeedDarkNavBar(Landroid/content/Context;)Z
    ...
    sget-boolean v0, mIsNeedDarkNavBar:Z
...
.method public static isOnePlusHomeApp()Z
    ...
    sget-boolean v0, mIsOnePlusHomeApp:Z

    return v0
.end method

.method public static isOpenBeta()Z
    .locals 3

    invoke-static {}, getReleaseType()I
...
.method public static isScreenCompat()Z
    ...
    sget-boolean v0, mIsScreenCompat:Z
...
.method public static isSprintMccMnc(Landroid/content/Context;)Z
    ...
    :goto_0
    sget-object v2, SprintMmcMnc:[Ljava/lang/String;
...
.method public static isSupportResolutionSwitch(Landroid/content/Context;)Z
    ...
    sget-boolean p0, mIsSupportResolutionSwitch:Z
...
.method public static isSupportShowVoLTE(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, isDETmoMccMnc(Landroid/content/Context;)Z
...
.method public static isWLBAllowed(Landroid/content/Context;)Z
    ...
    invoke-static {p0, v0}, isAppExists(Landroid/content/Context;Ljava/lang/String;)Z
...
.method private static loadMCLTypeface()V
    ...
    invoke-static {v1}, getTypefaceByPath(Ljava/lang/String;)Landroid/graphics/Typeface;
    ...
    invoke-static {v2}, getTypefaceByPath(Ljava/lang/String;)Landroid/graphics/Typeface;
...
.method public static updateIsCutoutEmulationEnabled()V
    ...
    :try_start_0
    sget-object v2, mOverlayManager:Landroid/content/om/IOverlayManager;
    ...
    :cond_1
    sput-boolean v1, mIsCutoutEmulationEnabled:Z
    ...
    sget-boolean v2, mIsCutoutEmulationEnabled:Z
...
.method public static updateTopPackage(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    sput-object p2, mTopClassName:Ljava/lang/String;
    ...
    :cond_6
    sput-boolean v1, mIsHomeApp:Z

    sput-boolean v1, mIsOnePlusHomeApp:Z
    ...
    :cond_b
    sput-boolean v1, mIsNeedDarkNavBar:Z
    ...
    :cond_c
    sput-boolean v1, mIsFullScreenListApp:Z
    ...
    :goto_b
    sput-boolean p2, mIsScreenCompat:Z

    goto :goto_c

    :cond_e
    sput-boolean v1, mIsScreenCompat:Z
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
