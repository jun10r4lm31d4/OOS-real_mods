...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object p3, p0, mTextChars:Ljava/util/ArrayList;
    ...
    iput-object p3, p0, mCharPool:Ljava/util/Stack;

    new-instance p3, Landroid/graphics/Paint;

    invoke-direct {p3}, Landroid/graphics/Paint;-><init>()V

    iput-object p3, p0, mDrawPaint:Landroid/graphics/Paint;

    new-instance p3, Landroid/graphics/Paint;

    invoke-direct {p3}, Landroid/graphics/Paint;-><init>()V

    iput-object p3, p0, mDrawEmptyCirclePaint:Landroid/graphics/Paint;

    new-instance p3, Landroid/graphics/Paint;

    invoke-direct {p3}, Landroid/graphics/Paint;-><init>()V

    iput-object p3, p0, mDrawAlphaPaint1:Landroid/graphics/Paint;

    new-instance p3, Landroid/graphics/Paint;

    invoke-direct {p3}, Landroid/graphics/Paint;-><init>()V

    iput-object p3, p0, mDrawAlphaPaint2:Landroid/graphics/Paint;

    new-instance p3, Landroid/graphics/Paint;

    invoke-direct {p3}, Landroid/graphics/Paint;-><init>()V

    iput-object p3, p0, mDrawAlphaPaint3:Landroid/graphics/Paint;

    new-instance p3, Landroid/graphics/Paint;

    invoke-direct {p3}, Landroid/graphics/Paint;-><init>()V

    iput-object p3, p0, mDrawAlphaPaint4:Landroid/graphics/Paint;

    const/4 p3, -0x1

    iput p3, p0, mTextColor:I

    const/4 p4, 0x0

    iput p4, p0, mPinPasswordLength:I
    ...
    iget-object p2, p0, mDrawPaint:Landroid/graphics/Paint;
    ...
    :cond_0
    iput-boolean p4, p0, mShowPassword:Z
    ...
    iput-object p2, p0, mAppearInterpolator:Landroid/view/animation/Interpolator;
    ...
    iput-object p2, p0, mDisappearInterpolator:Landroid/view/animation/Interpolator;
    ...
    iput-object p2, p0, mFastOutSlowInInterpolator:Landroid/view/animation/Interpolator;
    ...
    iput-object p2, p0, mPM:Landroid/os/PowerManager;
    ...
    iput p1, p0, mPinPasswordLength:I
...
.method static synthetic access$000(Lcom/oneplus/keyguard/OpPasswordTextViewForPin;)Lcom/oneplus/keyguard/OpPasswordTextViewForPin$UserActivityListener;
    ...
    iget-object p0, p0, mUserActivityListener:Lcom/oneplus/keyguard/OpPasswordTextViewForPin$UserActivityListener;
...
.method static synthetic access$1000(Lcom/oneplus/keyguard/OpPasswordTextViewForPin;)Landroid/graphics/Paint;
    ...
    iget-object p0, p0, mDrawPaint:Landroid/graphics/Paint;
...
.method static synthetic access$300(Lcom/oneplus/keyguard/OpPasswordTextViewForPin;)Ljava/util/ArrayList;
    ...
    iget-object p0, p0, mTextChars:Ljava/util/ArrayList;
...
.method static synthetic access$400(Lcom/oneplus/keyguard/OpPasswordTextViewForPin;)Ljava/util/Stack;
    ...
    iget-object p0, p0, mCharPool:Ljava/util/Stack;
...
.method static synthetic access$700(Lcom/oneplus/keyguard/OpPasswordTextViewForPin;)Z
    ...
    iget-boolean p0, p0, mShowPassword:Z
...
.method static synthetic access$800(Lcom/oneplus/keyguard/OpPasswordTextViewForPin;)Landroid/view/animation/Interpolator;
    ...
    iget-object p0, p0, mDisappearInterpolator:Landroid/view/animation/Interpolator;
...
.method static synthetic access$900(Lcom/oneplus/keyguard/OpPasswordTextViewForPin;)Landroid/view/animation/Interpolator;
    ...
    iget-object p0, p0, mAppearInterpolator:Landroid/view/animation/Interpolator;
...
.method private getDrawingWidth()F
    ...
    iget-object v0, p0, mTextChars:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->size()I

    move-result v0

    invoke-direct {p0}, getCharBounds()Landroid/graphics/Rect;
    ...
    iget-object v4, p0, mTextChars:Ljava/util/ArrayList;
...
.method private obtainCharState(C)Lcom/oneplus/keyguard/OpPasswordTextViewForPin$CharState;
    ...
    iget-object v0, p0, mCharPool:Ljava/util/Stack;
...
.method public append(C)V
    ...
    iget-object v3, p0, mText:Ljava/lang/String;
    ...
    iput-object v2, p0, mText:Ljava/lang/String;
    ...
    invoke-direct {p0, p1}, obtainCharState(C)Lcom/oneplus/keyguard/OpPasswordTextViewForPin$CharState;
    ...
    :cond_1
    iget v0, p0, mPinPasswordLength:I
    ...
    :cond_4
    iget-object v0, p0, mOnTextChangeListerner:Lcom/oneplus/keyguard/OpPasswordTextViewForPin$onTextChangedListerner;
    ...
    invoke-virtual {p0, v1, v0, v3, p1}, sendAccessibilityEventTypeViewTextChanged(Ljava/lang/String;III)V
...
.method public deleteLastChar()V
    ...
    iput-object v4, p0, mText:Ljava/lang/String;
    ...
    invoke-virtual {p0, v1, v0, v3, v2}, sendAccessibilityEventTypeViewTextChanged(Ljava/lang/String;III)V
...
.method public getText()Ljava/lang/String;
    ...
    iget-object p0, p0, mText:Ljava/lang/String;
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-direct {p0}, getDrawingWidth()F
    ...
    iget-object v6, p0, mTextChars:Ljava/util/ArrayList;
...
.method public reset(ZZ)V
    ...
    iget-object v1, v0, mText:Ljava/lang/String;

    const-string v2, ""

    iput-object v2, v0, mText:Ljava/lang/String;

    iget-object v2, v0, mTextChars:Ljava/util/ArrayList;
    ...
    iget-object v7, v0, mTextChars:Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object v8, v0, mCharPool:Ljava/util/Stack;
    ...
    :cond_3
    iget-object v2, v0, mOnTextChangeListerner:Lcom/oneplus/keyguard/OpPasswordTextViewForPin$onTextChangedListerner;
    ...
    invoke-virtual {v0, v1, v5, v2, v5}, sendAccessibilityEventTypeViewTextChanged(Ljava/lang/String;III)V
...
.method public setTextChangeListener(Lcom/oneplus/keyguard/OpPasswordTextViewForPin$onTextChangedListerner;)V
    ...
    iput-object p1, p0, mOnTextChangeListerner:Lcom/oneplus/keyguard/OpPasswordTextViewForPin$onTextChangedListerner;
...
.method public setUserActivityListener(Lcom/oneplus/keyguard/OpPasswordTextViewForPin$UserActivityListener;)V
    ...
    iput-object p1, p0, mUserActivityListener:Lcom/oneplus/keyguard/OpPasswordTextViewForPin$UserActivityListener;
