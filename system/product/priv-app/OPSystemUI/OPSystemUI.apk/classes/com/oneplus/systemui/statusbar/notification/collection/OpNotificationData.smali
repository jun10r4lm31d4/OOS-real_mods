...
.method public filterAndSort()V
    ...
    invoke-direct {p0}, getEntries()Landroid/util/ArrayMap;

    move-result-object v0

    invoke-direct {p0}, getSortedAndFiltered()Ljava/util/ArrayList;
    ...
    iput-boolean v2, p0, mShowHighlightNotification:Z

    const/4 v3, 0x0

    iput-object v3, p0, mHighlightHintNotification:Landroid/service/notification/StatusBarNotification;

    iput-boolean v2, p0, mShowCarModeHighlightNotification:Z

    iput-object v3, p0, mCarModeHighlightHintNotification:Landroid/service/notification/StatusBarNotification;
    ...
    iput-boolean v9, p0, mShowCarModeHighlightNotification:Z

    iput-object v6, p0, mCarModeHighlightHintNotification:Landroid/service/notification/StatusBarNotification;
    ...
    iput-boolean v9, p0, mShowHighlightNotification:Z

    iput-object v6, p0, mHighlightHintNotification:Landroid/service/notification/StatusBarNotification;

    move v4, v7

    :cond_1
    :goto_1
    invoke-direct {p0}, getNotificationFilter()Lcom/android/systemui/statusbar/notification/NotificationFilter;
    ...
    invoke-direct {p0}, getRankingComparator()Ljava/util/Comparator;
...
.method public getCarModeHighlightHintNotification()Landroid/service/notification/StatusBarNotification;
    ...
    iget-object p0, p0, mCarModeHighlightHintNotification:Landroid/service/notification/StatusBarNotification;
...
.method public getHighlightHintNotification()Landroid/service/notification/StatusBarNotification;
    ...
    iget-object p0, p0, mHighlightHintNotification:Landroid/service/notification/StatusBarNotification;
...
.method public getKeyguardChronometer()Landroid/widget/Chronometer;
    ...
    iget-object v0, p0, mHighlightHintNotification:Landroid/service/notification/StatusBarNotification;
    ...
    invoke-direct {p0, v0}, get(Ljava/lang/String;)Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;
...
.method public isLocked(Ljava/lang/String;)Z
    ...
    invoke-direct {p0}, getTmpRanking()Landroid/service/notification/NotificationListenerService$Ranking;

    move-result-object v0

    invoke-direct {p0}, getRankingMap()Landroid/service/notification/NotificationListenerService$RankingMap;

    move-result-object v1

    if-eqz v1, :cond_0

    invoke-direct {p0, p1, v0}, getRanking(Ljava/lang/String;Landroid/service/notification/NotificationListenerService$Ranking;)Z
...
.method public showCarModeNotification()Z
    ...
    iget-boolean p0, p0, mShowCarModeHighlightNotification:Z
...
.method public showNotification()Z
    ...
    iget-boolean p0, p0, mShowHighlightNotification:Z
