...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput p1, p0, mRadius:F

    const/4 v0, 0x0

    iput-boolean v0, p0, isDisappearAnimationStart:Z

    const/high16 v1, -0x1000000

    iput v1, p0, mCircle1Colr:I

    iput v1, p0, mCircle2Colr:I

    iput v1, p0, mCircle3Colr:I

    iput p1, p0, mWithoutDelayAnimationStartFrame:F

    iput v0, p0, mWithoutDelayAnimationDuration:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-boolean p2, p0, isDisappearAnimationStart:Z

    const/high16 v0, -0x1000000

    iput v0, p0, mCircle1Colr:I

    iput v0, p0, mCircle2Colr:I

    iput v0, p0, mCircle3Colr:I

    iput p1, p0, mWithoutDelayAnimationStartFrame:F

    iput p2, p0, mWithoutDelayAnimationDuration:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput p3, p0, mCircle1Colr:I

    iput p3, p0, mCircle2Colr:I

    iput p3, p0, mCircle3Colr:I
...
.method static synthetic access$200(Lcom/oneplus/aod/OpWakingUpScrim;F)V
    ...
    invoke-direct {p0, p1}, calculateCircleColor(F)V
...
.method private calculateCircleColor(F)V
    ...
    :goto_3
    invoke-direct {p0, p1}, getColor(F)I

    move-result p1

    iput p1, p0, mCircle1Colr:I

    invoke-direct {p0, v7}, getColor(F)I

    move-result p1

    iput p1, p0, mCircle2Colr:I

    const/high16 p1, -0x1000000

    iput p1, p0, mCircle3Colr:I
...
.method public getDisappearAnimationWithDelay()Landroid/animation/ValueAnimator;
    ...
    iput-object v0, p0, mDisappearAnimator:Landroid/animation/ValueAnimator;

    iget-object v0, p0, mDisappearAnimator:Landroid/animation/ValueAnimator;
    ...
    iget-object v1, p0, mDisappearAnimator:Landroid/animation/ValueAnimator;
    ...
    iget-object p0, p0, mDisappearAnimator:Landroid/animation/ValueAnimator;
...
.method public getDisappearAnimationWithoutDelay()Landroid/animation/ValueAnimator;
    ...
    iget v0, p0, mWithoutDelayAnimationStartFrame:F
    ...
    :goto_0
    iget v2, p0, mWithoutDelayAnimationDuration:I
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget v8, v0, mCircle1Colr:I

    aput v8, v6, v7

    const/4 v7, 0x1

    iget v8, v0, mCircle2Colr:I

    aput v8, v6, v7

    iget v7, v0, mCircle3Colr:I
    ...
    iget-boolean v2, v0, mTestUnlockSpeed:Z
...
.method public reset()V
    ...
    iput-boolean v2, p0, mTestUnlockSpeed:Z

    iget-boolean v2, p0, mTestUnlockSpeed:Z
    ...
    iput v2, p0, mWithoutDelayAnimationStartFrame:F
    ...
    iput v1, p0, mWithoutDelayAnimationDuration:I
    ...
    iget v2, p0, mWithoutDelayAnimationStartFrame:F
    ...
    iget p0, p0, mWithoutDelayAnimationDuration:I
