...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mHandler:Lcom/oneplus/opthreekey/OpThreekeyNavigationDialog$H;

    const/4 v0, -0x1

    iput v0, p0, mParentStatus:I

    const/4 v0, 0x0

    iput-boolean v0, p0, mShowing:Z

    iput v0, p0, mShowingType:I

    iput v0, p0, mOrientationType:I

    iput v0, p0, mThemeIconColor:I

    iput v0, p0, mThemeTextColor:I

    iput v0, p0, mThemeBgColor:I

    iput v0, p0, mAccentColor:I

    iput v0, p0, mThemeColorMode:I
    ...
    iput-object v0, p0, mClickThreeKeyNavigationNextTextButton:Landroid/view/View$OnClickListener;
    ...
    iput-object v0, p0, mClickThreeKeyNavigationGotItTextButton:Landroid/view/View$OnClickListener;
    ...
    iput-object v0, p0, mMonitorCallback:Lcom/android/keyguard/KeyguardUpdateMonitorCallback;
    ...
    iput-object p1, p0, mOpZenModeController:Lcom/oneplus/opzenmode/OpZenModeController;
    ...
    iput-object p1, p0, mOrientationListener:Landroid/view/OrientationEventListener;
...
.method static synthetic access$1000(Lcom/oneplus/opthreekey/OpThreekeyNavigationDialog;I)V
    ...
    invoke-direct {p0, p1}, stateChange(I)V
...
.method static synthetic access$1400(Lcom/oneplus/opthreekey/OpThreekeyNavigationDialog;Z)V
    ...
    invoke-direct {p0, p1}, updateTheme(Z)V
...
.method static synthetic access$1500(Lcom/oneplus/opthreekey/OpThreekeyNavigationDialog;)Landroid/view/View;
    ...
    iget-object p0, p0, mMainView:Landroid/view/View;
...
.method static synthetic access$1600(Lcom/oneplus/opthreekey/OpThreekeyNavigationDialog;)Landroid/view/View;
    ...
    iget-object p0, p0, mSecondView:Landroid/view/View;
...
.method static synthetic access$1700(Lcom/oneplus/opthreekey/OpThreekeyNavigationDialog;)V
    ...
    invoke-direct {p0}, inflateView()V
...
.method static synthetic access$1900(Lcom/oneplus/opthreekey/OpThreekeyNavigationDialog;Landroid/view/View;)V
    ...
    invoke-direct {p0, p1}, setAlphaH(Landroid/view/View;)V
...
.method static synthetic access$300(Lcom/oneplus/opthreekey/OpThreekeyNavigationDialog;)Lcom/oneplus/opthreekey/OpThreekeyNavigationDialog$H;
    ...
    iget-object p0, p0, mHandler:Lcom/oneplus/opthreekey/OpThreekeyNavigationDialog$H;
...
.method static synthetic access$500(Lcom/oneplus/opthreekey/OpThreekeyNavigationDialog;)Landroid/widget/LinearLayout;
    ...
    iget-object p0, p0, mViewContainer:Landroid/widget/LinearLayout;
...
.method static synthetic access$600(Lcom/oneplus/opthreekey/OpThreekeyNavigationDialog;Landroid/view/View;)V
    ...
    invoke-direct {p0, p1}, dismiss(Landroid/view/View;)V
...
.method static synthetic access$700(Lcom/oneplus/opthreekey/OpThreekeyNavigationDialog;Ljava/lang/String;I)V
    ...
    invoke-direct {p0, p1, p2}, setFinished(Ljava/lang/String;I)V
...
.method static synthetic access$800(Lcom/oneplus/opthreekey/OpThreekeyNavigationDialog;Landroid/view/View;)V
    ...
    invoke-direct {p0, p1}, showH(Landroid/view/View;)V
...
.method static synthetic access$900(Lcom/oneplus/opthreekey/OpThreekeyNavigationDialog;Landroid/view/View;)V
    ...
    invoke-direct {p0, p1}, dismissH(Landroid/view/View;)V
...
.method private applyTheme()V
    ...
    :cond_0
    iget v1, p0, mThemeColorMode:I

    const/4 v2, 0x1

    if-eq v1, v2, :cond_1

    iget v1, p0, mAccentColor:I

    iput v1, p0, mThemeIconColor:I
    ...
    :goto_0
    iget-object v0, p0, mInnerVirtualThreekeyView:[Landroid/widget/LinearLayout;
    ...
    iget-object v0, p0, mThreeKeyRowText:[Landroid/widget/TextView;

    aget-object v0, v0, v1

    iget v4, p0, mThemeTextColor:I
    ...
    iget-object v0, p0, mThreeKeyRowIcon:[Landroid/widget/ImageView;

    aget-object v0, v0, v1

    iget v1, p0, mThemeIconColor:I
...
.method private changeH()V
    ...
    iget-object v0, p0, mHandler:Lcom/oneplus/opthreekey/OpThreekeyNavigationDialog$H;
    ...
    iget-object v0, p0, mMainView:Landroid/view/View;
    ...
    iget-object v0, p0, mSecondView:Landroid/view/View;
    ...
    iget-object v0, p0, mViewContainer:Landroid/widget/LinearLayout;

    iget-object v1, p0, mSecondView:Landroid/view/View;

    invoke-virtual {v0, v1}, Landroid/widget/LinearLayout;->addView(Landroid/view/View;)V

    iget-object v0, p0, mViewContainer:Landroid/widget/LinearLayout;

    iget-object v1, p0, mMainView:Landroid/view/View;

    invoke-virtual {v0, v1}, Landroid/widget/LinearLayout;->removeView(Landroid/view/View;)V

    invoke-direct {p0}, checkShowPage()I

    invoke-direct {p0}, updateThreekeyLayout()V
...
.method private checkShowPage()I
    ...
    :goto_0
    iget-object v3, p0, mSecondView:Landroid/view/View;
...
.method public static getInstance(Landroid/content/Context;)Lcom/oneplus/opthreekey/OpThreekeyNavigationDialog;
    ...
    :try_start_0
    sget-object v1, mOpThreekeyNavigationDialog:Lcom/oneplus/opthreekey/OpThreekeyNavigationDialog;
    ...
    sput-object v1, mOpThreekeyNavigationDialog:Lcom/oneplus/opthreekey/OpThreekeyNavigationDialog;

    sget-object p0, mOpThreekeyNavigationDialog:Lcom/oneplus/opthreekey/OpThreekeyNavigationDialog;
...
.method private inflateView()V
    ...
    iput-object v0, p0, layoutInflater:Landroid/view/LayoutInflater;

    iget-object v0, p0, layoutInflater:Landroid/view/LayoutInflater;
    ...
    iput-object v0, p0, mMainView:Landroid/view/View;
    ...
    iput-object v0, p0, mSecondView:Landroid/view/View;
    ...
    iput-object v0, p0, mViewContainer:Landroid/widget/LinearLayout;
    ...
    iput-object v0, p0, mWindowLayoutParams:Landroid/view/WindowManager$LayoutParams;

    iget-object v0, p0, mWindowLayoutParams:Landroid/view/WindowManager$LayoutParams;
    ...
    iget-object p0, p0, mWindowLayoutParams:Landroid/view/WindowManager$LayoutParams;
...
.method private init()V
    ...
    iget-object v0, p0, mOpZenModeController:Lcom/oneplus/opzenmode/OpZenModeController;
    ...
    iget-object p0, p0, mMonitorCallback:Lcom/android/keyguard/KeyguardUpdateMonitorCallback;
...
.method private initDialog()V
    ...
    iget-object v2, p0, mMainView:Landroid/view/View;
    ...
    iget-object v2, p0, mSecondView:Landroid/view/View;
    ...
    iput-object v0, p0, mThreekeyNavigationFullBlueDialog:Landroid/widget/LinearLayout;
    ...
    iput-object v0, p0, mThreeKeyNavigationNextTextButton:Landroid/widget/TextView;

    iget-object v0, p0, mThreeKeyNavigationNextTextButton:Landroid/widget/TextView;

    iget-object v1, p0, mClickThreeKeyNavigationNextTextButton:Landroid/view/View$OnClickListener;
    ...
    iput-object v0, p0, mThreeKeyNavigationTriangle:Landroid/widget/ImageView;
    ...
    iput-object v0, p0, mThreeKeyNavigationNextGotItButton:Landroid/widget/TextView;

    iget-object v0, p0, mThreeKeyNavigationNextGotItButton:Landroid/widget/TextView;

    iget-object v1, p0, mClickThreeKeyNavigationGotItTextButton:Landroid/view/View$OnClickListener;
    ...
    iput-object v2, p0, mInnerVirtualThreekeyView:[Landroid/widget/LinearLayout;

    iget-object v2, p0, mInnerVirtualThreekeyView:[Landroid/widget/LinearLayout;

    iget-object v3, p0, mMainView:Landroid/view/View;
    ...
    iput-object v2, p0, mThreeKeyRowIcon:[Landroid/widget/ImageView;

    new-array v2, v1, [Landroid/widget/TextView;

    iput-object v2, p0, mThreeKeyRowText:[Landroid/widget/TextView;
    ...
    iget-object v3, p0, mThreeKeyRowIcon:[Landroid/widget/ImageView;

    iget-object v7, p0, mInnerVirtualThreekeyView:[Landroid/widget/LinearLayout;
    ...
    iget-object v3, p0, mThreeKeyRowText:[Landroid/widget/TextView;
    ...
    :cond_2
    iget-object v2, p0, mThreeKeyRowIcon:[Landroid/widget/ImageView;
    ...
    iget-object v2, p0, mThreeKeyRowText:[Landroid/widget/TextView;
    ...
    invoke-direct {p0, v5}, updateTheme(Z)V
    ...
    iget-object v11, p0, mInnerVirtualThreekeyView:[Landroid/widget/LinearLayout;

    iget v12, p0, mParentStatus:I
    ...
    iget-object v3, p0, mThreeKeyNavigationTriangle:Landroid/widget/ImageView;
    ...
    :cond_3
    iget-object v3, p0, mInnerVirtualThreekeyView:[Landroid/widget/LinearLayout;

    iget v11, p0, mParentStatus:I
    ...
    invoke-direct {p0, v3, v11}, setAlpha(Landroid/view/View;I)V
    ...
    iget-object v1, p0, mThreekeyNavigationFullBlueDialog:Landroid/widget/LinearLayout;
    ...
    iget-object v3, p0, mThreekeyNavigationFullBlueDialog:Landroid/widget/LinearLayout;
    ...
    iget-object p0, p0, mInnerVirtualThreekeyView:[Landroid/widget/LinearLayout;
    ...
    iget-object v6, p0, mInnerVirtualThreekeyView:[Landroid/widget/LinearLayout;
    ...
    :cond_5
    iget-object v1, p0, mInnerVirtualThreekeyView:[Landroid/widget/LinearLayout;

    iget v2, p0, mParentStatus:I
...
.method private registerOrientationListener(Z)V
    ...
    iget-object p0, p0, mOrientationListener:Landroid/view/OrientationEventListener;
...
.method private show()V
    ...
    :cond_5
    :goto_1
    iget-object v2, p0, layoutInflater:Landroid/view/LayoutInflater;
    ...
    :cond_6
    :goto_2
    invoke-direct {p0, v3}, registerOrientationListener(Z)V
...
.method private showH(Landroid/view/View;)V
    ...
    iget-object v1, p0, mViewContainer:Landroid/widget/LinearLayout;

    iget-object v2, p0, mWindowLayoutParams:Landroid/view/WindowManager$LayoutParams;
...
.method private stateChange(I)V
    ...
    :cond_0
    iget v0, p0, mParentStatus:I

    if-eq p1, v0, :cond_1

    iput p1, p0, mParentStatus:I
...
.method private updateThreekeyLayout()V
    ...
    iget-object v1, p0, mWindowLayoutParams:Landroid/view/WindowManager$LayoutParams;
...
.method public onThreeKeyStatus(I)V
    ...
    :cond_1
    sget-object v0, mOpThreekeyNavigationDialog:Lcom/oneplus/opthreekey/OpThreekeyNavigationDialog;
