...
.method constructor <init>(Lcom/oneplus/support/core/fragment/app/FragmentTransitionImpl;Lcom/oneplus/support/collection/ArrayMap;Ljava/lang/Object;Lcom/oneplus/support/core/fragment/app/FragmentTransition$FragmentContainerTransition;Ljava/util/ArrayList;Landroid/view/View;Lcom/oneplus/support/core/fragment/app/Fragment;Lcom/oneplus/support/core/fragment/app/Fragment;ZLjava/util/ArrayList;Ljava/lang/Object;Landroid/graphics/Rect;)V
    ...
    iput-object p1, p0, val$impl:Lcom/oneplus/support/core/fragment/app/FragmentTransitionImpl;

    iput-object p2, p0, val$nameOverrides:Lcom/oneplus/support/collection/ArrayMap;

    iput-object p3, p0, val$finalSharedElementTransition:Ljava/lang/Object;

    iput-object p4, p0, val$fragments:Lcom/oneplus/support/core/fragment/app/FragmentTransition$FragmentContainerTransition;

    iput-object p5, p0, val$sharedElementsIn:Ljava/util/ArrayList;

    iput-object p6, p0, val$nonExistentView:Landroid/view/View;

    iput-object p7, p0, val$inFragment:Lcom/oneplus/support/core/fragment/app/Fragment;

    iput-object p8, p0, val$outFragment:Lcom/oneplus/support/core/fragment/app/Fragment;

    iput-boolean p9, p0, val$inIsPop:Z

    iput-object p10, p0, val$sharedElementsOut:Ljava/util/ArrayList;

    iput-object p11, p0, val$enterTransition:Ljava/lang/Object;

    iput-object p12, p0, val$inEpicenter:Landroid/graphics/Rect;
...
.method public run()V
    ...
    iget-object v0, p0, val$impl:Lcom/oneplus/support/core/fragment/app/FragmentTransitionImpl;

    iget-object v1, p0, val$nameOverrides:Lcom/oneplus/support/collection/ArrayMap;

    iget-object v2, p0, val$finalSharedElementTransition:Ljava/lang/Object;

    iget-object v3, p0, val$fragments:Lcom/oneplus/support/core/fragment/app/FragmentTransition$FragmentContainerTransition;
    ...
    iget-object v1, p0, val$sharedElementsIn:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, val$nonExistentView:Landroid/view/View;

    invoke-virtual {v1, v2}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    :cond_0
    iget-object v1, p0, val$inFragment:Lcom/oneplus/support/core/fragment/app/Fragment;

    iget-object v2, p0, val$outFragment:Lcom/oneplus/support/core/fragment/app/Fragment;

    iget-boolean v3, p0, val$inIsPop:Z
    ...
    iget-object v1, p0, val$finalSharedElementTransition:Ljava/lang/Object;

    if-eqz v1, :cond_1

    iget-object v2, p0, val$impl:Lcom/oneplus/support/core/fragment/app/FragmentTransitionImpl;

    iget-object v3, p0, val$sharedElementsOut:Ljava/util/ArrayList;

    iget-object v4, p0, val$sharedElementsIn:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, val$fragments:Lcom/oneplus/support/core/fragment/app/FragmentTransition$FragmentContainerTransition;

    iget-object v2, p0, val$enterTransition:Ljava/lang/Object;
    ...
    iget-object v1, p0, val$impl:Lcom/oneplus/support/core/fragment/app/FragmentTransitionImpl;

    iget-object p0, p0, val$inEpicenter:Landroid/graphics/Rect;
