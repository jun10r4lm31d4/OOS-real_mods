...
.method public constructor <init>(Landroid/content/Context;Landroid/widget/ImageView;Lcom/android/systemui/plugins/qs/QSIconView;)V
    ...
    iput-object p2, p0, mBg:Landroid/widget/ImageView;

    iput-object p3, p0, mIcon:Lcom/android/systemui/plugins/qs/QSIconView;
...
.method static synthetic access$000(Lcom/oneplus/util/OpLottieUtils;)Lcom/airbnb/lottie/LottieDrawable;
    ...
    iget-object p0, p0, mLottieDrawable:Lcom/airbnb/lottie/LottieDrawable;
...
.method static synthetic access$100(Lcom/oneplus/util/OpLottieUtils;)Lcom/airbnb/lottie/LottieAnimationView;
    ...
    iget-object p0, p0, mLottieAnimView:Lcom/airbnb/lottie/LottieAnimationView;
...
.method static synthetic access$200(Lcom/oneplus/util/OpLottieUtils;Lcom/android/systemui/plugins/qs/QSTile$State;)Landroid/animation/ValueAnimator;
    ...
    invoke-direct {p0, p1}, setBgAnimator(Lcom/android/systemui/plugins/qs/QSTile$State;)Landroid/animation/ValueAnimator;
...
.method static synthetic access$300(Lcom/oneplus/util/OpLottieUtils;Lcom/android/systemui/plugins/qs/QSTile$State;)V
    ...
    invoke-direct {p0, p1}, onFinish(Lcom/android/systemui/plugins/qs/QSTile$State;)V
...
.method private static getCurrentShapeString(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p0}, getCurrentShape(Landroid/content/Context;)I
...
.method private getLottieAnimFile(Lcom/android/systemui/plugins/qs/QSTile$State;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, isNeedLottie(Lcom/android/systemui/plugins/qs/QSTile$State;)Z
    ...
    invoke-static {p0}, getCurrentShapeString(Landroid/content/Context;)Ljava/lang/String;
...
.method private onFinish(Lcom/android/systemui/plugins/qs/QSTile$State;)V
    ...
    iget-object v0, p0, mBg:Landroid/widget/ImageView;
    ...
    iput-boolean p1, p0, mClickedForAnim:Z

    iput-boolean p1, p0, mIsAnimating:Z
...
.method private setBgAnimator(Lcom/android/systemui/plugins/qs/QSTile$State;)Landroid/animation/ValueAnimator;
    ...
    invoke-direct {p0}, getCurrentBgColor()I
...
.method public applyLottieAnimIfNeeded(Landroid/widget/FrameLayout;Lcom/android/systemui/plugins/qs/QSTile$State;Z)Z
    ...
    invoke-virtual {p0, p2}, isNeedLottie(Lcom/android/systemui/plugins/qs/QSTile$State;)Z
    ...
    iput-boolean v0, p0, mIsAnimating:Z

    iget-object v1, p0, mLottieAnimView:Lcom/airbnb/lottie/LottieAnimationView;
    ...
    iput-object v1, p0, mLottieAnimView:Lcom/airbnb/lottie/LottieAnimationView;
    ...
    invoke-direct {p0, p2, p3}, createLottieDrawable(Lcom/android/systemui/plugins/qs/QSTile$State;Z)Lcom/airbnb/lottie/LottieDrawable;

    move-result-object p3

    iput-object p3, p0, mLottieDrawable:Lcom/airbnb/lottie/LottieDrawable;

    iget-object p3, p0, mLottieAnimView:Lcom/airbnb/lottie/LottieAnimationView;

    iget-object v1, p0, mLottieDrawable:Lcom/airbnb/lottie/LottieDrawable;
    ...
    invoke-direct {p0, p2}, getLottieAnimFile(Lcom/android/systemui/plugins/qs/QSTile$State;)Ljava/lang/String;
...
.method public isNeedLottie(Lcom/android/systemui/plugins/qs/QSTile$State;)Z
    ...
    iget-boolean v1, p0, mClickedForAnim:Z
    ...
    :cond_0
    invoke-direct {p0, p1}, isCurStateNeedLottie(Lcom/android/systemui/plugins/qs/QSTile$State;)Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-direct {p0, p1}, isCurShapeNeedLottie(Lcom/android/systemui/plugins/qs/QSTile$State;)Z
...
.method public performClick()Z
    ...
    :cond_0
    iput-boolean v1, p0, mClickedForAnim:Z
