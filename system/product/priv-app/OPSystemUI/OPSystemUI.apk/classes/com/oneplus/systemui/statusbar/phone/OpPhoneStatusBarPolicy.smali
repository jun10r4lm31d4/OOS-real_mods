...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/statusbar/phone/StatusBarIconController;)V
    ...
    iput-object v0, p0, mSettingObserver:Lcom/oneplus/systemui/statusbar/phone/OpPhoneStatusBarPolicy$SettingObserver;
    ...
    iput-object v1, p0, mBgHandler:Landroid/os/Handler;

    iput v0, p0, mBluetoothIconId:I

    const/4 v1, 0x0

    iput-object v1, p0, mBluetoothContentDescription:Ljava/lang/String;

    iput-boolean v0, p0, mBluetoothConnected:Z

    const/4 v2, -0x1

    iput v2, p0, mBluetoothBatteryLevel:I

    iput-boolean v0, p0, mBluetoothIconVisible:Z

    iput-boolean v0, p0, mIsNotifyShown:Z
    ...
    iput-object v3, p0, mShowRunnable:Ljava/lang/Runnable;
    ...
    iput-object v3, p0, mNfcReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v4, p0, mSettingObserver:Lcom/oneplus/systemui/statusbar/phone/OpPhoneStatusBarPolicy$SettingObserver;
    ...
    iput-object p2, p0, mOpZenModeController:Lcom/oneplus/opzenmode/OpZenModeController;

    iget-object p2, p0, mOpZenModeController:Lcom/oneplus/opzenmode/OpZenModeController;
    ...
    iput-boolean v3, p0, mIsNotifyShown:Z

    iget-boolean v3, p0, mIsNotifyShown:Z
    ...
    iget-object v6, p0, mNfcReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object p2, p0, mWlbSwitchController:Lcom/android/systemui/statusbar/phone/WLBSwitchController;
    ...
    iget-object v1, p0, mWlbSwitchController:Lcom/android/systemui/statusbar/phone/WLBSwitchController;
    ...
    iget-object p1, p0, mWlbSwitchController:Lcom/android/systemui/statusbar/phone/WLBSwitchController;
...
.method static synthetic access$300(Lcom/oneplus/systemui/statusbar/phone/OpPhoneStatusBarPolicy;)Z
    ...
    iget-boolean p0, p0, mBluetoothIconVisible:Z
...
.method static synthetic access$400(Lcom/oneplus/systemui/statusbar/phone/OpPhoneStatusBarPolicy;)Ljava/lang/String;
    ...
    invoke-direct {p0}, getSlotBluetooth()Ljava/lang/String;
...
.method static synthetic access$600(Lcom/oneplus/systemui/statusbar/phone/OpPhoneStatusBarPolicy;)Ljava/lang/String;
    ...
    iget-object p0, p0, mBluetoothContentDescription:Ljava/lang/String;
...
.method public hideStatusBarIcon()V
    ...
    iget-object p0, p0, mSlotWLB:Ljava/lang/String;
...
.method public synthetic lambda$OpUpdateBluetooth$0$OpPhoneStatusBarPolicy()V
    ...
    iget-object v0, p0, mBluetooth:Lcom/android/systemui/statusbar/policy/BluetoothController;
    ...
    iget-object v3, p0, mBluetooth:Lcom/android/systemui/statusbar/policy/BluetoothController;
    ...
    iget-object v5, p0, mBluetooth:Lcom/android/systemui/statusbar/policy/BluetoothController;
    ...
    invoke-direct {p0, v5}, getBluetoothBatteryIcon(I)I
    ...
    iget v6, p0, mBluetoothIconId:I

    if-ne v6, v1, :cond_5

    iget-boolean v6, p0, mBluetoothIconVisible:Z

    if-ne v6, v3, :cond_5

    iget-boolean v6, p0, mBluetoothConnected:Z

    if-ne v6, v0, :cond_5

    iget v6, p0, mBluetoothBatteryLevel:I

    if-ne v6, v5, :cond_5

    if-eqz v4, :cond_7

    iget-object v6, p0, mBluetoothContentDescription:Ljava/lang/String;
    ...
    iget-object v7, p0, mBluetooth:Lcom/android/systemui/statusbar/policy/BluetoothController;
    ...
    iget-boolean v7, p0, mBluetoothConnected:Z
    ...
    iget-boolean v7, p0, mBluetoothIconVisible:Z
    ...
    iget-object v7, p0, mBluetoothContentDescription:Ljava/lang/String;
    ...
    iget v7, p0, mBluetoothBatteryLevel:I
    ...
    iput v1, p0, mBluetoothIconId:I

    iput-boolean v3, p0, mBluetoothIconVisible:Z

    iput-boolean v0, p0, mBluetoothConnected:Z

    iput v5, p0, mBluetoothBatteryLevel:I

    iput-object v4, p0, mBluetoothContentDescription:Ljava/lang/String;

    :cond_7
    invoke-direct {p0}, postShowBT()V
...
.method public opUpdateHotspot()V
    ...
    invoke-direct {p0}, getSlotHotspot()Ljava/lang/String;
...
.method protected sendHeadsetNotify()V
    ...
    iget-boolean v0, p0, mIsNotifyShown:Z
    ...
    iput-boolean v7, p0, mIsNotifyShown:Z
...
.method protected updateVolumeZen(I)Lcom/oneplus/systemui/statusbar/phone/OpPhoneStatusBarPolicy$OpUpdateVolumeZenObject;
    ...
    iput v3, p0, mVibrateWhenMute:I

    iget-object v3, p0, mOpZenModeController:Lcom/oneplus/opzenmode/OpZenModeController;

    invoke-interface {v3}, Lcom/oneplus/opzenmode/OpZenModeController;->getThreeKeySatus()I

    move-result v3

    iget-object v4, p0, mOpZenModeController:Lcom/oneplus/opzenmode/OpZenModeController;
