...
.method public constructor <init>(Landroid/content/Context;Lcom/oneplus/keyguard/OpEmergencyPanel;Lcom/oneplus/keyguard/OpEmergencyBubble;Landroid/widget/LinearLayout;)V
    ...
    iput-boolean v0, p0, mIsReseting:Z
    ...
    iput-boolean v0, p0, isStart:Z

    iput-boolean v0, p0, animationRunning:Z

    iput-boolean v0, p0, shakeAnimationRunning:Z
    ...
    iput-object v0, p0, mHander:Landroid/os/Handler;

    iput-object p1, p0, mContext:Landroid/content/Context;

    iput-object p2, p0, mPanel:Lcom/oneplus/keyguard/OpEmergencyPanel;

    iput-object p3, p0, mTouchView:Lcom/oneplus/keyguard/OpEmergencyBubble;

    iget-object p1, p0, mTouchView:Lcom/oneplus/keyguard/OpEmergencyBubble;
    ...
    iput-object p4, p0, mIndicatorLayout:Landroid/widget/LinearLayout;

    iget-object p1, p0, mIndicatorLayout:Landroid/widget/LinearLayout;
    ...
    iput-object p1, p0, mArrowView:Landroid/view/View;
    ...
    iput-object p1, p0, mHintText:Landroid/widget/TextView;
    ...
    sput p1, mDropThreshold:I

    const-wide/16 p1, 0x74

    invoke-direct {p0, p1, p2}, getZoomInAnimatorSet(J)Landroid/animation/AnimatorSet;

    move-result-object p1

    iput-object p1, p0, mDragStartAnimation:Landroid/animation/AnimatorSet;

    const-wide/16 p1, 0x4b

    invoke-direct {p0, p1, p2}, getZoomOutAnimatorSet(J)Landroid/animation/AnimatorSet;

    move-result-object p1

    iput-object p1, p0, mDragEndAnimation:Landroid/animation/AnimatorSet;
...
.method static synthetic access$000(Lcom/oneplus/keyguard/OpDragPanelController;)V
    ...
    invoke-direct {p0}, createHintAnimation()V
...
.method static synthetic access$100(Lcom/oneplus/keyguard/OpDragPanelController;)Landroid/animation/AnimatorSet;
    ...
    iget-object p0, p0, mHintAnimation:Landroid/animation/AnimatorSet;
...
.method static synthetic access$1000(Lcom/oneplus/keyguard/OpDragPanelController;)V
    ...
    invoke-direct {p0}, stopShakeAnimation()V
...
.method static synthetic access$1100(Lcom/oneplus/keyguard/OpDragPanelController;)V
    ...
    invoke-direct {p0}, stopHintAnimation()V
...
.method static synthetic access$1200(Lcom/oneplus/keyguard/OpDragPanelController;)Landroid/animation/AnimatorSet;
    ...
    iget-object p0, p0, mDragStartAnimation:Landroid/animation/AnimatorSet;
...
.method static synthetic access$1400(Lcom/oneplus/keyguard/OpDragPanelController;)Lcom/oneplus/keyguard/OpDragPanelController$VelocityTracker;
    ...
    iget-object p0, p0, mVelocityTracker:Lcom/oneplus/keyguard/OpDragPanelController$VelocityTracker;
...
.method static synthetic access$1402(Lcom/oneplus/keyguard/OpDragPanelController;Lcom/oneplus/keyguard/OpDragPanelController$VelocityTracker;)Lcom/oneplus/keyguard/OpDragPanelController$VelocityTracker;
    ...
    iput-object p1, p0, mVelocityTracker:Lcom/oneplus/keyguard/OpDragPanelController$VelocityTracker;
...
.method static synthetic access$1600(Lcom/oneplus/keyguard/OpDragPanelController;)Lcom/oneplus/keyguard/OpEmergencyBubble;
    ...
    iget-object p0, p0, mTouchView:Lcom/oneplus/keyguard/OpEmergencyBubble;
...
.method static synthetic access$1700(Lcom/oneplus/keyguard/OpDragPanelController;F)V
    ...
    invoke-direct {p0, p1}, onDragStart(F)V
...
.method static synthetic access$200(Lcom/oneplus/keyguard/OpDragPanelController;)V
    ...
    invoke-direct {p0}, createShakeAnimator()V
...
.method static synthetic access$300(Lcom/oneplus/keyguard/OpDragPanelController;)Landroid/animation/AnimatorSet;
    ...
    iget-object p0, p0, mShakeAnimator:Landroid/animation/AnimatorSet;
...
.method static synthetic access$400(Lcom/oneplus/keyguard/OpDragPanelController;)Lcom/oneplus/keyguard/OpEmergencyPanel;
    ...
    iget-object p0, p0, mPanel:Lcom/oneplus/keyguard/OpEmergencyPanel;
...
.method static synthetic access$600(Lcom/oneplus/keyguard/OpDragPanelController;)Landroid/os/Handler;
    ...
    iget-object p0, p0, mHander:Landroid/os/Handler;
...
.method static synthetic access$700(Lcom/oneplus/keyguard/OpDragPanelController;)Z
    ...
    iget-boolean p0, p0, mIsReseting:Z
...
.method private createHintAnimation()V
    ...
    iget-object v0, p0, mHintAnimation:Landroid/animation/AnimatorSet;

    if-nez v0, :cond_0

    invoke-direct {p0}, getHintAnimation()Landroid/animation/AnimatorSet;

    move-result-object v0

    iput-object v0, p0, mHintAnimation:Landroid/animation/AnimatorSet;
...
.method private createShakeAnimator()V
    ...
    iget-object v0, p0, mShakeAnimator:Landroid/animation/AnimatorSet;

    if-nez v0, :cond_0

    const-wide/16 v0, 0x3e8

    invoke-direct {p0, v0, v1}, getZoomInAnimatorSet(J)Landroid/animation/AnimatorSet;

    move-result-object v2

    invoke-direct {p0, v0, v1}, getZoomOutAnimatorSet(J)Landroid/animation/AnimatorSet;
    ...
    iput-object v1, p0, mShakeAnimator:Landroid/animation/AnimatorSet;

    iget-object v1, p0, mShakeAnimator:Landroid/animation/AnimatorSet;
...
.method private getAlphaAnimatorSet()Landroid/animation/AnimatorSet;
    ...
    iget-object v0, p0, mTouchView:Lcom/oneplus/keyguard/OpEmergencyBubble;
    ...
    iget-object v1, p0, mTouchView:Lcom/oneplus/keyguard/OpEmergencyBubble;
...
.method private getHintAnimation()Landroid/animation/AnimatorSet;
    ...
    iget-object v2, p0, mArrowView:Landroid/view/View;
    ...
    iget-object v3, p0, mArrowView:Landroid/view/View;
...
.method private getZoomInAnimatorSet(J)Landroid/animation/AnimatorSet;
    ...
    iget-object v2, p0, mTouchView:Lcom/oneplus/keyguard/OpEmergencyBubble;
...
.method private isAnimationRunning()Z
    ...
    iget-boolean p0, p0, animationRunning:Z
...
.method private isShakeAnimationRunning()Z
    ...
    iget-boolean p0, p0, shakeAnimationRunning:Z
...
.method private onDragEnd()V
    ...
    iget-object v2, p0, mDragStartAnimation:Landroid/animation/AnimatorSet;
    ...
    :cond_0
    iget-object v0, p0, mVelocityTracker:Lcom/oneplus/keyguard/OpDragPanelController$VelocityTracker;
    ...
    iget-object v0, p0, mDragStartAnimation:Landroid/animation/AnimatorSet;
    ...
    :cond_1
    iget-boolean v0, p0, mDropped:Z

    if-nez v0, :cond_2

    iget-object v0, p0, mDragEndAnimation:Landroid/animation/AnimatorSet;

    invoke-virtual {v0}, Landroid/animation/AnimatorSet;->start()V

    invoke-direct {p0}, restartAnimation()V

    goto :goto_0

    :cond_2
    invoke-direct {p0}, getAlphaAnimatorSet()Landroid/animation/AnimatorSet;
...
.method private onDragStart(F)V
    ...
    iget-object p0, p0, mIndicatorLayout:Landroid/widget/LinearLayout;
...
.method private reset()V
    ...
    invoke-direct {p0}, resetIndicatorLayout()V

    invoke-direct {p0, v0}, resetArrow(Z)V

    invoke-direct {p0}, resetTouchView()V

    invoke-direct {p0}, resetText()V
...
.method private resetArrow(Z)V
    ...
    :cond_0
    iget-object v0, p0, mArrowView:Landroid/view/View;
...
.method private resetText()V
    ...
    iget-object p0, p0, mHintText:Landroid/widget/TextView;
...
.method private restartAnimation()V
    ...
    invoke-direct {p0}, startShakeAnimation()V

    invoke-direct {p0}, startHintAnimation()V
...
.method private startHintAnimation()V
    ...
    invoke-direct {p0}, isAnimationRunning()Z
    ...
    iget-object v0, p0, mHander:Landroid/os/Handler;
...
.method private startShakeAnimation()V
    ...
    invoke-direct {p0}, isShakeAnimationRunning()Z
    ...
    iput-boolean v1, p0, shakeAnimationRunning:Z
...
.method private stopHintAnimation()V
    ...
    iput-boolean v1, p0, animationRunning:Z
