...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-boolean v0, p0, mRefreshToolbar:Z
    ...
    iput v1, p0, mScrimVisibleHeightTrigger:I
    ...
    iput-object v2, p0, mCollapsingTextHelper:Lcom/oneplus/lib/design/widget/CollapsingTextHelper;
    ...
    iput p2, p0, mExpandedMarginBottom:I

    iput p2, p0, mExpandedMarginEnd:I

    iput p2, p0, mExpandedMarginTop:I

    iput p2, p0, mExpandedMarginStart:I
    ...
    iput p2, p0, mCollapsedTitileMarginBottom:I
    ...
    iput-boolean p2, p0, mCollapsingTitleEnabled:Z
    ...
    iput p2, p0, mScrimVisibleHeightTrigger:I
    ...
    iput-wide v2, p0, mScrimAnimationDuration:J
    ...
    invoke-virtual {p0, p2}, setContentScrim(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, p2}, setStatusBarScrim(Landroid/graphics/drawable/Drawable;)V
...
.method private animateScrim(I)V
    ...
    invoke-direct {p0}, ensureToolbar()V

    iget-object v0, p0, mScrimAnimator:Landroid/animation/ValueAnimator;
    ...
    iput-object v0, p0, mScrimAnimator:Landroid/animation/ValueAnimator;

    iget-object v0, p0, mScrimAnimator:Landroid/animation/ValueAnimator;

    iget-wide v1, p0, mScrimAnimationDuration:J

    invoke-virtual {v0, v1, v2}, Landroid/animation/ValueAnimator;->setDuration(J)Landroid/animation/ValueAnimator;

    iget-object v0, p0, mScrimAnimator:Landroid/animation/ValueAnimator;

    iget v1, p0, mScrimAlpha:I
    ...
    iget-object p0, p0, mScrimAnimator:Landroid/animation/ValueAnimator;
...
.method private ensureToolbar()V
    ...
    iget-boolean v0, p0, mRefreshToolbar:Z
    ...
    iput-object v0, p0, mToolbar:Lcom/oneplus/lib/widget/actionbar/Toolbar;

    iput-object v0, p0, mToolbarDirectChild:Landroid/view/View;

    iget v1, p0, mToolbarId:I
    ...
    iput-object v1, p0, mToolbar:Lcom/oneplus/lib/widget/actionbar/Toolbar;

    iget-object v1, p0, mToolbar:Lcom/oneplus/lib/widget/actionbar/Toolbar;

    if-eqz v1, :cond_1

    invoke-direct {p0, v1}, findDirectChild(Landroid/view/View;)Landroid/view/View;

    move-result-object v1

    iput-object v1, p0, mToolbarDirectChild:Landroid/view/View;
    ...
    :cond_4
    invoke-direct {p0}, updateDummyView()V

    iput-boolean v2, p0, mRefreshToolbar:Z
...
.method private isToolbarChildDrawnNext(Landroid/view/View;)Z
    ...
    iget v0, p0, mToolbarDrawIndex:I
...
.method private updateDummyView()V
    ...
    iget-boolean v0, p0, mCollapsingTitleEnabled:Z

    if-nez v0, :cond_0

    iget-object v0, p0, mDummyView:Landroid/view/View;
    ...
    iget-object v1, p0, mDummyView:Landroid/view/View;
    ...
    iget-object v0, p0, mToolbar:Lcom/oneplus/lib/widget/actionbar/Toolbar;
    ...
    iput-object v0, p0, mDummyView:Landroid/view/View;
    ...
    iget-object p0, p0, mDummyView:Landroid/view/View;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, mContentScrim:Landroid/graphics/drawable/Drawable;
    ...
    iget-boolean v0, p0, mDrawCollapsingTitle:Z
    ...
    :cond_1
    iget-object v0, p0, mStatusBarScrim:Landroid/graphics/drawable/Drawable;

    if-eqz v0, :cond_3

    iget v0, p0, mScrimAlpha:I
    ...
    iget-object v2, p0, mStatusBarScrim:Landroid/graphics/drawable/Drawable;

    iget v3, p0, mCurrentOffset:I
    ...
    iget-object p0, p0, mStatusBarScrim:Landroid/graphics/drawable/Drawable;
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    iget-object p4, p0, mContentScrim:Landroid/graphics/drawable/Drawable;

    if-eqz p4, :cond_0

    iget p4, p0, mScrimAlpha:I

    if-lez p4, :cond_0

    invoke-direct {p0, p2}, isToolbarChildDrawnNext(Landroid/view/View;)Z

    move-result p2

    if-eqz p2, :cond_0

    iget-object p2, p0, mContentScrim:Landroid/graphics/drawable/Drawable;

    invoke-virtual {p2}, Landroid/graphics/drawable/Drawable;->mutate()Landroid/graphics/drawable/Drawable;

    move-result-object p2

    iget p3, p0, mScrimAlpha:I

    invoke-virtual {p2, p3}, Landroid/graphics/drawable/Drawable;->setAlpha(I)V

    iget-object p0, p0, mContentScrim:Landroid/graphics/drawable/Drawable;
...
.method protected drawableStateChanged()V
    ...
    iget-object v1, p0, mStatusBarScrim:Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    iget-object v1, p0, mContentScrim:Landroid/graphics/drawable/Drawable;
...
.method protected bridge synthetic generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0}, generateDefaultLayoutParams()Lcom/oneplus/lib/design/widget/CollapsingToolbarLayout$LayoutParams;
...
.method protected bridge synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/widget/FrameLayout$LayoutParams;
...
.method final getMaxOffsetForPinChild(Landroid/view/View;)I
    ...
    invoke-static {p1}, getViewOffsetHelper(Landroid/view/View;)Lcom/oneplus/lib/design/widget/ViewOffsetHelper;
...
.method public getScrimVisibleHeightTrigger()I
    ...
    iget v0, p0, mScrimVisibleHeightTrigger:I
...
.method protected onAttachedToWindow()V
    ...
    iget-object v1, p0, mOnOffsetChangedListener:Lcom/oneplus/lib/design/widget/AppBarLayout$OnOffsetChangedListener;
    ...
    iput-object v1, p0, mOnOffsetChangedListener:Lcom/oneplus/lib/design/widget/AppBarLayout$OnOffsetChangedListener;
...
.method protected onLayout(ZIIII)V
    ...
    iget-object p1, p0, mLastInsets:Lcom/oneplus/support/core/view/WindowInsetsCompat;
    ...
    :cond_1
    iget-boolean p1, p0, mCollapsingTitleEnabled:Z

    if-eqz p1, :cond_9

    iget-object p1, p0, mDummyView:Landroid/view/View;
    ...
    :goto_1
    iput-boolean p1, p0, mDrawCollapsingTitle:Z

    iget-boolean p1, p0, mDrawCollapsingTitle:Z
    ...
    :goto_2
    iget-object p1, p0, mToolbarDirectChild:Landroid/view/View;
    ...
    :cond_4
    iget-object p1, p0, mToolbar:Lcom/oneplus/lib/widget/actionbar/Toolbar;

    :goto_3
    invoke-virtual {p0, p1}, getMaxOffsetForPinChild(Landroid/view/View;)I

    move-result p1

    iget-object v2, p0, mDummyView:Landroid/view/View;
    ...
    iget-object v4, p0, mToolbar:Lcom/oneplus/lib/widget/actionbar/Toolbar;
    ...
    iget-object v5, p0, mToolbar:Lcom/oneplus/lib/widget/actionbar/Toolbar;

    invoke-virtual {v5}, Lcom/oneplus/lib/widget/actionbar/Toolbar;->getTitleMarginTop()I

    move-result v5

    iget-object v6, p0, mToolbar:Lcom/oneplus/lib/widget/actionbar/Toolbar;
    ...
    iget v2, p0, mExpandedMarginEnd:I

    goto :goto_6

    :cond_7
    iget v2, p0, mExpandedMarginStart:I
    ...
    iget v4, p0, mExpandedMarginTop:I
    ...
    iget p2, p0, mExpandedMarginStart:I

    goto :goto_7

    :cond_8
    iget p2, p0, mExpandedMarginEnd:I
    ...
    iget p2, p0, mExpandedMarginBottom:I
    ...
    invoke-static {p2}, getViewOffsetHelper(Landroid/view/View;)Lcom/oneplus/lib/design/widget/ViewOffsetHelper;
    ...
    iget-object p2, p0, mToolbar:Lcom/oneplus/lib/widget/actionbar/Toolbar;
    ...
    :cond_c
    invoke-static {p1}, getHeightWithMargins(Landroid/view/View;)I
    ...
    iput p1, p0, mToolbarDrawIndex:I
    ...
    :goto_a
    invoke-virtual {p0}, updateScrimVisibility()V
...
.method onWindowInsetChanged(Lcom/oneplus/support/core/view/WindowInsetsCompat;)Lcom/oneplus/support/core/view/WindowInsetsCompat;
    ...
    iput-object v0, p0, mLastInsets:Lcom/oneplus/support/core/view/WindowInsetsCompat;
...
.method public setContentScrim(Landroid/graphics/drawable/Drawable;)V
    ...
    :cond_1
    iput-object v1, p0, mContentScrim:Landroid/graphics/drawable/Drawable;

    iget-object p1, p0, mContentScrim:Landroid/graphics/drawable/Drawable;
...
.method public setScrimsShown(Z)V
    ...
    :goto_0
    invoke-virtual {p0, p1, v0}, setScrimsShown(ZZ)V
...
.method public setScrimsShown(ZZ)V
    ...
    iget-boolean v0, p0, mScrimsAreShown:Z
    ...
    :goto_0
    invoke-direct {p0, v0}, animateScrim(I)V
    ...
    :goto_1
    invoke-virtual {p0, v0}, setScrimAlpha(I)V

    :goto_2
    iput-boolean p1, p0, mScrimsAreShown:Z
...
.method public setStatusBarScrim(Landroid/graphics/drawable/Drawable;)V
    ...
    :cond_1
    iput-object v1, p0, mStatusBarScrim:Landroid/graphics/drawable/Drawable;

    iget-object p1, p0, mStatusBarScrim:Landroid/graphics/drawable/Drawable;
...
.method final updateScrimVisibility()V
    ...
    iget v1, p0, mCurrentOffset:I

    add-int/2addr v0, v1

    invoke-virtual {p0}, getScrimVisibleHeightTrigger()I
    ...
    :goto_0
    invoke-virtual {p0, v0}, setScrimsShown(Z)V
