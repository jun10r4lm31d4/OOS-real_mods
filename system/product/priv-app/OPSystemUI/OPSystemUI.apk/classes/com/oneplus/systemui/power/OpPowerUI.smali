...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mLowBatteryReminderLevels:[I

    const/4 v0, -0x2

    iput v0, p0, SOFT_REMIND_BUCKET:I

    iput v2, p0, mScreenTimeout:I

    iput v2, p0, mUser:I

    iput-boolean v2, p0, mCurrentPowerSave:Z

    iput-boolean v2, p0, mSelfChange:Z

    iput-boolean v2, p0, mSelfChangeRestore:Z
...
.method static synthetic access$000(Lcom/oneplus/systemui/power/OpPowerUI;)Z
    ...
    iget-boolean p0, p0, mSelfChange:Z
...
.method static synthetic access$002(Lcom/oneplus/systemui/power/OpPowerUI;Z)Z
    ...
    iput-boolean p1, p0, mSelfChange:Z
...
.method static synthetic access$100(Lcom/oneplus/systemui/power/OpPowerUI;)Z
    ...
    iget-boolean p0, p0, mSelfChangeRestore:Z
...
.method static synthetic access$102(Lcom/oneplus/systemui/power/OpPowerUI;Z)Z
    ...
    iput-boolean p1, p0, mSelfChangeRestore:Z
...
.method static synthetic access$400(Lcom/oneplus/systemui/power/OpPowerUI;I)V
    ...
    invoke-direct {p0, p1}, saveScreenTimeoutToPrefs(I)V
...
.method private restoreScreenTimeoutFromPrefsIfNeeded()V
    ...
    invoke-direct {p0, v1}, saveScreenTimeoutToPrefs(I)V
...
.method protected maybeShowBatteryWarning(Lcom/android/systemui/power/BatteryStateSnapshot;Lcom/android/systemui/power/BatteryStateSnapshot;)V
    ...
    invoke-direct {p0}, getWarnings()Lcom/android/systemui/power/PowerUI$WarningsUI;
    ...
    :goto_0
    invoke-virtual {p0, p1, p2}, shouldShowLowBatteryWarningInternal(Lcom/android/systemui/power/BatteryStateSnapshot;Lcom/android/systemui/power/BatteryStateSnapshot;)Z
    ...
    :cond_3
    invoke-direct {p0, p1, p2}, shouldDismissLowBatteryWarning(Lcom/android/systemui/power/BatteryStateSnapshot;Lcom/android/systemui/power/BatteryStateSnapshot;)Z
...
.method protected maybeShowHybridWarningInternal(Lcom/android/systemui/power/BatteryStateSnapshot;Lcom/android/systemui/power/BatteryStateSnapshot;)V
    ...
    sget-wide v6, SIX_HOURS_MILLIS:J

    cmp-long v1, v4, v6

    if-lez v1, :cond_0

    invoke-direct {p0, v2}, setLowWarningShownThisChargeCycle(Z)V

    invoke-direct {p0, v2}, setSevereWarningShownThisChargeCycle(Z)V
    ...
    :cond_3
    invoke-direct {p0, p1}, shouldShowHybridWarning(Lcom/android/systemui/power/BatteryStateSnapshot;)Z
    ...
    invoke-direct {p0, v5}, setLowWarningShownThisChargeCycle(Z)V

    goto :goto_1

    :cond_5
    :goto_0
    invoke-direct {p0, v5}, setSevereWarningShownThisChargeCycle(Z)V

    invoke-direct {p0, v5}, setLowWarningShownThisChargeCycle(Z)V

    iget-boolean p0, p0, DEBUG:Z
    ...
    :cond_6
    invoke-direct {p0, p1}, shouldDismissHybridWarning(Lcom/android/systemui/power/BatteryStateSnapshot;)Z
...
.method protected restorePowerSavingSettingsForUser()V
    ...
    iput-boolean v0, p0, mSelfChangeRestore:Z
...
.method public start()V
    ...
    invoke-direct {p0}, restoreScreenTimeoutFromPrefsIfNeeded()V
...
.method protected updateBatteryWarningLevelsInternal()V
    ...
    :cond_0
    iget-object v2, p0, mLowBatteryReminderLevels:[I
    ...
    iget-object v1, p0, mLowBatteryReminderLevels:[I
    ...
    invoke-direct {p0, v0}, setLowBatteryAlertCloseLevel(I)V
...
.method protected updatePowerSavingSettings(Z)V
    ...
    iget-boolean v0, p0, mCurrentPowerSave:Z

    if-eq p1, v0, :cond_1

    iput-boolean p1, p0, mCurrentPowerSave:Z
