...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    iput v0, p0, mBatteryStyle:I

    new-instance v1, Landroid/graphics/RectF;

    invoke-direct {v1}, Landroid/graphics/RectF;-><init>()V

    iput-object v1, p0, mCircleRect:Landroid/graphics/RectF;

    iput-boolean v0, p0, mIsOptimizatedCharge:Z

    iput v0, p0, mLastHeight:I

    iput v0, p0, mLastWidth:I
    ...
    iput-object v0, p0, mCircleBackPaint:Landroid/graphics/Paint;

    iget-object v0, p0, mCircleBackPaint:Landroid/graphics/Paint;

    invoke-virtual {v0, p2}, Landroid/graphics/Paint;->setColor(I)V

    iget-object p2, p0, mCircleBackPaint:Landroid/graphics/Paint;
    ...
    iput-object p2, p0, mCircleFrontPaint:Landroid/graphics/Paint;

    iget-object p2, p0, mCircleFrontPaint:Landroid/graphics/Paint;
    ...
    iput-object p2, p0, mCircleChargingPaint:Landroid/graphics/Paint;

    iget-object p2, p0, mCircleChargingPaint:Landroid/graphics/Paint;
    ...
    iput-object p2, p0, mCirclePowerSavePaint:Landroid/graphics/Paint;

    iget-object p2, p0, mCirclePowerSavePaint:Landroid/graphics/Paint;
    ...
    iput-object p2, p0, mBatterySaveOutline:Landroid/graphics/Bitmap;
    ...
    iput p1, p0, mPowerSaveColor:I

    new-instance p1, Landroid/graphics/Paint;

    invoke-direct {p1, v1}, Landroid/graphics/Paint;-><init>(I)V

    iput-object p1, p0, mOptimizatedChargePaint:Landroid/graphics/Paint;

    iget-object p1, p0, mOptimizatedChargePaint:Landroid/graphics/Paint;
    ...
    iget-object p2, p0, mOptimizatedChargePaint:Landroid/graphics/Paint;
    ...
    iput-object p1, p0, mOptimizatedChargeOutline:Landroid/graphics/Bitmap;
    ...
    iput-object p1, p0, mChargingOutlineBitmap:Landroid/graphics/Bitmap;
...
.method private drawBattery(Landroid/graphics/RectF;Landroid/graphics/Canvas;)V
    ...
    iget v6, p0, mMaskColor:I

    invoke-static {v6}, Landroid/graphics/Color;->red(I)I

    move-result v6

    iget v7, p0, mMaskColor:I

    invoke-static {v7}, Landroid/graphics/Color;->green(I)I

    move-result v7

    iget v8, p0, mMaskColor:I
...
.method private drawCircle(Landroid/graphics/Canvas;II)V
    ...
    invoke-direct {p0, v8, v9}, initCircleSize(II)V
    ...
    iget-object v1, v0, mCircleFrontPaint:Landroid/graphics/Paint;
    ...
    iget-object v2, v0, mCircleRect:Landroid/graphics/RectF;
    ...
    iget-object v6, v0, mCircleBackPaint:Landroid/graphics/Paint;
    ...
    iget-object v6, v0, mCircleFrontPaint:Landroid/graphics/Paint;

    move v4, v12

    invoke-virtual/range {v1 .. v6}, Landroid/graphics/Canvas;->drawArc(Landroid/graphics/RectF;FFZLandroid/graphics/Paint;)V

    iget-object v1, v0, mCircleRect:Landroid/graphics/RectF;
    ...
    iget-object v1, v0, mCircleChargingPaint:Landroid/graphics/Paint;
    ...
    invoke-direct {p0}, isOptimizatedCharge()Z

    move-result v1

    if-eqz v1, :cond_2

    iget-object v1, v0, mMaskDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, v0, mMaskDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v3, v0, mCircleRect:Landroid/graphics/RectF;

    invoke-virtual {v3}, Landroid/graphics/RectF;->centerY()F

    move-result v3

    iget-object v0, v0, mCircleChargingPaint:Landroid/graphics/Paint;
    ...
    :cond_3
    iget-boolean v1, v0, mPowerSaveEnabled:Z
    ...
    iget-object v2, v0, mCirclePowerSavePaint:Landroid/graphics/Paint;
    ...
    iget-object v6, v0, mCirclePowerSavePaint:Landroid/graphics/Paint;
    ...
    iget-object v5, v0, mCirclePowerSavePaint:Landroid/graphics/Paint;
...
.method private initCircleSize(II)V
    ...
    iput p1, p0, mCircleSize:I

    iget p1, p0, mCircleSize:I
    ...
    iget-object p0, p0, mCircleRect:Landroid/graphics/RectF;
...
.method private isOptimizatedCharge()Z
    ...
    iget-boolean p0, p0, mIsOptimizatedCharge:Z
...
.method private setMaskDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iget v0, p0, mMaskColorWithoutAlpha:I

    sget-object v1, Landroid/graphics/PorterDuff$Mode;->SRC_ATOP:Landroid/graphics/PorterDuff$Mode;

    invoke-direct {p0, p1, v0, v1}, setMaskDrawable(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
...
.method private setMaskDrawable(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    iput-object p1, p0, mMaskDrawable:Landroid/graphics/drawable/Drawable;

    iget-object p1, p0, mMaskDrawable:Landroid/graphics/drawable/Drawable;

    if-eqz p1, :cond_0

    invoke-virtual {p1, p3}, Landroid/graphics/drawable/Drawable;->setTintMode(Landroid/graphics/PorterDuff$Mode;)V

    iget-object p0, p0, mMaskDrawable:Landroid/graphics/drawable/Drawable;
...
.method private updateViews()V
    ...
    invoke-direct {p0, v0}, setMaskDrawable(Landroid/graphics/drawable/Drawable;)V

    iget-object v0, p0, mBatterySaveOutline:Landroid/graphics/Bitmap;

    iput-object v0, p0, mMaskOutlineBitmap:Landroid/graphics/Bitmap;
    ...
    iget-object v0, p0, mOptimizatedChargeOutline:Landroid/graphics/Bitmap;
    ...
    sget v2, Lcom/android/systemui/R$drawable;->op_circle_optimized_charging:I
    ...
    iput-object v1, p0, mMaskOutlineBitmap:Landroid/graphics/Bitmap;
    ...
    iget-object v0, p0, mChargingOutlineBitmap:Landroid/graphics/Bitmap;
    ...
    :cond_3
    invoke-direct {p0, v1}, setMaskDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-direct {p0, v0, p1}, drawBattery(Landroid/graphics/RectF;Landroid/graphics/Canvas;)V

    iget-object v1, p0, mMaskOutlineBitmap:Landroid/graphics/Bitmap;
    ...
    iget-object v3, p0, mOptimizatedChargePaint:Landroid/graphics/Paint;
    ...
    :cond_1
    iget-object v0, p0, mMaskDrawable:Landroid/graphics/drawable/Drawable;

    if-eqz v0, :cond_2

    iget v1, p0, mMaskColor:I
    ...
    invoke-direct {p0, p1, v0, v1}, drawCircle(Landroid/graphics/Canvas;II)V
...
.method public onOptimizatedStatusChange(Z)V
    ...
    iget-boolean v0, p0, mIsOptimizatedCharge:Z
...
.method public setBounds(IIII)V
    ...
    iget p1, p0, mLastHeight:I

    iget p2, p0, mHeight:I

    if-ne p1, p2, :cond_0

    iget p1, p0, mLastWidth:I
    ...
    iput p1, p0, mLastHeight:I

    iget p1, p0, mWidth:I

    iput p1, p0, mLastWidth:I

    const/16 p1, 0x14

    invoke-direct {p0, p1}, postInvalidate(I)V
...
.method public setColors(II)V
    ...
    iget-object v0, p0, mCircleFrontPaint:Landroid/graphics/Paint;

    invoke-virtual {v0, p1}, Landroid/graphics/Paint;->setColor(I)V

    iget-object v0, p0, mCircleChargingPaint:Landroid/graphics/Paint;
...
.method public setColors(III)V
    ...
    iput p3, p0, mOutlineColor:I

    iput p1, p0, mMaskColor:I

    iget p3, p0, mMaskColor:I

    invoke-static {p3}, Landroid/graphics/Color;->red(I)I

    move-result p3

    iget v0, p0, mMaskColor:I
    ...
    iput p3, p0, mMaskColorWithoutAlpha:I

    iget-object p3, p0, mMaskDrawable:Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    iget-object p3, p0, mCirclePowerSavePaint:Landroid/graphics/Paint;

    iget v0, p0, mMaskColor:I

    invoke-virtual {p3, v0}, Landroid/graphics/Paint;->setColor(I)V

    iget p3, p0, mBatteryStyle:I
    ...
    :cond_1
    iget-boolean p3, p0, mPowerSaveEnabled:Z
    ...
    :cond_3
    :goto_0
    invoke-virtual {p0, p1, p2}, setColors(II)V
...
.method public setPowerSaveEnabled(Z)V
    ...
    iput-boolean p1, p0, mPowerSaveEnabled:Z
