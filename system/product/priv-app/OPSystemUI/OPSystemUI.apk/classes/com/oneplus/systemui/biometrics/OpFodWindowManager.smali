...
.method public constructor <init>(Landroid/content/Context;Lcom/oneplus/systemui/biometrics/OpBiometricDialogImpl;Lcom/oneplus/systemui/biometrics/OpFingerprintDialogView;)V
    ...
    iput-boolean v0, p0, mIs2KDisplay:Z
    ...
    iput-object p3, p0, mDialogView:Lcom/oneplus/systemui/biometrics/OpFingerprintDialogView;

    invoke-virtual {p0}, getFpLayoutParams()Landroid/view/WindowManager$LayoutParams;

    move-result-object p1

    iput-object p1, p0, mFpLayoutParams:Landroid/view/WindowManager$LayoutParams;

    invoke-direct {p0}, getHighlightViewLayoutParams()Landroid/view/WindowManager$LayoutParams;

    move-result-object p1

    iput-object p1, p0, mHighlightViewParams:Landroid/view/WindowManager$LayoutParams;

    invoke-direct {p0}, getIconLayoutParams()Landroid/view/WindowManager$LayoutParams;

    move-result-object p1

    iput-object p1, p0, mTransparentIconParams:Landroid/view/WindowManager$LayoutParams;

    iget-object p1, p0, mDialogView:Lcom/oneplus/systemui/biometrics/OpFingerprintDialogView;
    ...
    iput-boolean p1, p0, mCustHideCutout:Z
...
.method private getCustomLayoutParams(Ljava/lang/String;)Landroid/view/WindowManager$LayoutParams;
    ...
    iget-object v3, p0, mFpLayoutParams:Landroid/view/WindowManager$LayoutParams;
    ...
    iget-object v0, p0, mFpLayoutParams:Landroid/view/WindowManager$LayoutParams;
    ...
    :cond_2
    iget-object p0, p0, mFpLayoutParams:Landroid/view/WindowManager$LayoutParams;
    ...
    iget-object v8, p0, mHighlightViewParams:Landroid/view/WindowManager$LayoutParams;
    ...
    iget-object v0, p0, mHighlightViewParams:Landroid/view/WindowManager$LayoutParams;
    ...
    :cond_6
    iget-object p0, p0, mHighlightViewParams:Landroid/view/WindowManager$LayoutParams;
    ...
    invoke-virtual {p0}, is2KDisplay()Z
    ...
    iget-object p0, p0, mDialogView:Lcom/oneplus/systemui/biometrics/OpFingerprintDialogView;
...
.method private getHighlightViewLayoutParams()Landroid/view/WindowManager$LayoutParams;
    ...
    invoke-direct {p0, v0}, getCustomLayoutParams(Ljava/lang/String;)Landroid/view/WindowManager$LayoutParams;
...
.method private getIconLayoutParams()Landroid/view/WindowManager$LayoutParams;
    ...
    iput v0, p0, mTransparentIconSize:I
    ...
    iget v3, p0, mTransparentIconSize:I
...
.method public addFpViewToWindow()V
    ...
    iget-object v0, p0, mDialogView:Lcom/oneplus/systemui/biometrics/OpFingerprintDialogView;
    ...
    iget-object v1, p0, mDialogView:Lcom/oneplus/systemui/biometrics/OpFingerprintDialogView;
...
.method public addHighlightViewToWindow(Landroid/view/View;)V
    ...
    iput-object p1, p0, mHighlightView:Landroid/view/View;
...
.method public addTransparentIconViewToWindow(Landroid/view/View;)V
    ...
    iput-object p1, p0, mTransparentIconView:Landroid/view/View;

    iget-object v0, p0, mWindowManager:Landroid/view/WindowManager;

    iget-object p0, p0, mTransparentIconParams:Landroid/view/WindowManager$LayoutParams;
...
.method public addView(Landroid/view/View;)V
    ...
    :cond_0
    iget-object v1, p0, mHighlightView:Landroid/view/View;
    ...
    :cond_1
    iget-object v1, p0, mTransparentIconView:Landroid/view/View;
    ...
    :cond_3
    :goto_0
    invoke-virtual {p0, p1}, addTransparentIconViewToWindow(Landroid/view/View;)V

    goto :goto_2

    :cond_4
    :goto_1
    invoke-virtual {p0, p1}, addHighlightViewToWindow(Landroid/view/View;)V
...
.method public handleConfigurationChange()V
    ...
    iput-object v0, p0, mFpLayoutParams:Landroid/view/WindowManager$LayoutParams;

    const-string v1, "OPFingerprintView"

    invoke-direct {p0, v1}, getCustomLayoutParams(Ljava/lang/String;)Landroid/view/WindowManager$LayoutParams;

    move-result-object v1

    iput-object v1, p0, mFpLayoutParams:Landroid/view/WindowManager$LayoutParams;
    ...
    iget-object v2, p0, mFpLayoutParams:Landroid/view/WindowManager$LayoutParams;
    ...
    iget-object v2, p0, mDialogView:Lcom/oneplus/systemui/biometrics/OpFingerprintDialogView;
    ...
    :cond_0
    iput-object v0, p0, mHighlightViewParams:Landroid/view/WindowManager$LayoutParams;
    ...
    iput-object v1, p0, mHighlightViewParams:Landroid/view/WindowManager$LayoutParams;
    ...
    iget-object v2, p0, mHighlightView:Landroid/view/View;

    iget-object v3, p0, mHighlightViewParams:Landroid/view/WindowManager$LayoutParams;

    invoke-interface {v1, v2, v3}, Landroid/view/WindowManager;->updateViewLayout(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    :cond_1
    iput-object v0, p0, mTransparentIconParams:Landroid/view/WindowManager$LayoutParams;
    ...
    iget-object v0, p0, mTransparentIconView:Landroid/view/View;
    ...
    iget-boolean v0, p0, mTransparentIconExpand:Z
...
.method public handleUpdateTransparentIconLayoutParams(Z)V
    ...
    iput-boolean p1, p0, mTransparentIconExpand:Z
    ...
    iget-object p0, p0, mTransparentIconView:Landroid/view/View;
...
.method public is2KDisplay()Z
    ...
    iget-boolean p0, p0, mIs2KDisplay:Z
...
.method public isTransparentViewExpanded()Z
    ...
    iget-boolean p0, p0, mTransparentIconExpand:Z
...
.method public onDensityOrFontScaleChanged()V
    ...
    :goto_1
    iput-boolean v4, p0, mIs2KDisplay:Z
    ...
    iget-boolean v2, p0, mIs2KDisplay:Z
...
.method public onOverlayChanged()V
    ...
    iget-boolean v1, p0, mCustHideCutout:Z
    ...
    iget-boolean v0, p0, mCustHideCutout:Z
    ...
    iput-boolean v0, p0, mCustHideCutout:Z
...
.method public removeHighlightView()V
    ...
    iget-object v0, p0, mHighlightView:Landroid/view/View;
    ...
    iget-object p0, p0, mHighlightView:Landroid/view/View;
...
.method public removeView(Landroid/view/View;)V
    ...
    :cond_3
    :goto_0
    invoke-virtual {p0}, removeTransparentIconView()V

    goto :goto_2

    :cond_4
    :goto_1
    invoke-virtual {p0}, removeHighlightView()V
