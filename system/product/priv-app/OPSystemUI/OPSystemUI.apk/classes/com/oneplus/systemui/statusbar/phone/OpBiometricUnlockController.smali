...
.method static constructor <clinit>()V
    ...
    sput v0, FP_FAILED_ATTEMPTS_TO_WAKEUP:I

    const/4 v0, 0x1

    sput v0, FP_FAILED_ATTEMPTS_TO_WAKEUP_IN_DOZE:I
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/keyguard/KeyguardViewMediator;Lcom/android/systemui/statusbar/phone/StatusBar;)V
    ...
    iput-boolean v0, p0, IS_SUPPORT_CUSTOM_FINGERPRINT:Z

    const/4 v0, 0x0

    iput-boolean v0, p0, mForceShowBouncer:Z

    iput-boolean v0, p0, mNoBouncerAnim:Z

    iput-boolean v0, p0, mIsFingerprintAuthenticating:Z

    iput-boolean v0, p0, mApplySpeedUpPolicy:Z

    iput v0, p0, mFaceLockMode:I
    ...
    iput-object p3, p0, mStatusBar:Lcom/android/systemui/statusbar/phone/StatusBar;
...
.method private onFingerprintUnlockStart()V
    ...
    invoke-virtual {p0, v3, v3}, changePanelVisibilityByAlpha(IZ)V
    ...
    iput-boolean v2, p0, mIsScreenOffUnlock:Z
...
.method public isBouncerAnimNeeded()Z
    ...
    iget-boolean p0, p0, mNoBouncerAnim:Z
...
.method public isFingerprintAuthenticating()Z
    ...
    iget-boolean p0, p0, mIsFingerprintAuthenticating:Z
...
.method public isPlayingScrimAnimation()Z
    ...
    iget-boolean p0, p0, mIsPlaying:Z
...
.method public onBiometricHelp(ILjava/lang/String;Landroid/hardware/biometrics/BiometricSourceType;)V
    ...
    invoke-virtual {p0, p1}, onFingerprintUnlockCancel(I)V
...
.method public onFingerprintAcquired(I)V
    ...
    invoke-virtual {p0, v3, v3}, setFingerprintState(ZI)V

    goto :goto_2

    :cond_4
    invoke-virtual {p0, v3, v1}, setFingerprintState(ZI)V
    ...
    :goto_2
    invoke-direct {p0}, onFingerprintUnlockStart()V
...
.method protected onFingerprintAuthFailed()V
    ...
    invoke-virtual {p0}, isFingerprintAuthenticating()Z
    ...
    invoke-virtual {p0, v0}, onFingerprintUnlockCancel(I)V
...
.method protected onFingerprintUnlockCancel(I)V
    ...
    sget v1, FP_FAILED_ATTEMPTS_TO_WAKEUP:I

    iget-boolean v2, p0, IS_SUPPORT_CUSTOM_FINGERPRINT:Z
    ...
    sget v1, FP_FAILED_ATTEMPTS_TO_WAKEUP_IN_DOZE:I
    ...
    iget-object v2, p0, mKeyguardViewMediator:Lcom/android/systemui/keyguard/KeyguardViewMediator;
    ...
    invoke-virtual {p0, v2, v3}, changePanelVisibilityByAlpha(IZ)V
    ...
    iput-boolean v2, p0, mForceShowBouncer:Z

    invoke-direct {p0, v2}, setPendingShowBouncer(Z)V
    ...
    iget-boolean p1, p0, IS_SUPPORT_CUSTOM_FINGERPRINT:Z

    if-nez p1, :cond_7

    iget-boolean p1, p0, mIsScreenOffUnlock:Z
    ...
    invoke-virtual {p0, v3, p1}, setFingerprintState(ZI)V
...
.method public onKeyguardVisibilityChanged(Z)V
    ...
    iget-boolean v1, p0, mIsFingerprintAuthenticating:Z
    ...
    iget-boolean p1, p0, mIsFingerprintAuthenticating:Z

    if-eqz p1, :cond_0

    const/4 p1, 0x0

    invoke-virtual {p0, p1, p1}, changePanelVisibilityByAlpha(IZ)V
...
.method public onStartedWakingUp()V
    ...
    iget-boolean v0, p0, mIsScreenOffUnlock:Z
    ...
    invoke-virtual {p0, v0, v0}, changePanelVisibilityByAlpha(IZ)V

    const/4 v0, 0x0

    invoke-virtual {p0, v0, v0}, setFingerprintState(ZI)V
...
.method protected opIsBiometricUnlock()Z
    ...
    invoke-direct {p0}, isWakeAndUnlock()Z

    move-result v0

    if-nez v0, :cond_1

    invoke-direct {p0}, getMode()I
...
.method protected opShowBouncer()V
    ...
    iget-boolean v1, p0, IS_SUPPORT_CUSTOM_FINGERPRINT:Z

    if-eqz v1, :cond_0

    iget-boolean v1, p0, mForceShowBouncer:Z

    if-eqz v1, :cond_0

    const/4 v1, 0x1

    iput-boolean v1, p0, mNoBouncerAnim:Z
    ...
    invoke-direct {p0, v1}, calculateMode(Landroid/hardware/biometrics/BiometricSourceType;)I
    ...
    iget-boolean v2, p0, mNoBouncerAnim:Z
    ...
    invoke-direct {p0, v0}, setPendingShowBouncer(Z)V
...
.method protected setFingerprintState(ZI)V
    ...
    iget-boolean v0, p0, mIsFingerprintAuthenticating:Z
    ...
    :cond_0
    iput-boolean p1, p0, mIsFingerprintAuthenticating:Z
...
.method public shouldApplySpeedUpPolicy()Z
    ...
    iget-boolean v0, p0, IS_SUPPORT_CUSTOM_FINGERPRINT:Z
...
.method public startWakeAndUnlockForFace(I)V
    ...
    invoke-virtual {p0, p1}, setFaceLockMode(I)V
    ...
    invoke-direct {p0, v1}, setPendingShowBouncer(Z)V

    goto :goto_0

    :cond_2
    invoke-virtual {p0}, opShowBouncer()V
    ...
    invoke-direct {p0}, isLauncherOnTop()Z
