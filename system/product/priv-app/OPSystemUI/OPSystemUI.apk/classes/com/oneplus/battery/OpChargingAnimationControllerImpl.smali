...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v0, p0, mCurrentAnimationState:I

    const/4 v0, 0x0

    iput-boolean v0, p0, mWarpFastCharging:Z

    iput-boolean v0, p0, mFastCharging:Z

    iput-boolean v0, p0, mBouncerShow:Z

    iput-boolean v0, p0, mPreventViewShow:Z

    iput-boolean v0, p0, mPluggedButNotUsb:Z

    iput-boolean v0, p0, mKeyguardOn:Z
    ...
    iput-boolean v0, p0, isKeyguardShowing:Z

    const/4 v0, 0x0

    iput-object v0, p0, mWallpaper:Landroid/graphics/Bitmap;
    ...
    iput-object v1, p0, mScreenObserver:Lcom/android/systemui/keyguard/ScreenLifecycle$Observer;
    ...
    iput-object p1, p0, mBatteryController:Lcom/android/systemui/statusbar/policy/BatteryController;

    sget-boolean p1, Lcom/oneplus/util/OpUtils;->SUPPORT_WARP_CHARGING:Z

    if-eqz p1, :cond_0

    invoke-virtual {p0}, registerReceiver()V
    ...
    iput-object p1, p0, mKeyguardStateCallback:Lcom/oneplus/battery/OpChargingAnimationControllerImpl$KeyguardStateCallback;
...
.method static synthetic access$100(Lcom/oneplus/battery/OpChargingAnimationControllerImpl;)Lcom/oneplus/battery/OpWarpChargingView;
    ...
    iget-object p0, p0, mOpWarpChargingView:Lcom/oneplus/battery/OpWarpChargingView;
...
.method static synthetic access$1002(Lcom/oneplus/battery/OpChargingAnimationControllerImpl;Z)Z
    ...
    iput-boolean p1, p0, mPreventViewShow:Z
...
.method static synthetic access$200(Lcom/oneplus/battery/OpChargingAnimationControllerImpl;)Ljava/lang/String;
    ...
    iget-object p0, p0, TAG:Ljava/lang/String;
...
.method static synthetic access$400(Lcom/oneplus/battery/OpChargingAnimationControllerImpl;)Z
    ...
    iget-boolean p0, p0, mKeyguardOn:Z
...
.method static synthetic access$402(Lcom/oneplus/battery/OpChargingAnimationControllerImpl;Z)Z
    ...
    iput-boolean p1, p0, mKeyguardOn:Z
...
.method static synthetic access$500(Lcom/oneplus/battery/OpChargingAnimationControllerImpl;)Z
    ...
    iget-boolean p0, p0, mPluggedButNotUsb:Z
...
.method static synthetic access$502(Lcom/oneplus/battery/OpChargingAnimationControllerImpl;Z)Z
    ...
    iput-boolean p1, p0, mPluggedButNotUsb:Z
...
.method static synthetic access$600(Lcom/oneplus/battery/OpChargingAnimationControllerImpl;)V
    ...
    invoke-direct {p0}, prepareAnimationResource()V
...
.method static synthetic access$700(Lcom/oneplus/battery/OpChargingAnimationControllerImpl;)V
    ...
    invoke-direct {p0}, releaseAnimationResource()V
...
.method static synthetic access$800(Lcom/oneplus/battery/OpChargingAnimationControllerImpl;)Z
    ...
    iget-boolean p0, p0, isKeyguardShowing:Z
...
.method static synthetic access$802(Lcom/oneplus/battery/OpChargingAnimationControllerImpl;Z)Z
    ...
    iput-boolean p1, p0, isKeyguardShowing:Z
...
.method static synthetic access$900(Lcom/oneplus/battery/OpChargingAnimationControllerImpl;)Z
    ...
    iget-boolean p0, p0, mBouncerShow:Z
...
.method static synthetic access$902(Lcom/oneplus/battery/OpChargingAnimationControllerImpl;Z)Z
    ...
    iput-boolean p1, p0, mBouncerShow:Z
...
.method private genOpWarpChargingView()Lcom/oneplus/battery/OpWarpChargingView;
    ...
    iget-object v0, p0, mOpWarpChargingView:Lcom/oneplus/battery/OpWarpChargingView;
    ...
    iget-object v2, p0, mOpWarpChargingView:Lcom/oneplus/battery/OpWarpChargingView;
    ...
    iget-object v1, p0, mOpWarpChargingView:Lcom/oneplus/battery/OpWarpChargingView;
    ...
    iput-object v0, p0, mOpWarpChargingView:Lcom/oneplus/battery/OpWarpChargingView;
...
.method private initOPWarpCharging()V
    ...
    iput-object v0, p0, mWrapChargingLayout:Landroid/widget/FrameLayout;

    iget-object v0, p0, mWrapChargingLayout:Landroid/widget/FrameLayout;
    ...
    invoke-virtual {p0, v0}, onWallpaperChange(Landroid/graphics/Bitmap;)V
...
.method private updateScrim()V
    ...
    :cond_0
    iget-object v1, p0, mWallpaper:Landroid/graphics/Bitmap;
    ...
    const-string/jumbo v3, "updateScrim, "
...
.method public bridge synthetic addCallback(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, addCallback(Lcom/oneplus/battery/OpChargingAnimationController$ChargingStateChangeCallback;)V
...
.method public animationEnd(I)V
    ...
    iput-boolean v0, p0, mAnimationStarted:Z
    ...
    sget-boolean p1, mPreventModeNoBackground:Z

    if-eqz p1, :cond_0

    iget-boolean p0, p0, mPreventViewShow:Z
    ...
    sput-boolean v0, mPreventModeNoBackground:Z
...
.method public animationStart(I)V
    ...
    iget-object p0, p0, mWallpaper:Landroid/graphics/Bitmap;
...
.method public init(Lcom/android/systemui/keyguard/KeyguardViewMediator;)V
    ...
    invoke-direct {p0}, genOpWarpChargingView()Lcom/oneplus/battery/OpWarpChargingView;

    invoke-direct {p0}, initOPWarpCharging()V

    iget-object p0, p0, mKeyguardStateCallback:Lcom/oneplus/battery/OpChargingAnimationControllerImpl$KeyguardStateCallback;
...
.method public isAnimationStarted()Z
    ...
    iget-boolean p0, p0, mAnimationStarted:Z
...
.method public onFastChargeChanged(I)V
    ...
    :cond_0
    iget-object v0, p0, mBatteryController:Lcom/android/systemui/statusbar/policy/BatteryController;

    invoke-interface {v0, p1}, Lcom/android/systemui/statusbar/policy/BatteryController;->isWarpCharging(I)Z

    move-result p1

    iget-boolean v0, p0, mWarpFastCharging:Z

    if-eq p1, v0, :cond_2

    iput-boolean p1, p0, mWarpFastCharging:Z

    iget-object p1, p0, mScreenLifecycle:Lcom/android/systemui/keyguard/ScreenLifecycle;
    ...
    iget-boolean v0, p0, isKeyguardShowing:Z

    if-eqz v0, :cond_2

    if-eqz p1, :cond_2

    iget-boolean p1, p0, mBouncerShow:Z

    if-nez p1, :cond_2

    iget-boolean p1, p0, mPreventViewShow:Z

    if-nez p1, :cond_2

    invoke-direct {p0}, updateScrim()V
...
.method public onWallpaperChange(Landroid/graphics/Bitmap;)V
    ...
    iget-object p1, p0, mOpWarpChargingView:Lcom/oneplus/battery/OpWarpChargingView;
...
.method public registerReceiver()V
    ...
    iget-object p0, p0, mScreenObserver:Lcom/android/systemui/keyguard/ScreenLifecycle$Observer;
...
.method public bridge synthetic removeCallback(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, removeCallback(Lcom/oneplus/battery/OpChargingAnimationController$ChargingStateChangeCallback;)V
