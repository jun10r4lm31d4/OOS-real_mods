...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p2, p0, mAppMap:Ljava/util/ArrayList;
    ...
    iput-object p2, p0, mFocusedViewData:Lcom/oneplus/systemui/biometrics/OpQLRecyclerView$AnimationViewData;
    ...
    iput v0, p0, mScrollSpeed:F

    iput-boolean p2, p0, mIsCancel:Z

    iput-boolean p2, p0, mInitialized:Z

    const/4 v0, 0x3

    iput v0, p0, mBarPosition:I

    iput p2, p0, mPadding:I

    iput-boolean p2, p0, mAnimate:Z

    iput p2, p0, mVibTime:I

    const-wide/16 v0, 0x0

    iput-wide v0, p0, mLastScrollTime:J
    ...
    iput-object v0, p0, mHelper:Lcom/oneplus/systemui/biometrics/OpQLHelper;

    iput-boolean p2, p0, mIsQLExit:Z
    ...
    iput-object v0, p0, mQLVibTimeObserver:Landroid/database/ContentObserver;
    ...
    iput-object v0, p0, mCheckNextScroll:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mScrollToPosition:Ljava/lang/Runnable;

    const v0, 0x3ea8f5c2    # 0.32999998f

    iput v0, p0, mZoomAmount:F

    const/high16 v0, 0x3e800000    # 0.25f

    iput v0, p0, mZoomDistance:F
    ...
    iput-object v0, p0, mCancelFalseRunnable:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mLayoutManager:Lcom/oneplus/systemui/biometrics/OpQLRecyclerView$QLLayoutManager;

    iget-object v0, p0, mLayoutManager:Lcom/oneplus/systemui/biometrics/OpQLRecyclerView$QLLayoutManager;
    ...
    iget-object p1, p0, mHelper:Lcom/oneplus/systemui/biometrics/OpQLHelper;

    invoke-virtual {p1}, Lcom/oneplus/systemui/biometrics/OpQLHelper;->getQLApps()Ljava/util/ArrayList;

    move-result-object p1

    iput-object p1, p0, mAppMap:Ljava/util/ArrayList;
...
.method static synthetic access$1100(Lcom/oneplus/systemui/biometrics/OpQLRecyclerView;)Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object p0, p0, mView:Landroidx/recyclerview/widget/RecyclerView;
...
.method static synthetic access$1300(Lcom/oneplus/systemui/biometrics/OpQLRecyclerView;FZ)V
    ...
    invoke-direct {p0, p1, p2}, cancelAnimation(FZ)V
...
.method static synthetic access$1402(Lcom/oneplus/systemui/biometrics/OpQLRecyclerView;Landroid/animation/ValueAnimator;)Landroid/animation/ValueAnimator;
    ...
    iput-object p1, p0, mEnterAnimator:Landroid/animation/ValueAnimator;
...
.method static synthetic access$1502(Lcom/oneplus/systemui/biometrics/OpQLRecyclerView;Z)Z
    ...
    iput-boolean p1, p0, mIsCancel:Z
...
.method static synthetic access$1602(Lcom/oneplus/systemui/biometrics/OpQLRecyclerView;Landroid/animation/ValueAnimator;)Landroid/animation/ValueAnimator;
    ...
    iput-object p1, p0, mLeaveAnimator:Landroid/animation/ValueAnimator;
...
.method static synthetic access$1700(Lcom/oneplus/systemui/biometrics/OpQLRecyclerView;)Lcom/oneplus/systemui/biometrics/OpQLHelper;
    ...
    iget-object p0, p0, mHelper:Lcom/oneplus/systemui/biometrics/OpQLHelper;
...
.method static synthetic access$200(Lcom/oneplus/systemui/biometrics/OpQLRecyclerView;)Z
    ...
    iget-boolean p0, p0, mIsQLExit:Z
...
.method static synthetic access$500(Lcom/oneplus/systemui/biometrics/OpQLRecyclerView;)V
    ...
    invoke-direct {p0}, scrollToPosition()V
...
.method static synthetic access$600(Lcom/oneplus/systemui/biometrics/OpQLRecyclerView;)Ljava/lang/Runnable;
    ...
    iget-object p0, p0, mCheckNextScroll:Ljava/lang/Runnable;
...
.method static synthetic access$700(Lcom/oneplus/systemui/biometrics/OpQLRecyclerView;)V
    ...
    invoke-direct {p0}, updateViewScale()V
...
.method static synthetic access$800(Lcom/oneplus/systemui/biometrics/OpQLRecyclerView;)V
    ...
    invoke-direct {p0}, updateLabel()V
...
.method private cancelAnimation(FZ)V
    ...
    iget-object v0, p0, mAdapter:Lcom/oneplus/systemui/biometrics/OpQLAdapter;
    ...
    iget-object v1, p0, mAdapter:Lcom/oneplus/systemui/biometrics/OpQLAdapter;
    ...
    iget-object v4, p0, mLayoutManager:Lcom/oneplus/systemui/biometrics/OpQLRecyclerView$QLLayoutManager;

    iget v5, p0, mPosition:I
    ...
    iget-object p2, p0, mFocusedViewData:Lcom/oneplus/systemui/biometrics/OpQLRecyclerView$AnimationViewData;
    ...
    iget-object p2, p0, mLayoutManager:Lcom/oneplus/systemui/biometrics/OpQLRecyclerView$QLLayoutManager;
...
.method private updateLabel()V
    ...
    iget-object v0, p0, mAppMap:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, mLabel:Landroid/widget/TextView;
...
.method private updateViewScale()V
    ...
    iget-object v5, p0, mLayoutManager:Lcom/oneplus/systemui/biometrics/OpQLRecyclerView$QLLayoutManager;

    invoke-virtual {v5, v4}, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->getDecoratedRight(Landroid/view/View;)I

    move-result v5

    iget-object v6, p0, mLayoutManager:Lcom/oneplus/systemui/biometrics/OpQLRecyclerView$QLLayoutManager;
    ...
    iget-boolean v8, p0, mIsCancel:Z
    ...
    :cond_0
    iget-boolean v7, p0, mIsCancel:Z
...
.method private vibrate()V
    ...
    sget-object v1, VIBRATION_ATTRIBUTES:Landroid/media/AudioAttributes;
    ...
    :cond_2
    sget-object p0, VIBRATION_ATTRIBUTES:Landroid/media/AudioAttributes;
...
.method public getItemCount()I
    ...
    iget-object p0, p0, mAppMap:Ljava/util/ArrayList;
...
.method public synthetic lambda$new$2$OpQLRecyclerView()V
    ...
    iput-boolean v0, p0, mIsCancel:Z
...
.method public launch()V
    ...
    iget-object v0, p0, mCheckNextScroll:Ljava/lang/Runnable;

    invoke-virtual {p0, v0}, Landroid/view/ViewGroup;->removeCallbacks(Ljava/lang/Runnable;)Z

    iget-boolean v0, p0, mIsCancel:Z
    ...
    iget-object v1, p0, mPerfLock:Lcom/oneplus/sdk/utils/OpBoostFramework;
...
.method public declared-synchronized onEnterCancelView()V
    ...
    :cond_0
    iget-object v0, p0, mCancelFalseRunnable:Ljava/lang/Runnable;
    ...
    iget-object v1, p0, mCheckNextScroll:Ljava/lang/Runnable;

    invoke-virtual {p0, v1}, Landroid/view/ViewGroup;->removeCallbacks(Ljava/lang/Runnable;)Z

    iget-boolean v1, p0, mAnimate:Z

    const/4 v2, 0x0

    if-eqz v1, :cond_3

    iget-object v1, p0, mFocusedViewData:Lcom/oneplus/systemui/biometrics/OpQLRecyclerView$AnimationViewData;

    iget-object v3, p0, mLayoutManager:Lcom/oneplus/systemui/biometrics/OpQLRecyclerView$QLLayoutManager;
    ...
    iget-object v3, p0, mFocusedViewData:Lcom/oneplus/systemui/biometrics/OpQLRecyclerView$AnimationViewData;
    ...
    iget-object v1, p0, mLeaveAnimator:Landroid/animation/ValueAnimator;
    ...
    :cond_1
    iget-object v1, p0, mEnterAnimator:Landroid/animation/ValueAnimator;
    ...
    iput-object v0, p0, mEnterAnimator:Landroid/animation/ValueAnimator;
...
.method protected onFinishInflate()V
    ...
    iput-object p0, p0, mView:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {p0}, Landroid/view/ViewGroup;->getPaddingRight()I

    move-result v0

    iput v0, p0, mPadding:I
    ...
    iput-object v0, p0, mQuickPayConfigObserver:Lcom/oneplus/config/ConfigObserver;

    iget-object p0, p0, mQuickPayConfigObserver:Lcom/oneplus/config/ConfigObserver;
...
.method public declared-synchronized onLeaveCancelView()V
    ...
    iget-boolean v0, p0, mAnimate:Z

    if-eqz v0, :cond_3

    iget-object v0, p0, mFocusedViewData:Lcom/oneplus/systemui/biometrics/OpQLRecyclerView$AnimationViewData;
    ...
    :cond_1
    iget-object v0, p0, mLeaveAnimator:Landroid/animation/ValueAnimator;
    ...
    iput-object v0, p0, mLeaveAnimator:Landroid/animation/ValueAnimator;
...
.method public onQLExit()V
    ...
    iput-boolean v0, p0, mIsQLExit:Z

    iget-object v0, p0, mScrollToPosition:Ljava/lang/Runnable;
    ...
    iget-object v0, p0, mQuickPayConfigObserver:Lcom/oneplus/config/ConfigObserver;
    ...
    iput-object v0, p0, mAdapter:Lcom/oneplus/systemui/biometrics/OpQLAdapter;

    :cond_0
    iput-object v0, p0, mView:Landroidx/recyclerview/widget/RecyclerView;

    iput-object v0, p0, mAppMap:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, mFocusedViewData:Lcom/oneplus/systemui/biometrics/OpQLRecyclerView$AnimationViewData;
...
.method public declared-synchronized onScrollProgress(F)V
    ...
    :cond_0
    :try_start_1
    invoke-direct {p0, p1}, checkBarPosition(F)I
    ...
    iput p1, p0, mBarPosition:I

    iget-boolean p1, p0, mIsCancel:Z
    :try_end_1
    ...
    iget-object p1, p0, mAppMap:Ljava/util/ArrayList;
    ...
    iget-wide v2, p0, mLastScrollTime:J
    ...
    iget-object p1, p0, mScrollToPosition:Ljava/lang/Runnable;
    ...
    :cond_7
    iget-object p1, p0, mCheckNextScroll:Ljava/lang/Runnable;
...
.method public onVelocityChanged(F)V
    ...
    iput p1, p0, mScrollSpeed:F

    iget p1, p0, mScrollSpeed:F
...
.method public setLabelView(Landroid/widget/TextView;)V
    ...
    iput-object p1, p0, mLabel:Landroid/widget/TextView;
...
.method public setQLConfig(Ljava/lang/String;)V
    ...
    iget-object v0, p0, mHelper:Lcom/oneplus/systemui/biometrics/OpQLHelper;
    ...
    iget-object v1, p0, mAppMap:Ljava/util/ArrayList;

    invoke-direct {p1, v0, v1}, Lcom/oneplus/systemui/biometrics/OpQLAdapter;-><init>(Landroid/content/Context;Ljava/util/ArrayList;)V

    iput-object p1, p0, mAdapter:Lcom/oneplus/systemui/biometrics/OpQLAdapter;

    iget-object p1, p0, mAdapter:Lcom/oneplus/systemui/biometrics/OpQLAdapter;
    ...
    iget-object p1, p0, mLayoutManager:Lcom/oneplus/systemui/biometrics/OpQLRecyclerView$QLLayoutManager;
