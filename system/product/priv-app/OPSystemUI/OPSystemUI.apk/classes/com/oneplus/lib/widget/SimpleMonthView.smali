...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object p2, p0, mMonthPaint:Landroid/text/TextPaint;

    new-instance p2, Landroid/text/TextPaint;

    invoke-direct {p2}, Landroid/text/TextPaint;-><init>()V

    iput-object p2, p0, mDayOfWeekPaint:Landroid/text/TextPaint;

    new-instance p2, Landroid/text/TextPaint;

    invoke-direct {p2}, Landroid/text/TextPaint;-><init>()V

    iput-object p2, p0, mDayPaint:Landroid/text/TextPaint;

    new-instance p2, Landroid/graphics/Paint;

    invoke-direct {p2}, Landroid/graphics/Paint;-><init>()V

    iput-object p2, p0, mDaySelectorPaint:Landroid/graphics/Paint;

    new-instance p2, Landroid/graphics/Paint;

    invoke-direct {p2}, Landroid/graphics/Paint;-><init>()V

    iput-object p2, p0, mDayHighlightPaint:Landroid/graphics/Paint;

    new-instance p2, Landroid/graphics/Paint;

    invoke-direct {p2}, Landroid/graphics/Paint;-><init>()V

    iput-object p2, p0, mDayHighlightSelectorPaint:Landroid/graphics/Paint;

    const/4 p2, 0x7

    new-array p2, p2, [Ljava/lang/String;

    iput-object p2, p0, mDayOfWeekLabels:[Ljava/lang/String;

    const/4 p2, -0x1

    iput p2, p0, mActivatedDay:I

    iput p2, p0, mToday:I

    const/4 p3, 0x1

    iput p3, p0, mWeekStart:I

    iput p3, p0, mEnabledDayStart:I

    const/16 p4, 0x1f

    iput p4, p0, mEnabledDayEnd:I

    iput p2, p0, mHighlightedDay:I

    iput p2, p0, mPreviouslyHighlightedDay:I

    const/4 p2, 0x0

    iput-boolean p2, p0, mIsTouchHighlighted:Z
    ...
    iput p2, p0, mDesiredMonthHeight:I
    ...
    iput p2, p0, mDesiredDayOfWeekHeight:I
    ...
    iput p2, p0, mDesiredDayHeight:I
    ...
    iput p2, p0, mDesiredCellWidth:I
    ...
    iput p2, p0, mDesiredDaySelectorRadius:I
    ...
    iput-object p2, p0, mTouchHelper:Lcom/oneplus/lib/widget/SimpleMonthView$MonthViewTouchHelper;

    iget-object p2, p0, mTouchHelper:Lcom/oneplus/lib/widget/SimpleMonthView$MonthViewTouchHelper;
    ...
    iget-object p2, p0, mLocale:Ljava/util/Locale;

    invoke-static {p2}, Ljava/util/Calendar;->getInstance(Ljava/util/Locale;)Ljava/util/Calendar;

    move-result-object p2

    iput-object p2, p0, mCalendar:Ljava/util/Calendar;
    ...
    iput-object p2, p0, mDayFormatter:Ljava/text/NumberFormat;

    invoke-direct {p0}, updateMonthYearLabel()V

    invoke-direct {p0}, updateDayOfWeekLabels()V

    invoke-direct {p0, p1}, initPaints(Landroid/content/res/Resources;)V
...
.method static synthetic access$800(Lcom/oneplus/lib/widget/SimpleMonthView;)Ljava/text/NumberFormat;
    ...
    iget-object p0, p0, mDayFormatter:Ljava/text/NumberFormat;
...
.method private drawDays(Landroid/graphics/Canvas;)V
    ...
    :cond_0
    invoke-direct {v0, v3}, isDayEnabled(I)Z
    ...
    iget-object v11, v0, mDayHighlightSelectorPaint:Landroid/graphics/Paint;

    goto :goto_4

    :cond_4
    iget-object v11, v0, mDaySelectorPaint:Landroid/graphics/Paint;
    ...
    iget-object v15, v0, mDayHighlightPaint:Landroid/graphics/Paint;
    ...
    iget-object v8, v0, mDaySelectorPaint:Landroid/graphics/Paint;
    ...
    iget-object v11, v0, mDayTextColor:Landroid/content/res/ColorStateList;
    ...
    iget-object v8, v0, mDayFormatter:Ljava/text/NumberFormat;
...
.method private drawDaysOfWeek(Landroid/graphics/Canvas;)V
    ...
    iget v6, p0, mPaddedWidth:I

    sub-int v5, v6, v5

    :cond_0
    iget-object v6, p0, mDayOfWeekLabels:[Ljava/lang/String;
...
.method private drawMonth(Landroid/graphics/Canvas;)V
    ...
    iget-object p0, p0, mMonthPaint:Landroid/text/TextPaint;
...
.method private initPaints(Landroid/content/res/Resources;)V
    ...
    iget-object v5, p0, mMonthPaint:Landroid/text/TextPaint;
    ...
    iget-object v0, p0, mDaySelectorPaint:Landroid/graphics/Paint;
    ...
    iget-object v0, p0, mDayHighlightPaint:Landroid/graphics/Paint;
    ...
    iget-object v0, p0, mDayHighlightSelectorPaint:Landroid/graphics/Paint;
    ...
    iget-object p1, p0, mDayPaint:Landroid/text/TextPaint;
    ...
    iget-object p0, p0, mDayPaint:Landroid/text/TextPaint;
...
.method private moveOneDay(Z)Z
    ...
    iget p1, p0, mHighlightedDay:I

    invoke-direct {p0, p1}, isLastDayOfWeek(I)Z
    ...
    invoke-direct {p0, p1}, isFirstDayOfWeek(I)Z
...
.method private onDayClicked(I)Z
    ...
    :cond_1
    iget-object p0, p0, mTouchHelper:Lcom/oneplus/lib/widget/SimpleMonthView$MonthViewTouchHelper;
...
.method private updateDayOfWeekLabels()V
    ...
    iget-object v4, p0, mDayOfWeekLabels:[Ljava/lang/String;

    iget v5, p0, mWeekStart:I
...
.method private updateMonthYearLabel()V
    ...
    iput-object v0, p0, mMonthYearLabel:Ljava/lang/String;
...
.method public getBoundsForDay(ILandroid/graphics/Rect;)Z
    ...
    iget v4, p0, mMonthHeight:I

    iget v5, p0, mDayOfWeekHeight:I
...
.method public getMonthYearLabel()Ljava/lang/String;
    ...
    iget-object p0, p0, mMonthYearLabel:Ljava/lang/String;
...
.method public onFocusChange(Landroid/view/View;Z)V
    ...
    iget-boolean p1, p0, mIsTouchHighlighted:Z

    if-nez p1, :cond_0

    iget p1, p0, mHighlightedDay:I

    iput p1, p0, mPreviouslyHighlightedDay:I
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    invoke-direct {p0, v0}, moveOneDay(Z)Z
    ...
    invoke-direct {p0, v0}, onDayClicked(I)Z
...
.method protected onLayout(ZIIII)V
    ...
    :cond_1
    iput p4, p0, mPaddedWidth:I

    iput p5, p0, mPaddedHeight:I
    ...
    iget p4, p0, mDesiredMonthHeight:I
    ...
    iget p5, p0, mPaddedWidth:I

    div-int/lit8 p5, p5, 0x7

    iput p4, p0, mMonthHeight:I

    iget p4, p0, mDesiredDayOfWeekHeight:I
    ...
    iput p4, p0, mDayOfWeekHeight:I

    iget p4, p0, mDesiredDayHeight:I
    ...
    iput p2, p0, mDayHeight:I

    iput p5, p0, mCellWidth:I

    div-int/lit8 p5, p5, 0x2

    invoke-static {p1, p3}, Ljava/lang/Math;->min(II)I

    iget p1, p0, mDayHeight:I

    div-int/lit8 p1, p1, 0x2

    iget p1, p0, mDesiredDaySelectorRadius:I

    iput p1, p0, mDaySelectorRadius:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iput-boolean v2, p0, mIsTouchHighlighted:Z
...
.method setDaySelectorColor(Landroid/content/res/ColorStateList;)V
    ...
    iget-object p1, p0, mDayHighlightSelectorPaint:Landroid/graphics/Paint;
...
.method public setFirstDayOfWeek(I)V
    ...
    :cond_0
    iget-object p1, p0, mCalendar:Ljava/util/Calendar;
    ...
    iget-object p1, p0, mTouchHelper:Lcom/oneplus/lib/widget/SimpleMonthView$MonthViewTouchHelper;
...
.method setMonthParams(IIIIII)V
    ...
    invoke-static {p2, p4}, getDaysInMonth(II)I

    move-result p2

    iput p2, p0, mDaysInMonth:I

    const/4 p2, 0x0

    :cond_2
    :goto_1
    iget p4, p0, mDaysInMonth:I

    if-ge p2, p4, :cond_3

    add-int/lit8 p2, p2, 0x1

    invoke-direct {p0, p2, p1}, sameDay(ILjava/util/Calendar;)Z
    ...
    iput p1, p0, mEnabledDayStart:I

    iget p1, p0, mEnabledDayStart:I

    iget p2, p0, mDaysInMonth:I

    invoke-static {p6, p1, p2}, Lcom/oneplus/lib/util/MathUtils;->constrain(III)I

    move-result p1

    iput p1, p0, mEnabledDayEnd:I
