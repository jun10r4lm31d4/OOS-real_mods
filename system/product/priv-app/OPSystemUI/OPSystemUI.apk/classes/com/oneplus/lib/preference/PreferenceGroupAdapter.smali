...
.method static constructor <clinit>()V
    ...
    sput-object v0, sWrapperLayoutParams:Landroid/view/ViewGroup$LayoutParams;
...
.method public constructor <init>(Lcom/oneplus/lib/preference/PreferenceGroup;)V
    ...
    iput-object v0, p0, mTempPreferenceLayout:Lcom/oneplus/lib/preference/PreferenceGroupAdapter$PreferenceLayout;

    const/4 v0, 0x0

    iput-boolean v0, p0, mHasReturnedViewTypeCount:Z

    iput-boolean v0, p0, mIsSyncing:Z
    ...
    iput-object v0, p0, mSyncRunnable:Ljava/lang/Runnable;

    const/4 v0, -0x1

    iput v0, p0, mHighlightedPosition:I

    iput-object p1, p0, mPreferenceGroup:Lcom/oneplus/lib/preference/PreferenceGroup;

    iget-object p1, p0, mPreferenceGroup:Lcom/oneplus/lib/preference/PreferenceGroup;
    ...
    iput-object p1, p0, mPreferenceList:Ljava/util/List;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, mPreferenceLayouts:Ljava/util/ArrayList;

    invoke-direct {p0}, syncMyPreferences()V
...
.method private addPreferenceClassName(Lcom/oneplus/lib/preference/Preference;)V
    ...
    invoke-direct {p0, p1, v0}, createPreferenceLayout(Lcom/oneplus/lib/preference/Preference;Lcom/oneplus/lib/preference/PreferenceGroupAdapter$PreferenceLayout;)Lcom/oneplus/lib/preference/PreferenceGroupAdapter$PreferenceLayout;

    move-result-object p1

    iget-object v0, p0, mPreferenceLayouts:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, mPreferenceLayouts:Ljava/util/ArrayList;
...
.method private flattenPreferenceGroup(Ljava/util/List;Lcom/oneplus/lib/preference/PreferenceGroup;)V
    ...
    iget-boolean v3, p0, mHasReturnedViewTypeCount:Z
    ...
    invoke-direct {p0, v2}, addPreferenceClassName(Lcom/oneplus/lib/preference/Preference;)V
    ...
    invoke-direct {p0, p1, v3}, flattenPreferenceGroup(Ljava/util/List;Lcom/oneplus/lib/preference/PreferenceGroup;)V
...
.method private syncMyPreferences()V
    ...
    :try_start_0
    iget-boolean v0, p0, mIsSyncing:Z
    ...
    iget-object v1, p0, mPreferenceList:Ljava/util/List;
    ...
    iget-object v1, p0, mPreferenceGroup:Lcom/oneplus/lib/preference/PreferenceGroup;

    invoke-direct {p0, v0, v1}, flattenPreferenceGroup(Ljava/util/List;Lcom/oneplus/lib/preference/PreferenceGroup;)V

    iput-object v0, p0, mPreferenceList:Ljava/util/List;
...
.method public getCount()I
    ...
    iget-object p0, p0, mPreferenceList:Ljava/util/List;
...
.method public bridge synthetic getItem(I)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, getItem(I)Lcom/oneplus/lib/preference/Preference;
...
.method public getItemViewType(I)I
    ...
    iget v0, p0, mHighlightedPosition:I

    if-ne p1, v0, :cond_0

    invoke-direct {p0}, getHighlightItemViewType()I
    ...
    :cond_0
    iget-boolean v0, p0, mHasReturnedViewTypeCount:Z
    ...
    :cond_2
    iget-object v0, p0, mTempPreferenceLayout:Lcom/oneplus/lib/preference/PreferenceGroupAdapter$PreferenceLayout;

    invoke-direct {p0, p1, v0}, createPreferenceLayout(Lcom/oneplus/lib/preference/Preference;Lcom/oneplus/lib/preference/PreferenceGroupAdapter$PreferenceLayout;)Lcom/oneplus/lib/preference/PreferenceGroupAdapter$PreferenceLayout;

    move-result-object p1

    iput-object p1, p0, mTempPreferenceLayout:Lcom/oneplus/lib/preference/PreferenceGroupAdapter$PreferenceLayout;

    iget-object p1, p0, mPreferenceLayouts:Ljava/util/ArrayList;

    iget-object p0, p0, mTempPreferenceLayout:Lcom/oneplus/lib/preference/PreferenceGroupAdapter$PreferenceLayout;
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget-object v1, p0, mTempPreferenceLayout:Lcom/oneplus/lib/preference/PreferenceGroupAdapter$PreferenceLayout;

    invoke-direct {p0, v0, v1}, createPreferenceLayout(Lcom/oneplus/lib/preference/Preference;Lcom/oneplus/lib/preference/PreferenceGroupAdapter$PreferenceLayout;)Lcom/oneplus/lib/preference/PreferenceGroupAdapter$PreferenceLayout;

    move-result-object v1

    iput-object v1, p0, mTempPreferenceLayout:Lcom/oneplus/lib/preference/PreferenceGroupAdapter$PreferenceLayout;

    iget-object v1, p0, mPreferenceLayouts:Ljava/util/ArrayList;

    iget-object v2, p0, mTempPreferenceLayout:Lcom/oneplus/lib/preference/PreferenceGroupAdapter$PreferenceLayout;
    ...
    iget-object p1, p0, mHighlightedDrawable:Landroid/graphics/drawable/Drawable;
    ...
    sget-object p3, sWrapperLayoutParams:Landroid/view/ViewGroup$LayoutParams;

    invoke-virtual {p1, p3}, Landroid/view/ViewGroup;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    iget-object p0, p0, mHighlightedDrawable:Landroid/graphics/drawable/Drawable;
...
.method public getViewTypeCount()I
    ...
    iput-boolean v1, p0, mHasReturnedViewTypeCount:Z
