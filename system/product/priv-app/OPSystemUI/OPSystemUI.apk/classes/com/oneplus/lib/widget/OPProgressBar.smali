...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-boolean p3, p0, mNoInvalidate:Z
    ...
    invoke-static {p4}, needsTileify(Landroid/graphics/drawable/Drawable;)Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-virtual {p0, p4}, setProgressDrawableTiled(Landroid/graphics/drawable/Drawable;)V

    goto :goto_0

    :cond_0
    invoke-virtual {p0, p4}, setProgressDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, p1, p4}, setInterpolator(Landroid/content/Context;I)V
    ...
    invoke-virtual {p0, p1}, setMax(I)V

    sget p1, Lcom/oneplus/commonctrl/R$styleable;->OPProgressBar_android_progress:I

    iget p4, p0, mProgress:I

    invoke-virtual {p2, p1, p4}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result p1

    invoke-virtual {p0, p1}, setProgress(I)V

    sget p1, Lcom/oneplus/commonctrl/R$styleable;->OPProgressBar_android_secondaryProgress:I

    iget p4, p0, mSecondaryProgress:I

    invoke-virtual {p2, p1, p4}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result p1

    invoke-virtual {p0, p1}, setSecondaryProgress(I)V
    ...
    invoke-static {p1}, needsTileify(Landroid/graphics/drawable/Drawable;)Z

    move-result p4

    if-eqz p4, :cond_3

    invoke-virtual {p0, p1}, setIndeterminateDrawableTiled(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-boolean p4, p0, mMirrorForRtl:Z

    invoke-virtual {p2, p1, p4}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result p1

    iput-boolean p1, p0, mMirrorForRtl:Z
    ...
    iget-object p1, p0, mProgressTintInfo:Lcom/oneplus/lib/widget/OPProgressBar$ProgressTintInfo;
    ...
    iput-object p1, p0, mProgressTintInfo:Lcom/oneplus/lib/widget/OPProgressBar$ProgressTintInfo;
...
.method static synthetic access$100(Lcom/oneplus/lib/widget/OPProgressBar;)Ljava/util/ArrayList;
    ...
    iget-object p0, p0, mRefreshData:Ljava/util/ArrayList;
...
.method private declared-synchronized doRefreshProgress(IIZZZ)V
    ...
    iget-object p5, p0, VISUAL_PROGRESS:Landroid/util/FloatProperty;
    ...
    sget-object v2, PROGRESS_ANIM_INTERPOLATOR:Landroid/view/animation/DecelerateInterpolator;
...
.method private static needsTileify(Landroid/graphics/drawable/Drawable;)Z
    ...
    invoke-static {v4}, needsTileify(Landroid/graphics/drawable/Drawable;)Z
...
.method private declared-synchronized refreshProgress(IIZZ)V
    ...
    iget-object p2, p0, mRefreshData:Ljava/util/ArrayList;

    invoke-virtual {p2, p1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-boolean p1, p0, mAttached:Z

    if-eqz p1, :cond_2

    iget-boolean p1, p0, mRefreshIsPosted:Z

    if-nez p1, :cond_2

    iget-object p1, p0, mRefreshProgressRunnable:Lcom/oneplus/lib/widget/OPProgressBar$RefreshProgressRunnable;
...
.method private swapCurrentDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object p1, p0, mCurrentDrawable:Landroid/graphics/drawable/Drawable;
...
.method private tileify(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :goto_2
    invoke-direct {p0, v5, v4}, tileify(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, mSampleTile:Landroid/graphics/Bitmap;

    if-nez v2, :cond_5

    iput-object v0, p0, mSampleTile:Landroid/graphics/Bitmap;
...
.method private tileifyIndeterminate(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v4, v5}, tileify(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
...
.method private updateDrawableBounds(II)V
    ...
    iget-boolean v2, p0, mOnlyIndeterminate:Z
    ...
    iget-object v2, p0, mIndeterminateDrawable:Landroid/graphics/drawable/Drawable;
    ...
    :cond_3
    iget-object p0, p0, mProgressDrawable:Landroid/graphics/drawable/Drawable;
...
.method drawTrack(Landroid/graphics/Canvas;)V
    ...
    iget-boolean p1, p0, mShouldStartAnimationDrawable:Z
...
.method public drawableHotspotChanged(FF)V
    ...
    :cond_0
    iget-object p0, p0, mIndeterminateDrawable:Landroid/graphics/drawable/Drawable;
...
.method getCurrentDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object p0, p0, mCurrentDrawable:Landroid/graphics/drawable/Drawable;
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iget p0, p0, mSecondaryProgress:I
...
.method public declared-synchronized setIndeterminate(Z)V
    ...
    iget-object p1, p0, mIndeterminateDrawable:Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    iget-object p1, p0, mProgressDrawable:Landroid/graphics/drawable/Drawable;
...
.method public setInterpolator(Landroid/content/Context;I)V
    ...
    invoke-virtual {p0, p1}, setInterpolator(Landroid/view/animation/Interpolator;)V
...
.method public declared-synchronized setMax(I)V
    ...
    invoke-direct {p0, p1, v1, v0, v0}, refreshProgress(IIZZ)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public setProgressDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-direct {p0, p1, v0}, updateDrawableBounds(II)V
    ...
    iget v9, p0, mSecondaryProgress:I
    ...
    invoke-direct/range {v7 .. v12}, doRefreshProgress(IIZZZ)V
...
.method declared-synchronized setProgressInternal(IZZ)Z
    ...
    invoke-direct {p0, p1, v0, p2, p3}, refreshProgress(IIZZ)V
    :try_end_2
