...
.method static constructor <clinit>()V
    ...
    sput-object v0, ANIMATION_INTERPILATOR:Landroid/view/animation/Interpolator;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v1, v0, v0}, <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object p3, p0, mBackgroundHandler:Landroid/os/Handler;
    ...
    iput-object p3, p0, mStartAnimationAssets1:Ljava/util/ArrayList;

    iput-boolean p2, p0, mAssetLoading:Z

    iput-boolean p2, p0, mAssetLoaded:Z

    iput-boolean p2, p0, mAssetReleasing:Z

    iput-boolean p2, p0, mIsPaddingStartAnimation:Z

    const/4 p2, 0x0

    iput-object p2, p0, mWallpaper:Landroid/graphics/Bitmap;
    ...
    sput-object p0, mRes:Landroid/content/res/Resources;
...
.method static synthetic access$100(Lcom/oneplus/battery/OpWarpChargingView;)Landroid/view/View;
    ...
    iget-object p0, p0, mInfoView:Landroid/view/View;
...
.method static synthetic access$200(Lcom/oneplus/battery/OpWarpChargingView;)Lcom/oneplus/battery/OpChargingAnimationController;
    ...
    iget-object p0, p0, mChargingAnimationController:Lcom/oneplus/battery/OpChargingAnimationController;
...
.method static synthetic access$302(Lcom/oneplus/battery/OpWarpChargingView;Z)Z
    ...
    iput-boolean p1, p0, isAnimationStart:Z
...
.method static synthetic access$400(Lcom/oneplus/battery/OpWarpChargingView;)V
    ...
    invoke-direct {p0}, preloadAnimationList()V
...
.method static synthetic access$500(Lcom/oneplus/battery/OpWarpChargingView;)V
    ...
    invoke-direct {p0}, relaseAnimationList()V
...
.method static synthetic access$602(Lcom/oneplus/battery/OpWarpChargingView;Z)Z
    ...
    iput-boolean p1, p0, mAssetLoading:Z
...
.method static synthetic access$702(Lcom/oneplus/battery/OpWarpChargingView;Z)Z
    ...
    iput-boolean p1, p0, mAssetLoaded:Z
...
.method static synthetic access$800(Lcom/oneplus/battery/OpWarpChargingView;)Z
    ...
    iget-boolean p0, p0, mIsPaddingStartAnimation:Z
...
.method static synthetic access$902(Lcom/oneplus/battery/OpWarpChargingView;Z)Z
    ...
    iput-boolean p1, p0, mAssetReleasing:Z
...
.method private getWarpFastChargeAnimation()Landroid/animation/AnimatorSet;
    ...
    iget-object v2, p0, mStartAnimationAssets1:Ljava/util/ArrayList;
    ...
    sget-object v2, ANIMATION_INTERPILATOR:Landroid/view/animation/Interpolator;
    ...
    sget-object v3, ANIMATION_INTERPILATOR:Landroid/view/animation/Interpolator;
    ...
    sget-object v4, ANIMATION_INTERPILATOR:Landroid/view/animation/Interpolator;
...
.method private preloadAnimationList()V
    ...
    sget-object v0, mRes:Landroid/content/res/Resources;
    ...
    :goto_0
    iget-object v6, p0, mStartAnimationAssets1:Ljava/util/ArrayList;
    ...
    :cond_2
    iget-object v5, p0, mStartAnimationAssets1:Ljava/util/ArrayList;
    ...
    iget-object v8, p0, mStartAnimationAssets1:Ljava/util/ArrayList;
...
.method private relaseAnimationList()V
    ...
    :cond_0
    iget-object v0, p0, mBackgroundView:Landroid/widget/ImageView;
    ...
    :goto_0
    iget-object v1, p0, mStartAnimationAssets1:Ljava/util/ArrayList;
    ...
    :cond_2
    iget-object v0, p0, mStartAnimationAssets1:Ljava/util/ArrayList;
...
.method protected onAttachedToWindow()V
    ...
    iput-object v0, p0, mBatteryLevel:Landroid/widget/TextView;
    ...
    iput-object v0, p0, mWrapview:Landroid/widget/ImageView;
    ...
    iput-object v0, p0, mBackgroundView:Landroid/widget/ImageView;
    ...
    iput-object v0, p0, mWallpaperView:Landroid/widget/ImageView;

    iget-object v0, p0, mWallpaperView:Landroid/widget/ImageView;
    ...
    iput-object v0, p0, mInfoView:Landroid/view/View;
...
.method public onBatteryLevelChanged(IZZ)V
    ...
    iget-object p0, p0, mBatteryLevel:Landroid/widget/TextView;
...
.method public prepareAsset()V
    ...
    iget-boolean v1, p0, mAssetLoading:Z
    ...
    iget-boolean v1, p0, mAssetLoaded:Z
    ...
    :cond_0
    iget-boolean v0, p0, mAssetLoading:Z

    if-nez v0, :cond_2

    iget-boolean v0, p0, mAssetLoaded:Z

    if-nez v0, :cond_2

    const/4 v0, 0x1

    iput-boolean v0, p0, mAssetLoading:Z

    iget-object v0, p0, mInfoView:Landroid/view/View;
...
.method public releaseAsset()V
    ...
    iget-boolean v1, p0, isAnimationStart:Z
    ...
    iget-boolean v1, p0, mAssetReleasing:Z
    ...
    iget-boolean v0, p0, isAnimationStart:Z

    if-nez v0, :cond_2

    iget-boolean v0, p0, mAssetReleasing:Z

    if-nez v0, :cond_2

    const/4 v0, 0x1

    iput-boolean v0, p0, mAssetReleasing:Z
...
.method public setBackgroundWallpaper(Landroid/graphics/Bitmap;)V
    ...
    iput-object p1, p0, mWallpaper:Landroid/graphics/Bitmap;

    iget-object p0, p0, mWallpaperView:Landroid/widget/ImageView;
...
.method public setChargingAnimationController(Lcom/oneplus/battery/OpChargingAnimationController;)V
    ...
    iput-object p1, p0, mChargingAnimationController:Lcom/oneplus/battery/OpChargingAnimationController;
...
.method public startAnimation()V
    ...
    iput-boolean v0, p0, mIsPaddingStartAnimation:Z
    ...
    iput-boolean v2, p0, isAnimationStart:Z

    iget-object v0, p0, mChargeAnimation:Landroid/animation/AnimatorSet;
    ...
    :cond_0
    invoke-direct {p0}, getWarpFastChargeAnimation()Landroid/animation/AnimatorSet;

    move-result-object v0

    iput-object v0, p0, mChargeAnimation:Landroid/animation/AnimatorSet;

    :goto_0
    iget-object p0, p0, mChargeAnimation:Landroid/animation/AnimatorSet;
    ...
    :cond_2
    iput-boolean v2, p0, mIsPaddingStartAnimation:Z

    invoke-virtual {p0}, prepareAsset()V
...
.method public updaetScrimColor(I)V
    ...
    iget-object p0, p0, mScrim:Landroid/view/View;
...
.method public updateColors(I)V
    ...
    iget-object v0, p0, mBatteryLevel:Landroid/widget/TextView;
    ...
    :cond_0
    iget-object p0, p0, mWrapview:Landroid/widget/ImageView;
