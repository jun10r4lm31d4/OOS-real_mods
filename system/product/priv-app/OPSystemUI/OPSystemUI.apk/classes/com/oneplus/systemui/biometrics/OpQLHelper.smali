...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mWxMiniProgramAppsName:Ljava/util/ArrayList;
    ...
    invoke-direct {p0}, loadPaymentApps()V
...
.method private getApplicationIcon(Ljava/lang/String;I)Landroid/graphics/drawable/Drawable;
    ...
    :try_start_3
    invoke-direct {p0, p1, p2}, getDrawable(Landroid/content/res/Resources;I)Landroid/graphics/drawable/Drawable;
...
.method private getPaymentApplicationIcon(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v0, p1}, getDrawable(Landroid/content/res/Resources;I)Landroid/graphics/drawable/Drawable;
...
.method private loadPaymentApps()V
    ...
    iget-object v5, p0, mPaymentAppsName:Ljava/util/ArrayList;
    ...
    :cond_3
    invoke-direct {p0, v2}, getPaymentApplicationIcon(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v3, v5}, getApplicationIcon(Ljava/lang/String;I)Landroid/graphics/drawable/Drawable;
...
.method private loadShortCuts(Ljava/lang/String;)Ljava/util/List;
    ...
    iget-object p0, p0, mLauncherApps:Landroid/content/pm/LauncherApps;
...
.method private parseSettingData(Ljava/lang/String;)Lcom/oneplus/systemui/biometrics/OpQLAdapter$ActionInfo;
    ...
    invoke-direct {p0, p1, v0}, getApplicationIcon(Ljava/lang/String;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1}, getAppLabel(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, p1}, loadShortCuts(Ljava/lang/String;)Ljava/util/List;
    ...
    iget-object v2, p0, mLauncherApps:Landroid/content/pm/LauncherApps;
    ...
    invoke-direct {p0, v2, v3}, getApplicationIcon(Ljava/lang/String;I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object p1, p0, mPaymentApps:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, mPaymentAppsName:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v2}, getAppLabel(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, v0}, isPackageAvailable(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1}, getWxMiniProgramApplicationIcon(I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    iput-object v0, v1, Lcom/oneplus/systemui/biometrics/OpQLAdapter$ActionInfo;->mAppIcon:Landroid/graphics/drawable/Drawable;

    iget-object p0, p0, mWxMiniProgramAppsName:Ljava/util/ArrayList;
...
.method public parseQLConfig(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v2}, parseSettingData(Ljava/lang/String;)Lcom/oneplus/systemui/biometrics/OpQLAdapter$ActionInfo;

    move-result-object v2

    if-eqz v2, :cond_2

    iget-object v3, p0, mAppMap:Ljava/util/ArrayList;
...
.method public resolveQuickPayConfigFromJSON(Lorg/json/JSONArray;)V
    ...
    invoke-virtual {p0, v3, v5}, updateQuickPayIfNeed(ILorg/json/JSONObject;)V
    ...
    invoke-virtual {p0, v6, v5}, updateQuickPayIfNeed(ILorg/json/JSONObject;)V
...
.method public startQuickPay(II)V
    ...
    invoke-virtual {p0, v1, v3, p2, v2}, startShortcut(Ljava/lang/String;Ljava/lang/String;IZ)Z
    ...
    :cond_3
    iget-object p2, p0, mPaymentApps:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, p2}, isPackageAvailable(Ljava/lang/String;)Z
...
.method public startShortcut(Ljava/lang/String;Ljava/lang/String;IZ)Z
    ...
    iget-object p4, p0, mLauncherApps:Landroid/content/pm/LauncherApps;
    ...
    iput-object p4, p0, mLauncherApps:Landroid/content/pm/LauncherApps;
...
.method updateQuickPayIfNeed(ILorg/json/JSONObject;)V
    ...
    invoke-virtual {p0, v4, v5}, isNewConfig(Ljava/lang/String;Ljava/lang/String;)Z
