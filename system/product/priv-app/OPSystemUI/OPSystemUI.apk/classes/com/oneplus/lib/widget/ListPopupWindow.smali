...
.method static constructor <clinit>()V
    ...
    sput-object v3, sClipToWindowEnabledMethod:Ljava/lang/reflect/Method;
    :try_end_0
    ...
    sput-object v3, sGetMaxAvailableHeightMethod:Ljava/lang/reflect/Method;
    :try_end_1
    ...
    sput-object v1, sSetEpicenterBoundsMethod:Ljava/lang/reflect/Method;
    :try_end_2
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput v0, p0, mDropDownHeight:I

    iput v0, p0, mDropDownWidth:I

    const/16 v0, 0x3ea

    iput v0, p0, mDropDownWindowLayoutType:I

    const/4 v0, 0x1

    iput-boolean v0, p0, mIsAnimatedFromAnchor:Z

    const/4 v1, 0x0

    iput v1, p0, mDropDownGravity:I

    iput-boolean v1, p0, mDropDownAlwaysVisible:Z

    iput-boolean v1, p0, mForceIgnoreOutsideTouch:Z

    const v2, 0x7fffffff

    iput v2, p0, mListItemExpandMaximum:I

    iput v1, p0, mPromptPosition:I
    ...
    iput-object v2, p0, mResizePopupRunnable:Lcom/oneplus/lib/widget/ListPopupWindow$ResizePopupRunnable;
    ...
    iput-object v2, p0, mTouchInterceptor:Lcom/oneplus/lib/widget/ListPopupWindow$PopupTouchInterceptor;
    ...
    iput-object v2, p0, mScrollListener:Lcom/oneplus/lib/widget/ListPopupWindow$PopupScrollListener;
    ...
    iput-object v2, p0, mHideSelector:Lcom/oneplus/lib/widget/ListPopupWindow$ListSelectorHider;
    ...
    iput v3, p0, mDropDownHorizontalOffset:I
    ...
    iput v1, p0, mDropDownVerticalOffset:I

    iget v1, p0, mDropDownVerticalOffset:I
    ...
    iget-object p0, p0, mPopup:Landroid/widget/PopupWindow;
...
.method private buildDropDown()I
    ...
    iget-object v0, p0, mDropDownList:Lcom/oneplus/lib/widget/DropDownListView;
    ...
    iput-object v5, p0, mShowDropDownRunnable:Ljava/lang/Runnable;

    iget-boolean v5, p0, mModal:Z

    xor-int/2addr v5, v3

    invoke-virtual {p0, v0, v5}, createDropDownListView(Landroid/content/Context;Z)Lcom/oneplus/lib/widget/DropDownListView;

    move-result-object v5

    iput-object v5, p0, mDropDownList:Lcom/oneplus/lib/widget/DropDownListView;

    iget-object v5, p0, mDropDownListHighlight:Landroid/graphics/drawable/Drawable;

    if-eqz v5, :cond_0

    iget-object v6, p0, mDropDownList:Lcom/oneplus/lib/widget/DropDownListView;

    invoke-virtual {v6, v5}, Lcom/oneplus/lib/widget/OPListViewCompat;->setSelector(Landroid/graphics/drawable/Drawable;)V

    :cond_0
    iget-object v5, p0, mDropDownList:Lcom/oneplus/lib/widget/DropDownListView;
    ...
    iget-object v6, p0, mItemClickListener:Landroid/widget/AdapterView$OnItemClickListener;
    ...
    iget-object v6, p0, mScrollListener:Lcom/oneplus/lib/widget/ListPopupWindow$PopupScrollListener;

    invoke-virtual {v5, v6}, Landroid/widget/ListView;->setOnScrollListener(Landroid/widget/AbsListView$OnScrollListener;)V

    iget-object v5, p0, mItemSelectedListener:Landroid/widget/AdapterView$OnItemSelectedListener;
    ...
    iget-object v6, p0, mPromptView:Landroid/view/View;
    ...
    iget-object v0, p0, mPromptView:Landroid/view/View;
    ...
    iget-boolean v7, p0, mDropDownVerticalOffsetSet:Z

    if-nez v7, :cond_9

    neg-int v6, v6

    iput v6, p0, mDropDownVerticalOffset:I
    ...
    iget v6, p0, mDropDownVerticalOffset:I

    invoke-direct {p0, v4, v6, v3}, getMaxAvailableHeight(Landroid/view/View;IZ)I

    move-result v3

    iget-boolean v4, p0, mDropDownAlwaysVisible:Z

    if-nez v4, :cond_f

    iget v4, p0, mDropDownHeight:I
    ...
    iget-object v2, p0, mDropDownList:Lcom/oneplus/lib/widget/DropDownListView;

    invoke-virtual {v2}, Landroid/widget/ListView;->getPaddingTop()I

    move-result v2

    iget-object p0, p0, mDropDownList:Lcom/oneplus/lib/widget/DropDownListView;
...
.method private getMaxAvailableHeight(Landroid/view/View;IZ)I
    ...
    sget-object v0, sGetMaxAvailableHeightMethod:Ljava/lang/reflect/Method;
    ...
    :cond_0
    :goto_0
    iget-object p3, p0, mPopup:Landroid/widget/PopupWindow;

    invoke-virtual {p3, p1, p2}, Landroid/widget/PopupWindow;->getMaxAvailableHeight(Landroid/view/View;I)I

    move-result p1

    iget p0, p0, mMaxHeight:I
...
.method private removePromptView()V
    ...
    iget-object p0, p0, mPromptView:Landroid/view/View;
...
.method private setPopupClipToScreenEnabled(Z)V
    ...
    sget-object v0, sClipToWindowEnabledMethod:Ljava/lang/reflect/Method;
...
.method public dismiss()V
    ...
    iput-object v1, p0, mDropDownList:Lcom/oneplus/lib/widget/DropDownListView;

    iget-object v0, p0, mHandler:Landroid/os/Handler;

    iget-object p0, p0, mResizePopupRunnable:Lcom/oneplus/lib/widget/ListPopupWindow$ResizePopupRunnable;
...
.method public getAnchorView()Landroid/view/View;
    ...
    iget-object p0, p0, mDropDownAnchorView:Landroid/view/View;
...
.method public getHorizontalOffset()I
    ...
    iget p0, p0, mDropDownHorizontalOffset:I
...
.method public getVerticalOffset()I
    ...
    :cond_0
    iget p0, p0, mDropDownVerticalOffset:I
...
.method public isDropDownAlwaysVisible()Z
    ...
    iget-boolean p0, p0, mDropDownAlwaysVisible:Z
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    invoke-static {p1}, isConfirmKey(I)Z
    ...
    iget-object p1, p0, mPopup:Landroid/widget/PopupWindow;
    ...
    :cond_6
    iget-object v8, p0, mDropDownList:Lcom/oneplus/lib/widget/DropDownListView;
    ...
    iget-object p2, p0, mPopup:Landroid/widget/PopupWindow;

    const/4 v0, 0x2

    invoke-virtual {p2, v0}, Landroid/widget/PopupWindow;->setInputMethodMode(I)V

    iget-object p2, p0, mDropDownList:Lcom/oneplus/lib/widget/DropDownListView;
...
.method public performItemClick(I)Z
    ...
    iget-object v1, p0, mItemClickListener:Landroid/widget/AdapterView$OnItemClickListener;
...
.method public setAdapter(Landroid/widget/ListAdapter;)V
    ...
    :cond_2
    iget-object p1, p0, mDropDownList:Lcom/oneplus/lib/widget/DropDownListView;
...
.method public setEpicenterBounds(Landroid/graphics/Rect;)V
    ...
    iput-object p1, p0, mEpicenterBounds:Landroid/graphics/Rect;
...
.method public setOverlapAnchor(Z)V
    ...
    iput-boolean v0, p0, mOverlapAnchorSet:Z
...
.method public setVerticalOffset(I)V
    ...
    iput-boolean p1, p0, mDropDownVerticalOffsetSet:Z
...
.method public show()V
    ...
    iget-boolean v4, p0, mForceIgnoreOutsideTouch:Z
    ...
    iget-object v7, p0, mPopup:Landroid/widget/PopupWindow;

    invoke-virtual {p0}, getAnchorView()Landroid/view/View;

    move-result-object v8

    iget v9, p0, mDropDownHorizontalOffset:I

    iget v10, p0, mDropDownVerticalOffset:I
    ...
    invoke-direct {p0, v3}, setPopupClipToScreenEnabled(Z)V

    iget-object v0, p0, mPopup:Landroid/widget/PopupWindow;

    iget-boolean v1, p0, mForceIgnoreOutsideTouch:Z

    if-nez v1, :cond_11

    iget-boolean v1, p0, mDropDownAlwaysVisible:Z
    ...
    invoke-virtual {p0}, needInterceptorTouchEvent()Z
    ...
    iget-object v1, p0, mTouchInterceptor:Lcom/oneplus/lib/widget/ListPopupWindow$PopupTouchInterceptor;

    invoke-virtual {v0, v1}, Landroid/widget/PopupWindow;->setTouchInterceptor(Landroid/view/View$OnTouchListener;)V

    :cond_12
    iget-boolean v0, p0, mOverlapAnchorSet:Z

    if-eqz v0, :cond_13

    iget-object v0, p0, mPopup:Landroid/widget/PopupWindow;

    iget-boolean v1, p0, mOverlapAnchor:Z

    invoke-static {v0, v1}, Lcom/oneplus/support/core/widget/PopupWindowCompat;->setOverlapAnchor(Landroid/widget/PopupWindow;Z)V

    :cond_13
    sget-object v0, sSetEpicenterBoundsMethod:Ljava/lang/reflect/Method;
    ...
    iget-object v3, p0, mEpicenterBounds:Landroid/graphics/Rect;
    ...
    iget-object p0, p0, mHideSelector:Lcom/oneplus/lib/widget/ListPopupWindow$ListSelectorHider;
