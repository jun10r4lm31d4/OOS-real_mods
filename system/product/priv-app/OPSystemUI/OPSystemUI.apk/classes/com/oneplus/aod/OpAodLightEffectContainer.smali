...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput p1, p0, mDecodeIndex:I

    iput p1, p0, mAnimateIndex:I

    iput p1, p0, mLightIndex:I
    ...
    iput-object p1, p0, mFrameRunnable:Ljava/lang/Runnable;
...
.method static synthetic access$008(Lcom/oneplus/aod/OpAodLightEffectContainer;)I
    ...
    iget v0, p0, mAnimateIndex:I

    add-int/lit8 v1, v0, 0x1

    iput v1, p0, mAnimateIndex:I
...
.method static synthetic access$100(Lcom/oneplus/aod/OpAodLightEffectContainer;)[Landroid/graphics/Bitmap;
    ...
    iget-object p0, p0, mBitmapLeft:[Landroid/graphics/Bitmap;
...
.method static synthetic access$200(Lcom/oneplus/aod/OpAodLightEffectContainer;)Landroid/widget/ImageView;
    ...
    iget-object p0, p0, mLeftView:Landroid/widget/ImageView;
...
.method static synthetic access$300(Lcom/oneplus/aod/OpAodLightEffectContainer;)[Landroid/graphics/Bitmap;
    ...
    iget-object p0, p0, mBitmapRight:[Landroid/graphics/Bitmap;
...
.method static synthetic access$400(Lcom/oneplus/aod/OpAodLightEffectContainer;)Landroid/widget/ImageView;
    ...
    iget-object p0, p0, mRightView:Landroid/widget/ImageView;
...
.method static synthetic access$500(Lcom/oneplus/aod/OpAodLightEffectContainer;)Ljava/lang/Runnable;
    ...
    iget-object p0, p0, mFrameRunnable:Ljava/lang/Runnable;
...
.method static synthetic access$900(Lcom/oneplus/aod/OpAodLightEffectContainer;)V
    ...
    invoke-direct {p0}, decodeBitmap()V
...
.method private animateNotification()V
    ...
    iput-object v0, p0, mLightAnimator:Landroid/animation/ValueAnimator;

    iget-object v0, p0, mLightAnimator:Landroid/animation/ValueAnimator;
    ...
    iget-object p0, p0, mLightAnimator:Landroid/animation/ValueAnimator;
...
.method private decodeBitmap()V
    ...
    iget-object v0, p0, mBitmapLeft:[Landroid/graphics/Bitmap;

    if-eqz v0, :cond_1

    iget-object v0, p0, mBitmapRight:[Landroid/graphics/Bitmap;
    ...
    iget-object v2, p0, mBitmapRight:[Landroid/graphics/Bitmap;

    aput-object v1, v2, v0

    iget-object v2, p0, mBitmapLeft:[Landroid/graphics/Bitmap;

    invoke-direct {p0, v1}, flip(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    iget-object v1, p0, mBitmapLeft:[Landroid/graphics/Bitmap;
...
.method private initViews()V
    ...
    iput-object v0, p0, mLeftView:Landroid/widget/ImageView;
    ...
    iput-object v0, p0, mRightView:Landroid/widget/ImageView;

    invoke-direct {p0}, relayoutViews()V
...
.method private loadResources()V
    ...
    iput-object v0, p0, mAnimationBgRight:Landroid/graphics/Bitmap;
    ...
    iput-object v0, p0, mAnimationBgLeft:Landroid/graphics/Bitmap;

    iget-object v0, p0, mLeftView:Landroid/widget/ImageView;

    iget-object v1, p0, mAnimationBgLeft:Landroid/graphics/Bitmap;

    invoke-virtual {v0, v1}, Landroid/widget/ImageView;->setImageBitmap(Landroid/graphics/Bitmap;)V

    iget-object v0, p0, mRightView:Landroid/widget/ImageView;

    iget-object p0, p0, mAnimationBgRight:Landroid/graphics/Bitmap;
...
.method private prepareResources()V
    ...
    iput-object v0, p0, mBitmapLeft:[Landroid/graphics/Bitmap;
    ...
    iput-object v0, p0, mBitmapRight:[Landroid/graphics/Bitmap;
    ...
    :cond_2
    invoke-direct {p0}, startHandlerThread()V
...
.method private relayoutViews()V
    ...
    iget-object v2, p0, mLeftView:Landroid/widget/ImageView;
    ...
    iget-object v2, p0, mRightView:Landroid/widget/ImageView;
...
.method public resetNotificationAnimView()V
    ...
    iget-object v0, p0, mAnimationBgRight:Landroid/graphics/Bitmap;

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Landroid/graphics/Bitmap;->recycle()V

    iput-object v1, p0, mAnimationBgRight:Landroid/graphics/Bitmap;

    :cond_1
    iget-object v0, p0, mAnimationBgLeft:Landroid/graphics/Bitmap;

    if-eqz v0, :cond_2

    invoke-virtual {v0}, Landroid/graphics/Bitmap;->recycle()V

    iput-object v1, p0, mAnimationBgLeft:Landroid/graphics/Bitmap;
    ...
    iget-object v2, p0, mFrameRunnable:Ljava/lang/Runnable;
...
.method public showLight()V
    ...
    invoke-direct {p0}, prepareResources()V
    ...
    iget-object v1, p0, mFrameRunnable:Ljava/lang/Runnable;
    ...
    :cond_2
    invoke-direct {p0}, loadResources()V

    invoke-direct {p0}, animateNotification()V
