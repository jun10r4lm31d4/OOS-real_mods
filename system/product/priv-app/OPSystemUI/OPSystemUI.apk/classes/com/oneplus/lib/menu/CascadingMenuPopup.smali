...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;IIZ)V
    ...
    iput p1, p0, mMenuMaxWidth:I

    new-instance p1, Landroid/os/Handler;

    invoke-direct {p1}, Landroid/os/Handler;-><init>()V

    iput-object p1, p0, mSubMenuHoverHandler:Landroid/os/Handler;
...
.method static synthetic access$000(Lcom/oneplus/lib/menu/CascadingMenuPopup;)Landroid/view/ViewTreeObserver;
    ...
    iget-object p0, p0, mTreeObserver:Landroid/view/ViewTreeObserver;
...
.method static synthetic access$100(Lcom/oneplus/lib/menu/CascadingMenuPopup;)Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
    ...
    iget-object p0, p0, mGlobalLayoutListener:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
...
.method private showMenu(Lcom/oneplus/lib/menu/MenuBuilder;)V
    ...
    iget-boolean v2, p0, mOverflowOnly:Z
    ...
    invoke-direct {p0}, createPopupWindow()Lcom/oneplus/lib/menu/MenuPopupWindow;
    ...
    invoke-direct {p0, v1, p1}, findParentViewForSubmenu(Lcom/oneplus/lib/menu/CascadingMenuPopup$CascadingMenuInfo;Lcom/oneplus/lib/menu/MenuBuilder;)Landroid/view/View;
    ...
    invoke-direct {p0, v2}, getNextMenuPosition(I)I
    ...
    :goto_3
    iget v10, p0, mDropDownGravity:I
    ...
    :cond_8
    iget-boolean v2, p0, mHasXOffset:Z

    if-eqz v2, :cond_9

    iget v2, p0, mXOffset:I

    invoke-virtual {v4, v2}, Lcom/oneplus/lib/widget/ListPopupWindow;->setHorizontalOffset(I)V

    :cond_9
    iget-boolean v2, p0, mHasYOffset:Z
    ...
    :cond_a
    invoke-virtual {p0}, getEpicenterBounds()Landroid/graphics/Rect;
    ...
    iget-boolean p0, p0, mShowTitle:Z
...
.method public addMenu(Lcom/oneplus/lib/menu/MenuBuilder;)V
    ...
    :cond_0
    iget-object p0, p0, mPendingMenus:Ljava/util/List;
...
.method public dismiss()V
    ...
    iget-object p0, p0, mShowingMenus:Ljava/util/List;
...
.method public onCloseMenu(Lcom/oneplus/lib/menu/MenuBuilder;Z)V
    ...
    iget-boolean v1, p0, mShouldCloseImmediately:Z
    ...
    iget-object p2, p0, mPresenterCallback:Lcom/oneplus/lib/menu/MenuPresenter$Callback;
    ...
    :cond_4
    iget-object p1, p0, mTreeObserver:Landroid/view/ViewTreeObserver;
    ...
    iget-object p2, p0, mGlobalLayoutListener:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
    ...
    :cond_6
    iget-object p1, p0, mShownAnchorView:Landroid/view/View;

    iget-object p2, p0, mAttachStateChangeListener:Landroid/view/View$OnAttachStateChangeListener;

    invoke-virtual {p1, p2}, Landroid/view/View;->removeOnAttachStateChangeListener(Landroid/view/View$OnAttachStateChangeListener;)V

    iget-object p0, p0, mOnDismissListener:Landroid/widget/PopupWindow$OnDismissListener;
...
.method public onSubMenuSelected(Lcom/oneplus/lib/menu/SubMenuBuilder;)Z
    ...
    iget-object p0, p0, mPresenterCallback:Lcom/oneplus/lib/menu/MenuPresenter$Callback;
...
.method public setAnchorView(Landroid/view/View;)V
    ...
    iget p1, p0, mRawDropDownGravity:I
...
.method public show()V
    ...
    iget-object v1, p0, mGlobalLayoutListener:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
    ...
    iget-object p0, p0, mAttachStateChangeListener:Landroid/view/View$OnAttachStateChangeListener;
