...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput p2, p0, mFacelockRunningType:I
    ...
    iput-object p2, p0, mPaddingRetryRunnable:Ljava/lang/Runnable;
    ...
    iput-object p2, p0, mTrustDrawable:Lcom/oneplus/phone/OpTrustDrawable;
    ...
    iput-object p1, p0, mFacelockAnimationSet:Landroid/view/animation/Animation;
    ...
    iput-object p1, p0, mFacelockFailAnimationSet:Landroid/view/animation/Animation;

    invoke-direct {p0}, getFacelockRetryAnimator()Landroid/animation/AnimatorSet;

    move-result-object p1

    iput-object p1, p0, mFacelockRetryAnimationSet:Landroid/animation/AnimatorSet;
...
.method static synthetic access$000(Lcom/oneplus/systemui/statusbar/phone/OpLockIcon;)I
    ...
    invoke-direct {p0}, getLastState()I
...
.method static synthetic access$100(Lcom/oneplus/systemui/statusbar/phone/OpLockIcon;)V
    ...
    invoke-direct {p0}, setRetryIcon()V
...
.method protected opGetAnimationResForTransition(IIZZZZ)I
    ...
    invoke-direct {p0}, getUnlockMethodCache()Lcom/android/systemui/statusbar/phone/UnlockMethodCache;
...
.method protected opGetState()I
    ...
    :cond_3
    invoke-direct {p0}, getTransientBiometricsError()Z
...
.method public opSetDeviceInteractive(Z)V
    ...
    iput-boolean p1, p0, mDeviceInteractive:Z

    invoke-direct {p0}, opUpdate()V
...
.method public opSetScreenOn(Z)V
    ...
    iget-object p1, p0, mFacelockRetryAnimationSet:Landroid/animation/AnimatorSet;
    ...
    :cond_0
    iget-object p1, p0, mPaddingRetryRunnable:Ljava/lang/Runnable;
...
.method protected opUpdateClickability()V
    ...
    invoke-direct {p0}, getAccessibilityController()Lcom/android/systemui/statusbar/policy/AccessibilityController;
...
.method protected opUpdateIconAnimation(Landroid/view/View;I)V
    ...
    iget-object v0, p0, mFacelockFailAnimationSet:Landroid/view/animation/Animation;
    ...
    iget-object v0, p0, mFacelockRetryAnimationSet:Landroid/animation/AnimatorSet;
    ...
    invoke-direct {p0}, getScreenOn()Z
    ...
    :cond_3
    iget-object p0, p0, mFacelockRetryAnimationSet:Landroid/animation/AnimatorSet;
    ...
    :cond_7
    iget-object p0, p0, mFacelockFailAnimationSet:Landroid/view/animation/Animation;
    ...
    :cond_8
    iget-object p2, p0, mFacelockAnimationSet:Landroid/view/animation/Animation;
