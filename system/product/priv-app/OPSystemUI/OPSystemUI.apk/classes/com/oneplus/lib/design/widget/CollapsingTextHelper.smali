...
.method public constructor <init>(Landroid/view/View;)V
    ...
    iput-object p1, p0, mTextPaint:Landroid/text/TextPaint;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, mCollapsedBounds:Landroid/graphics/Rect;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, mExpandedBounds:Landroid/graphics/Rect;

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, mCurrentBounds:Landroid/graphics/RectF;
...
.method private calculateBaseOffsets()V
    ...
    iget-object v1, p0, mCollapsedBounds:Landroid/graphics/Rect;

    iget v1, v1, Landroid/graphics/Rect;->left:I

    int-to-float v1, v1

    iput v1, p0, mCollapsedDrawX:F

    goto :goto_2

    :cond_3
    iget-object v4, p0, mCollapsedBounds:Landroid/graphics/Rect;
    ...
    :goto_2
    iget v1, p0, mExpandedTextSize:F
    ...
    :cond_5
    iget v1, p0, mExpandedTextGravity:I

    iget-boolean v2, p0, mIsRtl:Z
    ...
    iput v4, p0, mExpandedDrawY:F

    goto :goto_3

    :cond_6
    iget-object v2, p0, mExpandedBounds:Landroid/graphics/Rect;
...
.method private calculateUsingTextSize(F)V
    ...
    invoke-static {p1, v2}, isClose(FF)Z
    ...
    iget p1, p0, mCollapsedTextSize:F

    iput v3, p0, mScale:F

    iget-object v1, p0, mCurrentTypeface:Landroid/graphics/Typeface;

    iget-object v2, p0, mCollapsedTypeface:Landroid/graphics/Typeface;

    if-eq v1, v2, :cond_1

    iput-object v2, p0, mCurrentTypeface:Landroid/graphics/Typeface;
    ...
    iget-object v6, p0, mCurrentTypeface:Landroid/graphics/Typeface;

    iget-object v7, p0, mExpandedTypeface:Landroid/graphics/Typeface;

    if-eq v6, v7, :cond_3

    iput-object v7, p0, mCurrentTypeface:Landroid/graphics/Typeface;
    ...
    :goto_1
    iget v7, p0, mExpandedTextSize:F

    invoke-static {p1, v7}, isClose(FF)Z
    ...
    iget p1, p0, mCurrentTextSize:F

    cmpl-float p1, p1, v2

    if-nez p1, :cond_7

    iget-boolean p1, p0, mBoundsChanged:Z
    ...
    :goto_5
    iput v2, p0, mCurrentTextSize:F

    iput-boolean v5, p0, mBoundsChanged:Z

    :cond_8
    iget-object p1, p0, mTextToDraw:Ljava/lang/CharSequence;
    ...
    :cond_9
    iget-object p1, p0, mTextPaint:Landroid/text/TextPaint;

    iget v1, p0, mCurrentTextSize:F
    ...
    iget-object p1, p0, mText:Ljava/lang/CharSequence;
    ...
    iput-object p1, p0, mTextToDraw:Ljava/lang/CharSequence;

    iget-object p1, p0, mTextToDraw:Ljava/lang/CharSequence;

    invoke-direct {p0, p1}, calculateIsRtl(Ljava/lang/CharSequence;)Z
...
.method private ensureExpandedTexture()V
    ...
    iget-object v0, p0, mTexturePaint:Landroid/graphics/Paint;
    ...
    iput-object v0, p0, mTexturePaint:Landroid/graphics/Paint;
...
.method private getCurrentCollapsedTextColor()I
    ...
    iget-object p0, p0, mCollapsedTextColor:Landroid/content/res/ColorStateList;
...
.method private getCurrentExpandedTextColor()I
    ...
    iget-object p0, p0, mExpandedTextColor:Landroid/content/res/ColorStateList;
...
.method private interpolateBounds(F)V
    ...
    iget-object p0, p0, mPositionInterpolator:Landroid/view/animation/Interpolator;

    invoke-static {v1, v2, p1, p0}, lerp(FFFLandroid/view/animation/Interpolator;)F
...
.method private setInterpolatedTextSize(F)V
    ...
    sget-boolean p1, USE_SCALING_TEXTURE:Z
    ...
    :goto_0
    iput-boolean p1, p0, mUseTexture:Z

    iget-boolean p1, p0, mUseTexture:Z
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget v6, p0, mCurrentDrawX:F

    iget v1, p0, mCurrentDrawY:F

    iget-boolean v2, p0, mUseTexture:Z
    ...
    iget-object v1, p0, mExpandedTitleTexture:Landroid/graphics/Bitmap;

    iget-object p0, p0, mTexturePaint:Landroid/graphics/Paint;
...
.method getCollapsedTextSize()F
    ...
    iget p0, p0, mCollapsedTextSize:F
...
.method getCollapsedTypeface()Landroid/graphics/Typeface;
    ...
    iget-object p0, p0, mCollapsedTypeface:Landroid/graphics/Typeface;
...
.method getText()Ljava/lang/CharSequence;
    ...
    iget-object p0, p0, mText:Ljava/lang/CharSequence;
