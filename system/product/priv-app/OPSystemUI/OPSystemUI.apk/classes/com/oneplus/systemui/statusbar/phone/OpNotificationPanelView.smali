...
.method static constructor <clinit>()V
    ...
    sput v0, mLastCameraGestureLaunchSource:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p1, p0, mUpdateCameraStateTimeout:Ljava/lang/Runnable;
    ...
    iput-object p1, p0, mMonitorCallback:Lcom/android/keyguard/KeyguardUpdateMonitorCallback;
    ...
    iput-object p1, p0, mOpNotificationController:Lcom/oneplus/notification/OpNotificationController;
...
.method static synthetic access$100(Lcom/oneplus/systemui/statusbar/phone/OpNotificationPanelView;)Landroid/util/BoostFramework;
    ...
    invoke-direct {p0}, getPerf()Landroid/util/BoostFramework;
...
.method static synthetic access$500(Lcom/oneplus/systemui/statusbar/phone/OpNotificationPanelView;)Lcom/android/systemui/statusbar/phone/KeyguardAffordanceHelper;
    ...
    invoke-direct {p0}, getKeyguardAffordanceHelper()Lcom/android/systemui/statusbar/phone/KeyguardAffordanceHelper;
...
.method protected createHeightAnimatorForBiometricUnlock()Landroid/animation/ValueAnimator;
    ...
    invoke-direct {p0}, getKeyguardClockPositionAlgorithm()Lcom/android/systemui/statusbar/phone/KeyguardClockPositionAlgorithm;
...
.method protected initOpBottomArea()V
    ...
    invoke-virtual {p0, v0}, setShowOTAWizard(Z)V
...
.method public onDoubleTap(Landroid/view/MotionEvent;)Z
    ...
    invoke-direct {p0}, getNotificationStackScroller()Lcom/android/systemui/statusbar/notification/stack/NotificationStackScrollLayout;
    ...
    invoke-direct {p0}, isFingerprintAuthenticating()Z
...
.method protected opFlingToHeightAnimatorForBiometricUnlock()V
    ...
    invoke-virtual {p0}, createHeightAnimatorForBiometricUnlock()Landroid/animation/ValueAnimator;
...
.method public setUnlockAlpha(F)V
    ...
    invoke-direct {p0}, getKeyguardShowing()Z
    ...
    :cond_1
    invoke-direct {p0}, getKeyguardStatusView()Lcom/android/keyguard/KeyguardStatusView;
...
.method protected updateLaunchingCameraState(ZI)V
    ...
    sput p2, mLastCameraGestureLaunchSource:I

    iget-object p1, p0, mHandler:Landroid/os/Handler;

    iget-object p2, p0, mUpdateCameraStateTimeout:Ljava/lang/Runnable;
...
.method protected updateOpLockIcon()V
    ...
    iget-object v2, p0, mLockIcon:Lcom/android/systemui/statusbar/phone/LockIcon;
    ...
    iput-object v1, p0, mLockIcon:Lcom/android/systemui/statusbar/phone/LockIcon;

    :cond_2
    if-eqz v0, :cond_5

    iget-object v1, p0, mLockIcon:Lcom/android/systemui/statusbar/phone/LockIcon;
