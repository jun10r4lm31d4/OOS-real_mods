...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p3, p0, mSearchIconDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iput-object p3, p0, mOptionIconDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iput-object p3, p0, mHintText:Ljava/lang/String;
    ...
    iput p3, p0, mSearchIconTintColor:I
    ...
    iput-object p2, p0, mHintView:Landroid/widget/TextView;
    ...
    iput-object p2, p0, mIconSearch:Landroid/widget/ImageView;
    ...
    iput-object p2, p0, mOptionIconView:Landroid/widget/ImageView;

    iget-object p2, p0, mHintView:Landroid/widget/TextView;

    invoke-virtual {p2, p1}, Landroid/widget/TextView;->setTextColor(I)V

    iget-object p1, p0, mHintText:Ljava/lang/String;

    invoke-virtual {p0, p1}, setHintText(Ljava/lang/CharSequence;)V

    iget-object p1, p0, mSearchIconDrawable:Landroid/graphics/drawable/Drawable;

    if-eqz p1, :cond_0

    iget p2, p0, mSearchIconTintColor:I
    ...
    invoke-virtual {p0, p1}, setSearchIcon(Landroid/graphics/drawable/Drawable;)V

    iget-object p1, p0, mOptionIconDrawable:Landroid/graphics/drawable/Drawable;

    invoke-virtual {p0, p1}, setOptionIcon(Landroid/graphics/drawable/Drawable;)V
...
.method public setHintText(Ljava/lang/CharSequence;)V
    ...
    iget-object p0, p0, mHintView:Landroid/widget/TextView;
...
.method public setOptionIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object p0, p0, mOptionIconView:Landroid/widget/ImageView;
...
.method public setSearchIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object p0, p0, mIconSearch:Landroid/widget/ImageView;
