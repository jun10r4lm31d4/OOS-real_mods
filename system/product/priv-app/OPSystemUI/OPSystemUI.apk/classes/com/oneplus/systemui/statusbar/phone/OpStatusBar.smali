...
.method static constructor <clinit>()V
    ...
    sput-object v0, sPkgReceiver:Landroid/content/BroadcastReceiver;
...
.method public constructor <init>()V
    ...
    iput v1, p0, mLastBarHeight:I

    iput v0, p0, mDoubaleTapPowerApp:I

    iput-boolean v0, p0, mLastIsAppFullscreen:Z

    iput-boolean v0, p0, mCameraWakeAndUnlocking:Z

    iput-boolean v0, p0, isCTSStart:Z

    iput-boolean v0, p0, mImeStateChange:Z

    iput-boolean v0, p0, mImeShow:Z

    const/4 v1, 0x0

    iput-object v1, p0, mOpOneHandModeController:Lcom/oneplus/systemui/statusbar/phone/OpOneHandModeController;

    iput v0, p0, mNavType:I

    const/4 v1, 0x1

    iput-boolean v1, p0, mNavShowing:Z

    const-wide/16 v1, 0x0

    iput-wide v1, p0, mLastUpdateNavBarTime:J
    ...
    iput-object v1, p0, mCheckNavigationBarTask:Ljava/lang/Runnable;

    iput-boolean v0, p0, mQsDisabled:Z

    iput v0, p0, mDisableQs:I

    iput-boolean v0, p0, mPreHideAod:Z

    iput-boolean v0, p0, mWakingUpAnimationStart:Z

    iput v0, p0, mOutOfBoundThenRelayoutTimes:I
...
.method static synthetic access$100(Lcom/oneplus/systemui/statusbar/phone/OpStatusBar;)Lcom/android/systemui/statusbar/phone/NotificationPanelView;
    ...
    invoke-direct {p0}, getNotificationPanelView()Lcom/android/systemui/statusbar/phone/NotificationPanelView;
...
.method static synthetic access$1000(Lcom/oneplus/systemui/statusbar/phone/OpStatusBar;)Lcom/oneplus/systemui/statusbar/phone/OpStatusBar$OpDozeCallbacks;
    ...
    invoke-direct {p0}, getDozeServiceHost()Lcom/oneplus/systemui/statusbar/phone/OpStatusBar$OpDozeCallbacks;
...
.method static synthetic access$302(Lcom/oneplus/systemui/statusbar/phone/OpStatusBar;I)I
    ...
    iput p1, p0, mDoubaleTapPowerApp:I
...
.method static synthetic access$400(Lcom/oneplus/systemui/statusbar/phone/OpStatusBar;)Lcom/android/keyguard/KeyguardUpdateMonitor;
    ...
    invoke-direct {p0}, getKeyguardUpdateMonitor()Lcom/android/keyguard/KeyguardUpdateMonitor;
...
.method static synthetic access$600(Lcom/oneplus/systemui/statusbar/phone/OpStatusBar;)V
    ...
    invoke-direct {p0}, checkIfThemeChanged()V
...
.method static synthetic access$802(Lcom/oneplus/systemui/statusbar/phone/OpStatusBar;Z)Z
    ...
    iput-boolean p1, p0, isCTSStart:Z
...
.method static synthetic access$900(Lcom/oneplus/systemui/statusbar/phone/OpStatusBar;)Z
    ...
    iget-boolean p0, p0, mPreHideAod:Z
...
.method private checkIfThemeChanged()V
    ...
    iget-boolean v5, p0, mSpecialTheme:Z
    ...
    iget-boolean v5, p0, mGoogleDarkTheme:Z
    ...
    iget-boolean v4, p0, mSpecialTheme:Z

    if-ne v4, v2, :cond_1

    iget v4, p0, mThemeColor:I
    ...
    :cond_1
    iput v0, p0, mThemeColor:I

    iput v1, p0, mAccentColor:I

    iput-boolean v2, p0, mSpecialTheme:Z
    ...
    iget-boolean v1, p0, mGoogleDarkTheme:Z

    if-ne v1, v3, :cond_2

    invoke-direct {p0}, getStatusBarWindow()Lcom/android/systemui/statusbar/phone/StatusBarWindowView;
    ...
    iput-boolean v3, p0, mGoogleDarkTheme:Z
...
.method private disableGestureHandler()V
    ...
    iget-object v0, p0, mOpEdgeBackGestureHandler:Lcom/oneplus/systemui/statusbar/phone/OpEdgeBackGestureHandler;
    ...
    iput-object v0, p0, mOpEdgeBackGestureHandler:Lcom/oneplus/systemui/statusbar/phone/OpEdgeBackGestureHandler;
...
.method private enableGestureHandler()V
    ...
    iget-object v3, p0, mOpEdgeBackGestureHandler:Lcom/oneplus/systemui/statusbar/phone/OpEdgeBackGestureHandler;
    ...
    iput-object v3, p0, mOpEdgeBackGestureHandler:Lcom/oneplus/systemui/statusbar/phone/OpEdgeBackGestureHandler;
...
.method private initDetectCTSReceiver()V
    ...
    sget-object v0, sPkgReceiver:Landroid/content/BroadcastReceiver;
    ...
    sget-object v1, sPkgReceiver:Landroid/content/BroadcastReceiver;
...
.method public checkGestureStartAssist(Landroid/os/Bundle;)Z
    ...
    iget-boolean v0, p0, mNavShowing:Z
...
.method public checkNavigationBarState()V
    ...
    iget-wide v2, p0, mLastUpdateNavBarTime:J
    ...
    iget-wide v0, p0, mLastUpdateNavBarTime:J
    ...
    iget-object v4, p0, mCheckNavigationBarTask:Ljava/lang/Runnable;
    ...
    iget-object v3, p0, mCheckNavigationBarTask:Ljava/lang/Runnable;

    iget-wide v4, p0, mLastUpdateNavBarTime:J
    ...
    iget-object p0, p0, mCheckNavigationBarTask:Ljava/lang/Runnable;
...
.method protected checkToStartDozing()V
    ...
    iget-boolean v1, p0, mStartDozingRequested:Z
    ...
    iget-boolean v1, p0, mOpDozingRequested:Z
    ...
    :cond_0
    iget-boolean v0, p0, mStartDozingRequested:Z

    if-eqz v0, :cond_1

    iget-boolean v0, p0, mOpDozingRequested:Z

    if-nez v0, :cond_1

    const/4 v0, 0x1

    iput-boolean v0, p0, mOpDozingRequested:Z

    iget-object v0, p0, mAodWindowManager:Lcom/oneplus/aod/OpAodWindowManager;

    invoke-virtual {v0}, Lcom/oneplus/aod/OpAodWindowManager;->startDozing()V

    iget-object v0, p0, mAodDisplayViewManager:Lcom/oneplus/aod/OpAodDisplayViewManager;

    invoke-virtual {v0}, Lcom/oneplus/aod/OpAodDisplayViewManager;->startDozing()V

    iget-object v0, p0, Lcom/android/systemui/SystemUI;->mContext:Landroid/content/Context;

    invoke-direct {p0}, isDozing()Z

    move-result v1

    invoke-static {v0, v1}, Lcom/android/systemui/doze/DozeLog;->traceDozing(Landroid/content/Context;Z)V

    invoke-virtual {p0}, opUpdateDozing()V
...
.method protected checkToStopDozing()V
    ...
    iget-boolean v2, p0, mOpDozingRequested:Z
    ...
    iget-boolean v2, p0, isCTSStart:Z
    ...
    :cond_0
    iget-boolean v0, p0, isCTSStart:Z
    ...
    :cond_1
    iget-object v0, p0, mOpWakingUpScrimController:Lcom/oneplus/systemui/statusbar/phone/OpWakingUpScrimController;
    ...
    iget-boolean v2, p0, mWakingUpAnimationStart:Z
    ...
    :cond_3
    invoke-virtual {p0}, startWakingUpAnimation()V
...
.method protected disable(II)V
    ...
    invoke-direct {p0}, getNavigationBarView()Lcom/android/systemui/statusbar/phone/NavigationBarView;
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v0, p0, mOpFacelockController:Lcom/oneplus/faceunlock/OpFacelockController;
    ...
    :cond_0
    iget-object p1, p0, mAodDisplayViewManager:Lcom/oneplus/aod/OpAodDisplayViewManager;
...
.method public flingToStartFacelock()V
    ...
    iget-object p0, p0, mOpFacelockController:Lcom/oneplus/faceunlock/OpFacelockController;
...
.method public getAodWindowManager()Lcom/oneplus/aod/OpAodWindowManager;
    ...
    iget-object p0, p0, mAodWindowManager:Lcom/oneplus/aod/OpAodWindowManager;
...
.method public getDoubleTapPowerOpAppIntent(I)Landroid/content/Intent;
    ...
    iget p0, p0, mDoubaleTapPowerApp:I
...
.method public getGestureButtonController()Lcom/oneplus/systemui/statusbar/phone/OpGestureButtonViewController;
    ...
    iget-object p0, p0, mOpGestureButtonViewController:Lcom/oneplus/systemui/statusbar/phone/OpGestureButtonViewController;
...
.method public getGestureOnlineConfig()Lcom/oneplus/onlineconfig/OpSystemUIGestureOnlineConfig;
    ...
    iget-object p0, p0, mGestureOnlineConfig:Lcom/oneplus/onlineconfig/OpSystemUIGestureOnlineConfig;
...
.method public getOneHandModeController()Lcom/oneplus/systemui/statusbar/phone/OpOneHandModeController;
    ...
    iget-object p0, p0, mOpOneHandModeController:Lcom/oneplus/systemui/statusbar/phone/OpOneHandModeController;
...
.method public getSystemIconAreaMaxWidth(I)I
    ...
    invoke-virtual {p0}, getOpStatusBarView()Landroid/view/View;
...
.method public getmStatusBarCollapseListener()Lcom/oneplus/systemui/statusbar/phone/OpStatusBar$StatusBarCollapseListener;
    ...
    iget-object p0, p0, mStatusBarCollapseListener:Lcom/oneplus/systemui/statusbar/phone/OpStatusBar$StatusBarCollapseListener;
...
.method protected inflateOPAodView(Landroid/content/Context;)V
    ...
    iput-object p1, p0, mOPAodWindow:Landroid/widget/RelativeLayout;
...
.method public isImeStateChange()Z
    ...
    iget-boolean p0, p0, mImeStateChange:Z
...
.method protected isNavShowing()Z
    ...
    iget-boolean p0, p0, mNavShowing:Z
...
.method protected isNotificationLightBlinking()Z
    ...
    iget-object v0, p0, mOpNotificationController:Lcom/oneplus/notification/OpNotificationController;

    if-eqz v0, :cond_0

    invoke-direct {p0}, getEntryManager()Lcom/android/systemui/statusbar/notification/NotificationEntryManager;
...
.method public isQsDisabled()Z
    ...
    iget-boolean p0, p0, mQsDisabled:Z
...
.method public synthetic lambda$new$0$OpStatusBar()V
    ...
    iget-boolean v6, p0, mNavShowing:Z
    ...
    iget-boolean v5, p0, mNavShowing:Z

    iget v7, p0, mNavType:I
    ...
    iget-object v2, p0, mImeNavLp:Landroid/view/WindowManager$LayoutParams;

    invoke-interface {v0, v1, v2}, Landroid/view/WindowManager;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    iput-boolean v3, p0, mNavShowing:Z

    :cond_3
    invoke-direct {p0}, disableGestureHandler()V
    ...
    iput-boolean v2, p0, mNavShowing:Z

    :cond_5
    invoke-direct {p0}, enableGestureHandler()V

    invoke-virtual {p0}, updateImeWindowStatus()V
    ...
    iget-boolean v2, p0, mNavShowing:Z
    ...
    iget-object v2, p0, mNavLp:Landroid/view/WindowManager$LayoutParams;
    ...
    invoke-direct {p0}, getStatusBarKeyguardViewManager()Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;
    ...
    iget-boolean v1, p0, mNavShowing:Z
    ...
    iput-wide v0, p0, mLastUpdateNavBarTime:J
...
.method protected makeStatusBarView(Landroid/content/Context;)V
    ...
    invoke-direct {p0}, getNetworkController()Lcom/android/systemui/statusbar/policy/NetworkController;
    ...
    invoke-virtual {p0}, setUpHighlightHintInfo()V
...
.method public notifyBarHeightChange(I)V
    ...
    invoke-direct {p0}, getKeyguardViewMediator()Lcom/android/systemui/keyguard/KeyguardViewMediator;

    move-result-object v1

    if-eqz v1, :cond_3

    iget v1, p0, mLastBarHeight:I
    ...
    invoke-virtual {p0}, getStatusBarWindowController()Lcom/android/systemui/statusbar/phone/StatusBarWindowController;
    ...
    invoke-direct {p0}, getScrimController()Lcom/android/systemui/statusbar/phone/ScrimController;
...
.method protected notifyImeWindowVisible(ILandroid/os/IBinder;IIZ)V
    ...
    iput p1, p0, mImeDisplayId:I

    iput-object p2, p0, mToken:Landroid/os/IBinder;

    iput p3, p0, mImeVisibleState:I

    iput p4, p0, mBackDisposition:I

    iput-boolean p5, p0, mShowImeSwitcher:Z
    ...
    :goto_0
    iput-boolean p1, p0, mImeShow:Z

    iput-boolean p2, p0, mImeStateChange:Z

    invoke-direct {p0}, getHandler()Landroid/os/Handler;

    move-result-object p1

    iget-object p2, p0, mCheckNavigationBarTask:Ljava/lang/Runnable;
    ...
    invoke-virtual {p0}, checkNavigationBarState()V
...
.method public onBrickModeChanged(Z)V
    ...
    invoke-direct {p0}, getHeadsUpAppearanceController()Lcom/android/systemui/statusbar/phone/HeadsUpAppearanceController;
    ...
    invoke-virtual {p0}, checkToStopDozing()V

    goto :goto_0

    :cond_1
    invoke-virtual {p0}, checkToStartDozing()V
...
.method public onFingerprintAuthenticated()V
    ...
    iget-object v2, p0, mAodDisplayViewManager:Lcom/oneplus/aod/OpAodDisplayViewManager;
    ...
    :cond_1
    iget-object v1, p0, mAodDisplayViewManager:Lcom/oneplus/aod/OpAodDisplayViewManager;
    ...
    iget-object p0, p0, mAodDisplayViewManager:Lcom/oneplus/aod/OpAodDisplayViewManager;
...
.method public onKeyguardShowingChanged()V
    ...
    invoke-virtual {p0}, updateQsEnabled()V
...
.method protected opOnConfigChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object p1, p0, mOpEdgeBackGestureHandler:Lcom/oneplus/systemui/statusbar/phone/OpEdgeBackGestureHandler;
    ...
    :cond_3
    iget-object p1, p0, mImeNavLp:Landroid/view/WindowManager$LayoutParams;
    ...
    iget-object p0, p0, mImeNavLp:Landroid/view/WindowManager$LayoutParams;
...
.method protected opOnDensityOrFontScaleChanged()V
    ...
    invoke-virtual {p0, v0}, inflateOPAodView(Landroid/content/Context;)V
    ...
    iget-object v2, p0, mOPAodWindow:Landroid/widget/RelativeLayout;
    ...
    iput-object v0, p0, mAodWindowManager:Lcom/oneplus/aod/OpAodWindowManager;

    iget-object v0, p0, mAodDisplayViewManager:Lcom/oneplus/aod/OpAodDisplayViewManager;

    iget-object p0, p0, mOPAodWindow:Landroid/widget/RelativeLayout;
...
.method public opOnStartedGoingToSleep()V
    ...
    iget-object v2, p0, mWakingUpAnimation:Landroid/animation/AnimatorSet;
    ...
    iget-object p0, p0, mOpWakingUpScrimController:Lcom/oneplus/systemui/statusbar/phone/OpWakingUpScrimController;
...
.method protected opUpdateDozing()V
    ...
    invoke-direct {p0}, getBiometricUnlockController()Lcom/android/systemui/statusbar/phone/BiometricUnlockController;
    ...
    :cond_2
    iget-boolean v1, p0, mCustomDozing:Z

    if-eq v1, v0, :cond_3

    iput-boolean v0, p0, mCustomDozing:Z

    invoke-direct {p0}, getDozeScrimController()Lcom/android/systemui/statusbar/phone/DozeScrimController;
...
.method protected opUpdatePanelExpansionForKeyguard()V
    ...
    invoke-direct {p0}, getBouncerShowing()Z
    ...
    invoke-direct {p0}, instantExpandNotificationsPanel()V
    ...
    invoke-direct {p0}, instantCollapseNotificationPanel()V
...
.method protected opUpdateScrimController()V
    ...
    :cond_0
    invoke-direct {p0}, isKeyguardShowing()Z
    ...
    :cond_1
    invoke-direct {p0}, isInLaunchTransition()Z

    move-result v3

    if-eqz v3, :cond_2

    invoke-direct {p0}, getIsKeyguard()Z
    ...
    :cond_2
    invoke-direct {p0}, isLaunchCameraWhenFinishedWaking()Z
    ...
    :cond_3
    invoke-direct {p0}, isBrightnessMirrorVisible()Z
    ...
    :cond_7
    invoke-direct {p0}, getBubbleController()Lcom/android/systemui/bubbles/BubbleController;
    ...
    invoke-direct {p0}, getUnlockScrimCallback()Lcom/android/systemui/statusbar/phone/ScrimController$Callback;
...
.method public removeHeadsUps()V
    ...
    invoke-direct {p0}, getHeadsUpManager()Lcom/android/systemui/statusbar/phone/HeadsUpManagerPhone;
    ...
    :cond_0
    iget-object p0, p0, mOpNotificationController:Lcom/oneplus/notification/OpNotificationController;
...
.method protected setUpHighlightHintInfo()V
    ...
    invoke-direct {p0}, getPanel()Lcom/android/systemui/statusbar/phone/NotificationPanelView;
...
.method public setmStatusBarCollapseListener(Lcom/oneplus/systemui/statusbar/phone/OpStatusBar$StatusBarCollapseListener;)V
    ...
    iput-object p1, p0, mStatusBarCollapseListener:Lcom/oneplus/systemui/statusbar/phone/OpStatusBar$StatusBarCollapseListener;
...
.method public start()V
    ...
    iput-object v0, p0, mOtaWizardObserver:Landroid/database/ContentObserver;

    iget-object v0, p0, mOtaWizardObserver:Landroid/database/ContentObserver;
    ...
    iget-object v3, p0, mOtaWizardObserver:Landroid/database/ContentObserver;
    ...
    iput-object v0, p0, mKeyguardMonitor:Lcom/android/systemui/statusbar/policy/KeyguardMonitor;
    ...
    iput-object v0, p0, mFullScreenGestureObserver:Landroid/database/ContentObserver;
    ...
    iget-object v0, p0, mFullScreenGestureObserver:Landroid/database/ContentObserver;
    ...
    iget-object v3, p0, mFullScreenGestureObserver:Landroid/database/ContentObserver;
    ...
    iput-object v0, p0, mDoubleTapPowerObserver:Landroid/database/ContentObserver;

    iget-object v0, p0, mDoubleTapPowerObserver:Landroid/database/ContentObserver;
    ...
    iget-object v3, p0, mDoubleTapPowerObserver:Landroid/database/ContentObserver;
    ...
    iput-object v0, p0, mDisableQsObserver:Landroid/database/ContentObserver;

    iget-object v0, p0, mDisableQsObserver:Landroid/database/ContentObserver;
    ...
    iget-object v3, p0, mDisableQsObserver:Landroid/database/ContentObserver;
    ...
    iput-boolean v0, p0, mSpecialTheme:Z
    ...
    iput-boolean v0, p0, mGoogleDarkTheme:Z
    ...
    iput-object v0, p0, mOpNotificationController:Lcom/oneplus/notification/OpNotificationController;
    ...
    iput-object v0, p0, mOpSceneModeObserver:Lcom/oneplus/scene/OpSceneModeObserver;

    iget-object v0, p0, Lcom/android/systemui/SystemUI;->mContext:Landroid/content/Context;

    invoke-static {v0}, Lcom/oneplus/util/OpUtils;->init(Landroid/content/Context;)V

    iget-object v0, p0, mThemeSetting:Lcom/oneplus/util/SystemSetting;
    ...
    iput-object v0, p0, mThemeSetting:Lcom/oneplus/util/SystemSetting;
    ...
    iput-object v0, p0, mOpWakingUpScrimController:Lcom/oneplus/systemui/statusbar/phone/OpWakingUpScrimController;

    invoke-direct {p0}, initDetectCTSReceiver()V
    ...
    iput-object v0, p0, mTelecomManager:Landroid/telecom/TelecomManager;

    iget-object v0, p0, mNavLp:Landroid/view/WindowManager$LayoutParams;
    ...
    iput-object v0, p0, mNavLp:Landroid/view/WindowManager$LayoutParams;
    ...
    :cond_2
    iget-object v0, p0, mImeNavLp:Landroid/view/WindowManager$LayoutParams;
    ...
    iput-object v0, p0, mImeNavLp:Landroid/view/WindowManager$LayoutParams;
    ...
    iput-object v0, p0, mOpGestureButtonViewController:Lcom/oneplus/systemui/statusbar/phone/OpGestureButtonViewController;
    ...
    invoke-static {}, Lcom/oneplus/util/OpUtils;->isOpenBeta()Z
    ...
    iput-object v0, p0, mOpOneHandModeController:Lcom/oneplus/systemui/statusbar/phone/OpOneHandModeController;
    ...
    iput-object v0, p0, mGestureOnlineConfig:Lcom/oneplus/onlineconfig/OpSystemUIGestureOnlineConfig;
...
.method protected startInner()V
    ...
    invoke-direct {p0}, getLockscreenUserManager()Lcom/android/systemui/statusbar/NotificationLockscreenUserManager;
...
.method protected startWakingUpAnimation()V
    ...
    iget-boolean v0, p0, mWakingUpAnimationStart:Z
    ...
    invoke-direct {p0}, getIsOccluded()Z
    ...
    iget-object v4, p0, mOpFacelockController:Lcom/oneplus/faceunlock/OpFacelockController;
    ...
    const-string/jumbo v8, "startWakingUpAnimation isFingerprintUnlock:"
    ...
    iget-object v8, p0, mOpFacelockController:Lcom/oneplus/faceunlock/OpFacelockController;
    ...
    :cond_2
    iget-object v7, p0, mWakingUpAnimation:Landroid/animation/AnimatorSet;
    ...
    iput-object v7, p0, mWakingUpAnimation:Landroid/animation/AnimatorSet;

    if-eqz v2, :cond_6

    iget-object v2, p0, mAodWindowManager:Lcom/oneplus/aod/OpAodWindowManager;
    ...
    iget-object v4, p0, mOpWakingUpScrimController:Lcom/oneplus/systemui/statusbar/phone/OpWakingUpScrimController;

    invoke-virtual {v4, v0}, Lcom/oneplus/systemui/statusbar/phone/OpWakingUpScrimController;->startAnimation(Z)V

    iget-object v4, p0, mWakingUpAnimation:Landroid/animation/AnimatorSet;
    ...
    :cond_4
    iget-object v3, p0, mWakingUpAnimation:Landroid/animation/AnimatorSet;

    invoke-virtual {v3, v2}, Landroid/animation/AnimatorSet;->play(Landroid/animation/Animator;)Landroid/animation/AnimatorSet$Builder;

    iget-object v2, p0, mOpWakingUpScrimController:Lcom/oneplus/systemui/statusbar/phone/OpWakingUpScrimController;
    ...
    :goto_2
    iget-object v0, p0, mWakingUpAnimation:Landroid/animation/AnimatorSet;
    ...
    iget-object p0, p0, mWakingUpAnimation:Landroid/animation/AnimatorSet;
...
.method public updateImeWindowStatus()V
    ...
    iget-boolean v1, p0, mImeStateChange:Z
    ...
    iget-boolean v0, p0, mImeStateChange:Z
    ...
    iget v2, p0, mImeDisplayId:I

    iget-object v3, p0, mToken:Landroid/os/IBinder;

    iget v4, p0, mImeVisibleState:I

    iget v5, p0, mBackDisposition:I

    iget-boolean v6, p0, mShowImeSwitcher:Z
...
.method public updateQsEnabled()V
    ...
    invoke-direct {p0}, isKeyguardSecure()Z

    move-result v0

    if-eqz v0, :cond_1

    iget-boolean v0, p0, mQsDisabled:Z
    ...
    :cond_0
    iput-boolean v2, p0, mQsDisabled:Z
