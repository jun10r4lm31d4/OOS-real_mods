...
.method private constructor <init>(Lcom/oneplus/keyguard/OpPasswordTextViewForPin;)V
    ...
    iput-object p1, p0, this$0:Lcom/oneplus/keyguard/OpPasswordTextViewForPin;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    const/high16 p1, 0x3f800000    # 1.0f

    iput p1, p0, currentTextTranslationY:F

    iput p1, p0, currentEmptyCircleSizeFactor:F
    ...
    iput-object p1, p0, removeEndListener:Landroid/animation/Animator$AnimatorListener;
    ...
    iput-object p1, p0, dotFinishListener:Landroid/animation/Animator$AnimatorListener;
    ...
    iput-object p1, p0, textFinishListener:Landroid/animation/Animator$AnimatorListener;
    ...
    iput-object p1, p0, textTranslateFinishListener:Landroid/animation/Animator$AnimatorListener;
    ...
    iput-object p1, p0, widthFinishListener:Landroid/animation/Animator$AnimatorListener;
    ...
    iput-object p1, p0, dotSizeUpdater:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    iput-object p1, p0, textSizeUpdater:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    iput-object p1, p0, textTranslationUpdater:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    iput-object p1, p0, widthUpdater:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    iput-object p1, p0, dotSwapperRunnable:Ljava/lang/Runnable;
...
.method synthetic constructor <init>(Lcom/oneplus/keyguard/OpPasswordTextViewForPin;Lcom/oneplus/keyguard/OpPasswordTextViewForPin$1;)V
    ...
    invoke-direct {p0, p1}, <init>(Lcom/oneplus/keyguard/OpPasswordTextViewForPin;)V
...
.method static synthetic access$200(Lcom/oneplus/keyguard/OpPasswordTextViewForPin$CharState;)V
    ...
    invoke-direct {p0}, removeDotSwapCallbacks()V
...
.method static synthetic access$500(Lcom/oneplus/keyguard/OpPasswordTextViewForPin$CharState;Landroid/animation/Animator;)V
    ...
    invoke-direct {p0, p1}, cancelAnimator(Landroid/animation/Animator;)V
...
.method static synthetic access$600(Lcom/oneplus/keyguard/OpPasswordTextViewForPin$CharState;)V
    ...
    invoke-direct {p0}, performSwap()V
...
.method private performSwap()V
    ...
    invoke-direct {p0, v0, v1}, startTextDisappearAnimation(J)V

    const-wide/16 v0, 0x1e

    invoke-direct {p0, v0, v1}, startDotAppearAnimation(J)V
...
.method private postDotSwap(J)V
    ...
    iget-object v0, p0, this$0:Lcom/oneplus/keyguard/OpPasswordTextViewForPin;

    iget-object v1, p0, dotSwapperRunnable:Ljava/lang/Runnable;

    invoke-virtual {v0, v1, p1, p2}, Landroid/view/View;->postDelayed(Ljava/lang/Runnable;J)Z

    const/4 p1, 0x1

    iput-boolean p1, p0, isDotSwapPending:Z
...
.method private removeDotSwapCallbacks()V
    ...
    iput-boolean v0, p0, isDotSwapPending:Z
...
.method private startDotAppearAnimation(J)V
    ...
    iget-object v0, p0, dotAnimator:Landroid/animation/Animator;
    ...
    iget v4, p0, currentDotSizeFactor:F
    ...
    iget-object v4, p0, dotSizeUpdater:Landroid/animation/ValueAnimator$AnimatorUpdateListener;

    invoke-virtual {v0, v4}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    iget-object v4, p0, this$0:Lcom/oneplus/keyguard/OpPasswordTextViewForPin;
    ...
    iget-object v7, p0, dotSizeUpdater:Landroid/animation/ValueAnimator$AnimatorUpdateListener;

    invoke-virtual {v6, v7}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    invoke-virtual {v6, v4, v5}, Landroid/animation/ValueAnimator;->setDuration(J)Landroid/animation/ValueAnimator;

    iget-object v4, p0, dotFinishListener:Landroid/animation/Animator$AnimatorListener;
    ...
    iput-object v4, p0, dotAnimator:Landroid/animation/Animator;
    ...
    iget v3, p0, currentDotSizeFactor:F
    ...
    iget-object v3, p0, dotSizeUpdater:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    iget-object v1, p0, dotFinishListener:Landroid/animation/Animator$AnimatorListener;
    ...
    iput-object v0, p0, dotAnimator:Landroid/animation/Animator;

    :goto_0
    iput-boolean v2, p0, dotAnimationIsGrowing:Z
...
.method private startDotDisappearAnimation(J)V
    ...
    iget v1, p0, currentDotSizeFactor:F
    ...
    iget-object v1, p0, dotSizeUpdater:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    iget-object v1, p0, this$0:Lcom/oneplus/keyguard/OpPasswordTextViewForPin;
...
.method private startTextAppearAnimation()V
    ...
    iget-object v0, p0, textAnimator:Landroid/animation/ValueAnimator;
    ...
    iget v2, p0, currentTextSizeFactor:F
    ...
    iput-object v1, p0, textAnimator:Landroid/animation/ValueAnimator;

    iget-object v1, p0, textAnimator:Landroid/animation/ValueAnimator;

    iget-object v4, p0, textSizeUpdater:Landroid/animation/ValueAnimator$AnimatorUpdateListener;

    invoke-virtual {v1, v4}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    iget-object v1, p0, textAnimator:Landroid/animation/ValueAnimator;

    iget-object v4, p0, textFinishListener:Landroid/animation/Animator$AnimatorListener;
    ...
    iget v4, p0, currentTextSizeFactor:F
    ...
    iput-boolean v3, p0, textAnimationIsGrowing:Z

    iget-object v1, p0, textTranslateAnimator:Landroid/animation/ValueAnimator;
    ...
    iput-object v0, p0, textTranslateAnimator:Landroid/animation/ValueAnimator;

    iget-object v0, p0, textTranslateAnimator:Landroid/animation/ValueAnimator;

    iget-object v1, p0, textTranslationUpdater:Landroid/animation/ValueAnimator$AnimatorUpdateListener;

    invoke-virtual {v0, v1}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    iget-object v0, p0, textTranslateAnimator:Landroid/animation/ValueAnimator;

    iget-object v1, p0, textTranslateFinishListener:Landroid/animation/Animator$AnimatorListener;
    ...
    iget-object p0, p0, textTranslateAnimator:Landroid/animation/ValueAnimator;
...
.method private startTextDisappearAnimation(J)V
    ...
    iget v1, p0, currentTextSizeFactor:F
    ...
    iput-object v0, p0, textAnimator:Landroid/animation/ValueAnimator;

    iget-object v0, p0, textAnimator:Landroid/animation/ValueAnimator;

    iget-object v1, p0, textSizeUpdater:Landroid/animation/ValueAnimator$AnimatorUpdateListener;

    invoke-virtual {v0, v1}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    iget-object v0, p0, textAnimator:Landroid/animation/ValueAnimator;

    iget-object v1, p0, textFinishListener:Landroid/animation/Animator$AnimatorListener;
    ...
    iget-object p1, p0, textAnimator:Landroid/animation/ValueAnimator;

    invoke-virtual {p1}, Landroid/animation/ValueAnimator;->start()V

    iput-boolean v2, p0, textAnimationIsGrowing:Z
...
.method private startWidthAppearAnimation()V
    ...
    iget-object v0, p0, widthAnimator:Landroid/animation/ValueAnimator;
    ...
    iget v1, p0, currentWidthFactor:F
    ...
    iput-object v0, p0, widthAnimator:Landroid/animation/ValueAnimator;

    iget-object v0, p0, widthAnimator:Landroid/animation/ValueAnimator;

    iget-object v3, p0, widthUpdater:Landroid/animation/ValueAnimator$AnimatorUpdateListener;

    invoke-virtual {v0, v3}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    iget-object v0, p0, widthAnimator:Landroid/animation/ValueAnimator;

    iget-object v3, p0, widthFinishListener:Landroid/animation/Animator$AnimatorListener;

    invoke-virtual {v0, v3}, Landroid/animation/ValueAnimator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    iget-object v0, p0, widthAnimator:Landroid/animation/ValueAnimator;

    iget v3, p0, currentWidthFactor:F
    ...
    iput-boolean v2, p0, widthAnimationIsGrowing:Z
...
.method private startWidthDisappearAnimation(J)V
    ...
    iget-object v1, p0, widthUpdater:Landroid/animation/ValueAnimator$AnimatorUpdateListener;

    invoke-virtual {v0, v1}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    iget-object v0, p0, widthAnimator:Landroid/animation/ValueAnimator;

    iget-object v1, p0, widthFinishListener:Landroid/animation/Animator$AnimatorListener;

    invoke-virtual {v0, v1}, Landroid/animation/ValueAnimator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    iget-object v0, p0, widthAnimator:Landroid/animation/ValueAnimator;

    iget-object v1, p0, removeEndListener:Landroid/animation/Animator$AnimatorListener;
    ...
    iget-object p1, p0, widthAnimator:Landroid/animation/ValueAnimator;
...
.method public draw(Landroid/graphics/Canvas;FIFF)F
    ...
    iget v0, p0, currentTextSizeFactor:F
    ...
    iget v4, p0, currentTextTranslationY:F
    ...
    iget p3, p0, currentTextSizeFactor:F

    invoke-virtual {p1, p3, p3}, Landroid/graphics/Canvas;->scale(FF)V

    iget-char p3, p0, whichChar:C
    ...
    iget-object p2, p0, this$0:Lcom/oneplus/keyguard/OpPasswordTextViewForPin;
    ...
    iget p3, p0, currentDotSizeFactor:F

    mul-float/2addr p2, p3

    iget-object p3, p0, this$0:Lcom/oneplus/keyguard/OpPasswordTextViewForPin;
    ...
    :cond_3
    iget-object p1, p0, this$0:Lcom/oneplus/keyguard/OpPasswordTextViewForPin;
    ...
    iget p0, p0, currentWidthFactor:F
...
.method reset()V
    ...
    iput-char v0, p0, whichChar:C

    const/4 v0, 0x0

    iput v0, p0, currentTextSizeFactor:F

    iput v0, p0, currentDotSizeFactor:F

    iput v0, p0, currentWidthFactor:F
    ...
    iget-object v1, p0, dotAnimator:Landroid/animation/Animator;

    invoke-direct {p0, v1}, cancelAnimator(Landroid/animation/Animator;)V

    iput-object v0, p0, dotAnimator:Landroid/animation/Animator;

    iget-object v1, p0, widthAnimator:Landroid/animation/ValueAnimator;
    ...
    iput v0, p0, currentTextTranslationY:F
...
.method startAppearAnimation()V
    ...
    iget-boolean v0, p0, dotAnimationIsGrowing:Z
    ...
    :goto_0
    iget-object v3, p0, this$0:Lcom/oneplus/keyguard/OpPasswordTextViewForPin;
    ...
    iget-object v3, p0, textAnimator:Landroid/animation/ValueAnimator;

    if-eqz v3, :cond_2

    iget-boolean v3, p0, textAnimationIsGrowing:Z
    ...
    :goto_1
    iget-object v4, p0, widthAnimator:Landroid/animation/ValueAnimator;

    if-eqz v4, :cond_5

    iget-boolean v4, p0, widthAnimationIsGrowing:Z
    ...
    invoke-direct {p0, v4, v5}, startDotAppearAnimation(J)V

    :cond_6
    if-eqz v3, :cond_7

    invoke-direct {p0}, startTextAppearAnimation()V

    :cond_7
    if-eqz v1, :cond_8

    invoke-direct {p0}, startWidthAppearAnimation()V
    ...
    invoke-direct {p0, v0, v1}, postDotSwap(J)V
...
.method startRemoveAnimation(JJ)V
    ...
    iget v0, p0, currentDotSizeFactor:F
    ...
    iget-object v4, p0, textAnimator:Landroid/animation/ValueAnimator;
    ...
    iget-boolean v4, p0, textAnimationIsGrowing:Z
    ...
    :goto_1
    iget v5, p0, currentWidthFactor:F
    ...
    iget-boolean v1, p0, widthAnimationIsGrowing:Z
    ...
    invoke-direct {p0, p1, p2}, startDotDisappearAnimation(J)V

    :cond_9
    if-eqz v4, :cond_a

    invoke-direct {p0, p1, p2}, startTextDisappearAnimation(J)V

    :cond_a
    if-eqz v2, :cond_b

    invoke-direct {p0, p3, p4}, startWidthDisappearAnimation(J)V
...
.method swapToDotWhenAppearFinished()V
    ...
    iget-object v2, p0, textAnimator:Landroid/animation/ValueAnimator;
