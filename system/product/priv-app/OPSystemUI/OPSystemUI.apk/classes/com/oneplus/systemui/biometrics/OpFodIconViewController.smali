...
.method public constructor <init>(Landroid/content/Context;Landroid/view/ViewGroup;Landroid/view/ViewGroup;Lcom/oneplus/systemui/biometrics/OpBiometricDialogImpl;)V
    ...
    iput-object p2, p0, mIconFlash:Lcom/oneplus/systemui/biometrics/OpCircleImageView;
    ...
    iput-object p2, p0, mIconNormal:Lcom/oneplus/systemui/biometrics/OpCircleImageView;
    ...
    iput-object p2, p0, mIconDisable:Lcom/oneplus/systemui/biometrics/OpCircleImageView;
    ...
    iget-object p2, p0, mKeyguardUpdateMonitorCallback:Lcom/android/keyguard/KeyguardUpdateMonitorCallback;
    ...
    iput-object p1, p0, mWakefulnessLifecycle:Lcom/android/systemui/keyguard/WakefulnessLifecycle;

    iget-object p1, p0, mWakefulnessLifecycle:Lcom/android/systemui/keyguard/WakefulnessLifecycle;

    iget-object p2, p0, mWakefulnessObserver:Lcom/android/systemui/keyguard/WakefulnessLifecycle$Observer;
    ...
    iput-object p1, p0, mAodDisplayViewManager:Lcom/oneplus/aod/OpAodDisplayViewManager;

    iput-object p4, p0, mDialogImpl:Lcom/oneplus/systemui/biometrics/OpBiometricDialogImpl;
    ...
    iput-object p1, p0, mContextResolver:Landroid/content/ContentResolver;
    ...
    iput-object p1, p0, mSettingsObserver:Lcom/oneplus/systemui/biometrics/OpFodIconViewController$SettingsObserver;
    ...
    iput-object p1, p0, mTimeoutAnimator:Landroid/animation/ValueAnimator;

    iget-object p1, p0, mTimeoutAnimator:Landroid/animation/ValueAnimator;
    ...
    iget-object p2, p0, mAnimatorUpdateListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;

    invoke-virtual {p1, p2}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    iget-object p1, p0, mSettingsObserver:Lcom/oneplus/systemui/biometrics/OpFodIconViewController$SettingsObserver;
...
.method static synthetic access$002(Lcom/oneplus/systemui/biometrics/OpFodIconViewController;Z)Z
    ...
    iput-boolean p1, p0, mIsWakingUp:Z
...
.method static synthetic access$100(Lcom/oneplus/systemui/biometrics/OpFodIconViewController;)Lcom/oneplus/systemui/biometrics/OpCircleImageView;
    ...
    iget-object p0, p0, mIconDisable:Lcom/oneplus/systemui/biometrics/OpCircleImageView;
...
.method static synthetic access$302(Lcom/oneplus/systemui/biometrics/OpFodIconViewController;Z)Z
    ...
    iput-boolean p1, p0, mIsScreenTurningOn:Z
...
.method static synthetic access$402(Lcom/oneplus/systemui/biometrics/OpFodIconViewController;Z)Z
    ...
    iput-boolean p1, p0, mShowingKeyguard:Z
...
.method static synthetic access$500(Lcom/oneplus/systemui/biometrics/OpFodIconViewController;)Lcom/oneplus/systemui/biometrics/OpCircleImageView;
    ...
    iget-object p0, p0, mIconNormal:Lcom/oneplus/systemui/biometrics/OpCircleImageView;
...
.method static synthetic access$600(Lcom/oneplus/systemui/biometrics/OpFodIconViewController;)Landroid/content/ContentResolver;
    ...
    iget-object p0, p0, mContextResolver:Landroid/content/ContentResolver;
...
.method public handleUpdateIconVisibility(Z)V
    ...
    iget-object v2, v0, mUpdateMonitor:Lcom/android/keyguard/KeyguardUpdateMonitor;
    ...
    iput-object v2, v0, mUpdateMonitor:Lcom/android/keyguard/KeyguardUpdateMonitor;

    :cond_0
    iget-object v2, v0, mIconNormal:Lcom/oneplus/systemui/biometrics/OpCircleImageView;

    const-string v4, "OpFodIconViewController"

    if-eqz v2, :cond_18

    iget-object v2, v0, mAodDisplayViewManager:Lcom/oneplus/aod/OpAodDisplayViewManager;

    if-eqz v2, :cond_18

    iget-object v2, v0, mIconDisable:Lcom/oneplus/systemui/biometrics/OpCircleImageView;
    ...
    iget-object v6, v0, mUpdateMonitor:Lcom/android/keyguard/KeyguardUpdateMonitor;

    invoke-virtual {v6}, Lcom/android/keyguard/KeyguardUpdateMonitor;->isUnlockingWithBiometricAllowed()Z

    move-result v6

    iget-object v7, v0, mStatusBarKeyguardViewManager:Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;

    invoke-virtual {v7}, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;->isBouncerShowing()Z

    move-result v7

    iget-object v8, v0, mUpdateMonitor:Lcom/android/keyguard/KeyguardUpdateMonitor;

    invoke-virtual {v8}, Lcom/oneplus/keyguard/OpKeyguardUpdateMonitor;->isImeShow()Z

    move-result v8

    iget-object v9, v0, mUpdateMonitor:Lcom/android/keyguard/KeyguardUpdateMonitor;

    invoke-virtual {v9}, Lcom/android/keyguard/KeyguardUpdateMonitor;->isSimPinSecure()Z

    move-result v9

    iget-object v10, v0, mUpdateMonitor:Lcom/android/keyguard/KeyguardUpdateMonitor;

    invoke-virtual {v10}, Lcom/android/keyguard/KeyguardUpdateMonitor;->isDreaming()Z

    move-result v10

    iget-object v11, v0, mUpdateMonitor:Lcom/android/keyguard/KeyguardUpdateMonitor;

    invoke-virtual {v11}, Lcom/oneplus/keyguard/OpKeyguardUpdateMonitor;->isUserUnlocked()Z

    move-result v11

    iget-object v12, v0, mUpdateMonitor:Lcom/android/keyguard/KeyguardUpdateMonitor;

    invoke-virtual {v12}, Lcom/oneplus/keyguard/OpKeyguardUpdateMonitor;->isQSExpanded()Z

    move-result v12

    iget-object v13, v0, mUpdateMonitor:Lcom/android/keyguard/KeyguardUpdateMonitor;

    invoke-virtual {v13}, Lcom/oneplus/keyguard/OpKeyguardUpdateMonitor;->isPreventModeActivte()Z

    move-result v13

    iget-object v14, v0, mUpdateMonitor:Lcom/android/keyguard/KeyguardUpdateMonitor;

    invoke-virtual {v14}, Lcom/oneplus/keyguard/OpKeyguardUpdateMonitor;->isFacelockRecognizing()Z

    move-result v14

    iget-object v15, v0, mUpdateMonitor:Lcom/android/keyguard/KeyguardUpdateMonitor;

    invoke-virtual {v15}, Lcom/oneplus/keyguard/OpKeyguardUpdateMonitor;->isLaunchingCamera()Z

    move-result v15

    iget-object v3, v0, mUpdateMonitor:Lcom/android/keyguard/KeyguardUpdateMonitor;

    invoke-virtual {v3}, Lcom/oneplus/keyguard/OpKeyguardUpdateMonitor;->isLaunchingLeftAffordance()Z

    move-result v3

    iget-object v5, v0, mStatusBarKeyguardViewManager:Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;
    ...
    iget-object v4, v0, mUpdateMonitor:Lcom/android/keyguard/KeyguardUpdateMonitor;
    ...
    iget-object v4, v0, mDialogImpl:Lcom/oneplus/systemui/biometrics/OpBiometricDialogImpl;
    ...
    iget-boolean v13, v0, mGoingToSleep:Z
    ...
    iget-boolean v13, v0, mShowingKeyguard:Z
    ...
    iget-boolean v4, v0, mIsScreenTurningOn:Z
    ...
    iget-boolean v4, v0, mIsWakingUp:Z
    ...
    iget-object v12, v0, mIconNormal:Lcom/oneplus/systemui/biometrics/OpCircleImageView;
    ...
    iget-object v1, v0, mIconNormal:Lcom/oneplus/systemui/biometrics/OpCircleImageView;

    invoke-virtual {v1, v5}, Lcom/oneplus/systemui/biometrics/OpCircleImageView;->setVisibility(I)V

    iget-object v0, v0, mIconDisable:Lcom/oneplus/systemui/biometrics/OpCircleImageView;
    ...
    :cond_3
    iget-object v1, v0, mDialogImpl:Lcom/oneplus/systemui/biometrics/OpBiometricDialogImpl;
    ...
    iget-boolean v4, v0, mGoingToSleep:Z
    ...
    iget-boolean v3, v0, mIsWakingUp:Z
    ...
    iget-object v3, v0, mIconNormal:Lcom/oneplus/systemui/biometrics/OpCircleImageView;

    invoke-virtual {v3, v5}, Lcom/oneplus/systemui/biometrics/OpCircleImageView;->setVisibility(I)V

    iget-object v3, v0, mIconDisable:Lcom/oneplus/systemui/biometrics/OpCircleImageView;

    invoke-virtual {v3, v2}, Lcom/oneplus/systemui/biometrics/OpCircleImageView;->setVisibility(I)V

    iget-object v0, v0, mDialogImpl:Lcom/oneplus/systemui/biometrics/OpBiometricDialogImpl;
    ...
    iget-object v0, v0, mIconNormal:Lcom/oneplus/systemui/biometrics/OpCircleImageView;
    ...
    iget-boolean v1, v0, mShowingKeyguard:Z
    ...
    iget-object v1, v0, mIconDisable:Lcom/oneplus/systemui/biometrics/OpCircleImageView;
...
.method public handleUpdateLayoutDimension()V
    ...
    iget-object v2, p0, mIconDisable:Lcom/oneplus/systemui/biometrics/OpCircleImageView;
    ...
    iget-object v3, p0, mIconDisable:Lcom/oneplus/systemui/biometrics/OpCircleImageView;
    ...
    iget-object v2, p0, mIconNormal:Lcom/oneplus/systemui/biometrics/OpCircleImageView;
    ...
    iget-object v1, p0, mIconNormal:Lcom/oneplus/systemui/biometrics/OpCircleImageView;
    ...
    iget-object p0, p0, mIconFlash:Lcom/oneplus/systemui/biometrics/OpCircleImageView;
...
.method public onFingerprintStateChanged()V
    ...
    invoke-virtual {p0, v0}, handleUpdateIconVisibility(Z)V
