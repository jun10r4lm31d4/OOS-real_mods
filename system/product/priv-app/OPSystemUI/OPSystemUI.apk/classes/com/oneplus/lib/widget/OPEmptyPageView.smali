...
.method private checkShowComplete()Z
    ...
    :goto_0
    iget-object v3, p0, mMiddleActionTextView:Landroid/widget/TextView;
    ...
    iget-object p0, p0, mBottomActionTextView:Landroid/widget/TextView;
...
.method private initTypedArray(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-virtual {p0, p2}, setEmptyDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, p2}, setTopActionColor(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {p0, p2}, setMiddleActionColor(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {p0, p2}, setBottomActionColor(Landroid/content/res/ColorStateList;)V

    :cond_2
    invoke-virtual {p0, p3}, setEmptyText(Ljava/lang/CharSequence;)V

    invoke-virtual {p0, p4}, setTopActionText(Ljava/lang/CharSequence;)V

    iget-object p2, p0, mTopActionTextView:Landroid/widget/TextView;

    invoke-virtual {p2, v0}, Landroid/widget/TextView;->setClickable(Z)V

    invoke-virtual {p0, v2}, setMiddleActionText(Ljava/lang/CharSequence;)V

    iget-object p2, p0, mMiddleActionTextView:Landroid/widget/TextView;

    invoke-virtual {p2, v3}, Landroid/widget/TextView;->setClickable(Z)V

    invoke-virtual {p0, v4}, setBottomActionText(Ljava/lang/CharSequence;)V
...
.method public onClick(Landroid/view/View;)V
    ...
    :cond_3
    iget-object p0, p0, onActionButtonClickedListener:Lcom/oneplus/lib/widget/OPEmptyPageView$OnEmptyViewActionButtonClickedListener;
...
.method protected onLayout(ZIIII)V
    ...
    iget-object p2, p0, mImageView:Landroid/widget/ImageView;
    ...
    iget-object p0, p0, mImageView:Landroid/widget/ImageView;
...
.method public setMiddleActionColor(Landroid/content/res/ColorStateList;)V
    ...
    iget-object p0, p0, mMiddleActionTextView:Landroid/widget/TextView;
...
.method public setTopActionColor(Landroid/content/res/ColorStateList;)V
    ...
    iget-object p0, p0, mTopActionTextView:Landroid/widget/TextView;
