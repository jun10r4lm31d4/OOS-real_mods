...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mHourPaint:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0}, Landroid/graphics/Paint;-><init>()V

    iput-object v0, p0, mMinPaint:Landroid/graphics/Paint;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object p2, p0, mFormat12:Ljava/lang/CharSequence;
    ...
    iput-object p2, p0, mFormat24:Ljava/lang/CharSequence;
    ...
    iput-object p2, p0, mTimeZone:Ljava/lang/String;
    :try_end_0
...
.method static synthetic access$100(Lcom/oneplus/aod/OpTextClock;)Ljava/lang/Runnable;
    ...
    iget-object p0, p0, mTicker:Ljava/lang/Runnable;
...
.method private chooseFormat(Z)V
    ...
    iget-object v2, p0, mFormat12:Ljava/lang/CharSequence;

    iget-object v1, v1, Llibcore/icu/LocaleData;->timeFormat_Hm:Ljava/lang/String;

    invoke-static {v0, v2, v1}, abc(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/CharSequence;

    move-result-object v0

    iput-object v0, p0, mFormat:Ljava/lang/CharSequence;

    iget-object v0, p0, mDescFormat24:Ljava/lang/CharSequence;

    iget-object v1, p0, mDescFormat12:Ljava/lang/CharSequence;

    iget-object v2, p0, mFormat:Ljava/lang/CharSequence;

    invoke-static {v0, v1, v2}, abc(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/CharSequence;

    move-result-object v0

    iput-object v0, p0, mDescFormat:Ljava/lang/CharSequence;
    ...
    iget-object v2, p0, mFormat24:Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, mDescFormat12:Ljava/lang/CharSequence;

    iget-object v1, p0, mDescFormat24:Ljava/lang/CharSequence;
    ...
    iget-object v1, p0, mFormat:Ljava/lang/CharSequence;

    invoke-static {v1}, Landroid/text/format/DateFormat;->hasSeconds(Ljava/lang/CharSequence;)Z

    move-result v1

    iput-boolean v1, p0, mHasSeconds:Z

    if-eqz p1, :cond_2

    iget-boolean p1, p0, mHasSeconds:Z
...
.method private createTime(Ljava/lang/String;)V
    ...
    iput-object p1, p0, mTime:Ljava/util/Calendar;
...
.method private drawClockDefault(Landroid/graphics/Canvas;)V
    ...
    :goto_0
    iget-object v4, p0, mTime:Ljava/util/Calendar;
    ...
    iget-object v5, p0, mHourPaint:Landroid/graphics/Paint;
    ...
    iget-object v7, p0, mHourPaint:Landroid/graphics/Paint;
    ...
    iget-object v9, p0, mHourPaint:Landroid/graphics/Paint;
    ...
    iget v9, p0, mDigitColorRed:I

    goto :goto_1

    :cond_1
    iget v9, p0, mDigitColorWhite:I

    :goto_1
    iget-object v11, p0, mHourPaint:Landroid/graphics/Paint;
    ...
    iget v0, p0, mDigitColorRed:I

    goto :goto_3

    :cond_3
    iget v0, p0, mDigitColorWhite:I

    :goto_3
    iget-object v3, p0, mHourPaint:Landroid/graphics/Paint;
    ...
    :goto_4
    iget-object v0, p0, mHourPaint:Landroid/graphics/Paint;
    ...
    iget v1, p0, mFontBaseLineY:F

    iget-object p0, p0, mHourPaint:Landroid/graphics/Paint;
...
.method private init()V
    ...
    iput-object v0, p0, mFormat24:Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, mMinPaint:Landroid/graphics/Paint;

    invoke-virtual {v0, v1}, Landroid/graphics/Paint;->setAntiAlias(Z)V

    iget-object v0, p0, mMinPaint:Landroid/graphics/Paint;

    iget v1, p0, mDigitColorWhite:I

    invoke-virtual {v0, v1}, Landroid/graphics/Paint;->setColor(I)V

    invoke-direct {p0}, updateTypeface()V
...
.method private onTimeChanged()V
    ...
    invoke-direct {p0}, getTextHeight()I
...
.method private updateTypeface()V
    ...
    :cond_1
    iget-object v1, p0, mHourPaint:Landroid/graphics/Paint;

    invoke-virtual {v1, v0}, Landroid/graphics/Paint;->setTypeface(Landroid/graphics/Typeface;)Landroid/graphics/Typeface;

    iget-object v1, p0, mMinPaint:Landroid/graphics/Paint;

    invoke-virtual {v1, v0}, Landroid/graphics/Paint;->setTypeface(Landroid/graphics/Typeface;)Landroid/graphics/Typeface;

    invoke-direct {p0}, updateTextSize()V
...
.method protected onAttachedToWindow()V
    ...
    invoke-virtual {p0, v0}, setTimeZone(Ljava/lang/String;)V
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget v0, p0, mClockStyle:I

    if-nez v0, :cond_0

    invoke-direct {p0, p1}, drawClockDefault(Landroid/graphics/Canvas;)V
