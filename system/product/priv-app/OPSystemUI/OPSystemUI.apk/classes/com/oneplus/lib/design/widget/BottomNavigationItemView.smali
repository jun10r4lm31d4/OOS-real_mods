...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget p3, Lcom/oneplus/commonctrl/R$layout;->op_design_bottom_navigation_item:I
    ...
    iput-object p1, p0, icon:Landroid/widget/ImageView;
    ...
    iput-object p1, p0, badge:Lcom/oneplus/lib/design/widget/BadgeView;
    ...
    iput-object p1, p0, smallLabel:Landroid/widget/TextView;
    ...
    iput-object p1, p0, largeLabel:Landroid/widget/TextView;

    iget-object p1, p0, badge:Lcom/oneplus/lib/design/widget/BadgeView;

    const/4 p2, 0x2

    invoke-static {p1, p2}, Lcom/oneplus/support/core/view/ViewCompat;->setImportantForAccessibility(Landroid/view/View;I)V

    iget-object p1, p0, smallLabel:Landroid/widget/TextView;

    invoke-static {p1, p2}, Lcom/oneplus/support/core/view/ViewCompat;->setImportantForAccessibility(Landroid/view/View;I)V

    iget-object p1, p0, largeLabel:Landroid/widget/TextView;
    ...
    iget-object p2, p0, largeLabel:Landroid/widget/TextView;

    invoke-virtual {p2}, Landroid/widget/TextView;->getTextSize()F

    move-result p2

    invoke-direct {p0, p1, p2}, calculateTextScaleFactors(FF)V
...
.method private calculateTextScaleFactors(FF)V
    ...
    iput v1, p0, scaleUpFactor:F

    mul-float/2addr p1, v0

    div-float/2addr p1, p2

    iput p1, p0, scaleDownFactor:F
...
.method bindNotification(Lcom/oneplus/lib/design/widget/BottomNavigationNotification;)V
    ...
    iget-object p0, p0, badge:Lcom/oneplus/lib/design/widget/BadgeView;

    invoke-virtual {p0, p1}, Lcom/oneplus/lib/design/widget/BadgeView;->bindNotification(Lcom/oneplus/lib/design/widget/BottomNavigationNotification;)V
...
.method public getItemData()Lcom/oneplus/lib/menu/MenuItemImpl;
    ...
    iget-object p0, p0, itemData:Lcom/oneplus/lib/menu/MenuItemImpl;
...
.method public getNotification()Lcom/oneplus/lib/design/widget/BottomNavigationNotification;
    ...
    invoke-virtual {p0}, Lcom/oneplus/lib/design/widget/BadgeView;->getNotification()Lcom/oneplus/lib/design/widget/BottomNavigationNotification;
...
.method public initialize(Lcom/oneplus/lib/menu/MenuItemImpl;I)V
    ...
    iput-object p1, p0, itemData:Lcom/oneplus/lib/menu/MenuItemImpl;
    ...
    invoke-virtual {p0, p2}, setChecked(Z)V
...
.method public onCreateDrawableState(I)[I
    ...
    iget-object v0, p0, itemData:Lcom/oneplus/lib/menu/MenuItemImpl;
...
.method public setChecked(Z)V
    ...
    iget-object v0, p0, largeLabel:Landroid/widget/TextView;
    ...
    iget-object v0, p0, smallLabel:Landroid/widget/TextView;
    ...
    :goto_0
    iget-object v0, p0, icon:Landroid/widget/ImageView;

    iget v2, p0, defaultMargin:I
    ...
    :cond_2
    invoke-direct {p0, v0, v2, v3}, setViewLayoutParams(Landroid/view/View;II)V
    ...
    iget v1, p0, defaultMargin:I

    int-to-float v1, v1

    iget v2, p0, shiftAmount:F

    add-float/2addr v1, v2

    float-to-int v1, v1

    invoke-direct {p0, v0, v1, v6}, setViewLayoutParams(Landroid/view/View;II)V

    iget-object v0, p0, largeLabel:Landroid/widget/TextView;

    invoke-direct {p0, v0, v8, v8, v5}, setViewValues(Landroid/view/View;FFI)V

    iget-object v0, p0, smallLabel:Landroid/widget/TextView;

    iget v1, p0, scaleUpFactor:F

    invoke-direct {p0, v0, v1, v1, v7}, setViewValues(Landroid/view/View;FFI)V
    ...
    invoke-direct {p0, v0, v1, v3}, setViewLayoutParams(Landroid/view/View;II)V

    iget-object v0, p0, largeLabel:Landroid/widget/TextView;

    invoke-direct {p0, v0, v4, v4, v7}, setViewValues(Landroid/view/View;FFI)V
    ...
    :cond_7
    iget-boolean v0, p0, isShifting:Z
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v0, p0, iconTint:Landroid/content/res/ColorStateList;
    ...
    :cond_1
    iget-object p0, p0, icon:Landroid/widget/ImageView;
...
.method public setIconTintList(Landroid/content/res/ColorStateList;)V
    ...
    iput-object p1, p0, iconTint:Landroid/content/res/ColorStateList;

    iget-object p1, p0, itemData:Lcom/oneplus/lib/menu/MenuItemImpl;
    ...
    invoke-virtual {p0, p1}, setIcon(Landroid/graphics/drawable/Drawable;)V
...
.method public setItemBackground(I)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, setItemBackground(Landroid/graphics/drawable/Drawable;)V
...
.method public setShifting(Z)V
    ...
    iput-boolean p1, p0, isShifting:Z
...
.method public setTextAppearanceActive(I)V
    ...
    invoke-direct {p0, p1, v0}, calculateTextScaleFactors(FF)V
...
.method public setTextColor(Landroid/content/res/ColorStateList;)V
    ...
    iget-object p0, p0, largeLabel:Landroid/widget/TextView;
