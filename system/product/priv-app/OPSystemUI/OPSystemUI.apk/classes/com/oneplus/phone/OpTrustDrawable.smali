...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mAlphaUpdateListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    iput-object v0, p0, mRadiusUpdateListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    iput v1, p0, mInnerRadiusVisibleMin:F
    ...
    iput v1, p0, mInnerRadiusVisibleMax:F
    ...
    iput v1, p0, mInnerRadiusEnter:F
    ...
    iput v0, p0, mThickness:F

    iget v0, p0, mInnerRadiusEnter:F

    iput v0, p0, mCurInnerRadius:F

    invoke-direct {p0}, makeVisibleAnimator()Landroid/animation/Animator;

    move-result-object v0

    iput-object v0, p0, mVisibleAnimator:Landroid/animation/Animator;
    ...
    iget-object p1, p0, mPaint:Landroid/graphics/Paint;
...
.method static synthetic access$300(Lcom/oneplus/phone/OpTrustDrawable;Z)V
    ...
    invoke-direct {p0, p1}, updateState(Z)V
...
.method private makeAnimators(FFIIJLandroid/view/animation/Interpolator;ZZ)Landroid/animation/Animator;
    ...
    iget-object v4, v7, mAlphaUpdateListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    invoke-direct/range {v0 .. v6}, configureAnimator(Landroid/animation/ValueAnimator;JLandroid/animation/ValueAnimator$AnimatorUpdateListener;Landroid/view/animation/Interpolator;Z)Landroid/animation/ValueAnimator;
    ...
    iget-object v4, v7, mRadiusUpdateListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
...
.method private makeEnterAnimator(FI)Landroid/animation/Animator;
    ...
    iget v2, p0, mInnerRadiusVisibleMax:F
    ...
    invoke-direct/range {v0 .. v9}, makeAnimators(FFIIJLandroid/view/animation/Interpolator;ZZ)Landroid/animation/Animator;
...
.method private makeVisibleAnimator()Landroid/animation/Animator;
    ...
    iget v1, p0, mInnerRadiusVisibleMax:F

    iget v2, p0, mInnerRadiusVisibleMin:F
...
.method private updateState(Z)V
    ...
    iget-boolean v0, p0, mTrustManaged:Z
    ...
    iget-boolean v5, p0, mTrustManaged:Z
    ...
    iget-object p1, p0, mCurAnimator:Landroid/animation/Animator;
    ...
    iput-object p1, p0, mCurAnimator:Landroid/animation/Animator;

    :cond_8
    if-nez v0, :cond_9

    iput v5, p0, mCurAlpha:I

    iget p1, p0, mInnerRadiusEnter:F
    ...
    iget p1, p0, mCurInnerRadius:F

    iget v2, p0, mCurAlpha:I

    invoke-direct {p0, p1, v2}, makeEnterAnimator(FI)Landroid/animation/Animator;
    ...
    iget p1, p0, mInnerRadiusVisibleMax:F

    iput p1, p0, mCurInnerRadius:F

    iget-object p1, p0, mVisibleAnimator:Landroid/animation/Animator;
    ...
    iget v1, p0, mCurAlpha:I

    invoke-direct {p0, p1, v1}, makeExitAnimator(FI)Landroid/animation/Animator;
...
.method public setTrustManaged(Z)V
    ...
    :cond_0
    iput-boolean p1, p0, mTrustManaged:Z
...
.method public start()V
    ...
    invoke-direct {p0, v0}, updateState(Z)V
...
.method public stop()V
    ...
    iget-object v1, p0, mCurAnimator:Landroid/animation/Animator;
    ...
    iput-object v1, p0, mCurAnimator:Landroid/animation/Animator;
