...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput v0, p0, mTextClockStyle:I

    iput v0, p0, mGradientStyle:I

    const/4 v1, -0x1

    iput v1, p0, mGradientStartColor:I

    iput v1, p0, mGradientEndColor:I

    iput v1, p0, mColorTop:I

    iput v1, p0, mColorBottom:I

    iput v1, p0, mTextClockStringTemplate:I
    ...
    invoke-direct {p0, p2}, setupAttributes(Landroid/content/res/TypedArray;)V
    ...
    iput-object p2, p0, mHours:[Ljava/lang/String;
    ...
    iput-object p1, p0, mMinutes:[Ljava/lang/String;
...
.method private loadProperties()V
    ...
    iput v2, p0, mGradientStartColor:I
    ...
    iput v0, p0, mGradientEndColor:I
    :try_end_0
...
.method private setupAttributes(Landroid/content/res/TypedArray;)V
    ...
    iget v1, p0, mGradientStartColor:I

    invoke-virtual {p1, v0, v1}, Landroid/content/res/TypedArray;->getColor(II)I

    move-result v0

    iput v0, p0, mGradientStartColor:I

    sget v0, Lcom/android/systemui/R$styleable;->OpCustomTextClock_gradientEndColor:I

    iget v1, p0, mGradientEndColor:I
    ...
    iget v1, p0, mColorTop:I

    invoke-virtual {p1, v0, v1}, Landroid/content/res/TypedArray;->getColor(II)I

    move-result v0

    iput v0, p0, mColorTop:I

    sget v0, Lcom/android/systemui/R$styleable;->OpCustomTextClock_colorBottom:I

    iget v1, p0, mColorBottom:I

    invoke-virtual {p1, v0, v1}, Landroid/content/res/TypedArray;->getColor(II)I

    move-result v0

    iput v0, p0, mColorBottom:I
    ...
    iput p1, p0, mTextClockStringTemplate:I
...
.method protected onAttachedToWindow()V
    ...
    invoke-virtual {p0, v0}, setTimeZone(Ljava/util/TimeZone;)V
...
.method protected onLayout(ZIIII)V
    ...
    iget p1, p0, mTextClockStyle:I

    if-nez p1, :cond_2

    iget p1, p0, mGradientStyle:I
    ...
    iget v5, p0, mGradientStartColor:I

    iget v6, p0, mGradientEndColor:I
...
.method public onTimeChanged()V
    ...
    iget-object v3, p0, mTime:Ljava/util/Calendar;
    ...
    iget v5, p0, mTextClockStringTemplate:I
    ...
    iget-object v5, p0, mHours:[Ljava/lang/String;

    aget-object v0, v5, v0

    aput-object v0, v4, v6

    iget-object v0, p0, mMinutes:[Ljava/lang/String;
...
.method public setClockStyle(I)V
    ...
    :goto_0
    invoke-direct {p0}, loadProperties()V

    invoke-direct {p0}, loadDimensions()V

    invoke-virtual {p0}, onTimeChanged()V
...
.method public setTimeZone(Ljava/util/TimeZone;)V
    ...
    iput-object p1, p0, mTimeZone:Ljava/util/TimeZone;
