...
.field private final mNavBarFrameHeight:I
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/recents/OverviewProxyService;)V
    ...
    iput-boolean v0, p0, mAllowNavGesture:Z
    ...
    iput-object p1, p0, mMainExecutor:Ljava/util/concurrent/Executor;
    ...
    iput p1, p0, mNavEdgeWidthLand:I
    ...
    iput p1, p0, mNavBarFrameHeight:I
    ...
    iput-object p1, p0, mOneHandModeController:Lcom/oneplus/systemui/statusbar/phone/OpOneHandModeController;
...
.method private getNavEdgeWidth(I)I
    ...
    :cond_1
    iget p0, p0, mNavEdgeWidth:I

    return p0

    :cond_2
    :goto_0
    iget p0, p0, mNavEdgeWidthLand:I
...
.method public static isOneHandedEnable()Z
    ...
    sget-boolean v0, mIsOneHandedEnable:Z
...
.method private isWithinNavTouchRegion(II)Z
    ...
    iget v0, p0, mNavBarFrameHeight:I

    goto :goto_0

    :cond_0
    iget v0, p0, mNavBarHeight:I
    ...
    iget-boolean v2, p0, mAllowGesture:Z
    ...
    invoke-direct {p0, v2}, getNavEdgeWidth(I)I
    ...
    invoke-direct {p0, v1}, getNavEdgeWidth(I)I
...
.method private onInputEvent(Landroid/view/InputEvent;)V
    ...
    iget-object v0, p0, mHome:Landroid/view/View;
...
.method private onMotionEvent(Landroid/view/MotionEvent;)V
    ...
    invoke-direct {p0, v4, v6}, isWithinTouchRegion(II)Z
    ...
    :goto_0
    iput-boolean v4, p0, mAllowGesture:Z
    ...
    invoke-direct {p0, v0, v4}, isWithinNavTouchRegion(II)Z
    ...
    :goto_1
    iput-boolean v3, p0, mAllowNavGesture:Z

    iget-boolean v0, p0, mAllowNavGesture:Z
    ...
    :cond_3
    iget-object p0, p0, mHome:Landroid/view/View;
    ...
    :cond_4
    iget-boolean v4, p0, mAllowNavGesture:Z
...
.method private updateIsEnabled()V
    ...
    const-string/jumbo v1, "updateIsEnabled: GestureModeEnable: "
    ...
    sget-boolean v1, mIsOneHandedEnable:Z
...
.method public onConfigurationChanged(I)V
    ...
    iget-boolean p1, p0, mIsEnabled:Z
...
.method public onNavBarAttached()V
    ...
    iget-object v0, p0, mOneHandModeController:Lcom/oneplus/systemui/statusbar/phone/OpOneHandModeController;
...
.method public onOneHandEnableStateChange(Z)V
    ...
    sput-boolean p1, mIsOneHandedEnable:Z
...
.method public setHomeButton(Landroid/view/View;)V
    ...
    iput-object p1, p0, mHome:Landroid/view/View;
