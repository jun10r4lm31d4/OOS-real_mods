...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object p1, p0, mItems:Ljava/util/ArrayList;
    ...
    iput-object p1, p0, mTempItem:Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;
    ...
    iput p1, p0, mRestoredCurItem:I

    const/4 p2, 0x0

    iput-object p2, p0, mRestoredAdapterState:Landroid/os/Parcelable;

    iput-object p2, p0, mRestoredClassLoader:Ljava/lang/ClassLoader;

    const p2, -0x800001

    iput p2, p0, mFirstOffset:F

    const p2, 0x7f7fffff    # Float.MAX_VALUE

    iput p2, p0, mLastOffset:F

    const/4 p2, 0x1

    iput p2, p0, mOffscreenPageLimit:I

    iput p1, p0, mActivePointerId:I

    iput-boolean p2, p0, mFirstLayout:Z

    const/4 p1, 0x0

    iput-boolean p1, p0, mNeedCalculatePageOffsets:Z
    ...
    iput-object p2, p0, mEndScrollRunnable:Ljava/lang/Runnable;
...
.method private calculatePageOffsets(Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;ILcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;)V
    ...
    :cond_6
    iget-object p3, p0, mItems:Ljava/util/ArrayList;
    ...
    :cond_e
    iput-boolean v1, p0, mNeedCalculatePageOffsets:Z
...
.method private completeScroll(Z)V
    ...
    iget-object p1, p0, mEndScrollRunnable:Ljava/lang/Runnable;
    ...
    :cond_5
    iget-object p0, p0, mEndScrollRunnable:Ljava/lang/Runnable;
...
.method private determineTargetPage(IFII)I
    ...
    :goto_1
    iget-object p2, p0, mItems:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, mItems:Ljava/util/ArrayList;
...
.method private dispatchOnPageScrolled(IFI)V
    ...
    :cond_2
    iget-object p0, p0, mInternalPageChangeListener:Lcom/oneplus/support/viewpager/widget/ViewPager$OnPageChangeListener;
...
.method private enableLayers(Z)V
    ...
    iget v3, p0, mPageTransformerLayerType:I
...
.method private infoForCurrentScrollPosition()Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;
    ...
    :goto_2
    iget-object v10, p0, mItems:Ljava/util/ArrayList;
    ...
    iget-object v10, p0, mTempItem:Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;
    ...
    iget-object v7, p0, mAdapter:Lcom/oneplus/support/viewpager/widget/PagerAdapter;
...
.method private pageScrolled(I)Z
    ...
    iget-boolean p1, p0, mFirstLayout:Z
    ...
    invoke-virtual {p0, v2, p1, v2}, onPageScrolled(IFI)V

    iget-boolean p0, p0, mCalledSuper:Z
    ...
    invoke-virtual {p0, v6, p1, v0}, onPageScrolled(IFI)V
...
.method private performDrag(F)Z
    ...
    iget-object v1, p0, mRightEdge:Landroid/widget/EdgeEffect;
...
.method private recomputeScrollPosition(IIII)V
    ...
    iget-object p1, p0, mScroller:Landroid/widget/Scroller;
    ...
    :cond_1
    iget p2, p0, mCurItem:I

    invoke-virtual {p0, p2}, infoForPosition(I)Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;
    ...
    invoke-direct {p0, p2}, completeScroll(Z)V
...
.method private resetTouch()Z
    ...
    iget-object p0, p0, mRightEdge:Landroid/widget/EdgeEffect;
...
.method private scrollToItem(IZIZ)V
    ...
    invoke-virtual {p0, v0, v1, p3}, smoothScrollTo(III)V
...
.method private sortChildDrawingOrder()V
    ...
    :cond_1
    iget-object p0, p0, mDrawingOrderedChildren:Ljava/util/ArrayList;

    sget-object v0, sPositionComparator:Lcom/oneplus/support/viewpager/widget/ViewPager$ViewPositionComparator;
...
.method addNewItem(II)Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;
    ...
    iget-object p1, p0, mItems:Ljava/util/ArrayList;
...
.method public addOnAdapterChangeListener(Lcom/oneplus/support/viewpager/widget/ViewPager$OnAdapterChangeListener;)V
    ...
    :cond_0
    iget-object p0, p0, mAdapterChangeListeners:Ljava/util/List;
...
.method public arrowScroll(I)Z
    ...
    invoke-direct {p0, v1, v0}, getChildRectInPagerCoordinates(Landroid/graphics/Rect;Landroid/view/View;)Landroid/graphics/Rect;
    ...
    invoke-direct {p0, v2, v3}, getChildRectInPagerCoordinates(Landroid/graphics/Rect;Landroid/view/View;)Landroid/graphics/Rect;
...
.method protected canScroll(Landroid/view/View;ZIII)Z
    ...
    invoke-virtual/range {v6 .. v11}, canScroll(Landroid/view/View;ZIII)Z
...
.method dataSetChanged()V
    ...
    sget-object v1, COMPARATOR:Ljava/util/Comparator;
    ...
    :cond_a
    invoke-virtual {p0, v6, v4, v3}, setCurrentItemInternal(IZZ)V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    :cond_0
    iget-object p1, p0, mLeftEdge:Landroid/widget/EdgeEffect;

    invoke-virtual {p1}, Landroid/widget/EdgeEffect;->finish()V

    iget-object p1, p0, mRightEdge:Landroid/widget/EdgeEffect;
    ...
    iget-object v4, p0, mLeftEdge:Landroid/widget/EdgeEffect;
    ...
    iget-object v4, p0, mRightEdge:Landroid/widget/EdgeEffect;
...
.method public executeKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    invoke-virtual {p0, v0}, arrowScroll(I)Z
    ...
    invoke-virtual {p0, p1}, arrowScroll(I)Z
...
.method public getAdapter()Lcom/oneplus/support/viewpager/widget/PagerAdapter;
    ...
    iget-object p0, p0, mAdapter:Lcom/oneplus/support/viewpager/widget/PagerAdapter;
...
.method initViewPager()V
    ...
    iput v1, p0, mDefaultGutterSize:I
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v8, v0, mItems:Ljava/util/ArrayList;
    ...
    iget-object v10, v0, mItems:Ljava/util/ArrayList;
    ...
    iget-object v11, v0, mMarginDrawable:Landroid/graphics/drawable/Drawable;
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v1, v6, mIsBeingDragged:Z
    ...
    :cond_1
    iget-boolean v1, v6, mIsUnableToDrag:Z
    ...
    invoke-direct {p0, v0, v1}, isGutterDrag(FF)Z
    ...
    iput v10, v6, mLastMotionX:F

    iput v12, v6, mLastMotionY:F

    iput-boolean v9, v6, mIsUnableToDrag:Z
    ...
    iput-boolean v9, v6, mIsBeingDragged:Z

    invoke-direct {p0, v9}, requestParentDisallowInterceptTouchEvent(Z)V

    invoke-virtual {p0, v9}, setScrollState(I)V
    ...
    invoke-direct {p0, v9}, setScrollingCacheEnabled(Z)V
    ...
    iput v0, v6, mInitialMotionY:F

    iput v0, v6, mLastMotionY:F
    ...
    iput-boolean v8, v6, mIsUnableToDrag:Z

    iput-boolean v9, v6, mIsScrollStarted:Z
    ...
    iput-boolean v8, v6, mPopulatePending:Z
    ...
    :cond_b
    invoke-direct {p0, v8}, completeScroll(Z)V

    iput-boolean v8, v6, mIsBeingDragged:Z
...
.method protected onLayout(ZIIII)V
    ...
    invoke-virtual {v0, v6}, infoForChild(Landroid/view/View;)Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;
    ...
    :cond_a
    iput v7, v0, mTopPageBounds:I

    sub-int/2addr v3, v10

    iput v3, v0, mBottomPageBounds:I
...
.method protected onMeasure(II)V
    ...
    iget v1, p0, mDefaultGutterSize:I

    invoke-static {p2, v1}, Ljava/lang/Math;->min(II)I

    move-result p2

    iput p2, p0, mGutterSize:I
    ...
    iput p1, p0, mChildWidthMeasureSpec:I

    invoke-static {v2, v5}, Landroid/view/View$MeasureSpec;->makeMeasureSpec(II)I

    move-result p1

    iput p1, p0, mChildHeightMeasureSpec:I
    ...
    iget v4, p0, mChildHeightMeasureSpec:I
...
.method protected onPageScrolled(IFI)V
    ...
    :cond_5
    invoke-direct {p0, p1, p2, p3}, dispatchOnPageScrolled(IFI)V

    iget-object p1, p0, mPageTransformer:Lcom/oneplus/support/viewpager/widget/ViewPager$PageTransformer;
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {p0, p1, v0, v1}, setCurrentItemInternal(IZZ)V
    ...
    iput-object v0, p0, mRestoredAdapterState:Landroid/os/Parcelable;

    iget-object p1, p1, Lcom/oneplus/support/viewpager/widget/ViewPager$SavedState;->loader:Ljava/lang/ClassLoader;

    iput-object p1, p0, mRestoredClassLoader:Ljava/lang/ClassLoader;
...
.method protected onSizeChanged(IIII)V
    ...
    iget p2, p0, mPageMargin:I

    invoke-direct {p0, p1, p3, p2, p2}, recomputeScrollPosition(IIII)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget p1, p0, mCurItem:I

    invoke-direct {p0, p1, v1, v2, v2}, scrollToItem(IZIZ)V
    ...
    invoke-direct {p0, v1}, requestParentDisallowInterceptTouchEvent(Z)V

    iget v4, p0, mInitialMotionX:F
    ...
    :goto_0
    iput v4, p0, mLastMotionX:F

    iput v0, p0, mLastMotionY:F

    invoke-virtual {p0, v1}, setScrollState(I)V
    ...
    invoke-direct {p0, p1}, performDrag(F)Z
    ...
    iget v2, p0, mInitialMotionX:F

    sub-float/2addr p1, v2

    float-to-int p1, p1

    invoke-direct {p0, v6, v3, v0, p1}, determineTargetPage(IFII)I

    move-result p1

    invoke-virtual {p0, p1, v1, v1, v0}, setCurrentItemInternal(IZZI)V
...
.method populate(I)V
    ...
    iget v2, v0, mCurItem:I

    if-eq v2, v1, :cond_0

    invoke-virtual {v0, v2}, infoForPosition(I)Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;

    move-result-object v2

    iput v1, v0, mCurItem:I
    ...
    :cond_1
    iget-boolean v1, v0, mPopulatePending:Z
    ...
    iget v1, v0, mOffscreenPageLimit:I

    iget v4, v0, mCurItem:I
    ...
    iget-object v6, v0, mAdapter:Lcom/oneplus/support/viewpager/widget/PagerAdapter;
    ...
    iget v7, v0, mExpectedAdapterCount:I
    ...
    invoke-virtual {v0, v8, v7}, addNewItem(II)Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;
    ...
    iget-object v5, v0, mAdapter:Lcom/oneplus/support/viewpager/widget/PagerAdapter;
    ...
    invoke-virtual {v0, v14, v5}, addNewItem(II)Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;
    ...
    iget-object v12, v0, mAdapter:Lcom/oneplus/support/viewpager/widget/PagerAdapter;
    ...
    :cond_14
    invoke-virtual {v0, v11, v4}, addNewItem(II)Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;
    ...
    :cond_16
    :goto_c
    invoke-direct {v0, v8, v10, v2}, calculatePageOffsets(Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;ILcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;)V
    ...
    invoke-virtual {v0, v3}, infoForChild(Landroid/view/View;)Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;
    ...
    invoke-virtual {v0, v1}, infoForAnyChild(Landroid/view/View;)Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;
    ...
    invoke-virtual {v0, v2}, infoForChild(Landroid/view/View;)Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;
    ...
    iget v4, v0, mExpectedAdapterCount:I
    ...
    iget-object v0, v0, mAdapter:Lcom/oneplus/support/viewpager/widget/PagerAdapter;
...
.method public setAdapter(Lcom/oneplus/support/viewpager/widget/PagerAdapter;)V
    ...
    iget v3, p0, mRestoredCurItem:I

    invoke-virtual {p0, v3, v2, v4}, setCurrentItemInternal(IZZ)V
...
.method setCurrentItemInternal(IZZI)V
    ...
    iget-object p1, p0, mAdapter:Lcom/oneplus/support/viewpager/widget/PagerAdapter;
    ...
    invoke-direct {p0, p1, p2, p4, p3}, scrollToItem(IZIZ)V
...
.method smoothScrollTo(III)V
    ...
    iget-boolean v0, p0, mIsScrollStarted:Z
    ...
    invoke-virtual {p0, p1}, setScrollState(I)V
    ...
    invoke-virtual {p0, v0}, distanceInfluenceForSnapDuration(F)F
    ...
    :cond_5
    iget-object p2, p0, mAdapter:Lcom/oneplus/support/viewpager/widget/PagerAdapter;
    ...
    iput-boolean v1, p0, mIsScrollStarted:Z
...
.method protected verifyDrawable(Landroid/graphics/drawable/Drawable;)Z
    ...
    iget-object p0, p0, mMarginDrawable:Landroid/graphics/drawable/Drawable;
