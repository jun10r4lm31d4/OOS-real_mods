...
.method constructor <init>()V
    ...
    iput-boolean v0, p0, mIsFinishedScreenTuredOn:Z

    new-instance v1, Lcom/oneplus/plugin/OpPreventModeCtrl;

    invoke-direct {v1}, Lcom/oneplus/plugin/OpPreventModeCtrl;-><init>()V

    iput-object v1, p0, mPreventModeCtrl:Lcom/oneplus/plugin/OpPreventModeCtrl;

    const/4 v1, 0x1

    new-array v1, v1, [Lcom/oneplus/plugin/OpBaseCtrl;

    iget-object v2, p0, mPreventModeCtrl:Lcom/oneplus/plugin/OpPreventModeCtrl;

    aput-object v2, v1, v0

    iput-object v1, p0, mControls:[Lcom/oneplus/plugin/OpBaseCtrl;
...
.method static synthetic access$102(Lcom/oneplus/plugin/OpLsState;Z)Z
    ...
    iput-boolean p1, p0, mIsFinishedScreenTuredOn:Z
...
.method public static declared-synchronized getInstance()Lcom/oneplus/plugin/OpLsState;
    ...
    :try_start_0
    sget-object v1, sInstance:Lcom/oneplus/plugin/OpLsState;
    ...
    sput-object v1, sInstance:Lcom/oneplus/plugin/OpLsState;
...
.method public getFpAnimationCtrl()Lcom/oneplus/systemui/biometrics/OpFingerprintAnimationCtrl;
    ...
    iget-object p0, p0, mFingerprintAnimationCtrl:Lcom/oneplus/systemui/biometrics/OpFingerprintAnimationCtrl;
...
.method public getNonUILooper()Landroid/os/Looper;
    ...
    :try_start_0
    iget-object v0, p0, mNonUiLooper:Landroid/os/Looper;
    ...
    iput-object v0, p0, mNonUiLooper:Landroid/os/Looper;
...
.method public getPhoneStatusBar()Lcom/android/systemui/statusbar/phone/StatusBar;
    ...
    iget-object p0, p0, mPhonstatusBar:Lcom/android/systemui/statusbar/phone/StatusBar;
...
.method public getPreventModeCtrl()Lcom/oneplus/plugin/OpPreventModeCtrl;
    ...
    iget-object p0, p0, mPreventModeCtrl:Lcom/oneplus/plugin/OpPreventModeCtrl;
...
.method public init(Landroid/content/Context;Landroid/view/ViewGroup;Lcom/android/systemui/statusbar/phone/StatusBar;Lcom/android/systemui/statusbar/CommandQueue;)V
    ...
    iput-object p3, p0, mPhonstatusBar:Lcom/android/systemui/statusbar/phone/StatusBar;

    iput-object p4, p0, mCommandQueue:Lcom/android/systemui/statusbar/CommandQueue;

    iget-object p2, p0, mUpdateMonitor:Lcom/android/keyguard/KeyguardUpdateMonitor;

    invoke-virtual {p2}, Lcom/android/keyguard/KeyguardUpdateMonitor;->hasBootCompleted()Z

    const/4 p2, 0x1

    iput-boolean p2, p0, mInit:Z

    iput-object p1, p0, mContext:Landroid/content/Context;

    invoke-virtual {p0}, getNonUILooper()Landroid/os/Looper;

    iget-object p2, p0, mControls:[Lcom/oneplus/plugin/OpBaseCtrl;
...
.method public isFinishedScreenTuredOn()Z
    ...
    iget-boolean p0, p0, mIsFinishedScreenTuredOn:Z
...
.method public onScreenTurnedOn()V
    ...
    iget-object p0, p0, mControls:[Lcom/oneplus/plugin/OpBaseCtrl;
...
.method public onWallpaperChange(Landroid/graphics/Bitmap;)V
    ...
    iget-object v0, p0, mControls:[Lcom/oneplus/plugin/OpBaseCtrl;
...
.method public setFpAnimationCtrl(Lcom/oneplus/systemui/biometrics/OpFingerprintAnimationCtrl;)V
    ...
    iput-object p1, p0, mFingerprintAnimationCtrl:Lcom/oneplus/systemui/biometrics/OpFingerprintAnimationCtrl;
