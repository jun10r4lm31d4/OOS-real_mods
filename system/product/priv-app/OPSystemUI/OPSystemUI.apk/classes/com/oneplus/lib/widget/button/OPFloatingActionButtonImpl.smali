...
.method static constructor <clinit>()V
    ...
    sput-object v1, PRESSED_ENABLED_STATE_SET:[I

    new-array v0, v0, [I

    fill-array-data v0, :array_1

    sput-object v0, FOCUSED_ENABLED_STATE_SET:[I
...
.method constructor <init>(Lcom/oneplus/lib/widget/button/OPFloatingActionButton;Lcom/oneplus/lib/widget/button/OPShadowViewDelegate;)V
    ...
    iput-object p1, p0, mView:Lcom/oneplus/lib/widget/button/OPFloatingActionButton;

    iput-object p2, p0, mShadowViewDelegate:Lcom/oneplus/lib/widget/button/OPShadowViewDelegate;
    ...
    iget-object p1, p0, mView:Lcom/oneplus/lib/widget/button/OPFloatingActionButton;
...
.method static synthetic access$002(Lcom/oneplus/lib/widget/button/OPFloatingActionButtonImpl;Z)Z
    ...
    iput-boolean p1, p0, mIsHiding:Z
...
.method createBorderDrawable(ILandroid/content/res/ColorStateList;)Landroid/graphics/drawable/Drawable;
    ...
    iget-object p0, p0, mView:Lcom/oneplus/lib/widget/button/OPFloatingActionButton;
...
.method hide(Z)V
    ...
    iget-boolean v0, p0, mIsHiding:Z

    if-nez v0, :cond_3

    iget-object v0, p0, mView:Lcom/oneplus/lib/widget/button/OPFloatingActionButton;
...
.method setBackground(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;II)V
    ...
    iput-object p1, p0, mShapeDrawable:Landroid/graphics/drawable/Drawable;

    iget-object p1, p0, mShapeDrawable:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p5, p2}, createBorderDrawable(ILandroid/content/res/ColorStateList;)Landroid/graphics/drawable/Drawable;

    move-result-object p2

    iput-object p2, p0, mBorderDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, mBorderDrawable:Landroid/graphics/drawable/Drawable;

    aput-object v0, p5, p3

    const/4 v0, 0x1

    iget-object v1, p0, mShapeDrawable:Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    iput-object p1, p0, mBorderDrawable:Landroid/graphics/drawable/Drawable;

    iget-object p2, p0, mShapeDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iput-object p5, p0, mRippleDrawable:Landroid/graphics/drawable/RippleDrawable;

    iget-object p1, p0, mShadowViewDelegate:Lcom/oneplus/lib/widget/button/OPShadowViewDelegate;

    iget-object p2, p0, mRippleDrawable:Landroid/graphics/drawable/RippleDrawable;
    ...
    iget-object p0, p0, mShadowViewDelegate:Lcom/oneplus/lib/widget/button/OPShadowViewDelegate;
...
.method setBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v0, p0, mShapeDrawable:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v0, p1}, Landroid/graphics/drawable/Drawable;->setTintList(Landroid/content/res/ColorStateList;)V

    iget-object p0, p0, mBorderDrawable:Landroid/graphics/drawable/Drawable;
...
.method setBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iget-object p0, p0, mShapeDrawable:Landroid/graphics/drawable/Drawable;
...
.method setPressedTranslationZ(F)V
    ...
    sget-object v1, PRESSED_ENABLED_STATE_SET:[I

    iget-object v2, p0, mView:Lcom/oneplus/lib/widget/button/OPFloatingActionButton;
    ...
    invoke-direct {p0, v2}, setupAnimator(Landroid/animation/Animator;)Landroid/animation/Animator;

    invoke-virtual {v0, v1, v2}, Landroid/animation/StateListAnimator;->addState([ILandroid/animation/Animator;)V

    sget-object v1, FOCUSED_ENABLED_STATE_SET:[I
    ...
    invoke-direct {p0, p1}, setupAnimator(Landroid/animation/Animator;)Landroid/animation/Animator;

    invoke-virtual {v0, v1, p1}, Landroid/animation/StateListAnimator;->addState([ILandroid/animation/Animator;)V

    sget-object p1, EMPTY_STATE_SET:[I

    iget-object v1, p0, mView:Lcom/oneplus/lib/widget/button/OPFloatingActionButton;
    ...
    invoke-direct {p0, v1}, setupAnimator(Landroid/animation/Animator;)Landroid/animation/Animator;
