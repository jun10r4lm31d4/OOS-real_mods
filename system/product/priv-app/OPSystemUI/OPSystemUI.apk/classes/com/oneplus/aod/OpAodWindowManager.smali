...
.method public constructor <init>(Landroid/content/Context;Landroid/widget/RelativeLayout;)V
    ...
    iput-object v0, p0, mSettingsOberver:Lcom/oneplus/aod/OpAodWindowManager$SettingObserver;
    ...
    iput-object v0, p0, mMdmReadyReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v0, p0, mUpdateCallback:Lcom/android/keyguard/KeyguardUpdateMonitorCallback;
    ...
    iput-object v0, p0, mRemoveWindow:Ljava/lang/Runnable;

    iput-object p1, p0, mContext:Landroid/content/Context;

    iput-object p2, p0, mAodWindowView:Landroid/widget/RelativeLayout;
    ...
    iput-object v0, p0, mPm:Landroid/os/IPowerManager;

    invoke-static {}, Lcom/oneplus/plugin/OpLsState;->getInstance()Lcom/oneplus/plugin/OpLsState;

    move-result-object v0

    iput-object v0, p0, mLSState:Lcom/oneplus/plugin/OpLsState;

    iget-object v0, p0, mSettingsOberver:Lcom/oneplus/aod/OpAodWindowManager$SettingObserver;
    ...
    iput-object v0, p0, mStatusBarWindowController:Lcom/android/systemui/statusbar/phone/StatusBarWindowController;
    ...
    iput-object p1, p0, mAodContainer:Landroid/view/View;
    ...
    iget-object p0, p0, mMdmReadyReceiver:Landroid/content/BroadcastReceiver;
...
.method static synthetic access$100(Lcom/oneplus/aod/OpAodWindowManager;)Landroid/content/Context;
    .locals 0
...
.method static synthetic access$200(Lcom/oneplus/aod/OpAodWindowManager;)Lcom/android/systemui/statusbar/phone/BiometricUnlockController;
    .locals 0

    iget-object p0, p0, mUnlockController:Lcom/android/systemui/statusbar/phone/BiometricUnlockController;

    return-object p0
.end method

.method static synthetic access$300(Lcom/oneplus/aod/OpAodWindowManager;)Z
    .locals 0

    iget-boolean p0, p0, mIsWakeAndUnlock:Z

    return p0
.end method

.method static synthetic access$302(Lcom/oneplus/aod/OpAodWindowManager;Z)Z
    .locals 0

    iput-boolean p1, p0, mIsWakeAndUnlock:Z

    return p1
.end method

.method static synthetic access$402(Lcom/oneplus/aod/OpAodWindowManager;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
...
.method static synthetic access$500(Lcom/oneplus/aod/OpAodWindowManager;)Lcom/android/keyguard/KeyguardUpdateMonitor;
    .locals 0
...
.method static synthetic access$600(Lcom/oneplus/aod/OpAodWindowManager;)V
    .locals 0

    invoke-direct {p0}, removeAodWindow()V

    return-void
.end method

.method static synthetic access$700(Lcom/oneplus/aod/OpAodWindowManager;)Lcom/oneplus/aod/OpAodWindowManager$SettingObserver;
    .locals 0

    iget-object p0, p0, mSettingsOberver:Lcom/oneplus/aod/OpAodWindowManager$SettingObserver;
...
.method private removeAodWindow()V
    ...
    iget-boolean v0, p0, mIsWindowRemoved:Z
    ...
    iget-object v1, p0, mAodWindowView:Landroid/widget/RelativeLayout;

    invoke-interface {v0, v1}, Landroid/view/WindowManager;->removeViewImmediate(Landroid/view/View;)V

    const/4 v0, 0x1

    iput-boolean v0, p0, mIsWindowRemoved:Z
...
.method public getAodDisappearAnimation()Landroid/animation/AnimatorSet;
    ...
    iget-object v2, p0, mAodContainer:Landroid/view/View;
    ...
    iget-object v3, p0, mAodContainer:Landroid/view/View;
    ...
    new-instance v1, Lcom/oneplus/aod/OpAodWindowManager$4;

    invoke-direct {v1, p0}, Lcom/oneplus/aod/OpAodWindowManager$4;-><init>(Lcom/oneplus/aod/OpAodWindowManager;)V
...
.method public startDozing()V
    ...
    :cond_0
    iget-object v1, p0, mUnlockController:Lcom/android/systemui/statusbar/phone/BiometricUnlockController;

    if-nez v1, :cond_1

    iget-object v1, p0, mLSState:Lcom/oneplus/plugin/OpLsState;
    ...
    iput-object v1, p0, mUnlockController:Lcom/android/systemui/statusbar/phone/BiometricUnlockController;

    :cond_1
    const/4 v1, 0x1

    iput-boolean v1, p0, mDozing:Z

    const/4 v1, 0x0

    iput-boolean v1, p0, mIsWakeAndUnlock:Z

    const/4 v2, 0x0

    iput-object v2, p0, mWakingUpReason:Ljava/lang/String;

    iget-object v2, p0, mAodWindowView:Landroid/widget/RelativeLayout;
    ...
    iget-object v3, p0, mRemoveWindow:Ljava/lang/Runnable;
    ...
    invoke-direct {p0}, getAodViewLayoutParams()Landroid/view/WindowManager$LayoutParams;
    ...
    :goto_0
    iput-boolean v1, p0, mIsWindowRemoved:Z

    iget-object v0, p0, mAodWindowView:Landroid/widget/RelativeLayout;
    ...
    iget-object p0, p0, mAodWindowView:Landroid/widget/RelativeLayout;
...
.method public stopDozing()V
    ...
    iget-boolean v3, p0, mIsWakeAndUnlock:Z
    ...
    iget-object v4, p0, mWakingUpReason:Ljava/lang/String;
    ...
    iget-object v3, p0, mWakingUpReason:Ljava/lang/String;
    ...
    :cond_5
    :goto_1
    iget-object v3, p0, mAodWindowView:Landroid/widget/RelativeLayout;
    ...
    iget-object p0, p0, mRemoveWindow:Ljava/lang/Runnable;
