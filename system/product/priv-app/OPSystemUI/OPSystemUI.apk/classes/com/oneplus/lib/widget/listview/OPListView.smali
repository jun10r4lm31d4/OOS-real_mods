...
.method static synthetic access$000(Lcom/oneplus/lib/widget/listview/OPListView;)Ljava/util/ArrayList;
    ...
    iget-object p0, p0, mDelViewList:Ljava/util/ArrayList;
...
.method static synthetic access$400(Lcom/oneplus/lib/widget/listview/OPListView;)Ljava/util/ArrayList;
    ...
    iget-object p0, p0, mDelPosList:Ljava/util/ArrayList;
...
.method static synthetic access$500(Lcom/oneplus/lib/widget/listview/OPListView;)Ljava/util/ArrayList;
    ...
    iget-object p0, p0, mDelOriViewTopList:Ljava/util/ArrayList;
...
.method static synthetic access$600(Lcom/oneplus/lib/widget/listview/OPListView;)Lcom/oneplus/lib/widget/listview/OPListView$DeleteAnimationListener;
    ...
    iget-object p0, p0, mDeleteAnimationListener:Lcom/oneplus/lib/widget/listview/OPListView$DeleteAnimationListener;
...
.method static synthetic access$800(Lcom/oneplus/lib/widget/listview/OPListView;)Ljava/util/ArrayList;
    ...
    iget-object p0, p0, mNowViewList:Ljava/util/ArrayList;
...
.method private getAnimator(ILandroid/view/View;F)Landroid/animation/ObjectAnimator;
    ...
    iget-object v0, p0, mAnimatorList:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, mAnimatorList:Ljava/util/ArrayList;
...
.method private getDividerType(I)I
    ...
    iget-object p0, p0, mDividerController:Lcom/oneplus/lib/widget/listview/IOPDividerController;
...
.method private init(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-virtual {p0, p2}, setDivider(Landroid/graphics/drawable/Drawable;)V
    ...
    iget p2, p0, mDividerHeight:I

    invoke-virtual {p0, p2}, Landroid/widget/ListView;->setDividerHeight(I)V

    invoke-virtual {p0, v0}, setFooterDividersEnabled(Z)V
...
.method private isClipToPadding()Z
    ...
    iget-boolean p0, p0, mIsClipToPadding:Z
...
.method private setDelViewLocation()V
    ...
    iget-object v7, p0, mNowViewList:Ljava/util/ArrayList;
    ...
    iput-object v7, p0, mNowViewList:Ljava/util/ArrayList;
    ...
    iget-object v10, p0, mNowViewList:Ljava/util/ArrayList;
    ...
    :cond_4
    iget-boolean v7, p0, mOriLastPage:Z
    ...
    iget v0, p0, mOriUpperDeleteCount:I
    ...
    :goto_4
    iget v1, p0, mOriUpperDeleteCount:I

    if-ge v0, v1, :cond_19

    iget-object v1, p0, mDelOriViewTopList:Ljava/util/ArrayList;
    ...
    :cond_8
    iget v2, p0, mOriCurDeleteCount:I

    if-nez v2, :cond_a

    iget v2, p0, mOriCurLeftCount:I
    ...
    :cond_c
    iget v0, p0, mOriCurDeleteCount:I
    ...
    :goto_6
    iget v2, p0, mOriBelowLeftCount:I

    if-ge v0, v2, :cond_f

    iget-object v2, p0, mDelOriViewTopList:Ljava/util/ArrayList;
    ...
    iget-object v7, p0, mDelOriViewTopList:Ljava/util/ArrayList;
    ...
    :cond_11
    iget v2, p0, mOriUpperDeleteCount:I
    ...
    iget-object v1, p0, mNowViewList:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, mNowViewList:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, mNowViewList:Ljava/util/ArrayList;

    invoke-virtual {v3}, Ljava/util/ArrayList;->clear()V

    iget-object v3, p0, mDelOriViewTopList:Ljava/util/ArrayList;
    ...
    :goto_11
    iget-object v6, p0, mNowViewList:Ljava/util/ArrayList;
    ...
    iget-object v6, p0, mDelOriViewTopList:Ljava/util/ArrayList;
...
.method private shouldDrawDivider(I)Z
    ...
    invoke-direct {p0, p1}, getDividerType(I)I
...
.method private startDelDropAnimation()V
    ...
    invoke-direct {p0, v1, v2, v4}, getAnimator(ILandroid/view/View;F)Landroid/animation/ObjectAnimator;
    ...
    iget-object v3, p0, mDecelerateInterpolator:Landroid/view/animation/DecelerateInterpolator;

    invoke-virtual {v2, v3}, Landroid/animation/ObjectAnimator;->setInterpolator(Landroid/animation/TimeInterpolator;)V

    iget-object v3, p0, mAnimatorUpdateListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    iget-object p0, p0, mDelAniSet:Landroid/animation/AnimatorSet;
...
.method protected dispatchDraw(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v12, v0, mFooterDividersEnabled:Z
    ...
    invoke-virtual {v0, v1, v7, v5}, drawDivider(Landroid/graphics/Canvas;Landroid/graphics/Rect;I)V
    ...
    invoke-direct {v0, v4}, shouldDrawDivider(I)Z
    ...
    :cond_1a
    iget-boolean v1, v0, mDelAnimationFlag:Z
    ...
    iput-boolean v1, v0, mDelAnimationFlag:Z
...
.method drawDivider(Landroid/graphics/Canvas;Landroid/graphics/Rect;I)V
    ...
    invoke-direct {p0, p3}, getDividerType(I)I

    move-result p3

    iget-object v1, p0, mDividerController:Lcom/oneplus/lib/widget/listview/IOPDividerController;
