...
.method static constructor <clinit>()V
    ...
    sput v0, AUTHENTICATE_FINGERPRINT:I
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, mIgnoreHandleShow:Z

    sget v1, AUTHENTICATE_IGNORE:I

    iput v1, p0, mAuthenticatingType:I

    iput-boolean v0, p0, mSettingShowing:Z

    iput-boolean v0, p0, mPendingHidePanel:Z

    const/4 v0, 0x1

    iput v0, p0, mLastAlpha:I
...
.method public changePanelAlpha(II)V
    ...
    invoke-virtual {p0}, isScreenOffAuthenticating()Z
    ...
    iget v0, p0, mAuthenticatingType:I
    ...
    iget p2, p0, mAuthenticatingType:I
    ...
    iget-object p2, p0, mStatusBar:Lcom/android/systemui/statusbar/phone/StatusBar;

    int-to-float v0, p1

    const/4 v1, 0x0

    iget v2, p0, mAuthenticatingType:I
...
.method public isScreenOffAuthenticating()Z
    ...
    iget p0, p0, mAuthenticatingType:I
...
.method public notifyPreventModeChange(Z)V
    ...
    invoke-direct {p0}, getKeyguardStateCallback()Ljava/util/ArrayList;
...
.method public notifyScreenOffAuthenticate(ZI)V
    ...
    invoke-virtual {p0, p1, p2, v0}, notifyScreenOffAuthenticate(ZII)V
...
.method public notifyScreenOffAuthenticate(ZII)V
    ...
    iget v1, p0, mAuthenticatingType:I
    ...
    :cond_0
    iput p2, p0, mAuthenticatingType:I

    goto :goto_0

    :cond_1
    sget-boolean v2, IS_CUSTOM_FINGERPRINT:Z

    if-eqz v2, :cond_2

    iget v2, p0, mAuthenticatingType:I

    sget v3, AUTHENTICATE_FACEUNLOCK:I
    ...
    iput v0, p0, mAuthenticatingType:I
...
.method public onWakeAndUnlocking(Z)V
    ...
    invoke-direct {p0}, onWakeAndUnlocking()V
    ...
    invoke-virtual {p0, p1, v0}, changePanelAlpha(II)V
    ...
    iput-boolean p1, p0, mPendingHidePanel:Z
...
.method protected opHandleHide()V
    ...
    iget-boolean v0, p0, mSettingShowing:Z
    ...
    invoke-direct {p0}, getHandler()Lcom/oneplus/systemui/keyguard/OpKeyguardViewMediator$OpHandler;

    move-result-object v0

    invoke-direct {p0}, getKeyguardGoingAwayRunnableRunnable()Ljava/lang/Runnable;
    ...
    :goto_0
    iget-boolean v0, p0, mPendingHidePanel:Z
    ...
    sget v1, AUTHENTICATE_FINGERPRINT:I

    invoke-virtual {p0, v0, v1}, changePanelAlpha(II)V
