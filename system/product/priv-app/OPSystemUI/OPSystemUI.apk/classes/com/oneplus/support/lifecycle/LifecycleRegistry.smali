...
.method private calculateTargetState(Lcom/oneplus/support/lifecycle/LifecycleObserver;)Lcom/oneplus/support/lifecycle/Lifecycle$State;
    ...
    :cond_1
    iget-object p0, p0, mState:Lcom/oneplus/support/lifecycle/Lifecycle$State;

    invoke-static {p0, p1}, min(Lcom/oneplus/support/lifecycle/Lifecycle$State;Lcom/oneplus/support/lifecycle/Lifecycle$State;)Lcom/oneplus/support/lifecycle/Lifecycle$State;

    move-result-object p0

    invoke-static {p0, v0}, min(Lcom/oneplus/support/lifecycle/Lifecycle$State;Lcom/oneplus/support/lifecycle/Lifecycle$State;)Lcom/oneplus/support/lifecycle/Lifecycle$State;
...
.method private moveToState(Lcom/oneplus/support/lifecycle/Lifecycle$State;)V
    ...
    iget-boolean p1, p0, mHandlingEvent:Z

    const/4 v0, 0x1

    if-nez p1, :cond_2

    iget p1, p0, mAddingObserverCounter:I
    ...
    iput-boolean p1, p0, mHandlingEvent:Z
...
.method private popParentState()V
    ...
    iget-object p0, p0, mParentStates:Ljava/util/ArrayList;
...
.method public addObserver(Lcom/oneplus/support/lifecycle/LifecycleObserver;)V
    ...
    :cond_1
    iget-object v1, p0, mLifecycleOwner:Ljava/lang/ref/WeakReference;
    ...
    :cond_2
    iget v2, p0, mAddingObserverCounter:I

    const/4 v3, 0x1

    if-nez v2, :cond_4

    iget-boolean v2, p0, mHandlingEvent:Z
    ...
    iget v5, p0, mAddingObserverCounter:I

    add-int/2addr v5, v3

    iput v5, p0, mAddingObserverCounter:I
    ...
    iget-object v4, p0, mObserverMap:Lcom/oneplus/support/collection/FastSafeIterableMap;
    ...
    invoke-static {v4}, upEvent(Lcom/oneplus/support/lifecycle/Lifecycle$State;)Lcom/oneplus/support/lifecycle/Lifecycle$Event;
    ...
    iput p1, p0, mAddingObserverCounter:I
...
.method public removeObserver(Lcom/oneplus/support/lifecycle/LifecycleObserver;)V
    ...
    iget-object p0, p0, mObserverMap:Lcom/oneplus/support/collection/FastSafeIterableMap;
