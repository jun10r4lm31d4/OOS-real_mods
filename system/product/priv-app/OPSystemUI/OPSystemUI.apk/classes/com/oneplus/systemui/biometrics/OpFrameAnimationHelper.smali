...
.method public constructor <init>(Landroid/widget/ImageView;[IJII)V
    ...
    iput-object v0, p0, mFrames:[I

    const/4 v1, 0x0

    iput v1, p0, mOrder:I

    iput v1, p0, mPlayFrameNum:I

    iput-object v0, p0, mCallback:Lcom/oneplus/systemui/biometrics/OpFrameAnimationHelper$Callbacks;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v0, p0, mStop:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v0, p0, runnable:Ljava/lang/Runnable;

    iput-object p1, p0, mAnimationView:Landroid/widget/ImageView;
    ...
    :goto_0
    iput-wide p3, p0, mAnimPostDelayTime:J

    iput-object p2, p0, mFrames:[I

    iget-object p1, p0, mFrames:[I
    ...
    const-string p2, "FrameAnimationHelper"

    invoke-static {p2, p1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    iput p5, p0, mStartFrameIndex:I

    iput p6, p0, mPlayFrameNum:I
...
.method static synthetic access$100(Lcom/oneplus/systemui/biometrics/OpFrameAnimationHelper;)Ljava/lang/Runnable;
    ...
    iget-object p0, p0, runnable:Ljava/lang/Runnable;
...
.method static synthetic access$400(Lcom/oneplus/systemui/biometrics/OpFrameAnimationHelper;)Lcom/oneplus/systemui/biometrics/OpFrameAnimationHelper$Callbacks;
    ...
    iget-object p0, p0, mCallback:Lcom/oneplus/systemui/biometrics/OpFrameAnimationHelper$Callbacks;
...
.method static synthetic access$402(Lcom/oneplus/systemui/biometrics/OpFrameAnimationHelper;Lcom/oneplus/systemui/biometrics/OpFrameAnimationHelper$Callbacks;)Lcom/oneplus/systemui/biometrics/OpFrameAnimationHelper$Callbacks;
    ...
    iput-object p1, p0, mCallback:Lcom/oneplus/systemui/biometrics/OpFrameAnimationHelper$Callbacks;
...
.method public isAnimationRunning()Z
    ...
    iget-boolean p0, p0, mAnimationRunning:Z
...
.method public prepareResource()V
    ...
    iget-object v0, p0, mAnimationView:Landroid/widget/ImageView;
    ...
    iget-object v0, p0, mBitmapArray:[Landroid/graphics/Bitmap;

    if-nez v0, :cond_1

    iget v0, p0, mPlayFrameNum:I

    new-array v0, v0, [Landroid/graphics/Bitmap;

    iput-object v0, p0, mBitmapArray:[Landroid/graphics/Bitmap;

    :cond_1
    iget-object v0, p0, mStop:Ljava/util/concurrent/atomic/AtomicBoolean;

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Ljava/util/concurrent/atomic/AtomicBoolean;->set(Z)V

    invoke-virtual {p0}, startExecutor()V
...
.method public resetResource()V
    ...
    :goto_0
    iget-object v2, p0, mBitmapArray:[Landroid/graphics/Bitmap;
    ...
    :cond_1
    iget-object v0, p0, mExecutorService:Ljava/util/concurrent/ExecutorService;
    ...
    iput-object v2, p0, mExecutorService:Ljava/util/concurrent/ExecutorService;

    :cond_2
    iput-object v2, p0, mBitmapArray:[Landroid/graphics/Bitmap;

    iget-object v0, p0, mAnimationView:Landroid/widget/ImageView;

    iget-object v3, p0, runnable:Ljava/lang/Runnable;

    invoke-virtual {v0, v3}, Landroid/widget/ImageView;->removeCallbacks(Ljava/lang/Runnable;)Z

    iput-object v2, p0, mAnimationView:Landroid/widget/ImageView;

    iput-boolean v1, p0, mAnimationRunning:Z
...
.method public start(Z)V
    ...
    invoke-virtual {p0}, prepareResource()V
    ...
    iget-object p1, p0, mAnimationView:Landroid/widget/ImageView;
...
.method public startExecutor()V
    ...
    iput-object v0, p0, mExecutorService:Ljava/util/concurrent/ExecutorService;
...
.method public stop()V
    ...
    iget-object v1, p0, mAnimationView:Landroid/widget/ImageView;

    if-eqz v1, :cond_1

    iput v0, p0, mOrder:I

    iput-boolean v0, p0, mLoop:Z

    const/4 v0, 0x0

    iput-object v0, p0, mCallback:Lcom/oneplus/systemui/biometrics/OpFrameAnimationHelper$Callbacks;

    iget-object v2, p0, runnable:Ljava/lang/Runnable;
    ...
    iget-object p0, p0, mAnimationView:Landroid/widget/ImageView;
...
.method public waitAnimationFinished(Lcom/oneplus/systemui/biometrics/OpFrameAnimationHelper$Callbacks;)V
    ...
    iget-object p1, p0, mCallback:Lcom/oneplus/systemui/biometrics/OpFrameAnimationHelper$Callbacks;
