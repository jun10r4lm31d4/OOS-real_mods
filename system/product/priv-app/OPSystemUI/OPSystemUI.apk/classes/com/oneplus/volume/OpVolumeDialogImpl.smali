...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mOutputChooserLock:Ljava/lang/Object;
    ...
    iput v0, p0, mThemeColorDialogBackground:I

    iput v0, p0, mThemeColorDialogRowContainerBackground:I

    iput v0, p0, mThemeColorText:I

    iput v0, p0, mThemeColorIcon:I

    iput v0, p0, mThemeColorSeekbarBackgroundDrawable:I

    iput v0, p0, mThemeButtonBg:I

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, mRows:Ljava/util/List;

    const/4 v1, 0x1

    iput-boolean v1, p0, mPendingInit:Z

    iput-boolean v1, p0, mFirstTimeInitDialog:Z

    iput-boolean v0, p0, mOpLastforceExpandState:Z

    iput-boolean v0, p0, mOpForceExpandState:Z

    iput-boolean v1, p0, mIsExpandAnimDone:Z
    ...
    iput-object v0, p0, mHandler:Lcom/oneplus/volume/OpVolumeDialogImpl$OpHandler;
    ...
    iput-object v0, p0, mOutputChooserCallback:Lcom/oneplus/volume/OpOutputChooser$OutputChooserCallback;
...
.method static synthetic access$000(Lcom/oneplus/volume/OpVolumeDialogImpl;I)V
    ...
    invoke-direct {p0, p1}, setDialogWidthH(I)V
...
.method static synthetic access$100(Lcom/oneplus/volume/OpVolumeDialogImpl;)Ljava/lang/Object;
    ...
    iget-object p0, p0, mOutputChooserLock:Ljava/lang/Object;
...
.method private applyColors()V
    ...
    iget-object v0, p0, mDialogUpper:Landroid/view/ViewGroup;

    iget v1, p0, mThemeColorDialogBackground:I

    invoke-direct {p0, v1}, getCornerGradientDrawable(I)Landroid/graphics/drawable/GradientDrawable;

    move-result-object v1

    invoke-virtual {v0, v1}, Landroid/view/ViewGroup;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V

    iget-object v0, p0, mDialogLower:Landroid/view/ViewGroup;
    ...
    iget-object v0, p0, mDialogRowContainer:Landroid/view/ViewGroup;

    iget v1, p0, mThemeColorDialogRowContainerBackground:I
    ...
    iget-object v0, p0, mODICaptionsView:Landroid/view/ViewGroup;
    ...
    invoke-direct {p0}, getSettingsIcon()Landroid/widget/ImageButton;

    move-result-object v0

    iget v1, p0, mThemeColorIcon:I

    invoke-virtual {v0, v1}, Landroid/widget/ImageButton;->setColorFilter(I)V

    invoke-direct {p0}, getSettingsBackIcon()Landroid/widget/ImageButton;
    ...
    invoke-direct {p0}, getSettingsOpSettingsIcon()Landroid/widget/ImageButton;
    ...
    invoke-direct {p0}, getODICaptionsIcon()Landroid/widget/ImageButton;
    ...
    iget-object v0, p0, mConnectedDevice:Landroid/widget/TextView;

    iget v1, p0, mThemeColorText:I

    invoke-virtual {v0, v1}, Landroid/widget/TextView;->setTextColor(I)V

    iget-object v0, p0, mOutputChooser:Landroid/widget/ImageButton;
    ...
    iget-object v0, p0, mOutputChooserBackgroundView:Landroid/view/View;
    ...
    iget-object v0, p0, mOutputChooserExpandIcon:Landroid/widget/ImageView;

    iget v1, p0, mThemeColorIcon:I

    invoke-virtual {v0, v1}, Landroid/widget/ImageView;->setColorFilter(I)V

    iget-object v0, p0, mOutputChooserExpandEditText:Landroid/widget/EditText;

    iget v1, p0, mThemeColorIcon:I

    invoke-virtual {v0, v1}, Landroid/widget/EditText;->setTextColor(I)V

    iget-object v0, p0, mOutputChooserExpandTextView:Landroid/widget/TextView;

    iget v1, p0, mThemeColorIcon:I

    invoke-virtual {v0, v1}, Landroid/widget/TextView;->setTextColor(I)V

    iget-object v0, p0, mRows:Ljava/util/List;
    ...
    invoke-direct {p0, v1, v2, v2}, updateVolumeRowTintH(Lcom/oneplus/volume/OpVolumeDialogImpl$VolumeRow;ZZ)V
...
.method private getCornerGradientDrawable(I)Landroid/graphics/drawable/GradientDrawable;
    ...
    invoke-direct {p0, v0}, getVolCornerRadii(Landroid/content/Context;)[F
...
.method private isAccentColorChanged(IZ)Z
    ...
    iget p2, p0, mAccentColor:I

    if-eq p2, p1, :cond_0

    iput p1, p0, mAccentColor:I
...
.method private setDialogWidthH(I)V
    ...
    invoke-direct {p0}, getDialog()Lcom/android/systemui/volume/VolumeDialogImpl$CustomDialog;
    ...
    invoke-direct {p0}, getDialogView()Landroid/view/ViewGroup;
...
.method protected applyAndroidTheme()V
    ...
    iput v1, p0, mThemeColorDialogBackground:I

    sget v1, Lcom/android/systemui/R$drawable;->volume_dialog_row_container_bg_light:I

    iput v1, p0, mThemeColorDialogRowContainerBackground:I
    ...
    iput v1, p0, mThemeColorIcon:I

    sget v1, Lcom/android/systemui/R$drawable;->volume_dialog_progress_light:I

    iput v1, p0, mThemeColorSeekbarBackgroundDrawable:I
...
.method protected applyColorTheme(Z)V
    ...
    invoke-direct {p0, v0, p1}, isAccentColorChanged(IZ)Z
    ...
    invoke-virtual {p0}, applyWhiteTheme()V

    goto :goto_0

    :cond_1
    invoke-virtual {p0}, applyAndroidTheme()V

    goto :goto_0

    :cond_2
    invoke-virtual {p0}, applyBlackTheme()V
...
.method protected changeEditTextAndTextViewForMarquee(Z)V
    ...
    iget-object p1, p0, mOutputChooserExpandEditText:Landroid/widget/EditText;

    invoke-virtual {p1, v0}, Landroid/widget/EditText;->setVisibility(I)V

    iget-object p0, p0, mOutputChooserExpandTextView:Landroid/widget/TextView;
...
.method protected generateOutputChooserH()V
    ...
    iput-object v0, p0, mOutputChooserDialog:Lcom/oneplus/volume/OpOutputChooserDialog;
...
.method public synthetic lambda$setViewVisibleGoneFadeInOutAnim$1$OpVolumeDialogImpl(ZLandroid/view/View;Landroid/widget/LinearLayout;)V
    ...
    invoke-virtual {p0, p1}, changeEditTextAndTextViewForMarquee(Z)V
...
.method protected loadOpDimens()V
    ...
    iput v0, p0, mOpBeforeExpandWidth:I
    ...
    iput v1, p0, mOpafterExpandWidth:I
...
.method protected setDialogWidth(I)V
    ...
    iget-object v0, p0, mHandler:Lcom/oneplus/volume/OpVolumeDialogImpl$OpHandler;

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Landroid/os/Handler;->removeMessages(I)V

    iget-object p0, p0, mHandler:Lcom/oneplus/volume/OpVolumeDialogImpl$OpHandler;
...
.method protected setExpandFeautureDismissState()V
    ...
    invoke-virtual {p0, v0, v1}, setOpOutputChooserVisible(ZZ)V

    invoke-direct {p0}, initSettingsH()V

    iget-object v0, p0, mOpOutputChooser:Lcom/oneplus/volume/OpOutputChooser;
    ...
    iput-object v0, p0, mOpOutputChooser:Lcom/oneplus/volume/OpOutputChooser;
...
.method protected setOpOutputChooserGravityNeedBeforeAnimStart(Z)V
    ...
    iget-object p0, p0, mOutputChooser:Landroid/widget/ImageButton;
...
.method protected setOpOutputChooserVisible(Z)V
    ...
    invoke-virtual {p0, p1, v0}, setOpOutputChooserVisible(ZZ)V
...
.method protected setOpOutputChooserVisible(ZZ)V
    ...
    iget-boolean v1, p0, mOpForceExpandState:Z
    ...
    iget-object p1, p0, mOutputChooserExpandIcon:Landroid/widget/ImageView;

    iget-object v4, p0, mDeviceInfo:Lcom/oneplus/volume/OpVolumeDialogImpl$DeviceInfo;
    ...
    iget-object p1, p0, mOutputChooserExpandTextView:Landroid/widget/TextView;
    ...
    iget-object p1, p0, mOutputChooser:Landroid/widget/ImageButton;
    ...
    invoke-direct {p0, p1, v2}, setViewVisibleGoneFadeInOutAndScaleAnim(Landroid/view/View;Z)V

    iget-object p1, p0, mOutputChooser:Landroid/widget/ImageButton;

    invoke-direct {p0, p1, v3}, setViewVisibleGoneFadeInOutAndScaleAnim(Landroid/view/View;Z)V

    iget-object p1, p0, mOutputChooserExpandEditText:Landroid/widget/EditText;

    invoke-direct {p0, p1, v2, v0}, setViewVisibleGoneFadeInOutAnim(Landroid/view/View;ZLandroid/widget/LinearLayout;)V
    ...
    invoke-direct {p0, p1, v3, v0}, setViewVisibleGoneFadeInOutAnim(Landroid/view/View;ZLandroid/widget/LinearLayout;)V
...
.method protected showOutputChooserH()V
    ...
    iget-object v0, p0, mOutputChooserLock:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, mOutputChooserDialog:Lcom/oneplus/volume/OpOutputChooserDialog;
    ...
    invoke-virtual {p0}, generateOutputChooserH()V
...
.method protected updateODIRelatedLayout()V
    ...
    invoke-virtual {v1, v3, v2, v4, v3}, Landroid/view/ViewGroup;->setPadding(IIII)V
    ...
    :cond_2
    iget-object v3, p0, mODICaptionsView:Landroid/view/ViewGroup;

    const/4 v4, 0x0

    if-eqz v3, :cond_4

    iget-object v3, p0, mDialogUpper:Landroid/view/ViewGroup;
    ...
    :cond_4
    invoke-direct {p0}, getSettingsView()Landroid/view/View;
    ...
    :cond_5
    invoke-direct {p0}, getSettingsBackView()Landroid/view/View;
    ...
    :cond_6
    invoke-direct {p0}, getSettingsOpSettingsView()Landroid/view/View;
    ...
    iget-object v1, p0, mRows:Ljava/util/List;
