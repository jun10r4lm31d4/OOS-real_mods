...
.method static constructor <clinit>()V
    ...
    sput-object v1, HOURS_NUMBERS:[I

    new-array v1, v0, [I

    fill-array-data v1, :array_1

    sput-object v1, HOURS_NUMBERS_24:[I

    new-array v1, v0, [I

    fill-array-data v1, :array_2

    sput-object v1, MINUTES_NUMBERS:[I

    const/4 v1, 0x4

    new-array v1, v1, [I

    sput-object v1, SECOND_MINUTES_NUMBERS:[I

    const/16 v1, 0x169

    new-array v1, v1, [I

    sput-object v1, SNAP_PREFER_30S_MAP:[I

    new-array v1, v0, [F

    sput-object v1, COS_30:[F

    new-array v1, v0, [F

    sput-object v1, SIN_30:[F
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object v0, p0, HOURS_TO_MINUTES:Landroid/util/FloatProperty;

    const/16 v0, 0xc

    new-array v1, v0, [Ljava/lang/String;

    iput-object v1, p0, mHours12Texts:[Ljava/lang/String;

    new-array v1, v0, [Ljava/lang/String;

    iput-object v1, p0, mOuterHours24Texts:[Ljava/lang/String;

    new-array v1, v0, [Ljava/lang/String;

    iput-object v1, p0, mInnerHours24Texts:[Ljava/lang/String;

    new-array v1, v0, [Ljava/lang/String;

    iput-object v1, p0, mMinutesTexts:[Ljava/lang/String;
    ...
    iput-object v2, p0, mPaintCenter:Landroid/graphics/Paint;

    const/4 v2, 0x3

    new-array v3, v2, [Landroid/graphics/Paint;

    iput-object v3, p0, mPaintSelector:[Landroid/graphics/Paint;

    new-instance v3, Landroid/graphics/Paint;

    invoke-direct {v3}, Landroid/graphics/Paint;-><init>()V

    iput-object v3, p0, mPaintBackground:Landroid/graphics/Paint;

    new-array v3, v2, [Landroid/content/res/ColorStateList;

    iput-object v3, p0, mTextColor:[Landroid/content/res/ColorStateList;

    new-array v3, v2, [I

    iput-object v3, p0, mTextSize:[I

    new-array v2, v2, [I

    iput-object v2, p0, mTextInset:[I
    ...
    iput-object v2, p0, mOuterTextX:[[F
    ...
    iput-object v2, p0, mOuterTextY:[[F

    new-array v2, v0, [F

    iput-object v2, p0, mInnerTextX:[F

    new-array v2, v0, [F

    iput-object v2, p0, mInnerTextY:[F

    new-array v2, v1, [I

    iput-object v2, p0, mSelectionDegrees:[I

    new-instance v2, Landroid/graphics/Path;

    invoke-direct {v2}, Landroid/graphics/Path;-><init>()V

    iput-object v2, p0, mSelectorPath:Landroid/graphics/Path;

    const/4 v2, 0x1

    iput-boolean v2, p0, mInputEnabled:Z

    new-instance v3, Landroid/graphics/RectF;

    invoke-direct {v3}, Landroid/graphics/RectF;-><init>()V

    iput-object v3, p0, oval:Landroid/graphics/RectF;

    const/4 v3, 0x0

    iput-boolean v3, p0, mChangedDuringTouch:Z

    invoke-virtual {p0, p2, p3, p4}, applyAttributes(Landroid/util/AttributeSet;II)V
    ...
    iput-object p2, p0, mTypeface:Landroid/graphics/Typeface;

    iget-object p2, p0, mPaint:[Landroid/graphics/Paint;
    ...
    iget-object p2, p0, mPaintCenter:Landroid/graphics/Paint;

    invoke-virtual {p2, v2}, Landroid/graphics/Paint;->setAntiAlias(Z)V

    iget-object p2, p0, mPaintSelector:[Landroid/graphics/Paint;
    ...
    iget-object p2, p0, mPaintBackground:Landroid/graphics/Paint;
    ...
    iput p3, p0, mSelectorDotRadius:I
    ...
    iput p3, p0, mCenterDotRadius:I

    iget-object p3, p0, mTextSize:[I
    ...
    iget-object p3, p0, mTextInset:[I
    ...
    iput-boolean v2, p0, mShowHours:Z

    const/4 p2, 0x0

    iput p2, p0, mHoursToMinutes:F

    iput-boolean v3, p0, mIs24HourMode:Z

    iput v3, p0, mAmOrPm:I
    ...
    iput-object p2, p0, mTouchHelper:Lcom/oneplus/lib/widget/RadialTimePickerView$RadialPickerTouchHelper;

    iget-object p2, p0, mTouchHelper:Lcom/oneplus/lib/widget/RadialTimePickerView$RadialPickerTouchHelper;
    ...
    :cond_0
    invoke-direct {p0}, initHoursAndMinutesText()V
    ...
    invoke-direct {p0, p3, v3, v3}, setCurrentHourInternal(IZZ)V

    invoke-direct {p0, p2, v3}, setCurrentMinuteInternal(IZ)V
...
.method static synthetic access$100(Lcom/oneplus/lib/widget/RadialTimePickerView;)Z
    ...
    iget-boolean p0, p0, mShowHours:Z
...
.method static synthetic access$1100(Lcom/oneplus/lib/widget/RadialTimePickerView;)[I
    ...
    iget-object p0, p0, mTextInset:[I
...
.method static synthetic access$200(Lcom/oneplus/lib/widget/RadialTimePickerView;)Z
    ...
    iget-boolean p0, p0, mIs24HourMode:Z
...
.method private animatePicker(ZJ)V
    ...
    :goto_0
    iget v0, p0, mHoursToMinutes:F

    cmpl-float v1, v0, p1

    if-nez v1, :cond_2

    iget-object p1, p0, mHoursToMinutesAnimator:Landroid/animation/ObjectAnimator;
    ...
    iput-object p1, p0, mHoursToMinutesAnimator:Landroid/animation/ObjectAnimator;
    ...
    iget-object p0, p0, mHoursToMinutesAnimator:Landroid/animation/ObjectAnimator;
...
.method private calculatePositionsHours()V
    ...
    invoke-static/range {v3 .. v9}, calculatePositions(Landroid/graphics/Paint;FFFF[F[F)V
    ...
    iget-object v9, p0, mInnerTextX:[F

    iget-object v10, p0, mInnerTextY:[F

    invoke-static/range {v4 .. v10}, calculatePositions(Landroid/graphics/Paint;FFFF[F[F)V
...
.method private calculatePositionsMinutes()V
    ...
    iget-object p0, p0, mOuterTextY:[[F
...
.method private drawCenter(Landroid/graphics/Canvas;F)V
    ...
    iget v1, p0, mCenterDotRadius:I

    int-to-float v1, v1

    iget-object p0, p0, mPaintCenter:Landroid/graphics/Paint;
...
.method private drawCircleBackground(Landroid/graphics/Canvas;)V
    ...
    iget-object p0, p0, mPaintBackground:Landroid/graphics/Paint;
...
.method private drawHours(Landroid/graphics/Canvas;Landroid/graphics/Path;F)V
    ...
    invoke-direct {p0, p1, p3, v0}, drawHoursClipped(Landroid/graphics/Canvas;IZ)V
    ...
    invoke-direct {p0, p1, p3, p2}, drawHoursClipped(Landroid/graphics/Canvas;IZ)V
...
.method private drawHoursClipped(Landroid/graphics/Canvas;IZ)V
    ...
    iget-object v0, v13, mTextSize:[I
    ...
    iget-object v3, v13, mTypeface:Landroid/graphics/Typeface;

    iget-object v0, v13, mTextColor:[Landroid/content/res/ColorStateList;

    aget-object v4, v0, v14

    iget-object v5, v13, mOuterTextHours:[Ljava/lang/String;

    iget-object v0, v13, mOuterTextX:[[F

    aget-object v6, v0, v14

    iget-object v0, v13, mOuterTextY:[[F

    aget-object v7, v0, v14

    iget-object v0, v13, mPaint:[Landroid/graphics/Paint;
    ...
    iget-boolean v0, v13, mIsOnInnerCircle:Z
    ...
    :goto_0
    iget-object v0, v13, mSelectionDegrees:[I
    ...
    iget-boolean v0, v13, mIs24HourMode:Z

    if-eqz v0, :cond_2

    iget-object v5, v13, mInnerTextHours:[Ljava/lang/String;
    ...
    iget-object v6, v13, mInnerTextX:[F

    iget-object v7, v13, mInnerTextY:[F
...
.method private drawMinutes(Landroid/graphics/Canvas;Landroid/graphics/Path;F)V
    ...
    invoke-direct {p0, p1, p3, v0}, drawMinutesClipped(Landroid/graphics/Canvas;IZ)V
    ...
    invoke-direct {p0, p1, p3, p2}, drawMinutesClipped(Landroid/graphics/Canvas;IZ)V
...
.method private drawMinutesClipped(Landroid/graphics/Canvas;IZ)V
    ...
    iget-object v4, v0, mTypeface:Landroid/graphics/Typeface;

    iget-object v1, v0, mTextColor:[Landroid/content/res/ColorStateList;

    aget-object v5, v1, v2

    iget-object v6, v0, mMinutesText:[Ljava/lang/String;

    iget-object v1, v0, mOuterTextX:[[F

    aget-object v7, v1, v2

    iget-object v1, v0, mOuterTextY:[[F

    aget-object v8, v1, v2

    iget-object v1, v0, mPaint:[Landroid/graphics/Paint;

    aget-object v9, v1, v2

    iget-object v1, v0, mSelectionDegrees:[I
...
.method private drawSelector(Landroid/graphics/Canvas;Landroid/graphics/Path;)V
    ...
    iget-boolean v2, v0, mIsOnInnerCircle:Z
    ...
    :goto_0
    iget-object v4, v0, mTextInset:[I

    aget v4, v4, v2

    iget-object v5, v0, mSelectionDegrees:[I
    ...
    :goto_1
    iget-object v10, v0, mTextInset:[I

    const/4 v11, 0x1

    aget v10, v10, v11

    iget-object v12, v0, mSelectionDegrees:[I
    ...
    :goto_2
    iget v12, v0, mSelectorRadius:I

    iget v14, v0, mCircleRadius:I
    ...
    iget-object v9, v0, mPaintSelector:[Landroid/graphics/Paint;

    aget-object v9, v9, v8

    iget v10, v0, mSelectorColor:I
    ...
    iget v5, v0, mSelectorDotColor:I

    invoke-virtual {v2, v5}, Landroid/graphics/Paint;->setColor(I)V

    iget v5, v0, mSelectorDotRadius:I
    ...
    iget v5, v0, mXCenter:I

    iget v6, v0, mCenterDotRadius:I
    ...
    iget-object v1, v0, mPaintSelector:[Landroid/graphics/Paint;

    const/4 v2, 0x2

    aget-object v7, v1, v2

    iget v1, v0, mSelectorColor:I

    invoke-virtual {v7, v1}, Landroid/graphics/Paint;->setColor(I)V

    iget v1, v0, mSelectorStroke:I

    int-to-float v1, v1

    invoke-virtual {v7, v1}, Landroid/graphics/Paint;->setStrokeWidth(F)V

    iget v1, v0, mXCenter:I

    int-to-float v2, v1

    iget v1, v0, mYCenter:I
    ...
    iget-boolean v1, v0, mShowHours:Z
    ...
    iget-object v1, v0, oval:Landroid/graphics/RectF;

    iget-object v2, v0, mOuterTextX:[[F
    ...
    invoke-direct {v0, v2}, getDegreesForMinute(I)I
...
.method private drawTextElements(Landroid/graphics/Canvas;FLandroid/graphics/Typeface;Landroid/content/res/ColorStateList;[Ljava/lang/String;[F[FLandroid/graphics/Paint;IZIZ)V
    ...
    invoke-direct {p0, v6, v9}, getMultipliedAlpha(II)I
...
.method private getDegreesFromXY(FFZ)I
    ...
    iget v0, p0, mMinDistForInnerNumber:I

    iget v1, p0, mMaxDistForOuterNumber:I
...
.method private handleTouchInput(FFZZ)Z
    ...
    invoke-direct {p0, p1, p2, v1}, getDegreesFromXY(FFZ)I
    ...
    :cond_0
    iget-boolean p2, p0, mShowHours:Z

    const-wide/16 v2, 0x3c

    invoke-direct {p0, p2, v2, v3}, animatePicker(ZJ)V
    ...
    invoke-static {p1, v1}, snapOnly30s(II)I

    move-result p1

    rem-int/lit16 p1, p1, 0x168

    iget-boolean p2, p0, mIsOnInnerCircle:Z

    if-ne p2, v0, :cond_2

    iget-object p2, p0, mSelectionDegrees:[I
    ...
    :goto_1
    iput-boolean v0, p0, mIsOnInnerCircle:Z
    ...
    :cond_3
    invoke-static {p1}, snapPrefer30s(I)I
    ...
    :cond_6
    :goto_4
    iget-object v1, p0, mListener:Lcom/oneplus/lib/widget/RadialTimePickerView$OnValueSelectedListener;
    ...
    iget-object p2, p0, mVibrator:Landroid/os/Vibrator;
    ...
    iput-object p1, p0, mVibratePattern:[J

    iget-object p1, p0, mVibratePattern:[J
...
.method private initData()V
    ...
    iget-object v0, p0, mOuterHours24Texts:[Ljava/lang/String;

    iput-object v0, p0, mOuterTextHours:[Ljava/lang/String;

    iget-object v0, p0, mInnerHours24Texts:[Ljava/lang/String;

    iput-object v0, p0, mInnerTextHours:[Ljava/lang/String;

    goto :goto_0

    :cond_0
    iget-object v0, p0, mHours12Texts:[Ljava/lang/String;
    ...
    :goto_0
    iget-object v0, p0, mMinutesTexts:[Ljava/lang/String;

    iput-object v0, p0, mMinutesText:[Ljava/lang/String;
...
.method private initHoursAndMinutesText()V
    ...
    sget-object v6, HOURS_NUMBERS_24:[I
    ...
    sget-object v7, HOURS_NUMBERS:[I
...
.method private static preparePrefer30sMap()V
    ...
    sget-object v5, SNAP_PREFER_30S_MAP:[I
...
.method private setCurrentHourInternal(IZZ)V
    ...
    iget v3, p0, mAmOrPm:I

    if-ne v3, v0, :cond_2

    iget-boolean v3, p0, mIsOnInnerCircle:Z
    ...
    iget-object v0, p0, mTouchHelper:Lcom/oneplus/lib/widget/RadialTimePickerView$RadialPickerTouchHelper;
    ...
    iget-object p0, p0, mListener:Lcom/oneplus/lib/widget/RadialTimePickerView$OnValueSelectedListener;
...
.method private showPicker(ZZ)V
    ...
    :cond_0
    iput-boolean p1, p0, mShowHours:Z

    if-eqz p2, :cond_1

    const-wide/16 v0, 0x1f4

    invoke-direct {p0, p1, v0, v1}, animatePicker(ZJ)V

    goto :goto_1

    :cond_1
    iget-object p2, p0, mHoursToMinutesAnimator:Landroid/animation/ObjectAnimator;
    ...
    iput-object p2, p0, mHoursToMinutesAnimator:Landroid/animation/ObjectAnimator;
    ...
    iget-object p0, p0, mTouchHelper:Lcom/oneplus/lib/widget/RadialTimePickerView$RadialPickerTouchHelper;
...
.method applyAttributes(Landroid/util/AttributeSet;II)V
    ...
    iget-object v1, p0, mTextColor:[Landroid/content/res/ColorStateList;
    ...
    iget-object p2, p0, mTextColor:[Landroid/content/res/ColorStateList;
    ...
    iput v2, p0, mSelectorColor:I

    iget-object p3, p0, mTextColor:[Landroid/content/res/ColorStateList;
    ...
    iput p2, p0, mSelectorDotColor:I
...
.method public initialize(IIZ)V
    ...
    invoke-direct {p0, p1, p3, p3}, setCurrentHourInternal(IZZ)V

    invoke-direct {p0, p2, p3}, setCurrentMinuteInternal(IZ)V
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-direct {p0, p1, v1}, drawSelector(Landroid/graphics/Canvas;Landroid/graphics/Path;)V

    invoke-direct {p0, p1, v1, v0}, drawHours(Landroid/graphics/Canvas;Landroid/graphics/Path;F)V

    invoke-direct {p0, p1, v1, v0}, drawMinutes(Landroid/graphics/Canvas;Landroid/graphics/Path;F)V
...
.method protected onLayout(ZIIII)V
    ...
    iput p1, p0, mCircleRadius:I

    iget p1, p0, mCircleRadius:I
    ...
    iget p5, p0, mSelectorRadius:I

    sub-int/2addr p4, p5

    iput p4, p0, mMinDistForInnerNumber:I
...
.method public onResolvePointerIcon(Landroid/view/MotionEvent;I)Landroid/view/PointerIcon;
    ...
    invoke-direct {p0, v0, v1, v2}, getDegreesFromXY(FFZ)I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iput-boolean v2, p0, mChangedDuringTouch:Z
    ...
    iget-boolean v0, p0, mChangedDuringTouch:Z
    ...
    invoke-direct {p0, v4, p1, v2, v0}, handleTouchInput(FFZZ)Z

    move-result p1

    or-int/2addr p1, v3

    iput-boolean p1, p0, mChangedDuringTouch:Z
...
.method public setOnValueSelectedListener(Lcom/oneplus/lib/widget/RadialTimePickerView$OnValueSelectedListener;)V
    ...
    iput-object p1, p0, mListener:Lcom/oneplus/lib/widget/RadialTimePickerView$OnValueSelectedListener;
...
.method public showHours(Z)V
    ...
    invoke-direct {p0, v0, p1}, showPicker(ZZ)V
