...
.method static constructor <clinit>()V
    ...
    sput-object v0, BEZIER_ANIMATION_INTERPOLATOR:Landroid/view/animation/Interpolator;

    new-instance v0, Landroid/view/animation/PathInterpolator;

    invoke-direct {v0, v2, v3, v3, v1}, Landroid/view/animation/PathInterpolator;-><init>(FFFF)V

    sput-object v0, ICON_ENTER_ANIMATION_INTERPOLATOR:Landroid/view/animation/Interpolator;
    ...
    sput-object v0, ICON_EXIT_ANIMATION_INTERPOLATOR:Landroid/view/animation/Interpolator;
...
.method public constructor <init>(Landroid/content/Context;II)V
    ...
    iput-boolean v0, p0, mEnterAnimProcessing:Z

    iput-boolean v0, p0, mExitAnimProcessing:Z

    iput-boolean v0, p0, mBackIconProcessing:Z

    new-instance v1, Landroid/graphics/Matrix;

    invoke-direct {v1}, Landroid/graphics/Matrix;-><init>()V

    iput-object v1, p0, mBackIconMatrix:Landroid/graphics/Matrix;

    const/high16 v1, 0x3f800000    # 1.0f

    iput v1, p0, mBackIconScale:F

    iput-boolean v0, p0, mAppIconProcessing:Z

    new-instance v1, Landroid/graphics/Matrix;

    invoke-direct {v1}, Landroid/graphics/Matrix;-><init>()V

    iput-object v1, p0, mAppIconMatrix:Landroid/graphics/Matrix;

    const/4 v1, 0x0

    iput v1, p0, mAppIconScale:F

    const/4 v1, -0x1

    iput v1, p0, mLastGestureState:I

    iput v1, p0, mGestureState:I

    new-instance v1, Landroid/graphics/PointF;

    invoke-direct {v1}, Landroid/graphics/PointF;-><init>()V

    iput-object v1, p0, mCurrentPoint:Landroid/graphics/PointF;

    new-instance v1, Landroid/graphics/PointF;

    invoke-direct {v1}, Landroid/graphics/PointF;-><init>()V

    iput-object v1, p0, mTargetPoint:Landroid/graphics/PointF;

    new-instance v1, Landroid/graphics/PointF;

    invoke-direct {v1}, Landroid/graphics/PointF;-><init>()V

    iput-object v1, p0, mStartPoint:Landroid/graphics/PointF;

    new-instance v1, Landroid/graphics/PointF;

    invoke-direct {v1}, Landroid/graphics/PointF;-><init>()V

    iput-object v1, p0, mEndPoint:Landroid/graphics/PointF;

    new-instance v1, Landroid/graphics/PointF;

    invoke-direct {v1}, Landroid/graphics/PointF;-><init>()V

    iput-object v1, p0, mBezierControlPoint1:Landroid/graphics/PointF;

    new-instance v1, Landroid/graphics/PointF;

    invoke-direct {v1}, Landroid/graphics/PointF;-><init>()V

    iput-object v1, p0, mBezierControlPoint2:Landroid/graphics/PointF;

    new-instance v1, Landroid/graphics/PointF;

    invoke-direct {v1}, Landroid/graphics/PointF;-><init>()V

    iput-object v1, p0, mBezierControlPoint3:Landroid/graphics/PointF;

    new-instance v1, Landroid/graphics/PointF;

    invoke-direct {v1}, Landroid/graphics/PointF;-><init>()V

    iput-object v1, p0, mBezierControlPoint4:Landroid/graphics/PointF;

    invoke-static {}, Lcom/oneplus/phone/OpSideGestureConfiguration;->getBezierControlOffset1()I

    move-result v1

    iput v1, p0, mBezierControlOffset1:I

    invoke-static {}, Lcom/oneplus/phone/OpSideGestureConfiguration;->getBezierControlOffsetSwitch2()I

    move-result v1

    iput v1, p0, mBezierControlOffset2:I

    const/4 v1, 0x1

    iput-boolean v1, p0, mFinished:Z

    iput-boolean v0, p0, mHasDownEvent:Z

    iput-boolean v0, p0, mInTouchArea:Z
    ...
    iput-object v1, p0, mEnterProperty:Landroid/util/IntProperty;
    ...
    iput-object v1, p0, mEnterAnimListener:Landroid/animation/AnimatorListenerAdapter;
    ...
    iput-object v1, p0, mExitProperty:Landroid/util/IntProperty;
    ...
    iput-object v1, p0, mExitAnimListener:Landroid/animation/AnimatorListenerAdapter;
    ...
    iput-object v1, p0, mBackIconProperty:Landroid/util/FloatProperty;
    ...
    iput-object v1, p0, mBackIconAnimListener:Landroid/animation/AnimatorListenerAdapter;
    ...
    iput-object v1, p0, mAppIconProperty:Landroid/util/FloatProperty;
    ...
    iput-object v1, p0, mAppIconAnimListener:Landroid/animation/AnimatorListenerAdapter;

    iput p2, p0, mPosition:I

    invoke-direct {p0, p3}, calculateOffset(I)V
    ...
    iput-object p1, p0, mBackIcon:Landroid/graphics/Bitmap;
...
.method static synthetic access$000(Lcom/oneplus/phone/OpSideGestureNavView;)Landroid/graphics/PointF;
    ...
    iget-object p0, p0, mCurrentPoint:Landroid/graphics/PointF;
...
.method static synthetic access$100(Lcom/oneplus/phone/OpSideGestureNavView;)Landroid/graphics/PointF;
    ...
    iget-object p0, p0, mTargetPoint:Landroid/graphics/PointF;
...
.method static synthetic access$1002(Lcom/oneplus/phone/OpSideGestureNavView;Z)Z
    ...
    iput-boolean p1, p0, mBackIconProcessing:Z
...
.method static synthetic access$1102(Lcom/oneplus/phone/OpSideGestureNavView;Z)Z
    ...
    iput-boolean p1, p0, mAppIconProcessing:Z
...
.method static synthetic access$300(Lcom/oneplus/phone/OpSideGestureNavView;)Z
    ...
    iget-boolean p0, p0, mEnterAnimProcessing:Z
...
.method static synthetic access$302(Lcom/oneplus/phone/OpSideGestureNavView;Z)Z
    ...
    iput-boolean p1, p0, mEnterAnimProcessing:Z
...
.method static synthetic access$400(Lcom/oneplus/phone/OpSideGestureNavView;)Z
    ...
    iget-boolean p0, p0, mExitAnimProcessing:Z
...
.method static synthetic access$402(Lcom/oneplus/phone/OpSideGestureNavView;Z)Z
    ...
    iput-boolean p1, p0, mExitAnimProcessing:Z
...
.method static synthetic access$500(Lcom/oneplus/phone/OpSideGestureNavView;)Landroid/animation/ObjectAnimator;
    ...
    iget-object p0, p0, mExitAnimator:Landroid/animation/ObjectAnimator;
...
.method static synthetic access$600(Lcom/oneplus/phone/OpSideGestureNavView;)Z
    ...
    iget-boolean p0, p0, mFinished:Z
...
.method static synthetic access$700(Lcom/oneplus/phone/OpSideGestureNavView;)Landroid/animation/ObjectAnimator;
    ...
    iget-object p0, p0, mEnterAnimator:Landroid/animation/ObjectAnimator;
...
.method private addCurveToPoint(Landroid/graphics/Path;)V
    ...
    iget-object v0, p0, mBezierControlPoint1:Landroid/graphics/PointF;

    iget v1, v0, Landroid/graphics/PointF;->x:F

    iget v2, p0, mViewOffsetX:I
    ...
    iget v1, p0, mViewOffsetY:I

    int-to-float v3, v1

    sub-float v6, v0, v3

    iget-object v0, p0, mBezierControlPoint2:Landroid/graphics/PointF;
    ...
    iget-object v0, p0, mCurrentPoint:Landroid/graphics/PointF;
    ...
    iget-object v0, p0, mBezierControlPoint3:Landroid/graphics/PointF;
    ...
    iget-object v0, p0, mBezierControlPoint4:Landroid/graphics/PointF;
    ...
    iget-object p0, p0, mEndPoint:Landroid/graphics/PointF;
...
.method private calculateControlPoint()V
    ...
    iget-object v0, p0, mStartPoint:Landroid/graphics/PointF;

    const/4 v1, 0x0

    iput v1, v0, Landroid/graphics/PointF;->x:F

    iget-object v2, p0, mCurrentPoint:Landroid/graphics/PointF;
    ...
    iget-object v0, p0, mEndPoint:Landroid/graphics/PointF;
    ...
    iget v4, p0, mBezierControlOffset1:I
    ...
    iget v4, p0, mBezierControlOffset2:I
    ...
    iget p0, p0, mBezierControlOffset1:I
    ...
    iget-object v1, p0, mCurrentPoint:Landroid/graphics/PointF;
    ...
    iget v3, p0, mBezierControlOffset1:I
    ...
    iget v3, p0, mBezierControlOffset2:I
...
.method private calculateMatrix()V
    ...
    iget-object v0, p0, mBackIconMatrix:Landroid/graphics/Matrix;

    invoke-virtual {v0}, Landroid/graphics/Matrix;->reset()V

    iget-object v0, p0, mAppIconMatrix:Landroid/graphics/Matrix;
    ...
    iget-object v2, p0, mBackIconMatrix:Landroid/graphics/Matrix;

    int-to-float v0, v0

    iget-object v3, p0, mCurrentPoint:Landroid/graphics/PointF;

    iget v3, v3, Landroid/graphics/PointF;->y:F

    iget v4, p0, mViewOffsetY:I
    ...
    iget-object v2, p0, mAppIconMatrix:Landroid/graphics/Matrix;
    ...
    iget-object p0, p0, mBackIconMatrix:Landroid/graphics/Matrix;
...
.method private calculateTargetPoint(Landroid/graphics/PointF;II)V
    ...
    iget p3, p0, mPosition:I

    const v0, 0x3ea56041    # 0.32299998f

    if-nez p3, :cond_0

    iget-object p2, p0, mTargetPoint:Landroid/graphics/PointF;
    ...
    iget-object p3, p0, mTargetPoint:Landroid/graphics/PointF;
...
.method private getBezierDrawingPath()Landroid/graphics/Path;
    ...
    iget-object v1, p0, mStartPoint:Landroid/graphics/PointF;

    iget v2, v1, Landroid/graphics/PointF;->x:F

    iget v3, p0, mViewOffsetX:I
    ...
    invoke-direct {p0, v0}, addCurveToPoint(Landroid/graphics/Path;)V
...
.method private initPaint()V
    ...
    iput-object v0, p0, mBezierPaint:Landroid/graphics/Paint;

    iget-object v0, p0, mBezierPaint:Landroid/graphics/Paint;
    ...
    iput-object v0, p0, mIconPaint:Landroid/graphics/Paint;

    iget-object p0, p0, mIconPaint:Landroid/graphics/Paint;
...
.method private startAppIconAniamtion(ZJJ)V
    ...
    iget-object v0, p0, mAppIconAnimator:Landroid/animation/ObjectAnimator;
    ...
    iget-object p1, p0, mAppIconProperty:Landroid/util/FloatProperty;
    ...
    iput-object p1, p0, mAppIconAnimator:Landroid/animation/ObjectAnimator;

    iget-object p1, p0, mAppIconAnimator:Landroid/animation/ObjectAnimator;

    sget-object v0, ICON_ENTER_ANIMATION_INTERPOLATOR:Landroid/view/animation/Interpolator;
    ...
    sget-object v0, ICON_EXIT_ANIMATION_INTERPOLATOR:Landroid/view/animation/Interpolator;
    ...
    iget-object v0, p0, mAppIconAnimListener:Landroid/animation/AnimatorListenerAdapter;
    ...
    iget-object p0, p0, mAppIconAnimator:Landroid/animation/ObjectAnimator;
...
.method private startBackIconAnimation(ZJJ)V
    ...
    iget-object v0, p0, mBackIconAnimator:Landroid/animation/ObjectAnimator;
    ...
    iget-object p1, p0, mBackIconProperty:Landroid/util/FloatProperty;
    ...
    iput-object p1, p0, mBackIconAnimator:Landroid/animation/ObjectAnimator;

    iget-object p1, p0, mBackIconAnimator:Landroid/animation/ObjectAnimator;
    ...
    iget-object v0, p0, mBackIconAnimListener:Landroid/animation/AnimatorListenerAdapter;
    ...
    iget-object p0, p0, mBackIconAnimator:Landroid/animation/ObjectAnimator;
...
.method private startEnterAnimation(IIJ)V
    ...
    iget-object v0, p0, mEnterProperty:Landroid/util/IntProperty;
    ...
    iput-object p1, p0, mEnterAnimator:Landroid/animation/ObjectAnimator;

    iget-object p1, p0, mEnterAnimator:Landroid/animation/ObjectAnimator;

    sget-object p2, BEZIER_ANIMATION_INTERPOLATOR:Landroid/view/animation/Interpolator;
    ...
    iget-object p2, p0, mEnterAnimListener:Landroid/animation/AnimatorListenerAdapter;
...
.method private startExitAnimation(IIJ)V
    ...
    iget-object v0, p0, mExitProperty:Landroid/util/IntProperty;
    ...
    iput-object p1, p0, mExitAnimator:Landroid/animation/ObjectAnimator;

    iget-object p1, p0, mExitAnimator:Landroid/animation/ObjectAnimator;
    ...
    iget-object p2, p0, mExitAnimListener:Landroid/animation/AnimatorListenerAdapter;
...
.method private updateView()V
    ...
    invoke-direct {p0}, calculateControlPoint()V

    invoke-direct {p0}, calculateMatrix()V
...
.method public synthetic lambda$onUpEvent$0$OpSideGestureNavView()V
    ...
    iget-boolean v0, p0, mHasDownEvent:Z
...
.method public onConfigChanged(I)V
    ...
    iput v0, p0, mBezierControlOffset1:I

    invoke-static {}, Lcom/oneplus/phone/OpSideGestureConfiguration;->getBezierControlOffsetSwitch2()I

    move-result v0

    iput v0, p0, mBezierControlOffset2:I

    invoke-direct {p0, p1}, calculateOffset(I)V

    invoke-virtual {p0}, resetState()V
...
.method public onDownEvent()V
    ...
    invoke-direct {p0, v0}, calculateOffset(I)V
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-direct {p0}, getBezierDrawingPath()Landroid/graphics/Path;

    move-result-object v0

    iget-object v1, p0, mBezierPaint:Landroid/graphics/Paint;

    invoke-virtual {p1, v0, v1}, Landroid/graphics/Canvas;->drawPath(Landroid/graphics/Path;Landroid/graphics/Paint;)V

    iget v0, p0, mGestureState:I

    const/4 v1, 0x2

    if-eq v0, v1, :cond_0

    iget-boolean v0, p0, mBackIconProcessing:Z

    if-eqz v0, :cond_1

    :cond_0
    iget-object v0, p0, mBackIcon:Landroid/graphics/Bitmap;

    iget-object v1, p0, mBackIconMatrix:Landroid/graphics/Matrix;

    iget-object v2, p0, mIconPaint:Landroid/graphics/Paint;
    ...
    iget-boolean v0, p0, mAppIconProcessing:Z

    if-eqz v0, :cond_3

    :cond_2
    iget-object v0, p0, mAppIcon:Landroid/graphics/Bitmap;

    iget-object v1, p0, mAppIconMatrix:Landroid/graphics/Matrix;
...
.method public onGestureFinished(Lcom/oneplus/phone/GesturePointContainer;)V
    ...
    iget-object p1, p0, mCurrentPoint:Landroid/graphics/PointF;
    ...
    invoke-direct {p0, p1, v0, v1, v2}, startExitAnimation(IIJ)V
...
.method public onUpEvent()V
    ...
    iget-boolean v0, p0, mExitAnimProcessing:Z
...
.method public onUpdateGestureView(Lcom/oneplus/phone/GesturePointContainer;)V
    ...
    invoke-direct {p0, v1, v2, v3}, calculateTargetPoint(Landroid/graphics/PointF;II)V

    iget v1, p0, mGestureState:I

    iget v2, p0, mLastGestureState:I
    ...
    :cond_1
    iget v1, p0, mLastGestureState:I
    ...
    iget-boolean v1, p0, mEnterAnimProcessing:Z

    if-nez v1, :cond_3

    iget-boolean v1, p0, mExitAnimProcessing:Z

    if-nez v1, :cond_3

    iget-object v1, p0, mCurrentPoint:Landroid/graphics/PointF;

    iget-object v5, p0, mTargetPoint:Landroid/graphics/PointF;
    ...
    invoke-direct {p0, v1, v0, v6, v7}, startExitAnimation(IIJ)V
    ...
    invoke-direct {p0, v0, v1, v6, v7}, startExitAnimation(IIJ)V

    goto :goto_0

    :cond_5
    iget v0, p0, mLastGestureState:I
    ...
    iget-object v1, p0, mTargetPoint:Landroid/graphics/PointF;

    iget v1, v1, Landroid/graphics/PointF;->x:F

    float-to-int v1, v1

    invoke-direct {p0, v0, v1, v6, v7}, startEnterAnimation(IIJ)V
    ...
    invoke-direct/range {v0 .. v5}, startBackIconAnimation(ZJJ)V

    const/4 v1, 0x1

    const-wide/16 v2, 0x64

    invoke-direct/range {v0 .. v5}, startAppIconAniamtion(ZJJ)V
    ...
    :cond_8
    :goto_1
    iget-boolean v0, p0, mEnterAnimProcessing:Z
...
.method public resetState()V
    ...
    iput v0, p0, mLastGestureState:I

    iput v0, p0, mGestureState:I

    iget-boolean v0, p0, mEnterAnimProcessing:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, mEnterAnimator:Landroid/animation/ObjectAnimator;
    ...
    iget-object v0, p0, mExitAnimator:Landroid/animation/ObjectAnimator;
