...
.method public constructor <init>()V
    ...
    iput-object v0, p0, curves:Ljava/util/List;
...
.method public constructor <init>(Landroid/graphics/PointF;ZLjava/util/List;)V
    ...
    iput-object p1, p0, initialPoint:Landroid/graphics/PointF;

    iput-boolean p2, p0, closed:Z

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1, p3}, Ljava/util/ArrayList;-><init>(Ljava/util/Collection;)V

    iput-object p1, p0, curves:Ljava/util/List;
...
.method private setInitialPoint(FF)V
    ...
    iget-object v0, p0, initialPoint:Landroid/graphics/PointF;
    ...
    iput-object v0, p0, initialPoint:Landroid/graphics/PointF;

    :cond_0
    iget-object p0, p0, initialPoint:Landroid/graphics/PointF;
...
.method public getCurves()Ljava/util/List;
    ...
    iget-object p0, p0, curves:Ljava/util/List;
...
.method public interpolateBetween(Lcom/airbnb/lottie/model/content/ShapeData;Lcom/airbnb/lottie/model/content/ShapeData;F)V
    ...
    invoke-virtual {p1}, getCurves()Ljava/util/List;
    ...
    invoke-virtual {p2}, getCurves()Ljava/util/List;
    ...
    iget-object v2, p0, curves:Ljava/util/List;
    ...
    iget-object v3, p0, curves:Ljava/util/List;
    ...
    :cond_5
    invoke-virtual {p1}, getInitialPoint()Landroid/graphics/PointF;

    move-result-object v0

    invoke-virtual {p2}, getInitialPoint()Landroid/graphics/PointF;
    ...
    invoke-direct {p0, v3, v0}, setInitialPoint(FF)V

    iget-object v0, p0, curves:Ljava/util/List;
    ...
    iget-object v7, p0, curves:Ljava/util/List;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, curves:Ljava/util/List;
