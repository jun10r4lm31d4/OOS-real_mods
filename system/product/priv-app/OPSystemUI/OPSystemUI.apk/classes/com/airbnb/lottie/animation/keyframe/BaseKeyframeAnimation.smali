...
.method constructor <init>(Ljava/util/List;)V
    ...
    iput-boolean v0, p0, isDiscrete:Z
    ...
    iput v0, p0, cachedGetValueProgress:F

    const/4 v1, 0x0

    iput-object v1, p0, cachedGetValue:Ljava/lang/Object;

    iput v0, p0, cachedStartDelayProgress:F

    iput v0, p0, cachedEndProgress:F

    iput-object p1, p0, keyframes:Ljava/util/List;
...
.method private getStartDelayProgress()F
    ...
    iget v0, p0, cachedStartDelayProgress:F
    ...
    iget-object v0, p0, keyframes:Ljava/util/List;
    ...
    :cond_1
    iget p0, p0, cachedStartDelayProgress:F
...
.method protected getCurrentKeyframe()Lcom/airbnb/lottie/value/Keyframe;
    ...
    iget-object v1, p0, cachedKeyframe:Lcom/airbnb/lottie/value/Keyframe;

    if-eqz v1, :cond_0

    iget v2, p0, progress:F
    ...
    iget-object p0, p0, cachedKeyframe:Lcom/airbnb/lottie/value/Keyframe;

    return-object p0

    :cond_0
    iget-object v1, p0, keyframes:Ljava/util/List;
    ...
    iget-object v2, p0, keyframes:Ljava/util/List;
    ...
    :cond_2
    :goto_1
    iput-object v1, p0, cachedKeyframe:Lcom/airbnb/lottie/value/Keyframe;
...
.method getEndProgress()F
    ...
    iget v0, p0, cachedEndProgress:F
    ...
    :cond_1
    iget p0, p0, cachedEndProgress:F
...
.method protected getInterpolatedCurrentKeyframeProgress()F
    ...
    invoke-virtual {p0}, getCurrentKeyframe()Lcom/airbnb/lottie/value/Keyframe;
    ...
    invoke-virtual {p0}, getLinearCurrentKeyframeProgress()F
...
.method getLinearCurrentKeyframeProgress()F
    ...
    iget-boolean v0, p0, isDiscrete:Z
...
.method public getValue()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, getInterpolatedCurrentKeyframeProgress()F

    move-result v1

    iget-object v2, p0, valueCallback:Lcom/airbnb/lottie/value/LottieValueCallback;

    if-nez v2, :cond_0

    iget-object v2, p0, cachedGetValueKeyframe:Lcom/airbnb/lottie/value/Keyframe;

    if-ne v0, v2, :cond_0

    iget v2, p0, cachedGetValueProgress:F

    cmpl-float v2, v2, v1

    if-nez v2, :cond_0

    iget-object p0, p0, cachedGetValue:Ljava/lang/Object;

    return-object p0

    :cond_0
    iput-object v0, p0, cachedGetValueKeyframe:Lcom/airbnb/lottie/value/Keyframe;

    iput v1, p0, cachedGetValueProgress:F

    invoke-virtual {p0, v0, v1}, getValue(Lcom/airbnb/lottie/value/Keyframe;F)Ljava/lang/Object;

    move-result-object v0

    iput-object v0, p0, cachedGetValue:Ljava/lang/Object;
...
.method public setProgress(F)V
    ...
    invoke-direct {p0}, getStartDelayProgress()F
...
.method public setValueCallback(Lcom/airbnb/lottie/value/LottieValueCallback;)V
    ...
    iget-object v0, p0, valueCallback:Lcom/airbnb/lottie/value/LottieValueCallback;
    ...
    :cond_0
    iput-object p1, p0, valueCallback:Lcom/airbnb/lottie/value/LottieValueCallback;
