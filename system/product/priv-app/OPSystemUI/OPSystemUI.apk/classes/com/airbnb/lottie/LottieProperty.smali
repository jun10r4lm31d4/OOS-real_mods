...
.method static constructor <clinit>()V
    ...
    sput-object v0, COLOR:Ljava/lang/Integer;
    ...
    sput-object v0, STROKE_COLOR:Ljava/lang/Integer;
    ...
    sput-object v0, TRANSFORM_OPACITY:Ljava/lang/Integer;
    ...
    sput-object v0, OPACITY:Ljava/lang/Integer;

    new-instance v0, Landroid/graphics/PointF;

    invoke-direct {v0}, Landroid/graphics/PointF;-><init>()V

    sput-object v0, TRANSFORM_ANCHOR_POINT:Landroid/graphics/PointF;

    new-instance v0, Landroid/graphics/PointF;

    invoke-direct {v0}, Landroid/graphics/PointF;-><init>()V

    sput-object v0, TRANSFORM_POSITION:Landroid/graphics/PointF;

    new-instance v0, Landroid/graphics/PointF;

    invoke-direct {v0}, Landroid/graphics/PointF;-><init>()V

    sput-object v0, ELLIPSE_SIZE:Landroid/graphics/PointF;

    new-instance v0, Landroid/graphics/PointF;

    invoke-direct {v0}, Landroid/graphics/PointF;-><init>()V

    sput-object v0, RECTANGLE_SIZE:Landroid/graphics/PointF;
    ...
    sput-object v0, CORNER_RADIUS:Ljava/lang/Float;

    new-instance v1, Landroid/graphics/PointF;

    invoke-direct {v1}, Landroid/graphics/PointF;-><init>()V

    sput-object v1, POSITION:Landroid/graphics/PointF;

    new-instance v1, Lcom/airbnb/lottie/value/ScaleXY;

    invoke-direct {v1}, Lcom/airbnb/lottie/value/ScaleXY;-><init>()V

    sput-object v1, TRANSFORM_SCALE:Lcom/airbnb/lottie/value/ScaleXY;
    ...
    sput-object v1, TRANSFORM_ROTATION:Ljava/lang/Float;

    sput-object v0, TRANSFORM_SKEW:Ljava/lang/Float;

    sput-object v0, TRANSFORM_SKEW_ANGLE:Ljava/lang/Float;
    ...
    sput-object v0, STROKE_WIDTH:Ljava/lang/Float;
    ...
    sput-object v0, TEXT_TRACKING:Ljava/lang/Float;
    ...
    sput-object v0, REPEATER_COPIES:Ljava/lang/Float;
    ...
    sput-object v0, REPEATER_OFFSET:Ljava/lang/Float;
    ...
    sput-object v0, POLYSTAR_POINTS:Ljava/lang/Float;
    ...
    sput-object v0, POLYSTAR_ROTATION:Ljava/lang/Float;
    ...
    sput-object v0, POLYSTAR_INNER_RADIUS:Ljava/lang/Float;
    ...
    sput-object v0, POLYSTAR_OUTER_RADIUS:Ljava/lang/Float;
    ...
    sput-object v0, POLYSTAR_INNER_ROUNDEDNESS:Ljava/lang/Float;
    ...
    sput-object v0, POLYSTAR_OUTER_ROUNDEDNESS:Ljava/lang/Float;
    ...
    sput-object v0, TRANSFORM_START_OPACITY:Ljava/lang/Float;

    sput-object v0, TRANSFORM_END_OPACITY:Ljava/lang/Float;
    ...
    sput-object v0, TIME_REMAP:Ljava/lang/Float;

    new-instance v0, Landroid/graphics/ColorFilter;

    invoke-direct {v0}, Landroid/graphics/ColorFilter;-><init>()V

    sput-object v0, COLOR_FILTER:Landroid/graphics/ColorFilter;

    const/4 v0, 0x0

    new-array v0, v0, [Ljava/lang/Integer;

    sput-object v0, GRADIENT_COLOR:[Ljava/lang/Integer;
