...
.method public constructor <init>()V
    ...
    iput-object v0, p0, performanceTracker:Lcom/airbnb/lottie/PerformanceTracker;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, warnings:Ljava/util/HashSet;

    const/4 v0, 0x0

    iput v0, p0, maskAndMatteCount:I
...
.method public addWarning(Ljava/lang/String;)V
    ...
    iget-object p0, p0, warnings:Ljava/util/HashSet;
...
.method public getBounds()Landroid/graphics/Rect;
    ...
    iget-object p0, p0, bounds:Landroid/graphics/Rect;
...
.method public getCharacters()Landroidx/collection/SparseArrayCompat;
    ...
    iget-object p0, p0, characters:Landroidx/collection/SparseArrayCompat;
...
.method public getDuration()F
    ...
    invoke-virtual {p0}, getDurationFrames()F

    move-result v0

    iget p0, p0, frameRate:F
...
.method public getDurationFrames()F
    ...
    iget v0, p0, endFrame:F

    iget p0, p0, startFrame:F
...
.method public getFonts()Ljava/util/Map;
    ...
    iget-object p0, p0, fonts:Ljava/util/Map;
...
.method public getImages()Ljava/util/Map;
    ...
    iget-object p0, p0, images:Ljava/util/Map;
...
.method public getLayers()Ljava/util/List;
    ...
    iget-object p0, p0, layers:Ljava/util/List;
...
.method public getMarker(Ljava/lang/String;)Lcom/airbnb/lottie/model/Marker;
    ...
    iget-object v0, p0, markers:Ljava/util/List;
    ...
    :goto_0
    iget-object v1, p0, markers:Ljava/util/List;
...
.method public getMarkers()Ljava/util/List;
    ...
    iget-object p0, p0, markers:Ljava/util/List;
...
.method public getMaskAndMatteCount()I
    ...
    iget p0, p0, maskAndMatteCount:I
...
.method public getPerformanceTracker()Lcom/airbnb/lottie/PerformanceTracker;
    ...
    iget-object p0, p0, performanceTracker:Lcom/airbnb/lottie/PerformanceTracker;
...
.method public getPrecomps(Ljava/lang/String;)Ljava/util/List;
    ...
    iget-object p0, p0, precomps:Ljava/util/Map;
...
.method public hasDashPattern()Z
    ...
    iget-boolean p0, p0, hasDashPattern:Z
...
.method public incrementMatteOrMaskCount(I)V
    ...
    iget v0, p0, maskAndMatteCount:I
...
.method public init(Landroid/graphics/Rect;FFFLjava/util/List;Landroidx/collection/LongSparseArray;Ljava/util/Map;Ljava/util/Map;Landroidx/collection/SparseArrayCompat;Ljava/util/Map;Ljava/util/List;)V
    ...
    iput-object p1, p0, bounds:Landroid/graphics/Rect;

    iput p2, p0, startFrame:F

    iput p3, p0, endFrame:F

    iput p4, p0, frameRate:F

    iput-object p5, p0, layers:Ljava/util/List;

    iput-object p6, p0, layerMap:Landroidx/collection/LongSparseArray;

    iput-object p7, p0, precomps:Ljava/util/Map;

    iput-object p8, p0, images:Ljava/util/Map;

    iput-object p9, p0, characters:Landroidx/collection/SparseArrayCompat;

    iput-object p10, p0, fonts:Ljava/util/Map;

    iput-object p11, p0, markers:Ljava/util/List;
...
.method public layerModelForId(J)Lcom/airbnb/lottie/model/layer/Layer;
    ...
    iget-object p0, p0, layerMap:Landroidx/collection/LongSparseArray;
...
.method public setHasDashPattern(Z)V
    ...
    iput-boolean p1, p0, hasDashPattern:Z
