...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, speedReversedForRepeatMode:Z

    const-wide/16 v1, 0x0

    iput-wide v1, p0, lastFrameTimeNs:J

    const/4 v1, 0x0

    iput v1, p0, frame:F

    iput v0, p0, repeatCount:I

    const/high16 v1, -0x31000000

    iput v1, p0, minFrame:F

    const/high16 v1, 0x4f000000

    iput v1, p0, maxFrame:F
...
.method private verifyFrame()V
    ...
    iget v1, p0, minFrame:F

    cmpg-float v1, v0, v1

    if-ltz v1, :cond_1

    iget v1, p0, maxFrame:F
...
.method public cancel()V
    ...
    invoke-virtual {p0}, removeFrameCallback()V
...
.method public clearComposition()V
    ...
    iput v0, p0, minFrame:F

    const/high16 v0, 0x4f000000

    iput v0, p0, maxFrame:F
...
.method public doFrame(J)V
    ...
    invoke-virtual {p0}, postFrameCallback()V
    ...
    iget-wide v1, p0, lastFrameTimeNs:J
    ...
    :goto_0
    invoke-direct {p0}, getFrameDurationNs()F
    ...
    iput-wide p1, p0, lastFrameTimeNs:J
    ...
    iget-boolean v1, p0, speedReversedForRepeatMode:Z

    xor-int/lit8 v1, v1, 0x1

    iput-boolean v1, p0, speedReversedForRepeatMode:Z

    invoke-virtual {p0}, reverseAnimationSpeed()V
    ...
    :cond_7
    :goto_4
    invoke-direct {p0}, verifyFrame()V
...
.method public getAnimatedValue()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, getAnimatedValueAbsolute()F
...
.method public playAnimation()V
    ...
    invoke-virtual {p0, v0}, setFrame(F)V

    const-wide/16 v0, 0x0

    iput-wide v0, p0, lastFrameTimeNs:J
...
.method protected postFrameCallback()V
    ...
    invoke-virtual {p0, v0}, removeFrameCallback(Z)V
...
.method public setComposition(Lcom/airbnb/lottie/LottieComposition;)V
    ...
    invoke-virtual {p0, v0, p1}, setMinAndMaxFrames(FF)V
    ...
    invoke-virtual {p0, p1}, setFrame(F)V
...
.method public setMinFrame(I)V
    ...
    iget v0, p0, maxFrame:F

    float-to-int v0, v0

    int-to-float v0, v0

    invoke-virtual {p0, p1, v0}, setMinAndMaxFrames(FF)V
...
.method public setRepeatMode(I)V
    ...
    iget-boolean p1, p0, speedReversedForRepeatMode:Z

    if-eqz p1, :cond_0

    const/4 p1, 0x0

    iput-boolean p1, p0, speedReversedForRepeatMode:Z
