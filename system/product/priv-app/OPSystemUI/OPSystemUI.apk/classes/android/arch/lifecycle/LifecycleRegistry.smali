...
.method public constructor <init>(Landroid/arch/lifecycle/LifecycleOwner;)V
    ...
    iput-object v0, p0, mObserverMap:Landroid/arch/core/internal/FastSafeIterableMap;
    ...
    iput-object p1, p0, mState:Landroid/arch/lifecycle/Lifecycle$State;
...
.method private backwardPass(Landroid/arch/lifecycle/LifecycleOwner;)V
    ...
    iget-object v0, p0, mObserverMap:Landroid/arch/core/internal/FastSafeIterableMap;
    ...
    iget-object v4, p0, mState:Landroid/arch/lifecycle/Lifecycle$State;
    ...
    iget-object v3, p0, mObserverMap:Landroid/arch/core/internal/FastSafeIterableMap;
    ...
    invoke-static {v3}, downEvent(Landroid/arch/lifecycle/Lifecycle$State;)Landroid/arch/lifecycle/Lifecycle$Event;

    move-result-object v3

    invoke-static {v3}, getStateAfter(Landroid/arch/lifecycle/Lifecycle$Event;)Landroid/arch/lifecycle/Lifecycle$State;

    move-result-object v4

    invoke-direct {p0, v4}, pushParentState(Landroid/arch/lifecycle/Lifecycle$State;)V
...
.method private calculateTargetState(Landroid/arch/lifecycle/LifecycleObserver;)Landroid/arch/lifecycle/Lifecycle$State;
    ...
    :cond_1
    iget-object p0, p0, mState:Landroid/arch/lifecycle/Lifecycle$State;

    invoke-static {p0, p1}, min(Landroid/arch/lifecycle/Lifecycle$State;Landroid/arch/lifecycle/Lifecycle$State;)Landroid/arch/lifecycle/Lifecycle$State;

    move-result-object p0

    invoke-static {p0, v0}, min(Landroid/arch/lifecycle/Lifecycle$State;Landroid/arch/lifecycle/Lifecycle$State;)Landroid/arch/lifecycle/Lifecycle$State;
...
.method private forwardPass(Landroid/arch/lifecycle/LifecycleOwner;)V
    ...
    invoke-direct {p0, v3}, pushParentState(Landroid/arch/lifecycle/Lifecycle$State;)V

    iget-object v3, v2, Landroid/arch/lifecycle/LifecycleRegistry$ObserverWithState;->mState:Landroid/arch/lifecycle/Lifecycle$State;

    invoke-static {v3}, upEvent(Landroid/arch/lifecycle/Lifecycle$State;)Landroid/arch/lifecycle/Lifecycle$Event;
...
.method private isSynced()Z
    ...
    iget-object v2, p0, mObserverMap:Landroid/arch/core/internal/FastSafeIterableMap;
...
.method private moveToState(Landroid/arch/lifecycle/Lifecycle$State;)V
    ...
    iget-object v0, p0, mState:Landroid/arch/lifecycle/Lifecycle$State;
...
.method private sync()V
    ...
    iget-object v1, p0, mState:Landroid/arch/lifecycle/Lifecycle$State;
    ...
    invoke-direct {p0, v0}, backwardPass(Landroid/arch/lifecycle/LifecycleOwner;)V

    :cond_1
    iget-object v1, p0, mObserverMap:Landroid/arch/core/internal/FastSafeIterableMap;
    ...
    iget-object v2, p0, mState:Landroid/arch/lifecycle/Lifecycle$State;
    ...
    invoke-direct {p0, v0}, forwardPass(Landroid/arch/lifecycle/LifecycleOwner;)V
...
.method public addObserver(Landroid/arch/lifecycle/LifecycleObserver;)V
    ...
    :goto_2
    invoke-direct {p0, p1}, calculateTargetState(Landroid/arch/lifecycle/LifecycleObserver;)Landroid/arch/lifecycle/Lifecycle$State;
    ...
    iget-object v4, p0, mObserverMap:Landroid/arch/core/internal/FastSafeIterableMap;
    ...
    invoke-static {v4}, upEvent(Landroid/arch/lifecycle/Lifecycle$State;)Landroid/arch/lifecycle/Lifecycle$Event;
...
.method public handleLifecycleEvent(Landroid/arch/lifecycle/Lifecycle$Event;)V
    ...
    invoke-static {p1}, getStateAfter(Landroid/arch/lifecycle/Lifecycle$Event;)Landroid/arch/lifecycle/Lifecycle$State;

    move-result-object p1

    invoke-direct {p0, p1}, moveToState(Landroid/arch/lifecycle/Lifecycle$State;)V
...
.method public removeObserver(Landroid/arch/lifecycle/LifecycleObserver;)V
    ...
    iget-object p0, p0, mObserverMap:Landroid/arch/core/internal/FastSafeIterableMap;
