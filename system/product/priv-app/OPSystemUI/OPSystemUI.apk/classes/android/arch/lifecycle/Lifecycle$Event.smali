...
.method static constructor <clinit>()V
    ...
    sput-object v0, ON_CREATE:Landroid/arch/lifecycle/Lifecycle$Event;
    ...
    sput-object v0, ON_START:Landroid/arch/lifecycle/Lifecycle$Event;
    ...
    sput-object v0, ON_RESUME:Landroid/arch/lifecycle/Lifecycle$Event;
    ...
    sput-object v0, ON_PAUSE:Landroid/arch/lifecycle/Lifecycle$Event;
    ...
    sput-object v0, ON_STOP:Landroid/arch/lifecycle/Lifecycle$Event;
    ...
    sput-object v0, ON_DESTROY:Landroid/arch/lifecycle/Lifecycle$Event;
    ...
    sput-object v0, ON_ANY:Landroid/arch/lifecycle/Lifecycle$Event;

    const/4 v0, 0x7

    new-array v0, v0, [Landroid/arch/lifecycle/Lifecycle$Event;

    sget-object v8, ON_CREATE:Landroid/arch/lifecycle/Lifecycle$Event;

    aput-object v8, v0, v1

    sget-object v1, ON_START:Landroid/arch/lifecycle/Lifecycle$Event;

    aput-object v1, v0, v2

    sget-object v1, ON_RESUME:Landroid/arch/lifecycle/Lifecycle$Event;

    aput-object v1, v0, v3

    sget-object v1, ON_PAUSE:Landroid/arch/lifecycle/Lifecycle$Event;

    aput-object v1, v0, v4

    sget-object v1, ON_STOP:Landroid/arch/lifecycle/Lifecycle$Event;

    aput-object v1, v0, v5

    sget-object v1, ON_DESTROY:Landroid/arch/lifecycle/Lifecycle$Event;

    aput-object v1, v0, v6

    sget-object v1, ON_ANY:Landroid/arch/lifecycle/Lifecycle$Event;

    aput-object v1, v0, v7

    sput-object v0, $VALUES:[Landroid/arch/lifecycle/Lifecycle$Event;
...
.method public static values()[Landroid/arch/lifecycle/Lifecycle$Event;
    ...
    sget-object v0, $VALUES:[Landroid/arch/lifecycle/Lifecycle$Event;
