...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    ...
    iput-object v0, p0, mPendingCallbacks:Ljava/util/List;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, mCallbackMap:Ljava/util/HashMap;

    iput-object p2, p0, mSessionToken:Landroid/support/v4/media/session/MediaSessionCompat$Token;

    new-instance p2, Landroid/media/session/MediaController;

    iget-object v0, p0, mSessionToken:Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    iput-object p2, p0, mControllerFwk:Landroid/media/session/MediaController;

    iget-object p1, p0, mControllerFwk:Landroid/media/session/MediaController;

    if-eqz p1, :cond_1

    iget-object p1, p0, mSessionToken:Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    invoke-direct {p0}, requestExtraBinder()V
...
.method private requestExtraBinder()V
    ...
    invoke-virtual {p0, v1, v2, v0}, sendCommand(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
...
.method public getMetadata()Landroid/support/v4/media/MediaMetadataCompat;
    ...
    iget-object p0, p0, mControllerFwk:Landroid/media/session/MediaController;
...
.method processPendingCallbacksLocked()V
    ...
    :cond_0
    iget-object v0, p0, mPendingCallbacks:Ljava/util/List;
    ...
    iget-object v3, p0, mCallbackMap:Ljava/util/HashMap;
    ...
    :try_start_0
    iget-object v3, p0, mSessionToken:Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    :cond_1
    iget-object p0, p0, mPendingCallbacks:Ljava/util/List;
...
.method public final registerCallback(Landroid/support/v4/media/session/MediaControllerCompat$Callback;Landroid/os/Handler;)V
    ...
    iget-object v0, p0, mControllerFwk:Landroid/media/session/MediaController;
    ...
    iget-object v2, p0, mCallbackMap:Ljava/util/HashMap;
    ...
    :try_start_1
    iget-object p0, p0, mSessionToken:Landroid/support/v4/media/session/MediaSessionCompat$Token;
...
.method public final unregisterCallback(Landroid/support/v4/media/session/MediaControllerCompat$Callback;)V
    ...
    :try_start_0
    iget-object v1, p0, mSessionToken:Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    :try_start_1
    iget-object v1, p0, mCallbackMap:Ljava/util/HashMap;
