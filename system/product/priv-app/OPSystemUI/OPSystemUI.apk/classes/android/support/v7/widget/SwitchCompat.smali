...
.method static constructor <clinit>()V
    ...
    sput-object v0, THUMB_POS:Landroid/util/Property;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, mTrackTintList:Landroid/content/res/ColorStateList;

    iput-object v0, p0, mTrackTintMode:Landroid/graphics/PorterDuff$Mode;

    iput-boolean v1, p0, mHasTrackTint:Z

    iput-boolean v1, p0, mHasTrackTintMode:Z
    ...
    iput-object v2, p0, mTextPaint:Landroid/text/TextPaint;
    ...
    iput-object p3, p0, mThumbDrawable:Landroid/graphics/drawable/Drawable;

    iget-object p3, p0, mThumbDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iput-object p3, p0, mTrackDrawable:Landroid/graphics/drawable/Drawable;

    iget-object p3, p0, mTrackDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iput-object p3, p0, mTextOn:Ljava/lang/CharSequence;
    ...
    iput-object p3, p0, mTextOff:Ljava/lang/CharSequence;
    ...
    iput-boolean p3, p0, mShowText:Z
    ...
    iput p3, p0, mThumbTextPadding:I
    ...
    iput-boolean p3, p0, mSplitTrack:Z
    ...
    iput-object p3, p0, mThumbTintList:Landroid/content/res/ColorStateList;

    iput-boolean v3, p0, mHasThumbTint:Z
    ...
    iget-object v4, p0, mThumbTintMode:Landroid/graphics/PorterDuff$Mode;

    if-eq v4, p3, :cond_3

    iput-object p3, p0, mThumbTintMode:Landroid/graphics/PorterDuff$Mode;

    iput-boolean v3, p0, mHasThumbTintMode:Z

    :cond_3
    iget-boolean p3, p0, mHasThumbTint:Z

    if-nez p3, :cond_4

    iget-boolean p3, p0, mHasThumbTintMode:Z
    ...
    iput-object p3, p0, mTrackTintList:Landroid/content/res/ColorStateList;

    iput-boolean v3, p0, mHasTrackTint:Z
    ...
    iput-object p3, p0, mTrackTintMode:Landroid/graphics/PorterDuff$Mode;

    iput-boolean v3, p0, mHasTrackTintMode:Z

    :cond_7
    iget-boolean p3, p0, mHasTrackTint:Z

    if-nez p3, :cond_8

    iget-boolean p3, p0, mHasTrackTintMode:Z
    ...
    invoke-virtual {p0, p1, p3}, setSwitchTextAppearance(Landroid/content/Context;I)V
    ...
    iput p1, p0, mMinFlingVelocity:I
    ...
    invoke-virtual {p0, p1}, setChecked(Z)V
...
.method private animateThumbToCheckedState(Z)V
    ...
    :goto_0
    sget-object v0, THUMB_POS:Landroid/util/Property;
    ...
    iput-object p1, p0, mPositionAnimator:Landroid/animation/ObjectAnimator;

    iget-object p1, p0, mPositionAnimator:Landroid/animation/ObjectAnimator;
    ...
    :cond_1
    iget-object p0, p0, mPositionAnimator:Landroid/animation/ObjectAnimator;
...
.method private hitThumb(FF)Z
    ...
    iget v2, p0, mSwitchTop:I

    iget v3, p0, mTouchSlop:I

    sub-int/2addr v2, v3

    iget v4, p0, mSwitchLeft:I

    add-int/2addr v4, v0

    sub-int/2addr v4, v3

    iget v0, p0, mThumbWidth:I
...
.method private makeLayout(Ljava/lang/CharSequence;)Landroid/text/Layout;
    ...
    iget-object v0, p0, mSwitchTransformationMethod:Landroid/text/method/TransformationMethod;
...
.method private setSwitchTypefaceByIndex(II)V
    ...
    :goto_0
    invoke-virtual {p0, p1, p2}, setSwitchTypeface(Landroid/graphics/Typeface;I)V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget v1, p0, mSwitchLeft:I

    iget v2, p0, mSwitchTop:I

    iget v3, p0, mSwitchRight:I

    iget v4, p0, mSwitchBottom:I
    ...
    :goto_0
    iget-object v7, p0, mTrackDrawable:Landroid/graphics/drawable/Drawable;
...
.method public drawableHotspotChanged(FF)V
    ...
    :cond_1
    iget-object p0, p0, mTrackDrawable:Landroid/graphics/drawable/Drawable;
...
.method protected onCreateDrawableState(I)[I
    ...
    sget-object p0, CHECKED_STATE_SET:[I
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v5, p0, mSplitTrack:Z
    ...
    iget-object v1, p0, mOnLayout:Landroid/text/Layout;

    goto :goto_2

    :cond_4
    iget-object v1, p0, mOffLayout:Landroid/text/Layout;
    ...
    iget-object v6, p0, mTextColors:Landroid/content/res/ColorStateList;
...
.method public onInitializeAccessibilityNodeInfo(Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    iget-object p0, p0, mTextOn:Ljava/lang/CharSequence;

    goto :goto_0

    :cond_0
    iget-object p0, p0, mTextOff:Ljava/lang/CharSequence;
...
.method protected onLayout(ZIIII)V
    ...
    iget-object p1, p0, mThumbDrawable:Landroid/graphics/drawable/Drawable;

    const/4 p2, 0x0

    if-eqz p1, :cond_1

    iget-object p1, p0, mTempRect:Landroid/graphics/Rect;
    ...
    :goto_4
    iput p1, p0, mSwitchLeft:I

    iput p2, p0, mSwitchTop:I

    iput p4, p0, mSwitchBottom:I

    iput p3, p0, mSwitchRight:I
...
.method public onMeasure(II)V
    ...
    iget-object v0, p0, mOnLayout:Landroid/text/Layout;

    if-nez v0, :cond_0

    iget-object v0, p0, mTextOn:Ljava/lang/CharSequence;

    invoke-direct {p0, v0}, makeLayout(Ljava/lang/CharSequence;)Landroid/text/Layout;

    move-result-object v0

    iput-object v0, p0, mOnLayout:Landroid/text/Layout;

    :cond_0
    iget-object v0, p0, mOffLayout:Landroid/text/Layout;
    ...
    iput-object v0, p0, mOffLayout:Landroid/text/Layout;
    ...
    :goto_0
    iget-boolean v4, p0, mShowText:Z

    if-eqz v4, :cond_3

    iget-object v4, p0, mOnLayout:Landroid/text/Layout;

    invoke-virtual {v4}, Landroid/text/Layout;->getWidth()I

    move-result v4

    iget-object v5, p0, mOffLayout:Landroid/text/Layout;
    ...
    iget v5, p0, mThumbTextPadding:I
    ...
    iput v0, p0, mSwitchWidth:I

    iput v1, p0, mSwitchHeight:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-static {v0, v4, v3}, constrain(FFF)F
    ...
    iput p1, p0, mTouchX:F

    invoke-virtual {p0, v0}, setThumbPosition(F)V
    ...
    iput v0, p0, mTouchX:F

    iput v3, p0, mTouchY:F
    ...
    invoke-direct {p0, v0, v2}, hitThumb(FF)Z
...
.method public setChecked(Z)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, setThumbPosition(F)V
...
.method public setSwitchTextAppearance(Landroid/content/Context;I)V
    ...
    iput-object p2, p0, mTextColors:Landroid/content/res/ColorStateList;
    ...
    invoke-direct {p0, p2, v1}, setSwitchTypefaceByIndex(II)V
    ...
    iput-object p2, p0, mSwitchTransformationMethod:Landroid/text/method/TransformationMethod;
...
.method public setSwitchTypeface(Landroid/graphics/Typeface;I)V
    ...
    iget-object p2, p0, mTextPaint:Landroid/text/TextPaint;
    ...
    iget-object p0, p0, mTextPaint:Landroid/text/TextPaint;
