...
.method public constructor <init>(Landroid/view/View;)V
    ...
    iput-object v0, p0, mScroller:Landroid/support/v4/widget/AutoScrollHelper$ClampedScroller;
    ...
    invoke-virtual {p0, v0, v0}, setMaximumVelocity(FF)Landroid/support/v4/widget/AutoScrollHelper;

    int-to-float p1, p1

    invoke-virtual {p0, p1, p1}, setMinimumVelocity(FF)Landroid/support/v4/widget/AutoScrollHelper;

    const/4 p1, 0x1

    invoke-virtual {p0, p1}, setEdgeType(I)Landroid/support/v4/widget/AutoScrollHelper;

    const p1, 0x7f7fffff    # Float.MAX_VALUE

    invoke-virtual {p0, p1, p1}, setMaximumEdges(FF)Landroid/support/v4/widget/AutoScrollHelper;

    const p1, 0x3e4ccccd    # 0.2f

    invoke-virtual {p0, p1, p1}, setRelativeEdges(FF)Landroid/support/v4/widget/AutoScrollHelper;

    const/high16 p1, 0x3f800000    # 1.0f

    invoke-virtual {p0, p1, p1}, setRelativeVelocity(FF)Landroid/support/v4/widget/AutoScrollHelper;

    sget p1, DEFAULT_ACTIVATION_DELAY:I

    invoke-virtual {p0, p1}, setActivationDelay(I)Landroid/support/v4/widget/AutoScrollHelper;

    const/16 p1, 0x1f4

    invoke-virtual {p0, p1}, setRampUpDuration(I)Landroid/support/v4/widget/AutoScrollHelper;

    invoke-virtual {p0, p1}, setRampDownDuration(I)Landroid/support/v4/widget/AutoScrollHelper;
...
.method private requestStop()V
    ...
    :cond_0
    iget-object p0, p0, mScroller:Landroid/support/v4/widget/AutoScrollHelper$ClampedScroller;
...
.method public onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    iget-object p2, p0, mScroller:Landroid/support/v4/widget/AutoScrollHelper$ClampedScroller;
...
.method public setRampDownDuration(I)Landroid/support/v4/widget/AutoScrollHelper;
    ...
    iget-object v0, p0, mScroller:Landroid/support/v4/widget/AutoScrollHelper$ClampedScroller;
