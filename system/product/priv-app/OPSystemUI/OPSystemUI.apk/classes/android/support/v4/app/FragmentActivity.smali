...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mFragments:Landroid/support/v4/app/FragmentController;

    const/4 v0, 0x1

    iput-boolean v0, p0, mStopped:Z

    iput-boolean v0, p0, mReallyStopped:Z
...
.method private markFragmentsCreated()V
    ...
    :cond_0
    invoke-virtual {p0}, getSupportFragmentManager()Landroid/support/v4/app/FragmentManager;

    move-result-object v0

    sget-object v1, Landroid/arch/lifecycle/Lifecycle$State;->CREATED:Landroid/arch/lifecycle/Lifecycle$State;

    invoke-static {v0, v1}, markState(Landroid/support/v4/app/FragmentManager;Landroid/arch/lifecycle/Lifecycle$State;)Z
...
.method private static markState(Landroid/support/v4/app/FragmentManager;Landroid/arch/lifecycle/Lifecycle$State;)Z
    ...
    invoke-static {v1, p1}, markState(Landroid/support/v4/app/FragmentManager;Landroid/arch/lifecycle/Lifecycle$State;)Z
...
.method final dispatchFragmentsOnCreateView(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    iget-object p0, p0, mFragments:Landroid/support/v4/app/FragmentController;
...
.method doReallyStop(Z)V
    ...
    iget-boolean v0, p0, mReallyStopped:Z
    ...
    iput-boolean p1, p0, mRetaining:Z

    iget-object p1, p0, mHandler:Landroid/os/Handler;

    invoke-virtual {p1, v0}, Landroid/os/Handler;->removeMessages(I)V

    invoke-virtual {p0}, onReallyStop()V
...
.method public dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-boolean v1, p0, mReallyStopped:Z
...
.method protected onActivityResult(IILandroid/content/Intent;)V
    ...
    iget-object v0, p0, mFragments:Landroid/support/v4/app/FragmentController;
    ...
    iget-object v1, p0, mPendingFragmentActivityResults:Landroid/support/v4/util/SparseArrayCompat;
    ...
    iget-object v2, p0, mPendingFragmentActivityResults:Landroid/support/v4/util/SparseArrayCompat;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v2, p0, mViewModelStore:Landroid/arch/lifecycle/ViewModelStore;
    ...
    iget-object v4, p0, mFragments:Landroid/support/v4/app/FragmentController;
    ...
    iput-object v1, p0, mPendingFragmentActivityResults:Landroid/support/v4/util/SparseArrayCompat;
    ...
    iget-object v3, p0, mPendingFragmentActivityResults:Landroid/support/v4/util/SparseArrayCompat;
    ...
    :cond_4
    iget-object p1, p0, mPendingFragmentActivityResults:Landroid/support/v4/util/SparseArrayCompat;
    ...
    iput-object p1, p0, mPendingFragmentActivityResults:Landroid/support/v4/util/SparseArrayCompat;
...
.method protected onDestroy()V
    ...
    invoke-virtual {p0, v0}, doReallyStop(Z)V

    iget-object v0, p0, mViewModelStore:Landroid/arch/lifecycle/ViewModelStore;

    if-eqz v0, :cond_0

    iget-boolean v1, p0, mRetaining:Z
...
.method public final onRetainNonConfigurationInstance()Ljava/lang/Object;
    ...
    iget-object v1, p0, mFragments:Landroid/support/v4/app/FragmentController;
    ...
    iget-object v2, p0, mViewModelStore:Landroid/arch/lifecycle/ViewModelStore;
...
.method protected onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    :cond_0
    iget-object v0, p0, mPendingFragmentActivityResults:Landroid/support/v4/util/SparseArrayCompat;
