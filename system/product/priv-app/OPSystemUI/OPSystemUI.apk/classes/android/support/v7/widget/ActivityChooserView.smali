...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, mModelDataSetObserver:Landroid/database/DataSetObserver;
    ...
    iput-object v0, p0, mOnGlobalLayoutListener:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;

    const/4 v0, 0x4

    iput v0, p0, mInitialActivityCount:I
    ...
    iput p3, p0, mInitialActivityCount:I
    ...
    iput-object p2, p0, mCallbacks:Landroid/support/v7/widget/ActivityChooserView$Callbacks;
    ...
    iput-object p2, p0, mActivityChooserContent:Landroid/view/View;

    iget-object p2, p0, mActivityChooserContent:Landroid/view/View;

    invoke-virtual {p2}, Landroid/view/View;->getBackground()Landroid/graphics/drawable/Drawable;

    move-result-object p2

    iput-object p2, p0, mActivityChooserContentBackground:Landroid/graphics/drawable/Drawable;
    ...
    iput-object p2, p0, mDefaultActivityButton:Landroid/widget/FrameLayout;

    iget-object p2, p0, mDefaultActivityButton:Landroid/widget/FrameLayout;

    iget-object v0, p0, mCallbacks:Landroid/support/v7/widget/ActivityChooserView$Callbacks;
    ...
    iput-object p2, p0, mDefaultActivityButtonImage:Landroid/widget/ImageView;
    ...
    iput-object p2, p0, mExpandActivityOverflowButton:Landroid/widget/FrameLayout;
    ...
    iput-object p2, p0, mExpandActivityOverflowButtonImage:Landroid/widget/ImageView;

    iget-object p2, p0, mExpandActivityOverflowButtonImage:Landroid/widget/ImageView;
    ...
    iput-object p2, p0, mAdapter:Landroid/support/v7/widget/ActivityChooserView$ActivityChooserViewAdapter;

    iget-object p2, p0, mAdapter:Landroid/support/v7/widget/ActivityChooserView$ActivityChooserViewAdapter;
    ...
    iput p1, p0, mListPopupMaxWidth:I
...
.method public dismissPopup()Z
    ...
    invoke-virtual {p0}, getListPopupWindow()Landroid/support/v7/widget/ListPopupWindow;
    ...
    iget-object p0, p0, mOnGlobalLayoutListener:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
...
.method getListPopupWindow()Landroid/support/v7/widget/ListPopupWindow;
    ...
    iget-object v0, p0, mListPopupWindow:Landroid/support/v7/widget/ListPopupWindow;
    ...
    iput-object v0, p0, mListPopupWindow:Landroid/support/v7/widget/ListPopupWindow;

    iget-object v0, p0, mListPopupWindow:Landroid/support/v7/widget/ListPopupWindow;

    iget-object v1, p0, mAdapter:Landroid/support/v7/widget/ActivityChooserView$ActivityChooserViewAdapter;
    ...
    iget-object v1, p0, mCallbacks:Landroid/support/v7/widget/ActivityChooserView$Callbacks;
    ...
    :cond_0
    iget-object p0, p0, mListPopupWindow:Landroid/support/v7/widget/ListPopupWindow;
...
.method protected onAttachedToWindow()V
    ...
    iget-object v0, p0, mAdapter:Landroid/support/v7/widget/ActivityChooserView$ActivityChooserViewAdapter;
    ...
    iget-object v1, p0, mModelDataSetObserver:Landroid/database/DataSetObserver;
...
.method protected onLayout(ZIIII)V
    ...
    iget-object p1, p0, mActivityChooserContent:Landroid/view/View;
...
.method protected onMeasure(II)V
    ...
    iget-object v0, p0, mActivityChooserContent:Landroid/view/View;
...
.method public showPopup()Z
    ...
    :cond_0
    iput-boolean v1, p0, mIsSelectingDefaultActivity:Z

    iget v0, p0, mInitialActivityCount:I

    invoke-virtual {p0, v0}, showPopupUnchecked(I)V
...
.method showPopupUnchecked(I)V
    ...
    :goto_0
    iget-object v3, p0, mAdapter:Landroid/support/v7/widget/ActivityChooserView$ActivityChooserViewAdapter;
    ...
    iget-boolean v3, p0, mIsSelectingDefaultActivity:Z
    ...
    iget v3, p0, mListPopupMaxWidth:I
    ...
    iget-object v0, p0, mProvider:Landroid/support/v4/view/ActionProvider;
...
.method updateAppearance()V
    ...
    iget-object v4, p0, mDefaultActivityButtonImage:Landroid/widget/ImageView;
    ...
    iget v4, p0, mDefaultActionButtonContentDescription:I
    ...
    iget-object p0, p0, mActivityChooserContentBackground:Landroid/graphics/drawable/Drawable;
    ...
    :cond_4
    iget-object p0, p0, mActivityChooserContent:Landroid/view/View;
