...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    ...
    iput-object v0, p0, mRegisteredCallbacks:Ljava/util/concurrent/ConcurrentHashMap;

    if-eqz p2, :cond_1

    iput-object p2, p0, mToken:Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    iput-object v0, p0, mImpl:Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImpl;
    ...
    iput-object p1, p0, mImpl:Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImpl;
...
.method public getMetadata()Landroid/support/v4/media/MediaMetadataCompat;
    ...
    iget-object p0, p0, mImpl:Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImpl;
...
.method public registerCallback(Landroid/support/v4/media/session/MediaControllerCompat$Callback;)V
    ...
    invoke-virtual {p0, p1, v0}, registerCallback(Landroid/support/v4/media/session/MediaControllerCompat$Callback;Landroid/os/Handler;)V
...
.method public registerCallback(Landroid/support/v4/media/session/MediaControllerCompat$Callback;Landroid/os/Handler;)V
    ...
    iget-object v0, p0, mRegisteredCallbacks:Ljava/util/concurrent/ConcurrentHashMap;
