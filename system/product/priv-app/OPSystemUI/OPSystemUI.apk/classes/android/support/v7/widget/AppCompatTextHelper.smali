...
.method constructor <init>(Landroid/widget/TextView;)V
    ...
    iput-object p1, p0, mAutoSizeTextHelper:Landroid/support/v7/widget/AppCompatTextViewAutoSizeHelper;
...
.method static synthetic access$000(Landroid/support/v7/widget/AppCompatTextHelper;Ljava/lang/ref/WeakReference;Landroid/graphics/Typeface;)V
    ...
    invoke-direct {p0, p1, p2}, onAsyncTypefaceReceived(Ljava/lang/ref/WeakReference;Landroid/graphics/Typeface;)V
...
.method private setTextSizeInternal(IF)V
    ...
    iget-object p0, p0, mAutoSizeTextHelper:Landroid/support/v7/widget/AppCompatTextViewAutoSizeHelper;
...
.method private updateTypefaceAndStyle(Landroid/content/Context;Landroid/support/v7/widget/TintTypedArray;)V
    ...
    iput-boolean v1, p0, mAsyncFontPending:Z
    ...
    iget-object v3, p0, mView:Landroid/widget/TextView;
...
.method applyCompoundDrawablesTints()V
    ...
    iget-object v0, p0, mDrawableLeftTint:Landroid/support/v7/widget/TintInfo;
    ...
    iget-object v0, p0, mDrawableTopTint:Landroid/support/v7/widget/TintInfo;

    if-nez v0, :cond_0

    iget-object v0, p0, mDrawableRightTint:Landroid/support/v7/widget/TintInfo;

    if-nez v0, :cond_0

    iget-object v0, p0, mDrawableBottomTint:Landroid/support/v7/widget/TintInfo;
    ...
    iget-object v4, p0, mDrawableLeftTint:Landroid/support/v7/widget/TintInfo;

    invoke-direct {p0, v3, v4}, applyCompoundDrawableTint(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/TintInfo;)V

    const/4 v3, 0x1

    aget-object v3, v0, v3

    iget-object v4, p0, mDrawableTopTint:Landroid/support/v7/widget/TintInfo;

    invoke-direct {p0, v3, v4}, applyCompoundDrawableTint(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/TintInfo;)V

    aget-object v3, v0, v1

    iget-object v4, p0, mDrawableRightTint:Landroid/support/v7/widget/TintInfo;
    ...
    iget-object v3, p0, mDrawableBottomTint:Landroid/support/v7/widget/TintInfo;

    invoke-direct {p0, v0, v3}, applyCompoundDrawableTint(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/TintInfo;)V
    ...
    iget-object v0, p0, mDrawableStartTint:Landroid/support/v7/widget/TintInfo;

    if-nez v0, :cond_2

    iget-object v0, p0, mDrawableEndTint:Landroid/support/v7/widget/TintInfo;
    ...
    iget-object v3, p0, mDrawableStartTint:Landroid/support/v7/widget/TintInfo;

    invoke-direct {p0, v2, v3}, applyCompoundDrawableTint(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/TintInfo;)V

    aget-object v0, v0, v1

    iget-object v1, p0, mDrawableEndTint:Landroid/support/v7/widget/TintInfo;

    invoke-direct {p0, v0, v1}, applyCompoundDrawableTint(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/TintInfo;)V
...
.method loadFromAttributes(Landroid/util/AttributeSet;I)V
    ...
    iget-object v3, v0, mView:Landroid/widget/TextView;
    ...
    invoke-static {v3, v4, v9}, createTintInfo(Landroid/content/Context;Landroid/support/v7/widget/AppCompatDrawableManager;I)Landroid/support/v7/widget/TintInfo;

    move-result-object v9

    iput-object v9, v0, mDrawableLeftTint:Landroid/support/v7/widget/TintInfo;
    ...
    iput-object v9, v0, mDrawableTopTint:Landroid/support/v7/widget/TintInfo;
    ...
    iput-object v9, v0, mDrawableRightTint:Landroid/support/v7/widget/TintInfo;
    ...
    iput-object v9, v0, mDrawableBottomTint:Landroid/support/v7/widget/TintInfo;
    ...
    iput-object v9, v0, mDrawableStartTint:Landroid/support/v7/widget/TintInfo;
    ...
    iput-object v4, v0, mDrawableEndTint:Landroid/support/v7/widget/TintInfo;

    :cond_5
    invoke-virtual {v5}, Landroid/support/v7/widget/TintTypedArray;->recycle()V

    iget-object v4, v0, mView:Landroid/widget/TextView;
    ...
    :goto_0
    invoke-direct {v0, v3, v7}, updateTypefaceAndStyle(Landroid/content/Context;Landroid/support/v7/widget/TintTypedArray;)V
    ...
    iget-object v7, v0, mView:Landroid/widget/TextView;
    ...
    invoke-virtual {v0, v12}, setAllCaps(Z)V

    :cond_13
    iget-object v4, v0, mFontTypeface:Landroid/graphics/Typeface;

    if-eqz v4, :cond_14

    iget-object v5, v0, mView:Landroid/widget/TextView;
    ...
    :cond_14
    iget-object v4, v0, mAutoSizeTextHelper:Landroid/support/v7/widget/AppCompatTextViewAutoSizeHelper;
    ...
    iget-object v2, v0, mAutoSizeTextHelper:Landroid/support/v7/widget/AppCompatTextViewAutoSizeHelper;
    ...
    iget-object v2, v0, mView:Landroid/widget/TextView;
    ...
    iget-object v5, v0, mAutoSizeTextHelper:Landroid/support/v7/widget/AppCompatTextViewAutoSizeHelper;

    invoke-virtual {v5}, Landroid/support/v7/widget/AppCompatTextViewAutoSizeHelper;->getAutoSizeMaxTextSize()I

    move-result v5

    iget-object v7, v0, mAutoSizeTextHelper:Landroid/support/v7/widget/AppCompatTextViewAutoSizeHelper;
    ...
    iget-object v1, v0, mView:Landroid/widget/TextView;
    ...
    iget-object v0, v0, mView:Landroid/widget/TextView;
...
.method onSetTextAppearance(Landroid/content/Context;I)V
    ...
    :cond_1
    invoke-direct {p0, p1, p2}, updateTypefaceAndStyle(Landroid/content/Context;Landroid/support/v7/widget/TintTypedArray;)V
