...
.method constructor <init>(Landroidx/recyclerview/widget/DiffUtil$Callback;Ljava/util/List;[I[IZ)V
    ...
    iput-object p2, p0, mSnakes:Ljava/util/List;

    iput-object p3, p0, mOldItemStatuses:[I

    iput-object p4, p0, mNewItemStatuses:[I

    iget-object p2, p0, mOldItemStatuses:[I

    const/4 p3, 0x0

    invoke-static {p2, p3}, Ljava/util/Arrays;->fill([II)V

    iget-object p2, p0, mNewItemStatuses:[I

    invoke-static {p2, p3}, Ljava/util/Arrays;->fill([II)V

    iput-object p1, p0, mCallback:Landroidx/recyclerview/widget/DiffUtil$Callback;

    invoke-virtual {p1}, Landroidx/recyclerview/widget/DiffUtil$Callback;->getOldListSize()I

    move-result p2

    iput p2, p0, mOldListSize:I

    invoke-virtual {p1}, Landroidx/recyclerview/widget/DiffUtil$Callback;->getNewListSize()I

    move-result p1

    iput p1, p0, mNewListSize:I

    iput-boolean p5, p0, mDetectMoves:Z

    invoke-direct {p0}, addRootSnake()V

    invoke-direct {p0}, findMatchingItems()V
...
.method private addRootSnake()V
    ...
    iget-object v0, p0, mSnakes:Ljava/util/List;
    ...
    iget-object p0, p0, mSnakes:Ljava/util/List;
...
.method private dispatchAdditions(Ljava/util/List;Landroidx/recyclerview/widget/ListUpdateCallback;III)V
    ...
    iget-boolean v0, p0, mDetectMoves:Z
    ...
    iget-object v1, p0, mNewItemStatuses:[I
    ...
    :cond_2
    iget-object v4, p0, mNewItemStatuses:[I

    aget v4, v4, v2

    shr-int/lit8 v4, v4, 0x5

    invoke-static {p1, v4, v0}, removePostponedUpdate(Ljava/util/List;IZ)Landroidx/recyclerview/widget/DiffUtil$PostponedUpdate;
    ...
    iget-object v1, p0, mCallback:Landroidx/recyclerview/widget/DiffUtil$Callback;
...
.method private dispatchRemovals(Ljava/util/List;Landroidx/recyclerview/widget/ListUpdateCallback;III)V
    ...
    iget-object v1, p0, mOldItemStatuses:[I
    ...
    :cond_2
    iget-object v4, p0, mOldItemStatuses:[I
    ...
    invoke-static {p1, v4, v5}, removePostponedUpdate(Ljava/util/List;IZ)Landroidx/recyclerview/widget/DiffUtil$PostponedUpdate;
    ...
    iget-object v3, p0, mCallback:Landroidx/recyclerview/widget/DiffUtil$Callback;
...
.method private findAddition(III)V
    ...
    iget-object v0, p0, mOldItemStatuses:[I
    ...
    invoke-direct {p0, p1, p2, p3, v0}, findMatchingItem(IIIZ)Z
...
.method private findMatchingItem(IIIZ)Z
    ...
    iget-object v2, p0, mSnakes:Ljava/util/List;
    ...
    iget-object p2, p0, mCallback:Landroidx/recyclerview/widget/DiffUtil$Callback;
    ...
    iget-object p1, p0, mCallback:Landroidx/recyclerview/widget/DiffUtil$Callback;
    ...
    :goto_2
    iget-object p1, p0, mNewItemStatuses:[I
    ...
    iget-object p0, p0, mOldItemStatuses:[I
    ...
    iget-object v0, p0, mCallback:Landroidx/recyclerview/widget/DiffUtil$Callback;
    ...
    iget-object p3, p0, mCallback:Landroidx/recyclerview/widget/DiffUtil$Callback;
    ...
    :goto_4
    iget-object p3, p0, mOldItemStatuses:[I
    ...
    iget-object p0, p0, mNewItemStatuses:[I
...
.method private findMatchingItems()V
    ...
    iget v0, p0, mOldListSize:I

    iget v1, p0, mNewListSize:I
    ...
    iget-object v4, p0, mSnakes:Ljava/util/List;
    ...
    iget-boolean v6, p0, mDetectMoves:Z
    ...
    invoke-direct {p0, v0, v1, v2}, findAddition(III)V
    ...
    invoke-direct {p0, v0, v1, v2}, findRemoval(III)V
    ...
    iget-object v6, p0, mCallback:Landroidx/recyclerview/widget/DiffUtil$Callback;
    ...
    :goto_4
    iget-object v7, p0, mOldItemStatuses:[I
    ...
    iget-object v7, p0, mNewItemStatuses:[I
...
.method private findRemoval(III)V
    ...
    iget-object v0, p0, mNewItemStatuses:[I
...
.method public dispatchUpdatesTo(Landroidx/recyclerview/widget/ListUpdateCallback;)V
    ...
    iget v1, p0, mOldListSize:I

    iget v2, p0, mNewListSize:I

    iget-object v3, p0, mSnakes:Ljava/util/List;
    ...
    invoke-direct/range {v1 .. v6}, dispatchRemovals(Ljava/util/List;Landroidx/recyclerview/widget/ListUpdateCallback;III)V
    ...
    invoke-direct/range {v1 .. v6}, dispatchAdditions(Ljava/util/List;Landroidx/recyclerview/widget/ListUpdateCallback;III)V
...
.method public dispatchUpdatesTo(Landroidx/recyclerview/widget/RecyclerView$Adapter;)V
    ...
    invoke-virtual {p0, v0}, dispatchUpdatesTo(Landroidx/recyclerview/widget/ListUpdateCallback;)V
