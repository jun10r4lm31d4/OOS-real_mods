...
.method static constructor <clinit>()V
    ...
    sput-object v1, NESTED_SCROLLING_ATTRS:[I
    ...
    sput-object v1, CLIP_TO_PADDING_ATTR:[I
    ...
    :goto_1
    sput-boolean v1, FORCE_INVALIDATE_DISPLAY_LIST:Z
    ...
    :goto_2
    sput-boolean v1, ALLOW_SIZE_IN_UNSPECIFIED_SPEC:Z
    ...
    :goto_3
    sput-boolean v1, POST_UPDATES_ON_ANIMATION:Z
    ...
    :goto_4
    sput-boolean v1, ALLOW_THREAD_GAP_WORK:Z
    ...
    :goto_5
    sput-boolean v1, FORCE_ABS_FOCUS_SEARCH_DIRECTION:Z
    ...
    :goto_6
    sput-boolean v1, IGNORE_DETACHED_FOCUSED_CHILD:Z
    ...
    sput-object v1, LAYOUT_MANAGER_CONSTRUCTOR_SIGNATURE:[Ljava/lang/Class;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, v7, mObserver:Landroidx/recyclerview/widget/RecyclerView$RecyclerViewDataObserver;
    ...
    iput-object v0, v7, mRecycler:Landroidx/recyclerview/widget/RecyclerView$Recycler;
    ...
    iput-object v0, v7, mViewInfoStore:Landroidx/recyclerview/widget/ViewInfoStore;
    ...
    iput-object v0, v7, mUpdateChildViewsRunnable:Ljava/lang/Runnable;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, v7, mTempRect:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, v7, mTempRect2:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, v7, mTempRectF:Landroid/graphics/RectF;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, v7, mItemDecorations:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, v7, mOnItemTouchListeners:Ljava/util/ArrayList;

    const/4 v11, 0x0

    iput v11, v7, mInterceptRequestLayoutDepth:I

    iput-boolean v11, v7, mDataSetHasChangedAfterLayout:Z

    iput-boolean v11, v7, mDispatchItemsChangedEvent:Z

    iput v11, v7, mLayoutOrScrollCounter:I

    iput v11, v7, mDispatchScrollCounter:I
    ...
    iput-object v0, v7, mEdgeEffectFactory:Landroidx/recyclerview/widget/RecyclerView$EdgeEffectFactory;

    new-instance v0, Landroidx/recyclerview/widget/DefaultItemAnimator;

    invoke-direct {v0}, Landroidx/recyclerview/widget/DefaultItemAnimator;-><init>()V

    iput-object v0, v7, mItemAnimator:Landroidx/recyclerview/widget/RecyclerView$ItemAnimator;

    iput v11, v7, mScrollState:I

    const/4 v12, -0x1

    iput v12, v7, mScrollPointerId:I

    const/4 v0, 0x1

    iput v0, v7, mScaledHorizontalScrollFactor:F

    iput v0, v7, mScaledVerticalScrollFactor:F

    const/4 v13, 0x1

    iput-boolean v13, v7, mPreserveFocusAfterLayout:Z
    ...
    iput-object v0, v7, mViewFlinger:Landroidx/recyclerview/widget/RecyclerView$ViewFlinger;

    sget-boolean v0, ALLOW_THREAD_GAP_WORK:Z
    ...
    :goto_0
    iput-object v0, v7, mPrefetchRegistry:Landroidx/recyclerview/widget/GapWorker$LayoutPrefetchRegistryImpl;
    ...
    iput-object v0, v7, mState:Landroidx/recyclerview/widget/RecyclerView$State;

    iput-boolean v11, v7, mItemsAddedOrRemoved:Z

    iput-boolean v11, v7, mItemsChanged:Z
    ...
    iput-object v0, v7, mItemAnimatorListener:Landroidx/recyclerview/widget/RecyclerView$ItemAnimator$ItemAnimatorListener;

    iput-boolean v11, v7, mPostedAnimatorRunner:Z

    const/4 v0, 0x2

    new-array v1, v0, [I

    iput-object v1, v7, mMinMaxLayoutPositions:[I

    new-array v1, v0, [I

    iput-object v1, v7, mScrollOffset:[I

    new-array v1, v0, [I

    iput-object v1, v7, mNestedOffsets:[I

    new-array v1, v0, [I

    iput-object v1, v7, mReusableIntPair:[I

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, v7, mPendingAccessibilityImportanceChange:Ljava/util/List;
    ...
    iput-object v1, v7, mItemAnimatorRunner:Ljava/lang/Runnable;
    ...
    iput-object v1, v7, mViewInfoProcessCallback:Landroidx/recyclerview/widget/ViewInfoStore$ProcessCallback;

    if-eqz v9, :cond_1

    sget-object v1, CLIP_TO_PADDING_ATTR:[I
    ...
    iput-boolean v2, v7, mClipToPadding:Z
    ...
    :cond_1
    iput-boolean v13, v7, mClipToPadding:Z
    ...
    iput v2, v7, mScaledHorizontalScrollFactor:F
    ...
    iput v2, v7, mScaledVerticalScrollFactor:F

    invoke-virtual {v1}, Landroid/view/ViewConfiguration;->getScaledMinimumFlingVelocity()I

    move-result v2

    iput v2, v7, mMinFlingVelocity:I

    invoke-virtual {v1}, Landroid/view/ViewConfiguration;->getScaledMaximumFlingVelocity()I

    move-result v1

    iput v1, v7, mMaxFlingVelocity:I
    ...
    iget-object v0, v7, mItemAnimator:Landroidx/recyclerview/widget/RecyclerView$ItemAnimator;

    iget-object v1, v7, mItemAnimatorListener:Landroidx/recyclerview/widget/RecyclerView$ItemAnimator$ItemAnimatorListener;
    ...
    invoke-virtual/range {p0 .. p0}, initAdapterManager()V

    invoke-direct/range {p0 .. p0}, initChildrenHelper()V

    invoke-direct/range {p0 .. p0}, initAutofill()V
    ...
    iput-object v0, v7, mAccessibilityManager:Landroid/view/accessibility/AccessibilityManager;
    ...
    invoke-virtual {v7, v0}, setAccessibilityDelegateCompat(Landroidx/recyclerview/widget/RecyclerViewAccessibilityDelegate;)V
    ...
    iput-boolean v0, v7, mEnableFastScroller:Z

    iget-boolean v0, v7, mEnableFastScroller:Z
    ...
    invoke-virtual {v7, v0, v1, v3, v4}, initFastScroller(Landroid/graphics/drawable/StateListDrawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/StateListDrawable;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-direct/range {v0 .. v5}, createLayoutManager(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;II)V
    ...
    sget-object v0, NESTED_SCROLLING_ATTRS:[I
    ...
    sget-object v2, NESTED_SCROLLING_ATTRS:[I
    ...
    :goto_5
    invoke-virtual {v7, v13}, setNestedScrollingEnabled(Z)V
...
.method private addAnimatingView(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
    ...
    :goto_0
    iget-object v3, p0, mRecycler:Landroidx/recyclerview/widget/RecyclerView$Recycler;

    invoke-virtual {p0, v0}, getChildViewHolder(Landroid/view/View;)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    ...
    iget-object p0, p0, mChildHelper:Landroidx/recyclerview/widget/ChildHelper;
...
.method private animateChange(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;Landroidx/recyclerview/widget/RecyclerView$ItemAnimator$ItemHolderInfo;Landroidx/recyclerview/widget/RecyclerView$ItemAnimator$ItemHolderInfo;ZZ)V
    ...
    invoke-direct {p0, p1}, addAnimatingView(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
    ...
    invoke-direct {p0, p2}, addAnimatingView(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
    ...
    iget-object p5, p0, mRecycler:Landroidx/recyclerview/widget/RecyclerView$Recycler;
    ...
    :cond_2
    iget-object p5, p0, mItemAnimator:Landroidx/recyclerview/widget/RecyclerView$ItemAnimator;
    ...
    invoke-virtual {p0}, postAnimationRunner()V
...
.method private createLayoutManager(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;II)V
    ...
    :try_start_1
    sget-object v5, LAYOUT_MANAGER_CONSTRUCTOR_SIGNATURE:[Ljava/lang/Class;
    ...
    invoke-virtual {p0, p1}, setLayoutManager(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;)V
...
.method private didChildRangeChange(II)Z
    ...
    iget-object v0, p0, mMinMaxLayoutPositions:[I

    invoke-direct {p0, v0}, findMinMaxChildLayoutPositions([I)V

    iget-object p0, p0, mMinMaxLayoutPositions:[I
...
.method private dispatchLayoutStep1()V
    ...
    iget-object v0, p0, mState:Landroidx/recyclerview/widget/RecyclerView$State;
    ...
    invoke-virtual {p0, v0}, fillRemainingScrollValues(Landroidx/recyclerview/widget/RecyclerView$State;)V
    ...
    invoke-virtual {p0}, startInterceptRequestLayout()V

    iget-object v0, p0, mViewInfoStore:Landroidx/recyclerview/widget/ViewInfoStore;

    invoke-virtual {v0}, Landroidx/recyclerview/widget/ViewInfoStore;->clear()V

    invoke-virtual {p0}, onEnterLayoutOrScroll()V

    invoke-direct {p0}, processAdapterUpdatesAndSetAnimationFlags()V

    invoke-direct {p0}, saveFocusInfo()V
    ...
    iget-boolean v3, p0, mItemsChanged:Z
    ...
    iput-boolean v2, p0, mItemsChanged:Z

    iput-boolean v2, p0, mItemsAddedOrRemoved:Z
    ...
    iget-object v1, p0, mAdapter:Landroidx/recyclerview/widget/RecyclerView$Adapter;
    ...
    iget-object v0, p0, mChildHelper:Landroidx/recyclerview/widget/ChildHelper;
    ...
    iget-object v3, p0, mChildHelper:Landroidx/recyclerview/widget/ChildHelper;

    invoke-virtual {v3, v1}, Landroidx/recyclerview/widget/ChildHelper;->getChildAt(I)Landroid/view/View;

    move-result-object v3

    invoke-static {v3}, getChildViewHolderInt(Landroid/view/View;)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    ...
    iget-object v4, p0, mAdapter:Landroidx/recyclerview/widget/RecyclerView$Adapter;
    ...
    :cond_1
    iget-object v4, p0, mItemAnimator:Landroidx/recyclerview/widget/RecyclerView$ItemAnimator;

    iget-object v5, p0, mState:Landroidx/recyclerview/widget/RecyclerView$State;
    ...
    iget-object v5, p0, mViewInfoStore:Landroidx/recyclerview/widget/ViewInfoStore;
    ...
    iget-object v4, p0, mState:Landroidx/recyclerview/widget/RecyclerView$State;
    ...
    invoke-virtual {p0, v3}, getChangedHolderKey(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)J

    move-result-wide v4

    iget-object v6, p0, mViewInfoStore:Landroidx/recyclerview/widget/ViewInfoStore;
    ...
    invoke-virtual {p0}, saveOldPositions()V
    ...
    iget-object v3, p0, mLayout:Landroidx/recyclerview/widget/RecyclerView$LayoutManager;

    iget-object v4, p0, mRecycler:Landroidx/recyclerview/widget/RecyclerView$Recycler;
    ...
    :goto_3
    iget-object v1, p0, mChildHelper:Landroidx/recyclerview/widget/ChildHelper;
    ...
    invoke-static {v1}, getChildViewHolderInt(Landroid/view/View;)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    ...
    :cond_4
    iget-object v3, p0, mViewInfoStore:Landroidx/recyclerview/widget/ViewInfoStore;
    ...
    :cond_5
    iget-object v5, p0, mItemAnimator:Landroidx/recyclerview/widget/RecyclerView$ItemAnimator;

    iget-object v6, p0, mState:Landroidx/recyclerview/widget/RecyclerView$State;
    ...
    invoke-virtual {p0, v1, v3}, recordAnimationInfoIfBouncedHiddenView(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;Landroidx/recyclerview/widget/RecyclerView$ItemAnimator$ItemHolderInfo;)V

    goto :goto_4

    :cond_6
    iget-object v4, p0, mViewInfoStore:Landroidx/recyclerview/widget/ViewInfoStore;
    ...
    :cond_8
    invoke-virtual {p0}, clearOldPositions()V
    ...
    :goto_5
    invoke-virtual {p0}, onExitLayoutOrScroll()V

    invoke-virtual {p0, v2}, stopInterceptRequestLayout(Z)V

    iget-object p0, p0, mState:Landroidx/recyclerview/widget/RecyclerView$State;
...
.method private dispatchLayoutStep2()V
    ...
    iget-object v0, p0, mAdapterHelper:Landroidx/recyclerview/widget/AdapterHelper;
    ...
    iget-object v2, p0, mLayout:Landroidx/recyclerview/widget/RecyclerView$LayoutManager;
    ...
    iput-object v2, p0, mPendingSavedState:Landroidx/recyclerview/widget/RecyclerView$SavedState;

    iget-boolean v2, v0, Landroidx/recyclerview/widget/RecyclerView$State;->mRunSimpleAnimations:Z

    if-eqz v2, :cond_0

    iget-object v2, p0, mItemAnimator:Landroidx/recyclerview/widget/RecyclerView$ItemAnimator;
    ...
    invoke-virtual {p0, v1}, stopInterceptRequestLayout(Z)V
...
.method private dispatchLayoutStep3()V
    ...
    iget-object v2, p0, mChildHelper:Landroidx/recyclerview/widget/ChildHelper;

    invoke-virtual {v2, v0}, Landroidx/recyclerview/widget/ChildHelper;->getChildAt(I)Landroid/view/View;

    move-result-object v2

    invoke-static {v2}, getChildViewHolderInt(Landroid/view/View;)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    ...
    :cond_0
    invoke-virtual {p0, v5}, getChangedHolderKey(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)J
    ...
    iget-object v7, p0, mViewInfoStore:Landroidx/recyclerview/widget/ViewInfoStore;
    ...
    iget-object v2, p0, mViewInfoStore:Landroidx/recyclerview/widget/ViewInfoStore;
    ...
    iget-object v10, p0, mViewInfoStore:Landroidx/recyclerview/widget/ViewInfoStore;
    ...
    invoke-direct {p0, v2, v3, v5, v6}, handleMissingPreInfoForChangeError(JLandroidx/recyclerview/widget/RecyclerView$ViewHolder;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
    ...
    invoke-direct/range {v3 .. v9}, animateChange(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;Landroidx/recyclerview/widget/RecyclerView$ItemAnimator$ItemHolderInfo;Landroidx/recyclerview/widget/RecyclerView$ItemAnimator$ItemHolderInfo;ZZ)V
    ...
    iget-object v2, p0, mViewInfoProcessCallback:Landroidx/recyclerview/widget/ViewInfoStore$ProcessCallback;
    ...
    :cond_5
    iget-object v0, p0, mLayout:Landroidx/recyclerview/widget/RecyclerView$LayoutManager;

    iget-object v2, p0, mRecycler:Landroidx/recyclerview/widget/RecyclerView$Recycler;
    ...
    iput-boolean v2, p0, mDataSetHasChangedAfterLayout:Z

    iput-boolean v2, p0, mDispatchItemsChangedEvent:Z
    ...
    iget-object v0, p0, mRecycler:Landroidx/recyclerview/widget/RecyclerView$Recycler;
    ...
    iget-object v3, p0, mState:Landroidx/recyclerview/widget/RecyclerView$State;
    ...
    invoke-direct {p0, v3, v0}, didChildRangeChange(II)Z

    move-result v0

    if-eqz v0, :cond_8

    invoke-virtual {p0, v2, v2}, dispatchOnScrolled(II)V

    :cond_8
    invoke-direct {p0}, recoverFocusFromState()V

    invoke-direct {p0}, resetFocusInfo()V
...
.method private dispatchToOnItemTouchListeners(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, mInterceptingOnItemTouchListener:Landroidx/recyclerview/widget/RecyclerView$OnItemTouchListener;
    ...
    :cond_0
    invoke-direct {p0, p1}, findInterceptingOnItemTouchListener(Landroid/view/MotionEvent;)Z
    ...
    iput-object p1, p0, mInterceptingOnItemTouchListener:Landroidx/recyclerview/widget/RecyclerView$OnItemTouchListener;
...
.method private findInterceptingOnItemTouchListener(Landroid/view/MotionEvent;)Z
    ...
    iput-object v4, p0, mInterceptingOnItemTouchListener:Landroidx/recyclerview/widget/RecyclerView$OnItemTouchListener;
...
.method private findMinMaxChildLayoutPositions([I)V
    ...
    iget-object v6, p0, mChildHelper:Landroidx/recyclerview/widget/ChildHelper;

    invoke-virtual {v6, v3}, Landroidx/recyclerview/widget/ChildHelper;->getChildAt(I)Landroid/view/View;

    move-result-object v6

    invoke-static {v6}, getChildViewHolderInt(Landroid/view/View;)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
...
.method static findNestedRecyclerView(Landroid/view/View;)Landroidx/recyclerview/widget/RecyclerView;
    ...
    invoke-static {v3}, findNestedRecyclerView(Landroid/view/View;)Landroidx/recyclerview/widget/RecyclerView;
...
.method private findNextViewToFocus()Landroid/view/View;
    ...
    :goto_0
    iget-object v1, p0, mState:Landroidx/recyclerview/widget/RecyclerView$State;
    ...
    invoke-virtual {p0, v2}, findViewHolderForAdapterPosition(I)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    ...
    invoke-virtual {p0, v0}, findViewHolderForAdapterPosition(I)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
...
.method private getScrollingChildHelper()Landroidx/core/view/NestedScrollingChildHelper;
    ...
    iget-object v0, p0, mScrollingChildHelper:Landroidx/core/view/NestedScrollingChildHelper;
    ...
    iput-object v0, p0, mScrollingChildHelper:Landroidx/core/view/NestedScrollingChildHelper;

    :cond_0
    iget-object p0, p0, mScrollingChildHelper:Landroidx/core/view/NestedScrollingChildHelper;
...
.method private handleMissingPreInfoForChangeError(JLandroidx/recyclerview/widget/RecyclerView$ViewHolder;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
    ...
    :cond_0
    invoke-virtual {p0, v2}, getChangedHolderKey(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)J
    ...
    iget-object p1, p0, mAdapter:Landroidx/recyclerview/widget/RecyclerView$Adapter;
    ...
    invoke-virtual {p0}, exceptionLabel()Ljava/lang/String;
...
.method private initChildrenHelper()V
    ...
    iput-object v0, p0, mChildHelper:Landroidx/recyclerview/widget/ChildHelper;
...
.method private isPreferredNextFocus(Landroid/view/View;Landroid/view/View;I)Z
    ...
    :cond_0
    invoke-virtual {p0, p2}, findContainingItemView(Landroid/view/View;)Landroid/view/View;
    ...
    :cond_2
    invoke-virtual {p0, p1}, findContainingItemView(Landroid/view/View;)Landroid/view/View;
    ...
    iget-object v2, p0, mTempRect2:Landroid/graphics/Rect;
    ...
    iget-object p1, p0, mTempRect2:Landroid/graphics/Rect;

    invoke-virtual {p0, p2, p1}, Landroid/view/ViewGroup;->offsetDescendantRectToMyCoords(Landroid/view/View;Landroid/graphics/Rect;)V

    iget-object p1, p0, mLayout:Landroidx/recyclerview/widget/RecyclerView$LayoutManager;
    ...
    iget-object v4, p0, mTempRect2:Landroid/graphics/Rect;
    ...
    iget-object v3, p0, mTempRect2:Landroid/graphics/Rect;
    ...
    iget-object v5, p0, mTempRect2:Landroid/graphics/Rect;
...
.method private onPointerUp(Landroid/view/MotionEvent;)V
    ...
    iput v1, p0, mLastTouchX:I

    iput v1, p0, mInitialTouchX:I
    ...
    iput p1, p0, mLastTouchY:I

    iput p1, p0, mInitialTouchY:I
...
.method private predictiveItemAnimationsEnabled()Z
    ...
    iget-object v0, p0, mItemAnimator:Landroidx/recyclerview/widget/RecyclerView$ItemAnimator;

    if-eqz v0, :cond_0

    iget-object p0, p0, mLayout:Landroidx/recyclerview/widget/RecyclerView$LayoutManager;
...
.method private processAdapterUpdatesAndSetAnimationFlags()V
    ...
    iget-boolean v0, p0, mDispatchItemsChangedEvent:Z
    ...
    iget-object v4, p0, mLayout:Landroidx/recyclerview/widget/RecyclerView$LayoutManager;
...
.method private pullGlows(FFFF)V
    ...
    iget-object p3, p0, mTopGlow:Landroid/widget/EdgeEffect;
    ...
    iget-object p3, p0, mBottomGlow:Landroid/widget/EdgeEffect;
...
.method private recoverFocusFromState()V
    ...
    iget-boolean v0, p0, mPreserveFocusAfterLayout:Z

    if-eqz v0, :cond_9

    iget-object v0, p0, mAdapter:Landroidx/recyclerview/widget/RecyclerView$Adapter;
    ...
    sget-boolean v1, IGNORE_DETACHED_FOCUSED_CHILD:Z
    ...
    invoke-virtual {p0, v4, v5}, findViewHolderForItemId(J)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    ...
    iget-object v4, p0, mChildHelper:Landroidx/recyclerview/widget/ChildHelper;
    ...
    invoke-direct {p0}, findNextViewToFocus()Landroid/view/View;
...
.method private requestChildOnScreen(Landroid/view/View;Landroid/view/View;)V
    ...
    :cond_2
    iget-object v5, p0, mLayout:Landroidx/recyclerview/widget/RecyclerView$LayoutManager;
...
.method private saveFocusInfo()V
    ...
    :cond_1
    invoke-virtual {p0, v0}, findContainingViewHolder(Landroid/view/View;)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    ...
    iget-object v2, p0, mAdapter:Landroidx/recyclerview/widget/RecyclerView$Adapter;
    ...
    iget-boolean v2, p0, mDataSetHasChangedAfterLayout:Z
    ...
    invoke-direct {p0, v1}, getDeepestFocusedViewWithId(Landroid/view/View;)I
...
.method private setAdapterInternal(Landroidx/recyclerview/widget/RecyclerView$Adapter;ZZ)V
    ...
    iget-object v1, p0, mObserver:Landroidx/recyclerview/widget/RecyclerView$RecyclerViewDataObserver;
    ...
    :cond_1
    invoke-virtual {p0}, removeAndRecycleViews()V

    :cond_2
    iget-object p3, p0, mAdapterHelper:Landroidx/recyclerview/widget/AdapterHelper;

    invoke-virtual {p3}, Landroidx/recyclerview/widget/AdapterHelper;->reset()V

    iget-object p3, p0, mAdapter:Landroidx/recyclerview/widget/RecyclerView$Adapter;

    iput-object p1, p0, mAdapter:Landroidx/recyclerview/widget/RecyclerView$Adapter;

    if-eqz p1, :cond_3

    iget-object v0, p0, mObserver:Landroidx/recyclerview/widget/RecyclerView$RecyclerViewDataObserver;
    ...
    :cond_4
    iget-object p1, p0, mRecycler:Landroidx/recyclerview/widget/RecyclerView$Recycler;
...
.method private stopScrollersInternal()V
    ...
    iget-object v0, p0, mViewFlinger:Landroidx/recyclerview/widget/RecyclerView$ViewFlinger;
...
.method public addItemDecoration(Landroidx/recyclerview/widget/RecyclerView$ItemDecoration;)V
    ...
    invoke-virtual {p0, p1, v0}, addItemDecoration(Landroidx/recyclerview/widget/RecyclerView$ItemDecoration;I)V
...
.method public addItemDecoration(Landroidx/recyclerview/widget/RecyclerView$ItemDecoration;I)V
    ...
    iget-object p2, p0, mItemDecorations:Ljava/util/ArrayList;
...
.method public addOnItemTouchListener(Landroidx/recyclerview/widget/RecyclerView$OnItemTouchListener;)V
    ...
    iget-object p0, p0, mOnItemTouchListeners:Ljava/util/ArrayList;
...
.method public addOnScrollListener(Landroidx/recyclerview/widget/RecyclerView$OnScrollListener;)V
    ...
    :cond_0
    iget-object p0, p0, mScrollListeners:Ljava/util/List;
...
.method assertNotInLayoutOrScroll(Ljava/lang/String;)V
    ...
    :cond_1
    iget p1, p0, mDispatchScrollCounter:I
...
.method canReuseUpdatedViewHolder(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)Z
    ...
    iget-object p0, p0, mItemAnimator:Landroidx/recyclerview/widget/RecyclerView$ItemAnimator;
...
.method clearOldPositions()V
    ...
    :cond_1
    iget-object p0, p0, mRecycler:Landroidx/recyclerview/widget/RecyclerView$Recycler;
...
.method considerReleasingGlowsOnScroll(II)V
    ...
    iget-object p1, p0, mRightGlow:Landroid/widget/EdgeEffect;
    ...
    :cond_1
    iget-object p1, p0, mTopGlow:Landroid/widget/EdgeEffect;
    ...
    :cond_2
    iget-object p1, p0, mBottomGlow:Landroid/widget/EdgeEffect;
...
.method consumePendingUpdateOperations()V
    ...
    iget-boolean v0, p0, mLayoutWasDefered:Z

    if-nez v0, :cond_3

    invoke-direct {p0}, hasUpdatedView()Z
    ...
    invoke-virtual {p0, v0}, stopInterceptRequestLayout(Z)V
...
.method dispatchChildAttached(Landroid/view/View;)V
    ...
    invoke-static {p1}, getChildViewHolderInt(Landroid/view/View;)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
...
.method dispatchLayout()V
    ...
    invoke-direct {p0}, dispatchLayoutStep1()V
    ...
    invoke-direct {p0}, dispatchLayoutStep2()V
    ...
    :goto_1
    invoke-direct {p0}, dispatchLayoutStep3()V
...
.method public dispatchNestedFling(FFZ)Z
    ...
    invoke-direct {p0}, getScrollingChildHelper()Landroidx/core/view/NestedScrollingChildHelper;
...
.method dispatchOnScrollStateChanged(I)V
    ...
    iget-object v0, p0, mScrollListener:Landroidx/recyclerview/widget/RecyclerView$OnScrollListener;
...
.method dispatchOnScrolled(II)V
    ...
    iput p1, p0, mDispatchScrollCounter:I
...
.method dispatchPendingImportantForAccessibilityChanges()V
    ...
    iget-object v0, p0, mPendingAccessibilityImportanceChange:Ljava/util/List;
    ...
    iget-object v1, p0, mPendingAccessibilityImportanceChange:Ljava/util/List;
    ...
    :cond_2
    iget-object p0, p0, mPendingAccessibilityImportanceChange:Ljava/util/List;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v3, p0, mClipToPadding:Z
    ...
    iget-object v3, p0, mLeftGlow:Landroid/widget/EdgeEffect;
    ...
    iget-boolean v4, p0, mClipToPadding:Z
    ...
    :cond_4
    iget-object v4, p0, mTopGlow:Landroid/widget/EdgeEffect;
    ...
    iget-object v4, p0, mRightGlow:Landroid/widget/EdgeEffect;
    ...
    :goto_7
    iget-object v4, p0, mBottomGlow:Landroid/widget/EdgeEffect;
    ...
    iget-object p1, p0, mItemAnimator:Landroidx/recyclerview/widget/RecyclerView$ItemAnimator;

    if-eqz p1, :cond_d

    iget-object p1, p0, mItemDecorations:Ljava/util/ArrayList;
...
.method ensureBottomGlow()V
    ...
    :cond_0
    iget-object v0, p0, mEdgeEffectFactory:Landroidx/recyclerview/widget/RecyclerView$EdgeEffectFactory;
...
.method exceptionLabel()Ljava/lang/String;
    ...
    iget-object v1, p0, mLayout:Landroidx/recyclerview/widget/RecyclerView$LayoutManager;
...
.method final fillRemainingScrollValues(Landroidx/recyclerview/widget/RecyclerView$State;)V
    ...
    invoke-virtual {p0}, getScrollState()I
    ...
    iget-object p0, p0, mViewFlinger:Landroidx/recyclerview/widget/RecyclerView$ViewFlinger;
...
.method public findContainingViewHolder(Landroid/view/View;)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    ...
    :cond_0
    invoke-virtual {p0, p1}, getChildViewHolder(Landroid/view/View;)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
...
.method public findViewHolderForAdapterPosition(I)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    ...
    invoke-virtual {p0, v3}, getAdapterPositionFor(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)I
...
.method public fling(II)Z
    ...
    :cond_0
    iget-boolean v2, p0, mLayoutSuppressed:Z
    ...
    :goto_1
    invoke-virtual {p0, v3, v4, v6}, dispatchNestedFling(FFZ)Z

    iget-object v3, p0, mOnFlingListener:Landroidx/recyclerview/widget/RecyclerView$OnFlingListener;
    ...
    :cond_b
    invoke-virtual {p0, v1, v5}, startNestedScroll(II)Z
...
.method public focusSearch(Landroid/view/View;I)Landroid/view/View;
    ...
    :goto_2
    sget-boolean v7, FORCE_ABS_FOCUS_SEARCH_DIRECTION:Z
    ...
    :goto_7
    sget-boolean v1, FORCE_ABS_FOCUS_SEARCH_DIRECTION:Z
    ...
    invoke-virtual {p0}, consumePendingUpdateOperations()V
    ...
    iget-object v1, p0, mRecycler:Landroidx/recyclerview/widget/RecyclerView$Recycler;
    ...
    :cond_11
    invoke-direct {p0, v0, v4}, requestChildOnScreen(Landroid/view/View;Landroid/view/View;)V

    return-object p1

    :cond_12
    invoke-direct {p0, p1, v0, p2}, isPreferredNextFocus(Landroid/view/View;Landroid/view/View;I)Z
...
.method public getAdapter()Landroidx/recyclerview/widget/RecyclerView$Adapter;
    ...
    iget-object p0, p0, mAdapter:Landroidx/recyclerview/widget/RecyclerView$Adapter;
...
.method getAdapterPositionFor(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)I
    ...
    :cond_0
    iget-object p0, p0, mAdapterHelper:Landroidx/recyclerview/widget/AdapterHelper;
...
.method protected getChildDrawingOrder(II)I
    ...
    iget-object v0, p0, mChildDrawingOrderCallback:Landroidx/recyclerview/widget/RecyclerView$ChildDrawingOrderCallback;
...
.method public getClipToPadding()Z
    ...
    iget-boolean p0, p0, mClipToPadding:Z
...
.method getItemDecorInsetsForChild(Landroid/view/View;)Landroid/graphics/Rect;
    ...
    iget-object v7, p0, mState:Landroidx/recyclerview/widget/RecyclerView$State;
...
.method getNanoTime()J
    ...
    sget-boolean p0, ALLOW_THREAD_GAP_WORK:Z
...
.method public hasFixedSize()Z
    ...
    iget-boolean p0, p0, mHasFixedSize:Z
...
.method initAdapterManager()V
    ...
    iput-object v0, p0, mAdapterHelper:Landroidx/recyclerview/widget/AdapterHelper;
...
.method isAccessibilityEnabled()Z
    ...
    iget-object p0, p0, mAccessibilityManager:Landroid/view/accessibility/AccessibilityManager;
...
.method public isAttachedToWindow()Z
    ...
    iget-boolean p0, p0, mIsAttached:Z
...
.method public isComputingLayout()Z
    ...
    iget p0, p0, mLayoutOrScrollCounter:I
...
.method public final isLayoutSuppressed()Z
    ...
    iget-boolean p0, p0, mLayoutSuppressed:Z
...
.method offsetPositionRecordsForMove(II)V
    ...
    iget-object v7, p0, mChildHelper:Landroidx/recyclerview/widget/ChildHelper;

    invoke-virtual {v7, v6}, Landroidx/recyclerview/widget/ChildHelper;->getUnfilteredChildAt(I)Landroid/view/View;

    move-result-object v7

    invoke-static {v7}, getChildViewHolderInt(Landroid/view/View;)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
...
.method protected onAttachedToWindow()V
    ...
    :goto_0
    iput-boolean v1, p0, mFirstLayoutComplete:Z
    ...
    iput-object v0, p0, mGapWorker:Landroidx/recyclerview/widget/GapWorker;

    iget-object v0, p0, mGapWorker:Landroidx/recyclerview/widget/GapWorker;
    ...
    :goto_1
    iget-object v1, p0, mGapWorker:Landroidx/recyclerview/widget/GapWorker;
...
.method onExitLayoutOrScroll()V
    ...
    invoke-virtual {p0, v0}, onExitLayoutOrScroll(Z)V
...
.method onExitLayoutOrScroll(Z)V
    ...
    invoke-virtual {p0}, dispatchPendingImportantForAccessibilityChanges()V
...
.method public onGenericMotionEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_7
    iget v2, p0, mScaledHorizontalScrollFactor:F

    mul-float/2addr v3, v2

    float-to-int v2, v3

    iget v3, p0, mScaledVerticalScrollFactor:F

    mul-float/2addr v0, v3

    float-to-int v0, v0

    invoke-virtual {p0, v2, v0, p1}, scrollByInternal(IILandroid/view/MotionEvent;)Z
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iput-object v0, p0, mInterceptingOnItemTouchListener:Landroidx/recyclerview/widget/RecyclerView$OnItemTouchListener;
    ...
    iput-object v4, p0, mVelocityTracker:Landroid/view/VelocityTracker;
    ...
    invoke-virtual {p0, v2}, setScrollState(I)V
    ...
    invoke-virtual {p0, v1}, stopNestedScroll(I)V

    goto :goto_2

    :cond_c
    iget-boolean v4, p0, mIgnoreMotionEventTillDown:Z
    ...
    iput v4, p0, mLastTouchX:I

    iput v4, p0, mInitialTouchX:I
    ...
    invoke-virtual {p0, v2}, stopNestedScroll(I)V

    :cond_e
    iget-object p1, p0, mNestedOffsets:[I
    ...
    :cond_10
    invoke-virtual {p0, p1, v1}, startNestedScroll(II)Z
...
.method protected onLayout(ZIIII)V
    ...
    iput-boolean p1, p0, mFirstLayoutComplete:Z
...
.method protected onMeasure(II)V
    ...
    invoke-virtual {p0, p1, p2}, defaultOnMeasure(II)V
    ...
    iget-object v5, p0, mRecycler:Landroidx/recyclerview/widget/RecyclerView$Recycler;
    ...
    :goto_1
    iput-boolean v2, p0, mAdapterUpdateDuringMeasure:Z
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    iput-object p1, p0, mPendingSavedState:Landroidx/recyclerview/widget/RecyclerView$SavedState;

    iget-object p1, p0, mPendingSavedState:Landroidx/recyclerview/widget/RecyclerView$SavedState;
    ...
    iget-object p0, p0, mPendingSavedState:Landroidx/recyclerview/widget/RecyclerView$SavedState;
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iget-object v1, p0, mPendingSavedState:Landroidx/recyclerview/widget/RecyclerView$SavedState;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v0, v6, mLayoutSuppressed:Z

    const/4 v8, 0x0

    if-nez v0, :cond_1f

    iget-boolean v0, v6, mIgnoreMotionEventTillDown:Z
    ...
    :cond_0
    invoke-direct/range {p0 .. p1}, dispatchToOnItemTouchListeners(Landroid/view/MotionEvent;)Z
    ...
    invoke-direct/range {p0 .. p0}, cancelScroll()V

    return v9

    :cond_1
    iget-object v0, v6, mLayout:Landroidx/recyclerview/widget/RecyclerView$LayoutManager;
    ...
    iget-object v0, v6, mVelocityTracker:Landroid/view/VelocityTracker;
    ...
    iput-object v0, v6, mVelocityTracker:Landroid/view/VelocityTracker;
    ...
    iget-object v2, v6, mNestedOffsets:[I
    ...
    iget-object v3, v6, mReusableIntPair:[I
    ...
    iget-object v0, v6, mReusableIntPair:[I
    ...
    invoke-virtual {v6, v9}, setScrollState(I)V

    :cond_f
    move/from16 v0, v16

    iget v1, v6, mScrollState:I

    if-ne v1, v9, :cond_1d

    iget-object v1, v6, mScrollOffset:[I

    aget v2, v1, v8

    sub-int/2addr v13, v2

    iput v13, v6, mLastTouchX:I

    aget v1, v1, v9

    sub-int/2addr v14, v1

    iput v14, v6, mLastTouchY:I
    ...
    :goto_4
    invoke-virtual {v6, v1, v2, v7}, scrollByInternal(IILandroid/view/MotionEvent;)Z
    ...
    :cond_12
    iget-object v1, v6, mGapWorker:Landroidx/recyclerview/widget/GapWorker;
    ...
    iget v2, v6, mMaxFlingVelocity:I
    ...
    iget-object v1, v6, mVelocityTracker:Landroid/view/VelocityTracker;

    iget v2, v6, mScrollPointerId:I
    ...
    iget-object v2, v6, mVelocityTracker:Landroid/view/VelocityTracker;

    iget v3, v6, mScrollPointerId:I
    ...
    invoke-virtual {v6, v0, v1}, fling(II)Z
    ...
    :cond_18
    invoke-virtual {v6, v8}, setScrollState(I)V

    :cond_19
    invoke-direct/range {p0 .. p0}, resetScroll()V
    ...
    :cond_1c
    invoke-virtual {v6, v0, v8}, startNestedScroll(II)Z
...
.method processDataSetCompletelyChanged(Z)V
    ...
    iput-boolean p1, p0, mDispatchItemsChangedEvent:Z

    const/4 p1, 0x1

    iput-boolean p1, p0, mDataSetHasChangedAfterLayout:Z
...
.method recordAnimationInfoIfBouncedHiddenView(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;Landroidx/recyclerview/widget/RecyclerView$ItemAnimator$ItemHolderInfo;)V
    ...
    invoke-virtual {p0, p1}, getChangedHolderKey(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)J
    ...
    :cond_0
    iget-object p0, p0, mViewInfoStore:Landroidx/recyclerview/widget/ViewInfoStore;
...
.method removeAnimatingView(Landroid/view/View;)Z
    ...
    invoke-virtual {p0, p1}, stopInterceptRequestLayout(Z)V
...
.method protected removeDetachedView(Landroid/view/View;Z)V
    ...
    invoke-virtual {p0, p1}, dispatchChildDetached(Landroid/view/View;)V
...
.method repositionShadowingViews()V
    ...
    invoke-virtual {p0, v2}, getChildViewHolder(Landroid/view/View;)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
...
.method public requestChildFocus(Landroid/view/View;Landroid/view/View;)V
    ...
    invoke-direct {p0, p1, p2}, requestChildOnScreen(Landroid/view/View;Landroid/view/View;)V
...
.method public requestLayout()V
    ...
    iget v0, p0, mInterceptRequestLayoutDepth:I
    ...
    iput-boolean v0, p0, mLayoutWasDefered:Z
...
.method public scrollBy(II)V
    ...
    :cond_0
    iget-boolean v1, p0, mLayoutSuppressed:Z
    ...
    invoke-virtual {p0, p1, p2, v0}, scrollByInternal(IILandroid/view/MotionEvent;)Z
...
.method scrollByInternal(IILandroid/view/MotionEvent;)Z
    ...
    invoke-virtual/range {p0 .. p0}, consumePendingUpdateOperations()V

    iget-object v0, v8, mAdapter:Landroidx/recyclerview/widget/RecyclerView$Adapter;
    ...
    iget-object v0, v8, mReusableIntPair:[I

    aput v13, v0, v13

    aput v13, v0, v12

    invoke-virtual {v8, v9, v10, v0}, scrollStep(II[I)V
    ...
    :goto_0
    iget-object v0, v8, mItemDecorations:Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object v5, v8, mReusableIntPair:[I

    aput v13, v5, v13

    aput v13, v5, v12

    iget-object v4, v8, mScrollOffset:[I
    ...
    invoke-virtual/range {v0 .. v7}, dispatchNestedScroll(IIII[II[I)V
    ...
    iget v0, v8, mLastTouchX:I

    iget-object v1, v8, mScrollOffset:[I

    aget v2, v1, v13

    sub-int/2addr v0, v2

    iput v0, v8, mLastTouchX:I

    iget v0, v8, mLastTouchY:I

    aget v2, v1, v12

    sub-int/2addr v0, v2

    iput v0, v8, mLastTouchY:I

    iget-object v0, v8, mNestedOffsets:[I
    ...
    invoke-direct {v8, v0, v1, v2, v3}, pullGlows(FFFF)V
    ...
    :cond_4
    invoke-virtual {v8, v1, v0}, dispatchOnScrolled(II)V
...
.method scrollStep(II[I)V
    ...
    invoke-virtual {p0}, repositionShadowingViews()V
...
.method public setAccessibilityDelegateCompat(Landroidx/recyclerview/widget/RecyclerViewAccessibilityDelegate;)V
    ...
    iput-object p1, p0, mAccessibilityDelegate:Landroidx/recyclerview/widget/RecyclerViewAccessibilityDelegate;

    iget-object p1, p0, mAccessibilityDelegate:Landroidx/recyclerview/widget/RecyclerViewAccessibilityDelegate;
...
.method public setAdapter(Landroidx/recyclerview/widget/RecyclerView$Adapter;)V
    ...
    invoke-direct {p0, p1, v0, v1}, setAdapterInternal(Landroidx/recyclerview/widget/RecyclerView$Adapter;ZZ)V

    invoke-virtual {p0, v0}, processDataSetCompletelyChanged(Z)V
...
.method public setClipToPadding(Z)V
    ...
    iget-boolean p1, p0, mFirstLayoutComplete:Z
...
.method public setLayoutFrozen(Z)V
    ...
    invoke-virtual {p0, p1}, suppressLayout(Z)V
...
.method public setLayoutManager(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;)V
    ...
    iput-object v1, p0, mLayout:Landroidx/recyclerview/widget/RecyclerView$LayoutManager;
    ...
    iput-object p1, p0, mLayout:Landroidx/recyclerview/widget/RecyclerView$LayoutManager;
    ...
    iget-boolean p1, p0, mIsAttached:Z
    ...
    invoke-virtual {p1}, exceptionLabel()Ljava/lang/String;
...
.method public setOnScrollListener(Landroidx/recyclerview/widget/RecyclerView$OnScrollListener;)V
    ...
    iput-object p1, p0, mScrollListener:Landroidx/recyclerview/widget/RecyclerView$OnScrollListener;
...
.method public setPreserveFocusAfterLayout(Z)V
    ...
    iput-boolean p1, p0, mPreserveFocusAfterLayout:Z
...
.method public setRecyclerListener(Landroidx/recyclerview/widget/RecyclerView$RecyclerListener;)V
    ...
    iput-object p1, p0, mRecyclerListener:Landroidx/recyclerview/widget/RecyclerView$RecyclerListener;
...
.method shouldDeferAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)Z
    ...
    iput p1, p0, mEatenAccessibilityChangeFlags:I
...
.method public smoothScrollBy(II)V
    ...
    invoke-virtual/range {v0 .. v5}, smoothScrollBy(IILandroid/view/animation/Interpolator;IZ)V
...
.method smoothScrollBy(IILandroid/view/animation/Interpolator;IZ)V
    ...
    :cond_8
    invoke-virtual {p0, v1, v2}, startNestedScroll(II)Z
...
.method startInterceptRequestLayout()V
    ...
    iput v0, p0, mInterceptRequestLayoutDepth:I
...
.method stopInterceptRequestLayout(Z)V
    ...
    iput v1, p0, mInterceptRequestLayoutDepth:I
    ...
    :cond_1
    iget v2, p0, mInterceptRequestLayoutDepth:I

    if-ne v2, v1, :cond_3

    if-eqz p1, :cond_2

    iget-boolean p1, p0, mLayoutWasDefered:Z

    if-eqz p1, :cond_2

    iget-boolean p1, p0, mLayoutSuppressed:Z
    ...
    :cond_3
    iget p1, p0, mInterceptRequestLayoutDepth:I

    sub-int/2addr p1, v1

    iput p1, p0, mInterceptRequestLayoutDepth:I
...
.method public final suppressLayout(Z)V
    ...
    :cond_0
    iput-boolean p1, p0, mLayoutWasDefered:Z
    ...
    iput-boolean p1, p0, mIgnoreMotionEventTillDown:Z
