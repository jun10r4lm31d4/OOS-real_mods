...
.method static constructor <clinit>()V
    ...
    sput-object v0, sGapWorker:Ljava/lang/ThreadLocal;
    ...
    sput-object v0, sTaskComparator:Ljava/util/Comparator;
...
.method constructor <init>()V
    ...
    iput-object v0, p0, mRecyclerViews:Ljava/util/ArrayList;
...
.method private buildTaskList()V
    ...
    iget-object v0, p0, mRecyclerViews:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, mRecyclerViews:Ljava/util/ArrayList;
    ...
    :cond_6
    iget-object p0, p0, mTasks:Ljava/util/ArrayList;

    sget-object v0, sTaskComparator:Ljava/util/Comparator;
...
.method private flushTaskWithDeadline(Landroidx/recyclerview/widget/GapWorker$Task;J)V
    ...
    invoke-direct {p0, v2, p1, v0, v1}, prefetchPositionWithDeadline(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    ...
    invoke-direct {p0, p1, p2, p3}, prefetchInnerRecyclerViewWithDeadline(Landroidx/recyclerview/widget/RecyclerView;J)V
...
.method private flushTasksWithDeadline(J)V
    ...
    :cond_0
    invoke-direct {p0, v1, p1, p2}, flushTaskWithDeadline(Landroidx/recyclerview/widget/GapWorker$Task;J)V
...
.method private prefetchInnerRecyclerViewWithDeadline(Landroidx/recyclerview/widget/RecyclerView;J)V
    ...
    invoke-direct {p0, p1, v2, p2, p3}, prefetchPositionWithDeadline(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    :try_end_0
...
.method private prefetchPositionWithDeadline(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    ...
    invoke-static {p1, p2}, isPrefetchPositionAttached(Landroidx/recyclerview/widget/RecyclerView;I)Z
...
.method public add(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    iget-object p0, p0, mRecyclerViews:Ljava/util/ArrayList;
...
.method prefetch(J)V
    ...
    invoke-direct {p0}, buildTaskList()V

    invoke-direct {p0, p1, p2}, flushTasksWithDeadline(J)V
...
.method public run()V
    ...
    iget-object v2, p0, mRecyclerViews:Ljava/util/ArrayList;
    ...
    iget-object v6, p0, mRecyclerViews:Ljava/util/ArrayList;
    ...
    iget-wide v4, p0, mFrameIntervalNs:J

    add-long/2addr v2, v4

    invoke-virtual {p0, v2, v3}, prefetch(J)V
    :try_end_1
