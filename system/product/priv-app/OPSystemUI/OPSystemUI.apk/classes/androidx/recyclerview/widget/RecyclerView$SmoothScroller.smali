...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mRecyclingAction:Landroidx/recyclerview/widget/RecyclerView$SmoothScroller$Action;
...
.method public computeScrollVectorForPosition(I)Landroid/graphics/PointF;
    ...
    invoke-virtual {p0}, getLayoutManager()Landroidx/recyclerview/widget/RecyclerView$LayoutManager;
...
.method public getLayoutManager()Landroidx/recyclerview/widget/RecyclerView$LayoutManager;
    ...
    iget-object p0, p0, mLayoutManager:Landroidx/recyclerview/widget/RecyclerView$LayoutManager;
...
.method public isPendingInitialRun()Z
    ...
    iget-boolean p0, p0, mPendingInitialRun:Z
...
.method onAnimation(II)V
    ...
    :cond_1
    iget-boolean v1, p0, mPendingInitialRun:Z
    ...
    iget-object v1, p0, mLayoutManager:Landroidx/recyclerview/widget/RecyclerView$LayoutManager;

    if-eqz v1, :cond_3

    iget v1, p0, mTargetPosition:I

    invoke-virtual {p0, v1}, computeScrollVectorForPosition(I)Landroid/graphics/PointF;
    ...
    iput-boolean v1, p0, mPendingInitialRun:Z

    iget-object v1, p0, mTargetView:Landroid/view/View;

    if-eqz v1, :cond_5

    invoke-virtual {p0, v1}, getChildPosition(Landroid/view/View;)I

    move-result v1

    iget v3, p0, mTargetPosition:I
    ...
    iget-object v3, p0, mRecyclingAction:Landroidx/recyclerview/widget/RecyclerView$SmoothScroller$Action;

    invoke-virtual {p0, v1, v2, v3}, onTargetFound(Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView$State;Landroidx/recyclerview/widget/RecyclerView$SmoothScroller$Action;)V

    iget-object v1, p0, mRecyclingAction:Landroidx/recyclerview/widget/RecyclerView$SmoothScroller$Action;
    ...
    iput-object v2, p0, mTargetView:Landroid/view/View;
    ...
    iget-object v2, p0, mRecyclingAction:Landroidx/recyclerview/widget/RecyclerView$SmoothScroller$Action;

    invoke-virtual {p0, p1, p2, v1, v2}, onSeekTargetStep(IILandroidx/recyclerview/widget/RecyclerView$State;Landroidx/recyclerview/widget/RecyclerView$SmoothScroller$Action;)V

    iget-object p1, p0, mRecyclingAction:Landroidx/recyclerview/widget/RecyclerView$SmoothScroller$Action;

    invoke-virtual {p1}, Landroidx/recyclerview/widget/RecyclerView$SmoothScroller$Action;->hasJumpTarget()Z

    move-result p1

    iget-object p2, p0, mRecyclingAction:Landroidx/recyclerview/widget/RecyclerView$SmoothScroller$Action;
    ...
    iget-boolean p1, p0, mRunning:Z

    if-eqz p1, :cond_6

    const/4 p1, 0x1

    iput-boolean p1, p0, mPendingInitialRun:Z
...
.method protected onChildAttachedToWindow(Landroid/view/View;)V
    ...
    invoke-virtual {p0, p1}, getChildPosition(Landroid/view/View;)I

    move-result v0

    invoke-virtual {p0}, getTargetPosition()I
...
.method start(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$LayoutManager;)V
    ...
    iput-object p2, p0, mLayoutManager:Landroidx/recyclerview/widget/RecyclerView$LayoutManager;

    iget p1, p0, mTargetPosition:I
    ...
    invoke-virtual {p0, p2}, findViewByPosition(I)Landroid/view/View;
...
.method protected final stop()V
    ...
    iput-object v1, p0, mTargetView:Landroid/view/View;

    iput v2, p0, mTargetPosition:I

    iput-boolean v0, p0, mPendingInitialRun:Z

    iget-object v0, p0, mLayoutManager:Landroidx/recyclerview/widget/RecyclerView$LayoutManager;
    ...
    iput-object v1, p0, mLayoutManager:Landroidx/recyclerview/widget/RecyclerView$LayoutManager;

    iput-object v1, p0, mRecyclerView:Landroidx/recyclerview/widget/RecyclerView;
