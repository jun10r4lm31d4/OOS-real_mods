...
.method constructor <init>(Landroidx/recyclerview/widget/ChildHelper$Callback;)V
    ...
    iput-object p1, p0, mCallback:Landroidx/recyclerview/widget/ChildHelper$Callback;
    ...
    iput-object p1, p0, mBucket:Landroidx/recyclerview/widget/ChildHelper$Bucket;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, mHiddenViews:Ljava/util/List;
...
.method private getOffset(I)I
    ...
    :cond_0
    iget-object v1, p0, mCallback:Landroidx/recyclerview/widget/ChildHelper$Callback;
    ...
    iget-object v3, p0, mBucket:Landroidx/recyclerview/widget/ChildHelper$Bucket;
    ...
    :goto_1
    iget-object p1, p0, mBucket:Landroidx/recyclerview/widget/ChildHelper$Bucket;
...
.method private hideViewInternal(Landroid/view/View;)V
    ...
    iget-object v0, p0, mHiddenViews:Ljava/util/List;

    invoke-interface {v0, p1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    iget-object p0, p0, mCallback:Landroidx/recyclerview/widget/ChildHelper$Callback;
...
.method addView(Landroid/view/View;IZ)V
    ...
    iget-object p2, p0, mCallback:Landroidx/recyclerview/widget/ChildHelper$Callback;
    ...
    :cond_0
    invoke-direct {p0, p2}, getOffset(I)I

    move-result p2

    :goto_0
    iget-object v0, p0, mBucket:Landroidx/recyclerview/widget/ChildHelper$Bucket;

    invoke-virtual {v0, p2, p3}, Landroidx/recyclerview/widget/ChildHelper$Bucket;->insert(IZ)V

    if-eqz p3, :cond_1

    invoke-direct {p0, p1}, hideViewInternal(Landroid/view/View;)V
...
.method addView(Landroid/view/View;Z)V
    ...
    invoke-virtual {p0, p1, v0, p2}, addView(Landroid/view/View;IZ)V
...
.method detachViewFromParent(I)V
    ...
    invoke-direct {p0, p1}, getOffset(I)I
...
.method findHiddenNonRemovedView(I)Landroid/view/View;
    ...
    iget-object v2, p0, mHiddenViews:Ljava/util/List;
    ...
    iget-object v3, p0, mCallback:Landroidx/recyclerview/widget/ChildHelper$Callback;
...
.method getChildCount()I
    ...
    iget-object v0, p0, mCallback:Landroidx/recyclerview/widget/ChildHelper$Callback;

    invoke-interface {v0}, Landroidx/recyclerview/widget/ChildHelper$Callback;->getChildCount()I

    move-result v0

    iget-object p0, p0, mHiddenViews:Ljava/util/List;
...
.method hide(Landroid/view/View;)V
    ...
    iget-object v1, p0, mBucket:Landroidx/recyclerview/widget/ChildHelper$Bucket;
...
.method indexOfChild(Landroid/view/View;)I
    ...
    :cond_1
    iget-object p0, p0, mBucket:Landroidx/recyclerview/widget/ChildHelper$Bucket;
...
.method removeAllViewsUnfiltered()V
    ...
    iget-object v1, p0, mHiddenViews:Ljava/util/List;
...
.method removeView(Landroid/view/View;)V
    ...
    invoke-direct {p0, p1}, unhideViewInternal(Landroid/view/View;)Z
...
.method removeViewAt(I)V
    ...
    invoke-direct {p0, v0}, unhideViewInternal(Landroid/view/View;)Z
...
.method removeViewIfHidden(Landroid/view/View;)Z
    ...
    :cond_0
    iget-object v2, p0, mBucket:Landroidx/recyclerview/widget/ChildHelper$Bucket;
