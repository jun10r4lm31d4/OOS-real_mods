...
.method constructor <init>(Landroidx/recyclerview/widget/AdapterHelper$Callback;)V
    ...
    invoke-direct {p0, p1, v0}, <init>(Landroidx/recyclerview/widget/AdapterHelper$Callback;Z)V
...
.method constructor <init>(Landroidx/recyclerview/widget/AdapterHelper$Callback;Z)V
    ...
    iput-object v0, p0, mUpdateOpPool:Landroidx/core/util/Pools$Pool;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mPendingUpdates:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mPostponedList:Ljava/util/ArrayList;

    const/4 v0, 0x0

    iput v0, p0, mExistingUpdateTypes:I

    iput-object p1, p0, mCallback:Landroidx/recyclerview/widget/AdapterHelper$Callback;

    iput-boolean p2, p0, mDisableRecycler:Z
    ...
    iput-object p1, p0, mOpReorderer:Landroidx/recyclerview/widget/OpReorderer;
...
.method private applyAdd(Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;)V
    ...
    invoke-direct {p0, p1}, postponeAndUpdateViewHolders(Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;)V
...
.method private applyRemove(Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;)V
    ...
    iget-object v8, p0, mCallback:Landroidx/recyclerview/widget/AdapterHelper$Callback;
    ...
    invoke-direct {p0, v1}, canFindInPreLayout(I)Z
    ...
    invoke-virtual {p0, v7, v0, v4, v6}, obtainUpdateOp(IIILjava/lang/Object;)Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;

    move-result-object v5

    invoke-direct {p0, v5}, postponeAndUpdateViewHolders(Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;)V
    ...
    invoke-direct {p0, v5}, dispatchAndUpdateViewHolders(Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;)V
    ...
    invoke-virtual {p0, p1}, recycleUpdateOp(Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;)V
    ...
    invoke-direct {p0, p1}, dispatchAndUpdateViewHolders(Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;)V
...
.method private applyUpdate(Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;)V
    ...
    iget-object v7, p0, mCallback:Landroidx/recyclerview/widget/AdapterHelper$Callback;
    ...
    invoke-direct {p0, v0}, canFindInPreLayout(I)Z
    ...
    invoke-virtual {p0, v6, v4, v3, v5}, obtainUpdateOp(IIILjava/lang/Object;)Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;

    move-result-object v3

    invoke-direct {p0, v3}, postponeAndUpdateViewHolders(Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;)V
    ...
    invoke-direct {p0, v3}, dispatchAndUpdateViewHolders(Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;)V
    ...
    invoke-virtual {p0, v6, v4, v3, v0}, obtainUpdateOp(IIILjava/lang/Object;)Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;
...
.method private canFindInPreLayout(I)Z
    ...
    iget-object v0, p0, mPostponedList:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, mPostponedList:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v3, v4}, findPositionOffset(II)I
    ...
    invoke-virtual {p0, v4, v5}, findPositionOffset(II)I
...
.method private dispatchAndUpdateViewHolders(Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;)V
    ...
    invoke-direct {p0, v2, v0}, updatePositionWithPostponed(II)I
    ...
    invoke-direct {p0, v9, v10}, updatePositionWithPostponed(II)I
    ...
    invoke-virtual {p0, v10, v7, v2, v11}, obtainUpdateOp(IIILjava/lang/Object;)Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;

    move-result-object v7

    invoke-virtual {p0, v7, v8}, dispatchFirstPassAndUpdateViewHolders(Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;I)V

    invoke-virtual {p0, v7}, recycleUpdateOp(Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;)V
    ...
    invoke-virtual {p0, p1, v7, v2, v0}, obtainUpdateOp(IIILjava/lang/Object;)Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;

    move-result-object p1

    invoke-virtual {p0, p1, v8}, dispatchFirstPassAndUpdateViewHolders(Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;I)V
...
.method private postponeAndUpdateViewHolders(Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;)V
    ...
    iget-object p0, p0, mCallback:Landroidx/recyclerview/widget/AdapterHelper$Callback;
...
.method private updatePositionWithPostponed(II)I
    ...
    :cond_d
    iget-object p2, p0, mPostponedList:Ljava/util/ArrayList;
    ...
    :cond_e
    iget-object v1, p0, mPostponedList:Ljava/util/ArrayList;

    invoke-virtual {v1, p2}, Ljava/util/ArrayList;->remove(I)Ljava/lang/Object;

    invoke-virtual {p0, v0}, recycleUpdateOp(Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;)V
...
.method public applyPendingUpdatesToPosition(I)I
    ...
    iget-object v0, p0, mPendingUpdates:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, mPendingUpdates:Ljava/util/ArrayList;
...
.method consumePostponedUpdates()V
    ...
    iget-object v3, p0, mCallback:Landroidx/recyclerview/widget/AdapterHelper$Callback;

    iget-object v4, p0, mPostponedList:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v0}, recycleUpdateOpsAndClearList(Ljava/util/List;)V

    iput v1, p0, mExistingUpdateTypes:I
...
.method consumeUpdatesInOnePass()V
    ...
    invoke-virtual {p0}, consumePostponedUpdates()V
    ...
    iget-object v3, p0, mPendingUpdates:Ljava/util/ArrayList;
    ...
    :cond_0
    iget-object v4, p0, mCallback:Landroidx/recyclerview/widget/AdapterHelper$Callback;
    ...
    :goto_1
    iget-object v3, p0, mOnItemProcessedCallback:Ljava/lang/Runnable;
...
.method dispatchFirstPassAndUpdateViewHolders(Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;I)V
    ...
    iget-object v0, p0, mCallback:Landroidx/recyclerview/widget/AdapterHelper$Callback;
...
.method findPositionOffset(I)I
    ...
    invoke-virtual {p0, p1, v0}, findPositionOffset(II)I
...
.method hasAnyUpdateTypes(I)Z
    ...
    iget p0, p0, mExistingUpdateTypes:I
...
.method hasPendingUpdates()Z
    ...
    iget-object p0, p0, mPendingUpdates:Ljava/util/ArrayList;
...
.method public obtainUpdateOp(IIILjava/lang/Object;)Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;
    ...
    iget-object p0, p0, mUpdateOpPool:Landroidx/core/util/Pools$Pool;
...
.method onItemRangeChanged(IILjava/lang/Object;)Z
    ...
    invoke-virtual {p0, v3, p1, p2, p3}, obtainUpdateOp(IIILjava/lang/Object;)Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;

    move-result-object p1

    invoke-virtual {v2, p1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget p1, p0, mExistingUpdateTypes:I

    or-int/2addr p1, v3

    iput p1, p0, mExistingUpdateTypes:I
...
.method onItemRangeInserted(II)Z
    ...
    invoke-virtual {p0, v1, p1, p2, v3}, obtainUpdateOp(IIILjava/lang/Object;)Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;
...
.method onItemRangeMoved(III)Z
    ...
    iget-object p3, p0, mPendingUpdates:Ljava/util/ArrayList;

    const/4 v2, 0x0

    const/16 v3, 0x8

    invoke-virtual {p0, v3, p1, p2, v2}, obtainUpdateOp(IIILjava/lang/Object;)Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;
...
.method onItemRangeRemoved(II)Z
    ...
    invoke-virtual {p0, v4, p1, p2, v3}, obtainUpdateOp(IIILjava/lang/Object;)Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;
...
.method preProcess()V
    ...
    iget-object v0, p0, mOpReorderer:Landroidx/recyclerview/widget/OpReorderer;

    iget-object v1, p0, mPendingUpdates:Ljava/util/ArrayList;
    ...
    :cond_0
    invoke-direct {p0, v2}, applyMove(Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;)V

    goto :goto_1

    :cond_1
    invoke-direct {p0, v2}, applyUpdate(Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;)V

    goto :goto_1

    :cond_2
    invoke-direct {p0, v2}, applyRemove(Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;)V

    goto :goto_1

    :cond_3
    invoke-direct {p0, v2}, applyAdd(Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;)V

    :goto_1
    iget-object v2, p0, mOnItemProcessedCallback:Ljava/lang/Runnable;
...
.method public recycleUpdateOp(Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;)V
    ...
    iget-boolean v0, p0, mDisableRecycler:Z
...
.method recycleUpdateOpsAndClearList(Ljava/util/List;)V
    ...
    invoke-virtual {p0, v2}, recycleUpdateOp(Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;)V
