...
.method public constructor <init>(Landroidx/collection/ArrayMap;Landroidx/collection/ArrayMap;Landroidx/collection/ArrayMap;)V
    ...
    iput-object p1, p0, mReadCache:Landroidx/collection/ArrayMap;

    iput-object p2, p0, mWriteCache:Landroidx/collection/ArrayMap;

    iput-object p3, p0, mParcelizerCache:Landroidx/collection/ArrayMap;
...
.method private findParcelClass(Ljava/lang/Class;)Ljava/lang/Class;
    ...
    iget-object v0, p0, mParcelizerCache:Landroidx/collection/ArrayMap;
    ...
    iget-object p0, p0, mParcelizerCache:Landroidx/collection/ArrayMap;
...
.method private getReadMethod(Ljava/lang/String;)Ljava/lang/reflect/Method;
    ...
    iget-object v0, p0, mReadCache:Landroidx/collection/ArrayMap;
    ...
    iget-object p0, p0, mReadCache:Landroidx/collection/ArrayMap;
...
.method private getWriteMethod(Ljava/lang/Class;)Ljava/lang/reflect/Method;
    ...
    iget-object v0, p0, mWriteCache:Landroidx/collection/ArrayMap;
    ...
    invoke-direct {p0, p1}, findParcelClass(Ljava/lang/Class;)Ljava/lang/Class;
    ...
    iget-object p0, p0, mWriteCache:Landroidx/collection/ArrayMap;
...
.method private writeSerializable(Ljava/io/Serializable;)V
    ...
    invoke-virtual {p0, p1}, writeString(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, writeString(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, writeByteArray([B)V
    :try_end_0
...
.method private writeVersionedParcelableCreator(Landroidx/versionedparcelable/VersionedParcelable;)V
    ...
    invoke-direct {p0, v0}, findParcelClass(Ljava/lang/Class;)Ljava/lang/Class;
...
.method protected readArray([Ljava/lang/Object;)[Ljava/lang/Object;
    ...
    invoke-virtual {p0}, readStrongBinder()Landroid/os/IBinder;
    ...
    invoke-virtual {p0}, readString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, readSerializable()Ljava/io/Serializable;
    ...
    invoke-virtual {p0}, readParcelable()Landroid/os/Parcelable;
    ...
    invoke-virtual {p0}, readVersionedParcelable()Landroidx/versionedparcelable/VersionedParcelable;
...
.method public readArray([Ljava/lang/Object;I)[Ljava/lang/Object;
    ...
    invoke-virtual {p0, p2}, readField(I)Z
    ...
    :cond_0
    invoke-virtual {p0, p1}, readArray([Ljava/lang/Object;)[Ljava/lang/Object;
...
.method public readBoolean(ZI)Z
    ...
    :cond_0
    invoke-virtual {p0}, readBoolean()Z
...
.method public readCharSequence(Ljava/lang/CharSequence;I)Ljava/lang/CharSequence;
    ...
    :cond_0
    invoke-virtual {p0}, readCharSequence()Ljava/lang/CharSequence;
...
.method protected readFromParcel(Ljava/lang/String;Landroidx/versionedparcelable/VersionedParcel;)Landroidx/versionedparcelable/VersionedParcelable;
    ...
    :try_start_0
    invoke-direct {p0, p1}, getReadMethod(Ljava/lang/String;)Ljava/lang/reflect/Method;
...
.method public readLong(JI)J
    ...
    invoke-virtual {p0, p3}, readField(I)Z
...
.method protected readVersionedParcelable()Landroidx/versionedparcelable/VersionedParcelable;
    ...
    :cond_0
    invoke-virtual {p0}, createSubParcel()Landroidx/versionedparcelable/VersionedParcel;

    move-result-object v1

    invoke-virtual {p0, v0, v1}, readFromParcel(Ljava/lang/String;Landroidx/versionedparcelable/VersionedParcel;)Landroidx/versionedparcelable/VersionedParcelable;
...
.method protected writeArray([Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, writeInt(I)V
    ...
    invoke-virtual {p0, v0}, writeInt(I)V
    ...
    invoke-direct {p0, v2}, getType(Ljava/lang/Object;)I

    move-result v2

    invoke-virtual {p0, v2}, writeInt(I)V
    ...
    invoke-virtual {p0, v2}, writeStrongBinder(Landroid/os/IBinder;)V
    ...
    invoke-virtual {p0, v2}, writeString(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v2}, writeSerializable(Ljava/io/Serializable;)V
    ...
    invoke-virtual {p0, v2}, writeParcelable(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {p0, v2}, writeVersionedParcelable(Landroidx/versionedparcelable/VersionedParcelable;)V
...
.method public writeArray([Ljava/lang/Object;I)V
    ...
    invoke-virtual {p0, p2}, setOutputField(I)V

    invoke-virtual {p0, p1}, writeArray([Ljava/lang/Object;)V
...
.method public writeBoolean(ZI)V
    ...
    invoke-virtual {p0, p1}, writeBoolean(Z)V
...
.method public writeCharSequence(Ljava/lang/CharSequence;I)V
    ...
    invoke-virtual {p0, p1}, writeCharSequence(Ljava/lang/CharSequence;)V
...
.method public writeLong(JI)V
    ...
    invoke-virtual {p0, p3}, setOutputField(I)V

    invoke-virtual {p0, p1, p2}, writeLong(J)V
...
.method public writeParcelable(Landroid/os/Parcelable;I)V
    ...
    invoke-virtual {p0, p1}, writeParcelable(Landroid/os/Parcelable;)V
...
.method protected writeToParcel(Landroidx/versionedparcelable/VersionedParcelable;Landroidx/versionedparcelable/VersionedParcel;)V
    ...
    invoke-direct {p0, v0}, getWriteMethod(Ljava/lang/Class;)Ljava/lang/reflect/Method;
...
.method protected writeVersionedParcelable(Landroidx/versionedparcelable/VersionedParcelable;)V
    ...
    :cond_0
    invoke-direct {p0, p1}, writeVersionedParcelableCreator(Landroidx/versionedparcelable/VersionedParcelable;)V

    invoke-virtual {p0}, createSubParcel()Landroidx/versionedparcelable/VersionedParcel;

    move-result-object v0

    invoke-virtual {p0, p1, v0}, writeToParcel(Landroidx/versionedparcelable/VersionedParcelable;Landroidx/versionedparcelable/VersionedParcel;)V

    invoke-virtual {v0}, closeField()V
...
.method public writeVersionedParcelable(Landroidx/versionedparcelable/VersionedParcelable;I)V
    ...
    invoke-virtual {p0, p1}, writeVersionedParcelable(Landroidx/versionedparcelable/VersionedParcelable;)V
