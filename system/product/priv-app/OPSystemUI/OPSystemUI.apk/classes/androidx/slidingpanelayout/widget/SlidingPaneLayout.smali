...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p3, p0, mTmpRect:Landroid/graphics/Rect;

    new-instance p3, Ljava/util/ArrayList;

    invoke-direct {p3}, Ljava/util/ArrayList;-><init>()V

    iput-object p3, p0, mPostedRunnables:Ljava/util/ArrayList;
    ...
    iput-object p2, p0, mDragHelper:Landroidx/customview/widget/ViewDragHelper;

    iget-object p0, p0, mDragHelper:Landroidx/customview/widget/ViewDragHelper;
...
.method private closePane(Landroid/view/View;I)Z
    ...
    invoke-virtual {p0, p1, p2}, smoothSlideTo(FI)Z
    ...
    :cond_1
    :goto_0
    iput-boolean v0, p0, mPreservedOpenState:Z
...
.method private dimChildView(Landroid/view/View;FI)V
    ...
    :cond_1
    invoke-virtual {p0, p1}, invalidateChildRegion(Landroid/view/View;)V
    ...
    iget-object p1, p0, mPostedRunnables:Ljava/util/ArrayList;
...
.method private openPane(Landroid/view/View;I)Z
    ...
    iput-boolean p1, p0, mPreservedOpenState:Z
...
.method private parallaxOtherViews(F)V
    ...
    invoke-virtual {p0}, isLayoutRtlSupport()Z

    move-result v0

    iget-object v1, p0, mSlideableView:Landroid/view/View;
    ...
    iget-object v5, p0, mSlideableView:Landroid/view/View;
    ...
    :cond_2
    iget v5, p0, mParallaxOffset:F

    const/high16 v6, 0x3f800000    # 1.0f

    sub-float v5, v6, v5

    iget v7, p0, mParallaxBy:I
    ...
    :goto_3
    iget v6, p0, mCoveredFadeColor:I

    invoke-direct {p0, v4, v5, v6}, dimChildView(Landroid/view/View;FI)V
...
.method public closePane()Z
    ...
    iget-object v0, p0, mSlideableView:Landroid/view/View;

    const/4 v1, 0x0

    invoke-direct {p0, v0, v1}, closePane(Landroid/view/View;I)Z
...
.method public computeScroll()V
    ...
    iget-object v0, p0, mDragHelper:Landroidx/customview/widget/ViewDragHelper;
    ...
    iget-boolean v0, p0, mCanSlide:Z
...
.method dispatchOnPanelClosed(Landroid/view/View;)V
    ...
    iget-object v0, p0, mPanelSlideListener:Landroidx/slidingpanelayout/widget/SlidingPaneLayout$PanelSlideListener;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, mShadowDrawableRight:Landroid/graphics/drawable/Drawable;

    goto :goto_0

    :cond_0
    iget-object v0, p0, mShadowDrawableLeft:Landroid/graphics/drawable/Drawable;
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    iget-boolean v2, p0, mCanSlide:Z
    ...
    iget-object v3, p0, mSlideableView:Landroid/view/View;
...
.method invalidateChildRegion(Landroid/view/View;)V
    ...
    iget-boolean v0, p0, mDisplayListReflectionLoaded:Z
    ...
    iput-object v0, p0, mGetDisplayList:Ljava/lang/reflect/Method;
    :try_end_0
    ...
    iput-object v0, p0, mRecreateDisplayList:Ljava/lang/reflect/Field;

    iget-object v0, p0, mRecreateDisplayList:Ljava/lang/reflect/Field;
    ...
    :goto_1
    iput-boolean v2, p0, mDisplayListReflectionLoaded:Z

    :cond_1
    iget-object v0, p0, mGetDisplayList:Ljava/lang/reflect/Method;
...
.method isDimmed(Landroid/view/View;)Z
    ...
    iget-boolean v1, p0, mCanSlide:Z
...
.method public isSlideable()Z
    ...
    iget-boolean p0, p0, mCanSlide:Z
...
.method protected onDetachedFromWindow()V
    ...
    iget-object v0, p0, mPostedRunnables:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, mPostedRunnables:Ljava/util/ArrayList;
    ...
    :cond_0
    iget-object p0, p0, mPostedRunnables:Ljava/util/ArrayList;
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v3, p0, mDragHelper:Landroidx/customview/widget/ViewDragHelper;
    ...
    iput-boolean v1, p0, mPreservedOpenState:Z
    ...
    iget-boolean v1, p0, mIsUnableToDrag:Z
    ...
    iget-object v4, p0, mDragHelper:Landroidx/customview/widget/ViewDragHelper;
    ...
    iget-object p1, p0, mDragHelper:Landroidx/customview/widget/ViewDragHelper;

    invoke-virtual {p1}, Landroidx/customview/widget/ViewDragHelper;->cancel()V

    iput-boolean v2, p0, mIsUnableToDrag:Z

    return v3

    :cond_4
    iput-boolean v3, p0, mIsUnableToDrag:Z
    ...
    invoke-virtual {p0, v0}, isDimmed(Landroid/view/View;)Z
...
.method protected onLayout(ZIIII)V
    ...
    invoke-virtual/range {p0 .. p0}, isLayoutRtlSupport()Z
    ...
    iget-object v3, v0, mDragHelper:Landroidx/customview/widget/ViewDragHelper;
    ...
    iget-boolean v8, v0, mFirstLayout:Z

    if-eqz v8, :cond_4

    iget-boolean v8, v0, mCanSlide:Z

    if-eqz v8, :cond_3

    iget-boolean v8, v0, mPreservedOpenState:Z
    ...
    :cond_8
    iget-boolean v2, v0, mCanSlide:Z

    if-eqz v2, :cond_9

    iget v2, v0, mParallaxBy:I

    if-eqz v2, :cond_9

    iget v8, v0, mSlideOffset:F
    ...
    iget-boolean v1, v0, mCanSlide:Z

    if-eqz v1, :cond_d

    iget v1, v0, mParallaxBy:I

    if-eqz v1, :cond_c

    iget v1, v0, mSlideOffset:F

    invoke-direct {v0, v1}, parallaxOtherViews(F)V

    :cond_c
    iget-object v1, v0, mSlideableView:Landroid/view/View;
    ...
    iget v2, v0, mSlideOffset:F

    iget v3, v0, mSliderFadeColor:I

    invoke-direct {v0, v1, v2, v3}, dimChildView(Landroid/view/View;FI)V
    ...
    invoke-direct {v0, v2, v4, v3}, dimChildView(Landroid/view/View;FI)V
    ...
    invoke-virtual {v0, v1}, updateObscuredViewsVisibility(Landroid/view/View;)V
...
.method protected onMeasure(II)V
    ...
    iput-object v10, v0, mSlideableView:Landroid/view/View;
    ...
    iput-object v6, v0, mSlideableView:Landroid/view/View;
    ...
    iget-object v15, v0, mSlideableView:Landroid/view/View;
    ...
    iput-boolean v11, v0, mCanSlide:Z

    iget-object v1, v0, mDragHelper:Landroidx/customview/widget/ViewDragHelper;
    ...
    iget-object v0, v0, mDragHelper:Landroidx/customview/widget/ViewDragHelper;
...
.method onPanelDragged(I)V
    ...
    iget-object v2, p0, mSlideableView:Landroid/view/View;
    ...
    iget p1, p0, mParallaxBy:I

    if-eqz p1, :cond_4

    iget p1, p0, mSlideOffset:F

    invoke-direct {p0, p1}, parallaxOtherViews(F)V
    ...
    iget-object p1, p0, mSlideableView:Landroid/view/View;

    iget v0, p0, mSlideOffset:F

    iget v1, p0, mSliderFadeColor:I

    invoke-direct {p0, p1, v0, v1}, dimChildView(Landroid/view/View;FI)V

    :cond_5
    iget-object p1, p0, mSlideableView:Landroid/view/View;

    invoke-virtual {p0, p1}, dispatchOnPanelSlide(Landroid/view/View;)V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {p0}, openPane()Z

    goto :goto_0

    :cond_1
    invoke-virtual {p0}, closePane()Z
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-virtual {p0}, isSlideable()Z
    ...
    :cond_0
    iget-boolean p0, p0, mPreservedOpenState:Z
...
.method protected onSizeChanged(IIII)V
    ...
    iput-boolean p1, p0, mFirstLayout:Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v2, p0, mDragHelper:Landroidx/customview/widget/ViewDragHelper;
    ...
    invoke-direct {p0, p1, v0}, closePane(Landroid/view/View;I)Z
...
.method public openPane()Z
    ...
    invoke-direct {p0, v0, v1}, openPane(Landroid/view/View;I)Z
...
.method public requestChildFocus(Landroid/view/View;Landroid/view/View;)V
    ...
    iget-boolean p2, p0, mCanSlide:Z

    if-nez p2, :cond_1

    iget-object p2, p0, mSlideableView:Landroid/view/View;
...
.method smoothSlideTo(FI)Z
    ...
    :goto_0
    iget-object p2, p0, mDragHelper:Landroidx/customview/widget/ViewDragHelper;
    ...
    invoke-virtual {p0}, setAllChildrenVisible()V
...
.method updateObscuredViewsVisibility(Landroid/view/View;)V
    ...
    invoke-static/range {p1 .. p1}, viewIsOpaque(Landroid/view/View;)Z
