...
.method public constructor <init>(Landroid/graphics/Bitmap;)V
    ...
    iput v0, p0, mMaxColors:I

    const/16 v0, 0x3100

    iput v0, p0, mResizeArea:I

    const/4 v0, -0x1

    iput v0, p0, mResizeMaxDimension:I

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mFilters:Ljava/util/List;
    ...
    iget-object v0, p0, mFilters:Ljava/util/List;
    ...
    iget-object p1, p0, mTargets:Ljava/util/List;
    ...
    iget-object p0, p0, mTargets:Ljava/util/List;
...
.method private getPixelsFromBitmap(Landroid/graphics/Bitmap;)[I
    ...
    iget-object p1, p0, mRegion:Landroid/graphics/Rect;
    ...
    iget-object v0, p0, mRegion:Landroid/graphics/Rect;
    ...
    iget-object v3, p0, mRegion:Landroid/graphics/Rect;
...
.method private scaleBitmapDown(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    :cond_0
    iget v0, p0, mResizeMaxDimension:I
    ...
    iget p0, p0, mResizeMaxDimension:I
...
.method public generate()Landroidx/palette/graphics/Palette;
    ...
    invoke-direct {p0, v0}, scaleBitmapDown(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;

    move-result-object v0

    iget-object v1, p0, mRegion:Landroid/graphics/Rect;
    ...
    invoke-direct {p0, v0}, getPixelsFromBitmap(Landroid/graphics/Bitmap;)[I

    move-result-object v2

    iget v3, p0, mMaxColors:I
...
.method public resizeBitmapArea(I)Landroidx/palette/graphics/Palette$Builder;
    ...
    iput p1, p0, mResizeArea:I

    const/4 p1, -0x1

    iput p1, p0, mResizeMaxDimension:I
...
.method public setRegion(IIII)Landroidx/palette/graphics/Palette$Builder;
    ...
    iput-object v0, p0, mRegion:Landroid/graphics/Rect;
