...
.method static constructor <clinit>()V
    ...
    sput-object v0, DEFAULT_FILTER:Landroidx/palette/graphics/Palette$Filter;
...
.method constructor <init>(Ljava/util/List;Ljava/util/List;)V
    ...
    iput-object p1, p0, mSwatches:Ljava/util/List;

    iput-object p2, p0, mTargets:Ljava/util/List;

    new-instance p1, Landroid/util/SparseBooleanArray;

    invoke-direct {p1}, Landroid/util/SparseBooleanArray;-><init>()V

    iput-object p1, p0, mUsedColors:Landroid/util/SparseBooleanArray;

    new-instance p1, Landroidx/collection/ArrayMap;

    invoke-direct {p1}, Landroidx/collection/ArrayMap;-><init>()V

    iput-object p1, p0, mSelectedSwatches:Ljava/util/Map;

    invoke-direct {p0}, findDominantSwatch()Landroidx/palette/graphics/Palette$Swatch;

    move-result-object p1

    iput-object p1, p0, mDominantSwatch:Landroidx/palette/graphics/Palette$Swatch;
...
.method private findDominantSwatch()Landroidx/palette/graphics/Palette$Swatch;
    ...
    iget-object v0, p0, mSwatches:Ljava/util/List;
    ...
    iget-object v4, p0, mSwatches:Ljava/util/List;
...
.method private generateScore(Landroidx/palette/graphics/Palette$Swatch;Landroidx/palette/graphics/Target;)F
    ...
    iget-object p0, p0, mDominantSwatch:Landroidx/palette/graphics/Palette$Swatch;
...
.method private generateScoredTarget(Landroidx/palette/graphics/Target;)Landroidx/palette/graphics/Palette$Swatch;
    ...
    invoke-direct {p0, p1}, getMaxScoredSwatchForTarget(Landroidx/palette/graphics/Target;)Landroidx/palette/graphics/Palette$Swatch;
    ...
    iget-object p0, p0, mUsedColors:Landroid/util/SparseBooleanArray;
...
.method private getMaxScoredSwatchForTarget(Landroidx/palette/graphics/Target;)Landroidx/palette/graphics/Palette$Swatch;
    ...
    invoke-direct {p0, v4, p1}, shouldBeScoredForTarget(Landroidx/palette/graphics/Palette$Swatch;Landroidx/palette/graphics/Target;)Z

    move-result v5

    if-eqz v5, :cond_1

    invoke-direct {p0, v4, p1}, generateScore(Landroidx/palette/graphics/Palette$Swatch;Landroidx/palette/graphics/Target;)F
...
.method generate()V
    ...
    iget-object v0, p0, mTargets:Ljava/util/List;
    ...
    iget-object v2, p0, mTargets:Ljava/util/List;
    ...
    iget-object v3, p0, mSelectedSwatches:Ljava/util/Map;

    invoke-direct {p0, v2}, generateScoredTarget(Landroidx/palette/graphics/Target;)Landroidx/palette/graphics/Palette$Swatch;
...
.method public getDarkMutedSwatch()Landroidx/palette/graphics/Palette$Swatch;
    ...
    invoke-virtual {p0, v0}, getSwatchForTarget(Landroidx/palette/graphics/Target;)Landroidx/palette/graphics/Palette$Swatch;
...
.method public getSwatchForTarget(Landroidx/palette/graphics/Target;)Landroidx/palette/graphics/Palette$Swatch;
    ...
    iget-object p0, p0, mSelectedSwatches:Ljava/util/Map;
...
.method public getSwatches()Ljava/util/List;
    ...
    iget-object p0, p0, mSwatches:Ljava/util/List;
