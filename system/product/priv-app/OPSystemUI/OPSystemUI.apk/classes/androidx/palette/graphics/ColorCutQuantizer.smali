...
.method static constructor <clinit>()V
    ...
    sput-object v0, VBOX_COMPARATOR_VOLUME:Ljava/util/Comparator;
...
.method constructor <init>([II[Landroidx/palette/graphics/Palette$Filter;)V
    ...
    iput-object v0, p0, mTempHsl:[F

    const/4 v0, 0x0

    iput-object v0, p0, mTimingLogger:Landroid/util/TimingLogger;

    iput-object p3, p0, mFilters:[Landroidx/palette/graphics/Palette$Filter;

    const p3, 0x8000

    new-array p3, p3, [I

    iput-object p3, p0, mHistogram:[I
    ...
    invoke-static {v2}, quantizeFromRgb888(I)I
    ...
    invoke-direct {p0, p1}, shouldIgnoreColor(I)Z
    ...
    iput-object p2, p0, mQuantizedColors:Ljava/util/List;
    ...
    iget-object v2, p0, mQuantizedColors:Ljava/util/List;

    new-instance v3, Landroidx/palette/graphics/Palette$Swatch;

    invoke-static {v1}, approximateToRgb888(I)I
    ...
    :cond_6
    invoke-direct {p0, p2}, quantizePixels(I)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, mQuantizedColors:Ljava/util/List;
...
.method private static approximateToRgb888(I)I
    ...
    invoke-static {p0}, quantizedRed(I)I

    move-result v0

    invoke-static {p0}, quantizedGreen(I)I

    move-result v1

    invoke-static {p0}, quantizedBlue(I)I

    move-result p0

    invoke-static {v0, v1, p0}, approximateToRgb888(III)I
...
.method static approximateToRgb888(III)I
    ...
    invoke-static {p0, v1, v0}, modifyWordWidth(III)I

    move-result p0

    invoke-static {p1, v1, v0}, modifyWordWidth(III)I

    move-result p1

    invoke-static {p2, v1, v0}, modifyWordWidth(III)I
...
.method private generateAverageColors(Ljava/util/Collection;)Ljava/util/List;
    ...
    invoke-direct {p0, v1}, shouldIgnoreColor(Landroidx/palette/graphics/Palette$Swatch;)Z
...
.method static modifySignificantOctet([IIII)V
    ...
    invoke-static {p1}, quantizedBlue(I)I

    move-result v0

    shl-int/lit8 v0, v0, 0xa

    invoke-static {p1}, quantizedGreen(I)I
    ...
    invoke-static {p1}, quantizedRed(I)I
...
.method private static quantizeFromRgb888(I)I
    ...
    invoke-static {v0, v1, v2}, modifyWordWidth(III)I
    ...
    invoke-static {v3, v1, v2}, modifyWordWidth(III)I
    ...
    invoke-static {p0, v1, v2}, modifyWordWidth(III)I
...
.method private quantizePixels(I)Ljava/util/List;
    ...
    sget-object v1, VBOX_COMPARATOR_VOLUME:Ljava/util/Comparator;
    ...
    invoke-direct {p0, v0, p1}, splitBoxes(Ljava/util/PriorityQueue;I)V

    invoke-direct {p0, v0}, generateAverageColors(Ljava/util/Collection;)Ljava/util/List;
...
.method private shouldIgnoreColor(I)Z
    ...
    invoke-static {p1}, approximateToRgb888(I)I

    move-result p1

    iget-object v0, p0, mTempHsl:[F

    invoke-static {p1, v0}, Landroidx/core/graphics/ColorUtils;->colorToHSL(I[F)V

    iget-object v0, p0, mTempHsl:[F

    invoke-direct {p0, p1, v0}, shouldIgnoreColor(I[F)Z
...
.method private shouldIgnoreColor(I[F)Z
    ...
    iget-object v0, p0, mFilters:[Landroidx/palette/graphics/Palette$Filter;
    ...
    iget-object v3, p0, mFilters:[Landroidx/palette/graphics/Palette$Filter;
...
.method private shouldIgnoreColor(Landroidx/palette/graphics/Palette$Swatch;)Z
    ...
    invoke-direct {p0, v0, p1}, shouldIgnoreColor(I[F)Z
...
.method getQuantizedColors()Ljava/util/List;
    ...
    iget-object p0, p0, mQuantizedColors:Ljava/util/List;
