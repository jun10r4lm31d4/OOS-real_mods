...
.method public constructor <init>(Landroid/os/Parcel;)V
    ...
    iput-object v0, p0, mFragmentWhos:Ljava/util/ArrayList;

    invoke-virtual {p1}, Landroid/os/Parcel;->createIntArray()[I

    move-result-object v0

    iput-object v0, p0, mOldMaxLifecycleStates:[I

    invoke-virtual {p1}, Landroid/os/Parcel;->createIntArray()[I

    move-result-object v0

    iput-object v0, p0, mCurrentMaxLifecycleStates:[I
...
.method public constructor <init>(Landroidx/fragment/app/BackStackRecord;)V
    ...
    iput-object v1, p0, mFragmentWhos:Ljava/util/ArrayList;

    new-array v1, v0, [I

    iput-object v1, p0, mOldMaxLifecycleStates:[I

    new-array v1, v0, [I

    iput-object v1, p0, mCurrentMaxLifecycleStates:[I
    ...
    iget-object v2, p0, mFragmentWhos:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, mOldMaxLifecycleStates:[I
    ...
    iget-object v2, p0, mCurrentMaxLifecycleStates:[I
...
.method public instantiate(Landroidx/fragment/app/FragmentManagerImpl;)Landroidx/fragment/app/BackStackRecord;
    ...
    :cond_0
    iget-object v1, p0, mFragmentWhos:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, mOldMaxLifecycleStates:[I
    ...
    iget-object v4, p0, mCurrentMaxLifecycleStates:[I
    ...
    iget-object v1, p0, mBreadCrumbTitleText:Ljava/lang/CharSequence;
    ...
    iget-object v1, p0, mBreadCrumbShortTitleText:Ljava/lang/CharSequence;
    ...
    iget-boolean p0, p0, mReorderingAllowed:Z
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    iget-object p2, p0, mOps:[I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeIntArray([I)V

    iget-object p2, p0, mFragmentWhos:Ljava/util/ArrayList;

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeStringList(Ljava/util/List;)V

    iget-object p2, p0, mOldMaxLifecycleStates:[I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeIntArray([I)V

    iget-object p2, p0, mCurrentMaxLifecycleStates:[I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeIntArray([I)V

    iget p2, p0, mTransition:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    iget p2, p0, mTransitionStyle:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    iget-object p2, p0, mName:Ljava/lang/String;
    ...
    iget p2, p0, mBreadCrumbTitleRes:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    iget-object p2, p0, mBreadCrumbTitleText:Ljava/lang/CharSequence;

    const/4 v0, 0x0

    invoke-static {p2, p1, v0}, Landroid/text/TextUtils;->writeToParcel(Ljava/lang/CharSequence;Landroid/os/Parcel;I)V

    iget p2, p0, mBreadCrumbShortTitleRes:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    iget-object p2, p0, mBreadCrumbShortTitleText:Ljava/lang/CharSequence;

    invoke-static {p2, p1, v0}, Landroid/text/TextUtils;->writeToParcel(Ljava/lang/CharSequence;Landroid/os/Parcel;I)V

    iget-object p2, p0, mSharedElementSourceNames:Ljava/util/ArrayList;

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeStringList(Ljava/util/List;)V

    iget-object p2, p0, mSharedElementTargetNames:Ljava/util/ArrayList;
