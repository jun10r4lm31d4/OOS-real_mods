...
.method public constructor <init>(Landroid/graphics/drawable/BitmapDrawable;Landroid/graphics/Rect;)V
    ...
    iput v0, p0, mCurrentAlpha:F

    iput v0, p0, mStartAlpha:F

    iput v0, p0, mEndAlpha:F

    iput-object p1, p0, mBitmap:Landroid/graphics/drawable/BitmapDrawable;

    iput-object p2, p0, mStartRect:Landroid/graphics/Rect;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1, p2}, Landroid/graphics/Rect;-><init>(Landroid/graphics/Rect;)V

    iput-object p1, p0, mCurrentBounds:Landroid/graphics/Rect;

    iget-object p1, p0, mBitmap:Landroid/graphics/drawable/BitmapDrawable;

    if-eqz p1, :cond_0

    iget-object p2, p0, mCurrentBounds:Landroid/graphics/Rect;

    if-eqz p2, :cond_0

    iget p2, p0, mCurrentAlpha:F
...
.method public getBitmapDrawable()Landroid/graphics/drawable/BitmapDrawable;
    ...
    iget-object p0, p0, mBitmap:Landroid/graphics/drawable/BitmapDrawable;
...
.method public isAnimationStarted()Z
    ...
    iget-boolean p0, p0, mIsAnimationStarted:Z
...
.method public setAlphaAnimation(FF)Landroidx/mediarouter/app/OverlayListView$OverlayObject;
    ...
    iput p1, p0, mStartAlpha:F

    iput p2, p0, mEndAlpha:F
...
.method public setAnimationEndListener(Landroidx/mediarouter/app/OverlayListView$OverlayObject$OnAnimationEndListener;)Landroidx/mediarouter/app/OverlayListView$OverlayObject;
    ...
    iput-object p1, p0, mListener:Landroidx/mediarouter/app/OverlayListView$OverlayObject$OnAnimationEndListener;
...
.method public startAnimation(J)V
    ...
    iput-boolean p1, p0, mIsAnimationStarted:Z
...
.method public stopAnimation()V
    ...
    iput-boolean v0, p0, mIsAnimationStarted:Z

    iput-boolean v0, p0, mIsAnimationEnded:Z

    iget-object p0, p0, mListener:Landroidx/mediarouter/app/OverlayListView$OverlayObject$OnAnimationEndListener;
...
.method public update(J)Z
    ...
    iget-boolean v0, p0, mIsAnimationEnded:Z
    ...
    iget-boolean v1, p0, mIsAnimationStarted:Z
    ...
    iget-object v3, p0, mStartRect:Landroid/graphics/Rect;
    ...
    iget v1, p0, mStartAlpha:F

    iget v3, p0, mEndAlpha:F
    ...
    iput v1, p0, mCurrentAlpha:F

    iget-object v0, p0, mBitmap:Landroid/graphics/drawable/BitmapDrawable;

    if-eqz v0, :cond_3

    if-eqz v2, :cond_3

    iget v1, p0, mCurrentAlpha:F
    ...
    :cond_3
    iget-boolean v0, p0, mIsAnimationStarted:Z
    ...
    iput-boolean v1, p0, mIsAnimationEnded:Z

    iget-object p1, p0, mListener:Landroidx/mediarouter/app/OverlayListView$OverlayObject$OnAnimationEndListener;
    ...
    :cond_4
    iget-boolean p0, p0, mIsAnimationEnded:Z
