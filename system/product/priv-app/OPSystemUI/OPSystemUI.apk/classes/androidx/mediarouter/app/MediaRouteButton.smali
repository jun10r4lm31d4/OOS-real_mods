...
.method static constructor <clinit>()V
    ...
    sput-object v0, sRemoteIndicatorCache:Landroid/util/SparseArray;
    ...
    sput-object v0, CHECKABLE_STATE_SET:[I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p1, p0, mDialogFactory:Landroidx/mediarouter/app/MediaRouteDialogFactory;
    ...
    iput-object p2, p0, mCallback:Landroidx/mediarouter/app/MediaRouteButton$MediaRouterCallback;
    ...
    iput-object p1, p0, mRemoteIndicator:Landroid/graphics/drawable/Drawable;
    ...
    sget-object p2, sConnectivityReceiver:Landroidx/mediarouter/app/MediaRouteButton$ConnectivityReceiver;
    ...
    sput-object p2, sConnectivityReceiver:Landroidx/mediarouter/app/MediaRouteButton$ConnectivityReceiver;
    ...
    iput-object p2, p0, mButtonTint:Landroid/content/res/ColorStateList;
    ...
    iput p3, p0, mRemoteIndicatorResIdToLoad:I

    invoke-virtual {v8}, Landroid/content/res/TypedArray;->recycle()V

    iget p3, p0, mRemoteIndicatorResIdToLoad:I

    if-eqz p3, :cond_3

    sget-object v0, sRemoteIndicatorCache:Landroid/util/SparseArray;
    ...
    invoke-virtual {p0, p3}, setRemoteIndicatorDrawable(Landroid/graphics/drawable/Drawable;)V

    :cond_3
    iget-object p3, p0, mRemoteIndicator:Landroid/graphics/drawable/Drawable;

    if-nez p3, :cond_6

    if-eqz p2, :cond_5

    sget-object p3, sRemoteIndicatorCache:Landroid/util/SparseArray;
    ...
    invoke-virtual {p0, p1}, setRemoteIndicatorDrawableInternal(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object p3, p0, mRemoteIndicatorLoader:Landroidx/mediarouter/app/MediaRouteButton$RemoteIndicatorLoader;

    iget-object p2, p0, mRemoteIndicatorLoader:Landroidx/mediarouter/app/MediaRouteButton$RemoteIndicatorLoader;
    ...
    :cond_5
    invoke-direct {p0}, loadRemoteIndicatorIfNeeded()V

    :cond_6
    :goto_0
    invoke-direct {p0}, updateContentDescription()V
...
.method private getFragmentManager()Landroidx/fragment/app/FragmentManager;
    ...
    invoke-direct {p0}, getActivity()Landroid/app/Activity;
...
.method private loadRemoteIndicatorIfNeeded()V
    ...
    iget v0, p0, mRemoteIndicatorResIdToLoad:I

    if-lez v0, :cond_1

    iget-object v0, p0, mRemoteIndicatorLoader:Landroidx/mediarouter/app/MediaRouteButton$RemoteIndicatorLoader;
    ...
    iget v2, p0, mRemoteIndicatorResIdToLoad:I
    ...
    iput-object v0, p0, mRemoteIndicatorLoader:Landroidx/mediarouter/app/MediaRouteButton$RemoteIndicatorLoader;

    iput v1, p0, mRemoteIndicatorResIdToLoad:I

    iget-object p0, p0, mRemoteIndicatorLoader:Landroidx/mediarouter/app/MediaRouteButton$RemoteIndicatorLoader;
...
.method protected drawableStateChanged()V
    ...
    iget-object v0, p0, mRemoteIndicator:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, p0, mRemoteIndicator:Landroid/graphics/drawable/Drawable;
...
.method public enableDynamicGroup()V
    ...
    iput-boolean v0, p0, mUseDynamicGroup:Z
...
.method public jumpDrawablesToCurrentState()V
    ...
    iget-object p0, p0, mRemoteIndicator:Landroid/graphics/drawable/Drawable;
...
.method public onAttachedToWindow()V
    ...
    iget-object v1, p0, mSelector:Landroidx/mediarouter/media/MediaRouteSelector;

    iget-object v2, p0, mCallback:Landroidx/mediarouter/app/MediaRouteButton$MediaRouterCallback;
    ...
    :cond_1
    invoke-virtual {p0}, refreshRoute()V

    sget-object v0, sConnectivityReceiver:Landroidx/mediarouter/app/MediaRouteButton$ConnectivityReceiver;
...
.method protected onCreateDrawableState(I)[I
    ...
    :cond_1
    sget-object p0, CHECKABLE_STATE_SET:[I
...
.method public onDetachedFromWindow()V
    ...
    iget-object v1, p0, mCallback:Landroidx/mediarouter/app/MediaRouteButton$MediaRouterCallback;
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v4, p0, mRemoteIndicator:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v4}, Landroid/graphics/drawable/Drawable;->getIntrinsicWidth()I

    move-result v4

    iget-object v5, p0, mRemoteIndicator:Landroid/graphics/drawable/Drawable;
...
.method protected onMeasure(II)V
    ...
    iget-object v3, p0, mRemoteIndicator:Landroid/graphics/drawable/Drawable;
...
.method public performClick()Z
    ...
    invoke-virtual {p0}, showDialog()Z
...
.method refreshRoute()V
    ...
    :goto_1
    iget v1, p0, mConnectionState:I

    if-eq v1, v0, :cond_2

    iput v0, p0, mConnectionState:I
    ...
    :cond_4
    iget-boolean v4, p0, mAttachedToWindow:Z

    if-eqz v4, :cond_7

    iget-boolean v4, p0, mAlwaysVisible:Z

    if-nez v4, :cond_5

    iget-object v4, p0, mRouter:Landroidx/mediarouter/media/MediaRouter;

    iget-object v5, p0, mSelector:Landroidx/mediarouter/media/MediaRouteSelector;
    ...
    :cond_7
    iget-object v2, p0, mRemoteIndicator:Landroid/graphics/drawable/Drawable;
    ...
    iget-boolean p0, p0, mAttachedToWindow:Z
...
.method refreshVisibility()V
    ...
    iget-boolean v0, p0, mAlwaysVisible:Z
...
.method public setAlwaysVisible(Z)V
    ...
    iput-boolean p1, p0, mAlwaysVisible:Z

    invoke-virtual {p0}, refreshVisibility()V
...
.method public setRemoteIndicatorDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iput v0, p0, mRemoteIndicatorResIdToLoad:I
...
.method setRemoteIndicatorDrawableInternal(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v2, p0, mButtonTint:Landroid/content/res/ColorStateList;
    ...
    iget-boolean p1, p0, mAttachedToWindow:Z

    if-eqz p1, :cond_7

    iget-object p1, p0, mRemoteIndicator:Landroid/graphics/drawable/Drawable;
...
.method public showDialog()Z
    ...
    :cond_0
    invoke-direct {p0}, getFragmentManager()Landroidx/fragment/app/FragmentManager;

    move-result-object v0

    if-eqz v0, :cond_5

    iget-object v2, p0, mRouter:Landroidx/mediarouter/media/MediaRouter;
    ...
    iget-object v3, p0, mSelector:Landroidx/mediarouter/media/MediaRouteSelector;
    ...
    :cond_2
    iget-object v1, p0, mDialogFactory:Landroidx/mediarouter/app/MediaRouteDialogFactory;
    ...
    iget-boolean p0, p0, mUseDynamicGroup:Z
