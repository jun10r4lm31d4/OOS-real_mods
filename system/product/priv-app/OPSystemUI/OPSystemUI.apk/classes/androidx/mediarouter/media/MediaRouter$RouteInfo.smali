...
.method constructor <init>(Landroidx/mediarouter/media/MediaRouter$ProviderInfo;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v0, p0, mControlFilters:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, mMemberRoutes:Ljava/util/List;

    iput-object p1, p0, mProvider:Landroidx/mediarouter/media/MediaRouter$ProviderInfo;
...
.method private isSameControlFilters(Ljava/util/List;Ljava/util/List;)Z
    ...
    invoke-direct {p0, v2, v3}, isSameControlFilter(Landroid/content/IntentFilter;Landroid/content/IntentFilter;)Z
...
.method private static isSystemMediaRouteProvider(Landroidx/mediarouter/media/MediaRouter$RouteInfo;)Z
    ...
    invoke-virtual {p0}, getProviderInstance()Landroidx/mediarouter/media/MediaRouteProvider;
...
.method public canDisconnect()Z
    ...
    iget-boolean p0, p0, mCanDisconnect:Z
...
.method findRouteByDynamicRouteDescriptor(Landroidx/mediarouter/media/MediaRouteProvider$DynamicGroupRouteController$DynamicRouteDescriptor;)Landroidx/mediarouter/media/MediaRouter$RouteInfo;
    ...
    invoke-virtual {p0}, getProvider()Landroidx/mediarouter/media/MediaRouter$ProviderInfo;
...
.method public getDescription()Ljava/lang/String;
    ...
    iget-object p0, p0, mDescription:Ljava/lang/String;
...
.method getDescriptorId()Ljava/lang/String;
    ...
    iget-object p0, p0, mDescriptorId:Ljava/lang/String;
...
.method public getDynamicGroupState()Landroidx/mediarouter/media/MediaRouter$RouteInfo$DynamicGroupState;
    ...
    iget-object v0, p0, mDynamicGroupState:Landroidx/mediarouter/media/MediaRouter$RouteInfo$DynamicGroupState;

    if-nez v0, :cond_0

    iget-object v0, p0, mDynamicDescriptor:Landroidx/mediarouter/media/MediaRouteProvider$DynamicGroupRouteController$DynamicRouteDescriptor;
    ...
    iput-object v0, p0, mDynamicGroupState:Landroidx/mediarouter/media/MediaRouter$RouteInfo$DynamicGroupState;

    :cond_0
    iget-object p0, p0, mDynamicGroupState:Landroidx/mediarouter/media/MediaRouter$RouteInfo$DynamicGroupState;
...
.method public getIconUri()Landroid/net/Uri;
    ...
    iget-object p0, p0, mIconUri:Landroid/net/Uri;
...
.method public getId()Ljava/lang/String;
    ...
    iget-object p0, p0, mUniqueId:Ljava/lang/String;
...
.method public getMemberRoutes()Ljava/util/List;
    ...
    iget-object p0, p0, mMemberRoutes:Ljava/util/List;
...
.method public getPresentationDisplayId()I
    ...
    iget p0, p0, mPresentationDisplayId:I
...
.method public getProvider()Landroidx/mediarouter/media/MediaRouter$ProviderInfo;
    ...
    iget-object p0, p0, mProvider:Landroidx/mediarouter/media/MediaRouter$ProviderInfo;
...
.method public isDefaultOrBluetooth()Z
    ...
    :cond_0
    invoke-static {p0}, isSystemMediaRouteProvider(Landroidx/mediarouter/media/MediaRouter$RouteInfo;)Z
    ...
    invoke-virtual {p0, v0}, supportsControlCategory(Ljava/lang/String;)Z
...
.method public isGroup()Z
    ...
    invoke-virtual {p0}, getMemberRoutes()Ljava/util/List;
...
.method isSelectable()Z
    ...
    iget-object v0, p0, mDescriptor:Landroidx/mediarouter/media/MediaRouteDescriptor;
...
.method public matchesSelector(Landroidx/mediarouter/media/MediaRouteSelector;)Z
    ...
    iget-object p0, p0, mControlFilters:Ljava/util/ArrayList;
...
.method maybeUpdateDescriptor(Landroidx/mediarouter/media/MediaRouteDescriptor;)I
    ...
    invoke-virtual {p0, p1}, updateDescriptor(Landroidx/mediarouter/media/MediaRouteDescriptor;)I
...
.method public supportsControlCategory(Ljava/lang/String;)Z
    ...
    iget-object v0, p0, mControlFilters:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, mControlFilters:Ljava/util/ArrayList;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, mMemberRoutes:Ljava/util/List;
    ...
    :cond_0
    iget-object v3, p0, mMemberRoutes:Ljava/util/List;
    ...
    iget-object v1, p0, mIconUri:Landroid/net/Uri;
    ...
    iget-boolean v1, p0, mCanDisconnect:Z
    ...
    iget v1, p0, mPresentationDisplayId:I
    ...
    iget-object v1, p0, mSettingsIntent:Landroid/content/IntentSender;
...
.method updateDescriptor(Landroidx/mediarouter/media/MediaRouteDescriptor;)I
    ...
    iput-object p1, p0, mDescriptor:Landroidx/mediarouter/media/MediaRouteDescriptor;
    ...
    iput-object v3, p0, mDescription:Ljava/lang/String;

    or-int/lit8 v1, v1, 0x1

    :cond_1
    iget-object v3, p0, mIconUri:Landroid/net/Uri;
    ...
    iput-object v3, p0, mIconUri:Landroid/net/Uri;
    ...
    iput-boolean v3, p0, mEnabled:Z

    or-int/lit8 v1, v1, 0x1

    :cond_3
    iget v3, p0, mConnectionState:I
    ...
    invoke-direct {p0, v3, v4}, isSameControlFilters(Ljava/util/List;Ljava/util/List;)Z
    ...
    iput v3, p0, mVolumeHandling:I

    or-int/lit8 v1, v1, 0x3

    :cond_9
    iget v3, p0, mVolume:I
    ...
    iput v3, p0, mVolumeMax:I

    or-int/lit8 v1, v1, 0x3

    :cond_b
    iget v3, p0, mPresentationDisplayId:I
    ...
    iput v3, p0, mPresentationDisplayId:I

    const/4 v3, 0x0

    iput-object v3, p0, mPresentationDisplay:Landroid/view/Display;
    ...
    :cond_d
    iget-object v3, p0, mSettingsIntent:Landroid/content/IntentSender;
    ...
    iput-object v3, p0, mSettingsIntent:Landroid/content/IntentSender;

    or-int/lit8 v1, v1, 0x1

    :cond_e
    iget-boolean v3, p0, mCanDisconnect:Z
    ...
    iput-boolean v3, p0, mCanDisconnect:Z
    ...
    iget-object v5, p0, mMemberRoutes:Ljava/util/List;
    ...
    iput-object v3, p0, mMemberRoutes:Ljava/util/List;
...
.method updateDescriptors(Ljava/util/Collection;)V
    ...
    invoke-virtual {p0, v0}, findRouteByDynamicRouteDescriptor(Landroidx/mediarouter/media/MediaRouteProvider$DynamicGroupRouteController$DynamicRouteDescriptor;)Landroidx/mediarouter/media/MediaRouter$RouteInfo;
    ...
    :cond_1
    iput-object v0, v1, mDynamicDescriptor:Landroidx/mediarouter/media/MediaRouteProvider$DynamicGroupRouteController$DynamicRouteDescriptor;
