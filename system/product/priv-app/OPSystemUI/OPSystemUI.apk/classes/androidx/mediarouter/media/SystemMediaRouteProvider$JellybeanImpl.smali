...
.method static constructor <clinit>()V
    ...
    sput-object v1, LIVE_AUDIO_CONTROL_FILTERS:Ljava/util/ArrayList;

    sget-object v1, LIVE_AUDIO_CONTROL_FILTERS:Ljava/util/ArrayList;
    ...
    sput-object v1, LIVE_VIDEO_CONTROL_FILTERS:Ljava/util/ArrayList;

    sget-object v1, LIVE_VIDEO_CONTROL_FILTERS:Ljava/util/ArrayList;
...
.method public constructor <init>(Landroid/content/Context;Landroidx/mediarouter/media/SystemMediaRouteProvider$SyncCallback;)V
    ...
    iput-object v0, p0, mSystemRouteRecords:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mUserRouteRecords:Ljava/util/ArrayList;

    iput-object p2, p0, mSyncCallback:Landroidx/mediarouter/media/SystemMediaRouteProvider$SyncCallback;
    ...
    iput-object p2, p0, mRouterObj:Ljava/lang/Object;

    invoke-virtual {p0}, createCallbackObj()Ljava/lang/Object;

    move-result-object p2

    iput-object p2, p0, mCallbackObj:Ljava/lang/Object;

    invoke-virtual {p0}, createVolumeCallbackObj()Ljava/lang/Object;

    move-result-object p2

    iput-object p2, p0, mVolumeCallbackObj:Ljava/lang/Object;

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object p1

    iget-object p2, p0, mRouterObj:Ljava/lang/Object;
    ...
    iput-object p1, p0, mUserRouteCategoryObj:Ljava/lang/Object;

    invoke-direct {p0}, updateSystemRoutes()V
...
.method private addSystemRouteNoPublish(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p1}, getUserRouteRecord(Ljava/lang/Object;)Landroidx/mediarouter/media/SystemMediaRouteProvider$JellybeanImpl$UserRouteRecord;

    move-result-object v0

    if-nez v0, :cond_0

    invoke-virtual {p0, p1}, findSystemRouteRecord(Ljava/lang/Object;)I

    move-result v0

    if-gez v0, :cond_0

    invoke-direct {p0, p1}, assignRouteId(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, updateSystemRouteDescriptor(Landroidx/mediarouter/media/SystemMediaRouteProvider$JellybeanImpl$SystemRouteRecord;)V

    iget-object p0, p0, mSystemRouteRecords:Ljava/util/ArrayList;
...
.method private assignRouteId(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {p0}, getDefaultRoute()Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, getRouteName(Ljava/lang/Object;)Ljava/lang/String;
    ...
    :goto_1
    invoke-virtual {p0, p1}, findSystemRouteRecordByDescriptorId(Ljava/lang/String;)I
    ...
    invoke-virtual {p0, v4}, findSystemRouteRecordByDescriptorId(Ljava/lang/String;)I
...
.method private updateSystemRoutes()V
    ...
    invoke-virtual {p0}, updateCallback()V

    iget-object v0, p0, mRouterObj:Ljava/lang/Object;
    ...
    invoke-direct {p0, v2}, addSystemRouteNoPublish(Ljava/lang/Object;)Z
...
.method protected findSystemRouteRecord(Ljava/lang/Object;)I
    ...
    iget-object v0, p0, mSystemRouteRecords:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, mSystemRouteRecords:Ljava/util/ArrayList;
...
.method protected findUserRouteRecord(Landroidx/mediarouter/media/MediaRouter$RouteInfo;)I
    ...
    iget-object v0, p0, mUserRouteRecords:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, mUserRouteRecords:Ljava/util/ArrayList;
...
.method protected getDefaultRoute()Ljava/lang/Object;
    ...
    iget-object v0, p0, mGetDefaultRouteWorkaround:Landroidx/mediarouter/media/MediaRouterJellybean$GetDefaultRouteWorkaround;
    ...
    iput-object v0, p0, mGetDefaultRouteWorkaround:Landroidx/mediarouter/media/MediaRouterJellybean$GetDefaultRouteWorkaround;

    :cond_0
    iget-object v0, p0, mGetDefaultRouteWorkaround:Landroidx/mediarouter/media/MediaRouterJellybean$GetDefaultRouteWorkaround;

    iget-object p0, p0, mRouterObj:Ljava/lang/Object;
...
.method protected onBuildSystemRouteDescriptor(Landroidx/mediarouter/media/SystemMediaRouteProvider$JellybeanImpl$SystemRouteRecord;Landroidx/mediarouter/media/MediaRouteDescriptor$Builder;)V
    ...
    sget-object v0, LIVE_AUDIO_CONTROL_FILTERS:Ljava/util/ArrayList;
    ...
    sget-object p0, LIVE_VIDEO_CONTROL_FILTERS:Ljava/util/ArrayList;
...
.method public onDiscoveryRequestChanged(Landroidx/mediarouter/media/MediaRouteDiscoveryRequest;)V
    ...
    iget-boolean v1, p0, mActiveScan:Z

    if-eq v1, p1, :cond_5

    :cond_4
    iput v0, p0, mRouteTypes:I

    iput-boolean p1, p0, mActiveScan:Z
...
.method public onRouteAdded(Ljava/lang/Object;)V
    ...
    invoke-direct {p0, p1}, addSystemRouteNoPublish(Ljava/lang/Object;)Z
...
.method public onRouteChanged(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, updateSystemRouteDescriptor(Landroidx/mediarouter/media/SystemMediaRouteProvider$JellybeanImpl$SystemRouteRecord;)V
...
.method public onRouteSelected(ILjava/lang/Object;)V
    ...
    iget-object p1, p0, mRouterObj:Ljava/lang/Object;
    ...
    :cond_0
    invoke-virtual {p0, p2}, getUserRouteRecord(Ljava/lang/Object;)Landroidx/mediarouter/media/SystemMediaRouteProvider$JellybeanImpl$UserRouteRecord;
    ...
    :cond_1
    invoke-virtual {p0, p2}, findSystemRouteRecord(Ljava/lang/Object;)I

    move-result p1

    if-ltz p1, :cond_2

    iget-object p2, p0, mSystemRouteRecords:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, mSyncCallback:Landroidx/mediarouter/media/SystemMediaRouteProvider$SyncCallback;
...
.method public onRouteVolumeChanged(Ljava/lang/Object;)V
    ...
    iget-object v1, p0, mSystemRouteRecords:Ljava/util/ArrayList;
...
.method public onSyncRouteAdded(Landroidx/mediarouter/media/MediaRouter$RouteInfo;)V
    ...
    iget-object v1, p0, mUserRouteCategoryObj:Ljava/lang/Object;
    ...
    iget-object p1, p0, mVolumeCallbackObj:Ljava/lang/Object;
    ...
    invoke-virtual {p0, v1}, updateUserRouteProperties(Landroidx/mediarouter/media/SystemMediaRouteProvider$JellybeanImpl$UserRouteRecord;)V

    iget-object p1, p0, mUserRouteRecords:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v0}, findSystemRouteRecord(Ljava/lang/Object;)I
...
.method public onSyncRouteChanged(Landroidx/mediarouter/media/MediaRouter$RouteInfo;)V
    ...
    invoke-virtual {p0, p1}, findUserRouteRecord(Landroidx/mediarouter/media/MediaRouter$RouteInfo;)I
    ...
    invoke-virtual {p0, p1}, updateUserRouteProperties(Landroidx/mediarouter/media/SystemMediaRouteProvider$JellybeanImpl$UserRouteRecord;)V
...
.method public onSyncRouteSelected(Landroidx/mediarouter/media/MediaRouter$RouteInfo;)V
    ...
    invoke-virtual {p0, p1}, selectRoute(Ljava/lang/Object;)V
...
.method protected publishRoutes()V
    ...
    iget-object v3, p0, mSystemRouteRecords:Ljava/util/ArrayList;
...
.method protected selectRoute(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, mSelectRouteWorkaround:Landroidx/mediarouter/media/MediaRouterJellybean$SelectRouteWorkaround;
    ...
    iput-object v0, p0, mSelectRouteWorkaround:Landroidx/mediarouter/media/MediaRouterJellybean$SelectRouteWorkaround;
...
.method protected updateCallback()V
    ...
    iget-boolean v0, p0, mCallbackRegistered:Z

    if-eqz v0, :cond_0

    const/4 v0, 0x0

    iput-boolean v0, p0, mCallbackRegistered:Z

    iget-object v0, p0, mRouterObj:Ljava/lang/Object;

    iget-object v1, p0, mCallbackObj:Ljava/lang/Object;
    ...
    iput-boolean v1, p0, mCallbackRegistered:Z

    iget-object v1, p0, mRouterObj:Ljava/lang/Object;

    iget-object p0, p0, mCallbackObj:Ljava/lang/Object;
...
.method protected updateSystemRouteDescriptor(Landroidx/mediarouter/media/SystemMediaRouteProvider$JellybeanImpl$SystemRouteRecord;)V
    ...
    invoke-virtual {p0, v2}, getRouteName(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, v0}, onBuildSystemRouteDescriptor(Landroidx/mediarouter/media/SystemMediaRouteProvider$JellybeanImpl$SystemRouteRecord;Landroidx/mediarouter/media/MediaRouteDescriptor$Builder;)V
