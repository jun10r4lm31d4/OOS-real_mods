...
.method static constructor <clinit>()V
    ...
    sput v0, COLOR_DARK_ON_LIGHT_BACKGROUND_RES_ID:I
...
.method static createThemedButtonContext(Landroid/content/Context;)Landroid/content/Context;
    ...
    invoke-static {p0}, getRouterThemeId(Landroid/content/Context;)I
    ...
    invoke-static {v0, p0}, getThemeResource(Landroid/content/Context;I)I
...
.method static createThemedDialogContext(Landroid/content/Context;IZ)Landroid/content/Context;
    ...
    :goto_0
    invoke-static {p0, p1}, getThemeResource(Landroid/content/Context;I)I
    ...
    invoke-static {p2, p0}, getThemeResource(Landroid/content/Context;I)I
    ...
    invoke-static {p2}, getRouterThemeId(Landroid/content/Context;)I
...
.method static createThemedDialogStyle(Landroid/content/Context;)I
    ...
    invoke-static {p0, v0}, getThemeResource(Landroid/content/Context;I)I
...
.method static getButtonTextColor(Landroid/content/Context;)I
    ...
    invoke-static {p0, v1, v0}, getThemeColor(Landroid/content/Context;II)I

    move-result v0

    const v2, 0x1010031

    invoke-static {p0, v1, v2}, getThemeColor(Landroid/content/Context;II)I
...
.method static getCheckBoxDrawableIcon(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, v0}, getIconByDrawableId(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method static getControllerColor(Landroid/content/Context;I)I
    ...
    invoke-static {p0, p1, v0}, getThemeColor(Landroid/content/Context;II)I
...
.method static getDefaultDrawableIcon(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, v0}, getIconByAttrId(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method private static getIconByAttrId(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0}, isLightTheme(Landroid/content/Context;)Z

    move-result v1

    if-eqz v1, :cond_0

    sget v1, COLOR_DARK_ON_LIGHT_BACKGROUND_RES_ID:I
...
.method private static getIconByDrawableId(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    sget v0, COLOR_DARK_ON_LIGHT_BACKGROUND_RES_ID:I
...
.method private static getRouterThemeId(Landroid/content/Context;)I
    ...
    invoke-static {p0, v2}, getControllerColor(Landroid/content/Context;I)I
...
.method static setMediaControlsBackgroundColor(Landroid/content/Context;Landroid/view/View;Landroid/view/View;Z)V
    ...
    invoke-static {p0, v1}, getControllerColor(Landroid/content/Context;I)I
...
.method static setVolumeSliderColor(Landroid/content/Context;Landroidx/mediarouter/app/MediaRouteVolumeSlider;Landroid/view/View;)V
    ...
    invoke-static {p0, v0}, getControllerColor(Landroid/content/Context;I)I
