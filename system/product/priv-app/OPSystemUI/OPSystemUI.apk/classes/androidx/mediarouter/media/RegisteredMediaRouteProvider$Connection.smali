...
.method public constructor <init>(Landroidx/mediarouter/media/RegisteredMediaRouteProvider;Landroid/os/Messenger;)V
    ...
    iput p1, p0, mNextRequestId:I

    iput p1, p0, mNextControllerId:I

    new-instance p1, Landroid/util/SparseArray;

    invoke-direct {p1}, Landroid/util/SparseArray;-><init>()V

    iput-object p1, p0, mPendingCallbacks:Landroid/util/SparseArray;

    iput-object p2, p0, mServiceMessenger:Landroid/os/Messenger;
    ...
    iput-object p1, p0, mReceiveHandler:Landroidx/mediarouter/media/RegisteredMediaRouteProvider$ReceiveHandler;

    new-instance p1, Landroid/os/Messenger;

    iget-object p2, p0, mReceiveHandler:Landroidx/mediarouter/media/RegisteredMediaRouteProvider$ReceiveHandler;

    invoke-direct {p1, p2}, Landroid/os/Messenger;-><init>(Landroid/os/Handler;)V

    iput-object p1, p0, mReceiveMessenger:Landroid/os/Messenger;
...
.method private sendRequest(IIILjava/lang/Object;Landroid/os/Bundle;)Z
    ...
    iget-object p2, p0, mReceiveMessenger:Landroid/os/Messenger;

    iput-object p2, v0, Landroid/os/Message;->replyTo:Landroid/os/Messenger;

    :try_start_0
    iget-object p0, p0, mServiceMessenger:Landroid/os/Messenger;
...
.method public addMemberRoute(ILjava/lang/String;)V
    ...
    invoke-direct/range {v0 .. v5}, sendRequest(IIILjava/lang/Object;Landroid/os/Bundle;)Z
...
.method public createDynamicGroupRouteController(Ljava/lang/String;Landroidx/mediarouter/media/MediaRouter$ControlRequestCallback;)I
    ...
    iget v6, p0, mNextControllerId:I

    add-int/lit8 v0, v6, 0x1

    iput v0, p0, mNextControllerId:I

    iget v7, p0, mNextRequestId:I
    ...
    iget-object p0, p0, mPendingCallbacks:Landroid/util/SparseArray;
...
.method public dispose()V
    ...
    iget-object v0, p0, mReceiveHandler:Landroidx/mediarouter/media/RegisteredMediaRouteProvider$ReceiveHandler;

    invoke-virtual {v0}, Landroidx/mediarouter/media/RegisteredMediaRouteProvider$ReceiveHandler;->dispose()V

    iget-object v0, p0, mServiceMessenger:Landroid/os/Messenger;
...
.method failPendingCallbacks()V
    ...
    iget-object v0, p0, mPendingCallbacks:Landroid/util/SparseArray;
    ...
    iget-object v2, p0, mPendingCallbacks:Landroid/util/SparseArray;
...
.method public onDynamicRouteDescriptorsChanged(ILandroid/os/Bundle;)Z
    ...
    :cond_0
    iget-object p2, p0, this$0:Landroidx/mediarouter/media/RegisteredMediaRouteProvider;
...
.method public onGenericFailure(I)Z
    ...
    iget v0, p0, mPendingRegisterRequestId:I

    if-ne p1, v0, :cond_0

    const/4 v0, 0x0

    iput v0, p0, mPendingRegisterRequestId:I
...
.method public onRegistered(IILandroid/os/Bundle;)Z
    ...
    iput v1, p0, mPendingRegisterRequestId:I

    iput p2, p0, mServiceVersion:I
...
.method public register()Z
    ...
    iget v0, p0, mNextRequestId:I

    add-int/lit8 v1, v0, 0x1

    iput v1, p0, mNextRequestId:I

    iput v0, p0, mPendingRegisterRequestId:I

    iget v4, p0, mPendingRegisterRequestId:I
    ...
    invoke-direct/range {v2 .. v7}, sendRequest(IIILjava/lang/Object;Landroid/os/Bundle;)Z
