...
.method constructor <init>(Landroid/content/Context;Landroidx/mediarouter/media/MediaRouteProvider$ProviderMetadata;)V
    ...
    iput-object v0, p0, mHandler:Landroidx/mediarouter/media/MediaRouteProvider$ProviderHandler;
    ...
    iput-object p2, p0, mMetadata:Landroidx/mediarouter/media/MediaRouteProvider$ProviderMetadata;
...
.method deliverDescriptorChanged()V
    ...
    iput-boolean v0, p0, mPendingDescriptorChange:Z

    iget-object v0, p0, mCallback:Landroidx/mediarouter/media/MediaRouteProvider$Callback;

    if-eqz v0, :cond_0

    iget-object v1, p0, mDescriptor:Landroidx/mediarouter/media/MediaRouteProviderDescriptor;
...
.method deliverDiscoveryRequestChanged()V
    ...
    iput-boolean v0, p0, mPendingDiscoveryRequestChange:Z

    iget-object v0, p0, mDiscoveryRequest:Landroidx/mediarouter/media/MediaRouteDiscoveryRequest;

    invoke-virtual {p0, v0}, onDiscoveryRequestChanged(Landroidx/mediarouter/media/MediaRouteDiscoveryRequest;)V
...
.method public final getDescriptor()Landroidx/mediarouter/media/MediaRouteProviderDescriptor;
    ...
    iget-object p0, p0, mDescriptor:Landroidx/mediarouter/media/MediaRouteProviderDescriptor;
...
.method public final getHandler()Landroid/os/Handler;
    ...
    iget-object p0, p0, mHandler:Landroidx/mediarouter/media/MediaRouteProvider$ProviderHandler;
...
.method public final getMetadata()Landroidx/mediarouter/media/MediaRouteProvider$ProviderMetadata;
    ...
    iget-object p0, p0, mMetadata:Landroidx/mediarouter/media/MediaRouteProvider$ProviderMetadata;
...
.method public onCreateRouteController(Ljava/lang/String;Ljava/lang/String;)Landroidx/mediarouter/media/MediaRouteProvider$RouteController;
    ...
    invoke-virtual {p0, p1}, onCreateRouteController(Ljava/lang/String;)Landroidx/mediarouter/media/MediaRouteProvider$RouteController;
...
.method public final setCallback(Landroidx/mediarouter/media/MediaRouteProvider$Callback;)V
    ...
    iput-object p1, p0, mCallback:Landroidx/mediarouter/media/MediaRouteProvider$Callback;
...
.method public final setDescriptor(Landroidx/mediarouter/media/MediaRouteProviderDescriptor;)V
    ...
    iget-object v0, p0, mDescriptor:Landroidx/mediarouter/media/MediaRouteProviderDescriptor;

    if-eq v0, p1, :cond_0

    iput-object p1, p0, mDescriptor:Landroidx/mediarouter/media/MediaRouteProviderDescriptor;

    iget-boolean p1, p0, mPendingDescriptorChange:Z

    if-nez p1, :cond_0

    const/4 p1, 0x1

    iput-boolean p1, p0, mPendingDescriptorChange:Z
...
.method public final setDiscoveryRequest(Landroidx/mediarouter/media/MediaRouteDiscoveryRequest;)V
    ...
    :cond_0
    iput-object p1, p0, mDiscoveryRequest:Landroidx/mediarouter/media/MediaRouteDiscoveryRequest;

    iget-boolean p1, p0, mPendingDiscoveryRequestChange:Z

    if-nez p1, :cond_1

    const/4 p1, 0x1

    iput-boolean p1, p0, mPendingDiscoveryRequestChange:Z
