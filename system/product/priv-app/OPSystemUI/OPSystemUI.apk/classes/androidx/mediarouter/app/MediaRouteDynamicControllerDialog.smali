...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    iput-object p1, p0, mMemberRoutes:Ljava/util/List;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, mGroupableRoutes:Ljava/util/List;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, mTransferableRoutes:Ljava/util/List;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, mUngroupableRoutes:Ljava/util/List;
    ...
    iput-object p1, p0, mCallback:Landroidx/mediarouter/app/MediaRouteDynamicControllerDialog$MediaRouterCallback;

    iget-object p1, p0, mRouter:Landroidx/mediarouter/media/MediaRouter;
    ...
    iput-object p1, p0, mControllerCallback:Landroidx/mediarouter/app/MediaRouteDynamicControllerDialog$MediaControllerCallback;
    ...
    invoke-direct {p0, p1}, setMediaSession(Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
...
.method private setMediaSession(Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    ...
    iget-object v2, p0, mControllerCallback:Landroidx/mediarouter/app/MediaRouteDynamicControllerDialog$MediaControllerCallback;
    ...
    iget-object v0, p0, mControllerCallback:Landroidx/mediarouter/app/MediaRouteDynamicControllerDialog$MediaControllerCallback;
    ...
    :goto_2
    iput-object v1, p0, mDescription:Landroid/support/v4/media/MediaDescriptionCompat;

    invoke-virtual {p0}, reloadIconIfNeeded()V

    invoke-virtual {p0}, updateMetadataViews()V
...
.method private shouldDeferUpdateViews()Z
    ...
    iget-object v0, p0, mRouteForVolumeUpdatingByUser:Landroidx/mediarouter/media/MediaRouter$RouteInfo;

    const/4 v1, 0x1

    if-nez v0, :cond_1

    iget-boolean v0, p0, mIsSelectingRoute:Z

    if-nez v0, :cond_1

    iget-boolean v0, p0, mIsAnimatingVolumeSliderLayout:Z
...
.method public onAttachedToWindow()V
    ...
    iget-object v3, p0, mCallback:Landroidx/mediarouter/app/MediaRouteDynamicControllerDialog$MediaRouterCallback;
    ...
    invoke-virtual {p0}, updateRoutes()V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object p1, p0, mStopCastingButton:Landroid/widget/Button;

    iget-object p1, p0, mStopCastingButton:Landroid/widget/Button;
    ...
    iput-object p1, p0, mAdapter:Landroidx/mediarouter/app/MediaRouteDynamicControllerDialog$RecyclerAdapter;
    ...
    iget-object v1, p0, mAdapter:Landroidx/mediarouter/app/MediaRouteDynamicControllerDialog$RecyclerAdapter;
    ...
    iput-object p1, p0, mVolumeChangeListener:Landroidx/mediarouter/app/MediaRouteDynamicControllerDialog$VolumeChangeListener;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, mVolumeSliderHolderMap:Ljava/util/Map;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, mUnmutedVolumeMap:Ljava/util/Map;
    ...
    iput-object p1, p0, mMetadataBackground:Landroid/widget/ImageView;
    ...
    iput-object p1, p0, mMetadataBlackScrim:Landroid/view/View;
    ...
    iput-object p1, p0, mArtView:Landroid/widget/ImageView;
    ...
    iput-object p1, p0, mTitleView:Landroid/widget/TextView;
    ...
    iput-object p1, p0, mSubtitleView:Landroid/widget/TextView;

    iget-object p1, p0, mSubtitleView:Landroid/widget/TextView;
    ...
    iput-object p1, p0, mTitlePlaceholder:Ljava/lang/String;
...
.method public onDetachedFromWindow()V
    ...
    iget-object v1, p0, mCallback:Landroidx/mediarouter/app/MediaRouteDynamicControllerDialog$MediaRouterCallback;
    ...
    invoke-direct {p0, v1}, setMediaSession(Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
...
.method public onFilterRoutes(Ljava/util/List;)V
    ...
    invoke-virtual {p0, v1}, onFilterRoute(Landroidx/mediarouter/media/MediaRouter$RouteInfo;)Z
...
.method reloadIconIfNeeded()V
    ...
    :goto_1
    iget-object v2, p0, mFetchArtTask:Landroidx/mediarouter/app/MediaRouteDynamicControllerDialog$FetchArtTask;
    ...
    :goto_2
    iget-object v3, p0, mFetchArtTask:Landroidx/mediarouter/app/MediaRouteDynamicControllerDialog$FetchArtTask;

    if-nez v3, :cond_3

    iget-object v3, p0, mArtIconUri:Landroid/net/Uri;
    ...
    :cond_5
    iget-object v0, p0, mFetchArtTask:Landroidx/mediarouter/app/MediaRouteDynamicControllerDialog$FetchArtTask;
    ...
    iput-object v0, p0, mFetchArtTask:Landroidx/mediarouter/app/MediaRouteDynamicControllerDialog$FetchArtTask;

    iget-object p0, p0, mFetchArtTask:Landroidx/mediarouter/app/MediaRouteDynamicControllerDialog$FetchArtTask;
...
.method updateLayout()V
    ...
    invoke-virtual {p0}, updateRoutesView()V
...
.method updateMetadataViews()V
    ...
    invoke-direct {p0}, shouldDeferUpdateViews()Z
    ...
    iput-boolean v1, p0, mUpdateMetadataViewsDeferred:Z
    ...
    iput-boolean v0, p0, mUpdateMetadataViewsDeferred:Z
    ...
    :cond_2
    iget-boolean v2, p0, mArtIconIsLoaded:Z
    ...
    iget-object v2, p0, mArtIconLoadedBitmap:Landroid/graphics/Bitmap;

    invoke-static {v2}, isBitmapRecycled(Landroid/graphics/Bitmap;)Z
    ...
    iget-object v2, p0, mArtView:Landroid/widget/ImageView;

    invoke-virtual {v2, v0}, Landroid/widget/ImageView;->setVisibility(I)V

    iget-object v2, p0, mArtView:Landroid/widget/ImageView;

    iget-object v5, p0, mArtIconLoadedBitmap:Landroid/graphics/Bitmap;

    invoke-virtual {v2, v5}, Landroid/widget/ImageView;->setImageBitmap(Landroid/graphics/Bitmap;)V

    iget-object v2, p0, mArtView:Landroid/widget/ImageView;

    iget v5, p0, mArtIconBackgroundColor:I

    invoke-virtual {v2, v5}, Landroid/widget/ImageView;->setBackgroundColor(I)V

    iget-object v2, p0, mMetadataBlackScrim:Landroid/view/View;
    ...
    invoke-static {v2, v5, v6}, blurBitmap(Landroid/graphics/Bitmap;FLandroid/content/Context;)Landroid/graphics/Bitmap;

    iget-object v5, p0, mMetadataBackground:Landroid/widget/ImageView;
    ...
    :cond_3
    iget-object v2, p0, mMetadataBackground:Landroid/widget/ImageView;
    ...
    iget-object v6, p0, mDescription:Landroid/support/v4/media/MediaDescriptionCompat;
    ...
    iget-object v5, p0, mTitleView:Landroid/widget/TextView;
    ...
    iget-object v5, p0, mTitlePlaceholder:Ljava/lang/String;
    ...
    iget-object p0, p0, mSubtitleView:Landroid/widget/TextView;
...
.method updateRoutes()V
    ...
    iget-object v0, p0, mMemberRoutes:Ljava/util/List;

    invoke-interface {v0}, Ljava/util/List;->clear()V

    iget-object v0, p0, mGroupableRoutes:Ljava/util/List;

    invoke-interface {v0}, Ljava/util/List;->clear()V

    iget-object v0, p0, mTransferableRoutes:Ljava/util/List;
    ...
    iget-object v3, p0, mGroupableRoutes:Ljava/util/List;
    ...
    iget-object v2, p0, mTransferableRoutes:Ljava/util/List;
    ...
    iget-object p0, p0, mAdapter:Landroidx/mediarouter/app/MediaRouteDynamicControllerDialog$RecyclerAdapter;
...
.method updateRoutesView()V
    ...
    iput-boolean v1, p0, mUpdateRoutesViewDeferred:Z
    ...
    iput-boolean v0, p0, mUpdateRoutesViewDeferred:Z
...
.method updateViewsIfNeeded()V
    ...
    iget-boolean v0, p0, mUpdateRoutesViewDeferred:Z
    ...
    :cond_0
    iget-boolean v0, p0, mUpdateMetadataViewsDeferred:Z
