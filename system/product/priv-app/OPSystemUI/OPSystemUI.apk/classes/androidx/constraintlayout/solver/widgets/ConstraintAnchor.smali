...
.method public constructor <init>(Landroidx/constraintlayout/solver/widgets/ConstraintWidget;Landroidx/constraintlayout/solver/widgets/ConstraintAnchor$Type;)V
    ...
    iput-object v0, p0, mResolutionAnchor:Landroidx/constraintlayout/solver/widgets/ResolutionAnchor;

    const/4 v0, 0x0

    iput v0, p0, mMargin:I

    const/4 v1, -0x1

    iput v1, p0, mGoneMargin:I
    ...
    iput-object v1, p0, mStrength:Landroidx/constraintlayout/solver/widgets/ConstraintAnchor$Strength;
    ...
    iput-object v1, p0, mConnectionType:Landroidx/constraintlayout/solver/widgets/ConstraintAnchor$ConnectionType;

    iput v0, p0, mConnectionCreator:I

    iput-object p1, p0, mOwner:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;

    iput-object p2, p0, mType:Landroidx/constraintlayout/solver/widgets/ConstraintAnchor$Type;
...
.method public connect(Landroidx/constraintlayout/solver/widgets/ConstraintAnchor;IILandroidx/constraintlayout/solver/widgets/ConstraintAnchor$Strength;IZ)Z
    ...
    iput-object p1, p0, mTarget:Landroidx/constraintlayout/solver/widgets/ConstraintAnchor;

    iput v1, p0, mMargin:I

    const/4 p1, -0x1

    iput p1, p0, mGoneMargin:I
    ...
    iput-object p1, p0, mStrength:Landroidx/constraintlayout/solver/widgets/ConstraintAnchor$Strength;

    const/4 p1, 0x2

    iput p1, p0, mConnectionCreator:I
    ...
    invoke-virtual {p0, p1}, isValidConnection(Landroidx/constraintlayout/solver/widgets/ConstraintAnchor;)Z
    ...
    :goto_0
    iput p3, p0, mGoneMargin:I

    iput-object p4, p0, mStrength:Landroidx/constraintlayout/solver/widgets/ConstraintAnchor$Strength;

    iput p5, p0, mConnectionCreator:I
...
.method public connect(Landroidx/constraintlayout/solver/widgets/ConstraintAnchor;ILandroidx/constraintlayout/solver/widgets/ConstraintAnchor$Strength;I)Z
    ...
    invoke-virtual/range {v0 .. v6}, connect(Landroidx/constraintlayout/solver/widgets/ConstraintAnchor;IILandroidx/constraintlayout/solver/widgets/ConstraintAnchor$Strength;IZ)Z
...
.method public getConnectionCreator()I
    ...
    iget p0, p0, mConnectionCreator:I
...
.method public getMargin()I
    ...
    iget-object v0, p0, mOwner:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;
    ...
    :cond_0
    iget v0, p0, mGoneMargin:I

    const/4 v2, -0x1

    if-le v0, v2, :cond_1

    iget-object v0, p0, mTarget:Landroidx/constraintlayout/solver/widgets/ConstraintAnchor;

    if-eqz v0, :cond_1

    iget-object v0, v0, mOwner:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;
    ...
    iget p0, p0, mGoneMargin:I

    return p0

    :cond_1
    iget p0, p0, mMargin:I
...
.method public getOwner()Landroidx/constraintlayout/solver/widgets/ConstraintWidget;
    ...
    iget-object p0, p0, mOwner:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;
...
.method public getResolutionNode()Landroidx/constraintlayout/solver/widgets/ResolutionAnchor;
    ...
    iget-object p0, p0, mResolutionAnchor:Landroidx/constraintlayout/solver/widgets/ResolutionAnchor;
...
.method public getSolverVariable()Landroidx/constraintlayout/solver/SolverVariable;
    ...
    iget-object p0, p0, mSolverVariable:Landroidx/constraintlayout/solver/SolverVariable;
...
.method public getStrength()Landroidx/constraintlayout/solver/widgets/ConstraintAnchor$Strength;
    ...
    iget-object p0, p0, mStrength:Landroidx/constraintlayout/solver/widgets/ConstraintAnchor$Strength;
...
.method public getTarget()Landroidx/constraintlayout/solver/widgets/ConstraintAnchor;
    ...
    iget-object p0, p0, mTarget:Landroidx/constraintlayout/solver/widgets/ConstraintAnchor;
...
.method public getType()Landroidx/constraintlayout/solver/widgets/ConstraintAnchor$Type;
    ...
    iget-object p0, p0, mType:Landroidx/constraintlayout/solver/widgets/ConstraintAnchor$Type;
...
.method public isValidConnection(Landroidx/constraintlayout/solver/widgets/ConstraintAnchor;)Z
    ...
    :cond_0
    invoke-virtual {p1}, getType()Landroidx/constraintlayout/solver/widgets/ConstraintAnchor$Type;

    move-result-object v1

    iget-object v2, p0, mType:Landroidx/constraintlayout/solver/widgets/ConstraintAnchor$Type;
    ...
    invoke-virtual {p1}, getOwner()Landroidx/constraintlayout/solver/widgets/ConstraintWidget;
    ...
    invoke-virtual {p0}, getOwner()Landroidx/constraintlayout/solver/widgets/ConstraintWidget;
...
.method public reset()V
    ...
    iput-object v0, p0, mTarget:Landroidx/constraintlayout/solver/widgets/ConstraintAnchor;
    ...
    iput-object v0, p0, mConnectionType:Landroidx/constraintlayout/solver/widgets/ConstraintAnchor$ConnectionType;
...
.method public resetSolverVariable(Landroidx/constraintlayout/solver/Cache;)V
    ...
    iget-object p1, p0, mSolverVariable:Landroidx/constraintlayout/solver/SolverVariable;
    ...
    iput-object p1, p0, mSolverVariable:Landroidx/constraintlayout/solver/SolverVariable;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, mOwner:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;
