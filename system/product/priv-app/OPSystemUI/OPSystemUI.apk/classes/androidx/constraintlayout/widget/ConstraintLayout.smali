...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, mChildrenByIds:Landroid/util/SparseArray;
    ...
    iput-object p1, p0, mConstraintHelpers:Ljava/util/ArrayList;
    ...
    iput-object p1, p0, mVariableDimensionsWidgets:Ljava/util/ArrayList;
    ...
    iput-object p1, p0, mLayoutWidget:Landroidx/constraintlayout/solver/widgets/ConstraintWidgetContainer;
    ...
    iput v0, p0, mOptimizationLevel:I

    const/4 v0, 0x0

    iput-object v0, p0, mConstraintSet:Landroidx/constraintlayout/widget/ConstraintSet;

    const/4 v1, -0x1

    iput v1, p0, mConstraintSetId:I

    new-instance v2, Ljava/util/HashMap;

    invoke-direct {v2}, Ljava/util/HashMap;-><init>()V

    iput-object v2, p0, mDesignIds:Ljava/util/HashMap;

    iput v1, p0, mLastMeasureWidth:I

    iput v1, p0, mLastMeasureHeight:I

    iput v1, p0, mLastMeasureWidthSize:I

    iput v1, p0, mLastMeasureHeightSize:I

    iput p1, p0, mLastMeasureWidthMode:I

    iput p1, p0, mLastMeasureHeightMode:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput v0, p0, mConstraintSetId:I

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, mDesignIds:Ljava/util/HashMap;

    iput v0, p0, mLastMeasureWidth:I

    iput v0, p0, mLastMeasureHeight:I

    iput v0, p0, mLastMeasureWidthSize:I

    iput v0, p0, mLastMeasureHeightSize:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput p3, p0, mMaxWidth:I

    iput p3, p0, mMaxHeight:I

    const/4 p3, 0x1

    iput-boolean p3, p0, mDirtyHierarchy:Z

    const/4 p3, 0x3

    iput p3, p0, mOptimizationLevel:I

    const/4 p3, 0x0

    iput-object p3, p0, mConstraintSet:Landroidx/constraintlayout/widget/ConstraintSet;

    const/4 p3, -0x1

    iput p3, p0, mConstraintSetId:I

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, mDesignIds:Ljava/util/HashMap;

    iput p3, p0, mLastMeasureWidth:I

    iput p3, p0, mLastMeasureHeight:I

    iput p3, p0, mLastMeasureWidthSize:I

    iput p3, p0, mLastMeasureHeightSize:I
...
.method private final getTargetWidget(I)Landroidx/constraintlayout/solver/widgets/ConstraintWidget;
    ...
    iget-object p0, p0, mLayoutWidget:Landroidx/constraintlayout/solver/widgets/ConstraintWidgetContainer;

    return-object p0

    :cond_0
    iget-object v0, p0, mChildrenByIds:Landroid/util/SparseArray;
...
.method private init(Landroid/util/AttributeSet;)V
    ...
    iget-object v0, p0, mLayoutWidget:Landroidx/constraintlayout/solver/widgets/ConstraintWidgetContainer;
    ...
    iget v5, p0, mOptimizationLevel:I

    invoke-virtual {p1, v4, v5}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v4

    iput v4, p0, mOptimizationLevel:I
    ...
    iput-object v5, p0, mConstraintSet:Landroidx/constraintlayout/widget/ConstraintSet;

    iget-object v5, p0, mConstraintSet:Landroidx/constraintlayout/widget/ConstraintSet;
    ...
    :cond_7
    iget-object p1, p0, mLayoutWidget:Landroidx/constraintlayout/solver/widgets/ConstraintWidgetContainer;

    iget p0, p0, mOptimizationLevel:I
...
.method private internalMeasureChildren(II)V
    ...
    iget-object v13, v0, mMetrics:Landroidx/constraintlayout/solver/Metrics;
...
.method private internalMeasureDimensions(II)V
    ...
    iget-object v11, v0, mMetrics:Landroidx/constraintlayout/solver/Metrics;
    ...
    iget-object v2, v0, mLayoutWidget:Landroidx/constraintlayout/solver/widgets/ConstraintWidgetContainer;
    ...
    iget-object v10, v0, mMetrics:Landroidx/constraintlayout/solver/Metrics;
...
.method private setChildrenConstraints()V
    ...
    invoke-virtual {v0, v3, v7, v8}, setDesignInformation(ILjava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-direct {v0, v6}, getTargetWidget(I)Landroidx/constraintlayout/solver/widgets/ConstraintWidget;
    ...
    invoke-virtual {v0, v6}, getViewWidget(Landroid/view/View;)Landroidx/constraintlayout/solver/widgets/ConstraintWidget;
    ...
    iput-object v6, v0, mConstraintSet:Landroidx/constraintlayout/widget/ConstraintSet;
    ...
    :cond_5
    iget-object v5, v0, mConstraintSet:Landroidx/constraintlayout/widget/ConstraintSet;
    ...
    :cond_6
    iget-object v5, v0, mLayoutWidget:Landroidx/constraintlayout/solver/widgets/ConstraintWidgetContainer;

    invoke-virtual {v5}, Landroidx/constraintlayout/solver/widgets/WidgetContainer;->removeAllChildren()V

    iget-object v5, v0, mConstraintHelpers:Ljava/util/ArrayList;
    ...
    iget-object v7, v0, mConstraintHelpers:Ljava/util/ArrayList;
    ...
    invoke-direct {v0, v8}, getTargetWidget(I)Landroidx/constraintlayout/solver/widgets/ConstraintWidget;
    ...
    iget-object v6, v0, mLayoutWidget:Landroidx/constraintlayout/solver/widgets/ConstraintWidgetContainer;
    ...
    :cond_e
    iget-object v6, v0, mVariableDimensionsWidgets:Ljava/util/ArrayList;
    ...
    invoke-direct {v0, v7}, getTargetWidget(I)Landroidx/constraintlayout/solver/widgets/ConstraintWidget;
    ...
    invoke-direct {v0, v11}, getTargetWidget(I)Landroidx/constraintlayout/solver/widgets/ConstraintWidget;
    ...
    invoke-direct {v0, v3}, getTargetWidget(I)Landroidx/constraintlayout/solver/widgets/ConstraintWidget;
    ...
    invoke-direct {v0, v15}, getTargetWidget(I)Landroidx/constraintlayout/solver/widgets/ConstraintWidget;
    ...
    iget-object v6, v0, mChildrenByIds:Landroid/util/SparseArray;
...
.method private setSelfDimensionBehaviour(II)V
    ...
    :goto_3
    iget-object v1, p0, mLayoutWidget:Landroidx/constraintlayout/solver/widgets/ConstraintWidgetContainer;
...
.method private updateHierarchy()V
    ...
    iget-object v0, p0, mVariableDimensionsWidgets:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    invoke-direct {p0}, setChildrenConstraints()V
...
.method private updatePostMeasures()V
    ...
    :cond_1
    iget-object v0, p0, mConstraintHelpers:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, mConstraintHelpers:Ljava/util/ArrayList;
...
.method protected bridge synthetic generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0}, generateDefaultLayoutParams()Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;
...
.method public bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, generateLayoutParams(Landroid/util/AttributeSet;)Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;
...
.method public getDesignInformation(ILjava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object p1, p0, mDesignIds:Ljava/util/HashMap;
    ...
    iget-object p0, p0, mDesignIds:Ljava/util/HashMap;
...
.method public getViewById(I)Landroid/view/View;
    ...
    iget-object p0, p0, mChildrenByIds:Landroid/util/SparseArray;
...
.method protected onLayout(ZIIII)V
    ...
    :cond_3
    iget-object p1, p0, mConstraintHelpers:Ljava/util/ArrayList;
    ...
    iget-object p2, p0, mConstraintHelpers:Ljava/util/ArrayList;
...
.method protected onMeasure(II)V
    ...
    iget v7, v0, mLastMeasureWidth:I

    const/4 v8, -0x1

    if-eq v7, v8, :cond_0

    iget v7, v0, mLastMeasureHeight:I
    ...
    iget v9, v0, mLastMeasureWidth:I

    if-ne v4, v9, :cond_1

    iget v9, v0, mLastMeasureHeight:I

    :cond_1
    iget v9, v0, mLastMeasureWidthMode:I
    ...
    iget v9, v0, mLastMeasureHeightMode:I
    ...
    iget v12, v0, mLastMeasureWidthSize:I

    if-ne v4, v12, :cond_3

    iget v12, v0, mLastMeasureHeightSize:I
    ...
    iget v13, v0, mLastMeasureWidth:I

    if-lt v4, v13, :cond_4

    iget v13, v0, mLastMeasureHeight:I
    ...
    :cond_5
    iput v3, v0, mLastMeasureWidthMode:I

    iput v5, v0, mLastMeasureHeightMode:I

    iput v4, v0, mLastMeasureWidthSize:I

    iput v6, v0, mLastMeasureHeightSize:I
    ...
    :cond_7
    invoke-direct/range {p0 .. p2}, setSelfDimensionBehaviour(II)V
    ...
    iget-boolean v9, v0, mDirtyHierarchy:Z

    if-eqz v9, :cond_8

    iput-boolean v10, v0, mDirtyHierarchy:Z

    invoke-direct/range {p0 .. p0}, updateHierarchy()V

    :cond_8
    iget v9, v0, mOptimizationLevel:I
    ...
    iget-object v13, v0, mLayoutWidget:Landroidx/constraintlayout/solver/widgets/ConstraintWidgetContainer;
    ...
    invoke-direct/range {p0 .. p2}, internalMeasureDimensions(II)V

    goto :goto_3

    :cond_a
    invoke-direct/range {p0 .. p2}, internalMeasureChildren(II)V

    :goto_3
    invoke-direct/range {p0 .. p0}, updatePostMeasures()V
    ...
    invoke-virtual {v0, v13}, solveLinearSystem(Ljava/lang/String;)V

    :cond_b
    iget-object v13, v0, mVariableDimensionsWidgets:Ljava/util/ArrayList;
    ...
    iget-object v15, v0, mLayoutWidget:Landroidx/constraintlayout/solver/widgets/ConstraintWidgetContainer;
    ...
    iget-object v7, v0, mVariableDimensionsWidgets:Ljava/util/ArrayList;
    ...
    iget-object v1, v0, mMetrics:Landroidx/constraintlayout/solver/Metrics;
    ...
    iget-object v1, v0, mLayoutWidget:Landroidx/constraintlayout/solver/widgets/ConstraintWidgetContainer;
    ...
    invoke-virtual {v0, v1}, solveLinearSystem(Ljava/lang/String;)V
    ...
    iget-object v6, v0, mMetrics:Landroidx/constraintlayout/solver/Metrics;
    ...
    iget-object v3, v0, mLayoutWidget:Landroidx/constraintlayout/solver/widgets/ConstraintWidgetContainer;
    ...
    iget v3, v0, mMaxWidth:I

    invoke-static {v3, v1}, Ljava/lang/Math;->min(II)I

    move-result v1

    iget v3, v0, mMaxHeight:I
    ...
    iput v1, v0, mLastMeasureWidth:I

    iput v2, v0, mLastMeasureHeight:I
    ...
    iput v3, v0, mLastMeasureHeight:I
...
.method public onViewAdded(Landroid/view/View;)V
    ...
    :cond_0
    invoke-virtual {p0, p1}, getViewWidget(Landroid/view/View;)Landroidx/constraintlayout/solver/widgets/ConstraintWidget;
    ...
    iget-object v1, p0, mConstraintHelpers:Ljava/util/ArrayList;
    ...
    iput-boolean v2, p0, mDirtyHierarchy:Z
...
.method public onViewRemoved(Landroid/view/View;)V
    ...
    iget-object p1, p0, mVariableDimensionsWidgets:Ljava/util/ArrayList;

    invoke-virtual {p1, v0}, Ljava/util/ArrayList;->remove(Ljava/lang/Object;)Z

    const/4 p1, 0x1

    iput-boolean p1, p0, mDirtyHierarchy:Z
...
.method public requestLayout()V
    ...
    iput v0, p0, mLastMeasureWidthMode:I

    iput v0, p0, mLastMeasureHeightMode:I
...
.method public setDesignInformation(ILjava/lang/Object;Ljava/lang/Object;)V
    ...
    iput-object p1, p0, mDesignIds:Ljava/util/HashMap;
...
.method public setId(I)V
    ...
    iget-object p1, p0, mChildrenByIds:Landroid/util/SparseArray;
...
.method protected solveLinearSystem(Ljava/lang/String;)V
    ...
    iget-object p0, p0, mMetrics:Landroidx/constraintlayout/solver/Metrics;
