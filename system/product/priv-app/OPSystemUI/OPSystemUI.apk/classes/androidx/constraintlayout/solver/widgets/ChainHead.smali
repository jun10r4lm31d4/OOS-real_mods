...
.method public constructor <init>(Landroidx/constraintlayout/solver/widgets/ConstraintWidget;IZ)V
    ...
    iput v0, p0, mTotalWeight:F

    const/4 v0, 0x0

    iput-boolean v0, p0, mIsRtl:Z

    iput-object p1, p0, mFirst:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;

    iput p2, p0, mOrientation:I

    iput-boolean p3, p0, mIsRtl:Z
...
.method private defineChainProperties()V
    ...
    iget-object v2, p0, mFirst:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;
    ...
    iget v6, p0, mWidgetsCount:I

    add-int/2addr v6, v5

    iput v6, p0, mWidgetsCount:I
    ...
    iget-object v6, p0, mFirstVisibleWidget:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;

    if-nez v6, :cond_0

    iput-object v4, p0, mFirstVisibleWidget:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;

    :cond_0
    iget-object v6, p0, mLastVisibleWidget:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;
    ...
    :cond_1
    iput-object v4, p0, mLastVisibleWidget:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;
    ...
    :cond_2
    iget v6, p0, mWidgetsMatchCount:I

    add-int/2addr v6, v5

    iput v6, p0, mWidgetsMatchCount:I
    ...
    iget v11, p0, mTotalWeight:F

    aget v6, v6, v7

    add-float/2addr v11, v6

    iput v11, p0, mTotalWeight:F

    :cond_3
    iget v6, p0, mOrientation:I

    invoke-static {v4, v6}, isMatchConstraintEqualityCandidate(Landroidx/constraintlayout/solver/widgets/ConstraintWidget;I)Z
    ...
    iput-boolean v5, p0, mHasUndefinedWeights:Z

    goto :goto_1

    :cond_4
    iput-boolean v5, p0, mHasDefinedWeights:Z

    :goto_1
    iget-object v6, p0, mWeightedMatchConstraintsWidgets:Ljava/util/ArrayList;
    ...
    iput-object v6, p0, mWeightedMatchConstraintsWidgets:Ljava/util/ArrayList;
    ...
    :cond_6
    iget-object v6, p0, mFirstMatchConstraintWidget:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;

    if-nez v6, :cond_7

    iput-object v4, p0, mFirstMatchConstraintWidget:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;

    :cond_7
    iget-object v6, p0, mLastMatchConstraintWidget:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;
    ...
    :cond_8
    iput-object v4, p0, mLastMatchConstraintWidget:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;
    ...
    :cond_d
    iput-object v4, p0, mLast:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;
    ...
    iget-object v0, p0, mLast:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;

    iput-object v0, p0, mHead:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;

    goto :goto_3

    :cond_e
    iget-object v0, p0, mFirst:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;

    iput-object v0, p0, mHead:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;

    :goto_3
    iget-boolean v0, p0, mHasDefinedWeights:Z

    if-eqz v0, :cond_f

    iget-boolean v0, p0, mHasUndefinedWeights:Z
    ...
    :cond_f
    iput-boolean v3, p0, mHasComplexMatchWeights:Z
...
.method public define()V
    ...
    iget-boolean v0, p0, mDefined:Z

    if-nez v0, :cond_0

    invoke-direct {p0}, defineChainProperties()V

    :cond_0
    const/4 v0, 0x1

    iput-boolean v0, p0, mDefined:Z
