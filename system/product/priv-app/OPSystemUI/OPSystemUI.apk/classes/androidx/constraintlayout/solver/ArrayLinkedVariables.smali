...
.method constructor <init>(Landroidx/constraintlayout/solver/ArrayRow;Landroidx/constraintlayout/solver/Cache;)V
    ...
    iput v0, p0, currentSize:I

    const/16 v1, 0x8

    iput v1, p0, ROW_SIZE:I

    const/4 v1, 0x0

    iput-object v1, p0, candidate:Landroidx/constraintlayout/solver/SolverVariable;

    iget v1, p0, ROW_SIZE:I

    new-array v2, v1, [I

    iput-object v2, p0, mArrayIndices:[I

    new-array v2, v1, [I

    iput-object v2, p0, mArrayNextIndices:[I

    new-array v1, v1, [F

    iput-object v1, p0, mArrayValues:[F
    ...
    iput-boolean v0, p0, mDidFillOnce:Z

    iput-object p1, p0, mRow:Landroidx/constraintlayout/solver/ArrayRow;

    iput-object p2, p0, mCache:Landroidx/constraintlayout/solver/Cache;
...
.method final add(Landroidx/constraintlayout/solver/SolverVariable;FZ)V
    ...
    iget-object p3, p0, mArrayValues:[F

    iget v0, p0, mHead:I

    aput p2, p3, v0

    iget-object p2, p0, mArrayIndices:[I

    iget p3, p1, Landroidx/constraintlayout/solver/SolverVariable;->id:I

    aput p3, p2, v0

    iget-object p2, p0, mArrayNextIndices:[I
    ...
    iget-object p2, p0, mRow:Landroidx/constraintlayout/solver/ArrayRow;
    ...
    iget p1, p0, currentSize:I

    add-int/2addr p1, v4

    iput p1, p0, currentSize:I

    iget-boolean p1, p0, mDidFillOnce:Z
    ...
    iput-boolean v4, p0, mDidFillOnce:Z
    ...
    iget v7, p0, currentSize:I

    if-ge v5, v7, :cond_9

    iget-object v7, p0, mArrayIndices:[I
    ...
    iget-object v2, p0, mArrayValues:[F
    ...
    :cond_4
    iget-boolean p2, p0, mDidFillOnce:Z
    ...
    :cond_8
    iget-object v7, p0, mArrayNextIndices:[I
    ...
    iget-boolean v1, p0, mDidFillOnce:Z

    if-eqz v1, :cond_b

    iget-object v0, p0, mArrayIndices:[I
    ...
    :goto_3
    iget-object v1, p0, mArrayIndices:[I
    ...
    iget v0, p0, ROW_SIZE:I

    mul-int/lit8 v0, v0, 0x2

    iput v0, p0, ROW_SIZE:I

    iput-boolean v2, p0, mDidFillOnce:Z

    add-int/lit8 v0, p3, -0x1

    iput v0, p0, mLast:I

    iget-object v0, p0, mArrayValues:[F
    ...
    iput-object v0, p0, mArrayValues:[F
    ...
    iput-object v0, p0, mArrayIndices:[I

    iget-object v0, p0, mArrayNextIndices:[I
    ...
    iput-object v0, p0, mArrayNextIndices:[I
...
.method chooseSubject(Landroidx/constraintlayout/solver/LinearSystem;)Landroidx/constraintlayout/solver/SolverVariable;
    ...
    iget v9, p0, currentSize:I

    if-ge v2, v9, :cond_8

    iget-object v9, p0, mArrayValues:[F

    aget v10, v9, v0

    const v11, 0x3a83126f    # 0.001f

    iget-object v12, p0, mCache:Landroidx/constraintlayout/solver/Cache;
    ...
    iget-object v13, p0, mArrayIndices:[I
    ...
    iget-object v9, p0, mRow:Landroidx/constraintlayout/solver/ArrayRow;
    ...
    invoke-direct {p0, v12, p1}, isNew(Landroidx/constraintlayout/solver/SolverVariable;Landroidx/constraintlayout/solver/LinearSystem;)Z
    ...
    :cond_7
    :goto_6
    iget-object v9, p0, mArrayNextIndices:[I
...
.method public final clear()V
    ...
    iget v4, p0, currentSize:I

    if-ge v2, v4, :cond_1

    iget-object v3, p0, mCache:Landroidx/constraintlayout/solver/Cache;
    ...
    iget-object v4, p0, mArrayIndices:[I
    ...
    iget-object v4, p0, mRow:Landroidx/constraintlayout/solver/ArrayRow;
    ...
    :cond_0
    iget-object v3, p0, mArrayNextIndices:[I
    ...
    iput-boolean v1, p0, mDidFillOnce:Z

    iput v1, p0, currentSize:I
...
.method final containsKey(Landroidx/constraintlayout/solver/SolverVariable;)Z
    ...
    :cond_1
    iget-object v4, p0, mArrayNextIndices:[I
...
.method divideByAmount(F)V
    ...
    iget-object v2, p0, mArrayNextIndices:[I
...
.method public final get(Landroidx/constraintlayout/solver/SolverVariable;)F
    ...
    iget-object v2, p0, mArrayIndices:[I
    ...
    iget-object p0, p0, mArrayValues:[F
...
.method getPivotCandidate([ZLandroidx/constraintlayout/solver/SolverVariable;)Landroidx/constraintlayout/solver/SolverVariable;
    ...
    iget v5, p0, currentSize:I

    if-ge v2, v5, :cond_3

    iget-object v5, p0, mArrayValues:[F
    ...
    iget-object v5, p0, mCache:Landroidx/constraintlayout/solver/Cache;
    ...
    iget-object v6, p0, mArrayIndices:[I
    ...
    :cond_1
    iget-object v6, p0, mArrayValues:[F
    ...
    :cond_2
    iget-object v5, p0, mArrayNextIndices:[I
...
.method final getVariable(I)Landroidx/constraintlayout/solver/SolverVariable;
    ...
    iget-object p0, p0, mArrayIndices:[I
...
.method public final put(Landroidx/constraintlayout/solver/SolverVariable;F)V
    ...
    invoke-virtual {p0, p1, v1}, remove(Landroidx/constraintlayout/solver/SolverVariable;Z)F
    ...
    :cond_4
    iget-object v6, p0, mArrayNextIndices:[I
    ...
    iget-boolean v6, p0, mDidFillOnce:Z
    ...
    iget v4, p0, ROW_SIZE:I

    mul-int/lit8 v4, v4, 0x2

    iput v4, p0, ROW_SIZE:I
    ...
    iput-object v2, p0, mArrayValues:[F
...
.method public final remove(Landroidx/constraintlayout/solver/SolverVariable;Z)F
    ...
    iget-object v0, p0, candidate:Landroidx/constraintlayout/solver/SolverVariable;

    if-ne v0, p1, :cond_0

    const/4 v0, 0x0

    iput-object v0, p0, candidate:Landroidx/constraintlayout/solver/SolverVariable;
    ...
    iget-object v5, p0, mArrayIndices:[I
    ...
    iget-object v1, p0, mArrayNextIndices:[I
    ...
    iget-object p1, p0, mArrayIndices:[I
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, mArrayValues:[F
...
.method final updateFromRow(Landroidx/constraintlayout/solver/ArrayRow;Landroidx/constraintlayout/solver/ArrayRow;Z)V
    ...
    invoke-virtual {p0, v5, p3}, remove(Landroidx/constraintlayout/solver/SolverVariable;Z)F
    ...
    iget v6, v2, currentSize:I

    if-ge v5, v6, :cond_0

    iget-object v6, p0, mCache:Landroidx/constraintlayout/solver/Cache;
    ...
    iget-object v7, v2, mArrayIndices:[I

    aget v7, v7, v4

    aget-object v6, v6, v7

    iget-object v7, v2, mArrayValues:[F

    aget v7, v7, v4

    mul-float/2addr v7, v0

    invoke-virtual {p0, v6, v7, p3}, add(Landroidx/constraintlayout/solver/SolverVariable;FZ)V

    iget-object v6, v2, mArrayNextIndices:[I
...
.method updateFromSystem(Landroidx/constraintlayout/solver/ArrayRow;[Landroidx/constraintlayout/solver/ArrayRow;)V
    ...
    iget-object v4, p0, mCache:Landroidx/constraintlayout/solver/Cache;
    ...
    invoke-virtual {p0, v4, v2}, remove(Landroidx/constraintlayout/solver/SolverVariable;Z)F
    ...
    iget v8, v5, currentSize:I

    if-ge v7, v8, :cond_0

    iget-object v8, p0, mCache:Landroidx/constraintlayout/solver/Cache;
    ...
    iget-object v9, v5, mArrayIndices:[I

    aget v9, v9, v6

    aget-object v8, v8, v9

    iget-object v9, v5, mArrayValues:[F

    aget v9, v9, v6

    mul-float/2addr v9, v0

    invoke-virtual {p0, v8, v9, v2}, add(Landroidx/constraintlayout/solver/SolverVariable;FZ)V

    iget-object v8, v5, mArrayNextIndices:[I
