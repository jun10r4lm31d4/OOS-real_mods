...
.method public constructor <init>()V
    ...
    iput-object v1, p0, mSystem:Landroidx/constraintlayout/solver/LinearSystem;

    iput v0, p0, mHorizontalChainsSize:I

    iput v0, p0, mVerticalChainsSize:I

    const/4 v1, 0x4

    new-array v2, v1, [Landroidx/constraintlayout/solver/widgets/ChainHead;

    iput-object v2, p0, mVerticalChainsArray:[Landroidx/constraintlayout/solver/widgets/ChainHead;

    new-array v1, v1, [Landroidx/constraintlayout/solver/widgets/ChainHead;

    iput-object v1, p0, mHorizontalChainsArray:[Landroidx/constraintlayout/solver/widgets/ChainHead;

    const/4 v1, 0x3

    iput v1, p0, mOptimizationLevel:I

    iput-boolean v0, p0, mWidthMeasuredTooSmall:Z

    iput-boolean v0, p0, mHeightMeasuredTooSmall:Z

    iput v0, p0, mDebugSolverPassCount:I
...
.method private addHorizontalChain(Landroidx/constraintlayout/solver/widgets/ConstraintWidget;)V
    ...
    iget v0, p0, mHorizontalChainsSize:I

    add-int/lit8 v0, v0, 0x1

    iget-object v1, p0, mHorizontalChainsArray:[Landroidx/constraintlayout/solver/widgets/ChainHead;
    ...
    iput-object v0, p0, mHorizontalChainsArray:[Landroidx/constraintlayout/solver/widgets/ChainHead;

    :cond_0
    iget-object v0, p0, mHorizontalChainsArray:[Landroidx/constraintlayout/solver/widgets/ChainHead;

    iget v1, p0, mHorizontalChainsSize:I

    new-instance v2, Landroidx/constraintlayout/solver/widgets/ChainHead;

    const/4 v3, 0x0

    invoke-virtual {p0}, isRtl()Z
    ...
    iget p1, p0, mHorizontalChainsSize:I

    add-int/lit8 p1, p1, 0x1

    iput p1, p0, mHorizontalChainsSize:I
...
.method private addVerticalChain(Landroidx/constraintlayout/solver/widgets/ConstraintWidget;)V
    ...
    iget v0, p0, mVerticalChainsSize:I

    const/4 v1, 0x1

    add-int/2addr v0, v1

    iget-object v2, p0, mVerticalChainsArray:[Landroidx/constraintlayout/solver/widgets/ChainHead;
    ...
    iput-object v0, p0, mVerticalChainsArray:[Landroidx/constraintlayout/solver/widgets/ChainHead;

    :cond_0
    iget-object v0, p0, mVerticalChainsArray:[Landroidx/constraintlayout/solver/widgets/ChainHead;

    iget v2, p0, mVerticalChainsSize:I
    ...
    iget p1, p0, mVerticalChainsSize:I

    add-int/2addr p1, v1

    iput p1, p0, mVerticalChainsSize:I
...
.method addChain(Landroidx/constraintlayout/solver/widgets/ConstraintWidget;I)V
    ...
    invoke-direct {p0, p1}, addHorizontalChain(Landroidx/constraintlayout/solver/widgets/ConstraintWidget;)V
    ...
    invoke-direct {p0, p1}, addVerticalChain(Landroidx/constraintlayout/solver/widgets/ConstraintWidget;)V
...
.method public isHeightMeasuredTooSmall()Z
    ...
    iget-boolean p0, p0, mHeightMeasuredTooSmall:Z
...
.method public isWidthMeasuredTooSmall()Z
    ...
    iget-boolean p0, p0, mWidthMeasuredTooSmall:Z
...
.method public layout()V
    ...
    iput-boolean v4, v1, mWidthMeasuredTooSmall:Z

    iput-boolean v4, v1, mHeightMeasuredTooSmall:Z
    ...
    iget-object v0, v1, mSnapshot:Landroidx/constraintlayout/solver/widgets/Snapshot;
    ...
    iput-object v0, v1, mSnapshot:Landroidx/constraintlayout/solver/widgets/Snapshot;
    ...
    iget-object v0, v1, mSystem:Landroidx/constraintlayout/solver/LinearSystem;
    ...
    :goto_0
    iget v0, v1, mOptimizationLevel:I
    ...
    invoke-virtual {v1, v7}, optimizeFor(I)Z

    move-result v0

    if-nez v0, :cond_2

    invoke-virtual/range {p0 .. p0}, optimizeReset()V

    :cond_2
    invoke-virtual/range {p0 .. p0}, optimize()V
    ...
    invoke-direct/range {p0 .. p0}, resetChains()V
    ...
    iget-object v7, v1, mSystem:Landroidx/constraintlayout/solver/LinearSystem;
    ...
    invoke-virtual {v1, v0}, addChildrenToSolver(Landroidx/constraintlayout/solver/LinearSystem;)Z
    ...
    invoke-virtual {v1, v7, v8}, updateChildrenFromSolver(Landroidx/constraintlayout/solver/LinearSystem;[Z)V
    ...
    iput-boolean v12, v1, mWidthMeasuredTooSmall:Z
    ...
    iput-boolean v12, v1, mHeightMeasuredTooSmall:Z
    ...
    iget-object v3, v1, mSnapshot:Landroidx/constraintlayout/solver/widgets/Snapshot;
    ...
    iget v3, v1, mPaddingLeft:I

    add-int/2addr v0, v3

    iget v3, v1, mPaddingRight:I
...
.method public optimize()V
    ...
    invoke-virtual {p0, v0}, optimizeFor(I)Z

    move-result v0

    if-nez v0, :cond_0

    iget v0, p0, mOptimizationLevel:I

    invoke-virtual {p0, v0}, analyze(I)V

    :cond_0
    invoke-virtual {p0}, solveGraph()V
...
.method public preOptimize()V
    ...
    invoke-virtual {p0}, optimizeReset()V
...
.method public reset()V
    ...
    iget-object v0, p0, mSystem:Landroidx/constraintlayout/solver/LinearSystem;
...
.method public setOptimizationLevel(I)V
    ...
    iput p1, p0, mOptimizationLevel:I
