...
.method public constructor <init>(Landroidx/constraintlayout/solver/SolverVariable$Type;Ljava/lang/String;)V
    ...
    iput-object v0, p0, strengthVector:[F

    const/16 v0, 0x8

    new-array v0, v0, [Landroidx/constraintlayout/solver/ArrayRow;

    iput-object v0, p0, mClientEquations:[Landroidx/constraintlayout/solver/ArrayRow;

    iput p2, p0, mClientEquationsCount:I

    iput p2, p0, usageInRowCount:I

    iput-object p1, p0, mType:Landroidx/constraintlayout/solver/SolverVariable$Type;
...
.method static increaseErrorId()V
    ...
    sget v0, uniqueErrorId:I

    add-int/lit8 v0, v0, 0x1

    sput v0, uniqueErrorId:I
...
.method public final addToRow(Landroidx/constraintlayout/solver/ArrayRow;)V
    ...
    :goto_0
    iget v1, p0, mClientEquationsCount:I

    if-ge v0, v1, :cond_1

    iget-object v1, p0, mClientEquations:[Landroidx/constraintlayout/solver/ArrayRow;
    ...
    :cond_1
    iget-object v0, p0, mClientEquations:[Landroidx/constraintlayout/solver/ArrayRow;
    ...
    iput v1, p0, mClientEquationsCount:I
...
.method public final removeFromRow(Landroidx/constraintlayout/solver/ArrayRow;)V
    ...
    iget v0, p0, mClientEquationsCount:I
    ...
    iget-object v3, p0, mClientEquations:[Landroidx/constraintlayout/solver/ArrayRow;
    ...
    iget-object p1, p0, mClientEquations:[Landroidx/constraintlayout/solver/ArrayRow;
    ...
    :cond_0
    iget p1, p0, mClientEquationsCount:I

    add-int/lit8 p1, p1, -0x1

    iput p1, p0, mClientEquationsCount:I
...
.method public reset()V
    ...
    iput-object v0, p0, mType:Landroidx/constraintlayout/solver/SolverVariable$Type;
    ...
    iput v1, p0, definitionId:I

    const/4 v1, 0x0

    iput v1, p0, computedValue:F

    iput v0, p0, mClientEquationsCount:I

    iput v0, p0, usageInRowCount:I
