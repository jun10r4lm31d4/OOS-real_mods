...
.method public constructor <init>()V
    ...
    iput-object v1, p0, mStackedMatrix:Landroid/graphics/Matrix;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, mChildren:Ljava/util/ArrayList;

    const/4 v1, 0x0

    iput v1, p0, mRotate:F
    ...
    iput v2, p0, mScaleX:F

    iput v2, p0, mScaleY:F

    iput v1, p0, mTranslateX:F

    iput v1, p0, mTranslateY:F

    new-instance v1, Landroid/graphics/Matrix;

    invoke-direct {v1}, Landroid/graphics/Matrix;-><init>()V

    iput-object v1, p0, mLocalMatrix:Landroid/graphics/Matrix;

    iput-object v0, p0, mGroupName:Ljava/lang/String;
...
.method public constructor <init>(Landroidx/vectordrawable/graphics/drawable/VectorDrawableCompat$VGroup;Landroidx/collection/ArrayMap;)V
    ...
    iget v0, p1, mRotate:F

    iput v0, p0, mRotate:F

    iget v0, p1, mPivotX:F

    iput v0, p0, mPivotX:F

    iget v0, p1, mPivotY:F

    iput v0, p0, mPivotY:F

    iget v0, p1, mScaleX:F

    iput v0, p0, mScaleX:F

    iget v0, p1, mScaleY:F

    iput v0, p0, mScaleY:F

    iget v0, p1, mTranslateX:F

    iput v0, p0, mTranslateX:F

    iget v0, p1, mTranslateY:F

    iput v0, p0, mTranslateY:F

    iget-object v0, p1, mThemeAttrs:[I

    iput-object v0, p0, mThemeAttrs:[I

    iget-object v0, p1, mGroupName:Ljava/lang/String;
    ...
    iget-object v0, p0, mGroupName:Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, p0, mLocalMatrix:Landroid/graphics/Matrix;

    iget-object v1, p1, mLocalMatrix:Landroid/graphics/Matrix;

    invoke-virtual {v0, v1}, Landroid/graphics/Matrix;->set(Landroid/graphics/Matrix;)V

    iget-object p1, p1, mChildren:Ljava/util/ArrayList;
    ...
    invoke-direct {v3, v1, p2}, <init>(Landroidx/vectordrawable/graphics/drawable/VectorDrawableCompat$VGroup;Landroidx/collection/ArrayMap;)V
...
.method private updateLocalMatrix()V
    ...
    iget v1, p0, mTranslateX:F

    iget v2, p0, mPivotX:F

    add-float/2addr v1, v2

    iget v2, p0, mTranslateY:F

    iget p0, p0, mPivotY:F
...
.method private updateStateFromTypedArray(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    iput-object p1, p0, mGroupName:Ljava/lang/String;

    :cond_0
    invoke-direct {p0}, updateLocalMatrix()V
...
.method public getGroupName()Ljava/lang/String;
    ...
    iget-object p0, p0, mGroupName:Ljava/lang/String;
...
.method public getLocalMatrix()Landroid/graphics/Matrix;
    ...
    iget-object p0, p0, mLocalMatrix:Landroid/graphics/Matrix;
