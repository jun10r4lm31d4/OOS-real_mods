...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mIsStateful:Ljava/lang/Boolean;

    new-instance v0, Landroidx/collection/ArrayMap;

    invoke-direct {v0}, Landroidx/collection/ArrayMap;-><init>()V

    iput-object v0, p0, mVGTargetsMap:Landroidx/collection/ArrayMap;
    ...
    iput-object v0, p0, mRootGroup:Landroidx/vectordrawable/graphics/drawable/VectorDrawableCompat$VGroup;
...
.method public constructor <init>(Landroidx/vectordrawable/graphics/drawable/VectorDrawableCompat$VPathRenderer;)V
    ...
    iget-object v1, p1, mRootGroup:Landroidx/vectordrawable/graphics/drawable/VectorDrawableCompat$VGroup;

    iget-object v2, p0, mVGTargetsMap:Landroidx/collection/ArrayMap;
    ...
    iget-object v1, p0, mVGTargetsMap:Landroidx/collection/ArrayMap;

    invoke-virtual {v1, v0, p0}, Landroidx/collection/SimpleArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_0
    iget-object p1, p1, mIsStateful:Ljava/lang/Boolean;

    iput-object p1, p0, mIsStateful:Ljava/lang/Boolean;
...
.method private drawGroupTree(Landroidx/vectordrawable/graphics/drawable/VectorDrawableCompat$VGroup;Landroid/graphics/Matrix;Landroid/graphics/Canvas;IILandroid/graphics/ColorFilter;)V
    ...
    invoke-direct/range {v2 .. v8}, drawGroupTree(Landroidx/vectordrawable/graphics/drawable/VectorDrawableCompat$VGroup;Landroid/graphics/Matrix;Landroid/graphics/Canvas;IILandroid/graphics/ColorFilter;)V
    ...
    invoke-direct/range {v2 .. v8}, drawPath(Landroidx/vectordrawable/graphics/drawable/VectorDrawableCompat$VGroup;Landroidx/vectordrawable/graphics/drawable/VectorDrawableCompat$VPath;Landroid/graphics/Canvas;IILandroid/graphics/ColorFilter;)V
...
.method private drawPath(Landroidx/vectordrawable/graphics/drawable/VectorDrawableCompat$VGroup;Landroidx/vectordrawable/graphics/drawable/VectorDrawableCompat$VPath;Landroid/graphics/Canvas;IILandroid/graphics/ColorFilter;)V
    ...
    iget v0, p0, mViewportWidth:F

    div-float/2addr p4, v0

    int-to-float p5, p5

    iget v0, p0, mViewportHeight:F
    ...
    iget-object v1, p0, mFinalPathMatrix:Landroid/graphics/Matrix;
    ...
    invoke-direct {p0, p1}, getMatrixScale(Landroid/graphics/Matrix;)F
    ...
    :cond_0
    iget-object p5, p0, mPath:Landroid/graphics/Path;
    ...
    iget-object v1, p0, mRenderPath:Landroid/graphics/Path;
    ...
    iget-object p1, p0, mRenderPath:Landroid/graphics/Path;
    ...
    iget-object p2, p0, mFinalPathMatrix:Landroid/graphics/Matrix;

    invoke-virtual {p1, p5, p2}, Landroid/graphics/Path;->addPath(Landroid/graphics/Path;Landroid/graphics/Matrix;)V

    iget-object p0, p0, mRenderPath:Landroid/graphics/Path;
    ...
    iget-object v2, p0, mPathMeasure:Landroid/graphics/PathMeasure;
    ...
    iput-object v2, p0, mPathMeasure:Landroid/graphics/PathMeasure;
    ...
    iget-object v4, p0, mPathMeasure:Landroid/graphics/PathMeasure;

    invoke-virtual {v4, v1, v2, p5, v3}, Landroid/graphics/PathMeasure;->getSegment(FFLandroid/graphics/Path;Z)Z

    iget-object v1, p0, mPathMeasure:Landroid/graphics/PathMeasure;
    ...
    :cond_6
    iget-object p4, p0, mRenderPath:Landroid/graphics/Path;
    ...
    iget-object v4, p0, mFillPaint:Landroid/graphics/Paint;
    ...
    iput-object v4, p0, mFillPaint:Landroid/graphics/Paint;
    ...
    iget-object v5, p0, mFinalPathMatrix:Landroid/graphics/Matrix;
    ...
    iget-object v4, p0, mStrokePaint:Landroid/graphics/Paint;
    ...
    iput-object v4, p0, mStrokePaint:Landroid/graphics/Paint;

    iget-object v3, p0, mStrokePaint:Landroid/graphics/Paint;
...
.method private getMatrixScale(Landroid/graphics/Matrix;)F
    ...
    invoke-static {p1, v2, v1, p0}, cross(FFFF)F
...
.method public draw(Landroid/graphics/Canvas;IILandroid/graphics/ColorFilter;)V
    ...
    iget-object v1, p0, mRootGroup:Landroidx/vectordrawable/graphics/drawable/VectorDrawableCompat$VGroup;
    ...
    invoke-direct/range {v0 .. v6}, drawGroupTree(Landroidx/vectordrawable/graphics/drawable/VectorDrawableCompat$VGroup;Landroid/graphics/Matrix;Landroid/graphics/Canvas;IILandroid/graphics/ColorFilter;)V
...
.method public isStateful()Z
    ...
    iget-object v0, p0, mIsStateful:Ljava/lang/Boolean;

    if-nez v0, :cond_0

    iget-object v0, p0, mRootGroup:Landroidx/vectordrawable/graphics/drawable/VectorDrawableCompat$VGroup;
    ...
    :cond_0
    iget-object p0, p0, mIsStateful:Ljava/lang/Boolean;
...
.method public onStateChanged([I)Z
    ...
    iget-object p0, p0, mRootGroup:Landroidx/vectordrawable/graphics/drawable/VectorDrawableCompat$VGroup;
...
.method public setAlpha(F)V
    ...
    invoke-virtual {p0, p1}, setRootAlpha(I)V
