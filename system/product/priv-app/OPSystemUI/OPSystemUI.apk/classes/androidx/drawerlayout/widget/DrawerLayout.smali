...
.method static constructor <clinit>()V
    ...
    :goto_1
    sput-boolean v1, SET_DRAWER_SHADOW_FROM_ELEVATION:Z
    ...
    :goto_2
    sput-boolean v0, sEdgeSizeUsingSystemGestureInsets:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, mChildAccessibilityDelegate:Landroidx/drawerlayout/widget/DrawerLayout$ChildAccessibilityDelegate;
    ...
    iput-object v4, p0, mLeftCallback:Landroidx/drawerlayout/widget/DrawerLayout$ViewDragCallback;
    ...
    iput-object v1, p0, mRightCallback:Landroidx/drawerlayout/widget/DrawerLayout$ViewDragCallback;

    iget-object v1, p0, mLeftCallback:Landroidx/drawerlayout/widget/DrawerLayout$ViewDragCallback;
    ...
    iput-object v1, p0, mLeftDragger:Landroidx/customview/widget/ViewDragHelper;

    iget-object v1, p0, mLeftDragger:Landroidx/customview/widget/ViewDragHelper;
    ...
    iget-object v5, p0, mLeftDragger:Landroidx/customview/widget/ViewDragHelper;
    ...
    iget-object v1, p0, mRightCallback:Landroidx/drawerlayout/widget/DrawerLayout$ViewDragCallback;

    invoke-static {p0, v4, v1}, Landroidx/customview/widget/ViewDragHelper;->create(Landroid/view/ViewGroup;FLandroidx/customview/widget/ViewDragHelper$Callback;)Landroidx/customview/widget/ViewDragHelper;

    move-result-object v1

    iput-object v1, p0, mRightDragger:Landroidx/customview/widget/ViewDragHelper;

    iget-object v1, p0, mRightDragger:Landroidx/customview/widget/ViewDragHelper;
    ...
    iget-object v3, p0, mRightDragger:Landroidx/customview/widget/ViewDragHelper;
    ...
    iput-object p1, p0, mNonDrawerViews:Ljava/util/ArrayList;
...
.method private getTransformedMotionEvent(Landroid/view/MotionEvent;Landroid/view/View;)Landroid/view/MotionEvent;
    ...
    iget-object v0, p0, mChildInvertedMatrix:Landroid/graphics/Matrix;
    ...
    iput-object v0, p0, mChildInvertedMatrix:Landroid/graphics/Matrix;
    ...
    iget-object p0, p0, mChildInvertedMatrix:Landroid/graphics/Matrix;
...
.method private isInBoundsOfChild(FFLandroid/view/View;)Z
    ...
    iget-object p0, p0, mChildHitRect:Landroid/graphics/Rect;
...
.method private resolveLeftShadow()Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v1, v0}, mirror(Landroid/graphics/drawable/Drawable;I)V

    iget-object p0, p0, mShadowStart:Landroid/graphics/drawable/Drawable;
    ...
    iget-object p0, p0, mShadowEnd:Landroid/graphics/drawable/Drawable;

    return-object p0

    :cond_1
    iget-object p0, p0, mShadowLeft:Landroid/graphics/drawable/Drawable;
...
.method private resolveRightShadow()Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    iget-object p0, p0, mShadowRight:Landroid/graphics/drawable/Drawable;
...
.method public addFocusables(Ljava/util/ArrayList;II)V
    ...
    invoke-virtual {p0, v4}, isDrawerView(Landroid/view/View;)Z

    move-result v5

    if-eqz v5, :cond_1

    invoke-virtual {p0, v4}, isDrawerOpen(Landroid/view/View;)Z
    ...
    :cond_1
    iget-object v5, p0, mNonDrawerViews:Ljava/util/ArrayList;
    ...
    iget-object v0, p0, mNonDrawerViews:Ljava/util/ArrayList;
    ...
    :cond_5
    iget-object p0, p0, mNonDrawerViews:Ljava/util/ArrayList;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    :goto_1
    sget-boolean p2, CAN_HIDE_DESCENDANTS:Z

    if-nez p2, :cond_2

    iget-object p0, p0, mChildAccessibilityDelegate:Landroidx/drawerlayout/widget/DrawerLayout$ChildAccessibilityDelegate;
...
.method cancelChildViewTouch()V
    ...
    iput-boolean v0, p0, mChildrenCanceledTouch:Z
...
.method public closeDrawer(Landroid/view/View;Z)V
    ...
    invoke-virtual {p0, p1, p2}, checkDrawerViewAbsoluteGravity(Landroid/view/View;I)Z

    move-result p2

    if-eqz p2, :cond_1

    iget-object p2, p0, mLeftDragger:Landroidx/customview/widget/ViewDragHelper;
    ...
    :cond_1
    iget-object p2, p0, mRightDragger:Landroidx/customview/widget/ViewDragHelper;
    ...
    invoke-virtual {p0, v2, p1}, updateDrawerState(ILandroid/view/View;)V
...
.method closeDrawers(Z)V
    ...
    invoke-virtual {p0, v4, v7}, checkDrawerViewAbsoluteGravity(Landroid/view/View;I)Z

    move-result v7

    if-eqz v7, :cond_1

    iget-object v7, p0, mLeftDragger:Landroidx/customview/widget/ViewDragHelper;
    ...
    :cond_1
    iget-object v6, p0, mRightDragger:Landroidx/customview/widget/ViewDragHelper;
    ...
    :cond_3
    iget-object p1, p0, mLeftCallback:Landroidx/drawerlayout/widget/DrawerLayout$ViewDragCallback;

    invoke-virtual {p1}, Landroidx/drawerlayout/widget/DrawerLayout$ViewDragCallback;->removeCallbacks()V

    iget-object p1, p0, mRightCallback:Landroidx/drawerlayout/widget/DrawerLayout$ViewDragCallback;
...
.method public computeScroll()V
    ...
    iget-object v0, p0, mLeftDragger:Landroidx/customview/widget/ViewDragHelper;
    ...
    iget-object v2, p0, mRightDragger:Landroidx/customview/widget/ViewDragHelper;
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    invoke-virtual {p0, v2}, isContentView(Landroid/view/View;)Z
    ...
    invoke-static {v12}, hasOpaqueBackground(Landroid/view/View;)Z

    move-result v13

    if-eqz v13, :cond_2

    invoke-virtual {p0, v12}, isDrawerView(Landroid/view/View;)Z
    ...
    :cond_0
    invoke-virtual {p0, v12, v7}, checkDrawerViewAbsoluteGravity(Landroid/view/View;I)Z
    ...
    iget-object v6, v0, mScrimPaint:Landroid/graphics/Paint;
    ...
    :cond_5
    iget-object v3, v0, mShadowLeftResolved:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v2, v7}, checkDrawerViewAbsoluteGravity(Landroid/view/View;I)Z
    ...
    iget-object v8, v0, mLeftDragger:Landroidx/customview/widget/ViewDragHelper;
    ...
    iget-object v6, v0, mShadowLeftResolved:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, v0, mShadowLeftResolved:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, v0, mShadowLeftResolved:Landroid/graphics/drawable/Drawable;
    ...
    :cond_6
    iget-object v3, v0, mShadowRightResolved:Landroid/graphics/drawable/Drawable;

    if-eqz v3, :cond_7

    const/4 v3, 0x5

    invoke-virtual {p0, v2, v3}, checkDrawerViewAbsoluteGravity(Landroid/view/View;I)Z
    ...
    iget-object v10, v0, mRightDragger:Landroidx/customview/widget/ViewDragHelper;
    ...
    iget-object v6, v0, mShadowRightResolved:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, v0, mShadowRightResolved:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, v0, mShadowRightResolved:Landroid/graphics/drawable/Drawable;
...
.method findDrawerWithGravity(I)Landroid/view/View;
    ...
    invoke-virtual {p0, v2}, getDrawerViewAbsoluteGravity(Landroid/view/View;)I
...
.method public getDrawerLockMode(I)I
    ...
    iget p0, p0, mLockModeRight:I

    goto :goto_0

    :cond_2
    iget p0, p0, mLockModeLeft:I
    ...
    iget p0, p0, mLockModeEnd:I

    goto :goto_2

    :cond_8
    iget p0, p0, mLockModeStart:I
...
.method public getDrawerLockMode(Landroid/view/View;)I
    ...
    invoke-virtual {p0, p1}, getDrawerLockMode(I)I
...
.method public getDrawerTitle(I)Ljava/lang/CharSequence;
    ...
    iget-object p0, p0, mTitleLeft:Ljava/lang/CharSequence;
    ...
    iget-object p0, p0, mTitleRight:Ljava/lang/CharSequence;
...
.method moveDrawerToOffset(Landroid/view/View;F)V
    ...
    invoke-virtual {p0, p1, v0}, checkDrawerViewAbsoluteGravity(Landroid/view/View;I)Z
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object p0, p0, mStatusBarBackground:Landroid/graphics/drawable/Drawable;
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    iget-object p1, p0, mLeftDragger:Landroidx/customview/widget/ViewDragHelper;
    ...
    :cond_1
    invoke-virtual {p0, v2}, closeDrawers(Z)V
    ...
    iput p1, p0, mInitialMotionY:F

    iget v4, p0, mScrimOpacity:F
    ...
    iget-object v4, p0, mLeftDragger:Landroidx/customview/widget/ViewDragHelper;
    ...
    invoke-virtual {p0, p1}, isContentView(Landroid/view/View;)Z
    ...
    iget-boolean p0, p0, mChildrenCanceledTouch:Z
...
.method public onKeyUp(ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {p0, p1}, getDrawerLockMode(Landroid/view/View;)I
...
.method protected onLayout(ZIIII)V
    ...
    invoke-virtual {v0, v6, v12}, setDrawerViewOffset(Landroid/view/View;F)V
    ...
    :cond_b
    sget-boolean v1, sEdgeSizeUsingSystemGestureInsets:Z
    ...
    iget-object v2, v0, mLeftDragger:Landroidx/customview/widget/ViewDragHelper;
    ...
    iget-object v2, v0, mRightDragger:Landroidx/customview/widget/ViewDragHelper;
...
.method protected onMeasure(II)V
    ...
    iget-object v2, v0, mLastInsets:Ljava/lang/Object;
    ...
    :cond_a
    :goto_4
    invoke-virtual {v0, v12}, isContentView(Landroid/view/View;)Z
    ...
    invoke-virtual {v0, v12}, isDrawerView(Landroid/view/View;)Z

    move-result v2

    if-eqz v2, :cond_12

    sget-boolean v2, SET_DRAWER_SHADOW_FROM_ELEVATION:Z
    ...
    iget v14, v0, mDrawerElevation:F
    ...
    :cond_c
    invoke-virtual {v0, v12}, getDrawerViewAbsoluteGravity(Landroid/view/View;)I
    ...
    invoke-static {v2}, gravityToString(I)Ljava/lang/String;
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {p0, v0}, openDrawer(Landroid/view/View;)V
    ...
    invoke-virtual {p0, v0, v1}, setDrawerLockMode(II)V
    ...
    invoke-virtual {p0, v0, v2}, setDrawerLockMode(II)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, mRightDragger:Landroidx/customview/widget/ViewDragHelper;
    ...
    iput-boolean v1, p0, mChildrenCanceledTouch:Z
    ...
    iget-object v3, p0, mLeftDragger:Landroidx/customview/widget/ViewDragHelper;
    ...
    invoke-virtual {p0, v3}, isContentView(Landroid/view/View;)Z

    move-result v3

    if-eqz v3, :cond_2

    iget v3, p0, mInitialMotionX:F

    sub-float/2addr v0, v3

    iget v3, p0, mInitialMotionY:F
    ...
    :cond_3
    invoke-virtual {p0, v1}, closeDrawers(Z)V
...
.method public openDrawer(Landroid/view/View;Z)V
    ...
    invoke-direct {p0, p1, p2}, updateChildrenImportantForAccessibility(Landroid/view/View;Z)V
    ...
    invoke-virtual {p0, v1, p1}, updateDrawerState(ILandroid/view/View;)V
...
.method public requestDisallowInterceptTouchEvent(Z)V
    ...
    invoke-virtual {p0, p1}, closeDrawers(Z)V
...
.method public setDrawerLockMode(II)V
    ...
    invoke-virtual {p0, p1}, openDrawer(Landroid/view/View;)V
    ...
    invoke-virtual {p0, p1}, closeDrawer(Landroid/view/View;)V
...
.method updateDrawerState(ILandroid/view/View;)V
    ...
    invoke-virtual {p0, p2}, dispatchOnDrawerClosed(Landroid/view/View;)V
    ...
    invoke-virtual {p0, p2}, dispatchOnDrawerOpened(Landroid/view/View;)V

    :cond_5
    :goto_2
    iget p1, p0, mDrawerState:I

    if-eq v2, p1, :cond_6

    iput v2, p0, mDrawerState:I

    iget-object p1, p0, mListeners:Ljava/util/List;
    ...
    iget-object p2, p0, mListeners:Ljava/util/List;
