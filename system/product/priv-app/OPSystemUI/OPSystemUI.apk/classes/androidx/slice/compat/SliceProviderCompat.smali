...
.method public constructor <init>(Landroidx/slice/SliceProvider;Landroidx/slice/compat/CompatPermissionManager;Landroid/content/Context;)V
    ...
    iput-object v0, p0, mAnr:Ljava/lang/Runnable;

    iput-object p1, p0, mProvider:Landroidx/slice/SliceProvider;
    ...
    iput-object p3, p0, mPinnedList:Landroidx/slice/compat/CompatPinnedList;

    iput-object p2, p0, mPermissionManager:Landroidx/slice/compat/CompatPermissionManager;
...
.method public static bindSlice(Landroid/content/Context;Landroid/content/Intent;Ljava/util/Set;)Landroidx/slice/Slice;
    ...
    invoke-static {p0, v1, p2}, bindSlice(Landroid/content/Context;Landroid/net/Uri;Ljava/util/Set;)Landroidx/slice/Slice;
    ...
    invoke-static {v0, v1}, acquireClient(Landroid/content/ContentResolver;Landroid/net/Uri;)Landroidx/slice/compat/SliceProviderCompat$ProviderHolder;
    ...
    invoke-static {v1, p2}, addSpecs(Landroid/os/Bundle;Ljava/util/Set;)V
    ...
    invoke-static {p0, p1}, parseSlice(Landroid/content/Context;Landroid/os/Bundle;)Landroidx/slice/Slice;
    ...
    invoke-static {p0, p1, p2}, bindSlice(Landroid/content/Context;Landroid/net/Uri;Ljava/util/Set;)Landroidx/slice/Slice;
...
.method public static bindSlice(Landroid/content/Context;Landroid/net/Uri;Ljava/util/Set;)Landroidx/slice/Slice;
    ...
    invoke-static {v0, p1}, acquireClient(Landroid/content/ContentResolver;Landroid/net/Uri;)Landroidx/slice/compat/SliceProviderCompat$ProviderHolder;
...
.method public static getPinnedSpecs(Landroid/content/Context;Landroid/net/Uri;)Ljava/util/Set;
    ...
    invoke-static {p0, p1}, acquireClient(Landroid/content/ContentResolver;Landroid/net/Uri;)Landroidx/slice/compat/SliceProviderCompat$ProviderHolder;
    ...
    invoke-static {p1}, getSpecs(Landroid/os/Bundle;)Ljava/util/Set;
...
.method public static grantSlicePermission(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri;)V
    ...
    :try_start_0
    invoke-static {p0, p3}, acquireClient(Landroid/content/ContentResolver;Landroid/net/Uri;)Landroidx/slice/compat/SliceProviderCompat$ProviderHolder;
...
.method private handleBindSlice(Landroid/net/Uri;Ljava/util/Set;Ljava/lang/String;)Landroidx/slice/Slice;
    ...
    :goto_0
    iget-object v0, p0, mPermissionManager:Landroidx/slice/compat/CompatPermissionManager;
    ...
    iget-object p0, p0, mProvider:Landroidx/slice/SliceProvider;
    ...
    :cond_1
    invoke-direct {p0, p1, p2}, onBindSliceStrict(Landroid/net/Uri;Ljava/util/Set;)Landroidx/slice/Slice;
...
.method private handleGetDescendants(Landroid/net/Uri;)Ljava/util/Collection;
    ...
    iput-object v0, p0, mCallback:Ljava/lang/String;
...
.method private handleSlicePinned(Landroid/net/Uri;)V
    ...
    iget-object v1, p0, mAnr:Ljava/lang/Runnable;
    ...
    :try_start_0
    iget-object v0, p0, mProvider:Landroidx/slice/SliceProvider;
    ...
    iget-object p0, p0, mAnr:Ljava/lang/Runnable;
...
.method private onBindSliceStrict(Landroid/net/Uri;Ljava/util/Set;)Landroidx/slice/Slice;
    ...
    iput-object v1, p0, mCallback:Ljava/lang/String;

    iget-object v1, p0, mHandler:Landroid/os/Handler;

    iget-object v2, p0, mAnr:Ljava/lang/Runnable;
    ...
    :try_start_1
    iget-object v1, p0, mProvider:Landroidx/slice/SliceProvider;
...
.method public static unpinSlice(Landroid/content/Context;Landroid/net/Uri;Ljava/util/Set;)V
    ...
    invoke-static {p0}, getPinnedSlices(Landroid/content/Context;)Ljava/util/List;
...
.method public call(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    invoke-static {p3}, getSpecs(Landroid/os/Bundle;)Ljava/util/Set;
    ...
    invoke-direct {p0, p1, p3, v0}, handleBindSlice(Landroid/net/Uri;Ljava/util/Set;Ljava/lang/String;)Landroidx/slice/Slice;
    ...
    invoke-direct {p0, p1, p3, v2}, handleBindSlice(Landroid/net/Uri;Ljava/util/Set;Ljava/lang/String;)Landroidx/slice/Slice;
    ...
    iget-object v0, p0, mPinnedList:Landroidx/slice/compat/CompatPinnedList;
    ...
    invoke-direct {p0, p1}, handleSlicePinned(Landroid/net/Uri;)V
    ...
    iget-object p3, p0, mPinnedList:Landroidx/slice/compat/CompatPinnedList;
    ...
    invoke-direct {p0, p1}, handleSliceUnpinned(Landroid/net/Uri;)V
    ...
    iget-object p0, p0, mPinnedList:Landroidx/slice/compat/CompatPinnedList;
    ...
    invoke-static {p2, p0}, addSpecs(Landroid/os/Bundle;Ljava/util/Set;)V
    ...
    invoke-direct {p0, p1}, handleGetDescendants(Landroid/net/Uri;)Ljava/util/Collection;
    ...
    iget-object p0, p0, mPermissionManager:Landroidx/slice/compat/CompatPermissionManager;
