...
.method public constructor <init>(Landroidx/slice/SliceItem;I)V
    ...
    iput-object v0, p0, mEndItems:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mToggleItems:Ljava/util/ArrayList;

    const/4 v0, 0x0

    iput v0, p0, mLineCount:I
    ...
    :cond_0
    invoke-direct {p0, p1, v0}, populate(Landroidx/slice/SliceItem;Z)Z
...
.method private determineStartAndPrimaryAction(Landroidx/slice/SliceItem;)V
    ...
    iput-object p1, p0, mPrimaryAction:Landroidx/slice/SliceItem;

    goto :goto_0

    :cond_3
    iget-object p1, p0, mStartItem:Landroidx/slice/SliceItem;
...
.method private static filterInvalidItems(Landroidx/slice/SliceItem;)Ljava/util/ArrayList;
    ...
    invoke-static {p0, v2}, isValidRowContent(Landroidx/slice/SliceItem;Landroidx/slice/SliceItem;)Z
...
.method private static isValidRow(Landroidx/slice/SliceItem;)Z
    ...
    invoke-static {p0, v4}, isValidRowContent(Landroidx/slice/SliceItem;Landroidx/slice/SliceItem;)Z
...
.method private populate(Landroidx/slice/SliceItem;Z)Z
    ...
    invoke-static {p1}, isValidRow(Landroidx/slice/SliceItem;)Z
    ...
    :cond_0
    invoke-direct {p0, p1}, determineStartAndPrimaryAction(Landroidx/slice/SliceItem;)V

    invoke-static {p1}, filterInvalidItems(Landroidx/slice/SliceItem;)Ljava/util/ArrayList;
    ...
    invoke-static {v1}, isValidRow(Landroidx/slice/SliceItem;)Z
    ...
    iput-object p1, p0, mRange:Landroidx/slice/SliceItem;
    ...
    iput-object p1, p0, mSelection:Landroidx/slice/SliceItem;
    ...
    :cond_5
    iget-object p1, p0, mPrimaryAction:Landroidx/slice/SliceItem;
    ...
    iget-object v6, p0, mTitleItem:Landroidx/slice/SliceItem;
    ...
    iput-object v5, p0, mTitleItem:Landroidx/slice/SliceItem;

    goto :goto_1

    :cond_8
    iget-object v6, p0, mSubtitleItem:Landroidx/slice/SliceItem;
    ...
    iput-object v5, p0, mSubtitleItem:Landroidx/slice/SliceItem;

    goto :goto_1

    :cond_9
    iget-object v6, p0, mSummaryItem:Landroidx/slice/SliceItem;
    ...
    iput-object v5, p0, mSummaryItem:Landroidx/slice/SliceItem;
    ...
    :cond_c
    iget-object p2, p0, mTitleItem:Landroidx/slice/SliceItem;

    invoke-static {p2}, hasText(Landroidx/slice/SliceItem;)Z

    move-result p2

    if-eqz p2, :cond_d

    iget p2, p0, mLineCount:I

    add-int/2addr p2, v4

    iput p2, p0, mLineCount:I

    :cond_d
    iget-object p2, p0, mSubtitleItem:Landroidx/slice/SliceItem;
    ...
    :cond_e
    iget-object p2, p0, mStartItem:Landroidx/slice/SliceItem;
    ...
    iget-object v3, p0, mEndItems:Ljava/util/ArrayList;
    ...
    :cond_11
    invoke-direct {p0, v5, v6}, processContent(Landroidx/slice/SliceItem;Z)V
...
.method private processContent(Landroidx/slice/SliceItem;Z)V
    ...
    iget-object v0, p0, mToggleItems:Ljava/util/ArrayList;
...
.method public getInputRangeThumb()Landroidx/slice/SliceItem;
    ...
    iget-object p0, p0, mRange:Landroidx/slice/SliceItem;
...
.method public getIsHeader()Z
    ...
    iget-boolean p0, p0, mIsHeader:Z
...
.method public getPrimaryAction()Landroidx/slice/SliceItem;
    ...
    iget-object p0, p0, mPrimaryAction:Landroidx/slice/SliceItem;
...
.method public getSelection()Landroidx/slice/SliceItem;
    ...
    iget-object p0, p0, mSelection:Landroidx/slice/SliceItem;
...
.method public getStartItem()Landroidx/slice/SliceItem;
    ...
    iget-boolean v0, p0, mIsHeader:Z

    if-eqz v0, :cond_0

    iget-boolean v0, p0, mShowTitleItems:Z
    ...
    :cond_0
    iget-object p0, p0, mStartItem:Landroidx/slice/SliceItem;
...
.method public getSummaryItem()Landroidx/slice/SliceItem;
    ...
    iget-object v0, p0, mSummaryItem:Landroidx/slice/SliceItem;
...
.method public getToggleItems()Ljava/util/ArrayList;
    ...
    iget-object p0, p0, mToggleItems:Ljava/util/ArrayList;
...
.method public hasActionDivider()Z
    ...
    iget-boolean p0, p0, mShowActionDivider:Z
...
.method public hasBottomDivider()Z
    ...
    iget-boolean p0, p0, mShowBottomDivider:Z
...
.method public hasTitleItems()Z
    ...
    iget-boolean p0, p0, mShowTitleItems:Z
...
.method public isValid()Z
    ...
    iget-object v0, p0, mPrimaryAction:Landroidx/slice/SliceItem;
    ...
    iget-object v0, p0, mRange:Landroidx/slice/SliceItem;

    if-nez v0, :cond_0

    iget-object v0, p0, mSelection:Landroidx/slice/SliceItem;

    if-nez v0, :cond_0

    invoke-virtual {p0}, isDefaultSeeMore()Z
...
.method public setIsHeader(Z)V
    ...
    iput-boolean p1, p0, mIsHeader:Z
...
.method public showActionDivider(Z)V
    ...
    iput-boolean p1, p0, mShowActionDivider:Z
...
.method public showBottomDivider(Z)V
    ...
    iput-boolean p1, p0, mShowBottomDivider:Z
