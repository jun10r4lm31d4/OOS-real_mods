...
.method public constructor <init>(Landroid/net/Uri;)V
    ...
    iput v0, p0, mLayoutDirection:I

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mEndItems:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mEndTypes:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mEndLoads:Ljava/util/List;
...
.method public addEndItem(Landroidx/core/graphics/drawable/IconCompat;I)Landroidx/slice/builders/ListBuilder$RowBuilder;
    ...
    invoke-virtual {p0, p1, p2, v0}, addEndItem(Landroidx/core/graphics/drawable/IconCompat;IZ)Landroidx/slice/builders/ListBuilder$RowBuilder;
...
.method public addEndItem(Landroidx/core/graphics/drawable/IconCompat;IZ)Landroidx/slice/builders/ListBuilder$RowBuilder;
    ...
    iget-boolean v0, p0, mHasEndActionOrToggle:Z

    if-nez v0, :cond_0

    iget-object v0, p0, mEndItems:Ljava/util/List;
    ...
    iget-object p1, p0, mEndTypes:Ljava/util/List;
    ...
    iget-object p1, p0, mEndLoads:Ljava/util/List;
    ...
    iput-boolean p2, p0, mHasEndImage:Z
...
.method public getEndItems()Ljava/util/List;
    ...
    iget-object p0, p0, mEndItems:Ljava/util/List;
...
.method public getEndLoads()Ljava/util/List;
    ...
    iget-object p0, p0, mEndLoads:Ljava/util/List;
...
.method public getEndTypes()Ljava/util/List;
    ...
    iget-object p0, p0, mEndTypes:Ljava/util/List;
...
.method public getSubtitle()Ljava/lang/CharSequence;
    ...
    iget-object p0, p0, mSubtitle:Ljava/lang/CharSequence;
...
.method public getTitleAction()Landroidx/slice/builders/SliceAction;
    ...
    iget-object p0, p0, mTitleAction:Landroidx/slice/builders/SliceAction;
...
.method public getTitleIcon()Landroidx/core/graphics/drawable/IconCompat;
    ...
    iget-object p0, p0, mTitleIcon:Landroidx/core/graphics/drawable/IconCompat;
...
.method public getUri()Landroid/net/Uri;
    ...
    iget-object p0, p0, mUri:Landroid/net/Uri;
...
.method public isSubtitleLoading()Z
    ...
    iget-boolean p0, p0, mSubtitleLoading:Z
...
.method public isTitleActionLoading()Z
    ...
    iget-boolean p0, p0, mTitleActionLoading:Z
...
.method public isTitleItemLoading()Z
    ...
    iget-boolean p0, p0, mTitleItemLoading:Z
...
.method public isTitleLoading()Z
    ...
    iget-boolean p0, p0, mTitleLoading:Z
...
.method public setTitle(Ljava/lang/CharSequence;)Landroidx/slice/builders/ListBuilder$RowBuilder;
    ...
    invoke-virtual {p0, p1, v0}, setTitle(Ljava/lang/CharSequence;Z)Landroidx/slice/builders/ListBuilder$RowBuilder;
...
.method public setTitle(Ljava/lang/CharSequence;Z)Landroidx/slice/builders/ListBuilder$RowBuilder;
    ...
    iput-boolean p2, p0, mTitleLoading:Z
