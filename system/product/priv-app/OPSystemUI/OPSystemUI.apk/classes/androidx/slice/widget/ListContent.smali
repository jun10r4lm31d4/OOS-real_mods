...
.method public constructor <init>(Landroid/content/Context;Landroidx/slice/Slice;)V
    ...
    iput-object p1, p0, mRowItems:Ljava/util/ArrayList;
    ...
    :cond_0
    invoke-direct {p0, p2}, populate(Landroidx/slice/Slice;)V
...
.method public constructor <init>(Landroidx/slice/Slice;)V
    ...
    iput-object v0, p0, mRowItems:Ljava/util/ArrayList;
    ...
    :cond_0
    invoke-direct {p0, p1}, populate(Landroidx/slice/Slice;)V
...
.method private static findHeaderItem(Landroidx/slice/Slice;)Landroidx/slice/SliceItem;
    ...
    invoke-static {p0}, isValidHeader(Landroidx/slice/SliceItem;)Z
...
.method private findPrimaryAction()Landroidx/slice/core/SliceAction;
    ...
    iget-object v0, p0, mHeaderContent:Landroidx/slice/widget/RowContent;
...
.method private populate(Landroidx/slice/Slice;)V
    ...
    iput-object v0, p0, mSliceActions:Ljava/util/List;

    invoke-static {p1}, findHeaderItem(Landroidx/slice/Slice;)Landroidx/slice/SliceItem;
    ...
    iput-object v2, p0, mHeaderContent:Landroidx/slice/widget/RowContent;

    iget-object v0, p0, mRowItems:Ljava/util/ArrayList;

    iget-object v2, p0, mHeaderContent:Landroidx/slice/widget/RowContent;

    invoke-virtual {v0, v2}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    :cond_1
    invoke-static {p1}, getSeeMoreItem(Landroidx/slice/Slice;)Landroidx/slice/SliceItem;
    ...
    iput-object v2, p0, mSeeMoreContent:Landroidx/slice/widget/RowContent;
    ...
    :cond_3
    iget-object v3, p0, mHeaderContent:Landroidx/slice/widget/RowContent;
    ...
    iput-object v3, p0, mHeaderContent:Landroidx/slice/widget/RowContent;

    iget-object v2, p0, mRowItems:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, mRowItems:Ljava/util/ArrayList;
    ...
    :cond_7
    iget-object p1, p0, mHeaderContent:Landroidx/slice/widget/RowContent;

    const/4 v0, 0x1

    if-nez p1, :cond_8

    iget-object p1, p0, mRowItems:Ljava/util/ArrayList;
    ...
    iput-object p1, p0, mHeaderContent:Landroidx/slice/widget/RowContent;
    ...
    :cond_9
    invoke-direct {p0}, findPrimaryAction()Landroidx/slice/core/SliceAction;

    move-result-object p1

    iput-object p1, p0, mPrimaryAction:Landroidx/slice/core/SliceAction;
...
.method public getHeader()Landroidx/slice/widget/RowContent;
    ...
    iget-object p0, p0, mHeaderContent:Landroidx/slice/widget/RowContent;
...
.method public getHeaderTemplateType()I
    ...
    iget-object p0, p0, mSliceActions:Ljava/util/List;

    const/4 v1, 0x1

    invoke-static {v0, v1, p0}, getRowType(Landroidx/slice/widget/SliceContent;ZLjava/util/List;)I
...
.method public getRowItems()Ljava/util/ArrayList;
    ...
    iget-object p0, p0, mRowItems:Ljava/util/ArrayList;
...
.method public getRowItems(ILandroidx/slice/widget/SliceStyle;Landroidx/slice/widget/SliceViewPolicy;)Ljava/util/ArrayList;
    ...
    invoke-virtual {p0}, getHeader()Landroidx/slice/widget/RowContent;
    ...
    :cond_1
    invoke-virtual {p0}, getRowItems()Ljava/util/ArrayList;
...
.method public getSeeMoreItem()Landroidx/slice/widget/SliceContent;
    ...
    iget-object p0, p0, mSeeMoreContent:Landroidx/slice/widget/RowContent;
...
.method public getShortcut(Landroid/content/Context;)Landroidx/slice/core/SliceAction;
    ...
    iget-object v0, p0, mPrimaryAction:Landroidx/slice/core/SliceAction;
