...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mPinnedSliceUrisLock:Ljava/lang/Object;

    const/4 v0, 0x0

    new-array v0, v0, [Ljava/lang/String;

    iput-object v0, p0, mAutoGrantPermissions:[Ljava/lang/String;
...
.method public static getClock()Landroidx/slice/Clock;
    ...
    sget-object v0, sClock:Landroidx/slice/Clock;
...
.method public static getCurrentSpecs()Ljava/util/Set;
    ...
    sget-object v0, sSpecs:Ljava/util/Set;
...
.method public static setSpecs(Ljava/util/Set;)V
    ...
    sput-object p0, sSpecs:Ljava/util/Set;
...
.method public call(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    :cond_0
    iget-object p0, p0, mCompat:Landroidx/slice/compat/SliceProviderCompat;
...
.method public createPermissionSlice(Landroid/net/Uri;Ljava/lang/String;)Landroidx/slice/Slice;
    ...
    invoke-virtual {p0, p1, p2}, onCreatePermissionRequest(Landroid/net/Uri;Ljava/lang/String;)Landroid/app/PendingIntent;

    move-result-object p0

    if-nez p0, :cond_0

    invoke-static {v0, p1, p2}, createPermissionIntent(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;)Landroid/app/PendingIntent;
    ...
    invoke-static {v0, p2}, getPermissionString(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/CharSequence;
...
.method public getPinnedSlices()Ljava/util/List;
    ...
    iget-object v0, p0, mPinnedSliceUrisLock:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, mPinnedSliceUris:Ljava/util/List;
    ...
    iput-object v1, p0, mPinnedSliceUris:Ljava/util/List;
    ...
    iget-object p0, p0, mPinnedSliceUris:Ljava/util/List;
...
.method public getWrapper()Ljava/lang/Object;
    ...
    iget-object v1, p0, mAutoGrantPermissions:[Ljava/lang/String;
...
.method public handleSlicePinned(Landroid/net/Uri;)V
    ...
    invoke-virtual {p0}, getPinnedSlices()Ljava/util/List;
...
.method public final onCreate()Z
    ...
    invoke-virtual {p0, v1}, onCreatePermissionManager([Ljava/lang/String;)Landroidx/slice/compat/CompatPermissionManager;
    ...
    iput-object v0, p0, mCompat:Landroidx/slice/compat/SliceProviderCompat;

    :cond_1
    invoke-virtual {p0}, onCreateSliceProvider()Z
