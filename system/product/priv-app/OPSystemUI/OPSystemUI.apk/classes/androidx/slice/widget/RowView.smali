...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, sCanSpecifyLargerRangeBarHeight:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mToggles:Landroid/util/ArrayMap;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, mActions:Landroid/util/ArrayMap;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, mLoadingActions:Ljava/util/Set;
    ...
    iput-object v0, p0, mRangeUpdater:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mSeekBarChangeListener:Landroid/widget/SeekBar$OnSeekBarChangeListener;
    ...
    iput-object p1, p0, mRootView:Landroid/widget/LinearLayout;

    iget-object p1, p0, mRootView:Landroid/widget/LinearLayout;
    ...
    iput-object p1, p0, mStartContainer:Landroid/widget/LinearLayout;
    ...
    iput-object p1, p0, mContent:Landroid/widget/LinearLayout;
    ...
    iput-object p1, p0, mPrimaryText:Landroid/widget/TextView;
    ...
    iput-object p1, p0, mSecondaryText:Landroid/widget/TextView;
    ...
    iput-object p1, p0, mLastUpdatedText:Landroid/widget/TextView;
    ...
    iput-object p1, p0, mBottomDivider:Landroid/view/View;
    ...
    iput-object p1, p0, mActionDivider:Landroid/view/View;
    ...
    iput-object p1, p0, mActionSpinner:Landroid/widget/ProgressBar;

    invoke-virtual {p0}, Landroid/widget/FrameLayout;->getContext()Landroid/content/Context;

    move-result-object p1

    iget-object v0, p0, mActionSpinner:Landroid/widget/ProgressBar;
    ...
    iput-object p1, p0, mEndContainer:Landroid/widget/LinearLayout;
...
.method private addAction(Landroidx/slice/core/SliceActionImpl;ILandroid/view/ViewGroup;Z)V
    ...
    iget-object p2, p0, mLoadingActions:Ljava/util/Set;
    ...
    iget-object p0, p0, mToggles:Landroid/util/ArrayMap;
    ...
    :cond_4
    iget-object p0, p0, mActions:Landroid/util/ArrayMap;
...
.method private addItem(Landroidx/slice/SliceItem;IZ)Z
    ...
    iget-object v0, p0, mStartContainer:Landroid/widget/LinearLayout;

    goto :goto_0

    :cond_0
    iget-object v0, p0, mEndContainer:Landroid/widget/LinearLayout;
    ...
    invoke-direct {p0, v1, p2, v0, p3}, addAction(Landroidx/slice/core/SliceActionImpl;ILandroid/view/ViewGroup;Z)V
...
.method private addRange()V
    ...
    :cond_0
    iget-object v0, p0, mRangeItem:Landroidx/slice/SliceItem;
    ...
    :cond_2
    iget v2, p0, mRangeMaxValue:I

    iget v3, p0, mRangeMinValue:I

    sub-int/2addr v2, v3

    invoke-virtual {v1, v2}, Landroid/widget/ProgressBar;->setMax(I)V

    iget v2, p0, mRangeValue:I
    ...
    iput-object v1, p0, mRangeBar:Landroid/widget/ProgressBar;

    if-eqz v0, :cond_5

    iget-object v0, p0, mRowContent:Landroidx/slice/widget/RowContent;

    invoke-virtual {v0}, Landroidx/slice/widget/RowContent;->getInputRangeThumb()Landroidx/slice/SliceItem;

    move-result-object v0

    iget-object v1, p0, mRangeBar:Landroid/widget/ProgressBar;
    ...
    :cond_4
    iget-object p0, p0, mSeekBarChangeListener:Landroid/widget/SeekBar$OnSeekBarChangeListener;
...
.method private addSelection(Landroidx/slice/SliceItem;)V
    ...
    iput-object v0, p0, mSelectionOptionKeys:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mSelectionOptionValues:Ljava/util/ArrayList;
    ...
    :cond_2
    iget-object v3, p0, mSelectionOptionKeys:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, mSelectionOptionValues:Ljava/util/ArrayList;
    ...
    iput-object p1, p0, mSelectionSpinner:Landroid/widget/Spinner;
    ...
    iget-object v2, p0, mSelectionOptionValues:Ljava/util/ArrayList;
    ...
    iget-object v0, p0, mSelectionSpinner:Landroid/widget/Spinner;

    invoke-virtual {v0, p1}, Landroid/widget/Spinner;->setAdapter(Landroid/widget/SpinnerAdapter;)V

    iget-object p1, p0, mSelectionSpinner:Landroid/widget/Spinner;
...
.method private addSubtitle(Z)V
    ...
    invoke-direct {p0, v5, v6}, getRelativeTimeString(J)Ljava/lang/CharSequence;
    ...
    iget-object v6, p0, mSecondaryText:Landroid/widget/TextView;

    iget-boolean v7, p0, mIsHeader:Z
    ...
    iget-boolean v5, p0, mIsHeader:Z
    ...
    iget-object v6, p0, mLastUpdatedText:Landroid/widget/TextView;
    ...
    iget-object v3, p0, mLastUpdatedText:Landroid/widget/TextView;
    ...
    iget v3, p0, mRowIndex:I

    if-gtz v3, :cond_f

    iget-boolean v3, p0, mAllowTwoLines:Z
    ...
    :goto_a
    iget-object p1, p0, mSecondaryText:Landroid/widget/TextView;
    ...
    iget-object p0, p0, mLastUpdatedText:Landroid/widget/TextView;
...
.method private applyRowStyle()V
    ...
    iget-object v1, p0, mStartContainer:Landroid/widget/LinearLayout;

    invoke-virtual {v0}, Landroidx/slice/widget/RowStyle;->getTitleItemEndPadding()I

    move-result v2

    invoke-direct {p0, v1, v2}, setViewPaddingEnd(Landroid/view/View;I)V

    iget-object v1, p0, mContent:Landroid/widget/LinearLayout;
    ...
    invoke-direct {p0, v1, v2, v3}, setViewSidePaddings(Landroid/view/View;II)V

    iget-object v1, p0, mEndContainer:Landroid/widget/LinearLayout;
    ...
    iget-object v1, p0, mBottomDivider:Landroid/view/View;
    ...
    invoke-direct {p0, v1, v2, v3}, setViewSideMargins(Landroid/view/View;II)V

    iget-object v1, p0, mActionDivider:Landroid/view/View;

    invoke-virtual {v0}, Landroidx/slice/widget/RowStyle;->getActionDividerHeight()I

    move-result v0

    invoke-direct {p0, v1, v0}, setViewHeight(Landroid/view/View;I)V
...
.method private getRowContentHeight()I
    ...
    :cond_0
    iget-object v1, p0, mSelectionSpinner:Landroid/widget/Spinner;
...
.method private populateViews(Z)V
    ...
    iget-boolean p1, p0, mIsRangeSliding:Z
    ...
    invoke-direct {p0}, resetViewState()V

    :cond_1
    iget-object v2, p0, mRowContent:Landroidx/slice/widget/RowContent;
    ...
    invoke-direct {p0}, showSeeMore()V
    ...
    iget-object v3, p0, mContent:Landroid/widget/LinearLayout;
    ...
    iput-object v2, p0, mStartItem:Landroidx/slice/SliceItem;

    iget-object v2, p0, mStartItem:Landroidx/slice/SliceItem;

    if-eqz v2, :cond_6

    iget v2, p0, mRowIndex:I
    ...
    invoke-direct {p0, v2, v3, v0}, addItem(Landroidx/slice/SliceItem;IZ)Z

    move-result v2

    :cond_7
    iget-object v3, p0, mStartContainer:Landroid/widget/LinearLayout;
    ...
    iget-boolean v6, p0, mIsHeader:Z
    ...
    :goto_5
    invoke-direct {p0, v2}, addSubtitle(Z)V

    iget-object v2, p0, mBottomDivider:Landroid/view/View;

    iget-object v3, p0, mRowContent:Landroidx/slice/widget/RowContent;
    ...
    iget-object v3, p0, mStartItem:Landroidx/slice/SliceItem;
    ...
    iput-object v3, p0, mRowAction:Landroidx/slice/core/SliceActionImpl;

    iget-object v2, p0, mRowAction:Landroidx/slice/core/SliceActionImpl;
    ...
    iget-object p1, p0, mRowAction:Landroidx/slice/core/SliceActionImpl;

    iget v2, p0, Landroidx/slice/widget/SliceChildView;->mTintColor:I

    iget-object v3, p0, mEndContainer:Landroid/widget/LinearLayout;

    invoke-direct {p0, p1, v2, v3, v1}, addAction(Landroidx/slice/core/SliceActionImpl;ILandroid/view/ViewGroup;Z)V

    iget-object p1, p0, mRootView:Landroid/widget/LinearLayout;

    invoke-direct {p0, p1, v0}, setViewClickable(Landroid/view/View;Z)V

    return-void

    :cond_f
    iget-object v1, p0, mRowContent:Landroidx/slice/widget/RowContent;
    ...
    iget-object v2, p0, mRootView:Landroid/widget/LinearLayout;

    invoke-direct {p0, v2, v0}, setViewClickable(Landroid/view/View;Z)V

    :cond_10
    iput-object v1, p0, mRangeItem:Landroidx/slice/SliceItem;

    if-nez p1, :cond_11

    invoke-direct {p0}, setRangeBounds()V

    invoke-direct {p0}, addRange()V

    :cond_11
    return-void

    :cond_12
    iget-object p1, p0, mRowContent:Landroidx/slice/widget/RowContent;
    ...
    iput-object p1, p0, mSelectionItem:Landroidx/slice/SliceItem;

    invoke-direct {p0, p1}, addSelection(Landroidx/slice/SliceItem;)V

    return-void

    :cond_13
    invoke-direct {p0}, updateEndItems()V

    invoke-virtual {p0}, updateActionSpinner()V
...
.method private resetViewState()V
    ...
    iget-object v0, p0, mRootView:Landroid/widget/LinearLayout;
    ...
    invoke-direct {p0, v0, v1}, setViewClickable(Landroid/view/View;Z)V

    iget-object v0, p0, mContent:Landroid/widget/LinearLayout;
    ...
    iget-object v0, p0, mPrimaryText:Landroid/widget/TextView;

    const/4 v3, 0x0

    invoke-virtual {v0, v3}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget-object v0, p0, mSecondaryText:Landroid/widget/TextView;

    invoke-virtual {v0, v3}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget-object v0, p0, mLastUpdatedText:Landroid/widget/TextView;
    ...
    iget-object v0, p0, mToggles:Landroid/util/ArrayMap;

    invoke-virtual {v0}, Landroid/util/ArrayMap;->clear()V

    iget-object v0, p0, mActions:Landroid/util/ArrayMap;

    invoke-virtual {v0}, Landroid/util/ArrayMap;->clear()V

    iput-object v3, p0, mRowAction:Landroidx/slice/core/SliceActionImpl;

    iput-object v3, p0, mStartItem:Landroidx/slice/SliceItem;

    iget-object v0, p0, mBottomDivider:Landroid/view/View;

    invoke-virtual {v0, v2}, Landroid/view/View;->setVisibility(I)V

    iget-object v0, p0, mActionDivider:Landroid/view/View;

    invoke-virtual {v0, v2}, Landroid/view/View;->setVisibility(I)V

    iget-object v0, p0, mSeeMoreView:Landroid/view/View;

    if-eqz v0, :cond_0

    iget-object v4, p0, mRootView:Landroid/widget/LinearLayout;

    invoke-virtual {v4, v0}, Landroid/widget/LinearLayout;->removeView(Landroid/view/View;)V

    iput-object v3, p0, mSeeMoreView:Landroid/view/View;

    :cond_0
    iput-boolean v1, p0, mIsRangeSliding:Z

    iput-boolean v1, p0, mRangeHasPendingUpdate:Z

    iput-object v3, p0, mRangeItem:Landroidx/slice/SliceItem;

    iput v1, p0, mRangeMinValue:I

    iput v1, p0, mRangeMaxValue:I

    iput v1, p0, mRangeValue:I

    const-wide/16 v0, 0x0

    iput-wide v0, p0, mLastSentRangeUpdate:J

    iput-object v3, p0, mHandler:Landroid/os/Handler;

    iget-object v0, p0, mRangeBar:Landroid/widget/ProgressBar;

    if-eqz v0, :cond_1

    invoke-virtual {p0, v0}, Landroid/widget/FrameLayout;->removeView(Landroid/view/View;)V

    iput-object v3, p0, mRangeBar:Landroid/widget/ProgressBar;
    ...
    iput-object v3, p0, mSelectionSpinner:Landroid/widget/Spinner;

    :cond_2
    iput-object v3, p0, mSelectionItem:Landroidx/slice/SliceItem;
...
.method private setRangeBounds()V
    ...
    :goto_0
    iput v0, p0, mRangeMinValue:I

    iget-object v3, p0, mRangeItem:Landroidx/slice/SliceItem;
...
.method private setViewSideMargins(Landroid/view/View;II)V
    ...
    iget-object p0, p0, mBottomDivider:Landroid/view/View;
...
.method private showSeeMore()V
    ...
    :cond_0
    iput-object v0, p0, mSeeMoreView:Landroid/view/View;

    iget-object v1, p0, mRootView:Landroid/widget/LinearLayout;

    iget-object v2, p0, mSeeMoreView:Landroid/view/View;

    invoke-virtual {v1, v2}, Landroid/widget/LinearLayout;->addView(Landroid/view/View;)V

    iget-object v1, p0, mLoadingActions:Ljava/util/Set;
    ...
    iput-boolean v1, p0, mShowActionSpinner:Z
...
.method private updateEndItems()V
    ...
    iget-object v1, p0, mHeaderActions:Ljava/util/List;
    ...
    :cond_1
    iget v1, p0, mRowIndex:I

    if-nez v1, :cond_2

    iget-object v1, p0, mStartItem:Landroidx/slice/SliceItem;
    ...
    invoke-direct {p0, v7, v10, v2}, addItem(Landroidx/slice/SliceItem;IZ)Z
    ...
    iget-object v4, p0, mToggles:Landroid/util/ArrayMap;
    ...
    iget-object v7, p0, mRowAction:Landroidx/slice/core/SliceActionImpl;

    if-eqz v7, :cond_b

    if-nez v4, :cond_a

    iget-object v4, p0, mRowContent:Landroidx/slice/widget/RowContent;
    ...
    iget-object v0, p0, mStartItem:Landroidx/slice/SliceItem;
    ...
    :goto_6
    iget-object v4, p0, mRowAction:Landroidx/slice/core/SliceActionImpl;

    if-eqz v4, :cond_e

    iget-object v0, p0, mRootView:Landroid/widget/LinearLayout;

    invoke-direct {p0, v0, v9}, setViewClickable(Landroid/view/View;Z)V
    ...
    iput-object v0, p0, mRowAction:Landroidx/slice/core/SliceActionImpl;
    ...
    :cond_12
    :goto_8
    iget-object v0, p0, mRowAction:Landroidx/slice/core/SliceActionImpl;
    ...
    iput-boolean v9, p0, mShowActionSpinner:Z
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object v1, p0, mRowAction:Landroidx/slice/core/SliceActionImpl;
    ...
    iput-boolean p1, p0, mShowActionSpinner:Z
    ...
    :cond_4
    iget-boolean p1, p0, mShowActionSpinner:Z
    ...
    iget-object p1, p0, mLoadingActions:Ljava/util/Set;
...
.method public onItemSelected(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    iget-object p2, p0, mSelectionItem:Landroidx/slice/SliceItem;

    if-eqz p2, :cond_3

    iget-object p2, p0, mSelectionSpinner:Landroid/widget/Spinner;

    if-ne p1, p2, :cond_3

    if-ltz p3, :cond_3

    iget-object p1, p0, mSelectionOptionKeys:Ljava/util/ArrayList;
    ...
    iget-object p4, p0, mSelectionItem:Landroidx/slice/SliceItem;
...
.method protected onLayout(ZIIII)V
    ...
    iget-object p2, p0, mRootView:Landroid/widget/LinearLayout;
    ...
    invoke-direct {p0}, getRowContentHeight()I
    ...
    iget-object p2, p0, mRangeBar:Landroid/widget/ProgressBar;
    ...
    iget p3, p0, mMeasuredRangeHeight:I
    ...
    iget p2, p0, mMeasuredRangeHeight:I

    add-int/2addr p2, p3

    iget-object p0, p0, mRangeBar:Landroid/widget/ProgressBar;
    ...
    iget-object p3, p0, mSelectionSpinner:Landroid/widget/Spinner;
    ...
    iget-object p0, p0, mSelectionSpinner:Landroid/widget/Spinner;
...
.method protected onMeasure(II)V
    ...
    invoke-direct {p0, v1, p1, p2}, measureChildWithExactHeight(Landroid/view/View;II)V
    ...
    sget-boolean v2, sCanSpecifyLargerRangeBarHeight:Z
    ...
    invoke-direct {p0, v1, p1, v2}, measureChildWithExactHeight(Landroid/view/View;II)V
    ...
    iput v1, p0, mMeasuredRangeHeight:I
...
.method public resetView()V
    ...
    iput-object v0, p0, mRowContent:Landroidx/slice/widget/RowContent;

    iget-object v0, p0, mLoadingActions:Ljava/util/Set;
...
.method sendSliderValue()V
    ...
    iget-object p0, p0, mRangeItem:Landroidx/slice/SliceItem;
...
.method public setAllowTwoLines(Z)V
    ...
    iput-boolean p1, p0, mAllowTwoLines:Z
    ...
    invoke-direct {p0, p1}, populateViews(Z)V
...
.method public setLastUpdated(J)V
    ...
    :goto_0
    invoke-direct {p0, p1}, addSubtitle(Z)V
...
.method public setLoadingActions(Ljava/util/Set;)V
    ...
    :cond_0
    iput-object p1, p0, mLoadingActions:Ljava/util/Set;
...
.method public setSliceActions(Ljava/util/List;)V
    ...
    iput-object p1, p0, mHeaderActions:Ljava/util/List;
...
.method public setSliceItem(Landroidx/slice/widget/SliceContent;ZIILandroidx/slice/widget/SliceView$OnSliceActionListener;)V
    ...
    iget-object p5, p0, mRowContent:Landroidx/slice/widget/RowContent;
    ...
    :goto_3
    iput-boolean p4, p0, mShowActionSpinner:Z

    iput-boolean p2, p0, mIsHeader:Z

    check-cast p1, Landroidx/slice/widget/RowContent;

    iput-object p1, p0, mRowContent:Landroidx/slice/widget/RowContent;

    iput p3, p0, mRowIndex:I

    invoke-direct {p0, v1}, populateViews(Z)V
...
.method public setStyle(Landroidx/slice/widget/SliceStyle;)V
    ...
    invoke-direct {p0}, applyRowStyle()V
...
.method updateActionSpinner()V
    ...
    iget-boolean p0, p0, mShowActionSpinner:Z
