...
.method public constructor <init>(Landroid/content/Context;Landroid/net/Uri;)V
    ...
    iput-object v0, p0, mBuilder:Landroidx/slice/Slice$Builder;

    iput-object p1, p0, mContext:Landroid/content/Context;

    invoke-direct {p0, p2}, getSpecs(Landroid/net/Uri;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, mSpecs:Ljava/util/List;

    invoke-virtual {p0}, selectImpl()Landroidx/slice/builders/impl/TemplateBuilderImpl;

    move-result-object p1

    iput-object p1, p0, mImpl:Landroidx/slice/builders/impl/TemplateBuilderImpl;

    iget-object p1, p0, mImpl:Landroidx/slice/builders/impl/TemplateBuilderImpl;

    if-eqz p1, :cond_0

    invoke-virtual {p0, p1}, setImpl(Landroidx/slice/builders/impl/TemplateBuilderImpl;)V
...
.method protected checkCompatible(Landroidx/slice/SliceSpec;)Z
    ...
    iget-object v0, p0, mSpecs:Ljava/util/List;
    ...
    iget-object v3, p0, mSpecs:Ljava/util/List;
...
.method protected getBuilder()Landroidx/slice/Slice$Builder;
    ...
    iget-object p0, p0, mBuilder:Landroidx/slice/Slice$Builder;
