...
.method static constructor <clinit>()V
    ...
    sput-object v0, SLICE_ACTION_PRIORITY_COMPARATOR:Ljava/util/Comparator;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-boolean v0, p0, mShowActions:Z

    const/4 v1, 0x1

    iput-boolean v1, p0, mShowLastUpdated:Z

    iput-boolean v0, p0, mCurrentSliceLoggedVisible:Z

    iput-boolean v0, p0, mShowTitleItems:Z

    iput-boolean v0, p0, mShowHeaderDivider:Z

    iput-boolean v0, p0, mShowActionDividers:Z

    const/4 v0, -0x1

    iput v0, p0, mThemeTintColor:I
    ...
    iput-object v0, p0, mLongpressCheck:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mRefreshLastUpdated:Ljava/lang/Runnable;
...
.method private applyConfigurations()V
    ...
    iget-object v0, p0, mCurrentView:Landroidx/slice/widget/SliceChildView;

    iget-object v1, p0, mSliceObserver:Landroidx/slice/widget/SliceView$OnSliceActionListener;
    ...
    iget-object p0, p0, mListContent:Landroidx/slice/widget/ListContent;
    ...
    :cond_0
    iget-object p0, p0, mCurrentView:Landroidx/slice/widget/SliceChildView;
...
.method private configureViewPolicy(I)V
    ...
    iget-object v0, p0, mSliceStyle:Landroidx/slice/widget/SliceStyle;
    ...
    iget v0, p0, mMinTemplateHeight:I
    ...
    :cond_0
    iget-object v0, p0, mViewPolicy:Landroidx/slice/widget/SliceViewPolicy;
    ...
    :goto_0
    iget-object p0, p0, mViewPolicy:Landroidx/slice/widget/SliceViewPolicy;
...
.method private getTintColor()I
    ...
    :cond_0
    iget-object v0, p0, mCurrentSlice:Landroidx/slice/Slice;
...
.method private handleTouchForLongpress(Landroid/view/MotionEvent;)Z
    ...
    iget p1, p0, mTouchSlopSquared:I

    if-le v0, p1, :cond_1

    iput-boolean v2, p0, mPressing:Z

    iget-object p1, p0, mHandler:Landroid/os/Handler;

    iget-object v0, p0, mLongpressCheck:Ljava/lang/Runnable;

    invoke-virtual {p1, v0}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    :cond_1
    iget-boolean p0, p0, mInLongpress:Z

    return p0

    :cond_2
    iget-boolean p1, p0, mInLongpress:Z
    ...
    iget-object p0, p0, mLongpressCheck:Ljava/lang/Runnable;
    ...
    iget-object v3, p0, mLongpressCheck:Ljava/lang/Runnable;
    ...
    iput-boolean v1, p0, mPressing:Z
...
.method private init(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object v0, p0, mSliceStyle:Landroidx/slice/widget/SliceStyle;

    iget-object p1, p0, mSliceStyle:Landroidx/slice/widget/SliceStyle;

    invoke-virtual {p1}, Landroidx/slice/widget/SliceStyle;->getTintColor()I

    move-result p1

    iput p1, p0, mThemeTintColor:I
    ...
    iput p1, p0, mMinTemplateHeight:I
    ...
    iput-object p1, p0, mCurrentView:Landroidx/slice/widget/SliceChildView;

    iget-object p1, p0, mCurrentView:Landroidx/slice/widget/SliceChildView;

    iget-object p2, p0, mViewPolicy:Landroidx/slice/widget/SliceViewPolicy;

    invoke-virtual {p1, p2}, Landroidx/slice/widget/SliceChildView;->setPolicy(Landroidx/slice/widget/SliceViewPolicy;)V

    iget-object p1, p0, mCurrentView:Landroidx/slice/widget/SliceChildView;

    invoke-direct {p0, p1}, getChildLp(Landroid/view/View;)Landroid/view/ViewGroup$LayoutParams;

    move-result-object p2

    invoke-virtual {p0, p1, p2}, Landroid/view/ViewGroup;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    invoke-direct {p0}, applyConfigurations()V
    ...
    iput-object p1, p0, mActionRow:Landroidx/slice/widget/ActionRow;

    iget-object p1, p0, mActionRow:Landroidx/slice/widget/ActionRow;
    ...
    invoke-direct {p0}, updateActions()V
    ...
    iput p1, p0, mTouchSlopSquared:I
...
.method private initSliceMetrics(Landroidx/slice/Slice;)V
    ...
    :cond_0
    iget-object v1, p0, mCurrentSlice:Landroidx/slice/Slice;
    ...
    :cond_1
    invoke-direct {p0, v0}, logSliceMetricsVisibilityChange(Z)V
    ...
    iput-object p1, p0, mCurrentSliceMetrics:Landroidx/slice/widget/SliceMetrics;
...
.method private logSliceMetricsOnTouch(Landroidx/slice/SliceItem;Landroidx/slice/widget/EventInfo;)V
    ...
    iget-object v0, p0, mCurrentSliceMetrics:Landroidx/slice/widget/SliceMetrics;
    ...
    iget-object p0, p0, mCurrentSliceMetrics:Landroidx/slice/widget/SliceMetrics;
...
.method private logSliceMetricsVisibilityChange(Z)V
    ...
    iget-boolean v1, p0, mCurrentSliceLoggedVisible:Z
    ...
    iget-boolean p1, p0, mCurrentSliceLoggedVisible:Z

    if-eqz p1, :cond_1

    iget-object p1, p0, mCurrentSliceMetrics:Landroidx/slice/widget/SliceMetrics;

    invoke-virtual {p1}, Landroidx/slice/widget/SliceMetrics;->logHidden()V

    const/4 p1, 0x0

    iput-boolean p1, p0, mCurrentSliceLoggedVisible:Z
...
.method private refreshLastUpdatedLabel(Z)V
    ...
    iget-boolean v0, p0, mShowLastUpdated:Z

    if-eqz v0, :cond_2

    iget-object v0, p0, mSliceMetadata:Landroidx/slice/SliceMetadata;
    ...
    iget-object v0, p0, mRefreshLastUpdated:Ljava/lang/Runnable;

    iget-object v1, p0, mSliceMetadata:Landroidx/slice/SliceMetadata;
    ...
    :cond_0
    iget-object p0, p0, mSliceMetadata:Landroidx/slice/SliceMetadata;
    ...
    iget-object p0, p0, mRefreshLastUpdated:Ljava/lang/Runnable;
...
.method private updateActions()V
    ...
    iget-object v0, p0, mActions:Ljava/util/List;
    ...
    iget-object v0, p0, mActionRow:Landroidx/slice/widget/ActionRow;
    ...
    sget-object v0, SLICE_ACTION_PRIORITY_COMPARATOR:Ljava/util/Comparator;

    invoke-static {v3, v0}, Ljava/util/Collections;->sort(Ljava/util/List;Ljava/util/Comparator;)V

    iget-boolean v0, p0, mShowActions:Z
    ...
    iget-object p0, p0, mActionRow:Landroidx/slice/widget/ActionRow;
...
.method public isSliceViewClickable()Z
    ...
    iget-object v0, p0, mOnClickListener:Landroid/view/View$OnClickListener;
...
.method protected onAttachedToWindow()V
    ...
    invoke-direct {p0, v0}, refreshLastUpdatedLabel(Z)V
...
.method public onChanged(Landroidx/slice/Slice;)V
    ...
    invoke-virtual {p0, p1}, setSlice(Landroidx/slice/Slice;)V
...
.method public bridge synthetic onChanged(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, onChanged(Landroidx/slice/Slice;)V
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object p1, p0, mListContent:Landroidx/slice/widget/ListContent;
    ...
    iget-object v3, p0, mCurrentView:Landroidx/slice/widget/SliceChildView;
    ...
    iget-object v0, p0, mSliceObserver:Landroidx/slice/widget/SliceView$OnSliceActionListener;

    if-eqz v0, :cond_3

    iget-object v0, p0, mClickInfo:[I
    ...
    iget-object v5, p0, mClickInfo:[I
    ...
    invoke-direct {p0, p1, v0}, logSliceMetricsOnTouch(Landroidx/slice/SliceItem;Landroidx/slice/widget/EventInfo;)V
    :try_end_0
    ...
    :cond_2
    iget-object p1, p0, mOnClickListener:Landroid/view/View$OnClickListener;
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, mLongClickListener:Landroid/view/View$OnLongClickListener;

    if-eqz v0, :cond_0

    invoke-direct {p0, p1}, handleTouchForLongpress(Landroid/view/MotionEvent;)Z
...
.method protected onLayout(ZIIII)V
    ...
    iget-object p2, p0, mActionRow:Landroidx/slice/widget/ActionRow;
...
.method protected onMeasure(II)V
    ...
    :goto_1
    invoke-direct {p0, v4}, configureViewPolicy(I)V
    ...
    iget-object v5, p0, mListContent:Landroidx/slice/widget/ListContent;
    ...
    :cond_6
    iget-object v1, p0, mListContent:Landroidx/slice/widget/ListContent;

    iget-object v5, p0, mSliceStyle:Landroidx/slice/widget/SliceStyle;

    iget-object v6, p0, mViewPolicy:Landroidx/slice/widget/SliceViewPolicy;
    ...
    :cond_8
    iget p2, p0, mMinTemplateHeight:I
    ...
    :goto_6
    iget-object v5, p0, mActionRow:Landroidx/slice/widget/ActionRow;
    ...
    iget-object p2, p0, mCurrentView:Landroidx/slice/widget/SliceChildView;
...
.method protected onVisibilityChanged(Landroid/view/View;I)V
    ...
    :goto_0
    invoke-direct {p0, v1}, logSliceMetricsVisibilityChange(Z)V
    ...
    :goto_1
    invoke-direct {p0, p1}, refreshLastUpdatedLabel(Z)V
...
.method protected onWindowVisibilityChanged(I)V
    ...
    :goto_0
    invoke-direct {p0, v2}, logSliceMetricsVisibilityChange(Z)V
...
.method public setClickInfo([I)V
    ...
    iput-object p1, p0, mClickInfo:[I
...
.method public setOnLongClickListener(Landroid/view/View$OnLongClickListener;)V
    ...
    iput-object p1, p0, mLongClickListener:Landroid/view/View$OnLongClickListener;
...
.method public setShowActionDividers(Z)V
    ...
    iput-boolean p1, p0, mShowActionDividers:Z
...
.method public setShowHeaderDivider(Z)V
    ...
    iput-boolean p1, p0, mShowHeaderDivider:Z
...
.method public setShowTitleItems(Z)V
    ...
    iput-boolean p1, p0, mShowTitleItems:Z
...
.method public setSlice(Landroidx/slice/Slice;)V
    ...
    invoke-direct {p0, p1}, initSliceMetrics(Landroidx/slice/Slice;)V
    ...
    iget-object v2, p0, mCurrentSlice:Landroidx/slice/Slice;
    ...
    iget-object v3, p0, mCurrentSlice:Landroidx/slice/Slice;
    ...
    :goto_0
    iget-object v3, p0, mSliceMetadata:Landroidx/slice/SliceMetadata;

    iput-object p1, p0, mCurrentSlice:Landroidx/slice/Slice;

    iget-object p1, p0, mCurrentSlice:Landroidx/slice/Slice;
    ...
    iget-object v5, p0, mCurrentSlice:Landroidx/slice/Slice;
    ...
    :goto_1
    iput-object p1, p0, mSliceMetadata:Landroidx/slice/SliceMetadata;

    const/4 p1, 0x2

    if-eqz v2, :cond_2

    iget-object v2, p0, mSliceMetadata:Landroidx/slice/SliceMetadata;
    ...
    :cond_2
    iget-object v2, p0, mCurrentView:Landroidx/slice/widget/SliceChildView;
    ...
    :goto_2
    iput-object v2, p0, mListContent:Landroidx/slice/widget/ListContent;

    iget-boolean v2, p0, mShowTitleItems:Z

    if-eqz v2, :cond_5

    invoke-virtual {p0, v1}, showTitleItems(Z)V

    :cond_5
    iget-boolean v2, p0, mShowHeaderDivider:Z

    if-eqz v2, :cond_6

    invoke-virtual {p0, v1}, showHeaderDivider(Z)V

    :cond_6
    iget-boolean v2, p0, mShowActionDividers:Z

    if-eqz v2, :cond_7

    invoke-virtual {p0, v1}, showActionDividers(Z)V

    :cond_7
    iget-object v2, p0, mListContent:Landroidx/slice/widget/ListContent;
    ...
    iput-object v2, p0, mActions:Ljava/util/List;
    ...
    iget-boolean v3, p0, mShowLastUpdated:Z
    ...
    invoke-direct {p0, v1}, refreshLastUpdatedLabel(Z)V

    return-void

    :cond_b
    :goto_4
    iput-object v4, p0, mActions:Ljava/util/List;
...
.method public showActionDividers(Z)V
    ...
    invoke-virtual {p0, p1}, setShowActionDividers(Z)V
...
.method public showHeaderDivider(Z)V
    ...
    invoke-virtual {p0, p1}, setShowHeaderDivider(Z)V
...
.method public showTitleItems(Z)V
    ...
    invoke-virtual {p0, p1}, setShowTitleItems(Z)V
