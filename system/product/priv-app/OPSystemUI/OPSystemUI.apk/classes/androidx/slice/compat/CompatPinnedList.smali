...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iput-object p2, p0, mPrefsName:Ljava/lang/String;
...
.method private getPins(Landroid/net/Uri;)Ljava/util/Set;
    ...
    invoke-direct {p0}, getPrefs()Landroid/content/SharedPreferences;
...
.method private getPrefs()Landroid/content/SharedPreferences;
    ...
    iget-object v1, p0, mPrefsName:Ljava/lang/String;
    ...
    invoke-virtual {p0}, getBootTime()J
...
.method private static mergeSpecs(Landroidx/collection/ArraySet;Ljava/util/Set;)Landroidx/collection/ArraySet;
    ...
    invoke-static {p1, v2}, findSpec(Ljava/util/Set;Ljava/lang/String;)Landroidx/slice/SliceSpec;
...
.method public declared-synchronized addPin(Landroid/net/Uri;Ljava/lang/String;Ljava/util/Set;)Z
    ...
    :try_start_0
    invoke-direct {p0, p1}, getPins(Landroid/net/Uri;)Ljava/util/Set;
    ...
    invoke-direct {p0, p1, v0}, setPins(Landroid/net/Uri;Ljava/util/Set;)V
    ...
    invoke-direct {p0, p1, p2}, setSpecs(Landroid/net/Uri;Landroidx/collection/ArraySet;)V

    goto :goto_0

    :cond_0
    invoke-virtual {p0, p1}, getSpecs(Landroid/net/Uri;)Landroidx/collection/ArraySet;

    move-result-object p2

    invoke-static {p2, p3}, mergeSpecs(Landroidx/collection/ArraySet;Ljava/util/Set;)Landroidx/collection/ArraySet;
...
.method public getPinnedSlices()Ljava/util/List;
    ...
    invoke-direct {p0, v2}, getPins(Landroid/net/Uri;)Ljava/util/Set;
