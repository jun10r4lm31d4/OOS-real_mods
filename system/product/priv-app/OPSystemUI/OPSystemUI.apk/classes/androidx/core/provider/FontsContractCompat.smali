...
.method static constructor <clinit>()V
    ...
    sput-object v0, sTypefaceCache:Landroidx/collection/LruCache;
    ...
    sput-object v0, sBackgroundThread:Landroidx/core/provider/SelfDestructiveThread;
    ...
    sput-object v0, sPendingReplies:Landroidx/collection/SimpleArrayMap;
...
.method public static fetchFonts(Landroid/content/Context;Landroid/os/CancellationSignal;Landroidx/core/provider/FontRequest;)Landroidx/core/provider/FontsContractCompat$FontFamilyResult;
    ...
    invoke-static {v0, p2, v1}, getProvider(Landroid/content/pm/PackageManager;Landroidx/core/provider/FontRequest;Landroid/content/res/Resources;)Landroid/content/pm/ProviderInfo;
    ...
    invoke-static {p0, p2, v0, p1}, getFontFromProvider(Landroid/content/Context;Landroidx/core/provider/FontRequest;Ljava/lang/String;Landroid/os/CancellationSignal;)[Landroidx/core/provider/FontsContractCompat$FontInfo;
...
.method static getFontInternal(Landroid/content/Context;Landroidx/core/provider/FontRequest;I)Landroidx/core/provider/FontsContractCompat$TypefaceResult;
    ...
    :try_start_0
    invoke-static {p0, v0, p1}, fetchFonts(Landroid/content/Context;Landroid/os/CancellationSignal;Landroidx/core/provider/FontRequest;)Landroidx/core/provider/FontsContractCompat$FontFamilyResult;
...
.method public static getFontSync(Landroid/content/Context;Landroidx/core/provider/FontRequest;Landroidx/core/content/res/ResourcesCompat$FontCallback;Landroid/os/Handler;ZIIZ)Landroid/graphics/Typeface;
    ...
    sget-object v1, sTypefaceCache:Landroidx/collection/LruCache;
    ...
    invoke-static {p0, p1, p6}, getFontInternal(Landroid/content/Context;Landroidx/core/provider/FontRequest;I)Landroidx/core/provider/FontsContractCompat$TypefaceResult;
    ...
    sget-object p7, sExecutor:Ljava/util/concurrent/Executor;

    if-nez p7, :cond_6

    sget-object p7, sLock:Ljava/lang/Object;

    monitor-enter p7

    :try_start_0
    sget-object v2, sExecutor:Ljava/util/concurrent/Executor;
    ...
    sput-object v2, sExecutor:Ljava/util/concurrent/Executor;
    ...
    :try_start_1
    sget-object p0, sBackgroundThread:Landroidx/core/provider/SelfDestructiveThread;
    ...
    :try_start_2
    sget-object p2, sPendingReplies:Landroidx/collection/SimpleArrayMap;
    ...
    sget-object p0, sPendingReplies:Landroidx/collection/SimpleArrayMap;
...
.method public static getProvider(Landroid/content/pm/PackageManager;Landroidx/core/provider/FontRequest;Landroid/content/res/Resources;)Landroid/content/pm/ProviderInfo;
    ...
    invoke-static {p0}, convertToByteArrayList([Landroid/content/pm/Signature;)Ljava/util/List;

    move-result-object p0

    sget-object v0, sByteArrayComparator:Ljava/util/Comparator;

    invoke-static {p0, v0}, Ljava/util/Collections;->sort(Ljava/util/List;Ljava/util/Comparator;)V

    invoke-static {p1, p2}, getCertificates(Landroidx/core/provider/FontRequest;Landroid/content/res/Resources;)Ljava/util/List;
    ...
    invoke-static {p0, p2}, equalsByteArrayList(Ljava/util/List;Ljava/util/List;)Z
