...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mDividerDecoration:Landroidx/preference/PreferenceFragment$DividerDecoration;
...
.method private unbindPreferences()V
    ...
    :cond_0
    invoke-virtual {p0}, onUnbindPreferences()V
...
.method public addPreferencesFromResource(I)V
    ...
    iget-object v1, p0, mStyledContext:Landroid/content/Context;
    ...
    invoke-virtual {p0, p1}, setPreferenceScreen(Landroidx/preference/PreferenceScreen;)V
...
.method bindPreferences()V
    ...
    invoke-virtual {p0, v0}, onCreateAdapter(Landroidx/preference/PreferenceScreen;)Landroidx/recyclerview/widget/RecyclerView$Adapter;
    ...
    :cond_0
    invoke-virtual {p0}, onBindPreferences()V
...
.method public final getListView()Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object p0, p0, mList:Landroidx/recyclerview/widget/RecyclerView;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v1, p0, mStyledContext:Landroid/content/Context;
    ...
    iput-object v0, p0, mPreferenceManager:Landroidx/preference/PreferenceManager;
    ...
    :goto_0
    invoke-virtual {p0, p1, v0}, onCreatePreferences(Landroid/os/Bundle;Ljava/lang/String;)V
...
.method public onCreateRecyclerView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object p3, p0, mStyledContext:Landroid/content/Context;
    ...
    invoke-virtual {p0}, onCreateLayoutManager()Landroidx/recyclerview/widget/RecyclerView$LayoutManager;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iget-object v0, p0, mStyledContext:Landroid/content/Context;
    ...
    invoke-virtual {p0, p1, v0, p3}, onCreateRecyclerView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroidx/recyclerview/widget/RecyclerView;

    move-result-object p1

    if-eqz p1, :cond_2

    iput-object p1, p0, mList:Landroidx/recyclerview/widget/RecyclerView;

    iget-object p3, p0, mDividerDecoration:Landroidx/preference/PreferenceFragment$DividerDecoration;
    ...
    :cond_0
    iget-object p1, p0, mDividerDecoration:Landroidx/preference/PreferenceFragment$DividerDecoration;

    invoke-virtual {p1, v5}, Landroidx/preference/PreferenceFragment$DividerDecoration;->setAllowDividerAfterLastItem(Z)V

    iget-object p1, p0, mList:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object p0, p0, mRequestFocus:Ljava/lang/Runnable;
...
.method public onDestroyView()V
    ...
    iget-boolean v0, p0, mHavePrefs:Z

    if-eqz v0, :cond_0

    invoke-direct {p0}, unbindPreferences()V

    :cond_0
    const/4 v0, 0x0

    iput-object v0, p0, mList:Landroidx/recyclerview/widget/RecyclerView;
...
.method public onDisplayPreferenceDialog(Landroidx/preference/Preference;)V
    ...
    invoke-virtual {p0}, getCallbackFragment()Landroid/app/Fragment;
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    :cond_0
    iget-boolean p1, p0, mHavePrefs:Z

    if-eqz p1, :cond_1

    invoke-virtual {p0}, bindPreferences()V

    iget-object p1, p0, mSelectPreferenceRunnable:Ljava/lang/Runnable;
    ...
    iput-object p1, p0, mSelectPreferenceRunnable:Ljava/lang/Runnable;

    :cond_1
    const/4 p1, 0x1

    iput-boolean p1, p0, mInitDone:Z
...
.method public setDivider(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object p0, p0, mDividerDecoration:Landroidx/preference/PreferenceFragment$DividerDecoration;
...
.method public setPreferenceScreen(Landroidx/preference/PreferenceScreen;)V
    ...
    iput-boolean p1, p0, mHavePrefs:Z

    iget-boolean p1, p0, mInitDone:Z
