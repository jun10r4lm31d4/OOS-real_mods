...
.method static constructor <clinit>()V
    ...
    sput-object v0, CONSTRUCTOR_SIGNATURE:[Ljava/lang/Class;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, CONSTRUCTOR_MAP:Ljava/util/HashMap;
...
.method public constructor <init>(Landroid/content/Context;Landroidx/preference/PreferenceManager;)V
    ...
    invoke-direct {p0, p2}, init(Landroidx/preference/PreferenceManager;)V
...
.method private createItem(Ljava/lang/String;[Ljava/lang/String;Landroid/util/AttributeSet;)Landroidx/preference/Preference;
    ...
    sget-object v0, CONSTRUCTOR_MAP:Ljava/util/HashMap;
    ...
    :cond_4
    sget-object p2, CONSTRUCTOR_SIGNATURE:[Ljava/lang/Class;
    ...
    sget-object p2, CONSTRUCTOR_MAP:Ljava/util/HashMap;
...
.method private createItemFromTag(Ljava/lang/String;Landroid/util/AttributeSet;)Landroidx/preference/Preference;
    ...
    invoke-virtual {p0, p1, p2}, onCreateItem(Ljava/lang/String;Landroid/util/AttributeSet;)Landroidx/preference/Preference;
    ...
    invoke-direct {p0, p1, v0, p2}, createItem(Ljava/lang/String;[Ljava/lang/String;Landroid/util/AttributeSet;)Landroidx/preference/Preference;
...
.method private init(Landroidx/preference/PreferenceManager;)V
    ...
    invoke-virtual {p0, p1}, setDefaultPackages([Ljava/lang/String;)V
...
.method private rInflate(Lorg/xmlpull/v1/XmlPullParser;Landroidx/preference/Preference;Landroid/util/AttributeSet;)V
    ...
    :try_start_1
    invoke-static {p1}, skipCurrentTag(Lorg/xmlpull/v1/XmlPullParser;)V
    :try_end_1
    ...
    :cond_3
    invoke-direct {p0, v1, p3}, createItemFromTag(Ljava/lang/String;Landroid/util/AttributeSet;)Landroidx/preference/Preference;
    ...
    invoke-direct {p0, p1, v1, p3}, rInflate(Lorg/xmlpull/v1/XmlPullParser;Landroidx/preference/Preference;Landroid/util/AttributeSet;)V
...
.method public inflate(ILandroidx/preference/PreferenceGroup;)Landroidx/preference/Preference;
    ...
    :try_start_0
    invoke-virtual {p0, p1, p2}, inflate(Lorg/xmlpull/v1/XmlPullParser;Landroidx/preference/PreferenceGroup;)Landroidx/preference/Preference;
...
.method public inflate(Lorg/xmlpull/v1/XmlPullParser;Landroidx/preference/PreferenceGroup;)Landroidx/preference/Preference;
    ...
    invoke-direct {p0, v2, v1}, createItemFromTag(Ljava/lang/String;Landroid/util/AttributeSet;)Landroidx/preference/Preference;

    move-result-object v2

    check-cast v2, Landroidx/preference/PreferenceGroup;

    invoke-direct {p0, p2, v2}, onMergeRoots(Landroidx/preference/PreferenceGroup;Landroidx/preference/PreferenceGroup;)Landroidx/preference/PreferenceGroup;

    move-result-object p2

    invoke-direct {p0, p1, p2, v1}, rInflate(Lorg/xmlpull/v1/XmlPullParser;Landroidx/preference/Preference;Landroid/util/AttributeSet;)V
    :try_end_1
...
.method protected onCreateItem(Ljava/lang/String;Landroid/util/AttributeSet;)Landroidx/preference/Preference;
    ...
    iget-object v0, p0, mDefaultPackages:[Ljava/lang/String;
...
.method public setDefaultPackages([Ljava/lang/String;)V
    ...
    iput-object p1, p0, mDefaultPackages:[Ljava/lang/String;
