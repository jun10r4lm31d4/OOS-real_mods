...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-boolean v2, p0, mSelectable:Z

    iput-boolean v2, p0, mPersistent:Z

    iput-boolean v2, p0, mDependencyMet:Z

    iput-boolean v2, p0, mParentDependencyMet:Z

    iput-boolean v2, p0, mVisible:Z

    iput-boolean v2, p0, mAllowDividerAbove:Z

    iput-boolean v2, p0, mAllowDividerBelow:Z

    iput-boolean v2, p0, mSingleLineTitle:Z

    iput-boolean v2, p0, mShouldDisableView:Z

    sget v3, Landroidx/preference/R$layout;->preference:I

    iput v3, p0, mLayoutResId:I
    ...
    iput-object v3, p0, mClickListener:Landroid/view/View$OnClickListener;
    ...
    iput-object p2, p0, mSummary:Ljava/lang/CharSequence;
    ...
    iput-object p2, p0, mFragment:Ljava/lang/String;
    ...
    iput p2, p0, mWidgetLayoutResId:I
    ...
    iput-boolean p2, p0, mSelectable:Z
    ...
    iput-boolean p2, p0, mPersistent:Z
    ...
    iput-boolean p2, p0, mAllowDividerBelow:Z
    ...
    invoke-virtual {p0, p1, p2}, onGetDefaultValue(Landroid/content/res/TypedArray;I)Ljava/lang/Object;

    move-result-object p2

    iput-object p2, p0, mDefaultValue:Ljava/lang/Object;
    ...
    iput-boolean p2, p0, mShouldDisableView:Z
    ...
    iput-boolean p2, p0, mHasSingleLineTitleAttr:Z

    iget-boolean p2, p0, mHasSingleLineTitleAttr:Z
    ...
    iput-boolean p2, p0, mSingleLineTitle:Z
    ...
    iput-boolean p2, p0, mIconSpaceReserved:Z
    ...
    iput-boolean p2, p0, mCopyingEnabled:Z
...
.method private dispatchSetInitialValue()V
    ...
    invoke-virtual {p0}, getPreferenceDataStore()Landroidx/preference/PreferenceDataStore;
    ...
    iget-object v0, p0, mDefaultValue:Ljava/lang/Object;

    invoke-virtual {p0, v1, v0}, onSetInitialValue(ZLjava/lang/Object;)V

    return-void

    :cond_0
    invoke-virtual {p0}, shouldPersist()Z

    move-result v0

    if-eqz v0, :cond_2

    invoke-virtual {p0}, getSharedPreferences()Landroid/content/SharedPreferences;

    move-result-object v0

    iget-object v2, p0, mKey:Ljava/lang/String;
...
.method private registerDependency()V
    ...
    iget-object v0, p0, mDependencyKey:Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, findPreferenceInHierarchy(Ljava/lang/String;)Landroidx/preference/Preference;

    move-result-object v0

    if-eqz v0, :cond_1

    invoke-direct {v0, p0}, registerDependent(Landroidx/preference/Preference;)V
    ...
    iget-object v2, p0, mDependencyKey:Ljava/lang/String;
...
.method private registerDependent(Landroidx/preference/Preference;)V
    ...
    iget-object v0, p0, mDependents:Ljava/util/List;
    ...
    iput-object v0, p0, mDependents:Ljava/util/List;
    ...
    invoke-virtual {p0}, shouldDisableDependents()Z

    move-result v0

    invoke-virtual {p1, p0, v0}, onDependencyChanged(Landroidx/preference/Preference;Z)V
...
.method private setEnabledStateOnViews(Landroid/view/View;Z)V
    ...
    invoke-direct {p0, v1, p2}, setEnabledStateOnViews(Landroid/view/View;Z)V
...
.method private tryCommit(Landroid/content/SharedPreferences$Editor;)V
    ...
    iget-object p0, p0, mPreferenceManager:Landroidx/preference/PreferenceManager;
...
.method private unregisterDependency()V
    ...
    invoke-direct {v0, p0}, unregisterDependent(Landroidx/preference/Preference;)V
...
.method private unregisterDependent(Landroidx/preference/Preference;)V
    ...
    iget-object p0, p0, mDependents:Ljava/util/List;
...
.method assignParent(Landroidx/preference/PreferenceGroup;)V
    ...
    iget-object v0, p0, mParentGroup:Landroidx/preference/PreferenceGroup;
    ...
    :cond_1
    :goto_0
    iput-object p1, p0, mParentGroup:Landroidx/preference/PreferenceGroup;
...
.method public callChangeListener(Ljava/lang/Object;)Z
    ...
    iget-object v0, p0, mOnChangeListener:Landroidx/preference/Preference$OnPreferenceChangeListener;
...
.method final clearWasDetached()V
    ...
    iput-boolean v0, p0, mWasDetached:Z
...
.method public compareTo(Landroidx/preference/Preference;)I
    ...
    iget-object v0, p1, mTitle:Ljava/lang/CharSequence;
    ...
    iget-object p1, p1, mTitle:Ljava/lang/CharSequence;
...
.method public bridge synthetic compareTo(Ljava/lang/Object;)I
    ...
    invoke-virtual {p0, p1}, compareTo(Landroidx/preference/Preference;)I
...
.method dispatchRestoreInstanceState(Landroid/os/Bundle;)V
    ...
    iput-boolean v0, p0, mBaseMethodCalled:Z

    invoke-virtual {p0, p1}, onRestoreInstanceState(Landroid/os/Parcelable;)V

    iget-boolean p0, p0, mBaseMethodCalled:Z
...
.method dispatchSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget-boolean v1, p0, mBaseMethodCalled:Z
...
.method getFilterableStringBuilder()Ljava/lang/StringBuilder;
    ...
    :cond_0
    invoke-virtual {p0}, getSummary()Ljava/lang/CharSequence;
...
.method public getFragment()Ljava/lang/String;
    ...
    iget-object p0, p0, mFragment:Ljava/lang/String;
...
.method public getIcon()Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    iget-object p0, p0, mIcon:Landroid/graphics/drawable/Drawable;
...
.method public getParent()Landroidx/preference/PreferenceGroup;
    ...
    iget-object p0, p0, mParentGroup:Landroidx/preference/PreferenceGroup;
...
.method protected getPersistedBoolean(Z)Z
    ...
    :cond_1
    iget-object v0, p0, mPreferenceManager:Landroidx/preference/PreferenceManager;
...
.method public getPreferenceDataStore()Landroidx/preference/PreferenceDataStore;
    ...
    iget-object v0, p0, mPreferenceDataStore:Landroidx/preference/PreferenceDataStore;
...
.method public getSummary()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0}, getSummaryProvider()Landroidx/preference/Preference$SummaryProvider;
    ...
    :cond_0
    iget-object p0, p0, mSummary:Ljava/lang/CharSequence;
...
.method public final getSummaryProvider()Landroidx/preference/Preference$SummaryProvider;
    ...
    iget-object p0, p0, mSummaryProvider:Landroidx/preference/Preference$SummaryProvider;
...
.method public final getWidgetLayoutResource()I
    ...
    iget p0, p0, mWidgetLayoutResId:I
...
.method public isCopyingEnabled()Z
    ...
    iget-boolean p0, p0, mCopyingEnabled:Z
...
.method public isEnabled()Z
    ...
    iget-boolean v0, p0, mDependencyMet:Z

    if-eqz v0, :cond_0

    iget-boolean p0, p0, mParentDependencyMet:Z
...
.method public isPersistent()Z
    ...
    iget-boolean p0, p0, mPersistent:Z
...
.method public isSelectable()Z
    ...
    iget-boolean p0, p0, mSelectable:Z
...
.method protected notifyChanged()V
    ...
    iget-object v0, p0, mListener:Landroidx/preference/Preference$OnPreferenceChangeInternalListener;
...
.method public notifyDependencyChange(Z)V
    ...
    invoke-virtual {v3, p0, p1}, onDependencyChanged(Landroidx/preference/Preference;Z)V
...
.method public onAttached()V
    ...
    invoke-direct {p0}, registerDependency()V
...
.method protected onAttachedToHierarchy(Landroidx/preference/PreferenceManager;)V
    ...
    iput-object p1, p0, mPreferenceManager:Landroidx/preference/PreferenceManager;

    iget-boolean v0, p0, mHasId:Z
    ...
    :cond_0
    invoke-direct {p0}, dispatchSetInitialValue()V
...
.method protected onAttachedToHierarchy(Landroidx/preference/PreferenceManager;J)V
    ...
    iput-boolean p2, p0, mHasId:Z

    const/4 p2, 0x0

    :try_start_0
    invoke-virtual {p0, p1}, onAttachedToHierarchy(Landroidx/preference/PreferenceManager;)V
    :try_end_0
...
.method public onBindViewHolder(Landroidx/preference/PreferenceViewHolder;)V
    ...
    iget-object v1, p0, mClickListener:Landroid/view/View$OnClickListener;
    ...
    iget-boolean v6, p0, mHasSingleLineTitleAttr:Z

    if-eqz v6, :cond_2

    iget-boolean v6, p0, mSingleLineTitle:Z

    invoke-virtual {v5, v6}, Landroid/widget/TextView;->setSingleLine(Z)V

    :cond_2
    invoke-virtual {p0}, isSelectable()Z
    ...
    iput-object v6, p0, mIcon:Landroid/graphics/drawable/Drawable;
    ...
    :cond_8
    iget-boolean v6, p0, mIconSpaceReserved:Z
    ...
    :cond_c
    iget-boolean v3, p0, mIconSpaceReserved:Z
    ...
    :cond_e
    :goto_4
    iget-boolean v1, p0, mShouldDisableView:Z
    ...
    invoke-direct {p0, v0, v1}, setEnabledStateOnViews(Landroid/view/View;Z)V
    ...
    iget-boolean v3, p0, mAllowDividerAbove:Z

    invoke-virtual {p1, v3}, Landroidx/preference/PreferenceViewHolder;->setDividerAllowedAbove(Z)V

    iget-boolean v3, p0, mAllowDividerBelow:Z

    invoke-virtual {p1, v3}, Landroidx/preference/PreferenceViewHolder;->setDividerAllowedBelow(Z)V

    invoke-virtual {p0}, isCopyingEnabled()Z

    move-result p1

    if-eqz p1, :cond_10

    iget-object v3, p0, mOnCopyListener:Landroidx/preference/Preference$OnPreferenceCopyListener;
    ...
    iput-object v3, p0, mOnCopyListener:Landroidx/preference/Preference$OnPreferenceCopyListener;

    :cond_10
    if-eqz p1, :cond_11

    iget-object p0, p0, mOnCopyListener:Landroidx/preference/Preference$OnPreferenceCopyListener;
...
.method public onDependencyChanged(Landroidx/preference/Preference;Z)V
    ...
    iget-boolean p1, p0, mDependencyMet:Z

    if-ne p1, p2, :cond_0

    xor-int/lit8 p1, p2, 0x1

    iput-boolean p1, p0, mDependencyMet:Z

    invoke-virtual {p0}, shouldDisableDependents()Z

    move-result p1

    invoke-virtual {p0, p1}, notifyDependencyChange(Z)V
...
.method public onDetached()V
    ...
    invoke-direct {p0}, unregisterDependency()V
...
.method public onParentChanged(Landroidx/preference/Preference;Z)V
    ...
    iget-boolean p1, p0, mParentDependencyMet:Z

    if-ne p1, p2, :cond_0

    xor-int/lit8 p1, p2, 0x1

    iput-boolean p1, p0, mParentDependencyMet:Z
...
.method protected onSetInitialValue(ZLjava/lang/Object;)V
    ...
    invoke-virtual {p0, p2}, onSetInitialValue(Ljava/lang/Object;)V
...
.method public performClick()V
    ...
    :cond_0
    invoke-virtual {p0}, onClick()V

    iget-object v0, p0, mOnClickListener:Landroidx/preference/Preference$OnPreferenceClickListener;
    ...
    :cond_1
    invoke-virtual {p0}, getPreferenceManager()Landroidx/preference/PreferenceManager;
...
.method protected performClick(Landroid/view/View;)V
    ...
    invoke-virtual {p0}, performClick()V
...
.method protected persistBoolean(Z)Z
    ...
    invoke-direct {p0, v0}, tryCommit(Landroid/content/SharedPreferences$Editor;)V
...
.method protected persistInt(I)Z
    ...
    invoke-virtual {p0, v0}, getPersistedInt(I)I
...
.method protected persistString(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v0}, getPersistedString(Ljava/lang/String;)Ljava/lang/String;
...
.method public persistStringSet(Ljava/util/Set;)Z
    ...
    invoke-virtual {p0, v0}, getPersistedStringSet(Ljava/util/Set;)Ljava/util/Set;
...
.method requireKey()V
    ...
    iput-boolean v0, p0, mRequiresKey:Z
...
.method public restoreHierarchyState(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, p1}, dispatchRestoreInstanceState(Landroid/os/Bundle;)V
...
.method public saveHierarchyState(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, p1}, dispatchSaveInstanceState(Landroid/os/Bundle;)V
...
.method public setKey(Ljava/lang/String;)V
    ...
    iget-boolean p1, p0, mRequiresKey:Z
    ...
    invoke-virtual {p0}, requireKey()V
...
.method final setOnPreferenceChangeInternalListener(Landroidx/preference/Preference$OnPreferenceChangeInternalListener;)V
    ...
    iput-object p1, p0, mListener:Landroidx/preference/Preference$OnPreferenceChangeInternalListener;
...
.method public setOnPreferenceChangeListener(Landroidx/preference/Preference$OnPreferenceChangeListener;)V
    ...
    iput-object p1, p0, mOnChangeListener:Landroidx/preference/Preference$OnPreferenceChangeListener;
...
.method public setOnPreferenceClickListener(Landroidx/preference/Preference$OnPreferenceClickListener;)V
    ...
    iput-object p1, p0, mOnClickListener:Landroidx/preference/Preference$OnPreferenceClickListener;
...
.method public setOrder(I)V
    ...
    invoke-virtual {p0}, notifyHierarchyChanged()V
...
.method public setSelectable(Z)V
    ...
    iget-boolean v0, p0, mSelectable:Z

    if-eq v0, p1, :cond_0

    iput-boolean p1, p0, mSelectable:Z
...
.method public setShouldDisableView(Z)V
    ...
    iget-boolean v0, p0, mShouldDisableView:Z

    if-eq v0, p1, :cond_0

    iput-boolean p1, p0, mShouldDisableView:Z
...
.method public setSummary(I)V
    ...
    invoke-virtual {p0, p1}, setSummary(Ljava/lang/CharSequence;)V
...
.method public setSummary(Ljava/lang/CharSequence;)V
    ...
    iget-object v0, p0, mSummary:Ljava/lang/CharSequence;
    ...
    iput-object p1, p0, mSummary:Ljava/lang/CharSequence;
...
.method public final setSummaryProvider(Landroidx/preference/Preference$SummaryProvider;)V
    ...
    iput-object p1, p0, mSummaryProvider:Landroidx/preference/Preference$SummaryProvider;
...
.method public final setVisible(Z)V
    ...
    iget-object p1, p0, mListener:Landroidx/preference/Preference$OnPreferenceChangeInternalListener;
...
.method public setWidgetLayoutResource(I)V
    ...
    iput p1, p0, mWidgetLayoutResId:I
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, getFilterableStringBuilder()Ljava/lang/StringBuilder;
