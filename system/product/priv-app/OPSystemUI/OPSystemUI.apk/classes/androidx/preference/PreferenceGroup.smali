...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object v0, p0, mIdRecycleCache:Landroidx/collection/SimpleArrayMap;
    ...
    iput-boolean v0, p0, mOrderingAsAdded:Z

    const/4 v1, 0x0

    iput v1, p0, mCurrentPreferenceOrder:I

    iput-boolean v1, p0, mAttachedToHierarchy:Z

    const v1, 0x7fffffff

    iput v1, p0, mInitialExpandedChildrenCount:I

    const/4 v2, 0x0

    iput-object v2, p0, mOnExpandButtonClickListener:Landroidx/preference/PreferenceGroup$OnExpandButtonClickListener;
    ...
    iput-object v2, p0, mClearRecycleCacheRunnable:Ljava/lang/Runnable;

    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    iput-object v2, p0, mPreferences:Ljava/util/List;
    ...
    iput-boolean p2, p0, mOrderingAsAdded:Z
    ...
    invoke-virtual {p0, p2}, setInitialExpandedChildrenCount(I)V
...
.method private removePreferenceInt(Landroidx/preference/Preference;)Z
    ...
    iget-object v2, p0, mIdRecycleCache:Landroidx/collection/SimpleArrayMap;
    ...
    iget-object v2, p0, mClearRecycleCacheRunnable:Ljava/lang/Runnable;
    ...
    :cond_1
    iget-boolean v1, p0, mAttachedToHierarchy:Z
...
.method public addItemFromInflater(Landroidx/preference/Preference;)V
    ...
    invoke-virtual {p0, p1}, addPreference(Landroidx/preference/Preference;)Z
...
.method public addPreference(Landroidx/preference/Preference;)Z
    ...
    invoke-virtual {v0, v2}, findPreference(Ljava/lang/CharSequence;)Landroidx/preference/Preference;
    ...
    iget-boolean v0, p0, mOrderingAsAdded:Z

    if-eqz v0, :cond_3

    iget v0, p0, mCurrentPreferenceOrder:I

    add-int/lit8 v2, v0, 0x1

    iput v2, p0, mCurrentPreferenceOrder:I
    ...
    iget-boolean v2, p0, mOrderingAsAdded:Z

    invoke-virtual {v0, v2}, setOrderingAsAdded(Z)V
    ...
    :cond_5
    invoke-virtual {p0, p1}, onPrepareAddPreference(Landroidx/preference/Preference;)Z
    ...
    :try_start_0
    iget-object v2, p0, mPreferences:Ljava/util/List;
    ...
    iget-object v3, p0, mIdRecycleCache:Landroidx/collection/SimpleArrayMap;
    ...
    iget-object v5, p0, mIdRecycleCache:Landroidx/collection/SimpleArrayMap;
    ...
    iget-boolean v0, p0, mAttachedToHierarchy:Z
...
.method protected dispatchRestoreInstanceState(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, getPreferenceCount()I
    ...
    invoke-virtual {p0, v1}, getPreference(I)Landroidx/preference/Preference;
...
.method public findPreference(Ljava/lang/CharSequence;)Landroidx/preference/Preference;
    ...
    invoke-virtual {v2, p1}, findPreference(Ljava/lang/CharSequence;)Landroidx/preference/Preference;
...
.method public getInitialExpandedChildrenCount()I
    ...
    iget p0, p0, mInitialExpandedChildrenCount:I
...
.method public getOnExpandButtonClickListener()Landroidx/preference/PreferenceGroup$OnExpandButtonClickListener;
    ...
    iget-object p0, p0, mOnExpandButtonClickListener:Landroidx/preference/PreferenceGroup$OnExpandButtonClickListener;
...
.method public onAttached()V
    ...
    iput-boolean v0, p0, mAttachedToHierarchy:Z
...
.method public onDetached()V
    ...
    invoke-virtual {p0, v0}, getPreference(I)Landroidx/preference/Preference;
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    iput v0, p0, mInitialExpandedChildrenCount:I
...
.method public removePreference(Landroidx/preference/Preference;)Z
    ...
    invoke-direct {p0, p1}, removePreferenceInt(Landroidx/preference/Preference;)Z
...
.method public setInitialExpandedChildrenCount(I)V
    ...
    :cond_0
    iput p1, p0, mInitialExpandedChildrenCount:I
...
.method public setOrderingAsAdded(Z)V
    ...
    iput-boolean p1, p0, mOrderingAsAdded:Z
