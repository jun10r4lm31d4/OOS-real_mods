...
.method public constructor <init>(Landroidx/preference/PreferenceGroup;)V
    ...
    iput-object p1, p0, mPreferenceGroup:Landroidx/preference/PreferenceGroup;
    ...
    iget-object p1, p0, mPreferenceGroup:Landroidx/preference/PreferenceGroup;
    ...
    iput-object p1, p0, mPreferences:Ljava/util/List;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, mVisiblePreferences:Ljava/util/List;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, mPreferenceResourceDescriptors:Ljava/util/List;
    ...
    :goto_0
    invoke-virtual {p0}, updatePreferences()V
...
.method private createVisiblePreferencesList(Landroidx/preference/PreferenceGroup;)Ljava/util/List;
    ...
    :cond_0
    invoke-direct {p0, p1}, isGroupExpandable(Landroidx/preference/PreferenceGroup;)Z
    ...
    invoke-direct {p0, v5}, isGroupExpandable(Landroidx/preference/PreferenceGroup;)Z
    ...
    :cond_6
    :goto_3
    invoke-direct {p0, v5}, createVisiblePreferencesList(Landroidx/preference/PreferenceGroup;)Ljava/util/List;
    ...
    invoke-direct {p0, p1, v1}, createExpandButton(Landroidx/preference/PreferenceGroup;Ljava/util/List;)Landroidx/preference/ExpandButton;
...
.method private flattenPreferenceGroup(Ljava/util/List;Landroidx/preference/PreferenceGroup;)V
    ...
    iget-object v4, p0, mPreferenceResourceDescriptors:Ljava/util/List;
    ...
    invoke-direct {p0, p1, v3}, flattenPreferenceGroup(Ljava/util/List;Landroidx/preference/PreferenceGroup;)V
...
.method public getItem(I)Landroidx/preference/Preference;
    ...
    :cond_0
    iget-object p0, p0, mVisiblePreferences:Ljava/util/List;
...
.method public getItemId(I)J
    ...
    :cond_0
    invoke-virtual {p0, p1}, getItem(I)Landroidx/preference/Preference;
...
.method public getItemViewType(I)I
    ...
    iget-object p1, p0, mPreferenceResourceDescriptors:Ljava/util/List;
    ...
    iget-object p0, p0, mPreferenceResourceDescriptors:Ljava/util/List;
...
.method public onBindViewHolder(Landroidx/preference/PreferenceViewHolder;I)V
    ...
    invoke-virtual {p0, p2}, getItem(I)Landroidx/preference/Preference;
...
.method public bridge synthetic onBindViewHolder(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;I)V
    ...
    invoke-virtual {p0, p1, p2}, onBindViewHolder(Landroidx/preference/PreferenceViewHolder;I)V
...
.method public bridge synthetic onCreateViewHolder(Landroid/view/ViewGroup;I)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    ...
    invoke-virtual {p0, p1, p2}, onCreateViewHolder(Landroid/view/ViewGroup;I)Landroidx/preference/PreferenceViewHolder;
...
.method public onPreferenceChange(Landroidx/preference/Preference;)V
    ...
    iget-object v0, p0, mVisiblePreferences:Ljava/util/List;
...
.method public onPreferenceHierarchyChange(Landroidx/preference/Preference;)V
    ...
    iget-object v0, p0, mSyncRunnable:Ljava/lang/Runnable;

    invoke-virtual {p1, v0}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    iget-object p1, p0, mHandler:Landroid/os/Handler;

    iget-object p0, p0, mSyncRunnable:Ljava/lang/Runnable;
...
.method public onPreferenceVisibilityChange(Landroidx/preference/Preference;)V
    ...
    invoke-virtual {p0, p1}, onPreferenceHierarchyChange(Landroidx/preference/Preference;)V
...
.method updatePreferences()V
    ...
    iget-object v0, p0, mPreferences:Ljava/util/List;
    ...
    iput-object v1, p0, mPreferences:Ljava/util/List;

    iget-object v0, p0, mPreferences:Ljava/util/List;

    iget-object v1, p0, mPreferenceGroup:Landroidx/preference/PreferenceGroup;

    invoke-direct {p0, v0, v1}, flattenPreferenceGroup(Ljava/util/List;Landroidx/preference/PreferenceGroup;)V

    iget-object v0, p0, mVisiblePreferences:Ljava/util/List;

    iget-object v1, p0, mPreferenceGroup:Landroidx/preference/PreferenceGroup;

    invoke-direct {p0, v1}, createVisiblePreferencesList(Landroidx/preference/PreferenceGroup;)Ljava/util/List;

    move-result-object v1

    iput-object v1, p0, mVisiblePreferences:Ljava/util/List;

    iget-object v2, p0, mPreferenceGroup:Landroidx/preference/PreferenceGroup;
    ...
    :goto_1
    iget-object p0, p0, mPreferences:Ljava/util/List;
