...
.method static constructor <clinit>()V
    ...
    sput-object v0, TRANSLATION_X:Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;
    ...
    sput-object v0, TRANSLATION_Y:Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;
    ...
    sput-object v0, TRANSLATION_Z:Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;
    ...
    sput-object v0, SCALE_X:Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;
    ...
    sput-object v0, SCALE_Y:Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;
    ...
    sput-object v0, ROTATION:Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;
    ...
    sput-object v0, ROTATION_X:Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;
    ...
    sput-object v0, ROTATION_Y:Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;
    ...
    sput-object v0, X:Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;
    ...
    sput-object v0, Y:Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;
    ...
    sput-object v0, Z:Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;
    ...
    sput-object v0, ALPHA:Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;
    ...
    sput-object v0, SCROLL_X:Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;
    ...
    sput-object v0, SCROLL_Y:Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;
...
.method constructor <init>(Ljava/lang/Object;Landroidx/dynamicanimation/animation/FloatPropertyCompat;)V
    ...
    iput-boolean v1, p0, mStartValueIsSet:Z

    iput-boolean v1, p0, mRunning:Z

    iput v0, p0, mMaxValue:F

    iget v0, p0, mMaxValue:F

    neg-float v0, v0

    iput v0, p0, mMinValue:F

    const-wide/16 v0, 0x0

    iput-wide v0, p0, mLastFrameTime:J

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mEndListeners:Ljava/util/ArrayList;
    ...
    iput-object p1, p0, mTarget:Ljava/lang/Object;

    iput-object p2, p0, mProperty:Landroidx/dynamicanimation/animation/FloatPropertyCompat;

    iget-object p1, p0, mProperty:Landroidx/dynamicanimation/animation/FloatPropertyCompat;

    sget-object p2, ROTATION:Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;

    if-eq p1, p2, :cond_4

    sget-object p2, ROTATION_X:Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;

    if-eq p1, p2, :cond_4

    sget-object p2, ROTATION_Y:Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;
    ...
    :cond_0
    sget-object p2, ALPHA:Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;

    const/high16 v0, 0x3b800000    # 0.00390625f

    if-ne p1, p2, :cond_1

    iput v0, p0, mMinVisibleChange:F

    goto :goto_2

    :cond_1
    sget-object p2, SCALE_X:Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;

    if-eq p1, p2, :cond_3

    sget-object p2, SCALE_Y:Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;
    ...
    iput p1, p0, mMinVisibleChange:F
...
.method private endAnimationInternal(Z)V
    ...
    iput-wide v1, p0, mLastFrameTime:J

    iput-boolean v0, p0, mStartValueIsSet:Z

    :goto_0
    iget-object v1, p0, mEndListeners:Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object p0, p0, mEndListeners:Ljava/util/ArrayList;

    invoke-static {p0}, removeNullEntries(Ljava/util/ArrayList;)V
...
.method private getPropertyValue()F
    ...
    iget-object v0, p0, mProperty:Landroidx/dynamicanimation/animation/FloatPropertyCompat;

    iget-object p0, p0, mTarget:Ljava/lang/Object;
...
.method private startAnimationInternal()V
    ...
    iget-boolean v0, p0, mStartValueIsSet:Z

    if-nez v0, :cond_0

    invoke-direct {p0}, getPropertyValue()F
    ...
    iget v1, p0, mMaxValue:F

    cmpl-float v1, v0, v1

    if-gtz v1, :cond_1

    iget v1, p0, mMinValue:F
...
.method public addEndListener(Landroidx/dynamicanimation/animation/DynamicAnimation$OnAnimationEndListener;)Landroidx/dynamicanimation/animation/DynamicAnimation;
    ...
    iget-object v0, p0, mEndListeners:Ljava/util/ArrayList;
...
.method public cancel()V
    ...
    invoke-direct {p0, v0}, endAnimationInternal(Z)V
...
.method public doAnimationFrame(J)Z
    ...
    iget-wide v0, p0, mLastFrameTime:J
    ...
    iput-wide p1, p0, mLastFrameTime:J

    iget p1, p0, mValue:F

    invoke-virtual {p0, p1}, setPropertyValue(F)V
    ...
    invoke-virtual {p0, v0, v1}, updateValueAndVelocity(J)Z
    ...
    invoke-virtual {p0, p2}, setPropertyValue(F)V

    if-eqz p1, :cond_1

    invoke-direct {p0, v3}, endAnimationInternal(Z)V
...
.method getValueThreshold()F
    ...
    iget p0, p0, mMinVisibleChange:F
...
.method public removeEndListener(Landroidx/dynamicanimation/animation/DynamicAnimation$OnAnimationEndListener;)V
    ...
    invoke-static {p0, p1}, removeEntry(Ljava/util/ArrayList;Ljava/lang/Object;)V
...
.method setPropertyValue(F)V
    ...
    iget-object v1, p0, mTarget:Ljava/lang/Object;
    ...
    :cond_1
    iget-object p0, p0, mUpdateListeners:Ljava/util/ArrayList;
...
.method public setStartValue(F)Landroidx/dynamicanimation/animation/DynamicAnimation;
    ...
    iput-boolean p1, p0, mStartValueIsSet:Z
...
.method public start()V
    ...
    invoke-direct {p0}, startAnimationInternal()V
