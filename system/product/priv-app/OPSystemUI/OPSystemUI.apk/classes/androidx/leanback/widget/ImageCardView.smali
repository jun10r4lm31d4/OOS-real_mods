...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p2, p3, p1}, buildImageCardView(Landroid/util/AttributeSet;II)V
...
.method private buildImageCardView(Landroid/util/AttributeSet;II)V
    ...
    iput-object v8, p0, mImageView:Landroid/widget/ImageView;

    iget-object v8, p0, mImageView:Landroid/widget/ImageView;
    ...
    :cond_6
    iget-object v6, p0, mImageView:Landroid/widget/ImageView;
    ...
    iput-object v0, p0, mFadeInAnimator:Landroid/animation/ObjectAnimator;

    iget-object v0, p0, mFadeInAnimator:Landroid/animation/ObjectAnimator;
    ...
    iput-object v0, p0, mInfoArea:Landroid/view/ViewGroup;

    if-eqz p3, :cond_7

    iget-object p1, p0, mInfoArea:Landroid/view/ViewGroup;
    ...
    iget-object v0, p0, mInfoArea:Landroid/view/ViewGroup;
    ...
    iput-object p3, p0, mTitleView:Landroid/widget/TextView;

    iget-object p3, p0, mInfoArea:Landroid/view/ViewGroup;
    ...
    iput-object p3, p0, mContentView:Landroid/widget/TextView;

    iget-object p3, p0, mInfoArea:Landroid/view/ViewGroup;

    iget-object v0, p0, mContentView:Landroid/widget/TextView;
    ...
    iput-object p2, p0, mBadgeImage:Landroid/widget/ImageView;

    iget-object p2, p0, mInfoArea:Landroid/view/ViewGroup;

    iget-object p3, p0, mBadgeImage:Landroid/widget/ImageView;
    ...
    iget-object v0, p0, mBadgeImage:Landroid/widget/ImageView;
    ...
    iget-object v1, p0, mBadgeImage:Landroid/widget/ImageView;
    ...
    iget-object p1, p0, mBadgeImage:Landroid/widget/ImageView;
    ...
    :cond_10
    iget-object p1, p0, mContentView:Landroid/widget/TextView;
    ...
    iget-object p2, p0, mContentView:Landroid/widget/TextView;
    ...
    iget-object p2, p0, mTitleView:Landroid/widget/TextView;
    ...
    :cond_13
    :goto_6
    iget-object p2, p0, mBadgeImage:Landroid/widget/ImageView;
    ...
    invoke-virtual {p0, p1}, setInfoAreaBackground(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object p0, p0, mBadgeImage:Landroid/widget/ImageView;
...
.method private fadeIn()V
    ...
    iget-object p0, p0, mFadeInAnimator:Landroid/animation/ObjectAnimator;
...
.method public setInfoAreaBackground(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object p0, p0, mInfoArea:Landroid/view/ViewGroup;
