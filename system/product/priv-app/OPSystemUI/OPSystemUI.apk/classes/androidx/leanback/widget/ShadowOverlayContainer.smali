...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput p1, p0, mShadowType:I

    invoke-virtual {p0}, useStaticShadow()V

    invoke-virtual {p0}, useDynamicShadow()V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, mOverlayPaint:Landroid/graphics/Paint;

    if-eqz v0, :cond_0

    iget v0, p0, mOverlayColor:I

    if-eqz v0, :cond_0

    iget-object v0, p0, mWrappedView:Landroid/view/View;
    ...
    iget-object v6, p0, mOverlayPaint:Landroid/graphics/Paint;
...
.method protected onLayout(ZIIII)V
    ...
    iget-object p1, p0, mWrappedView:Landroid/view/View;

    if-eqz p1, :cond_0

    sget-object p2, sTempRect:Landroid/graphics/Rect;
    ...
    sget-object p1, sTempRect:Landroid/graphics/Rect;

    iget-object p2, p0, mWrappedView:Landroid/view/View;
...
.method public useDynamicShadow()V
    ...
    invoke-virtual {p0, v0, v1}, useDynamicShadow(FF)V
...
.method public useDynamicShadow(FF)V
    ...
    invoke-static {}, supportsDynamicShadow()Z
    ...
    iput v0, p0, mShadowType:I

    iput p1, p0, mUnfocusedZ:F

    iput p2, p0, mFocusedZ:F
...
.method public useStaticShadow()V
    ...
    invoke-static {}, supportsShadow()Z
