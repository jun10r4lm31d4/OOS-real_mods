...
.method public constructor <init>(Landroidx/leanback/widget/BaseGridView;)V
    ...
    iput-object v1, p0, mOrientationHelper:Landroidx/recyclerview/widget/OrientationHelper;

    new-instance v1, Landroid/util/SparseIntArray;

    invoke-direct {v1}, Landroid/util/SparseIntArray;-><init>()V

    iput-object v1, p0, mPositionToRowInPostLayout:Landroid/util/SparseIntArray;
    ...
    iput-object v1, p0, mChildSelectedListener:Landroidx/leanback/widget/OnChildSelectedListener;

    iput-object v1, p0, mChildViewHolderSelectedListeners:Ljava/util/ArrayList;

    iput-object v1, p0, mChildLaidOutListener:Landroidx/leanback/widget/OnChildLaidOutListener;

    const/4 v1, -0x1

    iput v1, p0, mFocusPosition:I

    iput v0, p0, mSubFocusPosition:I

    iput v0, p0, mFocusPositionOffset:I
    ...
    iput v2, p0, mNumRowsRequested:I

    iput v0, p0, mFocusScrollStrategy:I
    ...
    iput-object v2, p0, mWindowAlignment:Landroidx/leanback/widget/WindowAlignment;

    new-instance v2, Landroidx/leanback/widget/ItemAlignment;

    invoke-direct {v2}, Landroidx/leanback/widget/ItemAlignment;-><init>()V

    iput-object v2, p0, mItemAlignment:Landroidx/leanback/widget/ItemAlignment;

    const/4 v2, 0x2

    new-array v2, v2, [I

    iput-object v2, p0, mMeasuredDimension:[I
    ...
    iput-object v2, p0, mChildrenStates:Landroidx/leanback/widget/ViewsStateBundle;
    ...
    iput-object v2, p0, mRequestLayoutRunnable:Ljava/lang/Runnable;
    ...
    iput-object v2, p0, mGridProvider:Landroidx/leanback/widget/Grid$Provider;

    iput-object p1, p0, mBaseGridView:Landroidx/leanback/widget/BaseGridView;

    iput v1, p0, mChildVisibility:I
...
.method private appendOneColumnVisibleItems()Z
    ...
    iget-object p0, p0, mGrid:Landroidx/leanback/widget/Grid;
...
.method private appendVisibleItems()V
    ...
    iget-object v0, p0, mGrid:Landroidx/leanback/widget/Grid;
    ...
    iget v1, p0, mExtraLayoutSpace:I

    neg-int v1, v1

    iget p0, p0, mExtraLayoutSpaceInPreLayout:I
    ...
    :cond_0
    iget v1, p0, mSizePrimary:I

    iget v2, p0, mExtraLayoutSpace:I
...
.method private discardLayoutInfo()V
    ...
    iput-object v0, p0, mGrid:Landroidx/leanback/widget/Grid;

    iput-object v0, p0, mRowSizeSecondary:[I
...
.method private fastRelayout()V
    ...
    iget-object v1, p0, mGrid:Landroidx/leanback/widget/Grid;
    ...
    invoke-direct {p0, v5}, getAdapterPositionByView(Landroid/view/View;)I
    ...
    :cond_0
    iget-object v6, p0, mGrid:Landroidx/leanback/widget/Grid;
    ...
    invoke-virtual {p0, v7}, getRowStartSecondary(I)I

    move-result v7

    iget-object v8, p0, mWindowAlignment:Landroidx/leanback/widget/WindowAlignment;
    ...
    iget v8, p0, mScrollOffsetSecondary:I

    sub-int v14, v7, v8

    invoke-virtual {p0, v5}, getViewMin(Landroid/view/View;)I

    move-result v12

    invoke-virtual {p0, v5}, getViewPrimarySize(Landroid/view/View;)I
    ...
    iget-object v8, p0, mRecycler:Landroidx/recyclerview/widget/RecyclerView$Recycler;
    ...
    invoke-virtual {p0, v3}, getViewForPosition(I)Landroid/view/View;
    ...
    invoke-virtual {p0, v11}, measureChild(Landroid/view/View;)V

    iget v5, p0, mOrientation:I

    if-nez v5, :cond_3

    invoke-virtual {p0, v11}, getDecoratedMeasuredWidthWithMargin(Landroid/view/View;)I
    ...
    :cond_3
    invoke-virtual {p0, v11}, getDecoratedMeasuredHeightWithMargin(Landroid/view/View;)I
    ...
    invoke-virtual/range {v9 .. v14}, layoutChild(ILandroid/view/View;III)V
    ...
    iget-object v2, p0, mGrid:Landroidx/leanback/widget/Grid;
    ...
    invoke-direct {p0}, appendVisibleItems()V

    iget v0, p0, mFocusPosition:I
    ...
    :cond_8
    invoke-virtual {p0}, updateScrollLimits()V

    invoke-direct {p0}, updateSecondaryScrollLimits()V
...
.method private findImmediateChildIndex(Landroid/view/View;)I
    ...
    iget-object v0, p0, mBaseGridView:Landroidx/leanback/widget/BaseGridView;
...
.method private focusToViewInLayout(ZZII)V
    ...
    invoke-virtual {p0, v0, v1, p3, p4}, scrollToView(Landroid/view/View;ZII)V
    ...
    iget-object p1, p0, mBaseGridView:Landroidx/leanback/widget/BaseGridView;
    ...
    invoke-virtual {p0, v2, v1, p3, p4}, scrollToView(Landroid/view/View;ZII)V
...
.method private forceRequestLayout()V
    ...
    iget-object p0, p0, mRequestLayoutRunnable:Ljava/lang/Runnable;
...
.method private getAdapterPositionByIndex(I)I
    ...
    invoke-direct {p0, p1}, getAdapterPositionByView(Landroid/view/View;)I
...
.method private getAdjustedPrimaryAlignedScrollDistance(ILandroid/view/View;Landroid/view/View;)I
    ...
    invoke-virtual {p0, p2, p3}, getSubPositionByView(Landroid/view/View;Landroid/view/View;)I
...
.method private getAlignedPosition(Landroid/view/View;Landroid/view/View;[I)Z
    ...
    invoke-direct {p0, p1}, getPrimaryAlignedScrollDistance(Landroid/view/View;)I

    move-result v0

    if-eqz p2, :cond_0

    invoke-direct {p0, v0, p1, p2}, getAdjustedPrimaryAlignedScrollDistance(ILandroid/view/View;Landroid/view/View;)I

    move-result v0

    :cond_0
    invoke-direct {p0, p1}, getSecondaryScrollDistance(Landroid/view/View;)I

    move-result p1

    iget p0, p0, mPrimaryScrollExtra:I
...
.method private getNoneAlignedPosition(Landroid/view/View;[I)Z
    ...
    invoke-virtual {p0, p1}, getViewMin(Landroid/view/View;)I

    move-result v1

    invoke-virtual {p0, p1}, getViewMax(Landroid/view/View;)I

    move-result v2

    iget-object v3, p0, mWindowAlignment:Landroidx/leanback/widget/WindowAlignment;
    ...
    iget-object v4, p0, mWindowAlignment:Landroidx/leanback/widget/WindowAlignment;
    ...
    iget-object v5, p0, mGrid:Landroidx/leanback/widget/Grid;
    ...
    iget v1, p0, mFocusScrollStrategy:I
    ...
    :goto_0
    invoke-direct {p0}, prependOneColumnVisibleItems()Z
    ...
    invoke-virtual {p0, v10}, getViewMin(Landroid/view/View;)I
    ...
    iget v2, p0, mFocusScrollStrategy:I
    ...
    invoke-virtual {p0, v2}, getViewMax(Landroid/view/View;)I
    ...
    :cond_7
    invoke-direct {p0}, appendOneColumnVisibleItems()Z
    ...
    invoke-virtual {p0, v9}, getViewMin(Landroid/view/View;)I
...
.method private getPrimaryAlignedScrollDistance(Landroid/view/View;)I
    ...
    iget-object v0, p0, mWindowAlignment:Landroidx/leanback/widget/WindowAlignment;

    invoke-virtual {v0}, Landroidx/leanback/widget/WindowAlignment;->mainAxis()Landroidx/leanback/widget/WindowAlignment$Axis;

    move-result-object v0

    invoke-direct {p0, p1}, getViewCenter(Landroid/view/View;)I
...
.method private getRowSizeSecondary(I)I
    ...
    iget v0, p0, mFixedRowSizeSecondary:I
    ...
    :cond_0
    iget-object p0, p0, mRowSizeSecondary:[I
...
.method private getSecondaryScrollDistance(Landroid/view/View;)I
    ...
    invoke-direct {p0, p1}, getViewCenterSecondary(Landroid/view/View;)I

    move-result p1

    iget-object p0, p0, mWindowAlignment:Landroidx/leanback/widget/WindowAlignment;
...
.method private getSizeSecondary()I
    ...
    :goto_0
    invoke-virtual {p0, v0}, getRowStartSecondary(I)I

    move-result v1

    invoke-direct {p0, v0}, getRowSizeSecondary(I)I
...
.method private getViewCenter(Landroid/view/View;)I
    ...
    invoke-direct {p0, p1}, getViewCenterX(Landroid/view/View;)I
    ...
    :cond_0
    invoke-direct {p0, p1}, getViewCenterY(Landroid/view/View;)I
...
.method private gridOnRequestFocusInDescendantsUnaligned(Landroidx/recyclerview/widget/RecyclerView;ILandroid/graphics/Rect;)Z
    ...
    iget-object v5, p0, mWindowAlignment:Landroidx/leanback/widget/WindowAlignment;
    ...
    invoke-virtual {p0, v6}, getViewMin(Landroid/view/View;)I

    move-result v7

    if-lt v7, v4, :cond_1

    invoke-virtual {p0, v6}, getViewMax(Landroid/view/View;)I
...
.method private initScrollController()V
    ...
    iput v0, p0, mSizePrimary:I

    const/4 v0, 0x0

    iput v0, p0, mScrollOffsetSecondary:I
...
.method private layoutInit()Z
    ...
    iput v3, p0, mSubFocusPosition:I

    goto :goto_0

    :cond_0
    iget v4, p0, mFocusPosition:I

    if-lt v4, v0, :cond_1

    sub-int/2addr v0, v2

    iput v0, p0, mFocusPosition:I
    ...
    invoke-direct {p0}, updateScrollController()V

    invoke-direct {p0}, updateSecondaryScrollLimits()V

    iget-object v0, p0, mGrid:Landroidx/leanback/widget/Grid;

    iget p0, p0, mSpacingPrimary:I
    ...
    :goto_1
    iget-object v4, p0, mGrid:Landroidx/leanback/widget/Grid;
    ...
    iget-object v4, p0, mGridProvider:Landroidx/leanback/widget/Grid$Provider;
    ...
    :cond_7
    invoke-direct {p0}, initScrollController()V

    invoke-direct {p0}, updateSecondaryScrollLimits()V

    iget-object v0, p0, mGrid:Landroidx/leanback/widget/Grid;

    iget v1, p0, mSpacingPrimary:I
...
.method private leaveContext()V
    ...
    iput-object v0, p0, mRecycler:Landroidx/recyclerview/widget/RecyclerView$Recycler;

    iput-object v0, p0, mState:Landroidx/recyclerview/widget/RecyclerView$State;

    const/4 v0, 0x0

    iput v0, p0, mPositionDeltaInPreLayout:I

    iput v0, p0, mExtraLayoutSpaceInPreLayout:I
...
.method private measureScrapChild(III[I)V
    ...
    sget-object v1, sTempRect:Landroid/graphics/Rect;
    ...
    sget-object v2, sTempRect:Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, p1}, getDecoratedMeasuredWidthWithMargin(Landroid/view/View;)I
    ...
    invoke-virtual {p0, p1}, getDecoratedMeasuredHeightWithMargin(Landroid/view/View;)I
...
.method private processPendingMovement(Z)V
    ...
    invoke-virtual {p0}, hasCreatedLastItem()Z
    ...
    :cond_0
    invoke-virtual {p0}, hasCreatedFirstItem()Z
    ...
    :cond_1
    iget-object v0, p0, mPendingMoveSmoothScroller:Landroidx/leanback/widget/GridLayoutManager$PendingMoveSmoothScroller;
    ...
    iput v3, p0, mFocusPositionOffset:I

    invoke-virtual {p0, v0}, startSmoothScroll(Landroidx/recyclerview/widget/RecyclerView$SmoothScroller;)V
...
.method private processRowSizeSecondary(Z)Z
    ...
    iget v1, v0, mFixedRowSizeSecondary:I

    const/4 v2, 0x0

    if-nez v1, :cond_15

    iget-object v1, v0, mRowSizeSecondary:[I
    ...
    :cond_0
    iget-object v1, v0, mGrid:Landroidx/leanback/widget/Grid;
    ...
    iget v14, v0, mPositionDeltaInPreLayout:I
    ...
    invoke-virtual {v0, v14}, measureChild(Landroid/view/View;)V

    :cond_5
    iget v15, v0, mOrientation:I

    if-nez v15, :cond_6

    invoke-virtual {v0, v14}, getDecoratedMeasuredHeightWithMargin(Landroid/view/View;)I
    ...
    :cond_6
    invoke-virtual {v0, v14}, getDecoratedMeasuredWidthWithMargin(Landroid/view/View;)I
    ...
    :cond_9
    iget-object v8, v0, mState:Landroidx/recyclerview/widget/RecyclerView$State;

    invoke-virtual {v8}, Landroidx/recyclerview/widget/RecyclerView$State;->getItemCount()I

    move-result v8

    iget-object v9, v0, mBaseGridView:Landroidx/leanback/widget/BaseGridView;
    ...
    iget-object v12, v0, mBaseGridView:Landroidx/leanback/widget/BaseGridView;
    ...
    iget-object v13, v0, mBaseGridView:Landroidx/leanback/widget/BaseGridView;
    ...
    iget-object v12, v0, mMeasuredDimension:[I

    invoke-direct {v0, v9, v7, v8, v12}, measureScrapChild(III[I)V

    iget v7, v0, mOrientation:I

    if-nez v7, :cond_f

    iget-object v7, v0, mMeasuredDimension:[I
    ...
    :cond_12
    iget-object v8, v0, mRowSizeSecondary:[I
...
.method private removeInvisibleViewsAtEnd()V
    ...
    iget p0, p0, mExtraLayoutSpace:I
...
.method private saveContext(Landroidx/recyclerview/widget/RecyclerView$Recycler;Landroidx/recyclerview/widget/RecyclerView$State;)V
    ...
    :cond_1
    iput-object p1, p0, mRecycler:Landroidx/recyclerview/widget/RecyclerView$Recycler;

    iput-object p2, p0, mState:Landroidx/recyclerview/widget/RecyclerView$State;

    const/4 p1, 0x0

    iput p1, p0, mPositionDeltaInPreLayout:I

    iput p1, p0, mExtraLayoutSpaceInPreLayout:I
...
.method private scrollDirectionPrimary(I)I
    ...
    invoke-direct {p0, v1}, offsetChildrenPrimary(I)V
    ...
    :goto_1
    invoke-direct {p0}, prependVisibleItems()V
    ...
    :goto_4
    invoke-direct {p0}, removeInvisibleViewsAtEnd()V

    goto :goto_5

    :cond_8
    invoke-direct {p0}, removeInvisibleViewsAtFront()V
    ...
    invoke-direct {p0}, updateRowSecondarySizeRefresh()V
...
.method private scrollDirectionSecondary(I)I
    ...
    invoke-direct {p0, v0}, offsetChildrenSecondary(I)V

    iget v0, p0, mScrollOffsetSecondary:I
    ...
    iget-object p0, p0, mBaseGridView:Landroidx/leanback/widget/BaseGridView;
...
.method private scrollGrid(IIZ)V
    ...
    invoke-direct {p0, p1}, scrollDirectionPrimary(I)I

    invoke-direct {p0, p2}, scrollDirectionSecondary(I)I
    ...
    :cond_2
    iget-object p3, p0, mBaseGridView:Landroidx/leanback/widget/BaseGridView;

    invoke-virtual {p3, p1, p2}, Landroidx/recyclerview/widget/RecyclerView;->scrollBy(II)V

    invoke-virtual {p0}, dispatchChildSelectedAndPositioned()V
...
.method private scrollToView(Landroid/view/View;Landroid/view/View;Z)V
    ...
    invoke-direct/range {v0 .. v5}, scrollToView(Landroid/view/View;Landroid/view/View;ZII)V
...
.method private scrollToView(Landroid/view/View;Landroid/view/View;ZII)V
    ...
    invoke-virtual {p0, p1, p2}, getSubPositionByView(Landroid/view/View;Landroid/view/View;)I
    ...
    iget v2, p0, mSubFocusPosition:I
    ...
    iput v1, p0, mSubFocusPosition:I

    iput v4, p0, mFocusPositionOffset:I
    ...
    invoke-virtual {p0}, dispatchChildSelected()V
    ...
    :cond_6
    sget-object v0, sTwoInts:[I

    invoke-virtual {p0, p1, p2, v0}, getScrollPosition(Landroid/view/View;Landroid/view/View;[I)Z
    ...
    invoke-direct {p0, p2, p1, p3}, scrollGrid(IIZ)V
...
.method private updateChildAlignments(Landroid/view/View;)V
    ...
    iget-object v1, p0, mItemAlignment:Landroidx/leanback/widget/ItemAlignment;
    ...
    iget-object p0, p0, mItemAlignment:Landroidx/leanback/widget/ItemAlignment;
...
.method private updateRowSecondarySizeRefresh()V
    ...
    invoke-direct {p0, v1}, processRowSizeSecondary(Z)Z
    ...
    invoke-direct {p0}, forceRequestLayout()V
...
.method private updateSecondaryScrollLimits()V
    ...
    iget v2, p0, mScrollOffsetSecondary:I

    sub-int/2addr v1, v2

    invoke-direct {p0}, getSizeSecondary()I
...
.method public collectAdjacentPrefetchPositions(IILandroidx/recyclerview/widget/RecyclerView$State;Landroidx/recyclerview/widget/RecyclerView$LayoutManager$LayoutPrefetchRegistry;)V
    ...
    :try_start_0
    invoke-direct {p0, v0, p3}, saveContext(Landroidx/recyclerview/widget/RecyclerView$Recycler;Landroidx/recyclerview/widget/RecyclerView$State;)V

    iget p3, p0, mOrientation:I
    ...
    iget p2, p0, mExtraLayoutSpace:I
    ...
    :cond_2
    iget p2, p0, mSizePrimary:I

    iget p3, p0, mExtraLayoutSpace:I

    add-int/2addr p2, p3

    :goto_1
    iget-object p3, p0, mGrid:Landroidx/leanback/widget/Grid;
    ...
    invoke-direct {p0}, leaveContext()V
...
.method dispatchChildSelected()V
    ...
    iget-object v0, p0, mChildSelectedListener:Landroidx/leanback/widget/OnChildSelectedListener;

    if-nez v0, :cond_0

    invoke-virtual {p0}, hasOnChildViewHolderSelectedListener()Z
    ...
    iget-object v1, p0, mBaseGridView:Landroidx/leanback/widget/BaseGridView;
    ...
    iget-object v3, p0, mChildSelectedListener:Landroidx/leanback/widget/OnChildSelectedListener;

    if-eqz v3, :cond_3

    iget-object v4, p0, mBaseGridView:Landroidx/leanback/widget/BaseGridView;

    iget v6, p0, mFocusPosition:I
    ...
    :cond_3
    iget-object v2, p0, mBaseGridView:Landroidx/leanback/widget/BaseGridView;

    iget v3, p0, mFocusPosition:I

    iget v4, p0, mSubFocusPosition:I

    invoke-virtual {p0, v2, v1, v3, v4}, fireOnChildViewHolderSelected(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;II)V

    goto :goto_2

    :cond_4
    iget-object v5, p0, mChildSelectedListener:Landroidx/leanback/widget/OnChildSelectedListener;

    if-eqz v5, :cond_5

    iget-object v6, p0, mBaseGridView:Landroidx/leanback/widget/BaseGridView;
    ...
    :cond_5
    iget-object v3, p0, mBaseGridView:Landroidx/leanback/widget/BaseGridView;

    invoke-virtual {p0, v3, v1, v2, v0}, fireOnChildViewHolderSelected(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;II)V
...
.method dispatchChildSelectedAndPositioned()V
    ...
    iget v3, p0, mSubFocusPosition:I

    invoke-virtual {p0, v1, v0, v2, v3}, fireOnChildViewHolderSelectedAndPositioned(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;II)V

    goto :goto_1

    :cond_2
    iget-object v4, p0, mChildSelectedListener:Landroidx/leanback/widget/OnChildSelectedListener;

    if-eqz v4, :cond_3

    iget-object v5, p0, mBaseGridView:Landroidx/leanback/widget/BaseGridView;
    ...
    invoke-virtual {p0, v0, v1, v2, v3}, fireOnChildViewHolderSelectedAndPositioned(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;II)V
...
.method fillScrapViewsInPostLayout()V
    ...
    :cond_0
    iget-object v2, p0, mDisappearingPositions:[I
    ...
    iput-object v2, p0, mDisappearingPositions:[I
    ...
    iget-object v6, p0, mDisappearingPositions:[I
    ...
    iget-object v0, p0, mDisappearingPositions:[I

    invoke-static {v0, v2, v4}, Ljava/util/Arrays;->sort([III)V

    iget-object v0, p0, mGrid:Landroidx/leanback/widget/Grid;

    iget-object v1, p0, mDisappearingPositions:[I

    iget-object v2, p0, mPositionToRowInPostLayout:Landroid/util/SparseIntArray;

    invoke-virtual {v0, v1, v4, v2}, Landroidx/leanback/widget/Grid;->fillDisappearingItems([IILandroid/util/SparseIntArray;)V

    :cond_7
    iget-object p0, p0, mPositionToRowInPostLayout:Landroid/util/SparseIntArray;
...
.method fireOnChildViewHolderSelected(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;II)V
    ...
    iget-object v0, p0, mChildViewHolderSelectedListeners:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, mChildViewHolderSelectedListeners:Ljava/util/ArrayList;
...
.method getFacet(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    iget-object p0, p0, mFacetProviderAdapter:Landroidx/leanback/widget/FacetProviderAdapter;
...
.method getRowStartSecondary(I)I
    ...
    iget v3, p0, mSpacingSecondary:I
    ...
    invoke-direct {p0, v1}, getRowSizeSecondary(I)I
...
.method getScrollPosition(Landroid/view/View;Landroid/view/View;[I)Z
    ...
    iget v0, p0, mFocusScrollStrategy:I
    ...
    invoke-direct {p0, p1, p2, p3}, getAlignedPosition(Landroid/view/View;Landroid/view/View;[I)Z
    ...
    :cond_0
    invoke-direct {p0, p1, p3}, getNoneAlignedPosition(Landroid/view/View;[I)Z
...
.method getViewMax(Landroid/view/View;)I
    ...
    iget-object p0, p0, mOrientationHelper:Landroidx/recyclerview/widget/OrientationHelper;
...
.method getViewPrimarySize(Landroid/view/View;)I
    ...
    sget-object v0, sTempRect:Landroid/graphics/Rect;

    invoke-virtual {p0, p1, v0}, getDecoratedBoundsWithMargins(Landroid/view/View;Landroid/graphics/Rect;)V

    iget p0, p0, mOrientation:I

    if-nez p0, :cond_0

    sget-object p0, sTempRect:Landroid/graphics/Rect;
...
.method gridOnRequestFocusInDescendants(Landroidx/recyclerview/widget/RecyclerView;ILandroid/graphics/Rect;)Z
    ...
    invoke-direct {p0, p1, p2, p3}, gridOnRequestFocusInDescendantsAligned(Landroidx/recyclerview/widget/RecyclerView;ILandroid/graphics/Rect;)Z
    ...
    :cond_0
    invoke-direct {p0, p1, p2, p3}, gridOnRequestFocusInDescendantsUnaligned(Landroidx/recyclerview/widget/RecyclerView;ILandroid/graphics/Rect;)Z
...
.method hasOnChildViewHolderSelectedListener()Z
    ...
    iget-object p0, p0, mChildViewHolderSelectedListeners:Ljava/util/ArrayList;
...
.method layoutChild(ILandroid/view/View;III)V
    ...
    invoke-virtual {p0, p2}, getDecoratedMeasuredHeightWithMargin(Landroid/view/View;)I
    ...
    :cond_0
    invoke-virtual {p0, p2}, getDecoratedMeasuredWidthWithMargin(Landroid/view/View;)I

    move-result v0

    :goto_0
    iget v1, p0, mFixedRowSizeSecondary:I
    ...
    :cond_6
    invoke-direct {p0, p1}, getRowSizeSecondary(I)I
    ...
    invoke-direct {p0, p2}, updateChildAlignments(Landroid/view/View;)V
...
.method measureChild(Landroid/view/View;)V
    ...
    iget v2, p0, mRowSizeSecondaryRequested:I
    ...
    :cond_0
    iget v2, p0, mFixedRowSizeSecondary:I
...
.method public onAdapterChanged(Landroidx/recyclerview/widget/RecyclerView$Adapter;Landroidx/recyclerview/widget/RecyclerView$Adapter;)V
    ...
    invoke-direct {p0}, discardLayoutInfo()V
    ...
    iget-object v0, p0, mChildrenStates:Landroidx/leanback/widget/ViewsStateBundle;
    ...
    iput-object v0, p0, mFacetProviderAdapter:Landroidx/leanback/widget/FacetProviderAdapter;
...
.method public onAddFocusables(Landroidx/recyclerview/widget/RecyclerView;Ljava/util/ArrayList;II)Z
    ...
    iget-object v4, v0, mPendingMoveSmoothScroller:Landroidx/leanback/widget/GridLayoutManager$PendingMoveSmoothScroller;
    ...
    :cond_1
    invoke-direct {v0, v2}, getMovement(I)I
    ...
    invoke-direct {v0, v7}, findImmediateChildIndex(Landroid/view/View;)I

    move-result v7

    invoke-direct {v0, v7}, getAdapterPositionByIndex(I)I
    ...
    :cond_3
    iget-object v11, v0, mGrid:Landroidx/leanback/widget/Grid;
    ...
    :cond_5
    iget-object v13, v0, mGrid:Landroidx/leanback/widget/Grid;
    ...
    iget-object v12, v0, mGrid:Landroidx/leanback/widget/Grid;
    ...
    iget v6, v0, mFocusScrollStrategy:I

    if-eqz v6, :cond_1f

    iget-object v6, v0, mWindowAlignment:Landroidx/leanback/widget/WindowAlignment;
    ...
    iget-object v7, v0, mWindowAlignment:Landroidx/leanback/widget/WindowAlignment;
    ...
    invoke-virtual {v0, v10}, getViewMin(Landroid/view/View;)I

    move-result v11

    if-lt v11, v6, :cond_1c

    invoke-virtual {v0, v10}, getViewMax(Landroid/view/View;)I
...
.method onChildRecycled(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
    ...
    iget-object p0, p0, mChildrenStates:Landroidx/leanback/widget/ViewsStateBundle;
...
.method public onInitializeAccessibilityNodeInfo(Landroidx/recyclerview/widget/RecyclerView$Recycler;Landroidx/recyclerview/widget/RecyclerView$State;Landroidx/core/view/accessibility/AccessibilityNodeInfoCompat;)V
    ...
    invoke-direct {p0, p1, p2}, saveContext(Landroidx/recyclerview/widget/RecyclerView$Recycler;Landroidx/recyclerview/widget/RecyclerView$State;)V
    ...
    invoke-virtual {p0, v2}, isItemFullyVisible(I)Z
    ...
    invoke-virtual {p0, v0}, isItemFullyVisible(I)Z
    ...
    :cond_8
    invoke-virtual {p0, p1, p2}, getRowCountForAccessibility(Landroidx/recyclerview/widget/RecyclerView$Recycler;Landroidx/recyclerview/widget/RecyclerView$State;)I

    move-result v0

    invoke-virtual {p0, p1, p2}, getColumnCountForAccessibility(Landroidx/recyclerview/widget/RecyclerView$Recycler;Landroidx/recyclerview/widget/RecyclerView$State;)I
...
.method public onInitializeAccessibilityNodeInfoForItem(Landroidx/recyclerview/widget/RecyclerView$Recycler;Landroidx/recyclerview/widget/RecyclerView$State;Landroid/view/View;Landroidx/core/view/accessibility/AccessibilityNodeInfoCompat;)V
    ...
    iget-object p2, p0, mGrid:Landroidx/leanback/widget/Grid;
...
.method public onInterceptFocusSearch(Landroid/view/View;I)Landroid/view/View;
    ...
    :cond_2
    :goto_0
    invoke-virtual {p0}, canScrollVertically()Z
    ...
    :cond_4
    invoke-virtual {p0}, canScrollHorizontally()Z
    ...
    :cond_a
    invoke-direct {p0, p2}, getMovement(I)I
    ...
    invoke-direct {p0, v4}, processPendingMovement(Z)V
    ...
    invoke-direct {p0, v2}, processPendingMovement(Z)V
...
.method public onItemsAdded(Landroidx/recyclerview/widget/RecyclerView;II)V
    ...
    iget-object p1, p0, mGrid:Landroidx/leanback/widget/Grid;
    ...
    iget p1, p0, mFocusPositionOffset:I
    ...
    iput p1, p0, mFocusPositionOffset:I
...
.method public onItemsMoved(Landroidx/recyclerview/widget/RecyclerView;III)V
    ...
    iget v0, p0, mFocusPositionOffset:I
...
.method public onItemsUpdated(Landroidx/recyclerview/widget/RecyclerView;II)V
    ...
    iget-object p1, p0, mChildrenStates:Landroidx/leanback/widget/ViewsStateBundle;
...
.method public onLayoutChildren(Landroidx/recyclerview/widget/RecyclerView$Recycler;Landroidx/recyclerview/widget/RecyclerView$State;)V
    ...
    invoke-virtual {p0, p1}, removeAndRecycleAllViews(Landroidx/recyclerview/widget/RecyclerView$Recycler;)V
    ...
    invoke-virtual {p0}, updatePositionDeltaInPreLayout()V
    ...
    :cond_6
    invoke-virtual {p0, v4}, getViewMin(Landroid/view/View;)I
    ...
    invoke-virtual {p0, v4}, getViewMax(Landroid/view/View;)I
    ...
    invoke-virtual {p0}, updatePositionToRowMapInPostLayout()V
    ...
    iget p1, p0, mFocusScrollStrategy:I
    ...
    iget v4, p0, mFocusPositionOffset:I

    if-eq v4, v0, :cond_e

    add-int/2addr p1, v4

    iput p1, p0, mFocusPosition:I

    iput v2, p0, mSubFocusPosition:I

    :cond_e
    iput v2, p0, mFocusPositionOffset:I
    ...
    :goto_2
    iget-object v7, p0, mGrid:Landroidx/leanback/widget/Grid;
    ...
    invoke-direct {p0}, fastRelayout()V
    ...
    iget-object v3, p0, mGrid:Landroidx/leanback/widget/Grid;
    ...
    invoke-direct {p0, v5, v1, v6, v7}, focusToViewInLayout(ZZII)V
    ...
    invoke-virtual {p0}, fillScrapViewsInPostLayout()V
    ...
    iget p2, p0, mFocusPosition:I

    if-ne p2, v0, :cond_19

    iget v0, p0, mSubFocusPosition:I
    ...
    invoke-virtual {p0}, getSlideOutDistance()I
...
.method public onLayoutCompleted(Landroidx/recyclerview/widget/RecyclerView$State;)V
    ...
    iget-object p0, p0, mLayoutCompleteListener:Landroidx/leanback/widget/GridLayoutManager$OnLayoutCompleteListener;
...
.method public onMeasure(Landroidx/recyclerview/widget/RecyclerView$Recycler;Landroidx/recyclerview/widget/RecyclerView$State;II)V
    ...
    iput p2, p0, mMaxSizeSecondary:I

    iget v0, p0, mRowSizeSecondaryRequested:I
    ...
    iget p2, p0, mNumRowsRequested:I
    ...
    :cond_1
    iput p2, p0, mNumRows:I

    const/4 p2, 0x0

    iput p2, p0, mFixedRowSizeSecondary:I

    iget-object p2, p0, mRowSizeSecondary:[I
    ...
    :cond_2
    iget p2, p0, mNumRows:I

    new-array p2, p2, [I

    iput-object p2, p0, mRowSizeSecondary:[I

    :cond_3
    iget-object p2, p0, mState:Landroidx/recyclerview/widget/RecyclerView$State;
    ...
    :cond_4
    invoke-direct {p0, v5}, processRowSizeSecondary(Z)Z
    ...
    iget p2, p0, mMaxSizeSecondary:I
    ...
    iget p3, p0, mMaxSizeSecondary:I
    ...
    :cond_b
    iput v0, p0, mFixedRowSizeSecondary:I
    ...
    iget p2, p0, mFixedRowSizeSecondary:I

    iget p3, p0, mNumRows:I

    mul-int/2addr p2, p3

    iget v0, p0, mSpacingSecondary:I
    ...
    :cond_d
    :goto_2
    iget v0, p0, mNumRowsRequested:I
    ...
    iget v1, p0, mSpacingSecondary:I
    ...
    iput v2, p0, mNumRows:I

    goto :goto_3

    :cond_f
    iget v1, p0, mRowSizeSecondaryRequested:I
    ...
    iput v1, p0, mFixedRowSizeSecondary:I

    :goto_3
    if-ne p3, v4, :cond_11

    iget p3, p0, mFixedRowSizeSecondary:I
...
.method public onRequestChildFocus(Landroidx/recyclerview/widget/RecyclerView;Landroid/view/View;Landroid/view/View;)Z
    ...
    :cond_0
    invoke-direct {p0, p2}, getAdapterPositionByView(Landroid/view/View;)I
    ...
    invoke-direct {p0, p2, p3, v0}, scrollToView(Landroid/view/View;Landroid/view/View;Z)V
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-virtual {p0}, getSelection()I

    move-result v1

    iput v1, v0, Landroidx/leanback/widget/GridLayoutManager$SavedState;->index:I

    iget-object v1, p0, mChildrenStates:Landroidx/leanback/widget/ViewsStateBundle;
    ...
    invoke-direct {p0, v4}, getAdapterPositionByView(Landroid/view/View;)I
    ...
    iget-object v6, p0, mChildrenStates:Landroidx/leanback/widget/ViewsStateBundle;
...
.method public performAccessibilityAction(Landroidx/recyclerview/widget/RecyclerView$Recycler;Landroidx/recyclerview/widget/RecyclerView$State;ILandroid/os/Bundle;)Z
    ...
    invoke-virtual {p0}, isScrollEnabled()Z
    ...
    :cond_8
    invoke-direct {p0, p2}, processPendingMovement(Z)V

    const/4 p1, -0x1

    invoke-virtual {p0, p2, p1}, processSelectionMoves(ZI)I

    goto :goto_4

    :cond_9
    invoke-direct {p0, v0}, processPendingMovement(Z)V

    invoke-virtual {p0, p2, v0}, processSelectionMoves(ZI)I
...
.method processSelectionMoves(ZI)I
    ...
    invoke-virtual {p0, v8}, canScrollTo(Landroid/view/View;)Z
    ...
    :cond_3
    invoke-direct {p0, v7}, getAdapterPositionByIndex(I)I

    move-result v7

    iget-object v9, p0, mGrid:Landroidx/leanback/widget/Grid;
    ...
    iput v5, p0, mSubFocusPosition:I
    ...
    invoke-virtual {p0, v3, p1}, scrollToView(Landroid/view/View;Z)V
...
.method public scrollHorizontallyBy(ILandroidx/recyclerview/widget/RecyclerView$Recycler;Landroidx/recyclerview/widget/RecyclerView$State;)I
    ...
    invoke-virtual {p0}, hasDoneFirstLayout()Z
    ...
    :cond_0
    invoke-direct {p0, p2, p3}, saveContext(Landroidx/recyclerview/widget/RecyclerView$Recycler;Landroidx/recyclerview/widget/RecyclerView$State;)V
    ...
    :cond_1
    invoke-direct {p0, p1}, scrollDirectionSecondary(I)I
...
.method public scrollToPosition(I)V
    ...
    invoke-virtual {p0, p1, v0, v0, v0}, setSelection(IIZI)V
...
.method scrollToSelection(IIZI)V
    ...
    iput p4, p0, mPrimaryScrollExtra:I
    ...
    invoke-direct {p0, p4}, getAdapterPositionByView(Landroid/view/View;)I
    ...
    invoke-virtual {p0, p4, p3}, scrollToView(Landroid/view/View;Z)V
    ...
    iput p2, p0, mSubFocusPosition:I
    ...
    :cond_3
    invoke-virtual {p0, p1}, startPositionSmoothScroller(I)I
    ...
    invoke-virtual {p0}, skipSmoothScrollerOnStopInternal()V
...
.method scrollToView(Landroid/view/View;Z)V
    ...
    :goto_0
    invoke-direct {p0, p1, v0, p2}, scrollToView(Landroid/view/View;Landroid/view/View;Z)V
...
.method scrollToView(Landroid/view/View;ZII)V
    ...
    invoke-direct/range {v1 .. v6}, scrollToView(Landroid/view/View;Landroid/view/View;ZII)V
...
.method public setHorizontalSpacing(I)V
    ...
    iput p1, p0, mHorizontalSpacing:I

    iput p1, p0, mSpacingPrimary:I
    ...
    iput p1, p0, mSpacingSecondary:I
...
.method public setNumRows(I)V
    ...
    iput p1, p0, mNumRowsRequested:I
...
.method public setOnChildViewHolderSelectedListener(Landroidx/leanback/widget/OnChildViewHolderSelectedListener;)V
    ...
    iput-object p1, p0, mChildViewHolderSelectedListeners:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, mChildViewHolderSelectedListeners:Ljava/util/ArrayList;
...
.method public setOrientation(I)V
    ...
    iput-object v0, p0, mOrientationHelper:Landroidx/recyclerview/widget/OrientationHelper;

    iget-object v0, p0, mWindowAlignment:Landroidx/leanback/widget/WindowAlignment;

    invoke-virtual {v0, p1}, Landroidx/leanback/widget/WindowAlignment;->setOrientation(I)V

    iget-object v0, p0, mItemAlignment:Landroidx/leanback/widget/ItemAlignment;
...
.method public setRowHeight(I)V
    ...
    :cond_1
    :goto_0
    iput p1, p0, mRowSizeSecondaryRequested:I
...
.method public setSelection(II)V
    ...
    invoke-virtual {p0, p1, v0, v0, p2}, setSelection(IIZI)V
...
.method public setSelection(IIZI)V
    ...
    iget v0, p0, mPrimaryScrollExtra:I

    if-eq p4, v0, :cond_2

    :cond_1
    invoke-virtual {p0, p1, p2, p3, p4}, scrollToSelection(IIZI)V
...
.method public setSelectionSmooth(I)V
    ...
    invoke-virtual {p0, p1, v0, v1, v0}, setSelection(IIZI)V
...
.method skipSmoothScrollerOnStopInternal()V
    ...
    iget-object p0, p0, mCurrentSmoothScroller:Landroidx/leanback/widget/GridLayoutManager$GridLinearSmoothScroller;
...
.method public startSmoothScroll(Landroidx/recyclerview/widget/RecyclerView$SmoothScroller;)V
    ...
    iput-object p1, p0, mCurrentSmoothScroller:Landroidx/leanback/widget/GridLayoutManager$GridLinearSmoothScroller;

    iget-object p1, p0, mCurrentSmoothScroller:Landroidx/leanback/widget/GridLayoutManager$GridLinearSmoothScroller;
    ...
    iput-object p1, p0, mPendingMoveSmoothScroller:Landroidx/leanback/widget/GridLayoutManager$PendingMoveSmoothScroller;

    goto :goto_0

    :cond_0
    iput-object v1, p0, mPendingMoveSmoothScroller:Landroidx/leanback/widget/GridLayoutManager$PendingMoveSmoothScroller;

    goto :goto_0

    :cond_1
    iput-object v1, p0, mCurrentSmoothScroller:Landroidx/leanback/widget/GridLayoutManager$GridLinearSmoothScroller;
...
.method updatePositionDeltaInPreLayout()V
    ...
    iput v1, p0, mPositionDeltaInPreLayout:I
...
.method updatePositionToRowMapInPostLayout()V
    ...
    iget-object v0, p0, mPositionToRowInPostLayout:Landroid/util/SparseIntArray;
    ...
    iget-object v4, p0, mPositionToRowInPostLayout:Landroid/util/SparseIntArray;
...
.method updateScrollLimits()V
    ...
    invoke-direct {p0, v0}, getViewCenter(Landroid/view/View;)I
    ...
    invoke-direct {p0, v1}, getViewCenter(Landroid/view/View;)I
