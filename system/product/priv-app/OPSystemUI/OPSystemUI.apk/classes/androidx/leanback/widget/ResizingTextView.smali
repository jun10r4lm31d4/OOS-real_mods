...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-boolean v0, p0, mIsResized:Z

    iput-boolean v0, p0, mDefaultsInitialized:Z
    ...
    iput p2, p0, mTriggerConditions:I
    ...
    iput-boolean p2, p0, mMaintainLineSpacing:Z
    ...
    iput p2, p0, mResizedPaddingAdjustmentTop:I
    ...
    iput p2, p0, mResizedPaddingAdjustmentBottom:I
    :try_end_0
...
.method protected onMeasure(II)V
    ...
    iget-boolean v0, p0, mDefaultsInitialized:Z
    ...
    iput v0, p0, mDefaultLineSpacingExtra:F

    invoke-virtual {p0}, Landroid/widget/TextView;->getPaddingTop()I

    move-result v0

    iput v0, p0, mDefaultPaddingTop:I

    invoke-virtual {p0}, Landroid/widget/TextView;->getPaddingBottom()I

    move-result v0

    iput v0, p0, mDefaultPaddingBottom:I

    iput-boolean v1, p0, mDefaultsInitialized:Z

    :cond_0
    iget v0, p0, mDefaultTextSize:I
    ...
    iget v0, p0, mDefaultLineSpacingExtra:F
    ...
    iget v0, p0, mDefaultPaddingTop:I

    iget v3, p0, mDefaultPaddingBottom:I

    invoke-direct {p0, v0, v3}, setPaddingTopAndBottom(II)V
    ...
    iget v3, p0, mTriggerConditions:I
    ...
    :cond_2
    iget v3, p0, mDefaultLineSpacingExtra:F

    iget v4, p0, mDefaultTextSize:I

    int-to-float v4, v4

    add-float/2addr v3, v4

    iget v4, p0, mResizedTextSize:I

    int-to-float v4, v4

    sub-float/2addr v3, v4

    iget-boolean v4, p0, mMaintainLineSpacing:Z
    ...
    :cond_3
    iget v3, p0, mDefaultPaddingTop:I

    iget v4, p0, mResizedPaddingAdjustmentTop:I

    add-int/2addr v3, v4

    iget v4, p0, mDefaultPaddingBottom:I

    iget v5, p0, mResizedPaddingAdjustmentBottom:I
    ...
    :cond_4
    invoke-direct {p0, v3, v4}, setPaddingTopAndBottom(II)V
    ...
    :cond_6
    iget-boolean v3, p0, mMaintainLineSpacing:Z
    ...
    iget v4, p0, mDefaultLineSpacingExtra:F
    ...
    iget v4, p0, mDefaultPaddingTop:I
    ...
    :cond_9
    :goto_1
    iget v2, p0, mDefaultPaddingTop:I

    iget v3, p0, mDefaultPaddingBottom:I

    invoke-direct {p0, v2, v3}, setPaddingTopAndBottom(II)V
