...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p3, p0, mDateFormat:Ljava/text/DateFormat;

    invoke-direct {p0}, updateCurrentLocale()V
    ...
    iget-object p3, p0, mTempDate:Ljava/util/Calendar;
    ...
    invoke-direct {p0, p2, p3}, parseDate(Ljava/lang/String;Ljava/util/Calendar;)Z

    move-result p2

    if-nez p2, :cond_2

    iget-object p2, p0, mTempDate:Ljava/util/Calendar;
    ...
    invoke-direct {p0, v0, p2}, parseDate(Ljava/lang/String;Ljava/util/Calendar;)Z
    ...
    :cond_5
    invoke-virtual {p0, v1}, setDatePickerFormat(Ljava/lang/String;)V
...
.method private isNewDate(III)Z
    ...
    iget-object p1, p0, mCurrentDate:Ljava/util/Calendar;
    ...
    iget-object p0, p0, mCurrentDate:Ljava/util/Calendar;
...
.method private setDate(III)V
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, setDate(IIIZ)V
...
.method private updateCurrentLocale()V
    ...
    iput-object v0, p0, mConstant:Landroidx/leanback/widget/picker/PickerUtility$DateConstant;

    iget-object v0, p0, mTempDate:Ljava/util/Calendar;

    iget-object v1, p0, mConstant:Landroidx/leanback/widget/picker/PickerUtility$DateConstant;
    ...
    iget-object v0, p0, mMonthColumn:Landroidx/leanback/widget/picker/PickerColumn;
    ...
    iget v0, p0, mColMonthIndex:I

    iget-object v1, p0, mMonthColumn:Landroidx/leanback/widget/picker/PickerColumn;
...
.method extractSeparators()Ljava/util/List;
    ...
    iget-object v0, p0, mDatePickerFormat:Ljava/lang/String;

    invoke-virtual {p0, v0}, getBestYearMonthDayPattern(Ljava/lang/String;)Ljava/lang/String;
...
.method getBestYearMonthDayPattern(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object p0, p0, mConstant:Landroidx/leanback/widget/picker/PickerUtility$DateConstant;
...
.method public final onColumnValueChanged(II)V
    ...
    invoke-direct {p0, p1, p2, v0}, setDate(III)V
...
.method public setDate(IIIZ)V
    ...
    :cond_2
    :goto_0
    invoke-direct {p0, p4}, updateSpinners(Z)V
...
.method public setDatePickerFormat(Ljava/lang/String;)V
    ...
    :cond_1
    iput-object p1, p0, mDatePickerFormat:Ljava/lang/String;
    ...
    iput-object v0, p0, mDayColumn:Landroidx/leanback/widget/picker/PickerColumn;

    iput-object v0, p0, mMonthColumn:Landroidx/leanback/widget/picker/PickerColumn;

    iput-object v0, p0, mYearColumn:Landroidx/leanback/widget/picker/PickerColumn;

    const/4 v0, -0x1

    iput v0, p0, mColMonthIndex:I

    iput v0, p0, mColDayIndex:I

    iput v0, p0, mColYearIndex:I
    ...
    iget-object v3, p0, mYearColumn:Landroidx/leanback/widget/picker/PickerColumn;
    ...
    iput-object v3, p0, mYearColumn:Landroidx/leanback/widget/picker/PickerColumn;

    invoke-virtual {v0, v3}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iput v2, p0, mColYearIndex:I
    ...
    :cond_4
    iget-object v3, p0, mMonthColumn:Landroidx/leanback/widget/picker/PickerColumn;
    ...
    iput-object v3, p0, mMonthColumn:Landroidx/leanback/widget/picker/PickerColumn;

    invoke-virtual {v0, v3}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v3, p0, mMonthColumn:Landroidx/leanback/widget/picker/PickerColumn;

    iget-object v4, p0, mConstant:Landroidx/leanback/widget/picker/PickerUtility$DateConstant;
    ...
    :cond_6
    iget-object v3, p0, mDayColumn:Landroidx/leanback/widget/picker/PickerColumn;
    ...
    iput-object v3, p0, mDayColumn:Landroidx/leanback/widget/picker/PickerColumn;
    ...
    invoke-direct {p0, v1}, updateSpinners(Z)V
...
.method updateSpinnersImpl(Z)V
    ...
    invoke-static {v7, v8}, updateMin(Landroidx/leanback/widget/picker/PickerColumn;I)Z
    ...
    :cond_1
    iget-object v8, p0, mCurrentDate:Ljava/util/Calendar;
    ...
    iget-object v9, p0, mMaxDate:Ljava/util/Calendar;

    invoke-virtual {v9, v6}, Ljava/util/Calendar;->get(I)I

    move-result v9

    invoke-static {v7, v9}, updateMax(Landroidx/leanback/widget/picker/PickerColumn;I)Z
    ...
    :cond_2
    iget-object v9, p0, mCurrentDate:Ljava/util/Calendar;
    ...
    iget-object v10, p0, mMinDate:Ljava/util/Calendar;
    ...
    iget-object v10, p0, mMaxDate:Ljava/util/Calendar;
