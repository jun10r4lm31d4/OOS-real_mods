...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p3, p0, mTempPaint:Landroid/graphics/Paint;

    new-instance p3, Landroid/graphics/Rect;

    invoke-direct {p3}, Landroid/graphics/Rect;-><init>()V

    iput-object p3, p0, mTempRect:Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, p1, p2}, initAttributes(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method private getTempBitmapHigh()Landroid/graphics/Bitmap;
    ...
    iget-object v0, p0, mTempBitmapHigh:Landroid/graphics/Bitmap;
    ...
    iget v1, p0, mHighFadeShaderLength:I
    ...
    :cond_0
    iget v0, p0, mHighFadeShaderLength:I
    ...
    iput-object v0, p0, mTempBitmapHigh:Landroid/graphics/Bitmap;

    :cond_1
    iget-object p0, p0, mTempBitmapHigh:Landroid/graphics/Bitmap;
...
.method private getTempBitmapLow()Landroid/graphics/Bitmap;
    ...
    iget-object v0, p0, mTempBitmapLow:Landroid/graphics/Bitmap;
    ...
    iget v1, p0, mLowFadeShaderLength:I
    ...
    :cond_0
    iget v0, p0, mLowFadeShaderLength:I
    ...
    iput-object v0, p0, mTempBitmapLow:Landroid/graphics/Bitmap;

    :cond_1
    iget-object p0, p0, mTempBitmapLow:Landroid/graphics/Bitmap;
...
.method private needsFadingHighEdge()Z
    ...
    iget-boolean v0, p0, mFadingHighEdge:Z
    ...
    iget v5, p0, mHighFadeShaderOffset:I
...
.method private needsFadingLowEdge()Z
    ...
    iget-boolean v0, p0, mFadingLowEdge:Z
    ...
    iget v5, p0, mLowFadeShaderOffset:I
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-direct/range {p0 .. p0}, needsFadingLowEdge()Z

    move-result v2

    invoke-direct/range {p0 .. p0}, needsFadingHighEdge()Z
    ...
    iput-object v4, v0, mTempBitmapLow:Landroid/graphics/Bitmap;

    :cond_0
    if-nez v3, :cond_1

    iput-object v4, v0, mTempBitmapHigh:Landroid/graphics/Bitmap;
    ...
    :cond_2
    iget-boolean v5, v0, mFadingLowEdge:Z
    ...
    iget v7, v0, mLowFadeShaderOffset:I

    sub-int/2addr v5, v7

    iget v7, v0, mLowFadeShaderLength:I
    ...
    :goto_0
    iget-boolean v7, v0, mFadingHighEdge:Z
    ...
    iget v8, v0, mHighFadeShaderOffset:I

    add-int/2addr v7, v8

    iget v8, v0, mHighFadeShaderLength:I
    ...
    iget-boolean v9, v0, mFadingLowEdge:Z

    if-eqz v9, :cond_5

    iget v9, v0, mLowFadeShaderLength:I
    ...
    iget-boolean v10, v0, mFadingHighEdge:Z

    if-eqz v10, :cond_6

    iget v10, v0, mHighFadeShaderLength:I
    ...
    iget v2, v0, mLowFadeShaderLength:I

    if-lez v2, :cond_7

    invoke-direct/range {p0 .. p0}, getTempBitmapLow()Landroid/graphics/Bitmap;
    ...
    iget v11, v0, mLowFadeShaderLength:I
    ...
    iget-object v10, v0, mTempPaint:Landroid/graphics/Paint;

    iget-object v12, v0, mLowFadeShader:Landroid/graphics/LinearGradient;
    ...
    iget v10, v0, mLowFadeShaderLength:I
    ...
    iget-object v12, v0, mTempPaint:Landroid/graphics/Paint;
    ...
    iget-object v10, v0, mTempRect:Landroid/graphics/Rect;

    iput v6, v10, Landroid/graphics/Rect;->left:I

    iget v12, v0, mLowFadeShaderLength:I
    ...
    iget v2, v0, mHighFadeShaderLength:I

    if-lez v2, :cond_8

    invoke-direct/range {p0 .. p0}, getTempBitmapHigh()Landroid/graphics/Bitmap;
    ...
    iget v5, v0, mHighFadeShaderLength:I
    ...
    iget-object v3, v0, mTempPaint:Landroid/graphics/Paint;

    iget-object v5, v0, mHighFadeShader:Landroid/graphics/LinearGradient;
    ...
    iget v3, v0, mHighFadeShaderLength:I
    ...
    iget-object v5, v0, mTempPaint:Landroid/graphics/Paint;
    ...
    iget v0, v0, mHighFadeShaderLength:I
...
.method protected initAttributes(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    :cond_0
    invoke-virtual {p0, v0}, setRowHeight(Landroid/content/res/TypedArray;)V
    ...
    invoke-virtual {p0, p1}, setNumRows(I)V

    invoke-virtual {v0}, Landroid/content/res/TypedArray;->recycle()V

    invoke-direct {p0}, updateLayerType()V

    new-instance p1, Landroid/graphics/Paint;

    invoke-direct {p1}, Landroid/graphics/Paint;-><init>()V

    iput-object p1, p0, mTempPaint:Landroid/graphics/Paint;
...
.method setRowHeight(Landroid/content/res/TypedArray;)V
    ...
    invoke-virtual {p0, p1}, setRowHeight(I)V
