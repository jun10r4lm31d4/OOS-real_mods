...
.method constructor <init>()V
    ...
    iput-object v0, p0, mLocations:Landroidx/collection/CircularArray;

    const/4 v0, -0x1

    iput v0, p0, mFirstIndex:I
...
.method private calculateOffsetAfterLastItem(I)I
    ...
    invoke-virtual {p0}, getLastIndex()I

    move-result v0

    :goto_0
    iget v1, p0, mFirstIndex:I

    const/4 v2, 0x1

    if-lt v0, v1, :cond_1

    invoke-virtual {p0, v0}, getLocation(I)Landroidx/leanback/widget/StaggeredGrid$Location;
...
.method protected final appendVisbleItemsWithCache(IZ)Z
    ...
    iget-object v1, v0, mLocations:Landroidx/collection/CircularArray;
    ...
    invoke-virtual {p0}, getFirstIndex()I
    ...
    invoke-virtual {p0, v6}, getLocation(I)Landroidx/leanback/widget/StaggeredGrid$Location;
    ...
    iget-object v8, v0, mLocations:Landroidx/collection/CircularArray;
    ...
    :cond_c
    :goto_3
    iget-object v0, v0, mLocations:Landroidx/collection/CircularArray;
...
.method protected final appendVisibleItemToRow(III)I
    ...
    iget-object v0, p0, mLocations:Landroidx/collection/CircularArray;
    ...
    invoke-direct {p0, p2}, calculateOffsetAfterLastItem(I)I
    ...
    iget-object v0, p0, mPendingItem:Ljava/lang/Object;

    if-eqz v0, :cond_4

    iget v1, p0, mPendingItemSize:I

    iput v1, v3, Landroidx/leanback/widget/StaggeredGrid$Location;->size:I

    const/4 v1, 0x0

    iput-object v1, p0, mPendingItem:Ljava/lang/Object;
...
.method protected final appendVisibleItems(IZ)Z
    ...
    :try_start_0
    invoke-virtual {p0, p1, p2}, appendVisbleItemsWithCache(IZ)Z
    ...
    :goto_0
    iput-object v0, p0, mPendingItem:Ljava/lang/Object;

    return p1

    :cond_2
    :try_start_1
    invoke-virtual {p0, p1, p2}, appendVisibleItemsWithoutCache(IZ)Z
...
.method public final getItemPositionsInRows(II)[Landroidx/collection/CircularIntArray;
    ...
    invoke-virtual {p0, p1}, getLocation(I)Landroidx/leanback/widget/StaggeredGrid$Location;
...
.method public final getLastIndex()I
    ...
    iget v0, p0, mFirstIndex:I

    iget-object p0, p0, mLocations:Landroidx/collection/CircularArray;
...
.method public invalidateItemsAfter(I)V
    ...
    iget-object p1, p0, mLocations:Landroidx/collection/CircularArray;
...
.method protected final prependVisbleItemsWithCache(IZ)Z
    ...
    invoke-virtual {p0, v4}, getLocation(I)Landroidx/leanback/widget/StaggeredGrid$Location;
    ...
    invoke-virtual {p0, v5}, getLocation(I)Landroidx/leanback/widget/StaggeredGrid$Location;
    ...
    iput v1, v0, mFirstIndex:I

    iget-object v1, v0, Landroidx/leanback/widget/Grid;->mTmpItem:[Ljava/lang/Object;

    aget-object v1, v1, v2

    iput-object v1, v0, mPendingItem:Ljava/lang/Object;

    iput v10, v0, mPendingItemSize:I
...
.method protected final prependVisibleItemToRow(III)I
    ...
    iget-object v5, p0, mLocations:Landroidx/collection/CircularArray;

    invoke-virtual {v5, v3}, Landroidx/collection/CircularArray;->addFirst(Ljava/lang/Object;)V

    iget-object v5, p0, mPendingItem:Ljava/lang/Object;

    if-eqz v5, :cond_3

    iget v4, p0, mPendingItemSize:I
...
.method protected final prependVisibleItems(IZ)Z
    ...
    :try_start_0
    invoke-virtual {p0, p1, p2}, prependVisbleItemsWithCache(IZ)Z
    ...
    :cond_2
    :try_start_1
    invoke-virtual {p0, p1, p2}, prependVisibleItemsWithoutCache(IZ)Z
