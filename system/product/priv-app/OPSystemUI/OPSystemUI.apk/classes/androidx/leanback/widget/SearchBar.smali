...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-boolean p2, p0, mAutoStartRecognition:Z

    new-instance p3, Landroid/util/SparseIntArray;

    invoke-direct {p3}, Landroid/util/SparseIntArray;-><init>()V

    iput-object p3, p0, mSoundMap:Landroid/util/SparseIntArray;

    iput-boolean p2, p0, mRecognizing:Z
    ...
    iput v0, p0, mBarHeight:I

    new-instance v0, Landroid/widget/RelativeLayout$LayoutParams;

    iget v1, p0, mBarHeight:I
    ...
    iput-object p2, p0, mSearchQuery:Ljava/lang/String;
    ...
    iput-object p2, p0, mInputMethodManager:Landroid/view/inputmethod/InputMethodManager;
    ...
    iput p2, p0, mTextColorSpeechMode:I
    ...
    iput p2, p0, mBackgroundSpeechAlpha:I
    ...
    iput p2, p0, mTextHintColorSpeechMode:I
...
.method private isVoiceMode()Z
    ...
    iget-object p0, p0, mSpeechOrbView:Landroidx/leanback/widget/SpeechOrbView;
...
.method private loadSounds(Landroid/content/Context;)V
    ...
    iget-object v5, p0, mSoundMap:Landroid/util/SparseIntArray;

    iget-object v6, p0, mSoundPool:Landroid/media/SoundPool;
...
.method private updateHint()V
    ...
    invoke-direct {p0}, isVoiceMode()Z
    ...
    iget-object v4, p0, mTitle:Ljava/lang/String;
    ...
    :cond_2
    :goto_0
    iput-object v0, p0, mHint:Ljava/lang/String;

    iget-object v0, p0, mSearchTextEditor:Landroidx/leanback/widget/SearchEditText;

    if-eqz v0, :cond_3

    iget-object p0, p0, mHint:Ljava/lang/String;
...
.method hideNativeKeyboard()V
    ...
    iget-object p0, p0, mSearchTextEditor:Landroidx/leanback/widget/SearchEditText;
...
.method protected onAttachedToWindow()V
    ...
    invoke-direct {p0, v0}, loadSounds(Landroid/content/Context;)V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-virtual {p0}, stopRecognition()V
...
.method protected onFinishInflate()V
    ...
    iput-object v0, p0, mBarBackground:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, mSearchTextEditor:Landroidx/leanback/widget/SearchEditText;
    ...
    iput-object v0, p0, mBadgeView:Landroid/widget/ImageView;

    iget-object v0, p0, mBadgeDrawable:Landroid/graphics/drawable/Drawable;

    if-eqz v0, :cond_0

    iget-object v1, p0, mBadgeView:Landroid/widget/ImageView;
    ...
    iget-object v1, p0, mSearchTextEditor:Landroidx/leanback/widget/SearchEditText;
    ...
    iput-object v0, p0, mSpeechOrbView:Landroidx/leanback/widget/SpeechOrbView;

    iget-object v0, p0, mSpeechOrbView:Landroidx/leanback/widget/SpeechOrbView;
    ...
    invoke-virtual {p0, v0}, updateUi(Z)V

    invoke-direct {p0}, updateHint()V
...
.method setSearchQueryInternal(Ljava/lang/String;)V
    ...
    iget-object v0, p0, mSearchQuery:Ljava/lang/String;
    ...
    :cond_0
    iput-object p1, p0, mSearchQuery:Ljava/lang/String;

    iget-object p1, p0, mSearchBarListener:Landroidx/leanback/widget/SearchBar$SearchBarListener;

    if-eqz p1, :cond_1

    iget-object p0, p0, mSearchQuery:Ljava/lang/String;
...
.method public startRecognition()V
    ...
    iget-boolean v0, p0, mRecognizing:Z
    ...
    :cond_1
    iget-object v0, p0, mSpeechRecognitionCallback:Landroidx/leanback/widget/SpeechRecognitionCallback;
    ...
    iput-boolean v2, p0, mRecognizing:Z

    return-void

    :cond_2
    iget-object v0, p0, mSpeechRecognizer:Landroid/speech/SpeechRecognizer;
    ...
    iget-object p0, p0, mPermissionListener:Landroidx/leanback/widget/SearchBar$SearchBarPermissionListener;
    ...
    iget-object v1, p0, mSpeechRecognizer:Landroid/speech/SpeechRecognizer;
    ...
    iput-boolean v2, p0, mListening:Z

    iget-object p0, p0, mSpeechRecognizer:Landroid/speech/SpeechRecognizer;
...
.method public stopRecognition()V
    ...
    iget-object v1, p0, mSearchQuery:Ljava/lang/String;

    invoke-virtual {v0, v1}, Landroid/widget/EditText;->setText(Ljava/lang/CharSequence;)V

    iget-object v0, p0, mSearchTextEditor:Landroidx/leanback/widget/SearchEditText;

    iget-object v1, p0, mHint:Ljava/lang/String;

    invoke-virtual {v0, v1}, Landroid/widget/EditText;->setHint(Ljava/lang/CharSequence;)V

    const/4 v0, 0x0

    iput-boolean v0, p0, mRecognizing:Z

    iget-object v1, p0, mSpeechRecognitionCallback:Landroidx/leanback/widget/SpeechRecognitionCallback;
    ...
    :cond_1
    iget-object v1, p0, mSpeechOrbView:Landroidx/leanback/widget/SpeechOrbView;
...
.method submitQuery()V
    ...
    iget-object v0, p0, mSearchBarListener:Landroidx/leanback/widget/SearchBar$SearchBarListener;
...
.method toggleRecognition()V
    ...
    :cond_0
    invoke-virtual {p0}, startRecognition()V
...
.method updateUi(Z)V
    ...
    iget-object p1, p0, mBarBackground:Landroid/graphics/drawable/Drawable;

    iget v0, p0, mBackgroundSpeechAlpha:I
    ...
    iget-object p1, p0, mSearchTextEditor:Landroidx/leanback/widget/SearchEditText;

    iget v0, p0, mTextHintColorSpeechMode:I
    ...
    iget v0, p0, mTextColorSpeechMode:I
