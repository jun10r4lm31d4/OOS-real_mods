...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput p2, p0, mNumOfThumbs:I

    new-instance p2, Landroid/util/SparseArray;

    invoke-direct {p2}, Landroid/util/SparseArray;-><init>()V

    iput-object p2, p0, mBitmaps:Landroid/util/SparseArray;

    const/4 p2, 0x0

    iput-boolean p2, p0, mIsUserSets:Z
    ...
    iput p2, p0, mThumbWidthInPixel:I
    ...
    iput p2, p0, mThumbHeightInPixel:I
    ...
    iput p2, p0, mHeroThumbHeightInPixel:I
    ...
    iput p2, p0, mHeroThumbWidthInPixel:I
    ...
    iput p1, p0, mMeasuredMarginInPixel:I
...
.method private calculateNumOfThumbs(I)I
    ...
    iget v0, p0, mHeroThumbWidthInPixel:I

    sub-int/2addr p1, v0

    iget v0, p0, mThumbWidthInPixel:I

    iget p0, p0, mMeasuredMarginInPixel:I

    add-int/2addr v0, p0

    invoke-static {p1, v0}, roundUp(II)I
...
.method private setNumberOfThumbsInternal()V
    ...
    invoke-virtual {p0, p0}, createThumbView(Landroid/view/ViewGroup;)Landroid/view/View;

    move-result-object v0

    new-instance v1, Landroid/widget/LinearLayout$LayoutParams;

    iget v2, p0, mThumbWidthInPixel:I

    iget v3, p0, mThumbHeightInPixel:I
    ...
    :cond_1
    invoke-virtual {p0}, getHeroIndex()I
    ...
    iget v4, p0, mHeroThumbWidthInPixel:I

    iput v4, v3, Landroid/widget/LinearLayout$LayoutParams;->width:I

    iget v4, p0, mHeroThumbHeightInPixel:I
    ...
    :cond_2
    iget v4, p0, mThumbWidthInPixel:I

    iput v4, v3, Landroid/widget/LinearLayout$LayoutParams;->width:I

    iget v4, p0, mThumbHeightInPixel:I
...
.method protected onLayout(ZIIII)V
    ...
    iget v0, p0, mMeasuredMarginInPixel:I
    ...
    iget p2, p0, mNumOfThumbs:I

    if-ge p1, p2, :cond_1

    iget p2, p0, mMeasuredMarginInPixel:I
...
.method protected onMeasure(II)V
    ...
    iget-boolean p2, p0, mIsUserSets:Z

    if-nez p2, :cond_0

    invoke-direct {p0, p1}, calculateNumOfThumbs(I)I
    ...
    iput p1, p0, mNumOfThumbs:I

    invoke-direct {p0}, setNumberOfThumbsInternal()V
