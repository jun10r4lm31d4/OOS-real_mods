...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p3, p0, mConstant:Landroidx/leanback/widget/picker/PickerUtility$TimeConstant;
    ...
    iput-boolean p1, p0, mIs24hFormat:Z
    ...
    invoke-direct {p0}, updateColumns()V

    invoke-direct {p0}, updateColumnsRange()V

    if-eqz p1, :cond_1

    const/4 p1, 0x0

    iget-object p2, p0, mConstant:Landroidx/leanback/widget/picker/PickerUtility$TimeConstant;
    ...
    invoke-virtual {p0, p2}, setHour(I)V
    ...
    invoke-virtual {p0, p1}, setMinute(I)V

    invoke-direct {p0}, setAmPmValue()V
...
.method private extractTimeFields()Ljava/lang/String;
    ...
    invoke-virtual {p0}, getBestHourMinutePattern()Ljava/lang/String;

    move-result-object v0

    iget-object v1, p0, mConstant:Landroidx/leanback/widget/picker/PickerUtility$TimeConstant;
...
.method private setAmPmValue()V
    ...
    iget v0, p0, mColAmPmIndex:I

    iget v1, p0, mCurrentAmPmIndex:I
...
.method private updateColumns()V
    ...
    iget-object v1, p0, mTimePickerFormat:Ljava/lang/String;
    ...
    :cond_0
    iput-object v0, p0, mTimePickerFormat:Ljava/lang/String;

    invoke-direct {p0}, extractTimeFields()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p0}, extractSeparators()Ljava/util/List;
    ...
    iput-object v1, p0, mAmPmColumn:Landroidx/leanback/widget/picker/PickerColumn;

    iput-object v1, p0, mMinuteColumn:Landroidx/leanback/widget/picker/PickerColumn;

    iput-object v1, p0, mHourColumn:Landroidx/leanback/widget/picker/PickerColumn;

    const/4 v1, -0x1

    iput v1, p0, mColAmPmIndex:I

    iput v1, p0, mColMinuteIndex:I

    iput v1, p0, mColHourIndex:I
    ...
    iput-object v5, p0, mMinuteColumn:Landroidx/leanback/widget/picker/PickerColumn;

    invoke-virtual {v1, v5}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v5, p0, mMinuteColumn:Landroidx/leanback/widget/picker/PickerColumn;

    iget-object v6, p0, mConstant:Landroidx/leanback/widget/picker/PickerUtility$TimeConstant;
    ...
    iput-object v5, p0, mHourColumn:Landroidx/leanback/widget/picker/PickerColumn;

    invoke-virtual {v1, v5}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v5, p0, mHourColumn:Landroidx/leanback/widget/picker/PickerColumn;
    ...
    iput-object v5, p0, mAmPmColumn:Landroidx/leanback/widget/picker/PickerColumn;

    invoke-virtual {v1, v5}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v5, p0, mAmPmColumn:Landroidx/leanback/widget/picker/PickerColumn;
    ...
    iput v3, p0, mColAmPmIndex:I

    iget-object v5, p0, mAmPmColumn:Landroidx/leanback/widget/picker/PickerColumn;

    invoke-static {v5, v2}, updateMin(Landroidx/leanback/widget/picker/PickerColumn;I)V

    iget-object v5, p0, mAmPmColumn:Landroidx/leanback/widget/picker/PickerColumn;

    invoke-static {v5, v4}, updateMax(Landroidx/leanback/widget/picker/PickerColumn;I)V
...
.method private updateColumnsRange()V
    ...
    iget-object v0, p0, mHourColumn:Landroidx/leanback/widget/picker/PickerColumn;

    iget-boolean v1, p0, mIs24hFormat:Z

    const/4 v2, 0x1

    xor-int/2addr v1, v2

    invoke-static {v0, v1}, updateMin(Landroidx/leanback/widget/picker/PickerColumn;I)V
    ...
    :goto_0
    invoke-static {v0, v1}, updateMax(Landroidx/leanback/widget/picker/PickerColumn;I)V

    iget-object v0, p0, mMinuteColumn:Landroidx/leanback/widget/picker/PickerColumn;
    ...
    invoke-static {v0, v3}, updateMax(Landroidx/leanback/widget/picker/PickerColumn;I)V

    iget-object v0, p0, mAmPmColumn:Landroidx/leanback/widget/picker/PickerColumn;

    if-eqz v0, :cond_1

    invoke-static {v0, v1}, updateMin(Landroidx/leanback/widget/picker/PickerColumn;I)V

    iget-object p0, p0, mAmPmColumn:Landroidx/leanback/widget/picker/PickerColumn;

    invoke-static {p0, v2}, updateMax(Landroidx/leanback/widget/picker/PickerColumn;I)V
...
.method extractSeparators()Ljava/util/List;
    ...
    :cond_3
    invoke-static {v7, v2}, isAnyOf(C[C)Z
...
.method getBestHourMinutePattern()Ljava/lang/String;
    ...
    iget-object v0, p0, mConstant:Landroidx/leanback/widget/picker/PickerUtility$TimeConstant;

    iget-object v0, v0, Landroidx/leanback/widget/picker/PickerUtility$TimeConstant;->locale:Ljava/util/Locale;

    iget-boolean p0, p0, mIs24hFormat:Z
    ...
    iget-object v2, p0, mConstant:Landroidx/leanback/widget/picker/PickerUtility$TimeConstant;
...
.method public onColumnValueChanged(II)V
    ...
    iget v0, p0, mColHourIndex:I

    if-ne p1, v0, :cond_0

    iput p2, p0, mCurrentHour:I

    goto :goto_0

    :cond_0
    iget v0, p0, mColMinuteIndex:I
    ...
    iput p2, p0, mCurrentAmPmIndex:I
...
.method public setHour(I)V
    ...
    iput v2, p0, mCurrentAmPmIndex:I
    ...
    :cond_0
    iput v0, p0, mCurrentAmPmIndex:I

    if-nez p1, :cond_1

    iput v1, p0, mCurrentHour:I
