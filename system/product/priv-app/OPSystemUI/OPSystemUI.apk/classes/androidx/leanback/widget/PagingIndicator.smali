...
.method static constructor <clinit>()V
    ...
    sput-object v0, DECELERATE_INTERPOLATOR:Landroid/animation/TimeInterpolator;
    ...
    sput-object v0, DOT_ALPHA:Landroid/util/Property;
    ...
    sput-object v0, DOT_DIAMETER:Landroid/util/Property;
    ...
    sput-object v0, DOT_TRANSLATION_X:Landroid/util/Property;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, mAnimator:Landroid/animation/AnimatorSet;
    ...
    invoke-direct {p0, v1, p1, p2}, getDimensionFromTypedArray(Landroid/content/res/TypedArray;II)I

    move-result p1

    iput p1, p0, mDotRadius:I

    iget p1, p0, mDotRadius:I

    const/4 p2, 0x2

    mul-int/2addr p1, p2

    iput p1, p0, mDotDiameter:I
    ...
    invoke-direct {p0, v1, p1, p3}, getDimensionFromTypedArray(Landroid/content/res/TypedArray;II)I

    move-result p1

    iput p1, p0, mArrowRadius:I

    iget p1, p0, mArrowRadius:I

    mul-int/2addr p1, p2

    iput p1, p0, mArrowDiameter:I
    ...
    invoke-direct {p0, v1, p1, p3}, getColorFromTypedArray(Landroid/content/res/TypedArray;II)I
    ...
    iput-object p3, p0, mBgPaint:Landroid/graphics/Paint;

    iget-object p3, p0, mBgPaint:Landroid/graphics/Paint;
    ...
    iput p1, p0, mDotFgSelectColor:I

    iget-object p1, p0, mArrowPaint:Landroid/graphics/Paint;
    ...
    invoke-virtual {p0, p1}, setArrowColor(I)V
    ...
    iput p3, p0, mShadowRadius:I

    new-instance p3, Landroid/graphics/Paint;

    invoke-direct {p3, v3}, Landroid/graphics/Paint;-><init>(I)V

    iput-object p3, p0, mFgPaint:Landroid/graphics/Paint;
    ...
    iget-object v0, p0, mFgPaint:Landroid/graphics/Paint;

    iget v1, p0, mShadowRadius:I
    ...
    invoke-direct {p0}, loadArrow()Landroid/graphics/Bitmap;

    move-result-object p1

    iput-object p1, p0, mArrow:Landroid/graphics/Bitmap;

    new-instance p1, Landroid/graphics/Rect;

    iget-object p3, p0, mArrow:Landroid/graphics/Bitmap;

    invoke-virtual {p3}, Landroid/graphics/Bitmap;->getWidth()I

    move-result p3

    iget-object v0, p0, mArrow:Landroid/graphics/Bitmap;
    ...
    iput-object p1, p0, mArrowRect:Landroid/graphics/Rect;

    iget-object p1, p0, mArrow:Landroid/graphics/Bitmap;
    ...
    iget p3, p0, mArrowDiameter:I

    int-to-float p3, p3

    div-float/2addr p1, p3

    iput p1, p0, mArrowToBgRatio:F

    new-instance p1, Landroid/animation/AnimatorSet;

    invoke-direct {p1}, Landroid/animation/AnimatorSet;-><init>()V

    iput-object p1, p0, mShowAnimator:Landroid/animation/AnimatorSet;

    iget-object p1, p0, mShowAnimator:Landroid/animation/AnimatorSet;
    ...
    invoke-direct {p0, v4, v1}, createDotAlphaAnimator(FF)Landroid/animation/Animator;

    move-result-object v5

    aput-object v5, v0, v2

    iget v5, p0, mDotRadius:I

    mul-int/2addr v5, p2

    int-to-float v5, v5

    iget v6, p0, mArrowRadius:I

    mul-int/2addr v6, p2

    int-to-float v6, v6

    invoke-direct {p0, v5, v6}, createDotDiameterAnimator(FF)Landroid/animation/Animator;

    move-result-object v5

    aput-object v5, v0, v3

    invoke-direct {p0}, createDotTranslationXAnimator()Landroid/animation/Animator;
    ...
    iput-object p1, p0, mHideAnimator:Landroid/animation/AnimatorSet;

    iget-object p1, p0, mHideAnimator:Landroid/animation/AnimatorSet;

    new-array p3, p3, [Landroid/animation/Animator;

    invoke-direct {p0, v1, v4}, createDotAlphaAnimator(FF)Landroid/animation/Animator;

    move-result-object v0

    aput-object v0, p3, v2

    iget v0, p0, mArrowRadius:I

    mul-int/2addr v0, p2

    int-to-float v0, v0

    iget v1, p0, mDotRadius:I

    mul-int/2addr v1, p2

    int-to-float v1, v1

    invoke-direct {p0, v0, v1}, createDotDiameterAnimator(FF)Landroid/animation/Animator;
    ...
    iget-object p1, p0, mAnimator:Landroid/animation/AnimatorSet;

    new-array p2, p2, [Landroid/animation/Animator;

    iget-object p3, p0, mShowAnimator:Landroid/animation/AnimatorSet;

    aput-object p3, p2, v2

    iget-object p3, p0, mHideAnimator:Landroid/animation/AnimatorSet;
...
.method private adjustDotPosition()V
    ...
    iget-object v1, p0, mDots:[Landroidx/leanback/widget/PagingIndicator$Dot;
    ...
    iget-object v2, p0, mDotSelectedPrevX:[I
    ...
    :cond_1
    iget-object v0, p0, mDots:[Landroidx/leanback/widget/PagingIndicator$Dot;
    ...
    iget-object v2, p0, mDotSelectedX:[I
    ...
    iget-object v2, p0, mDotSelectedNextX:[I
...
.method private calculateDotPositions()V
    ...
    invoke-direct {p0}, getRequiredWidth()I
    ...
    iput-object v4, p0, mDotSelectedX:[I

    new-array v4, v2, [I

    iput-object v4, p0, mDotSelectedPrevX:[I

    new-array v2, v2, [I

    iput-object v2, p0, mDotSelectedNextX:[I

    iget-boolean v2, p0, mIsLtr:Z
    ...
    iget v3, p0, mDotRadius:I

    add-int v6, v0, v3

    iget v7, p0, mDotGap:I

    sub-int/2addr v6, v7

    iget v8, p0, mArrowGap:I
    ...
    iget-object v0, p0, mDotSelectedX:[I
    ...
    iput v1, p0, mDotCenterY:I

    invoke-direct {p0}, adjustDotPosition()V
...
.method private createDotAlphaAnimator(FF)Landroid/animation/Animator;
    ...
    sget-object p0, DOT_ALPHA:Landroid/util/Property;
    ...
    sget-object p1, DECELERATE_INTERPOLATOR:Landroid/animation/TimeInterpolator;
...
.method private createDotDiameterAnimator(FF)Landroid/animation/Animator;
    ...
    sget-object p0, DOT_DIAMETER:Landroid/util/Property;
...
.method private createDotTranslationXAnimator()Landroid/animation/Animator;
    ...
    sget-object v0, DOT_TRANSLATION_X:Landroid/util/Property;

    const/4 v1, 0x2

    new-array v1, v1, [F

    iget v2, p0, mArrowGap:I

    neg-int v2, v2

    iget p0, p0, mDotGap:I
    ...
    sget-object v0, DECELERATE_INTERPOLATOR:Landroid/animation/TimeInterpolator;
...
.method private getRequiredWidth()I
    ...
    iget v0, p0, mDotRadius:I

    mul-int/lit8 v0, v0, 0x2

    iget v1, p0, mArrowGap:I

    mul-int/lit8 v1, v1, 0x2

    add-int/2addr v0, v1

    iget v1, p0, mPageCount:I
...
.method getDotSelectedLeftX()[I
    ...
    iget-object p0, p0, mDotSelectedPrevX:[I
...
.method getDotSelectedRightX()[I
    ...
    iget-object p0, p0, mDotSelectedNextX:[I
...
.method getDotSelectedX()[I
    ...
    iget-object p0, p0, mDotSelectedX:[I
...
.method protected onMeasure(II)V
    ...
    :goto_0
    invoke-direct {p0}, getDesiredWidth()I
...
.method public onRtlPropertiesChanged(I)V
    ...
    iget-object p1, p0, mDots:[Landroidx/leanback/widget/PagingIndicator$Dot;
    ...
    :cond_1
    invoke-direct {p0}, calculateDotPositions()V
...
.method public setArrowColor(I)V
    ...
    iget-object v0, p0, mArrowPaint:Landroid/graphics/Paint;
    ...
    iput-object v0, p0, mArrowPaint:Landroid/graphics/Paint;

    :cond_0
    iget-object p0, p0, mArrowPaint:Landroid/graphics/Paint;
