...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, mColorEvaluator:Landroid/animation/ArgbEvaluator;
    ...
    iput-object v0, p0, mFocusUpdateListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    invoke-virtual {p0}, getLayoutResourceId()I
    ...
    iput-object v1, p0, mRootView:Landroid/view/View;
    ...
    iput-object v1, p0, mSearchOrbView:Landroid/view/View;
    ...
    iput-object v1, p0, mIcon:Landroid/widget/ImageView;
    ...
    :cond_1
    invoke-virtual {p0, p1}, setOrbIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, v0}, setOrbColors(Landroidx/leanback/widget/SearchOrbView$Colors;)V
    ...
    invoke-virtual {p0, p1}, setSearchOrbZ(F)V

    iget-object p1, p0, mIcon:Landroid/widget/ImageView;

    iget p0, p0, mFocusedZ:F
...
.method private startShadowFocusAnimation(ZI)V
    ...
    iget-object v0, p0, mShadowFocusAnimator:Landroid/animation/ValueAnimator;
    ...
    iput-object v0, p0, mShadowFocusAnimator:Landroid/animation/ValueAnimator;

    iget-object v0, p0, mShadowFocusAnimator:Landroid/animation/ValueAnimator;

    iget-object v1, p0, mFocusUpdateListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    iget-object p1, p0, mShadowFocusAnimator:Landroid/animation/ValueAnimator;
    ...
    :goto_0
    iget-object p0, p0, mShadowFocusAnimator:Landroid/animation/ValueAnimator;
...
.method private updateColorAnimator()V
    ...
    iput-object v0, p0, mColorAnimator:Landroid/animation/ValueAnimator;

    :cond_0
    iget-boolean v0, p0, mColorAnimationEnabled:Z
    ...
    iget-object v0, p0, mColorEvaluator:Landroid/animation/ArgbEvaluator;
    ...
    iget-object v3, p0, mColors:Landroidx/leanback/widget/SearchOrbView$Colors;
    ...
    iget-object v2, p0, mColors:Landroidx/leanback/widget/SearchOrbView$Colors;
    ...
    iget-object v1, p0, mUpdateListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
...
.method animateOnFocus(Z)V
    ...
    iget v0, p0, mScaleDurationMs:I

    invoke-direct {p0, p1, v0}, startShadowFocusAnimation(ZI)V

    invoke-virtual {p0, p1}, enableOrbColorAnimation(Z)V
...
.method public enableOrbColorAnimation(Z)V
    ...
    iput-boolean p1, p0, mColorAnimationEnabled:Z

    invoke-direct {p0}, updateColorAnimator()V
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object p0, p0, mListener:Landroid/view/View$OnClickListener;
...
.method protected onFocusChanged(ZILandroid/graphics/Rect;)V
    ...
    invoke-virtual {p0, p1}, animateOnFocus(Z)V
...
.method scaleOrbViewOnly(F)V
    ...
    iget-object v0, p0, mSearchOrbView:Landroid/view/View;

    invoke-virtual {v0, p1}, Landroid/view/View;->setScaleX(F)V

    iget-object p0, p0, mSearchOrbView:Landroid/view/View;
...
.method public setOnOrbClickedListener(Landroid/view/View$OnClickListener;)V
    ...
    iput-object p1, p0, mListener:Landroid/view/View$OnClickListener;
...
.method public setOrbColors(Landroidx/leanback/widget/SearchOrbView$Colors;)V
    ...
    iput-object p1, p0, mColors:Landroidx/leanback/widget/SearchOrbView$Colors;

    iget-object p1, p0, mIcon:Landroid/widget/ImageView;

    iget-object v0, p0, mColors:Landroidx/leanback/widget/SearchOrbView$Colors;
    ...
    iget-object p1, p0, mColors:Landroidx/leanback/widget/SearchOrbView$Colors;

    iget p1, p1, Landroidx/leanback/widget/SearchOrbView$Colors;->color:I

    invoke-virtual {p0, p1}, setOrbViewColor(I)V
