...
.method static constructor <clinit>()V
    ...
    sput-object v0, LB_PRESSED_STATE_SET:[I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, mAnimationTrigger:Ljava/lang/Runnable;
    ...
    iput p2, p0, mExtraVisibility:I

    iget p2, p0, mExtraVisibility:I

    iget v0, p0, mInfoVisibility:I

    if-ge p2, v0, :cond_2

    iget p2, p0, mInfoVisibility:I
    ...
    iput p2, p0, mSelectedAnimationDelay:I
    ...
    iput p2, p0, mSelectedAnimDuration:I
    ...
    iput p2, p0, mActivatedAnimDuration:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-virtual {p1}, Landroid/content/res/TypedArray;->recycle()V

    iput-boolean p3, p0, mDelaySelectedAnim:Z

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, mMainViewList:Ljava/util/ArrayList;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, mInfoViewList:Ljava/util/ArrayList;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, mExtraViewList:Ljava/util/ArrayList;

    const/4 p1, 0x0

    iput p1, p0, mInfoOffset:F

    invoke-virtual {p0}, getFinalInfoVisFraction()F

    move-result p1

    iput p1, p0, mInfoVisFraction:F

    invoke-virtual {p0}, getFinalInfoAlpha()F

    move-result p1

    iput p1, p0, mInfoAlpha:F
...
.method private animateInfoAlpha(Z)V
    ...
    :goto_0
    iget-object v2, p0, mInfoViewList:Ljava/util/ArrayList;
    ...
    iput-object v2, p0, mAnim:Landroid/view/animation/Animation;

    iget-object p1, p0, mAnim:Landroid/view/animation/Animation;

    iget v0, p0, mActivatedAnimDuration:I
...
.method private animateInfoHeight(Z)V
    ...
    iput-object v1, p0, mAnim:Landroid/view/animation/Animation;

    iget-object p1, p0, mAnim:Landroid/view/animation/Animation;

    iget v0, p0, mSelectedAnimDuration:I
...
.method private applyActiveState(Z)V
    ...
    invoke-direct {p0}, hasInfoRegion()Z

    move-result p1

    if-eqz p1, :cond_0

    iget p1, p0, mInfoVisibility:I

    const/4 v0, 0x1

    if-ne p1, v0, :cond_0

    invoke-direct {p0, p1}, isRegionVisible(I)Z

    move-result p1

    invoke-direct {p0, p1}, setInfoViewVisibility(Z)V
...
.method private applySelectedState(Z)V
    ...
    iget-object v0, p0, mAnimationTrigger:Ljava/lang/Runnable;

    invoke-virtual {p0, v0}, Landroid/widget/FrameLayout;->removeCallbacks(Ljava/lang/Runnable;)Z

    iget v0, p0, mCardType:I
    ...
    iget-boolean p1, p0, mDelaySelectedAnim:Z

    if-nez p1, :cond_0

    iget-object p1, p0, mAnimationTrigger:Ljava/lang/Runnable;

    invoke-virtual {p0, p1}, Landroid/widget/FrameLayout;->post(Ljava/lang/Runnable;)Z

    const/4 p1, 0x1

    iput-boolean p1, p0, mDelaySelectedAnim:Z
    ...
    iget v0, p0, mSelectedAnimationDelay:I
    ...
    invoke-virtual {p0, p1}, animateInfoOffset(Z)V
...
.method private findChildrenViews()V
    ...
    iget-object v0, p0, mMainViewList:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    iget-object v0, p0, mInfoViewList:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    iget-object v0, p0, mExtraViewList:Ljava/util/ArrayList;
    ...
    iget v1, p0, mInfoVisibility:I

    invoke-direct {p0, v1}, isCurrentRegionVisible(I)Z
    ...
    :goto_0
    invoke-direct {p0}, hasExtraRegion()Z

    move-result v4

    if-eqz v4, :cond_1

    iget v4, p0, mInfoOffset:F
    ...
    iget v7, p0, mInfoAlpha:F

    invoke-virtual {v6, v7}, Landroid/view/View;->setAlpha(F)V

    iget-object v7, p0, mInfoViewList:Ljava/util/ArrayList;
    ...
    iget-object v7, p0, mExtraViewList:Ljava/util/ArrayList;
    ...
    :cond_6
    iget-object v7, p0, mMainViewList:Ljava/util/ArrayList;
...
.method private isCurrentRegionVisible(I)Z
    ...
    :cond_0
    iget p1, p0, mCardType:I

    if-ne p1, v2, :cond_2

    iget p0, p0, mInfoVisFraction:F
...
.method private setInfoViewVisibility(Z)V
    ...
    :cond_1
    :goto_2
    iget-object p1, p0, mExtraViewList:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, p1}, animateInfoHeight(Z)V
    ...
    :goto_3
    iget-object v3, p0, mInfoViewList:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, p1}, animateInfoAlpha(Z)V
...
.method animateInfoOffset(Z)V
    ...
    :goto_0
    iget-object v5, p0, mExtraViewList:Ljava/util/ArrayList;
...
.method cancelAnimations()V
    ...
    iget-object v0, p0, mAnim:Landroid/view/animation/Animation;
    ...
    iput-object v0, p0, mAnim:Landroid/view/animation/Animation;
...
.method protected bridge synthetic generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0}, generateDefaultLayoutParams()Landroidx/leanback/widget/BaseCardView$LayoutParams;
...
.method public bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, generateLayoutParams(Landroid/util/AttributeSet;)Landroidx/leanback/widget/BaseCardView$LayoutParams;
...
.method protected bridge synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroidx/leanback/widget/BaseCardView$LayoutParams;
...
.method protected onCreateDrawableState(I)[I
    ...
    sget-object p0, LB_PRESSED_STATE_SET:[I
...
.method protected onLayout(ZIIII)V
    ...
    :goto_0
    iget-object v4, v0, mMainViewList:Ljava/util/ArrayList;
    ...
    :goto_1
    iget-object v7, v0, mInfoViewList:Ljava/util/ArrayList;
    ...
    iget v4, v0, mInfoVisibility:I

    if-ne v4, v7, :cond_5

    iget v4, v0, mInfoVisFraction:F
    ...
    :goto_5
    iget-object v3, v0, mExtraViewList:Ljava/util/ArrayList;
...
.method protected onMeasure(II)V
    ...
    iput v0, p0, mMeasuredWidth:I

    iput v0, p0, mMeasuredHeight:I

    invoke-direct {p0}, findChildrenViews()V
    ...
    :goto_0
    iget-object v5, p0, mMainViewList:Ljava/util/ArrayList;
    ...
    :goto_1
    iget-object v10, p0, mInfoViewList:Ljava/util/ArrayList;
    ...
    :goto_2
    iget-object v11, p0, mExtraViewList:Ljava/util/ArrayList;
...
.method public setActivated(Z)V
    ...
    invoke-direct {p0, p1}, applyActiveState(Z)V
...
.method public setSelected(Z)V
    ...
    invoke-direct {p0, p1}, applySelectedState(Z)V
