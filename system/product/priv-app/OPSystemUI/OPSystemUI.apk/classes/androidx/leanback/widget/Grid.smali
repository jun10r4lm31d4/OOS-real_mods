...
.method constructor <init>()V
    ...
    iput-object v0, p0, mTmpItem:[Ljava/lang/Object;

    const/4 v0, -0x1

    iput v0, p0, mFirstVisibleIndex:I

    iput v0, p0, mLastVisibleIndex:I

    iput v0, p0, mStartIndex:I
...
.method public static createGrid(I)Landroidx/leanback/widget/Grid;
    ...
    invoke-virtual {v0, p0}, setNumRows(I)V
...
.method private resetVisibleIndexIfEmpty()V
    ...
    iget v0, p0, mLastVisibleIndex:I

    iget v1, p0, mFirstVisibleIndex:I

    if-ge v0, v1, :cond_0

    invoke-virtual {p0}, resetVisibleIndex()V
...
.method public appendOneColumnVisibleItems()Z
    ...
    iget-boolean v0, p0, mReversedFlow:Z
    ...
    invoke-virtual {p0, v0, v1}, appendVisibleItems(IZ)Z
...
.method public final appendVisibleItems(I)V
    ...
    invoke-virtual {p0, p1, v0}, appendVisibleItems(IZ)Z
...
.method protected final checkAppendOverLimit(I)Z
    ...
    invoke-virtual {p0, v3, v2}, findRowMin(Z[I)I

    move-result v0

    iget p0, p0, mSpacing:I
    ...
    :cond_1
    invoke-virtual {p0, v1, v2}, findRowMax(Z[I)I
...
.method public fillDisappearingItems([IILandroid/util/SparseIntArray;)V
    ...
    invoke-virtual {p0}, getLastVisibleIndex()I
    ...
    iget-boolean v4, p0, mReversedFlow:Z

    if-eqz v4, :cond_1

    iget-object v4, p0, mProvider:Landroidx/leanback/widget/Grid$Provider;

    invoke-interface {v4, v0}, Landroidx/leanback/widget/Grid$Provider;->getEdge(I)I

    move-result v4

    iget-object v5, p0, mProvider:Landroidx/leanback/widget/Grid$Provider;
    ...
    iget-object v5, p0, mTmpItem:[Ljava/lang/Object;
    ...
    :cond_4
    invoke-virtual {p0}, getFirstVisibleIndex()I
    ...
    iget-boolean v2, p0, mReversedFlow:Z

    if-eqz v2, :cond_6

    iget-object v2, p0, mProvider:Landroidx/leanback/widget/Grid$Provider;
    ...
    iget-object v4, p0, mTmpItem:[Ljava/lang/Object;
    ...
    iget-object v2, p0, mTmpItem:[Ljava/lang/Object;
...
.method public final findRowMax(Z[I)I
    ...
    iget v0, p0, mFirstVisibleIndex:I
    ...
    :goto_0
    invoke-virtual {p0, p1, v0, p2}, findRowMax(ZI[I)I
...
.method public final findRowMin(Z[I)I
    ...
    :goto_0
    invoke-virtual {p0, p1, v0, p2}, findRowMin(ZI[I)I
...
.method public final getFirstVisibleIndex()I
    ...
    iget p0, p0, mFirstVisibleIndex:I
...
.method public final getItemPositionsInRows()[Landroidx/collection/CircularIntArray;
    ...
    invoke-virtual {p0, v0, v1}, getItemPositionsInRows(II)[Landroidx/collection/CircularIntArray;
...
.method public final getLastVisibleIndex()I
    ...
    iget p0, p0, mLastVisibleIndex:I
...
.method public final getRowIndex(I)I
    ...
    invoke-virtual {p0, p1}, getLocation(I)Landroidx/leanback/widget/Grid$Location;
...
.method public invalidateItemsAfter(I)V
    ...
    :cond_2
    invoke-direct {p0}, resetVisibleIndexIfEmpty()V
    ...
    invoke-virtual {p0, p1}, setStart(I)V
...
.method public isReversedFlow()Z
    ...
    iget-boolean p0, p0, mReversedFlow:Z
...
.method public final prependOneColumnVisibleItems()Z
    ...
    invoke-virtual {p0, v0, v1}, prependVisibleItems(IZ)Z
...
.method public final prependVisibleItems(I)V
    ...
    invoke-virtual {p0, p1, v0}, prependVisibleItems(IZ)Z
...
.method public removeInvisibleItemsAtEnd(II)V
    ...
    iget-boolean v1, p0, mReversedFlow:Z
    ...
    iget-object v1, p0, mProvider:Landroidx/leanback/widget/Grid$Provider;
    ...
    iget-object v0, p0, mProvider:Landroidx/leanback/widget/Grid$Provider;

    iget v1, p0, mLastVisibleIndex:I
...
.method public removeInvisibleItemsAtFront(II)V
    ...
    iget v4, p0, mFirstVisibleIndex:I
...
.method setNumRows(I)V
    ...
    :cond_0
    iput p1, p0, mNumRows:I

    iget p1, p0, mNumRows:I

    new-array p1, p1, [Landroidx/collection/CircularIntArray;

    iput-object p1, p0, mTmpItemPositionsInRows:[Landroidx/collection/CircularIntArray;
    ...
    iget-object v0, p0, mTmpItemPositionsInRows:[Landroidx/collection/CircularIntArray;
...
.method public setProvider(Landroidx/leanback/widget/Grid$Provider;)V
    ...
    iput-object p1, p0, mProvider:Landroidx/leanback/widget/Grid$Provider;
...
.method public final setReversedFlow(Z)V
    ...
    iput-boolean p1, p0, mReversedFlow:Z
