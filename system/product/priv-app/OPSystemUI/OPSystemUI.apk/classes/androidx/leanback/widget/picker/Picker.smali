...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, mColumnViews:Ljava/util/List;

    const/high16 v0, 0x40400000    # 3.0f

    iput v0, p0, mVisibleItemsActivated:F

    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, p0, mVisibleItems:F

    const/4 v1, 0x0

    iput v1, p0, mSelectedColumn:I

    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    iput-object v2, p0, mSeparators:Ljava/util/List;
    ...
    iput-object v2, p0, mColumnChangeListener:Landroidx/leanback/widget/OnChildViewHolderSelectedListener;
    ...
    iput p1, p0, mPickerItemLayoutId:I
    ...
    iput p1, p0, mPickerItemTextViewId:I
    ...
    iput v0, p0, mFocusedAlpha:F

    iput v0, p0, mUnfocusedAlpha:F

    const/high16 p2, 0x3f000000    # 0.5f

    iput p2, p0, mVisibleColumnAlpha:F

    const/4 p2, 0x0

    iput p2, p0, mInvisibleColumnAlpha:F

    const/16 p2, 0xc8

    iput p2, p0, mAlphaAnimDuration:I
    ...
    iput-object p2, p0, mDecelerateInterpolator:Landroid/view/animation/Interpolator;
    ...
    iput-object p1, p0, mPickerView:Landroid/view/ViewGroup;
...
.method private setOrAnimateAlpha(Landroid/view/View;ZFFLandroid/view/animation/Interpolator;)V
    ...
    iget p0, p0, mAlphaAnimDuration:I
...
.method private updateColumnSize()V
    ...
    :goto_0
    invoke-virtual {p0}, getColumnsCount()I

    move-result v1

    if-ge v0, v1, :cond_0

    iget-object v1, p0, mColumnViews:Ljava/util/List;
    ...
    invoke-direct {p0, v1}, updateColumnSize(Landroidx/leanback/widget/VerticalGridView;)V
...
.method private updateColumnSize(Landroidx/leanback/widget/VerticalGridView;)V
    ...
    invoke-virtual {p0}, getActivatedVisibleItemCount()F
    ...
    :cond_0
    invoke-virtual {p0}, getVisibleItemCount()F

    move-result v1

    :goto_0
    invoke-virtual {p0}, getPickerItemHeightPixels()I
...
.method private updateItemFocusable()V
    ...
    iget-object v3, p0, mColumnViews:Ljava/util/List;
...
.method public getActivatedVisibleItemCount()F
    ...
    iget p0, p0, mVisibleItemsActivated:F
...
.method public getColumnAt(I)Landroidx/leanback/widget/picker/PickerColumn;
    ...
    iget-object p0, p0, mColumns:Ljava/util/ArrayList;
...
.method public final getPickerItemLayoutId()I
    ...
    iget p0, p0, mPickerItemLayoutId:I
...
.method public final getPickerItemTextViewId()I
    ...
    iget p0, p0, mPickerItemTextViewId:I
...
.method public onColumnValueChanged(II)V
    ...
    invoke-direct {p0, p1}, notifyValueChanged(I)V
...
.method protected onRequestFocusInDescendants(ILandroid/graphics/Rect;)Z
    ...
    invoke-virtual {p0}, getSelectedColumn()I
    ...
    iget-object p0, p0, mColumnViews:Ljava/util/List;
...
.method public requestChildFocus(Landroid/view/View;Landroid/view/View;)V
    ...
    :goto_0
    iget-object p2, p0, mColumnViews:Ljava/util/List;
    ...
    invoke-virtual {p0, p1}, setSelectedColumn(I)V
...
.method public setActivated(Z)V
    ...
    :cond_2
    invoke-direct {p0}, updateColumnSize()V

    invoke-direct {p0}, updateItemFocusable()V
    ...
    iget-object p1, p0, mColumnViews:Ljava/util/List;
...
.method public setColumnValue(IIZ)V
    ...
    iget-object v0, p0, mColumnViews:Ljava/util/List;
...
.method public setColumns(Ljava/util/List;)V
    ...
    iget-object v0, p0, mSeparators:Ljava/util/List;
    ...
    iget-object v3, p0, mSeparators:Ljava/util/List;
    ...
    iget-object v5, p0, mSeparators:Ljava/util/List;
    ...
    iget-object v0, p0, mPickerView:Landroid/view/ViewGroup;
    ...
    iget-object p1, p0, mColumns:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, mSeparators:Ljava/util/List;
    ...
    iget-object v3, p0, mPickerView:Landroid/view/ViewGroup;
    ...
    iget-object v4, p0, mPickerView:Landroid/view/ViewGroup;
    ...
    invoke-direct {p0, v3}, updateColumnSize(Landroidx/leanback/widget/VerticalGridView;)V
    ...
    iget-object v4, p0, mColumnViews:Ljava/util/List;
    ...
    iget-object v4, p0, mSeparators:Ljava/util/List;
    ...
    iget-object v6, p0, mPickerView:Landroid/view/ViewGroup;
    ...
    iget-object v6, p0, mSeparators:Ljava/util/List;
    ...
    invoke-virtual {p0}, getPickerItemLayoutId()I

    move-result v6

    invoke-virtual {p0}, getPickerItemTextViewId()I
    ...
    iget-object v1, p0, mColumnChangeListener:Landroidx/leanback/widget/OnChildViewHolderSelectedListener;
    ...
    iget-object p0, p0, mSeparators:Ljava/util/List;
...
.method setOrAnimateAlpha(Landroid/view/View;ZIZ)V
    ...
    invoke-direct/range {v0 .. v5}, setOrAnimateAlpha(Landroid/view/View;ZFFLandroid/view/animation/Interpolator;)V

    goto :goto_2

    :cond_2
    iget v3, p0, mUnfocusedAlpha:F
    ...
    iget v3, p0, mVisibleColumnAlpha:F
    ...
    :cond_4
    iget v3, p0, mInvisibleColumnAlpha:F
...
.method public setSelectedColumn(I)V
    ...
    invoke-virtual {p0, v0, v1}, updateColumnAlpha(IZ)V
...
.method public final setSeparator(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p0, p1}, setSeparators(Ljava/util/List;)V
...
.method updateColumnAlpha(IZ)V
    ...
    :goto_1
    invoke-virtual {p0, v4, v5, p1, p2}, setOrAnimateAlpha(Landroid/view/View;ZIZ)V
