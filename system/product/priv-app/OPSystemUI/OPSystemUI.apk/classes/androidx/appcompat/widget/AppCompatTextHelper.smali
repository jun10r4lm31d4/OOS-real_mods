...
.method constructor <init>(Landroid/widget/TextView;)V
    ...
    iput-object p1, p0, mAutoSizeTextHelper:Landroidx/appcompat/widget/AppCompatTextViewAutoSizeHelper;
...
.method private applyCompoundDrawableTint(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/TintInfo;)V
    ...
    iget-object p0, p0, mView:Landroid/widget/TextView;
...
.method private setCompoundDrawables(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    :cond_0
    iget-object p1, p0, mView:Landroid/widget/TextView;
    ...
    iget-object p5, p0, mView:Landroid/widget/TextView;
...
.method private setCompoundTints()V
    ...
    iget-object v0, p0, mDrawableTint:Landroidx/appcompat/widget/TintInfo;

    iput-object v0, p0, mDrawableLeftTint:Landroidx/appcompat/widget/TintInfo;

    iput-object v0, p0, mDrawableTopTint:Landroidx/appcompat/widget/TintInfo;

    iput-object v0, p0, mDrawableRightTint:Landroidx/appcompat/widget/TintInfo;

    iput-object v0, p0, mDrawableBottomTint:Landroidx/appcompat/widget/TintInfo;

    iput-object v0, p0, mDrawableStartTint:Landroidx/appcompat/widget/TintInfo;

    iput-object v0, p0, mDrawableEndTint:Landroidx/appcompat/widget/TintInfo;
...
.method private setTextSizeInternal(IF)V
    ...
    iget-object p0, p0, mAutoSizeTextHelper:Landroidx/appcompat/widget/AppCompatTextViewAutoSizeHelper;
...
.method private updateTypefaceAndStyle(Landroid/content/Context;Landroidx/appcompat/widget/TintTypedArray;)V
    ...
    iput-boolean v4, p0, mAsyncFontPending:Z
    ...
    iput-object p1, p0, mFontTypeface:Landroid/graphics/Typeface;
    ...
    iput-object v0, p0, mFontTypeface:Landroid/graphics/Typeface;
    ...
    iget-object v8, p0, mView:Landroid/widget/TextView;
    ...
    :cond_a
    :goto_4
    iget-object p1, p0, mFontTypeface:Landroid/graphics/Typeface;
    ...
    :goto_5
    iput-boolean p1, p0, mAsyncFontPending:Z
    :try_end_0
...
.method applyCompoundDrawablesTints()V
    ...
    iget-object v0, p0, mDrawableLeftTint:Landroidx/appcompat/widget/TintInfo;
    ...
    iget-object v0, p0, mDrawableTopTint:Landroidx/appcompat/widget/TintInfo;

    if-nez v0, :cond_0

    iget-object v0, p0, mDrawableRightTint:Landroidx/appcompat/widget/TintInfo;

    if-nez v0, :cond_0

    iget-object v0, p0, mDrawableBottomTint:Landroidx/appcompat/widget/TintInfo;
    ...
    iget-object v4, p0, mDrawableLeftTint:Landroidx/appcompat/widget/TintInfo;

    invoke-direct {p0, v3, v4}, applyCompoundDrawableTint(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/TintInfo;)V

    const/4 v3, 0x1

    aget-object v3, v0, v3

    iget-object v4, p0, mDrawableTopTint:Landroidx/appcompat/widget/TintInfo;

    invoke-direct {p0, v3, v4}, applyCompoundDrawableTint(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/TintInfo;)V

    aget-object v3, v0, v1

    iget-object v4, p0, mDrawableRightTint:Landroidx/appcompat/widget/TintInfo;
    ...
    iget-object v3, p0, mDrawableBottomTint:Landroidx/appcompat/widget/TintInfo;

    invoke-direct {p0, v0, v3}, applyCompoundDrawableTint(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/TintInfo;)V
    ...
    iget-object v0, p0, mDrawableStartTint:Landroidx/appcompat/widget/TintInfo;

    if-nez v0, :cond_2

    iget-object v0, p0, mDrawableEndTint:Landroidx/appcompat/widget/TintInfo;
    ...
    iget-object v3, p0, mDrawableStartTint:Landroidx/appcompat/widget/TintInfo;

    invoke-direct {p0, v2, v3}, applyCompoundDrawableTint(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/TintInfo;)V

    aget-object v0, v0, v1

    iget-object v1, p0, mDrawableEndTint:Landroidx/appcompat/widget/TintInfo;

    invoke-direct {p0, v0, v1}, applyCompoundDrawableTint(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/TintInfo;)V
...
.method loadFromAttributes(Landroid/util/AttributeSet;I)V
    ...
    iget-object v2, v7, mView:Landroid/widget/TextView;
    ...
    invoke-static {v2, v3, v9}, createTintInfo(Landroid/content/Context;Landroidx/appcompat/widget/AppCompatDrawableManager;I)Landroidx/appcompat/widget/TintInfo;

    move-result-object v9

    iput-object v9, v7, mDrawableLeftTint:Landroidx/appcompat/widget/TintInfo;
    ...
    iput-object v9, v7, mDrawableTopTint:Landroidx/appcompat/widget/TintInfo;
    ...
    iput-object v9, v7, mDrawableRightTint:Landroidx/appcompat/widget/TintInfo;
    ...
    iput-object v9, v7, mDrawableBottomTint:Landroidx/appcompat/widget/TintInfo;
    ...
    iput-object v9, v7, mDrawableStartTint:Landroidx/appcompat/widget/TintInfo;
    ...
    iput-object v9, v7, mDrawableEndTint:Landroidx/appcompat/widget/TintInfo;

    :cond_5
    invoke-virtual {v4}, Landroidx/appcompat/widget/TintTypedArray;->recycle()V

    iget-object v4, v7, mView:Landroid/widget/TextView;
    ...
    :goto_0
    invoke-direct {v7, v2, v6}, updateTypefaceAndStyle(Landroid/content/Context;Landroidx/appcompat/widget/TintTypedArray;)V
    ...
    iget-object v5, v7, mView:Landroid/widget/TextView;
    ...
    iget-object v3, v7, mView:Landroid/widget/TextView;
    ...
    invoke-virtual {v7, v14}, setAllCaps(Z)V

    :cond_18
    iget-object v3, v7, mFontTypeface:Landroid/graphics/Typeface;

    if-eqz v3, :cond_1a

    iget v4, v7, mFontWeight:I
    ...
    :cond_1d
    :goto_a
    iget-object v3, v7, mAutoSizeTextHelper:Landroidx/appcompat/widget/AppCompatTextViewAutoSizeHelper;
    ...
    iget-object v1, v7, mAutoSizeTextHelper:Landroidx/appcompat/widget/AppCompatTextViewAutoSizeHelper;
    ...
    iget-object v1, v7, mView:Landroid/widget/TextView;
    ...
    iget-object v4, v7, mAutoSizeTextHelper:Landroidx/appcompat/widget/AppCompatTextViewAutoSizeHelper;

    invoke-virtual {v4}, Landroidx/appcompat/widget/AppCompatTextViewAutoSizeHelper;->getAutoSizeMaxTextSize()I

    move-result v4

    iget-object v5, v7, mAutoSizeTextHelper:Landroidx/appcompat/widget/AppCompatTextViewAutoSizeHelper;
    ...
    invoke-direct/range {v0 .. v6}, setCompoundDrawables(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v0, v7, mView:Landroid/widget/TextView;
...
.method onAsyncTypefaceReceived(Ljava/lang/ref/WeakReference;Landroid/graphics/Typeface;)V
    ...
    iget-boolean v0, p0, mAsyncFontPending:Z

    if-eqz v0, :cond_0

    iput-object p2, p0, mFontTypeface:Landroid/graphics/Typeface;
...
.method onSetCompoundDrawables()V
    ...
    invoke-virtual {p0}, applyCompoundDrawablesTints()V
...
.method onSetTextAppearance(Landroid/content/Context;I)V
    ...
    invoke-virtual {p0, v0}, setAllCaps(Z)V
    ...
    iget-object v2, p0, mView:Landroid/widget/TextView;
    ...
    :cond_2
    invoke-direct {p0, p1, p2}, updateTypefaceAndStyle(Landroid/content/Context;Landroidx/appcompat/widget/TintTypedArray;)V
    ...
    iget-object p2, p0, mView:Landroid/widget/TextView;
...
.method setCompoundDrawableTintList(Landroid/content/res/ColorStateList;)V
    ...
    iput-object v0, p0, mDrawableTint:Landroidx/appcompat/widget/TintInfo;
    ...
    invoke-direct {p0}, setCompoundTints()V
...
.method setTextSize(IF)V
    ...
    invoke-direct {p0, p1, p2}, setTextSizeInternal(IF)V
