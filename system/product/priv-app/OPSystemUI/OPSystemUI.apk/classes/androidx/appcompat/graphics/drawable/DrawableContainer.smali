...
.method private initializeDrawableForDisplay(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v0, p0, mBlockInvalidateCallback:Landroidx/appcompat/graphics/drawable/DrawableContainer$BlockInvalidateCallback;
    ...
    iput-object v0, p0, mBlockInvalidateCallback:Landroidx/appcompat/graphics/drawable/DrawableContainer$BlockInvalidateCallback;
    ...
    :try_start_0
    iget-object v0, p0, mDrawableContainerState:Landroidx/appcompat/graphics/drawable/DrawableContainer$DrawableContainerState;

    iget v0, v0, Landroidx/appcompat/graphics/drawable/DrawableContainer$DrawableContainerState;->mEnterFadeDuration:I

    if-gtz v0, :cond_1

    iget-boolean v0, p0, mHasAlpha:Z
    ...
    :cond_6
    iget-object v0, p0, mHotspotBounds:Landroid/graphics/Rect;
    ...
    :cond_7
    iget-object p0, p0, mBlockInvalidateCallback:Landroidx/appcompat/graphics/drawable/DrawableContainer$BlockInvalidateCallback;
...
.method animate(Z)V
    ...
    iput-boolean v0, p0, mHasAlpha:Z

    invoke-static {}, Landroid/os/SystemClock;->uptimeMillis()J

    move-result-wide v1

    iget-object v3, p0, mCurrDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iget-wide v9, p0, mEnterAnimationEnd:J
    ...
    iput-wide v7, p0, mEnterAnimationEnd:J
    ...
    iget-object v10, p0, mDrawableContainerState:Landroidx/appcompat/graphics/drawable/DrawableContainer$DrawableContainerState;
    ...
    :goto_1
    iget-object v9, p0, mLastDrawable:Landroid/graphics/drawable/Drawable;

    if-eqz v9, :cond_4

    iget-wide v10, p0, mExitAnimationEnd:J
    ...
    iput-object v0, p0, mLastDrawable:Landroid/graphics/drawable/Drawable;

    const/4 v0, -0x1

    iput v0, p0, mLastIndex:I

    iput-wide v7, p0, mExitAnimationEnd:J
    ...
    iget-object v4, p0, mDrawableContainerState:Landroidx/appcompat/graphics/drawable/DrawableContainer$DrawableContainerState;
    ...
    iget-object p1, p0, mAnimationRunnable:Ljava/lang/Runnable;
...
.method public applyTheme(Landroid/content/res/Resources$Theme;)V
    ...
    iget-object p0, p0, mDrawableContainerState:Landroidx/appcompat/graphics/drawable/DrawableContainer$DrawableContainerState;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, mCurrDrawable:Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    iget-object p0, p0, mLastDrawable:Landroid/graphics/drawable/Drawable;
...
.method public getCurrent()Landroid/graphics/drawable/Drawable;
    ...
    iget-object p0, p0, mCurrDrawable:Landroid/graphics/drawable/Drawable;
...
.method public getPadding(Landroid/graphics/Rect;)Z
    ...
    :goto_0
    invoke-direct {p0}, needsMirroring()Z
...
.method public jumpToCurrentState()V
    ...
    iget-object v0, p0, mLastDrawable:Landroid/graphics/drawable/Drawable;
    ...
    :goto_0
    iget-object v2, p0, mCurrDrawable:Landroid/graphics/drawable/Drawable;

    if-eqz v2, :cond_1

    invoke-virtual {v2}, Landroid/graphics/drawable/Drawable;->jumpToCurrentState()V

    iget-boolean v2, p0, mHasAlpha:Z
    ...
    :cond_1
    iget-wide v2, p0, mExitAnimationEnd:J
    ...
    iput-wide v4, p0, mExitAnimationEnd:J

    move v0, v1

    :cond_2
    iget-wide v2, p0, mEnterAnimationEnd:J

    cmp-long v2, v2, v4

    if-eqz v2, :cond_3

    iput-wide v4, p0, mEnterAnimationEnd:J
...
.method public mutate()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0}, cloneConstantState()Landroidx/appcompat/graphics/drawable/DrawableContainer$DrawableContainerState;
...
.method public onLayoutDirectionChanged(I)Z
    ...
    invoke-virtual {p0}, getCurrentIndex()I
...
.method selectDrawable(I)Z
    ...
    iput-wide v0, p0, mExitAnimationEnd:J

    goto :goto_0

    :cond_2
    iput-object v5, p0, mLastDrawable:Landroid/graphics/drawable/Drawable;

    iput v4, p0, mLastIndex:I

    iput-wide v6, p0, mExitAnimationEnd:J
    ...
    iput-object v0, p0, mCurrDrawable:Landroid/graphics/drawable/Drawable;

    iput p1, p0, mCurIndex:I

    if-eqz v0, :cond_7

    iget-object p1, p0, mDrawableContainerState:Landroidx/appcompat/graphics/drawable/DrawableContainer$DrawableContainerState;
    ...
    iput-wide v2, p0, mEnterAnimationEnd:J

    :cond_5
    invoke-direct {p0, v0}, initializeDrawableForDisplay(Landroid/graphics/drawable/Drawable;)V

    goto :goto_1

    :cond_6
    iput-object v5, p0, mCurrDrawable:Landroid/graphics/drawable/Drawable;

    iput v4, p0, mCurIndex:I

    :cond_7
    :goto_1
    iget-wide v0, p0, mEnterAnimationEnd:J
    ...
    iget-wide v1, p0, mExitAnimationEnd:J
    ...
    iput-object p1, p0, mAnimationRunnable:Ljava/lang/Runnable;
    ...
    :goto_2
    invoke-virtual {p0, v0}, animate(Z)V
...
.method public setAlpha(I)V
    ...
    iget-wide v1, p0, mEnterAnimationEnd:J
    ...
    invoke-virtual {p0, p1}, animate(Z)V
...
.method setConstantState(Landroidx/appcompat/graphics/drawable/DrawableContainer$DrawableContainerState;)V
    ...
    iput-object p1, p0, mDrawableContainerState:Landroidx/appcompat/graphics/drawable/DrawableContainer$DrawableContainerState;
    ...
    iput-object p1, p0, mCurrDrawable:Landroid/graphics/drawable/Drawable;

    iget-object p1, p0, mCurrDrawable:Landroid/graphics/drawable/Drawable;

    if-eqz p1, :cond_0

    invoke-direct {p0, p1}, initializeDrawableForDisplay(Landroid/graphics/drawable/Drawable;)V

    :cond_0
    const/4 p1, -0x1

    iput p1, p0, mLastIndex:I

    const/4 p1, 0x0

    iput-object p1, p0, mLastDrawable:Landroid/graphics/drawable/Drawable;
...
.method public setHotspotBounds(IIII)V
    ...
    iput-object v0, p0, mHotspotBounds:Landroid/graphics/Rect;
...
.method public setVisible(ZZ)Z
    ...
    iget-object v1, p0, mLastDrawable:Landroid/graphics/drawable/Drawable;
