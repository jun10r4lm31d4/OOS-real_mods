...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, mCancelable:Z
...
.method private createListView(Landroidx/appcompat/app/AlertController;)V
    ...
    iget-object v2, p0, mLabelColumn:Ljava/lang/String;
    ...
    :cond_3
    iget-object v9, p0, mAdapter:Landroid/widget/ListAdapter;
    ...
    :goto_1
    iget-object v1, p0, mOnPrepareListViewListener:Landroidx/appcompat/app/AlertController$AlertParams$OnPrepareListViewListener;
    ...
    :cond_9
    iget-boolean p0, p0, mIsMultiChoice:Z
...
.method public apply(Landroidx/appcompat/app/AlertController;)V
    ...
    iget-object v0, p0, mPositiveButtonIcon:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v3, p0, mPositiveButtonText:Ljava/lang/CharSequence;

    iget-object v4, p0, mPositiveButtonListener:Landroid/content/DialogInterface$OnClickListener;

    const/4 v5, 0x0

    iget-object v6, p0, mPositiveButtonIcon:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, mNegativeButtonIcon:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v3, p0, mNegativeButtonText:Ljava/lang/CharSequence;

    iget-object v4, p0, mNegativeButtonListener:Landroid/content/DialogInterface$OnClickListener;

    const/4 v5, 0x0

    iget-object v6, p0, mNegativeButtonIcon:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, mNeutralButtonIcon:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v3, p0, mNeutralButtonText:Ljava/lang/CharSequence;

    iget-object v4, p0, mNeutralButtonListener:Landroid/content/DialogInterface$OnClickListener;

    const/4 v5, 0x0

    iget-object v6, p0, mNeutralButtonIcon:Landroid/graphics/drawable/Drawable;
    ...
    :cond_c
    invoke-direct {p0, p1}, createListView(Landroidx/appcompat/app/AlertController;)V
