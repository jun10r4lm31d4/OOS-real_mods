...
.method public constructor <init>(Landroid/content/Context;Landroidx/appcompat/app/AppCompatDialog;Landroid/view/Window;)V
    ...
    iput v0, p0, mButtonPanelLayoutHint:I
    ...
    iput-object p2, p0, mDialog:Landroidx/appcompat/app/AppCompatDialog;
    ...
    iput p3, p0, mAlertDialogLayout:I
    ...
    iput p3, p0, mButtonPanelSideLayout:I
    ...
    iput p3, p0, mMultiChoiceItemLayout:I
    ...
    iput p3, p0, mSingleChoiceItemLayout:I
    ...
    iput-boolean p3, p0, mShowTitle:Z
...
.method static canTextInput(Landroid/view/View;)Z
    ...
    invoke-static {v3}, canTextInput(Landroid/view/View;)Z
...
.method private selectContentView()I
    ...
    iget p0, p0, mAlertDialogLayout:I

    return p0

    :cond_0
    iget v1, p0, mButtonPanelLayoutHint:I
...
.method private setScrollIndicators(Landroid/view/ViewGroup;Landroid/view/View;II)V
    ...
    :cond_4
    iget-object p3, p0, mMessage:Ljava/lang/CharSequence;

    if-eqz p3, :cond_5

    iget-object p1, p0, mScrollView:Landroidx/core/widget/NestedScrollView;
    ...
    :cond_5
    iget-object p3, p0, mListView:Landroid/widget/ListView;
    ...
    iget-object p1, p0, mListView:Landroid/widget/ListView;
...
.method private setupButtons(Landroid/view/ViewGroup;)V
    ...
    iput-object v0, p0, mButtonPositive:Landroid/widget/Button;

    iget-object v0, p0, mButtonPositive:Landroid/widget/Button;

    iget-object v1, p0, mButtonHandler:Landroid/view/View$OnClickListener;

    invoke-virtual {v0, v1}, Landroid/widget/Button;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v0, p0, mButtonPositiveText:Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, mButtonPositiveIcon:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v5, p0, mButtonPositiveText:Ljava/lang/CharSequence;
    ...
    iget v5, p0, mButtonIconDimen:I

    invoke-virtual {v0, v4, v4, v5, v5}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V

    iget-object v0, p0, mButtonPositive:Landroid/widget/Button;

    iget-object v5, p0, mButtonPositiveIcon:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v5, p0, mButtonNegative:Landroid/widget/Button;

    iget-object v5, p0, mButtonNegative:Landroid/widget/Button;

    iget-object v6, p0, mButtonHandler:Landroid/view/View$OnClickListener;

    invoke-virtual {v5, v6}, Landroid/widget/Button;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v5, p0, mButtonNegativeText:Ljava/lang/CharSequence;
    ...
    iget-object v5, p0, mButtonNegativeIcon:Landroid/graphics/drawable/Drawable;
    ...
    iget v6, p0, mButtonIconDimen:I

    invoke-virtual {v5, v4, v4, v6, v6}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V

    iget-object v5, p0, mButtonNegative:Landroid/widget/Button;

    iget-object v6, p0, mButtonNegativeIcon:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v5, p0, mButtonNeutral:Landroid/widget/Button;

    iget-object v5, p0, mButtonNeutral:Landroid/widget/Button;

    iget-object v6, p0, mButtonHandler:Landroid/view/View$OnClickListener;

    invoke-virtual {v5, v6}, Landroid/widget/Button;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v5, p0, mButtonNeutralText:Ljava/lang/CharSequence;
    ...
    iget-object v5, p0, mButtonNeutralIcon:Landroid/graphics/drawable/Drawable;

    if-nez v5, :cond_4

    iget-object v3, p0, mButtonNeutral:Landroid/widget/Button;
    ...
    iget-object v5, p0, mButtonPositive:Landroid/widget/Button;

    iget-object v6, p0, mButtonPositiveIcon:Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v3}, shouldCenterSingleButton(Landroid/content/Context;)Z
    ...
    iget-object v3, p0, mButtonPositive:Landroid/widget/Button;

    invoke-direct {p0, v3}, centerButton(Landroid/widget/Button;)V
    ...
    iget-object v3, p0, mButtonNegative:Landroid/widget/Button;
...
.method private setupContent(Landroid/view/ViewGroup;)V
    ...
    iput-object v0, p0, mScrollView:Landroidx/core/widget/NestedScrollView;

    iget-object v0, p0, mScrollView:Landroidx/core/widget/NestedScrollView;
    ...
    iget-object p0, p0, mListView:Landroid/widget/ListView;
...
.method private setupCustomContent(Landroid/view/ViewGroup;)V
    ...
    invoke-static {v0}, canTextInput(Landroid/view/View;)Z
    ...
    iget v0, p0, mViewSpacingLeft:I

    iget v2, p0, mViewSpacingTop:I

    iget v3, p0, mViewSpacingRight:I

    iget v4, p0, mViewSpacingBottom:I
...
.method private setupTitle(Landroid/view/ViewGroup;)V
    ...
    iget-object v2, p0, mCustomTitleView:Landroid/view/View;
    ...
    iget-boolean v0, p0, mShowTitle:Z
    ...
    :cond_1
    iget-object p1, p0, mIcon:Landroid/graphics/drawable/Drawable;
...
.method private setupView()V
    ...
    invoke-direct {p0, v0}, setupCustomContent(Landroid/view/ViewGroup;)V
    ...
    invoke-direct {p0, v4, v1}, resolvePanel(Landroid/view/View;Landroid/view/View;)Landroid/view/ViewGroup;

    move-result-object v1

    invoke-direct {p0, v5, v2}, resolvePanel(Landroid/view/View;Landroid/view/View;)Landroid/view/ViewGroup;

    move-result-object v2

    invoke-direct {p0, v6, v3}, resolvePanel(Landroid/view/View;Landroid/view/View;)Landroid/view/ViewGroup;

    move-result-object v3

    invoke-direct {p0, v2}, setupContent(Landroid/view/ViewGroup;)V

    invoke-direct {p0, v3}, setupButtons(Landroid/view/ViewGroup;)V

    invoke-direct {p0, v1}, setupTitle(Landroid/view/ViewGroup;)V
    ...
    iget-object v4, p0, mScrollView:Landroidx/core/widget/NestedScrollView;
    ...
    iget-object v8, p0, mMessage:Ljava/lang/CharSequence;

    if-nez v8, :cond_5

    iget-object v8, p0, mListView:Landroid/widget/ListView;
    ...
    invoke-direct {p0, v2, v0, v1, v3}, setScrollIndicators(Landroid/view/ViewGroup;Landroid/view/View;II)V
...
.method public installContent()V
    ...
    iget-object v1, p0, mDialog:Landroidx/appcompat/app/AppCompatDialog;
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    iget-object p0, p0, mScrollView:Landroidx/core/widget/NestedScrollView;
...
.method public setButton(ILjava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;Landroid/os/Message;Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object p5, p0, mButtonPositiveIcon:Landroid/graphics/drawable/Drawable;
    ...
    iput-object p5, p0, mButtonNegativeIcon:Landroid/graphics/drawable/Drawable;
    ...
    iput-object p5, p0, mButtonNeutralIcon:Landroid/graphics/drawable/Drawable;
...
.method public setMessage(Ljava/lang/CharSequence;)V
    ...
    iget-object p0, p0, mMessageView:Landroid/widget/TextView;
...
.method public setView(I)V
    ...
    iput-boolean p1, p0, mViewSpacingSpecified:Z
