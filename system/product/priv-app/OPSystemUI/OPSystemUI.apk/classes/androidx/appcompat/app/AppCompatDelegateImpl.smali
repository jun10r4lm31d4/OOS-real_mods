...
.method static constructor <clinit>()V
    ...
    sput-object v0, sLocalNightModes:Ljava/util/Map;
    ...
    :goto_0
    sput-boolean v0, IS_PRE_LOLLIPOP:Z
    ...
    sput-object v0, sWindowBackgroundStyleable:[I

    sget-boolean v0, IS_PRE_LOLLIPOP:Z

    if-eqz v0, :cond_1

    sget-boolean v0, sInstalledExceptionHandler:Z
    ...
    sput-boolean v2, sInstalledExceptionHandler:Z
...
.method constructor <init>(Landroid/app/Activity;Landroidx/appcompat/app/AppCompatCallback;)V
    ...
    invoke-direct {p0, p1, v0, p2, p1}, <init>(Landroid/content/Context;Landroid/view/Window;Landroidx/appcompat/app/AppCompatCallback;Ljava/lang/Object;)V
...
.method constructor <init>(Landroid/app/Dialog;Landroidx/appcompat/app/AppCompatCallback;)V
    ...
    invoke-direct {p0, v0, v1, p2, p1}, <init>(Landroid/content/Context;Landroid/view/Window;Landroidx/appcompat/app/AppCompatCallback;Ljava/lang/Object;)V
...
.method private constructor <init>(Landroid/content/Context;Landroid/view/Window;Landroidx/appcompat/app/AppCompatCallback;Ljava/lang/Object;)V
    ...
    iput-object v0, p0, mFadeAnim:Landroidx/core/view/ViewPropertyAnimatorCompat;

    const/4 v0, 0x1

    iput-boolean v0, p0, mHandleNativeActionModes:Z

    const/16 v0, -0x64

    iput v0, p0, mLocalNightMode:I
    ...
    iput-object v1, p0, mInvalidatePanelMenuRunnable:Ljava/lang/Runnable;

    iput-object p1, p0, mContext:Landroid/content/Context;

    iput-object p3, p0, mAppCompatCallback:Landroidx/appcompat/app/AppCompatCallback;

    iput-object p4, p0, mHost:Ljava/lang/Object;

    iget p1, p0, mLocalNightMode:I

    if-ne p1, v0, :cond_0

    iget-object p1, p0, mHost:Ljava/lang/Object;

    instance-of p1, p1, Landroid/app/Dialog;

    if-eqz p1, :cond_0

    invoke-direct {p0}, tryUnwrapContext()Landroidx/appcompat/app/AppCompatActivity;
    ...
    sget-object p1, sLocalNightModes:Ljava/util/Map;

    iget-object p3, p0, mHost:Ljava/lang/Object;
    ...
    invoke-direct {p0, p2}, attachToWindow(Landroid/view/Window;)V
...
.method private applyDayNight(Z)Z
    ...
    iget-boolean v0, p0, mIsDestroyed:Z
    ...
    :cond_0
    invoke-direct {p0}, calculateNightMode()I

    move-result v0

    invoke-virtual {p0, v0}, mapNightMode(I)I

    move-result v1

    invoke-direct {p0, v1, p1}, updateForNightMode(IZ)Z

    move-result p1

    if-nez v0, :cond_1

    invoke-virtual {p0}, getAutoTimeNightModeManager()Landroidx/appcompat/app/AppCompatDelegateImpl$AutoNightModeManager;
    ...
    :cond_1
    iget-object v1, p0, mAutoTimeNightModeManager:Landroidx/appcompat/app/AppCompatDelegateImpl$AutoNightModeManager;
    ...
    invoke-direct {p0}, getAutoBatteryNightModeManager()Landroidx/appcompat/app/AppCompatDelegateImpl$AutoNightModeManager;
    ...
    :cond_3
    iget-object p0, p0, mAutoBatteryNightModeManager:Landroidx/appcompat/app/AppCompatDelegateImpl$AutoNightModeManager;
...
.method private applyFixedSizeWindow()V
    ...
    iget-object v0, p0, mSubDecor:Landroid/view/ViewGroup;
...
.method private attachToWindow(Landroid/view/Window;)V
    ...
    iput-object v1, p0, mAppCompatWindowCallback:Landroidx/appcompat/app/AppCompatDelegateImpl$AppCompatWindowCallback;

    iget-object v0, p0, mAppCompatWindowCallback:Landroidx/appcompat/app/AppCompatDelegateImpl$AppCompatWindowCallback;
    ...
    sget-object v2, sWindowBackgroundStyleable:[I
    ...
    iput-object p1, p0, mWindow:Landroid/view/Window;
...
.method private createSubDecor()Landroid/view/ViewGroup;
    ...
    invoke-virtual {p0, v3}, requestWindowFeature(I)Z
    ...
    invoke-virtual {p0, v1}, requestWindowFeature(I)Z
    ...
    invoke-virtual {p0, v4}, requestWindowFeature(I)Z
    ...
    iput-boolean v1, p0, mIsFloating:Z

    invoke-virtual {v0}, Landroid/content/res/TypedArray;->recycle()V

    invoke-direct {p0}, ensureWindow()V
    ...
    iget-boolean v1, p0, mWindowNoTitle:Z

    const/4 v5, 0x0

    if-nez v1, :cond_9

    iget-boolean v1, p0, mIsFloating:Z
    ...
    iput-boolean v2, p0, mOverlayActionBar:Z

    iput-boolean v2, p0, mHasActionBar:Z

    goto/16 :goto_3

    :cond_4
    iget-boolean v0, p0, mHasActionBar:Z
    ...
    iput-object v1, p0, mDecorContentParent:Landroidx/appcompat/widget/DecorContentParent;

    iget-object v1, p0, mDecorContentParent:Landroidx/appcompat/widget/DecorContentParent;

    invoke-virtual {p0}, getWindowCallback()Landroid/view/Window$Callback;
    ...
    iget-boolean v1, p0, mOverlayActionBar:Z
    ...
    :cond_6
    iget-boolean v1, p0, mFeatureProgress:Z
    ...
    :cond_7
    iget-boolean v1, p0, mFeatureIndeterminateProgress:Z
    ...
    :cond_9
    iget-boolean v1, p0, mOverlayActionMode:Z
    ...
    iget-boolean v2, p0, mHasActionBar:Z
    ...
    iget-boolean v2, p0, mOverlayActionBar:Z
    ...
    iget-boolean v2, p0, mIsFloating:Z
    ...
    iget-boolean v2, p0, mOverlayActionMode:Z
    ...
    iget-boolean p0, p0, mWindowNoTitle:Z
...
.method private ensureSubDecor()V
    ...
    iget-boolean v0, p0, mSubDecorInstalled:Z

    if-nez v0, :cond_4

    invoke-direct {p0}, createSubDecor()Landroid/view/ViewGroup;

    move-result-object v0

    iput-object v0, p0, mSubDecor:Landroid/view/ViewGroup;
    ...
    :cond_0
    invoke-virtual {p0}, peekSupportActionBar()Landroidx/appcompat/app/ActionBar;
    ...
    :cond_2
    :goto_0
    invoke-direct {p0}, applyFixedSizeWindow()V

    iget-object v0, p0, mSubDecor:Landroid/view/ViewGroup;

    invoke-virtual {p0, v0}, onSubDecorInstalled(Landroid/view/ViewGroup;)V

    const/4 v0, 0x1

    iput-boolean v0, p0, mSubDecorInstalled:Z

    const/4 v0, 0x0

    invoke-virtual {p0, v0, v0}, getPanelState(IZ)Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;
    ...
    invoke-direct {p0, v0}, invalidatePanelMenu(I)V
...
.method private ensureWindow()V
    ...
    iget-object v0, p0, mHost:Ljava/lang/Object;
    ...
    invoke-direct {p0, v0}, attachToWindow(Landroid/view/Window;)V

    :cond_0
    iget-object p0, p0, mWindow:Landroid/view/Window;
...
.method private getAutoBatteryNightModeManager()Landroidx/appcompat/app/AppCompatDelegateImpl$AutoNightModeManager;
    ...
    iget-object v0, p0, mAutoBatteryNightModeManager:Landroidx/appcompat/app/AppCompatDelegateImpl$AutoNightModeManager;
    ...
    iput-object v0, p0, mAutoBatteryNightModeManager:Landroidx/appcompat/app/AppCompatDelegateImpl$AutoNightModeManager;
...
.method private initWindowDecorActionBar()V
    ...
    invoke-direct {p0}, ensureSubDecor()V

    iget-boolean v0, p0, mHasActionBar:Z

    if-eqz v0, :cond_3

    iget-object v0, p0, mActionBar:Landroidx/appcompat/app/ActionBar;
    ...
    iput-object v1, p0, mActionBar:Landroidx/appcompat/app/ActionBar;
    ...
    iget-boolean p0, p0, mEnableDefaultActionBarUp:Z
...
.method private initializePanelContent(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;)Z
    ...
    :cond_1
    iget-object v0, p0, mPanelMenuPresenterCallback:Landroidx/appcompat/app/AppCompatDelegateImpl$PanelMenuPresenterCallback;
    ...
    iput-object v0, p0, mPanelMenuPresenterCallback:Landroidx/appcompat/app/AppCompatDelegateImpl$PanelMenuPresenterCallback;

    :cond_2
    iget-object p0, p0, mPanelMenuPresenterCallback:Landroidx/appcompat/app/AppCompatDelegateImpl$PanelMenuPresenterCallback;
...
.method private initializePanelDecor(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;)Z
    ...
    invoke-virtual {p0}, getActionBarThemedContext()Landroid/content/Context;
...
.method private invalidatePanelMenu(I)V
    ...
    iget-boolean p1, p0, mInvalidatePanelMenuPosted:Z

    if-nez p1, :cond_0

    iget-object p1, p0, mWindow:Landroid/view/Window;
    ...
    iput-boolean v1, p0, mInvalidatePanelMenuPosted:Z
...
.method private isActivityManifestHandlingUiMode()Z
    ...
    iget-boolean v0, p0, mActivityHandlesUiModeChecked:Z
    ...
    iget-object v5, p0, mHost:Ljava/lang/Object;
    ...
    :goto_0
    iput-boolean v0, p0, mActivityHandlesUiMode:Z
    :try_end_0
    ...
    iput-boolean v2, p0, mActivityHandlesUiMode:Z

    :cond_2
    :goto_1
    iput-boolean v1, p0, mActivityHandlesUiModeChecked:Z

    iget-boolean p0, p0, mActivityHandlesUiMode:Z
...
.method private onKeyDownPanel(ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {p0, p1, v0}, getPanelState(IZ)Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;
    ...
    invoke-direct {p0, p1, p2}, preparePanel(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;Landroid/view/KeyEvent;)Z
...
.method private onKeyUpPanel(ILandroid/view/KeyEvent;)Z
    ...
    iget-object v0, p0, mActionMode:Landroidx/appcompat/view/ActionMode;
    ...
    iget-object p1, p0, mDecorContentParent:Landroidx/appcompat/widget/DecorContentParent;
    ...
    iget-boolean p1, p0, mIsDestroyed:Z

    if-nez p1, :cond_5

    invoke-direct {p0, v2, p2}, preparePanel(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;Landroid/view/KeyEvent;)Z
    ...
    invoke-direct {p0, v2, p2}, openPanel(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;Landroid/view/KeyEvent;)V
    ...
    invoke-virtual {p0, v2, v0}, closePanel(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;Z)V
...
.method private openPanel(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;Landroid/view/KeyEvent;)V
    ...
    invoke-virtual {p0, p1, v2}, closePanel(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;Z)V
    ...
    invoke-direct {p0, p1}, initializePanelDecor(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;)Z
    ...
    :cond_a
    invoke-direct {p0, p1}, initializePanelContent(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;)Z
...
.method private performPanelShortcut(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;ILandroid/view/KeyEvent;I)Z
    ...
    invoke-direct {p0, p1, p3}, preparePanel(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;Landroid/view/KeyEvent;)Z
    ...
    iget-object p3, p0, mDecorContentParent:Landroidx/appcompat/widget/DecorContentParent;

    if-nez p3, :cond_3

    invoke-virtual {p0, p1, p2}, closePanel(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;Z)V
...
.method private preparePanel(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;Landroid/view/KeyEvent;)Z
    ...
    :cond_1
    iget-object v0, p0, mPreparedPanel:Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;

    if-eqz v0, :cond_2

    if-eq v0, p1, :cond_2

    invoke-virtual {p0, v0, v1}, closePanel(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;Z)V
    ...
    iget-object v4, p0, mDecorContentParent:Landroidx/appcompat/widget/DecorContentParent;
    ...
    invoke-direct {p0, p1}, initializePanelMenu(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;)Z
    ...
    iget-object v4, p0, mActionMenuPresenterCallback:Landroidx/appcompat/app/AppCompatDelegateImpl$ActionMenuPresenterCallback;
    ...
    iput-object v4, p0, mActionMenuPresenterCallback:Landroidx/appcompat/app/AppCompatDelegateImpl$ActionMenuPresenterCallback;
    ...
    iget-object v7, p0, mActionMenuPresenterCallback:Landroidx/appcompat/app/AppCompatDelegateImpl$ActionMenuPresenterCallback;
    ...
    iget-object p0, p0, mActionMenuPresenterCallback:Landroidx/appcompat/app/AppCompatDelegateImpl$ActionMenuPresenterCallback;
    ...
    iget-object p2, p0, mDecorContentParent:Landroidx/appcompat/widget/DecorContentParent;
    ...
    iput-object p1, p0, mPreparedPanel:Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;
...
.method private reopenMenu(Landroidx/appcompat/view/menu/MenuBuilder;Z)V
    ...
    iget-object v2, p0, mDecorContentParent:Landroidx/appcompat/widget/DecorContentParent;
    ...
    iget-boolean p2, p0, mIsDestroyed:Z

    if-nez p2, :cond_4

    invoke-virtual {p0, v1, v0}, getPanelState(IZ)Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;
    ...
    iget-boolean p2, p0, mInvalidatePanelMenuPosted:Z

    if-eqz p2, :cond_3

    iget p2, p0, mInvalidatePanelMenuFeatures:I

    and-int/2addr p2, v0

    if-eqz p2, :cond_3

    iget-object p2, p0, mWindow:Landroid/view/Window;

    invoke-virtual {p2}, Landroid/view/Window;->getDecorView()Landroid/view/View;

    move-result-object p2

    iget-object v2, p0, mInvalidatePanelMenuRunnable:Ljava/lang/Runnable;

    invoke-virtual {p2, v2}, Landroid/view/View;->removeCallbacks(Ljava/lang/Runnable;)Z

    iget-object p2, p0, mInvalidatePanelMenuRunnable:Ljava/lang/Runnable;
    ...
    iget-object p0, p0, mDecorContentParent:Landroidx/appcompat/widget/DecorContentParent;
    ...
    invoke-virtual {p0, p1, v1}, closePanel(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;Z)V

    const/4 p2, 0x0

    invoke-direct {p0, p1, p2}, openPanel(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;Landroid/view/KeyEvent;)V
...
.method private throwFeatureRequestIfSubDecorInstalled()V
    ...
    iget-boolean p0, p0, mSubDecorInstalled:Z
...
.method private updateForNightMode(IZ)Z
    ...
    :goto_0
    invoke-direct {p0}, isActivityManifestHandlingUiMode()Z
    ...
    iget-boolean v0, p0, mBaseContextAttached:Z
    ...
    :try_start_0
    iget-object v6, p0, mHost:Ljava/lang/Object;
    ...
    iget-boolean p2, p0, mBaseContextAttached:Z
    ...
    iget-boolean p2, p0, mCreated:Z

    if-eqz p2, :cond_4

    :cond_3
    iget-object p2, p0, mHost:Ljava/lang/Object;
    ...
    invoke-direct {p0, v2}, updateResourcesConfigurationForNightMode(I)V
    ...
    :cond_6
    iget-object p0, p0, mHost:Ljava/lang/Object;
...
.method public addContentView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    iget-object p0, p0, mAppCompatWindowCallback:Landroidx/appcompat/app/AppCompatDelegateImpl$AppCompatWindowCallback;
...
.method public applyDayNight()Z
    ...
    invoke-direct {p0, v0}, applyDayNight(Z)Z
...
.method public attachBaseContext(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1}, applyDayNight(Z)Z

    const/4 p1, 0x1

    iput-boolean p1, p0, mBaseContextAttached:Z
...
.method callOnPanelClosed(ILandroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;Landroid/view/Menu;)V
    ...
    iget-object v0, p0, mPanels:[Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;
...
.method checkCloseActionMenu(Landroidx/appcompat/view/menu/MenuBuilder;)V
    ...
    iget-object v0, p0, mDecorContentParent:Landroidx/appcompat/widget/DecorContentParent;
    ...
    iput-boolean p1, p0, mClosingActionMenu:Z
...
.method closePanel(I)V
    ...
    invoke-virtual {p0, p1, v0}, closePanel(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;Z)V
...
.method closePanel(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;Z)V
    ...
    invoke-virtual {p0, p1}, checkCloseActionMenu(Landroidx/appcompat/view/menu/MenuBuilder;)V
    ...
    invoke-virtual {p0, p2, p1, v1}, callOnPanelClosed(ILandroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;Landroid/view/Menu;)V
    ...
    iget-object p2, p0, mPreparedPanel:Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;

    if-ne p2, p1, :cond_2

    iput-object v1, p0, mPreparedPanel:Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;
...
.method public createView(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    iget-object v0, p0, mAppCompatViewInflater:Landroidx/appcompat/app/AppCompatViewInflater;
    ...
    iput-object v2, p0, mAppCompatViewInflater:Landroidx/appcompat/app/AppCompatViewInflater;
    :try_end_0
    ...
    iput-object v0, p0, mAppCompatViewInflater:Landroidx/appcompat/app/AppCompatViewInflater;
    ...
    invoke-direct {p0, v0}, shouldInheritContext(Landroid/view/ViewParent;)Z
    ...
    iget-object v2, p0, mAppCompatViewInflater:Landroidx/appcompat/app/AppCompatViewInflater;

    sget-boolean v8, IS_PRE_LOLLIPOP:Z
...
.method dismissPopups()V
    ...
    iget-object v1, p0, mShowActionModePopup:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mActionModePopup:Landroid/widget/PopupWindow;

    :cond_2
    invoke-virtual {p0}, endOnGoingFadeAnimation()V
...
.method dispatchKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    invoke-virtual {p0, v0, p1}, onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    :cond_4
    invoke-virtual {p0, v0, p1}, onKeyUp(ILandroid/view/KeyEvent;)Z
...
.method doInvalidatePanelMenu(I)V
    ...
    invoke-virtual {p0, p1, p1}, getPanelState(IZ)Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;
    ...
    invoke-direct {p0, v0, p1}, preparePanel(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;Landroid/view/KeyEvent;)Z
...
.method endOnGoingFadeAnimation()V
    ...
    iget-object p0, p0, mFadeAnim:Landroidx/core/view/ViewPropertyAnimatorCompat;
...
.method findMenuPanel(Landroid/view/Menu;)Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;
    ...
    iget-object p0, p0, mPanels:[Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;
...
.method final getActionBarThemedContext()Landroid/content/Context;
    ...
    invoke-virtual {p0}, getSupportActionBar()Landroidx/appcompat/app/ActionBar;
...
.method final getAutoTimeNightModeManager()Landroidx/appcompat/app/AppCompatDelegateImpl$AutoNightModeManager;
    ...
    iget-object v0, p0, mAutoTimeNightModeManager:Landroidx/appcompat/app/AppCompatDelegateImpl$AutoNightModeManager;
    ...
    iput-object v0, p0, mAutoTimeNightModeManager:Landroidx/appcompat/app/AppCompatDelegateImpl$AutoNightModeManager;

    :cond_0
    iget-object p0, p0, mAutoTimeNightModeManager:Landroidx/appcompat/app/AppCompatDelegateImpl$AutoNightModeManager;
...
.method public getMenuInflater()Landroid/view/MenuInflater;
    ...
    iget-object v0, p0, mMenuInflater:Landroid/view/MenuInflater;

    if-nez v0, :cond_1

    invoke-direct {p0}, initWindowDecorActionBar()V

    new-instance v0, Landroidx/appcompat/view/SupportMenuInflater;

    iget-object v1, p0, mActionBar:Landroidx/appcompat/app/ActionBar;
    ...
    iput-object v0, p0, mMenuInflater:Landroid/view/MenuInflater;

    :cond_1
    iget-object p0, p0, mMenuInflater:Landroid/view/MenuInflater;
...
.method protected getPanelState(IZ)Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;
    ...
    iget-object p2, p0, mPanels:[Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;
    ...
    :cond_1
    iput-object v0, p0, mPanels:[Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;
...
.method public getSupportActionBar()Landroidx/appcompat/app/ActionBar;
    ...
    iget-object p0, p0, mActionBar:Landroidx/appcompat/app/ActionBar;
...
.method public isHandleNativeActionModesEnabled()Z
    ...
    iget-boolean p0, p0, mHandleNativeActionModes:Z
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-boolean p1, p0, mEnableDefaultActionBarUp:Z
...
.method public final onCreateView(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, createView(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
...
.method public onDestroy()V
    ...
    iput-boolean v0, p0, mIsDestroyed:Z
...
.method onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    :cond_0
    invoke-direct {p0, v2, p2}, onKeyDownPanel(ILandroid/view/KeyEvent;)Z
    ...
    :goto_0
    iput-boolean v1, p0, mLongPressBackDown:Z
...
.method onKeyShortcut(ILandroid/view/KeyEvent;)Z
    ...
    :cond_0
    iget-object p1, p0, mPreparedPanel:Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;
    ...
    invoke-direct {p0, p1, v0, p2, v1}, performPanelShortcut(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;ILandroid/view/KeyEvent;I)Z

    move-result p1

    if-eqz p1, :cond_2

    iget-object p0, p0, mPreparedPanel:Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;
    ...
    invoke-virtual {p0, v0, v1}, getPanelState(IZ)Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;
    ...
    invoke-direct {p0, p1, v2, p2, v1}, performPanelShortcut(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;ILandroid/view/KeyEvent;I)Z
...
.method onKeyUp(ILandroid/view/KeyEvent;)Z
    ...
    :cond_0
    invoke-direct {p0, v2, p2}, onKeyUpPanel(ILandroid/view/KeyEvent;)Z

    return v1

    :cond_1
    iget-boolean p1, p0, mLongPressBackDown:Z

    iput-boolean v2, p0, mLongPressBackDown:Z

    invoke-virtual {p0, v2, v2}, getPanelState(IZ)Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;
    ...
    invoke-virtual {p0, p2, v1}, closePanel(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;Z)V

    :cond_2
    return v1

    :cond_3
    invoke-virtual {p0}, onBackPressed()Z
...
.method public onMenuItemSelected(Landroidx/appcompat/view/menu/MenuBuilder;Landroid/view/MenuItem;)Z
    ...
    invoke-virtual {p0, p1}, findMenuPanel(Landroid/view/Menu;)Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;
...
.method public onMenuModeChange(Landroidx/appcompat/view/menu/MenuBuilder;)V
    ...
    invoke-direct {p0, p1, v0}, reopenMenu(Landroidx/appcompat/view/menu/MenuBuilder;Z)V
...
.method onPanelClosed(I)V
    ...
    invoke-virtual {p0, p1, v1}, getPanelState(IZ)Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;
...
.method public onStart()V
    ...
    invoke-virtual {p0}, applyDayNight()Z
...
.method public requestWindowFeature(I)Z
    ...
    invoke-direct {p0, p1}, sanitizeWindowFeatureId(I)I

    move-result p1

    iget-boolean v0, p0, mWindowNoTitle:Z
    ...
    iput-boolean v1, p0, mHasActionBar:Z
    ...
    :cond_2
    invoke-direct {p0}, throwFeatureRequestIfSubDecorInstalled()V

    iput-boolean v3, p0, mOverlayActionBar:Z
    ...
    iput-boolean v3, p0, mHasActionBar:Z
    ...
    iput-boolean v3, p0, mOverlayActionMode:Z
    ...
    iput-boolean v3, p0, mFeatureIndeterminateProgress:Z
    ...
    iput-boolean v3, p0, mFeatureProgress:Z
    ...
    iput-boolean v3, p0, mWindowNoTitle:Z
...
.method final shouldAnimateActionModeView()Z
    ...
    iget-object p0, p0, mSubDecor:Landroid/view/ViewGroup;
...
.method public startSupportActionMode(Landroidx/appcompat/view/ActionMode$Callback;)Landroidx/appcompat/view/ActionMode;
    ...
    iput-object p1, p0, mActionMode:Landroidx/appcompat/view/ActionMode;

    iget-object p1, p0, mActionMode:Landroidx/appcompat/view/ActionMode;

    if-eqz p1, :cond_1

    iget-object v1, p0, mAppCompatCallback:Landroidx/appcompat/app/AppCompatCallback;
    ...
    invoke-virtual {p0, v0}, startSupportActionModeFromWindow(Landroidx/appcompat/view/ActionMode$Callback;)Landroidx/appcompat/view/ActionMode;
    ...
    :cond_2
    iget-object p0, p0, mActionMode:Landroidx/appcompat/view/ActionMode;
...
.method startSupportActionModeFromWindow(Landroidx/appcompat/view/ActionMode$Callback;)Landroidx/appcompat/view/ActionMode;
    ...
    :cond_1
    iget-object v0, p0, mAppCompatCallback:Landroidx/appcompat/app/AppCompatCallback;
    ...
    iput-object v0, p0, mActionMode:Landroidx/appcompat/view/ActionMode;

    goto/16 :goto_5

    :cond_3
    iget-object v0, p0, mActionModeView:Landroidx/appcompat/widget/ActionBarContextView;
    ...
    iput-object v5, p0, mActionModeView:Landroidx/appcompat/widget/ActionBarContextView;
    ...
    iput-object v5, p0, mActionModePopup:Landroid/widget/PopupWindow;

    iget-object v5, p0, mActionModePopup:Landroid/widget/PopupWindow;
    ...
    iget-object v6, p0, mActionModeView:Landroidx/appcompat/widget/ActionBarContextView;
    ...
    iget-object v4, p0, mActionModeView:Landroidx/appcompat/widget/ActionBarContextView;
    ...
    iput-object v0, p0, mShowActionModePopup:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mActionModeView:Landroidx/appcompat/widget/ActionBarContextView;
    ...
    iget-object v5, p0, mActionModeView:Landroidx/appcompat/widget/ActionBarContextView;

    iget-object v6, p0, mActionModePopup:Landroid/widget/PopupWindow;
    ...
    iget-object p1, p0, mActionModeView:Landroidx/appcompat/widget/ActionBarContextView;

    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/ActionBarContextView;->initForMode(Landroidx/appcompat/view/ActionMode;)V

    iput-object v0, p0, mActionMode:Landroidx/appcompat/view/ActionMode;

    invoke-virtual {p0}, shouldAnimateActionModeView()Z
    ...
    iput-object p1, p0, mFadeAnim:Landroidx/core/view/ViewPropertyAnimatorCompat;

    iget-object p1, p0, mFadeAnim:Landroidx/core/view/ViewPropertyAnimatorCompat;
    ...
    :cond_9
    :goto_4
    iget-object p1, p0, mActionModePopup:Landroid/widget/PopupWindow;
    ...
    :cond_a
    iput-object v1, p0, mActionMode:Landroidx/appcompat/view/ActionMode;
...
.method updateStatusGuard(I)I
    ...
    iget-object v2, p0, mActionModeView:Landroidx/appcompat/widget/ActionBarContextView;
    ...
    iput-object v2, p0, mTempRect1:Landroid/graphics/Rect;

    new-instance v2, Landroid/graphics/Rect;

    invoke-direct {v2}, Landroid/graphics/Rect;-><init>()V

    iput-object v2, p0, mTempRect2:Landroid/graphics/Rect;
    ...
    iget-object v5, p0, mSubDecor:Landroid/view/ViewGroup;
    ...
    iget-object v2, p0, mStatusGuard:Landroid/view/View;
    ...
    iput-object v2, p0, mStatusGuard:Landroid/view/View;
    ...
    iget-object v2, p0, mSubDecor:Landroid/view/ViewGroup;

    iget-object v4, p0, mStatusGuard:Landroid/view/View;
    ...
    :goto_3
    iget-boolean v4, p0, mOverlayActionMode:Z
    ...
    :cond_a
    :goto_5
    iget-object p0, p0, mStatusGuard:Landroid/view/View;
