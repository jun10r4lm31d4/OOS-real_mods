...
.method constructor <init>(Landroidx/appcompat/view/menu/CascadingMenuPopup$3;Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;Landroid/view/MenuItem;Landroidx/appcompat/view/menu/MenuBuilder;)V
    ...
    iput-object p1, p0, this$1:Landroidx/appcompat/view/menu/CascadingMenuPopup$3;

    iput-object p2, p0, val$nextInfo:Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;

    iput-object p3, p0, val$item:Landroid/view/MenuItem;

    iput-object p4, p0, val$menu:Landroidx/appcompat/view/menu/MenuBuilder;
...
.method public run()V
    ...
    iget-object v0, p0, val$nextInfo:Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;

    if-eqz v0, :cond_0

    iget-object v1, p0, this$1:Landroidx/appcompat/view/menu/CascadingMenuPopup$3;
    ...
    iget-object v0, p0, this$1:Landroidx/appcompat/view/menu/CascadingMenuPopup$3;
    ...
    :cond_0
    iget-object v0, p0, val$item:Landroid/view/MenuItem;
    ...
    iget-object v0, p0, val$menu:Landroidx/appcompat/view/menu/MenuBuilder;

    iget-object p0, p0, val$item:Landroid/view/MenuItem;
