...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, mStructureChangedWhileDispatchPrevented:Z
    ...
    iput-object v1, p0, mTempShortcutItemList:Ljava/util/ArrayList;

    new-instance v1, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v1}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v1, p0, mPresenters:Ljava/util/concurrent/CopyOnWriteArrayList;

    iput-boolean v0, p0, mGroupDividerEnabled:Z
    ...
    iput-object p1, p0, mVisibleItems:Ljava/util/ArrayList;

    const/4 p1, 0x1

    iput-boolean p1, p0, mIsVisibleItemsStale:Z
    ...
    iput-boolean p1, p0, mIsActionItemsStale:Z
...
.method private dispatchPresenterUpdate(Z)V
    ...
    iget-object v2, p0, mPresenters:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method private dispatchSubMenuSelected(Landroidx/appcompat/view/menu/SubMenuBuilder;Landroidx/appcompat/view/menu/MenuPresenter;)Z
    ...
    :cond_1
    iget-object p2, p0, mPresenters:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method private removeItemAtInt(IZ)V
    ...
    invoke-virtual {p0, p1}, onItemsChanged(Z)V
...
.method private setHeaderInternal(ILjava/lang/CharSequence;ILandroid/graphics/drawable/Drawable;Landroid/view/View;)V
    ...
    iput-object p1, p0, mHeaderTitle:Ljava/lang/CharSequence;
    ...
    iput-object p1, p0, mHeaderIcon:Landroid/graphics/drawable/Drawable;
    ...
    :cond_4
    :goto_1
    iput-object v1, p0, mHeaderView:Landroid/view/View;
...
.method private setShortcutsVisibleInner(Z)V
    ...
    iget-object p1, p0, mResources:Landroid/content/res/Resources;
...
.method public add(I)Landroid/view/MenuItem;
    ...
    invoke-virtual {p0, v0, v0, v0, p1}, addInternal(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
...
.method public add(IIII)Landroid/view/MenuItem;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, addInternal(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
...
.method public addIntentOptions(IIILandroid/content/ComponentName;[Landroid/content/Intent;Landroid/content/Intent;I[Landroid/view/MenuItem;)I
    ...
    invoke-virtual {p0, p1, p2, p3, v4}, add(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
...
.method protected addInternal(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    invoke-direct/range {v0 .. v6}, createNewMenuItem(IIIILjava/lang/CharSequence;I)Landroidx/appcompat/view/menu/MenuItemImpl;

    move-result-object p1

    iget-object p2, p0, mCurrentMenuInfo:Landroid/view/ContextMenu$ContextMenuInfo;
    ...
    invoke-static {p2, v7}, findInsertIndex(Ljava/util/ArrayList;I)I
    ...
    invoke-virtual {p0, p2}, onItemsChanged(Z)V
...
.method public addMenuPresenter(Landroidx/appcompat/view/menu/MenuPresenter;)V
    ...
    invoke-virtual {p0, p1, v0}, addMenuPresenter(Landroidx/appcompat/view/menu/MenuPresenter;Landroid/content/Context;)V
...
.method public addSubMenu(IIII)Landroid/view/SubMenu;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, addSubMenu(IIILjava/lang/CharSequence;)Landroid/view/SubMenu;
...
.method public changeMenuMode()V
    ...
    iget-object v0, p0, mCallback:Landroidx/appcompat/view/menu/MenuBuilder$Callback;
...
.method public clear()V
    ...
    iget-object v0, p0, mExpandedItem:Landroidx/appcompat/view/menu/MenuItemImpl;

    if-eqz v0, :cond_0

    invoke-virtual {p0, v0}, collapseItemActionView(Landroidx/appcompat/view/menu/MenuItemImpl;)Z
...
.method public final close(Z)V
    ...
    iget-boolean v0, p0, mIsClosing:Z
    ...
    iput-boolean p1, p0, mIsClosing:Z
...
.method public collapseItemActionView(Landroidx/appcompat/view/menu/MenuItemImpl;)Z
    ...
    iput-object p1, p0, mExpandedItem:Landroidx/appcompat/view/menu/MenuItemImpl;
...
.method dispatchMenuItemSelected(Landroidx/appcompat/view/menu/MenuBuilder;Landroid/view/MenuItem;)Z
    ...
    iget-object p0, p0, mCallback:Landroidx/appcompat/view/menu/MenuBuilder$Callback;
...
.method findItemWithShortcutForKey(ILandroid/view/KeyEvent;)Landroidx/appcompat/view/menu/MenuItemImpl;
    ...
    iget-object v0, p0, mTempShortcutItemList:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    invoke-virtual {p0, v0, p1, p2}, findItemsWithShortcutForKey(Ljava/util/List;ILandroid/view/KeyEvent;)V
...
.method public flagActionItems()V
    ...
    iget-boolean v1, p0, mIsActionItemsStale:Z
    ...
    :cond_0
    iget-object v1, p0, mPresenters:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iget-object v1, p0, mActionItems:Ljava/util/ArrayList;

    invoke-virtual {v1}, Ljava/util/ArrayList;->clear()V

    iget-object v1, p0, mNonActionItems:Ljava/util/ArrayList;
    ...
    iget-object v5, p0, mActionItems:Ljava/util/ArrayList;
    ...
    :cond_3
    iget-object v5, p0, mNonActionItems:Ljava/util/ArrayList;
    ...
    :cond_5
    iput-boolean v2, p0, mIsActionItemsStale:Z
...
.method public getActionItems()Ljava/util/ArrayList;
    ...
    iget-object p0, p0, mActionItems:Ljava/util/ArrayList;
...
.method public getExpandedItem()Landroidx/appcompat/view/menu/MenuItemImpl;
    ...
    iget-object p0, p0, mExpandedItem:Landroidx/appcompat/view/menu/MenuItemImpl;
...
.method public getHeaderIcon()Landroid/graphics/drawable/Drawable;
    ...
    iget-object p0, p0, mHeaderIcon:Landroid/graphics/drawable/Drawable;
...
.method public getHeaderTitle()Ljava/lang/CharSequence;
    ...
    iget-object p0, p0, mHeaderTitle:Ljava/lang/CharSequence;
...
.method public getHeaderView()Landroid/view/View;
    ...
    iget-object p0, p0, mHeaderView:Landroid/view/View;
...
.method public getNonActionItems()Ljava/util/ArrayList;
    ...
    iget-object p0, p0, mNonActionItems:Ljava/util/ArrayList;
...
.method getOptionalIconsVisible()Z
    ...
    iget-boolean p0, p0, mOptionalIconsVisible:Z
...
.method getResources()Landroid/content/res/Resources;
    ...
    iget-object p0, p0, mResources:Landroid/content/res/Resources;
...
.method public getVisibleItems()Ljava/util/ArrayList;
    ...
    iget-boolean v0, p0, mIsVisibleItemsStale:Z

    if-nez v0, :cond_0

    iget-object p0, p0, mVisibleItems:Ljava/util/ArrayList;

    return-object p0

    :cond_0
    iget-object v0, p0, mVisibleItems:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, mVisibleItems:Ljava/util/ArrayList;
...
.method public hasVisibleItems()Z
    ...
    iget-boolean v0, p0, mOverrideVisibleItems:Z
...
.method public isGroupDividerEnabled()Z
    ...
    iget-boolean p0, p0, mGroupDividerEnabled:Z
...
.method isQwertyMode()Z
    ...
    iget-boolean p0, p0, mQwertyMode:Z
...
.method public isShortcutKey(ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {p0, p1, p2}, findItemWithShortcutForKey(ILandroid/view/KeyEvent;)Landroidx/appcompat/view/menu/MenuItemImpl;
...
.method public isShortcutsVisible()Z
    ...
    iget-boolean p0, p0, mShortcutsVisible:Z
...
.method public onItemsChanged(Z)V
    ...
    iput-boolean v1, p0, mStructureChangedWhileDispatchPrevented:Z
...
.method public performIdentifierAction(II)Z
    ...
    invoke-virtual {p0, p1, p2}, performItemAction(Landroid/view/MenuItem;I)Z
...
.method public performItemAction(Landroid/view/MenuItem;I)Z
    ...
    invoke-virtual {p0, p1, v0, p2}, performItemAction(Landroid/view/MenuItem;Landroidx/appcompat/view/menu/MenuPresenter;I)Z
...
.method public performItemAction(Landroid/view/MenuItem;Landroidx/appcompat/view/menu/MenuPresenter;I)Z
    ...
    invoke-virtual {p0, v3}, close(Z)V
    ...
    :cond_7
    invoke-direct {p0, p1, p2}, dispatchSubMenuSelected(Landroidx/appcompat/view/menu/SubMenuBuilder;Landroidx/appcompat/view/menu/MenuPresenter;)Z
...
.method public performShortcut(ILandroid/view/KeyEvent;I)Z
    ...
    invoke-virtual {p0, p1, p3}, performItemAction(Landroid/view/MenuItem;I)Z
    ...
    invoke-virtual {p0, p2}, close(Z)V
...
.method public removeGroup(I)V
    ...
    invoke-direct {p0, v0, v2}, removeItemAtInt(IZ)V
...
.method public restoreActionViewStates(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v2}, getItem(I)Landroid/view/MenuItem;
    ...
    invoke-virtual {v3, p1}, restoreActionViewStates(Landroid/os/Bundle;)V
...
.method public saveActionViewStates(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v3, p1}, saveActionViewStates(Landroid/os/Bundle;)V
...
.method public setCallback(Landroidx/appcompat/view/menu/MenuBuilder$Callback;)V
    ...
    iput-object p1, p0, mCallback:Landroidx/appcompat/view/menu/MenuBuilder$Callback;
...
.method public setGroupDividerEnabled(Z)V
    ...
    iput-boolean p1, p0, mGroupDividerEnabled:Z
...
.method public setGroupVisible(IZ)V
    ...
    invoke-virtual {p0, v3}, onItemsChanged(Z)V
...
.method public setOverrideVisibleItems(Z)V
    ...
    iput-boolean p1, p0, mOverrideVisibleItems:Z
...
.method public startDispatchingItemsChanged()V
    ...
    iget-boolean v1, p0, mItemsChangedWhileDispatchPrevented:Z

    if-eqz v1, :cond_0

    iput-boolean v0, p0, mItemsChangedWhileDispatchPrevented:Z

    iget-boolean v0, p0, mStructureChangedWhileDispatchPrevented:Z
