...
.method constructor <init>(Landroid/widget/SeekBar;)V
    ...
    iput-object v0, p0, mTickMarkTintList:Landroid/content/res/ColorStateList;

    iput-object v0, p0, mTickMarkTintMode:Landroid/graphics/PorterDuff$Mode;

    const/4 v0, 0x0

    iput-boolean v0, p0, mHasTickMarkTint:Z

    iput-boolean v0, p0, mHasTickMarkTintMode:Z

    iput-object p1, p0, mView:Landroid/widget/SeekBar;
...
.method private applyTickMarkTint()V
    ...
    iget-object v0, p0, mTickMark:Landroid/graphics/drawable/Drawable;

    if-eqz v0, :cond_3

    iget-boolean v0, p0, mHasTickMarkTint:Z

    if-nez v0, :cond_0

    iget-boolean v0, p0, mHasTickMarkTintMode:Z
    ...
    iput-object v0, p0, mTickMark:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, p0, mTickMarkTintList:Landroid/content/res/ColorStateList;
    ...
    iget-object v1, p0, mTickMarkTintMode:Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object p0, p0, mView:Landroid/widget/SeekBar;
...
.method drawTickMarks(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, mView:Landroid/widget/SeekBar;
    ...
    iget-object v2, p0, mTickMark:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v2}, Landroid/graphics/drawable/Drawable;->getIntrinsicWidth()I

    move-result v2

    iget-object v3, p0, mTickMark:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, p0, mView:Landroid/widget/SeekBar;

    invoke-virtual {v1}, Landroid/widget/SeekBar;->getWidth()I

    move-result v1

    iget-object v2, p0, mView:Landroid/widget/SeekBar;
    ...
    iget-object v3, p0, mView:Landroid/widget/SeekBar;
    ...
    iget-object v4, p0, mView:Landroid/widget/SeekBar;
    ...
    iget-object v4, p0, mTickMark:Landroid/graphics/drawable/Drawable;
...
.method jumpDrawablesToCurrentState()V
    ...
    iget-object p0, p0, mTickMark:Landroid/graphics/drawable/Drawable;
...
.method loadFromAttributes(Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {p0, p2}, setTickMark(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object p2, p0, mTickMarkTintMode:Landroid/graphics/PorterDuff$Mode;
    ...
    iput-object p2, p0, mTickMarkTintList:Landroid/content/res/ColorStateList;
    ...
    invoke-direct {p0}, applyTickMarkTint()V
...
.method setTickMark(Landroid/graphics/drawable/Drawable;)V
    ...
    :cond_0
    iput-object p1, p0, mTickMark:Landroid/graphics/drawable/Drawable;
