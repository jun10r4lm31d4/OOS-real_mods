...
.method constructor <init>(Landroid/content/Context;Landroid/location/LocationManager;)V
    ...
    iput-object v0, p0, mTwilightState:Landroidx/appcompat/app/TwilightManager$TwilightState;

    iput-object p1, p0, mContext:Landroid/content/Context;

    iput-object p2, p0, mLocationManager:Landroid/location/LocationManager;
...
.method static getInstance(Landroid/content/Context;)Landroidx/appcompat/app/TwilightManager;
    ...
    sget-object v0, sInstance:Landroidx/appcompat/app/TwilightManager;
    ...
    invoke-direct {v0, p0, v1}, <init>(Landroid/content/Context;Landroid/location/LocationManager;)V

    sput-object v0, sInstance:Landroidx/appcompat/app/TwilightManager;

    :cond_0
    sget-object p0, sInstance:Landroidx/appcompat/app/TwilightManager;
...
.method private getLastKnownLocation()Landroid/location/Location;
    ...
    invoke-direct {p0, v0}, getLastKnownLocationForProvider(Ljava/lang/String;)Landroid/location/Location;
    ...
    invoke-direct {p0, v1}, getLastKnownLocationForProvider(Ljava/lang/String;)Landroid/location/Location;
...
.method private isStateValid()Z
    ...
    iget-object p0, p0, mTwilightState:Landroidx/appcompat/app/TwilightManager$TwilightState;
...
.method static setInstance(Landroidx/appcompat/app/TwilightManager;)V
    ...
    sput-object p0, sInstance:Landroidx/appcompat/app/TwilightManager;
...
.method private updateState(Landroid/location/Location;)V
    ...
    iget-object v0, v0, mTwilightState:Landroidx/appcompat/app/TwilightManager$TwilightState;
...
.method isNight()Z
    ...
    iget-object v0, p0, mTwilightState:Landroidx/appcompat/app/TwilightManager$TwilightState;

    invoke-direct {p0}, isStateValid()Z
    ...
    :cond_0
    invoke-direct {p0}, getLastKnownLocation()Landroid/location/Location;

    move-result-object v1

    if-eqz v1, :cond_1

    invoke-direct {p0, v1}, updateState(Landroid/location/Location;)V
