...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0, v0}, <init>(Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;Landroid/content/res/Resources;)V
...
.method constructor <init>(Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;Landroid/content/res/Resources;)V
    ...
    iput v0, p0, mTransitionToIndex:I

    iput v0, p0, mTransitionFromIndex:I
    ...
    invoke-virtual {p0}, jumpToCurrentState()V
...
.method public static createFromXmlInner(Landroid/content/Context;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat;
    ...
    invoke-virtual/range {v2 .. v7}, inflate(Landroid/content/Context;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
...
.method private inflateChildElements(Landroid/content/Context;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    invoke-direct/range {p0 .. p5}, parseItem(Landroid/content/Context;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)I
    ...
    invoke-direct/range {p0 .. p5}, parseTransition(Landroid/content/Context;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)I
...
.method private init()V
    ...
    invoke-virtual {p0, v0}, onStateChange([I)Z
...
.method private parseItem(Landroid/content/Context;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)I
    ...
    iget-object p0, p0, mState:Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;
...
.method private selectTransition(I)Z
    ...
    iget-object v0, p0, mTransition:Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$Transition;

    const/4 v1, 0x1

    if-eqz v0, :cond_2

    iget v2, p0, mTransitionToIndex:I
    ...
    :cond_0
    iget v2, p0, mTransitionFromIndex:I
    ...
    iget v0, p0, mTransitionFromIndex:I

    iput v0, p0, mTransitionToIndex:I

    iput p1, p0, mTransitionFromIndex:I
    ...
    iput-object v0, p0, mTransition:Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$Transition;
    ...
    iget-object v0, p0, mState:Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;
    ...
    invoke-virtual {p0}, getCurrent()Landroid/graphics/drawable/Drawable;
    ...
    iput-object v3, p0, mTransition:Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$Transition;

    iput v2, p0, mTransitionFromIndex:I

    iput p1, p0, mTransitionToIndex:I
...
.method private updateStateFromTypedArray(Landroid/content/res/TypedArray;)V
    ...
    invoke-virtual {p0, p1}, setDither(Z)V
...
.method cloneConstantState()Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;
    ...
    iget-object v1, p0, mState:Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;
...
.method bridge synthetic cloneConstantState()Landroidx/appcompat/graphics/drawable/DrawableContainer$DrawableContainerState;
    ...
    invoke-virtual {p0}, cloneConstantState()Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;
...
.method public inflate(Landroid/content/Context;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    invoke-virtual {p0, v1, v2}, setVisible(ZZ)Z

    invoke-direct {p0, v0}, updateStateFromTypedArray(Landroid/content/res/TypedArray;)V
    ...
    invoke-direct/range {p0 .. p5}, inflateChildElements(Landroid/content/Context;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
...
.method public jumpToCurrentState()V
    ...
    iget v0, p0, mTransitionToIndex:I
...
.method protected onStateChange([I)Z
    ...
    invoke-direct {p0, v0}, selectTransition(I)Z
...
.method setConstantState(Landroidx/appcompat/graphics/drawable/DrawableContainer$DrawableContainerState;)V
    ...
    iput-object p1, p0, mState:Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;
...
.method public setVisible(ZZ)Z
    ...
    iget-object v1, p0, mTransition:Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$Transition;
    ...
    iget-object p0, p0, mTransition:Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$Transition;
