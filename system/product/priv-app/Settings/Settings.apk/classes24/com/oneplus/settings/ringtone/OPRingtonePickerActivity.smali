...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mSystemRings:Ljava/util/List;

    const/16 v0, 0x64

    iput v0, p0, mRequestCode:I
    ...
    iput-object v0, p0, mSimStateReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v0, p0, mVibrateWhenRingObserver:Landroid/database/ContentObserver;
...
.method static synthetic access$000(Lcom/oneplus/settings/ringtone/OPRingtonePickerActivity;)Landroid/preference/Preference;
    ...
    iget-object v0, p0, mSim1Layout:Landroid/preference/Preference;
...
.method static synthetic access$100(Lcom/oneplus/settings/ringtone/OPRingtonePickerActivity;)Landroid/preference/Preference;
    ...
    iget-object v0, p0, mSim2Layout:Landroid/preference/Preference;
...
.method static synthetic access$200(Lcom/oneplus/settings/ringtone/OPRingtonePickerActivity;)Landroid/preference/SwitchPreference;
    ...
    iget-object v0, p0, mVibrateWhenRingPreference:Landroid/preference/SwitchPreference;
...
.method private initPreference(Z)V
    ...
    iget-object v0, p0, mSystemRings:Ljava/util/List;
    ...
    iget-object v4, p0, mSystemRings:Ljava/util/List;

    invoke-interface {v4, v0}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-virtual {p0}, getPreferenceScreen()Landroid/preference/PreferenceScreen;

    move-result-object v4

    invoke-virtual {v4, v0}, Landroid/preference/PreferenceScreen;->addPreference(Landroid/preference/Preference;)Z

    iget-object v4, p0, mUriForDefaultItem:Landroid/net/Uri;
    ...
    :goto_1
    iget-object v1, p0, mSystemRings:Ljava/util/List;
    ...
    iget-object v2, p0, mSystemRings:Ljava/util/List;
...
.method private initVibrateWhenRingPreference()V
    ...
    invoke-virtual {p0, v0}, findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v0

    check-cast v0, Landroid/preference/SwitchPreference;

    iput-object v0, p0, mVibrateWhenRingPreference:Landroid/preference/SwitchPreference;
    ...
    invoke-direct {p0}, isRampingRingerEnabled()Z
    ...
    :cond_0
    iget-object v0, p0, mVibrateCategory:Landroid/preference/PreferenceCategory;

    iget-object v1, p0, mVibrateWhenRingPreference:Landroid/preference/SwitchPreference;
...
.method private switchSimRingtone(Z)V
    ...
    iget-object v0, p0, mSwitch:Landroid/preference/SwitchPreference;
    ...
    iget-boolean v0, p0, mContactsRingtone:Z

    if-nez v0, :cond_0

    iget-object v0, p0, mMainRoot:Landroid/preference/PreferenceCategory;

    iget-object v1, p0, mLocalPreference:Lcom/oneplus/settings/ringtone/OPRadioButtonPreference;

    invoke-virtual {v0, v1}, Landroid/preference/PreferenceCategory;->removePreference(Landroid/preference/Preference;)Z

    iget-object v0, p0, mMainRoot:Landroid/preference/PreferenceCategory;

    iget-object v1, p0, mNOPreference:Lcom/oneplus/settings/ringtone/OPRadioButtonPreference;
    ...
    iget-object v1, p0, mSim1Layout:Landroid/preference/Preference;

    invoke-virtual {v0, v1}, Landroid/preference/PreferenceCategory;->removePreference(Landroid/preference/Preference;)Z

    iget-object v0, p0, mMainRoot:Landroid/preference/PreferenceCategory;

    iget-object v1, p0, mSim2Layout:Landroid/preference/Preference;

    invoke-virtual {v0, v1}, Landroid/preference/PreferenceCategory;->removePreference(Landroid/preference/Preference;)Z

    const/4 v0, 0x1

    invoke-direct {p0, v0}, initPreference(Z)V
...
.method private updatePreference()V
    ...
    iget-object v0, p0, mRingtoneManager:Lcom/oneplus/settings/ringtone/OPRingtoneManager;
    ...
    invoke-virtual {p0, v3}, findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v0

    check-cast v0, Landroid/preference/PreferenceCategory;

    iput-object v0, p0, mMainRoot:Landroid/preference/PreferenceCategory;

    invoke-virtual {p0, v2}, findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v0

    check-cast v0, Landroid/preference/PreferenceCategory;

    iput-object v0, p0, mVibrateCategory:Landroid/preference/PreferenceCategory;
    ...
    iput-object v0, p0, mSwitch:Landroid/preference/SwitchPreference;
    ...
    iput-object v0, p0, mSim1Layout:Landroid/preference/Preference;
    ...
    iput-object v0, p0, mSim2Layout:Landroid/preference/Preference;

    invoke-virtual {p0, v5}, findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v0

    check-cast v0, Lcom/oneplus/settings/ringtone/OPRadioButtonPreference;

    iput-object v0, p0, mLocalPreference:Lcom/oneplus/settings/ringtone/OPRadioButtonPreference;

    invoke-virtual {p0, v4}, findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v0

    check-cast v0, Lcom/oneplus/settings/ringtone/OPRadioButtonPreference;

    iput-object v0, p0, mNOPreference:Lcom/oneplus/settings/ringtone/OPRadioButtonPreference;
    ...
    invoke-virtual {p0}, isProfileId()Z
    ...
    iget-object v2, p0, mSwitch:Landroid/preference/SwitchPreference;
    ...
    invoke-direct {p0, v0}, switchSimRingtone(Z)V

    invoke-virtual {p0, v1}, findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v0

    iput-object v0, p0, mVibrateRingPreference:Landroid/preference/Preference;

    iget-object v0, p0, mVibrateRingPreference:Landroid/preference/Preference;

    invoke-virtual {v0, p0}, Landroid/preference/Preference;->setOnPreferenceClickListener(Landroid/preference/Preference$OnPreferenceClickListener;)V

    invoke-direct {p0}, initVibrateWhenRingPreference()V
    ...
    iget-object v1, p0, mVibrateCategory:Landroid/preference/PreferenceCategory;
    ...
    iput-object v0, p0, mDefualtPreference:Lcom/oneplus/settings/ringtone/OPRadioButtonPreference;

    iget-object v0, p0, mDefualtPreference:Lcom/oneplus/settings/ringtone/OPRadioButtonPreference;
    ...
    iput-object v0, p0, mSMSNotificationVibrateIntensityPreference:Landroid/preference/Preference;

    iget-object v0, p0, mSMSNotificationVibrateIntensityPreference:Landroid/preference/Preference;
    ...
    iput-object v0, p0, mRingtoneVibrateCategory:Landroid/preference/PreferenceCategory;
    ...
    iget-object v2, p0, mVibrateCategory:Landroid/preference/PreferenceCategory;
    ...
    iget-object v1, p0, mRingtoneVibrateCategory:Landroid/preference/PreferenceCategory;
    ...
    iget-object v1, p0, mDefualtPreference:Lcom/oneplus/settings/ringtone/OPRadioButtonPreference;

    invoke-virtual {v0, v1}, Landroid/preference/PreferenceCategory;->removePreference(Landroid/preference/Preference;)Z

    invoke-direct {p0, v6}, initPreference(Z)V

    :cond_5
    :goto_1
    iget-object v0, p0, mLocalPreference:Lcom/oneplus/settings/ringtone/OPRadioButtonPreference;

    invoke-virtual {v0, p0}, Lcom/oneplus/settings/ringtone/OPRadioButtonPreference;->setOnPreferenceClickListener(Landroid/preference/Preference$OnPreferenceClickListener;)V

    iget-object v0, p0, mNOPreference:Lcom/oneplus/settings/ringtone/OPRadioButtonPreference;

    invoke-virtual {v0, p0}, Lcom/oneplus/settings/ringtone/OPRadioButtonPreference;->setOnPreferenceClickListener(Landroid/preference/Preference$OnPreferenceClickListener;)V

    invoke-virtual {p0}, updateSelected()V
...
.method private updateSimSwitch()V
    ...
    invoke-virtual {p0}, getSim1Enable()Z
    ...
    invoke-virtual {p0}, getSim2Enable()Z
    ...
    iput-object v0, p0, mSim1Uri:Landroid/net/Uri;
    ...
    iput-object v0, p0, mSim2Uri:Landroid/net/Uri;
    ...
    iget-object v2, p0, mSim1Uri:Landroid/net/Uri;
    ...
    iget-object v2, p0, mSim2Uri:Landroid/net/Uri;
    ...
    iget-object v3, p0, mSim1Layout:Landroid/preference/Preference;
    ...
    :cond_4
    iget-object v3, p0, mSim2Layout:Landroid/preference/Preference;
...
.method protected onActivityResult(IILandroid/content/Intent;)V
    ...
    iget-object v1, p0, mUriForDefaultItem:Landroid/net/Uri;
    ...
    iput-object v0, p0, mUriForDefaultItem:Landroid/net/Uri;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    :cond_0
    invoke-direct {p0}, updatePreference()V
...
.method protected onPause()V
    ...
    iget-object v1, p0, mVibrateWhenRingObserver:Landroid/database/ContentObserver;
...
.method public onPreferenceClick(Landroid/preference/Preference;)Z
    ...
    iput-boolean v0, p0, isSelectedNone:Z
    ...
    invoke-virtual {p0}, stopAnyPlayingRingtone()V

    invoke-virtual {p0}, getApplicationContext()Landroid/content/Context;

    move-result-object v2

    iget-object v4, p0, mSwitch:Landroid/preference/SwitchPreference;
    ...
    iget-object v2, p0, mMainRoot:Landroid/preference/PreferenceCategory;

    iget-object v4, p0, mLocalPreference:Lcom/oneplus/settings/ringtone/OPRadioButtonPreference;

    invoke-virtual {v2, v4}, Landroid/preference/PreferenceCategory;->removePreference(Landroid/preference/Preference;)Z

    iget-object v2, p0, mMainRoot:Landroid/preference/PreferenceCategory;

    iget-object v4, p0, mNOPreference:Lcom/oneplus/settings/ringtone/OPRadioButtonPreference;

    invoke-virtual {v2, v4}, Landroid/preference/PreferenceCategory;->removePreference(Landroid/preference/Preference;)Z

    iget-object v2, p0, mMainRoot:Landroid/preference/PreferenceCategory;

    iget-object v4, p0, mSim1Layout:Landroid/preference/Preference;

    invoke-virtual {v2, v4}, Landroid/preference/PreferenceCategory;->addPreference(Landroid/preference/Preference;)Z

    iget-object v2, p0, mMainRoot:Landroid/preference/PreferenceCategory;

    iget-object v4, p0, mSim2Layout:Landroid/preference/Preference;
    ...
    iget-object v2, p0, mLocalPreference:Lcom/oneplus/settings/ringtone/OPRadioButtonPreference;

    invoke-virtual {v0, v2}, Landroid/preference/PreferenceCategory;->addPreference(Landroid/preference/Preference;)Z

    iget-object v0, p0, mMainRoot:Landroid/preference/PreferenceCategory;

    iget-object v2, p0, mNOPreference:Lcom/oneplus/settings/ringtone/OPRadioButtonPreference;

    invoke-virtual {v0, v2}, Landroid/preference/PreferenceCategory;->addPreference(Landroid/preference/Preference;)Z

    iget-object v0, p0, mMainRoot:Landroid/preference/PreferenceCategory;

    iget-object v2, p0, mSim1Layout:Landroid/preference/Preference;

    invoke-virtual {v0, v2}, Landroid/preference/PreferenceCategory;->removePreference(Landroid/preference/Preference;)Z

    iget-object v0, p0, mMainRoot:Landroid/preference/PreferenceCategory;

    iget-object v2, p0, mSim2Layout:Landroid/preference/Preference;

    invoke-virtual {v0, v2}, Landroid/preference/PreferenceCategory;->removePreference(Landroid/preference/Preference;)Z

    invoke-direct {p0, v3}, initPreference(Z)V

    :goto_0
    invoke-virtual {p0}, startVibrate()V
    ...
    iget-boolean v2, p0, mHasDefaultItem:Z

    const-string v5, "android.intent.extra.ringtone.SHOW_DEFAULT"

    invoke-virtual {v0, v5, v2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    iget-object v2, p0, mUriForLocalItem:Landroid/net/Uri;
    ...
    iget-boolean v2, p0, mContactsRingtone:Z

    const-string v4, "ringtone_for_contacts"

    invoke-virtual {v0, v4, v2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    iget-boolean v2, p0, mIsAlarmNeedVibrate:Z

    const-string v4, "needVibrate"

    invoke-virtual {v0, v4, v2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    iget v2, p0, mRequestCode:I

    invoke-virtual {p0, v0, v2}, startActivityForResult(Landroid/content/Intent;I)V
    ...
    invoke-direct {p0, v6}, updateChecks(Ljava/lang/String;)V

    invoke-virtual {p0}, isThreePart()Z
    ...
    iget-object v2, p0, mDefualtPreference:Lcom/oneplus/settings/ringtone/OPRadioButtonPreference;
    ...
    iput-boolean v3, p0, isSelectedNone:Z

    iget-object v0, p0, mLocalPreference:Lcom/oneplus/settings/ringtone/OPRadioButtonPreference;

    invoke-virtual {v0, v7}, Lcom/oneplus/settings/ringtone/OPRadioButtonPreference;->setSummary(I)V

    iput-object v8, p0, mUriForLocalItem:Landroid/net/Uri;

    iput-object v8, p0, mUriForDefaultItem:Landroid/net/Uri;
    ...
    iget-object v2, p0, mDefualtUri:Landroid/net/Uri;

    iput-object v2, p0, mUriForDefaultItem:Landroid/net/Uri;

    iget-object v2, p0, mUriForDefaultItem:Landroid/net/Uri;

    invoke-virtual {p0, v4, v2}, playRingtone(ILandroid/net/Uri;)V
    ...
    iget-object v4, p0, mVibrateWhenRingPreference:Landroid/preference/SwitchPreference;
    ...
    iget-object v5, p0, mUriForDefaultItem:Landroid/net/Uri;
    ...
    :cond_d
    invoke-direct {p0, v1}, updateChecks(Ljava/lang/String;)V
...
.method protected onResume()V
    ...
    iget-object v3, p0, mVibrateWhenRingPreference:Landroid/preference/SwitchPreference;
    ...
    iget-object v3, p0, mVibrateWhenRingObserver:Landroid/database/ContentObserver;
...
.method protected onStart()V
    ...
    iget-object v1, p0, mSimStateReceiver:Landroid/content/BroadcastReceiver;
...
.method protected onStop()V
    ...
    iget-object v0, p0, mSimStateReceiver:Landroid/content/BroadcastReceiver;
...
.method protected updateSelected()V
    ...
    invoke-direct {p0}, updateSimSwitch()V
    ...
    invoke-direct {p0, v3}, updateChecks(Ljava/lang/String;)V

    iget-object v0, p0, mLocalPreference:Lcom/oneplus/settings/ringtone/OPRadioButtonPreference;

    invoke-virtual {v0, v4}, Lcom/oneplus/settings/ringtone/OPRadioButtonPreference;->setSummary(I)V

    iput-object v2, p0, mUriForLocalItem:Landroid/net/Uri;
    ...
    iget-object v7, p0, mUriForDefaultItem:Landroid/net/Uri;
    ...
    iget-object v6, p0, mUriForDefaultItem:Landroid/net/Uri;
    ...
    invoke-direct {p0, v0}, updateChecks(Ljava/lang/String;)V
    ...
    iput-object v1, p0, mUriForDefaultItem:Landroid/net/Uri;

    iput-object v1, p0, mUriForLocalItem:Landroid/net/Uri;
