...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, mQueuedPositions:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, mAnimationDone:Ljava/lang/Runnable;
    ...
    iput v0, p0, mPageIndicatorWidth:I
    ...
    iput v0, p0, mPageIndicatorHeight:I

    iget v0, p0, mPageIndicatorWidth:I
...
.method static synthetic access$100(Lcom/oneplus/lib/design/widget/OPPageIndicator;)Ljava/util/ArrayList;
    ...
    iget-object v0, p0, mQueuedPositions:Ljava/util/ArrayList;
...
.method static synthetic access$200(Lcom/oneplus/lib/design/widget/OPPageIndicator;I)V
    ...
    invoke-direct {p0, p1}, setPosition(I)V
...
.method private animate(II)V
    ...
    invoke-direct {p0, v0}, setIndex(I)V
    ...
    invoke-direct {p0, v2, v5, v3}, getTransition(ZZZ)I

    move-result v10

    invoke-direct {p0, v8, v10}, playAnimation(Landroid/widget/ImageView;I)V

    invoke-direct {p0, v3}, getAlpha(Z)F

    move-result v3

    invoke-virtual {v8, v3}, Landroid/widget/ImageView;->setAlpha(F)V

    invoke-direct {p0, v2, v5, v4}, getTransition(ZZZ)I

    move-result v3

    invoke-direct {p0, v9, v3}, playAnimation(Landroid/widget/ImageView;I)V

    invoke-direct {p0, v4}, getAlpha(Z)F
...
.method private playAnimation(Landroid/widget/ImageView;I)V
    ...
    invoke-direct {p0, v0}, forceAnimationOnUI2(Landroid/graphics/drawable/AnimatedVectorDrawable;)V

    invoke-virtual {v0}, Landroid/graphics/drawable/AnimatedVectorDrawable;->start()V

    iget-object v1, p0, mAnimationDone:Ljava/lang/Runnable;
...
.method private setPosition(I)V
    ...
    invoke-virtual {p0}, isVisibleToUser2()Z
    ...
    invoke-direct {p0, v0, p1}, animate(II)V
...
.method protected onLayout(ZIIII)V
    ...
    iget v2, p0, mPageIndicatorWidth:I

    iget v3, p0, mPageDotWidth:I
    ...
    iget v5, p0, mPageIndicatorWidth:I

    add-int/2addr v5, v2

    iget v6, p0, mPageIndicatorHeight:I
...
.method protected onMeasure(II)V
    ...
    :cond_0
    iget v1, p0, mPageIndicatorWidth:I
    ...
    iget v3, p0, mPageIndicatorHeight:I
    ...
    :cond_1
    iget v3, p0, mPageIndicatorWidth:I

    iget v4, p0, mPageDotWidth:I
    ...
    iget v4, p0, mPageIndicatorHeight:I
...
.method public setLocation(F)V
    ...
    iget-object v3, p0, mQueuedPositions:Ljava/util/ArrayList;
    ...
    :cond_3
    invoke-direct {p0, v1}, setPosition(I)V
...
.method public setNumPages(I)V
    ...
    invoke-direct {p0, v1}, setIndex(I)V
