...
.field private static final NOTIFICATION_KEY:Ljava/lang/String; = "oneplus:menu:notification"
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, itemPool:Lcom/oneplus/support/core/util/Pools$Pool;
    ...
    iput v3, p0, inactiveItemMaxWidth:I
    ...
    iput v3, p0, inactiveItemMinWidth:I
    ...
    iput v3, p0, activeItemMaxWidth:I
    ...
    iput v3, p0, activeItemMinWidth:I

    sget v3, Lcom/oneplus/commonctrl/R$dimen;->op_design_bottom_navigation_height:I

    invoke-virtual {v2, v3}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v3

    iput v3, p0, itemHeight:I

    const v3, 0x1010038

    invoke-virtual {p0, v3}, createDefaultColorStateList(I)Landroid/content/res/ColorStateList;

    move-result-object v3

    iput-object v3, p0, itemTextColorDefault:Landroid/content/res/ColorStateList;

    new-instance v3, Landroid/transition/AutoTransition;

    invoke-direct {v3}, Landroid/transition/AutoTransition;-><init>()V

    iput-object v3, p0, set:Landroid/transition/TransitionSet;

    iget-object v3, p0, set:Landroid/transition/TransitionSet;
    ...
    iput-object v0, p0, onClickListener:Landroid/view/View$OnClickListener;

    new-array v0, v1, [I

    iput-object v0, p0, tempChildWidths:[I
...
.method static synthetic access$000(Lcom/oneplus/lib/design/widget/BottomNavigationMenuView;)Lcom/oneplus/lib/design/widget/BottomNavigationPresenter;
    ...
    iget-object v0, p0, presenter:Lcom/oneplus/lib/design/widget/BottomNavigationPresenter;
...
.method public buildMenuView()V
    ...
    invoke-virtual {p0, v3, v4}, addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    iget v2, p0, selectedItemPosition:I
...
.method public createDefaultColorStateList(I)Landroid/content/res/ColorStateList;
    ...
    sget-object v8, DISABLED_STATE_SET:[I

    const/4 v9, 0x0

    aput-object v8, v7, v9

    sget-object v8, CHECKED_STATE_SET:[I

    aput-object v8, v7, v2

    sget-object v8, EMPTY_STATE_SET:[I
...
.method public getIconTintList()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, p0, itemIconTint:Landroid/content/res/ColorStateList;
...
.method public getItemBackground()Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    iget-object v0, p0, itemBackground:Landroid/graphics/drawable/Drawable;
...
.method public getItemBackgroundRes()I
    ...
    iget v0, p0, itemBackgroundRes:I
...
.method public getItemTextAppearanceActive()I
    ...
    iget v0, p0, itemTextAppearanceActive:I
...
.method public getItemTextAppearanceInactive()I
    ...
    iget v0, p0, itemTextAppearanceInactive:I
...
.method public getItemTextColor()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, p0, itemTextColorFromUser:Landroid/content/res/ColorStateList;
...
.method public isItemHorizontalTranslationEnabled()Z
    ...
    iget-boolean v0, p0, itemHorizontalTranslationEnabled:Z
...
.method public setItemBackground(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object p1, p0, itemBackground:Landroid/graphics/drawable/Drawable;
...
.method tryRestoreNotifications(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v4}, Lcom/oneplus/lib/design/widget/BottomNavigationItemView;->getItemData()Lcom/oneplus/lib/menu/MenuItemImpl;
    ...
    instance-of v7, v6, Lcom/oneplus/lib/design/widget/BottomNavigationNotification;

    if-eqz v7, :cond_1

    move-object v7, v6

    check-cast v7, Lcom/oneplus/lib/design/widget/BottomNavigationNotification;

    invoke-virtual {v4, v7}, Lcom/oneplus/lib/design/widget/BottomNavigationItemView;->bindNotification(Lcom/oneplus/lib/design/widget/BottomNavigationNotification;)V
...
.method trySaveNotifications(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v4}, Lcom/oneplus/lib/design/widget/BottomNavigationItemView;->getNotification()Lcom/oneplus/lib/design/widget/BottomNavigationNotification;
    ...
    :cond_1
    const-string v1, "oneplus:menu:notification"
...
.method public updateMenuView()V
    ...
    iput v2, p0, selectedItemPosition:I
    ...
    :cond_3
    iget v2, p0, selectedItemId:I

    if-eq v1, v2, :cond_4

    iget-object v2, p0, set:Landroid/transition/TransitionSet;
    ...
    :cond_4
    iget v2, p0, labelVisibilityMode:I
    ...
    invoke-direct {p0, v2, v3}, isShifting(II)Z
