...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mRectColorPlate:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, mRectSelectBox:Landroid/graphics/RectF;

    const/16 v0, 0x64

    iput v0, p0, mMaxXProgress:I

    iput v0, p0, mMaxYProgress:I
...
.method static synthetic access$000(Lcom/oneplus/settings/better/ColorPlateView;II)V
    ...
    invoke-direct {p0, p1, p2}, updateSelectBox(II)V
...
.method private calculateXProgress(I)I
    ...
    iget-object v0, p0, mRectColorPlate:Landroid/graphics/Rect;
    ...
    iget-object v1, p0, mRectColorPlate:Landroid/graphics/Rect;
...
.method private init()V
    ...
    iput-object v0, p0, mBmpColorPlate:Landroid/graphics/Bitmap;
    ...
    iput v0, p0, mSelectBoxCornerRadius:F

    iget-object v0, p0, mBmpColorPlate:Landroid/graphics/Bitmap;

    invoke-virtual {v0}, Landroid/graphics/Bitmap;->getWidth()I

    move-result v0

    iput v0, p0, mIntrinsicWidthColorPlate:I
    ...
    iput v0, p0, mIntrinsicHeightColorPlate:I
    ...
    iput v0, p0, mWidthSelectBox:I

    iget v0, p0, mWidthSelectBox:I

    iput v0, p0, mHeightSelectBox:I
    ...
    iput v0, p0, mColorPlateMargin:I

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0}, Landroid/graphics/Paint;-><init>()V

    iput-object v0, p0, mPaintColorPlate:Landroid/graphics/Paint;

    iget-object v0, p0, mPaintColorPlate:Landroid/graphics/Paint;
    ...
    iput-object v0, p0, mPaintSelectBox:Landroid/graphics/Paint;

    iget-object v0, p0, mPaintSelectBox:Landroid/graphics/Paint;
...
.method private updateSelectBox(II)V
    ...
    iget-object v2, p0, mRectColorPlate:Landroid/graphics/Rect;
    ...
    iget-object v2, p0, mRectSelectBox:Landroid/graphics/RectF;

    iget v3, p0, mWidthSelectBox:I
...
.method public getColorChangeListener()Lcom/oneplus/settings/better/ColorPlateView$OnColorChangeListener;
    ...
    iget-object v0, p0, mColorChangeListener:Lcom/oneplus/settings/better/ColorPlateView$OnColorChangeListener;
...
.method public getXYProgress()[I
    ...
    iget v1, p0, mCurrentXProgress:I

    const/4 v2, 0x0

    aput v1, v0, v2

    iget v1, p0, mCurrentYProgress:I
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, mBmpColorPlate:Landroid/graphics/Bitmap;

    invoke-virtual {v1}, Landroid/graphics/Bitmap;->getWidth()I

    move-result v1

    iget-object v2, p0, mBmpColorPlate:Landroid/graphics/Bitmap;
    ...
    iget-object v3, p0, mPaintColorPlate:Landroid/graphics/Paint;
    ...
    iget-object v1, p0, mRectSelectBox:Landroid/graphics/RectF;

    iget v2, p0, mSelectBoxCornerRadius:F

    iget-object v3, p0, mPaintSelectBox:Landroid/graphics/Paint;
...
.method protected onMeasure(II)V
    ...
    invoke-direct {p0, p1}, measureWidth(I)I

    move-result v0

    iget v1, p0, mIntrinsicHeightColorPlate:I

    mul-int/2addr v1, v0

    iget v2, p0, mIntrinsicWidthColorPlate:I
    ...
    iget v3, p0, mColorPlateMargin:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget v2, p0, mCurrentXProgress:I

    iput v2, p0, mLastXProgress:I

    iget v2, p0, mCurrentYProgress:I

    iput v2, p0, mLastYProgress:I

    invoke-direct {p0, v0}, calculateXProgress(I)I

    move-result v2

    iput v2, p0, mCurrentXProgress:I

    invoke-direct {p0, v1}, calculateYProgress(I)I

    move-result v2

    iput v2, p0, mCurrentYProgress:I
    ...
    :cond_5
    iget-object v2, p0, mColorChangeListener:Lcom/oneplus/settings/better/ColorPlateView$OnColorChangeListener;

    if-eqz v2, :cond_9

    iget v2, p0, mLastXProgress:I

    iget v4, p0, mCurrentXProgress:I
    ...
    iget v2, p0, mLastYProgress:I

    iget v4, p0, mCurrentYProgress:I
    ...
    iget v5, p0, mMaxXProgress:I

    iget v6, p0, mCurrentYProgress:I

    iget v7, p0, mMaxYProgress:I
...
.method public setColorChangeListener(Lcom/oneplus/settings/better/ColorPlateView$OnColorChangeListener;)V
    ...
    iput-object p1, p0, mColorChangeListener:Lcom/oneplus/settings/better/ColorPlateView$OnColorChangeListener;
...
.method public setProgress(II)V
    ...
    iput p1, p0, mCurrentXProgress:I

    iput p2, p0, mCurrentYProgress:I
