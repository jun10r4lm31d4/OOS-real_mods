...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, mIsPoweroff:Z

    sput-boolean v0, mIsCalling:Z
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mPoweroffAction:Ljava/lang/String;
    ...
    iput-object v0, p0, mPowerOffPromptRunnable:Ljava/lang/Runnable;
...
.method static synthetic access$100(Lcom/oneplus/settings/timer/timepower/ReceiverPowerOff;)Ljava/lang/String;
    ...
    iget-object v0, p0, mPoweroffAction:Ljava/lang/String;
...
.method static synthetic access$200(Lcom/oneplus/settings/timer/timepower/ReceiverPowerOff;)Ljava/lang/Runnable;
    ...
    iget-object v0, p0, mPowerOffPromptRunnable:Ljava/lang/Runnable;
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    :cond_2
    sget-boolean v3, mIsCalling:Z

    if-eqz v3, :cond_3

    sput-boolean v4, mIsPoweroff:Z
    ...
    invoke-direct {p0, p1}, isUsingTheme(Landroid/content/Context;)Z
    ...
    invoke-direct {p0, p1}, rememberShutdownRequestMissed(Landroid/content/Context;)V
    ...
    sput-boolean v5, mIsCalling:Z

    sget-boolean v4, mIsPoweroff:Z

    if-eqz v4, :cond_9

    sput-boolean v5, mIsPoweroff:Z

    iput-object p1, p0, mContext:Landroid/content/Context;

    iput-object v1, p0, mPoweroffAction:Ljava/lang/String;

    iget-object v4, p0, mHandler:Landroid/os/Handler;

    iget-object v5, p0, mPowerOffPromptRunnable:Ljava/lang/Runnable;
