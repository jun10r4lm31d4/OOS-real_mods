...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mCallback:Lcom/oneplus/settings/permission/PermissionManager$Callback;
...
.method static synthetic access$000(Lcom/oneplus/settings/permission/PermissionManager;)Lcom/oneplus/settings/permission/PermissionManager$Callback;
    ...
    iget-object v0, p0, mCallback:Lcom/oneplus/settings/permission/PermissionManager$Callback;
...
.method static synthetic access$102(Lcom/oneplus/settings/permission/PermissionManager;Landroid/os/Messenger;)Landroid/os/Messenger;
    ...
    iput-object p1, p0, mRemoteService:Landroid/os/Messenger;
...
.method static synthetic access$200(Lcom/oneplus/settings/permission/PermissionManager;)Landroid/os/HandlerThread;
    ...
    iget-object v0, p0, mWorker:Landroid/os/HandlerThread;
...
.method public connectToPermissionControlService(Landroid/content/Context;)V
    ...
    iput-object v1, p0, mWorker:Landroid/os/HandlerThread;

    iget-object v1, p0, mWorker:Landroid/os/HandlerThread;

    invoke-virtual {v1}, Landroid/os/HandlerThread;->start()V

    new-instance v1, Lcom/oneplus/settings/permission/PermissionManager$IncomingHandler;

    iget-object v2, p0, mWorker:Landroid/os/HandlerThread;
    ...
    iput-object v1, p0, mLocalClient:Landroid/os/Messenger;
    ...
    :cond_0
    iget-object v1, p0, mCallback:Lcom/oneplus/settings/permission/PermissionManager$Callback;
...
.method public queryPermissionData(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iget-object v2, p0, mLocalClient:Landroid/os/Messenger;

    iput-object v2, v1, Landroid/os/Message;->replyTo:Landroid/os/Messenger;

    :try_start_0
    iget-object v2, p0, mRemoteService:Landroid/os/Messenger;
...
.method public setCallback(Lcom/oneplus/settings/permission/PermissionManager$Callback;)V
    ...
    iput-object p1, p0, mCallback:Lcom/oneplus/settings/permission/PermissionManager$Callback;
...
.method public updatePermissionData(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;ZZ)V
    ...
    invoke-static {v0, p2}, isSystemOrSystemUpdatedApp(Landroid/content/pm/PackageManager;Ljava/lang/String;)Z
    ...
    iget-object v3, p0, mLocalClient:Landroid/os/Messenger;

    iput-object v3, v2, Landroid/os/Message;->replyTo:Landroid/os/Messenger;

    :try_start_0
    iget-object v3, p0, mRemoteService:Landroid/os/Messenger;
...
.method public updatePermissionsData(Landroid/content/Context;Ljava/lang/String;Ljava/util/List;ZZ)V
    ...
    invoke-virtual/range {v2 .. v7}, updatePermissionData(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;ZZ)V
