...
.method public constructor <init>(Landroid/content/Context;ILandroid/net/Uri;Lcom/oneplus/settings/notification/OPSeekBarVolumizer$Callback;)V
    ...
    invoke-direct/range {v0 .. v5}, <init>(Landroid/content/Context;ILandroid/net/Uri;Lcom/oneplus/settings/notification/OPSeekBarVolumizer$Callback;Z)V
...
.method public constructor <init>(Landroid/content/Context;ILandroid/net/Uri;Lcom/oneplus/settings/notification/OPSeekBarVolumizer$Callback;Z)V
    ...
    iput-object v0, p0, mVolumeHandler:Landroid/os/Handler;
    ...
    iput-object v0, p0, mVolumeGroupCallback:Landroid/media/AudioManager$VolumeGroupCallback;
    ...
    iput-object v0, p0, mUiHandler:Lcom/oneplus/settings/notification/OPSeekBarVolumizer$H;
    ...
    iput-object v0, p0, mReceiver:Lcom/oneplus/settings/notification/OPSeekBarVolumizer$Receiver;

    const/4 v0, -0x1

    iput v0, p0, mLastProgress:I

    iput v0, p0, mVolumeBeforeMute:I
    ...
    iput-object v0, p0, mNotificationPolicy:Landroid/app/NotificationManager$Policy;

    iget-object v0, p0, mNotificationPolicy:Landroid/app/NotificationManager$Policy;
    ...
    :goto_0
    iput-boolean v0, p0, mAllowAlarms:Z
    ...
    :cond_1
    iput-boolean v1, p0, mAllowMedia:Z
    ...
    iput-boolean v0, p0, mAllowRinger:Z
    ...
    iput-boolean v0, p0, mAffectedByRingerMode:Z

    iget v0, p0, mStreamType:I

    invoke-static {v0}, isNotificationOrRing(I)Z

    move-result v0

    iput-boolean v0, p0, mNotificationOrRing:Z

    iget-boolean v0, p0, mNotificationOrRing:Z
    ...
    invoke-direct {p0}, hasAudioProductStrategies()Z
    ...
    invoke-direct {p0, v0}, getVolumeGroupIdForLegacyStreamType(I)I

    move-result v0

    iput v0, p0, mVolumeGroupId:I

    iget v0, p0, mStreamType:I

    invoke-direct {p0, v0}, getAudioAttributesForLegacyStreamType(I)Landroid/media/AudioAttributes;
    ...
    iput v0, p0, mMaxStreamVolume:I

    iput-object p4, p0, mCallback:Lcom/oneplus/settings/notification/OPSeekBarVolumizer$Callback;
    ...
    iput v0, p0, mOriginalStreamVolume:I
    ...
    iput v0, p0, mLastAudibleStreamVolume:I
    ...
    iput-boolean v0, p0, mMuted:Z

    iput-boolean p5, p0, mPlaySample:Z

    iget-object v0, p0, mCallback:Lcom/oneplus/settings/notification/OPSeekBarVolumizer$Callback;

    if-eqz v0, :cond_4

    iget-boolean v1, p0, mMuted:Z

    invoke-direct {p0}, isZenMuted()Z
    ...
    :cond_7
    :goto_1
    iput-object p3, p0, mDefaultUri:Landroid/net/Uri;
...
.method static synthetic access$1100(Lcom/oneplus/settings/notification/OPSeekBarVolumizer;)V
    ...
    invoke-direct {p0}, updateSlider()V
...
.method static synthetic access$1800(Lcom/oneplus/settings/notification/OPSeekBarVolumizer;)Z
    ...
    iget-boolean v0, p0, mAffectedByRingerMode:Z
...
.method static synthetic access$1900(I)Z
    ...
    invoke-static {p0}, isNotificationOrRing(I)Z
...
.method static synthetic access$200(Lcom/oneplus/settings/notification/OPSeekBarVolumizer;)Landroid/os/Handler;
    ...
    iget-object v0, p0, mVolumeHandler:Landroid/os/Handler;
...
.method static synthetic access$2000(Lcom/oneplus/settings/notification/OPSeekBarVolumizer;I)I
    ...
    invoke-direct {p0, p1}, getVolumeGroupIdForLegacyStreamType(I)I
...
.method static synthetic access$2400(Lcom/oneplus/settings/notification/OPSeekBarVolumizer;)Lcom/oneplus/settings/notification/OPSeekBarVolumizer$H;
    ...
    iget-object v0, p0, mUiHandler:Lcom/oneplus/settings/notification/OPSeekBarVolumizer$H;
...
.method static synthetic access$2502(Lcom/oneplus/settings/notification/OPSeekBarVolumizer;Landroid/app/NotificationManager$Policy;)Landroid/app/NotificationManager$Policy;
    ...
    iput-object p1, p0, mNotificationPolicy:Landroid/app/NotificationManager$Policy;
...
.method static synthetic access$2602(Lcom/oneplus/settings/notification/OPSeekBarVolumizer;Z)Z
    ...
    iput-boolean p1, p0, mAllowAlarms:Z
...
.method static synthetic access$2702(Lcom/oneplus/settings/notification/OPSeekBarVolumizer;Z)Z
    ...
    iput-boolean p1, p0, mAllowMedia:Z
...
.method static synthetic access$2802(Lcom/oneplus/settings/notification/OPSeekBarVolumizer;Z)Z
    ...
    iput-boolean p1, p0, mAllowRinger:Z
...
.method static synthetic access$500(Lcom/oneplus/settings/notification/OPSeekBarVolumizer;)Landroid/widget/SeekBar;
    ...
    iget-object v0, p0, mSeekBar:Landroid/widget/SeekBar;
...
.method static synthetic access$700(Lcom/oneplus/settings/notification/OPSeekBarVolumizer;)I
    ...
    iget v0, p0, mLastAudibleStreamVolume:I
...
.method static synthetic access$702(Lcom/oneplus/settings/notification/OPSeekBarVolumizer;I)I
    ...
    iput p1, p0, mLastAudibleStreamVolume:I
...
.method private isZenMuted()Z
    ...
    invoke-virtual {p0, v0}, getThreeKeyStatus(Landroid/content/Context;)I
...
.method private onInitSample()V
    ...
    iget-object v1, p0, mDefaultUri:Landroid/net/Uri;

    invoke-static {v0, v1}, Landroid/media/RingtoneManager;->getRingtone(Landroid/content/Context;Landroid/net/Uri;)Landroid/media/Ringtone;

    move-result-object v0

    iput-object v0, p0, mRingtone:Landroid/media/Ringtone;

    iget-object v0, p0, mRingtone:Landroid/media/Ringtone;
...
.method private onStartSample()V
    ...
    invoke-virtual {p0}, isSamplePlaying()Z
    ...
    iget-object v2, p0, mRingtone:Landroid/media/Ringtone;
...
.method private registerVolumeGroupCb()V
    ...
    iget-object v2, p0, mVolumeGroupCallback:Landroid/media/AudioManager$VolumeGroupCallback;
...
.method private unregisterVolumeGroupCb()V
    ...
    iget-object v1, p0, mVolumeGroupCallback:Landroid/media/AudioManager$VolumeGroupCallback;
...
.method private updateSlider()V
    ...
    iget-object v3, p0, mUiHandler:Lcom/oneplus/settings/notification/OPSeekBarVolumizer$H;
...
.method public changeVolumeBy(I)V
    ...
    invoke-direct {p0, v0}, postSetVolume(I)V

    invoke-direct {p0}, postStartSample()V
...
.method public handleMessage(Landroid/os/Message;)Z
    ...
    :cond_0
    iget-boolean v0, p0, mPlaySample:Z

    if-eqz v0, :cond_6

    invoke-direct {p0}, onInitSample()V
    ...
    invoke-direct {p0}, onStopSample()V
    ...
    invoke-direct {p0}, onStartSample()V
...
.method public muteVolume()V
    ...
    iget v0, p0, mVolumeBeforeMute:I
    ...
    iget-object v3, p0, mSeekBar:Landroid/widget/SeekBar;
    ...
    iput v2, p0, mVolumeBeforeMute:I
    ...
    invoke-direct {p0}, postStopSample()V

    invoke-direct {p0, v2}, postSetVolume(I)V
...
.method public onSaveInstanceState(Landroid/preference/VolumePreference$VolumeStore;)V
    ...
    iget v0, p0, mOriginalStreamVolume:I
...
.method public revertVolume()V
    ...
    iget v2, p0, mOriginalStreamVolume:I
...
.method public setSeekBar(Landroid/widget/SeekBar;)V
    ...
    :cond_0
    iput-object p1, p0, mSeekBar:Landroid/widget/SeekBar;
    ...
    iget v1, p0, mMaxStreamVolume:I

    invoke-virtual {v0, v1}, Landroid/widget/SeekBar;->setMax(I)V

    invoke-virtual {p0}, updateSeekBar()V
...
.method public start()V
    ...
    iput-object v1, p0, mVolumeObserver:Lcom/oneplus/settings/notification/OPSeekBarVolumizer$Observer;
    ...
    iget-object v3, p0, mVolumeObserver:Lcom/oneplus/settings/notification/OPSeekBarVolumizer$Observer;
    ...
    iget-object v1, p0, mReceiver:Lcom/oneplus/settings/notification/OPSeekBarVolumizer$Receiver;
    ...
    invoke-direct {p0}, registerVolumeGroupCb()V
...
.method public stop()V
    ...
    iget-object v1, p0, mVolumeObserver:Lcom/oneplus/settings/notification/OPSeekBarVolumizer$Observer;

    invoke-virtual {v0, v1}, Landroid/content/ContentResolver;->unregisterContentObserver(Landroid/database/ContentObserver;)V

    iget-object v0, p0, mReceiver:Lcom/oneplus/settings/notification/OPSeekBarVolumizer$Receiver;
    ...
    invoke-direct {p0}, unregisterVolumeGroupCb()V
...
.method protected updateSeekBar()V
    ...
    iget-boolean v1, p0, mNotificationOrRing:Z

    if-eqz v1, :cond_0

    iget-object v1, p0, mSeekBar:Landroid/widget/SeekBar;
    ...
    invoke-static {v1}, isAlarmsStream(I)Z
    ...
    invoke-virtual {p0, v1}, isZenModeEnabled(I)Z

    move-result v1

    if-eqz v1, :cond_1

    iget-boolean v1, p0, mAllowAlarms:Z
    ...
    invoke-static {v1}, isMediaStream(I)Z
    ...
    iget-boolean v1, p0, mAllowMedia:Z
