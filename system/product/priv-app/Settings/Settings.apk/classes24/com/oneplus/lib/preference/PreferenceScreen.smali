...
.method private showDialog(Landroid/os/Bundle;)V
    ...
    iput-object v3, p0, mListView:Landroid/widget/ListView;

    iget-object v3, p0, mListView:Landroid/widget/ListView;

    invoke-virtual {p0, v3}, bind(Landroid/widget/ListView;)V
    ...
    iput-object v4, p0, mDialog:Landroid/app/Dialog;
...
.method public bind(Landroid/widget/ListView;)V
    ...
    invoke-virtual {p0}, getRootAdapter()Landroid/widget/ListAdapter;

    move-result-object v0

    invoke-virtual {p1, v0}, Landroid/widget/ListView;->setAdapter(Landroid/widget/ListAdapter;)V

    invoke-virtual {p0}, onAttachedToActivity()V
...
.method public getRootAdapter()Landroid/widget/ListAdapter;
    ...
    iget-object v0, p0, mRootAdapter:Landroid/widget/ListAdapter;

    if-nez v0, :cond_0

    invoke-virtual {p0}, onCreateRootAdapter()Landroid/widget/ListAdapter;

    move-result-object v0

    iput-object v0, p0, mRootAdapter:Landroid/widget/ListAdapter;
...
.method protected onClick()V
    ...
    invoke-virtual {p0}, getFragment()Ljava/lang/String;
    ...
    invoke-direct {p0, v0}, showDialog(Landroid/os/Bundle;)V
...
.method public onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    iput-object v2, p0, mVibratePattern:[J

    iget-object v2, p0, mVibratePattern:[J
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-direct {p0, v1}, showDialog(Landroid/os/Bundle;)V
