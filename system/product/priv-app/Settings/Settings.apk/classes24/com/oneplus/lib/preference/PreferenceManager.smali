...
.method public constructor <init>(Landroid/app/Activity;I)V
    ...
    iput-wide v0, p0, mNextId:J

    const/4 v0, 0x0

    iput v0, p0, mStorage:I

    iput-object p1, p0, mActivity:Landroid/app/Activity;

    iput p2, p0, mNextRequestCode:I
...
.method private dismissAllScreens()V
    ...
    :try_start_0
    iget-object v0, p0, mPreferencesScreens:Ljava/util/List;
    ...
    iget-object v1, p0, mPreferencesScreens:Ljava/util/List;
...
.method public static getDefaultSharedPreferences(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    invoke-static {p0}, getDefaultSharedPreferencesName(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v0

    invoke-static {}, getDefaultSharedPreferencesMode()I
...
.method private init(Landroid/content/Context;)V
    ...
    invoke-static {p1}, getDefaultSharedPreferencesName(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p0, v0}, setSharedPreferencesName(Ljava/lang/String;)V
...
.method public static setDefaultValues(Landroid/content/Context;IZ)V
    ...
    invoke-static {p0, v0, v1, p1, p2}, setDefaultValues(Landroid/content/Context;Ljava/lang/String;IIZ)V
...
.method public static setDefaultValues(Landroid/content/Context;Ljava/lang/String;IIZ)V
    ...
    invoke-virtual {v0, p1}, setSharedPreferencesName(Ljava/lang/String;)V

    invoke-virtual {v0, p2}, setSharedPreferencesMode(I)V

    const/4 v3, 0x0

    invoke-virtual {v0, p0, p3, v3}, inflateFromResource(Landroid/content/Context;ILcom/oneplus/lib/preference/PreferenceScreen;)Lcom/oneplus/lib/preference/PreferenceScreen;
...
.method private setNoCommit(Z)V
    ...
    iget-object v0, p0, mEditor:Landroid/content/SharedPreferences$Editor;
    ...
    iget-object v1, p0, mEditor:Landroid/content/SharedPreferences$Editor;

    invoke-interface {v1}, Landroid/content/SharedPreferences$Editor;->commit()Z

    :cond_0
    :goto_0
    iput-boolean p1, p0, mNoCommit:Z
...
.method addPreferencesScreen(Landroid/content/DialogInterface;)V
    ...
    iput-object v0, p0, mPreferencesScreens:Ljava/util/List;
...
.method dispatchActivityDestroy()V
    ...
    :try_start_0
    iget-object v1, p0, mActivityDestroyListeners:Ljava/util/List;

    if-eqz v1, :cond_0

    new-instance v1, Ljava/util/ArrayList;

    iget-object v2, p0, mActivityDestroyListeners:Ljava/util/List;
    ...
    :cond_1
    invoke-direct {p0}, dismissAllScreens()V
...
.method dispatchActivityResult(IILandroid/content/Intent;)V
    ...
    :try_start_0
    iget-object v0, p0, mActivityResultListeners:Ljava/util/List;
    ...
    iget-object v1, p0, mActivityResultListeners:Ljava/util/List;
...
.method dispatchActivityStop()V
    ...
    :try_start_0
    iget-object v0, p0, mActivityStopListeners:Ljava/util/List;
    ...
    iget-object v1, p0, mActivityStopListeners:Ljava/util/List;
...
.method public findPreference(Ljava/lang/CharSequence;)Lcom/oneplus/lib/preference/Preference;
    ...
    iget-object v0, p0, mPreferenceScreen:Lcom/oneplus/lib/preference/PreferenceScreen;
...
.method getEditor()Landroid/content/SharedPreferences$Editor;
    ...
    iget-boolean v0, p0, mNoCommit:Z
    ...
    iput-object v0, p0, mEditor:Landroid/content/SharedPreferences$Editor;
...
.method getFragment()Lcom/oneplus/lib/preference/PreferenceFragment;
    ...
    iget-object v0, p0, mFragment:Lcom/oneplus/lib/preference/PreferenceFragment;
...
.method getNextId()J
    ...
    :try_start_0
    iget-wide v0, p0, mNextId:J

    const-wide/16 v2, 0x1

    add-long/2addr v2, v0

    iput-wide v2, p0, mNextId:J
...
.method getNextRequestCode()I
    ...
    :try_start_0
    iget v0, p0, mNextRequestCode:I

    add-int/lit8 v1, v0, 0x1

    iput v1, p0, mNextRequestCode:I
...
.method getOnPreferenceTreeClickListener()Lcom/oneplus/lib/preference/PreferenceManager$OnPreferenceTreeClickListener;
    ...
    iget-object v0, p0, mOnPreferenceTreeClickListener:Lcom/oneplus/lib/preference/PreferenceManager$OnPreferenceTreeClickListener;
...
.method public getSharedPreferences()Landroid/content/SharedPreferences;
    ...
    iget-object v0, p0, mSharedPreferences:Landroid/content/SharedPreferences;

    if-nez v0, :cond_2

    iget v0, p0, mStorage:I
    ...
    :goto_1
    iget-object v1, p0, mSharedPreferencesName:Ljava/lang/String;

    iget v2, p0, mSharedPreferencesMode:I

    invoke-virtual {v0, v1, v2}, Landroid/content/Context;->getSharedPreferences(Ljava/lang/String;I)Landroid/content/SharedPreferences;

    move-result-object v1

    iput-object v1, p0, mSharedPreferences:Landroid/content/SharedPreferences;
...
.method public getSharedPreferencesMode()I
    ...
    iget v0, p0, mSharedPreferencesMode:I
...
.method public getSharedPreferencesName()Ljava/lang/String;
    ...
    iget-object v0, p0, mSharedPreferencesName:Ljava/lang/String;
...
.method inflateFromIntent(Landroid/content/Intent;Lcom/oneplus/lib/preference/PreferenceScreen;)Lcom/oneplus/lib/preference/PreferenceScreen;
    ...
    invoke-direct {p0, p1}, queryIntentActivities(Landroid/content/Intent;)Ljava/util/List;
...
.method public inflateFromResource(Landroid/content/Context;ILcom/oneplus/lib/preference/PreferenceScreen;)Lcom/oneplus/lib/preference/PreferenceScreen;
    ...
    invoke-direct {p0, v0}, setNoCommit(Z)V
...
.method registerOnActivityDestroyListener(Lcom/oneplus/lib/preference/PreferenceManager$OnActivityDestroyListener;)V
    ...
    :try_start_0
    iget-object v0, p0, mActivityDestroyListeners:Ljava/util/List;
    ...
    iput-object v0, p0, mActivityDestroyListeners:Ljava/util/List;
...
.method registerOnActivityResultListener(Lcom/oneplus/lib/preference/PreferenceManager$OnActivityResultListener;)V
    ...
    iput-object v0, p0, mActivityResultListeners:Ljava/util/List;
...
.method public registerOnActivityStopListener(Lcom/oneplus/lib/preference/PreferenceManager$OnActivityStopListener;)V
    ...
    iput-object v0, p0, mActivityStopListeners:Ljava/util/List;
...
.method setFragment(Lcom/oneplus/lib/preference/PreferenceFragment;)V
    ...
    iput-object p1, p0, mFragment:Lcom/oneplus/lib/preference/PreferenceFragment;
...
.method setOnPreferenceTreeClickListener(Lcom/oneplus/lib/preference/PreferenceManager$OnPreferenceTreeClickListener;)V
    ...
    iput-object p1, p0, mOnPreferenceTreeClickListener:Lcom/oneplus/lib/preference/PreferenceManager$OnPreferenceTreeClickListener;
...
.method setPreferences(Lcom/oneplus/lib/preference/PreferenceScreen;)Z
    ...
    iput-object p1, p0, mPreferenceScreen:Lcom/oneplus/lib/preference/PreferenceScreen;
...
.method public setSharedPreferencesMode(I)V
    ...
    iput p1, p0, mSharedPreferencesMode:I

    const/4 v0, 0x0

    iput-object v0, p0, mSharedPreferences:Landroid/content/SharedPreferences;
...
.method public setSharedPreferencesName(Ljava/lang/String;)V
    ...
    iput-object p1, p0, mSharedPreferencesName:Ljava/lang/String;
...
.method public setStorageDeviceEncrypted()V
    ...
    invoke-virtual {p0}, setStorageDeviceProtected()V
