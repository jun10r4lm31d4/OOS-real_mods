...
.method static constructor <clinit>()V
    ...
    sput-object v0, FAST_OUT_LINEAR_IN_INTERPOLATOR:Landroid/animation/TimeInterpolator;
    ...
    sput-object v0, LINEAR_OUT_SLOW_IN_INTERPOLATOR:Landroid/animation/TimeInterpolator;
    ...
    sput-object v0, FastOutSlowInInterpolator:Landroid/view/animation/Interpolator;

    new-instance v0, Landroid/view/animation/PathInterpolator;

    invoke-direct {v0, v2, v4, v3, v3}, Landroid/view/animation/PathInterpolator;-><init>(FFFF)V

    sput-object v0, FastOutLinearInInterpolator:Landroid/view/animation/Interpolator;
    ...
    sput-object v0, FastOutLinearInInterpolatorSine:Landroid/view/animation/Interpolator;

    new-instance v0, Landroid/view/animation/PathInterpolator;

    invoke-direct {v0, v4, v4, v1, v3}, Landroid/view/animation/PathInterpolator;-><init>(FFFF)V

    sput-object v0, LinearOutSlowInInterpolator:Landroid/view/animation/Interpolator;
    ...
    sput-object v0, GRID_ITEM_ANIMATION_INTERPOLATOR:Landroid/view/animation/Interpolator;

    const-string v0, "location:left"

    sput-object v0, PROPNAME_SCREENLOCATION_LEFT:Ljava/lang/String;

    const-string v0, "location:top"

    sput-object v0, PROPNAME_SCREENLOCATION_TOP:Ljava/lang/String;

    const-string v0, "space:width"

    sput-object v0, PROPNAME_WIDTH:Ljava/lang/String;

    const-string v0, "space:height"

    sput-object v0, PROPNAME_HEIGHT:Ljava/lang/String;

    new-instance v0, Landroid/os/Bundle;

    invoke-direct {v0}, Landroid/os/Bundle;-><init>()V

    sput-object v0, mEndValues:Landroid/os/Bundle;
...
.method static synthetic access$000(Landroid/view/View;)V
    ...
    invoke-static {p0}, prepareScene(Landroid/view/View;)V
...
.method static synthetic access$100(Landroid/view/View;)V
    ...
    invoke-static {p0}, runEnterAnimation(Landroid/view/View;)V
...
.method public static captureValues(Landroid/view/View;)Landroid/os/Bundle;
    ...
    sget-object v2, PROPNAME_SCREENLOCATION_LEFT:Ljava/lang/String;
    ...
    sget-object v2, PROPNAME_SCREENLOCATION_TOP:Ljava/lang/String;
    ...
    sget-object v2, PROPNAME_WIDTH:Ljava/lang/String;
    ...
    sget-object v2, PROPNAME_HEIGHT:Ljava/lang/String;
...
.method public static onUiReady(Landroid/content/Intent;Landroid/view/View;)V
    ...
    sput-object v0, mStartValues:Landroid/os/Bundle;
...
.method private static prepareScene(Landroid/view/View;)V
    ...
    sget-object v0, mEndValues:Landroid/os/Bundle;

    sget-object v1, PROPNAME_WIDTH:Ljava/lang/String;
    ...
    sget-object v1, PROPNAME_HEIGHT:Ljava/lang/String;
    ...
    sget-object v0, mStartValues:Landroid/os/Bundle;

    sget-object v1, mEndValues:Landroid/os/Bundle;

    sget-object v2, PROPNAME_WIDTH:Ljava/lang/String;

    invoke-static {v0, v1, v2}, scaleDelta(Landroid/os/Bundle;Landroid/os/Bundle;Ljava/lang/String;)F

    move-result v0

    sget-object v1, mStartValues:Landroid/os/Bundle;

    sget-object v2, mEndValues:Landroid/os/Bundle;

    sget-object v3, PROPNAME_HEIGHT:Ljava/lang/String;

    invoke-static {v1, v2, v3}, scaleDelta(Landroid/os/Bundle;Landroid/os/Bundle;Ljava/lang/String;)F
    ...
    sget-object v3, mEndValues:Landroid/os/Bundle;

    sget-object v4, PROPNAME_SCREENLOCATION_LEFT:Ljava/lang/String;
    ...
    sget-object v4, PROPNAME_SCREENLOCATION_TOP:Ljava/lang/String;
    ...
    sget-object v3, mStartValues:Landroid/os/Bundle;

    sget-object v4, mEndValues:Landroid/os/Bundle;

    sget-object v5, PROPNAME_SCREENLOCATION_LEFT:Ljava/lang/String;

    invoke-static {v3, v4, v5}, translationDelta(Landroid/os/Bundle;Landroid/os/Bundle;Ljava/lang/String;)I

    move-result v3

    sget-object v4, mStartValues:Landroid/os/Bundle;

    sget-object v5, mEndValues:Landroid/os/Bundle;

    sget-object v6, PROPNAME_SCREENLOCATION_TOP:Ljava/lang/String;

    invoke-static {v4, v5, v6}, translationDelta(Landroid/os/Bundle;Landroid/os/Bundle;Ljava/lang/String;)I
...
.method private static runEnterAnimation(Landroid/view/View;)V
    ...
    sget-object v1, FastOutLinearInInterpolatorSine:Landroid/view/animation/Interpolator;
...
.method public static runExitAnimation(Landroid/app/Activity;Landroid/view/View;Landroid/view/View;)V
    ...
    invoke-static {v0, v1, v2}, translationDelta(Landroid/os/Bundle;Landroid/os/Bundle;Ljava/lang/String;)I
    ...
    sget-object v3, PROPNAME_SCREENLOCATION_TOP:Ljava/lang/String;

    invoke-static {v1, v2, v3}, translationDelta(Landroid/os/Bundle;Landroid/os/Bundle;Ljava/lang/String;)I

    move-result v1

    sget-object v2, mStartValues:Landroid/os/Bundle;

    sget-object v3, mEndValues:Landroid/os/Bundle;

    sget-object v4, PROPNAME_WIDTH:Ljava/lang/String;

    invoke-static {v2, v3, v4}, scaleDelta(Landroid/os/Bundle;Landroid/os/Bundle;Ljava/lang/String;)F
    ...
    sget-object v5, PROPNAME_HEIGHT:Ljava/lang/String;

    invoke-static {v3, v4, v5}, scaleDelta(Landroid/os/Bundle;Landroid/os/Bundle;Ljava/lang/String;)F
    ...
    sget-object v8, FastOutLinearInInterpolatorSine:Landroid/view/animation/Interpolator;
    ...
    sget-object v6, FastOutLinearInInterpolatorSine:Landroid/view/animation/Interpolator;
