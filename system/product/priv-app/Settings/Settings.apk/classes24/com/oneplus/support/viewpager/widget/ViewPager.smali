...
.method static constructor <clinit>()V
    ...
    sput-object v0, sPositionComparator:Lcom/oneplus/support/viewpager/widget/ViewPager$ViewPositionComparator;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object v0, p0, mTempItem:Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;
    ...
    iput v1, p0, mFirstOffset:F

    const v1, 0x7f7fffff    # Float.MAX_VALUE

    iput v1, p0, mLastOffset:F

    const/4 v1, 0x1

    iput v1, p0, mOffscreenPageLimit:I

    iput v0, p0, mActivePointerId:I

    iput-boolean v1, p0, mFirstLayout:Z

    const/4 v0, 0x0

    iput-boolean v0, p0, mNeedCalculatePageOffsets:Z
    ...
    iput-object v1, p0, mEndScrollRunnable:Ljava/lang/Runnable;

    iput v0, p0, mScrollState:I

    invoke-virtual {p0}, initViewPager()V
...
.method private calculatePageOffsets(Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;ILcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;)V
    ...
    iget-object v0, p0, mAdapter:Lcom/oneplus/support/viewpager/widget/PagerAdapter;

    invoke-virtual {v0}, Lcom/oneplus/support/viewpager/widget/PagerAdapter;->getCount()I

    move-result v0

    invoke-direct {p0}, getClientWidth()I

    move-result v1

    if-lez v1, :cond_0

    iget v2, p0, mPageMargin:I
    ...
    iget-object v8, p0, mAdapter:Lcom/oneplus/support/viewpager/widget/PagerAdapter;
    ...
    iget-object v9, p0, mAdapter:Lcom/oneplus/support/viewpager/widget/PagerAdapter;
    ...
    iput-boolean v5, p0, mNeedCalculatePageOffsets:Z
...
.method private completeScroll(Z)V
    ...
    invoke-direct {p0, v2}, setScrollingCacheEnabled(Z)V
    ...
    iget-object v5, p0, mScroller:Landroid/widget/Scroller;
    ...
    invoke-direct {p0, v5}, pageScrolled(I)Z

    :cond_2
    iput-boolean v2, p0, mPopulatePending:Z
    ...
    iget-object v1, p0, mEndScrollRunnable:Ljava/lang/Runnable;
...
.method private dispatchOnPageScrolled(IFI)V
    ...
    iget-object v0, p0, mOnPageChangeListener:Lcom/oneplus/support/viewpager/widget/ViewPager$OnPageChangeListener;
    ...
    :cond_0
    iget-object v0, p0, mOnPageChangeListeners:Ljava/util/List;
    ...
    iget-object v2, p0, mOnPageChangeListeners:Ljava/util/List;
    ...
    :cond_2
    iget-object v0, p0, mInternalPageChangeListener:Lcom/oneplus/support/viewpager/widget/ViewPager$OnPageChangeListener;
...
.method private enableLayers(Z)V
    ...
    iget v2, p0, mPageTransformerLayerType:I
...
.method private infoForCurrentScrollPosition()Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;
    ...
    iget-object v9, p0, mTempItem:Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;
    ...
    iget-object v10, p0, mAdapter:Lcom/oneplus/support/viewpager/widget/PagerAdapter;
    ...
    iget-object v13, p0, mItems:Ljava/util/ArrayList;
...
.method private pageScrolled(I)Z
    ...
    :cond_0
    iput-boolean v2, p0, mCalledSuper:Z

    const/4 v0, 0x0

    invoke-virtual {p0, v2, v0, v2}, onPageScrolled(IFI)V

    iget-boolean v0, p0, mCalledSuper:Z
    ...
    :cond_2
    invoke-direct {p0}, infoForCurrentScrollPosition()Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;
    ...
    invoke-virtual {p0, v6, v7, v8}, onPageScrolled(IFI)V

    iget-boolean v2, p0, mCalledSuper:Z
...
.method private performDrag(F)Z
    ...
    iget v3, v0, mLastMotionX:F

    sub-float/2addr v3, v1

    iput v1, v0, mLastMotionX:F
    ...
    invoke-direct/range {p0 .. p0}, getClientWidth()I

    move-result v6

    int-to-float v7, v6

    iget v8, v0, mFirstOffset:F

    mul-float/2addr v7, v8

    int-to-float v8, v6

    iget v9, v0, mLastOffset:F
    ...
    iget-object v11, v0, mItems:Ljava/util/ArrayList;
    ...
    iget-object v12, v0, mItems:Ljava/util/ArrayList;
    ...
    iget-object v14, v0, mAdapter:Lcom/oneplus/support/viewpager/widget/PagerAdapter;
    ...
    iget-object v14, v0, mLeftEdge:Landroid/widget/EdgeEffect;
    ...
    iget-object v13, v0, mRightEdge:Landroid/widget/EdgeEffect;
    ...
    invoke-virtual {v0, v1, v13}, scrollTo(II)V
...
.method private recomputeScrollPosition(IIII)V
    ...
    invoke-virtual {p0}, getCurrentItem()I
    ...
    invoke-virtual {p0, v4, v5}, scrollTo(II)V
    ...
    invoke-virtual {p0, v0}, infoForPosition(I)Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;
    ...
    invoke-direct {p0, v3}, completeScroll(Z)V
...
.method private resetTouch()Z
    ...
    iget-object v0, p0, mLeftEdge:Landroid/widget/EdgeEffect;

    invoke-virtual {v0}, Landroid/widget/EdgeEffect;->onRelease()V

    iget-object v0, p0, mRightEdge:Landroid/widget/EdgeEffect;
...
.method private scrollToItem(IZIZ)V
    ...
    invoke-virtual {p0, p1}, infoForPosition(I)Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;
    ...
    invoke-virtual {p0, v1, v2, p3}, smoothScrollTo(III)V

    if-eqz p4, :cond_3

    invoke-direct {p0, p1}, dispatchOnPageSelected(I)V
    ...
    invoke-virtual {p0, v1, v2}, scrollTo(II)V

    invoke-direct {p0, v1}, pageScrolled(I)Z
...
.method private sortChildDrawingOrder()V
    ...
    iget v0, p0, mDrawingOrder:I

    if-eqz v0, :cond_2

    iget-object v0, p0, mDrawingOrderedChildren:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, mDrawingOrderedChildren:Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object v1, p0, mDrawingOrderedChildren:Ljava/util/ArrayList;

    sget-object v2, sPositionComparator:Lcom/oneplus/support/viewpager/widget/ViewPager$ViewPositionComparator;
...
.method public addFocusables(Ljava/util/ArrayList;II)V
    ...
    invoke-virtual {p0, v3}, infoForChild(Landroid/view/View;)Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;
...
.method addNewItem(II)Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;
    ...
    iget-object v1, p0, mAdapter:Lcom/oneplus/support/viewpager/widget/PagerAdapter;
...
.method public addOnAdapterChangeListener(Lcom/oneplus/support/viewpager/widget/ViewPager$OnAdapterChangeListener;)V
    .locals 1
    .param p1    # Lcom/oneplus/support/viewpager/widget/ViewPager$OnAdapterChangeListener;
        .annotation build Lcom/oneplus/support/annotation/NonNull;
        .end annotation
    .end param

    iget-object v0, p0, mAdapterChangeListeners:Ljava/util/List;
    ...
    iput-object v0, p0, mAdapterChangeListeners:Ljava/util/List;
...
.method public addOnPageChangeListener(Lcom/oneplus/support/viewpager/widget/ViewPager$OnPageChangeListener;)V
    .locals 1
    .param p1    # Lcom/oneplus/support/viewpager/widget/ViewPager$OnPageChangeListener;
        .annotation build Lcom/oneplus/support/annotation/NonNull;
        .end annotation
    .end param
    ...
    iput-object v0, p0, mOnPageChangeListeners:Ljava/util/List;
...
.method public addTouchables(Ljava/util/ArrayList;)V
    ...
    invoke-virtual {p0, v1}, infoForChild(Landroid/view/View;)Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-static {p1}, isDecorView(Landroid/view/View;)Z
...
.method public arrowScroll(I)Z
    ...
    invoke-direct {p0, v3, v2}, getChildRectInPagerCoordinates(Landroid/graphics/Rect;Landroid/view/View;)Landroid/graphics/Rect;
    ...
    invoke-direct {p0, v4, v0}, getChildRectInPagerCoordinates(Landroid/graphics/Rect;Landroid/view/View;)Landroid/graphics/Rect;
...
.method public beginFakeDrag()Z
    ...
    iput-boolean v0, p0, mFakeDragging:Z

    invoke-virtual {p0, v0}, setScrollState(I)V

    const/4 v1, 0x0

    iput v1, p0, mLastMotionX:F

    iput v1, p0, mInitialMotionX:F
    ...
    iput-wide v10, p0, mFakeDragBeginTime:J
...
.method protected canScroll(Landroid/view/View;ZIII)Z
    ...
    invoke-virtual/range {v7 .. v12}, canScroll(Landroid/view/View;ZIII)Z
...
.method public computeScroll()V
    ...
    iput-boolean v0, p0, mIsScrollStarted:Z
...
.method dataSetChanged()V
    ...
    iget-object v6, p0, mAdapter:Lcom/oneplus/support/viewpager/widget/PagerAdapter;
    ...
    sget-object v7, COMPARATOR:Ljava/util/Comparator;
    ...
    :cond_9
    invoke-virtual {p0, v2, v4, v3}, setCurrentItemInternal(IZZ)V
...
.method public dispatchPopulateAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)Z
    ...
    invoke-virtual {p0, v2}, infoForChild(Landroid/view/View;)Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v3, p0, mAdapter:Lcom/oneplus/support/viewpager/widget/PagerAdapter;
    ...
    :cond_0
    iget-object v2, p0, mLeftEdge:Landroid/widget/EdgeEffect;

    invoke-virtual {v2}, Landroid/widget/EdgeEffect;->finish()V

    iget-object v2, p0, mRightEdge:Landroid/widget/EdgeEffect;
...
.method public endFakeDrag()V
    ...
    iget-boolean v0, p0, mFakeDragging:Z
    ...
    iget v8, p0, mLastMotionX:F

    iget v9, p0, mInitialMotionX:F

    sub-float/2addr v8, v9

    float-to-int v8, v8

    invoke-direct {p0, v6, v7, v1, v8}, determineTargetPage(IFII)I

    move-result v9

    invoke-virtual {p0, v9, v2, v2, v1}, setCurrentItemInternal(IZZI)V
...
.method public executeKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    invoke-virtual {p0, v3}, arrowScroll(I)Z
...
.method public fakeDragBy(F)V
    ...
    iget-boolean v1, v0, mFakeDragging:Z

    if-eqz v1, :cond_5

    iget-object v1, v0, mAdapter:Lcom/oneplus/support/viewpager/widget/PagerAdapter;
    ...
    iget v5, v0, mFirstOffset:F

    mul-float/2addr v4, v5

    int-to-float v5, v3

    iget v6, v0, mLastOffset:F
    ...
    iget-object v9, v0, mAdapter:Lcom/oneplus/support/viewpager/widget/PagerAdapter;
    ...
    invoke-virtual {v0, v8, v9}, scrollTo(II)V

    float-to-int v8, v2

    invoke-direct {v0, v8}, pageScrolled(I)Z

    invoke-static {}, Landroid/os/SystemClock;->uptimeMillis()J

    move-result-wide v17

    iget-wide v9, v0, mFakeDragBeginTime:J

    const/4 v13, 0x2

    iget v14, v0, mLastMotionX:F
    ...
    iget-object v9, v0, mVelocityTracker:Landroid/view/VelocityTracker;
...
.method infoForAnyChild(Landroid/view/View;)Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;
    ...
    :cond_2
    invoke-virtual {p0, p1}, infoForChild(Landroid/view/View;)Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;
...
.method infoForChild(Landroid/view/View;)Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;
    ...
    iget-object v2, p0, mAdapter:Lcom/oneplus/support/viewpager/widget/PagerAdapter;
...
.method initViewPager()V
    ...
    iput v4, p0, mMinimumVelocity:I

    invoke-virtual {v2}, Landroid/view/ViewConfiguration;->getScaledMaximumFlingVelocity()I

    move-result v4

    iput v4, p0, mMaximumVelocity:I

    new-instance v4, Landroid/widget/EdgeEffect;

    invoke-direct {v4, v1}, Landroid/widget/EdgeEffect;-><init>(Landroid/content/Context;)V

    iput-object v4, p0, mLeftEdge:Landroid/widget/EdgeEffect;

    new-instance v4, Landroid/widget/EdgeEffect;

    invoke-direct {v4, v1}, Landroid/widget/EdgeEffect;-><init>(Landroid/content/Context;)V

    iput-object v4, p0, mRightEdge:Landroid/widget/EdgeEffect;
    ...
    iput v4, p0, mDefaultGutterSize:I
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget v1, v0, mPageMargin:I

    if-lez v1, :cond_5

    iget-object v1, v0, mMarginDrawable:Landroid/graphics/drawable/Drawable;

    if-eqz v1, :cond_5

    iget-object v1, v0, mItems:Ljava/util/ArrayList;
    ...
    iget-object v5, v0, mItems:Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object v11, v0, mAdapter:Lcom/oneplus/support/viewpager/widget/PagerAdapter;
    ...
    iget-object v12, v0, mMarginDrawable:Landroid/graphics/drawable/Drawable;

    invoke-static {v11}, Ljava/lang/Math;->round(F)I

    move-result v13

    iget v14, v0, mTopPageBounds:I
    ...
    iget v3, v0, mBottomPageBounds:I

    invoke-virtual {v12, v13, v14, v15, v3}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V

    iget-object v3, v0, mMarginDrawable:Landroid/graphics/drawable/Drawable;
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v0, v6, mIsBeingDragged:Z
    ...
    :cond_1
    iget-boolean v0, v6, mIsUnableToDrag:Z
    ...
    :cond_4
    iget v11, v6, mActivePointerId:I
    ...
    invoke-direct {v6, v0, v14}, isGutterDrag(FF)Z
    ...
    iput v13, v6, mLastMotionX:F

    iput v9, v6, mLastMotionY:F

    iput-boolean v10, v6, mIsUnableToDrag:Z
    ...
    iput-boolean v10, v6, mIsBeingDragged:Z

    invoke-direct {v6, v10}, requestParentDisallowInterceptTouchEvent(Z)V

    invoke-virtual {v6, v10}, setScrollState(I)V

    cmpl-float v0, v14, v17

    if-lez v0, :cond_8

    iget v0, v6, mInitialMotionX:F
    ...
    :goto_0
    iput v0, v6, mLastMotionX:F

    iput v9, v6, mLastMotionY:F

    invoke-direct {v6, v10}, setScrollingCacheEnabled(Z)V
    ...
    invoke-direct {v6, v13}, performDrag(F)Z
    ...
    iput v1, v6, mInitialMotionX:F

    iput v1, v6, mLastMotionX:F

    invoke-virtual/range {p1 .. p1}, Landroid/view/MotionEvent;->getY()F

    move-result v1

    iput v1, v6, mInitialMotionY:F

    iput v1, v6, mLastMotionY:F
    ...
    iput v2, v6, mActivePointerId:I

    iput-boolean v1, v6, mIsUnableToDrag:Z

    iput-boolean v10, v6, mIsScrollStarted:Z

    iget-object v1, v6, mScroller:Landroid/widget/Scroller;
    ...
    iget-object v0, v6, mScroller:Landroid/widget/Scroller;
    ...
    iput-boolean v0, v6, mPopulatePending:Z
    ...
    invoke-direct {v6, v0}, completeScroll(Z)V

    iput-boolean v0, v6, mIsBeingDragged:Z
    ...
    :cond_f
    :goto_3
    invoke-direct/range {p0 .. p0}, resetTouch()Z
...
.method protected onLayout(ZIIII)V
    ...
    invoke-virtual {v0, v14}, infoForChild(Landroid/view/View;)Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;
    ...
    iput v5, v0, mTopPageBounds:I

    sub-int v1, v3, v7

    iput v1, v0, mBottomPageBounds:I

    iput v9, v0, mDecorChildCount:I

    iget-boolean v1, v0, mFirstLayout:Z

    if-eqz v1, :cond_e

    iget v1, v0, mCurItem:I

    const/4 v2, 0x0

    invoke-direct {v0, v1, v2, v2, v2}, scrollToItem(IZIZ)V
    ...
    :goto_7
    iput-boolean v2, v0, mFirstLayout:Z
...
.method protected onMeasure(II)V
    ...
    invoke-static {v1, v2}, getDefaultSize(II)I

    move-result v3

    move/from16 v4, p2

    invoke-static {v1, v4}, getDefaultSize(II)I

    move-result v5

    invoke-virtual {v0, v3, v5}, setMeasuredDimension(II)V
    ...
    iget v6, v0, mDefaultGutterSize:I

    invoke-static {v5, v6}, Ljava/lang/Math;->min(II)I

    move-result v6

    iput v6, v0, mGutterSize:I
    ...
    iput v2, v0, mChildWidthMeasureSpec:I

    invoke-static {v7, v1}, Landroid/view/View$MeasureSpec;->makeMeasureSpec(II)I

    move-result v2

    iput v2, v0, mChildHeightMeasureSpec:I

    const/4 v2, 0x1

    iput-boolean v2, v0, mInLayout:Z
    ...
    iget v9, v0, mChildHeightMeasureSpec:I
...
.method protected onPageScrolled(IFI)V
    ...
    :cond_5
    invoke-direct/range {p0 .. p3}, dispatchOnPageScrolled(IFI)V

    iget-object v1, v0, mPageTransformer:Lcom/oneplus/support/viewpager/widget/ViewPager$PageTransformer;
    ...
    iget-object v8, v0, mPageTransformer:Lcom/oneplus/support/viewpager/widget/ViewPager$PageTransformer;
    ...
    :cond_7
    iput-boolean v2, v0, mCalledSuper:Z
...
.method protected onRequestFocusInDescendants(ILandroid/graphics/Rect;)Z
    ...
    invoke-virtual {p0, v5}, infoForChild(Landroid/view/View;)Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {p0, v1, v2, v3}, setCurrentItemInternal(IZZ)V
...
.method protected onSizeChanged(IIII)V
    ...
    invoke-direct {p0, p1, p3, v0, v0}, recomputeScrollPosition(IIII)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v2, v0, mFakeDragging:Z
    ...
    :cond_1
    iget-object v2, v0, mAdapter:Lcom/oneplus/support/viewpager/widget/PagerAdapter;
    ...
    iput-object v2, v0, mVelocityTracker:Landroid/view/VelocityTracker;
    ...
    :cond_6
    iget-boolean v6, v0, mIsBeingDragged:Z

    if-eqz v6, :cond_7

    iget v6, v0, mCurItem:I

    invoke-direct {v0, v6, v3, v4, v4}, scrollToItem(IZIZ)V
    ...
    :cond_8
    iget-boolean v4, v0, mIsBeingDragged:Z
    ...
    iput-boolean v3, v0, mIsBeingDragged:Z

    invoke-direct {v0, v3}, requestParentDisallowInterceptTouchEvent(Z)V

    iget v10, v0, mInitialMotionX:F
    ...
    :goto_0
    iput v10, v0, mLastMotionX:F

    iput v8, v0, mLastMotionY:F

    invoke-virtual {v0, v3}, setScrollState(I)V

    invoke-direct {v0, v3}, setScrollingCacheEnabled(Z)V
    ...
    invoke-direct {v0, v6}, performDrag(F)Z
    ...
    iput-boolean v3, v0, mPopulatePending:Z
    ...
    invoke-direct/range {p0 .. p0}, infoForCurrentScrollPosition()Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;

    move-result-object v9

    iget v10, v0, mPageMargin:I
    ...
    invoke-direct {v0, v11, v12, v6, v15}, determineTargetPage(IFII)I

    move-result v2

    invoke-virtual {v0, v2, v3, v3, v6}, setCurrentItemInternal(IZZI)V
    ...
    iput-boolean v4, v0, mPopulatePending:Z
    ...
    iput v2, v0, mInitialMotionX:F

    iput v2, v0, mLastMotionX:F

    invoke-virtual/range {p1 .. p1}, Landroid/view/MotionEvent;->getY()F

    move-result v2

    iput v2, v0, mInitialMotionY:F

    iput v2, v0, mLastMotionY:F
...
.method pageLeft()Z
    ...
    invoke-virtual {p0, v0, v1}, setCurrentItem(IZ)V
...
.method pageRight()Z
    ...
    invoke-virtual {p0, v0, v2}, setCurrentItem(IZ)V
...
.method populate(I)V
    ...
    iget v3, v1, mCurItem:I

    if-eq v3, v2, :cond_0

    invoke-virtual {v1, v3}, infoForPosition(I)Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;

    move-result-object v0

    iput v2, v1, mCurItem:I
    ...
    :goto_0
    iget-object v0, v1, mAdapter:Lcom/oneplus/support/viewpager/widget/PagerAdapter;
    ...
    :cond_1
    iget-boolean v0, v1, mPopulatePending:Z
    ...
    iget v4, v1, mOffscreenPageLimit:I

    const/4 v0, 0x0

    iget v5, v1, mCurItem:I
    ...
    iget v0, v1, mExpectedAdapterCount:I
    ...
    :goto_1
    iget-object v9, v1, mItems:Ljava/util/ArrayList;
    ...
    iget v9, v1, mCurItem:I

    invoke-virtual {v1, v9, v0}, addNewItem(II)Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;
    ...
    iget-object v13, v1, mItems:Ljava/util/ArrayList;
    ...
    iget-object v15, v1, mItems:Ljava/util/ArrayList;

    invoke-virtual {v15, v12}, Ljava/util/ArrayList;->remove(I)Ljava/lang/Object;

    iget-object v15, v1, mAdapter:Lcom/oneplus/support/viewpager/widget/PagerAdapter;
    ...
    iget-object v2, v1, mItems:Ljava/util/ArrayList;
    ...
    invoke-virtual {v1, v10, v2}, addNewItem(II)Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;
    ...
    iget-object v12, v1, mItems:Ljava/util/ArrayList;
    ...
    iget-object v4, v1, mItems:Ljava/util/ArrayList;

    invoke-virtual {v4, v10}, Ljava/util/ArrayList;->remove(I)Ljava/lang/Object;

    iget-object v4, v1, mAdapter:Lcom/oneplus/support/viewpager/widget/PagerAdapter;
    ...
    :cond_18
    invoke-virtual {v1, v15, v10}, addNewItem(II)Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;
    ...
    iget-object v5, v1, mItems:Ljava/util/ArrayList;
    ...
    :goto_12
    invoke-direct {v1, v8, v0, v3}, calculatePageOffsets(Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;ILcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;)V
    ...
    :goto_13
    iget-object v2, v1, mAdapter:Lcom/oneplus/support/viewpager/widget/PagerAdapter;
    ...
    invoke-virtual {v1, v4}, getChildAt(I)Landroid/view/View;
    ...
    invoke-virtual {v1, v5}, infoForChild(Landroid/view/View;)Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;
    ...
    invoke-virtual {v1, v4}, infoForAnyChild(Landroid/view/View;)Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;
    ...
    invoke-virtual {v1, v9}, getChildAt(I)Landroid/view/View;

    move-result-object v10

    invoke-virtual {v1, v10}, infoForChild(Landroid/view/View;)Lcom/oneplus/support/viewpager/widget/ViewPager$ItemInfo;
    ...
    iget v5, v1, mExpectedAdapterCount:I
    ...
    iget-object v5, v1, mAdapter:Lcom/oneplus/support/viewpager/widget/PagerAdapter;
...
.method public setAdapter(Lcom/oneplus/support/viewpager/widget/PagerAdapter;)V
    .locals 8
    .param p1    # Lcom/oneplus/support/viewpager/widget/PagerAdapter;
        .annotation build Lcom/oneplus/support/annotation/Nullable;
        .end annotation
    .end param
    ...
    iget-object v4, p0, mAdapter:Lcom/oneplus/support/viewpager/widget/PagerAdapter;
    ...
    iput v2, p0, mCurItem:I

    invoke-virtual {p0, v2, v2}, scrollTo(II)V

    :cond_1
    iget-object v0, p0, mAdapter:Lcom/oneplus/support/viewpager/widget/PagerAdapter;

    iput-object p1, p0, mAdapter:Lcom/oneplus/support/viewpager/widget/PagerAdapter;

    iput v2, p0, mExpectedAdapterCount:I

    iget-object v3, p0, mAdapter:Lcom/oneplus/support/viewpager/widget/PagerAdapter;

    if-eqz v3, :cond_5

    iget-object v3, p0, mObserver:Lcom/oneplus/support/viewpager/widget/ViewPager$PagerObserver;
    ...
    iput-object v3, p0, mObserver:Lcom/oneplus/support/viewpager/widget/ViewPager$PagerObserver;

    :cond_2
    iget-object v3, p0, mAdapter:Lcom/oneplus/support/viewpager/widget/PagerAdapter;

    iget-object v4, p0, mObserver:Lcom/oneplus/support/viewpager/widget/ViewPager$PagerObserver;
    ...
    iget-object v5, p0, mAdapter:Lcom/oneplus/support/viewpager/widget/PagerAdapter;

    invoke-virtual {v5}, Lcom/oneplus/support/viewpager/widget/PagerAdapter;->getCount()I

    move-result v5

    iput v5, p0, mExpectedAdapterCount:I

    iget v5, p0, mRestoredCurItem:I

    if-ltz v5, :cond_3

    iget-object v5, p0, mAdapter:Lcom/oneplus/support/viewpager/widget/PagerAdapter;

    iget-object v6, p0, mRestoredAdapterState:Landroid/os/Parcelable;

    iget-object v7, p0, mRestoredClassLoader:Ljava/lang/ClassLoader;
    ...
    invoke-virtual {p0, v5, v2, v4}, setCurrentItemInternal(IZZ)V

    const/4 v2, -0x1

    iput v2, p0, mRestoredCurItem:I
    ...
    :cond_5
    :goto_1
    iget-object v1, p0, mAdapterChangeListeners:Ljava/util/List;
    ...
    iget-object v2, p0, mAdapterChangeListeners:Ljava/util/List;
    ...
    iget-object v3, p0, mAdapterChangeListeners:Ljava/util/List;
...
.method public setCurrentItem(I)V
    ...
    iget-boolean v1, p0, mFirstLayout:Z

    xor-int/lit8 v1, v1, 0x1

    invoke-virtual {p0, p1, v1, v0}, setCurrentItemInternal(IZZ)V
...
.method public setCurrentItem(IZ)V
    ...
    invoke-virtual {p0, p1, p2, v0}, setCurrentItemInternal(IZZ)V
...
.method setCurrentItemInternal(IZZ)V
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, setCurrentItemInternal(IZZI)V
...
.method setInternalPageChangeListener(Lcom/oneplus/support/viewpager/widget/ViewPager$OnPageChangeListener;)Lcom/oneplus/support/viewpager/widget/ViewPager$OnPageChangeListener;
    ...
    iput-object p1, p0, mInternalPageChangeListener:Lcom/oneplus/support/viewpager/widget/ViewPager$OnPageChangeListener;
...
.method public setOnPageChangeListener(Lcom/oneplus/support/viewpager/widget/ViewPager$OnPageChangeListener;)V
    ...
    iput-object p1, p0, mOnPageChangeListener:Lcom/oneplus/support/viewpager/widget/ViewPager$OnPageChangeListener;
...
.method public setPageTransformer(ZLcom/oneplus/support/viewpager/widget/ViewPager$PageTransformer;)V
    .locals 1
    .param p2    # Lcom/oneplus/support/viewpager/widget/ViewPager$PageTransformer;
        .annotation build Lcom/oneplus/support/annotation/Nullable;
        .end annotation
    .end param
    ...
    invoke-virtual {p0, p1, p2, v0}, setPageTransformer(ZLcom/oneplus/support/viewpager/widget/ViewPager$PageTransformer;I)V
...
.method public setPageTransformer(ZLcom/oneplus/support/viewpager/widget/ViewPager$PageTransformer;I)V
    ...
    :goto_0
    iget-object v3, p0, mPageTransformer:Lcom/oneplus/support/viewpager/widget/ViewPager$PageTransformer;
    ...
    :goto_2
    iput-object p2, p0, mPageTransformer:Lcom/oneplus/support/viewpager/widget/ViewPager$PageTransformer;

    invoke-virtual {p0, v2}, setChildrenDrawingOrderEnabled(Z)V
    ...
    :cond_3
    iput v0, p0, mDrawingOrder:I

    iput p3, p0, mPageTransformerLayerType:I

    goto :goto_3

    :cond_4
    iput v1, p0, mDrawingOrder:I
...
.method setScrollState(I)V
    ...
    iget-object v0, p0, mPageTransformer:Lcom/oneplus/support/viewpager/widget/ViewPager$PageTransformer;
    ...
    :cond_2
    invoke-direct {p0, p1}, dispatchOnScrollStateChanged(I)V
...
.method smoothScrollTo(III)V
    ...
    invoke-direct {v0, v2}, setScrollingCacheEnabled(Z)V
    ...
    iget-boolean v4, v0, mIsScrollStarted:Z
    ...
    :goto_1
    iget-object v5, v0, mScroller:Landroid/widget/Scroller;
    ...
    invoke-direct {v0, v2}, completeScroll(Z)V

    invoke-virtual/range {p0 .. p0}, populate()V

    invoke-virtual {v0, v2}, setScrollState(I)V
    ...
    invoke-virtual {v0, v15}, distanceInfluenceForSnapDuration(F)F
    ...
    iget-object v7, v0, mAdapter:Lcom/oneplus/support/viewpager/widget/PagerAdapter;

    iget v8, v0, mCurItem:I
    ...
    iput-boolean v2, v0, mIsScrollStarted:Z
