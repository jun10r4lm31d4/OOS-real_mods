...
.method public constructor <init>(Lcom/oneplus/support/lifecycle/LifecycleOwner;)V
    ...
    iput-object v0, p0, mObserverMap:Lcom/oneplus/support/collection/FastSafeIterableMap;

    const/4 v0, 0x0

    iput v0, p0, mAddingObserverCounter:I

    iput-boolean v0, p0, mHandlingEvent:Z

    iput-boolean v0, p0, mNewEventOccurred:Z

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mParentStates:Ljava/util/ArrayList;

    new-instance v0, Ljava/lang/ref/WeakReference;

    invoke-direct {v0, p1}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object v0, p0, mLifecycleOwner:Ljava/lang/ref/WeakReference;

    sget-object v0, Lcom/oneplus/support/lifecycle/Lifecycle$State;->INITIALIZED:Lcom/oneplus/support/lifecycle/Lifecycle$State;

    iput-object v0, p0, mState:Lcom/oneplus/support/lifecycle/Lifecycle$State;
...
.method private backwardPass(Lcom/oneplus/support/lifecycle/LifecycleOwner;)V
    ...
    iget-object v0, p0, mObserverMap:Lcom/oneplus/support/collection/FastSafeIterableMap;
    ...
    iget-boolean v1, p0, mNewEventOccurred:Z
    ...
    iget-object v4, p0, mState:Lcom/oneplus/support/lifecycle/Lifecycle$State;
    ...
    iget-boolean v3, p0, mNewEventOccurred:Z

    if-nez v3, :cond_0

    iget-object v3, p0, mObserverMap:Lcom/oneplus/support/collection/FastSafeIterableMap;
    ...
    invoke-static {v3}, downEvent(Lcom/oneplus/support/lifecycle/Lifecycle$State;)Lcom/oneplus/support/lifecycle/Lifecycle$Event;

    move-result-object v3

    invoke-static {v3}, getStateAfter(Lcom/oneplus/support/lifecycle/Lifecycle$Event;)Lcom/oneplus/support/lifecycle/Lifecycle$State;

    move-result-object v4

    invoke-direct {p0, v4}, pushParentState(Lcom/oneplus/support/lifecycle/Lifecycle$State;)V
    ...
    invoke-direct {p0}, popParentState()V
...
.method private calculateTargetState(Lcom/oneplus/support/lifecycle/LifecycleObserver;)Lcom/oneplus/support/lifecycle/Lifecycle$State;
    ...
    :goto_0
    iget-object v3, p0, mParentStates:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, mParentStates:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, mState:Lcom/oneplus/support/lifecycle/Lifecycle$State;

    invoke-static {v3, v2}, min(Lcom/oneplus/support/lifecycle/Lifecycle$State;Lcom/oneplus/support/lifecycle/Lifecycle$State;)Lcom/oneplus/support/lifecycle/Lifecycle$State;

    move-result-object v3

    invoke-static {v3, v1}, min(Lcom/oneplus/support/lifecycle/Lifecycle$State;Lcom/oneplus/support/lifecycle/Lifecycle$State;)Lcom/oneplus/support/lifecycle/Lifecycle$State;
...
.method private forwardPass(Lcom/oneplus/support/lifecycle/LifecycleOwner;)V
    ...
    invoke-direct {p0, v3}, pushParentState(Lcom/oneplus/support/lifecycle/Lifecycle$State;)V

    iget-object v3, v2, Lcom/oneplus/support/lifecycle/LifecycleRegistry$ObserverWithState;->mState:Lcom/oneplus/support/lifecycle/Lifecycle$State;

    invoke-static {v3}, upEvent(Lcom/oneplus/support/lifecycle/Lifecycle$State;)Lcom/oneplus/support/lifecycle/Lifecycle$Event;
...
.method private isSynced()Z
    ...
    iget-object v2, p0, mObserverMap:Lcom/oneplus/support/collection/FastSafeIterableMap;
...
.method private moveToState(Lcom/oneplus/support/lifecycle/Lifecycle$State;)V
    ...
    iget-object v0, p0, mState:Lcom/oneplus/support/lifecycle/Lifecycle$State;
    ...
    :cond_0
    iput-object p1, p0, mState:Lcom/oneplus/support/lifecycle/Lifecycle$State;

    iget-boolean v0, p0, mHandlingEvent:Z

    const/4 v1, 0x1

    if-nez v0, :cond_2

    iget v0, p0, mAddingObserverCounter:I
    ...
    :cond_1
    iput-boolean v1, p0, mHandlingEvent:Z

    invoke-direct {p0}, sync()V
    ...
    :cond_2
    :goto_0
    iput-boolean v1, p0, mNewEventOccurred:Z
...
.method private popParentState()V
    ...
    iget-object v0, p0, mParentStates:Ljava/util/ArrayList;
...
.method private sync()V
    ...
    iget-object v0, p0, mLifecycleOwner:Ljava/lang/ref/WeakReference;
    ...
    iput-boolean v2, p0, mNewEventOccurred:Z

    iget-object v1, p0, mState:Lcom/oneplus/support/lifecycle/Lifecycle$State;
    ...
    invoke-direct {p0, v0}, backwardPass(Lcom/oneplus/support/lifecycle/LifecycleOwner;)V

    :cond_1
    iget-object v1, p0, mObserverMap:Lcom/oneplus/support/collection/FastSafeIterableMap;

    invoke-virtual {v1}, Lcom/oneplus/support/collection/FastSafeIterableMap;->newest()Ljava/util/Map$Entry;

    move-result-object v1

    iget-boolean v2, p0, mNewEventOccurred:Z

    if-nez v2, :cond_2

    if-eqz v1, :cond_2

    iget-object v2, p0, mState:Lcom/oneplus/support/lifecycle/Lifecycle$State;
    ...
    invoke-direct {p0, v0}, forwardPass(Lcom/oneplus/support/lifecycle/LifecycleOwner;)V
...
.method public addObserver(Lcom/oneplus/support/lifecycle/LifecycleObserver;)V
    ...
    :cond_1
    iget-object v3, p0, mLifecycleOwner:Ljava/lang/ref/WeakReference;
    ...
    :cond_2
    iget v4, p0, mAddingObserverCounter:I

    const/4 v5, 0x1

    if-nez v4, :cond_4

    iget-boolean v4, p0, mHandlingEvent:Z
    ...
    :goto_2
    invoke-direct {p0, p1}, calculateTargetState(Lcom/oneplus/support/lifecycle/LifecycleObserver;)Lcom/oneplus/support/lifecycle/Lifecycle$State;

    move-result-object v6

    iget v7, p0, mAddingObserverCounter:I

    add-int/2addr v7, v5

    iput v7, p0, mAddingObserverCounter:I
    ...
    iget-object v7, p0, mObserverMap:Lcom/oneplus/support/collection/FastSafeIterableMap;
    ...
    invoke-direct {p0, v7}, pushParentState(Lcom/oneplus/support/lifecycle/Lifecycle$State;)V

    iget-object v7, v1, Lcom/oneplus/support/lifecycle/LifecycleRegistry$ObserverWithState;->mState:Lcom/oneplus/support/lifecycle/Lifecycle$State;

    invoke-static {v7}, upEvent(Lcom/oneplus/support/lifecycle/Lifecycle$State;)Lcom/oneplus/support/lifecycle/Lifecycle$Event;
...
.method public handleLifecycleEvent(Lcom/oneplus/support/lifecycle/Lifecycle$Event;)V
    ...
    invoke-static {p1}, getStateAfter(Lcom/oneplus/support/lifecycle/Lifecycle$Event;)Lcom/oneplus/support/lifecycle/Lifecycle$State;

    move-result-object v0

    invoke-direct {p0, v0}, moveToState(Lcom/oneplus/support/lifecycle/Lifecycle$State;)V
...
.method public markState(Lcom/oneplus/support/lifecycle/Lifecycle$State;)V
    ...
    invoke-direct {p0, p1}, moveToState(Lcom/oneplus/support/lifecycle/Lifecycle$State;)V
