...
.field public static final KEY_ALWAYS_SHOW_NAVIGATION_BAR:Ljava/lang/String; = "always_show_navigation_bar"

.field public static final KEY_BACK_HOME:Ljava/lang/String; = "back_home"
...
.field public static final KEY_GESTURE_NAVIGATION_BAR:Ljava/lang/String; = "gesture_navigation_bar"
...
.method static synthetic access$000()Z
    ...
    invoke-static {}, isSupportHardwareKeys()Z
...
.method public static isCustomSettingsEnable(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, is3ButtonEnabled(Landroid/content/Context;)Z
...
.method public synthetic lambda$onPreferenceChange$3$OPNavigationBarGesturesSettings()V
    ...
    iget-object v0, p0, mGestureHiddenBar:Landroidx/preference/SwitchPreference;
...
.method public synthetic lambda$onRadioButtonClicked$1$OPNavigationBarGesturesSettings()V
    ...
    iget-object v0, p0, mAlwaysShowNavigationBar:Lcom/android/settings/ui/RadioButtonPreference;

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Lcom/android/settings/ui/RadioButtonPreference;->setEnabled(Z)V

    iget-object v0, p0, mGestureNavigationBar:Lcom/android/settings/ui/RadioButtonPreference;

    invoke-virtual {v0, v1}, Lcom/android/settings/ui/RadioButtonPreference;->setEnabled(Z)V

    iget-object v0, p0, mGestureNavigationBarDeprecated:Lcom/android/settings/ui/RadioButtonPreference;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, mCustomization:Landroidx/preference/Preference;
    ...
    iput-object v1, p0, mAlwaysShowNavigationBar:Lcom/android/settings/ui/RadioButtonPreference;
    ...
    iput-object v2, p0, mGestureNavigationBar:Lcom/android/settings/ui/RadioButtonPreference;
    ...
    iput-object v3, p0, mGestureNavigationBarDeprecated:Lcom/android/settings/ui/RadioButtonPreference;
    ...
    iput-object v4, p0, mGestureHiddenBar:Landroidx/preference/SwitchPreference;
    ...
    iput-object v4, p0, mOPPhoneControlWayCategory:Lcom/oneplus/settings/ui/OPPhoneControlWayCategory;
    ...
    iput-object v4, p0, mCustomSettingsCategory:Landroidx/preference/PreferenceCategory;
    ...
    iget-object v4, p0, mAlwaysShowNavigationBar:Lcom/android/settings/ui/RadioButtonPreference;
    ...
    iget-object v4, p0, mGestureNavigationBar:Lcom/android/settings/ui/RadioButtonPreference;
    ...
    iget-object v4, p0, mGestureNavigationBarDeprecated:Lcom/android/settings/ui/RadioButtonPreference;
    ...
    iget-object v4, p0, mCustomization:Landroidx/preference/Preference;
    ...
    iget-object v4, p0, mGestureHiddenBar:Landroidx/preference/SwitchPreference;
    ...
    iput-object v4, p0, mOverlayManager:Landroid/content/om/IOverlayManager;
    ...
    iput-object v4, p0, mbuttonLayoutPref:Lcom/android/settingslib/widget/LayoutPreference;

    iget-object v4, p0, mbuttonLayoutPref:Lcom/android/settingslib/widget/LayoutPreference;
    ...
    invoke-static {v7}, isGesturalEnabled(Landroid/content/Context;)Z
    ...
    invoke-static {v7}, is2ButtonEnabled(Landroid/content/Context;)Z

    move-result v7

    if-nez v7, :cond_3

    iget-object v7, p0, mAlwaysShowNavigationBar:Lcom/android/settings/ui/RadioButtonPreference;

    invoke-virtual {v7, v6}, Lcom/android/settings/ui/RadioButtonPreference;->setChecked(Z)V

    iget-object v7, p0, mCustomization:Landroidx/preference/Preference;

    invoke-virtual {v7, v6}, Landroidx/preference/Preference;->setVisible(Z)V

    iget-object v6, p0, mGestureHiddenBar:Landroidx/preference/SwitchPreference;

    invoke-virtual {v6, v5}, Landroidx/preference/SwitchPreference;->setVisible(Z)V

    iget-object v6, p0, mbuttonLayoutPref:Lcom/android/settingslib/widget/LayoutPreference;
    ...
    invoke-static {v7}, isSideEnabled(Landroid/content/Context;)Z

    move-result v7

    if-eqz v7, :cond_4

    iget-object v7, p0, mGestureNavigationBar:Lcom/android/settings/ui/RadioButtonPreference;
    ...
    iget-object v5, p0, mGestureHiddenBar:Landroidx/preference/SwitchPreference;
    ...
    invoke-static {v7}, isHideBarEnabled(Landroid/content/Context;)Z

    move-result v7

    invoke-virtual {v5, v7}, Landroidx/preference/SwitchPreference;->setChecked(Z)V

    iget-object v5, p0, mbuttonLayoutPref:Lcom/android/settingslib/widget/LayoutPreference;
    ...
    iget-object v7, p0, mGestureNavigationBarDeprecated:Lcom/android/settings/ui/RadioButtonPreference;

    invoke-virtual {v7, v6}, Lcom/android/settings/ui/RadioButtonPreference;->setChecked(Z)V

    iget-object v6, p0, mCustomSettingsCategory:Landroidx/preference/PreferenceCategory;
    ...
    invoke-static {v5}, isGesturalEnabled(Landroid/content/Context;)Z
    ...
    invoke-static {v5}, is2ButtonEnabled(Landroid/content/Context;)Z

    move-result v5

    if-nez v5, :cond_6

    iput-object v0, p0, mEnterStatus:Ljava/lang/String;
    ...
    invoke-static {v0}, isGesturalEnabled(Landroid/content/Context;)Z
    ...
    iput-object v1, p0, mEnterStatus:Ljava/lang/String;
    ...
    iput-object v3, p0, mEnterStatus:Ljava/lang/String;

    goto :goto_2

    :cond_8
    iput-object v2, p0, mEnterStatus:Ljava/lang/String;
...
.method public onDestroy()V
    ...
    iget-object v0, p0, mOPPhoneControlWayCategory:Lcom/oneplus/settings/ui/OPPhoneControlWayCategory;
...
.method public onRadioButtonClicked(Lcom/android/settings/ui/RadioButtonPreference;)V
    ...
    invoke-static {v0}, is3ButtonEnabled(Landroid/content/Context;)Z
    ...
    iget-object v0, p0, mCustomSettingsCategory:Landroidx/preference/PreferenceCategory;

    invoke-virtual {v0, v1}, Landroidx/preference/PreferenceCategory;->setVisible(Z)V

    iget-object v0, p0, mCustomization:Landroidx/preference/Preference;
    ...
    iget-object v0, p0, mbuttonLayoutPref:Lcom/android/settingslib/widget/LayoutPreference;
    ...
    iget-object v0, p0, mOverlayManager:Landroid/content/om/IOverlayManager;

    const-string v1, "com.android.internal.systemui.navbar.threebutton"

    invoke-static {v0, v1}, setNavBarInteractionMode(Landroid/content/om/IOverlayManager;Ljava/lang/String;)V
    ...
    invoke-static {v6}, isHideBarEnabled(Landroid/content/Context;)Z
    ...
    invoke-static {v0, v1}, setSideEnable(Landroid/content/Context;Z)V
    ...
    invoke-static {v0, v5}, setNavBarInteractionMode(Landroid/content/om/IOverlayManager;Ljava/lang/String;)V
    ...
    invoke-static {v0, v2}, setSideEnable(Landroid/content/Context;Z)V
...
.method public onStop()V
    ...
    iget-object v1, p0, mEnterStatus:Ljava/lang/String;
    ...
    invoke-static {v1}, is3ButtonEnabled(Landroid/content/Context;)Z
    ...
    invoke-static {v3, v5, v1}, Lcom/oneplus/settings/utils/OPUtils;->sendAnalytics(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v1, "full_screen_capsule"
    ...
    const-string v1, "capsule_full_screen"
