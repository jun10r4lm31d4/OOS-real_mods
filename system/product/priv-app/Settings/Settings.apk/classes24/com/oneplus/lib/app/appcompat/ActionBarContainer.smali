...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v2, p0, mSplitBackground:Landroid/graphics/drawable/Drawable;
...
.method public onLayout(ZIIII)V
    ...
    iget-boolean v4, p0, mIsSplit:Z

    if-eqz v4, :cond_2

    iget-object v4, p0, mSplitBackground:Landroid/graphics/drawable/Drawable;
    ...
    :cond_3
    iget-object v4, p0, mContextView:Landroid/view/View;
    ...
    iget-object v5, p0, mContextView:Landroid/view/View;

    invoke-virtual {v5}, Landroid/view/View;->getTop()I

    move-result v5

    iget-object v6, p0, mContextView:Landroid/view/View;

    invoke-virtual {v6}, Landroid/view/View;->getRight()I

    move-result v6

    iget-object v7, p0, mContextView:Landroid/view/View;
    ...
    :cond_5
    iput-boolean v3, p0, mIsStacked:Z
...
.method public onMeasure(II)V
    ...
    iget-object v2, p0, mTabContainer:Landroid/view/View;
    ...
    invoke-direct {p0, v2}, isCollapsed(Landroid/view/View;)Z
    ...
    invoke-direct {p0, v2}, getMeasuredHeightWithMargins(Landroid/view/View;)I
    ...
    invoke-direct {p0, v4}, getMeasuredHeightWithMargins(Landroid/view/View;)I
...
.method public setSplitBackground(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-boolean v1, p0, mIsSplit:Z

    if-eqz v1, :cond_1

    iget-object v1, p0, mSplitBackground:Landroid/graphics/drawable/Drawable;
