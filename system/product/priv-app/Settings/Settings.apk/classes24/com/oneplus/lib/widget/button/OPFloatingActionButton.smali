...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput v0, p0, mUserSetVisibility:I

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, mShadowPadding:Landroid/graphics/Rect;
    ...
    iput-object v2, p0, mBackgroundTint:Landroid/content/res/ColorStateList;
    ...
    invoke-static {v2, v3}, parseTintMode(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v2

    iput-object v2, p0, mBackgroundTintMode:Landroid/graphics/PorterDuff$Mode;
    ...
    iput-object v2, p0, mImpl:Lcom/oneplus/lib/widget/button/OPFloatingActionButtonImpl;
    ...
    invoke-virtual {p0}, getSizeDimension()I
    ...
    iput v2, p0, mContentPadding:I

    iget-object v2, p0, mImpl:Lcom/oneplus/lib/widget/button/OPFloatingActionButtonImpl;

    iget-object v4, p0, mBackgroundTint:Landroid/content/res/ColorStateList;

    iget-object v5, p0, mBackgroundTintMode:Landroid/graphics/PorterDuff$Mode;

    iget v6, p0, mRippleColor:I

    iget v7, p0, mBorderWidth:I
...
.method static synthetic access$000(Lcom/oneplus/lib/widget/button/OPFloatingActionButton;)Landroid/graphics/Rect;
    ...
    iget-object v0, p0, mShadowPadding:Landroid/graphics/Rect;
...
.method protected drawableStateChanged()V
    ...
    iget-object v0, p0, mImpl:Lcom/oneplus/lib/widget/button/OPFloatingActionButtonImpl;
...
.method public getBackgroundTintList()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, p0, mBackgroundTint:Landroid/content/res/ColorStateList;
...
.method public getBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v0, p0, mBackgroundTintMode:Landroid/graphics/PorterDuff$Mode;
...
.method final getUserSetVisibility()I
    ...
    iget v0, p0, mUserSetVisibility:I
...
.method final internalSetVisibility(IZ)V
    ...
    iput p1, p0, mUserSetVisibility:I
...
.method protected onMeasure(II)V
    ...
    invoke-static {v0, p1}, resolveAdjustedSize(II)I

    move-result v1

    invoke-static {v0, p2}, resolveAdjustedSize(II)I
    ...
    iget-object v4, p0, mShadowPadding:Landroid/graphics/Rect;

    iget v4, v4, Landroid/graphics/Rect;->left:I

    add-int/2addr v4, v3

    iget-object v5, p0, mShadowPadding:Landroid/graphics/Rect;
    ...
    iget-object v6, p0, mShadowPadding:Landroid/graphics/Rect;
...
.method public setBackground(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v2, p0, mBackgroundTint:Landroid/content/res/ColorStateList;

    iget-object v3, p0, mBackgroundTintMode:Landroid/graphics/PorterDuff$Mode;

    iget v4, p0, mRippleColor:I

    iget v5, p0, mBorderWidth:I
...
.method public setBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    iput-object p1, p0, mBackgroundTint:Landroid/content/res/ColorStateList;
...
.method public setBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iput-object p1, p0, mBackgroundTintMode:Landroid/graphics/PorterDuff$Mode;
...
.method public setVisibility(I)V
    ...
    invoke-virtual {p0, p1, v0}, internalSetVisibility(IZ)V
