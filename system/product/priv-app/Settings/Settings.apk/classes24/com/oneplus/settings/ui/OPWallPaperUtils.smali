...
.method static constructor <clinit>()V
    ...
    sput-object v0, ONEPLUS_BLUR_WALLPAPER:Landroid/content/ComponentName;
    ...
    sput-object v0, LEGACY_ONEPLUS_BLUR_WALLPAPER:Landroid/content/ComponentName;
    ...
    sput-object v0, ONEPLUS_H2_BLUR_WALLPAPER:Landroid/content/ComponentName;
    ...
    sput-object v0, ONEPLUS_LIVE_WALLPAPER:Landroid/content/ComponentName;
    ...
    sget-object v1, ONEPLUS_LIVE_WALLPAPER:Landroid/content/ComponentName;
    ...
    sput-object v0, ONEPLUS_LIVE_WALLPAPER_URI:Landroid/net/Uri;
    ...
    sput-object v0, DUMMY_WALLPAPER:Landroid/content/ComponentName;

    sget-object v0, Landroid/graphics/Bitmap$CompressFormat;->JPEG:Landroid/graphics/Bitmap$CompressFormat;

    sput-object v0, DEFAULT_COMPRESS_FORMAT:Landroid/graphics/Bitmap$CompressFormat;

    const/4 v0, -0x1

    sput v0, sMinValidLiveWallpaperPreviewWidthPx:I

    sput v0, sMinValidLiveWallpaperPreviewHeightPx:I
    ...
    :goto_0
    sput-boolean v0, ATLEAST_OREO_MR1:Z
...
.method public static checkPeekWallpaperPermission(Landroid/content/Context;)Z
    ...
    sget-boolean v0, ATLEAST_OREO_MR1:Z
    ...
    invoke-static {p0, v1}, hasGrantedPermission(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static getOnePlusLiveWallpaperBitmap(Landroid/content/Context;)Landroid/graphics/Bitmap;
    ...
    sget-object v3, ONEPLUS_LIVE_WALLPAPER_URI:Landroid/net/Uri;
    ...
    :try_start_1
    invoke-static {p0, v2}, getBitmapResizeWidthHeight(Landroid/content/Context;Ljava/io/InputStream;)Landroid/graphics/Bitmap;
...
.method public static hasGrantedPermission(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {p0, v0}, hasGrantedPermissions(Landroid/content/Context;[Ljava/lang/String;)Z
...
.method public static isDefaultImageWallpaper(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, checkPeekWallpaperPermission(Landroid/content/Context;)Z
...
.method public static isLegacyOnePlusBlurWallpaper(Landroid/content/Context;)Z
    ...
    sget-object v2, LEGACY_ONEPLUS_BLUR_WALLPAPER:Landroid/content/ComponentName;
...
.method public static isNormalLiveWallpaper(Landroid/app/WallpaperInfo;)Z
    ...
    sget-object v1, LEGACY_ONEPLUS_BLUR_WALLPAPER:Landroid/content/ComponentName;
    ...
    sget-object v1, ONEPLUS_BLUR_WALLPAPER:Landroid/content/ComponentName;
    ...
    sget-object v1, ONEPLUS_H2_BLUR_WALLPAPER:Landroid/content/ComponentName;
...
.method public static isNormalLiveWallpaper(Landroid/content/Context;)Z
    ...
    invoke-static {v0}, isNormalLiveWallpaper(Landroid/app/WallpaperInfo;)Z
...
.method public static isOnePlusBlurWallpaper(Landroid/content/Context;)Z
    ...
    sget-object v3, ONEPLUS_BLUR_WALLPAPER:Landroid/content/ComponentName;
    ...
    sget-object v3, LEGACY_ONEPLUS_BLUR_WALLPAPER:Landroid/content/ComponentName;
...
.method public static isOnePlusH2BlurWallpaper(Landroid/content/Context;)Z
    ...
    sget-object v3, ONEPLUS_H2_BLUR_WALLPAPER:Landroid/content/ComponentName;
...
.method public static isOnePlusLiveWallpaper(Landroid/content/Context;)Z
    ...
    sget-object v2, ONEPLUS_LIVE_WALLPAPER:Landroid/content/ComponentName;
...
.method public static loadHomeWallpaper(Landroid/content/Context;Landroid/app/WallpaperInfo;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0}, isOnePlusLiveWallpaper(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, getOnePlusLiveWallpaperBitmap(Landroid/content/Context;)Landroid/graphics/Bitmap;
    ...
    :cond_0
    invoke-static {p0}, isImageWallpaper(Landroid/content/Context;)Z
    ...
    :cond_1
    invoke-static {p0}, isNormalLiveWallpaper(Landroid/content/Context;)Z
    ...
    invoke-static {p0, v2}, loadThumbnailFromWallpaperIcon(Landroid/content/Context;Landroid/graphics/drawable/Drawable;)Landroid/graphics/Bitmap;
    ...
    :cond_2
    invoke-static {p0}, isOnePlusBlurWallpaper(Landroid/content/Context;)Z

    move-result v2

    if-eqz v2, :cond_4

    invoke-static {p0}, getOnePlusBlurWallpaperFile(Landroid/content/Context;)Ljava/io/File;
    ...
    invoke-static {v7, v5, v6}, calculateSampleSize(Landroid/graphics/BitmapFactory$Options;II)I
