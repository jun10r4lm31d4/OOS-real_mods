...
.method static constructor <clinit>()V
    ...
    sput-object v0, KEY_AOD_CLOCK_STYLE:Ljava/lang/String;

    const/4 v0, 0x0

    sput v0, CLOCK_TYPE_DEFAULT:I

    const/4 v0, 0x6

    sput v0, CLOCK_TYPE_ANALOG:I

    const/16 v0, 0x9

    sput v0, CLOCK_TYPE_MINIMALISM:I

    const/4 v0, 0x3

    sput v0, CLOCK_TYPE_NONE:I
...
.method static synthetic access$000(Landroid/content/Context;Z)V
    ...
    invoke-static {p0, p1}, enableAospDarkTheme(Landroid/content/Context;Z)V
...
.method public static disableAllColorfulThemes(Landroid/content/Context;)V
    ...
    invoke-static {p0, v2}, setCurrentBasicColorMode(Landroid/content/Context;I)V
    ...
    invoke-static {p0, v2}, setCurrentFont(Landroid/content/Context;I)V
    ...
    invoke-static {p0, v3}, setCurrentShape(Landroid/content/Context;I)V
    ...
    invoke-static {p0, v2}, setCurrentHorizonLight(Landroid/content/Context;I)V
...
.method public static disableAllDarkThemes(Landroid/content/Context;)V
    ...
    invoke-static {p0, v2}, setCurrentShape(Landroid/content/Context;I)V
...
.method public static disableAllLightThemes(Landroid/content/Context;)V
    ...
    invoke-static {p0, v3}, setCurrentFont(Landroid/content/Context;I)V
...
.method public static disableCurrentTheme(Landroid/content/Context;)V
    ...
    invoke-static {p0}, getCurrentCustomizationTheme(Landroid/content/Context;)I
    ...
    :cond_0
    invoke-static {p0}, disableAllColorfulThemes(Landroid/content/Context;)V

    goto :goto_0

    :cond_1
    invoke-static {p0}, disableAllDarkThemes(Landroid/content/Context;)V

    goto :goto_0

    :cond_2
    invoke-static {p0}, disableAllLightThemes(Landroid/content/Context;)V
...
.method public static enableColorfulThemes(Landroid/content/Context;)V
    ...
    invoke-static {p0}, disableAllThemes(Landroid/content/Context;)V

    const-string v0, "wallpaper_g_live_gold"

    invoke-static {p0, v0}, setDefaultWallpaper(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {p0, v1}, setCurrentBasicColorMode(Landroid/content/Context;I)V

    const/4 v2, 0x0

    invoke-static {p0, v2}, enableAospDarkTheme(Landroid/content/Context;Z)V
    ...
    invoke-static {p0, v5}, setCurrentShape(Landroid/content/Context;I)V
    ...
    invoke-static {p0, v1}, setCurrentHorizonLight(Landroid/content/Context;I)V
    ...
    const-string v7, "oneplus_accentcolor"
    ...
    sget-object v2, KEY_AOD_CLOCK_STYLE:Ljava/lang/String;

    sget v7, CLOCK_TYPE_MINIMALISM:I
...
.method public static enableDarkThemes(Landroid/content/Context;)V
    ...
    invoke-static {p0, v3}, setCurrentHorizonLight(Landroid/content/Context;I)V
    ...
    invoke-static {p0, v2, v5, v6}, enableAospDarkThemeDelay(Landroid/content/Context;ZJ)V
    ...
    sget-object v3, KEY_AOD_CLOCK_STYLE:Ljava/lang/String;

    sget v6, CLOCK_TYPE_ANALOG:I
...
.method public static enableMclThemes(Landroid/content/Context;)V
    ...
    invoke-static {p0, v1}, setDefaultWallpaper(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {p0, v3}, setCurrentBasicColorMode(Landroid/content/Context;I)V

    invoke-static {p0, v3}, enableAospDarkTheme(Landroid/content/Context;Z)V
    ...
    invoke-static {}, isSupportMclTheme()Z
...
.method public static isSupportCustomeTheme()Z
    ...
    invoke-static {}, isSupportAVGTheme()Z

    move-result v0

    if-nez v0, :cond_1

    invoke-static {}, isSupportSwTheme()Z
