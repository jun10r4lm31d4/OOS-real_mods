...
.method public constructor <init>(Landroid/app/Activity;Landroidx/fragment/app/Fragment;Lcom/oneplus/settings/aboutphone/Contract$View;)V
    ...
    iput-object p3, p0, mView:Lcom/oneplus/settings/aboutphone/Contract$View;

    iput-object p2, p0, mFragment:Landroidx/fragment/app/Fragment;
    ...
    iput-object v0, p0, mDebuggingFeaturesDisallowedAdmin:Lcom/android/settingslib/RestrictedLockUtils$EnforcedAdmin;
    ...
    iput-boolean v0, p0, mDebuggingFeaturesDisallowedBySystem:Z
...
.method private showHardwareInfo()V
    ...
    invoke-static {}, is7TMCLVersionProject()Z
    ...
    :cond_6
    invoke-static {}, isGuaLiftCameraProject()Z
    ...
    :goto_1
    iget-object v1, p0, mView:Lcom/oneplus/settings/aboutphone/Contract$View;

    invoke-direct {p0}, getCameraInfo()Ljava/lang/String;

    move-result-object v3

    invoke-direct {p0}, getCpuName()Ljava/lang/String;

    move-result-object v4

    invoke-direct {p0}, getScreenInfo()Ljava/lang/String;

    move-result-object v5

    invoke-static {}, getTotalMemory()Ljava/lang/String;
...
.method private showSoftwareInfo()V
    ...
    invoke-direct {p0}, addAuthenticationInfo()V

    :cond_0
    invoke-direct {p0}, addAndroidVersion()V
    ...
    invoke-direct {p0}, addOneplusSystemVersion()V
    ...
    invoke-direct {p0}, addVersionNumber()V

    :cond_2
    invoke-direct {p0}, addDeviceModel()V

    invoke-direct {p0}, addLegalInfo()V

    invoke-direct {p0}, addStatusInfo()V
    ...
    :cond_3
    invoke-direct {p0}, addProductIntroduce()V

    invoke-direct {p0}, addAwardInfo()V
    ...
    invoke-direct {p0}, addSoftwareVersion()V

    invoke-direct {p0}, addHardwareVersion()V
...
.method public enableDevelopmentSettings()V
    ...
    iput-boolean v0, p0, mProcessingLastDevHit:Z
...
.method public onItemClick(I)V
    ...
    :cond_5
    iget-object v2, p0, mDebuggingFeaturesDisallowedAdmin:Lcom/android/settingslib/RestrictedLockUtils$EnforcedAdmin;

    if-eqz v2, :cond_6

    iget-boolean v4, p0, mDebuggingFeaturesDisallowedBySystem:Z
    ...
    iput v2, p0, mDevHitCountdown:I

    iget v2, p0, mDevHitCountdown:I

    if-nez v2, :cond_7

    iget-boolean v5, p0, mProcessingLastDevHit:Z
    ...
    iget-object v4, p0, mFragment:Landroidx/fragment/app/Fragment;
    ...
    iput-boolean v3, p0, mProcessingLastDevHit:Z

    iget-boolean v3, p0, mProcessingLastDevHit:Z

    if-nez v3, :cond_8

    invoke-virtual {p0}, enableDevelopmentSettings()V
    ...
    :cond_a
    iget-object v2, p0, mFragment:Landroidx/fragment/app/Fragment;
...
.method public onResume()V
    ...
    invoke-direct {p0}, showHardwareInfo()V

    invoke-direct {p0}, showSoftwareInfo()V
