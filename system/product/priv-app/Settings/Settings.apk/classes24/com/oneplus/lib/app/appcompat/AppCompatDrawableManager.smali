...
.method static constructor <clinit>()V
    ...
    sput-object v0, COLOR_FILTER_CACHE:Lcom/oneplus/lib/app/appcompat/AppCompatDrawableManager$ColorFilterLruCache;
...
.method private addDelegate(Ljava/lang/String;Lcom/oneplus/lib/app/appcompat/AppCompatDrawableManager$InflateDelegate;)V
    ...
    iget-object v0, p0, mDelegates:Lcom/oneplus/support/collection/ArrayMap;
    ...
    iput-object v0, p0, mDelegates:Lcom/oneplus/support/collection/ArrayMap;
...
.method private addDrawableToCache(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    iget-object v1, p0, mDrawableCacheLock:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, mDrawableCaches:Ljava/util/WeakHashMap;
    ...
    iget-object v3, p0, mDrawableCaches:Ljava/util/WeakHashMap;
...
.method private addTintListToCache(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    ...
    iget-object v1, p0, mTintLists:Ljava/util/WeakHashMap;
...
.method private createBorderlessButtonColorStateList(Landroid/content/Context;Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
    ...
    invoke-direct {p0, p1, v0, v1}, createButtonColorStateList(Landroid/content/Context;ILandroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
...
.method private createColoredButtonColorStateList(Landroid/content/Context;Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
    ...
    invoke-direct {p0, p1, v0, p2}, createButtonColorStateList(Landroid/content/Context;ILandroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
...
.method private createDrawableIfNeeded(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, v8}, getDrawable(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, v7}, getDrawable(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method private static createTintFilter(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;[I)Landroid/graphics/PorterDuffColorFilter;
    ...
    invoke-static {v0, p1}, getPorterDuffColorFilter(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method public static get()Lcom/oneplus/lib/app/appcompat/AppCompatDrawableManager;
    ...
    sget-object v0, INSTANCE:Lcom/oneplus/lib/app/appcompat/AppCompatDrawableManager;
    ...
    sput-object v0, INSTANCE:Lcom/oneplus/lib/app/appcompat/AppCompatDrawableManager;

    sget-object v0, INSTANCE:Lcom/oneplus/lib/app/appcompat/AppCompatDrawableManager;

    invoke-static {v0}, installDefaultInflateDelegates(Lcom/oneplus/lib/app/appcompat/AppCompatDrawableManager;)V
...
.method public static getPorterDuffColorFilter(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    sget-object v0, COLOR_FILTER_CACHE:Lcom/oneplus/lib/app/appcompat/AppCompatDrawableManager$ColorFilterLruCache;
    ...
    sget-object v1, COLOR_FILTER_CACHE:Lcom/oneplus/lib/app/appcompat/AppCompatDrawableManager$ColorFilterLruCache;
...
.method private static installDefaultInflateDelegates(Lcom/oneplus/lib/app/appcompat/AppCompatDrawableManager;)V
    ...
    invoke-direct {p0, v2, v1}, addDelegate(Ljava/lang/String;Lcom/oneplus/lib/app/appcompat/AppCompatDrawableManager$InflateDelegate;)V
...
.method private loadDrawableFromDelegates(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, mKnownDrawableIdTags:Landroid/util/SparseArray;
    ...
    iget-object v3, p0, mDelegates:Lcom/oneplus/support/collection/ArrayMap;
    ...
    iput-object v0, p0, mKnownDrawableIdTags:Landroid/util/SparseArray;
    ...
    iget-object v9, p0, mKnownDrawableIdTags:Landroid/util/SparseArray;

    invoke-virtual {v9, p2, v3}, Landroid/util/SparseArray;->append(ILjava/lang/Object;)V

    iget-object v9, p0, mDelegates:Lcom/oneplus/support/collection/ArrayMap;
    ...
    iget-object v3, p0, mKnownDrawableIdTags:Landroid/util/SparseArray;
...
.method private static setPorterDuffColorFilter(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    :goto_0
    invoke-static {p1, v0}, getPorterDuffColorFilter(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method private tintDrawable(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    sget-object v6, DEFAULT_MODE:Landroid/graphics/PorterDuff$Mode;

    invoke-static {v4, v5, v6}, setPorterDuffColorFilter(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    sget-object v5, DEFAULT_MODE:Landroid/graphics/PorterDuff$Mode;

    invoke-static {v3, v4, v5}, setPorterDuffColorFilter(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    sget-object v4, DEFAULT_MODE:Landroid/graphics/PorterDuff$Mode;

    invoke-static {v2, v3, v4}, setPorterDuffColorFilter(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
...
.method static tintDrawable(Landroid/graphics/drawable/Drawable;Lcom/oneplus/lib/app/appcompat/TintInfo;[I)V
    ...
    :goto_2
    invoke-static {v0, v1, p2}, createTintFilter(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;[I)Landroid/graphics/PorterDuffColorFilter;
...
.method static tintDrawableUsingColorFilter(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    sget-object v4, COLORFILTER_TINT_COLOR_CONTROL_NORMAL:[I

    invoke-static {v4, p1}, arrayContains([II)Z
    ...
    :cond_0
    sget-object v4, COLORFILTER_COLOR_CONTROL_ACTIVATED:[I
    ...
    :cond_1
    sget-object v4, COLORFILTER_COLOR_BACKGROUND_MULTIPLY:[I
    ...
    invoke-static {v4, v0}, getPorterDuffColorFilter(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method getTintList(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p0, p1, p2, v0}, getTintList(Landroid/content/Context;ILandroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
...
.method getTintList(Landroid/content/Context;ILandroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
    ...
    invoke-direct {p0, p1, p3}, createDefaultButtonColorStateList(Landroid/content/Context;Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
    ...
    invoke-direct {p0, p1, p3}, createBorderlessButtonColorStateList(Landroid/content/Context;Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
    ...
    invoke-direct {p0, p1, p3}, createColoredButtonColorStateList(Landroid/content/Context;Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
    ...
    :cond_8
    sget-object v2, TINT_COLOR_CONTROL_NORMAL:[I

    invoke-static {v2, p2}, arrayContains([II)Z
    ...
    :cond_9
    sget-object v2, TINT_COLOR_CONTROL_STATE_LIST:[I
    ...
    :cond_a
    sget-object v2, TINT_CHECKABLE_BUTTON_LIST:[I
    ...
    invoke-direct {p0, p1, p2, v1}, addTintListToCache(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
...
.method onDrawableLoadedFromResources(Landroid/content/Context;Lcom/oneplus/lib/app/appcompat/VectorEnabledTintResources;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1, p3, v1, v0}, tintDrawable(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
