...
.method static constructor <clinit>()V
    ...
    sput-object v0, APP_NOTIFICATION_PREFS_CATEGORY_INTENT:Landroid/content/Intent;

    const-wide/16 v0, 0x12c

    sput-wide v0, WILL_SHOW_PROGRESS_TIME:J

    const-wide/16 v0, 0x1f4

    sput-wide v0, PROGRESS_MIN_SHOW_TIME:J
    ...
    sput-object v0, mRowComparator:Ljava/util/Comparator;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mBackend:Lcom/oneplus/settings/notification/OPNotificationAppList$Backend;

    new-instance v0, Lcom/android/settings/notification/NotificationBackend;

    invoke-direct {v0}, Lcom/android/settings/notification/NotificationBackend;-><init>()V

    iput-object v0, p0, mNotificationBackend:Lcom/android/settings/notification/NotificationBackend;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, mRows:Landroid/util/ArrayMap;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mSortedRows:Ljava/util/ArrayList;
    ...
    iput-boolean v0, p0, mShowAllowLEDApps:Z

    iput-boolean v0, p0, mShowNotAllowLEDApps:Z
    ...
    iput-object v0, p0, mRefreshAppsListRunnable:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mCollectAppsRunnable:Ljava/lang/Runnable;
...
.method static synthetic access$002(Lcom/oneplus/settings/notification/OPNotificationAppList;Z)Z
    ...
    iput-boolean p1, p0, mHasShowProgress:Z
...
.method static synthetic access$100(Lcom/oneplus/settings/notification/OPNotificationAppList;)Landroid/view/View;
    ...
    iget-object v0, p0, emptyView:Landroid/view/View;
...
.method static synthetic access$1000(Lcom/oneplus/settings/notification/OPNotificationAppList;)Landroid/content/pm/LauncherApps;
    ...
    iget-object v0, p0, mLauncherApps:Landroid/content/pm/LauncherApps;
...
.method static synthetic access$1200(Lcom/oneplus/settings/notification/OPNotificationAppList;)Lcom/oneplus/settings/notification/OPNotificationAppList$Backend;
    ...
    iget-object v0, p0, mBackend:Lcom/oneplus/settings/notification/OPNotificationAppList$Backend;
...
.method static synthetic access$1300()Ljava/util/Comparator;
    ...
    sget-object v0, mRowComparator:Ljava/util/Comparator;
...
.method static synthetic access$202(Lcom/oneplus/settings/notification/OPNotificationAppList;J)J
    ...
    iput-wide p1, p0, mShowPromptTime:J
...
.method static synthetic access$300(Lcom/oneplus/settings/notification/OPNotificationAppList;)V
    ...
    invoke-direct {p0}, loadAppsList()V
...
.method static synthetic access$400(Lcom/oneplus/settings/notification/OPNotificationAppList;)Ljava/util/ArrayList;
    ...
    iget-object v0, p0, mSortedRows:Ljava/util/ArrayList;
...
.method static synthetic access$500(Lcom/oneplus/settings/notification/OPNotificationAppList;Ljava/util/ArrayList;)V
    ...
    invoke-direct {p0, p1}, refreshDisplayedItems(Ljava/util/ArrayList;)V
...
.method static synthetic access$600(Lcom/oneplus/settings/notification/OPNotificationAppList;)Lcom/android/settings/notification/NotificationBackend;
    ...
    iget-object v0, p0, mNotificationBackend:Lcom/android/settings/notification/NotificationBackend;
...
.method static synthetic access$700(Lcom/oneplus/settings/notification/OPNotificationAppList;)Ljava/lang/Runnable;
    ...
    iget-object v0, p0, mRefreshAppsListRunnable:Ljava/lang/Runnable;
...
.method static synthetic access$900(Lcom/oneplus/settings/notification/OPNotificationAppList;)Landroid/util/ArrayMap;
    ...
    iget-object v0, p0, mRows:Landroid/util/ArrayMap;
...
.method public static applyConfigActivities(Landroid/content/pm/PackageManager;Landroid/util/ArrayMap;Ljava/util/List;)V
    ...
    sget-object v7, APP_NOTIFICATION_PREFS_CATEGORY_INTENT:Landroid/content/Intent;
...
.method public static collectConfigActivities(Landroid/content/pm/PackageManager;Landroid/util/ArrayMap;)V
    ...
    invoke-static {p0}, queryNotificationConfigActivities(Landroid/content/pm/PackageManager;)Ljava/util/List;

    move-result-object v0

    invoke-static {p0, p1, v0}, applyConfigActivities(Landroid/content/pm/PackageManager;Landroid/util/ArrayMap;Ljava/util/List;)V
...
.method private loadAppsList()V
    ...
    iget-object v0, p0, mCollectAppsRunnable:Ljava/lang/Runnable;
...
.method public static queryNotificationConfigActivities(Landroid/content/pm/PackageManager;)Ljava/util/List;
    ...
    sget-object v1, APP_NOTIFICATION_PREFS_CATEGORY_INTENT:Landroid/content/Intent;
    ...
    sget-object v0, APP_NOTIFICATION_PREFS_CATEGORY_INTENT:Landroid/content/Intent;
...
.method private refreshDisplayedItems(Ljava/util/ArrayList;)V
    ...
    iput-boolean v5, p0, mShowNotAllowLEDApps:Z

    iget-object v4, p0, mNotAllowLEDApps:Landroidx/preference/PreferenceCategory;
    ...
    :cond_1
    iput-boolean v5, p0, mShowAllowLEDApps:Z

    iget-object v4, p0, mAllowLEDApps:Landroidx/preference/PreferenceCategory;
    ...
    :cond_3
    invoke-direct {p0}, removeCatagoryIfNoneApp()V
    ...
    iget-object v1, p0, mSortedRows:Ljava/util/ArrayList;
...
.method private removeCatagoryIfNoneApp()V
    ...
    iget-boolean v0, p0, mShowNotAllowLEDApps:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, mRoot:Landroidx/preference/PreferenceScreen;

    iget-object v1, p0, mNotAllowLEDApps:Landroidx/preference/PreferenceCategory;
    ...
    :goto_0
    iget-boolean v0, p0, mShowAllowLEDApps:Z

    if-eqz v0, :cond_1

    iget-object v0, p0, mRoot:Landroidx/preference/PreferenceScreen;

    iget-object v1, p0, mAllowLEDApps:Landroidx/preference/PreferenceCategory;
...
.method private resetUI()V
    ...
    iget-object v0, p0, mAllowLEDApps:Landroidx/preference/PreferenceCategory;

    invoke-virtual {v0}, Landroidx/preference/PreferenceCategory;->removeAll()V

    iget-object v0, p0, mNotAllowLEDApps:Landroidx/preference/PreferenceCategory;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, mLauncherApps:Landroid/content/pm/LauncherApps;

    invoke-virtual {p0}, getPreferenceScreen()Landroidx/preference/PreferenceScreen;

    move-result-object v0

    iput-object v0, p0, mRoot:Landroidx/preference/PreferenceScreen;
    ...
    iput-object v0, p0, mAllowLEDApps:Landroidx/preference/PreferenceCategory;
    ...
    iput-object v0, p0, mNotAllowLEDApps:Landroidx/preference/PreferenceCategory;
...
.method protected final onPostExecute()V
    ...
    iget-wide v4, p0, mShowPromptTime:J

    sub-long/2addr v2, v4

    sget-wide v4, PROGRESS_MIN_SHOW_TIME:J
...
.method protected final onPreExecute()V
    ...
    sget-wide v2, WILL_SHOW_PROGRESS_TIME:J
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, getListView()Landroidx/recyclerview/widget/RecyclerView;
    ...
    iput-object v1, p0, emptyView:Landroid/view/View;

    iget-object v1, p0, emptyView:Landroid/view/View;
    ...
    invoke-virtual {p0}, onPostExecute()V
