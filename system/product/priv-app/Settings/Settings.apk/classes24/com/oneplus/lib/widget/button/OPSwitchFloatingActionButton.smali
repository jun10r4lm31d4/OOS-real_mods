...
.method static constructor <clinit>()V
    ...
    sput-object v0, SWITCH_INTERPOLATOR:Landroid/view/animation/Interpolator;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-boolean v0, p0, mIsDisappear1:Z

    iput-boolean v0, p0, mIsSwitchState:Z
    ...
    invoke-virtual {p0, v5}, setBackground(Landroid/graphics/drawable/Drawable;)V

    invoke-virtual {p0, v1}, setElevation(F)V
    ...
    iput-object v7, p0, mNormalImageView:Landroid/widget/ImageView;
    ...
    iget-object v8, p0, mNormalImageView:Landroid/widget/ImageView;
    ...
    iput-object v8, p0, mSwitchImageView:Landroid/widget/ImageView;
...
.method private setPressedTranslationZ(F)V
    ...
    invoke-direct {p0, v3}, setupAnimator(Landroid/animation/Animator;)Landroid/animation/Animator;
    ...
    invoke-virtual {p0, v0}, setStateListAnimator(Landroid/animation/StateListAnimator;)V
...
.method public doFabAppearSwitch1(I)V
    ...
    iget-boolean v1, p0, mIsSwitchState:Z
    ...
    iget-boolean v2, p0, mIsDisappear1:Z
    ...
    invoke-virtual {p0}, isFabDisappear1()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p0}, isSwitchState()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0, p1}, setSwitchImageView(I)V

    goto :goto_0

    :cond_0
    invoke-virtual {p0, p1}, setImageResource(I)V

    :goto_0
    invoke-virtual {p0}, fabAppears1()V
    ...
    invoke-virtual {p0}, fabSwitchRevert()V
...
.method public fabAppears1()V
    ...
    invoke-virtual {p0, v0}, setPivotType(I)V

    invoke-virtual {p0}, animate()Landroid/view/ViewPropertyAnimator;
...
.method public fabSwitch()V
    ...
    iget-object v0, p0, mNormalImageView:Landroid/widget/ImageView;
    ...
    iget-object v0, p0, mSwitchImageView:Landroid/widget/ImageView;
    ...
    sget-object v1, SWITCH_INTERPOLATOR:Landroid/view/animation/Interpolator;
...
.method public fabSwitchRevert()V
    ...
    sget-object v3, SWITCH_INTERPOLATOR:Landroid/view/animation/Interpolator;
...
.method public fabSwitchScaleRevert()V
    ...
    sget-object v4, SWITCH_INTERPOLATOR:Landroid/view/animation/Interpolator;
...
.method public isFabDisappear1()Z
    ...
    iget-boolean v0, p0, mIsDisappear1:Z
...
.method public isSwitchState()Z
    ...
    iget-boolean v0, p0, mIsSwitchState:Z
...
.method public setPivotType(I)V
    ...
    invoke-virtual {p0, v0}, setPivotY(F)V
    ...
    invoke-virtual {p0, v0}, setPivotX(F)V
    ...
    invoke-virtual {p0, v1}, setPivotY(F)V
