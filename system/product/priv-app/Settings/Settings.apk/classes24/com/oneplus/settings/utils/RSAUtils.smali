...
.method static constructor <clinit>()V
    ...
    sput-object v0, DEFAULT_SPLIT:[B
    ...
    sput-object v0, PUBLIC_KEY_MAP:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0, v1}, Ljava/util/HashMap;-><init>(I)V

    sput-object v0, PRIVATE_KEY_MAP:Ljava/util/Map;
...
.method public static decryptByPrivateKeyForSpilt([B[B)[B
    ...
    sget-object v2, DEFAULT_SPLIT:[B

    array-length v2, v2

    if-gtz v2, :cond_0

    invoke-static/range {p0 .. p1}, decryptByPrivateKey([B[B)[B
    ...
    invoke-static {v9, v1}, decryptByPrivateKey([B[B)[B
    ...
    :cond_3
    sget-object v9, DEFAULT_SPLIT:[B
    ...
    sget-object v11, DEFAULT_SPLIT:[B
...
.method public static decryptByPublicKeyForSpilt([B[B)[B
    ...
    invoke-static/range {p0 .. p1}, decryptByPublicKey([B[B)[B
    ...
    invoke-static {v9, v1}, decryptByPublicKey([B[B)[B
...
.method public static encryptByPrivateKeyForSpilt([B[B)[B
    ...
    invoke-static {p0, p1}, encryptByPrivateKey([B[B)[B
    ...
    :cond_2
    invoke-static {v5, p1}, encryptByPrivateKey([B[B)[B
...
.method public static encryptByPublicKeyForSpilt([B[B)[B
    ...
    invoke-static {p0, p1}, encryptByPublicKey([B[B)[B
    ...
    :cond_2
    invoke-static {v5, p1}, encryptByPublicKey([B[B)[B
...
.method public static generateRSAKeyPair()Ljava/security/KeyPair;
    ...
    invoke-static {v0}, generateRSAKeyPair(I)Ljava/security/KeyPair;
...
.method public static getAlitaPrivateKey()Ljava/security/PrivateKey;
    ...
    sget-object v1, PRIVATE_KEY_MAP:Ljava/util/Map;
    ...
    invoke-static {v2}, loadPrivateKey(Ljava/io/InputStream;)Ljava/security/PrivateKey;
...
.method private static initPrivateKey()Ljava/security/PrivateKey;
    .locals 4
...
.method private static initPublicKey()Ljava/security/PublicKey;
    ...
    sget-object v0, PUBLIC_KEY_MAP:Ljava/util/Map;
    ...
    invoke-static {v1}, loadPublicKey(Ljava/io/InputStream;)Ljava/security/PublicKey;
...
.method public static loadPrivateKey(Ljava/io/InputStream;)Ljava/security/PrivateKey;
    ...
    :try_start_0
    invoke-static {p0}, readKey(Ljava/io/InputStream;)Ljava/lang/String;

    move-result-object v0

    invoke-static {v0}, loadPrivateKey(Ljava/lang/String;)Ljava/security/PrivateKey;
...
.method public static loadPrivateKey(Ljava/lang/String;)Ljava/security/PrivateKey;
    ...
    sget-object v4, PRIVATE_KEY_MAP:Ljava/util/Map;
...
.method public static loadPublicKey(Ljava/io/InputStream;)Ljava/security/PublicKey;
    ...
    invoke-static {v0}, loadPublicKey(Ljava/lang/String;)Ljava/security/PublicKey;
...
.method public static loadPublicKey(Ljava/lang/String;)Ljava/security/PublicKey;
    ...
    sget-object v4, PUBLIC_KEY_MAP:Ljava/util/Map;
...
.method public static rsaDecrypt(Ljava/lang/String;)Ljava/lang/String;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    invoke-static {}, initPrivateKey()Ljava/security/PrivateKey;
    ...
    invoke-static {v1, v2}, decryptByPrivateKeyForSpilt([B[B)[B
...
.method public static rsaDecrypt(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1}, loadPrivateKey(Ljava/lang/String;)Ljava/security/PrivateKey;
...
.method public static rsaEncrypt(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {}, initPublicKey()Ljava/security/PublicKey;
    ...
    invoke-static {v2, v3}, encryptByPublicKeyForSpilt([B[B)[B
...
.method public static rsaEncrypt(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1}, loadPublicKeyForStr(Ljava/lang/String;)Ljava/security/PublicKey;
