...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, ONEPLUS_DEBUG:Z
...
.method public static getHandler()Landroid/os/Handler;
    ...
    sget-object v0, handler:Landroid/os/Handler;
    ...
    :try_start_0
    sget-object v1, handler:Landroid/os/Handler;

    if-nez v1, :cond_2

    sget-object v1, handlerThread:Landroid/os/HandlerThread;
    ...
    sput-object v1, handlerThread:Landroid/os/HandlerThread;
    ...
    sget-object v2, handlerThread:Landroid/os/HandlerThread;
    ...
    sput-object v1, handler:Landroid/os/Handler;
...
.method public getDefaultTracker()Lcom/google/analytics/tracking/android/Tracker;
    ...
    :try_start_0
    iget-object v1, p0, mTracker:Lcom/google/analytics/tracking/android/Tracker;
    ...
    iput-object v2, p0, mTracker:Lcom/google/analytics/tracking/android/Tracker;
    ...
    iget-object v0, p0, mTracker:Lcom/google/analytics/tracking/android/Tracker;
...
.method public onCreate()V
    ...
    sput-object p0, mApplication:Landroid/app/Application;

    invoke-static {}, Lcom/oneplus/settings/utils/OPUtils;->isBetaRom()Z

    move-result v0

    iput-boolean v0, p0, mIsBeta:Z

    sget-object v0, mApplication:Landroid/app/Application;
