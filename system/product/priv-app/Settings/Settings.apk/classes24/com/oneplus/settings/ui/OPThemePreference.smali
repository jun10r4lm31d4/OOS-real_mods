...
.method private initAppIconView(Landroidx/preference/PreferenceViewHolder;)V
    ...
    iput-object v1, p0, mThemeIcon1:Landroid/widget/ImageView;
    ...
    iput-object v1, p0, mThemeIcon2:Landroid/widget/ImageView;
    ...
    iput-object v1, p0, mThemeIcon3:Landroid/widget/ImageView;
    ...
    iput-object v1, p0, mThemeIcon4:Landroid/widget/ImageView;

    const-string v1, "com.android.dialer"

    invoke-direct {p0, v1}, getAppIcon(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    if-eqz v1, :cond_0

    iget-object v2, p0, mThemeIcon1:Landroid/widget/ImageView;
    ...
    invoke-direct {p0, v2}, getAppIcon(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;

    move-result-object v2

    if-eqz v2, :cond_1

    iget-object v3, p0, mThemeIcon2:Landroid/widget/ImageView;
    ...
    invoke-direct {p0, v3}, getAppIcon(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;

    move-result-object v3

    if-eqz v3, :cond_2

    iget-object v4, p0, mThemeIcon3:Landroid/widget/ImageView;
    ...
    invoke-direct {p0, v4}, getAppIcon(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;

    move-result-object v4

    if-eqz v4, :cond_3

    iget-object v5, p0, mThemeIcon4:Landroid/widget/ImageView;
...
.method public onBindViewHolder(Landroidx/preference/PreferenceViewHolder;)V
    ...
    invoke-direct {p0}, getColorThmeImage()I
    ...
    :cond_0
    invoke-virtual {p0, p1}, initViewStatus(Landroidx/preference/PreferenceViewHolder;)V

    invoke-direct {p0, p1}, initAppIconView(Landroidx/preference/PreferenceViewHolder;)V
...
.method public refreshUI()V
    ...
    iget-object v0, p0, mThemeIcon1:Landroid/widget/ImageView;

    if-eqz v0, :cond_5

    iget-object v0, p0, mThemeIcon2:Landroid/widget/ImageView;

    if-eqz v0, :cond_5

    iget-object v0, p0, mThemeIcon3:Landroid/widget/ImageView;

    if-eqz v0, :cond_5

    iget-object v0, p0, mThemeIcon4:Landroid/widget/ImageView;
    ...
    invoke-direct {p0, v0}, getAppIcon(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    if-eqz v0, :cond_1

    iget-object v1, p0, mThemeIcon1:Landroid/widget/ImageView;
    ...
    iget-object v2, p0, mThemeIcon2:Landroid/widget/ImageView;
    ...
    iget-object v3, p0, mThemeIcon3:Landroid/widget/ImageView;
    ...
    iget-object v4, p0, mThemeIcon4:Landroid/widget/ImageView;
