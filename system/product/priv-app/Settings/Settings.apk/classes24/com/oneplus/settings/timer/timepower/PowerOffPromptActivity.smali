...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mLock:Landroid/os/PowerManager$WakeLock;

    const/4 v0, 0x0

    iput-boolean v0, p0, mIsCurrentLocked:Z
    ...
    iput-object v0, p0, mStateReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v0, p0, mMoveToFrontRunnable:Ljava/lang/Runnable;
...
.method static synthetic access$000(Lcom/oneplus/settings/timer/timepower/PowerOffPromptActivity;)V
    ...
    invoke-direct {p0}, beginShutdown()V
...
.method private beginShutdown()V
    ...
    iget-object v0, p0, mLock:Landroid/os/PowerManager$WakeLock;
...
.method private lightScreen()V
    ...
    iget-boolean v2, p0, mIsCurrentLocked:Z
...
.method public onBackPressed()V
    ...
    iget-object v1, p0, mMoveToFrontRunnable:Ljava/lang/Runnable;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-boolean v3, p0, mIsCurrentLocked:Z
    ...
    iput-boolean v2, p0, mIsCurrentLocked:Z

    :cond_1
    :goto_0
    iget-boolean v1, p0, mIsCurrentLocked:Z

    if-eqz v1, :cond_2

    invoke-direct {p0}, lightScreen()V
    ...
    iput-object v1, p0, pm:Landroid/os/PowerManager;

    iget-object v1, p0, pm:Landroid/os/PowerManager;
    ...
    iput-object v1, p0, mLock:Landroid/os/PowerManager$WakeLock;

    iget-object v1, p0, mLock:Landroid/os/PowerManager$WakeLock;
    ...
    iget-object v4, p0, mStateReceiver:Landroid/content/BroadcastReceiver;

    invoke-virtual {p0, v4, v1}, registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    iget-object v4, p0, mAlertParams:Lcom/android/internal/app/AlertController$AlertParams;
...
.method protected onDestroy()V
    ...
    iget-object v2, p0, mMoveToFrontRunnable:Ljava/lang/Runnable;
    ...
    :cond_0
    iget-object v1, p0, mStateReceiver:Landroid/content/BroadcastReceiver;
