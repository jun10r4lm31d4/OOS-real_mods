...
.method public constructor <init>()V
    ...
    iput-boolean v1, p0, mContactsRingtone:Z

    iput-boolean v0, p0, isFirst:Z

    iput v1, p0, mSimid:I

    iput-boolean v1, p0, mIsAlarmNeedVibrate:Z

    iput-boolean v1, p0, isPlaying:Z

    iput-boolean v1, p0, isSelectedNone:Z
    ...
    iput-object v0, p0, mAudioFocusChangeListener:Landroid/media/AudioManager$OnAudioFocusChangeListener;
    ...
    iput-object v0, p0, mLookupRingtoneNames:Ljava/lang/Runnable;
...
.method static synthetic access$100(Lcom/oneplus/settings/ringtone/OPRingtoneBaseActivity;)Z
    ...
    iget-boolean v0, p0, isPlaying:Z
...
.method private lookupRingtoneNames()V
    ...
    :cond_0
    iget-object v0, p0, mLookupRingtoneNames:Ljava/lang/Runnable;
...
.method private startPreview()V
    ...
    invoke-virtual {p0, v0}, startVibrate(Landroid/net/Uri;)V
...
.method private stopAnyPlayingRingtone2()V
    ...
    iget-object v2, p0, mDefaultRingtone:Landroid/media/Ringtone;
...
.method enableSpringEdgeEffect()V
    ...
    invoke-direct {v2, p0}, Lcom/oneplus/settings/edgeeffect/SpringRelativeLayout;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v2, v4}, Lcom/oneplus/settings/edgeeffect/SpringRelativeLayout;->setSaveEnabled(Z)V
    ...
    invoke-virtual {v2, v4}, Lcom/oneplus/settings/edgeeffect/SpringRelativeLayout;->addView(Landroid/view/View;)V

    const v5, 0x102000a

    invoke-virtual {v2, v5}, Lcom/oneplus/settings/edgeeffect/SpringRelativeLayout;->addSpringView(I)V
    ...
    iput-object v4, p0, mList:Landroid/widget/ListView;
...
.method public isThreePart()Z
    ...
    iget-boolean v1, p0, mHasDefaultItem:Z
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v3, p0, mUserContext:Landroid/content/Context;

    iget-object v3, p0, mUserContext:Landroid/content/Context;
    ...
    iput-boolean v5, p0, mIsAlarmNeedVibrate:Z
    ...
    iput-boolean v5, p0, mHasDefaultItem:Z
    ...
    iput-boolean v5, p0, mContactsRingtone:Z
    ...
    iput-object v5, p0, mDefualtUri:Landroid/net/Uri;
    ...
    iput-object v6, p0, mUriForDefaultItem:Landroid/net/Uri;
    ...
    iget-boolean v5, p0, isSelectedNone:Z
    ...
    iput-object v5, p0, mUriForDefaultItem:Landroid/net/Uri;
    ...
    iget-object v6, p0, mDefualtUri:Landroid/net/Uri;
    ...
    iget-boolean v6, p0, mHasDefaultItem:Z
    ...
    iput-object v1, p0, mRingtoneManager:Lcom/oneplus/settings/ringtone/OPRingtoneManager;

    iget-object v1, p0, mRingtoneManager:Lcom/oneplus/settings/ringtone/OPRingtoneManager;
    ...
    invoke-virtual {p0, v1}, setVolumeControlStream(I)V
    ...
    iput-object v3, p0, mPhoneCallListener:Lcom/oneplus/settings/ringtone/OPRingtoneBaseActivity$PhoneCallListener;

    invoke-virtual {p0}, enableSpringEdgeEffect()V
...
.method protected onPause()V
    ...
    iget-object v1, p0, mPhoneCallListener:Lcom/oneplus/settings/ringtone/OPRingtoneBaseActivity$PhoneCallListener;
    ...
    iget-object v1, p0, mAudioFocusChangeListener:Landroid/media/AudioManager$OnAudioFocusChangeListener;
...
.method protected onResume()V
    ...
    invoke-direct {p0}, lookupRingtoneNames()V
...
.method protected playRingtone(ILandroid/net/Uri;)V
    ...
    iput-object p2, p0, mUriForDefaultItem:Landroid/net/Uri;
...
.method public run()V
    ...
    invoke-direct {p0}, stopAnyPlayingRingtone2()V
    ...
    iput-boolean v0, p0, isPlaying:Z

    iget-object v0, p0, mAudioManager:Landroid/media/AudioManager;

    iget-object v1, p0, mAudioFocusChangeListener:Landroid/media/AudioManager$OnAudioFocusChangeListener;

    iget-object v2, p0, mRingtoneManager:Lcom/oneplus/settings/ringtone/OPRingtoneManager;
    ...
    :cond_1
    invoke-direct {p0}, startPreview()V
...
.method protected startVibrate(Landroid/net/Uri;)V
    ...
    :cond_2
    iget-boolean v0, p0, mIsAlarmNeedVibrate:Z
...
.method protected stopAnyPlayingRingtone()V
    ...
    invoke-virtual {p0}, stopVibrate()V
