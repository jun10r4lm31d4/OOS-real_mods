...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput v2, p0, mSubtitleStyleRes:I
...
.method public initForMode(Lcom/oneplus/lib/app/appcompat/ActionMode;)V
    ...
    iput-object v1, p0, mClose:Landroid/view/View;
    ...
    iput-object v2, p0, mActionMenuPresenter:Lcom/oneplus/lib/menu/ActionMenuPresenter;
    ...
    iget-object v3, p0, mActionMenuPresenter:Lcom/oneplus/lib/menu/ActionMenuPresenter;
    ...
    iput-object v3, p0, mMenuView:Lcom/oneplus/lib/menu/ActionMenuView;

    iget-object v3, p0, mMenuView:Lcom/oneplus/lib/menu/ActionMenuView;
    ...
    invoke-virtual {p0, v3, v2}, addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v1, v6, mClose:Landroid/view/View;
    ...
    invoke-static {v0, v12, v7}, next(IIZ)I
    ...
    invoke-static {v14, v13, v7}, next(IIZ)I
    ...
    :goto_3
    iget-object v0, v6, mTitleLayout:Landroid/widget/LinearLayout;

    if-eqz v0, :cond_4

    iget-object v1, v6, mCustomView:Landroid/view/View;
    ...
    iget-object v1, v6, mTitleLayout:Landroid/widget/LinearLayout;
    ...
    iget-object v0, v6, mMenuView:Lcom/oneplus/lib/menu/ActionMenuView;

    if-eqz v0, :cond_7

    iget-object v1, v6, mMenuView:Lcom/oneplus/lib/menu/ActionMenuView;
...
.method protected onMeasure(II)V
    ...
    iget-object v11, v0, mClose:Landroid/view/View;

    const/4 v12, 0x0

    if-eqz v11, :cond_1

    invoke-virtual {v0, v11, v7, v10, v12}, measureChildView(Landroid/view/View;III)I
    ...
    :cond_1
    iget-object v11, v0, mMenuView:Lcom/oneplus/lib/menu/ActionMenuView;
    ...
    :cond_2
    iget-object v11, v0, mTitleLayout:Landroid/widget/LinearLayout;

    if-eqz v11, :cond_7

    iget-object v13, v0, mCustomView:Landroid/view/View;

    if-nez v13, :cond_7

    iget-boolean v13, v0, mTitleOptional:Z
    ...
    iget-object v13, v0, mTitleLayout:Landroid/widget/LinearLayout;
    ...
    :cond_4
    iget-object v15, v0, mTitleLayout:Landroid/widget/LinearLayout;
    ...
    :cond_7
    :goto_3
    iget-object v11, v0, mCustomView:Landroid/view/View;
    ...
    :cond_e
    invoke-virtual {v0, v4, v1}, setMeasuredDimension(II)V

    goto :goto_a

    :cond_f
    invoke-virtual {v0, v4, v5}, setMeasuredDimension(II)V
