...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mDefaultGestureAppList:Ljava/util/List;
...
.method static synthetic access$000(Lcom/oneplus/settings/gestures/OPGestureAppListSettings;)Lcom/oneplus/settings/gestures/OPGestureAppAdapter;
    ...
    iget-object v0, p0, mOPGestureAppAdapter:Lcom/oneplus/settings/gestures/OPGestureAppAdapter;
...
.method static synthetic access$200(Lcom/oneplus/settings/gestures/OPGestureAppListSettings;)Ljava/util/List;
    ...
    iget-object v0, p0, mGestureAppList:Ljava/util/List;
...
.method static synthetic access$300(Lcom/oneplus/settings/gestures/OPGestureAppListSettings;)Ljava/util/List;
    ...
    iget-object v0, p0, mDefaultGestureAppList:Ljava/util/List;
...
.method static synthetic access$400(Lcom/oneplus/settings/gestures/OPGestureAppListSettings;)I
    ...
    invoke-direct {p0}, getSelectionPosition()I
...
.method static synthetic access$500(Lcom/oneplus/settings/gestures/OPGestureAppListSettings;)Landroid/widget/ListView;
    ...
    iget-object v0, p0, mGestureAppListView:Landroid/widget/ListView;
...
.method private createDefaultAppList()Ljava/util/List;
    ...
    invoke-virtual {p0, v5, v4}, getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    iget-object v6, p0, mDefaultGestureAppList:Ljava/util/List;
...
.method private doNothing()V
    ...
    iget v0, p0, mGestureValueIndex:I
...
.method private getSelectionPosition()I
    ...
    iget-object v0, p0, mGestureKey:Ljava/lang/String;
    ...
    iput-object v0, p0, mGesturePackageName:Ljava/lang/String;
    ...
    iget-object v3, p0, mGestureAppList:Ljava/util/List;
    ...
    :cond_0
    iget-object v2, p0, mGesturePackageName:Ljava/lang/String;
...
.method private initView()V
    ...
    iput-object v0, p0, mGestureAppListView:Landroid/widget/ListView;
    ...
    invoke-direct {p0}, createDefaultAppList()Ljava/util/List;
    ...
    iput-object v0, p0, mOPGestureAppAdapter:Lcom/oneplus/settings/gestures/OPGestureAppAdapter;

    iget-object v0, p0, mGestureAppListView:Landroid/widget/ListView;

    iget-object v1, p0, mOPGestureAppAdapter:Lcom/oneplus/settings/gestures/OPGestureAppAdapter;
...
.method private refreshList()V
    ...
    iget-object v1, p0, mGesturePackageName:Ljava/lang/String;
    ...
    iget-object v2, p0, mOPGestureAppAdapter:Lcom/oneplus/settings/gestures/OPGestureAppAdapter;

    iget-object v3, p0, mGestureSummary:Ljava/lang/String;

    iget-object v4, p0, mGesturePackageName:Ljava/lang/String;

    iget v5, p0, mGestureUid:I
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v1, p0, mGestureTitle:Ljava/lang/String;
    ...
    iput v1, p0, mGestureValueIndex:I
    ...
    iput-object v1, p0, mGestureSummary:Ljava/lang/String;
    ...
    :goto_0
    iput v2, p0, mGestureUid:I

    iget-object v2, p0, mGestureKey:Ljava/lang/String;
    ...
    iput-object v2, p0, mGesturePackageName:Ljava/lang/String;

    invoke-virtual {p0}, getActionBar()Landroid/app/ActionBar;

    move-result-object v2

    iget-object v3, p0, mGestureTitle:Ljava/lang/String;
...
.method public onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    iget-object v1, p0, mGestureAppListView:Landroid/widget/ListView;
    ...
    invoke-direct {p0, v1}, gotoShortCutsPickPage(Lcom/oneplus/settings/better/OPAppModel;)V
    ...
    :cond_0
    invoke-direct {p0, v1}, openApps(Lcom/oneplus/settings/better/OPAppModel;)V

    goto :goto_0

    :cond_1
    invoke-direct {p0}, openShelf()V

    goto :goto_0

    :cond_2
    invoke-direct {p0}, openFlashLight()V

    goto :goto_0

    :cond_3
    invoke-direct {p0}, openTakeVideo()V

    goto :goto_0

    :cond_4
    invoke-direct {p0}, openFrontCamera()V

    goto :goto_0

    :cond_5
    invoke-direct {p0}, openBackCamera()V

    goto :goto_0

    :cond_6
    invoke-direct {p0}, doNothing()V
