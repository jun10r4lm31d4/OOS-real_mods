...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mRemoveCallback:Landroid/hardware/fingerprint/FingerprintManager$RemovalCallback;
...
.method static synthetic access$000(Lcom/oneplus/settings/opfinger/OPFingerPrintEditFragments;)Lcom/oneplus/settings/ui/OPProgressDialog;
    ...
    iget-object v0, p0, mProgressDialog:Lcom/oneplus/settings/ui/OPProgressDialog;
...
.method static synthetic access$300(Lcom/oneplus/settings/opfinger/OPFingerPrintEditFragments;)Landroid/hardware/fingerprint/Fingerprint;
    ...
    iget-object v0, p0, mFingerprint:Landroid/hardware/fingerprint/Fingerprint;
...
.method static synthetic access$400(Lcom/oneplus/settings/opfinger/OPFingerPrintEditFragments;Landroid/hardware/fingerprint/Fingerprint;)V
    ...
    invoke-direct {p0, p1}, deleteFingerPrint(Landroid/hardware/fingerprint/Fingerprint;)V
...
.method static synthetic access$500(Lcom/oneplus/settings/opfinger/OPFingerPrintEditFragments;)Lcom/oneplus/lib/widget/OPEditText;
    ...
    iget-object v0, p0, renameEdit:Lcom/oneplus/lib/widget/OPEditText;
...
.method static synthetic access$600(Lcom/oneplus/settings/opfinger/OPFingerPrintEditFragments;)Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, mFingerprintName:Ljava/lang/CharSequence;
...
.method static synthetic access$700(Lcom/oneplus/settings/opfinger/OPFingerPrintEditFragments;ILjava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2}, renameFingerPrint(ILjava/lang/String;)V
...
.method static synthetic access$800(Lcom/oneplus/settings/opfinger/OPFingerPrintEditFragments;)Lcom/oneplus/settings/opfinger/OPFingerPrintEditCategory;
    ...
    iget-object v0, p0, mOPFingerPrintEditViewCategory:Lcom/oneplus/settings/opfinger/OPFingerPrintEditCategory;
...
.method static synthetic access$900(Lcom/oneplus/settings/opfinger/OPFingerPrintEditFragments;)Landroid/app/AlertDialog;
    ...
    iget-object v0, p0, mRenameDialog:Landroid/app/AlertDialog;
...
.method private deleteFingerPrint(Landroid/hardware/fingerprint/Fingerprint;)V
    ...
    iget-object v2, p0, mRemoveCallback:Landroid/hardware/fingerprint/FingerprintManager$RemovalCallback;
...
.method private initViews()V
    ...
    iput-object v0, p0, mOPFingerPrintEditViewCategory:Lcom/oneplus/settings/opfinger/OPFingerPrintEditCategory;
    ...
    iput-object v0, p0, mRenamePreference:Landroidx/preference/Preference;
    ...
    iput-object v0, p0, mDeltePreference:Landroidx/preference/Preference;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-boolean v0, p0, isRenameDialogShow:Z
    ...
    iput-boolean v0, p0, isDeleteDialogShow:Z
    ...
    iput-boolean v0, p0, isWarnDialogShow:Z
    ...
    iput-object v0, p0, renameData:Ljava/lang/String;
    ...
    iput-object v0, p0, mFingerprint:Landroid/hardware/fingerprint/Fingerprint;
    ...
    iput-object v0, p0, mFingerprintName:Ljava/lang/CharSequence;
    ...
    iput-object v0, p0, mProgressDialog:Lcom/oneplus/settings/ui/OPProgressDialog;
    ...
    iget-boolean v0, p0, isRenameDialogShow:Z

    if-eqz v0, :cond_3

    invoke-virtual {p0}, showRenameDialog()V

    goto :goto_1

    :cond_3
    iget-boolean v0, p0, isWarnDialogShow:Z

    if-eqz v0, :cond_4

    iget-object v0, p0, mFingerprint:Landroid/hardware/fingerprint/Fingerprint;

    invoke-virtual {p0, v0}, showWarnigDialog(Landroid/hardware/fingerprint/Fingerprint;)V

    goto :goto_1

    :cond_4
    iget-boolean v0, p0, isDeleteDialogShow:Z

    if-eqz v0, :cond_5

    iget-object v0, p0, mFingerprint:Landroid/hardware/fingerprint/Fingerprint;

    invoke-virtual {p0, v0}, showDeleteDialog(Landroid/hardware/fingerprint/Fingerprint;)V
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    :cond_1
    iget-object v0, p0, mDeleteDialog:Landroid/app/AlertDialog;
...
.method public showDeleteDialog(Landroid/hardware/fingerprint/Fingerprint;)V
    ...
    iput-object v0, p0, mDeleteDialog:Landroid/app/AlertDialog;
...
.method public showRenameDialog()V
    ...
    iput-object v2, p0, renameEdit:Lcom/oneplus/lib/widget/OPEditText;

    iget-object v2, p0, renameEdit:Lcom/oneplus/lib/widget/OPEditText;

    iget-object v3, p0, mFingerprintName:Ljava/lang/CharSequence;
    ...
    iget-object v3, p0, renameData:Ljava/lang/String;
    ...
    iput-object v1, p0, mRenameDialog:Landroid/app/AlertDialog;

    iget-object v1, p0, mRenameDialog:Landroid/app/AlertDialog;
