...
.method static constructor <clinit>()V
    ...
    sput-object v0, START_CALENDAR:Ljava/util/GregorianCalendar;
...
.method private static checkLunarDate(IIIZ)V
    ...
    invoke-static {p0}, getLeapMonth(I)I
...
.method private static daysBetween(Ljava/util/Calendar;Ljava/util/Calendar;)I
    ...
    invoke-virtual {v7, v6}, Ljava/util/Calendar;->getActualMaximum(I)I

    move-result v9

    add-int/2addr v0, v9

    invoke-virtual {v7, v3, v3}, Ljava/util/Calendar;->add(II)V
...
.method private static getYearDays(I)I
    ...
    :cond_1
    invoke-static {p0}, getLeapMonthDays(I)I
...
.method public static lunarToSolar(Lcom/oneplus/lib/util/calendar/OneplusLunarCalendar;)Ljava/util/Calendar;
    ...
    invoke-static {v0, v1, v2, v3}, checkLunarDate(IIIZ)V
    ...
    invoke-static {v5}, getYearDays(I)I
    ...
    :cond_0
    invoke-static {v0}, getLeapMonth(I)I
    ...
    invoke-static {v0, v8}, getMonthDays(II)I
    ...
    invoke-static {v0}, getLeapMonthDays(I)I

    move-result v8

    add-int/2addr v4, v8

    invoke-static {v0, v1}, getMonthDays(II)I
    ...
    sget-object v8, START_CALENDAR:Ljava/util/GregorianCalendar;
    ...
    sget-object v9, START_CALENDAR:Ljava/util/GregorianCalendar;
...
.method public static solarToLunar(Ljava/util/Calendar;)Lcom/oneplus/lib/util/calendar/OneplusLunarCalendar;
    ...
    sget-object v3, START_CALENDAR:Ljava/util/GregorianCalendar;
    ...
    sget-object v5, START_CALENDAR:Ljava/util/GregorianCalendar;
    ...
    sget-object v6, START_CALENDAR:Ljava/util/GregorianCalendar;
    ...
    invoke-static {v2, p0}, daysBetween(Ljava/util/Calendar;Ljava/util/Calendar;)I
    ...
    invoke-static {v6}, getLeapMonth(I)I
    ...
    invoke-static {v6}, getLeapMonthDays(I)I
    ...
    :cond_3
    invoke-static {v6, v5}, getMonthDays(II)I
