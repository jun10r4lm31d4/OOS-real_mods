...
.method public addContentView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {p0}, getDelegate()Lcom/oneplus/lib/app/appcompat/AppCompatDelegate;
...
.method public dispatchKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    iput-boolean v1, p0, mEatKeyUpEvent:Z
    ...
    iget-boolean v2, p0, mEatKeyUpEvent:Z

    if-eqz v2, :cond_1

    const/4 v2, 0x0

    iput-boolean v2, p0, mEatKeyUpEvent:Z
...
.method public getDelegate()Lcom/oneplus/lib/app/appcompat/AppCompatDelegate;
    ...
    iget-object v0, p0, mDelegate:Lcom/oneplus/lib/app/appcompat/AppCompatDelegate;
    ...
    iput-object v0, p0, mDelegate:Lcom/oneplus/lib/app/appcompat/AppCompatDelegate;
...
.method public onContentChanged()V
    ...
    invoke-virtual {p0}, onSupportContentChanged()V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iget v2, p0, mThemeId:I

    const/4 v3, 0x0

    invoke-virtual {p0, v1, v2, v3}, onApplyThemeResource(Landroid/content/res/Resources$Theme;IZ)V
...
.method public onCreateSupportNavigateUpTaskStack(Lcom/oneplus/support/core/app/TaskStackBuilder;)V
    .locals 0
    .param p1    # Lcom/oneplus/support/core/app/TaskStackBuilder;
        .annotation build Lcom/oneplus/support/annotation/NonNull;
        .end annotation
    .end param
...
.method public final onMenuItemSelected(ILandroid/view/MenuItem;)Z
    ...
    invoke-virtual {p0}, onSupportNavigateUp()Z
...
.method public onSupportNavigateUp()Z
    ...
    invoke-virtual {p0}, getSupportParentActivityIntent()Landroid/content/Intent;

    move-result-object v0

    if-eqz v0, :cond_1

    invoke-virtual {p0, v0}, supportShouldUpRecreateTask(Landroid/content/Intent;)Z
    ...
    invoke-virtual {p0, v1}, onCreateSupportNavigateUpTaskStack(Lcom/oneplus/support/core/app/TaskStackBuilder;)V

    invoke-virtual {p0, v1}, onPrepareSupportNavigateUpTaskStack(Lcom/oneplus/support/core/app/TaskStackBuilder;)V
    ...
    :cond_0
    invoke-virtual {p0, v0}, supportNavigateUpTo(Landroid/content/Intent;)V
