...
.method static constructor <clinit>()V
    ...
    sput-object v1, sEmptyList:[Ljava/util/Locale;

    new-instance v1, Lcom/oneplus/support/core/os/LocaleListHelper;

    new-array v0, v0, [Ljava/util/Locale;

    invoke-direct {v1, v0}, <init>([Ljava/util/Locale;)V

    sput-object v1, sEmptyLocaleList:Lcom/oneplus/support/core/os/LocaleListHelper;
    ...
    sput-object v0, LOCALE_EN_XA:Ljava/util/Locale;
    ...
    sput-object v0, LOCALE_AR_XB:Ljava/util/Locale;
    ...
    sput-object v0, EN_LATN:Ljava/util/Locale;
    ...
    sput-object v0, sLastExplicitlySetLocaleList:Lcom/oneplus/support/core/os/LocaleListHelper;

    sput-object v0, sDefaultLocaleList:Lcom/oneplus/support/core/os/LocaleListHelper;

    sput-object v0, sDefaultAdjustedLocaleList:Lcom/oneplus/support/core/os/LocaleListHelper;

    sput-object v0, sLastDefaultLocale:Ljava/util/Locale;
...
.method constructor <init>(Ljava/util/Locale;Lcom/oneplus/support/core/os/LocaleListHelper;)V
    ...
    :cond_0
    iget-object v1, p2, mList:[Ljava/util/Locale;
    ...
    iget-object v4, p2, mList:[Ljava/util/Locale;
    ...
    iget-object v6, p2, mList:[Ljava/util/Locale;
    ...
    iget-object v3, p2, mList:[Ljava/util/Locale;
    ...
    :cond_9
    iput-object v5, p0, mList:[Ljava/util/Locale;

    invoke-virtual {v0}, Ljava/lang/StringBuilder;->toString()Ljava/lang/String;

    move-result-object v3

    iput-object v3, p0, mStringRepresentation:Ljava/lang/String;
...
.method varargs constructor <init>([Ljava/util/Locale;)V
    ...
    sget-object v0, sEmptyList:[Ljava/util/Locale;

    iput-object v0, p0, mList:[Ljava/util/Locale;

    const-string v0, ""

    iput-object v0, p0, mStringRepresentation:Ljava/lang/String;
...
.method private computeFirstMatch(Ljava/util/Collection;Z)Ljava/util/Locale;
    ...
    invoke-direct {p0, p1, p2}, computeFirstMatchIndex(Ljava/util/Collection;Z)I
    ...
    :cond_0
    iget-object v1, p0, mList:[Ljava/util/Locale;
...
.method private computeFirstMatchIndex(Ljava/util/Collection;Z)I
    ...
    iget-object v0, p0, mList:[Ljava/util/Locale;
    ...
    sget-object v1, EN_LATN:Ljava/util/Locale;

    invoke-direct {p0, v1}, findFirstMatchIndex(Ljava/util/Locale;)I
    ...
    invoke-direct {p0, v4}, findFirstMatchIndex(Ljava/util/Locale;)I
...
.method private findFirstMatchIndex(Ljava/util/Locale;)I
    ...
    invoke-static {p1, v1}, matchScore(Ljava/util/Locale;Ljava/util/Locale;)I
...
.method static forLanguageTags(Ljava/lang/String;)Lcom/oneplus/support/core/os/LocaleListHelper;
    ...
    invoke-direct {v2, v1}, <init>([Ljava/util/Locale;)V

    return-object v2

    :cond_2
    :goto_1
    invoke-static {}, getEmptyLocaleList()Lcom/oneplus/support/core/os/LocaleListHelper;
...
.method static getAdjustedDefault()Lcom/oneplus/support/core/os/LocaleListHelper;
    ...
    invoke-static {}, getDefault()Lcom/oneplus/support/core/os/LocaleListHelper;
    ...
    :try_start_0
    sget-object v1, sDefaultAdjustedLocaleList:Lcom/oneplus/support/core/os/LocaleListHelper;
...
.method static getDefault()Lcom/oneplus/support/core/os/LocaleListHelper;
    ...
    :try_start_0
    sget-object v2, sLastDefaultLocale:Ljava/util/Locale;
    ...
    sget-object v2, sDefaultLocaleList:Lcom/oneplus/support/core/os/LocaleListHelper;
    ...
    invoke-virtual {v2, v3}, get(I)Ljava/util/Locale;
    ...
    sget-object v3, sLastExplicitlySetLocaleList:Lcom/oneplus/support/core/os/LocaleListHelper;

    invoke-direct {v2, v0, v3}, <init>(Ljava/util/Locale;Lcom/oneplus/support/core/os/LocaleListHelper;)V

    sput-object v2, sDefaultLocaleList:Lcom/oneplus/support/core/os/LocaleListHelper;

    sget-object v2, sDefaultLocaleList:Lcom/oneplus/support/core/os/LocaleListHelper;

    sput-object v2, sDefaultAdjustedLocaleList:Lcom/oneplus/support/core/os/LocaleListHelper;
...
.method static getEmptyLocaleList()Lcom/oneplus/support/core/os/LocaleListHelper;
    ...
    sget-object v0, sEmptyLocaleList:Lcom/oneplus/support/core/os/LocaleListHelper;
...
.method private static isPseudoLocale(Ljava/util/Locale;)Z
    ...
    sget-object v0, LOCALE_EN_XA:Ljava/util/Locale;
    ...
    sget-object v0, LOCALE_AR_XB:Ljava/util/Locale;
...
.method static isPseudoLocalesOnly([Ljava/lang/String;)Z
    ...
    invoke-static {v4}, isPseudoLocale(Ljava/lang/String;)Z
...
.method private static matchScore(Ljava/util/Locale;Ljava/util/Locale;)I
    ...
    :cond_1
    invoke-static {p0}, isPseudoLocale(Ljava/util/Locale;)Z

    move-result v0

    if-nez v0, :cond_6

    invoke-static {p1}, isPseudoLocale(Ljava/util/Locale;)Z
    ...
    :cond_2
    invoke-static {p0}, getLikelyScript(Ljava/util/Locale;)Ljava/lang/String;
    ...
    :cond_5
    invoke-static {p1}, getLikelyScript(Ljava/util/Locale;)Ljava/lang/String;
...
.method static setDefault(Lcom/oneplus/support/core/os/LocaleListHelper;)V
    ...
    invoke-static {p0, v0}, setDefault(Lcom/oneplus/support/core/os/LocaleListHelper;I)V
...
.method static setDefault(Lcom/oneplus/support/core/os/LocaleListHelper;I)V
    ...
    :try_start_0
    invoke-virtual {p0, p1}, get(I)Ljava/util/Locale;

    move-result-object v1

    sput-object v1, sLastDefaultLocale:Ljava/util/Locale;

    sget-object v1, sLastDefaultLocale:Ljava/util/Locale;

    invoke-static {v1}, Ljava/util/Locale;->setDefault(Ljava/util/Locale;)V

    sput-object p0, sLastExplicitlySetLocaleList:Lcom/oneplus/support/core/os/LocaleListHelper;

    sput-object p0, sDefaultLocaleList:Lcom/oneplus/support/core/os/LocaleListHelper;

    if-nez p1, :cond_0

    sget-object v1, sDefaultLocaleList:Lcom/oneplus/support/core/os/LocaleListHelper;

    sput-object v1, sDefaultAdjustedLocaleList:Lcom/oneplus/support/core/os/LocaleListHelper;
    ...
    sget-object v3, sDefaultLocaleList:Lcom/oneplus/support/core/os/LocaleListHelper;

    invoke-direct {v1, v2, v3}, <init>(Ljava/util/Locale;Lcom/oneplus/support/core/os/LocaleListHelper;)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v1, v1, mList:[Ljava/util/Locale;

    iget-object v3, p0, mList:[Ljava/util/Locale;
    ...
    :goto_0
    iget-object v4, p0, mList:[Ljava/util/Locale;
...
.method getFirstMatch([Ljava/lang/String;)Ljava/util/Locale;
    ...
    invoke-direct {p0, v0, v1}, computeFirstMatch(Ljava/util/Collection;Z)Ljava/util/Locale;
...
.method getFirstMatchIndex([Ljava/lang/String;)I
    ...
    invoke-direct {p0, v0, v1}, computeFirstMatchIndex(Ljava/util/Collection;Z)I
...
.method getFirstMatchIndexWithEnglishSupported(Ljava/util/Collection;)I
    ...
    invoke-direct {p0, p1, v0}, computeFirstMatchIndex(Ljava/util/Collection;Z)I
...
.method getFirstMatchIndexWithEnglishSupported([Ljava/lang/String;)I
    ...
    invoke-virtual {p0, v0}, getFirstMatchIndexWithEnglishSupported(Ljava/util/Collection;)I
...
.method public hashCode()I
    ...
    :goto_0
    iget-object v2, p0, mList:[Ljava/util/Locale;
...
.method toLanguageTags()Ljava/lang/String;
    ...
    iget-object v0, p0, mStringRepresentation:Ljava/lang/String;
