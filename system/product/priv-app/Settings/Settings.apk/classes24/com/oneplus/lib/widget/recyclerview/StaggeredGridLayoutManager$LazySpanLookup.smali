...
.method private invalidateFullSpansAfter(I)I
    ...
    :cond_0
    invoke-virtual {p0, p1}, getFullSpanItem(I)Lcom/oneplus/lib/widget/recyclerview/StaggeredGridLayoutManager$LazySpanLookup$FullSpanItem;

    move-result-object v0

    if-eqz v0, :cond_1

    iget-object v2, p0, mFullSpanItems:Ljava/util/List;
    ...
    iget-object v3, p0, mFullSpanItems:Ljava/util/List;
    ...
    iget-object v5, p0, mFullSpanItems:Ljava/util/List;
    ...
    iget-object v1, p0, mFullSpanItems:Ljava/util/List;
    ...
    iget-object v4, p0, mFullSpanItems:Ljava/util/List;
...
.method ensureSize(I)V
    ...
    invoke-virtual {p0, p1}, sizeForPosition(I)I

    move-result v2

    new-array v2, v2, [I

    iput-object v2, p0, mData:[I
...
.method forceInvalidateAfter(I)I
    ...
    :cond_1
    invoke-virtual {p0, p1}, invalidateAfter(I)I
...
.method invalidateAfter(I)I
    ...
    :cond_1
    invoke-direct {p0, p1}, invalidateFullSpansAfter(I)I
...
.method offsetForAddition(II)V
    ...
    invoke-virtual {p0, v0}, ensureSize(I)V
    ...
    invoke-direct {p0, p1, p2}, offsetFullSpansForAddition(II)V
...
.method offsetForRemoval(II)V
    ...
    invoke-direct {p0, p1, p2}, offsetFullSpansForRemoval(II)V
...
.method setSpan(ILcom/oneplus/lib/widget/recyclerview/StaggeredGridLayoutManager$Span;)V
    ...
    invoke-virtual {p0, p1}, ensureSize(I)V
