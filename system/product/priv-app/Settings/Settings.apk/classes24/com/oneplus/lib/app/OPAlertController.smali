...
.method public constructor <init>(Landroid/content/Context;Landroid/content/DialogInterface;Landroid/view/Window;)V
    ...
    iget-object v1, p0, mDialogInterface:Landroid/content/DialogInterface;
...
.method private setBackground(Landroid/content/res/TypedArray;Landroid/view/View;Landroid/view/View;Landroid/view/View;Landroid/view/View;ZZZ)V
    ...
    iget-object v1, v0, mListView:Landroid/widget/ListView;
    ...
    iget-boolean v1, v0, mForceInverseBackground:Z
    ...
    :cond_f
    :goto_9
    iget-object v2, v0, mListView:Landroid/widget/ListView;

    if-eqz v2, :cond_10

    iget-object v15, v0, mAdapter:Landroid/widget/ListAdapter;

    if-eqz v15, :cond_10

    invoke-virtual {v2, v15}, Landroid/widget/ListView;->setAdapter(Landroid/widget/ListAdapter;)V

    iget v15, v0, mCheckedItem:I
...
.method private setupButtons(Landroid/view/ViewGroup;)V
    ...
    iget-object v4, p0, mDialogInterface:Landroid/content/DialogInterface;
    ...
    const-string v4, "setupButtons mSpaceView set GONE"
    ...
    iput-object v7, p0, mSpaceView:Landroid/view/View;

    iget v7, p0, mProgressStyle:I

    if-nez v7, :cond_0

    iget-object v7, p0, mSpaceView:Landroid/view/View;
    ...
    iget-object v7, p0, mButtonHandler:Landroid/view/View$OnClickListener;
...
.method private setupCustomContent(Landroid/view/ViewGroup;)V
    ...
    iget-boolean v3, p0, mViewSpacingSpecified:Z
...
.method private setupView()V
    ...
    iget-object v0, v9, mWindow:Landroid/view/Window;
    ...
    invoke-direct {v9, v14}, setupCustomContent(Landroid/view/ViewGroup;)V
    ...
    invoke-direct {v9, v15, v11}, resolvePanel(Landroid/view/View;Landroid/view/View;)Landroid/view/ViewGroup;

    move-result-object v6

    invoke-direct {v9, v8, v12}, resolvePanel(Landroid/view/View;Landroid/view/View;)Landroid/view/ViewGroup;

    move-result-object v5

    invoke-direct {v9, v7, v13}, resolvePanel(Landroid/view/View;Landroid/view/View;)Landroid/view/ViewGroup;

    move-result-object v4

    invoke-direct {v9, v5}, setupContent(Landroid/view/ViewGroup;)V

    invoke-direct {v9, v4}, setupButtons(Landroid/view/ViewGroup;)V

    invoke-direct {v9, v6}, setupTitle(Landroid/view/ViewGroup;)V
    ...
    iget-object v1, v9, mTitle:Ljava/lang/CharSequence;
    ...
    iget-object v0, v9, mScrollView:Landroid/widget/ScrollView;
    ...
    iget-object v0, v9, mListView:Landroid/widget/ListView;
    ...
    invoke-direct/range {v0 .. v8}, setBackground(Landroid/content/res/TypedArray;Landroid/view/View;Landroid/view/View;Landroid/view/View;Landroid/view/View;ZZZ)V
...
.method private updateMessageView()V
    ...
    iget-boolean v3, p0, mOnlyDarkTheme:Z
    ...
    invoke-direct {p0, v4}, getColorCompat(I)Landroid/content/res/ColorStateList;
    ...
    :cond_3
    iget-boolean v3, p0, mOnlyLightTheme:Z
...
.method private updateTitleView()V
    ...
    iget-object v2, p0, mDialogInterface:Landroid/content/DialogInterface;
    ...
    :cond_5
    iget-object v2, p0, mTitle_template:Landroid/widget/LinearLayout;
    ...
    iget-object v5, p0, mTitle_template:Landroid/widget/LinearLayout;

    invoke-virtual {v5}, Landroid/widget/LinearLayout;->getPaddingTop()I

    move-result v5

    iget-object v6, p0, mTitle_template:Landroid/widget/LinearLayout;
...
.method public setOnlyDarkTheme(Z)V
    ...
    iput-boolean p1, p0, mOnlyDarkTheme:Z
...
.method public setOnlyLightTheme(Z)V
    ...
    iput-boolean p1, p0, mOnlyLightTheme:Z
