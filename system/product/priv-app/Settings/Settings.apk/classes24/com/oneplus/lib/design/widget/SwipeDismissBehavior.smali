...
.method public constructor <init>()V
    ...
    iput v0, p0, mSensitivity:F

    const/4 v1, 0x2

    iput v1, p0, mSwipeDirection:I

    const/high16 v1, 0x3f000000    # 0.5f

    iput v1, p0, mDragDismissThreshold:F

    iput v0, p0, mAlphaStartSwipeDistance:F

    iput v1, p0, mAlphaEndSwipeDistance:F
    ...
    iput-object v0, p0, mDragCallback:Lcom/oneplus/lib/util/ViewDragHelper$Callback;
...
.method private ensureViewDragHelper(Landroid/view/ViewGroup;)V
    ...
    iget-object v0, p0, mViewDragHelper:Lcom/oneplus/lib/util/ViewDragHelper;

    if-nez v0, :cond_1

    iget-boolean v0, p0, mSensitivitySet:Z

    if-eqz v0, :cond_0

    iget v0, p0, mSensitivity:F

    iget-object v1, p0, mDragCallback:Lcom/oneplus/lib/util/ViewDragHelper$Callback;
    ...
    :cond_0
    iget-object v0, p0, mDragCallback:Lcom/oneplus/lib/util/ViewDragHelper$Callback;
    ...
    :goto_0
    iput-object v0, p0, mViewDragHelper:Lcom/oneplus/lib/util/ViewDragHelper;
...
.method public onInterceptTouchEvent(Lcom/oneplus/lib/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v0, p0, mInterceptingEvents:Z
    ...
    :cond_0
    iput-boolean v2, p0, mInterceptingEvents:Z
    ...
    iput-boolean v1, p0, mInterceptingEvents:Z
    ...
    invoke-direct {p0, p1}, ensureViewDragHelper(Landroid/view/ViewGroup;)V

    iget-object v1, p0, mViewDragHelper:Lcom/oneplus/lib/util/ViewDragHelper;
...
.method public setDragDismissDistance(F)V
    ...
    invoke-static {v0, p1, v1}, clamp(FFF)F

    move-result v0

    iput v0, p0, mDragDismissThreshold:F
...
.method public setEndAlphaSwipeDistance(F)V
    ...
    iput v0, p0, mAlphaEndSwipeDistance:F
...
.method public setListener(Lcom/oneplus/lib/design/widget/SwipeDismissBehavior$OnDismissListener;)V
    ...
    iput-object p1, p0, mListener:Lcom/oneplus/lib/design/widget/SwipeDismissBehavior$OnDismissListener;
...
.method public setSensitivity(F)V
    ...
    iput p1, p0, mSensitivity:F

    const/4 v0, 0x1

    iput-boolean v0, p0, mSensitivitySet:Z
