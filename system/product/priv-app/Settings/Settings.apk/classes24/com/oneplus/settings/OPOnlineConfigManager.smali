...
.method static constructor <clinit>()V
    ...
    sput-object v0, onlineConfigManager:Lcom/oneplus/settings/OPOnlineConfigManager;
    ...
    sput-object v0, slaDownloadWhiteList:Ljava/util/List;

    const/4 v0, 0x0

    sput-boolean v0, isSupportEnable:Z

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, multiAppWhiteList:Ljava/util/List;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    sput-object v1, localMultiAppWhiteList:Ljava/util/List;
    ...
    sput-object v2, localSlaDownloadWhiteList:Ljava/util/List;
...
.method static synthetic access$100(Lcom/oneplus/settings/OPOnlineConfigManager;Lorg/json/JSONArray;)V
    ...
    invoke-direct {p0, p1}, parseConfigFromJson(Lorg/json/JSONArray;)V
...
.method static synthetic access$200(Lcom/oneplus/settings/OPOnlineConfigManager;Lorg/json/JSONArray;)V
    ...
    invoke-direct {p0, p1}, parseSlaConfigFromJson(Lorg/json/JSONArray;)V
...
.method private deleteNoWhiteListSlaDownLoadOpenApp()V
    ...
    :cond_0
    invoke-static {}, getSlaDownloadWhiteList()Ljava/util/List;
    ...
    sget-object v7, slaDownloadWhiteList:Ljava/util/List;
    ...
    invoke-virtual {p0, v10}, saveSlaDownLoadOpenAppsListStrings(Ljava/lang/String;)V
...
.method public static declared-synchronized getInstence(Landroid/content/Context;)Lcom/oneplus/settings/OPOnlineConfigManager;
    ...
    :try_start_0
    sget-object v1, lock:Ljava/lang/Object;
    ...
    :try_start_1
    sget-object v2, onlineConfigManager:Lcom/oneplus/settings/OPOnlineConfigManager;
    ...
    sput-object v2, onlineConfigManager:Lcom/oneplus/settings/OPOnlineConfigManager;
    ...
    :try_start_2
    sget-object v1, onlineConfigManager:Lcom/oneplus/settings/OPOnlineConfigManager;
    :try_end_2
...
.method public static getMultiAppWhiteList()Ljava/util/List;
    ...
    sget-object v0, multiAppWhiteList:Ljava/util/List;

    monitor-enter v0

    :try_start_0
    sget-object v1, multiAppWhiteList:Ljava/util/List;
    ...
    :cond_0
    sget-object v1, localMultiAppWhiteList:Ljava/util/List;
...
.method public static getSlaDownloadWhiteList()Ljava/util/List;
    ...
    sget-object v0, slaDownloadWhiteList:Ljava/util/List;

    monitor-enter v0

    :try_start_0
    sget-object v1, slaDownloadWhiteList:Ljava/util/List;
    ...
    :cond_0
    sget-object v1, localSlaDownloadWhiteList:Ljava/util/List;
...
.method public static isSupportEnable()Z
    ...
    sget-boolean v0, isSupportEnable:Z
...
.method private parseConfigFromJson(Lorg/json/JSONArray;)V
    ...
    sget-object v4, multiAppWhiteList:Ljava/util/List;
    ...
    :try_start_2
    sget-object v5, multiAppWhiteList:Ljava/util/List;
    ...
    sget-object v7, multiAppWhiteList:Ljava/util/List;
    ...
    sput-boolean v3, isSupportEnable:Z
...
.method private parseSlaConfigFromJson(Lorg/json/JSONArray;)V
    ...
    sget-object v4, slaDownloadWhiteList:Ljava/util/List;
    ...
    :try_start_2
    sget-object v5, slaDownloadWhiteList:Ljava/util/List;
    ...
    :cond_6
    invoke-direct {p0}, deleteNoWhiteListSlaDownLoadOpenApp()V
    :try_end_3
    .catch Lorg/json/JSONException; {:try_start_3 .. :try_end_3} :catch_2
    .catch Ljava/lang/Exception; {:try_start_3 .. :try_end_3} :catch_1
...
.method private supportConfigParseCompleted()V
    ...
    iget-object v0, p0, mOnConfigCompleteParseListener:Lcom/oneplus/settings/OPOnlineConfigManager$OnSupportConfigCompleteParseListener;
...
.method public init()V
    ...
    iput-object v0, p0, mBackgroundConfigObserver:Lcom/oneplus/config/ConfigObserver;

    iget-object v0, p0, mBackgroundConfigObserver:Lcom/oneplus/config/ConfigObserver;
    ...
    iput-object v0, p0, mSlaBackgroundConfigObserver:Lcom/oneplus/config/ConfigObserver;

    iget-object v0, p0, mSlaBackgroundConfigObserver:Lcom/oneplus/config/ConfigObserver;
...
.method public synthetic lambda$parseConfigFromJson$0$OPOnlineConfigManager()V
    ...
    invoke-direct {p0}, supportConfigParseCompleted()V
...
.method public setOnConfigCompleteParseListener(Lcom/oneplus/settings/OPOnlineConfigManager$OnSupportConfigCompleteParseListener;)V
    ...
    iput-object p1, p0, mOnConfigCompleteParseListener:Lcom/oneplus/settings/OPOnlineConfigManager$OnSupportConfigCompleteParseListener;
