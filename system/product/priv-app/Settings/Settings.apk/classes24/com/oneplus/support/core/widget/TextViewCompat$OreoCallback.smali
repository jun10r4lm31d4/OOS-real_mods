.class Lcom/oneplus/support/core/widget/TextViewCompat$OreoCallback;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/oneplus/support/core/widget/TextViewCompat;
.end annotation
...
.method constructor <init>(Landroid/view/ActionMode$Callback;Landroid/widget/TextView;)V
    ...
    iput-object p1, p0, mCallback:Landroid/view/ActionMode$Callback;

    iput-object p2, p0, mTextView:Landroid/widget/TextView;

    const/4 v0, 0x0

    iput-boolean v0, p0, mInitializedMenuBuilderReferences:Z
...
.method private createProcessTextIntentForResolveInfo(Landroid/content/pm/ResolveInfo;Landroid/widget/TextView;)Landroid/content/Intent;
    ...
    invoke-direct {p0, p2}, isEditable(Landroid/widget/TextView;)Z
...
.method private getSupportedActivities(Landroid/content/Context;Landroid/content/pm/PackageManager;)Ljava/util/List;
    ...
    invoke-direct {p0, v4, p1}, isSupportedActivity(Landroid/content/pm/ResolveInfo;Landroid/content/Context;)Z
...
.method private recomputeProcessTextMenuItems(Landroid/view/Menu;)V
    ...
    iget-boolean v2, p0, mInitializedMenuBuilderReferences:Z
    ...
    iput-boolean v5, p0, mInitializedMenuBuilderReferences:Z
    ...
    iput-object v2, p0, mMenuBuilderClass:Ljava/lang/Class;

    iget-object v2, p0, mMenuBuilderClass:Ljava/lang/Class;
    ...
    iput-object v2, p0, mMenuBuilderRemoveItemAtMethod:Ljava/lang/reflect/Method;

    iput-boolean v5, p0, mCanUseMenuBuilderReferences:Z
    :try_end_0
    ...
    iput-object v6, p0, mMenuBuilderClass:Ljava/lang/Class;

    iput-object v6, p0, mMenuBuilderRemoveItemAtMethod:Ljava/lang/reflect/Method;

    iput-boolean v4, p0, mCanUseMenuBuilderReferences:Z

    :cond_0
    :goto_0
    :try_start_1
    iget-boolean v2, p0, mCanUseMenuBuilderReferences:Z
    ...
    iget-object v2, p0, mMenuBuilderRemoveItemAtMethod:Ljava/lang/reflect/Method;
    ...
    invoke-direct {p0, v0, v1}, getSupportedActivities(Landroid/content/Context;Landroid/content/pm/PackageManager;)Ljava/util/List;
    ...
    invoke-direct {p0, v6, v8}, createProcessTextIntentForResolveInfo(Landroid/content/pm/ResolveInfo;Landroid/widget/TextView;)Landroid/content/Intent;
...
.method public onPrepareActionMode(Landroid/view/ActionMode;Landroid/view/Menu;)Z
    ...
    invoke-direct {p0, p2}, recomputeProcessTextMenuItems(Landroid/view/Menu;)V
