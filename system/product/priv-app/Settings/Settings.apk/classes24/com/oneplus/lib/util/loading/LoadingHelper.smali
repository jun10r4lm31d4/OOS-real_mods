...
.method public constructor <init>()V
    ...
    iput-wide v0, p0, mWillShowProgreeTime:J

    const-wide/16 v0, 0x1f4

    iput-wide v0, p0, mProgreeMinShowTime:J
...
.method static synthetic access$002(Lcom/oneplus/lib/util/loading/LoadingHelper;Ljava/lang/Runnable;)Ljava/lang/Runnable;
    ...
    iput-object p1, p0, mShowProgreeRunnable:Ljava/lang/Runnable;
...
.method static synthetic access$100(Lcom/oneplus/lib/util/loading/LoadingHelper;)Ljava/lang/Object;
    ...
    iget-object v0, p0, mProgreeView:Ljava/lang/Object;
...
.method static synthetic access$102(Lcom/oneplus/lib/util/loading/LoadingHelper;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iput-object p1, p0, mProgreeView:Ljava/lang/Object;
...
.method static synthetic access$202(Lcom/oneplus/lib/util/loading/LoadingHelper;J)J
    ...
    iput-wide p1, p0, mShowProgreeTime:J
...
.method static synthetic access$300(Lcom/oneplus/lib/util/loading/LoadingHelper;Lcom/oneplus/lib/util/loading/LoadingHelper$FinishShowCallback;Z)V
    ...
    invoke-direct {p0, p1, p2}, doFinish(Lcom/oneplus/lib/util/loading/LoadingHelper$FinishShowCallback;Z)V
...
.method private doFinish(Lcom/oneplus/lib/util/loading/LoadingHelper$FinishShowCallback;Z)V
    ...
    invoke-virtual {p0, v0}, hideProgree(Ljava/lang/Object;)V
...
.method public beginShowProgress()V
    ...
    iput-object v0, p0, mShowProgreeRunnable:Ljava/lang/Runnable;

    sget-object v0, mHandler:Landroid/os/Handler;

    iget-object v1, p0, mShowProgreeRunnable:Ljava/lang/Runnable;

    iget-wide v2, p0, mWillShowProgreeTime:J
...
.method public finishShowProgress(Lcom/oneplus/lib/util/loading/LoadingHelper$FinishShowCallback;)V
    ...
    iget-object v0, p0, mShowProgreeRunnable:Ljava/lang/Runnable;
    ...
    invoke-direct {p0, p1, v0}, doFinish(Lcom/oneplus/lib/util/loading/LoadingHelper$FinishShowCallback;Z)V
    ...
    iget-wide v2, p0, mShowProgreeTime:J

    sub-long/2addr v0, v2

    iget-wide v2, p0, mProgreeMinShowTime:J
    ...
    sget-object v4, mHandler:Landroid/os/Handler;
    ...
    invoke-direct {p0, p1, v4}, doFinish(Lcom/oneplus/lib/util/loading/LoadingHelper$FinishShowCallback;Z)V
...
.method public setProgreeMinShowTime(J)Lcom/oneplus/lib/util/loading/LoadingHelper;
    ...
    iput-wide p1, p0, mProgreeMinShowTime:J
...
.method public setWillShowProgreeTime(J)Lcom/oneplus/lib/util/loading/LoadingHelper;
    ...
    iput-wide p1, p0, mWillShowProgreeTime:J
