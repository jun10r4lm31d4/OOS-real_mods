...
.method static synthetic a(Lcom/oneplus/accountsdk/auth/d;)Lcom/oneplus/accountsdk/entity/AuthUserInfo;
    .locals 0

    iget-object p0, p0, a:Lcom/oneplus/accountsdk/entity/AuthUserInfo;

    return-object p0
.end method

.method static synthetic a(Lcom/oneplus/accountsdk/auth/d;Lcom/oneplus/accountsdk/entity/AuthUserInfo;)Lcom/oneplus/accountsdk/entity/AuthUserInfo;
    .locals 0

    iput-object p1, p0, a:Lcom/oneplus/accountsdk/entity/AuthUserInfo;

    return-object p1
.end method

.method static synthetic a(Lcom/oneplus/accountsdk/auth/d;Landroid/content/Context;Ljava/lang/String;Lcom/oneplus/accountsdk/auth/OPAuthListener;)V
    .locals 1

    invoke-static {}, Lcom/oneplus/accountsdk/b/a/b;->a()Lcom/oneplus/accountsdk/b/a/b;

    new-instance v0, Lcom/oneplus/accountsdk/auth/d$8;

    invoke-direct {v0, p0, p3, p1}, Lcom/oneplus/accountsdk/auth/d$8;-><init>(Lcom/oneplus/accountsdk/auth/d;Lcom/oneplus/accountsdk/auth/OPAuthListener;Landroid/content/Context;)V
...
.method static synthetic a(Lcom/oneplus/accountsdk/auth/d;Ljava/lang/String;Lcom/oneplus/accountsdk/auth/OPAuthListener;)V
    .locals 0

    invoke-direct {p0, p1, p2}, b(Ljava/lang/String;Lcom/oneplus/accountsdk/auth/OPAuthListener;)V

    return-void
.end method

.method static synthetic a(Lcom/oneplus/accountsdk/auth/d;Ljava/lang/String;Ljava/lang/String;Lcom/oneplus/accountsdk/auth/OPAuthListener;)V
    .locals 2

    invoke-static {}, Lcom/oneplus/accountsdk/b/a/b;->a()Lcom/oneplus/accountsdk/b/a/b;

    new-instance v0, Lcom/oneplus/accountsdk/auth/d$4;

    invoke-direct {v0, p0, p3}, Lcom/oneplus/accountsdk/auth/d$4;-><init>(Lcom/oneplus/accountsdk/auth/d;Lcom/oneplus/accountsdk/auth/OPAuthListener;)V

    const-string p0, "account.mob.modify.username"

    invoke-static {p0}, Lcom/oneplus/accountsdk/b/d/a;->a(Ljava/lang/String;)Lcom/oneplus/accountbase/network/params/PostFormRequsetParams$Builder;

    move-result-object p0

    sget-object p3, Lcom/oneplus/accountsdk/utils/OPAuthConstants;->ALITA_API_URL:Ljava/lang/String;

    invoke-virtual {p0, p3}, Lcom/oneplus/accountbase/network/params/PostFormRequsetParams$Builder;->url(Ljava/lang/String;)Lcom/oneplus/accountbase/network/params/PostFormRequsetParams$Builder;
...
.method static synthetic a(Ljava/lang/String;Lcom/oneplus/accountsdk/auth/OPAuthListener;)V
    .locals 1

    if-eqz p1, :cond_0

    new-instance v0, Lcom/oneplus/accountsdk/entity/ModifyUserNameInfo;

    invoke-direct {v0}, Lcom/oneplus/accountsdk/entity/ModifyUserNameInfo;-><init>()V

    iput-object p0, v0, Lcom/oneplus/accountsdk/entity/ModifyUserNameInfo;->resultCode:Ljava/lang/String;

    invoke-static {p0}, Lcom/oneplus/accountsdk/auth/e;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object p0

    iput-object p0, v0, Lcom/oneplus/accountsdk/entity/ModifyUserNameInfo;->resultMsg:Ljava/lang/String;
...
.method static synthetic b(Lcom/oneplus/accountsdk/auth/d;Landroid/content/Context;Ljava/lang/String;Lcom/oneplus/accountsdk/auth/OPAuthListener;)V
    .locals 1

    invoke-static {}, Lcom/oneplus/accountsdk/b/a/b;->a()Lcom/oneplus/accountsdk/b/a/b;

    new-instance v0, Lcom/oneplus/accountsdk/auth/d$7;

    invoke-direct {v0, p0, p3, p2, p1}, Lcom/oneplus/accountsdk/auth/d$7;-><init>(Lcom/oneplus/accountsdk/auth/d;Lcom/oneplus/accountsdk/auth/OPAuthListener;Ljava/lang/String;Landroid/content/Context;)V
...
.method private b(Ljava/lang/String;Lcom/oneplus/accountsdk/auth/OPAuthListener;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object v0, p0, a:Lcom/oneplus/accountsdk/entity/AuthUserInfo;

    iget-object v0, p0, a:Lcom/oneplus/accountsdk/entity/AuthUserInfo;
    ...
    iget-object p1, p0, a:Lcom/oneplus/accountsdk/entity/AuthUserInfo;
...
.method static synthetic c(Landroid/content/Context;)I
    ...
    invoke-static {p0}, e(Landroid/content/Context;)I
...
.method private static d(Ljava/lang/String;Lcom/oneplus/accountsdk/auth/OPAuthListener;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final a(Landroid/app/Activity;Lcom/oneplus/accountsdk/auth/OPAuthListener;)V
    ...
    invoke-static {v0}, e(Landroid/content/Context;)I
    ...
    invoke-static {p1, p2}, d(Ljava/lang/String;Lcom/oneplus/accountsdk/auth/OPAuthListener;)V
    ...
    invoke-virtual {p0, v0}, a(Landroid/content/Context;)Z
    ...
    new-instance v0, Lcom/oneplus/accountsdk/auth/d$6;

    invoke-direct {v0, p0, p2}, Lcom/oneplus/accountsdk/auth/d$6;-><init>(Lcom/oneplus/accountsdk/auth/d;Lcom/oneplus/accountsdk/auth/OPAuthListener;)V
...
.method public final a(Landroid/content/Context;Lcom/oneplus/accountsdk/auth/OPAuthInfo;Lcom/oneplus/accountsdk/auth/OPAuthListener;)V
    ...
    invoke-static {p1}, e(Landroid/content/Context;)I
    ...
    :goto_0
    invoke-direct {p0, p1, p3}, b(Ljava/lang/String;Lcom/oneplus/accountsdk/auth/OPAuthListener;)V
    ...
    :cond_1
    new-instance v0, Lcom/oneplus/accountsdk/auth/d$5;

    invoke-direct {v0, p0, p3, p1}, Lcom/oneplus/accountsdk/auth/d$5;-><init>(Lcom/oneplus/accountsdk/auth/d;Lcom/oneplus/accountsdk/auth/OPAuthListener;Landroid/content/Context;)V
...
.method public final a(Landroid/content/Context;Lcom/oneplus/accountsdk/auth/OPAuthListener;)V
    ...
    :cond_1
    invoke-virtual {p0, p1}, a(Landroid/content/Context;)Z

    move-result v0

    if-eqz v0, :cond_2

    new-instance v0, Lcom/oneplus/accountsdk/auth/d$1;

    invoke-direct {v0, p0, p1, p2}, Lcom/oneplus/accountsdk/auth/d$1;-><init>(Lcom/oneplus/accountsdk/auth/d;Landroid/content/Context;Lcom/oneplus/accountsdk/auth/OPAuthListener;)V
...
.method public final a(Landroid/content/Context;Ljava/lang/String;Lcom/oneplus/accountsdk/auth/OPAuthListener;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            ...
            "Ljava/lang/String;",
            "Lcom/oneplus/accountsdk/auth/OPAuthListener<",
            "Lcom/oneplus/accountsdk/entity/ModifyUserNameInfo;",
            ">;)V"
        }
    .end annotation
    ...
    new-instance v0, Lcom/oneplus/accountsdk/auth/d$3;

    invoke-direct {v0, p0, p2, p3}, Lcom/oneplus/accountsdk/auth/d$3;-><init>(Lcom/oneplus/accountsdk/auth/d;Ljava/lang/String;Lcom/oneplus/accountsdk/auth/OPAuthListener;)V
    ...
    const-string p2, "account not login, can not call this method"
...
.method public final a(Lcom/oneplus/accountsdk/auth/OPAuthInfo;Landroid/content/Context;Lcom/oneplus/accountsdk/auth/OPAuthListener;)V
    ...
    iput-object p3, p0, c:Lcom/oneplus/accountsdk/auth/OPAuthListener;
    ...
    :cond_0
    invoke-static {p2}, e(Landroid/content/Context;)I
    ...
    invoke-static {p1, p3}, c(Ljava/lang/String;Lcom/oneplus/accountsdk/auth/OPAuthListener;)V

    return-void

    :cond_1
    invoke-virtual {p0, p2}, a(Landroid/content/Context;)Z
...
.method public final a(Lcom/oneplus/accountsdk/auth/OPAuthListener;)V
    ...
    invoke-static {v0, p1}, d(Ljava/lang/String;Lcom/oneplus/accountsdk/auth/OPAuthListener;)V
...
.method public final a(Lcom/oneplus/accountsdk/entity/UserBindInfo;)V
    ...
    iget-object v0, p0, c:Lcom/oneplus/accountsdk/auth/OPAuthListener;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1}, Lcom/oneplus/accountsdk/auth/OPAuthListener;->onReqFinish(Ljava/lang/Object;)V

    iget-object p1, p0, c:Lcom/oneplus/accountsdk/auth/OPAuthListener;
...
.method public final a(Landroid/app/Activity;I[Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v1}, a(Landroid/content/Context;)Z
