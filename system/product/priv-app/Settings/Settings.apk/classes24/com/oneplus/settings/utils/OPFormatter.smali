...
.method static constructor <clinit>()V
    ...
    sput-object v0, SPACES_AND_CONTROLS:Landroid/icu/text/UnicodeSetSpanner;

    invoke-static {}, createPetaByte()Landroid/icu/util/MeasureUnit;

    move-result-object v0

    sput-object v0, PETABYTE:Landroid/icu/util/MeasureUnit;
...
.method static synthetic access$000()Landroid/icu/util/MeasureUnit;
    ...
    sget-object v0, PETABYTE:Landroid/icu/util/MeasureUnit;
...
.method private static bidiWrap(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0}, localeFromContext(Landroid/content/Context;)Ljava/util/Locale;
...
.method public static formatBytes(Landroid/content/res/Resources;JI)Lcom/oneplus/settings/utils/OPFormatter$BytesResult;
    ...
    invoke-static {v1, v2}, getNumberFormatter(Ljava/util/Locale;I)Landroid/icu/text/NumberFormat;
    ...
    sget-object v5, PETABYTE:Landroid/icu/util/MeasureUnit;
    ...
    invoke-static {v1, v2, v4, v5}, formatMeasureShort(Ljava/util/Locale;Landroid/icu/text/NumberFormat;FLandroid/icu/util/MeasureUnit;)Ljava/lang/String;

    move-result-object v4

    invoke-static {v4, v3}, deleteFirstFromString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v5

    sget-object v6, SPACES_AND_CONTROLS:Landroid/icu/text/UnicodeSetSpanner;
    ...
    invoke-static {p0, v4}, getSuffixOverride(Landroid/content/res/Resources;Landroid/icu/util/MeasureUnit;)Ljava/lang/String;
...
.method public static formatFileSize(Landroid/content/Context;J)Ljava/lang/String;
    ...
    invoke-static {p0, p1, p2, v0}, formatFileSize(Landroid/content/Context;JI)Ljava/lang/String;
...
.method private static formatFileSize(Landroid/content/Context;JI)Ljava/lang/String;
    ...
    invoke-static {p0, v0}, formatRoundedBytesResult(Landroid/content/Context;Lcom/oneplus/settings/utils/OPFormatter$RoundedBytesResult;)Ljava/lang/String;
...
.method private static formatRoundedBytesResult(Landroid/content/Context;Lcom/oneplus/settings/utils/OPFormatter$RoundedBytesResult;)Ljava/lang/String;
    ...
    invoke-static {v0, v1}, getNumberFormatter(Ljava/util/Locale;I)Landroid/icu/text/NumberFormat;
    ...
    sget-object v3, PETABYTE:Landroid/icu/util/MeasureUnit;
    ...
    invoke-static {v0, v1, v2, v3}, formatMeasureShort(Ljava/util/Locale;Landroid/icu/text/NumberFormat;FLandroid/icu/util/MeasureUnit;)Ljava/lang/String;
    ...
    invoke-static {v6, v7}, getSuffixOverride(Landroid/content/res/Resources;Landroid/icu/util/MeasureUnit;)Ljava/lang/String;
...
.method public static formatShortElapsedTimeRoundingUpToMinutes(Landroid/content/Context;J)Ljava/lang/String;
    ...
    invoke-static {p0, v0, v1}, formatShortElapsedTime(Landroid/content/Context;J)Ljava/lang/String;
