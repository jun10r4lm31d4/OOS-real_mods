...
.method public constructor <init>()V
    ...
    :try_start_0
    invoke-virtual {p0}, obtainFontFamily()Ljava/lang/Class;

    move-result-object v0

    invoke-virtual {p0, v0}, obtainFontFamilyCtor(Ljava/lang/Class;)Ljava/lang/reflect/Constructor;

    move-result-object v1

    invoke-virtual {p0, v0}, obtainAddFontFromAssetManagerMethod(Ljava/lang/Class;)Ljava/lang/reflect/Method;

    move-result-object v2

    invoke-virtual {p0, v0}, obtainAddFontFromBufferMethod(Ljava/lang/Class;)Ljava/lang/reflect/Method;

    move-result-object v3

    invoke-virtual {p0, v0}, obtainFreezeMethod(Ljava/lang/Class;)Ljava/lang/reflect/Method;

    move-result-object v4

    invoke-virtual {p0, v0}, obtainAbortCreationMethod(Ljava/lang/Class;)Ljava/lang/reflect/Method;

    move-result-object v5

    invoke-virtual {p0, v0}, obtainCreateFromFamiliesWithDefaultMethod(Ljava/lang/Class;)Ljava/lang/reflect/Method;
    ...
    :goto_0
    iput-object v0, p0, mFontFamily:Ljava/lang/Class;

    iput-object v1, p0, mFontFamilyCtor:Ljava/lang/reflect/Constructor;

    iput-object v2, p0, mAddFontFromAssetManager:Ljava/lang/reflect/Method;

    iput-object v3, p0, mAddFontFromBuffer:Ljava/lang/reflect/Method;

    iput-object v4, p0, mFreeze:Ljava/lang/reflect/Method;

    iput-object v5, p0, mAbortCreation:Ljava/lang/reflect/Method;

    iput-object v6, p0, mCreateFromFamiliesWithDefault:Ljava/lang/reflect/Method;
...
.method private abortCreation(Ljava/lang/Object;)V
    ...
    :try_start_0
    iget-object v0, p0, mAbortCreation:Ljava/lang/reflect/Method;
...
.method private addFontFromAssetManager(Landroid/content/Context;Ljava/lang/Object;Ljava/lang/String;III[Landroid/graphics/fonts/FontVariationAxis;)Z
    ...
    :try_start_0
    iget-object v0, p0, mAddFontFromAssetManager:Ljava/lang/reflect/Method;
...
.method private addFontFromBuffer(Ljava/lang/Object;Ljava/nio/ByteBuffer;III)Z
    ...
    :try_start_0
    iget-object v0, p0, mAddFontFromBuffer:Ljava/lang/reflect/Method;
...
.method private freeze(Ljava/lang/Object;)Z
    ...
    :try_start_0
    iget-object v0, p0, mFreeze:Ljava/lang/reflect/Method;
...
.method private newFamily()Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v0, p0, mFontFamilyCtor:Ljava/lang/reflect/Constructor;
...
.method protected createFromFamiliesWithDefault(Ljava/lang/Object;)Landroid/graphics/Typeface;
    ...
    :try_start_0
    iget-object v0, p0, mFontFamily:Ljava/lang/Class;
    ...
    iget-object v3, p0, mCreateFromFamiliesWithDefault:Ljava/lang/reflect/Method;
...
.method public createFromFontFamilyFilesResourceEntry(Landroid/content/Context;Lcom/oneplus/support/core/content/res/FontResourcesParserCompat$FontFamilyFilesResourceEntry;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    invoke-direct {p0}, isFontFamilyPrivateAPIAvailable()Z
    ...
    :cond_0
    invoke-direct {p0}, newFamily()Ljava/lang/Object;
    ...
    invoke-direct/range {v0 .. v7}, addFontFromAssetManager(Landroid/content/Context;Ljava/lang/Object;Ljava/lang/String;III[Landroid/graphics/fonts/FontVariationAxis;)Z

    move-result v0

    if-nez v0, :cond_1

    invoke-direct {p0, v9}, abortCreation(Ljava/lang/Object;)V
    ...
    :cond_2
    invoke-direct {p0, v9}, freeze(Ljava/lang/Object;)Z
    ...
    :cond_3
    invoke-virtual {p0, v9}, createFromFamiliesWithDefault(Ljava/lang/Object;)Landroid/graphics/Typeface;
...
.method public createFromFontInfo(Landroid/content/Context;Landroid/os/CancellationSignal;[Lcom/oneplus/support/core/provider/FontsContractCompat$FontInfo;I)Landroid/graphics/Typeface;
    ...
    :cond_0
    invoke-direct/range {p0 .. p0}, isFontFamilyPrivateAPIAvailable()Z

    move-result v0

    if-nez v0, :cond_3

    invoke-virtual {v7, v9, v10}, findBestInfo([Lcom/oneplus/support/core/provider/FontsContractCompat$FontInfo;I)Lcom/oneplus/support/core/provider/FontsContractCompat$FontInfo;
    ...
    invoke-direct/range {p0 .. p0}, newFamily()Ljava/lang/Object;
    ...
    invoke-direct/range {v1 .. v6}, addFontFromBuffer(Ljava/lang/Object;Ljava/nio/ByteBuffer;III)Z

    move-result v1

    if-nez v1, :cond_5

    invoke-direct {v7, v13}, abortCreation(Ljava/lang/Object;)V
    ...
    :cond_7
    invoke-direct {v7, v13}, freeze(Ljava/lang/Object;)Z
    ...
    :cond_8
    invoke-virtual {v7, v13}, createFromFamiliesWithDefault(Ljava/lang/Object;)Landroid/graphics/Typeface;
...
.method public createFromResourcesFontFile(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;I)Landroid/graphics/Typeface;
    ...
    invoke-direct/range {v1 .. v8}, addFontFromAssetManager(Landroid/content/Context;Ljava/lang/Object;Ljava/lang/String;III[Landroid/graphics/fonts/FontVariationAxis;)Z
    ...
    invoke-direct {p0, v0}, abortCreation(Ljava/lang/Object;)V

    return-object v2

    :cond_1
    invoke-direct {p0, v0}, freeze(Ljava/lang/Object;)Z
    ...
    :cond_2
    invoke-virtual {p0, v0}, createFromFamiliesWithDefault(Ljava/lang/Object;)Landroid/graphics/Typeface;
