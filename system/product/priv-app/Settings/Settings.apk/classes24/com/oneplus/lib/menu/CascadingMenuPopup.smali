...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;IIZ)V
    ...
    iput-object v0, p0, mPendingMenus:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, mShowingMenus:Ljava/util/List;
    ...
    iput-object v0, p0, mGlobalLayoutListener:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
    ...
    iput-object v0, p0, mAttachStateChangeListener:Landroid/view/View$OnAttachStateChangeListener;
    ...
    iput-object v0, p0, mMenuItemHoverListener:Lcom/oneplus/lib/menu/MenuItemHoverListener;

    const/4 v0, 0x0

    iput v0, p0, mRawDropDownGravity:I

    iput v0, p0, mDropDownGravity:I

    iput-object p1, p0, mContext:Landroid/content/Context;

    iput-object p2, p0, mAnchorView:Landroid/view/View;

    iput p3, p0, mPopupStyleAttr:I

    iput p4, p0, mPopupStyleRes:I

    iput-boolean p5, p0, mOverflowOnly:Z

    iput-boolean v0, p0, mForceShowIcon:Z

    invoke-direct {p0}, getInitialMenuPosition()I

    move-result v0

    iput v0, p0, mLastPosition:I
    ...
    iput v1, p0, mMenuMaxWidth:I

    new-instance v1, Landroid/os/Handler;

    invoke-direct {v1}, Landroid/os/Handler;-><init>()V

    iput-object v1, p0, mSubMenuHoverHandler:Landroid/os/Handler;
...
.method static synthetic access$002(Lcom/oneplus/lib/menu/CascadingMenuPopup;Landroid/view/ViewTreeObserver;)Landroid/view/ViewTreeObserver;
    ...
    iput-object p1, p0, mTreeObserver:Landroid/view/ViewTreeObserver;
...
.method static synthetic access$100(Lcom/oneplus/lib/menu/CascadingMenuPopup;)Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
    ...
    iget-object v0, p0, mGlobalLayoutListener:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
...
.method private createPopupWindow()Lcom/oneplus/lib/menu/MenuPopupWindow;
    ...
    iget v2, p0, mPopupStyleAttr:I

    iget v3, p0, mPopupStyleRes:I
    ...
    iget-object v1, p0, mMenuItemHoverListener:Lcom/oneplus/lib/menu/MenuItemHoverListener;
...
.method private findIndexOfAddedMenu(Lcom/oneplus/lib/menu/MenuBuilder;)I
    ...
    iget-object v1, p0, mShowingMenus:Ljava/util/List;
    ...
    iget-object v2, p0, mShowingMenus:Ljava/util/List;
...
.method private findParentViewForSubmenu(Lcom/oneplus/lib/menu/CascadingMenuPopup$CascadingMenuInfo;Lcom/oneplus/lib/menu/MenuBuilder;)Landroid/view/View;
    ...
    invoke-direct {p0, v0, p2}, findMenuItemForSubmenu(Lcom/oneplus/lib/menu/MenuBuilder;Lcom/oneplus/lib/menu/MenuBuilder;)Landroid/view/MenuItem;
...
.method private getNextMenuPosition(I)I
    ...
    iget-object v0, p0, mShowingMenus:Ljava/util/List;
    ...
    iget-object v4, p0, mShownAnchorView:Landroid/view/View;

    invoke-virtual {v4, v3}, Landroid/view/View;->getWindowVisibleDisplayFrame(Landroid/graphics/Rect;)V

    iget v4, p0, mLastPosition:I
...
.method private showMenu(Lcom/oneplus/lib/menu/MenuBuilder;)V
    ...
    iget-boolean v4, v0, mOverflowOnly:Z
    ...
    iget-boolean v4, v0, mForceShowIcon:Z
    ...
    iget v6, v0, mMenuMaxWidth:I

    const/4 v7, 0x0

    invoke-static {v3, v7, v4, v6}, measureIndividualMenuWidth(Landroid/widget/ListAdapter;Landroid/view/ViewGroup;Landroid/content/Context;I)I

    move-result v4

    invoke-direct/range {p0 .. p0}, createPopupWindow()Lcom/oneplus/lib/menu/MenuPopupWindow;
    ...
    invoke-direct {v0, v8, v1}, findParentViewForSubmenu(Lcom/oneplus/lib/menu/CascadingMenuPopup$CascadingMenuInfo;Lcom/oneplus/lib/menu/MenuBuilder;)Landroid/view/View;
    ...
    invoke-direct {v0, v4}, getNextMenuPosition(I)I
    ...
    :goto_3
    iget v13, v0, mDropDownGravity:I
    ...
    :cond_8
    iget-boolean v5, v0, mHasXOffset:Z

    if-eqz v5, :cond_9

    iget v5, v0, mXOffset:I

    invoke-virtual {v6, v5}, Lcom/oneplus/lib/menu/MenuPopupWindow;->setHorizontalOffset(I)V

    :cond_9
    iget-boolean v5, v0, mHasYOffset:Z

    if-eqz v5, :cond_a

    iget v5, v0, mYOffset:I

    invoke-virtual {v6, v5}, Lcom/oneplus/lib/menu/MenuPopupWindow;->setVerticalOffset(I)V

    :cond_a
    invoke-virtual/range {p0 .. p0}, getEpicenterBounds()Landroid/graphics/Rect;
    ...
    iget-object v7, v0, mShowingMenus:Ljava/util/List;
    ...
    iget-boolean v11, v0, mShowTitle:Z
...
.method public addMenu(Lcom/oneplus/lib/menu/MenuBuilder;)V
    ...
    invoke-direct {p0, p1}, showMenu(Lcom/oneplus/lib/menu/MenuBuilder;)V

    goto :goto_0

    :cond_0
    iget-object v0, p0, mPendingMenus:Ljava/util/List;
...
.method public onCloseMenu(Lcom/oneplus/lib/menu/MenuBuilder;Z)V
    ...
    invoke-direct {p0, p1}, findIndexOfAddedMenu(Lcom/oneplus/lib/menu/MenuBuilder;)I
    ...
    iget-boolean v4, p0, mShouldCloseImmediately:Z
    ...
    iget-object v4, p0, mShowingMenus:Ljava/util/List;
    ...
    iget-object v6, p0, mShowingMenus:Ljava/util/List;
    ...
    iget-object v3, p0, mPresenterCallback:Lcom/oneplus/lib/menu/MenuPresenter$Callback;
    ...
    :cond_4
    iget-object v3, p0, mTreeObserver:Landroid/view/ViewTreeObserver;
    ...
    iget-object v6, p0, mGlobalLayoutListener:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
    ...
    :cond_6
    iget-object v3, p0, mShownAnchorView:Landroid/view/View;

    iget-object v5, p0, mAttachStateChangeListener:Landroid/view/View$OnAttachStateChangeListener;
    ...
    iget-object v3, p0, mOnDismissListener:Landroid/widget/PopupWindow$OnDismissListener;
    ...
    iget-object v5, p0, mShowingMenus:Ljava/util/List;
...
.method public onDismiss()V
    ...
    iget-object v3, p0, mShowingMenus:Ljava/util/List;
...
.method public onSubMenuSelected(Lcom/oneplus/lib/menu/SubMenuBuilder;)Z
    ...
    invoke-virtual {p0, p1}, addMenu(Lcom/oneplus/lib/menu/MenuBuilder;)V

    iget-object v0, p0, mPresenterCallback:Lcom/oneplus/lib/menu/MenuPresenter$Callback;
...
.method public setAnchorView(Landroid/view/View;)V
    ...
    iget v0, p0, mRawDropDownGravity:I
...
.method public setCallback(Lcom/oneplus/lib/menu/MenuPresenter$Callback;)V
    ...
    iput-object p1, p0, mPresenterCallback:Lcom/oneplus/lib/menu/MenuPresenter$Callback;
...
.method public setGravity(I)V
    ...
    iput p1, p0, mRawDropDownGravity:I
...
.method public setHorizontalOffset(I)V
    ...
    iput-boolean v0, p0, mHasXOffset:Z
...
.method public setShowTitle(Z)V
    ...
    iput-boolean p1, p0, mShowTitle:Z
...
.method public setVerticalOffset(I)V
    ...
    iput-boolean v0, p0, mHasYOffset:Z

    iput p1, p0, mYOffset:I
...
.method public show()V
    ...
    invoke-direct {p0, v1}, showMenu(Lcom/oneplus/lib/menu/MenuBuilder;)V
    ...
    iput-object v0, p0, mShownAnchorView:Landroid/view/View;

    iget-object v0, p0, mShownAnchorView:Landroid/view/View;
    ...
    :goto_1
    iget-object v1, p0, mShownAnchorView:Landroid/view/View;
    ...
    iget-object v1, p0, mTreeObserver:Landroid/view/ViewTreeObserver;

    iget-object v2, p0, mGlobalLayoutListener:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
...
.method public updateMenuView(Z)V
    ...
    invoke-static {v2}, toMenuAdapter(Landroid/widget/ListAdapter;)Lcom/oneplus/lib/menu/MenuAdapter;
