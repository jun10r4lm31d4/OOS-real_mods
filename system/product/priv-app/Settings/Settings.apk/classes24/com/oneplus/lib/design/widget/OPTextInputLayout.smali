...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, mCollapsingTextHelper:Lcom/oneplus/lib/design/widget/CollapsingTextHelper;
    ...
    invoke-virtual {p0, v0}, setAddStatesFromChildren(Z)V

    new-instance v2, Landroid/widget/FrameLayout;

    invoke-direct {v2, p1}, Landroid/widget/FrameLayout;-><init>(Landroid/content/Context;)V

    iput-object v2, p0, mInputFrame:Landroid/widget/FrameLayout;
    ...
    iget-object v2, p0, mCollapsingTextHelper:Lcom/oneplus/lib/design/widget/CollapsingTextHelper;
    ...
    iput-boolean v3, p0, mHintEnabled:Z
    ...
    invoke-virtual {p0, v3}, setHint(Ljava/lang/CharSequence;)V
    ...
    iput-boolean v3, p0, mHintAnimationEnabled:Z
    ...
    iput-object v3, p0, mFocusedTextColor:Landroid/content/res/ColorStateList;

    iput-object v3, p0, mDefaultTextColor:Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p0, v4}, setHintTextAppearance(I)V
    ...
    iput v4, p0, mErrorTextAppearance:I
    ...
    invoke-virtual {p0, v6}, setCounterMaxLength(I)V
    ...
    iput v6, p0, mCounterTextAppearance:I
    ...
    iput v6, p0, mCounterOverflowTextAppearance:I
    ...
    iput-boolean v1, p0, mPasswordToggleEnabled:Z
    ...
    iput-object v1, p0, mPasswordToggleDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v1, p0, mPasswordToggleContentDesc:Ljava/lang/CharSequence;
    ...
    iput-boolean v0, p0, mHasPasswordToggleTintList:Z
    ...
    iput-object v1, p0, mPasswordToggleTintList:Landroid/content/res/ColorStateList;
    ...
    iput-boolean v0, p0, mHasPasswordToggleTintMode:Z
    ...
    iput-object v1, p0, mPasswordToggleTintMode:Landroid/graphics/PorterDuff$Mode;

    :cond_3
    invoke-virtual {v2}, Landroid/content/res/TypedArray;->recycle()V

    invoke-virtual {p0, v4}, setErrorEnabled(Z)V

    invoke-virtual {p0, v5}, setCounterEnabled(Z)V

    invoke-direct {p0}, applyPasswordToggleTint()V
...
.method static synthetic access$000(Lcom/oneplus/lib/design/widget/OPTextInputLayout;)Z
    ...
    iget-boolean v0, p0, mRestoringSavedState:Z
...
.method private addIndicator(Landroid/widget/TextView;I)V
    ...
    iget-object v0, p0, mIndicatorArea:Landroid/widget/LinearLayout;
    ...
    iput-object v0, p0, mIndicatorArea:Landroid/widget/LinearLayout;
    ...
    invoke-virtual {p0, v0, v2, v3}, addView(Landroid/view/View;II)V
    ...
    iget-object v3, p0, mIndicatorArea:Landroid/widget/LinearLayout;

    invoke-virtual {v3, v0, v2}, Landroid/widget/LinearLayout;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    iget-object v3, p0, mEditText:Landroid/widget/EditText;

    if-eqz v3, :cond_0

    invoke-direct {p0}, adjustIndicatorPadding()V
    ...
    iget v0, p0, mIndicatorsAdded:I

    add-int/lit8 v0, v0, 0x1

    iput v0, p0, mIndicatorsAdded:I
...
.method private applyPasswordToggleTint()V
    ...
    iget-object v0, p0, mPasswordToggleDrawable:Landroid/graphics/drawable/Drawable;

    if-eqz v0, :cond_3

    iget-boolean v0, p0, mHasPasswordToggleTintList:Z

    if-nez v0, :cond_0

    iget-boolean v0, p0, mHasPasswordToggleTintMode:Z
    ...
    iput-object v0, p0, mPasswordToggleDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, p0, mPasswordToggleTintList:Landroid/content/res/ColorStateList;
    ...
    iget-object v1, p0, mPasswordToggleTintMode:Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_2
    iget-object v0, p0, mPasswordToggleView:Lcom/oneplus/lib/design/widget/OPCheckableImageButton;
    ...
    iget-object v1, p0, mPasswordToggleDrawable:Landroid/graphics/drawable/Drawable;
...
.method private collapseHint(Z)V
    ...
    iget-object v0, p0, mAnimator:Landroid/animation/ValueAnimator;
    ...
    iget-boolean v1, p0, mHintAnimationEnabled:Z

    if-eqz v1, :cond_1

    invoke-virtual {p0, v0}, animateToExpansionFraction(F)V

    goto :goto_0

    :cond_1
    iget-object v1, p0, mCollapsingTextHelper:Lcom/oneplus/lib/design/widget/CollapsingTextHelper;
    ...
    iput-boolean v0, p0, mHintExpanded:Z
...
.method private ensureBackgroundDrawableStateWorkaround()V
    ...
    :cond_1
    iget-boolean v2, p0, mHasReconstructedEditTextBackground:Z
    ...
    iput-boolean v3, p0, mHasReconstructedEditTextBackground:Z

    :cond_2
    iget-boolean v3, p0, mHasReconstructedEditTextBackground:Z
...
.method private static recursiveSetEnabled(Landroid/view/ViewGroup;Z)V
    ...
    invoke-static {v3, p1}, recursiveSetEnabled(Landroid/view/ViewGroup;Z)V
...
.method private setEditText(Landroid/widget/EditText;)V
    ...
    :cond_0
    iput-object p1, p0, mEditText:Landroid/widget/EditText;
    ...
    invoke-direct {p0}, hasPasswordTransformation()Z
    ...
    iget-object v2, p0, mDefaultTextColor:Landroid/content/res/ColorStateList;
    ...
    iput-object v2, p0, mDefaultTextColor:Landroid/content/res/ColorStateList;

    :cond_2
    iget-boolean v2, p0, mHintEnabled:Z
    ...
    iput-object v2, p0, mOriginalHint:Ljava/lang/CharSequence;

    iget-object v2, p0, mOriginalHint:Ljava/lang/CharSequence;

    invoke-virtual {p0, v2}, setHint(Ljava/lang/CharSequence;)V
    ...
    :cond_3
    iget-object v2, p0, mCounterView:Landroid/widget/TextView;
    ...
    invoke-virtual {p0, v2}, updateCounter(I)V

    :cond_4
    iget-object v2, p0, mIndicatorArea:Landroid/widget/LinearLayout;
    ...
    :cond_5
    invoke-direct {p0}, updatePasswordToggleView()V

    const/4 v2, 0x0

    const/4 v3, 0x1

    invoke-virtual {p0, v2, v3}, updateLabelState(ZZ)V
...
.method private setError(Ljava/lang/CharSequence;ZZ)V
    ...
    iget-boolean v0, p0, mErrorEnabled:Z
    ...
    :cond_0
    invoke-virtual {p0, v1}, setErrorEnabled(Z)V
    ...
    iput-boolean v0, p0, mErrorShown:Z

    iget-object v0, p0, mErrorView:Landroid/widget/TextView;
    ...
    iget-boolean v0, p0, mErrorShown:Z
    ...
    iget-object v4, p0, mErrorView:Landroid/widget/TextView;
    ...
    :cond_3
    iget-object v3, p0, mErrorView:Landroid/widget/TextView;
    ...
    :cond_4
    iget-object v1, p0, mErrorView:Landroid/widget/TextView;
    ...
    :cond_7
    :goto_0
    invoke-direct {p0}, updateEditTextBackground()V

    invoke-virtual {p0, p2}, updateLabelState(Z)V
...
.method private setHintInternal(Ljava/lang/CharSequence;)V
    ...
    iput-object p1, p0, mHint:Ljava/lang/CharSequence;

    iget-object v0, p0, mCollapsingTextHelper:Lcom/oneplus/lib/design/widget/CollapsingTextHelper;
...
.method private shouldShowPasswordIcon()Z
    ...
    iget-boolean v0, p0, mPasswordToggleEnabled:Z
    ...
    iget-boolean v0, p0, mPasswordToggledVisible:Z
...
.method private updateEditTextBackground()V
    ...
    :cond_1
    invoke-direct {p0}, ensureBackgroundDrawableStateWorkaround()V
    ...
    :cond_2
    iget-boolean v1, p0, mErrorShown:Z
    ...
    :cond_3
    iget-boolean v1, p0, mCounterOverflowed:Z

    if-eqz v1, :cond_4

    iget-object v1, p0, mCounterView:Landroid/widget/TextView;
...
.method private updateInputLayoutMargins()V
    ...
    iget-boolean v1, p0, mHintEnabled:Z

    if-eqz v1, :cond_1

    iget-object v1, p0, mTmpPaint:Landroid/graphics/Paint;
    ...
    iput-object v1, p0, mTmpPaint:Landroid/graphics/Paint;
...
.method private updatePasswordToggleView()V
    ...
    :cond_0
    invoke-direct {p0}, shouldShowPasswordIcon()Z
    ...
    iget-object v6, p0, mInputFrame:Landroid/widget/FrameLayout;
    ...
    iput-object v0, p0, mPasswordToggleView:Lcom/oneplus/lib/design/widget/OPCheckableImageButton;

    iget-object v0, p0, mPasswordToggleView:Lcom/oneplus/lib/design/widget/OPCheckableImageButton;

    iget-object v5, p0, mPasswordToggleDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v5, p0, mPasswordToggleContentDesc:Ljava/lang/CharSequence;
    ...
    iget-object v5, p0, mPasswordToggleView:Lcom/oneplus/lib/design/widget/OPCheckableImageButton;
    ...
    iget-boolean v5, p0, mPasswordToggledVisible:Z

    invoke-virtual {v0, v5}, Lcom/oneplus/lib/design/widget/OPCheckableImageButton;->setChecked(Z)V

    iget-object v0, p0, mPasswordToggleDummyDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, mPasswordToggleDummyDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v6, p0, mPasswordToggleDummyDrawable:Landroid/graphics/drawable/Drawable;

    if-eq v5, v6, :cond_4

    aget-object v3, v0, v3

    iput-object v3, p0, mOriginalEditTextEndDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v5, p0, mPasswordToggleDummyDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, p0, mPasswordToggleView:Lcom/oneplus/lib/design/widget/OPCheckableImageButton;
    ...
    iget-object v4, p0, mEditText:Landroid/widget/EditText;

    invoke-virtual {v4}, Landroid/widget/EditText;->getPaddingRight()I

    move-result v4

    iget-object v5, p0, mEditText:Landroid/widget/EditText;
    ...
    iget-object v5, p0, mOriginalEditTextEndDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v1, p0, mPasswordToggleDummyDrawable:Landroid/graphics/drawable/Drawable;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    iget-object v1, p0, mInputFrame:Landroid/widget/FrameLayout;
    ...
    invoke-direct {p0}, updateInputLayoutMargins()V

    move-object v1, p1

    check-cast v1, Landroid/widget/EditText;

    invoke-direct {p0, v1}, setEditText(Landroid/widget/EditText;)V
...
.method animateToExpansionFraction(F)V
    ...
    iput-object v0, p0, mAnimator:Landroid/animation/ValueAnimator;
    ...
    iget-object v3, p0, mCollapsingTextHelper:Lcom/oneplus/lib/design/widget/CollapsingTextHelper;
...
.method public dispatchProvideAutofillStructure(Landroid/view/ViewStructure;I)V
    ...
    iget-object v0, p0, mOriginalHint:Ljava/lang/CharSequence;
...
.method protected dispatchRestoreInstanceState(Landroid/util/SparseArray;)V
    ...
    iput-boolean v0, p0, mRestoringSavedState:Z
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v0, p0, mHintEnabled:Z
...
.method protected drawableStateChanged()V
    ...
    iget-boolean v0, p0, mInDrawableStateChanged:Z
    ...
    iput-boolean v0, p0, mInDrawableStateChanged:Z
    ...
    :goto_0
    invoke-virtual {p0, v0}, updateLabelState(Z)V
    ...
    :cond_3
    iput-boolean v4, p0, mInDrawableStateChanged:Z
...
.method public getCounterMaxLength()I
    ...
    iget v0, p0, mCounterMaxLength:I
...
.method public getPasswordVisibilityToggleContentDescription()Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, mPasswordToggleContentDesc:Ljava/lang/CharSequence;
...
.method public getTypeface()Landroid/graphics/Typeface;
    ...
    iget-object v0, p0, mTypeface:Landroid/graphics/Typeface;
...
.method public isCounterEnabled()Z
    ...
    iget-boolean v0, p0, mCounterEnabled:Z
...
.method public isHintAnimationEnabled()Z
    ...
    iget-boolean v0, p0, mHintAnimationEnabled:Z
...
.method final isHintExpanded()Z
    ...
    iget-boolean v0, p0, mHintExpanded:Z
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v6, p0, mEditText:Landroid/widget/EditText;
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {p0, v1}, setError(Ljava/lang/CharSequence;)V
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iget-boolean v2, p0, mErrorShown:Z
...
.method passwordVisibilityToggleRequested()V
    ...
    iput-boolean v1, p0, mPasswordToggledVisible:Z
    ...
    iget-boolean v2, p0, mPasswordToggledVisible:Z
...
.method public setCounterEnabled(Z)V
    ...
    iput-object v0, p0, mCounterView:Landroid/widget/TextView;

    iget-object v0, p0, mCounterView:Landroid/widget/TextView;
    ...
    iget v1, p0, mCounterTextAppearance:I
    ...
    invoke-direct {p0, v0, v1}, addIndicator(Landroid/widget/TextView;I)V
    ...
    invoke-virtual {p0, v0}, updateCounter(I)V
    ...
    invoke-direct {p0, v0}, removeIndicator(Landroid/widget/TextView;)V
    ...
    :goto_1
    iput-boolean p1, p0, mCounterEnabled:Z
...
.method public setCounterMaxLength(I)V
    ...
    iput p1, p0, mCounterMaxLength:I
    ...
    iput v0, p0, mCounterMaxLength:I
...
.method public setEnabled(Z)V
    ...
    invoke-static {p0, p1}, recursiveSetEnabled(Landroid/view/ViewGroup;Z)V
...
.method public setError(Ljava/lang/CharSequence;)V
    ...
    :goto_0
    invoke-direct {p0, p1, v0, v1}, setError(Ljava/lang/CharSequence;ZZ)V
...
.method public setErrorEnabled(Z)V
    ...
    iput-object v1, p0, mErrorView:Landroid/widget/TextView;
    ...
    iget-object v1, p0, mTypeface:Landroid/graphics/Typeface;

    if-eqz v1, :cond_1

    iget-object v2, p0, mErrorView:Landroid/widget/TextView;
    ...
    iget v3, p0, mErrorTextAppearance:I
    ...
    invoke-direct {p0, v2, v0}, addIndicator(Landroid/widget/TextView;I)V
    ...
    iput-object v0, p0, mErrorView:Landroid/widget/TextView;

    :goto_1
    iput-boolean p1, p0, mErrorEnabled:Z
...
.method public setErrorTextAppearance(I)V
    ...
    iput p1, p0, mErrorTextAppearance:I
...
.method public setHint(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {p0, p1}, setHintInternal(Ljava/lang/CharSequence;)V
...
.method public setHintAnimationEnabled(Z)V
    ...
    iput-boolean p1, p0, mHintAnimationEnabled:Z
...
.method public setHintEnabled(Z)V
    ...
    iput-boolean p1, p0, mHintEnabled:Z
    ...
    iget-object v3, p0, mHint:Ljava/lang/CharSequence;

    invoke-virtual {v1, v3}, Landroid/widget/EditText;->setHint(Ljava/lang/CharSequence;)V

    :cond_0
    invoke-direct {p0, v2}, setHintInternal(Ljava/lang/CharSequence;)V
...
.method public setHintTextAppearance(I)V
    ...
    iput-object v0, p0, mFocusedTextColor:Landroid/content/res/ColorStateList;
...
.method public setPasswordVisibilityToggleContentDescription(I)V
    ...
    :goto_0
    invoke-virtual {p0, v0}, setPasswordVisibilityToggleContentDescription(Ljava/lang/CharSequence;)V
...
.method public setPasswordVisibilityToggleContentDescription(Ljava/lang/CharSequence;)V
    ...
    iput-object p1, p0, mPasswordToggleContentDesc:Ljava/lang/CharSequence;
...
.method public setPasswordVisibilityToggleDrawable(I)V
    ...
    :goto_0
    invoke-virtual {p0, v0}, setPasswordVisibilityToggleDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method public setPasswordVisibilityToggleDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object p1, p0, mPasswordToggleDrawable:Landroid/graphics/drawable/Drawable;
...
.method public setPasswordVisibilityToggleEnabled(Z)V
    ...
    iput-boolean p1, p0, mPasswordToggleEnabled:Z
    ...
    iput-boolean v0, p0, mPasswordToggledVisible:Z
...
.method public setPasswordVisibilityToggleTintList(Landroid/content/res/ColorStateList;)V
    ...
    iput-object p1, p0, mPasswordToggleTintList:Landroid/content/res/ColorStateList;
...
.method public setPasswordVisibilityToggleTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iput-object p1, p0, mPasswordToggleTintMode:Landroid/graphics/PorterDuff$Mode;
...
.method public setTypeface(Landroid/graphics/Typeface;)V
    ...
    :cond_1
    iput-object p1, p0, mTypeface:Landroid/graphics/Typeface;
...
.method updateCounter(I)V
    ...
    iget-boolean v0, p0, mCounterOverflowed:Z

    iget v1, p0, mCounterMaxLength:I
    ...
    iput-boolean v2, p0, mCounterOverflowed:Z
    ...
    :goto_0
    iput-boolean v1, p0, mCounterOverflowed:Z

    iget-boolean v1, p0, mCounterOverflowed:Z

    if-eq v0, v1, :cond_3

    iget-object v4, p0, mCounterView:Landroid/widget/TextView;

    if-eqz v1, :cond_2

    iget v1, p0, mCounterOverflowTextAppearance:I
    ...
    iget v7, p0, mCounterMaxLength:I
    ...
    invoke-virtual {p0, v2}, updateLabelState(Z)V
...
.method updateLabelState(Z)V
    ...
    invoke-virtual {p0, p1, v0}, updateLabelState(ZZ)V
...
.method updateLabelState(ZZ)V
    ...
    invoke-static {v3, v4}, arrayContains([II)Z
    ...
    iget-object v4, p0, mDefaultTextColor:Landroid/content/res/ColorStateList;

    if-eqz v4, :cond_1

    iget-object v5, p0, mCollapsingTextHelper:Lcom/oneplus/lib/design/widget/CollapsingTextHelper;
    ...
    iget-boolean v4, p0, mCounterOverflowed:Z
    ...
    iget-object v4, p0, mFocusedTextColor:Landroid/content/res/ColorStateList;
    ...
    iget-boolean v4, p0, mHintExpanded:Z

    if-nez v4, :cond_9

    :cond_6
    invoke-direct {p0, p1}, expandHint(Z)V
    ...
    :cond_8
    invoke-direct {p0, p1}, collapseHint(Z)V
