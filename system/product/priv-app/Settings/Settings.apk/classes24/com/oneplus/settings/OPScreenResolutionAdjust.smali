...
.method static constructor <clinit>()V
    ...
    sput-object v0, DPI_VALUES_1080P:[I
...
.method static synthetic access$000(Lcom/oneplus/settings/OPScreenResolutionAdjust;I)V
    ...
    invoke-direct {p0, p1}, changeScreenResolution(I)V
...
.method static synthetic access$100(Lcom/oneplus/settings/OPScreenResolutionAdjust;)Lcom/android/settings/ui/RadioButtonPreference;
    ...
    iget-object v0, p0, mOtherResolutionMode:Lcom/android/settings/ui/RadioButtonPreference;
...
.method static synthetic access$200(Lcom/oneplus/settings/OPScreenResolutionAdjust;)Lcom/android/settings/ui/RadioButtonPreference;
    ...
    iget-object v0, p0, m1080PMode:Lcom/android/settings/ui/RadioButtonPreference;
...
.method private changeScreenResolution(I)V
    ...
    iget-object v5, p0, mIntelligentSwitchResolutionMode:Lcom/android/settings/ui/RadioButtonPreference;

    invoke-virtual {v5, v3}, Lcom/android/settings/ui/RadioButtonPreference;->setChecked(Z)V

    iget-object v5, p0, mOtherResolutionMode:Lcom/android/settings/ui/RadioButtonPreference;

    invoke-virtual {v5, v4}, Lcom/android/settings/ui/RadioButtonPreference;->setChecked(Z)V

    iget-object v5, p0, m1080PMode:Lcom/android/settings/ui/RadioButtonPreference;

    invoke-virtual {v5, v4}, Lcom/android/settings/ui/RadioButtonPreference;->setChecked(Z)V

    if-ne v0, v3, :cond_0

    invoke-direct {p0}, openSurfaceComposerInterface()V

    :cond_0
    invoke-direct {p0}, is1080pMode()Z

    move-result v3

    if-eqz v3, :cond_1

    iget-object v3, p0, mDpiValuesOther:[I

    invoke-direct {p0}, getCurrent1080pDpiIndex()I
    ...
    iget-object v1, p0, mIntelligentSwitchResolutionMode:Lcom/android/settings/ui/RadioButtonPreference;

    invoke-virtual {v1, v4}, Lcom/android/settings/ui/RadioButtonPreference;->setChecked(Z)V

    iget-object v1, p0, mOtherResolutionMode:Lcom/android/settings/ui/RadioButtonPreference;

    invoke-virtual {v1, v3}, Lcom/android/settings/ui/RadioButtonPreference;->setChecked(Z)V

    iget-object v1, p0, m1080PMode:Lcom/android/settings/ui/RadioButtonPreference;
    ...
    iget-object v1, p0, mDpiValuesOther:[I
    ...
    sget-object v1, DPI_VALUES_1080P:[I

    invoke-direct {p0}, getCurrentOtherDpiIndex()I
...
.method private getCurrent1080pDpiIndex()I
    ...
    :goto_0
    sget-object v3, DPI_VALUES_1080P:[I
...
.method private killRunningProcess()V
    ...
    iget-object v3, p0, mAm:Landroid/app/ActivityManager;
...
.method public killSystemInputMethods()V
    ...
    invoke-direct {p0}, getIInputMethodManager()Lcom/android/internal/view/IInputMethodManager;
    ...
    iget-object v7, p0, mAm:Landroid/app/ActivityManager;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, mIntelligentSwitchResolutionMode:Lcom/android/settings/ui/RadioButtonPreference;
    ...
    iput-object v0, p0, mOtherResolutionMode:Lcom/android/settings/ui/RadioButtonPreference;
    ...
    iput-object v0, p0, m1080PMode:Lcom/android/settings/ui/RadioButtonPreference;

    iget-object v0, p0, mIntelligentSwitchResolutionMode:Lcom/android/settings/ui/RadioButtonPreference;
    ...
    iput-object v0, p0, mDpiValuesOther:[I
...
.method public onRadioButtonClicked(Lcom/android/settings/ui/RadioButtonPreference;)V
    ...
    invoke-direct {p0}, isIntelligentSwitchMode()Z
    ...
    invoke-virtual {p0, v0}, showWarnigDialog(I)V
    ...
    invoke-direct {p0}, isOtherMode()Z
...
.method public onResume()V
    ...
    iget-object v4, p0, mIntelligentSwitchResolutionMode:Lcom/android/settings/ui/RadioButtonPreference;
    ...
    :goto_0
    invoke-virtual {v4, v6}, Lcom/android/settings/ui/RadioButtonPreference;->setChecked(Z)V

    iget-object v4, p0, mOtherResolutionMode:Lcom/android/settings/ui/RadioButtonPreference;
    ...
    iget-object v4, p0, m1080PMode:Lcom/android/settings/ui/RadioButtonPreference;
