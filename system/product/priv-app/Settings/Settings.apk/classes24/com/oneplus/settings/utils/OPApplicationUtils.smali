...
.method public static forceStopPackage(Landroid/app/ActivityManager;)V
    ...
    const-string v5, "forceStopPackage-PackageName:"
    ...
    invoke-virtual {p0, v3}, Landroid/app/ActivityManager;->forceStopPackage(Ljava/lang/String;)V
...
.method public static isInForceStopAppList(Ljava/lang/String;)Z
    .locals 3
...
.method public static killProcess(Landroid/app/ActivityManager;)V
    ...
    :cond_0
    invoke-static {p0}, killSomeProcess(Landroid/app/ActivityManager;)V

    const/4 v0, 0x1

    invoke-static {p0, v0}, killRunningProcess(Landroid/app/ActivityManager;Z)V

    invoke-static {p0}, killSystemInputMethods(Landroid/app/ActivityManager;)V

    invoke-static {}, removeRunningTask()V
...
.method public static killProcess(Landroid/app/ActivityManager;Z)V
    ...
    invoke-static {p0, p1}, killRunningProcess(Landroid/app/ActivityManager;Z)V
...
.method public static killRunningProcess(Landroid/app/ActivityManager;Z)V
    ...
    invoke-static {v3}, isOnePlusO2UninstallationApp(Ljava/lang/String;)Z
    ...
    invoke-static {v3}, isOnePlusH2UninstallationApp(Ljava/lang/String;)Z
    ...
    invoke-static {v3}, isInNotKillAppWhiteList(Ljava/lang/String;)Z
...
.method public static killRunningTargetProcess(Landroid/app/ActivityManager;Ljava/lang/String;)V
    ...
    const-string v4, "remove face unlock"
    ...
    const-string v4, "killRunningTargetProcess-packageName:"
...
.method public static killSystemInputMethods(Landroid/app/ActivityManager;)V
    ...
    invoke-static {v7, v8}, Lcom/oneplus/settings/highpowerapp/PackageUtils;->isSystemApplication(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static killTargetProcess(Landroid/app/ActivityManager;Ljava/lang/String;)V
    .locals 0
...
.method public static removeRunningTask()V
    ...
    invoke-static {v4}, isInNotKillAppWhiteList(Ljava/lang/String;)Z
