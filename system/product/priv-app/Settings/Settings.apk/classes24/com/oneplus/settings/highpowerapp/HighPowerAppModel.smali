...
.method public constructor <init>(Landroid/content/Context;Lcom/oneplus/settings/highpowerapp/IHighPowerAppObserver;)V
    ...
    iput-object v0, p0, mDataObserverList:Ljava/util/List;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, mInstalledPackages:Ljava/util/Map;
    ...
    iput-object v0, p0, mData:Ljava/util/List;
    ...
    iput-object v0, p0, mDataObserverListLock:Ljava/lang/Object;

    new-instance v0, Ljava/lang/ref/SoftReference;

    invoke-direct {v0, p1}, Ljava/lang/ref/SoftReference;-><init>(Ljava/lang/Object;)V

    iput-object v0, p0, mContext:Ljava/lang/ref/SoftReference;
    ...
    iput-object v0, p0, mActivityManager:Lcom/oneplus/settings/highpowerapp/IMyActivityManager;

    invoke-virtual {p0, p2}, registerObserver(Lcom/oneplus/settings/highpowerapp/IHighPowerAppObserver;)V
...
.method private getContext()Landroid/content/Context;
    ...
    iget-object v0, p0, mContext:Ljava/lang/ref/SoftReference;
...
.method private makeFakeList()Ljava/util/List;
    ...
    :goto_0
    iget-object v3, v0, mData:Ljava/util/List;
...
.method private notifyDataChanged()V
    ...
    iget-object v0, p0, mDataObserverList:Ljava/util/List;

    if-eqz v0, :cond_2

    iget-object v0, p0, mDataObserverListLock:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, mDataObserverList:Ljava/util/List;
...
.method private process()V
    ...
    iget-object v0, p0, mActivityManager:Lcom/oneplus/settings/highpowerapp/IMyActivityManager;
    ...
    iget-object v3, p0, mInstalledPackages:Ljava/util/Map;
    ...
    iget-object v4, p0, mInstalledPackages:Ljava/util/Map;
    ...
    invoke-direct {p0}, notifyDataChanged()V
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object v1, p0, mActivityManager:Lcom/oneplus/settings/highpowerapp/IMyActivityManager;
...
.method public updateInstalledPackages()V
    ...
    iget-object v0, p0, mInstalledPackages:Ljava/util/Map;
