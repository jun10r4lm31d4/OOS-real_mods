...
.method static constructor <clinit>()V
    ...
    sput-object v0, mAuth:Lcom/oneplus/accountsdk/auth/f;
...
.method public static bindInfo(Landroid/content/Context;Lcom/oneplus/accountsdk/auth/OPAuthInfo;Lcom/oneplus/accountsdk/auth/OPAuthListener;)V
    ...
    invoke-static {p0}, checkContextNotNull(Landroid/content/Context;)V

    invoke-static {p1}, createConfig(Lcom/oneplus/accountsdk/auth/OPAuthInfo;)V

    sget-object v0, mAuth:Lcom/oneplus/accountsdk/auth/f;

    invoke-interface {v0, p1, p0, p2}, Lcom/oneplus/accountsdk/auth/f;->a(Lcom/oneplus/accountsdk/auth/OPAuthInfo;Landroid/content/Context;Lcom/oneplus/accountsdk/auth/OPAuthListener;)V
...
.method public static confirmCredentials(Landroid/app/Activity;Lcom/oneplus/accountsdk/auth/OPAuthInfo;Lcom/oneplus/accountsdk/auth/OPAuthListener;)V
    ...
    sget-object p1, mAuth:Lcom/oneplus/accountsdk/auth/f;

    invoke-interface {p1, p0, p2}, Lcom/oneplus/accountsdk/auth/f;->a(Landroid/app/Activity;Lcom/oneplus/accountsdk/auth/OPAuthListener;)V
...
.method public static getAccountInfo(Landroid/content/Context;Lcom/oneplus/accountsdk/auth/OPAuthInfo;Lcom/oneplus/accountsdk/auth/OPAuthListener;)V
    ...
    invoke-interface {p1, p0, p2}, Lcom/oneplus/accountsdk/auth/f;->a(Landroid/content/Context;Lcom/oneplus/accountsdk/auth/OPAuthListener;)V
...
.method public static initConfig(Lcom/oneplus/accountsdk/config/OPAuthEnvConfig$Builder;)V
    .locals 1

    if-eqz p0, :cond_0

    invoke-virtual {p0}, Lcom/oneplus/accountsdk/config/OPAuthEnvConfig$Builder;->build()Lcom/oneplus/accountsdk/config/OPAuthEnvConfig;
...
.method public static isLogin(Landroid/content/Context;Lcom/oneplus/accountsdk/auth/OPAuthInfo;)Z
    ...
    invoke-interface {p1, p0}, Lcom/oneplus/accountsdk/auth/f;->a(Landroid/content/Context;)Z
...
.method public static modifyUserName(Landroid/content/Context;Ljava/lang/String;Lcom/oneplus/accountsdk/auth/OPAuthListener;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {v0, p0, p1, p2}, Lcom/oneplus/accountsdk/auth/f;->a(Landroid/content/Context;Ljava/lang/String;Lcom/oneplus/accountsdk/auth/OPAuthListener;)V
...
.method public static reqAccountInfo(Landroid/content/Context;Lcom/oneplus/accountsdk/auth/OPAuthInfo;Lcom/oneplus/accountsdk/auth/OPAuthListener;)V
    ...
    invoke-interface {v0, p0, p1, p2}, Lcom/oneplus/accountsdk/auth/f;->a(Landroid/content/Context;Lcom/oneplus/accountsdk/auth/OPAuthInfo;Lcom/oneplus/accountsdk/auth/OPAuthListener;)V
...
.method public static updateCredentials(Landroid/app/Activity;Lcom/oneplus/accountsdk/auth/OPAuthInfo;Lcom/oneplus/accountsdk/auth/OPAuthListener;)V
    ...
    sget-object p0, mAuth:Lcom/oneplus/accountsdk/auth/f;

    invoke-interface {p0, p2}, Lcom/oneplus/accountsdk/auth/f;->a(Lcom/oneplus/accountsdk/auth/OPAuthListener;)V
