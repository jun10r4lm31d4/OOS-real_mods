...
.method static constructor <clinit>()V
    ...
    sput-object v1, INDETERMINATE_STATE_SET:[I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object v0, p0, mButtonTintList:Landroid/content/res/ColorStateList;

    iput-object v0, p0, mButtonTintMode:Landroid/graphics/PorterDuff$Mode;

    const/4 v1, 0x0

    iput-boolean v1, p0, mHasButtonTint:Z

    iput-boolean v1, p0, mHasButtonTintMode:Z
    ...
    invoke-virtual {p0, v3}, setButtonDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v7, p0, mButtonTintMode:Landroid/graphics/PorterDuff$Mode;

    invoke-static {v4, v7}, parseTintMode(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v4

    iput-object v4, p0, mButtonTintMode:Landroid/graphics/PorterDuff$Mode;
    ...
    iput-object v4, p0, mButtonTintList:Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p0, v4}, setThreeState(Z)V
    ...
    :goto_0
    invoke-virtual {p0, v0}, setTriStateChecked(Ljava/lang/Boolean;)V

    goto :goto_1

    :cond_4
    invoke-virtual {p0, v5}, setCheckedInternal(Z)V
    ...
    invoke-direct {p0, v0}, setRadius(I)V
...
.method public isThreeState()Z
    ...
    iget-boolean v0, p0, mThreeState:Z
...
.method protected onCreateDrawableState(I)[I
    ...
    sget-object v1, INDETERMINATE_STATE_SET:[I
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    iput-boolean v1, p0, mThreeState:Z

    iget-boolean v1, p0, mThreeState:Z
    ...
    :goto_0
    invoke-virtual {p0, v1}, setTriStateChecked(Ljava/lang/Boolean;)V
    ...
    invoke-virtual {p0, v1}, setCheckedInternal(Z)V
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iget-boolean v2, p0, mThreeState:Z
...
.method public setChecked(Z)V
    ...
    invoke-virtual {p0, p1}, setCheckedInternal(Z)V
...
.method public setCheckedInternal(Z)V
    ...
    invoke-virtual {p0, p1, v0}, setCheckedInternal(ZZ)V
...
.method public setCheckedInternal(ZZ)V
    ...
    invoke-direct {p0, v2}, notifyViewAccessibilityStateChangedIfNeededInternal(I)V

    if-eqz v0, :cond_5

    iget-boolean v3, p0, mBroadcasting:Z
    ...
    :cond_2
    iput-boolean v1, p0, mBroadcasting:Z

    iget-object v1, p0, mOnCheckedChangeListener:Lcom/oneplus/lib/widget/button/OPCompoundButton$OnCheckedChangeListener;

    if-eqz v1, :cond_3

    iget-boolean v3, p0, mChecked:Z
    ...
    :cond_3
    iget-object v1, p0, mOnCheckedChangeWidgetListener:Lcom/oneplus/lib/widget/button/OPCompoundButton$OnCheckedChangeListener;
    ...
    :cond_4
    iput-boolean v2, p0, mBroadcasting:Z
...
.method public setOnCheckedChangeListener(Lcom/oneplus/lib/widget/button/OPCompoundButton$OnCheckedChangeListener;)V
    ...
    iput-object p1, p0, mOnCheckedChangeListener:Lcom/oneplus/lib/widget/button/OPCompoundButton$OnCheckedChangeListener;
...
.method setOnCheckedChangeWidgetListener(Lcom/oneplus/lib/widget/button/OPCompoundButton$OnCheckedChangeListener;)V
    ...
    iput-object p1, p0, mOnCheckedChangeWidgetListener:Lcom/oneplus/lib/widget/button/OPCompoundButton$OnCheckedChangeListener;
...
.method public setOnTriStateCheckedChangeListener(Lcom/oneplus/lib/widget/button/OPCompoundButton$OnTriStateCheckedChangeListener;)V
    ...
    iput-object p1, p0, mOnTriStateCheckedChangeListener:Lcom/oneplus/lib/widget/button/OPCompoundButton$OnTriStateCheckedChangeListener;
...
.method public setThreeState(Z)V
    ...
    iput-boolean p1, p0, mThreeState:Z
...
.method protected setTriStateChecked(Ljava/lang/Boolean;)V
    ...
    invoke-virtual {p0, v0, v1}, setCheckedInternal(ZZ)V
    ...
    iget-object v0, p0, mOnTriStateCheckedChangeListener:Lcom/oneplus/lib/widget/button/OPCompoundButton$OnTriStateCheckedChangeListener;
...
.method public toggle()V
    ...
    invoke-virtual {p0, v0}, setCheckedInternal(Z)V
