...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-boolean v5, v0, mWrapSelectorWheelPreferred:Z

    const-wide/16 v6, 0x12c

    iput-wide v6, v0, mLongPressUpdateInterval:J

    new-instance v6, Landroid/util/SparseArray;

    invoke-direct {v6}, Landroid/util/SparseArray;-><init>()V

    iput-object v6, v0, mSelectorIndexToStringCache:Landroid/util/SparseArray;

    const/4 v6, 0x3

    new-array v6, v6, [I

    iput-object v6, v0, mSelectorIndices:[I

    const/high16 v6, -0x80000000

    iput v6, v0, mInitialScrollOffset:I

    iput v4, v0, mScrollState:I

    const/4 v6, -0x1

    iput v6, v0, mLastHandledDownDpadKeyCode:I

    iput v5, v0, mSelectMiddleCount:I
    ...
    sget v9, DEFAULT_LAYOUT_RESOURCE_ID:I
    ...
    :goto_0
    iput-boolean v9, v0, mHasSelectorWheel:Z
    ...
    iput-boolean v9, v0, mHideWheelUntilFocused:Z
    ...
    :cond_2
    iput-object v9, v0, mSelectionDivider:Landroid/graphics/drawable/Drawable;
    ...
    iput v11, v0, mSelectionDividerHeight:I
    ...
    iput v11, v0, mSelectionDividerWidth:I
    ...
    iput v12, v0, mSelectionDividersDistance:I
    ...
    iput v12, v0, mMaxHeight:I

    iget v12, v0, mMinHeight:I

    if-eq v12, v6, :cond_4

    iget v13, v0, mMaxHeight:I
    ...
    iput v12, v0, mMaxWidth:I

    iget v12, v0, mMinWidth:I

    if-eq v12, v6, :cond_6

    iget v13, v0, mMaxWidth:I
    ...
    :goto_3
    iput-boolean v6, v0, mComputeMaxWidth:Z
    ...
    iput-object v6, v0, mVirtualButtonPressedDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v13, v0, mPressedStateHelper:Lcom/oneplus/lib/widget/NumberPicker$PressedStateHelper;

    iget-boolean v13, v0, mHasSelectorWheel:Z

    xor-int/2addr v13, v5

    invoke-virtual {v0, v13}, setWillNotDraw(Z)V
    ...
    invoke-virtual {v0, v12}, findViewById(I)Landroid/view/View;

    move-result-object v12

    check-cast v12, Landroid/widget/ImageButton;

    iput-object v12, v0, mIncrementButton:Landroid/widget/ImageButton;

    iget-object v12, v0, mIncrementButton:Landroid/widget/ImageButton;
    ...
    :cond_8
    iput-object v4, v0, mIncrementButton:Landroid/widget/ImageButton;
    ...
    iput-object v12, v0, mDecrementButton:Landroid/widget/ImageButton;

    iget-object v12, v0, mDecrementButton:Landroid/widget/ImageButton;
    ...
    :cond_9
    iput-object v4, v0, mDecrementButton:Landroid/widget/ImageButton;
    ...
    iput-object v12, v0, mInputText:Landroid/widget/EditText;
    ...
    iget-object v4, v0, mInputText:Landroid/widget/EditText;
    ...
    iput v5, v0, mTouchSlop:I

    invoke-virtual {v4}, Landroid/view/ViewConfiguration;->getScaledMinimumFlingVelocity()I

    move-result v5

    iput v5, v0, mMinimumFlingVelocity:I
    ...
    iput v5, v0, mMaximumFlingVelocity:I

    iget-object v5, v0, mInputText:Landroid/widget/EditText;
    ...
    sget-object v12, ENABLED_STATE_SET:[I
    ...
    iput v1, v0, mSelectedValueColor:I

    iput v6, v0, mPaintColor:I
    ...
    iput-object v1, v0, mSelectorWheelPaint:Landroid/graphics/Paint;
    ...
    iput-object v5, v0, mFlingScroller:Landroid/widget/Scroller;
    ...
    iput-object v1, v0, mAdjustScroller:Landroid/widget/Scroller;
...
.method private changeValueByOne(Z)V
    ...
    invoke-direct {p0, v1, v0}, setValueInternal(IZ)V
...
.method private initializeSelectorWheel()V
    ...
    iput v4, p0, mSelectorTextGapHeight:I

    iget v4, p0, mTextSize:I

    iget v5, p0, mSelectorTextGapHeight:I

    add-int/2addr v4, v5

    iput v4, p0, mSelectorElementHeight:I

    iget-object v4, p0, mInputText:Landroid/widget/EditText;
    ...
    iget v6, p0, mSelectMiddleCount:I
...
.method private moveToFinalScrollerPosition(Landroid/widget/Scroller;)Z
    ...
    iget v3, p0, mSelectorElementHeight:I

    rem-int/2addr v2, v3

    iget v3, p0, mInitialScrollOffset:I
    ...
    invoke-virtual {p0, v4, v1}, scrollBy(II)V
...
.method private notifyChange(II)V
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, mOnValueChangeListener:Lcom/oneplus/lib/widget/NumberPicker$OnValueChangeListener;
...
.method private updateWrapSelectorWheel()V
    ...
    iget-boolean v1, p0, mWrapSelectorWheelPreferred:Z
...
.method private validateInputTextView(Landroid/view/View;)V
    ...
    invoke-direct {p0, v1}, getSelectedPos(Ljava/lang/String;)I

    move-result v1

    const/4 v2, 0x1

    invoke-direct {p0, v1, v2}, setValueInternal(IZ)V
...
.method protected dispatchHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    iget v2, p0, mTopSelectionDividerTop:I
    ...
    :cond_1
    iget v2, p0, mBottomSelectionDividerBottom:I
    ...
    iput v6, p0, mLastHoveredChildVirtualViewId:I
    ...
    :cond_5
    iget v5, p0, mLastHoveredChildVirtualViewId:I
...
.method protected drawableStateChanged()V
    ...
    invoke-virtual {p0, v0}, invalidateDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v2, v0, mHasSelectorWheel:Z
    ...
    :cond_0
    iget-boolean v2, v0, mHideWheelUntilFocused:Z
    ...
    invoke-virtual/range {p0 .. p0}, getLeft()I
    ...
    iget v5, v0, mCurrentScrollOffset:I
    ...
    iget-object v7, v0, mVirtualButtonPressedDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iget-boolean v8, v0, mDecrementVirtualButtonPressed:Z

    if-eqz v8, :cond_2

    sget-object v8, PRESSED_STATE_SET:[I
    ...
    :cond_2
    iget-boolean v7, v0, mIncrementVirtualButtonPressed:Z
    ...
    iget v8, v0, mBottomSelectionDividerBottom:I
    ...
    :cond_3
    iget-object v7, v0, mSelectorIndices:[I
    ...
    iget-object v10, v0, mSelectorIndexToStringCache:Landroid/util/SparseArray;
    ...
    iget v11, v0, mSelectMiddleCount:I
    ...
    iget-object v11, v0, mInputText:Landroid/widget/EditText;
    ...
    iget-object v11, v0, mSelectorWheelPaint:Landroid/graphics/Paint;

    iget v12, v0, mSelectedValueColor:I
    ...
    :cond_7
    iget v11, v0, mSelectorElementHeight:I
    ...
    iget-object v3, v0, mSelectionDivider:Landroid/graphics/drawable/Drawable;

    if-eqz v3, :cond_b

    iget v3, v0, mTopSelectionDividerTop:I
    ...
    iget v9, v0, mSelectionDividerWidth:I
    ...
    iget v13, v0, mSelectionDividerHeight:I

    add-int/2addr v13, v3

    if-nez v9, :cond_9

    iget-object v9, v0, mSelectionDivider:Landroid/graphics/drawable/Drawable;
    ...
    iget v9, v0, mBottomSelectionDividerBottom:I

    iget v14, v0, mSelectionDividerHeight:I

    sub-int v14, v9, v14

    iget v15, v0, mSelectionDividerWidth:I

    if-nez v15, :cond_a

    iget-object v15, v0, mSelectionDivider:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, v0, mSelectionDivider:Landroid/graphics/drawable/Drawable;
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iput v2, p0, mLastDownEventY:F

    iput v2, p0, mLastDownOrMoveEventY:F
    ...
    iget v3, p0, mTopSelectionDividerTop:I
    ...
    iget v2, p0, mScrollState:I

    if-nez v2, :cond_3

    iget-object v2, p0, mPressedStateHelper:Lcom/oneplus/lib/widget/NumberPicker$PressedStateHelper;
    ...
    invoke-direct {p0, v4, v1, v2}, postChangeCurrentByOneFromLongPress(ZJ)V

    goto :goto_1

    :cond_7
    iput-boolean v4, p0, mPerformClickOnTap:Z
...
.method protected onLayout(ZIIII)V
    ...
    iget-boolean v1, v0, mHasSelectorWheel:Z
    ...
    iget-object v3, v0, mInputText:Landroid/widget/EditText;
    ...
    iget-object v9, v0, mInputText:Landroid/widget/EditText;
    ...
    iget v10, v0, mSelectionDividersDistance:I

    sub-int/2addr v9, v10

    div-int/lit8 v9, v9, 0x2

    iget v11, v0, mSelectionDividerHeight:I

    sub-int/2addr v9, v11

    iput v9, v0, mTopSelectionDividerTop:I
    ...
    iput v9, v0, mBottomSelectionDividerBottom:I
...
.method protected onMeasure(II)V
    ...
    iget v2, p0, mMinWidth:I

    invoke-virtual {p0}, getMeasuredWidth()I

    move-result v3

    invoke-direct {p0, v2, v3, p1}, resolveSizeAndStateRespectingMinSize(III)I
    ...
    invoke-direct {p0, v3, v4, p2}, resolveSizeAndStateRespectingMinSize(III)I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_2
    iget-boolean v2, p0, mIgnoreMoveEvents:Z
    ...
    :cond_5
    iget v4, p0, mLastDownOrMoveEventY:F

    sub-float v4, v2, v4

    float-to-int v4, v4

    invoke-virtual {p0, v1, v4}, scrollBy(II)V
    ...
    iget-object v4, p0, mPressedStateHelper:Lcom/oneplus/lib/widget/NumberPicker$PressedStateHelper;
    ...
    iget v6, p0, mMaximumFlingVelocity:I
    ...
    iget v7, p0, mMinimumFlingVelocity:I

    if-le v6, v7, :cond_7

    invoke-direct {p0, v5}, fling(I)V
    ...
    iget-wide v10, p0, mLastDownEventTime:J
    ...
    iget v11, p0, mSelectMiddleCount:I
    ...
    iget-object v11, p0, mPressedStateHelper:Lcom/oneplus/lib/widget/NumberPicker$PressedStateHelper;
...
.method public scrollBy(II)V
    ...
    iget v1, p0, mSelectMiddleCount:I
    ...
    iget v3, p0, mSelectorTextGapHeight:I
    ...
    invoke-direct {p0, v1, v4}, setValueInternal(IZ)V
...
.method public setDividerWidth(I)V
    ...
    iput p1, p0, mSelectionDividerWidth:I
...
.method public setOnScrollListener(Lcom/oneplus/lib/widget/NumberPicker$OnScrollListener;)V
    ...
    iput-object p1, p0, mOnScrollListener:Lcom/oneplus/lib/widget/NumberPicker$OnScrollListener;
