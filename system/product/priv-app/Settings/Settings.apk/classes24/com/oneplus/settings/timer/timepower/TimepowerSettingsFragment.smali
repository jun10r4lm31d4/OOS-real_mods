...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, misCheckedPoweron:Z

    sput-boolean v0, misCheckedPoweroff:Z
...
.method public constructor <init>()V
    ...
    iput-object v1, p0, mTimeArray:[[I
    ...
    iput-object v0, p0, mStateArray:[[Z

    const/4 v0, 0x0

    iput-boolean v0, p0, mDlgVisible:Z
    ...
    iput-object v0, p0, onDismissListener:Landroid/content/DialogInterface$OnDismissListener;
...
.method static synthetic access$000(Lcom/oneplus/settings/timer/timepower/TimepowerSettingsFragment;)Z
    ...
    iget-boolean v0, p0, mDlgVisible:Z
...
.method static synthetic access$002(Lcom/oneplus/settings/timer/timepower/TimepowerSettingsFragment;Z)Z
    ...
    iput-boolean p1, p0, mDlgVisible:Z
...
.method static synthetic access$100(Lcom/oneplus/settings/timer/timepower/TimepowerSettingsFragment;I)Landroid/content/Intent;
    ...
    invoke-direct {p0, p1}, getTimeSettingsIntent(I)Landroid/content/Intent;
...
.method static synthetic access$200(Lcom/oneplus/settings/timer/timepower/TimepowerSettingsFragment;Landroid/content/Intent;I)V
    ...
    invoke-direct {p0, p1, p2}, startDialogForResult(Landroid/content/Intent;I)V
...
.method public static getPowerOnOffStatus(Ljava/lang/String;)Z
    ...
    sget-boolean v0, misCheckedPoweron:Z
    ...
    sget-boolean v0, misCheckedPoweroff:Z
...
.method private getTimeSettingsIntent(I)Landroid/content/Intent;
    ...
    :cond_0
    iget-object v1, p0, mStateArray:[[Z
    ...
    iget-object v3, p0, mPowerOnPreference:Landroidx/preference/Preference;
    ...
    iget-object v5, p0, mTimeArray:[[I
    ...
    iget-object v7, p0, mStateArray:[[Z

    aget-object v7, v7, v0

    aget-boolean v1, v7, v2

    iget-object v7, p0, mPowerOffPref:Lcom/oneplus/settings/timer/timepower/TimepowerPreference;
    ...
    iget-object v7, p0, mPowerOffPreference:Landroidx/preference/Preference;
    ...
    iget-object v4, p0, mPowerOffPreference:Landroidx/preference/Preference;
    ...
    iget-object v4, p0, mTimeArray:[[I
    ...
    invoke-direct/range {v7 .. v12}, getEditIntent(IIIZLjava/lang/String;)Landroid/content/Intent;
...
.method private init()V
    ...
    invoke-direct {p0}, readData()V

    iget-object v0, p0, mStateArray:[[Z
    ...
    iget-object v3, p0, mTimeArray:[[I
    ...
    invoke-direct {p0, v4, v3}, formatTime(II)Ljava/lang/String;

    move-result-object v3

    iget-object v4, p0, mStateArray:[[Z
    ...
    invoke-direct {p0, v1, v2}, formatTime(II)Ljava/lang/String;
    ...
    iput-object v2, p0, mPowerOnStatePref:Landroidx/preference/SwitchPreference;

    iget-object v2, p0, mPowerOnStatePref:Landroidx/preference/SwitchPreference;
    ...
    iput-object v2, p0, mPowerOffStatePref:Landroidx/preference/SwitchPreference;

    iget-object v2, p0, mPowerOffStatePref:Landroidx/preference/SwitchPreference;
    ...
    iput-object v5, p0, mPowerOnPref:Lcom/oneplus/settings/timer/timepower/TimepowerPreference;

    iget-object v5, p0, mPowerOnPref:Lcom/oneplus/settings/timer/timepower/TimepowerPreference;
    ...
    iput-object v5, p0, mPowerOnPreference:Landroidx/preference/Preference;

    iget-object v5, p0, mPowerOnPreference:Landroidx/preference/Preference;
    ...
    iput-object v6, p0, mPowerOffPref:Lcom/oneplus/settings/timer/timepower/TimepowerPreference;

    iget-object v6, p0, mPowerOffPref:Lcom/oneplus/settings/timer/timepower/TimepowerPreference;
    ...
    invoke-virtual {p0, v6}, findPreference(Ljava/lang/CharSequence;)Landroidx/preference/Preference;

    move-result-object v6

    iput-object v6, p0, mPowerOffPreference:Landroidx/preference/Preference;

    iget-object v6, p0, mPowerOffPreference:Landroidx/preference/Preference;
    ...
    invoke-virtual {p0, v5}, removePreference(Ljava/lang/String;)Z
...
.method private readData()V
    ...
    iget-object v5, p0, mStateArray:[[Z
    ...
    invoke-static {v8}, intToBool(I)Z
    ...
    invoke-static {v3}, intToBool(I)Z
...
.method private returnData(II)V
    ...
    iget-boolean v1, p0, mPowerState:Z
    ...
    invoke-direct {p0, v2, v1}, returnNewTimeSetResult(ILandroid/content/Intent;)V
...
.method private returnNewTimeSetResult(ILandroid/content/Intent;)V
    ...
    iget-object v10, p0, mTimeArray:[[I
    ...
    iget-object v9, p0, mTimeArray:[[I
    ...
    iget-object v8, p0, mTimeArray:[[I
    ...
    iget-object v1, p0, mTimeArray:[[I
    ...
    invoke-direct {p0, v3, v1}, formatTime(II)Ljava/lang/String;

    move-result-object v1

    iget-object v3, p0, mStateArray:[[Z
    ...
    iget-object v8, p0, mPowerOnPref:Lcom/oneplus/settings/timer/timepower/TimepowerPreference;

    invoke-virtual {v8, v1}, Lcom/oneplus/settings/timer/timepower/TimepowerPreference;->setTitle(Ljava/lang/CharSequence;)V

    iget-object v8, p0, mPowerOnPreference:Landroidx/preference/Preference;
    ...
    iget-object v8, p0, mPowerOffPref:Lcom/oneplus/settings/timer/timepower/TimepowerPreference;

    invoke-virtual {v8, v1}, Lcom/oneplus/settings/timer/timepower/TimepowerPreference;->setTitle(Ljava/lang/CharSequence;)V

    iget-object v8, p0, mPowerOffPreference:Landroidx/preference/Preference;
    ...
    invoke-direct {p0, v11, v7}, updateState(IZ)V

    iget-object v8, p0, mPowerOnStatePref:Landroidx/preference/SwitchPreference;
    ...
    :cond_4
    invoke-direct {p0, v7, v7}, updateState(IZ)V

    iget-object v8, p0, mPowerOffStatePref:Landroidx/preference/SwitchPreference;
    ...
    invoke-direct {p0}, cancleNewPlanLastPowerOn()V

    invoke-direct {p0}, writeData()V
...
.method private startDialogForResult(Landroid/content/Intent;I)V
    ...
    iput-object v0, v7, mTimePicker:Lcom/oneplus/lib/widget/TimePicker;
    ...
    iput-boolean v1, v7, mPowerState:Z
    ...
    :goto_0
    iget-object v0, v7, mTimePicker:Lcom/oneplus/lib/widget/TimePicker;
    ...
    iget-object v1, v7, onDismissListener:Landroid/content/DialogInterface$OnDismissListener;
    ...
    iput-boolean v14, v7, mDlgVisible:Z
...
.method private updateState(IZ)V
    ...
    sput-boolean v4, misCheckedPoweroff:Z
    ...
    sput-boolean v4, misCheckedPoweron:Z
...
.method private writeData()V
    ...
    iget-object v7, p0, mTimeArray:[[I
    ...
    invoke-static {v5}, boolToInt(Z)I
    ...
    invoke-static {v3}, boolToInt(Z)I
...
.method public onPreferenceChange(Landroidx/preference/Preference;Ljava/lang/Object;)Z
    ...
    invoke-direct {p0, v3, v0}, updateState(IZ)V
    ...
    invoke-direct {p0, v4, v0}, updateState(IZ)V
...
.method public onTimeSet(Lcom/oneplus/lib/widget/TimePicker;II)V
    ...
    invoke-direct {p0, p2, p3}, returnData(II)V
