...
.method protected onMeasure(II)V
    ...
    invoke-virtual {p0, v9, p1, p2}, measureChild(Landroid/view/View;II)V
    ...
    invoke-static {v6, v11}, combineMeasuredStates(II)I
    ...
    :cond_2
    iget-object v8, p0, mMatchParentChildren:Ljava/util/ArrayList;
    ...
    :cond_5
    invoke-static {v5, p1, v6}, resolveSizeAndState(III)I

    move-result v7

    shl-int/lit8 v9, v6, 0x10

    invoke-static {v4, p2, v9}, resolveSizeAndState(III)I

    move-result v9

    invoke-virtual {p0, v7, v9}, setMeasuredDimension(II)V

    iget-object v7, p0, mMatchParentChildren:Ljava/util/ArrayList;
    ...
    invoke-static {p1, v10, v11}, getChildMeasureSpec(III)I
    ...
    :cond_8
    iget-object v2, p0, mMatchParentChildren:Ljava/util/ArrayList;
