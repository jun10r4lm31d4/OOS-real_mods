...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-boolean v0, p0, mIsDisableAnimation:Z

    const/4 v1, 0x0

    iput-object v1, p0, mDelViewList:Ljava/util/ArrayList;

    iput-object v1, p0, mDelPosList:Ljava/util/ArrayList;

    iput-object v1, p0, mNowViewList:Ljava/util/ArrayList;

    iput-object v1, p0, mDelOriViewTopList:Ljava/util/ArrayList;

    iput-object v1, p0, mDelAniSet:Landroid/animation/AnimatorSet;
    ...
    iput-object v2, p0, mDecelerateInterpolator:Landroid/view/animation/DecelerateInterpolator;

    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    iput-object v2, p0, mAnimatorList:Ljava/util/ArrayList;
    ...
    iput-boolean v0, p0, mHeaderDividersEnabled:Z

    iput-boolean v0, p0, mFooterDividersEnabled:Z

    iput-boolean v0, p0, mIsClipToPadding:Z

    iput-object v1, p0, mDividerController:Lcom/oneplus/lib/widget/listview/IOPDividerController;
    ...
    iput-object v0, p0, mAnimatorUpdateListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;

    invoke-direct {p0, p1, p2, p3, p4}, init(Landroid/content/Context;Landroid/util/AttributeSet;II)V
...
.method static synthetic access$000(Lcom/oneplus/lib/widget/listview/OPListView;)Ljava/util/ArrayList;
    ...
    iget-object v0, p0, mDelViewList:Ljava/util/ArrayList;
...
.method static synthetic access$102(Lcom/oneplus/lib/widget/listview/OPListView;Z)Z
    ...
    iput-boolean p1, p0, mAnimRunning:Z
...
.method static synthetic access$202(Lcom/oneplus/lib/widget/listview/OPListView;Z)Z
    ...
    iput-boolean p1, p0, mInDeleteAnimation:Z
...
.method static synthetic access$302(Lcom/oneplus/lib/widget/listview/OPListView;Z)Z
    ...
    iput-boolean p1, p0, mDisableTouchEvent:Z
...
.method static synthetic access$400(Lcom/oneplus/lib/widget/listview/OPListView;)Ljava/util/ArrayList;
    ...
    iget-object v0, p0, mDelPosList:Ljava/util/ArrayList;
...
.method static synthetic access$500(Lcom/oneplus/lib/widget/listview/OPListView;)Ljava/util/ArrayList;
    ...
    iget-object v0, p0, mDelOriViewTopList:Ljava/util/ArrayList;
...
.method static synthetic access$600(Lcom/oneplus/lib/widget/listview/OPListView;)Lcom/oneplus/lib/widget/listview/OPListView$DeleteAnimationListener;
    ...
    iget-object v0, p0, mDeleteAnimationListener:Lcom/oneplus/lib/widget/listview/OPListView$DeleteAnimationListener;
...
.method static synthetic access$702(Lcom/oneplus/lib/widget/listview/OPListView;Z)Z
    ...
    iput-boolean p1, p0, mDelAnimationFlag:Z
...
.method static synthetic access$800(Lcom/oneplus/lib/widget/listview/OPListView;)Ljava/util/ArrayList;
    ...
    iget-object v0, p0, mNowViewList:Ljava/util/ArrayList;
...
.method private getAnimator(ILandroid/view/View;F)Landroid/animation/ObjectAnimator;
    ...
    iget-object v1, p0, mAnimatorList:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, mAnimatorList:Ljava/util/ArrayList;
...
.method private getDividerType(I)I
    ...
    iget-object v0, p0, mDividerController:Lcom/oneplus/lib/widget/listview/IOPDividerController;
...
.method private init(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput v4, p0, mDividerHeight:I

    invoke-virtual {p0, v2}, setOverScrollMode(I)V
    ...
    invoke-virtual {p0, v2}, setFooterDividersEnabled(Z)V
...
.method private isClipToPadding()Z
    ...
    iget-boolean v0, p0, mIsClipToPadding:Z
...
.method private setDelViewLocation()V
    ...
    :cond_1
    invoke-virtual/range {p0 .. p0}, getTop()I
    ...
    iget-object v12, v0, mNowViewList:Ljava/util/ArrayList;
    ...
    iput-object v12, v0, mNowViewList:Ljava/util/ArrayList;
    ...
    iget-object v13, v0, mNowViewList:Ljava/util/ArrayList;
    ...
    iget-boolean v13, v0, mOriLastPage:Z
    ...
    iget v13, v0, mOriUpperDeleteCount:I
    ...
    iget-object v6, v0, mDelOriViewTopList:Ljava/util/ArrayList;
    ...
    iget-object v13, v0, mDelOriViewTopList:Ljava/util/ArrayList;
    ...
    iget v6, v0, mOriUpperDeleteCount:I
    ...
    :cond_9
    iget v13, v0, mOriCurDeleteCount:I

    if-nez v13, :cond_b

    iget v13, v0, mOriCurLeftCount:I
    ...
    :cond_d
    iget v6, v0, mOriCurDeleteCount:I
    ...
    :goto_4
    iget v13, v0, mOriBelowLeftCount:I
    ...
    :cond_1a
    :goto_a
    iget-object v6, v0, mNowViewList:Ljava/util/ArrayList;
    ...
    iget-object v14, v0, mNowViewList:Ljava/util/ArrayList;
    ...
    iget-object v15, v0, mDelOriViewTopList:Ljava/util/ArrayList;
    ...
    iget-object v14, v0, mDelOriViewTopList:Ljava/util/ArrayList;
    ...
    iget-object v15, v0, mNowViewList:Ljava/util/ArrayList;
    ...
    iget-object v2, v0, mNowViewList:Ljava/util/ArrayList;
    ...
    iget-object v2, v0, mDelOriViewTopList:Ljava/util/ArrayList;
...
.method private shouldDrawDivider(I)Z
    ...
    invoke-direct {p0, v0}, getDividerType(I)I

    move-result v1

    iget-object v2, p0, mDividerController:Lcom/oneplus/lib/widget/listview/IOPDividerController;
...
.method private startDelDropAnimation()V
    ...
    iput-object v0, p0, mDelAniSet:Landroid/animation/AnimatorSet;

    invoke-direct {p0}, setDelViewLocation()V
    ...
    :goto_0
    iget-object v4, p0, mNowViewList:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, mDelOriViewTopList:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v3, v2, v4}, getAnimator(ILandroid/view/View;F)Landroid/animation/ObjectAnimator;
    ...
    iget-object v5, p0, mDecelerateInterpolator:Landroid/view/animation/DecelerateInterpolator;

    invoke-virtual {v4, v5}, Landroid/animation/ObjectAnimator;->setInterpolator(Landroid/animation/TimeInterpolator;)V

    iget-object v5, p0, mAnimatorUpdateListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    iget-object v5, p0, mDelAniSet:Landroid/animation/AnimatorSet;
    ...
    :cond_0
    iget-object v3, p0, mDelAniSet:Landroid/animation/AnimatorSet;
...
.method private startDelGoneAnimation()V
    ...
    iget-object v1, p0, mDelViewList:Ljava/util/ArrayList;
    ...
    iput-boolean v0, p0, mDelAnimationFlag:Z
    ...
    :cond_0
    iput-boolean v2, p0, mDisableTouchEvent:Z
    ...
    iput-object v3, p0, mDelAniSet:Landroid/animation/AnimatorSet;
    ...
    iget-object v6, p0, mDelViewList:Ljava/util/ArrayList;
    ...
    iget-object v8, p0, mDecelerateInterpolator:Landroid/view/animation/DecelerateInterpolator;

    invoke-virtual {v7, v8}, Landroid/animation/ObjectAnimator;->setInterpolator(Landroid/animation/TimeInterpolator;)V

    iget-object v8, p0, mAnimatorUpdateListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    iget-object v8, p0, mDelAniSet:Landroid/animation/AnimatorSet;
    ...
    :cond_2
    iget-object v0, p0, mDelAniSet:Landroid/animation/AnimatorSet;
...
.method protected dispatchDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual/range {p0 .. p0}, getOverscrollHeader()Landroid/graphics/drawable/Drawable;

    move-result-object v2

    invoke-virtual/range {p0 .. p0}, getOverscrollFooter()Landroid/graphics/drawable/Drawable;
    ...
    :goto_1
    invoke-virtual/range {p0 .. p0}, getDivider()Landroid/graphics/drawable/Drawable;
    ...
    :cond_4
    :goto_3
    iget-object v9, v0, mTempRect:Landroid/graphics/Rect;
    ...
    iget-boolean v14, v0, mHeaderDividersEnabled:Z

    iget-boolean v15, v0, mFooterDividersEnabled:Z
    ...
    invoke-direct/range {p0 .. p0}, isClipToPadding()Z

    move-result v20

    if-eqz v20, :cond_5

    invoke-virtual/range {p0 .. p0}, getListPaddingTop()I

    move-result v18

    invoke-virtual/range {p0 .. p0}, getListPaddingBottom()I
    ...
    invoke-virtual/range {p0 .. p0}, isStackFromBottom()Z
    ...
    invoke-virtual/range {p0 .. p0}, getDividerHeight()I
    ...
    invoke-virtual {v0, v1, v9, v2}, drawDivider(Landroid/graphics/Canvas;Landroid/graphics/Rect;I)V
    ...
    invoke-direct {v0, v2}, shouldDrawDivider(I)Z
    ...
    invoke-direct {v0, v5}, shouldDrawDivider(I)Z
    ...
    invoke-virtual {v0, v1, v9, v3}, drawDivider(Landroid/graphics/Canvas;Landroid/graphics/Rect;I)V
    ...
    invoke-virtual {v0, v1, v9, v5}, drawDivider(Landroid/graphics/Canvas;Landroid/graphics/Rect;I)V
    ...
    :goto_14
    iget-boolean v2, v0, mDelAnimationFlag:Z
    ...
    iput-boolean v2, v0, mDelAnimationFlag:Z

    invoke-direct/range {p0 .. p0}, startDelDropAnimation()V
...
.method drawDivider(Landroid/graphics/Canvas;Landroid/graphics/Rect;I)V
    ...
    invoke-virtual {p0}, getDivider()Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v1}, getDividerType(I)I

    move-result v2

    iget-object v3, p0, mDividerController:Lcom/oneplus/lib/widget/listview/IOPDividerController;
...
.method public isDeleteAnimationEnabled()Z
    ...
    iget-boolean v0, p0, mIsDisableAnimation:Z
...
.method public setClipToPadding(Z)V
    ...
    iput-boolean p1, p0, mIsClipToPadding:Z
...
.method public setDelPositionsList(Ljava/util/ArrayList;)V
    ...
    iput-boolean v0, p0, mDisableTouchEvent:Z

    return-void

    :cond_0
    invoke-virtual {p0}, isDeleteAnimationEnabled()Z

    move-result v1

    if-nez v1, :cond_2

    iget-object v1, p0, mDeleteAnimationListener:Lcom/oneplus/lib/widget/listview/OPListView$DeleteAnimationListener;
    ...
    :cond_3
    iput-boolean v2, p0, mAnimRunning:Z

    iget-object v3, p0, mDeleteAnimationListener:Lcom/oneplus/lib/widget/listview/OPListView$DeleteAnimationListener;
    ...
    :cond_4
    iput-boolean v2, p0, mInDeleteAnimation:Z

    invoke-virtual {p0}, getFirstVisiblePosition()I

    move-result v3

    iput v3, p0, mOriFirstPosition:I

    invoke-virtual {p0}, getChildCount()I

    move-result v3

    iget v4, p0, mOriFirstPosition:I
    ...
    iput-boolean v2, p0, mOriLastPage:Z

    goto :goto_0

    :cond_5
    iput-boolean v0, p0, mOriLastPage:Z

    :goto_0
    iput v0, p0, mOriUpperDeleteCount:I

    iput v0, p0, mOriCurDeleteCount:I

    iput v0, p0, mOriCurLeftCount:I

    iput v0, p0, mOriBelowLeftCount:I
    ...
    iput-object v4, p0, mDelOriViewTopList:Ljava/util/ArrayList;
    ...
    :goto_1
    iget-object v4, p0, mDelViewList:Ljava/util/ArrayList;
    ...
    iput-object v4, p0, mDelViewList:Ljava/util/ArrayList;
    ...
    :goto_2
    iget-object v4, p0, mDelPosList:Ljava/util/ArrayList;
    ...
    iput-object v4, p0, mDelPosList:Ljava/util/ArrayList;
    ...
    iget v7, p0, mOriFirstPosition:I

    if-ge v4, v7, :cond_9

    iget v7, p0, mOriUpperDeleteCount:I

    add-int/2addr v7, v2

    iput v7, p0, mOriUpperDeleteCount:I
    ...
    iget-object v7, p0, mDelPosList:Ljava/util/ArrayList;
    ...
    iget-object v7, p0, mDelViewList:Ljava/util/ArrayList;

    iget v8, p0, mOriFirstPosition:I
    ...
    iget v7, p0, mOriCurDeleteCount:I

    add-int/2addr v7, v2

    iput v7, p0, mOriCurDeleteCount:I
    ...
    iput-boolean v0, p0, mInDeleteAnimation:Z
    ...
    iget-object v8, p0, mDelPosList:Ljava/util/ArrayList;
    ...
    iget v10, p0, mOriFirstPosition:I

    add-int v7, v10, v9

    iget-object v10, p0, mDelPosList:Ljava/util/ArrayList;
    ...
    iget-object v10, p0, mDelOriViewTopList:Ljava/util/ArrayList;
    ...
    iget v10, p0, mOriCurDeleteCount:I

    sub-int/2addr v9, v10

    iput v9, p0, mOriCurLeftCount:I
    ...
    iput v9, p0, mOriBelowLeftCount:I

    invoke-direct {p0}, startDelGoneAnimation()V
...
.method public setDeleteAnimationEnabled(Z)V
    ...
    iput-boolean p1, p0, mIsDisableAnimation:Z
...
.method public setDeleteAnimationListener(Lcom/oneplus/lib/widget/listview/OPListView$DeleteAnimationListener;)V
    ...
    iput-object p1, p0, mDeleteAnimationListener:Lcom/oneplus/lib/widget/listview/OPListView$DeleteAnimationListener;
...
.method public setDividerController(Lcom/oneplus/lib/widget/listview/IOPDividerController;)V
    ...
    iput-object p1, p0, mDividerController:Lcom/oneplus/lib/widget/listview/IOPDividerController;
