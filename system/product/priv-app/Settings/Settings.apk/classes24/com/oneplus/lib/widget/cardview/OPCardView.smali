...
.method private initialize(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput v1, p0, mBackgroundColorMask:I

    invoke-virtual {v0}, Landroid/content/res/TypedArray;->recycle()V

    iget v1, p0, mBackgroundColor:I

    invoke-virtual {p0, v1}, setCardBackgroundColor(I)V

    new-instance v1, Landroid/graphics/Paint;

    invoke-direct {v1}, Landroid/graphics/Paint;-><init>()V

    iput-object v1, p0, mCardBackgroundMaskPaint:Landroid/graphics/Paint;

    iget-object v1, p0, mCardBackgroundMaskPaint:Landroid/graphics/Paint;

    iget v2, p0, mBackgroundColorMask:I
...
.method public dispatchDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, mCardBackgroundMaskPaint:Landroid/graphics/Paint;

    if-eqz v0, :cond_0

    iget-boolean v0, p0, mIsCardSelected:Z
    ...
    iget-object v6, p0, mCardBackgroundMaskPaint:Landroid/graphics/Paint;
...
.method public setCardSelected(Z)V
    ...
    iput-boolean p1, p0, mIsCardSelected:Z
