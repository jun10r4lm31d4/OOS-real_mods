...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    invoke-direct {p0}, initFormats()V
...
.method static synthetic access$000(Lcom/oneplus/lib/app/OPProgressDialog;)Lcom/oneplus/lib/widget/OPProgressBar;
    ...
    iget-object v0, p0, mProgress:Lcom/oneplus/lib/widget/OPProgressBar;
...
.method static synthetic access$100(Lcom/oneplus/lib/app/OPProgressDialog;)Ljava/lang/String;
    ...
    iget-object v0, p0, mProgressNumberFormat:Ljava/lang/String;
...
.method static synthetic access$200(Lcom/oneplus/lib/app/OPProgressDialog;)Landroid/widget/TextView;
    ...
    iget-object v0, p0, mProgressNumber:Landroid/widget/TextView;
...
.method static synthetic access$300(Lcom/oneplus/lib/app/OPProgressDialog;)Ljava/text/NumberFormat;
    ...
    iget-object v0, p0, mProgressPercentFormat:Ljava/text/NumberFormat;
...
.method static synthetic access$400(Lcom/oneplus/lib/app/OPProgressDialog;)Landroid/widget/TextView;
    ...
    iget-object v0, p0, mProgressPercent:Landroid/widget/TextView;
...
.method private initFormats()V
    ...
    iput-object v0, p0, mProgressNumberFormat:Ljava/lang/String;

    invoke-static {}, Ljava/text/NumberFormat;->getPercentInstance()Ljava/text/NumberFormat;

    move-result-object v0

    iput-object v0, p0, mProgressPercentFormat:Ljava/text/NumberFormat;
...
.method private onProgressChanged()V
    ...
    iget v0, p0, mProgressStyle:I

    const/4 v1, 0x1

    if-ne v0, v1, :cond_0

    iget-object v0, p0, mViewUpdateHandler:Landroid/os/Handler;
...
.method public static show(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Lcom/oneplus/lib/app/OPProgressDialog;
    ...
    invoke-static {p0, p1, p2, v0}, show(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Z)Lcom/oneplus/lib/app/OPProgressDialog;
...
.method public static show(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Z)Lcom/oneplus/lib/app/OPProgressDialog;
    ...
    invoke-static/range {v0 .. v5}, show(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLandroid/content/DialogInterface$OnCancelListener;)Lcom/oneplus/lib/app/OPProgressDialog;
...
.method public static show(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLandroid/content/DialogInterface$OnCancelListener;)Lcom/oneplus/lib/app/OPProgressDialog;
    ...
    invoke-virtual {v0, p1}, setTitle(Ljava/lang/CharSequence;)V

    invoke-virtual {v0, p2}, setMessage(Ljava/lang/CharSequence;)V

    invoke-virtual {v0, p3}, setIndeterminate(Z)V

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, setCancelable(Z)V

    invoke-virtual {v0, p5}, setOnCancelListener(Landroid/content/DialogInterface$OnCancelListener;)V

    invoke-virtual {v0}, show()V
...
.method public getSecondaryProgress()I
    ...
    :cond_0
    iget v0, p0, mSecondaryProgressVal:I
...
.method public incrementProgressBy(I)V
    ...
    invoke-direct {p0}, onProgressChanged()V

    goto :goto_0

    :cond_0
    iget v0, p0, mIncrementBy:I

    add-int/2addr v0, p1

    iput v0, p0, mIncrementBy:I
...
.method public incrementSecondaryProgressBy(I)V
    ...
    :cond_0
    iget v0, p0, mIncrementSecondaryBy:I

    add-int/2addr v0, p1

    iput v0, p0, mIncrementSecondaryBy:I
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v1, p0, mViewUpdateHandler:Landroid/os/Handler;
    ...
    iput-object v2, p0, mProgress:Lcom/oneplus/lib/widget/OPProgressBar;
    ...
    iput-object v2, p0, mProgressNumber:Landroid/widget/TextView;
    ...
    iput-object v2, p0, mProgressPercent:Landroid/widget/TextView;
    ...
    invoke-virtual {p0, v1}, setMax(I)V

    :cond_1
    iget v1, p0, mProgressVal:I
    ...
    :cond_2
    iget v1, p0, mSecondaryProgressVal:I
    ...
    :cond_3
    iget v1, p0, mIncrementBy:I

    if-lez v1, :cond_4

    invoke-virtual {p0, v1}, incrementProgressBy(I)V

    :cond_4
    iget v1, p0, mIncrementSecondaryBy:I

    if-lez v1, :cond_5

    invoke-virtual {p0, v1}, incrementSecondaryProgressBy(I)V
    ...
    invoke-virtual {p0, v1}, setProgressDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, v1}, setIndeterminate(Z)V
...
.method public onStart()V
    ...
    iput-boolean v0, p0, mHasStarted:Z
...
.method public setProgress(I)V
    ...
    iget-boolean v0, p0, mHasStarted:Z
...
.method public setProgressNumberFormat(Ljava/lang/String;)V
    ...
    iput-object p1, p0, mProgressNumberFormat:Ljava/lang/String;
...
.method public setProgressPercentFormat(Ljava/text/NumberFormat;)V
    ...
    iput-object p1, p0, mProgressPercentFormat:Ljava/text/NumberFormat;
...
.method public setSecondaryProgress(I)V
    ...
    :cond_0
    iput p1, p0, mSecondaryProgressVal:I
