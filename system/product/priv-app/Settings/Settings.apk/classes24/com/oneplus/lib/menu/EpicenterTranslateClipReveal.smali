...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v3, p0, mInterpolatorX:Landroid/animation/TimeInterpolator;
...
.method public onAppear(Landroid/view/ViewGroup;Landroid/view/View;Landroid/transition/TransitionValues;Landroid/transition/TransitionValues;)Landroid/animation/Animator;
    ...
    invoke-direct {v0, v13}, getBestRect(Landroid/transition/TransitionValues;)Landroid/graphics/Rect;

    move-result-object v4

    invoke-direct {v0, v4}, getEpicenterOrCenter(Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    iget-object v8, v0, mInterpolatorX:Landroid/animation/TimeInterpolator;

    iget-object v1, v0, mInterpolatorY:Landroid/animation/TimeInterpolator;

    move/from16 v19, v11

    iget-object v11, v0, mInterpolatorZ:Landroid/animation/TimeInterpolator;
    ...
    invoke-static/range {v1 .. v11}, createRectAnimator(Landroid/view/View;Lcom/oneplus/lib/menu/EpicenterTranslateClipReveal$State;Lcom/oneplus/lib/menu/EpicenterTranslateClipReveal$State;FLcom/oneplus/lib/menu/EpicenterTranslateClipReveal$State;Lcom/oneplus/lib/menu/EpicenterTranslateClipReveal$State;FLandroid/transition/TransitionValues;Landroid/animation/TimeInterpolator;Landroid/animation/TimeInterpolator;Landroid/animation/TimeInterpolator;)Landroid/animation/Animator;
...
.method public onDisappear(Landroid/view/ViewGroup;Landroid/view/View;Landroid/transition/TransitionValues;Landroid/transition/TransitionValues;)Landroid/animation/Animator;
    ...
    invoke-direct {v0, v8}, getEpicenterOrCenter(Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    iget-object v1, v0, mInterpolatorX:Landroid/animation/TimeInterpolator;

    iget-object v2, v0, mInterpolatorY:Landroid/animation/TimeInterpolator;
    ...
    invoke-static/range {v2 .. v12}, createRectAnimator(Landroid/view/View;Lcom/oneplus/lib/menu/EpicenterTranslateClipReveal$State;Lcom/oneplus/lib/menu/EpicenterTranslateClipReveal$State;FLcom/oneplus/lib/menu/EpicenterTranslateClipReveal$State;Lcom/oneplus/lib/menu/EpicenterTranslateClipReveal$State;FLandroid/transition/TransitionValues;Landroid/animation/TimeInterpolator;Landroid/animation/TimeInterpolator;Landroid/animation/TimeInterpolator;)Landroid/animation/Animator;
