...
.method public constructor <init>(Lcom/oneplus/lib/widget/DatePicker;Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput v1, v0, mCurrentView:I

    const/4 v1, 0x0

    iput v1, v0, mFirstDayOfWeek:I
    ...
    iput-object v2, v0, mOnDaySelectedListener:Lcom/oneplus/lib/widget/DayPickerView$OnDaySelectedListener;
    ...
    iput-object v2, v0, mOnYearSelectedListener:Lcom/oneplus/lib/widget/YearPickerView$OnYearSelectedListener;
    ...
    iput-object v2, v0, mOnHeaderClickListener:Landroid/view/View$OnClickListener;

    iget-object v2, v0, mCurrentLocale:Ljava/util/Locale;

    invoke-static {v2}, Ljava/util/Calendar;->getInstance(Ljava/util/Locale;)Ljava/util/Calendar;

    move-result-object v3

    iput-object v3, v0, mCurrentDate:Ljava/util/Calendar;

    invoke-static {v2}, Ljava/util/Calendar;->getInstance(Ljava/util/Locale;)Ljava/util/Calendar;

    move-result-object v3

    iput-object v3, v0, mTempDate:Ljava/util/Calendar;

    invoke-static {v2}, Ljava/util/Calendar;->getInstance(Ljava/util/Locale;)Ljava/util/Calendar;

    move-result-object v3

    iput-object v3, v0, mMinDate:Ljava/util/Calendar;

    invoke-static {v2}, Ljava/util/Calendar;->getInstance(Ljava/util/Locale;)Ljava/util/Calendar;

    move-result-object v3

    iput-object v3, v0, mMaxDate:Ljava/util/Calendar;

    iget-object v3, v0, mMinDate:Ljava/util/Calendar;
    ...
    iget-object v3, v0, mMaxDate:Ljava/util/Calendar;
    ...
    iget-object v3, v0, mDelegator:Lcom/oneplus/lib/widget/DatePicker;
    ...
    iget-object v11, v0, mDelegator:Lcom/oneplus/lib/widget/DatePicker;
    ...
    iput-object v11, v0, mContainer:Landroid/view/ViewGroup;

    iget-object v11, v0, mContainer:Landroid/view/ViewGroup;

    invoke-virtual {v11, v1}, Landroid/view/ViewGroup;->setSaveFromParentEnabled(Z)V

    iget-object v11, v0, mDelegator:Lcom/oneplus/lib/widget/DatePicker;

    iget-object v12, v0, mContainer:Landroid/view/ViewGroup;
    ...
    iput-object v12, v0, mHeaderYear:Landroid/widget/TextView;

    iget-object v12, v0, mHeaderYear:Landroid/widget/TextView;

    iget-object v13, v0, mOnHeaderClickListener:Landroid/view/View$OnClickListener;
    ...
    iput-object v12, v0, mHeaderMonthDay:Landroid/widget/TextView;

    iget-object v12, v0, mHeaderMonthDay:Landroid/widget/TextView;
    ...
    iput-object v12, v0, mHeaderLunarMonthDay:Landroid/widget/TextView;
    ...
    sget-object v4, ATTRS_TEXT_COLOR:[I
    ...
    iget-object v4, v0, mHeaderYear:Landroid/widget/TextView;

    invoke-virtual {v4, v12}, Landroid/widget/TextView;->setTextColor(Landroid/content/res/ColorStateList;)V

    iget-object v4, v0, mHeaderMonthDay:Landroid/widget/TextView;
    ...
    iget-object v4, v0, mContainer:Landroid/view/ViewGroup;
    ...
    iput-object v4, v0, mAnimator:Landroid/widget/ViewAnimator;

    iget-object v4, v0, mAnimator:Landroid/widget/ViewAnimator;
    ...
    iput-object v4, v0, mDayPickerView:Lcom/oneplus/lib/widget/DayPickerView;

    iget-object v4, v0, mDayPickerView:Lcom/oneplus/lib/widget/DayPickerView;

    iget v14, v0, mFirstDayOfWeek:I
    ...
    iget-object v14, v0, mCurrentDate:Ljava/util/Calendar;
    ...
    iget-object v14, v0, mOnDaySelectedListener:Lcom/oneplus/lib/widget/DayPickerView$OnDaySelectedListener;
    ...
    iput-object v4, v0, mYearPickerView:Lcom/oneplus/lib/widget/YearPickerView;

    iget-object v4, v0, mYearPickerView:Lcom/oneplus/lib/widget/YearPickerView;
    ...
    iget-object v14, v0, mOnYearSelectedListener:Lcom/oneplus/lib/widget/YearPickerView$OnYearSelectedListener;
    ...
    iput-object v4, v0, mSelectDay:Ljava/lang/String;
    ...
    iput-object v4, v0, mSelectYear:Ljava/lang/String;

    iget-object v4, v0, mCurrentLocale:Ljava/util/Locale;

    invoke-virtual {v0, v4}, onLocaleChanged(Ljava/util/Locale;)V

    invoke-direct {v0, v1}, setCurrentView(I)V
...
.method private onCurrentDateChanged(Z)V
    ...
    :cond_0
    iget-object v0, p0, mYearFormat:Ljava/text/SimpleDateFormat;
    ...
    iget-object v1, p0, mMonthDayFormat:Ljava/text/SimpleDateFormat;
    ...
    iget-object v2, p0, mHeaderMonthDay:Landroid/widget/TextView;

    invoke-virtual {v2, v1}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    invoke-direct {p0}, updateLunarDate()V

    if-eqz p1, :cond_1

    iget-object v2, p0, mAnimator:Landroid/widget/ViewAnimator;

    invoke-virtual {p0}, getFormattedCurrentDate()Ljava/lang/String;
...
.method private onDateChanged(ZZ)V
    ...
    iget-object v1, p0, mOnDateChangedListener:Lcom/oneplus/lib/widget/DatePicker$OnDateChangedListener;

    if-nez v1, :cond_0

    iget-object v1, p0, mAutoFillChangeListener:Lcom/oneplus/lib/widget/DatePicker$OnDateChangedListener;
    ...
    iget-object v3, p0, mOnDateChangedListener:Lcom/oneplus/lib/widget/DatePicker$OnDateChangedListener;

    if-eqz v3, :cond_1

    iget-object v3, p0, mOnDateChangedListener:Lcom/oneplus/lib/widget/DatePicker$OnDateChangedListener;

    iget-object v4, p0, mDelegator:Lcom/oneplus/lib/widget/DatePicker;
    ...
    :cond_1
    iget-object v3, p0, mAutoFillChangeListener:Lcom/oneplus/lib/widget/DatePicker$OnDateChangedListener;
    ...
    :cond_2
    iget-object v1, p0, mDayPickerView:Lcom/oneplus/lib/widget/DayPickerView;
    ...
    iget-object v1, p0, mYearPickerView:Lcom/oneplus/lib/widget/YearPickerView;
...
.method private setCurrentView(I)V
    ...
    :cond_0
    invoke-virtual {p0}, changeYearLayoutParams()V
    ...
    iget-object v3, p0, mYearPickerView:Lcom/oneplus/lib/widget/YearPickerView;

    invoke-virtual {v3, v2}, Lcom/oneplus/lib/widget/YearPickerView;->setYear(I)V

    iget v3, p0, mCurrentView:I

    if-eq v3, p1, :cond_1

    iget-object v3, p0, mHeaderMonthDay:Landroid/widget/TextView;
    ...
    :cond_2
    iget-object v2, p0, mDayPickerView:Lcom/oneplus/lib/widget/DayPickerView;
    ...
    iget-object v1, p0, mAnimator:Landroid/widget/ViewAnimator;
...
.method private tryVibrate()V
    ...
    :cond_0
    iget-object v0, p0, mDelegator:Lcom/oneplus/lib/widget/DatePicker;
...
.method private updateLunarDate()V
    ...
    iget-object v3, p0, mHeaderLunarMonthDay:Landroid/widget/TextView;
    ...
    :cond_1
    iget-object v1, p0, mHeaderLunarMonthDay:Landroid/widget/TextView;
...
.method public init(IIILcom/oneplus/lib/widget/DatePicker$OnDateChangedListener;)V
    ...
    invoke-direct {p0, v0, v0}, onDateChanged(ZZ)V

    iput-object p4, p0, mOnDateChangedListener:Lcom/oneplus/lib/widget/DatePicker$OnDateChangedListener;
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    iget-object v3, p0, mDayPickerView:Lcom/oneplus/lib/widget/DayPickerView;
...
.method public onSaveInstanceState(Landroid/os/Parcelable;)Landroid/os/Parcelable;
    ...
    iget-object v1, v0, mCurrentDate:Ljava/util/Calendar;
    ...
    iget-object v2, v0, mCurrentDate:Ljava/util/Calendar;
    ...
    iget-object v3, v0, mCurrentDate:Ljava/util/Calendar;
...
.method public setCurrentYear()V
    ...
    iget-object v0, p0, mYearPickerView:Lcom/oneplus/lib/widget/YearPickerView;
...
.method public setEnabled(Z)V
    ...
    iget-object v0, p0, mDayPickerView:Lcom/oneplus/lib/widget/DayPickerView;
...
.method public setMaxDate(J)V
    ...
    iget-object v2, p0, mTempDate:Ljava/util/Calendar;
    ...
    invoke-direct {p0, v0, v1}, onDateChanged(ZZ)V
