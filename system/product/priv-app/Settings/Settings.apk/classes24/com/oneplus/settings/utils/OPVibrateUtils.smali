...
.method static constructor <clinit>()V
    ...
    sput-object v0, sVibratePatternrhythm:[[J

    new-array v0, v3, [J

    fill-array-data v0, :array_5

    sput-object v0, mAlarmVibratePattern:[J
...
.method public static startVibrateByIndex(Landroid/os/Vibrator;I)V
    ...
    sget-object v3, sVibratePatternrhythm:[[J
...
.method public static startVibrateByType(Landroid/os/Vibrator;)V
    ...
    invoke-static {v1}, getRingtoneVibrateMode(Landroid/content/Context;)I
...
.method public static startVibrateByType(Landroid/os/Vibrator;I)V
    ...
    sget-object v2, sVibratePatternrhythm:[[J
...
.method public static startVibrateForAlarm(Landroid/content/Context;Landroid/net/Uri;Landroid/os/Vibrator;)V
    ...
    invoke-static {p0}, isThreeKeyRingMode(Landroid/content/Context;)Z

    move-result v2

    if-eqz v2, :cond_3

    invoke-static {p1, v1}, isSystemRingtone(Landroid/net/Uri;I)Z

    move-result v2

    if-eqz v2, :cond_1

    invoke-static {p0, p1, p2}, startVibrateWithRingtoneUri(Landroid/content/Context;Landroid/net/Uri;Landroid/os/Vibrator;)V
    ...
    sget-object v2, mAlarmVibratePattern:[J
    ...
    :cond_2
    sget-object v1, mAlarmVibratePattern:[J
...
.method public static startVibrateForNotification(Landroid/content/Context;Landroid/net/Uri;Landroid/os/Vibrator;)V
    ...
    invoke-static {p0}, isThreeKeyVibrateMode(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, isThreeKeyMuteMode(Landroid/content/Context;)Z
    ...
    invoke-static {p1, v0}, isSystemRingtone(Landroid/net/Uri;I)Z
...
.method public static startVibrateForRingtone(Landroid/content/Context;Landroid/net/Uri;Landroid/os/Vibrator;)V
    ...
    :cond_0
    invoke-static {p0}, isVibrateWhenRinging(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, isDynamicVibrateMode(Landroid/content/Context;)Z
    ...
    :cond_2
    invoke-static {p2}, startVibrateByType(Landroid/os/Vibrator;)V
...
.method public static startVibrateWithRingtoneUri(Landroid/content/Context;Landroid/net/Uri;Landroid/os/Vibrator;)V
    ...
    invoke-static {v4}, getVibrateLevel(I)I
