...
.method constructor <init>(Landroid/content/Context;Landroid/content/pm/IPackageManager;Lcom/android/internal/view/IInputMethodManager;Ljava/lang/String;IZIZLcom/oneplus/settings/multiapp/OPDeleteNonRequiredAppsTask$Callback;)V
    ...
    iput-object p9, p0, mCallback:Lcom/oneplus/settings/multiapp/OPDeleteNonRequiredAppsTask$Callback;

    iput-object p1, p0, mContext:Landroid/content/Context;

    iput-object p4, p0, mMdmPackageName:Ljava/lang/String;

    iput p5, p0, mProvisioningType:I

    iput p7, p0, mUserId:I

    iput-boolean p6, p0, mNewProfile:Z

    iput-boolean p8, p0, mLeaveAllSystemAppsEnabled:Z
    ...
    iput-object p2, p0, mIPackageManager:Landroid/content/pm/IPackageManager;

    iput-object p3, p0, mIInputMethodManager:Lcom/android/internal/view/IInputMethodManager;
    ...
    iput-object v3, p0, mRequiredAppsList:Ljava/util/List;
    ...
    iput-object v3, p0, mDisallowedAppsList:Ljava/util/List;

    const/4 v3, 0x0

    iput-object v3, p0, mVendorRequiredAppsList:Ljava/util/List;

    iput-object v3, p0, mVendorDisallowedAppsList:Ljava/util/List;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;IZIZLcom/oneplus/settings/multiapp/OPDeleteNonRequiredAppsTask$Callback;)V
    ...
    invoke-static {}, getIInputMethodManager()Lcom/android/internal/view/IInputMethodManager;
    ...
    invoke-direct/range {v0 .. v9}, <init>(Landroid/content/Context;Landroid/content/pm/IPackageManager;Lcom/android/internal/view/IInputMethodManager;Ljava/lang/String;IZIZLcom/oneplus/settings/multiapp/OPDeleteNonRequiredAppsTask$Callback;)V
...
.method static synthetic access$000(Lcom/oneplus/settings/multiapp/OPDeleteNonRequiredAppsTask;)Lcom/oneplus/settings/multiapp/OPDeleteNonRequiredAppsTask$Callback;
    ...
    iget-object v0, p0, mCallback:Lcom/oneplus/settings/multiapp/OPDeleteNonRequiredAppsTask$Callback;
...
.method private getDisallowedApps()Ljava/util/Set;
    ...
    iget-object v1, p0, mDisallowedAppsList:Ljava/util/List;
...
.method private getPackagesToDelete()Ljava/util/Set;
    ...
    invoke-direct {p0}, getCurrentAppsWithLauncher()Ljava/util/Set;

    move-result-object v0

    invoke-virtual {p0}, getRequiredApps()Ljava/util/Set;

    move-result-object v1

    invoke-interface {v0, v1}, Ljava/util/Set;->removeAll(Ljava/util/Collection;)Z

    iget v1, p0, mProvisioningType:I
    ...
    :cond_0
    invoke-direct {p0}, getSystemInputMethods()Ljava/util/Set;
    ...
    :cond_1
    invoke-direct {p0}, getDisallowedApps()Ljava/util/Set;
...
.method public static shouldDeleteNonRequiredApps(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1}, getSystemAppsFile(Landroid/content/Context;I)Ljava/io/File;
...
.method protected getRequiredApps()Ljava/util/Set;
    ...
    iget-object v1, p0, mRequiredAppsList:Ljava/util/List;
...
.method public run()V
    ...
    iget-boolean v0, p0, mLeaveAllSystemAppsEnabled:Z
    ...
    invoke-direct {p0}, getPackagesToDelete()Ljava/util/Set;

    move-result-object v0

    invoke-direct {p0, v0}, removeNonInstalledPackages(Ljava/util/Set;)V
    ...
    iget-object v1, p0, mCallback:Lcom/oneplus/settings/multiapp/OPDeleteNonRequiredAppsTask$Callback;
