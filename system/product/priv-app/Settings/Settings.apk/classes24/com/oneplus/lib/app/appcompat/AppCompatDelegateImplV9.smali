...
.method constructor <init>(Landroid/content/Context;Landroid/view/Window;Lcom/oneplus/lib/app/appcompat/AppCompatCallback;)V
    ...
    iput-object v0, p0, mFadeAnim:Landroid/view/ViewPropertyAnimator;
...
.method private createSubDecor()Landroid/view/ViewGroup;
    ...
    iget-boolean v6, p0, mWindowNoTitle:Z

    const/4 v7, 0x0

    if-nez v6, :cond_9

    iget-boolean v6, p0, mIsFloating:Z
    ...
    :cond_4
    iget-boolean v6, p0, mHasActionBar:Z
    ...
    iput-object v8, p0, mDecorContentParent:Lcom/oneplus/lib/app/appcompat/DecorContentParent;

    iget-object v8, p0, mDecorContentParent:Lcom/oneplus/lib/app/appcompat/DecorContentParent;
    ...
    iget-boolean v8, p0, mOverlayActionBar:Z
    ...
    :cond_6
    iget-boolean v4, p0, mFeatureProgress:Z

    if-eqz v4, :cond_7

    iget-object v4, p0, mDecorContentParent:Lcom/oneplus/lib/app/appcompat/DecorContentParent;
    ...
    :cond_7
    iget-boolean v4, p0, mFeatureIndeterminateProgress:Z
    ...
    :cond_9
    iget-boolean v3, p0, mOverlayActionMode:Z
    ...
    iput-object v3, p0, mContentFrameLayout:Lcom/oneplus/lib/app/appcompat/ContentFrameLayout;

    iget-object v3, p0, mContentFrameLayout:Lcom/oneplus/lib/app/appcompat/ContentFrameLayout;

    if-eqz v3, :cond_b

    iput-object v3, p0, mDecorContentParent:Lcom/oneplus/lib/app/appcompat/DecorContentParent;

    iget-object v3, p0, mDecorContentParent:Lcom/oneplus/lib/app/appcompat/DecorContentParent;
    ...
    iget-boolean v4, p0, mHasActionBar:Z
    ...
    iget-boolean v4, p0, mOverlayActionBar:Z
    ...
    iget-boolean v4, p0, mIsFloating:Z
    ...
    iget-boolean v4, p0, mWindowNoTitle:Z
...
.method private ensureSubDecor()V
    ...
    invoke-virtual {p0, v0}, onTitleChanged(Ljava/lang/CharSequence;)V

    :cond_0
    invoke-direct {p0}, applyFixedSizeWindow()V

    iget-object v1, p0, mSubDecor:Landroid/view/ViewGroup;

    invoke-virtual {p0, v1}, onSubDecorInstalled(Landroid/view/ViewGroup;)V

    const/4 v1, 0x1

    iput-boolean v1, p0, mSubDecorInstalled:Z

    const/4 v1, 0x0

    invoke-virtual {p0, v1, v1}, getPanelState(IZ)Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;
    ...
    invoke-direct {p0, v2}, invalidatePanelMenu(I)V
...
.method private initializePanelContent(Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;)Z
    ...
    :cond_1
    iget-object v0, p0, mPanelMenuPresenterCallback:Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelMenuPresenterCallback;
    ...
    iput-object v0, p0, mPanelMenuPresenterCallback:Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelMenuPresenterCallback;
...
.method private initializePanelMenu(Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;)Z
    ...
    :cond_0
    iget-object v1, p0, mDecorContentParent:Lcom/oneplus/lib/app/appcompat/DecorContentParent;
...
.method private onKeyDownPanel(ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {p0, p1, v0}, getPanelState(IZ)Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;
    ...
    invoke-direct {p0, v0, p2}, preparePanel(Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;Landroid/view/KeyEvent;)Z
...
.method private onKeyUpPanel(ILandroid/view/KeyEvent;)Z
    ...
    iget-object v0, p0, mActionMode:Lcom/oneplus/lib/app/appcompat/ActionMode;
    ...
    invoke-virtual {p0, p1, v2}, getPanelState(IZ)Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;
    ...
    iget-object v2, p0, mDecorContentParent:Lcom/oneplus/lib/app/appcompat/DecorContentParent;
    ...
    invoke-direct {p0, v3, p2}, preparePanel(Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;Landroid/view/KeyEvent;)Z
    ...
    invoke-direct {p0, v3, p2}, openPanel(Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;Landroid/view/KeyEvent;)V
    ...
    invoke-virtual {p0, v3, v2}, closePanel(Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;Z)V
...
.method private openPanel(Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;Landroid/view/KeyEvent;)V
    ...
    :cond_3
    invoke-virtual/range {p0 .. p0}, getWindowCallback()Landroid/view/Window$Callback;
    ...
    invoke-virtual {v0, v1, v4}, closePanel(Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;Z)V
    ...
    :cond_5
    invoke-direct/range {p0 .. p2}, preparePanel(Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;Landroid/view/KeyEvent;)Z
    ...
    invoke-direct/range {p0 .. p1}, initializePanelDecor(Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;)Z
    ...
    :cond_c
    invoke-direct/range {p0 .. p1}, initializePanelContent(Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;)Z
...
.method private performPanelShortcut(Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;ILandroid/view/KeyEvent;I)Z
    ...
    invoke-direct {p0, p1, p3}, preparePanel(Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;Landroid/view/KeyEvent;)Z
    ...
    invoke-virtual {p0, p1, v1}, closePanel(Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;Z)V
...
.method private preparePanel(Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;Landroid/view/KeyEvent;)Z
    ...
    :cond_1
    iget-object v0, p0, mPreparedPanel:Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;

    if-eqz v0, :cond_2

    if-eq v0, p1, :cond_2

    invoke-virtual {p0, v0, v1}, closePanel(Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;Z)V
    ...
    invoke-virtual {p0}, peekSupportActionBar()Lcom/oneplus/lib/app/appcompat/ActionBar;
    ...
    invoke-direct {p0, p1}, initializePanelMenu(Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;)Z
    ...
    iget-object v4, p0, mActionMenuPresenterCallback:Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$ActionMenuPresenterCallback;
    ...
    iput-object v4, p0, mActionMenuPresenterCallback:Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$ActionMenuPresenterCallback;
    ...
    iget-object v7, p0, mActionMenuPresenterCallback:Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$ActionMenuPresenterCallback;
    ...
    iput-object p1, p0, mPreparedPanel:Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;
...
.method private reopenMenu(Lcom/oneplus/lib/menu/MenuBuilder;Z)V
    ...
    iget-object v0, p0, mDecorContentParent:Lcom/oneplus/lib/app/appcompat/DecorContentParent;
    ...
    invoke-virtual {p0, v2, v1}, getPanelState(IZ)Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;
    ...
    iget-boolean v3, p0, mInvalidatePanelMenuPosted:Z

    if-eqz v3, :cond_3

    iget v3, p0, mInvalidatePanelMenuFeatures:I
    ...
    iget-object v3, p0, mInvalidatePanelMenuRunnable:Ljava/lang/Runnable;
    ...
    invoke-virtual {p0, v0, v2}, closePanel(Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;Z)V

    const/4 v1, 0x0

    invoke-direct {p0, v0, v1}, openPanel(Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;Landroid/view/KeyEvent;)V
...
.method public addContentView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    iget-object v1, p0, mOriginalWindowCallback:Landroid/view/Window$Callback;
...
.method callActivityOnCreateView(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    iget-object v0, p0, mOriginalWindowCallback:Landroid/view/Window$Callback;
...
.method callOnPanelClosed(ILcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;Landroid/view/Menu;)V
    ...
    iget-object v0, p0, mPanels:[Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;
...
.method closePanel(I)V
    ...
    invoke-virtual {p0, v1, v0}, closePanel(Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;Z)V
...
.method closePanel(Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;Z)V
    ...
    invoke-virtual {p0, v0}, checkCloseActionMenu(Lcom/oneplus/lib/menu/MenuBuilder;)V
    ...
    invoke-virtual {p0, v2, p1, v1}, callOnPanelClosed(ILcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;Landroid/view/Menu;)V
    ...
    iget-object v2, p0, mPreparedPanel:Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;

    if-ne v2, p1, :cond_2

    iput-object v1, p0, mPreparedPanel:Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;
...
.method public createView(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    :goto_0
    iget-object v4, v0, mAppCompatViewInflater:Lcom/oneplus/lib/app/appcompat/AppCompatViewInflater;
    ...
    iput-object v4, v0, mAppCompatViewInflater:Lcom/oneplus/lib/app/appcompat/AppCompatViewInflater;
    ...
    invoke-direct {p0, v4}, shouldInheritContext(Landroid/view/ViewParent;)Z
...
.method dismissPopups()V
    ...
    invoke-virtual {p0, v0, v0}, getPanelState(IZ)Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;
...
.method doInvalidatePanelMenu(I)V
    ...
    invoke-direct {p0, v1, v0}, preparePanel(Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;Landroid/view/KeyEvent;)Z
...
.method endOnGoingFadeAnimation()V
    ...
    iget-object v0, p0, mFadeAnim:Landroid/view/ViewPropertyAnimator;
...
.method protected getPanelState(IZ)Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;
    ...
    iput-object v0, p0, mPanels:[Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;
...
.method public hasWindowFeature(I)Z
    ...
    :cond_0
    iget-boolean v0, p0, mOverlayActionBar:Z
    ...
    :cond_2
    iget-boolean v0, p0, mOverlayActionMode:Z

    return v0

    :cond_3
    iget-boolean v0, p0, mFeatureIndeterminateProgress:Z

    return v0

    :cond_4
    iget-boolean v0, p0, mFeatureProgress:Z
...
.method public initWindowDecorActionBar()V
    ...
    iget-object v0, p0, mActionBar:Lcom/oneplus/lib/app/appcompat/ActionBar;
    ...
    iput-object v0, p0, mActionBar:Lcom/oneplus/lib/app/appcompat/ActionBar;
    ...
    iget-boolean v1, p0, mEnableDefaultActionBarUp:Z
...
.method public invalidateOptionsMenu()V
    ...
    invoke-virtual {p0}, getSupportActionBar()Lcom/oneplus/lib/app/appcompat/ActionBar;
    ...
    invoke-direct {p0, v1}, invalidatePanelMenu(I)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-boolean v1, p0, mEnableDefaultActionBarUp:Z
...
.method public final onCreateView(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, callActivityOnCreateView(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
...
.method onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {p0, p1, p2}, onKeyShortcut(ILandroid/view/KeyEvent;)Z
...
.method onKeyShortcut(ILandroid/view/KeyEvent;)Z
    ...
    invoke-direct {p0, v2, v3, p2, v1}, performPanelShortcut(Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;ILandroid/view/KeyEvent;I)Z

    move-result v2

    if-eqz v2, :cond_2

    iget-object v3, p0, mPreparedPanel:Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;
    ...
    invoke-virtual {p0, v3, v1}, getPanelState(IZ)Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;

    move-result-object v2

    invoke-direct {p0, v2, p2}, preparePanel(Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;Landroid/view/KeyEvent;)Z

    invoke-virtual {p2}, Landroid/view/KeyEvent;->getKeyCode()I

    move-result v4

    invoke-direct {p0, v2, v4, p2, v1}, performPanelShortcut(Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;ILandroid/view/KeyEvent;I)Z
...
.method onKeyUp(ILandroid/view/KeyEvent;)Z
    ...
    :cond_1
    iget-boolean v0, p0, mLongPressBackDown:Z

    iput-boolean v2, p0, mLongPressBackDown:Z

    invoke-virtual {p0, v2, v2}, getPanelState(IZ)Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;
    ...
    invoke-virtual {p0, v3, v1}, closePanel(Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;Z)V
...
.method public onMenuItemSelected(Lcom/oneplus/lib/menu/MenuBuilder;Landroid/view/MenuItem;)Z
    ...
    invoke-virtual {p0, v1}, findMenuPanel(Landroid/view/Menu;)Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;
...
.method public onMenuModeChange(Lcom/oneplus/lib/menu/MenuBuilder;)V
    ...
    invoke-direct {p0, p1, v0}, reopenMenu(Lcom/oneplus/lib/menu/MenuBuilder;Z)V
...
.method onPanelClosed(ILandroid/view/Menu;)V
    ...
    invoke-virtual {p0, p1, v1}, getPanelState(IZ)Lcom/oneplus/lib/app/appcompat/AppCompatDelegateImplV9$PanelFeatureState;
...
.method public setSupportActionBar(Lcom/oneplus/lib/widget/actionbar/Toolbar;)V
    ...
    :cond_0
    iget-object v0, p0, mContentFrameLayout:Lcom/oneplus/lib/app/appcompat/ContentFrameLayout;
    ...
    iput-object v1, p0, mMenuInflater:Landroid/view/MenuInflater;
    ...
    iget-object v3, p0, mAppCompatWindowCallback:Landroid/view/Window$Callback;
    ...
    iput-object v1, p0, mActionBar:Lcom/oneplus/lib/app/appcompat/ActionBar;
    ...
    iget-object v2, p0, mAppCompatWindowCallback:Landroid/view/Window$Callback;

    invoke-virtual {v1, v2}, Landroid/view/Window;->setCallback(Landroid/view/Window$Callback;)V

    :goto_0
    invoke-virtual {p0}, invalidateOptionsMenu()V
...
.method public startSupportActionMode(Lcom/oneplus/lib/app/appcompat/ActionMode$Callback;)Lcom/oneplus/lib/app/appcompat/ActionMode;
    ...
    iput-object v2, p0, mActionMode:Lcom/oneplus/lib/app/appcompat/ActionMode;

    iget-object v2, p0, mActionMode:Lcom/oneplus/lib/app/appcompat/ActionMode;

    if-eqz v2, :cond_1

    iget-object v2, p0, mAppCompatCallback:Lcom/oneplus/lib/app/appcompat/AppCompatCallback;

    if-eqz v2, :cond_1

    iget-object v2, p0, mAppCompatCallback:Lcom/oneplus/lib/app/appcompat/AppCompatCallback;

    iget-object v3, p0, mActionMode:Lcom/oneplus/lib/app/appcompat/ActionMode;
    ...
    invoke-virtual {p0, v0}, startSupportActionModeFromWindow(Lcom/oneplus/lib/app/appcompat/ActionMode$Callback;)Lcom/oneplus/lib/app/appcompat/ActionMode;
...
.method startSupportActionModeFromWindow(Lcom/oneplus/lib/app/appcompat/ActionMode$Callback;)Lcom/oneplus/lib/app/appcompat/ActionMode;
    ...
    iget-object v1, p0, mAppCompatCallback:Lcom/oneplus/lib/app/appcompat/AppCompatCallback;
    ...
    iput-object v0, p0, mActionMode:Lcom/oneplus/lib/app/appcompat/ActionMode;

    goto/16 :goto_5

    :cond_3
    iget-object v1, p0, mActionModeView:Lcom/oneplus/lib/app/appcompat/ActionBarContextView;
    ...
    iput-object v6, p0, mActionModeView:Lcom/oneplus/lib/app/appcompat/ActionBarContextView;
    ...
    iput-object v6, p0, mActionModePopup:Landroid/widget/PopupWindow;
    ...
    iget-object v8, p0, mActionModeView:Lcom/oneplus/lib/app/appcompat/ActionBarContextView;
    ...
    iput-object v5, p0, mActionModeView:Lcom/oneplus/lib/app/appcompat/ActionBarContextView;
    ...
    iget-object v5, p0, mActionModeView:Lcom/oneplus/lib/app/appcompat/ActionBarContextView;

    invoke-virtual {v5}, Lcom/oneplus/lib/app/appcompat/ActionBarContextView;->getContext()Landroid/content/Context;

    move-result-object v5

    iget-object v6, p0, mActionModeView:Lcom/oneplus/lib/app/appcompat/ActionBarContextView;

    iget-object v7, p0, mActionModePopup:Landroid/widget/PopupWindow;
    ...
    iput-object v1, p0, mFadeAnim:Landroid/view/ViewPropertyAnimator;

    iget-object v1, p0, mFadeAnim:Landroid/view/ViewPropertyAnimator;
    ...
    :cond_a
    :goto_4
    iget-object v1, p0, mActionModePopup:Landroid/widget/PopupWindow;
    ...
    :cond_c
    :goto_5
    iget-object v1, p0, mActionMode:Lcom/oneplus/lib/app/appcompat/ActionMode;
...
.method updateStatusGuard(I)I
    ...
    iget-object v4, p0, mActionModeView:Lcom/oneplus/lib/app/appcompat/ActionBarContextView;
    ...
    iget-object v4, p0, mTempRect1:Landroid/graphics/Rect;
    ...
    iput-object v4, p0, mTempRect1:Landroid/graphics/Rect;

    new-instance v4, Landroid/graphics/Rect;

    invoke-direct {v4}, Landroid/graphics/Rect;-><init>()V

    iput-object v4, p0, mTempRect2:Landroid/graphics/Rect;
    ...
    iget-object v6, p0, mSubDecor:Landroid/view/ViewGroup;
    ...
    iget-object v7, p0, mSubDecor:Landroid/view/ViewGroup;
    ...
    iget-boolean v7, p0, mOverlayActionMode:Z
    ...
    :cond_8
    iget-object v1, p0, mStatusGuard:Landroid/view/View;
