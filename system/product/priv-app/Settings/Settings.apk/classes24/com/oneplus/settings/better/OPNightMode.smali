...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mNightModeSeekBarContentObserver:Landroid/database/ContentObserver;
...
.method static synthetic access$000(Lcom/oneplus/settings/better/OPNightMode;)Landroid/hardware/display/ColorDisplayManager;
    ...
    iget-object v0, p0, mColorDisplayManager:Landroid/hardware/display/ColorDisplayManager;
...
.method static synthetic access$300(Lcom/oneplus/settings/better/OPNightMode;)Landroidx/preference/SwitchPreference;
    ...
    iget-object v0, p0, mNightModeEnabledPreference:Landroidx/preference/SwitchPreference;
...
.method static synthetic access$500(Lcom/oneplus/settings/better/OPNightMode;)V
    ...
    invoke-direct {p0}, disableEntryForWellbeingGrayscale()V
...
.method public static checkCurrentValueIsDefault(IF)Z
    ...
    sget v0, DEFAULT_COLOR_PROGRESS:I
...
.method private closeNightModeGradually(F)V
    ...
    iget-object v0, p0, mRestoreBrightnessAnimator:Landroid/animation/ValueAnimator;
    ...
    iput-object v0, p0, mRestoreBrightnessAnimator:Landroid/animation/ValueAnimator;
...
.method private disableEntryForWellbeingGrayscale()V
    ...
    :goto_1
    iget-object v4, p0, mNightModeEnabledPreference:Landroidx/preference/SwitchPreference;
    ...
    :cond_3
    iget-object v4, p0, mAutoActivatePreference:Landroidx/preference/ListPreference;
    ...
    :cond_5
    iget-object v4, p0, mNightModeLevelPreferenceCategory:Lcom/oneplus/settings/ui/OPNightModeLevelPreferenceCategory;
...
.method private getFormattedTimeString(Ljava/time/LocalTime;)Ljava/lang/String;
    ...
    iget-object v1, p0, mTimeFormatter:Ljava/text/DateFormat;
...
.method private openNightModeGradually(IF)V
    ...
    iget-object v0, p0, mOPenNightModeAnimator:Landroid/animation/ValueAnimator;
    ...
    iput-object v0, p0, mOPenNightModeAnimator:Landroid/animation/ValueAnimator;
...
.method private updateAutoActivateModePreferenceDescription(I)V
    ...
    iget-object v0, p0, mAutoActivatePreference:Landroidx/preference/ListPreference;
    ...
    iget-object v1, p0, mAutoActivatePreference:Landroidx/preference/ListPreference;
...
.method public onAutoModeChanged(I)V
    ...
    :goto_0
    iget-object v1, p0, mTurnOnTimePreference:Landroidx/preference/Preference;

    invoke-virtual {v1, v0}, Landroidx/preference/Preference;->setVisible(Z)V

    iget-object v1, p0, mTurnOffTimePreference:Landroidx/preference/Preference;
...
.method public onBrightnessProgressChanged(IZ)V
    ...
    :cond_0
    invoke-direct {p0, p1}, saveBrightnessProgress(I)V
...
.method public onBrightnessStopTrackingTouch(I)V
    ...
    invoke-virtual {p0, p1, v0}, onBrightnessProgressChanged(IZ)V
...
.method public onColorProgressChanged(IZ)V
    ...
    :cond_0
    invoke-direct {p0, p1}, saveColorTemperatureProgress(I)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-boolean v1, p0, isSupportReadingMode:Z
    ...
    iput-object v1, p0, mColorDisplayManager:Landroid/hardware/display/ColorDisplayManager;
    ...
    iput-object v1, p0, mNightDisplayListener:Landroid/hardware/display/NightDisplayListener;
    ...
    iput-object v1, p0, mNightModeEnabledPreference:Landroidx/preference/SwitchPreference;
    ...
    iput-object v1, p0, mAutoActivatePreference:Landroidx/preference/ListPreference;
    ...
    iput-object v1, p0, mTurnOnTimePreference:Landroidx/preference/Preference;
    ...
    iput-object v1, p0, mTurnOffTimePreference:Landroidx/preference/Preference;
    ...
    iput-object v1, p0, mNightModeLevelPreferenceCategory:Lcom/oneplus/settings/ui/OPNightModeLevelPreferenceCategory;

    iget-object v1, p0, mNightModeEnabledPreference:Landroidx/preference/SwitchPreference;
    ...
    :cond_0
    iget-object v1, p0, mNightModeLevelPreferenceCategory:Lcom/oneplus/settings/ui/OPNightModeLevelPreferenceCategory;
    ...
    iget-object v2, p0, mColorDisplayManager:Landroid/hardware/display/ColorDisplayManager;
    ...
    iput-object v1, p0, mTimeFormatter:Ljava/text/DateFormat;
    ...
    iget-object v1, p0, mColorDisplayManager:Landroid/hardware/display/ColorDisplayManager;

    invoke-virtual {v1}, Landroid/hardware/display/ColorDisplayManager;->getNightDisplayAutoMode()I

    move-result v1

    invoke-static {v1}, convertAutoMode(I)I

    move-result v1

    invoke-direct {p0, v1}, updateAutoActivateModePreferenceDescription(I)V
    ...
    iput-object v1, p0, mCM:Lcom/oneplus/settings/OneplusColorManager;
    ...
    :cond_2
    iput-boolean v3, p0, mIsReadingModeOn:Z
...
.method public onCustomEndTimeChanged(Ljava/time/LocalTime;)V
    ...
    iget-object v0, p0, mTurnOffTimePreference:Landroidx/preference/Preference;

    invoke-direct {p0, p1}, getFormattedTimeString(Ljava/time/LocalTime;)Ljava/lang/String;
...
.method public onCustomStartTimeChanged(Ljava/time/LocalTime;)V
    ...
    iget-object v0, p0, mTurnOnTimePreference:Landroidx/preference/Preference;
...
.method public onPreferenceChange(Landroidx/preference/Preference;Ljava/lang/Object;)Z
    ...
    iget-object v3, p0, mNightModeLevelPreferenceCategory:Lcom/oneplus/settings/ui/OPNightModeLevelPreferenceCategory;
    ...
    iget-object v5, p0, mColorDisplayManager:Landroid/hardware/display/ColorDisplayManager;

    invoke-virtual {v5, v2}, Landroid/hardware/display/ColorDisplayManager;->setNightDisplayActivated(Z)Z

    invoke-direct {p0, v3}, saveColorTemperatureProgress(I)V

    invoke-direct {p0, v4}, saveBrightnessProgress(I)V
    ...
    iget-object v3, p0, mColorDisplayManager:Landroid/hardware/display/ColorDisplayManager;
    ...
    invoke-static {v3}, convertAutoMode(I)I

    move-result v3

    invoke-direct {p0, v3}, updateAutoActivateModePreferenceDescription(I)V
...
.method public onPreferenceTreeClick(Landroidx/preference/Preference;)Z
    ...
    invoke-virtual {p0, v1}, showDialog(I)V
    ...
    invoke-virtual {p0, v2}, showDialog(I)V
...
.method public onResume()V
    ...
    invoke-virtual {p0, v0}, onActivated(Z)V
    ...
    invoke-static {v0}, convertAutoMode(I)I

    move-result v0

    iput v0, p0, mEnterAutoOpenValue:I

    invoke-virtual {p0}, getContentResolver()Landroid/content/ContentResolver;

    move-result-object v0

    sget v1, DEFAULT_COLOR_PROGRESS:I
    ...
    iput v0, p0, mEnterScreenColorValue:I
    ...
    iput v0, p0, mEnterBrightnessValue:F
...
.method public onStart()V
    ...
    iget-object v0, p0, mNightDisplayListener:Landroid/hardware/display/NightDisplayListener;
    ...
    invoke-virtual {p0, v0}, onAutoModeChanged(I)V
    ...
    invoke-virtual {p0, v0}, onCustomStartTimeChanged(Ljava/time/LocalTime;)V
    ...
    invoke-virtual {p0, v0}, onCustomEndTimeChanged(Ljava/time/LocalTime;)V
    ...
    iget-object v2, p0, mNightModeSeekBarContentObserver:Landroid/database/ContentObserver;
...
.method public onStop()V
    ...
    iget-object v1, v0, mNightDisplayListener:Landroid/hardware/display/NightDisplayListener;
    ...
    iget-object v2, v0, mNightModeSeekBarContentObserver:Landroid/database/ContentObserver;

    invoke-virtual {v1, v2}, Landroid/content/ContentResolver;->unregisterContentObserver(Landroid/database/ContentObserver;)V

    iget-object v1, v0, mColorDisplayManager:Landroid/hardware/display/ColorDisplayManager;
    ...
    iget v2, v0, mEnterAutoOpenValue:I

    const-string v3, "night_mode"

    if-eq v2, v1, :cond_0

    iget-object v2, v0, mColorDisplayManager:Landroid/hardware/display/ColorDisplayManager;

    invoke-virtual {v2}, Landroid/hardware/display/ColorDisplayManager;->getNightDisplayAutoMode()I

    move-result v2

    invoke-static {v2}, convertAutoMode(I)I
    ...
    sget v4, DEFAULT_COLOR_PROGRESS:I
    ...
    iget v4, v0, mEnterScreenColorValue:I
    ...
    iget-object v4, v0, mNightModeLevelPreferenceCategory:Lcom/oneplus/settings/ui/OPNightModeLevelPreferenceCategory;
    ...
    invoke-static {v3, v5, v8}, Lcom/oneplus/settings/utils/OPUtils;->sendAnalytics(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v11, "oem_nightmode_brightness_progress"

    const/4 v12, -0x2

    invoke-static {v5, v11, v6, v12}, Landroid/provider/Settings$System;->getFloatForUser(Landroid/content/ContentResolver;Ljava/lang/String;FI)F

    move-result v5

    iget v6, v0, mEnterBrightnessValue:F
    ...
    iget-object v6, v0, mNightModeLevelPreferenceCategory:Lcom/oneplus/settings/ui/OPNightModeLevelPreferenceCategory;
    ...
    const-wide v15, 0x3fd51eb851eb851fL    # 0.33
    ...
    invoke-static {v3, v11, v8}, Lcom/oneplus/settings/utils/OPUtils;->sendAnalytics(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v3, v11, v7}, Lcom/oneplus/settings/utils/OPUtils;->sendAnalytics(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v3, v11, v4}, Lcom/oneplus/settings/utils/OPUtils;->sendAnalytics(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
