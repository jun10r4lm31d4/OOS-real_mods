...
.method constructor <init>(Ljava/io/File;)V
    ...
    iput-object v0, p0, mResults:Landroid/util/SparseArray;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, mObservers:Landroid/util/SparseArray;

    new-instance v0, Landroid/util/AtomicFile;

    invoke-direct {v0, p1}, Landroid/util/AtomicFile;-><init>(Ljava/io/File;)V

    iput-object v0, p0, mResultsFile:Landroid/util/AtomicFile;
    ...
    :try_start_0
    iget-object v0, p0, mResultsFile:Landroid/util/AtomicFile;
    ...
    invoke-static {v1}, nextElement(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    invoke-static {v1, v3}, readIntAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)I

    move-result v3

    iput v3, p0, mCounter:I
    ...
    invoke-static {v1, v4}, readIntAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)I
    ...
    invoke-static {v1, v4}, readStringAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v9

    iget-object v4, p0, mResults:Landroid/util/SparseArray;
    ...
    iget-object v1, p0, mResults:Landroid/util/SparseArray;

    invoke-virtual {v1}, Landroid/util/SparseArray;->clear()V

    invoke-direct {p0}, writeState()V
...
.method private writeState()V
    ...
    :try_start_0
    iput-boolean v1, p0, mIsPersistingStateValid:Z

    iget-boolean v1, p0, mIsPersistScheduled:Z

    if-nez v1, :cond_0

    const/4 v1, 0x1

    iput-boolean v1, p0, mIsPersistScheduled:Z
...
.method addObserver(ILcom/oneplus/settings/packageuninstaller/EventResultPersister$EventResultObserver;)I
    ...
    :cond_0
    iget-object v2, p0, mResults:Landroid/util/SparseArray;
    ...
    iget-object v3, p0, mResults:Landroid/util/SparseArray;
    ...
    :cond_1
    iget-object v2, p0, mObservers:Landroid/util/SparseArray;
...
.method public synthetic lambda$writeState$0$EventResultPersister()V
    ...
    iput-boolean v3, p0, mIsPersistingStateValid:Z
    ...
    :try_start_1
    iget-object v4, p0, mResultsFile:Landroid/util/AtomicFile;
    ...
    iget-object v5, p0, mResultsFile:Landroid/util/AtomicFile;
    ...
    :try_start_2
    iget-boolean v0, p0, mIsPersistingStateValid:Z

    if-eqz v0, :cond_3

    const/4 v0, 0x0

    iput-boolean v0, p0, mIsPersistScheduled:Z
...
.method onEventReceived(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    iget-object v14, v7, mLock:Ljava/lang/Object;

    monitor-enter v14

    :try_start_0
    iget-object v0, v7, mObservers:Landroid/util/SparseArray;
    ...
    iget-object v3, v7, mObservers:Landroid/util/SparseArray;
    ...
    :cond_3
    iget-object v6, v7, mResults:Landroid/util/SparseArray;
    ...
    invoke-direct/range {p0 .. p0}, writeState()V
...
.method removeObserver(I)V
    ...
    :try_start_0
    iget-object v1, p0, mObservers:Landroid/util/SparseArray;
