...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object v5, p0, mTypeface:Landroid/graphics/Typeface;
    ...
    iget-object v5, p0, mPaintCenter:Landroid/graphics/Paint;

    invoke-virtual {v5, v2}, Landroid/graphics/Paint;->setAntiAlias(Z)V

    iget-object v5, p0, mPaintSelector:[Landroid/graphics/Paint;
    ...
    iget-object v5, p0, mPaintBackground:Landroid/graphics/Paint;
    ...
    iput v6, p0, mSelectorDotRadius:I
    ...
    iput v6, p0, mCenterDotRadius:I

    iget-object v6, p0, mTextSize:[I
    ...
    iget-object v6, p0, mTextInset:[I
    ...
    iput-object v1, p0, mTouchHelper:Lcom/oneplus/lib/widget/RadialTimePickerView$RadialPickerTouchHelper;

    iget-object v1, p0, mTouchHelper:Lcom/oneplus/lib/widget/RadialTimePickerView$RadialPickerTouchHelper;
    ...
    invoke-direct {p0, v6, v3, v3}, setCurrentHourInternal(IZZ)V

    invoke-direct {p0, v0, v3}, setCurrentMinuteInternal(IZ)V
    ...
    iput-object v3, p0, mVibrator:Landroid/os/Vibrator;

    :cond_1
    invoke-virtual {p0, v2}, setHapticFeedbackEnabled(Z)V
...
.method private animatePicker(ZJ)V
    ...
    :goto_0
    iget v1, p0, mHoursToMinutes:F

    cmpl-float v2, v1, v0

    if-nez v2, :cond_2

    iget-object v1, p0, mHoursToMinutesAnimator:Landroid/animation/ObjectAnimator;
    ...
    iput-object v1, p0, mHoursToMinutesAnimator:Landroid/animation/ObjectAnimator;
    ...
    iput-object v2, p0, mHoursToMinutesAnimator:Landroid/animation/ObjectAnimator;

    iget-object v2, p0, mHoursToMinutesAnimator:Landroid/animation/ObjectAnimator;
...
.method private calculatePositionsHours()V
    ...
    iget-object v1, p0, mTextSize:[I

    aget v1, v1, v2

    int-to-float v7, v1

    iget-object v1, p0, mOuterTextX:[[F

    aget-object v8, v1, v2

    iget-object v1, p0, mOuterTextY:[[F
    ...
    iget-object v3, p0, mTextInset:[I
    ...
    iget-object v2, p0, mTextSize:[I

    aget v2, v2, v4

    int-to-float v9, v2

    iget-object v10, p0, mInnerTextX:[F

    iget-object v11, p0, mInnerTextY:[F

    invoke-static/range {v5 .. v11}, calculatePositions(Landroid/graphics/Paint;FFFF[F[F)V
...
.method private drawHours(Landroid/graphics/Canvas;Landroid/graphics/Path;F)V
    ...
    invoke-direct {p0, p1, v0, v1}, drawHoursClipped(Landroid/graphics/Canvas;IZ)V
...
.method private drawMinutes(Landroid/graphics/Canvas;Landroid/graphics/Path;F)V
    ...
    invoke-direct {p0, p1, v0, v1}, drawMinutesClipped(Landroid/graphics/Canvas;IZ)V
...
.method private drawMinutesClipped(Landroid/graphics/Canvas;IZ)V
    ...
    iget-object v5, v13, mMinutesText:[Ljava/lang/String;
...
.method private drawSelector(Landroid/graphics/Canvas;Landroid/graphics/Path;)V
    ...
    iget-boolean v1, v0, mIsOnInnerCircle:Z
    ...
    iget-object v1, v0, mTextInset:[I
    ...
    :goto_2
    iget v1, v0, mSelectorRadius:I

    iget v2, v0, mCircleRadius:I
    ...
    iget-object v2, v0, oval:Landroid/graphics/RectF;

    invoke-virtual/range {p0 .. p0}, getCurrentMinute()I

    move-result v1

    invoke-direct {v0, v1}, getDegreesForMinute(I)I
...
.method private drawTextElements(Landroid/graphics/Canvas;FLandroid/graphics/Typeface;Landroid/content/res/ColorStateList;[Ljava/lang/String;[F[FLandroid/graphics/Paint;IZIZ)V
    ...
    invoke-direct {v12, v9, v14}, getMultipliedAlpha(II)I
...
.method private handleTouchInput(FFZZ)Z
    ...
    :cond_0
    iget-boolean v3, p0, mShowHours:Z

    const-wide/16 v4, 0x3c

    invoke-direct {p0, v3, v4, v5}, animatePicker(ZJ)V
    ...
    invoke-static {v2, v1}, snapOnly30s(II)I

    move-result v3

    rem-int/lit16 v3, v3, 0x168

    iget-boolean v5, p0, mIsOnInnerCircle:Z
    ...
    iget-object v6, p0, mSelectionDegrees:[I
    ...
    :cond_3
    invoke-static {v2}, snapPrefer30s(I)I
    ...
    iput-object v1, p0, mVibratePattern:[J

    iget-object v1, p0, mVibratePattern:[J
...
.method private initHoursAndMinutesText()V
    ...
    sget-object v3, MINUTES_NUMBERS:[I
...
.method private setCurrentHourInternal(IZZ)V
    ...
    iget-object v4, p0, mTouchHelper:Lcom/oneplus/lib/widget/RadialTimePickerView$RadialPickerTouchHelper;
    ...
    iget-object v4, p0, mListener:Lcom/oneplus/lib/widget/RadialTimePickerView$OnValueSelectedListener;
...
.method private setCurrentMinuteInternal(IZ)V
    ...
    iget-object v0, p0, mListener:Lcom/oneplus/lib/widget/RadialTimePickerView$OnValueSelectedListener;
...
.method private showPicker(ZZ)V
    ...
    :cond_1
    iget-object v0, p0, mHoursToMinutesAnimator:Landroid/animation/ObjectAnimator;
    ...
    iput-object v0, p0, mHoursToMinutesAnimator:Landroid/animation/ObjectAnimator;
...
.method applyAttributes(Landroid/util/AttributeSet;II)V
    ...
    :goto_2
    iget-object v8, p0, mPaintCenter:Landroid/graphics/Paint;
    ...
    iput v6, p0, mSelectorColor:I

    iget-object v8, p0, mTextColor:[Landroid/content/res/ColorStateList;
    ...
    iput v7, p0, mSelectorDotColor:I

    iget-object v7, p0, mPaintBackground:Landroid/graphics/Paint;
...
.method public initialize(IIZ)V
    ...
    invoke-direct {p0, p1, v0, v0}, setCurrentHourInternal(IZZ)V

    invoke-direct {p0, p2, v0}, setCurrentMinuteInternal(IZ)V
...
.method protected onLayout(ZIIII)V
    ...
    iput v3, p0, mCircleRadius:I

    iget v3, p0, mCircleRadius:I

    iget-object v4, p0, mTextInset:[I

    aget v5, v4, v1

    sub-int v5, v3, v5

    iget v6, p0, mSelectorRadius:I

    sub-int/2addr v5, v6

    iput v5, p0, mMinDistForInnerNumber:I
    ...
    iput v7, p0, mMaxDistForOuterNumber:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iput-boolean v4, p0, mChangedDuringTouch:Z
    ...
    iget-boolean v4, p0, mChangedDuringTouch:Z
    ...
    invoke-direct {p0, v5, v6, v2, v3}, handleTouchInput(FFZZ)Z
