...
.method public constructor <init>(Lcom/oneplus/lib/widget/listitem/OPListitemBuilder;Landroid/content/Context;)V
    ...
    iput-object p1, p0, this$0:Lcom/oneplus/lib/widget/listitem/OPListitemBuilder;
    ...
    iput-object p1, p0, mIcon:Landroid/widget/ImageView;

    iput-object p1, p0, mPrimaryText:Landroid/widget/TextView;

    iput-object p1, p0, mSecondaryText:Landroid/widget/TextView;

    iput-object p1, p0, mStamp:Landroid/widget/TextView;

    iput-object p1, p0, mActionButton:Landroid/widget/ImageView;

    const/4 v0, -0x1

    iput v0, p0, mIconSize:I

    iput v0, p0, mActionBtnSize:I

    const/4 v0, 0x0

    iput v0, p0, mMarginM1:I

    iput v0, p0, mRemainHeight:I
...
.method private init()V
    ...
    iget-object v0, p0, this$0:Lcom/oneplus/lib/widget/listitem/OPListitemBuilder;
    ...
    iput-object v0, p0, mPrimaryText:Landroid/widget/TextView;
    ...
    iput-object v0, p0, mSecondaryText:Landroid/widget/TextView;
    ...
    iput-object v0, p0, mStamp:Landroid/widget/TextView;

    iget-object v0, p0, mStamp:Landroid/widget/TextView;
    ...
    iput-object v0, p0, mActionButton:Landroid/widget/ImageView;
    ...
    iget-object v0, p0, mActionButton:Landroid/widget/ImageView;

    new-instance v1, Landroid/view/ViewGroup$LayoutParams;

    iget v2, p0, mActionBtnSize:I
...
.method private layoutLTR(IIII)V
    ...
    iget v3, p0, mMarginM1:I

    add-int/2addr v3, p1

    iget v4, p0, mIconSize:I
    ...
    :cond_0
    iget-object v2, p0, mActionButton:Landroid/widget/ImageView;
    ...
    iget-object v6, p0, mPrimaryText:Landroid/widget/TextView;

    invoke-virtual {v6, v3, v4, v2, v5}, Landroid/widget/TextView;->layout(IIII)V

    :cond_3
    iget-object v2, p0, mStamp:Landroid/widget/TextView;
    ...
    iget-object v4, p0, mSecondaryText:Landroid/widget/TextView;
    ...
    iget-object v6, p0, mStamp:Landroid/widget/TextView;
    ...
    :cond_4
    iget-object v4, p0, mStamp:Landroid/widget/TextView;
    ...
    :goto_0
    iget-object v5, p0, mStamp:Landroid/widget/TextView;
...
.method protected onLayout(ZIIII)V
    ...
    invoke-direct {p0, p2, p3, p4, p5}, layoutLTR(IIII)V
...
.method protected onMeasure(II)V
    ...
    iget-object v6, p0, mIcon:Landroid/widget/ImageView;
    ...
    iget v8, p0, mMarginM1:I

    sub-int v4, v6, v8

    :cond_0
    iget-object v6, p0, mActionButton:Landroid/widget/ImageView;

    if-eqz v6, :cond_1

    iget v8, p0, mActionBtnSize:I

    invoke-static {v8, v7}, Landroid/view/View$MeasureSpec;->makeMeasureSpec(II)I

    move-result v8

    iget v9, p0, mActionBtnSize:I
    ...
    iget v6, p0, mActionBtnSize:I

    sub-int v6, v4, v6

    iget v7, p0, mMarginM1:I
