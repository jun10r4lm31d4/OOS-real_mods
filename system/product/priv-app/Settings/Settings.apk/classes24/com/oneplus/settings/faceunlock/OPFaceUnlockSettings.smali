...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, mPasswordConfirmed:Z
    ...
    iput-object v0, p0, mFaceUnlockConnection:Landroid/content/ServiceConnection;
...
.method static synthetic access$002(Lcom/oneplus/settings/faceunlock/OPFaceUnlockSettings;Lcom/oneplus/faceunlock/internal/IOPFaceSettingService;)Lcom/oneplus/faceunlock/internal/IOPFaceSettingService;
    ...
    iput-object p1, p0, mFaceSettingService:Lcom/oneplus/faceunlock/internal/IOPFaceSettingService;
...
.method static synthetic access$300(Lcom/oneplus/settings/faceunlock/OPFaceUnlockSettings;)V
    ...
    invoke-direct {p0}, gotoAddFaceData()V
...
.method static synthetic access$400(Lcom/oneplus/settings/faceunlock/OPFaceUnlockSettings;)V
    ...
    invoke-direct {p0}, removeFaceData()V
...
.method private bindFaceUnlockService()V
    ...
    iget-object v3, p0, mFaceUnlockConnection:Landroid/content/ServiceConnection;
...
.method private disableAutoUnlockSettings(Z)V
    ...
    iget-object v0, p0, mAutoFaceUnlock:Landroidx/preference/SwitchPreference;
...
.method private disableFaceUnlockAssistiveLightingSettings(Z)V
    ...
    iget-object v0, p0, mFaceUnlockAssistiveLighting:Landroidx/preference/SwitchPreference;
...
.method private disableFaceUnlockModeSettings(Z)V
    ...
    iget-object v0, p0, mFaceUnlockMode:Landroidx/preference/Preference;
...
.method private initView()V
    ...
    iput-object v0, p0, mFaceUnlockCategory:Landroidx/preference/PreferenceCategory;
    ...
    iput-object v0, p0, mFaceUnlockManagerCategory:Landroidx/preference/PreferenceCategory;
    ...
    iput-object v0, p0, mAddFace:Landroidx/preference/Preference;

    iget-object v0, p0, mAddFace:Landroidx/preference/Preference;
    ...
    iput-object v0, p0, mRemoveFace:Landroidx/preference/Preference;

    iget-object v0, p0, mRemoveFace:Landroidx/preference/Preference;
    ...
    iput-object v0, p0, mFaceUnlock:Landroidx/preference/SwitchPreference;

    iget-object v0, p0, mFaceUnlock:Landroidx/preference/SwitchPreference;
    ...
    iput-object v0, p0, mAutoFaceUnlock:Landroidx/preference/SwitchPreference;
    ...
    iput-object v0, p0, mFaceUnlockAssistiveLighting:Landroidx/preference/SwitchPreference;
    ...
    iput-object v0, p0, mFaceUnlockMode:Landroidx/preference/Preference;
...
.method private isFaceAdded()Z
    ...
    iget-object v1, p0, mFaceSettingService:Lcom/oneplus/faceunlock/internal/IOPFaceSettingService;
...
.method private refreshUI()V
    ...
    invoke-direct {p0}, isFaceAdded()Z
    ...
    iget-object v0, p0, mFaceUnlockCategory:Landroidx/preference/PreferenceCategory;

    iget-object v3, p0, mRemoveFace:Landroidx/preference/Preference;

    invoke-virtual {v0, v3}, Landroidx/preference/PreferenceCategory;->addPreference(Landroidx/preference/Preference;)Z

    iget-object v0, p0, mFaceUnlockCategory:Landroidx/preference/PreferenceCategory;

    iget-object v3, p0, mAddFace:Landroidx/preference/Preference;
    ...
    invoke-direct {p0, v0}, disableAutoUnlockSettings(Z)V
    ...
    invoke-direct {p0, v0}, disableFaceUnlockAssistiveLightingSettings(Z)V
    ...
    invoke-direct {p0, v0}, disableFaceUnlockModeSettings(Z)V
    ...
    invoke-direct {p0}, isFaceUnlockEnabled()Z
    ...
    invoke-direct {p0}, isAutoFaceUnlockEnabled()Z
    ...
    invoke-direct {p0}, isFaceUnlockAssistiveLightingEnabled()Z
    ...
    iget-object v2, p0, mFaceUnlockMode:Landroidx/preference/Preference;
...
.method private removeFaceData()V
    ...
    iget-object v0, p0, mFaceSettingService:Lcom/oneplus/faceunlock/internal/IOPFaceSettingService;
...
.method private switchFaceUnlock(Z)V
    ...
    invoke-direct {p0, p1}, disableAutoUnlockSettings(Z)V

    invoke-direct {p0, p1}, disableFaceUnlockAssistiveLightingSettings(Z)V

    invoke-direct {p0, p1}, disableFaceUnlockModeSettings(Z)V
...
.method private unbindFaceUnlockService()V
    ...
    iget-object v1, p0, mFaceUnlockConnection:Landroid/content/ServiceConnection;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0}, bindFaceUnlockService()V
...
.method public onDestroy()V
    ...
    invoke-direct {p0}, unbindFaceUnlockService()V
...
.method public onPreferenceChange(Landroidx/preference/Preference;Ljava/lang/Object;)Z
    ...
    invoke-direct {p0, v1}, switchFaceUnlock(Z)V
    ...
    invoke-direct {p0, v1}, switchAutoFaceUnlock(Z)V
    ...
    invoke-direct {p0, v1}, switchFaceUnlockAssistiveLighting(Z)V
...
.method public onPreferenceClick(Landroidx/preference/Preference;)Z
    ...
    invoke-virtual {p0}, showDisableAospFaceUnlockDialog()V
    ...
    invoke-virtual {p0}, showRemoveFaceDataDialog()V
...
.method public showRemoveFaceDataDialog()V
    ...
    iput-object v0, p0, mRemoveDialog:Landroid/app/AlertDialog;

    iget-object v0, p0, mRemoveDialog:Landroid/app/AlertDialog;
