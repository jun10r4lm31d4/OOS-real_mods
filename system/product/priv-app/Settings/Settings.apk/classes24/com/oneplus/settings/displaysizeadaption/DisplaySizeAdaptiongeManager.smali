...
.method static constructor <clinit>()V
    ...
    sput-object v0, mFullScreenAppMap:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, mOriginalSizeAppMap:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, m17819FullScreenAppMap:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, mTmpFullScreenAppMap:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, mTmpOriginalSizeAppMap:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, mTmp17819FullScreenAppMap:Ljava/util/Map;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, multiAppInfo:Landroid/content/pm/ApplicationInfo;
...
.method public static getInstance(Landroid/content/Context;)Lcom/oneplus/settings/displaysizeadaption/DisplaySizeAdaptiongeManager;
    ...
    sget-object v0, mDisplaySizeAdaptiongeManager:Lcom/oneplus/settings/displaysizeadaption/DisplaySizeAdaptiongeManager;
    ...
    sput-object v0, mDisplaySizeAdaptiongeManager:Lcom/oneplus/settings/displaysizeadaption/DisplaySizeAdaptiongeManager;
...
.method private loadClassAppList(I)V
    ...
    :cond_8
    sget-object v12, mTmpFullScreenAppMap:Ljava/util/Map;

    invoke-interface {v12, v10}, Ljava/util/Map;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v12, mTmpOriginalSizeAppMap:Ljava/util/Map;

    invoke-interface {v12, v10}, Ljava/util/Map;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v12, mTmp17819FullScreenAppMap:Ljava/util/Map;
...
.method private loadFullScreenApp()V
    ...
    invoke-direct {p0, v0}, loadClassAppList(I)V
    ...
    sget-object v0, mFullScreenAppMap:Ljava/util/Map;

    invoke-interface {v0}, Ljava/util/Map;->clear()V

    sget-object v0, m17819FullScreenAppMap:Ljava/util/Map;

    invoke-interface {v0}, Ljava/util/Map;->clear()V

    new-instance v0, Ljava/util/HashMap;

    sget-object v1, mTmpFullScreenAppMap:Ljava/util/Map;
    ...
    sget-object v1, mTmp17819FullScreenAppMap:Ljava/util/Map;

    invoke-direct {v0, v1}, Ljava/util/HashMap;-><init>(Ljava/util/Map;)V

    sput-object v0, m17819FullScreenAppMap:Ljava/util/Map;

    sget-object v0, mTmpFullScreenAppMap:Ljava/util/Map;

    invoke-interface {v0}, Ljava/util/Map;->clear()V

    sget-object v0, mTmp17819FullScreenAppMap:Ljava/util/Map;
...
.method private loadOriginalSizeApp()V
    ...
    sget-object v0, mOriginalSizeAppMap:Ljava/util/Map;

    invoke-interface {v0}, Ljava/util/Map;->clear()V

    new-instance v0, Ljava/util/HashMap;

    sget-object v1, mTmpOriginalSizeAppMap:Ljava/util/Map;

    invoke-direct {v0, v1}, Ljava/util/HashMap;-><init>(Ljava/util/Map;)V

    sput-object v0, mOriginalSizeAppMap:Ljava/util/Map;

    sget-object v0, mTmpOriginalSizeAppMap:Ljava/util/Map;
...
.method private removeTask(Ljava/lang/String;)V
    ...
    iget v6, v2, Landroid/app/ActivityManager$RecentTaskInfo;->persistentId:I
...
.method public getAppTypeValue(Ljava/lang/String;)I
    ...
    sget-object v1, mOriginalSizeAppMap:Ljava/util/Map;
    ...
    sget-object v2, mFullScreenAppMap:Ljava/util/Map;
    ...
    sget-object v3, m17819FullScreenAppMap:Ljava/util/Map;
...
.method public loadAppMap()Ljava/util/Map;
    ...
    invoke-direct {p0}, loadFullScreenApp()V

    invoke-direct {p0}, loadOriginalSizeApp()V
...
.method public setClassApp(ILjava/lang/String;I)V
    ...
    invoke-direct {p0, p2}, removeTask(Ljava/lang/String;)V
    ...
    iput-object v2, p0, multiAppInfo:Landroid/content/pm/ApplicationInfo;
    :try_end_0
    ...
    :goto_0
    iget-object v2, p0, multiAppInfo:Landroid/content/pm/ApplicationInfo;
    ...
    const-string v2, "DisplaySizeAdaptiongeManager"
