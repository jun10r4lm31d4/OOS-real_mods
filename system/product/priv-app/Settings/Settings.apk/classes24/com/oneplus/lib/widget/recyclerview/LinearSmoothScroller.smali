...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mLinearInterpolator:Landroid/view/animation/LinearInterpolator;

    new-instance v0, Landroid/view/animation/DecelerateInterpolator;

    invoke-direct {v0}, Landroid/view/animation/DecelerateInterpolator;-><init>()V

    iput-object v0, p0, mDecelerateInterpolator:Landroid/view/animation/DecelerateInterpolator;

    const/4 v0, 0x0

    iput v0, p0, mInterimTargetDx:I

    iput v0, p0, mInterimTargetDy:I
    ...
    invoke-virtual {p0, v0}, calculateSpeedPerPixel(Landroid/util/DisplayMetrics;)F

    move-result v0

    iput v0, p0, MILLISECONDS_PER_PX:F
...
.method public calculateDxToMakeVisible(Landroid/view/View;I)I
    ...
    invoke-virtual {p0}, getLayoutManager()Lcom/oneplus/lib/widget/recyclerview/RecyclerView$LayoutManager;
    ...
    invoke-virtual/range {v4 .. v9}, calculateDtToFit(IIIII)I
...
.method protected calculateTimeForDeceleration(I)I
    ...
    invoke-virtual {p0, p1}, calculateTimeForScrolling(I)I
...
.method protected calculateTimeForScrolling(I)I
    ...
    iget v1, p0, MILLISECONDS_PER_PX:F
...
.method protected getHorizontalSnapPreference()I
    ...
    iget-object v0, p0, mTargetVector:Landroid/graphics/PointF;
...
.method protected onSeekTargetStep(IILcom/oneplus/lib/widget/recyclerview/RecyclerView$State;Lcom/oneplus/lib/widget/recyclerview/RecyclerView$SmoothScroller$Action;)V
    ...
    :cond_0
    iget v0, p0, mInterimTargetDx:I

    invoke-direct {p0, v0, p1}, clampApplyScroll(II)I

    move-result v0

    iput v0, p0, mInterimTargetDx:I

    iget v0, p0, mInterimTargetDy:I

    invoke-direct {p0, v0, p2}, clampApplyScroll(II)I
    ...
    invoke-virtual {p0, p4}, updateActionForInterimTarget(Lcom/oneplus/lib/widget/recyclerview/RecyclerView$SmoothScroller$Action;)V
...
.method protected onStop()V
    ...
    iput-object v0, p0, mTargetVector:Landroid/graphics/PointF;
...
.method protected onTargetFound(Landroid/view/View;Lcom/oneplus/lib/widget/recyclerview/RecyclerView$State;Lcom/oneplus/lib/widget/recyclerview/RecyclerView$SmoothScroller$Action;)V
    ...
    invoke-virtual {p0}, getHorizontalSnapPreference()I

    move-result v0

    invoke-virtual {p0, p1, v0}, calculateDxToMakeVisible(Landroid/view/View;I)I

    move-result v0

    invoke-virtual {p0}, getVerticalSnapPreference()I

    move-result v1

    invoke-virtual {p0, p1, v1}, calculateDyToMakeVisible(Landroid/view/View;I)I
    ...
    invoke-virtual {p0, v2}, calculateTimeForDeceleration(I)I
    ...
    iget-object v6, p0, mDecelerateInterpolator:Landroid/view/animation/DecelerateInterpolator;
...
.method protected updateActionForInterimTarget(Lcom/oneplus/lib/widget/recyclerview/RecyclerView$SmoothScroller$Action;)V
    ...
    invoke-virtual {p0, v0}, computeScrollVectorForPosition(I)Landroid/graphics/PointF;
    ...
    :cond_0
    invoke-virtual {p0, v0}, normalize(Landroid/graphics/PointF;)V
    ...
    iput v1, p0, mInterimTargetDy:I

    const/16 v1, 0x2710

    invoke-virtual {p0, v1}, calculateTimeForScrolling(I)I

    move-result v1

    iget v2, p0, mInterimTargetDx:I
    ...
    iget-object v5, p0, mLinearInterpolator:Landroid/view/animation/LinearInterpolator;
