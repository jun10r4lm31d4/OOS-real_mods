...
.method private handleMessage(Landroid/os/Message;)V
    ...
    invoke-virtual/range {p0 .. p0}, isFinishing()Z
    ...
    :cond_1
    invoke-direct/range {p0 .. p0}, initView()V
    ...
    iget-object v0, v1, mCallback:Landroid/os/IBinder;
    ...
    :goto_1
    invoke-virtual {v1, v4, v0}, setResult(ILandroid/content/Intent;)V
    ...
    invoke-virtual {v1, v9}, getString(I)Ljava/lang/String;
    ...
    invoke-virtual {v1, v0}, getString(I)Ljava/lang/String;

    move-result-object v0

    invoke-direct/range {p0 .. p0}, notifyPackageRemoved()V
    ...
    invoke-virtual/range {p0 .. p0}, setResultAndFinish()V
    ...
    invoke-virtual {v1, v8}, getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-direct {v1, v6, v9, v0}, isProfileOfOrSame(Landroid/os/UserManager;II)Z
    ...
    invoke-direct/range {p0 .. p0}, getProgressFragment()Lcom/oneplus/settings/packageuninstaller/UninstallAppProgress$ProgressFragment;
    ...
    invoke-direct {v1, v6, v0, v14}, isProfileOfOrSame(Landroid/os/UserManager;II)Z
    ...
    invoke-virtual {v1, v4}, getString(I)Ljava/lang/String;
    ...
    :cond_12
    iget-boolean v4, v1, mAllUsers:Z
...
.method private initView()V
    ...
    iget-boolean v0, p0, mIsViewInitialized:Z
    ...
    iput-boolean v0, p0, mIsViewInitialized:Z
    ...
    iget-object v2, p0, mAppInfo:Landroid/content/pm/ApplicationInfo;
    ...
    :goto_2
    invoke-virtual {p0, v2}, setTitle(I)V
...
.method public getAppInfo()Landroid/content/pm/ApplicationInfo;
    ...
    iget-object v0, p0, mAppInfo:Landroid/content/pm/ApplicationInfo;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v1, p0, mAppInfo:Landroid/content/pm/ApplicationInfo;
    ...
    iput-object v1, p0, mCallback:Landroid/os/IBinder;
    ...
    iput v2, p0, mResultCode:I

    iget-object v2, p0, mCallback:Landroid/os/IBinder;
    ...
    :try_start_0
    iget-object v3, p0, mAppInfo:Landroid/content/pm/ApplicationInfo;

    iget-object v3, v3, Landroid/content/pm/ApplicationInfo;->packageName:Ljava/lang/String;

    iget v4, p0, mResultCode:I
    ...
    :cond_0
    invoke-virtual {p0}, setResultAndFinish()V
    ...
    iput-boolean v3, p0, mAllUsers:Z
    ...
    iget-boolean v7, p0, mAllUsers:Z
