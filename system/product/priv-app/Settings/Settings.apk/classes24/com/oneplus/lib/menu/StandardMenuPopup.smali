...
.method public constructor <init>(Landroid/content/Context;Lcom/oneplus/lib/menu/MenuBuilder;Landroid/view/View;IIZ)V
    ...
    iput-boolean p6, p0, mOverflowOnly:Z
    ...
    iput-object v1, p0, mAdapter:Lcom/oneplus/lib/menu/MenuAdapter;

    iput p4, p0, mPopupStyleAttr:I

    iput p5, p0, mPopupStyleRes:I
    ...
    iget v4, p0, mPopupStyleAttr:I

    iget v5, p0, mPopupStyleRes:I
    ...
    iput-object v2, p0, mPopup:Lcom/oneplus/lib/menu/MenuPopupWindow;
...
.method private tryShow()Z
    ...
    :cond_0
    iget-boolean v0, p0, mWasDismissed:Z
    ...
    iget-object v0, p0, mPopup:Lcom/oneplus/lib/menu/MenuPopupWindow;
    ...
    iput-object v4, p0, mTreeObserver:Landroid/view/ViewTreeObserver;

    if-eqz v3, :cond_3

    iget-object v4, p0, mTreeObserver:Landroid/view/ViewTreeObserver;

    iget-object v5, p0, mGlobalLayoutListener:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;

    invoke-virtual {v4, v5}, Landroid/view/ViewTreeObserver;->addOnGlobalLayoutListener(Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;)V

    :cond_3
    iget-object v4, p0, mAttachStateChangeListener:Landroid/view/View$OnAttachStateChangeListener;

    invoke-virtual {v0, v4}, Landroid/view/View;->addOnAttachStateChangeListener(Landroid/view/View$OnAttachStateChangeListener;)V

    iget-object v4, p0, mPopup:Lcom/oneplus/lib/menu/MenuPopupWindow;

    invoke-virtual {v4, v0}, Lcom/oneplus/lib/menu/MenuPopupWindow;->setAnchorView(Landroid/view/View;)V

    iget-object v4, p0, mPopup:Lcom/oneplus/lib/menu/MenuPopupWindow;

    iget v5, p0, mDropDownGravity:I

    invoke-virtual {v4, v5}, Lcom/oneplus/lib/menu/MenuPopupWindow;->setDropDownGravity(I)V

    iget-boolean v4, p0, mHasContentWidth:Z

    const/4 v5, 0x0

    if-nez v4, :cond_4

    iget-object v4, p0, mAdapter:Lcom/oneplus/lib/menu/MenuAdapter;

    iget-object v6, p0, mContext:Landroid/content/Context;

    iget v7, p0, mPopupMaxWidth:I

    invoke-static {v4, v5, v6, v7}, measureIndividualMenuWidth(Landroid/widget/ListAdapter;Landroid/view/ViewGroup;Landroid/content/Context;I)I

    move-result v4

    iput v4, p0, mContentWidth:I

    iput-boolean v1, p0, mHasContentWidth:Z
    ...
    iget-boolean v6, p0, mShowTitle:Z

    if-eqz v6, :cond_6

    iget-object v6, p0, mMenu:Lcom/oneplus/lib/menu/MenuBuilder;
    ...
    iget-object v8, p0, mMenu:Lcom/oneplus/lib/menu/MenuBuilder;
    ...
    :cond_6
    iget-object v2, p0, mPopup:Lcom/oneplus/lib/menu/MenuPopupWindow;

    iget-object v5, p0, mAdapter:Lcom/oneplus/lib/menu/MenuAdapter;
...
.method public onDismiss()V
    ...
    iput-boolean v0, p0, mWasDismissed:Z
...
.method public onSubMenuSelected(Lcom/oneplus/lib/menu/SubMenuBuilder;)Z
    ...
    iget-object v5, p0, mShownAnchorView:Landroid/view/View;

    iget-boolean v6, p0, mOverflowOnly:Z

    iget v7, p0, mPopupStyleAttr:I

    iget v8, p0, mPopupStyleRes:I
    ...
    iget-object v2, p0, mPresenterCallback:Lcom/oneplus/lib/menu/MenuPresenter$Callback;
    ...
    iget v2, p0, mDropDownGravity:I

    invoke-virtual {v0, v2}, Lcom/oneplus/lib/menu/MenuPopupHelper;->setGravity(I)V

    iget-object v2, p0, mOnDismissListener:Landroid/widget/PopupWindow$OnDismissListener;
    ...
    iput-object v2, p0, mOnDismissListener:Landroid/widget/PopupWindow$OnDismissListener;
    ...
    iget-object v3, p0, mPopup:Lcom/oneplus/lib/menu/MenuPopupWindow;
    ...
    iget-object v1, p0, mPresenterCallback:Lcom/oneplus/lib/menu/MenuPresenter$Callback;
...
.method public setForceShowIcon(Z)V
    ...
    iget-object v0, p0, mAdapter:Lcom/oneplus/lib/menu/MenuAdapter;
