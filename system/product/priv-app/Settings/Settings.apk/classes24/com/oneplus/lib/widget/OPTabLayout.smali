...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, fast_out_slow_in_interpolator:Landroid/view/animation/Interpolator;

    const/4 v0, 0x0

    invoke-virtual {p0, v0}, setHorizontalScrollBarEnabled(Z)V
    ...
    iput-object v2, p0, mTabStrip:Lcom/oneplus/lib/widget/OPTabLayout$SlidingTabStrip;

    iget-object v2, p0, mTabStrip:Lcom/oneplus/lib/widget/OPTabLayout$SlidingTabStrip;

    const/4 v3, -0x2

    const/4 v4, -0x1

    invoke-virtual {p0, v2, v3, v4}, addView(Landroid/view/View;II)V
    ...
    iget-object v3, p0, mTabStrip:Lcom/oneplus/lib/widget/OPTabLayout$SlidingTabStrip;
    ...
    iput v3, p0, mTabTextAppearance:I
    ...
    iput v3, p0, mTabPaddingBottom:I

    iput v3, p0, mTabPaddingEnd:I

    iput v3, p0, mTabPaddingTop:I

    iput v3, p0, mTabPaddingStart:I

    sget v3, Lcom/oneplus/commonctrl/R$styleable;->OPTabLayout_op_tabPaddingStart:I

    iget v4, p0, mTabPaddingStart:I
    ...
    iget v4, p0, mTabPaddingBottom:I
    ...
    iget v3, p0, mTabTextAppearance:I

    invoke-direct {p0, v3}, loadTextColorFromTextAppearance(I)Landroid/content/res/ColorStateList;

    move-result-object v3

    iput-object v3, p0, mTabTextColors:Landroid/content/res/ColorStateList;
    ...
    iget-object v4, p0, mTabTextColors:Landroid/content/res/ColorStateList;

    invoke-virtual {v4}, Landroid/content/res/ColorStateList;->getDefaultColor()I

    move-result v4

    invoke-static {v4, v3}, createColorStateList(II)Landroid/content/res/ColorStateList;

    move-result-object v4

    iput-object v4, p0, mTabTextColors:Landroid/content/res/ColorStateList;
    ...
    iput v3, p0, mRequestedTabMaxWidth:I
    ...
    iput v3, p0, mTabBackgroundResId:I
    ...
    iput v3, p0, mContentInsetStart:I
    ...
    iput v3, p0, mTabHorizontalSpacing:I
    ...
    iput v0, p0, mTabGravity:I

    invoke-virtual {v2}, Landroid/content/res/TypedArray;->recycle()V

    invoke-direct {p0}, applyModeAndGravity()V
...
.method static synthetic access$100(Lcom/oneplus/lib/widget/OPTabLayout;I)V
    ...
    invoke-direct {p0, p1}, updateTab(I)V
...
.method static synthetic access$1000(Lcom/oneplus/lib/widget/OPTabLayout;)Landroid/content/res/ColorStateList;
    ...
    iget-object v0, p0, mTabTextColors:Landroid/content/res/ColorStateList;
...
.method static synthetic access$1300(Lcom/oneplus/lib/widget/OPTabLayout;I)I
    ...
    invoke-direct {p0, p1}, dpToPx(I)I
...
.method static synthetic access$1400(Lcom/oneplus/lib/widget/OPTabLayout;)V
    ...
    invoke-direct {p0}, updateTabViewsLayoutParams()V
...
.method static synthetic access$1500(Lcom/oneplus/lib/widget/OPTabLayout;)Landroid/animation/ValueAnimator;
    ...
    iget-object v0, p0, mIndicatorAnimator:Landroid/animation/ValueAnimator;
...
.method static synthetic access$1502(Lcom/oneplus/lib/widget/OPTabLayout;Landroid/animation/ValueAnimator;)Landroid/animation/ValueAnimator;
    ...
    iput-object p1, p0, mIndicatorAnimator:Landroid/animation/ValueAnimator;
...
.method static synthetic access$1600(Lcom/oneplus/lib/widget/OPTabLayout;)Landroid/view/animation/Interpolator;
    ...
    iget-object v0, p0, fast_out_slow_in_interpolator:Landroid/view/animation/Interpolator;
...
.method static synthetic access$200(Lcom/oneplus/lib/widget/OPTabLayout;)I
    ...
    iget v0, p0, mTabBackgroundResId:I
...
.method static synthetic access$600(Lcom/oneplus/lib/widget/OPTabLayout;)I
    ...
    iget v0, p0, mTabPaddingBottom:I
...
.method static synthetic access$900(Lcom/oneplus/lib/widget/OPTabLayout;)I
    ...
    iget v0, p0, mTabTextAppearance:I
...
.method private addTabView(Lcom/oneplus/lib/widget/OPTabLayout$Tab;IZ)V
    ...
    invoke-direct {p0, p1}, createTabView(Lcom/oneplus/lib/widget/OPTabLayout$Tab;)Lcom/oneplus/lib/widget/OPTabLayout$TabView;

    move-result-object v0

    iget-object v1, p0, mTabStrip:Lcom/oneplus/lib/widget/OPTabLayout$SlidingTabStrip;

    invoke-direct {p0}, createLayoutParamsForTabs()Landroid/widget/LinearLayout$LayoutParams;
    ...
    invoke-direct {p0}, updateTabViewsMargin()V
...
.method private animateToTab(I)V
    ...
    iget-object v0, p0, mTabStrip:Lcom/oneplus/lib/widget/OPTabLayout$SlidingTabStrip;
    ...
    invoke-direct {p0, p1, v2}, calculateScrollXForTab(IF)I

    move-result v2

    if-eq v0, v2, :cond_3

    iget-object v3, p0, mScrollAnimator:Landroid/animation/ValueAnimator;
    ...
    iput-object v3, p0, mScrollAnimator:Landroid/animation/ValueAnimator;

    iget-object v3, p0, mScrollAnimator:Landroid/animation/ValueAnimator;

    iget-object v4, p0, fast_out_slow_in_interpolator:Landroid/view/animation/Interpolator;
    ...
    iget-object v1, p0, mScrollAnimator:Landroid/animation/ValueAnimator;
    ...
    :cond_4
    :goto_0
    invoke-virtual {p0, p1, v2, v1}, setScrollPosition(IFZ)V
...
.method private applyModeAndGravity()V
    ...
    iget v0, p0, mContentInsetStart:I
...
.method private static createColorStateList(II)Landroid/content/res/ColorStateList;
    ...
    sget-object v3, SELECTED_STATE_SET:[I
...
.method private createLayoutParamsForTabs()Landroid/widget/LinearLayout$LayoutParams;
    ...
    iget v1, p0, mTabHorizontalSpacing:I

    invoke-virtual {v0, v1}, Landroid/widget/LinearLayout$LayoutParams;->setMarginStart(I)V

    invoke-direct {p0, v0}, updateTabViewLayoutParams(Landroid/widget/LinearLayout$LayoutParams;)V
...
.method private createTabView(Lcom/oneplus/lib/widget/OPTabLayout$Tab;)Lcom/oneplus/lib/widget/OPTabLayout$TabView;
    ...
    iget-object v1, p0, mTabClickListener:Landroid/view/View$OnClickListener;
    ...
    iput-object v1, p0, mTabClickListener:Landroid/view/View$OnClickListener;
...
.method private getDefaultMaxWidth()I
    ...
    iget v0, p0, mRequestedTabMaxWidth:I
...
.method private updateAllTabs()V
    ...
    invoke-direct {p0, v0}, updateTab(I)V
...
.method private updateTabViewsLayoutParams()V
    ...
    invoke-direct {p0, v2}, updateTabViewLayoutParams(Landroid/widget/LinearLayout$LayoutParams;)V
...
.method public addTab(Lcom/oneplus/lib/widget/OPTabLayout$Tab;)V
    ...
    invoke-virtual {p0, p1, v0}, addTab(Lcom/oneplus/lib/widget/OPTabLayout$Tab;Z)V
...
.method public addTab(Lcom/oneplus/lib/widget/OPTabLayout$Tab;I)V
    ...
    invoke-virtual {p0, p1, p2, v0}, addTab(Lcom/oneplus/lib/widget/OPTabLayout$Tab;IZ)V
...
.method public addTab(Lcom/oneplus/lib/widget/OPTabLayout$Tab;IZ)V
    ...
    invoke-direct {p0, p1, p2, p3}, addTabView(Lcom/oneplus/lib/widget/OPTabLayout$Tab;IZ)V

    invoke-direct {p0, p1, p2}, configureTab(Lcom/oneplus/lib/widget/OPTabLayout$Tab;I)V
...
.method public addTab(Lcom/oneplus/lib/widget/OPTabLayout$Tab;Z)V
    ...
    invoke-direct {p0, p1, p2}, addTabView(Lcom/oneplus/lib/widget/OPTabLayout$Tab;Z)V
    ...
    invoke-direct {p0, p1, v0}, configureTab(Lcom/oneplus/lib/widget/OPTabLayout$Tab;I)V
...
.method public getSelectedTabPosition()I
    ...
    iget-object v0, p0, mSelectedTab:Lcom/oneplus/lib/widget/OPTabLayout$Tab;
...
.method protected onMeasure(II)V
    ...
    invoke-static {p2, v4, v5}, getChildMeasureSpec(III)I
    ...
    :cond_2
    iget v1, p0, mRequestedTabMaxWidth:I

    invoke-virtual {p0}, getMeasuredWidth()I

    move-result v2

    invoke-direct {p0}, getDefaultMaxWidth()I
    ...
    :cond_4
    iget v3, p0, mTabMaxWidth:I

    if-eq v3, v1, :cond_5

    iput v1, p0, mTabMaxWidth:I
...
.method public removeAllTabs()V
    ...
    iput-object v0, p0, mSelectedTab:Lcom/oneplus/lib/widget/OPTabLayout$Tab;
...
.method public removeTabAt(I)V
    ...
    :goto_0
    invoke-direct {p0, p1}, removeTabViewAt(I)V
    ...
    iget-object v5, p0, mTabs:Ljava/util/ArrayList;
    ...
    :goto_2
    invoke-virtual {p0, v1}, selectTab(Lcom/oneplus/lib/widget/OPTabLayout$Tab;)V
...
.method selectTab(Lcom/oneplus/lib/widget/OPTabLayout$Tab;)V
    ...
    invoke-virtual {p0, p1, v0}, selectTab(Lcom/oneplus/lib/widget/OPTabLayout$Tab;Z)V
...
.method selectTab(Lcom/oneplus/lib/widget/OPTabLayout$Tab;Z)V
    ...
    iget-object v1, p0, mOnTabSelectedListener:Lcom/oneplus/lib/widget/OPTabLayout$OnTabSelectedListener;
    ...
    invoke-direct {p0, v0}, animateToTab(I)V
    ...
    :goto_0
    invoke-direct {p0, v1}, setSelectedTabView(I)V

    if-eqz p2, :cond_5

    iget-object v2, p0, mSelectedTab:Lcom/oneplus/lib/widget/OPTabLayout$Tab;
    ...
    invoke-virtual {p0, v1, v0, v2}, setScrollPosition(IFZ)V

    goto :goto_1

    :cond_4
    invoke-direct {p0, v1}, animateToTab(I)V
    ...
    iget-object v2, p0, mOnTabSelectedListener:Lcom/oneplus/lib/widget/OPTabLayout$OnTabSelectedListener;
    ...
    :cond_6
    iput-object p1, p0, mSelectedTab:Lcom/oneplus/lib/widget/OPTabLayout$Tab;
...
.method public setOnTabSelectedListener(Lcom/oneplus/lib/widget/OPTabLayout$OnTabSelectedListener;)V
    ...
    iput-object p1, p0, mOnTabSelectedListener:Lcom/oneplus/lib/widget/OPTabLayout$OnTabSelectedListener;
...
.method public setScrollPosition(IFZ)V
    ...
    invoke-direct {p0, p1, p2}, calculateScrollXForTab(IF)I
    ...
    invoke-direct {p0, v0}, setSelectedTabView(I)V
...
.method public setTabTextColors(II)V
    ...
    invoke-static {p1, p2}, createColorStateList(II)Landroid/content/res/ColorStateList;

    move-result-object v0

    invoke-virtual {p0, v0}, setTabTextColors(Landroid/content/res/ColorStateList;)V
...
.method public setTabTextColors(Landroid/content/res/ColorStateList;)V
    ...
    iput-object p1, p0, mTabTextColors:Landroid/content/res/ColorStateList;

    invoke-direct {p0}, updateAllTabs()V
