...
.method static constructor <clinit>()V
    ...
    sput-object v0, IMPL:Lcom/oneplus/lib/widget/cardview/CardViewImpl;

    sget-object v0, IMPL:Lcom/oneplus/lib/widget/cardview/CardViewImpl;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mContentPadding:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, mShadowBounds:Landroid/graphics/Rect;

    const/4 v0, 0x0

    const/4 v1, 0x0

    invoke-direct {p0, p1, v0, v1}, initialize(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2, v0}, initialize(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p1, p2, p3}, initialize(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method private initialize(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-boolean v2, v7, mCompatPadding:Z
    ...
    iput-boolean v2, v7, mPreventCornerOverlap:Z
    ...
    iget-object v1, v7, mContentPadding:Landroid/graphics/Rect;
...
.method public getContentPaddingBottom()I
    ...
    iget-object v0, p0, mContentPadding:Landroid/graphics/Rect;
...
.method public getPreventCornerOverlap()Z
    ...
    iget-boolean v0, p0, mPreventCornerOverlap:Z
...
.method public getUseCompatPadding()Z
    ...
    iget-boolean v0, p0, mCompatPadding:Z
...
.method protected onMeasure(II)V
    ...
    :cond_0
    sget-object v3, IMPL:Lcom/oneplus/lib/widget/cardview/CardViewImpl;
    ...
    :cond_1
    sget-object v1, IMPL:Lcom/oneplus/lib/widget/cardview/CardViewImpl;
...
.method public setPreventCornerOverlap(Z)V
    ...
    :cond_0
    iput-boolean p1, p0, mPreventCornerOverlap:Z
...
.method public setShadowPadding(IIII)V
    ...
    iget-object v0, p0, mShadowBounds:Landroid/graphics/Rect;
    ...
    iget-object v1, p0, mContentPadding:Landroid/graphics/Rect;

    iget v1, v1, Landroid/graphics/Rect;->top:I

    add-int/2addr v1, p2

    iget-object v2, p0, mContentPadding:Landroid/graphics/Rect;

    iget v2, v2, Landroid/graphics/Rect;->right:I

    add-int/2addr v2, p3

    iget-object v3, p0, mContentPadding:Landroid/graphics/Rect;
...
.method public setUseCompatPadding(Z)V
    ...
    :cond_0
    iput-boolean p1, p0, mCompatPadding:Z
