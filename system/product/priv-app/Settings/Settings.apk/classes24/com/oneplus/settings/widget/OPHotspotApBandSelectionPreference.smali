...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v0, p0, mExistingConfigValue:I
...
.method private addApBandRadioGroupViews(Landroid/widget/LinearLayout;)V
    ...
    iput-object v0, p0, mRadio2G:Landroid/widget/RadioButton;

    iget-object v0, p0, mRadio2G:Landroid/widget/RadioButton;

    iget-object v1, p0, mBandEntries:[Ljava/lang/String;
    ...
    invoke-direct {p0, v2}, restoreBandIfNeeded(I)Z
    ...
    iput-object v0, p0, mRadio5G:Landroid/widget/RadioButton;

    iget-object v0, p0, mRadio5G:Landroid/widget/RadioButton;
    ...
    iput-object v0, p0, mApBandRadioGroup:Landroid/widget/RadioGroup;

    iget-object v0, p0, mApBandRadioGroup:Landroid/widget/RadioGroup;
...
.method private isBandPreviouslySelected(I)Z
    ...
    iget v0, p0, mExistingConfigValue:I
...
.method private restoreBandIfNeeded(I)Z
    ...
    invoke-direct {p0, p1}, isBandPreviouslySelected(I)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-boolean v0, p0, mShouldRestore:Z
    ...
    iget-object v0, p0, mRestoredBands:Ljava/util/ArrayList;
...
.method private updatePositiveButton()V
    ...
    iget-object v2, p0, mRadio2G:Landroid/widget/RadioButton;

    if-eqz v2, :cond_3

    iget-object v3, p0, mRadio5G:Landroid/widget/RadioButton;
    ...
    iget-object v2, p0, mRadio5G:Landroid/widget/RadioButton;
...
.method getWifiBand()I
    ...
    iget-object v1, p0, mRadio5G:Landroid/widget/RadioButton;
...
.method protected onBindDialogView(Landroid/view/View;)V
    ...
    invoke-virtual {p0, p0}, setOnShowListener(Landroid/content/DialogInterface$OnShowListener;)V
    ...
    invoke-direct {p0, v1}, addApBandRadioGroupViews(Landroid/widget/LinearLayout;)V

    invoke-direct {p0}, updatePositiveButton()V

    const/4 v1, 0x0

    iput-object v1, p0, mRestoredBands:Ljava/util/ArrayList;

    const/4 v1, 0x0

    iput-boolean v1, p0, mShouldRestore:Z
...
.method protected onClick()V
    ...
    invoke-virtual {p0}, isDialogOpen()Z
...
.method protected onClick(Landroid/content/DialogInterface;I)V
    ...
    :cond_0
    invoke-virtual {p0}, getWifiBand()I
    ...
    invoke-virtual {p0, v1}, callChangeListener(Ljava/lang/Object;)Z
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    iget-boolean v1, p0, mShouldRestore:Z
    ...
    iget-object v1, p0, mRestoredBands:Ljava/util/ArrayList;
...
.method public setExistingConfigValue(I)V
    ...
    iput p1, p0, mExistingConfigValue:I
