...
.method static constructor <clinit>()V
    ...
    sput-object v1, ONEPLUS_CHECK_ATTRS:[I
    ...
    sput-object v0, MATERIAL_CHECK_ATTRS:[I
...
.method public static checkAppCompatTheme(Landroid/content/Context;)V
    ...
    sget-object v0, ONEPLUS_CHECK_ATTRS:[I

    const-string v1, "Oneplus.Theme"

    invoke-static {p0, v0, v1}, checkTheme(Landroid/content/Context;[ILjava/lang/String;)V
...
.method private static checkCompatibleTheme(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-static {p0}, checkMaterialTheme(Landroid/content/Context;)V

    :cond_0
    invoke-static {p0}, checkAppCompatTheme(Landroid/content/Context;)V
...
.method public static checkMaterialTheme(Landroid/content/Context;)V
    ...
    sget-object v0, MATERIAL_CHECK_ATTRS:[I
...
.method private static varargs checkTextAppearance(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)V
    ...
    invoke-static/range {p0 .. p5}, isCustomTextAppearanceValid(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)Z
...
.method private static checkTheme(Landroid/content/Context;[ILjava/lang/String;)V
    ...
    invoke-static {p0, p1}, isTheme(Landroid/content/Context;[I)Z
...
.method public static isAppCompatTheme(Landroid/content/Context;)Z
    ...
    invoke-static {p0, v0}, isTheme(Landroid/content/Context;[I)Z
...
.method public static varargs obtainStyledAttributes(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)Landroid/content/res/TypedArray;
    ...
    invoke-static {p0, p1, p3, p4}, checkCompatibleTheme(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    invoke-static/range {p0 .. p5}, checkTextAppearance(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)V
