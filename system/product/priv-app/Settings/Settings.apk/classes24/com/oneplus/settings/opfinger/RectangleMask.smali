...
.method public constructor <init>(Landroid/graphics/Point;Landroid/graphics/Point;Landroid/graphics/Point;Landroid/graphics/Point;Lcom/oneplus/settings/opfinger/RectangleMask$MaskType;Lcom/oneplus/settings/opfinger/RectangleMask$FlipType;)V
    ...
    iput-object v2, v0, m_BottomLeft:Landroid/graphics/Point;

    iput-object v3, v0, m_BottomRight:Landroid/graphics/Point;

    iput-object v1, v0, m_TopLeft:Landroid/graphics/Point;

    move-object/from16 v4, p2

    iput-object v4, v0, m_TopRight:Landroid/graphics/Point;

    move-object/from16 v5, p5

    iput-object v5, v0, m_Mask:Lcom/oneplus/settings/opfinger/RectangleMask$MaskType;

    move-object/from16 v6, p6

    iput-object v6, v0, m_Flip:Lcom/oneplus/settings/opfinger/RectangleMask$FlipType;
    ...
    iput-wide v11, v0, dHeight:D

    iget-wide v11, v0, dWidth:D

    double-to-int v11, v11

    iput v11, v0, m_Width:I

    iget-wide v11, v0, dHeight:D

    double-to-int v11, v11

    iput v11, v0, m_Height:I
    ...
    iput v3, v0, m_Angle:F

    iget v3, v2, Landroid/graphics/Point;->x:I

    iget v4, v0, m_Width:I

    add-int/2addr v4, v3

    iget v15, v1, Landroid/graphics/Point;->y:I

    iget v1, v0, m_Height:I
    ...
    iput-object v2, v0, m_Rect:Landroid/graphics/Rect;

    new-instance v2, Landroid/graphics/Paint;

    invoke-direct {v2}, Landroid/graphics/Paint;-><init>()V

    iput-object v2, v0, m_Paint:Landroid/graphics/Paint;

    iget-object v2, v0, m_Paint:Landroid/graphics/Paint;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v3, v0, m_Mask:Lcom/oneplus/settings/opfinger/RectangleMask$MaskType;
    ...
    invoke-static {v2, v6, v9}, Landroid/graphics/Color;->rgb(III)I
    ...
    :goto_0
    iget-object v1, v0, m_Paint:Landroid/graphics/Paint;
    ...
    iget v1, v0, m_Angle:F

    neg-float v1, v1

    invoke-virtual {v7, v1}, Landroid/graphics/Canvas;->rotate(F)V

    iget-object v1, v0, m_Rect:Landroid/graphics/Rect;
    ...
    iget-object v2, v0, m_Flip:Lcom/oneplus/settings/opfinger/RectangleMask$FlipType;
    ...
    iget-object v2, v0, m_Mask:Lcom/oneplus/settings/opfinger/RectangleMask$MaskType;
    ...
    iget-object v6, v0, m_Paint:Landroid/graphics/Paint;
    ...
    iget-object v1, v0, m_Mask:Lcom/oneplus/settings/opfinger/RectangleMask$MaskType;
...
.method public getMaskType()Lcom/oneplus/settings/opfinger/RectangleMask$MaskType;
    ...
    iget-object v0, p0, m_Mask:Lcom/oneplus/settings/opfinger/RectangleMask$MaskType;
...
.method public setAlpha(I)V
    ...
    iget-object v0, p0, m_Paint:Landroid/graphics/Paint;
...
.method public setMaskType(Lcom/oneplus/settings/opfinger/RectangleMask$MaskType;)V
    ...
    iput-object p1, p0, m_Mask:Lcom/oneplus/settings/opfinger/RectangleMask$MaskType;
