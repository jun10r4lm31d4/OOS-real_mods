...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mHeaders:Ljava/util/ArrayList;

    const/4 v0, 0x0

    iput v0, p0, mPreferenceHeaderItemResId:I

    iput-boolean v0, p0, mPreferenceHeaderRemoveEmptyIcon:Z
...
.method static synthetic access$000(Lcom/oneplus/lib/preference/PreferenceActivity;)V
    ...
    invoke-direct {p0}, bindPreferences()V
...
.method static synthetic access$100(Lcom/oneplus/lib/preference/PreferenceActivity;)Ljava/util/ArrayList;
    ...
    iget-object v0, p0, mHeaders:Ljava/util/ArrayList;
...
.method static synthetic access$200(Lcom/oneplus/lib/preference/PreferenceActivity;)Lcom/oneplus/lib/preference/PreferenceActivity$Header;
    ...
    iget-object v0, p0, mCurHeader:Lcom/oneplus/lib/preference/PreferenceActivity$Header;
...
.method private bindPreferences()V
    ...
    invoke-virtual {p0}, getPreferenceScreen()Lcom/oneplus/lib/preference/PreferenceScreen;
    ...
    iget-object v1, p0, mSavedInstanceState:Landroid/os/Bundle;
    ...
    iput-object v1, p0, mSavedInstanceState:Landroid/os/Bundle;
...
.method private switchToHeaderInner(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, p1}, isValidFragment(Ljava/lang/String;)Z
...
.method public addPreferencesFromIntent(Landroid/content/Intent;)V
    ...
    invoke-direct {p0}, requirePreferenceManager()V
    ...
    invoke-virtual {p0, v0}, setPreferenceScreen(Lcom/oneplus/lib/preference/PreferenceScreen;)V
...
.method public finishPreferencePanel(Landroid/app/Fragment;ILandroid/content/Intent;)V
    ...
    iget-boolean v0, p0, mSinglePane:Z

    if-eqz v0, :cond_0

    invoke-virtual {p0, p2, p3}, setResult(ILandroid/content/Intent;)V
...
.method protected getNextButton()Landroid/widget/Button;
    ...
    iget-object v0, p0, mNextButton:Landroid/widget/Button;
...
.method public isMultiPane()Z
    ...
    invoke-virtual {p0}, hasHeaders()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, mPrefsContainer:Landroid/view/ViewGroup;
...
.method public loadHeadersFromResource(ILjava/util/List;)V
    ...
    :try_start_2
    invoke-virtual {v14, v3, v13}, obtainStyledAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;
...
.method public onContentChanged()V
    ...
    invoke-direct {p0}, postBindPreferences()V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v0}, requestWindowFeature(I)Z
    ...
    invoke-virtual {p0, v3, v1, v2, v4}, obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;
    ...
    iput v5, p0, mPreferenceHeaderItemResId:I
    ...
    iput-boolean v5, p0, mPreferenceHeaderRemoveEmptyIcon:Z
    ...
    iput-object v5, p0, mListFooter:Landroid/widget/FrameLayout;
    ...
    iput-object v5, p0, mPrefsContainer:Landroid/view/ViewGroup;

    invoke-virtual {p0}, onIsHidingHeaders()Z

    move-result v5

    if-nez v5, :cond_1

    invoke-virtual {p0}, onIsMultiPane()Z
    ...
    :goto_1
    iput-boolean v6, p0, mSinglePane:Z
    ...
    iget-object v11, p0, mHeaders:Ljava/util/ArrayList;
    ...
    iget-object v12, p0, mHeaders:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v12}, setSelectedHeader(Lcom/oneplus/lib/preference/PreferenceActivity$Header;)V
    ...
    iget-boolean v10, p0, mSinglePane:Z

    if-eqz v10, :cond_5

    invoke-virtual {p0, v6, v7}, switchToHeader(Ljava/lang/String;Landroid/os/Bundle;)V

    if-eqz v8, :cond_7

    invoke-virtual {p0, v8}, getText(I)Ljava/lang/CharSequence;

    move-result-object v10

    if-eqz v9, :cond_4

    invoke-virtual {p0, v9}, getText(I)Ljava/lang/CharSequence;
    ...
    :goto_2
    invoke-virtual {p0, v10, v11}, showBreadCrumbs(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)V

    goto :goto_3

    :cond_5
    iget-object v10, p0, mHeaders:Ljava/util/ArrayList;

    invoke-virtual {p0, v10}, onBuildHeaders(Ljava/util/List;)V
    ...
    invoke-virtual {p0}, onGetInitialHeader()Lcom/oneplus/lib/preference/PreferenceActivity$Header;

    move-result-object v10

    invoke-virtual {p0, v10}, switchToHeader(Lcom/oneplus/lib/preference/PreferenceActivity$Header;)V
    ...
    iget-boolean v11, p0, mSinglePane:Z
    ...
    :goto_4
    invoke-virtual {p0, v0, v3}, showBreadCrumbs(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)V

    goto :goto_5

    :cond_9
    iget-object v3, p0, mHeaders:Ljava/util/ArrayList;
    ...
    iget v12, p0, mPreferenceHeaderItemResId:I

    iget-boolean v13, p0, mPreferenceHeaderRemoveEmptyIcon:Z
    ...
    invoke-virtual {p0, v3}, setListAdapter(Landroid/widget/ListAdapter;)V

    iget-boolean v3, p0, mSinglePane:Z
    ...
    invoke-virtual {p0, v0}, setSelectedHeader(Lcom/oneplus/lib/preference/PreferenceActivity$Header;)V
    ...
    iput-object v0, p0, mListFooter:Landroid/widget/FrameLayout;
    ...
    iput-object v0, p0, mPrefsContainer:Landroid/view/ViewGroup;
    ...
    iput-object v0, p0, mPreferenceManager:Lcom/oneplus/lib/preference/PreferenceManager;
    ...
    invoke-virtual {p0, v11}, findViewById(I)Landroid/view/View;
    ...
    invoke-virtual {p0, v12}, findViewById(I)Landroid/view/View;

    move-result-object v12

    check-cast v12, Landroid/widget/Button;

    iput-object v12, p0, mNextButton:Landroid/widget/Button;

    iget-object v12, p0, mNextButton:Landroid/widget/Button;
    ...
    iget-object v13, p0, mNextButton:Landroid/widget/Button;
    ...
    invoke-virtual {p0, v3}, setActionBar(Landroid/widget/Toolbar;)V
...
.method public onGetInitialHeader()Lcom/oneplus/lib/preference/PreferenceActivity$Header;
    ...
    :goto_0
    iget-object v1, p0, mHeaders:Ljava/util/ArrayList;
...
.method public onHeaderClick(Lcom/oneplus/lib/preference/PreferenceActivity$Header;I)V
    ...
    invoke-virtual/range {v2 .. v8}, startWithFragment(Ljava/lang/String;Landroid/os/Bundle;Landroid/app/Fragment;III)V

    goto :goto_0

    :cond_1
    invoke-virtual {p0, p1}, switchToHeader(Lcom/oneplus/lib/preference/PreferenceActivity$Header;)V
...
.method protected onListItemClick(Landroid/widget/ListView;Landroid/view/View;IJ)V
    ...
    invoke-virtual {p0, v1, p3}, onHeaderClick(Lcom/oneplus/lib/preference/PreferenceActivity$Header;I)V
...
.method public onPreferenceStartFragment(Lcom/oneplus/lib/preference/PreferenceFragment;Lcom/oneplus/lib/preference/Preference;)Z
    ...
    invoke-virtual/range {v0 .. v6}, startPreferencePanel(Ljava/lang/String;Landroid/os/Bundle;ILjava/lang/CharSequence;Landroid/app/Fragment;I)V
...
.method protected onRestoreInstanceState(Landroid/os/Bundle;)V
    ...
    iput-object p1, p0, mSavedInstanceState:Landroid/os/Bundle;
...
.method protected onStart()V
    ...
    invoke-virtual {p0}, getToolBar()Lcom/oneplus/lib/widget/actionbar/Toolbar;
...
.method public setListFooter(Landroid/view/View;)V
    ...
    iget-object v0, p0, mListFooter:Landroid/widget/FrameLayout;
...
.method public setParentTitle(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/view/View$OnClickListener;)V
    ...
    iget-object v0, p0, mFragmentBreadCrumbs:Landroid/app/FragmentBreadCrumbs;
...
.method setSelectedHeader(Lcom/oneplus/lib/preference/PreferenceActivity$Header;)V
    ...
    iput-object p1, p0, mCurHeader:Lcom/oneplus/lib/preference/PreferenceActivity$Header;
    ...
    :goto_0
    invoke-virtual {p0, p1}, showBreadCrumbs(Lcom/oneplus/lib/preference/PreferenceActivity$Header;)V
...
.method showBreadCrumbs(Lcom/oneplus/lib/preference/PreferenceActivity$Header;)V
    ...
    invoke-virtual {p0, v0, v1}, showBreadCrumbs(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)V
...
.method public showBreadCrumbs(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)V
    ...
    iput-object v1, p0, mFragmentBreadCrumbs:Landroid/app/FragmentBreadCrumbs;
    :try_end_0
    .catch Ljava/lang/ClassCastException; {:try_start_0 .. :try_end_0} :catch_0

    nop

    iget-object v1, p0, mFragmentBreadCrumbs:Landroid/app/FragmentBreadCrumbs;
    ...
    :cond_1
    iget-boolean v2, p0, mSinglePane:Z
...
.method public startPreferencePanel(Ljava/lang/String;Landroid/os/Bundle;ILjava/lang/CharSequence;Landroid/app/Fragment;I)V
    ...
    invoke-virtual/range {v1 .. v7}, startWithFragment(Ljava/lang/String;Landroid/os/Bundle;Landroid/app/Fragment;III)V
...
.method public startWithFragment(Ljava/lang/String;Landroid/os/Bundle;Landroid/app/Fragment;I)V
    ...
    invoke-virtual/range {v0 .. v6}, startWithFragment(Ljava/lang/String;Landroid/os/Bundle;Landroid/app/Fragment;III)V
...
.method public startWithFragment(Ljava/lang/String;Landroid/os/Bundle;Landroid/app/Fragment;III)V
    ...
    invoke-virtual {p0, p1, p2, p5, p6}, onBuildStartFragmentIntent(Ljava/lang/String;Landroid/os/Bundle;II)Landroid/content/Intent;
...
.method public switchToHeader(Lcom/oneplus/lib/preference/PreferenceActivity$Header;)V
    ...
    invoke-direct {p0, v0, v1}, switchToHeaderInner(Ljava/lang/String;Landroid/os/Bundle;)V

    invoke-virtual {p0, p1}, setSelectedHeader(Lcom/oneplus/lib/preference/PreferenceActivity$Header;)V
...
.method public switchToHeader(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    :goto_0
    iget-object v2, p0, mHeaders:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, p1, p2}, switchToHeaderInner(Ljava/lang/String;Landroid/os/Bundle;)V
