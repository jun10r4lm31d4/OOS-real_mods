...
.method constructor <init>(ILokhttp3/internal/http2/Http2Connection;ZZLjava/util/List;)V
    ...
    iput-object v0, p0, readTimeout:Lokhttp3/internal/http2/Http2Stream$StreamTimeout;

    new-instance v0, Lokhttp3/internal/http2/Http2Stream$StreamTimeout;

    invoke-direct {v0, p0}, Lokhttp3/internal/http2/Http2Stream$StreamTimeout;-><init>(Lokhttp3/internal/http2/Http2Stream;)V

    iput-object v0, p0, writeTimeout:Lokhttp3/internal/http2/Http2Stream$StreamTimeout;

    const/4 v0, 0x0

    iput-object v0, p0, errorCode:Lokhttp3/internal/http2/ErrorCode;
    ...
    iput-object p2, p0, connection:Lokhttp3/internal/http2/Http2Connection;
    ...
    iput-object v0, p0, source:Lokhttp3/internal/http2/Http2Stream$FramingSource;
    ...
    iput-object v0, p0, sink:Lokhttp3/internal/http2/Http2Stream$FramingSink;

    iget-object v0, p0, source:Lokhttp3/internal/http2/Http2Stream$FramingSource;

    iput-boolean p4, v0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->finished:Z

    iget-object v0, p0, sink:Lokhttp3/internal/http2/Http2Stream$FramingSink;

    iput-boolean p3, v0, Lokhttp3/internal/http2/Http2Stream$FramingSink;->finished:Z

    iput-object p5, p0, requestHeaders:Ljava/util/List;
...
.method private closeInternal(Lokhttp3/internal/http2/ErrorCode;)Z
    ...
    :try_start_0
    iget-object v0, p0, errorCode:Lokhttp3/internal/http2/ErrorCode;
    ...
    :cond_1
    iput-object p1, p0, errorCode:Lokhttp3/internal/http2/ErrorCode;
...
.method cancelStreamIfNecessary()V
    ...
    invoke-virtual {p0, v2}, close(Lokhttp3/internal/http2/ErrorCode;)V
...
.method public close(Lokhttp3/internal/http2/ErrorCode;)V
    ...
    invoke-direct {p0, p1}, closeInternal(Lokhttp3/internal/http2/ErrorCode;)Z
...
.method public getRequestHeaders()Ljava/util/List;
    ...
    iget-object v0, p0, requestHeaders:Ljava/util/List;
...
.method public getSink()Lokio/Sink;
    ...
    :try_start_0
    iget-boolean v0, p0, hasResponseHeaders:Z

    if-nez v0, :cond_1

    invoke-virtual {p0}, isLocallyInitiated()Z
...
.method public isLocallyInitiated()Z
    ...
    :goto_0
    iget-object v3, p0, connection:Lokhttp3/internal/http2/Http2Connection;
...
.method public readTimeout()Lokio/Timeout;
    ...
    iget-object v0, p0, readTimeout:Lokhttp3/internal/http2/Http2Stream$StreamTimeout;
...
.method receiveFin()V
    ...
    iget-object v1, p0, connection:Lokhttp3/internal/http2/Http2Connection;
...
.method receiveHeaders(Ljava/util/List;)V
    ...
    :try_start_0
    iput-boolean v1, p0, hasResponseHeaders:Z

    iget-object v1, p0, responseHeaders:Ljava/util/List;

    if-nez v1, :cond_0

    iput-object p1, p0, responseHeaders:Ljava/util/List;
    ...
    iget-object v2, p0, responseHeaders:Ljava/util/List;
    ...
    iput-object v1, p0, responseHeaders:Ljava/util/List;
...
.method public sendResponseHeaders(Ljava/util/List;Z)V
    ...
    iget-object v2, p0, sink:Lokhttp3/internal/http2/Http2Stream$FramingSink;
...
.method public declared-synchronized takeResponseHeaders()Ljava/util/List;
    ...
    :goto_0
    :try_start_1
    iget-object v0, p0, responseHeaders:Ljava/util/List;
    :try_end_1
    ...
    iget-object v2, p0, errorCode:Lokhttp3/internal/http2/ErrorCode;
    ...
    :goto_1
    iget-object v1, p0, readTimeout:Lokhttp3/internal/http2/Http2Stream$StreamTimeout;
...
.method public writeTimeout()Lokio/Timeout;
    ...
    iget-object v0, p0, writeTimeout:Lokhttp3/internal/http2/Http2Stream$StreamTimeout;
