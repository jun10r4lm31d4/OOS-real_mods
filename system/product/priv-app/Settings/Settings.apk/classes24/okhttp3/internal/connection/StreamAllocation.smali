...
.method public constructor <init>(Lokhttp3/ConnectionPool;Lokhttp3/Address;Ljava/lang/Object;)V
    ...
    iput-object p2, p0, address:Lokhttp3/Address;

    new-instance v0, Lokhttp3/internal/connection/RouteSelector;

    invoke-direct {p0}, routeDatabase()Lokhttp3/internal/connection/RouteDatabase;
    ...
    iput-object v0, p0, routeSelector:Lokhttp3/internal/connection/RouteSelector;

    iput-object p3, p0, callStackTrace:Ljava/lang/Object;
...
.method private deallocate(ZZZ)Ljava/net/Socket;
    ...
    iput-object v0, p0, codec:Lokhttp3/internal/http/HttpCodec;
    ...
    iput-boolean v1, p0, released:Z

    :cond_1
    const/4 v2, 0x0

    iget-object v3, p0, connection:Lokhttp3/internal/connection/RealConnection;
    ...
    :cond_2
    iget-object v1, p0, codec:Lokhttp3/internal/http/HttpCodec;

    if-nez v1, :cond_5

    iget-boolean v1, p0, released:Z

    if-nez v1, :cond_3

    iget-object v1, p0, connection:Lokhttp3/internal/connection/RealConnection;
    ...
    invoke-direct {p0, v1}, release(Lokhttp3/internal/connection/RealConnection;)V
    ...
    iget-object v4, p0, connection:Lokhttp3/internal/connection/RealConnection;
    ...
    :cond_4
    iput-object v0, p0, connection:Lokhttp3/internal/connection/RealConnection;
...
.method private findConnection(IIIZ)Lokhttp3/internal/connection/RealConnection;
    ...
    iget-object v4, p0, address:Lokhttp3/Address;
    ...
    iget-object v2, p0, connection:Lokhttp3/internal/connection/RealConnection;
    ...
    iget-object v0, p0, routeSelector:Lokhttp3/internal/connection/RouteSelector;
    ...
    :cond_2
    iget-object v2, p0, connectionPool:Lokhttp3/ConnectionPool;
    ...
    iget-object v0, p0, connection:Lokhttp3/internal/connection/RealConnection;

    if-eqz v0, :cond_3

    iput-object v1, p0, route:Lokhttp3/Route;
    ...
    iput v0, p0, refusedStreamCount:I
    ...
    invoke-virtual {p0, v0}, acquire(Lokhttp3/internal/connection/RealConnection;)V
    ...
    iget-object v5, p0, connectionPool:Lokhttp3/ConnectionPool;
    ...
    iget-object v6, p0, address:Lokhttp3/Address;
...
.method private findHealthyConnection(IIIZZ)Lokhttp3/internal/connection/RealConnection;
    ...
    :goto_0
    invoke-direct {p0, p1, p2, p3, p4}, findConnection(IIIZ)Lokhttp3/internal/connection/RealConnection;

    move-result-object v0

    iget-object v1, p0, connectionPool:Lokhttp3/ConnectionPool;
    ...
    invoke-virtual {p0}, noNewStreams()V
...
.method public acquire(Lokhttp3/internal/connection/RealConnection;)V
    ...
    iput-object p1, p0, connection:Lokhttp3/internal/connection/RealConnection;

    iget-object v0, p1, Lokhttp3/internal/connection/RealConnection;->allocations:Ljava/util/List;

    new-instance v1, Lokhttp3/internal/connection/StreamAllocation$StreamAllocationReference;

    iget-object v2, p0, callStackTrace:Ljava/lang/Object;
...
.method public newStream(Lokhttp3/OkHttpClient;Z)Lokhttp3/internal/http/HttpCodec;
    ...
    :try_start_0
    invoke-direct/range {v0 .. v5}, findHealthyConnection(IIIZZ)Lokhttp3/internal/connection/RealConnection;
    ...
    :try_start_1
    iput-object v1, p0, codec:Lokhttp3/internal/http/HttpCodec;
...
.method public noNewStreams()V
    ...
    :try_start_0
    invoke-direct {p0, v1, v2, v2}, deallocate(ZZZ)Ljava/net/Socket;
...
.method public release()V
    ...
    :try_start_0
    invoke-direct {p0, v2, v1, v2}, deallocate(ZZZ)Ljava/net/Socket;
...
.method public releaseAndAcquire(Lokhttp3/internal/connection/RealConnection;)Ljava/net/Socket;
    ...
    iget-object v0, p0, codec:Lokhttp3/internal/http/HttpCodec;
...
.method public streamFailed(Ljava/io/IOException;)V
    ...
    iget v5, p0, refusedStreamCount:I

    add-int/2addr v5, v4

    iput v5, p0, refusedStreamCount:I
    ...
    iput-object v3, p0, route:Lokhttp3/Route;
    ...
    iget-object v2, p0, routeSelector:Lokhttp3/internal/connection/RouteSelector;
    ...
    invoke-direct {p0, v0, v2, v4}, deallocate(ZZZ)Ljava/net/Socket;
...
.method public streamFinished(ZLokhttp3/internal/http/HttpCodec;)V
    ...
    invoke-direct {p0, p1, v2, v1}, deallocate(ZZZ)Ljava/net/Socket;
    ...
    iget-object v3, p0, codec:Lokhttp3/internal/http/HttpCodec;
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, connection()Lokhttp3/internal/connection/RealConnection;
    ...
    :cond_0
    iget-object v1, p0, address:Lokhttp3/Address;
