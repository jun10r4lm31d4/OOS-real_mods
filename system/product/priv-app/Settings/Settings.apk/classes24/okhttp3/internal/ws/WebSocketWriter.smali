...
.method constructor <init>(ZLokio/BufferedSink;Ljava/util/Random;)V
    ...
    iput-object v0, p0, frameSink:Lokhttp3/internal/ws/WebSocketWriter$FrameSink;
    ...
    iput-object p2, p0, sink:Lokio/BufferedSink;
...
.method private writeControlFrameSynchronized(ILokio/ByteString;)V
    ...
    iget-boolean v0, p0, writerClosed:Z
...
.method newMessageSink(IJ)Lokio/Sink;
    ...
    iget-boolean v0, p0, activeWriter:Z

    if-nez v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, p0, activeWriter:Z

    iget-object v1, p0, frameSink:Lokhttp3/internal/ws/WebSocketWriter$FrameSink;
...
.method writeClose(ILokio/ByteString;)V
    ...
    :try_start_0
    invoke-direct {p0, v1, v0}, writeControlFrameSynchronized(ILokio/ByteString;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_1

    :try_start_1
    iput-boolean v2, p0, writerClosed:Z
...
.method writeMessageFrameSynchronized(IJZZ)V
    ...
    iget-boolean v3, v0, writerClosed:Z
    ...
    iget-object v6, v0, sink:Lokio/BufferedSink;
    ...
    iget-object v6, v0, random:Ljava/util/Random;

    iget-object v7, v0, maskKey:[B
    ...
    iget-object v8, v0, maskBuffer:[B
    ...
    iget-object v8, v0, buffer:Lokio/Buffer;

    iget-object v9, v0, maskBuffer:[B
    ...
    :cond_7
    iget-object v3, v0, sink:Lokio/BufferedSink;
...
.method writePing(Lokio/ByteString;)V
    ...
    :try_start_0
    invoke-direct {p0, v0, p1}, writeControlFrameSynchronized(ILokio/ByteString;)V
