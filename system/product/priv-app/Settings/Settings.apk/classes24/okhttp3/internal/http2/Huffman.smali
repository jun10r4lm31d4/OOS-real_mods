...
.method static constructor <clinit>()V
    ...
    sput-object v1, CODES:[I

    new-array v0, v0, [B

    fill-array-data v0, :array_1

    sput-object v0, CODE_LENGTHS:[B

    new-instance v0, Lokhttp3/internal/http2/Huffman;

    invoke-direct {v0}, <init>()V

    sput-object v0, INSTANCE:Lokhttp3/internal/http2/Huffman;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, root:Lokhttp3/internal/http2/Huffman$Node;

    invoke-direct {p0}, buildTree()V
...
.method private addCode(IIB)V
    ...
    iget-object v1, p0, root:Lokhttp3/internal/http2/Huffman$Node;
...
.method private buildTree()V
    ...
    :goto_0
    sget-object v1, CODE_LENGTHS:[B

    array-length v2, v1

    if-ge v0, v2, :cond_0

    sget-object v2, CODES:[I

    aget v2, v2, v0

    aget-byte v1, v1, v0

    invoke-direct {p0, v0, v2, v1}, addCode(IIB)V
...
.method public static get()Lokhttp3/internal/http2/Huffman;
    ...
    sget-object v0, INSTANCE:Lokhttp3/internal/http2/Huffman;
...
.method encode(Lokio/ByteString;Lokio/BufferedSink;)V
    ...
    sget-object v6, CODES:[I

    aget v6, v6, v4

    sget-object v7, CODE_LENGTHS:[B
