...
.method constructor <init>(ZLokio/BufferedSource;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;)V
    ...
    iput-object v0, p0, maskKey:[B

    const/16 v0, 0x2000

    new-array v0, v0, [B

    iput-object v0, p0, maskBuffer:[B

    if-eqz p2, :cond_1

    if-eqz p3, :cond_0

    iput-boolean p1, p0, isClient:Z

    iput-object p2, p0, source:Lokio/BufferedSource;

    iput-object p3, p0, frameCallback:Lokhttp3/internal/ws/WebSocketReader$FrameCallback;
...
.method private readControlFrame()V
    ...
    iget-wide v1, p0, frameBytesRead:J

    iget-wide v3, p0, frameLength:J

    cmp-long v1, v1, v3

    if-gez v1, :cond_2

    iget-boolean v1, p0, isClient:Z
    ...
    iget-object v1, p0, maskBuffer:[B
    ...
    iget-object v3, p0, maskBuffer:[B
    ...
    iget-object v5, p0, maskBuffer:[B

    int-to-long v6, v2

    iget-object v8, p0, maskKey:[B

    iget-wide v9, p0, frameBytesRead:J
    ...
    iget-wide v3, p0, frameBytesRead:J

    int-to-long v5, v2

    add-long/2addr v3, v5

    iput-wide v3, p0, frameBytesRead:J
    ...
    :pswitch_0
    iget-object v1, p0, frameCallback:Lokhttp3/internal/ws/WebSocketReader$FrameCallback;
    ...
    :cond_4
    :goto_2
    iget-object v5, p0, frameCallback:Lokhttp3/internal/ws/WebSocketReader$FrameCallback;

    invoke-interface {v5, v1, v2}, Lokhttp3/internal/ws/WebSocketReader$FrameCallback;->onReadClose(ILjava/lang/String;)V

    const/4 v5, 0x1

    iput-boolean v5, p0, closed:Z
...
.method private readHeader()V
    ...
    :goto_0
    iput-boolean v3, p0, isFinalFrame:Z
    ...
    :goto_1
    iput-boolean v3, p0, isControlFrame:Z

    iget-boolean v3, p0, isControlFrame:Z

    if-eqz v3, :cond_3

    iget-boolean v3, p0, isFinalFrame:Z
    ...
    iget-object v8, p0, source:Lokio/BufferedSource;
    ...
    :goto_6
    iput-boolean v4, p0, isMasked:Z

    iget-boolean v4, p0, isMasked:Z

    iget-boolean v5, p0, isClient:Z
    ...
    iput-wide v4, p0, frameLength:J

    iget-wide v4, p0, frameLength:J
    ...
    :cond_c
    :goto_8
    iput-wide v10, p0, frameBytesRead:J

    iget-boolean v4, p0, isControlFrame:Z
...
.method private readMessage(Lokio/Buffer;)V
    ...
    iget-wide v0, p0, frameBytesRead:J

    iget-wide v2, p0, frameLength:J

    cmp-long v0, v0, v2

    if-nez v0, :cond_2

    iget-boolean v0, p0, isFinalFrame:Z
    ...
    :cond_0
    invoke-virtual {p0}, readUntilNonControlFrame()V
    ...
    iget-wide v2, p0, frameBytesRead:J

    sub-long/2addr v0, v2

    iget-boolean v2, p0, isMasked:Z

    const-wide/16 v3, -0x1

    if-eqz v2, :cond_4

    iget-object v2, p0, maskBuffer:[B
    ...
    iget-object v8, p0, maskBuffer:[B

    iget-object v11, p0, maskKey:[B

    iget-wide v12, p0, frameBytesRead:J
    ...
    iput-wide v2, p0, frameBytesRead:J
...
.method private readMessageFrame()V
    ...
    invoke-direct {p0, v2}, readMessage(Lokio/Buffer;)V
...
.method processNextFrame()V
    ...
    invoke-direct {p0}, readHeader()V

    iget-boolean v0, p0, isControlFrame:Z

    if-eqz v0, :cond_0

    invoke-direct {p0}, readControlFrame()V

    goto :goto_0

    :cond_0
    invoke-direct {p0}, readMessageFrame()V
