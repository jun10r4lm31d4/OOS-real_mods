...
.method static constructor <clinit>()V
    ...
    sput-object v0, PREFIX_CLEAN:Lokio/ByteString;
    ...
    sput-object v0, PREFIX_DIRTY:Lokio/ByteString;
...
.method private constructor <init>(Ljava/io/RandomAccessFile;Lokio/Source;JLokio/ByteString;J)V
    ...
    iput-object v0, p0, upstreamBuffer:Lokio/Buffer;
    ...
    iput-object p1, p0, file:Ljava/io/RandomAccessFile;

    iput-object p2, p0, upstream:Lokio/Source;
    ...
    :goto_0
    iput-boolean v0, p0, complete:Z

    iput-wide p3, p0, upstreamPos:J

    iput-object p5, p0, metadata:Lokio/ByteString;

    iput-wide p6, p0, bufferMaxSize:J
...
.method public static edit(Ljava/io/File;Lokio/Source;Lokio/ByteString;J)Lokhttp3/internal/cache2/Relay;
    ...
    invoke-direct/range {v3 .. v10}, <init>(Ljava/io/RandomAccessFile;Lokio/Source;JLokio/ByteString;J)V

    const-wide/16 v3, 0x0

    invoke-virtual {v0, v3, v4}, Ljava/io/RandomAccessFile;->setLength(J)V

    sget-object v9, PREFIX_DIRTY:Lokio/ByteString;
    ...
    invoke-direct/range {v8 .. v13}, writeHeader(Lokio/ByteString;JJ)V
...
.method public static read(Ljava/io/File;)Lokhttp3/internal/cache2/Relay;
    ...
    sget-object v0, PREFIX_CLEAN:Lokio/ByteString;
    ...
    invoke-direct/range {v0 .. v7}, <init>(Ljava/io/RandomAccessFile;Lokio/Source;JLokio/ByteString;J)V
...
.method private writeHeader(Lokio/ByteString;JJ)V
    ...
    iget-object v2, p0, file:Ljava/io/RandomAccessFile;
...
.method private writeMetadata(J)V
    ...
    iget-object v1, p0, metadata:Lokio/ByteString;
    ...
    iget-object v4, p0, metadata:Lokio/ByteString;
...
.method commit(J)V
    ...
    invoke-direct {p0, p1, p2}, writeMetadata(J)V

    iget-object v0, p0, file:Ljava/io/RandomAccessFile;
    ...
    sget-object v3, PREFIX_CLEAN:Lokio/ByteString;

    iget-object v0, p0, metadata:Lokio/ByteString;
    ...
    invoke-direct/range {v2 .. v7}, writeHeader(Lokio/ByteString;JJ)V
    ...
    iget-object v0, p0, upstream:Lokio/Source;

    invoke-static {v0}, Lokhttp3/internal/Util;->closeQuietly(Ljava/io/Closeable;)V

    const/4 v0, 0x0

    iput-object v0, p0, upstream:Lokio/Source;
...
.method public newSource()Lokio/Source;
    ...
    :cond_0
    iget v0, p0, sourceCount:I

    add-int/lit8 v0, v0, 0x1

    iput v0, p0, sourceCount:I
