...
.method constructor <init>(Lokhttp3/internal/http2/Http2Stream;J)V
    ...
    iput-object p1, p0, this$0:Lokhttp3/internal/http2/Http2Stream;
    ...
    iput-object p1, p0, receiveBuffer:Lokio/Buffer;

    new-instance p1, Lokio/Buffer;

    invoke-direct {p1}, Lokio/Buffer;-><init>()V

    iput-object p1, p0, readBuffer:Lokio/Buffer;

    iput-wide p2, p0, maxByteCount:J
...
.method private checkNotClosed()V
    ...
    iget-object v0, p0, this$0:Lokhttp3/internal/http2/Http2Stream;
    ...
    iget-object v1, p0, this$0:Lokhttp3/internal/http2/Http2Stream;
...
.method private waitUntilReadable()V
    ...
    :goto_0
    :try_start_0
    iget-object v0, p0, readBuffer:Lokio/Buffer;
...
.method public close()V
    ...
    iget-object v1, p0, readBuffer:Lokio/Buffer;
...
.method public read(Lokio/Buffer;J)J
    ...
    iget-object v2, p0, this$0:Lokhttp3/internal/http2/Http2Stream;

    monitor-enter v2

    :try_start_0
    invoke-direct {p0}, waitUntilReadable()V

    invoke-direct {p0}, checkNotClosed()V

    iget-object v3, p0, readBuffer:Lokio/Buffer;
    ...
    iget-object v4, p0, readBuffer:Lokio/Buffer;
    ...
    iget-object v5, p0, this$0:Lokhttp3/internal/http2/Http2Stream;
    ...
    iget-object v7, p0, this$0:Lokhttp3/internal/http2/Http2Stream;
    ...
    iget-object v6, p0, this$0:Lokhttp3/internal/http2/Http2Stream;
...
.method receive(Lokio/BufferedSource;J)V
    ...
    iget-wide v6, p0, maxByteCount:J
    ...
    :cond_2
    iget-object v2, p0, receiveBuffer:Lokio/Buffer;
    ...
    :try_start_1
    iget-object p2, p0, readBuffer:Lokio/Buffer;
    ...
    iget-object p3, p0, readBuffer:Lokio/Buffer;

    iget-object v0, p0, receiveBuffer:Lokio/Buffer;

    invoke-virtual {p3, v0}, Lokio/Buffer;->writeAll(Lokio/Source;)J

    if-eqz p2, :cond_4

    iget-object p3, p0, this$0:Lokhttp3/internal/http2/Http2Stream;
