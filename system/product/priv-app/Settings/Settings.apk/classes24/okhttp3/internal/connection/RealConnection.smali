...
.method public constructor <init>(Lokhttp3/ConnectionPool;Lokhttp3/Route;)V
    ...
    iput v0, p0, allocationLimit:I

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, allocations:Ljava/util/List;

    const-wide v0, 0x7fffffffffffffffL

    iput-wide v0, p0, idleAtNanos:J

    iput-object p1, p0, connectionPool:Lokhttp3/ConnectionPool;

    iput-object p2, p0, route:Lokhttp3/Route;
...
.method private connectSocket(II)V
    ...
    iget-object v0, p0, route:Lokhttp3/Route;

    invoke-virtual {v0}, Lokhttp3/Route;->proxy()Ljava/net/Proxy;

    move-result-object v0

    iget-object v1, p0, route:Lokhttp3/Route;
    ...
    :goto_1
    iput-object v2, p0, rawSocket:Ljava/net/Socket;

    iget-object v2, p0, rawSocket:Ljava/net/Socket;
    ...
    iget-object v3, p0, rawSocket:Ljava/net/Socket;

    iget-object v4, p0, route:Lokhttp3/Route;
    ...
    iput-object v2, p0, source:Lokio/BufferedSource;
    ...
    iput-object v2, p0, sink:Lokio/BufferedSink;
    :try_end_1
    ...
    iget-object v5, p0, route:Lokhttp3/Route;
...
.method private connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    :try_start_0
    iget-object v4, p0, rawSocket:Ljava/net/Socket;
    ...
    iput-object v3, p0, socket:Ljava/net/Socket;

    iget-object v7, p0, socket:Ljava/net/Socket;
    ...
    iput-object v7, p0, source:Lokio/BufferedSource;
    ...
    iput-object v7, p0, sink:Lokio/BufferedSink;

    iput-object v5, p0, handshake:Lokhttp3/Handshake;
    ...
    :goto_1
    iput-object v7, p0, protocol:Lokhttp3/Protocol;
    :try_end_0
...
.method private connectTunnel(III)V
    ...
    invoke-direct {p0}, createTunnelRequest()Lokhttp3/Request;
    ...
    invoke-direct {p0, p1, p2}, connectSocket(II)V

    invoke-direct {p0, p2, p3, v0, v1}, createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    iput-object v4, p0, rawSocket:Ljava/net/Socket;

    iput-object v4, p0, sink:Lokio/BufferedSink;

    iput-object v4, p0, source:Lokio/BufferedSource;
...
.method private createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    iget-object v3, p0, sink:Lokio/BufferedSink;
    ...
    iget-object v2, p0, sink:Lokio/BufferedSink;
    ...
    iget-object v7, p0, route:Lokhttp3/Route;
    ...
    :cond_4
    iget-object v7, p0, source:Lokio/BufferedSource;
    ...
    iget-object v7, p0, sink:Lokio/BufferedSink;
...
.method private establishProtocol(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    iget-object v0, p0, rawSocket:Ljava/net/Socket;
    ...
    :cond_0
    invoke-direct {p0, p1}, connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V

    iget-object v0, p0, protocol:Lokhttp3/Protocol;

    sget-object v1, Lokhttp3/Protocol;->HTTP_2:Lokhttp3/Protocol;

    if-ne v0, v1, :cond_1

    iget-object v0, p0, socket:Ljava/net/Socket;
    ...
    iget-object v1, p0, socket:Ljava/net/Socket;

    iget-object v2, p0, route:Lokhttp3/Route;
    ...
    iget-object v4, p0, sink:Lokio/BufferedSink;
    ...
    iput-object v0, p0, http2Connection:Lokhttp3/internal/http2/Http2Connection;

    iget-object v0, p0, http2Connection:Lokhttp3/internal/http2/Http2Connection;
...
.method public static testConnection(Lokhttp3/ConnectionPool;Lokhttp3/Route;Ljava/net/Socket;J)Lokhttp3/internal/connection/RealConnection;
    ...
    invoke-direct {v0, p0, p1}, <init>(Lokhttp3/ConnectionPool;Lokhttp3/Route;)V

    iput-object p2, v0, socket:Ljava/net/Socket;

    iput-wide p3, v0, idleAtNanos:J
...
.method public connect(IIIZ)V
    ...
    iget-object v3, p0, route:Lokhttp3/Route;
    ...
    invoke-direct {p0, p1, p2, p3}, connectTunnel(III)V
    ...
    :goto_1
    invoke-direct {p0, v2}, establishProtocol(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0

    nop

    iget-object v3, p0, http2Connection:Lokhttp3/internal/http2/Http2Connection;

    if-eqz v3, :cond_4

    iget-object v3, p0, connectionPool:Lokhttp3/ConnectionPool;

    monitor-enter v3

    :try_start_1
    iget-object v4, p0, http2Connection:Lokhttp3/internal/http2/Http2Connection;

    invoke-virtual {v4}, Lokhttp3/internal/http2/Http2Connection;->maxConcurrentStreams()I

    move-result v4

    iput v4, p0, allocationLimit:I
    ...
    iget-object v4, p0, socket:Ljava/net/Socket;
    ...
    iput-object v4, p0, socket:Ljava/net/Socket;
    ...
    iput-object v4, p0, handshake:Lokhttp3/Handshake;

    iput-object v4, p0, protocol:Lokhttp3/Protocol;

    iput-object v4, p0, http2Connection:Lokhttp3/internal/http2/Http2Connection;
...
.method public handshake()Lokhttp3/Handshake;
    ...
    iget-object v0, p0, handshake:Lokhttp3/Handshake;
...
.method public isEligible(Lokhttp3/Address;Lokhttp3/Route;)Z
    ...
    iget-object v0, p0, allocations:Ljava/util/List;

    invoke-interface {v0}, Ljava/util/List;->size()I

    move-result v0

    iget v1, p0, allocationLimit:I

    const/4 v2, 0x0

    if-ge v0, v1, :cond_a

    iget-boolean v0, p0, noNewStreams:Z
    ...
    invoke-virtual {p0}, route()Lokhttp3/Route;
    ...
    invoke-virtual {p0, v0}, supportsUrl(Lokhttp3/HttpUrl;)Z
    ...
    invoke-virtual {p0}, handshake()Lokhttp3/Handshake;
...
.method public newCodec(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;)Lokhttp3/internal/http/HttpCodec;
    ...
    iget-object v0, p0, sink:Lokio/BufferedSink;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, protocol:Lokhttp3/Protocol;
