...
.method static constructor <clinit>()V
    ...
    sput-object v8, executor:Ljava/util/concurrent/ExecutorService;
...
.method constructor <init>(Lokhttp3/internal/http2/Http2Connection$Builder;)V
    ...
    iput-object v0, p0, streams:Ljava/util/Map;

    const-wide/16 v0, 0x0

    iput-wide v0, p0, unacknowledgedBytesRead:J

    new-instance v0, Lokhttp3/internal/http2/Settings;

    invoke-direct {v0}, Lokhttp3/internal/http2/Settings;-><init>()V

    iput-object v0, p0, okHttpSettings:Lokhttp3/internal/http2/Settings;

    new-instance v0, Lokhttp3/internal/http2/Settings;

    invoke-direct {v0}, Lokhttp3/internal/http2/Settings;-><init>()V

    iput-object v0, p0, peerSettings:Lokhttp3/internal/http2/Settings;

    const/4 v0, 0x0

    iput-boolean v0, p0, receivedInitialPeerSettings:Z

    new-instance v1, Ljava/util/LinkedHashSet;

    invoke-direct {v1}, Ljava/util/LinkedHashSet;-><init>()V

    iput-object v1, p0, currentPushRequests:Ljava/util/Set;

    iget-object v1, p1, Lokhttp3/internal/http2/Http2Connection$Builder;->pushObserver:Lokhttp3/internal/http2/PushObserver;

    iput-object v1, p0, pushObserver:Lokhttp3/internal/http2/PushObserver;

    iget-boolean v1, p1, Lokhttp3/internal/http2/Http2Connection$Builder;->client:Z

    iput-boolean v1, p0, client:Z
    ...
    iput-object v1, p0, listener:Lokhttp3/internal/http2/Http2Connection$Listener;
    ...
    :goto_0
    iput v1, p0, nextStreamId:I

    iget-boolean v1, p1, Lokhttp3/internal/http2/Http2Connection$Builder;->client:Z

    if-eqz v1, :cond_1

    iget v1, p0, nextStreamId:I
    ...
    iget-object v1, p0, okHttpSettings:Lokhttp3/internal/http2/Settings;
    ...
    iput-object v1, p0, hostname:Ljava/lang/String;
    ...
    iget-object v11, p0, hostname:Ljava/lang/String;
    ...
    iput-object v1, p0, pushExecutor:Ljava/util/concurrent/ExecutorService;

    iget-object v0, p0, peerSettings:Lokhttp3/internal/http2/Settings;
    ...
    iget-boolean v2, p0, client:Z

    invoke-direct {v0, v1, v2}, Lokhttp3/internal/http2/Http2Writer;-><init>(Lokio/BufferedSink;Z)V

    iput-object v0, p0, writer:Lokhttp3/internal/http2/Http2Writer;
    ...
    iput-object v0, p0, readerRunnable:Lokhttp3/internal/http2/Http2Connection$ReaderRunnable;
...
.method private newStream(ILjava/util/List;Z)Lokhttp3/internal/http2/Http2Stream;
    ...
    iget-object v8, p0, writer:Lokhttp3/internal/http2/Http2Writer;
    ...
    iget-wide v2, p0, bytesLeftInWriteWindow:J
    ...
    iget-object v3, p0, streams:Ljava/util/Map;
    ...
    :try_start_2
    iget-object v3, p0, writer:Lokhttp3/internal/http2/Http2Writer;
...
.method addBytesToWriteWindow(J)V
    ...
    iget-wide v0, p0, bytesLeftInWriteWindow:J
...
.method public close()V
    ...
    invoke-virtual {p0, v0, v1}, close(Lokhttp3/internal/http2/ErrorCode;Lokhttp3/internal/http2/ErrorCode;)V
...
.method close(Lokhttp3/internal/http2/ErrorCode;Lokhttp3/internal/http2/ErrorCode;)V
    ...
    :try_start_0
    invoke-virtual {p0, p1}, shutdown(Lokhttp3/internal/http2/ErrorCode;)V
    :try_end_0
    ...
    iget-object v4, p0, streams:Ljava/util/Map;
    ...
    :cond_0
    iget-object v3, p0, pings:Ljava/util/Map;
    ...
    iget-object v4, p0, pings:Ljava/util/Map;
    ...
    iput-object v3, p0, pings:Ljava/util/Map;
    ...
    :goto_4
    :try_start_4
    iget-object v3, p0, socket:Ljava/net/Socket;
...
.method public flush()V
    ...
    iget-object v0, p0, writer:Lokhttp3/internal/http2/Http2Writer;
...
.method declared-synchronized getStream(I)Lokhttp3/internal/http2/Http2Stream;
    ...
    :try_start_0
    iget-object v0, p0, streams:Ljava/util/Map;
...
.method public newStream(Ljava/util/List;Z)Lokhttp3/internal/http2/Http2Stream;
    ...
    invoke-direct {p0, v0, p1, p2}, newStream(ILjava/util/List;Z)Lokhttp3/internal/http2/Http2Stream;
...
.method public ping()Lokhttp3/internal/http2/Ping;
    ...
    iget v1, p0, nextPingId:I

    iget v2, p0, nextPingId:I

    add-int/lit8 v2, v2, 0x2

    iput v2, p0, nextPingId:I

    iget-object v2, p0, pings:Ljava/util/Map;
    ...
    iput-object v2, p0, pings:Ljava/util/Map;
    ...
    invoke-virtual {p0, v2, v1, v3, v0}, writePing(ZIILokhttp3/internal/http2/Ping;)V
...
.method pushDataLater(ILokio/BufferedSource;IZ)V
    ...
    iget-object v9, p0, pushExecutor:Ljava/util/concurrent/ExecutorService;
...
.method pushHeadersLater(ILjava/util/List;Z)V
    ...
    iget-object v0, p0, pushExecutor:Ljava/util/concurrent/ExecutorService;
    ...
    iget-object v1, p0, hostname:Ljava/lang/String;
...
.method pushRequestLater(ILjava/util/List;)V
    ...
    :try_start_0
    iget-object v0, p0, currentPushRequests:Ljava/util/Set;
    ...
    invoke-virtual {p0, p1, v0}, writeSynResetLater(ILokhttp3/internal/http2/ErrorCode;)V
...
.method public pushStream(ILjava/util/List;Z)Lokhttp3/internal/http2/Http2Stream;
    ...
    invoke-direct {p0, p1, p2, p3}, newStream(ILjava/util/List;Z)Lokhttp3/internal/http2/Http2Stream;
...
.method declared-synchronized removePing(I)Lokhttp3/internal/http2/Ping;
    ...
    :try_start_0
    iget-object v0, p0, pings:Ljava/util/Map;
...
.method public setSettings(Lokhttp3/internal/http2/Settings;)V
    ...
    iget-object v1, p0, writer:Lokhttp3/internal/http2/Http2Writer;
...
.method public shutdown(Lokhttp3/internal/http2/ErrorCode;)V
    ...
    :try_start_3
    iput-boolean v1, p0, shutdown:Z

    iget v1, p0, lastGoodStreamId:I
    ...
    :try_start_4
    iget-object v2, p0, writer:Lokhttp3/internal/http2/Http2Writer;
...
.method start(Z)V
    ...
    iget-object v0, p0, okHttpSettings:Lokhttp3/internal/http2/Settings;
    ...
    iget-object v1, p0, readerRunnable:Lokhttp3/internal/http2/Http2Connection$ReaderRunnable;
...
.method public writeData(IZLokio/Buffer;J)V
    ...
    :goto_1
    :try_start_0
    iget-wide v4, p0, bytesLeftInWriteWindow:J

    cmp-long v2, v4, v0

    if-gtz v2, :cond_2

    iget-object v2, p0, streams:Ljava/util/Map;
    ...
    iget-object v4, p0, writer:Lokhttp3/internal/http2/Http2Writer;
    ...
    iput-wide v4, p0, bytesLeftInWriteWindow:J
...
.method writePingLater(ZIILokhttp3/internal/http2/Ping;)V
    ...
    sget-object v0, executor:Ljava/util/concurrent/ExecutorService;
