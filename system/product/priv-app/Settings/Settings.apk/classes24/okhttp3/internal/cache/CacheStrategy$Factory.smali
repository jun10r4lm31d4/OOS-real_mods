...
.method public constructor <init>(JLokhttp3/Request;Lokhttp3/Response;)V
    ...
    iput v0, p0, ageSeconds:I

    iput-wide p1, p0, nowMillis:J

    iput-object p3, p0, request:Lokhttp3/Request;

    iput-object p4, p0, cacheResponse:Lokhttp3/Response;
    ...
    iput-wide v1, p0, sentRequestMillis:J

    invoke-virtual {p4}, Lokhttp3/Response;->receivedResponseAtMillis()J

    move-result-wide v1

    iput-wide v1, p0, receivedResponseMillis:J
    ...
    iput-object v6, p0, servedDate:Ljava/util/Date;

    iput-object v5, p0, servedDateString:Ljava/lang/String;
    ...
    iput-object v6, p0, expires:Ljava/util/Date;
    ...
    iput-object v6, p0, lastModified:Ljava/util/Date;

    iput-object v5, p0, lastModifiedString:Ljava/lang/String;
    ...
    iput-object v5, p0, etag:Ljava/lang/String;
...
.method private cacheResponseAge()J
    ...
    iget-object v0, p0, servedDate:Ljava/util/Date;
    ...
    iget-wide v6, p0, sentRequestMillis:J

    sub-long v6, v4, v6

    iget-wide v8, p0, nowMillis:J
...
.method private computeFreshnessLifetime()J
    ...
    iget-object v0, p0, cacheResponse:Lokhttp3/Response;
    ...
    :cond_0
    iget-object v1, p0, expires:Ljava/util/Date;

    const-wide/16 v2, 0x0

    if-eqz v1, :cond_3

    iget-object v1, p0, servedDate:Ljava/util/Date;
    ...
    :cond_3
    iget-object v1, p0, lastModified:Ljava/util/Date;

    if-eqz v1, :cond_6

    iget-object v1, p0, cacheResponse:Lokhttp3/Response;
...
.method private getCandidate()Lokhttp3/internal/cache/CacheStrategy;
    ...
    iget-object v1, v0, cacheResponse:Lokhttp3/Response;
    ...
    iget-object v3, v0, request:Lokhttp3/Request;
    ...
    :cond_0
    iget-object v1, v0, request:Lokhttp3/Request;
    ...
    invoke-static {v3}, hasConditions(Lokhttp3/Request;)Z
    ...
    :cond_3
    invoke-direct/range {p0 .. p0}, cacheResponseAge()J

    move-result-wide v3

    invoke-direct/range {p0 .. p0}, computeFreshnessLifetime()J
    ...
    iget-object v7, v0, cacheResponse:Lokhttp3/Response;
    ...
    iget-object v8, v0, cacheResponse:Lokhttp3/Response;
    ...
    invoke-direct/range {p0 .. p0}, isFreshnessLifetimeHeuristic()Z
    ...
    :cond_9
    iget-object v8, v0, etag:Ljava/lang/String;
    ...
    :cond_a
    iget-object v8, v0, lastModified:Ljava/util/Date;

    if-eqz v8, :cond_b

    const-string v2, "If-Modified-Since"

    iget-object v8, v0, lastModifiedString:Ljava/lang/String;

    goto :goto_0

    :cond_b
    iget-object v8, v0, servedDate:Ljava/util/Date;

    if-eqz v8, :cond_c

    const-string v2, "If-Modified-Since"

    iget-object v8, v0, servedDateString:Ljava/lang/String;

    :goto_0
    iget-object v13, v0, request:Lokhttp3/Request;
    ...
    iget-object v14, v0, request:Lokhttp3/Request;
    ...
    iget-object v8, v0, request:Lokhttp3/Request;
...
.method private isFreshnessLifetimeHeuristic()Z
    ...
    iget-object v0, p0, expires:Ljava/util/Date;
...
.method public get()Lokhttp3/internal/cache/CacheStrategy;
    ...
    invoke-direct {p0}, getCandidate()Lokhttp3/internal/cache/CacheStrategy;
    ...
    iget-object v1, p0, request:Lokhttp3/Request;
