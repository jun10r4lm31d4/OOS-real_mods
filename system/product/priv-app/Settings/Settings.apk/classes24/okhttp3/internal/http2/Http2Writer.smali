...
.method constructor <init>(Lokio/BufferedSink;Z)V
    ...
    iput-object p1, p0, sink:Lokio/BufferedSink;
    ...
    iput-object v0, p0, hpackBuffer:Lokio/Buffer;

    new-instance v0, Lokhttp3/internal/http2/Hpack$Writer;

    iget-object v1, p0, hpackBuffer:Lokio/Buffer;

    invoke-direct {v0, v1}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(Lokio/Buffer;)V

    iput-object v0, p0, hpackWriter:Lokhttp3/internal/http2/Hpack$Writer;

    const/16 v0, 0x4000

    iput v0, p0, maxFrameSize:I
...
.method private writeContinuationFrames(IJ)V
    ...
    :goto_1
    invoke-virtual {p0, p1, v2, v3, v0}, frameHeader(IIBB)V
...
.method public declared-synchronized applyAndAckSettings(Lokhttp3/internal/http2/Settings;)V
    ...
    iget-object v0, p0, hpackWriter:Lokhttp3/internal/http2/Hpack$Writer;
    ...
    invoke-virtual {p0, v3, v0, v1, v2}, frameHeader(IIBB)V
...
.method public declared-synchronized data(ZILokio/Buffer;I)V
    ...
    :cond_0
    invoke-virtual {p0, p2, v0, p3, p4}, dataFrame(IBLokio/Buffer;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method dataFrame(IBLokio/Buffer;I)V
    ...
    invoke-virtual {p0, p1, p4, v0, p2}, frameHeader(IIBB)V

    if-lez p4, :cond_0

    iget-object v1, p0, sink:Lokio/BufferedSink;
...
.method public frameHeader(IIBB)V
    ...
    invoke-static {v0, p2}, writeMedium(Lokio/BufferedSink;I)V
...
.method public declared-synchronized headers(ILjava/util/List;)V
    ...
    invoke-virtual {p0, v0, p1, p2}, headers(ZILjava/util/List;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method headers(ZILjava/util/List;)V
    ...
    iget-object v0, p0, hpackBuffer:Lokio/Buffer;
    ...
    :cond_1
    invoke-virtual {p0, p2, v2, v3, v4}, frameHeader(IIBB)V

    iget-object v5, p0, sink:Lokio/BufferedSink;

    iget-object v6, p0, hpackBuffer:Lokio/Buffer;
    ...
    invoke-direct {p0, p2, v5, v6}, writeContinuationFrames(IJ)V
...
.method public declared-synchronized pushPromise(IILjava/util/List;)V
    ...
    invoke-virtual {p0, p1, v5, v4, v3}, frameHeader(IIBB)V
    ...
    invoke-direct {p0, p1, v5, v6}, writeContinuationFrames(IJ)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized rstStream(ILokhttp3/internal/http2/ErrorCode;)V
    ...
    invoke-virtual {p0, p1, v0, v1, v2}, frameHeader(IIBB)V
...
.method public declared-synchronized settings(Lokhttp3/internal/http2/Settings;)V
    ...
    :cond_2
    :goto_1
    iget-object v6, p0, sink:Lokio/BufferedSink;
...
.method public declared-synchronized synReply(ZILjava/util/List;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, headers(ZILjava/util/List;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized synStream(ZIILjava/util/List;)V
    ...
    invoke-virtual {p0, p1, p2, p4}, headers(ZILjava/util/List;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
