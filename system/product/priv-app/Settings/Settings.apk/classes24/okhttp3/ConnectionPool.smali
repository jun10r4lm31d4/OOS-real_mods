...
.method static constructor <clinit>()V
    ...
    sput-object v8, executor:Ljava/util/concurrent/Executor;
...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v1, v2, v3, v0}, <init>(IJLjava/util/concurrent/TimeUnit;)V
...
.method public constructor <init>(IJLjava/util/concurrent/TimeUnit;)V
    ...
    iput-object v0, p0, connections:Ljava/util/Deque;
    ...
    iput-object v0, p0, routeDatabase:Lokhttp3/internal/connection/RouteDatabase;

    iput p1, p0, maxIdleConnections:I

    invoke-virtual {p4, p2, p3}, Ljava/util/concurrent/TimeUnit;->toNanos(J)J

    move-result-wide v0

    iput-wide v0, p0, keepAliveDurationNs:J
...
.method private pruneAndGetAllocationCount(Lokhttp3/internal/connection/RealConnection;J)I
    ...
    iget-wide v5, p0, keepAliveDurationNs:J
...
.method cleanup(J)J
    ...
    :try_start_0
    iget-object v5, p0, connections:Ljava/util/Deque;
    ...
    invoke-direct {p0, v6, p1, p2}, pruneAndGetAllocationCount(Lokhttp3/internal/connection/RealConnection;J)I
    ...
    iget v5, p0, maxIdleConnections:I
    ...
    iput-boolean v5, p0, cleanupRunning:Z
...
.method connectionBecameIdle(Lokhttp3/internal/connection/RealConnection;)Z
    ...
    iget v0, p0, maxIdleConnections:I
    ...
    :cond_1
    :goto_0
    iget-object v0, p0, connections:Ljava/util/Deque;
...
.method public evictAll()V
    ...
    :try_start_0
    iget-object v1, p0, connections:Ljava/util/Deque;
...
.method put(Lokhttp3/internal/connection/RealConnection;)V
    ...
    iget-boolean v0, p0, cleanupRunning:Z

    if-nez v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, p0, cleanupRunning:Z

    sget-object v0, executor:Ljava/util/concurrent/Executor;
