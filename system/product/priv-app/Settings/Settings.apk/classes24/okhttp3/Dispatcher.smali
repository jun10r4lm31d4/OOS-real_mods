...
.method public constructor <init>()V
    ...
    iput v0, p0, maxRequests:I

    const/4 v0, 0x5

    iput v0, p0, maxRequestsPerHost:I

    new-instance v0, Ljava/util/ArrayDeque;

    invoke-direct {v0}, Ljava/util/ArrayDeque;-><init>()V

    iput-object v0, p0, readyAsyncCalls:Ljava/util/Deque;

    new-instance v0, Ljava/util/ArrayDeque;

    invoke-direct {v0}, Ljava/util/ArrayDeque;-><init>()V

    iput-object v0, p0, runningAsyncCalls:Ljava/util/Deque;

    new-instance v0, Ljava/util/ArrayDeque;

    invoke-direct {v0}, Ljava/util/ArrayDeque;-><init>()V

    iput-object v0, p0, runningSyncCalls:Ljava/util/Deque;
...
.method public constructor <init>(Ljava/util/concurrent/ExecutorService;)V
    ...
    iput-object p1, p0, executorService:Ljava/util/concurrent/ExecutorService;
...
.method private finished(Ljava/util/Deque;Ljava/lang/Object;Z)V
    ...
    invoke-direct {p0}, promoteCalls()V

    :cond_0
    invoke-virtual {p0}, runningCallsCount()I

    move-result v0

    iget-object v1, p0, idleCallback:Ljava/lang/Runnable;
...
.method private promoteCalls()V
    ...
    iget-object v0, p0, runningAsyncCalls:Ljava/util/Deque;

    invoke-interface {v0}, Ljava/util/Deque;->size()I

    move-result v0

    iget v1, p0, maxRequests:I
    ...
    :cond_0
    iget-object v0, p0, readyAsyncCalls:Ljava/util/Deque;
    ...
    invoke-direct {p0, v1}, runningCallsForHost(Lokhttp3/RealCall$AsyncCall;)I

    move-result v2

    iget v3, p0, maxRequestsPerHost:I

    if-ge v2, v3, :cond_2

    invoke-interface {v0}, Ljava/util/Iterator;->remove()V

    iget-object v2, p0, runningAsyncCalls:Ljava/util/Deque;

    invoke-interface {v2, v1}, Ljava/util/Deque;->add(Ljava/lang/Object;)Z

    invoke-virtual {p0}, executorService()Ljava/util/concurrent/ExecutorService;
...
.method private runningCallsForHost(Lokhttp3/RealCall$AsyncCall;)I
    ...
    iget-object v1, p0, runningAsyncCalls:Ljava/util/Deque;
...
.method public declared-synchronized cancelAll()V
    ...
    :cond_1
    iget-object v0, p0, runningSyncCalls:Ljava/util/Deque;
...
.method declared-synchronized enqueue(Lokhttp3/RealCall$AsyncCall;)V
    ...
    invoke-direct {p0, p1}, runningCallsForHost(Lokhttp3/RealCall$AsyncCall;)I

    move-result v0

    iget v1, p0, maxRequestsPerHost:I
...
.method public declared-synchronized executorService()Ljava/util/concurrent/ExecutorService;
    ...
    :try_start_0
    iget-object v0, p0, executorService:Ljava/util/concurrent/ExecutorService;
    ...
    iput-object v0, p0, executorService:Ljava/util/concurrent/ExecutorService;
...
.method finished(Lokhttp3/RealCall$AsyncCall;)V
    ...
    invoke-direct {p0, v0, p1, v1}, finished(Ljava/util/Deque;Ljava/lang/Object;Z)V
...
.method public declared-synchronized getMaxRequestsPerHost()I
    ...
    :try_start_0
    iget v0, p0, maxRequestsPerHost:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized queuedCalls()Ljava/util/List;
    ...
    iget-object v1, p0, readyAsyncCalls:Ljava/util/Deque;
...
.method public declared-synchronized runningCalls()Ljava/util/List;
    ...
    iget-object v1, p0, runningSyncCalls:Ljava/util/Deque;
...
.method public declared-synchronized setIdleCallback(Ljava/lang/Runnable;)V
    ...
    :try_start_0
    iput-object p1, p0, idleCallback:Ljava/lang/Runnable;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized setMaxRequestsPerHost(I)V
    ...
    :try_start_0
    iput p1, p0, maxRequestsPerHost:I
