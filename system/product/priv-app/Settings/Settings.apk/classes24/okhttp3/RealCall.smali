...
.method constructor <init>(Lokhttp3/OkHttpClient;Lokhttp3/Request;Z)V
    ...
    iput-object p2, p0, originalRequest:Lokhttp3/Request;

    iput-boolean p3, p0, forWebSocket:Z
    ...
    iput-object v1, p0, retryAndFollowUpInterceptor:Lokhttp3/internal/http/RetryAndFollowUpInterceptor;

    invoke-interface {v0, p0}, Lokhttp3/EventListener$Factory;->create(Lokhttp3/Call;)Lokhttp3/EventListener;

    move-result-object v1

    iput-object v1, p0, eventListener:Lokhttp3/EventListener;
...
.method private captureCallStackTrace()V
    ...
    iget-object v1, p0, retryAndFollowUpInterceptor:Lokhttp3/internal/http/RetryAndFollowUpInterceptor;
...
.method public cancel()V
    ...
    iget-object v0, p0, retryAndFollowUpInterceptor:Lokhttp3/internal/http/RetryAndFollowUpInterceptor;
...
.method public bridge synthetic clone()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, clone()Lokhttp3/RealCall;
...
.method public clone()Lokhttp3/RealCall;
    ...
    iget-object v2, p0, originalRequest:Lokhttp3/Request;

    iget-boolean v3, p0, forWebSocket:Z

    invoke-direct {v0, v1, v2, v3}, <init>(Lokhttp3/OkHttpClient;Lokhttp3/Request;Z)V
...
.method public enqueue(Lokhttp3/Callback;)V
    ...
    :try_start_0
    iget-boolean v0, p0, executed:Z

    if-nez v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, p0, executed:Z

    monitor-exit p0
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-direct {p0}, captureCallStackTrace()V
...
.method public execute()Lokhttp3/Response;
    ...
    invoke-virtual {p0}, getResponseWithInterceptorChain()Lokhttp3/Response;
...
.method getResponseWithInterceptorChain()Lokhttp3/Response;
    ...
    iget-boolean v1, p0, forWebSocket:Z
    ...
    iget-boolean v2, p0, forWebSocket:Z
    ...
    iget-object v7, p0, originalRequest:Lokhttp3/Request;
...
.method toLoggableString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, redactedUrl()Ljava/lang/String;
