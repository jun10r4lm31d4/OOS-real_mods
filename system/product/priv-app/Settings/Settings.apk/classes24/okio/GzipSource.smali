...
.method public constructor <init>(Lokio/Source;)V
    ...
    iput v0, p0, section:I

    new-instance v0, Ljava/util/zip/CRC32;

    invoke-direct {v0}, Ljava/util/zip/CRC32;-><init>()V

    iput-object v0, p0, crc:Ljava/util/zip/CRC32;
    ...
    iput-object v0, p0, inflater:Ljava/util/zip/Inflater;
    ...
    iget-object v2, p0, inflater:Ljava/util/zip/Inflater;

    invoke-direct {v0, v1, v2}, Lokio/InflaterSource;-><init>(Lokio/BufferedSource;Ljava/util/zip/Inflater;)V

    iput-object v0, p0, inflaterSource:Lokio/InflaterSource;
...
.method private consumeHeader()V
    ...
    iget-object v0, v6, source:Lokio/BufferedSource;
    ...
    invoke-direct/range {v0 .. v5}, updateCrc(Lokio/Buffer;JJ)V
    ...
    invoke-direct {v6, v1, v0, v11}, checkEqual(Ljava/lang/String;II)V
    ...
    iget-object v1, v6, crc:Ljava/util/zip/CRC32;
    ...
    invoke-direct {v6, v2, v0, v1}, checkEqual(Ljava/lang/String;II)V

    iget-object v0, v6, crc:Ljava/util/zip/CRC32;
...
.method private consumeTrailer()V
    ...
    iget-object v1, p0, crc:Ljava/util/zip/CRC32;
    ...
    invoke-direct {p0, v2, v0, v1}, checkEqual(Ljava/lang/String;II)V
    ...
    iget-object v1, p0, inflater:Ljava/util/zip/Inflater;
...
.method private updateCrc(Lokio/Buffer;JJ)V
    ...
    iget-object v3, p0, crc:Ljava/util/zip/CRC32;
...
.method public close()V
    ...
    iget-object v0, p0, inflaterSource:Lokio/InflaterSource;
...
.method public read(Lokio/Buffer;J)J
    ...
    :cond_0
    iget v0, v6, section:I

    const/4 v1, 0x1

    if-nez v0, :cond_1

    invoke-direct {p0}, consumeHeader()V

    iput v1, v6, section:I
    ...
    iget-object v0, v6, inflaterSource:Lokio/InflaterSource;
    ...
    invoke-direct {p0}, consumeTrailer()V

    const/4 v0, 0x3

    iput v0, v6, section:I
