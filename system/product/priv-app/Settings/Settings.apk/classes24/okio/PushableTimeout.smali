...
.method pop()V
    ...
    iget-object v0, p0, pushed:Lokio/Timeout;

    iget-wide v1, p0, originalTimeoutNanos:J

    sget-object v3, Ljava/util/concurrent/TimeUnit;->NANOSECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v0, v1, v2, v3}, Lokio/Timeout;->timeout(JLjava/util/concurrent/TimeUnit;)Lokio/Timeout;

    iget-boolean v0, p0, originalHasDeadline:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, pushed:Lokio/Timeout;

    iget-wide v1, p0, originalDeadlineNanoTime:J
...
.method push(Lokio/Timeout;)V
    ...
    iput-object p1, p0, pushed:Lokio/Timeout;

    invoke-virtual {p1}, Lokio/Timeout;->hasDeadline()Z

    move-result v0

    iput-boolean v0, p0, originalHasDeadline:Z
    ...
    :goto_0
    iput-wide v0, p0, originalDeadlineNanoTime:J

    invoke-virtual {p1}, Lokio/Timeout;->timeoutNanos()J

    move-result-wide v0

    iput-wide v0, p0, originalTimeoutNanos:J

    iget-wide v0, p0, originalTimeoutNanos:J

    invoke-virtual {p0}, timeoutNanos()J

    move-result-wide v2

    invoke-static {v0, v1, v2, v3}, minTimeout(JJ)J
    ...
    iget-wide v2, p0, originalDeadlineNanoTime:J
